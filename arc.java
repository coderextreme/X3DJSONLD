          ...
          .setProtoBody(new ProtoBodyObject()
            .addChild(new TransformObject().setDEF("node")
              ...
              .addChild(new ScriptObject().setDEF("MB1")
                ...
                .addField(new fieldObject().setName("set_location").setAccessType("inputOnly").setType(fieldObject.TYPE_SFTIME))
...
""))
        ...
        .addChild(new ProtoDeclareObject().setName("x3dconnector")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setName("startnode").setAccessType("initializeOnly").setType(fieldObject.TYPE_SFNODE))
            .addField(new fieldObject().setName("endnode").setAccessType("initializeOnly").setType(fieldObject.TYPE_SFNODE))
            .addField(new fieldObject().setName("connectornode").setAccessType("initializeOnly").setType(fieldObject.TYPE_SFNODE))
            .addField(new fieldObject().setName("set_startpoint").setAccessType("inputOnly").setType(fieldObject.TYPE_SFVEC3F))
            .addField(new fieldObject().setName("set_endpoint").setAccessType("inputOnly").setType(fieldObject.TYPE_SFVEC3F)))
          .setProtoBody(new ProtoBodyObject()

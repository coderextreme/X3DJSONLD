          ...
          .addChild(new ShapeObject()
            ...
            .setAppearance(new AppearanceObject()
              ...
              .addShaders(new ComposedShaderObject().setLanguage("GLSL")
                ...
                .addParts(new ShaderPartObject().setType("FRAGMENT").setDEF("common").setUrl(Java.to(["common.fs","http://coderextreme.net/X3DJSONLD/common.fs"], Java.type("java.lang.String[]")))))
              .addShaders(new ComposedShaderObject().setLanguage("GLSL")

    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new ScriptObject().setDEF("S1")
          ...
          .addField(new fieldObject().setName("translation").setAccessType("outputOnly").setType(fieldObject.TYPE_SFVEC3F))
          .addField(new fieldObject().setName("rotation").setAccessType("outputOnly").setType(fieldObject.TYPE_SFROTATION))
          .addField(new fieldObject().setName("scale").setAccessType("outputOnly").setType(fieldObject.TYPE_SFVEC3F))

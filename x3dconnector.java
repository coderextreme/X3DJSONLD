    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new ScriptObject().setDEF("S1")
          ...
          .addField(new fieldObject().setName("translation").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFVEC3F))
          .addField(new fieldObject().setName("rotation").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFROTATION))
          .addField(new fieldObject().setName("scale").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFVEC3F))
...
"        }\n"+
""))
        .addChild(new ROUTEObject().setFromNode("G1").setFromField("translation").setToNode("S1").setToField("startpoint"))
        .addChild(new ROUTEObject().setFromNode("G2").setFromField("translation").setToNode("S1").setToField("endpoint"))

  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new BackgroundObject().setDEF("cube").setLeftUrl(new MFStringObject(MFString0())).setRightUrl(new MFStringObject(MFString1())).setFrontUrl(new MFStringObject(MFString2())).setBackUrl(new MFStringObject(MFString3())).setTopUrl(new MFStringObject(MFString4())).setBottomUrl(new MFStringObject(MFString5())))

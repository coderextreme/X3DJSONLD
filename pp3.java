        ...
        .addChild(new ProtoDeclareObject().setName("Process")
          .setProtoBody(new ProtoBodyObject()
            ...
            .addChild(new ScriptObject().setDEF("RightSingleToMultiString")
              .addField(new fieldObject().setName("set_rightstring").setAccessType("inputOnly").setType(fieldObject.TYPE_SFSTRING))
              .addField(new fieldObject().setName("rightlines").setAccessType("outputOnly").setType(fieldObject.TYPE_MFSTRING))
...
""))
            .addChild(new ScriptObject().setDEF("UpSingleToMultiString")
              .addField(new fieldObject().setName("set_upstring").setAccessType("inputOnly").setType(fieldObject.TYPE_SFSTRING))
              .addField(new fieldObject().setName("uplines").setAccessType("outputOnly").setType(fieldObject.TYPE_MFSTRING))
              .setSourceCode("ecmascript:\n"+
"\n"+
"function initialize() {\n"+
...
""))
            .addChild(new ScriptObject().setDEF("CenterSingleToMultiString")
              .addField(new fieldObject().setName("set_centerstring").setAccessType("inputOnly").setType(fieldObject.TYPE_SFSTRING))
              .addField(new fieldObject().setName("centerlines").setAccessType("outputOnly").setType(fieldObject.TYPE_MFSTRING))
              .setSourceCode("ecmascript:\n"+
"\n"+
"function initialize() {\n"+

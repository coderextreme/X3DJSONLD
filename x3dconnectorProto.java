    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new TransformObject().setDEF("G3").setTranslation(new float[] {1f,1f,0.01f})
          ...
          .addChild(new ROUTEObject().setFromNode("PS3").setFromField("translation_changed").setToNode("G3").setToField("translation")))
        .addChild(new TransformObject().setDEF("G4").setTranslation(new float[] {-1f,1f,0.01f})
          ...
          .addChild(new ROUTEObject().setFromNode("PS4").setFromField("translation_changed").setToNode("G4").setToField("translation")))

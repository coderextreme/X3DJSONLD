    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new TransformObject().setDEF("G1")
          ...
          .addChild(new ROUTEObject().setFromNode("PS1").setFromField("translation").setToNode("G1").setToField("translation")))
        .addChild(new TransformObject().setDEF("G2").setTranslation(new float[] {1f,-1f,0.01f})
          ...
          .addChild(new ROUTEObject().setFromNode("PS2").setFromField("translation").setToNode("G2").setToField("translation")))
        .addChild(new TransformObject().setDEF("G3").setTranslation(new float[] {1f,1f,0.01f})
          ...
          .addChild(new ROUTEObject().setFromNode("PS3").setFromField("translation").setToNode("G3").setToField("translation")))
        .addChild(new TransformObject().setDEF("G4").setTranslation(new float[] {-1f,1f,0.01f})
          ...
          .addChild(new ROUTEObject().setFromNode("PS4").setFromField("translation").setToNode("G4").setToField("translation")))
...
""))))
        ...
        .addChild(new ROUTEObject().setFromNode("G1").setFromField("translation").setToNode("connector1").setToField("startpoint"))
        .addChild(new ROUTEObject().setFromNode("G2").setFromField("translation").setToNode("connector1").setToField("endpoint"))
        .addChild(new ROUTEObject().setFromNode("G1").setFromField("translation").setToNode("connector2").setToField("startpoint"))
        .addChild(new ROUTEObject().setFromNode("G3").setFromField("translation").setToNode("connector2").setToField("endpoint"))
        .addChild(new ROUTEObject().setFromNode("G1").setFromField("translation").setToNode("connector3").setToField("startpoint"))
        .addChild(new ROUTEObject().setFromNode("G4").setFromField("translation").setToNode("connector3").setToField("endpoint")))      ;
    }

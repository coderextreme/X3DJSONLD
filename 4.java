  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setName("modified").setContent("26 November 2015"))
      ...
      .setScene(new SceneObject()
        .addChild(new ExternProtoDeclareObject().setName("ViewPositionOrientation").setUrl(new MFStringObject(new MFString0().getArray()))
          .addField(new fieldObject().setName("enabled").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setType(fieldObject.TYPE_SFBOOL))
          .addField(new fieldObject().setName("traceEnabled").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFBOOL))
          .addField(new fieldObject().setName("set_traceEnabled").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFBOOL))
          .addField(new fieldObject().setName("position_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFVEC3F))
          .addField(new fieldObject().setName("orientation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFROTATION))
          .addField(new fieldObject().setName("outputViewpointString").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_MFSTRING)))

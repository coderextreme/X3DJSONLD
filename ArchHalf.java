    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        .addChild(new ShapeObject().setDEF("Arch")
          ...
          .setGeometry(new IndexedFaceSetObject().setDEF("ArchIndex").setConvex(false).setCoordIndex(new MFInt32Object(MFInt320())).setSolid(false)
            .setCoord(new CoordinateObject().setDEF("ArchChord").setPoint(new MFVec3fObject(MFVec3f1()))))

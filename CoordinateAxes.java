    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        .addChild(new CollisionObject().setDEF("DoNotCollideWithVisualizationWidget")
          ...
          .setProxy(new TransformObject().setRotation(new float[] {0f,0f,1f,-1.57079f})
          ...
          .setProxy(new TransformObject().setRotation(new float[] {1f,0f,0f,1.57079f})

...
public class fors {
  public static void main(String[] args) {
    ...
    new fors().initialize().toFileJSON("fors.new.json");
    }
        ...
        .addChild(new ProtoDeclareObject().setName("cylinder")
          ...
          .setProtoBody(new ProtoBodyObject()
            ...
            .addChild(new ScriptObject().setDEF("MoveCylinder")
              .addField(new fieldObject().setName("spine").setAccessType("inputOutput").setType(fieldObject.TYPE_MFVEC3F).setValue("0 -50 0 0 0 0 0 50 0"))

  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
              ...
              .addChild(new TransformObject().setDEF("Stop_Text").setTranslation(new float[] {0f,0.4f,0f})
                ...
                .addChild(new ShapeObject().setDEF("Stop_Back")
                  .setAppearance(new AppearanceObject()
                    .setMaterial(new MaterialObject().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSetObject().setUSE("Backing")))))))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_HumanoidRootTransInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_HumanoidRootRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_sacroiliacRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_subtalarRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_midtarsalRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_metatarsalRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_subtalarRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_midtarsalRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_metatarsalRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vl5RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vl4RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vl3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vl2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vl1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt12RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt11RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt10RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt9RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt8RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt7RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt6RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt5RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt4RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vt1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vc7RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vc6RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vc5RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vc4RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vc3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vc2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_vc1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_skullbaseRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_eyeball_jointRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_eyeball_jointRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_sternoclavicularRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_acromioclavicularRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_thumb1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_thumb2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_thumb3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_index0RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_index1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_index2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_index3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_middle0RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_middle1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_middle2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_middle3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_ring0RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_ring1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_ring2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_ring3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_pinky0RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_pinky1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_pinky2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_l_pinky3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_sternoclavicularRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_acromioclavicularRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_thumb1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_thumb2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_thumb3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_index0RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_index1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_index2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_index3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_middle0RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_middle1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_middle2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_middle3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_ring0RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_ring1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_ring2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_ring3RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_pinky0RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_pinky1RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_pinky2RotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StopTimer").setToField("fraction").setToNode("Stop_r_pinky3RotInterp"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_HumanoidRootTransInterp").setToField("translation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_HumanoidRootRotInterp").setToField("rotation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_l_hipRotInterp").setToField("rotation").setToNode("hanim_l_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_l_kneeRotInterp").setToField("rotation").setToNode("hanim_l_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_l_ankleRotInterp").setToField("rotation").setToNode("hanim_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_l_midtarsalRotInterp").setToField("rotation").setToNode("hanim_l_midtarsal"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_r_hipRotInterp").setToField("rotation").setToNode("hanim_r_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_r_kneeRotInterp").setToField("rotation").setToNode("hanim_r_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_r_ankleRotInterp").setToField("rotation").setToNode("hanim_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_r_midtarsalRotInterp").setToField("rotation").setToNode("hanim_r_midtarsal"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_vl5RotInterp").setToField("rotation").setToNode("hanim_vl5"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_skullbaseRotInterp").setToField("rotation").setToNode("hanim_skullbase"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_l_shoulderRotInterp").setToField("rotation").setToNode("hanim_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_l_elbowRotInterp").setToField("rotation").setToNode("hanim_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_l_wristRotInterp").setToField("rotation").setToNode("hanim_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_r_shoulderRotInterp").setToField("rotation").setToNode("hanim_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_r_elbowRotInterp").setToField("rotation").setToNode("hanim_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stop_r_wristRotInterp").setToField("rotation").setToNode("hanim_r_wrist"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_lower_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_headRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_neckRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_eyeballRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_eyeballRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_upper_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_whole_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_whole_bodyTransInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_metatarsalPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_sacroiliacYaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_vl5Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_vc6Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_l_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_index1Roll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_index2Roll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("StandTimer").setToField("fraction").setToNode("Stand_r_index3Roll"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_r_ankleRotInterp").setToField("rotation").setToNode("hanim_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_r_kneeRotInterp").setToField("rotation").setToNode("hanim_r_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_r_hipRotInterp").setToField("rotation").setToNode("hanim_r_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_l_ankleRotInterp").setToField("rotation").setToNode("hanim_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_l_kneeRotInterp").setToField("rotation").setToNode("hanim_l_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_l_hipRotInterp").setToField("rotation").setToNode("hanim_l_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_r_wristRotInterp").setToField("rotation").setToNode("hanim_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_r_elbowRotInterp").setToField("rotation").setToNode("hanim_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_r_shoulderRotInterp").setToField("rotation").setToNode("hanim_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_l_wristRotInterp").setToField("rotation").setToNode("hanim_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_l_elbowRotInterp").setToField("rotation").setToNode("hanim_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_l_shoulderRotInterp").setToField("rotation").setToNode("hanim_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_headRotInterp").setToField("rotation").setToNode("hanim_skullbase"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_whole_bodyRotInterp").setToField("rotation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_whole_bodyTransInterp").setToField("translation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Stand_vl5Yaw").setToField("rotation").setToNode("hanim_vl5"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_r_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_r_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_r_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_l_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_l_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_l_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_lower_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_r_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_r_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_r_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_l_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_l_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_l_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_headRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_neckRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_upper_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_whole_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitches_whole_bodyTransInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_l_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_l_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_r_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_r_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_r_metatarsalPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_sacroiliacYaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_vl5Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_vc6Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_l_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("PitchTimer").setToField("fraction").setToNode("Pitch_r_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_r_ankleRotInterp").setToField("rotation").setToNode("hanim_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_r_kneeRotInterp").setToField("rotation").setToNode("hanim_r_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_r_hipRotInterp").setToField("rotation").setToNode("hanim_r_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_l_ankleRotInterp").setToField("rotation").setToNode("hanim_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_l_kneeRotInterp").setToField("rotation").setToNode("hanim_l_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_l_hipRotInterp").setToField("rotation").setToNode("hanim_l_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_r_wristRotInterp").setToField("rotation").setToNode("hanim_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_r_elbowRotInterp").setToField("rotation").setToNode("hanim_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_r_shoulderRotInterp").setToField("rotation").setToNode("hanim_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_l_wristRotInterp").setToField("rotation").setToNode("hanim_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_l_elbowRotInterp").setToField("rotation").setToNode("hanim_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_l_shoulderRotInterp").setToField("rotation").setToNode("hanim_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_headRotInterp").setToField("rotation").setToNode("hanim_skullbase"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_whole_bodyRotInterp").setToField("rotation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitches_whole_bodyTransInterp").setToField("translation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Pitch_vl5Yaw").setToField("rotation").setToNode("hanim_vl5"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_r_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_r_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_r_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_l_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_l_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_l_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_lower_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_r_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_r_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_r_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_l_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_l_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_l_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_headRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_neckRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_upper_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_whole_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaws_whole_bodyTransInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_l_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_l_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_r_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_r_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_r_metatarsalPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_sacroiliacYaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_vl5Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_vc6Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_l_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("YawTimer").setToField("fraction").setToNode("Yaw_r_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_r_ankleRotInterp").setToField("rotation").setToNode("hanim_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_r_kneeRotInterp").setToField("rotation").setToNode("hanim_r_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_r_hipRotInterp").setToField("rotation").setToNode("hanim_r_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_l_ankleRotInterp").setToField("rotation").setToNode("hanim_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_l_kneeRotInterp").setToField("rotation").setToNode("hanim_l_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_l_hipRotInterp").setToField("rotation").setToNode("hanim_l_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_r_wristRotInterp").setToField("rotation").setToNode("hanim_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_r_elbowRotInterp").setToField("rotation").setToNode("hanim_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_r_shoulderRotInterp").setToField("rotation").setToNode("hanim_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_l_wristRotInterp").setToField("rotation").setToNode("hanim_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_l_elbowRotInterp").setToField("rotation").setToNode("hanim_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_l_shoulderRotInterp").setToField("rotation").setToNode("hanim_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_headRotInterp").setToField("rotation").setToNode("hanim_skullbase"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_whole_bodyRotInterp").setToField("rotation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaws_whole_bodyTransInterp").setToField("translation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Yaw_vl5Yaw").setToField("rotation").setToNode("hanim_vl5"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_r_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_r_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_r_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_l_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_l_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_l_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_lower_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_r_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_r_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_r_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_l_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_l_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_l_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_headRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_neckRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_upper_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_whole_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Rolls_whole_bodyTransInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_l_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_l_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_r_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_r_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_r_metatarsalPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_sacroiliacYaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_vl5Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_vc6Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_l_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RollTimer").setToField("fraction").setToNode("Roll_r_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_r_ankleRotInterp").setToField("rotation").setToNode("hanim_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_r_kneeRotInterp").setToField("rotation").setToNode("hanim_r_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_r_hipRotInterp").setToField("rotation").setToNode("hanim_r_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_l_ankleRotInterp").setToField("rotation").setToNode("hanim_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_l_kneeRotInterp").setToField("rotation").setToNode("hanim_l_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_l_hipRotInterp").setToField("rotation").setToNode("hanim_l_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_r_wristRotInterp").setToField("rotation").setToNode("hanim_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_r_elbowRotInterp").setToField("rotation").setToNode("hanim_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_r_shoulderRotInterp").setToField("rotation").setToNode("hanim_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_l_wristRotInterp").setToField("rotation").setToNode("hanim_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_l_elbowRotInterp").setToField("rotation").setToNode("hanim_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_l_shoulderRotInterp").setToField("rotation").setToNode("hanim_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_headRotInterp").setToField("rotation").setToNode("hanim_skullbase"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_whole_bodyRotInterp").setToField("rotation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Rolls_whole_bodyTransInterp").setToField("translation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Roll_vl5Yaw").setToField("rotation").setToNode("hanim_vl5"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_l_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_l_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_l_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_lower_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_l_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_l_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_l_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_headRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_neckRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_upper_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_whole_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_whole_bodyTranInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_l_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_l_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_metatarsalPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_sacroiliacYaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_vl5Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_vc6Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_l_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("WalkTimer").setToField("fraction").setToNode("Walk_r_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_r_ankleRotInterp").setToField("rotation").setToNode("hanim_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_r_kneeRotInterp").setToField("rotation").setToNode("hanim_r_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_r_hipRotInterp").setToField("rotation").setToNode("hanim_r_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_l_ankleRotInterp").setToField("rotation").setToNode("hanim_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_l_kneeRotInterp").setToField("rotation").setToNode("hanim_l_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_l_hipRotInterp").setToField("rotation").setToNode("hanim_l_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_r_wristRotInterp").setToField("rotation").setToNode("hanim_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_r_elbowRotInterp").setToField("rotation").setToNode("hanim_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_r_shoulderRotInterp").setToField("rotation").setToNode("hanim_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_l_wristRotInterp").setToField("rotation").setToNode("hanim_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_l_elbowRotInterp").setToField("rotation").setToNode("hanim_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_l_shoulderRotInterp").setToField("rotation").setToNode("hanim_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_headRotInterp").setToField("rotation").setToNode("hanim_skullbase"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_whole_bodyRotInterp").setToField("rotation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_whole_bodyTranInterp").setToField("translation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Walk_vl5Yaw").setToField("rotation").setToNode("hanim_vl5"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_ankleRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_kneeRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_hipRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_l_ankleRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_l_kneeRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_l_hipRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_lower_bodyRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_wristRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_elbowRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_shoulderRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_l_wristRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_l_elbowRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_l_shoulderRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_headRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_neckRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_upper_bodyRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_whole_bodyRotInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_whole_bodyTranInterp_Run"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_l_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_l_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_metatarsalPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_sacroiliacYaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_vl5Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_vc6Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_l_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("RunTimer").setToField("fraction").setToNode("Run_r_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_r_ankleRotInterp_Run").setToField("rotation").setToNode("hanim_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_r_kneeRotInterp_Run").setToField("rotation").setToNode("hanim_r_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_r_hipRotInterp_Run").setToField("rotation").setToNode("hanim_r_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_l_ankleRotInterp_Run").setToField("rotation").setToNode("hanim_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_l_kneeRotInterp_Run").setToField("rotation").setToNode("hanim_l_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_l_hipRotInterp_Run").setToField("rotation").setToNode("hanim_l_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_r_wristRotInterp_Run").setToField("rotation").setToNode("hanim_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_r_elbowRotInterp_Run").setToField("rotation").setToNode("hanim_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_r_shoulderRotInterp_Run").setToField("rotation").setToNode("hanim_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_l_wristRotInterp_Run").setToField("rotation").setToNode("hanim_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_l_elbowRotInterp_Run").setToField("rotation").setToNode("hanim_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_l_shoulderRotInterp_Run").setToField("rotation").setToNode("hanim_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_headRotInterp_Run").setToField("rotation").setToNode("hanim_skullbase"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_whole_bodyRotInterp_Run").setToField("rotation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_whole_bodyTranInterp_Run").setToField("translation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Run_vl5Yaw").setToField("rotation").setToNode("hanim_vl5"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_l_ankleRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_l_kneeRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_l_hipRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_lower_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_l_wristRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_l_elbowRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_l_shoulderRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_headRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_neckRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_upper_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_whole_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_whole_bodyTranInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_l_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_l_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_metatarsalPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_sacroiliacYaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_vl5Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_vc6Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_l_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("JumpTimer").setToField("fraction").setToNode("Jump_r_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_r_ankleRotInterp").setToField("rotation").setToNode("hanim_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_r_kneeRotInterp").setToField("rotation").setToNode("hanim_r_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_r_hipRotInterp").setToField("rotation").setToNode("hanim_r_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_l_ankleRotInterp").setToField("rotation").setToNode("hanim_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_l_kneeRotInterp").setToField("rotation").setToNode("hanim_l_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_l_hipRotInterp").setToField("rotation").setToNode("hanim_l_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_r_wristRotInterp").setToField("rotation").setToNode("hanim_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_r_elbowRotInterp").setToField("rotation").setToNode("hanim_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_r_shoulderRotInterp").setToField("rotation").setToNode("hanim_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_l_wristRotInterp").setToField("rotation").setToNode("hanim_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_l_elbowRotInterp").setToField("rotation").setToNode("hanim_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_l_shoulderRotInterp").setToField("rotation").setToNode("hanim_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_headRotInterp").setToField("rotation").setToNode("hanim_skullbase"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_whole_bodyRotInterp").setToField("rotation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_whole_bodyTranInterp").setToField("translation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Jump_vl5Yaw").setToField("rotation").setToNode("hanim_vl5"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_l_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_l_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_l_shoulderRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_l_ForeArmPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_l_wristRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_l_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_sternoclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_acromioclavicularRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_shoulderRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_ForeArmPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_wristRoll"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_thumb1Pitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_hipPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_kneePitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_l_hipPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_l_kneePitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_anklePitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_r_metatarsalPitch"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_sacroiliacYaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_vl5Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_vc6Yaw"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_lower_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_upper_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_whole_bodyRotInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_whole_bodyTransInterp"))
        .addChild(new ROUTEObject().setFromField("fraction").setFromNode("KickTimer").setToField("fraction").setToNode("Kick_neckRotInterp"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_l_shoulderRoll").setToField("rotation").setToNode("hanim_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_l_ForeArmPitch").setToField("rotation").setToNode("hanim_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_l_wristRoll").setToField("rotation").setToNode("hanim_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_r_shoulderRoll").setToField("rotation").setToNode("hanim_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_r_ForeArmPitch").setToField("rotation").setToNode("hanim_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_r_wristRoll").setToField("rotation").setToNode("hanim_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_r_hipPitch").setToField("rotation").setToNode("hanim_r_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_r_kneePitch").setToField("rotation").setToNode("hanim_r_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_r_anklePitch").setToField("rotation").setToNode("hanim_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_l_hipPitch").setToField("rotation").setToNode("hanim_l_hip"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_l_kneePitch").setToField("rotation").setToNode("hanim_l_knee"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_r_anklePitch").setToField("rotation").setToNode("hanim_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_vl5Yaw").setToField("rotation").setToNode("hanim_vl5"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_whole_bodyRotInterp").setToField("rotation").setToNode("hanim_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value").setFromNode("Kick_whole_bodyTransInterp").setToField("translation").setToNode("hanim_HumanoidRoot"))
        ...
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stand_Touch").setToField("stopTime").setToNode("PitchTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stand_Touch").setToField("stopTime").setToNode("YawTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stand_Touch").setToField("stopTime").setToNode("RollTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stand_Touch").setToField("stopTime").setToNode("WalkTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stand_Touch").setToField("stopTime").setToNode("RunTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stand_Touch").setToField("stopTime").setToNode("JumpTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stand_Touch").setToField("stopTime").setToNode("KickTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stand_Touch").setToField("stopTime").setToNode("StopTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stand_Touch").setToField("startTime").setToNode("StandTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Pitch_Touch").setToField("stopTime").setToNode("StandTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Pitch_Touch").setToField("stopTime").setToNode("YawTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Pitch_Touch").setToField("stopTime").setToNode("RollTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Pitch_Touch").setToField("stopTime").setToNode("WalkTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Pitch_Touch").setToField("stopTime").setToNode("RunTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Pitch_Touch").setToField("stopTime").setToNode("JumpTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Pitch_Touch").setToField("stopTime").setToNode("KickTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Pitch_Touch").setToField("stopTime").setToNode("StopTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Pitch_Touch").setToField("startTime").setToNode("PitchTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Yaw_Touch").setToField("stopTime").setToNode("StandTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Yaw_Touch").setToField("stopTime").setToNode("PitchTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Yaw_Touch").setToField("stopTime").setToNode("RollTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Yaw_Touch").setToField("stopTime").setToNode("WalkTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Yaw_Touch").setToField("stopTime").setToNode("RunTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Yaw_Touch").setToField("stopTime").setToNode("JumpTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Yaw_Touch").setToField("stopTime").setToNode("KickTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Yaw_Touch").setToField("stopTime").setToNode("StopTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Yaw_Touch").setToField("startTime").setToNode("YawTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Walk_Touch").setToField("stopTime").setToNode("StandTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Walk_Touch").setToField("stopTime").setToNode("PitchTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Walk_Touch").setToField("stopTime").setToNode("YawTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Walk_Touch").setToField("stopTime").setToNode("RollTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Walk_Touch").setToField("stopTime").setToNode("RunTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Walk_Touch").setToField("stopTime").setToNode("JumpTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Walk_Touch").setToField("stopTime").setToNode("KickTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Walk_Touch").setToField("stopTime").setToNode("StopTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Walk_Touch").setToField("startTime").setToNode("WalkTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Roll_Touch").setToField("stopTime").setToNode("StandTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Roll_Touch").setToField("stopTime").setToNode("PitchTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Roll_Touch").setToField("stopTime").setToNode("YawTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Roll_Touch").setToField("stopTime").setToNode("WalkTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Roll_Touch").setToField("stopTime").setToNode("RunTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Roll_Touch").setToField("stopTime").setToNode("JumpTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Roll_Touch").setToField("stopTime").setToNode("KickTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Roll_Touch").setToField("stopTime").setToNode("StopTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Roll_Touch").setToField("startTime").setToNode("RollTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Run_Touch").setToField("stopTime").setToNode("StandTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Run_Touch").setToField("stopTime").setToNode("PitchTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Run_Touch").setToField("stopTime").setToNode("YawTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Run_Touch").setToField("stopTime").setToNode("RollTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Run_Touch").setToField("stopTime").setToNode("WalkTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Run_Touch").setToField("stopTime").setToNode("JumpTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Run_Touch").setToField("stopTime").setToNode("KickTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Run_Touch").setToField("stopTime").setToNode("StopTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Run_Touch").setToField("startTime").setToNode("RunTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Jump_Touch").setToField("stopTime").setToNode("StandTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Jump_Touch").setToField("stopTime").setToNode("PitchTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Jump_Touch").setToField("stopTime").setToNode("YawTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Jump_Touch").setToField("stopTime").setToNode("RollTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Jump_Touch").setToField("stopTime").setToNode("WalkTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Jump_Touch").setToField("stopTime").setToNode("RunTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Jump_Touch").setToField("stopTime").setToNode("KickTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Jump_Touch").setToField("stopTime").setToNode("StopTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Jump_Touch").setToField("startTime").setToNode("JumpTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Kick_Touch").setToField("stopTime").setToNode("StandTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Kick_Touch").setToField("stopTime").setToNode("PitchTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Kick_Touch").setToField("stopTime").setToNode("YawTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Kick_Touch").setToField("stopTime").setToNode("RollTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Kick_Touch").setToField("stopTime").setToNode("WalkTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Kick_Touch").setToField("stopTime").setToNode("RunTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Kick_Touch").setToField("stopTime").setToNode("JumpTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Kick_Touch").setToField("stopTime").setToNode("StopTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Kick_Touch").setToField("startTime").setToNode("KickTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stop_Touch").setToField("stopTime").setToNode("StandTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stop_Touch").setToField("stopTime").setToNode("PitchTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stop_Touch").setToField("stopTime").setToNode("YawTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stop_Touch").setToField("stopTime").setToNode("RollTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stop_Touch").setToField("stopTime").setToNode("WalkTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stop_Touch").setToField("stopTime").setToNode("RunTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stop_Touch").setToField("stopTime").setToNode("JumpTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stop_Touch").setToField("stopTime").setToNode("KickTimer"))
        .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("Stop_Touch").setToField("startTime").setToNode("StopTimer")))      ;
    }

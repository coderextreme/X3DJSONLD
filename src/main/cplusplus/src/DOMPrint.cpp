...
#include <src/xercesc/dom/DOM.hpp>

#include <src/xercesc/framework/StdOutFormatTarget.hpp>
#include <src/xercesc/framework/LocalFileFormatTarget.hpp>
#include <src/xercesc/parsers/XercesDOMParser.hpp>
#include <src/xercesc/util/XMLUni.hpp>
#include <src/xercesc/util/OutOfMemoryException.hpp>
    ...
    catch(const XMLException &toCatch)
    {
        ...
        try
        {
            ...
            if(gXPathExpression!=NULL)
            {
                ...
                {
                    cerr << "An error occurred during processing of the XPath expression. Msg is:"
                        << endl
        ...
        {
            cerr << "An error occurred during serialization of the DOM tree. Msg is:"
                << endl
                << StrX(e.getMessage()) << endl;
            retval = 4;
        }

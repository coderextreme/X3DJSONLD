...
/* ./.libs/lt-x3djsonld.c - temporary wrapper executable for .libs/x3djsonld
   Generated by libtool (GNU libtool) 2.4.6

   The x3djsonld program cannot be directly executed until all the libtool
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# x3djsonld - temporary wrapper script for .libs/x3djsonld\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The x3djsonld program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"x3djsonld:x3djsonld:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"x3djsonld:x3djsonld:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"x3djsonld:x3djsonld:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);

...
/* ./.libs/lt-DOMCount.c - temporary wrapper executable for .libs/DOMCount
...
const char * TARGET_PROGRAM_NAME = "DOMCount"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# DOMCount - temporary wrapper script for .libs/DOMCount\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The DOMCount program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"DOMCount:DOMCount:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"DOMCount:DOMCount:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"DOMCount:DOMCount:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);

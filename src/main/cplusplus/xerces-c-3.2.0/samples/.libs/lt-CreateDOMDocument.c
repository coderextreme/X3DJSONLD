...
/* ./.libs/lt-CreateDOMDocument.c - temporary wrapper executable for .libs/CreateDOMDocument
...
const char * TARGET_PROGRAM_NAME = "CreateDOMDocument"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# CreateDOMDocument - temporary wrapper script for .libs/CreateDOMDocument\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The CreateDOMDocument program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"CreateDOMDocument:CreateDOMDocument:$LINENO: libtool wrapper (GNU lib", f);
  fputs ("tool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"CreateDOMDocument:CreateDOMDocument:$LINENO: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"CreateDOMDocument:CreateDOMDocument:$LINENO: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='CreateDOMDocument'\n", f);

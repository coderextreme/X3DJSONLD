...
/* ./.libs/lt-SAX2Print.c - temporary wrapper executable for .libs/SAX2Print
...
const char * TARGET_PROGRAM_NAME = "SAX2Print"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# SAX2Print - temporary wrapper script for .libs/SAX2Print\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The SAX2Print program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"SAX2Print:SAX2Print:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"SAX2Print:SAX2Print:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"SAX2Print:SAX2Print:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);

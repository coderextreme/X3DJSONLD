...
Material13.setDiffuseColor(new float[]{1,0.794631,0.389824});
...
Transform21.setTranslation(new float[]{0,0.947,0.502001});
...
Transform24.setTranslation(new float[]{0,1.664,1.189});
...
Transform26.setTranslation(new float[]{0,0.947,1.8795});
...
Transform28.setTranslation(new float[]{0,0,2.384});
...
Material35.setDiffuseColor(new float[]{0.585106,0.0214792,0});
...
TextureTransform37.setScale(new float[]{2,2});
...
TextureCoordinate47.setPoint(new float[]{-0.0303601,0.997813,0,0,1,0,0.96964,0.997813}, 8);
...
Material52.setDiffuseColor(new float[]{1,0.794631,0.389824});

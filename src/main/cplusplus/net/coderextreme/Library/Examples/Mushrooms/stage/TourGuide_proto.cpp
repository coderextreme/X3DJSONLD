...
Viewpoint19.setPosition(new float[]{0,0,0});
...
PositionInterpolator33.setKey(new float[]{0,1}, 2);
PositionInterpolator33.setKeyValue(new float[]{0,0,0,0,0,0}, 6);
...
OrientationInterpolator35.setKey(new float[]{0,1}, 2);
OrientationInterpolator35.setKeyValue(new float[]{0,0,1,0,0,0,1,0}, 8);

...
Transform11.setTranslation(new float[]{52.4723,0.0,11.8231});
Transform11.setRotation(new float[]{0.0,1.0,0.0,1.49907});
...
Transform14.setTranslation(new float[]{35.6884,0.0,14.5356});
Transform14.setRotation(new float[]{0.0,1.0,0.0,1.22763});
...
Transform17.setTranslation(new float[]{6.59897,0.0,10.7292});
Transform17.setRotation(new float[]{0.0,1.0,0.0,0.61945});
...
Transform20.setTranslation(new float[]{-12.4465,0.0,-2.34085});
Transform20.setRotation(new float[]{0.0,1.0,0.0,0.200959});
...
Transform23.setTranslation(new float[]{-24.2654,0.0,-22.5612});
Transform23.setRotation(new float[]{0.0,-1.0,0.0,0.203997});
...
Transform26.setTranslation(new float[]{-26.8513,0.0,-39.5722});
Transform26.setRotation(new float[]{0.0,-1.0,0.0,0.455394});
...
Transform29.setTranslation(new float[]{-13.6717,0.0,-73.6618});
Transform29.setRotation(new float[]{0.0,-1.0,0.0,1.20026});
...
PointLight33.setColor(new float[]{0.341451,1.0,0.269661});

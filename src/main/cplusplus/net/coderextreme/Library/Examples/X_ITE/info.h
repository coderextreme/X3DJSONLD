...
Transform39.setTranslation(new float[]{-0.421689,0.1,1.0});
Shape& Shape40 =  Shape();
Appearance& Appearance41 =  Appearance();
Material& Material42 =  Material();
Material42.setDiffuseColor(new float[]{0.0,0.0,0.0});
...
Transform51.setTranslation(new float[]{0.0,0.0,-1.0});
Shape& Shape52 =  Shape();
...
Rectangle2D55.setSize(new float[]{1.0,1.0});
...
Layout57.setOffset(new float[]{0.0,-0.32}, 2);
Layout57.setSize(new float[]{1.0,0.19}, 2);
...
Rectangle2D61.setSize(new float[]{1.0,1.0});
...
Transform64.setScale(new float[]{1.01,1.0,1.0});
...
Rectangle2D69.setSize(new float[]{1.0,1.0});
...
Transform70.setTranslation(new float[]{0.34,0.245,0.0});
Transform70.setScale(new float[]{0.2,0.51,1.0});
Shape& Shape71 =  Shape();
...
Transform75.setTranslation(new float[]{0.34,-0.255,0.0});
Transform75.setScale(new float[]{0.2,0.49,1.0});
Shape& Shape76 =  Shape();
Appearance& Appearance77 =  Appearance();
Material& Material78 =  Material();
Material78.setDiffuseColor(new float[]{1.0,0.890196,0.176471});
...
Layout81.setSize(new float[]{0.1,1.0}, 2);
...
Transform82.setTranslation(new float[]{-0.480889,0.469111,1.0});
...
Transform87.setCenter(new float[]{5.6,-5.9,0.0});
...
Transform89.setTranslation(new float[]{-0.219,0.3611,1.0});
Shape& Shape90 =  Shape();
...
Transform95.setTranslation(new float[]{-0.216884,0.26855,1.0});
Shape& Shape96 =  Shape();
...
Transform101.setTranslation(new float[]{-0.213525,0.219,1.0});
...
Transform108.setTranslation(new float[]{0.262,0.267,1.0});
...
Transform114.setTranslation(new float[]{0.262,0.217,1.0});
Shape& Shape115 =  Shape();
Appearance& Appearance116 =  Appearance();
Material& Material117 =  Material();
Material117.setDiffuseColor(new float[]{0.0,0.0,0.0});
...
Transform120.setTranslation(new float[]{-0.438782,-0.385263,1.0});

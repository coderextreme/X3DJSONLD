...
WorldInfo9.setInfo(new CString[]{CString(", "), CString("Packaged by CosmoPackagePackaged by CosmoPackage")}, 2);
...
TimeSensor16.setStartTime(952972804.863);
...
Transform18.setDEF(CString("xform"));
Shape& Shape19 =  Shape();
...
IndexedFaceSet21.setColorIndex(new int[]{0,1,2,2,1,0,3,4,5,5,4,6}, 12);
...
Color22.setColor(new float[]{1,0.544676,0,1,0.347574,0,0.8,0.462602,0,1,0.719854,0,1,0.691608,0,1,0.456295,0,1,0.780794,0}, 21);
IndexedFaceSet21.setColor(&Color22);

Coordinate& Coordinate23 =  Coordinate();
Coordinate23.setPoint(new float[]{-0.2,0.0965052,-0.1,-0.3,0.0965052,0,-0.2,0.205105,0,-0.2,0.0965052,0.1,0.2,0.205105,0,0.2,0.0965052,-0.1,0.2,0.0965052,0.1,0.3,0.0965052,0,0,-0.302545,0}, 27);
...
ImageTexture30.setUrl(new CString[]{CString("bp-glow.png")}, 1);
...
IndexedFaceSet31.setTexCoordIndex(new int32_t[]{1,2,0,-1,2,3,0,-1}, 8);

...
Transform10.setDEF(CString("level0"));
Shape& Shape11 =  Shape();
PointSet& PointSet12 =  PointSet();
CColor& Color13 =  CColor();
Color13.setColor(new float[]{0.7,0,0.7}, 3);
PointSet12.setColor(&Color13);

Coordinate& Coordinate14 =  Coordinate();
Coordinate14.setPoint(new float[]{0,0,0}, 3);
PointSet12.setCoord(&Coordinate14);

Shape11.setGeometry(PointSet12);

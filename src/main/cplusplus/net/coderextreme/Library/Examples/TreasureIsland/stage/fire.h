...
meta3.setContent(CString("Thu, 05 Nov 2015 03:29:17 GMT"));
head1.addMeta(&meta3);
...
meta6.setContent(CString("Thu, 05 Nov 2015 03:29:17 GMT"));
head1.addMeta(&meta6);
...
Transform10.setDEF(CString("Fire"));
...
Transform20.setTranslation(new float[]{0.0,8.27842e-10,0.0});
Billboard& Billboard21 =  Billboard();
Transform& Transform22 =  Transform();
Transform22.setDEF(CString("Fire_1"));
Transform22.setTranslation(new float[]{0.0,-8.27842e-10,0.0});
...
Coordinate29.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
TextureCoordinate34.setPoint(new float[]{0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0}, 8);
IndexedFaceSet33.setTexCoord(&TextureCoordinate34);

Coordinate& Coordinate35 =  Coordinate();
Coordinate35.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
TextureCoordinate46.setPoint(new float[]{0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0}, 8);
IndexedFaceSet45.setTexCoord(&TextureCoordinate46);

Coordinate& Coordinate47 =  Coordinate();
Coordinate47.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
TextureCoordinate52.setPoint(new float[]{0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0}, 8);
IndexedFaceSet51.setTexCoord(&TextureCoordinate52);

Coordinate& Coordinate53 =  Coordinate();
Coordinate53.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
TextureCoordinate58.setPoint(new float[]{0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0}, 8);
IndexedFaceSet57.setTexCoord(&TextureCoordinate58);

Coordinate& Coordinate59 =  Coordinate();
Coordinate59.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
TextureCoordinate64.setPoint(new float[]{0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0}, 8);
IndexedFaceSet63.setTexCoord(&TextureCoordinate64);

Coordinate& Coordinate65 =  Coordinate();
Coordinate65.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
VisibilitySensor67.setSize(new float[]{1.0,1.0,1.0});

...
Color22.setColor(new float[]{1,0,0.155583,1,0,0.370293,0.8,0,0.612321,0.8,0.0151274,0.373652,1,0,0.462642,1,0.135478,0.337722,1,0,0.596723,1,0.0156003,0.918097,0.984243,0,1,1,0,0.646092,1,0,0.561501,1,0,0.819442}, 36);
IndexedFaceSet21.setColor(&Color22);

Coordinate& Coordinate23 =  Coordinate();
Coordinate23.setPoint(new float[]{-0.2,0.145225,-0.1,-0.3,0.145225,0,-0.2,0.253825,0,-0.2,0.145225,0.1,0.2,0.253825,0,0.2,0.145225,-0.1,0.2,0.145225,0.1,0.3,0.145225,0,0,-0.253825,0}, 27);
...
Color32.setColor(new float[]{0.8,0.198115,0,1,0.0603581,0}, 6);
IndexedFaceSet31.setColor(&Color32);

TextureCoordinate& TextureCoordinate33 =  TextureCoordinate();
TextureCoordinate33.setPoint(new float[]{0,0,1,0,1,1,0,1,1,0.5,0,0.5,0.5,1,0.5,0}, 16);
IndexedFaceSet31.setTexCoord(&TextureCoordinate33);

Coordinate& Coordinate34 =  Coordinate();
Coordinate34.setPoint(new float[]{-0.5,-0.502186,0,0.5,-0.502186,0,0.5,0.497814,0,-0.5,0.497814,0}, 12);

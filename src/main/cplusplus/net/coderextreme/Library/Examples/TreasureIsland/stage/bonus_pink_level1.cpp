...
ImageTexture17.setUrl(new CString[]{CString("bv-glow.png")}, 1);
...
Color19.setColor(new float[]{0.8,0.198115,0,1,0.0603581,0}, 6);
IndexedFaceSet18.setColor(&Color19);

TextureCoordinate& TextureCoordinate20 =  TextureCoordinate();
TextureCoordinate20.setPoint(new float[]{0,0,1,0,1,1,0,1,1,0.5,0,0.5,0.5,1,0.5,0}, 16);
IndexedFaceSet18.setTexCoord(&TextureCoordinate20);

Coordinate& Coordinate21 =  Coordinate();
Coordinate21.setPoint(new float[]{-0.5,-0.502186,0,0.5,-0.502186,0,0.5,0.497814,0,-0.5,0.497814,0}, 12);

...
TextureCoordinate15.setPoint(new float[]{0.28267,0,0.374974,0,0.374974,1,0.28267,1}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{-0.21733,-0.5,0,-0.125026,-0.5,0,-0.125026,0.5,0,-0.21733,0.5,0}, 12);

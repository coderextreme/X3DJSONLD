...
meta3.setContent(CString("Sat, 25 Apr 2015 12:38:16 GMT"));
head1.addMeta(&meta3);
...
meta6.setContent(CString("Sat, 25 Apr 2015 12:38:16 GMT"));
head1.addMeta(&meta6);
...
Transform9.setDEF(CString("a3on"));
Transform9.setTranslation(new float[]{0.0862359,0.114095,-0.299906});
Transform9.setScale(new float[]{0.163145,0.0203932,0.0318644});
Shape& Shape10 =  Shape();
Appearance& Appearance11 =  Appearance();
ImageTexture& ImageTexture12 =  ImageTexture();
ImageTexture12.setUrl(new CString[]{CString("menu-cam.png")}, 1);
...
Color14.setColor(new float[]{0.0,0.985749,1.0}, 3);
IndexedFaceSet13.setColor(&Color14);

TextureCoordinate& TextureCoordinate15 =  TextureCoordinate();
TextureCoordinate15.setPoint(new float[]{0.374974,0.0,0.467277,0.0,0.467277,1.0,0.374974,1.0}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{-0.125026,-0.5,0.0,-0.0327225,-0.5,0.0,-0.0327227,0.5,0.0,-0.125026,0.5,0.0}, 12);

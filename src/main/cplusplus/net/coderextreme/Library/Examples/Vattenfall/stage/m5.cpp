...
TextureCoordinate15.setPoint(new float[]{1,0.147102,1,0.294205,0,0.294205,0,0.147102}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{0.5,-0.352898,0,0.5,-0.205795,0,-0.5,-0.205795,0,-0.5,-0.352898,0}, 12);

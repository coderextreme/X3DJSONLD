...
TextureCoordinate14.setPoint(new float[]{0.999634,0.0149957,1.0,1.0,0.389588,1.0,0.612131,0.0149957}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate14);

Coordinate& Coordinate15 =  Coordinate();
Coordinate15.setPoint(new float[]{0.5,-0.5,0.0,0.5,0.5,0.0,-0.110412,0.5,0.0,0.112497,-0.5,0.0}, 12);

...
Transform9.setDEF(CString("c1on"));
...
TextureCoordinate15.setPoint(new float[]{0.623897,0,0.718658,0,0.718658,1,0.623897,1}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{0.123897,-0.5,0,0.218658,-0.5,0,0.218658,0.5,0,0.123897,0.5,0}, 12);

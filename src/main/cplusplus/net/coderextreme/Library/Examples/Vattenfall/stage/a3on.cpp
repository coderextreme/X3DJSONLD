...
TextureCoordinate15.setPoint(new float[]{0.374974,0,0.467277,0,0.467277,1,0.374974,1}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{-0.125026,-0.5,0,-0.0327225,-0.5,0,-0.0327227,0.5,0,-0.125026,0.5,0}, 12);

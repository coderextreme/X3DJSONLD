...
TextureCoordinate14.setPoint(new float[]{0.0000980757,0.0145581,0.0,1.0,0.38331,0.0145581,0.606851,1.0}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate14);

Coordinate& Coordinate15 =  Coordinate();
Coordinate15.setPoint(new float[]{-0.5,-0.5,0.0,-0.5,0.5,0.0,-0.116788,-0.5,0.0,0.106851,0.5,0.0}, 12);

...
TextureCoordinate15.setPoint(new float[]{0.467277,0.0,0.623897,0.0,0.623897,1.0,0.467277,1.0}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{-0.0327225,-0.5,0.0,0.123897,-0.5,0.0,0.123897,0.5,0.0,-0.0327227,0.5,0.0}, 12);

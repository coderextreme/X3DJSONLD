...
meta3.setContent(CString("Sat, 25 Apr 2015 12:38:14 GMT"));
head1.addMeta(&meta3);
...
meta6.setContent(CString("Sat, 25 Apr 2015 12:38:14 GMT"));
head1.addMeta(&meta6);
...
Transform9.setDEF(CString("a2on"));
...
TextureCoordinate15.setPoint(new float[]{0.28267,0.0,0.374974,0.0,0.374974,1.0,0.28267,1.0}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{-0.21733,-0.5,0.0,-0.125026,-0.5,0.0,-0.125026,0.5,0.0,-0.21733,0.5,0.0}, 12);

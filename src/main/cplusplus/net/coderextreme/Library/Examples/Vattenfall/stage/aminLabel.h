...
TextureCoordinate15.setPoint(new float[]{0.0,0.0,0.190368,0.0,0.190368,1.0,0.0,1.0}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{-0.5,-0.5,0.0,-0.309632,-0.5,0.0,-0.309632,0.5,0.0,-0.5,0.5,0.0}, 12);

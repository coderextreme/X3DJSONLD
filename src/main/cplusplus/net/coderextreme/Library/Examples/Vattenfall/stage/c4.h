...
TextureCoordinate15.setPoint(new float[]{1.0,0.0,1.0,1.0,0.902474,1.0,0.902474,0.0}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{0.5,-0.5,0.0,0.5,0.5,0.0,0.402474,0.5,0.0,0.402474,-0.5,0.0}, 12);

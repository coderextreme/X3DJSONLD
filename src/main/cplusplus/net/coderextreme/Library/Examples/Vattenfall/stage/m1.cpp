...
TextureCoordinate15.setPoint(new float[]{1,0.73711,1,0.887401,0,0.887401,0,0.73711}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{0.5,0.23711,0,0.5,0.387401,0,-0.5,0.387401,0,-0.5,0.23711,0}, 12);

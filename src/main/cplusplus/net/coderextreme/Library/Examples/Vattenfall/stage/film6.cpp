...
meta6.setContent(CString("Mon, 27 Apr 2015 08:52:30 GMT"));
head1.addMeta(&meta6);
...
MovieTexture11.setUrl(new CString[]{CString(", "), CString("film6.mp4, "), CString("film6.mpvhttp://titania.create3000.de/fileadmin/cobweb/videos/film6.mp4")}, 3);

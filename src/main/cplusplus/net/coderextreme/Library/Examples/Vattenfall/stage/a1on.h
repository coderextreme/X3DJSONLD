...
meta6.setContent(CString("Sat, 14 Nov 2015 11:32:03 GMT"));
head1.addMeta(&meta6);
...
ImageTexture19.setUrl(new CString[]{CString("menu-cam-on.png")}, 1);
...
Color21.setColor(new float[]{1.0,1.0,1.0}, 3);
IndexedFaceSet20.setColor(&Color21);

TextureCoordinate& TextureCoordinate22 =  TextureCoordinate();
TextureCoordinate22.setPoint(new float[]{0.190368,0.0,0.28267,0.0,0.28267,1.0,0.190368,1.0}, 8);
IndexedFaceSet20.setTexCoord(&TextureCoordinate22);

Coordinate& Coordinate23 =  Coordinate();
Coordinate23.setPoint(new float[]{-0.309632,-0.5,0.0,-0.21733,-0.5,0.0,-0.21733,0.5,0.0,-0.309632,0.5,0.0}, 12);

...
TextureCoordinate15.setPoint(new float[]{1.0,0.590405,1.0,0.73711,0.0,0.73711,0.0,0.590405}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{0.5,0.0904053,0.0,0.5,0.23711,0.0,-0.5,0.23711,0.0,-0.5,0.0904054,0.0}, 12);

...
TextureCoordinate15.setPoint(new float[]{1.0,0.294205,1.0,0.4437,0.0,0.4437,0.0,0.294205}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{0.5,-0.205795,0.0,0.5,-0.0562996,0.0,-0.5,-0.0562996,0.0,-0.5,-0.205795,0.0}, 12);

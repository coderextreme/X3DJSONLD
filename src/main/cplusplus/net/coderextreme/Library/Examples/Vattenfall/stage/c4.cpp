...
meta3.setContent(CString("Sat, 25 Apr 2015 12:38:19 GMT"));
head1.addMeta(&meta3);
...
meta6.setContent(CString("Sat, 25 Apr 2015 12:38:19 GMT"));
head1.addMeta(&meta6);
...
Transform9.setDEF(CString("c4on"));
Transform9.setTranslation(new float[]{0.0862364,0.114095,-0.299906});
...
Color14.setColor(new float[]{0,0.985749,1}, 3);
IndexedFaceSet13.setColor(&Color14);

TextureCoordinate& TextureCoordinate15 =  TextureCoordinate();
TextureCoordinate15.setPoint(new float[]{1,0,1,1,0.902474,1,0.902474,0}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate15);

Coordinate& Coordinate16 =  Coordinate();
Coordinate16.setPoint(new float[]{0.5,-0.5,0,0.5,0.5,0,0.402474,0.5,0,0.402474,-0.5,0}, 12);

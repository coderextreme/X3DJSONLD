...
Background14.setSkyColor(new float[]{1.0,1.0,1.0,0.35,0.65,0.65}, 6);
...
DirectionalLight15.setDirection(new float[]{0.0,-1.0,0.0});
...
DirectionalLight16.setDirection(new float[]{0.0,-1.0,0.0});

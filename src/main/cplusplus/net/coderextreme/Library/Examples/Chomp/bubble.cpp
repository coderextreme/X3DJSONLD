...
TimeSensor10.setDEF(CString("TimeSensor_bubble01-TIMER"));
...
PositionInterpolator15.setDEF(CString("Bubble01-POS-INTERP"));
PositionInterpolator15.setKey(new float[]{0,0.09375,0.1875,0.2813,0.375,0.4687,0.5625,0.6562,0.75,0.8437,0.9375,1}, 12);
PositionInterpolator15.setKeyValue(new float[]{0,0,0,0.5973,1.123,0,0.09513,2.519,0,-0.24,3.984,0,0.533,5.336,0,-0.04356,6.729,0,0.1768,8.286,0,0.4477,9.871,0,-0.02732,11.37,0,0.4801,13.07,0,0.6285,14.78,0,0.4446,15.91,0}, 36);
Transform14.addChild(&PositionInterpolator15);

Shape& Shape16 =  Shape();
Appearance& Appearance17 =  Appearance();
Material& Material18 =  Material();
Material18.setDiffuseColor(new float[]{0.4745,0.6784,0.7961});
...
IndexedFaceSet19.setDEF(CString("Bubble01-FACES"));
...
Coordinate20.setDEF(CString("Bubble01-COORD"));
...
ROUTE& ROUTE21 =  ROUTE();
ROUTE21.setFromNode(CString("Billboard_bubble01-TIMER"));
ROUTE21.setFromField(CString("fraction_changed"));
ROUTE21.setToNode(CString("Bubble01-POS-INTERP"));
ROUTE21.setToField(CString("set_fraction"));
Scene7.addChild(&ROUTE21);

ROUTE& ROUTE22 =  ROUTE();
ROUTE22.setFromNode(CString("TimeSensor_bubble01-TIMER"));
ROUTE22.setFromField(CString("fraction_changed"));
ROUTE22.setToNode(CString("Bubble01-POS-INTERP"));
ROUTE22.setToField(CString("set_fraction"));
Scene7.addChild(&ROUTE22);

ROUTE& ROUTE23 =  ROUTE();
ROUTE23.setFromNode(CString("Bubble01-POS-INTERP"));
ROUTE23.setFromField(CString("value_changed"));
ROUTE23.setToNode(CString("Bubble01-ROOT"));

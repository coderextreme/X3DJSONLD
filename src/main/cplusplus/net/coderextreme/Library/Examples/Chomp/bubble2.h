...
Transform14.setTranslation(new float[]{-0.1568,7.22,0.0});
...
PositionInterpolator15.setKey(new float[]{0.0,0.09375,0.1875,0.2813,0.375,0.5,0.5001,0.6562,0.75,0.8437,0.9375,1.0}, 12);
PositionInterpolator15.setKeyValue(new float[]{-0.1568,7.22,0.0,0.4111,8.834,0.0,0.2528,10.36,0.0,0.06727,11.92,0.0,0.6111,13.64,0.0,0.5617,15.34,0.0,0.4965,0.7224,0.0,0.4236,2.017,0.0,-0.3717,3.521,0.0,0.375,4.881,0.0,0.2019,6.257,0.0,-0.1568,7.22,0.0}, 36);
...
Coordinate20.setPoint(new float[]{0.0,0.6564,0.0,0.0,0.3282,-0.5685,-0.4923,0.3282,-0.2842,-0.4923,0.3282,0.2842,0.0,0.3282,0.5685,0.4923,0.3282,0.2842,0.4923,0.3282,-0.2842}, 21);

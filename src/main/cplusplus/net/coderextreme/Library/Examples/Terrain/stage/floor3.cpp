...
Transform25.setTranslation(new float[]{-50,0,-50});
Shape& Shape26 =  Shape();
...
ElevationGrid33.setHeight(new float[]{0,1,2,2,1,0,1,-1,-1,-2,1,1,-1,2,1,0,-1,-1,-2,-1,0,-1,-1,-2,-1,0,2,1,0,-1,0,1,2,2,1,0}, 36);
...
Background40.setSkyAngle(new float[]{2}, 1);
Background40.setSkyColor(new float[]{1,1,0,0,0,1}, 6);
...
Background42.setSkyColor(new float[]{1,1,0,0,0,1}, 6);
...
OrientationInterpolator44.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator44.setKeyValue(new float[]{0,0,1,0,1,0,0,3.14,1,0,0,6.28002}, 12);
...
OrientationInterpolator45.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator45.setKeyValue(new float[]{0,0,1,0,0,1,0,3.14,0,1,0,6.28002}, 12);
Scene8.addChild(&OrientationInterpolator45);

Transform& Transform46 =  Transform();
Transform46.setDEF(CString("K"));
Transform46.setTranslation(new float[]{0,10,0});
Viewpoint& Viewpoint47 =  Viewpoint();
Viewpoint47.setDEF(CString("View0"));
Viewpoint47.setPosition(new float[]{0,3,0});
...
DirectionalLight48.setDirection(new float[]{-1,-1,0});
Scene8.addChild(&DirectionalLight48);

DirectionalLight& DirectionalLight49 =  DirectionalLight();
DirectionalLight49.setDirection(new float[]{-1,-1,-1});
...
Transform68.setTranslation(new float[]{100,0,100});
...
Extrusion74.setScale(new float[]{1,1,0.95,0.95,0.00001,0.00001}, 6);
Extrusion74.setSpine(new float[]{0,0,0,0,10,0,0,11.5,0}, 9);
...
Extrusion77.setScale(new float[]{10,10,0.00001,0.00001}, 4);
Extrusion77.setSpine(new float[]{0,0,0,0,15,0}, 6);
...
Extrusion80.setScale(new float[]{0.00001,0.00001,10,10}, 4);
Extrusion80.setSpine(new float[]{0,0,0,0,15,0}, 6);

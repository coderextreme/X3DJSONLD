...
MetadataDouble1528.setValue(new double[]{0,0,5}, 3);
...
MetadataDouble1529.setValue(new double[]{0,0,1,0}, 4);
...
MetadataDouble1530.setValue(new double[]{0,0,0}, 3);
...
Viewpoint1533.setPosition(new float[]{0,0,5});
...
Transform1539.setRotation(new float[]{-0.145494,-0.989359,0,0.7418});
...
Transform1549.setRotation(new float[]{1,0,0,3.166});
Transform1549.setCenter(new float[]{0,0,1.94e-8});
...
Transform1587.setRotation(new float[]{0,0,1,0.3252});
Transform1587.setCenter(new float[]{0,0,-1.282e-8});
...
Transform1613.setCenter(new float[]{0,0,-5.221e-9});
...
Transform1626.setRotation(new float[]{0,0,1,0.7457});
Transform1626.setCenter(new float[]{0,0,-5.221e-9});
...
Transform1650.setTranslation(new float[]{0,0,-0.005423});
Transform& Transform1651 =  Transform();
Transform1651.setDEF(CString("nj"));
Transform1651.setScale(new float[]{0.96,0.96,1});
...
Transform1712.setTranslation(new float[]{-0.3425,0,-0.004982});
Transform& Transform1713 =  Transform();
Transform1713.setDEF(CString("yj"));
Transform1713.setScale(new float[]{0.72,0.72,1});
...
Transform1738.setTranslation(new float[]{-0.07406,0,-0.009982});
Transform& Transform1739 =  Transform();
Transform1739.setDEF(CString("Cj"));
Transform1739.setScale(new float[]{0.72,0.72,1});
...
Transform1764.setTranslation(new float[]{0.04629,0,-0.005});
Transform& Transform1765 =  Transform();
Transform1765.setDEF(CString("Gj"));
Transform1765.setScale(new float[]{0.72,0.72,1});
...
Transform1821.setRotation(new float[]{1,0,0,3.13});
Transform1821.setCenter(new float[]{0.253,0.2677,0});
...
Transform1845.setCenter(new float[]{0,0,-2.608e-8});
...
Transform1869.setCenter(new float[]{0,0,1.49e-8});
...
Transform1884.setRotation(new float[]{0,0,1,0.1762});
...
Box1945.setSize(new float[]{1,1,1});
...
Transform1946.setRotation(new float[]{0,0,1,4.711});
Transform1946.setScaleOrientation(new float[]{0,0,-1,0.120801});
...
Box1960.setSize(new float[]{1,1,1});
...
Transform1961.setRotation(new float[]{1,0,0,1.571});
...
Box1975.setSize(new float[]{1,1,1});
...
Transform1999.setRotation(new float[]{-0.145494,0.989359,0,0.7418});
...
Transform2094.setTranslation(new float[]{-1.192e-7,-0.006944,0});

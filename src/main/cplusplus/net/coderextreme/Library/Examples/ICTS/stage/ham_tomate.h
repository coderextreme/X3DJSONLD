...
Transform9.setDEF(CString("Tomate"));
Transform& Transform10 =  Transform();
Transform10.setDEF(CString("tomate"));
Transform10.setTranslation(new float[]{0.0118001,-0.0967947,-0.00506372});
Transform10.setRotation(new float[]{0.0,-1.0,0.0,1.05718});
Transform10.setScale(new float[]{1.0,0.999999,1.0});
...
Transform11.setTranslation(new float[]{0.00677532,0.0,0.0379922});
Transform11.setRotation(new float[]{-1.0,0.0,0.0,1.5708});
Transform11.setScale(new float[]{0.0809931,0.0809931,0.0809931});
Shape& Shape12 =  Shape();
Appearance& Appearance13 =  Appearance();
ImageTexture& ImageTexture14 =  ImageTexture();
ImageTexture14.setUrl(new CString[]{CString("tomate.jpg")}, 1);
...
Transform18.setTranslation(new float[]{0.0247079,-4.80884e-10,-0.0482792});
Transform18.setRotation(new float[]{0.0,-1.0,0.0,1.29688});
Transform18.setScale(new float[]{0.86924,0.86924,0.86924});
Transform& Transform19 =  Transform();
Transform19.setUSE(CString("_1"));

...
ProtoDeclare8.setName(CString("Translation"));
...
field& field16 =  field();
field16.setName(CString("translation"));
...
connect25.setProtoField(CString("translation"));
...
//_T("{")+
//_T("	value_changed = data.translation;")+
//_T("}"));

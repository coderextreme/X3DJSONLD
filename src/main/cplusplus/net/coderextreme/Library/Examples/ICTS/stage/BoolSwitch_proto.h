...
ProtoDeclare8.setName(CString("BoolSwitch"));
...
field& field15 =  field();
field15.setName(CString("wichChoice_changed"));
...
connect17.setNodeField(CString("isActive"));
connect17.setProtoField(CString("isActive"));
IS16.addChild(&connect17);

Connect& connect18 =  Connect();
connect18.setNodeField(CString("wichChoice_changed"));
connect18.setProtoField(CString("wichChoice_changed"));

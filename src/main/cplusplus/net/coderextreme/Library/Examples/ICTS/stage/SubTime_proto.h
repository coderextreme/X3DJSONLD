...
ProtoDeclare8.setName(CString("SubTime"));
...
field& field21 =  field();
field21.setName(CString("set_time"));
...
//_T("function set_time(value)")+
//_T("{")+
//_T("	value_changed = value - offset.time;")+
//_T("}"));
ProtoBody14.addChild(&Script20);

ROUTE& ROUTE31 =  ROUTE();
ROUTE31.setFromNode(CString("_2"));
ROUTE31.setFromField(CString("time_changed"));
ROUTE31.setToNode(CString("_time"));
ROUTE31.setToField(CString("set_time"));

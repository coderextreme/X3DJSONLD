...
field& field13 =  field();
field13.setName(CString("fraction_changed"));
...
field& field25 =  field();
field25.setName(CString("fraction_changed"));
...
connect33.setNodeField(CString("fraction_changed"));
connect33.setProtoField(CString("fraction_changed"));
...
_T("	{")+
_T("		fraction_changed = data.minValue + (Math.random() * (data.maxValue - data.minValue));")+
_T("	}")+
_T("	function  initialize()")+
_T("	{")+
_T("		if (data.startTime) set_startTime(0, 0);")+
_T("	}"));

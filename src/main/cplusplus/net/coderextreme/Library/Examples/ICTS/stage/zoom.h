...
Transform9.setTranslation(new float[]{0.0,0.0,0.005});
Transform9.setScale(new float[]{0.02726,0.02726,0.272602});
Shape& Shape10 =  Shape();
Appearance& Appearance11 =  Appearance();
ImageTexture& ImageTexture12 =  ImageTexture();
ImageTexture12.setUrl(new CString[]{CString("zoom.gif")}, 1);

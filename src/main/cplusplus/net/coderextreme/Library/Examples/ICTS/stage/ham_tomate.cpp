...
Transform10.setRotation(new float[]{0,-1,0,1.05718});
Transform10.setScale(new float[]{1,0.999999,1});
...
Transform11.setTranslation(new float[]{0.00677532,0,0.0379922});
...
Transform18.setRotation(new float[]{0,-1,0,1.29688});

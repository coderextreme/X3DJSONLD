...
Color15.setColor(new float[]{0.112299,0.473076,1,0.144385,0.354857,1}, 6);
...
Coordinate17.setPoint(new float[]{-0.230846,-0.066663,0,-0.230846,-0.193214,0,0.101703,-0.193214,0,0.101703,-0.066663,0}, 12);
...
TextureCoordinate23.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet22.setTexCoord(&TextureCoordinate23);

Coordinate& Coordinate24 =  Coordinate();
Coordinate24.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);

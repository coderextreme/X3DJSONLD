...
ProtoDeclare8.setName(CString("EnableTouch"));
...
Script14.setDEF(CString("_enableTouch"));
field& field15 =  field();
...
field& field16 =  field();
field16.setName(CString("isActive"));
...
connect19.setNodeField(CString("touchTime"));
connect19.setProtoField(CString("touchTime"));
IS18.addChild(&connect19);

Connect& connect20 =  Connect();
connect20.setNodeField(CString("isActive"));
connect20.setProtoField(CString("isActive"));

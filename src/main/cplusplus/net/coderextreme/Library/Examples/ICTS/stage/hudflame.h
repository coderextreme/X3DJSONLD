...
Transform15.setTranslation(new float[]{0.0,0.678885,0.0});
...
Coordinate54.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
TextureCoordinate60.setPoint(new float[]{0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0}, 8);
IndexedFaceSet59.setTexCoord(&TextureCoordinate60);

Coordinate& Coordinate61 =  Coordinate();
Coordinate61.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
TextureCoordinate67.setPoint(new float[]{0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0}, 8);
IndexedFaceSet66.setTexCoord(&TextureCoordinate67);

Coordinate& Coordinate68 =  Coordinate();
Coordinate68.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
Transform69.setTranslation(new float[]{-0.0734722,0.0,0.0});
Transform69.setScale(new float[]{0.853056,1.0,1.0});
Shape& Shape70 =  Shape();
...
TextureCoordinate75.setPoint(new float[]{0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0}, 8);
IndexedFaceSet74.setTexCoord(&TextureCoordinate75);

Coordinate& Coordinate76 =  Coordinate();
Coordinate76.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
PointLight78.setColor(new float[]{1.0,0.8,0.0});
PointLight78.setIntensity(0.9);
PointLight78.setAttenuation(new float[]{0.1,0.0,0.01});
PointLight78.setLocation(new float[]{0.0,0.497334,0.00961055});

...
Material12.setDiffuseColor(new float[]{0.0,0.0,0.0});
Material12.setEmissiveColor(new float[]{1.0,0.0552964,0.0});
...
Coordinate16.setPoint(new float[]{-0.230846,-0.066663,0.0,-0.230846,-0.193214,0.0,0.101703,-0.193214,0.0,0.101703,-0.066663,0.0}, 12);

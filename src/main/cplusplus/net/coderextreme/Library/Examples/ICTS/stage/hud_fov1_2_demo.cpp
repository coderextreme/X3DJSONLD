...
Transform9.setTranslation(new float[]{0,0.5,0});
ProximitySensor& ProximitySensor10 =  ProximitySensor();
ProximitySensor10.setDEF(CString("_1"));
ProximitySensor10.setSize(new float[]{100,10,100});
...
Transform11.setTranslation(new float[]{0,0.5,0});
...
Viewpoint14.setPosition(new float[]{0,0,0});
...
TextureCoordinate21.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet20.setTexCoord(&TextureCoordinate21);

Coordinate& Coordinate22 =  Coordinate();
Coordinate22.setPoint(new float[]{-1,-0.5,0,1,-0.5,0,1,0.5,0,-1,0.5,0}, 12);

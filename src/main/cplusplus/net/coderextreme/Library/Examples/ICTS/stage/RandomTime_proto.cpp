...
field& field13 =  field();
field13.setName(CString("randomTime"));
...
Script23.setDEF(CString("_randomTime"));
...
field& field25 =  field();
field25.setName(CString("randomTime"));
...
connect29.setNodeField(CString("minTime"));
connect29.setProtoField(CString("minTime"));
IS28.addChild(&connect29);

Connect& connect30 =  Connect();
connect30.setNodeField(CString("maxTime"));
connect30.setProtoField(CString("maxTime"));
...
connect33.setNodeField(CString("randomTime"));
connect33.setProtoField(CString("randomTime"));
...
_T("	{")+
_T("		randomTime = value + data.minTime + (Math.random() * (data.maxTime - data.minTime));")+
_T("	}")+
...
ROUTE34.setToNode(CString("_randomTime"));

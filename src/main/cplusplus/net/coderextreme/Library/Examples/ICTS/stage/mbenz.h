...
VisibilitySensor25.setCenter(new float[]{0.0,0.0,-0.298});
...
TextureCoordinate39.setPoint(new float[]{0.0,0.0,1.0,0.0,1.0,1.0,0.0,1.0}, 8);
IndexedFaceSet38.setTexCoord(&TextureCoordinate39);

Coordinate& Coordinate40 =  Coordinate();
Coordinate40.setPoint(new float[]{-0.5,-0.5,0.0,0.5,-0.5,0.0,0.5,0.5,0.0,-0.5,0.5,0.0}, 12);
...
Material46.setDiffuseColor(new float[]{0.0,0.0,0.0});
...
Coordinate48.setPoint(new float[]{-0.5,-0.5,0.0,-0.5,0.5,0.0,0.5,0.0,0.0,-0.489453,0.0,0.0,-1.48945,0.5,0.0,-1.48945,-0.5,0.0}, 18);
...
Material54.setDiffuseColor(new float[]{0.0,0.0,0.0});
...
Text& Text55 =  Text();
Text55.setString(new CString[]{CString(", "), CString("Hi, ich bin Else! Ich möchte gern mit Dir, "), CString("gemeinsam einen Ausflug in die Zukunft, "), CString("des Internet machen! Wenn Du mit mir, "), CString("mitgehst, kann ich Dir viele schöne und, "), CString("interessante Dinge zeigen! ")}, 6);
Text55.setLength(new float[]{0.0}, 1);
...
Material60.setDiffuseColor(new float[]{0.0,0.0,0.0});
...
Text& Text61 =  Text();
Text61.setString(new CString[]{CString(", "), CString("Wir befinden uns hier in einer, "), CString("Demonstration, die zu Anschauungs-, "), CString("zwecken erstellt wurde. Du kannst überall, "), CString("herumlaufen und Dich umschauen.Ich kann Dir erklären, wie das ...")}, 5);
Text61.setLength(new float[]{0.0}, 1);
...
Transform63.setTranslation(new float[]{-0.125224,0.0301585,-0.296962});
Transform63.setScale(new float[]{0.00272371,0.00272434,0.00272354});
Shape& Shape64 =  Shape();
Appearance& Appearance65 =  Appearance();
Material& Material66 =  Material();
Material66.setAmbientIntensity(0);
Material66.setDiffuseColor(new float[]{0.0,0.0,0.0});
...
Text& Text67 =  Text();
Text67.setString(new CString[]{CString(", "), CString("... geht: Klicke einfach mit Deiner Maus, "), CString("in die Mitte des Bildes und ziehe mit, "), CString("gedrückt gehaltener Maustaste, "), CString("in die Richtung, in die Du laufen möchtestoder benutze die Pfeiltasten.")}, 5);
Text67.setLength(new float[]{0.0}, 1);
...
ROUTE& ROUTE77 =  ROUTE();
ROUTE77.setFromNode(CString("_7"));
ROUTE77.setFromField(CString("whichChoice_changed"));

...
Transform9.setTranslation(new float[]{-0.0641994,0,0});
...
Transform13.setRotation(new float[]{0,1,0,4.71239});
...
TextureCoordinate18.setPoint(new float[]{0,0,1,0,1,1,0,1,1,0.5,0,0.5,1,0.25,0,0.25,0.271287,0.0518155,0.271287,0.418541,0.0469032,0.418541,0.0469032,0.0518155}, 24);
IndexedFaceSet17.setTexCoord(&TextureCoordinate18);

Coordinate& Coordinate19 =  Coordinate();
Coordinate19.setPoint(new float[]{-2,-0.487787,0,2,-0.487787,0,2,0.575824,0,-2,0.575824,0,2,0.480384,0,-2,0.480384,0,2,-0.390195,0,-2,-0.390195,0}, 24);
...
Transform20.setRotation(new float[]{0,1,0,4.71239});
...
Material23.setEmissiveColor(new float[]{0.0105023,0,0.255319});
...
Text24.setLength(new float[]{0}, 1);
...
Transform27.setRotation(new float[]{0,-1,0,1.5708});
...
Text31.setLength(new float[]{0}, 1);
...
Transform33.setRotation(new float[]{0,-1,0,1.5708});
...
Text37.setLength(new float[]{0}, 1);
...
Transform39.setRotation(new float[]{0,-1,0,1.5708});
...
Text43.setLength(new float[]{0}, 1);
...
Transform45.setRotation(new float[]{0,1,0,4.71239});
Transform45.setScale(new float[]{2.29482,0.793292,1});
Shape& Shape46 =  Shape();
...
TextureCoordinate50.setPoint(new float[]{0,0,1,0,1,1,0,1,1,0.5,0,0.5,1,0.25,0,0.25,0.271287,0.0518155,0.271287,0.418541,0.0469032,0.418541,0.0469032,0.0518155}, 24);
IndexedFaceSet49.setTexCoord(&TextureCoordinate50);

Coordinate& Coordinate51 =  Coordinate();
Coordinate51.setPoint(new float[]{-2,-0.487787,0,2,-0.487787,0,2,0.575824,0,-2,0.575824,0,2,0.480384,0,-2,0.480384,0,2,-0.390195,0,-2,-0.390195,0}, 24);

...
Inline10.setUrl(new CString[]{CString("else_demo__2.x3d")}, 1);
...
Inline19.setUrl(new CString[]{CString("window-mbenz.x3d")}, 1);
Inline19.setBboxSize(new float[]{1.288,0.8863,0.060779});
Inline19.setBboxCenter(new float[]{5.06639e-7,-2.23517e-7,-0.320511});
...
ProximitySensor22.setSize(new float[]{25.0,25.0,25.0});

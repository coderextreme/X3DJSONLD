...
Transform12.setTranslation(new float[]{-1.37383,0.503751,0.0});
Transform12.setRotation(new float[]{0.0,0.0,-1.0,1.5708});
Transform& Transform13 =  Transform();
Transform13.setDEF(CString("_1"));
Transform& Transform14 =  Transform();
Transform14.setTranslation(new float[]{0.0,0.0,6.63116});
Transform& Transform15 =  Transform();
Transform15.setDEF(CString("_2"));
Transform15.setScale(new float[]{1.0,2.98486,1.0});
Shape& Shape16 =  Shape();
Appearance& Appearance17 =  Appearance();
Material& Material18 =  Material();
Material18.setAmbientIntensity(0);
Material18.setDiffuseColor(new float[]{0.0,0.0,0.0});
...
Transform21.setTranslation(new float[]{0.0,0.0,2.57238});
...
Transform23.setTranslation(new float[]{0.0,0.0,-6.72781});
...
Transform25.setRotation(new float[]{0.0000398219,1.0,-0.0000398219,4.71239});
Transform25.setScaleOrientation(new float[]{0.0000361377,1.0,-0.0000237345,2.35619});
...
Transform27.setRotation(new float[]{0.0000398219,1.0,-0.0000398219,4.71239});
Transform27.setScaleOrientation(new float[]{0.0000361377,1.0,-0.0000237345,2.35619});

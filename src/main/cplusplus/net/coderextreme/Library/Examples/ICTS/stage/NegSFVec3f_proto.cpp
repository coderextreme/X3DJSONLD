...
ProtoDeclare8.setName(CString("NegSFVec3f"));
ProtoInterface& ProtoInterface9 =  ProtoInterface();
field& field10 =  field();
field10.setName(CString("set_SFVec3f"));
...
connect17.setNodeField(CString("set_SFVec3f"));
connect17.setProtoField(CString("set_SFVec3f"));
...
_T("function set_SFVec3f(value, time)")+
_T("{")+
_T("	value_changed = value.multiply(-1);")+
_T("}"));

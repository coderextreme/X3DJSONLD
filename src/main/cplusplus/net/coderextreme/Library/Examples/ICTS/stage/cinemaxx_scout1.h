...
Inline10.setUrl(new CString[]{CString("else_demo.x3d")}, 1);
Inline10.setBboxSize(new float[]{8.02745,8.02745,8.02745});
...
Inline19.setUrl(new CString[]{CString("window-cinemaxx.x3d")}, 1);

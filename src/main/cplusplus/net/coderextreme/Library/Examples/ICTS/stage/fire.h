...
Transform20.setRotation(new float[]{1.0,0.0,0.0,0.207709});
Transform20.setScale(new float[]{1.98355,1.0,1.0});
Transform& Transform21 =  Transform();
Transform21.setTranslation(new float[]{0.0362256,0.901673,1.68843});
Transform21.setRotation(new float[]{1.0,0.0,0.0,1.65743});
...
Transform28.setScale(new float[]{0.504147,1.0,1.0});
Shape& Shape29 =  Shape();
...
Transform35.setScale(new float[]{0.504147,1.0,1.0});
Shape& Shape36 =  Shape();
...
VisibilitySensor49.setSize(new float[]{1.0,1.0,1.0});
VisibilitySensor49.setCenter(new float[]{0.0,1.0,0.0});

...
ProtoDeclare8.setName(CString("Time"));
...
connect26.setNodeField(CString("startTime"));
connect26.setProtoField(CString("startTime"));
IS25.addChild(&connect26);

Connect& connect27 =  Connect();
connect27.setNodeField(CString("time"));
connect27.setProtoField(CString("time"));
...
ROUTE30.setToNode(CString("_time"));

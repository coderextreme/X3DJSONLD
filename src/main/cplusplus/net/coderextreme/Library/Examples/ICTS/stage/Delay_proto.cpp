...
field& field29 =  field();
field29.setName(CString("set_time"));
...
TimeSensor31.setDEF(CString("_2"));
IS& IS32 =  IS();
...
ProtoInstance35.setDEF(CString("_3"));
IS& IS36 =  IS();
...
_T("	timeSensor.startTime = time + data.cycleInterval;")+
_T("}")+

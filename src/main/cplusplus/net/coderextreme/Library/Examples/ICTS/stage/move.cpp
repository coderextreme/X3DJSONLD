...
Transform9.setTranslation(new float[]{0,0,0.005});
Transform9.setScale(new float[]{0.0313628,0.0313628,0.31363});
Shape& Shape10 =  Shape();
Appearance& Appearance11 =  Appearance();
ImageTexture& ImageTexture12 =  ImageTexture();
ImageTexture12.setUrl(new CString[]{CString("move.gif")}, 1);
...
TextureCoordinate14.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet13.setTexCoord(&TextureCoordinate14);

Coordinate& Coordinate15 =  Coordinate();
Coordinate15.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);

...
Transform9.setDEF(CString("on"));
Transform9.setTranslation(new float[]{0.183659,0.0636474,-0.296069});
Transform9.setScale(new float[]{0.0162762,0.0162762,0.162762});
Shape& Shape10 =  Shape();
Appearance& Appearance11 =  Appearance();
ImageTexture& ImageTexture12 =  ImageTexture();
ImageTexture12.setUrl(new CString[]{CString("close.gif")}, 1);

...
Transform14.setTranslation(new float[]{0,0.0057869,0});
...
Transform22.setTranslation(new float[]{2.56114e-9,-0.000322939,0});
Transform22.setScale(new float[]{0.999999,0.999999,0.999999});
Transform22.setCenter(new float[]{0,0.00213197,0});
Group& Group23 =  Group();
Group& Group24 =  Group();
...
OrientationInterpolator26.setKey(new float[]{0}, 1);
OrientationInterpolator26.setKeyValue(new float[]{0,0,1,0}, 4);
...
OrientationInterpolator27.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator27.setKeyValue(new float[]{0,0,1,0,0,0,1,1.5708,0,0,1,3.14159}, 12);
...
PositionInterpolator28.setKey(new float[]{0,0.5,1}, 3);
PositionInterpolator28.setKeyValue(new float[]{2.56114e-9,-0.000322939,0,2.56114e-9,0.00155101,0,2.56114e-9,0.00342495,0}, 9);
...
OrientationInterpolator32.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator32.setKeyValue(new float[]{0,0,1,3.14159,0,0,1,1.5708,0,0,1,0}, 12);
...
PositionInterpolator33.setKey(new float[]{0,0.5,1}, 3);
PositionInterpolator33.setKeyValue(new float[]{2.56114e-9,0.00342495,0,2.56114e-9,0.00155101,0,2.56114e-9,-0.000322939,0}, 9);
...
Transform34.setCenter(new float[]{0.109583,0.00336227,0});
...
Transform36.setRotation(new float[]{-1,-1.45502e-8,-1.67461e-7,1.57079});
Transform36.setScale(new float[]{0.2083,0.313,0.313});
Transform36.setScaleOrientation(new float[]{1,-9.19798e-14,-5.94339e-14,4.71239});
Shape& Shape37 =  Shape();
...
Transform45.setRotation(new float[]{-1,-1.4552e-8,-1.67464e-7,1.57076});
Transform45.setScale(new float[]{0.2083,0.313,0.313});
Transform45.setScaleOrientation(new float[]{1,-1.33242e-12,-3.23498e-13,4.71239});
Shape& Shape46 =  Shape();
...
TextureCoordinate50.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet49.setTexCoord(&TextureCoordinate50);

Coordinate& Coordinate51 =  Coordinate();
Coordinate51.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);
...
Transform52.setTranslation(new float[]{2.56114e-9,0.00248178,0});
Transform52.setScale(new float[]{1,1,0.999999});
Transform52.setCenter(new float[]{0,0.00213197,0});
Group& Group53 =  Group();
Group& Group54 =  Group();
...
OrientationInterpolator56.setKey(new float[]{0}, 1);
OrientationInterpolator56.setKeyValue(new float[]{0,0,1,0}, 4);
...
OrientationInterpolator57.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator57.setKeyValue(new float[]{0,0,1,0,0,0,1,1.5708,0,0,1,3.14159}, 12);
...
PositionInterpolator58.setKeyValue(new float[]{2.56114e-9,0.00248178,0,2.56114e-9,0.00216769,0,2.56114e-9,0.00185361,0}, 9);
...
OrientationInterpolator62.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator62.setKeyValue(new float[]{0,0,1,3.14159,0,0,1,1.5708,0,0,1,0}, 12);
...
PositionInterpolator63.setKey(new float[]{0,0.5,1}, 3);
PositionInterpolator63.setKeyValue(new float[]{2.56114e-9,0.00185361,0,2.56114e-9,0.00216769,0,2.56114e-9,0.00248178,0}, 9);
...
Transform64.setCenter(new float[]{0.109583,0.00336227,0});
...
Transform66.setRotation(new float[]{-1,-1.45502e-8,-1.67461e-7,1.57079});
Transform66.setScale(new float[]{0.2083,0.313,0.313});
Transform66.setScaleOrientation(new float[]{1,-9.19798e-14,-5.94339e-14,4.71239});
Shape& Shape67 =  Shape();
...
TextureCoordinate71.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet70.setTexCoord(&TextureCoordinate71);

Coordinate& Coordinate72 =  Coordinate();
Coordinate72.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);
...
Transform75.setRotation(new float[]{-1,-1.455e-8,-1.67461e-7,1.57079});
Transform75.setScale(new float[]{0.2083,0.313,0.313});
Transform75.setScaleOrientation(new float[]{1,-1.79204e-13,6.48902e-14,4.71239});
Shape& Shape76 =  Shape();
...
Coordinate81.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);
...
Transform82.setTranslation(new float[]{2.56114e-9,0.00455024,0});
Transform82.setScale(new float[]{1,1,0.999999});
Transform82.setCenter(new float[]{0,0.00213197,0});
Group& Group83 =  Group();
Group& Group84 =  Group();
...
OrientationInterpolator86.setKey(new float[]{0}, 1);
OrientationInterpolator86.setKeyValue(new float[]{0,0,1,0}, 4);
...
OrientationInterpolator87.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator87.setKeyValue(new float[]{0,0,1,0,0,0,1,1.5708,0,0,1,3.14159}, 12);
...
PositionInterpolator88.setKeyValue(new float[]{2.56114e-9,0.00455024,0,2.56113e-9,0.00265246,0,2.56113e-9,0.00075468,0}, 9);
...
OrientationInterpolator92.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator92.setKeyValue(new float[]{0,0,1,3.14159,0,0,1,1.5708,0,0,1,0}, 12);
...
PositionInterpolator93.setKey(new float[]{0,0.5,1}, 3);
PositionInterpolator93.setKeyValue(new float[]{2.56113e-9,0.00075468,0,2.56113e-9,0.00265246,0,2.56114e-9,0.00455024,0}, 9);
...
Transform94.setCenter(new float[]{0.109583,0.00336227,0});
...
Transform96.setRotation(new float[]{-1,-1.45502e-8,-1.67461e-7,1.57079});
Transform96.setScale(new float[]{0.2083,0.313,0.313});
Transform96.setScaleOrientation(new float[]{1,-8.7009e-14,-3.81901e-14,4.71239});
Shape& Shape97 =  Shape();
...
Coordinate102.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);
...
Transform105.setRotation(new float[]{-1,-1.45527e-8,-1.67465e-7,1.57074});
Transform105.setScale(new float[]{0.2083,0.313,0.313});
Transform105.setScaleOrientation(new float[]{1,-1.54436e-12,-2.75076e-13,4.71239});
...
Coordinate111.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);
...
Transform112.setTranslation(new float[]{2.56114e-9,0.00645655,0});
Transform112.setScale(new float[]{1,1,0.999999});
Transform112.setCenter(new float[]{0,0.00213197,0});
...
OrientationInterpolator116.setKey(new float[]{0}, 1);
OrientationInterpolator116.setKeyValue(new float[]{0,0,1,0}, 4);
...
OrientationInterpolator117.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator117.setKeyValue(new float[]{0,0,1,0,0,0,1,1.5708,0,0,1,3.14159}, 12);
...
PositionInterpolator118.setKey(new float[]{0,0.5,1}, 3);
PositionInterpolator118.setKeyValue(new float[]{2.56114e-9,0.00645655,0,-1.22092e-9,0.00277808,0,-5.00297e-9,-0.00090039,0}, 9);
...
OrientationInterpolator122.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator122.setKeyValue(new float[]{0,0,1,3.14159,0,0,1,1.5708,0,0,1,0}, 12);
...
PositionInterpolator123.setKey(new float[]{0,0.5,1}, 3);
PositionInterpolator123.setKeyValue(new float[]{-5.00297e-9,-0.00090039,0,-1.22092e-9,0.00277808,0,2.56114e-9,0.00645655,0}, 9);
...
Transform124.setCenter(new float[]{0.109583,0.00336227,0});
...
Transform126.setRotation(new float[]{-1,-1.45502e-8,-1.67461e-7,1.57079});
Transform126.setScale(new float[]{0.2083,0.313,0.313});
Transform126.setScaleOrientation(new float[]{1,-9.19798e-14,-5.94339e-14,4.71239});
...
TextureCoordinate131.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet130.setTexCoord(&TextureCoordinate131);

Coordinate& Coordinate132 =  Coordinate();
Coordinate132.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);
...
Transform135.setRotation(new float[]{-1,-1.45501e-8,-1.67461e-7,1.57079});
Transform135.setScale(new float[]{0.2083,0.313,0.313});
Transform135.setScaleOrientation(new float[]{1,-2.06631e-13,8.62823e-14,4.71239});
...
Coordinate141.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);
...
Transform142.setTranslation(new float[]{0,1,0});
...
Transform144.setTranslation(new float[]{0,1,0});
...
Transform146.setRotation(new float[]{-1,-1.45521e-8,-1.67464e-7,1.57076});
Transform146.setScale(new float[]{0.2083,0.313,0.313});
Transform146.setScaleOrientation(new float[]{1,-1.415e-12,-3.57256e-13,4.71239});
...
Coordinate152.setPoint(new float[]{-0.5,-0.5,0,0.5,-0.5,0,0.5,0.5,0,-0.5,0.5,0}, 12);

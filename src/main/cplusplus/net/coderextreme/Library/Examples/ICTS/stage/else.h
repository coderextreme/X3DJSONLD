...
Transform9.setTranslation(new float[]{-0.240425,-0.171864,-0.297753});
Transform9.setScale(new float[]{0.0412831,0.0412831,0.412834});
Shape& Shape10 =  Shape();
Appearance& Appearance11 =  Appearance();
ImageTexture& ImageTexture12 =  ImageTexture();
ImageTexture12.setUrl(new CString[]{CString("else.gif")}, 1);

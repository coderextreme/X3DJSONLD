...
LOD& LOD25 =  LOD();
LOD25.setRange(new float[]{10.0}, 1);
...
Transform28.setTranslation(new float[]{2.44177e-8,-1.39698e-9,0.0});
Transform28.setScale(new float[]{0.487699,0.487699,0.487699});
Transform28.setCenter(new float[]{0.0,0.00560371,0.0});
Transform& Transform29 =  Transform();
Transform29.setDEF(CString("shadow"));
Transform29.setTranslation(new float[]{0.0,0.00560371,0.0});
Transform29.setRotation(new float[]{-1.0,0.0,0.0,1.5708});
...
Transform40.setRotation(new float[]{0.0,-1.0,0.0,1.5708});
...
Material43.setEmissiveColor(new float[]{0.0957447,0.0,0.0042168});
...
Material50.setDiffuseColor(new float[]{0.0,0.0,0.0});
Material50.setEmissiveColor(new float[]{1.0,0.0,0.0440421});
...
Transform55.setTranslation(new float[]{0.0,0.162414,0.0});
...
Transform56.setScale(new float[]{0.999997,1.0,1.0});
...
Transform57.setScale(new float[]{0.999999,1.0,0.999997});
...
Transform58.setScale(new float[]{0.999997,1.0,0.999999});
...
Material61.setEmissiveColor(new float[]{0.117021,0.0,0.00515386});
...
Transform66.setScale(new float[]{1.0,0.999999,1.0});
Transform66.setScaleOrientation(new float[]{1.04347e-8,1.0,5.17544e-9,1.5708});
Shape& Shape67 =  Shape();
...
Transform74.setScale(new float[]{1.0,0.999999,1.0});
Transform74.setScaleOrientation(new float[]{8.9523e-9,1.0,7.03487e-9,1.5708});
Shape& Shape75 =  Shape();
...
Transform83.setScale(new float[]{0.999999,1.0,0.999997});
...
Transform84.setScale(new float[]{0.999999,1.0,0.999998});
...
Transform92.setScale(new float[]{1.0,0.999999,1.0});
Transform92.setScaleOrientation(new float[]{1.14369e-8,1.0,5.95853e-9,1.5708});
Shape& Shape93 =  Shape();
...
Transform100.setScale(new float[]{1.0,0.999999,1.0});
Transform100.setScaleOrientation(new float[]{1.00532e-8,1.0,9.24515e-9,1.5708});
...
TextureCoordinate106.setPoint(new float[]{0.663162,1.14776,0.762388,0.822301,0.751572,0.822301,0.406698,0.87573,0.212002,1.09871,0.424232,0.87573,0.751572,0.171594,0.762388,0.171594,0.28043,0.171594,0.0,0.171594,0.297908,0.171594,0.435576,0.0}, 24);
...
Transform108.setTranslation(new float[]{0.0,0.857361,0.0});
...
Transform122.setRotation(new float[]{0.0,1.0,0.0,4.71239});
...
Inline132.setBboxSize(new float[]{1.0,1.0,1.0});

...
Inline40.setBboxSize(new float[]{0.0412831,0.0412831,0});
...
PlaneSensor43.setMinPosition(new float[]{-0.17,0});
PlaneSensor43.setMaxPosition(new float[]{0.1488,0});
...
Transform45.setTranslation(new float[]{-0.0746069,-0.133511,0});
...
Inline47.setBboxSize(new float[]{0.0111772,0.0107642,0});
...
Inline55.setBboxSize(new float[]{0.000743108,0.000743108,0});
Inline55.setBboxCenter(new float[]{0,0,0.00636301});
...
PlaneSensor67.setOffset(new float[]{-0.0746069,-0.133511,0});
...
Transform69.setTranslation(new float[]{-0.0746069,-0.133511,0});
...
Transform80.setScale(new float[]{1.11103,1.2214,1});
Shape& Shape81 =  Shape();
...
Coordinate83.setPoint(new float[]{-0.230846,-0.066663,0,-0.230846,-0.193214,0,0.101703,-0.193214,0,0.101703,-0.066663,0}, 12);
...
Coordinate88.setPoint(new float[]{-0.230846,-0.066663,0,-0.230846,-0.193214,0,0.101703,-0.193214,0,0.101703,-0.066663,0}, 12);
...
Inline95.setBboxSize(new float[]{0.0111772,0.0107642,0});
...
Inline100.setBboxSize(new float[]{0.0162762,0.0162762,0});
...
Inline110.setBboxSize(new float[]{0.0313628,0.0313628,0});
Inline110.setBboxCenter(new float[]{0,0,0.005});
...
Coordinate140.setPoint(new float[]{-0.230846,-0.066663,0,-0.230846,-0.193214,0,0.101703,-0.193214,0,0.101703,-0.066663,0}, 12);

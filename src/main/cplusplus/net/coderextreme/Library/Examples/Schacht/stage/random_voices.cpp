...
VisibilitySensor19.setSize(new float[]{1,1,1});
...
VisibilitySensor24.setSize(new float[]{1,1,1});
...
VisibilitySensor29.setSize(new float[]{1,1,1});
...
VisibilitySensor34.setSize(new float[]{1,1,1});

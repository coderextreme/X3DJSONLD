...
Viewpoint50.setPosition(new float[]{0,0,20});
...
Material64.setDiffuseColor(new float[]{0.8,0.1,0});
...
Material73.setDiffuseColor(new float[]{0,0.8,0.2});
...
Material84.setDiffuseColor(new float[]{0.2,0.2,1});

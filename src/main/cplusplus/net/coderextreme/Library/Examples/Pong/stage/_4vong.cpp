...
Coordinate21.setPoint(new float[]{-1,-1,0,-1,1,0,1,1,0,1,-1,0}, 12);
...
PlaneSensor69.setOffset(new float[]{0,0.617632,0});
PlaneSensor69.setMinPosition(new float[]{0,-4});
PlaneSensor69.setMaxPosition(new float[]{0,4});
...
Transform89.setTranslation(new float[]{-3.5,3,-0.2});
...
Coordinate94.setPoint(new float[]{-1,-1,0,-1,1,0,1,1,0,1,-1,0}, 12);
...
Transform95.setTranslation(new float[]{3.5,3,-0.2});
...
Coordinate100.setPoint(new float[]{-1,-1,0,-1,1,0,1,1,0,1,-1,0}, 12);
...
DirectionalLight102.setDirection(new float[]{0,-1,0});
...
Background106.setSkyColor(new float[]{1,1,0,0,0,1}, 6);
...
OrientationInterpolator108.setKey(new float[]{0,0.5,1}, 3);
OrientationInterpolator108.setKeyValue(new float[]{0,0,1,0,1,0,0,3.14,1,0,0,6.28002}, 12);
...
Viewpoint109.setPosition(new float[]{0,0,0});
...
ProximitySensor110.setSize(new float[]{200,200,200});
...
PositionInterpolator112.setKey(new float[]{0,1}, 2);
PositionInterpolator112.setKeyValue(new float[]{0,1,0,0,-1,0}, 6);
...
PositionInterpolator113.setKey(new float[]{0,1}, 2);
PositionInterpolator113.setKeyValue(new float[]{4.8,5.48778,0,-4.8,2.26548,0}, 6);

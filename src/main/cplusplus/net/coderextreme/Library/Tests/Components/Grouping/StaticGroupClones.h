...
Transform14.setTranslation(new float[]{-3.0,0.0,0.0});
Shape& Shape15 =  Shape();
Shape15.setDEF(CString("_1"));
Appearance& Appearance16 =  Appearance();
Material& Material17 =  Material();
Material17.setDiffuseColor(new float[]{0.8,0.0,0.0});
...
Transform19.setTranslation(new float[]{-1.0,0.0,0.0});
Shape& Shape20 =  Shape();
...
Transform21.setTranslation(new float[]{1.0,0.0,0.0});
Shape& Shape22 =  Shape();
...
Transform23.setTranslation(new float[]{3.0,0.0,0.0});
Shape& Shape24 =  Shape();
...
Transform26.setTranslation(new float[]{-3.0,-2.0,0.0});
Shape& Shape27 =  Shape();
Appearance& Appearance28 =  Appearance();
Appearance28.setDEF(CString("_2"));
Material& Material29 =  Material();
Material29.setDiffuseColor(new float[]{1.0,0.8509804,0.4});
...
Transform31.setTranslation(new float[]{-1.0,-2.0,0.0});
Shape& Shape32 =  Shape();
...
Transform35.setTranslation(new float[]{1.0,-2.0,0.0});
Shape& Shape36 =  Shape();
...
Transform39.setTranslation(new float[]{3.0,-2.0,0.0});
Shape& Shape40 =  Shape();

...
Material26.setEmissiveColor(new float[]{1.0,1.0,1.0});
...
Coordinate28.setPoint(new float[]{4.0,6.0,0.0,7.0,12.0,0.0,11.0,6.0,0.0,15.0,2.0,0.0,20.0,6.0,0.0}, 15);
...
Viewpoint29.setPosition(new float[]{11.0,4.6,18.0});
...
NurbsPositionInterpolator31.setKnot(new double[]{0.0,0.25,0.5,0.75,1.0}, 5);
Coordinate& Coordinate32 =  Coordinate();
Coordinate32.setDEF(CString("_3"));
Coordinate32.setPoint(new float[]{4.0,6.0,0.0,7.0,12.0,0.0,11.0,6.0,0.0,15.0,2.0,0.0,20.0,6.0,0.0}, 15);
...
NurbsOrientationInterpolator33.setKnot(new double[]{0.0,0.25,0.5,0.75,1.0}, 5);
...
Transform35.setTranslation(new float[]{12.6002,4.57153,0.0});
Transform35.setRotation(new float[]{0.68202330039387,0.731330443588842,0.0,1.57048490427067});

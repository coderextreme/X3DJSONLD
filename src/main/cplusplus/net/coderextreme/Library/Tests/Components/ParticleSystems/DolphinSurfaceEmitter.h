...
meta6.setContent(CString("file:///home/holger/Projekte/Cobweb/excite/tests/Components/ParticleSystems/DolphinSurfaceEmitter.x3d"));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(CString("modified"));
meta7.setContent(CString("Sat, 30 Apr 2016 11:54:15 GMT"));
head1.addMeta(&meta7);
...
TimeSensor34.setDEF(CString("_2"));
...
ParticleSystem36.setGeometryType(CString("SPRITE"));
ParticleSystem36.setMaxParticles(2000);
ParticleSystem36.setParticleLifetime(1);
...
ProtoInstance38.setUSE(CString("_1"));

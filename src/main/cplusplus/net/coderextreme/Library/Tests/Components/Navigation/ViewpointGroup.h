...
Viewpoint15.setPosition(new float[]{0.0,0.0,25.0});
...
Viewpoint16.setPosition(new float[]{0.0,0.0,30.0});
...
Transform17.setScale(new float[]{35.0,35.0,35.0});
Shape& Shape18 =  Shape();
Appearance& Appearance19 =  Appearance();
Material& Material20 =  Material();
Material20.setDiffuseColor(new float[]{0.5,0.0,1.0});

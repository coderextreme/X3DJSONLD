...
MetadataFloat22.setValue(new float[]{1,0,0,1.5708}, 4);
...
MetadataFloat37.setValue(new float[]{1,0,0,1.5708}, 4);
...
MetadataFloat38.setValue(new float[]{0,-1,-0.00000363588}, 3);
...
Transform43.setTranslation(new float[]{0.999976,-0.000498056,0});
Transform43.setCenter(new float[]{-5.99998,4.0005,-1.36914e-7});
Transform& Transform44 =  Transform();
Transform44.setTranslation(new float[]{-6,4,-1.36914e-7});
Shape& Shape45 =  Shape();
...
Transform50.setTranslation(new float[]{-6,4,-1.36914e-7});
Shape& Shape51 =  Shape();
...
Transform57.setTranslation(new float[]{-2,4,-1.36914e-7});
Shape& Shape58 =  Shape();
...
Transform62.setTranslation(new float[]{2,4,-1.36914e-7});
Shape& Shape63 =  Shape();
...
Transform67.setTranslation(new float[]{5,4,-1.36914e-7});
Shape& Shape68 =  Shape();
...
TriangleSet2D70.setVertices(new float[]{-1,-1,1,-1,0,1}, 6);
...
Transform73.setTranslation(new float[]{-5,0,0});
...
Material82.setSpecularColor(new float[]{0.176503,0.0894282,0});
...
Transform85.setTranslation(new float[]{-2,0,0});
Shape& Shape86 =  Shape();
...
Transform91.setTranslation(new float[]{2,0,0});
Shape& Shape92 =  Shape();
...
Transform97.setTranslation(new float[]{5,0,0});
Shape& Shape98 =  Shape();
...
Material100.setSpecularColor(new float[]{1,0.464407,0.4753});
...
Transform104.setTranslation(new float[]{-5,-3,1.02686e-7});
...
Transform110.setTranslation(new float[]{-5.00105,-0.000807524,0});
Transform110.setCenter(new float[]{3.00105,-2.99919,1.02686e-7});
Transform& Transform111 =  Transform();
Transform111.setTranslation(new float[]{3,-3,1.02686e-7});
...
Transform117.setTranslation(new float[]{3,-3,1.02686e-7});
...
Transform123.setTranslation(new float[]{0,-3,1.02686e-7});
...
Transform130.setTranslation(new float[]{-5,-6,2.05371e-7});
...
Transform136.setTranslation(new float[]{-2,-6,2.05371e-7});
...
Transform142.setTranslation(new float[]{2,-3,-0.0000109853});
...
Polyline2D147.setLineSegments(new float[]{0,0,1,2,2,1,4,3,10,0}, 10);
...
Transform148.setTranslation(new float[]{5,-5,-0.0000183347});
...
NormalInterpolator150.setKey(new float[]{0,0.25,0.5,0.75,1}, 5);
NormalInterpolator150.setKeyValue(new float[]{1,0,0,0,1,0,-1,0,0,0,-1,0,0,1,0,-1,0,0,0,-1,0,1,0,0,-1,0,0,0,-1,0,1,0,0,0,1,0,0,-1,0,1,0,0,0,1,0,-1,0,0,1,0,0,0,1,0,-1,0,0,0,-1,0}, 60);
Transform148.addChild(&NormalInterpolator150);

Transform& Transform151 =  Transform();
Transform151.setDEF(CString("PointSet"));
Transform151.setScale(new float[]{3,3,3});
...
Coordinate157.setPoint(new float[]{0.419056,-0.907961,0,0.907961,0.419056,0,-0.419056,0.907961,0,-0.907961,-0.419056,0}, 12);
...
Transform158.setTranslation(new float[]{2,-6,-0.0000220094});
...
MetadataFloat171.setValue(new float[]{1,0,0,1.5708}, 4);
...
MetadataFloat176.setValue(new float[]{1,0.7,0.7,0.0588235}, 4);
...
Transform180.setTranslation(new float[]{-1.6905,0.955504,-1});
...
Transform193.setTranslation(new float[]{1.6905,-0.857496,-1});
...
Material196.setDiffuseColor(new float[]{0,0,0});
...
Transform199.setTranslation(new float[]{1.6905,-0.955496,-1});
...
Transform205.setTranslation(new float[]{0.436176,-0.916146,0});
...
TextureCoordinate210.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet209.setTexCoord(&TextureCoordinate210);

Coordinate& Coordinate211 =  Coordinate();
Coordinate211.setPoint(new float[]{-1,-1,0,1,-1,0,1,1,0,-1,1,0}, 12);
...
Transform213.setTranslation(new float[]{0.77569,-0.916146,0});
...
TextureCoordinate218.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet217.setTexCoord(&TextureCoordinate218);

Coordinate& Coordinate219 =  Coordinate();
Coordinate219.setPoint(new float[]{-1,-1,0,1,-1,0,1,1,0,-1,1,0}, 12);
...
Transform221.setTranslation(new float[]{1.04432,-0.916146,0});
...
TextureCoordinate226.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet225.setTexCoord(&TextureCoordinate226);

Coordinate& Coordinate227 =  Coordinate();
Coordinate227.setPoint(new float[]{-1,-1,0,1,-1,0,1,1,0,-1,1,0}, 12);
...
Transform229.setTranslation(new float[]{1.27986,-0.916146,0});
...
TextureCoordinate234.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet233.setTexCoord(&TextureCoordinate234);

Coordinate& Coordinate235 =  Coordinate();
Coordinate235.setPoint(new float[]{-1,-1,0,1,-1,0,1,1,0,-1,1,0}, 12);
...
Transform237.setTranslation(new float[]{1.55457,-0.916146,0});
...
TextureCoordinate242.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
IndexedFaceSet241.setTexCoord(&TextureCoordinate242);

Coordinate& Coordinate243 =  Coordinate();
Coordinate243.setPoint(new float[]{-1,-1,0,1,-1,0,1,1,0,-1,1,0}, 12);

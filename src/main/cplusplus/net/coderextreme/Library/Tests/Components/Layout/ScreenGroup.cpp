...
Transform20.setScale(new float[]{2,1,1});
Transform20.setScaleOrientation(new float[]{0,0,1,0.785398});
...
Material25.setDiffuseColor(new float[]{1,0,0});
...
Rectangle2D33.setSize(new float[]{1,1});

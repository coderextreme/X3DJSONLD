...
MetadataDouble25.setValue(new double[]{0.0,0.0,0.0}, 3);
...
MetadataDouble26.setValue(new double[]{1.0}, 1);
...
MetadataDouble28.setValue(new double[]{0.0,10000.0,0.0}, 3);
...
MetadataDouble29.setValue(new double[]{1.0,0.0,0.0,4.71238898038469}, 4);
...
MetadataDouble30.setValue(new double[]{-0.0320612526145463,0.0,0.0937320149966475}, 3);
...
MetadataDouble33.setValue(new double[]{0.0,0.0,10000.0}, 3);
...
MetadataDouble34.setValue(new double[]{0.0,0.0,1.0,0.0}, 4);
...
MetadataDouble35.setValue(new double[]{-0.00884759203065143,0.0177734813359099,0.0}, 3);
...
Material43.setEmissiveColor(new float[]{1.0,1.0,1.0});
Appearance42.addChild(&Material43);

Shape41.addChild(&Appearance42);

NurbsCurve& NurbsCurve44 =  NurbsCurve();
NurbsCurve44.setKnot(new double[]{0.0,0.0,0.0,0.25,0.25,0.5,0.5,0.75,0.75,1.0,1.0,1.0}, 12);
NurbsCurve44.setWeight(new double[]{1.0,0.7071,1.0,0.7071,1.0,0.7071,1.0,0.7071,1.0}, 9);
CoordinateDouble& CoordinateDouble45 =  CoordinateDouble();
CoordinateDouble45.setPoint(new double[]{1.0,0.0,0.0,0.7071,-0.7071,0.0,0.0,-1.0,0.0,-0.7071,-0.7071,0.0,-1.0,0.0,0.0,-0.7071,0.7071,0.0,0.0,1.0,0.0,0.7071,0.7071,0.0,1.0,0.0,0.0}, 27);

...
Background9.setSkyColor(new float[]{1.0,1.0,1.0}, 3);
...
Transform13.setScale(new float[]{2.82961,0.74589,1.0});
Shape& Shape14 =  Shape();
...
Box& Box17 =  Box();
Box17.setSize(new float[]{1.0,1.0,1.0});
...
VisibilitySensor18.setSize(new float[]{2.82961,0.74589,1.0});
...
Transform29.setTranslation(new float[]{-2.61579,1.3267,0.0});
Shape& Shape30 =  Shape();
...
Material32.setDiffuseColor(new float[]{0.895967,0.0,0.691271});
...
Transform35.setTranslation(new float[]{-0.0107825,0.240168,0.0});
...
Transform41.setTranslation(new float[]{3.38007,1.3267,0.0});
Shape& Shape42 =  Shape();
...
Transform47.setTranslation(new float[]{-0.0486381,0.213912,0.0});

...
MetadataDouble25.setValue(new double[]{1.0}, 1);
...
MetadataDouble27.setValue(new double[]{-8.4961538177602,10000.0,0.726184320129006}, 3);
...
MetadataDouble28.setValue(new double[]{1.0,0.0,0.0,4.71238898038469}, 4);
...
MetadataDouble29.setValue(new double[]{-8.52821507037475,0.0,0.819916335125654}, 3);
...
MetadataDouble32.setValue(new double[]{-1.32132392601719,1.49125645364041,10000.0}, 3);
...
MetadataDouble34.setValue(new double[]{-1.33017151804784,1.50902993497632,0.0}, 3);
...
Transform41.setTranslation(new float[]{0.0,5.0,0.0});
Transform41.setScale(new float[]{5.0,5.0,5.0});
Shape& Shape42 =  Shape();
...
LocalFog46.setColor(new float[]{0.0,0.0,1.0});
...
Viewpoint47.setPosition(new float[]{0.0,1.6,0.0});
...
Transform48.setTranslation(new float[]{-15.0,0.0,0.0});
Transform48.setRotation(new float[]{0.0,-1.0,0.0,0.785398131619433});
Transform48.setScale(new float[]{2.0,1.0,1.0});
...
Viewpoint51.setPosition(new float[]{0.0,1.6,0.0});
...
Viewpoint52.setPosition(new float[]{0.0,1.6,0.0});
...
Viewpoint53.setPosition(new float[]{-15.0,1.6,0.0});
Viewpoint53.setOrientation(new float[]{0.0,-1.0,0.0,0.785398131619433});

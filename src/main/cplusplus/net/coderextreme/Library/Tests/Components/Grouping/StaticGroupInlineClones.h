...
Viewpoint13.setCenterOfRotation(new float[]{0.0,0.0844979,0.0});
...
Transform22.setTranslation(new float[]{0.0,0.2,0.0});
...
Transform28.setTranslation(new float[]{0.0,0.4,0.0});
...
Transform30.setTranslation(new float[]{2.0,0.0,0.0});
...
Transform32.setTranslation(new float[]{0.0,0.0,2.0});

...
MetadataDouble24.setValue(new double[]{0,0,10}, 3);
...
MetadataDouble25.setValue(new double[]{0,0,1,0}, 4);
...
MetadataDouble26.setValue(new double[]{0,0,0}, 3);
...
Transform30.setTranslation(new float[]{4.43603,-0.67719,0});
...
Transform45.setScale(new float[]{4,4,1});
Shape& Shape46 =  Shape();
Appearance& Appearance47 =  Appearance();
Material& Material48 =  Material();
Material48.setDiffuseColor(new float[]{0.5,0,0.5});
...
Transform60.setTranslation(new float[]{-1.9999,-1.9999,0});
...
Material67.setEmissiveColor(new float[]{0,0.8,0.8});
...
Transform82.setTranslation(new float[]{4.43603,0,0});

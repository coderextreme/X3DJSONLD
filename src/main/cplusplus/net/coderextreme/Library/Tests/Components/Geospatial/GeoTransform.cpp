...
MetadataDouble14.setValue(new double[]{-8069103.5,-13976098,11294733}, 3);
...
MetadataDouble16.setValue(new double[]{-35164.6875,0,-9.22524860322294e-13}, 3);
...
GeoViewpoint21.setOrientation(new float[]{1,9.51556969047435e-10,-1.67784993205101e-10,4.71398251875275});
GeoViewpoint21.setCenterOfRotation(new double[]{180,0,-6342972.31424518});
Scene8.addChild(&GeoViewpoint21);

Shape& Shape22 =  Shape();
Appearance& Appearance23 =  Appearance();
Material& Material24 =  Material();
Material24.setDiffuseColor(new float[]{0.3,1,0.3});
Appearance23.addChild(&Material24);

Shape22.addChild(&Appearance23);

GeoElevationGrid& GeoElevationGrid25 =  GeoElevationGrid();
GeoElevationGrid25.setGeoGridOrigin(new double[]{-90,-180,0});
...
Material28.setDiffuseColor(new float[]{0.9,0,0});
...
GeoElevationGrid29.setGeoGridOrigin(new double[]{3600000,0,0});
...
GeoElevationGrid29.setHeight(new double[]{1000,1000,1000,1000}, 4);
Shape26.setGeometry(&GeoElevationGrid29);

Scene8.addChild(&Shape26);

GeoTransform& GeoTransform30 =  GeoTransform();
GeoTransform30.setTranslation(new float[]{0,100000,200000});
GeoTransform30.setRotation(new float[]{0,1,0,0.5});
GeoTransform30.setScale(new float[]{1,2,3});
GeoTransform30.setGeoSystem(new CString[]{CString(", "), CString("UTM, "), CString("Z10, "), CString("Neasting_first")}, 4);
GeoTransform30.setGeoCenter(new double[]{0,3600000,0});
Shape& Shape31 =  Shape();

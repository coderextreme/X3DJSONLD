...
CoordinateDouble25.setPoint(new double[]{0.0,0.0,0.0,10.0,0.0,0.0,10.0,3.0,0.0,2.0,5.0,0.0,10.0,7.0,0.0,10.0,10.0,0.0,0.0,10.0,0.0,0.0,0.0,0.0}, 24);
...
MetadataDouble33.setValue(new double[]{1.0}, 1);
...
MetadataDouble36.setValue(new double[]{1.0,0.0,0.0,4.71238898038469}, 4);
...
MetadataDouble41.setValue(new double[]{0.0,0.0,1.0,0.0}, 4);
...
Background47.setSkyColor(new float[]{1.0,1.0,1.0}, 3);
...
Viewpoint48.setCenterOfRotation(new float[]{5.03567,4.99999,0.0});

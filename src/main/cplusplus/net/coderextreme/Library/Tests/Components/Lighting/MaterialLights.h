...
Transform10.setTranslation(new float[]{-1.5,1.5,0.0});
...
Transform17.setTranslation(new float[]{-1.5,-1.5,0.0});
...
Transform24.setTranslation(new float[]{1.5,1.5,0.0});
...
SpotLight30.setColor(new float[]{0.8,0.0,0.0});
SpotLight30.setIntensity(10);
SpotLight30.setLocation(new float[]{0.0,0.0,1.0});
...
Transform31.setTranslation(new float[]{1.5,-1.5,0.0});

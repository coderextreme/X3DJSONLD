...
Viewpoint11.setPosition(new float[]{3.9086,-1,8.05518});
Viewpoint11.setCenterOfRotation(new float[]{3.9086,-1,0});
...
Coordinate19.setPoint(new float[]{0,0,0,1,-0.4216,0,3,0.4216,0,5,-0.4216,0,7,0.4216,0,8,0,0}, 18);
...
Transform20.setTranslation(new float[]{0,-2,0});
Shape& Shape21 =  Shape();
...
ContourPolyline2D25.setControlPoint(new double[]{-0.5,0,0.5,0}, 4);
...
CoordinateInterpolator28.setKey(new float[]{0,0.5,1}, 3);
CoordinateInterpolator28.setKeyValue(new float[]{0,0,0,1,1,0,3,-1,0,5,1,0,7,-1,0,8,0,0,0,0,0,1,-1,0,3,1,0,5,-1,0,7,1,0,8,0,0,0,0,0,1,1,0,3,-1,0,5,1,0,7,-1,0,8,0,0}, 54);

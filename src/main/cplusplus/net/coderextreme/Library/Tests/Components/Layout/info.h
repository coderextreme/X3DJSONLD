...
MetadataDouble36.setValue(new double[]{0.0,0.0,0.0}, 3);
...
Transform44.setTranslation(new float[]{-0.421689,0.1,1.0});
Shape& Shape45 =  Shape();
Appearance& Appearance46 =  Appearance();
Material& Material47 =  Material();
Material47.setDiffuseColor(new float[]{0.0,0.0,0.0});
...
Layout62.setOffset(new float[]{0.0,-0.32}, 2);
Layout62.setSize(new float[]{1.0,0.19}, 2);
...
Rectangle2D66.setSize(new float[]{1.0,1.0});
...
Transform69.setScale(new float[]{1.01,1.0,1.0});
...
Rectangle2D74.setSize(new float[]{1.0,1.0});
...
Transform75.setTranslation(new float[]{0.34,0.245,0.0});
Transform75.setScale(new float[]{0.2,0.51,1.0});
Shape& Shape76 =  Shape();
...
Rectangle2D79.setSize(new float[]{1.0,1.0});
...
Transform80.setTranslation(new float[]{0.34,-0.255,0.0});
Transform80.setScale(new float[]{0.2,0.49,1.0});
Shape& Shape81 =  Shape();
Appearance& Appearance82 =  Appearance();
Material& Material83 =  Material();
Material83.setDiffuseColor(new float[]{1.0,0.890196,0.176471});
Appearance82.addChild(&Material83);

Shape81.addChild(&Appearance82);

Rectangle2D& Rectangle2D84 =  Rectangle2D();
Rectangle2D84.setSize(new float[]{1.0,1.0});
...
Layout86.setSize(new float[]{0.1,1.0}, 2);
...
Transform87.setTranslation(new float[]{-0.480889,0.469111,1.0});
...
Transform92.setRotation(new float[]{0.0,0.0,-1.0,2.96629171850506});
Transform92.setCenter(new float[]{5.6,-5.9,0.0});
...
Transform94.setTranslation(new float[]{-0.219,0.3611,1.0});
Shape& Shape95 =  Shape();
...
Transform100.setTranslation(new float[]{-0.216884,0.26855,1.0});
...
Transform106.setTranslation(new float[]{-0.213525,0.219,1.0});
Shape& Shape107 =  Shape();
Appearance& Appearance108 =  Appearance();
Material& Material109 =  Material();
Material109.setDiffuseColor(new float[]{1.0,1.0,1.0});
...
Transform113.setTranslation(new float[]{0.262,0.267,1.0});
Shape& Shape114 =  Shape();
Appearance& Appearance115 =  Appearance();
Material& Material116 =  Material();
Material116.setDiffuseColor(new float[]{0.0,0.0,0.0});
...
Transform119.setTranslation(new float[]{0.262,0.217,1.0});
...
Transform125.setTranslation(new float[]{-0.438782,-0.385263,1.0});

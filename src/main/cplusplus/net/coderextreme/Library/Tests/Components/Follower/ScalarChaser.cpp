...
MetadataDouble32.setValue(new double[]{0,0,10}, 3);
...
MetadataDouble34.setValue(new double[]{0,0,0}, 3);
...
Transform52.setTranslation(new float[]{2.45296,1.55582,0});
...
Material59.setEmissiveColor(new float[]{0,0.8,0.8});
...
Transform76.setTranslation(new float[]{4.43603,0,0});
...
Transform83.setTranslation(new float[]{4.43603,-0.67719,0});

...
MetadataDouble16.setValue(new double[]{-35164.6857548207,0.0,-9.22524835922619e-13}, 3);
...
Transform20.setRotation(new float[]{1.0,0.0,0.0,1.5707963267949});
Background& Background21 =  Background();
Background21.setSkyAngle(new float[]{1.56287}, 1);
Background21.setSkyColor(new float[]{0.0343751,0.034375,0.275,0.702145,0.702145,1.0}, 6);
Background21.setGroundAngle(new float[]{1.5708}, 1);
Background21.setGroundColor(new float[]{0.0343751,0.034375,0.275,0.702145,0.702145,1.0}, 6);
...
GeoViewpoint22.setOrientation(new float[]{-1.0,-1.32396391064704e-9,2.31940358896155e-10,1.56899698076057});
GeoViewpoint22.setCenterOfRotation(new double[]{180.0,0.0,-6342972.31424518});
...
GeoElevationGrid26.setGeoGridOrigin(new double[]{-90.0,-180.0,0.0});
...
Material29.setDiffuseColor(new float[]{0.9,0.0,0.0});
...
GeoElevationGrid30.setGeoGridOrigin(new double[]{3600000.0,0.0,0.0});

...
meta6.setContent(CString("file:///home/holger/Projekte/Library/Tests/Components/Follower/TexCoordChaser2D.x3d"));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(CString("modified"));
meta7.setContent(CString("Sun, 25 Feb 2018 06:57:53 GMT"));
head1.addMeta(&meta7);
...
MetadataDouble22.setValue(new double[]{0,0,10}, 3);
...
MetadataDouble23.setValue(new double[]{0,0,1,0}, 4);
...
Transform32.setTranslation(new float[]{2.71505,2.16353,0});
Transform32.setScale(new float[]{0.204112,0.204112,1});
Shape& Shape33 =  Shape();
...
Transform40.setTranslation(new float[]{2.71505,1.65935,0});
Transform40.setScale(new float[]{0.204112,0.204112,1});
Shape& Shape41 =  Shape();
...
Transform48.setTranslation(new float[]{2.71505,1.16847,0});
Transform48.setScale(new float[]{0.204112,0.204112,1});
Shape& Shape49 =  Shape();
...
Transform56.setTranslation(new float[]{2.71505,0.678305,0});
Transform56.setScale(new float[]{0.204112,0.204112,1});
Shape& Shape57 =  Shape();
...
TexCoordChaser2D& TexCoordChaser2D64 =  TexCoordChaser2D();
TexCoordChaser2D64.setDEF(CString("_5"));
TexCoordChaser2D64.setInitialValue(new float[]{-1,-1,1,-1,1,1,-1,1}, 8);
TexCoordChaser2D64.setInitialDestination(new float[]{-1,-1,1,-1,1,1,-1,1}, 8);
Scene8.addChild(&TexCoordChaser2D64);
...
TextureCoordinate70.setPoint(new float[]{-1,-1,1,-1,1,1,-1,1}, 8);
QuadSet69.setTexCoord(&TextureCoordinate70);

Coordinate& Coordinate71 =  Coordinate();
Coordinate71.setDEF(CString("Coordinate"));
Coordinate71.setPoint(new float[]{-1,-1,0,1,-1,0,1,1,0,-1,1,0}, 12);
...
ROUTE& ROUTE72 =  ROUTE();
ROUTE72.setFromNode(CString("Touch3"));
ROUTE72.setFromField(CString("touchTime"));
ROUTE72.setToNode(CString("_4"));
ROUTE72.setToField(CString("set_triggerTime"));
Scene8.addChild(&ROUTE72);

ROUTE& ROUTE73 =  ROUTE();
ROUTE73.setFromNode(CString("Touch2"));
ROUTE73.setFromField(CString("touchTime"));
ROUTE73.setToNode(CString("_3"));
ROUTE73.setToField(CString("set_triggerTime"));
Scene8.addChild(&ROUTE73);

ROUTE& ROUTE74 =  ROUTE();
ROUTE74.setFromNode(CString("Touch1"));
ROUTE74.setFromField(CString("touchTime"));
ROUTE74.setToNode(CString("_2"));
...
ROUTE75.setToNode(CString("_1"));
ROUTE75.setToField(CString("set_triggerTime"));
Scene8.addChild(&ROUTE75);

ROUTE& ROUTE76 =  ROUTE();
ROUTE76.setFromNode(CString("_4"));
ROUTE76.setFromField(CString("value_changed"));
ROUTE76.setToNode(CString("_5"));
ROUTE76.setToField(CString("set_destination"));
Scene8.addChild(&ROUTE76);

ROUTE& ROUTE77 =  ROUTE();
ROUTE77.setFromNode(CString("_3"));
...
ROUTE& ROUTE78 =  ROUTE();
ROUTE78.setFromNode(CString("_2"));
...
ROUTE& ROUTE79 =  ROUTE();
ROUTE79.setFromNode(CString("_1"));
...
ROUTE& ROUTE80 =  ROUTE();
ROUTE80.setFromNode(CString("_5"));
ROUTE80.setFromField(CString("value_changed"));
ROUTE80.setToNode(CString("_6"));
ROUTE80.setToField(CString("set_point"));

...
HAnimJoint10.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint10.setLlimit(new float[]{0,0,0}, 3);
...
HAnimDisplacer11.setDisplacements(new float[]{-3,0,0}, 3);
...
HAnimDisplacer12.setDisplacements(new float[]{-1,-2,0}, 3);
...
HAnimDisplacer13.setDisplacements(new float[]{1,0,0}, 3);
...
HAnimDisplacer14.setDisplacements(new float[]{-1,2,0}, 3);
...
HAnimDisplacer15.setDisplacements(new float[]{1,0,0}, 3);
...
HAnimDisplacer17.setDisplacements(new float[]{1,0,0}, 3);
HAnimJoint16.setDisplacers(HAnimDisplacer17);

HAnimJoint& HAnimJoint18 =  HAnimJoint();
HAnimJoint18.setDEF(CString("_9"));
HAnimJoint18.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint18.setLlimit(new float[]{0,0,0}, 3);
...
HAnimDisplacer19.setDisplacements(new float[]{1,0,0}, 3);
HAnimJoint18.setDisplacers(HAnimDisplacer19);

HAnimJoint& HAnimJoint20 =  HAnimJoint();
HAnimJoint20.setDEF(CString("_11"));
HAnimJoint20.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint20.setLlimit(new float[]{0,0,0}, 3);
...
HAnimDisplacer21.setDisplacements(new float[]{1,0,0}, 3);
...
Coordinate26.setPoint(new float[]{1,1,0,-1,1,0,-1,-1,0,1,-1,0}, 12);

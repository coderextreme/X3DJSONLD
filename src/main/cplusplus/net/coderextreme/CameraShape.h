...
Viewpoint17.setOrientation(new float[]{0.0,1.0,0.0,1.5708});
Viewpoint17.setPosition(new float[]{12.0,0.0,-4.0});
Scene13.addChild(&Viewpoint17);

Viewpoint& Viewpoint18 =  Viewpoint();
Viewpoint18.setDescription(CString("Camera view from above"));
Viewpoint18.setOrientation(new float[]{1.0,0.0,0.0,-1.5708});
Viewpoint18.setPosition(new float[]{0.0,15.0,-5.0});
Scene13.addChild(&Viewpoint18);

Viewpoint& Viewpoint19 =  Viewpoint();
Viewpoint19.setDescription(CString("Camera view from left side"));
Viewpoint19.setOrientation(new float[]{0.0,1.0,0.0,-1.5708});
Viewpoint19.setPosition(new float[]{-12.0,0.0,-4.0});
Scene13.addChild(&Viewpoint19);

Transform& Transform20 =  Transform();
Transform20.setScale(new float[]{0.1,0.1,0.1});
Transform20.setTranslation(new float[]{0.0,-0.165,0.02});
...
Coordinate27.setPoint(new float[]{-0.36,-2.39,-0.26,-0.36,-1.77,-0.89,-0.36,0.0,-1.7,-0.36,0.85,-1.47,-0.36,1.47,-0.85,-0.36,1.7,0.0,-0.36,1.47,0.85,-0.36,-0.07,2.05,-0.36,-0.92,2.28,-0.36,-1.77,2.05,-0.36,-2.39,1.43,-0.36,-2.62,0.58,0.36,-2.39,-0.26,0.36,-1.77,-0.89,0.36,0.0,-1.7,0.36,0.85,-1.47,0.36,1.47,-0.85,0.36,1.7,0.0,0.36,1.47,0.85,0.36,-0.07,2.05,0.36,-0.92,2.28,0.36,-1.77,2.05,0.36,-2.39,1.43,0.36,-2.62,0.58,-0.36,-0.46,0.31,0.36,-0.46,0.31}, 78);
...
Transform42.setRotation(new float[]{-1.0,0.0,0.0,0.373518});
...
Transform46.setScale(new float[]{1.0,0.727134,0.801457});
...
Transform50.setScale(new float[]{1.0,1.0,0.569444});

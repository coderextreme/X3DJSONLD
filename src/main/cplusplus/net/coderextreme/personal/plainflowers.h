...
meta6.setContent(CString("https://coderextreme.net/X3DJSONLD/src/main/personal/plainflowers.x3d"));
head1.addMeta(&meta6);
...
ExternProtoDeclare11.setUrl(new CString[]{CString("../personal/flowerproto.x3d#FlowerProto")}, 1);
field& field12 =  field();

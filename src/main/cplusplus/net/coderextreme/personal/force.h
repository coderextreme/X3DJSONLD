...
meta6.setContent(CString("https://coderextreme.net/X3DJSONLD/src/main/personal/force.x3d"));
head1.addMeta(&meta6);
...
Transform22.setTranslation(new float[]{1.0,0.0,0.0});
Shape& Shape23 =  Shape();
Text& Text24 =  Text();
...
Extrusion46.setSpine(new float[]{0.0,-50.0,0.0,0.0,50.0,0.0}, 6);

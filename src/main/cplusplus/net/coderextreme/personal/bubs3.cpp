...
meta6.setContent(CString("https://coderextreme.net/X3DJSONLD/src/main/personal/bubs.x3d"));
head1.addMeta(&meta6);
...
Material45.setDiffuseColor(new float[]{1,0,0});
...
Material60.setDiffuseColor(new float[]{1,0,0});

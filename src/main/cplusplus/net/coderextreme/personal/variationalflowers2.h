...
meta10.setContent(CString("variationalflowers2.x3d"));
...
meta12.setContent(CString("A flower variational system"));
head1.addMeta(&meta12);

meta& meta13 =  meta();
meta13.setName(CString("identifier"));
meta13.setContent(CString("https://coderextreme.net/X3DJSONLD/src/main/personal/variationalflowers2.x3d"));
...
WorldInfo15.setTitle(CString("variationalflowers2.x3d"));

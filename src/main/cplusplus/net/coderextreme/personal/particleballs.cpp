...
meta10.setContent(CString("particleballs.x3d"));
...
meta12.setContent(CString("A balls proto with configurable shaders"));
head1.addMeta(&meta12);

meta& meta13 =  meta();
meta13.setName(CString("identifier"));
meta13.setContent(CString("https://coderextreme.net/X3DJSONLD/src/main/personal/particleballs.x3d"));
...
WorldInfo15.setTitle(CString("particleballs.x3d"));

...
Viewpoint10.setPosition(new float[]{0,0,20});
Scene7.addChild(&Viewpoint10);

Transform& Transform11 =  Transform();
Transform11.setTranslation(new float[]{-4,0,0});
Shape& Shape12 =  Shape();
Box& Box13 =  Box();
...
Transform14.setTranslation(new float[]{4,0,0});
Shape& Shape15 =  Shape();
Box& Box16 =  Box();
...
Transform17.setTranslation(new float[]{4,0,0});
Shape& Shape18 =  Shape();
Box& Box19 =  Box();
...
ProximitySensor20.setSize(new float[]{1000000,1000000,1000000});
...
OrientationInterpolator23.setKey(new float[]{0,1}, 2);
OrientationInterpolator23.setKeyValue(new float[]{0,0,1,0,0,0,1,1.57}, 8);

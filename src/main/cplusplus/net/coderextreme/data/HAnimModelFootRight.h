...
Coordinate42.setPoint(new float[]{0.0,0.0,0.0,0.0,-0.3,0.0}, 6);
...
Coordinate47.setPoint(new float[]{0.0,0.0,0.0,-0.2,0.3,0.0}, 6);
...
HAnimJoint48.setCenter(new float[]{0.0,-0.3,0.0});
...
Transform50.setTranslation(new float[]{0.0,-0.3,0.0});
Shape& Shape51 =  Shape();
...
Coordinate56.setPoint(new float[]{0.0,-0.3,0.0,0.1,-0.45,0.0}, 6);
...
Coordinate61.setPoint(new float[]{0.0,-0.3,0.0,0.0,-0.45,0.0}, 6);
...
Coordinate66.setPoint(new float[]{0.0,-0.3,0.0,-0.1,-0.4,0.0}, 6);
...
HAnimJoint67.setCenter(new float[]{0.1,-0.45,0.0});
...
Transform69.setTranslation(new float[]{0.1,-0.45,0.0});
Shape& Shape70 =  Shape();
...
Coordinate75.setPoint(new float[]{0.1,-0.45,0.0,0.1,-0.6,0.0}, 6);
...
HAnimJoint76.setCenter(new float[]{0.1,-0.6,0.0});
...
Transform78.setTranslation(new float[]{0.1,-0.6,0.0});
Shape& Shape79 =  Shape();
...
Coordinate84.setPoint(new float[]{0.1,-0.6,0.0,0.1,-0.9,0.0}, 6);
...
HAnimJoint85.setCenter(new float[]{0.1,-0.9,0.0});
...
Transform87.setTranslation(new float[]{0.1,-0.9,0.0});
Shape& Shape88 =  Shape();
...
Coordinate93.setPoint(new float[]{0.1,-0.9,0.0,0.1,-1.05,0.0}, 6);
...
HAnimJoint94.setCenter(new float[]{0.1,-1.05,0.0});
...
Transform96.setTranslation(new float[]{0.1,-1.05,0.0});
Shape& Shape97 =  Shape();
...
Coordinate102.setPoint(new float[]{0.1,-1.05,0.0,0.1,-1.1,0.0}, 6);
...
HAnimJoint103.setCenter(new float[]{0.0,-0.45,0.0});
...
Transform105.setTranslation(new float[]{0.0,-0.45,0.0});
...
Coordinate111.setPoint(new float[]{0.0,-0.45,0.0,-0.05,-0.6,0.0}, 6);
...
HAnimJoint112.setCenter(new float[]{-0.05,-0.6,0.0});
...
Transform114.setTranslation(new float[]{-0.05,-0.6,0.0});
...
Coordinate120.setPoint(new float[]{-0.05,-0.6,0.0,-0.05,-0.9,0.0}, 6);
...
HAnimJoint121.setCenter(new float[]{-0.05,-0.9,0.0});
...
Transform123.setTranslation(new float[]{-0.05,-0.9,0.0});
...
Coordinate129.setPoint(new float[]{-0.05,-0.9,0.0,-0.05,-1.05,0.0}, 6);
...
HAnimJoint130.setCenter(new float[]{-0.05,-1.05,0.0});
...
Transform132.setTranslation(new float[]{-0.05,-1.05,0.0});
...
Coordinate138.setPoint(new float[]{-0.05,-1.05,0.0,-0.05,-1.12,0.0}, 6);
...
HAnimJoint139.setCenter(new float[]{-0.05,-1.12,0.0});
...
Transform141.setTranslation(new float[]{-0.05,-1.12,0.0});
...
Coordinate147.setPoint(new float[]{-0.05,-1.12,0.0,-0.05,-1.16,0.0}, 6);
...
HAnimJoint148.setCenter(new float[]{-0.1,-0.4,0.0});
...
Transform150.setTranslation(new float[]{-0.1,-0.4,0.0});
...
Coordinate156.setPoint(new float[]{-0.1,-0.4,0.0,-0.15,-0.6,0.0}, 6);
...
HAnimJoint157.setCenter(new float[]{-0.15,-0.6,0.0});
...
Transform159.setTranslation(new float[]{-0.15,-0.6,0.0});
...
Coordinate165.setPoint(new float[]{-0.15,-0.6,0.0,-0.15,-0.9,0.0}, 6);
...
HAnimJoint166.setCenter(new float[]{-0.15,-0.9,0.0});
...
Transform168.setTranslation(new float[]{-0.15,-0.9,0.0});
...
Coordinate174.setPoint(new float[]{-0.15,-0.9,0.0,-0.15,-1.05,0.0}, 6);
...
HAnimJoint175.setCenter(new float[]{-0.15,-1.05,0.0});
...
Transform177.setTranslation(new float[]{-0.15,-1.05,0.0});
...
Coordinate183.setPoint(new float[]{-0.15,-1.05,0.0,-0.15,-1.13,0.0}, 6);
...
HAnimJoint184.setCenter(new float[]{-0.15,-1.13,0.0});
HAnimJoint184.setUlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimJoint184.setLlimit(new float[]{0.0,0.0,0.0}, 3);
...
Transform186.setTranslation(new float[]{-0.15,-1.13,0.0});
...
Coordinate192.setPoint(new float[]{-0.15,-1.13,0.0,-0.15,-1.16,0.0}, 6);
...
HAnimJoint193.setCenter(new float[]{-0.2,0.3,0.0});
HAnimJoint193.setUlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimJoint193.setLlimit(new float[]{0.0,0.0,0.0}, 3);
...
Transform195.setTranslation(new float[]{-0.2,0.3,0.0});
...
Coordinate201.setPoint(new float[]{-0.2,0.3,0.0,-0.21,-0.3,0.0}, 6);
...
HAnimJoint202.setCenter(new float[]{-0.21,-0.3,0.0});
...
Transform204.setTranslation(new float[]{-0.21,-0.3,0.0});
...
Coordinate210.setPoint(new float[]{-0.21,-0.3,0.0,-0.25,-0.58,0.0}, 6);
...
Coordinate215.setPoint(new float[]{-0.21,-0.3,0.0,-0.33,-0.52,0.0}, 6);
...
HAnimJoint216.setCenter(new float[]{-0.25,-0.58,0.0});
HAnimJoint216.setUlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimJoint216.setLlimit(new float[]{0.0,0.0,0.0}, 3);
...
Transform218.setTranslation(new float[]{-0.25,-0.58,0.0});
...
Coordinate224.setPoint(new float[]{-0.25,-0.58,0.0,-0.25,-0.87,0.0}, 6);
...
HAnimJoint225.setCenter(new float[]{-0.25,-0.87,0.0});
HAnimJoint225.setUlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimJoint225.setLlimit(new float[]{0.0,0.0,0.0}, 3);
...
Transform227.setTranslation(new float[]{-0.25,-0.87,0.0});
...
Coordinate233.setPoint(new float[]{-0.25,-0.87,0.0,-0.25,-1.0,0.0}, 6);
...
HAnimJoint234.setCenter(new float[]{-0.25,-1.0,0.0});
...
Transform236.setTranslation(new float[]{-0.25,-1.0,0.0});
...
Coordinate242.setPoint(new float[]{-0.25,-1.0,0.0,-0.25,-1.1,0.0}, 6);
...
HAnimJoint243.setCenter(new float[]{-0.25,-1.1,0.0});
HAnimJoint243.setUlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimJoint243.setLlimit(new float[]{0.0,0.0,0.0}, 3);
...
Transform245.setTranslation(new float[]{-0.25,-1.1,0.0});
...
Coordinate251.setPoint(new float[]{-0.25,-1.1,0.0,-0.25,-1.15,0.0}, 6);
...
HAnimJoint252.setCenter(new float[]{-0.33,-0.52,0.0});
HAnimJoint252.setUlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimJoint252.setLlimit(new float[]{0.0,0.0,0.0}, 3);
...
Transform254.setTranslation(new float[]{-0.33,-0.52,0.0});
...
Coordinate260.setPoint(new float[]{-0.33,-0.52,0.0,-0.34,-0.8,0.0}, 6);
...
HAnimJoint261.setCenter(new float[]{-0.34,-0.8,0.0});
HAnimJoint261.setUlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimJoint261.setLlimit(new float[]{0.0,0.0,0.0}, 3);
...
Transform263.setTranslation(new float[]{-0.34,-0.8,0.0});
...
Coordinate269.setPoint(new float[]{-0.34,-0.8,0.0,-0.34,-0.95,0.0}, 6);
...
HAnimJoint270.setCenter(new float[]{-0.34,-0.95,0.0});
...
Transform272.setTranslation(new float[]{-0.34,-0.95,0.0});
...
Coordinate278.setPoint(new float[]{-0.34,-0.95,0.0,-0.34,-1.05,0.0}, 6);
...
HAnimJoint279.setCenter(new float[]{-0.34,-1.05,0.0});
HAnimJoint279.setUlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimJoint279.setLlimit(new float[]{0.0,0.0,0.0}, 3);
...
Transform281.setTranslation(new float[]{-0.34,-1.05,0.0});
...
Coordinate287.setPoint(new float[]{-0.34,-1.05,0.0,-0.34,-1.08,0.0}, 6);

...
meta2.setContent(CString("personal.x3d"));
head1.addMeta(&meta2);

meta& meta3 =  meta();
meta3.setName(CString("identifier"));
meta3.setContent(CString("https://someAddress/somePath/personal.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(CString("description"));
meta4.setContent(CString("John's Portfolio"));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(CString("generator"));
meta5.setContent(CString("vim and X3D-Edit, https://savage.nps.edu/X3D-Edit"));
head1.addMeta(&meta5);
...
Viewpoint7.setDescription(CString("Tour Views"));
Viewpoint7.setPosition(new float[]{0,0,12});
Scene6.addChild(&Viewpoint7);

Switch& Switch8 =  Switch();
Switch8.setDEF(CString("SceneSwitcher"));
...
Inline9.setUrl(new CString[]{CString("../data/force-tidy.x3d"), CString("https://coderextreme.net/X3DJSONLD/src/main/data/force-tidy.x3d")}, 2);

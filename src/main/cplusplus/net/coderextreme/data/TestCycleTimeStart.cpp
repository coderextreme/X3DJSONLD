...
Transform19.setTranslation(new float[]{1.615999,0,0});
Shape& Shape20 =  Shape();
...
Material27.setDiffuseColor(new float[]{0,1,0});
...
Material32.setDiffuseColor(new float[]{0,0,1});
...
PositionInterpolator34.setKey(new float[]{0,0.25,0.5,0.75,1}, 5);
PositionInterpolator34.setKeyValue(new float[]{0,0,0,2,0,0,0,0,0,-2,0,0,0,0,0}, 15);
...
PositionInterpolator35.setKey(new float[]{0,0.25,0.5,0.75,1}, 5);
PositionInterpolator35.setKeyValue(new float[]{0,0,0,0,2,0,0,0,0,0,-2,0,0,0,0}, 15);
...
PositionInterpolator36.setKey(new float[]{0,0.25,0.5,0.75,1}, 5);
PositionInterpolator36.setKeyValue(new float[]{0,0,0,0,-2,0,0,0,0,0,2,0,0,0,0}, 15);

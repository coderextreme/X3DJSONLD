...
NavigationInfo* NavigationInfo13 = new NavigationInfo();
Scene12->addChild(NavigationInfo13);

Viewpoint* Viewpoint14 = new Viewpoint();
...
OrientationInterpolator* OrientationInterpolator26 = new OrientationInterpolator();

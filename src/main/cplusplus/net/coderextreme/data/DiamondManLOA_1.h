...
Viewpoint28.setPosition(new float[]{0.0,1.0,3.0});
...
HAnimJoint36.setCenter(new float[]{0.0,0.824,0.0277});
...
HAnimJoint37.setCenter(new float[]{0.0,0.9149,0.0016});
...
Transform39.setTranslation(new float[]{0.0,0.9149,0.0016});
Shape& Shape40 =  Shape();
...
HAnimJoint89.setCenter(new float[]{-0.0801,0.0,0.0368});
...
Transform101.setRotation(new float[]{1.0,0.0,0.0,0.119});
...
Transform107.setRotation(new float[]{-1.0,0.0,0.0,0.1});
...
Transform126.setRotation(new float[]{1.0,0.0,0.0,0.0836});
...
Transform132.setRotation(new float[]{-1.0,0.0,0.0,0.1254});
...
HAnimJoint147.setCenter(new float[]{0.0,1.43,-0.0458});
...
Viewpoint256.setPosition(new float[]{0.0,0.854,2.57665});
...
Viewpoint257.setPosition(new float[]{2.5929,0.854,0.0});
Viewpoint257.setOrientation(new float[]{0.0,1.0,0.0,1.57079});
...
Viewpoint258.setPosition(new float[]{0.0,3.4495,0.0});
Viewpoint258.setOrientation(new float[]{1.0,0.0,0.0,-1.57079});

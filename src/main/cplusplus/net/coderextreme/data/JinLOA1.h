...
meta3.setContent(CString("JinLOA1.x3d"));
head1.addMeta(&meta3);
...
meta8.setContent(CString("17 February 2024"));
head1.addMeta(&meta8);
...
meta14.setContent(CString("JinOriginalLOA1.x3d"));
head1.addMeta(&meta14);

meta& meta15 =  meta();
meta15.setName(CString("identifier"));
meta15.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinLOA1.x3d"));
...
WorldInfo22.setTitle(CString("JinLOA1.x3d"));
...
Viewpoint24.setCenterOfRotation(new float[]{0.0,1.0,0.0});
Viewpoint24.setDescription(CString("JinLOA1"));
Viewpoint24.setPosition(new float[]{0.0,1.0,3.0});
Scene21.addChild(&Viewpoint24);

HAnimHumanoid& HAnimHumanoid25 =  HAnimHumanoid();
HAnimHumanoid25.X3DNode::setName(CString("JinLOA1"));
HAnimHumanoid25.setDEF(CString("hanim_JinLOA1"));
HAnimHumanoid25.setLoa(1);
...
MetadataString27.setValue(new CString[]{CString("Jin Hoon Lee and Min Joo Lee, Chul Hee Jung and Myeong Won Lee")}, 1);
...
MetadataFloat32.X3DNode::setName(CString("weight"));
MetadataFloat32.setValue(new float[]{50.0}, 1);
MetadataSet26.setValue((X3DNode *)&MetadataFloat32);

MetadataString& MetadataString33 =  MetadataString();
MetadataString33.X3DNode::setName(CString("humanoidVersion"));
MetadataString33.setValue(new CString[]{CString("validation testing")}, 1);
MetadataSet26.setValue((X3DNode *)&MetadataString33);

HAnimHumanoid25.setMetadata(&MetadataSet26);

HAnimJoint& HAnimJoint34 =  HAnimJoint();
HAnimJoint34.X3DNode::setName(CString("humanoid_root"));
HAnimJoint34.setDEF(CString("hanim_humanoid_root"));
HAnimJoint34.setCenter(new float[]{0.0,30.530001,-0.7076});
...
HAnimSegment35.setDEF(CString("hanim_sacrum"));
Transform& Transform36 =  Transform();
Transform36.setTranslation(new float[]{0.0,30.530001,-0.7076});
Shape& Shape37 =  Shape();
Appearance& Appearance38 =  Appearance();
Material& Material39 =  Material();
Material39.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance38.addChild(&Material39);

ImageTexture& ImageTexture40 =  ImageTexture();
ImageTexture40.setDEF(CString("JinLOA1TextureAtlas"));
ImageTexture40.setUrl(new CString[]{CString("images/Jin.png"), CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Jin.png")}, 2);
...
HAnimSegment35.addChild(&Transform36);

HAnimJoint34.addChildren(&HAnimSegment35);

HAnimJoint& HAnimJoint44 =  HAnimJoint();
HAnimJoint44.X3DNode::setName(CString("sacroiliac"));
HAnimJoint44.setDEF(CString("hanim_sacroiliac"));
HAnimJoint44.setCenter(new float[]{0.0,35.799999,-0.7076});
...
HAnimSegment45.X3DNode::setName(CString("pelvis"));
HAnimSegment45.setDEF(CString("hanim_pelvis"));
Transform& Transform46 =  Transform();
Transform46.setTranslation(new float[]{0.0,35.799999,-0.7076});
Shape& Shape47 =  Shape();
Appearance& Appearance48 =  Appearance();
Material& Material49 =  Material();
Material49.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance48.addChild(&Material49);

ImageTexture& ImageTexture50 =  ImageTexture();
ImageTexture50.setUSE(CString("JinLOA1TextureAtlas"));
...
IndexedFaceSet51.setCreaseAngle(3.14159);
0.8206,-1.132,0.0,-0.4353,-1.307,0.0,0.0273,-1.132,0.0,0.5536,-0.6534,0.0,0.8206,0.0,0.0,0.9616,0.6534,0.0,0.8206,1.132,0.0,0.5536,1.307,0.0,0.0273,1.132,0.0,-0.4353,0.6534,0.0,-0.8206,0.0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0.0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0.0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0.0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0.0,-1.053,0.0273}, 186);
IndexedFaceSet51.setCoord(&Coordinate52);

TextureCoordinate& TextureCoordinate53 =  TextureCoordinate();
TextureCoordinate53.setPoint(new float[]{0.6211,0.5754,0.7851,0.572,0.7614,0.572,0.6907,0.5698,0.62,0.5698,0.6158,0.5702,0.5451,0.5702,0.4167,0.5698,0.5451,0.5702,0.6158,0.5702,0.62,0.5698,0.6907,0.5698,0.7614,0.572,0.8036,0.5346,0.7761,0.5346,0.6989,0.4838,0.6219,0.4428,0.6154,0.4438,0.5492,0.4639,0.4166,0.5346,0.5492,0.4639,0.6154,0.4438,0.6219,0.4428,0.6989,0.4838,0.7761,0.5346,0.7912,0.4044,0.7635,0.4044,0.7042,0.3925,0.6194,0.3907,0.6148,0.3907,0.545,0.3974,0.4163,0.4938,0.545,0.3974,0.6148,0.3907,0.6194,0.3907,0.7042,0.3925,0.7635,0.4044,0.795,0.3772,0.7662,0.3772,0.6945,0.3645,0.6236,0.3695,0.616,0.3695,0.5438,0.378,0.416,0.453,0.5438,0.378,0.616,0.3695,0.6236,0.3695,0.6945,0.3645,0.7662,0.3772,0.7887,0.3451,0.7635,0.3451,0.698,0.3508,0.6262,0.3508,0.6297,0.3503,0.5389,0.3503,0.4181,0.3884,0.5389,0.3503,0.6297,0.3503,0.6262,0.3508,0.698,0.3508,0.7635,0.3451,0.6237,0.3398}, 124);
...
HAnimSegment55.addChild(&Transform56);

HAnimJoint54.addChildren(&HAnimSegment55);

HAnimJoint& HAnimJoint64 =  HAnimJoint();
HAnimJoint64.X3DNode::setName(CString("l_knee"));
HAnimJoint64.setDEF(CString("hanim_l_knee"));
HAnimJoint64.setCenter(new float[]{4.116,17.26,-0.8639});
...
HAnimSegment65.X3DNode::setName(CString("l_calf"));
HAnimSegment65.setDEF(CString("hanim_l_calf"));
Transform& Transform66 =  Transform();
Transform66.setTranslation(new float[]{4.116,17.26,-0.8639});
Shape& Shape67 =  Shape();
Appearance& Appearance68 =  Appearance();
Material& Material69 =  Material();
Material69.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance68.addChild(&Material69);

ImageTexture& ImageTexture70 =  ImageTexture();
ImageTexture70.setUSE(CString("JinLOA1TextureAtlas"));
...
HAnimJoint74.X3DNode::setName(CString("l_talocrural"));
HAnimJoint74.setDEF(CString("hanim_l_talocrural"));
HAnimJoint74.setCenter(new float[]{3.854,3.939,-0.7038});
...
HAnimJoint84.X3DNode::setName(CString("l_metatarsophalangeal_2"));
HAnimJoint84.setDEF(CString("hanim_l_metatarsophalangeal_2"));
HAnimJoint84.setCenter(new float[]{3.854,3.64,0.7402});
...
HAnimSegment85.X3DNode::setName(CString("l_tarsal_proximal_phalanx_2"));
HAnimSegment85.setDEF(CString("hanim_l_tarsal_proximal_phalanx_2"));
//TODO append _2
Transform& Transform86 =  Transform();
Transform86.setTranslation(new float[]{3.854,3.64,0.7402});
Shape& Shape87 =  Shape();
...
HAnimJoint94.X3DNode::setName(CString("r_hip"));
HAnimJoint94.setDEF(CString("hanim_r_hip"));
HAnimJoint94.setCenter(new float[]{-4.207,32.02,-0.8155});
...
HAnimJoint104.X3DNode::setName(CString("r_knee"));
HAnimJoint104.setDEF(CString("hanim_r_knee"));
HAnimJoint104.setCenter(new float[]{-4.116,17.26,-0.8639});
...
HAnimSegment105.X3DNode::setName(CString("r_calf"));
HAnimSegment105.setDEF(CString("hanim_r_calf"));
Transform& Transform106 =  Transform();
Transform106.setTranslation(new float[]{-4.116,17.26,-0.8639});
Shape& Shape107 =  Shape();
Appearance& Appearance108 =  Appearance();
Material& Material109 =  Material();
Material109.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance108.addChild(&Material109);

ImageTexture& ImageTexture110 =  ImageTexture();
ImageTexture110.setUSE(CString("JinLOA1TextureAtlas"));
...
IndexedFaceSet111.setTexCoordIndex(new int32_t[]{0,1,2,-1,2,3,4,-1,2,4,5,-1,0,2,5,-1,6,0,5,-1,9,10,7,-1,7,8,9,-1,12,9,8,-1,8,11,12,-1,14,12,11,-1,11,13,14,-1,16,14,13,-1,13,15,16,-1,18,16,15,-1,15,17,18,-1,20,18,17,-1,17,19,20,-1,10,20,19,-1,19,7,10,-1,21,22,10,-1,10,9,21,-1,23,21,9,-1,9,12,23,-1,24,23,12,-1,12,14,24,-1,25,24,14,-1,14,16,25,-1,26,25,16,-1,16,18,26,-1,27,26,18,-1,18,20,27,-1,22,27,20,-1,20,10,22,-1,1,0,22,-1,22,21,1,-1,2,1,21,-1,21,23,2,-1,3,2,23,-1,23,24,3,-1,4,3,24,-1,24,25,4,-1,5,4,25,-1,25,26,5,-1,6,5,26,-1,26,27,6,-1,0,6,27,-1,27,22,0,-1,8,7,28,-1,28,29,8,-1,11,8,29,-1,29,30,11,-1,13,11,30,-1,30,31,13,-1,15,13,31,-1,31,32,15,-1,17,15,32,-1,32,33,17,-1,19,17,33,-1,33,34,19,-1,7,19,34,-1,34,28,7,-1,29,28,35,-1,35,36,29,-1,30,29,36,-1,36,37,30,-1,31,30,37,-1,37,38,31,-1,32,31,38,-1,38,39,32,-1,33,32,39,-1,39,40,33,-1,34,33,40,-1,40,41,34,-1,28,34,41,-1,41,35,28,-1}, 300);
Coordinate& Coordinate112 =  Coordinate();
Coordinate112.setPoint(new float[]{-0.7186,0.9688,0.0234,-0.3632,0.9688,0.9354,0.4353,0.9688,1.12,1.076,0.9688,0.603,1.076,0.9688,-0.3911,0.4353,0.9688,-0.9079,-0.3632,0.9688,-0.7235,-2.337,-4.613,0.0234,-1.46,-3.622,2.019,-1.236,-1.628,2.42,-2.118,-1.912,0.0234,0.8111,-3.622,2.567,0.7468,-1.628,2.903,2.254,-4.613,1.255,2.337,-1.912,0.9793,2.254,-5.383,-1.368,2.337,-1.912,-0.9325,0.8111,-5.383,-2.903,0.7468,-1.912,-2.368,-1.46,-5.383,-2.355,-1.236,-1.912,-1.885,-1.121,-0.0032,1.896,-1.933,-0.0032,0.0234,0.7056,-0.0032,2.318,2.17,-0.0032,1.136,2.17,-0.0032,-0.9244,0.7056,-0.0032,-2.061,-1.121,-0.0032,-1.64,-1.607,-12.92,0.0032,-0.9216,-12.91,1.565,0.619,-12.91,1.951,1.854,-12.92,0.8701,1.854,-12.94,-0.9762,0.619,-12.94,-1.742,-0.9216,-12.94,-1.356,-0.7072,-14.53,0.0239,-0.3604,-14.53,0.814,0.4188,-14.53,1.009,1.044,-14.53,0.4624,1.044,-14.54,-0.4714,0.4188,-14.54,-0.8587,-0.3604,-14.54,-0.6635}, 126);
IndexedFaceSet111.setCoord(&Coordinate112);

TextureCoordinate& TextureCoordinate113 =  TextureCoordinate();
TextureCoordinate113.setPoint(new float[]{0.9309,0.5848,0.919,0.5848,0.8921,0.5848,0.8706,0.5848,0.8706,0.5848,0.8921,0.5848,0.919,0.5848,0.9845,0.5321,0.955,0.5475,0.9491,0.5599,0.9788,0.5571,0.8787,0.5475,0.8825,0.5599,0.8302,0.5321,0.8291,0.5571,0.8302,0.52,0.8291,0.5571,0.8787,0.52,0.8825,0.5571,0.955,0.52,0.9491,0.5571,0.9444,0.5755,0.9717,0.5755,0.8831,0.5755,0.8339,0.5755,0.8339,0.5755,0.8831,0.5755,0.9444,0.5755,0.9679,0.2444,0.9449,0.2445,0.8931,0.2445,0.8516,0.2444,0.8516,0.2442,0.8931,0.2442,0.9449,0.2442,0.9372,0.2243,0.9255,0.2244,0.8993,0.2244,0.8783,0.2243,0.8783,0.2243,0.8993,0.2243,0.9255,0.2243}, 84);
...
HAnimJoint114.X3DNode::setName(CString("r_talocrural"));
HAnimJoint114.setDEF(CString("hanim_r_talocrural"));
HAnimJoint114.setCenter(new float[]{-3.854,3.939,-0.7038});
...
HAnimSegment115.X3DNode::setName(CString("r_talus"));
HAnimSegment115.setDEF(CString("hanim_r_talus"));
Transform& Transform116 =  Transform();
Transform116.setTranslation(new float[]{-3.854,3.939,-0.7038});
Shape& Shape117 =  Shape();
Appearance& Appearance118 =  Appearance();
Material& Material119 =  Material();
Material119.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance118.addChild(&Material119);

ImageTexture& ImageTexture120 =  ImageTexture();
ImageTexture120.setUSE(CString("JinLOA1TextureAtlas"));
...
...
HAnimJoint124.X3DNode::setName(CString("r_metatarsophalangeal_2"));
HAnimJoint124.setDEF(CString("hanim_r_metatarsophalangeal_2"));
HAnimJoint124.setCenter(new float[]{-3.854,3.64,0.7402});
...
HAnimSegment125.X3DNode::setName(CString("r_tarsal_proximal_phalanx_2"));
HAnimSegment125.setDEF(CString("hanim_r_tarsal_proximal_phalanx_2"));
//TODO append _2
Transform& Transform126 =  Transform();
Transform126.setTranslation(new float[]{-3.854,3.64,0.7402});
Shape& Shape127 =  Shape();
Appearance& Appearance128 =  Appearance();
Material& Material129 =  Material();
Material129.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance128.addChild(&Material129);

ImageTexture& ImageTexture130 =  ImageTexture();
ImageTexture130.setUSE(CString("JinLOA1TextureAtlas"));
...
HAnimJoint104.addChildren(&HAnimJoint114);

HAnimJoint94.addChildren(&HAnimJoint104);

HAnimJoint44.addChildren(&HAnimJoint94);

HAnimJoint34.addChildren(&HAnimJoint44);

HAnimJoint& HAnimJoint134 =  HAnimJoint();
HAnimJoint134.X3DNode::setName(CString("vl5"));
HAnimJoint134.setDEF(CString("hanim_vl5"));
HAnimJoint134.setCenter(new float[]{0.0,40.07,-0.8527});
...
HAnimSegment135.X3DNode::setName(CString("l5"));
HAnimSegment135.setDEF(CString("hanim_l5"));
Transform& Transform136 =  Transform();
Transform136.setTranslation(new float[]{0.0,40.07,-0.8527});
Shape& Shape137 =  Shape();
Appearance& Appearance138 =  Appearance();
Material& Material139 =  Material();
Material139.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance138.addChild(&Material139);

ImageTexture& ImageTexture140 =  ImageTexture();
ImageTexture140.setUSE(CString("JinLOA1TextureAtlas"));
...
HAnimJoint144.X3DNode::setName(CString("skullbase"));
HAnimJoint144.setDEF(CString("hanim_skullbase"));
HAnimJoint144.setCenter(new float[]{0.0,57.43,-0.6863});
...
HAnimJoint154.X3DNode::setName(CString("l_shoulder"));
HAnimJoint154.setDEF(CString("hanim_l_shoulder"));
HAnimJoint154.setCenter(new float[]{5.975,52.0,-0.1452});
...
HAnimSegment155.X3DNode::setName(CString("l_upperarm"));
HAnimSegment155.setDEF(CString("hanim_l_upperarm"));
Transform& Transform156 =  Transform();
Transform156.setTranslation(new float[]{5.975,52.0,-0.1452});
Shape& Shape157 =  Shape();
Appearance& Appearance158 =  Appearance();
Material& Material159 =  Material();
Material159.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance158.addChild(&Material159);

ImageTexture& ImageTexture160 =  ImageTexture();
ImageTexture160.setUSE(CString("JinLOA1TextureAtlas"));
Appearance158.addChild(&ImageTexture160);
...
IndexedFaceSet161.setCreaseAngle(3.14159);
...
HAnimJoint164.X3DNode::setName(CString("l_elbow"));
HAnimJoint164.setDEF(CString("hanim_l_elbow"));
HAnimJoint164.setCenter(new float[]{8.093,40.380001,-0.2502});
...
HAnimSegment165.X3DNode::setName(CString("l_forearm"));
HAnimSegment165.setDEF(CString("hanim_l_forearm"));
Transform& Transform166 =  Transform();
Transform166.setTranslation(new float[]{8.093,40.380001,-0.2502});
Shape& Shape167 =  Shape();
Appearance& Appearance168 =  Appearance();
Material& Material169 =  Material();
Material169.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance168.addChild(&Material169);

ImageTexture& ImageTexture170 =  ImageTexture();
ImageTexture170.setUSE(CString("JinLOA1TextureAtlas"));
...
HAnimSegment165.addChild(&Transform166);

HAnimJoint164.addChildren(&HAnimSegment165);

HAnimJoint& HAnimJoint174 =  HAnimJoint();
HAnimJoint174.X3DNode::setName(CString("l_radiocarpal"));
HAnimJoint174.setDEF(CString("hanim_l_radiocarpal"));
HAnimJoint174.setCenter(new float[]{7.808,31.459999,-0.05849});
...
HAnimSegment175.X3DNode::setName(CString("l_carpal"));
HAnimSegment175.setDEF(CString("hanim_l_carpal"));
Transform& Transform176 =  Transform();
Transform176.setTranslation(new float[]{7.808,31.459999,-0.05849});
...
ImageTexture180.setUSE(CString("JinLOA1TextureAtlas"));
...
IndexedFaceSet181.setCreaseAngle(3.14159);
...
HAnimJoint144.addChildren(&HAnimJoint154);

HAnimJoint& HAnimJoint184 =  HAnimJoint();
HAnimJoint184.X3DNode::setName(CString("r_shoulder"));
HAnimJoint184.setDEF(CString("hanim_r_shoulder"));
HAnimJoint184.setCenter(new float[]{-5.975,52.0,-0.1452});
...
HAnimSegment185.X3DNode::setName(CString("r_upperarm"));
HAnimSegment185.setDEF(CString("hanim_r_upperarm"));
Transform& Transform186 =  Transform();
Transform186.setTranslation(new float[]{-5.975,52.0,-0.1452});
Shape& Shape187 =  Shape();
Appearance& Appearance188 =  Appearance();
Material& Material189 =  Material();
Material189.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance188.addChild(&Material189);

ImageTexture& ImageTexture190 =  ImageTexture();
ImageTexture190.setUSE(CString("JinLOA1TextureAtlas"));
...
HAnimJoint194.X3DNode::setName(CString("r_elbow"));
HAnimJoint194.setDEF(CString("hanim_r_elbow"));
HAnimJoint194.setCenter(new float[]{-8.093,40.380001,-0.2502});
...
HAnimSegment195.X3DNode::setName(CString("r_forearm"));
HAnimSegment195.setDEF(CString("hanim_r_forearm"));
Transform& Transform196 =  Transform();
Transform196.setTranslation(new float[]{-8.093,40.380001,-0.2502});
Shape& Shape197 =  Shape();
Appearance& Appearance198 =  Appearance();
Material& Material199 =  Material();
Material199.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance198.addChild(&Material199);

ImageTexture& ImageTexture200 =  ImageTexture();
ImageTexture200.setUSE(CString("JinLOA1TextureAtlas"));
Appearance198.addChild(&ImageTexture200);
...
HAnimJoint204.X3DNode::setName(CString("r_radiocarpal"));
HAnimJoint204.setDEF(CString("hanim_r_radiocarpal"));
HAnimJoint204.setCenter(new float[]{-7.808,31.459999,-0.05849});
HAnimJoint204.setUlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimJoint204.setLlimit(new float[]{0.0,0.0,0.0}, 3);
HAnimSegment& HAnimSegment205 =  HAnimSegment();
HAnimSegment205.X3DNode::setName(CString("r_carpal"));
HAnimSegment205.setDEF(CString("hanim_r_carpal"));
Transform& Transform206 =  Transform();
Transform206.setTranslation(new float[]{-7.808,31.459999,-0.05849});
Shape& Shape207 =  Shape();
Appearance& Appearance208 =  Appearance();
Material& Material209 =  Material();
Material209.setDiffuseColor(new float[]{0.588,0.588,0.588});
Appearance208.addChild(&Material209);

ImageTexture& ImageTexture210 =  ImageTexture();
ImageTexture210.setUSE(CString("JinLOA1TextureAtlas"));
...
HAnimJoint194.addChildren(&HAnimJoint204);

HAnimJoint184.addChildren(&HAnimJoint194);

HAnimJoint144.addChildren(&HAnimJoint184);

HAnimJoint134.addChildren(&HAnimJoint144);

HAnimJoint34.addChildren(&HAnimJoint134);

HAnimHumanoid25.setSkeleton(&HAnimJoint34);

HAnimJoint& HAnimJoint214 =  HAnimJoint();
HAnimJoint214.setUSE(CString("hanim_humanoid_root"));
HAnimHumanoid25.setJoints(&HAnimJoint214);

HAnimJoint& HAnimJoint215 =  HAnimJoint();
HAnimJoint215.setUSE(CString("hanim_sacroiliac"));
...
HAnimJoint217.setUSE(CString("hanim_skullbase"));
HAnimHumanoid25.setJoints(&HAnimJoint217);

HAnimJoint& HAnimJoint218 =  HAnimJoint();
HAnimJoint218.setUSE(CString("hanim_l_elbow"));
...
HAnimJoint220.setUSE(CString("hanim_l_hip"));
HAnimHumanoid25.setJoints(&HAnimJoint220);

HAnimJoint& HAnimJoint221 =  HAnimJoint();
HAnimJoint221.setUSE(CString("hanim_r_hip"));
HAnimHumanoid25.setJoints(&HAnimJoint221);

HAnimJoint& HAnimJoint222 =  HAnimJoint();
HAnimJoint222.setUSE(CString("hanim_l_knee"));
HAnimHumanoid25.setJoints(&HAnimJoint222);

HAnimJoint& HAnimJoint223 =  HAnimJoint();
HAnimJoint223.setUSE(CString("hanim_r_knee"));
HAnimHumanoid25.setJoints(&HAnimJoint223);

HAnimJoint& HAnimJoint224 =  HAnimJoint();
HAnimJoint224.setUSE(CString("hanim_l_metatarsophalangeal_2"));
HAnimHumanoid25.setJoints(&HAnimJoint224);

HAnimJoint& HAnimJoint225 =  HAnimJoint();
HAnimJoint225.setUSE(CString("hanim_r_metatarsophalangeal_2"));
HAnimHumanoid25.setJoints(&HAnimJoint225);

HAnimJoint& HAnimJoint226 =  HAnimJoint();
HAnimJoint226.setUSE(CString("hanim_l_radiocarpal"));
HAnimHumanoid25.setJoints(&HAnimJoint226);

HAnimJoint& HAnimJoint227 =  HAnimJoint();
HAnimJoint227.setUSE(CString("hanim_r_radiocarpal"));
HAnimHumanoid25.setJoints(&HAnimJoint227);

HAnimJoint& HAnimJoint228 =  HAnimJoint();
HAnimJoint228.setUSE(CString("hanim_l_shoulder"));
HAnimHumanoid25.setJoints(&HAnimJoint228);

HAnimJoint& HAnimJoint229 =  HAnimJoint();
HAnimJoint229.setUSE(CString("hanim_r_shoulder"));
HAnimHumanoid25.setJoints(&HAnimJoint229);

HAnimJoint& HAnimJoint230 =  HAnimJoint();
HAnimJoint230.setUSE(CString("hanim_l_talocrural"));
HAnimHumanoid25.setJoints(&HAnimJoint230);

HAnimJoint& HAnimJoint231 =  HAnimJoint();
HAnimJoint231.setUSE(CString("hanim_r_talocrural"));
HAnimHumanoid25.setJoints(&HAnimJoint231);

HAnimSegment& HAnimSegment232 =  HAnimSegment();
HAnimSegment232.setUSE(CString("hanim_sacrum"));
HAnimHumanoid25.setSegments(&HAnimSegment232);

HAnimSegment& HAnimSegment233 =  HAnimSegment();
HAnimSegment233.setUSE(CString("hanim_pelvis"));
HAnimHumanoid25.setSegments(&HAnimSegment233);

HAnimSegment& HAnimSegment234 =  HAnimSegment();
HAnimSegment234.setUSE(CString("hanim_l5"));
HAnimHumanoid25.setSegments(&HAnimSegment234);

HAnimSegment& HAnimSegment235 =  HAnimSegment();
HAnimSegment235.setUSE(CString("hanim_skull"));
HAnimHumanoid25.setSegments(&HAnimSegment235);

HAnimSegment& HAnimSegment236 =  HAnimSegment();
HAnimSegment236.setUSE(CString("hanim_l_calf"));
HAnimHumanoid25.setSegments(&HAnimSegment236);

HAnimSegment& HAnimSegment237 =  HAnimSegment();
HAnimSegment237.setUSE(CString("hanim_r_calf"));
HAnimHumanoid25.setSegments(&HAnimSegment237);

HAnimSegment& HAnimSegment238 =  HAnimSegment();
HAnimSegment238.setUSE(CString("hanim_l_carpal"));
HAnimHumanoid25.setSegments(&HAnimSegment238);

HAnimSegment& HAnimSegment239 =  HAnimSegment();
HAnimSegment239.setUSE(CString("hanim_r_carpal"));
HAnimHumanoid25.setSegments(&HAnimSegment239);

HAnimSegment& HAnimSegment240 =  HAnimSegment();
HAnimSegment240.setUSE(CString("hanim_l_forearm"));
HAnimHumanoid25.setSegments(&HAnimSegment240);

HAnimSegment& HAnimSegment241 =  HAnimSegment();
HAnimSegment241.setUSE(CString("hanim_r_forearm"));
HAnimHumanoid25.setSegments(&HAnimSegment241);

HAnimSegment& HAnimSegment242 =  HAnimSegment();
HAnimSegment242.setUSE(CString("hanim_l_talus"));
HAnimHumanoid25.setSegments(&HAnimSegment242);

HAnimSegment& HAnimSegment243 =  HAnimSegment();
HAnimSegment243.setUSE(CString("hanim_r_talus"));
HAnimHumanoid25.setSegments(&HAnimSegment243);

HAnimSegment& HAnimSegment244 =  HAnimSegment();
HAnimSegment244.setUSE(CString("hanim_l_tarsal_proximal_phalanx_2"));
HAnimHumanoid25.setSegments(&HAnimSegment244);

HAnimSegment& HAnimSegment245 =  HAnimSegment();
HAnimSegment245.setUSE(CString("hanim_r_tarsal_proximal_phalanx_2"));
HAnimHumanoid25.setSegments(&HAnimSegment245);

HAnimSegment& HAnimSegment246 =  HAnimSegment();
HAnimSegment246.setUSE(CString("hanim_l_thigh"));
HAnimHumanoid25.setSegments(&HAnimSegment246);

HAnimSegment& HAnimSegment247 =  HAnimSegment();
HAnimSegment247.setUSE(CString("hanim_r_thigh"));
HAnimHumanoid25.setSegments(&HAnimSegment247);

HAnimSegment& HAnimSegment248 =  HAnimSegment();
HAnimSegment248.setUSE(CString("hanim_l_upperarm"));
HAnimHumanoid25.setSegments(&HAnimSegment248);

HAnimSegment& HAnimSegment249 =  HAnimSegment();
HAnimSegment249.setUSE(CString("hanim_r_upperarm"));
HAnimHumanoid25.setSegments(&HAnimSegment249);

...
Extrusion12.setSpine(new float[]{-50,-50,0,50,50,0}, 6);
Extrusion12.setCreaseAngle(0.785);
Extrusion12.setCrossSection(new float[]{1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0}, 34);
Shape11.setGeometry(&Extrusion12);

Appearance& Appearance13 =  Appearance();
Material& Material14 =  Material();
Material14.setDiffuseColor(new float[]{0,1,0});

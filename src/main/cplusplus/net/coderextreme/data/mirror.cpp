...
ImageTexture17->setDEF("leftBackgroundTexture");
...
ImageTexture18->setDEF("rightBackgroundTexture");
...
ImageTexture19->setDEF("frontBackgroundTexture");
...
ImageTexture20->setDEF("backBackgroundTexture");
...
ImageTexture21->setDEF("topBackgroundTexture");
...
ImageTexture22->setDEF("bottomBackgroundTexture");
...
ROUTE68->setToNode("frontBackgroundTexture");
...
ROUTE69->setToNode("backBackgroundTexture");
...
ROUTE70->setToNode("leftBackgroundTexture");
...
ROUTE71->setToNode("rightBackgroundTexture");
...
ROUTE72->setToNode("topBackgroundTexture");
...
ROUTE73->setToNode("bottomBackgroundTexture");

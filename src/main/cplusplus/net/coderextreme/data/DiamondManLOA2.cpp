...
Viewpoint19.setPosition(new float[]{0,1,3});
Viewpoint19.setCenterOfRotation(new float[]{0,1,0});
Scene16.addChild(&Viewpoint19);

Transform& Transform20 =  Transform();
Transform20.setTranslation(new float[]{1,1.5,0});
...
Transform27.setTranslation(new float[]{0,-0.3,0});
Shape& Shape28 =  Shape();
...
Transform32.setTranslation(new float[]{0.2,0,0});
Shape& Shape33 =  Shape();
...
Transform38.setTranslation(new float[]{0,-0.5,0});
Shape& Shape39 =  Shape();
...
Transform43.setTranslation(new float[]{0.2,0,0});
Shape& Shape44 =  Shape();
...
Transform54.setTranslation(new float[]{0.2,0,0});
Shape& Shape55 =  Shape();
...
Transform65.setTranslation(new float[]{0.2,0,0});
Shape& Shape66 =  Shape();
...
Transform76.setTranslation(new float[]{0.2,0,0});
Shape& Shape77 =  Shape();
...
Transform87.setTranslation(new float[]{0.2,0,0});
Shape& Shape88 =  Shape();

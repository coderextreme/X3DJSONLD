...
Material26.setDiffuseColor(new float[]{1,0.452381,0.40339});
...
Material56.setDiffuseColor(new float[]{0.794445,0.249425,0});
...
Material62.setSpecularColor(new float[]{0.345745,0.143066,0});
...
Material71.setDiffuseColor(new float[]{0,0.346939,0.253624});
Material71.setShininess(0.316327);
Material71.setSpecularColor(new float[]{0,0.311074,0.357143});
...
Material74.setDiffuseColor(new float[]{0,0.251004,0.239248});
...
Material89.setDiffuseColor(new float[]{1,0.854922,0});
...
Material98.setSpecularColor(new float[]{0.212121,0.107475,0});
...
Material104.setDiffuseColor(new float[]{0.087034,0.025888,0});
...
Material123.setDiffuseColor(new float[]{0.8,0.4,0});

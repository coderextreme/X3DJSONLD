...
meta2.setContent(CString("WinterAndSpringTitleBox.x3d"));
head1.addMeta(&meta2);
...
meta9.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringTitleBox.x3d"));
head1.addMeta(&meta9);
...
WorldInfo11.setTitle(CString("WinterAndSpringTitleBox.x3d"));
Scene10.addChild(&WorldInfo11);

Viewpoint& Viewpoint12 =  Viewpoint();
Viewpoint12.setDEF(CString("WinterAndSpringTitleView"));
Viewpoint12.setDescription(CString("Look at main title"));
Viewpoint12.setPosition(new float[]{10,11,5});
Viewpoint12.setOrientation(new float[]{-0.15,0,0,0.2});
Scene10.addChild(&Viewpoint12);

Transform& Transform13 =  Transform();
Transform13.setDEF(CString("WinterAndSpringTitle"));
Transform13.setTranslation(new float[]{10,10,0});
Shape& Shape14 =  Shape();
...
ImageTexture17.setUrl(new CString[]{CString("images/WinterAndSpring.png"), CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WinterAndSpring.png")}, 2);

...
CProtoDeclare ProtoDeclare80 = browser.createX3DFromString(R"foo(<?xml version="1.0" encoding="UTF-8"?>
...
CProtoDeclare ProtoDeclare109 = browser.createX3DFromString(R"foo(<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE X3D PUBLIC "ISO//Web3D//DTD X3D 4.0//EN" "https://www.web3d.org/specifications/x3d-4.0.dtd">

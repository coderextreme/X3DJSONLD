...
meta2->setContent(CString("indexedfaceset_pixeltexture_part.x3d"));
head1->addMeta(meta2);

meta* meta3 = new meta();
meta3->setName(CString("Image"));
meta3->setContent(CString("indexedfaceset_pixeltexture_part-front.jpg"));
head1->addMeta(meta3);

meta* meta4 = new meta();
meta4->setName(CString("Image"));
meta4->setContent(CString("indexedfaceset_pixeltexture_part-rear.jpg"));
head1->addMeta(meta4);

meta* meta5 = new meta();
meta5->setName(CString("Image"));
meta5->setContent(CString("indexedfaceset_pixeltexture_part-top.jpg"));
head1->addMeta(meta5);

meta* meta6 = new meta();
meta6->setName(CString("Image"));
meta6->setContent(CString("indexedfaceset_pixeltexture_part-bottom.jpg"));
head1->addMeta(meta6);

meta* meta7 = new meta();
meta7->setName(CString("Image"));
meta7->setContent(CString("indexedfaceset_pixeltexture_part-left.jpg"));
head1->addMeta(meta7);

meta* meta8 = new meta();
meta8->setName(CString("Image"));
meta8->setContent(CString("indexedfaceset_pixeltexture_part-right.jpg"));
head1->addMeta(meta8);
...
meta17->setContent(CString("Test of browser ability to map a partial portion of an PixelTexture onto an IndexedFaceSet geometry. Only the yellow portion of four equal sized red, green, yellow and white squares in the pixel texture map all the faces of the cube."));
head1->addMeta(meta17);

meta* meta18 = new meta();
meta18->setName(CString("identifier"));
meta18->setContent(CString("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_part.x3d"));
...
TextureCoordinate37->setPoint(new float[8]{0.5,1,0.5,0.5,1,1,1,0.5}, 8);

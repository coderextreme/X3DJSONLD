...
HAnimHumanoid23->setName(CString("Ga"));
...
ImageTexture37->setUrl(new CString[2]{CString("images/Ga.png"), CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ga.png")}, 2);

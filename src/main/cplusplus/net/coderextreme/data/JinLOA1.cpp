...
MetadataString26->setValue(new String[1]{"Jin Hoon Lee and Min Joo Lee, Chul Hee Jung and Myeong Won Lee"}, 1);
...
MetadataString32->setValue(new String[1]{"validation testing"}, 1);
...
ImageTexture39->setUrl(new String[2]{"images/Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Jin.png"}, 2);

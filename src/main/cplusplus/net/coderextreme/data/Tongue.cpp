...
meta3.setContent(CString("Tongue.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(CString("description"));
meta4.setContent(CString("Facial Action Coding System (FACS) example for Action Unit (AU) 27, Mouth Stretch Morpher, Tongue Derivated."));
head1.addMeta(&meta4);

meta& meta5 =  meta();
meta5.setName(CString("creator"));
meta5.setContent(CString("Yujin Jung"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(CString("translator"));
meta6.setContent(CString("Chul Hee Jung"));
head1.addMeta(&meta6);

meta& meta7 =  meta();
meta7.setName(CString("translator"));
meta7.setContent(CString("Myeong Won Lee"));
head1.addMeta(&meta7);

meta& meta8 =  meta();
meta8.setName(CString("created"));
meta8.setContent(CString("25 April 2022"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(CString("modified"));
meta9.setContent(CString("27 October 2024"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(CString("translator"));
meta10.setContent(CString("Don Brutzman"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(CString("translator"));
meta11.setContent(CString("Joe D. Williams"));
head1.addMeta(&meta11);

meta& meta12 =  meta();
meta12.setName(CString("reference"));
meta12.setContent(CString("https://en.wikipedia.org/wiki/Facial_Action_Coding_System"));
head1.addMeta(&meta12);

meta& meta13 =  meta();
meta13.setName(CString("reference"));
meta13.setContent(CString("https://web.cs.wpi.edu/~matt/courses/cs563/talks/face_anim/ekman.html"));
head1.addMeta(&meta13);

meta& meta14 =  meta();
meta14.setName(CString("reference"));
meta14.setContent(CString("Bryn Farnsworth, FACS Visual Guidebook https://imotions.com/blog/learning/research-fundamentals/facial-action-coding-system"));
head1.addMeta(&meta14);

meta& meta15 =  meta();
meta15.setName(CString("generator"));
meta15.setContent(CString("Suwon VRLAB X3D Converter"));
head1.addMeta(&meta15);

meta& meta16 =  meta();
meta16.setName(CString("MovingImage"));
meta16.setContent(CString("originals/SuwonHAnimFacialMotionConverter.mp4"));
...
meta18.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/Tongue.x3d"));
...
Viewpoint21.setDEF(CString("HelloJin"));
Viewpoint21.setDescription(CString("Hello Jin! 안녕하세요 진!"));
Viewpoint21.setPosition(new float[]{0,20,60});
Scene20.addChild(&Viewpoint21);

TimeSensor& TimeSensor22 =  TimeSensor();
TimeSensor22.setDEF(CString("JinMouthStretch_Clock"));
TimeSensor22.setCycleInterval(0.99);
TimeSensor22.setLoop(True);
Scene20.addChild(&TimeSensor22);

EXPORT& EXPORT23 =  EXPORT();
EXPORT23.setLocalDEF(CString("JinMouthStretch_Clock"));
EXPORT23.setAS(CString("JinMouthStretch_Clock"));
Scene20.addChild(&EXPORT23);

ScalarInterpolator& ScalarInterpolator24 =  ScalarInterpolator();
ScalarInterpolator24.setDEF(CString("AnimationAdapter_JinMouthStretch"));
ScalarInterpolator24.setKey(new float[]{0,0.25,0.5,0.75,1}, 5);
ScalarInterpolator24.setKeyValue(new float[]{0,0.5,1,0.5,0}, 5);
...
HAnimJoint26.X3DNode::setName(CString("humanoid_root"));
HAnimJoint26.setDEF(CString("hanim_root"));
HAnimJoint26.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint26.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment27 =  HAnimSegment();
HAnimSegment27.X3DNode::setName(CString("sacrum"));
HAnimSegment27.setDEF(CString("hanim_sacrum"));
WorldInfo& WorldInfo28 =  WorldInfo();
WorldInfo28.setTitle(CString("Tongue.x3d"));
HAnimSegment27.addChild(&WorldInfo28);

Background& Background29 =  Background();
Background29.setSkyColor(new float[]{0.8,0.9,1}, 3);
...
HAnimJoint31.X3DNode::setName(CString("skullbase"));
HAnimJoint31.setDEF(CString("hanim_skullbase"));
HAnimJoint31.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint31.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment32 =  HAnimSegment();
HAnimSegment32.X3DNode::setName(CString("tongue"));
HAnimSegment32.setDEF(CString("hanim_Tongue"));
Transform& Transform33 =  Transform();
Transform33.setDEF(CString("Tongue"));
Transform33.setTranslation(new float[]{0,8.886,11.1});
Shape& Shape34 =  Shape();
Appearance& Appearance35 =  Appearance();
Appearance35.setDEF(CString("BaseAppearance"));
Material& Material36 =  Material();
Material36.setDEF(CString("BaseMaterial"));
Material36.setAmbientIntensity(1);
Material36.setDiffuseColor(new float[]{0.588,0.588,0.588});
Material36.setShininess(0.145);
Appearance35.addChild(&Material36);

ImageTexture& ImageTexture37 =  ImageTexture();
ImageTexture37.setDEF(CString("JinImageAtlas"));
ImageTexture37.setUrl(new CString[]{CString("JinImageAtlas.jpg"), CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/JinImageAtlas.jpg")}, 2);
Appearance35.addChild(&ImageTexture37);

Shape34.addChild(&Appearance35);

IndexedFaceSet& IndexedFaceSet38 =  IndexedFaceSet();
IndexedFaceSet38.setDEF(CString("Tongue-FACES"));
...
TextureCoordinate39.setDEF(CString("Tongue-TEXCOORD"));

...
Background19.setGroundColor(new float[]{0.1,0.1,0,0.4,0.25,0.2,0.6,0.6,0.6}, 9);
...
Background19.setSkyColor(new float[]{0,0.2,0.7,0,0.5,1,1,1,1}, 9);
...
Shape& Shape22 =  Shape();
Box& Box23 =  Box();
Box23.setSize(new float[]{10000,1,10000});
...
Transform26.setRotation(new float[]{0,1,0,1.57});
...
Material29.setEmissiveColor(new float[]{1,1,0});
...
Transform32.setRotation(new float[]{0,1,0,1.57});
Transform32.setScale(new float[]{0.5,0.5,0.5});
Transform32.setTranslation(new float[]{11,5.5,6});
...
Transform51.setTranslation(new float[]{8,0,0});
Shape& Shape52 =  Shape();
Box& Box53 =  Box();
Box53.setSize(new float[]{20,1,1});
...
Transform56.setRotation(new float[]{0,1,0,1.57});
Transform56.setTranslation(new float[]{10,0.5,4.5});
Transform& Transform57 =  Transform();
Transform57.setDEF(CString("launch"));
Transform57.setTranslation(new float[]{0,2,5});
Billboard& Billboard58 =  Billboard();
Shape& Shape59 =  Shape();
Appearance& Appearance60 =  Appearance();
Material& Material61 =  Material();
Material61.setDiffuseColor(new float[]{1,0,0});
...
Transform64.setTranslation(new float[]{2,0.3,0});
Shape& Shape65 =  Shape();
Box& Box66 =  Box();
Box66.setSize(new float[]{5,1,1});
...
Transform100.setRotation(new float[]{0,1,0,-1.67});
Transform& Transform101 =  Transform();
Transform101.setDEF(CString("aft"));
Transform101.setTranslation(new float[]{5,5,15});
Transform& Transform102 =  Transform();
Transform102.setTranslation(new float[]{-2.5,-4.5,-2});
...
Transform104.setTranslation(new float[]{0,3,0});
Shape& Shape105 =  Shape();
Shape105.setDEF(CString("plank"));
Box& Box106 =  Box();
Box106.setSize(new float[]{25,1,1});
...
Transform109.setRotation(new float[]{0,0,1,1});
Transform109.setTranslation(new float[]{-5,10,0});
...
Transform111.setRotation(new float[]{0,0,1,-1});
Transform111.setTranslation(new float[]{5,10,0});
...
Transform113.setRotation(new float[]{0,0,1,1.57});
Transform113.setScale(new float[]{0.9,1,1});
Transform113.setTranslation(new float[]{0,11,0});
...
Transform115.setScale(new float[]{0.4,1,1});
Transform115.setTranslation(new float[]{0,10,0});
...
Transform117.setRotation(new float[]{0,0,1,1.57});
Transform117.setScale(new float[]{0.6,1,1});
Transform117.setTranslation(new float[]{0,5,10});
Transform& Transform118 =  Transform();
Transform118.setRotation(new float[]{0,1,0,0.4});
...
Transform120.setTranslation(new float[]{0,18.2,-0.3});
Shape& Shape121 =  Shape();
Box& Box122 =  Box();
Box122.setSize(new float[]{5,5,0.5});
...
Transform124.setRotation(new float[]{1,0,0,-1.57});
Transform124.setTranslation(new float[]{0,0.6,2.5});
Transform& Transform125 =  Transform();
Transform125.setRotation(new float[]{0,0,1,1.57});
Shape& Shape126 =  Shape();
Extrusion& Extrusion127 =  Extrusion();
Extrusion127.setBeginCap(False);
Extrusion127.setCrossSection(new float[]{1,-0.38,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,-0.38,-1,-1.1,1,-1.1,1,-0.38}, 24);
Extrusion127.setEndCap(False);
Extrusion127.setSolid(False);
Extrusion127.setSpine(new float[]{0,6,0,0,-11,0}, 6);
...
Transform129.setCenter(new float[]{7,0,0});
Transform129.setRotation(new float[]{0,0,1,0.82});
Transform129.setScale(new float[]{0.9,1,1});
Transform129.setTranslation(new float[]{-7,18,2.5});
Transform& Transform130 =  Transform();
Shape& Shape131 =  Shape();
Box& Box132 =  Box();
Box132.setSize(new float[]{35,1,1});
...
Transform134.setTranslation(new float[]{7,0,0});
Shape& Shape135 =  Shape();
Box& Box136 =  Box();
Box136.setSize(new float[]{8,2,2});
...
Extrusion142.setCrossSection(new float[]{0.9,0,0.81,-0.34,0.63,-0.63,0.34,-0.83,0,-0.9,-0.34,-0.81,-0.63,-0.63,-0.81,-0.34,-0.9,0,-0.81,0.34,-0.63,0.63,-0.34,0.81,0,0.9,0.38,0.81,0.63,0.63,0.81,0.34,0.9,0}, 34);
Extrusion142.setEndCap(False);
Extrusion142.setSpine(new float[]{2,0,0,1.85,0,0.77,1.41,0,1.41,0.77,0,1.85,0,0,2,-0.77,0,1.85,-1.41,0,1.41,-1.85,0,0.77,-2,0,0,-1.85,0,-0.77,-1.41,0,-1.41,-0.77,0,-1.85,0,0,-2,0.77,0,-1.85,1.41,0,-1.41,1.85,0,-0.77,2,0,0}, 51);
Shape139.setGeometry(&Extrusion142);

Transform138.addChild(&Shape139);

Transform& Transform143 =  Transform();
Transform143.setTranslation(new float[]{1,0,2});
...
Transform148.setRotation(new float[]{0,0,1,1.2});
Transform148.setScale(new float[]{0.2,0.2,0.2});
Transform148.setTranslation(new float[]{-18.3,0.3,0});
...
Material152.setSpecularColor(new float[]{1,1,1});
...
Transform153.setTranslation(new float[]{0,-2.5,0});
//The Unicorn
...
Transform155.setTranslation(new float[]{-2,0,0});
...
Transform159.setRotation(new float[]{0,0,1,1.2});
Transform159.setTranslation(new float[]{15,55,-11});
Transform& Transform160 =  Transform();
Transform160.setScale(new float[]{5,5,5});
...
Extrusion163.setCrossSection(new float[]{0.1,0,0.092,-0.038,0.071,-0.071,0.038,-0.092,0,-0.1,-0.038,-0.092,-0.071,-0.071,-0.092,-0.038,-0.1,0,-0.092,0.038,-0.071,0.071,-0.038,0.092,0,0.1,0.038,0.092,0.071,0.071,0.092,0.038,0.1,0}, 34);
Extrusion163.setEndCap(False);
Extrusion163.setSolid(False);
Extrusion163.setSpine(new float[]{-15.2,1.4,2.2,-12,-0.8,2.2}, 6);
...
Transform164.setRotation(new float[]{1,0,0,-1.7});
Transform164.setTranslation(new float[]{-17,-4.5,0});
...
Transform167.setTranslation(new float[]{-1,0,1.7});
...
Transform173.setRotation(new float[]{0,0,1,-0.82});
Transform173.setTranslation(new float[]{7,-26,-2.5});
...
Extrusion176.setCrossSection(new float[]{0.1,0,0.092,-0.038,0.071,-0.071,0.038,-0.092,0,-0.1,-0.038,-0.092,-0.071,-0.071,-0.092,-0.038,-0.1,0,-0.092,0.038,-0.071,0.071,-0.038,0.092,0,0.1,0.038,0.092,0.071,0.071,0.092,0.038,0.1,0}, 34);
Extrusion176.setEndCap(False);
Extrusion176.setSolid(False);
Extrusion176.setSpine(new float[]{-33,0.9,2.5,-18.5,1.9,2.55}, 6);
...
Extrusion179.setCrossSection(new float[]{0.1,0,0.092,-0.038,0.071,-0.071,0.038,-0.092,0,-0.1,-0.038,-0.092,-0.071,-0.071,-0.092,-0.038,-0.1,0,-0.092,0.038,-0.071,0.071,-0.038,0.092,0,0.1,0.038,0.092,0.071,0.071,0.092,0.038,0.1,0}, 34);
...
Transform180.setRotation(new float[]{0,0,1,-0.82});
Transform180.setTranslation(new float[]{-4,-15.3,0});
Transform& Transform181 =  Transform();
Transform& Transform182 =  Transform();
Transform182.setRotation(new float[]{0,1,0,-1.57});
Transform182.setScale(new float[]{1,1.3,1});
Transform182.setTranslation(new float[]{0.5,0,-1});
Transform& Transform183 =  Transform();
Transform183.setRotation(new float[]{0,0,1,1.57});
...
Extrusion188.setCrossSection(new float[]{0,0,0,5,0.5,7,1,8,2,9,3,11,3.5,11.2,4,11,5,9,6,8,6.5,7,6.7,5,6.7,0,0,0}, 28);
Extrusion188.setSpine(new float[]{0,0,0,0.1,0,0}, 6);
...
Transform195.setTranslation(new float[]{2,0,0});
...
Transform203.setTranslation(new float[]{1,-1,0});
Shape& Shape204 =  Shape();
Extrusion& Extrusion205 =  Extrusion();
Extrusion205.setBeginCap(False);
Extrusion205.setCreaseAngle(0.785);
Extrusion205.setCrossSection(new float[]{1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0}, 18);
Extrusion205.setEndCap(False);
Extrusion205.setSolid(False);
Extrusion205.setSpine(new float[]{0,-1,0,0,1,0}, 6);
...
Transform211.setTranslation(new float[]{0,0.7,0});
...
Transform220.setRotation(new float[]{0,1,0,1.57});
Transform220.setScale(new float[]{0.4,0.4,0.4});
Transform220.setTranslation(new float[]{0,0.7,0});
...
Transform222.setRotation(new float[]{1,0,0,1.57});
Transform222.setTranslation(new float[]{0,18,2.5});
...
Material226.setDiffuseColor(new float[]{0,0,0});
Material226.setSpecularColor(new float[]{1,1,1});
...
Transform228.setTranslation(new float[]{4,18,1.8});
Shape& Shape229 =  Shape();
Box& Box230 =  Box();
Box230.setSize(new float[]{1,10,0.5});
...
Transform232.setTranslation(new float[]{4,18,3.2});
Shape& Shape233 =  Shape();
Box& Box234 =  Box();
Box234.setSize(new float[]{1,10,0.5});
...
Transform236.setTranslation(new float[]{4,14,2.5});
//CounterWeight
...
Material240.setDiffuseColor(new float[]{0,0,0});
Material240.setSpecularColor(new float[]{1,1,1});
...
Transform241.setRotation(new float[]{1,0,0,1.57});
Transform241.setTranslation(new float[]{4,22,2.5});
...
Material245.setDiffuseColor(new float[]{0,0,0});
Material245.setSpecularColor(new float[]{1,1,1});
...
Transform246.setRotation(new float[]{0,0,1,1.57});
Transform246.setScale(new float[]{0.2,0.2,0.2});
Transform246.setTranslation(new float[]{-11.5,-1,2});
Transform& Transform247 =  Transform();
Transform247.setDEF(CString("screw"));
Transform247.setRotation(new float[]{1,0,0,1.57});
Shape& Shape248 =  Shape();
Shape248.setUSE(CString("Torus"));
Transform247.addChild(&Shape248);

Transform& Transform249 =  Transform();
Transform249.setRotation(new float[]{1,0,0,-1.57});
Transform249.setTranslation(new float[]{0,0,7});
...
Material253.setSpecularColor(new float[]{1,1,1});
...
Transform254.setTranslation(new float[]{0,0,7});
...
Transform256.setRotation(new float[]{1,0,0,-1.57});
Transform256.setTranslation(new float[]{0,0,-3});
...
Transform258.setTranslation(new float[]{0,0,5});
...
Transform264.setRotation(new float[]{0,1,0,1.57});
Transform264.setScale(new float[]{0.6,1,1});
Transform264.setTranslation(new float[]{0,-11,-2.5});
...
Transform266.setRotation(new float[]{0,0,1,-1.57});
Transform266.setScale(new float[]{0.6,1,1});
Transform266.setTranslation(new float[]{0,5,-10});
Transform& Transform267 =  Transform();
Transform267.setRotation(new float[]{0,1,0,0.4});
...
Transform269.setTranslation(new float[]{0,0,0.6});
...
Transform271.setTranslation(new float[]{10,-1,2.5});
Shape& Shape272 =  Shape();
Shape272.setDEF(CString("Axle"));
Box& Box273 =  Box();
Box273.setSize(new float[]{1,1,8});
...
Transform275.setRotation(new float[]{1,0,0,1.57});
Transform275.setTranslation(new float[]{0,0,4.5});
...
Transform282.setTranslation(new float[]{0,0.55,0});
...
Transform286.setRotation(new float[]{1,0,0,1.57});
Transform286.setTranslation(new float[]{0,0,-4.5});
...
Transform289.setTranslation(new float[]{0,-0.55,0});
...
Transform291.setTranslation(new float[]{-10,-1,2.5});
Shape& Shape292 =  Shape();
Shape292.setUSE(CString("Axle"));
Transform291.addChild(&Shape292);

Transform& Transform293 =  Transform();
Transform293.setRotation(new float[]{1,0,0,1.57});
Transform293.setTranslation(new float[]{0,0,4.5});
...
Transform296.setTranslation(new float[]{0,0.55,0});
...
Transform298.setRotation(new float[]{1,0,0,1.57});
Transform298.setTranslation(new float[]{0,0,-4.5});
...
Transform301.setTranslation(new float[]{0,-0.55,0});
...
Transform303.setRotation(new float[]{0,1,0,-0.6});
Transform303.setTranslation(new float[]{0,100,400});
Transform& Transform304 =  Transform();
Transform304.setTranslation(new float[]{1,3,0});
...
Transform310.setTranslation(new float[]{2.5,0,0});
Shape& Shape311 =  Shape();
Box& Box312 =  Box();
Box312.setSize(new float[]{5,0.5,0.5});
...
Transform315.setTranslation(new float[]{0,-1,0});
...
Transform318.setTranslation(new float[]{8,0,0});
Shape& Shape319 =  Shape();
Box& Box320 =  Box();
Box320.setSize(new float[]{17,1,0.5});
...
Transform323.setTranslation(new float[]{14.25,1.25,0});
...
Transform325.setRotation(new float[]{0,1,0,1.57});
Transform325.setTranslation(new float[]{0,1,0});
Viewpoint& Viewpoint326 =  Viewpoint();
Viewpoint326.setDescription(CString("Projectile Cam"));
Viewpoint326.setPosition(new float[]{0,0,15});
...
Transform327.setTranslation(new float[]{20,2,0});
Transform& Transform328 =  Transform();
Transform328.setDEF(CString("Front"));
Transform328.setRotation(new float[]{0,1,0,1.57});
...
Transform330.setTranslation(new float[]{-8,4,0});
Transform& Transform331 =  Transform();
Transform331.setRotation(new float[]{0,1,0,-1.57});
...
PositionInterpolator353.setKey(new float[]{0,0.1,0.2,0.2,0.3,0.9}, 6);
PositionInterpolator353.setKeyValue(new float[]{1.4,1.6,0,1,-8,0,-3.5,-12,0,-3.5,-12,0,1.2,-8,0,1.4,1.6,0}, 18);
...
OrientationInterpolator354.setKey(new float[]{0,0.1,0.2,0.2,0.3,0.9}, 6);
OrientationInterpolator354.setKeyValue(new float[]{0,0,1,0.82,0,0,1,-0.77,0,0,1,-1.57,0,0,1,-1.57,0,0,1,-0.77,0,0,1,0.82}, 24);
...
PositionInterpolator355.setKey(new float[]{0,0.01,0.95,1}, 4);
PositionInterpolator355.setKeyValue(new float[]{0,0,-3,0,0,-10,0,0,-10,0,0,-3}, 12);
...
OrientationInterpolator356.setKey(new float[]{0,0.7,1}, 3);
OrientationInterpolator356.setKeyValue(new float[]{0,0,1,0,0,0,1,-3.14,0,0,1,0}, 12);
...
PositionInterpolator357.setKey(new float[]{0,0.2,0.98,0.99}, 4);
PositionInterpolator357.setKeyValue(new float[]{1,1,1,0.01,0.01,0.01,0.01,0.01,0.01,1,1,1}, 12);

...
Viewpoint* Viewpoint43 = new Viewpoint();
Viewpoint43->setDEF("CameraViewpoint");
IS* IS44 = new IS();
Connect* connect45 = new Connect();
...
NavigationInfo* NavigationInfo52 = new NavigationInfo();
NavigationInfo52->setDEF("CameraNavInfo");
NavigationInfo52->setType(new String[3]{"EXAMINE","FLY","ANY"}, 3);
IS* IS53 = new IS();
...
DirectionalLight* DirectionalLight57 = new DirectionalLight();
...
PositionInterpolator* PositionInterpolator62 = new PositionInterpolator();
...
Viewpoint* Viewpoint89 = new Viewpoint();
...
NavigationInfo* NavigationInfo91 = new NavigationInfo();
...
PositionInterpolator* PositionInterpolator93 = new PositionInterpolator();
...
Connect* connect110 = new Connect();
...
Connect* connect113 = new Connect();
...
//=============== CameraShot ==============
ProtoDeclare* ProtoDeclare131 = new ProtoDeclare();
...
ProtoInterface* ProtoInterface132 = new ProtoInterface();
...
ProtoBody* ProtoBody145 = new ProtoBody();
Script* Script146 = new Script();
...
//=============== CameraMovement ==============
ProtoDeclare* ProtoDeclare175 = new ProtoDeclare();
...
ProtoInterface* ProtoInterface176 = new ProtoInterface();
...
ProtoBody* ProtoBody189 = new ProtoBody();
...
//=============== OfflineRender ==============
ProtoDeclare* ProtoDeclare216 = new ProtoDeclare();
...
ProtoInterface* ProtoInterface217 = new ProtoInterface();
...
ProtoBody* ProtoBody229 = new ProtoBody();
//First node determines node type of this prototype
//Subsequent nodes do not render, but still must be a valid X3D subgraph
Script* Script230 = new Script();
...
Background* Background254 = new Background();
...
Anchor255->setUrl(new String[4]{"CameraExamples.x3d","https://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.x3d","CameraExamples.wrl","https://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.wrl"}, 4);
Transform* Transform256 = new Transform();
Shape* Shape257 = new Shape();
Text* Text258 = new Text();
Text258->setString(new String[5]{"CameraPrototypes.x3d","defines multiple prototype nodes","","Click on this text to see","CameraExamples.x3d scene"}, 5);
FontStyle* FontStyle259 = new FontStyle();
FontStyle259->setJustify(new String[2]{"MIDDLE","MIDDLE"}, 2);
Text258->setFontStyle(FontStyle259);

Shape257->setGeometry(Text258);

Appearance* Appearance260 = new Appearance();
Material* Material261 = new Material();

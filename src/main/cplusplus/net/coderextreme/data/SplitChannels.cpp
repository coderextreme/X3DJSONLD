...
NavigationInfo16.setType(new CString[]{CString("NONE")}, 1);
...
Transform19.setTranslation(new float[]{100,400,400});
Transform& Transform20 =  Transform();
Transform20.setRotation(new float[]{1,0,0,-0.5});
Transform20.setTranslation(new float[]{0,40,0});
Shape& Shape21 =  Shape();
Appearance& Appearance22 =  Appearance();
Appearance22.setDEF(CString("audio_emit"));
Material& Material23 =  Material();
Material23.setDiffuseColor(new float[]{0,1,0});
...
Box& Box24 =  Box();
Box24.setSize(new float[]{10,80,0.01});
...
Transform25.setRotation(new float[]{1,0,0,-0.5});
Transform25.setTranslation(new float[]{-2.7,37,0});
Shape& Shape26 =  Shape();
Appearance& Appearance27 =  Appearance();
Appearance27.setDEF(CString("audio_emit2"));
Material& Material28 =  Material();
Material28.setDiffuseColor(new float[]{0,1,0});
...
ImageTexture29.setUrl(new CString[]{CString("images/line.png"), CString("https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/images/line.png")}, 2);
Appearance27.addChild(&ImageTexture29);

Shape26.addChild(&Appearance27);

Box& Box30 =  Box();
Box30.setSize(new float[]{25,83,0.01});
...
Transform31.setRotation(new float[]{1,0,0,-0.5});
Transform31.setScale(new float[]{10,10,10});
Transform31.setTranslation(new float[]{0,-10,0});
Shape& Shape32 =  Shape();
...
Text& Text35 =  Text();
Text35.setString(new CString[]{CString("Right Channel Volume")}, 1);
CFontStyle& FontStyle36 =  CFontStyle();
FontStyle36.setDEF(CString("VolumeFontStyle"));
FontStyle36.setFamily(new CString[]{CString("Times"), CString("SERIF")}, 2);
...
Transform37.setTranslation(new float[]{-100,400,400});
Transform& Transform38 =  Transform();
Transform38.setRotation(new float[]{1,0,0,-0.5});
Transform38.setTranslation(new float[]{0,40,0});
Shape& Shape39 =  Shape();
Appearance& Appearance40 =  Appearance();
Appearance40.setDEF(CString("audio_emit3"));
Material& Material41 =  Material();
Material41.setDiffuseColor(new float[]{0,1,0});
...
Box& Box42 =  Box();
Box42.setSize(new float[]{10,80,0.01});
...
Transform43.setRotation(new float[]{1,0,0,-0.5});
Transform43.setTranslation(new float[]{13.2,37,0});
Shape& Shape44 =  Shape();
Appearance& Appearance45 =  Appearance();
Appearance45.setDEF(CString("audio_emit4"));
Material& Material46 =  Material();
Material46.setDiffuseColor(new float[]{0,1,0});
...
ImageTexture47.setUrl(new CString[]{CString("images/line.png"), CString("https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/images/line.png")}, 2);
Appearance45.addChild(&ImageTexture47);

Shape44.addChild(&Appearance45);

Box& Box48 =  Box();
Box48.setSize(new float[]{25,83,0.01});
...
Transform49.setScale(new float[]{10,10,10});
Transform49.setTranslation(new float[]{0,-10,0});
Shape& Shape50 =  Shape();
...
Text& Text53 =  Text();
Text53.setString(new CString[]{CString("Left Channel Volume")}, 1);
...
Box& Box59 =  Box();
Box59.setSize(new float[]{1500,10,500});
...
AudioClip69.setUrl(new CString[]{CString("sound/violin.mp3"), CString("https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/violin.mp3")}, 2);
...
Transform70.setRotation(new float[]{1,0,0,-0.5});
Transform70.setTranslation(new float[]{0,100,0});
Shape& Shape71 =  Shape();
Appearance& Appearance72 =  Appearance();
Appearance72.setDEF(CString("audio_emit5"));
Material& Material73 =  Material();
Material73.setDiffuseColor(new float[]{0.3,1,0.3});
...
ImageTexture74.setUrl(new CString[]{CString("images/loudspeaker.png"), CString("https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/images/loudspeaker.png")}, 2);
Appearance72.addChild(&ImageTexture74);

Shape71.addChild(&Appearance72);

Box& Box75 =  Box();
Box75.setSize(new float[]{100,100,0.001});

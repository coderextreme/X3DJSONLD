...
Text& Text123 =  Text();
Text123.setString(new CString[]{CString("LOA1_SwimmingFlutterKickAnimation.x3d"), CString("defines a prototype"), CString("for animating a humanoid."), CString("Click text to see example.")}, 4);

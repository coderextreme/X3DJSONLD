...
HAnimJoint31.setCenter(new float[3]{0.0,31.540001,-0.3172});
...
Transform33.setTranslation(new float[3]{0.0,31.540001,-0.3172});
Shape& Shape34 =  Shape();
...
HAnimJoint121.setCenter(new float[3]{0.0,27.07,-0.3172});
...
Transform123.setTranslation(new float[3]{0.0,27.07,-0.3172});
...
HAnimJoint191.setCenter(new float[3]{0.0,35.75,-0.445});
...
Transform193.setTranslation(new float[3]{0.0,35.75,-0.445});
...
HAnimJoint201.setCenter(new float[3]{0.0,50.470001,-0.1481});
...
Transform203.setTranslation(new float[3]{0.0,50.470001,-0.1481});

...
meta3->setContent(CString("KoreanCharacter04Young.x3d"));
head1->addMeta(meta3);
...
meta13->setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter04Young.x3d"));
...
WorldInfo20->setTitle(CString("KoreanCharacter04Young.x3d"));
...
Viewpoint22->setDescription(CString("Young"));
Viewpoint22->setPosition(new float[3]{0,1,3});
Scene19->addChild(Viewpoint22);

HAnimHumanoid* HAnimHumanoid23 = new HAnimHumanoid();
HAnimHumanoid23->setName(CString("Young"));
HAnimHumanoid23->setDEF(CString("hanim_Young"));
...
ImageTexture37->setDEF(CString("YoungTextureAtlas"));
ImageTexture37->setUrl(new CString[2]{CString("images/Young.png"), CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Young.png")}, 2);
...
ImageTexture47->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture57->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture67->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture77->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture87->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture97->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture107->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture117->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture127->setUSE(CString("YoungTextureAtlas"));
...
Coordinate129->setPoint(new float[186]{0,9.369,0.1256,0,8.719,-2.49,-2.012,8.719,-2.14,-3.486,8.719,-1.717,-4.025,8.719,0.1256,-3.486,8.719,1.968,-2.012,8.719,2.391,0,8.719,2.741,2.012,8.719,2.391,3.486,8.719,1.968,4.025,8.719,0.1256,3.486,8.719,-1.717,2.012,8.719,-2.14,0,6.946,-4.067,-2.603,6.946,-3.506,-4.508,6.946,-1.971,-5.205,6.946,0.1256,-4.508,6.946,2.222,-2.603,6.946,3.213,0,6.946,3.775,2.603,6.946,3.213,4.508,6.946,2.222,5.205,6.946,0.1256,4.508,6.946,-1.971,2.603,6.946,-3.506,0,4.523,-4.423,-3.005,4.523,-3.775,-5.205,4.523,-2.003,-6.011,4.523,0.1256,-5.205,4.523,2.546,-3.005,4.523,3.775,0,4.523,4.423,3.005,4.523,3.775,5.205,4.523,2.546,6.011,4.523,0.1256,5.205,4.523,-2.003,3.005,4.523,-3.775,0,2.1,-3.775,-2.603,2.1,-3.213,-4.508,2.1,-1.678,-5.205,2.1,0.1256,-4.508,2.1,2.222,-2.603,2.1,3.213,0,2.1,3.775,2.603,2.1,3.213,4.508,2.1,2.222,5.205,2.1,0.1255,4.508,2.1,-1.678,2.603,2.1,-3.213,0,0.3265,-2.003,-1.503,0.3265,-1.678,-2.603,0.3265,-1.085,-3.005,0.3265,0.1255,-2.603,0.3265,1.336,-1.503,0.3265,2.222,0,0.3265,2.546,1.503,0.3265,2.222,2.603,0.3265,1.336,3.005,0.3265,0.1255,2.603,0.3265,-1.085,1.503,0.3265,-1.678,0,-0.3227,0.1255}, 186);
...
ImageTexture137->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture147->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture157->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture167->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture177->setUSE(CString("YoungTextureAtlas"));
...
ImageTexture187->setUSE(CString("YoungTextureAtlas"));

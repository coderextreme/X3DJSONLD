...
Material24.setDiffuseColor(new float[]{1,0,0});
...
Transform25.setTranslation(new float[]{1,0,0});
Shape& Shape26 =  Shape();
...
Material50.setDiffuseColor(new float[]{0,1,0});
...
Extrusion51.setCrossSection(new float[]{1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0}, 34);
Extrusion51.setSpine(new float[]{0,-50,0,0,0,0,0,50,0}, 9);
...
PlaneSensor61.setMinPosition(new float[]{-50,-50});
PlaneSensor61.setMaxPosition(new float[]{50,50});

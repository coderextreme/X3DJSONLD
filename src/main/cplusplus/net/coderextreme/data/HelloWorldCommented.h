...
Viewpoint17.setCenterOfRotation(new float[]{0.0,-1.0,0.0});
Viewpoint17.setDescription(CString("Hello world!"));
Viewpoint17.setPosition(new float[]{0.0,-1.0,7.0});
Group16.addChild(&Viewpoint17);

//Viewpoint complete, Transform begin
Transform& Transform18 =  Transform();
Transform18.setRotation(new float[]{0.0,1.0,0.0,3.0});
//Shape begin
Shape& Shape19 =  Shape();
//Sphere begin
...
Transform24.setTranslation(new float[]{0.0,-2.0,0.0});
//Shape begin
Shape& Shape25 =  Shape();
//Text begin

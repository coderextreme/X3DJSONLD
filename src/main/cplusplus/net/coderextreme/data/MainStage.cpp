...
DirectionalLight17.setDirection(new float[]{-1,-1,-1});
...
DirectionalLight18.setDirection(new float[]{1,1,-1});
...
Viewpoint19.setOrientation(new float[]{1,0,0,-0.449999988});
Viewpoint19.setPosition(new float[]{0,4,10});
...
Viewpoint21.setPosition(new float[]{0,1,5});
...
Viewpoint22.setOrientation(new float[]{1,0,0,1.570000052});
Viewpoint22.setPosition(new float[]{0,-10,0});
...
Viewpoint23.setOrientation(new float[]{1,0,0,-1.570000052});
Viewpoint23.setPosition(new float[]{0,15,0});
...
Viewpoint24.setOrientation(new float[]{1,0,0,-1.100000024});
Viewpoint24.setPosition(new float[]{0,8,3});
...
Transform28.setScale(new float[]{1,0.01,1});
Transform28.setTranslation(new float[]{0,-0.01,0});
Shape& Shape29 =  Shape();
...
Material36.setDiffuseColor(new float[]{0.699999988,0,0.899999976});
Material36.setEmissiveColor(new float[]{0.449999988,0.449999988,1});
Material36.setShininess(1);
Material36.setSpecularColor(new float[]{0,0,1});
...
Transform39.setScale(new float[]{0.5,1,0.5});
Shape& Shape40 =  Shape();
...
Transform43.setScale(new float[]{0.25,1,0.25});
Shape& Shape44 =  Shape();
...
Transform47.setScale(new float[]{2,1,2});
Shape& Shape48 =  Shape();
...
Transform51.setScale(new float[]{3,1,3});
Shape& Shape52 =  Shape();

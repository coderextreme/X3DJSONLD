...
meta13->setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter09Ru.x3d");
...
HAnimJoint24->setCenter(new float[3]{0,35.950001,-1.712});
...
Transform26->setTranslation(new float[3]{0,35.950001,-1.712});
...
ImageTexture30->setDEF("RuTextureAtlas");
ImageTexture30->setUrl(new CString[2]{"images/Ru.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/images/Ru.png"}, 2);
...
HAnimJoint34->setCenter(new float[3]{3.602,33.740002,-1.967});
...
Transform36->setTranslation(new float[3]{3.602,33.740002,-1.967});
...
ImageTexture40->setUSE("RuTextureAtlas");
...
HAnimJoint44->setCenter(new float[3]{3.931,18.23,-1.935});
...
Transform46->setTranslation(new float[3]{3.931,18.23,-1.935});
...
ImageTexture50->setUSE("RuTextureAtlas");
...
HAnimJoint54->setCenter(new float[3]{4.077,4.031,-1.998});
...
Transform56->setTranslation(new float[3]{4.077,4.031,-1.998});
...
ImageTexture60->setUSE("RuTextureAtlas");
...
HAnimJoint64->setCenter(new float[3]{4.077,3.104,-0.9239});
...
Transform66->setTranslation(new float[3]{4.077,3.104,-0.9239});
...
ImageTexture70->setUSE("RuTextureAtlas");
...
HAnimJoint74->setCenter(new float[3]{-3.602,33.740002,-1.967});
...
Transform76->setTranslation(new float[3]{-3.602,33.740002,-1.967});
...
ImageTexture80->setUSE("RuTextureAtlas");
...
HAnimJoint84->setCenter(new float[3]{-3.931,18.23,-1.935});
...
Transform86->setTranslation(new float[3]{-3.931,18.23,-1.935});
...
ImageTexture90->setUSE("RuTextureAtlas");
...
HAnimJoint94->setCenter(new float[3]{-4.077,4.031,-1.998});
...
Transform96->setTranslation(new float[3]{-4.077,4.031,-1.998});
...
ImageTexture100->setUSE("RuTextureAtlas");
...
HAnimJoint104->setCenter(new float[3]{-4.077,3.104,-0.9239});
...
Transform106->setTranslation(new float[3]{-4.077,3.104,-0.9239});
...
ImageTexture110->setUSE("RuTextureAtlas");
...
HAnimJoint114->setCenter(new float[3]{0,32.209999,-2.058});
...
Transform116->setTranslation(new float[3]{0,32.209999,-2.058});
...
ImageTexture120->setUSE("RuTextureAtlas");
...
HAnimJoint124->setCenter(new float[3]{6.479,53.209999,-2.007});
...
Transform126->setTranslation(new float[3]{6.479,53.209999,-2.007});
...
ImageTexture130->setUSE("RuTextureAtlas");
...
HAnimJoint134->setCenter(new float[3]{7.489,44.990002,-2.016});
...
Transform136->setTranslation(new float[3]{7.489,44.990002,-2.016});
...
ImageTexture140->setUSE("RuTextureAtlas");
...
HAnimJoint144->setCenter(new float[3]{7.938,35.98,-1.856});
...
Transform146->setTranslation(new float[3]{7.938,35.98,-1.856});
...
ImageTexture150->setUSE("RuTextureAtlas");
...
HAnimJoint154->setCenter(new float[3]{-6.479,53.209999,-2.007});
...
Transform156->setTranslation(new float[3]{-6.479,53.209999,-2.007});
...
ImageTexture160->setUSE("RuTextureAtlas");
...
HAnimJoint164->setCenter(new float[3]{-7.489,44.990002,-2.016});
...
Transform166->setTranslation(new float[3]{-7.489,44.990002,-2.016});
...
ImageTexture170->setUSE("RuTextureAtlas");
...
HAnimJoint174->setCenter(new float[3]{-7.938,35.98,-1.856});
...
Transform176->setTranslation(new float[3]{-7.938,35.98,-1.856});
...
ImageTexture180->setUSE("RuTextureAtlas");
...

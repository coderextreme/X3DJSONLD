...
PositionInterpolator58->setKeyValue(new float[12]{0,0,0,0,-0.049999,0,0,-0.195,0,0,-0.439997,0}, 12);
IS* IS59 = new IS();
...
OrientationInterpolator64->setKeyValue(new float[16]{1,0,0,0,-1,0,0,0.619393,-1,0,0,1.069302,-1,0,0,1.937315}, 16);
IS* IS65 = new IS();
...
OrientationInterpolator67->setKeyValue(new float[16]{1,0,0,0,1,0,0,0.615228,1,0,0,0.984524,1,0,0,2.076941}, 16);
IS* IS68 = new IS();
...
OrientationInterpolator70->setKeyValue(new float[16]{1,0,0,0,-1,0,0,0.017453,-1,0,0,0.069812,1,0,0,0.261799}, 16);
IS* IS71 = new IS();
...
OrientationInterpolator73->setKeyValue(new float[12]{1,0,0,0,1,0,0,0.523598,-1,0,0,0.157079}, 12);
IS* IS74 = new IS();
...
OrientationInterpolator76->setKeyValue(new float[16]{1,0,0,0,1,0,0,0.349065,1,0,0,1.023397,0.999934,0.008043,0.008185,1.727938}, 16);
IS* IS77 = new IS();
...
OrientationInterpolator79->setKeyValue(new float[16]{1,0,0,0,-0.991692,-0.072372,0.106338,0.205053,-0.981083,-0.103267,0.163741,0.272231,-1,0,0,0.349065}, 16);
IS* IS80 = new IS();
...
OrientationInterpolator82->setKeyValue(new float[8]{1,0,0,0,1,0,0,0.174533}, 8);
IS* IS83 = new IS();
...
OrientationInterpolator85->setKeyValue(new float[16]{1,0,0,0,-1,0,0,0.279252,-1,0,0,0.506145,-1,0,0,0.191986}, 16);
IS* IS86 = new IS();
...
OrientationInterpolator88->setKeyValue(new float[16]{1,0,0,0,-1,0,0,0.052359,-1,0,0,0.296706,-1,0,0,1.431169}, 16);
IS* IS89 = new IS();
...
OrientationInterpolator91->setKeyValue(new float[16]{1,0,0,0,-1,0,0,0.104719,-1,0,0,0.157079,1,0,0,0.314159}, 16);
IS* IS92 = new IS();
...
OrientationInterpolator94->setKeyValue(new float[16]{1,0,0,0,-1,0,0,0.837757,-1,0,0,1.239183,-1,0,0,1.500983}, 16);
IS* IS95 = new IS();
...
CFontStyle* FontStyle113 = new CFontStyle();

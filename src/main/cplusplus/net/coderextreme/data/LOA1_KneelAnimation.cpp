...
PositionInterpolator58.setKey(new float[]{0,0.3125,0.625,1}, 4);
PositionInterpolator58.setKeyValue(new float[]{0,0,0,0,-0.049999,0,0,-0.195,0,0,-0.439997,0}, 12);
IS& IS59 =  IS();
...
OrientationInterpolator61.setKey(new float[]{0,1}, 2);
OrientationInterpolator61.setKeyValue(new float[]{0,1,0,0,0,1,0,0}, 8);
IS& IS62 =  IS();
...
OrientationInterpolator64.setKey(new float[]{0,0.3125,0.625,1}, 4);
OrientationInterpolator64.setKeyValue(new float[]{1,0,0,0,-1,0,0,0.619393,-1,0,0,1.069302,-1,0,0,1.937315}, 16);
IS& IS65 =  IS();
...
OrientationInterpolator67.setKey(new float[]{0,0.3125,0.625,1}, 4);
OrientationInterpolator67.setKeyValue(new float[]{1,0,0,0,1,0,0,0.615228,1,0,0,0.984524,1,0,0,2.076941}, 16);
IS& IS68 =  IS();
...
OrientationInterpolator70.setKey(new float[]{0,0.3125,0.625,1}, 4);
OrientationInterpolator70.setKeyValue(new float[]{1,0,0,0,-1,0,0,0.017453,-1,0,0,0.069812,1,0,0,0.261799}, 16);
IS& IS71 =  IS();
...
OrientationInterpolator73.setKey(new float[]{0,0.3125,1}, 3);
OrientationInterpolator73.setKeyValue(new float[]{1,0,0,0,1,0,0,0.523598,-1,0,0,0.157079}, 12);
IS& IS74 =  IS();
...
OrientationInterpolator76.setKey(new float[]{0,0.3125,0.625,1}, 4);
OrientationInterpolator76.setKeyValue(new float[]{1,0,0,0,1,0,0,0.349065,1,0,0,1.023397,0.999934,0.008043,0.008185,1.727938}, 16);
IS& IS77 =  IS();
...
OrientationInterpolator79.setKey(new float[]{0,0.3125,0.625,1}, 4);
OrientationInterpolator79.setKeyValue(new float[]{1,0,0,0,-0.991692,-0.072372,0.106338,0.205053,-0.981083,-0.103267,0.163741,0.272231,-1,0,0,0.349065}, 16);
IS& IS80 =  IS();
...
OrientationInterpolator82.setKey(new float[]{0,1}, 2);
OrientationInterpolator82.setKeyValue(new float[]{1,0,0,0,1,0,0,0.174533}, 8);
IS& IS83 =  IS();
...
OrientationInterpolator85.setKey(new float[]{0,0.3125,0.625,1}, 4);
OrientationInterpolator85.setKeyValue(new float[]{1,0,0,0,-1,0,0,0.279252,-1,0,0,0.506145,-1,0,0,0.191986}, 16);
IS& IS86 =  IS();
...
OrientationInterpolator88.setKey(new float[]{0,0.3125,0.625,1}, 4);
OrientationInterpolator88.setKeyValue(new float[]{1,0,0,0,-1,0,0,0.052359,-1,0,0,0.296706,-1,0,0,1.431169}, 16);
IS& IS89 =  IS();
...
OrientationInterpolator91.setKey(new float[]{0,0.3125,0.625,1}, 4);
OrientationInterpolator91.setKeyValue(new float[]{1,0,0,0,-1,0,0,0.104719,-1,0,0,0.157079,1,0,0,0.314159}, 16);
IS& IS92 =  IS();
...
OrientationInterpolator94.setKey(new float[]{0,0.3125,0.625,1}, 4);
OrientationInterpolator94.setKeyValue(new float[]{1,0,0,0,-1,0,0,0.837757,-1,0,0,1.239183,-1,0,0,1.500983}, 16);
IS& IS95 =  IS();
...
Text& Text112 =  Text();
Text112.setString(new CString[]{CString("LOA1_KneelAnimation.x3d"), CString("defines a prototype"), CString("for animating a humanoid."), CString("Click this text to see"), CString("InterchangableActorsViaDynamicRouting example.")}, 5);
...
Material115.setDiffuseColor(new float[]{1,1,0.2});

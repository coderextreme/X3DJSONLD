...
meta3.setContent(CString("JinOriginalLOA3.x3d"));
head1.addMeta(&meta3);
...
meta14.setContent(CString("JinLOA3.x3d"));
...
meta16.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA3.x3d"));
...
WorldInfo21.setTitle(CString("JinOriginalLOA3.x3d"));

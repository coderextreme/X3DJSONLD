...
Text23->setString(new String[1]{"Y"}, 1);
FontStyle* FontStyle24 = new FontStyle();
FontStyle24->setDEF("LABEL_FONT");
FontStyle24->setFamily(new String[1]{"SANS"}, 1);
FontStyle24->setSize(0.2);
FontStyle24->setJustify(new String[1]{"MIDDLE"}, 1);
...
Text32->setString(new String[1]{"X"}, 1);
...
Text41->setString(new String[1]{"Z"}, 1);

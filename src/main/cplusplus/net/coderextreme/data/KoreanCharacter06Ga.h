...
HAnimJoint31.setCenter(new float[]{0.0,32.310001,-0.7076});
...
Transform33.setTranslation(new float[]{0.0,32.310001,-0.7076});
Shape& Shape34 =  Shape();
...
HAnimJoint121.setCenter(new float[]{0.0,29.389999,-0.3829});
...
Transform123.setTranslation(new float[]{0.0,29.389999,-0.3829});
...
HAnimJoint191.setCenter(new float[]{0.0,34.389999,-0.1643});
...
Transform193.setTranslation(new float[]{0.0,34.389999,-0.1643});
...
HAnimJoint201.setCenter(new float[]{0.0,52.639999,-0.209});
...
Transform203.setTranslation(new float[]{0.0,52.639999,-0.209});

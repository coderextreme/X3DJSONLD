...
WorldInfo13->setTitle("SimpleCamera.x3d");
WorldInfo13->setInfo(new CString[1]{"VRML2.0 created with Version 1.3, from Alias Maya 2008"}, 1);
group->addChildren(*WorldInfo13);

CViewpoint* Viewpoint14 = (CViewpoint *)(m_pScene.createNode("Viewpoint"));
Viewpoint14->setDEF("CameraShapeView");
Viewpoint14->setDescription("Camera view, over the shoulder");
Viewpoint14->setPosition(new float[3]{0,0.75,3});
group->addChildren(*Viewpoint14);

CViewpoint* Viewpoint15 = (CViewpoint *)(m_pScene.createNode("Viewpoint"));
Viewpoint15->setDescription("Camera view through lens");
Viewpoint15->setPosition(new float[3]{0,0,0});
group->addChildren(*Viewpoint15);

CViewpoint* Viewpoint16 = (CViewpoint *)(m_pScene.createNode("Viewpoint"));
Viewpoint16->setDescription("Camera view from right side");
Viewpoint16->setPosition(new float[3]{12,0,-4});
Viewpoint16->setOrientation(new float[4]{0,1,0,1.5708});
group->addChildren(*Viewpoint16);

CViewpoint* Viewpoint17 = (CViewpoint *)(m_pScene.createNode("Viewpoint"));
Viewpoint17->setDescription("Camera view from above");
Viewpoint17->setPosition(new float[3]{0,15,-5});
Viewpoint17->setOrientation(new float[4]{1,0,0,-1.5708});
group->addChildren(*Viewpoint17);

CViewpoint* Viewpoint18 = (CViewpoint *)(m_pScene.createNode("Viewpoint"));
Viewpoint18->setDescription("Camera view from left side");
Viewpoint18->setPosition(new float[3]{-12,0,-4});
Viewpoint18->setOrientation(new float[4]{0,1,0,-1.5708});
group->addChildren(*Viewpoint18);

CTransform* Transform19 = (CTransform *)(m_pScene.createNode("Transform"));
Transform19->setTranslation(new float[3]{0,-0.165,0.02});
Transform19->setScale(new float[3]{0.1,0.1,0.1});
CSwitch* Switch20 = (CSwitch *)(m_pScene.createNode("Switch"));
CShape* Shape21 = (CShape *)(m_pScene.createNode("Shape"));
CAppearance* Appearance22 = (CAppearance *)(m_pScene.createNode("Appearance"));
Appearance22->setDEF("CameraAppearance");
CMaterial* Material23 = (CMaterial *)(m_pScene.createNode("Material"));
Material23->setDEF("lambert1_1");
Material23->setAmbientIntensity(0.25);
Material23->setDiffuseColor(new float[3]{0.372322,0.371574,0.373173});
Material23->setSpecularColor(new float[3]{0.890909,0.887832,0.890909});
Material23->setShininess(0.02);
Appearance22->setMaterial(*Material23);

Shape21->setAppearance(*Appearance22);

Switch20->addChildren(*Shape21);

CShape* Shape24 = (CShape *)(m_pScene.createNode("Shape"));
CAppearance* Appearance25 = (CAppearance *)(m_pScene.createNode("Appearance"));
Appearance25->setUSE("CameraAppearance");

...
meta3.setContent(CString("DiamondManLOA2.x3d"));
head1.addMeta(&meta3);

meta& meta4 =  meta();
meta4.setName(CString("description"));
meta4.setContent(CString("HAnim skeletal structure at level of articulation two, one diamond at the base node for the structure, blue spheres for HAnimSite feaature points"));
head1.addMeta(&meta4);
...
meta9.setContent(CString("Mon, 15 Sep 2025 05:18:47 GMT"));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(CString("Image"));
meta10.setContent(CString("DiamondManLOA2.png"));
head1.addMeta(&meta10);

meta& meta11 =  meta();
meta11.setName(CString("Image"));
meta11.setContent(CString("images/BonesAllSkeletonFrontViewLOA2.png"));
...
meta13.setContent(CString("The joint centers of this figure are based on the work of Norman Badler, director of the Center for Human Modeling and Simulation at the University of Pennsylvania. The original document which these joint centers are based on can be found at: http://www.cis.upenn.edu/~badler/anthro/89-71.ps"));
head1.addMeta(&meta13);

meta& meta14 =  meta();
meta14.setName(CString("subject"));
meta14.setContent(CString("human animation, x3d, vrml, animation"));
head1.addMeta(&meta14);

meta& meta15 =  meta();
meta15.setName(CString("identifier"));
meta15.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA2.x3d"));
...
Viewpoint19.setDescription(CString("Diamond Man, LOA 2"));
Viewpoint19.setPosition(new float[]{0.0,1.0,3.0});
Viewpoint19.setCenterOfRotation(new float[]{0.0,1.0,0.0});
Scene16.addChild(&Viewpoint19);

Transform& Transform20 =  Transform();
Transform20.setTranslation(new float[]{1.0,1.5,0.0});
Billboard& Billboard21 =  Billboard();
Shape& Shape22 =  Shape();
Appearance& Appearance23 =  Appearance();
Material& Material24 =  Material();
Material24.setDEF(CString("TextMaterial"));
Material24.setDiffuseColor(new float[]{0.9,0.9,0.9});
Appearance23.addChild(&Material24);

Shape22.addChild(&Appearance23);

Text& Text25 =  Text();
Text25.setString(new CString[]{CString("Diamond Man Key")}, 1);
...
Transform27.setTranslation(new float[]{0.0,-0.3,0.0});
Shape& Shape28 =  Shape();
Appearance& Appearance29 =  Appearance();
Material& Material30 =  Material();
Material30.setDEF(CString("MIN_COLOR"));
...
Transform32.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape33 =  Shape();
Appearance& Appearance34 =  Appearance();
Material& Material35 =  Material();
Material35.setUSE(CString("TextMaterial"));
Appearance34.addChild(&Material35);

Shape33.addChild(&Appearance34);

Text& Text36 =  Text();
Text36.setString(new CString[]{CString("Minimal Humanoid Joints")}, 1);
CFontStyle& FontStyle37 =  CFontStyle();
FontStyle37.setFamily(new CString[]{CString("SANS")}, 1);
...
Transform38.setTranslation(new float[]{0.0,-0.5,0.0});
Shape& Shape39 =  Shape();
Appearance& Appearance40 =  Appearance();
Material& Material41 =  Material();
Material41.setDEF(CString("JOINT_COLOR"));
...
Transform43.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape44 =  Shape();
Appearance& Appearance45 =  Appearance();
Material& Material46 =  Material();
Material46.setUSE(CString("TextMaterial"));
Appearance45.addChild(&Material46);

Shape44.addChild(&Appearance45);

Text& Text47 =  Text();
Text47.setString(new CString[]{CString("Humanoid Joints")}, 1);
CFontStyle& FontStyle48 =  CFontStyle();
FontStyle48.setFamily(new CString[]{CString("SANS")}, 1);
...
Transform49.setTranslation(new float[]{0.0,-0.7,0.0});
Shape& Shape50 =  Shape();
Appearance& Appearance51 =  Appearance();
Material& Material52 =  Material();
Material52.setDEF(CString("REC_SPINAL_COLOR"));
Material52.setDiffuseColor(new float[]{1.0,0.0,1.0});
...
Transform54.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape55 =  Shape();
Appearance& Appearance56 =  Appearance();
Material& Material57 =  Material();
Material57.setUSE(CString("TextMaterial"));
Appearance56.addChild(&Material57);

Shape55.addChild(&Appearance56);

Text& Text58 =  Text();
Text58.setString(new CString[]{CString("Recommended Spinal Joints")}, 1);
...
Transform60.setTranslation(new float[]{0.0,-0.9,0.0});
Shape& Shape61 =  Shape();
Appearance& Appearance62 =  Appearance();
Material& Material63 =  Material();
Material63.setDEF(CString("SPINAL_COLOR"));
Material63.setDiffuseColor(new float[]{0.0,1.0,0.0});
...
Transform65.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape66 =  Shape();
Appearance& Appearance67 =  Appearance();
Material& Material68 =  Material();
Material68.setUSE(CString("TextMaterial"));
Appearance67.addChild(&Material68);

Shape66.addChild(&Appearance67);

Text& Text69 =  Text();
Text69.setString(new CString[]{CString("Spinal Joints")}, 1);
CFontStyle& FontStyle70 =  CFontStyle();
FontStyle70.setFamily(new CString[]{CString("SANS")}, 1);
...
Transform71.setTranslation(new float[]{0.0,-1.3,0.0});
Shape& Shape72 =  Shape();
Appearance& Appearance73 =  Appearance();
Material& Material74 =  Material();
Material74.setDEF(CString("SITE_COLOR"));
Material74.setDiffuseColor(new float[]{0.0,0.0,1.0});
...
Transform76.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape77 =  Shape();
Appearance& Appearance78 =  Appearance();
Material& Material79 =  Material();
Material79.setUSE(CString("TextMaterial"));
Appearance78.addChild(&Material79);

Shape77.addChild(&Appearance78);

Text& Text80 =  Text();
Text80.setString(new CString[]{CString("Humanoid Sites")}, 1);
CFontStyle& FontStyle81 =  CFontStyle();
FontStyle81.setFamily(new CString[]{CString("SANS")}, 1);
...
Transform82.setTranslation(new float[]{0.0,-1.1,0.0});
Shape& Shape83 =  Shape();
Appearance& Appearance84 =  Appearance();
Material& Material85 =  Material();
Material85.setDEF(CString("HAND_FEET_COLOR"));
Material85.setDiffuseColor(new float[]{0.0,1.0,1.0});
...
Transform87.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape88 =  Shape();
Appearance& Appearance89 =  Appearance();
Material& Material90 =  Material();
Material90.setUSE(CString("TextMaterial"));
Appearance89.addChild(&Material90);

Shape88.addChild(&Appearance89);

Text& Text91 =  Text();
Text91.setString(new CString[]{CString("Hand & Feet Joints")}, 1);
CFontStyle& FontStyle92 =  CFontStyle();
FontStyle92.setFamily(new CString[]{CString("SANS")}, 1);
...
HAnimHumanoid& HAnimHumanoid93 =  HAnimHumanoid();
HAnimHumanoid93.setDEF(CString("hanim_humanoid"));
HAnimHumanoid93.X3DNode::setName(CString("humanoid"));
HAnimHumanoid93.setLoa(2);
MetadataSet& MetadataSet94 =  MetadataSet();
MetadataSet94.X3DNode::setName(CString("HAnimHumanoid.info"));
MetadataSet94.X3DNode::setReference(CString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid"));
MetadataString& MetadataString95 =  MetadataString();
MetadataString95.X3DNode::setName(CString("humanoidVersion"));
MetadataSet94.setValue((X3DNode *)&MetadataString95);

MetadataString& MetadataString96 =  MetadataString();
MetadataString96.X3DNode::setName(CString("authorEmail"));
MetadataSet94.setValue((X3DNode *)&MetadataString96);

MetadataString& MetadataString97 =  MetadataString();
MetadataString97.X3DNode::setName(CString("authorName"));
MetadataSet94.setValue((X3DNode *)&MetadataString97);

HAnimHumanoid93.setMetadata(&MetadataSet94);

HAnimJoint& HAnimJoint98 =  HAnimJoint();
HAnimJoint98.setDEF(CString("hanim_humanoid_root"));
...
HAnimSite189.setDEF(CString("hanim_l_femoral_lateral_epicondyle_pt"));
HAnimSite189.X3DNode::setName(CString("l_femoral_lateral_epicondyle_pt"));
...
HAnimSite195.setDEF(CString("hanim_l_femoral_medial_epicondyle_pt"));
HAnimSite195.X3DNode::setName(CString("l_femoral_medial_epicondyle_pt"));
...
HAnimJoint209.setDEF(CString("hanim_l_talocrural"));
HAnimJoint209.X3DNode::setName(CString("l_talocrural"));
HAnimJoint209.setCenter(new float[]{0.1101,0.0656,-0.0736});
HAnimSegment& HAnimSegment210 =  HAnimSegment();
HAnimSegment210.setDEF(CString("hanim_l_talus"));
HAnimSegment210.X3DNode::setName(CString("l_talus"));
...
HAnimSite235.setDEF(CString("hanim_l_calcaneus_posterior_pt"));
HAnimSite235.X3DNode::setName(CString("l_calcaneus_posterior_pt"));
...
HAnimJoint241.setDEF(CString("hanim_l_tarsometatarsal_2"));
HAnimJoint241.X3DNode::setName(CString("l_tarsometatarsal_2"));
HAnimJoint241.setCenter(new float[]{0.1086,0.0001,-0.0368});
HAnimSegment& HAnimSegment242 =  HAnimSegment();
HAnimSegment242.setDEF(CString("hanim_l_metatarsal_2"));
HAnimSegment242.X3DNode::setName(CString("l_metatarsal_2"));
...
HAnimSite263.setDEF(CString("hanim_l_metatarsal_phalanx_1_pt"));
HAnimSite263.X3DNode::setName(CString("l_metatarsal_phalanx_1_pt"));
...
HAnimJoint269.setDEF(CString("hanim_l_tarsal_distal_interphalangeal_2"));
HAnimJoint269.X3DNode::setName(CString("l_tarsal_distal_interphalangeal_2"));
HAnimJoint269.setCenter(new float[]{0.1086,0.0,0.0762});
HAnimSegment& HAnimSegment270 =  HAnimSegment();
HAnimSegment270.setDEF(CString("hanim_l_tarsal_distal_phalanx_2"));
HAnimSegment270.X3DNode::setName(CString("l_tarsal_distal_phalanx_2"));
...
HAnimSite283.setDEF(CString("hanim_l_metatarsal_phalanx_5_pt"));
HAnimSite283.X3DNode::setName(CString("l_metatarsal_phalanx_5_pt"));
...
HAnimSite289.setDEF(CString("hanim_l_tarsal_distal_phalanx_2_pt"));
HAnimSite289.X3DNode::setName(CString("l_tarsal_distal_phalanx_2_pt"));
...
HAnimSite309.setDEF(CString("hanim_r_femoral_lateral_epicondyle_pt"));
HAnimSite309.X3DNode::setName(CString("r_femoral_lateral_epicondyle_pt"));
...
HAnimSite315.setDEF(CString("hanim_r_femoral_medial_epicondyle_pt"));
HAnimSite315.X3DNode::setName(CString("r_femoral_medial_epicondyle_pt"));
...
HAnimJoint329.setDEF(CString("hanim_r_talocrural"));
HAnimJoint329.X3DNode::setName(CString("r_talocrural"));
HAnimJoint329.setCenter(new float[]{-0.0801,0.0712,-0.0766});
HAnimSegment& HAnimSegment330 =  HAnimSegment();
HAnimSegment330.setDEF(CString("hanim_r_talus"));
HAnimSegment330.X3DNode::setName(CString("r_talus"));
...
HAnimSite355.setDEF(CString("hanim_r_calcaneus_posterior_pt"));
HAnimSite355.X3DNode::setName(CString("r_calcaneus_posterior_pt"));
...
HAnimJoint361.setDEF(CString("hanim_r_metatarsophalangeal_2"));
HAnimJoint361.X3DNode::setName(CString("r_metatarsophalangeal_2"));
HAnimJoint361.setCenter(new float[]{-0.0801,0.0,0.0368});
HAnimSegment& HAnimSegment362 =  HAnimSegment();
HAnimSegment362.setDEF(CString("hanim_r_tarsal_proximal_phalanx_2"));
HAnimSegment362.X3DNode::setName(CString("r_tarsal_proximal_phalanx_2"));
...
HAnimSite375.setDEF(CString("hanim_r_metatarsal_phalanx_5_pt"));
HAnimSite375.X3DNode::setName(CString("r_metatarsal_phalanx_5_pt"));
...
HAnimSite381.setDEF(CString("hanim_r_metatarsal_phalanx_1_pt"));
HAnimSite381.X3DNode::setName(CString("r_metatarsal_phalanx_1_pt"));
...
HAnimSite387.setDEF(CString("hanim_r_tarsal_distal_phalanx_2_pt"));
HAnimSite387.X3DNode::setName(CString("r_tarsal_distal_phalanx_2_pt"));
...
HAnimSite538.setDEF(CString("hanim_l_humeral_lateral_epicondyle_pt"));
HAnimSite538.X3DNode::setName(CString("l_humeral_lateral_epicondyle_pt"));
...
HAnimSite565.setDEF(CString("hanim_l_humeral_medial_epicondyle_pt"));
HAnimSite565.X3DNode::setName(CString("l_humeral_medial_epicondyle_pt"));
...
HAnimJoint577.setDEF(CString("hanim_l_radiocarpal"));
HAnimJoint577.X3DNode::setName(CString("l_radiocarpal"));
HAnimJoint577.setCenter(new float[]{0.1984,0.8663,-0.0583});
HAnimSegment& HAnimSegment578 =  HAnimSegment();
HAnimSegment578.setDEF(CString("hanim_l_carpal"));
HAnimSegment578.X3DNode::setName(CString("l_carpal"));
...
HAnimSite592.setDEF(CString("hanim_l_metacarpal_phalanx_2_pt"));
HAnimSite592.X3DNode::setName(CString("l_metacarpal_phalanx_2_pt"));
...
HAnimSite610.setDEF(CString("hanim_l_metacarpal_phalanx_5_pt"));
HAnimSite610.X3DNode::setName(CString("l_metacarpal_phalanx_5_pt"));
...
HAnimJoint616.setDEF(CString("hanim_l_carpometacarpal_1"));
HAnimJoint616.X3DNode::setName(CString("l_carpometacarpal_1"));
HAnimJoint616.setCenter(new float[]{0.1924,0.8472,-0.0534});
HAnimSegment& HAnimSegment617 =  HAnimSegment();
HAnimSegment617.setDEF(CString("hanim_l_metacarpal_1"));
HAnimSegment617.X3DNode::setName(CString("l_metacarpal_1"));
...
HAnimJoint624.setDEF(CString("hanim_l_metacarpophalangeal_1"));
HAnimJoint624.X3DNode::setName(CString("l_metacarpophalangeal_1"));
HAnimJoint624.setCenter(new float[]{0.1951,0.8226,0.0246});
HAnimSegment& HAnimSegment625 =  HAnimSegment();
HAnimSegment625.setDEF(CString("hanim_l_carpal_proximal_phalanx_1"));
HAnimSegment625.X3DNode::setName(CString("l_carpal_proximal_phalanx_1"));
...
HAnimJoint632.setDEF(CString("hanim_l_carpal_interphalangeal_1"));
HAnimJoint632.X3DNode::setName(CString("l_carpal_interphalangeal_1"));
HAnimJoint632.setCenter(new float[]{0.1955,0.8159,0.0464});
HAnimSegment& HAnimSegment633 =  HAnimSegment();
HAnimSegment633.setDEF(CString("hanim_l_carpal_distal_phalanx_1"));
HAnimSegment633.X3DNode::setName(CString("l_carpal_distal_phalanx_1"));
...
HAnimSite640.setDEF(CString("hanim_l_carpal_distal_phalanx_1_tip"));
HAnimSite640.X3DNode::setName(CString("l_carpal_distal_phalanx_1_tip"));
...
HAnimJoint646.setDEF(CString("hanim_l_carpometacarpal_2"));
HAnimJoint646.X3DNode::setName(CString("l_carpometacarpal_2"));
HAnimJoint646.setCenter(new float[]{0.1983,0.8024,-0.028});
HAnimSegment& HAnimSegment647 =  HAnimSegment();
HAnimSegment647.setDEF(CString("hanim_l_metacarpal_2"));
HAnimSegment647.X3DNode::setName(CString("l_metacarpal_2"));
...
HAnimJoint654.setDEF(CString("hanim_l_metacarpophalangeal_2"));
HAnimJoint654.X3DNode::setName(CString("l_metacarpophalangeal_2"));
HAnimJoint654.setCenter(new float[]{0.1983,0.7815,-0.028});
HAnimSegment& HAnimSegment655 =  HAnimSegment();
HAnimSegment655.setDEF(CString("hanim_l_carpal_proximal_phalanx_2"));
HAnimSegment655.X3DNode::setName(CString("l_carpal_proximal_phalanx_2"));
...
HAnimJoint662.setDEF(CString("hanim_l_carpal_proximal_interphalangeal_2"));
HAnimJoint662.X3DNode::setName(CString("l_carpal_proximal_interphalangeal_2"));
HAnimJoint662.setCenter(new float[]{0.2017,0.7363,-0.0248});
HAnimSegment& HAnimSegment663 =  HAnimSegment();
HAnimSegment663.setDEF(CString("hanim_l_carpal_middle_phalanx_2"));
HAnimSegment663.X3DNode::setName(CString("l_carpal_middle_phalanx_2"));
...
HAnimJoint670.setDEF(CString("hanim_l_carpal_distal_interphalangeal_2"));
HAnimJoint670.X3DNode::setName(CString("l_carpal_distal_interphalangeal_2"));
HAnimJoint670.setCenter(new float[]{0.2028,0.7139,-0.0236});
HAnimSegment& HAnimSegment671 =  HAnimSegment();
HAnimSegment671.setDEF(CString("hanim_l_carpal_distal_phalanx_2"));
HAnimSegment671.X3DNode::setName(CString("l_carpal_distal_phalanx_2"));
...
HAnimSite678.setDEF(CString("hanim_l_carpal_distal_phalanx_2_tip"));
HAnimSite678.X3DNode::setName(CString("l_carpal_distal_phalanx_2_tip"));
...
HAnimSite693.setDEF(CString("hanim_r_humeral_lateral_epicondyle_pt"));
HAnimSite693.X3DNode::setName(CString("r_humeral_lateral_epicondyle_pt"));
...
HAnimSite720.setDEF(CString("hanim_r_humeral_medial_epicondyle_pt"));
HAnimSite720.X3DNode::setName(CString("r_humeral_medial_epicondyle_pt"));
...
HAnimJoint732.setDEF(CString("hanim_r_radiocarpal"));
HAnimJoint732.X3DNode::setName(CString("r_radiocarpal"));
HAnimJoint732.setCenter(new float[]{-0.1959,0.8694,-0.0521});
HAnimSegment& HAnimSegment733 =  HAnimSegment();
HAnimSegment733.setDEF(CString("hanim_r_carpal"));
HAnimSegment733.X3DNode::setName(CString("r_carpal"));
...
HAnimSite747.setDEF(CString("hanim_r_metacarpal_phalanx_2_pt"));
HAnimSite747.X3DNode::setName(CString("r_metacarpal_phalanx_2_pt"));
...
HAnimSite765.setDEF(CString("hanim_r_metacarpal_phalanx_5_pt"));
HAnimSite765.X3DNode::setName(CString("r_metacarpal_phalanx_5_pt"));
...
HAnimSite835.setDEF(CString("hanim_skull_vertex_tip"));
HAnimSite835.X3DNode::setName(CString("skull_vertex_tip"));
...
HAnimHumanoid93.setSkeleton(&HAnimJoint98);

HAnimJoint& HAnimJoint895 =  HAnimJoint();
HAnimJoint895.setUSE(CString("hanim_humanoid_root"));
HAnimHumanoid93.setJoints(&HAnimJoint895);

HAnimJoint& HAnimJoint896 =  HAnimJoint();
HAnimJoint896.setUSE(CString("hanim_sacroiliac"));
HAnimHumanoid93.setJoints(&HAnimJoint896);

HAnimJoint& HAnimJoint897 =  HAnimJoint();
HAnimJoint897.setUSE(CString("hanim_vl1"));
HAnimHumanoid93.setJoints(&HAnimJoint897);

HAnimJoint& HAnimJoint898 =  HAnimJoint();
HAnimJoint898.setUSE(CString("hanim_vc4"));
HAnimHumanoid93.setJoints(&HAnimJoint898);

HAnimJoint& HAnimJoint899 =  HAnimJoint();
HAnimJoint899.setUSE(CString("hanim_skullbase"));
HAnimHumanoid93.setJoints(&HAnimJoint899);

HAnimJoint& HAnimJoint900 =  HAnimJoint();
HAnimJoint900.setUSE(CString("hanim_vl5"));
HAnimHumanoid93.setJoints(&HAnimJoint900);

HAnimJoint& HAnimJoint901 =  HAnimJoint();
HAnimJoint901.setUSE(CString("hanim_vl4"));
HAnimHumanoid93.setJoints(&HAnimJoint901);

HAnimJoint& HAnimJoint902 =  HAnimJoint();
HAnimJoint902.setUSE(CString("hanim_vl3"));
HAnimHumanoid93.setJoints(&HAnimJoint902);

HAnimJoint& HAnimJoint903 =  HAnimJoint();
HAnimJoint903.setUSE(CString("hanim_vl2"));
HAnimHumanoid93.setJoints(&HAnimJoint903);

HAnimJoint& HAnimJoint904 =  HAnimJoint();
HAnimJoint904.setUSE(CString("hanim_vt12"));
HAnimHumanoid93.setJoints(&HAnimJoint904);

HAnimJoint& HAnimJoint905 =  HAnimJoint();
HAnimJoint905.setUSE(CString("hanim_vt11"));
HAnimHumanoid93.setJoints(&HAnimJoint905);

HAnimJoint& HAnimJoint906 =  HAnimJoint();
HAnimJoint906.setUSE(CString("hanim_vt10"));
HAnimHumanoid93.setJoints(&HAnimJoint906);

HAnimJoint& HAnimJoint907 =  HAnimJoint();
HAnimJoint907.setUSE(CString("hanim_vt9"));
HAnimHumanoid93.setJoints(&HAnimJoint907);

HAnimJoint& HAnimJoint908 =  HAnimJoint();
HAnimJoint908.setUSE(CString("hanim_vt8"));
HAnimHumanoid93.setJoints(&HAnimJoint908);

HAnimJoint& HAnimJoint909 =  HAnimJoint();
HAnimJoint909.setUSE(CString("hanim_vt7"));
HAnimHumanoid93.setJoints(&HAnimJoint909);

HAnimJoint& HAnimJoint910 =  HAnimJoint();
HAnimJoint910.setUSE(CString("hanim_vt6"));
HAnimHumanoid93.setJoints(&HAnimJoint910);

HAnimJoint& HAnimJoint911 =  HAnimJoint();
HAnimJoint911.setUSE(CString("hanim_vt5"));
HAnimHumanoid93.setJoints(&HAnimJoint911);

HAnimJoint& HAnimJoint912 =  HAnimJoint();
HAnimJoint912.setUSE(CString("hanim_vt4"));
HAnimHumanoid93.setJoints(&HAnimJoint912);

HAnimJoint& HAnimJoint913 =  HAnimJoint();
HAnimJoint913.setUSE(CString("hanim_vt3"));
HAnimHumanoid93.setJoints(&HAnimJoint913);

HAnimJoint& HAnimJoint914 =  HAnimJoint();
HAnimJoint914.setUSE(CString("hanim_vt2"));
HAnimHumanoid93.setJoints(&HAnimJoint914);

HAnimJoint& HAnimJoint915 =  HAnimJoint();
HAnimJoint915.setUSE(CString("hanim_vt1"));
HAnimHumanoid93.setJoints(&HAnimJoint915);

HAnimJoint& HAnimJoint916 =  HAnimJoint();
HAnimJoint916.setUSE(CString("hanim_vc7"));
HAnimHumanoid93.setJoints(&HAnimJoint916);

HAnimJoint& HAnimJoint917 =  HAnimJoint();
HAnimJoint917.setUSE(CString("hanim_vc6"));
HAnimHumanoid93.setJoints(&HAnimJoint917);

HAnimJoint& HAnimJoint918 =  HAnimJoint();
HAnimJoint918.setUSE(CString("hanim_vc5"));
HAnimHumanoid93.setJoints(&HAnimJoint918);

HAnimJoint& HAnimJoint919 =  HAnimJoint();
HAnimJoint919.setUSE(CString("hanim_vc3"));
HAnimHumanoid93.setJoints(&HAnimJoint919);

HAnimJoint& HAnimJoint920 =  HAnimJoint();
HAnimJoint920.setUSE(CString("hanim_vc2"));
HAnimHumanoid93.setJoints(&HAnimJoint920);

HAnimJoint& HAnimJoint921 =  HAnimJoint();
HAnimJoint921.setUSE(CString("hanim_vc1"));
HAnimHumanoid93.setJoints(&HAnimJoint921);

HAnimJoint& HAnimJoint922 =  HAnimJoint();
HAnimJoint922.setUSE(CString("hanim_l_carpal_distal_interphalangeal_2"));
HAnimHumanoid93.setJoints(&HAnimJoint922);

HAnimJoint& HAnimJoint923 =  HAnimJoint();
HAnimJoint923.setUSE(CString("hanim_l_carpal_interphalangeal_1"));
HAnimHumanoid93.setJoints(&HAnimJoint923);

HAnimJoint& HAnimJoint924 =  HAnimJoint();
HAnimJoint924.setUSE(CString("hanim_l_carpal_proximal_interphalangeal_2"));
HAnimHumanoid93.setJoints(&HAnimJoint924);

HAnimJoint& HAnimJoint925 =  HAnimJoint();
HAnimJoint925.setUSE(CString("hanim_l_carpometacarpal_1"));
HAnimHumanoid93.setJoints(&HAnimJoint925);

HAnimJoint& HAnimJoint926 =  HAnimJoint();
HAnimJoint926.setUSE(CString("hanim_l_carpometacarpal_2"));
HAnimHumanoid93.setJoints(&HAnimJoint926);

HAnimJoint& HAnimJoint927 =  HAnimJoint();
HAnimJoint927.setUSE(CString("hanim_l_elbow"));
HAnimHumanoid93.setJoints(&HAnimJoint927);

HAnimJoint& HAnimJoint928 =  HAnimJoint();
HAnimJoint928.setUSE(CString("hanim_r_elbow"));
HAnimHumanoid93.setJoints(&HAnimJoint928);

HAnimJoint& HAnimJoint929 =  HAnimJoint();
HAnimJoint929.setUSE(CString("hanim_l_hip"));
HAnimHumanoid93.setJoints(&HAnimJoint929);

HAnimJoint& HAnimJoint930 =  HAnimJoint();
HAnimJoint930.setUSE(CString("hanim_r_hip"));
HAnimHumanoid93.setJoints(&HAnimJoint930);

HAnimJoint& HAnimJoint931 =  HAnimJoint();
HAnimJoint931.setUSE(CString("hanim_l_knee"));
HAnimHumanoid93.setJoints(&HAnimJoint931);

HAnimJoint& HAnimJoint932 =  HAnimJoint();
HAnimJoint932.setUSE(CString("hanim_r_knee"));
HAnimHumanoid93.setJoints(&HAnimJoint932);

HAnimJoint& HAnimJoint933 =  HAnimJoint();
HAnimJoint933.setUSE(CString("hanim_l_metacarpophalangeal_1"));
HAnimHumanoid93.setJoints(&HAnimJoint933);

HAnimJoint& HAnimJoint934 =  HAnimJoint();
HAnimJoint934.setUSE(CString("hanim_l_metacarpophalangeal_2"));
HAnimHumanoid93.setJoints(&HAnimJoint934);

HAnimJoint& HAnimJoint935 =  HAnimJoint();
HAnimJoint935.setUSE(CString("hanim_l_metatarsophalangeal_2"));
HAnimHumanoid93.setJoints(&HAnimJoint935);

HAnimJoint& HAnimJoint936 =  HAnimJoint();
HAnimJoint936.setUSE(CString("hanim_r_metatarsophalangeal_2"));
HAnimHumanoid93.setJoints(&HAnimJoint936);

HAnimJoint& HAnimJoint937 =  HAnimJoint();
HAnimJoint937.setUSE(CString("hanim_l_radiocarpal"));
HAnimHumanoid93.setJoints(&HAnimJoint937);

HAnimJoint& HAnimJoint938 =  HAnimJoint();
HAnimJoint938.setUSE(CString("hanim_r_radiocarpal"));
HAnimHumanoid93.setJoints(&HAnimJoint938);

HAnimJoint& HAnimJoint939 =  HAnimJoint();
HAnimJoint939.setUSE(CString("hanim_l_shoulder"));
HAnimHumanoid93.setJoints(&HAnimJoint939);

HAnimJoint& HAnimJoint940 =  HAnimJoint();
HAnimJoint940.setUSE(CString("hanim_r_shoulder"));
HAnimHumanoid93.setJoints(&HAnimJoint940);

HAnimJoint& HAnimJoint941 =  HAnimJoint();
HAnimJoint941.setUSE(CString("hanim_l_talocrural"));
HAnimHumanoid93.setJoints(&HAnimJoint941);

HAnimJoint& HAnimJoint942 =  HAnimJoint();
HAnimJoint942.setUSE(CString("hanim_r_talocrural"));
HAnimHumanoid93.setJoints(&HAnimJoint942);

HAnimJoint& HAnimJoint943 =  HAnimJoint();
HAnimJoint943.setUSE(CString("hanim_l_tarsal_distal_interphalangeal_2"));
HAnimHumanoid93.setJoints(&HAnimJoint943);

HAnimJoint& HAnimJoint944 =  HAnimJoint();
HAnimJoint944.setUSE(CString("hanim_l_tarsometatarsal_2"));
HAnimHumanoid93.setJoints(&HAnimJoint944);

HAnimSegment& HAnimSegment945 =  HAnimSegment();
HAnimSegment945.setUSE(CString("hanim_pelvis"));
HAnimHumanoid93.setSegments(&HAnimSegment945);

HAnimSegment& HAnimSegment946 =  HAnimSegment();
HAnimSegment946.setUSE(CString("hanim_c7"));
HAnimHumanoid93.setSegments(&HAnimSegment946);

HAnimSegment& HAnimSegment947 =  HAnimSegment();
HAnimSegment947.setUSE(CString("hanim_c4"));
HAnimHumanoid93.setSegments(&HAnimSegment947);

HAnimSegment& HAnimSegment948 =  HAnimSegment();
HAnimSegment948.setUSE(CString("hanim_skull"));
HAnimHumanoid93.setSegments(&HAnimSegment948);

HAnimSegment& HAnimSegment949 =  HAnimSegment();
HAnimSegment949.setUSE(CString("hanim_sacrum"));
HAnimHumanoid93.setSegments(&HAnimSegment949);

HAnimSegment& HAnimSegment950 =  HAnimSegment();
HAnimSegment950.setUSE(CString("hanim_l5"));
HAnimHumanoid93.setSegments(&HAnimSegment950);

HAnimSegment& HAnimSegment951 =  HAnimSegment();
HAnimSegment951.setUSE(CString("hanim_l4"));
HAnimHumanoid93.setSegments(&HAnimSegment951);

HAnimSegment& HAnimSegment952 =  HAnimSegment();
HAnimSegment952.setUSE(CString("hanim_l3"));
HAnimHumanoid93.setSegments(&HAnimSegment952);

HAnimSegment& HAnimSegment953 =  HAnimSegment();
HAnimSegment953.setUSE(CString("hanim_l2"));
HAnimHumanoid93.setSegments(&HAnimSegment953);

HAnimSegment& HAnimSegment954 =  HAnimSegment();
HAnimSegment954.setUSE(CString("hanim_l1"));
HAnimHumanoid93.setSegments(&HAnimSegment954);

HAnimSegment& HAnimSegment955 =  HAnimSegment();
HAnimSegment955.setUSE(CString("hanim_t12"));
HAnimHumanoid93.setSegments(&HAnimSegment955);

HAnimSegment& HAnimSegment956 =  HAnimSegment();
HAnimSegment956.setUSE(CString("hanim_t11"));
HAnimHumanoid93.setSegments(&HAnimSegment956);

HAnimSegment& HAnimSegment957 =  HAnimSegment();
HAnimSegment957.setUSE(CString("hanim_t10"));
HAnimHumanoid93.setSegments(&HAnimSegment957);

HAnimSegment& HAnimSegment958 =  HAnimSegment();
HAnimSegment958.setUSE(CString("hanim_t9"));
HAnimHumanoid93.setSegments(&HAnimSegment958);

HAnimSegment& HAnimSegment959 =  HAnimSegment();
HAnimSegment959.setUSE(CString("hanim_t8"));
HAnimHumanoid93.setSegments(&HAnimSegment959);

HAnimSegment& HAnimSegment960 =  HAnimSegment();
HAnimSegment960.setUSE(CString("hanim_t7"));
HAnimHumanoid93.setSegments(&HAnimSegment960);

HAnimSegment& HAnimSegment961 =  HAnimSegment();
HAnimSegment961.setUSE(CString("hanim_t6"));
HAnimHumanoid93.setSegments(&HAnimSegment961);

HAnimSegment& HAnimSegment962 =  HAnimSegment();
HAnimSegment962.setUSE(CString("hanim_t5"));
HAnimHumanoid93.setSegments(&HAnimSegment962);

HAnimSegment& HAnimSegment963 =  HAnimSegment();
HAnimSegment963.setUSE(CString("hanim_t4"));
HAnimHumanoid93.setSegments(&HAnimSegment963);

HAnimSegment& HAnimSegment964 =  HAnimSegment();
HAnimSegment964.setUSE(CString("hanim_t3"));
HAnimHumanoid93.setSegments(&HAnimSegment964);

HAnimSegment& HAnimSegment965 =  HAnimSegment();
HAnimSegment965.setUSE(CString("hanim_t2"));
HAnimHumanoid93.setSegments(&HAnimSegment965);

HAnimSegment& HAnimSegment966 =  HAnimSegment();
HAnimSegment966.setUSE(CString("hanim_t1"));
HAnimHumanoid93.setSegments(&HAnimSegment966);

HAnimSegment& HAnimSegment967 =  HAnimSegment();
HAnimSegment967.setUSE(CString("hanim_c6"));
HAnimHumanoid93.setSegments(&HAnimSegment967);

HAnimSegment& HAnimSegment968 =  HAnimSegment();
HAnimSegment968.setUSE(CString("hanim_c5"));
HAnimHumanoid93.setSegments(&HAnimSegment968);

HAnimSegment& HAnimSegment969 =  HAnimSegment();
HAnimSegment969.setUSE(CString("hanim_c3"));
HAnimHumanoid93.setSegments(&HAnimSegment969);

HAnimSegment& HAnimSegment970 =  HAnimSegment();
HAnimSegment970.setUSE(CString("hanim_c2"));
HAnimHumanoid93.setSegments(&HAnimSegment970);

HAnimSegment& HAnimSegment971 =  HAnimSegment();
HAnimSegment971.setUSE(CString("hanim_c1"));
HAnimHumanoid93.setSegments(&HAnimSegment971);

HAnimSegment& HAnimSegment972 =  HAnimSegment();
HAnimSegment972.setUSE(CString("hanim_l_calf"));
HAnimHumanoid93.setSegments(&HAnimSegment972);

HAnimSegment& HAnimSegment973 =  HAnimSegment();
HAnimSegment973.setUSE(CString("hanim_r_calf"));
HAnimHumanoid93.setSegments(&HAnimSegment973);

HAnimSegment& HAnimSegment974 =  HAnimSegment();
HAnimSegment974.setUSE(CString("hanim_l_carpal"));
HAnimHumanoid93.setSegments(&HAnimSegment974);

HAnimSegment& HAnimSegment975 =  HAnimSegment();
HAnimSegment975.setUSE(CString("hanim_r_carpal"));
HAnimHumanoid93.setSegments(&HAnimSegment975);

HAnimSegment& HAnimSegment976 =  HAnimSegment();
HAnimSegment976.setUSE(CString("hanim_l_carpal_distal_phalanx_1"));
HAnimHumanoid93.setSegments(&HAnimSegment976);

HAnimSegment& HAnimSegment977 =  HAnimSegment();
HAnimSegment977.setUSE(CString("hanim_l_carpal_distal_phalanx_2"));
HAnimHumanoid93.setSegments(&HAnimSegment977);

HAnimSegment& HAnimSegment978 =  HAnimSegment();
HAnimSegment978.setUSE(CString("hanim_l_carpal_middle_phalanx_2"));
HAnimHumanoid93.setSegments(&HAnimSegment978);

HAnimSegment& HAnimSegment979 =  HAnimSegment();
HAnimSegment979.setUSE(CString("hanim_l_carpal_proximal_phalanx_1"));
HAnimHumanoid93.setSegments(&HAnimSegment979);

HAnimSegment& HAnimSegment980 =  HAnimSegment();
HAnimSegment980.setUSE(CString("hanim_l_carpal_proximal_phalanx_2"));
HAnimHumanoid93.setSegments(&HAnimSegment980);

HAnimSegment& HAnimSegment981 =  HAnimSegment();
HAnimSegment981.setUSE(CString("hanim_l_forearm"));
HAnimHumanoid93.setSegments(&HAnimSegment981);

HAnimSegment& HAnimSegment982 =  HAnimSegment();
HAnimSegment982.setUSE(CString("hanim_r_forearm"));
HAnimHumanoid93.setSegments(&HAnimSegment982);

HAnimSegment& HAnimSegment983 =  HAnimSegment();
HAnimSegment983.setUSE(CString("hanim_l_metacarpal_1"));
HAnimHumanoid93.setSegments(&HAnimSegment983);

HAnimSegment& HAnimSegment984 =  HAnimSegment();
HAnimSegment984.setUSE(CString("hanim_l_metacarpal_2"));
HAnimHumanoid93.setSegments(&HAnimSegment984);

HAnimSegment& HAnimSegment985 =  HAnimSegment();
HAnimSegment985.setUSE(CString("hanim_l_metatarsal_2"));
HAnimHumanoid93.setSegments(&HAnimSegment985);

HAnimSegment& HAnimSegment986 =  HAnimSegment();
HAnimSegment986.setUSE(CString("hanim_l_talus"));
HAnimHumanoid93.setSegments(&HAnimSegment986);

HAnimSegment& HAnimSegment987 =  HAnimSegment();
HAnimSegment987.setUSE(CString("hanim_r_talus"));
HAnimHumanoid93.setSegments(&HAnimSegment987);

HAnimSegment& HAnimSegment988 =  HAnimSegment();
HAnimSegment988.setUSE(CString("hanim_l_tarsal_distal_phalanx_2"));
HAnimHumanoid93.setSegments(&HAnimSegment988);

HAnimSegment& HAnimSegment989 =  HAnimSegment();
HAnimSegment989.setUSE(CString("hanim_l_tarsal_proximal_phalanx_2"));
HAnimHumanoid93.setSegments(&HAnimSegment989);

HAnimSegment& HAnimSegment990 =  HAnimSegment();
HAnimSegment990.setUSE(CString("hanim_r_tarsal_proximal_phalanx_2"));
HAnimHumanoid93.setSegments(&HAnimSegment990);

HAnimSegment& HAnimSegment991 =  HAnimSegment();
HAnimSegment991.setUSE(CString("hanim_l_thigh"));
HAnimHumanoid93.setSegments(&HAnimSegment991);

HAnimSegment& HAnimSegment992 =  HAnimSegment();
HAnimSegment992.setUSE(CString("hanim_r_thigh"));
HAnimHumanoid93.setSegments(&HAnimSegment992);

HAnimSegment& HAnimSegment993 =  HAnimSegment();
HAnimSegment993.setUSE(CString("hanim_l_upperarm"));
HAnimHumanoid93.setSegments(&HAnimSegment993);

HAnimSegment& HAnimSegment994 =  HAnimSegment();
HAnimSegment994.setUSE(CString("hanim_r_upperarm"));
HAnimHumanoid93.setSegments(&HAnimSegment994);

HAnimSite& HAnimSite995 =  HAnimSite();
HAnimSite995.setUSE(CString("hanim_crotch_pt"));
HAnimHumanoid93.setSites(&HAnimSite995);

HAnimSite& HAnimSite996 =  HAnimSite();
HAnimSite996.setUSE(CString("hanim_skull_vertex_tip"));
HAnimHumanoid93.setSites(&HAnimSite996);

HAnimSite& HAnimSite997 =  HAnimSite();
HAnimSite997.setUSE(CString("hanim_sellion_pt"));
HAnimHumanoid93.setSites(&HAnimSite997);

HAnimSite& HAnimSite998 =  HAnimSite();
HAnimSite998.setUSE(CString("hanim_supramenton_pt"));
HAnimHumanoid93.setSites(&HAnimSite998);

HAnimSite& HAnimSite999 =  HAnimSite();
HAnimSite999.setUSE(CString("hanim_nuchale_pt"));
HAnimHumanoid93.setSites(&HAnimSite999);

HAnimSite& HAnimSite1000 =  HAnimSite();
HAnimSite1000.setUSE(CString("hanim_r_asis_pt"));
HAnimHumanoid93.setSites(&HAnimSite1000);

HAnimSite& HAnimSite1001 =  HAnimSite();
HAnimSite1001.setUSE(CString("hanim_l_asis_pt"));
HAnimHumanoid93.setSites(&HAnimSite1001);

HAnimSite& HAnimSite1002 =  HAnimSite();
HAnimSite1002.setUSE(CString("hanim_l_calcaneus_posterior_pt"));
HAnimHumanoid93.setSites(&HAnimSite1002);

HAnimSite& HAnimSite1003 =  HAnimSite();
HAnimSite1003.setUSE(CString("hanim_r_calcaneus_posterior_pt"));
HAnimHumanoid93.setSites(&HAnimSite1003);

HAnimSite& HAnimSite1004 =  HAnimSite();
HAnimSite1004.setUSE(CString("hanim_l_carpal_distal_phalanx_1_tip"));
HAnimHumanoid93.setSites(&HAnimSite1004);

HAnimSite& HAnimSite1005 =  HAnimSite();
HAnimSite1005.setUSE(CString("hanim_l_carpal_distal_phalanx_2_tip"));
HAnimHumanoid93.setSites(&HAnimSite1005);

HAnimSite& HAnimSite1006 =  HAnimSite();
HAnimSite1006.setUSE(CString("hanim_l_dactylion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1006);

HAnimSite& HAnimSite1007 =  HAnimSite();
HAnimSite1007.setUSE(CString("hanim_r_dactylion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1007);

HAnimSite& HAnimSite1008 =  HAnimSite();
HAnimSite1008.setUSE(CString("hanim_l_femoral_lateral_epicondyle_pt"));
HAnimHumanoid93.setSites(&HAnimSite1008);

HAnimSite& HAnimSite1009 =  HAnimSite();
HAnimSite1009.setUSE(CString("hanim_r_femoral_lateral_epicondyle_pt"));
HAnimHumanoid93.setSites(&HAnimSite1009);

HAnimSite& HAnimSite1010 =  HAnimSite();
HAnimSite1010.setUSE(CString("hanim_l_femoral_medial_epicondyle_pt"));
HAnimHumanoid93.setSites(&HAnimSite1010);

HAnimSite& HAnimSite1011 =  HAnimSite();
HAnimSite1011.setUSE(CString("hanim_r_femoral_medial_epicondyle_pt"));
HAnimHumanoid93.setSites(&HAnimSite1011);

HAnimSite& HAnimSite1012 =  HAnimSite();
HAnimSite1012.setUSE(CString("hanim_l_forefoot_tip"));
HAnimHumanoid93.setSites(&HAnimSite1012);

HAnimSite& HAnimSite1013 =  HAnimSite();
HAnimSite1013.setUSE(CString("hanim_r_gonion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1013);

HAnimSite& HAnimSite1014 =  HAnimSite();
HAnimSite1014.setUSE(CString("hanim_l_gonion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1014);

HAnimSite& HAnimSite1015 =  HAnimSite();
HAnimSite1015.setUSE(CString("hanim_l_hand_tip"));
HAnimHumanoid93.setSites(&HAnimSite1015);

HAnimSite& HAnimSite1016 =  HAnimSite();
HAnimSite1016.setUSE(CString("hanim_r_hand_tip"));
HAnimHumanoid93.setSites(&HAnimSite1016);

HAnimSite& HAnimSite1017 =  HAnimSite();
HAnimSite1017.setUSE(CString("hanim_l_humeral_lateral_epicondyle_pt"));
HAnimHumanoid93.setSites(&HAnimSite1017);

HAnimSite& HAnimSite1018 =  HAnimSite();
HAnimSite1018.setUSE(CString("hanim_r_humeral_lateral_epicondyle_pt"));
HAnimHumanoid93.setSites(&HAnimSite1018);

HAnimSite& HAnimSite1019 =  HAnimSite();
HAnimSite1019.setUSE(CString("hanim_l_humeral_medial_epicondyle_pt"));
HAnimHumanoid93.setSites(&HAnimSite1019);

HAnimSite& HAnimSite1020 =  HAnimSite();
HAnimSite1020.setUSE(CString("hanim_r_humeral_medial_epicondyle_pt"));
HAnimHumanoid93.setSites(&HAnimSite1020);

HAnimSite& HAnimSite1021 =  HAnimSite();
HAnimSite1021.setUSE(CString("hanim_r_iliocristale_pt"));
HAnimHumanoid93.setSites(&HAnimSite1021);

HAnimSite& HAnimSite1022 =  HAnimSite();
HAnimSite1022.setUSE(CString("hanim_l_iliocristale_pt"));
HAnimHumanoid93.setSites(&HAnimSite1022);

HAnimSite& HAnimSite1023 =  HAnimSite();
HAnimSite1023.setUSE(CString("hanim_r_infraorbitale_pt"));
HAnimHumanoid93.setSites(&HAnimSite1023);

HAnimSite& HAnimSite1024 =  HAnimSite();
HAnimSite1024.setUSE(CString("hanim_l_infraorbitale_pt"));
HAnimHumanoid93.setSites(&HAnimSite1024);

HAnimSite& HAnimSite1025 =  HAnimSite();
HAnimSite1025.setUSE(CString("hanim_l_knee_crease_pt"));
HAnimHumanoid93.setSites(&HAnimSite1025);

HAnimSite& HAnimSite1026 =  HAnimSite();
HAnimSite1026.setUSE(CString("hanim_r_knee_crease_pt"));
HAnimHumanoid93.setSites(&HAnimSite1026);

HAnimSite& HAnimSite1027 =  HAnimSite();
HAnimSite1027.setUSE(CString("hanim_l_lateral_malleolus_pt"));
HAnimHumanoid93.setSites(&HAnimSite1027);

HAnimSite& HAnimSite1028 =  HAnimSite();
HAnimSite1028.setUSE(CString("hanim_r_lateral_malleolus_pt"));
HAnimHumanoid93.setSites(&HAnimSite1028);

HAnimSite& HAnimSite1029 =  HAnimSite();
HAnimSite1029.setUSE(CString("hanim_l_medial_malleolus_pt"));
HAnimHumanoid93.setSites(&HAnimSite1029);

HAnimSite& HAnimSite1030 =  HAnimSite();
HAnimSite1030.setUSE(CString("hanim_r_medial_malleolus_pt"));
HAnimHumanoid93.setSites(&HAnimSite1030);

HAnimSite& HAnimSite1031 =  HAnimSite();
HAnimSite1031.setUSE(CString("hanim_l_metacarpal_phalanx_2_pt"));
HAnimHumanoid93.setSites(&HAnimSite1031);

HAnimSite& HAnimSite1032 =  HAnimSite();
HAnimSite1032.setUSE(CString("hanim_r_metacarpal_phalanx_2_pt"));
HAnimHumanoid93.setSites(&HAnimSite1032);

HAnimSite& HAnimSite1033 =  HAnimSite();
HAnimSite1033.setUSE(CString("hanim_l_metacarpal_phalanx_5_pt"));
HAnimHumanoid93.setSites(&HAnimSite1033);

HAnimSite& HAnimSite1034 =  HAnimSite();
HAnimSite1034.setUSE(CString("hanim_r_metacarpal_phalanx_5_pt"));
HAnimHumanoid93.setSites(&HAnimSite1034);

HAnimSite& HAnimSite1035 =  HAnimSite();
HAnimSite1035.setUSE(CString("hanim_l_metatarsal_phalanx_1_pt"));
HAnimHumanoid93.setSites(&HAnimSite1035);

HAnimSite& HAnimSite1036 =  HAnimSite();
HAnimSite1036.setUSE(CString("hanim_r_metatarsal_phalanx_1_pt"));
HAnimHumanoid93.setSites(&HAnimSite1036);

HAnimSite& HAnimSite1037 =  HAnimSite();
HAnimSite1037.setUSE(CString("hanim_l_metatarsal_phalanx_5_pt"));
HAnimHumanoid93.setSites(&HAnimSite1037);

HAnimSite& HAnimSite1038 =  HAnimSite();
HAnimSite1038.setUSE(CString("hanim_r_metatarsal_phalanx_5_pt"));
HAnimHumanoid93.setSites(&HAnimSite1038);

HAnimSite& HAnimSite1039 =  HAnimSite();
HAnimSite1039.setUSE(CString("hanim_l_middistal_tip"));
HAnimHumanoid93.setSites(&HAnimSite1039);

HAnimSite& HAnimSite1040 =  HAnimSite();
HAnimSite1040.setUSE(CString("hanim_r_middistal_tip"));
HAnimHumanoid93.setSites(&HAnimSite1040);

HAnimSite& HAnimSite1041 =  HAnimSite();
HAnimSite1041.setUSE(CString("hanim_l_olecranon_pt"));
HAnimHumanoid93.setSites(&HAnimSite1041);

HAnimSite& HAnimSite1042 =  HAnimSite();
HAnimSite1042.setUSE(CString("hanim_r_olecranon_pt"));
HAnimHumanoid93.setSites(&HAnimSite1042);

HAnimSite& HAnimSite1043 =  HAnimSite();
HAnimSite1043.setUSE(CString("hanim_r_psis_pt"));
HAnimHumanoid93.setSites(&HAnimSite1043);

HAnimSite& HAnimSite1044 =  HAnimSite();
HAnimSite1044.setUSE(CString("hanim_l_psis_pt"));
HAnimHumanoid93.setSites(&HAnimSite1044);

HAnimSite& HAnimSite1045 =  HAnimSite();
HAnimSite1045.setUSE(CString("hanim_l_radial_styloid_pt"));
HAnimHumanoid93.setSites(&HAnimSite1045);

HAnimSite& HAnimSite1046 =  HAnimSite();
HAnimSite1046.setUSE(CString("hanim_r_radial_styloid_pt"));
HAnimHumanoid93.setSites(&HAnimSite1046);

HAnimSite& HAnimSite1047 =  HAnimSite();
HAnimSite1047.setUSE(CString("hanim_l_radiale_pt"));
HAnimHumanoid93.setSites(&HAnimSite1047);

HAnimSite& HAnimSite1048 =  HAnimSite();
HAnimSite1048.setUSE(CString("hanim_r_radiale_pt"));
HAnimHumanoid93.setSites(&HAnimSite1048);

HAnimSite& HAnimSite1049 =  HAnimSite();
HAnimSite1049.setUSE(CString("hanim_l_sphyrion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1049);

HAnimSite& HAnimSite1050 =  HAnimSite();
HAnimSite1050.setUSE(CString("hanim_r_sphyrion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1050);

HAnimSite& HAnimSite1051 =  HAnimSite();
HAnimSite1051.setUSE(CString("hanim_l_tarsal_distal_phalanx_2_pt"));
HAnimHumanoid93.setSites(&HAnimSite1051);

HAnimSite& HAnimSite1052 =  HAnimSite();
HAnimSite1052.setUSE(CString("hanim_r_tarsal_distal_phalanx_2_pt"));
HAnimHumanoid93.setSites(&HAnimSite1052);

HAnimSite& HAnimSite1053 =  HAnimSite();
HAnimSite1053.setUSE(CString("hanim_r_tragion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1053);

HAnimSite& HAnimSite1054 =  HAnimSite();
HAnimSite1054.setUSE(CString("hanim_l_tragion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1054);

HAnimSite& HAnimSite1055 =  HAnimSite();
HAnimSite1055.setUSE(CString("hanim_r_trochanterion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1055);

HAnimSite& HAnimSite1056 =  HAnimSite();
HAnimSite1056.setUSE(CString("hanim_l_trochanterion_pt"));
HAnimHumanoid93.setSites(&HAnimSite1056);

HAnimSite& HAnimSite1057 =  HAnimSite();
HAnimSite1057.setUSE(CString("hanim_l_ulnar_styloid_pt"));
HAnimHumanoid93.setSites(&HAnimSite1057);

HAnimSite& HAnimSite1058 =  HAnimSite();
HAnimSite1058.setUSE(CString("hanim_r_ulnar_styloid_pt"));
HAnimHumanoid93.setSites(&HAnimSite1058);

HAnimSite& HAnimSite1059 =  HAnimSite();
HAnimSite1059.setDEF(CString("hanim_DiamondManLOA2_view"));
HAnimSite1059.X3DNode::setName(CString("DiamondManLOA2_view"));
...
HAnimHumanoid93.setViewpoints(&HAnimSite1059);

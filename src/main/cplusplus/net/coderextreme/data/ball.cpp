...
ImageTexture26->setUrl(new CString[1]{"../resources/images/all_probes/stpeters_cross/stpeters_back.png"}, 1);
...
ImageTexture27->setUrl(new CString[1]{"../resources/images/all_probes/stpeters_cross/stpeters_bottom.png"}, 1);
...
ImageTexture28->setUrl(new CString[1]{"../resources/images/all_probes/stpeters_cross/stpeters_front.png"}, 1);
...
ImageTexture29->setUrl(new CString[1]{"../resources/images/all_probes/stpeters_cross/stpeters_left.png"}, 1);
...
ImageTexture30->setUrl(new CString[1]{"../resources/images/all_probes/stpeters_cross/stpeters_right.png"}, 1);
...
ImageTexture31->setUrl(new CString[1]{"../resources/images/all_probes/stpeters_cross/stpeters_top.png"}, 1);
...
ShaderPart39->setUrl(new CString[1]{"../shaders/x3dom.vs"}, 1);
...
ShaderPart40->setUrl(new CString[1]{"../shaders/common.fs"}, 1);
...
ShaderPart48->setUrl(new CString[1]{"../shaders/x_ite.vs"}, 1);
...
ShaderPart49->setUrl(new CString[1]{"../shaders/x_itebubbles.fs"}, 1);

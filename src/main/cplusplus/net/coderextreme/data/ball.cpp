...
ShaderPart31->setUrl(new CString[2]{"../shaders/x3dom.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom.vs"}, 2);
ComposedShader30->addParts(*ShaderPart31);

CShaderPart* ShaderPart32 = (CShaderPart *)(m_pScene.createNode("ShaderPart"));
ShaderPart32->setDEF("common");
ShaderPart32->setType("FRAGMENT");
ShaderPart32->setUrl(new CString[2]{"../shaders/common.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs"}, 2);
...
ComposedShader39->addParts(*ShaderPart40);
...
ComposedShader39->addParts(*ShaderPart41);

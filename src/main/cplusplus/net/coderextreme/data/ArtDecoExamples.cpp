...
Inline64.setUrl(new CString[]{CString("../data/gridBack.json"), CString("../data/gridBack.x3d"), CString("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.x3d"), CString("gridBack.wrl"), CString("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.wrl")}, 5);

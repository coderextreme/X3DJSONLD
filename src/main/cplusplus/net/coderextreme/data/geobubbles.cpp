...
GeoViewpoint9.setPosition(new double[]{0,0,4});
GeoViewpoint9.setOrientation(new float[]{1,0,0,0});
...
GeoPositionInterpolator17.setKey(new float[]{0,1}, 2);
GeoPositionInterpolator17.setKeyValue(new double[]{0.0015708,0,4,0,0.0015708,4}, 6);

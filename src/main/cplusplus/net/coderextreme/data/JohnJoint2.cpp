...
meta4.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/JohnJoint2.x3d"));
head1.addMeta(&meta4);
...
Material23.setDiffuseColor(new float[]{0,0,0.8});
...
ColorRGBA27.setColor(new float[]{1,1,0,1,1,1,0,0.1}, 8);
...
HAnimHumanoid31.setInfo(new CString[]{CString("humanoidVersion=2.0")}, 1);
...
HAnimJoint32.setCenter(new float[]{0,0.824,0.0277});
...
HAnimJoint33.setCenter(new float[]{0,0.9149,0.0016});
...
HAnimJoint34.setCenter(new float[]{0.0961,0.9124,-0.0001});
...
HAnimJoint35.setCenter(new float[]{0.104,0.4867,0.0308});
...
HAnimJoint36.setCenter(new float[]{0.1101,0.0656,-0.0736});
...
HAnimJoint37.setCenter(new float[]{0,1,0});
...
HAnimJoint38.setCenter(new float[]{0,1,0});
...
HAnimJoint39.setCenter(new float[]{0,1,0});
...
HAnimJoint40.setCenter(new float[]{0,1,0});
...
HAnimJoint41.setCenter(new float[]{0,1,0});
...
HAnimJoint42.setCenter(new float[]{0,1,0});
...
HAnimJoint43.setCenter(new float[]{0,1,0});
...
HAnimJoint44.setCenter(new float[]{0,1,0});
...
HAnimJoint45.setCenter(new float[]{0,1,0});
...
HAnimJoint46.setCenter(new float[]{0,1,0});
...
HAnimJoint47.setCenter(new float[]{0,1,0});
...
HAnimJoint48.setCenter(new float[]{0,1,0});
...
HAnimJoint49.setCenter(new float[]{0,1,0});
...
HAnimJoint50.setCenter(new float[]{0,1,0});
...
HAnimJoint51.setCenter(new float[]{0,1,0});
...
HAnimJoint52.setCenter(new float[]{0,1,0});
...
HAnimJoint53.setCenter(new float[]{0,1,0});
...
HAnimJoint54.setCenter(new float[]{0,1,0});
...
HAnimJoint55.setCenter(new float[]{0,1,0});
...
HAnimJoint56.setCenter(new float[]{0,1,0});
...
HAnimJoint57.setCenter(new float[]{0,1,0});
...
HAnimJoint58.setCenter(new float[]{0,1,0});
...
HAnimJoint59.setCenter(new float[]{0,1,0});
...
HAnimJoint60.setCenter(new float[]{0,1,0});
...
HAnimJoint61.setCenter(new float[]{0,1,0});
...
HAnimJoint62.setCenter(new float[]{-0.095,0.9171,0.0029});
...
HAnimJoint63.setCenter(new float[]{-0.0867,0.4913,0.0318});
...
HAnimJoint64.setCenter(new float[]{-0.0801,0.0712,-0.0766});
...
HAnimJoint65.setCenter(new float[]{0,1,0});
...
HAnimJoint66.setCenter(new float[]{0,1,0});
...
HAnimJoint67.setCenter(new float[]{0,1,0});
...
HAnimJoint68.setCenter(new float[]{0,1,0});
...
HAnimJoint69.setCenter(new float[]{0,1,0});
...
HAnimJoint70.setCenter(new float[]{0,1,0});
...
HAnimJoint71.setCenter(new float[]{0,1,0});
...
HAnimJoint72.setCenter(new float[]{0,1,0});
...
HAnimJoint73.setCenter(new float[]{0,1,0});
...
HAnimJoint74.setCenter(new float[]{0,1,0});
...
HAnimJoint75.setCenter(new float[]{0,1,0});
...
HAnimJoint76.setCenter(new float[]{0,1,0});
...
HAnimJoint77.setCenter(new float[]{0,1,0});
...
HAnimJoint78.setCenter(new float[]{0,1,0});
...
HAnimJoint79.setCenter(new float[]{0,1,0});
...
HAnimJoint80.setCenter(new float[]{0,1,0});
...
HAnimJoint81.setCenter(new float[]{0,1,0});
...
HAnimJoint82.setCenter(new float[]{0,1,0});
...
HAnimJoint83.setCenter(new float[]{0,1,0});
...
HAnimJoint84.setCenter(new float[]{0,1,0});
...
HAnimJoint85.setCenter(new float[]{0,1,0});
...
HAnimJoint86.setCenter(new float[]{0,1,0});
...
HAnimJoint87.setCenter(new float[]{0,1,0});
...
HAnimJoint88.setCenter(new float[]{0,1,0});
...
HAnimJoint89.setCenter(new float[]{0,1,0});
...
HAnimJoint90.setCenter(new float[]{0.0028,1.0568,-0.0776});
...
HAnimJoint91.setCenter(new float[]{0.0035,1.0925,-0.0787});
...
HAnimJoint92.setCenter(new float[]{0.0041,1.1276,-0.0796});
...
HAnimJoint93.setCenter(new float[]{0.0045,1.1546,-0.08});
...
HAnimJoint94.setCenter(new float[]{0.0048,1.1912,-0.0805});
...
HAnimJoint95.setCenter(new float[]{0.0051,1.2278,-0.0808});
...
HAnimJoint96.setCenter(new float[]{0.0053,1.2679,-0.081});
...
HAnimJoint97.setCenter(new float[]{0.0056,1.2848,-0.0822});
...
HAnimJoint98.setCenter(new float[]{0.0057,1.3126,-0.0838});
...
HAnimJoint99.setCenter(new float[]{0.0057,1.3382,-0.0845});
...
HAnimJoint100.setCenter(new float[]{0.0058,1.3625,-0.0833});
...
HAnimJoint101.setCenter(new float[]{0.0059,1.3866,-0.08});
...
HAnimJoint102.setCenter(new float[]{0.006,1.4102,-0.0745});
...
HAnimJoint103.setCenter(new float[]{0.0061,1.432,-0.0675});
...
HAnimJoint104.setCenter(new float[]{0.0062,1.4583,-0.057});
...
HAnimJoint105.setCenter(new float[]{0.0063,1.4761,-0.0484});
...
HAnimJoint106.setCenter(new float[]{0.0065,1.4951,-0.0387});
...
HAnimJoint107.setCenter(new float[]{0.0066,1.5132,-0.0301});
...
HAnimJoint108.setCenter(new float[]{0.0066,1.5357,-0.0143});
...
HAnimJoint109.setCenter(new float[]{0.0066,1.552,-0.0082});
...
HAnimJoint110.setCenter(new float[]{0.0066,1.5662,-0.0084});
...
HAnimJoint111.setCenter(new float[]{0.0066,1.58,-0.0103});
...
HAnimJoint112.setCenter(new float[]{0.0066,1.5928,-0.0103});
...
HAnimJoint113.setCenter(new float[]{0.0066,1.6144,-0.0034});
...
HAnimJoint114.setCenter(new float[]{0.0044,1.6209,0.0236});
...
HAnimJoint115.setCenter(new float[]{0,1,0});
...
HAnimJoint116.setCenter(new float[]{0,1,0});
...
HAnimJoint117.setCenter(new float[]{0,1,0});
...
HAnimJoint118.setCenter(new float[]{0,1,0});
...
HAnimJoint119.setCenter(new float[]{0,1,0});
...
HAnimJoint120.setCenter(new float[]{0,1,0});
...
HAnimJoint121.setCenter(new float[]{0,1,0});
...
HAnimJoint122.setCenter(new float[]{0.082,1.4488,-0.0353});
...
HAnimJoint123.setCenter(new float[]{0.0962,1.4269,-0.0424});
...
HAnimJoint124.setCenter(new float[]{0.2029,1.4376,-0.0387});
...
HAnimJoint125.setCenter(new float[]{0.2014,1.1357,-0.0682});
...
HAnimJoint126.setCenter(new float[]{0.1984,0.8663,-0.0583});
...
HAnimJoint127.setCenter(new float[]{0,1,0});
...
HAnimJoint128.setCenter(new float[]{0.1924,0.8472,-0.0534});
...
HAnimJoint129.setCenter(new float[]{0.1951,0.8226,0.0246});
...
HAnimJoint130.setCenter(new float[]{0.1955,0.8159,0.0464});
...
HAnimJoint131.setCenter(new float[]{0,1,0});
...
HAnimJoint132.setCenter(new float[]{0.1983,0.8024,-0.028});
...
HAnimJoint133.setCenter(new float[]{0.1983,0.7815,-0.028});
...
HAnimJoint134.setCenter(new float[]{0.2017,0.7363,-0.0248});
...
HAnimJoint135.setCenter(new float[]{0.2028,0.7139,-0.0236});
...
HAnimJoint136.setCenter(new float[]{0,1,0});
...
HAnimJoint137.setCenter(new float[]{0.1987,0.8029,-0.053});
HAnimJoint137.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint137.setLlimit(new float[]{0,0,0}, 3);
...
HAnimJoint138.setCenter(new float[]{0.1987,0.7818,-0.053});
...
HAnimJoint139.setCenter(new float[]{0.2013,0.7273,-0.0503});
HAnimJoint139.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint139.setLlimit(new float[]{0,0,0}, 3);
...
HAnimJoint140.setCenter(new float[]{0.2026,0.7011,-0.0494});
HAnimJoint140.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint140.setLlimit(new float[]{0,0,0}, 3);
...
HAnimJoint141.setCenter(new float[]{0,1,0});
...
HAnimJoint142.setCenter(new float[]{0.1956,0.8019,-0.0794});
...
HAnimJoint143.setCenter(new float[]{0.1956,0.7815,-0.0794});
...
HAnimJoint144.setCenter(new float[]{0.1973,0.7287,-0.0777});
HAnimJoint144.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint144.setLlimit(new float[]{0,0,0}, 3);
...
HAnimJoint145.setCenter(new float[]{0.1983,0.7045,-0.0767});
...
HAnimJoint146.setCenter(new float[]{0.1925,0.8066,-0.1036});
...
HAnimJoint147.setCenter(new float[]{0.1925,0.7866,-0.1036});
...
HAnimJoint148.setCenter(new float[]{0.1938,0.7452,-0.1024});
...
HAnimJoint149.setCenter(new float[]{0.1948,0.7277,-0.1017});
...
HAnimJoint150.setCenter(new float[]{-0.0694,1.46,-0.033});
...
HAnimJoint151.setCenter(new float[]{-0.0836,1.4281,-0.0401});
...
HAnimJoint152.setCenter(new float[]{-0.1907,1.4407,-0.0325});
...
HAnimJoint153.setCenter(new float[]{-0.1949,1.1388,-0.062});
...
HAnimJoint154.setCenter(new float[]{-0.1959,0.8694,-0.0521});
...
HAnimJoint155.setCenter(new float[]{0,1,0});
...
HAnimJoint156.setCenter(new float[]{-0.1899,0.8502,-0.0473});
...
HAnimJoint157.setCenter(new float[]{-0.1874,0.8256,0.0306});
...
HAnimJoint158.setCenter(new float[]{-0.1864,0.819,0.0506});
...
HAnimJoint159.setCenter(new float[]{0,1,0});
...
HAnimJoint160.setCenter(new float[]{-0.1961,0.8055,-0.0218});
...
HAnimJoint161.setCenter(new float[]{-0.1961,0.7846,-0.0218});
...
HAnimJoint162.setCenter(new float[]{-0.1954,0.7393,-0.0185});
...
HAnimJoint163.setCenter(new float[]{-0.1945,0.7169,-0.0173});
...
HAnimJoint164.setCenter(new float[]{0,1,0});
HAnimJoint164.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint164.setLlimit(new float[]{0,0,0}, 3);
...
HAnimJoint165.setCenter(new float[]{-0.1972,0.806,-0.0468});
...
HAnimJoint166.setCenter(new float[]{-0.1972,0.7849,-0.0468});
HAnimJoint166.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint166.setLlimit(new float[]{0,0,0}, 3);
...
HAnimJoint167.setCenter(new float[]{-0.195,0.7304,-0.0441});
...
HAnimJoint168.setCenter(new float[]{-0.1939,0.7042,-0.0432});
...
HAnimJoint169.setCenter(new float[]{0,1,0});
HAnimJoint169.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint169.setLlimit(new float[]{0,0,0}, 3);
...
HAnimJoint170.setCenter(new float[]{-0.1951,0.8049,-0.0732});
...
HAnimJoint171.setCenter(new float[]{-0.1951,0.7845,-0.0732});
HAnimJoint171.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint171.setLlimit(new float[]{0,0,0}, 3);
...
HAnimJoint172.setCenter(new float[]{-0.192,0.7318,-0.0716});
...
HAnimJoint173.setCenter(new float[]{-0.1908,0.7077,-0.0706});
...
HAnimJoint174.setCenter(new float[]{-0.1926,0.8096,-0.0975});
HAnimJoint174.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint174.setLlimit(new float[]{0,0,0}, 3);
...
HAnimJoint175.setCenter(new float[]{-0.1926,0.7896,-0.0975});
...
HAnimJoint176.setCenter(new float[]{-0.1902,0.7483,-0.0963});
...
HAnimJoint177.setCenter(new float[]{-0.1908,0.754,-0.096});

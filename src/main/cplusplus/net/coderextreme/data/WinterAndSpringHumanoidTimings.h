...
Viewpoint18.setPosition(new float[]{0.0,2.0,40.0});
...
Viewpoint19.setPosition(new float[]{-15.0,10.0,30.0});
Viewpoint19.setOrientation(new float[]{0.0,1.0,0.0,-0.643501});
Viewpoint19.setCenterOfRotation(new float[]{0.0,10.0,10.0});
...
Material23.setDiffuseColor(new float[]{0.960784,0.894118,0.0});
...
PositionInterpolator29.setKey(new float[]{0.0,0.09,0.11,0.22,0.043,0.55,0.63,0.73,0.85,0.86,1.0}, 11);
PositionInterpolator29.setKeyValue(new float[]{6.8557,0.95,0.5,6.8557,0.95,0.5,6.8557,0.95,0.5,9.8557,0.95,3.5,9.8557,0.95,3.5,9.8557,0.95,3.5,14.3558,0.95,8.0,16.8558,0.95,15.0,21.3557,0.95,24.5,21.3557,0.95,24.5,21.3557,0.95,24.5}, 33);
...
PositionInterpolator31.setKey(new float[]{0.0,0.09,0.11,0.223,0.043,0.55,0.63,0.73,0.85,0.86,1.0}, 11);
PositionInterpolator31.setKeyValue(new float[]{-7.9962,0.4,3.0,-7.9962,0.4,3.0,-7.9962,0.4,3.0,-7.9962,0.4,3.0,9.004,0.475,3.4999,11.5048,0.475,3.3699,16.0038,0.475,7.8699,18.5038,0.475,14.8699,23.0038,0.475,24.3699,23.0038,0.475,24.3699,23.0038,0.475,24.3699}, 33);
...
PositionInterpolator33.setKey(new float[]{0.0,0.09,0.11,0.225,0.043,0.55,0.63,0.73,0.85,0.86,1.0}, 11);
...
PositionInterpolator35.setKey(new float[]{0.0,0.09,0.11,0.227,0.043,0.55,0.63,0.73,0.85,0.86,1.0}, 11);
...
Background38.setSkyColor(new float[]{0.0,0.71,0.886}, 3);
Background38.setGroundAngle(new float[]{1.57}, 1);
Background38.setGroundColor(new float[]{0.356863,0.639216,0.0,0.721569,1.0,0.501961}, 6);
...
BooleanSequencer43.setKey(new float[]{0.0,0.09,0.11,0.22,0.043,0.55,0.63,0.73,0.85,0.86,1.0}, 11);
...
BooleanSequencer44.setKey(new float[]{0.0,0.09,0.11,0.22,0.043,0.55,0.63,0.73,0.85,0.86,1.0}, 11);
...
BooleanSequencer45.setKey(new float[]{0.0,0.09,0.11,0.22,0.043,0.55,0.63,0.73,0.85,0.86,1.0}, 11);
...
BooleanSequencer46.setKey(new float[]{0.0,0.09,0.11,0.22,0.043,0.55,0.63,0.73,0.85,0.86,1.0}, 11);

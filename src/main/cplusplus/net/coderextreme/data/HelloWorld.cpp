...
Viewpoint28.setPosition(new float[]{0,-1,7});
Group27.addChild(&Viewpoint28);

Transform& Transform29 =  Transform();
Transform29.setRotation(new float[]{0,1,0,3});
Shape& Shape30 =  Shape();
...
Material33.setDiffuseColor(new float[]{0.1,0.5,1});
...
Transform35.setTranslation(new float[]{0,-2,0});
Shape& Shape36 =  Shape();
Text& Text37 =  Text();

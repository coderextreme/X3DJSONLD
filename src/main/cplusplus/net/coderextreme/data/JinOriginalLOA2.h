...
meta3.setContent(CString("JinOriginalLOA2.x3d"));
head1.addMeta(&meta3);
...
meta8.setContent(CString("Mon, 15 Sep 2025 05:20:33 GMT"));
head1.addMeta(&meta8);

meta& meta9 =  meta();
meta9.setName(CString("warning"));
meta9.setContent(CString("All length values are rescaled from inches to meters, not compatible with other typical motion animation behavior libraries which are based in meters."));
head1.addMeta(&meta9);

meta& meta10 =  meta();
meta10.setName(CString("description"));
meta10.setContent(CString("Original version of articulated 3D game character designed with a general graphics tool, then converted into an X3D HAnim model."));
...
meta14.setContent(CString("JinLOA2.x3d"));
...
meta16.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA2.x3d"));
...
WorldInfo21.setTitle(CString("JinOriginalLOA2.x3d"));

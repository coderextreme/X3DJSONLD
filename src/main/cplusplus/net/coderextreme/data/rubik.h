...
meta2.setContent(CString("rubik.x3d"));
head1.addMeta(&meta2);
...
meta5.setContent(CString("https://coderextreme.net/X3DJSONLD/src/main/data/rubik.x3d"));
head1.addMeta(&meta5);

meta& meta6 =  meta();
meta6.setName(CString("description"));
meta6.setContent(CString("a kind of rubik cube with spheres"));
head1.addMeta(&meta6);

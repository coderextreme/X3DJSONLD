...
Viewpoint50.setPosition(new float[]{0.0,0.854,2.57665});
...
Viewpoint51.setPosition(new float[]{2.5929,0.854,0.0});
Viewpoint51.setOrientation(new float[]{0.0,1.0,0.0,1.57079});
...
Viewpoint52.setPosition(new float[]{0.0,3.4495,0.0});
Viewpoint52.setOrientation(new float[]{1.0,0.0,0.0,-1.57079});

...
Material44.setDiffuseColor(new float[]{1.0,1.0,0.0});
...
Coordinate46.setPoint(new float[]{0.0,0.01,0.0,-0.01,0.0,0.0,0.0,0.0,0.01,0.01,0.0,0.0,0.0,0.0,-0.01,0.0,-0.01,0.0}, 18);
...
Viewpoint52.setPosition(new float[]{0.0,0.854,2.57665});
...
Viewpoint53.setPosition(new float[]{2.5929,0.854,0.0});
Viewpoint53.setOrientation(new float[]{0.0,1.0,0.0,1.57079});
...
Viewpoint54.setPosition(new float[]{0.0,3.4495,0.0});
Viewpoint54.setOrientation(new float[]{1.0,0.0,0.0,-1.57079});

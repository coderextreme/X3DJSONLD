...
Transform104.setTranslation(new float[]{0,0,-3});
...
Box& Box108 =  Box();
Box108.setSize(new float[]{100,100,0.02});
...
Transform109.setTranslation(new float[]{0,0.7,0});
Transform& Transform110 =  Transform();
Transform110.setRotation(new float[]{0,0,1,1.57});
...
Transform115.setTranslation(new float[]{0,0,0.1});
PlaneSensor& PlaneSensor116 =  PlaneSensor();
PlaneSensor116.setDEF(CString("aSensor"));
PlaneSensor116.setMinPosition(new float[]{-20,0});
PlaneSensor116.setMaxPosition(new float[]{20,0});
Transform115.addChild(&PlaneSensor116);

Transform& Transform117 =  Transform();
Transform117.setTranslation(new float[]{0,0,0});
...
Material122.setDiffuseColor(new float[]{1,0,0});
...
Transform127.setRotation(new float[]{0,0,1,1.57});
...
Transform132.setTranslation(new float[]{0,0.4,0});
Transform& Transform133 =  Transform();
Transform133.setRotation(new float[]{0,0,1,1.57});
...
Transform138.setTranslation(new float[]{0,0,0.1});
PlaneSensor& PlaneSensor139 =  PlaneSensor();
PlaneSensor139.setDEF(CString("bSensor"));
PlaneSensor139.setMinPosition(new float[]{-20,0});
PlaneSensor139.setMaxPosition(new float[]{20,0});
Transform138.addChild(&PlaneSensor139);

Transform& Transform140 =  Transform();
Transform140.setTranslation(new float[]{0,0,0});
...
Material145.setDiffuseColor(new float[]{1,0,0});
...
Transform150.setTranslation(new float[]{0,0.1,0});
Transform& Transform151 =  Transform();
Transform151.setRotation(new float[]{0,0,1,1.57});
...
Transform156.setTranslation(new float[]{0,0,0.1});
PlaneSensor& PlaneSensor157 =  PlaneSensor();
PlaneSensor157.setDEF(CString("cSensor"));
PlaneSensor157.setMinPosition(new float[]{-20,0});
PlaneSensor157.setMaxPosition(new float[]{20,0});
Transform156.addChild(&PlaneSensor157);

Transform& Transform158 =  Transform();
Transform158.setTranslation(new float[]{0,0,0});
...
Material163.setDiffuseColor(new float[]{1,0,0});
...
Transform168.setTranslation(new float[]{0,-0.2,0});
Transform& Transform169 =  Transform();
Transform169.setRotation(new float[]{0,0,1,1.57});
...
Transform174.setTranslation(new float[]{0,0,0.1});
PlaneSensor& PlaneSensor175 =  PlaneSensor();
PlaneSensor175.setDEF(CString("dSensor"));
PlaneSensor175.setMinPosition(new float[]{-20,0});
PlaneSensor175.setMaxPosition(new float[]{20,0});
Transform174.addChild(&PlaneSensor175);

Transform& Transform176 =  Transform();
Transform176.setTranslation(new float[]{0,0,0});
...
Material181.setDiffuseColor(new float[]{1,0,0});
...
Transform186.setTranslation(new float[]{0,-0.5,0});
Transform& Transform187 =  Transform();
Transform187.setRotation(new float[]{0,0,1,1.57});
...
Transform192.setTranslation(new float[]{0,0,0.1});
PlaneSensor& PlaneSensor193 =  PlaneSensor();
PlaneSensor193.setDEF(CString("pdeltaSensor"));
PlaneSensor193.setMinPosition(new float[]{-20,0});
PlaneSensor193.setMaxPosition(new float[]{20,0});
Transform192.addChild(&PlaneSensor193);

Transform& Transform194 =  Transform();
Transform194.setTranslation(new float[]{0,0,0});
...
Material199.setDiffuseColor(new float[]{1,0,0});
...
Transform204.setTranslation(new float[]{0,-0.8,0});
Transform& Transform205 =  Transform();
Transform205.setRotation(new float[]{0,0,1,1.57});
...
Transform210.setTranslation(new float[]{0,0,0.1});
PlaneSensor& PlaneSensor211 =  PlaneSensor();
PlaneSensor211.setDEF(CString("tdeltaSensor"));
PlaneSensor211.setMinPosition(new float[]{-20,0});
PlaneSensor211.setMaxPosition(new float[]{20,0});
Transform210.addChild(&PlaneSensor211);

Transform& Transform212 =  Transform();
Transform212.setTranslation(new float[]{0,0,0});
...
Material217.setDiffuseColor(new float[]{1,0,0});
...
Layout258.setOffset(new float[]{0,0}, 2);
...
Layout258.setSize(new float[]{0.4,1}, 2);
...
Viewport259.setClipBoundary(new float[]{0,1,0,1}, 4);

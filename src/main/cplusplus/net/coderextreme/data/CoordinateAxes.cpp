...
Transform23.setTranslation(new float[]{0,1,0});
Shape& Shape24 =  Shape();
Cone& Cone25 =  Cone();
...
Transform27.setTranslation(new float[]{0,1.08,0});
...
Material31.setDiffuseColor(new float[]{1,1,0.3});
...
Transform34.setRotation(new float[]{0,0,1,-1.57079});
...
Material40.setEmissiveColor(new float[]{0.33,0,0});
...
Transform41.setTranslation(new float[]{0,1,0});
Shape& Shape42 =  Shape();
Cone& Cone43 =  Cone();
...
Transform45.setRotation(new float[]{0,0,1,1.57079});
Transform45.setTranslation(new float[]{0.072,1.1,0});
...
Text& Text49 =  Text();
Text49.setString(new CString[]{CString("X")}, 1);
...
Transform51.setRotation(new float[]{1,0,0,1.57079});
...
Material57.setDiffuseColor(new float[]{0.3,0.3,1});
...
Transform58.setTranslation(new float[]{0,1,0});
Shape& Shape59 =  Shape();
Cone& Cone60 =  Cone();
...
Transform62.setRotation(new float[]{1,0,0,-1.57079});
Transform62.setTranslation(new float[]{0,1.1,0.072});
//note label rotated back to original coordinate frame
...
Text& Text66 =  Text();
Text66.setString(new CString[]{CString("Z")}, 1);

...
HAnimJoint33.setCenter(new float[]{0,30.53,-0.7076});
...
Transform35.setTranslation(new float[]{0,30.53,-0.7076});
Shape& Shape36 =  Shape();
...
HAnimJoint43.setCenter(new float[]{0,35.8,-0.7076});
...
Transform45.setTranslation(new float[]{0,35.8,-0.7076});
Shape& Shape46 =  Shape();

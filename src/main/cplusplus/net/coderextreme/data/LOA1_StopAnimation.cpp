...
ProtoDeclare17->setName("LOA1_StopAnimation");
...
field19->setValue("0.00999999977648258");
...
PositionInterpolator56->setKey(new float[2]{0,1}, 2);
PositionInterpolator56->setKeyValue(new float[6]{0,0,0,0,0,0});
CIS* IS57 = new CIS();
...
OrientationInterpolator74->setKeyValue(new float[8]{1,0,0,0,1,0,0,0});
CIS* IS75 = new CIS();
...
OrientationInterpolator77->setKeyValue(new float[8]{0,0,1,0,0,0,1,0});
CIS* IS78 = new CIS();
...
OrientationInterpolator86->setKeyValue(new float[8]{1,0,0,0,1,0,0,0});
CIS* IS87 = new CIS();
...
OrientationInterpolator89->setKeyValue(new float[8]{0,0,1,0,0,0,1,0});
CIS* IS90 = new CIS();
...
OrientationInterpolator95->setKey(new float[2]{0,1}, 2);
OrientationInterpolator95->setKeyValue(new float[8]{0,0,1,0,0,0,1,0});
CIS* IS96 = new CIS();
...
WorldInfo132->setTitle("LOA1_StopAnimation.x3d");
...
Text137->setString(new CString[6]{"LOA1_StopAnimation.x3d","defines a prototype","for animating a humanoid.","","Click this text to see","InterchangableActorsViaDynamicRouting example."}, 6);

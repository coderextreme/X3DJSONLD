...
Transform11.setTranslation(new float[]{48,27,0});
...
Material15.setDiffuseColor(new float[]{1,1,1});
...
Material22.setDiffuseColor(new float[]{0,0,1});
...
Coordinate24.setPoint(new float[]{25,36,-0.01,-25,36,-0.01,-25,-51,-0.01,25,-51,-0.01}, 12);

...
Background12.setSkyColor(new float[]{0,0,0.9}, 3);
...
Material17.setDiffuseColor(new float[]{0,0,0});
...
Transform26.setTranslation(new float[]{0,-0.02,0});
...
Material30.setDiffuseColor(new float[]{0.678,1,0.184});
...
Extrusion31.setCrossSection(new float[]{0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0,0.013,-0.00494,-0.01196,-0.00923,-0.00923,-0.01196,-0.00494,-0.013,0,-0.01196,0.00494,-0.00923,0.00923,-0.00494,0.01196,0,0.013}, 34);
Extrusion31.setSpine(new float[]{-0.01,-0.04,0,0,0,0,0.03,0.05,0,0.05,0.2,0,0.03,0.4,0.03}, 15);
...
Transform32.setRotation(new float[]{0,0,1,1.57});
...
Material35.setDiffuseColor(new float[]{0.678,1,0.8});
...
Extrusion36.setCrossSection(new float[]{0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0,0.013,-0.00494,-0.01196,-0.00923,-0.00923,-0.01196,-0.00494,-0.013,0,-0.01196,0.00494,-0.00923,0.00923,-0.00494,0.01196,0,0.013}, 34);
Extrusion36.setSpine(new float[]{-0.01,-0.03,0,0,0,0,0.02,0.01,0}, 9);
...
Transform37.setRotation(new float[]{0,0,1,-0.85});
...
Extrusion41.setCrossSection(new float[]{0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0,0.013}, 18);
Extrusion41.setSpine(new float[]{-0.02,-0.03,0,-0.01,-0.03,0,0,-0.0175,0,0,-0.0135,0,-0.01,0,0,-0.02,0,0}, 18);
...
Material45.setDiffuseColor(new float[]{0.941,0.973,1});
...
Coordinate47.setPoint(new float[]{0,0.08,0,0.02,0.05,0,0.05,0.05,0,0.06,0.06,0,0.06,0.09,0,0.05,0.1,0,0,0.1,0,-0.05,0.1,0,-0.06,0.09,0,-0.06,0.06,0,-0.05,0.05,0,-0.02,0.05,0,0.005,0.08,0,0.02,0.055,0,0.05,0.055,0,0.055,0.06,0,0.055,0.09,0,0.045,0.095,0,0.005,0.095,0,-0.005,0.08,0,-0.02,0.055,0,-0.05,0.055,0,-0.055,0.06,0,-0.055,0.09,0,-0.045,0.095,0,-0.005,0.095,0}, 78);
...
Coordinate53.setPoint(new float[]{0,0.08,0,0.02,0.05,0,0.05,0.05,0,0.06,0.06,0,0.06,0.09,0,0.05,0.1,0,0,0.1,0,-0.05,0.1,0,-0.06,0.09,0,-0.06,0.06,0,-0.05,0.05,0,-0.02,0.05,0,0.005,0.08,0,0.02,0.055,0,0.05,0.055,0,0.055,0.06,0,0.055,0.09,0,0.045,0.095,0,0.005,0.095,0,-0.005,0.08,0,-0.02,0.055,0,-0.05,0.055,0,-0.055,0.06,0,-0.055,0.09,0,-0.045,0.095,0,-0.005,0.095,0}, 78);
...
Material57.setDiffuseColor(new float[]{0.678,1,0.184});

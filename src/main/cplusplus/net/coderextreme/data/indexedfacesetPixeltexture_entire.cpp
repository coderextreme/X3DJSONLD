...
Viewpoint18.setOrientation(new float[]{0,1,0,3.14});
Viewpoint18.setPosition(new float[]{0,0,-10});
...
Viewpoint19.setPosition(new float[]{0,10,0});
Scene16.addChild(&Viewpoint19);

Viewpoint& Viewpoint20 =  Viewpoint();
Viewpoint20.setDescription(CString("Bottom View"));
Viewpoint20.setOrientation(new float[]{1,0,0,1.57});
Viewpoint20.setPosition(new float[]{0,-10,0});
...
Viewpoint21.setPosition(new float[]{10,0,0});
Scene16.addChild(&Viewpoint21);

Viewpoint& Viewpoint22 =  Viewpoint();
Viewpoint22.setDescription(CString("Left View"));
Viewpoint22.setOrientation(new float[]{0,1,0,-1.57});
Viewpoint22.setPosition(new float[]{-10,0,0});
...
Coordinate30.setPoint(new float[]{-2,1.5,1,-2,-1.5,1,2,1.5,1,2,-1.5,1,2,1.5,-1,2,-1.5,-1,-2,1.5,-1,-2,-1.5,-1}, 24);

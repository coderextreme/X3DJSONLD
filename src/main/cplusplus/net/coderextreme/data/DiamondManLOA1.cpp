...
HAnimJoint35.setCenter(new float[]{0,0.824,0.0277});
...
HAnimJoint36.setCenter(new float[]{0,0.9149,0.0016});
...
Transform38.setTranslation(new float[]{0,0.9149,0.0016});
Shape& Shape39 =  Shape();
...
Coordinate43.setPoint(new float[]{0,0.01,0,-0.01,0,0,0,0,0.01,0.01,0,0,0,0,-0.01,0,-0.01,0}, 18);
...
HAnimJoint88.setCenter(new float[]{-0.0801,0,0.0368});
...
Transform100.setRotation(new float[]{1,0,0,0.119});
...
Transform106.setRotation(new float[]{-1,0,0,0.1});
...
Transform125.setRotation(new float[]{1,0,0,0.0836});
...
Transform131.setRotation(new float[]{-1,0,0,0.1254});
...
HAnimJoint146.setCenter(new float[]{0,1.43,-0.0458});
...
Viewpoint255.setPosition(new float[]{0,0.854,2.57665});
...
Viewpoint256.setPosition(new float[]{2.5929,0.854,0});
Viewpoint256.setOrientation(new float[]{0,1,0,1.57079});
...
Viewpoint257.setPosition(new float[]{0,3.4495,0});
Viewpoint257.setOrientation(new float[]{1,0,0,-1.57079});

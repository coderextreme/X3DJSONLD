...
MetadataString28->setValue(new String[1]{"male"}, 1);
...
ImageTexture37->setUrl(new String[2]{"images/Chul.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Chul.png"}, 2);

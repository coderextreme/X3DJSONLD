...
Background17.setSkyColor(new float[]{0.72549,1,0.721569}, 3);
...
TextureCoordinate27.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
...
TextureCoordinate29.setPoint(new float[]{0,0,1,0,1,1,0,1}, 8);
...
MultiTexture32.setColor(new float[]{0.9,1,0.2});

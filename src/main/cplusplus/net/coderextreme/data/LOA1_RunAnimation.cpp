...
PositionInterpolator58.setKey(new float[]{0,0.2182,0.2909,0.3091,0.7091,0.8,0.8182,1}, 8);
PositionInterpolator58.setKeyValue(new float[]{0,-0.0351,0,0,-0.0351,0,0,-0.04087,0,0,-0.04886,0,0,-0.04051,0,0,-0.03666,0,0,-0.03666,0,0,-0.0351,0}, 24);
IS& IS59 =  IS();
...
OrientationInterpolator67.setKey(new float[]{0,0.2182,0.4909,0.7455,1}, 5);
...
OrientationInterpolator70.setKey(new float[]{0,0.2182,0.4909,0.7455,1}, 5);
OrientationInterpolator70.setKeyValue(new float[]{1,0,0,1.108,1,0,0,0.4265,1,0,0,0.7052,1,0,0,2.179,1,0,0,1.108}, 20);
IS& IS71 =  IS();
...
OrientationInterpolator73.setKey(new float[]{0,0.2182,0.3091,0.4909,1}, 5);
OrientationInterpolator73.setKeyValue(new float[]{1,0,0,0.03543,-1,0,0,0.1037,-1,0,0,0.4328,1,0,0,0.1929,1,0,0,0.03543}, 20);
IS& IS74 =  IS();
...
OrientationInterpolator79.setKey(new float[]{0,0.2182,0.4909,0.7455,1}, 5);
OrientationInterpolator79.setKeyValue(new float[]{0.9999,0.00293,-0.00989,0.402,-1,0.004977,-0.00497,0.5943,-1,0.003265,-0.001752,1.178,-0.9999,0.00815,-0.01093,0.3031,0.9999,0.00293,-0.00989,0.402}, 20);
IS& IS80 =  IS();
...
OrientationInterpolator82.setKey(new float[]{0,0.03636,0.2182,0.4909,0.7455,1}, 6);
OrientationInterpolator82.setKeyValue(new float[]{1,0,0,0.7004,1,0,0,1.011,1,0,0,1.892,1,0,0,1.188,1,0,0,0.3964,1,0,0,0.7004}, 24);
IS& IS83 =  IS();
...
OrientationInterpolator85.setKey(new float[]{0,0.4909,0.7091,0.8,0.8182,1}, 6);
OrientationInterpolator85.setKeyValue(new float[]{1,0,0,0.2323,-1,0,0,0.07843,-1,0,0,0.09676,-1,0,0,0.3274,-1,0,0,0.3278,1,0,0,0.2323}, 24);
IS& IS86 =  IS();
...
OrientationInterpolator91.setKey(new float[]{0,0.2545,0.4909,0.7636,1}, 5);
...
OrientationInterpolator94.setKey(new float[]{0,0.4909,1}, 3);
...
OrientationInterpolator97.setKey(new float[]{0,0.2182,0.4909,0.7455,1}, 5);
...
OrientationInterpolator100.setKey(new float[]{0,0.2182,0.4909,0.7455,1}, 5);
...
OrientationInterpolator106.setKey(new float[]{0,0.2182,0.4909,0.7455,1}, 5);
OrientationInterpolator106.setKeyValue(new float[]{-1,0,0,0.6979,0.9094,0.2062,-0.3613,0.4157,0.9637,0.1537,-0.2185,1.353,0.4864,0.08841,-0.8693,0.1716,-1,0,0,0.6979}, 20);
IS& IS107 =  IS();
...
OrientationInterpolator109.setKey(new float[]{0,0.2182,0.4909,0.7455,1}, 5);

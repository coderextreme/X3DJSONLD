...
Background18.setGroundColor(new float[]{0,0.5,0,0,0.5,0}, 6);
Background18.setSkyColor(new float[]{0,0,1}, 3);
...
Viewpoint21.setOrientation(new float[]{1,0,0,-1.57});
Viewpoint21.setPosition(new float[]{0,10,0});

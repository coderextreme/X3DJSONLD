...
CViewpointGroup* ViewpointGroup27 = (CViewpointGroup *)(m_pScene.createNode("ViewpointGroup"));
...
Viewpoint29->setOrientation(new float[4]{1,0,0,-1.570796});
Viewpoint29->setPosition(new float[3]{0,100,0});
ViewpointGroup27->addChildren(*Viewpoint29);

group->addChildren(*ViewpointGroup27);

CNavigationInfo* NavigationInfo30 = (CNavigationInfo *)(m_pScene.createNode("NavigationInfo"));
NavigationInfo30->setType(new CString[3]{"EXAMINE","FLY","ANY"}, 3);
...
CProtoDeclare ProtoDeclare107 = browser.createX3DFromString(R"foo(<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE X3D PUBLIC "ISO//Web3D//DTD X3D 4.0//EN" "https://www.web3d.org/specifications/x3d-4.0.dtd">
...
CProtoDeclare ProtoDeclare149 = browser.createX3DFromString(R"foo(<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE X3D PUBLIC "ISO//Web3D//DTD X3D 4.0//EN" "https://www.web3d.org/specifications/x3d-4.0.dtd">
...
CProtoBody* ProtoBody152 = new CProtoBody();
...
CGroup* Group156 = (CGroup *)(m_pScene.createNode("Group"));
Group156->setDEF("Node2");
//intentionally empty
Group148->addChildren(*Group156);

CProtoInstance* ProtoInstance157 = (CProtoInstance *)(m_pScene.createNode("ProtoInstance"));
...
CProtoDeclare ProtoDeclare159 = browser.createX3DFromString(R"foo(<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE X3D PUBLIC "ISO//Web3D//DTD X3D 4.0//EN" "https://www.web3d.org/specifications/x3d-4.0.dtd">
<ProtoDeclare name="ShaderProto" ><ProtoBody><ProgramShader></ProgramShader>
</ProtoBody>
</ProtoDeclare>)foo");
ProtoDeclare159->setName("ShaderProto");
CProtoBody* ProtoBody160 = new CProtoBody();
CProgramShader* ProgramShader161 = (CProgramShader *)(m_pScene.createNode("ProgramShader"));
ProtoBody160->addChildren(*ProgramShader161);

ProtoDeclare159->setProtoBody(*ProtoBody160);

group->addChildren(*ProtoDeclare159);
...
CProgramShader* ProgramShader164 = (CProgramShader *)(m_pScene.createNode("ProgramShader"));
ProgramShader164->setDEF("TestShader1");
CShaderProgram* ShaderProgram165 = (CShaderProgram *)(m_pScene.createNode("ShaderProgram"));
...
CComposedShader* ComposedShader167 = (CComposedShader *)(m_pScene.createNode("ComposedShader"));
ComposedShader167->setDEF("TestShader4");
CShaderPart* ShaderPart168 = (CShaderPart *)(m_pScene.createNode("ShaderPart"));

...
HAnimJoint931->setName(CString("l_sternoclavicular"));
...
HAnimJoint941->setName(CString("l_acromioclavicular"));
...
HAnimJoint1211->setName(CString("r_sternoclavicular"));
...
HAnimJoint1221->setName(CString("r_acromioclavicular"));

...
Transform12.setTranslation(new float[]{0.0,1.0,0.0});
Shape& Shape13 =  Shape();
...
Transform16.setTranslation(new float[]{0.0,-1.0,0.0});
Transform16.setRotation(new float[]{1.0,0.0,0.0,3.1416});
Shape& Shape17 =  Shape();
...
Transform18.setTranslation(new float[]{0.0,1.08,0.0});
...
Transform25.setRotation(new float[]{0.0,0.0,1.0,-1.5708});
Group& Group26 =  Group();
Group& Group27 =  Group();
...
Transform28.setTranslation(new float[]{0.072,1.1,0.0});
Transform28.setRotation(new float[]{0.0,0.0,1.0,1.5708});
...
Transform34.setRotation(new float[]{1.0,0.0,0.0,1.5708});
Group& Group35 =  Group();
Group& Group36 =  Group();
...
Transform37.setTranslation(new float[]{0.0,1.1,0.072});
Transform37.setRotation(new float[]{1.0,0.0,0.0,-1.5708});

...
HAnimHumanoid27->setName(CString("Foot_Right"));
...
MetadataSet28->setName(CString("HAnimHumanoid.info"));
MetadataSet28->setReference(CString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid"));
MetadataString* MetadataString29 = new MetadataString();
MetadataString29->setName(CString("authorName"));
...
HAnimJoint31->setName(CString("r_talocrural"));
...
HAnimSegment32->setName(CString("r_talus"));
...
Coordinate42->setPoint(new float[6]{0,0,0,0,-0.3,0}, 6);
IndexedLineSet41->addChild(Coordinate42);
...
Coordinate47->setPoint(new float[6]{0,0,0,-0.2,0.3,0}, 6);
IndexedLineSet46->addChild(Coordinate47);
...
HAnimJoint48->setName(CString("r_talocalcaneonavicular"));
...
HAnimSegment49->setName(CString("r_navicular"));
...
Coordinate56->setPoint(new float[6]{0,-0.3,0,0.1,-0.45,0}, 6);
IndexedLineSet55->addChild(Coordinate56);
...
Coordinate61->setPoint(new float[6]{0,-0.3,0,0,-0.45,0}, 6);
IndexedLineSet60->addChild(Coordinate61);
...
Coordinate66->setPoint(new float[6]{0,-0.3,0,-0.1,-0.4,0}, 6);
IndexedLineSet65->addChild(Coordinate66);
...
HAnimJoint67->setName(CString("r_cuneonavicular_1"));
...
HAnimSegment68->setName(CString("r_cuneiform_1"));
...
Coordinate75->setPoint(new float[6]{0.1,-0.45,0,0.1,-0.6,0}, 6);
IndexedLineSet74->addChild(Coordinate75);
...
HAnimJoint76->setName(CString("r_tarsometatarsal_1"));
...
HAnimSegment77->setName(CString("r_metatarsal_1"));
...
Coordinate84->setPoint(new float[6]{0.1,-0.6,0,0.1,-0.9,0}, 6);
IndexedLineSet83->addChild(Coordinate84);
...
HAnimJoint85->setName(CString("r_metatarsophalangeal_1"));
...
HAnimSegment86->setName(CString("r_tarsal_proximal_phalanx_1"));
...
Coordinate93->setPoint(new float[6]{0.1,-0.9,0,0.1,-1.05,0}, 6);
IndexedLineSet92->addChild(Coordinate93);
...
HAnimJoint94->setName(CString("r_tarsal_interphalangeal_1"));
...
HAnimSegment95->setName(CString("r_tarsal_distal_phalanx_1"));
...
Coordinate102->setPoint(new float[6]{0.1,-1.05,0,0.1,-1.1,0}, 6);
IndexedLineSet101->addChild(Coordinate102);
...
HAnimJoint103->setName(CString("r_cuneonavicular_2"));
...
HAnimSegment104->setName(CString("r_cuneiform_2"));
...
Coordinate111->setPoint(new float[6]{0,-0.45,0,-0.05,-0.6,0}, 6);
IndexedLineSet110->addChild(Coordinate111);
...
HAnimJoint112->setName(CString("r_tarsometatarsal_2"));
...
HAnimSegment113->setName(CString("r_metatarsal_2"));
...
Coordinate120->setPoint(new float[6]{-0.05,-0.6,0,-0.05,-0.9,0}, 6);
IndexedLineSet119->addChild(Coordinate120);
...
HAnimJoint121->setName(CString("r_metatarsophalangeal_2"));
...
HAnimSegment122->setName(CString("r_tarsal_proximal_phalanx_2"));
...
Coordinate129->setPoint(new float[6]{-0.05,-0.9,0,-0.05,-1.05,0}, 6);
IndexedLineSet128->addChild(Coordinate129);
...
HAnimJoint130->setName(CString("r_tarsal_proximal_interphalangeal_2"));
...
HAnimSegment131->setName(CString("r_tarsal_middle_phalanx_2"));
...
Coordinate138->setPoint(new float[6]{-0.05,-1.05,0,-0.05,-1.12,0}, 6);
IndexedLineSet137->addChild(Coordinate138);
...
HAnimJoint139->setName(CString("r_tarsal_distal_interphalangeal_2"));
...
HAnimSegment140->setName(CString("r_tarsal_distal_phalanx_2"));
...
Coordinate147->setPoint(new float[6]{-0.05,-1.12,0,-0.05,-1.16,0}, 6);
IndexedLineSet146->addChild(Coordinate147);
...
HAnimJoint148->setName(CString("r_cuneonavicular_3"));
...
HAnimSegment149->setName(CString("r_cuneiform_3"));
...
Coordinate156->setPoint(new float[6]{-0.1,-0.4,0,-0.15,-0.6,0}, 6);
IndexedLineSet155->addChild(Coordinate156);
...
HAnimJoint157->setName(CString("r_tarsometatarsal_3"));
...
HAnimSegment158->setName(CString("r_metatarsal_3"));
...
Coordinate165->setPoint(new float[6]{-0.15,-0.6,0,-0.15,-0.9,0}, 6);
IndexedLineSet164->addChild(Coordinate165);
...
HAnimJoint166->setName(CString("r_metatarsophalangeal_3"));
...
HAnimSegment167->setName(CString("r_tarsal_proximal_phalanx_3"));
...
Coordinate174->setPoint(new float[6]{-0.15,-0.9,0,-0.15,-1.05,0}, 6);
IndexedLineSet173->addChild(Coordinate174);
...
HAnimJoint175->setName(CString("r_tarsal_proximal_interphalangeal_3"));
...
HAnimSegment176->setName(CString("r_tarsal_middle_phalanx_3"));
...
Coordinate183->setPoint(new float[6]{-0.15,-1.05,0,-0.15,-1.13,0}, 6);
IndexedLineSet182->addChild(Coordinate183);
...
HAnimJoint184->setName(CString("r_tarsal_distal_interphalangeal_3"));
...
HAnimSegment185->setName(CString("r_tarsal_distal_phalanx_3"));
...
Coordinate192->setPoint(new float[6]{-0.15,-1.13,0,-0.15,-1.16,0}, 6);
IndexedLineSet191->addChild(Coordinate192);
...
HAnimJoint193->setName(CString("r_calcaneocuboid"));
...
HAnimSegment194->setName(CString("r_calcaneus"));
...
Coordinate201->setPoint(new float[6]{-0.2,0.3,0,-0.21,-0.3,0}, 6);
IndexedLineSet200->addChild(Coordinate201);
...
HAnimJoint202->setName(CString("r_transversetarsal"));
...
HAnimSegment203->setName(CString("r_cuboid"));
...
Coordinate210->setPoint(new float[6]{-0.21,-0.3,0,-0.25,-0.58,0}, 6);
IndexedLineSet209->addChild(Coordinate210);
...
Coordinate215->setPoint(new float[6]{-0.21,-0.3,0,-0.33,-0.52,0}, 6);
IndexedLineSet214->addChild(Coordinate215);
...
HAnimJoint216->setName(CString("r_tarsometatarsal_4"));
...
HAnimSegment217->setName(CString("r_metatarsal_4"));
...
Coordinate224->setPoint(new float[6]{-0.25,-0.58,0,-0.25,-0.87,0}, 6);
IndexedLineSet223->addChild(Coordinate224);
...
HAnimJoint225->setName(CString("r_metatarsophalangeal_4"));
...
HAnimSegment226->setName(CString("r_tarsal_proximal_phalanx_4"));
...
Coordinate233->setPoint(new float[6]{-0.25,-0.87,0,-0.25,-1,0}, 6);
IndexedLineSet232->addChild(Coordinate233);
...
HAnimJoint234->setName(CString("r_tarsal_proximal_interphalangeal_4"));
...
HAnimSegment235->setName(CString("r_tarsal_middle_phalanx_4"));
...
Coordinate242->setPoint(new float[6]{-0.25,-1,0,-0.25,-1.1,0}, 6);
IndexedLineSet241->addChild(Coordinate242);
...
HAnimJoint243->setName(CString("r_tarsal_distal_interphalangeal_4"));
...
HAnimSegment244->setName(CString("r_tarsal_distal_phalanx_4"));
...
Coordinate251->setPoint(new float[6]{-0.25,-1.1,0,-0.25,-1.15,0}, 6);
IndexedLineSet250->addChild(Coordinate251);
...
HAnimJoint252->setName(CString("r_tarsometatarsal_5"));
...
HAnimSegment253->setName(CString("r_metatarsal_5"));
...
Coordinate260->setPoint(new float[6]{-0.33,-0.52,0,-0.34,-0.8,0}, 6);
IndexedLineSet259->addChild(Coordinate260);
...
HAnimJoint261->setName(CString("r_metatarsophalangeal_5"));
...
HAnimSegment262->setName(CString("r_tarsal_proximal_phalanx_5"));
...
Coordinate269->setPoint(new float[6]{-0.34,-0.8,0,-0.34,-0.95,0}, 6);
IndexedLineSet268->addChild(Coordinate269);
...
HAnimJoint270->setName(CString("r_tarsal_proximal_interphalangeal_5"));
...
HAnimSegment271->setName(CString("r_tarsal_middle_phalanx_5"));
...
Coordinate278->setPoint(new float[6]{-0.34,-0.95,0,-0.34,-1.05,0}, 6);
IndexedLineSet277->addChild(Coordinate278);
...
HAnimJoint279->setName(CString("r_tarsal_distal_interphalangeal_5"));
...
HAnimSegment280->setName(CString("r_tarsal_distal_phalanx_5"));
...
Coordinate287->setPoint(new float[6]{-0.34,-1.05,0,-0.34,-1.08,0}, 6);
IndexedLineSet286->addChild(Coordinate287);

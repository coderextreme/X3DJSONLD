...
meta3.setContent(CString("DiamondManLOA_0.x3d"));
head1.addMeta(&meta3);
...
meta9.setContent(CString("../Templates/DiamondManLOA_0.x3d"));
head1.addMeta(&meta9);
...
meta& meta21 =  meta();
meta21.setName(CString("error"));
meta21.setContent(CString("Legacy model, not valid as X3D4 HAnim version 2.0 since HAnim version 1.0 has significant differences and is no longer directly supported"));
...
meta23.setContent(CString("humanoid_landmark_locations.gif"));
head1.addMeta(&meta23);

meta& meta24 =  meta();
meta24.setName(CString("Image"));
meta24.setContent(CString("http://HAnim.org/Specifications/HAnim1.1/humanoid_landmark_locations.gif"));
head1.addMeta(&meta24);

meta& meta25 =  meta();
meta25.setName(CString("identifier"));
meta25.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA_0.x3d"));
...
Viewpoint29.setPosition(new float[]{0,1,3});
Viewpoint29.setCenterOfRotation(new float[]{0,1,0});
...
HAnimHumanoid30.setVersion(CString("1.0"));
...
HAnimJoint38.setDEF(CString("hanim_HumanoidRoot"));
HAnimJoint38.X3DNode::setName(CString("humanoid_root"));
HAnimJoint38.setCenter(new float[]{0,0.824,0.0277});
...
HAnimJoint39.setCenter(new float[]{0,0.9149,0.0016});
...
IndexedFaceSet45.setCoordIndex(new int32_t[]{0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,1,-1,5,2,1,-1,5,3,2,-1,5,4,3,-1,5,1,4,-1}, 32);
Coordinate& Coordinate46 =  Coordinate();
Coordinate46.setPoint(new float[]{0,0.01,0,-0.01,0,0,0,0,0.01,0.01,0,0,0,0,-0.01,0,-0.01,0}, 18);
...
HAnimJoint47.setUSE(CString("hanim_HumanoidRoot"));
HAnimHumanoid30.setJoints(&HAnimJoint47);

HAnimJoint& HAnimJoint48 =  HAnimJoint();
HAnimJoint48.setUSE(CString("hanim_sacroiliac"));
HAnimHumanoid30.setJoints(&HAnimJoint48);

HAnimSegment& HAnimSegment49 =  HAnimSegment();
HAnimSegment49.setUSE(CString("hanim_pelvis"));
HAnimHumanoid30.setSegments(&HAnimSegment49);

HAnimSite& HAnimSite50 =  HAnimSite();
HAnimSite50.setDEF(CString("hanim_site_view"));
HAnimSite50.X3DNode::setName(CString("site_view"));
Viewpoint& Viewpoint51 =  Viewpoint();
Viewpoint51.setDEF(CString("InclinedView"));
Viewpoint51.setDescription(CString("Inclined View"));
Viewpoint51.setPosition(new float[]{1.62,1.05,2.06});
Viewpoint51.setOrientation(new float[]{-0.113,0.993,0.0347,0.671});
HAnimSite50.addChild(&Viewpoint51);

Viewpoint& Viewpoint52 =  Viewpoint();
Viewpoint52.setDEF(CString("FrontView"));
Viewpoint52.setDescription(CString("Front View"));
Viewpoint52.setPosition(new float[]{0,0.854,2.57665});
HAnimSite50.addChild(&Viewpoint52);

Viewpoint& Viewpoint53 =  Viewpoint();
Viewpoint53.setDEF(CString("SideView"));
Viewpoint53.setDescription(CString("Side View"));
Viewpoint53.setPosition(new float[]{2.5929,0.854,0});
Viewpoint53.setOrientation(new float[]{0,1,0,1.57079});
HAnimSite50.addChild(&Viewpoint53);

Viewpoint& Viewpoint54 =  Viewpoint();
Viewpoint54.setDEF(CString("TopView"));
Viewpoint54.setDescription(CString("Top View"));
Viewpoint54.setPosition(new float[]{0,3.4495,0});
Viewpoint54.setOrientation(new float[]{1,0,0,-1.57079});
HAnimSite50.addChild(&Viewpoint54);

HAnimHumanoid30.setViewpoints(&HAnimSite50);

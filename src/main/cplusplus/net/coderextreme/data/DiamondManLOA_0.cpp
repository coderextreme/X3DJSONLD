...
meta23->setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA_0.x3d");
...
HAnimJoint52->setUSE("hanim_HumanoidRoot");

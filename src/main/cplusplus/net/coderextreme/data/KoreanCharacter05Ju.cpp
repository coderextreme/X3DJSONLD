...
WorldInfo* WorldInfo21 = new WorldInfo();
WorldInfo21->setTitle(CString("KoreanCharacter05Ju.x3d"));
Scene20->addChild(WorldInfo21);

NavigationInfo* NavigationInfo22 = new NavigationInfo();
...
HAnimHumanoid24->setName(CString("Ju"));
...
MetadataString26->setValue(new CString[1]{CString("Chul Hee Jung and Myeong Won Lee")}, 1);
MetadataSet25->setValue((X3DNode *)MetadataString26);

MetadataString* MetadataString27 = new MetadataString();
MetadataString27->setName(CString("authorEmail"));
MetadataString27->setValue(new CString[1]{CString("myeongwonlee@gmail.com")}, 1);
MetadataSet25->setValue((X3DNode *)MetadataString27);

MetadataString* MetadataString28 = new MetadataString();
MetadataString28->setName(CString("creationDate"));
MetadataString28->setValue(new CString[1]{CString("31 March 2011")}, 1);
MetadataSet25->setValue((X3DNode *)MetadataString28);

MetadataString* MetadataString29 = new MetadataString();
MetadataString29->setName(CString("gender"));
MetadataString29->setValue(new CString[1]{CString("female")}, 1);
MetadataSet25->setValue((X3DNode *)MetadataString29);

MetadataFloat* MetadataFloat30 = new MetadataFloat();
MetadataFloat30->setName(CString("height"));
MetadataFloat30->setValue(new float[1]{1.5}, 1);
MetadataSet25->setValue((X3DNode *)MetadataFloat30);

MetadataString* MetadataString31 = new MetadataString();
MetadataString31->setName(CString("humanoidVersion"));
MetadataString31->setValue(new CString[1]{CString("2.0")}, 1);
...
HAnimSegment* HAnimSegment33 = new HAnimSegment();
HAnimSegment33->setName(CString("sacrum"));
...
IndexedFaceSet39->addChild(Coordinate40);

TextureCoordinate* TextureCoordinate41 = new TextureCoordinate();
...
IndexedFaceSet39->addChild(TextureCoordinate41);
...
HAnimJoint42->setName(CString("l_hip"));
...
HAnimSegment43->setName(CString("l_thigh"));
...
ImageTexture* ImageTexture48 = new ImageTexture();
ImageTexture48->setUSE(CString("JuTextureAtlas"));
Appearance46->addChild(ImageTexture48);

Shape45->addChild(Appearance46);

IndexedFaceSet* IndexedFaceSet49 = new IndexedFaceSet();
IndexedFaceSet49->setCoordIndex(new int32_t[384]{33,32,31,-1,31,30,29,-1,31,29,28,-1,33,31,28,-1,34,33,28,-1,0,1,8,-1,8,7,0,-1,1,2,9,-1,9,8,1,-1,2,3,10,-1,10,9,2,-1,3,4,11,-1,11,10,3,-1,4,5,12,-1,12,11,4,-1,5,6,13,-1,13,12,5,-1,6,0,7,-1,7,13,6,-1,7,8,15,-1,15,14,7,-1,8,9,16,-1,16,15,8,-1,9,10,17,-1,17,16,9,-1,10,11,18,-1,18,17,10,-1,11,12,19,-1,19,18,11,-1,12,13,20,-1,20,19,12,-1,13,7,14,-1,14,20,13,-1,14,15,22,-1,22,21,14,-1,15,16,23,-1,23,22,15,-1,16,17,24,-1,24,23,16,-1,17,18,25,-1,25,24,17,-1,18,19,26,-1,26,25,18,-1,19,20,27,-1,27,26,19,-1,20,14,21,-1,21,27,20,-1,28,29,1,-1,1,0,28,-1,29,30,2,-1,2,1,29,-1,30,31,3,-1,3,2,30,-1,31,32,4,-1,4,3,31,-1,32,33,5,-1,5,4,32,-1,33,34,6,-1,6,5,33,-1,34,28,0,-1,0,6,34,-1,21,22,35,-1,35,36,21,-1,22,23,37,-1,37,35,22,-1,23,24,38,-1,38,37,23,-1,24,25,39,-1,39,38,24,-1,25,26,40,-1,40,39,25,-1,26,27,41,-1,41,40,26,-1,27,21,36,-1,36,41,27,-1,36,35,42,-1,42,43,36,-1,35,37,44,-1,44,42,35,-1,37,38,45,-1,45,44,37,-1,38,39,46,-1,46,45,38,-1,39,40,47,-1,47,46,39,-1,40,41,48,-1,48,47,40,-1,41,36,43,-1,43,48,41,-1,43,42,49,-1,42,44,49,-1,44,45,49,-1,45,46,49,-1,46,47,49,-1,47,48,49,-1,48,43,49,-1}, 384);
IndexedFaceSet49->setCreaseAngle(1.57);
IndexedFaceSet49->setTexCoordIndex(new int32_t[384]{5,4,3,-1,3,2,0,-1,3,0,1,-1,5,3,1,-1,6,5,1,-1,7,10,8,-1,8,9,7,-1,10,12,11,-1,11,8,10,-1,12,14,13,-1,13,11,12,-1,14,16,15,-1,15,13,14,-1,16,18,17,-1,17,15,16,-1,18,20,19,-1,19,17,18,-1,20,7,9,-1,9,19,20,-1,9,8,21,-1,21,22,9,-1,8,11,23,-1,23,21,8,-1,11,13,24,-1,24,23,11,-1,13,15,25,-1,25,24,13,-1,15,17,26,-1,26,25,15,-1,17,19,27,-1,27,26,17,-1,19,9,22,-1,22,27,19,-1,22,21,28,-1,28,29,22,-1,21,23,30,-1,30,28,21,-1,23,24,31,-1,31,30,23,-1,24,25,32,-1,32,31,24,-1,25,26,33,-1,33,32,25,-1,26,27,34,-1,34,33,26,-1,27,22,29,-1,29,34,27,-1,1,0,10,-1,10,7,1,-1,0,2,12,-1,12,10,0,-1,2,3,14,-1,14,12,2,-1,3,4,16,-1,16,14,3,-1,4,5,18,-1,18,16,4,-1,5,6,20,-1,20,18,5,-1,6,1,7,-1,7,20,6,-1,29,28,35,-1,35,36,29,-1,28,30,37,-1,37,35,28,-1,30,31,38,-1,38,37,30,-1,31,32,39,-1,39,38,31,-1,32,33,40,-1,40,39,32,-1,33,34,41,-1,41,40,33,-1,34,29,36,-1,36,41,34,-1,36,35,42,-1,42,43,36,-1,35,37,44,-1,44,42,35,-1,37,38,45,-1,45,44,37,-1,38,39,46,-1,46,45,38,-1,39,40,47,-1,47,46,39,-1,40,41,48,-1,48,47,40,-1,41,36,43,-1,43,48,41,-1,43,42,49,-1,42,44,49,-1,44,45,49,-1,45,46,49,-1,46,47,49,-1,47,48,49,-1,48,43,49,-1}, 384);
...
IndexedFaceSet49->addChild(Coordinate50);

TextureCoordinate* TextureCoordinate51 = new TextureCoordinate();
...
IndexedFaceSet49->addChild(TextureCoordinate51);
...
HAnimJoint52->setName(CString("l_knee"));
...
HAnimSegment53->setName(CString("l_calf"));
...
IndexedFaceSet59->addChild(Coordinate60);

TextureCoordinate* TextureCoordinate61 = new TextureCoordinate();
...
IndexedFaceSet59->addChild(TextureCoordinate61);
...
HAnimJoint62->setName(CString("l_talocrural"));
HAnimJoint62->setDEF(CString("hanim_l_talocrural"));
HAnimJoint62->setCenter(new float[3]{3.467,3.522,0.118});
HAnimSegment* HAnimSegment63 = new HAnimSegment();
HAnimSegment63->setName(CString("l_talus"));
...
IndexedFaceSet69->addChild(Coordinate70);

TextureCoordinate* TextureCoordinate71 = new TextureCoordinate();
...
IndexedFaceSet69->addChild(TextureCoordinate71);
...
HAnimJoint72->setName(CString("l_metatarsophalangeal_2"));
HAnimJoint72->setDEF(CString("hanim_l_metatarsophalangeal_2"));
HAnimJoint72->setCenter(new float[3]{3.467,3.251,1.465});
HAnimSegment* HAnimSegment73 = new HAnimSegment();
HAnimSegment73->setName(CString("l_tarsal_proximal_phalanx_2"));
HAnimSegment73->setDEF(CString("hanim_l_tarsal_proximal_phalanx_2"));
Transform* Transform74 = new Transform();
...
IndexedFaceSet79->addChild(Coordinate80);

TextureCoordinate* TextureCoordinate81 = new TextureCoordinate();
...
IndexedFaceSet79->addChild(TextureCoordinate81);
...
HAnimSegment83->setName(CString("r_thigh"));
...
IndexedFaceSet89->addChild(TextureCoordinate91);
...
HAnimJoint92->setName(CString("r_knee"));
HAnimJoint92->setDEF(CString("hanim_r_knee"));
HAnimJoint92->setCenter(new float[3]{-3.454,18.67,-0.02158});
HAnimSegment* HAnimSegment93 = new HAnimSegment();
HAnimSegment93->setName(CString("r_calf"));
...
IndexedFaceSet99->addChild(Coordinate100);

TextureCoordinate* TextureCoordinate101 = new TextureCoordinate();
...
IndexedFaceSet99->addChild(TextureCoordinate101);
...
HAnimJoint102->setName(CString("r_talocrural"));
HAnimJoint102->setDEF(CString("hanim_r_talocrural"));
HAnimJoint102->setCenter(new float[3]{-3.679,3.522,0.118});
HAnimSegment* HAnimSegment103 = new HAnimSegment();
HAnimSegment103->setName(CString("r_talus"));
...
IndexedFaceSet109->addChild(TextureCoordinate111);
...
HAnimJoint112->setName(CString("r_metatarsophalangeal_2"));
...
HAnimSegment113->setName(CString("r_tarsal_proximal_phalanx_2"));
...
IndexedFaceSet119->addChild(Coordinate120);

TextureCoordinate* TextureCoordinate121 = new TextureCoordinate();
...
IndexedFaceSet119->addChild(TextureCoordinate121);
...
HAnimJoint32->addChild(HAnimJoint82);

HAnimJoint* HAnimJoint122 = new HAnimJoint();
HAnimJoint122->setName(CString("sacroiliac"));
...
HAnimSegment123->setName(CString("pelvis"));
...
IndexedFaceSet129->addChild(Coordinate130);

TextureCoordinate* TextureCoordinate131 = new TextureCoordinate();
...
IndexedFaceSet129->addChild(TextureCoordinate131);
...
HAnimJoint132->setName(CString("l_shoulder"));
...
HAnimSegment133->setName(CString("l_upperarm"));
...
IndexedFaceSet139->addChild(Coordinate140);

TextureCoordinate* TextureCoordinate141 = new TextureCoordinate();
...
IndexedFaceSet139->addChild(TextureCoordinate141);
...
HAnimJoint142->setName(CString("l_elbow"));
HAnimJoint142->setDEF(CString("hanim_l_elbow"));
HAnimJoint142->setCenter(new float[3]{5.297,40.119999,-2.055});
HAnimSegment* HAnimSegment143 = new HAnimSegment();
HAnimSegment143->setName(CString("l_forearm"));
...
IndexedFaceSet149->addChild(Coordinate150);

TextureCoordinate* TextureCoordinate151 = new TextureCoordinate();
...
IndexedFaceSet149->addChild(TextureCoordinate151);
...
HAnimJoint152->setName(CString("l_radiocarpal"));
...
HAnimSegment153->setName(CString("l_carpal"));
...
Material* Material157 = new Material();
Material157->setDiffuseColor(new float[3]{0.588,0.588,0.588});
Appearance156->addChild(Material157);

ImageTexture* ImageTexture158 = new ImageTexture();
ImageTexture158->setUSE(CString("JuTextureAtlas"));
Appearance156->addChild(ImageTexture158);

Shape155->addChild(Appearance156);

IndexedFaceSet* IndexedFaceSet159 = new IndexedFaceSet();
IndexedFaceSet159->setCoordIndex(new int32_t[160]{4,5,0,-1,0,2,4,-1,6,7,3,-1,3,1,6,-1,1,0,5,-1,5,6,1,-1,8,9,5,-1,5,4,8,-1,10,11,7,-1,7,6,10,-1,9,10,6,-1,6,5,9,-1,12,13,9,-1,9,8,12,-1,14,15,11,-1,11,10,14,-1,13,14,10,-1,10,9,13,-1,4,2,16,-1,2,3,7,-1,7,16,2,-1,17,19,18,-1,18,20,17,-1,21,16,7,-1,7,11,21,-1,8,21,12,-1,12,21,11,-1,11,15,12,-1,13,12,15,-1,15,14,13,-1,8,4,19,-1,19,17,8,-1,4,16,18,-1,18,19,4,-1,16,21,20,-1,20,18,16,-1,21,8,17,-1,17,20,21,-1,3,2,0,-1,0,1,3,-1}, 160);
IndexedFaceSet159->setCreaseAngle(1.57);
IndexedFaceSet159->setTexCoordIndex(new int32_t[160]{0,2,1,-1,1,3,0,-1,36,38,37,-1,37,39,36,-1,28,30,29,-1,29,31,28,-1,4,5,2,-1,2,0,4,-1,40,41,38,-1,38,36,40,-1,32,33,31,-1,31,29,32,-1,6,7,5,-1,5,4,6,-1,42,43,41,-1,41,40,42,-1,34,35,33,-1,33,32,34,-1,10,12,11,-1,12,14,13,-1,13,11,12,-1,15,17,16,-1,16,18,15,-1,19,11,13,-1,13,20,19,-1,21,19,22,-1,22,19,20,-1,20,23,22,-1,24,22,23,-1,23,25,24,-1,4,0,8,-1,8,9,4,-1,10,11,16,-1,16,17,10,-1,11,19,18,-1,18,16,11,-1,19,21,15,-1,15,18,19,-1,14,12,26,-1,26,27,14,-1}, 160);
...
IndexedFaceSet159->addChild(Coordinate160);

TextureCoordinate* TextureCoordinate161 = new TextureCoordinate();
...
IndexedFaceSet159->addChild(TextureCoordinate161);
...
HAnimJoint162->setName(CString("r_shoulder"));
...
HAnimSegment163->setName(CString("r_upperarm"));
...
IndexedFaceSet169->addChild(Coordinate170);

TextureCoordinate* TextureCoordinate171 = new TextureCoordinate();
...
IndexedFaceSet169->addChild(TextureCoordinate171);
...
HAnimJoint172->setName(CString("r_elbow"));
...
HAnimSegment173->setName(CString("r_forearm"));
...
IndexedFaceSet179->addChild(Coordinate180);

TextureCoordinate* TextureCoordinate181 = new TextureCoordinate();
...
IndexedFaceSet179->addChild(TextureCoordinate181);
...
HAnimJoint182->setName(CString("r_radiocarpal"));
HAnimJoint182->setDEF(CString("hanim_r_radiocarpal"));
HAnimJoint182->setCenter(new float[3]{-5.07,31.99,-1.559});
HAnimSegment* HAnimSegment183 = new HAnimSegment();
HAnimSegment183->setName(CString("r_carpal"));
...
ImageTexture* ImageTexture188 = new ImageTexture();
ImageTexture188->setUSE(CString("JuTextureAtlas"));
Appearance186->addChild(ImageTexture188);

Shape185->addChild(Appearance186);

IndexedFaceSet* IndexedFaceSet189 = new IndexedFaceSet();
IndexedFaceSet189->setCoordIndex(new int32_t[160]{4,2,0,-1,0,5,4,-1,6,1,3,-1,3,7,6,-1,1,6,5,-1,5,0,1,-1,8,4,5,-1,5,9,8,-1,10,6,7,-1,7,11,10,-1,9,5,6,-1,6,10,9,-1,12,8,9,-1,9,13,12,-1,14,10,11,-1,11,15,14,-1,13,9,10,-1,10,14,13,-1,4,16,2,-1,2,16,7,-1,7,3,2,-1,17,20,18,-1,18,19,17,-1,21,11,7,-1,7,16,21,-1,8,12,21,-1,12,15,11,-1,11,21,12,-1,13,14,15,-1,15,12,13,-1,8,17,19,-1,19,4,8,-1,4,19,18,-1,18,16,4,-1,16,18,20,-1,20,21,16,-1,21,20,17,-1,17,8,21,-1,3,1,0,-1,0,2,3,-1}, 160);
IndexedFaceSet189->setCreaseAngle(1.57);
IndexedFaceSet189->setTexCoordIndex(new int32_t[160]{0,3,1,-1,1,2,0,-1,36,39,37,-1,37,38,36,-1,28,31,29,-1,29,30,28,-1,4,0,2,-1,2,5,4,-1,40,36,38,-1,38,41,40,-1,32,29,31,-1,31,33,32,-1,6,4,5,-1,5,7,6,-1,42,40,41,-1,41,43,42,-1,34,32,33,-1,33,35,34,-1,10,11,12,-1,12,11,13,-1,13,14,12,-1,15,18,16,-1,16,17,15,-1,19,20,13,-1,13,11,19,-1,21,22,19,-1,22,23,20,-1,20,19,22,-1,24,25,23,-1,23,22,24,-1,4,9,8,-1,8,0,4,-1,10,17,16,-1,16,11,10,-1,11,16,18,-1,18,19,11,-1,19,18,15,-1,15,21,19,-1,14,27,26,-1,26,12,14,-1}, 160);
...
IndexedFaceSet189->addChild(Coordinate190);

TextureCoordinate* TextureCoordinate191 = new TextureCoordinate();
...
IndexedFaceSet189->addChild(TextureCoordinate191);
...
HAnimJoint122->addChild(HAnimJoint162);

HAnimJoint* HAnimJoint192 = new HAnimJoint();
HAnimJoint192->setName(CString("vl5"));
HAnimJoint192->setDEF(CString("hanim_vl5"));
HAnimJoint192->setCenter(new float[3]{0.000025,39.84,0.1163});
HAnimSegment* HAnimSegment193 = new HAnimSegment();
HAnimSegment193->setName(CString("l5"));
...
IndexedFaceSet199->addChild(Coordinate200);

TextureCoordinate* TextureCoordinate201 = new TextureCoordinate();
...
IndexedFaceSet199->addChild(TextureCoordinate201);
...
HAnimJoint202->setName(CString("skullbase"));
...
HAnimSegment203->setName(CString("skull"));
...
IndexedFaceSet209->addChild(Coordinate210);

TextureCoordinate* TextureCoordinate211 = new TextureCoordinate();
...
IndexedFaceSet209->addChild(TextureCoordinate211);
...
HAnimJoint122->addChild(HAnimJoint192);

HAnimJoint32->addChild(HAnimJoint122);
...
HAnimSegment* HAnimSegment233 = new HAnimSegment();
HAnimSegment233->setUSE(CString("hanim_skull"));
HAnimHumanoid24->setSegments(HAnimSegment233);

HAnimSegment* HAnimSegment234 = new HAnimSegment();
...
HAnimSegment* HAnimSegment236 = new HAnimSegment();
...
HAnimSegment* HAnimSegment245 = new HAnimSegment();
...
HAnimSegment* HAnimSegment247 = new HAnimSegment();

...
meta8.setContent(CString("5 November 2025"));
head1.addMeta(&meta8);
...
meta11.setContent(CString("../Poses/images/HAnimPoseExampleKoreanCharacter05Ju.png"));
head1.addMeta(&meta11);

meta& meta12 =  meta();
meta12.setName(CString("reference"));
meta12.setContent(CString("KoreanCharacter00ReadMe.txt"));
head1.addMeta(&meta12);

meta& meta13 =  meta();
meta13.setName(CString("reference"));
meta13.setContent(CString("../KoreanCharacterHumanMotion_Infotech2014_140706.pdf"));
head1.addMeta(&meta13);

meta& meta14 =  meta();
meta14.setName(CString("reference"));
meta14.setContent(CString("KoreanCharactersIllustrated.pdf"));
head1.addMeta(&meta14);

meta& meta15 =  meta();
meta15.setName(CString("identifier"));
meta15.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter05Ju.x3d"));
...
meta17.setContent(CString("Suwon University HAnim Editor"));
...
meta19.setContent(CString("X3D-Edit 3.3, https://www.web3d.org/x3d/tools/X3D-Edit"));
...
WorldInfo22.setTitle(CString("KoreanCharacter05Ju.x3d"));
Scene21.addChild(&WorldInfo22);

NavigationInfo& NavigationInfo23 =  NavigationInfo();
NavigationInfo23.setSpeed(1.5);
Scene21.addChild(&NavigationInfo23);

Viewpoint& Viewpoint24 =  Viewpoint();
Viewpoint24.setCenterOfRotation(new float[]{0,1,0});
Viewpoint24.setDescription(CString("Ju"));
Viewpoint24.setPosition(new float[]{0,1,3});
Scene21.addChild(&Viewpoint24);

HAnimHumanoid& HAnimHumanoid25 =  HAnimHumanoid();
HAnimHumanoid25.X3DNode::setName(CString("Ju"));
HAnimHumanoid25.setDEF(CString("hanim_Ju"));
HAnimHumanoid25.setScale(new float[]{0.0225,0.0225,0.0225});
...
MetadataSet26.X3DNode::setName(CString("HAnimHumanoid.info"));
MetadataSet26.X3DNode::setReference(CString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid"));
MetadataString& MetadataString27 =  MetadataString();
MetadataString27.X3DNode::setName(CString("authorName"));
MetadataString27.setValue(new CString[]{CString("Chul Hee Jung and Myeong Won Lee")}, 1);
MetadataSet26.setValue((X3DNode *)&MetadataString27);

MetadataString& MetadataString28 =  MetadataString();
MetadataString28.X3DNode::setName(CString("authorEmail"));
MetadataString28.setValue(new CString[]{CString("myeongwonlee@gmail.com")}, 1);
MetadataSet26.setValue((X3DNode *)&MetadataString28);

MetadataString& MetadataString29 =  MetadataString();
MetadataString29.X3DNode::setName(CString("creationDate"));
MetadataString29.setValue(new CString[]{CString("31 March 2011")}, 1);
MetadataSet26.setValue((X3DNode *)&MetadataString29);

MetadataString& MetadataString30 =  MetadataString();
MetadataString30.X3DNode::setName(CString("gender"));
MetadataString30.setValue(new CString[]{CString("female")}, 1);
MetadataSet26.setValue((X3DNode *)&MetadataString30);

MetadataFloat& MetadataFloat31 =  MetadataFloat();
MetadataFloat31.X3DNode::setName(CString("height"));
...
MetadataString32.X3DNode::setName(CString("humanoidVersion"));
MetadataString32.setValue(new CString[]{CString("2.0")}, 1);
...
HAnimJoint33.setCenter(new float[]{0,36,-0.008798});
...
HAnimSegment34.setDEF(CString("hanim_sacrum"));
Transform& Transform35 =  Transform();
Transform35.setTranslation(new float[]{0,36,-0.008798});
Shape& Shape36 =  Shape();
...
ImageTexture39.setDEF(CString("JuTextureAtlas"));
ImageTexture39.setUrl(new CString[]{CString("images/Ju.png"), CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ju.png")}, 2);
...
HAnimJoint43.setDEF(CString("hanim_l_hip"));
HAnimJoint43.setCenter(new float[]{3.22,33.619999,-0.2832});
...
HAnimSegment44.setDEF(CString("hanim_l_thigh"));
Transform& Transform45 =  Transform();
Transform45.setTranslation(new float[]{3.22,33.619999,-0.2832});
Shape& Shape46 =  Shape();
...
ImageTexture49.setUSE(CString("JuTextureAtlas"));
...
HAnimJoint53.X3DNode::setName(CString("l_knee"));
HAnimJoint53.setDEF(CString("hanim_l_knee"));
HAnimJoint53.setCenter(new float[]{3.454,18.67,-0.02158});
HAnimJoint53.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint53.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment54 =  HAnimSegment();
HAnimSegment54.X3DNode::setName(CString("l_calf"));
HAnimSegment54.setDEF(CString("hanim_l_calf"));
Transform& Transform55 =  Transform();
Transform55.setTranslation(new float[]{3.454,18.67,-0.02158});
Shape& Shape56 =  Shape();
...
ImageTexture59.setUSE(CString("JuTextureAtlas"));
...
HAnimJoint63.X3DNode::setName(CString("l_talocrural"));
HAnimJoint63.setDEF(CString("hanim_l_talocrural"));
HAnimJoint63.setCenter(new float[]{3.467,3.522,0.118});
HAnimJoint63.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint63.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment64 =  HAnimSegment();
HAnimSegment64.X3DNode::setName(CString("l_talus"));
HAnimSegment64.setDEF(CString("hanim_l_talus"));
Transform& Transform65 =  Transform();
Transform65.setTranslation(new float[]{3.467,3.522,0.118});
Shape& Shape66 =  Shape();
...
ImageTexture69.setUSE(CString("JuTextureAtlas"));
...
IndexedFaceSet70.setCreaseAngle(1.57);
...
Coordinate71.setPoint(new float[]{0.8966,-0.0174,-1.568,1.521,-0.0174,0.4019,0,-0.0174,-1.568,1.288,0.6634,0.3302,0.7503,0.6634,-1.364,0,0.6634,-1.364,0,0.6634,1.372,-1.521,-0.0174,0.4019,-1.288,0.6634,0.3302,-0.7503,0.6634,-1.364,-0.8967,-0.0174,-1.568,0,-0.0174,1.633,1.556,-0.2684,1.333,-1.556,-0.2684,1.333,1.293,-1.746,-2.684,1.293,-3.579,-1.568,0,-3.579,-1.568,1.018,-0.5447,-1.908,0,-0.5447,-1.908,-1.293,-1.746,-2.684,0,-1.746,-2.684,-1.018,-0.5447,-1.908,-1.293,-3.579,-1.568,2.687,-1.746,0.4019,1.918,-3.579,0.4019,1.877,-0.5447,0.4019,-2.687,-1.746,0.4019,-1.877,-0.5447,0.4019,-1.918,-3.579,0.4019,0,-3.579,0.4019,1.708,-3.439,1.272,2.332,-1.78,1.272,-2.332,-1.78,1.272,-1.708,-3.439,1.272,0,-3.439,1.272,1.469,-0.8455,1.311,-1.469,-0.8455,1.311,0,-0.5969,1.593}, 114);
IndexedFaceSet70.setCoord(&Coordinate71);

TextureCoordinate& TextureCoordinate72 =  TextureCoordinate();
TextureCoordinate72.setPoint(new float[]{0.4269,0.4898,0.4623,0.4901,0.4269,0.4898,0.4623,0.4901,0.4269,0.4898,0.4269,0.4898,0.4777,0.4914,0.4623,0.4901,0.4777,0.4914,0.4623,0.4901,0.4269,0.4898,0.4269,0.4898,0.4269,0.4898,0.4269,0.4898,0.4777,0.4914,0.4777,0.4914,0.4309,0.4635,0.4687,0.4544,0.4611,0.4911,0.4284,0.4641,0.4284,0.4641,0.4309,0.4635,0.4687,0.4544,0.4611,0.4911,0.4611,0.4911,0.4777,0.4914,0.4611,0.4911,0.4321,0.4164,0.4315,0.3728,0.4321,0.4164,0.4315,0.3728,0.4315,0.3728,0.4309,0.4635,0.4284,0.4641,0.4321,0.4164,0.4321,0.4164,0.4284,0.4641,0.4309,0.4635,0.4315,0.3728,0.4315,0.3728,0.4315,0.3728,0.4804,0.417,0.4726,0.3714,0.4687,0.4544,0.4804,0.417,0.4687,0.4544,0.4726,0.3714,0.4726,0.3714,0.4726,0.3714,0.4726,0.3714,0.4804,0.417,0.4687,0.4544,0.4687,0.4544,0.4804,0.417,0.4726,0.3714,0.4726,0.3714,0.4687,0.4544}, 114);
...
HAnimJoint73.X3DNode::setName(CString("l_metatarsophalangeal_2"));
HAnimJoint73.setDEF(CString("hanim_l_metatarsophalangeal_2"));
HAnimJoint73.setCenter(new float[]{3.467,3.251,1.465});
HAnimJoint73.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint73.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment74 =  HAnimSegment();
HAnimSegment74.X3DNode::setName(CString("l_tarsal_proximal_phalanx_2"));
HAnimSegment74.setDEF(CString("hanim_l_tarsal_proximal_phalanx_2"));
Transform& Transform75 =  Transform();
Transform75.setTranslation(new float[]{3.467,3.251,1.465});
Shape& Shape76 =  Shape();
...
ImageTexture79.setUSE(CString("JuTextureAtlas"));
...
HAnimJoint83.X3DNode::setName(CString("r_hip"));
HAnimJoint83.setDEF(CString("hanim_r_hip"));
HAnimJoint83.setCenter(new float[]{-3.22,33.619999,-0.2832});
HAnimJoint83.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint83.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment84 =  HAnimSegment();
HAnimSegment84.X3DNode::setName(CString("r_thigh"));
HAnimSegment84.setDEF(CString("hanim_r_thigh"));
Transform& Transform85 =  Transform();
Transform85.setTranslation(new float[]{-3.22,33.619999,-0.2832});
Shape& Shape86 =  Shape();
...
ImageTexture89.setUSE(CString("JuTextureAtlas"));
...
HAnimJoint93.X3DNode::setName(CString("r_knee"));
HAnimJoint93.setDEF(CString("hanim_r_knee"));
HAnimJoint93.setCenter(new float[]{-3.454,18.67,-0.02158});
HAnimJoint93.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint93.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment94 =  HAnimSegment();
HAnimSegment94.X3DNode::setName(CString("r_calf"));
HAnimSegment94.setDEF(CString("hanim_r_calf"));
Transform& Transform95 =  Transform();
Transform95.setTranslation(new float[]{-3.454,18.67,-0.02158});
Shape& Shape96 =  Shape();
...
ImageTexture99.setUSE(CString("JuTextureAtlas"));
...
IndexedFaceSet100.setCreaseAngle(1.57);
IndexedFaceSet100.setTexCoordIndex(new int32_t[]{0,1,2,-1,2,3,4,-1,0,2,4,-1,0,4,5,-1,6,0,5,-1,9,10,7,-1,7,8,9,-1,12,9,8,-1,8,11,12,-1,14,12,11,-1,11,13,14,-1,16,14,13,-1,13,15,16,-1,18,16,15,-1,15,17,18,-1,20,18,17,-1,17,19,20,-1,10,20,19,-1,19,7,10,-1,21,22,10,-1,10,9,21,-1,23,21,9,-1,9,12,23,-1,24,23,12,-1,12,14,24,-1,25,24,14,-1,14,16,25,-1,26,25,16,-1,16,18,26,-1,27,26,18,-1,18,20,27,-1,22,27,20,-1,20,10,22,-1,1,0,22,-1,22,21,1,-1,2,1,21,-1,21,23,2,-1,3,2,23,-1,23,24,3,-1,4,3,24,-1,24,25,4,-1,5,4,25,-1,25,26,5,-1,6,5,26,-1,26,27,6,-1,0,6,27,-1,27,22,0,-1,8,7,28,-1,28,29,8,-1,11,8,29,-1,29,30,11,-1,13,11,30,-1,30,31,13,-1,15,13,31,-1,31,32,15,-1,17,15,32,-1,32,33,17,-1,19,17,33,-1,33,34,19,-1,7,19,34,-1,34,28,7,-1,29,28,35,-1,35,36,29,-1,30,29,36,-1,36,37,30,-1,31,30,37,-1,37,38,31,-1,32,31,38,-1,38,39,32,-1,33,32,39,-1,39,40,33,-1,34,33,40,-1,40,41,34,-1,28,34,41,-1,41,35,28,-1}, 300);
Coordinate& Coordinate101 =  Coordinate();
Coordinate101.setPoint(new float[]{-0.7406,0.9639,0.0216,-0.4117,0.9639,0.8655,0.3272,0.9639,1.036,0.9197,0.9639,0.5579,0.9197,0.9639,-0.3619,0.3272,0.9639,-0.8401,-0.4117,0.9639,-0.6694,-2.238,-4.201,0.0216,-1.426,-3.284,1.868,-1.219,-1.439,2.239,-2.036,-1.701,0.0216,0.6748,-3.284,2.375,0.6153,-1.439,2.686,2.01,-4.201,1.161,2.086,-1.701,0.9061,2.01,-4.913,-1.265,2.086,-1.701,-0.8628,0.6748,-4.913,-2.686,0.6153,-1.701,-2.191,-1.426,-4.913,-2.179,-1.219,-1.701,-1.744,-1.112,0.0646,1.755,-1.864,0.0646,0.0216,0.5772,0.0646,2.145,1.932,0.0646,1.051,1.932,0.0646,-0.8553,0.5772,0.0646,-1.907,-1.112,0.0646,-1.517,-2.345,-14.69,-0.0151,-1.416,-14.67,2.102,0.6712,-14.67,2.624,2.345,-14.69,1.16,2.345,-14.71,-1.342,0.6712,-14.71,-2.38,-1.416,-14.71,-1.857,-0.73,-16.18,0.0221,-0.4092,-16.17,0.7532,0.3118,-16.17,0.9337,0.89,-16.18,0.4278,0.89,-16.19,-0.4362,0.3118,-16.19,-0.7945,-0.4092,-16.19,-0.614}, 126);
...
HAnimJoint103.X3DNode::setName(CString("r_talocrural"));
HAnimJoint103.setDEF(CString("hanim_r_talocrural"));
HAnimJoint103.setCenter(new float[]{-3.679,3.522,0.118});
...
HAnimSegment104.X3DNode::setName(CString("r_talus"));
HAnimSegment104.setDEF(CString("hanim_r_talus"));
Transform& Transform105 =  Transform();
Transform105.setTranslation(new float[]{-3.679,3.522,0.118});
...
ImageTexture109.setUSE(CString("JuTextureAtlas"));
...
IndexedFaceSet110.setCreaseAngle(1.57);
...
Coordinate111.setPoint(new float[]{-0.8966,-0.0174,-1.568,-1.521,-0.0174,0.4019,0,-0.0174,-1.568,-1.288,0.6634,0.3302,-0.7503,0.6634,-1.364,0,0.6634,-1.364,0,0.6634,1.372,1.521,-0.0174,0.4019,1.288,0.6634,0.3302,0.7503,0.6634,-1.364,0.8967,-0.0174,-1.568,0,-0.0174,1.633,-1.556,-0.2684,1.333,1.556,-0.2684,1.333,-1.293,-1.746,-2.684,-1.293,-3.579,-1.568,0,-3.579,-1.568,-1.018,-0.5447,-1.908,0,-0.5447,-1.908,1.293,-1.746,-2.684,0,-1.746,-2.684,1.018,-0.5447,-1.908,1.293,-3.579,-1.568,-2.687,-1.746,0.4019,-1.918,-3.579,0.4019,-1.877,-0.5447,0.4019,2.687,-1.746,0.4019,1.877,-0.5447,0.4019,1.918,-3.579,0.4019,0,-3.579,0.4019,-1.708,-3.439,1.272,-2.332,-1.78,1.272,2.332,-1.78,1.272,1.708,-3.439,1.272,0,-3.439,1.272,-1.469,-0.8455,1.311,1.469,-0.8455,1.311,0,-0.5969,1.593}, 114);
IndexedFaceSet110.setCoord(&Coordinate111);

TextureCoordinate& TextureCoordinate112 =  TextureCoordinate();
TextureCoordinate112.setPoint(new float[]{0.4269,0.4898,0.4623,0.4901,0.4269,0.4898,0.4623,0.4901,0.4269,0.4898,0.4269,0.4898,0.4777,0.4914,0.4623,0.4901,0.4777,0.4914,0.4623,0.4901,0.4269,0.4898,0.4269,0.4898,0.4269,0.4898,0.4269,0.4898,0.4777,0.4914,0.4777,0.4914,0.4309,0.4635,0.4687,0.4544,0.4611,0.4911,0.4284,0.4641,0.4284,0.4641,0.4309,0.4635,0.4687,0.4544,0.4611,0.4911,0.4611,0.4911,0.4777,0.4914,0.4611,0.4911,0.4321,0.4164,0.4315,0.3728,0.4321,0.4164,0.4315,0.3728,0.4315,0.3728,0.4309,0.4635,0.4284,0.4641,0.4321,0.4164,0.4321,0.4164,0.4284,0.4641,0.4309,0.4635,0.4315,0.3728,0.4315,0.3728,0.4315,0.3728,0.4804,0.417,0.4726,0.3714,0.4687,0.4544,0.4804,0.417,0.4687,0.4544,0.4726,0.3714,0.4726,0.3714,0.4726,0.3714,0.4726,0.3714,0.4804,0.417,0.4687,0.4544,0.4687,0.4544,0.4804,0.417,0.4726,0.3714,0.4726,0.3714,0.4687,0.4544}, 114);
...
HAnimJoint113.X3DNode::setName(CString("r_metatarsophalangeal_2"));
HAnimJoint113.setDEF(CString("hanim_r_metatarsophalangeal_2"));
HAnimJoint113.setCenter(new float[]{-3.679,3.251,1.465});
...
HAnimSegment114.X3DNode::setName(CString("r_tarsal_proximal_phalanx_2"));
HAnimSegment114.setDEF(CString("hanim_r_tarsal_proximal_phalanx_2"));
Transform& Transform115 =  Transform();
Transform115.setTranslation(new float[]{-3.679,3.251,1.465});
...
ImageTexture119.setUSE(CString("JuTextureAtlas"));
...
HAnimJoint123.X3DNode::setName(CString("sacroiliac"));
HAnimJoint123.setDEF(CString("hanim_sacroiliac"));
HAnimJoint123.setCenter(new float[]{0.000034,31.26,-0.008798});
...
HAnimSegment124.X3DNode::setName(CString("pelvis"));
HAnimSegment124.setDEF(CString("hanim_pelvis"));
Transform& Transform125 =  Transform();
Transform125.setTranslation(new float[]{0.000034,31.26,-0.008798});
...
ImageTexture129.setUSE(CString("JuTextureAtlas"));
...
IndexedFaceSet130.setCreaseAngle(1.57);
...
HAnimJoint133.X3DNode::setName(CString("l_shoulder"));
HAnimJoint133.setDEF(CString("hanim_l_shoulder"));
HAnimJoint133.setCenter(new float[]{4.778,51.029999,-2.069});
HAnimJoint133.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint133.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment134 =  HAnimSegment();
HAnimSegment134.X3DNode::setName(CString("l_upperarm"));
HAnimSegment134.setDEF(CString("hanim_l_upperarm"));
Transform& Transform135 =  Transform();
Transform135.setTranslation(new float[]{4.778,51.029999,-2.069});
...
ImageTexture139.setUSE(CString("JuTextureAtlas"));
...
IndexedFaceSet140.setCreaseAngle(1.57);
...
HAnimSegment134.addChild(&Transform135);

HAnimJoint133.addChildren(&HAnimSegment134);

HAnimJoint& HAnimJoint143 =  HAnimJoint();
HAnimJoint143.X3DNode::setName(CString("l_elbow"));
HAnimJoint143.setDEF(CString("hanim_l_elbow"));
HAnimJoint143.setCenter(new float[]{5.297,40.119999,-2.055});
...
HAnimSegment144.X3DNode::setName(CString("l_forearm"));
HAnimSegment144.setDEF(CString("hanim_l_forearm"));
Transform& Transform145 =  Transform();
Transform145.setTranslation(new float[]{5.297,40.119999,-2.055});
...
HAnimJoint153.X3DNode::setName(CString("l_radiocarpal"));
HAnimJoint153.setDEF(CString("hanim_l_radiocarpal"));
HAnimJoint153.setCenter(new float[]{5.07,31.99,-1.559});
...
HAnimSegment154.X3DNode::setName(CString("l_carpal"));
HAnimSegment154.setDEF(CString("hanim_l_carpal"));
Transform& Transform155 =  Transform();
Transform155.setTranslation(new float[]{5.07,31.99,-1.559});
...
ImageTexture159.setUSE(CString("JuTextureAtlas"));
...
HAnimSegment154.addChild(&Transform155);
...
HAnimJoint163.X3DNode::setName(CString("r_shoulder"));
HAnimJoint163.setDEF(CString("hanim_r_shoulder"));
HAnimJoint163.setCenter(new float[]{-4.778,51.029999,-2.069});
...
HAnimSegment164.X3DNode::setName(CString("r_upperarm"));
HAnimSegment164.setDEF(CString("hanim_r_upperarm"));
Transform& Transform165 =  Transform();
Transform165.setTranslation(new float[]{-4.778,51.029999,-2.069});
...
ImageTexture169.setUSE(CString("JuTextureAtlas"));
...
HAnimJoint173.setCenter(new float[]{-5.297,40.119999,-2.055});
HAnimJoint173.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint173.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment174 =  HAnimSegment();
HAnimSegment174.X3DNode::setName(CString("r_forearm"));
HAnimSegment174.setDEF(CString("hanim_r_forearm"));
Transform& Transform175 =  Transform();
Transform175.setTranslation(new float[]{-5.297,40.119999,-2.055});
...
ImageTexture179.setUSE(CString("JuTextureAtlas"));
...
HAnimSegment174.addChild(&Transform175);

HAnimJoint173.addChildren(&HAnimSegment174);

HAnimJoint& HAnimJoint183 =  HAnimJoint();
HAnimJoint183.X3DNode::setName(CString("r_radiocarpal"));
HAnimJoint183.setDEF(CString("hanim_r_radiocarpal"));
HAnimJoint183.setCenter(new float[]{-5.07,31.99,-1.559});
HAnimJoint183.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint183.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment184 =  HAnimSegment();
HAnimSegment184.X3DNode::setName(CString("r_carpal"));
HAnimSegment184.setDEF(CString("hanim_r_carpal"));
Transform& Transform185 =  Transform();
Transform185.setTranslation(new float[]{-5.07,31.99,-1.559});
...
ImageTexture189.setUSE(CString("JuTextureAtlas"));
...
HAnimJoint123.addChildren(&HAnimJoint163);

HAnimJoint& HAnimJoint193 =  HAnimJoint();
HAnimJoint193.X3DNode::setName(CString("vl5"));
HAnimJoint193.setDEF(CString("hanim_vl5"));
HAnimJoint193.setCenter(new float[]{0.000025,39.84,0.1163});
HAnimJoint193.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint193.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment194 =  HAnimSegment();
HAnimSegment194.X3DNode::setName(CString("l5"));
HAnimSegment194.setDEF(CString("hanim_l5"));
Transform& Transform195 =  Transform();
Transform195.setTranslation(new float[]{0.000025,39.84,0.1163});
...
ImageTexture199.setUSE(CString("JuTextureAtlas"));
...
IndexedFaceSet200.setCreaseAngle(1.57);
...
HAnimJoint203.X3DNode::setName(CString("skullbase"));
HAnimJoint203.setDEF(CString("hanim_skullbase"));
HAnimJoint203.setCenter(new float[]{0.000025,56.07,-1.554});
HAnimJoint203.setUlimit(new float[]{0,0,0}, 3);
HAnimJoint203.setLlimit(new float[]{0,0,0}, 3);
HAnimSegment& HAnimSegment204 =  HAnimSegment();
HAnimSegment204.X3DNode::setName(CString("skull"));
HAnimSegment204.setDEF(CString("hanim_skull"));
Transform& Transform205 =  Transform();
Transform205.setTranslation(new float[]{0.000025,56.07,-1.554});
...
ImageTexture209.setUSE(CString("JuTextureAtlas"));
...
IndexedFaceSet210.setCreaseAngle(1.57);
...
EXPORT231.setAS(CString("KoreanCharacter05Ju"));
EXPORT231.setLocalDEF(CString("hanim_Ju"));

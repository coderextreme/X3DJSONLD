...
Text& Text136 =  Text();
Text136.setString(new CString[]{CString("LOA1_WalkAnimation.x3d"), CString("defines a prototype"), CString("for animating a humanoid."), CString("Click this text to see"), CString("InterchangableActorsViaDynamicRouting example.")}, 5);

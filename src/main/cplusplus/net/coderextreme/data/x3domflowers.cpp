...
meta14.setContent(CString("https://coderextreme.net/X3DJSONLD/src/main/data/x3domflowers.x3d"));
...
ExternProtoDeclare19.setUrl(new CString[1]{CString("../data/flowerproto.json#FlowerProto")}, 1);
field& field20 =  field();

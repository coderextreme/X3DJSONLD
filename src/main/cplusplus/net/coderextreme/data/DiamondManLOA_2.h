...
Viewpoint21.setPosition(new float[]{0.0,1.0,3.0});
Viewpoint21.setCenterOfRotation(new float[]{0.0,1.0,0.0});
Scene18.addChild(&Viewpoint21);

Transform& Transform22 =  Transform();
Transform22.setTranslation(new float[]{1.0,1.5,0.0});
...
Transform34.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape35 =  Shape();
...
Transform45.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape46 =  Shape();
...
Transform56.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape57 =  Shape();
...
Transform62.setTranslation(new float[]{0.0,-0.9,0.0});
Shape& Shape63 =  Shape();
...
Transform67.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape68 =  Shape();
...
Transform78.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape79 =  Shape();
...
Transform89.setTranslation(new float[]{0.2,0.0,0.0});
Shape& Shape90 =  Shape();
...
HAnimJoint98.setCenter(new float[]{0.0,0.824,0.0277});
...
Transform100.setTranslation(new float[]{0.0,0.824,0.0277});
...
Material103.setDiffuseColor(new float[]{1.0,1.0,1.0});
...
Coordinate105.setPoint(new float[]{0.0,0.01,0.0,-0.01,0.0,0.0,0.0,0.0,0.01,0.01,0.0,0.0,0.0,0.0,-0.01,0.0,-0.01,0.0}, 18);
...
HAnimJoint113.setCenter(new float[]{0.0,0.9149,0.0016});
...
Transform115.setTranslation(new float[]{0.0,0.9149,0.0016});
...
HAnimJoint269.setCenter(new float[]{0.1086,0.0,0.0762});
...
Transform271.setTranslation(new float[]{0.1086,0.0,0.0762});
...
HAnimJoint361.setCenter(new float[]{-0.0801,0.0,0.0368});
...
Transform363.setTranslation(new float[]{-0.0801,0.0,0.0368});
...
Transform537.setRotation(new float[]{1.0,0.0,0.0,0.119});
...
Transform552.setRotation(new float[]{-1.0,0.0,0.0,0.1});
...
Transform692.setRotation(new float[]{1.0,0.0,0.0,0.0836});
...
Transform707.setRotation(new float[]{-1.0,0.0,0.0,0.1254});
...
Viewpoint1061.setPosition(new float[]{2.0,0.854,0.0});
Viewpoint1061.setOrientation(new float[]{0.0,1.0,0.0,1.57079});
...
Viewpoint1062.setPosition(new float[]{0.0,3.4495,0.0});
Viewpoint1062.setOrientation(new float[]{1.0,0.0,0.0,-1.57079});
...
Viewpoint1063.setPosition(new float[]{0.0,0.824,0.277});

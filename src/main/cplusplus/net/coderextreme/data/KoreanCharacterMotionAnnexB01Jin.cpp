...
meta2->setName("title");
meta2->setContent("KoreanCharacterMotionAnnexB01Jin.x3d");
head1->addMeta(*meta2);
...
meta7->setContent("8 January 2023");
head1->addMeta(*meta7);
...
meta12->setContent("HAnim 2.0 Part 2: Humanoid animation (HAnim) motion data animation, Annex D (informative) Examples of HAnim motion data animation using a Motion object");
head1->addMeta(*meta12);

Cmeta* meta13 = new Cmeta();
meta13->setName("specificationUrl");
meta13->setContent("https://www.web3d.org/documents/specifications/19774/V2.0/MotionDataAnimation/ExampleKeyframeAnimation.html");
head1->addMeta(*meta13);

Cmeta* meta14 = new Cmeta();
meta14->setName("identifier");
meta14->setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/KoreanCharacterAnnexB01Jin.x3d");
...
Ccomponent* component19 = new Ccomponent();
component19->setName("HAnim");
component19->setLevel(1);
head1->addComponent(*component19);
...
Viewpoint22->setDescription("AnnexB01Jin");
...
HAnimHumanoid23->setDEF("hanim_AnnexB01Jin");
HAnimHumanoid23->setVersion("2.0");
HAnimHumanoid23->setName("AnnexB01Jin");
HAnimHumanoid23->setInfo(new CString[1]{"humanoidVersion=2.0"}, 1);
...
HAnimJoint24->setDEF("hanim_HumanoidRoot");
HAnimJoint24->setName("HumanoidRoot");
HAnimJoint24->setCenter(new float[3]{0,30.53,-0.7076});
...
Transform26->setTranslation(new float[3]{0,30.53,-0.7076});
...
ImageTexture30->setDEF("Annex01JinTextureAtlas");
ImageTexture30->setUrl(new CString[2]{"Jin.png","http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/Jin.png"}, 2);
...
IndexedFaceSet31->setCreaseAngle(3.14159);
...
HAnimJoint34->setCenter(new float[3]{0,35.8,-0.7076});
...
Transform36->setTranslation(new float[3]{0,35.8,-0.7076});
...
ImageTexture40->setUSE("Annex01JinTextureAtlas");
...
IndexedFaceSet41->setCoordIndex(new int[480]{0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,5,-1,0,5,6,-1,0,6,7,-1,0,7,8,-1,0,8,9,-1,0,9,10,-1,0,10,11,-1,0,11,12,-1,0,12,1,-1,14,2,1,-1,1,13,14,-1,15,3,2,-1,2,14,15,-1,16,4,3,-1,3,15,16,-1,17,5,4,-1,4,16,17,-1,18,6,5,-1,5,17,18,-1,19,7,6,-1,6,18,19,-1,20,8,7,-1,7,19,20,-1,21,9,8,-1,8,20,21,-1,22,10,9,-1,9,21,22,-1,23,11,10,-1,10,22,23,-1,24,12,11,-1,11,23,24,-1,13,1,12,-1,12,24,13,-1,26,14,13,-1,13,25,26,-1,27,15,14,-1,14,26,27,-1,28,16,15,-1,15,27,28,-1,29,17,16,-1,16,28,29,-1,30,18,17,-1,17,29,30,-1,31,19,18,-1,18,30,31,-1,32,20,19,-1,19,31,32,-1,33,21,20,-1,20,32,33,-1,34,22,21,-1,21,33,34,-1,35,23,22,-1,22,34,35,-1,36,24,23,-1,23,35,36,-1,25,13,24,-1,24,36,25,-1,38,26,25,-1,25,37,38,-1,39,27,26,-1,26,38,39,-1,40,28,27,-1,27,39,40,-1,41,29,28,-1,28,40,41,-1,42,30,29,-1,29,41,42,-1,43,31,30,-1,30,42,43,-1,44,32,31,-1,31,43,44,-1,45,33,32,-1,32,44,45,-1,46,34,33,-1,33,45,46,-1,47,35,34,-1,34,46,47,-1,48,36,35,-1,35,47,48,-1,37,25,36,-1,36,48,37,-1,50,38,37,-1,37,49,50,-1,51,39,38,-1,38,50,51,-1,52,40,39,-1,39,51,52,-1,53,41,40,-1,40,52,53,-1,54,42,41,-1,41,53,54,-1,55,43,42,-1,42,54,55,-1,56,44,43,-1,43,55,56,-1,57,45,44,-1,44,56,57,-1,58,46,45,-1,45,57,58,-1,59,47,46,-1,46,58,59,-1,60,48,47,-1,47,59,60,-1,49,37,48,-1,48,60,49,-1,61,50,49,-1,61,51,50,-1,61,52,51,-1,61,53,52,-1,61,54,53,-1,61,55,54,-1,61,56,55,-1,61,57,56,-1,61,58,57,-1,61,59,58,-1,61,60,59,-1,61,49,60,-1});
...
HAnimJoint44->setCenter(new float[3]{4.207,32.02,-0.8155});
...
Transform46->setTranslation(new float[3]{4.207,32.02,-0.8155});
...
ImageTexture50->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint54->setDEF("hanim_l_knee");
HAnimJoint54->setName("l_knee");
HAnimJoint54->setCenter(new float[3]{4.116,17.26,-0.8639});
CHAnimSegment* HAnimSegment55 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment55->setDEF("hanim_l_calf");
HAnimSegment55->setName("l_calf");
CTransform* Transform56 = (CTransform *)(m_pScene.createNode("Transform"));
Transform56->setTranslation(new float[3]{4.116,17.26,-0.8639});
...
ImageTexture60->setUSE("Annex01JinTextureAtlas");
...
IndexedFaceSet61->setTexCoordIndex(new int[300]{4,3,2,-1,5,4,2,-1,2,1,0,-1,5,2,0,-1,6,5,0,-1,9,8,7,-1,7,10,9,-1,12,11,8,-1,8,9,12,-1,14,13,11,-1,11,12,14,-1,16,15,13,-1,13,14,16,-1,18,17,15,-1,15,16,18,-1,20,19,17,-1,17,18,20,-1,10,7,19,-1,19,20,10,-1,21,9,10,-1,10,22,21,-1,23,12,9,-1,9,21,23,-1,24,14,12,-1,12,23,24,-1,25,16,14,-1,14,24,25,-1,26,18,16,-1,16,25,26,-1,27,20,18,-1,18,26,27,-1,22,10,20,-1,20,27,22,-1,1,21,22,-1,22,0,1,-1,2,23,21,-1,21,1,2,-1,3,24,23,-1,23,2,3,-1,4,25,24,-1,24,3,4,-1,5,26,25,-1,25,4,5,-1,6,27,26,-1,26,5,6,-1,0,22,27,-1,27,6,0,-1,8,29,28,-1,28,7,8,-1,11,30,29,-1,29,8,11,-1,13,31,30,-1,30,11,13,-1,15,32,31,-1,31,13,15,-1,17,33,32,-1,32,15,17,-1,19,34,33,-1,33,17,19,-1,7,28,34,-1,34,19,7,-1,29,36,35,-1,35,28,29,-1,30,37,36,-1,36,29,30,-1,31,38,37,-1,37,30,31,-1,32,39,38,-1,38,31,32,-1,33,40,39,-1,39,32,33,-1,34,41,40,-1,40,33,34,-1,28,35,41,-1,41,34,28,-1});
IndexedFaceSet61->setCoordIndex(new int[300]{4,3,2,-1,5,4,2,-1,2,1,0,-1,5,2,0,-1,6,5,0,-1,9,8,7,-1,7,10,9,-1,12,11,8,-1,8,9,12,-1,14,13,11,-1,11,12,14,-1,16,15,13,-1,13,14,16,-1,18,17,15,-1,15,16,18,-1,20,19,17,-1,17,18,20,-1,10,7,19,-1,19,20,10,-1,21,9,10,-1,10,22,21,-1,23,12,9,-1,9,21,23,-1,24,14,12,-1,12,23,24,-1,25,16,14,-1,14,24,25,-1,26,18,16,-1,16,25,26,-1,27,20,18,-1,18,26,27,-1,22,10,20,-1,20,27,22,-1,1,21,22,-1,22,0,1,-1,2,23,21,-1,21,1,2,-1,3,24,23,-1,23,2,3,-1,4,25,24,-1,24,3,4,-1,5,26,25,-1,25,4,5,-1,6,27,26,-1,26,5,6,-1,0,22,27,-1,27,6,0,-1,8,29,28,-1,28,7,8,-1,11,30,29,-1,29,8,11,-1,13,31,30,-1,30,11,13,-1,15,32,31,-1,31,13,15,-1,17,33,32,-1,32,15,17,-1,19,34,33,-1,33,17,19,-1,7,28,34,-1,34,19,7,-1,29,36,35,-1,35,28,29,-1,30,37,36,-1,36,29,30,-1,31,38,37,-1,37,30,31,-1,32,39,38,-1,38,31,32,-1,33,40,39,-1,39,32,33,-1,34,41,40,-1,40,33,34,-1,28,35,41,-1,41,34,28,-1});
CTextureCoordinate* TextureCoordinate62 = (CTextureCoordinate *)(m_pScene.createNode("TextureCoordinate"));
TextureCoordinate62->setPoint(new float[84]{0.9309,0.5848,0.919,0.5848,0.8921,0.5848,0.8706,0.5848,0.8706,0.5848,0.8921,0.5848,0.919,0.5848,0.9845,0.5321,0.955,0.5475,0.9491,0.5599,0.9788,0.5571,0.8787,0.5475,0.8825,0.5599,0.8302,0.5321,0.8291,0.5571,0.8302,0.52,0.8291,0.5571,0.8787,0.52,0.8825,0.5571,0.955,0.52,0.9491,0.5571,0.9444,0.5755,0.9717,0.5755,0.8831,0.5755,0.8339,0.5755,0.8339,0.5755,0.8831,0.5755,0.9444,0.5755,0.9679,0.2444,0.9449,0.2445,0.8931,0.2445,0.8516,0.2444,0.8516,0.2442,0.8931,0.2442,0.9449,0.2442,0.9372,0.2243,0.9255,0.2244,0.8993,0.2244,0.8783,0.2243,0.8783,0.2243,0.8993,0.2243,0.9255,0.2243});
...
HAnimJoint64->setDEF("hanim_l_talocrural");
HAnimJoint64->setName("l_talocrural");
HAnimJoint64->setCenter(new float[3]{3.854,3.939,-0.7038});
...
Transform66->setTranslation(new float[3]{3.854,3.939,-0.7038});
...
ImageTexture70->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint74->setDEF("hanim_l_metatarsophalangeal");
HAnimJoint74->setName("l_metatarsophalangeal");
HAnimJoint74->setCenter(new float[3]{3.854,3.64,0.7402});
CHAnimSegment* HAnimSegment75 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment75->setDEF("hanim_l_middistal");
HAnimSegment75->setName("l_middistal");
CTransform* Transform76 = (CTransform *)(m_pScene.createNode("Transform"));
Transform76->setTranslation(new float[3]{3.854,3.64,0.7402});
...
ImageTexture80->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint84->setDEF("hanim_r_hip");
HAnimJoint84->setName("r_hip");
HAnimJoint84->setCenter(new float[3]{-4.207,32.02,-0.8155});
CHAnimSegment* HAnimSegment85 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment85->setDEF("hanim_r_thigh");
HAnimSegment85->setName("r_thigh");
CTransform* Transform86 = (CTransform *)(m_pScene.createNode("Transform"));
Transform86->setTranslation(new float[3]{-4.207,32.02,-0.8155});
...
ImageTexture90->setUSE("Annex01JinTextureAtlas");
...
ImageTexture100->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint104->setDEF("hanim_r_talocrural");
HAnimJoint104->setName("r_talocrural");
HAnimJoint104->setCenter(new float[3]{-3.854,3.939,-0.7038});
CHAnimSegment* HAnimSegment105 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment105->setDEF("hanim_r_hindfoot");
HAnimSegment105->setName("r_hindfoot");
CTransform* Transform106 = (CTransform *)(m_pScene.createNode("Transform"));
Transform106->setTranslation(new float[3]{-3.854,3.939,-0.7038});
...
ImageTexture110->setUSE("Annex01JinTextureAtlas");
...
IndexedFaceSet111->setTexCoordIndex(new int[408]{1,18,14,-1,3,6,5,-1,5,4,3,-1,1,3,4,-1,4,0,1,-1,0,4,5,-1,5,2,0,-1,14,6,3,-1,3,1,14,-1,19,16,0,-1,0,2,19,-1,0,16,17,-1,17,1,0,-1,17,18,1,-1,7,15,23,-1,9,10,11,-1,11,8,9,-1,7,12,10,-1,10,9,7,-1,12,13,11,-1,11,10,12,-1,15,7,9,-1,9,8,15,-1,20,13,12,-1,12,21,20,-1,12,7,22,-1,22,21,12,-1,22,7,23,-1,24,31,30,-1,30,29,28,-1,24,30,28,-1,28,27,26,-1,24,28,26,-1,25,24,26,-1,19,24,25,-1,25,16,19,-1,16,25,26,-1,26,17,16,-1,17,26,27,-1,27,18,17,-1,18,27,28,-1,28,14,18,-1,15,28,29,-1,29,23,15,-1,23,29,30,-1,30,22,23,-1,22,30,31,-1,31,21,22,-1,21,31,24,-1,24,20,21,-1,34,32,37,-1,37,38,34,-1,46,48,37,-1,37,32,46,-1,35,33,32,-1,32,34,35,-1,47,46,32,-1,32,33,47,-1,33,36,53,-1,53,47,33,-1,40,41,42,-1,42,39,40,-1,49,39,42,-1,42,50,49,-1,44,40,39,-1,39,43,44,-1,51,43,39,-1,39,49,51,-1,43,51,52,-1,52,45,43,-1,55,54,58,-1,55,58,57,-1,55,57,56,-1,62,61,60,-1,60,59,65,-1,60,65,64,-1,62,60,64,-1,62,64,63,-1,37,54,55,-1,55,38,37,-1,41,55,56,-1,56,42,41,-1,42,56,57,-1,57,50,42,-1,50,57,58,-1,58,48,50,-1,48,58,54,-1,54,37,48,-1,47,59,60,-1,60,46,47,-1,46,60,61,-1,61,48,46,-1,48,61,62,-1,62,50,48,-1,50,62,63,-1,63,49,50,-1,49,63,64,-1,64,51,49,-1,51,64,65,-1,65,52,51,-1,53,65,59,-1,59,47,53,-1});
IndexedFaceSet111->setCoordIndex(new int[408]{1,14,11,-1,3,6,5,-1,5,4,3,-1,1,3,4,-1,4,0,1,-1,0,4,5,-1,5,2,0,-1,11,6,3,-1,3,1,11,-1,15,12,0,-1,0,2,15,-1,0,12,13,-1,13,1,0,-1,13,14,1,-1,7,11,18,-1,8,9,5,-1,5,6,8,-1,7,10,9,-1,9,8,7,-1,10,2,5,-1,5,9,10,-1,11,7,8,-1,8,6,11,-1,15,2,10,-1,10,16,15,-1,10,7,17,-1,17,16,10,-1,17,7,18,-1,19,26,25,-1,25,24,23,-1,19,25,23,-1,23,22,21,-1,19,23,21,-1,20,19,21,-1,15,19,20,-1,20,12,15,-1,12,20,21,-1,21,13,12,-1,13,21,22,-1,22,14,13,-1,14,22,23,-1,23,11,14,-1,11,23,24,-1,24,18,11,-1,18,24,25,-1,25,17,18,-1,17,25,26,-1,26,16,17,-1,16,26,19,-1,19,15,16,-1,33,27,30,-1,30,31,33,-1,36,38,30,-1,30,27,36,-1,29,28,27,-1,27,33,29,-1,37,36,27,-1,27,28,37,-1,28,29,42,-1,42,37,28,-1,33,31,34,-1,34,32,33,-1,39,32,34,-1,34,40,39,-1,29,33,32,-1,32,35,29,-1,41,35,32,-1,32,39,41,-1,35,41,42,-1,42,29,35,-1,44,43,47,-1,44,47,46,-1,44,46,45,-1,51,50,49,-1,49,48,54,-1,49,54,53,-1,51,49,53,-1,51,53,52,-1,30,43,44,-1,44,31,30,-1,31,44,45,-1,45,34,31,-1,34,45,46,-1,46,40,34,-1,40,46,47,-1,47,38,40,-1,38,47,43,-1,43,30,38,-1,37,48,49,-1,49,36,37,-1,36,49,50,-1,50,38,36,-1,38,50,51,-1,51,40,38,-1,40,51,52,-1,52,39,40,-1,39,52,53,-1,53,41,39,-1,41,53,54,-1,54,42,41,-1,42,54,48,-1,48,37,42,-1});
CTextureCoordinate* TextureCoordinate112 = (CTextureCoordinate *)(m_pScene.createNode("TextureCoordinate"));
TextureCoordinate112->setPoint(new float[132]{0.3819,0.171,0.4216,0.1651,0.3819,0.171,0.4216,0.1651,0.3819,0.171,0.3819,0.171,0.4637,0.1714,0.4216,0.1651,0.4637,0.1714,0.4216,0.1651,0.3819,0.171,0.3819,0.171,0.3819,0.171,0.3819,0.171,0.4637,0.1714,0.4637,0.1714,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.3836,0.1404,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.4637,0.1714,0.4394,0.1472,0.4244,0.1312,0.3861,0.1398,0.3873,0.0706,0.3871,0.0221,0.3873,0.0706,0.3871,0.0221,0.3871,0.0221,0.3861,0.1398,0.3836,0.1404,0.3873,0.0706,0.3873,0.0706,0.3836,0.1404,0.3861,0.1398,0.3871,0.0221,0.3871,0.0221,0.3871,0.0221,0.433,0.0595,0.4411,0.0186,0.4244,0.1312,0.433,0.0595,0.4244,0.1312,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.3861,0.1398,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4244,0.1312,0.4411,0.0186,0.433,0.0595,0.4244,0.1312,0.4244,0.1312,0.433,0.0595,0.4411,0.0186,0.4411,0.0186});
...
HAnimJoint114->setDEF("hanim_r_metatarsophalangeal");
HAnimJoint114->setName("r_metatarsophalangeal");
HAnimJoint114->setCenter(new float[3]{-3.854,3.64,0.7402});
CHAnimSegment* HAnimSegment115 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment115->setDEF("hanim_r_middistal");
HAnimSegment115->setName("r_middistal");
CTransform* Transform116 = (CTransform *)(m_pScene.createNode("Transform"));
Transform116->setTranslation(new float[3]{-3.854,3.64,0.7402});
...
ImageTexture120->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint34->addChildren(*HAnimJoint84);

CHAnimJoint* HAnimJoint124 = (CHAnimJoint *)(m_pScene.createNode("HAnimJoint"));
HAnimJoint124->setDEF("hanim_vl5");
HAnimJoint124->setName("vl5");
HAnimJoint124->setCenter(new float[3]{0,40.23,-0.8527});
CHAnimSegment* HAnimSegment125 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment125->setDEF("hanim_l5");
HAnimSegment125->setName("l5");
CTransform* Transform126 = (CTransform *)(m_pScene.createNode("Transform"));
Transform126->setTranslation(new float[3]{0,40.23,-0.8527});
...
ImageTexture130->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint134->setCenter(new float[3]{0,57.43,-0.6863});
CHAnimSegment* HAnimSegment135 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment135->setDEF("hanim_skull");
HAnimSegment135->setName("skull");
CTransform* Transform136 = (CTransform *)(m_pScene.createNode("Transform"));
Transform136->setTranslation(new float[3]{0,57.43,-0.6863});
...
ImageTexture140->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint144->setCenter(new float[3]{5.975,52,-0.1452});
CHAnimSegment* HAnimSegment145 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment145->setDEF("hanim_l_upperarm");
HAnimSegment145->setName("l_upperarm");
CTransform* Transform146 = (CTransform *)(m_pScene.createNode("Transform"));
Transform146->setTranslation(new float[3]{5.975,52,-0.1452});
...
ImageTexture150->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint154->setDEF("hanim_l_elbow");
HAnimJoint154->setName("l_elbow");
HAnimJoint154->setCenter(new float[3]{8.093,40.38,-0.2502});
CHAnimSegment* HAnimSegment155 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment155->setDEF("hanim_l_forearm");
HAnimSegment155->setName("l_forearm");
CTransform* Transform156 = (CTransform *)(m_pScene.createNode("Transform"));
Transform156->setTranslation(new float[3]{8.093,40.38,-0.2502});
...
ImageTexture160->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint164->setDEF("hanim_l_radiocarpal");
HAnimJoint164->setName("l_radiocarpal");
HAnimJoint164->setCenter(new float[3]{7.808,31.46,-0.05849});
CHAnimSegment* HAnimSegment165 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment165->setDEF("hanim_l_hand");
HAnimSegment165->setName("l_hand");
CTransform* Transform166 = (CTransform *)(m_pScene.createNode("Transform"));
Transform166->setTranslation(new float[3]{7.808,31.46,-0.05849});
...
ImageTexture170->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint124->addChildren(*HAnimJoint144);

CHAnimJoint* HAnimJoint174 = (CHAnimJoint *)(m_pScene.createNode("HAnimJoint"));
HAnimJoint174->setDEF("hanim_r_shoulder");
HAnimJoint174->setName("r_shoulder");
HAnimJoint174->setCenter(new float[3]{-5.975,52,-0.1452});
CHAnimSegment* HAnimSegment175 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment175->setDEF("hanim_r_upperarm");
HAnimSegment175->setName("r_upperarm");
CTransform* Transform176 = (CTransform *)(m_pScene.createNode("Transform"));
Transform176->setTranslation(new float[3]{-5.975,52,-0.1452});
...
ImageTexture180->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint184->setDEF("hanim_r_elbow");
HAnimJoint184->setName("r_elbow");
HAnimJoint184->setCenter(new float[3]{-8.093,40.38,-0.2502});
CHAnimSegment* HAnimSegment185 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment185->setDEF("hanim_r_forearm");
HAnimSegment185->setName("r_forearm");
CTransform* Transform186 = (CTransform *)(m_pScene.createNode("Transform"));
Transform186->setTranslation(new float[3]{-8.093,40.38,-0.2502});
...
ImageTexture190->setUSE("Annex01JinTextureAtlas");
...
HAnimJoint194->setDEF("hanim_r_radiocarpal");
HAnimJoint194->setName("r_radiocarpal");
HAnimJoint194->setCenter(new float[3]{-7.808,31.46,-0.05849});
CHAnimSegment* HAnimSegment195 = (CHAnimSegment *)(m_pScene.createNode("HAnimSegment"));
HAnimSegment195->setDEF("hanim_r_hand");
HAnimSegment195->setName("r_hand");
CTransform* Transform196 = (CTransform *)(m_pScene.createNode("Transform"));
Transform196->setTranslation(new float[3]{-7.808,31.46,-0.05849});
...
ImageTexture200->setUSE("Annex01JinTextureAtlas");
...
IndexedFaceSet201->setCoord(*Coordinate203);
...
HAnimJoint124->addChildren(*HAnimJoint174);

HAnimJoint34->addChildren(*HAnimJoint124);
...
group->addChildren(*ROUTE239);

CROUTE* ROUTE240 = new CROUTE();
...
group->addChildren(*ROUTE240);

CROUTE* ROUTE241 = new CROUTE();
...
group->addChildren(*ROUTE241);

CROUTE* ROUTE242 = new CROUTE();
...
group->addChildren(*ROUTE242);

CROUTE* ROUTE243 = new CROUTE();
ROUTE243->setFromNode("Keyframe_HumanoidRoot");
ROUTE243->setFromField("value_changed");
ROUTE243->setToNode("hanim_HumanoidRoot");
ROUTE243->setToField("rotation");
group->addChildren(*ROUTE243);

CROUTE* ROUTE244 = new CROUTE();
ROUTE244->setFromNode("Keyframe_sacroiliac");
ROUTE244->setFromField("value_changed");
ROUTE244->setToNode("hanim_sacroiliac");
ROUTE244->setToField("rotation");
group->addChildren(*ROUTE244);

CROUTE* ROUTE245 = new CROUTE();
ROUTE245->setFromNode("Keyframe_l_shoulder");
ROUTE245->setFromField("value_changed");
ROUTE245->setToNode("hanim_l_shoulder");
ROUTE245->setToField("rotation");
group->addChildren(*ROUTE245);

CROUTE* ROUTE246 = new CROUTE();
ROUTE246->setFromNode("Keyframe_l_elbow");
ROUTE246->setFromField("value_changed");
ROUTE246->setToNode("hanim_l_elbow");
ROUTE246->setToField("rotation");
group->addChildren(*ROUTE246);

CROUTE* ROUTE247 = new CROUTE();
ROUTE247->setFromNode("Keyframe_l_radiocarpal");
ROUTE247->setFromField("value_changed");
ROUTE247->setToNode("hanim_l_radiocarpal");
ROUTE247->setToField("rotation");
group->addChildren(*ROUTE247);

CROUTE* ROUTE248 = new CROUTE();
ROUTE248->setFromNode("Keyframe_r_shoulder");
ROUTE248->setFromField("value_changed");
ROUTE248->setToNode("hanim_r_shoulder");
ROUTE248->setToField("rotation");
group->addChildren(*ROUTE248);

CROUTE* ROUTE249 = new CROUTE();
ROUTE249->setFromNode("Keyframe_r_elbow");
ROUTE249->setFromField("value_changed");
ROUTE249->setToNode("hanim_r_elbow");
ROUTE249->setToField("rotation");
group->addChildren(*ROUTE249);

CROUTE* ROUTE250 = new CROUTE();
ROUTE250->setFromNode("Keyframe_r_radiocarpal");
ROUTE250->setFromField("value_changed");
ROUTE250->setToNode("hanim_r_radiocarpal");
ROUTE250->setToField("rotation");
group->addChildren(*ROUTE250);

CROUTE* ROUTE251 = new CROUTE();
ROUTE251->setFromNode("Keyframe_vl5");
ROUTE251->setFromField("value_changed");
ROUTE251->setToNode("hanim_vl5");
ROUTE251->setToField("rotation");
group->addChildren(*ROUTE251);

CROUTE* ROUTE252 = new CROUTE();
ROUTE252->setFromNode("Keyframe_skullbase");
ROUTE252->setFromField("value_changed");
ROUTE252->setToNode("hanim_skullbase");
ROUTE252->setToField("rotation");
group->addChildren(*ROUTE252);

CROUTE* ROUTE253 = new CROUTE();
ROUTE253->setFromNode("Keyframe_l_hip");
ROUTE253->setFromField("value_changed");
ROUTE253->setToNode("hanim_l_hip");
ROUTE253->setToField("rotation");
group->addChildren(*ROUTE253);

CROUTE* ROUTE254 = new CROUTE();
ROUTE254->setFromNode("Keyframe_l_knee");
ROUTE254->setFromField("value_changed");
ROUTE254->setToNode("hanim_l_knee");
ROUTE254->setToField("rotation");
group->addChildren(*ROUTE254);

CROUTE* ROUTE255 = new CROUTE();
ROUTE255->setFromNode("Keyframe_l_talocrural");
ROUTE255->setFromField("value_changed");
ROUTE255->setToNode("hanim_l_talocrural");
ROUTE255->setToField("rotation");
group->addChildren(*ROUTE255);

CROUTE* ROUTE256 = new CROUTE();
ROUTE256->setFromNode("Keyframe_l_talocrural");
ROUTE256->setFromField("value_changed");
ROUTE256->setToNode("hanim_l_metatarsophalangeal");
ROUTE256->setToField("rotation");
group->addChildren(*ROUTE256);

CROUTE* ROUTE257 = new CROUTE();
ROUTE257->setFromNode("Keyframe_r_hip");
ROUTE257->setFromField("value_changed");
ROUTE257->setToNode("hanim_r_hip");
ROUTE257->setToField("rotation");
group->addChildren(*ROUTE257);

CROUTE* ROUTE258 = new CROUTE();
ROUTE258->setFromNode("Keyframe_r_knee");
ROUTE258->setFromField("value_changed");
ROUTE258->setToNode("hanim_r_knee");
ROUTE258->setToField("rotation");
group->addChildren(*ROUTE258);

CROUTE* ROUTE259 = new CROUTE();
ROUTE259->setFromNode("Keyframe_l_talocrural");
ROUTE259->setFromField("value_changed");
ROUTE259->setToNode("hanim_r_talocrural");
ROUTE259->setToField("rotation");
group->addChildren(*ROUTE259);

CROUTE* ROUTE260 = new CROUTE();
ROUTE260->setFromNode("Keyframe_l_talocrural");
ROUTE260->setFromField("value_changed");
ROUTE260->setToNode("hanim_r_metatarsophalangeal");
ROUTE260->setToField("rotation");
group->addChildren(*ROUTE260);

...
HAnimHumanoid24->setInfo(new CString[1]{"humanoidVersion=2.0"}, 1);
...
HAnimJoint25->setUlimit(new float[3]{0,0,0}, 3);
HAnimJoint25->setLlimit(new float[3]{0,0,0}, 3);
...
ImageTexture31->setUrl(new CString[2]{"Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/Jin.png"}, 2);
...
CGroup* Group205 = (CGroup *)(m_pScene.createNode("Group"));
Group205->setDEF("KeyframeAnimation");
CTimeSensor* TimeSensor206 = (CTimeSensor *)(m_pScene.createNode("TimeSensor"));
...
CPositionInterpolator* PositionInterpolator207 = (CPositionInterpolator *)(m_pScene.createNode("PositionInterpolator"));

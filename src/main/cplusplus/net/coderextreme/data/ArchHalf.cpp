...
Material17->setDEF("MaterialNode");
Material17->setDiffuseColor(new float[3]{1,0.75,0.25});
Appearance16->setMaterial(*Material17);

Shape13->setAppearance(*Appearance16);

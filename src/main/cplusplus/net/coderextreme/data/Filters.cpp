...
Viewpoint18.setOrientation(new float[]{1,0,0,-0.5});
Viewpoint18.setPosition(new float[]{0,500,600});
Viewpoint18.setRetainUserOffsets(True);
Scene14.addChild(&Viewpoint18);

Transform& Transform19 =  Transform();
Transform19.setDEF(CString("TransformAudio1"));
Transform19.setTranslation(new float[]{-200,50,0});
Shape& Shape20 =  Shape();
...
Transform24.setTranslation(new float[]{0,50,0});
Shape& Shape25 =  Shape();
...
Transform29.setTranslation(new float[]{200,50,0});
Shape& Shape30 =  Shape();

...
meta2.setContent(CString("WinterAndSpringMusicCreditAllTitleBox.x3d"));
head1.addMeta(&meta2);

meta& meta3 =  meta();
meta3.setName(CString("description"));
meta3.setContent(CString("Credits for scene musics clips."));
head1.addMeta(&meta3);
...
meta9.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringMusicCreditAllTitleBox.x3d"));
head1.addMeta(&meta9);
...
WorldInfo11.setTitle(CString("WinterAndSpringMusicCreditAllTitleBox.x3d"));
Scene10.addChild(&WorldInfo11);

Viewpoint& Viewpoint12 =  Viewpoint();
Viewpoint12.setDEF(CString("WSAuthorsAllTitleView"));
Viewpoint12.setDescription(CString("Look at Music Credit title"));
Viewpoint12.setPosition(new float[]{10.0,11.0,-15.0});
Viewpoint12.setOrientation(new float[]{-0.15,0.0,0.0,0.2});
Scene10.addChild(&Viewpoint12);

Transform& Transform13 =  Transform();
Transform13.setDEF(CString("WSMusicCreditAllTitle"));
Transform13.setTranslation(new float[]{10.0,10.0,-20.0});
Shape& Shape14 =  Shape();
...
ImageTexture17.setUrl(new CString[]{CString("images/WSMusicCreditAll.png"), CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSMusicCreditAll.png")}, 2);

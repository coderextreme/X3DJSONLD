...
HAnimJoint31.setCenter(new float[]{0.0,32.68,-0.7076});
...
Transform33.setTranslation(new float[]{0.0,32.68,-0.7076});
Shape& Shape34 =  Shape();
...
HAnimJoint191.setCenter(new float[]{0.0,35.310001,-2.314});
...
Transform193.setTranslation(new float[]{0.0,35.310001,-2.314});
...
HAnimJoint201.setCenter(new float[]{0.0,35.310001,-2.314});
...
Transform203.setTranslation(new float[]{0.0,35.310001,-2.314});

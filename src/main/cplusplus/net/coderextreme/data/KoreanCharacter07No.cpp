...
meta2->setName("title");
meta2->setContent("KoreanCharacter07No.x3d");
head1->addMeta(*meta2);
...
meta12->setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter07No.x3d");
...
WorldInfo19->setTitle("KoreanCharacter07No.x3d");
...
HAnimHumanoid22->setDEF("hanim_No");
HAnimHumanoid22->setVersion("2.0");
HAnimHumanoid22->setName("No");
...
HAnimJoint25->setCenter(new float[3]{0,34.79,-1.299});
...
Transform27->setTranslation(new float[3]{0,34.79,-1.299});
...
ImageTexture31->setDEF("NoTextureAtlas");
ImageTexture31->setUrl(new CString[2]{"images/No.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/No.png"}, 2);
...
HAnimJoint35->setCenter(new float[3]{3.785,34.07,-1.57});
...
Transform37->setTranslation(new float[3]{3.785,34.07,-1.57});
...
ImageTexture41->setUSE("NoTextureAtlas");
...
HAnimJoint45->setCenter(new float[3]{3.838,18.4,-1.212});
...
Transform47->setTranslation(new float[3]{3.838,18.4,-1.212});
...
ImageTexture51->setUSE("NoTextureAtlas");
...
HAnimJoint55->setCenter(new float[3]{3.826,4.044,-1.361});
...
Transform57->setTranslation(new float[3]{3.826,4.044,-1.361});
...
ImageTexture61->setUSE("NoTextureAtlas");
...
HAnimJoint65->setCenter(new float[3]{3.826,3.118,-0.2867});
...
Transform67->setTranslation(new float[3]{3.826,3.118,-0.2867});
...
ImageTexture71->setUSE("NoTextureAtlas");
...
HAnimJoint75->setCenter(new float[3]{-3.785,34.07,-1.57});
...
Transform77->setTranslation(new float[3]{-3.785,34.07,-1.57});
...
ImageTexture81->setUSE("NoTextureAtlas");
...
HAnimJoint85->setCenter(new float[3]{-3.838,18.4,-1.212});
...
Transform87->setTranslation(new float[3]{-3.838,18.4,-1.212});
...
ImageTexture91->setUSE("NoTextureAtlas");
...
HAnimJoint95->setCenter(new float[3]{-3.826,4.044,-1.361});
...
Transform97->setTranslation(new float[3]{-3.826,4.044,-1.361});
...
ImageTexture101->setUSE("NoTextureAtlas");
...
TextureCoordinate103->setPoint(new float[168]{0.3815,0.8453,0.3815,0.8109,0.3624,0.829,0.3685,0.8453,0.3815,0.8034,0.3528,0.8194,0.3815,0.8107,0.3623,0.8291,0.4668,0.873,0.4763,0.8464,0.3815,0.8453,0.3685,0.8453,0.3813,0.8654,0.368,0.8691,0.4224,0.8577,0.4224,0.8376,0.4224,0.8026,0.4224,0.8376,0.4224,0.7937,0.4224,0.8026,0.4291,0.8577,0.4291,0.8376,0.4291,0.8028,0.4291,0.8376,0.4291,0.7943,0.4291,0.8029,0.3433,0.8314,0.3514,0.8453,0.3396,0.8261,0.3431,0.8311,0.3514,0.8453,0.368,0.869,0.352,0.8609,0.352,0.8606,0.3472,0.8677,0.3591,0.8766,0.3419,0.8568,0.3419,0.8634,0.5046,0.84,0.5046,0.873,0.3419,0.8564,0.539,0.8465,0.5488,0.873,0.3419,0.8451,0.3434,0.8311,0.3404,0.826,0.3431,0.8307,0.3419,0.8452,0.3813,0.8655,0.4224,0.8577,0.4291,0.8577,0.3684,0.8871,0.3756,0.8816,0.3831,0.8794,0.4229,0.872,0.4261,0.8727,0.4261,0.8727,0.4261,0.8727,0.4229,0.872,0.3831,0.8794,0.3756,0.8815,0.4291,0.8577,0.5498,0.8883,0.5046,0.8883,0.4666,0.8883,0.5445,0.8996,0.5046,0.8996,0.3624,0.829,0.3685,0.8453,0.3528,0.8194,0.368,0.8691,0.3396,0.8261,0.3472,0.8677,0.3591,0.8766,0.3419,0.8634,0.3419,0.8564,0.3419,0.8451,0.3434,0.8311,0.3404,0.826,0.3528,0.8194,0.3623,0.8291,0.3685,0.8453,0.368,0.869,0.3591,0.8766});
...
HAnimJoint105->setCenter(new float[3]{-3.826,3.118,-0.2867});
...
Transform107->setTranslation(new float[3]{-3.826,3.118,-0.2867});
...
ImageTexture111->setUSE("NoTextureAtlas");
...
TextureCoordinate113->setPoint(new float[134]{0.5046,0.9061,0.4664,0.9061,0.3813,0.8655,0.3794,0.8893,0.368,0.869,0.3703,0.8986,0.3591,0.8766,0.3794,0.8891,0.368,0.8691,0.4666,0.8883,0.5046,0.8883,0.5509,0.9061,0.3967,0.963,0.3877,0.9702,0.562,0.9285,0.5046,0.9285,0.4059,0.9781,0.4144,0.966,0.4542,0.9285,0.5657,0.9535,0.5046,0.9535,0.4506,0.9535,0.5561,0.9717,0.397,0.9616,0.4144,0.966,0.4224,0.8577,0.4263,0.8811,0.4134,0.9791,0.4208,0.9685,0.4208,0.9685,0.4291,0.8577,0.4329,0.8811,0.3769,0.9239,0.3855,0.9182,0.3855,0.9183,0.502,0.9815,0.4591,0.9717,0.4263,0.8811,0.4263,0.9104,0.4263,0.9104,0.5498,0.8883,0.4329,0.8811,0.4329,0.9104,0.4329,0.9104,0.3843,0.9558,0.3913,0.9496,0.4741,0.8664,0.5046,0.8664,0.4263,0.9431,0.3913,0.9494,0.4263,0.9431,0.4329,0.9431,0.4329,0.9431,0.3813,0.8654,0.4224,0.8577,0.4291,0.8577,0.3704,0.8386,0.38,0.8357,0.4179,0.8293,0.4204,0.8297,0.4204,0.8297,0.4204,0.8297,0.4179,0.8293,0.38,0.8357,0.3704,0.8386,0.3666,0.8532,0.4291,0.8577});
...
HAnimJoint115->setCenter(new float[3]{0,32.91,-1.57});
...
Transform117->setTranslation(new float[3]{0,32.91,-1.57});
...
ImageTexture121->setUSE("NoTextureAtlas");
...
HAnimJoint125->setCenter(new float[3]{7.266,54.05,-1.79});
...
Transform127->setTranslation(new float[3]{7.266,54.05,-1.79});
...
ImageTexture131->setUSE("NoTextureAtlas");
...
HAnimJoint135->setCenter(new float[3]{7.834,43.39,-1.651});
...
Transform137->setTranslation(new float[3]{7.834,43.39,-1.651});
...
ImageTexture141->setUSE("NoTextureAtlas");
...
HAnimJoint145->setCenter(new float[3]{7.738,35.43,-1.558});
...
Transform147->setTranslation(new float[3]{7.738,35.43,-1.558});
...
ImageTexture151->setUSE("NoTextureAtlas");
...
HAnimJoint155->setCenter(new float[3]{-7.266,54.05,-1.79});
...
Transform157->setTranslation(new float[3]{-7.266,54.05,-1.79});
...
ImageTexture161->setUSE("NoTextureAtlas");
...
HAnimJoint165->setCenter(new float[3]{-7.834,43.39,-1.651});
...
Transform167->setTranslation(new float[3]{-7.834,43.39,-1.651});
...
ImageTexture171->setUSE("NoTextureAtlas");
...
HAnimJoint175->setCenter(new float[3]{-7.738,35.43,-1.558});
...
Transform177->setTranslation(new float[3]{-7.738,35.43,-1.558});
...
ImageTexture181->setUSE("NoTextureAtlas");
...
HAnimJoint185->setCenter(new float[3]{0,37.06,-1.409});
...
Transform187->setTranslation(new float[3]{0,37.06,-1.409});
...
ImageTexture191->setUSE("NoTextureAtlas");
...
HAnimJoint195->setCenter(new float[3]{0,37.06,-1.409});
...
Transform197->setTranslation(new float[3]{0,37.06,-1.409});
...
ImageTexture201->setUSE("NoTextureAtlas");

...
meta3->setName("title");
meta3->setContent("skeletonTidy.x3d");
head1->addMeta(*meta3);

Cmeta* meta4 = new Cmeta();
meta4->setName("identifier");
meta4->setContent("http://www.web3d.org/x3d/content/examples/HumanoidAnimation/skeletonTidy.x3d");
head1->addMeta(*meta4);

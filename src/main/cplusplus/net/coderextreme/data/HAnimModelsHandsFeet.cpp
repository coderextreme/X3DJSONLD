...
Viewpoint21.setPosition(new float[]{0,0,1.7});
Scene18.addChild(&Viewpoint21);

Transform& Transform22 =  Transform();
Transform22.setTranslation(new float[]{-1,1,0});
...
Transform26.setTranslation(new float[]{1,1,0});
...
Transform29.setTranslation(new float[]{-1,-1,0});
...
Transform32.setTranslation(new float[]{1,-1,0});

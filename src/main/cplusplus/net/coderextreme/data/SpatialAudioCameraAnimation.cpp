...
PositionInterpolator20.setKey(new float[5]{0.0,0.25,0.5,0.75,1.0}, 5);
PositionInterpolator20.setKeyValue(new float[15]{0.0,2000.0,3500.0,0.0,2000.0,0.0,0.0,2000.0,-3500.0,0.0,2000.0,0.0,0.0,2000.0,3500.0}, 15);
...
OrientationInterpolator21.setKey(new float[5]{0.0,0.25,0.5,0.75,1.0}, 5);
OrientationInterpolator21.setKeyValue(new float[20]{1.0,0.0,0.0,-0.523599,0.99999,0.003554,0.002727,-1.309007,0.0,-0.965926,-0.258819,-3.141593,0.002282,-0.793351,-0.60876,-3.135645,1.0,-0.000001,0.0,-0.523599}, 20);
...
Transform26.setTranslation(new float[3]{1.241,0.0,0.358});
Shape& Shape27 =  Shape();
...
Box& Box30 =  Box();
Box30.setSize(new float[3]{2000.0,1.0,2000.0});
...
Transform31.setTranslation(new float[3]{-933.123474,0.0,-926.253235});
Shape& Shape32 =  Shape();
...
Transform37.setRotation(new float[4]{1.0,0.0,0.0,-0.5});
Transform37.setScale(new float[3]{100.0,100.0,100.0});
Transform37.setTranslation(new float[3]{0.0,100.0,0.0});
Shape& Shape38 =  Shape();
Appearance& Appearance39 =  Appearance();
Material& Material40 =  Material();
Material40.setAmbientIntensity(0.0933);
Material40.setDiffuseColor(new float[3]{1.0,1.0,1.0});
...
Transform43.setTranslation(new float[3]{933.475586,0.0,924.423218});
Shape& Shape44 =  Shape();
...
Transform49.setScale(new float[3]{100.0,100.0,100.0});
Transform49.setTranslation(new float[3]{0.0,100.0,0.0});
Shape& Shape50 =  Shape();
Appearance& Appearance51 =  Appearance();
Material& Material52 =  Material();
Material52.setAmbientIntensity(0.0933);
Material52.setDiffuseColor(new float[3]{1.0,1.0,1.0});

...
Viewpoint14.setOrientation(new float[]{1,0,0,-0.4});
Viewpoint14.setPosition(new float[]{0,10,25});
...
Coordinate19.setPoint(new float[]{0,0,0,-10,0,10,-9,0,10,-8,0,10,-7,0,10,-6,0,10,-5,0,10,-4,0,10,-3,0,10,-2,0,10,-1,0,10,0,0,10,1,0,10,2,0,10,3,0,10,4,0,10,5,0,10,6,0,10,7,0,10,8,0,10,9,0,10,10,0,10,-10,0,-10,-9,0,-10,-8,0,-10,-7,0,-10,-6,0,-10,-5,0,-10,-4,0,-10,-3,0,-10,-2,0,-10,-1,0,-10,0,0,-10,1,0,-10,2,0,-10,3,0,-10,4,0,-10,5,0,-10,6,0,-10,7,0,-10,8,0,-10,9,0,-10,10,0,-10}, 129);
IndexedLineSet18.setCoord(&Coordinate19);

CColor& Color20 =  CColor();
Color20.setColor(new float[]{0.4,0.4,0.4,0.8,0.2,0,0.4,0.1,0.05}, 9);
...
Transform21.setRotation(new float[]{0,1,0,1.57079});
Shape& Shape22 =  Shape();
...
Transform23.setTranslation(new float[]{0,-0.5,0});
...
Transform30.setTranslation(new float[]{10,-0.5,10});
...
Transform36.setTranslation(new float[]{10,-0.5,-10});
...
Transform42.setTranslation(new float[]{-10,-0.5,10});
...
Transform48.setTranslation(new float[]{-10,-0.5,-10});

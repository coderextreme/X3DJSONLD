...
meta3.setContent(CString("KoreanCharacter10Mi.x3d"));
head1.addMeta(&meta3);
...
meta13.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter10Mi.x3d"));
...
meta15.setContent(CString("Suwon University HAnim Editor"));
...
WorldInfo20.setTitle(CString("KoreanCharacter10Mi.x3d"));
...
Viewpoint22.setDescription(CString("Mi"));
Viewpoint22.setPosition(new float[3]{0.0,1.0,3.0});
Scene19.addChild(&Viewpoint22);

HAnimHumanoid& HAnimHumanoid23 =  HAnimHumanoid();
HAnimHumanoid23.X3DNode::setName(CString("Mi"));
HAnimHumanoid23.setDEF(CString("hanim_Mi"));
...
MetadataString25.setValue(new CString[1]{CString("Chul Hee Jung and Myeong Won Lee")}, 1);
...
HAnimJoint31.setCenter(new float[3]{0.0,32.68,-0.7076});
...
Transform33.setTranslation(new float[3]{0.0,32.68,-0.7076});
Shape& Shape34 =  Shape();
...
ImageTexture37.setDEF(CString("MiTextureAtlas"));
ImageTexture37.setUrl(new CString[2]{CString("images/Mi.png"), CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Mi.png")}, 2);
...
HAnimJoint41.setCenter(new float[3]{3.309,31.309999,-0.8377});
...
Transform43.setTranslation(new float[3]{3.309,31.309999,-0.8377});
Shape& Shape44 =  Shape();
...
HAnimJoint51.setCenter(new float[3]{3.584,17.16,-1.037});
...
Transform53.setTranslation(new float[3]{3.584,17.16,-1.037});
Shape& Shape54 =  Shape();
...
HAnimJoint61.setDEF(CString("hanim_l_talocrural"));
HAnimJoint61.setCenter(new float[3]{3.602,4.137,0.6104});
HAnimSegment& HAnimSegment62 =  HAnimSegment();
HAnimSegment62.X3DNode::setName(CString("l_talus"));
HAnimSegment62.setDEF(CString("hanim_l_talus"));
Transform& Transform63 =  Transform();
Transform63.setTranslation(new float[3]{3.602,4.137,0.6104});
Shape& Shape64 =  Shape();
...
HAnimJoint71.X3DNode::setName(CString("l_metatarsophalangeal_2"));
HAnimJoint71.setDEF(CString("hanim_l_metatarsophalangeal_2"));
HAnimJoint71.setCenter(new float[3]{3.602,3.02,0.07017});
HAnimSegment& HAnimSegment72 =  HAnimSegment();
HAnimSegment72.X3DNode::setName(CString("l_tarsal_proximal_phalanx_2"));
HAnimSegment72.setDEF(CString("hanim_l_tarsal_proximal_phalanx_2"));
Transform& Transform73 =  Transform();
Transform73.setTranslation(new float[3]{3.602,3.02,0.07017});
Shape& Shape74 =  Shape();
...
HAnimJoint81.X3DNode::setName(CString("r_hip"));
HAnimJoint81.setDEF(CString("hanim_r_hip"));
HAnimJoint81.setCenter(new float[3]{-3.309,31.309999,-0.8377});
HAnimSegment& HAnimSegment82 =  HAnimSegment();
HAnimSegment82.X3DNode::setName(CString("r_thigh"));
HAnimSegment82.setDEF(CString("hanim_r_thigh"));
Transform& Transform83 =  Transform();
Transform83.setTranslation(new float[3]{-3.309,31.309999,-0.8377});
Shape& Shape84 =  Shape();
...
HAnimJoint91.setCenter(new float[3]{-3.584,17.16,-1.037});
...
Transform93.setTranslation(new float[3]{-3.584,17.16,-1.037});
Shape& Shape94 =  Shape();
...
HAnimJoint101.X3DNode::setName(CString("r_talocrural"));
HAnimJoint101.setDEF(CString("hanim_r_talocrural"));
HAnimJoint101.setCenter(new float[3]{-3.602,4.137,0.6104});
HAnimSegment& HAnimSegment102 =  HAnimSegment();
HAnimSegment102.X3DNode::setName(CString("r_talus"));
HAnimSegment102.setDEF(CString("hanim_r_talus"));
Transform& Transform103 =  Transform();
Transform103.setTranslation(new float[3]{-3.602,4.137,0.6104});
...
HAnimJoint111.X3DNode::setName(CString("r_metatarsophalangeal_2"));
HAnimJoint111.setDEF(CString("hanim_r_metatarsophalangeal_2"));
HAnimJoint111.setCenter(new float[3]{-3.602,3.02,0.07017});
HAnimSegment& HAnimSegment112 =  HAnimSegment();
HAnimSegment112.X3DNode::setName(CString("r_tarsal_proximal_phalanx_2"));
HAnimSegment112.setDEF(CString("hanim_r_tarsal_proximal_phalanx_2"));
Transform& Transform113 =  Transform();
Transform113.setTranslation(new float[3]{-3.602,3.02,0.07017});
...
HAnimJoint121.X3DNode::setName(CString("sacroiliac"));
HAnimJoint121.setDEF(CString("hanim_sacroiliac"));
HAnimJoint121.setCenter(new float[3]{0.05053,30.200001,-1.38});
HAnimSegment& HAnimSegment122 =  HAnimSegment();
HAnimSegment122.X3DNode::setName(CString("pelvis"));
HAnimSegment122.setDEF(CString("hanim_pelvis"));
Transform& Transform123 =  Transform();
Transform123.setTranslation(new float[3]{0.05053,30.200001,-1.38});
...
HAnimJoint131.X3DNode::setName(CString("l_shoulder"));
HAnimJoint131.setDEF(CString("hanim_l_shoulder"));
HAnimJoint131.setCenter(new float[3]{6.032,48.580002,-1.277});
HAnimSegment& HAnimSegment132 =  HAnimSegment();
HAnimSegment132.X3DNode::setName(CString("l_upperarm"));
HAnimSegment132.setDEF(CString("hanim_l_upperarm"));
Transform& Transform133 =  Transform();
Transform133.setTranslation(new float[3]{6.032,48.580002,-1.277});
...
HAnimJoint141.X3DNode::setName(CString("l_elbow"));
HAnimJoint141.setDEF(CString("hanim_l_elbow"));
HAnimJoint141.setCenter(new float[3]{6.032,40.810001,-1.412});
HAnimSegment& HAnimSegment142 =  HAnimSegment();
HAnimSegment142.X3DNode::setName(CString("l_forearm"));
HAnimSegment142.setDEF(CString("hanim_l_forearm"));
Transform& Transform143 =  Transform();
Transform143.setTranslation(new float[3]{6.032,40.810001,-1.412});
...
HAnimJoint151.X3DNode::setName(CString("l_radiocarpal"));
HAnimJoint151.setDEF(CString("hanim_l_radiocarpal"));
HAnimJoint151.setCenter(new float[3]{6.934,33.959999,-1.108});
HAnimSegment& HAnimSegment152 =  HAnimSegment();
HAnimSegment152.X3DNode::setName(CString("l_carpal"));
HAnimSegment152.setDEF(CString("hanim_l_carpal"));
Transform& Transform153 =  Transform();
Transform153.setTranslation(new float[3]{6.934,33.959999,-1.108});
...
HAnimJoint161.X3DNode::setName(CString("r_shoulder"));
HAnimJoint161.setDEF(CString("hanim_r_shoulder"));
HAnimJoint161.setCenter(new float[3]{-6.032,48.580002,-1.277});
HAnimSegment& HAnimSegment162 =  HAnimSegment();
HAnimSegment162.X3DNode::setName(CString("r_upperarm"));
HAnimSegment162.setDEF(CString("hanim_r_upperarm"));
Transform& Transform163 =  Transform();
Transform163.setTranslation(new float[3]{-6.032,48.580002,-1.277});
...
HAnimJoint171.X3DNode::setName(CString("r_elbow"));
HAnimJoint171.setDEF(CString("hanim_r_elbow"));
HAnimJoint171.setCenter(new float[3]{-6.032,40.810001,-1.412});
HAnimSegment& HAnimSegment172 =  HAnimSegment();
HAnimSegment172.X3DNode::setName(CString("r_forearm"));
HAnimSegment172.setDEF(CString("hanim_r_forearm"));
Transform& Transform173 =  Transform();
Transform173.setTranslation(new float[3]{-6.032,40.810001,-1.412});
...
HAnimJoint181.X3DNode::setName(CString("r_radiocarpal"));
HAnimJoint181.setDEF(CString("hanim_r_radiocarpal"));
HAnimJoint181.setCenter(new float[3]{-6.934,33.959999,-1.108});
HAnimSegment& HAnimSegment182 =  HAnimSegment();
HAnimSegment182.X3DNode::setName(CString("r_carpal"));
HAnimSegment182.setDEF(CString("hanim_r_carpal"));
Transform& Transform183 =  Transform();
Transform183.setTranslation(new float[3]{-6.934,33.959999,-1.108});
...
HAnimJoint191.X3DNode::setName(CString("vl5"));
HAnimJoint191.setDEF(CString("hanim_vl5"));
HAnimJoint191.setCenter(new float[3]{0.0,35.310001,-2.314});
HAnimSegment& HAnimSegment192 =  HAnimSegment();
HAnimSegment192.X3DNode::setName(CString("l5"));
HAnimSegment192.setDEF(CString("hanim_l5"));
Transform& Transform193 =  Transform();
Transform193.setTranslation(new float[3]{0.0,35.310001,-2.314});
...
HAnimJoint201.X3DNode::setName(CString("skullbase"));
HAnimJoint201.setDEF(CString("hanim_skullbase"));
HAnimJoint201.setCenter(new float[3]{0.0,35.310001,-2.314});
HAnimSegment& HAnimSegment202 =  HAnimSegment();
HAnimSegment202.X3DNode::setName(CString("skull"));
HAnimSegment202.setDEF(CString("hanim_skull"));
Transform& Transform203 =  Transform();
Transform203.setTranslation(new float[3]{0.0,35.310001,-2.314});
...
HAnimJoint211.setUSE(CString("hanim_humanoid_root"));
HAnimHumanoid23.setJoints(&HAnimJoint211);

HAnimJoint& HAnimJoint212 =  HAnimJoint();
HAnimJoint212.setUSE(CString("hanim_sacroiliac"));
HAnimHumanoid23.setJoints(&HAnimJoint212);

HAnimJoint& HAnimJoint213 =  HAnimJoint();
HAnimJoint213.setUSE(CString("hanim_skullbase"));
HAnimHumanoid23.setJoints(&HAnimJoint213);

HAnimJoint& HAnimJoint214 =  HAnimJoint();
HAnimJoint214.setUSE(CString("hanim_vl5"));
HAnimHumanoid23.setJoints(&HAnimJoint214);

HAnimJoint& HAnimJoint215 =  HAnimJoint();
HAnimJoint215.setUSE(CString("hanim_l_elbow"));
HAnimHumanoid23.setJoints(&HAnimJoint215);

HAnimJoint& HAnimJoint216 =  HAnimJoint();
HAnimJoint216.setUSE(CString("hanim_r_elbow"));
HAnimHumanoid23.setJoints(&HAnimJoint216);

HAnimJoint& HAnimJoint217 =  HAnimJoint();
HAnimJoint217.setUSE(CString("hanim_l_hip"));
HAnimHumanoid23.setJoints(&HAnimJoint217);

HAnimJoint& HAnimJoint218 =  HAnimJoint();
HAnimJoint218.setUSE(CString("hanim_r_hip"));
HAnimHumanoid23.setJoints(&HAnimJoint218);

HAnimJoint& HAnimJoint219 =  HAnimJoint();
HAnimJoint219.setUSE(CString("hanim_l_knee"));
HAnimHumanoid23.setJoints(&HAnimJoint219);

HAnimJoint& HAnimJoint220 =  HAnimJoint();
HAnimJoint220.setUSE(CString("hanim_r_knee"));
HAnimHumanoid23.setJoints(&HAnimJoint220);

HAnimJoint& HAnimJoint221 =  HAnimJoint();
HAnimJoint221.setUSE(CString("hanim_l_metatarsophalangeal_2"));
HAnimHumanoid23.setJoints(&HAnimJoint221);

HAnimJoint& HAnimJoint222 =  HAnimJoint();
HAnimJoint222.setUSE(CString("hanim_r_metatarsophalangeal_2"));
HAnimHumanoid23.setJoints(&HAnimJoint222);

HAnimJoint& HAnimJoint223 =  HAnimJoint();
HAnimJoint223.setUSE(CString("hanim_l_radiocarpal"));
HAnimHumanoid23.setJoints(&HAnimJoint223);

HAnimJoint& HAnimJoint224 =  HAnimJoint();
HAnimJoint224.setUSE(CString("hanim_r_radiocarpal"));
HAnimHumanoid23.setJoints(&HAnimJoint224);

HAnimJoint& HAnimJoint225 =  HAnimJoint();
HAnimJoint225.setUSE(CString("hanim_l_shoulder"));
HAnimHumanoid23.setJoints(&HAnimJoint225);

HAnimJoint& HAnimJoint226 =  HAnimJoint();
HAnimJoint226.setUSE(CString("hanim_r_shoulder"));
HAnimHumanoid23.setJoints(&HAnimJoint226);

HAnimJoint& HAnimJoint227 =  HAnimJoint();
HAnimJoint227.setUSE(CString("hanim_l_talocrural"));
HAnimHumanoid23.setJoints(&HAnimJoint227);

HAnimJoint& HAnimJoint228 =  HAnimJoint();
HAnimJoint228.setUSE(CString("hanim_r_talocrural"));
HAnimHumanoid23.setJoints(&HAnimJoint228);

HAnimSegment& HAnimSegment229 =  HAnimSegment();
HAnimSegment229.setUSE(CString("hanim_l5"));
HAnimHumanoid23.setSegments(&HAnimSegment229);

HAnimSegment& HAnimSegment230 =  HAnimSegment();
HAnimSegment230.setUSE(CString("hanim_pelvis"));
HAnimHumanoid23.setSegments(&HAnimSegment230);

HAnimSegment& HAnimSegment231 =  HAnimSegment();
HAnimSegment231.setUSE(CString("hanim_sacrum"));
HAnimHumanoid23.setSegments(&HAnimSegment231);

HAnimSegment& HAnimSegment232 =  HAnimSegment();
HAnimSegment232.setUSE(CString("hanim_skull"));
HAnimHumanoid23.setSegments(&HAnimSegment232);

HAnimSegment& HAnimSegment233 =  HAnimSegment();
HAnimSegment233.setUSE(CString("hanim_l_calf"));
HAnimHumanoid23.setSegments(&HAnimSegment233);

HAnimSegment& HAnimSegment234 =  HAnimSegment();
HAnimSegment234.setUSE(CString("hanim_r_calf"));
HAnimHumanoid23.setSegments(&HAnimSegment234);

HAnimSegment& HAnimSegment235 =  HAnimSegment();
HAnimSegment235.setUSE(CString("hanim_l_carpal"));
HAnimHumanoid23.setSegments(&HAnimSegment235);

HAnimSegment& HAnimSegment236 =  HAnimSegment();
HAnimSegment236.setUSE(CString("hanim_r_carpal"));
HAnimHumanoid23.setSegments(&HAnimSegment236);

HAnimSegment& HAnimSegment237 =  HAnimSegment();
HAnimSegment237.setUSE(CString("hanim_l_forearm"));
HAnimHumanoid23.setSegments(&HAnimSegment237);

HAnimSegment& HAnimSegment238 =  HAnimSegment();
HAnimSegment238.setUSE(CString("hanim_r_forearm"));
HAnimHumanoid23.setSegments(&HAnimSegment238);

HAnimSegment& HAnimSegment239 =  HAnimSegment();
HAnimSegment239.setUSE(CString("hanim_l_talus"));
HAnimHumanoid23.setSegments(&HAnimSegment239);

HAnimSegment& HAnimSegment240 =  HAnimSegment();
HAnimSegment240.setUSE(CString("hanim_r_talus"));
HAnimHumanoid23.setSegments(&HAnimSegment240);

HAnimSegment& HAnimSegment241 =  HAnimSegment();
HAnimSegment241.setUSE(CString("hanim_l_tarsal_proximal_phalanx_2"));
HAnimHumanoid23.setSegments(&HAnimSegment241);

HAnimSegment& HAnimSegment242 =  HAnimSegment();
HAnimSegment242.setUSE(CString("hanim_r_tarsal_proximal_phalanx_2"));
HAnimHumanoid23.setSegments(&HAnimSegment242);

HAnimSegment& HAnimSegment243 =  HAnimSegment();
HAnimSegment243.setUSE(CString("hanim_l_thigh"));
HAnimHumanoid23.setSegments(&HAnimSegment243);

HAnimSegment& HAnimSegment244 =  HAnimSegment();
HAnimSegment244.setUSE(CString("hanim_r_thigh"));
HAnimHumanoid23.setSegments(&HAnimSegment244);

HAnimSegment& HAnimSegment245 =  HAnimSegment();
HAnimSegment245.setUSE(CString("hanim_l_upperarm"));
HAnimHumanoid23.setSegments(&HAnimSegment245);

HAnimSegment& HAnimSegment246 =  HAnimSegment();
HAnimSegment246.setUSE(CString("hanim_r_upperarm"));

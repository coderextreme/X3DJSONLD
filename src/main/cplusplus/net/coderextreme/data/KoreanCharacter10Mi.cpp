...
meta3->setName("title");
meta3->setContent("KoreanCharacter10Mi.x3d");
head1->addMeta(*meta3);
...
meta13->setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter10Mi.x3d");
...
WorldInfo20->setTitle("KoreanCharacter10Mi.x3d");
...
HAnimHumanoid23->setName("Mi");
HAnimHumanoid23->setDEF("hanim_Mi");
...
HAnimJoint24->setCenter(new float[3]{0,32.68,-0.7076});
...
Transform26->setTranslation(new float[3]{0,32.68,-0.7076});
...
ImageTexture30->setDEF("MiTextureAtlas");
ImageTexture30->setUrl(new CString[2]{"images/Mi.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/images/Mi.png"}, 2);
...
Coordinate32->setPoint(new float[186]{0,1.053,0.0273,0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.875,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0,0.9123,0.596,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.875,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.98,0.5267,-0.4285,-1.132,0.5267,0.0273,-0.98,0.5267,0.483,-0.5658,0.5267,0.6985,0,0.5267,0.8206,0.5658,0.5267,0.6985,0.98,0.5267,0.483,1.132,0.5267,0.0273,0.98,0.5267,-0.4285,0.5658,0.5267,-0.7621,0,0,-0.9616,-0.6534,0,-0.8206,-1.132,0,-0.4353,-1.307,0,0.0273,-1.132,0,0.5536,-0.6534,0,0.8206,0,0,0.9616,0.6534,0,0.8206,1.132,0,0.5536,1.307,0,0.0273,1.132,0,-0.4353,0.6534,0,-0.8206,0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0,-1.053,0.0273});
...
HAnimJoint34->setCenter(new float[3]{3.309,31.309999,-0.8377});
...
Transform36->setTranslation(new float[3]{3.309,31.309999,-0.8377});
...
ImageTexture40->setUSE("MiTextureAtlas");
...
HAnimJoint44->setCenter(new float[3]{3.584,17.16,-1.037});
...
Transform46->setTranslation(new float[3]{3.584,17.16,-1.037});
...
ImageTexture50->setUSE("MiTextureAtlas");
...
HAnimJoint54->setCenter(new float[3]{3.602,4.137,0.6104});
...
Transform56->setTranslation(new float[3]{3.602,4.137,0.6104});
...
ImageTexture60->setUSE("MiTextureAtlas");
...
HAnimJoint64->setCenter(new float[3]{3.602,3.02,0.07017});
...
Transform66->setTranslation(new float[3]{3.602,3.02,0.07017});
...
ImageTexture70->setUSE("MiTextureAtlas");
...
HAnimJoint74->setCenter(new float[3]{-3.309,31.309999,-0.8377});
...
Transform76->setTranslation(new float[3]{-3.309,31.309999,-0.8377});
...
ImageTexture80->setUSE("MiTextureAtlas");
...
HAnimJoint84->setCenter(new float[3]{-3.584,17.16,-1.037});
...
Transform86->setTranslation(new float[3]{-3.584,17.16,-1.037});
...
ImageTexture90->setUSE("MiTextureAtlas");
...
HAnimJoint94->setCenter(new float[3]{-3.602,4.137,0.6104});
...
Transform96->setTranslation(new float[3]{-3.602,4.137,0.6104});
...
ImageTexture100->setUSE("MiTextureAtlas");
...
HAnimJoint104->setCenter(new float[3]{-3.602,3.02,0.07017});
...
Transform106->setTranslation(new float[3]{-3.602,3.02,0.07017});
...
ImageTexture110->setUSE("MiTextureAtlas");
...
HAnimJoint114->setCenter(new float[3]{0.05053,30.200001,-1.38});
...
Transform116->setTranslation(new float[3]{0.05053,30.200001,-1.38});
...
ImageTexture120->setUSE("MiTextureAtlas");
...
HAnimJoint124->setCenter(new float[3]{6.032,48.580002,-1.277});
...
Transform126->setTranslation(new float[3]{6.032,48.580002,-1.277});
...
ImageTexture130->setUSE("MiTextureAtlas");
...
HAnimJoint134->setCenter(new float[3]{6.032,40.810001,-1.412});
...
Transform136->setTranslation(new float[3]{6.032,40.810001,-1.412});
...
ImageTexture140->setUSE("MiTextureAtlas");
...
HAnimJoint144->setCenter(new float[3]{6.934,33.959999,-1.108});
...
Transform146->setTranslation(new float[3]{6.934,33.959999,-1.108});
...
ImageTexture150->setUSE("MiTextureAtlas");
...
HAnimJoint154->setCenter(new float[3]{-6.032,48.580002,-1.277});
...
Transform156->setTranslation(new float[3]{-6.032,48.580002,-1.277});
...
ImageTexture160->setUSE("MiTextureAtlas");
...
HAnimJoint164->setCenter(new float[3]{-6.032,40.810001,-1.412});
...
Transform166->setTranslation(new float[3]{-6.032,40.810001,-1.412});
...
ImageTexture170->setUSE("MiTextureAtlas");
...
HAnimJoint174->setCenter(new float[3]{-6.934,33.959999,-1.108});
...
Transform176->setTranslation(new float[3]{-6.934,33.959999,-1.108});
...
ImageTexture180->setUSE("MiTextureAtlas");
...
HAnimJoint184->setCenter(new float[3]{0,35.310001,-2.314});
...
Transform186->setTranslation(new float[3]{0,35.310001,-2.314});
...
ImageTexture190->setUSE("MiTextureAtlas");
...
HAnimJoint194->setCenter(new float[3]{0,35.310001,-2.314});
...
Transform196->setTranslation(new float[3]{0,35.310001,-2.314});
...
ImageTexture200->setUSE("MiTextureAtlas");

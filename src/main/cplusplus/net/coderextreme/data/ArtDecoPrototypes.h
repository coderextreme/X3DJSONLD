...
Material17.setDiffuseColor(new float[]{0.282435,0.085159,0.134462});
Material17.setShininess(0.127273);
Material17.setSpecularColor(new float[]{0.276305,0.11431,0.139857});
...
Material20.setDiffuseColor(new float[]{0.685208,0.134679,0.332385});
Material20.setShininess(0.071429);
Material20.setSpecularColor(new float[]{0.122449,0.050035,0.050035});
...
Material23.setDiffuseColor(new float[]{0.536861,0.0529,0.245479});
Material23.setShininess(0.832432);
Material23.setSpecularColor(new float[]{0.805292,0.765198,0.747416});
...
Material26.setDiffuseColor(new float[]{1.0,0.452381,0.40339});
Material26.setShininess(0.902703);
Material26.setSpecularColor(new float[]{0.686486,0.396903,0.419275});
...
Material29.setDiffuseColor(new float[]{0.748016,0.298362,0.342624});
Material29.setShininess(0.69697);
Material29.setSpecularColor(new float[]{0.345455,0.345455,0.345455});
...
Material32.setDiffuseColor(new float[]{0.945455,0.318988,0.321717});
Material32.setShininess(0.018182);
Material32.setSpecularColor(new float[]{0.072727,0.021705,0.010732});
...
Material35.setDiffuseColor(new float[]{0.228655,0.195513,0.425484});
Material35.setShininess(0.542553);
Material35.setSpecularColor(new float[]{0.324504,0.404255,0.404255});
...
Material38.setDiffuseColor(new float[]{0.200348,0.100857,0.320833});
Material38.setShininess(0.133333);
Material38.setSpecularColor(new float[]{0.311358,0.387879,0.387879});
...
Material41.setDiffuseColor(new float[]{0.330519,0.3389,0.6});
Material41.setShininess(0.787879);
Material41.setSpecularColor(new float[]{0.290909,0.290909,0.290909});
...
Material44.setDiffuseColor(new float[]{0.237059,0.096273,0.215625});
Material44.setShininess(0.133333);
Material44.setSpecularColor(new float[]{0.311358,0.387879,0.387879});
...
Material47.setDiffuseColor(new float[]{0.304,0.09025,0.207364});
Material47.setShininess(0.072727);
Material47.setSpecularColor(new float[]{0.6665,0.579046,0.830303});
...
Material50.setDiffuseColor(new float[]{0.335631,0.207672,0.238304});
Material50.setEmissiveColor(new float[]{0.010638,0.010638,0.010638});
Material50.setShininess(0.021277);
Material50.setSpecularColor(new float[]{0.198631,0.075403,0.138803});
...
Material53.setDiffuseColor(new float[]{0.876873,0.14715,0.00856});
Material53.setShininess(0.076531);
Material53.setSpecularColor(new float[]{0.193878,0.029416,0.029416});
...
Material56.setDiffuseColor(new float[]{0.794445,0.249425,0.0});
Material56.setShininess(0.551515);
Material56.setSpecularColor(new float[]{0.62904,0.194211,0.033663});
...
Material59.setDiffuseColor(new float[]{0.510609,0.17264,0.059872});
Material59.setShininess(0.933333);
Material59.setSpecularColor(new float[]{0.533333,0.533333,0.533333});
...
Material62.setDiffuseColor(new float[]{0.914894,0.444404,0.348914});
Material62.setShininess(0.12766);
Material62.setSpecularColor(new float[]{0.345745,0.143066,0.0});
...
Material65.setDiffuseColor(new float[]{0.876873,0.323147,0.199564});
Material65.setShininess(0.80102);
Material65.setSpecularColor(new float[]{0.816327,0.278677,0.278677});
...
Material68.setDiffuseColor(new float[]{0.515625,0.315496,0.252441});
Material68.setShininess(0.933333);
Material68.setSpecularColor(new float[]{0.533333,0.533333,0.533333});
...
Material71.setDiffuseColor(new float[]{0.0,0.346939,0.253624});
Material71.setShininess(0.316327);
Material71.setSpecularColor(new float[]{0.0,0.311074,0.357143});
...
Material74.setDiffuseColor(new float[]{0.0,0.251004,0.239248});
Material74.setShininess(0.060606);
Material74.setSpecularColor(new float[]{0.177935,0.249369,0.229278});
...
Material77.setDiffuseColor(new float[]{0.228298,0.385771,0.186794});
Material77.setShininess(0.393939);
Material77.setSpecularColor(new float[]{0.200464,0.300145,0.293518});
...
Material80.setDiffuseColor(new float[]{0.315389,0.544,0.258052});
Material80.setShininess(0.509389);
Material80.setSpecularColor(new float[]{0.456,0.456,0.456});
...
Material83.setDiffuseColor(new float[]{0.251104,0.312562,0.201724});
Material83.setShininess(0.086735);
Material83.setSpecularColor(new float[]{0.209184,0.113842,0.111328});
...
Material86.setDiffuseColor(new float[]{0.392348,0.456,0.417708});
Material86.setShininess(0.933333);
Material86.setSpecularColor(new float[]{0.533333,0.533333,0.533333});
...
Material89.setDiffuseColor(new float[]{1.0,0.854922,0.0});
Material89.setShininess(1);
Material89.setSpecularColor(new float[]{0.872449,0.247119,0.254214});
...
Material92.setDiffuseColor(new float[]{0.795918,0.505869,0.093315});
Material92.setShininess(0.397959);
Material92.setSpecularColor(new float[]{0.923469,0.428866,0.006369});
...
Material95.setDiffuseColor(new float[]{0.331633,0.296582,0.279057});
Material95.setShininess(0.096939);
Material95.setSpecularColor(new float[]{0.311224,0.25183,0.133042});
...
Material98.setDiffuseColor(new float[]{0.345455,0.163262,0.122622});
Material98.setShininess(0.048649);
Material98.setSpecularColor(new float[]{0.212121,0.107475,0.0});
...
Material101.setDiffuseColor(new float[]{0.277281,0.104336,0.0799});
Material101.setShininess(0.09697);
Material101.setSpecularColor(new float[]{0.305587,0.141916,0.270572});
...
Material104.setDiffuseColor(new float[]{0.087034,0.025888,0.0});
Material104.setShininess(0.045918);
Material104.setSpecularColor(new float[]{0.224138,0.104091,0.104091});
...
Material107.setSpecularColor(new float[]{0.293243,0.297387,0.290421});
...
Material110.setDiffuseColor(new float[]{0.236364,0.236364,0.236364});
Material110.setShininess(0.054546);
Material110.setSpecularColor(new float[]{0.29697,0.245839,0.295962});
...
Material113.setDiffuseColor(new float[]{0.38087,0.382957,0.417708});
Material113.setShininess(0.933333);
Material113.setSpecularColor(new float[]{0.533333,0.533333,0.533333});
...
Material116.setDiffuseColor(new float[]{0.610811,0.610811,0.610811});
Material116.setShininess(0.897297);
Material116.setSpecularColor(new float[]{0.767568,0.756757,0.764964});
...
Material119.setSpecularColor(new float[]{0.2,0.2,0.2});
...
Anchor120.setParameter(new CString[]{CString("target=_blank")}, 1);
Anchor120.setUrl(new CString[]{CString("../data/ArtDecoExamples.json"), CString("../data/ArtDecoExamples.x3d"), CString("ArtDecoExamples.json"), CString("ArtDecoExamples.x3d")}, 4);
...
Text& Text124 =  Text();
Text124.setString(new CString[]{CString("ArtDecoExamples.x3d"), CString("is a Materials Prototype declaration file."), CString(""), CString("For an example scene using these node,"), CString("click this text and view"), CString("ArtDecoExamples.x3d")}, 6);
CFontStyle& FontStyle125 =  CFontStyle();
FontStyle125.setJustify(new CString[]{CString("MIDDLE"), CString("MIDDLE")}, 2);

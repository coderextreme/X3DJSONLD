...
Text& Text124 =  Text();
Text124.setString(new CString[]{CString("ArtDecoExamples.x3d"), CString("is a Materials Prototype declaration file."), CString("For an example scene using these node,"), CString("click this text and view"), CString("ArtDecoExamples.x3d")}, 5);

...
meta11.setContent(CString("../Poses/images/HAnimPoseExampleKoreanCharacter12Sun.png"));
...
meta15.setContent(CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter12Sun.x3d"));
...
WorldInfo22.setTitle(CString("KoreanCharacter12Sun.x3d"));
...
Viewpoint24.setDescription(CString("Sun"));
Viewpoint24.setPosition(new float[]{0,1,3});
Scene21.addChild(&Viewpoint24);

HAnimHumanoid& HAnimHumanoid25 =  HAnimHumanoid();
HAnimHumanoid25.X3DNode::setName(CString("Sun"));
HAnimHumanoid25.setDEF(CString("hanim_Sun"));
...
HAnimJoint33.setCenter(new float[]{0,29.860001,-0.4567});
...
Transform35.setTranslation(new float[]{0,29.860001,-0.4567});
Shape& Shape36 =  Shape();
...
ImageTexture39.setDEF(CString("SunTextureAtlas"));
ImageTexture39.setUrl(new CString[]{CString("images/Sun.png"), CString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Sun.png")}, 2);
...
HAnimJoint43.setCenter(new float[]{2.955,28.940001,-0.5218});
...
Transform45.setTranslation(new float[]{2.955,28.940001,-0.5218});
Shape& Shape46 =  Shape();
...
ImageTexture49.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint53.setCenter(new float[]{2.948,16.459999,-0.5275});
...
Transform55.setTranslation(new float[]{2.948,16.459999,-0.5275});
Shape& Shape56 =  Shape();
...
ImageTexture59.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint63.setCenter(new float[]{2.839,3.899,-0.4116});
...
Transform65.setTranslation(new float[]{2.839,3.899,-0.4116});
Shape& Shape66 =  Shape();
...
ImageTexture69.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint73.setCenter(new float[]{2.839,3.312,1.078});
...
Transform75.setTranslation(new float[]{2.839,3.312,1.078});
Shape& Shape76 =  Shape();
...
ImageTexture79.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint83.setCenter(new float[]{-2.955,28.940001,-0.5218});
...
Transform85.setTranslation(new float[]{-2.955,28.940001,-0.5218});
Shape& Shape86 =  Shape();
...
ImageTexture89.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint93.setCenter(new float[]{-2.948,16.459999,-0.5275});
...
Transform95.setTranslation(new float[]{-2.948,16.459999,-0.5275});
Shape& Shape96 =  Shape();
...
ImageTexture99.setUSE(CString("SunTextureAtlas"));
...
Coordinate101.setPoint(new float[]{-1.375,-5.834,-1.193,-1.477,-4.137,-1.195,-1.952,-4.672,0.1143,-0.6966,-12.16,-0.8887,0.0964,-12.16,-1.304,-0.0075,-6.489,-1.984,0.9748,-12.16,-0.8887,1.329,-6.244,-1.314,1.339,-12.16,0.1054,1.761,-6.229,0.1143,0.9748,-12.16,0.9689,1.217,-6.865,1.222,0.0964,-12.16,1.384,-0.0075,-7.096,1.879,-0.6966,-12.16,0.9689,-1.312,-6.004,1.225,-1.06,-12.16,0.1054,-1.831,0.0045,0.1143,-1.301,0.0045,-1.198,-0.9277,1.148,-0.902,-1.353,1.148,0.1143,-0.0071,0.0045,-1.771,-0.0071,1.148,-1.327,1.396,0.0045,-1.198,1.02,1.148,-0.902,1.885,0.0045,0.1143,1.445,1.148,0.1143,1.396,0.0045,1.551,1.02,1.148,1.396,-0.0071,0.0045,2.125,-0.0071,1.148,1.821,-1.301,0.0045,1.551,-0.9277,1.148,1.396,-0.0071,2.106,0.1143,-0.7952,-13.2,0.1143,-0.5053,-13.2,-0.6746,-0.5053,-13.2,0.749,0.0941,-13.2,1.08,0.7943,-13.2,0.749,1.084,-13.2,0.1143,0.7943,-13.2,-0.6746,0.0941,-13.2,-1.006,0.0941,-13.94,0.1143,-1.319,-1.205,-1.195,-1.928,-1.333,0.1143,0.0092,-1.051,-1.85,-0.0075,-3.792,-2.125,1.423,-1.205,-1.195,1.386,-4.758,-1.344,1.952,-1.333,0.1143,1.391,-1.333,1.308,-0.0071,-1.333,1.881,-1.326,-1.333,1.308,0.0957,-10.22,-1.525,-0.8601,-10.22,-0.9874,1.1,-10.22,-1.026,1.478,-10.22,0.1083,1.065,-10.22,1.051,0.0957,-10.22,1.545,-0.8407,-10.22,1.052,-1.283,-10.22,0.1083}, 183);
IndexedFaceSet100.setCoord(&Coordinate101);

TextureCoordinate& TextureCoordinate102 =  TextureCoordinate();
TextureCoordinate102.setPoint(new float[]{0.9287,0.342,0.9261,0.3817,0.9166,0.3743,0.9312,0.2839,0.9471,0.2839,0.9471,0.3395,0.9648,0.2839,0.9653,0.3367,0.9721,0.2839,0.9756,0.3608,0.9668,0.3526,0.9471,0.3496,0.9261,0.3638,0.9239,0.2839,0.9178,0.4416,0.9263,0.4416,0.9323,0.4565,0.9255,0.4565,0.9471,0.4416,0.9471,0.4565,0.9697,0.4416,0.9637,0.4565,0.9783,0.4416,0.9705,0.4565,0.9471,0.4689,0.932,0.2704,0.937,0.2704,0.9471,0.2704,0.959,0.2704,0.964,0.2704,0.9471,0.2608,0.9261,0.428,0.9162,0.4243,0.9474,0.428,0.9471,0.3767,0.9684,0.428,0.9669,0.3711,0.9771,0.4243,0.9678,0.4243,0.9471,0.4243,0.9259,0.4243,0.9467,0.3066,0.9291,0.3066,0.9659,0.3066,0.9763,0.3066,0.967,0.3066,0.9459,0.3066,0.9267,0.3066,0.9183,0.3066}, 98);
...
HAnimJoint103.setCenter(new float[]{-2.839,3.899,-0.4116});
...
Transform105.setTranslation(new float[]{-2.839,3.899,-0.4116});
...
ImageTexture109.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint113.setCenter(new float[]{-2.839,3.312,1.078});
...
Transform115.setTranslation(new float[]{-2.839,3.312,1.078});
...
ImageTexture119.setUSE(CString("SunTextureAtlas"));
...
,0.0183,0.2887,0.0595,0.2029,0.9339,0.9522,0.9339,0.9254,0.9339,0.9014,0.9339,0.8697,0.9832,0.9254,0.9789,0.9522,0.9339,0.9904,0.9656,0.9806,0.9857,0.8697,0.9861,0.9014,0.8846,0.9254,0.8818,0.9014,0.9023,0.9806,0.889,0.9522,0.8822,0.8697,0.1368,0.0198,0.172,0.0181,0.1989,0.0212,0.1959,0.3397,0.233,0.3209,0.1086,0.051,0.1073,0.0299,0.1066,0.0253,0.1188,0.3009,0.1607,0.3056,0.042,0.3397,0.0049,0.3208,0.0774,0.3058,0.9339,0.8425,0.9842,0.8425,0.1053,0.0075,0.8836,0.8425,0.1925,0.3379,0.0929,0.0472,0.0926,0.0413,0.0916,0.0386,0.0732,0.0453,0.0548,0.052,0.0558,0.0548,0.0593,0.0595,0.0051,0.3217,0.0786,0.3181,0.1161,0.313,0.1637,0.3136,0.8849,0.8425,0.9342,0.8425,0.9342,0.8153,0.8926,0.8153,0.9835,0.8425,0.9758,0.8153,0.1064,0.0254,0.1052,0.0081,0.09,0.0108,0.0907,0.0265,0.1052,0.0081,0.1064,0.0254,0.0907,0.0265,0.09,0.0108,0.1068,0.0747,0.1086,0.0517,0.0941,0.0542,0.0982,0.0753,0.1071,0.03,0.0934,0.041,0.1071,0.03,0.1086,0.0517,0.0941,0.0542,0.0934,0.041,0.1068,0.0747,0.0982,0.0754,0.0683,0.0723,0.0739,0.0833,0.0866,0.0821,0.097,0.0748,0.0943,0.0628}, 232);
...
HAnimJoint123.setCenter(new float[]{0,29.860001,-0.4567});
...
Transform125.setTranslation(new float[]{0,29.860001,-0.4567});
...
ImageTexture129.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint133.setCenter(new float[]{6.077,45.880001,-1.319});
...
Transform135.setTranslation(new float[]{6.077,45.880001,-1.319});
...
ImageTexture139.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint143.setCenter(new float[]{7.076,38.529999,-1.385});
...
Transform145.setTranslation(new float[]{7.076,38.529999,-1.385});
...
ImageTexture149.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint153.setCenter(new float[]{6.946,30.889999,-1.308});
...
Transform155.setTranslation(new float[]{6.946,30.889999,-1.308});
...
ImageTexture159.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint163.setCenter(new float[]{-6.077,45.880001,-1.319});
...
Transform165.setTranslation(new float[]{-6.077,45.880001,-1.319});
...
ImageTexture169.setUSE(CString("SunTextureAtlas"));
...
954,-0.506,-0.8653,0.02,-0.506,-1.277,0.9426,-4.179,-0.7253,1.041,-0.506,-0.8653,1.43,-0.6344,0.0721,1.323,-4.321,0.0723,1.018,-0.6344,0.9221,0.0236,-0.6344,1.334,-0.9707,-0.6344,0.9221,-1.063,-7.046,0.0729,-0.7325,-7.042,-0.4818,0.8456,-7.281,-0.5402,1.188,-7.284,0.0721}, 198);
IndexedFaceSet180.setCoord(&Coordinate181);

TextureCoordinate& TextureCoordinate182 =  TextureCoordinate();
TextureCoordinate182.setPoint(new float[]{0.6214,1.732,0.7319,1.729,0.7045,1.73,0.6763,1.731,0.6737,1.57,0.6695,1.581,0.6525,1.578,0.6596,1.565,0.672,1.648,0.5944,1.731,0.669,1.585,0.692,1.585,0.6985,1.654,0.6909,1.571,0.7076,1.568,0.7136,1.579,0.6917,1.581,0.7251,1.66,0.7149,1.583,0.7334,1.58,0.5663,1.733,0.5738,1.66,0.5479,1.661,0.7502,1.661,0.5667,1.581,0.5849,1.584,0.6006,1.655,0.6078,1.585,0.6259,1.57,0.6303,1.581,0.6081,1.582,0.6088,1.572,0.6784,1.72,0.6987,1.718,0.715,1.723,0.7248,1.738,0.7566,1.727,0.6922,1.739,0.7083,1.553,0.7208,1.562,0.7017,1.557,0.69,1.561,0.6778,1.559,0.6394,1.565,0.6467,1.578,0.6707,1.555,0.6891,1.549,0.5851,1.722,0.5744,1.738,0.5383,1.729,0.6749,1.719,0.7035,1.718,0.732,1.717,0.7566,1.715,0.6497,1.584,0.73,1.574,0.6021,1.717,0.6226,1.719,0.6477,1.727,0.6092,1.739,0.5919,1.569,0.5792,1.563,0.5915,1.554,0.5975,1.558,0.6219,1.559,0.6284,1.556,0.6095,1.561,0.6103,1.55,0.5395,1.716,0.5658,1.721,0.5946,1.722,0.6275,1.648,0.6242,1.723,0.6504,1.719,0.6499,1.645,0.5702,1.575,0.5861,1.579,0.6308,1.586,0.6503,1.731,0.6767,1.711,0.7018,1.71,0.7234,1.719,0.7395,1.728,0.577,1.712,0.5523,1.731,0.5995,1.706,0.6239,1.709,0.6527,1.716}, 176);
...
HAnimJoint183.setCenter(new float[]{-6.946,30.889999,-1.308});
...
Transform185.setTranslation(new float[]{-6.946,30.889999,-1.308});
...
ImageTexture189.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint193.setCenter(new float[]{0.05249,34.130001,-0.468});
...
Transform195.setTranslation(new float[]{0.05249,34.130001,-0.468});
...
ImageTexture199.setUSE(CString("SunTextureAtlas"));
...
HAnimJoint203.setCenter(new float[]{0,51.25,-1.124});
...
Transform205.setTranslation(new float[]{0,51.25,-1.124});
...
ImageTexture209.setUSE(CString("SunTextureAtlas"));
...
EXPORT231.setAS(CString("KoreanCharacter12Sun"));
EXPORT231.setLocalDEF(CString("hanim_Sun"));

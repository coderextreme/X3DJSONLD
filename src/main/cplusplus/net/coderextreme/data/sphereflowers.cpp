...
ExternProtoDeclare21.setUrl(new CString[]{CString("../data/flowerproto.x3d#FlowerProto"), CString("https://coderextreme.net/X3DJSONLD/src/main/data/flowerproto.x3d#FlowerProto")}, 2);
field& field22 =  field();

...
Background9->setBackUrl(new CString[2]{"../resources/images/all_probes/stpeters_cross/stpeters_back.png","https://coderextreme.net/X3DJSONLD/src/main/resourcesimages/all_probes/stpeters_cross/stpeters_back.png"}, 2);
Background9->setBottomUrl(new CString[2]{"../resources/images/all_probes/stpeters_cross/stpeters_bottom.png","https://coderextreme.net/X3DJSONLD/src/main/resourcesimages/all_probes/stpeters_cross/stpeters_bottom.png"}, 2);
Background9->setFrontUrl(new CString[2]{"../resources/images/all_probes/stpeters_cross/stpeters_front.png","https://coderextreme.net/X3DJSONLD/src/main/resourcesimages/all_probes/stpeters_cross/stpeters_front.png"}, 2);
Background9->setLeftUrl(new CString[2]{"../resources/images/all_probes/stpeters_cross/stpeters_left.png","https://coderextreme.net/X3DJSONLD/src/main/resourcesimages/all_probes/stpeters_cross/stpeters_left.png"}, 2);
Background9->setRightUrl(new CString[2]{"../resources/images/all_probes/stpeters_cross/stpeters_right.png","https://coderextreme.net/X3DJSONLD/src/main/resourcesimages/all_probes/stpeters_cross/stpeters_right.png"}, 2);
Background9->setTopUrl(new CString[2]{"../resources/images/all_probes/stpeters_cross/stpeters_top.png","https://coderextreme.net/X3DJSONLD/images/src/main/resourcesall_probes/stpeters_cross/stpeters_top.png"}, 2);
...
ExternProtoDeclare11->setUrl(new CString[1]{"../data/flowerproto.json#FlowerProto"}, 1);
...
fieldValue19->setValue("\"../shaders/x_ite.fs\"");
...
Group10->addChildren(TimeSensor26);

CSound* Sound27 = (CSound *)m_pScene.createNode("Sound");
Sound27->setMaxBack(100);
Sound27->setMaxFront(100);
Sound27->setMinBack(20);
Sound27->setMinFront(20);
CAudioClip* AudioClip28 = (CAudioClip *)m_pScene.createNode("AudioClip");
AudioClip28->setDEF("AudioClip");
AudioClip28->setDescription("Chandubabamusic #1");
AudioClip28->setUrl(new CString[1]{"../resources/chandubabamusic1.wav"}, 1);
Sound27->setSource(AudioClip28);

Group10->addChildren(Sound27);

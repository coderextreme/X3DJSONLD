...
Viewpoint15.setPosition(new float[]{0,1,-2});
Viewpoint15.setCenterOfRotation(new float[]{0,1,0});
...
Viewpoint24.setPosition(new float[]{-2.6,1.5,1});
...
Viewpoint25.setPosition(new float[]{-5,1.5,1});
Viewpoint25.setOrientation(new float[]{0,1,0,1.5708});
...
Viewpoint26.setPosition(new float[]{-10,1.5,1});
...
Viewpoint27.setPosition(new float[]{-20,1.5,1});
...
Viewpoint28.setPosition(new float[]{-10,1.5,1});
Viewpoint28.setOrientation(new float[]{0,1,0,1.5708});
Viewpoint28.setCenterOfRotation(new float[]{0,0.8,0});
...
Viewpoint29.setPosition(new float[]{0,1.5,-5});
Viewpoint29.setOrientation(new float[]{0,1,0,3.14});
...
Viewpoint30.setPosition(new float[]{0,1.5,-2.5});
Viewpoint30.setOrientation(new float[]{0,1,0,3.14});
Viewpoint30.setCenterOfRotation(new float[]{0,1.5,0});
...
Viewpoint31.setPosition(new float[]{0,1.5,-20});
Viewpoint31.setOrientation(new float[]{0,1,15,3.14});
Viewpoint31.setCenterOfRotation(new float[]{0,1.5,0});
...
Viewpoint32.setPosition(new float[]{0,3.5,0});
Viewpoint32.setOrientation(new float[]{1,0,0,-1.5708});
Viewpoint32.setCenterOfRotation(new float[]{0,1.5,0});
...
Color44.setColor(new float[]{1,0,0,0,0.6,0,0,0,1}, 9);
IndexedLineSet43.setColor(&Color44);

Coordinate& Coordinate45 =  Coordinate();
Coordinate45.setPoint(new float[]{0,0,0,1,0,0,0,1,0,0,0,1}, 12);
...
HAnimJoint62.setSkinCoordWeight(new float[]{1,1,1}, 3);
...
HAnimJoint63.setSkinCoordWeight(new float[]{1,1,1,1}, 4);
...
HAnimJoint64.setSkinCoordWeight(new float[]{1,1,1,1,1,1,1,1,1}, 9);
...
HAnimDisplacer90.setDisplacements(new float[]{0,0.15,0,0,0,0.15,-0.1,0,0.15,0.1,0,0.05,0,-0.02,0.05,-0.15,0,0,-0.05,0,0,0.15,0,0,0.05,0,0,0,0,-0.15}, 30);

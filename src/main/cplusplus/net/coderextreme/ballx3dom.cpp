...
meta10.setContent(CString("ballx3dom.x3d"));
...
ShaderPart39.setUrl(new CString[]{CString("../shaders/x3dom.vs"), CString("https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom.vs")}, 2);

...
meta9.setContent(CString("https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/Buildings/ArchHalf.x3d"));
head1.addMeta(&meta9);
...
WorldInfo13.setTitle(CString("ArchHalf.x3d"));
Scene12.addChild(&WorldInfo13);

Shape& Shape14 =  Shape();
Shape14.setDEF(CString("Arch"));
//note that convex='false' (meaning concave geometry) is crucial for this IFS of a geometric chord to render properly
IndexedFaceSet& IndexedFaceSet15 =  IndexedFaceSet();
IndexedFaceSet15.setDEF(CString("ArchIndex"));
...
Material18.setDEF(CString("MaterialNode"));
Material18.setDiffuseColor(new float[]{1,0.75,0.25});

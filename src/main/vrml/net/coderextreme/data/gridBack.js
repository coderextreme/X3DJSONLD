...
X3D0.version = "3.0";
let Shape2 = browser.currentScene.createNode("Shape");
Shape2.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape2.bboxSize = new SFVec3f(new float[-1,-1,-1]);
let Appearance3 = browser.currentScene.createNode("Appearance");
let Material4 = browser.currentScene.createNode("Material");

...
Text124.string = new X3D.MFString([new X3D.SFString("ArtDecoExamples.x3d"), new X3D.SFString("is a Materials Prototype declaration file."), new X3D.SFString("For an example scene using these node,"), new X3D.SFString("click this text and view"), new X3D.SFString("ArtDecoExamples.x3d")]);

...
scene.addMetaData("reference", "http://en.wikipedia.org/wiki/Hello_world");
...
scene.addMetaData("reference", "http://en.wikibooks.org/w/index.php?title=Computer_Programming/Hello_world");
scene.addMetaData("reference", "http://www.HelloWorldExample.net");
...
scene.addMetaData("reference", "http://X3dGraphics.com/examples/X3dForAdvancedModeling/HelloWorldScenes/HelloWorld.x3d");
scene.addMetaData("identifier", "http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter01TechnicalOverview/HelloWorld.x3d");

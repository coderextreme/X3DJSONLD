...
Text123.string = new X3D.MFString([new X3D.SFString("LOA1_SwimmingFlutterKickAnimation.x3d"), new X3D.SFString("defines a prototype"), new X3D.SFString("for animating a humanoid."), new X3D.SFString("Click text to see example.")]);

...
scene.addMetaData("title", "arc4.x3d");
...
Script50.getField("startnode")Script49YYY.field = new X3D.MFNode();

Script51.getField("endnode")Script49YYY.field = new X3D.MFNode();

Script52.getField("position")let Transform53 = browser.currentScene.createNode("Transform");
Transform53.USE = "DECLx3dconnector_connector1_trans";
field52YYY.children = new X3D.MFNode();

field52ZZZ.children[0] = Transform53;

Script49YYY.field = new X3D.MFNode();

Script54.getField("rotscale")let Transform55 = browser.currentScene.createNode("Transform");
...
Script56.getField("set_startpoint")Script49YYY.field = new X3D.MFNode();

Script57.getField("set_endpoint")Script49YYY.field = new X3D.MFNode();

...
scene.addMetaData("title", "KoreanCharacter05Ju.x3d");
scene.addMetaData("creator", "Jin Hoon Lee and Min Joo Lee");
scene.addMetaData("translator", "Chul Hee Jung and Myeong Won Lee");
scene.addMetaData("created", "31 March 2011");
scene.addMetaData("translated", "1 November 2014");
scene.addMetaData("modified", "5 November 2025");
scene.addMetaData("warning", "HAnimJoint and HAnimSegment names upgraded to HAnim2 but graph topology has inconsistencies that do not match loa=1 specification hierarchy");
scene.addMetaData("description", "Articulated 3D game character designed with a general graphics tool, then converted into an X3D HAnim model.");
scene.addMetaData("Image", "../Poses/images/HAnimPoseExampleKoreanCharacter05Ju.png");
scene.addMetaData("reference", "KoreanCharacter00ReadMe.txt");
scene.addMetaData("reference", "../KoreanCharacterHumanMotion_Infotech2014_140706.pdf");
scene.addMetaData("reference", "KoreanCharactersIllustrated.pdf");
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter05Ju.x3d");
scene.addMetaData("generator", "3DS MAX, http://www.autodesk.com/products/autodesk-3ds-max/overview");
scene.addMetaData("generator", "Suwon University HAnim Editor");
...
WorldInfo22.title = "KoreanCharacter05Ju.x3d";
...
browser.currentScene.children[1] = NavigationInfo23;

let Viewpoint24 = browser.currentScene.createNode("Viewpoint");
Viewpoint24.centerOfRotation = new X3D.SFVec3f([0,1,0]);
Viewpoint24.description = "Ju";
Viewpoint24.position = new X3D.SFVec3f([0,1,3]);
browser.currentScene.children[2] = Viewpoint24;

let HAnimHumanoid25 = browser.currentScene.createNode("HAnimHumanoid");
HAnimHumanoid25.name = "Ju";
HAnimHumanoid25.DEF = "hanim_Ju";
HAnimHumanoid25.scale = new X3D.SFVec3f([0.0225,0.0225,0.0225]);
...
MetadataString27.value = new X3D.MFString([new X3D.SFString("Chul Hee Jung and Myeong Won Lee")]);
MetadataSet26.value = new X3D.MFNode();

MetadataSet26XXX.value[0] = MetadataString27;

let MetadataString28 = browser.currentScene.createNode("MetadataString");
MetadataString28.name = "authorEmail";
MetadataString28.value = new X3D.MFString([new X3D.SFString("myeongwonlee@gmail.com")]);
value[1] = MetadataString28;

let MetadataString29 = browser.currentScene.createNode("MetadataString");
MetadataString29.name = "creationDate";
MetadataString29.value = new X3D.MFString([new X3D.SFString("31 March 2011")]);
value[2] = MetadataString29;

let MetadataString30 = browser.currentScene.createNode("MetadataString");
MetadataString30.name = "gender";
MetadataString30.value = new X3D.MFString([new X3D.SFString("female")]);
value[3] = MetadataString30;

let MetadataFloat31 = browser.currentScene.createNode("MetadataFloat");
MetadataFloat31.name = "height";
MetadataFloat31.value = new X3D.MFFloat([1.5]);
value[4] = MetadataFloat31;

let MetadataString32 = browser.currentScene.createNode("MetadataString");
MetadataString32.name = "humanoidVersion";
MetadataString32.value = new X3D.MFString([new X3D.SFString("2.0")]);
value[5] = MetadataString32;

HAnimHumanoid25.metadata = new X3D.SFNode();

HAnimHumanoid25XXX.metadata[0] = MetadataSet26;
...
HAnimJoint33.center = new X3D.SFVec3f([0,36,-0.008798]);
...
HAnimSegment34.DEF = "hanim_sacrum";
let Transform35 = browser.currentScene.createNode("Transform");
Transform35.translation = new X3D.SFVec3f([0,36,-0.008798]);
...
HAnimSegment34ZZZ.children[0] = Transform35;
...
HAnimJoint43.DEF = "hanim_l_hip";
HAnimJoint43.center = new X3D.SFVec3f([3.22,33.619999,-0.2832]);
...
HAnimSegment44.DEF = "hanim_l_thigh";
let Transform45 = browser.currentScene.createNode("Transform");
Transform45.translation = new X3D.SFVec3f([3.22,33.619999,-0.2832]);
...
Material48.diffuseColor = new X3D.SFColor([0.588,0.588,0.588]);
material = Material48;

let ImageTexture49 = browser.currentScene.createNode("ImageTexture");
ImageTexture49.USE = "JuTextureAtlas";
texture = ImageTexture49;

appearance = Appearance47;

let IndexedFaceSet50 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet50.coordIndex = new X3D.MFInt32([33,32,31,-1,31,30,29,-1,31,29,28,-1,33,31,28,-1,34,33,28,-1,0,1,8,-1,8,7,0,-1,1,2,9,-1,9,8,1,-1,2,3,10,-1,10,9,2,-1,3,4,11,-1,11,10,3,-1,4,5,12,-1,12,11,4,-1,5,6,13,-1,13,12,5,-1,6,0,7,-1,7,13,6,-1,7,8,15,-1,15,14,7,-1,8,9,16,-1,16,15,8,-1,9,10,17,-1,17,16,9,-1,10,11,18,-1,18,17,10,-1,11,12,19,-1,19,18,11,-1,12,13,20,-1,20,19,12,-1,13,7,14,-1,14,20,13,-1,14,15,22,-1,22,21,14,-1,15,16,23,-1,23,22,15,-1,16,17,24,-1,24,23,16,-1,17,18,25,-1,25,24,17,-1,18,19,26,-1,26,25,18,-1,19,20,27,-1,27,26,19,-1,20,14,21,-1,21,27,20,-1,28,29,1,-1,1,0,28,-1,29,30,2,-1,2,1,29,-1,30,31,3,-1,3,2,30,-1,31,32,4,-1,4,3,31,-1,32,33,5,-1,5,4,32,-1,33,34,6,-1,6,5,33,-1,34,28,0,-1,0,6,34,-1,21,22,35,-1,35,36,21,-1,22,23,37,-1,37,35,22,-1,23,24,38,-1,38,37,23,-1,24,25,39,-1,39,38,24,-1,25,26,40,-1,40,39,25,-1,26,27,41,-1,41,40,26,-1,27,21,36,-1,36,41,27,-1,36,35,42,-1,42,43,36,-1,35,37,44,-1,44,42,35,-1,37,38,45,-1,45,44,37,-1,38,39,46,-1,46,45,38,-1,39,40,47,-1,47,46,39,-1,40,41,48,-1,48,47,40,-1,41,36,43,-1,43,48,41,-1,43,42,49,-1,42,44,49,-1,44,45,49,-1,45,46,49,-1,46,47,49,-1,47,48,49,-1,48,43,49,-1]);
IndexedFaceSet50.creaseAngle = 1.57;
= browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate52.point = new X3D.MFVec2f([0.7387,0.5078,0.7519,0.5078,0.7092,0.5078,0.6855,0.5078,0.6855,0.5078,0.7092,0.5078,0.7387,0.5078,0.7641,0.4868,0.7464,0.4472,0.7641,0.4472,0.7464,0.4868,0.7065,0.4472,0.7065,0.4868,0.6788,0.4472,0.6788,0.4868,0.6788,0.4472,0.6788,0.4868,0.7065,0.4472,0.7065,0.4868,0.7464,0.4472,0.7464,0.4868,0.7464,0.3861,0.7641,0.3861,0.7065,0.3861,0.6788,0.3861,0.6788,0.3861,0.7065,0.3861,0.7464,0.3861,0.743,0.3252,0.7584,0.3252,0.7085,0.3252,0.6882,0.3252,0.6882,0.3252,0.7085,0.3252,0.743,0.3252,0.7383,0.2938,0.7506,0.2938,0.7107,0.2938,0.6945,0.2938,0.6945,0.2938,0.7107,0.2938,0.7383,0.2938,0.7284,0.2787,0.7342,0.2787,0.7155,0.2787,0.7079,0.2787,0.7079,0.2787,0.7155,0.2787,0.7284,0.2787,0.7197,0.2768]);
texCoord = TextureCoordinate52;

geometry = IndexedFaceSet50;
...
HAnimJoint53.center = new X3D.SFVec3f([3.454,18.67,-0.02158]);
...
Transform55.translation = new X3D.SFVec3f([3.454,18.67,-0.02158]);
...
HAnimSegment54ZZZ.children[0] = Transform55;
...
HAnimJoint63.name = "l_talocrural";
HAnimJoint63.DEF = "hanim_l_talocrural";
HAnimJoint63.center = new X3D.SFVec3f([3.467,3.522,0.118]);
...
HAnimSegment64.name = "l_talus";
HAnimSegment64.DEF = "hanim_l_talus";
let Transform65 = browser.currentScene.createNode("Transform");
Transform65.translation = new X3D.SFVec3f([3.467,3.522,0.118]);
...
HAnimSegment64ZZZ.children[0] = Transform65;
...
HAnimJoint73.DEF = "hanim_l_metatarsophalangeal_2";
HAnimJoint73.center = new X3D.SFVec3f([3.467,3.251,1.465]);
...
HAnimSegment74.DEF = "hanim_l_tarsal_proximal_phalanx_2";
let Transform75 = browser.currentScene.createNode("Transform");
Transform75.translation = new X3D.SFVec3f([3.467,3.251,1.465]);
...
HAnimJoint53ZZZ.children[1] = HAnimJoint63;

HAnimJoint43ZZZ.children[1] = HAnimJoint53;

HAnimJoint33ZZZ.children[1] = HAnimJoint43;

let HAnimJoint83 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint83.name = "r_hip";
HAnimJoint83.DEF = "hanim_r_hip";
HAnimJoint83.center = new X3D.SFVec3f([-3.22,33.619999,-0.2832]);
...
HAnimSegment84.name = "r_thigh";
HAnimSegment84.DEF = "hanim_r_thigh";
let Transform85 = browser.currentScene.createNode("Transform");
Transform85.translation = new X3D.SFVec3f([-3.22,33.619999,-0.2832]);
...
Material88.diffuseColor = new X3D.SFColor([0.588,0.588,0.588]);
material = Material88;

let ImageTexture89 = browser.currentScene.createNode("ImageTexture");
ImageTexture89.USE = "JuTextureAtlas";
texture = ImageTexture89;

appearance = Appearance87;

let IndexedFaceSet90 = browser.currentScene.createNode("IndexedFaceSet");
texCoord = TextureCoordinate92;

geometry = IndexedFaceSet90;
...
HAnimJoint93.center = new X3D.SFVec3f([-3.454,18.67,-0.02158]);
...
Transform95.translation = new X3D.SFVec3f([-3.454,18.67,-0.02158]);
...
ImageTexture99.USE = "JuTextureAtlas";
texture = ImageTexture99;

appearance = Appearance97;

let IndexedFaceSet100 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet100.coordIndex = new X3D.MFInt32([0,1,2,-1,2,3,4,-1,0,2,4,-1,0,4,5,-1,6,0,5,-1,9,10,7,-1,7,8,9,-1,12,9,8,-1,8,11,12,-1,14,12,11,-1,11,13,14,-1,16,14,13,-1,13,15,16,-1,18,16,15,-1,15,17,18,-1,20,18,17,-1,17,19,20,-1,10,20,19,-1,19,7,10,-1,21,22,10,-1,10,9,21,-1,23,21,9,-1,9,12,23,-1,24,23,12,-1,12,14,24,-1,25,24,14,-1,14,16,25,-1,26,25,16,-1,16,18,26,-1,27,26,18,-1,18,20,27,-1,22,27,20,-1,20,10,22,-1,1,0,22,-1,22,21,1,-1,2,1,21,-1,21,23,2,-1,3,2,23,-1,23,24,3,-1,4,3,24,-1,24,25,4,-1,5,4,25,-1,25,26,5,-1,6,5,26,-1,26,27,6,-1,0,6,27,-1,27,22,0,-1,8,7,28,-1,28,29,8,-1,11,8,29,-1,29,30,11,-1,13,11,30,-1,30,31,13,-1,15,13,31,-1,31,32,15,-1,17,15,32,-1,32,33,17,-1,19,17,33,-1,33,34,19,-1,7,19,34,-1,34,28,7,-1,29,28,35,-1,35,36,29,-1,30,29,36,-1,36,37,30,-1,31,30,37,-1,37,38,31,-1,32,31,38,-1,38,39,32,-1,33,32,39,-1,39,40,33,-1,34,33,40,-1,40,41,34,-1,28,34,41,-1,41,35,28,-1]);
IndexedFaceSet100.creaseAngle = 1.57;
IndexedFaceSet100.texCoordIndex = new X3D.MFInt32([0,1,2,-1,2,3,4,-1,0,2,4,-1,0,4,5,-1,6,0,5,-1,9,10,7,-1,7,8,9,-1,12,9,8,-1,8,11,12,-1,14,12,11,-1,11,13,14,-1,16,14,13,-1,13,15,16,-1,18,16,15,-1,15,17,18,-1,20,18,17,-1,17,19,20,-1,10,20,19,-1,19,7,10,-1,21,22,10,-1,10,9,21,-1,23,21,9,-1,9,12,23,-1,24,23,12,-1,12,14,24,-1,25,24,14,-1,14,16,25,-1,26,25,16,-1,16,18,26,-1,27,26,18,-1,18,20,27,-1,22,27,20,-1,20,10,22,-1,1,0,22,-1,22,21,1,-1,2,1,21,-1,21,23,2,-1,3,2,23,-1,23,24,3,-1,4,3,24,-1,24,25,4,-1,5,4,25,-1,25,26,5,-1,6,5,26,-1,26,27,6,-1,0,6,27,-1,27,22,0,-1,8,7,28,-1,28,29,8,-1,11,8,29,-1,29,30,11,-1,13,11,30,-1,30,31,13,-1,15,13,31,-1,31,32,15,-1,17,15,32,-1,32,33,17,-1,19,17,33,-1,33,34,19,-1,7,19,34,-1,34,28,7,-1,29,28,35,-1,35,36,29,-1,30,29,36,-1,36,37,30,-1,31,30,37,-1,37,38,31,-1,32,31,38,-1,38,39,32,-1,33,32,39,-1,39,40,33,-1,34,33,40,-1,40,41,34,-1,28,34,41,-1,41,35,28,-1]);
let Coordinate101 = browser.currentScene.createNode("Coordinate");
Coordinate101.point = new X3D.MFVec3f([-0.7406,0.9639,0.0216,-0.4117,0.9639,0.8655,0.3272,0.9639,1.036,0.9197,0.9639,0.5579,0.9197,0.9639,-0.3619,0.3272,0.9639,-0.8401,-0.4117,0.9639,-0.6694,-2.238,-4.201,0.0216,-1.426,-3.284,1.868,-1.219,-1.439,2.239,-2.036,-1.701,0.0216,0.6748,-3.284,2.375,0.6153,-1.439,2.686,2.01,-4.201,1.161,2.086,-1.701,0.9061,2.01,-4.913,-1.265,2.086,-1.701,-0.8628,0.6748,-4.913,-2.686,0.6153,-1.701,-2.191,-1.426,-4.913,-2.179,-1.219,-1.701,-1.744,-1.112,0.0646,1.755,-1.864,0.0646,0.0216,0.5772,0.0646,2.145,1.932,0.0646,1.051,1.932,0.0646,-0.8553,0.5772,0.0646,-1.907,-1.112,0.0646,-1.517,-2.345,-14.69,-0.0151,-1.416,-14.67,2.102,0.6712,-14.67,2.624,2.345,-14.69,1.16,2.345,-14.71,-1.342,0.6712,-14.71,-2.38,-1.416,-14.71,-1.857,-0.73,-16.18,0.0221,-0.4092,-16.17,0.7532,0.3118,-16.17,0.9337,0.89,-16.18,0.4278,0.89,-16.19,-0.4362,0.3118,-16.19,-0.7945,-0.4092,-16.19,-0.614]);
coord = Coordinate101;

let TextureCoordinate102 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate102.point = new X3D.MFVec2f([0.7637,0.172,0.755,0.172,0.7356,0.172,0.72,0.172,0.72,0.172,0.7356,0.172,0.755,0.172,0.8032,0.2271,0.7818,0.2173,0.7763,0.1976,0.7978,0.2004,0.7264,0.2173,0.728,0.1976,0.6912,0.2271,0.6892,0.2004,0.6912,0.2347,0.6892,0.2004,0.7264,0.2347,0.728,0.2004,0.7818,0.2347,0.7763,0.2004,0.7735,0.1816,0.7933,0.1816,0.729,0.1816,0.6933,0.1816,0.6933,0.1816,0.729,0.1816,0.7735,0.1816,0.806,0.339,0.7815,0.3388,0.7265,0.3388,0.6824,0.339,0.6824,0.3392,0.7265,0.3392,0.7815,0.3392,0.7634,0.3549,0.755,0.3548,0.736,0.3548,0.7207,0.3549,0.7207,0.355,0.736,0.355,0.755,0.355]);
texCoord = TextureCoordinate102;
...
HAnimJoint103.name = "r_talocrural";
HAnimJoint103.DEF = "hanim_r_talocrural";
HAnimJoint103.center = new X3D.SFVec3f([-3.679,3.522,0.118]);
...
HAnimSegment104.name = "r_talus";
HAnimSegment104.DEF = "hanim_r_talus";
let Transform105 = browser.currentScene.createNode("Transform");
Transform105.translation = new X3D.SFVec3f([-3.679,3.522,0.118]);
...
Material108.diffuseColor = new X3D.SFColor([0.588,0.588,0.588]);
material = Material108;

let ImageTexture109 = browser.currentScene.createNode("ImageTexture");
ImageTexture109.USE = "JuTextureAtlas";
texture = ImageTexture109;

appearance = Appearance107;

let IndexedFaceSet110 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet110.coordIndex = new X3D.MFInt32([1,12,11,-1,3,6,5,-1,5,4,3,-1,1,3,4,-1,4,0,1,-1,0,4,5,-1,5,2,0,-1,11,6,3,-1,3,1,11,-1,18,17,0,-1,0,2,18,-1,0,17,25,-1,25,1,0,-1,25,12,1,-1,7,11,13,-1,8,9,5,-1,5,6,8,-1,7,10,9,-1,9,8,7,-1,10,2,5,-1,5,9,10,-1,11,7,8,-1,8,6,11,-1,18,2,10,-1,10,21,18,-1,10,7,27,-1,27,21,10,-1,27,7,13,-1,12,35,37,-1,37,11,12,-1,11,37,36,-1,36,13,11,-1,20,14,17,-1,17,18,20,-1,23,25,17,-1,17,14,23,-1,16,15,14,-1,14,20,16,-1,24,23,14,-1,14,15,24,-1,15,16,29,-1,29,24,15,-1,20,18,21,-1,21,19,20,-1,26,19,21,-1,21,27,26,-1,16,20,19,-1,19,22,16,-1,28,22,19,-1,19,26,28,-1,22,28,29,-1,29,16,22,-1,36,35,31,-1,31,30,34,-1,31,34,33,-1,36,31,33,-1,36,33,32,-1,24,30,31,-1,31,23,24,-1,23,31,35,-1,35,25,23,-1,27,36,32,-1,32,26,27,-1,26,32,33,-1,33,28,26,-1,28,33,34,-1,34,29,28,-1,29,34,30,-1,30,24,29,-1,36,37,35,-1,12,25,35,-1,27,13,36,-1]);
IndexedFaceSet110.creaseAngle = 1.57;
IndexedFaceSet110.texCoordIndex = new X3D.MFInt32([1,18,14,-1,3,6,5,-1,5,4,3,-1,1,3,4,-1,4,0,1,-1,0,4,5,-1,5,2,0,-1,14,6,3,-1,3,1,14,-1,19,16,0,-1,0,2,19,-1,0,16,17,-1,17,1,0,-1,17,18,1,-1,7,15,23,-1,9,10,11,-1,11,8,9,-1,7,12,10,-1,10,9,7,-1,12,13,11,-1,11,10,12,-1,15,7,9,-1,9,8,15,-1,20,13,12,-1,12,21,20,-1,12,7,22,-1,22,21,12,-1,22,7,23,-1,18,24,25,-1,25,14,18,-1,15,25,26,-1,26,23,15,-1,29,27,32,-1,32,33,29,-1,41,43,32,-1,32,27,41,-1,30,28,27,-1,27,29,30,-1,42,41,27,-1,27,28,42,-1,28,31,48,-1,48,42,28,-1,35,36,37,-1,37,34,35,-1,44,34,37,-1,37,45,44,-1,39,35,34,-1,34,38,39,-1,46,38,34,-1,34,44,46,-1,38,46,47,-1,47,40,38,-1,52,51,50,-1,50,49,55,-1,50,55,54,-1,52,50,54,-1,52,54,53,-1,42,49,50,-1,50,41,42,-1,41,50,51,-1,51,43,41,-1,45,52,53,-1,53,44,45,-1,44,53,54,-1,54,46,44,-1,46,54,55,-1,55,47,46,-1,48,55,49,-1,49,42,48,-1,52,56,51,-1,18,43,24,-1,22,23,52,-1]);
let Transform115 = browser.currentScene.createNode("Transform");
Transform115.translation = new X3D.SFVec3f([-3.679,3.251,1.465]);
...
Material118.diffuseColor = new X3D.SFColor([0.588,0.588,0.588]);
material = Material118;

let ImageTexture119 = browser.currentScene.createNode("ImageTexture");
ImageTexture119.USE = "JuTextureAtlas";
texture = ImageTexture119;

appearance = Appearance117;

let IndexedFaceSet120 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet120.coordIndex = new X3D.MFInt32([25,4,3,-1,26,25,3,-1,0,26,3,-1,1,10,26,-1,26,0,1,-1,1,9,12,-1,12,10,1,-1,2,4,25,-1,25,34,2,-1,6,8,31,-1,6,31,32,-1,5,6,32,-1,7,5,32,-1,32,11,7,-1,7,11,12,-1,12,9,7,-1,2,34,31,-1,31,8,2,-1,14,13,19,-1,17,16,15,-1,18,17,15,-1,19,18,15,-1,14,19,15,-1,0,13,14,-1,14,1,0,-1,1,14,15,-1,15,9,1,-1,9,15,16,-1,16,7,9,-1,7,16,17,-1,17,5,7,-1,5,17,18,-1,18,6,5,-1,6,18,19,-1,19,3,6,-1,3,19,13,-1,13,0,3,-1,2,8,6,-1,2,6,3,-1,4,2,3,-1,23,24,20,-1,20,21,23,-1,29,23,21,-1,21,22,29,-1,22,33,29,-1,20,25,26,-1,26,21,20,-1,26,10,22,-1,22,21,26,-1,10,12,33,-1,33,22,10,-1,34,25,20,-1,20,24,34,-1,23,27,28,-1,28,24,23,-1,29,30,27,-1,27,23,29,-1,30,29,33,-1,28,27,32,-1,32,31,28,-1,32,27,30,-1,30,11,32,-1,11,30,33,-1,33,12,11,-1,34,24,28,-1,28,31,34,-1]);
IndexedFaceSet120.creaseAngle = 1.57;
IndexedFaceSet120.texCoordIndex = new X3D.MFInt32([12,5,4,-1,13,12,4,-1,0,13,4,-1,1,14,13,-1,13,0,1,-1,1,3,18,-1,18,14,1,-1,2,5,12,-1,12,20,2,-1,7,10,12,-1,7,12,15,-1,6,7,15,-1,8,6,15,-1,15,16,8,-1,8,16,17,-1,17,11,8,-1,9,19,12,-1,12,10,9,-1,22,21,27,-1,25,24,23,-1,26,25,23,-1,27,26,23,-1,22,27,23,-1,0,21,22,-1,22,1,0,-1,1,22,23,-1,23,3,1,-1,11,23,24,-1,24,8,11,-1,8,24,25,-1,25,6,8,-1,6,25,26,-1,26,7,6,-1,7,26,27,-1,27,4,7,-1,4,27,21,-1,21,0,4,-1,9,10,7,-1,9,7,4,-1,5,9,4,-1,29,28,12,-1,12,30,29,-1,31,29,30,-1,30,32,31,-1,32,33,31,-1,12,12,34,-1,34,30,12,-1,34,35,32,-1,32,30,34,-1,35,36,33,-1,33,32,35,-1,37,12,12,-1,12,28,37,-1,38,39,12,-1,12,40,38,-1,41,42,39,-1,39,38,41,-1,42,41,45,-1,12,39,43,-1,43,12,12,-1,43,39,42,-1,42,44,43,-1,44,42,45,-1,45,46,44,-1,47,40,12,-1,12,12,47,-1]);
let Coordinate121 = browser.currentScene.createNode("Coordinate");
Coordinate121.point = new X3D.MFVec3f([-2.687,-1.475,-0.9449,-1.918,-3.308,-0.9449,0,0.2536,0.2858,-1.877,-0.2736,-0.9449,-1.556,0.0026,-0.0141,2.687,-1.475,-0.9449,1.877,-0.2736,-0.9449,1.918,-3.308,-0.9449,1.556,0.0026,-0.0141,0,-3.308,-0.9449,-1.965,-3.308,0.8573,1.965,-3.308,0.8573,0,-3.308,0.8573,-2.208,-1.501,-1.786,-1.607,-2.668,-1.786,0,-2.668,-1.786,1.607,-2.668,-1.786,2.208,-1.501,-1.786,1.599,-0.5151,-1.786,-1.599,-0.5151,-1.786,-1.638,-0.5877,2.175,-2.034,-2.055,3.865,-2.034,-3.308,3.522,0,-2.055,5.096,0,-0.4955,3.684,-1.597,-0.2925,1.08,-2.442,-1.692,0.8573,2.034,-2.055,3.865,1.638,-0.5877,2.175,0,-3.308,4.753,2.034,-3.308,3.522,1.597,-0.2925,1.08,2.442,-1.692,0.8573,0,-3.308,3.522,0,-0.0249,1.55]);
coord = Coordinate121;

let TextureCoordinate122 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate122.point = new X3D.MFVec2f([0.4804,0.417,0.4726,0.3714,0.4777,0.4914,0.4726,0.3714,0.4687,0.4544,0.4611,0.4911,0.4804,0.417,0.4687,0.4544,0.4726,0.3714,0.4777,0.4914,0.4611,0.4911,0.4726,0.3714,0.5246,0.4611,0.5392,0.409,0.5352,0.3721,0.5392,0.409,0.5352,0.3721,0.537,0.3715,0.537,0.3715,0.5123,0.477,0.5123,0.477,0.4804,0.417,0.4726,0.3714,0.4726,0.3714,0.4726,0.3714,0.4804,0.417,0.4687,0.4544,0.4687,0.4544,0.5785,0.4537,0.601,0.4307,0.5382,0.4079,0.6345,0.3741,0.5897,0.3729,0.5897,0.3729,0.5392,0.409,0.5352,0.3721,0.537,0.3715,0.5123,0.477,0.601,0.4307,0.5382,0.4079,0.5785,0.4537,0.6345,0.3741,0.5897,0.3729,0.5392,0.409,0.5352,0.3721,0.5897,0.3729,0.537,0.3715,0.5123,0.477]);
texCoord = TextureCoordinate122;
...
HAnimJoint103ZZZ.children[1] = HAnimJoint113;

HAnimJoint93ZZZ.children[1] = HAnimJoint103;

HAnimJoint83ZZZ.children[1] = HAnimJoint93;

HAnimJoint33ZZZ.children[2] = HAnimJoint83;

let HAnimJoint123 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint123.name = "sacroiliac";
HAnimJoint123.DEF = "hanim_sacroiliac";
HAnimJoint123.center = new X3D.SFVec3f([0.000034,31.26,-0.008798]);
...
HAnimSegment124.name = "pelvis";
HAnimSegment124.DEF = "hanim_pelvis";
let Transform125 = browser.currentScene.createNode("Transform");
Transform125.translation = new X3D.SFVec3f([0.000034,31.26,-0.008798]);
...
Material128.diffuseColor = new X3D.SFColor([0.588,0.588,0.588]);
material = Material128;

let ImageTexture129 = browser.currentScene.createNode("ImageTexture");
ImageTexture129.USE = "JuTextureAtlas";
texture = ImageTexture129;

appearance = Appearance127;

let IndexedFaceSet130 = browser.currentScene.createNode("IndexedFaceSet");
...
HAnimJoint133.name = "l_shoulder";
HAnimJoint133.DEF = "hanim_l_shoulder";
HAnimJoint133.center = new X3D.SFVec3f([4.778,51.029999,-2.069]);
...
HAnimSegment134.name = "l_upperarm";
HAnimSegment134.DEF = "hanim_l_upperarm";
let Transform135 = browser.currentScene.createNode("Transform");
Transform135.translation = new X3D.SFVec3f([4.778,51.029999,-2.069]);
...
HAnimSegment134YYY.children = new X3D.MFNode();

HAnimSegment134ZZZ.children[0] = Transform135;

HAnimJoint133YYY.children = new X3D.MFNode();

HAnimJoint133ZZZ.children[0] = HAnimSegment134;

let HAnimJoint143 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint143.name = "l_elbow";
HAnimJoint143.DEF = "hanim_l_elbow";
HAnimJoint143.center = new X3D.SFVec3f([5.297,40.119999,-2.055]);
...
HAnimSegment144.name = "l_forearm";
HAnimSegment144.DEF = "hanim_l_forearm";
let Transform145 = browser.currentScene.createNode("Transform");
Transform145.translation = new X3D.SFVec3f([5.297,40.119999,-2.055]);
...
Material148.diffuseColor = new X3D.SFColor([0.588,0.588,0.588]);
material = Material148;

let ImageTexture149 = browser.currentScene.createNode("ImageTexture");
ImageTexture149.USE = "JuTextureAtlas";
texture = ImageTexture149;

appearance = Appearance147;

let IndexedFaceSet150 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet150.coordIndex = new X3D.MFInt32([3,2,1,-1,3,1,0,-1,4,3,0,-1,0,1,6,-1,6,5,0,-1,1,2,7,-1,7,6,1,-1,2,3,8,-1,8,7,2,-1,3,4,9,-1,9,8,3,-1,4,0,5,-1,5,9,4,-1,5,6,11,-1,11,10,5,-1,6,7,12,-1,12,11,6,-1,7,8,13,-1,13,12,7,-1,8,9,14,-1,14,13,8,-1,9,5,10,-1,10,14,9,-1,10,11,16,-1,16,15,10,-1,11,12,17,-1,17,16,11,-1,12,13,18,-1,18,17,12,-1,13,14,19,-1,19,18,13,-1,14,10,15,-1,15,19,14,-1,21,22,23,-1,20,21,23,-1,24,20,23,-1,21,20,15,-1,15,16,21,-1,22,21,16,-1,16,17,22,-1,23,22,17,-1,17,18,23,-1,24,23,18,-1,18,19,24,-1,20,24,19,-1,19,15,20,-1]);
IndexedFaceSet150.creaseAngle = 1.57;
IndexedFaceSet150.texCoordIndex = new X3D.MFInt32([3,2,0,-1,3,0,1,-1,4,3,1,-1,1,0,5,-1,5,6,1,-1,0,2,7,-1,7,5,0,-1,2,3,8,-1,8,7,2,-1,3,4,9,-1,9,8,3,-1,4,1,6,-1,6,9,4,-1,6,5,10,-1,10,11,6,-1,5,7,12,-1,12,10,5,-1,7,8,13,-1,13,12,7,-1,8,9,14,-1,14,13,8,-1,9,6,11,-1,11,14,9,-1,11,10,15,-1,15,16,11,-1,10,12,17,-1,17,15,10,-1,12,13,18,-1,18,17,12,-1,13,14,19,-1,19,18,13,-1,14,11,16,-1,16,19,14,-1,21,22,23,-1,20,21,23,-1,24,20,23,-1,21,20,16,-1,16,15,21,-1,22,21,15,-1,15,17,22,-1,23,22,17,-1,17,18,23,-1,24,23,18,-1,18,19,24,-1,20,24,19,-1,19,16,20,-1]);
let Coordinate151 = browser.currentScene.createNode("Coordinate");
Coordinate151.point = new X3D.MFVec3f([0.1284,0.6566,-0.794,0.7947,0.6566,-0.1619,0.4154,0.6566,0.757,-0.4852,0.6566,0.6929,-0.6626,0.6566,-0.2657,0.0855,-0.4623,-1.129,1.027,-0.4623,-0.281,0.4911,-0.4623,1.171,-0.7817,-0.4623,1.07,-1.032,-0.4623,-0.445,0.0941,-3.046,-1.116,1.1,-3.046,-0.2777,0.55,-2.481,1.16,-0.8091,-2.481,1.06,-1.1,-3.046,-0.4401,0.084,-8.01,-1.171,1.025,-7.982,-0.1359,0.3907,-8.118,1.09,-0.6003,-8.118,0.9957,-0.9132,-8.109,-0.2244,0.0434,-8.725,-0.6054,0.5441,-8.725,0.0272,0.2591,-8.725,0.759,-0.4177,-8.725,0.6949,-0.551,-8.725,-0.0767]);
coord = Coordinate151;

let TextureCoordinate152 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate152.point = new X3D.MFVec2f([0.5159,0.3385,0.5159,0.3244,0.5159,0.3332,0.5159,0.3157,0.5159,0.3103,0.521,0.3428,0.521,0.3229,0.521,0.3355,0.521,0.3108,0.521,0.3029,0.5327,0.3442,0.5327,0.3231,0.5302,0.3366,0.5302,0.3103,0.5327,0.3016,0.5558,0.339,0.5558,0.323,0.5558,0.3334,0.5558,0.3141,0.5558,0.3079,0.5585,0.3232,0.5585,0.3341,0.5585,0.3302,0.5585,0.317,0.5585,0.3129]);
texCoord = TextureCoordinate152;

geometry = IndexedFaceSet150;
...
HAnimJoint153.name = "l_radiocarpal";
HAnimJoint153.DEF = "hanim_l_radiocarpal";
HAnimJoint153.center = new X3D.SFVec3f([5.07,31.99,-1.559]);
...
HAnimSegment154.name = "l_carpal";
HAnimSegment154.DEF = "hanim_l_carpal";
let Transform155 = browser.currentScene.createNode("Transform");
Transform155.translation = new X3D.SFVec3f([5.07,31.99,-1.559]);
...
Material158.diffuseColor = new X3D.SFColor([0.588,0.588,0.588]);
material = Material158;

let ImageTexture159 = browser.currentScene.createNode("ImageTexture");
ImageTexture159.USE = "JuTextureAtlas";
texture = ImageTexture159;

appearance = Appearance157;

let IndexedFaceSet160 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet160.coordIndex = new X3D.MFInt32([4,5,0,-1,0,2,4,-1,6,7,3,-1,3,1,6,-1,1,0,5,-1,5,6,1,-1,8,9,5,-1,5,4,8,-1,10,11,7,-1,7,6,10,-1,9,10,6,-1,6,5,9,-1,12,13,9,-1,9,8,12,-1,14,15,11,-1,11,10,14,-1,13,14,10,-1,10,9,13,-1,4,2,16,-1,2,3,7,-1,7,16,2,-1,17,19,18,-1,18,20,17,-1,21,16,7,-1,7,11,21,-1,8,21,12,-1,12,21,11,-1,11,15,12,-1,13,12,15,-1,15,14,13,-1,8,4,19,-1,19,17,8,-1,4,16,18,-1,18,19,4,-1,16,21,20,-1,20,18,16,-1,21,8,17,-1,17,20,21,-1,3,2,0,-1,0,1,3,-1]);
IndexedFaceSet160.creaseAngle = 1.57;
IndexedFaceSet160.texCoordIndex = new X3D.MFInt32([0,2,1,-1,1,3,0,-1,36,38,37,-1,37,39,36,-1,28,30,29,-1,29,31,28,-1,4,5,2,-1,2,0,4,-1,40,41,38,-1,38,36,40,-1,32,33,31,-1,31,29,32,-1,6,7,5,-1,5,4,6,-1,42,43,41,-1,41,40,42,-1,34,35,33,-1,33,32,34,-1,10,12,11,-1,12,14,13,-1,13,11,12,-1,15,17,16,-1,16,18,15,-1,19,11,13,-1,13,20,19,-1,21,19,22,-1,22,19,20,-1,20,23,22,-1,24,22,23,-1,23,25,24,-1,4,0,8,-1,8,9,4,-1,10,11,16,-1,16,17,10,-1,11,19,18,-1,18,16,11,-1,19,21,15,-1,15,18,19,-1,14,12,26,-1,26,27,14,-1]);
let Coordinate161 = browser.currentScene.createNode("Coordinate");
Coordinate161.point = new X3D.MFVec3f([0.8732,0.4437,0.6298,0.8463,0.4584,-1.065,-0.5135,0.3661,0.7037,-0.5196,0.3675,-1.013,-0.6654,-0.1688,1.167,1.16,0.015,1.096,1.119,0.0434,-1.571,-0.747,-0.1537,-1.566,-0.5777,-1.832,1.902,1.387,-1.647,1.643,1.345,-1.619,-1.902,-0.8391,-1.916,-1.775,-0.3897,-3.083,1.338,0.6425,-3.283,1.382,0.6009,-3.255,-1.636,-0.5412,-3.094,-1.527,-0.742,-0.1555,-0.1478,-1.159,-1.873,1.533,-1.387,-0.4699,0.0458,-1.361,-0.5281,1.488,-1.163,-1.872,0.1088,-0.7494,-1.912,-0.1591]);
coord = Coordinate161;

let TextureCoordinate162 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate162.point = new X3D.MFVec2f([0.4675,0.2229,0.4534,0.3224,0.4709,0.3268,0.4579,0.2308,0.5552,0.233,0.5504,0.3288,0.6215,0.2576,0.6159,0.3282,0.478,0.1884,0.5527,0.2007,0.4618,0.1862,0.4629,0.1191,0.4583,0.192,0.4802,0.0435,0.4672,0.0405,0.5177,0.1794,0.4789,0.1246,0.4811,0.1812,0.515,0.132,0.538,0.1232,0.5459,0.0341,0.5348,0.1824,0.6006,0.1887,0.5977,0.0452,0.6323,0.1888,0.629,0.0403,0.4501,0.1899,0.4535,0.0388,0.5577,0.3108,0.5496,0.3395,0.5573,0.3333,0.5503,0.3041,0.5263,0.3468,0.527,0.2997,0.5106,0.3433,0.5113,0.3032,0.4584,0.3225,0.4544,0.2224,0.4607,0.2253,0.4525,0.325,0.5365,0.3334,0.5532,0.2053,0.6323,0.3251,0.6179,0.2145]);
texCoord = TextureCoordinate162;

geometry = IndexedFaceSet160;
...
HAnimSegment154ZZZ.children[0] = Transform155;

HAnimJoint153YYY.children = new X3D.MFNode();

HAnimJoint153ZZZ.children[0] = HAnimSegment154;

HAnimJoint143ZZZ.children[1] = HAnimJoint153;

HAnimJoint133ZZZ.children[1] = HAnimJoint143;

HAnimJoint123ZZZ.children[1] = HAnimJoint133;
...
HAnimJoint163.center = new X3D.SFVec3f([-4.778,51.029999,-2.069]);
...
HAnimSegment164.name = "r_upperarm";
HAnimSegment164.DEF = "hanim_r_upperarm";
let Transform165 = browser.currentScene.createNode("Transform");
Transform165.translation = new X3D.SFVec3f([-4.778,51.029999,-2.069]);
...
HAnimJoint173.center = new X3D.SFVec3f([-5.297,40.119999,-2.055]);
...
HAnimSegment174.name = "r_forearm";
HAnimSegment174.DEF = "hanim_r_forearm";
let Transform175 = browser.currentScene.createNode("Transform");
Transform175.translation = new X3D.SFVec3f([-5.297,40.119999,-2.055]);
...
Material178.diffuseColor = new X3D.SFColor([0.588,0.588,0.588]);
material = Material178;

let ImageTexture179 = browser.currentScene.createNode("ImageTexture");
ImageTexture179.USE = "JuTextureAtlas";
texture = ImageTexture179;

appearance = Appearance177;

let IndexedFaceSet180 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet180.coordIndex = new X3D.MFInt32([1,2,3,-1,0,1,3,-1,4,0,3,-1,0,5,6,-1,6,1,0,-1,1,6,7,-1,7,2,1,-1,2,7,8,-1,8,3,2,-1,3,8,9,-1,9,4,3,-1,4,9,5,-1,5,0,4,-1,5,10,11,-1,11,6,5,-1,6,11,12,-1,12,7,6,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,9,8,-1,9,14,10,-1,10,5,9,-1,10,15,16,-1,16,11,10,-1,11,16,17,-1,17,12,11,-1,12,17,18,-1,18,13,12,-1,13,18,19,-1,19,14,13,-1,14,19,15,-1,15,10,14,-1,23,22,21,-1,23,21,20,-1,24,23,20,-1,21,16,15,-1,15,20,21,-1,22,17,16,-1,16,21,22,-1,23,18,17,-1,17,22,23,-1,24,19,18,-1,18,23,24,-1,20,15,19,-1,19,24,20,-1]);
IndexedFaceSet180.creaseAngle = 1.57;
IndexedFaceSet180.texCoordIndex = new X3D.MFInt32([0,2,3,-1,1,0,3,-1,4,1,3,-1,1,6,5,-1,5,0,1,-1,0,5,7,-1,7,2,0,-1,2,7,8,-1,8,3,2,-1,3,8,9,-1,9,4,3,-1,4,9,6,-1,6,1,4,-1,6,11,10,-1,10,5,6,-1,5,10,12,-1,12,7,5,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,9,8,-1,9,14,11,-1,11,6,9,-1,11,16,15,-1,15,10,11,-1,10,15,17,-1,17,12,10,-1,12,17,18,-1,18,13,12,-1,13,18,19,-1,19,14,13,-1,14,19,16,-1,16,11,14,-1,23,22,21,-1,23,21,20,-1,24,23,20,-1,21,15,16,-1,16,20,21,-1,22,17,15,-1,15,21,22,-1,23,18,17,-1,17,22,23,-1,24,19,18,-1,18,23,24,-1,20,16,19,-1,19,24,20,-1]);
let Coordinate181 = browser.currentScene.createNode("Coordinate");
Coordinate181.point = new X3D.MFVec3f([-0.1284,0.6566,-0.794,-0.7947,0.6566,-0.1619,-0.4154,0.6566,0.757,0.4852,0.6566,0.6929,0.6626,0.6566,-0.2657,-0.0855,-0.4623,-1.129,-1.027,-0.4623,-0.281,-0.4911,-0.4623,1.171,0.7817,-0.4623,1.07,1.032,-0.4623,-0.445,-0.0941,-3.046,-1.116,-1.1,-3.046,-0.2777,-0.55,-2.481,1.16,0.8091,-2.481,1.06,1.1,-3.046,-0.4401,-0.084,-8.01,-1.171,-1.025,-7.982,-0.1359,-0.3907,-8.118,1.09,0.6003,-8.118,0.9957,0.9132,-8.109,-0.2244,-0.0434,-8.725,-0.6054,-0.5441,-8.725,0.0272,-0.2591,-8.725,0.759,0.4177,-8.725,0.6949,0.551,-8.725,-0.0767]);
coord = Coordinate181;

let TextureCoordinate182 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate182.point = new X3D.MFVec2f([0.5159,0.3385,0.5159,0.3244,0.5159,0.3332,0.5159,0.3157,0.5159,0.3103,0.521,0.3428,0.521,0.3229,0.521,0.3355,0.521,0.3108,0.521,0.3029,0.5327,0.3442,0.5327,0.3231,0.5302,0.3366,0.5302,0.3103,0.5327,0.3016,0.5558,0.339,0.5558,0.323,0.5558,0.3334,0.5558,0.3141,0.5558,0.3079,0.5585,0.3232,0.5585,0.3341,0.5585,0.3302,0.5585,0.317,0.5585,0.3129]);
texCoord = TextureCoordinate182;
...
HAnimSegment174YYY.children = new X3D.MFNode();

HAnimSegment174ZZZ.children[0] = Transform175;

HAnimJoint173YYY.children = new X3D.MFNode();

HAnimJoint173ZZZ.children[0] = HAnimSegment174;

let HAnimJoint183 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint183.name = "r_radiocarpal";
HAnimJoint183.DEF = "hanim_r_radiocarpal";
HAnimJoint183.center = new X3D.SFVec3f([-5.07,31.99,-1.559]);
...
HAnimSegment184.name = "r_carpal";
HAnimSegment184.DEF = "hanim_r_carpal";
let Transform185 = browser.currentScene.createNode("Transform");
Transform185.translation = new X3D.SFVec3f([-5.07,31.99,-1.559]);
...
Material188.diffuseColor = new X3D.SFColor([0.588,0.588,0.588]);
material = Material188;

let ImageTexture189 = browser.currentScene.createNode("ImageTexture");
ImageTexture189.USE = "JuTextureAtlas";
texture = ImageTexture189;

appearance = Appearance187;

let IndexedFaceSet190 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet190.coordIndex = new X3D.MFInt32([4,2,0,-1,0,5,4,-1,6,1,3,-1,3,7,6,-1,1,6,5,-1,5,0,1,-1,8,4,5,-1,5,9,8,-1,10,6,7,-1,7,11,10,-1,9,5,6,-1,6,10,9,-1,12,8,9,-1,9,13,12,-1,14,10,11,-1,11,15,14,-1,13,9,10,-1,10,14,13,-1,4,16,2,-1,2,16,7,-1,7,3,2,-1,17,20,18,-1,18,19,17,-1,21,11,7,-1,7,16,21,-1,8,12,21,-1,12,15,11,-1,11,21,12,-1,13,14,15,-1,15,12,13,-1,8,17,19,-1,19,4,8,-1,4,19,18,-1,18,16,4,-1,16,18,20,-1,20,21,16,-1,21,20,17,-1,17,8,21,-1,3,1,0,-1,0,2,3,-1]);
IndexedFaceSet190.creaseAngle = 1.57;
IndexedFaceSet190.texCoordIndex = new X3D.MFInt32([0,3,1,-1,1,2,0,-1,36,39,37,-1,37,38,36,-1,28,31,29,-1,29,30,28,-1,4,0,2,-1,2,5,4,-1,40,36,38,-1,38,41,40,-1,32,29,31,-1,31,33,32,-1,6,4,5,-1,5,7,6,-1,42,40,41,-1,41,43,42,-1,34,32,33,-1,33,35,34,-1,10,11,12,-1,12,11,13,-1,13,14,12,-1,15,18,16,-1,16,17,15,-1,19,20,13,-1,13,11,19,-1,21,22,19,-1,22,23,20,-1,20,19,22,-1,24,25,23,-1,23,22,24,-1,4,9,8,-1,8,0,4,-1,10,17,16,-1,16,11,10,-1,11,16,18,-1,18,19,11,-1,19,18,15,-1,15,21,19,-1,14,27,26,-1,26,12,14,-1]);
let Coordinate191 = browser.currentScene.createNode("Coordinate");
Coordinate191.point = new X3D.MFVec3f([-0.8732,0.4437,0.6298,-0.8463,0.4584,-1.065,0.5135,0.3661,0.7037,0.5196,0.3675,-1.013,0.6654,-0.1688,1.167,-1.16,0.015,1.096,-1.119,0.0434,-1.571,0.747,-0.1537,-1.566,0.5777,-1.832,1.902,-1.387,-1.647,1.643,-1.345,-1.619,-1.902,0.8391,-1.916,-1.775,0.3897,-3.083,1.338,-0.6425,-3.283,1.382,-0.6009,-3.255,-1.636,0.5412,-3.094,-1.527,0.742,-0.1555,-0.1478,1.159,-1.873,1.533,1.387,-0.4699,0.0458,1.361,-0.5281,1.488,1.163,-1.872,0.1088,0.7494,-1.912,-0.1591]);
coord = Coordinate191;

let TextureCoordinate192 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate192.point = new X3D.MFVec2f([0.4675,0.2229,0.4534,0.3224,0.4709,0.3268,0.4579,0.2308,0.5552,0.233,0.5504,0.3288,0.6215,0.2576,0.6159,0.3282,0.478,0.1884,0.5527,0.2007,0.4618,0.1862,0.4629,0.1191,0.4583,0.192,0.4802,0.0435,0.4672,0.0405,0.5177,0.1794,0.4789,0.1246,0.4811,0.1812,0.515,0.132,0.538,0.1232,0.5459,0.0341,0.5348,0.1824,0.6006,0.1887,0.5977,0.0452,0.6323,0.1888,0.629,0.0403,0.4501,0.1899,0.4535,0.0388,0.5577,0.3108,0.5496,0.3395,0.5573,0.3333,0.5503,0.3041,0.5263,0.3468,0.527,0.2997,0.5106,0.3433,0.5113,0.3032,0.4584,0.3225,0.4544,0.2224,0.4607,0.2253,0.4525,0.325,0.5365,0.3334,0.5532,0.2053,0.6323,0.3251,0.6179,0.2145]);
texCoord = TextureCoordinate192;

geometry = IndexedFaceSet190;
...
HAnimJoint173ZZZ.children[1] = HAnimJoint183;

HAnimJoint163ZZZ.children[1] = HAnimJoint173;

HAnimJoint123ZZZ.children[2] = HAnimJoint163;

let HAnimJoint193 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint193.name = "vl5";
HAnimJoint193.DEF = "hanim_vl5";
HAnimJoint193.center = new X3D.SFVec3f([0.000025,39.84,0.1163]);
...
HAnimSegment194.name = "l5";
HAnimSegment194.DEF = "hanim_l5";
let Transform195 = browser.currentScene.createNode("Transform");
Transform195.translation = new X3D.SFVec3f([0.000025,39.84,0.1163]);
...
HAnimJoint203.name = "skullbase";
HAnimJoint203.DEF = "hanim_skullbase";
HAnimJoint203.center = new X3D.SFVec3f([0.000025,56.07,-1.554]);
HAnimJoint203.ulimit = new X3D.MFFloat([0,0,0]);
HAnimJoint203.llimit = new X3D.MFFloat([0,0,0]);
let HAnimSegment204 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment204.name = "skull";
HAnimSegment204.DEF = "hanim_skull";
let Transform205 = browser.currentScene.createNode("Transform");
Transform205.translation = new X3D.SFVec3f([0.000025,56.07,-1.554]);
...
HAnimSegment204YYY.children = new X3D.MFNode();

HAnimSegment204ZZZ.children[0] = Transform205;

HAnimJoint203YYY.children = new X3D.MFNode();

HAnimJoint203ZZZ.children[0] = HAnimSegment204;

HAnimJoint193ZZZ.children[1] = HAnimJoint203;

HAnimJoint123ZZZ.children[3] = HAnimJoint193;

HAnimJoint33ZZZ.children[3] = HAnimJoint123;

joints[1] = HAnimJoint33;

let HAnimJoint213 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint213.USE = "hanim_humanoid_root";
joints[2] = HAnimJoint213;

let HAnimJoint214 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint214.USE = "hanim_sacroiliac";
joints[3] = HAnimJoint214;

let HAnimJoint215 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint215.USE = "hanim_skullbase";
joints[4] = HAnimJoint215;

let HAnimJoint216 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint216.USE = "hanim_vl5";
joints[5] = HAnimJoint216;

let HAnimJoint217 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint217.USE = "hanim_l_elbow";
joints[6] = HAnimJoint217;

let HAnimJoint218 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint218.USE = "hanim_r_elbow";
joints[7] = HAnimJoint218;

let HAnimJoint219 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint219.USE = "hanim_l_hip";
joints[8] = HAnimJoint219;

let HAnimJoint220 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint220.USE = "hanim_r_hip";
joints[9] = HAnimJoint220;

let HAnimJoint221 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint221.USE = "hanim_l_knee";
joints[10] = HAnimJoint221;

let HAnimJoint222 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint222.USE = "hanim_r_knee";
joints[11] = HAnimJoint222;

let HAnimJoint223 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint223.USE = "hanim_l_metatarsophalangeal_2";
joints[12] = HAnimJoint223;

let HAnimJoint224 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint224.USE = "hanim_r_metatarsophalangeal_2";
joints[13] = HAnimJoint224;

let HAnimJoint225 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint225.USE = "hanim_l_radiocarpal";
joints[14] = HAnimJoint225;

let HAnimJoint226 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint226.USE = "hanim_r_radiocarpal";
joints[15] = HAnimJoint226;

let HAnimJoint227 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint227.USE = "hanim_l_shoulder";
joints[16] = HAnimJoint227;

let HAnimJoint228 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint228.USE = "hanim_r_shoulder";
joints[17] = HAnimJoint228;

let HAnimJoint229 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint229.USE = "hanim_l_talocrural";
joints[18] = HAnimJoint229;

let HAnimJoint230 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint230.USE = "hanim_r_talocrural";
joints[19] = HAnimJoint230;

browser.currentScene.children[3] = HAnimHumanoid25;

let EXPORT231 = browser.currentScene.createNode("EXPORT");
EXPORT231.AS = "KoreanCharacter05Ju";
EXPORT231.localDEF = "hanim_Ju";
browser.currentScene.children[4] = EXPORT231;

...
meta7.name = "modified";
meta7.content = "Sat, 30 Dec 2023 07:50:57 GMT";
head1.meta[5] = meta7;
...
WorldInfo19.title = "KoreanCharacter05Ju.x3d";
...
HAnimHumanoid22.DEF = "hanim_Ju";
HAnimHumanoid22.name = "Ju";
...
HAnimJoint30.center = new SFVec3f(new float[0,36,-0.008798]);
...
Transform32.translation = new SFVec3f(new float[0,36,-0.008798]);
...
ImageTexture36.DEF = "JuTextureAtlas";
ImageTexture36.url = new MFString(new java.lang.String["images/Ju.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ju.png"]);
...
IndexedFaceSet37.creaseAngle = 1.57;
...
HAnimJoint40.center = new SFVec3f(new float[3.22,33.62,-0.2832]);
...
Transform42.translation = new SFVec3f(new float[3.22,33.62,-0.2832]);
...
ImageTexture46.USE = "JuTextureAtlas";
...
IndexedFaceSet47.creaseAngle = 1.57;
...
HAnimJoint50.DEF = "hanim_l_knee";
HAnimJoint50.name = "l_knee";
HAnimJoint50.center = new SFVec3f(new float[3.454,18.67,-0.02158]);
let HAnimSegment51 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment51.DEF = "hanim_l_calf";
HAnimSegment51.name = "l_calf";
let Transform52 = browser.currentScene.createNode("Transform");
Transform52.translation = new SFVec3f(new float[3.454,18.67,-0.02158]);
...
ImageTexture56.USE = "JuTextureAtlas";
...
IndexedFaceSet57.creaseAngle = 1.57;
...
HAnimJoint60.DEF = "hanim_l_talocrural";
HAnimJoint60.name = "l_talocrural";
HAnimJoint60.center = new SFVec3f(new float[3.467,3.522,0.118]);
let HAnimSegment61 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment61.DEF = "hanim_l_talus";
HAnimSegment61.name = "l_talus";
let Transform62 = browser.currentScene.createNode("Transform");
Transform62.translation = new SFVec3f(new float[3.467,3.522,0.118]);
...
ImageTexture66.USE = "JuTextureAtlas";
...
IndexedFaceSet67.creaseAngle = 1.57;
...
HAnimJoint70.DEF = "hanim_l_metatarsophalangeal_2";
HAnimJoint70.name = "l_metatarsophalangeal_2";
HAnimJoint70.center = new SFVec3f(new float[3.467,3.251,1.465]);
let HAnimSegment71 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment71.DEF = "hanim_l_tarsal_proximal_phalanx_2";
HAnimSegment71.name = "l_tarsal_proximal_phalanx_2";
let Transform72 = browser.currentScene.createNode("Transform");
Transform72.translation = new SFVec3f(new float[3.467,3.251,1.465]);
...
ImageTexture76.USE = "JuTextureAtlas";
...
IndexedFaceSet77.creaseAngle = 1.57;
...
let TextureCoordinate78 = browser.currentScene.createNode("TextureCoordinate");
...
HAnimJoint80.center = new SFVec3f(new float[-3.22,33.62,-0.2832]);
...
Transform82.translation = new SFVec3f(new float[-3.22,33.62,-0.2832]);
...
ImageTexture86.USE = "JuTextureAtlas";
...
let TextureCoordinate88 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate88.point = new MFVec2f(new float[0.7387,0.5078,0.7519,0.5078,0.7092,0.5078,0.6855,0.5078,0.6855,0.5078,0.7092,0.5078,0.7387,0.5078,0.7641,0.4868,0.7464,0.4472,0.7641,0.4472,0.7464,0.4868,0.7065,0.4472,0.7065,0.4868,0.6788,0.4472,0.6788,0.4868,0.6788,0.4472,0.6788,0.4868,0.7065,0.4472,0.7065,0.4868,0.7464,0.4472,0.7464,0.4868,0.7464,0.3861,0.7641,0.3861,0.7065,0.3861,0.6788,0.3861,0.6788,0.3861,0.7065,0.3861,0.7464,0.3861,0.743,0.3252,0.7584,0.3252,0.7085,0.3252,0.6882,0.3252,0.6882,0.3252,0.7085,0.3252,0.743,0.3252,0.7383,0.2938,0.7506,0.2938,0.7107,0.2938,0.6945,0.2938,0.6945,0.2938,0.7107,0.2938,0.7383,0.2938,0.7284,0.2787,0.7342,0.2787,0.7155,0.2787,0.7079,0.2787,0.7079,0.2787,0.7155,0.2787,0.7284,0.2787,0.7197,0.2768]);
IndexedFaceSet87.texCoord = TextureCoordinate88;

let Coordinate89 = browser.currentScene.createNode("Coordinate");
Coordinate89.point = new MFVec3f(new float[-2.617,2.231,0.2976,-1.527,2.231,2.592,0.9211,2.231,3.159,2.617,2.231,1.571,2.617,2.231,-1.571,0.9211,2.231,-3.159,-1.527,2.231,-2.29,-2.617,-1.238,0.2976,-1.527,-1.238,2.592,0.9211,-1.238,3.159,2.617,-1.238,1.571,2.617,-1.238,-0.9758,0.9211,-1.238,-3.009,-1.527,-1.238,-2.442,-2.617,-6.593,0.2976,-1.527,-6.593,2.58,0.9211,-6.593,3.147,2.617,-6.593,1.571,2.617,-6.593,-0.9758,0.9211,-6.593,-2.564,-1.527,-6.593,-1.997,-2.264,-11.92,0.2976,-1.321,-11.92,2.282,0.7969,-11.92,2.773,2.046,-11.92,1.399,2.046,-11.92,-0.8039,0.7969,-11.92,-2.177,-1.321,-11.92,-1.687,-1.864,4.073,0.2976,-1.058,4.073,1.995,0.7536,4.073,2.415,2.206,4.073,1.24,2.206,4.073,-0.6446,0.7536,4.073,-1.819,-1.058,4.073,-1.4,-1.033,-14.67,1.883,-1.786,-14.67,0.2976,0.6591,-14.67,2.275,1.657,-14.67,1.178,1.657,-14.67,-0.5825,0.6591,-14.67,-1.68,-1.033,-14.67,-1.288,-0.4256,-15.99,1.041,-0.7788,-15.99,0.2976,0.3682,-15.99,1.225,0.8362,-15.99,0.7104,0.8362,-15.99,-0.1152,0.3682,-15.99,-0.63,-0.4256,-15.99,-0.4463,0.1114,-16.17,0.2976]);
...
HAnimJoint90.DEF = "hanim_r_knee";
HAnimJoint90.name = "r_knee";
HAnimJoint90.center = new SFVec3f(new float[-3.454,18.67,-0.02158]);
let HAnimSegment91 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment91.DEF = "hanim_r_calf";
HAnimSegment91.name = "r_calf";
let Transform92 = browser.currentScene.createNode("Transform");
Transform92.translation = new SFVec3f(new float[-3.454,18.67,-0.02158]);
...
ImageTexture96.USE = "JuTextureAtlas";
...
IndexedFaceSet97.creaseAngle = 1.57;
...
TextureCoordinate98.point = new MFVec2f(new float[0.7637,0.172,0.755,0.172,0.7356,0.172,0.72,0.172,0.72,0.172,0.7356,0.172,0.755,0.172,0.8032,0.2271,0.7818,0.2173,0.7763,0.1976,0.7978,0.2004,0.7264,0.2173,0.728,0.1976,0.6912,0.2271,0.6892,0.2004,0.6912,0.2347,0.6892,0.2004,0.7264,0.2347,0.728,0.2004,0.7818,0.2347,0.7763,0.2004,0.7735,0.1816,0.7933,0.1816,0.729,0.1816,0.6933,0.1816,0.6933,0.1816,0.729,0.1816,0.7735,0.1816,0.806,0.339,0.7815,0.3388,0.7265,0.3388,0.6824,0.339,0.6824,0.3392,0.7265,0.3392,0.7815,0.3392,0.7634,0.3549,0.755,0.3548,0.736,0.3548,0.7207,0.3549,0.7207,0.355,0.736,0.355,0.755,0.355]);
IndexedFaceSet97.texCoord = TextureCoordinate98;

let Coordinate99 = browser.currentScene.createNode("Coordinate");
Coordinate99.point = new MFVec3f(new float[-0.7406,0.9639,0.0216,-0.4117,0.9639,0.8655,0.3272,0.9639,1.036,0.9197,0.9639,0.5579,0.9197,0.9639,-0.3619,0.3272,0.9639,-0.8401,-0.4117,0.9639,-0.6694,-2.238,-4.201,0.0216,-1.426,-3.284,1.868,-1.219,-1.439,2.239,-2.036,-1.701,0.0216,0.6748,-3.284,2.375,0.6153,-1.439,2.686,2.01,-4.201,1.161,2.086,-1.701,0.9061,2.01,-4.913,-1.265,2.086,-1.701,-0.8628,0.6748,-4.913,-2.686,0.6153,-1.701,-2.191,-1.426,-4.913,-2.179,-1.219,-1.701,-1.744,-1.112,0.0646,1.755,-1.864,0.0646,0.0216,0.5772,0.0646,2.145,1.932,0.0646,1.051,1.932,0.0646,-0.8553,0.5772,0.0646,-1.907,-1.112,0.0646,-1.517,-2.345,-14.69,-0.0151,-1.416,-14.67,2.102,0.6712,-14.67,2.624,2.345,-14.69,1.16,2.345,-14.71,-1.342,0.6712,-14.71,-2.38,-1.416,-14.71,-1.857,-0.73,-16.18,0.0221,-0.4092,-16.17,0.7532,0.3118,-16.17,0.9337,0.89,-16.18,0.4278,0.89,-16.19,-0.4362,0.3118,-16.19,-0.7945,-0.4092,-16.19,-0.614]);
IndexedFaceSet97.coord = Coordinate99;
...
HAnimJoint100.DEF = "hanim_r_talocrural";
HAnimJoint100.name = "r_talocrural";
HAnimJoint100.center = new SFVec3f(new float[-3.679,3.522,0.118]);
let HAnimSegment101 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment101.DEF = "hanim_r_talus";
HAnimSegment101.name = "r_talus";
let Transform102 = browser.currentScene.createNode("Transform");
Transform102.translation = new SFVec3f(new float[-3.679,3.522,0.118]);
...
ImageTexture106.USE = "JuTextureAtlas";
...
IndexedFaceSet107.creaseAngle = 1.57;
...
let TextureCoordinate108 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate108.point = new MFVec2f(new float[0.4269,0.4898,0.4623,0.4901,0.4269,0.4898,0.4623,0.4901,0.4269,0.4898,0.4269,0.4898,0.4777,0.4914,0.4623,0.4901,0.4777,0.4914,0.4623,0.4901,0.4269,0.4898,0.4269,0.4898,0.4269,0.4898,0.4269,0.4898,0.4777,0.4914,0.4777,0.4914,0.4309,0.4635,0.4687,0.4544,0.4611,0.4911,0.4284,0.4641,0.4284,0.4641,0.4309,0.4635,0.4687,0.4544,0.4611,0.4911,0.4611,0.4911,0.4777,0.4914,0.4611,0.4911,0.4321,0.4164,0.4315,0.3728,0.4321,0.4164,0.4315,0.3728,0.4315,0.3728,0.4309,0.4635,0.4284,0.4641,0.4321,0.4164,0.4321,0.4164,0.4284,0.4641,0.4309,0.4635,0.4315,0.3728,0.4315,0.3728,0.4315,0.3728,0.4804,0.417,0.4726,0.3714,0.4687,0.4544,0.4804,0.417,0.4687,0.4544,0.4726,0.3714,0.4726,0.3714,0.4726,0.3714,0.4726,0.3714,0.4804,0.417,0.4687,0.4544,0.4687,0.4544,0.4804,0.417,0.4726,0.3714,0.4726,0.3714,0.4687,0.4544]);
IndexedFaceSet107.texCoord = TextureCoordinate108;

let Coordinate109 = browser.currentScene.createNode("Coordinate");
Coordinate109.point = new MFVec3f(new float[-0.8966,-0.0174,-1.568,-1.521,-0.0174,0.4019,0,-0.0174,-1.568,-1.288,0.6634,0.3302,-0.7503,0.6634,-1.364,0,0.6634,-1.364,0,0.6634,1.372,1.521,-0.0174,0.4019,1.288,0.6634,0.3302,0.7503,0.6634,-1.364,0.8967,-0.0174,-1.568,0,-0.0174,1.633,-1.556,-0.2684,1.333,1.556,-0.2684,1.333,-1.293,-1.746,-2.684,-1.293,-3.579,-1.568,0,-3.579,-1.568,-1.018,-0.5447,-1.908,0,-0.5447,-1.908,1.293,-1.746,-2.684,0,-1.746,-2.684,1.018,-0.5447,-1.908,1.293,-3.579,-1.568,-2.687,-1.746,0.4019,-1.918,-3.579,0.4019,-1.877,-0.5447,0.4019,2.687,-1.746,0.4019,1.877,-0.5447,0.4019,1.918,-3.579,0.4019,0,-3.579,0.4019,-1.708,-3.439,1.272,-2.332,-1.78,1.272,2.332,-1.78,1.272,1.708,-3.439,1.272,0,-3.439,1.272,-1.469,-0.8455,1.311,1.469,-0.8455,1.311,0,-0.5969,1.593]);
...
HAnimJoint110.DEF = "hanim_r_metatarsophalangeal_2";
HAnimJoint110.name = "r_metatarsophalangeal_2";
HAnimJoint110.center = new SFVec3f(new float[-3.679,3.251,1.465]);
let HAnimSegment111 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment111.DEF = "hanim_r_tarsal_proximal_phalanx_2";
HAnimSegment111.name = "r_tarsal_proximal_phalanx_2";
let Transform112 = browser.currentScene.createNode("Transform");
Transform112.translation = new SFVec3f(new float[-3.679,3.251,1.465]);
...
ImageTexture116.USE = "JuTextureAtlas";
...
HAnimJoint30.children[2] = HAnimJoint80;

let HAnimJoint120 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint120.DEF = "hanim_sacroiliac";
HAnimJoint120.name = "sacroiliac";
HAnimJoint120.center = new SFVec3f(new float[0.000034,31.26,-0.008798]);
let HAnimSegment121 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment121.DEF = "hanim_pelvis";
HAnimSegment121.name = "pelvis";
let Transform122 = browser.currentScene.createNode("Transform");
Transform122.translation = new SFVec3f(new float[0.000034,31.26,-0.008798]);
...
ImageTexture126.USE = "JuTextureAtlas";
...
IndexedFaceSet127.creaseAngle = 1.57;
...
HAnimJoint130.DEF = "hanim_l_shoulder";
HAnimJoint130.name = "l_shoulder";
HAnimJoint130.center = new SFVec3f(new float[4.778,51.03,-2.069]);
let HAnimSegment131 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment131.DEF = "hanim_l_upperarm";
HAnimSegment131.name = "l_upperarm";
let Transform132 = browser.currentScene.createNode("Transform");
Transform132.translation = new SFVec3f(new float[4.778,51.03,-2.069]);
...
ImageTexture136.USE = "JuTextureAtlas";
...
IndexedFaceSet137.creaseAngle = 1.57;
...
HAnimJoint140.DEF = "hanim_l_elbow";
HAnimJoint140.name = "l_elbow";
HAnimJoint140.center = new SFVec3f(new float[5.297,40.12,-2.055]);
let HAnimSegment141 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment141.DEF = "hanim_l_forearm";
HAnimSegment141.name = "l_forearm";
let Transform142 = browser.currentScene.createNode("Transform");
Transform142.translation = new SFVec3f(new float[5.297,40.12,-2.055]);
...
ImageTexture146.USE = "JuTextureAtlas";
...
IndexedFaceSet147.creaseAngle = 1.57;
...
HAnimJoint150.DEF = "hanim_l_radiocarpal";
HAnimJoint150.name = "l_radiocarpal";
HAnimJoint150.center = new SFVec3f(new float[5.07,31.99,-1.559]);
let HAnimSegment151 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment151.DEF = "hanim_l_carpal";
HAnimSegment151.name = "l_carpal";
let Transform152 = browser.currentScene.createNode("Transform");
Transform152.translation = new SFVec3f(new float[5.07,31.99,-1.559]);
...
ImageTexture156.USE = "JuTextureAtlas";
...
IndexedFaceSet157.creaseAngle = 1.57;
...
HAnimJoint120.children[1] = HAnimJoint130;

let HAnimJoint160 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint160.DEF = "hanim_r_shoulder";
HAnimJoint160.name = "r_shoulder";
HAnimJoint160.center = new SFVec3f(new float[-4.778,51.03,-2.069]);
let HAnimSegment161 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment161.DEF = "hanim_r_upperarm";
HAnimSegment161.name = "r_upperarm";
let Transform162 = browser.currentScene.createNode("Transform");
Transform162.translation = new SFVec3f(new float[-4.778,51.03,-2.069]);
...
ImageTexture166.USE = "JuTextureAtlas";
...
let TextureCoordinate168 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate168.point = new MFVec2f(new float[0.2661,0.1332,0.3717,0.1332,0.1245,0.1332,0.0067,0.1321,0.2119,0.1332,0.2707,0.1099,0.3728,0.1099,0.1275,0.1099,0.0049,0.1088,0.2167,0.1099,0.271,0.0284,0.3751,0.0284,0.1295,0.0284,0.0061,0.0273,0.2178,0.0284,0.2716,0.0086,0.3751,0.0086,0.1299,0.0086,0.0058,0.0075,0.2184,0.0086,0.2836,0.0426,0.3685,0.0426,0.1368,0.0426,0.0085,0.0415,0.2198,0.0426,0.0067,0.1343,0.0084,0.111,0.0084,0.111,0.0073,0.0295,0.0073,0.0295,0.0076,0.0097,0.0076,0.0097,0.0065,0.0437,0.6285,0.3174,0.6285,0.3316,0.6285,0.3312,0.6285,0.3167,0.6285,0.3082,0.5864,0.3116,0.5864,0.3376,0.6087,0.339,0.6087,0.3139,0.5864,0.3394,0.6087,0.3383,0.5864,0.3146,0.6087,0.3128,0.5864,0.2974,0.6087,0.2977,0.6261,0.339,0.6261,0.3148,0.6261,0.3383,0.6261,0.3137,0.6261,0.2992,0.0441,0.1287,-0.1162,0.128]);
IndexedFaceSet167.texCoord = TextureCoordinate168;

let Coordinate169 = browser.currentScene.createNode("Coordinate");
Coordinate169.point = new MFVec3f(new float[-0.7458,1.679,-1.189,-1.565,1.679,0.0238,-0.6631,1.679,1.177,0.714,1.679,0.6762,0.6628,1.679,-0.7857,-0.9082,0.4486,-1.634,-2.04,0.4486,0.0404,-0.794,0.4486,1.632,1.108,0.4486,0.9413,1.037,0.4486,-1.078,-0.9397,-2.611,-1.634,-2.071,-2.611,0.0404,-0.8254,-2.611,1.632,1.076,-2.611,0.9413,1.006,-2.611,-1.078,-0.9738,-3.656,-1.728,-2.171,-3.656,0.0439,-0.8529,-3.656,1.728,1.159,-3.656,0.9971,1.084,-3.656,-1.139,-0.598,-1.86,-1.372,-1.463,-1.86,-0.3215,-1.015,-1.86,1.153,0.1265,-1.86,1.013,0.3843,-1.86,-0.5473,-0.6162,-6.896,-1.11,-1.515,-6.896,-0.2675,-1.049,-6.896,0.9149,0.1364,-6.896,0.8029,0.4042,-6.896,-0.4486,-0.6445,-10.84,-1.07,-1.509,-10.84,-0.2583,-1.062,-10.84,0.88,0.0801,-10.84,0.7722,0.3379,-10.84,-0.4327,-0.6093,-11.37,-0.6358,-1.116,-11.37,-0.1604,-0.8538,-11.37,0.5067,-0.1847,-11.37,0.4436,-0.0336,-11.37,-0.2626]);
...
HAnimJoint170.DEF = "hanim_r_elbow";
HAnimJoint170.name = "r_elbow";
HAnimJoint170.center = new SFVec3f(new float[-5.297,40.12,-2.055]);
let HAnimSegment171 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment171.DEF = "hanim_r_forearm";
HAnimSegment171.name = "r_forearm";
let Transform172 = browser.currentScene.createNode("Transform");
Transform172.translation = new SFVec3f(new float[-5.297,40.12,-2.055]);
...
ImageTexture176.USE = "JuTextureAtlas";
...
IndexedFaceSet177.creaseAngle = 1.57;
...
let TextureCoordinate178 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate178.point = new MFVec2f(new float[0.5159,0.3385,0.5159,0.3244,0.5159,0.3332,0.5159,0.3157,0.5159,0.3103,0.521,0.3428,0.521,0.3229,0.521,0.3355,0.521,0.3108,0.521,0.3029,0.5327,0.3442,0.5327,0.3231,0.5302,0.3366,0.5302,0.3103,0.5327,0.3016,0.5558,0.339,0.5558,0.323,0.5558,0.3334,0.5558,0.3141,0.5558,0.3079,0.5585,0.3232,0.5585,0.3341,0.5585,0.3302,0.5585,0.317,0.5585,0.3129]);
IndexedFaceSet177.texCoord = TextureCoordinate178;

let Coordinate179 = browser.currentScene.createNode("Coordinate");
Coordinate179.point = new MFVec3f(new float[-0.1284,0.6566,-0.794,-0.7947,0.6566,-0.1619,-0.4154,0.6566,0.757,0.4852,0.6566,0.6929,0.6626,0.6566,-0.2657,-0.0855,-0.4623,-1.129,-1.027,-0.4623,-0.281,-0.4911,-0.4623,1.171,0.7817,-0.4623,1.07,1.032,-0.4623,-0.445,-0.0941,-3.046,-1.116,-1.1,-3.046,-0.2777,-0.55,-2.481,1.16,0.8091,-2.481,1.06,1.1,-3.046,-0.4401,-0.084,-8.01,-1.171,-1.025,-7.982,-0.1359,-0.3907,-8.118,1.09,0.6003,-8.118,0.9957,0.9132,-8.109,-0.2244,-0.0434,-8.725,-0.6054,-0.5441,-8.725,0.0272,-0.2591,-8.725,0.759,0.4177,-8.725,0.6949,0.551,-8.725,-0.0767]);
...
HAnimJoint180.DEF = "hanim_r_radiocarpal";
HAnimJoint180.name = "r_radiocarpal";
HAnimJoint180.center = new SFVec3f(new float[-5.07,31.99,-1.559]);
let HAnimSegment181 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment181.DEF = "hanim_r_carpal";
HAnimSegment181.name = "r_carpal";
let Transform182 = browser.currentScene.createNode("Transform");
Transform182.translation = new SFVec3f(new float[-5.07,31.99,-1.559]);
...
ImageTexture186.USE = "JuTextureAtlas";
...
IndexedFaceSet187.creaseAngle = 1.57;
...
let TextureCoordinate188 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate188.point = new MFVec2f(new float[0.4675,0.2229,0.4534,0.3224,0.4709,0.3268,0.4579,0.2308,0.5552,0.233,0.5504,0.3288,0.6215,0.2576,0.6159,0.3282,0.478,0.1884,0.5527,0.2007,0.4618,0.1862,0.4629,0.1191,0.4583,0.192,0.4802,0.0435,0.4672,0.0405,0.5177,0.1794,0.4789,0.1246,0.4811,0.1812,0.515,0.132,0.538,0.1232,0.5459,0.0341,0.5348,0.1824,0.6006,0.1887,0.5977,0.0452,0.6323,0.1888,0.629,0.0403,0.4501,0.1899,0.4535,0.0388,0.5577,0.3108,0.5496,0.3395,0.5573,0.3333,0.5503,0.3041,0.5263,0.3468,0.527,0.2997,0.5106,0.3433,0.5113,0.3032,0.4584,0.3225,0.4544,0.2224,0.4607,0.2253,0.4525,0.325,0.5365,0.3334,0.5532,0.2053,0.6323,0.3251,0.6179,0.2145]);
IndexedFaceSet187.texCoord = TextureCoordinate188;

let Coordinate189 = browser.currentScene.createNode("Coordinate");
Coordinate189.point = new MFVec3f(new float[-0.8732,0.4437,0.6298,-0.8463,0.4584,-1.065,0.5135,0.3661,0.7037,0.5196,0.3675,-1.013,0.6654,-0.1688,1.167,-1.16,0.015,1.096,-1.119,0.0434,-1.571,0.747,-0.1537,-1.566,0.5777,-1.832,1.902,-1.387,-1.647,1.643,-1.345,-1.619,-1.902,0.8391,-1.916,-1.775,0.3897,-3.083,1.338,-0.6425,-3.283,1.382,-0.6009,-3.255,-1.636,0.5412,-3.094,-1.527,0.742,-0.1555,-0.1478,1.159,-1.873,1.533,1.387,-0.4699,0.0458,1.361,-0.5281,1.488,1.163,-1.872,0.1088,0.7494,-1.912,-0.1591]);
IndexedFaceSet187.coord = Coordinate189;
...
HAnimJoint170.children[1] = HAnimJoint180;

HAnimJoint160.children[1] = HAnimJoint170;

HAnimJoint120.children[2] = HAnimJoint160;

let HAnimJoint190 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint190.DEF = "hanim_vl5";
HAnimJoint190.name = "vl5";
HAnimJoint190.center = new SFVec3f(new float[0.000025,39.84,0.1163]);
let HAnimSegment191 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment191.DEF = "hanim_l5";
HAnimSegment191.name = "l5";
let Transform192 = browser.currentScene.createNode("Transform");
Transform192.translation = new SFVec3f(new float[0.000025,39.84,0.1163]);
...
ImageTexture196.USE = "JuTextureAtlas";
...
IndexedFaceSet197.creaseAngle = 1.57;
...
HAnimJoint200.DEF = "hanim_skullbase";
HAnimJoint200.name = "skullbase";
HAnimJoint200.center = new SFVec3f(new float[0.000025,56.07,-1.554]);
let HAnimSegment201 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment201.DEF = "hanim_skull";
HAnimSegment201.name = "skull";
let Transform202 = browser.currentScene.createNode("Transform");
Transform202.translation = new SFVec3f(new float[0.000025,56.07,-1.554]);
...
ImageTexture206.USE = "JuTextureAtlas";
...
HAnimJoint120.children[3] = HAnimJoint190;

HAnimJoint30.children[3] = HAnimJoint120;

HAnimHumanoid22.joints[1] = HAnimJoint30;

let HAnimSegment210 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment210.USE = "hanim_l5";
HAnimHumanoid22.segments[2] = HAnimSegment210;

let HAnimSegment211 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment211.USE = "hanim_pelvis";
HAnimHumanoid22.segments[3] = HAnimSegment211;

let HAnimSegment212 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment212.USE = "hanim_sacrum";
HAnimHumanoid22.segments[4] = HAnimSegment212;

let HAnimSegment213 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment213.USE = "hanim_skull";
HAnimHumanoid22.segments[5] = HAnimSegment213;

let HAnimSegment214 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment214.USE = "hanim_l_calf";
HAnimHumanoid22.segments[6] = HAnimSegment214;

let HAnimSegment215 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment215.USE = "hanim_r_calf";
HAnimHumanoid22.segments[7] = HAnimSegment215;

let HAnimSegment216 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment216.USE = "hanim_l_carpal";
HAnimHumanoid22.segments[8] = HAnimSegment216;

let HAnimSegment217 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment217.USE = "hanim_r_carpal";
HAnimHumanoid22.segments[9] = HAnimSegment217;

let HAnimSegment218 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment218.USE = "hanim_l_forearm";
HAnimHumanoid22.segments[10] = HAnimSegment218;

let HAnimSegment219 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment219.USE = "hanim_r_forearm";
HAnimHumanoid22.segments[11] = HAnimSegment219;

let HAnimSegment220 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment220.USE = "hanim_l_talus";
HAnimHumanoid22.segments[12] = HAnimSegment220;

let HAnimSegment221 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment221.USE = "hanim_r_talus";
HAnimHumanoid22.segments[13] = HAnimSegment221;

let HAnimSegment222 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment222.USE = "hanim_l_tarsal_proximal_phalanx_2";
HAnimHumanoid22.segments[14] = HAnimSegment222;

let HAnimSegment223 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment223.USE = "hanim_r_tarsal_proximal_phalanx_2";
HAnimHumanoid22.segments[15] = HAnimSegment223;

let HAnimSegment224 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment224.USE = "hanim_l_thigh";
HAnimHumanoid22.segments[16] = HAnimSegment224;

let HAnimSegment225 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment225.USE = "hanim_r_thigh";
HAnimHumanoid22.segments[17] = HAnimSegment225;

let HAnimSegment226 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment226.USE = "hanim_l_upperarm";
HAnimHumanoid22.segments[18] = HAnimSegment226;

let HAnimSegment227 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment227.USE = "hanim_r_upperarm";
HAnimHumanoid22.segments[19] = HAnimSegment227;

let HAnimJoint228 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint228.USE = "hanim_humanoid_root";
HAnimHumanoid22.joints[20] = HAnimJoint228;

let HAnimJoint229 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint229.USE = "hanim_sacroiliac";
HAnimHumanoid22.joints[21] = HAnimJoint229;

let HAnimJoint230 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint230.USE = "hanim_skullbase";
HAnimHumanoid22.joints[22] = HAnimJoint230;

let HAnimJoint231 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint231.USE = "hanim_vl5";
HAnimHumanoid22.joints[23] = HAnimJoint231;

let HAnimJoint232 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint232.USE = "hanim_l_elbow";
HAnimHumanoid22.joints[24] = HAnimJoint232;

let HAnimJoint233 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint233.USE = "hanim_r_elbow";
HAnimHumanoid22.joints[25] = HAnimJoint233;

let HAnimJoint234 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint234.USE = "hanim_l_hip";
HAnimHumanoid22.joints[26] = HAnimJoint234;

let HAnimJoint235 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint235.USE = "hanim_r_hip";
HAnimHumanoid22.joints[27] = HAnimJoint235;

let HAnimJoint236 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint236.USE = "hanim_l_knee";
HAnimHumanoid22.joints[28] = HAnimJoint236;

let HAnimJoint237 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint237.USE = "hanim_r_knee";
HAnimHumanoid22.joints[29] = HAnimJoint237;

let HAnimJoint238 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint238.USE = "hanim_l_metatarsophalangeal_2";
HAnimHumanoid22.joints[30] = HAnimJoint238;

let HAnimJoint239 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint239.USE = "hanim_r_metatarsophalangeal_2";
HAnimHumanoid22.joints[31] = HAnimJoint239;

let HAnimJoint240 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint240.USE = "hanim_l_radiocarpal";
HAnimHumanoid22.joints[32] = HAnimJoint240;

let HAnimJoint241 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint241.USE = "hanim_r_radiocarpal";
HAnimHumanoid22.joints[33] = HAnimJoint241;

let HAnimJoint242 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint242.USE = "hanim_l_shoulder";
HAnimHumanoid22.joints[34] = HAnimJoint242;

let HAnimJoint243 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint243.USE = "hanim_r_shoulder";
HAnimHumanoid22.joints[35] = HAnimJoint243;

let HAnimJoint244 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint244.USE = "hanim_l_talocrural";
HAnimHumanoid22.joints[36] = HAnimJoint244;

let HAnimJoint245 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint245.USE = "hanim_r_talocrural";
HAnimHumanoid22.joints[37] = HAnimJoint245;

...
scene.addMetaData("title", "ThreeDTexture.x3d");
scene.addMetaData("creator", "John Carlson");
scene.addMetaData("generator", "manual");
scene.addMetaData("identifier", "https://coderextreme.net/X3DJSONLD/src/main/data/ThreeDTexture.x3d");
scene.addMetaData("description", "a kind of ThreeDTexture cube with spheres");

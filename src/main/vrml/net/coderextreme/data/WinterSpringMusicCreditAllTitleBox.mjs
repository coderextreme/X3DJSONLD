...
scene.addMetaData("title", "WinterAndSpringMusicCreditAllTitleBox.x3d");
scene.addMetaData("description", "Credits for scene musics clips.");
...
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringMusicCreditAllTitleBox.x3d");
await browser .loadComponents (scene);
let WorldInfo11 = browser.currentScene.createNode("WorldInfo");
WorldInfo11.title = "WinterAndSpringMusicCreditAllTitleBox.x3d";
...
Viewpoint12.description = "Look at Music Credit title";
Viewpoint12.position = new X3D.SFVec3f([10,11,-15]);
...
Transform13.DEF = "WSMusicCreditAllTitle";
Transform13.translation = new X3D.SFVec3f([10,10,-20]);
...
ImageTexture17.url = new X3D.MFString([new X3D.SFString("images/WSMusicCreditAll.png"), new X3D.SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSMusicCreditAll.png")]);

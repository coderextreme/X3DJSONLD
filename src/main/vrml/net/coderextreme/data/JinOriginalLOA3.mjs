...
scene.addMetaData("title", "JinOriginalLOA3.x3d");
...
scene.addMetaData("reference", "JinLOA3.x3d");
...
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA3.x3d");

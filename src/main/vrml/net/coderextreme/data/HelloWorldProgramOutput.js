...
var ProtoInstance6 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("19 June 2019"))
      ...
      .setScene(new Scene()
        .addChild(new ViewpointGroup().setDescription("Available viewpoints")
          ...
          .addChild(new Viewpoint().setDEF("TopDownView").setDescription("top-down view from above").setOrientation(java.newArray("float", [1,0,0,-1.570796])).setPosition(java.newArray("float", [0,100,0]))))
        .addChild(new NavigationInfo().setType(java.newArray("java.lang.String", ["EXAMINE","FLY","ANY"])))
        ...
        .addChild(new WorldInfo().setUSE("WorldInfoDEF"))
        .addMetadata(new MetadataString().setName("test").setDEF("scene.addChildMetadata").setValue(java.newArray("java.lang.String", ["Top-level root Metadata node beneath Scene needs to be one of '-children' in JSON encoding"])))
        .addLayerSet(new LayerSet().setDEF("scene.addChildLayerSetTest"))
        .addChild(new Transform().setDEF("LogoGeometryTransform").setTranslation(java.newArray("float", [0,1.5,0]))
          .addChild(new Anchor().setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(java.newArray("java.lang.String", ["../X3DJSAIL.html","http://www.web3d.org/specifications/java/X3DJSAIL.html"]))
            .addChild(new Shape().setDEF("BoxShape")
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF("GreenMaterial").setDiffuseColor(java.newArray("float", [0,1,1])).setEmissiveColor(java.newArray("float", [0.8,0,0])).setTransparency(0.1))
                .setTexture(new ImageTexture().setUrl(java.newArray("java.lang.String", ["images/X3dJavaSceneAccessInterfaceSaiLibrary.png","http://www.web3d.org/specifications/java/examples/images/X3dJavaSceneAccessInterfaceSaiLibrary.png"]))))
              .setGeometry(new Box().setDEF("test-NMTOKEN_regex.0123456789").setCssClass("untextured")))))
        .addChild(new Shape().setDEF("LineShape")
          .setAppearance(new Appearance()
            .setMaterial(new Material().setEmissiveColor(java.newArray("float", [0.6,0.19607843,0.8]))))
          .setGeometry(new IndexedLineSet().setCoordIndex(java.newArray("int", [0,1,2,3,4,0]))
            .addComments(new CommentsBlock("Coordinate 3-tuple point count: 6"))
            .setCoord(new Coordinate().setPoint(java.newArray("float", [0,1.5,0,2,1.5,0,2,1.5,-2,-2,1.5,-2,-2,1.5,0,0,1.5,0])))))
        .addChild(new PositionInterpolator().setDEF("BoxPathAnimator").setKey(java.newArray("float", [0,0.125,0.375,0.625,0.875,1])).setKeyValue(java.newArray("float", [0,1.5,0,2,1.5,0,2,1.5,-2,-2,1.5,-2,-2,1.5,0,0,1.5,0])))
        ...
        .addChild(new Transform().setDEF("TextTransform").setTranslation(java.newArray("float", [0,-1.5,0]))
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setUSE("GreenMaterial")))
            .setGeometry(new Text().setString(java.newArray("java.lang.String", ["X3D Java","SAI Library","X3DJSAIL"]))
              ...
              .setMetadata(new MetadataSet().setName("EscapedQuotationMarksMetadataSet")
                .addValue(new MetadataString().setName("quotesTestC").setValue(java.newArray("java.lang.String", ["MFString example C, backslash-escaped quotes: He said, \"Immel did it!\""])))
                .addValue(new MetadataString().setName("extraChildTest").setValue(java.newArray("java.lang.String", ["checks MetadataSetObject addValue() method"]))))
          ...
          .addChild(new Collision()
            ...
            .setProxy(new Shape().setDEF("ProxyShape")
              ...
              .setGeometry(new Text().setString(java.newArray("java.lang.String", ["One, Two, Text","","He said, \"Immel did it!\" \"\""])))))
        ...
        .addChild(new OrientationInterpolator().setDEF("SpinInterpolator").setKey(java.newArray("float", [0,0.5,1])).setKeyValue(java.newArray("float", [0,1,0,4.712389,0,1,0,0,0,1,0,1.5707964])))
...
"}"))
          .addChild(new ColorInterpolator().setDEF("ColorAnimator").setKey(java.newArray("float", [0,0.5,1])).setKeyValue(java.newArray("float", [0.9411765,1,1,0.29411766,0,0.50980395,0.9411765,1,1]))
        ...
        .addChild(new ProtoDeclare().setName("ArtDeco01Material").setAppinfo("tooltip: ArtDeco01Material prototype is a Material node")
          ...
          .setProtoBody(new ProtoBody()
            ...
            .addChild(new Material().setAmbientIntensity(0.25).setDiffuseColor(java.newArray("float", [0.282435,0.085159,0.134462])).setShininess(0.127273).setSpecularColor(java.newArray("float", [0.276305,0.11431,0.139857])))
        ...
        .addChild(new ExternProtoDeclare().setName("ArtDeco02Material").setAppinfo("this is a different Material node").setUrl(java.newArray("java.lang.String", ["http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02Material","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02Material"]))
        ...
        .addChild(new Inline().setDEF("inlineSceneDef").setUrl(java.newArray("java.lang.String", ["someOtherScene.x3d","http://www.web3d.org/specifications/java/examples/someOtherScene.x3d"])))
...
"}"))))
        ...
        .addChild(new Group().setDEF("DeclarativeGroupExample")
          .addChild(new Shape()
            .setMetadata(new MetadataString().setName("findThisNameValue").setDEF("FindableMetadataStringTest").setValue(java.newArray("java.lang.String", ["test case"])))
        ...
        .addChild(new Sound().setLocation(java.newArray("float", [0,1.6,0]))
          .addComments(new CommentsBlock("set sound-ellipsoid location height at 1.6m to match typical avatar height"))
          .setSource(new AudioClip().setDescription("chimes").setUrl(java.newArray("java.lang.String", ["chimes.wav","http://www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/AudioClip/chimes.wav"]))
        ...
        .addChild(new Sound().setLocation(java.newArray("float", [0,1.6,0]))
          .addComments(new CommentsBlock("set sound-ellipsoid location height at 1.6m to match typical avatar height"))
          .setSource(new MovieTexture().setDescription("mpgsys.mpg from ConformanceNist suite").setUrl(java.newArray("java.lang.String", ["mpgsys.mpg","http://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpgsys.mpg"]))
        ...
        .addChild(new Shape()
          .setAppearance(new Appearance()
            ...
            .setMaterial(ProtoInstance6 = new ProtoInstance().setName("ShaderProto").setDEF("TestShader3"))
        ...
        .addChild(new Transform().setDEF("SpecialtyNodes")
          ...
          .addChild(new HAnimHumanoid().setName("TestHumanoid").setDEF("TestHumanoidDEF").setVersion("2.0"))))      ;
ProtoInstance0

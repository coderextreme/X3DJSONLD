...
let Switch9 = browser.currentScene.createNode("Switch");
Switch9.whichChoice = -1;
Switch9.bboxCenter = new SFVec3f(new float[0,0,0]);
Switch9.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Group29.bboxCenter = new SFVec3f(new float[0,0,0]);
Group29.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform42.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform42.bboxSize = new SFVec3f(new float[-1,-1,-1]);
let Shape43 = browser.currentScene.createNode("Shape");
Shape43.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape43.bboxSize = new SFVec3f(new float[-1,-1,-1]);

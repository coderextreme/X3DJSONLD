...
WorldInfo2.info = new MFString(new java.lang.String["VRML2.0 created with Version 1.3, from Alias Maya 2008"]);
WorldInfo2.title = "SimpleCamera.x3d";
browser.currentScene.children = new MFNode();

browser.currentScene.children[0] = WorldInfo2;

Viewpoint3 = browser.currentScene.createNode("Viewpoint");
Viewpoint3.DEF = "CameraShapeView";
Viewpoint3.description = "Camera view, over the shoulder";
Viewpoint3.position = new SFVec3f(new float[0,0.75,3]);
browser.currentScene.children[1] = Viewpoint3;

Viewpoint4 = browser.currentScene.createNode("Viewpoint");
Viewpoint4.description = "Camera view through lens";
Viewpoint4.position = new SFVec3f(new float[0,0,0]);
browser.currentScene.children[2] = Viewpoint4;

Viewpoint5 = browser.currentScene.createNode("Viewpoint");
Viewpoint5.description = "Camera view from right side";
Viewpoint5.orientation = new SFRotation(new float[0,1,0,1.5708]);
Viewpoint5.position = new SFVec3f(new float[12,0,-4]);
browser.currentScene.children[3] = Viewpoint5;

Viewpoint6 = browser.currentScene.createNode("Viewpoint");
Viewpoint6.description = "Camera view from above";
Viewpoint6.orientation = new SFRotation(new float[1,0,0,-1.5708]);
Viewpoint6.position = new SFVec3f(new float[0,15,-5]);
browser.currentScene.children[4] = Viewpoint6;

Viewpoint7 = browser.currentScene.createNode("Viewpoint");
Viewpoint7.description = "Camera view from left side";
Viewpoint7.orientation = new SFRotation(new float[0,1,0,-1.5708]);
Viewpoint7.position = new SFVec3f(new float[-12,0,-4]);
browser.currentScene.children[5] = Viewpoint7;

Transform8 = browser.currentScene.createNode("Transform");
Transform8.scale = new SFVec3f(new float[0.1,0.1,0.1]);
Transform8.translation = new SFVec3f(new float[0,-0.165,0.02]);
Switch9 = browser.currentScene.createNode("Switch");
Switch9.whichChoice = -1;
Shape10 = browser.currentScene.createNode("Shape");
Appearance11 = browser.currentScene.createNode("Appearance");
Appearance11.DEF = "CameraAppearance";
Material12 = browser.currentScene.createNode("Material");
Material12.DEF = "lambert1_0";
Material12.ambientIntensity = 0.25;
...
IndexedFaceSet14.DEF = "pCylinder1_0Geo";
...
IndexedFaceSet14.creaseAngle = 0.7854;
Coordinate15 = browser.currentScene.createNode("Coordinate");
Coordinate15.DEF = "pCylinder1GeoPoints";
Coordinate15.point = new MFVec3f(new float[-0.36,-2.39,-0.26,-0.36,-1.77,-0.89,-0.36,0,-1.7,-0.36,0.85,-1.47,-0.36,1.47,-0.85,-0.36,1.7,0,-0.36,1.47,0.85,-0.36,-0.07,2.05,-0.36,-0.92,2.28,-0.36,-1.77,2.05,-0.36,-2.39,1.43,-0.36,-2.62,0.58,0.36,-2.39,-0.26,0.36,-1.77,-0.89,0.36,0,-1.7,0.36,0.85,-1.47,0.36,1.47,-0.85,0.36,1.7,0,0.36,1.47,0.85,0.36,-0.07,2.05,0.36,-0.92,2.28,0.36,-1.77,2.05,0.36,-2.39,1.43,0.36,-2.62,0.58,-0.36,-0.46,0.31,0.36,-0.46,0.31]);
...
Appearance16.USE = "CameraAppearance";
Shape13.appearance = Appearance16;

Switch9.children[1] = Shape13;

Shape17 = browser.currentScene.createNode("Shape");
IndexedFaceSet18 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet18.DEF = "pCube1_0Geo";
...
Appearance20.USE = "CameraAppearance";
Shape17.appearance = Appearance20;

Switch9.children[2] = Shape17;

Shape21 = browser.currentScene.createNode("Shape");
IndexedFaceSet22 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet22.DEF = "pPipe1_0Geo";
...
Switch9.children[4] = Shape25;

Transform8.children = new MFNode();

Transform8.children[0] = Switch9;

Group29 = browser.currentScene.createNode("Group");
Transform30 = browser.currentScene.createNode("Transform");
Transform30.DEF = "pCylinder1";
Transform30.rotation = new SFRotation(new float[-1,0,0,0.373518]);
Transform30.translation = new SFVec3f(new float[-0.038462,3.596312,3.297562]);
Shape31 = browser.currentScene.createNode("Shape");
Appearance32 = browser.currentScene.createNode("Appearance");
Appearance32.USE = "CameraAppearance";
Shape31.appearance = Appearance32;

IndexedFaceSet33 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet33.USE = "pCylinder1_0Geo";
Shape31.geometry = IndexedFaceSet33;
...
Group29.children[0] = Transform30;

Transform34 = browser.currentScene.createNode("Transform");
Transform34.DEF = "pCube1";
Transform34.scale = new SFVec3f(new float[1,0.727134,0.801457]);
Transform34.translation = new SFVec3f(new float[-0.030769,1.738461,1.4436]);
...
IndexedFaceSet37.USE = "pCube1_0Geo";
Shape35.geometry = IndexedFaceSet37;

Transform34.children = new MFNode();

Transform34.children[0] = Shape35;

Group29.children[1] = Transform34;

Transform38 = browser.currentScene.createNode("Transform");
Transform38.DEF = "pPipe1";
Transform38.scale = new SFVec3f(new float[1,1,0.569444]);
Transform38.translation = new SFVec3f(new float[0.015385,1.630769,-1.973274]);
...
IndexedFaceSet41 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet41.USE = "pPipe1_0Geo";
Shape39.geometry = IndexedFaceSet41;

Transform38.children = new MFNode();

Transform38.children[0] = Shape39;

Group29.children[2] = Transform38;

Transform42 = browser.currentScene.createNode("Transform");
Transform42.DEF = "pSphere1";
Transform42.scale = new SFVec3f(new float[1.1,1.1,0.1]);
Transform42.translation = new SFVec3f(new float[-0.015385,1.628515,-2.569231]);
Shape43 = browser.currentScene.createNode("Shape");
Appearance44 = browser.currentScene.createNode("Appearance");
Appearance44.USE = "CameraAppearance";
Shape43.appearance = Appearance44;

IndexedFaceSet45 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet45.USE = "pSphere1_0Geo";
...
Group29.children[3] = Transform42;

Transform8.children[1] = Group29;

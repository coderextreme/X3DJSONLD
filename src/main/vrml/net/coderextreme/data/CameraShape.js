...
scene.addMetaData("title", "CameraShape.x3d");
scene.addMetaData("description", "Simple video camera shape");
scene.addMetaData("creator", "Jeff Weekley and Don Brutzman");
scene.addMetaData("created", "2 June 2009");
scene.addMetaData("translated", "2 June 2009");
scene.addMetaData("modified", "13 January 2014");
scene.addMetaData("reference", "CameraExamples.x3d");
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/Basic/development/SimpleCamera.x3d");
...
WorldInfo14.info = new X3D.MFString([new X3D.SFString("VRML2.0 created with Version 1.3, from Alias Maya 2008")]);
...
Viewpoint15.position = new X3D.SFVec3f([0,0.75,3]);
...
Viewpoint16.position = new X3D.SFVec3f([0,0,0]);
...
Viewpoint17.orientation = new X3D.SFRotation([0,1,0,1.5708]);
Viewpoint17.position = new X3D.SFVec3f([12,0,-4]);
...
Viewpoint18.orientation = new X3D.SFRotation([1,0,0,-1.5708]);
Viewpoint18.position = new X3D.SFVec3f([0,15,-5]);
browser.currentScene.children[4] = Viewpoint18;

let Viewpoint19 = browser.currentScene.createNode("Viewpoint");
Viewpoint19.description = "Camera view from left side";
Viewpoint19.orientation = new X3D.SFRotation([0,1,0,-1.5708]);
Viewpoint19.position = new X3D.SFVec3f([-12,0,-4]);
browser.currentScene.children[5] = Viewpoint19;

let Transform20 = browser.currentScene.createNode("Transform");
Transform20.scale = new X3D.SFVec3f([0.1,0.1,0.1]);
Transform20.translation = new X3D.SFVec3f([0,-0.165,0.02]);
let Switch21 = browser.currentScene.createNode("Switch");
...
Material24.diffuseColor = new X3D.SFColor([0.372322,0.371574,0.373173]);
Material24.shininess = 0.02;
Material24.specularColor = new X3D.SFColor([0.890909,0.887832,0.890909]);
//Universal Media Library: Metals 30
material = Material24;

appearance = Appearance23;

Switch21YYY.children = new X3D.MFNode();

Switch21ZZZ.children[0] = Shape22;
...
Coordinate27.point = new X3D.MFVec3f([-0.36,-2.39,-0.26,-0.36,-1.77,-0.89,-0.36,0,-1.7,-0.36,0.85,-1.47,-0.36,1.47,-0.85,-0.36,1.7,0,-0.36,1.47,0.85,-0.36,-0.07,2.05,-0.36,-0.92,2.28,-0.36,-1.77,2.05,-0.36,-2.39,1.43,-0.36,-2.62,0.58,0.36,-2.39,-0.26,0.36,-1.77,-0.89,0.36,0,-1.7,0.36,0.85,-1.47,0.36,1.47,-0.85,0.36,1.7,0,0.36,1.47,0.85,0.36,-0.07,2.05,0.36,-0.92,2.28,0.36,-1.77,2.05,0.36,-2.39,1.43,0.36,-2.62,0.58,-0.36,-0.46,0.31,0.36,-0.46,0.31]);
coord = Coordinate27;

geometry = IndexedFaceSet26;

let Appearance28 = browser.currentScene.createNode("Appearance");
Appearance28.USE = "CameraAppearance";
appearance = Appearance28;

Switch21ZZZ.children[1] = Shape25;
...
Switch21ZZZ.children[3] = Shape33;
...
Switch21ZZZ.children[4] = Shape37;

Transform20YYY.children = new X3D.MFNode();

Transform20ZZZ.children[0] = Switch21;
...
Transform42.rotation = new X3D.SFRotation([-1,0,0,0.373518]);
Transform42.translation = new X3D.SFVec3f([-0.038462,3.596312,3.297562]);
...
Group41YYY.children = new X3D.MFNode();

Group41ZZZ.children[0] = Transform42;

let Transform46 = browser.currentScene.createNode("Transform");
Transform46.DEF = "pCube1";
Transform46.scale = new X3D.SFVec3f([1,0.727134,0.801457]);
Transform46.translation = new X3D.SFVec3f([-0.030769,1.738461,1.4436]);
...
Group41ZZZ.children[1] = Transform46;

let Transform50 = browser.currentScene.createNode("Transform");
Transform50.DEF = "pPipe1";
Transform50.scale = new X3D.SFVec3f([1,1,0.569444]);
Transform50.translation = new X3D.SFVec3f([0.015385,1.630769,-1.973274]);
...
Group41ZZZ.children[2] = Transform50;

let Transform54 = browser.currentScene.createNode("Transform");
Transform54.DEF = "pSphere1";
Transform54.scale = new X3D.SFVec3f([1.1,1.1,0.1]);
Transform54.translation = new X3D.SFVec3f([-0.015385,1.628515,-2.569231]);
...
Group41ZZZ.children[3] = Transform54;

Transform20ZZZ.children[1] = Group41;

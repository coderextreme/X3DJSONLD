...
WorldInfo2.info = ["VRML2.0 created with Version 1.3, from Alias Maya 2008"];
...
Viewpoint5.orientation = [0,1,0,1.5708];
Viewpoint5.position = [12,0,-4];
...
Viewpoint6.orientation = [1,0,0,-1.5708];
Viewpoint6.position = [0,15,-5];
...
Viewpoint7.orientation = [0,1,0,-1.5708];
Viewpoint7.position = [-12,0,-4];
browser.currentScene.children[5] = Viewpoint7;

Transform8 = browser.currentScene.createNode("Transform");
Transform8.scale = [0.1,0.1,0.1];
Transform8.translation = [0,-0.165,0.02];
...
Material12.diffuseColor = [0.372322,0.371574,0.373173];
Material12.shininess = 0.02;
Material12.specularColor = [0.890909,0.887832,0.890909];
...
Coordinate15.point = [-0.36,-2.39,-0.26,-0.36,-1.77,-0.89,-0.36,0,-1.7,-0.36,0.85,-1.47,-0.36,1.47,-0.85,-0.36,1.7,0,-0.36,1.47,0.85,-0.36,-0.07,2.05,-0.36,-0.92,2.28,-0.36,-1.77,2.05,-0.36,-2.39,1.43,-0.36,-2.62,0.58,0.36,-2.39,-0.26,0.36,-1.77,-0.89,0.36,0,-1.7,0.36,0.85,-1.47,0.36,1.47,-0.85,0.36,1.7,0,0.36,1.47,0.85,0.36,-0.07,2.05,0.36,-0.92,2.28,0.36,-1.77,2.05,0.36,-2.39,1.43,0.36,-2.62,0.58,-0.36,-0.46,0.31,0.36,-0.46,0.31];
...
Transform30.rotation = [-1,0,0,0.373518];
Transform30.translation = [-0.038462,3.596312,3.297562];
...
Transform34.scale = [1,0.727134,0.801457];
Transform34.translation = [-0.030769,1.738461,1.4436];
...
Transform38.scale = [1,1,0.569444];
Transform38.translation = [0.015385,1.630769,-1.973274];
...
Transform42.scale = [1.1,1.1,0.1];
Transform42.translation = [-0.015385,1.628515,-2.569231];

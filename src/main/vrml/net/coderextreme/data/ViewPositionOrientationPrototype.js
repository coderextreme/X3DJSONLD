...
"}"))
        ...
        .addChild(new Viewpoint().setDescription("ViewPositionOrientation prototype").setPosition(java.newArray("float", [0,0,14])))
        .addChild(new Anchor().setDescription("ViewPositionOrientation Example").setParameter(java.newArray("java.lang.String", ["target=_blank"])).setUrl(java.newArray("java.lang.String", ["ViewPositionOrientationExample.x3d","https://savage.nps.edu/Savage/Tools/Authoring/ViewPositionOrientationExample.x3d","ViewPositionOrientationExample.wrl","https://savage.nps.edu/Savage/Tools/Authoring/ViewPositionOrientationExample.wrl"]))
          .addChild(new Shape()
            .setGeometry(new Text().setString(java.newArray("java.lang.String", ["ViewPositionOrientationPrototype","is a prototype definition file","","Click this text to see","ViewPositionOrientationExample"]))
              .setFontStyle(new FontStyle().setJustify(java.newArray("java.lang.String", ["MIDDLE","MIDDLE"])).setSize(1.2)))
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(java.newArray("float", [0.6,0.8,0.4])))))
          ...
          .addChild(new Shape()
            ...
            .setGeometry(new Box().setSize(java.newArray("float", [16,7,0.001])))
            .setAppearance(new Appearance()

...
scene.addMetaData("title", "DiamondManLOA_2.x3d");
scene.addMetaData("description", "hanim skeletal structure at level of articulation two, one diamond at the base node for the structure");
...
scene.addMetaData("reference", "../Templates/DiamondManLOA_2.x3d");
...
scene.addMetaData("Image", "DiamondManLOA_2.png");
...
Viewpoint21.position = new X3D.SFVec3f([0,1,3]);
Viewpoint21.centerOfRotation = new X3D.SFVec3f([0,1,0]);
browser.currentScene.children[2] = Viewpoint21;

let Transform22 = browser.currentScene.createNode("Transform");
Transform22.translation = new X3D.SFVec3f([1,1.5,0]);
...
Material26.diffuseColor = new X3D.SFColor([0.9,0.9,0.9]);
material = Material26;

appearance = Appearance25;

let Text27 = browser.currentScene.createNode("Text");
Text27.string = new X3D.MFString([new X3D.SFString("Diamond Man Key")]);
let FontStyle28 = browser.currentScene.createNode("FontStyle");
FontStyle28.family = new X3D.MFString([new X3D.SFString("SANS")]);
FontStyle28.size = 0.1;
fontStyle = FontStyle28;

geometry = Text27;

Billboard23YYY.children = new X3D.MFNode();

Billboard23ZZZ.children[0] = Shape24;

let Transform29 = browser.currentScene.createNode("Transform");
Transform29.translation = new X3D.SFVec3f([0,-0.3,0]);
...
Material32.diffuseColor = new X3D.SFColor([1,0,0]);
material = Material32;
...
Transform34.translation = new X3D.SFVec3f([0.2,0,0]);
...
Text38.string = new X3D.MFString([new X3D.SFString("Minimal Humanoid Joints")]);
let FontStyle39 = browser.currentScene.createNode("FontStyle");
FontStyle39.family = new X3D.MFString([new X3D.SFString("SANS")]);
...
Transform29ZZZ.children[1] = Transform34;

Billboard23ZZZ.children[1] = Transform29;

let Transform40 = browser.currentScene.createNode("Transform");
Transform40.translation = new X3D.SFVec3f([0,-0.5,0]);
...
Material43.diffuseColor = new X3D.SFColor([1,1,0]);
material = Material43;
...
Transform45.translation = new X3D.SFVec3f([0.2,0,0]);
...
Text49.string = new X3D.MFString([new X3D.SFString("Humanoid Joints")]);
let FontStyle50 = browser.currentScene.createNode("FontStyle");
FontStyle50.family = new X3D.MFString([new X3D.SFString("SANS")]);
...
Transform40ZZZ.children[1] = Transform45;

Billboard23ZZZ.children[2] = Transform40;

let Transform51 = browser.currentScene.createNode("Transform");
Transform51.translation = new X3D.SFVec3f([0,-0.7,0]);
...
Material54.diffuseColor = new X3D.SFColor([1,0,1]);
material = Material54;
...
Transform56.translation = new X3D.SFVec3f([0.2,0,0]);
...
Text60.string = new X3D.MFString([new X3D.SFString("Recommended Spinal Joints")]);
...
Transform51ZZZ.children[1] = Transform56;

Billboard23ZZZ.children[3] = Transform51;

let Transform62 = browser.currentScene.createNode("Transform");
Transform62.translation = new X3D.SFVec3f([0,-0.9,0]);
...
Transform67.translation = new X3D.SFVec3f([0.2,0,0]);
...
Text71.string = new X3D.MFString([new X3D.SFString("Spinal Joints")]);
let FontStyle72 = browser.currentScene.createNode("FontStyle");
FontStyle72.family = new X3D.MFString([new X3D.SFString("SANS")]);
FontStyle72.size = 0.1;
fontStyle = FontStyle72;
...
Transform62ZZZ.children[1] = Transform67;

Billboard23ZZZ.children[4] = Transform62;

let Transform73 = browser.currentScene.createNode("Transform");
Transform73.translation = new X3D.SFVec3f([0,-1.3,0]);
...
Material76.diffuseColor = new X3D.SFColor([0,0,1]);
material = Material76;
...
Transform78.translation = new X3D.SFVec3f([0.2,0,0]);
...
Text82.string = new X3D.MFString([new X3D.SFString("Humanoid Sites")]);
let FontStyle83 = browser.currentScene.createNode("FontStyle");
FontStyle83.family = new X3D.MFString([new X3D.SFString("SANS")]);
...
Transform73ZZZ.children[1] = Transform78;

Billboard23ZZZ.children[5] = Transform73;

let Transform84 = browser.currentScene.createNode("Transform");
Transform84.translation = new X3D.SFVec3f([0,-1.1,0]);
...
Material87.diffuseColor = new X3D.SFColor([0,1,1]);
material = Material87;

appearance = Appearance86;

let Sphere88 = browser.currentScene.createNode("Sphere");
...
Transform89.translation = new X3D.SFVec3f([0.2,0,0]);
...
Text93.string = new X3D.MFString([new X3D.SFString("Hand & Feet Joints")]);
let FontStyle94 = browser.currentScene.createNode("FontStyle");
FontStyle94.family = new X3D.MFString([new X3D.SFString("SANS")]);
FontStyle94.size = 0.1;
fontStyle = FontStyle94;
...
Transform84ZZZ.children[1] = Transform89;

Billboard23ZZZ.children[6] = Transform84;

Transform22YYY.children = new X3D.MFNode();

Transform22ZZZ.children[0] = Billboard23;

browser.currentScene.children[3] = Transform22;

let HAnimHumanoid95 = browser.currentScene.createNode("HAnimHumanoid");
HAnimHumanoid95.DEF = "hanim_humanoid";
HAnimHumanoid95.name = "humanoid";
HAnimHumanoid95.version = "1.0";
let MetadataSet96 = browser.currentScene.createNode("MetadataSet");
...
MetadataSet96.value = new X3D.MFNode();

MetadataSet96XXX.value[0] = MetadataString97;

HAnimHumanoid95.metadata = new X3D.SFNode();

HAnimHumanoid95XXX.metadata[0] = MetadataSet96;
...
browser.currentScene.children[4] = HAnimHumanoid95;

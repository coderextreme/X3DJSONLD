...
<ProtoBody><Transform><IS><connect nodeField="translation" protoField="pos"></connect>
</IS>
<Shape><Appearance><Material transparency="0.200000002980232" diffuseColor="0.5 0 1"></Material>
</Appearance>
...
connect13.nodeField = "translation";
connect13.protoField = "pos";
...
Material16.transparency = 0.200000002980232;
Material16.diffuseColor = new SFColor(new float[0.5,0,1]);
Appearance15.material = Material16;

Shape14.appearance = Appearance15;

let IndexedFaceSet17 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet17.coordIndex = new MFInt32(new int[0,1,4,-1,1,2,4,-1,2,3,4,-1,3,0,4,-1,0,3,2,1,-1]);
let Coordinate18 = browser.currentScene.createNode("Coordinate");
Coordinate18.point = new MFVec3f(new float[-0.349999994039536,-0.349999994039536,0.349999994039536,0.349999994039536,-0.349999994039536,0.349999994039536,0.349999994039536,-0.349999994039536,-0.349999994039536,-0.349999994039536,-0.349999994039536,-0.349999994039536,0,0.349999994039536,0]);
...
Transform11.children[0] = Shape14;
...
<Shape><Appearance><Material transparency="0.200000002980232" diffuseColor="1 1 0"></Material>
</Appearance>
...
Material28.transparency = 0.200000002980232;
Material28.diffuseColor = new SFColor(new float[1,1,0]);
Appearance27.material = Material28;

Shape26.appearance = Appearance27;

let Box29 = browser.currentScene.createNode("Box");
Box29.size = new SFVec3f(new float[0.699999988079071,0.699999988079071,0.699999988079071]);
Shape26.geometry = Box29;

Transform23.children = new MFNode();

Transform23.children[0] = Shape26;
...
<Shape><Appearance><Material diffuseColor="1 1 0"></Material>
</Appearance>
<Sphere containerField="geometry" radius="5.699999988079071"></Sphere>
</Shape>
</Transform>
</ProtoBody>
</ProtoDeclare>`);
...
connect36.nodeField = "translation";
...
Sphere40.radius = 5.699999988079071;
Shape37.geometry = Sphere40;

Transform34.children = new MFNode();

Transform34.children[0] = Shape37;
...
<Shape><Appearance><Material diffuseColor="0 1 1" transparency="0.400000005960464"><IS><connect nodeField="emissiveColor" protoField="col"></connect>
</IS>
</Material>
</Appearance>
...
Material51.diffuseColor = new SFColor(new float[0,1,1]);
Material51.transparency = 0.400000005960464;
let IS52 = browser.currentScene.createNode("IS");
let connect53 = browser.currentScene.createNode("connect");
connect53.nodeField = "emissiveColor";
connect53.protoField = "col";
...
Transform46.children[0] = Shape49;

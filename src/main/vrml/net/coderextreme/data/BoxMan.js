...
Script206.field = new MFNode();

Script206.field[0] = field207;

let field208 = browser.currentScene.createNode("field");
field208.name = "humanoid";
field208.accessType = "initializeOnly";
field208.type = "SFNode";
let HAnimHumanoid209 = browser.currentScene.createNode("HAnimHumanoid");
HAnimHumanoid209.USE = "boxman_Humanoid";
field208.children = new MFNode();

field208.children[0] = HAnimHumanoid209;

Script206.field[1] = field208;

let field210 = browser.currentScene.createNode("field");
field210.name = "coordList";
field210.accessType = "initializeOnly";
field210.type = "MFVec3f";
Script206.field[2] = field210;

let field211 = browser.currentScene.createNode("field");
field211.name = "joint";
field211.accessType = "initializeOnly";
field211.type = "SFNode";
//initialization node (if any) goes here
Script206.field[3] = field211;

let field212 = browser.currentScene.createNode("field");
field212.name = "translation";
field212.accessType = "initializeOnly";
field212.type = "SFVec3f";
field212.value = "0 0 0";
Script206.field[4] = field212;

let field213 = browser.currentScene.createNode("field");
field213.name = "rotation";
field213.accessType = "initializeOnly";
field213.type = "SFRotation";
field213.value = "1 0 0 0";
Script206.field[5] = field213;

let field214 = browser.currentScene.createNode("field");
field214.name = "scale";
field214.accessType = "initializeOnly";
field214.type = "SFVec3f";
field214.value = "1 1 1";
Script206.field[6] = field214;

browser.currentScene.children[23] = Script206;

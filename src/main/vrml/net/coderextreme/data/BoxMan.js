...
HAnimJoint12.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimJoint12.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimJoint20.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimJoint20.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite28.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite28.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite49.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite49.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform53.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform53.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform57.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform57.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite59.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite59.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform63.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform63.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite73.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite73.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform77.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform77.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform81.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform81.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite87.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite87.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Group90.bboxCenter = new SFVec3f(new float[0,0,0]);
Group90.bboxSize = new SFVec3f(new float[-1,-1,-1]);
let Shape91 = browser.currentScene.createNode("Shape");
Shape91.DEF = "TrouserSkin";
Shape91.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape91.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Shape96.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape96.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Shape101.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape101.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite155.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite155.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
field162.type = "SFTime";
ExternProtoDeclare161.field = new MFNode();

ExternProtoDeclare161.field[0] = field162;
...
ExternProtoDeclare161.field[24] = field186;

browser.currentScene.children[3] = ExternProtoDeclare161;

let ProtoInstance187 = browser.currentScene.createNode("ProtoInstance");
ProtoInstance187.name = "LOA1_WalkAnimation";
ProtoInstance187.DEF = "ANIMATOR";
browser.currentScene.children[4] = ProtoInstance187;
...
ROUTE190.fromField = "l_hip_rotation_changed";
ROUTE190.fromNode = "ANIMATOR";
ROUTE190.toField = "set_rotation";
ROUTE190.toNode = "boxman_l_hip";
browser.currentScene.children[7] = ROUTE190;

let ROUTE191 = browser.currentScene.createNode("ROUTE");
ROUTE191.fromField = "l_knee_rotation_changed";
ROUTE191.fromNode = "ANIMATOR";
ROUTE191.toField = "set_rotation";
ROUTE191.toNode = "boxman_l_knee";
browser.currentScene.children[8] = ROUTE191;

let ROUTE192 = browser.currentScene.createNode("ROUTE");
ROUTE192.fromField = "l_ankle_rotation_changed";
ROUTE192.fromNode = "ANIMATOR";
ROUTE192.toField = "set_rotation";
ROUTE192.toNode = "boxman_l_ankle";
browser.currentScene.children[9] = ROUTE192;

let ROUTE193 = browser.currentScene.createNode("ROUTE");
ROUTE193.fromField = "l_midtarsal_rotation_changed";
ROUTE193.fromNode = "ANIMATOR";
ROUTE193.toField = "set_rotation";
ROUTE193.toNode = "boxman_l_midtarsal";
browser.currentScene.children[10] = ROUTE193;

let ROUTE194 = browser.currentScene.createNode("ROUTE");
ROUTE194.fromField = "r_hip_rotation_changed";
ROUTE194.fromNode = "ANIMATOR";
ROUTE194.toField = "set_rotation";
ROUTE194.toNode = "boxman_r_hip";
browser.currentScene.children[11] = ROUTE194;

let ROUTE195 = browser.currentScene.createNode("ROUTE");
ROUTE195.fromField = "r_knee_rotation_changed";
ROUTE195.fromNode = "ANIMATOR";
ROUTE195.toField = "set_rotation";
ROUTE195.toNode = "boxman_r_knee";
browser.currentScene.children[12] = ROUTE195;

let ROUTE196 = browser.currentScene.createNode("ROUTE");
ROUTE196.fromField = "r_ankle_rotation_changed";
ROUTE196.fromNode = "ANIMATOR";
ROUTE196.toField = "set_rotation";
ROUTE196.toNode = "boxman_r_ankle";
browser.currentScene.children[13] = ROUTE196;

let ROUTE197 = browser.currentScene.createNode("ROUTE");
ROUTE197.fromField = "r_midtarsal_rotation_changed";
ROUTE197.fromNode = "ANIMATOR";
ROUTE197.toField = "set_rotation";
ROUTE197.toNode = "boxman_r_midtarsal";
browser.currentScene.children[14] = ROUTE197;

let ROUTE198 = browser.currentScene.createNode("ROUTE");
ROUTE198.fromField = "vl5_rotation_changed";
ROUTE198.fromNode = "ANIMATOR";
ROUTE198.toField = "set_rotation";
ROUTE198.toNode = "boxman_vl5";
browser.currentScene.children[15] = ROUTE198;

let ROUTE199 = browser.currentScene.createNode("ROUTE");
ROUTE199.fromField = "skullbase_rotation_changed";
ROUTE199.fromNode = "ANIMATOR";
ROUTE199.toField = "set_rotation";
ROUTE199.toNode = "boxman_skullbase";
browser.currentScene.children[16] = ROUTE199;

let ROUTE200 = browser.currentScene.createNode("ROUTE");
ROUTE200.fromField = "l_shoulder_rotation_changed";
ROUTE200.fromNode = "ANIMATOR";
ROUTE200.toField = "set_rotation";
ROUTE200.toNode = "boxman_l_shoulder";
browser.currentScene.children[17] = ROUTE200;

let ROUTE201 = browser.currentScene.createNode("ROUTE");
ROUTE201.fromField = "l_elbow_rotation_changed";
ROUTE201.fromNode = "ANIMATOR";
ROUTE201.toField = "set_rotation";
ROUTE201.toNode = "boxman_l_elbow";
browser.currentScene.children[18] = ROUTE201;

let ROUTE202 = browser.currentScene.createNode("ROUTE");
ROUTE202.fromField = "l_wrist_rotation_changed";
ROUTE202.fromNode = "ANIMATOR";
ROUTE202.toField = "set_rotation";
ROUTE202.toNode = "boxman_l_wrist";
browser.currentScene.children[19] = ROUTE202;

let ROUTE203 = browser.currentScene.createNode("ROUTE");
ROUTE203.fromField = "r_shoulder_rotation_changed";
ROUTE203.fromNode = "ANIMATOR";
ROUTE203.toField = "set_rotation";
ROUTE203.toNode = "boxman_r_shoulder";
browser.currentScene.children[20] = ROUTE203;

let ROUTE204 = browser.currentScene.createNode("ROUTE");
ROUTE204.fromField = "r_elbow_rotation_changed";
ROUTE204.fromNode = "ANIMATOR";
ROUTE204.toField = "set_rotation";
ROUTE204.toNode = "boxman_r_elbow";
browser.currentScene.children[21] = ROUTE204;

let ROUTE205 = browser.currentScene.createNode("ROUTE");
ROUTE205.fromField = "r_wrist_rotation_changed";
ROUTE205.fromNode = "ANIMATOR";
ROUTE205.toField = "set_rotation";
ROUTE205.toNode = "boxman_r_wrist";

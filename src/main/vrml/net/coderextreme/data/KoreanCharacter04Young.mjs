...
HAnimHumanoid22.DEF = "hanim_Young";
...
HAnimJoint25.center = new SFVec3f(new float[0,31.54,-0.3172]);
...
Transform27.translation = new SFVec3f(new float[0,31.54,-0.3172]);
...
ImageTexture31.DEF = "YoungTextureAtlas";
ImageTexture31.url = new MFString(new java.lang.String["images/Young.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Young.png"]);
...
HAnimJoint35.center = new SFVec3f(new float[3.504,29.04,-0.4027]);
...
Transform37.translation = new SFVec3f(new float[3.504,29.04,-0.4027]);
...
ImageTexture41.USE = "YoungTextureAtlas";
...
HAnimJoint45.center = new SFVec3f(new float[3.414,14.95,-0.4549]);
...
Transform47.translation = new SFVec3f(new float[3.414,14.95,-0.4549]);
...
ImageTexture51.USE = "YoungTextureAtlas";
...
Coordinate54.point = new MFVec3f(new float[0.6335,1.142,0.0206,0.3202,1.142,0.8245,-0.3837,1.142,0.9871,-0.9483,1.142,0.5315,-0.9483,1.142,-0.3447,-0.3837,1.142,-0.8003,0.3202,1.142,-0.6377,2.06,-3.778,0.0206,1.287,-2.905,1.78,1.089,-1.147,2.133,1.867,-1.397,0.0206,-0.715,-2.905,2.263,-0.6583,-1.147,2.559,-1.987,-3.778,1.106,-2.06,-1.397,0.8632,-1.987,-4.457,-1.205,-2.06,-1.397,-0.822,-0.715,-4.457,-2.559,-0.6583,-1.397,-2.087,1.287,-4.457,-2.076,1.089,-1.397,-1.661,0.9877,0.2851,1.672,1.704,0.2851,0.0206,-0.622,0.2851,2.043,-1.913,0.2851,1.002,-1.913,0.2851,-0.8149,-0.622,0.2851,-1.817,0.9877,0.2851,-1.445,1.417,-11.1,0.0028,0.8123,-11.09,1.38,-0.5457,-11.09,1.72,-1.635,-11.1,0.767,-1.635,-11.11,-0.8605,-0.5457,-11.11,-1.535,0.8123,-11.11,-1.195,0.6234,-12.52,0.021,0.3177,-12.52,0.7175,-0.3691,-12.52,0.8896,-0.9199,-12.52,0.4076,-0.9199,-12.53,-0.4156,-0.3691,-12.53,-0.7569,0.3177,-12.53,-0.5849]);
...
HAnimJoint55.center = new SFVec3f(new float[3.18,3.449,-0.3088]);
...
Transform57.translation = new SFVec3f(new float[3.18,3.449,-0.3088]);
...
ImageTexture61.USE = "YoungTextureAtlas";
...
HAnimJoint65.center = new SFVec3f(new float[3.18,3.189,0.9724]);
...
Transform67.translation = new SFVec3f(new float[3.18,3.189,0.9724]);
...
ImageTexture71.USE = "YoungTextureAtlas";
...
HAnimJoint75.center = new SFVec3f(new float[-3.504,29.04,-0.4027]);
...
Transform77.translation = new SFVec3f(new float[-3.504,29.04,-0.4027]);
...
ImageTexture81.USE = "YoungTextureAtlas";
...
Coordinate84.point = new MFVec3f(new float[-2.61,2.495,-0.0096,-1.449,2.495,2.819,1.16,2.495,3.518,2.968,2.495,1.56,2.968,2.495,-1.58,1.16,2.495,-3.537,-1.449,2.495,-2.839,-2.61,-0.8104,-0.0096,-1.449,-0.8104,2.819,1.16,-0.8104,3.518,2.968,-0.8104,1.56,2.968,-0.8104,-1.58,1.16,-0.8104,-3.537,-1.449,-0.8104,-2.839,-2.61,-3.375,-0.0096,-1.449,-3.375,2.819,1.16,-3.375,3.518,2.968,-3.375,1.56,2.968,-3.375,-1.58,1.16,-3.375,-3.537,-1.449,-3.375,-2.839,-2.968,-6.68,-0.0096,-1.672,-6.68,3.148,1.24,-6.68,3.928,2.957,-6.68,1.743,2.957,-6.68,-1.762,1.24,-6.68,-3.947,-1.672,-6.68,-3.167,-1.892,-5.194,-0.0096,-1.001,-5.194,2.161,1.001,-5.194,2.697,2.321,-5.194,1.195,2.321,-5.194,-1.214,1.001,-5.194,-2.716,-1.001,-5.194,-2.18,-1.9,-10.89,-0.0096,-1.08,-10.89,1.714,0.7636,-10.89,2.14,2.242,-10.89,0.9472,2.242,-10.89,-0.9663,0.7636,-10.89,-2.159,-1.08,-10.89,-1.734,-1.807,4.249,-0.0096,-0.9484,4.249,2.084,0.982,4.249,2.601,2.53,4.249,1.152,2.53,4.249,-1.171,0.982,4.249,-2.62,-0.9484,4.249,-2.103,-1.624,-14.13,-0.0096,-0.9076,-14.13,1.641,0.7021,-14.13,2.013,1.993,-14.13,0.9715,1.993,-14.13,-0.8451,0.7021,-14.13,-1.887,-0.9076,-14.13,-1.515,-0.5533,-14.99,-0.0096,-0.2401,-14.99,0.7943,0.4639,-14.99,0.9569,1.028,-14.99,0.5013,1.028,-14.99,-0.3749,0.4639,-14.99,-0.8305,-0.2401,-14.99,-0.6679]);
...
HAnimJoint85.center = new SFVec3f(new float[-3.414,14.95,-0.4549]);
...
Transform87.translation = new SFVec3f(new float[-3.414,14.95,-0.4549]);
...
ImageTexture91.USE = "YoungTextureAtlas";
...
HAnimJoint95.center = new SFVec3f(new float[-3.18,3.449,-0.3088]);
...
Transform97.translation = new SFVec3f(new float[-3.18,3.449,-0.3088]);
...
ImageTexture101.USE = "YoungTextureAtlas";
...
HAnimJoint105.center = new SFVec3f(new float[-3.18,3.189,0.9724]);
...
Transform107.translation = new SFVec3f(new float[-3.18,3.189,0.9724]);
...
ImageTexture111.USE = "YoungTextureAtlas";
...
HAnimJoint115.center = new SFVec3f(new float[0,27.07,-0.3172]);
...
Transform117.translation = new SFVec3f(new float[0,27.07,-0.3172]);
...
ImageTexture121.USE = "YoungTextureAtlas";
...
HAnimJoint125.center = new SFVec3f(new float[5.441,45.83,0.1786]);
...
Transform127.translation = new SFVec3f(new float[5.441,45.83,0.1786]);
...
ImageTexture131.USE = "YoungTextureAtlas";
...
HAnimJoint135.center = new SFVec3f(new float[6.823,36.08,0.08607]);
...
Transform137.translation = new SFVec3f(new float[6.823,36.08,0.08607]);
...
ImageTexture141.USE = "YoungTextureAtlas";
...
HAnimJoint145.center = new SFVec3f(new float[6.915,28.41,0.3752]);
...
Transform147.translation = new SFVec3f(new float[6.915,28.41,0.3752]);
...
ImageTexture151.USE = "YoungTextureAtlas";
...
HAnimJoint155.center = new SFVec3f(new float[-5.441,45.83,0.1786]);
...
Transform157.translation = new SFVec3f(new float[-5.441,45.83,0.1786]);
...
ImageTexture161.USE = "YoungTextureAtlas";
...
Coordinate164.point = new MFVec3f(new float[-1.592,1.817,-1.481,-2.611,1.817,0.0297,-1.489,1.817,1.466,0.2232,1.817,0.8423,0.1596,1.817,-0.9787,-1.794,0.7023,-2.036,-3.201,0.7023,0.0503,-1.652,0.7023,2.033,0.7128,0.7023,1.173,0.625,0.7023,-1.342,-1.794,-1.513,-2.036,-3.201,-1.513,0.0503,-1.652,-1.513,2.033,0.7128,-1.513,1.173,0.625,-1.513,-1.342,-1.836,-2.461,-2.153,-3.325,-2.461,0.0546,-1.686,-2.461,2.153,0.8158,-2.461,1.242,0.7229,-2.461,-1.419,-1.369,-0.8329,-1.709,-2.445,-0.8329,-0.4004,-1.888,-0.8329,1.436,-0.4682,-0.8329,1.262,-0.1476,-0.8329,-0.6818,-1.431,-5.952,-1.383,-2.548,-5.952,-0.3332,-1.97,-5.952,1.14,-0.495,-5.952,1,-0.162,-5.952,-0.5588,-1.466,-9.522,-1.332,-2.541,-9.522,-0.3218,-1.985,-9.522,1.096,-0.565,-9.522,0.9618,-0.2445,-9.522,-0.539,-1.422,-10.01,-0.792,-2.053,-10.01,-0.1998,-1.726,-10.01,0.6312,-0.8942,-10.01,0.5525,-0.7063,-10.01,-0.3271]);
...
HAnimJoint165.center = new SFVec3f(new float[-6.823,36.08,0.08607]);
...
Transform167.translation = new SFVec3f(new float[-6.823,36.08,0.08607]);
...
ImageTexture171.USE = "YoungTextureAtlas";
...
HAnimJoint175.center = new SFVec3f(new float[-6.915,28.41,0.3752]);
...
Transform177.translation = new SFVec3f(new float[-6.915,28.41,0.3752]);
...
ImageTexture181.USE = "YoungTextureAtlas";
...
Coordinate184.point = new MFVec3f(new float[-0.6237,0.0984,0.703,-0.5903,0.1133,-1.189,1.101,0.02,0.7856,1.108,0.0215,-1.131,1.289,-0.5207,1.303,-0.9805,-0.3349,1.224,-0.9287,-0.3062,-1.753,1.391,-0.5055,-1.749,1.18,-2.202,2.123,-1.263,-2.015,1.834,-1.211,-1.986,-2.123,1.505,-2.287,-1.981,0.9466,-3.466,1.493,-0.3369,-3.669,1.543,-0.2851,-3.64,-1.826,1.135,-3.477,-1.705,1.385,-0.5072,-0.165,1.903,-2.244,1.711,2.187,-0.825,0.0512,2.154,-0.8839,1.662,1.908,-2.242,0.1214,1.394,-2.282,-0.1776,-0.5903,0.1133,-1.189,1.108,0.0215,-1.131,1.101,0.02,0.7856,-0.6237,0.0984,0.703,-0.5903,0.1133,-1.189,1.101,0.02,0.7856]);
...
HAnimJoint185.center = new SFVec3f(new float[0,35.75,-0.445]);
...
Transform187.translation = new SFVec3f(new float[0,35.75,-0.445]);
...
ImageTexture191.USE = "YoungTextureAtlas";
...
HAnimJoint195.center = new SFVec3f(new float[0,50.47,-0.1481]);
...
Transform197.translation = new SFVec3f(new float[0,50.47,-0.1481]);
...
ImageTexture201.USE = "YoungTextureAtlas";

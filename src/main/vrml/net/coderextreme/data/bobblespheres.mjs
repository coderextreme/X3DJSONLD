...
PhysicalMaterial71YYY.extensions = new X3D.MFNode();

PhysicalMaterial71ZZZ.extensions[0] = IORMaterialExtension72;
...
PhysicalMaterial84YYY.extensions = new X3D.MFNode();

PhysicalMaterial84ZZZ.extensions[0] = IridescenceMaterialExtension85;

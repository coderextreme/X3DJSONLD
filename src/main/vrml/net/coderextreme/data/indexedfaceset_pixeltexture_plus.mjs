...
scene.addMetaData("title", "indexedfaceset_pixeltexture_plus.x3d");
scene.addMetaData("Image", "indexedfaceset_pixeltexture_plus-front.jpg");
scene.addMetaData("Image", "indexedfaceset_pixeltexture_plus-rear.jpg");
scene.addMetaData("Image", "indexedfaceset_pixeltexture_plus-top.jpg");
scene.addMetaData("Image", "indexedfaceset_pixeltexture_plus-bottom.jpg");
scene.addMetaData("Image", "indexedfaceset_pixeltexture_plus-left.jpg");
scene.addMetaData("Image", "indexedfaceset_pixeltexture_plus-right.jpg");
...
scene.addMetaData("description", "Test of browser ability to map a 3 times multiple of an PixelTexture onto an IndexedFaceSet geometry. A 3 by 3 matrix of four equal sized red, green, white and yellow squares in the pixel texture map all the faces of the cube.");
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plus.x3d");

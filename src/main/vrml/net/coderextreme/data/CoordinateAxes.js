      ...
      .setHead(new head()
        .addMeta(new meta().setName("title").setContent("CoordinateAxis.x3d"))
        .addMeta(new meta().setName("creator").setContent("Unknown, see X3D Resources Archives"))
        .addMeta(new meta().setName("generator").setContent("manual"))
        .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/CoordinateAxis.x3d"))

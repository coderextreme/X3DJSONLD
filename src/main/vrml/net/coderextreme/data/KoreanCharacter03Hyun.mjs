...
meta7.name = "modified";
meta7.content = "Sat, 30 Dec 2023 07:50:35 GMT";
head1.meta[5] = meta7;
...
WorldInfo18.title = "KoreanCharacter03Hyun.x3d";
...
HAnimHumanoid21.DEF = "hanim_Hyun";
HAnimHumanoid21.name = "Hyun";
...
HAnimJoint29.center = new SFVec3f(new float[0,31.43,-0.5601]);
...
Transform31.translation = new SFVec3f(new float[0,31.43,-0.5601]);
...
ImageTexture35.DEF = "HyunTextureAtlas";
ImageTexture35.url = new MFString(new java.lang.String["images/Hyun.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Hyun.png"]);
...
HAnimJoint39.center = new SFVec3f(new float[3.551,29.33,-0.1267]);
...
Transform41.translation = new SFVec3f(new float[3.551,29.33,-0.1267]);
...
ImageTexture45.USE = "HyunTextureAtlas";
...
HAnimJoint49.center = new SFVec3f(new float[3.71,15.48,-0.1446]);
...
Transform51.translation = new SFVec3f(new float[3.71,15.48,-0.1446]);
...
ImageTexture55.USE = "HyunTextureAtlas";
...
HAnimJoint59.center = new SFVec3f(new float[3.388,3.168,-0.537]);
...
Transform61.translation = new SFVec3f(new float[3.388,3.168,-0.537]);
...
ImageTexture65.USE = "HyunTextureAtlas";
...
HAnimJoint69.center = new SFVec3f(new float[3.388,2.908,0.7441]);
...
Transform71.translation = new SFVec3f(new float[3.388,2.908,0.7441]);
...
ImageTexture75.USE = "HyunTextureAtlas";
...
HAnimJoint79.center = new SFVec3f(new float[-3.551,29.33,-0.1267]);
...
Transform81.translation = new SFVec3f(new float[-3.551,29.33,-0.1267]);
...
ImageTexture85.USE = "HyunTextureAtlas";
...
TextureCoordinate87.point = new MFVec2f(new float[0.7912,0.3382,0.7912,0.364,0.7912,0.2804,0.7912,0.234,0.7912,0.234,0.7912,0.2804,0.7912,0.3382,0.7762,0.388,0.748,0.3532,0.748,0.388,0.7762,0.3532,0.748,0.275,0.7762,0.275,0.748,0.2209,0.7762,0.2209,0.748,0.2209,0.7762,0.2209,0.748,0.275,0.7762,0.275,0.748,0.3532,0.7762,0.3532,0.6856,0.3532,0.6856,0.388,0.6856,0.275,0.6856,0.2209,0.6856,0.2209,0.6856,0.275,0.6856,0.3532,0.6315,0.3608,0.6315,0.3996,0.6315,0.2735,0.6315,0.222,0.6315,0.222,0.6315,0.2735,0.6315,0.3608,0.6248,0.3387,0.6248,0.3636,0.6248,0.2828,0.6248,0.2498,0.6248,0.2498,0.6248,0.2828,0.6248,0.3387,0.6133,0.3009]);
IndexedFaceSet86.texCoord = TextureCoordinate87;

let Coordinate88 = browser.currentScene.createNode("Coordinate");
Coordinate88.point = new MFVec3f(new float[-2.616,1.989,0,-1.452,1.989,2.836,1.163,1.989,3.536,2.975,1.989,1.574,2.975,1.989,-1.574,1.163,1.989,-3.536,-1.452,1.989,-2.836,-2.616,-1.325,0,-1.452,-1.325,2.836,1.163,-1.325,3.536,2.975,-1.325,1.574,2.975,-1.325,-1.574,1.163,-1.325,-3.536,-1.452,-1.325,-2.836,-2.616,-7.064,0,-1.452,-7.064,2.836,1.163,-7.064,3.536,2.975,-7.064,1.574,2.975,-7.064,-1.574,1.163,-7.064,-3.536,-1.452,-7.064,-2.836,-2.975,-11.91,0,-1.676,-11.91,3.165,1.243,-11.91,3.947,2.964,-11.91,1.756,2.964,-11.91,-1.756,1.243,-11.91,-3.947,-1.676,-11.91,-3.165,-1.812,3.747,0,-0.9506,3.747,2.098,0.9843,3.747,2.616,2.536,3.747,1.164,2.536,3.747,-1.164,0.9843,3.747,-2.616,-0.9506,3.747,-2.098,-0.9661,-14.81,2.027,-1.798,-14.81,0,0.9034,-14.81,2.528,2.006,-14.81,1.125,2.006,-14.81,-1.125,0.9034,-14.81,-2.528,-0.9661,-14.81,-2.027,0.2983,-16.16,0]);
...
HAnimJoint89.center = new SFVec3f(new float[-3.71,15.48,-0.1446]);
...
Transform91.translation = new SFVec3f(new float[-3.71,15.48,-0.1446]);
...
ImageTexture95.USE = "HyunTextureAtlas";
...
TextureCoordinate97.point = new MFVec2f(new float[0.6566,0.2462,0.6181,0.2462,0.5796,0.2462,0.5411,0.2462,0.5026,0.2462,0.4641,0.2462,0.6951,0.2462,0.6566,0.2951,0.6181,0.2951,0.5796,0.2951,0.5411,0.2951,0.5026,0.2951,0.4641,0.2951,0.6951,0.2951,0.6566,0.3439,0.6181,0.3439,0.5796,0.3439,0.5411,0.3439,0.5026,0.3439,0.4641,0.3439,0.6951,0.3439,0.6566,0.3927,0.6181,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.6951,0.3927,0.4256,0.2462,0.4256,0.2951,0.4256,0.2462,0.4256,0.3439,0.4256,0.2951,0.4256,0.3927,0.4256,0.3439,0.4256,0.3927,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927,0.6566,0.2462,0.6181,0.2462,0.6951,0.2462,0.5796,0.2462,0.5411,0.2462,0.5026,0.2462,0.4641,0.2462,0.4256,0.2462,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927]);
IndexedFaceSet96.texCoord = TextureCoordinate97;

let Coordinate98 = browser.currentScene.createNode("Coordinate");
Coordinate98.point = new MFVec3f(new float[-2.616,-0.0823,0.0541,-1.452,-0.0823,2.89,1.163,-0.0823,3.59,2.975,-0.0823,1.628,2.975,-0.0823,-1.52,1.163,-0.0823,-3.482,-1.452,-0.0823,-2.782,-2.616,-3.395,0.0541,-1.452,-3.395,2.89,1.163,-3.395,3.59,2.975,-3.395,1.628,2.975,-3.395,-1.52,1.163,-3.395,-3.482,-1.452,-3.395,-2.782,-2.708,-6.91,0.0541,-1.545,-6.91,2.89,1.071,-6.91,3.59,2.882,-6.91,1.628,2.882,-6.91,-1.52,1.071,-6.91,-3.482,-1.545,-6.91,-2.782,-2.975,-11.77,0.0541,-1.676,-11.77,3.219,1.243,-11.77,4.001,2.964,-11.77,1.81,2.964,-11.77,-1.702,1.243,-11.77,-3.892,-1.676,-11.77,-3.111,-1.896,-7.789,0.0541,-1.003,-7.789,2.23,1.003,-7.789,2.767,2.326,-7.789,1.261,2.326,-7.789,-1.153,1.003,-7.789,-2.659,-1.003,-7.789,-2.122,-1.905,-9.68,0.0541,-1.082,-9.68,1.782,0.7654,-9.68,2.209,2.247,-9.68,1.013,2.247,-9.68,-0.9049,0.7654,-9.68,-2.101,-1.082,-9.68,-1.674,-1.812,1.676,0.0541,-0.9506,1.676,2.152,0.9843,1.676,2.67,2.536,1.676,1.218,2.536,1.676,-1.11,0.9843,1.676,-2.562,-0.9506,1.676,-2.044,-1.628,-12.93,0.0541,-0.9097,-12.93,1.709,0.7038,-12.93,2.082,1.998,-12.93,1.037,1.998,-12.93,-0.7834,0.7038,-12.93,-1.828,-0.9097,-12.93,-1.455,-0.5546,-13.79,0.0541,-0.2406,-13.79,0.8599,0.465,-13.79,1.023,1.031,-13.79,0.5662,1.031,-13.79,-0.3121,0.465,-13.79,-0.7688,-0.2406,-13.79,-0.6058]);
...
HAnimJoint99.center = new SFVec3f(new float[-3.388,3.168,-0.537]);
...
Transform101.translation = new SFVec3f(new float[-3.388,3.168,-0.537]);
...
ImageTexture105.USE = "HyunTextureAtlas";
...
HAnimJoint109.center = new SFVec3f(new float[-3.388,2.908,0.7441]);
...
Transform111.translation = new SFVec3f(new float[-3.388,2.908,0.7441]);
...
ImageTexture115.USE = "HyunTextureAtlas";
...
HAnimJoint119.center = new SFVec3f(new float[0,26.58,-0.5601]);
...
Transform121.translation = new SFVec3f(new float[0,26.58,-0.5601]);
...
ImageTexture125.USE = "HyunTextureAtlas";
...
HAnimJoint129.center = new SFVec3f(new float[5.502,45.78,-0.3559]);
...
Transform131.translation = new SFVec3f(new float[5.502,45.78,-0.3559]);
...
ImageTexture135.USE = "HyunTextureAtlas";
...
HAnimJoint139.center = new SFVec3f(new float[6.735,35.67,-0.4487]);
...
Transform141.translation = new SFVec3f(new float[6.735,35.67,-0.4487]);
...
ImageTexture145.USE = "HyunTextureAtlas";
...
HAnimJoint149.center = new SFVec3f(new float[6.432,27.83,-0.1589]);
...
Transform151.translation = new SFVec3f(new float[6.432,27.83,-0.1589]);
...
ImageTexture155.USE = "HyunTextureAtlas";
...
HAnimJoint159.center = new SFVec3f(new float[-5.502,45.78,-0.3559]);
...
Transform161.translation = new SFVec3f(new float[-5.502,45.78,-0.3559]);
...
ImageTexture165.USE = "HyunTextureAtlas";
...
HAnimJoint169.center = new SFVec3f(new float[-6.735,35.67,-0.4487]);
...
Transform171.translation = new SFVec3f(new float[-6.735,35.67,-0.4487]);
...
ImageTexture175.USE = "HyunTextureAtlas";
...
TextureCoordinate177.point = new MFVec2f(new float[0.2667,0.6308,0.2522,0.6308,0.2052,0.6308,0.22,0.6308,0.2355,0.6308,0.266,0.6397,0.2508,0.6397,0.2066,0.6397,0.2205,0.6397,0.2357,0.6397,0.2662,0.6601,0.251,0.6601,0.206,0.6557,0.2208,0.6557,0.2354,0.6601,0.2679,0.7003,0.2509,0.7003,0.2072,0.7003,0.2192,0.7003,0.2343,0.7003,0.2512,0.7051,0.2692,0.7051,0.2072,0.7051,0.219,0.7051,0.2329,0.7051,0.1923,0.6308,0.1778,0.6308,0.1923,0.6308,0.1916,0.6397,0.1916,0.6397,0.1918,0.6601,0.1918,0.6601,0.1935,0.7003,0.1768,0.7051,0.1948,0.7051,0.1935,0.7003,0.1948,0.7051]);
IndexedFaceSet176.texCoord = TextureCoordinate177;

let Coordinate178 = browser.currentScene.createNode("Coordinate");
Coordinate178.point = new MFVec3f(new float[-0.133,0.4969,-1.018,-0.9633,0.5042,-0.2287,-0.4907,0.5001,0.9186,0.6318,0.4904,0.8386,0.8529,0.4884,-0.3582,-0.0877,-0.5196,-1.436,-1.261,-0.5094,-0.3773,-0.5932,-0.515,1.436,0.9931,-0.5288,1.309,1.306,-0.5317,-0.5821,-0.1173,-2.866,-1.42,-1.37,-2.855,-0.3733,-0.6813,-2.348,1.422,1.012,-2.362,1.297,1.37,-2.879,-0.576,-0.1304,-7.472,-1.27,-1.044,-7.464,-0.1131,-0.5241,-7.468,1.334,0.7111,-7.479,1.217,0.9544,-7.481,-0.3029,-0.0956,-8.023,-0.7824,-0.7196,-8.018,0.0074,-0.3644,-8.021,0.9211,0.4791,-8.028,0.841,0.6452,-8.03,-0.1223]);
...
HAnimJoint179.center = new SFVec3f(new float[-6.432,27.83,-0.1589]);
...
Transform181.translation = new SFVec3f(new float[-6.432,27.83,-0.1589]);
...
ImageTexture185.USE = "HyunTextureAtlas";
...
Coordinate188.point = new MFVec3f(new float[-1.076,0.3804,0.7047,-1.042,0.395,-1.192,0.6516,0.2878,0.7874,0.6592,0.2892,-1.133,0.8366,-0.2556,1.306,-1.437,-0.0511,1.226,-1.385,-0.0228,-1.757,0.9384,-0.2412,-1.753,0.7136,-1.939,2.128,-1.733,-1.733,1.838,-1.681,-1.704,-2.128,1.039,-2.028,-1.986,0.4691,-3.205,1.497,-0.8189,-3.398,1.547,-0.7668,-3.369,-1.83,0.6579,-3.218,-1.709,0.9322,-0.2429,-0.1654,1.437,-1.988,1.715,1.733,-0.5679,0.0513,1.7,-0.6266,1.665,1.443,-1.986,0.1217,0.9271,-2.022,-0.178,-1.042,0.395,-1.192,0.6592,0.2892,-1.133,0.6516,0.2878,0.7874,-1.076,0.3804,0.7047,-1.042,0.395,-1.192,0.6516,0.2878,0.7874]);
...
HAnimJoint189.center = new SFVec3f(new float[0,35.77,-0.5028]);
...
Transform191.translation = new SFVec3f(new float[0,35.77,-0.5028]);
...
ImageTexture195.USE = "HyunTextureAtlas";
...
HAnimJoint199.center = new SFVec3f(new float[0,49.98,-0.5228]);
...
Transform201.translation = new SFVec3f(new float[0,49.98,-0.5228]);
...
ImageTexture205.USE = "HyunTextureAtlas";

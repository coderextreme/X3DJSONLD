...
Text40.string = new X3D.MFString([new X3D.SFString("Oblique Strategies"), new X3D.SFString("(Over One Hundred Worthwhile Dilemmas)"), new X3D.SFString("by Brian Eno and Peter Schmidt")]);

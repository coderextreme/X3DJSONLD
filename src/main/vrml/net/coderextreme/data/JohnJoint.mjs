...
let IndexedLineSet12 = browser.currentScene.createNode("IndexedLineSet");
...
browser.currentScene.children[0] = Transform10;
...
let LineSet24 = browser.currentScene.createNode("LineSet");
LineSet24.vertexCount = new MFInt32(new int[2]);
let ColorRGBA25 = browser.currentScene.createNode("ColorRGBA");
...
browser.currentScene.children[4] = HAnimHumanoid29;

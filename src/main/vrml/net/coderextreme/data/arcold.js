...
Material8.diffuseColor = [0.2,0.7,0.7];
...
PositionInterpolator33.key = [0,1];
PositionInterpolator33.keyValue = [0,0,0,0,5,0];
...
fieldValue81.children = [];

fieldValue81.children[0] = ProtoInstance82;

ProtoInstance80.fieldValue = [];

...
scene.addMetaData("identifier", "https://coderextreme.net/X3DJSONLD/src/main/data/x3domflowers.x3d");
...
ExternProtoDeclare19.url = new X3D.MFString([new X3D.SFString("../data/flowerproto.json#FlowerProto")]);

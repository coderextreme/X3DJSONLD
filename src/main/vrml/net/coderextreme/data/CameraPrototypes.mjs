...
Text258.string = new X3D.MFString([new X3D.SFString("CameraPrototypes.x3d"), new X3D.SFString("defines multiple prototype nodes"), new X3D.SFString("Click on this text to see"), new X3D.SFString("CameraExamples.x3d scene")]);

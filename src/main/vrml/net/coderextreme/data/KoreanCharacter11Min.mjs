...
scene.addMetaData("title", "KoreanCharacter11Min.x3d");
...
scene.addMetaData("Image", "../Poses/images/HAnimPoseExampleKoreanCharacter11Min.png");
...
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter11Min.x3d");
...
HAnimJoint32.center = new X3D.SFVec3f([0,33.689999,-2.063]);
...
Transform34.translation = new X3D.SFVec3f([0,33.689999,-2.063]);
...
HAnimJoint42.center = new X3D.SFVec3f([3.383,32.919998,-2.063]);
...
Transform44.translation = new X3D.SFVec3f([3.383,32.919998,-2.063]);
...
HAnimJoint52.center = new X3D.SFVec3f([3.745,17.99,-2.063]);
...
Transform54.translation = new X3D.SFVec3f([3.745,17.99,-2.063]);
...
HAnimJoint62.center = new X3D.SFVec3f([3.701,4.188,-1.915]);
...
Transform64.translation = new X3D.SFVec3f([3.701,4.188,-1.915]);
...
HAnimJoint72.center = new X3D.SFVec3f([3.701,3.418,-0.4009]);
...
Transform74.translation = new X3D.SFVec3f([3.701,3.418,-0.4009]);
...
HAnimJoint82.center = new X3D.SFVec3f([-3.383,32.919998,-2.063]);
...
Transform84.translation = new X3D.SFVec3f([-3.383,32.919998,-2.063]);
...
HAnimJoint92.center = new X3D.SFVec3f([-3.745,17.99,-2.063]);
...
Transform94.translation = new X3D.SFVec3f([-3.745,17.99,-2.063]);
...
HAnimJoint102.center = new X3D.SFVec3f([-3.701,4.188,-1.915]);
...
Transform104.translation = new X3D.SFVec3f([-3.701,4.188,-1.915]);
...
HAnimJoint112.center = new X3D.SFVec3f([-3.701,3.418,-0.4009]);
...
Transform114.translation = new X3D.SFVec3f([-3.701,3.418,-0.4009]);
...
HAnimJoint122.center = new X3D.SFVec3f([0,30.98,-2.063]);
...
Transform124.translation = new X3D.SFVec3f([0,30.98,-2.063]);
...
HAnimJoint132.center = new X3D.SFVec3f([5.199,51.119999,-2.106]);
...
Transform134.translation = new X3D.SFVec3f([5.199,51.119999,-2.106]);
...
HAnimJoint142.center = new X3D.SFVec3f([7.024,42.73,-2.051]);
...
Transform144.translation = new X3D.SFVec3f([7.024,42.73,-2.051]);
...
HAnimJoint152.center = new X3D.SFVec3f([7.221,34,-2.015]);
...
Transform154.translation = new X3D.SFVec3f([7.221,34,-2.015]);
...
HAnimJoint162.center = new X3D.SFVec3f([-5.199,51.119999,-2.106]);
...
Transform164.translation = new X3D.SFVec3f([-5.199,51.119999,-2.106]);
...
HAnimJoint172.center = new X3D.SFVec3f([-7.024,42.73,-2.051]);
...
Transform174.translation = new X3D.SFVec3f([-7.024,42.73,-2.051]);
...
HAnimJoint182.center = new X3D.SFVec3f([-7.221,34,-2.015]);
...
Transform184.translation = new X3D.SFVec3f([-7.221,34,-2.015]);
...
IndexedFaceSet189.coordIndex = new X3D.MFInt32([3,2,1,-1,1,0,3,-1,5,4,7,-1,7,6,5,-1,9,8,11,-1,11,10,9,-1,9,10,13,-1,13,12,9,-1,15,14,17,-1,17,16,15,-1,16,19,18,-1,18,15,16,-1,3,0,10,-1,10,11,3,-1,10,0,1,-1,1,13,10,-1,16,17,21,-1,21,20,16,-1,20,2,19,-1,19,16,20,-1,7,8,9,-1,9,6,7,-1,5,6,9,-1,9,12,5,-1,15,23,22,-1,22,14,15,-1,18,4,23,-1,23,15,18,-1,21,1,2,-1,2,20,21,-1,23,4,5,-1,5,22,23,-1,12,13,17,-1,17,14,12,-1,26,25,24,-1,24,27,26,-1,21,17,13,-1,13,1,21,-1,11,19,2,-1,2,3,11,-1,22,5,12,-1,12,14,22,-1,4,18,8,-1,8,7,4,-1,25,11,8,-1,8,24,25,-1,11,25,26,-1,26,19,11,-1,19,26,27,-1,27,18,19,-1,18,27,24,-1,24,8,18,-1]);
IndexedFaceSet189.creaseAngle = 1.57;
IndexedFaceSet189.texCoordIndex = new X3D.MFInt32([3,2,1,-1,1,0,3,-1,28,5,4,-1,4,29,28,-1,9,8,11,-1,11,10,9,-1,9,10,13,-1,13,12,9,-1,39,38,41,-1,41,40,39,-1,16,19,18,-1,18,15,16,-1,3,0,10,-1,10,11,3,-1,10,0,1,-1,1,13,10,-1,40,41,43,-1,43,42,40,-1,20,2,19,-1,19,16,20,-1,7,8,9,-1,9,6,7,-1,28,29,30,-1,30,31,28,-1,39,23,22,-1,22,38,39,-1,33,5,32,-1,32,34,33,-1,21,1,2,-1,2,20,21,-1,32,5,28,-1,28,35,32,-1,12,13,17,-1,17,14,12,-1,26,25,24,-1,24,27,26,-1,21,17,13,-1,13,1,21,-1,11,19,2,-1,2,3,11,-1,35,28,31,-1,31,36,35,-1,5,33,37,-1,37,4,5,-1,25,11,8,-1,8,24,25,-1,11,25,26,-1,26,19,11,-1,19,26,27,-1,27,18,19,-1,18,27,24,-1,24,8,18,-1]);
let Coordinate190 = browser.currentScene.createNode("Coordinate");
Coordinate190.point = new X3D.MFVec3f([-0.6858,-0.0091,1.043,-0.8572,-0.0091,0.3582,0.582,-0.0091,0.3582,0.5216,-0.0091,1.043,0.679,-2.66,0.2822,-0.9542,-2.992,0.2822,-0.7672,-2.714,1.233,0.603,-2.435,1.233,0.8768,-1.907,1.4,-1.041,-1.907,1.4,-1.041,-0.5983,1.4,0.8768,-0.5983,1.4,-1.281,-2.03,0.2845,-1.281,-0.5489,0.2845,-1.097,-1.908,-1.452,0.8213,-1.908,-1.452,0.8213,-0.5991,-1.452,-1.097,-0.5991,-1.452,1.005,-2.03,0.2845,1.005,-0.5489,0.2845,0.4661,-0.0091,-1.084,-0.7414,-0.0091,-1.084,-0.8227,-2.714,-1.198,0.5474,-2.436,-1.198,1.272,-1.761,1.213,1.272,-0.7447,1.213,1.476,-0.7234,0.4714,1.476,-1.856,0.4714]);
coord = Coordinate190;

let TextureCoordinate191 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate191.point = new X3D.MFVec2f([0.9934,0.082,0.9951,0.0877,0.9456,0.0877,0.9473,0.082,0.9034,0.0905,0.8766,0.0919,0.9942,0.009,0.945,0.0157,0.9371,0.0285,0.9969,0.0285,0.9969,0.0684,0.9371,0.0684,0.9993,0.0256,0.9993,0.0715,0.9975,0.0285,0.9365,0.0285,0.9365,0.0684,0.9975,0.0684,0.9312,0.0256,0.9312,0.0715,0.9489,0.082,0.9939,0.082,0.9948,0.009,0.9466,0.0157,0.9256,0.0321,0.9256,0.0648,0.9198,0.0672,0.9198,0.0298,0.8753,0.0485,0.9025,0.0502,0.9023,0.0288,0.8757,0.0269,0.8373,0.0909,0.8768,0.1071,0.8372,0.1061,0.8367,0.0504,0.837,0.0294,0.9035,0.1061,0.9975,0.0285,0.9387,0.0285,0.9387,0.0684,0.9975,0.0684,0.9489,0.082,0.9939,0.082]);
...
HAnimJoint192.center = new X3D.SFVec3f([0,36.290001,-2.197]);
...
Transform194.translation = new X3D.SFVec3f([0,36.290001,-2.197]);
...
HAnimJoint202.center = new X3D.SFVec3f([0,54.84,-1.903]);
...
Transform204.translation = new X3D.SFVec3f([0,54.84,-1.903]);

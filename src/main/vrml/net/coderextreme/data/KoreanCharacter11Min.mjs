...
HAnimJoint31.center = new X3D.SFVec3f([0,33.689999,-2.063]);
...
Transform33.translation = new X3D.SFVec3f([0,33.689999,-2.063]);
...
HAnimJoint41.center = new X3D.SFVec3f([3.383,32.919998,-2.063]);
...
Transform43.translation = new X3D.SFVec3f([3.383,32.919998,-2.063]);
...
HAnimJoint51.center = new X3D.SFVec3f([3.745,17.99,-2.063]);
...
Transform53.translation = new X3D.SFVec3f([3.745,17.99,-2.063]);
...
HAnimJoint61.center = new X3D.SFVec3f([3.701,4.188,-1.915]);
...
Transform63.translation = new X3D.SFVec3f([3.701,4.188,-1.915]);
...
HAnimJoint71.center = new X3D.SFVec3f([3.701,3.418,-0.4009]);
...
Transform73.translation = new X3D.SFVec3f([3.701,3.418,-0.4009]);
...
HAnimJoint81.center = new X3D.SFVec3f([-3.383,32.919998,-2.063]);
...
Transform83.translation = new X3D.SFVec3f([-3.383,32.919998,-2.063]);
...
HAnimJoint91.center = new X3D.SFVec3f([-3.745,17.99,-2.063]);
...
Transform93.translation = new X3D.SFVec3f([-3.745,17.99,-2.063]);
...
HAnimJoint101.center = new X3D.SFVec3f([-3.701,4.188,-1.915]);
...
Transform103.translation = new X3D.SFVec3f([-3.701,4.188,-1.915]);
...
HAnimJoint111.center = new X3D.SFVec3f([-3.701,3.418,-0.4009]);
...
Transform113.translation = new X3D.SFVec3f([-3.701,3.418,-0.4009]);
...
HAnimJoint121.center = new X3D.SFVec3f([0,30.98,-2.063]);
...
Transform123.translation = new X3D.SFVec3f([0,30.98,-2.063]);
...
HAnimJoint131.center = new X3D.SFVec3f([5.199,51.119999,-2.106]);
...
Transform133.translation = new X3D.SFVec3f([5.199,51.119999,-2.106]);
...
HAnimJoint141.center = new X3D.SFVec3f([7.024,42.73,-2.051]);
...
Transform143.translation = new X3D.SFVec3f([7.024,42.73,-2.051]);
...
HAnimJoint151.center = new X3D.SFVec3f([7.221,34,-2.015]);
...
Transform153.translation = new X3D.SFVec3f([7.221,34,-2.015]);
...
HAnimJoint161.center = new X3D.SFVec3f([-5.199,51.119999,-2.106]);
...
Transform163.translation = new X3D.SFVec3f([-5.199,51.119999,-2.106]);
...
HAnimJoint171.center = new X3D.SFVec3f([-7.024,42.73,-2.051]);
...
Transform173.translation = new X3D.SFVec3f([-7.024,42.73,-2.051]);
...
HAnimJoint181.center = new X3D.SFVec3f([-7.221,34,-2.015]);
...
Transform183.translation = new X3D.SFVec3f([-7.221,34,-2.015]);
...
Coordinate189.point = new X3D.MFVec3f([-0.6858,-0.0091,1.043,-0.8572,-0.0091,0.3582,0.582,-0.0091,0.3582,0.5216,-0.0091,1.043,0.679,-2.66,0.2822,-0.9542,-2.992,0.2822,-0.7672,-2.714,1.233,0.603,-2.435,1.233,0.8768,-1.907,1.4,-1.041,-1.907,1.4,-1.041,-0.5983,1.4,0.8768,-0.5983,1.4,-1.281,-2.03,0.2845,-1.281,-0.5489,0.2845,-1.097,-1.908,-1.452,0.8213,-1.908,-1.452,0.8213,-0.5991,-1.452,-1.097,-0.5991,-1.452,1.005,-2.03,0.2845,1.005,-0.5489,0.2845,0.4661,-0.0091,-1.084,-0.7414,-0.0091,-1.084,-0.8227,-2.714,-1.198,0.5474,-2.436,-1.198,1.272,-1.761,1.213,1.272,-0.7447,1.213,1.476,-0.7234,0.4714,1.476,-1.856,0.4714]);
coord = Coordinate189;

let TextureCoordinate190 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate190.point = new X3D.MFVec2f([0.9934,0.082,0.9951,0.0877,0.9456,0.0877,0.9473,0.082,0.9034,0.0905,0.8766,0.0919,0.9942,0.009,0.945,0.0157,0.9371,0.0285,0.9969,0.0285,0.9969,0.0684,0.9371,0.0684,0.9993,0.0256,0.9993,0.0715,0.9975,0.0285,0.9365,0.0285,0.9365,0.0684,0.9975,0.0684,0.9312,0.0256,0.9312,0.0715,0.9489,0.082,0.9939,0.082,0.9948,0.009,0.9466,0.0157,0.9256,0.0321,0.9256,0.0648,0.9198,0.0672,0.9198,0.0298,0.8753,0.0485,0.9025,0.0502,0.9023,0.0288,0.8757,0.0269,0.8373,0.0909,0.8768,0.1071,0.8372,0.1061,0.8367,0.0504,0.837,0.0294,0.9035,0.1061,0.9975,0.0285,0.9387,0.0285,0.9387,0.0684,0.9975,0.0684,0.9489,0.082,0.9939,0.082]);
...
HAnimJoint191.center = new X3D.SFVec3f([0,36.290001,-2.197]);
...
Transform193.translation = new X3D.SFVec3f([0,36.290001,-2.197]);
...
HAnimJoint201.center = new X3D.SFVec3f([0,54.84,-1.903]);
...
Transform203.translation = new X3D.SFVec3f([0,54.84,-1.903]);

...
scene.addMetaData("title", "WinterAndSpringDedicationAllTitleBox.x3d");
scene.addMetaData("description", "Credits for scene dedications.");
...
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringDedicationAllTitleBox.x3d");
...
Transform13.translation = new X3D.SFVec3f([10,10,-10]);
...
ImageTexture17.url = new X3D.MFString([new X3D.SFString("images/WSDedicationAll.png"), new X3D.SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSDedicationAll.png")]);

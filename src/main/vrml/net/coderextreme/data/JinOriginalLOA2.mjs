...
scene.addMetaData("title", "JinOriginalLOA2.x3d");
...
scene.addMetaData("reference", "JinLOA2.x3d");
...
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA2.x3d");

      ...
      .setScene(new Scene()
        .addChild(new ProtoDeclare().setName("HeadsUpDisplay").setAppinfo("HeadsUpDisplay positions child geometry in screen space, movable by the user")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new ProximitySensor().setDEF("WhereSensor").setSize(java.newArray("float", [1000000000,1000000000,1000000000]))
                .setIS(new IS()
              ...
              .addChild(new Transform().setDEF("FixedLocation")
                .addChild(new Transform().setDEF("MovableLocation")
                  .addChild(new Transform().setDEF("LocationOffset")
                    ...
                    .addChild(new Transform().setTranslation(java.newArray("float", [0,0,-10]))
                      .addChild(new Group()
                        .setIS(new IS()
...
"}"))
        ...
        .addChild(new Background().setGroundColor(java.newArray("float", [0.1,0.1,0.3])).setSkyColor(java.newArray("float", [0.5,0.5,0.1])))
        .addChild(new Anchor().setDescription("HeadsUpDisplayExample").setParameter(java.newArray("java.lang.String", ["target=_blank"])).setUrl(java.newArray("java.lang.String", ["HeadsUpDisplayExample.x3d","https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/HeadsUpDisplayrExample.x3d","HeadsUpDisplayExample.wrl","https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/HeadsUpDisplayExample.wrl"]))
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(java.newArray("float", [0,1,1])).setEmissiveColor(java.newArray("float", [0,1,1]))))
            .setGeometry(new Text().setString(java.newArray("java.lang.String", ["HeadsUpDisplayPrototype.x3d","is a Prototype definition file.","","To see an example scene using this node","click this text to view","HeadsUpDisplayExample.x3d"]))
              .setFontStyle(new FontStyle().setJustify(java.newArray("java.lang.String", ["MIDDLE","MIDDLE"])).setSize(0.8))))))      ;

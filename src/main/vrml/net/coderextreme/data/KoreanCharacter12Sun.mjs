...
meta2.name = "title";
meta2.content = "KoreanCharacter12Sun.x3d";
...
meta12.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter12Sun.x3d";
...
WorldInfo19.title = "KoreanCharacter12Sun.x3d";
...
HAnimHumanoid22.DEF = "hanim_Sun";
HAnimHumanoid22.version = "2.0";
HAnimHumanoid22.name = "Sun";
...
HAnimJoint25.center = new SFVec3f(new float[0,29.86,-0.4567]);
...
Transform27.translation = new SFVec3f(new float[0,29.86,-0.4567]);
...
ImageTexture31.DEF = "SunTextureAtlas";
ImageTexture31.url = new MFString(new java.lang.String["images/Sun.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Sun.png"]);
...
HAnimJoint35.center = new SFVec3f(new float[2.955,28.94,-0.5218]);
...
Transform37.translation = new SFVec3f(new float[2.955,28.94,-0.5218]);
...
ImageTexture41.USE = "SunTextureAtlas";
...
HAnimJoint45.center = new SFVec3f(new float[2.948,16.46,-0.5275]);
...
Transform47.translation = new SFVec3f(new float[2.948,16.46,-0.5275]);
...
ImageTexture51.USE = "SunTextureAtlas";
...
HAnimJoint55.center = new SFVec3f(new float[2.839,3.899,-0.4116]);
...
Transform57.translation = new SFVec3f(new float[2.839,3.899,-0.4116]);
...
let ImageTexture61 = browser.currentScene.createNode("ImageTexture");
ImageTexture61.USE = "SunTextureAtlas";
...
HAnimJoint65.center = new SFVec3f(new float[2.839,3.312,1.078]);
...
Transform67.translation = new SFVec3f(new float[2.839,3.312,1.078]);
...
let ImageTexture71 = browser.currentScene.createNode("ImageTexture");
ImageTexture71.USE = "SunTextureAtlas";
...
HAnimJoint75.center = new SFVec3f(new float[-2.955,28.94,-0.5218]);
...
Transform77.translation = new SFVec3f(new float[-2.955,28.94,-0.5218]);
...
ImageTexture81.USE = "SunTextureAtlas";
...
HAnimJoint85.center = new SFVec3f(new float[-2.948,16.46,-0.5275]);
...
Transform87.translation = new SFVec3f(new float[-2.948,16.46,-0.5275]);
...
let ImageTexture91 = browser.currentScene.createNode("ImageTexture");
ImageTexture91.USE = "SunTextureAtlas";
...
HAnimJoint95.center = new SFVec3f(new float[-2.839,3.899,-0.4116]);
...
Transform97.translation = new SFVec3f(new float[-2.839,3.899,-0.4116]);
...
ImageTexture101.USE = "SunTextureAtlas";
...
HAnimJoint105.center = new SFVec3f(new float[-2.839,3.312,1.078]);
...
Transform107.translation = new SFVec3f(new float[-2.839,3.312,1.078]);
...
let ImageTexture111 = browser.currentScene.createNode("ImageTexture");
ImageTexture111.USE = "SunTextureAtlas";
...
Coordinate114.point = new MFVec3f(new float[-1.388,-0.7441,0.9353,0,-0.5418,1.142,0,-1.042,2.002,-1.356,-1.234,1.823,-1.286,-1.394,3.004,0,-1.212,3.154,0,-1.708,3.962,-1.162,-1.8,3.64,-1.65,-1.868,2.671,-1.806,-1.859,1.688,-1.217,-2.657,3.79,0,-2.605,4.159,-1.729,-2.767,2.676,-1.984,-2.747,-0.4534,-1.847,-1.879,-0.4111,-1.91,-1.914,0.8074,-2.006,-2.83,0.7644,-1.895,-2.791,1.697,1.388,-0.7441,0.9353,1.356,-1.234,1.823,1.286,-1.394,3.004,1.162,-1.8,3.64,1.91,-1.914,0.8074,1.806,-1.859,1.688,1.217,-2.657,3.79,1.729,-2.767,2.676,2.006,-2.83,0.7644,1.847,-1.879,-0.4111,1.984,-2.747,-0.4534,1.65,-1.868,2.671,1.895,-2.791,1.697,0,-3.18,0.7644,-2.006,-3.18,0.7644,-1.729,-3.137,2.71,-1.217,-3.069,3.793,0,-2.997,4.162,0,-3.18,-0.4554,-1.99,-3.18,-0.4554,1.729,-3.137,2.71,2.006,-3.18,0.7644,1.217,-3.069,3.793,1.99,-3.18,-0.4554,0,-3.141,2.71,-1.895,-3.164,1.686,1.895,-3.164,1.686,0,-3.164,1.686,-1.486,-0.5175,-1.502,-1.788,-1.797,-1.502,-1.928,-2.585,-1.502,0.0009,0.1637,0.361,-1.326,-0.0186,0.0033,1.486,-0.5175,-1.502,1.788,-1.797,-1.502,1.928,-2.585,-1.502,1.331,-0.0112,0.0089,0,-3.164,-1.502,-1.935,-3.164,-1.502,1.934,-3.164,-1.502,-1.153,-0.3082,-2.015,-1.192,-1.388,-2.379,-1.307,-1.876,-2.363,-1.307,-2.129,-2.356,-0.0004,-2.129,-2.356,1.306,-2.129,-2.356,1.306,-1.876,-2.362,1.191,-1.388,-2.378,1.152,-0.3071,-2.014,1.027,0.2573,-1.173,0.0025,0.3479,-0.8576,-1.023,0.2519,-1.179]);
...
HAnimJoint115.center = new SFVec3f(new float[0,29.86,-0.4567]);
...
Transform117.translation = new SFVec3f(new float[0,29.86,-0.4567]);
...
let ImageTexture121 = browser.currentScene.createNode("ImageTexture");
ImageTexture121.USE = "SunTextureAtlas";
...
HAnimJoint125.center = new SFVec3f(new float[6.077,45.88,-1.319]);
...
Transform127.translation = new SFVec3f(new float[6.077,45.88,-1.319]);
...
let ImageTexture131 = browser.currentScene.createNode("ImageTexture");
ImageTexture131.USE = "SunTextureAtlas";
...
HAnimJoint135.center = new SFVec3f(new float[7.076,38.53,-1.385]);
...
Transform137.translation = new SFVec3f(new float[7.076,38.53,-1.385]);
...
let ImageTexture141 = browser.currentScene.createNode("ImageTexture");
ImageTexture141.USE = "SunTextureAtlas";
...
HAnimJoint145.center = new SFVec3f(new float[6.946,30.89,-1.308]);
...
Transform147.translation = new SFVec3f(new float[6.946,30.89,-1.308]);
...
let ImageTexture151 = browser.currentScene.createNode("ImageTexture");
ImageTexture151.USE = "SunTextureAtlas";
...
HAnimJoint155.center = new SFVec3f(new float[-6.077,45.88,-1.319]);
...
Transform157.translation = new SFVec3f(new float[-6.077,45.88,-1.319]);
...
let ImageTexture161 = browser.currentScene.createNode("ImageTexture");
ImageTexture161.USE = "SunTextureAtlas";
...
HAnimJoint165.center = new SFVec3f(new float[-7.076,38.53,-1.385]);
...
Transform167.translation = new SFVec3f(new float[-7.076,38.53,-1.385]);
...
let ImageTexture171 = browser.currentScene.createNode("ImageTexture");
ImageTexture171.USE = "SunTextureAtlas";
...
Coordinate174.point = new MFVec3f(new float[-0.896,-3.458,-0.7733,-1.43,-3.283,0.0723,-1.163,-7.27,0.0721,-0.7935,-7.267,-0.5416,0.0234,-3.843,-1.144,0.0262,-7.3,-0.8983,0.6588,-7.609,-0.4491,0.7822,-7.049,-0.481,0.025,-7.07,-0.8149,0.0233,-7.631,-0.7795,0.922,-7.614,0.0729,1.098,-7.053,0.0729,0.6588,-7.612,0.6263,0.7823,-7.05,0.6527,0.9427,-4.174,0.8667,0.8457,-7.28,0.7082,0.0234,-7.282,1.066,0.0234,-3.825,1.273,0.0233,-7.623,0.9572,-0.6122,-7.612,0.6263,-0.7325,-7.043,0.6513,0.0233,-7.057,0.9867,-0.896,-3.452,0.8897,-0.7936,-7.266,0.7058,-0.896,-0.0257,-0.9221,-0.7144,0.4948,-0.6658,-1.02,0.4948,0.0721,-1.277,-0.0257,0.0721,0.0236,-0.0257,-1.334,0.0236,0.4948,-0.9714,0.9432,-0.0257,-0.9221,0.7615,0.4948,-0.6658,1.324,-0.0257,0.0721,1.067,0.4948,0.0721,0.9432,-0.0257,0.9219,0.7615,0.4948,0.8099,0.0236,-0.0257,1.334,0.0236,0.4948,1.116,-0.896,-0.0257,0.9219,-0.7144,0.4948,0.8099,0.0236,0.931,0.0721,-0.6122,-7.609,-0.4491,-0.8754,-7.614,0.0729,-0.583,-8.086,0.0729,-0.4054,-8.063,-0.1612,-0.4054,-8.076,0.3527,0.0233,-8.083,0.5759,0.452,-8.076,0.3527,0.6297,-8.086,0.0729,0.452,-8.063,-0.1612,0.0233,-8.078,-0.3841,0.0233,-8.424,0.0729,-1.403,-0.6344,0.0721,-0.9954,-0.506,-0.8653,0.02,-0.506,-1.277,0.9426,-4.179,-0.7253,1.041,-0.506,-0.8653,1.43,-0.6344,0.0721,1.323,-4.321,0.0723,1.018,-0.6344,0.9221,0.0236,-0.6344,1.334,-0.9707,-0.6344,0.9221,-1.063,-7.046,0.0729,-0.7325,-7.042,-0.4818,0.8456,-7.281,-0.5402,1.188,-7.284,0.0721]);
...
HAnimJoint175.center = new SFVec3f(new float[-6.946,30.89,-1.308]);
...
Transform177.translation = new SFVec3f(new float[-6.946,30.89,-1.308]);
...
let ImageTexture181 = browser.currentScene.createNode("ImageTexture");
ImageTexture181.USE = "SunTextureAtlas";
...
HAnimJoint185.center = new SFVec3f(new float[0.05249,34.13,-0.468]);
...
Transform187.translation = new SFVec3f(new float[0.05249,34.13,-0.468]);
...
ImageTexture191.USE = "SunTextureAtlas";
...
HAnimJoint195.center = new SFVec3f(new float[0,51.25,-1.124]);
...
Transform197.translation = new SFVec3f(new float[0,51.25,-1.124]);
...
ImageTexture201.USE = "SunTextureAtlas";

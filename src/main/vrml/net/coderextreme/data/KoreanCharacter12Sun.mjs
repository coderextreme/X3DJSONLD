...
scene.addMetaData("title", "KoreanCharacter12Sun.x3d");
...
scene.addMetaData("TODO", "check connectivity of geometry between upper left arm and shoulder");
scene.addMetaData("Image", "../Poses/images/HAnimPoseExampleKoreanCharacter12Sun.png");
...
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter12Sun.x3d");
...
WorldInfo22.title = "KoreanCharacter12Sun.x3d";
...
HAnimHumanoid25.name = "Sun";
HAnimHumanoid25.DEF = "hanim_Sun";
...
HAnimJoint33.center = new X3D.SFVec3f([0,29.860001,-0.4567]);
...
Transform35.translation = new X3D.SFVec3f([0,29.860001,-0.4567]);
...
HAnimJoint43.center = new X3D.SFVec3f([2.955,28.940001,-0.5218]);
...
Transform45.translation = new X3D.SFVec3f([2.955,28.940001,-0.5218]);
...
HAnimJoint53.center = new X3D.SFVec3f([2.948,16.459999,-0.5275]);
...
Transform55.translation = new X3D.SFVec3f([2.948,16.459999,-0.5275]);
...
HAnimJoint63.center = new X3D.SFVec3f([2.839,3.899,-0.4116]);
...
Transform65.translation = new X3D.SFVec3f([2.839,3.899,-0.4116]);
...
HAnimJoint73.center = new X3D.SFVec3f([2.839,3.312,1.078]);
...
Transform75.translation = new X3D.SFVec3f([2.839,3.312,1.078]);
...
HAnimJoint83.center = new X3D.SFVec3f([-2.955,28.940001,-0.5218]);
...
Transform85.translation = new X3D.SFVec3f([-2.955,28.940001,-0.5218]);
...
HAnimJoint93.center = new X3D.SFVec3f([-2.948,16.459999,-0.5275]);
...
Transform95.translation = new X3D.SFVec3f([-2.948,16.459999,-0.5275]);
...
HAnimJoint103.center = new X3D.SFVec3f([-2.839,3.899,-0.4116]);
...
Transform105.translation = new X3D.SFVec3f([-2.839,3.899,-0.4116]);
...
HAnimJoint113.center = new X3D.SFVec3f([-2.839,3.312,1.078]);
...
Transform115.translation = new X3D.SFVec3f([-2.839,3.312,1.078]);
...
HAnimJoint123.center = new X3D.SFVec3f([0,29.860001,-0.4567]);
...
Transform125.translation = new X3D.SFVec3f([0,29.860001,-0.4567]);
...
HAnimJoint133.center = new X3D.SFVec3f([6.077,45.880001,-1.319]);
...
Transform135.translation = new X3D.SFVec3f([6.077,45.880001,-1.319]);
...
HAnimJoint143.center = new X3D.SFVec3f([7.076,38.529999,-1.385]);
...
Transform145.translation = new X3D.SFVec3f([7.076,38.529999,-1.385]);
...
HAnimJoint153.center = new X3D.SFVec3f([6.946,30.889999,-1.308]);
...
Transform155.translation = new X3D.SFVec3f([6.946,30.889999,-1.308]);
...
HAnimJoint163.center = new X3D.SFVec3f([-6.077,45.880001,-1.319]);
...
Transform165.translation = new X3D.SFVec3f([-6.077,45.880001,-1.319]);
...
HAnimJoint173.center = new X3D.SFVec3f([-7.076,38.529999,-1.385]);
...
Transform175.translation = new X3D.SFVec3f([-7.076,38.529999,-1.385]);
...
HAnimJoint183.center = new X3D.SFVec3f([-6.946,30.889999,-1.308]);
...
Transform185.translation = new X3D.SFVec3f([-6.946,30.889999,-1.308]);
...
HAnimJoint193.center = new X3D.SFVec3f([0.05249,34.130001,-0.468]);
...
Transform195.translation = new X3D.SFVec3f([0.05249,34.130001,-0.468]);
...
HAnimJoint203.center = new X3D.SFVec3f([0,51.25,-1.124]);
...
Transform205.translation = new X3D.SFVec3f([0,51.25,-1.124]);
...
EXPORT231.AS = "KoreanCharacter12Sun";
EXPORT231.localDEF = "hanim_Sun";

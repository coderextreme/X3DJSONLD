...
HAnimHumanoid23.scale = new X3D.SFVec3f([0.0225,0.0225,0.0225]);
...
MetadataString25.value = new X3D.MFString([new X3D.SFString("Chul Hee Jung and Myeong Won Lee")]);
...
HAnimJoint31.center = new X3D.SFVec3f([0,29.860001,-0.4567]);
...
Transform33.translation = new X3D.SFVec3f([0,29.860001,-0.4567]);
...
HAnimJoint41.center = new X3D.SFVec3f([2.955,28.940001,-0.5218]);
...
Transform43.translation = new X3D.SFVec3f([2.955,28.940001,-0.5218]);
...
HAnimJoint51.center = new X3D.SFVec3f([2.948,16.459999,-0.5275]);
...
Transform53.translation = new X3D.SFVec3f([2.948,16.459999,-0.5275]);
...
HAnimJoint61.center = new X3D.SFVec3f([2.839,3.899,-0.4116]);
...
Transform63.translation = new X3D.SFVec3f([2.839,3.899,-0.4116]);
...
HAnimJoint71.center = new X3D.SFVec3f([2.839,3.312,1.078]);
...
Transform73.translation = new X3D.SFVec3f([2.839,3.312,1.078]);
...
HAnimJoint81.center = new X3D.SFVec3f([-2.955,28.940001,-0.5218]);
...
Transform83.translation = new X3D.SFVec3f([-2.955,28.940001,-0.5218]);
...
HAnimJoint91.center = new X3D.SFVec3f([-2.948,16.459999,-0.5275]);
...
Transform93.translation = new X3D.SFVec3f([-2.948,16.459999,-0.5275]);
...
HAnimJoint101.center = new X3D.SFVec3f([-2.839,3.899,-0.4116]);
...
Transform103.translation = new X3D.SFVec3f([-2.839,3.899,-0.4116]);
...
HAnimJoint111.center = new X3D.SFVec3f([-2.839,3.312,1.078]);
...
Transform113.translation = new X3D.SFVec3f([-2.839,3.312,1.078]);
...
HAnimJoint31ZZZ.children[2] = HAnimJoint81;
...
HAnimJoint121.center = new X3D.SFVec3f([0,29.860001,-0.4567]);
...
Transform123.translation = new X3D.SFVec3f([0,29.860001,-0.4567]);
...
HAnimJoint131.center = new X3D.SFVec3f([6.077,45.880001,-1.319]);
...
Transform133.translation = new X3D.SFVec3f([6.077,45.880001,-1.319]);
...
HAnimJoint141.center = new X3D.SFVec3f([7.076,38.529999,-1.385]);
...
Transform143.translation = new X3D.SFVec3f([7.076,38.529999,-1.385]);
...
HAnimJoint151.center = new X3D.SFVec3f([6.946,30.889999,-1.308]);
...
Transform153.translation = new X3D.SFVec3f([6.946,30.889999,-1.308]);
...
HAnimJoint121ZZZ.children[1] = HAnimJoint131;
...
HAnimJoint161.center = new X3D.SFVec3f([-6.077,45.880001,-1.319]);
...
Transform163.translation = new X3D.SFVec3f([-6.077,45.880001,-1.319]);
...
HAnimJoint171.center = new X3D.SFVec3f([-7.076,38.529999,-1.385]);
...
Transform173.translation = new X3D.SFVec3f([-7.076,38.529999,-1.385]);
...
HAnimJoint181.center = new X3D.SFVec3f([-6.946,30.889999,-1.308]);
...
Transform183.translation = new X3D.SFVec3f([-6.946,30.889999,-1.308]);
...
Transform193.translation = new X3D.SFVec3f([0.05249,34.130001,-0.468]);
...
HAnimJoint201.center = new X3D.SFVec3f([0,51.25,-1.124]);
...
Transform203.translation = new X3D.SFVec3f([0,51.25,-1.124]);

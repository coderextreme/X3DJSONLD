...
Billboard12.axisOfRotation = new SFVec3f(new float[0,1,0]);
Billboard12.bboxCenter = new SFVec3f(new float[0,0,0]);
Billboard12.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Billboard19.axisOfRotation = new SFVec3f(new float[0,1,0]);
Billboard19.bboxCenter = new SFVec3f(new float[0,0,0]);
Billboard19.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Billboard25.axisOfRotation = new SFVec3f(new float[0,1,0]);
Billboard25.bboxCenter = new SFVec3f(new float[0,0,0]);
Billboard25.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Billboard31.axisOfRotation = new SFVec3f(new float[0,1,0]);
Billboard31.bboxCenter = new SFVec3f(new float[0,0,0]);
Billboard31.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Billboard37.axisOfRotation = new SFVec3f(new float[0,1,0]);
Billboard37.bboxCenter = new SFVec3f(new float[0,0,0]);
Billboard37.bboxSize = new SFVec3f(new float[-1,-1,-1]);

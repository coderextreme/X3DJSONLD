...
browser.currentScene.children[1] = ProtoDeclare36;
...
browser.currentScene.children[2] = ProtoDeclare58;
...
browser.currentScene.children[3] = ProtoDeclare79;
...
browser.currentScene.children[4] = ProtoInstance101;

let Group1051 = browser.currentScene.createNode("Group");
Group1051.DEF = "JointCenters_WorldInfo";
let WorldInfo1052 = browser.currentScene.createNode("WorldInfo");
...
browser.currentScene.children[5] = Group1051;

let NavigationInfo1053 = browser.currentScene.createNode("NavigationInfo");
NavigationInfo1053.avatarSize = new MFFloat(new float[0.25,1.600000023841858,0.75]);
NavigationInfo1053.speed = 1.5;
browser.currentScene.children[6] = NavigationInfo1053;

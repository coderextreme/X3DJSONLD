...
let MetadataFloat12 = browser.currentScene.createNode("MetadataFloat");
MetadataFloat12.name = "weight";
MetadataFloat12.value = new MFFloat(new float[50]);
MetadataSet6.value[5] = MetadataFloat12;

let MetadataString13 = browser.currentScene.createNode("MetadataString");
MetadataString13.name = "humanoidVersion";
MetadataString13.value = new MFString(new java.lang.String["validation testing"]);
MetadataSet6.value[6] = MetadataString13;
...
HAnimJoint14.DEF = "hanim_humanoid_root";
HAnimJoint14.center = new SFVec3f(new float[0,30.530001,-0.7076]);
...
HAnimSegment15.DEF = "hanim_sacrum";
let Transform16 = browser.currentScene.createNode("Transform");
Transform16.translation = new SFVec3f(new float[0,30.530001,-0.7076]);
...
Material19.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance18.material = Material19;

let ImageTexture20 = browser.currentScene.createNode("ImageTexture");
ImageTexture20.DEF = "JinLOA1TextureAtlas";
ImageTexture20.url = new MFString(new java.lang.String["images/Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Jin.png"]);
...
HAnimJoint24.name = "sacroiliac";
HAnimJoint24.DEF = "hanim_sacroiliac";
...
HAnimSegment25.name = "pelvis";
HAnimSegment25.DEF = "hanim_pelvis";
...
ImageTexture30.USE = "JinLOA1TextureAtlas";
...
ImageTexture40.USE = "JinLOA1TextureAtlas";
...
HAnimJoint54.name = "l_talocrural";
HAnimJoint54.DEF = "hanim_l_talocrural";
...
HAnimSegment55.name = "l_talus";
HAnimSegment55.DEF = "hanim_l_talus";
...
HAnimSegment65.name = "l_tarsal_proximal_phalanx_2";
HAnimSegment65.DEF = "hanim_l_tarsal_proximal_phalanx_2";
//TODO append _2
...
HAnimJoint94.name = "r_talocrural";
HAnimJoint94.DEF = "hanim_r_talocrural";
...
HAnimSegment95.name = "r_talus";
HAnimSegment95.DEF = "hanim_r_talus";
...
HAnimJoint104.name = "r_metatarsophalangeal_2";
HAnimJoint104.DEF = "hanim_r_metatarsophalangeal_2";
...
HAnimSegment105.name = "r_tarsal_proximal_phalanx_2";
HAnimSegment105.DEF = "hanim_r_tarsal_proximal_phalanx_2";
//TODO append _2
...
HAnimJoint14.children[1] = HAnimJoint24;

let HAnimJoint114 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint114.name = "vl5";
HAnimJoint114.DEF = "hanim_vl5";
HAnimJoint114.center = new SFVec3f(new float[0,40.07,-0.8527]);
HAnimJoint114.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment115 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment115.name = "l5";
HAnimSegment115.DEF = "hanim_l5";
let Transform116 = browser.currentScene.createNode("Transform");
Transform116.translation = new SFVec3f(new float[0,40.07,-0.8527]);
...
HAnimJoint124.DEF = "hanim_skullbase";
HAnimJoint124.center = new SFVec3f(new float[0,57.43,-0.6863]);
HAnimJoint124.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment125 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment125.name = "skull";
HAnimSegment125.DEF = "hanim_skull";
let Transform126 = browser.currentScene.createNode("Transform");
Transform126.translation = new SFVec3f(new float[0,57.43,-0.6863]);
...
HAnimJoint134.DEF = "hanim_l_shoulder";
HAnimJoint134.center = new SFVec3f(new float[5.975,52,-0.1452]);
HAnimJoint134.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment135 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment135.name = "l_upperarm";
HAnimSegment135.DEF = "hanim_l_upperarm";
let Transform136 = browser.currentScene.createNode("Transform");
Transform136.translation = new SFVec3f(new float[5.975,52,-0.1452]);
...
HAnimJoint144.name = "l_elbow";
HAnimJoint144.DEF = "hanim_l_elbow";
HAnimJoint144.center = new SFVec3f(new float[8.093,40.380001,-0.2502]);
HAnimJoint144.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment145 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment145.name = "l_forearm";
HAnimSegment145.DEF = "hanim_l_forearm";
let Transform146 = browser.currentScene.createNode("Transform");
Transform146.translation = new SFVec3f(new float[8.093,40.380001,-0.2502]);
...
HAnimJoint154.name = "l_radiocarpal";
HAnimJoint154.DEF = "hanim_l_radiocarpal";
HAnimJoint154.center = new SFVec3f(new float[7.808,31.459999,-0.05849]);
HAnimJoint154.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment155 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment155.name = "l_carpal";
HAnimSegment155.DEF = "hanim_l_carpal";
let Transform156 = browser.currentScene.createNode("Transform");
Transform156.translation = new SFVec3f(new float[7.808,31.459999,-0.05849]);
...
HAnimJoint164.name = "r_shoulder";
HAnimJoint164.DEF = "hanim_r_shoulder";
HAnimJoint164.center = new SFVec3f(new float[-5.975,52,-0.1452]);
HAnimJoint164.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment165 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment165.name = "r_upperarm";
HAnimSegment165.DEF = "hanim_r_upperarm";
let Transform166 = browser.currentScene.createNode("Transform");
Transform166.translation = new SFVec3f(new float[-5.975,52,-0.1452]);
...
Coordinate172.point = new MFVec3f(new float[-2.525,1.246,-1.68,-3.681,1.236,0.0337,-2.408,1.247,1.663,-0.4657,1.264,0.9556,-0.5379,1.264,-1.11,-2.743,-0.0209,-2.31,-4.339,-0.0351,0.057,-2.581,-0.0195,2.307,0.1009,0.0044,1.33,0.0013,0.0036,-1.523,-2.72,-2.534,-2.31,-4.317,-2.548,0.057,-2.559,-2.533,2.307,0.1233,-2.509,1.33,0.0237,-2.51,-1.523,-2.759,-3.609,-2.442,-4.448,-3.624,0.0619,-2.588,-3.608,2.442,0.2497,-3.583,1.409,0.1443,-3.583,-1.61,-2.245,-1.758,-1.939,-3.465,-1.769,-0.4543,-2.834,-1.763,1.629,-1.223,-1.749,1.432,-0.8596,-1.746,-0.7734,-2.263,-7.566,-1.569,-3.531,-7.577,-0.378,-2.875,-7.571,1.293,-1.202,-7.556,1.135,-0.8242,-7.553,-0.634,-2.267,-11.62,-1.511,-3.487,-11.63,-0.3651,-2.856,-11.62,1.243,-1.245,-11.61,1.091,-0.8817,-11.6,-0.6115,-2.213,-12.17,-0.8985,-2.928,-12.17,-0.2267,-2.558,-12.17,0.716,-1.614,-12.16,0.6268,-1.401,-12.16,-0.3711]);
IndexedFaceSet171.coord = Coordinate172;

let TextureCoordinate173 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate173.point = new MFVec2f(new float[0.2986,0.2114,0.2726,0.2114,0.3201,0.2114,0.3415,0.2114,0.2466,0.2114,0.2979,0.2417,0.2726,0.2417,0.3197,0.2417,0.3418,0.2417,0.2473,0.2417,0.2979,0.3018,0.2726,0.3018,0.3197,0.3018,0.3418,0.3018,0.2473,0.3018,0.2978,0.3276,0.2726,0.3276,0.3197,0.3276,0.3419,0.3276,0.2474,0.3276,0.2932,0.2834,0.2689,0.2834,0.316,0.2834,0.3322,0.2834,0.245,0.2834,0.2251,0.2114,0.2255,0.2417,0.2255,0.2417,0.2255,0.3018,0.2255,0.3018,0.2255,0.3276,0.2255,0.3276,0.2159,0.2834,0.4315,0.6736,0.442,0.6736,0.3947,0.6736,0.4041,0.6736,0.418,0.6736,0.4296,0.6167,0.4409,0.6167,0.4415,0.6485,0.4303,0.6485,0.3965,0.6167,0.3953,0.6485,0.4047,0.6167,0.4053,0.6485,0.4189,0.6167,0.418,0.6485,0.4415,0.6706,0.4306,0.6706,0.395,0.6706,0.4051,0.6706,0.4182,0.6706,0.3746,0.6736,0.3851,0.6736,0.384,0.6167,0.3845,0.6485,0.3845,0.6485,0.3846,0.6706,0.3846,0.6706,0.3851,0.6736,0.3481,0.2114]);
...
HAnimJoint174.name = "r_elbow";
HAnimJoint174.DEF = "hanim_r_elbow";
HAnimJoint174.center = new SFVec3f(new float[-8.093,40.380001,-0.2502]);
HAnimJoint174.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment175 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment175.name = "r_forearm";
HAnimSegment175.DEF = "hanim_r_forearm";
let Transform176 = browser.currentScene.createNode("Transform");
Transform176.translation = new SFVec3f(new float[-8.093,40.380001,-0.2502]);
...
Coordinate182.point = new MFVec3f(new float[-0.215,0.3047,-1.152,-1.155,0.2966,-0.2588,-0.6199,0.3013,1.04,0.6505,0.3122,0.9491,0.9008,0.3143,-0.4054,-0.1442,-0.8448,-1.625,-1.472,-0.8561,-0.4271,-0.7164,-0.8496,1.625,1.079,-0.8342,1.482,1.433,-0.8312,-0.6588,-0.1328,-3.5,-1.607,-1.551,-3.513,-0.4225,-0.781,-2.925,1.61,1.136,-2.909,1.468,1.551,-3.486,-0.6519,-0.0592,-8.713,-1.437,-1.093,-8.722,-0.1279,-0.5047,-8.716,1.51,0.8932,-8.704,1.377,1.169,-8.702,-0.3428,-0.0092,-9.336,-0.8855,-0.7154,-9.342,0.0084,-0.3135,-9.339,1.043,0.6412,-9.331,0.9519,0.8292,-9.329,-0.1383]);
IndexedFaceSet181.coord = Coordinate182;

let TextureCoordinate183 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate183.point = new MFVec2f(new float[0.4222,0.6201,0.4327,0.6201,0.3884,0.6201,0.3987,0.6201,0.4103,0.6201,0.4213,0.6265,0.4321,0.6265,0.3894,0.6265,0.399,0.6265,0.4105,0.6265,0.4214,0.6413,0.4323,0.6413,0.389,0.6381,0.3992,0.6381,0.4103,0.6413,0.4213,0.6705,0.4336,0.6705,0.3899,0.6705,0.3981,0.6705,0.4094,0.6705,0.4215,0.674,0.4346,0.674,0.3899,0.674,0.398,0.674,0.4083,0.674,0.3787,0.6201,0.3682,0.6201,0.3787,0.6201,0.3782,0.6265,0.3782,0.6265,0.3783,0.6413,0.3783,0.6413,0.3796,0.6705,0.3676,0.674,0.3806,0.674,0.3796,0.6705,0.3806,0.674]);
...
HAnimJoint184.name = "r_radiocarpal";
HAnimJoint184.DEF = "hanim_r_radiocarpal";
HAnimJoint184.center = new SFVec3f(new float[-7.808,31.459999,-0.05849]);
HAnimJoint184.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment185 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment185.name = "r_carpal";
HAnimSegment185.DEF = "hanim_r_carpal";
let Transform186 = browser.currentScene.createNode("Transform");
Transform186.translation = new SFVec3f(new float[-7.808,31.459999,-0.05849]);
...
Coordinate192.point = new MFVec3f(new float[-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912,0.7183,0.0002,-1.283,0.9295,-0.613,1.478,-1.647,-0.4252,1.388,-1.589,-0.3921,-1.989,1.044,-0.5947,-1.984,0.8227,-2.521,2.408,-1.951,-2.334,2.08,-1.892,-2.301,-2.409,1.192,-2.614,-2.248,0.5703,-3.958,1.694,-0.8836,-4.2,1.75,-0.8251,-4.167,-2.071,0.7842,-3.968,-1.934,1.037,-0.5968,-0.1872,1.642,-2.561,1.941,1.951,-0.9492,0.058,1.914,-1.016,1.885,1.649,-2.56,0.1377,1.066,-2.61,-0.2014,-1.209,0.0872,-1.349,0.7183,0.0002,-1.283,0.7098,-0.0015,0.8912,-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912]);
...
HAnimJoint124.children[2] = HAnimJoint164;

HAnimJoint114.children[1] = HAnimJoint124;

HAnimJoint14.children[2] = HAnimJoint114;

HAnimHumanoid5.joints = new MFNode();

HAnimHumanoid5.joints[0] = HAnimJoint14;

let HAnimJoint194 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint194.USE = "hanim_humanoid_root";
HAnimHumanoid5.joints[1] = HAnimJoint194;

let HAnimJoint195 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint195.USE = "hanim_sacroiliac";
HAnimHumanoid5.joints[2] = HAnimJoint195;

let HAnimJoint196 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint196.USE = "hanim_vl5";
HAnimHumanoid5.joints[3] = HAnimJoint196;

let HAnimJoint197 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint197.USE = "hanim_skullbase";
HAnimHumanoid5.joints[4] = HAnimJoint197;

let HAnimJoint198 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint198.USE = "hanim_l_elbow";
HAnimHumanoid5.joints[5] = HAnimJoint198;

let HAnimJoint199 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint199.USE = "hanim_r_elbow";
HAnimHumanoid5.joints[6] = HAnimJoint199;

let HAnimJoint200 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint200.USE = "hanim_l_hip";
HAnimHumanoid5.joints[7] = HAnimJoint200;

let HAnimJoint201 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint201.USE = "hanim_r_hip";
HAnimHumanoid5.joints[8] = HAnimJoint201;

let HAnimJoint202 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint202.USE = "hanim_l_knee";
HAnimHumanoid5.joints[9] = HAnimJoint202;

let HAnimJoint203 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint203.USE = "hanim_r_knee";
HAnimHumanoid5.joints[10] = HAnimJoint203;

let HAnimJoint204 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint204.USE = "hanim_l_metatarsophalangeal_2";
HAnimHumanoid5.joints[11] = HAnimJoint204;

let HAnimJoint205 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint205.USE = "hanim_r_metatarsophalangeal_2";
HAnimHumanoid5.joints[12] = HAnimJoint205;

let HAnimJoint206 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint206.USE = "hanim_l_radiocarpal";
HAnimHumanoid5.joints[13] = HAnimJoint206;

let HAnimJoint207 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint207.USE = "hanim_r_radiocarpal";
HAnimHumanoid5.joints[14] = HAnimJoint207;

let HAnimJoint208 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint208.USE = "hanim_l_shoulder";
HAnimHumanoid5.joints[15] = HAnimJoint208;

let HAnimJoint209 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint209.USE = "hanim_r_shoulder";
HAnimHumanoid5.joints[16] = HAnimJoint209;

let HAnimJoint210 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint210.USE = "hanim_l_talocrural";
HAnimHumanoid5.joints[17] = HAnimJoint210;

let HAnimJoint211 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint211.USE = "hanim_r_talocrural";
HAnimHumanoid5.joints[18] = HAnimJoint211;

let HAnimSegment212 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment212.USE = "hanim_sacrum";
HAnimHumanoid5.segments[19] = HAnimSegment212;

let HAnimSegment213 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment213.USE = "hanim_pelvis";
HAnimHumanoid5.segments[20] = HAnimSegment213;

let HAnimSegment214 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment214.USE = "hanim_l5";
HAnimHumanoid5.segments[21] = HAnimSegment214;

let HAnimSegment215 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment215.USE = "hanim_skull";
HAnimHumanoid5.segments[22] = HAnimSegment215;

let HAnimSegment216 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment216.USE = "hanim_l_calf";
HAnimHumanoid5.segments[23] = HAnimSegment216;

let HAnimSegment217 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment217.USE = "hanim_r_calf";
HAnimHumanoid5.segments[24] = HAnimSegment217;

let HAnimSegment218 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment218.USE = "hanim_l_carpal";
HAnimHumanoid5.segments[25] = HAnimSegment218;

let HAnimSegment219 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment219.USE = "hanim_r_carpal";
HAnimHumanoid5.segments[26] = HAnimSegment219;

let HAnimSegment220 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment220.USE = "hanim_l_forearm";
HAnimHumanoid5.segments[27] = HAnimSegment220;

let HAnimSegment221 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment221.USE = "hanim_r_forearm";
HAnimHumanoid5.segments[28] = HAnimSegment221;

let HAnimSegment222 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment222.USE = "hanim_l_talus";
HAnimHumanoid5.segments[29] = HAnimSegment222;

let HAnimSegment223 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment223.USE = "hanim_r_talus";
HAnimHumanoid5.segments[30] = HAnimSegment223;

let HAnimSegment224 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment224.USE = "hanim_l_tarsal_proximal_phalanx_2";
HAnimHumanoid5.segments[31] = HAnimSegment224;

let HAnimSegment225 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment225.USE = "hanim_r_tarsal_proximal_phalanx_2";
HAnimHumanoid5.segments[32] = HAnimSegment225;

let HAnimSegment226 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment226.USE = "hanim_l_thigh";
HAnimHumanoid5.segments[33] = HAnimSegment226;

let HAnimSegment227 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment227.USE = "hanim_r_thigh";
HAnimHumanoid5.segments[34] = HAnimSegment227;

let HAnimSegment228 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment228.USE = "hanim_l_upperarm";
HAnimHumanoid5.segments[35] = HAnimSegment228;

let HAnimSegment229 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment229.USE = "hanim_r_upperarm";
HAnimHumanoid5.segments[36] = HAnimSegment229;

...
scene.addMetaData("reference", "https://www.HAnim.org/Models/HAnim2001/boxman/protos/LOA1_WalkAnimation.wrl");
...
Text112.string = new X3D.MFString([new X3D.SFString("LOA1_KneelAnimation.x3d"), new X3D.SFString("defines a prototype"), new X3D.SFString("for animating a humanoid."), new X3D.SFString("Click this text to see"), new X3D.SFString("InterchangableActorsViaDynamicRouting example.")]);

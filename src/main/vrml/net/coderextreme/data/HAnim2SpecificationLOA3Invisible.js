...
HAnimJoint175.stiffness = new SFVec3f(new float[0,0,0]);
...
HAnimJoint208.stiffness = new SFVec3f(new float[0,0,0]);
...
HAnimJoint216.stiffness = new SFVec3f(new float[0,0,0]);
...
HAnimJoint225.stiffness = new SFVec3f(new float[0,0,0]);
...
HAnimJoint274.stiffness = new SFVec3f(new float[0,0,0]);
...
HAnimJoint280.stiffness = new SFVec3f(new float[0,0,0]);
...
HAnimJoint284.stiffness = new SFVec3f(new float[0,0,0]);

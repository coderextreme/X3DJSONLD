...
WorldInfo13.title = "SimpleCamera.x3d";
WorldInfo13.info = new MFString(new java.lang.String["VRML2.0 created with Version 1.3, from Alias Maya 2008"]);
browser.currentScene.children = new MFNode();

browser.currentScene.children[0] = WorldInfo13;

let Viewpoint14 = browser.currentScene.createNode("Viewpoint");
Viewpoint14.DEF = "CameraShapeView";
Viewpoint14.description = "Camera view, over the shoulder";
Viewpoint14.position = new SFVec3f(new float[0,0.75,3]);
browser.currentScene.children[1] = Viewpoint14;

let Viewpoint15 = browser.currentScene.createNode("Viewpoint");
Viewpoint15.description = "Camera view through lens";
...
Viewpoint16.description = "Camera view from right side";
Viewpoint16.position = new SFVec3f(new float[12,0,-4]);
Viewpoint16.orientation = new SFRotation(new float[0,1,0,1.5708]);
browser.currentScene.children[3] = Viewpoint16;

let Viewpoint17 = browser.currentScene.createNode("Viewpoint");
Viewpoint17.description = "Camera view from above";
Viewpoint17.position = new SFVec3f(new float[0,15,-5]);
Viewpoint17.orientation = new SFRotation(new float[1,0,0,-1.5708]);
browser.currentScene.children[4] = Viewpoint17;

let Viewpoint18 = browser.currentScene.createNode("Viewpoint");
Viewpoint18.description = "Camera view from left side";
Viewpoint18.position = new SFVec3f(new float[-12,0,-4]);
Viewpoint18.orientation = new SFRotation(new float[0,1,0,-1.5708]);
browser.currentScene.children[5] = Viewpoint18;

let Transform19 = browser.currentScene.createNode("Transform");
Transform19.translation = new SFVec3f(new float[0,-0.165,0.02]);
Transform19.scale = new SFVec3f(new float[0.1,0.1,0.1]);
...
Appearance22.DEF = "CameraAppearance";
let Material23 = browser.currentScene.createNode("Material");
Material23.DEF = "lambert1_1";
Material23.ambientIntensity = 0.25;
Material23.diffuseColor = new SFColor(new float[0.372322,0.371574,0.373173]);
Material23.specularColor = new SFColor(new float[0.890909,0.887832,0.890909]);
Material23.shininess = 0.02;
...
Appearance25.USE = "CameraAppearance";
...
Shape36.geometry = IndexedFaceSet38;

Switch20.children[4] = Shape36;
...
Transform41.DEF = "pCylinder1";
Transform41.translation = new SFVec3f(new float[-0.038462,3.596312,3.297562]);
Transform41.rotation = new SFRotation(new float[-1,0,0,0.373518]);
let Shape42 = browser.currentScene.createNode("Shape");
let Appearance43 = browser.currentScene.createNode("Appearance");
Appearance43.USE = "CameraAppearance";
Shape42.appearance = Appearance43;

let IndexedFaceSet44 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet44.USE = "pCylinder1_0Geo";
...
Transform45.DEF = "pCube1";
Transform45.translation = new SFVec3f(new float[-0.030769,1.738461,1.4436]);
Transform45.scale = new SFVec3f(new float[1,0.727134,0.801457]);
let Shape46 = browser.currentScene.createNode("Shape");
let Appearance47 = browser.currentScene.createNode("Appearance");
Appearance47.USE = "CameraAppearance";
Shape46.appearance = Appearance47;

let IndexedFaceSet48 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet48.USE = "pCube1_0Geo";
Shape46.geometry = IndexedFaceSet48;
...
Transform49.DEF = "pPipe1";
Transform49.translation = new SFVec3f(new float[0.015385,1.630769,-1.973274]);
Transform49.scale = new SFVec3f(new float[1,1,0.569444]);
let Shape50 = browser.currentScene.createNode("Shape");
let Appearance51 = browser.currentScene.createNode("Appearance");
Appearance51.USE = "CameraAppearance";
Shape50.appearance = Appearance51;

let IndexedFaceSet52 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet52.USE = "pPipe1_0Geo";
Shape50.geometry = IndexedFaceSet52;

Transform49.child = new undefined();

Transform49.child[0] = Shape50;

Group40.children[2] = Transform49;

let Transform53 = browser.currentScene.createNode("Transform");
Transform53.DEF = "pSphere1";
Transform53.translation = new SFVec3f(new float[-0.015385,1.628515,-2.569231]);
Transform53.scale = new SFVec3f(new float[1.1,1.1,0.1]);
let Shape54 = browser.currentScene.createNode("Shape");
let Appearance55 = browser.currentScene.createNode("Appearance");
Appearance55.USE = "CameraAppearance";
Shape54.appearance = Appearance55;

let IndexedFaceSet56 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet56.USE = "pSphere1_0Geo";
Shape54.geometry = IndexedFaceSet56;

Transform53.child = new undefined();

Transform53.child[0] = Shape54;

Group40.children[3] = Transform53;

Transform19.children[1] = Group40;

browser.currentScene.children[6] = Transform19;

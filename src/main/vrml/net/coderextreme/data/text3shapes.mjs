...
scene.addMetaData("title", "text3shapes.x3d");
scene.addMetaData("identifier", "https://coderextreme.net/X3DJSONLD/src/main/data/text3shapes.x3d");
scene.addMetaData("description", "3 text shapes");
...
Text16.string = new X3D.MFString([new X3D.SFString("Node2"), new X3D.SFString("\\\\\\\\\\\\Node2")]);
...
Text21.string = new X3D.MFString([new X3D.SFString("Node3 \\\\\\\\ \\\\ Node3\"\"\"")]);

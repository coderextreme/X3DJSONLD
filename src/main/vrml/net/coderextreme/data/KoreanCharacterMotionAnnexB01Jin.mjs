...
HAnimHumanoid24.info = new MFString(new java.lang.String["humanoidVersion=2.0"]);
...
HAnimJoint25.center = new SFVec3f(new float[0,30.53,-0.7076]);
...
Transform27.translation = new SFVec3f(new float[0,30.53,-0.7076]);
...
ImageTexture31.url = new MFString(new java.lang.String["Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/Jin.png"]);
...
HAnimJoint35.center = new SFVec3f(new float[0,35.8,-0.7076]);
...
Transform37.translation = new SFVec3f(new float[0,35.8,-0.7076]);
...
HAnimJoint45.center = new SFVec3f(new float[4.207,32.02,-0.8155]);
...
Transform47.translation = new SFVec3f(new float[4.207,32.02,-0.8155]);
...
HAnimJoint55.center = new SFVec3f(new float[4.116,17.26,-0.8639]);
...
Transform57.translation = new SFVec3f(new float[4.116,17.26,-0.8639]);
...
HAnimJoint65.center = new SFVec3f(new float[3.854,3.939,-0.7038]);
...
Transform67.translation = new SFVec3f(new float[3.854,3.939,-0.7038]);
...
HAnimJoint75.center = new SFVec3f(new float[3.854,3.64,0.7402]);
...
Transform77.translation = new SFVec3f(new float[3.854,3.64,0.7402]);
...
HAnimJoint65.children[1] = HAnimJoint75;
...
HAnimJoint85.center = new SFVec3f(new float[-4.207,32.02,-0.8155]);
...
Transform87.translation = new SFVec3f(new float[-4.207,32.02,-0.8155]);
...
HAnimJoint95.center = new SFVec3f(new float[-4.116,17.26,-0.8639]);
...
Transform97.translation = new SFVec3f(new float[-4.116,17.26,-0.8639]);
...
HAnimJoint105.center = new SFVec3f(new float[-3.854,3.939,-0.7038]);
...
Transform107.translation = new SFVec3f(new float[-3.854,3.939,-0.7038]);
...
HAnimJoint115.center = new SFVec3f(new float[-3.854,3.64,0.7402]);
...
Transform117.translation = new SFVec3f(new float[-3.854,3.64,0.7402]);
...
Transform127.translation = new SFVec3f(new float[0,40.23,-0.8527]);
...
HAnimJoint135.center = new SFVec3f(new float[0,57.43,-0.6863]);
...
Transform137.translation = new SFVec3f(new float[0,57.43,-0.6863]);
...
HAnimJoint145.center = new SFVec3f(new float[5.975,52,-0.1452]);
...
Transform147.translation = new SFVec3f(new float[5.975,52,-0.1452]);
...
HAnimJoint155.center = new SFVec3f(new float[8.093,40.38,-0.2502]);
...
Transform157.translation = new SFVec3f(new float[8.093,40.38,-0.2502]);
...
HAnimJoint165.center = new SFVec3f(new float[7.808,31.46,-0.05849]);
...
Transform167.translation = new SFVec3f(new float[7.808,31.46,-0.05849]);
...
HAnimJoint145.children[1] = HAnimJoint155;

HAnimJoint125.children[2] = HAnimJoint145;
...
HAnimJoint175.center = new SFVec3f(new float[-5.975,52,-0.1452]);
...
Transform177.translation = new SFVec3f(new float[-5.975,52,-0.1452]);
...
HAnimJoint185.center = new SFVec3f(new float[-8.093,40.38,-0.2502]);
...
Transform187.translation = new SFVec3f(new float[-8.093,40.38,-0.2502]);
...
HAnimJoint195.center = new SFVec3f(new float[-7.808,31.46,-0.05849]);
...
Transform197.translation = new SFVec3f(new float[-7.808,31.46,-0.05849]);
...
HAnimJoint175.children[1] = HAnimJoint185;

HAnimJoint125.children[3] = HAnimJoint175;

HAnimJoint35.children[3] = HAnimJoint125;
...
Group205.children[0] = TimeSensor206;
...
PositionInterpolator207.key = new MFFloat(new float[0,1]);
PositionInterpolator207.keyValue = new MFVec3f(new float[0,0,0,0,0,0]);
Group205.children[1] = PositionInterpolator207;
...
Group205.children[2] = OrientationInterpolator208;
...
OrientationInterpolator209.key = new MFFloat(new float[0,1]);
OrientationInterpolator209.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group205.children[3] = OrientationInterpolator209;
...
OrientationInterpolator210.keyValue = new MFRotation(new float[0,0,0,0,-1,0,0,3,0,0,0,0]);
Group205.children[4] = OrientationInterpolator210;
...
Group205.children[5] = OrientationInterpolator211;
...
OrientationInterpolator212.key = new MFFloat(new float[0,1]);
OrientationInterpolator212.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group205.children[6] = OrientationInterpolator212;
...
OrientationInterpolator213.keyValue = new MFRotation(new float[0,0,0,0,-1,0,0,3,0,0,0,0]);
Group205.children[7] = OrientationInterpolator213;
...
Group205.children[8] = OrientationInterpolator214;
...
Group205.children[9] = OrientationInterpolator215;
...
Group205.children[10] = OrientationInterpolator216;
...
Group205.children[11] = OrientationInterpolator217;
...
Group205.children[12] = OrientationInterpolator218;
...
Group205.children[13] = OrientationInterpolator219;
...
Group205.children[14] = OrientationInterpolator220;
...
Group205.children[15] = OrientationInterpolator221;
...
Group205.children[16] = OrientationInterpolator222;
...
Group205.children[17] = OrientationInterpolator223;
...
Group205.children[18] = OrientationInterpolator224;
...
OrientationInterpolator225.key = new MFFloat(new float[0,1]);
OrientationInterpolator225.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group205.children[19] = OrientationInterpolator225;

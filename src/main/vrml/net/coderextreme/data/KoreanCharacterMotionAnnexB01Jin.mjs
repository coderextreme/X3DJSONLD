...
meta2.name = "title";
meta2.content = "KoreanCharacterMotionAnnexB01Jin.x3d";
...
meta12.content = "HAnim 2.0 Part 2: Humanoid animation (HAnim) motion data animation, Annex D (informative) Examples of HAnim motion data animation using a Motion object";
head1.meta[10] = meta12;

let meta13 = browser.currentScene.createNode("meta");
meta13.name = "specificationUrl";
meta13.content = "https://www.web3d.org/documents/specifications/19774/V2.0/MotionDataAnimation/ExampleKeyframeAnimation.html";
head1.meta[11] = meta13;

let meta14 = browser.currentScene.createNode("meta");
meta14.name = "identifier";
meta14.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/KoreanCharacterAnnexB01Jin.x3d";
...
Viewpoint22.description = "AnnexB01Jin";
...
HAnimHumanoid23.DEF = "hanim_AnnexB01Jin";
HAnimHumanoid23.version = "2.0";
HAnimHumanoid23.name = "AnnexB01Jin";
HAnimHumanoid23.info = new MFString(new java.lang.String["humanoidVersion=2.0"]);
...
HAnimJoint24.DEF = "hanim_HumanoidRoot";
HAnimJoint24.name = "HumanoidRoot";
HAnimJoint24.center = new SFVec3f(new float[0,30.53,-0.7076]);
...
Transform26.translation = new SFVec3f(new float[0,30.53,-0.7076]);
...
ImageTexture30.DEF = "Annex01JinTextureAtlas";
ImageTexture30.url = new MFString(new java.lang.String["Jin.png","http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/Jin.png"]);
Appearance28.texture = ImageTexture30;

Shape27.appearance = Appearance28;

let IndexedFaceSet31 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet31.creaseAngle = 3.14159;
...
HAnimJoint34.center = new SFVec3f(new float[0,35.8,-0.7076]);
...
Transform36.translation = new SFVec3f(new float[0,35.8,-0.7076]);
...
ImageTexture40.USE = "Annex01JinTextureAtlas";
...
Coordinate43.point = new MFVec3f(new float[0,1.053,0.0273,0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.875,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0,0.9123,0.596,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.875,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.98,0.5267,-0.4285,-1.132,0.5267,0.0273,-0.98,0.5267,0.483,-0.5658,0.5267,0.6985,0,0.5267,0.8206,0.5658,0.5267,0.6985,0.98,0.5267,0.483,1.132,0.5267,0.0273,0.98,0.5267,-0.4285,0.5658,0.5267,-0.7621,0,0,-0.9616,-0.6534,0,-0.8206,-1.132,0,-0.4353,-1.307,0,0.0273,-1.132,0,0.5536,-0.6534,0,0.8206,0,0,0.9616,0.6534,0,0.8206,1.132,0,0.5536,1.307,0,0.0273,1.132,0,-0.4353,0.6534,0,-0.8206,0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0,-1.053,0.0273]);
...
HAnimJoint44.center = new SFVec3f(new float[4.207,32.02,-0.8155]);
...
Transform46.translation = new SFVec3f(new float[4.207,32.02,-0.8155]);
...
ImageTexture50.USE = "Annex01JinTextureAtlas";
...
HAnimJoint54.DEF = "hanim_l_knee";
HAnimJoint54.name = "l_knee";
HAnimJoint54.center = new SFVec3f(new float[4.116,17.26,-0.8639]);
let HAnimSegment55 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment55.DEF = "hanim_l_calf";
HAnimSegment55.name = "l_calf";
let Transform56 = browser.currentScene.createNode("Transform");
Transform56.translation = new SFVec3f(new float[4.116,17.26,-0.8639]);
...
ImageTexture60.USE = "Annex01JinTextureAtlas";
...
HAnimJoint64.DEF = "hanim_l_talocrural";
HAnimJoint64.name = "l_talocrural";
HAnimJoint64.center = new SFVec3f(new float[3.854,3.939,-0.7038]);
...
Transform66.translation = new SFVec3f(new float[3.854,3.939,-0.7038]);
...
ImageTexture70.USE = "Annex01JinTextureAtlas";
...
HAnimJoint74.DEF = "hanim_l_metatarsophalangeal";
HAnimJoint74.name = "l_metatarsophalangeal";
HAnimJoint74.center = new SFVec3f(new float[3.854,3.64,0.7402]);
let HAnimSegment75 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment75.DEF = "hanim_l_middistal";
HAnimSegment75.name = "l_middistal";
let Transform76 = browser.currentScene.createNode("Transform");
Transform76.translation = new SFVec3f(new float[3.854,3.64,0.7402]);
...
ImageTexture80.USE = "Annex01JinTextureAtlas";
...
HAnimJoint84.DEF = "hanim_r_hip";
HAnimJoint84.name = "r_hip";
HAnimJoint84.center = new SFVec3f(new float[-4.207,32.02,-0.8155]);
let HAnimSegment85 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment85.DEF = "hanim_r_thigh";
HAnimSegment85.name = "r_thigh";
let Transform86 = browser.currentScene.createNode("Transform");
Transform86.translation = new SFVec3f(new float[-4.207,32.02,-0.8155]);
...
ImageTexture90.USE = "Annex01JinTextureAtlas";
...
TextureCoordinate92.point = new MFVec2f(new float[0.719,0.5576,0.6284,0.5576,0.7414,0.5576,0.6787,0.5576,0.5781,0.5576,0.5154,0.5576,0.5378,0.5576,0.6284,0.5029,0.7509,0.3997,0.6284,0.3997,0.7509,0.5029,0.7811,0.3997,0.7811,0.5029,0.6964,0.3997,0.6964,0.5029,0.5604,0.3997,0.5604,0.5029,0.4756,0.3997,0.4756,0.5029,0.5059,0.3997,0.5059,0.5029,0.7509,0.3197,0.6284,0.3197,0.7811,0.3197,0.6964,0.3197,0.5604,0.3197,0.4756,0.3197,0.5059,0.3197,0.7651,0.2166,0.6284,0.2166,0.7989,0.2166,0.7043,0.2166,0.5525,0.2166,0.4579,0.2166,0.4917,0.2166,0.7224,0.263,0.6284,0.263,0.7456,0.263,0.6805,0.263,0.5762,0.263,0.5112,0.263,0.5344,0.263,0.8705,0.5452,0.8705,0.5383,0.8705,0.5369,0.8705,0.5408,0.8705,0.5483,0.8705,0.5522,0.8705,0.5509,0.917,0.5452,0.917,0.5266,0.89,0.5304,0.89,0.5452,0.917,0.522,0.89,0.5268,0.917,0.5349,0.89,0.537,0.917,0.5555,0.89,0.5534,0.917,0.5684,0.89,0.5636,0.917,0.5638,0.89,0.56,0.8746,0.531,0.8746,0.5452,0.8746,0.5279,0.8746,0.5368,0.8746,0.5524,0.8746,0.5613,0.8746,0.5581]);
IndexedFaceSet91.texCoord = TextureCoordinate92;

let Coordinate93 = browser.currentScene.createNode("Coordinate");
Coordinate93.point = new MFVec3f(new float[-2.96,3.738,0,-1.643,3.738,3.209,1.316,3.738,4.002,3.367,3.738,1.781,3.367,3.738,-1.781,1.316,3.738,-4.002,-1.643,3.738,-3.209,-2.96,-0.0114,0,-1.643,-0.0114,3.209,1.316,-0.0114,4.002,3.367,-0.0114,1.781,3.367,-0.0114,-1.781,1.316,-0.0114,-4.002,-1.643,-0.0114,-3.209,-2.96,-6.507,0,-1.643,-6.507,3.209,1.316,-6.507,4.002,3.367,-6.507,1.781,3.367,-6.507,-1.781,1.316,-6.507,-4.002,-1.643,-6.507,-3.209,-3.367,-13.13,0,-1.897,-13.13,3.582,1.407,-13.13,4.467,3.355,-13.13,1.988,3.355,-13.13,-1.988,1.407,-13.13,-4.467,-1.897,-13.13,-3.582,-2.146,-4.985,0,-1.136,-4.985,2.462,1.135,-4.985,3.07,2.633,-4.985,1.366,2.633,-4.985,-1.366,1.135,-4.985,-3.07,-1.136,-4.985,-2.462,-2.156,-11.45,0,-1.225,-11.45,1.956,0.8662,-11.45,2.439,2.543,-11.45,1.085,2.543,-11.45,-1.085,0.8662,-11.45,-2.439,-1.225,-11.45,-1.956,-2.051,5.729,0,-1.076,5.729,2.375,1.114,5.729,2.961,2.87,5.729,1.318,2.87,5.729,-1.318,1.114,5.729,-2.961,-1.076,5.729,-2.375,-1.842,-15.12,0,-1.03,-15.12,1.873,0.7965,-15.12,2.295,2.261,-15.12,1.113,2.261,-15.12,-0.9478,0.7965,-15.12,-2.13,-1.03,-15.12,-1.708,-0.6277,-16.1,0,-0.2723,-16.1,0.912,0.5262,-16.1,1.096,1.167,-16.1,0.5796,1.167,-16.1,-0.4145,0.5262,-16.1,-0.9313,-0.2723,-16.1,-0.7469]);
...
HAnimJoint94.DEF = "hanim_r_knee";
HAnimJoint94.name = "r_knee";
HAnimJoint94.center = new SFVec3f(new float[-4.116,17.26,-0.8639]);
let HAnimSegment95 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment95.DEF = "hanim_r_calf";
HAnimSegment95.name = "r_calf";
let Transform96 = browser.currentScene.createNode("Transform");
Transform96.translation = new SFVec3f(new float[-4.116,17.26,-0.8639]);
...
ImageTexture100.USE = "Annex01JinTextureAtlas";
...
TextureCoordinate102.point = new MFVec2f(new float[0.9309,0.5848,0.919,0.5848,0.8921,0.5848,0.8706,0.5848,0.8706,0.5848,0.8921,0.5848,0.919,0.5848,0.9845,0.5321,0.955,0.5475,0.9491,0.5599,0.9788,0.5571,0.8787,0.5475,0.8825,0.5599,0.8302,0.5321,0.8291,0.5571,0.8302,0.52,0.8291,0.5571,0.8787,0.52,0.8825,0.5571,0.955,0.52,0.9491,0.5571,0.9444,0.5755,0.9717,0.5755,0.8831,0.5755,0.8339,0.5755,0.8339,0.5755,0.8831,0.5755,0.9444,0.5755,0.9679,0.2444,0.9449,0.2445,0.8931,0.2445,0.8516,0.2444,0.8516,0.2442,0.8931,0.2442,0.9449,0.2442,0.9372,0.2243,0.9255,0.2244,0.8993,0.2244,0.8783,0.2243,0.8783,0.2243,0.8993,0.2243,0.9255,0.2243]);
IndexedFaceSet101.texCoord = TextureCoordinate102;

let Coordinate103 = browser.currentScene.createNode("Coordinate");
Coordinate103.point = new MFVec3f(new float[-0.7186,0.9688,0.0234,-0.3632,0.9688,0.9354,0.4353,0.9688,1.12,1.076,0.9688,0.603,1.076,0.9688,-0.3911,0.4353,0.9688,-0.9079,-0.3632,0.9688,-0.7235,-2.337,-4.613,0.0234,-1.46,-3.622,2.019,-1.236,-1.628,2.42,-2.118,-1.912,0.0234,0.8111,-3.622,2.567,0.7468,-1.628,2.903,2.254,-4.613,1.255,2.337,-1.912,0.9793,2.254,-5.383,-1.368,2.337,-1.912,-0.9325,0.8111,-5.383,-2.903,0.7468,-1.912,-2.368,-1.46,-5.383,-2.355,-1.236,-1.912,-1.885,-1.121,-0.0032,1.896,-1.933,-0.0032,0.0234,0.7056,-0.0032,2.318,2.17,-0.0032,1.136,2.17,-0.0032,-0.9244,0.7056,-0.0032,-2.061,-1.121,-0.0032,-1.64,-1.607,-12.92,0.0032,-0.9216,-12.91,1.565,0.619,-12.91,1.951,1.854,-12.92,0.8701,1.854,-12.94,-0.9762,0.619,-12.94,-1.742,-0.9216,-12.94,-1.356,-0.7072,-14.53,0.0239,-0.3604,-14.53,0.814,0.4188,-14.53,1.009,1.044,-14.53,0.4624,1.044,-14.54,-0.4714,0.4188,-14.54,-0.8587,-0.3604,-14.54,-0.6635]);
...
HAnimJoint104.DEF = "hanim_r_talocrural";
HAnimJoint104.name = "r_talocrural";
HAnimJoint104.center = new SFVec3f(new float[-3.854,3.939,-0.7038]);
let HAnimSegment105 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment105.DEF = "hanim_r_hindfoot";
HAnimSegment105.name = "r_hindfoot";
let Transform106 = browser.currentScene.createNode("Transform");
Transform106.translation = new SFVec3f(new float[-3.854,3.939,-0.7038]);
...
ImageTexture110.USE = "Annex01JinTextureAtlas";
...
TextureCoordinate112.point = new MFVec2f(new float[0.3819,0.171,0.4216,0.1651,0.3819,0.171,0.4216,0.1651,0.3819,0.171,0.3819,0.171,0.4637,0.1714,0.4216,0.1651,0.4637,0.1714,0.4216,0.1651,0.3819,0.171,0.3819,0.171,0.3819,0.171,0.3819,0.171,0.4637,0.1714,0.4637,0.1714,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.3836,0.1404,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.4637,0.1714,0.4394,0.1472,0.4244,0.1312,0.3861,0.1398,0.3873,0.0706,0.3871,0.0221,0.3873,0.0706,0.3871,0.0221,0.3871,0.0221,0.3861,0.1398,0.3836,0.1404,0.3873,0.0706,0.3873,0.0706,0.3836,0.1404,0.3861,0.1398,0.3871,0.0221,0.3871,0.0221,0.3871,0.0221,0.433,0.0595,0.4411,0.0186,0.4244,0.1312,0.433,0.0595,0.4244,0.1312,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.3861,0.1398,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4244,0.1312,0.4411,0.0186,0.433,0.0595,0.4244,0.1312,0.4244,0.1312,0.433,0.0595,0.4411,0.0186,0.4411,0.0186]);
IndexedFaceSet111.texCoord = TextureCoordinate112;

let Coordinate113 = browser.currentScene.createNode("Coordinate");
Coordinate113.point = new MFVec3f(new float[-0.9768,-0.0192,-1.681,-1.657,-0.0192,0.4309,0,-0.0192,-1.681,-1.403,0.7316,0.354,-0.8174,0.7316,-1.463,0,0.7316,-1.463,0,0.7316,1.471,1.657,-0.0192,0.4309,1.403,0.7316,0.354,0.8174,0.7316,-1.463,0.9768,-0.0192,-1.681,0,-0.0192,1.75,-1.109,-0.6007,-2.046,-2.045,-0.6007,0.4309,-1.695,-0.296,1.429,0,-0.6007,-2.046,1.109,-0.6007,-2.046,2.045,-0.6007,0.4309,1.695,-0.296,1.429,0,-1.207,-1.841,-1.023,-1.207,-1.841,-1.913,-1.223,0.5161,-1.601,-0.9325,1.406,0,-0.6582,1.708,1.601,-0.9325,1.406,1.913,-1.223,0.5161,1.023,-1.207,-1.841,-1.409,-1.925,-2.878,-1.409,-3.947,-1.681,0,-3.947,-1.681,-1.109,-0.6007,-2.046,0,-0.6007,-2.046,1.409,-1.925,-2.878,0,-1.925,-2.878,1.109,-0.6007,-2.046,1.409,-3.947,-1.681,-2.927,-1.925,0.4309,-2.089,-3.947,0.4309,-2.045,-0.6007,0.4309,2.927,-1.925,0.4309,2.045,-0.6007,0.4309,2.089,-3.947,0.4309,0,-3.947,0.4309,-0.9442,-0.3153,-1.692,0,-0.3153,-1.692,0.9442,-0.3153,-1.692,1.7,-0.3153,0.3093,-1.7,-0.3153,0.3093,-1.86,-3.793,1.364,-2.541,-1.963,1.364,-1.861,-0.9431,1.364,1.861,-0.9431,1.364,2.541,-1.963,1.364,1.86,-3.793,1.364,0,-3.793,1.364]);
...
HAnimJoint114.DEF = "hanim_r_metatarsophalangeal";
HAnimJoint114.name = "r_metatarsophalangeal";
HAnimJoint114.center = new SFVec3f(new float[-3.854,3.64,0.7402]);
let HAnimSegment115 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment115.DEF = "hanim_r_middistal";
HAnimSegment115.name = "r_middistal";
let Transform116 = browser.currentScene.createNode("Transform");
Transform116.translation = new SFVec3f(new float[-3.854,3.64,0.7402]);
...
ImageTexture120.USE = "Annex01JinTextureAtlas";
...
TextureCoordinate122.point = new MFVec2f(new float[0.433,0.0595,0.4411,0.0186,0.4637,0.1714,0.4411,0.0186,0.4244,0.1312,0.4394,0.1472,0.433,0.0595,0.4244,0.1312,0.4411,0.0186,0.4637,0.1714,0.4394,0.1472,0.4411,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4949,0.0186,0.4868,0.1432,0.4868,0.1432,0.433,0.0595,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.433,0.0595,0.4244,0.1312,0.4244,0.1312,0.532,0.098,0.5645,0.0707,0.4885,0.102,0.5026,0.044,0.5945,0.0186,0.5487,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4868,0.1432,0.5645,0.0707,0.5026,0.044,0.4885,0.102,0.532,0.098,0.5945,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.5487,0.0186,0.4949,0.0186,0.4868,0.1432]);
IndexedFaceSet121.texCoord = TextureCoordinate122;

let Coordinate123 = browser.currentScene.createNode("Coordinate");
Coordinate123.point = new MFVec3f(new float[-2.927,-1.627,-1.013,-2.089,-3.648,-1.013,0,0.2797,0.3064,-2.045,-0.3017,-1.013,-1.695,0.0029,-0.0151,2.927,-1.627,-1.013,2.045,-0.3017,-1.013,2.089,-3.648,-1.013,1.695,0.0029,-0.0151,0,-3.648,-1.013,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0,-3.648,0.9192,0,-0.0274,1.661,-2.405,-1.656,-1.915,-1.75,-2.942,-1.915,0,-2.942,-1.915,1.75,-2.942,-1.915,2.405,-1.656,-1.915,1.742,-0.5681,-1.915,-1.742,-0.5681,-1.915,-1.784,-0.648,2.332,-2.216,-2.267,4.144,-2.216,-3.648,3.776,0,-2.267,5.463,0,-0.5463,3.95,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,2.216,-2.267,4.144,1.784,-0.648,2.332,0,-3.648,5.096,2.216,-3.648,3.776,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0,-3.648,3.776,0,-3.648,0.9192,0,-0.0274,1.661]);
...
HAnimJoint34.children[2] = HAnimJoint84;

let HAnimJoint124 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint124.DEF = "hanim_vl5";
HAnimJoint124.name = "vl5";
HAnimJoint124.center = new SFVec3f(new float[0,40.23,-0.8527]);
let HAnimSegment125 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment125.DEF = "hanim_l5";
HAnimSegment125.name = "l5";
let Transform126 = browser.currentScene.createNode("Transform");
Transform126.translation = new SFVec3f(new float[0,40.23,-0.8527]);
...
ImageTexture130.USE = "Annex01JinTextureAtlas";
...
HAnimJoint134.center = new SFVec3f(new float[0,57.43,-0.6863]);
let HAnimSegment135 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment135.DEF = "hanim_skull";
HAnimSegment135.name = "skull";
let Transform136 = browser.currentScene.createNode("Transform");
Transform136.translation = new SFVec3f(new float[0,57.43,-0.6863]);
...
ImageTexture140.USE = "Annex01JinTextureAtlas";
...
HAnimJoint144.center = new SFVec3f(new float[5.975,52,-0.1452]);
let HAnimSegment145 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment145.DEF = "hanim_l_upperarm";
HAnimSegment145.name = "l_upperarm";
let Transform146 = browser.currentScene.createNode("Transform");
Transform146.translation = new SFVec3f(new float[5.975,52,-0.1452]);
...
ImageTexture150.USE = "Annex01JinTextureAtlas";
...
HAnimJoint154.DEF = "hanim_l_elbow";
HAnimJoint154.name = "l_elbow";
HAnimJoint154.center = new SFVec3f(new float[8.093,40.38,-0.2502]);
let HAnimSegment155 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment155.DEF = "hanim_l_forearm";
HAnimSegment155.name = "l_forearm";
let Transform156 = browser.currentScene.createNode("Transform");
Transform156.translation = new SFVec3f(new float[8.093,40.38,-0.2502]);
...
ImageTexture160.USE = "Annex01JinTextureAtlas";
...
IndexedFaceSet161.texCoord = TextureCoordinate162;
...
HAnimJoint164.DEF = "hanim_l_radiocarpal";
HAnimJoint164.name = "l_radiocarpal";
HAnimJoint164.center = new SFVec3f(new float[7.808,31.46,-0.05849]);
let HAnimSegment165 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment165.DEF = "hanim_l_hand";
HAnimSegment165.name = "l_hand";
let Transform166 = browser.currentScene.createNode("Transform");
Transform166.translation = new SFVec3f(new float[7.808,31.46,-0.05849]);
...
ImageTexture170.USE = "Annex01JinTextureAtlas";
...
HAnimJoint124.children[2] = HAnimJoint144;

let HAnimJoint174 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint174.DEF = "hanim_r_shoulder";
HAnimJoint174.name = "r_shoulder";
HAnimJoint174.center = new SFVec3f(new float[-5.975,52,-0.1452]);
let HAnimSegment175 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment175.DEF = "hanim_r_upperarm";
HAnimSegment175.name = "r_upperarm";
let Transform176 = browser.currentScene.createNode("Transform");
Transform176.translation = new SFVec3f(new float[-5.975,52,-0.1452]);
...
ImageTexture180.USE = "Annex01JinTextureAtlas";
...
TextureCoordinate182.point = new MFVec2f(new float[0.2986,0.2114,0.2726,0.2114,0.3201,0.2114,0.3415,0.2114,0.2466,0.2114,0.2979,0.2417,0.2726,0.2417,0.3197,0.2417,0.3418,0.2417,0.2473,0.2417,0.2979,0.3018,0.2726,0.3018,0.3197,0.3018,0.3418,0.3018,0.2473,0.3018,0.2978,0.3276,0.2726,0.3276,0.3197,0.3276,0.3419,0.3276,0.2474,0.3276,0.2932,0.2834,0.2689,0.2834,0.316,0.2834,0.3322,0.2834,0.245,0.2834,0.2251,0.2114,0.2255,0.2417,0.2255,0.2417,0.2255,0.3018,0.2255,0.3018,0.2255,0.3276,0.2255,0.3276,0.2159,0.2834,0.4315,0.6736,0.442,0.6736,0.3947,0.6736,0.4041,0.6736,0.418,0.6736,0.4296,0.6167,0.4409,0.6167,0.4415,0.6485,0.4303,0.6485,0.3965,0.6167,0.3953,0.6485,0.4047,0.6167,0.4053,0.6485,0.4189,0.6167,0.418,0.6485,0.4415,0.6706,0.4306,0.6706,0.395,0.6706,0.4051,0.6706,0.4182,0.6706,0.3746,0.6736,0.3851,0.6736,0.384,0.6167,0.3845,0.6485,0.3845,0.6485,0.3846,0.6706,0.3846,0.6706,0.3851,0.6736,0.3481,0.2114]);
IndexedFaceSet181.texCoord = TextureCoordinate182;

let Coordinate183 = browser.currentScene.createNode("Coordinate");
Coordinate183.point = new MFVec3f(new float[-2.525,1.246,-1.68,-3.681,1.236,0.0337,-2.408,1.247,1.663,-0.4657,1.264,0.9556,-0.5379,1.264,-1.11,-2.743,-0.0209,-2.31,-4.339,-0.0351,0.057,-2.581,-0.0195,2.307,0.1009,0.0044,1.33,0.0013,0.0035,-1.523,-2.72,-2.534,-2.31,-4.317,-2.548,0.057,-2.559,-2.533,2.307,0.1233,-2.509,1.33,0.0237,-2.51,-1.523,-2.759,-3.609,-2.442,-4.448,-3.624,0.0619,-2.588,-3.608,2.442,0.2497,-3.583,1.409,0.1443,-3.583,-1.61,-2.245,-1.758,-1.939,-3.465,-1.769,-0.4543,-2.834,-1.763,1.629,-1.223,-1.749,1.432,-0.8596,-1.746,-0.7734,-2.263,-7.566,-1.569,-3.531,-7.577,-0.378,-2.875,-7.571,1.293,-1.202,-7.556,1.135,-0.8242,-7.553,-0.6339,-2.267,-11.62,-1.511,-3.487,-11.63,-0.3651,-2.856,-11.62,1.243,-1.245,-11.61,1.091,-0.8817,-11.6,-0.6115,-2.213,-12.17,-0.8985,-2.928,-12.17,-0.2266,-2.558,-12.17,0.7161,-1.614,-12.16,0.6268,-1.401,-12.16,-0.3711]);
...
HAnimJoint184.center = new SFVec3f(new float[-8.093,40.38,-0.2502]);
...
Transform186.translation = new SFVec3f(new float[-8.093,40.38,-0.2502]);
...
ImageTexture190.USE = "Annex01JinTextureAtlas";
...
TextureCoordinate192.point = new MFVec2f(new float[0.4222,0.6201,0.4327,0.6201,0.3884,0.6201,0.3987,0.6201,0.4103,0.6201,0.4213,0.6265,0.4321,0.6265,0.3894,0.6265,0.399,0.6265,0.4105,0.6265,0.4214,0.6413,0.4323,0.6413,0.389,0.6381,0.3992,0.6381,0.4103,0.6413,0.4213,0.6705,0.4336,0.6705,0.3899,0.6705,0.3981,0.6705,0.4094,0.6705,0.4215,0.674,0.4346,0.674,0.3899,0.674,0.398,0.674,0.4083,0.674,0.3787,0.6201,0.3682,0.6201,0.3787,0.6201,0.3782,0.6265,0.3782,0.6265,0.3783,0.6413,0.3783,0.6413,0.3796,0.6705,0.3676,0.674,0.3806,0.674,0.3796,0.6705,0.3806,0.674]);
IndexedFaceSet191.texCoord = TextureCoordinate192;

let Coordinate193 = browser.currentScene.createNode("Coordinate");
Coordinate193.point = new MFVec3f(new float[-0.215,0.3047,-1.152,-1.155,0.2966,-0.2588,-0.6199,0.3013,1.04,0.6505,0.3122,0.9491,0.9008,0.3143,-0.4054,-0.1442,-0.8448,-1.625,-1.472,-0.8561,-0.4271,-0.7164,-0.8496,1.625,1.079,-0.8342,1.482,1.433,-0.8312,-0.6588,-0.1328,-3.5,-1.607,-1.551,-3.513,-0.4225,-0.781,-2.925,1.61,1.136,-2.909,1.468,1.551,-3.486,-0.6519,-0.0592,-8.713,-1.437,-1.093,-8.722,-0.1279,-0.5047,-8.716,1.51,0.8932,-8.704,1.377,1.169,-8.702,-0.3428,-0.0092,-9.336,-0.8855,-0.7154,-9.342,0.0084,-0.3135,-9.339,1.043,0.6412,-9.331,0.9519,0.8292,-9.329,-0.1383]);
...
HAnimJoint194.DEF = "hanim_r_radiocarpal";
HAnimJoint194.name = "r_radiocarpal";
HAnimJoint194.center = new SFVec3f(new float[-7.808,31.46,-0.05849]);
let HAnimSegment195 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment195.DEF = "hanim_r_hand";
HAnimSegment195.name = "r_hand";
let Transform196 = browser.currentScene.createNode("Transform");
Transform196.translation = new SFVec3f(new float[-7.808,31.46,-0.05849]);
...
ImageTexture200.USE = "Annex01JinTextureAtlas";
...
IndexedFaceSet201.texCoord = TextureCoordinate202;

let Coordinate203 = browser.currentScene.createNode("Coordinate");
Coordinate203.point = new MFVec3f(new float[-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912,0.7183,0.0002,-1.283,0.9295,-0.613,1.478,-1.647,-0.4252,1.388,-1.589,-0.3921,-1.989,1.044,-0.5947,-1.984,0.8227,-2.521,2.408,-1.951,-2.334,2.08,-1.892,-2.301,-2.409,1.192,-2.614,-2.248,0.5703,-3.958,1.694,-0.8836,-4.2,1.75,-0.8251,-4.167,-2.071,0.7842,-3.968,-1.934,1.037,-0.5968,-0.1872,1.642,-2.561,1.941,1.951,-0.9492,0.058,1.914,-1.016,1.885,1.649,-2.56,0.1377,1.066,-2.61,-0.2014,-1.209,0.0872,-1.349,0.7183,0.0002,-1.283,0.7098,-0.0015,0.8912,-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912]);
IndexedFaceSet201.coord = Coordinate203;
...
HAnimJoint174.children[1] = HAnimJoint184;

HAnimJoint124.children[3] = HAnimJoint174;

HAnimJoint34.children[3] = HAnimJoint124;
...
browser.currentScene.children[2] = HAnimHumanoid23;

let Group204 = browser.currentScene.createNode("Group");
Group204.DEF = "KeyframeAnimation";
let TimeSensor205 = browser.currentScene.createNode("TimeSensor");
TimeSensor205.DEF = "KeyframeTimer";
TimeSensor205.cycleInterval = 8.033494;
TimeSensor205.loop = True;
Group204.children = new MFNode();

Group204.children[0] = TimeSensor205;

let PositionInterpolator206 = browser.currentScene.createNode("PositionInterpolator");
PositionInterpolator206.DEF = "Keyframe_HumanoidRoot_1";
PositionInterpolator206.key = new MFFloat(new float[0,1]);
PositionInterpolator206.keyValue = new MFVec3f(new float[0,0,0,0,0,0]);
Group204.children[1] = PositionInterpolator206;

let OrientationInterpolator207 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator207.DEF = "Keyframe_HumanoidRoot";
OrientationInterpolator207.key = new MFFloat(new float[0,1]);
OrientationInterpolator207.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[2] = OrientationInterpolator207;

let OrientationInterpolator208 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator208.DEF = "Keyframe_sacroiliac";
OrientationInterpolator208.key = new MFFloat(new float[0,1]);
OrientationInterpolator208.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[3] = OrientationInterpolator208;

let OrientationInterpolator209 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator209.DEF = "Keyframe_l_shoulder";
OrientationInterpolator209.key = new MFFloat(new float[0,0.5,1]);
OrientationInterpolator209.keyValue = new MFRotation(new float[0,0,0,0,-1,0,0,3,0,0,0,0]);
Group204.children[4] = OrientationInterpolator209;

let OrientationInterpolator210 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator210.DEF = "Keyframe_l_elbow";
OrientationInterpolator210.key = new MFFloat(new float[0,1]);
OrientationInterpolator210.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[5] = OrientationInterpolator210;

let OrientationInterpolator211 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator211.DEF = "Keyframe_l_radiocarpal";
OrientationInterpolator211.key = new MFFloat(new float[0,1]);
OrientationInterpolator211.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[6] = OrientationInterpolator211;

let OrientationInterpolator212 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator212.DEF = "Keyframe_r_shoulder";
OrientationInterpolator212.key = new MFFloat(new float[0,0.5,1]);
OrientationInterpolator212.keyValue = new MFRotation(new float[0,0,0,0,-1,0,0,3,0,0,0,0]);
Group204.children[7] = OrientationInterpolator212;

let OrientationInterpolator213 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator213.DEF = "Keyframe_r_elbow";
OrientationInterpolator213.key = new MFFloat(new float[0,1]);
OrientationInterpolator213.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[8] = OrientationInterpolator213;

let OrientationInterpolator214 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator214.DEF = "Keyframe_r_radiocarpal";
OrientationInterpolator214.key = new MFFloat(new float[0,1]);
OrientationInterpolator214.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[9] = OrientationInterpolator214;

let OrientationInterpolator215 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator215.DEF = "Keyframe_vl5";
OrientationInterpolator215.key = new MFFloat(new float[0,1]);
OrientationInterpolator215.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[10] = OrientationInterpolator215;

let OrientationInterpolator216 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator216.DEF = "Keyframe_skullbase";
OrientationInterpolator216.key = new MFFloat(new float[0,1]);
OrientationInterpolator216.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[11] = OrientationInterpolator216;

let OrientationInterpolator217 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator217.DEF = "Keyframe_l_hip";
OrientationInterpolator217.key = new MFFloat(new float[0,1]);
OrientationInterpolator217.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[12] = OrientationInterpolator217;

let OrientationInterpolator218 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator218.DEF = "Keyframe_l_knee";
OrientationInterpolator218.key = new MFFloat(new float[0,1]);
OrientationInterpolator218.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[13] = OrientationInterpolator218;

let OrientationInterpolator219 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator219.DEF = "Keyframe_l_talocrural";
OrientationInterpolator219.key = new MFFloat(new float[0,1]);
OrientationInterpolator219.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[14] = OrientationInterpolator219;

let OrientationInterpolator220 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator220.DEF = "Keyframe_l_metatarsophalangeal";
OrientationInterpolator220.key = new MFFloat(new float[0,1]);
OrientationInterpolator220.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[15] = OrientationInterpolator220;

let OrientationInterpolator221 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator221.DEF = "Keyframe_r_hip";
OrientationInterpolator221.key = new MFFloat(new float[0,1]);
OrientationInterpolator221.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[16] = OrientationInterpolator221;

let OrientationInterpolator222 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator222.DEF = "Keyframe_r_knee";
OrientationInterpolator222.key = new MFFloat(new float[0,1]);
OrientationInterpolator222.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[17] = OrientationInterpolator222;

let OrientationInterpolator223 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator223.DEF = "Keyframe_r_talocrural";
OrientationInterpolator223.key = new MFFloat(new float[0,1]);
OrientationInterpolator223.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[18] = OrientationInterpolator223;

let OrientationInterpolator224 = browser.currentScene.createNode("OrientationInterpolator");
OrientationInterpolator224.DEF = "Keyframe_r_metatarsophalangeal";
OrientationInterpolator224.key = new MFFloat(new float[0,1]);
OrientationInterpolator224.keyValue = new MFRotation(new float[0,0,0,0,0,0,0,0]);
Group204.children[19] = OrientationInterpolator224;

browser.currentScene.children[3] = Group204;

let ROUTE225 = browser.currentScene.createNode("ROUTE");
ROUTE225.fromNode = "KeyframeTimer";
ROUTE225.fromField = "fraction_changed";
ROUTE225.toNode = "Keyframe_HumanoidRoot";
ROUTE225.toField = "set_fraction";
browser.currentScene.children[4] = ROUTE225;

let ROUTE226 = browser.currentScene.createNode("ROUTE");
ROUTE226.fromNode = "KeyframeTimer";
ROUTE226.fromField = "fraction_changed";
ROUTE226.toNode = "Keyframe_sacroiliac";
ROUTE226.toField = "set_fraction";
browser.currentScene.children[5] = ROUTE226;

let ROUTE227 = browser.currentScene.createNode("ROUTE");
ROUTE227.fromNode = "KeyframeTimer";
ROUTE227.fromField = "fraction_changed";
ROUTE227.toNode = "Keyframe_l_shoulder";
ROUTE227.toField = "set_fraction";
browser.currentScene.children[6] = ROUTE227;

let ROUTE228 = browser.currentScene.createNode("ROUTE");
ROUTE228.fromNode = "KeyframeTimer";
ROUTE228.fromField = "fraction_changed";
ROUTE228.toNode = "Keyframe_l_elbow";
ROUTE228.toField = "set_fraction";
browser.currentScene.children[7] = ROUTE228;

let ROUTE229 = browser.currentScene.createNode("ROUTE");
ROUTE229.fromNode = "KeyframeTimer";
ROUTE229.fromField = "fraction_changed";
ROUTE229.toNode = "Keyframe_l_radiocarpal";
ROUTE229.toField = "set_fraction";
browser.currentScene.children[8] = ROUTE229;

let ROUTE230 = browser.currentScene.createNode("ROUTE");
ROUTE230.fromNode = "KeyframeTimer";
ROUTE230.fromField = "fraction_changed";
ROUTE230.toNode = "Keyframe_r_shoulder";
ROUTE230.toField = "set_fraction";
browser.currentScene.children[9] = ROUTE230;

let ROUTE231 = browser.currentScene.createNode("ROUTE");
ROUTE231.fromNode = "KeyframeTimer";
ROUTE231.fromField = "fraction_changed";
ROUTE231.toNode = "Keyframe_r_elbow";
ROUTE231.toField = "set_fraction";
browser.currentScene.children[10] = ROUTE231;

let ROUTE232 = browser.currentScene.createNode("ROUTE");
ROUTE232.fromNode = "KeyframeTimer";
ROUTE232.fromField = "fraction_changed";
ROUTE232.toNode = "Keyframe_r_radiocarpal";
ROUTE232.toField = "set_fraction";
browser.currentScene.children[11] = ROUTE232;

let ROUTE233 = browser.currentScene.createNode("ROUTE");
ROUTE233.fromNode = "KeyframeTimer";
ROUTE233.fromField = "fraction_changed";
ROUTE233.toNode = "Keyframe_vl5";
ROUTE233.toField = "set_fraction";
browser.currentScene.children[12] = ROUTE233;

let ROUTE234 = browser.currentScene.createNode("ROUTE");
ROUTE234.fromNode = "KeyframeTimer";
ROUTE234.fromField = "fraction_changed";
ROUTE234.toNode = "Keyframe_skullbase";
ROUTE234.toField = "set_fraction";
browser.currentScene.children[13] = ROUTE234;

let ROUTE235 = browser.currentScene.createNode("ROUTE");
ROUTE235.fromNode = "KeyframeTimer";
ROUTE235.fromField = "fraction_changed";
ROUTE235.toNode = "Keyframe_l_hip";
ROUTE235.toField = "set_fraction";
browser.currentScene.children[14] = ROUTE235;

let ROUTE236 = browser.currentScene.createNode("ROUTE");
ROUTE236.fromNode = "KeyframeTimer";
ROUTE236.fromField = "fraction_changed";
ROUTE236.toNode = "Keyframe_l_knee";
ROUTE236.toField = "set_fraction";
browser.currentScene.children[15] = ROUTE236;

let ROUTE237 = browser.currentScene.createNode("ROUTE");
ROUTE237.fromNode = "KeyframeTimer";
ROUTE237.fromField = "fraction_changed";
ROUTE237.toNode = "Keyframe_l_talocrural";
ROUTE237.toField = "set_fraction";
browser.currentScene.children[16] = ROUTE237;

let ROUTE238 = browser.currentScene.createNode("ROUTE");
ROUTE238.fromNode = "KeyframeTimer";
ROUTE238.fromField = "fraction_changed";
ROUTE238.toNode = "Keyframe_l_metatarsophalangeal";
ROUTE238.toField = "set_fraction";
browser.currentScene.children[17] = ROUTE238;

let ROUTE239 = browser.currentScene.createNode("ROUTE");
ROUTE239.fromNode = "KeyframeTimer";
ROUTE239.fromField = "fraction_changed";
ROUTE239.toNode = "Keyframe_r_hip";
ROUTE239.toField = "set_fraction";
browser.currentScene.children[18] = ROUTE239;

let ROUTE240 = browser.currentScene.createNode("ROUTE");
ROUTE240.fromNode = "KeyframeTimer";
ROUTE240.fromField = "fraction_changed";
ROUTE240.toNode = "Keyframe_r_knee";
ROUTE240.toField = "set_fraction";
browser.currentScene.children[19] = ROUTE240;

let ROUTE241 = browser.currentScene.createNode("ROUTE");
ROUTE241.fromNode = "KeyframeTimer";
ROUTE241.fromField = "fraction_changed";
ROUTE241.toNode = "Keyframe_r_talocrural";
ROUTE241.toField = "set_fraction";
browser.currentScene.children[20] = ROUTE241;

let ROUTE242 = browser.currentScene.createNode("ROUTE");
ROUTE242.fromNode = "KeyframeTimer";
ROUTE242.fromField = "fraction_changed";
ROUTE242.toNode = "Keyframe_r_metatarsophalangeal";
ROUTE242.toField = "set_fraction";
browser.currentScene.children[21] = ROUTE242;

let ROUTE243 = browser.currentScene.createNode("ROUTE");
ROUTE243.fromNode = "Keyframe_HumanoidRoot";
ROUTE243.fromField = "value_changed";
ROUTE243.toNode = "hanim_HumanoidRoot";
ROUTE243.toField = "rotation";
browser.currentScene.children[22] = ROUTE243;

let ROUTE244 = browser.currentScene.createNode("ROUTE");
ROUTE244.fromNode = "Keyframe_sacroiliac";
ROUTE244.fromField = "value_changed";
ROUTE244.toNode = "hanim_sacroiliac";
ROUTE244.toField = "rotation";
browser.currentScene.children[23] = ROUTE244;

let ROUTE245 = browser.currentScene.createNode("ROUTE");
ROUTE245.fromNode = "Keyframe_l_shoulder";
ROUTE245.fromField = "value_changed";
ROUTE245.toNode = "hanim_l_shoulder";
ROUTE245.toField = "rotation";
browser.currentScene.children[24] = ROUTE245;

let ROUTE246 = browser.currentScene.createNode("ROUTE");
ROUTE246.fromNode = "Keyframe_l_elbow";
ROUTE246.fromField = "value_changed";
ROUTE246.toNode = "hanim_l_elbow";
ROUTE246.toField = "rotation";
browser.currentScene.children[25] = ROUTE246;

let ROUTE247 = browser.currentScene.createNode("ROUTE");
ROUTE247.fromNode = "Keyframe_l_radiocarpal";
ROUTE247.fromField = "value_changed";
ROUTE247.toNode = "hanim_l_radiocarpal";
ROUTE247.toField = "rotation";
browser.currentScene.children[26] = ROUTE247;

let ROUTE248 = browser.currentScene.createNode("ROUTE");
ROUTE248.fromNode = "Keyframe_r_shoulder";
ROUTE248.fromField = "value_changed";
ROUTE248.toNode = "hanim_r_shoulder";
ROUTE248.toField = "rotation";
browser.currentScene.children[27] = ROUTE248;

let ROUTE249 = browser.currentScene.createNode("ROUTE");
ROUTE249.fromNode = "Keyframe_r_elbow";
ROUTE249.fromField = "value_changed";
ROUTE249.toNode = "hanim_r_elbow";
ROUTE249.toField = "rotation";
browser.currentScene.children[28] = ROUTE249;

let ROUTE250 = browser.currentScene.createNode("ROUTE");
ROUTE250.fromNode = "Keyframe_r_radiocarpal";
ROUTE250.fromField = "value_changed";
ROUTE250.toNode = "hanim_r_radiocarpal";
ROUTE250.toField = "rotation";
browser.currentScene.children[29] = ROUTE250;

let ROUTE251 = browser.currentScene.createNode("ROUTE");
ROUTE251.fromNode = "Keyframe_vl5";
ROUTE251.fromField = "value_changed";
ROUTE251.toNode = "hanim_vl5";
ROUTE251.toField = "rotation";
browser.currentScene.children[30] = ROUTE251;

let ROUTE252 = browser.currentScene.createNode("ROUTE");
ROUTE252.fromNode = "Keyframe_skullbase";
ROUTE252.fromField = "value_changed";
ROUTE252.toNode = "hanim_skullbase";
ROUTE252.toField = "rotation";
browser.currentScene.children[31] = ROUTE252;

let ROUTE253 = browser.currentScene.createNode("ROUTE");
ROUTE253.fromNode = "Keyframe_l_hip";
ROUTE253.fromField = "value_changed";
ROUTE253.toNode = "hanim_l_hip";
ROUTE253.toField = "rotation";
browser.currentScene.children[32] = ROUTE253;

let ROUTE254 = browser.currentScene.createNode("ROUTE");
ROUTE254.fromNode = "Keyframe_l_knee";
ROUTE254.fromField = "value_changed";
ROUTE254.toNode = "hanim_l_knee";
ROUTE254.toField = "rotation";
browser.currentScene.children[33] = ROUTE254;

let ROUTE255 = browser.currentScene.createNode("ROUTE");
ROUTE255.fromNode = "Keyframe_l_talocrural";
ROUTE255.fromField = "value_changed";
ROUTE255.toNode = "hanim_l_talocrural";
ROUTE255.toField = "rotation";
browser.currentScene.children[34] = ROUTE255;

let ROUTE256 = browser.currentScene.createNode("ROUTE");
ROUTE256.fromNode = "Keyframe_l_talocrural";
ROUTE256.fromField = "value_changed";
ROUTE256.toNode = "hanim_l_metatarsophalangeal";
ROUTE256.toField = "rotation";
browser.currentScene.children[35] = ROUTE256;

let ROUTE257 = browser.currentScene.createNode("ROUTE");
ROUTE257.fromNode = "Keyframe_r_hip";
ROUTE257.fromField = "value_changed";
ROUTE257.toNode = "hanim_r_hip";
ROUTE257.toField = "rotation";
browser.currentScene.children[36] = ROUTE257;

let ROUTE258 = browser.currentScene.createNode("ROUTE");
ROUTE258.fromNode = "Keyframe_r_knee";
ROUTE258.fromField = "value_changed";
ROUTE258.toNode = "hanim_r_knee";
ROUTE258.toField = "rotation";
browser.currentScene.children[37] = ROUTE258;
...
ROUTE259.toNode = "hanim_r_talocrural";
ROUTE259.toField = "rotation";
browser.currentScene.children[38] = ROUTE259;

let ROUTE260 = browser.currentScene.createNode("ROUTE");
ROUTE260.fromNode = "Keyframe_l_talocrural";
ROUTE260.fromField = "value_changed";
ROUTE260.toNode = "hanim_r_metatarsophalangeal";
ROUTE260.toField = "rotation";
browser.currentScene.children[39] = ROUTE260;

...
scene.addMetaData("title", "JohnJoint2.x3d");
scene.addMetaData("identifier", "http://www.web3d.org/x3d/content/examples/HumanoidAnimation/JohnJoint2.x3d");
...
Material23.diffuseColor = new X3D.SFColor([0,0,0.8]);
...
ColorRGBA27.color = new X3D.MFColorRGBA([1,1,0,1,1,1,0,0.1]);
color = ColorRGBA27;
...
HAnimHumanoid31.info = new X3D.MFString([new X3D.SFString("humanoidVersion=2.0")]);
...
HAnimJoint32.center = new X3D.SFVec3f([0,0.824,0.0277]);
...
HAnimJoint33.center = new X3D.SFVec3f([0,0.9149,0.0016]);
...
HAnimJoint34.center = new X3D.SFVec3f([0.0961,0.9124,-0.0001]);
...
HAnimJoint35.center = new X3D.SFVec3f([0.104,0.4867,0.0308]);
...
HAnimJoint36.center = new X3D.SFVec3f([0.1101,0.0656,-0.0736]);
...
HAnimJoint37ZZZ.children[1] = HAnimJoint42;
...
HAnimJoint37ZZZ.children[2] = HAnimJoint47;
...
HAnimJoint61.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint53ZZZ.children[1] = HAnimJoint58;

HAnimJoint52YYY.children = new X3D.MFNode();

HAnimJoint52ZZZ.children[0] = HAnimJoint53;

HAnimJoint36ZZZ.children[1] = HAnimJoint52;
...
HAnimJoint62.center = new X3D.SFVec3f([-0.095,0.9171,0.0029]);
...
HAnimJoint63.center = new X3D.SFVec3f([-0.0867,0.4913,0.0318]);
...
HAnimJoint64.center = new X3D.SFVec3f([-0.0801,0.0712,-0.0766]);
...
HAnimJoint65ZZZ.children[1] = HAnimJoint70;
...
HAnimJoint65ZZZ.children[2] = HAnimJoint75;
...
HAnimJoint89.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint81ZZZ.children[1] = HAnimJoint86;

HAnimJoint80YYY.children = new X3D.MFNode();

HAnimJoint80ZZZ.children[0] = HAnimJoint81;

HAnimJoint64ZZZ.children[1] = HAnimJoint80;
...
HAnimJoint33ZZZ.children[1] = HAnimJoint62;
...
HAnimJoint90.center = new X3D.SFVec3f([0.0028,1.0568,-0.0776]);
...
HAnimJoint91.center = new X3D.SFVec3f([0.0035,1.0925,-0.0787]);
...
HAnimJoint92.center = new X3D.SFVec3f([0.0041,1.1276,-0.0796]);
...
HAnimJoint93.center = new X3D.SFVec3f([0.0045,1.1546,-0.08]);
...
HAnimJoint94.center = new X3D.SFVec3f([0.0048,1.1912,-0.0805]);
...
HAnimJoint95.center = new X3D.SFVec3f([0.0051,1.2278,-0.0808]);
...
HAnimJoint96.center = new X3D.SFVec3f([0.0053,1.2679,-0.081]);
...
HAnimJoint97.center = new X3D.SFVec3f([0.0056,1.2848,-0.0822]);
...
HAnimJoint98.center = new X3D.SFVec3f([0.0057,1.3126,-0.0838]);
...
HAnimJoint99.center = new X3D.SFVec3f([0.0057,1.3382,-0.0845]);
...
HAnimJoint100.center = new X3D.SFVec3f([0.0058,1.3625,-0.0833]);
...
HAnimJoint101.center = new X3D.SFVec3f([0.0059,1.3866,-0.08]);
...
HAnimJoint102.center = new X3D.SFVec3f([0.006,1.4102,-0.0745]);
...
HAnimJoint103.center = new X3D.SFVec3f([0.0061,1.432,-0.0675]);
...
HAnimJoint104.center = new X3D.SFVec3f([0.0062,1.4583,-0.057]);
...
HAnimJoint105.center = new X3D.SFVec3f([0.0063,1.4761,-0.0484]);
...
HAnimJoint106.center = new X3D.SFVec3f([0.0065,1.4951,-0.0387]);
...
HAnimJoint107.center = new X3D.SFVec3f([0.0066,1.5132,-0.0301]);
...
HAnimJoint108.center = new X3D.SFVec3f([0.0066,1.5357,-0.0143]);
...
HAnimJoint109.center = new X3D.SFVec3f([0.0066,1.552,-0.0082]);
...
HAnimJoint110.center = new X3D.SFVec3f([0.0066,1.5662,-0.0084]);
...
HAnimJoint111.center = new X3D.SFVec3f([0.0066,1.58,-0.0103]);
...
HAnimJoint112.center = new X3D.SFVec3f([0.0066,1.5928,-0.0103]);
...
HAnimJoint113.center = new X3D.SFVec3f([0.0066,1.6144,-0.0034]);
...
HAnimJoint114.center = new X3D.SFVec3f([0.0044,1.6209,0.0236]);
...
HAnimJoint114ZZZ.children[1] = HAnimJoint116;
...
HAnimJoint114ZZZ.children[2] = HAnimJoint117;
...
HAnimJoint114ZZZ.children[3] = HAnimJoint118;
...
HAnimJoint114ZZZ.children[4] = HAnimJoint119;
...
HAnimJoint114ZZZ.children[5] = HAnimJoint120;
...
HAnimJoint122.center = new X3D.SFVec3f([0.082,1.4488,-0.0353]);
...
HAnimJoint123.center = new X3D.SFVec3f([0.0962,1.4269,-0.0424]);
...
HAnimJoint124.center = new X3D.SFVec3f([0.2029,1.4376,-0.0387]);
...
HAnimJoint125.center = new X3D.SFVec3f([0.2014,1.1357,-0.0682]);
...
HAnimJoint126.center = new X3D.SFVec3f([0.1984,0.8663,-0.0583]);
...
HAnimJoint127.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint128.center = new X3D.SFVec3f([0.1924,0.8472,-0.0534]);
...
HAnimJoint129.center = new X3D.SFVec3f([0.1951,0.8226,0.0246]);
...
HAnimJoint130.center = new X3D.SFVec3f([0.1955,0.8159,0.0464]);
...
HAnimJoint131.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint132.center = new X3D.SFVec3f([0.1983,0.8024,-0.028]);
...
HAnimJoint133.center = new X3D.SFVec3f([0.1983,0.7815,-0.028]);
...
HAnimJoint134.center = new X3D.SFVec3f([0.2017,0.7363,-0.0248]);
...
HAnimJoint135.center = new X3D.SFVec3f([0.2028,0.7139,-0.0236]);
...
HAnimJoint126ZZZ.children[1] = HAnimJoint131;
...
HAnimJoint136.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint137.center = new X3D.SFVec3f([0.1987,0.8029,-0.053]);
...
HAnimJoint138.center = new X3D.SFVec3f([0.1987,0.7818,-0.053]);
...
HAnimJoint139.center = new X3D.SFVec3f([0.2013,0.7273,-0.0503]);
...
HAnimJoint140.center = new X3D.SFVec3f([0.2026,0.7011,-0.0494]);
...
HAnimJoint126ZZZ.children[2] = HAnimJoint136;
...
HAnimJoint141.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint142.center = new X3D.SFVec3f([0.1956,0.8019,-0.0794]);
...
HAnimJoint143.center = new X3D.SFVec3f([0.1956,0.7815,-0.0794]);
...
HAnimJoint144.center = new X3D.SFVec3f([0.1973,0.7287,-0.0777]);
...
HAnimJoint145.center = new X3D.SFVec3f([0.1983,0.7045,-0.0767]);
...
HAnimJoint146.center = new X3D.SFVec3f([0.1925,0.8066,-0.1036]);
...
HAnimJoint147.center = new X3D.SFVec3f([0.1925,0.7866,-0.1036]);
...
HAnimJoint148.center = new X3D.SFVec3f([0.1938,0.7452,-0.1024]);
...
HAnimJoint149.center = new X3D.SFVec3f([0.1948,0.7277,-0.1017]);
...
HAnimJoint141ZZZ.children[1] = HAnimJoint146;

HAnimJoint126ZZZ.children[3] = HAnimJoint141;
...
HAnimJoint106ZZZ.children[1] = HAnimJoint122;
...
HAnimJoint150.center = new X3D.SFVec3f([-0.0694,1.46,-0.033]);
...
HAnimJoint151.center = new X3D.SFVec3f([-0.0836,1.4281,-0.0401]);
...
HAnimJoint152.center = new X3D.SFVec3f([-0.1907,1.4407,-0.0325]);
...
HAnimJoint153.center = new X3D.SFVec3f([-0.1949,1.1388,-0.062]);
...
HAnimJoint154.center = new X3D.SFVec3f([-0.1959,0.8694,-0.0521]);
...
HAnimJoint155.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint156.center = new X3D.SFVec3f([-0.1899,0.8502,-0.0473]);
...
HAnimJoint157.center = new X3D.SFVec3f([-0.1874,0.8256,0.0306]);
...
HAnimJoint158.center = new X3D.SFVec3f([-0.1864,0.819,0.0506]);
...
HAnimJoint159.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint160.center = new X3D.SFVec3f([-0.1961,0.8055,-0.0218]);
...
HAnimJoint161.center = new X3D.SFVec3f([-0.1961,0.7846,-0.0218]);
...
HAnimJoint162.center = new X3D.SFVec3f([-0.1954,0.7393,-0.0185]);
...
HAnimJoint163.center = new X3D.SFVec3f([-0.1945,0.7169,-0.0173]);
...
HAnimJoint154ZZZ.children[1] = HAnimJoint159;
...
HAnimJoint164.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint165.center = new X3D.SFVec3f([-0.1972,0.806,-0.0468]);
...
HAnimJoint166.center = new X3D.SFVec3f([-0.1972,0.7849,-0.0468]);
...
HAnimJoint167.center = new X3D.SFVec3f([-0.195,0.7304,-0.0441]);
...
HAnimJoint168.center = new X3D.SFVec3f([-0.1939,0.7042,-0.0432]);
...
HAnimJoint154ZZZ.children[2] = HAnimJoint164;
...
HAnimJoint169.center = new X3D.SFVec3f([0,1,0]);
...
HAnimJoint170.center = new X3D.SFVec3f([-0.1951,0.8049,-0.0732]);
...
HAnimJoint171.center = new X3D.SFVec3f([-0.1951,0.7845,-0.0732]);
...
HAnimJoint172.center = new X3D.SFVec3f([-0.192,0.7318,-0.0716]);
...
HAnimJoint173.center = new X3D.SFVec3f([-0.1908,0.7077,-0.0706]);
...
HAnimJoint174.center = new X3D.SFVec3f([-0.1926,0.8096,-0.0975]);
...
HAnimJoint175.center = new X3D.SFVec3f([-0.1926,0.7896,-0.0975]);
...
HAnimJoint176.center = new X3D.SFVec3f([-0.1902,0.7483,-0.0963]);
...
HAnimJoint177.center = new X3D.SFVec3f([-0.1908,0.754,-0.096]);
...
HAnimJoint169ZZZ.children[1] = HAnimJoint174;

HAnimJoint154ZZZ.children[3] = HAnimJoint169;
...
HAnimJoint106ZZZ.children[2] = HAnimJoint150;
...
HAnimJoint32ZZZ.children[1] = HAnimJoint90;

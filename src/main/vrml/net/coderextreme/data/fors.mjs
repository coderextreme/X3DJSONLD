...
Script66.getField("counter").setValue("0");
...
"\n"+
"        }`)
browser.currentScene.children[3] = Script65;
...
browser.currentScene.children[4] = ROUTE68;
...
browser.currentScene.children[5] = ROUTE69;
...
browser.currentScene.children[6] = ROUTE70;

...
Viewpoint6.centerOfRotation = new SFVec3f(new float[-0.0002,0.0139,-0.1019]);
Viewpoint6.description = "JinLOA4";
Viewpoint6.position = new SFVec3f(new float[-0.0002,0.0139,-0.0344]);
browser.currentScene.children[2] = Viewpoint6;

let Transform7 = browser.currentScene.createNode("Transform");
Transform7.DEF = "cordsysfloor";
Transform7.scale = new SFVec3f(new float[0.175,0.175,0.175]);
let Inline8 = browser.currentScene.createNode("Inline");
Inline8.url = new MFString(new java.lang.String["JointCoordinateAxes.x3dv"]);
Transform7.children = new MFNode();

Transform7.children[0] = Inline8;

browser.currentScene.children[3] = Transform7;
...
HAnimJoint10.center = new SFVec3f(new float[-0.0002,0.8174,-0.1178]);
HAnimJoint10.ulimit = new MFFloat(new float[0,0,0]);
HAnimJoint10.llimit = new MFFloat(new float[0,0,0]);
let HAnimSegment11 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment11.name = "sacrum";
HAnimSegment11.DEF = "hanim_sacrum";
let Transform12 = browser.currentScene.createNode("Transform");
Transform12.translation = new SFVec3f(new float[-0.0002,0.8174,-0.1178]);
...
Material15.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance14.material = Material15;

let ImageTexture16 = browser.currentScene.createNode("ImageTexture");
ImageTexture16.DEF = "JinLOA4TextureAtlas";
ImageTexture16.url = new MFString(new java.lang.String["Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Jin.png"]);
...
HAnimSegment11.children[0] = Transform12;

HAnimJoint10.children = new MFNode();

HAnimJoint10.children[0] = HAnimSegment11;

let HAnimJoint20 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint20.name = "sacroiliac";
HAnimJoint20.DEF = "hanim_sacroiliac";
HAnimJoint20.center = new SFVec3f(new float[-0.0002,0.6986,-0.1178]);
...
Transform22.translation = new SFVec3f(new float[-0.0002,0.6986,-0.1178]);
...
Material25.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint30.center = new SFVec3f(new float[0.0945,0.8181,-0.1202]);
...
Transform32.translation = new SFVec3f(new float[0.0945,0.8181,-0.1202]);
...
HAnimJoint40.center = new SFVec3f(new float[0.0924,0.4003,-0.1213]);
...
Transform42.translation = new SFVec3f(new float[0.0924,0.4003,-0.1213]);
...
Coordinate48.point = new MFVec3f(new float[0.016,0.0132,-0.1014,0.008,0.0132,-0.0808,-0.01,0.0132,-0.0767,-0.0244,0.0132,-0.0883,-0.0244,0.0132,-0.1107,-0.01,0.0132,-0.1223,0.008,0.0132,-0.1182,0.0524,-0.1124,-0.1014,0.0327,-0.0901,-0.0565,0.0276,-0.0452,-0.0474,0.0475,-0.0516,-0.1014,-0.0184,-0.0901,-0.0441,-0.017,-0.0452,-0.0366,-0.0509,-0.1124,-0.0736,-0.0528,-0.0516,-0.0798,-0.0509,-0.1297,-0.1327,-0.0528,-0.0516,-0.1229,-0.0184,-0.1297,-0.1672,-0.017,-0.0516,-0.1552,0.0327,-0.1297,-0.1549,0.0276,-0.0516,-0.1443,0.025,-0.0086,-0.0592,0.0433,-0.0086,-0.1014,-0.0161,-0.0086,-0.0497,-0.049,-0.0086,-0.0763,-0.049,-0.0086,-0.1227,-0.0161,-0.0086,-0.1483,0.025,-0.0086,-0.1388,0.036,-0.2993,-0.1018,0.0206,-0.299,-0.0667,-0.0141,-0.299,-0.058,-0.0419,-0.2993,-0.0823,-0.0419,-0.2997,-0.1238,-0.0141,-0.2997,-0.1411,0.0206,-0.2997,-0.1324,0.0157,-0.3355,-0.1013,0.0079,-0.3355,-0.0836,-0.0096,-0.3355,-0.0792,-0.0237,-0.3355,-0.0915,-0.0237,-0.3357,-0.1125,-0.0096,-0.3357,-0.1212,0.0079,-0.3357,-0.1168]);
IndexedFaceSet47.coord = Coordinate48;

let TextureCoordinate49 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate49.point = new MFVec2f(new float[0.9309,0.5848,0.919,0.5848,0.8921,0.5848,0.8706,0.5848,0.8706,0.5848,0.8921,0.5848,0.919,0.5848,0.9845,0.5321,0.955,0.5475,0.9491,0.5599,0.9788,0.5571,0.8787,0.5475,0.8825,0.5599,0.8302,0.5321,0.8291,0.5571,0.8302,0.52,0.8291,0.5571,0.8787,0.52,0.8825,0.5571,0.955,0.52,0.9491,0.5571,0.9444,0.5755,0.9717,0.5755,0.8831,0.5755,0.8339,0.5755,0.8339,0.5755,0.8831,0.5755,0.9444,0.5755,0.9632,0.3942,0.9402,0.3943,0.8884,0.3943,0.8469,0.3942,0.8469,0.3941,0.8884,0.3941,0.9402,0.3941,0.9325,0.3742,0.9208,0.3742,0.8947,0.3742,0.8737,0.3742,0.8737,0.3741,0.8947,0.3741,0.9208,0.3741]);
...
HAnimJoint50.center = new SFVec3f(new float[0.0886,0.0869,-0.1123]);
...
Transform52.translation = new SFVec3f(new float[0.0886,0.0869,-0.1123]);
...
HAnimJoint60.center = new SFVec3f(new float[0.0781,0.0283,-0.097]);
...
Transform62.translation = new SFVec3f(new float[0.0781,0.0283,-0.097]);
...
HAnimJoint70.center = new SFVec3f(new float[0.0672,0.0235,-0.0835]);
...
Transform72.translation = new SFVec3f(new float[0.0672,0.0235,-0.0835]);
...
HAnimJoint80.center = new SFVec3f(new float[0.0644,0.0147,-0.0577]);
...
Transform82.translation = new SFVec3f(new float[0.0644,0.0147,-0.0577]);
...
HAnimJoint90.center = new SFVec3f(new float[0.0619,0.0059,-0.0083]);
...
Transform92.translation = new SFVec3f(new float[0.0619,0.0059,-0.0083]);
...
HAnimJoint100.center = new SFVec3f(new float[0.0619,0.0036,0.0134]);
...
Transform102.translation = new SFVec3f(new float[0.0619,0.0036,0.0134]);
...
HAnimJoint110.center = new SFVec3f(new float[0.0812,0.025,-0.0805]);
...
Transform112.translation = new SFVec3f(new float[0.0812,0.025,-0.0805]);
...
HAnimJoint120.center = new SFVec3f(new float[0.08,0.0175,-0.0608]);
...
Transform122.translation = new SFVec3f(new float[0.08,0.0175,-0.0608]);
...
HAnimJoint130.center = new SFVec3f(new float[0.0824,0.0064,-0.004]);
...
Transform132.translation = new SFVec3f(new float[0.0824,0.0064,-0.004]);
...
HAnimJoint140.center = new SFVec3f(new float[0.0841,0.0041,0.0121]);
...
Transform142.translation = new SFVec3f(new float[0.0841,0.0041,0.0121]);
...
HAnimJoint150.center = new SFVec3f(new float[0.0841,0.0013,0.0216]);
...
Transform152.translation = new SFVec3f(new float[0.0841,0.0013,0.0216]);
...
HAnimJoint60.children[2] = HAnimJoint110;
...
HAnimJoint160.center = new SFVec3f(new float[0.0928,0.0248,-0.0821]);
...
Transform162.translation = new SFVec3f(new float[0.0928,0.0248,-0.0821]);
...
HAnimJoint170.center = new SFVec3f(new float[0.0944,0.0175,-0.0625]);
...
Transform172.translation = new SFVec3f(new float[0.0944,0.0175,-0.0625]);
...
HAnimJoint180.center = new SFVec3f(new float[0.0963,0.0065,-0.0065]);
...
Transform182.translation = new SFVec3f(new float[0.0963,0.0065,-0.0065]);
...
HAnimJoint190.center = new SFVec3f(new float[0.0987,0.0034,0.0086]);
...
Transform192.translation = new SFVec3f(new float[0.0987,0.0034,0.0086]);
...
HAnimJoint200.center = new SFVec3f(new float[0.1002,0.0013,0.0178]);
...
Transform202.translation = new SFVec3f(new float[0.1002,0.0013,0.0178]);
...
HAnimJoint60.children[3] = HAnimJoint160;
...
HAnimJoint210.center = new SFVec3f(new float[0.0889,0.0494,-0.1278]);
...
Transform212.translation = new SFVec3f(new float[0.0889,0.0494,-0.1278]);
...
HAnimJoint220.center = new SFVec3f(new float[0.1105,0.0267,-0.0998]);
...
Transform222.translation = new SFVec3f(new float[0.1105,0.0267,-0.0998]);
...
HAnimJoint230.center = new SFVec3f(new float[0.1063,0.016,-0.0634]);
...
Transform232.translation = new SFVec3f(new float[0.1063,0.016,-0.0634]);
...
HAnimJoint240.center = new SFVec3f(new float[0.1097,0.0058,-0.0107]);
...
Transform242.translation = new SFVec3f(new float[0.1097,0.0058,-0.0107]);
...
HAnimJoint250.center = new SFVec3f(new float[0.114,0.0037,0.0044]);
...
Transform252.translation = new SFVec3f(new float[0.114,0.0037,0.0044]);
...
HAnimJoint260.center = new SFVec3f(new float[0.1155,0.0008,0.0118]);
...
Transform262.translation = new SFVec3f(new float[0.1155,0.0008,0.0118]);
...
HAnimJoint220.children[1] = HAnimJoint230;
...
HAnimJoint270.center = new SFVec3f(new float[0.1206,0.0124,-0.0671]);
...
Transform272.translation = new SFVec3f(new float[0.1206,0.0124,-0.0671]);
...
HAnimJoint280.center = new SFVec3f(new float[0.1239,0.0051,-0.0153]);
...
Transform282.translation = new SFVec3f(new float[0.1239,0.0051,-0.0153]);
...
HAnimJoint290.center = new SFVec3f(new float[0.1262,0.0023,-0.0077]);
...
Transform292.translation = new SFVec3f(new float[0.1262,0.0023,-0.0077]);
...
HAnimJoint300.center = new SFVec3f(new float[0.1271,0,0]);
...
Transform302.translation = new SFVec3f(new float[0.1271,0,0]);
...
Transform312.translation = new SFVec3f(new float[-0.0948,0.8181,-0.1202]);
...
HAnimJoint320.center = new SFVec3f(new float[-0.0928,0.4003,-0.1213]);
...
Transform322.translation = new SFVec3f(new float[-0.0928,0.4003,-0.1213]);
...
Coordinate328.point = new MFVec3f(new float[-0.0163,0.0132,-0.1014,-0.0084,0.0132,-0.0808,0.0096,0.0132,-0.0767,0.024,0.0132,-0.0883,0.024,0.0132,-0.1107,0.0096,0.0132,-0.1223,-0.0084,0.0132,-0.1182,-0.0528,-0.1124,-0.1014,-0.033,-0.0901,-0.0565,-0.028,-0.0452,-0.0474,-0.0478,-0.0516,-0.1014,0.0181,-0.0901,-0.0441,0.0166,-0.0452,-0.0366,0.0505,-0.1124,-0.0736,0.0524,-0.0516,-0.0798,0.0505,-0.1297,-0.1327,0.0524,-0.0516,-0.1229,0.0181,-0.1297,-0.1672,0.0166,-0.0516,-0.1552,-0.033,-0.1297,-0.1549,-0.028,-0.0516,-0.1443,-0.0254,-0.0086,-0.0592,-0.0437,-0.0086,-0.1014,0.0157,-0.0086,-0.0497,0.0486,-0.0086,-0.0763,0.0486,-0.0086,-0.1227,0.0157,-0.0086,-0.1483,-0.0254,-0.0086,-0.1388,-0.0363,-0.2993,-0.1018,-0.0209,-0.299,-0.0667,0.0137,-0.299,-0.058,0.0415,-0.2993,-0.0823,0.0415,-0.2997,-0.1238,0.0137,-0.2997,-0.1411,-0.0209,-0.2997,-0.1324,-0.0161,-0.3355,-0.1013,-0.0083,-0.3355,-0.0836,0.0092,-0.3355,-0.0792,0.0233,-0.3355,-0.0915,0.0233,-0.3357,-0.1125,0.0092,-0.3357,-0.1212,-0.0083,-0.3357,-0.1168]);
IndexedFaceSet327.coord = Coordinate328;

let TextureCoordinate329 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate329.point = new MFVec2f(new float[0.9309,0.5848,0.919,0.5848,0.8921,0.5848,0.8706,0.5848,0.8706,0.5848,0.8921,0.5848,0.919,0.5848,0.9845,0.5321,0.955,0.5475,0.9491,0.5599,0.9788,0.5571,0.8787,0.5475,0.8825,0.5599,0.8302,0.5321,0.8291,0.5571,0.8302,0.52,0.8291,0.5571,0.8787,0.52,0.8825,0.5571,0.955,0.52,0.9491,0.5571,0.9444,0.5755,0.9717,0.5755,0.8831,0.5755,0.8339,0.5755,0.8339,0.5755,0.8831,0.5755,0.9444,0.5755,0.9632,0.3942,0.9402,0.3943,0.8884,0.3943,0.8469,0.3942,0.8469,0.3941,0.8884,0.3941,0.9402,0.3941,0.9325,0.3742,0.9208,0.3742,0.8947,0.3742,0.8737,0.3742,0.8737,0.3741,0.8947,0.3741,0.9208,0.3741]);
...
HAnimJoint330.center = new SFVec3f(new float[-0.0886,0.0869,-0.1123]);
...
Transform332.translation = new SFVec3f(new float[-0.0886,0.0869,-0.1123]);
...
HAnimJoint340.center = new SFVec3f(new float[-0.0781,0.0283,-0.097]);
...
Transform342.translation = new SFVec3f(new float[-0.0781,0.0283,-0.097]);
...
HAnimJoint350.center = new SFVec3f(new float[-0.0672,0.0235,-0.0835]);
...
Transform352.translation = new SFVec3f(new float[-0.0672,0.0235,-0.0835]);
...
HAnimJoint360.center = new SFVec3f(new float[-0.0644,0.0147,-0.0577]);
...
Transform362.translation = new SFVec3f(new float[-0.0644,0.0147,-0.0577]);
...
Coordinate368.point = new MFVec3f(new float[0.0125,-0.0299,-0.0707,0.0138,-0.0033,-0.0641,0.0169,-0.0206,-0.0652,0.0108,-0.0165,-0.0978,0.0091,0.0036,-0.0949,0.0116,-0.0281,-0.0529,0.0118,-0.0067,-0.0522,0.0138,-0.0206,-0.0506,0.0063,-0.0246,-0.0962,0.0158,-0.0189,-0.0781,0.0127,-0.0005,-0.076,0.0118,-0.0295,-0.0796,-0.0087,-0.0003,-0.0652,-0.0078,0.0091,-0.0918,-0.0088,-0.0299,-0.0675,-0.007,-0.028,-0.0943,-0.0105,-0.0048,-0.0525,-0.0105,-0.0281,-0.0534,-0.008,0.0044,-0.0779,0.0076,0.0043,-0.1035,0.0039,-0.0246,-0.1028,0.0087,-0.0166,-0.1043,-0.0084,0.0128,-0.101,-0.0085,-0.0279,-0.1007,-0.014,0.0003,-0.0796,-0.0139,0.005,-0.0935,-0.0139,0.0063,-0.0968,-0.0141,-0.0236,-0.0965,-0.0132,-0.0236,-0.0943,-0.0149,-0.0255,-0.0678,-0.016,-0.0242,-0.0578,-0.016,-0.0079,-0.0572,-0.0147,-0.0044,-0.067,0.0078,-0.0256,-0.0479,0.0097,-0.0199,-0.0459,0.008,-0.0094,-0.0473,-0.0105,-0.008,-0.0476,-0.0152,-0.0103,-0.0515,-0.0152,-0.0226,-0.052,-0.0106,-0.0256,-0.0483,0.0002,-0.0153,-0.1094,-0.0027,-0.0201,-0.1082,-0.0112,-0.0223,-0.1076,-0.0131,-0.0207,-0.1058,-0.0129,0.0039,-0.106,-0.0113,0.0065,-0.1083,-0.0007,0.001,-0.1086]);
...
HAnimJoint370.center = new SFVec3f(new float[-0.0619,0.0059,-0.0083]);
...
Transform372.translation = new SFVec3f(new float[-0.0619,0.0059,-0.0083]);
...
HAnimJoint380.center = new SFVec3f(new float[-0.0619,0.0036,0.0134]);
...
Transform382.translation = new SFVec3f(new float[-0.0619,0.0036,0.0134]);
...
HAnimJoint390.center = new SFVec3f(new float[-0.0812,0.025,-0.0805]);
...
Transform392.translation = new SFVec3f(new float[-0.0812,0.025,-0.0805]);
...
HAnimJoint400.center = new SFVec3f(new float[-0.08,0.0175,-0.0608]);
...
Transform402.translation = new SFVec3f(new float[-0.08,0.0175,-0.0608]);
...
HAnimJoint410.center = new SFVec3f(new float[-0.0823,0.0064,-0.004]);
...
Transform412.translation = new SFVec3f(new float[-0.0823,0.0064,-0.004]);
...
HAnimJoint420.center = new SFVec3f(new float[-0.0841,0.0041,0.0121]);
...
Transform422.translation = new SFVec3f(new float[-0.0841,0.0041,0.0121]);
...
HAnimJoint430.center = new SFVec3f(new float[-0.0841,0.0013,0.0216]);
...
Transform432.translation = new SFVec3f(new float[-0.0841,0.0013,0.0216]);
...
HAnimJoint400.children[1] = HAnimJoint410;

HAnimJoint390.children[1] = HAnimJoint400;

HAnimJoint340.children[2] = HAnimJoint390;
...
HAnimJoint440.center = new SFVec3f(new float[-0.0928,0.0248,-0.0821]);
...
Transform442.translation = new SFVec3f(new float[-0.0928,0.0248,-0.0821]);
...
HAnimJoint450.center = new SFVec3f(new float[-0.0944,0.0175,-0.0625]);
...
Transform452.translation = new SFVec3f(new float[-0.0944,0.0175,-0.0625]);
...
HAnimJoint460.center = new SFVec3f(new float[-0.0963,0.0065,-0.0065]);
...
Transform462.translation = new SFVec3f(new float[-0.0963,0.0065,-0.0065]);
...
HAnimJoint470.center = new SFVec3f(new float[-0.0987,0.0034,0.0086]);
...
Transform472.translation = new SFVec3f(new float[-0.0987,0.0034,0.0086]);
...
HAnimJoint480.center = new SFVec3f(new float[-0.1002,0.0013,0.0178]);
...
Transform482.translation = new SFVec3f(new float[-0.1002,0.0013,0.0178]);
...
HAnimJoint450.children[1] = HAnimJoint460;

HAnimJoint440.children[1] = HAnimJoint450;

HAnimJoint340.children[3] = HAnimJoint440;
...
HAnimJoint490.center = new SFVec3f(new float[-0.0889,0.0494,-0.1278]);
...
Transform492.translation = new SFVec3f(new float[-0.0889,0.0494,-0.1278]);
...
HAnimJoint500.center = new SFVec3f(new float[-0.1105,0.0267,-0.0998]);
...
Transform502.translation = new SFVec3f(new float[-0.1105,0.0267,-0.0998]);
...
HAnimJoint510.center = new SFVec3f(new float[-0.1063,0.016,-0.0634]);
...
Transform512.translation = new SFVec3f(new float[-0.1063,0.016,-0.0634]);
...
HAnimJoint520.center = new SFVec3f(new float[-0.1097,0.0058,-0.0107]);
...
Transform522.translation = new SFVec3f(new float[-0.1097,0.0058,-0.0107]);
...
HAnimJoint530.center = new SFVec3f(new float[-0.114,0.0037,0.0044]);
...
Transform532.translation = new SFVec3f(new float[-0.114,0.0037,0.0044]);
...
HAnimJoint540.center = new SFVec3f(new float[-0.1155,0.0008,0.0118]);
...
Transform542.translation = new SFVec3f(new float[-0.1155,0.0008,0.0118]);
...
HAnimJoint500.children[1] = HAnimJoint510;
...
HAnimJoint550.center = new SFVec3f(new float[-0.1206,0.0124,-0.0671]);
...
Transform552.translation = new SFVec3f(new float[-0.1206,0.0124,-0.0671]);
...
HAnimJoint560.center = new SFVec3f(new float[-0.1239,0.0051,-0.0153]);
...
Transform562.translation = new SFVec3f(new float[-0.1239,0.0051,-0.0153]);
...
Coordinate568.point = new MFVec3f(new float[-0.0063,-0.0025,-0.1035,-0.0052,-0.0194,-0.098,-0.0052,-0.0177,-0.1041,-0.0078,-0.0111,-0.1037,0.0039,-0.0171,-0.0955,0.0071,0.0002,-0.1001,0.0071,-0.0164,-0.1,0.0061,-0.0006,-0.0949,0.0061,-0.0172,-0.0948,0.0058,-0.0098,-0.0938,-0.0051,-0.0183,-0.1085,-0.0087,-0.0111,-0.1095,-0.0066,0.0001,-0.1085,0.0074,-0.0176,-0.1042,0.0081,0.0026,-0.1032,0.004,-0.0004,-0.0954,-0.0059,-0.0021,-0.0981,-0.0072,-0.0106,-0.0974,0.0047,-0.0096,-0.0939,-0.0059,-0.0198,-0.0952,-0.0078,-0.0115,-0.095,-0.0066,-0.0036,-0.0952,0.0037,-0.0022,-0.0929,0.0043,-0.0108,-0.0918,0.0031,-0.018,-0.093,-0.0018,-0.0152,-0.113,-0.0042,-0.0105,-0.1136,-0.0027,-0.0022,-0.1129,0.0067,-0.0006,-0.1097,0.0062,-0.0147,-0.1104,0.011,-0.0141,-0.1008,0.0109,-0.0148,-0.1033,0.0115,-0.0012,-0.1026,0.0111,-0.0022,-0.1012,0.0104,-0.0028,-0.0971,0.01,-0.0096,-0.0962,0.0102,-0.0147,-0.0969]);
IndexedFaceSet567.coord = Coordinate568;

let TextureCoordinate569 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate569.point = new MFVec2f(new float[0.2192,0.0256,0.2205,0.0195,0.2048,0.0404,0.2199,0.022,0.2063,0.0414,0.2047,0.0523,0.1956,0.0462,0.1979,0.0386,0.2109,0.0476,0.277,0.1031,0.2673,0.0987,0.263,0.1,0.2744,0.109,0.1892,0.0439,0.1911,0.0375,0.2576,0.0911,0.2083,0.0537,0.263,0.0893,0.2612,0.0869,0.2047,0.0593,0.2048,0.0593,0.2671,0.0842,0.2673,0.0839,0.2245,0.0286,0.226,0.0221,0.2232,0.0245,0.2102,0.0461,0.2083,0.0443,0.2039,0.0358,0.2152,0.0224,0.2154,0.0203,0.2126,0.0258,0.2034,0.0366,0.2033,0.0375,0.2114,0.0219,0.2132,0.0168,0.2123,0.0196,0.1999,0.0356,0.201,0.0349,0.2011,0.0354,0.2245,0.0286,0.226,0.0221,0.2232,0.0245,0.2083,0.0443,0.2102,0.0461,0.2576,0.0911,0.2102,0.0461,0.2083,0.0443,0.2048,0.0404,0.2083,0.0537,0.2047,0.0593,0.2612,0.0869]);
...
HAnimJoint570.center = new SFVec3f(new float[-0.1262,0.0023,-0.0077]);
...
Transform572.translation = new SFVec3f(new float[-0.1262,0.0023,-0.0077]);
...
HAnimJoint580.center = new SFVec3f(new float[-0.1271,0,0]);
...
Transform582.translation = new SFVec3f(new float[-0.1271,0,0]);
...
HAnimJoint560.children[1] = HAnimJoint570;

HAnimJoint550.children[1] = HAnimJoint560;

HAnimJoint500.children[2] = HAnimJoint550;

HAnimJoint490.children[1] = HAnimJoint500;

HAnimJoint330.children[2] = HAnimJoint490;

HAnimJoint320.children[1] = HAnimJoint330;

HAnimJoint310.children[1] = HAnimJoint320;

HAnimJoint20.children[2] = HAnimJoint310;

let HAnimJoint590 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint590.name = "vl5";
HAnimJoint590.DEF = "hanim_vl5";
HAnimJoint590.center = new SFVec3f(new float[-0.0002,0.9169,-0.1156]);
...
Transform592.translation = new SFVec3f(new float[-0.0002,0.9169,-0.1156]);
...
Coordinate598.point = new MFVec3f(new float[0.0938,0.0165,-0.0184,0.1294,0.0173,-0.0624,0.034,0.013,-0.19,0.0887,0.0132,-0.1643,0.1193,0.0156,-0.1239,0.0851,-0.0077,-0.0351,0.1161,-0.007,-0.0694,0.0357,-0.0104,-0.1675,0.0808,-0.0099,-0.1488,0.1087,-0.0088,-0.1173,0.0366,0.0158,-0.0046,0.0357,-0.0085,-0.0253,-0.0002,-0.0085,-0.0253,-0.0002,0.0158,-0.0046,-0.0361,-0.0085,-0.0253,-0.0854,-0.0077,-0.0351,-0.0942,0.0165,-0.0184,-0.037,0.0158,-0.0046,-0.1164,-0.007,-0.0694,-0.1298,0.0173,-0.0624,-0.0812,-0.0099,-0.1488,-0.036,-0.0104,-0.1675,-0.0344,0.013,-0.19,-0.0891,0.0132,-0.1643,-0.1091,-0.0088,-0.1173,-0.1196,0.0156,-0.1239,-0.0002,-0.0104,-0.1675,-0.0002,0.013,-0.19,0.036,0.0246,-0.0097,0.091,0.0246,-0.0229,0.1241,0.0246,-0.0638,0.1145,0.0246,-0.1219,0.0855,0.0246,-0.1588,0.0329,0.0246,-0.1835,-0.0002,0.0246,-0.1835,-0.0333,0.0246,-0.1835,-0.0858,0.0246,-0.1588,-0.1149,0.0246,-0.1219,-0.1245,0.0246,-0.0638,-0.0914,0.0246,-0.0229,-0.0364,0.0246,-0.0097,-0.0002,0.0246,-0.0097]);
IndexedFaceSet597.coord = Coordinate598;

let TextureCoordinate599 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate599.point = new MFVec2f(new float[0.019,0.2349,0.1011,0.241,0.1445,0.2419,0.2369,0.2375,0.3561,0.2404,0.1927,0.24,0.0206,0.2122,0.1067,0.2154,0.1463,0.2162,0.227,0.2131,0.3536,0.2151,0.1879,0.2143,0.3553,0.2398,0.3555,0.2151,0.3557,0.2401,0.3545,0.2151,0.3536,0.2151,0.019,0.2349,0.0206,0.2122,0.0206,0.2122,0.1067,0.2154,0.1011,0.241,0.019,0.2349,0.1463,0.2162,0.1445,0.2419,0.227,0.2131,0.3536,0.2151,0.3561,0.2404,0.2369,0.2375,0.1879,0.2143,0.1927,0.24,0.3553,0.2398,0.3555,0.2151,0.3545,0.2151,0.3557,0.2401,0.0206,0.2122,0.019,0.2349,0.3536,0.2151,0.019,0.2349,0.1011,0.241,0.1445,0.2419,0.1927,0.24,0.2369,0.2375,0.3561,0.2404,0.3557,0.2401,0.3553,0.2398,0.2369,0.2375,0.1927,0.24,0.1445,0.2419,0.1011,0.241,0.019,0.2349,0.019,0.2349]);
...
HAnimJoint600.center = new SFVec3f(new float[-0.0002,0.9412,-0.1156]);
...
Transform602.translation = new SFVec3f(new float[-0.0002,0.9412,-0.1156]);
...
HAnimJoint610.center = new SFVec3f(new float[-0.0002,0.9574,-0.1156]);
...
Transform612.translation = new SFVec3f(new float[-0.0002,0.9574,-0.1156]);
...
HAnimJoint620.center = new SFVec3f(new float[-0.0002,0.9738,-0.1156]);
...
Transform622.translation = new SFVec3f(new float[-0.0002,0.9738,-0.1156]);
...
HAnimJoint630.center = new SFVec3f(new float[-0.0002,0.9911,-0.1156]);
...
Transform632.translation = new SFVec3f(new float[-0.0002,0.9911,-0.1156]);
...
HAnimJoint640.center = new SFVec3f(new float[-0.0002,1.0145,-0.1156]);
...
Transform642.translation = new SFVec3f(new float[-0.0002,1.0145,-0.1156]);
...
HAnimJoint650.center = new SFVec3f(new float[-0.0002,1.0381,-0.1156]);
...
Transform652.translation = new SFVec3f(new float[-0.0002,1.0381,-0.1156]);
...
HAnimJoint660.center = new SFVec3f(new float[-0.0002,1.0552,-0.1157]);
...
Transform662.translation = new SFVec3f(new float[-0.0002,1.0552,-0.1157]);
...
HAnimJoint670.center = new SFVec3f(new float[-0.0002,1.0699,-0.1156]);
...
Transform672.translation = new SFVec3f(new float[-0.0002,1.0699,-0.1156]);
...
HAnimJoint680.center = new SFVec3f(new float[-0.0002,1.0845,-0.1156]);
...
Transform682.translation = new SFVec3f(new float[-0.0002,1.0845,-0.1156]);
...
HAnimJoint690.center = new SFVec3f(new float[-0.0002,1.1002,-0.1156]);
...
Transform692.translation = new SFVec3f(new float[-0.0002,1.1002,-0.1156]);
...
HAnimJoint700.center = new SFVec3f(new float[-0.0002,1.1131,-0.1156]);
...
Transform702.translation = new SFVec3f(new float[-0.0002,1.1131,-0.1156]);
...
HAnimJoint710.center = new SFVec3f(new float[-0.0002,1.1286,-0.1156]);
...
Transform712.translation = new SFVec3f(new float[-0.0002,1.1286,-0.1156]);
...
HAnimJoint720.center = new SFVec3f(new float[-0.0002,1.1439,-0.1156]);
...
Transform722.translation = new SFVec3f(new float[-0.0002,1.1439,-0.1156]);
...
HAnimJoint730.center = new SFVec3f(new float[-0.0002,1.1623,-0.1156]);
...
Transform732.translation = new SFVec3f(new float[-0.0002,1.1623,-0.1156]);
...
HAnimJoint740.center = new SFVec3f(new float[-0.0002,1.1871,-0.1157]);
...
Transform742.translation = new SFVec3f(new float[-0.0002,1.1871,-0.1157]);
...
HAnimJoint750.center = new SFVec3f(new float[-0.0002,1.2109,-0.1156]);
...
Transform752.translation = new SFVec3f(new float[-0.0002,1.2109,-0.1156]);
...
HAnimJoint760.center = new SFVec3f(new float[-0.0002,1.2368,-0.1169]);
...
Transform762.translation = new SFVec3f(new float[-0.0002,1.2368,-0.1169]);
...
HAnimJoint770.center = new SFVec3f(new float[-0.0002,1.249,-0.1169]);
...
Transform772.translation = new SFVec3f(new float[-0.0002,1.249,-0.1169]);
...
HAnimJoint780.center = new SFVec3f(new float[-0.0002,1.2613,-0.1169]);
...
Transform782.translation = new SFVec3f(new float[-0.0002,1.2613,-0.1169]);
...
Coordinate788.point = new MFVec3f(new float[0.0119,0.0037,-0.1272,0.0254,0.0037,-0.121,0.035,0.0037,-0.1002,0.0272,0.0037,-0.0858,-0.0002,0.0037,-0.075,-0.0138,0.0037,-0.0771,-0.0258,0.0037,-0.121,-0.0353,0.0037,-0.1002,-0.0002,0.0037,-0.1288,0.0134,0.0037,-0.0771,-0.0123,0.0037,-0.1272,-0.0276,0.0037,-0.0858,0.0119,-0.0085,-0.1272,0.0254,-0.0085,-0.121,0.035,-0.0085,-0.1002,0.0272,-0.0085,-0.0858,-0.0002,-0.0085,-0.075,-0.0138,-0.0085,-0.0771,-0.0258,-0.0085,-0.121,-0.0353,-0.0085,-0.1002,-0.0002,-0.0085,-0.1288,0.0134,-0.0085,-0.0771,-0.0123,-0.0085,-0.1272,-0.0276,-0.0085,-0.0858,0.011,0.0082,-0.1229,-0.0002,0.0082,-0.1244,-0.0113,0.0082,-0.1229,-0.0229,0.0082,-0.1177,-0.0308,0.0082,-0.1003,-0.0247,0.0082,-0.089,-0.0125,0.0082,-0.0813,-0.0002,0.0082,-0.0794,0.0121,0.0082,-0.0813,0.0244,0.0082,-0.089,0.0304,0.0082,-0.1003,0.0225,0.0082,-0.1177,-0.0002,-0.0137,-0.1244,0.011,-0.0137,-0.1229,0.0225,-0.0137,-0.1177,0.0304,-0.0137,-0.1003,0.0244,-0.0137,-0.089,0.0121,-0.0137,-0.0813,-0.0002,-0.0137,-0.0794,-0.0125,-0.0137,-0.0813,-0.0247,-0.0137,-0.089,-0.0308,-0.0137,-0.1003,-0.0229,-0.0137,-0.1177,-0.0113,-0.0137,-0.1229]);
IndexedFaceSet787.coord = Coordinate788;

let TextureCoordinate789 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate789.point = new MFVec2f(new float[0.3995,0.6596,0.4094,0.6606,0.4164,0.6605,0.4107,0.6591,0.3906,0.6538,0.3807,0.6592,0.3719,0.6606,0.3649,0.6605,0.3906,0.6599,0.4006,0.6592,0.3818,0.6596,0.3706,0.6591,0.3995,0.6565,0.4094,0.6578,0.4164,0.6576,0.4107,0.6559,0.3906,0.6507,0.3807,0.6555,0.3719,0.6578,0.3649,0.6576,0.3906,0.6568,0.4006,0.6555,0.3818,0.6565,0.3706,0.6559,0.3995,0.6596,0.3906,0.6599,0.3818,0.6596,0.3719,0.6606,0.3649,0.6605,0.3706,0.6591,0.3807,0.6592,0.3906,0.6538,0.4006,0.6592,0.4107,0.6591,0.4164,0.6605,0.4094,0.6606,0.3906,0.6568,0.3995,0.6565,0.4094,0.6578,0.4164,0.6576,0.4107,0.6559,0.4006,0.6555,0.3906,0.6507,0.3807,0.6555,0.3706,0.6559,0.3649,0.6576,0.3719,0.6578,0.3818,0.6565]);
...
HAnimJoint790.center = new SFVec3f(new float[-0.0002,1.2737,-0.1169]);
...
Transform792.translation = new SFVec3f(new float[-0.0002,1.2737,-0.1169]);
...
Coordinate798.point = new MFVec3f(new float[0.0119,0.0044,-0.1272,0.0254,0.0044,-0.121,0.035,0.0044,-0.1002,0.0272,0.0044,-0.0858,-0.0002,0.0044,-0.075,-0.0138,0.0044,-0.0771,-0.0258,0.0044,-0.121,-0.0353,0.0044,-0.1002,-0.0002,0.0044,-0.1288,0.0134,0.0044,-0.0771,-0.0123,0.0044,-0.1272,-0.0276,0.0044,-0.0858,0.0119,-0.0085,-0.1272,0.0254,-0.0085,-0.121,0.035,-0.0085,-0.1002,0.0272,-0.0085,-0.0858,-0.0002,-0.0085,-0.075,-0.0138,-0.0085,-0.0771,-0.0258,-0.0085,-0.121,-0.0353,-0.0085,-0.1002,-0.0002,-0.0085,-0.1288,0.0134,-0.0085,-0.0771,-0.0123,-0.0085,-0.1272,-0.0276,-0.0085,-0.0858,0.011,0.0089,-0.1229,-0.0002,0.0089,-0.1244,-0.0113,0.0089,-0.1229,-0.0229,0.0089,-0.1177,-0.0308,0.0089,-0.1003,-0.0247,0.0089,-0.089,-0.0125,0.0089,-0.0813,-0.0002,0.0089,-0.0794,0.0121,0.0089,-0.0813,0.0244,0.0089,-0.089,0.0304,0.0089,-0.1003,0.0225,0.0089,-0.1177,-0.0002,-0.0139,-0.1244,0.011,-0.0139,-0.1229,0.0225,-0.0139,-0.1177,0.0304,-0.0139,-0.1003,0.0244,-0.0139,-0.089,0.0121,-0.0139,-0.0813,-0.0002,-0.0139,-0.0794,-0.0125,-0.0139,-0.0813,-0.0247,-0.0139,-0.089,-0.0308,-0.0139,-0.1003,-0.0229,-0.0139,-0.1177,-0.0113,-0.0139,-0.1229]);
IndexedFaceSet797.coord = Coordinate798;

let TextureCoordinate799 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate799.point = new MFVec2f(new float[0.3995,0.6628,0.4094,0.6635,0.4164,0.6634,0.4107,0.6624,0.3906,0.657,0.3807,0.6628,0.3719,0.6635,0.3649,0.6634,0.3906,0.6629,0.4006,0.6628,0.3818,0.6628,0.3706,0.6624,0.3995,0.6596,0.4094,0.6606,0.4164,0.6605,0.4107,0.6591,0.3906,0.6538,0.3807,0.6592,0.3719,0.6606,0.3649,0.6605,0.3906,0.6599,0.4006,0.6592,0.3818,0.6596,0.3706,0.6591,0.3995,0.6628,0.3906,0.6629,0.3818,0.6628,0.3719,0.6635,0.3649,0.6634,0.3706,0.6624,0.3807,0.6628,0.3906,0.657,0.4006,0.6628,0.4107,0.6624,0.4164,0.6634,0.4094,0.6635,0.3906,0.6599,0.3995,0.6596,0.4094,0.6606,0.4164,0.6605,0.4107,0.6591,0.4006,0.6592,0.3906,0.6538,0.3807,0.6592,0.3706,0.6591,0.3649,0.6605,0.3719,0.6606,0.3818,0.6596]);
...
HAnimJoint800.center = new SFVec3f(new float[-0.0002,1.2865,-0.1169]);
...
Transform802.translation = new SFVec3f(new float[-0.0002,1.2865,-0.1169]);
...
HAnimJoint810.center = new SFVec3f(new float[-0.0002,1.2982,-0.1169]);
...
Transform812.translation = new SFVec3f(new float[-0.0002,1.2982,-0.1169]);
...
Coordinate818.point = new MFVec3f(new float[0.0119,0.0032,-0.1272,-0.0002,0.0032,-0.1288,0.0254,0.0032,-0.121,0.035,0.0032,-0.1002,0.0272,0.0032,-0.0858,0.0134,0.0032,-0.0771,-0.0002,0.0032,-0.075,-0.0123,0.0032,-0.1272,-0.0258,0.0032,-0.121,-0.0353,0.0032,-0.1002,-0.0276,0.0032,-0.0858,-0.0138,0.0032,-0.0771,0.0106,0.0085,-0.1227,-0.0002,0.0085,-0.1241,-0.011,0.0085,-0.1227,-0.0223,0.0085,-0.1175,-0.0302,0.0085,-0.1004,-0.0241,0.0085,-0.089,-0.0121,0.0085,-0.0815,-0.0002,0.0085,-0.0797,0.0118,0.0085,-0.0815,0.0238,0.0085,-0.089,0.0298,0.0085,-0.1004,0.022,0.0085,-0.1175,0.0119,-0.0085,-0.1272,0.0254,-0.0085,-0.121,0.035,-0.0085,-0.1002,0.0272,-0.0085,-0.0858,-0.0002,-0.0085,-0.075,-0.0138,-0.0085,-0.0771,-0.0258,-0.0085,-0.121,-0.0353,-0.0085,-0.1002,-0.0002,-0.0085,-0.1288,0.0134,-0.0085,-0.0771,-0.0123,-0.0085,-0.1272,-0.0276,-0.0085,-0.0858,-0.0002,-0.0134,-0.1244,0.011,-0.0134,-0.1229,0.0225,-0.0134,-0.1177,0.0304,-0.0134,-0.1003,0.0244,-0.0134,-0.089,0.0121,-0.0134,-0.0813,-0.0002,-0.0134,-0.0794,-0.0125,-0.0134,-0.0813,-0.0247,-0.0134,-0.089,-0.0308,-0.0134,-0.1003,-0.0229,-0.0134,-0.1177,-0.0113,-0.0134,-0.1229]);
IndexedFaceSet817.coord = Coordinate818;

let TextureCoordinate819 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate819.point = new MFVec2f(new float[0.3995,0.6721,0.3906,0.6721,0.4094,0.6721,0.4164,0.6721,0.4107,0.6721,0.4006,0.6738,0.3906,0.6664,0.3818,0.6721,0.3719,0.6721,0.3649,0.6721,0.3706,0.6721,0.3807,0.6738,0.3995,0.6721,0.3906,0.6721,0.3818,0.6721,0.3719,0.6721,0.3649,0.6721,0.3706,0.6721,0.3807,0.6738,0.3906,0.6664,0.4006,0.6738,0.4107,0.6721,0.4164,0.6721,0.4094,0.6721,0.3995,0.669,0.4094,0.6692,0.4164,0.6692,0.4107,0.6689,0.3906,0.6632,0.3807,0.6702,0.3719,0.6692,0.3649,0.6692,0.3906,0.669,0.4006,0.6702,0.3818,0.669,0.3706,0.6689,0.3906,0.669,0.3995,0.669,0.4094,0.6692,0.4164,0.6692,0.4107,0.6689,0.4006,0.6702,0.3906,0.6632,0.3807,0.6702,0.3706,0.6689,0.3649,0.6692,0.3719,0.6692,0.3818,0.669]);
...
HAnimJoint820.center = new SFVec3f(new float[-0.0002,1.3099,-0.1169]);
...
Transform822.translation = new SFVec3f(new float[-0.0002,1.3099,-0.1169]);
...
HAnimJoint830.center = new SFVec3f(new float[-0.0002,1.3041,-0.1173]);
...
Transform832.translation = new SFVec3f(new float[-0.0002,1.3041,-0.1173]);
...
HAnimJoint840.center = new SFVec3f(new float[0.0503,1.4157,-0.0689]);
...
Transform842.translation = new SFVec3f(new float[0.0503,1.4157,-0.0689]);
...
HAnimJoint850.center = new SFVec3f(new float[-0.0507,1.4157,-0.0689]);
...
Transform852.translation = new SFVec3f(new float[-0.0507,1.4157,-0.0689]);
...
HAnimJoint830.children[2] = HAnimJoint850;
...
HAnimJoint860.center = new SFVec3f(new float[0.0479,1.3963,-0.0188]);
...
Transform862.translation = new SFVec3f(new float[0.0479,1.3963,-0.0188]);
...
HAnimJoint830.children[3] = HAnimJoint860;
...
HAnimJoint870.center = new SFVec3f(new float[-0.0483,1.3963,-0.0188]);
...
Transform872.translation = new SFVec3f(new float[-0.0483,1.3963,-0.0188]);
...
HAnimJoint830.children[4] = HAnimJoint870;
...
HAnimJoint880.center = new SFVec3f(new float[0.0216,1.4053,0.0051]);
...
Transform882.translation = new SFVec3f(new float[0.0216,1.4053,0.0051]);
...
HAnimJoint830.children[5] = HAnimJoint880;
...
HAnimJoint890.center = new SFVec3f(new float[-0.0219,1.4053,0.0051]);
...
Transform892.translation = new SFVec3f(new float[-0.0219,1.4053,0.0051]);
...
HAnimJoint830.children[6] = HAnimJoint890;
...
HAnimJoint900.center = new SFVec3f(new float[-0.0002,1.3043,-0.0865]);
...
Transform902.translation = new SFVec3f(new float[-0.0002,1.3043,-0.0865]);
...
HAnimJoint830.children[7] = HAnimJoint900;
...
HAnimJoint910.center = new SFVec3f(new float[0.0383,1.2001,-0.1157]);
...
Transform912.translation = new SFVec3f(new float[0.0383,1.2001,-0.1157]);
...
IndexedFaceSet917.coordIndex = new MFInt32(new int[9,6,1,-1,1,0,9,-1,6,5,2,-1,2,1,6,-1,8,3,2,-1,2,5,8,-1,8,7,4,-1,4,3,8,-1,9,0,4,-1,4,7,9,-1,2,3,4,-1,2,4,0,-1,1,2,0,-1,13,14,10,-1,12,13,10,-1,11,12,10,-1,6,9,11,-1,11,10,6,-1,9,7,12,-1,12,11,9,-1,7,8,13,-1,13,12,7,-1,8,5,14,-1,14,13,8,-1,5,6,10,-1,10,14,5,-1]);
IndexedFaceSet917.creaseAngle = 3.14159;
IndexedFaceSet917.texCoordIndex = new MFInt32(new int[9,6,1,-1,1,0,9,-1,6,5,2,-1,2,1,6,-1,8,3,2,-1,2,5,8,-1,8,7,4,-1,4,3,8,-1,9,0,4,-1,4,7,9,-1,2,3,4,-1,2,4,0,-1,1,2,0,-1,13,14,10,-1,12,13,10,-1,11,12,10,-1,6,9,11,-1,11,10,6,-1,9,7,12,-1,12,11,9,-1,7,8,13,-1,13,12,7,-1,8,5,14,-1,14,13,8,-1,5,6,10,-1,10,14,5,-1]);
let Coordinate918 = browser.currentScene.createNode("Coordinate");
Coordinate918.point = new MFVec3f(new float[0.1121,-0.0062,-0.1213,0.114,0.0027,-0.1008,0.1057,-0.0047,-0.0749,0.104,-0.0495,-0.077,0.103,-0.0456,-0.1047,0.0758,0.0002,-0.062,0.0874,0.0137,-0.1031,0.0942,-0.0646,-0.1147,0.0985,-0.0646,-0.0697,0.0844,-0.0013,-0.1399,-0.003,0.0056,-0.1061,-0.003,-0.0018,-0.1231,-0.003,-0.0405,-0.1077,-0.003,-0.0399,-0.0878,-0.003,-0.0027,-0.0835]);
IndexedFaceSet917.coord = Coordinate918;

let TextureCoordinate919 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate919.point = new MFVec2f(new float[0.1911,0.4797,0.171,0.4832,0.1497,0.4806,0.1519,0.4334,0.1831,0.4416,0.1474,0.4856,0.1708,0.4854,0.1784,0.4249,0.1538,0.4251,0.1963,0.4863,0.19,0.5091,0.1847,0.499,0.172,0.4382,0.1568,0.4457,0.1409,0.4926]);
...
HAnimJoint920.center = new SFVec3f(new float[0.1228,1.1833,-0.1148]);
...
Transform922.translation = new SFVec3f(new float[0.1228,1.1833,-0.1148]);
...
HAnimJoint930.center = new SFVec3f(new float[0.1649,1.17,-0.1051]);
...
Transform932.translation = new SFVec3f(new float[0.1649,1.17,-0.1051]);
...
HAnimJoint940.center = new SFVec3f(new float[0.1819,0.9202,-0.1075]);
...
Transform942.translation = new SFVec3f(new float[0.1819,0.9202,-0.1075]);
...
Coordinate948.point = new MFVec3f(new float[0.0047,-0.0017,-0.1278,0.0258,-0.0019,-0.1077,0.0138,-0.0018,-0.0785,-0.0148,-0.0015,-0.0805,-0.0204,-0.0015,-0.111,0.0031,-0.0276,-0.1384,0.0329,-0.0278,-0.1115,0.0159,-0.0277,-0.0653,-0.0245,-0.0273,-0.0685,-0.0324,-0.0273,-0.1167,0.0028,-0.0873,-0.138,0.0347,-0.0876,-0.1114,0.0174,-0.0744,-0.0657,-0.0257,-0.074,-0.0688,-0.0351,-0.087,-0.1165,0.0012,-0.2046,-0.1342,0.0244,-0.2048,-0.1048,0.0112,-0.2047,-0.0679,-0.0203,-0.2044,-0.0709,-0.0265,-0.2044,-0.1096,0,-0.2186,-0.1218,0.0159,-0.2188,-0.1017,0.0069,-0.2187,-0.0784,-0.0146,-0.2185,-0.0805,-0.0188,-0.2185,-0.105]);
IndexedFaceSet947.coord = Coordinate948;

let TextureCoordinate949 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate949.point = new MFVec2f(new float[0.8857,0.572,0.9344,0.572,0.9377,0.5719,0.8909,0.5718,0.8588,0.5719,0.8849,0.5578,0.8418,0.558,0.9588,0.5579,0.9536,0.5581,0.8765,0.5581,0.885,0.5257,0.8424,0.5258,0.9582,0.5328,0.9531,0.533,0.8768,0.526,0.8957,0.4625,0.8485,0.4627,0.9546,0.4626,0.9498,0.4628,0.8879,0.4628,0.8953,0.4552,0.8684,0.4551,0.9006,0.455,0.9378,0.4551,0.9345,0.4552]);
...
HAnimJoint950.center = new SFVec3f(new float[0.1818,0.7157,-0.1069]);
...
Transform952.translation = new SFVec3f(new float[0.1818,0.7157,-0.1069]);
...
HAnimJoint960.center = new SFVec3f(new float[0.1811,0.6975,-0.0826]);
...
Transform962.translation = new SFVec3f(new float[0.1811,0.6975,-0.0826]);
...
HAnimJoint970.center = new SFVec3f(new float[0.1803,0.684,-0.0759]);
...
Transform972.translation = new SFVec3f(new float[0.1803,0.684,-0.0759]);
...
HAnimJoint980.center = new SFVec3f(new float[0.1809,0.6642,-0.0661]);
...
Transform982.translation = new SFVec3f(new float[0.1809,0.6642,-0.0661]);
...
HAnimJoint990.center = new SFVec3f(new float[0.1825,0.6455,-0.0522]);
...
Transform992.translation = new SFVec3f(new float[0.1825,0.6455,-0.0522]);
...
HAnimJoint1000.center = new SFVec3f(new float[0.1811,0.6984,-0.0935]);
...
Transform1002.translation = new SFVec3f(new float[0.1811,0.6984,-0.0935]);
...
HAnimJoint1010.center = new SFVec3f(new float[0.1811,0.679,-0.0922]);
...
Transform1012.translation = new SFVec3f(new float[0.1811,0.679,-0.0922]);
...
HAnimJoint1020.center = new SFVec3f(new float[0.1836,0.6286,-0.0868]);
...
Transform1022.translation = new SFVec3f(new float[0.1836,0.6286,-0.0868]);
...
HAnimJoint1030.center = new SFVec3f(new float[0.1815,0.5983,-0.0877]);
...
Transform1032.translation = new SFVec3f(new float[0.1815,0.5983,-0.0877]);
...
HAnimJoint1040.center = new SFVec3f(new float[0.1805,0.5731,-0.0885]);
...
Transform1042.translation = new SFVec3f(new float[0.1805,0.5731,-0.0885]);
...
HAnimJoint1010.children[1] = HAnimJoint1020;

HAnimJoint1000.children[1] = HAnimJoint1010;

HAnimJoint950.children[2] = HAnimJoint1000;
...
HAnimJoint1050.center = new SFVec3f(new float[0.1809,0.7,-0.1067]);
...
Transform1052.translation = new SFVec3f(new float[0.1809,0.7,-0.1067]);
...
HAnimJoint1060.center = new SFVec3f(new float[0.1809,0.6772,-0.1081]);
...
Transform1062.translation = new SFVec3f(new float[0.1809,0.6772,-0.1081]);
...
HAnimJoint1070.center = new SFVec3f(new float[0.1835,0.6264,-0.1058]);
...
Transform1072.translation = new SFVec3f(new float[0.1835,0.6264,-0.1058]);
...
HAnimJoint1080.center = new SFVec3f(new float[0.1815,0.5947,-0.1054]);
...
Transform1082.translation = new SFVec3f(new float[0.1815,0.5947,-0.1054]);
...
HAnimJoint1090.center = new SFVec3f(new float[0.1805,0.5668,-0.1056]);
...
Transform1092.translation = new SFVec3f(new float[0.1805,0.5668,-0.1056]);
...
HAnimJoint1060.children[1] = HAnimJoint1070;

HAnimJoint1050.children[1] = HAnimJoint1060;

HAnimJoint950.children[3] = HAnimJoint1050;
...
HAnimJoint1100.center = new SFVec3f(new float[0.1809,0.6973,-0.1276]);
...
Transform1102.translation = new SFVec3f(new float[0.1809,0.6973,-0.1276]);
...
HAnimJoint1110.center = new SFVec3f(new float[0.1809,0.6777,-0.1218]);
...
Transform1112.translation = new SFVec3f(new float[0.1809,0.6777,-0.1218]);
...
HAnimJoint1120.center = new SFVec3f(new float[0.1835,0.6255,-0.1233]);
...
Transform1122.translation = new SFVec3f(new float[0.1835,0.6255,-0.1233]);
...
HAnimJoint1130.center = new SFVec3f(new float[0.1815,0.598,-0.1225]);
...
Transform1132.translation = new SFVec3f(new float[0.1815,0.598,-0.1225]);
...
HAnimJoint1140.center = new SFVec3f(new float[0.1805,0.5722,-0.1217]);
...
Transform1142.translation = new SFVec3f(new float[0.1805,0.5722,-0.1217]);
...
HAnimJoint1110.children[1] = HAnimJoint1120;

HAnimJoint1100.children[1] = HAnimJoint1110;

HAnimJoint950.children[4] = HAnimJoint1100;
...
HAnimJoint1150.center = new SFVec3f(new float[0.1815,0.6797,-0.1347]);
...
Transform1152.translation = new SFVec3f(new float[0.1815,0.6797,-0.1347]);
...
HAnimJoint1160.center = new SFVec3f(new float[0.1832,0.6295,-0.1389]);
...
Transform1162.translation = new SFVec3f(new float[0.1832,0.6295,-0.1389]);
...
HAnimJoint1170.center = new SFVec3f(new float[0.1815,0.6124,-0.139]);
...
Transform1172.translation = new SFVec3f(new float[0.1815,0.6124,-0.139]);
...
HAnimJoint1180.center = new SFVec3f(new float[0.1806,0.5938,-0.1388]);
...
Transform1182.translation = new SFVec3f(new float[0.1806,0.5938,-0.1388]);
...
HAnimJoint1160.children[1] = HAnimJoint1170;

HAnimJoint1150.children[1] = HAnimJoint1160;

HAnimJoint950.children[5] = HAnimJoint1150;

HAnimJoint940.children[1] = HAnimJoint950;

HAnimJoint930.children[1] = HAnimJoint940;

HAnimJoint920.children[1] = HAnimJoint930;

HAnimJoint910.children[1] = HAnimJoint920;

HAnimJoint750.children[2] = HAnimJoint910;
...
HAnimJoint1190.center = new SFVec3f(new float[-0.0387,1.2001,-0.1157]);
...
Transform1192.translation = new SFVec3f(new float[-0.0387,1.2001,-0.1157]);
...
IndexedFaceSet1197.coordIndex = new MFInt32(new int[9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1]);
IndexedFaceSet1197.creaseAngle = 3.14159;
IndexedFaceSet1197.texCoordIndex = new MFInt32(new int[9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1]);
let Coordinate1198 = browser.currentScene.createNode("Coordinate");
Coordinate1198.point = new MFVec3f(new float[-0.1125,-0.0062,-0.1213,-0.1143,0.0027,-0.1008,-0.1061,-0.0047,-0.0749,-0.1044,-0.0495,-0.077,-0.1034,-0.0456,-0.1047,-0.0761,0.0002,-0.062,-0.0877,0.0137,-0.1031,-0.0945,-0.0646,-0.1147,-0.0989,-0.0646,-0.0697,-0.0848,-0.0013,-0.1399,0.0026,0.0056,-0.1061,0.0026,-0.0018,-0.1231,0.0026,-0.0405,-0.1077,0.0026,-0.0399,-0.0878,0.0026,-0.0027,-0.0835]);
IndexedFaceSet1197.coord = Coordinate1198;

let TextureCoordinate1199 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate1199.point = new MFVec2f(new float[0.1911,0.4797,0.171,0.4832,0.1497,0.4806,0.1519,0.4334,0.1831,0.4416,0.1474,0.4856,0.1708,0.4854,0.1784,0.4249,0.1538,0.4251,0.1963,0.4863,0.19,0.5091,0.1847,0.499,0.172,0.4382,0.1568,0.4457,0.1409,0.4926]);
...
HAnimJoint1200.center = new SFVec3f(new float[-0.1231,1.1833,-0.1148]);
...
Transform1202.translation = new SFVec3f(new float[-0.1231,1.1833,-0.1148]);
...
HAnimJoint1210.center = new SFVec3f(new float[-0.1649,1.17,-0.1051]);
...
Transform1212.translation = new SFVec3f(new float[-0.1649,1.17,-0.1051]);
...
HAnimJoint1220.center = new SFVec3f(new float[-0.1819,0.9202,-0.1075]);
...
Transform1222.translation = new SFVec3f(new float[-0.1819,0.9202,-0.1075]);
...
Coordinate1228.point = new MFVec3f(new float[-0.005,-0.0017,-0.1278,-0.0262,-0.0019,-0.1077,-0.0141,-0.0018,-0.0785,0.0145,-0.0015,-0.0805,0.0201,-0.0015,-0.111,-0.0034,-0.0276,-0.1384,-0.0333,-0.0278,-0.1115,-0.0163,-0.0277,-0.0653,0.0241,-0.0273,-0.0685,0.0321,-0.0273,-0.1167,-0.0032,-0.0873,-0.138,-0.0351,-0.0876,-0.1114,-0.0178,-0.0744,-0.0657,0.0254,-0.074,-0.0688,0.0347,-0.087,-0.1165,-0.0015,-0.2046,-0.1342,-0.0248,-0.2048,-0.1048,-0.0115,-0.2047,-0.0679,0.0199,-0.2044,-0.0709,0.0261,-0.2044,-0.1096,-0.0004,-0.2186,-0.1218,-0.0163,-0.2188,-0.1017,-0.0072,-0.2187,-0.0784,0.0142,-0.2185,-0.0805,0.0185,-0.2185,-0.105]);
IndexedFaceSet1227.coord = Coordinate1228;

let TextureCoordinate1229 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate1229.point = new MFVec2f(new float[0.8857,0.572,0.9344,0.572,0.9377,0.5719,0.8909,0.5718,0.8588,0.5719,0.8849,0.5578,0.8418,0.558,0.9588,0.5579,0.9536,0.5581,0.8765,0.5581,0.885,0.5257,0.8424,0.5258,0.9582,0.5328,0.9531,0.533,0.8768,0.526,0.8957,0.4625,0.8485,0.4627,0.9546,0.4626,0.9498,0.4628,0.8879,0.4628,0.8953,0.4552,0.8684,0.4551,0.9006,0.455,0.9378,0.4551,0.9345,0.4552]);
...
HAnimJoint1230.center = new SFVec3f(new float[-0.1818,0.7157,-0.1069]);
...
Transform1232.translation = new SFVec3f(new float[-0.1818,0.7157,-0.1069]);
...
HAnimJoint1240.center = new SFVec3f(new float[-0.1811,0.6975,-0.0826]);
...
Transform1242.translation = new SFVec3f(new float[-0.1811,0.6975,-0.0826]);
...
HAnimJoint1250.center = new SFVec3f(new float[-0.1803,0.684,-0.0759]);
...
Transform1252.translation = new SFVec3f(new float[-0.1803,0.684,-0.0759]);
...
HAnimJoint1260.center = new SFVec3f(new float[-0.1808,0.6642,-0.0661]);
...
Transform1262.translation = new SFVec3f(new float[-0.1808,0.6642,-0.0661]);
...
HAnimJoint1270.center = new SFVec3f(new float[-0.1825,0.6455,-0.0522]);
...
Transform1272.translation = new SFVec3f(new float[-0.1825,0.6455,-0.0522]);
...
HAnimJoint1280.center = new SFVec3f(new float[-0.1811,0.6984,-0.0935]);
...
Transform1282.translation = new SFVec3f(new float[-0.1811,0.6984,-0.0935]);
...
Coordinate1288.point = new MFVec3f(new float[0.0141,-0.0297,-0.1071,-0.0178,-0.0297,-0.1071,-0.0155,-0.0071,-0.108,0.0134,-0.0071,-0.1078,0.0115,-0.0334,-0.107,-0.0144,-0.0334,-0.107,-0.0117,-0.0002,-0.1085,0.0101,-0.0002,-0.1083,0.0117,-0.0087,-0.1096,0.0131,-0.0279,-0.1087,-0.0157,-0.0279,-0.1087,-0.0138,-0.0087,-0.1098,-0.016,-0.027,-0.0932,0.0142,-0.027,-0.0932,-0.013,-0.0096,-0.096,0.012,-0.0096,-0.096,0.0108,-0.031,-0.092,-0.0129,-0.0313,-0.0925,-0.0098,-0.0028,-0.0972,0.01,-0.0028,-0.0971,-0.014,-0.0255,-0.092,-0.0113,-0.0105,-0.0944,-0.0086,-0.0045,-0.0954,0.0086,-0.0045,-0.0953,0.0103,-0.0105,-0.0943,0.0122,-0.0255,-0.092,0.0092,-0.0289,-0.0909,-0.0113,-0.0292,-0.0913]);
IndexedFaceSet1287.coord = Coordinate1288;

let TextureCoordinate1289 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate1289.point = new MFVec2f(new float[0.813,0.0266,0.8136,0.0488,0.8136,0.0488,0.8133,0.0266,0.8111,0.0474,0.8105,0.0283,0.8108,0.0283,0.8111,0.0474,0.8141,0.0525,0.8141,0.0525,0.8123,0.0198,0.8125,0.0198,0.9273,0.2479,0.9315,0.2698,0.9337,0.2676,0.9301,0.2489,0.9262,0.2444,0.9337,0.2762,0.9335,0.2763,0.8381,0.0441,0.904,0.2568,0.8327,0.0273,0.9122,0.2724,0.8401,0.0478,0.9014,0.2535,0.8395,0.0482,0.9142,0.2789,0.8319,0.0206,0.9141,0.2788,0.8381,0.0441,0.8327,0.0273,0.8319,0.0206,0.9141,0.2788,0.9122,0.2724,0.904,0.2568,0.9014,0.2535,0.8395,0.0482]);
...
HAnimJoint1290.center = new SFVec3f(new float[-0.1811,0.679,-0.0922]);
...
Transform1292.translation = new SFVec3f(new float[-0.1811,0.679,-0.0922]);
...
HAnimJoint1300.center = new SFVec3f(new float[-0.1835,0.6286,-0.0868]);
...
Transform1302.translation = new SFVec3f(new float[-0.1835,0.6286,-0.0868]);
...
HAnimJoint1310.center = new SFVec3f(new float[-0.1815,0.5983,-0.0877]);
...
Transform1312.translation = new SFVec3f(new float[-0.1815,0.5983,-0.0877]);
...
HAnimJoint1320.center = new SFVec3f(new float[-0.1805,0.5731,-0.0885]);
...
Transform1322.translation = new SFVec3f(new float[-0.1805,0.5731,-0.0885]);
...
Coordinate1328.point = new MFVec3f(new float[-0.0073,-0.0118,-0.0964,-0.0073,-0.0117,-0.1071,-0.0056,-0.0199,-0.097,-0.0056,-0.0198,-0.1067,0.0078,-0.0192,-0.0965,0.0017,-0.0197,-0.0947,0.0078,-0.0191,-0.1071,0.0017,-0.0195,-0.1091,-0.0032,-0.0261,-0.0975,-0.0032,-0.026,-0.1064,0.0079,-0.0257,-0.0976,0.0025,-0.0264,-0.0957,0.0079,-0.0256,-0.1061,0.0025,-0.0262,-0.1082,-0.0039,-0.028,-0.102,0.007,-0.028,-0.102,0.0025,-0.0294,-0.102,-0.0038,-0.0276,-0.0995,0.0071,-0.0275,-0.104,0.0022,-0.0287,-0.0987,-0.0038,-0.0276,-0.1043,0.0071,-0.0275,-0.0998,0.0022,-0.0288,-0.105,0.0083,-0.0085,-0.0966,-0.0078,-0.0059,-0.107,-0.0078,-0.006,-0.0963,-0.0031,-0.0041,-0.0967,-0.0031,-0.004,-0.1066,0.0049,-0.0041,-0.0967,0.0084,-0.0084,-0.1068,0.0049,-0.0039,-0.1066,0.0006,-0.0089,-0.0939,0.0006,-0.0087,-0.1092]);
IndexedFaceSet1327.coord = Coordinate1328;

let TextureCoordinate1329 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate1329.point = new MFVec2f(new float[0.8542,0.1553,0.8574,0.1518,0.8533,0.1496,0.8379,0.1515,0.8351,0.1545,0.8388,0.1572,0.8414,0.1663,0.8547,0.1647,0.8578,0.1639,0.8665,0.142,0.8703,0.1535,0.8804,0.1378,0.8846,0.1491,0.8382,0.1663,0.8495,0.1759,0.8523,0.1752,0.8544,0.1737,0.8566,0.1736,0.8658,0.1324,0.8753,0.1296,0.8677,0.1303,0.8725,0.1289,0.842,0.1753,0.8441,0.175,0.8533,0.1759,0.8496,0.1769,0.8467,0.1759,0.846,0.1768,0.87,0.1292,0.8525,0.1477,0.8382,0.1495,0.8525,0.1475,0.8381,0.1492,0.8664,0.1541,0.8878,0.1476,0.8639,0.1422,0.8827,0.1365,0.8634,0.1325,0.8774,0.1283,0.8662,0.1297,0.8697,0.1281,0.8732,0.1275,0.872,0.1575,0.8858,0.1533]);
...
HAnimJoint1290.children[1] = HAnimJoint1300;

HAnimJoint1280.children[1] = HAnimJoint1290;

HAnimJoint1230.children[2] = HAnimJoint1280;
...
HAnimJoint1330.center = new SFVec3f(new float[-0.1809,0.7,-0.1067]);
...
Transform1332.translation = new SFVec3f(new float[-0.1809,0.7,-0.1067]);
...
HAnimJoint1340.center = new SFVec3f(new float[-0.1809,0.6772,-0.1081]);
...
Transform1342.translation = new SFVec3f(new float[-0.1809,0.6772,-0.1081]);
...
HAnimJoint1350.center = new SFVec3f(new float[-0.1835,0.6264,-0.1058]);
...
Transform1352.translation = new SFVec3f(new float[-0.1835,0.6264,-0.1058]);
...
HAnimJoint1360.center = new SFVec3f(new float[-0.1815,0.5947,-0.1054]);
...
Transform1362.translation = new SFVec3f(new float[-0.1815,0.5947,-0.1054]);
...
HAnimJoint1370.center = new SFVec3f(new float[-0.1805,0.5668,-0.1056]);
...
Transform1372.translation = new SFVec3f(new float[-0.1805,0.5668,-0.1056]);
...
HAnimJoint1340.children[1] = HAnimJoint1350;

HAnimJoint1330.children[1] = HAnimJoint1340;

HAnimJoint1230.children[3] = HAnimJoint1330;
...
HAnimJoint1380.center = new SFVec3f(new float[-0.1809,0.6973,-0.1276]);
...
Transform1382.translation = new SFVec3f(new float[-0.1809,0.6973,-0.1276]);
...
HAnimJoint1390.center = new SFVec3f(new float[-0.1809,0.6777,-0.1218]);
...
Transform1392.translation = new SFVec3f(new float[-0.1809,0.6777,-0.1218]);
...
HAnimJoint1400.center = new SFVec3f(new float[-0.1835,0.6255,-0.1233]);
...
Transform1402.translation = new SFVec3f(new float[-0.1835,0.6255,-0.1233]);
...
HAnimJoint1410.center = new SFVec3f(new float[-0.1815,0.598,-0.1225]);
...
Transform1412.translation = new SFVec3f(new float[-0.1815,0.598,-0.1225]);
...
HAnimJoint1420.center = new SFVec3f(new float[-0.1805,0.5722,-0.1217]);
...
Transform1422.translation = new SFVec3f(new float[-0.1805,0.5722,-0.1217]);
...
HAnimJoint1390.children[1] = HAnimJoint1400;

HAnimJoint1380.children[1] = HAnimJoint1390;

HAnimJoint1230.children[4] = HAnimJoint1380;
...
HAnimJoint1430.center = new SFVec3f(new float[-0.1814,0.6797,-0.1347]);
...
Transform1432.translation = new SFVec3f(new float[-0.1814,0.6797,-0.1347]);
...
HAnimJoint1440.center = new SFVec3f(new float[-0.1832,0.6295,-0.1389]);
...
Transform1442.translation = new SFVec3f(new float[-0.1832,0.6295,-0.1389]);
...
Coordinate1448.point = new MFVec3f(new float[0.0103,-0.0254,-0.1063,-0.0075,-0.0234,-0.1067,0.0026,-0.0258,-0.109,0.0084,-0.0285,-0.1057,-0.0041,-0.03,-0.1064,0.0084,-0.0286,-0.0981,-0.0041,-0.0301,-0.0975,0.0025,-0.0305,-0.1064,0.0025,-0.0306,-0.098,0.0103,-0.0256,-0.0973,0.002,-0.0262,-0.0944,-0.0075,-0.0236,-0.0972,-0.0089,-0.012,-0.0961,-0.0087,-0.0093,-0.1069,0.0098,-0.0093,-0.1069,0.0099,-0.012,-0.0961,0.0009,-0.015,-0.0941,0.0011,-0.0087,-0.1097,-0.0075,-0.0007,-0.0935,-0.006,0.0017,-0.1052,0.0015,0.0021,-0.1077,0.0086,0.0017,-0.1051,0.0087,-0.0008,-0.0933,-0.0097,-0.0042,-0.1071,0.0011,-0.0036,-0.11,0.0105,-0.0042,-0.1071,0.0107,-0.0068,-0.0933,0.01,-0.0063,-0.0922,0.0094,-0.0117,-0.0927,0.0006,-0.0141,-0.0935,-0.0083,-0.0116,-0.0927,-0.01,-0.0062,-0.0923,-0.0069,-0.0009,-0.0926,0.008,-0.0009,-0.0925,-0.0111,-0.0068,-0.0933,0.0008,-0.015,-0.0939,-0.0095,-0.0125,-0.0937,0.0099,-0.0125,-0.0937]);
IndexedFaceSet1447.coord = Coordinate1448;

let TextureCoordinate1449 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate1449.point = new MFVec2f(new float[0.7578,0.1276,0.7543,0.1247,0.753,0.131,0.7531,0.1316,0.9854,0.1598,0.9725,0.1615,0.9734,0.1584,0.9844,0.1569,0.7413,0.123,0.7403,0.1293,0.7378,0.1249,0.7401,0.1299,0.7405,0.104,0.7443,0.1047,0.9859,0.1809,0.7455,0.0995,0.766,0.1015,0.9713,0.1822,0.7589,0.1059,0.7648,0.1066,0.766,0.1014,0.7622,0.1091,0.7648,0.1066,0.7644,0.1092,0.7455,0.0995,0.7415,0.0989,0.7664,0.0954,0.7667,0.0954,0.7485,0.0932,0.7449,0.0928,0.7484,0.0932,0.7683,0.1016,0.7686,0.0957,0.7683,0.0956,0.7679,0.1015,0.7671,0.1055,0.7666,0.1084,0.7674,0.1056,0.9687,0.1615,0.9723,0.1564,0.9888,0.1589,0.9852,0.1547,0.9898,0.1809,0.9856,0.1862,0.9651,0.1878,0.9675,0.1796,0.9654,0.1826,0.9654,0.1799,0.9897,0.1861]);
...
HAnimJoint1450.center = new SFVec3f(new float[-0.1815,0.6124,-0.139]);
...
Transform1452.translation = new SFVec3f(new float[-0.1815,0.6124,-0.139]);
...
Coordinate1458.point = new MFVec3f(new float[0.0015,-0.0272,-0.1084,0.009,-0.0264,-0.0971,-0.0066,-0.0247,-0.097,-0.0085,-0.012,-0.0973,-0.0085,-0.0118,-0.1064,0.0086,-0.0083,-0.1062,-0.0092,-0.0063,-0.1066,0.0086,-0.0084,-0.0972,-0.0092,-0.0064,-0.0971,0.0048,-0.0049,-0.1065,0.0048,-0.005,-0.097,-0.0036,-0.0053,-0.097,-0.0036,-0.0052,-0.1065,0.0009,-0.0086,-0.1089,0.0004,-0.009,-0.0943,0.0015,-0.0268,-0.0946,-0.0045,-0.031,-0.0972,-0.0013,-0.0314,-0.097,0.009,-0.0267,-0.1062,0.0078,-0.0295,-0.0978,0.0073,-0.0297,-0.1052,-0.0066,-0.025,-0.1065,-0.0045,-0.0312,-0.1057,-0.0014,-0.0316,-0.1057]);
IndexedFaceSet1457.coord = Coordinate1458;

let TextureCoordinate1459 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate1459.point = new MFVec2f(new float[0.9725,0.1615,0.7578,0.1276,0.7541,0.1444,0.9727,0.1441,0.7543,0.1247,0.7533,0.1302,0.9851,0.1424,0.9854,0.1598,0.7404,0.1285,0.7384,0.1404,0.7513,0.1418,0.7413,0.123,0.7378,0.1249,0.7355,0.1424,0.7545,0.1231,0.7416,0.1216,0.7546,0.1229,0.7417,0.1214,0.7496,0.1479,0.7498,0.1481,0.9738,0.1409,0.9839,0.1396,0.738,0.1467,0.7381,0.1469,0.9687,0.1616,0.9694,0.1441,0.9888,0.1589,0.988,0.1416,0.9725,0.165,0.9854,0.1633,0.9728,0.1395,0.9846,0.1375]);
...
HAnimJoint1460.center = new SFVec3f(new float[-0.1806,0.5938,-0.1388]);
...
Transform1462.translation = new SFVec3f(new float[-0.1806,0.5938,-0.1388]);
...
HAnimJoint600.children[1] = HAnimJoint610;

HAnimJoint590.children[1] = HAnimJoint600;

HAnimJoint20.children[3] = HAnimJoint590;

HAnimJoint10.children[1] = HAnimJoint20;
...
HAnimHumanoid9.joints[43] = HAnimJoint1512;
...
HAnimHumanoid9.joints[44] = HAnimJoint1513;
...
HAnimHumanoid9.joints[45] = HAnimJoint1514;
...
HAnimHumanoid9.joints[46] = HAnimJoint1515;
...
HAnimHumanoid9.joints[47] = HAnimJoint1516;
...
HAnimHumanoid9.joints[48] = HAnimJoint1517;
...
HAnimHumanoid9.joints[49] = HAnimJoint1518;
...
HAnimHumanoid9.joints[127] = HAnimJoint1596;
...
HAnimHumanoid9.joints[128] = HAnimJoint1597;
...
HAnimHumanoid9.joints[129] = HAnimJoint1598;
...
HAnimHumanoid9.joints[130] = HAnimJoint1599;
...
HAnimHumanoid9.joints[131] = HAnimJoint1600;
...
HAnimHumanoid9.joints[132] = HAnimJoint1601;
...
HAnimHumanoid9.joints[133] = HAnimJoint1602;

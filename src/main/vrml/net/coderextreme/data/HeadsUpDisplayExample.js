...
let Background7 = browser.currentScene.createNode("Background");
Background7.DEF = "SandyShallowBottom";
Background7.groundAngle = new MFFloat(new float[0.05,1.52,1.56,1.5707]);
...
ProtoInstance9.fieldValue = new MFNode();
...
Material16.diffuseColor = new SFColor(new float[0.894118,0.819608,1]);
Appearance15.material = Material16;

Shape12.appearance = Appearance15;

fieldValue11.children = new MFNode();

var ProtoInstance0 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setDEF("SandyShallowBottom").setGroundAngle(java.newArray("float", [0.05,1.52,1.56,1.5707])).setGroundColor(java.newArray("float", [0.2,0.2,0,0.3,0.3,0,0.5,0.5,0.3,0.1,0.3,0.4,0,0.2,0.4])).setSkyAngle(java.newArray("float", [0.04,0.05,0.1,1.309,1.57])).setSkyColor(java.newArray("float", [0.8,0.8,0.2,0.8,0.8,0.2,0.1,0.1,0.6,0.1,0.1,0.6,0.1,0.25,0.8,0.6,0.6,0.9])))
        ...
        .addChild(new Inline().setUrl(java.newArray("java.lang.String", ["../HelloWorld.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/HelloWorld.x3d","../HelloWorld.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/HelloWorld.wrl"]))))      ;
ProtoInstance0
          .addFieldValue(new fieldValue().setName("screenOffset").setValue("-0.75 1 -5"));
ProtoInstance0
          .addFieldValue(new fieldValue().setName("children")
            .addChild(new Shape()
              .setGeometry(new Text().setString(java.newArray("java.lang.String", ["HUD text stays fixed","while user navigates"]))
                .setFontStyle(new FontStyle().setJustify(java.newArray("java.lang.String", ["MIDDLE","MIDDLE"])).setSize(0.3)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(java.newArray("float", [0.894118,0.819608,1]))))));

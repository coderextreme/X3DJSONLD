...
meta5.content = "https://coderextreme.net/X3DJSONLD/src/main/data/flower3.x3d";
head1.meta[3] = meta5;
...
Transform12.translation = new SFVec3f(new float[8,0,0]);
...
Material15.diffuseColor = new SFColor(new float[0,0.5,1]);
Material15.specularColor = new SFColor(new float[0,0.5,1]);

...
Material23.diffuseColor = new X3D.SFColor([1,0,0]);
material = Material23;
...
Extrusion50.spine = new X3D.MFVec3f([0,-50,0,0,0,0,0,50,0]);
...
Script52.getField("spine").setValue("0 -50 0 0 0 0 0 50 0");
Script51YYY.field = new X3D.MFNode();

Script53.getField("endA")Script51YYY.field = new X3D.MFNode();

Script54.getField("endB")Script51YYY.field = new X3D.MFNode();

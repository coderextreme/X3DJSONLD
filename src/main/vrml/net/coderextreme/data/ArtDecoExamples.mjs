...
Inline64.url = new X3D.MFString([new X3D.SFString("../data/gridBack.json"), new X3D.SFString("../data/gridBack.x3d"), new X3D.SFString("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.x3d"), new X3D.SFString("gridBack.wrl"), new X3D.SFString("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.wrl")]);

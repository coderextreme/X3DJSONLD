...
scene.addMetaData("title", "Tongue.x3d");
scene.addMetaData("description", "Facial Action Coding System (FACS) example for Action Unit (AU) 27, Mouth Stretch Morpher, Tongue Derivated.");
scene.addMetaData("creator", "Yujin Jung");
scene.addMetaData("translator", "Chul Hee Jung");
scene.addMetaData("translator", "Myeong Won Lee");
scene.addMetaData("created", "25 April 2022");
scene.addMetaData("modified", "27 October 2024");
scene.addMetaData("translator", "Don Brutzman");
scene.addMetaData("translator", "Joe D. Williams");
scene.addMetaData("reference", "https://en.wikipedia.org/wiki/Facial_Action_Coding_System");
scene.addMetaData("reference", "https://web.cs.wpi.edu/~matt/courses/cs563/talks/face_anim/ekman.html");
scene.addMetaData("reference", "Bryn Farnsworth, FACS Visual Guidebook https://imotions.com/blog/learning/research-fundamentals/facial-action-coding-system");
scene.addMetaData("generator", "Suwon VRLAB X3D Converter");
scene.addMetaData("MovingImage", "originals/SuwonHAnimFacialMotionConverter.mp4");
scene.addMetaData("generator", "X3D-Edit 4.0, https://savage.nps.edu/X3D-Edit");
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/Tongue.x3d");
...
Viewpoint21.position = new X3D.SFVec3f([0,20,60]);
...
browser.currentScene.children[1] = TimeSensor22;

let EXPORT23 = browser.currentScene.createNode("EXPORT");
EXPORT23.localDEF = "JinMouthStretch_Clock";
EXPORT23.AS = "JinMouthStretch_Clock";
browser.currentScene.children[2] = EXPORT23;

let ScalarInterpolator24 = browser.currentScene.createNode("ScalarInterpolator");
ScalarInterpolator24.DEF = "AnimationAdapter_JinMouthStretch";
ScalarInterpolator24.key = new X3D.MFFloat([0,0.25,0.5,0.75,1]);
ScalarInterpolator24.keyValue = new X3D.MFFloat([0,0.5,1,0.5,0]);
browser.currentScene.children[3] = ScalarInterpolator24;
...
HAnimSegment27ZZZ.children[0] = WorldInfo28;

let Background29 = browser.currentScene.createNode("Background");
Background29.skyColor = new X3D.MFColor([0.8,0.9,1]);
HAnimSegment27ZZZ.children[1] = Background29;
...
HAnimSegment27ZZZ.children[2] = NavigationInfo30;
...
Transform33.translation = new X3D.SFVec3f([0,8.886,11.1]);
...
ImageTexture37.url = new X3D.MFString([new X3D.SFString("JinImageAtlas.jpg"), new X3D.SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/JinImageAtlas.jpg")]);

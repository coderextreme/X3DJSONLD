...
var ProtoInstance3 = null;
      ...
      .setScene(new Scene()
        .addChild(new ExternProtoDeclare().setName("ViewPositionOrientation").setUrl(java.newArray("java.lang.String", ["../../Savage/Tools/Authoring/ViewPositionOrientationPrototype.x3d#ViewPositionOrientation","https://savage.nps.edu/Savage/Tools/Authoring/ViewPositionOrientationPrototype.x3d#ViewPositionOrientation","../../Savage/Tools/Authoring/ViewPositionOrientationPrototype.wrl#ViewPositionOrientation","https://savage.nps.edu/Savage/Tools/Authoring/ViewPositionOrientationPrototype.wrl#ViewPositionOrientation"]))
        ...
        .addChild(new ProtoDeclare().setName("EmissiveMaterial")
          ...
          .setProtoBody(new ProtoBody()
            ...
            .addChild(new Material().setDiffuseColor(java.newArray("float", [0,0,0]))
        ...
        .addChild(new ProtoDeclare().setName("ShiftGroupUp2m")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType(field.TYPE_MFNODE).setName("children").setAccessType(field.ACCESSTYPE_INPUTOUTPUT)
              .addChild(new Group().setDEF("DefaultNodeValue").setBboxSize(java.newArray("float", [2,2,2]))
        ...
        .addChild(new Transform().setDEF("TransformExampleUSE").setRotation(java.newArray("float", [0,1,0,0.78])).setTranslation(java.newArray("float", [0,2.5,0]))
        ...
        .addChild(new Transform().setTranslation(java.newArray("float", [0,-2.5,0]))
          .addChild(new Shape()
            ...
            .setGeometry(new Text().setString(java.newArray("java.lang.String", ["X3D Header Prototype syntax examples","(view console for EXTERNPROTO output)"]))
              .setFontStyle(new FontStyle().setJustify(java.newArray("java.lang.String", ["MIDDLE","MIDDLE"])).setSize(0.6)))))
        ...
        .addChild(new OrientationInterpolator().setDEF("Spinner").setKey(java.newArray("float", [0,0.5,1])).setKeyValue(java.newArray("float", [0,1,0,0,0,1,0,3.14159,0,1,0,6.28318])))
        ...
        .addChild(new Inline().setDEF("someInline").setUrl(java.newArray("java.lang.String", ["someUrl.x3d","http://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/someUrl.x3d"])))
        .addChild(new IMPORT().setAS("someInlineRoot").setImportedDEF("someName").setInlineDEF("someInline"))
        .addChild(new PositionInterpolator().setDEF("StayInPlace").setKey(java.newArray("float", [0,1])).setKeyValue(java.newArray("float", [0,0,0,0,0,0])))

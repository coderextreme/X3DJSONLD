...
Transform48.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform48.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite50.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite50.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite62.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite62.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite77.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite77.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform78.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform78.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform90.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform90.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimSite92.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimSite92.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform93.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform93.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Group96.bboxCenter = new SFVec3f(new float[0,0,0]);
Group96.bboxSize = new SFVec3f(new float[-1,-1,-1]);
let Shape97 = browser.currentScene.createNode("Shape");
Shape97.DEF = "TrouserSkin";
Shape97.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape97.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Shape107.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape107.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Group166.bboxCenter = new SFVec3f(new float[0,0,0]);
Group166.bboxSize = new SFVec3f(new float[-1,-1,-1]);

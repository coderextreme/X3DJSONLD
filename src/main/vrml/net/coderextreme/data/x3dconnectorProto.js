...
Transform33.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform33.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
ProtoBody58.x3DScript = X3DScript59;

...
HAnimHumanoid5.info = new MFString(new java.lang.String["authorName=Chul Hee Jung and Myeong Won Lee","authorEmail=myeongwonlee@gmail.com","creationDate=31 March 2011","humanoidVersion=1.0","gender=male","height=1.5"]);
...
HAnimJoint6.center = new SFVec3f(new float[0,34.790001,-1.299]);
let HAnimSegment7 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment7.name = "sacrum";
HAnimSegment7.DEF = "hanim_sacrum";
let Transform8 = browser.currentScene.createNode("Transform");
Transform8.translation = new SFVec3f(new float[0,34.790001,-1.299]);
...
Material11.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance10.material = Material11;

let ImageTexture12 = browser.currentScene.createNode("ImageTexture");
ImageTexture12.DEF = "NoTextureAtlas";
ImageTexture12.url = new MFString(new java.lang.String["images/No.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/images/No.png"]);
...
IndexedFaceSet13.creaseAngle = 1.57;
...
HAnimSegment7.children[0] = Transform8;
...
HAnimJoint16.name = "l_hip";
HAnimJoint16.DEF = "hanim_l_hip";
HAnimJoint16.center = new SFVec3f(new float[3.785,34.07,-1.57]);
let HAnimSegment17 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment17.name = "l_thigh";
HAnimSegment17.DEF = "hanim_l_thigh";
let Transform18 = browser.currentScene.createNode("Transform");
Transform18.translation = new SFVec3f(new float[3.785,34.07,-1.57]);
...
Material21.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance20.material = Material21;

let ImageTexture22 = browser.currentScene.createNode("ImageTexture");
ImageTexture22.USE = "NoTextureAtlas";
...
HAnimJoint26.name = "l_knee";
HAnimJoint26.DEF = "hanim_l_knee";
HAnimJoint26.center = new SFVec3f(new float[3.838,18.4,-1.212]);
let HAnimSegment27 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment27.name = "l_calf";
HAnimSegment27.DEF = "hanim_l_calf";
let Transform28 = browser.currentScene.createNode("Transform");
Transform28.translation = new SFVec3f(new float[3.838,18.4,-1.212]);
...
ImageTexture32.USE = "NoTextureAtlas";
...
HAnimJoint36.center = new SFVec3f(new float[3.826,4.044,-1.361]);
...
Transform38.translation = new SFVec3f(new float[3.826,4.044,-1.361]);
...
ImageTexture42.USE = "NoTextureAtlas";
...
HAnimJoint46.DEF = "hanim_l_midtarsal";
HAnimJoint46.center = new SFVec3f(new float[3.826,3.118,-0.2867]);
let HAnimSegment47 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment47.name = "l_middistal";
HAnimSegment47.DEF = "hanim_l_middistal";
let Transform48 = browser.currentScene.createNode("Transform");
Transform48.translation = new SFVec3f(new float[3.826,3.118,-0.2867]);
...
ImageTexture52.USE = "NoTextureAtlas";
...
HAnimJoint16.children[1] = HAnimJoint26;

HAnimJoint6.children[1] = HAnimJoint16;

let HAnimJoint56 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint56.name = "r_hip";
HAnimJoint56.DEF = "hanim_r_hip";
HAnimJoint56.center = new SFVec3f(new float[-3.785,34.07,-1.57]);
let HAnimSegment57 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment57.name = "r_thigh";
HAnimSegment57.DEF = "hanim_r_thigh";
let Transform58 = browser.currentScene.createNode("Transform");
Transform58.translation = new SFVec3f(new float[-3.785,34.07,-1.57]);
...
ImageTexture62.USE = "NoTextureAtlas";
...
= browser.currentScene.createNode("HAnimSegment");
HAnimSegment67.name = "r_calf";
HAnimSegment67.DEF = "hanim_r_calf";
let Transform68 = browser.currentScene.createNode("Transform");
Transform68.translation = new SFVec3f(new float[-3.838,18.4,-1.212]);
...
ImageTexture72.USE = "NoTextureAtlas";
...
Coordinate74.point = new MFVec3f(new float[-0.6802,-14.47,-1.046,-1.131,-14.47,-0.1321,0.1728,-14.47,-1.461,1.44,-14.47,-0.177,0.9948,-14.47,0.7524,0.2093,-14.47,1.433,-0.6826,-14.47,0.8297,-1.766,-1.607,-0.121,-0.9594,-1.594,-1.515,0.047,-1.58,-2.136,1.778,-1.557,-0.1829,1.169,-1.603,1.193,0.0665,-1.637,1.901,-0.954,-1.596,1.204,0.8812,-14.47,-0.9886,1.076,-1.566,-1.642,-0.8712,-6.987,-1.462,-1.58,-6.82,-0.1242,0.2167,-7.265,-2.016,1.685,-7.632,-0.1812,1.054,-7.528,-1.491,1.107,-7.553,1.106,0.1228,-7.253,1.773,-0.9062,-7.028,1.167,-0.7544,-13.44,-1.12,0.1636,-13.42,-1.601,1.465,-13.45,-0.1774,1.002,-13.47,0.7811,0.2213,-13.46,1.483,-0.6466,-13.47,0.8065,-1.197,-13.45,-0.1309,0.9586,-13.47,-1.084,0.184,-14.79,-0.155,-1.947,0.0101,-0.1035,-1.083,0.0162,-1.534,0.0672,0.0385,-2.065,1.947,0.0623,-0.1715,1.253,0.0335,1.416,0.0571,0.0079,2.136,-1.119,0.0202,1.449,1.211,0.0535,-1.641,-1.68,1.544,-0.09,-0.9219,1.548,-1.346,0.0599,1.568,-1.799,1.008,1.581,-1.447,1.654,1.589,-0.1584,1.033,1.562,1.263,0.0368,1.539,1.862,-0.9449,1.553,1.288,0.0222,2.153,-0.0477]);
IndexedFaceSet73.coord = Coordinate74;

let TextureCoordinate75 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate75.point = new MFVec2f(new float[0.932,0.0281,0.9375,0.0382,0.9285,0.0402,0.9254,0.0312,0.9374,0.024,0.9462,0.0354,0.8988,0.0252,0.8904,0.038,0.8808,0.0336,0.8942,0.0184,0.9057,0.0303,0.9022,0.0409,0.9104,0.0324,0.9093,0.0416,0.9182,0.0316,0.9191,0.0408,0.9517,0.1696,0.9373,0.1675,0.9627,0.1723,0.8764,0.1822,0.8889,0.1769,0.9037,0.1713,0.9136,0.1687,0.9236,0.1679,0.9644,0.1089,0.9758,0.1044,0.9513,0.1129,0.9366,0.1157,0.881,0.1091,0.8973,0.1096,0.9098,0.1121,0.9231,0.1139,0.9177,0.0179,0.9548,0.03,0.9408,0.0161,0.9745,0.1762,0.8679,0.1104,0.9373,0.1675,0.9517,0.1696,0.9627,0.1723,0.8889,0.1769,0.9037,0.1713,0.9136,0.1687,0.9236,0.1679,0.9745,0.1762,0.8764,0.1822,0.9373,0.1675,0.9517,0.1696,0.9627,0.1723,0.9745,0.1762,0.8889,0.1769,0.9037,0.1713,0.9136,0.1687,0.9236,0.1679,0.932,0.1713]);
...
HAnimJoint76.name = "r_ankle";
HAnimJoint76.DEF = "hanim_r_ankle";
HAnimJoint76.center = new SFVec3f(new float[-3.826,4.044,-1.361]);
let HAnimSegment77 = browser.currentScene.createNode("HAnimSegment");
HAnimSeg
0.873,0.3419,0.8564,0.539,0.8465,0.5488,0.873,0.3419,0.8451,0.3434,0.8311,0.3404,0.826,0.3431,0.8307,0.3419,0.8452,0.3813,0.8655,0.4224,0.8577,0.4291,0.8577,0.3684,0.8871,0.3756,0.8816,0.3831,0.8794,0.4229,0.872,0.4261,0.8727,0.4261,0.8727,0.4261,0.8727,0.4229,0.872,0.3831,0.8794,0.3756,0.8815,0.4291,0.8577,0.5498,0.8883,0.5046,0.8883,0.4666,0.8883,0.5445,0.8996,0.5046,0.8996,0.3624,0.829,0.3685,0.8453,0.3528,0.8194,0.368,0.8691,0.3396,0.8261,0.3472,0.8677,0.3591,0.8766,0.3419,0.8634,0.3419,0.8564,0.3419,0.8451,0.3434,0.8311,0.3404,0.826,0.3528,0.8194,0.3623,0.8291,0.3685,0.8453,0.368,0.869,0.3591,0.8766]);
IndexedFaceSet83.texCoord = TextureCoordinate85;
...
HAnimJoint86.name = "r_midtarsal";
HAnimJoint86.DEF = "hanim_r_midtarsal";
HAnimJoint86.center = new SFVec3f(new float[-3.826,3.118,-0.2867]);
let HAnimSegment87 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment87.name = "r_middistal";
HAnimSegment87.DEF = "hanim_r_middistal";
let Transform88 = browser.currentScene.createNode("Transform");
Transform88.translation = new SFVec3f(new float[-3.826,3.118,-0.2867]);
...
ImageTexture92.USE = "NoTextureAtlas";
...
let TextureCoordinate95 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate95.point = new MFVec2f(new float[0.5046,0.9061,0.4664,0.9061,0.3813,0.8655,0.3794,0.8893,0.368,0.869,0.3703,0.8986,0.3591,0.8766,0.3794,0.8891,0.368,0.8691,0.4666,0.8883,0.5046,0.8883,0.5509,0.9061,0.3967,0.963,0.3877,0.9702,0.562,0.9285,0.5046,0.9285,0.4059,0.9781,0.4144,0.966,0.4542,0.9285,0.5657,0.9535,0.5046,0.9535,0.4506,0.9535,0.5561,0.9717,0.397,0.9616,0.4144,0.966,0.4224,0.8577,0.4263,0.8811,0.4134,0.9791,0.4208,0.9685,0.4208,0.9685,0.4291,0.8577,0.4329,0.8811,0.3769,0.9239,0.3855,0.9182,0.3855,0.9183,0.502,0.9815,0.4591,0.9717,0.4263,0.8811,0.4263,0.9104,0.4263,0.9104,0.5498,0.8883,0.4329,0.8811,0.4329,0.9104,0.4329,0.9104,0.3843,0.9558,0.3913,0.9496,0.4741,0.8664,0.5046,0.8664,0.4263,0.9431,0.3913,0.9494,0.4263,0.9431,0.4329,0.9431,0.4329,0.9431,0.3813,0.8654,0.4224,0.8577,0.4291,0.8577,0.3704,0.8386,0.38,0.8357,0.4179,0.8293,0.4204,0.8297,0.4204,0.8297,0.4204,0.8297,0.4179,0.8293,0.38,0.8357,0.3704,0.8386,0.3666,0.8532,0.4291,0.8577]);
IndexedFaceSet93.texCoord = TextureCoordinate95;
...
Transform98.translation = new SFVec3f(new float[0,32.91,-1.57]);
...
ImageTexture102.USE = "NoTextureAtlas";
...
HAnimJoint106.name = "l_shoulder";
HAnimJoint106.DEF = "hanim_l_shoulder";
HAnimJoint106.center = new SFVec3f(new float[7.266,54.049999,-1.79]);
let HAnimSegment107 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment107.name = "l_upperarm";
HAnimSegment107.DEF = "hanim_l_upperarm";
let Transform108 = browser.currentScene.createNode("Transform");
Transform108.translation = new SFVec3f(new float[7.266,54.049999,-1.79]);
...
ImageTexture112.USE = "NoTextureAtlas";
...
HAnimJoint116.name = "l_elbow";
HAnimJoint116.DEF = "hanim_l_elbow";
HAnimJoint116.center = new SFVec3f(new float[7.834,43.389999,-1.651]);
let HAnimSegment117 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment117.name = "l_forearm";
HAnimSegment117.DEF = "hanim_l_forearm";
let Transform118 = browser.currentScene.createNode("Transform");
Transform118.translation = new SFVec3f(new float[7.834,43.389999,-1.651]);
...
ImageTexture122.USE = "NoTextureAtlas";
...
HAnimJoint126.DEF = "hanim_l_wrist";
HAnimJoint126.center = new SFVec3f(new float[7.738,35.43,-1.558]);
let HAnimSegment127 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment127.name = "l_hand";
HAnimSegment127.DEF = "hanim_l_hand";
let Transform128 = browser.currentScene.createNode("Transform");
Transform128.translation = new SFVec3f(new float[7.738,35.43,-1.558]);
...
ImageTexture132.USE = "NoTextureAtlas";
...
HAnimJoint136.name = "r_shoulder";
HAnimJoint136.DEF = "hanim_r_shoulder";
HAnimJoint136.center = new SFVec3f(new float[-7.266,54.049999,-1.79]);
let HAnimSegment137 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment137.name = "r_upperarm";
HAnimSegment137.DEF = "hanim_r_upperarm";
let Transform138 = browser.currentScene.createNode("Transform");
Transform138.translation = new SFVec3f(new float[-7.266,54.049999,-1.79]);
...
ImageTexture142.USE = "NoTextureAtlas";
...
Coordinate144.point = new MFVec3f(new float[-1.368,-9.721,-1.075,-0.5554,-9.627,-1.323,-1.697,-9.897,0.0871,-1.37,-9.961,0.9966,-0.5722,-10.03,1.401,0.1728,-10.12,1.029,0.5888,-10.15,0.0951,0.1549,-9.857,-1.083,-1.515,-5.201,-1.218,-0.6263,-5.266,-1.527,-1.964,-5.133,0.0302,-1.424,-5.144,1.327,-0.5103,-5.244,1.701,0.3415,-5.296,1.393,0.9295,-5.321,0.1721,0.2188,-5.361,-1.227,-1.425,-0.1998,-1.296,-0.5195,-0.6168,-1.758,-1.89,-0.0318,-0.0615,-1.445,-0.2217,1.407,-0.4413,-0.6502,1.913,0.3607,-0.9925,1.358,1.068,-1.294,0.1351,0.4203,-1.018,-1.326,0.0087,0.9247,-1.888,-0.8381,1.677,-1.7,-1.274,0.682,-1.606,-0.0986,0.1637,-2.066,-1.254,1.865,-0.0092,-1.904,0.7808,-0.0329,-0.8112,1.565,1.759,-1.261,0.6935,1.832,0.2175,1.07,1.96,-0.055,0.2851,2.17,0.9228,0.622,1.646,1.001,-0.0973,1.703,1.019,0.6054,-1.572,0.9724,-0.2436,-1.642,1.322,0.4084,-0.0629,1.46,-0.5337,-0.0223,-1.482,-1.046,-1.674,-0.3106,-1.259,-2.163,-2.16,-0.9553,-0.0259,-1.486,-1.078,1.804,-0.2797,-1.333,2.23,0.9142,-1.685,1.672,1.394,-1.825,-0.0013,0.8917,-1.602,-1.736,0.466,1.569,-0.0085,-1.676,-3.535,-1.681
= browser.currentScene.createNode("HAnimSegment");
HAnimSegment147.name = "r_forearm";
HAnimSegment147.DEF = "hanim_r_forearm";
let Transform148 = browser.currentScene.createNode("Transform");
Transform148.translation = new SFVec3f(new float[-7.834,43.389999,-1.651]);
...
ImageTexture152.USE = "NoTextureAtlas";
...
Coordinate154.point = new MFVec3f(new float[0.0407,-0.8376,-1.221,-0.7331,-0.5933,0.8017,0.0176,-0.6645,1.182,0.7221,-0.7616,0.9014,0.0602,-7.36,-0.7594,-0.7233,-7.36,0.0564,0.7878,-7.36,0.0568,0.5288,-7.365,-0.5335,-0.4165,-7.365,0.6592,0.0602,-7.36,0.9907,0.5288,-7.365,0.6609,-0.4165,-7.365,-0.4678,-0.6188,-0.6937,-0.9942,-1.126,-0.5903,0.0001,1.1,-0.8178,0.0254,0.5969,-0.8537,-1.073,0.0602,-7.92,-0.6297,-0.5422,-7.92,0.0623,0.6846,-7.92,0.0627,0.4317,-7.915,-0.4625,-0.3194,-7.915,0.6006,0.0602,-7.92,0.8486,0.4317,-7.915,0.6022,-0.3194,-7.915,-0.398,0.0602,-8.182,0.065,0.0299,-0.0952,-1.393,-0.7675,0.0555,0.847,0.0065,-0.0143,1.165,0.7382,-0.1075,0.8559,-0.7086,0.015,-1.16,-1.198,0.0615,-0.0132,1.198,-0.2053,-0.0002,0.6672,-0.1246,-1.202,-0.4447,0.8519,-0.9853,0.1246,0.7619,-1.165,0.5954,0.7485,-1.024,1.032,0.6748,-0.0338,0.6669,0.7576,0.6468,0.0988,0.8314,0.8871,-0.5047,0.8844,0.639,-0.8466,0.8853,-0.0438,0.1526,1.367,-0.1493]);
IndexedFaceSet153.coord = Coordinate154;

let TextureCoordinate155 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate155.point = new MFVec2f(new float[0.0471,0.5348,0.0457,0.5477,0.0517,0.5187,0.0571,0.5017,0.0625,0.4884,0.0657,0.4747,0.0673,0.4552,0.0409,0.557,0.1806,0.5707,0.1797,0.5783,0.1804,0.5567,0.1838,0.5503,0.1875,0.5412,0.1933,0.5295,0.2007,0.5198,0.175,0.5862,0.19,0.5703,0.1907,0.5757,0.1892,0.5587,0.1918,0.5533,0.2114,0.539,0.2025,0.5422,0.1895,0.5821,0.1949,0.5468,0.2041,0.5636,0.0292,0.5765,0.1758,0.5987,0.1959,0.5888,0.0457,0.5477,0.0571,0.5017,0.0625,0.4884,0.0657,0.4747,0.0471,0.5348,0.0517,0.5187,0.0292,0.5765,0.0673,0.4552,0.0409,0.557,0.0471,0.5348,0.0457,0.5477,0.0409,0.557,0.0292,0.5765,0.0657,0.4747,0.0625,0.4884,0.0571,0.5017,0.0517,0.5187,0.05,0.5249]);
...
HAnimJoint156.name = "r_wrist";
HAnimJoint156.DEF = "hanim_r_wrist";
HAnimJoint156.center = new SFVec3f(new float[-7.738,35.43,-1.558]);
let HAnimSegment157 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment157.name = "r_hand";
HAnimSegment157.DEF = "hanim_r_hand";
let Transform158 = browser.currentScene.createNode("Transform");
Transform158.translation = new SFVec3f(new float[-7.738,35.43,-1.558]);
...
ImageTexture162.USE = "NoTextureAtlas";
...
.4382,0.2727,0.4496,0.2874,0.4405,0.1356,0.4327,0.133,0.4126,0.1318,0.4062,0.2758,0.4563,0.1279,0.4134,0.2905,0.4451,0.1841,0.4441,0.173,0.4428,0.2336,0.4239,0.232,0.4181,0.2553,0.4468,0.1634,0.4452,0.1514,0.4479,0.2509,0.4359,0.1412,0.4529,0.1367,0.4599,0.2432,0.4272,0.2531,0.4616,0.2586,0.4664,0.1365,0.476,0.1366,0.4681,0.241,0.4558,0.2368,0.4586,0.1496,0.4794,0.1502,0.4711,0.1836,0.4592,0.1761,0.4601,0.2253,0.4494,0.1684,0.463,0.2261,0.4579,0.1588,0.4664,0.1796,0.4752,0.1737,0.474,0.1709,0.4735,0.1663,0.4756,0.162,0.4762,0.1602,0.4819,0.1617,0.4895,0.2206,0.4327,0.2187,0.4259,0.2227,0.4378,0.2131,0.456,0.2115,0.4515,0.2119,0.4457,0.2094,0.4437,0.2061,0.4411,0.2017,0.4524,0.1652,0.3951,0.1534,0.3946,0.1894,0.4248,0.1835,0.4079,0.1786,0.3986,0.1411,0.3973,0.1285,0.4039,0.1298,0.4342,0.193,0.4435,0.1346,0.4831,0.1474,0.4881,0.1921,0.4603,0.1832,0.4783,0.1721,0.4818,0.1111,0.4765,0.1087,0.4729,0.1098,0.4688,0.1162,0.467,0.1174,0.4712,0.114,0.4745,0.2355,0.48,0.239,0.4794,0.241,0.4768,0.2455,0.4762]);
IndexedFaceSet163.texCoord = TextureCoordinate165;

Shape159.geometry = IndexedFaceSet163;

Transform158.children = new MFNode();

Transform158.children[0] = Shape159;
...
ImageTexture172.USE = "NoTextureAtlas";
...
HAnimJoint176.name = "skullbase";
HAnimJoint176.DEF = "hanim_skullbase";
HAnimJoint176.center = new SFVec3f(new float[0,37.060001,-1.409]);
let HAnimSegment177 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment177.name = "skull";
HAnimSegment177.DEF = "hanim_skull";
let Transform178 = browser.currentScene.createNode("Transform");
Transform178.translation = new SFVec3f(new float[0,37.060001,-1.409]);
...
ImageTexture182.USE = "NoTextureAtlas";
...
HAnimJoint96.children[3] = HAnimJoint166;

HAnimJoint6.children[3] = HAnimJoint96;
...
HAnimJoint186.USE = "hanim_humanoid_root";
HAnimHumanoid5.joints[1] = HAnimJoint186;

let HAnimJoint187 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint187.USE = "hanim_sacroiliac";
HAnimHumanoid5.joints[2] = HAnimJoint187;

let HAnimJoint188 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint188.USE = "hanim_vl5";
HAnimHumanoid5.joints[3] = HAnimJoint188;

let HAnimJoint189 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint189.USE = "hanim_skullbase";
HAnimHumanoid5.joints[4] = HAnimJoint189;

let HAnimJoint190 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint190.USE = "hanim_l_ankle";
HAnimHumanoid5.joints[5] = HAnimJoint190;

let HAnimJoint191 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint191.USE = "hanim_r_ankle";
HAnimHumanoid5.joints[6] = HAnimJoint191;

let HAnimJoint192 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint192.USE = "hanim_l_elbow";
HAnimHumanoid5.joints[7] = HAnimJoint192;

let HAnimJoint193 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint193.USE = "hanim_r_elbow";
HAnimHumanoid5.joints[8] = HAnimJoint193;

let HAnimJoint194 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint194.USE = "hanim_l_hip";
HAnimHumanoid5.joints[9] = HAnimJoint194;

let HAnimJoint195 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint195.USE = "hanim_r_hip";
HAnimHumanoid5.joints[10] = HAnimJoint195;

let HAnimJoint196 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint196.USE = "hanim_l_knee";
HAnimHumanoid5.joints[11] = HAnimJoint196;

let HAnimJoint197 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint197.USE = "hanim_r_knee";
HAnimHumanoid5.joints[12] = HAnimJoint197;

let HAnimJoint198 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint198.USE = "hanim_l_midtarsal";
HAnimHumanoid5.joints[13] = HAnimJoint198;

let HAnimJoint199 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint199.USE = "hanim_r_midtarsal";
HAnimHumanoid5.joints[14] = HAnimJoint199;

let HAnimJoint200 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint200.USE = "hanim_l_shoulder";
HAnimHumanoid5.joints[15] = HAnimJoint200;

let HAnimJoint201 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint201.USE = "hanim_r_shoulder";
HAnimHumanoid5.joints[16] = HAnimJoint201;

let HAnimJoint202 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint202.USE = "hanim_l_wrist";
HAnimHumanoid5.joints[17] = HAnimJoint202;

let HAnimJoint203 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint203.USE = "hanim_r_wrist";
HAnimHumanoid5.joints[18] = HAnimJoint203;

let HAnimSegment204 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment204.USE = "hanim_sacrum";
HAnimHumanoid5.segments[19] = HAnimSegment204;

let HAnimSegment205 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment205.USE = "hanim_pelvis";
HAnimHumanoid5.segments[20] = HAnimSegment205;

let HAnimSegment206 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment206.USE = "hanim_l5";
HAnimHumanoid5.segments[21] = HAnimSegment206;

let HAnimSegment207 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment207.USE = "hanim_skull";
HAnimHumanoid5.segments[22] = HAnimSegment207;

let HAnimSegment208 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment208.USE = "hanim_l_calf";
HAnimHumanoid5.segments[23] = HAnimSegment208;

let HAnimSegment209 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment209.USE = "hanim_r_calf";
HAnimHumanoid5.segments[24] = HAnimSegment209;

let HAnimSegment210 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment210.USE = "hanim_l_forearm";
HAnimHumanoid5.segments[25] = HAnimSegment210;

let HAnimSegment211 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment211.USE = "hanim_r_forearm";
HAnimHumanoid5.segments[26] = HAnimSegment211;

let HAnimSegment212 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment212.USE = "hanim_l_hand";
HAnimHumanoid5.segments[27] = HAnimSegment212;

let HAnimSegment213 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment213.USE = "hanim_r_hand";
HAnimHumanoid5.segments[28] = HAnimSegment213;

let HAnimSegment214 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment214.USE = "hanim_l_hindfoot";
HAnimHumanoid5.segments[29] = HAnimSegment214;

let HAnimSegment215 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment215.USE = "hanim_r_hindfoot";
HAnimHumanoid5.segments[30] = HAnimSegment215;

let HAnimSegment216 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment216.USE = "hanim_l_middistal";
HAnimHumanoid5.segments[31] = HAnimSegment216;

let HAnimSegment217 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment217.USE = "hanim_r_middistal";
HAnimHumanoid5.segments[32] = HAnimSegment217;

let HAnimSegment218 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment218.USE = "hanim_l_thigh";
HAnimHumanoid5.segments[33] = HAnimSegment218;

let HAnimSegment219 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment219.USE = "hanim_r_thigh";
HAnimHumanoid5.segments[34] = HAnimSegment219;

let HAnimSegment220 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment220.USE = "hanim_l_upperarm";
HAnimHumanoid5.segments[35] = HAnimSegment220;

let HAnimSegment221 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment221.USE = "hanim_r_upperarm";
HAnimHumanoid5.segments[36] = HAnimSegment221;

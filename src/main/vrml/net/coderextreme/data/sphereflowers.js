...
var ProtoInstance6 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group()
          .addChild(new ExternProtoDeclare().setName("FlowerProto").setUrl(java.newArray("java.lang.String", ["../data/flowerproto.json#FlowerProto"]))
          ...
          .addChild(new Sound().setMaxBack(100).setMaxFront(100).setMinBack(20).setMinFront(20)
            .setSource(new AudioClip().setDEF("AudioClip").setDescription("Chandubabamusic #1").setUrl(java.newArray("java.lang.String", ["../resources/chandubabamusic1.wav"]))))

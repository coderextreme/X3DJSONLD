...
HAnimSegment8.name = "l_wrist";
HAnimSegment8.DEF = "hanim_l_wrist";
...
HAnimJoint29.name = "l_midcarpal_2";
HAnimJoint29.DEF = "hanim_l_midcarpal_2";
HAnimJoint29.center = new SFVec3f(new float[0.1,0.1,0]);
let HAnimSegment30 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment30.name = "l_trapezoid";
HAnimSegment30.DEF = "hanim_l_trapezoid";
...
HAnimJoint73.DEF = "hanim_l_carpometacarpal_2";
HAnimJoint73.center = new SFVec3f(new float[0.1,0.2,0]);
let HAnimSegment74 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment74.name = "l_metacarpal_2";
HAnimSegment74.DEF = "hanim_l_metacarpal_2";
...
HAnimJoint82.DEF = "hanim_l_metacarpophalangeal_2";
HAnimJoint82.center = new SFVec3f(new float[0.15,0.5,0]);
let HAnimSegment83 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment83.name = "l_carpal_proximal_phalanx_2";
HAnimSegment83.DEF = "hanim_l_carpal_proximal_phalanx_2";
...
HAnimJoint91.name = "l_carpal_proximal_interphalangeal_2";
HAnimJoint91.DEF = "hanim_l_carpal_proximal_interphalangeal_2";
HAnimJoint91.center = new SFVec3f(new float[0.2,0.7,0]);
let HAnimSegment92 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment92.name = "l_carpal_middle_phalanx_2";
HAnimSegment92.DEF = "hanim_l_carpal_middle_phalanx_2";
...
HAnimJoint100.DEF = "hanim_l_carpal_distal_interphalangeal_2";
HAnimJoint100.center = new SFVec3f(new float[0.24,0.87,0]);
let HAnimSegment101 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment101.name = "l_carpal_distal_phalanx_2";
HAnimSegment101.DEF = "hanim_l_carpal_distal_phalanx_2";
...
IndexedLineSet107.DEF = "fingertip_l_carpal_distal_interphalangeal_2";
...
HAnimJoint109.name = "l_midcarpal_3";
HAnimJoint109.DEF = "hanim_l_midcarpal_3";
HAnimJoint109.center = new SFVec3f(new float[0,0.07,0]);
let HAnimSegment110 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment110.name = "l_capitate";
HAnimSegment110.DEF = "hanim_l_capitate";
...
HAnimJoint118.name = "l_carpometacarpal_3";
HAnimJoint118.DEF = "hanim_l_carpometacarpal_3";
HAnimJoint118.center = new SFVec3f(new float[0,0.2,0]);
let HAnimSegment119 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment119.name = "l_metacarpal_3";
HAnimSegment119.DEF = "hanim_l_metacarpal_3";
...
HAnimJoint127.name = "l_metacarpophalangeal_3";
HAnimJoint127.DEF = "hanim_l_metacarpophalangeal_3";
HAnimJoint127.center = new SFVec3f(new float[0.03,0.5,0]);
let HAnimSegment128 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment128.name = "l_carpal_proximal_phalanx_3";
HAnimSegment128.DEF = "hanim_l_carpal_proximal_phalanx_3";
...
HAnimJoint136.name = "l_carpal_proximal_interphalangeal_3";
HAnimJoint136.DEF = "hanim_l_carpal_proximal_interphalangeal_3";
HAnimJoint136.center = new SFVec3f(new float[0.05,0.75,0]);
let HAnimSegment137 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment137.name = "l_carpal_middle_phalanx_3";
HAnimSegment137.DEF = "hanim_l_carpal_middle_phalanx_3";
...
HAnimJoint145.name = "l_carpal_distal_interphalangeal_3";
HAnimJoint145.DEF = "hanim_l_carpal_distal_interphalangeal_3";
HAnimJoint145.center = new SFVec3f(new float[0.08,0.96,0]);
let HAnimSegment146 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment146.name = "l_carpal_distal_phalanx_3";
HAnimSegment146.DEF = "hanim_l_carpal_distal_phalanx_3";
...
IndexedLineSet152.DEF = "fingertip_l_carpal_distal_interphalangeal_3";
...
HAnimJoint154.name = "l_midcarpal_4_5";
HAnimJoint154.DEF = "hanim_l_midcarpal_4_5";
HAnimJoint154.center = new SFVec3f(new float[-0.1,0.1,0]);
let HAnimSegment155 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment155.name = "l_hamate";
HAnimSegment155.DEF = "hanim_l_hamate";
...
HAnimJoint168.name = "l_carpometacarpal_4";
HAnimJoint168.DEF = "hanim_l_carpometacarpal_4";
HAnimJoint168.center = new SFVec3f(new float[-0.1,0.2,0]);
let HAnimSegment169 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment169.name = "l_metacarpal_4";
HAnimSegment169.DEF = "hanim_l_metacarpal_4";
...
HAnimJoint177.name = "l_metacarpophalangeal_4";
HAnimJoint177.DEF = "hanim_l_metacarpophalangeal_4";
HAnimJoint177.center = new SFVec3f(new float[-0.1,0.47,0]);
let HAnimSegment178 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment178.name = "l_carpal_proximal_phalanx_4";
HAnimSegment178.DEF = "hanim_l_carpal_proximal_phalanx_4";
...
HAnimJoint186.name = "l_carpal_proximal_interphalangeal_4";
HAnimJoint186.DEF = "hanim_l_carpal_proximal_interphalangeal_4";
HAnimJoint186.center = new SFVec3f(new float[-0.1,0.7,0]);
let HAnimSegment187 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment187.name = "l_carpal_middle_phalanx_4";
HAnimSegment187.DEF = "hanim_l_carpal_middle_phalanx_4";
...
HAnimJoint195.name = "l_carpal_distal_interphalangeal_4";
HAnimJoint195.DEF = "hanim_l_carpal_distal_interphalangeal_4";
HAnimJoint195.center = new SFVec3f(new float[-0.1,0.93,0]);
let HAnimSegment196 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment196.name = "l_carpal_distal_phalanx_4";
HAnimSegment196.DEF = "hanim_l_carpal_distal_phalanx_4";
...
IndexedLineSet202.DEF = "fingertip_l_carpal_distal_interphalangeal_4";
...
HAnimJoint204.name = "l_carpometacarpal_5";
HAnimJoint204.DEF = "hanim_l_carpometacarpal_5";
HAnimJoint204.center = new SFVec3f(new float[-0.15,0.17,0]);
let HAnimSegment205 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment205.name = "l_metacarpal_5";
HAnimSegment205.DEF = "hanim_l_metacarpal_5";
...
HAnimJoint213.name = "l_metacarpophalangeal_5";
HAnimJoint213.DEF = "hanim_l_metacarpophalangeal_5";
HAnimJoint213.center = new SFVec3f(new float[-0.2,0.4,0]);
let HAnimSegment214 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment214.name = "l_carpal_proximal_phalanx_5";
HAnimSegment214.DEF = "hanim_l_carpal_proximal_phalanx_5";
...
HAnimJoint222.name = "l_carpal_proximal_interphalangeal_5";
HAnimJoint222.DEF = "hanim_l_carpal_proximal_interphalangeal_5";
HAnimJoint222.center = new SFVec3f(new float[-0.23,0.63,0]);
let HAnimSegment223 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment223.name = "l_carpal_middle_phalanx_5";
HAnimSegment223.DEF = "hanim_l_carpal_middle_phalanx_5";
...
HAnimJoint231.name = "l_carpal_distal_interphalangeal_5";
HAnimJoint231.DEF = "hanim_l_carpal_distal_interphalangeal_5";
HAnimJoint231.center = new SFVec3f(new float[-0.25,0.79,0]);
let HAnimSegment232 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment232.name = "l_carpal_distal_phalanx_5";
HAnimSegment232.DEF = "hanim_l_carpal_distal_phalanx_5";
...
IndexedLineSet238.DEF = "fingertip_l_carpal_distal_interphalangeal_5";

...
scene.addMetaData("title", "personal.x3d");
scene.addMetaData("identifier", "https://someAddress/somePath/personal.x3d");
scene.addMetaData("description", "John's Portfolio");
scene.addMetaData("generator", "vim and X3D-Edit, https://savage.nps.edu/X3D-Edit");
await browser .loadComponents (scene);
let Viewpoint7 = browser.currentScene.createNode("Viewpoint");
Viewpoint7.description = "Tour Views";
Viewpoint7.position = new X3D.SFVec3f([0,0,12]);
browser.currentScene.children = new X3D.MFNode();

browser.currentScene.children[0] = Viewpoint7;

let Switch8 = browser.currentScene.createNode("Switch");
Switch8.DEF = "SceneSwitcher";
...
Inline9.url = new X3D.MFString([new X3D.SFString("../data/force-tidy.x3d"), new X3D.SFString("https://coderextreme.net/X3DJSONLD/src/main/data/force-tidy.x3d")]);
Switch8YYY.children = new X3D.MFNode();

Switch8ZZZ.children[0] = Inline9;

browser.currentScene.children[1] = Switch8;

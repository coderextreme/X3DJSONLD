...
let Normal37 = browser.currentScene.createNode("Normal");
...
let Normal49 = browser.currentScene.createNode("Normal");
...
let Normal55 = browser.currentScene.createNode("Normal");
...
let Normal67 = browser.currentScene.createNode("Normal");
...
let Normal73 = browser.currentScene.createNode("Normal");
...
let Inline75 = browser.currentScene.createNode("Inline");
...
//Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel)
let Inline83 = browser.currentScene.createNode("Inline");
...
let Cylinder87 = browser.currentScene.createNode("Cylinder");
Cylinder87.height = 1;
Cylinder87.radius = 4;
...
let Text115 = browser.currentScene.createNode("Text");
...
let Viewpoint122 = browser.currentScene.createNode("Viewpoint");
...
browser.currentScene.children[0] = Transform18;

let TimeSensor129 = browser.currentScene.createNode("TimeSensor");
TimeSensor129.DEF = "WheelUp";
TimeSensor129.cycleInterval = 8;
browser.currentScene.children[1] = TimeSensor129;
...
browser.currentScene.children[2] = OrientationInterpolator130;
...
browser.currentScene.children[3] = ROUTE131;
...
browser.currentScene.children[4] = ROUTE132;
...
browser.currentScene.children[7] = OrientationInterpolator135;

let ROUTE136 = browser.currentScene.createNode("ROUTE");
ROUTE136.fromField = "touchTime";
ROUTE136.fromNode = "TouchSensorDown";
ROUTE136.toField = "set_startTime";
ROUTE136.toNode = "WheelDown";
browser.currentScene.children[8] = ROUTE136;
...
browser.currentScene.children[9] = ROUTE137;
...
browser.currentScene.children[10] = ROUTE138;

//Animation commands for Rear Right Wheel Starts
let TimeSensor139 = browser.currentScene.createNode("TimeSensor");
TimeSensor139.DEF = "RRearUp1";
TimeSensor139.cycleInterval = 8;
browser.currentScene.children[11] = TimeSensor139;

let TimeSensor140 = browser.currentScene.createNode("TimeSensor");
TimeSensor140.DEF = "RRearDown1";
TimeSensor140.cycleInterval = 8;
browser.currentScene.children[12] = TimeSensor140;
...
browser.currentScene.children[13] = OrientationInterpolator141;
...
browser.currentScene.children[14] = OrientationInterpolator142;

let ROUTE143 = browser.currentScene.createNode("ROUTE");
ROUTE143.fromField = "touchTime";
ROUTE143.fromNode = "TouchSensorDown";
ROUTE143.toField = "set_startTime";
ROUTE143.toNode = "RRearDown1";
browser.currentScene.children[15] = ROUTE143;

let ROUTE144 = browser.currentScene.createNode("ROUTE");
ROUTE144.fromField = "touchTime";
ROUTE144.fromNode = "TouchSensorUp";
ROUTE144.toField = "set_startTime";
ROUTE144.toNode = "RRearUp1";
browser.currentScene.children[16] = ROUTE144;

let ROUTE145 = browser.currentScene.createNode("ROUTE");
...
browser.currentScene.children[17] = ROUTE145;
...
browser.currentScene.children[18] = ROUTE146;

let ROUTE147 = browser.currentScene.createNode("ROUTE");
...
browser.currentScene.children[19] = ROUTE147;

let ROUTE148 = browser.currentScene.createNode("ROUTE");
...
browser.currentScene.children[20] = ROUTE148;

//Animation commands for Rear Left Wheel
let TimeSensor149 = browser.currentScene.createNode("TimeSensor");
TimeSensor149.DEF = "LRearUp1";
TimeSensor149.cycleInterval = 8;
browser.currentScene.children[21] = TimeSensor149;

let TimeSensor150 = browser.currentScene.createNode("TimeSensor");
TimeSensor150.DEF = "LRearDown1";
TimeSensor150.cycleInterval = 8;
browser.currentScene.children[22] = TimeSensor150;
...
browser.currentScene.children[23] = OrientationInterpolator151;
...
browser.currentScene.children[24] = OrientationInterpolator152;
...
browser.currentScene.children[25] = ROUTE153;
...
browser.currentScene.children[26] = ROUTE154;
...
browser.currentScene.children[27] = ROUTE155;
...
browser.currentScene.children[28] = ROUTE156;
...
browser.currentScene.children[29] = ROUTE157;
...
browser.currentScene.children[30] = ROUTE158;

let Background159 = browser.currentScene.createNode("Background");
...
browser.currentScene.children[31] = Background159;
...
browser.currentScene.children[32] = Transform160;
...
browser.currentScene.children[33] = Transform162;
...
browser.currentScene.children[34] = Transform164;
...
browser.currentScene.children[35] = Transform166;
...
browser.currentScene.children[36] = Transform168;
...
browser.currentScene.children[37] = Transform170;
...
browser.currentScene.children[38] = Transform172;
...
browser.currentScene.children[39] = Transform174;
...
let Inline177 = browser.currentScene.createNode("Inline");
Inline177.USE = "Amraam";
Transform176.children = new MFNode();

Transform176.children[0] = Inline177;

browser.currentScene.children[40] = Transform176;
...
let Inline179 = browser.currentScene.createNode("Inline");
Inline179.USE = "Amraam";
Transform178.children = new MFNode();

Transform178.children[0] = Inline179;

browser.currentScene.children[41] = Transform178;
...
let Inline181 = browser.currentScene.createNode("Inline");
...
browser.currentScene.children[42] = Transform180;
...
let Inline183 = browser.currentScene.createNode("Inline");
Inline183.USE = "Sidewinder";
Transform182.children = new MFNode();

Transform182.children[0] = Inline183;

browser.currentScene.children[43] = Transform182;
...
let Inline185 = browser.currentScene.createNode("Inline");
...
browser.currentScene.children[44] = Transform184;
...
let Inline187 = browser.currentScene.createNode("Inline");
Inline187.USE = "FuelTankHolder";
Transform186.children = new MFNode();

Transform186.children[0] = Inline187;

browser.currentScene.children[45] = Transform186;
...
let Inline189 = browser.currentScene.createNode("Inline");
...
browser.currentScene.children[46] = Transform188;
...
let Inline191 = browser.currentScene.createNode("Inline");
Inline191.USE = "FuelTank";
Transform190.children = new MFNode();

Transform190.children[0] = Inline191;

browser.currentScene.children[47] = Transform190;
...
let Box194 = browser.currentScene.createNode("Box");
...
browser.currentScene.children[48] = Transform192;
...
browser.currentScene.children[49] = Transform197;

let TimeSensor199 = browser.currentScene.createNode("TimeSensor");
TimeSensor199.DEF = "FireClock";
TimeSensor199.cycleInterval = 8;
browser.currentScene.children[50] = TimeSensor199;

let PositionInterpolator200 = browser.currentScene.createNode("PositionInterpolator");
...
browser.currentScene.children[51] = PositionInterpolator200;
...
browser.currentScene.children[52] = ROUTE201;
...
browser.currentScene.children[53] = ROUTE202;
...
browser.currentScene.children[54] = ROUTE203;
...
browser.currentScene.children[55] = Viewpoint204;
...
browser.currentScene.children[56] = ROUTE205;

...
<ProtoBody><Transform bboxCenter="0 0 0" bboxSize="-1 -1 -1"><Shape bboxCenter="0 0 0" bboxSize="-1 -1 -1"><Appearance><Material transparency="0.200000002980232" diffuseColor="0.5 0 1"></Material>
</Appearance>
...
<ProtoBody><Transform bboxCenter="0 0 0" bboxSize="-1 -1 -1"><Shape bboxCenter="0 0 0" bboxSize="-1 -1 -1"><Appearance><Material transparency="0.200000002980232" diffuseColor="1 1 0"></Material>
</Appearance>
<Box containerField="geometry" size="0.699999988079071 0.699999988079071 0.699999988079071" solid="true"></Box>
</Shape>
<IS><connect nodeField="translation" protoField="pos"></connect>
</IS>
</Transform>
...
<ProtoBody><Transform bboxCenter="0 0 0" bboxSize="-1 -1 -1"><Shape bboxCenter="0 0 0" bboxSize="-1 -1 -1"><Appearance><Material diffuseColor="1 1 0"></Material>
</Appearance>
...
Shape47.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape47.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform87.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform87.bboxSize = new SFVec3f(new float[-1,-1,-1]);
let Inline88 = browser.currentScene.createNode("Inline");
Inline88.url = new MFString(new java.lang.String["t.wrl"]);
Inline88.bboxCenter = new SFVec3f(new float[0,0,0]);
Inline88.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor89.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor89.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor92.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor92.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor95.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor95.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor98.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor98.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor101.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor101.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor104.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor104.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor107.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor107.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor110.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor110.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor113.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor113.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor116.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor116.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor119.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor119.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor122.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor122.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor125.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor125.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor128.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor128.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor131.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor131.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor134.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor134.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor137.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor137.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor140.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor140.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor143.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor143.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor146.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor146.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor149.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor149.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor152.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor152.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor155.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor155.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor158.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor158.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor161.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor161.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor164.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor164.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor167.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor167.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor170.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor170.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor173.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor173.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor176.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor176.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor179.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor179.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor182.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor182.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor185.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor185.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor188.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor188.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor191.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor191.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor194.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor194.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor197.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor197.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor200.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor200.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor203.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor203.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor206.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor206.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor209.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor209.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor212.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor212.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor215.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor215.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor218.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor218.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor221.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor221.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor224.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor224.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor227.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor227.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor230.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor230.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor233.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor233.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor236.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor236.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor239.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor239.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Anchor242.bboxCenter = new SFVec3f(new float[0,0,0]);
Anchor242.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Shape250.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape250.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Shape255.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape255.bboxSize = new SFVec3f(new float[-1,-1,-1]);

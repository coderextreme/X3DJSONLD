...
WorldInfo2.title = "KoreanCharacter12Sun.x3d";
...
HAnimHumanoid5.name = "Sun";
HAnimHumanoid5.DEF = "hanim_Sun";
...
MetadataString7.value = new MFString(new java.lang.String["Chul Hee Jung and Myeong Won Lee"]);
...
HAnimJoint13.center = new SFVec3f(new float[0,29.860001,-0.4567]);
...
Transform15.translation = new SFVec3f(new float[0,29.860001,-0.4567]);
...
ImageTexture19.DEF = "SunTextureAtlas";
ImageTexture19.url = new MFString(new java.lang.String["images/Sun.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Sun.png"]);
...
HAnimJoint23.center = new SFVec3f(new float[2.955,28.940001,-0.5218]);
...
Transform25.translation = new SFVec3f(new float[2.955,28.940001,-0.5218]);
...
HAnimJoint33.center = new SFVec3f(new float[2.948,16.459999,-0.5275]);
...
Transform35.translation = new SFVec3f(new float[2.948,16.459999,-0.5275]);
...
HAnimJoint43.DEF = "hanim_l_talocrural";
HAnimJoint43.center = new SFVec3f(new float[2.839,3.899,-0.4116]);
HAnimJoint43.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment44 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment44.name = "l_talus";
HAnimSegment44.DEF = "hanim_l_talus";
let Transform45 = browser.currentScene.createNode("Transform");
Transform45.translation = new SFVec3f(new float[2.839,3.899,-0.4116]);
...
ImageTexture49.USE = "SunTextureAtlas";
...
HAnimJoint53.name = "l_metatarsophalangeal_2";
HAnimJoint53.DEF = "hanim_l_metatarsophalangeal_2";
HAnimJoint53.center = new SFVec3f(new float[2.839,3.312,1.078]);
HAnimJoint53.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment54 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment54.name = "l_tarsal_proximal_phalanx_2";
HAnimSegment54.DEF = "hanim_l_tarsal_proximal_phalanx_2";
let Transform55 = browser.currentScene.createNode("Transform");
Transform55.translation = new SFVec3f(new float[2.839,3.312,1.078]);
...
ImageTexture59.USE = "SunTextureAtlas";
...
HAnimJoint63.name = "r_hip";
HAnimJoint63.DEF = "hanim_r_hip";
HAnimJoint63.center = new SFVec3f(new float[-2.955,28.940001,-0.5218]);
HAnimJoint63.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment64 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment64.name = "r_thigh";
HAnimSegment64.DEF = "hanim_r_thigh";
let Transform65 = browser.currentScene.createNode("Transform");
Transform65.translation = new SFVec3f(new float[-2.955,28.940001,-0.5218]);
...
ImageTexture69.USE = "SunTextureAtlas";
...
HAnimJoint73.DEF = "hanim_r_knee";
HAnimJoint73.center = new SFVec3f(new float[-2.948,16.459999,-0.5275]);
HAnimJoint73.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment74 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment74.name = "r_calf";
HAnimSegment74.DEF = "hanim_r_calf";
let Transform75 = browser.currentScene.createNode("Transform");
Transform75.translation = new SFVec3f(new float[-2.948,16.459999,-0.5275]);
...
ImageTexture79.USE = "SunTextureAtlas";
...
HAnimJoint83.name = "r_talocrural";
HAnimJoint83.DEF = "hanim_r_talocrural";
HAnimJoint83.center = new SFVec3f(new float[-2.839,3.899,-0.4116]);
HAnimJoint83.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment84 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment84.name = "r_talus";
HAnimSegment84.DEF = "hanim_r_talus";
let Transform85 = browser.currentScene.createNode("Transform");
Transform85.translation = new SFVec3f(new float[-2.839,3.899,-0.4116]);
...
ImageTexture89.USE = "SunTextureAtlas";
...
HAnimJoint93.name = "r_metatarsophalangeal_2";
HAnimJoint93.DEF = "hanim_r_metatarsophalangeal_2";
HAnimJoint93.center = new SFVec3f(new float[-2.839,3.312,1.078]);
HAnimJoint93.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment94 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment94.name = "r_tarsal_proximal_phalanx_2";
HAnimSegment94.DEF = "hanim_r_tarsal_proximal_phalanx_2";
let Transform95 = browser.currentScene.createNode("Transform");
Transform95.translation = new SFVec3f(new float[-2.839,3.312,1.078]);
...
ImageTexture99.USE = "SunTextureAtlas";
...
Coordinate101.point = new MFVec3f(new float[-1.388,-0.7441,0.9353,0,-0.5418,1.142,0,-1.042,2.002,-1.356,-1.234,1.823,-1.286,-1.394,3.004,0,-1.212,3.154,0,-1.708,3.962,-1.162,-1.8,3.64,-1.65,-1.868,2.671,-1.806,-1.859,1.688,-1.217,-2.657,3.79,0,-2.605,4.159,-1.729,-2.767,2.676,-1.984,-2.747,-0.4534,-1.847,-1.879,-0.4111,-1.91,-1.914,0.8074,-2.006,-2.83,0.7644,-1.895,-2.791,1.697,1.388,-0.7441,0.9353,1.356,-1.234,1.823,1.286,-1.394,3.004,1.162,-1.8,3.64,1.91,-1.914,0.8074,1.806,-1.859,1.688,1.217,-2.657,3.79,1.729,-2.767,2.676,2.006,-2.83,0.7644,1.847,-1.879,-0.4111,1.984,-2.747,-0.4534,1.65,-1.868,2.671,1.895,-2.791,1.697,0,-3.18,0.7644,-2.006,-3.18,0.7644,-1.729,-3.137,2.71,-1.217,-3.069,3.793,0,-2.997,4.162,0,-3.18,-0.4554,-1.99,-3.18,-0.4554,1.729,-3.137,2.71,2.006,-3.18,0.7644,1.217,-3.069,3.793,1.99,-3.18,-0.4554,0,-3.141,2.71,-1.895,-3.164,1.686,1.895,-3.164,1.686,0,-3.164,1.686,-1.486,-0.5175,-1.502,-1.788,-1.797,-1.502,-1.928,-2.585,-1.502,0.0009,0.1637,0.361,-1.326,-0.0186,0.0033,1.486,-0.5175,-1.502,1.788,-1.797,-1.502,1.928,-2.585,-1.502,1.331,-0.0112,0.0089,0,-3.164,-1.502,-1.935,-3.164,-1.502,1.934,-3.164,-1.502,-1.153,-0.3082,-2.015,-1.192,-1.388,-2.379,-1.307,-1.876,-2.363,-1.307,-2.129,-2.356,-0.0004,-2.129,-2.356,1.306,-2.129,-2.356,1.306,-1.876,-2.362,1.191,-1.388,-2.378,1.152,-0.3071,-2.014,1.027,0.2573,-1.173,0.0025,0.3479,-0.8576,-1.023,0.2519,-1.179]);
IndexedFaceSet100.coord = Coordinate101;

let TextureCoordinate102 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate102.point = new MFVec2f(new float[0.1645,0.2682,0.119,0.2656,0.119,0.2333,0.1642,0.2355,0.1585,0.1986,0.119,0.1964,0.119,0.1664,0.1572,0.175,0.1786,0.2029,0.1893,0.2321,0.2954,0.0497,0.2633,0.0308,0.2607,0.0443,0.2924,0.0621,0.2275,0.0325,0.2299,0.0183,0.1375,0.0244,0.1392,0.0478,0.1726,0.0473,0.1726,0.0227,0.1726,0.0066,0.1366,0.0058,0.2807,0.084,0.2512,0.067,0.2227,0.0576,0.2601,0.0398,0.2197,0.2888,0.2029,0.2547,0.1996,0.0258,0.2,0.0107,0.1962,0.0514,0.0735,0.2682,0.0739,0.2355,0.0796,0.1986,0.0809,0.175,0.0352,0.2547,0.0488,0.232,0.2918,0.0575,0.2269,0.0279,0.0183,0.2887,0.0595,0.2029,0.9339,0.9522,0.9339,0.9254,0.9339,0.9014,0.9339,0.8697,0.9832,0.9254,0.9789,0.9522,0.9339,0.9904,0.9656,0.9806,0.9857,0.8697,0.9861,0.9014,0.8846,0.9254,0.8818,0.9014,0.9023,0.9806,0.889,0.9522,0.8822,0.8697,0.1368,0.0198,0.172,0.0181,0.1989,0.0212,0.1959,0.3397,0.233,0.3209,0.1086,0.051,0.1073,0.0299,0.1066,0.0253,0.1188,0.3009,0.1607,0.3056,0.042,0.3397,0.0049,0.3208,0.0774,0.3058,0.9339,0.8425,0.9842,0.8425,0.1053,0.0075,0.8836,0.8425,0.1925,0.3379,0.0929,0.0472,0.0926,0.0413,0.0916,0.0386,0.0732,0.0453,0.0548,0.052,0.0558,0.0548,0.0593,0.0595,0.0051,0.3217,0.0786,0.3181,0.1161,0.313,0.1637,0.3136,0.8849,0.8425,0.9342,0.8425,0.9342,0.8153,0.8926,0.8153,0.9835,0.8425,0.9758,0.8153,0.1064,0.0254,0.1052,0.0081,0.09,0.0108,0.0907,0.0265,0.1052,0.0081,0.1064,0.0254,0.0907,0.0265,0.09,0.0108,0.1068,0.0747,0.1086,0.0517,0.0941,0.0542,0.0982,0.0753,0.1071,0.03,0.0934,0.041,0.1071,0.03,0.1086,0.0517,0.0941,0.0542,0.0934,0.041,0.1068,0.0747,0.0982,0.0754,0.0683,0.0723,0.0739,0.0833,0.0866,0.0821,0.097,0.0748,0.0943,0.0628]);
...
HAnimJoint13.children[2] = HAnimJoint63;

let HAnimJoint103 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint103.name = "sacroiliac";
HAnimJoint103.DEF = "hanim_sacroiliac";
HAnimJoint103.center = new SFVec3f(new float[0,29.860001,-0.4567]);
HAnimJoint103.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment104 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment104.name = "pelvis";
HAnimSegment104.DEF = "hanim_pelvis";
let Transform105 = browser.currentScene.createNode("Transform");
Transform105.translation = new SFVec3f(new float[0,29.860001,-0.4567]);
...
ImageTexture109.USE = "SunTextureAtlas";
...
HAnimJoint113.name = "l_shoulder";
HAnimJoint113.DEF = "hanim_l_shoulder";
HAnimJoint113.center = new SFVec3f(new float[6.077,45.880001,-1.319]);
HAnimJoint113.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment114 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment114.name = "l_upperarm";
HAnimSegment114.DEF = "hanim_l_upperarm";
let Transform115 = browser.currentScene.createNode("Transform");
Transform115.translation = new SFVec3f(new float[6.077,45.880001,-1.319]);
...
ImageTexture119.USE = "SunTextureAtlas";
...
HAnimJoint123.center = new SFVec3f(new float[7.076,38.529999,-1.385]);
HAnimJoint123.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment124 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment124.name = "l_forearm";
HAnimSegment124.DEF = "hanim_l_forearm";
let Transform125 = browser.currentScene.createNode("Transform");
Transform125.translation = new SFVec3f(new float[7.076,38.529999,-1.385]);
...
ImageTexture129.USE = "SunTextureAtlas";
...
HAnimJoint133.name = "l_radiocarpal";
HAnimJoint133.DEF = "hanim_l_radiocarpal";
HAnimJoint133.center = new SFVec3f(new float[6.946,30.889999,-1.308]);
HAnimJoint133.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment134 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment134.name = "l_carpal";
HAnimSegment134.DEF = "hanim_l_carpal";
let Transform135 = browser.currentScene.createNode("Transform");
Transform135.translation = new SFVec3f(new float[6.946,30.889999,-1.308]);
...
ImageTexture139.USE = "SunTextureAtlas";
...
HAnimJoint143.name = "r_shoulder";
HAnimJoint143.DEF = "hanim_r_shoulder";
HAnimJoint143.center = new SFVec3f(new float[-6.077,45.880001,-1.319]);
HAnimJoint143.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment144 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment144.name = "r_upperarm";
HAnimSegment144.DEF = "hanim_r_upperarm";
let Transform145 = browser.currentScene.createNode("Transform");
Transform145.translation = new SFVec3f(new float[-6.077,45.880001,-1.319]);
...
ImageTexture149.USE = "SunTextureAtlas";
...
HAnimJoint153.center = new SFVec3f(new float[-7.076,38.529999,-1.385]);
HAnimJoint153.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment154 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment154.name = "r_forearm";
HAnimSegment154.DEF = "hanim_r_forearm";
let Transform155 = browser.currentScene.createNode("Transform");
Transform155.translation = new SFVec3f(new float[-7.076,38.529999,-1.385]);
...
ImageTexture159.USE = "SunTextureAtlas";
...
HAnimJoint163.name = "r_radiocarpal";
HAnimJoint163.DEF = "hanim_r_radiocarpal";
HAnimJoint163.center = new SFVec3f(new float[-6.946,30.889999,-1.308]);
HAnimJoint163.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment164 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment164.name = "r_carpal";
HAnimSegment164.DEF = "hanim_r_carpal";
let Transform165 = browser.currentScene.createNode("Transform");
Transform165.translation = new SFVec3f(new float[-6.946,30.889999,-1.308]);
...
ImageTexture169.USE = "SunTextureAtlas";
...
HAnimJoint153.children[1] = HAnimJoint163;

HAnimJoint143.children[1] = HAnimJoint153;

HAnimJoint103.children[2] = HAnimJoint143;

let HAnimJoint173 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint173.name = "vl5";
HAnimJoint173.DEF = "hanim_vl5";
HAnimJoint173.center = new SFVec3f(new float[0.05249,34.130001,-0.468]);
HAnimJoint173.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment174 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment174.name = "l5";
HAnimSegment174.DEF = "hanim_l5";
let Transform175 = browser.currentScene.createNode("Transform");
Transform175.translation = new SFVec3f(new float[0.05249,34.130001,-0.468]);
...
ImageTexture179.USE = "SunTextureAtlas";
...
HAnimJoint183.name = "skullbase";
HAnimJoint183.DEF = "hanim_skullbase";
HAnimJoint183.center = new SFVec3f(new float[0,51.25,-1.124]);
HAnimJoint183.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment184 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment184.name = "skull";
HAnimSegment184.DEF = "hanim_skull";
let Transform185 = browser.currentScene.createNode("Transform");
Transform185.translation = new SFVec3f(new float[0,51.25,-1.124]);
...
ImageTexture189.USE = "SunTextureAtlas";
...
HAnimJoint103.children[3] = HAnimJoint173;

HAnimJoint13.children[3] = HAnimJoint103;
...
HAnimJoint193.USE = "hanim_humanoid_root";
HAnimHumanoid5.joints[1] = HAnimJoint193;

let HAnimJoint194 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint194.USE = "hanim_sacroiliac";
HAnimHumanoid5.joints[2] = HAnimJoint194;

let HAnimJoint195 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint195.USE = "hanim_skullbase";
HAnimHumanoid5.joints[3] = HAnimJoint195;

let HAnimJoint196 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint196.USE = "hanim_vl5";
HAnimHumanoid5.joints[4] = HAnimJoint196;

let HAnimJoint197 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint197.USE = "hanim_l_elbow";
HAnimHumanoid5.joints[5] = HAnimJoint197;

let HAnimJoint198 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint198.USE = "hanim_r_elbow";
HAnimHumanoid5.joints[6] = HAnimJoint198;

let HAnimJoint199 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint199.USE = "hanim_l_hip";
HAnimHumanoid5.joints[7] = HAnimJoint199;

let HAnimJoint200 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint200.USE = "hanim_r_hip";
HAnimHumanoid5.joints[8] = HAnimJoint200;

let HAnimJoint201 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint201.USE = "hanim_l_knee";
HAnimHumanoid5.joints[9] = HAnimJoint201;

let HAnimJoint202 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint202.USE = "hanim_r_knee";
HAnimHumanoid5.joints[10] = HAnimJoint202;

let HAnimJoint203 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint203.USE = "hanim_l_metatarsophalangeal_2";
HAnimHumanoid5.joints[11] = HAnimJoint203;

let HAnimJoint204 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint204.USE = "hanim_r_metatarsophalangeal_2";
HAnimHumanoid5.joints[12] = HAnimJoint204;

let HAnimJoint205 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint205.USE = "hanim_l_radiocarpal";
HAnimHumanoid5.joints[13] = HAnimJoint205;

let HAnimJoint206 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint206.USE = "hanim_r_radiocarpal";
HAnimHumanoid5.joints[14] = HAnimJoint206;

let HAnimJoint207 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint207.USE = "hanim_l_shoulder";
HAnimHumanoid5.joints[15] = HAnimJoint207;

let HAnimJoint208 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint208.USE = "hanim_r_shoulder";
HAnimHumanoid5.joints[16] = HAnimJoint208;

let HAnimJoint209 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint209.USE = "hanim_l_talocrural";
HAnimHumanoid5.joints[17] = HAnimJoint209;

let HAnimJoint210 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint210.USE = "hanim_r_talocrural";
HAnimHumanoid5.joints[18] = HAnimJoint210;

let HAnimSegment211 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment211.USE = "hanim_l5";
HAnimHumanoid5.segments[19] = HAnimSegment211;

let HAnimSegment212 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment212.USE = "hanim_pelvis";
HAnimHumanoid5.segments[20] = HAnimSegment212;

let HAnimSegment213 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment213.USE = "hanim_sacrum";
HAnimHumanoid5.segments[21] = HAnimSegment213;

let HAnimSegment214 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment214.USE = "hanim_skull";
HAnimHumanoid5.segments[22] = HAnimSegment214;

let HAnimSegment215 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment215.USE = "hanim_l_calf";
HAnimHumanoid5.segments[23] = HAnimSegment215;

let HAnimSegment216 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment216.USE = "hanim_r_calf";
HAnimHumanoid5.segments[24] = HAnimSegment216;

let HAnimSegment217 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment217.USE = "hanim_l_carpal";
HAnimHumanoid5.segments[25] = HAnimSegment217;

let HAnimSegment218 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment218.USE = "hanim_r_carpal";
HAnimHumanoid5.segments[26] = HAnimSegment218;

let HAnimSegment219 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment219.USE = "hanim_l_forearm";
HAnimHumanoid5.segments[27] = HAnimSegment219;

let HAnimSegment220 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment220.USE = "hanim_r_forearm";
HAnimHumanoid5.segments[28] = HAnimSegment220;

let HAnimSegment221 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment221.USE = "hanim_l_talus";
HAnimHumanoid5.segments[29] = HAnimSegment221;

let HAnimSegment222 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment222.USE = "hanim_r_talus";
HAnimHumanoid5.segments[30] = HAnimSegment222;

let HAnimSegment223 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment223.USE = "hanim_l_tarsal_proximal_phalanx_2";
HAnimHumanoid5.segments[31] = HAnimSegment223;

let HAnimSegment224 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment224.USE = "hanim_r_tarsal_proximal_phalanx_2";
HAnimHumanoid5.segments[32] = HAnimSegment224;

let HAnimSegment225 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment225.USE = "hanim_l_thigh";
HAnimHumanoid5.segments[33] = HAnimSegment225;

let HAnimSegment226 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment226.USE = "hanim_r_thigh";
HAnimHumanoid5.segments[34] = HAnimSegment226;

let HAnimSegment227 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment227.USE = "hanim_l_upperarm";
HAnimHumanoid5.segments[35] = HAnimSegment227;

let HAnimSegment228 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment228.USE = "hanim_r_upperarm";
HAnimHumanoid5.segments[36] = HAnimSegment228;

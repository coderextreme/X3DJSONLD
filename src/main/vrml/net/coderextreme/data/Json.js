...
NavigationInfo5.type = ["EXAMINE","FLY","ANY"];
...
MetadataString9.value = ["Top-level root Metadata node beneath Scene needs to be one of '-children' in JSON encoding"];
...
Material15.diffuseColor = [0,1,1];
Material15.emissiveColor = [0.8,0,0];
...
Material20.emissiveColor = [0.6,0.19607843,0.8];
Appearance19.material = Material20;

Shape18.appearance = Appearance19;

IndexedLineSet21 = browser.currentScene.createNode("IndexedLineSet");
IndexedLineSet21.coordIndex = [0,1,2,3,4,0];
//Coordinate 3-tuple point count: 6
Coordinate22 = browser.currentScene.createNode("Coordinate");
Coordinate22.point = [0,1.5,0,2,1.5,0,2,1.5,-2,-2,1.5,-2,-2,1.5,0,0,1.5,0];
...
PositionInterpolator23.key = [0,0.125,0.375,0.625,0.875,1];
PositionInterpolator23.keyValue = [0,1.5,0,2,1.5,0,2,1.5,-2,-2,1.5,-2,-2,1.5,0,0,1.5,0];
...
Text31.string = ["X3D Java","SAI Library","X3DJSAIL"];
...
MetadataString33.value = ["MFString example C, backslash-escaped quotes: He said, \"Immel did it!\""];
MetadataSet32.value = [];
...
OrientationInterpolator39.key = [0,0.5,1];
OrientationInterpolator39.keyValue = [0,1,0,4.712389,0,1,0,0,0,1,0,1.5707964];
...
ColorInterpolator48.key = [0,0.5,1];
ColorInterpolator48.keyValue = [0.9411765,1,1,0.29411766,0,0.50980395,0.9411765,1,1];
...
Material58.diffuseColor = [0.282435,0.085159,0.134462];
Material58.shininess = 0.127273;
Material58.specularColor = [0.276305,0.11431,0.139857];
ProtoBody57.children = [];
...
ExternProtoDeclare63.url = ["http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02Material","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02Material"];
...
MetadataString110.value = ["test case"];
...
Group129 = browser.currentScene.createNode("Group");
Group129.DEF = "Node2";
//intentionally empty
Group123.children[1] = Group129;

Transform130 = browser.currentScene.createNode("Transform");
...
ProtoDeclare131 = browser.currentScene.createNode("ProtoDeclare");
ProtoDeclare131.name = "ShaderProto";
ProtoBody132 = browser.currentScene.createNode("ProtoBody");
ProgramShader133 = browser.currentScene.createNode("ProgramShader");
ProtoBody132.children = [];
...
Shape134 = browser.currentScene.createNode("Shape");
Appearance135 = browser.currentScene.createNode("Appearance");
...
ShaderProgram137 = browser.currentScene.createNode("ShaderProgram");
ShaderProgram137.DEF = "TestShader2";
ShaderProgram137.type = "VERTEX";
ProgramShader136.programs = [];

ProgramShader136.programs[0] = ShaderProgram137;

Appearance135.shaders = [];
...
ComposedShader139 = browser.currentScene.createNode("ComposedShader");
ComposedShader139.DEF = "TestShader4";
ShaderPart140 = browser.currentScene.createNode("ShaderPart");
ShaderPart140.DEF = "TestShader5";
ShaderPart140.type = "VERTEX";
ComposedShader139.parts = [];
...
Transform141 = browser.currentScene.createNode("Transform");
Transform141.DEF = "SpecialtyNodes";
CADLayer142 = browser.currentScene.createNode("CADLayer");
CADAssembly143 = browser.currentScene.createNode("CADAssembly");
CADPart144 = browser.currentScene.createNode("CADPart");
CADFace145 = browser.currentScene.createNode("CADFace");
CADPart144.children = [];

CADPart144.children[0] = CADFace145;

CADAssembly143.children = [];

CADAssembly143.children[0] = CADPart144;

CADLayer142.children = [];

CADLayer142.children[0] = CADAssembly143;

Transform141.children = [];

Transform141.children[0] = CADLayer142;

EspduTransform146 = browser.currentScene.createNode("EspduTransform");
Transform141.children[1] = EspduTransform146;

ReceiverPdu147 = browser.currentScene.createNode("ReceiverPdu");
Transform141.children[2] = ReceiverPdu147;

SignalPdu148 = browser.currentScene.createNode("SignalPdu");
Transform141.children[3] = SignalPdu148;

TransmitterPdu149 = browser.currentScene.createNode("TransmitterPdu");
Transform141.children[4] = TransmitterPdu149;

DISEntityManager150 = browser.currentScene.createNode("DISEntityManager");
DISEntityTypeMapping151 = browser.currentScene.createNode("DISEntityTypeMapping");
DISEntityManager150.mapping = [];

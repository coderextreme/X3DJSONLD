...
HAnimHumanoid5.info = new MFString(new java.lang.String["humanoidVersion=2.0"]);
HAnimHumanoid5.scale = new SFVec3f(new float[0.0225,0.0225,0.0225]);
HAnimHumanoid5.version = "2.0";
HAnimHumanoid5.bboxDisplay = False;
HAnimHumanoid5.visible = True;
let HAnimJoint6 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint6.name = "HumanoidRoot";
HAnimJoint6.DEF = "hanim_HumanoidRoot";
HAnimJoint6.center = new SFVec3f(new float[0,30.53,-0.7076]);
HAnimJoint6.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimJoint6.bboxSize = new SFVec3f(new float[-1,-1,-1]);
HAnimJoint6.bboxDisplay = False;
HAnimJoint6.visible = True;
let HAnimSegment7 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment7.name = "sacrum";
HAnimSegment7.DEF = "hanim_sacrum";
HAnimSegment7.bboxDisplay = False;
HAnimSegment7.visible = True;
let Transform8 = browser.currentScene.createNode("Transform");
Transform8.translation = new SFVec3f(new float[0,30.53,-0.7076]);
Transform8.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform8.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform8.bboxDisplay = False;
Transform8.visible = True;
...
ImageTexture12.DEF = "Annex01JinTextureAtlas";
ImageTexture12.url = new MFString(new java.lang.String["Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/HAnimSpecification/Jin.png"]);
ImageTexture12.load = "true";
ImageTexture12.refresh = "0";
...
HAnimJoint16.center = new SFVec3f(new float[0,35.8,-0.7076]);
...
Transform18.translation = new SFVec3f(new float[0,35.8,-0.7076]);
Transform18.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform18.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform18.bboxDisplay = False;
Transform18.visible = True;
...
ImageTexture22.USE = "Annex01JinTextureAtlas";
...
Coordinate24.point = new MFVec3f(new float[0,1.053,0.0273,0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.875,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0,0.9123,0.596,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.875,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.98,0.5267,-0.4285,-1.132,0.5267,0.0273,-0.98,0.5267,0.483,-0.5658,0.5267,0.6985,0,0.5267,0.8206,0.5658,0.5267,0.6985,0.98,0.5267,0.483,1.132,0.5267,0.0273,0.98,0.5267,-0.4285,0.5658,0.5267,-0.7621,0,0,-0.9616,-0.6534,0,-0.8206,-1.132,0,-0.4353,-1.307,0,0.0273,-1.132,0,0.5536,-0.6534,0,0.8206,0,0,0.9616,0.6534,0,0.8206,1.132,0,0.5536,1.307,0,0.0273,1.132,0,-0.4353,0.6534,0,-0.8206,0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0,-1.053,0.0273]);
IndexedFaceSet23.coord = Coordinate24;

let TextureCoordinate25 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate25.point = new MFVec2f(new float[0.6211,0.5754,0.7851,0.572,0.7614,0.572,0.6907,0.5698,0.62,0.5698,0.6158,0.5702,0.5451,0.5702,0.4167,0.5698,0.5451,0.5702,0.6158,0.5702,0.62,0.5698,0.6907,0.5698,0.7614,0.572,0.8036,0.5346,0.7761,0.5346,0.6989,0.4838,0.6219,0.4428,0.6154,0.4438,0.5492,0.4639,0.4166,0.5346,0.5492,0.4639,0.6154,0.4438,0.6219,0.4428,0.6989,0.4838,0.7761,0.5346,0.7912,0.4044,0.7635,0.4044,0.7042,0.3925,0.6194,0.3907,0.6148,0.3907,0.545,0.3974,0.4163,0.4938,0.545,0.3974,0.6148,0.3907,0.6194,0.3907,0.7042,0.3925,0.7635,0.4044,0.795,0.3772,0.7662,0.3772,0.6945,0.3645,0.6236,0.3695,0.616,0.3695,0.5438,0.378,0.416,0.453,0.5438,0.378,0.616,0.3695,0.6236,0.3695,0.6945,0.3645,0.7662,0.3772,0.7887,0.3451,0.7635,0.3451,0.698,0.3508,0.6262,0.3508,0.6297,0.3503,0.5389,0.3503,0.4181,0.3884,0.5389,0.3503,0.6297,0.3503,0.6262,0.3508,0.698,0.3508,0.7635,0.3451,0.6237,0.3398]);
...
HAnimJoint26.center = new SFVec3f(new float[4.207,32.02,-0.8155]);
...
HAnimSegment27.bboxDisplay = False;
HAnimSegment27.visible = True;
let Transform28 = browser.currentScene.createNode("Transform");
Transform28.translation = new SFVec3f(new float[4.207,32.02,-0.8155]);
Transform28.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform28.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform28.bboxDisplay = False;
Transform28.visible = True;
...
ImageTexture32.USE = "Annex01JinTextureAtlas";
...
HAnimJoint36.DEF = "hanim_l_knee";
HAnimJoint36.center = new SFVec3f(new float[4.116,17.26,-0.8639]);
...
HAnimSegment37.name = "l_calf";
HAnimSegment37.DEF = "hanim_l_calf";
HAnimSegment37.bboxDisplay = False;
HAnimSegment37.visible = True;
let Transform38 = browser.currentScene.createNode("Transform");
Transform38.translation = new SFVec3f(new float[4.116,17.26,-0.8639]);
Transform38.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform38.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform38.bboxDisplay = False;
Transform38.visible = True;
...
HAnimJoint46.DEF = "hanim_l_talocrural";
HAnimJoint46.center = new SFVec3f(new float[3.854,3.939,-0.7038]);
...
HAnimSegment47.name = "l_hindfoot";
HAnimSegment47.DEF = "hanim_l_hindfoot";
HAnimSegment47.bboxDisplay = False;
HAnimSegment47.visible = True;
let Transform48 = browser.currentScene.createNode("Transform");
Transform48.translation = new SFVec3f(new float[3.854,3.939,-0.7038]);
Transform48.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform48.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform48.bboxDisplay = False;
Transform48.visible = True;
let Shape49 = browser.currentScene.createNode("Shape");
Shape49.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape49.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
HAnimJoint56.name = "l_metatarsophalangeal";
HAnimJoint56.DEF = "hanim_l_metatarsophalangeal";
HAnimJoint56.center = new SFVec3f(new float[3.854,3.64,0.7402]);
...
HAnimSegment57.DEF = "hanim_l_middistal";
HAnimSegment57.bboxDisplay = False;
HAnimSegment57.visible = True;
let Transform58 = browser.currentScene.createNode("Transform");
Transform58.translation = new SFVec3f(new float[3.854,3.64,0.7402]);
Transform58.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform58.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform58.bboxDisplay = False;
Transform58.visible = True;
let Shape59 = browser.currentScene.createNode("Shape");
Shape59.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape59.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Shape59.bboxDisplay = False;
...
HAnimJoint66.DEF = "hanim_r_hip";
HAnimJoint66.center = new SFVec3f(new float[-4.207,32.02,-0.8155]);
...
HAnimSegment67.DEF = "hanim_r_thigh";
HAnimSegment67.bboxDisplay = False;
HAnimSegment67.visible = True;
let Transform68 = browser.currentScene.createNode("Transform");
Transform68.translation = new SFVec3f(new float[-4.207,32.02,-0.8155]);
Transform68.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform68.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform68.bboxDisplay = False;
Transform68.visible = True;
...
Coordinate74.point = new MFVec3f(new float[-2.96,3.738,0,-1.643,3.738,3.209,1.316,3.738,4.002,3.367,3.738,1.781,3.367,3.738,-1.781,1.316,3.738,-4.002,-1.643,3.738,-3.209,-2.96,-0.0114,0,-1.643,-0.0114,3.209,1.316,-0.0114,4.002,3.367,-0.0114,1.781,3.367,-0.0114,-1.781,1.316,-0.0114,-4.002,-1.643,-0.0114,-3.209,-2.96,-6.507,0,-1.643,-6.507,3.209,1.316,-6.507,4.002,3.367,-6.507,1.781,3.367,-6.507,-1.781,1.316,-6.507,-4.002,-1.643,-6.507,-3.209,-3.367,-13.13,0,-1.897,-13.13,3.582,1.407,-13.13,4.467,3.355,-13.13,1.988,3.355,-13.13,-1.988,1.407,-13.13,-4.467,-1.897,-13.13,-3.582,-2.146,-4.985,0,-1.136,-4.985,2.462,1.135,-4.985,3.07,2.633,-4.985,1.366,2.633,-4.985,-1.366,1.135,-4.985,-3.07,-1.136,-4.985,-2.462,-2.156,-11.45,0,-1.225,-11.45,1.956,0.8662,-11.45,2.439,2.543,-11.45,1.085,2.543,-11.45,-1.085,0.8662,-11.45,-2.439,-1.225,-11.45,-1.956,-2.051,5.729,0,-1.076,5.729,2.375,1.114,5.729,2.961,2.87,5.729,1.318,2.87,5.729,-1.318,1.114,5.729,-2.961,-1.076,5.729,-2.375,-1.842,-15.12,0,-1.03,-15.12,1.873,0.7965,-15.12,2.295,2.261,-15.12,1.113,2.261,-15.12,-0.9478,0.7965,-15.12,-2.13,-1.03,-15.12,-1.708,-0.6277,-16.1,0,-0.2723,-16.1,0.912,0.5262,-16.1,1.096,1.167,-16.1,0.5796,1.167,-16.1,-0.4145,0.5262,-16.1,-0.9313,-0.2723,-16.1,-0.7469]);
IndexedFaceSet73.coord = Coordinate74;

let TextureCoordinate75 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate75.point = new MFVec2f(new float[0.719,0.5576,0.6284,0.5576,0.7414,0.5576,0.6787,0.5576,0.5781,0.5576,0.5154,0.5576,0.5378,0.5576,0.6284,0.5029,0.7509,0.3997,0.6284,0.3997,0.7509,0.5029,0.7811,0.3997,0.7811,0.5029,0.6964,0.3997,0.6964,0.5029,0.5604,0.3997,0.5604,0.5029,0.4756,0.3997,0.4756,0.5029,0.5059,0.3997,0.5059,0.5029,0.7509,0.3197,0.6284,0.3197,0.7811,0.3197,0.6964,0.3197,0.5604,0.3197,0.4756,0.3197,0.5059,0.3197,0.7651,0.2166,0.6284,0.2166,0.7989,0.2166,0.7043,0.2166,0.5525,0.2166,0.4579,0.2166,0.4917,0.2166,0.7224,0.263,0.6284,0.263,0.7456,0.263,0.6805,0.263,0.5762,0.263,0.5112,0.263,0.5344,0.263,0.8705,0.5452,0.8705,0.5383,0.8705,0.5369,0.8705,0.5408,0.8705,0.5483,0.8705,0.5522,0.8705,0.5509,0.917,0.5452,0.917,0.5266,0.89,0.5304,0.89,0.5452,0.917,0.522,0.89,0.5268,0.917,0.5349,0.89,0.537,0.917,0.5555,0.89,0.5534,0.917,0.5684,0.89,0.5636,0.917,0.5638,0.89,0.56,0.8746,0.531,0.8746,0.5452,0.8746,0.5279,0.8746,0.5368,0.8746,0.5524,0.8746,0.5613,0.8746,0.5581]);
...
HAnimJoint76.center = new SFVec3f(new float[-4.116,17.26,-0.8639]);
...
HAnimSegment77.bboxDisplay = False;
HAnimSegment77.visible = True;
let Transform78 = browser.currentScene.createNode("Transform");
Transform78.translation = new SFVec3f(new float[-4.116,17.26,-0.8639]);
Transform78.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform78.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform78.bboxDisplay = False;
Transform78.visible = True;
let Shape79 = browser.currentScene.createNode("Shape");
Shape79.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape79.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Shape79.bboxDisplay = False;
...
Coordinate84.point = new MFVec3f(new float[-0.7186,0.9688,0.0234,-0.3632,0.9688,0.9354,0.4353,0.9688,1.12,1.076,0.9688,0.603,1.076,0.9688,-0.3911,0.4353,0.9688,-0.9079,-0.3632,0.9688,-0.7235,-2.337,-4.613,0.0234,-1.46,-3.622,2.019,-1.236,-1.628,2.42,-2.118,-1.912,0.0234,0.8111,-3.622,2.567,0.7468,-1.628,2.903,2.254,-4.613,1.255,2.337,-1.912,0.9793,2.254,-5.383,-1.368,2.337,-1.912,-0.9325,0.8111,-5.383,-2.903,0.7468,-1.912,-2.368,-1.46,-5.383,-2.355,-1.236,-1.912,-1.885,-1.121,-0.0032,1.896,-1.933,-0.0032,0.0234,0.7056,-0.0032,2.318,2.17,-0.0032,1.136,2.17,-0.0032,-0.9244,0.7056,-0.0032,-2.061,-1.121,-0.0032,-1.64,-1.607,-12.92,0.0032,-0.9216,-12.91,1.565,0.619,-12.91,1.951,1.854,-12.92,0.8701,1.854,-12.94,-0.9762,0.619,-12.94,-1.742,-0.9216,-12.94,-1.356,-0.7072,-14.53,0.0239,-0.3604,-14.53,0.814,0.4188,-14.53,1.009,1.044,-14.53,0.4624,1.044,-14.54,-0.4714,0.4188,-14.54,-0.8587,-0.3604,-14.54,-0.6635]);
...
HAnimJoint86.name = "r_talocrural";
HAnimJoint86.DEF = "hanim_r_talocrural";
HAnimJoint86.center = new SFVec3f(new float[-3.854,3.939,-0.7038]);
...
Transform88.translation = new SFVec3f(new float[-3.854,3.939,-0.7038]);
...
Shape89.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape89.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Shape89.bboxDisplay = False;
...
TextureCoordinate95.point = new MFVec2f(new float[0.3819,0.171,0.4216,0.1651,0.3819,0.171,0.4216,0.1651,0.3819,0.171,0.3819,0.171,0.4637,0.1714,0.4216,0.1651,0.4637,0.1714,0.4216,0.1651,0.3819,0.171,0.3819,0.171,0.3819,0.171,0.3819,0.171,0.4637,0.1714,0.4637,0.1714,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.3836,0.1404,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.4637,0.1714,0.4394,0.1472,0.4244,0.1312,0.3861,0.1398,0.3873,0.0706,0.3871,0.0221,0.3873,0.0706,0.3871,0.0221,0.3871,0.0221,0.3861,0.1398,0.3836,0.1404,0.3873,0.0706,0.3873,0.0706,0.3836,0.1404,0.3861,0.1398,0.3871,0.0221,0.3871,0.0221,0.3871,0.0221,0.433,0.0595,0.4411,0.0186,0.4244,0.1312,0.433,0.0595,0.4244,0.1312,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.3861,0.1398,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4244,0.1312,0.4411,0.0186,0.433,0.0595,0.4244,0.1312,0.4244,0.1312,0.433,0.0595,0.4411,0.0186,0.4411,0.0186]);
...
HAnimJoint96.name = "r_metatarsophalangeal";
HAnimJoint96.DEF = "hanim_r_metatarsophalangeal";
HAnimJoint96.center = new SFVec3f(new float[-3.854,3.64,0.7402]);
...
HAnimSegment97.bboxDisplay = False;
HAnimSegment97.visible = True;
let Transform98 = browser.currentScene.createNode("Transform");
Transform98.translation = new SFVec3f(new float[-3.854,3.64,0.7402]);
Transform98.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform98.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform98.bboxDisplay = False;
Transform98.visible = True;
...
Coordinate104.point = new MFVec3f(new float[-2.927,-1.627,-1.013,-2.089,-3.648,-1.013,0,0.2797,0.3064,-2.045,-0.3017,-1.013,-1.695,0.0029,-0.0151,2.927,-1.627,-1.013,2.045,-0.3017,-1.013,2.089,-3.648,-1.013,1.695,0.0029,-0.0151,0,-3.648,-1.013,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0,-3.648,0.9192,0,-0.0274,1.661,-2.405,-1.656,-1.915,-1.75,-2.942,-1.915,0,-2.942,-1.915,1.75,-2.942,-1.915,2.405,-1.656,-1.915,1.742,-0.5681,-1.915,-1.742,-0.5681,-1.915,-1.784,-0.648,2.332,-2.216,-2.267,4.144,-2.216,-3.648,3.776,0,-2.267,5.463,0,-0.5463,3.95,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,2.216,-2.267,4.144,1.784,-0.648,2.332,0,-3.648,5.096,2.216,-3.648,3.776,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0,-3.648,3.776,0,-3.648,0.9192,0,-0.0274,1.661]);
IndexedFaceSet103.coord = Coordinate104;

let TextureCoordinate105 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate105.point = new MFVec2f(new float[0.433,0.0595,0.4411,0.0186,0.4637,0.1714,0.4411,0.0186,0.4244,0.1312,0.4394,0.1472,0.433,0.0595,0.4244,0.1312,0.4411,0.0186,0.4637,0.1714,0.4394,0.1472,0.4411,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4949,0.0186,0.4868,0.1432,0.4868,0.1432,0.433,0.0595,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.433,0.0595,0.4244,0.1312,0.4244,0.1312,0.532,0.098,0.5645,0.0707,0.4885,0.102,0.5026,0.044,0.5945,0.0186,0.5487,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4868,0.1432,0.5645,0.0707,0.5026,0.044,0.4885,0.102,0.532,0.098,0.5945,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.5487,0.0186,0.4949,0.0186,0.4868,0.1432]);
...
HAnimJoint16.children[2] = HAnimJoint66;

let HAnimJoint106 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint106.name = "vl5";
HAnimJoint106.DEF = "hanim_vl5";
HAnimJoint106.center = new SFVec3f(new float[0,40.23,-0.8527]);
...
HAnimSegment107.name = "l5";
HAnimSegment107.DEF = "hanim_l5";
HAnimSegment107.bboxDisplay = False;
HAnimSegment107.visible = True;
let Transform108 = browser.currentScene.createNode("Transform");
Transform108.translation = new SFVec3f(new float[0,40.23,-0.8527]);
Transform108.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform108.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform108.bboxDisplay = False;
Transform108.visible = True;
...
HAnimJoint116.name = "skullbase";
HAnimJoint116.DEF = "hanim_skullbase";
HAnimJoint116.center = new SFVec3f(new float[0,57.43,-0.6863]);
...
HAnimJoint126.center = new SFVec3f(new float[5.975,52,-0.1452]);
HAnimJoint126.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimJoint126.bboxSize = new SFVec3f(new float[-1,-1,-1]);
HAnimJoint126.bboxDisplay = False;
HAnimJoint126.visible = True;
...
HAnimSegment127.bboxDisplay = False;
HAnimSegment127.visible = True;
let Transform128 = browser.currentScene.createNode("Transform");
Transform128.translation = new SFVec3f(new float[5.975,52,-0.1452]);
Transform128.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform128.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform128.bboxDisplay = False;
Transform128.visible = True;
...
HAnimJoint136.center = new SFVec3f(new float[8.093,40.38,-0.2502]);
HAnimJoint136.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimJoint136.bboxSize = new SFVec3f(new float[-1,-1,-1]);
...
Transform138.translation = new SFVec3f(new float[8.093,40.38,-0.2502]);
Transform138.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform138.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform138.bboxDisplay = False;
Transform138.visible = True;
let Shape139 = browser.currentScene.createNode("Shape");
Shape139.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape139.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Shape139.bboxDisplay = False;
...
HAnimJoint146.center = new SFVec3f(new float[7.808,31.46,-0.05849]);
HAnimJoint146.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimJoint146.bboxSize = new SFVec3f(new float[-1,-1,-1]);
HAnimJoint146.bboxDisplay = False;
HAnimJoint146.visible = True;
let HAnimSegment147 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment147.name = "l_hand";
HAnimSegment147.DEF = "hanim_l_hand";
HAnimSegment147.bboxDisplay = False;
HAnimSegment147.visible = True;
let Transform148 = browser.currentScene.createNode("Transform");
Transform148.translation = new SFVec3f(new float[7.808,31.46,-0.05849]);
Transform148.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform148.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform148.bboxDisplay = False;
Transform148.visible = True;
let Shape149 = browser.currentScene.createNode("Shape");
Shape149.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape149.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Shape149.bboxDisplay = False;
...
HAnimJoint106.children[2] = HAnimJoint126;
...
HAnimJoint156.center = new SFVec3f(new float[-5.975,52,-0.1452]);
HAnimJoint156.bboxCenter = new SFVec3f(new float[0,0,0]);
HAnimJoint156.bboxSize = new SFVec3f(new float[-1,-1,-1]);
HAnimJoint156.bboxDisplay = False;
HAnimJoint156.visible = True;
...
HAnimSegment157.bboxDisplay = False;
HAnimSegment157.visible = True;
let Transform158 = browser.currentScene.createNode("Transform");
Transform158.translation = new SFVec3f(new float[-5.975,52,-0.1452]);
Transform158.bboxCenter = new SFVec3f(new float[0,0,0]);
Transform158.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Transform158.bboxDisplay = False;
Transform158.visible = True;
let Shape159 = browser.currentScene.createNode("Shape");
Shape159.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape159.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Shape159.bboxDisplay = False;
...
TextureCoordinate165.point = new MFVec2f(new float[0.2986,0.2114,0.2726,0.2114,0.3201,0.2114,0.3415,0.2114,0.2466,0.2114,0.2979,0.2417,0.2726,0.2417,0.3197,0.2417,0.3418,0.2417,0.2473,0.2417,0.2979,0.3018,0.2726,0.3018,0.3197,0.3018,0.3418,0.3018,0.2473,0.3018,0.2978,0.3276,0.2726,0.3276,0.3197,0.3276,0.3419,0.3276,0.2474,0.3276,0.2932,0.2834,0.2689,0.2834,0.316,0.2834,0.3322,0.2834,0.245,0.2834,0.2251,0.2114,0.2255,0.2417,0.2255,0.2417,0.2255,0.3018,0.2255,0.3018,0.2255,0.3276,0.2255,0.3276,0.2159,0.2834,0.4315,0.6736,0.442,0.6736,0.3947,0.6736,0.4041,0.6736,0.418,0.6736,0.4296,0.6167,0.4409,0.6167,0.4415,0.6485,0.4303,0.6485,0.3965,0.6167,0.3953,0.6485,0.4047,0.6167,0.4053,0.6485,0.4189,0.6167,0.418,0.6485,0.4415,0.6706,0.4306,0.6706,0.395,0.6706,0.4051,0.6706,0.4182,0.6706,0.3746,0.6736,0.3851,0.6736,0.384,0.6167,0.3845,0.6485,0.3845,0.6485,0.3846,0.6706,0.3846,0.6706,0.3851,0.6736,0.3481,0.2114]);
...
HAnimJoint166.center = new SFVec3f(new float[-8.093,40.38,-0.2502]);
...
Transform168.translation = new SFVec3f(new float[-8.093,40.38,-0.2502]);
...
Shape169.bboxCenter = new SFVec3f(new float[0,0,0]);
Shape169.bboxSize = new SFVec3f(new float[-1,-1,-1]);
Shape169.bboxDisplay = False;
...
TextureCoordinate175.point = new MFVec2f(new float[0.4222,0.6201,0.4327,0.6201,0.3884,0.6201,0.3987,0.6201,0.4103,0.6201,0.4213,0.6265,0.4321,0.6265,0.3894,0.6265,0.399,0.6265,0.4105,0.6265,0.4214,0.6413,0.4323,0.6413,0.389,0.6381,0.3992,0.6381,0.4103,0.6413,0.4213,0.6705,0.4336,0.6705,0.3899,0.6705,0.3981,0.6705,0.4094,0.6705,0.4215,0.674,0.4346,0.674,0.3899,0.674,0.398,0.674,0.4083,0.674,0.3787,0.6201,0.3682,0.6201,0.3787,0.6201,0.3782,0.6265,0.3782,0.6265,0.3783,0.6413,0.3783,0.6413,0.3796,0.6705,0.3676,0.674,0.3806,0.674,0.3796,0.6705,0.3806,0.674]);
...
HAnimJoint176.center = new SFVec3f(new float[-7.808,31.46,-0.05849]);
...
HAnimSegment177.name = "r_hand";
HAnimSegment177.DEF = "hanim_r_hand";
HAnimSegment177.bboxDisplay = False;
HAnimSegment177.visible = True;
let Transform178 = browser.currentScene.createNode("Transform");
Transform178.translation = new SFVec3f(new float[-7.808,31.46,-0.05849]);
...
TextureCoordinate185.point = new MFVec2f(new float[0.8107,0.9924,0.8122,0.9033,0.7694,0.9912,0.7683,0.9026,0.1329,0.0347,0.0307,0.0051,0.0134,0.0353,0.1366,0.0058,0.1249,0.1081,0.0147,0.117,0.1349,0.1856,0.0462,0.1842,0.1559,0.0454,0.148,0.1033,0.3244,0.0096,0.1758,0.0039,0.1759,0.011,0.3241,0.0033,0.173,0.1764,0.3074,0.1757,0.1732,0.1519,0.3074,0.1513,0.1756,0.032,0.2159,0.0368,0.1791,0.0165,0.3169,0.0458,0.3158,0.0193,0.172,0.0594,0.2087,0.0476,0.1736,0.0504,0.2073,0.064,0.2362,0.0821,0.3267,0.0796,0.1717,0.0822,0.1726,0.1297,0.3077,0.1289,0.3074,0.1865,0.1742,0.184,0.0061,0.1086,0.1366,0.0368,0.1241,0.1189,0.0168,0.0309,0.0211,0.1882,0.14,0.1857]);
...
HAnimJoint106.children[3] = HAnimJoint156;

HAnimJoint16.children[3] = HAnimJoint106;
...
HAnimSegment207.USE = "hanim_l_thigh";
...
HAnimSegment222.USE = "hanim_r_hand";
HAnimHumanoid5.segments[37] = HAnimSegment222;

...
HAnimHumanoid5.jointBindingPositions = new MFVec3f(new float[0,0,0]);
HAnimHumanoid5.jointBindingRotations = new MFRotation(new float[0,0,1,0]);
HAnimHumanoid5.jointBindingScales = new MFVec3f(new float[1,1,1]);

...
WorldInfo2.title = "KoreanCharacterMotionAnnexD01Jin.x3d";
...
HAnimHumanoid5.name = "AnnexD01Jin";
HAnimHumanoid5.DEF = "hanim_AnnexD01Jin";
...
MetadataString7.name = "humanoidVersion";
MetadataString7.value = new MFString(new java.lang.String["2.0"]);
...
let HAnimJoint8 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint8.name = "humanoid_root";
HAnimJoint8.DEF = "hanim_humanoid_root";
HAnimJoint8.center = new SFVec3f(new float[0,30.53,-0.7076]);
HAnimJoint8.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment9 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment9.name = "sacrum";
HAnimSegment9.DEF = "hanim_sacrum";
let Transform10 = browser.currentScene.createNode("Transform");
Transform10.translation = new SFVec3f(new float[0,30.53,-0.7076]);
...
Material13.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance12.material = Material13;

let ImageTexture14 = browser.currentScene.createNode("ImageTexture");
ImageTexture14.DEF = "Annex01JinTextureAtlas";
ImageTexture14.url = new MFString(new java.lang.String["Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/HAnimSpecification/Jin.png"]);
...
IndexedFaceSet15.texCoord = TextureCoordinate17;
...
HAnimSegment9.children = new MFNode();

HAnimSegment9.children[0] = Transform10;

HAnimJoint8.children = new MFNode();

HAnimJoint8.children[0] = HAnimSegment9;

let HAnimJoint18 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint18.name = "sacroiliac";
HAnimJoint18.DEF = "hanim_sacroiliac";
HAnimJoint18.center = new SFVec3f(new float[0,35.8,-0.7076]);
...
Transform20.translation = new SFVec3f(new float[0,35.8,-0.7076]);
...
Material23.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance22.material = Material23;

let ImageTexture24 = browser.currentScene.createNode("ImageTexture");
ImageTexture24.USE = "Annex01JinTextureAtlas";
...
IndexedFaceSet25.texCoordIndex = new MFInt32(new int[0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,5,-1,0,5,6,-1,0,6,7,-1,0,7,8,-1,0,8,9,-1,0,9,10,-1,0,10,11,-1,0,11,12,-1,0,12,1,-1,14,2,1,-1,1,13,14,-1,15,3,2,-1,2,14,15,-1,16,4,3,-1,3,15,16,-1,17,5,4,-1,4,16,17,-1,18,6,5,-1,5,17,18,-1,19,7,6,-1,6,18,19,-1,20,8,7,-1,7,19,20,-1,21,9,8,-1,8,20,21,-1,22,10,9,-1,9,21,22,-1,23,11,10,-1,10,22,23,-1,24,12,11,-1,11,23,24,-1,13,1,12,-1,12,24,13,-1,26,14,13,-1,13,25,26,-1,27,15,14,-1,14,26,27,-1,28,16,15,-1,15,27,28,-1,29,17,16,-1,16,28,29,-1,30,18,17,-1,17,29,30,-1,31,19,18,-1,18,30,31,-1,32,20,19,-1,19,31,32,-1,33,21,20,-1,20,32,33,-1,34,22,21,-1,21,33,34,-1,35,23,22,-1,22,34,35,-1,36,24,23,-1,23,35,36,-1,25,13,24,-1,24,36,25,-1,38,26,25,-1,25,37,38,-1,39,27,26,-1,26,38,39,-1,40,28,27,-1,27,39,40,-1,41,29,28,-1,28,40,41,-1,42,30,29,-1,29,41,42,-1,43,31,30,-1,30,42,43,-1,44,32,31,-1,31,43,44,-1,45,33,32,-1,32,44,45,-1,46,34,33,-1,33,45,46,-1,47,35,34,-1,34,46,47,-1,48,36,35,-1,35,47,48,-1,37,25,36,-1,36,48,37,-1,50,38,37,-1,37,49,50,-1,51,39,38,-1,38,50,51,-1,52,40,39,-1,39,51,52,-1,53,41,40,-1,40,52,53,-1,54,42,41,-1,41,53,54,-1,55,43,42,-1,42,54,55,-1,56,44,43,-1,43,55,56,-1,57,45,44,-1,44,56,57,-1,58,46,45,-1,45,57,58,-1,59,47,46,-1,46,58,59,-1,60,48,47,-1,47,59,60,-1,49,37,48,-1,48,60,49,-1,61,50,49,-1,61,51,50,-1,61,52,51,-1,61,53,52,-1,61,54,53,-1,61,55,54,-1,61,56,55,-1,61,57,56,-1,61,58,57,-1,61,59,58,-1,61,60,59,-1,61,49,60,-1]);
let Coordinate26 = browser.currentScene.createNode("Coordinate");
Coordinate26.point = new MFVec3f(new float[0,1.053,0.0273,0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.875,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0,0.9123,0.596,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.875,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.98,0.5267,-0.4285,-1.132,0.5267,0.0273,-0.98,0.5267,0.483,-0.5658,0.5267,0.6985,0,0.5267,0.8206,0.5658,0.5267,0.6985,0.98,0.5267,0.483,1.132,0.5267,0.0273,0.98,0.5267,-0.4285,0.5658,0.5267,-0.7621,0,0,-0.9616,-0.6534,0,-0.8206,-1.132,0,-0.4353,-1.307,0,0.0273,-1.132,0,0.5536,-0.6534,0,0.8206,0,0,0.9616,0.6534,0,0.8206,1.132,0,0.5536,1.307,0,0.0273,1.132,0,-0.4353,0.6534,0,-0.8206,0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0,-1.053,0.0273]);
IndexedFaceSet25.coord = Coordinate26;

let TextureCoordinate27 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate27.point = new MFVec2f(new float[0.6211,0.5754,0.7851,0.572,0.7614,0.572,0.6907,0.5698,0.62,0.5698,0.6158,0.5702,0.5451,0.5702,0.4167,0.5698,0.5451,0.5702,0.6158,0.5702,0.62,0.5698,0.6907,0.5698,0.7614,0.572,0.8036,0.5346,0.7761,0.5346,0.6989,0.4838,0.6219,0.4428,0.6154,0.4438,0.5492,0.4639,0.4166,0.5346,0.5492,0.4639,0.6154,0.4438,0.6219,0.4428,0.6989,0.4838,0.7761,0.5346,0.7912,0.4044,0.7635,0.4044,0.7042,0.3925,0.6194,0.3907,0.6148,0.3907,0.545,0.3974,0.4163,0.4938,0.545,0.3974,0.6148,0.3907,0.6194,0.3907,0.7042,0.3925,0.7635,0.4044,0.795,0.3772,0.7662,0.3772,0.6945,0.3645,0.6236,0.3695,0.616,0.3695,0.5438,0.378,0.416,0.453,0.5438,0.378,0.616,0.3695,0.6236,0.3695,0.6945,0.3645,0.7662,0.3772,0.7887,0.3451,0.7635,0.3451,0.698,0.3508,0.6262,0.3508,0.6297,0.3503,0.5389,0.3503,0.4181,0.3884,0.5389,0.3503,0.6297,0.3503,0.6262,0.3508,0.698,0.3508,0.7635,0.3451,0.6237,0.3398]);
IndexedFaceSet25.texCoord = TextureCoordinate27;
...
HAnimSegment19.children[0] = Transform20;
...
HAnimJoint28.name = "l_hip";
HAnimJoint28.DEF = "hanim_l_hip";
HAnimJoint28.center = new SFVec3f(new float[4.207,32.02,-0.8155]);
HAnimJoint28.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment29 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment29.name = "l_thigh";
HAnimSegment29.DEF = "hanim_l_thigh";
let Transform30 = browser.currentScene.createNode("Transform");
Transform30.translation = new SFVec3f(new float[4.207,32.02,-0.8155]);
...
Material33.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance32.material = Material33;

let ImageTexture34 = browser.currentScene.createNode("ImageTexture");
ImageTexture34.USE = "Annex01JinTextureAtlas";
...
HAnimJoint38.name = "l_knee";
HAnimJoint38.DEF = "hanim_l_knee";
HAnimJoint38.center = new SFVec3f(new float[4.116,17.26,-0.8639]);
HAnimJoint38.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment39 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment39.name = "l_calf";
HAnimSegment39.DEF = "hanim_l_calf";
let Transform40 = browser.currentScene.createNode("Transform");
Transform40.translation = new SFVec3f(new float[4.116,17.26,-0.8639]);
...
Material43.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint48.name = "l_talocrural";
HAnimJoint48.DEF = "hanim_l_talocrural";
HAnimJoint48.center = new SFVec3f(new float[3.854,3.939,-0.7038]);
HAnimJoint48.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment49 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment49.name = "l_talus";
HAnimSegment49.DEF = "hanim_l_talus";
let Transform50 = browser.currentScene.createNode("Transform");
Transform50.translation = new SFVec3f(new float[3.854,3.939,-0.7038]);
...
Material53.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance52.material = Material53;

let ImageTexture54 = browser.currentScene.createNode("ImageTexture");
...
HAnimJoint58.center = new SFVec3f(new float[3.854,3.64,0.7402]);
HAnimJoint58.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment59 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment59.name = "l_tarsal_proximal_phalanx_2";
HAnimSegment59.DEF = "hanim_l_tarsal_proximal_phalanx_2";
let Transform60 = browser.currentScene.createNode("Transform");
Transform60.translation = new SFVec3f(new float[3.854,3.64,0.7402]);
...
Material63.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint48.children[1] = HAnimJoint58;

HAnimJoint38.children[1] = HAnimJoint48;

HAnimJoint28.children[1] = HAnimJoint38;

HAnimJoint18.children[1] = HAnimJoint28;

let HAnimJoint68 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint68.name = "r_hip";
HAnimJoint68.DEF = "hanim_r_hip";
HAnimJoint68.center = new SFVec3f(new float[-4.207,32.02,-0.8155]);
...
Transform70.translation = new SFVec3f(new float[-4.207,32.02,-0.8155]);
...
Material73.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint78.center = new SFVec3f(new float[-4.116,17.26,-0.8639]);
...
Transform80.translation = new SFVec3f(new float[-4.116,17.26,-0.8639]);
...
Material83.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance82.material = Material83;

let ImageTexture84 = browser.currentScene.createNode("ImageTexture");
...
IndexedFaceSet85.texCoordIndex = new MFInt32(new int[0,1,2,-1,2,3,4,-1,2,4,5,-1,0,2,5,-1,6,0,5,-1,9,10,7,-1,7,8,9,-1,12,9,8,-1,8,11,12,-1,14,12,11,-1,11,13,14,-1,16,14,13,-1,13,15,16,-1,18,16,15,-1,15,17,18,-1,20,18,17,-1,17,19,20,-1,10,20,19,-1,19,7,10,-1,21,22,10,-1,10,9,21,-1,23,21,9,-1,9,12,23,-1,24,23,12,-1,12,14,24,-1,25,24,14,-1,14,16,25,-1,26,25,16,-1,16,18,26,-1,27,26,18,-1,18,20,27,-1,22,27,20,-1,20,10,22,-1,1,0,22,-1,22,21,1,-1,2,1,21,-1,21,23,2,-1,3,2,23,-1,23,24,3,-1,4,3,24,-1,24,25,4,-1,5,4,25,-1,25,26,5,-1,6,5,26,-1,26,27,6,-1,0,6,27,-1,27,22,0,-1,8,7,28,-1,28,29,8,-1,11,8,29,-1,29,30,11,-1,13,11,30,-1,30,31,13,-1,15,13,31,-1,31,32,15,-1,17,15,32,-1,32,33,17,-1,19,17,33,-1,33,34,19,-1,7,19,34,-1,34,28,7,-1,29,28,35,-1,35,36,29,-1,30,29,36,-1,36,37,30,-1,31,30,37,-1,37,38,31,-1,32,31,38,-1,38,39,32,-1,33,32,39,-1,39,40,33,-1,34,33,40,-1,40,41,34,-1,28,34,41,-1,41,35,28,-1]);
let Coordinate86 = browser.currentScene.createNode("Coordinate");
Coordinate86.point = new MFVec3f(new float[-0.7186,0.9688,0.0234,-0.3632,0.9688,0.9354,0.4353,0.9688,1.12,1.076,0.9688,0.603,1.076,0.9688,-0.3911,0.4353,0.9688,-0.9079,-0.3632,0.9688,-0.7235,-2.337,-4.613,0.0234,-1.46,-3.622,2.019,-1.236,-1.628,2.42,-2.118,-1.912,0.0234,0.8111,-3.622,2.567,0.7468,-1.628,2.903,2.254,-4.613,1.255,2.337,-1.912,0.9793,2.254,-5.383,-1.368,2.337,-1.912,-0.9325,0.8111,-5.383,-2.903,0.7468,-1.912,-2.368,-1.46,-5.383,-2.355,-1.236,-1.912,-1.885,-1.121,-0.0032,1.896,-1.933,-0.0032,0.0234,0.7056,-0.0032,2.318,2.17,-0.0032,1.136,2.17,-0.0032,-0.9244,0.7056,-0.0032,-2.061,-1.121,-0.0032,-1.64,-1.607,-12.92,0.0032,-0.9216,-12.91,1.565,0.619,-12.91,1.951,1.854,-12.92,0.8701,1.854,-12.94,-0.9762,0.619,-12.94,-1.742,-0.9216,-12.94,-1.356,-0.7072,-14.53,0.0239,-0.3604,-14.53,0.814,0.4188,-14.53,1.009,1.044,-14.53,0.4624,1.044,-14.54,-0.4714,0.4188,-14.54,-0.8587,-0.3604,-14.54,-0.6635]);
IndexedFaceSet85.coord = Coordinate86;

let TextureCoordinate87 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate87.point = new MFVec2f(new float[0.9309,0.5848,0.919,0.5848,0.8921,0.5848,0.8706,0.5848,0.8706,0.5848,0.8921,0.5848,0.919,0.5848,0.9845,0.5321,0.955,0.5475,0.9491,0.5599,0.9788,0.5571,0.8787,0.5475,0.8825,0.5599,0.8302,0.5321,0.8291,0.5571,0.8302,0.52,0.8291,0.5571,0.8787,0.52,0.8825,0.5571,0.955,0.52,0.9491,0.5571,0.9444,0.5755,0.9717,0.5755,0.8831,0.5755,0.8339,0.5755,0.8339,0.5755,0.8831,0.5755,0.9444,0.5755,0.9679,0.2444,0.9449,0.2445,0.8931,0.2445,0.8516,0.2444,0.8516,0.2442,0.8931,0.2442,0.9449,0.2442,0.9372,0.2243,0.9255,0.2244,0.8993,0.2244,0.8783,0.2243,0.8783,0.2243,0.8993,0.2243,0.9255,0.2243]);
...
HAnimJoint88.name = "r_talocrural";
HAnimJoint88.DEF = "hanim_r_talocrural";
HAnimJoint88.center = new SFVec3f(new float[-3.854,3.939,-0.7038]);
HAnimJoint88.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment89 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment89.name = "r_talus";
HAnimSegment89.DEF = "hanim_r_talus";
let Transform90 = browser.currentScene.createNode("Transform");
Transform90.translation = new SFVec3f(new float[-3.854,3.939,-0.7038]);
...
Material93.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance92.material = Material93;

let ImageTexture94 = browser.currentScene.createNode("ImageTexture");
...
HAnimJoint98.name = "r_metatarsophalangeal_2";
HAnimJoint98.DEF = "hanim_r_metatarsophalangeal_2";
HAnimJoint98.center = new SFVec3f(new float[-3.854,3.64,0.7402]);
HAnimJoint98.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment99 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment99.name = "r_tarsal_proximal_phalanx_2";
HAnimSegment99.DEF = "hanim_r_tarsal_proximal_phalanx_2";
let Transform100 = browser.currentScene.createNode("Transform");
Transform100.translation = new SFVec3f(new float[-3.854,3.64,0.7402]);
...
Material103.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance102.material = Material103;

let ImageTexture104 = browser.currentScene.createNode("ImageTexture");
...
Coordinate106.point = new MFVec3f(new float[-2.927,-1.627,-1.013,-2.089,-3.648,-1.013,0,0.2797,0.3064,-2.045,-0.3017,-1.013,-1.695,0.0029,-0.0151,2.927,-1.627,-1.013,2.045,-0.3017,-1.013,2.089,-3.648,-1.013,1.695,0.0029,-0.0151,0,-3.648,-1.013,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0,-3.648,0.9192,0,-0.0274,1.661,-2.405,-1.656,-1.915,-1.75,-2.942,-1.915,0,-2.942,-1.915,1.75,-2.942,-1.915,2.405,-1.656,-1.915,1.742,-0.5681,-1.915,-1.742,-0.5681,-1.915,-1.784,-0.648,2.332,-2.216,-2.267,4.144,-2.216,-3.648,3.776,0,-2.267,5.463,0,-0.5463,3.95,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,2.216,-2.267,4.144,1.784,-0.648,2.332,0,-3.648,5.096,2.216,-3.648,3.776,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0,-3.648,3.776,0,-3.648,0.9192,0,-0.0274,1.661]);
IndexedFaceSet105.coord = Coordinate106;

let TextureCoordinate107 = browser.currentScene.createNode("TextureCoordinate");
TextureCoordinate107.point = new MFVec2f(new float[0.433,0.0595,0.4411,0.0186,0.4637,0.1714,0.4411,0.0186,0.4244,0.1312,0.4394,0.1472,0.433,0.0595,0.4244,0.1312,0.4411,0.0186,0.4637,0.1714,0.4394,0.1472,0.4411,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4949,0.0186,0.4868,0.1432,0.4868,0.1432,0.433,0.0595,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.433,0.0595,0.4244,0.1312,0.4244,0.1312,0.532,0.098,0.5645,0.0707,0.4885,0.102,0.5026,0.044,0.5945,0.0186,0.5487,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4868,0.1432,0.5645,0.0707,0.5026,0.044,0.4885,0.102,0.532,0.098,0.5945,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.5487,0.0186,0.4949,0.0186,0.4868,0.1432]);
...
HAnimJoint68.children[1] = HAnimJoint78;

HAnimJoint18.children[2] = HAnimJoint68;

let HAnimJoint108 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint108.name = "vl5";
HAnimJoint108.DEF = "hanim_vl5";
HAnimJoint108.center = new SFVec3f(new float[0,40.23,-0.8527]);
...
HAnimSegment109.DEF = "hanim_l5";
let Transform110 = browser.currentScene.createNode("Transform");
Transform110.translation = new SFVec3f(new float[0,40.23,-0.8527]);
...
Material113.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint118.name = "skullbase";
HAnimJoint118.DEF = "hanim_skullbase";
HAnimJoint118.center = new SFVec3f(new float[0,57.43,-0.6863]);
HAnimJoint118.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment119 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment119.name = "skull";
HAnimSegment119.DEF = "hanim_skull";
let Transform120 = browser.currentScene.createNode("Transform");
Transform120.translation = new SFVec3f(new float[0,57.43,-0.6863]);
...
Material123.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance122.material = Material123;

let ImageTexture124 = browser.currentScene.createNode("ImageTexture");
...
HAnimJoint108.children[1] = HAnimJoint118;

let HAnimJoint128 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint128.name = "l_shoulder";
HAnimJoint128.DEF = "hanim_l_shoulder";
HAnimJoint128.center = new SFVec3f(new float[5.975,52,-0.1452]);
HAnimJoint128.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment129 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment129.name = "l_upperarm";
HAnimSegment129.DEF = "hanim_l_upperarm";
let Transform130 = browser.currentScene.createNode("Transform");
Transform130.translation = new SFVec3f(new float[5.975,52,-0.1452]);
...
Material133.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint138.name = "l_elbow";
HAnimJoint138.DEF = "hanim_l_elbow";
HAnimJoint138.center = new SFVec3f(new float[8.093,40.38,-0.2502]);
HAnimJoint138.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment139 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment139.name = "l_forearm";
HAnimSegment139.DEF = "hanim_l_forearm";
let Transform140 = browser.currentScene.createNode("Transform");
Transform140.translation = new SFVec3f(new float[8.093,40.38,-0.2502]);
...
Material143.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance142.material = Material143;

let ImageTexture144 = browser.currentScene.createNode("ImageTexture");
...
HAnimJoint148.name = "l_radiocarpal";
HAnimJoint148.DEF = "hanim_l_radiocarpal";
HAnimJoint148.center = new SFVec3f(new float[7.808,31.46,-0.05849]);
HAnimJoint148.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment149 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment149.name = "l_carpal";
HAnimSegment149.DEF = "hanim_l_carpal";
let Transform150 = browser.currentScene.createNode("Transform");
Transform150.translation = new SFVec3f(new float[7.808,31.46,-0.05849]);
...
Material153.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance152.material = Material153;

let ImageTexture154 = browser.currentScene.createNode("ImageTexture");
...
HAnimJoint138.children[1] = HAnimJoint148;

HAnimJoint128.children[1] = HAnimJoint138;

HAnimJoint108.children[2] = HAnimJoint128;

let HAnimJoint158 = browser.currentScene.createNode("HAnimJoint");
HAnimJoint158.name = "r_shoulder";
HAnimJoint158.DEF = "hanim_r_shoulder";
HAnimJoint158.center = new SFVec3f(new float[-5.975,52,-0.1452]);
HAnimJoint158.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment159 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment159.name = "r_upperarm";
HAnimSegment159.DEF = "hanim_r_upperarm";
let Transform160 = browser.currentScene.createNode("Transform");
Transform160.translation = new SFVec3f(new float[-5.975,52,-0.1452]);
...
Material163.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance162.material = Material163;

let ImageTexture164 = browser.currentScene.createNode("ImageTexture");
...
Coordinate166.point = new MFVec3f(new float[-2.525,1.246,-1.68,-3.681,1.236,0.0337,-2.408,1.247,1.663,-0.4657,1.264,0.9556,-0.5379,1.264,-1.11,-2.743,-0.0209,-2.31,-4.339,-0.0351,0.057,-2.581,-0.0195,2.307,0.1009,0.0044,1.33,0.0013,0.0035,-1.523,-2.72,-2.534,-2.31,-4.317,-2.548,0.057,-2.559,-2.533,2.307,0.1233,-2.509,1.33,0.0237,-2.51,-1.523,-2.759,-3.609,-2.442,-4.448,-3.624,0.0619,-2.588,-3.608,2.442,0.2497,-3.583,1.409,0.1443,-3.583,-1.61,-2.245,-1.758,-1.939,-3.465,-1.769,-0.4543,-2.834,-1.763,1.629,-1.223,-1.749,1.432,-0.8596,-1.746,-0.7734,-2.263,-7.566,-1.569,-3.531,-7.577,-0.378,-2.875,-7.571,1.293,-1.202,-7.556,1.135,-0.8242,-7.553,-0.6339,-2.267,-11.62,-1.511,-3.487,-11.63,-0.3651,-2.856,-11.62,1.243,-1.245,-11.61,1.091,-0.8817,-11.6,-0.6115,-2.213,-12.17,-0.8985,-2.928,-12.17,-0.2266,-2.558,-12.17,0.7161,-1.614,-12.16,0.6268,-1.401,-12.16,-0.3711]);
...
HAnimJoint168.name = "r_elbow";
HAnimJoint168.DEF = "hanim_r_elbow";
HAnimJoint168.center = new SFVec3f(new float[-8.093,40.38,-0.2502]);
HAnimJoint168.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment169 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment169.name = "r_forearm";
HAnimSegment169.DEF = "hanim_r_forearm";
let Transform170 = browser.currentScene.createNode("Transform");
Transform170.translation = new SFVec3f(new float[-8.093,40.38,-0.2502]);
...
Material173.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint178.name = "r_radiocarpal";
HAnimJoint178.DEF = "hanim_r_radiocarpal";
HAnimJoint178.center = new SFVec3f(new float[-7.808,31.46,-0.05849]);
HAnimJoint178.stiffness = new SFVec3f(new float[0,0,0]);
let HAnimSegment179 = browser.currentScene.createNode("HAnimSegment");
HAnimSegment179.name = "r_carpal";
HAnimSegment179.DEF = "hanim_r_carpal";
let Transform180 = browser.currentScene.createNode("Transform");
Transform180.translation = new SFVec3f(new float[-7.808,31.46,-0.05849]);
...
Material183.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance182.material = Material183;

let ImageTexture184 = browser.currentScene.createNode("ImageTexture");
...
Coordinate186.point = new MFVec3f(new float[-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912,0.7183,0.0002,-1.283,0.9295,-0.613,1.478,-1.647,-0.4252,1.388,-1.589,-0.3921,-1.989,1.044,-0.5947,-1.984,0.8227,-2.521,2.408,-1.951,-2.334,2.08,-1.892,-2.301,-2.409,1.192,-2.614,-2.248,0.5703,-3.958,1.694,-0.8836,-4.2,1.75,-0.8251,-4.167,-2.071,0.7842,-3.968,-1.934,1.037,-0.5968,-0.1872,1.642,-2.561,1.941,1.951,-0.9492,0.058,1.914,-1.016,1.885,1.649,-2.56,0.1377,1.066,-2.61,-0.2014,-1.209,0.0872,-1.349,0.7183,0.0002,-1.283,0.7098,-0.0015,0.8912,-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912]);

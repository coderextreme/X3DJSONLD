...
Text21.string = new X3D.MFString([new X3D.SFString("I don't think so"), new X3D.SFString("he said \"Hi\"")]);
...
Text26.string = new X3D.MFString([new X3D.SFString("I don't think so"), new X3D.SFString("he said \"Hi\"")]);

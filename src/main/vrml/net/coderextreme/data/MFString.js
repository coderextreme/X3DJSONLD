...
Material6.diffuseColor = [0.25,0.25,0.25];
...
Material12.diffuseColor = [0.25,0.25,0.25];
...
IndexedFaceSet13.coordIndex = [2,32,33,-1,34,32,2,-1,35,36,37,-1,38,36,35,-1,39,40,41,-1,37,36,42,-1,2,43,44,-1,33,43,2,-1,45,37,42,46,-1,46,42,47,48,-1,33,45,46,43,-1,43,46,48,44,-1,34,49,50,32,-1,32,50,45,33,-1,49,38,35,50,-1,50,35,37,45,-1];
IndexedFaceSet13.creaseAngle = 0.5;
IndexedFaceSet13.normalIndex = [2,22,23,-1,24,22,2,-1,25,26,27,-1,28,26,25,-1,29,29,29,-1,27,26,30,-1,2,31,32,-1,23,31,2,-1,33,27,30,34,-1,34,30,35,36,-1,23,33,34,31,-1,31,34,36,32,-1,24,37,38,22,-1,22,38,33,23,-1,37,28,25,38,-1,38,25,27,33,-1];
...
Material18.diffuseColor = [0.1796,0.1914,0.2382];
...
Material24.diffuseColor = [0.5,0.5,0.5];
Appearance23.material = Material24;

Shape22.appearance = Appearance23;

IndexedFaceSet25 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet25.coordIndex = [186,187,188,189,190,-1,190,191,192,193,186,-1];
IndexedFaceSet25.creaseAngle = 0.5;
IndexedFaceSet25.normalIndex = [118,119,120,121,122,-1,122,123,124,125,118,-1];
...
Material30.diffuseColor = [0.2304,0.2304,0.2304];
Appearance29.material = Material30;

Shape28.appearance = Appearance29;

IndexedFaceSet31 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet31.coordIndex = [194,130,173,195,196,197,-1,197,198,199,82,81,194,-1];
IndexedFaceSet31.creaseAngle = 0.5;
IndexedFaceSet31.normalIndex = [126,126,126,126,126,126,-1,126,126,126,126,126,126,-1];
...
Material36.diffuseColor = [0.6,0.6,0.6];
Appearance35.material = Material36;

Shape34.appearance = Appearance35;

IndexedFaceSet37 = browser.currentScene.createNode("IndexedFaceSet");
IndexedFaceSet37.coordIndex = [12,200,201,15,-1,19,48,127,17,-1,15,201,128,5,-1,17,127,202,11,-1,11,202,200,12,-1,5,128,49,1,-1,48,19,44,-1,19,2,44,-1,34,1,49,-1,34,2,1,-1];
IndexedFaceSet37.creaseAngle = 0.5;
IndexedFaceSet37.normalIndex = [8,127,128,11,-1,15,36,83,13,-1,11,128,85,5,-1,13,83,129,7,-1,7,129,127,8,-1,5,85,37,1,-1,36,15,32,-1,15,2,32,-1,24,1,37,-1,24,2,1,-1];
...
Material42.diffuseColor = [0.37,0.37,0.37];
...
IndexedFaceSet43.coordIndex = [64,186,193,165,-1,203,204,164,163,-1,192,191,138,142,-1,191,190,96,138,-1,94,96,190,189,-1,95,94,189,188,-1,63,187,186,64,-1,62,61,205,206,-1];
IndexedFaceSet43.creaseAngle = 0.5;
IndexedFaceSet43.normalIndex = [50,118,125,107,-1,130,130,130,130,-1,124,123,91,94,-1,123,122,75,91,-1,73,75,122,121,-1,74,73,121,120,-1,49,119,118,50,-1,131,131,131,131,-1];
...
Material48.emissiveColor = [0.1796,0.1914,0.2382];
...
Material54.diffuseColor = [0.6,0.6,0.6];
...
IndexedFaceSet55.coordIndex = [0,1,2,3,-1,4,5,1,0,-1,10,11,12,13,-1,14,15,5,4,-1,13,12,15,14,-1,16,17,11,10,-1,18,19,17,16,-1,3,2,19,18,-1];
IndexedFaceSet55.creaseAngle = 0.5;
IndexedFaceSet55.normalIndex = [0,1,2,3,-1,4,5,1,0,-1,6,7,8,9,-1,10,11,5,4,-1,9,8,11,10,-1,12,13,7,6,-1,14,15,13,12,-1,3,2,15,14,-1];
...
Transform58.rotation = [1,0,0,-0.1];
Transform58.scale = [0.045,0.045,0.045];
Transform58.translation = [0,1,-10];
Inline59 = browser.currentScene.createNode("Inline");
Inline59.url = ["Cockpit.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Cockpit.x3d","Cockpit.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Cockpit.wrl"];
Transform58.children = [];

Transform58.children[0] = Inline59;

Transform2.children[1] = Transform58;

Transform60 = browser.currentScene.createNode("Transform");
Transform60.DEF = "SeatTransform";
Transform60.rotation = [-1,0,0,-0.1];
Transform60.scale = [0.9,0.9,0.9];
Transform60.translation = [0,0,-8.3];
Inline61 = browser.currentScene.createNode("Inline");
Inline61.url = ["Seat.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Seat.x3d","Seat.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Seat.wrl"];
Transform60.children = [];

Transform60.children[0] = Inline61;
...
Transform62.center = [0,2.5,0];
Transform62.rotation = [-1,0,0,1.92];
Transform62.translation = [0.7,-5.2,-6.5];
...
Inline63.url = ["FrontWheel.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FrontWheel.x3d","FrontWheel.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FrontWheel.wrl"];
Transform62.children = [];
...
Transform64.center = [0,2.5,0];
Transform64.rotation = [1,0,1,1.92];
Transform64.translation = [-2.95,-5,7];
...
Inline65.url = ["RearLeftWheel.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/RearLeftWheel.x3d","RearLeftWheel.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/RearLeftWheel.wrl"];
Transform64.children = [];

Transform64.children[0] = Inline65;
...
Transform66.center = [0,2.5,0];
Transform66.rotation = [-1,0,-1,1.92];
Transform66.translation = [2.95,-5,7];
//Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel)
Inline67 = browser.currentScene.createNode("Inline");
Inline67.url = ["RearRightWheel.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/RearRightWheel.x3d","RearRightWheel.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/RearRightWheel.wrl"];
Transform66.children = [];

Transform66.children[0] = Inline67;
...
Transform69.rotation = [1,0,0,1.57];
Transform69.scale = [0.008,0.008,0.008];
Transform69.translation = [-0.95,1.05,-10];
...
Transform75.rotation = [1,0,0,1.57];
Transform75.scale = [0.008,0.008,0.008];
Transform75.translation = [-0.83,1.05,-10];
...
Material79.diffuseColor = [1,1,0];
Material79.shininess = 0.8;
Appearance78.material = Material79;

Shape76.appearance = Appearance78;
...
Transform81.scale = [0.06,0.06,0.06];
Transform81.translation = [-0.65,1.55,-10];
Shape82 = browser.currentScene.createNode("Shape");
Text83 = browser.currentScene.createNode("Text");
Text83.string = ["RED Button","Gear Up"];
...
Material85.diffuseColor = [1,0,0];
Appearance84.material = Material85;

Shape82.appearance = Appearance84;
...
Transform86.scale = [0.06,0.06,0.06];
Transform86.translation = [-0.65,1.35,-10];
Shape87 = browser.currentScene.createNode("Shape");
Text88 = browser.currentScene.createNode("Text");
Text88.length = [5.5];
Text88.string = ["YELLOW Button","Gear Down"];
...
Material90.diffuseColor = [1,1,0];
Appearance89.material = Material90;

Shape87.appearance = Appearance89;

Transform86.children = [];
...
Transform91.translation = [0.52,1.6,-10];
...
Viewpoint102.orientation = [-0.559,-0.827,-0.057,1.3534];
Viewpoint102.position = [-28.7,19.9,17.4];
Transform2.children[7] = Viewpoint102;

Viewpoint103 = browser.currentScene.createNode("Viewpoint");
Viewpoint103.description = "Cockpit";
Viewpoint103.orientation = [-1,0,0,0.1249];
Viewpoint103.position = [0,1.5,-7.9];
...
Viewpoint104.orientation = [-0.003,1,-0.012,2.5741];
Viewpoint104.position = [16.1,-5.8,-24.6];
...
Viewpoint105.orientation = [-0.276,-0.922,-0.271,1.2338];
Viewpoint105.position = [-6.7,6.1,-3.9];
...
Viewpoint106.orientation = [-0.007,0.995,0.102,3.1152];
Viewpoint106.position = [-0.1,13.4,-65];
...
Viewpoint107.orientation = [-0.834,-0.523,-0.176,0.0875];
Viewpoint107.position = [0,2.4,-7.9];
...
Transform108.rotation = [1,0,0,1.57];
Transform108.translation = [0,-0.275,-21];
...
OrientationInterpolator114.key = [0,0.5,1];
OrientationInterpolator114.keyValue = [1,0,0,0,1,0,0,-0.79,1,0,0,-1.92];
...
OrientationInterpolator119.key = [0,0.5,1];
OrientationInterpolator119.keyValue = [1,0,0,-1.92,1,0,0,-0.79,1,0,0,0];
...
OrientationInterpolator125.key = [0,0.5,1];
OrientationInterpolator125.keyValue = [-1,0,-1,0,-1,0,-1,0.44,-1,0,-1,1.92];
...
OrientationInterpolator126.key = [0,0.5,1];
OrientationInterpolator126.keyValue = [-1,0,-1,1.92,-1,0,-1,0.44,-1,0,-1,0];
...
OrientationInterpolator135.keyValue = [1,0,1,0,1,0,1,0.44,1,0,1,1.92];
...
OrientationInterpolator136.key = [0,0.5,1];
OrientationInterpolator136.keyValue = [1,0,1,1.92,1,0,1,0.44,1,0,1,0];
...
Background143.groundAngle = [1.309,1.570796];
Background143.groundColor = [0,0.3,0.7,0,0.35,0.75,0,0.4,0.8];
Background143.skyAngle = [1.309,1.571];
Background143.skyColor = [0,0.3,0.8,0,0.5,1,1,1,1];
...
Transform144.rotation = [-1,0,0,1.57];
Transform144.scale = [1.4,1.4,1.4];
Transform144.translation = [15.65,0,4.5];
Inline145 = browser.currentScene.createNode("Inline");
Inline145.DEF = "Amraam";
Inline145.url = ["../../Weapons/Missiles/Amraam.x3d","https://savage.nps.edu/Savage/Weapons/Missiles/Amraam.x3d","../../Weapons/Missiles/Amraam.wrl","https://savage.nps.edu/Savage/Weapons/Missiles/Amraam.wrl"];
Transform144.children = [];

Transform144.children[0] = Inline145;
...
Transform146.rotation = [-1,0,0,1.57];
Transform146.scale = [1.4,1.4,1.4];
Transform146.translation = [-15.65,0,4.5];
Inline147 = browser.currentScene.createNode("Inline");
Inline147.USE = "Amraam";
Transform146.children = [];

Transform146.children[0] = Inline147;
...
Transform148.rotation = [0,1,0,1.57];
Transform148.scale = [6,3,3];
Transform148.translation = [9,-1.125,8];
Inline149 = browser.currentScene.createNode("Inline");
Inline149.DEF = "SidewinderHolder";
Inline149.url = ["SidewinderHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/SidewinderHolder.x3d","SidewinderHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/SidewinderHolder.wrl"];
Transform148.children = [];

Transform148.children[0] = Inline149;
...
Transform150.rotation = [0,1,0,1.57];
Transform150.scale = [6,3,3];
Transform150.translation = [-8.45,-1.125,8];
Inline151 = browser.currentScene.createNode("Inline");
Inline151.USE = "SidewinderHolder";
Transform150.children = [];
...
Transform152.rotation = [0,-1,0,1.57];
Transform152.scale = [0.3,0.25,0.3];
Transform152.translation = [-0.01,8,19.5];
Inline153 = browser.currentScene.createNode("Inline");
Inline153.url = ["TurkishFlagLeft.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagLeft.x3d","TurkishFlagLeft.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagLeft.wrl"];
Transform152.children = [];

Transform152.children[0] = Inline153;
...
Transform154.rotation = [0,1,0,1.57];
Transform154.scale = [0.3,0.25,0.3];
Transform154.translation = [0.01,8,20.5];
Inline155 = browser.currentScene.createNode("Inline");
Inline155.url = ["TurkishFlagRight.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagRight.x3d","TurkishFlagRight.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagRight.wrl"];
Transform154.children = [];
...
Transform156.translation = [-12,-0.176,10.7];
Inline157 = browser.currentScene.createNode("Inline");
Inline157.DEF = "AmraamHolder";
Inline157.url = ["AmraamHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/AmraamHolder.x3d","AmraamHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/AmraamHolder.wrl"];
Transform156.children = [];
...
Transform164.rotation = [-1,0,0,1.57];
Transform164.scale = [1.6,1.6,1.6];
Transform164.translation = [-8.7,-2,3.5];
Inline165 = browser.currentScene.createNode("Inline");
Inline165.DEF = "Sidewinder";
Inline165.url = ["../../Weapons/Missiles/Sidewinder.x3d","https://savage.nps.edu/Savage/Weapons/Missiles/Sidewinder.x3d","../../Weapons/Missiles/Sidewinder.wrl","https://savage.nps.edu/Savage/Weapons/Missiles/Sidewinder.wrl"];
Transform164.children = [];
...
Transform166.scale = [1.6,1.6,1.6];
Transform166.translation = [8.7,-2,3.5];
Inline167 = browser.currentScene.createNode("Inline");
Inline167.USE = "Sidewinder";
Transform166.children = [];
...
Transform168.scale = [1.5,1.5,1.5];
Transform168.translation = [-4.8,-1.125,6];
Inline169 = browser.currentScene.createNode("Inline");
Inline169.DEF = "FuelTankHolder";
Inline169.url = ["FuelTankHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTankHolder.x3d","FuelTankHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTankHolder.wrl"];
Transform168.children = [];
...
Transform170.scale = [1.5,1.5,1.5];
Transform170.translation = [5.3,-1.125,6];
Inline171 = browser.currentScene.createNode("Inline");
Inline171.USE = "FuelTankHolder";
Transform170.children = [];
...
Transform172.rotation = [-1,0,0,1.57];
Transform172.scale = [1.5,1.5,1.5];
Transform172.translation = [5,-2.85,5.5];
Inline173 = browser.currentScene.createNode("Inline");
Inline173.DEF = "FuelTank";
Inline173.url = ["FuelTank.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTank.x3d","FuelTank.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTank.wrl"];
Transform172.children = [];
...
Transform174.rotation = [-1,0,0,1.57];
Transform174.scale = [1.5,1.5,1.5];
Transform174.translation = [-5,-2.85,5.5];
Inline175 = browser.currentScene.createNode("Inline");
Inline175.USE = "FuelTank";
Transform174.children = [];
...
Material180.diffuseColor = [0.25,0.25,0.25];
Appearance179.material = Material180;

Shape177.appearance = Appearance179;

Transform176.children = [];
...
Transform181.translation = [16,-50,-500];
Inline182 = browser.currentScene.createNode("Inline");
Inline182.url = ["Target.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Target.x3d","Target.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Target.wrl"];
Transform181.children = [];

Transform181.children[0] = Inline182;
...
PositionInterpolator184.key = [0,0.1,1];
PositionInterpolator184.keyValue = [-15.65,0,4.5,-15.65,-2,4.5,16,-50,-500];
...
Viewpoint188.orientation = [0.094,-0.994,0.057,1.1716];
Viewpoint188.position = [-344.3,-142.8,-27.7];

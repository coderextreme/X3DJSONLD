...
scene.addMetaData("title", "WinterAndSpringAuthorsAllTitleBox.x3d");
scene.addMetaData("description", "Credits for scene authors.");
...
scene.addMetaData("identifier", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringAuthorsAllTitleBox.x3d");
...
Viewpoint12.position = new X3D.SFVec3f([10,11,0]);
...
Transform13.translation = new X3D.SFVec3f([10,10,-5]);
...
ImageTexture17.url = new X3D.MFString([new X3D.SFString("images/WSAuthorsAll.png"), new X3D.SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSAuthorsAll.png")]);

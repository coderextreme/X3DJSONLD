...
scene.addMetaData("identifier", "https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d");
...
ExternProtoDeclare11.url = new X3D.MFString([new X3D.SFString("../data/flowerproto.x3d#FlowerProto")]);

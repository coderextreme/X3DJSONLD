      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("G1")
          .addChild(new Transform().setDEF("DECLpoint_INSTANCE_node")
            ...
            .addChild(new PositionInterpolator().setDEF("DECLpoint_INSTANCE_PI1").setKey(java.newArray("float", [0,1])).setKeyValue(java.newArray("float", [0,0,0,0,5,0])))
        ...
        .addChild(new Transform().setDEF("G2")
          .addChild(new Transform().setDEF("DECLpoint_INSTANCE1000_node")
            .addChild(new Shape()
              ...
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(java.newArray("float", [1,0,0])))))
            .addChild(new PositionInterpolator().setDEF("DECLpoint_INSTANCE1000_PI1").setKey(java.newArray("float", [0,1])).setKeyValue(java.newArray("float", [0,0,0,0,5,0])))

...
"					}"))
        ...
        .addChild(new ProtoDeclare().setName("cylinder")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Shape()
              .setGeometry(new Extrusion().setDEF("extrusion").setCreaseAngle(0.785).setCrossSection(java.newArray("float", [1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0])).setSpine(java.newArray("float", [0,-50,0,0,0,0,0,50,0])))
              .setAppearance(new Appearance()
...
"                }"))
        ...
        .addChild(new Transform().setScale(java.newArray("float", [0.1,0.1,0.1]))

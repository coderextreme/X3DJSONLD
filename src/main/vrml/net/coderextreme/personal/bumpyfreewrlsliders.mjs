...
DISEntityTypeMapping97.url = new X3D.MFString([new X3D.SFString("../data/Leif8Final.x3dv"), new X3D.SFString("https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3dv")]);
...
DISEntityTypeMapping98.url = new X3D.MFString([new X3D.SFString("../data/Lily8Final.x3dv"), new X3D.SFString("https://coderextreme.net/X3DJSONLD/src/main/data/Lily8Final.x3dv")]);
...
DISEntityTypeMapping99.url = new X3D.MFString([new X3D.SFString("../data/Tufani8Final.x3dv"), new X3D.SFString("https://coderextreme.net/X3DJSONLD/src/main/data/Tufani8Final.x3dv")]);
...
DISEntityTypeMapping100.url = new X3D.MFString([new X3D.SFString("../data/Gramps8Final.x3dv"), new X3D.SFString("https://coderextreme.net/X3DJSONLD/src/main/data/Gramps8Final.x3dv")]);

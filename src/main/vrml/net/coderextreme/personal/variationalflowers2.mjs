...
scene.addMetaData("title", "variationalflowers2.x3d");
scene.addMetaData("creator", "John Carlson");
scene.addMetaData("description", "A flower variational system");
scene.addMetaData("identifier", "https://coderextreme.net/X3DJSONLD/src/main/personal/variationalflowers2.x3d");

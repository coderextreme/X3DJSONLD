...
scene.addMetaData("title", "bumpyfreewrl.x3d");
scene.addMetaData("creator", "John Carlson");
scene.addMetaData("description", "A flower");
scene.addMetaData("generator", "X3D-Edit, https://savage.nps.edu/X3D-Edit");
scene.addMetaData("identifier", "https://coderextreme.net/X3DJSONLD/src/main/personal/bumpyfreewrl.x3d");
...
ComposedShader34.getField("fw_textureCoordGenType").setValue("0");
ComposedShader32YYY.field = new X3D.MFNode();
...
ComposedShader40.getField("c").setValue("5");
ComposedShader32YYY.field = new X3D.MFNode();

ComposedShader41.getField("d").setValue("5");
ComposedShader32YYY.field = new X3D.MFNode();
...
ShaderPart44.url = new X3D.MFString([new X3D.SFString("../shaders/freewrl_flowers_chromatic.vs"), new X3D.SFString("https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs")]);
ShaderPart44.type = "VERTEX";
ComposedShader32YYY.parts = new X3D.MFNode();

ComposedShader32ZZZ.parts[0] = ShaderPart44;

let ShaderPart45 = browser.currentScene.createNode("ShaderPart");
ShaderPart45.url = new X3D.MFString([new X3D.SFString("../shaders/freewrl_bubbles.fs"), new X3D.SFString("https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_bubbles.fs")]);
ShaderPart45.type = "FRAGMENT";
ComposedShader32ZZZ.parts[1] = ShaderPart45;

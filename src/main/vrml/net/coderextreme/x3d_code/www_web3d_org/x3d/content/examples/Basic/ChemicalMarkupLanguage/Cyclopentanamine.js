...
WorldInfo2.title = "Cyclopentanamine.x3d";
...
Viewpoint300.description = "Inspect Cyclopentanamine";
...
fieldValue305.value = "\"Cyclopentanamine: C5 H11 N\"";
...
fieldValue308.value = "\"molecule weight: 85.15\"";
...
fieldValue311.value = "\"melting point: -6\"";
...
fieldValue314.value = "\"boiling point: 106\"";
...
fieldValue317.value = "\"specific gravity: 0.863\"";
...
ProtoInstance320.name = "Nitrogen";
ProtoInstance320.DEF = "cyclopentanamine_a1";
let fieldValue321 = browser.currentScene.createNode("fieldValue");
fieldValue321.name = "position";
fieldValue321.value = "0.6333 2.5818 1.6112";
...
ProtoInstance338.DEF = "cyclopentanamine_b1";
let fieldValue339 = browser.currentScene.createNode("fieldValue");
fieldValue339.name = "bond_set";
fieldValue339.value = "0.6333 2.5818 1.6112 2.0204 2.1653 1.9102";
...
ProtoInstance340.DEF = "cyclopentanamine_b4";
let fieldValue341 = browser.currentScene.createNode("fieldValue");
fieldValue341.name = "bond_set";
fieldValue341.value = "2.0204 2.1653 1.9102 3.053 3.047 1.1939";
...
ProtoInstance342.DEF = "cyclopentanamine_b5";
let fieldValue343 = browser.currentScene.createNode("fieldValue");
fieldValue343.name = "bond_set";
fieldValue343.value = "2.3704 0.7241 1.4997 2.0204 2.1653 1.9102";
...
ProtoInstance344.DEF = "cyclopentanamine_b7";
let fieldValue345 = browser.currentScene.createNode("fieldValue");
fieldValue345.name = "bond_set";
fieldValue345.value = "3.053 3.047 1.1939 4.2903 2.1762 0.9973";
...
ProtoInstance346.DEF = "cyclopentanamine_b10";
let fieldValue347 = browser.currentScene.createNode("fieldValue");
fieldValue347.name = "bond_set";
fieldValue347.value = "4.2903 2.1762 0.9973 3.8619 0.7218 1.1851";
...
ProtoInstance348.DEF = "cyclopentanamine_b13";
let fieldValue349 = browser.currentScene.createNode("fieldValue");
fieldValue349.name = "bond_set";
fieldValue349.value = "3.8619 0.7218 1.1851 2.3704 0.7241 1.4997";

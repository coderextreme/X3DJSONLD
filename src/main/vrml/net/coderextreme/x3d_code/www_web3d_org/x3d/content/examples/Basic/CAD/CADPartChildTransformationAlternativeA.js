...
WorldInfo2.title = "CADPartChildTransformationAlternativeA.x3d";
...
Transform17.rotation = new SFRotation(new float[1,0,0,1.5708]);
Transform17.translation = new SFVec3f(new float[0,1.5,0]);
...
Transform23.rotation = new SFRotation(new float[-1,0,0,1.5708]);
Transform23.translation = new SFVec3f(new float[0,-1.5,0]);
...
CADFace22.shape = Transform23;

CADPart6.children[3] = CADFace22;

...
WorldInfo2.title = "Histamine.x3d";
...
Viewpoint300.description = "Inspect Histamine";
...
fieldValue305.value = "\"Histamine: C5 H9 N3\"";
...
fieldValue308.value = "\"molecular weight: 111.15\"";
...
fieldValue311.value = "\"melting point: 88\"";
...
fieldValue317.value = "\"ACX: I1009215\"";
...
Transform318.translation = new SFVec3f(new float[0,-2,0]);
...
fieldValue320.value = "\"RTECS: MS1050000\"";
...
Group321.children[0] = Transform322;
...
Group321.children[1] = Transform325;
...
ProtoInstance329.name = "Nitrogen";
ProtoInstance329.DEF = "histamine_karne_a_3";
let fieldValue330 = browser.currentScene.createNode("fieldValue");
fieldValue330.name = "position";
fieldValue330.value = "0.14 -1.152 0.508";
...
Group321.children[2] = Transform328;
...
Group321.children[3] = Transform331;
...
Group321.children[4] = Transform334;
...
Group321.children[5] = Transform337;
...
Group321.children[6] = Transform340;
...
Group321.children[7] = Transform343;
...
ProtoInstance347.name = "Hydrogen";
ProtoInstance347.DEF = "histamine_karne_a_9";
let fieldValue348 = browser.currentScene.createNode("fieldValue");
fieldValue348.name = "position";
fieldValue348.value = "-2.452 0.812 0.164";
...
Group321.children[8] = Transform346;
...
ProtoInstance350.name = "Hydrogen";
ProtoInstance350.DEF = "histamine_karne_a_10";
let fieldValue351 = browser.currentScene.createNode("fieldValue");
fieldValue351.name = "position";
fieldValue351.value = "-0.852 -3.032 0.84";
...
Group321.children[9] = Transform349;
...
ProtoInstance353.name = "Hydrogen";
ProtoInstance353.DEF = "histamine_karne_a_11";
let fieldValue354 = browser.currentScene.createNode("fieldValue");
fieldValue354.name = "position";
fieldValue354.value = "0.188 2.088 0.832";
...
Group321.children[10] = Transform352;
...
ProtoInstance356.name = "Hydrogen";
ProtoInstance356.DEF = "histamine_karne_a_12";
let fieldValue357 = browser.currentScene.createNode("fieldValue");
fieldValue357.name = "position";
fieldValue357.value = "0.184 1.78 -0.904";
...
Group321.children[11] = Transform355;
...
ProtoInstance359.name = "Hydrogen";
ProtoInstance359.DEF = "histamine_karne_a_13";
let fieldValue360 = browser.currentScene.createNode("fieldValue");
fieldValue360.name = "position";
fieldValue360.value = "2.224 0.348 -0.66";
...
Group321.children[12] = Transform358;
...
Group321.children[13] = Transform361;
...
Group321.children[14] = Transform364;
...
Group321.children[15] = Transform367;

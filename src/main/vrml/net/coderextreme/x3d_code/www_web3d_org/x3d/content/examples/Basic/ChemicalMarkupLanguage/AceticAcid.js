...
WorldInfo2.title = "AceticAcid.x3d";
...
Viewpoint300.description = "Inspect AceticAcid";
...
fieldValue305.value = "\"Acetic Acid: C2 H4 O2\"";
...
fieldValue308.value = "\"molecule weight: 60.05\"";
...
fieldValue311.value = "\"melting point: 16.6\"";
...
fieldValue314.value = "\"boiling point: 117.9\"";
...
fieldValue317.value = "\"specific gravity: 1.0492\"";
...
ProtoInstance326.name = "Oxygen";
ProtoInstance326.DEF = "acetic_acid_a3";
let fieldValue327 = browser.currentScene.createNode("fieldValue");
fieldValue327.name = "position";
fieldValue327.value = "3.1225 1.026 0.5122";
...
ProtoInstance332.DEF = "acetic_acid_b1";
let fieldValue333 = browser.currentScene.createNode("fieldValue");
fieldValue333.name = "bond_set";
fieldValue333.value = "0.7649 0.9627 1.0051 2.0422 1.7381 0.9144";

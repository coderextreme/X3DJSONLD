...
WorldInfo2.title = "tetrahydrofuran.x3d";
...
Viewpoint300.description = "Inspect tetrahydrofuran";
...
fieldValue305.value = "\"tetrahydrofuran: C4 H8 O\"";
...
fieldValue308.value = "\"molecular weight: 72.1066\"";
...
fieldValue311.value = "\"melting point: -108.3\"";
...
fieldValue314.value = "\"boiling point: 65\"";
...
fieldValue317.value = "\"specific gravity: 0.886\"";
...
fieldValue323.value = "\"CAS: 109-99-9\"";
...
Transform324.translation = new SFVec3f(new float[0,-1,0]);
...
fieldValue326.value = "\"ACX: I1001473\"";
...
Transform327.translation = new SFVec3f(new float[0,-2,0]);
let ProtoInstance328 = browser.currentScene.createNode("ProtoInstance");
ProtoInstance328.name = "ano2_text";
let fieldValue329 = browser.currentScene.createNode("fieldValue");
fieldValue329.name = "txt";
fieldValue329.value = "\"DOT: UN 2056\"";
...
Transform301.children[9] = Transform330;

let Transform333 = browser.currentScene.createNode("Transform");
Transform333.translation = new SFVec3f(new float[0,-4,0]);
let ProtoInstance334 = browser.currentScene.createNode("ProtoInstance");
ProtoInstance334.name = "ano2_text";
let fieldValue335 = browser.currentScene.createNode("fieldValue");
fieldValue335.name = "txt";
fieldValue335.value = "\"comments: Colorless liquid with an ether-like odor detectable at 2 to 50 ppm. HYGROSCOPIC\"";
...
Transform301.children[10] = Transform333;
...
Group336.children[0] = Transform337;
...
Group336.children[1] = Transform340;
...
Group336.children[2] = Transform343;
...
Group336.children[3] = Transform346;
...
Group336.children[4] = Transform349;

browser.currentScene.children[22] = Group336;

let Group352 = browser.currentScene.createNode("Group");
let ProtoInstance353 = browser.currentScene.createNode("ProtoInstance");
ProtoInstance353.name = "line";
ProtoInstance353.DEF = "tetrahydrofuran_karne_b_1";
let fieldValue354 = browser.currentScene.createNode("fieldValue");
fieldValue354.name = "bond_set";
fieldValue354.value = "-1.22 -0.29 0 0.03 -1.17 0";

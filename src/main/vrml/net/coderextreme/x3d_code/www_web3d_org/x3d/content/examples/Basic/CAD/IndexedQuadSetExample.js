...
WorldInfo2.title = "IndexedQuadSetExample.x3d";
...
Viewpoint6.DEF = "Top";
Viewpoint6.description = "IndexedQuadSet top view";
...
let IndexedQuadSet11 = browser.currentScene.createNode("IndexedQuadSet");
IndexedQuadSet11.index = new MFInt32(new int[0,3,2,1,4,5,6,7,2,7,9,8,2,3,4,7]);
let Coordinate12 = browser.currentScene.createNode("Coordinate");
Coordinate12.point = new MFVec3f(new float[-1.5,0,0,-1.5,1,-1,-0.5,1,-1,-0.5,0,0,0.5,0,0,1.5,0,0,1.5,1,-1,0.5,1,-1,-0.5,2,-1,0.5,2,-1]);
IndexedQuadSet11.coord = Coordinate12;

Shape8.geometry = IndexedQuadSet11;

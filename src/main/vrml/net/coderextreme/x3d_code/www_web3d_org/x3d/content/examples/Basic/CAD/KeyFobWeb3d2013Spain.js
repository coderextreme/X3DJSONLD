...
WorldInfo2.title = "KeyFobWeb3d2013Spain.x3d";
browser.currentScene.children = new MFNode();

browser.currentScene.children[0] = WorldInfo2;

let Background3 = browser.currentScene.createNode("Background");
Background3.skyColor = new MFColor(new float[0.858824,0.878431,0.858824]);
...
Material8.diffuseColor = new SFColor(new float[0.776,0.043,0.118]);
...
Material1172.diffuseColor = new SFColor(new float[1,0.584,0]);
...
Material1883.diffuseColor = new SFColor(new float[1,0.584,0]);

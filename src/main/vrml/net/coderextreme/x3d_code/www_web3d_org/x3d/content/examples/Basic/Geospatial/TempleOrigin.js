...
WorldInfo2.title = "TempleOrigin.x3d";
...
Material249.diffuseColor = new SFColor(new float[1,1,1]);
Appearance248.material = Material249;

let ImageTexture250 = browser.currentScene.createNode("ImageTexture");
ImageTexture250.USE = "stone5";

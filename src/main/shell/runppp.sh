...
echo ===================Find Protos in Examples================================ 2>&1
JSONSCRIPTS=
...
echo ===================CompleteXMLPrototypeExpander.js Examples======= 2>&1

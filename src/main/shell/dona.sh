...
(ls "$@" | grep -v intermediate | grep -v "AnchorMenu") | xargs -P $PROCESSORS java -Xss1g -Xmx19g net.coderextreme.RunSaxon ---overwrite ---silent --../lib/stylesheets/X3dToJson.xslt -${JSONEXT} ---

...
set NASHORN_CLASSPATH=%PYTHONSAI%\X3DJSAIL.4.0.full.jar;.;%PYTHONSAI%\saxon-he-12.1.jar;%PYTHONSAI%\jslint4java-2.0.5.jar;%PYTHONSAI%\json-schema-validator-2.2.6-lib.jar

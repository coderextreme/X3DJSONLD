...
const X3DLightNode_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Lighting/X3DLightNode");
...
const MatrixStack_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Utility/MatrixStack");
...
Object .defineProperties (TextureProjector,
{
   ...
   fieldDefinitions:
   {
      value: new (FieldDefinitionArray_default()) ([
         ...
         new (X3DFieldDefinition_default()) ((X3DConstants_default()).inputOutput,    "location",         new (Fields_default()).SFVec3f ()),

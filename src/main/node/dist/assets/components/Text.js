...
const X3DNode_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Core/X3DNode");
...
const URLs_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Browser/Networking/URLs");
...
const PrimitiveQuality_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Browser/Core/PrimitiveQuality");
...
const Box2_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Geometry/Box2");
var Box2_default = /*#__PURE__*/__webpack_require__.n(Box2_namespaceObject);
;// CONCATENATED MODULE: external "window [Symbol .for (\"X_ITE.X3D\")] .require (\"standard/Math/Geometry/Box3\")"
const Box3_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Geometry/Box3");
var Box3_default = /*#__PURE__*/__webpack_require__.n(Box3_namespaceObject);
;// CONCATENATED MODULE: external "window [Symbol .for (\"X_ITE.X3D\")] .require (\"standard/Math/Numbers/Vector2\")"
const Vector2_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Numbers/Vector2");
...
const Bezier_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Algorithms/Bezier");
...
const libtess_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("lib/libtess");
...
/* provided dependency */ var opentype = __webpack_require__(651);
/*******************************************************************************
 *
 * DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS FILE HEADER.
 *
...
const X3DGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Rendering/X3DGeometryNode");

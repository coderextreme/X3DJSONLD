...
const X3DSingleTextureNode_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Texturing/X3DSingleTextureNode");
...
const BitSet_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Utility/BitSet");
...
const X3DRenderObject_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Rendering/X3DRenderObject");
...
const TextureBuffer_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Rendering/TextureBuffer");
...
const Camera_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Geometry/Camera");
...
const ViewVolume_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Geometry/ViewVolume");
...
const Vector4_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Numbers/Vector4");
...
const DEVELOPMENT_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/DEVELOPMENT");

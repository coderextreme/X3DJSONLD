...
const Complex_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Numbers/Complex");
...
const IndexedFaceSet_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Geometry3D/IndexedFaceSet");
...
const Coordinate_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Rendering/Coordinate");
...
const TextureCoordinate_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Texturing/TextureCoordinate");
...
const X3DLineGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Rendering/X3DLineGeometryNode");
...
const X3DPointGeometryNode_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Rendering/X3DPointGeometryNode");

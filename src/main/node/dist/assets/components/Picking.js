...
const X3DSensorNode_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("x_ite/Components/Core/X3DSensorNode");
...
const ObjectCache_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Utility/ObjectCache");
...
const Line3_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("standard/Math/Geometry/Line3");
...
const AmmoClass_namespaceObject = window [Symbol .for ("X_ITE.X3D")] .require ("lib/ammojs/AmmoClass");

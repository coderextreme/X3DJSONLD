...
"        <Inline DEF=\"Flower\" url='\"bumpyx_ite.x3d\"' />"]))
          ...
          .addChild((new autoclass.Transform())
            .addChild((new autoclass.Shape())
              .setGeometry((new autoclass.Sphere()).setRadius(40))
              .setAppearance((new autoclass.Appearance())
                ...
                .addShaders((new autoclass.ComposedShader("x_iteShader")).setLanguage("GLSL")
                  .addField((new autoclass.field()).setName("chromaticDispertion").setType("SFVec3f").setAccessType("inputOnly").setValue("0.98 1.0 1.033"))
                  .addField((new autoclass.field()).setName("cube").setType("SFNode").setAccessType("inputOnly")
...
"                  <ShaderPart url='\"../shaders/x_itebubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>"])))))))
        ...
        .addChild((new autoclass.DISEntityManager("EntityManager")).setNetworkMode("networkReader")
          .addChild((new autoclass.DISEntityTypeMapping()).setCategory(77).setSpecific(1).setUrl(new autoclass.MFString("\"Leif8Final.x3d\"")))
          .addChild((new autoclass.DISEntityTypeMapping()).setCategory(77).setSpecific(2).setUrl(new autoclass.MFString("\"Lily8Final.x3d\""))))
...
"         like a HUD (heads up display) ]))
      .addLayers((new autoclass.LayoutLayer()).setObjectType(new autoclass.MFString("\"ALL\"")).setPickable(true)
        ...
        .setLayout((new autoclass.Layout()).setAlign(new autoclass.MFString("\"RIGHT\",\"BOTTOM\"")).setOffset(java.newArray("float", [0.0,.0,0.2])).setOffsetUnits(new autoclass.MFString("\"WORLD\",\"WORLD\"")).setScaleMode(new autoclass.MFString("\"NONE\",\"NONE\"")).setSize(java.newArray("float", [0.4,.0,0.6])).setSizeUnits(new autoclass.MFString("\"WORLD\",\"WORLD\"")))
...
"	  ecmascript: function newTranslation(Value) { aValue_changed = Value.x * 30; }" + "\n")
          ...
          .addField((new autoclass.field()).setName("aValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { bValue_changed = Value.x * 30; }" + "\n")
          .addField((new autoclass.field()).setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField((new autoclass.field()).setName("bValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { cValue_changed = Value.x * 5; }" + "\n")
          .addField((new autoclass.field()).setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField((new autoclass.field()).setName("cValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { dValue_changed = Value.x * 5; }" + "\n")
          .addField((new autoclass.field()).setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField((new autoclass.field()).setName("dValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { pdeltaValue_changed = Value.x; }" + "\n")
          .addField((new autoclass.field()).setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField((new autoclass.field()).setName("pdeltaValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { tdeltaValue_changed = Value.x; }" + "\n")
          .addField((new autoclass.field()).setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField((new autoclass.field()).setName("tdeltaValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
        ...
        .addChild((new autoclass.ROUTE()).setFromNode("aValueTransformerScript").setFromField("aValue_changed").setToNode("x_iteShader").setToField("a"))
        .addChild((new autoclass.ROUTE()).setFromNode("bValueTransformerScript").setFromField("bValue_changed").setToNode("x_iteShader").setToField("b"))
        .addChild((new autoclass.ROUTE()).setFromNode("cValueTransformerScript").setFromField("cValue_changed").setToNode("x_iteShader").setToField("c"))
        .addChild((new autoclass.ROUTE()).setFromNode("dValueTransformerScript").setFromField("dValue_changed").setToNode("x_iteShader").setToField("d"))
        .addChild((new autoclass.ROUTE()).setFromNode("pdeltaValueTransformerScript").setFromField("pdeltaValue_changed").setToNode("x_iteShader").setToField("pdelta"))
        .addChild((new autoclass.ROUTE()).setFromNode("tdeltaValueTransformerScript").setFromField("tdeltaValue_changed").setToNode("x_iteShader").setToField("tdelta")))));
  },

      ...
      .addLayers((new autoclass.LayoutLayer()).setObjectType(new autoclass.MFString("\"ALL\"")).setPickable(true)
        ...
        .addChild((new autoclass.ProtoDeclare()).setName("SliderProto")
          .setProtoInterface((new autoclass.ProtoInterface())
            .addField((new autoclass.field()).setName("sliderTranslation").setType("SFVec3f").setAccessType("inputOutput").setValue("0 0.7 0"))
            .addField((new autoclass.field()).setName("transformTranslation").setType("SFVec3f").setAccessType("inputOutput").setValue("0 0 0.1"))
            .addField((new autoclass.field()).setName("sensorTranslation").setType("SFVec3f").setAccessType("inputOutput").setValue("0 0 0.0"))
            .addField((new autoclass.field()).setName("textString").setType("MFString").setAccessType("inputOutput").setValue("\"a=\""))
...
"}" + "\n")
                ...
                .addField((new autoclass.field()).setName("protoText_changed").setType("MFString").setAccessType("outputOnly").setValue("1.0"))
                .setIS((new autoclass.IS())

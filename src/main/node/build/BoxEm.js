  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("anyShape")
      .setProtoInterface((new autoclass.ProtoInterface())
        .addField((new autoclass.field()).setName("xtranslation").setType("SFVec3f").setAccessType("inputOutput").setValue("0 0 0"))
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("three")
      .setProtoInterface((new autoclass.ProtoInterface())
        .addField((new autoclass.field()).setName("ytranslation").setType("SFVec3f").setAccessType("inputOutput").setValue("0 0 0"))
        .addField((new autoclass.field()).setName("myShape").setType("MFNode").setAccessType("inputOutput")
          .addChild((new autoclass.Shape())

...
DOM2JSONSerializer.prototype = {
	serializeToString : function(json, element, clazz, mapToMethod, fieldTypes) {
		...
		if (typeof obj['X3D']['head'] !== 'undefined') {
			...
			obj['X3D']['head']['meta'].push({ "@name":"translated", "@content":date.getDate()+" "+month+" "+date.getFullYear()});
 			obj['X3D']['head']['meta'].push({ "@name":"generator", "@content":"DOM2JSONSerializer.mjs, https://github.com/coderextreme/X3DJSONLD/blob/master/src/main/node/DOM2JSONSerializer.mjs" });
			//  fake X3dToJson.xslt
	...
	parseBool: function(value) {
		if (value === "False") {
			...
			return "UNKNOWN BOOLEAN "+value+", Fix parseBool in DOM2JSONSerializer.mjs";
		}
	},

 ...
 <p> Related links: HAnimSpecificationLOA3Invisible.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;" summary="Scene Metadata">
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/HAnimSpecificationLOA3Invisible.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/HAnimSpecificationLOA3Invisible.x3d</a> </td>
		</tr>
		<tr>
...
HAnimSpecificationLOA3Invisible.prototype = {
  ...
  .setHead((new autoclass.head())
    ...
    .addMeta((new autoclass.meta()).setName("modified").setContent("11 July 2020"))
    ...
    .addMeta((new autoclass.meta()).setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/HAnimSpecificationLOA3Invisible.x3d"))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		console.log ("HAnimSpecificationLOA3Invisible execution self-validation test results: " + testObject.validateSelf());
	}
}

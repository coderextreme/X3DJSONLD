...
function LOA4ExampleSourceWithDiamonds
...
LOA4ExampleSourceWithDiamonds.prototype = {
  ...
  initialize : function ()
  {
	...
	/** Large attribute array: fieldValue value field, scene-graph level=4, element #1305, 62 total values */
	this.fieldValue_info_4_1305_value = new autoclass.SFString("\"authorName=Matthew T. Beitler\" \"authorEmail=beitler@cis.upenn.edu or beitler@acm.org\" \"creationDate=05/12/99\" \"copyright=Copyright 1999-2003, Matthew T. Beitler\" \"humanoidVersion=JointCenters 200x, LOA&#8209;4\" \"usageRestrictions=
	...
	/** Large attribute array: WorldInfo info field, scene-graph level=4, element #1307, 74 total values */
	this.WorldInfo_4_1307_info = new autoclass.MFString(new autoclass.MFString("\"
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ProtoInstance("humanoid_2", "Humanoid")).setDEF("humanoid_2").setName("Humanoid")
      .addFieldValue((new autoclass.fieldValue()).setName("humanoidBody")
        .setHumanoidBody((new autoclass.ProtoInstance("hanim_humanoid_root_2", "Joint")).setDEF("hanim_humanoid_root_2").setName("Joint")
          ...
          .addFieldValue((new autoclass.fieldValue()).setName("children")
            .addChild((new autoclass.ProtoInstance("hanim_sacroiliac_2", "Joint")).setDEF("hanim_sacroiliac_2").setName("Joint")
              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
              ...
              .addFieldValue((new autoclass.fieldValue()).setName("children")
                .addChild((new autoclass.ProtoInstance("hanim_l_hip_2", "Joint")).setDEF("hanim_l_hip_2").setName("Joint")
                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                  ...
                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                    .addChild((new autoclass.ProtoInstance("hanim_l_knee_2", "Joint")).setDEF("hanim_l_knee_2").setName("Joint")
                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                      ...
                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                        .addChild((new autoclass.ProtoInstance("hanim_l_talocrural_2", "Joint")).setDEF("hanim_l_talocrural_2").setName("Joint")
                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                          ...
                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                            .addChild((new autoclass.ProtoInstance("hanim_l_tarsotarsal_interphalangeal__2", "Joint")).setDEF("hanim_l_tarsotarsal_interphalangeal__2").setName("Joint")
                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                              ...
                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                .addChild((new autoclass.ProtoInstance("hanim_l_metatarsophalangeal__2", "Joint")).setDEF("hanim_l_metatarsophalangeal__2").setName("Joint")
                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_metatarsophalangeal_"))
                                  .addFieldValue((new autoclass.fieldValue()).setName("center").setValue("0.108599998056889 0.0000999999974737875 0.0368000008165836"))
                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                    .addChild((new autoclass.ProtoInstance("hanim_l_tarsal_interphalangeal__2", "Joint")).setDEF("hanim_l_tarsal_interphalangeal__2").setName("Joint")
                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                      ...
                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                        .addChild((new autoclass.ProtoInstance("hanim_l_tarsal_distal_phalanx2", "Segment")).setDEF("hanim_l_tarsal_distal_phalanx2").setName("Segment")
                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_tarsal_distal_phalanx_1"))
                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                            .addChild((new autoclass.ProtoInstance("hanim_l_tarsal_distal_phalanx_1_tip_2", "Site")).setDEF("hanim_l_tarsal_distal_phalanx_1_tip_2").setName("Site")
                                    ...
                                    .addChild((new autoclass.ProtoInstance("hanim_l_middistal_2", "Segment")).setDEF("hanim_l_middistal_2").setName("Segment")
                                ...
                                .addChild((new autoclass.ProtoInstance("hanim_l_midproximal_2", "Segment")).setDEF("hanim_l_midproximal_2").setName("Segment")
                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_midproximal")))))
                            .addChild((new autoclass.ProtoInstance("hanim_l_hindfoot_2", "Segment")).setDEF("hanim_l_hindfoot_2").setName("Segment")
                        ...
                        .addChild((new autoclass.ProtoInstance("hanim_l_calf_2", "Segment")).setDEF("hanim_l_calf_2").setName("Segment")
                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_calf")))))
                    .addChild((new autoclass.ProtoInstance("hanim_l_thigh_2", "Segment")).setDEF("hanim_l_thigh_2").setName("Segment")
                ...
                .addChild((new autoclass.ProtoInstance("hanim_r_hip_2", "Joint")).setDEF("hanim_r_hip_2").setName("Joint")
                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                  ...
                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                    .addChild((new autoclass.ProtoInstance("hanim_r_knee_2", "Joint")).setDEF("hanim_r_knee_2").setName("Joint")
                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                      ...
                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                        .addChild((new autoclass.ProtoInstance("hanim_r_talocrural_2", "Joint")).setDEF("hanim_r_talocrural_2").setName("Joint")
                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                          ...
                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                            .addChild((new autoclass.ProtoInstance("hanim_r_tarsotarsal_interphalangeal__2", "Joint")).setDEF("hanim_r_tarsotarsal_interphalangeal__2").setName("Joint")
                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                              ...
                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                .addChild((new autoclass.ProtoInstance("hanim_r_metatarsophalangeal__2", "Joint")).setDEF("hanim_r_metatarsophalangeal__2").setName("Joint")
                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_metatarsophalangeal_"))
                                  .addFieldValue((new autoclass.fieldValue()).setName("center").setValue("-0.0800999999046326 0 0.0368000008165836"))
                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                    .addChild((new autoclass.ProtoInstance("hanim_r_tarsal_interphalangeal__2", "Joint")).setDEF("hanim_r_tarsal_interphalangeal__2").setName("Joint")
                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                      ...
                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                        .addChild((new autoclass.ProtoInstance("hanim_r_tarsal_distal_phalanx2", "Segment")).setDEF("hanim_r_tarsal_distal_phalanx2").setName("Segment")
                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_tarsal_distal_phalanx_1"))
                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                            .addChild((new autoclass.ProtoInstance("hanim_r_tarsal_distal_phalanx_1_tip_2", "Site")).setDEF("hanim_r_tarsal_distal_phalanx_1_tip_2").setName("Site")
                                    ...
                                    .addChild((new autoclass.ProtoInstance("hanim_r_middistal_2", "Segment")).setDEF("hanim_r_middistal_2").setName("Segment")
                                ...
                                .addChild((new autoclass.ProtoInstance("hanim_r_midproximal_2", "Segment")).setDEF("hanim_r_midproximal_2").setName("Segment")
                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_midproximal")))))
                            .addChild((new autoclass.ProtoInstance("hanim_r_hindfoot_2", "Segment")).setDEF("hanim_r_hindfoot_2").setName("Segment")
                        ...
                        .addChild((new autoclass.ProtoInstance("hanim_r_calf_2", "Segment")).setDEF("hanim_r_calf_2").setName("Segment")
                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_calf")))))
                    .addChild((new autoclass.ProtoInstance("hanim_r_thigh_2", "Segment")).setDEF("hanim_r_thigh_2").setName("Segment")
                ...
                .addChild((new autoclass.ProtoInstance("hanim_pelvis_2", "Segment")).setDEF("hanim_pelvis_2").setName("Segment")
            ...
            .addChild((new autoclass.ProtoInstance("hanim_vl5_2", "Joint")).setDEF("hanim_vl5_2").setName("Joint")
              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
              ...
              .addFieldValue((new autoclass.fieldValue()).setName("children")
                .addChild((new autoclass.ProtoInstance("hanim_vl4_2", "Joint")).setDEF("hanim_vl4_2").setName("Joint")
                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                  ...
                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                    .addChild((new autoclass.ProtoInstance("hanim_vl3_2", "Joint")).setDEF("hanim_vl3_2").setName("Joint")
                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                      ...
                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                        .addChild((new autoclass.ProtoInstance("hanim_vl2_2", "Joint")).setDEF("hanim_vl2_2").setName("Joint")
                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                          ...
                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                            .addChild((new autoclass.ProtoInstance("hanim_vl1_2", "Joint")).setDEF("hanim_vl1_2").setName("Joint")
                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                              ...
                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                .addChild((new autoclass.ProtoInstance("hanim_vt12_2", "Joint")).setDEF("hanim_vt12_2").setName("Joint")
                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                  ...
                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                    .addChild((new autoclass.ProtoInstance("hanim_vt11_2", "Joint")).setDEF("hanim_vt11_2").setName("Joint")
                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                      ...
                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                        .addChild((new autoclass.ProtoInstance("hanim_vt10_2", "Joint")).setDEF("hanim_vt10_2").setName("Joint")
                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                          ...
                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                            .addChild((new autoclass.ProtoInstance("hanim_vt9_2", "Joint")).setDEF("hanim_vt9_2").setName("Joint")
                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                              ...
                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                .addChild((new autoclass.ProtoInstance("hanim_vt8_2", "Joint")).setDEF("hanim_vt8_2").setName("Joint")
                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                  ...
                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                    .addChild((new autoclass.ProtoInstance("hanim_vt7_2", "Joint")).setDEF("hanim_vt7_2").setName("Joint")
                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                      ...
                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                        .addChild((new autoclass.ProtoInstance("hanim_vt6_2", "Joint")).setDEF("hanim_vt6_2").setName("Joint")
                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                          ...
                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                            .addChild((new autoclass.ProtoInstance("hanim_vt5_2", "Joint")).setDEF("hanim_vt5_2").setName("Joint")
                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                              ...
                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                .addChild((new autoclass.ProtoInstance("hanim_vt4_2", "Joint")).setDEF("hanim_vt4_2").setName("Joint")
                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                  ...
                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                    .addChild((new autoclass.ProtoInstance("hanim_vt3_2", "Joint")).setDEF("hanim_vt3_2").setName("Joint")
                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                      ...
                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                        .addChild((new autoclass.ProtoInstance("hanim_vt2_2", "Joint")).setDEF("hanim_vt2_2").setName("Joint")
                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                          ...
                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                            .addChild((new autoclass.ProtoInstance("hanim_vt1_2", "Joint")).setDEF("hanim_vt1_2").setName("Joint")
                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                              ...
                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                .addChild((new autoclass.ProtoInstance("hanim_vc7_2", "Joint")).setDEF("hanim_vc7_2").setName("Joint")
                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                  ...
                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                    .addChild((new autoclass.ProtoInstance("hanim_vc6_2", "Joint")).setDEF("hanim_vc6_2").setName("Joint")
                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                      ...
                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                        .addChild((new autoclass.ProtoInstance("hanim_vc5_2", "Joint")).setDEF("hanim_vc5_2").setName("Joint")
                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                          ...
                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                            .addChild((new autoclass.ProtoInstance("hanim_vc4_2", "Joint")).setDEF("hanim_vc4_2").setName("Joint")
                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                              ...
                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                .addChild((new autoclass.ProtoInstance("hanim_vc3_2", "Joint")).setDEF("hanim_vc3_2").setName("Joint")
                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                  ...
                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_vc2_2", "Joint")).setDEF("hanim_vc2_2").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_vc1_2", "Joint")).setDEF("hanim_vc1_2").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_skullbase_2", "Joint")).setDEF("hanim_skullbase_2").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_eyeball_4", "Joint")).setDEF("hanim_l_eyeball_4").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_eyeball_3", "Segment")).setDEF("hanim_l_eyeball_3").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_eyeball")))))
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_eyeball_4", "Joint")).setDEF("hanim_r_eyeball_4").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_eyeball_3", "Segment")).setDEF("hanim_r_eyeball_3").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_eyeball")))))
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_skull_2", "Segment")).setDEF("hanim_skull_2").setName("Segment")
                                                                                                            ...
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_c1_2", "Segment")).setDEF("hanim_c1_2").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("c1")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_c2_2", "Segment")).setDEF("hanim_c2_2").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("c2")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_c3_2", "Segment")).setDEF("hanim_c3_2").setName("Segment")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("c3")))))
                                                                                                .addChild((new autoclass.ProtoInstance("hanim_c4_2", "Segment")).setDEF("hanim_c4_2").setName("Segment")
                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("c4")))))
                                                                                            .addChild((new autoclass.ProtoInstance("hanim_c5_2", "Segment")).setDEF("hanim_c5_2").setName("Segment")
                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("c5")))))
                                                                                        .addChild((new autoclass.ProtoInstance("hanim_c6_2", "Segment")).setDEF("hanim_c6_2").setName("Segment")
                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("c6")))))
                                                                                    .addChild((new autoclass.ProtoInstance("hanim_c7_2", "Segment")).setDEF("hanim_c7_2").setName("Segment")
                                                                                ...
                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_sternoclavicular_2", "Joint")).setDEF("hanim_l_sternoclavicular_2").setName("Joint")
                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                  ...
                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_acromioclavicular_2", "Joint")).setDEF("hanim_l_acromioclavicular_2").setName("Joint")
                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                      ...
                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_shoulder_2", "Joint")).setDEF("hanim_l_shoulder_2").setName("Joint")
                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                          ...
                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_elbow_2", "Joint")).setDEF("hanim_l_elbow_2").setName("Joint")
                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                              ...
                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_radiocarpal_2", "Joint")).setDEF("hanim_l_radiocarpal_2").setName("Joint")
                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                  ...
                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpometacarpal2", "Joint")).setDEF("hanim_l_carpometacarpal2").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_metacarpophalangeal2", "Joint")).setDEF("hanim_l_metacarpophalangeal2").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_carpal_interphalangeal2", "Joint")).setDEF("hanim_l_carpal_interphalangeal2").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx2", "Segment")).setDEF("hanim_l_carpal_distal_phalanx2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_carpal_distal_phalanx_1"))
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx_1_tip_2", "Site")).setDEF("hanim_l_carpal_distal_phalanx_1_tip_2").setName("Site")
                                                                                                            ...
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_index_proximal_2", "Segment")).setDEF("hanim_l_index_proximal_2").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_index_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_index_proximal_4", "Segment")).setDEF("hanim_l_index_proximal_4").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_index_proximal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpometacarpal3", "Joint")).setDEF("hanim_l_carpometacarpal3").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_metacarpophalangeal3", "Joint")).setDEF("hanim_l_metacarpophalangeal3").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_carpal_proximal_interphalangeal3", "Joint")).setDEF("hanim_l_carpal_proximal_interphalangeal3").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_interphalangeal3", "Joint")).setDEF("hanim_l_carpal_distal_interphalangeal3").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx3", "Segment")).setDEF("hanim_l_carpal_distal_phalanx3").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_carpal_distal_phalanx_2"))
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx_2_tip_2", "Site")).setDEF("hanim_l_carpal_distal_phalanx_2_tip_2").setName("Site")
                                                                                                                ...
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_index_middle_2", "Segment")).setDEF("hanim_l_index_middle_2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_index_middle")))))
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_index_proximal_6", "Segment")).setDEF("hanim_l_index_proximal_6").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_index_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_index_metacarpal_2", "Segment")).setDEF("hanim_l_index_metacarpal_2").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_index_metacarpal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpometacarpal4", "Joint")).setDEF("hanim_l_carpometacarpal4").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_metacarpophalangeal4", "Joint")).setDEF("hanim_l_metacarpophalangeal4").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_carpal_proximal_interphalangeal4", "Joint")).setDEF("hanim_l_carpal_proximal_interphalangeal4").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_interphalangeal4", "Joint")).setDEF("hanim_l_carpal_distal_interphalangeal4").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx4", "Segment")).setDEF("hanim_l_carpal_distal_phalanx4").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_carpal_distal_phalanx_3"))
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx_3_tip_2", "Site")).setDEF("hanim_l_carpal_distal_phalanx_3_tip_2").setName("Site")
                                                                                                                ...
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_middle_middle_2", "Segment")).setDEF("hanim_l_middle_middle_2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_middle_middle")))))
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_middle_proximal_2", "Segment")).setDEF("hanim_l_middle_proximal_2").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_middle_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_middle_metacarpal_2", "Segment")).setDEF("hanim_l_middle_metacarpal_2").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_middle_metacarpal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpometacarpal5", "Joint")).setDEF("hanim_l_carpometacarpal5").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_metacarpophalangeal5", "Joint")).setDEF("hanim_l_metacarpophalangeal5").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_carpal_proximal_interphalangeal5", "Joint")).setDEF("hanim_l_carpal_proximal_interphalangeal5").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_interphalangeal5", "Joint")).setDEF("hanim_l_carpal_distal_interphalangeal5").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx5", "Segment")).setDEF("hanim_l_carpal_distal_phalanx5").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_carpal_distal_phalanx_4"))
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx_4_tip_2", "Site")).setDEF("hanim_l_carpal_distal_phalanx_4_tip_2").setName("Site")
                                                                                                                ...
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_ring_middle_2", "Segment")).setDEF("hanim_l_ring_middle_2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_ring_middle")))))
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_ring_proximal_2", "Segment")).setDEF("hanim_l_ring_proximal_2").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_ring_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_ring_metacarpal_2", "Segment")).setDEF("hanim_l_ring_metacarpal_2").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_ring_metacarpal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpometacarpal6", "Joint")).setDEF("hanim_l_carpometacarpal6").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_metacarpophalangeal6", "Joint")).setDEF("hanim_l_metacarpophalangeal6").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_carpal_proximal_interphalangeal6", "Joint")).setDEF("hanim_l_carpal_proximal_interphalangeal6").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_interphalangeal6", "Joint")).setDEF("hanim_l_carpal_distal_interphalangeal6").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx6", "Segment")).setDEF("hanim_l_carpal_distal_phalanx6").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_carpal_distal_phalanx_5"))
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_carpal_distal_phalanx_5_tip_2", "Site")).setDEF("hanim_l_carpal_distal_phalanx_5_tip_2").setName("Site")
                                                                                                                ...
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_pinky_middle_2", "Segment")).setDEF("hanim_l_pinky_middle_2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_pinky_middle")))))
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_pinky_proximal_2", "Segment")).setDEF("hanim_l_pinky_proximal_2").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_pinky_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_pinky_metacarpal_2", "Segment")).setDEF("hanim_l_pinky_metacarpal_2").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_pinky_metacarpal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_hand_2", "Segment")).setDEF("hanim_l_hand_2").setName("Segment")
                                                                                                ...
                                                                                                .addChild((new autoclass.ProtoInstance("hanim_l_forearm_2", "Segment")).setDEF("hanim_l_forearm_2").setName("Segment")
                                                                                            ...
                                                                                            .addChild((new autoclass.ProtoInstance("hanim_l_upperarm_2", "Segment")).setDEF("hanim_l_upperarm_2").setName("Segment")
                                                                                        ...
                                                                                        .addChild((new autoclass.ProtoInstance("hanim_l_scapula_2", "Segment")).setDEF("hanim_l_scapula_2").setName("Segment")
                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l_scapula")))))
                                                                                    .addChild((new autoclass.ProtoInstance("hanim_l_clavicle_2", "Segment")).setDEF("hanim_l_clavicle_2").setName("Segment")
                                                                                ...
                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_sternoclavicular_2", "Joint")).setDEF("hanim_r_sternoclavicular_2").setName("Joint")
                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                  ...
                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_acromioclavicular_2", "Joint")).setDEF("hanim_r_acromioclavicular_2").setName("Joint")
                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                      ...
                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_shoulder_2", "Joint")).setDEF("hanim_r_shoulder_2").setName("Joint")
                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                          ...
                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_elbow_2", "Joint")).setDEF("hanim_r_elbow_2").setName("Joint")
                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                              ...
                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_radiocarpal_2", "Joint")).setDEF("hanim_r_radiocarpal_2").setName("Joint")
                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                  ...
                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpometacarpal2", "Joint")).setDEF("hanim_r_carpometacarpal2").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_metacarpophalangeal2", "Joint")).setDEF("hanim_r_metacarpophalangeal2").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_carpal_interphalangeal2", "Joint")).setDEF("hanim_r_carpal_interphalangeal2").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx2", "Segment")).setDEF("hanim_r_carpal_distal_phalanx2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_carpal_distal_phalanx_1"))
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx_1_tip_2", "Site")).setDEF("hanim_r_carpal_distal_phalanx_1_tip_2").setName("Site")
                                                                                                            ...
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_index_proximal_2", "Segment")).setDEF("hanim_r_index_proximal_2").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_index_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_index_proximal_4", "Segment")).setDEF("hanim_r_index_proximal_4").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_index_proximal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpometacarpal3", "Joint")).setDEF("hanim_r_carpometacarpal3").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_metacarpophalangeal3", "Joint")).setDEF("hanim_r_metacarpophalangeal3").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_carpal_proximal_interphalangeal3", "Joint")).setDEF("hanim_r_carpal_proximal_interphalangeal3").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_interphalangeal3", "Joint")).setDEF("hanim_r_carpal_distal_interphalangeal3").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx3", "Segment")).setDEF("hanim_r_carpal_distal_phalanx3").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_carpal_distal_phalanx_2"))
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx_2_tip_2", "Site")).setDEF("hanim_r_carpal_distal_phalanx_2_tip_2").setName("Site")
                                                                                                                ...
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_index_middle_2", "Segment")).setDEF("hanim_r_index_middle_2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_index_middle")))))
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_index_proximal_6", "Segment")).setDEF("hanim_r_index_proximal_6").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_index_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_index_metacarpal_2", "Segment")).setDEF("hanim_r_index_metacarpal_2").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_index_metacarpal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpometacarpal4", "Joint")).setDEF("hanim_r_carpometacarpal4").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_metacarpophalangeal4", "Joint")).setDEF("hanim_r_metacarpophalangeal4").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_carpal_proximal_interphalangeal4", "Joint")).setDEF("hanim_r_carpal_proximal_interphalangeal4").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_interphalangeal4", "Joint")).setDEF("hanim_r_carpal_distal_interphalangeal4").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx4", "Segment")).setDEF("hanim_r_carpal_distal_phalanx4").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_carpal_distal_phalanx_3"))
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx_3_tip_2", "Site")).setDEF("hanim_r_carpal_distal_phalanx_3_tip_2").setName("Site")
                                                                                                                ...
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_middle_middle_2", "Segment")).setDEF("hanim_r_middle_middle_2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_middle_middle")))))
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_middle_proximal_2", "Segment")).setDEF("hanim_r_middle_proximal_2").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_middle_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_middle_metacarpal_2", "Segment")).setDEF("hanim_r_middle_metacarpal_2").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_middle_metacarpal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpometacarpal5", "Joint")).setDEF("hanim_r_carpometacarpal5").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_metacarpophalangeal5", "Joint")).setDEF("hanim_r_metacarpophalangeal5").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_carpal_proximal_interphalangeal5", "Joint")).setDEF("hanim_r_carpal_proximal_interphalangeal5").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_interphalangeal5", "Joint")).setDEF("hanim_r_carpal_distal_interphalangeal5").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx5", "Segment")).setDEF("hanim_r_carpal_distal_phalanx5").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_carpal_distal_phalanx_4"))
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx_4_tip_2", "Site")).setDEF("hanim_r_carpal_distal_phalanx_4_tip_2").setName("Site")
                                                                                                                ...
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_ring_middle_2", "Segment")).setDEF("hanim_r_ring_middle_2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_ring_middle")))))
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_ring_proximal_2", "Segment")).setDEF("hanim_r_ring_proximal_2").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_ring_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_ring_metacarpal_2", "Segment")).setDEF("hanim_r_ring_metacarpal_2").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_ring_metacarpal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpometacarpal6", "Joint")).setDEF("hanim_r_carpometacarpal6").setName("Joint")
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                      ...
                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_metacarpophalangeal6", "Joint")).setDEF("hanim_r_metacarpophalangeal6").setName("Joint")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                          ...
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_carpal_proximal_interphalangeal6", "Joint")).setDEF("hanim_r_carpal_proximal_interphalangeal6").setName("Joint")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                              ...
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_interphalangeal6", "Joint")).setDEF("hanim_r_carpal_distal_interphalangeal6").setName("Joint")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("stiffness").setValue("1 1 1"))
                                                                                                                  ...
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx6", "Segment")).setDEF("hanim_r_carpal_distal_phalanx6").setName("Segment")
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_carpal_distal_phalanx_5"))
                                                                                                                      .addFieldValue((new autoclass.fieldValue()).setName("children")
                                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_carpal_distal_phalanx_5_tip_2", "Site")).setDEF("hanim_r_carpal_distal_phalanx_5_tip_2").setName("Site")
                                                                                                                ...
                                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_pinky_middle_2", "Segment")).setDEF("hanim_r_pinky_middle_2").setName("Segment")
                                                                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_pinky_middle")))))
                                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_pinky_proximal_2", "Segment")).setDEF("hanim_r_pinky_proximal_2").setName("Segment")
                                                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_pinky_proximal")))))
                                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_pinky_metacarpal_2", "Segment")).setDEF("hanim_r_pinky_metacarpal_2").setName("Segment")
                                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_pinky_metacarpal")))))
                                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_hand_2", "Segment")).setDEF("hanim_r_hand_2").setName("Segment")
                                                                                                ...
                                                                                                .addChild((new autoclass.ProtoInstance("hanim_r_forearm_2", "Segment")).setDEF("hanim_r_forearm_2").setName("Segment")
                                                                                            ...
                                                                                            .addChild((new autoclass.ProtoInstance("hanim_r_upperarm_2", "Segment")).setDEF("hanim_r_upperarm_2").setName("Segment")
                                                                                        ...
                                                                                        .addChild((new autoclass.ProtoInstance("hanim_r_scapula_2", "Segment")).setDEF("hanim_r_scapula_2").setName("Segment")
                                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("r_scapula")))))
                                                                                    .addChild((new autoclass.ProtoInstance("hanim_r_clavicle_2", "Segment")).setDEF("hanim_r_clavicle_2").setName("Segment")
                                                                                ...
                                                                                .addChild((new autoclass.ProtoInstance("hanim_t1_2", "Segment")).setDEF("hanim_t1_2").setName("Segment")
                                                                            ...
                                                                            .addChild((new autoclass.ProtoInstance("hanim_t2_2", "Segment")).setDEF("hanim_t2_2").setName("Segment")
                                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("t2")))))
                                                                        .addChild((new autoclass.ProtoInstance("hanim_t3_2", "Segment")).setDEF("hanim_t3_2").setName("Segment")
                                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("t3")))))
                                                                    .addChild((new autoclass.ProtoInstance("hanim_t4_2", "Segment")).setDEF("hanim_t4_2").setName("Segment")
                                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("t4")))))
                                                                .addChild((new autoclass.ProtoInstance("hanim_t5_2", "Segment")).setDEF("hanim_t5_2").setName("Segment")
                                                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("t5")))))
                                                            .addChild((new autoclass.ProtoInstance("hanim_t6_2", "Segment")).setDEF("hanim_t6_2").setName("Segment")
                                                              .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("t6")))))
                                                        .addChild((new autoclass.ProtoInstance("hanim_t7_2", "Segment")).setDEF("hanim_t7_2").setName("Segment")
                                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("t7")))))
                                                    .addChild((new autoclass.ProtoInstance("hanim_t8_2", "Segment")).setDEF("hanim_t8_2").setName("Segment")
                                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("t8")))))
                                                .addChild((new autoclass.ProtoInstance("hanim_t9_2", "Segment")).setDEF("hanim_t9_2").setName("Segment")
                                            ...
                                            .addChild((new autoclass.ProtoInstance("hanim_t10_2", "Segment")).setDEF("hanim_t10_2").setName("Segment")
                                        ...
                                        .addChild((new autoclass.ProtoInstance("hanim_t11_2", "Segment")).setDEF("hanim_t11_2").setName("Segment")
                                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("t11")))))
                                    .addChild((new autoclass.ProtoInstance("hanim_t12_2", "Segment")).setDEF("hanim_t12_2").setName("Segment")
                                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("t12")))))
                                .addChild((new autoclass.ProtoInstance("hanim_l1_2", "Segment")).setDEF("hanim_l1_2").setName("Segment")
                                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l1")))))
                            .addChild((new autoclass.ProtoInstance("hanim_l2_2", "Segment")).setDEF("hanim_l2_2").setName("Segment")
                        ...
                        .addChild((new autoclass.ProtoInstance("hanim_l3_2", "Segment")).setDEF("hanim_l3_2").setName("Segment")
                          .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l3")))))
                    .addChild((new autoclass.ProtoInstance("hanim_l4_2", "Segment")).setDEF("hanim_l4_2").setName("Segment")
                      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("l4")))))
                .addChild((new autoclass.ProtoInstance("hanim_l5_2", "Segment")).setDEF("hanim_l5_2").setName("Segment")
      ...
      .addFieldValue((new autoclass.fieldValue()).setName("joints")
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_humanoid_root_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_sacroiliac_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_hip_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_knee_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_talocrural_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_tarsotarsal_interphalangeal__2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_metatarsophalangeal__2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_tarsal_interphalangeal__2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_hip_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_knee_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_talocrural_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_tarsotarsal_interphalangeal__2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_metatarsophalangeal__2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_tarsal_interphalangeal__2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vl5_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vl4_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vl3_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vl2_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vl1_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt12_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt11_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt10_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt9_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt8_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt7_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt6_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt5_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt4_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt3_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt2_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vt1_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vc7_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vc6_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vc5_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vc4_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vc3_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vc2_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_vc1_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_skullbase_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_eyeball_4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_eyeball_4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_sternoclavicular_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_acromioclavicular_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_shoulder_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_elbow_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_radiocarpal_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpometacarpal2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_metacarpophalangeal2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_interphalangeal2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpometacarpal3"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_metacarpophalangeal3"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_proximal_interphalangeal3"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_interphalangeal3"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpometacarpal4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_metacarpophalangeal4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_proximal_interphalangeal4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_interphalangeal4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpometacarpal5"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_metacarpophalangeal5"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_proximal_interphalangeal5"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_interphalangeal5"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpometacarpal6"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_metacarpophalangeal6"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_proximal_interphalangeal6"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_interphalangeal6"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_sternoclavicular_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_acromioclavicular_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_shoulder_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_elbow_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_radiocarpal_2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpometacarpal2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_metacarpophalangeal2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_interphalangeal2"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpometacarpal3"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_metacarpophalangeal3"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_proximal_interphalangeal3"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_interphalangeal3"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpometacarpal4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_metacarpophalangeal4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_proximal_interphalangeal4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_interphalangeal4"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpometacarpal5"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_metacarpophalangeal5"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_proximal_interphalangeal5"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_interphalangeal5"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpometacarpal6"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_metacarpophalangeal6"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_proximal_interphalangeal6"))
        .addJoints((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_interphalangeal6")))
      .addFieldValue((new autoclass.fieldValue()).setName("sites")
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_l_tarsal_distal_phalanx_1_tip_2"))
        ...
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_r_tarsal_distal_phalanx_1_tip_2"))
        ...
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx_1_tip_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx_2_tip_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_l_dactylion_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx_3_tip_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx_4_tip_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx_5_tip_2"))
        ...
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx_1_tip_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx_2_tip_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_r_dactylion_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx_3_tip_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx_4_tip_2"))
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx_5_tip_2"))
      ...
      .addFieldValue((new autoclass.fieldValue()).setName("segments")
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_tarsal_distal_phalanx2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_middistal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_midproximal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_hindfoot_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_calf_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_thigh_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_tarsal_distal_phalanx2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_middistal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_midproximal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_hindfoot_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_calf_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_thigh_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_pelvis_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_eyeball_4"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_eyeball_4"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_skull_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_c1_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_c2_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_c3_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_c4_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_c5_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_c6_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_c7_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_index_proximal_6"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_index_proximal_6"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx3"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_index_middle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_index_proximal_6"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_index_metacarpal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx4"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_middle_middle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_middle_proximal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_middle_metacarpal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx5"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_ring_middle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_ring_proximal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_ring_metacarpal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_carpal_distal_phalanx6"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_pinky_middle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_pinky_proximal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_pinky_metacarpal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_hand_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_forearm_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_upperarm_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_scapula_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l_clavicle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_index_proximal_6"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_index_proximal_6"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx3"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_index_middle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_index_proximal_6"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_index_metacarpal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx4"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_middle_middle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_middle_proximal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_middle_metacarpal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx5"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_ring_middle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_ring_proximal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_ring_metacarpal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_carpal_distal_phalanx6"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_pinky_middle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_pinky_proximal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_pinky_metacarpal_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_hand_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_forearm_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_upperarm_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_scapula_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_r_clavicle_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t1_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t2_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t3_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t4_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t5_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t6_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t7_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t8_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t9_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t10_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t11_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_t12_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l1_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l2_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l3_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l4_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_l5_2"))
        .addSegments((new autoclass.ProtoInstance()).setUSE("hanim_sacrum_2")))
      .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("humanoid"))
      .addFieldValue((new autoclass.fieldValue()).setName("info").setValue(this.fieldValue_info_4_1305_value)))
    .addChild((new autoclass.Group("JointCenters_WorldInfo"))
      .addChild((new autoclass.WorldInfo()).setInfo(this.WorldInfo_4_1307_info).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;4")))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new LOA4ExampleSourceWithDiamonds();
		console.log ("LOA4ExampleSourceWithDiamonds execution self-validation test results: " + testObject.validateSelf());
	}
}
new LOA4ExampleSourceWithDiamonds().main();
...
NeedClassName.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Transform()).setTranslation(0.0,-3.0,8.0)
      ...
      .setX3DScript((new autoclass.X3DScript("BindingSequencerEngine"))
        .addField((new autoclass.field()).setAccessType("inputOnly").setName("set_timeEvent").setType("SFInt32"))
        .addField((new autoclass.field()).setAccessType("outputOnly").setName("bindView1").setType("SFBool"))
        .addField((new autoclass.field()).setAccessType("outputOnly").setName("bindView2").setType("SFBool"))
        .addField((new autoclass.field()).setAccessType("outputOnly").setName("bindView3").setType("SFBool"))
        .addField((new autoclass.field()).setAccessType("outputOnly").setName("bindView4").setType("SFBool"))
        .addField((new autoclass.field()).setAccessType("outputOnly").setName("bindView5").setType("SFBool"))
        .addField((new autoclass.field()).setAccessType("inputOnly").setName("view1Bound").setType("SFBool"))
        .addField((new autoclass.field()).setAccessType("inputOnly").setName("view2Bound").setType("SFBool"))
        .addField((new autoclass.field()).setAccessType("inputOnly").setName("view3Bound").setType("SFBool"))
        .addField((new autoclass.field()).setAccessType("inputOnly").setName("view4Bound").setType("SFBool"))
        .addField((new autoclass.field()).setAccessType("initializeOnly").setName("priorInputvalue").setType("SFInt32").setValue("-1")))

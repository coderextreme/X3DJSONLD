  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("boxproto")
      .setProtoInterface((new autoclass.ProtoInterface())
        ...
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("diffuseColor").setType("SFColor").setValue("1 1 1")))
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("two")
      .setProtoInterface((new autoclass.ProtoInterface())
        ...
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("diffuseColor").setType("SFColor").setValue("1 0 0")))
      .setProtoBody((new autoclass.ProtoBody())
        .addChild((new autoclass.Transform())
          .setIS((new autoclass.IS())
            .addConnect((new autoclass.connect()).setNodeField("translation").setProtoField("ytranslation")))
          .addChild((new autoclass.ProtoInstance()).setName("boxproto")
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("four")
      .setProtoInterface((new autoclass.ProtoInterface())
        ...
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("x1diffuseColor").setType("SFColor").setValue("1 0 0"))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("x2diffuseColor").setType("SFColor").setValue("0 1 0")))
      .setProtoBody((new autoclass.ProtoBody())
        .addChild((new autoclass.Transform())
          .setIS((new autoclass.IS())
            .addConnect((new autoclass.connect()).setNodeField("translation").setProtoField("ztranslation")))
          .addChild((new autoclass.ProtoInstance()).setName("two")
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("eight")
      ...
      .setProtoBody((new autoclass.ProtoBody())
        .addChild((new autoclass.Transform())
          ...
          .addChild((new autoclass.ProtoInstance()).setName("four")
    ...
    .addChild((new autoclass.ProtoInstance()).setName("eight")
      .addFieldValue((new autoclass.fieldValue()).setName("ttranslation").setValue("0 0 0")))
    .addComments(java.newArray("java.lang.String",[" Axes below",
"      <Group>",
...
"      </Transform>"])));
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new rubikcoord();
		console.log ("rubikcoord execution self-validation test results: " + testObject.validateSelf());
	}
}
new rubikcoord().main();
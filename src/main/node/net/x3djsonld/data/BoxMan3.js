 ...
 * <p> A Seamless VRML Human, demonstrating the HAnim 2001 Specification, animation scripting via an external prototype (ExternProtoDeclare). </p>
 <p> Related links: BoxMan3.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;" summary="Scene Metadata">
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.BoxMan3&nbsp; Document Metadata </td>
		</tr>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3.js">BoxMan3.js</a> </td>
		</tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3.x3d</a> </td>
		</tr>
		<tr>
...
BoxMan3.prototype = {
  ...
  .setHead((new autoclass.head())
    ...
    .addMeta((new autoclass.meta()).setName("title").setContent("BoxMan3.x3d"))
    ...
    .addMeta((new autoclass.meta()).setName("modified").setContent("6 January 2023"))
    .addMeta((new autoclass.meta()).setName("reference").setContent("http://HAnim.org"))
    .addMeta((new autoclass.meta()).setName("reference").setContent("originals/boxman.wrl"))
    .addMeta((new autoclass.meta()).setName("reference").setContent("BoxMan3.js"))
    ...
    .addMeta((new autoclass.meta()).setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3.x3d"))
    .addMeta((new autoclass.meta()).setName("generator").setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta((new autoclass.meta()).setName("license").setContent("../license.html")))
  .setScene((new autoclass.Scene())
    .addChild((new autoclass.WorldInfo()).setInfo(this.WorldInfo_3_34_info).setTitle("BoxMan3 - A Seamless VRML Human"))
    ...
    .addChild((new autoclass.Script("ENGINE")).setDirectOutput(true).setUrl(new autoclass.MFString("\"BoxMan3.js\" \"https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3.js\""))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new BoxMan3();
		console.log ("BoxMan3 execution self-validation test results: " + testObject.validateSelf());
	}
}
new BoxMan3().main();
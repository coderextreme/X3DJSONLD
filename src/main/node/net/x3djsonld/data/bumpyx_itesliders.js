...
"                  <ShaderPart url='\"../shaders/x_itebubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>"])))))))
        ...
        .addChild((new autoclass.DISEntityManager("EntityManager")).setNetworkMode("networkReader")
          .addMapping((new autoclass.DISEntityTypeMapping()).setCategory(77).setSpecific(1).setUrl(new autoclass.MFString("\"Leif8Final.x3d\"")))
          .addMapping((new autoclass.DISEntityTypeMapping()).setCategory(77).setSpecific(2).setUrl(new autoclass.MFString("\"Lily8Final.x3d\""))))
...
"	  ecmascript: function newTranslation(Value) { tdeltaValue_changed = Value.x; }" + "\n")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		console.log ("bumpyx_itesliders execution self-validation test results: " + testObject.validateSelf());
		process.exit();
	}
}

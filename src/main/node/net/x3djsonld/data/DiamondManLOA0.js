...
DiamondManLOA0.prototype = {
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new DiamondManLOA0();
		console.log ("DiamondManLOA0 execution self-validation test results: " + testObject.validateSelf());
	}
}
new DiamondManLOA0().main();
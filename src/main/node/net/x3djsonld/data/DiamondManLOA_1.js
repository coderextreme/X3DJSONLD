            ...
            .addChild((new autoclass.HAnimJoint("hanim_r_knee")).setName("r_knee").setCenter(-0.0867,0.4913,0.0318)
              .addChild((new autoclass.HAnimSegment("hanim_r_calf")).setName("r_calf")
                .addChild((new autoclass.Transform()).setTranslation(-0.0867,0.4913,0.0318)
                  .addChild((new autoclass.Shape()).setUSE("DiamondShape"))))
              .addChild((new autoclass.HAnimJoint("hanim_r_ankle")).setName("r_ankle").setCenter(-0.0801,0.0712,-0.0766)
                ...
                .addChild((new autoclass.HAnimJoint("hanim_r_midtarsal")).setName("r_midtarsal").setCenter(-0.0801,0.0,0.0368)
        ...
        .addChild((new autoclass.HAnimJoint("hanim_vl1")).setName("vl1").setCenter(-0.00405,1.07,-0.0275)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_r_shoulder")).setName("r_shoulder").setCenter(-0.1907,1.4407,-0.0325)
            ...
            .addChild((new autoclass.HAnimJoint("hanim_r_elbow")).setName("r_elbow").setCenter(-0.1949,1.1388,-0.0620)
              ...
              .addChild((new autoclass.HAnimJoint("hanim_r_wrist")).setName("r_wrist").setCenter(-0.1959,0.8694,-0.0521)

...
NeedClassName.prototype = {
  ...
  initialize : function ()
  {
	...
	this.Coordinate_8_14_point = new autoclass.MFVec3f(java.newArray("float", [-0.349999994039536,-0.349999994039536,0.349999994039536,0.349999994039536,-0.349999994039536,0.349999994039536,0.349999994039536,-0.349999994039536,-0.349999994039536,-0.349999994039536,-0.349999994039536,-0.349999994039536,0.0,0.349999994039536,0.0]));

	/** Large attribute array: IndexedLineSet coordIndex field, scene-graph level=5, element #249, 54 total numbers */
	this.IndexedLineSet_5_249_coordIndex = new autoclass.MFInt32(java.newArray("int", [0,1,-1,2,3,-1,4,5,-1,6,7,-1,8,9,-1,10,11,-1,12,13,-1,14,15,-1,16,17,-1,18,19,-1,20,21,-1,22,23,-1,24,25,-1,26,27,-1,28,29,-1,30,31,-1,32,33,-1,34,35,-1]));
	...
	this.Coordinate_6_249_point = new autoclass.MFVec3f() /* splitting up long array to improve readability */
	...
	this.IndexedLineSet_5_254_coordIndex = new autoclass.MFInt32(java.newArray("int", [0,1,-1,2,3,-1,4,5,-1,6,7,-1,8,9,-1,10,11,-1,12,13,-1,14,15,-1,16,17,-1,18,19,-1,20,21,-1,22,23,-1,24,25,-1,26,27,-1,28,29,-1,30,31,-1,32,33,-1,34,35,-1]));
	...
	this.Coordinate_6_254_point = new autoclass.MFVec3f() /* splitting up long array to improve readability */
	...
	this.Coordinate_6_259_point = new autoclass.MFVec3f(java.newArray("float", [430.0,0.0199999995529652,-335.0,429.899993896484,0.100000001490116,-360.299987792969,442.399993896484,0.0199999995529652,-314.5,429.899993896484,0.100000001490116,-319.600006103516,457.399993896484,0.0199999995529652,-262.700012207031,467.0,0.100000001490116,-243.899993896484,458.700012207031,0.0199999995529652,-262.700012207031,457.399993896484,0.100000001490116,-262.700012207031,458.700012207031,0.0199999995529652,-262.700012207031,467.0,0.100000001490116,-243.899993896484]));
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Transform()).setTranslation(-468.0,0.0,315.0)
      ...
      .addChild((new autoclass.Shape())
        ...
        .setGeometry((new autoclass.IndexedLineSet()).setCoordIndex(this.IndexedLineSet_5_249_coordIndex)
          .setCoord((new autoclass.Coordinate()).setPoint(this.Coordinate_6_249_point))))
      .addChild((new autoclass.Shape())
        .setAppearance((new autoclass.Appearance())
          .setMaterial((new autoclass.Material()).setEmissiveColor(0.0,1.0,0.0).setTransparency(0.200000002980232)))
        .setGeometry((new autoclass.IndexedLineSet()).setCoordIndex(this.IndexedLineSet_5_254_coordIndex)
          .setCoord((new autoclass.Coordinate()).setPoint(this.Coordinate_6_254_point))))
      .addChild((new autoclass.Shape())
        .setAppearance((new autoclass.Appearance())
        ...
        .setGeometry((new autoclass.IndexedLineSet()).setCoordIndex(java.newArray("int", [0,1,-1,2,3,-1,4,5,-1,6,7,-1,8,9,-1]))
          .setCoord((new autoclass.Coordinate()).setPoint(this.Coordinate_6_259_point))))));
  },

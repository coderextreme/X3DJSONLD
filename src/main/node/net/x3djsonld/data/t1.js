...
t1.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Viewpoint()).setDescription("looking North").setPosition(0.0,60.0,110.0).setFieldOfView(0.78539812564849854).setOrientation(1.0,0.0,0.0,-0.69999998807907104))
    .addChild((new autoclass.Viewpoint()).setDescription("looking East").setPosition(-140.0,30.0,0.0).setOrientation(0.0,0.40000000596046448,0.0,-1.3999999761581421).setFieldOfView(0.78539812564849854))
    .addChild((new autoclass.Viewpoint()).setDescription("Overhead").setPosition(0.0,150.0,0.0).setFieldOfView(0.78539812564849854).setOrientation(1.0,0.0,0.0,-1.5700000524520874))
        ...
        .addChild((new autoclass.Transform())
          .addChild((new autoclass.Shape())
            .setAppearance((new autoclass.Appearance())
              .setMaterial((new autoclass.Material()).setTransparency(0.20000000298023224).setDiffuseColor(0.5,0.0,1.0)))
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("institute")
      ...
      .setProtoBody((new autoclass.ProtoBody())
        .addChild((new autoclass.Transform())
          .addChild((new autoclass.Shape())
            .setAppearance((new autoclass.Appearance())
              .setMaterial((new autoclass.Material()).setTransparency(0.20000000298023224).setDiffuseColor(1.0,1.0,0.0)))
    ...
    .addChild((new autoclass.Transform()).setTranslation(-468.0,0.0,315.0)
      ...
      .addChild((new autoclass.Shape())
        .setAppearance((new autoclass.Appearance())
          .setMaterial((new autoclass.Material()).setTransparency(0.20000000298023224).setEmissiveColor(1.0,0.0,0.0)))
      ...
      .addChild((new autoclass.Shape())
        .setAppearance((new autoclass.Appearance())
          .setMaterial((new autoclass.Material()).setTransparency(0.20000000298023224).setEmissiveColor(1.0,0.0,1.0)))

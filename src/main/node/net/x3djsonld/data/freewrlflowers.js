...
freewrlflowers.prototype = {
  /** Create and initialize the X3D model. */
  initialize : function ()
  {
  this.x3dModel = (new autoclass.X3D()).setProfile("Immersive").setVersion("4.0")
  .setHead((new autoclass.head())
    .addMeta((new autoclass.meta()).setName("title").setContent("freewrlflowers.x3d"))
    ...
    .addMeta((new autoclass.meta()).setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/data/freewrlflowers.x3d")))
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Group())
      .addChild((new autoclass.ExternProtoDeclare()).setName("FlowerProto").setUrl(new autoclass.MFString("\"../data/flowerproto.x3d#FlowerProto\""))
        .addField((new autoclass.field()).setName(new autoclass.MFString("\"vertex\"")).setType(new autoclass.MFString("\"MFString\"")).setAccessType(new autoclass.MFString("\"inputOutput\"")))
        .addField((new autoclass.field()).setName(new autoclass.MFString("\"fragment\"")).setType(new autoclass.MFString("\"MFString\"")).setAccessType(new autoclass.MFString("\"inputOutput\""))))
      .addChild((new autoclass.ProtoDeclare()).setName("flower")
        .setProtoBody((new autoclass.ProtoBody())
          .addChild((new autoclass.Group())
            .addChild((new autoclass.ProtoInstance())
              .addFieldValue((new autoclass.fieldValue()).setName("vertex").setValue("../shaders/freewrl_flowers_chromatic.vs"))

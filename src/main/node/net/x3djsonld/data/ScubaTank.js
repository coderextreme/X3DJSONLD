    ...
    .addChild((new autoclass.Transform("ScubaTank"))
      .addChild((new autoclass.Transform())
        .addChild((new autoclass.Shape())
          .setAppearance((new autoclass.Appearance())
            .setMaterial((new autoclass.Material("tank")).setShininess(0.10).setAmbientIntensity(0.3).setDiffuseColor(0.3,0.3,0.5).setSpecularColor(0.7,0.7,0.8)))
          .setGeometry((new autoclass.Cylinder()).setRadius(0.1).setHeight(0.7))))
      ...
      .addChild((new autoclass.Transform()).setTranslation(0.0,-0.35,0.0)
        .addChild((new autoclass.Shape("tankBottom"))
          .setAppearance((new autoclass.Appearance())
            .setMaterial((new autoclass.Material("black")).setDiffuseColor(0.0,0.0,0.0).setAmbientIntensity(0.3)))
        ...
        .addChild((new autoclass.Transform())
          .addChild((new autoclass.Transform()).setTranslation(0.0,0.45,0.0)
            .addChild((new autoclass.Shape("pressure"))
              .setAppearance((new autoclass.Appearance())
                .setMaterial((new autoclass.Material("pressureColor")).setShininess(0.16).setAmbientIntensity(0.4).setSpecularColor(0.91,0.90,0.91).setDiffuseColor(0.91,0.91,0.91)))
              .setGeometry((new autoclass.Cylinder()).setRadius(0.015).setHeight(0.1))))
          ...
          .addChild((new autoclass.Transform()).setTranslation(-0.028,0.462,0.0).setRotation(0.0,0.0,1.0,1.57)
            .addChild((new autoclass.Transform())
              .addChild((new autoclass.Shape("connectorToRegulator"))
                .setAppearance((new autoclass.Appearance())
                  .setMaterial((new autoclass.Material()).setUSE("pressureColor")))
                .setGeometry((new autoclass.Cylinder()).setRadius(0.01).setHeight(0.03))))

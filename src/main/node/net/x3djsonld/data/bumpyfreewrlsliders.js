        ...
        .addChild((new autoclass.Group())
          ...
          .addChild((new autoclass.Transform()).setRotation(0.0,0.0,-1.0,1.57).setTranslation(25.0,0.0,0.0)
            .addChild((new autoclass.Shape())
              .setGeometry((new autoclass.Cylinder("Shaft")).setHeight(50).setRadius(.35))
          ...
          .addChild((new autoclass.Transform()).setRotation(0.0,0.0,-1.0,1.57).setTranslation(50.0,0.0,0.0)
            .addChild((new autoclass.Shape())
              .setGeometry((new autoclass.Cone("Tip")).setBottomRadius(.8).setHeight(3))
              .setAppearance((new autoclass.Appearance())
...
"        <Inline DEF=\"Flower\" url='\"bumpyfreewrl.x3d\"' />"]))
        ...
        .addChild((new autoclass.DISEntityManager("EntityManager")).setNetworkMode("networkReader")
          .addChild((new autoclass.DISEntityTypeMapping()).setCategory(77).setSpecific(1).setUrl(new autoclass.MFString("\"../data/Leif8Final.x3dv\" \"https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3dv\"")))
          .addChild((new autoclass.DISEntityTypeMapping()).setCategory(77).setSpecific(2).setUrl(new autoclass.MFString("\"../data/Lily8Final.x3dv\" \"https://coderextreme.net/X3DJSONLD/src/main/data/Lily8Final.x3dv\"")))
          .addChild((new autoclass.DISEntityTypeMapping()).setCategory(77).setSpecific(3).setUrl(new autoclass.MFString("\"../data/Tufani8Final.x3dv\" \"https://coderextreme.net/X3DJSONLD/src/main/data/Tufani8Final.x3dv\"")))
          .addChild((new autoclass.DISEntityTypeMapping()).setCategory(77).setSpecific(4).setUrl(new autoclass.MFString("\"../data/Gramps8Final.x3dv\" \"https://coderextreme.net/X3DJSONLD/src/main/data/Gramps8Final.x3dv\""))))
...
"	  ecmascript: function newTranslation(Value) { tdeltaValue = Value.x; }" + "\n")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		console.log ("bumpyfreewrlsliders execution self-validation test results: " + testObject.validateSelf());
		process.exit();
	}
}

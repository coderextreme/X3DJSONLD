  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.StreamAudioDestination()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setId("AudioDestination")
      .addChild((new autoclass.Gain()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setId("Gain3")
        .addChild((new autoclass.ChannelMerger()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setId("ChannelMerger")
          .addChild((new autoclass.ChannelSelector()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setId("ChannelSelector0")

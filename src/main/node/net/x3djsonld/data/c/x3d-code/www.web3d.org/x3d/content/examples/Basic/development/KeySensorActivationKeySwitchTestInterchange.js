 ...
 * <p> A simple scene to show KeySensor functionality using Core Profile. </p>
 <p> Related links: <a href="../../../development/KeySensorActivationKeySwitchTestInterchange.java">KeySensorActivationKeySwitchTestInterchange.java</a> source, <a href="../../../development/KeySensorActivationKeySwitchTestInterchangeIndex.html" target="_top">KeySensorActivationKeySwitchTestInterchange catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;" summary="Scene Metadata">
		...
		<tr>
			...
			<td> <a href="../../../development/KeySensorActivationKeySwitchTestInterchange.x3d">KeySensorActivationKeySwitchTestInterchange.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/development/KeySensorActivationKeySwitchTestInterchange.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/development/KeySensorActivationKeySwitchTestInterchange.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/ConformanceNist/Sensors/Keyboard/KeySensorActivationKeySwitchTestInterchange.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/ConformanceNist/Sensors/Keyboard/KeySensorActivationKeySwitchTestInterchange.x3d</a> </td>
		</tr>
		<tr>
...
function KeySensorActivationKeySwitchTestInterchange
...
KeySensorActivationKeySwitchTestInterchange.prototype = {
  ...
  .setHead((new autoclass.head())
    ...
    .addMeta((new autoclass.meta()).setName("title").setContent("KeySensorActivationKeySwitchTestInterchange.x3d"))
    .addMeta((new autoclass.meta()).setName("description").setContent("A simple scene to show KeySensor functionality using Core Profile."))
    ...
    .addMeta((new autoclass.meta()).setName("subject").setContent("KeySensor Core Profile"))
    .addMeta((new autoclass.meta()).setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/development/KeySensorActivationKeySwitchTestInterchange.x3d"))
    .addMeta((new autoclass.meta()).setName("reference").setContent("https://www.web3d.org/x3d/content/examples/Basic/ConformanceNist/Sensors/Keyboard/KeySensorActivationKeySwitchTestInterchange.x3d"))
    .addMeta((new autoclass.meta()).setName("generator").setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta((new autoclass.meta()).setName("license").setContent("../license.html")))
  .setScene((new autoclass.Scene())
    .addChild((new autoclass.WorldInfo()).setTitle("KeySensorActivationKeySwitchTestInterchange.x3d"))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new KeySensorActivationKeySwitchTestInterchange();
		console.log ("KeySensorActivationKeySwitchTestInterchange execution self-validation test results: " + testObject.validateSelf());
	}
}
new KeySensorActivationKeySwitchTestInterchange().main();
process.exit(0);
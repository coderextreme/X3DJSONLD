...
function CADPartChildTransformationAlternativeB
...
CADPartChildTransformationAlternativeB.prototype = {
  ...
  initialize : function ()
  {
	...
	this.HollowCircleCoordinates_8_30_point = new autoclass.MFVec3f() /* splitting up long array to improve readability */
	...
	/** Large attribute array: IndexedTriangleSet index field, scene-graph level=7, element #35, 192 total numbers */
	this.IndexedTriangleSet_7_35_index = new autoclass.MFInt32(java.newArray("int", [0,1,2,2,1,3,2,3,4,4,3,5,4,5,6,6,5,7,6,7,8,8,7,9,8,9,10,10,9,11,10,11,12,12,11,13,12,13,14,14,13,15,14,15,16,16,15,17,16,17,18,18,17,19,18,19,20,20,19,21,20,21,22,22,21,23,22,23,24,24,23,25,24,25,26,26,25,27,26,27,28,28,27,29,28,29,30,30,29,31,30,31,32,32,31,33,32,33,34,34,33,35,34,35,36,36,35,37,36,37,38,38,37,39,38,39,40,40,39,41,40,41,42,42,41,43,42,43,44,44,43,45,44,45,46,46,45,47,46,47,48,48,47,49,48,49,50,50,49,51,50,51,52,52,51,53,52,53,54,54,53,55,54,55,56,56,55,57,56,57,58,58,57,59,58,59,60,60,59,61,60,61,62,62,61,63,62,63,64,64,63,65]));
  ...
  .setHead((new autoclass.head())
    ...
    .addMeta((new autoclass.meta()).setName("title").setContent("CADPartChildTransformationAlternativeB.x3d"))
    .addMeta((new autoclass.meta()).setName("description").setContent("Developer scene to explore Mantis Issue 528 Alternative B for transformation of CADFace children: add transformation fields to CADFace specification."))
    ...
    .addMeta((new autoclass.meta()).setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/CAD/CADPartChildTransformationAlternativeB.x3d"))
    .addMeta((new autoclass.meta()).setName("generator").setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta((new autoclass.meta()).setName("license").setContent("../license.html")))
  .setScene((new autoclass.Scene())
    .addChild((new autoclass.WorldInfo()).setTitle("CADPartChildTransformationAlternativeB.x3d"))
    ...
    .addChild((new autoclass.CADAssembly()).setName("DesignPatternAssembly")
      .addChild((new autoclass.CADPart()).setName("CADPartExample")
        ...
        .addChild((new autoclass.CADFace()).setName("topCap").setTranslation(0.0,1.5,0.0).setRotation(1.0,0.0,0.0,1.5708)
          .setShape((new autoclass.Shape())
            .setGeometry((new autoclass.IndexedTriangleSet()).setIndex(this.IndexedTriangleSet_7_30_index).setCcw(true).setColorPerVertex(true).setNormalPerVertex(true).setSolid(true)
              .setCoord((new autoclass.Coordinate("HollowCircleCoordinates")).setPoint(this.HollowCircleCoordinates_8_30_point)))
            .setAppearance((new autoclass.Appearance()).setUSE("AppearanceGrey"))))
        .addChild((new autoclass.CADFace()).setName("bottomCap").setRotation(-1.0,0.0,0.0,1.5708).setTranslation(0.0,-1.5,0.0)
          .setShape((new autoclass.Shape())
            .setGeometry((new autoclass.IndexedTriangleSet()).setIndex(this.IndexedTriangleSet_7_35_index).setCcw(true).setColorPerVertex(true).setNormalPerVertex(true).setSolid(true)
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new CADPartChildTransformationAlternativeB();
		console.log ("CADPartChildTransformationAlternativeB execution self-validation test results: " + testObject.validateSelf());
	}
}
new CADPartChildTransformationAlternativeB().main();
process.exit(0);
...
CameraExamples.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ExternProtoDeclare()).setName("Camera").setAppinfo(this.ExternProtoDeclare_Camera_3_22_appinfo).setUrl(new autoclass.MFString("\"CameraPrototypes.x3d#Camera\" \"https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#Camera\" \"CameraPrototypes.wrl#Camera\" \"https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#Camera\""))
      ...
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("position").setType("SFVec3f").setAppinfo(this.field_position_4_23_appinfo))
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("orientation").setType("SFRotation").setAppinfo(this.field_orientation_4_24_appinfo))
      ...
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("nearClipPlane").setType("SFFloat").setAppinfo("Vector distance to near clipping plane corresponds to NavigationInfo.avatarSize[0]"))
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("farClipPlane").setType("SFFloat").setAppinfo("Vector distance to far clipping plane corresponds to NavigationInfo.visibilityLimit"))
      ...
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("headlight").setType("SFBool").setAppinfo("Whether camera headlight is on or off"))
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("headlightColor").setType("SFColor").setAppinfo("Camera headlight color"))
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("headlightIntensity").setType("SFFloat").setAppinfo("Camera headlight intensity"))
    ...
    .addChild((new autoclass.ExternProtoDeclare()).setName("OfflineRender").setAppinfo(this.ExternProtoDeclare_OfflineRender_3_72_appinfo).setUrl(new autoclass.MFString("\"CameraPrototypes.x3d#OfflineRender\" \"https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#OfflineRender\" \"CameraPrototypes.wrl#OfflineRender\" \"https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#OfflineRender\""))
      ...
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("movieFormat").setType("MFString").setAppinfo("Format of rendered output movie (mpeg mp4 etc.), use first supported format"))
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("imageFormat").setType("MFString").setAppinfo("Format of rendered output images (png jpeg gif tiff etc.) use first supported format"))
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("traceEnabled").setType("SFBool").setAppinfo("enable console output to trace script computations and prototype progress"))
      .addComments(" TODO non-photorealistic rendering (NPR) parameters "))
    .addComments(" =============== Lights, camera, action! ============== ")
    .addChild((new autoclass.DirectionalLight()).setDirection(0.0,-1.0,0.0).setIntensity(0.8).setGlobal(true))
    ...
    .addChild((new autoclass.Viewpoint()).setDescription("Camera test scene from above").setPosition(0.0,150.0,0.0).setOrientation(1.0,0.0,0.0,-1.57079))
    ...
    .addChild((new autoclass.ProtoInstance("Camera.SimpleShotsTest", "Camera")).setDEF("Camera.SimpleShotsTest").setName("Camera")
      ...
      .addFieldValue((new autoclass.fieldValue()).setName("shots")
        .addChild((new autoclass.ProtoInstance("Zoom", "CameraShot")).setDEF("Zoom").setName("CameraShot")
          ...
          .addFieldValue((new autoclass.fieldValue()).setName("moves")
            .addChild((new autoclass.ProtoInstance()).setName("CameraMovement")
            ...
            .addChild((new autoclass.ProtoInstance()).setName("CameraMovement")
              ...
              .addFieldValue((new autoclass.fieldValue()).setName("goalPosition").setValue("-50 1 -10"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalOrientation").setValue("0 1 0 0")))))
        .addChild((new autoclass.ProtoInstance("Dolly", "CameraShot")).setDEF("Dolly").setName("CameraShot")
          ...
          .addFieldValue((new autoclass.fieldValue()).setName("initialOrientation").setValue("0 1 0 0"))
          .addFieldValue((new autoclass.fieldValue()).setName("moves")
            .addChild((new autoclass.ProtoInstance("DollyMove1", "CameraMovement")).setDEF("DollyMove1").setName("CameraMovement")
            ...
            .addChild((new autoclass.ProtoInstance()).setName("CameraMovement")
              ...
              .addFieldValue((new autoclass.fieldValue()).setName("goalPosition").setValue("-40 1 -10"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalOrientation").setValue("0 1 0 0")))))
        .addChild((new autoclass.ProtoInstance("Pan", "CameraShot")).setDEF("Pan").setName("CameraShot")
          ...
          .addFieldValue((new autoclass.fieldValue()).setName("initialOrientation").setValue("0 1 0 0"))
          .addFieldValue((new autoclass.fieldValue()).setName("moves")
            .addChild((new autoclass.ProtoInstance("PanLeft", "CameraMovement")).setDEF("PanLeft").setName("CameraMovement")
            ...
            .addChild((new autoclass.ProtoInstance("PanRight", "CameraMovement")).setDEF("PanRight").setName("CameraMovement")
            ...
            .addChild((new autoclass.ProtoInstance()).setName("CameraMovement")
              ...
              .addFieldValue((new autoclass.fieldValue()).setName("goalPosition").setValue("-30 1 -10"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalOrientation").setValue("0 1 0 0")))))
        .addChild((new autoclass.ProtoInstance("CameraBoom", "CameraShot")).setDEF("CameraBoom").setName("CameraShot")
          ...
          .addFieldValue((new autoclass.fieldValue()).setName("initialOrientation").setValue("0 1 0 0"))
          .addFieldValue((new autoclass.fieldValue()).setName("moves")
            .addChild((new autoclass.ProtoInstance("CameraBoomUp", "CameraMovement")).setDEF("CameraBoomUp").setName("CameraMovement")
              ...
              .addFieldValue((new autoclass.fieldValue()).setName("goalOrientation").setValue("0 1 0 0")))
            .addChild((new autoclass.ProtoInstance("BoomDown", "CameraMovement")).setDEF("BoomDown").setName("CameraMovement")
              ...
              .addFieldValue((new autoclass.fieldValue()).setName("goalOrientation").setValue("0 1 0 0")))
            .addChild((new autoclass.ProtoInstance("BoomPause", "CameraMovement")).setDEF("BoomPause").setName("CameraMovement")
              .addFieldValue((new autoclass.fieldValue()).setName("description").setValue("Camera Pause"))
              .addFieldValue((new autoclass.fieldValue()).setName("duration").setValue("2"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalPosition").setValue("-20 1 -10"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalOrientation").setValue("0 1 0 0")))))
        .addChild((new autoclass.ProtoInstance("CameraTilt", "CameraShot")).setDEF("CameraTilt").setName("CameraShot")
          ...
          .addFieldValue((new autoclass.fieldValue()).setName("moves")
            ...
            .addChild((new autoclass.ProtoInstance("TiltDown", "CameraMovement")).setDEF("TiltDown").setName("CameraMovement")
            ...
            .addChild((new autoclass.ProtoInstance("TiltPause", "CameraMovement")).setDEF("TiltPause").setName("CameraMovement")
              .addFieldValue((new autoclass.fieldValue()).setName("description").setValue("Camera Tilt Pause"))
              .addFieldValue((new autoclass.fieldValue()).setName("duration").setValue("1"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalPosition").setValue("-10 1 -10"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalOrientation").setValue("0 0 1 0.785")))
            ...
            .addChild((new autoclass.ProtoInstance()).setName("CameraMovement")
              ...
              .addFieldValue((new autoclass.fieldValue()).setName("goalPosition").setValue("-10 1 -10"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalOrientation").setValue("0 0 1 -0.785")))
            .addChild((new autoclass.ProtoInstance("TiltReset", "CameraMovement")).setDEF("TiltReset").setName("CameraMovement")
              .addFieldValue((new autoclass.fieldValue()).setName("description").setValue("Camera Tilt Reset"))
              .addFieldValue((new autoclass.fieldValue()).setName("duration").setValue("1"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalPosition").setValue("-10 1 -10"))
              .addFieldValue((new autoclass.fieldValue()).setName("goalOrientation").setValue("0 0 1 0")))
            .addChild((new autoclass.ProtoInstance("TiltUp", "CameraMovement")).setDEF("TiltUp").setName("CameraMovement")
      ...
      .addChild((new autoclass.Transform("Trigger.SimpleShots")).setTranslation(-4.0,4.0,0.0)
        ...
        .addChild((new autoclass.Shape())
          ...
          .setAppearance((new autoclass.Appearance())
            .setMaterial((new autoclass.Material("ArtDeco5")).setShininess(0.01).setSpecularColor(0.072727,0.021705,0.010732).setAmbientIntensity(0.24).setDiffuseColor(0.945455,0.318988,0.321717)
    ...
    .addChild((new autoclass.ProtoInstance("Camera.AimPointTest", "Camera")).setDEF("Camera.AimPointTest").setName("Camera")
      ...
      .addFieldValue((new autoclass.fieldValue()).setName("position").setValue("4 4 10"))
      .addFieldValue((new autoclass.fieldValue()).setName("shots")
        .addChild((new autoclass.ProtoInstance("Shot5", "CameraShot")).setDEF("Shot5").setName("CameraShot")
          ...
          .addFieldValue((new autoclass.fieldValue()).setName("initialOrientation").setValue("0 1 0 0"))
          .addFieldValue((new autoclass.fieldValue()).setName("moves")
            .addChild((new autoclass.ProtoInstance("MoveAimPoint3.1", "CameraMovement")).setDEF("MoveAimPoint3.1").setName("CameraMovement")
            ...
            .addChild((new autoclass.ProtoInstance("MoveAimPoint3.2", "CameraMovement")).setDEF("MoveAimPoint3.2").setName("CameraMovement")
              ...
              .addComments(" goalAimPoint modified by ROUTE to match moving Box "))
            .addChild((new autoclass.ProtoInstance("MoveAimPoint3.3", "CameraMovement")).setDEF("MoveAimPoint3.3").setName("CameraMovement")
              ...
              .addComments(" goalAimPoint modified by ROUTE to match moving Box "))
            .addChild((new autoclass.ProtoInstance("MoveAimPoint3.4", "CameraMovement")).setDEF("MoveAimPoint3.4").setName("CameraMovement")
    ...
    .addChild((new autoclass.ProtoInstance()).setName("OfflineRender"))
    ...
    .addChild((new autoclass.Transform("CameraShapeTransform")).setTranslation(0.0,0.5,0.0)
      ...
      .addChild((new autoclass.ProtoInstance("ViewFrustumNode", "ViewFrustum")).setDEF("ViewFrustumNode").setName("ViewFrustum")
    ...
    .addChild((new autoclass.Transform()).setTranslation(0.0,0.25,0.0).setScale(3.0,3.0,3.0)
    ...
    .addChild((new autoclass.Transform("MovingBoxTransform"))
      .addChild((new autoclass.PositionInterpolator("BoxPath")).setKeyValue(new autoclass.MFVec3f(java.newArray("float", [-5.0,1.0,5.0,45.0,1.0,5.0,45.0,1.0,-45.0,-5.0,1.0,-45.0,-5.0,1.0,5.0]))).setKey(java.newArray("float", [0.0,0.25,0.5,0.75,1.0])))
    ...
    .addChild((new autoclass.ExternProtoDeclare()).setName("CrossHair").setAppinfo(this.ExternProtoDeclare_CrossHair_3_404_appinfo).setUrl(new autoclass.MFString("\"../../Savage/Tools/HeadsUpDisplays/CrossHairPrototype.x3d#CrossHair\" \"https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/CrossHairPrototype.x3d#CrossHair\" \"../../Savage/Tools/HeadsUpDisplays/CrossHairPrototype.wrl#CrossHair\" \"https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/CrossHairPrototype.wrl#CrossHair\""))
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("enabled").setType("SFBool").setAppinfo("whether CrissHair orititype is enabled or not"))
      .addField((new autoclass.field()).setAccessType("inputOnly").setName("set_enabled").setType("SFBool").setAppinfo("control whether enabled/disabled"))
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("markerColor").setType("SFColor").setAppinfo("color of CrossHair marker"))
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("scale").setType("SFVec3f").setAppinfo("size of CrossHair in meters"))
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("positionOffsetFromCamera").setType("SFVec3f").setAppinfo("distance in front of HUD viewpoint")))
    .addChild((new autoclass.ProtoInstance("CrossHairInstance", "CrossHair")).setDEF("CrossHairInstance").setName("CrossHair")

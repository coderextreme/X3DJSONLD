...
HelloWorld.prototype = {
  ...
  .setHead((new autoclass.head())
    ...
    .addMeta((new autoclass.meta()).setName("reference").setContent("https://X3dGraphics.com"))
    .addMeta((new autoclass.meta()).setName("Image").setContent("HelloWorld.tall.png"))
    .addMeta((new autoclass.meta()).setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HelloWorld.x3d"))
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.WorldInfo()).setTitle("HelloWorld.x3d"))

  ...
  .setScene((new autoclass.Scene())
    .addChild((new autoclass.ProtoDeclare()).setName("FlowerProto")
      .setProtoInterface((new autoclass.ProtoInterface())
        .addField((new autoclass.field()).setName(new autoclass.MFString("\"vertex\"")).setType(new autoclass.MFString("\"MFString\"")).setAccessType(new autoclass.MFString("\"inputOutput\"")).setValue(new autoclass.MFString("\"https://coderextreme.net/X3DJSONLD/src/main/shaders/gl_flowers_chromatic.vs\"")))
        .addField((new autoclass.field()).setName(new autoclass.MFString("\"fragment\"")).setType(new autoclass.MFString("\"MFString\"")).setAccessType(new autoclass.MFString("\"inputOutput\"")).setValue(new autoclass.MFString("\"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_flowers.fs\""))))

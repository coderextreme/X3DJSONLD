  ...
  .setScene((new autoclass.Scene())
    .addChild((new autoclass.ProtoDeclare()).setName("FlowerProto")
      .setProtoInterface((new autoclass.ProtoInterface())
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("vertex").setType("MFString").setValue("\"../shaders/gl_flowers_chromatic.vs\""))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("fragment").setType("MFString").setValue("\"../shaders/pc_flowers.fs\"")))
...
"			}" + "\n")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new autoclass.flowerproto();

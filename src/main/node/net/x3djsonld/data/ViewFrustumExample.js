...
ViewFrustumExample.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Viewpoint()).setDescription("ViewFrustum from above, looking down").setOrientation(1.0,0.0,0.0,-1.57).setPosition(0.0,40.0,0.0))
    ...
    .addChild((new autoclass.Viewpoint()).setDescription("ViewFrustum oblique side view").setOrientation(0.8005,0.5926,0.0898,-0.3743).setPosition(-5.0,5.0,20.0))
    ...
    .addChild((new autoclass.ExternProtoDeclare()).setName("ViewFrustum").setAppinfo("Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes").setUrl(new autoclass.MFString("\"ViewFrustumPrototype.x3d#ViewFrustum\""))
      ...
      .addField((new autoclass.field()).setName(lineColor).setType(SFColor.0).setAccessType(inputOutput.0).setAppinfo(RGB,color,of,ViewFrustum,outline,,default,value,0.9,0.9,0.9))
      .addField((new autoclass.field()).setName(frustumColor.0).setType(SFColor.0).setAccessType(inputOutput.0).setAppinfo(RGB,color,of,ViewFrustum,hull,geometry,,default,value,0.8,0.8,0.8))

...
LOA4ExampleSourceInVRML.prototype = {
  ...
  initialize : function ()
  {
	...
	this.fieldValue_info_4_1296_value = new autoclass.SFString("\"authorName=Matthew T. Beitler\" \"authorEmail=beitler@cis.upenn.edu or beitler@acm.org\" \"creationDate=05/12/99\" \"copyright=Copyright 1999-2003, Matthew T. Beitler\" \"humanoidVersion=JointCenters 200x, LOA&#8209;4\" \"usageRestrictions=
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Group("JointCenters_WorldInfo"))
      .addChild((new autoclass.WorldInfo()).setInfo(this.WorldInfo_4_1298_info).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;4")))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		console.log ("LOA4ExampleSourceInVRML execution self-validation test results: " + testObject.validateSelf());
	}
}

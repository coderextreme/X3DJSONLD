...
GridXZ_20x20Fixed.prototype = {
  ...
  initialize : function ()
  {
	...
	this.IndexedLineSet_6_13_coordIndex = new autoclass.MFInt32(java.newArray("int", [1,22,-1,2,23,-1,3,24,-1,4,25,-1,5,26,-1,6,27,-1,7,28,-1,8,29,-1,9,30,-1,10,31,-1,11,32,-1,12,33,-1,13,34,-1,14,35,-1,15,36,-1,16,37,-1,17,38,-1,18,39,-1,19,40,-1,20,41,-1,21,42,-1]));
	...
	this.EndPoints_7_13_point = new autoclass.MFVec3f() /* splitting up long array to improve readability */
    ...
    .addChild((new autoclass.Transform("GridLocation"))
      .addChild((new autoclass.Group())
        .addChild((new autoclass.Shape("LinesAlignedAlongZ"))
          .setGeometry((new autoclass.IndexedLineSet()).setColorPerVertex(false).setColorIndex(java.newArray("int", [1,0,0,0,0,2,0,0,0,0,1,0,0,0,0,2,0,0,0,0,1])).setCoordIndex(this.IndexedLineSet_6_13_coordIndex)

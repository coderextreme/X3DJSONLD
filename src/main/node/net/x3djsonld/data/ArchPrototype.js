  ...
  .setScene((new autoclass.Scene())
    .addChild((new autoclass.ProtoDeclare()).setName("ArchPrototype").setAppinfo(this.ProtoDeclare_ArchPrototype_3_13_appinfo)
      ...
      .setProtoBody((new autoclass.ProtoBody())
        ...
        .addChild((new autoclass.X3DScript("ArchPrototypeScript")).setUrl(new autoclass.MFString("\"../node/ArchPrototypeScript.js\" \"https://coderextreme.net/X3DJSONLD/src/main/node/ArchPrototypeScript.js\""))
          .addComments(" INPUT PARAMETERS ")

                                                      ...
                                                      .addChild((new autoclass.HAnimSegment("hanim_l_thumb_distal")).setName("l_thumb_distal")
                                                        ...
                                                        .addChild((new autoclass.HAnimSite("hanim_l_thumb_distal_tip")).setName("l_thumb_distal_tip").setTranslation(0.1982,0.8061,0.0759)
                                                          .addChild((new autoclass.Shape())
                                                            ...
                                                            .setAppearance((new autoclass.Appearance())
                                                              .setMaterial((new autoclass.Material()).setUSE("HAND_FEET_COLOR")))))))))
                                                .addChild((new autoclass.HAnimJoint("hanim_l_index0")).setName("l_index0").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1983,0.8024,-0.0280)
                                                  .addChild((new autoclass.HAnimSegment("hanim_l_index_metacarpal")).setName("l_index_metacarpal")
                                                    .addChild((new autoclass.Transform()).setTranslation(0.1983,0.8024,-0.0280)
                                                      .addChild((new autoclass.Shape())
                                                        ...
                                                        .setAppearance((new autoclass.Appearance())
                                                          .setMaterial((new autoclass.Material()).setUSE("JOINT_COLOR"))))))
                                                  .addChild((new autoclass.HAnimJoint("hanim_l_index1")).setName("l_index1").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1983,0.7815,-0.0280)

  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("Humanoid1_1").setAppinfo(this.ProtoDeclare_Humanoid1_1_3_23_appinfo).setDocumentation("http://HAnim.org/Specifications/HAnim2001/part1/Humanoid.html")
      .setProtoInterface((new autoclass.ProtoInterface())
        ...
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("humanoidBody").setType("MFNode").setAppinfo("HAnim 1.1 field container for body head. Hint: replaced by 2.0 skeleton.").setDocumentation("http://HAnim.org/Specifications/HAnim1.1/#humanoid"))
    ...
    .addChild((new autoclass.Shape())
      ...
      .setAppearance((new autoclass.Appearance())
        .setMaterial((new autoclass.Material()).setAmbientIntensity(0.25).setShininess(0.39).setDiffuseColor(0.795918,0.505869,0.093315).setSpecularColor(0.923469,0.428866,0.006369)

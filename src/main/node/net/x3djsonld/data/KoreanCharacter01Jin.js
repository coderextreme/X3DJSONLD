...
KoreanCharacter01Jin.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.HAnimHumanoid("hanim_Jin")).setName("Jin").setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addSkeleton((new autoclass.HAnimJoint("hanim_humanoid_root")).setName("humanoid_root").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,35.799999,-0.707600)
        ...
        .addChild((new autoclass.HAnimJoint("hanim_l_hip")).setName("l_hip").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(4.207000,32.020000,-0.815500)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_l_knee")).setName("l_knee").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(4.116000,17.260000,-0.863900)
            ...
            .addChild((new autoclass.HAnimJoint("hanim_l_talocrural")).setName("l_talocrural").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(3.854000,3.939000,-0.703800)
              ...
              .addChild((new autoclass.HAnimJoint("hanim_l_metatarsophalangeal_2")).setName("l_metatarsophalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(3.854000,3.640000,0.740200)
        ...
        .addChild((new autoclass.HAnimJoint("hanim_r_hip")).setName("r_hip").setCenter(-4.207000,32.020000,-0.815500).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
          ...
          .addChild((new autoclass.HAnimJoint("hanim_r_knee")).setName("r_knee").setCenter(-4.116000,17.260000,-0.863900).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
            ...
            .addChild((new autoclass.HAnimJoint("hanim_r_talocrural")).setName("r_talocrural").setCenter(-3.854000,3.939000,-0.703800).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
              ...
              .addChild((new autoclass.HAnimJoint("hanim_r_metatarsophalangeal_2")).setName("r_metatarsophalangeal_2").setCenter(-3.854000,3.640000,0.740200).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
        ...
        .addChild((new autoclass.HAnimJoint("hanim_sacroiliac")).setName("sacroiliac").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,30.530001,-0.707600)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_l_shoulder")).setName("l_shoulder").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(5.975000,52.0,-0.145200)
            ...
            .addChild((new autoclass.HAnimJoint("hanim_l_elbow")).setName("l_elbow").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(8.093000,40.380001,-0.250200)
              ...
              .addChild((new autoclass.HAnimJoint("hanim_l_radiocarpal")).setName("l_radiocarpal").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(7.808000,31.459999,-0.058490)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_r_shoulder")).setName("r_shoulder").setCenter(-5.975000,52.0,-0.145200).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
            ...
            .addChild((new autoclass.HAnimJoint("hanim_r_elbow")).setName("r_elbow").setCenter(-8.093000,40.380001,-0.250200).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
              ...
              .addChild((new autoclass.HAnimJoint("hanim_r_radiocarpal")).setName("r_radiocarpal").setCenter(-7.808000,31.459999,-0.058490).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
          ...
          .addChild((new autoclass.HAnimJoint("hanim_vl5")).setName("vl5").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,40.230000,-0.852700)
            ...
            .addChild((new autoclass.HAnimJoint("hanim_skullbase")).setName("skullbase").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,57.430000,-0.686300)
                ...
                .addChild((new autoclass.Transform()).setTranslation(0.0,57.430000,-0.686300)
                  .addChild((new autoclass.Shape())
                    .setAppearance((new autoclass.Appearance())
                      .setMaterial((new autoclass.Material()).setDiffuseColor(0.588000,0.588000,0.588000))
                      .setTexture((new autoclass.ImageTexture()).setUSE("JinTextureAtlas")))
                    .setGeometry((new autoclass.IndexedFaceSet()).setCreaseAngle(1.57).setTexCoordIndex(this.IndexedFaceSet_11_199_texCoordIndex).setCoordIndex(this.IndexedFaceSet_11_199_coordIndex)

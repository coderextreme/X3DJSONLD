...
LOA0ExampleSourceWithDiamonds.prototype = {
  ...
  initialize : function ()
  {
	...
	this.fieldValue_info_4_432_value = new autoclass.SFString("\"authorName=Matthew T. Beitler\" \"authorEmail=beitler@cis.upenn.edu or beitler@acm.org\" \"creationDate=05/12/99\" \"copyright=Copyright 1999-2003, Matthew T. Beitler\" \"humanoidVersion=JointCenters 200x, LOA&#8209;0\" \"usageRestrictions=
	...
	this.WorldInfo_4_434_info = new autoclass.MFString(new autoclass.MFString("\"
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ProtoInstance("humanoid_2", "Humanoid")).setDEF("humanoid_2").setName("Humanoid")
      ...
      .addFieldValue((new autoclass.fieldValue()).setName("info").setValue(this.fieldValue_info_4_432_value)))
    .addChild((new autoclass.Group("JointCenters_WorldInfo"))
      .addChild((new autoclass.WorldInfo()).setInfo(this.WorldInfo_4_434_info).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;0")))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		console.log ("LOA0ExampleSourceWithDiamonds execution self-validation test results: " + testObject.validateSelf());
	}
}

      ...
      .addChild((new autoclass.ParticleSystem()).setGeometryType("GEOMETRY").setMaxParticles(20)
        ...
        .setAppearance((new autoclass.Appearance())
          ...
          .setTexture((new autoclass.ComposedCubeMapTexture("texture"))
            ...
            .setFrontTexture((new autoclass.ImageTexture()).setUrl(new autoclass.MFString("\"../resources/images/all_probes/stpeters_cross/stpeters_from.png\" \"https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png\"")))

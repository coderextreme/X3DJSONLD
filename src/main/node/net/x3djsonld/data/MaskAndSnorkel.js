    ...
    .addChild((new autoclass.Transform("maskAndSnorkel"))
      ...
      .addChild((new autoclass.Group("snorkel"))
        .addChild((new autoclass.Transform()).setTranslation(0.0,-0.02,0.0)
          .addChild((new autoclass.Transform()).setTranslation(0.035,-0.07,-0.02).setScale(0.9,0.9,0.9)
            .addChild((new autoclass.Shape())
              .setAppearance((new autoclass.Appearance())
                .setMaterial((new autoclass.Material("snorkelTube")).setTransparency(0.4).setDiffuseColor(0.678,1.0,0.184)))
              .setGeometry((new autoclass.Extrusion()).setSpine(new autoclass.MFVec3f(java.newArray("float", [-0.01,-0.04,0.0,0.0,0.0,0.0,0.03,0.05,0.0,0.05,0.2,0.0,0.03,0.4,0.03]))).setCrossSection(this.Extrusion_8_25_crossSection))))
          .addChild((new autoclass.Transform()).setRotation(0.0,0.0,1.0,1.57).setTranslation(0.01,-0.04,-0.02).setScale(0.9,0.9,0.9)
            .addChild((new autoclass.Shape())
              .setAppearance((new autoclass.Appearance())
                .setMaterial((new autoclass.Material("Mouthpiece")).setTransparency(0.4).setDiffuseColor(0.678,1.0,0.8)))
              .setGeometry((new autoclass.Extrusion()).setSpine(new autoclass.MFVec3f(java.newArray("float", [-0.01,-0.03,0.0,0.0,0.0,0.0,0.02,0.01,0.0]))).setCrossSection(this.Extrusion_8_30_crossSection))))
          .addChild((new autoclass.Transform()).setRotation(0.0,0.0,1.0,-0.85).setTranslation(0.005,-0.01,-0.02).setScale(0.9,0.9,0.9)
            .addChild((new autoclass.Shape())
              .setAppearance((new autoclass.Appearance())
                .setMaterial((new autoclass.Material()).setUSE("Mouthpiece")))
              .setGeometry((new autoclass.Extrusion()).setSpine(new autoclass.MFVec3f(java.newArray("float", [-0.02,-0.03,0.0,-0.01,-0.03,0.0,0.0,-0.0175,0.0,0.0,-0.0135,0.0,-0.01,0.0,0.0,-0.02,0.0,0.0]))).setCrossSection(this.Extrusion_8_35_crossSection))))))
      .addChild((new autoclass.Transform())
        .addChild((new autoclass.Shape("maskLensR"))
          .setAppearance((new autoclass.Appearance())
            .setMaterial((new autoclass.Material("plastic")).setTransparency(0.8).setDiffuseColor(0.941,0.973,1.0)))

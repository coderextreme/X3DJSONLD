...
JinLOA1.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.HAnimHumanoid("hanim_JinLOA1")).setName("JinLOA1").setScale(0.0225,0.0225,0.0225).setLoa(1).setVersion("2.0")
      ...
      .addSkeleton((new autoclass.HAnimJoint("hanim_humanoid_root")).setName("humanoid_root").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,30.530001,-0.707600)
        ...
        .addChild((new autoclass.HAnimJoint("hanim_sacroiliac")).setName("sacroiliac").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,35.799999,-0.707600)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_l_hip")).setName("l_hip").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(4.207,32.020,-0.815500)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_r_hip")).setName("r_hip").setCenter(-4.207,32.020,-0.815500).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
              ...
              .addChild((new autoclass.Transform()).setTranslation(-4.207,32.020,-0.815500)
                .addChild((new autoclass.Shape())
                  .setAppearance((new autoclass.Appearance())
                    .setMaterial((new autoclass.Material()).setDiffuseColor(0.588,0.588,0.588))
                    .setTexture((new autoclass.ImageTexture()).setUSE("JinLOA1TextureAtlas")))
                  .setGeometry((new autoclass.IndexedFaceSet()).setCreaseAngle(3.14159).setTexCoordIndex(this.IndexedFaceSet_10_92_texCoordIndex).setCoordIndex(this.IndexedFaceSet_10_92_coordIndex)
        ...
        .addChild((new autoclass.HAnimJoint("hanim_vl5")).setName("vl5").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,40.070,-0.852700)
            ...
            .addChild((new autoclass.Transform()).setTranslation(0.0,40.070,-0.852700)
              .addChild((new autoclass.Shape())
                .setAppearance((new autoclass.Appearance())
                  .setMaterial((new autoclass.Material()).setDiffuseColor(0.588,0.588,0.588))
                  .setTexture((new autoclass.ImageTexture()).setUSE("JinLOA1TextureAtlas")))
                .setGeometry((new autoclass.IndexedFaceSet()).setCreaseAngle(3.14159).setTexCoordIndex(this.IndexedFaceSet_9_133_texCoordIndex).setCoordIndex(this.IndexedFaceSet_9_133_coordIndex)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_skullbase")).setName("skullbase").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,57.430,-0.686300)
              ...
              .addChild((new autoclass.Transform()).setTranslation(0.0,57.430,-0.686300)
                .addChild((new autoclass.Shape())
                  .setAppearance((new autoclass.Appearance())
                    .setMaterial((new autoclass.Material()).setDiffuseColor(0.588,0.588,0.588))
                    .setTexture((new autoclass.ImageTexture()).setUSE("JinLOA1TextureAtlas")))
                  .setGeometry((new autoclass.IndexedFaceSet()).setCreaseAngle(3.14159).setTexCoordIndex(this.IndexedFaceSet_10_142_texCoordIndex).setCoordIndex(this.IndexedFaceSet_10_142_coordIndex)
            ...
            .addChild((new autoclass.HAnimJoint("hanim_l_shoulder")).setName("l_shoulder").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(5.975,52.0,-0.145200)
                ...
                .addChild((new autoclass.Transform()).setTranslation(5.975,52.0,-0.145200)
                  .addChild((new autoclass.Shape())
                    .setAppearance((new autoclass.Appearance())
                      .setMaterial((new autoclass.Material()).setDiffuseColor(0.588,0.588,0.588))
                      .setTexture((new autoclass.ImageTexture()).setUSE("JinLOA1TextureAtlas")))
                    .setGeometry((new autoclass.IndexedFaceSet()).setCreaseAngle(3.14159).setTexCoordIndex(this.IndexedFaceSet_11_151_texCoordIndex).setCoordIndex(this.IndexedFaceSet_11_151_coordIndex)
              ...
              .addChild((new autoclass.HAnimJoint("hanim_l_elbow")).setName("l_elbow").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(8.093,40.380001,-0.250200)
                ...
                .addChild((new autoclass.HAnimJoint("hanim_l_radiocarpal")).setName("l_radiocarpal").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(7.808,31.459999,-0.058490)
            ...
            .addChild((new autoclass.HAnimJoint("hanim_r_shoulder")).setName("r_shoulder").setCenter(-5.975,52.0,-0.145200).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
              ...
              .addChild((new autoclass.HAnimJoint("hanim_r_elbow")).setName("r_elbow").setCenter(-8.093,40.380001,-0.250200).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                ...
                .addChild((new autoclass.HAnimJoint("hanim_r_radiocarpal")).setName("r_radiocarpal").setCenter(-7.808,31.459999,-0.058490).setStiffness(java.newArray("float", [0.0,0.0,0.0]))

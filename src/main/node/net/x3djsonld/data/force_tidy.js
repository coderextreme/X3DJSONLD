...
force_tidy.prototype = {
  ...
  initialize : function ()
  {
	...
	/** Large attribute array: Extrusion DEF='extrusion' crossSection field, scene-graph level=7, element #45, 34 total numbers made up of 17 2-tuple values */
	this.extrusion_7_45_crossSection = new autoclass.MFVec2f() /* splitting up long array to improve readability */
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("node")
      ...
      .setProtoBody((new autoclass.ProtoBody())
        .addChild((new autoclass.Group())
          ...
          .addChild((new autoclass.PositionInterpolator("NodePosition")).setKey(java.newArray("float", [0.0,.0,1.0])).setKeyValue(new autoclass.MFVec3f(java.newArray("float", [0.0,0.0,0.0,.0,0.0,5.0,0.0]))))
      ...
      .setProtoBody((new autoclass.ProtoBody())
        .addChild((new autoclass.Group())
          .addChild((new autoclass.Shape())
            ...
            .setGeometry((new autoclass.Extrusion("extrusion")).setCreaseAngle(0.785).setCrossSection(this.extrusion_7_45_crossSection).setSpine(new autoclass.MFVec3f(java.newArray("float", [0.0,-50.0,0.0,.0,0.0,50.0,0.0])))))
...
"                    spine = value;" + "\n" + 
"                }" + "\n")
            .addField((new autoclass.field()).setName(new autoclass.MFVec3f(java.newArray("float", [spine]))).setType(new autoclass.MFVec3f(java.newArray("float", [MFVec3f]))).setAccessType(new autoclass.MFVec3f(java.newArray("float", [inputOutput.0]))).setValue(new autoclass.MFVec3f(java.newArray("float", [0.0,-50.0,0.0,.0,0.0,50.0,0.0]))))

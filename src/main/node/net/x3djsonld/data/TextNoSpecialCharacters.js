...
function TextNoSpecialCharacters
...
TextNoSpecialCharacters.prototype = {
  /** Create and initialize the X3D model. */
  initialize : function ()
  {

	/** Large attribute array: Text DEF='DefaultText' string field, scene-graph level=4, element #15, 45 total values */
	this.DefaultText_4_15_string = new autoclass.MFString(new autoclass.MFString("\"Character entity substitutions:\"         \"empty string \\\"\\\" skips a line:\"         \"\"         \"apostrophe  '  is &apos;\"          \"ampersand & is &amp;\"         \"quote mark  \\\"  is &quot;\"         \"backslash \\\\ is X3D escape character\"         \"double backslash \\\\\\\\ is X3D backslash \\\\ character\"         \"Pi is pi is pi XML character entity\""));
   ...
   * @return TextNoSpecialCharacters model
   */
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new TextNoSpecialCharacters();
		console.log ("TextNoSpecialCharacters execution self-validation test results: " + testObject.validateSelf());
	}
}
new TextNoSpecialCharacters().main();
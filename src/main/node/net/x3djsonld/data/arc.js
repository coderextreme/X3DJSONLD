    ...
    .addChild(new autoclass.ProtoDeclare().setName("x3dconnector")
      ...
      .setProtoBody(new autoclass.ProtoBody()
        .addChild(new autoclass.Group()
          .addChild(new autoclass.Transform("trans")
            .addChild(new autoclass.Transform("rotscale")
              .addChild(new autoclass.Shape()
                .setAppearance(new autoclass.Appearance()
...
"        }" + "\n")
            ...
            .addField(new autoclass.field().setAccessType("inputOutput").setName("rotscale").setType("SFNode")
    ...
    .addChild(new autoclass.ProtoInstance("G1", "point").setDEF("G1").setName("point"))
    .addChild(new autoclass.ProtoInstance("G2", "point").setDEF("G2").setName("point"))
    .addChild(new autoclass.ProtoInstance("G3", "point").setDEF("G3").setName("point"))
    .addChild(new autoclass.ProtoInstance("G4", "point").setDEF("G4").setName("point"))
    .addChild(new autoclass.ProtoInstance("connector1", "x3dconnector").setDEF("connector1").setName("x3dconnector")
      .addFieldValue(new autoclass.fieldValue().setName("startnode")
        .addChild(new autoclass.ProtoInstance().setUSE("G1")))
      .addFieldValue(new autoclass.fieldValue().setName("endnode")
        .addChild(new autoclass.ProtoInstance().setUSE("G2")))
    ...
    .addChild(new autoclass.ProtoInstance("connector2", "x3dconnector").setDEF("connector2").setName("x3dconnector")
      .addFieldValue(new autoclass.fieldValue().setName("startnode")
        .addChild(new autoclass.ProtoInstance().setUSE("G1")))
      .addFieldValue(new autoclass.fieldValue().setName("endnode")
        .addChild(new autoclass.ProtoInstance().setUSE("G3")))
      .addFieldValue(new autoclass.fieldValue().setName("set_startpoint"))
      .addFieldValue(new autoclass.fieldValue().setName("set_endpoint")))
    .addChild(new autoclass.ProtoInstance("connector3", "x3dconnector").setDEF("connector3").setName("x3dconnector")
      .addFieldValue(new autoclass.fieldValue().setName("startnode")
        .addChild(new autoclass.ProtoInstance().setUSE("G1")))
      .addFieldValue(new autoclass.fieldValue().setName("endnode")
        .addChild(new autoclass.ProtoInstance().setUSE("G4")))
      .addFieldValue(new autoclass.fieldValue().setName("set_startpoint"))
      .addFieldValue(new autoclass.fieldValue().setName("set_endpoint")))

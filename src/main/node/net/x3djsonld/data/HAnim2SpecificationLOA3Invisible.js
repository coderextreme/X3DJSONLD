...
HAnim2SpecificationLOA3Invisible.prototype = {
  ...
  .setHead((new autoclass.head())
    ...
    .addMeta((new autoclass.meta()).setName("modified").setContent("13 March 2021"))
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.HAnimHumanoid("hanim_humanoid")).setName("humanoid").setVersion("2.0").setLoa(3)
        ...
        .addChild((new autoclass.HAnimJoint("hanim_sacroiliac")).setName("sacroiliac").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,0.9149,0.0016)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_l_hip")).setName("l_hip").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0961,0.9124,-0.0001)
            ...
            .addChild((new autoclass.HAnimJoint("hanim_l_knee")).setName("l_knee").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.104,0.4867,0.0308)
              ...
              .addChild((new autoclass.HAnimJoint("hanim_l_talocrural")).setName("l_talocrural").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1101,0.0656,-0.0736)
                ...
                .addChild((new autoclass.HAnimJoint("hanim_l_tarsometatarsal_2")).setName("l_tarsometatarsal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1086,0.0001,-0.0368)
                  .addChild((new autoclass.HAnimSegment("hanim_l_metatarsal_2")).setName("l_metatarsal_2"))
                  .addChild((new autoclass.HAnimJoint("hanim_l_metatarsophalangeal_2")).setName("l_metatarsophalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1086,0.0001,0.0368)
                    ...
                    .addChild((new autoclass.HAnimJoint("hanim_l_tarsal_distal_interphalangeal_2")).setName("l_tarsal_distal_interphalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1086,0.0,0.0762)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_r_hip")).setName("r_hip").setCenter(-0.0961,0.9124,-0.0001).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
            ...
            .addChild((new autoclass.HAnimJoint("hanim_r_knee")).setName("r_knee").setCenter(-0.104,0.4867,0.0308).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
              ...
              .addChild((new autoclass.HAnimJoint("hanim_r_talocrural")).setName("r_talocrural").setCenter(-0.1101,0.0656,-0.0736).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                ...
                .addChild((new autoclass.HAnimJoint("hanim_r_tarsometatarsal_2")).setName("r_tarsometatarsal_2").setCenter(-0.1086,0.0001,-0.0368).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                  .addChild((new autoclass.HAnimSegment("hanim_r_metatarsal_2")).setName("r_metatarsal_2"))
                  .addChild((new autoclass.HAnimJoint("hanim_r_metatarsophalangeal_2")).setName("r_metatarsophalangeal_2").setCenter(-0.1086,0.0001,0.0368).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                    ...
                    .addChild((new autoclass.HAnimJoint("hanim_r_tarsal_distal_interphalangeal_2")).setName("r_tarsal_distal_interphalangeal_2").setCenter(-0.1086,0.0,0.0762).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                      ...
                                                      .addChild((new autoclass.HAnimJoint("hanim_vc1")).setName("vc1").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0066,1.6144,-0.0034)
                                                        ...
                                                        .addChild((new autoclass.HAnimJoint("hanim_skullbase")).setName("skullbase").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0044,1.6209,0.0236)
                                                          .addChild((new autoclass.HAnimSegment("hanim_skull")).setName("skull")
                                                            .addChild((new autoclass.HAnimSite("hanim_skull_vertex_tip")).setName("skull_vertex_tip").setTranslation(0.005,1.7504,0.0055)
                                            ...
                                            .addChild((new autoclass.HAnimJoint("hanim_l_acromioclavicular")).setName("l_acromioclavicular").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0962,1.4269,-0.0424)
                                              ...
                                              .addChild((new autoclass.HAnimJoint("hanim_l_shoulder")).setName("l_shoulder").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.2029,1.4376,-0.0387)
                                                ...
                                                .addChild((new autoclass.HAnimJoint("hanim_l_elbow")).setName("l_elbow").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.2014,1.1357,-0.0682)
                                                  ...
                                                  .addChild((new autoclass.HAnimJoint("hanim_l_radiocarpal")).setName("l_radiocarpal").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1984,0.8663,-0.0583)
                                                    ...
                                                    .addChild((new autoclass.HAnimJoint("hanim_l_carpometacarpal_1")).setName("l_carpometacarpal_1").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1924,0.8472,-0.0534)
                                                      .addChild((new autoclass.HAnimSegment("hanim_l_metacarpal_1")).setName("l_metacarpal_1"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_l_metacarpophalangeal_1")).setName("l_metacarpophalangeal_1").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1951,0.8226,0.0246)
                                                        .addChild((new autoclass.HAnimSegment("hanim_l_carpal_proximal_phalanx_1")).setName("l_carpal_proximal_phalanx_1"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_l_carpal_interphalangeal_1")).setName("l_carpal_interphalangeal_1").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1955,0.8159,0.0464)
                                                          .addChild((new autoclass.HAnimSegment("hanim_l_carpal_distal_phalanx_1")).setName("l_carpal_distal_phalanx_1")
                                                            .addChild((new autoclass.HAnimSite("hanim_l_carpal_distal_phalanx_1_tip")).setName("l_carpal_distal_phalanx_1_tip").setTranslation(0.1982,0.8061,0.0759))))))
                                                    .addChild((new autoclass.HAnimJoint("hanim_l_carpometacarpal_2")).setName("l_carpometacarpal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1983,0.8024,-0.028)
                                                      .addChild((new autoclass.HAnimSegment("hanim_l_metacarpal_2")).setName("l_metacarpal_2"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_l_metacarpophalangeal_2")).setName("l_metacarpophalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1983,0.7815,-0.028)
                                                        .addChild((new autoclass.HAnimSegment("hanim_l_carpal_proximal_phalanx_2")).setName("l_carpal_proximal_phalanx_2"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2")).setName("l_carpal_proximal_interphalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.2017,0.7363,-0.0248)
                                                          .addChild((new autoclass.HAnimSegment("hanim_l_carpal_middle_phalanx_2")).setName("l_carpal_middle_phalanx_2"))
                                                          .addChild((new autoclass.HAnimJoint("hanim_l_carpal_distal_interphalangeal_2")).setName("l_carpal_distal_interphalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.2028,0.7139,-0.0236)
                                                            .addChild((new autoclass.HAnimSegment("hanim_l_carpal_distal_phalanx_2")).setName("l_carpal_distal_phalanx_2")
                                                              .addChild((new autoclass.HAnimSite("hanim_l_carpal_distal_phalanx_2_tip")).setName("l_carpal_distal_phalanx_2_tip").setTranslation(0.2089,0.6858,-0.0245))
                                                              .addChild((new autoclass.HAnimSite("hanim_l_dactylion_pt")).setName("l_dactylion_pt").setTranslation(0.2056,0.6743,-0.0482)))))))
                                                    .addChild((new autoclass.HAnimJoint("hanim_l_carpometacarpal_3")).setName("l_carpometacarpal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1987,0.8029,-0.053)
                                                      .addChild((new autoclass.HAnimSegment("hanim_l_metacarpal_3")).setName("l_metacarpal_3"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_l_metacarpophalangeal_3")).setName("l_metacarpophalangeal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1987,0.7818,-0.053)
                                                        .addChild((new autoclass.HAnimSegment("hanim_l_carpal_proximal_phalanx_3")).setName("l_carpal_proximal_phalanx_3"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3")).setName("l_carpal_proximal_interphalangeal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.2013,0.7273,-0.0503)
                                                          .addChild((new autoclass.HAnimSegment("hanim_l_carpal_middle_phalanx_3")).setName("l_carpal_middle_phalanx_3"))
                                                          .addChild((new autoclass.HAnimJoint("hanim_l_carpal_distal_interphalangeal_3")).setName("l_carpal_distal_interphalangeal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.2026,0.7011,-0.0494)
                                                            .addChild((new autoclass.HAnimSegment("hanim_l_carpal_distal_phalanx_3")).setName("l_carpal_distal_phalanx_3")
                                                              .addChild((new autoclass.HAnimSite("hanim_l_carpal_distal_phalanx_3_tip")).setName("l_carpal_distal_phalanx_3_tip").setTranslation(0.208,0.6731,-0.0491)))))))
                                                    .addChild((new autoclass.HAnimJoint("hanim_l_carpometacarpal_4")).setName("l_carpometacarpal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1956,0.8019,-0.0794)
                                                      .addChild((new autoclass.HAnimSegment("hanim_l_metacarpal_4")).setName("l_metacarpal_4"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_l_metacarpophalangeal_4")).setName("l_metacarpophalangeal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1956,0.7815,-0.0794)
                                                        .addChild((new autoclass.HAnimSegment("hanim_l_carpal_proximal_phalanx_4")).setName("l_carpal_proximal_phalanx_4"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4")).setName("l_carpal_proximal_interphalangeal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1973,0.7287,-0.0777)
                                                          .addChild((new autoclass.HAnimSegment("hanim_l_carpal_middle_phalanx_4")).setName("l_carpal_middle_phalanx_4"))
                                                          .addChild((new autoclass.HAnimJoint("hanim_l_carpal_distal_interphalangeal_4")).setName("l_carpal_distal_interphalangeal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1983,0.7045,-0.0767)
                                                            .addChild((new autoclass.HAnimSegment("hanim_l_carpal_distal_phalanx_4")).setName("l_carpal_distal_phalanx_4")
                                                              .addChild((new autoclass.HAnimSite("hanim_l_carpal_distal_phalanx_4_tip")).setName("l_carpal_distal_phalanx_4_tip").setTranslation(0.2035,0.675,-0.0756)))))))
                                                    .addChild((new autoclass.HAnimJoint("hanim_l_carpometacarpal_5")).setName("l_carpometacarpal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1925,0.8066,-0.1036)
                                                      .addChild((new autoclass.HAnimSegment("hanim_l_metacarpal_5")).setName("l_metacarpal_5"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_l_metacarpophalangeal_5")).setName("l_metacarpophalangeal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1925,0.7866,-0.1036)
                                                        .addChild((new autoclass.HAnimSegment("hanim_l_carpal_proximal_phalanx_5")).setName("l_carpal_proximal_phalanx_5"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_l_carpal_proximal_interphalangeal_5")).setName("l_carpal_proximal_interphalangeal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1938,0.7452,-0.1024)
                                                          .addChild((new autoclass.HAnimSegment("hanim_l_carpal_middle_phalanx_5")).setName("l_carpal_middle_phalanx_5"))
                                                          .addChild((new autoclass.HAnimJoint("hanim_l_carpal_distal_interphalangeal_5")).setName("l_carpal_distal_interphalangeal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1948,0.7277,-0.1017)
                                                            .addChild((new autoclass.HAnimSegment("hanim_l_carpal_distal_phalanx_5")).setName("l_carpal_distal_phalanx_5")
                                                              .addChild((new autoclass.HAnimSite("hanim_l_carpal_distal_phalanx_5_tip")).setName("l_carpal_distal_phalanx_5_tip").setTranslation(0.2014,0.7009,-0.1012))))))))))))
                                            ...
                                            .addChild((new autoclass.HAnimJoint("hanim_r_acromioclavicular")).setName("r_acromioclavicular").setCenter(-0.0962,1.4269,-0.0424).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                              ...
                                              .addChild((new autoclass.HAnimJoint("hanim_r_shoulder")).setName("r_shoulder").setCenter(-0.2029,1.4376,-0.0387).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                ...
                                                .addChild((new autoclass.HAnimJoint("hanim_r_elbow")).setName("r_elbow").setCenter(-0.2014,1.1357,-0.0682).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                  ...
                                                  .addChild((new autoclass.HAnimJoint("hanim_r_radiocarpal")).setName("r_radiocarpal").setCenter(-0.1984,0.8663,-0.0583).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                    ...
                                                    .addChild((new autoclass.HAnimJoint("hanim_r_carpometacarpal_1")).setName("r_carpometacarpal_1").setCenter(-0.1924,0.8472,-0.0534).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                      .addChild((new autoclass.HAnimSegment("hanim_r_metacarpal_1")).setName("r_metacarpal_1"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_r_metacarpophalangeal_1")).setName("r_metacarpophalangeal_1").setCenter(-0.1951,0.8226,0.0246).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                        .addChild((new autoclass.HAnimSegment("hanim_r_carpal_proximal_phalanx_1")).setName("r_carpal_proximal_phalanx_1"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_r_carpal_interphalangeal_1")).setName("r_carpal_interphalangeal_1").setCenter(-0.1955,0.8159,0.0464).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                          .addChild((new autoclass.HAnimSegment("hanim_r_carpal_distal_phalanx_1")).setName("r_carpal_distal_phalanx_1")
                                                            .addChild((new autoclass.HAnimSite("hanim_r_carpal_distal_phalanx_1_tip")).setName("r_carpal_distal_phalanx_1_tip").setTranslation(-0.1869,0.809,0.082))))))
                                                    .addChild((new autoclass.HAnimJoint("hanim_r_carpometacarpal_2")).setName("r_carpometacarpal_2").setCenter(-0.1983,0.8024,-0.028).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                      .addChild((new autoclass.HAnimSegment("hanim_r_metacarpal_2")).setName("r_metacarpal_2"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_r_metacarpophalangeal_2")).setName("r_metacarpophalangeal_2").setCenter(-0.1983,0.7815,-0.028).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                        .addChild((new autoclass.HAnimSegment("hanim_r_carpal_proximal_phalanx_2")).setName("r_carpal_proximal_phalanx_2"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2")).setName("r_carpal_proximal_interphalangeal_2").setCenter(-0.2017,0.7363,-0.0248).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                          .addChild((new autoclass.HAnimSegment("hanim_r_carpal_middle_phalanx_2")).setName("r_carpal_middle_phalanx_2"))
                                                          .addChild((new autoclass.HAnimJoint("hanim_r_carpal_distal_interphalangeal_2")).setName("r_carpal_distal_interphalangeal_2").setCenter(-0.2028,0.7139,-0.0236).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                            .addChild((new autoclass.HAnimSegment("hanim_r_carpal_distal_phalanx_2")).setName("r_carpal_distal_phalanx_2")
                                                              .addChild((new autoclass.HAnimSite("hanim_r_carpal_distal_phalanx_2_tip")).setName("r_carpal_distal_phalanx_2_tip").setTranslation(-0.198,0.6883,-0.018))
                                                              .addChild((new autoclass.HAnimSite("hanim_r_dactylion_pt")).setName("r_dactylion_pt").setTranslation(-0.1941,0.6772,-0.0423)))))))
                                                    .addChild((new autoclass.HAnimJoint("hanim_r_carpometacarpal_3")).setName("r_carpometacarpal_3").setCenter(-0.1987,0.8029,-0.053).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                      .addChild((new autoclass.HAnimSegment("hanim_r_metacarpal_3")).setName("r_metacarpal_3"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_r_metacarpophalangeal_3")).setName("r_metacarpophalangeal_3").setCenter(-0.1987,0.7818,-0.053).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                        .addChild((new autoclass.HAnimSegment("hanim_r_carpal_proximal_phalanx_3")).setName("r_carpal_proximal_phalanx_3"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3")).setName("r_carpal_proximal_interphalangeal_3").setCenter(-0.2013,0.7273,-0.0503).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                          .addChild((new autoclass.HAnimSegment("hanim_r_carpal_middle_phalanx_3")).setName("r_carpal_middle_phalanx_3"))
                                                          .addChild((new autoclass.HAnimJoint("hanim_r_carpal_distal_interphalangeal_3")).setName("r_carpal_distal_interphalangeal_3").setCenter(-0.2026,0.7011,-0.0494).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                            .addChild((new autoclass.HAnimSegment("hanim_r_carpal_distal_phalanx_3")).setName("r_carpal_distal_phalanx_3")
                                                              .addChild((new autoclass.HAnimSite("hanim_r_carpal_distal_phalanx_3_tip")).setName("r_carpal_distal_phalanx_3_tip").setTranslation(-0.1969,0.6758,-0.0427)))))))
                                                    .addChild((new autoclass.HAnimJoint("hanim_r_carpometacarpal_4")).setName("r_carpometacarpal_4").setCenter(-0.1956,0.8019,-0.0794).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                      .addChild((new autoclass.HAnimSegment("hanim_r_metacarpal_4")).setName("r_metacarpal_4"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_r_metacarpophalangeal_4")).setName("r_metacarpophalangeal_4").setCenter(-0.1956,0.7815,-0.0794).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                        .addChild((new autoclass.HAnimSegment("hanim_r_carpal_proximal_phalanx_4")).setName("r_carpal_proximal_phalanx_4"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4")).setName("r_carpal_proximal_interphalangeal_4").setCenter(-0.1973,0.7287,-0.0777).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                          .addChild((new autoclass.HAnimSegment("hanim_r_carpal_middle_phalanx_4")).setName("r_carpal_middle_phalanx_4"))
                                                          .addChild((new autoclass.HAnimJoint("hanim_r_carpal_distal_interphalangeal_4")).setName("r_carpal_distal_interphalangeal_4").setCenter(-0.1983,0.7045,-0.0767).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                            .addChild((new autoclass.HAnimSegment("hanim_r_carpal_distal_phalanx_4")).setName("r_carpal_distal_phalanx_4")
                                                              .addChild((new autoclass.HAnimSite("hanim_r_carpal_distal_phalanx_4_tip")).setName("r_carpal_distal_phalanx_4_tip").setTranslation(-0.1934,0.6778,-0.0693)))))))
                                                    .addChild((new autoclass.HAnimJoint("hanim_r_carpometacarpal_5")).setName("r_carpometacarpal_5").setCenter(-0.1925,0.8066,-0.1036).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                      .addChild((new autoclass.HAnimSegment("hanim_r_metacarpal_5")).setName("r_metacarpal_5"))
                                                      .addChild((new autoclass.HAnimJoint("hanim_r_metacarpophalangeal_5")).setName("r_metacarpophalangeal_5").setCenter(-0.1925,0.7866,-0.1036).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                        .addChild((new autoclass.HAnimSegment("hanim_r_carpal_proximal_phalanx_5")).setName("r_carpal_proximal_phalanx_5"))
                                                        .addChild((new autoclass.HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5")).setName("r_carpal_proximal_interphalangeal_5").setCenter(-0.1938,0.7452,-0.1024).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                          .addChild((new autoclass.HAnimSegment("hanim_r_carpal_middle_phalanx_5")).setName("r_carpal_middle_phalanx_5"))
                                                          .addChild((new autoclass.HAnimJoint("hanim_r_carpal_distal_interphalangeal_5")).setName("r_carpal_distal_interphalangeal_5").setCenter(-0.1948,0.7277,-0.1017).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                                                            .addChild((new autoclass.HAnimSegment("hanim_r_carpal_distal_phalanx_5")).setName("r_carpal_distal_phalanx_5")
                                                              .addChild((new autoclass.HAnimSite("hanim_r_carpal_distal_phalanx_5_tip")).setName("r_carpal_distal_phalanx_5_tip").setTranslation(-0.1938,0.7035,-0.0949))))))))))))))))))))))))))))))
      ...
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpal_distal_interphalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpal_distal_interphalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpal_distal_interphalangeal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpal_distal_interphalangeal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpal_distal_interphalangeal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpal_distal_interphalangeal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpal_distal_interphalangeal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpal_distal_interphalangeal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpal_interphalangeal_1").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpal_interphalangeal_1").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpal_proximal_interphalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpal_proximal_interphalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpal_proximal_interphalangeal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpal_proximal_interphalangeal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpal_proximal_interphalangeal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpal_proximal_interphalangeal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpal_proximal_interphalangeal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpal_proximal_interphalangeal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpometacarpal_1").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpometacarpal_1").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpometacarpal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpometacarpal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpometacarpal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpometacarpal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpometacarpal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpometacarpal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_carpometacarpal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_carpometacarpal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      ...
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_metacarpophalangeal_1").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_metacarpophalangeal_1").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_metacarpophalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_metacarpophalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_metacarpophalangeal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_metacarpophalangeal_3").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_metacarpophalangeal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_metacarpophalangeal_4").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_metacarpophalangeal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_metacarpophalangeal_5").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_metatarsophalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_metatarsophalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_radiocarpal").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_radiocarpal").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      ...
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_talocrural").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_talocrural").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_tarsal_distal_interphalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_tarsal_distal_interphalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_l_tarsometatarsal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
      .addJoints((new autoclass.HAnimJoint()).setUSE("hanim_r_tarsometatarsal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new HAnim2SpecificationLOA3Invisible();
		console.log ("HAnim2SpecificationLOA3Invisible execution self-validation test results: " + testObject.validateSelf());
	}
}
new HAnim2SpecificationLOA3Invisible().main();
process.exit(0);
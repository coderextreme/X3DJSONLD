...
LOA3ExampleSourceWithDiamonds.prototype = {
  ...
  initialize : function ()
  {
	...
	this.fieldValue_info_4_1305_value = new autoclass.SFString("\"authorName=Matthew T. Beitler\" \"authorEmail=beitler@cis.upenn.edu or beitler@acm.org\" \"creationDate=05/12/99\" \"copyright=Copyright 1999-2003, Matthew T. Beitler\" \"humanoidVersion=JointCenters 200x, LOA&#8209;3\" \"usageRestrictions=
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Group("JointCenters_WorldInfo"))
      .addChild((new autoclass.WorldInfo()).setInfo(this.WorldInfo_4_1307_info).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;3")))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		console.log ("LOA3ExampleSourceWithDiamonds execution self-validation test results: " + testObject.validateSelf());
	}
}

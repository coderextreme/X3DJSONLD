  ...
  .setScene((new autoclass.Scene())
    .addChild((new autoclass.ProtoDeclare()).setName("RoundedRectangle2D")
      .setProtoInterface((new autoclass.ProtoInterface())
        ...
        .addField((new autoclass.field()).setName("size").setType("SFVec2f").setAccessType("initializeOnly").setValue("2 2"))
...
"}" + "\n")
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("Widget")
      .setProtoInterface((new autoclass.ProtoInterface())
        .addField((new autoclass.field()).setName("fillColor").setType("SFColor").setAccessType("inputOutput").setValue("0.1 0.1 0.1"))
        .addField((new autoclass.field()).setName("lineColor").setType("SFColor").setAccessType("inputOutput").setValue("0.4 0.4 0.4"))
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("Node")
      .setProtoInterface((new autoclass.ProtoInterface())
        .addField((new autoclass.field()).setName("translation").setType("SFVec3f").setAccessType("inputOutput")))
      .setProtoBody((new autoclass.ProtoBody())
...
"}" + "\n")
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("Route")
      .setProtoInterface((new autoclass.ProtoInterface())
        .addField((new autoclass.field()).setName("lineColor").setType("SFColor").setAccessType("inputOutput").setValue("0.43 0.43 0.98"))
...
"	}" + "\n" + 
"}" + "\n")
          .addField((new autoclass.field()).setName("set_translation").setType("SFVec3f").setAccessType("inputOnly"))
    ...
    .addChild((new autoclass.OrthoViewpoint()).setDescription("OthoViewpoint").setCenterOfRotation(-3.13496,-4.19776,0.0).setFieldOfView(0, 0, 10, 10).setPosition(-3.13496,-4.19776,10.0))

...
BoxMan.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ROUTE()).setFromNode("ANIMATOR").setFromField("HumanoidRoot_translation_changed").setToNode("boxman_HumanoidRoot").setToField("set_translation"))
    .addChild((new autoclass.ROUTE()).setFromNode("ANIMATOR").setFromField("HumanoidRoot_rotation_changed").setToNode("boxman_HumanoidRoot").setToField("set_rotation"))

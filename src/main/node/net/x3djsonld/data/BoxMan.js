...
BoxMan.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ExternProtoDeclare()).setName("LOA1_WalkAnimation").setUrl(new autoclass.MFString("\"LOA1_WalkAnimation.wrl#LOA1_WalkAnimation\" \"https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/LOA1_WalkAnimation.wrl#LOA1_WalkAnimation\" \"http://HAnim.org/Models/HAnim2001/boxman/protos/LOA1WalkAnimation.wrl#LOA1WalkAnimation\" \"LOA1_WalkAnimation.x3d#LOA1_WalkAnimation\" \"https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/LOA1_WalkAnimation.x3d#LOA1_WalkAnimation\" \"http://HAnim.org/Models/HAnim2001/boxman/protos/LOA1WalkAnimation.x3d#LOA1WalkAnimation\""))
      ...
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("startTime").setType("SFTime"))
      .addField((new autoclass.field()).setAccessType("inputOutput").setName("stopTime").setType("SFTime"))
    ...
    .addChild((new autoclass.ProtoInstance("ANIMATOR", "LOA1_WalkAnimation")).setDEF("ANIMATOR").setName("LOA1_WalkAnimation"))
    ...
    .addChild((new autoclass.Script("ENGINE")).setDirectOutput(true).setUrl(new autoclass.MFString("\"BoxMan.js\" \"https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan.js\""))
      ...
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("humanoid").setType("SFNode")
        .addChild((new autoclass.HAnimHumanoid()).setUSE("boxman_Humanoid").setVersion("1.0")))
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("coordList").setType("MFVec3f"))
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("joint").setType("SFNode")
        .addComments(" initialization node (if any) goes here "))
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("translation").setType("SFVec3f").setValue("0 0 0"))
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("rotation").setType("SFRotation").setValue("1 0 0 0"))
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("scale").setType("SFVec3f").setValue("1 1 1")))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		console.log ("BoxMan execution self-validation test results: " + testObject.validateSelf());
	}
}
new BoxMan().main();
process.exit(0);
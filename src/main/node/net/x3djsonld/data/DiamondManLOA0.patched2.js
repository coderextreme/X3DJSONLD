...
function DiamondManLOA0_patched2
...
DiamondManLOA0_patched2.prototype = {
  ...
  .setHead((new autoclass.head())
    ...
    .addMeta((new autoclass.meta()).setName("modified").setContent("2 November 2023"))
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.HAnimHumanoid("hanim_humanoid")).setName("humanoid").setLoa(0).setVersion("2.0")
      ...
      .addSkeleton((new autoclass.HAnimJoint("hanim_humanoid_root")).setName("humanoid_root").setCenter(0.0,0.8240,0.0277).setLlimit(java.newArray("float", [0.0,0.0,0.0])).setUlimit(java.newArray("float", [0.0,0.0,0.0]))
   ...
   * @return DiamondManLOA0_patched2 model
   */
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new DiamondManLOA0_patched2();
		console.log ("DiamondManLOA0_patched2 execution self-validation test results: " + testObject.validateSelf());
	}
}
new DiamondManLOA0_patched2().main();
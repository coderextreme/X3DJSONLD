...
HAnimModelHandRight.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.HAnimHumanoid("Humanoid_Right_hand")).setName("Humanoid_Right_hand").setLoa(-1).setJointBindingPositions(new autoclass.MFVec3f(java.newArray(
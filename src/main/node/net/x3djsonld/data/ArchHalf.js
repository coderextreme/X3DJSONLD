...
ArchHalf.prototype = {
  ...
  initialize : function ()
  {
	...
	this.ArchChord_5_13_point = new autoclass.MFVec3f() /* splitting up long array to improve readability */
  ...
  .setHead((new autoclass.head())
    ...
    .addMeta((new autoclass.meta()).setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/Buildings/ArchHalf.x3d"))
    .addMeta((new autoclass.meta()).setName("generator").setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta((new autoclass.meta()).setName("license").setContent("../license.html")))
  .setScene((new autoclass.Scene())
    .addChild((new autoclass.WorldInfo()).setTitle("ArchHalf.x3d"))
    .addChild((new autoclass.Shape("Arch"))
      ...
      .setGeometry((new autoclass.IndexedFaceSet("ArchIndex")).setDEF("ArchIndex").setConvex(false).setSolid(false).setCoordIndex(this.ArchIndex_4_13_coordIndex)
        .setCoord((new autoclass.Coordinate("ArchChord")).setPoint(this.ArchChord_5_13_point)))

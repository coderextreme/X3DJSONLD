    ...
    .addChild((new autoclass.ProtoDeclare()).setName("ViewFrustum").setAppinfo("Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes")
      .setProtoInterface((new autoclass.ProtoInterface())
        ...
        .addField((new autoclass.field()).setAccessType("initializeOnly").setName("NavigationInfoNode").setType("SFNode").setAppinfo("required: insert NavigationInfo DEF or USE node of interest")
          .addComments(" NULL node, ProtoInstance must provide "))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("visible").setType("SFBool").setValue("true").setAppinfo("whether or not frustum geometry is rendered"))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("lineColor").setType("SFColor").setValue("0.9 0.9 0.9").setAppinfo("RGB color of ViewFrustum outline, default value 0.9 0.9 0.9"))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("frustumColor").setType("SFColor").setValue("0.8 0.8 0.8").setAppinfo("RGB color of ViewFrustum hull geometry, default value 0.8 0.8 0.8"))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("transparency").setType("SFFloat").setValue("0.5").setAppinfo("transparency of ViewFrustum hull geometry, default value 0.5"))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("aspectRatio").setType("SFFloat").setValue("0.75").setAppinfo("assumed ratio height/width, default value 0.75"))
        .addField((new autoclass.field()).setAccessType("initializeOnly").setName("trace").setType("SFBool").setValue("false").setAppinfo("debug support, default false")))
      .setProtoBody((new autoclass.ProtoBody())
        ...
        .addChild((new autoclass.Script("GeometryComputationScript")).setDirectOutput(true).setUrl(new autoclass.MFString("\"ViewFrustumPrototypeScript.js\""))
          ...
          .addField((new autoclass.field()).setAccessType("outputOnly").setName("visibilitySwitchSelection").setType("SFInt32").setAppinfo("Adjust Switch selection to make geometry visible or not"))
          .addField((new autoclass.field()).setAccessType("initializeOnly").setName("ViewpointNode").setType("SFNode")
            .addComments(" initialization node (if any) goes here "))
          .addField((new autoclass.field()).setAccessType("initializeOnly").setName("NavigationInfoNode").setType("SFNode")
            .addComments(" initialization node (if any) goes here "))
          .addField((new autoclass.field()).setAccessType("initializeOnly").setName("FrustumCoordinate").setType("SFNode")
            .addChild((new autoclass.Coordinate()).setUSE("FrustumCoordinate")))
          .addField((new autoclass.field()).setAccessType("initializeOnly").setName("FrustumExtrusion").setType("SFNode")
            .addChild((new autoclass.Extrusion()).setUSE("FrustumExtrusion")))
          .addField((new autoclass.field()).setAccessType("inputOnly").setName("recompute").setType("SFBool"))
          .addField((new autoclass.field()).setAccessType("inputOutput").setName("aspectRatio").setType("SFFloat").setAppinfo("assumed ratio height/width"))
          .addField((new autoclass.field()).setAccessType("outputOnly").setName("position_changed").setType("SFVec3f"))
          .addField((new autoclass.field()).setAccessType("outputOnly").setName("orientation_changed").setType("SFRotation"))
          .addField((new autoclass.field()).setAccessType("outputOnly").setName("spine_changed").setType("MFVec3f"))
          .addField((new autoclass.field()).setAccessType("outputOnly").setName("scale_changed").setType("MFVec2f"))
          .addField((new autoclass.field()).setAccessType("outputOnly").setName("point_changed").setType("MFVec3f"))
          .addField((new autoclass.field()).setAccessType("initializeOnly").setName("trace").setType("SFBool"))
          .setIS((new autoclass.IS())

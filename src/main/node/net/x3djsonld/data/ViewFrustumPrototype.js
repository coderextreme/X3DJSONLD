  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("ViewFrustum").setAppinfo("Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes")
      .setProtoInterface((new autoclass.ProtoInterface())
        ...
        .addField((new autoclass.field()).setName(lineColor).setType(SFColor.0).setAccessType(inputOutput.0).setValue(0.9,0.9,0.9).setAppinfo(RGB,color,of,ViewFrustum,outline,,default,value,0.9,0.9,0.9))
        .addField((new autoclass.field()).setName(frustumColor.0).setType(SFColor.0).setAccessType(inputOutput.0).setValue(0.8,0.8,0.8).setAppinfo(RGB,color,of,ViewFrustum,hull,geometry,,default,value,0.8,0.8,0.8))
      ...
      .setProtoBody((new autoclass.ProtoBody())
        ...
        .addChild((new autoclass.Script("GeometryComputationScript")).setDirectOutput(true).setUrl(new autoclass.MFString("\"ViewFrustumPrototypeScript.js\""))
          ...
          .addField((new autoclass.field()).setName(position_changed).setType(SFVec3f).setAccessType(outputOnly.0))
          .addField((new autoclass.field()).setName(orientation_changed).setType(SFRotation.0).setAccessType(outputOnly.0))
          .addField((new autoclass.field()).setName(new autoclass.MFVec3f(java.newArray("float", [spine_changed]))).setType(new autoclass.MFVec3f(java.newArray("float", [MFVec3f]))).setAccessType(new autoclass.MFVec3f(java.newArray("float", [outputOnly.0]))))
          .addField((new autoclass.field()).setName(new autoclass.MFVec2f(java.newArray("float", [scale_changed]))).setType(new autoclass.MFVec2f(java.newArray("float", [MFVec2f]))).setAccessType(new autoclass.MFVec2f(java.newArray("float", [outputOnly.0]))))
          .addField((new autoclass.field()).setName(new autoclass.MFVec3f(java.newArray("float", [point_changed]))).setType(new autoclass.MFVec3f(java.newArray("float", [MFVec3f]))).setAccessType(new autoclass.MFVec3f(java.newArray("float", [outputOnly.0]))))

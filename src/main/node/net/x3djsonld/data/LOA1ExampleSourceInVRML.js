...
LOA1ExampleSourceInVRML.prototype = {
  ...
  initialize : function ()
  {
	...
	this.fieldValue_info_4_606_value = new autoclass.SFString("\"authorName=Matthew T. Beitler\" \"authorEmail=beitler@cis.upenn.edu or beitler@acm.org\" \"creationDate=05/12/99\" \"copyright=Copyright 1999-2003, Matthew T. Beitler\" \"humanoidVersion=JointCenters 200x, LOA&#8209;1\" \"usageRestrictions=
	...
	this.WorldInfo_4_608_info = new autoclass.MFString(new autoclass.MFString("\"
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ProtoInstance("humanoid_2", "Humanoid")).setDEF("humanoid_2").setName("Humanoid")
      ...
      .addFieldValue((new autoclass.fieldValue()).setName("info").setValue(this.fieldValue_info_4_606_value)))
    .addChild((new autoclass.Group("JointCenters_WorldInfo"))
      .addChild((new autoclass.WorldInfo()).setInfo(this.WorldInfo_4_608_info).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;1")))

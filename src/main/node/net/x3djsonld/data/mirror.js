...
mirror.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.TextureBackground())
      .setLeft((new autoclass.ImageTexture("leftBackgroundTexture")).setUrl(new autoclass.MFString("\"../resources/images/all_probes/beach_cross/beach_left.png\" \"https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_left.png\"")))
      .setRight((new autoclass.ImageTexture("rightBackgroundTexture")).setUrl(new autoclass.MFString("\"../resources/images/all_probes/beach_cross/beach_right.png\" \"https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_right.png\"")))
      .setFront((new autoclass.ImageTexture("frontBackgroundTexture")).setUrl(new autoclass.MFString("\"../resources/images/all_probes/beach_cross/beach_front.png\" \"https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_front.png\"")))
      .setBack((new autoclass.ImageTexture("backBackgroundTexture")).setUrl(new autoclass.MFString("\"../resources/images/all_probes/beach_cross/beach_back.png\" \"https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_back.png\"")))
      .setTop((new autoclass.ImageTexture("topBackgroundTexture")).setUrl(new autoclass.MFString("\"../resources/images/all_probes/beach_cross/beach_top.png\" \"https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_top.png\"")))
      .setBottom((new autoclass.ImageTexture("bottomBackgroundTexture")).setUrl(new autoclass.MFString("\"../resources/images/all_probes/beach_cross/beach_bottom.png\" \"https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_bottom.png\""))))

...
"					}" + "\n")
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("cylinder")
      ...
      .setProtoBody((new autoclass.ProtoBody())
        .addChild((new autoclass.Group())
          .addChild((new autoclass.Shape())
            .setGeometry((new autoclass.Extrusion("extrusion")).setSpine(new autoclass.MFVec3f(java.newArray("float", [0.0,-50.0,0.0,0.0,50.0,0.0]))).setCreaseAngle(0.785).setCrossSection(this.extrusion_7_40_crossSection))
            .setAppearance((new autoclass.Appearance())

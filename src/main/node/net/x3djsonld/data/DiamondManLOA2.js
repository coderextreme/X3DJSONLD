...
DiamondManLOA2.prototype = {
        ...
        .addChild((new autoclass.Transform()).setTranslation(0.0,-1.1,0.0)
          ...
          .addChild((new autoclass.Transform()).setTranslation(0.2,0.0,0.0)
            .addChild((new autoclass.Shape())
              ...
              .setAppearance((new autoclass.Appearance())
                .setMaterial((new autoclass.Material()).setUSE("TextMaterial"))))))))
    .addChild((new autoclass.HAnimHumanoid("hanim_humanoid")).setName("humanoid").setLoa(2).setVersion("2.0")
              ...
              .addChild((new autoclass.HAnimSegment("hanim_l3")).setName("l3")
                .addChild((new autoclass.Transform()).setTranslation(0.0041,1.1276,-0.0796)
                  .addChild((new autoclass.Shape())
                    ...
                    .setAppearance((new autoclass.Appearance())
                      .setMaterial((new autoclass.Material()).setUSE("REC_SPINAL_COLOR"))))))
              .addChild((new autoclass.HAnimJoint("hanim_vl2")).setName("vl2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0045,1.1546,-0.0800)
                    ...
                    .addChild((new autoclass.HAnimSegment("hanim_t12")).setName("t12")
                      .addChild((new autoclass.Transform()).setTranslation(0.0051,1.2278,-0.0808)
                        .addChild((new autoclass.Shape())
                          ...
                          .setAppearance((new autoclass.Appearance())
                            .setMaterial((new autoclass.Material()).setUSE("SPINAL_COLOR"))))))
                    .addChild((new autoclass.HAnimJoint("hanim_vt11")).setName("vt11").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0053,1.2679,-0.0810)
                              ...
                              .addChild((new autoclass.HAnimSegment("hanim_t7")).setName("t7")
                                .addChild((new autoclass.Transform()).setTranslation(0.0058,1.3625,-0.0833)
                                  .addChild((new autoclass.Shape())
                                    ...
                                    .setAppearance((new autoclass.Appearance())
                                      .setMaterial((new autoclass.Material()).setUSE("SPINAL_COLOR"))))))
                              .addChild((new autoclass.HAnimJoint("hanim_vt6")).setName("vt6").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0059,1.3866,-0.0800)
                                .addChild((new autoclass.HAnimSegment("hanim_t6")).setName("t6")
                                  .addChild((new autoclass.Transform()).setTranslation(0.0059,1.3866,-0.0800)
                                    .addChild((new autoclass.Shape())
                                      ...
                                      .setAppearance((new autoclass.Appearance())
                                        .setMaterial((new autoclass.Material()).setUSE("REC_SPINAL_COLOR"))))))
                                .addChild((new autoclass.HAnimJoint("hanim_vt5")).setName("vt5").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0060,1.4102,-0.0745)
                                  .addChild((new autoclass.HAnimSegment("hanim_t5")).setName("t5")
                                    .addChild((new autoclass.Transform()).setTranslation(0.0060,1.4102,-0.0745)
                                      .addChild((new autoclass.Shape())
                                        ...
                                        .setAppearance((new autoclass.Appearance())
                                          .setMaterial((new autoclass.Material()).setUSE("SPINAL_COLOR"))))))
                                  .addChild((new autoclass.HAnimJoint("hanim_vt4")).setName("vt4").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0061,1.4320,-0.0675)
                                    .addChild((new autoclass.HAnimSegment("hanim_t4")).setName("t4")
                                      .addChild((new autoclass.Transform()).setTranslation(0.0061,1.4320,-0.0675)
                                        .addChild((new autoclass.Shape())
                                          ...
                                          .setAppearance((new autoclass.Appearance())
                                            .setMaterial((new autoclass.Material()).setUSE("SPINAL_COLOR"))))))
                                    .addChild((new autoclass.HAnimJoint("hanim_vt3")).setName("vt3").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0062,1.4583,-0.0570)
                                                      ...
                                                      .addChild((new autoclass.HAnimSegment("hanim_l_carpal_distal_phalanx_1")).setName("l_carpal_distal_phalanx_1")
                                                        ...
                                                        .addChild((new autoclass.HAnimSite("hanim_l_carpal_distal_phalanx_1_tip")).setName("l_carpal_distal_phalanx_1_tip").setTranslation(0.1982,0.8061,0.0759)
                                                          .addChild((new autoclass.Shape())
                                                            ...
                                                            .setAppearance((new autoclass.Appearance())
                                                              .setMaterial((new autoclass.Material()).setUSE("HAND_FEET_COLOR")))))))))
                                                .addChild((new autoclass.HAnimJoint("hanim_l_carpometacarpal_2")).setName("l_carpometacarpal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1983,0.8024,-0.0280)
                                                  .addChild((new autoclass.HAnimSegment("hanim_l_metacarpal_2")).setName("l_metacarpal_2")
                                                    .addChild((new autoclass.Transform()).setTranslation(0.1983,0.8024,-0.0280)
                                                      .addChild((new autoclass.Shape())
                                                        ...
                                                        .setAppearance((new autoclass.Appearance())
                                                          .setMaterial((new autoclass.Material()).setUSE("JOINT_COLOR"))))))
                                                  .addChild((new autoclass.HAnimJoint("hanim_l_metacarpophalangeal_2")).setName("l_metacarpophalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1983,0.7815,-0.0280)
                                              ...
                                              .addChild((new autoclass.HAnimSegment("hanim_c6")).setName("c6")
                                                .addChild((new autoclass.Transform()).setTranslation(0.0066,1.5357,-0.0143)
                                                  .addChild((new autoclass.Shape())
                                                    ...
                                                    .setAppearance((new autoclass.Appearance())
                                                      .setMaterial((new autoclass.Material()).setUSE("SPINAL_COLOR"))))))
                                              .addChild((new autoclass.HAnimJoint("hanim_vc5")).setName("vc5").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0066,1.5520,-0.0082)
                                                  ...
                                                  .addChild((new autoclass.HAnimSegment("hanim_c4")).setName("c4")
                                                    .addChild((new autoclass.Transform()).setTranslation(0.0066,1.5662,-0.0084)
                                                      .addChild((new autoclass.Shape())
                                                        ...
                                                        .setAppearance((new autoclass.Appearance())
                                                          .setMaterial((new autoclass.Material()).setUSE("SPINAL_COLOR"))))))
                                                  .addChild((new autoclass.HAnimJoint("hanim_vc3")).setName("vc3").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0066,1.5800,-0.0103)
                                                          ...
                                                          .addChild((new autoclass.HAnimSegment("hanim_skull")).setName("skull")
                                                            ...
                                                            .addChild((new autoclass.HAnimSite("hanim_nuchale_pt")).setName("nuchale_pt").setTranslation(0.0039,1.5972,-0.0796)
                                                              .addChild((new autoclass.Shape())
                                                                ...
                                                                .setAppearance((new autoclass.Appearance())
                                                                  .setMaterial((new autoclass.Material()).setUSE("SITE_COLOR"))))))))))))))))))))))))))))))))
      .addViewpoints((new autoclass.HAnimSite("hanim_DiamondManLOA2_view")).setName("DiamondManLOA2_view")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new DiamondManLOA2();
		console.log ("DiamondManLOA2 execution self-validation test results: " + testObject.validateSelf());
	}
}

...
DiamondManLOA1.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.HAnimHumanoid("hanim_humanoid")).setName("humanoid").setLoa(1).setVersion("2.0")
      ...
      .addSkeleton((new autoclass.HAnimJoint("hanim_humanoid_root")).setName("humanoid_root").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,0.8240,0.0277)
        .addChild((new autoclass.HAnimJoint("hanim_sacroiliac")).setName("sacroiliac").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0,0.9149,0.0016)
          ...
          .addChild((new autoclass.HAnimJoint("hanim_l_hip")).setName("l_hip").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0961,0.9124,-0.0001)
            ...
            .addChild((new autoclass.HAnimJoint("hanim_l_knee")).setName("l_knee").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1040,0.4867,0.0308)
              ...
              .addChild((new autoclass.HAnimJoint("hanim_l_talocrural")).setName("l_talocrural").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1101,0.0656,-0.0736)
                ...
                .addChild((new autoclass.HAnimJoint("hanim_l_metatarsophalangeal_2")).setName("l_metatarsophalangeal_2").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1086,0.0001,0.0368)
                  .addChild((new autoclass.HAnimSegment("hanim_l_tarsal_proximal_phalanx_2")).setName("l_tarsal_proximal_phalanx_2")
                    ...
                    .addChild((new autoclass.HAnimSite("hanim_l_metatarsal_phalanx_5_pt")).setName("l_metatarsal_phalanx_5_pt").setTranslation(0.1825,0.0070,0.0928))
          ...
          .addChild((new autoclass.HAnimJoint("hanim_r_hip")).setName("r_hip").setCenter(-0.0950,0.9171,0.0029).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
            .addChild((new autoclass.HAnimSegment("hanim_r_thigh")).setName("r_thigh")
              ...
              .addChild((new autoclass.HAnimSite("hanim_r_femoral_lateral_epicondyle_pt")).setName("r_femoral_lateral_epicondyle_pt").setTranslation(-0.1421,0.4992,0.0310))
            ...
            .addChild((new autoclass.HAnimJoint("hanim_r_knee")).setName("r_knee").setCenter(-0.0867,0.4913,0.0318).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
              .addChild((new autoclass.HAnimSegment("hanim_r_calf")).setName("r_calf")
                .addChild((new autoclass.Transform()).setTranslation(-0.0867,0.4913,0.0318)
                  .addChild((new autoclass.Shape()).setUSE("DiamondShape"))))
              .addChild((new autoclass.HAnimJoint("hanim_r_talocrural")).setName("r_talocrural").setCenter(-0.0801,0.0712,-0.0766).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                ...
                .addChild((new autoclass.HAnimJoint("hanim_r_metatarsophalangeal_2")).setName("r_metatarsophalangeal_2").setCenter(-0.0801,0.0,0.0368).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
                  .addChild((new autoclass.HAnimSegment("hanim_r_tarsal_proximal_phalanx_2")).setName("r_tarsal_proximal_phalanx_2")
                    ...
                    .addChild((new autoclass.HAnimSite("hanim_r_metatarsal_phalanx_1_pt")).setName("r_metatarsal_phalanx_1_pt").setTranslation(-0.0521,0.0260,0.0127))
        ...
        .addChild((new autoclass.HAnimJoint("hanim_vl1")).setName("vl1").setCenter(-0.00405,1.07,-0.0275).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
          ...
          .addChild((new autoclass.HAnimJoint("hanim_l_shoulder")).setName("l_shoulder").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.2029,1.4376,-0.0387)
            .addChild((new autoclass.HAnimSegment("hanim_l_upperarm")).setName("l_upperarm")
              .addChild((new autoclass.Transform()).setTranslation(0.2029,1.4376,-0.0387)
                .addChild((new autoclass.Shape()).setUSE("DiamondShape")))
              .addChild((new autoclass.Transform("l_upperarm_adjust")).setCenter(0.182,1.22,-0.047).setTranslation(0.2029,1.4376,-0.0387).setRotation(1.0,0.0,0.0,0.119))
              .addChild((new autoclass.HAnimSite("hanim_l_humeral_lateral_epicondyle_pt")).setName("l_humeral_lateral_epicondyle_pt").setTranslation(0.2280,1.1482,-0.1100)))
            .addChild((new autoclass.HAnimJoint("hanim_l_elbow")).setName("l_elbow").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.2014,1.1357,-0.0682)
              .addChild((new autoclass.HAnimSegment("hanim_l_forearm")).setName("l_forearm")
                .addChild((new autoclass.Transform()).setTranslation(0.2014,1.1357,-0.0682)
                  .addChild((new autoclass.Shape()).setUSE("DiamondShape")))
                .addChild((new autoclass.Transform("l_forearm_adjust")).setRotation(-1.0,0.0,0.0,0.1).setCenter(0.198,0.961,-0.0405).setTranslation(0.2014,1.1357,-0.0682))
              ...
              .addChild((new autoclass.HAnimJoint("hanim_l_radiocarpal")).setName("l_radiocarpal").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.1984,0.8663,-0.0583)
                .addChild((new autoclass.HAnimSegment("hanim_l_carpal")).setName("l_carpal")
                  .addChild((new autoclass.Transform()).setTranslation(0.1984,0.8663,-0.0583)
                    .addChild((new autoclass.Shape()).setUSE("DiamondShape")))
                  .addChild((new autoclass.Transform("l_hand_adjust")).setRotation(-0.06361,-0.9967,0.04988,1.333).setTranslation(0.1984,0.8663,-0.0583).setCenter(0.213,0.811,-0.0338))
          ...
          .addChild((new autoclass.HAnimJoint("hanim_r_shoulder")).setName("r_shoulder").setCenter(-0.1907,1.4407,-0.0325).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
            .addChild((new autoclass.HAnimSegment("hanim_r_upperarm")).setName("r_upperarm")
              .addChild((new autoclass.Transform()).setTranslation(-0.1907,1.4407,-0.0325)
                .addChild((new autoclass.Shape()).setUSE("DiamondShape")))
              .addChild((new autoclass.Transform("r_upperarm_adjust")).setCenter(-0.182,1.22,-0.047).setTranslation(-0.1907,1.4407,-0.0325).setRotation(1.0,0.0,0.0,0.0836))
            ...
            .addChild((new autoclass.HAnimJoint("hanim_r_elbow")).setName("r_elbow").setCenter(-0.1949,1.1388,-0.0620).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
              .addChild((new autoclass.HAnimSegment("hanim_r_forearm")).setName("r_forearm")
                .addChild((new autoclass.Transform()).setTranslation(-0.1949,1.1388,-0.0620)
                  .addChild((new autoclass.Shape()).setUSE("DiamondShape")))
                .addChild((new autoclass.Transform("r_forearm_adjust")).setTranslation(-0.1949,1.1388,-0.0620).setCenter(-0.198,0.961,-0.0397).setRotation(-1.0,0.0,0.0,0.1254))
                ...
                .addChild((new autoclass.HAnimSite("hanim_r_humeral_medial_epicondyle_pt")).setName("r_humeral_medial_epicondyle_pt").setTranslation(-0.1680,1.1298,-0.1062))
                .addChild((new autoclass.HAnimSite("hanim_r_radiale_pt")).setName("r_radiale_pt").setTranslation(-0.2130,1.1305,-0.1091)))
              .addChild((new autoclass.HAnimJoint("hanim_r_radiocarpal")).setName("r_radiocarpal").setCenter(-0.1959,0.8694,-0.0521).setStiffness(java.newArray("float", [0.0,0.0,0.0]))
          ...
          .addChild((new autoclass.HAnimJoint("hanim_skullbase")).setName("skullbase").setStiffness(java.newArray("float", [0.0,0.0,0.0])).setCenter(0.0044,1.6209,0.0236)
            .addChild((new autoclass.HAnimSegment("hanim_skull")).setName("skull")
              .addChild((new autoclass.Transform()).setTranslation(0.0044,1.6209,0.0236)
                .addChild((new autoclass.Shape()).setUSE("DiamondShape")))
              .addChild((new autoclass.HAnimSite("hanim_skull_vertex_tip")).setName("skull_vertex_tip").setTranslation(0.0050,1.7504,0.0055))
      ...
      .addViewpoints((new autoclass.HAnimSite("hanim_DiamondManLOA1_view")).setName("DiamondManLOA1_view")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new DiamondManLOA1();
		console.log ("DiamondManLOA1 execution self-validation test results: " + testObject.validateSelf());
	}
}
new DiamondManLOA1().main();
process.exit(0);
...
NeedClassName.prototype = {
  ...
  initialize : function ()
  {
	...
	/** Large attribute array: WorldInfo info field, scene-graph level=3, element #28, 100 total values */
	this.WorldInfo_3_28_info = new autoclass.MFString(new autoclass.MFString("\"HAnim 2.0 Default Joint Centers, Level Of Articulation (LOA) 1 -------------------------------------------------------- HANIM 1.1 (VRML 2.0) Author name: eMpTy (a.k.a. Matthew T. Beitler) HANIM 1.1 (VRML 2.0) Author email: beitler@graphics.cis.upenn.edu or beitler@acm.org HANIM 1.1 (VRML 2.0) Author homepage: http://www.cis.upenn.edu/~beitler HANIM 1.1 (VRML 2.0) Compliance Date: May 12, 1999 HANIM 1.1 Compliance Information: http://ece.uwaterloo.ca/~HAnim/ Construction Info (joint centers): The joint centers of this figure are based on the work of Norman Badler, director of the Center for Human Modeling and Simulation at the University of Pennsylvania. The original document which these joint centers are based on can be found at: http://www.cis.upenn.edu/~badler/anthro/89-71.ps, .pdf\""));

	/** Large attribute array: MetadataSet reference field, scene-graph level=4, element #31, 1 total value */
	this.MetadataSet_HAnimHumanoid.info_4_31_reference = new autoclass.SFString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid");

	/** Large attribute array: MetadataString value field, scene-graph level=5, element #35, 51 total values */
	this.MetadataString_usageRestrictions_5_35_value = new autoclass.MFString(new autoclass.MFString("\"PERMISSION TO FULLY USE THIS SCENE GRAPH IS GRANTED PROVIDED THIS COPYRIGHT INFORMATION AND DOCUMENTATION OF THE ORIGINAL AUTHOR IS INCLUDED. This humanoid scene graph is provided _as-is_ and without warranty of any kind express implied or otherwise including without limitation any warranty of merchantability or fitness for a particular purpose.\""));
  ...
  .setScene((new autoclass.Scene())
    .addChild((new autoclass.WorldInfo()).setInfo(this.WorldInfo_3_28_info).setTitle("HANIM 1.1 Default Joint Centers, LOA1"))
    ...
    .addChild((new autoclass.HAnimHumanoid("hanim_humanoid")).setName("humanoid").setVersion("2.0")
      ...
      .addChild((new autoclass.MetadataSet()).setName("HAnimHumanoid.info").setReference(this.MetadataSet_HAnimHumanoid.info_4_31_reference)
        ...
        .setMetadata((new autoclass.MetadataString()).setName("humanoidVersion").setValue(new autoclass.MFString("\"JointCenters 1.1 LOA1\"")))
        .setMetadata((new autoclass.MetadataString()).setName("usageRestrictions").setValue(this.MetadataString_usageRestrictions_5_35_value)))

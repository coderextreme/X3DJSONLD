  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.HAnimHumanoid("hanim_humanoid")).setName("humanoid").setVersion("2.0")
      ...
      .addChild((new autoclass.MetadataSet()).setName("HAnimHumanoid.info").setReference(this.MetadataSet_HAnimHumanoid.info_4_29_reference)
        .setMetadata((new autoclass.MetadataString()).setName("authorEmail").setValue(new autoclass.MFString("\"beitler@graphics.cis.upenn.edu beitler@acm.org\"")))
        .setMetadata((new autoclass.MetadataString()).setName("authorName").setValue(new autoclass.MFString("\"Matthew T. Beitler\"")))
        .setMetadata((new autoclass.MetadataString()).setName("copyright").setValue(new autoclass.MFString("\"Copyright 1999 Matthew T. Beitler\"")))
        .setMetadata((new autoclass.MetadataString()).setName("creationDate").setValue(new autoclass.MFString("\"05/12/99\"")))
        .setMetadata((new autoclass.MetadataString()).setName("humanoidVersion").setValue(new autoclass.MFString("\"JointCenters 1.1 LOA0\"")))
        .setMetadata((new autoclass.MetadataString()).setName("usageRestrictions").setValue(this.MetadataString_usageRestrictions_5_34_value)))
      .addSkeleton((new autoclass.HAnimJoint("hanim_humanoid_root")).setName("humanoid_root").setCenter(0.0,0.8240,0.0277)

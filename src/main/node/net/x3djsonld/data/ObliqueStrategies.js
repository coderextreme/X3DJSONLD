...
NeedClassName.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Transform()).setTranslation(0.0,1.0,0.0).setScale(0.4,0.4,0.4)
      ...
      .addChild((new autoclass.Shape())
        .setGeometry((new autoclass.Text()).setString(new autoclass.MFString("\"Oblique Strategies\" \"\" \"(Over One Hundred Worthwhile Dilemmas)\" \"\" \"by Brian Eno and Peter Schmidt\""))
          .setFontStyle((new autoclass.FontStyle("MessageFont")).setJustify(new autoclass.MFString("\"MIDDLE\" \"MIDDLE\"")).setFamily(new autoclass.MFString("\"SANS\"")).setStyle("BOLD")))
    ...
    .addChild((new autoclass.Script("TextScript")).setUrl(new autoclass.MFString("\"ObliqueStrategiesScript.js\" \"https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategiesScript.js\""))
      ...
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("index").setType("SFInt32").setValue("0").setAppinfo("index for active strategy card, -1 means no selection"))
      .addField((new autoclass.field()).setAccessType("outputOnly").setName("string_changed").setType("MFString").setAppinfo("latest strategy card value"))
      .addField((new autoclass.field()).setAccessType("outputOnly").setName("textToSpeechUrl").setType("MFString").setAppinfo("\"url to invoke Google Translate\""))
      .addField((new autoclass.field()).setAccessType("outputOnly").setName("newCardTime").setType("SFTime").setAppinfo("activate Sound node"))
      .addField((new autoclass.field()).setAccessType("inputOnly").setName("selectPreviousCard").setType("SFBool"))
      .addField((new autoclass.field()).setAccessType("inputOnly").setName("selectNextCard").setType("SFBool"))
      .addField((new autoclass.field()).setAccessType("inputOnly").setName("selectRandomCard").setType("SFBool"))
      .addField((new autoclass.field()).setAccessType("initializeOnly").setName("traceEnabled").setType("SFBool").setValue("true").setAppinfo("controls console tracing")))
    .addChild((new autoclass.Transform("CardTransform")).setTranslation(0.0,-1.5,0.0).setScale(0.4,0.4,0.4)
      .addChild((new autoclass.Shape())
        .setGeometry((new autoclass.Text("CardText"))
          .setFontStyle((new autoclass.FontStyle()).setJustify(new autoclass.MFString("\"MIDDLE\" \"MIDDLE\"")).setFamily(new autoclass.MFString("\"SANS\"")).setStyle("BOLD")))
        .setAppearance((new autoclass.Appearance())
          .setMaterial((new autoclass.Material()).setDiffuseColor(1.0,1.0,1.0))))
    ...
    .addChild((new autoclass.Transform()).setTranslation(-3.2,2.5,0.0).setScale(0.4,0.4,0.4)
    ...
    .addChild((new autoclass.Transform()).setTranslation(-3.3,-0.5,0.0).setScale(0.4,0.4,0.4)

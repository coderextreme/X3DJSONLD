...
ObliqueStrategies.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Script("TextScript")).setUrl(new autoclass.MFString("\"ObliqueStrategiesScript.js\" \"https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategiesScript.js\""))
      ...
      .addField((new autoclass.field()).setName("string_changed").setType("MFString").setAccessType("outputOnly").setAppinfo("latest strategy card value"))
      .addField((new autoclass.field()).setName("textToSpeechUrl").setType("MFString").setAccessType("outputOnly").setAppinfo("\"url to invoke Google Translate\""))

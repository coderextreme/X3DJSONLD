...
NeedClassName.prototype = {
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.HAnimHumanoid("hanim_Hand_Left")).setName("Hand_Left").setVersion("2.0")
      ...
      .addSkeleton((new autoclass.HAnimJoint("hanim_humanoid_root")).setName("humanoid_root")
        ...
        .addChild((new autoclass.HAnimJoint("hanim_l_radiocarpal")).setName("l_radiocarpal").setDescription("connection joint of hand to leg above")
          .addChild((new autoclass.HAnimSegment("hanim_l_wrist")).setName("l_wrist").setDescription("test diagnostic to compare name with expected HAnimSegment name for parent HAnimJoint")

...
arc4.prototype = {
  ...
  .setScene(new autoclass.Scene()
    ...
    .addChild(new autoclass.Transform("DECLpoint_G1_node")
      ...
      .addChild(new autoclass.PositionInterpolator("DECLpoint_G1_PI1").setKeyValue(new autoclass.MFVec3f(java.to([0.0,0.0,0.0,0.0,5.0,0.0], java.type("float[]")))).setKey(java.to([0.0,1.0], java.type("float[]"))))
...
"		}" + "\n")
    ...
    .addChild(new autoclass.Transform("DECLpoint_G2_node")
      .addChild(new autoclass.Shape()
        ...
        .setAppearance(new autoclass.Appearance()
          .setMaterial(new autoclass.Material().setDiffuseColor(1.0,0.0,0.0))))
      .addChild(new autoclass.PositionInterpolator("DECLpoint_G2_PI1").setKeyValue(new autoclass.MFVec3f(java.to([0.0,0.0,0.0,0.0,5.0,0.0], java.type("float[]")))).setKey(java.to([0.0,1.0], java.type("float[]"))))
...
"        }" + "\n")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new autoclass.arc4();

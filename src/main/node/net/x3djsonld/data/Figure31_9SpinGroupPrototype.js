  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ProtoDeclare()).setName("SpinGroup")
      .setProtoInterface((new autoclass.ProtoInterface())
        ...
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("cycleInterval").setType("SFTime").setValue("1"))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("loop").setType("SFBool").setValue("false"))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("startTime").setType("SFTime").setValue("0"))
        .addField((new autoclass.field()).setAccessType("inputOutput").setName("stopTime").setType("SFTime").setValue("0")))
    ...
    .addChild((new autoclass.Viewpoint()).setDescription("Click on blue crossbar to activate second SpinGroup").setPosition(0.0,18.0,30.0).setOrientation(1.0,0.0,0.0,-0.52))
    .addComments(" Create an instance, meaning actual nodes that render ")
    .addChild((new autoclass.ProtoInstance()).setName("SpinGroup")
      ...
      .addFieldValue((new autoclass.fieldValue()).setName("children")
        ...
        .addChild((new autoclass.ProtoInstance("SecondSpinGroup", "SpinGroup")).setDEF("SecondSpinGroup").setName("SpinGroup")

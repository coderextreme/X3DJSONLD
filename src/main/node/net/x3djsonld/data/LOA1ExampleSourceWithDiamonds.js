...
LOA1ExampleSourceWithDiamonds.prototype = {
  ...
  initialize : function ()
  {
	...
	/** Large attribute array: fieldValue value field, scene-graph level=4, element #615, 62 total values */
	this.fieldValue_info_4_615_value = new autoclass.SFString("\"authorName=Matthew T. Beitler\" \"authorEmail=beitler@cis.upenn.edu or beitler@acm.org\" \"creationDate=05/12/99\" \"copyright=Copyright 1999-2003, Matthew T. Beitler\" \"humanoidVersion=JointCenters 200x, LOA&#8209;1\" \"usageRestrictions=
	...
	/** Large attribute array: WorldInfo info field, scene-graph level=4, element #617, 74 total values */
	this.WorldInfo_4_617_info = new autoclass.MFString(new autoclass.MFString("\"
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.ProtoInstance("humanoid_2", "Humanoid")).setDEF("humanoid_2").setName("Humanoid")
                            ...
                            .addChild((new autoclass.ProtoInstance("hanim_l_metatarsophalangeal__2", "Joint")).setDEF("hanim_l_metatarsophalangeal__2").setName("Joint")
                              ...
                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                .addChild((new autoclass.ProtoInstance("hanim_l_middistal_2", "Segment")).setDEF("hanim_l_middistal_2").setName("Segment")
                                  ...
                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                    .addChild((new autoclass.ProtoInstance("hanim_l_middistal_tip_2", "Site")).setDEF("hanim_l_middistal_tip_2").setName("Site")
                            ...
                            .addChild((new autoclass.ProtoInstance("hanim_r_metatarsophalangeal__2", "Joint")).setDEF("hanim_r_metatarsophalangeal__2").setName("Joint")
                              ...
                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                .addChild((new autoclass.ProtoInstance("hanim_r_middistal_2", "Segment")).setDEF("hanim_r_middistal_2").setName("Segment")
                                  ...
                                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                                    .addChild((new autoclass.ProtoInstance("hanim_r_middistal_tip_2", "Site")).setDEF("hanim_r_middistal_tip_2").setName("Site")
                        ...
                        .addChild((new autoclass.ProtoInstance("hanim_l_radiocarpal_2", "Joint")).setDEF("hanim_l_radiocarpal_2").setName("Joint")
                          ...
                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                            .addChild((new autoclass.ProtoInstance("hanim_l_hand_2", "Segment")).setDEF("hanim_l_hand_2").setName("Segment")
                              ...
                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                .addChild((new autoclass.ProtoInstance("hanim_l_hand_tip_2", "Site")).setDEF("hanim_l_hand_tip_2").setName("Site")
                        ...
                        .addChild((new autoclass.ProtoInstance("hanim_r_radiocarpal_2", "Joint")).setDEF("hanim_r_radiocarpal_2").setName("Joint")
                          ...
                          .addFieldValue((new autoclass.fieldValue()).setName("children")
                            .addChild((new autoclass.ProtoInstance("hanim_r_hand_2", "Segment")).setDEF("hanim_r_hand_2").setName("Segment")
                              ...
                              .addFieldValue((new autoclass.fieldValue()).setName("children")
                                .addChild((new autoclass.ProtoInstance("hanim_r_hand_tip_2", "Site")).setDEF("hanim_r_hand_tip_2").setName("Site")
      ...
      .addFieldValue((new autoclass.fieldValue()).setName("sites")
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_l_middistal_tip_2"))
        ...
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_r_middistal_tip_2"))
        ...
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_l_hand_tip_2"))
        ...
        .addSites((new autoclass.ProtoInstance()).setUSE("hanim_r_hand_tip_2"))
      ...
      .addFieldValue((new autoclass.fieldValue()).setName("info").setValue(this.fieldValue_info_4_615_value)))
    .addChild((new autoclass.Group("JointCenters_WorldInfo"))
      .addChild((new autoclass.WorldInfo()).setInfo(this.WorldInfo_4_617_info).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;1")))

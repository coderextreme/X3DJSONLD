...
AllAudioGraphNodesTest.prototype = {
  ...
  .setHead((new autoclass.head())
    ...
    .addMeta((new autoclass.meta()).setName("modified").setContent("17 December 2023"))
  ...
  .setScene((new autoclass.Scene())
    ...
    .addChild((new autoclass.Sound()).setLocation(0.0,1.6,0.0)
      .setSource((new autoclass.AudioClip()).setDescription("testing").setUrl(new autoclass.MFString("\"sound/saxophone.mp3\" \"https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/saxophone.mp3\""))))
    .addChild((new autoclass.Sound()).setLocation(0.0,1.6,0.0)
      .setSource((new autoclass.MovieTexture()).setDescription("testing").setUrl(new autoclass.MFString("\"bogus.mpg\" \"https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/bogus.mpg\""))))
    .addChild((new autoclass.SpatialSound())
      .addChild((new autoclass.Analyser())
        .addChild((new autoclass.StreamAudioDestination())
          .addChild((new autoclass.BiquadFilter()).setType("LOWPASS")

    ...
    .addChild((new autoclass.Transform())
      .addChild((new autoclass.ParticleSystem()).setGeometryType("GEOMETRY").setMaxParticles(20)
        ...
        .setAppearance((new autoclass.Appearance())
          ...
          .addShaders((new autoclass.ComposedShader("fw")).setLanguage("GLSL")
            ...
            .addParts((new autoclass.ShaderPart()).setUrl(new autoclass.MFString("\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"")))
            .addParts((new autoclass.ShaderPart()).setType("FRAGMENT").setUrl(new autoclass.MFString("\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\""))))))
...
"			}" + "\n")
      ...
      .addChild((new autoclass.ROUTE()).setFromNode("Animate").setFromField("a").setToNode("fw").setToField("a"))
      .addChild((new autoclass.ROUTE()).setFromNode("Animate").setFromField("b").setToNode("fw").setToField("b"))
      .addChild((new autoclass.ROUTE()).setFromNode("Animate").setFromField("c").setToNode("fw").setToField("c"))
      .addChild((new autoclass.ROUTE()).setFromNode("Animate").setFromField("d").setToNode("fw").setToField("d"))
      .addChild((new autoclass.ROUTE()).setFromNode("Animate").setFromField("pdelta").setToNode("fw").setToField("pdelta"))
      .addChild((new autoclass.ROUTE()).setFromNode("Animate").setFromField("tdelta").setToNode("fw").setToField("tdelta"))));
  },
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		console.log ("fwparticleflowers execution self-validation test results: " + testObject.validateSelf());
	}
}

...
"	}\n"+
"}"))))
        .addChild(new autoclass.NavigationInfo().setType(java.newArray("java.lang.String", [", ","PLANE_create3000.deANY"])))
...
ProtoInstance31
    ...
    X3D0.toFileX3D(".././Connectors.new.node.x3d");
    X3D0.toFileJSON(".././Connectors.new.node.json");
    process.exit(0);

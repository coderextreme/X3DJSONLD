          ...
          .addChild(new autoclass.ParticleSystem().setMaxParticles(20).setGeometryType("GEOMETRY")
            ...
            .setAppearance(new autoclass.Appearance()
              ...
              .addShaders(new autoclass.ComposedShader().setDEF("shader").setLanguage("GLSL")
                ...
                .addComments((new autoclass.CommentsBlock("<field name='cube' type='SFNode' accessType=\"initializeOnly\"> <ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture> </field>")))
                .addParts(new autoclass.ShaderPart().setType("VERTEX").setUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs"])))
                .addParts(new autoclass.ShaderPart().setType("FRAGMENT").setUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs"]))))))
...
"			}"))
    ...
    X3D0.toFileX3D(".././cgeparticleflowers.new.node.x3d");
    X3D0.toFileJSON(".././cgeparticleflowers.new.node.json");
    process.exit(0);

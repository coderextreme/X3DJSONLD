...
ConfigurationProperties.setStripDefaultAttributes(true);
        ...
        .addLayerSet(new autoclass.LayerSet().setActiveLayer(1).setOrder(java.newArray("int", [1,2]))
          ...
          .addLayers(new autoclass.Layer()
            ...
            .addChild(new autoclass.DISEntityManager().setDEF("EntityManager").setNetworkMode("networkReader")
              .addChild(new autoclass.DISEntityTypeMapping().setCategory(77).setSpecific(1).setUrl(java.newArray("java.lang.String", ["../data/Leif8Final.x3dv","https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3dv"])))
              .addChild(new autoclass.DISEntityTypeMapping().setCategory(77).setSpecific(2).setUrl(java.newArray("java.lang.String", ["../data/Lily8Final.x3dv","https://coderextreme.net/X3DJSONLD/src/main/data/Lily8Final.x3dv"])))
              .addChild(new autoclass.DISEntityTypeMapping().setCategory(77).setSpecific(3).setUrl(java.newArray("java.lang.String", ["../data/Tufani8Final.x3dv","https://coderextreme.net/X3DJSONLD/src/main/data/Tufani8Final.x3dv"])))
              .addChild(new autoclass.DISEntityTypeMapping().setCategory(77).setSpecific(4).setUrl(java.newArray("java.lang.String", ["../data/Gramps8Final.x3dv","https://coderextreme.net/X3DJSONLD/src/main/data/Gramps8Final.x3dv"]))))
    ...
    X3D0.toFileX3D("../personal/bumpyfreewrlsliders.new.node.x3d");
    X3D0.toFileJSON("../personal/bumpyfreewrlsliders.new.node.json");
    process.exit(0);

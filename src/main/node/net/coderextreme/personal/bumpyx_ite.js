...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/bumpyx_ite.x3d")))
    ...
    X3D0.toFileX3D("../personal/bumpyx_ite.new.node.x3d");
    X3D0.toFileJSON("../personal/bumpyx_ite.new.node.json");
    process.exit(0);

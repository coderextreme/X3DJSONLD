...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/bumpyfreewrl.x3d")))
      .setScene(new autoclass.Scene()
        .addChild(new autoclass.WorldInfo().setTitle("bumpyfreewrl.x3d"))
    ...
    X3D0.toFileX3D("../personal/bumpyfreewrl.new.node.x3d");
    X3D0.toFileJSON("../personal/bumpyfreewrl.new.node.json");
    process.exit(0);

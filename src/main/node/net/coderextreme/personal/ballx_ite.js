...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/ballx_ite.x3d"))
        .addMeta(new autoclass.meta().setName("description").setContent("a prismatic sphere")))
      .setScene(new autoclass.Scene()
        .addChild(new autoclass.WorldInfo().setTitle("ballx_ite.x3d"))
    ...
    X3D0.toFileX3D("../personal/ballx_ite.new.node.x3d");
    X3D0.toFileJSON("../personal/ballx_ite.new.node.json");
    process.exit(0);

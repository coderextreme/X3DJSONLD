...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("title").setContent("variationalflowers2.x3d"))
        .addMeta(new autoclass.meta().setName("creator").setContent("John Carlson"))
        .addMeta(new autoclass.meta().setName("description").setContent("A flower variational system"))
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/variationalflowers2.x3d")))
      .setScene(new autoclass.Scene()
        .addChild(new autoclass.WorldInfo().setTitle("variationalflowers2.x3d"))
...
"			}"))
    ...
    X3D0.toFileX3D("../personal/variationalflowers2.new.node.x3d");
    X3D0.toFileJSON("../personal/variationalflowers2.new.node.json");
    process.exit(0);

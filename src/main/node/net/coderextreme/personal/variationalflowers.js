...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/variationalflowers.x3d")))
...
"			}"))
    ...
    X3D0.toFileX3D("../personal/variationalflowers.new.node.x3d");
    X3D0.toFileJSON("../personal/variationalflowers.new.node.json");
    process.exit(0);

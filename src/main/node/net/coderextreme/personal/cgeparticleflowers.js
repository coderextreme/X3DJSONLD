...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/particleflowers.x3d")))
...
"			}"))
    ...
    X3D0.toFileX3D("../personal/cgeparticleflowers.new.node.x3d");
    X3D0.toFileJSON("../personal/cgeparticleflowers.new.node.json");
    process.exit(0);

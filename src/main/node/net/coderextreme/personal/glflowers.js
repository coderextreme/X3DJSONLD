...
var ProtoInstance6 = null;
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/glflowers.x3d")))
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.Group()
          .addChild(new autoclass.ExternProtoDeclare().setName("FlowerProto").setUrl(java.newArray("java.lang.String", ["../personal/flowerproto.x3d#FlowerProto"]))
...
ProtoInstance0
    ...
    X3D0.toFileX3D("../personal/glflowers.new.node.x3d");
    X3D0.toFileJSON("../personal/glflowers.new.node.json");
    process.exit(0);

...
var ProtoInstance6 = null;
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/x3domflowers.x3d")))
...
ProtoInstance0
    ...
    X3D0.toFileX3D("../personal/x3domflowers.new.x3d");
    process.exit(0);

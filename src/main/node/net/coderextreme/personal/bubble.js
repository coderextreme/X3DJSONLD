...
var ProtoInstance0 = null;
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/bubble.x3d")))
...
"}"))
    ...
    X3D0.toFileJSON("../personal/bubble.new.node.json");
    process.exit(0);

...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/ballx3dom.x3d"))
        .addMeta(new autoclass.meta().setName("description").setContent("a prismatic sphere")))
      .setScene(new autoclass.Scene()
        .addChild(new autoclass.WorldInfo().setTitle("ballx3dom.x3d"))
    ...
    X3D0.toFileX3D("../personal/ballx3dom.new.node.x3d");
    X3D0.toFileJSON("../personal/ballx3dom.new.node.json");
    process.exit(0);

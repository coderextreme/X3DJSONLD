...
var ProtoInstance2 = null;
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/bub.x3d")))
...
"			}"))
    ...
    X3D0.toFileX3D("../personal/bub.new.node.x3d");
    X3D0.toFileJSON("../personal/bub.new.node.json");
    process.exit(0);

...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/flowers7.x3d"))
...
"}"))
    ...
    X3D0.toFileJSON("../personal/flowers7.new.node.json");
    process.exit(0);

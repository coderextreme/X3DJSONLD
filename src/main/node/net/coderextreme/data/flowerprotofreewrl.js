      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.ProtoDeclare().setName("FlowerProto")
          .setProtoInterface(new autoclass.ProtoInterface()
            .addField(new autoclass.field().setType(autoclass.field.TYPE_MFSTRING).setName("vertex").setAccessType(autoclass.field.ACCESSTYPE_INPUTONLY).setValue("\"../shaders/freewrl_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs\""))
            .addField(new autoclass.field().setType(autoclass.field.TYPE_MFSTRING).setName("fragment").setAccessType(autoclass.field.ACCESSTYPE_INPUTONLY).setValue("\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"")))
          .setProtoBody(new autoclass.ProtoBody()
            .addChild(new autoclass.Transform().setDEF("transform")
              ...
              .addChild(new autoclass.Script().setDEF("Animate").setDirectOutput(true)
                ...
                .addField(new autoclass.field().setType(autoclass.field.TYPE_SFFLOAT).setName("set_fraction").setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT))
...
ProtoInstance0
          .addFieldValue(new autoclass.fieldValue().setName("vertex").setValue("\"../shaders/freewrl_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs\""));
ProtoInstance0
          .addFieldValue(new autoclass.fieldValue().setName("fragment").setValue("\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\""));
    X3D0.toFileX3D("../data/flowerprotofreewrl.new.node.x3d");
    X3D0.toFileJSON("../data/flowerprotofreewrl.new.node.x3dj");
    process.exit(0);

          ...
          .setProtoBody((new autoclass.ProtoBody())
            .addChild((new autoclass.Group())
              ...
              .addChild((new autoclass.Transform()).setScale(java.newArray("float", [java.newFloat(0.5), java.newFloat(0.5), java.newFloat(0.5)]))
                ...
                .addChild((new autoclass.StringSensor()).setDEF("RightSensor").setEnabled(false).setDeletionAllowed(true))
              ...
              .addChild((new autoclass.Transform()).setScale(java.newArray("float", [java.newFloat(0.5), java.newFloat(0.5), java.newFloat(0.5)]))
                ...
                .addChild((new autoclass.StringSensor()).setDEF("UpSensor").setEnabled(false).setDeletionAllowed(true))
              ...
              .addChild((new autoclass.Transform())
                ...
                .addChild((new autoclass.StringSensor()).setDEF("CenterSensor").setEnabled(false).setDeletionAllowed(true))

...
ConfigurationProperties.setStripTrailingZeroesSync(true);
      ...
      .setHeadSync(new autoclass.head()
        .addMetaSync(new autoclass.meta().setNameSync("title").setContentSync("indexedfaceset_pixeltexture_whole.x3d"))
        .addMetaSync(new autoclass.meta().setNameSync("warning").setContentSync("file did not transform to vrml97"))
        .addMetaSync(new autoclass.meta().setNameSync("Image").setContentSync("indexedfaceset_pixeltexture_whole-front.jpg"))
        .addMetaSync(new autoclass.meta().setNameSync("Image").setContentSync("indexedfaceset_pixeltexture_whole-rear.jpg"))
        .addMetaSync(new autoclass.meta().setNameSync("Image").setContentSync("indexedfaceset_pixeltexture_whole-top.jpg"))
        .addMetaSync(new autoclass.meta().setNameSync("Image").setContentSync("indexedfaceset_pixeltexture_whole-bottom.jpg"))
        .addMetaSync(new autoclass.meta().setNameSync("Image").setContentSync("indexedfaceset_pixeltexture_whole-left.jpg"))
        .addMetaSync(new autoclass.meta().setNameSync("Image").setContentSync("indexedfaceset_pixeltexture_whole-right.jpg"))
        ...
        .addMetaSync(new autoclass.meta().setNameSync("description").setContentSync("Test of browser ability to map the entire portion of an PixelTexture onto an IndexedFaceSet geometry. Four equal sized red (bottom left), green (bottom right) yellow (top left) and white (top right) squares in the pixel texture map all the faces of the cube."))
        .addMetaSync(new autoclass.meta().setNameSync("identifier").setContentSync("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_whole.x3d"))
      ...
      .setSceneSync(new autoclass.Scene()
        ...
        .addChildSync(new autoclass.Shape()
          ...
          .setGeometrySync(new autoclass.IndexedFaceSet().setColorPerVertexSync(false).setCoordIndexSync(java.newArray("int", [0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1])).setCreaseAngleSync(java.newFloat(0.5)).setTexCoordIndexSync(java.newArray("int", [0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1]))
            ...
            .setTexCoordSync(new autoclass.TextureCoordinate().setPointSync(java.newArray("float", [java.newFloat(0), java.newFloat(1), java.newFloat(0), java.newFloat(0), java.newFloat(1), java.newFloat(1), java.newFloat(1), java.newFloat(0)]))))))      ;

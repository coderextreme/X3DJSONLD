...
var ProtoInstance9 = null;
      ...
      .setHeadSync(new autoclass.head()
        .addMetaSync(new autoclass.meta().setNameSync("title").setContentSync("rubikOnFire.x3d"))
        ...
        .addMetaSync(new autoclass.meta().setNameSync("identifier").setContentSync("https://coderextreme.net/X3DJSONLD/rubikOnFire.x3d"))
        .addMetaSync(new autoclass.meta().setNameSync("description").setContentSync("a white rubik cube")))
      .setSceneSync(new autoclass.Scene()
        ...
        .addChildSync(new autoclass.ProtoDeclare().setNameSync("anyShape")
          .setProtoInterfaceSync(new autoclass.ProtoInterface()
            ...
            .addFieldSync(new autoclass.field().setTypeSync(autoclass.field.TYPE_SFNODE).setNameSync("myShape").setAccessTypeSync(autoclass.field.ACCESSTYPE_INPUTOUTPUT)
              .addChildSync(new autoclass.Sphere())))
          .setProtoBodySync(new autoclass.ProtoBody()
            .addChildSync(new autoclass.Transform()
              ...
              .addChildSync(new autoclass.Shape()
                .setISSync(new autoclass.IS()
                  .addConnectSync(new autoclass.connect().setNodeFieldSync("geometry").setProtoFieldSync("myShape")))
...
ProtoInstance9
          .addFieldValueSync(new autoclass.fieldValue().setNameSync("myShape")
            .addChildSync(new autoclass.Box().setSizeSync(java.newArray("float", [java.newFloat(1), java.newFloat(1), java.newFloat(1)]))));

      ...
      .setScene((new autoclass.Scene())
        .addChild((new autoclass.ProtoDeclare()).setName("anyShape")
          .setProtoInterface((new autoclass.ProtoInterface())
            ...
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("myShape")
        ...
        .addChild((new autoclass.ProtoDeclare()).setName("three")
          .setProtoInterface((new autoclass.ProtoInterface())
            ...
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("myShape")
              .addChild((new autoclass.Sphere()).setDEF("_1"))))
          .setProtoBody((new autoclass.ProtoBody())
            .addChild((new autoclass.Transform())
        ...
        .addChild((new autoclass.ProtoDeclare()).setName("nine")
          .setProtoInterface((new autoclass.ProtoInterface())
            ...
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("myShape")
              .addChild((new autoclass.Sphere()).setDEF("_2"))))
          .setProtoBody((new autoclass.ProtoBody())
            .addChild((new autoclass.Transform())
        ...
        .addChild((new autoclass.ProtoDeclare()).setName("twentyseven")
          .setProtoInterface((new autoclass.ProtoInterface())
            ...
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("myShape")
              .addChild((new autoclass.Sphere()).setDEF("_3"))))
          .setProtoBody((new autoclass.ProtoBody())
            .addChild((new autoclass.Transform())

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        .addChild((new autoclass.ProtoDeclare()).setName("LOA1_RunAnimation")
          .setProtoInterface((new autoclass.ProtoInterface())
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFTIME).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("cycleInterval").setValue("1"))
    ...
    X3D0.toFileX3D("../data/LOA1_RunAnimation.new.node.x3d");
    process.exit(0);

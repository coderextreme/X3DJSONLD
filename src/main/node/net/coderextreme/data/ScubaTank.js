          ...
          .addChild((new autoclass.Transform())
            .addChild((new autoclass.Shape())
              .setAppearance((new autoclass.Appearance())
                .setMaterial((new autoclass.Material()).setDEF("tank").setAmbientIntensity(java.newFloat(0.3)).setDiffuseColor(java.newArray("float", [java.newFloat(0.3), java.newFloat(0.3), java.newFloat(0.5)])).setSpecularColor(java.newArray("float", [java.newFloat(0.7), java.newFloat(0.7), java.newFloat(0.8)])).setShininess(java.newFloat(0.1))))
            ...
            .addChild((new autoclass.Transform())
              .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(0.45), java.newFloat(0)]))
                .addChild((new autoclass.Shape()).setDEF("pressure")
                  .setAppearance((new autoclass.Appearance())
                    .setMaterial((new autoclass.Material()).setDEF("pressureColor").setAmbientIntensity(java.newFloat(0.4)).setDiffuseColor(java.newArray("float", [java.newFloat(0.91), java.newFloat(0.91), java.newFloat(0.91)])).setSpecularColor(java.newArray("float", [java.newFloat(0.91), java.newFloat(0.9), java.newFloat(0.91)])).setShininess(java.newFloat(0.16))))
              ...
              .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(-0.028), java.newFloat(0.462), java.newFloat(0)])).setRotation(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(1), java.newFloat(1.57)]))
                .addChild((new autoclass.Transform())

...
var ProtoInstance2 = null;
      ...
      .setHead((new autoclass.head())
        .addMeta((new autoclass.meta()).setContent("qq3.x3d").setName("title"))
        .addMeta((new autoclass.meta()).setContent("John Carlson").setName("creator"))
        .addMeta((new autoclass.meta()).setContent("John Carlson").setName("translator"))
        .addMeta((new autoclass.meta()).setContent("11 Jan 2015").setName("created"))
        .addMeta((new autoclass.meta()).setContent("05 May 2017").setName("modified"))
        .addMeta((new autoclass.meta()).setContent("12 extrusions to test prototype expander").setName("description"))
        .addMeta((new autoclass.meta()).setContent("https://coderextreme.net/x3d/qq3.x3d").setName("identifier"))
        .addMeta((new autoclass.meta()).setContent("manual").setName("generator")))

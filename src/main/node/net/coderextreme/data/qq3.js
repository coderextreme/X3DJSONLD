...
var ProtoInstance2 = null;
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Viewpoint()).setDescription("Process pipes").setPosition(java.newArray("float", [java.newFloat(0), java.newFloat(5), java.newFloat(12)])).setOrientation(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0), java.newFloat(-0.4)])))

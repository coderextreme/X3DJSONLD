...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.Group()
          ...
          .addChild(new autoclass.Transform()
            .addComments((new autoclass.CommentsBlock("<Transform translation='0 2 0'> <Shape DEF='HAnimRootShape'> <Sphere radius='0.02' /> <Appearance> <Material DEF='HAnimRootMaterial' diffuseColor='0.8 0 0' transparency='0.3'/> </Appearance> </Shape> </Transform>")))

...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("reference").setContent("https://www.ballreich.net/vrml/HAnim/nancy_HAnim.wrl"))
        .addMeta(new autoclass.meta().setName("reference").setContent("https://www.HAnim.org/Models/HAnim2001/boxman/protos/LOA1_WalkAnimation.wrl"))
        .addMeta(new autoclass.meta().setName("reference").setContent("https://www.HAnim.org"))
        .addMeta(new autoclass.meta().setName("reference").setContent("https://HAnim.org/Models"))
        .addMeta(new autoclass.meta().setName("reference").setContent("https://HAnim.org/Nodes"))
    ...
    X3D0.toFileJSON("../data/LOA1_KneelAnimation.new.node.x3dj");
    process.exit(0);

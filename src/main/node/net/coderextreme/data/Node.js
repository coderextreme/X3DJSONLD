...
var ProtoInstance3 = null;
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("modified").setContent("28 June 2018"))
        ...
        .addMeta((new autoclass.meta()).setName("translated").setContent("19 April 2020"))
...
ProtoInstance1
    ...
    X3D0.toFileX3D("../data/Node.new.x3d");

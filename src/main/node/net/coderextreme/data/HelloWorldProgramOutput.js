...
var ProtoInstance6 = null;
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("modified").setContent("19 June 2019"))
...
"}"))))
        ...
        .addChild(new autoclass.Shape()
          .setAppearance(new autoclass.Appearance()
            ...
            .setMaterial(ProtoInstance6 = new autoclass.ProtoInstance().setName("ShaderProto").setDEF("TestShader3"))
        ...
        .addChild(new autoclass.Transform().setDEF("SpecialtyNodes")
          ...
          .addChild(new autoclass.HAnimHumanoid().setName("TestHumanoid").setDEF("TestHumanoidDEF").setVersion("2.0"))))      ;
ProtoInstance0

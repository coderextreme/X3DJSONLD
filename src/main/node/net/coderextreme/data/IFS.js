...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/IFS.x3d"))
    ...
    X3D0.toFileJSON("../data/IFS.new.node.x3dj");
    process.exit(0);

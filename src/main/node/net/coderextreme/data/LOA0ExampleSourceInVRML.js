...
ProtoInstance0
          .addFieldValue((new autoclass.fieldValue()).setName("joints")
            .addChild(ProtoInstance80 = (new autoclass.ProtoInstance()).setUSE("hanim_humanoid_root_2")));
ProtoInstance0
          .addFieldValue((new autoclass.fieldValue()).setName("segments")
            .addChild(ProtoInstance81 = (new autoclass.ProtoInstance()).setUSE("hanim_sacrum_2")));
ProtoInstance0
          .addFieldValue((new autoclass.fieldValue()).setName("sites")
            .addChild(ProtoInstance82 = (new autoclass.ProtoInstance()).setUSE("hanim_skull_tip_2"))
            .addChild(ProtoInstance83 = (new autoclass.ProtoInstance()).setUSE("hanim_sellion_2"))
            .addChild(ProtoInstance84 = (new autoclass.ProtoInstance()).setUSE("hanim_r_infraorbitale_2"))
            .addChild(ProtoInstance85 = (new autoclass.ProtoInstance()).setUSE("hanim_l_infraorbitale_2"))
            .addChild(ProtoInstance86 = (new autoclass.ProtoInstance()).setUSE("hanim_supramenton_2"))
            .addChild(ProtoInstance87 = (new autoclass.ProtoInstance()).setUSE("hanim_r_tragion_2"))
            .addChild(ProtoInstance88 = (new autoclass.ProtoInstance()).setUSE("hanim_r_gonion_2"))
            .addChild(ProtoInstance89 = (new autoclass.ProtoInstance()).setUSE("hanim_l_tragion_2"))
            .addChild(ProtoInstance90 = (new autoclass.ProtoInstance()).setUSE("hanim_l_gonion_2"))
            .addChild(ProtoInstance91 = (new autoclass.ProtoInstance()).setUSE("hanim_nuchale_2"))
            .addChild(ProtoInstance92 = (new autoclass.ProtoInstance()).setUSE("hanim_r_clavicale_2"))
            .addChild(ProtoInstance93 = (new autoclass.ProtoInstance()).setUSE("hanim_suprasternale_2"))
            .addChild(ProtoInstance94 = (new autoclass.ProtoInstance()).setUSE("hanim_l_clavicale_2"))
            .addChild(ProtoInstance95 = (new autoclass.ProtoInstance()).setUSE("hanim_r_thelion_2"))
            .addChild(ProtoInstance96 = (new autoclass.ProtoInstance()).setUSE("hanim_l_thelion_2"))
            .addChild(ProtoInstance97 = (new autoclass.ProtoInstance()).setUSE("hanim_substernale_2"))
            .addChild(ProtoInstance98 = (new autoclass.ProtoInstance()).setUSE("hanim_r_rib10_2"))
            .addChild(ProtoInstance99 = (new autoclass.ProtoInstance()).setUSE("hanim_r_asis_2"))
            .addChild(ProtoInstance100 = (new autoclass.ProtoInstance()).setUSE("hanim_l_rib10_2"))
            .addChild(ProtoInstance101 = (new autoclass.ProtoInstance()).setUSE("hanim_l_asis_2"))
            .addChild(ProtoInstance102 = (new autoclass.ProtoInstance()).setUSE("hanim_r_iliocristale_2"))
            .addChild(ProtoInstance103 = (new autoclass.ProtoInstance()).setUSE("hanim_r_trochanterion_2"))
            .addChild(ProtoInstance104 = (new autoclass.ProtoInstance()).setUSE("hanim_l_iliocristale_2"))
            .addChild(ProtoInstance105 = (new autoclass.ProtoInstance()).setUSE("hanim_l_trochanterion_2"))
            .addChild(ProtoInstance106 = (new autoclass.ProtoInstance()).setUSE("hanim_cervicale_2"))
            .addChild(ProtoInstance107 = (new autoclass.ProtoInstance()).setUSE("hanim_spine_2_lower_back_2"))
            .addChild(ProtoInstance108 = (new autoclass.ProtoInstance()).setUSE("hanim_r_psis_2"))
            .addChild(ProtoInstance109 = (new autoclass.ProtoInstance()).setUSE("hanim_l_psis_2"))
            .addChild(ProtoInstance110 = (new autoclass.ProtoInstance()).setUSE("hanim_waist_preferred_posterior_2"))
            .addChild(ProtoInstance111 = (new autoclass.ProtoInstance()).setUSE("hanim_r_acromion_2"))
            .addChild(ProtoInstance112 = (new autoclass.ProtoInstance()).setUSE("hanim_r_axilla_proximal_2"))
            .addChild(ProtoInstance113 = (new autoclass.ProtoInstance()).setUSE("hanim_r_radial_styloid_2"))
            .addChild(ProtoInstance114 = (new autoclass.ProtoInstance()).setUSE("hanim_r_axilla_distal_2"))
            .addChild(ProtoInstance115 = (new autoclass.ProtoInstance()).setUSE("hanim_r_olecranon_2"))
            .addChild(ProtoInstance116 = (new autoclass.ProtoInstance()).setUSE("hanim_r_humeral_lateral_epicondyles_2"))
            .addChild(ProtoInstance117 = (new autoclass.ProtoInstance()).setUSE("hanim_r_humeral_medial_epicondyles_2"))
            .addChild(ProtoInstance118 = (new autoclass.ProtoInstance()).setUSE("hanim_r_radiale_2"))
            .addChild(ProtoInstance119 = (new autoclass.ProtoInstance()).setUSE("hanim_r_metacarpal_phalanx3"))
            .addChild(ProtoInstance120 = (new autoclass.ProtoInstance()).setUSE("hanim_r_dactylion_2"))
            .addChild(ProtoInstance121 = (new autoclass.ProtoInstance()).setUSE("hanim_r_ulnar_styloid_2"))
            .addChild(ProtoInstance122 = (new autoclass.ProtoInstance()).setUSE("hanim_r_metacarpal_phalanx6"))
            .addChild(ProtoInstance123 = (new autoclass.ProtoInstance()).setUSE("hanim_l_acromion_2"))
            .addChild(ProtoInstance124 = (new autoclass.ProtoInstance()).setUSE("hanim_l_axilla_proximal_2"))
            .addChild(ProtoInstance125 = (new autoclass.ProtoInstance()).setUSE("hanim_l_radial_styloid_2"))
            .addChild(ProtoInstance126 = (new autoclass.ProtoInstance()).setUSE("hanim_l_axilla_distal_2"))
            .addChild(ProtoInstance127 = (new autoclass.ProtoInstance()).setUSE("hanim_l_olecranon_2"))
            .addChild(ProtoInstance128 = (new autoclass.ProtoInstance()).setUSE("hanim_l_humeral_lateral_epicondyles_2"))
            .addChild(ProtoInstance129 = (new autoclass.ProtoInstance()).setUSE("hanim_l_humeral_medial_epicondyles_2"))
            .addChild(ProtoInstance130 = (new autoclass.ProtoInstance()).setUSE("hanim_l_radiale_2"))
            .addChild(ProtoInstance131 = (new autoclass.ProtoInstance()).setUSE("hanim_l_metacarpal_phalanx3"))
            .addChild(ProtoInstance132 = (new autoclass.ProtoInstance()).setUSE("hanim_l_dactylion_2"))
            .addChild(ProtoInstance133 = (new autoclass.ProtoInstance()).setUSE("hanim_l_ulnar_styloid_2"))
            .addChild(ProtoInstance134 = (new autoclass.ProtoInstance()).setUSE("hanim_l_metacarpal_phalanx6"))
            .addChild(ProtoInstance135 = (new autoclass.ProtoInstance()).setUSE("hanim_r_knee_crease_2"))
            .addChild(ProtoInstance136 = (new autoclass.ProtoInstance()).setUSE("hanim_r_femoral_lateral_epicondyles_2"))
            .addChild(ProtoInstance137 = (new autoclass.ProtoInstance()).setUSE("hanim_r_femoral_medial_epicondyles_2"))
            .addChild(ProtoInstance138 = (new autoclass.ProtoInstance()).setUSE("hanim_r_tarsal_interphalangeal_phalanx6"))
            .addChild(ProtoInstance139 = (new autoclass.ProtoInstance()).setUSE("hanim_r_lateral_malleolus_2"))
            .addChild(ProtoInstance140 = (new autoclass.ProtoInstance()).setUSE("hanim_r_medial_malleolus_2"))
            .addChild(ProtoInstance141 = (new autoclass.ProtoInstance()).setUSE("hanim_r_sphyrion_2"))
            .addChild(ProtoInstance142 = (new autoclass.ProtoInstance()).setUSE("hanim_r_tarsal_interphalangeal_phalanx2"))
            .addChild(ProtoInstance143 = (new autoclass.ProtoInstance()).setUSE("hanim_r_calcaneus_posterior_2"))
            .addChild(ProtoInstance144 = (new autoclass.ProtoInstance()).setUSE("hanim_r_tarsal_distal_phalanx3"))
            .addChild(ProtoInstance145 = (new autoclass.ProtoInstance()).setUSE("hanim_l_knee_crease_2"))
            .addChild(ProtoInstance146 = (new autoclass.ProtoInstance()).setUSE("hanim_l_femoral_lateral_epicondyles_2"))
            .addChild(ProtoInstance147 = (new autoclass.ProtoInstance()).setUSE("hanim_l_femoral_medial_epicondyles_2"))
            .addChild(ProtoInstance148 = (new autoclass.ProtoInstance()).setUSE("hanim_l_tarsal_interphalangeal_phalanx6"))
            .addChild(ProtoInstance149 = (new autoclass.ProtoInstance()).setUSE("hanim_l_lateral_malleolus_2"))
            .addChild(ProtoInstance150 = (new autoclass.ProtoInstance()).setUSE("hanim_l_medial_malleolus_2"))
            .addChild(ProtoInstance151 = (new autoclass.ProtoInstance()).setUSE("hanim_l_sphyrion_2"))
            .addChild(ProtoInstance152 = (new autoclass.ProtoInstance()).setUSE("hanim_l_tarsal_interphalangeal_phalanx2"))
            .addChild(ProtoInstance153 = (new autoclass.ProtoInstance()).setUSE("hanim_l_calcaneus_posterior_2"))
            .addChild(ProtoInstance154 = (new autoclass.ProtoInstance()).setUSE("hanim_l_tarsal_distal_phalanx3"))
            .addChild(ProtoInstance155 = (new autoclass.ProtoInstance()).setUSE("hanim_crotch_2"))
            .addChild(ProtoInstance156 = (new autoclass.ProtoInstance()).setUSE("hanim_r_neck_base_2"))
            .addChild(ProtoInstance157 = (new autoclass.ProtoInstance()).setUSE("hanim_l_neck_base_2"))
            .addChild(ProtoInstance158 = (new autoclass.ProtoInstance()).setUSE("hanim_navel_2")));
ProtoInstance0
...
ProtoInstance1
              .addFieldValue((new autoclass.fieldValue()).setName("children")
                .addChild(ProtoInstance2 = (new autoclass.ProtoInstance()).setName("Segment").setDEF("hanim_sacrum_2")));
ProtoInstance2
                  .addFieldValue((new autoclass.fieldValue()).setName("name").setValue("sacrum"));
ProtoInstance2
                  .addFieldValue((new autoclass.fieldValue()).setName("children")
                    .addChild(ProtoInstance3 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_skull_tip_2"))
                    .addChild(ProtoInstance4 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_sellion_2"))
                    .addChild(ProtoInstance5 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_infraorbitale_2"))
                    .addChild(ProtoInstance6 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_infraorbitale_2"))
                    .addChild(ProtoInstance7 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_supramenton_2"))
                    .addChild(ProtoInstance8 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_tragion_2"))
                    .addChild(ProtoInstance9 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_gonion_2"))
                    .addChild(ProtoInstance10 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_tragion_2"))
                    .addChild(ProtoInstance11 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_gonion_2"))
                    .addChild(ProtoInstance12 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_nuchale_2"))
                    .addChild(ProtoInstance13 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_clavicale_2"))
                    .addChild(ProtoInstance14 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_suprasternale_2"))
                    .addChild(ProtoInstance15 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_clavicale_2"))
                    .addChild(ProtoInstance16 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_thelion_2"))
                    .addChild(ProtoInstance17 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_thelion_2"))
                    .addChild(ProtoInstance18 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_substernale_2"))
                    .addChild(ProtoInstance19 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_rib10_2"))
                    .addChild(ProtoInstance20 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_asis_2"))
                    .addChild(ProtoInstance21 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_rib10_2"))
                    .addChild(ProtoInstance22 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_asis_2"))
                    .addChild(ProtoInstance23 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_iliocristale_2"))
                    .addChild(ProtoInstance24 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_trochanterion_2"))
                    .addChild(ProtoInstance25 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_iliocristale_2"))
                    .addChild(ProtoInstance26 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_trochanterion_2"))
                    .addChild(ProtoInstance27 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_cervicale_2"))
                    .addChild(ProtoInstance28 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_spine_2_lower_back_2"))
                    .addChild(ProtoInstance29 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_psis_2"))
                    .addChild(ProtoInstance30 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_psis_2"))
                    .addChild(ProtoInstance31 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_waist_preferred_posterior_2"))
                    .addChild(ProtoInstance32 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_acromion_2"))
                    .addChild(ProtoInstance33 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_axilla_proximal_2"))
                    .addChild(ProtoInstance34 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_radial_styloid_2"))
                    .addChild(ProtoInstance35 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_axilla_distal_2"))
                    .addChild(ProtoInstance36 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_olecranon_2"))
                    .addChild(ProtoInstance37 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_humeral_lateral_epicondyles_2"))
                    .addChild(ProtoInstance38 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_humeral_medial_epicondyles_2"))
                    .addChild(ProtoInstance39 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_radiale_2"))
                    .addChild(ProtoInstance40 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_metacarpal_phalanx3"))
                    .addChild(ProtoInstance41 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_dactylion_2"))
                    .addChild(ProtoInstance42 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_ulnar_styloid_2"))
                    .addChild(ProtoInstance43 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_metacarpal_phalanx6"))
                    .addChild(ProtoInstance44 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_acromion_2"))
                    .addChild(ProtoInstance45 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_axilla_proximal_2"))
                    .addChild(ProtoInstance46 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_radial_styloid_2"))
                    .addChild(ProtoInstance47 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_axilla_distal_2"))
                    .addChild(ProtoInstance48 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_olecranon_2"))
                    .addChild(ProtoInstance49 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_humeral_lateral_epicondyles_2"))
                    .addChild(ProtoInstance50 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_humeral_medial_epicondyles_2"))
                    .addChild(ProtoInstance51 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_radiale_2"))
                    .addChild(ProtoInstance52 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_metacarpal_phalanx3"))
                    .addChild(ProtoInstance53 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_dactylion_2"))
                    .addChild(ProtoInstance54 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_ulnar_styloid_2"))
                    .addChild(ProtoInstance55 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_metacarpal_phalanx6"))
                    .addChild(ProtoInstance56 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_knee_crease_2"))
                    .addChild(ProtoInstance57 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_femoral_lateral_epicondyles_2"))
                    .addChild(ProtoInstance58 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_femoral_medial_epicondyles_2"))
                    .addChild(ProtoInstance59 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_tarsal_interphalangeal_phalanx6"))
                    .addChild(ProtoInstance60 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_lateral_malleolus_2"))
                    .addChild(ProtoInstance61 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_medial_malleolus_2"))
                    .addChild(ProtoInstance62 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_sphyrion_2"))
                    .addChild(ProtoInstance63 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_tarsal_interphalangeal_phalanx2"))
                    .addChild(ProtoInstance64 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_calcaneus_posterior_2"))
                    .addChild(ProtoInstance65 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_tarsal_distal_phalanx3"))
                    .addChild(ProtoInstance66 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_knee_crease_2"))
                    .addChild(ProtoInstance67 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_femoral_lateral_epicondyles_2"))
                    .addChild(ProtoInstance68 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_femoral_medial_epicondyles_2"))
                    .addChild(ProtoInstance69 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_tarsal_interphalangeal_phalanx6"))
                    .addChild(ProtoInstance70 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_lateral_malleolus_2"))
                    .addChild(ProtoInstance71 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_medial_malleolus_2"))
                    .addChild(ProtoInstance72 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_sphyrion_2"))
                    .addChild(ProtoInstance73 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_tarsal_interphalangeal_phalanx2"))
                    .addChild(ProtoInstance74 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_calcaneus_posterior_2"))
                    .addChild(ProtoInstance75 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_tarsal_distal_phalanx3"))
                    .addChild(ProtoInstance76 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_crotch_2"))
                    .addChild(ProtoInstance77 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_r_neck_base_2"))
                    .addChild(ProtoInstance78 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_l_neck_base_2"))
                    .addChild(ProtoInstance79 = (new autoclass.ProtoInstance()).setName("Site").setDEF("hanim_navel_2")));
ProtoInstance3

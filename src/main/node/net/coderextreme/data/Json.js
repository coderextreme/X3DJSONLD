...
var ProtoInstance4 = null;
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("modified").setContent("4 April 2020"))
        ...
        .addMeta((new autoclass.meta()).setName("reference").setContent("https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/Java.x3d"))
        ...
        .addMeta((new autoclass.meta()).setName("translated").setContent("04 April 2020"))
...
"}"))
        ...
        .addChild((new autoclass.Inline()).setDEF("inlineSceneDef").setUrl(java.newArray("java.lang.String", ["someOtherScene.x3d","https://www.web3d.org/specifications/java/examples/someOtherScene.x3d"])))

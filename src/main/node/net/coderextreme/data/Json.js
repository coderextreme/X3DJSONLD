...
var ProtoInstance4 = null;
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Transform()).setDEF("LogoGeometryTransform").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(1.5), java.newFloat(0)])).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)]))
          .addChild((new autoclass.Anchor()).setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(java.newArray("java.lang.String", ["../X3DJSAIL.html","https://www.web3d.org/specifications/java/X3DJSAIL.html"])).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)]))
        ...
        .addChild((new autoclass.Inline()).setDEF("inlineSceneDef").setUrl(java.newArray("java.lang.String", ["someOtherScene.x3d","https://www.web3d.org/specifications/java/examples/someOtherScene.x3d"])).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)])))
        ...
        .addChild((new autoclass.Sound()).setLocation(java.newArray("float", [java.newFloat(0), java.newFloat(1.6), java.newFloat(0)]))
          ...
          .setSource((new autoclass.AudioClip()).setDescription("chimes").setUrl(java.newArray("java.lang.String", ["chimes.wav","https://www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/AudioClip/chimes.wav"])).setLoop(false).setPitch(java.newFloat(1)).setStartTime(0).setStopTime(0).setPauseTime(0).setResumeTime(0)
        ...
        .addChild((new autoclass.Group()).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)]))
          ...
          .addChild((new autoclass.Group()).setDEF("Node2").setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)]))
            .addComments((new autoclass.CommentsBlock("intentionally empty"))))
          .addChild((new autoclass.Transform()).setDEF("Node4").setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)]))
            .addComments((new autoclass.CommentsBlock("intentionally empty"))))
        ...
        .addChild((new autoclass.Shape()).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)]))
          .setAppearance((new autoclass.Appearance())
            ...
            .addShaders(ProtoInstance4 = (new autoclass.ProtoInstance()).setName("ShaderProto").setDEF("TestShader3"))
        ...
        .addChild((new autoclass.Transform()).setDEF("SpecialtyNodes").setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)]))
          ...
          .addChild((new autoclass.EspduTransform()).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)])))
          .addChild((new autoclass.ReceiverPdu()).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)])))
          .addChild((new autoclass.SignalPdu()).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)])))
          .addChild((new autoclass.TransmitterPdu()).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)])))

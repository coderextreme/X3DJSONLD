          ...
          .setProtoBody((new autoclass.ProtoBody())
            .addChild((new autoclass.Transform())
              ...
              .addChild((new autoclass.Shape())
                ...
                .setGeometry((new autoclass.Sphere()).setRadius(java.newFloat(5.699999988079071)))))))
        .addChild((new autoclass.ProtoDeclare()).setName("org")
          ...
          .setProtoBody((new autoclass.ProtoBody())
            .addChild((new autoclass.Transform())
              ...
              .addChild((new autoclass.Shape())
                .setAppearance((new autoclass.Appearance())
                  .setMaterial((new autoclass.Material()).setDiffuseColor(java.newArray("float", [java.newFloat(0), java.newFloat(1), java.newFloat(1)])).setTransparency(java.newFloat(0.400000005960464))
                    .setIS((new autoclass.IS())

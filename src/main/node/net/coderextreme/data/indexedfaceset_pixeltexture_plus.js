...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_plus.x3d").setName("title"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_plus-front.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_plus-rear.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_plus-top.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_plus-bottom.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_plus-left.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_plus-right.jpg").setName("Image"))
        ...
        .addMeta((new autoclass.meta()).setContent("Test of browser ability to map a 3 times multiple of an PixelTexture onto an IndexedFaceSet geometry. A 3 by 3 matrix of four equal sized red, green, white and yellow squares in the pixel texture map all the faces of the cube.").setName("description"))
        .addMeta((new autoclass.meta()).setContent("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plus.x3d").setName("identifier"))

...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.Transform().setDEF("DECLBubble_transformA")
...
"}"))
          ...
          .addChild(new autoclass.ROUTE().setFromNode("DECLBubble_bubbleA_bounce").setFromField("translation_changed").setToNode("DECLBubble_transformA").setToField("set_translation"))
          .addChild(new autoclass.ROUTE().setFromNode("DECLBubble_bubbleA_bounce").setFromField("scale_changed").setToNode("DECLBubble_transformA").setToField("set_scale"))
        ...
        .addChild(new autoclass.Transform().setDEF("DECLBubble_transformB")
          .addChild(new autoclass.Shape()
            .setGeometry(new autoclass.Sphere().setRadius(java.newFloat(0.25)))
            .setAppearance(new autoclass.Appearance()
              .setMaterial(new autoclass.Material().setDiffuseColor(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0)])).setTransparency(java.newFloat(0.2)))))
...
"}"))
          ...
          .addChild(new autoclass.ROUTE().setFromNode("DECLBubble_bubbleB_bounce").setFromField("translation_changed").setToNode("DECLBubble_transformB").setToField("set_translation"))
          .addChild(new autoclass.ROUTE().setFromNode("DECLBubble_bubbleB_bounce").setFromField("scale_changed").setToNode("DECLBubble_transformB").setToField("set_scale"))
        ...
        .addChild(new autoclass.Transform().setDEF("DECLBubble_transformC")
          .addChild(new autoclass.Shape()
            .setGeometry(new autoclass.Sphere().setRadius(java.newFloat(0.25)))
            .setAppearance(new autoclass.Appearance()
              .setMaterial(new autoclass.Material().setDiffuseColor(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0)])).setTransparency(java.newFloat(0.2)))))
...
"}"))
          ...
          .addChild(new autoclass.ROUTE().setFromNode("DECLBubble_bubbleC_bounce").setFromField("translation_changed").setToNode("DECLBubble_transformC").setToField("set_translation"))
          .addChild(new autoclass.ROUTE().setFromNode("DECLBubble_bubbleC_bounce").setFromField("scale_changed").setToNode("DECLBubble_transformC").setToField("set_scale"))
        ...
        .addChild(new autoclass.Transform().setDEF("DECLBubble_transformD")
          .addChild(new autoclass.Shape()
            .setGeometry(new autoclass.Sphere().setRadius(java.newFloat(0.25)))
            .setAppearance(new autoclass.Appearance()
              .setMaterial(new autoclass.Material().setDiffuseColor(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0)])).setTransparency(java.newFloat(0.2)))))
...
"}"))
          ...
          .addChild(new autoclass.ROUTE().setFromNode("DECLBubble_bubbleD_bounce").setFromField("translation_changed").setToNode("DECLBubble_transformD").setToField("set_translation"))
          .addChild(new autoclass.ROUTE().setFromNode("DECLBubble_bubbleD_bounce").setFromField("scale_changed").setToNode("DECLBubble_transformD").setToField("set_scale"))
    ...
    X3D0.toFileJSON("../data/bubs3.new.node.x3dj");
    process.exit(0);

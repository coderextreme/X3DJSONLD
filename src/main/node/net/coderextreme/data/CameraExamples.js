...
var ProtoInstance34 = null;
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("reference").setContent("http://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.x3d"))
        .addMeta(new autoclass.meta().setName("identifier").setContent("http://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.x3d"))
        .addMeta(new autoclass.meta().setName("identifier").setContent("http://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.x3d"))
        .addMeta(new autoclass.meta().setName("generator").setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
        .addMeta(new autoclass.meta().setName("license").setContent("../license.html"))
        .addComments(new autoclass.CommentsBlock("TODO warn if more than one identifier present")))
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.ExternProtoDeclare().setName("OfflineRender").setAppinfo("OfflineRender defines a parameters for offline rendering of Camera animation output to a movie file (or possibly a still shot)").setUrl(java.newArray("java.lang.String", ["CameraPrototypes.x3d#OfflineRender","http://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#OfflineRender","CameraPrototypes.wrl#OfflineRender","http://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#OfflineRender"]))
        ...
        .addChild(new autoclass.Group().setDEF("SimpleShotsTargets")
          .addChild(new autoclass.Transform().setDEF("TargetBoxZoom").setTranslation(java.newArray("float", [java.newFloat(-50), java.newFloat(1), java.newFloat(-20)]))
            .addChild(new autoclass.Shape()
              ...
              .setAppearance(new autoclass.Appearance()
                ...
                .setTexture(new autoclass.ImageTexture().setUrl(java.newArray("java.lang.String", ["images/CameraMoveZoom.png","http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveZoom.png"])))))
          ...
          .addChild(new autoclass.Transform().setDEF("TargetBoxDolly").setTranslation(java.newArray("float", [java.newFloat(-40), java.newFloat(1), java.newFloat(-20)]))
            .addChild(new autoclass.Shape()
              ...
              .setAppearance(new autoclass.Appearance()
                .setMaterial(new autoclass.Material())
                .setTexture(new autoclass.ImageTexture().setUrl(java.newArray("java.lang.String", ["images/CameraMoveDolly.png","http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveDolly.png"])))))
            .addChild(new autoclass.Transform().setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(2), java.newFloat(0)]))
              .addChild(new autoclass.Shape()
          ...
          .addChild(new autoclass.Transform().setDEF("TargetBoxPan").setTranslation(java.newArray("float", [java.newFloat(-30), java.newFloat(1), java.newFloat(-20)]))
            .addChild(new autoclass.Shape()
              ...
              .setAppearance(new autoclass.Appearance()
                .setMaterial(new autoclass.Material())
                .setTexture(new autoclass.ImageTexture().setUrl(java.newArray("java.lang.String", ["images/CameraMovePan.png","http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMovePan.png"])))))
            .addChild(new autoclass.Transform().setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(2), java.newFloat(0)]))
              .addChild(new autoclass.Shape()
          ...
          .addChild(new autoclass.Transform().setDEF("TargetBoxBoom").setTranslation(java.newArray("float", [java.newFloat(-20), java.newFloat(1), java.newFloat(-20)]))
            .addChild(new autoclass.Shape()
              ...
              .setAppearance(new autoclass.Appearance()
                .setMaterial(new autoclass.Material())
                .setTexture(new autoclass.ImageTexture().setUrl(java.newArray("java.lang.String", ["images/CameraMoveBoom.png","http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveBoom.png"])))))
            .addChild(new autoclass.Transform().setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(2), java.newFloat(0)]))
              .addChild(new autoclass.Shape()
          ...
          .addChild(new autoclass.Transform().setDEF("TargetBoxTilt").setTranslation(java.newArray("float", [java.newFloat(-10), java.newFloat(1), java.newFloat(-20)]))
            .addChild(new autoclass.Shape()
              ...
              .setAppearance(new autoclass.Appearance()
                .setMaterial(new autoclass.Material())
                .setTexture(new autoclass.ImageTexture().setUrl(java.newArray("java.lang.String", ["images/CameraMoveTilt.png","http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveTilt.png"])))))
            .addChild(new autoclass.Transform().setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(2), java.newFloat(0)]))
              .addChild(new autoclass.Shape()
        ...
        .addChild(new autoclass.Transform().setDEF("CameraShapeTransform").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(0.5), java.newFloat(0)]))
          ...
          .addChild(new autoclass.Transform().setDEF("CameraOffsetTransform").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0.25)]))
            ...
            .addChild(new autoclass.Inline().setDEF("CameraShape").setUrl(java.newArray("java.lang.String", ["CameraShape.x3d","http://www.web3d.org/x3d/content/examples/Basic/development/CameraShape.x3d"])))
        ...
        .addChild(new autoclass.Transform().setDEF("MovingBoxTransform")
          ...
          .addChild(new autoclass.Shape()
            ...
            .setAppearance(new autoclass.Appearance()
              .setMaterial(new autoclass.Material())
              .setTexture(new autoclass.ImageTexture().setUrl(java.newArray("java.lang.String", ["../earth-topo.png","http://www.web3d.org/x3d/content/examples/Basic/earth-topo.png"]))))))
...
ProtoInstance27
              .addFieldValue(new autoclass.fieldValue().setName("moves")
                ...
                .addChild(ProtoInstance31 = new autoclass.ProtoInstance().setName("CameraMovement").setDEF("MoveAimPoint3.4")
                  .addComments(new autoclass.CommentsBlock("can test tracking or not using following values"))));
ProtoInstance28

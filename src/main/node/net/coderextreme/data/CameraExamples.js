...
var ProtoInstance34 = null;
      ...
      .setHead((new autoclass.head())
        .addMeta((new autoclass.meta()).setContent("CameraExamples.x3d").setName("title"))
        .addMeta((new autoclass.meta()).setContent("Camera, CameraShot and CameraMove examples that demonstrate storyboard capabilities and precise camera operation. This is a developmental effort for potential X3D Specification improvement.").setName("description"))
        .addMeta((new autoclass.meta()).setContent("Two demos are found in the scene, click the \"red text\" on left or right to start. (a) SimpleShotsTest shows Zoom in/out, Pan left/right, Boom up/down, Tilt left/right, with each is defined by a CameraShot collecting a series of CameraMovements. (b) AimPointTest gradually slews the camera view to look at the sliding cube, then follows it around before returning to original viewpoint.").setName("documentation"))
        .addMeta((new autoclass.meta()).setContent("Don Brutzman and Jeff Weekley").setName("creator"))
        .addMeta((new autoclass.meta()).setContent("18 June 2009").setName("created"))
        .addMeta((new autoclass.meta()).setContent("20 January 2020").setName("modified"))
        ...
        .addMeta((new autoclass.meta()).setContent("CameraExamplesDemo.mp4").setName("MovingImage"))
        .addMeta((new autoclass.meta()).setContent("https://www.web3d.org/x3d/specifications/ISO-IEC-FDIS-19775-1.2-X3D-AbstractSpecification/Part01/components/navigation.html").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("Camera nodes for Viewpoint navigation control").setName("subject"))
        .addMeta((new autoclass.meta()).setContent("CameraPrototypes.x3d").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("CameraExamplesConsoleLog.txt").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("http://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.avi").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.x3d").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("https://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.x3d").setName("identifier"))
        .addMeta((new autoclass.meta()).setContent("http://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.x3d").setName("reference"))
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.ExternProtoDeclare()).setAppinfo("Camera node provides direct control of scene view to enable cinematic camera animation shot by shot and move by move along with still digital-photography settings for offline rendering of camera images").setName("Camera").setUrl(java.newArray("java.lang.String", ["CameraPrototypes.x3d#Camera","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#Camera","CameraPrototypes.wrl#Camera","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#Camera"]))
          ...
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFVEC3F).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Camera position in local transformation frame, which is default prior to first CameraShot initialPosition getting activated").setName("position"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFROTATION).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Camera rotation in local transformation frame, which is default prior to first CameraShot initialPosition getting activated").setName("orientation"))
          ...
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFFLOAT).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Vector distance to near clipping plane corresponds to NavigationInfo.avatarSize[0]").setName("nearClipPlane"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFFLOAT).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Vector distance to far clipping plane corresponds to NavigationInfo.visibilityLimit").setName("farClipPlane"))
          ...
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Whether camera headlight is on or off").setName("headlight"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFCOLOR).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Camera headlight color").setName("headlightColor"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFFLOAT).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Camera headlight intensity").setName("headlightIntensity"))
        ...
        .addChild((new autoclass.ExternProtoDeclare()).setAppinfo("CameraShot collects a specific set of CameraMovement animations that make up an individual shot").setName("CameraShot").setUrl(java.newArray("java.lang.String", ["CameraPrototypes.x3d#CameraShot","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#CameraShot","CameraPrototypes.wrl#CameraShot","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#CameraShot"]))
        ...
        .addChild((new autoclass.ExternProtoDeclare()).setAppinfo("CameraMovement defines a single camera movement animation").setName("CameraMovement").setUrl(java.newArray("java.lang.String", ["CameraPrototypes.x3d#CameraMovement","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#CameraMovement","CameraPrototypes.wrl#CameraMovement","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#CameraMovement"]))
        ...
        .addChild((new autoclass.ExternProtoDeclare()).setAppinfo("OfflineRender defines a parameters for offline rendering of Camera animation output to a movie file (or possibly a still shot)").setName("OfflineRender").setUrl(java.newArray("java.lang.String", ["CameraPrototypes.x3d#OfflineRender","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#OfflineRender","CameraPrototypes.wrl#OfflineRender","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#OfflineRender"]))
          ...
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_MFSTRING).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("Format of rendered output movie (mpeg mp4 etc.), use first supported format").setName("movieFormat"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_MFSTRING).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("Format of rendered output images (png jpeg gif tiff etc.) use first supported format").setName("imageFormat"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("enable console output to trace script computations and prototype progress").setName("traceEnabled"))
        ...
        .addChild(ProtoInstance0 = (new autoclass.ProtoInstance()).setDEF("Camera.SimpleShotsTest").setName("Camera"))
        ...
        .addChild(ProtoInstance26 = (new autoclass.ProtoInstance()).setDEF("Camera.AimPointTest").setName("Camera"))
        ...
        .addChild((new autoclass.Transform()).setDEF("CameraShapeTransform").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(0.5), java.newFloat(0)]))
          ...
          .addChild((new autoclass.ExternProtoDeclare()).setAppinfo("Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes").setName("ViewFrustum").setUrl(java.newArray("java.lang.String", ["../../X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.x3d#ViewFrustum","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.x3d#ViewFrustum","../../X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.wrl#ViewFrustum","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.wrl#ViewFrustum"]))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("required: insert Viewpoint DEF or USE node for view of interest").setName("ViewpointNode"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("required: insert NavigationInfo DEF or USE node of interest").setName("NavigationInfoNode"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("whether or not frustum geometry is rendered").setName("visible"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFCOLOR).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("RGB color of ViewFrustum outline, default value 0.9 0.9 0.9").setName("lineColor"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFCOLOR).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("RGB color of ViewFrustum hull geometry, default value 0.8 0.8 0.8").setName("frustumColor"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFFLOAT).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("transparency of ViewFrustum hull geometry, default value 0.5").setName("transparency"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFFLOAT).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("assumed ratio height/width, default value 0.75").setName("aspectRatio"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("debug support, default false").setName("trace")))
          .addChild(ProtoInstance33 = (new autoclass.ProtoInstance()).setDEF("ViewFrustumNode").setName("ViewFrustum"))
        ...
        .addChild((new autoclass.ExternProtoDeclare()).setAppinfo("CrossHair prototype provides a heads-up display (HUD) crosshair at the view center, which is useful for assessing NavigationInfo lookAt point").setName("CrossHair").setUrl(java.newArray("java.lang.String", ["../../Savage/Tools/HeadsUpDisplays/CrossHairPrototype.x3d#CrossHair","https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/CrossHairPrototype.x3d#CrossHair","../../Savage/Tools/HeadsUpDisplays/CrossHairPrototype.wrl#CrossHair","https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/CrossHairPrototype.wrl#CrossHair"]))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("whether CrissHair orititype is enabled or not").setName("enabled"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INPUTONLY).setAppinfo("control whether enabled/disabled").setName("set_enabled"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFCOLOR).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("color of CrossHair marker").setName("markerColor"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFVEC3F).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("size of CrossHair in meters").setName("scale"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFVEC3F).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("distance in front of HUD viewpoint").setName("positionOffsetFromCamera")))
        .addChild(ProtoInstance34 = (new autoclass.ProtoInstance()).setDEF("CrossHairInstance").setName("CrossHair"))
...
ProtoInstance0
          .addFieldValue((new autoclass.fieldValue()).setName("shots")
            .addChild(ProtoInstance1 = (new autoclass.ProtoInstance()).setDEF("Zoom").setName("CameraShot"))
            .addChild(ProtoInstance5 = (new autoclass.ProtoInstance()).setDEF("Dolly").setName("CameraShot"))
            .addChild(ProtoInstance9 = (new autoclass.ProtoInstance()).setDEF("Pan").setName("CameraShot"))
            .addChild(ProtoInstance14 = (new autoclass.ProtoInstance()).setDEF("CameraBoom").setName("CameraShot"))
            .addChild(ProtoInstance18 = (new autoclass.ProtoInstance()).setDEF("CameraTilt").setName("CameraShot")));
ProtoInstance1
...
ProtoInstance5
              .addFieldValue((new autoclass.fieldValue()).setName("moves")
                .addChild(ProtoInstance6 = (new autoclass.ProtoInstance()).setDEF("DollyMove1").setName("CameraMovement"))
...
ProtoInstance9
              .addFieldValue((new autoclass.fieldValue()).setName("moves")
                .addChild(ProtoInstance10 = (new autoclass.ProtoInstance()).setDEF("PanLeft").setName("CameraMovement"))
                .addChild(ProtoInstance11 = (new autoclass.ProtoInstance()).setDEF("PanRight").setName("CameraMovement"))
...
ProtoInstance14
              .addFieldValue((new autoclass.fieldValue()).setName("moves")
                .addChild(ProtoInstance15 = (new autoclass.ProtoInstance()).setDEF("CameraBoomUp").setName("CameraMovement"))
                .addChild(ProtoInstance16 = (new autoclass.ProtoInstance()).setDEF("BoomDown").setName("CameraMovement"))
                .addChild(ProtoInstance17 = (new autoclass.ProtoInstance()).setDEF("BoomPause").setName("CameraMovement")));
ProtoInstance15
...
ProtoInstance18
              .addFieldValue((new autoclass.fieldValue()).setName("moves")
                ...
                .addChild(ProtoInstance20 = (new autoclass.ProtoInstance()).setDEF("TiltDown").setName("CameraMovement"))
                .addChild(ProtoInstance21 = (new autoclass.ProtoInstance()).setDEF("TiltPause").setName("CameraMovement"))
                ...
                .addChild(ProtoInstance24 = (new autoclass.ProtoInstance()).setDEF("TiltReset").setName("CameraMovement"))
                .addChild(ProtoInstance25 = (new autoclass.ProtoInstance()).setDEF("TiltUp").setName("CameraMovement")));
ProtoInstance19
...
ProtoInstance26
          .addFieldValue((new autoclass.fieldValue()).setName("shots")
            .addChild(ProtoInstance27 = (new autoclass.ProtoInstance()).setDEF("Shot5").setName("CameraShot")));
ProtoInstance27
...
ProtoInstance27
              .addFieldValue((new autoclass.fieldValue()).setName("moves")
                .addChild(ProtoInstance28 = (new autoclass.ProtoInstance()).setDEF("MoveAimPoint3.1").setName("CameraMovement")
                  .addComments((new autoclass.CommentsBlock(" goalAimPoint modified by ROUTE to match moving Box "))))
                .addChild(ProtoInstance29 = (new autoclass.ProtoInstance()).setDEF("MoveAimPoint3.2").setName("CameraMovement")
                  .addComments((new autoclass.CommentsBlock(" goalAimPoint modified by ROUTE to match moving Box "))))
                .addChild(ProtoInstance30 = (new autoclass.ProtoInstance()).setDEF("MoveAimPoint3.3").setName("CameraMovement")
                  .addComments((new autoclass.CommentsBlock(" goalAimPoint modified by ROUTE to match moving Box "))))
                .addChild(ProtoInstance31 = (new autoclass.ProtoInstance()).setDEF("MoveAimPoint3.4").setName("CameraMovement")

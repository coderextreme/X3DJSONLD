...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("TODO").setContent("fix visible geometry for thumb and index finger"))
        ...
        .addChild((new autoclass.HAnimHumanoid()).setName("Hand_Left").setDEF("hanim_Hand_Left").setLoa(4).setVersion("2.0")
          ...
          .setSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setDEF("hanim_humanoid_root")
            ...
            .addChild((new autoclass.HAnimJoint()).setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setDescription("connection joint of hand to leg above")
              ...
              .addChild((new autoclass.HAnimJoint()).setName("l_midcarpal_1").setDEF("hanim_l_midcarpal_1").setCenter(java.newArray("float", [java.newFloat(0.1), java.newFloat(0.1), java.newFloat(0)]))
              ...
              .addChild((new autoclass.HAnimJoint()).setName("l_midcarpal_2").setDEF("hanim_l_midcarpal_2").setCenter(java.newArray("float", [java.newFloat(0.1), java.newFloat(0.1), java.newFloat(0)]))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.HAnimHumanoid()).setName("Humanoid_Left_hand").setDEF("Humanoid_Left_hand").setVersion("2.0")
          .setSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setDEF("hanim_HumanoidRoot")
            .addChild((new autoclass.HAnimJoint()).setName("l_radiocarpal_joint").setDEF("l_radiocarpal_joint")
              ...
              .addChild((new autoclass.HAnimJoint()).setName("l_midcarpal_joint_12").setDEF("l_midcarpal_joint_12").setCenter(java.newArray("float", [java.newFloat(0.1), java.newFloat(0.1), java.newFloat(0)]))
                .addChild((new autoclass.HAnimSegment()).setName("l_trapezoid").setDEF("l_trapezoid")
                ...
                .addChild((new autoclass.HAnimJoint()).setName("l_carpometacarpal_joint_1").setDEF("l_carpometacarpal_joint_1").setCenter(java.newArray("float", [java.newFloat(0.2), java.newFloat(0.15), java.newFloat(0)]))
                  .addChild((new autoclass.HAnimSegment()).setName("l_metacarpal_1").setDEF("l_metacarpal_1")
                  ...
                  .addChild((new autoclass.HAnimJoint()).setName("l_metacarpophalangeal_joint_1").setDEF("l_metacarpophalangeal_joint_1").setCenter(java.newArray("float", [java.newFloat(0.3), java.newFloat(0.3), java.newFloat(0)]))
                    .addChild((new autoclass.HAnimSegment()).setName("l_proximal_phalanges1").setDEF("l_proximal_phalanges1")
                    ...
                    .addChild((new autoclass.HAnimJoint()).setName("l_interphalangeal_joint_1").setDEF("l_interphalangeal_joint_1").setCenter(java.newArray("float", [java.newFloat(0.35), java.newFloat(0.4), java.newFloat(0)]))
                      .addChild((new autoclass.HAnimSegment()).setName("l_distal_phalanges1").setDEF("l_distal_phalanges1")
                ...
                .addChild((new autoclass.HAnimJoint()).setName("l_carpometacarpal_joint_2").setDEF("l_carpometacarpal_joint_2").setCenter(java.newArray("float", [java.newFloat(0.1), java.newFloat(0.2), java.newFloat(0)]))
                  .addChild((new autoclass.HAnimSegment()).setName("l_metacarpal2").setDEF("l_metacarpal2")
                  ...
                  .addChild((new autoclass.HAnimJoint()).setName("l_metacarpophalangeal_joint_2").setDEF("l_metacarpophalangeal_joint_2").setCenter(java.newArray("float", [java.newFloat(0.15), java.newFloat(0.5), java.newFloat(0)]))
                    .addChild((new autoclass.HAnimSegment()).setName("l_proximal_phalanges2").setDEF("l_proximal_phalanges2")
                    ...
                    .addChild((new autoclass.HAnimJoint()).setName("l_proximal_interphalangeal_joint_2").setDEF("l_proximal_interphalangeal_joint_2").setCenter(java.newArray("float", [java.newFloat(0.2), java.newFloat(0.7), java.newFloat(0)]))
                      .addChild((new autoclass.HAnimSegment()).setName("l_middle_phalanges2").setDEF("l_middle_phalanges2")
                      ...
                      .addChild((new autoclass.HAnimJoint()).setName("l_distal_interphalangeal_joint_2").setDEF("l_distal_interphalangeal_joint_2").setCenter(java.newArray("float", [java.newFloat(0.24), java.newFloat(0.87), java.newFloat(0)]))
                        .addChild((new autoclass.HAnimSegment()).setName("l_distal_phalanges2").setDEF("l_distal_phalanges2")
              ...
              .addChild((new autoclass.HAnimJoint()).setName("l_midcarpal_joint_3").setDEF("l_midcarpal_joint_3").setCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0.07), java.newFloat(0)]))
                .addChild((new autoclass.HAnimSegment()).setName("l_capitate").setDEF("l_capitate")
                ...
                .addChild((new autoclass.HAnimJoint()).setName("l_carpometacarpal_joint_3").setDEF("l_carpometacarpal_joint_3").setCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0.2), java.newFloat(0)]))
                  .addChild((new autoclass.HAnimSegment()).setName("l_metacarpal3").setDEF("l_metacarpal3")
                  ...
                  .addChild((new autoclass.HAnimJoint()).setName("l_metacarpophalangeal_joint_3").setDEF("l_metacarpophalangeal_joint_3").setCenter(java.newArray("float", [java.newFloat(0.03), java.newFloat(0.5), java.newFloat(0)]))
                    .addChild((new autoclass.HAnimSegment()).setName("l_proximal_phalanges3").setDEF("l_proximal_phalanges3")
                    ...
                    .addChild((new autoclass.HAnimJoint()).setName("l_proximal_interphalangeal_joint_3").setDEF("l_proximal_interphalangeal_joint_3").setCenter(java.newArray("float", [java.newFloat(0.05), java.newFloat(0.75), java.newFloat(0)]))
                      .addChild((new autoclass.HAnimSegment()).setName("l_middle_phalanges3").setDEF("l_middle_phalanges3")
                      ...
                      .addChild((new autoclass.HAnimJoint()).setName("l_distal_interphalangeal_joint_3").setDEF("l_distal_interphalangeal_joint_3").setCenter(java.newArray("float", [java.newFloat(0.08), java.newFloat(0.96), java.newFloat(0)]))
                        .addChild((new autoclass.HAnimSegment()).setName("l_distal_phalanges3").setDEF("l_distal_phalanges3")
              ...
              .addChild((new autoclass.HAnimJoint()).setName("l_midcarpal_joint_12").setDEF("l_midcarpal_joint_45").setCenter(java.newArray("float", [java.newFloat(-0.1), java.newFloat(0.1), java.newFloat(0)]))
                .addChild((new autoclass.HAnimSegment()).setName("l_hamate").setDEF("l_hamate")
                  .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(-0.1), java.newFloat(0.1), java.newFloat(0)]))
                    .addChild((new autoclass.Shape()).setUSE("HAnimNewJointShape")))
                  .addChild((new autoclass.Shape())
                    .setAppearance((new autoclass.Appearance())
                ...
                .addChild((new autoclass.HAnimJoint()).setName("l_carpometacarpal_joint_4").setDEF("l_carpometacarpal_joint_4").setCenter(java.newArray("float", [java.newFloat(-0.1), java.newFloat(0.2), java.newFloat(0)]))
                  .addChild((new autoclass.HAnimSegment()).setName("l_metacarpal4").setDEF("l_metacarpal4")
                    .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(-0.1), java.newFloat(0.2), java.newFloat(0)]))
                      .addChild((new autoclass.Shape()).setUSE("HAnimJointShape")))
                    .addChild((new autoclass.Shape())
                      .setAppearance((new autoclass.Appearance())
                  ...
                  .addChild((new autoclass.HAnimJoint()).setName("l_metacarpophalangeal_joint_4").setDEF("l_metacarpophalangeal_joint_4").setCenter(java.newArray("float", [java.newFloat(-0.1), java.newFloat(0.47), java.newFloat(0)]))
                    .addChild((new autoclass.HAnimSegment()).setName("l_proximal_phalanges4").setDEF("l_proximal_phalanges4")
                    ...
                    .addChild((new autoclass.HAnimJoint()).setName("l_proximal_interphalangeal_joint_4").setDEF("l_proximal_interphalangeal_joint_4").setCenter(java.newArray("float", [java.newFloat(-0.1), java.newFloat(0.7), java.newFloat(0)]))
                      .addChild((new autoclass.HAnimSegment()).setName("l_middle_phalanges4").setDEF("l_middle_phalanges4")
                      ...
                      .addChild((new autoclass.HAnimJoint()).setName("l_distal_interphalangeal_joint_4").setDEF("l_distal_interphalangeal_joint_4").setCenter(java.newArray("float", [java.newFloat(-0.1), java.newFloat(0.93), java.newFloat(0)]))
                        .addChild((new autoclass.HAnimSegment()).setName("l_distal_phalanx4").setDEF("l_distal_phalanx4")
                ...
                .addChild((new autoclass.HAnimJoint()).setName("l_carpometacarpal_joint_5").setDEF("l_carpometacarpal_joint_5").setCenter(java.newArray("float", [java.newFloat(-0.15), java.newFloat(0.17), java.newFloat(0)]))
                  .addChild((new autoclass.HAnimSegment()).setName("l_metacarpal5").setDEF("l_metacarpal5")
                  ...
                  .addChild((new autoclass.HAnimJoint()).setName("l_metacarpophalangeal_joint_5").setDEF("l_metacarpophalangeal_joint_5").setCenter(java.newArray("float", [java.newFloat(-0.2), java.newFloat(0.4), java.newFloat(0)]))
                    .addChild((new autoclass.HAnimSegment()).setName("l_proximal_phalanges2").setDEF("l_proximal_phalanges5")
                    ...
                    .addChild((new autoclass.HAnimJoint()).setName("l_proximal_interphalangeal_joint_5").setDEF("l_proximal_interphalangeal_joint_5").setCenter(java.newArray("float", [java.newFloat(-0.23), java.newFloat(0.63), java.newFloat(0)]))
                      .addChild((new autoclass.HAnimSegment()).setName("l_middle_phalanges5").setDEF("l_middle_phalanges5")
                      ...
                      .addChild((new autoclass.HAnimJoint()).setName("l_distal_interphalangeal_joint_5").setDEF("l_distal_interphalangeal_joint_5").setCenter(java.newArray("float", [java.newFloat(-0.25), java.newFloat(0.79), java.newFloat(0)]))
                        .addChild((new autoclass.HAnimSegment()).setName("l_distal_phalanges5").setDEF("l_distal_phalanges5")

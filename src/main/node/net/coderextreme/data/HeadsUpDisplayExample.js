...
var ProtoInstance0 = null;
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Background()).setDEF("SandyShallowBottom").setGroundAngle(java.newArray("float", [java.newFloat(0.05), java.newFloat(1.52), java.newFloat(1.56), java.newFloat(1.5707)])).setGroundColor(java.newArray("float", [java.newFloat(0.2), java.newFloat(0.2), java.newFloat(0), java.newFloat(0.3), java.newFloat(0.3), java.newFloat(0), java.newFloat(0.5), java.newFloat(0.5), java.newFloat(0.3), java.newFloat(0.1), java.newFloat(0.3), java.newFloat(0.4), java.newFloat(0), java.newFloat(0.2), java.newFloat(0.4)])).setSkyAngle(java.newArray("float", [java.newFloat(0.04), java.newFloat(0.05), java.newFloat(0.1), java.newFloat(1.309), java.newFloat(1.57)])).setSkyColor(java.newArray("float", [java.newFloat(0.8), java.newFloat(0.8), java.newFloat(0.2), java.newFloat(0.8), java.newFloat(0.8), java.newFloat(0.2), java.newFloat(0.1), java.newFloat(0.1), java.newFloat(0.6), java.newFloat(0.1), java.newFloat(0.1), java.newFloat(0.6), java.newFloat(0.1), java.newFloat(0.25), java.newFloat(0.8), java.newFloat(0.6), java.newFloat(0.6), java.newFloat(0.9)])).setTransparency(java.newFloat(0)))

        ...
        .addChild((new autoclass.ProtoDeclare()).setName("three")
          ...
          .setProtoBody((new autoclass.ProtoBody())
            .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
              ...
              .addChild(ProtoInstance0 = (new autoclass.ProtoInstance()).setName("sphere"))
              .addChild(ProtoInstance1 = (new autoclass.ProtoInstance()).setName("sphere"))
              .addChild(ProtoInstance2 = (new autoclass.ProtoInstance()).setName("sphere")))))

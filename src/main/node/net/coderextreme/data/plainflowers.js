...
var ProtoInstance6 = null;
      ...
      .setHeadSync(new autoclass.head()
        .addMetaSync(new autoclass.meta().setNameSync("title").setContentSync("plainflowers.x3d"))
        ...
        .addMetaSync(new autoclass.meta().setNameSync("identifier").setContentSync("https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d")))
...
ProtoInstance0
                  .addFieldValueSync(new autoclass.fieldValue().setNameSync("vertex").setValueSync("\"../shaders/x_ite_flowers_plain.vs\""));
ProtoInstance0
                  .addFieldValueSync(new autoclass.fieldValue().setNameSync("fragment").setValueSync("\"../shaders/plain.fs\""));

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        .addMeta((new autoclass.meta()).setContent("Table5_18PixelTexture").setName("title"))
        .addMeta((new autoclass.meta()).setContent("PixelTexture example for Table 5.18").setName("description"))
        .addMeta((new autoclass.meta()).setContent("Leonard Daly and Don Brutzman").setName("creator"))
        .addMeta((new autoclass.meta()).setContent("18 December 2006").setName("created"))
        ...
        .addMeta((new autoclass.meta()).setContent("X3D, PixelTexture").setName("subject"))
        .addMeta((new autoclass.meta()).setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/Table5_18PixelTexture").setName("identifier"))

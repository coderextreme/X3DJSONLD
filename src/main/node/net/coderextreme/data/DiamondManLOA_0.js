...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.HAnimHumanoid()).setName("humanoid").setDEF("hanim_humanoid").setVersion("1.0")
          ...
          .addSkeleton((new autoclass.HAnimJoint()).setName("HumanoidRoot").setDEF("hanim_HumanoidRoot").setCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0.824), java.newFloat(0.0277)])).setStiffness(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
            .addChild((new autoclass.HAnimJoint()).setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0.9149), java.newFloat(0.0016)])).setStiffness(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
          ...
          .addViewpoints((new autoclass.HAnimSite()).setName("site_view").setDEF("hanim_site_view")

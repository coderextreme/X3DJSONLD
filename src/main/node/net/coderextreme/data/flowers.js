            ...
            .addChild(new autoclass.Transform().setDEF("animate_transform")
              .addChild(new autoclass.Shape()
                .setAppearance(new autoclass.Appearance()
                  ...
                  .addComments((new autoclass.CommentsBlock("<ComposedShader DEF='x3dom' language=\"GLSL\">")))
                  ...
                  .addComments((new autoclass.CommentsBlock("<field name='b' type='SFFloat' accessType='inputOutput' value='1'></field>")))
                  ...
                  .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs\"'></ShaderPart>")))
                  .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\"' type='FRAGMENT'></ShaderPart>")))
...
"			}"))
            ...
            .addComments((new autoclass.CommentsBlock("<ROUTE fromNode='Animate' fromField='a' toNode='x3dom' toField='a'/>")))
            .addComments((new autoclass.CommentsBlock("<ROUTE fromNode='Animate' fromField='b' toNode='x3dom' toField='b'/>")))
            .addComments((new autoclass.CommentsBlock("<ROUTE fromNode='Animate' fromField='c' toNode='x3dom' toField='c'/>")))
            .addComments((new autoclass.CommentsBlock("<ROUTE fromNode='Animate' fromField='d' toNode='x3dom' toField='d'/>")))
            .addComments((new autoclass.CommentsBlock("<ROUTE fromNode='Animate' fromField='pdelta' toNode='x3dom' toField='pdelta'/>")))
            .addComments((new autoclass.CommentsBlock("<ROUTE fromNode='Animate' fromField='tdelta' toNode='x3dom' toField='tdelta'/>")))))
    ...
    X3D0.toFileX3D("../data/flowers.new.node.x3d");
    X3D0.toFileJSON("../data/flowers.new.node.x3dj");
    process.exit(0);

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("modified").setContent("Sat, 30 Dec 2023 07:56:51 GMT"))
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Group())
          .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(6.14221f), java.newFloat(0.0694613f), java.newFloat(-0.000999451f)]))
          ...
          .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(-4.85443f), java.newFloat(0.0694381f), java.newFloat(-0.00149918f)]))
            .addChild((new autoclass.Shape())
              .setAppearance((new autoclass.Appearance())
                .setMaterial((new autoclass.Material()))
                .setTexture((new autoclass.PixelTexture()).setUSE("RgbOpacityCheckerboard")))
              .setGeometry((new autoclass.Sphere()))))
          .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(-1.47341f), java.newFloat(0.036672f), java.newFloat(-0.00175095f)]))
            .addChild((new autoclass.Shape())
              .setAppearance((new autoclass.Appearance())
                .setMaterial((new autoclass.Material()))
                .setTexture((new autoclass.PixelTexture()).setUSE("RgbOpacityCheckerboard")))
              .setGeometry((new autoclass.Cone()))))
          .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(2.31094f), java.newFloat(0.0694206f), java.newFloat(-0.00187683f)]))
            .addChild((new autoclass.Shape())
              .setAppearance((new autoclass.Appearance())
                .setMaterial((new autoclass.Material()))
                .setTexture((new autoclass.PixelTexture()).setUSE("RgbOpacityCheckerboard")))

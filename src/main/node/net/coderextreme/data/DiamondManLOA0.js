...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.HAnimHumanoid().setDEF("hanim_humanoid").setName("humanoid").setLoa(0)
          ...
          .addViewpoints(new autoclass.HAnimSite("hanim_humanoid").setDEF("hanim_site_view").setName("site_view").setContainerFieldOverride("viewpoints")
    ...
    X3D0.toFileJSON("../data/DiamondManLOA0.new.node.x3dj");
    process.exit(0);

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.HAnimHumanoid().setName("humanoid").setDEF("hanim_humanoid").setLoa(0).setVersion("2.0")
          ...
          .addSkeleton(new autoclass.HAnimJoint("hanim_humanoid").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0.824), java.newFloat(0.0277)])).setContainerFieldOverride("skeleton")
          ...
          .addViewpoints(new autoclass.HAnimSite("hanim_humanoid").setName("site_view").setDEF("hanim_site_view").setContainerFieldOverride("viewpoints")
    ...
    X3D0.toFileX3D("../data/DiamondManLOA0patched2.new.node.x3d");
    X3D0.toFileJSON("../data/DiamondManLOA0patched2.new.node.json");
    process.exit(0);

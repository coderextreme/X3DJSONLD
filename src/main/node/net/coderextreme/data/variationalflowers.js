      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.Transform()
          .addChild(new autoclass.ParticleSystem().setMaxParticles(100).setGeometryType("GEOMETRY")
            ...
            .addComments((new autoclass.CommentsBlock("* lastFrame - last frame that was rendered (0 for default)")))
            .addComments((new autoclass.CommentsBlock("* updateRate - update rate is amount of time between frames")))
            .addComments((new autoclass.CommentsBlock("<VariationPhysicsModel values=\"2 2 5 5 0 0\" varations=\"2 1 3 3 0.1 0.1\" lastFrame='0' updateRate='0.1'>")))
            .addComments((new autoclass.CommentsBlock("</VariationPhysicsModel>")))
            ...
            .setAppearance(new autoclass.Appearance()
              ...
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"../shaders/freewrl.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' type='FRAGMENT'></ShaderPart>")))
              ...
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"../shaders/castle.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart type='FRAGMENT' url='\"../shaders/castle.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/>")))
              .addComments((new autoclass.CommentsBlock("</ComposedShader>")))
...
"			}"))
    ...
    X3D0.toFileJSON("../data/variationalflowers.new.node.x3dj");
    process.exit(0);

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Background()).setBackUrl(java.newArray("java.lang.String", ["resources/images/bBK.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBK.png"])).setBottomUrl(java.newArray("java.lang.String", ["resources/images/bBT.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBT.png"])).setFrontUrl(java.newArray("java.lang.String", ["resources/images/bFR.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bFR.png"])).setLeftUrl(java.newArray("java.lang.String", ["resources/images/bLF.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bLF.png"])).setRightUrl(java.newArray("java.lang.String", ["resources/images/bRT.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bRT.png"])).setTopUrl(java.newArray("java.lang.String", ["resources/images/bTP.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bTP.png"])).setSkyColor(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setTransparency(java.newFloat(0)))
          ...
          .addChild((new autoclass.Shape()).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)]))
            ...
            .setAppearance((new autoclass.Appearance())
              ...
              .setTexture((new autoclass.ComposedCubeMapTexture()).setDEF("texture")
                .setBack((new autoclass.ImageTexture()).setUrl(java.newArray("java.lang.String", ["resources/images/bBK.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBK.png"])))
                .setBottom((new autoclass.ImageTexture()).setUrl(java.newArray("java.lang.String", ["resources/images/bBT.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBT.png"])))
                .setFront((new autoclass.ImageTexture()).setUrl(java.newArray("java.lang.String", ["resources/images/bFR.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bFR.png"])))
                .setLeft((new autoclass.ImageTexture()).setUrl(java.newArray("java.lang.String", ["resources/images/bLF.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bLF.png"])))
                .setRight((new autoclass.ImageTexture()).setUrl(java.newArray("java.lang.String", ["resources/images/bRT.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bRT.png"])))
                .setTop((new autoclass.ImageTexture()).setUrl(java.newArray("java.lang.String", ["resources/images/bTP.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/bTP.png"]))))

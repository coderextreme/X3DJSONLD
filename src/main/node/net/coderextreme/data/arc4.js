...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Transform()).setDEF("DECLpoint_G1_node").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
...
"		}"))
        ...
        .addChild((new autoclass.Transform()).setDEF("DECLpoint_G2_node").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
          .addChild((new autoclass.Shape())
            .setGeometry((new autoclass.Sphere()).setRadius(java.newFloat(0.1)))
            .setAppearance((new autoclass.Appearance())
              .setMaterial((new autoclass.Material()).setDiffuseColor(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0)])))))

...
ConfigurationProperties.setStripTrailingZeroesSync(true);
      ...
      .setHeadSync(new autoclass.head()
        .addMetaSync(new autoclass.meta().setNameSync("title").setContentSync("x3dconnectorProto"))
...
"        }")))
        .addChildSync(new autoclass.ROUTE().setFromNodeSync("DECLpoint_G1_node").setFromFieldSync("translation_changed").setToNodeSync("DECLx3dconnector_connector1_S1").setToFieldSync("set_startpoint"))
        .addChildSync(new autoclass.ROUTE().setFromNodeSync("DECLpoint_G2_node").setFromFieldSync("translation_changed").setToNodeSync("DECLx3dconnector_connector1_S1").setToFieldSync("set_endpoint")))      ;

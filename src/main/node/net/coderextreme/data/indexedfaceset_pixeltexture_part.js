...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_part.x3d").setName("title"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_part-front.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_part-rear.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_part-top.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_part-bottom.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_part-left.jpg").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("indexedfaceset_pixeltexture_part-right.jpg").setName("Image"))
        ...
        .addMeta((new autoclass.meta()).setContent("Test of browser ability to map a partial portion of an PixelTexture onto an IndexedFaceSet geometry. Only the yellow portion of four equal sized red, green, yellow and white squares in the pixel texture map all the faces of the cube.").setName("description"))
        .addMeta((new autoclass.meta()).setContent("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_part.x3d").setName("identifier"))

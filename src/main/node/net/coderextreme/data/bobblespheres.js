          ...
          .addChild(new autoclass.Shape()
            .setAppearance(new autoclass.Appearance()
              .setMaterial(new autoclass.PhysicalMaterial().setTransmissionFactor("0.95").setRoughness(java.newFloat(0.05))
                .addExtensions(new autoclass.IORMaterialExtension().setDEF("IOR_2").setIndexOfRefraction(java.newFloat(1.5)))))
            .setGeometry(new autoclass.Sphere().setRadius(java.newFloat(0.2)))))
          ...
          .addChild(new autoclass.Shape()
            .setAppearance(new autoclass.Appearance()
              .setMaterial(new autoclass.PhysicalMaterial().setTransmissionFactor("0.95").setRoughness(java.newFloat(0.05)).setIndexOfRefraction("1.33")
                .addExtensions(new autoclass.IridescenceMaterialExtension().setDEF("IRI_3").setIridescence(java.newFloat(1)).setIridescenceIndexOfRefraction(java.newFloat(1.3)).setIridescenceThicknessMinimum(java.newFloat(100)))))
            .setGeometry(new autoclass.Sphere().setRadius(java.newFloat(0.2)))))

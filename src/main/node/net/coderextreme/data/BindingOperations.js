...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        .addMeta((new autoclass.meta()).setContent("BindingOperations.x3d").setName("title"))
        .addMeta((new autoclass.meta()).setContent("Illustrate Viewpoint binding operations (in gory detail!) as described in Chapter 4 concepts. Scene design: a TimeSensor clock drives and IntegerSequencer for each t0/t1/etc. event, and a customized Script node sends bind/unbind events to the correct Viewpoint. Display the browser console to see occurrence of each event.").setName("description"))
        .addMeta((new autoclass.meta()).setContent("Don Brutzman").setName("creator"))
        .addMeta((new autoclass.meta()).setContent("5 January 2008").setName("created"))
        .addMeta((new autoclass.meta()).setContent("22 July 2013").setName("modified"))
        .addMeta((new autoclass.meta()).setContent("BindingOperations.console.txt").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("BindingStackOperations.png").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("X3D for Web Authors, Section 2.5.1, Figure 4.1").setName("reference"))
        ...
        .addMeta((new autoclass.meta()).setContent("Copyright Don Brutzman and Leonard Daly 2007").setName("rights"))
        .addMeta((new autoclass.meta()).setContent("X3D book, X3D graphics, X3D-Edit, http://www.x3dGraphics.com").setName("subject"))
        .addMeta((new autoclass.meta()).setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter04ViewingNavigation/BindingOperations.x3d").setName("identifier"))
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(-3), java.newFloat(8)]))
          ...
          .addChild((new autoclass.Script()).setDEF("BindingSequencerEngine")
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFINT32).setAccessType(autoclass.field.ACCESSTYPE_INPUTONLY).setName("set_timeEvent"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setName("bindView1"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setName("bindView2"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setName("bindView3"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setName("bindView4"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setName("bindView5"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INPUTONLY).setName("view1Bound"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INPUTONLY).setName("view2Bound"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INPUTONLY).setName("view3Bound"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INPUTONLY).setName("view4Bound"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFINT32).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setName("priorInputvalue").setValue("-1"))

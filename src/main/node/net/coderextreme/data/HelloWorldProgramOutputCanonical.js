...
var ProtoInstance6 = null;
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("modified").setContent("27 December 2018"))
        ...
        .addMeta((new autoclass.meta()).setName("reference").setContent("https://savage.nps.edu/X3dValidator?url=http://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d"))
...
"}"))
        ...
        .addChild((new autoclass.Shape()).setDEF("TestShape2")
          .setAppearance((new autoclass.Appearance()).setDEF("TestAppearance2")
            ...
            .setMaterial(ProtoInstance1 = (new autoclass.ProtoInstance()).setName("ArtDeco02Material").setDEF("ArtDeco02MaterialDEF")
              .addComments((new autoclass.CommentsBlock("[HelloWorldProgram diagnostic] ArtDeco02ProtoInstance.getNodeType()=\"ERROR_UNKNOWN_EXTERNPROTODECLARE_NODE_TYPE: ExternProtoDeclare name='ArtDeco02Material' type cannot be remotely accessed at run time. TODO X3DJSAIL needs to add further capability that retrieves the ExternProtoDeclare file.\"")))))
        ...
        .addChild((new autoclass.Shape()).setDEF("TestShape3")
          .setAppearance((new autoclass.Appearance()).setDEF("TestAppearance3")
            .addComments((new autoclass.CommentsBlock("ArtDeco02Material ProtoInstance USE goes here. Note that name field is NOT defined as part of ProtoInstance USE.")))
        ...
        .addChild((new autoclass.Inline()).setDEF("inlineSceneDef").setUrl(java.newArray("java.lang.String", ["someOtherScene.x3d","http://www.web3d.org/specifications/java/examples/someOtherScene.x3d"])))
...
"}"))))
        ...
        .addChild((new autoclass.Sound()).setLocation(java.newArray("float", [java.newFloat(0), java.newFloat(1.6), java.newFloat(0)]))
          .addComments((new autoclass.CommentsBlock("set sound-ellipsoid location height at 1.6m to match typical avatar height")))
          .setSource((new autoclass.MovieTexture()).setDescription("mpgsys.mpg from ConformanceNist suite").setUrl(java.newArray("java.lang.String", ["mpgsys.mpg","http://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpgsys.mpg"]))
        ...
        .addChild((new autoclass.Group())
          .addComments((new autoclass.CommentsBlock("Test MFNode children array as an ordered list consisting of comments, statements, ProtoInstance and nodes")))
          .addChild((new autoclass.ProtoDeclare()).setName("NewWorldInfo")
            .setProtoInterface((new autoclass.ProtoInterface())
              .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFSTRING).setName("description").setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY)))
            .setProtoBody((new autoclass.ProtoBody())
              .addChild((new autoclass.WorldInfo()))))
          .addChild(ProtoInstance4 = (new autoclass.ProtoInstance()).setName("NewWorldInfo").setDEF("Proto1"))
          .addChild((new autoclass.Group()).setDEF("Node2")
            .addComments((new autoclass.CommentsBlock("intentionally empty"))))
          .addChild(ProtoInstance5 = (new autoclass.ProtoInstance()).setName("NewWorldInfo").setDEF("Proto3"))
          .addChild((new autoclass.Transform()).setDEF("Node4")
            .addComments((new autoclass.CommentsBlock("intentionally empty"))))
          .addComments((new autoclass.CommentsBlock("Test satisfactorily creates MFNode children array as an ordered list with mixed content"))))
        .addChild((new autoclass.ProtoDeclare()).setName("ShaderProto")
          .setProtoBody((new autoclass.ProtoBody())
            .addChild((new autoclass.ProgramShader()))))
        .addChild((new autoclass.Shape())
          .setAppearance((new autoclass.Appearance())
            .addComments((new autoclass.CommentsBlock("Test MFNode shaders array as an ordered list consisting of comments, ProtoInstance and nodes")))
            .addComments((new autoclass.CommentsBlock("Test satisfactorily creates MFNode shaders array as an ordered list with mixed content")))
            .addShaders((new autoclass.ProgramShader()).setDEF("TestShader1")
              .addPrograms((new autoclass.ShaderProgram()).setType("VERTEX").setDEF("TestShader2")))
            .addShaders(ProtoInstance6 = (new autoclass.ProtoInstance()).setName("ShaderProto").setDEF("TestShader3"))
            .addShaders((new autoclass.ComposedShader()).setDEF("TestShader4")
              .addParts((new autoclass.ShaderPart()).setType("VERTEX").setDEF("TestShader5"))))))      ;
ProtoInstance0

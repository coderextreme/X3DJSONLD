...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Background()).setDEF("background").setBackUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_back.png"])).setBottomUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_bottom.png"])).setFrontUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_front.png"])).setLeftUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_left.png"])).setRightUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_right.png"])).setTopUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_top.png"])))
          ...
          .addChild((new autoclass.Shape())
            .setAppearance((new autoclass.Appearance())
              ...
              .setTexture((new autoclass.ComposedCubeMapTexture()).setDEF("texture")
                .setBack((new autoclass.ImageTexture()).setDEF("backShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_back.png"])))
                .setBottom((new autoclass.ImageTexture()).setDEF("bottomShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_bottom.png"])))
                .setFront((new autoclass.ImageTexture()).setDEF("frontShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_front.png"])))
                .setLeft((new autoclass.ImageTexture()).setDEF("leftShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_left.png"])))
                .setRight((new autoclass.ImageTexture()).setDEF("rightShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_right.png"])))
                .setTop((new autoclass.ImageTexture()).setDEF("topShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_top.png"]))))
...
"        }"))
        .addComments((new autoclass.CommentsBlock("")))
        .addComments((new autoclass.CommentsBlock("            <TimeSensor DEF=\"Clock\" cycleInterval=\"45\" loop='true'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='Clock' fromField='fraction_changed' toNode='UrlSelector' toField='set_fraction'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='front' toNode='background' toField='frontUrl'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='back' toNode='background' toField='backUrl'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='left' toNode='background' toField='leftUrl'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='right' toNode='background' toField='rightUrl'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='top' toNode='background' toField='topUrl'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='bottom' toNode='background' toField='bottomUrl'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='front' toNode='frontShader' toField='url'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='back' toNode='backShader' toField='url'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='left' toNode='leftShader' toField='url'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='right' toNode='rightShader' toField='url'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='top' toNode='topShader' toField='url'/>")))
        .addComments((new autoclass.CommentsBlock("            <ROUTE fromNode='UrlSelector' fromField='bottom' toNode='bottomShader' toField='url'/>")))
        .addComments((new autoclass.CommentsBlock("	    ")))

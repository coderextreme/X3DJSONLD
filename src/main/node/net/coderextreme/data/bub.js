            ...
            .addChild((new autoclass.Transform()).setDEF("transform").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
              .addChild((new autoclass.Shape()).setDEF("myShape")
                .setAppearance((new autoclass.Appearance())
                  ...
                  .addComments((new autoclass.CommentsBlock("					<ComposedShader DEF='gl' language=\"GLSL\">")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='cube' type='SFInt32' accessType=\"inputOutput\" value='0'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='chromaticDispertion' type='SFVec3f' accessType=\"inputOutput\" value='0.98 1.0 1.033'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='bias' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='scale' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='power' type='SFFloat' accessType=\"inputOutput\" value='2.0'/>")))
                  .addComments((new autoclass.CommentsBlock("")))
                  .addComments((new autoclass.CommentsBlock("					  <ShaderPart url='\"../shaders/gl.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/gl.vs\"' type='VERTEX'></ShaderPart>")))
                  .addComments((new autoclass.CommentsBlock("					  <ShaderPart url='\"../shaders/pc_bubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_bubbles.fs\"' type='FRAGMENT'></ShaderPart>")))
                  .addComments((new autoclass.CommentsBlock("					</ComposedShader>")))
                  .addComments((new autoclass.CommentsBlock("					<ComposedShader DEF='freewrl' language=\"GLSL\">")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='fw_textureCoodGenType' type='SFInt32' accessType=\"inputOutput\" value='0'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='chromaticDispertion' type='SFVec3f' accessType=\"inputOutput\" value='0.98 1.0 1.033'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='bias' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='scale' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='power' type='SFFloat' accessType=\"inputOutput\" value='2.0'/>")))
                  .addComments((new autoclass.CommentsBlock("")))
                  .addComments((new autoclass.CommentsBlock("					  <ShaderPart url='\"../shaders/freewrl.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"' type='VERTEX'></ShaderPart>")))
                  .addComments((new autoclass.CommentsBlock("					  <ShaderPart url='\"../shaders/pc_bubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_bubbles.fs\"' type='FRAGMENT'></ShaderPart>")))
                  .addComments((new autoclass.CommentsBlock("					</ComposedShader>")))
                  .addComments((new autoclass.CommentsBlock("					")))
                  .addComments((new autoclass.CommentsBlock("")))
                  .addComments((new autoclass.CommentsBlock("					<ComposedShader DEF='instant' language=\"GLSL\">")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='cube' type='SFInt32' accessType=\"inputOutput\" value='0'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='chromaticDispertion' type='SFVec3f' accessType=\"inputOutput\" value='0.98 1.0 1.033'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='bias' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='scale' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>")))
                  .addComments((new autoclass.CommentsBlock("					  <field name='power' type='SFFloat' accessType=\"inputOutput\" value='2.0'/>")))
                  .addComments((new autoclass.CommentsBlock("")))
                  .addComments((new autoclass.CommentsBlock("			      <ShaderPart url='\"../shaders/instant.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/instant.vs\"' type='VERTEX'></ShaderPart>")))
                  .addComments((new autoclass.CommentsBlock("			      <ShaderPart url='\"../shaders/pc_bubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_bubbles.fs\"' type='FRAGMENT'></ShaderPart>")))
                  .addComments((new autoclass.CommentsBlock("                            </ComposedShader>")))
                  .addComments((new autoclass.CommentsBlock("                            ")))

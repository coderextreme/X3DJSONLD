...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("reference").setContent("https://en.wikipedia.org/wiki/Hello_world"))
        ...
        .addMeta(new autoclass.meta().setName("reference").setContent("https://www.HelloWorldExample.net"))
        ...
        .addMeta(new autoclass.meta().setName("reference").setContent("https://X3dGraphics.com/examples/X3dForAdvancedModeling/HelloWorldScenes/HelloWorld.x3d"))
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter01TechnicalOverview/HelloWorld.x3d"))
    ...
    X3D0.toFileJSON("../data/HelloWorld.new.node.x3dj");
    process.exit(0);

      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Group()).setBboxCenter(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setBboxSize(java.newArray("float", [java.newFloat(-1), java.newFloat(-1), java.newFloat(-1)]))
          ...
          .addChild((new autoclass.Sound()).setMaxBack(java.newFloat(100)).setMaxFront(java.newFloat(100)).setMinBack(java.newFloat(20)).setMinFront(java.newFloat(20))
            .setSource((new autoclass.AudioClip()).setDEF("AudioClip").setDescription("Chandubabamusic #1").setUrl(java.newArray("java.lang.String", ["../resources/chandubabamusic1.wav"])).setLoop(false).setPitch(java.newFloat(1)).setStartTime(0).setStopTime(0).setPauseTime(0).setResumeTime(0)))

...
var ProtoInstance6 = null;
      ...
      .setSceneSync(new autoclass.Scene()
        ...
        .addChildSync(new autoclass.Group()
          ...
          .addChildSync(new autoclass.TimeSensor().setDEFSync("SongTime").setLoopSync(true))
          .addChildSync(new autoclass.Sound().setMaxBackSync(java.newFloat(100)).setMaxFrontSync(java.newFloat(100)).setMinBackSync(java.newFloat(20)).setMinFrontSync(java.newFloat(20))
            .setSourceSync(new autoclass.AudioClip().setDEFSync("AudioClip").setDescriptionSync("Chandubabamusic #1").setUrlSync(java.newArray("java.lang.String", ["../resources/chandubabamusic1.wav"]))))
          .addChildSync(new autoclass.ROUTE().setFromFieldSync("cycleTime").setFromNodeSync("SongTime").setToFieldSync("startTime").setToNodeSync("AudioClip"))))      ;
ProtoInstance0
                  .addFieldValueSync(new autoclass.fieldValue().setNameSync("vertex").setValueSync("\"../shaders/x_ite_flowers_chromatic.vs\""));
ProtoInstance0

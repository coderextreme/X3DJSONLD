...
var ProtoInstance6 = null;
      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.Group()
          .addChild(new autoclass.ExternProtoDeclare().setName("FlowerProto").setUrl(java.newArray("java.lang.String", ["../data/flowerproto.x3d#FlowerProto","https://coderextreme.net/X3DJSONLD/src/main/data/flowerproto.x3d#FlowerProto"]))
...
ProtoInstance0
    ...
    X3D0.toFileJSON("../data/sphereflowers.new.node.x3dj");
    process.exit(0);

...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_whole.x3d"))
    ...
    X3D0.toFileX3D("../data/indexedfacesetPixeltexture_whole.new.node.x3d");
    X3D0.toFileJSON("../data/indexedfacesetPixeltexture_whole.new.node.x3dj");
    process.exit(0);

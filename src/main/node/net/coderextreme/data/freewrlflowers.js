...
var ProtoInstance6 = null;
      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.Viewpoint().setDescription("Tour Views").setPosition(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(50)])))
        ...
        .addChild(new autoclass.Group()
          .addChild(new autoclass.ExternProtoDeclare().setName("FlowerProto").setUrl(java.newArray("java.lang.String", ["../data/flowerprotofreewrl.x3d#FlowerProto","https://coderextreme.net/X3DJSONLD/src/main/data/flowerprotofreewrl.x3d#FlowerProto"]))
...
ProtoInstance0
    ...
    X3D0.toFileX3D("../data/freewrlflowers.new.node.x3d");
    X3D0.toFileJSON("../data/freewrlflowers.new.node.x3dj");
    process.exit(0);

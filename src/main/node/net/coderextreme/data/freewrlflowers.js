...
var ProtoInstance6 = null;
      ...
      .setHeadSync(new autoclass.head()
        ...
        .addMetaSync(new autoclass.meta().setNameSync("identifier").setContentSync("https://coderextreme.net/X3DJSONLD/src/main/data/freewrlflowers.x3d")))
      .setSceneSync(new autoclass.Scene()
        ...
        .addChildSync(new autoclass.Group()
          .addChildSync(new autoclass.ExternProtoDeclare().setNameSync("FlowerProto").setUrlSync(java.newArray("java.lang.String", ["../data/flowerproto.x3d#FlowerProto"]))
...
ProtoInstance0
                  .addFieldValueSync(new autoclass.fieldValue().setNameSync("vertex").setValueSync("\"../shaders/freewrl_flowers_chromatic.vs\""));
ProtoInstance0
                  .addFieldValueSync(new autoclass.fieldValue().setNameSync("fragment").setValueSync("\"../shaders/freewrl.fs\""));

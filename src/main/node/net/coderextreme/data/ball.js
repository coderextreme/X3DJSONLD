        ...
        .addChild((new autoclass.Transform())
          .addChild((new autoclass.Shape())
            ...
            .setAppearance((new autoclass.Appearance())
              ...
              .addComments((new autoclass.CommentsBlock("			<ShaderProgram url='\"../shaders/freewrl.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"' containerField='programs' type='VERTEX'>")))
              ...
              .addComments((new autoclass.CommentsBlock("			<ShaderProgram url='\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' containerField='programs' type='FRAGMENT'/>")))
              ...
              .addComments((new autoclass.CommentsBlock("		  <ShaderPart url='\"../shaders/contact.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/contact.vs\"' type=\"VERTEX\" containerField='parts'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("		  <ShaderPart url='\"../shaders/common.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>")))
              ...
              .addComments((new autoclass.CommentsBlock("		  <ShaderPart url='\"../shaders/octaga.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/octaga.vs\"' type=\"VERTEX\" containerField='parts'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("		  <ShaderPart url='\"../shaders/common.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("                </ComposedShader>")))
              .addComments((new autoclass.CommentsBlock("		")))
              .addComments((new autoclass.CommentsBlock("")))
              ...
              .addComments((new autoclass.CommentsBlock("		  <field name='scale' accessType='initializeOnly' type='SFFloat' value='0.5'></field>")))
              .addComments((new autoclass.CommentsBlock("		  <field name='power' accessType='initializeOnly' type='SFFloat' value='2'></field>")))
              .addComments((new autoclass.CommentsBlock("		  <ShaderPart url='\"../shaders/instant.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/instant.vs\"' type=\"VERTEX\" containerField='parts'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("		  <ShaderPart url='\"../shaders/common.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("                </ComposedShader>")))
              .addComments((new autoclass.CommentsBlock("		")))
              .addComments((new autoclass.CommentsBlock("")))

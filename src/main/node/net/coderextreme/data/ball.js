...
ConfigurationProperties.setStripDefaultAttributes(true);
        ...
        .addChild(new autoclass.Transform()
          .addChild(new autoclass.Shape()
            ...
            .setAppearance(new autoclass.Appearance()
              ...
              .addComments((new autoclass.CommentsBlock("<ProgramShader DEF='ProgramShader' containerField='shaders' language='GLSL'>")))
              .addComments((new autoclass.CommentsBlock("<ShaderProgram url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"' containerField='programs'>")))
              .addComments((new autoclass.CommentsBlock("<field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1 1.033'/>")))
              .addComments((new autoclass.CommentsBlock("<field name='bias' accessType='initializeOnly' type='SFFloat' value='0.5'/>")))
              .addComments((new autoclass.CommentsBlock("<field name='scale' accessType='initializeOnly' type='SFFloat' value='0.5'/>")))
              .addComments((new autoclass.CommentsBlock("<field name='power' accessType='initializeOnly' type='SFFloat' value='2'/>")))
              .addComments((new autoclass.CommentsBlock("</ShaderProgram>")))
              .addComments((new autoclass.CommentsBlock("<ShaderProgram url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' containerField='programs' type='FRAGMENT'/>")))
              .addComments((new autoclass.CommentsBlock("</ProgramShader>")))
              .addComments((new autoclass.CommentsBlock("<ComposedShader language='GLSL'>")))
              .addComments((new autoclass.CommentsBlock("<field name='chromaticDispertion' accessType='inputOutput' type='SFVec3f' value='0.98 1 1.033'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='cube' type='SFNode' accessType=\"inputOutput\">")))
              .addComments((new autoclass.CommentsBlock("<ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture>")))
              .addComments((new autoclass.CommentsBlock("</field>")))
              .addComments((new autoclass.CommentsBlock("<field name='bias' accessType='inputOutput' type='SFFloat' value='0.5'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='scale' accessType='inputOutput' type='SFFloat' value='0.5'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='power' accessType='inputOutput' type='SFFloat' value='2'></field>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"../shaders/castle.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart DEF='commonfs' url='\"../shaders/common.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\"' type='FRAGMENT'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("</ComposedShader>")))
              .addComments((new autoclass.CommentsBlock("<ComposedShader language='GLSL'>")))
              .addComments((new autoclass.CommentsBlock("<field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1 1.033'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='fw_Texture_unit0' type='SFNode' accessType=\"initializeOnly\">")))
              .addComments((new autoclass.CommentsBlock("<ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture>")))
              .addComments((new autoclass.CommentsBlock("</field>")))
              .addComments((new autoclass.CommentsBlock("<field name='bias' accessType='initializeOnly' type='SFFloat' value='0.5'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='scale' accessType='initializeOnly' type='SFFloat' value='0.5'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='power' accessType='initializeOnly' type='SFFloat' value='2'></field>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/contact.vs\"'></ShaderPart>")))
              ...
              .addComments((new autoclass.CommentsBlock("<field name='scale' accessType='inputOutput' type='SFFloat' value='0.5'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='power' accessType='inputOutput' type='SFFloat' value='2'></field>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/octaga.vs\"'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart USE='commonfs'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("</ComposedShader>")))
              .addComments((new autoclass.CommentsBlock("<ComposedShader language='GLSL'>")))
              .addComments((new autoclass.CommentsBlock("<field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1 1.033'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='cube' accessType='initializeOnly' type='SFInt32' value='0'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='bias' accessType='initializeOnly' type='SFFloat' value='0.5'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='scale' accessType='initializeOnly' type='SFFloat' value='0.5'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='power' accessType='initializeOnly' type='SFFloat' value='2'></field>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/instant.vs\"'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart USE='commonfs'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("</ComposedShader>")))
              .addComments((new autoclass.CommentsBlock("<ComposedShader language='GLSL'>")))
              .addComments((new autoclass.CommentsBlock("<field name='chromaticDispertion' accessType='inputOutput' type='SFVec3f' value='0.98 1 1.033'></field>")))
              ...
              .addComments((new autoclass.CommentsBlock("<field name='scale' accessType='inputOutput' type='SFFloat' value='0.5'></field>")))
              .addComments((new autoclass.CommentsBlock("<field name='power' accessType='inputOutput' type='SFFloat' value='2'></field>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom.vs\"'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart USE=\"commonfs\"></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("</ComposedShader>")))
    ...
    X3D0.toFileJSON("../data/ball.new.node.x3dj");
    process.exit(0);

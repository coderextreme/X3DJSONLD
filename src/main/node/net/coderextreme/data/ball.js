            ...
            .setAppearance((new autoclass.Appearance())
              ...
              .addShaders((new autoclass.ComposedShader()).setLanguage("GLSL")
                .addParts((new autoclass.ShaderPart())
                  .setSourceCode("../shaders/x3dom.vs"))
                .addParts((new autoclass.ShaderPart()).setType("FRAGMENT").setDEF("common")
                  .setSourceCode("../shaders/common.fs"))
              ...
              .addShaders((new autoclass.ComposedShader()).setLanguage("GLSL")
                .addParts((new autoclass.ShaderPart())
                  .setSourceCode("../shaders/x_ite.vs"))
                .addParts((new autoclass.ShaderPart()).setType("FRAGMENT")
                  .setSourceCode("../shaders/x_itebubbles.fs"))

      ...
      .setScene((new autoclass.Scene())
        .addChild((new autoclass.Transform())
          ...
          .addChild((new autoclass.Script())
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_MFSTRING).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setName("frontUrls").setValue("\"rnl_front.png\" \"uffizi_front.png\""))

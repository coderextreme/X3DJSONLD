                ...
                .addChild(new autoclass.Shape()
                  ...
                  .setAppearance(new autoclass.Appearance()
                    ...
                    .addShaders(new autoclass.ComposedShader().setDEF("freewrlShader").setLanguage("GLSL")
                      ...
                      .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"../shaders/freewrl.vs\"'></ShaderPart>")))
                      .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"../shaders/freewrl_bubbles.fs\"' type='FRAGMENT'></ShaderPart>"))))))))

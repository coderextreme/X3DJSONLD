...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Group()).setDEF("MultipleHumanoids")
          ...
          .addComments((new autoclass.CommentsBlock("==============================")))
          .addChild((new autoclass.HAnimHumanoid()).setName("SimpleSkeletonMesh").setDEF("b_SimpleSkeletonMesh").setVersion("2.0")
            .addSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setUlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setLlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
              .addChild((new autoclass.HAnimSegment()).setName("sacrum")
                .addChild((new autoclass.Shape())
                  .setGeometry((new autoclass.IndexedFaceSet()).setDEF("SegmentBoneMesh"))))))
          .addComments((new autoclass.CommentsBlock("==============================")))
          .addChild((new autoclass.HAnimHumanoid()).setName("SkinIndexedGeometry").setDEF("c_SkinIndexedGeometry").setVersion("2.0")
            .addSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setUlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setLlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
              .addChild((new autoclass.HAnimSegment()).setName("sacrum")))
            .addSkin((new autoclass.IndexedFaceSet()).setDEF("SkinMeshIFS")))
          .addComments((new autoclass.CommentsBlock("==============================")))
          .addChild((new autoclass.HAnimHumanoid()).setName("SkinShapeIndexedGeometry").setDEF("d_SkinShapeIndexedGeometry").setVersion("2.0")
            .addSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setUlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setLlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
              .addChild((new autoclass.HAnimSegment()).setName("sacrum")))
            .addSkin((new autoclass.Shape())
              .setGeometry((new autoclass.IndexedFaceSet()).setUSE("SkinMeshIFS"))))
          .addComments((new autoclass.CommentsBlock("==============================")))
          .addChild((new autoclass.HAnimHumanoid()).setName("SkinSwitchShapeIndexedGeometry").setDEF("e_SkinSwitchShapeIndexedGeometry").setVersion("2.0")
            .addSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setUlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setLlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
              .addChild((new autoclass.HAnimSegment()).setName("sacrum")))
            .addComments((new autoclass.CommentsBlock("TODO proposed for X3D4 <Switch DEF='AlternativeSkins' containerField='skin'>")))
            .addSkin((new autoclass.Shape())
            ...
            .addComments((new autoclass.CommentsBlock("TODO proposed for X3D4 </Switch>"))))
          .addComments((new autoclass.CommentsBlock("similarly for LOD")))
          .addComments((new autoclass.CommentsBlock("==============================")))
          .addChild((new autoclass.HAnimHumanoid()).setName("SynthesizedSkinShapeIndexedTwoPartGeometry").setDEF("f_SynthesizedSkinShapeIndexedTwoPartGeometry").setVersion("2.0")
            .addSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setUlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setLlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
              .addChild((new autoclass.HAnimSegment()).setName("sacrum")))
            .addSkin((new autoclass.Shape())
          ...
          .addComments((new autoclass.CommentsBlock("==============================")))
          .addChild((new autoclass.HAnimHumanoid()).setName("ApparelSkinIndexedGeometryMultipleShapes").setDEF("g_ApparelSkinIndexedGeometryMultipleShapes").setVersion("2.0")
            .addSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setUlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setLlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
              .addChild((new autoclass.HAnimSegment()).setName("sacrum")))
            .addSkin((new autoclass.Shape()))
          ...
          .addComments((new autoclass.CommentsBlock("==============================")))
          .addChild((new autoclass.HAnimHumanoid()).setName("AnatomySkinIndexedGeometryMultipleShapes").setDEF("h_AnatomySkinIndexedGeometryMultipleShapes").setVersion("2.0")
            .addSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setUlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setLlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
              .addChild((new autoclass.HAnimSegment()).setName("sacrum")))
            .addComments((new autoclass.CommentsBlock("allow multiple Shape nodes with containerField='skin', one for each layer of skin")))
            .addComments((new autoclass.CommentsBlock("TODO proposed for X3D4.1 <Shape containerField='skin'/>")))
            .addComments((new autoclass.CommentsBlock("TODO proposed for X3D4.1 <Shape containerField='skin'/>")))
            .addSkin((new autoclass.Shape())))
          .addComments((new autoclass.CommentsBlock("=============================="))))
    ...
    X3D0.toFileX3D("../data/DesignPatternsApparelMedicalSkinLayers.new.x3d");
    process.exit(0);

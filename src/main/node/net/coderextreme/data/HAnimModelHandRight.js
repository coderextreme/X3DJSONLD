        ...
        .addChild((new autoclass.HAnimHumanoid()).setName("Hand_Right").setDEF("hanim_Hand_Right").setLoa(4).setVersion("2.0")
          ...
          .setSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setDEF("hanim_humanoid_root")
            ...
            .addChild((new autoclass.HAnimJoint()).setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setDescription("connection joint of hand to leg above")
              ...
              .addChild((new autoclass.HAnimJoint()).setName("r_midcarpal_1").setDEF("hanim_r_midcarpal_1").setCenter(java.newArray("float", [java.newFloat(-0.1), java.newFloat(0.1), java.newFloat(0)]))
              ...
              .addChild((new autoclass.HAnimJoint()).setName("r_midcarpal_2").setDEF("hanim_r_midcarpal_2").setCenter(java.newArray("float", [java.newFloat(-0.1), java.newFloat(0.1), java.newFloat(0)]))

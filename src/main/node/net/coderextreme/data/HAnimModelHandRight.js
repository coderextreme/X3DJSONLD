      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.HAnimHumanoid()).setName("Hand_Right").setDEF("hanim_Hand_Right").setLoa(4).setVersion("2.0")
          ...
          .addSkeleton((new autoclass.HAnimJoint()).setName("humanoid_root").setDEF("hanim_humanoid_root").setUlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setLlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))
            ...
            .addChild((new autoclass.HAnimJoint()).setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setDescription("connection joint of hand to leg above").setUlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setLlimit(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)]))

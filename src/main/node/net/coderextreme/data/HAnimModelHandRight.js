...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.HAnimHumanoid()).setName("Humanoid_Right_hand").setDEF("Humanoid_Right_hand").setJointBindingPositions(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0)])).setJointBindingRotations(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(1), java.newFloat(0)])).setJointBindingScales(java.newArray("float", [java.newFloat(1), java.newFloat(1), java.newFloat(1)])).setVersion("2.0")

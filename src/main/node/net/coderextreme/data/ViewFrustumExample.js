...
var ProtoInstance0 = null;
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumExample.x3d"))
...
ProtoInstance0
    ...
    X3D0.toFileJSON("../data/ViewFrustumExample.new.node.x3dj");
    process.exit(0);

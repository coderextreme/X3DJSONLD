...
var ProtoInstance0 = null;
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Viewpoint()).setDescription("ViewFrustum from above, looking down").setPosition(java.newArray("float", [java.newFloat(0), java.newFloat(40), java.newFloat(0)])).setOrientation(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0), java.newFloat(-1.57)])))
        ...
        .addChild((new autoclass.Viewpoint()).setDescription("ViewFrustum oblique side view").setPosition(java.newArray("float", [java.newFloat(-5), java.newFloat(5), java.newFloat(20)])).setOrientation(java.newArray("float", [java.newFloat(0.8005), java.newFloat(0.5926), java.newFloat(0.0898), java.newFloat(-0.3743)])))
...
ProtoInstance0
          .addFieldValue((new autoclass.fieldValue()).setName("NavigationInfoNode")
            .addChild((new autoclass.NavigationInfo()).setDEF("_2").setVisibilityLimit(java.newFloat(15))));
ProtoInstance0
...
ProtoInstance0
          .addFieldValue((new autoclass.fieldValue()).setName("aspectRatio").setValue("0.75"));
ProtoInstance0

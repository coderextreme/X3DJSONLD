...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setScene(new autoclass.Scene()
        ...
        .addChild(new autoclass.Background().setFrontUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"])).setBackUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"])).setLeftUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"])).setRightUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"])).setTopUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"])).setBottomUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"])))
        .addChild(new autoclass.Transform()
          .addChild(new autoclass.ParticleSystem().setGeometryType("GEOMETRY").setMaxParticles(20)
            ...
            .setAppearance(new autoclass.Appearance()
              ...
              .addShaders(new autoclass.ComposedShader().setDEF("fw").setLanguage("GLSL")
                .addParts(new autoclass.ShaderPart().setUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs"])))
...
"			}")))
        ...
        .addChild(new autoclass.ROUTE().setFromNode("Animate").setFromField("a_changed").setToNode("fw").setToField("set_a"))
        .addChild(new autoclass.ROUTE().setFromNode("Animate").setFromField("b_changed").setToNode("fw").setToField("set_b"))
        .addChild(new autoclass.ROUTE().setFromNode("Animate").setFromField("c_changed").setToNode("fw").setToField("set_c"))
        .addChild(new autoclass.ROUTE().setFromNode("Animate").setFromField("d_changed").setToNode("fw").setToField("set_d"))
        .addChild(new autoclass.ROUTE().setFromNode("Animate").setFromField("pdelta_changed").setToNode("fw").setToField("set_pdelta"))
        .addChild(new autoclass.ROUTE().setFromNode("Animate").setFromField("tdelta_changed").setToNode("fw").setToField("set_tdelta")))      ;
    X3D0.toFileX3D("../data/fwparticleflowersTidy.new.node.x3d");
    X3D0.toFileJSON("../data/fwparticleflowersTidy.new.node.x3dj");
    process.exit(0);

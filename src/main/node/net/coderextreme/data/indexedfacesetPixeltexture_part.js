...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("Image").setContent("indexedfaceset_pixeltexture_part-rear.jpg"))
        .addMeta(new autoclass.meta().setName("Image").setContent("indexedfaceset_pixeltexture_part-top.jpg"))
        .addMeta(new autoclass.meta().setName("Image").setContent("indexedfaceset_pixeltexture_part-bottom.jpg"))
        .addMeta(new autoclass.meta().setName("Image").setContent("indexedfaceset_pixeltexture_part-left.jpg"))
        .addMeta(new autoclass.meta().setName("Image").setContent("indexedfaceset_pixeltexture_part-right.jpg"))
        ...
        .addMeta(new autoclass.meta().setName("description").setContent("Test of browser ability to map a partial portion of an PixelTexture onto an IndexedFaceSet geometry. Only the yellow portion of four equal sized red, green, yellow and white squares in the pixel texture map all the faces of the cube."))
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_part.x3d"))
      ...
      .setScene(new autoclass.Scene()
        ...
        .addComments((new autoclass.CommentsBlock("<Environment id=\"gamma\" gammaCorrectionDefault=\"none\"></Environment>")))
        .addChild(new autoclass.Shape()
          .setAppearance(new autoclass.Appearance()
            ...
            .setTexture(new autoclass.PixelTexture().setImage(java.newArray("int", [2,2,4,4278190335,16711935,4294967295,4294902015]))
              .setTextureProperties(new autoclass.TextureProperties().setMagnificationFilter("NEAREST_PIXEL"))))
          .setGeometry(new autoclass.IndexedFaceSet().setColorPerVertex(false).setCoordIndex(java.newArray("int", [0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1])).setCreaseAngle(java.newFloat(0.5)).setTexCoordIndex(java.newArray("int", [0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1]))
            ...
            .setTexCoord(new autoclass.TextureCoordinate().setPoint(java.newArray("float", [java.newFloat(0.5), java.newFloat(1), java.newFloat(0.5), java.newFloat(0.5), java.newFloat(1), java.newFloat(1), java.newFloat(1), java.newFloat(0.5)]))))))      ;
    X3D0.toFileX3D("../data/indexedfacesetPixeltexture_part.new.node.x3d");
    X3D0.toFileJSON("../data/indexedfacesetPixeltexture_part.new.node.x3dj");
    process.exit(0);

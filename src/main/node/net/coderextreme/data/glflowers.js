...
var ProtoInstance6 = null;
      ...
      .setHeadSync(new autoclass.head()
        .addMetaSync(new autoclass.meta().setNameSync("title").setContentSync("glflowers.x3d"))
        ...
        .addMetaSync(new autoclass.meta().setNameSync("identifier").setContentSync("https://coderextreme.net/X3DJSONLD/src/main/data/glflowers.x3d")))
...
ProtoInstance0
                  .addFieldValueSync(new autoclass.fieldValue().setNameSync("vertex").setValueSync("\"../shaders/gl_flowers_chromatic.vs\""));
ProtoInstance0

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Transform()).setDEF("TransformAudio1").setTranslation(java.newArray("float", [java.newFloat(-933.1235), java.newFloat(0), java.newFloat(-926.2532)]))
          .addChild((new autoclass.Shape())
          ...
          .addChild((new autoclass.Billboard())
            .addChild((new autoclass.Transform()).setDEF("violin").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(100), java.newFloat(0)])).setRotation(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0), java.newFloat(-0.5)])).setScale(java.newArray("float", [java.newFloat(100), java.newFloat(100), java.newFloat(100)]))
              .addChild((new autoclass.Shape())
                .setAppearance((new autoclass.Appearance())
                  .setMaterial((new autoclass.Material()).setAmbientIntensity(java.newFloat(0.0933)).setDiffuseColor(java.newArray("float", [java.newFloat(1), java.newFloat(1), java.newFloat(1)])).setSpecularColor(java.newArray("float", [java.newFloat(0.46), java.newFloat(0.46), java.newFloat(0.46)])).setShininess(java.newFloat(0.51))))
        ...
        .addChild((new autoclass.Transform()).setDEF("TransformAudio2").setTranslation(java.newArray("float", [java.newFloat(933.4756), java.newFloat(0), java.newFloat(924.4232)]))
          .addChild((new autoclass.Shape())
            ...
            .setGeometry((new autoclass.Sphere()).setRadius(java.newFloat(100))))
          .addChild((new autoclass.Billboard())
            .addChild((new autoclass.Transform()).setDEF("saxophone").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(100), java.newFloat(0)])).setRotation(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0), java.newFloat(-0.5)])).setScale(java.newArray("float", [java.newFloat(100), java.newFloat(100), java.newFloat(100)]))
              .addChild((new autoclass.Shape())
                .setAppearance((new autoclass.Appearance())
                  .setMaterial((new autoclass.Material()).setAmbientIntensity(java.newFloat(0.0933)).setDiffuseColor(java.newArray("float", [java.newFloat(1), java.newFloat(1), java.newFloat(1)])).setSpecularColor(java.newArray("float", [java.newFloat(0.46), java.newFloat(0.46), java.newFloat(0.46)])).setShininess(java.newFloat(0.51))))
        ...
        .addChild((new autoclass.StreamAudioDestination())
          .addChild((new autoclass.SpatialSound()).setDEF("Audio1")
            .addChild((new autoclass.Gain())
              .addChild((new autoclass.AudioClip()).setDescription("Violin").setUrl(java.newArray("java.lang.String", ["sound/violin.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/violin.mp3"])).setLoop(true))))
          .addChild((new autoclass.SpatialSound()).setDEF("Audio2")
            .addChild((new autoclass.Gain())
              .addChild((new autoclass.AudioClip()).setDescription("Saxophone").setUrl(java.newArray("java.lang.String", ["sound/saxophone.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/saxophone.mp3"])).setLoop(true)))))
        ...
        .addChild((new autoclass.ROUTE()).setFromNode("Camera001-POS-INTERP").setFromField("value_changed").setToNode("Camera001").setToField("position"))
        ...
        .addChild((new autoclass.ROUTE()).setFromNode("Camera001-ROT-INTERP").setFromField("value_changed").setToNode("Camera001").setToField("orientation")))      ;

...
ConfigurationProperties.setStripTrailingZeroesSync(true);
      ...
      .setHeadSync(new autoclass.head()
        ...
        .addMetaSync(new autoclass.meta().setNameSync("description").setContentSync("a mirrored sphere")))
      .setSceneSync(new autoclass.Scene()
        ...
        .addChildSync(new autoclass.Background().setDEFSync("cube").setLeftUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"])).setRightUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"])).setFrontUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"])).setBackUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"])).setTopUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"])).setBottomUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"])))
          ...
          .addChildSync(new autoclass.Shape()
            .setAppearanceSync(new autoclass.Appearance()
              ...
              .setTextureSync(new autoclass.ComposedCubeMapTexture()
                .setBackSync(new autoclass.ImageTexture().setDEFSync("backShader").setUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"])))
                .setBottomSync(new autoclass.ImageTexture().setDEFSync("bottomShader").setUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"])))
                .setFrontSync(new autoclass.ImageTexture().setDEFSync("frontShader").setUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"])))
                .setLeftSync(new autoclass.ImageTexture().setDEFSync("leftShader").setUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"])))
                .setRightSync(new autoclass.ImageTexture().setDEFSync("rightShader").setUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"])))
                .setTopSync(new autoclass.ImageTexture().setDEFSync("topShader").setUrlSync(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"]))))
...
"        }"))
          ...
          .addChildSync(new autoclass.ROUTE().setFromNodeSync("UrlSelector").setFromFieldSync("front_changed").setToNodeSync("cube").setToFieldSync("frontUrl"))
          .addChildSync(new autoclass.ROUTE().setFromNodeSync("UrlSelector").setFromFieldSync("back_changed").setToNodeSync("cube").setToFieldSync("backUrl"))
          .addChildSync(new autoclass.ROUTE().setFromNodeSync("UrlSelector").setFromFieldSync("left_changed").setToNodeSync("cube").setToFieldSync("leftUrl"))
          .addChildSync(new autoclass.ROUTE().setFromNodeSync("UrlSelector").setFromFieldSync("right_changed").setToNodeSync("cube").setToFieldSync("rightUrl"))
          .addChildSync(new autoclass.ROUTE().setFromNodeSync("UrlSelector").setFromFieldSync("top_changed").setToNodeSync("cube").setToFieldSync("topUrl"))
          .addChildSync(new autoclass.ROUTE().setFromNodeSync("UrlSelector").setFromFieldSync("bottom_changed").setToNodeSync("cube").setToFieldSync("bottomUrl"))

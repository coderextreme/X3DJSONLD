...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        .addChild((new autoclass.Viewpoint()).setDescription("Extrusion Heart").setPosition(java.newArray("float", [java.newFloat(0), java.newFloat(-4), java.newFloat(0)])).setOrientation(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0), java.newFloat(1.57)])))
        .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(-0.5), java.newFloat(0)]))
          .addChild((new autoclass.Shape())
            ...
            .setGeometry((new autoclass.Extrusion()).setSolid(false).setCreaseAngle(java.newFloat(3.14159)).setCrossSection(java.newArray("float", [java.newFloat(0), java.newFloat(0.8), java.newFloat(0.2), java.newFloat(1), java.newFloat(0.7), java.newFloat(0.95), java.newFloat(1), java.newFloat(0.5), java.newFloat(0.8), java.newFloat(0), java.newFloat(0.5), java.newFloat(-0.3), java.newFloat(0), java.newFloat(-0.7), java.newFloat(-0.5), java.newFloat(-0.3), java.newFloat(-0.8), java.newFloat(0), java.newFloat(-1), java.newFloat(0.5), java.newFloat(-0.7), java.newFloat(0.95), java.newFloat(-0.2), java.newFloat(1), java.newFloat(0), java.newFloat(0.8)])).setScale(java.newArray("float", [java.newFloat(0.01), java.newFloat(0.01), java.newFloat(0.8), java.newFloat(0.8), java.newFloat(1), java.newFloat(1), java.newFloat(0.8), java.newFloat(0.8), java.newFloat(0.01), java.newFloat(0.01)])).setSpine(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(0), java.newFloat(0), java.newFloat(0.1), java.newFloat(0), java.newFloat(0), java.newFloat(0.5), java.newFloat(0), java.newFloat(0), java.newFloat(0.9), java.newFloat(0), java.newFloat(0), java.newFloat(1), java.newFloat(0)]))))))      ;

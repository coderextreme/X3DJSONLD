...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        .addMeta((new autoclass.meta()).setContent("ExtrusionHeart.x3d").setName("title"))
        .addMeta((new autoclass.meta()).setContent("Simple extrusion of a Valentine heart.").setName("description"))
        .addMeta((new autoclass.meta()).setContent("Class participants in course Introduction to VRML/X3D.").setName("creator"))
        .addMeta((new autoclass.meta()).setContent("14 February 2001").setName("created"))
        .addMeta((new autoclass.meta()).setContent("27 November 2015").setName("modified"))
        .addMeta((new autoclass.meta()).setContent("http://www.web3d.org/x3d/content/examples/Basic/course/ExtrusionHeart.x3d").setName("identifier"))

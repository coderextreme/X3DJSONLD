...
var ProtoInstance9 = null;
      ...
      .setScene(new autoclass.Scene()
        .addChild(new autoclass.NavigationInfo().setType(java.newArray("java.lang.String", ["ANY","EXAMINE","WALK","FLY","LOOKAT"])))
...
ProtoInstance9
    ...
    X3D0.toFileJSON("../data/rubikFurnace.new.node.x3dj");
    process.exit(0);

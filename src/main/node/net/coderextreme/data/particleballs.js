        ...
        .addChild(new autoclass.Transform()
          .addChild(new autoclass.ParticleSystem().setMaxParticles(20).setGeometryType("GEOMETRY")
            ...
            .setAppearance(new autoclass.Appearance()
              ...
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' type='FRAGMENT'></ShaderPart>")))
              .addComments((new autoclass.CommentsBlock("</ComposedShader>")))
              .addComments((new autoclass.CommentsBlock("<ComposedShader DEF=\"shader\" language=\"GLSL\">")))
              .addComments((new autoclass.CommentsBlock("<field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field>")))
              ...
              .addComments((new autoclass.CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/>")))
              .addComments((new autoclass.CommentsBlock("<ShaderPart type='FRAGMENT' url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/>")))
              .addComments((new autoclass.CommentsBlock("</ComposedShader>")))

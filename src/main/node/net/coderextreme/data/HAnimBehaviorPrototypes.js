...
ProtoInstance1
          .addFieldValue(new autoclass.fieldValue().setName("hAnimBehaviorNodes")
            .addChild(ProtoInstance2 = new autoclass.ProtoInstance().setName("HAnimBehavior").setUSE("BehaviorTest1")));
ProtoInstance1
    ...
    X3D0.toFileJSON("../data/HAnimBehaviorPrototypes.new.node.x3dj");
    process.exit(0);

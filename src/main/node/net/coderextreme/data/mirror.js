...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.TextureBackground())
          .setLeftTexture((new autoclass.ImageTexture()).setDEF("leftBack").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/images/all_probes/beach_cross/beach_left.png"])))
          .setRightTexture((new autoclass.ImageTexture()).setDEF("rightBack").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/images/all_probes/beach_cross/beach_right.png"])))
          .setFrontTexture((new autoclass.ImageTexture()).setDEF("frontBack").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/images/all_probes/beach_cross/beach_front.png"])))
          .setBackTexture((new autoclass.ImageTexture()).setDEF("backBack").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/images/all_probes/beach_cross/beach_back.png"])))
          .setTopTexture((new autoclass.ImageTexture()).setDEF("topBack").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/images/all_probes/beach_cross/beach_top.png"])))
          .setBottomTexture((new autoclass.ImageTexture()).setDEF("bottomBack").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/images/all_probes/beach_cross/beach_bottom.png"]))))
          ...
          .addChild((new autoclass.Shape())
            .setAppearance((new autoclass.Appearance())
              ...
              .setTexture((new autoclass.ComposedCubeMapTexture())
                .setBackTexture((new autoclass.ImageTexture()).setDEF("backShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/images/all_probes/beach_cross/beach_back.png"])))
                .setBottomTexture((new autoclass.ImageTexture()).setDEF("bottomShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/images/all_probes/beach_cross/beach_bottom.png"])))
                .setFrontTexture((new autoclass.ImageTexture()).setDEF("frontShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/images/all_probes/beach_cross/beach_front.png"])))
                .setLeftTexture((new autoclass.ImageTexture()).setDEF("leftShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/images/all_probes/beach_cross/beach_left.png"])))
                .setRightTexture((new autoclass.ImageTexture()).setDEF("rightShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/images/all_probes/beach_cross/beach_right.png"])))
                .setTopTexture((new autoclass.ImageTexture()).setDEF("topShader").setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/images/all_probes/beach_cross/beach_top.png"]))))
              ...
              .addShaders((new autoclass.ComposedShader()).setDEF("x_ite").setLanguage("GLSL")
                ...
                .addParts((new autoclass.ShaderPart()).setType("FRAGMENT").setUrl(java.newArray("java.lang.String", ["../shaders/mix.fs","https://coderextreme.net/X3DJSONLD/src/main/src/main/shaders/mix.fs"])))))

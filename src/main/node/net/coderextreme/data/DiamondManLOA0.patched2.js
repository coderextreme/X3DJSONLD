...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("modified").setContent("Sat, 30 Dec 2023 07:36:14 GMT"))
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.NavigationInfo()).setSpeed(java.newFloat(1.5f)))
        .addChild((new autoclass.Viewpoint()).setDescription("Diamond Man, LOA 0").setPosition(java.newArray("float", [java.newFloat(0f), java.newFloat(1f), java.newFloat(3f)])).setCenterOfRotation(java.newArray("float", [java.newFloat(0f), java.newFloat(1f), java.newFloat(0f)])))
        .addChild((new autoclass.HAnimHumanoid()).setDEF("hanim_humanoid").setName("humanoid").setLoa(0)
          ...
          .addSkeleton((new autoclass.HAnimJoint()).setDEF("hanim_humanoid_root").setName("humanoid_root").setCenter(java.newArray("float", [java.newFloat(0f), java.newFloat(0.824f), java.newFloat(0.0277f)]))
            .addChild((new autoclass.HAnimJoint()).setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(java.newArray("float", [java.newFloat(0f), java.newFloat(0.9149f), java.newFloat(0.0016f)]))
              .addChild((new autoclass.HAnimSegment()).setDEF("hanim_pelvis").setName("pelvis")
                .addChild((new autoclass.Transform()).setTranslation(java.newArray("float", [java.newFloat(0f), java.newFloat(0.9149f), java.newFloat(0.0016f)]))
                  .addChild((new autoclass.Shape()).setDEF("DiamondShape")
                    .setAppearance((new autoclass.Appearance())
                      .setMaterial((new autoclass.Material()).setDiffuseColor(java.newArray("float", [java.newFloat(1f), java.newFloat(1f), java.newFloat(0f)]))))
                    .setGeometry((new autoclass.IndexedFaceSet()).setCreaseAngle(java.newFloat(0.5f)).setCoordIndex(java.newArray("int", [0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,1,-1,5,2,1,-1,5,3,2,-1,5,4,3,-1,5,1,4,-1]))
                      .setCoord((new autoclass.Coordinate()).setPoint(java.newArray("float", [java.newFloat(0f), java.newFloat(0.01f), java.newFloat(0f), java.newFloat(-0.01f), java.newFloat(0f), java.newFloat(0f), java.newFloat(0f), java.newFloat(0f), java.newFloat(0.01f), java.newFloat(0.01f), java.newFloat(0f), java.newFloat(0f), java.newFloat(0f), java.newFloat(0f), java.newFloat(-0.01f), java.newFloat(0f), java.newFloat(-0.01f), java.newFloat(0f)])))))))))
          .addViewpoints((new autoclass.HAnimSite()).setDEF("hanim_site_view").setName("site_view")
            .addChild((new autoclass.Viewpoint()).setDEF("InclinedView").setDescription("Inclined View").setPosition(java.newArray("float", [java.newFloat(1.62f), java.newFloat(1.05f), java.newFloat(2.06f)])).setOrientation(java.newArray("float", [java.newFloat(-0.113f), java.newFloat(0.993f), java.newFloat(0.0347f), java.newFloat(0.671f)])))
            .addChild((new autoclass.Viewpoint()).setDEF("FrontView").setDescription("Front View").setPosition(java.newArray("float", [java.newFloat(0f), java.newFloat(0.854f), java.newFloat(2.57665f)])))
            .addChild((new autoclass.Viewpoint()).setDEF("SideView").setDescription("Side View").setPosition(java.newArray("float", [java.newFloat(2.5929f), java.newFloat(0.854f), java.newFloat(0f)])).setOrientation(java.newArray("float", [java.newFloat(0f), java.newFloat(1f), java.newFloat(0f), java.newFloat(1.57079f)])))
            .addChild((new autoclass.Viewpoint()).setDEF("TopView").setDescription("Top View").setPosition(java.newArray("float", [java.newFloat(0f), java.newFloat(3.4495f), java.newFloat(0f)])).setOrientation(java.newArray("float", [java.newFloat(1f), java.newFloat(0f), java.newFloat(0f), java.newFloat(-1.57079f)]))))
    ...
    X3D0.toFileX3D("../data/DiamondManLOA0.patched2.new.node.x3d");
    process.exit(0);

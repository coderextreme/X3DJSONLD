...
ConfigurationProperties.setStripTrailingZeroesSync(true);
      ...
      .setHeadSync(new autoclass.head()
        .addMetaSync(new autoclass.meta().setNameSync("title").setContentSync("flower3.x3d"))
        ...
        .addMetaSync(new autoclass.meta().setNameSync("identifier").setContentSync("https://coderextreme.net/X3DJSONLD/src/main/data/flower3.x3d"))

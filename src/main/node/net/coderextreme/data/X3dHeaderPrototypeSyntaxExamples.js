...
var ProtoInstance3 = null;
      ...
      .setHead((new autoclass.head())
        .addComponent((new autoclass.component()).setLevel(1).setName("Geospatial"))
        .addComponent((new autoclass.component()).setLevel(2).setName("NURBS"))
        .addComponent((new autoclass.component()).setLevel(2).setName("Core"))
        .addComponent((new autoclass.component()).setLevel(1).setName("Navigation"))
        .addComponent((new autoclass.component()).setLevel(1).setName("Text"))
        .addMeta((new autoclass.meta()).setContent("X3dHeaderPrototypeSyntaxExamples.x3d").setName("title"))
        .addMeta((new autoclass.meta()).setContent("X3D scene header and prototype syntax examples. This example header indicates that the content is XML encoded, follows the Interactive Profile and explicitly lists additional necessary components. The X3D header may also contain additional semantic information. Used for specification EXAMPLE excerpts in 19776:1 XML Encoding.").setName("description"))
        .addMeta((new autoclass.meta()).setContent("14 October 2002").setName("created"))
        .addMeta((new autoclass.meta()).setContent("27 May 2017").setName("modified"))
        .addMeta((new autoclass.meta()).setContent("Don Brutzman").setName("creator"))
        .addMeta((new autoclass.meta()).setContent("X3D encodings, ISO/IEC 19776-1.3, Part 1: XML encoding, 4.3 XML file syntax").setName("specificationSection"))
        .addMeta((new autoclass.meta()).setContent("http://www.web3d.org/documents/specifications/19776-1/V3.3/Part01/concepts.html#XMLFileSyntax").setName("specificationUrl"))
        .addMeta((new autoclass.meta()).setContent("http://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/X3dHeaderPrototypeSyntaxExamples.x3d").setName("identifier"))
      ...
      .setScene((new autoclass.Scene())
        .addChild((new autoclass.ExternProtoDeclare()).setName("ViewPositionOrientation").setUrl(java.newArray("java.lang.String", ["../../Savage/Tools/Authoring/ViewPositionOrientationPrototype.x3d#ViewPositionOrientation","https://savage.nps.edu/Savage/Tools/Authoring/ViewPositionOrientationPrototype.x3d#ViewPositionOrientation","../../Savage/Tools/Authoring/ViewPositionOrientationPrototype.wrl#ViewPositionOrientation","https://savage.nps.edu/Savage/Tools/Authoring/ViewPositionOrientationPrototype.wrl#ViewPositionOrientation"]))
          ...
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INPUTONLY).setName("set_traceEnabled"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFVEC3F).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setName("position_changed"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFROTATION).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setName("orientation_changed"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_MFSTRING).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setName("outputViewpointString")))
        ...
        .addChild((new autoclass.ProtoDeclare()).setName("EmissiveMaterial")
          .setProtoInterface((new autoclass.ProtoInterface())
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFCOLOR).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("onlyColor").setValue("1 0 0")))
          .setProtoBody((new autoclass.ProtoBody())
        ...
        .addChild((new autoclass.Inline()).setDEF("someInline").setUrl(java.newArray("java.lang.String", ["someUrl.x3d","http://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/someUrl.x3d"])))

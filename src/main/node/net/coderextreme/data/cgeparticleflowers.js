          ...
          .addChild(new autoclass.ParticleSystem().setMaxParticles(20).setGeometryType("GEOMETRY")
            ...
            .setAppearance(new autoclass.Appearance()
              ...
              .setTexture(new autoclass.ComposedCubeMapTexture().setDEF("texture")
                ...
                .setFrontTexture(new autoclass.ImageTexture().setUrl(java.newArray("java.lang.String", ["../resources/images/all_probes/stpeters_cross/stpeters_from.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"])))
              ...
              .addShaders(new autoclass.ComposedShader().setDEF("shader").setLanguage("GLSL")
                ...
                .addComments((new autoclass.CommentsBlock("<field name='cube' type='SFNode' accessType=\"initializeOnly\">")))
...
"			}"))
    ...
    X3D0.toFileX3D("../data/cgeparticleflowers.new.node.x3d");
    X3D0.toFileJSON("../data/cgeparticleflowers.new.node.x3dj");
    process.exit(0);

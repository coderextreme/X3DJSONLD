...
var ProtoInstance6 = null;
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Transform()).setDEF("LogoGeometryTransform").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(1.5), java.newFloat(0)]))
          .addChild((new autoclass.Anchor()).setDEF("siteAnchor").setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(java.newArray("java.lang.String", ["../X3DJSAIL.html","https://www.web3d.org/specifications/java/X3DJSAIL.html"]))
          ...
          .addChild((new autoclass.Shape())
            ...
            .setGeometry((new autoclass.Text()).setString(java.newArray("java.lang.String", ["X3D Java","SAI Library","X3DJSAIL"]))
              ...
              .setMetadata((new autoclass.MetadataSet()).setName("EscapedQuotationMarksMetadataSet")
                ...
                .addValue((new autoclass.MetadataString()).setName("extraChildTest").setValue(java.newArray("java.lang.String", ["checks MetadataSet addValue() method"]))))
...
"}"))
        ...
        .addChild((new autoclass.ExternProtoDeclare()).setName("ArtDeco02Material").setAppinfo("this is a different Material node").setUrl(java.newArray("java.lang.String", ["https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02Material","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02Material"]))
        ...
        .addChild((new autoclass.Inline()).setDEF("inlineScene").setUrl(java.newArray("java.lang.String", ["someOtherScene.x3d","https://www.web3d.org/specifications/java/examples/someOtherScene.x3d"])))
        .addChild((new autoclass.IMPORT()).setAS("WorldInfoDEF2").setImportedDEF("WorldInfoDEF").setInlineDEF("inlineScene"))
...
"}"))))
        ...
        .addChild((new autoclass.Group()).setDEF("TestFieldObjectsGroup")
          ...
          .addComments((new autoclass.CommentsBlock("SFBool default=false, true=true, false=false, negate()=true")))
          ...
          .addComments((new autoclass.CommentsBlock("regex test SFVec3f().matches(\"1 2 3\")=true, regex test SFVec3f().matches(\"1 2 3 4\")=false, regex test (SFRotation.matches(\"0 0 0 0\")=true, failure detecting illegal (zero axis) rotation value"))))
        ...
        .addChild((new autoclass.Sound()).setLocation(java.newArray("float", [java.newFloat(0), java.newFloat(1.6), java.newFloat(0)]))
          ...
          .setSource((new autoclass.MovieTexture()).setDescription("mpgsys.mpg from ConformanceNist suite").setUrl(java.newArray("java.lang.String", ["mpgsys.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpgsys.mpg"]))
            ...
            .addComments((new autoclass.CommentsBlock("Expected containerField='source', allowed containerField values=\"texture\" \"source\" \"back\" \"bottom\" \"front\" \"left\" \"right\" \"top\" \"backTexture\" \"bottomTexture\" \"frontTexture\" \"leftTexture\" \"rightTexture\" \"topTexture\" \"children\"")))))
        .addComments((new autoclass.CommentsBlock("Test success: Anchor.isNode()=true, siteAnchor.isNode()=true")))
        .addComments((new autoclass.CommentsBlock("Test success: Anchor.isStatement()=false, siteAnchor.isStatement()=false")))
        .addComments((new autoclass.CommentsBlock("Test success: ROUTE.isNode()=false, orbitPositionROUTE.isNode()=false")))
        .addComments((new autoclass.CommentsBlock("Test success: ROUTE.isStatement()=true, orbitPositionROUTE.isStatement()=true")))
        ...
        .addChild((new autoclass.Transform()).setDEF("SpecialtyNodes")
        ...
        .addChild((new autoclass.LoadSensor())
          .addComments((new autoclass.CommentsBlock("Contained nodes typically must be USE references for nodes previously DEFined in the scene")))
          .addComments((new autoclass.CommentsBlock("The following nodes are test cases for all X3DUrlObject nodes")))
          .addChild((new autoclass.Anchor()).setUSE("siteAnchor"))
          .addChild((new autoclass.Inline()).setUSE("inlineScene"))
          .addChild((new autoclass.DISEntityTypeMapping()))
          ...
          .addChild((new autoclass.ShaderPart()).setType("VERTEX"))
          .addChild((new autoclass.ShaderProgram()).setType("VERTEX"))))      ;
ProtoInstance0

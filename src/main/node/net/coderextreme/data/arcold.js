...
ProtoInstance4
          .addFieldValue(new autoclass.fieldValue().setName("startnode")
            .addChild(ProtoInstance5 = new autoclass.ProtoInstance().setName("point").setUSE("G1")));
ProtoInstance4
          .addFieldValue(new autoclass.fieldValue().setName("endnode")
            .addChild(ProtoInstance6 = new autoclass.ProtoInstance().setName("point").setUSE("G2")));
ProtoInstance4
...
ProtoInstance7
          .addFieldValue(new autoclass.fieldValue().setName("startnode")
            .addChild(ProtoInstance8 = new autoclass.ProtoInstance().setName("point").setUSE("G1")));
ProtoInstance7
          .addFieldValue(new autoclass.fieldValue().setName("endnode")
            .addChild(ProtoInstance9 = new autoclass.ProtoInstance().setName("point").setUSE("G3")));
ProtoInstance7
          .addFieldValue(new autoclass.fieldValue().setName("transnode")
...
ProtoInstance10
          .addFieldValue(new autoclass.fieldValue().setName("startnode")
            .addChild(ProtoInstance11 = new autoclass.ProtoInstance().setName("point").setUSE("G1")));
ProtoInstance10
          .addFieldValue(new autoclass.fieldValue().setName("endnode")
            .addChild(ProtoInstance12 = new autoclass.ProtoInstance().setName("point").setUSE("G4")));
ProtoInstance10
          .addFieldValue(new autoclass.fieldValue().setName("transnode")
...
ProtoInstance10
    ...
    X3D0.toFileJSON("../data/arcold.new.node.x3dj");
    process.exit(0);

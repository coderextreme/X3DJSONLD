...
var ProtoInstance12 = null;
      ...
      .setScene((new autoclass.Scene())
        .addChild((new autoclass.Viewpoint()).setPosition(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(5)])).setOrientation(java.newArray("float", [java.newFloat(0), java.newFloat(0), java.newFloat(1), java.newFloat(0)])).setDescription("a moving graph"))
...
"		}"))
        ...
        .addChild((new autoclass.ProtoDeclare()).setName("x3dconnector")
          .setProtoInterface((new autoclass.ProtoInterface())
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("startnode"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("endnode"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("transnode"))
            .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFNODE).setAccessType(autoclass.field.ACCESSTYPE_INPUTOUTPUT).setName("rotscalenode"))
...
"        }"))))
        .addChild(ProtoInstance0 = (new autoclass.ProtoInstance()).setDEF("G1").setName("point"))
        .addChild(ProtoInstance1 = (new autoclass.ProtoInstance()).setDEF("G2").setName("point"))
        .addChild(ProtoInstance2 = (new autoclass.ProtoInstance()).setDEF("G3").setName("point"))
        .addChild(ProtoInstance3 = (new autoclass.ProtoInstance()).setDEF("G4").setName("point"))

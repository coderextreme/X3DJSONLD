...
"}"))
            ...
            .addChild((new autoclass.ROUTE()).setFromNode("bounce1").setFromField("translation").setToNode("body_trans").setToField("translation"))
            .addChild((new autoclass.ROUTE()).setFromNode("bounce1").setFromField("scale").setToNode("body_trans").setToField("scale"))
        ...
        .addChild((new autoclass.Viewpoint()).setDescription("Bubbles in action").setPosition(java.newArray("float", [java.newFloat(0f), java.newFloat(0f), java.newFloat(4f)])))
        ...
        .addChild(ProtoInstance1 = (new autoclass.ProtoInstance()).setDEF("bubbleB").setName("Bubble"))
        .addChild(ProtoInstance2 = (new autoclass.ProtoInstance()).setDEF("bubbleC").setName("Bubble"))
        .addChild(ProtoInstance3 = (new autoclass.ProtoInstance()).setDEF("bubbleD").setName("Bubble")))      ;

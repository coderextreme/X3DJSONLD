...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("title").setContent("skeleton2.x3d"))
        .addMeta((new autoclass.meta()).setName("identifier").setContent("http://www.web3d.org/x3d/content/examples/HumanoidAnimation/skeleton2.x3d"))
    ...
    X3D0.toFileX3D("../data/skeleton2.new.x3d");
    process.exit(0);

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Viewpoint()).setDescription("View entire audio model").setPosition(java.newArray("float", [java.newFloat(0), java.newFloat(500), java.newFloat(600)])).setOrientation(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0), java.newFloat(-0.5)])).setRetainUserOffsets(true))
        .addChild((new autoclass.Transform()).setDEF("TransformAudio1").setTranslation(java.newArray("float", [java.newFloat(-200), java.newFloat(50), java.newFloat(0)]))
          .addChild((new autoclass.Shape())
            .setAppearance((new autoclass.Appearance()).setDEF("audio_emit")
              .setMaterial((new autoclass.Material()).setDiffuseColor(java.newArray("float", [java.newFloat(0.1), java.newFloat(0.1), java.newFloat(0.1)])).setSpecularColor(java.newArray("float", [java.newFloat(0.01), java.newFloat(0.01), java.newFloat(0.01)])).setEmissiveColor(java.newArray("float", [java.newFloat(0.8), java.newFloat(0.8), java.newFloat(0.8)]))))
        ...
        .addChild((new autoclass.Transform())
          .addChild((new autoclass.Shape())
            .setAppearance((new autoclass.Appearance()).setDEF("floor")
              .setMaterial((new autoclass.Material()).setDiffuseColor(java.newArray("float", [java.newFloat(0.1), java.newFloat(0.1), java.newFloat(0.1)])).setSpecularColor(java.newArray("float", [java.newFloat(0.5), java.newFloat(0.6), java.newFloat(0.7)])).setShininess(java.newFloat(0.8))))
                ...
                .addChild((new autoclass.Gain())
                  .addChild((new autoclass.Analyser())
                    .addChild((new autoclass.BiquadFilter()).setType(autoclass.field.TYPE_ALLPASS).setDetune(java.newFloat(50)).setFrequency(java.newFloat(600)).setQualityFactor(java.newFloat(30))
                      .addChild((new autoclass.AudioClip()).setDescription("Techno beat").setUrl(java.newArray("java.lang.String", ["sound/techno_beat.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/techno_beat.mp3"])).setLoop(true))))))
                ...
                .addChild((new autoclass.Gain())
                  .addChild((new autoclass.Analyser())
                    .addChild((new autoclass.BiquadFilter()).setType(autoclass.field.TYPE_ALLPASS).setDetune(java.newFloat(15)).setFrequency(java.newFloat(600)).setQualityFactor(java.newFloat(15))
                      .addChild((new autoclass.AudioClip()).setDescription("Simple beat").setUrl(java.newArray("java.lang.String", ["sound/beat.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/beat.mp3"])).setLoop(true))))))
                ...
                .addChild((new autoclass.Gain())
                  .addChild((new autoclass.Analyser())
                    .addChild((new autoclass.BiquadFilter()).setType(autoclass.field.TYPE_ALLPASS).setFrequency(java.newFloat(1000)).setQualityFactor(java.newFloat(0))
                      .addChild((new autoclass.AudioClip()).setDescription("Wobble loop").setUrl(java.newArray("java.lang.String", ["sound/wobble_loop.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/wobble_loop.mp3"])).setLoop(true))))))))))      ;

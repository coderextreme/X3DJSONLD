...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Transform()).setDEF("Audio1").setTranslation(java.newArray("float", [java.newFloat(-200), java.newFloat(50), java.newFloat(0)]))
        ...
        .addChild((new autoclass.Transform()).setDEF("Audio2").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(50), java.newFloat(0)]))
          .addChild((new autoclass.Shape())
            .setAppearance((new autoclass.Appearance()).setDEF("audio_emit")
              .setMaterial((new autoclass.Material()).setDiffuseColor(java.newArray("float", [java.newFloat(0.1), java.newFloat(0.1), java.newFloat(0.1)])).setEmissiveColor(java.newArray("float", [java.newFloat(0.8), java.newFloat(0.8), java.newFloat(0.8)])).setSpecularColor(java.newArray("float", [java.newFloat(0.01), java.newFloat(0.01), java.newFloat(0.01)]))))
            .setGeometry((new autoclass.Sphere()).setRadius(java.newFloat(30)))))
        .addChild((new autoclass.Transform()).setDEF("Audio3").setTranslation(java.newArray("float", [java.newFloat(200), java.newFloat(50), java.newFloat(0)]))
          .addChild((new autoclass.Shape())
            .setAppearance((new autoclass.Appearance()).setDEF("audio_emit")
              .setMaterial((new autoclass.Material()).setDiffuseColor(java.newArray("float", [java.newFloat(0.1), java.newFloat(0.1), java.newFloat(0.1)])).setEmissiveColor(java.newArray("float", [java.newFloat(0.8), java.newFloat(0.8), java.newFloat(0.8)])).setSpecularColor(java.newArray("float", [java.newFloat(0.01), java.newFloat(0.01), java.newFloat(0.01)]))))
            .setGeometry((new autoclass.Sphere()).setRadius(java.newFloat(30)))))
        ...
        .addChild((new autoclass.AudioDestination()).setChannelCountMode("MAX")
          .addChild((new autoclass.DynamicsCompressor()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
            .addChild((new autoclass.Gain()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
              .addChild((new autoclass.SpatialSound()).setUSE("Audio1")
                .addChild((new autoclass.Gain()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                  .addChild((new autoclass.Analyser()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                    .addChild((new autoclass.BiquadFilter()).setType(autoclass.field.TYPE_ALLPASS).setDetune(java.newFloat(50)).setFrequency(java.newFloat(600)).setQualityFactor(java.newFloat(30)).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                      .addChild((new autoclass.AudioClip()).setLoop(true).setPauseTime(-1).setResumeTime(-1).setStopTime(-1).setUrl(java.newArray("java.lang.String", ["sound/techno_beat.mp3"])))))))
              .addChild((new autoclass.SpatialSound()).setUSE("Audio2")
                .addChild((new autoclass.Gain()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                  .addChild((new autoclass.Analyser()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                    .addChild((new autoclass.BiquadFilter()).setType(autoclass.field.TYPE_ALLPASS).setDetune(java.newFloat(15)).setFrequency(java.newFloat(600)).setQualityFactor(java.newFloat(15)).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                      .addChild((new autoclass.AudioClip()).setLoop(true).setPauseTime(-1).setResumeTime(-1).setStopTime(-1).setUrl(java.newArray("java.lang.String", ["sound/beat.mp3"])))))))
              .addChild((new autoclass.SpatialSound()).setUSE("Audio3")
                .addChild((new autoclass.Gain()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                  .addChild((new autoclass.Analyser()).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                    .addChild((new autoclass.BiquadFilter()).setType(autoclass.field.TYPE_ALLPASS).setFrequency(java.newFloat(1000)).setQualityFactor(java.newFloat(0)).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")

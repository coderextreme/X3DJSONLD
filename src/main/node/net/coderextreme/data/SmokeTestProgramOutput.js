...
var ProtoInstance6 = null;
      ...
      .addComments((new autoclass.CommentsBlock("X3D model top-level comment")))
      .setHead(new autoclass.head()
        ...
        .addMeta(new autoclass.meta().setName("title").setContent("SmokeTestProgramOutput.x3d"))
        .addMeta(new autoclass.meta().setName("info").setContent("continued development and testing in progress"))
        .addMeta(new autoclass.meta().setName("description").setContent("Example SmokeTestProgram creates an X3D model using the X3D Java Scene Access Interface Library (X3DJSAIL)"))
        .addMeta(new autoclass.meta().setName("reference").setContent("https://www.web3d.org/specifications/java/X3DJSAIL.html"))
        .addMeta(new autoclass.meta().setName("generator").setContent("SmokeTestProgramOutput.java"))
        .addMeta(new autoclass.meta().setName("created").setContent("6 September 2016"))
        .addMeta(new autoclass.meta().setName("modified").setContent("20 June 2026"))
        .addMeta(new autoclass.meta().setName("generator").setContent("X3D Java Scene Access Interface Library (X3DJSAIL)"))
        .addMeta(new autoclass.meta().setName("generator").setContent("https://www.web3d.org/specifications/java/examples/SmokeTestProgram.java"))
        .addMeta(new autoclass.meta().setName("generator").setContent("Netbeans https://www.netbeans.org"))
        .addMeta(new autoclass.meta().setName("creator").setContent("Don Brutzman"))
        .addMeta(new autoclass.meta().setName("reference").setContent("https://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/java/examples/SmokeTestProgramOutput.x3d"))
        ...
        .addMeta(new autoclass.meta().setName("reference").setContent("SmokeTestProgramOutput.txt"))
        .addMeta(new autoclass.meta().setName("reference").setContent("SmokeTestProgramOutput.x3dv"))
        .addMeta(new autoclass.meta().setName("reference").setContent("SmokeTestProgramOutput.wrl"))
        .addMeta(new autoclass.meta().setName("reference").setContent("SmokeTestProgramOutput.html"))
        .addMeta(new autoclass.meta().setName("reference").setContent("https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/SmokeTestProgramOutput.x3d"))
        .addMeta(new autoclass.meta().setName("identifier").setContent("https://www.web3d.org/specifications/java/examples/SmokeTestProgramOutput.x3d"))
      ...
      .setScene(new autoclass.Scene()
        .addChild(new autoclass.ViewpointGroup().setDescription("Available viewpoints")
          .addChild(new autoclass.Viewpoint().setDEF("DefaultView").setDescription("Hello X3DJSAIL")
            .setNavigationInfo(new autoclass.NavigationInfo().setDEF("ViewpointChildNavigationInfo")))
          .addChild(new autoclass.Viewpoint().setDEF("TopDownView").setDescription("top-down view from above").setOrientation(java.newArray("float", [java.newFloat(1), java.newFloat(0), java.newFloat(0), java.newFloat(-1.5708)])).setPosition(java.newArray("float", [java.newFloat(0), java.newFloat(100), java.newFloat(0)]))))
        .addChild(new autoclass.NavigationInfo().setType(java.newArray("java.lang.String", ["EXAMINE","FLY","ANY"])))
        .addChild(new autoclass.WorldInfo().setDEF("WorldInfoDEF").setCssClass("worldInfoNode.class").setCssStyle("worldInfoNode.style").setTitle("SmokeTestProgram produced by X3D Java SAI Library (X3DJSAIL)"))
        ...
        .addChild(new autoclass.Shape().setDEF("LineShape")
          .setAppearance(new autoclass.Appearance()
            .setMaterial(new autoclass.Material().setEmissiveColor(java.newArray("float", [java.newFloat(0.6), java.newFloat(0.1961), java.newFloat(0.8)]))))
        ...
        .addChild(new autoclass.Transform().setDEF("TextTransform").setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(-1.5), java.newFloat(0)]))
          ...
          .addChild(new autoclass.Collision()
            ...
            .addChild(new autoclass.Shape().setDEF("ProxyShape")
        ...
        .addChild(new autoclass.OrientationInterpolator().setDEF("SpinInterpolator").setKey(java.newArray("float", [java.newFloat(0), java.newFloat(0.5), java.newFloat(1)])).setKeyValue(java.newArray("float", [java.newFloat(0), java.newFloat(1), java.newFloat(0), java.newFloat(4.7124), java.newFloat(0), java.newFloat(1), java.newFloat(0), java.newFloat(0), java.newFloat(0), java.newFloat(1), java.newFloat(0), java.newFloat(1.5708)])))
...
"}"))
          .addChild(new autoclass.ColorInterpolator().setDEF("ColorAnimator").setKey(java.newArray("float", [java.newFloat(0), java.newFloat(0.5), java.newFloat(1)])).setKeyValue(java.newArray("float", [java.newFloat(0.9412), java.newFloat(1), java.newFloat(1), java.newFloat(0.2941), java.newFloat(0), java.newFloat(0.5098), java.newFloat(0.9412), java.newFloat(1), java.newFloat(1)]))
        ...
        .addChild(new autoclass.ProtoDeclare().setName("ArtDeco01").setAppinfo("tooltip: ArtDeco01Material prototype is a Material node")
          ...
          .setProtoBody(new autoclass.ProtoBody()
            ...
            .addChild(new autoclass.Material().setAmbientIntensity(java.newFloat(0.25)).setDiffuseColor(java.newArray("float", [java.newFloat(0.2824), java.newFloat(0.0852), java.newFloat(0.1345)])).setShininess(java.newFloat(0.1273)).setSpecularColor(java.newArray("float", [java.newFloat(0.2763), java.newFloat(0.1143), java.newFloat(0.1399)])))
            .addComments((new autoclass.CommentsBlock("[SmokeTestProgram diagnostic] should be connected to scene graph: artDeco01ProtoDeclare.getNodeType()=\"Material\"")))
        ...
        .addChild(new autoclass.ExternProtoDeclare().setName("ArtDeco02").setAppinfo("this is a different Material node").setUrl(java.newArray("java.lang.String", ["https://www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02","https://www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02"]))
          .addComments((new autoclass.CommentsBlock("[SmokeTestProgram diagnostic] artDeco02ExternProtoDeclare.getNodeType()=\"ERROR_UNKNOWN_EXTERNPROTODECLARE_NODE_TYPE: ExternProtoDeclare name='ArtDeco02' type cannot be remotely accessed at run time. TODO X3DJSAIL needs to add further capability that retrieves the ExternProtoDeclare file.\"")))
        ...
        .addChild(new autoclass.Shape().setDEF("TestShape1")
          .setAppearance(new autoclass.Appearance().setDEF("TestAppearance1")
            .addComments((new autoclass.CommentsBlock("ArtDeco01Material prototype goes here...")))
            .setMaterial(ProtoInstance0 = new autoclass.ProtoInstance().setName("ArtDeco01")
              .addComments((new autoclass.CommentsBlock("[SmokeTestProgram diagnostic] ArtDeco01ProtoInstance.getNodeType()=\"Material\"")))))
        ...
        .addChild(new autoclass.Shape().setDEF("TestShape2")
          .setAppearance(new autoclass.Appearance().setDEF("TestAppearance2")
            .addComments((new autoclass.CommentsBlock("ArtDeco02Material ProtoInstance goes here...")))
            .setMaterial(ProtoInstance1 = new autoclass.ProtoInstance().setName("ArtDeco02").setDEF("ArtDeco02MaterialDEF")
              .addComments((new autoclass.CommentsBlock("[SmokeTestProgram diagnostic] ArtDeco02ProtoInstance.getNodeType()=\"ERROR_UNKNOWN_EXTERNPROTODECLARE_NODE_TYPE: ExternProtoDeclare name='ArtDeco02' type cannot be remotely accessed at run time. TODO X3DJSAIL needs to add further capability that retrieves the ExternProtoDeclare file.\"")))))
        ...
        .addChild(new autoclass.Shape().setDEF("TestShape3")
          .setAppearance(new autoclass.Appearance().setDEF("TestAppearance3")
            .addComments((new autoclass.CommentsBlock("ArtDeco02Material ProtoInstance USE goes here. Note that name field is REQUIRED as part of ProtoInstance USE.")))
            .setMaterial(ProtoInstance2 = new autoclass.ProtoInstance().setName("ArtDeco02").setUSE("ArtDeco02MaterialDEF")))
          .setGeometry(new autoclass.Cylinder().setHeight(java.newFloat(0.001)).setRadius(java.newFloat(0.001))))
        .addChild(new autoclass.Inline().setDEF("inlineScene").setUrl(java.newArray("java.lang.String", ["newScene.x3d","https://www.web3d.org/specifications/java/examples/newScene.x3d"])))
        ...
        .addChild(new autoclass.ProtoDeclare().setName("MaterialModulator").setAppinfo("mimic a Material node and modulate fields as an animation effect").setDocumentation("https://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html")
          ...
          .setProtoBody(new autoclass.ProtoBody()
            ...
            .addComments((new autoclass.CommentsBlock("Only first node (the node type for the prototype) is renderable, others are along for the ride")))
...
"}"))))
        ...
        .addComments((new autoclass.CommentsBlock("Test success: x3dModel.findElementByNameValue(\"ArtDeco01\", \"ProtoDeclare\") found")))
        ...
        .addChild(new autoclass.Group().setDEF("TestFieldObjectsGroup")
          ...
          .addComments((new autoclass.CommentsBlock("SFFloat default=0.0, initial=1, setValue(2)=2, setValue(3.0f)=3, setValue(4.0)=4")))
          ...
          .addComments((new autoclass.CommentsBlock("SFVec3f default=0 0 0, initial=1 2 3, setValue=4 5 6, multiply(2)=8 10 12, normalize()=0.4558 0.5698 0.6838, regex matches()=true")))
        ...
        .addChild(new autoclass.LoadSensor()
          ...
          .addChild(new autoclass.Script().setDEF("DummyScript")
            .setSourceCode("ecmascript:\n"+
"/* dummy test source code */"))
        ...
        .addChild(new autoclass.OrthoViewpoint().setDEF("SpecialTestOrthoViewpoint").setFieldOfView(java.newArray("float", [java.newFloat(1), java.newFloat(3), java.newFloat(2), java.newFloat(4)]))))      ;
ProtoInstance0
...
ProtoInstance4
    ...
    X3D0.toFileX3D("../data/SmokeTestProgramOutput.new.node.x3d");
    X3D0.toFileJSON("../data/SmokeTestProgramOutput.new.node.x3dj");
    process.exit(0);

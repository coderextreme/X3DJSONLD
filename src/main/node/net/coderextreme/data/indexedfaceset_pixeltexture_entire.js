...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("modified").setContent("Sat, 30 Dec 2023 07:46:15 GMT"))
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Viewpoint()).setDescription("Rear View").setPosition(java.newArray("float", [java.newFloat(0f), java.newFloat(0f), java.newFloat(-10f)])).setOrientation(java.newArray("float", [java.newFloat(0f), java.newFloat(1f), java.newFloat(0f), java.newFloat(3.14f)])))
        .addChild((new autoclass.Viewpoint()).setDescription("Top View").setPosition(java.newArray("float", [java.newFloat(0f), java.newFloat(10f), java.newFloat(0f)])).setOrientation(java.newArray("float", [java.newFloat(1f), java.newFloat(0f), java.newFloat(0f), java.newFloat(-1.57f)])))
        .addChild((new autoclass.Viewpoint()).setDescription("Bottom View").setPosition(java.newArray("float", [java.newFloat(0f), java.newFloat(-10f), java.newFloat(0f)])).setOrientation(java.newArray("float", [java.newFloat(1f), java.newFloat(0f), java.newFloat(0f), java.newFloat(1.57f)])))
        .addChild((new autoclass.Viewpoint()).setDescription("Right View").setPosition(java.newArray("float", [java.newFloat(10f), java.newFloat(0f), java.newFloat(0f)])).setOrientation(java.newArray("float", [java.newFloat(0f), java.newFloat(1f), java.newFloat(0f), java.newFloat(1.57f)])))
        .addChild((new autoclass.Viewpoint()).setDescription("Left View").setPosition(java.newArray("float", [java.newFloat(-10f), java.newFloat(0f), java.newFloat(0f)])).setOrientation(java.newArray("float", [java.newFloat(0f), java.newFloat(1f), java.newFloat(0f), java.newFloat(-1.57f)])))
        ...
        .addChild((new autoclass.Shape())
          ...
          .setGeometry((new autoclass.IndexedFaceSet()).setCoordIndex(java.newArray("int", [0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1]))
            .setCoord((new autoclass.Coordinate()).setPoint(java.newArray("float", [java.newFloat(-2f), java.newFloat(1.5f), java.newFloat(1f), java.newFloat(-2f), java.newFloat(-1.5f), java.newFloat(1f), java.newFloat(2f), java.newFloat(1.5f), java.newFloat(1f), java.newFloat(2f), java.newFloat(-1.5f), java.newFloat(1f), java.newFloat(2f), java.newFloat(1.5f), java.newFloat(-1f), java.newFloat(2f), java.newFloat(-1.5f), java.newFloat(-1f), java.newFloat(-2f), java.newFloat(1.5f), java.newFloat(-1f), java.newFloat(-2f), java.newFloat(-1.5f), java.newFloat(-1f)]))))))      ;
    X3D0.toFileX3D("../data/indexedfaceset_pixeltexture_entire.new.node.x3d");
    process.exit(0);

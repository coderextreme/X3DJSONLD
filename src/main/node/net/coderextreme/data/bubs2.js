...
var ProtoInstance3 = null;
      ...
      .setHeadSync(new autoclass.head()
        .addMetaSync(new autoclass.meta().setNameSync("title").setContentSync("bubs2.x3d"))
        ...
        .addMetaSync(new autoclass.meta().setNameSync("translated").setContentSync("13 March 2016"))
        .addMetaSync(new autoclass.meta().setNameSync("generator").setContentSync("X3dToJson.xslt, http://www.web3d.org/x3d/stylesheets/X3dToJson.html")))

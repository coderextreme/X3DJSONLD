...
"}"))
            ...
            .addChild((new autoclass.ROUTE()).setFromNode("bounce").setFromField("translation").setToNode("body_trans").setToField("translation"))
            .addChild((new autoclass.ROUTE()).setFromNode("bounce").setFromField("scale").setToNode("body_trans").setToField("scale"))
    ...
    X3D0.toFileX3D("../data/bubs2.new.node.x3d");
    process.exit(0);

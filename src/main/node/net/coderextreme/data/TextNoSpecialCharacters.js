...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Shape())
          ...
          .setGeometry((new autoclass.Text()).setDEF("DefaultText").setString(java.newArray("java.lang.String", ["Character entity substitutions:","empty string \"\" skips a line:","","apostrophe ' is &apos;","ampersand & is &amp;","quote mark \" is &quot;","backslash \\\\ is X3D escape character","double backslash \\\\\\\\ is X3D backslash \\\\ character","Pi is pi is pi XML character entity"]))
    ...
    X3D0.toFileX3D("../data/TextNoSpecialCharacters.new.x3d");
    process.exit(0);

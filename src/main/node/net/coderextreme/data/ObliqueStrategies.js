...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        .addMeta((new autoclass.meta()).setContent("ObliqueStrategies.x3d").setName("title"))
        .addMeta((new autoclass.meta()).setContent("Text scripting and animation example using Oblique Strategies card set by Brian Eno.").setName("description"))
        .addMeta((new autoclass.meta()).setContent("Don Brutzman, John Kelly, Ben Cheng").setName("creator"))
        .addMeta((new autoclass.meta()).setContent("3 November 2013").setName("created"))
        .addMeta((new autoclass.meta()).setContent("10 November 2019").setName("modified"))
        .addMeta((new autoclass.meta()).setContent("oblique.html").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("ObliqueStrategies.txt").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("ObliqueStrategiesScript.js").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("http://music.hyperreal.org/artists/brian_eno/oblique/oblique.html").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("http://www.eno-web.co.uk/obliques.html").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("http://gothpunk.com/haiku-intro.html").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("http://www.rtqe.net/ObliqueStrategies/OSintro.html").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("https://en.wikipedia.org/wiki/Oblique_Strategies").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("Brian Eno, Oblique Strategies").setName("subject"))
        .addMeta((new autoclass.meta()).setContent("images/ObliqueStrategiesEntryScreen.png").setName("Image"))
        .addMeta((new autoclass.meta()).setContent("http://translate.google.com/translate_tts?tl=en&q=hello%20X3D").setName("Sound"))
        .addMeta((new autoclass.meta()).setContent("translate_tts_HelloX3D.mp3").setName("Sound"))
        .addMeta((new autoclass.meta()).setContent("translate_tts_HelloX3D.wav").setName("Sound"))
        .addMeta((new autoclass.meta()).setContent("multiliingual translation parameter").setName("TODO"))
        .addMeta((new autoclass.meta()).setContent("http://stackoverflow.com/questions/9163988/download-mp3-from-google-translate-text-to-speech").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("http://www.greenbot.com/article/2105862/how-to-get-started-with-google-text-to-speech.html").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("under development, scene Sound/AudioClip triggering (or retrieved file format) not working").setName("warning"))
        .addMeta((new autoclass.meta()).setContent("TODO resolve potential error in Script node TextScript: parse problem line 15 \" var strategy = [];").setName("warning"))
        .addMeta((new autoclass.meta()).setContent("https://gist.github.com/alotaiba/1728771").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("https://stackoverflow.com/questions/35002003/how-to-use-google-translate-tts-with-the-new-v2-api").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("https://translate.google.com/translate_tts?ie=UTF-8&client=tw-ob&tl=en&q=Hello+X3D4").setName("Sound"))
        .addMeta((new autoclass.meta()).setContent("translate_tts_HelloX3D4.mp3").setName("Sound"))
        .addMeta((new autoclass.meta()).setContent("https://cloud.google.com/translate/docs/basic/translating-text").setName("reference"))
        .addMeta((new autoclass.meta()).setContent("https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategies.x3d").setName("identifier"))
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Script()).setDEF("TextScript").setUrl(java.newArray("java.lang.String", ["ObliqueStrategiesScript.js","https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategiesScript.js"]))
          ...
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFINT32).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("index for active strategy card, -1 means no selection").setName("index").setValue("0"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_MFSTRING).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setAppinfo("latest strategy card value").setName("string_changed"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_MFSTRING).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setAppinfo("\"url to invoke Google Translate\"").setName("textToSpeechUrl"))
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFTIME).setAccessType(autoclass.field.ACCESSTYPE_OUTPUTONLY).setAppinfo("activate Sound node").setName("newCardTime"))
          ...
          .addField((new autoclass.field()).setType(autoclass.field.TYPE_SFBOOL).setAccessType(autoclass.field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("controls console tracing").setName("traceEnabled").setValue("true")))

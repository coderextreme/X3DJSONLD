...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead((new autoclass.head())
        ...
        .addMeta((new autoclass.meta()).setName("modified").setContent("18 October 2015"))
        ...
        .addMeta((new autoclass.meta()).setName("audio").setContent("http://translate.google.com/translate_tts?tl=en&q=hello%20X3D"))
        .addMeta((new autoclass.meta()).setName("audio").setContent("translate_tts_HelloX3D.mp3"))
        .addMeta((new autoclass.meta()).setName("audio").setContent("translate_tts_HelloX3D.wav"))
        ...
        .addMeta((new autoclass.meta()).setName("warning").setContent("BSContact error: Script node TextScript: parse error: line 15 \" var strategy = [];"))
        .addMeta((new autoclass.meta()).setName("identifier").setContent("http://X3dGraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategies.x3d"))
      ...
      .setScene((new autoclass.Scene())
        ...
        .addChild((new autoclass.Script()).setDEF("TextScript").setUrl(java.newArray("java.lang.String", ["../node/ObliqueStrategiesScript.js"]))
        ...
        .addChild((new autoclass.Transform()).setDEF("CardTransform").setScale(java.newArray("float", [java.newFloat(0.4), java.newFloat(0.4), java.newFloat(0.4)])).setTranslation(java.newArray("float", [java.newFloat(0), java.newFloat(-1.5), java.newFloat(0)]))
          ...
          .addChild((new autoclass.Sound()).setDEF("CardSoundSpatialization").setMaxBack(java.newFloat(100)).setMaxFront(java.newFloat(100)).setMinBack(java.newFloat(20)).setMinFront(java.newFloat(20))
            ...
            .setSource((new autoclass.AudioClip()).setDEF("TextToSpeechAudioClip").setDescription("sends strategy text google translate").setUrl(java.newArray("java.lang.String", ["http://translate.google.com/translate_tts?tl=en&q=Feed%20the%20recording%20back%20out%20of%20the%20medium","translate_tts_mp3FileFormatNotSupported.wav"]))))

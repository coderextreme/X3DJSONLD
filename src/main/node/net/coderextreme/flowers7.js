          ...
          .addChild(new autoclass.Shape()
            .setAppearance(new autoclass.Appearance()
              ...
              .addShaders(new autoclass.ComposedShader().setDEF("x3dom").setLanguage("GLSL")
                .addComments((new autoclass.CommentsBlock("TODO VERIFY <field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field>")))
                ...
                .addParts(new autoclass.ShaderPart().setType("VERTEX").setUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs"])))
                .addParts(new autoclass.ShaderPart().setType("FRAGMENT").setUrl(java.newArray("java.lang.String", ["https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs"]))))
...
"}"))
    ...
    X3D0.toFileX3D(".././flowers7.new.node.x3d");
    X3D0.toFileJSON(".././flowers7.new.node.json");
    process.exit(0);

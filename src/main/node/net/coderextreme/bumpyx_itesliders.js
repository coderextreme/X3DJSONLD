...
ConfigurationProperties.setStripDefaultAttributes(true);
      ...
      .setScene(new autoclass.Scene()
        ...
        .addLayerSet(new autoclass.LayerSet().setActiveLayer(1).setOrder(java.newArray("int", [1,2]))
          ...
          .addLayers(new autoclass.LayoutLayer().setPickable(true).setObjectType(java.newArray("java.lang.String", ["ALL"]))
            ...
            .setLayout(new autoclass.Layout().setAlign(java.newArray("java.lang.String", ["RIGHT","BOTTOM"])).setOffset(java.newArray("float", [java.newFloat(0), java.newFloat(0.2)])).setSize(java.newArray("float", [java.newFloat(0.4), java.newFloat(0.6)])))
    ...
    X3D0.toFileX3D(".././bumpyx_itesliders.new.node.x3d");
    X3D0.toFileJSON(".././bumpyx_itesliders.new.node.json");
    process.exit(0);

        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("variationalflowers2.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("A flower variational system")}),

            new meta({
              name : new SFString("identifier"),
              content : new SFString("https://coderextreme.net/X3DJSONLD/src/main/personal/variationalflowers2.x3d")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("variationalflowers2.x3d")}),

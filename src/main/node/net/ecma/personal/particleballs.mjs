        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("particleballs.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("A balls proto with configurable shaders")}),

            new meta({
              name : new SFString("identifier"),
              content : new SFString("https://coderextreme.net/X3DJSONLD/src/main/personal/particleballs.x3d")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("particleballs.x3d")}),

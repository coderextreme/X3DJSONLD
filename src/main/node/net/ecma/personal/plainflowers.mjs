        ...
        new head({
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("plainflowers.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("https://coderextreme.net/X3DJSONLD/src/main/personal/plainflowers.x3d")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new NavigationInfo({}),
                          ...
                          children : new MFNode([
                            new ProtoInstance({
                              ...
                              fieldValue : new MFNode([
                                ...
                                new fieldValue({
                                  name : new SFString("fragment"),
                                  value : new SFString("\"../shaders/plain.fs\"")})])})])})])}))}),

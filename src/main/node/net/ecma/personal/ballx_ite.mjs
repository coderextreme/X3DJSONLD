...
var X3D0 =  new X3D({
        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("ballx_ite.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("https://coderextreme.net/X3DJSONLD/src/main/personal/ballx_ite.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("ballx_ite.x3d")}),

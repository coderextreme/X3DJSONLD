        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("x3domflowers.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("https://coderextreme.net/X3DJSONLD/src/main/personal/x3domflowers.x3d")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new NavigationInfo({}),
                          ...
                          children : new MFNode([
                            new ProtoInstance({
                              ...
                              fieldValue : new MFNode([
                                new fieldValue({
                                  name : new SFString("vertex"),
                                  value : new SFString("\"../shaders/x3dom_flowers_chromatic.vs\"")}),

        ...
        new head({
          ...
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("7 April 2018")}),
            ...
            new meta({
              name : new SFString("reference"),
              content : new SFString("X3dValidator https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("30 April 2018")}),
                        ...
                        new MetadataSet({
                          ...
                          value : new SFNode(
                            new MetadataString({
                              ...
                              value : new MFString(new MFString(["checks MetadataSetObject addValue() method"]))}))}),
...
// Browser.print('colorInput=' + eventValue + ', colorsOutput=' + colorsOutput + '\n');
          ...
          /*Tested ArtDeco01ProtoInstance, ArtDeco02ProtoInstance for improper node type when ProtoInstance is added in wrong place*/
            ...
            new Inline({
              ...
              url : new MFString(new MFString(["someOtherScene.x3d"]))}),

...
var X3D0 =  new X3D({
        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("KoreanCharacter04Young.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter04Young.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("KoreanCharacter04Young.x3d")}),
            ...
            new Viewpoint({
              ...
              description : new SFString("Young"),
              position : new SFVec3f(new SFVec3f([0,1,3]))}),

            new HAnimHumanoid({
              name : new SFString("Young"),
              DEF : new SFString("hanim_Young"),
              ...
              joints : new SFNode(
                new HAnimJoint({
                  ...
                  center : new SFVec3f(new SFVec3f([0,31.540001,-0.3172])),
                  children : new MFNode([
                    new HAnimSegment({
                      ...
                      children : new MFNode([
                        new Transform({
                          translation : new SFVec3f(new SFVec3f([0,31.540001,-0.3172])),
                          children : new MFNode([
                            new Shape({
                              appearance : new SFNode(
                                new Appearance({
                                  ...
                                  texture : new SFNode(
                                    new ImageTexture({
                                      DEF : new SFString("YoungTextureAtlas"),
                                      url : new MFString(new MFString(["images/Young.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Young.png"]))}))})),
                              geometry : new SFNode(
                                new IndexedFaceSet({
                    ...
                    new HAnimJoint({
                      ...
                      center : new SFVec3f(new SFVec3f([3.504,29.040001,-0.4027])),
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f(new SFVec3f([3.504,29.040001,-0.4027])),
                              children : new MFNode([
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                                      ...
                                      texture : new SFNode(
                                        new ImageTexture({
                                          USE : new SFString("YoungTextureAtlas")}))})),
                                  geometry : new SFNode(
                                    new IndexedFaceSet({
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f(new SFVec3f([3.414,14.95,-0.4549])),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f(new SFVec3f([3.414,14.95,-0.4549])),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                                      ...
                                      geometry : new SFNode(
                                        new IndexedFaceSet({
                                          ...
                                          coord : new SFNode(
                                            new Coordinate({
                                              point : new MFVec3f(new MFVec3f([0.6335,1.142,0.0206,0.3202,1.142,0.8245,-0.3837,1.142,0.9871,-0.9483,1.142,0.5315,-0.9483,1.142,-0.3447,-0.3837,1.142,-0.8003,0.3202,1.142,-0.6377,2.06,-3.778,0.0206,1.287,-2.905,1.78,1.089,-1.147,2.133,1.867,-1.397,0.0206,-0.715,-2.905,2.263,-0.6583,-1.147,2.559,-1.987,-3.778,1.106,-2.06,-1.397,0.8632,-1.987,-4.457,-1.205,-2.06,-1.397,-0.822,-0.715,-4.457,-2.559,-0.6583,-1.397,-2.087,1.287,-4.457,-2.076,1.089,-1.397,-1.661,0.9877,0.2851,1.672,1.704,0.2851,0.0206,-0.622,0.2851,2.043,-1.913,0.2851,1.002,-1.913,0.2851,-0.8149,-0.622,0.2851,-1.817,0.9877,0.2851,-1.445,1.417,-11.1,0.0028,0.8123,-11.09,1.38,-0.5457,-11.09,1.72,-1.635,-11.1,0.767,-1.635,-11.11,-0.8605,-0.5457,-11.11,-1.535,0.8123,-11.11,-1.195,0.6234,-12.52,0.021,0.3177,-12.52,0.7175,-0.3691,-12.52,0.8896,-0.9199,-12.52,0.4076,-0.9199,-12.53,-0.4156,-0.3691,-12.53,-0.7569,0.3177,-12.53,-0.5849]))})),
                                          texCoord : new SFNode(
                                            new TextureCoordinate({
                            ...
                            new HAnimJoint({
                              ...
                              center : new SFVec3f(new SFVec3f([3.18,3.449,-0.3088])),
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([3.18,3.449,-0.3088])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({
                                ...
                                new HAnimJoint({
                                  ...
                                  center : new SFVec3f(new SFVec3f([3.18,3.189,0.9724])),
                                  children : new MFNode([
                                    new HAnimSegment({
                                      ...
                                      children : new MFNode([
                                        new Transform({
                                          translation : new SFVec3f(new SFVec3f([3.18,3.189,0.9724])),
                                          children : new MFNode([
                                            new Shape({
                                              appearance : new SFNode(
                                                new Appearance({
                                ...
                                new Shape({
                                  ...
                                  geometry : new SFNode(
                                    new IndexedFaceSet({
                                      ...
                                      coord : new SFNode(
                                        new Coordinate({
                                          point : new MFVec3f(new MFVec3f([-2.61,2.495,-0.0096,-1.449,2.495,2.819,1.16,2.495,3.518,2.968,2.495,1.56,2.968,2.495,-1.58,1.16,2.495,-3.537,-1.449,2.495,-2.839,-2.61,-0.8104,-0.0096,-1.449,-0.8104,2.819,1.16,-0.8104,3.518,2.968,-0.8104,1.56,2.968,-0.8104,-1.58,1.16,-0.8104,-3.537,-1.449,-0.8104,-2.839,-2.61,-3.375,-0.0096,-1.449,-3.375,2.819,1.16,-3.375,3.518,2.968,-3.375,1.56,2.968,-3.375,-1.58,1.16,-3.375,-3.537,-1.449,-3.375,-2.839,-2.968,-6.68,-0.0096,-1.672,-6.68,3.148,1.24,-6.68,3.928,2.957,-6.68,1.743,2.957,-6.68,-1.762,1.24,-6.68,-3.947,-1.672,-6.68,-3.167,-1.892,-5.194,-0.0096,-1.001,-5.194,2.161,1.001,-5.194,2.697,2.321,-5.194,1.195,2.321,-5.194,-1.214,1.001,-5.194,-2.716,-1.001,-5.194,-2.18,-1.9,-10.89,-0.0096,-1.08,-10.89,1.714,0.7636,-10.89,2.14,2.242,-10.89,0.9472,2.242,-10.89,-0.9663,0.7636,-10.89,-2.159,-1.08,-10.89,-1.734,-1.807,4.249,-0.0096,-0.9484,4.249,2.084,0.982,4.249,2.601,2.53,4.249,1.152,2.53,4.249,-1.171,0.982,4.249,-2.62,-0.9484,4.249,-2.103,-1.624,-14.13,-0.0096,-0.9076,-14.13,1.641,0.7021,-14.13,2.013,1.993,-14.13,0.9715,1.993,-14.13,-0.8451,0.7021,-14.13,-1.887,-0.9076,-14.13,-1.515,-0.5533,-14.99,-0.0096,-0.2401,-14.99,0.7943,0.4639,-14.99,0.9569,1.028,-14.99,0.5013,1.028,-14.99,-0.3749,0.4639,-14.99,-0.8305,-0.2401,-14.99,-0.6679]))})),
                                      texCoord : new SFNode(
                                        new TextureCoordinate({
                                          point : new MFVec2f(new MFVec2f([0.719,0.5576,0.6284,0.5576,0.7414,0.5576,0.6787,0.5576,0.5781,0.5576,0.5154,0.5576,0.5378,0.5576,0.6284,0.5029,0.7509,0.3997,0.6284,0.3997,0.7509,0.5029,0.7811,0.3997,0.7811,0.5029,0.6964,0.3997,0.6964,0.5029,0.5604,0.3997,0.5604,0.5029,0.4756,0.3997,0.4756,0.5029,0.5059,0.3997,0.5059,0.5029,0.7509,0.3197,0.6284,0.3197,0.7811,0.3197,0.6964,0.3197,0.5604,0.3197,0.4756,0.3197,0.5059,0.3197,0.7651,0.2166,0.6284,0.2166,0.7989,0.2166,0.7043,0.2166,0.5525,0.2166,0.4579,0.2166,0.4917,0.2166,0.7224,0.263,0.6284,0.263,0.7456,0.263,0.6805,0.263,0.5762,0.263,0.5112,0.263,0.5344,0.263,0.8705,0.5452,0.8705,0.5383,0.8705,0.5369,0.8705,0.5408,0.8705,0.5483,0.8705,0.5522,0.8705,0.5509,0.917,0.5452,0.917,0.5266,0.89,0.5304,0.89,0.5452,0.917,0.522,0.89,0.5268,0.917,0.5349,0.89,0.537,0.917,0.5555,0.89,0.5534,0.917,0.5684,0.89,0.5636,0.917,0.5638,0.89,0.56,0.8746,0.531,0.8746,0.5452,0.8746,0.5279,0.8746,0.5368,0.8746,0.5524,0.8746,0.5613,0.8746,0.5581]))}))}))})])})])}),
                    ...
                    new HAnimJoint({
                      ...
                      center : new SFVec3f(new SFVec3f([0,27.07,-0.3172])),
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f(new SFVec3f([0,27.07,-0.3172])),
                              children : new MFNode([
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f(new SFVec3f([5.441,45.830002,0.1786])),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f(new SFVec3f([5.441,45.830002,0.1786])),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              center : new SFVec3f(new SFVec3f([6.823,36.080002,0.08607])),
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([6.823,36.080002,0.08607])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({
                                ...
                                new HAnimJoint({
                                  ...
                                  center : new SFVec3f(new SFVec3f([6.915,28.41,0.3752])),
                                  children : new MFNode([
                                    new HAnimSegment({
                                      ...
                                      children : new MFNode([
                                        new Transform({
                                          translation : new SFVec3f(new SFVec3f([6.915,28.41,0.3752])),
                                          children : new MFNode([
                                            new Shape({
                                              appearance : new SFNode(
                                                new Appearance({
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f(new SFVec3f([0,35.75,-0.445])),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f(new SFVec3f([0,35.75,-0.445])),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([0,50.470001,-0.1481])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({

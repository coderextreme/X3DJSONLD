        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("Sat, 30 Dec 2023 07:50:46 GMT")}),
            ...
            new HAnimHumanoid({
              ...
              joints : new MFNode([
                new HAnimJoint({
                  ...
                  center : new SFVec3f([0,31.54,-0.3172]),
                  children : new MFNode([
                    new HAnimSegment({
                      ...
                      children : new MFNode([
                        new Transform({
                          translation : new SFVec3f([0,31.54,-0.3172]),
                          child : new SFNode(
                            new Shape({
                    ...
                    new HAnimJoint({
                      ...
                      center : new SFVec3f([3.504,29.04,-0.4027]),
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f([3.504,29.04,-0.4027]),
                              child : new SFNode(
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                    ...
                    new HAnimJoint({
                      ...
                      children : new MFNode([
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f([5.441,45.83,0.1786]),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f([5.441,45.83,0.1786]),
                                  child : new SFNode(
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              center : new SFVec3f([6.823,36.08,0.08607]),
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f([6.823,36.08,0.08607]),
                                      child : new SFNode(
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({
                        ...
                        new HAnimJoint({
                          ...
                          children : new MFNode([
                            ...
                            new HAnimJoint({
                              ...
                              center : new SFVec3f([0,50.47,-0.1481]),
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f([0,50.47,-0.1481]),
                                      child : new SFNode(
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({

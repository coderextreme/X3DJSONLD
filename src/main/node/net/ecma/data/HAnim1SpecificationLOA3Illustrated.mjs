        ...
        new Scene({
          ...
          /*Viewpoint centerOfRotation=\"0 0.9149 0.0016\" matches initial at-rest locaton of the sacroliac. Note that these viewpoints are external to the HAnimHumanoid and do not move with the human.*/
            ...
            new HAnimHumanoid({
              ...
              info : new MFString(new MFString(["authorName=Matthew T. Beitler Joe D. Williams Don Brutzman","authorEmail=HAnim@web3D.org","copyright=none","creationDate=12 May 1999","usageRestrictions=none","humanoidVersion=2.0","height=1.7504"])),
                                                                                                                                    ...
                                                                                                                                    new LineSet({
                                                                                                                                      ...
                                                                                                                                      color : new SFNode(
                                                                                                                                        new ColorRGBA({
                                                                                                                                          ...
                                                                                                                                          color : new MFColorRGBA(new MFColorRGBA([0,0,1,1,0,0,1,0.1]))}))}))}),

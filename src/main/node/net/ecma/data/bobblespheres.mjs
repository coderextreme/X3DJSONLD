                    ...
                    new Appearance({
                      material : new SFNode(
                        new PhysicalMaterial({
                          ...
                          roughness : new SFFloat(0.05),
                          extensions : new SFNode(
                            new IORMaterialExtension({
                              DEF : new undefined("IOR_2"),
                              indexOfRefraction : new SFFloat(1.5)}))}))})),
                  geometry : new SFNode(
                    new Sphere({
                      radius : new SFFloat(0.2)}))}))}),
                        ...
                        new PhysicalMaterial({
                          ...
                          extensions : new SFNode(
                            new IridescenceMaterialExtension({
                              DEF : new undefined("IRI_3"),
                              iridescence : new SFFloat(1),
                              iridescenceIndexOfRefraction : new SFFloat(1.3),
                              iridescenceThicknessMinimum : new SFFloat(100)}))}))})),
                  geometry : new SFNode(
                    new Sphere({
                      radius : new SFFloat(0.2)}))}))}),

...
var X3D0 =  new X3D({
      ...
      Scene : new SFNode(
        new Scene({
          ...
          { "#comment" : new CommentsBlock("Trigger calculation after each animation change") },
          { "#comment" : new CommentsBlock("<ROUTE fromField='rotation_changed' fromNode='boxman_r_wrist' toField='update' toNode='ENGINE'/>") }])}))});

...
var X3D0 =  new X3D({
        ...
        new head({
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("CameraShape.x3d")}),

            new meta({
              name : new SFString("description"),
              content : new SFString("Simple video camera shape")}),

            new meta({
              name : new SFString("creator"),
              content : new SFString("Jeff Weekley and Don Brutzman")}),

            new meta({
              name : new SFString("created"),
              content : new SFString("2 June 2009")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              info : new MFString(["VRML2.0 created with Version 1.3, from Alias Maya 2008"]),
              title : new SFString("SimpleCamera.x3d")}),

            new Viewpoint({
              DEF : new SFString("CameraShapeView"),
              description : new SFString("Camera view, over the shoulder"),
              position : new SFVec3f([0,0.75,3])}),

            new Viewpoint({
              description : new SFString("Camera view through lens"),
              position : new SFVec3f([0,0,0])}),

            new Viewpoint({
              description : new SFString("Camera view from right side"),
              orientation : new SFRotation([0,1,0,1.5708]),
              position : new SFVec3f([12,0,-4])}),

            new Viewpoint({
              description : new SFString("Camera view from above"),
              orientation : new SFRotation([1,0,0,-1.5708]),
              position : new SFVec3f([0,15,-5])}),

            new Viewpoint({
              description : new SFString("Camera view from left side"),
              orientation : new SFRotation([0,1,0,-1.5708]),
              position : new SFVec3f([-12,0,-4])}),
                    ...
                    new Shape({
                      appearance : new SFNode(
                        new Appearance({
                          ...
                          material : new SFNode(
                            new Material({
                              DEF : new SFString("lambert1_0"),
                              ambientIntensity : new SFFloat(0.25),
                              diffuseColor : new SFColor([0.372322,0.371574,0.373173]),
                              shininess : new SFFloat(0.02),
                              specularColor : new SFColor([0.890909,0.887832,0.890909]),
                    ...
                    new Shape({
                      geometry : new SFNode(
                        new IndexedFaceSet({
                          ...
                          coord : new SFNode(
                            new Coordinate({
                              DEF : new SFString("pCylinder1GeoPoints"),
                              point : new MFVec3f([-0.36,-2.39,-0.26,-0.36,-1.77,-0.89,-0.36,0,-1.7,-0.36,0.85,-1.47,-0.36,1.47,-0.85,-0.36,1.7,0,-0.36,1.47,0.85,-0.36,-0.07,2.05,-0.36,-0.92,2.28,-0.36,-1.77,2.05,-0.36,-2.39,1.43,-0.36,-2.62,0.58,0.36,-2.39,-0.26,0.36,-1.77,-0.89,0.36,0,-1.7,0.36,0.85,-1.47,0.36,1.47,-0.85,0.36,1.7,0,0.36,1.47,0.85,0.36,-0.07,2.05,0.36,-0.92,2.28,0.36,-1.77,2.05,0.36,-2.39,1.43,0.36,-2.62,0.58,-0.36,-0.46,0.31,0.36,-0.46,0.31])}))})),
                      appearance : new SFNode(
                        new Appearance({
                    ...
                    new Transform({
                      ...
                      children : new MFNode([
                        new Shape({
                          ...
                          geometry : new SFNode(
                            new IndexedFaceSet({
                              USE : new SFString("pCylinder1_0Geo")}))})])}),
                    ...
                    new Transform({
                      ...
                      children : new MFNode([
                        new Shape({
                          ...
                          geometry : new SFNode(
                            new IndexedFaceSet({
                              USE : new SFString("pSphere1_0Geo")}))})])})])})])})])}))});

        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("November 9 2024")}),

            new meta({
              name : new SFString("title"),
              content : new SFString("myextrusion.x3d")}),

            new meta({
              name : new SFString("identifier"),
              content : new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/myextrusion.x3d")}),
...
ecmascript:eval (0
			...
			tmpspine[1] = endB;
                ...
                new ROUTE({
                  ...
                  toNode : new SFString("myextrusion"),

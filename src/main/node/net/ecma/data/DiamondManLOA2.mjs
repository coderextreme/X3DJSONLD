        ...
        new head({
          ...
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("HAnim skeletal structure at level of articulation two, one diamond at the base node for the structure, blue spheres for HAnimSite feaature points")}),
            ...
            new meta({
              ...
              content : new SFString("Mon, 15 Sep 2025 05:18:47 GMT")}),

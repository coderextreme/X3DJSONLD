...
var X3D0 =  new X3D({
        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("Tongue.x3d")}),

            new meta({
              name : new SFString("description"),
              content : new SFString("Facial Action Coding System (FACS) example for Action Unit (AU) 27, Mouth Stretch Morpher, Tongue Derivated.")}),

            new meta({
              name : new SFString("creator"),
              content : new SFString("Yujin Jung")}),

            new meta({
              name : new SFString("translator"),
              content : new SFString("Chul Hee Jung")}),

            new meta({
              name : new SFString("translator"),
              content : new SFString("Myeong Won Lee")}),

            new meta({
              name : new SFString("created"),
              content : new SFString("25 April 2022")}),

            new meta({
              name : new SFString("modified"),
              content : new SFString("27 October 2024")}),
            ...
            new meta({
              ...
              content : new SFString("https://en.wikipedia.org/wiki/Facial_Action_Coding_System")}),

            new meta({
              name : new SFString("reference"),
              content : new SFString("https://web.cs.wpi.edu/~matt/courses/cs563/talks/face_anim/ekman.html")}),

            new meta({
              name : new SFString("reference"),
              content : new SFString("Bryn Farnsworth, FACS Visual Guidebook https://imotions.com/blog/learning/research-fundamentals/facial-action-coding-system")}),

            new meta({
              name : new SFString("generator"),
              content : new SFString("Suwon VRLAB X3D Converter")}),

            new meta({
              name : new SFString("MovingImage"),
              content : new SFString("originals/SuwonHAnimFacialMotionConverter.mp4")}),
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/Tongue.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new Viewpoint({
              DEF : new SFString("HelloJin"),
              description : new SFString("Hello Jin! 안녕하세요 진!"),
              position : new SFVec3f([0,20,60])}),
            ...
            new EXPORT({
              localDEF : new SFString("JinMouthStretch_Clock"),
              aS : new SFString("JinMouthStretch_Clock")}),
                                    ...
                                    new IndexedFaceSet({
                                      ...
                                      texCoord : new SFNode(
                                        new TextureCoordinate({
                                          DEF : new SFString("Tongue-TEXCOORD"),

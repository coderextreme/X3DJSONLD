                ...
                new MetadataSet({
                  ...
                  value : new SFNode(
                    new MetadataFloat({
                      ...
                      value : new MFFloat(new MFFloat([50]))})),
                  value : new SFNode(
                    new MetadataString({
                      name : new SFString("humanoidVersion"),
                      value : new MFString(new MFString(["validation testing"]))}))}),
              joints : new SFNode(
                new HAnimJoint({
                  ...
                  children : new MFNode([
                    ...
                    new HAnimJoint({
                      ...
                      center : new SFVec3f(new SFVec3f([0,40.07,-0.8527])),
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f(new SFVec3f([0,40.07,-0.8527])),
                              children : new MFNode([
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({

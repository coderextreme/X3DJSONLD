        ...
        new head({
          ...
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("detect, append _2. rescale smaller than 30m! convert inches to meters? what about motion scaling?")}),
                                    ...
                                    new HAnimJoint({
                                      ...
                                      children : new MFNode([
                                        new HAnimSegment({
                                          ...
                                          { "#comment" : new CommentsBlock("TODO append _2") },
                                          children : new MFNode([
                                            new Transform({

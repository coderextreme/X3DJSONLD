        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("SmokeTestProgramOutput.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("Example SmokeTestProgram creates an X3D model using the X3D Java Scene Access Interface Library (X3DJSAIL)")}),
            ...
            new meta({
              ...
              content : new SFString("SmokeTestProgramOutput.java")}),
            ...
            new meta({
              ...
              content : new SFString("20 June 2026")}),
            ...
            new meta({
              name : new SFString("generator"),
              content : new SFString("https://www.web3d.org/specifications/java/examples/SmokeTestProgram.java")}),
            ...
            new meta({
              name : new SFString("reference"),
              content : new SFString("https://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/java/examples/SmokeTestProgramOutput.x3d")}),
            ...
            new meta({
              name : new SFString("reference"),
              content : new SFString("SmokeTestProgramOutput.txt")}),

            new meta({
              name : new SFString("reference"),
              content : new SFString("SmokeTestProgramOutput.x3dv")}),

            new meta({
              name : new SFString("reference"),
              content : new SFString("SmokeTestProgramOutput.wrl")}),

            new meta({
              name : new SFString("reference"),
              content : new SFString("SmokeTestProgramOutput.html")}),

            new meta({
              name : new SFString("reference"),
              content : new SFString("https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/SmokeTestProgramOutput.x3d")}),

            new meta({
              name : new SFString("identifier"),
              content : new SFString("https://www.web3d.org/specifications/java/examples/SmokeTestProgramOutput.x3d")}),
        ...
        new Scene({
          children : new MFNode([
              ...
              children : new MFNode([
                new Viewpoint({
                  ...
                  navigationInfo : new SFNode(
                    new NavigationInfo({
                      DEF : new SFString("ViewpointChildNavigationInfo")}))}),
            ...
            new WorldInfo({
              ...
              title : new SFString("SmokeTestProgram produced by X3D Java SAI Library (X3DJSAIL)")}),
            ...
            new Shape({
              ...
              appearance : new SFNode(
                new Appearance({
                  material : new SFNode(
                    new Material({
                      emissiveColor : new SFColor([0.6,0.1961,0.8])}))})),
              geometry : new SFNode(
                new IndexedLineSet({
          ...
          /*repeatedly spin 180 degrees as a readable special effect*/
            ...
            new OrientationInterpolator({
              ...
              keyValue : new MFRotation([0,1,0,4.7124,0,1,0,0,0,1,0,1.5708])}),
...
// TODO check line wrapping when exporting/converting
                ...
                new ColorInterpolator({
                  ...
                  key : new MFFloat([0,0.5,1]),
                  keyValue : new MFColor([0.9412,1,1,0.2941,0,0.5098,0.9412,1,1]),
                ...
                new ProtoBody({
                  ...
                  children : new MFNode([
                    new Material({
                      ...
                      diffuseColor : new SFColor([0.2824,0.0852,0.1345]),
                      shininess : new SFFloat(0.1273),
                      specularColor : new SFColor([0.2763,0.1143,0.1399])}),
            ...
            new ExternProtoDeclare({
              ...
              url : new MFString(["https://www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02","https://www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02"]),
          ...
          /*Tested ArtDeco01ProtoInstance, ArtDeco02ProtoInstance for improper node type when ProtoInstance is added in wrong place*/
            ...
            new Inline({
              ...
              url : new MFString(["newScene.x3d","https://www.web3d.org/specifications/java/examples/newScene.x3d"])}),
...
/* dummy test source code */)}),
            ...
            new OrthoViewpoint({
              DEF : new SFString("SpecialTestOrthoViewpoint"),
              fieldOfView : new MFFloat([1,3,2,4])})}))});

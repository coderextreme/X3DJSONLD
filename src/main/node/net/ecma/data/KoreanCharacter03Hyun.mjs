...
var X3D0 =  new X3D({
        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("KoreanCharacter03Hyun.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter03Hyun.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("KoreanCharacter03Hyun.x3d")}),
            ...
            new HAnimHumanoid({
              ...
              joints : new SFNode(
                new HAnimJoint({
                  ...
                  center : new SFVec3f(new SFVec3f([0,31.43,-0.5601])),
                  children : new MFNode([
                    new HAnimSegment({
                      ...
                      children : new MFNode([
                        new Transform({
                          translation : new SFVec3f(new SFVec3f([0,31.43,-0.5601])),
                          children : new MFNode([
                            new Shape({
                              appearance : new SFNode(
                                new Appearance({
                                  ...
                                  texture : new SFNode(
                                    new ImageTexture({
                                      DEF : new SFString("HyunTextureAtlas"),
                                      url : new MFString(new MFString(["images/Hyun.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Hyun.png"]))}))})),
                              geometry : new SFNode(
                                new IndexedFaceSet({
                    ...
                    new HAnimJoint({
                      ...
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f(new SFVec3f([3.551,29.33,-0.1267])),
                              children : new MFNode([
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                                      ...
                                      texture : new SFNode(
                                        new ImageTexture({
                                          USE : new SFString("HyunTextureAtlas")}))})),
                                  geometry : new SFNode(
                                    new IndexedFaceSet({
                        ...
                        new HAnimJoint({
                          ...
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f(new SFVec3f([3.71,15.48,-0.1446])),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([3.388,3.168,-0.537])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({
                                ...
                                new HAnimJoint({
                                  ...
                                  center : new SFVec3f(new SFVec3f([3.388,2.908,0.7441])),
                                  children : new MFNode([
                                    new HAnimSegment({
                                      ...
                                      children : new MFNode([
                                        new Transform({
                                          translation : new SFVec3f(new SFVec3f([3.388,2.908,0.7441])),
                                          children : new MFNode([
                                            new Shape({
                                              appearance : new SFNode(
                                                new Appearance({
                                              ...
                                              geometry : new SFNode(
                                                new IndexedFaceSet({
                                                  ...
                                                  coord : new SFNode(
                                                    new Coordinate({
                                                      point : new MFVec3f(new MFVec3f([2.548,-1.416,-0.8988,1.819,-3.176,-0.8988,0,0.2435,0.2718,1.78,-0.2627,-0.8989,1.476,0.0025,-0.0134,-2.548,-1.416,-0.8988,-1.78,-0.2627,-0.8989,-1.819,-3.176,-0.8988,-1.476,0.0025,-0.0134,0,-3.176,-0.8988,1.863,-3.176,0.8155,-1.863,-3.176,0.8155,0,-3.176,0.8155,2.094,-1.441,-1.699,1.524,-2.561,-1.699,0,-2.561,-1.699,-1.524,-2.561,-1.699,-2.094,-1.441,-1.699,-1.516,-0.4945,-1.699,1.516,-0.4945,-1.699,1.553,-0.5642,2.069,1.929,-1.973,3.676,1.929,-3.176,3.35,0,-1.973,4.847,0,-0.4757,3.505,1.514,-0.2808,1.028,2.316,-1.625,0.8155,-1.929,-1.973,3.676,-1.553,-0.5642,2.069,0,-3.176,4.521,-1.929,-3.176,3.35,-1.514,-0.2808,1.028,-2.316,-1.625,0.8155,0,-3.176,3.35,0,-0.0239,1.474]))})),
                                                  texCoord : new SFNode(
                                                    new TextureCoordinate({
                                        ...
                                        new Transform({
                                          ...
                                          children : new MFNode([
                                            new Shape({
                                              ...
                                              geometry : new SFNode(
                                                new IndexedFaceSet({
                                                  coordIndex : new MFInt32(new MFInt32([25,4,3,-1,26,25,3,-1,0,26,3,-1,1,10,26,-1,26,0,1,-1,1,9,12,-1,12,10,1,-1,2,4,25,-1,25,34,2,-1,6,8,31,-1,6,31,32,-1,5,6,32,-1,7,5,32,-1,32,11,7,-1,7,11,12,-1,12,9,7,-1,2,34,31,-1,31,8,2,-1,14,13,19,-1,17,16,15,-1,18,17,15,-1,19,18,15,-1,14,19,15,-1,0,13,14,-1,14,1,0,-1,1,14,15,-1,15,9,1,-1,9,15,16,-1,16,7,9,-1,7,16,17,-1,17,5,7,-1,5,17,18,-1,18,6,5,-1,6,18,19,-1,19,3,6,-1,3,19,13,-1,13,0,3,-1,2,8,6,-1,2,6,3,-1,4,2,3,-1,23,24,20,-1,20,21,23,-1,29,23,21,-1,21,22,29,-1,22,33,29,-1,20,25,26,-1,26,21,20,-1,26,10,22,-1,22,21,26,-1,10,12,33,-1,33,22,10,-1,34,25,20,-1,20,24,34,-1,23,27,28,-1,28,24,23,-1,29,30,27,-1,27,23,29,-1,30,29,33,-1,28,27,32,-1,32,31,28,-1,32,27,30,-1,30,11,32,-1,11,30,33,-1,33,12,11,-1,34,24,28,-1,28,31,34,-1])),
                                                  creaseAngle : new SFFloat(1.57),
                    ...
                    new HAnimJoint({
                      ...
                      center : new SFVec3f(new SFVec3f([0,26.58,-0.5601])),
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f(new SFVec3f([0,26.58,-0.5601])),
                              children : new MFNode([
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f(new SFVec3f([5.502,45.779999,-0.3559])),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f(new SFVec3f([5.502,45.779999,-0.3559])),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([6.735,35.669998,-0.4487])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({
                                ...
                                new HAnimJoint({
                                  ...
                                  children : new MFNode([
                                    new HAnimSegment({
                                      ...
                                      children : new MFNode([
                                        new Transform({
                                          translation : new SFVec3f(new SFVec3f([6.432,27.83,-0.1589])),
                                          children : new MFNode([
                                            new Shape({
                                              appearance : new SFNode(
                                                new Appearance({
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f(new SFVec3f([0,35.77,-0.5028])),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f(new SFVec3f([0,35.77,-0.5028])),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([0,49.98,-0.5228])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({

                    ...
                    new HAnimJoint({
                      ...
                      children : new MFNode([
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f([5.502,45.78,-0.3559]),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f([5.502,45.78,-0.3559]),
                                  child : new SFNode(
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              center : new SFVec3f([6.735,35.67,-0.4487]),
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f([6.735,35.67,-0.4487]),
                                      child : new SFNode(
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({

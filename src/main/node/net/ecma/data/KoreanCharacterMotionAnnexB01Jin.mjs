      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            ...
            new HAnimHumanoid({
              name : new SFString("AnnexB01Jin"),
              DEF : new SFString("hanim_AnnexB01Jin"),
                                ...
                                new Appearance({
                                  ...
                                  texture : new SFNode(
                                    new ImageTexture({
                                      ...
                                      url : new MFString(["Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/Jin.png"])}))})),
                              geometry : new SFNode(
                                new IndexedFaceSet({
            ...
            new Group({
              ...
              children : new MFNode([
                ...
                new PositionInterpolator({
                  DEF : new SFString("Keyframe_HumanoidRootTranslation"),
                  key : new MFFloat([0,1]),
                  keyValue : new MFVec3f([0,0,0,0,0,0])}),

                new OrientationInterpolator({
                  DEF : new SFString("Keyframe_HumanoidRootOrientation"),
                  key : new MFFloat([0,1]),
                ...
                new ROUTE({
                  ...
                  toNode : new SFString("Keyframe_HumanoidRootTranslation")}),

                new ROUTE({
                  fromField : new SFString("fraction_changed"),
                  fromNode : new SFString("KeyframeTimer"),
                  toField : new SFString("set_fraction"),
                  toNode : new SFString("Keyframe_HumanoidRootOrientation")}),
                ...
                new ROUTE({
                  ...
                  fromNode : new SFString("Keyframe_HumanoidRootTranslation"),
                  toField : new SFString("translation"),
                  toNode : new SFString("hanim_HumanoidRoot")}),

                new ROUTE({
                  fromField : new SFString("value_changed"),
                  fromNode : new SFString("Keyframe_HumanoidRootOrientation"),

...
var X3D0 =  new X3D({
        ...
        new head({
          ...
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("A Seamless VRML Human, demonstrating the H-Anim 2001 Specification. Animation scripting via EcmaScript.")}),
            ...
            new meta({
              ...
              content : new SFString("17 November 2014")}),
            ...
            new meta({
              ...
              content : new SFString("reconcile z-coordinate mismatches using source anthropometry, see source for details")}),

            new meta({
              name : new SFString("reference"),
              content : new SFString("http://h-anim.org/Models/H-Anim2001/boxman")}),
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/BoxManC.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          ...
          { "#comment" : new CommentsBlock("H-Anim node prototypes are provided automatically by the X3dToVrml97.xsl translation stylesheet when converting to VRML97 (which didn't include H-Anim)") },
            ...
            new HAnimHumanoid({
                    ...
                    new HAnimJoint({
                      ...
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          { "#comment" : new CommentsBlock("TODO reconcile z-coordinate mismatch using source anthropometry") },
                          children : new MFNode([
                            new Transform({
                        ...
                        new HAnimJoint({
                          ...
                          displacers : new SFNode(
                            new HAnimDisplacer({
                              ...
                              displacements : new MFVec3f([0,0.031993,0]),
                              coordIndex : new MFInt32([168]),
                              weight : new SFFloat(1)})),
                          children : new MFNode([
                            new HAnimSegment({
                                      ...
                                      children : new MFNode([
                                        ...
                                        new Transform({
                                          ...
                                          children : new MFNode([
                                            new Shape({
                                              USE : new SFString("SphereRed")})])})])})])})])})])})])})])})),
              { "#comment" : new CommentsBlock("# sacrum (12) # l_thigh (28) # l_calf (24) # l_hindfoot (8) # l_middistal (8) # r_thigh (28) # r_calf (24) # r_hindfoot (8) # r_middistal (8) # l5 (20) # skull (8) # l_upperarm (8) # l_forearm (8) # l_hand (8) # r_upperarm (8) # r_forearm (8) # r_hand (8)") },
              { "#comment" : new CommentsBlock("top-level joint references") },
              { "#comment" : new CommentsBlock("top-level site references") },
              { "#comment" : new CommentsBlock("top-level segment references") },
              { "#comment" : new CommentsBlock("top-level viewpoint references") },
                ...
                new Group({
                  children : new MFNode([
                    new Shape({
                      ...
                      { "#comment" : new CommentsBlock("# 0: sacrum (8) # 1: l_hip joint (8) # 2: r_hip joint (8) # 3: l_thigh (48) # 4: l_knee joint (8) # 5: l_calf (40) # 10: r_thigh (48) # 11: r_knee joint (8) # 12: r_calf (40)") },
                      geometry : new SFNode(
                        new IndexedFaceSet({
                        ...
                        new Appearance({
                          material : new SFNode(
                            new Material({
                              ...
                              transparency : new SFFloat(0.5)}))})),
                      { "#comment" : new CommentsBlock("# 6: l_ankle joint (8) # 7: l_hindfoot (8) # 8: l_midtarsal joint (8) # 9: l_middistal (10) # 13: r_ankle joint (8) # 14: r_hindfoot (8) # 15: r_midtarsal joint (8) # 16: r_middistal (10)") },
                      geometry : new SFNode(
                        new IndexedFaceSet({
                        ...
                        new Appearance({
                          material : new SFNode(
                            new Material({
                              diffuseColor : new SFColor([1,1,0]),
                              transparency : new SFFloat(0.5)}))})),
                      { "#comment" : new CommentsBlock("# 17: vl5_joint (8) # 18: l5 (28) # 21: l_shoulder joint (8) # 22: l_upperarm (8) # 23: l_elbow joint (8) # 24: l_forearm (8) # 27: r_shoulder joint (8) # 28: r_upperarm (8) # 29: r_elbow joint (8) # 30: r_forearm (8)") },
                      geometry : new SFNode(
                        new IndexedFaceSet({
                        ...
                        new Appearance({
                          material : new SFNode(
                            new Material({
                              ...
                              transparency : new SFFloat(0.5)}))})),
                      { "#comment" : new CommentsBlock("# 19: skullbase joint (8) # 20: skull (10) # 25: l_wrist joint (8) # 26: l_hand (10) # 31: r_wrist joint (8) # 32: r_hand (10)") },
                      geometry : new SFNode(
                        new IndexedFaceSet({
                      ...
                      appearance : new SFNode(
                        new Appearance({
                          material : new SFNode(
                            new Material({
                              diffuseColor : new SFColor([0,0,0])}))})),
                      { "#comment" : new CommentsBlock("Combined set of prior IFS coordIndex values") },
                      geometry : new SFNode(
                        new IndexedLineSet({
              ...
              viewpoint : new SFNode(
                new Viewpoint({
                  ...
                  position : new SFVec3f([2,1,2])})),
              viewpoint : new SFNode(
                new Viewpoint({
                  DEF : new SFString("Best_View"),
                  description : new SFString("Best View"),
                  orientation : new SFRotation([0,1,0,-1.57]),
                  position : new SFVec3f([-2,0.25,0])})),
              viewpoint : new SFNode(
                new Viewpoint({
          ...
          { "#comment" : new CommentsBlock("ExternProtoDeclare name='LOA1_WalkAnimation' url='\"LOA1_WalkAnimation.wrl#LOA1_WalkAnimation\" \"https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/LOA1_WalkAnimation.wrl#LOA1_WalkAnimation\" \"http://h-anim.org/Models/H-Anim2001/boxman/protos/LOA1WalkAnimation.wrl#LOA1WalkAnimation\" \"LOA1_WalkAnimation.x3d#LOA1_WalkAnimation\" \"https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/LOA1_WalkAnimation.x3d#LOA1_WalkAnimation\" \"http://h-anim.org/Models/H-Anim2001/boxman/protos/LOA1WalkAnimation.x3d#LOA1WalkAnimation\"'> <field accessType='inputOutput' name='cycleInterval' type='SFTime'/> <field accessType='inputOutput' name='enabled' type='SFBool'/> <field accessType='inputOutput' name='loop' type='SFBool'/> <field accessType='inputOutput' name='startTime' type='SFTime'/> <field accessType='inputOutput' name='stopTime' type='SFTime'/> <field accessType='outputOnly' name='fraction_changed' type='SFFloat'/> <field accessType='outputOnly' name='HumanoidRoot_translation_changed' type='SFVec3f'/> <field accessType='outputOnly' name='HumanoidRoot_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='l_hip_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='l_knee_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='l_ankle_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='l_midtarsal_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='r_hip_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='r_knee_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='r_ankle_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='r_midtarsal_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='vl5_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='skullbase_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='l_shoulder_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='l_elbow_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='l_wrist_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='r_shoulder_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='r_elbow_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='r_wrist_rotation_changed' type='SFRotation'/> <field accessType='outputOnly' name='isActive' type='SFBool'/> </ExternProtoDeclare> <ProtoInstance DEF='ANIMATOR' name='LOA1_WalkAnimation'/") },
            ...
            new Group({
              ...
              { "#comment" : new CommentsBlock("ROUTE information for HUMANOIDROOT_POSITION_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new PositionInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='HumanoidRoot_translation_changed'/> </IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for HUMANOIDROOT_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },

                new OrientationInterpolator({
                  DEF : new SFString("HUMANOIDROOT_ANIMATOR"),
                  key : new MFFloat([0,1]),
                  keyValue : new MFRotation([0,1,0,0,0,1,0,0]),
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='HumanoidRoot_rotation_changed'/> </IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for SACROILIAC_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='lower_body_rotation_changed'/> </IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for L_HIP_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='l_hip_rotation_changed'/> </IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for L_KNEE_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='l_knee_rotation_changed'/> </IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for L_ANKLE_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='l_ankle_rotation_changed'/> </IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for L_MIDTARSAL_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },

                new OrientationInterpolator({
                  DEF : new SFString("L_MIDTARSAL_ANIMATOR"),
                  key : new MFFloat([0,0.5,1]),
                  keyValue : new MFRotation([1,0,0,0,1,0,0,-0.2,1,0,0,0]),
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='l_midtarsal_rotation_changed'/> </IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for R_HIP_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='r_hip_rotation_changed'/> </IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for R_KNEE_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='r_knee_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for R_ANKLE_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='r_ankle_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for R_MIDTARSAL_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },

                new OrientationInterpolator({
                  DEF : new SFString("R_MIDTARSAL_ANIMATOR"),
                  key : new MFFloat([0,0.5,1]),
                  keyValue : new MFRotation([1,0,0,-0.2,1,0,0,0,1,0,0,-0.2]),
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='r_midtarsal_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for VL5_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='vl5_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for SKULLBASE_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='skullbase_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for L_SHOULDER_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='l_shoulder_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for L_ELBOW_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='l_elbow_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for L_WRIST_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='l_wrist_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for R_SHOULDER_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='r_shoulder_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for R_ELBOW_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='r_elbow_rotation_changed'/> <IS") }}),
              { "#comment" : new CommentsBlock("ROUTE information for R_WRIST_ANIMATOR node: [from TIMER.fraction_changed to set_fraction ]") },
                ...
                new OrientationInterpolator({
                  ...
                  { "#comment" : new CommentsBlock("IS> <connect nodeField='value_changed' protoField='r_wrist_rotation_changed'/> <IS") }})])}),
            ...
            new ROUTE({
              ...
              toField : new SFString("set_fraction")}),
          { "#comment" : new CommentsBlock("Animation ROUTEs") },
            ...
            new ROUTE({
              fromNode : new SFString("TIMER"),
              fromField : new SFString("fraction_changed"),
              toNode : new SFString("hanim_skullbase_displacer"),

...
var CollisionCollection = require('./x3d.mjs');
var RigidBody = require('./x3d.mjs');
var CollidableShape = require('./x3d.mjs');
var Sphere = require('./x3d.mjs');
var SingleAxisHingeJoint = require('./x3d.mjs');
...
var X3D0 =  new X3D({
      ...
      head : new SFNode(
        new head({
          component : new SFNode(
            new component({
              name : new SFString("RigidBodyPhysics"),
              level : new SFInt32(2)})),
          component : new SFNode(
            new component({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("JinLOA1.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("16 February 2026")}),
            ...
            new meta({
              ...
              content : new SFString("This scene includes an EXPORT statement to simplify reuse of a large, complex HAnimHumanoid model by other X3D scenes.")}),
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinLOA1.x3d")}),

            new meta({
              name : new SFString("generator"),
              content : new SFString("3DS MAX, http://www.autodesk.com/products/atodesk-3ds-max/overview")}),
            ...
            new meta({
              name : new SFString("generator"),
              content : new SFString("X3dTidy, https://www.web3d.org/x3d/stylesheets/X3dTidy.html")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new HAnimHumanoid({
              name : new SFString("JinLOA1"),
              DEF : new SFString("hanim_JinLOA1"),
              loa : new SFInt32(1),
                ...
                new MetadataSet({
                  ...
                  value : new SFNode(
                    new MetadataString({
                      ...
                      reference : new SFString("validation testing"),
                ...
                new HAnimJoint({
                  ...
                  children : new MFNode([
                            ...
                            new Shape({
                              appearance : new SFNode(
                                new Appearance({
                                  ...
                                  texture : new SFNode(
                                    new ImageTexture({
                                      DEF : new SFString("JinLOA1TextureAtlas"),
                              ...
                              geometry : new SFNode(
                                new IndexedFaceSet({
                                  ...
                                  creaseAngle : new SFFloat(3.1416),
                                  coord : new SFNode(
                                    new Coordinate({
                                ...
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                                      ...
                                      texture : new SFNode(
                                        new ImageTexture({
                                          USE : new SFString("JinLOA1TextureAtlas")}))})),
                                  geometry : new SFNode(
                                    new IndexedFaceSet({
                                      coordIndex : new MFInt32([0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,5,-1,0,5,6,-1,0,6,7,-1,0,7,8,-1,0,8,9,-1,0,9,10,-1,0,10,11,-1,0,11,12,-1,0,12,1,-1,14,2,1,-1,1,13,14,-1,15,3,2,-1,2,14,15,-1,16,4,3,-1,3,15,16,-1,17,5,4,-1,4,16,17,-1,18,6,5,-1,5,17,18,-1,19,7,6,-1,6,18,19,-1,20,8,7,-1,7,19,20,-1,21,9,8,-1,8,20,21,-1,22,10,9,-1,9,21,22,-1,23,11,10,-1,10,22,23,-1,24,12,11,-1,11,23,24,-1,13,1,12,-1,12,24,13,-1,26,14,13,-1,13,25,26,-1,27,15,14,-1,14,26,27,-1,28,16,15,-1,15,27,28,-1,29,17,16,-1,16,28,29,-1,30,18,17,-1,17,29,30,-1,31,19,18,-1,18,30,31,-1,32,20,19,-1,19,31,32,-1,33,21,20,-1,20,32,33,-1,34,22,21,-1,21,33,34,-1,35,23,22,-1,22,34,35,-1,36,24,23,-1,23,35,36,-1,25,13,24,-1,24,36,25,-1,38,26,25,-1,25,37,38,-1,39,27,26,-1,26,38,39,-1,40,28,27,-1,27,39,40,-1,41,29,28,-1,28,40,41,-1,42,30,29,-1,29,41,42,-1,43,31,30,-1,30,42,43,-1,44,32,31,-1,31,43,44,-1,45,33,32,-1,32,44,45,-1,46,34,33,-1,33,45,46,-1,47,35,34,-1,34,46,47,-1,48,36,35,-1,35,47,48,-1,37,25,36,-1,36,48,37,-1,50,38,37,-1,37,49,50,-1,51,39,38,-1,38,50,51,-1,52,40,39,-1,39,51,52,-1,53,41,40,-1,40,52,53,-1,54,42,41,-1,41,53,54,-1,55,43,42,-1,42,54,55,-1,56,44,43,-1,43,55,56,-1,57,45,44,-1,44,56,57,-1,58,46,45,-1,45,57,58,-1,59,47,46,-1,46,58,59,-1,60,48,47,-1,47,59,60,-1,49,37,48,-1,48,60,49,-1,61,50,49,-1,61,51,50,-1,61,52,51,-1,61,53,52,-1,61,54,53,-1,61,55,54,-1,61,56,55,-1,61,57,56,-1,61,58,57,-1,61,59,58,-1,61,60,59,-1,61,49,60,-1]),
                                      creaseAngle : new SFFloat(3.1416),
                    ...
                    new HAnimJoint({
                      ...
                      center : new SFVec3f([0,40.07,-0.8527]),
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f([0,40.07,-0.8527]),
                              child : new SFNode(
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                                ...
                                new HAnimJoint({
                                  ...
                                  children : new MFNode([
                                    ...
                                    new HAnimJoint({
                                      ...
                                      center : new SFVec3f([7.808,31.46,-0.0585]),
                                      children : new MFNode([
                                        new HAnimSegment({
                                          ...
                                          children : new MFNode([
                                            new Transform({
                                              translation : new SFVec3f([7.808,31.46,-0.0585]),
                                              child : new SFNode(
                                                new Shape({
                                                  appearance : new SFNode(
                                                    new Appearance({
            ...
            new WorldInfo({
              title : new SFString("JinLOA1.x3d")}),
            ...
            new Viewpoint({
              ...
              description : new SFString("JinLOA1"),
              position : new SFVec3f([0,1,3])}),

            new RigidBodyCollection({
              DEF : new SFString("hanim_JinLOA1_rbc"),
              iterations : new SFInt32(3),
              metadata : new MFNode([
                new MetadataSet({
                  name : new SFString("HAnimHumanoid.info"),
                  reference : new SFString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid"),
                  value : new SFNode(
                    new MetadataString({
                      ...
                      value : new MFString(["2.0"])}))}),
              collider : new SFNode(
                new CollisionCollection({
                  appliedParameters : new MFString(["FRICTION_COEFFICIENT_1","SLIP_COEFFICIENTS"])})]),
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("sphere_rb"),
                  mass : new SFFloat(0),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("sphere_cs"),
                      shape : new SFNode(
                        new Shape({
                          ...
                          geometry : new SFNode(
                            new Sphere({
                              radius : new SFFloat(3)}))}))}))})),
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_r_radiocarpal_rb"),
                  position : new SFVec3f([-7.808,31.46,-0.0585]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_r_carpal_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_r_elbow_rb"),
                  position : new SFVec3f([-8.093,40.38,-0.2502]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_r_forearm_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_l_radiocarpal_rb"),
                  position : new SFVec3f([7.808,31.46,-0.0585]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_l_carpal_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_l_elbow_rb"),
                  position : new SFVec3f([8.093,40.38,-0.2502]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_l_forearm_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_r_shoulder_rb"),
                  position : new SFVec3f([-5.975,52,-0.1452]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_r_upperarm_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_l_shoulder_rb"),
                  position : new SFVec3f([5.975,52,-0.1452]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_l_upperarm_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_skullbase_rb"),
                  position : new SFVec3f([0,57.43,-0.6863]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_skull_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_r_metatarsophalangeal_2_rb"),
                  position : new SFVec3f([-3.854,3.64,0.7402]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_r_tarsal_proximal_phalanx_2_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_r_talocrural_rb"),
                  position : new SFVec3f([-3.854,3.939,-0.7038]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_r_talus_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_r_knee_rb"),
                  position : new SFVec3f([-4.116,17.26,-0.8639]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_r_calf_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_l_metatarsophalangeal_2_rb"),
                  position : new SFVec3f([3.854,3.64,0.7402]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_l_tarsal_proximal_phalanx_2_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_l_talocrural_rb"),
                  position : new SFVec3f([3.854,3.939,-0.7038]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_l_talus_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_l_knee_rb"),
                  position : new SFVec3f([4.116,17.26,-0.8639]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_l_calf_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_r_hip_rb"),
                  position : new SFVec3f([-4.207,32.02,-0.8155]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_r_thigh_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_l_hip_rb"),
                  position : new SFVec3f([4.207,32.02,-0.8155]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_l_thigh_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_vl5_rb"),
                  position : new SFVec3f([0,40.07,-0.8527]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_l5_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_sacroiliac_rb"),
                  position : new SFVec3f([0,35.8,-0.7076]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_pelvis_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
              ...
              bodies : new SFNode(
                new RigidBody({
                  DEF : new SFString("hanim_humanoid_root_rb"),
                  position : new SFVec3f([0,30.53,-0.7076]),
                  mass : new SFFloat(0.5),
                  geometry : new SFNode(
                    new CollidableShape({
                      DEF : new SFString("hanim_sacrum_cs"),
                      shape : new SFNode(
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
                            ...
                            new IndexedFaceSet({
                              ...
                              texCoord : new SFNode(
                                new TextureCoordinate({
                                  point : new MFVec2f([0.6211,0.5754,0.7851,0.572,0.7614,0.572,0.6907,0.5698,0.62,0.5698,0.6158,0.5702,0.5451,0.5702,0.4167,0.5698,0.5451,0.5702,0.6158,0.5702,0.62,0.5698,0.6907,0.5698,0.7614,0.572,0.8036,0.5346,0.7761,0.5346,0.6989,0.4838,0.6219,0.4428,0.6154,0.4438,0.5492,0.4639,0.4166,0.5346,0.5492,0.4639,0.6154,0.4438,0.6219,0.4428,0.6989,0.4838,0.7761,0.5346,0.7912,0.4044,0.7635,0.4044,0.7042,0.3925,0.6194,0.3907,0.6148,0.3907,0.545,0.3974,0.4163,0.4938,0.545,0.3974,0.6148,0.3907,0.6194,0.3907,0.7042,0.3925,0.7635,0.4044,0.795,0.3772,0.7662,0.3772,0.6945,0.3645,0.6236,0.3695,0.616,0.3695,0.5438,0.378,0.416,0.453,0.5438,0.378,0.616,0.3695,0.6236,0.3695,0.6945,0.3645,0.7662,0.3772,0.7887,0.3451,0.7635,0.3451,0.698,0.3508,0.6262,0.3508,0.6297,0.3503,0.5389,0.3503,0.4181,0.3884,0.5389,0.3503,0.6297,0.3503,0.6262,0.3508,0.698,0.3508,0.7635,0.3451,0.6237,0.3398])}))}))}))}))})),
              joints : new MFNode([
                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([0,35.8,-0.7076]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_humanoid_root_rb")})),
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_sacroiliac_rb")}))}),

                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([4.207,32.02,-0.8155]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_l_hip_rb")}))}),

                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([4.116,17.26,-0.8639]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_l_knee_rb")}))}),

                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([3.854,3.939,-0.7038]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_l_talocrural_rb")}))}),

                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([3.854,3.64,0.7402]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_l_metatarsophalangeal_2_rb")}))}),
                ...
                new SingleAxisHingeJoint({
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_r_hip_rb")}))}),
                ...
                new SingleAxisHingeJoint({
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_r_knee_rb")}))}),
                ...
                new SingleAxisHingeJoint({
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_r_talocrural_rb")}))}),
                ...
                new SingleAxisHingeJoint({
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_r_metatarsophalangeal_2_rb")}))}),

                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([0,40.07,-0.8527]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_vl5_rb")}))}),

                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([0,57.43,-0.6863]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_skullbase_rb")}))}),

                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([5.975,52,-0.1452]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_l_shoulder_rb")}))}),

                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([8.093,40.38,-0.2502]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_l_elbow_rb")}))}),

                new SingleAxisHingeJoint({
                  anchorPoint : new SFVec3f([7.808,31.46,-0.0585]),
                  axis : new SFVec3f([0,0,1]),
                  minAngle : new SFFloat(1.5708),
                  maxAngle : new SFFloat(1.5708),
                  body2 : new SFNode(
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_l_radiocarpal_rb")}))}),
                ...
                new SingleAxisHingeJoint({
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_r_shoulder_rb")}))}),
                ...
                new SingleAxisHingeJoint({
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_r_elbow_rb")}))}),
                ...
                new SingleAxisHingeJoint({
                  ...
                  body2 : new SFNode(
                    new RigidBody({
                      USE : new SFString("hanim_r_radiocarpal_rb")}))})])}),

            new EXPORT({
              aS : new SFString("JinLOA1"),
              localDEF : new SFString("hanim_JinLOA1")}),
            ...
            new ROUTE({
              fromNode : new SFString("hanim_humanoid_root_rb"),
              toNode : new SFString("hanim_humanoid_root"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_sacroiliac_rb"),
              toNode : new SFString("hanim_sacroiliac"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_l_hip_rb"),
              toNode : new SFString("hanim_l_hip"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_l_knee_rb"),
              toNode : new SFString("hanim_l_knee"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_l_talocrural_rb"),
              toNode : new SFString("hanim_l_talocrural"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_l_metatarsophalangeal_2_rb"),
              toNode : new SFString("hanim_l_metatarsophalangeal_2"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_r_hip_rb"),
              toNode : new SFString("hanim_r_hip"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_r_knee_rb"),
              toNode : new SFString("hanim_r_knee"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_r_talocrural_rb"),
              toNode : new SFString("hanim_r_talocrural"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_r_metatarsophalangeal_2_rb"),
              toNode : new SFString("hanim_r_metatarsophalangeal_2"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_vl5_rb"),
              toNode : new SFString("hanim_vl5"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_skullbase_rb"),
              toNode : new SFString("hanim_skullbase"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_l_shoulder_rb"),
              toNode : new SFString("hanim_l_shoulder"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_l_elbow_rb"),
              toNode : new SFString("hanim_l_elbow"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_l_radiocarpal_rb"),
              toNode : new SFString("hanim_l_radiocarpal"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_r_shoulder_rb"),
              toNode : new SFString("hanim_r_shoulder"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_r_elbow_rb"),
              toNode : new SFString("hanim_r_elbow"),
              fromField : new SFString("orientation"),
              toField : new SFString("rotation")}),

            new ROUTE({
              fromNode : new SFString("hanim_r_radiocarpal_rb"),

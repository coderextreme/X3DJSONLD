        ...
        new head({
          ...
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("12 July 2020")}),
        ...
        new Scene({
          children : new MFNode([
            ...
            new HAnimHumanoid({
              ...
              { "#comment" : new CommentsBlock("HAnimHumanoid original info='\"humanoidVersion=2.0\"'") },
              metadata : new MFNode([
                new MetadataSet({
                                ...
                                new Appearance({
                                  ...
                                  texture : new SFNode(
                                    new ImageTexture({
                                      ...
                                      url : new MFString(["Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/HAnimSpecification/Jin.png"])}))})),
                              geometry : new SFNode(
                                new IndexedFaceSet({
                    ...
                    new HAnimJoint({
                      ...
                      children : new MFNode([
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f([4.207,32.02,-0.8155]),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f([4.207,32.02,-0.8155]),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f([0,40.23,-0.8527]),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f([0,40.23,-0.8527]),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              center : new SFVec3f([5.975,52,-0.1452]),
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f([5.975,52,-0.1452]),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({
                                ...
                                new HAnimJoint({
                                  ...
                                  children : new MFNode([
                                    ...
                                    new HAnimJoint({
                                      ...
                                      center : new SFVec3f([7.808,31.46,-0.05849]),
                                      children : new MFNode([
                                        new HAnimSegment({
                                          ...
                                          children : new MFNode([
                                            new Transform({
                                              translation : new SFVec3f([7.808,31.46,-0.05849]),
                                              children : new MFNode([
                                                new Shape({
                                                  appearance : new SFNode(
                                                    new Appearance({

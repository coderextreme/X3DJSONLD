        ...
        new Scene({
          children : new MFNode([
            ...
            new ProtoDeclare({
              ...
              appinfo : new SFString("UniversalMediaMaterials prototype"),
              documentation : new SFString("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials"),
              { "#comment" : new CommentsBlock("computed conversion ambientIntensity=1.745282, normalized to 1.0") },
              ProtoBody : new SFNode(
                new ProtoBody({
                  children : new MFNode([
                    new Material({
            ...
            new ProtoDeclare({
              ...
              appinfo : new SFString("UniversalMediaMaterials prototype"),
              documentation : new SFString("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials"),
              { "#comment" : new CommentsBlock("computed conversion ambientIntensity=2.226234, normalized to 1.0") },
              ProtoBody : new SFNode(
                new ProtoBody({
                  children : new MFNode([
                    new Material({

...
var X3D0 =  new X3D({
        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("KoreanCharacter01Jin.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter01Jin.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("KoreanCharacter01Jin.x3d")}),
            ...
            new Viewpoint({
              ...
              description : new SFString("Jin"),
              position : new SFVec3f([0,1,3])}),

            new HAnimHumanoid({
              name : new SFString("Jin"),
              DEF : new SFString("hanim_Jin"),
              info : new MFString(["authorName=Chul Hee Jung and Myeong Won Lee","authorEmail=myeongwonlee@gmail.com","creationDate=31 March 2011","humanoidVersion=1.0","gender=female","height=1.5"]),
                            ...
                            new Shape({
                              appearance : new SFNode(
                                new Appearance({
                                  ...
                                  texture : new SFNode(
                                    new ImageTexture({
                                      DEF : new SFString("JinTextureAtlas"),
                                      url : new MFString(["images/Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/images/Jin.png"])}))})),
                              geometry : new SFNode(
                                new IndexedFaceSet({
                                ...
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                                      ...
                                      texture : new SFNode(
                                        new ImageTexture({
                                          USE : new SFString("JinTextureAtlas")}))})),
                                  geometry : new SFNode(
                                    new IndexedFaceSet({

        ...
        new head({
          ...
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter01Jin.x3d")}),
                            ...
                            new HAnimJoint({
                              ...
                              children : new MFNode([
                                ...
                                new HAnimJoint({
                                  ...
                                  center : new SFVec3f(new SFVec3f([7.808,31.459999,-0.05849])),
                                  children : new MFNode([
                                    new HAnimSegment({
                                      ...
                                      children : new MFNode([
                                        new Transform({
                                          translation : new SFVec3f(new SFVec3f([7.808,31.459999,-0.05849])),
                                          children : new MFNode([
                                            new Shape({
                                              appearance : new SFNode(
                                                new Appearance({

        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("bumpyfreewrl.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/bumpfreewrl.x3d")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("bumpyx_ite.x3d")}),

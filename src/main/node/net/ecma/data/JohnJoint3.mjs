        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("JohnJoint3.x3d")}),

            new meta({
              name : new SFString("identifier"),
              content : new SFString("http://www.web3d.org/x3d/content/examples/HumanoidAnimation/JohnJoint3.x3d")}),
                                    ...
                                    new HAnimJoint({
                                      ...
                                      child : new SFNode(
                                        new Shape({
                                          geometry : new SFNode(
                                            new LineSet({
                                              vertexCount : new MFInt32([1]),
                                              coord : new SFNode(
                                                new Coordinate({
                                                  point : new MFVec3f([0,1,0])})),

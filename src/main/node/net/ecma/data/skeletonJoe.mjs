        ...
        new head({
          ...
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/JohnBoy.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            ...
            new Transform({
              { "#comment" : new CommentsBlock("DEF for markerfor XYZ axes") },
              children : new MFNode([
                new Shape({
            ...
            new Group({
              { "#comment" : new CommentsBlock("DEFS for markers of skeleton joints, segments, and sites") },
              children : new MFNode([
                new Transform({
                  children : new MFNode([
                    new Transform({

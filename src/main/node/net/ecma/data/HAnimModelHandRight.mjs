        ...
        new Scene({
          children : new MFNode([
            ...
            new HAnimHumanoid({
                    ...
                    new HAnimJoint({
                      ...
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          description : new SFString("test diagnostic to compare name with expected HAnimSegment name for parent HAnimJoint"),
                          children : new MFNode([
                            new Transform({
                              children : new MFNode([
                                new Shape({
                      ...
                      { "#comment" : new CommentsBlock("MC12") },
                        ...
                        new HAnimJoint({
                          name : new SFString("r_midcarpal_12"),
                          DEF : new SFString("hanim_r_midcarpal_12"),
              ...
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("hanim_r_midcarpal_12")})),
              joints : new SFNode(
                new HAnimJoint({

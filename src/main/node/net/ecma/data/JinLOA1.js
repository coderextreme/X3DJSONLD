            ...
            new HAnimHumanoid({
              ...
              metadata : new MFNode([
                new MetadataSet({
                  ...
                  value : new SFNode(
                    new MetadataFloat({
                      name : new SFString("weight"),
                      value : new MFFloat([50])})),
                  value : new SFNode(
                    new MetadataString({
                      name : new SFString("humanoidVersion"),
                      value : new MFString(["validation testing"])}))}),
              joints : new MFNode([
                new HAnimJoint({
                                ...
                                new HAnimJoint({
                                  ...
                                  children : new MFNode([
                                    ...
                                    new HAnimJoint({
                                      ...
                                      center : new SFVec3f([7.808,31.459999,-0.05849]),
                                      ulimit : new MFFloat([0,0,0]),
                                      llimit : new MFFloat([0,0,0]),
                                      children : new MFNode([
                                        new HAnimSegment({
                                          ...
                                          children : new MFNode([
                                            new Transform({
                                              translation : new SFVec3f([7.808,31.459999,-0.05849]),
                                              children : new MFNode([
                                                new Shape({
                                                  appearance : new SFNode(
                                                    new Appearance({

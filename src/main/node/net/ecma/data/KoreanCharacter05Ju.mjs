...
var X3D0 =  new X3D({
        ...
        new head({
          ...
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("KoreanCharacter05Ju.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("HAnimJoint and HAnimSegment names upgraded to HAnim2 but graph topology has inconsistencies that do not match loa=1 specification hierarchy")}),
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter05Ju.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("KoreanCharacter05Ju.x3d")}),
            ...
            new Viewpoint({
              ...
              description : new SFString("Ju"),
              position : new SFVec3f(new SFVec3f([0,1,3]))}),

            new HAnimHumanoid({
              name : new SFString("Ju"),
              DEF : new SFString("hanim_Ju"),
              ...
              joints : new SFNode(
                new HAnimJoint({
                  ...
                  center : new SFVec3f(new SFVec3f([0,36,-0.008798])),
                  children : new MFNode([
                    new HAnimSegment({
                      ...
                      children : new MFNode([
                        new Transform({
                          translation : new SFVec3f(new SFVec3f([0,36,-0.008798])),
                          children : new MFNode([
                            new Shape({
                              appearance : new SFNode(
                                new Appearance({
                                  ...
                                  texture : new SFNode(
                                    new ImageTexture({
                                      DEF : new SFString("JuTextureAtlas"),
                                      url : new MFString(new MFString(["images/Ju.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ju.png"]))}))})),
                              geometry : new SFNode(
                                new IndexedFaceSet({
                    ...
                    new HAnimJoint({
                      ...
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f(new SFVec3f([3.22,33.619999,-0.2832])),
                              children : new MFNode([
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                                      ...
                                      texture : new SFNode(
                                        new ImageTexture({
                                          USE : new SFString("JuTextureAtlas")}))})),
                                  geometry : new SFNode(
                                    new IndexedFaceSet({
                        ...
                        new HAnimJoint({
                          ...
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f(new SFVec3f([3.454,18.67,-0.02158])),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([3.467,3.522,0.118])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({
                                ...
                                new HAnimJoint({
                                  ...
                                  children : new MFNode([
                                    new HAnimSegment({
                                      ...
                                      children : new MFNode([
                                        new Transform({
                                          translation : new SFVec3f(new SFVec3f([3.467,3.251,1.465])),
                                          children : new MFNode([
                                            new Shape({
                                              appearance : new SFNode(
                                                new Appearance({
                        ...
                        new HAnimJoint({
                          ...
                          children : new MFNode([
                            ...
                            new HAnimJoint({
                              ...
                              center : new SFVec3f(new SFVec3f([-3.679,3.522,0.118])),
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([-3.679,3.522,0.118])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({
                                ...
                                new HAnimJoint({
                                  ...
                                  center : new SFVec3f(new SFVec3f([-3.679,3.251,1.465])),
                                  children : new MFNode([
                                    new HAnimSegment({
                                      ...
                                      children : new MFNode([
                                        new Transform({
                                          translation : new SFVec3f(new SFVec3f([-3.679,3.251,1.465])),
                                          children : new MFNode([
                                            new Shape({
                                              appearance : new SFNode(
                                                new Appearance({
                    ...
                    new HAnimJoint({
                      ...
                      center : new SFVec3f(new SFVec3f([0.000034,31.26,-0.008798])),
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f(new SFVec3f([0.000034,31.26,-0.008798])),
                              children : new MFNode([
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                        ...
                        new HAnimJoint({
                          ...
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f(new SFVec3f([4.778,51.029999,-2.069])),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([5.297,40.119999,-2.055])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({
                                ...
                                new HAnimJoint({
                                  ...
                                  children : new MFNode([
                                    new HAnimSegment({
                                      ...
                                      children : new MFNode([
                                        new Transform({
                                          translation : new SFVec3f(new SFVec3f([5.07,31.99,-1.559])),
                                          children : new MFNode([
                                            new Shape({
                                              appearance : new SFNode(
                                                new Appearance({
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f(new SFVec3f([0.000025,39.84,0.1163])),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f(new SFVec3f([0.000025,39.84,0.1163])),
                                  children : new MFNode([
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f(new SFVec3f([0.000025,56.07,-1.554])),
                                      children : new MFNode([
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({

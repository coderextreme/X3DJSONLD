        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("Sat, 30 Dec 2023 07:50:57 GMT")}),
                ...
                new HAnimJoint({
                  ...
                  children : new MFNode([
                    ...
                    new HAnimJoint({
                      ...
                      center : new SFVec3f([3.22,33.62,-0.2832]),
                      children : new MFNode([
                        new HAnimSegment({
                          ...
                          children : new MFNode([
                            new Transform({
                              translation : new SFVec3f([3.22,33.62,-0.2832]),
                              child : new SFNode(
                                new Shape({
                                  appearance : new SFNode(
                                    new Appearance({
                    ...
                    new HAnimJoint({
                      ...
                      children : new MFNode([
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f([4.778,51.03,-2.069]),
                          children : new MFNode([
                            new HAnimSegment({
                              ...
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f([4.778,51.03,-2.069]),
                                  child : new SFNode(
                                    new Shape({
                                      appearance : new SFNode(
                                        new Appearance({
                            ...
                            new HAnimJoint({
                              ...
                              center : new SFVec3f([5.297,40.12,-2.055]),
                              children : new MFNode([
                                new HAnimSegment({
                                  ...
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f([5.297,40.12,-2.055]),
                                      child : new SFNode(
                                        new Shape({
                                          appearance : new SFNode(
                                            new Appearance({

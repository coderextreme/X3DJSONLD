        ...
        new head({
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("F16.x3d")}),

            new meta({
              name : new SFString("description"),
              content : new SFString("F-16, The Fighting Falcon, Turkish Air Force (TUAF), Turkey")}),

            new meta({
              name : new SFString("creator"),
              content : new SFString("Murat ONDER, LTJG, Turkish Navy")}),

            new meta({
              name : new SFString("creator"),
              content : new SFString("The coordinates of the main body (Except landing gears, nose antenna, flag, weapons, missile holders, cockpit, cockpit seat and fuel tanks) are mostly similar to the model of Soji Yamakawa and used with permission.")}),

            new meta({
              name : new SFString("created"),
              content : new SFString("13 July 2003")}),
            ...
            new meta({
              ...
              content : new SFString("http://www.fas.org/man/dod-101/sys/ac/f-16.htm")}),

            new meta({
              name : new SFString("permission"),
              content : new SFString("Here is a copy of the permission for the usage of the main hull; -----Original Message----- From: Soji Yamakawa [mailto:soji@andrew.cmu.edu] Sent: Tuesday, September 16, 2003 8:00 PM To: Onder, Murat TUR Subject: Re: VRML model points usage permission Sure. No problem. Soji ----- Original Message ----- From: \"Murat Onder\" <monder@nps.navy.mil> To: <Soji_Yamakawa@cmu.edu>; <PEB01130@nifty.ne.jp> Sent: Monday, September 15, 2003 3:50 PM Subject: VRML model points usage permission Hi Sir, I&apos;m a MS student in Naval Postgraduate School. I'm making a model of Turkish F-16 for my project in a VRML course. For the main hull of the F-16, I want to use the coordinate points of your VRML model since I think that model represents well enough F-16. This is going to be only a student project and will not be used for any commercial purposes. Of course I'll make the citation and put the reference links to your page in the meta files of x3d file. I'd like to know if you can give permission to use those points in my model. V/R, Murat Onder LTJG, TU NAVY")}),

            new meta({
              name : new SFString("reference"),
              content : new SFString("The landing gears are taken from the Savage Archive, from F18 Blue Angel, then modified and re-animated.")}),

            new meta({
              name : new SFString("drawing"),
              content : new SFString("\"Drawing.jpg\" \"../../../Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Drawing.jpg\" \"https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Drawing.jpg\"")}),

            new meta({
              name : new SFString("Image"),
              content : new SFString("\"FrontView.jpg\" \"FrontView2.jpg\" \"Missiles.jpg\" \"../../../Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FrontView.jpg\" \"https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FrontView.jpg\" \"../../../Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FrontView2.jpg\" \"https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FrontView2.jpg\" \"../../../Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Missiles.jpg\" \"https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Missiles.jpg\"")}),

            new meta({
              name : new SFString("identifier"),
              content : new SFString("https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/F16.x3d")}),

            new meta({
              name : new SFString("subject"),
              content : new SFString("F16, F-16, Fighting Falcon")}),
        ...
        new Scene({
          children : new MFNode([
              ...
              children : new MFNode([
                new Transform({
                  ...
                  children : new MFNode([
                    ...
                    new Shape({
                      ...
                      geometry : new SFNode(
                        new IndexedFaceSet({
                          coordIndex : new MFInt32([2,32,33,-1,34,32,2,-1,35,36,37,-1,38,36,35,-1,39,40,41,-1,37,36,42,-1,2,43,44,-1,33,43,2,-1,45,37,42,46,-1,46,42,47,48,-1,33,45,46,43,-1,43,46,48,44,-1,34,49,50,32,-1,32,50,45,33,-1,49,38,35,50,-1,50,35,37,45,-1]),
                          creaseAngle : new SFFloat(0.5),
                          normalIndex : new MFInt32([2,22,23,-1,24,22,2,-1,25,26,27,-1,28,26,25,-1,29,29,29,-1,27,26,30,-1,2,31,32,-1,23,31,2,-1,33,27,30,34,-1,34,30,35,36,-1,23,33,34,31,-1,31,34,36,32,-1,24,37,38,22,-1,22,38,33,23,-1,37,28,25,38,-1,38,25,27,33,-1]),
                          solid : new SFBool(false),
                          coord : new SFNode(
                            new Coordinate({
                    ...
                    new Shape({
                      ...
                      geometry : new SFNode(
                        new IndexedFaceSet({
                          coordIndex : new MFInt32([186,187,188,189,190,-1,190,191,192,193,186,-1]),
                          creaseAngle : new SFFloat(0.5),
                          normalIndex : new MFInt32([118,119,120,121,122,-1,122,123,124,125,118,-1]),
                          solid : new SFBool(false),
                          coord : new SFNode(
                            new Coordinate({
                              USE : new SFString("coordinates")})),
                    ...
                    new Shape({
                      ...
                      appearance : new SFNode(
                        new Appearance({
                          material : new SFNode(
                            new Material({
                              diffuseColor : new SFColor([0.2304,0.2304,0.2304])}))})),
                      geometry : new SFNode(
                        new IndexedFaceSet({
                          coordIndex : new MFInt32([194,130,173,195,196,197,-1,197,198,199,82,81,194,-1]),
                          creaseAngle : new SFFloat(0.5),
                          normalIndex : new MFInt32([126,126,126,126,126,126,-1,126,126,126,126,126,126,-1]),
                          solid : new SFBool(false),
                          coord : new SFNode(
                            new Coordinate({
                              USE : new SFString("coordinates")})),
                    ...
                    new Shape({
                      ...
                      appearance : new SFNode(
                        new Appearance({
                          material : new SFNode(
                            new Material({
                              diffuseColor : new SFColor([0.6,0.6,0.6])}))})),
                      geometry : new SFNode(
                        new IndexedFaceSet({
                          coordIndex : new MFInt32([12,200,201,15,-1,19,48,127,17,-1,15,201,128,5,-1,17,127,202,11,-1,11,202,200,12,-1,5,128,49,1,-1,48,19,44,-1,19,2,44,-1,34,1,49,-1,34,2,1,-1]),
                          creaseAngle : new SFFloat(0.5),
                          normalIndex : new MFInt32([8,127,128,11,-1,15,36,83,13,-1,11,128,85,5,-1,13,83,129,7,-1,7,129,127,8,-1,5,85,37,1,-1,36,15,32,-1,15,2,32,-1,24,1,37,-1,24,2,1,-1]),
                          solid : new SFBool(false),
                          coord : new SFNode(
                            new Coordinate({
                              USE : new SFString("coordinates")})),
                    ...
                    new Shape({
                      ...
                      appearance : new SFNode(
                        new Appearance({
                          material : new SFNode(
                            new Material({
                              diffuseColor : new SFColor([0.37,0.37,0.37]),
                              shininess : new SFFloat(0.5)}))})),
                      geometry : new SFNode(
                        new IndexedFaceSet({
                          coordIndex : new MFInt32([64,186,193,165,-1,203,204,164,163,-1,192,191,138,142,-1,191,190,96,138,-1,94,96,190,189,-1,95,94,189,188,-1,63,187,186,64,-1,62,61,205,206,-1]),
                          creaseAngle : new SFFloat(0.5),
                          normalIndex : new MFInt32([50,118,125,107,-1,130,130,130,130,-1,124,123,91,94,-1,123,122,75,91,-1,73,75,122,121,-1,74,73,121,120,-1,49,119,118,50,-1,131,131,131,131,-1]),
                          solid : new SFBool(false),
                          coord : new SFNode(
                            new Coordinate({
                              USE : new SFString("coordinates")})),
                    ...
                    new Shape({
                      ...
                      appearance : new SFNode(
                        new Appearance({
                          material : new SFNode(
                            new Material({
                              emissiveColor : new SFColor([0.1796,0.1914,0.2382])}))})),
                      geometry : new SFNode(
                        new IndexedFaceSet({
                    ...
                    new Shape({
                      ...
                      geometry : new SFNode(
                        new IndexedFaceSet({
                          coordIndex : new MFInt32([0,1,2,3,-1,4,5,1,0,-1,10,11,12,13,-1,14,15,5,4,-1,13,12,15,14,-1,16,17,11,10,-1,18,19,17,16,-1,3,2,19,18,-1]),
                          creaseAngle : new SFFloat(0.5),
                          normalIndex : new MFInt32([0,1,2,3,-1,4,5,1,0,-1,6,7,8,9,-1,10,11,5,4,-1,9,8,11,10,-1,12,13,7,6,-1,14,15,13,12,-1,3,2,15,14,-1]),
                          solid : new SFBool(false),
                          coord : new SFNode(
                            new Coordinate({
                              USE : new SFString("coordinates")})),
                ...
                new Transform({
                  ...
                  children : new MFNode([
                    ...
                    new Transform({
                      DEF : new SFString("DownButtonTransform"),
                      rotation : new SFRotation([1,0,0,1.57]),
                      scale : new SFVec3f([0.008,0.008,0.008]),
                        ...
                        new Shape({
                          geometry : new SFNode(
                            new Text({
                              ...
                              string : new MFString(["YELLOW Button","Gear Down"])})),
                          appearance : new SFNode(
                            new Appearance({
                              material : new SFNode(
                                new Material({
                ...
                new Viewpoint({
                  ...
                  orientation : new SFRotation([-0.559,-0.827,-0.057,1.3534]),
                  position : new SFVec3f([-28.7,19.9,17.4])}),

                new Viewpoint({
                  description : new SFString("Cockpit"),
                  orientation : new SFRotation([-1,0,0,0.1249]),
                  position : new SFVec3f([0,1.5,-7.9])}),

                new Viewpoint({
                  DEF : new SFString("LandingGearAnimationView"),
                  description : new SFString("Landing Gear Animation View"),
                  orientation : new SFRotation([-0.003,1,-0.012,2.5741]),
                  position : new SFVec3f([16.1,-5.8,-24.6])}),

                new Viewpoint({
                  description : new SFString("Cockpit Left View"),
                  orientation : new SFRotation([-0.276,-0.922,-0.271,1.2338]),
                  position : new SFVec3f([-6.7,6.1,-3.9])}),

                new Viewpoint({
                  description : new SFString("F-16 Front View"),
                  orientation : new SFRotation([-0.007,0.995,0.102,3.1152]),
                  position : new SFVec3f([-0.1,13.4,-65])}),

                new Viewpoint({
                  description : new SFString("Cockpit Target View"),
                  orientation : new SFRotation([-0.834,-0.523,-0.176,0.0875]),
                  position : new SFVec3f([0,2.4,-7.9])}),
            ...
            new OrientationInterpolator({
              DEF : new SFString("GearUpInterpolator"),
              key : new MFFloat([0,0.5,1]),
              keyValue : new MFRotation([1,0,0,0,1,0,0,-0.79,1,0,0,-1.92])}),

            new ROUTE({
              fromField : new SFString("touchTime"),
              fromNode : new SFString("TouchSensorUp"),
              toField : new SFString("set_startTime"),
              toNode : new SFString("WheelUp")}),

            new ROUTE({
              fromField : new SFString("fraction_changed"),
              fromNode : new SFString("WheelUp"),
              toField : new SFString("set_fraction"),
              toNode : new SFString("GearUpInterpolator")}),

            new ROUTE({
              fromField : new SFString("value_changed"),
              fromNode : new SFString("GearUpInterpolator"),
              toField : new SFString("set_rotation"),
              toNode : new SFString("FrontWheelTransform")}),

            new TimeSensor({
              DEF : new SFString("WheelDown"),
              cycleInterval : new SFTime(8)}),

            new OrientationInterpolator({
              DEF : new SFString("GearDownInterpolator"),
              key : new MFFloat([0,0.5,1]),
              keyValue : new MFRotation([1,0,0,-1.92,1,0,0,-0.79,1,0,0,0])}),

            new ROUTE({
              fromField : new SFString("touchTime"),
              fromNode : new SFString("TouchSensorDown"),
              toField : new SFString("set_startTime"),
              toNode : new SFString("WheelDown")}),

            new ROUTE({
              fromField : new SFString("fraction_changed"),
              fromNode : new SFString("WheelDown"),
              toField : new SFString("set_fraction"),
              toNode : new SFString("GearDownInterpolator")}),

            new ROUTE({
              fromField : new SFString("value_changed"),
              fromNode : new SFString("GearDownInterpolator"),
              toField : new SFString("set_rotation"),
              toNode : new SFString("FrontWheelTransform")}),
          /*Animation commands for Rear Right Wheel Starts*/

            new TimeSensor({
              DEF : new SFString("RRearUp1"),
              cycleInterval : new SFTime(8)}),

            new TimeSensor({
              DEF : new SFString("RRearDown1"),
              cycleInterval : new SFTime(8)}),

            new OrientationInterpolator({
              DEF : new SFString("RRearInterUp1"),
              key : new MFFloat([0,0.5,1]),
              keyValue : new MFRotation([-1,0,-1,0,-1,0,-1,0.44,-1,0,-1,1.92])}),

            new OrientationInterpolator({
              DEF : new SFString("RRearInterDown1"),
              key : new MFFloat([0,0.5,1]),
              keyValue : new MFRotation([-1,0,-1,1.92,-1,0,-1,0.44,-1,0,-1,0])}),

            new ROUTE({
              fromField : new SFString("touchTime"),
              fromNode : new SFString("TouchSensorDown"),
              toField : new SFString("set_startTime"),
              toNode : new SFString("RRearDown1")}),

            new ROUTE({
              fromField : new SFString("touchTime"),
              fromNode : new SFString("TouchSensorUp"),
              toField : new SFString("set_startTime"),
              toNode : new SFString("RRearUp1")}),

            new ROUTE({
              fromField : new SFString("fraction_changed"),
              fromNode : new SFString("RRearDown1"),
              toField : new SFString("set_fraction"),
              toNode : new SFString("RRearInterDown1")}),

            new ROUTE({
              fromField : new SFString("fraction_changed"),
              fromNode : new SFString("RRearUp1"),
              toField : new SFString("set_fraction"),
              toNode : new SFString("RRearInterUp1")}),

            new ROUTE({
              fromField : new SFString("value_changed"),
              fromNode : new SFString("RRearInterDown1"),
              toField : new SFString("set_rotation"),
              toNode : new SFString("RearRightWheelTransform")}),

            new ROUTE({
              fromField : new SFString("value_changed"),
              fromNode : new SFString("RRearInterUp1"),
              toField : new SFString("set_rotation"),
              toNode : new SFString("RearRightWheelTransform")}),
          /*Animation commands for Rear Left Wheel*/

            new TimeSensor({
              DEF : new SFString("LRearUp1"),
              cycleInterval : new SFTime(8)}),

            new TimeSensor({
              DEF : new SFString("LRearDown1"),
              cycleInterval : new SFTime(8)}),

            new OrientationInterpolator({
              DEF : new SFString("LRearInterUp1"),
              key : new MFFloat([0,0.5,1]),
              keyValue : new MFRotation([1,0,1,0,1,0,1,0.44,1,0,1,1.92])}),

            new OrientationInterpolator({
              DEF : new SFString("LRearInterDown1"),
              key : new MFFloat([0,0.5,1]),
              keyValue : new MFRotation([1,0,1,1.92,1,0,1,0.44,1,0,1,0])}),
            ...
            new ROUTE({
              ...
              fromNode : new SFString("TouchSensorDown"),
              toField : new SFString("set_startTime"),
              toNode : new SFString("LRearDown1")}),

            new ROUTE({
              fromField : new SFString("touchTime"),
              fromNode : new SFString("TouchSensorUp"),
              toField : new SFString("set_startTime"),
              toNode : new SFString("LRearUp1")}),

            new ROUTE({
              fromField : new SFString("fraction_changed"),
              fromNode : new SFString("LRearDown1"),
              toField : new SFString("set_fraction"),
              toNode : new SFString("LRearInterDown1")}),

            new ROUTE({
              fromField : new SFString("fraction_changed"),
              fromNode : new SFString("LRearUp1"),
              toField : new SFString("set_fraction"),
              toNode : new SFString("LRearInterUp1")}),

            new ROUTE({
              fromField : new SFString("value_changed"),
              fromNode : new SFString("LRearInterDown1"),
              toField : new SFString("set_rotation"),
              toNode : new SFString("RearLeftWheelTransform")}),

            new ROUTE({
              fromField : new SFString("value_changed"),
              fromNode : new SFString("LRearInterUp1"),
              toField : new SFString("set_rotation"),
              toNode : new SFString("RearLeftWheelTransform")}),

            new Background({
              groundAngle : new MFFloat([1.309,1.570796]),
              groundColor : new MFColor([0,0.3,0.7,0,0.35,0.75,0,0.4,0.8]),
              skyAngle : new MFFloat([1.309,1.571]),
              skyColor : new MFColor([0,0.3,0.8,0,0.5,1,1,1,1])}),

            new Transform({
              DEF : new SFString("RightmostAmraamTransform"),
              rotation : new SFRotation([-1,0,0,1.57]),
            ...
            new Transform({
              DEF : new SFString("SidewinderHolderTransformRight"),
            ...
            new Transform({
              DEF : new SFString("TurkishFlagTransformLeft"),
              rotation : new SFRotation([0,-1,0,1.57]),
            ...
            new Transform({
              DEF : new SFString("AmraamInnerTransformRight"),
              rotation : new SFRotation([-1,0,0,1.57]),
              scale : new SFVec3f([1.4,1.4,1.4]),
            ...
            new Transform({
              DEF : new SFString("AmraamInnerTransformLeft"),
              rotation : new SFRotation([-1,0,0,1.57]),
              scale : new SFVec3f([1.4,1.4,1.4]),
              translation : new SFVec3f([-12,-1.6,4.5]),
              children : new MFNode([
            ...
            new Transform({
              DEF : new SFString("SidewinderTransformLeft"),
              rotation : new SFRotation([-1,0,0,1.57]),
            ...
            new Transform({
              DEF : new SFString("FuelTankHolderTransformLeft"),
              rotation : new SFRotation([0,1,0,1.57]),
            ...
            new Transform({
              DEF : new SFString("FuelTankTransformRight"),
              rotation : new SFRotation([-1,0,0,1.57]),
              scale : new SFVec3f([1.5,1.5,1.5]),
            ...
            new PositionInterpolator({
              DEF : new SFString("MissilePath"),
              key : new MFFloat([0,0.1,1]),
              keyValue : new MFVec3f([-15.65,0,4.5,-15.65,-2,4.5,16,-50,-500])}),

            new ROUTE({
              fromField : new SFString("touchTime"),
              fromNode : new SFString("FireSensor"),
              toField : new SFString("set_startTime"),
              toNode : new SFString("FireClock")}),

            new ROUTE({
              fromField : new SFString("fraction_changed"),
              fromNode : new SFString("FireClock"),
              toField : new SFString("set_fraction"),
              toNode : new SFString("MissilePath")}),

            new ROUTE({
              fromField : new SFString("value_changed"),
              fromNode : new SFString("MissilePath"),
              toField : new SFString("set_translation"),
              toNode : new SFString("LeftmostAmraamTransform")}),

            new Viewpoint({
              DEF : new SFString("MissileLaunchView"),
              description : new SFString("Missile Fire View"),
              orientation : new SFRotation([0.094,-0.994,0.057,1.1716]),
              position : new SFVec3f([-344.3,-142.8,-27.7])}),

            new ROUTE({
              fromField : new SFString("isActive"),
              fromNode : new SFString("FireSensor"),
              toField : new SFString("set_bind"),
              toNode : new SFString("MissileLaunchView")}),

...
var X3D0 =  new X3D({
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              info : new MFString(new MFString(["HAnim 2.0 Default Joint Centers, Level Of Articulation (LOA) 1 -------------------------------------------------------- HANIM 1.1 (VRML 2.0) Author name: eMpTy (a.k.a. Matthew T. Beitler) HANIM 1.1 (VRML 2.0) Author email: beitler@graphics.cis.upenn.edu or beitler@acm.org HANIM 1.1 (VRML 2.0) Author homepage: http://www.cis.upenn.edu/~beitler HANIM 1.1 (VRML 2.0) Compliance Date: May 12, 1999 HANIM 1.1 Compliance Information: http://ece.uwaterloo.ca/~HAnim/ Construction Info (joint centers): The joint centers of this figure are based on the work of Norman Badler, director of the Center for Human Modeling and Simulation at the University of Pennsylvania. The original document which these joint centers are based on can be found at: http://www.cis.upenn.edu/~badler/anthro/89-71.ps, .pdf"])),
                ...
                new MetadataSet({
                  ...
                  value : new SFNode(
                    new MetadataString({
                      ...
                      value : new MFString(new MFString(["beitler@graphics.cis.upenn.edu beitler@acm.org"]))})),
                  value : new SFNode(
                    new MetadataString({
                      name : new SFString("authorName"),
                      value : new MFString(new MFString(["Matthew T. Beitler"]))})),
                  value : new SFNode(
                    new MetadataString({
                      name : new SFString("copyright"),
                      value : new MFString(new MFString(["Copyright 1999 Matthew T. Beitler"]))})),
                  value : new SFNode(
                    new MetadataString({
                      name : new SFString("humanoidVersion"),
                      value : new MFString(new MFString(["JointCenters 1.1 LOA1"]))})),
                  value : new SFNode(
                    new MetadataString({
                      name : new SFString("usageRestrictions"),
                      value : new MFString(new MFString(["PERMISSION TO FULLY USE THIS SCENE GRAPH IS GRANTED PROVIDED THIS COPYRIGHT INFORMATION AND DOCUMENTATION OF THE ORIGINAL AUTHOR IS INCLUDED. This humanoid scene graph is provided _as-is_ and without warranty of any kind express implied or otherwise including without limitation any warranty of merchantability or fitness for a particular purpose."]))}))}),
              joints : new SFNode(
                new HAnimJoint({
                  ...
                  children : new MFNode([
                    ...
                    new HAnimJoint({
                      ...
                      center : new SFVec3f(new SFVec3f([-0.00405,1.07,-0.0275])),
                      children : new MFNode([
                        new HAnimSegment({
                        ...
                        new HAnimJoint({
                          ...
                          center : new SFVec3f(new SFVec3f([0,1.43,-0.0458])),
                          children : new MFNode([
                            new HAnimSegment({

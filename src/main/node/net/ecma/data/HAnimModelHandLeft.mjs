        ...
        new head({
          ...
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("Left hand, using high-fidelity definitions for H-Anim version 2.2")}),
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/HAnimModelHandLeft.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            ...
            new HAnimHumanoid({
              name : new SFString("Humanoid_Left_hand"),
              DEF : new SFString("Humanoid_Left_hand"),
              ...
              joints : new SFNode(
                new HAnimJoint({
                  ...
                  children : new MFNode([
                    new HAnimJoint({
                      name : new SFString("l_radiocarpal_joint"),
                      DEF : new SFString("l_radiocarpal_joint"),
                      children : new MFNode([
                        new HAnimSegment({
                          name : new SFString("l_wrist"),
                          DEF : new SFString("l_wrist"),
                          children : new MFNode([
                            new Transform({
                              children : new MFNode([
                                new Shape({
                      ...
                      { "#comment" : new CommentsBlock("MC12") },
                        ...
                        new HAnimJoint({
                          name : new SFString("l_midcarpal_joint_12"),
                          DEF : new SFString("l_midcarpal_joint_12"),
                          center : new SFVec3f([0.1,0.1,0]),
                          children : new MFNode([
                            new HAnimSegment({
                              name : new SFString("l_trapezoid"),
                              DEF : new SFString("l_trapezoid"),
                              children : new MFNode([
                                new Transform({
                          ...
                          { "#comment" : new CommentsBlock("thumb finger") },
                            ...
                            new HAnimJoint({
                              name : new SFString("l_carpometacarpal_joint_1"),
                              DEF : new SFString("l_carpometacarpal_joint_1"),
                              center : new SFVec3f([0.2,0.15,0]),
                              children : new MFNode([
                                new HAnimSegment({
                                  name : new SFString("l_metacarpal_1"),
                                  DEF : new SFString("l_metacarpal_1"),
                                  children : new MFNode([
                                    new Transform({
                                ...
                                new HAnimJoint({
                                  name : new SFString("l_metacarpophalangeal_joint_1"),
                                  DEF : new SFString("l_metacarpophalangeal_joint_1"),
                                  ...
                                  children : new MFNode([
                                    ...
                                    new HAnimJoint({
                                      name : new SFString("l_interphalangeal_joint_1"),
                                      DEF : new SFString("l_interphalangeal_joint_1"),
                                        ...
                                        new HAnimSegment({
                                          ...
                                          children : new MFNode([
                                            ...
                                            new Shape({
                                              ...
                                              geometry : new SFNode(
                                                new IndexedLineSet({
                                                  DEF : new SFString("fingertip_l_interphalangeal_joint_1"),
                                                  coordIndex : new MFInt32([0,1]),
                                                  coord : new SFNode(
                                                    new Coordinate({
                          ...
                          { "#comment" : new CommentsBlock("index finger") },
                            ...
                            new HAnimJoint({
                              name : new SFString("l_carpometacarpal_joint_2"),
                              DEF : new SFString("l_carpometacarpal_joint_2"),
                              center : new SFVec3f([0.1,0.2,0]),
                              children : new MFNode([
                                new HAnimSegment({
                                  name : new SFString("l_metacarpal2"),
                                  DEF : new SFString("l_metacarpal2"),
                                  children : new MFNode([
                                    new Transform({
                                ...
                                new HAnimJoint({
                                  name : new SFString("l_metacarpophalangeal_joint_2"),
                                  DEF : new SFString("l_metacarpophalangeal_joint_2"),
                                  ...
                                  children : new MFNode([
                                    ...
                                    new HAnimJoint({
                                      name : new SFString("l_proximal_interphalangeal_joint_2"),
                                      DEF : new SFString("l_proximal_interphalangeal_joint_2"),
                                      ...
                                      children : new MFNode([
                                        ...
                                        new HAnimJoint({
                                          name : new SFString("l_distal_interphalangeal_joint_2"),
                                          DEF : new SFString("l_distal_interphalangeal_joint_2"),
                                            ...
                                            new HAnimSegment({
                                              ...
                                              children : new MFNode([
                                                ...
                                                new Shape({
                                                  ...
                                                  geometry : new SFNode(
                                                    new IndexedLineSet({
                                                      DEF : new SFString("fingertip_l_distal_interphalangeal_joint_2"),
                                                      coordIndex : new MFInt32([0,1]),
                                                      coord : new SFNode(
                                                        new Coordinate({
                      ...
                      { "#comment" : new CommentsBlock("MC3") },
                        ...
                        new HAnimJoint({
                          name : new SFString("l_midcarpal_joint_3"),
                          DEF : new SFString("l_midcarpal_joint_3"),
                          center : new SFVec3f([0,0.07,0]),
                          children : new MFNode([
                            new HAnimSegment({
                              name : new SFString("l_capitate"),
                              DEF : new SFString("l_capitate"),
                              children : new MFNode([
                                new Transform({
                          ...
                          { "#comment" : new CommentsBlock("Middle fingle") },
                            ...
                            new HAnimJoint({
                              name : new SFString("l_carpometacarpal_joint_3"),
                              DEF : new SFString("l_carpometacarpal_joint_3"),
                              center : new SFVec3f([0,0.2,0]),
                              children : new MFNode([
                                new HAnimSegment({
                                  name : new SFString("l_metacarpal3"),
                                  DEF : new SFString("l_metacarpal3"),
                                  children : new MFNode([
                                    new Transform({
                                ...
                                new HAnimJoint({
                                  name : new SFString("l_metacarpophalangeal_joint_3"),
                                  DEF : new SFString("l_metacarpophalangeal_joint_3"),
                                  ...
                                  children : new MFNode([
                                    ...
                                    new HAnimJoint({
                                      name : new SFString("l_proximal_interphalangeal_joint_3"),
                                      DEF : new SFString("l_proximal_interphalangeal_joint_3"),
                                      ...
                                      children : new MFNode([
                                        ...
                                        new HAnimJoint({
                                          name : new SFString("l_distal_interphalangeal_joint_3"),
                                          DEF : new SFString("l_distal_interphalangeal_joint_3"),
                                            ...
                                            new HAnimSegment({
                                              ...
                                              children : new MFNode([
                                                ...
                                                new Shape({
                                                  ...
                                                  geometry : new SFNode(
                                                    new IndexedLineSet({
                                                      DEF : new SFString("fingertip_l_distal_interphalangeal_joint_3"),
                                                      coordIndex : new MFInt32([0,1]),
                                                      coord : new SFNode(
                                                        new Coordinate({
                      ...
                      { "#comment" : new CommentsBlock("MC45") },
                        ...
                        new HAnimJoint({
                          name : new SFString("l_midcarpal_joint_12"),
                          DEF : new SFString("l_midcarpal_joint_45"),
                          center : new SFVec3f([-0.1,0.1,0]),
                          children : new MFNode([
                            new HAnimSegment({
                              name : new SFString("l_hamate"),
                              DEF : new SFString("l_hamate"),
                              children : new MFNode([
                                new Transform({
                                  translation : new SFVec3f([-0.1,0.1,0]),
                                  children : new MFNode([
                          ...
                          { "#comment" : new CommentsBlock("ring finger") },
                            ...
                            new HAnimJoint({
                              name : new SFString("l_carpometacarpal_joint_4"),
                              DEF : new SFString("l_carpometacarpal_joint_4"),
                              center : new SFVec3f([-0.1,0.2,0]),
                              children : new MFNode([
                                new HAnimSegment({
                                  name : new SFString("l_metacarpal4"),
                                  DEF : new SFString("l_metacarpal4"),
                                  children : new MFNode([
                                    new Transform({
                                      translation : new SFVec3f([-0.1,0.2,0]),
                                      children : new MFNode([
                                ...
                                new HAnimJoint({
                                  name : new SFString("l_metacarpophalangeal_joint_4"),
                                  DEF : new SFString("l_metacarpophalangeal_joint_4"),
                                  ...
                                  children : new MFNode([
                                    ...
                                    new HAnimJoint({
                                      name : new SFString("l_proximal_interphalangeal_joint_4"),
                                      DEF : new SFString("l_proximal_interphalangeal_joint_4"),
                                      ...
                                      children : new MFNode([
                                        ...
                                        new HAnimJoint({
                                          name : new SFString("l_distal_interphalangeal_joint_4"),
                                          DEF : new SFString("l_distal_interphalangeal_joint_4"),
                                          center : new SFVec3f([-0.1,0.93,0]),
                                          children : new MFNode([
                                            new HAnimSegment({
                                              name : new SFString("l_distal_phalanx4"),
                                              DEF : new SFString("l_distal_phalanx4"),
                                              children : new MFNode([
                                                new Transform({
                                                ...
                                                new Shape({
                                                  ...
                                                  geometry : new SFNode(
                                                    new IndexedLineSet({
                                                      DEF : new SFString("fingertip_l_distal_interphalangeal_joint_4"),
                                                      coordIndex : new MFInt32([0,1]),
                                                      coord : new SFNode(
                                                        new Coordinate({
                          ...
                          { "#comment" : new CommentsBlock("pinky finger") },
                            ...
                            new HAnimJoint({
                              name : new SFString("l_carpometacarpal_joint_5"),
                              DEF : new SFString("l_carpometacarpal_joint_5"),
                              center : new SFVec3f([-0.15,0.17,0]),
                              children : new MFNode([
                                new HAnimSegment({
                                  name : new SFString("l_metacarpal5"),
                                  DEF : new SFString("l_metacarpal5"),
                                  children : new MFNode([
                                    new Transform({
                                ...
                                new HAnimJoint({
                                  name : new SFString("l_metacarpophalangeal_joint_5"),
                                  DEF : new SFString("l_metacarpophalangeal_joint_5"),
                                  ...
                                  children : new MFNode([
                                    ...
                                    new HAnimJoint({
                                      name : new SFString("l_proximal_interphalangeal_joint_5"),
                                      DEF : new SFString("l_proximal_interphalangeal_joint_5"),
                                      ...
                                      children : new MFNode([
                                        ...
                                        new HAnimJoint({
                                          name : new SFString("l_distal_interphalangeal_joint_5"),
                                          DEF : new SFString("l_distal_interphalangeal_joint_5"),
                                            ...
                                            new HAnimSegment({
                                              ...
                                              children : new MFNode([
                                                ...
                                                new Shape({
                                                  ...
                                                  geometry : new SFNode(
                                                    new IndexedLineSet({
                                                      DEF : new SFString("fingertip_l_distal_interphalangeal_joint_5"),
                                                      coordIndex : new MFInt32([0,1]),
                                                      coord : new SFNode(
                                                        new Coordinate({
              ...
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_radiocarpal_joint")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_midcarpal_joint_12")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_carpometacarpal_joint_1")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_metacarpophalangeal_joint_1")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_interphalangeal_joint_1")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_carpometacarpal_joint_2")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_metacarpophalangeal_joint_2")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_proximal_interphalangeal_joint_2")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_distal_interphalangeal_joint_2")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_midcarpal_joint_3")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_carpometacarpal_joint_3")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_metacarpophalangeal_joint_3")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_proximal_interphalangeal_joint_3")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_distal_interphalangeal_joint_3")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_midcarpal_joint_45")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_carpometacarpal_joint_4")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_metacarpophalangeal_joint_4")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_proximal_interphalangeal_joint_4")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_distal_interphalangeal_joint_4")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_carpometacarpal_joint_5")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_metacarpophalangeal_joint_5")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_proximal_interphalangeal_joint_5")})),
              joints : new SFNode(
                new HAnimJoint({
                  USE : new SFString("l_distal_interphalangeal_joint_5")})),
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_wrist")})),
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_trapezoid")})),
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_metacarpal_1")})),
              segments : new SFNode(
                new HAnimSegment({
              ...
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_metacarpal2")})),
              segments : new SFNode(
                new HAnimSegment({
              ...
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_capitate")})),
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_metacarpal3")})),
              segments : new SFNode(
                new HAnimSegment({
              ...
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_hamate")})),
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_metacarpal4")})),
              segments : new SFNode(
                new HAnimSegment({
              ...
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_distal_phalanx4")})),
              segments : new SFNode(
                new HAnimSegment({
                  USE : new SFString("l_metacarpal5")})),
              segments : new SFNode(
                new HAnimSegment({

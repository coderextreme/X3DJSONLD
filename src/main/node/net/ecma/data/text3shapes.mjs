        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("text3shapes.x3d")}),

            new meta({
              name : new SFString("identifier"),
              content : new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/text3shapes.x3d")}),

            new meta({
              name : new SFString("description"),
              content : new SFString("3 text shapes")}),

...
var X3D0 =  new X3D({
        ...
        new head({
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("LOA1_StopAnimation.x3d")}),
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/LOA1_StopAnimation.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("LOA1_StopAnimation.x3d")}),

            new ProtoDeclare({
              name : new SFString("LOA1_StopAnimation"),

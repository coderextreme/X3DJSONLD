...
var X3D0 =  new X3D({
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              info : new MFString(new MFString(["VRML2.0 created with Version 1.3, from Alias Maya 2008"])),
            ...
            new Viewpoint({
              ...
              position : new SFVec3f(new SFVec3f([0,0.75,3]))}),
            ...
            new Transform({
              ...
              translation : new SFVec3f(new SFVec3f([0,-0.165,0.02])),
              children : new MFNode([
                new Switch({
                        ...
                        new Appearance({
                          ...
                          material : new SFNode(
                            new Material({
                              ...
                              diffuseColor : new SFColor(new SFColor([0.372322,0.371574,0.373173])),
                              shininess : new SFFloat(0.02),
                              specularColor : new SFColor(new SFColor([0.890909,0.887832,0.890909])),
                        ...
                        new IndexedFaceSet({
                          ...
                          coord : new SFNode(
                            new Coordinate({
                              ...
                              point : new MFVec3f(new MFVec3f([-0.36,-2.39,-0.26,-0.36,-1.77,-0.89,-0.36,0,-1.7,-0.36,0.85,-1.47,-0.36,1.47,-0.85,-0.36,1.7,0,-0.36,1.47,0.85,-0.36,-0.07,2.05,-0.36,-0.92,2.28,-0.36,-1.77,2.05,-0.36,-2.39,1.43,-0.36,-2.62,0.58,0.36,-2.39,-0.26,0.36,-1.77,-0.89,0.36,0,-1.7,0.36,0.85,-1.47,0.36,1.47,-0.85,0.36,1.7,0,0.36,1.47,0.85,0.36,-0.07,2.05,0.36,-0.92,2.28,0.36,-1.77,2.05,0.36,-2.39,1.43,0.36,-2.62,0.58,-0.36,-0.46,0.31,0.36,-0.46,0.31]))}))})),
                      appearance : new SFNode(
                        new Appearance({
                ...
                new Group({
                  children : new MFNode([
                    new Transform({
                      ...
                      rotation : new SFRotation(new SFRotation([-1,0,0,0.373518])),
                      translation : new SFVec3f(new SFVec3f([-0.038462,3.596312,3.297562])),
                      children : new MFNode([
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
                    ...
                    new Transform({
                      ...
                      scale : new SFVec3f(new SFVec3f([1,0.727134,0.801457])),
                      translation : new SFVec3f(new SFVec3f([-0.030769,1.738461,1.4436])),
                      children : new MFNode([
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
                    ...
                    new Transform({
                      ...
                      scale : new SFVec3f(new SFVec3f([1,1,0.569444])),
                      translation : new SFVec3f(new SFVec3f([0.015385,1.630769,-1.973274])),
                      children : new MFNode([
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({
                    ...
                    new Transform({
                      ...
                      scale : new SFVec3f(new SFVec3f([1.1,1.1,0.1])),
                      translation : new SFVec3f(new SFVec3f([-0.015385,1.628515,-2.569231])),
                      children : new MFNode([
                        new Shape({
                          appearance : new SFNode(
                            new Appearance({

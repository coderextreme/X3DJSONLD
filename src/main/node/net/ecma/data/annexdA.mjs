...
var X3D0 =  new X3D({
        ...
        new head({
          ...
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/KoreanCharacterAnnexD01Jin.x3d")}),
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("KoreanCharacterAnnexD01Jin.x3d")}),

            new NavigationInfo({
              speed : new SFFloat(1.5)}),
          { "#comment" : new CommentsBlock("Viewpoint centerOfRotation=\"0 1 0\" description=\"AnnexD01Jin\" position=\"0 35 113\"/") },

            new Viewpoint({
              centerOfRotation : new SFVec3f([0,1,0]),
              description : new SFString("AnnexD01Jin"),
              position : new SFVec3f([0,40,140])})])}))});

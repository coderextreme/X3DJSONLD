...
ecmascript:eval (0
            ...
            new ROUTE({
              ...
              fromField : new SFString("a_changed"),
              toNode : new SFString("fw"),
              toField : new SFString("set_a")}),

            new ROUTE({
              fromNode : new SFString("Animate"),
              fromField : new SFString("b_changed"),
              toNode : new SFString("fw"),
              toField : new SFString("set_b")}),

            new ROUTE({
              fromNode : new SFString("Animate"),
              fromField : new SFString("c_changed"),
              toNode : new SFString("fw"),
              toField : new SFString("set_c")}),

            new ROUTE({
              fromNode : new SFString("Animate"),
              fromField : new SFString("d_changed"),
              toNode : new SFString("fw"),
              toField : new SFString("set_d")}),

            new ROUTE({
              fromNode : new SFString("Animate"),
              fromField : new SFString("pdelta_changed"),
              toNode : new SFString("fw"),
              toField : new SFString("set_pdelta")}),

            new ROUTE({
              fromNode : new SFString("Animate"),
              fromField : new SFString("tdelta_changed"),
              toNode : new SFString("fw"),
              toField : new SFString("set_tdelta")})])}))});

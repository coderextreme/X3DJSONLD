        ...
        new head({
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("indexedfaceset_pixeltexture_plus.x3d")}),

            new meta({
              name : new SFString("Image"),
              content : new SFString("indexedfaceset_pixeltexture_plus-front.jpg")}),

            new meta({
              name : new SFString("Image"),
              content : new SFString("indexedfaceset_pixeltexture_plus-rear.jpg")}),

            new meta({
              name : new SFString("Image"),
              content : new SFString("indexedfaceset_pixeltexture_plus-top.jpg")}),

            new meta({
              name : new SFString("Image"),
              content : new SFString("indexedfaceset_pixeltexture_plus-bottom.jpg")}),

            new meta({
              name : new SFString("Image"),
              content : new SFString("indexedfaceset_pixeltexture_plus-left.jpg")}),

            new meta({
              name : new SFString("Image"),
              content : new SFString("indexedfaceset_pixeltexture_plus-right.jpg")}),
            ...
            new meta({
              ...
              content : new SFString("Test of browser ability to map a 3 times multiple of an PixelTexture onto an IndexedFaceSet geometry. A 3 by 3 matrix of four equal sized red, green, white and yellow squares in the pixel texture map all the faces of the cube.")}),

            new meta({
              name : new SFString("identifier"),
              content : new SFString("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plus.x3d")}),
                ...
                new IndexedFaceSet({
                  ...
                  texCoord : new SFNode(
                    new TextureCoordinate({
                      point : new MFVec2f(new MFVec2f([-1,2,-1,-1,2,2,2,-1]))}))}))})])}))});

                    ...
                    new Group({
                      children : new MFNode([
                        ...
                        new OrientationInterpolator({
                          ...
                          key : new MFFloat(new MFFloat([0,0.5,1])),
                          keyValue : new MFRotation(new MFRotation([1,0,0,0,1,0,0,-0.2,1,0,0,0])),
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
                        ...
                        new OrientationInterpolator({
                          ...
                          key : new MFFloat(new MFFloat([0,0.125,0.2083,0.2917,0.375,0.5,0.6667,0.7917,0.9167,1])),
                          keyValue : new MFRotation(new MFRotation([1,0,0,0.8573,1,0,0,0.8926,1,0,0,0.5351,1,0,0,0.1756,1,0,0,0.1194,1,0,0,0.3153,1,-1.176e-8,-4.971e-9,0.09354,1,0,0,0.08558,1,0,0,0.2475,1,0,0,0.8573])),
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
                        ...
                        new OrientationInterpolator({
                          ...
                          keyValue : new MFRotation(new MFRotation([0,0,1,0,-1,0,0,0.3533,-1,0,0,0.1072,1,0,0,0.2612,1,-1.641e-7,1.827e-8,0.1268,-1,0,0,0.01793,-1,0,0,0.05824,-1,0,0,0.2398,-1,0,0,0.35,-1,0,0,0.3322,0,0,1,0])),
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
                        ...
                        new OrientationInterpolator({
                          ...
                          key : new MFFloat(new MFFloat([0,0.5,1])),
                          keyValue : new MFRotation(new MFRotation([1,0,0,-0.2,1,0,0,0,1,0,0,-0.2])),
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
                        ...
                        new OrientationInterpolator({
                          ...
                          keyValue : new MFRotation(new MFRotation([1,0,0,0.1189,-1,-5.928e-7,1.525e-7,0.1861,1,-2.038e-7,-1.257e-7,0.3357,1,0,0,0.1189])),
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
                        ...
                        new OrientationInterpolator({
                          ...
                          key : new MFFloat(new MFFloat([0,0.375,0.9167,1])),
                          keyValue : new MFRotation(new MFRotation([-1,-1.58298e-7,8.15967e-8,0.0659878,-1,-3.28826e-8,-2.31665e-8,0.488383,-1,0.00000306462,-0.00000311947,0.0177536,-1,-1.58298e-7,8.15967e-8,0.0659878])),
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
                        ...
                        new OrientationInterpolator({
                          ...
                          key : new MFFloat(new MFFloat([0,0.375,0.9167,1])),
                          keyValue : new MFRotation(new MFRotation([0.00000151276,-1,0.0000017724,0.461076,-0.330195,-0.927451,0.175516,0.538852,0.0327774,-0.999314,-0.0172185,0.492033,0.00000151276,-1,0.0000017724,0.461076])),
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
                        ...
                        new OrientationInterpolator({
                          ...
                          key : new MFFloat(new MFFloat([0,0.375,0.9167,1])),
                          keyValue : new MFRotation(new MFRotation([-1,-7.689e-7,-1.48e-7,0.09346,1,5.004e-8,2.254e-8,0.3197,-1,-1.104e-7,5.267e-10,0.1564,-1,-7.689e-7,-1.48e-7,0.09346])),
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
                        ...
                        new OrientationInterpolator({
                          ...
                          key : new MFFloat(new MFFloat([0,0.375,0.9167,1])),
                          keyValue : new MFRotation(new MFRotation([-1,-4.45619e-8,2.70318e-8,0.411508,-1,8.16742e-7,-1.09556e-7,0.0925011,-1,-2.47628e-8,-7.02862e-9,0.572568,-1,-4.45619e-8,2.70318e-8,0.411508])),
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
            ...
            new Anchor({
              ...
              children : new MFNode([
                new Shape({
                  geometry : new SFNode(
                    new Text({
                      string : new MFString(new MFString(["LOA1_WalkAnimation.x3d","defines a prototype","for animating a humanoid.","","Click this text to see","InterchangableActorsViaDynamicRouting example."])),

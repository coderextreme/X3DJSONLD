        ...
        new head({
          meta : new MFNode([
            new meta({
              ...
              content : new SFString("gridBack.json")}),

            new meta({
              name : new SFString("description"),
              content : new SFString("Checkerboard grid background for X3D/VRML materials selection.")}),
            ...
            new meta({
              ...
              content : new SFString("8 April 2002")}),

            new meta({
              name : new SFString("modified"),
              content : new SFString("12 January 2014")}),
            ...
            new Shape({
              ...
              geometry : new SFNode(
                new IndexedFaceSet({
                  ...
                  color : new SFNode(
                    new Color({
                      color : new MFColor(new MFColor([0.5,0.5,0.5,0.75,0.75,0.75]))}))}))})])}))});

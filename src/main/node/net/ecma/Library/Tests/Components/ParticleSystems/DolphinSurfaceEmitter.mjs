        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("file:///home/holger/Projekte/Cobweb/excite/tests/Components/ParticleSystems/DolphinSurfaceEmitter.x3d")}),

            new meta({
              name : new SFString("modified"),
              content : new SFString("Sat, 30 Apr 2016 11:54:15 GMT")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            ...
            new ParticleSystem({
              ...
              particleLifetime : new SFFloat(1),

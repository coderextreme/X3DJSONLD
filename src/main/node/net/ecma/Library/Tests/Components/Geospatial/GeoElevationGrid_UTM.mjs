        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("file:///home/holger/Projekte/Cobweb/excite/tests/Components/Geospatial/GeoElevationGrid.UTM.x3d")}),

            new meta({
              name : new SFString("modified"),
              content : new SFString("Sat, 16 Apr 2016 16:50:33 GMT")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
              title : new SFString("GeoElevationGrid.UTM"),
              metadata : new MFNode([
                new MetadataSet({
                    ...
                    new MetadataSet({
                      ...
                      value : new SFNode(
                        new MetadataDouble({
                          ...
                          reference : new SFString("http://titania.create3000.de"),
                          value : new MFDouble([-7234615.07024952,-12259154.7395488,10094150.4329588])})),
                      value : new SFNode(
                        new MetadataDouble({
                          name : new SFString("orientation"),
                          DEF : new SFString("orientation"),
                          reference : new SFString("http://titania.create3000.de"),
                          value : new MFDouble([0.862673463069908,-0.242562620482203,-0.443799359237684,1.07653185497723])})),
                      value : new SFNode(
                        new MetadataDouble({
                          name : new SFString("centerOfRotation"),
                          DEF : new SFString("centerOfRotation"),
                          reference : new SFString("http://titania.create3000.de"),
                          value : new MFDouble([-35164.6857548207,0,-9.22524835922619e-13])}))})),
                  value : new SFNode(
                    new MetadataSet({
            ...
            new Transform({
              rotation : new SFRotation([1,0,0,1.5707963267949]),
              children : new MFNode([
                new Background({
                  skyAngle : new MFFloat([1.56287]),
                  skyColor : new MFColor([0.0343751,0.034375,0.275,0.702145,0.702145,1]),
                  groundAngle : new MFFloat([1.5708]),
                  groundColor : new MFColor([0.0343751,0.034375,0.275,0.702145,0.702145,1])})])}),

            new GeoViewpoint({
              description : new SFString("Initial GeoViewpoint"),
              position : new SFVec3d([35.1149156947289,-119.999998674153,11079190.0771837]),
              orientation : new SFRotation([-1,-1.32396391064704e-9,2.31940358896155e-10,1.56899698076057]),
            ...
            new Shape({
              appearance : new SFNode(
                new Appearance({
                  material : new SFNode(
                    new Material({
                      DEF : new SFString("Metal18"),
                      ambientIntensity : new SFFloat(0.00746438),
                      diffuseColor : new SFColor([0.456,0.03648,0.134863]),
                      specularColor : new SFColor([0.641609,0.651044,0.979592]),
                      shininess : new SFFloat(0.0612245)}))})),
              geometry : new SFNode(
            ...
            new Shape({
              ...
              geometry : new SFNode(
                new GeoElevationGrid({
                  geoSystem : new MFString([", ","UTM, ","Z11, ","Nnorthing_first"]),

        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("Titania V1.4.4, http://titania.create3000.de")}),
            ...
            new meta({
              ...
              content : new SFString("Tue, 17 May 2016 08:14:35 GMT")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
                    ...
                    new MetadataSet({
                      ...
                      value : new SFNode(
                        new MetadataDouble({
                          ...
                          reference : new SFString("http://titania.create3000.de"),
                          value : new MFDouble([209.085708618164,-284.294311523438,251.209625244141])})),
                      value : new SFNode(
                        new MetadataDouble({
                          name : new SFString("orientation"),
                          DEF : new SFString("orientation"),
                          reference : new SFString("http://titania.create3000.de"),
                          value : new MFDouble([0.832041258895059,0.311619716372351,0.458912296484134,1.01485308574234])})),
                      value : new SFNode(
                        new MetadataDouble({
                      ...
                      value : new SFNode(
                        new MetadataSet({
                          ...
                          particleSystem : new SFNode(
                            new ParticleSystem({
                              DEF : new SFString("_1"),
                              geometryType : new SFString("LINE"),
                              maxParticles : new SFInt32(15000),

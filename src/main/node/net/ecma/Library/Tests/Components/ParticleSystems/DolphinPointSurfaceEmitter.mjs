        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("file:///home/holger/Projekte/Cobweb/excite/tests/Components/ParticleSystems/DolphinPointSurfaceEmitter.x3d")}),

            new meta({
              name : new SFString("modified"),
              content : new SFString("Sat, 30 Apr 2016 11:56:51 GMT")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
                    ...
                    new MetadataSet({
                      ...
                      value : new SFNode(
                        new MetadataDouble({
                          ...
                          reference : new SFString("http://titania.create3000.de"),
                          value : new MFDouble([235.02507019043,-304.458618164062,206.560821533203])})),
                      value : new SFNode(
                        new MetadataDouble({
                          name : new SFString("orientation"),
                          DEF : new SFString("orientation"),
                          reference : new SFString("http://titania.create3000.de"),
                          value : new MFDouble([0.838011514790102,0.301117702286433,0.455043767619048,1.16040551972849])})),
                      value : new SFNode(
                        new MetadataDouble({
                        ...
                        new MetadataSet({
                          ...
                          particleSystem : new SFNode(
                            new ParticleSystem({
                              ...
                              maxParticles : new SFInt32(10000),
                              ...
                              appearance : new SFNode(
                                new Appearance({
                                  pointProperties : new SFNode(
                                    new PointProperties({
                                      pointSizeScaleFactor : new SFFloat(3.24),
                                      pointSizeMaxValue : new SFFloat(3.24)})),
                                  material : new SFNode(
                                    new Material({
                                      ...
                                      emissiveColor : new SFColor([0.640987,0.460097,0.748016]),

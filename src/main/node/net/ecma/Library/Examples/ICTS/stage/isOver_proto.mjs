                    ...
                    new Script({
                      ...
                      IS : new SFNode(
                        new IS({
                          connect : new MFNode([
                            new connect({
                              nodeField : new SFString("set_isOver"),
                              protoField : new SFString("set_isOver")}),

                            new connect({
                              nodeField : new SFString("set_hitPoint"),
                              protoField : new SFString("set_hitPoint")}),

                            new connect({
                              nodeField : new SFString("isOver_changed"),
                              protoField : new SFString("isOver_changed")})])})]),
                      vrmlscript:

...
var X3D0 =  new X3D({
      ...
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new ProtoDeclare({
              name : new SFString("RandomTime"),
              ProtoInterface : new SFNode(
                new ProtoInterface({
                  field : new MFNode([
                    new field({
                      type : field.TYPE_SFTIME,
                      name : new SFString("minTime"),
                      accessType : new SFString(field.ACCESSTYPE_INPUTOUTPUT)}),

                    new field({
                      type : field.TYPE_SFTIME,
                      name : new SFString("maxTime"),
                      accessType : new SFString(field.ACCESSTYPE_INPUTOUTPUT),
                        ...
                        new Script({
                                ...
                                new ProtoInstance({
                                  ...
                                  IS : new SFNode(
                                    new IS({
                                      connect : new MFNode([
                                        new connect({
                                          nodeField : new SFString("minTime"),
                                          protoField : new SFString("minTime")}),

                                        new connect({
                                          nodeField : new SFString("maxTime"),
                                          protoField : new SFString("maxTime")}),
                          ...
                          IS : new SFNode(
                            new IS({
                              connect : new MFNode([
                                new connect({
                                  nodeField : new SFString("randomTime"),
                                  protoField : new SFString("randomTime")})])})]),
                          vrmlscript:
	...
	, function  initialize()
	{
		if (data.startTime == 1) set_startTime(0, 0);
                    ...
                    new ROUTE({
                      ...
                      toNode : new SFString("_randomTime"),

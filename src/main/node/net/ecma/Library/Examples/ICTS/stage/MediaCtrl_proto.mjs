                            ...
                            new ProtoInstance({
                              ...
                              IS : new SFNode(
                                new IS({
                                  connect : new MFNode([
                                    new connect({
                                      nodeField : new SFString("reset"),
                                      protoField : new SFString("reset")}),
                      ...
                      IS : new SFNode(
                        new IS({
                          connect : new MFNode([
                            ...
                            new connect({
                              nodeField : new SFString("source"),
                              protoField : new SFString("source")})])})]),
                      vrmlscript:
	...
	if (!isActive && data.reset) {
		source.startTime = time;
                    ...
                    new ROUTE({
                      ...
                      toNode : new SFString("_mediaCtrl"),

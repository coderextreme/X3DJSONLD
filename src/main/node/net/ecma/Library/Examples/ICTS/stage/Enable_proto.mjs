                    ...
                    new Script({
                      ...
                      IS : new SFNode(
                        new IS({
                          connect : new MFNode([
                            new connect({
                              nodeField : new SFString("enable"),
                              protoField : new SFString("enable")}),

                            new connect({
                              nodeField : new SFString("disable"),
                              protoField : new SFString("disable")}),

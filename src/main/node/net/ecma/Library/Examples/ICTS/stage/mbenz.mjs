                        ...
                        new Transform({
                          ...
                          children : new MFNode([
                            new Shape({
                              ...
                              geometry : new SFNode(
                                new Text({
                                  string : new MFString([", ","Hi, ich bin Else! Ich möchte gern mit Dir, ","gemeinsam einen Ausflug in die Zukunft, ","des Internet machen! Wenn Du mit mir, ","mitgehst, kann ich Dir viele schöne und, ","interessante Dinge zeigen! "]),
                        ...
                        new Transform({
                          ...
                          children : new MFNode([
                            new Shape({
                              ...
                              geometry : new SFNode(
                                new Text({
                                  string : new MFString([", ","Wir befinden uns hier in einer, ","Demonstration, die zu Anschauungs-, ","zwecken erstellt wurde. Du kannst überall, ","herumlaufen und Dich umschauen.Ich kann Dir erklären, wie das ..."]),
                                  length : new MFFloat([0]),
                                  fontStyle : new SFNode(
                                    new FontStyle({
                                      family : new MFString(["SANS"]),
                        ...
                        new Transform({
                          ...
                          children : new MFNode([
                            new Shape({
                              ...
                              geometry : new SFNode(
                                new Text({
                                  string : new MFString([", ","... geht: Klicke einfach mit Deiner Maus, ","in die Mitte des Bildes und ziehe mit, ","gedrückt gehaltener Maustaste, ","in die Richtung, in die Du laufen möchtestoder benutze die Pfeiltasten."]),
                                  length : new MFFloat([0]),
                                  fontStyle : new SFNode(
                                    new FontStyle({
                                      family : new MFString(["SANS"]),

        ...
        new Scene({
          children : new MFNode([
            ...
            new Collision({
              ...
              proxy : new SFNode(
                new Transform({
                  bboxSize : new SFVec3f([4.9,4.9,4.9]),
                  children : new MFNode([
                    new Transform({
                      children : new MFNode([
                        new Billboard({
                          children : new MFNode([
                            new Transform({
                              children : new MFNode([
                                ...
                                new Transform({
                                  DEF : new SFString("feuerring_1"),
                                  translation : new SFVec3f([0,1.01373,-0.00000266663]),
                                  scale : new SFVec3f([1.36804,1.36804,1.36804]),
                                  children : new MFNode([
                                    new Group({
                                      children : new MFNode([
                                        new Group({
                                          DEF : new SFString("feuerring"),
                                          children : new MFNode([
                                            new TimeSensor({
                                              DEF : new SFString("Time_1"),
                                              cycleInterval : new SFTime(2),
                                              loop : new SFBool(true),
                                              startTime : new SFTime(968923801.489069),
                                    ...
                                    new Group({
                                      children : new MFNode([
                                        ...
                                        new PositionInterpolator({
                                          DEF : new SFString("feuerringTranslationInterp"),
                                          key : new MFFloat([0,0.1,0.2,0.4,0.6,0.8,0.9,0.95,1]),
                                          keyValue : new MFVec3f([0,1.01373,-0.00000266663,0,0.721592,-0.00000266663,0,0.784905,-0.00000266663,0,0.817842,-0.00000266663,0,1.12452,-0.00000266663,0,0.478494,-0.00000266663,0,0.943791,-0.00000266663,0,0.349177,-0.00000266663,0,0.943791,-0.00000266663])}),

                                        new PositionInterpolator({
                                          DEF : new SFString("feuerringScaleFactorInterp"),
                                          key : new MFFloat([0,0.1,0.2,0.4,0.6,0.8,0.9,0.95,1]),
                                          keyValue : new MFVec3f([1.36804,1.36804,1.36804,7.21592,7.21592,7.21592,7.83104,7.83104,7.83104,6.95249,6.95249,6.95249,8.29699,8.29699,8.29699,6.9222,4.30184,6.9222,4.08144,2.53644,4.08144,4.83704,3.01807,4.83704,0.571008,0.354858,0.571008])})])}),
                                ...
                                new Transform({
                                  ...
                                  children : new MFNode([
                                    new Group({
                                      children : new MFNode([
                                        new Group({
                                          DEF : new SFString("mummy_freezeAnim"),
                                          children : new MFNode([
                                            new TimeSensor({
                                        ...
                                        new PositionInterpolator({
                                          DEF : new SFString("mummyTranslationInterp"),
                                          key : new MFFloat([0,0.5,1]),
                                          keyValue : new MFVec3f([0,0,0,0,0.283851,0,0,0,0])})])}),

                                    new Transform({
                                      DEF : new SFString("head_mat"),
                                      center : new SFVec3f([-0.0130462,0.94049,0.227249]),
                                      children : new MFNode([
                                        new Transform({
                                    ...
                                    new Transform({
                                      ...
                                      children : new MFNode([
                                        new Group({
                                          children : new MFNode([
                                            new Group({
                                              USE : new SFString("fireAnim")}),

                                            new ColorInterpolator({
                                              DEF : new SFString("mummyMatEmissiveColorInterp"),
                                              key : new MFFloat([0,0.1,0.9,1]),
                                              keyValue : new MFColor([0.117021,0,0.00515386,0.297872,0.0635673,0,0.297872,0.0635673,0,0.117021,0,0.00515386])})])}),
            ...
            new ROUTE({
              ...
              fromField : new SFString("fraction_changed"),
              toNode : new SFString("feuerringTranslationInterp"),
              toField : new SFString("set_fraction")}),

            new ROUTE({
              fromNode : new SFString("Time_2"),
              fromField : new SFString("fraction_changed"),
              toNode : new SFString("feuerringScaleFactorInterp"),
              toField : new SFString("set_fraction")}),
            ...
            new ROUTE({
              fromNode : new SFString("feuerringTranslationInterp"),
              fromField : new SFString("value_changed"),
              toNode : new SFString("feuerring_1"),
              toField : new SFString("set_translation")}),

            new ROUTE({
              fromNode : new SFString("feuerringScaleFactorInterp"),
              fromField : new SFString("value_changed"),
              toNode : new SFString("feuerring_1"),
            ...
            new ROUTE({
              ...
              fromField : new SFString("fraction_changed"),
              toNode : new SFString("mummyTranslationInterp"),
              toField : new SFString("set_fraction")}),

            new ROUTE({
              fromNode : new SFString("Time_2"),
              fromField : new SFString("fraction_changed"),
              toNode : new SFString("mummyMatEmissiveColorInterp"),
              toField : new SFString("set_fraction")}),

            new ROUTE({
              fromNode : new SFString("mummyMatEmissiveColorInterp"),
              fromField : new SFString("value_changed"),
              toNode : new SFString("_6"),
              toField : new SFString("set_emissiveColor")}),

            new ROUTE({
              fromNode : new SFString("mummyTranslationInterp"),
              fromField : new SFString("value_changed"),
              toNode : new SFString("mummy"),
              toField : new SFString("set_translation")})])}))});

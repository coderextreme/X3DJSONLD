        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("Mon, 27 Apr 2015 08:59:01 GMT")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
                ...
                new Appearance({
                  texture : new SFNode(
                    new MovieTexture({
                      ...
                      url : new MFString([", ","film3.mp4, ","film3.mpvhttp://titania.create3000.de/fileadmin/cobweb/videos/film3.mp4"]),

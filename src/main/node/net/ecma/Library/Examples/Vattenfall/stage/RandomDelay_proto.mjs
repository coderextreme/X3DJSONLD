                            ...
                            new ProtoInstance({
                              ...
                              IS : new SFNode(
                                new IS({
                                  connect : new MFNode([
                                    new connect({
                                      nodeField : new SFString("minInterval"),
                                      protoField : new SFString("minInterval")}),

                                    new connect({
                                      nodeField : new SFString("maxInterval"),
                                      protoField : new SFString("maxInterval")}),
...
, function initialize() {
	if (data.startTime) data.startTime = 1;
                    ...
                    new ROUTE({
                      fromNode : new SFString("TimeSensor"),
                      fromField : new SFString("isActive"),
                      toNode : new SFString("_randomDelay"),

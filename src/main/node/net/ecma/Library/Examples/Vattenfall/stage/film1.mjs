        ...
        new head({
          meta : new MFNode([
            ...
            new meta({
              ...
              content : new SFString("Tue, 28 Apr 2015 02:31:10 GMT")})])})),
      Scene : new SFNode(
        new Scene({
          children : new MFNode([
            new WorldInfo({
                ...
                new Appearance({
                  texture : new SFNode(
                    new MovieTexture({
                      ...
                      url : new MFString([", ","film1.mp4, ","film1.mpvhttp://titania.create3000.de/fileadmin/cobweb/videos/film1.mp4"]),

...
NodeSerializer.prototype = {
	serializeToString : function(json, element, clazz, mapToMethod, fieldTypes) {
		...
		str += "import { util } from 'util' assert { type: 'json' };\n";
		str += "import { promisify } from 'util' assert { type: 'json' };\n";
		...
		str += "  promisify: promisify, // Needs Node.js version 8 or greater, see comment below\n";

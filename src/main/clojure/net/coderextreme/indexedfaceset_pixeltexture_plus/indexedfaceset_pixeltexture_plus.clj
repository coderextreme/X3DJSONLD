(ns x3dclsail.indexedfaceset_pixeltexture_plus
...
(.toFileX3D X3D0 ".././indexedfaceset_pixeltexture_plus.new.clojure.x3d")
(.toFileJSON X3D0 ".././indexedfaceset_pixeltexture_plus.new.clojure.json")
(defn -main []

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/data/glflowers.x3d")
        ))
    ))
    (.setScene (doto (Scene. )
...
(.toFileX3D X3D0 ".././glflowers.new.clojure.x3d")
(.toFileJSON X3D0 ".././glflowers.new.clojure.json")
(defn -main []

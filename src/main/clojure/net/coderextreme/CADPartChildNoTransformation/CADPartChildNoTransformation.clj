(ns x3dclsail.CADPartChildNoTransformation
...
(.toFileX3D X3D0 ".././CADPartChildNoTransformation.new.clojure.x3d")
(.toFileJSON X3D0 ".././CADPartChildNoTransformation.new.clojure.json")
(defn -main []

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "text3shapes.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/data/text3shapes.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "3 text shapes")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
    ...
    (.setScene (doto (Scene. )
        (.addChildren (doto (Transform. )
            ...
            (.addChild (doto (Shape. )
                (.setGeometry (doto (Text. )
                    (.setString (into-array ["Node2" "\\\\" "\\\\\\\\" "Node2"]))
                    (.setFontStyle (doto (FontStyle. )
                    ))
                ))
                (.setAppearance (doto (Appearance. )
            ...
            (.addChild (doto (Shape. )
                (.setGeometry (doto (Text. )
                    (.setString (into-array ["Node3 \\\\\\\\ \\\\ " "Node3\"\"\""]))
                    (.setFontStyle (doto (FontStyle. )
                    ))
                ))
                (.setAppearance (doto (Appearance. )
...
(.toFileX3D X3D0 "../../../../../data/text3shapes.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/text3shapes.new.clojure.x3dj")
(defn -main []

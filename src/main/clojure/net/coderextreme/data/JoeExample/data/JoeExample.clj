...
(.setSourceCode "\\newline\\newline      function combinationEntered (value) {\\newline\\newline        unlocked = value;\\newline\\newline      }\\newline\\newline      function openVault(value) {\\newline\\newline      if (unlocked) vaultUnlocked = value;\\newline\\newline      }\\newline")        ))
        ...
        (.addChildren (doto (Sound. )
            ...
            (.setSource (doto (AudioClip. )
                ...
                (.setUrl (into-array ["../resources/chandubabamusic1.wav"]))
            ))
        ))
...
(.toFileX3D X3D0 "../data/JoeExample.new.clojure.x3d")
(.toFileJSON X3D0 "../data/JoeExample.new.clojure.json")
(defn -main []

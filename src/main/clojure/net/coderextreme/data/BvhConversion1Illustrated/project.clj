(defproject BvhConversion1Illustrated "1.0.0"
  ...
  :main ^:skip-aot BvhConversion1Illustrated
  ...
  :jvm-opts ["-cp" "src/BvhConversion1Illustrated:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "BvhConversion1Illustrated.jar"
                       :main BvhConversion1Illustrated
                       }})

(defproject JoeHAnimKick1a_Final "1.0.0"
  ...
  :main ^:skip-aot JoeHAnimKick1a_Final
  ...
  :jvm-opts ["-cp" "src/JoeHAnimKick1a_Final:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JoeHAnimKick1a_Final.jar"
                       :main JoeHAnimKick1a_Final
                       }})

(ns x3dclsail.KoreanCharacter02Chul
...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "KoreanCharacter02Chul.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "creator")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter02Chul.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
    ...
    (.setScene (doto (Scene. )
        (.addChildren (doto (WorldInfo. )
            (.setTitle "KoreanCharacter02Chul.x3d")
        ))
...
;original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"'
            (.setMetadata (doto (MetadataSet. )
                ...
                (.addValue (doto (MetadataString. )
                    (.setName "authorName")
                    (.setValue (into-array ["Chul Hee Jung and Myeong Won Lee"]))
                ))
                (.addValue (doto (MetadataString. )
                    (.setName "authorEmail")
                    (.setValue (into-array ["myeongwonlee@gmail.com"]))
                ))
                (.addValue (doto (MetadataString. )
                    (.setName "creationDate")
                    (.setValue (into-array ["31 March 2011"]))
                ))
                (.addValue (doto (MetadataString. )
                    (.setName "gender")
                    (.setValue (into-array ["male"]))
                ))
            ...
            (.addSkeleton (doto (HAnimJoint. )
                ...
                (.setCenter (float-array [0 44.07 -1.034]))
                ...
                (.addChildren (doto (HAnimSegment. )
                    ...
                    (.addChildren (doto (Transform. )
                        (.setTranslation (float-array [0 44.07 -1.034]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                ...
                                (.setTexture (doto (ImageTexture. )
                                    (.setDEF "ChulTextureAtlas")
                                    (.setUrl (into-array ["images/Chul.png" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Chul.png"]))
                                ))
                            ))
                            (.setGeometry (doto (IndexedFaceSet. )
                                ...
                                (.setCoord (doto (Coordinate. )
                                    (.setPoint (float-array [0 0.87 0.0225 0 0.7535 -0.4472 -0.3613 0.7535 -0.3842 -0.6259 0.7535 -0.3083 -0.7227 0.7535 0.0225 -0.6259 0.7535 0.3534 -0.3613 0.7535 0.4293 0 0.7535 0.4922 0.3613 0.7535 0.4293 0.6259 0.7535 0.3534 0.7227 0.7535 0.0225 0.6259 0.7535 -0.3083 0.3613 0.7535 -0.3842 0 0.435 -0.7303 -0.4673 0.435 -0.6294 -0.8094 0.435 -0.3539 -0.9347 0.435 0.0225 -0.8094 0.435 0.399 -0.4673 0.435 0.5769 0 0.435 0.6777 0.4673 0.435 0.5769 0.8094 0.435 0.399 0.9347 0.435 0.0225 0.8094 0.435 -0.3539 0.4673 0.435 -0.6294 0 0 -0.7942 -0.5396 0 -0.6777 -0.9347 0 -0.3596 -1.079 0 0.0225 -0.9347 0 0.4572 -0.5396 0 0.6777 0 0 0.7942 0.5396 0 0.6777 0.9347 0 0.4572 1.079 0 0.0225 0.9347 0 -0.3596 0.5396 0 -0.6777 0 -0.435 -0.6777 -0.4673 -0.435 -0.5769 -0.8094 -0.435 -0.3013 -0.9347 -0.435 0.0225 -0.8094 -0.435 0.399 -0.4673 -0.435 0.5769 0 -0.435 0.6777 0.4673 -0.435 0.5769 0.8094 -0.435 0.399 0.9347 -0.435 0.0225 0.8094 -0.435 -0.3013 0.4673 -0.435 -0.5769 0 -0.7535 -0.3596 -0.2698 -0.7535 -0.3013 -0.4673 -0.7535 -0.1948 -0.5396 -0.7535 0.0225 -0.4673 -0.7535 0.2399 -0.2698 -0.7535 0.399 0 -0.7535 0.4572 0.2698 -0.7535 0.399 0.4673 -0.7535 0.2399 0.5396 -0.7535 0.0225 0.4673 -0.7535 -0.1948 0.2698 -0.7535 -0.3013 0 -0.87 0.0225]))
                                ))
                                (.setTexCoord (doto (TextureCoordinate. )
                                    (.setPoint (float-array [0.7418 0.2139 0.7309 0.2139 0.7342 0.26 0.7342 0.2938 0.7342 0.3062 0.7342 0.2938 0.7342 0.26 0.7309 0.2139 0.7343 0.2601 0.7343 0.2939 0.7343 0.3063 0.7343 0.2939 0.7343 0.2601 0.7157 0.2139 0.7156 0.2735 0.7156 0.3173 0.7156 0.3333 0.7156 0.3173 0.7156 0.2735 0.7157 0.2139 0.7157 0.2736 0.7157 0.3174 0.7157 0.3334 0.7157 0.3174 0.7157 0.2736 0.7015 0.2147 0.7014 0.2836 0.7014 0.3341 0.7014 0.3526 0.7014 0.3341 0.7014 0.2836 0.7015 0.2147 0.7015 0.2837 0.7015 0.3342 0.7015 0.3527 0.7015 0.3342 0.7015 0.2837 0.6609 0.2147 0.6608 0.2744 0.6608 0.3181 0.6608 0.3341 0.6608 0.3181 0.6608 0.2744 0.6609 0.2147 0.6609 0.2745 0.6609 0.3182 0.6609 0.3342 0.6609 0.3182 0.6609 0.2745 0.6312 0.2147 0.6311 0.2491 0.6311 0.2744 0.6311 0.2836 0.6311 0.2744 0.6311 0.2491 0.6312 0.2147 0.6312 0.2492 0.6312 0.2745 0.6312 0.2837 0.6312 0.2745 0.6312 0.2492 0.6204 0.2147]))
                                ))
                            ))
                        ))
                    ))
                ...
                (.addChildren (doto (HAnimJoint. )
                    (.setName "l_hip")
                    (.setDEF "hanim_l_hip")
                    (.setCenter (float-array [4.001 41.139999 -1.119]))
                    (.setUlimit (float-array [0 0 0]))
                    (.setLlimit (float-array [0 0 0]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "l_thigh")
                        ...
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [4.001 41.139999 -1.119]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "l_knee")
                        (.setDEF "hanim_l_knee")
                        (.setCenter (float-array [4.315 25.190001 -1.119]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l_calf")
                            (.setDEF "hanim_l_calf")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [4.315 25.190001 -1.119]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                                            (.setPoint (float-array [0.5993 0.2671 0.5993 0.2423 0.5993 0.3227 0.5993 0.3673 0.5993 0.3673 0.5993 0.3227 0.5993 0.2671 0.5849 0.2192 0.5579 0.2527 0.5579 0.2192 0.5849 0.2527 0.5579 0.3279 0.5849 0.3279 0.5579 0.3793 0.5849 0.3793 0.5579 0.3793 0.5849 0.3793 0.5579 0.3279 0.5849 0.3279 0.5579 0.2527 0.5849 0.2527 0.4746 0.2527 0.4746 0.2192 0.4746 0.3279 0.4746 0.3793 0.4746 0.3793 0.4746 0.3279 0.4746 0.2527 0.426 0.2592 0.4268 0.2203 0.4268 0.3325 0.4268 0.3852 0.4268 0.3852 0.4268 0.3325 0.426 0.2592 0.4856 0.2656 0.4856 0.2399 0.4856 0.3232 0.4856 0.3607 0.4856 0.3607 0.4856 0.3232 0.4856 0.2656]))
                                        ))
                                    ))
                                ))
                            ))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [4.574 6.838 -1.463]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_talus")
                                ...
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [4.574 6.838 -1.463]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [4.809 5.583 1.492]))
                                (.setUlimit (float-array [0 0 0]))
                                (.setLlimit (float-array [0 0 0]))
                                (.addChildren (doto (HAnimSegment. )
                                    ...
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [4.809 5.583 1.492]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                                            ...
                                            (.setGeometry (doto (IndexedFaceSet. )
                                                (.setCoordIndex (int-array [0 1 19 -1 19 18 0 -1 1 2 20 -1 20 19 1 -1 22 5 25 -1 4 24 25 -1 25 5 4 -1 3 0 18 -1 18 21 3 -1 6 9 7 -1 7 8 6 -1 22 20 2 -1 2 5 22 -1 6 11 10 -1 10 9 6 -1 0 13 12 -1 12 1 0 -1 1 12 14 -1 14 2 1 -1 3 4 15 -1 15 16 3 -1 5 17 15 -1 15 4 5 -1 3 16 13 -1 13 0 3 -1 2 14 17 -1 17 5 2 -1 15 6 8 -1 8 16 15 -1 16 8 7 -1 7 13 16 -1 13 7 9 -1 9 12 13 -1 15 17 11 -1 11 6 15 -1 12 9 10 -1 10 14 12 -1 14 10 11 -1 11 17 14 -1 4 3 23 -1 23 24 4 -1 23 3 21 -1 18 19 27 -1 27 26 18 -1 19 20 28 -1 28 27 19 -1 20 22 29 -1 29 28 20 -1 22 25 29 -1 23 21 30 -1 21 18 26 -1 26 30 21 -1 23 25 24 -1 29 25 23 -1 23 30 29 -1 27 28 29 -1 26 27 29 -1 30 26 29 -1]))
                                                (.setCreaseAngle 1.57)
                                                (.setTexCoordIndex (int-array [0 1 19 -1 19 18 0 -1 1 2 20 -1 20 19 1 -1 22 5 25 -1 4 24 25 -1 25 5 4 -1 3 0 18 -1 18 21 3 -1 6 9 7 -1 7 8 6 -1 22 20 2 -1 2 5 22 -1 6 11 10 -1 10 9 6 -1 0 13 12 -1 12 1 0 -1 1 12 14 -1 14 2 1 -1 3 4 15 -1 15 16 3 -1 5 17 15 -1 15 4 5 -1 3 16 13 -1 13 0 3 -1 2 14 17 -1 17 5 2 -1 15 6 8 -1 8 16 15 -1 16 8 7 -1 7 13 16 -1 13 7 9 -1 9 12 13 -1 15 17 11 -1 11 6 15 -1 12 9 10 -1 10 14 12 -1 14 10 11 -1 11 17 14 -1 4 3 23 -1 23 24 4 -1 23 3 21 -1 18 19 27 -1 27 26 18 -1 19 20 28 -1 28 27 19 -1 20 22 29 -1 29 28 20 -1 22 25 29 -1 23 21 30 -1 21 18 26 -1 26 30 21 -1 23 25 24 -1 29 25 23 -1 23 30 29 -1 27 28 29 -1 26 27 29 -1 30 26 29 -1]))
                                                (.setCoord (doto (Coordinate. )
                                                    (.setPoint (float-array [2.803 -5.588 0.6731 0.2267 -5.589 2.081 -2.411 -5.604 1.896 2.336 -2.423 0.7256 -0.4491 -0.4293 2.144 -2.566 -2.188 1.933 -0.2886 -2.342 8.508 2.628 -5.51 5.676 2.567 -2.341 5.71 -0.0624 -5.51 8.465 -1.743 -5.522 7.68 -1.73 -2.103 7.711 -0.0387 -5.541 5.353 2.584 -5.536 2.735 -2.525 -5.553 5.417 -0.265 -1.11 5.396 2.299 -2.375 2.776 -2.512 -2.385 5.448 2.332 -5.559 -2.589 0.1713 -5.58 -2.36 -2.269 -5.545 -2.217 1.912 -2.384 -2.527 -2.26 -2.379 -2.19 1.356 -0.6618 -0.8278 -0.925 0.3698 0.4552 -2.684 -0.8406 0.1573 1.828 -3.703 -4.62 0.0134 -3.719 -4.434 -1.422 -3.68 -4.33 -1.411 -0.7578 -4.754 0.2889 -0.8748 -4.705]))
                                                ))
                                                (.setTexCoord (doto (TextureCoordinate. )
                                                    (.setPoint (float-array [0.278 0.0809 0.2779 0.1038 0.277 0.1083 0.3615 0.0805 0.4946 0.1295 0.3758 0.1069 0.3664 0.1777 0.2827 0.1396 0.3665 0.1379 0.2827 0.1788 0.282 0.1739 0.3809 0.172 0.2808 0.1426 0.2811 0.1055 0.2801 0.1495 0.4533 0.1669 0.3644 0.1045 0.3638 0.1477 0.2798 0.0442 0.2785 0.0523 0.2806 0.06 0.3638 0.0437 0.3642 0.0581 0.4855 0.066 0.5541 0.0994 0.4746 0.0876 0.2798 0.0442 0.2785 0.0523 0.2806 0.06 0.3642 0.0581 0.3638 0.0437]))
                                                ))
                                            ))
                                        ))
                                    ))
                            ...
                            (.addChildren (doto (Transform. )
                                ...
                                (.addChild (doto (Shape. )
                                    ...
                                    (.setGeometry (doto (IndexedFaceSet. )
                                        ...
                                        (.setCreaseAngle 1.57)
17 14 2 -1 15 16 8 -1 8 6 15 -1 16 13 7 -1 7 8 16 -1 13 12 9 -1 9 7 13 -1 15 6 11 -1 11 17 15 -1 12 14 10 -1 10 9 12 -1 14 17 11 -1 11 10 14 -1 4 24 23 -1 23 3 4 -1 23 21 3 -1 18 26 27 -1 27 19 18 -1 19 27 28 -1 28 20 19 -1 20 28 29 -1 29 22 20 -1 22 29 25 -1 23 30 21 -1 21 30 26 -1 26 18 21 -1 23 24 25 -1 29 30 23 -1 23 25 29 -1 29 28 27 -1 29 27 26 -1 30 29 26 -1]))
                                                (.setCreaseAngle 1.57)
                                                (.setTexCoordIndex (int-array [0 18 19 -1 19 1 0 -1 1 19 20 -1 20 2 1 -1 22 25 5 -1 4 5 25 -1 25 24 4 -1 3 21 18 -1 18 0 3 -1 6 8 7 -1 7 9 6 -1 22 5 2 -1 2 20 22 -1 6 9 10 -1 10 11 6 -1 0 1 12 -1 12 13 0 -1 1 2 14 -1 14 12 1 -1 3 16 15 -1 15 4 3 -1 5 4 15 -1 15 17 5 -1 3 0 13 -1 13 16 3 -1 2 5 17 -1 17 14 2 -1 15 16 8 -1 8 6 15 -1 16 13 7 -1 7 8 16 -1 13 12 9 -1 9 7 13 -1 15 6 11 -1 11 17 15 -1 12 14 10 -1 10 9 12 -1 14 17 11 -1 11 10 14 -1 4 24 23 -1 23 3 4 -1 23 21 3 -1 18 26 27 -1 27 19 18 -1 19 27 28 -1 28 20 19 -1 20 28 29 -1 29 22 20 -1 22 29 25 -1 23 30 21 -1 21 30 26 -1 26 18 21 -1 23 24 25 -1 29 30 23 -1 23 25 29 -1 29 28 27 -1 29 27 26 -1 30 29 26 -1]))
                                                (.setCoord (doto (Coordinate. )
                                                    (.setPoint (float-array [-2.803 -5.588 0.6731 -0.2267 -5.589 2.081 2.411 -5.604 1.896 -2.336 -2.423 0.7256 0.4491 -0.4293 2.144 2.566 -2.188 1.933 0.2886 -2.342 8.508 -2.628 -5.51 5.676 -2.567 -2.341 5.71 0.0624 -5.51 8.465 1.743 -5.522 7.68 1.73 -2.103 7.711 0.0387 -5.541 5.353 -2.584 -5.536 2.735 2.525 -5.553 5.417 0.265 -1.11 5.396 -2.299 -2.375 2.776 2.512 -2.385 5.448 -2.332 -5.559 -2.589 -0.1713 -5.58 -2.36 2.269 -5.545 -2.217 -1.912 -2.384 -2.527 2.26 -2.379 -2.19 -1.356 -0.6618 -0.8278 0.925 0.3698 0.4552 2.684 -0.8406 0.1573 -1.828 -3.703 -4.62 -0.0134 -3.719 -4.434 1.422 -3.68 -4.33 1.411 -0.7578 -4.754 -0.2889 -0.8748 -4.705]))
                                                ))
                                                (.setTexCoord (doto (TextureCoordinate. )
                ...
                (.addChildren (doto (HAnimJoint. )
                    ...
                    (.setCenter (float-array [0 38.639999 -1.034]))
                    (.setUlimit (float-array [0 0 0]))
                    (.setLlimit (float-array [0 0 0]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "pelvis")
                        (.setDEF "hanim_pelvis")
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [0 38.639999 -1.034]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        ...
                        (.setCenter (float-array [7.699 59.419998 -1.567]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l_upperarm")
                            ...
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [7.699 59.419998 -1.567]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [8.026 48.450001 -1.959]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_forearm")
                                ...
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [8.026 48.450001 -1.959]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [7.617 37.689999 -1.663]))
                                (.setUlimit (float-array [0 0 0]))
                                (.setLlimit (float-array [0 0 0]))
                                (.addChildren (doto (HAnimSegment. )
                                    (.setName "l_carpal")
                                    ...
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [7.617 37.689999 -1.663]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "vl5")
                        (.setDEF "hanim_vl5")
                        (.setCenter (float-array [0 47.330002 -0.5744]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l5")
                            (.setDEF "hanim_l5")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [0 47.330002 -0.5744]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [0 65.510002 -1.446]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "skull")
                                (.setDEF "hanim_skull")
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [0 65.510002 -1.446]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
...
(.toFileX3D X3D0 "../data/KoreanCharacter02Chul.new.clojure.x3d")
(.toFileJSON X3D0 "../data/KoreanCharacter02Chul.new.clojure.json")
(defn -main []

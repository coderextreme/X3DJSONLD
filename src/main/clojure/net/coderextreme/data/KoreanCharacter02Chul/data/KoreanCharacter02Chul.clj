...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "Image")
            (.setContent "../Poses/images/HAnimPoseExampleKoreanCharacter02Chul.png")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "reference")
...
(.addComments "original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"'")
        ...
        (.addChildren (doto (EXPORT. )
            (.setAS "KoreanCharacter02Chul")
            (.setLocalDEF "hanim_Chul")
        ))
    ))
))
(.toFileX3D X3D0 "../../../../../data/KoreanCharacter02Chul.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/KoreanCharacter02Chul.new.clojure.x3dj")
(defn -main []

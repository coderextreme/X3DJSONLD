(defproject KoreanCharacter02Chul "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter02Chul
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter02Chul:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter02Chul.jar"
                       :main KoreanCharacter02Chul
                       }})

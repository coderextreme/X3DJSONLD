...
(def X3D0 (doto (X3D.)
    ...
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (Transform. )
            (.setDEF "T_0")
            (.setTranslation (float-array [-10.871 0.4108254 -10.453]))
            (.addChild (doto (Shape. )
                (.setAppearance (doto (Appearance. )
                    (.setMaterial (doto (PhysicalMaterial. )
                        (.setDEF "M_0")
...
(.setSourceCode "ecmascript:
        ...
        (.addChildren (doto (Transform. )
            (.setDEF "T_1")
            (.setTranslation (float-array [-10.411 0.4288193 -9.16]))
            (.addChild (doto (Shape. )
                (.setAppearance (doto (Appearance. )
                    (.setMaterial (doto (PhysicalMaterial. )
                        (.setDEF "M_1")
...
(.setSourceCode "ecmascript:
        ...
        (.addChildren (doto (Transform. )
            (.setDEF "T_2")
            (.setTranslation (float-array [-10.155 0.5931959 -8.324]))
            (.addChild (doto (Shape. )
                (.setAppearance (doto (Appearance. )
                    (.setMaterial (doto (PhysicalMaterial. )
                        (.setRoughness 0.05)
        ...
        (.addChildren (doto (Transform. )
            (.setDEF "T_3")
            (.setTranslation (float-array [-10.518 0.3316 -7.283]))
            (.addChild (doto (Shape. )
                (.setAppearance (doto (Appearance. )
                    (.setMaterial (doto (PhysicalMaterial. )
                        (.setRoughness 0.05)
                        (.setIridescenceMaterialExtension (doto (IridescenceMaterialExtension. )
                            (.setDEF "IRI_3")
                            (.setIridescence "1")
                            (.setIridescenceThicknessMaximum "297.4")
                        ))
                    ))
                ))
                (.setGeometry (doto (Sphere. )

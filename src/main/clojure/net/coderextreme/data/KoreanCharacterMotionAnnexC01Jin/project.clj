(defproject KoreanCharacterMotionAnnexC01Jin "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacterMotionAnnexC01Jin
  ...
  :jvm-opts ["-cp" "src/KoreanCharacterMotionAnnexC01Jin:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacterMotionAnnexC01Jin.jar"
                       :main KoreanCharacterMotionAnnexC01Jin
                       }})

(defproject JinFacsAu44SquintMorpher "1.0.0"
  ...
  :main ^:skip-aot JinFacsAu44SquintMorpher
  ...
  :jvm-opts ["-cp" "src/JinFacsAu44SquintMorpher:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinFacsAu44SquintMorpher.jar"
                       :main JinFacsAu44SquintMorpher
                       }})

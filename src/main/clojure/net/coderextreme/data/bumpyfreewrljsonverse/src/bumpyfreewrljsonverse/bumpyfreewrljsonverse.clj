...
(.addComments "TO CONVERT TO A SPHERE <ShaderPart url='\"../shaders/freewrl.vs\"'></ShaderPart> <ShaderPart url='\"../shaders/freewrl_bubbles.fs\"' type='FRAGMENT'></ShaderPart>")
                                ))
                            ))
                        ))
                    ))
...
(.toFileJSON X3D0 "../../../../../data/bumpyfreewrljsonverse.new.clojure.x3dj")
(defn -main []

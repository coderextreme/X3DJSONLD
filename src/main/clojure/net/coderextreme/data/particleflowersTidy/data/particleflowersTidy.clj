...
(def X3D0 (doto (X3D.)
    ...
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (Background. )
            (.setFrontUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png" "../resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
            (.setBackUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png" "../resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
            (.setLeftUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png" "../resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
            (.setRightUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png" "../resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
            (.setTopUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png" "../resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
            (.setBottomUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png" "../resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
        ))
                ...
                (.setAppearance (doto (Appearance. )
                    ...
                    (.setTexture (doto (ComposedCubeMapTexture. )
                        ...
                        (.setFrontTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png" "../resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
                        ))
                        (.setBackTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png" "../resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
                        ))
                        (.setLeftTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png" "../resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
                        ))
                        (.setRightTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png" "../resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
                        ))
                        (.setTopTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png" "../resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
                        ))
                        (.setBottomTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png" "../resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
                        ))
                    ))
                    (.addShaders (doto (ComposedShader. )
                        ...
                        (.addParts (doto (ShaderPart. )
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flower_particles.vs" "../shaders/x_ite_flower_particles.vs"]))
                        ))
                        (.addParts (doto (ShaderPart. )
                            (.setType "FRAGMENT")
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/shaders/commonnew.fs" "../shaders/commonnew.fs"]))
                        ))
                        (.addField (doto (field. )
...
(.toFileX3D X3D0 "../../../../../data/particleflowersTidy.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/particleflowersTidy.new.clojure.x3dj")
(defn -main []

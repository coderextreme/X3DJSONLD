(defproject Humanoid2NoSegSite "1.0.0"
  ...
  :main ^:skip-aot Humanoid2NoSegSite
  ...
  :jvm-opts ["-cp" "src/Humanoid2NoSegSite:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "Humanoid2NoSegSite.jar"
                       :main Humanoid2NoSegSite
                       }})

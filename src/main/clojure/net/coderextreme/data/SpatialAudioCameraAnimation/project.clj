(defproject SpatialAudioCameraAnimation "1.0.0"
  ...
  :main ^:skip-aot SpatialAudioCameraAnimation
  ...
  :jvm-opts ["-cp" "src/SpatialAudioCameraAnimation:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "SpatialAudioCameraAnimation.jar"
                       :main SpatialAudioCameraAnimation
                       }})

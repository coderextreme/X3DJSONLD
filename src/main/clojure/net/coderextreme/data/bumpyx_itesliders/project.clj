(defproject bumpyx_itesliders "1.0.0"
  ...
  :main ^:skip-aot bumpyx_itesliders
  ...
  :jvm-opts ["-cp" "src/bumpyx_itesliders:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "bumpyx_itesliders.jar"
                       :main bumpyx_itesliders
                       }})

(defproject variationalflowers2 "1.0.0"
  ...
  :main ^:skip-aot variationalflowers2
  ...
  :jvm-opts ["-cp" "src/variationalflowers2:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "variationalflowers2.jar"
                       :main variationalflowers2
                       }})

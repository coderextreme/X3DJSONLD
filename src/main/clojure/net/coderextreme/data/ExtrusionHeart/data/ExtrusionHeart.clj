...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/Basic/course/ExtrusionHeart.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
        ...
        (.addChildren (doto (Transform. )
            ...
            (.addChild (doto (Shape. )
                (.setGeometry (doto (Extrusion. )
                    ...
                    (.setCrossSection (float-array [0 0.8 0.2 1 0.7 0.95 1 0.5 0.8 0 0.5 -0.3 0 -0.7 -0.5 -0.3 -0.8 0 -1 0.5 -0.7 0.95 -0.2 1 0 0.8]))
                    (.setScale (float-array [0.01 0.01 0.8 0.8 1 1 0.8 0.8 0.01 0.01]))
                    (.setSolid false)
                    (.setSpine (float-array [0 0 0 0 0.1 0 0 0.5 0 0 0.9 0 0 1 0]))
                ))
                (.setAppearance (doto (Appearance. )
                    (.setMaterial (doto (Material. )
                        (.setDiffuseColor (float-array [0.8 0.3 0.3]))
                    ))
                ))
            ))
        ))
...
(.toFileX3D X3D0 "../../../../../data/ExtrusionHeart.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/ExtrusionHeart.new.clojure.x3dj")
(defn -main []

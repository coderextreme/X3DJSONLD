...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "HAnimModelsHandsFeet.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "Left and right hands and feet, using high-fidelity definitions for HAnim version 2.0")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "creator")
            (.setContent "Kwan Hee YOO and Don Brutzman")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "created")
            (.setContent "8 February 2015")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "modified")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "TODO")
            (.setContent "how to have HAnimHumanoid root with Inline IMPORT/EXPORT of limbs?")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "Image")
            (.setContent "HAnimModelsHandsFeet.png")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "Image")
            (.setContent "HAnimModelsHandsFeetWithFour1mGrids.png")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "reference")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "reference")
            (.setContent "https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/hanim.html")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "subject")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelsHandsFeet.x3d")
        ))
    ))
    (.setScene (doto (Scene. )
        (.addChildren (doto (WorldInfo. )
            (.setTitle "HAnimModelsHandsFeet.x3d")
        ))
        (.addChildren (doto (Viewpoint. )
            (.setDescription "Hands and feet 10m")
        ))
        (.addChildren (doto (Viewpoint. )
            (.setDescription "Hands and feet 1.7m")
            (.setPosition (float-array [0 0 1.7]))
        ))
        (.addChildren (doto (Transform. )
            (.setTranslation (float-array [-1 1 0]))
            (.addChildren (doto (Inline. )
                (.setUrl (into-array ["HAnimModelHandLeft.x3d" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelHandLeft.x3d" "HAnimModelHandLeft.wrl" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelHandLeft.wrl"]))
            ))
            (.addChildren (doto (Transform. )
                (.setDEF "GridXY_20x20Fixed_AdjustScale")
                (.setScale (float-array [0.1 0.1 0.1]))
                (.addChildren (doto (Inline. )
                    (.setDEF "GridXY_20x20Fixed")
                    (.setUrl (into-array ["../../Savage/Tools/Authoring/GridXY_20x20Fixed.x3d" "https://savage.nps.edu/Savage/Tools/Authoring/GridXY_20x20Fixed.x3d" "../../Savage/Tools/Authoring/GridXY_20x20Fixed.wrl" "https://savage.nps.edu/Savage/Tools/Authoring/GridXY_20x20Fixed.wrl"]))
                ))
            ))
        ))
        (.addChildren (doto (Transform. )
            (.setTranslation (float-array [1 1 0]))
            (.addChildren (doto (Inline. )
                (.setUrl (into-array ["HAnimModelHandRight.x3d" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelHandRight.x3d" "HAnimModelHandRight.wrl" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelHandRight.wrl"]))
            ))
            (.addChildren (doto (Transform. )
                (.setUSE "GridXY_20x20Fixed_AdjustScale")
            ))
        ))
        (.addChildren (doto (Transform. )
            (.setTranslation (float-array [-1 -1 0]))
            (.addChildren (doto (Inline. )
                (.setUrl (into-array ["HAnimModelFootLeft.x3d" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootLeft.x3d" "HAnimModelFootLeft.wrl" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootLeft.wrl"]))
            ))
            (.addChildren (doto (Transform. )
                (.setUSE "GridXY_20x20Fixed_AdjustScale")
            ))
        ...
        (.addChildren (doto (Transform. )
            (.setTranslation (float-array [1 -1 0]))
            (.addChildren (doto (Inline. )
                (.setUrl (into-array ["HAnimModelFootRight.x3d" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootRight.x3d" "HAnimModelFootRight.wrl" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootRight.wrl"]))
            ))
            (.addChildren (doto (Transform. )
                (.setUSE "GridXY_20x20Fixed_AdjustScale")
            ))
...
(.toFileX3D X3D0 "../../../../../data/HAnimModelsHandsFeet.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/HAnimModelsHandsFeet.new.clojure.x3dj")
(defn -main []

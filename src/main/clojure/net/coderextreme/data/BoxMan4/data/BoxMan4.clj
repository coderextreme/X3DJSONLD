...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "reference")
            (.setContent "Original site http://HAnim.org")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "reference")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan.x3d")
        ))
    ))
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (Script. )
            (.setDEF "ENGINE")
            (.setUrl (into-array ["BoxMan.js" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan.js"]))
...
(.toFileX3D X3D0 "../../../../../data/BoxMan4.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/BoxMan4.new.clojure.json")
(defn -main []

...
(.addComments "<ComposedShader DEF=\"shader\" language=\"GLSL\"> <field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field> <field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1.0 1.033'></field> <field name='bias' type='SFFloat' accessType='inputOutput' value='0.5'></field> <field name='scale' type='SFFloat' accessType='inputOutput' value='0.5'></field> <field name='power' type='SFFloat' accessType='inputOutput' value='2'></field> <ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/> <ShaderPart type='FRAGMENT' url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/> </ComposedShader>")
                    (.addShaders (doto (ComposedShader. )
                        ...
                        (.addParts (doto (ShaderPart. )
                            (.setUrl (into-array ["../shaders/x_iteparticles.vs" "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_iteparticles.vs"]))
                            (.setType "VERTEX")
                        ))
                        (.addParts (doto (ShaderPart. )
                            (.setDEF "commonfs")
...
(.toFileX3D X3D0 "../../../../../data/particleballs.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/particleballs.new.clojure.x3dj")
(defn -main []

(defproject HAnim2SpecificationLOA3Invisible "1.0.0"
  ...
  :main ^:skip-aot HAnim2SpecificationLOA3Invisible
  ...
  :jvm-opts ["-cp" "src/HAnim2SpecificationLOA3Invisible:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "HAnim2SpecificationLOA3Invisible.jar"
                       :main HAnim2SpecificationLOA3Invisible
                       }})

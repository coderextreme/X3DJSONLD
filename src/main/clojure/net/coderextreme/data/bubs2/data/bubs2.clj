...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
            (.setContent "X3dToJson.xslt, https://www.web3d.org/x3d/stylesheets/X3dToJson.html")
        ))
    ))
    (.setScene (doto (Scene. )
...
(.toFileX3D X3D0 "../../../../../data/bubs2.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/bubs2.new.clojure.x3dj")
(defn -main []

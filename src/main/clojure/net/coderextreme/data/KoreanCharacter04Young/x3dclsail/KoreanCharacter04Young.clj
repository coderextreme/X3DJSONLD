(ns x3dclsail.KoreanCharacter04Young
...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "KoreanCharacter04Young.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "creator")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter04Young.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
    ...
    (.setScene (doto (Scene. )
        (.addChildren (doto (WorldInfo. )
            (.setTitle "KoreanCharacter04Young.x3d")
        ))
...
;original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'
            ...
            (.addSkeleton (doto (HAnimJoint. )
                ...
                (.setCenter (float-array [0 31.540001 -0.3172]))
                ...
                (.addChildren (doto (HAnimSegment. )
                    ...
                    (.addChildren (doto (Transform. )
                        (.setTranslation (float-array [0 31.540001 -0.3172]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                ...
                                (.setTexture (doto (ImageTexture. )
                                    (.setDEF "YoungTextureAtlas")
                                    (.setUrl (into-array ["images/Young.png" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Young.png"]))
                                ))
                            ))
                ...
                (.addChildren (doto (HAnimJoint. )
                    (.setName "l_hip")
                    (.setDEF "hanim_l_hip")
                    (.setCenter (float-array [3.504 29.040001 -0.4027]))
                    (.setUlimit (float-array [0 0 0]))
                    (.setLlimit (float-array [0 0 0]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "l_thigh")
                        ...
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [3.504 29.040001 -0.4027]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "l_knee")
                        (.setDEF "hanim_l_knee")
                        (.setCenter (float-array [3.414 14.95 -0.4549]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l_calf")
                            (.setDEF "hanim_l_calf")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [3.414 14.95 -0.4549]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                                    ...
                                    (.setGeometry (doto (IndexedFaceSet. )
                                        ...
                                        (.setCoord (doto (Coordinate. )
                                            (.setPoint (float-array [0.6335 1.142 0.0206 0.3202 1.142 0.8245 -0.3837 1.142 0.9871 -0.9483 1.142 0.5315 -0.9483 1.142 -0.3447 -0.3837 1.142 -0.8003 0.3202 1.142 -0.6377 2.06 -3.778 0.0206 1.287 -2.905 1.78 1.089 -1.147 2.133 1.867 -1.397 0.0206 -0.715 -2.905 2.263 -0.6583 -1.147 2.559 -1.987 -3.778 1.106 -2.06 -1.397 0.8632 -1.987 -4.457 -1.205 -2.06 -1.397 -0.822 -0.715 -4.457 -2.559 -0.6583 -1.397 -2.087 1.287 -4.457 -2.076 1.089 -1.397 -1.661 0.9877 0.2851 1.672 1.704 0.2851 0.0206 -0.622 0.2851 2.043 -1.913 0.2851 1.002 -1.913 0.2851 -0.8149 -0.622 0.2851 -1.817 0.9877 0.2851 -1.445 1.417 -11.1 0.0028 0.8123 -11.09 1.38 -0.5457 -11.09 1.72 -1.635 -11.1 0.767 -1.635 -11.11 -0.8605 -0.5457 -11.11 -1.535 0.8123 -11.11 -1.195 0.6234 -12.52 0.021 0.3177 -12.52 0.7175 -0.3691 -12.52 0.8896 -0.9199 -12.52 0.4076 -0.9199 -12.53 -0.4156 -0.3691 -12.53 -0.7569 0.3177 -12.53 -0.5849]))
                                        ))
                                        (.setTexCoord (doto (TextureCoordinate. )
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [3.18 3.449 -0.3088]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_talus")
                                ...
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [3.18 3.449 -0.3088]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [3.18 3.189 0.9724]))
                                (.setUlimit (float-array [0 0 0]))
                                (.setLlimit (float-array [0 0 0]))
                                (.addChildren (doto (HAnimSegment. )
                                    ...
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [3.18 3.189 0.9724]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                                            ...
                                            (.setGeometry (doto (IndexedFaceSet. )
                                                ...
                                                (.setCoord (doto (Coordinate. )
                                                    (.setPoint (float-array [2.548 -1.416 -0.8988 1.819 -3.176 -0.8988 0 0.2435 0.2718 1.78 -0.2627 -0.8989 1.476 0.0025 -0.0134 -2.548 -1.416 -0.8988 -1.78 -0.2627 -0.8989 -1.819 -3.176 -0.8988 -1.476 0.0025 -0.0134 0 -3.176 -0.8988 1.863 -3.176 0.8155 -1.863 -3.176 0.8155 0 -3.176 0.8155 2.094 -1.441 -1.699 1.524 -2.561 -1.699 0 -2.561 -1.699 -1.524 -2.561 -1.699 -2.094 -1.441 -1.699 -1.516 -0.4945 -1.699 1.516 -0.4945 -1.699 1.553 -0.5642 2.069 1.929 -1.973 3.676 1.929 -3.176 3.35 0 -1.973 4.847 0 -0.4757 3.505 1.514 -0.2808 1.028 2.316 -1.625 0.8155 -1.929 -1.973 3.676 -1.553 -0.5642 2.069 0 -3.176 4.521 -1.929 -3.176 3.35 -1.514 -0.2808 1.028 -2.316 -1.625 0.8155 0 -3.176 3.35 0 -0.0239 1.474]))
                                                ))
                                                (.setTexCoord (doto (TextureCoordinate. )
                        ...
                        (.addChildren (doto (Transform. )
                            ...
                            (.addChild (doto (Shape. )
                                ...
.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        ...
                        (.setCenter (float-array [5.441 45.830002 0.1786]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l_upperarm")
                            ...
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [5.441 45.830002 0.1786]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [6.823 36.080002 0.08607]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_forearm")
                                ...
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [6.823 36.080002 0.08607]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [6.915 28.41 0.3752]))
                                (.setUlimit (float-array [0 0 0]))
                                (.setLlimit (float-array [0 0 0]))
                                (.addChildren (doto (HAnimSegment. )
                                    (.setName "l_carpal")
                                    ...
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [6.915 28.41 0.3752]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "vl5")
                        (.setDEF "hanim_vl5")
                        (.setCenter (float-array [0 35.75 -0.445]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l5")
                            (.setDEF "hanim_l5")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [0 35.75 -0.445]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [0 50.470001 -0.1481]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "skull")
                                (.setDEF "hanim_skull")
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [0 50.470001 -0.1481]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
...
(.toFileX3D X3D0 "../data/KoreanCharacter04Young.new.clojure.x3d")
(.toFileJSON X3D0 "../data/KoreanCharacter04Young.new.clojure.json")
(defn -main []

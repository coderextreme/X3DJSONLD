(defproject KoreanCharacter04Young "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter04Young
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter04Young:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter04Young.jar"
                       :main KoreanCharacter04Young
                       }})

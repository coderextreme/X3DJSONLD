(defproject KoreanCharacter03Hyun "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter03Hyun
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter03Hyun:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter03Hyun.jar"
                       :main KoreanCharacter03Hyun
                       }})

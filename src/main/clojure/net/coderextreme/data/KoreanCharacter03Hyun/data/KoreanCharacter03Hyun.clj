...
(.addComments "original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"'")
            ...
            (.addSkeleton (doto (HAnimJoint. )
                        ...
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                ...
                                (.setTexture (doto (ImageTexture. )
                                    ...
                                    (.setUrl (into-array ["images/Hyun.png" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Hyun.png"]))
                                ))
                            ))
                ...
                (.addChildren (doto (HAnimJoint. )
                    (.setName "l_hip")
                    (.setDEF "hanim_l_hip")
                    (.setCenter (float-array [3.551 29.33 -0.1267]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "l_thigh")
                        (.setDEF "hanim_l_thigh")
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [3.551 29.33 -0.1267]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                                ...
                                (.setGeometry (doto (IndexedFaceSet. )
                                    (.setCoordIndex (int-array [31 30 29 -1 31 29 28 -1 28 34 33 -1 31 28 33 -1 31 33 32 -1 8 7 0 -1 0 1 8 -1 9 8 1 -1 1 2 9 -1 10 9 2 -1 2 3 10 -1 11 10 3 -1 3 4 11 -1 12 11 4 -1 4 5 12 -1 13 12 5 -1 5 6 13 -1 7 13 6 -1 6 0 7 -1 15 14 7 -1 7 8 15 -1 16 15 8 -1 8 9 16 -1 17 16 9 -1 9 10 17 -1 18 17 10 -1 10 11 18 -1 19 18 11 -1 11 12 19 -1 20 19 12 -1 12 13 20 -1 14 20 13 -1 13 7 14 -1 22 21 14 -1 14 15 22 -1 23 22 15 -1 15 16 23 -1 24 23 16 -1 16 17 24 -1 25 24 17 -1 17 18 25 -1 26 25 18 -1 18 19 26 -1 27 26 19 -1 19 20 27 -1 21 27 20 -1 20 14 21 -1 1 0 28 -1 28 29 1 -1 2 1 29 -1 29 30 2 -1 3 2 30 -1 30 31 3 -1 4 3 31 -1 31 32 4 -1 5 4 32 -1 32 33 5 -1 6 5 33 -1 33 34 6 -1 0 6 34 -1 34 28 0 -1 35 36 21 -1 21 22 35 -1 37 35 22 -1 22 23 37 -1 38 37 23 -1 23 24 38 -1 39 38 24 -1 24 25 39 -1 40 39 25 -1 25 26 40 -1 41 40 26 -1 26 27 41 -1 36 41 27 -1 27 21 36 -1 36 35 42 -1 35 37 42 -1 37 38 42 -1 38 39 42 -1 39 40 42 -1 40 41 42 -1 41 36 42 -1]))
                                    (.setCreaseAngle 1.57)
                                    ))
                                ))
                            ))
                        ))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "l_knee")
                        (.setDEF "hanim_l_knee")
                        (.setCenter (float-array [3.71 15.48 -0.1446]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l_calf")
                            (.setDEF "hanim_l_calf")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [3.71 15.48 -0.1446]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [3.388 3.168 -0.537]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_talus")
                                (.setDEF "hanim_l_talus")
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [3.388 3.168 -0.537]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [3.388 2.908 0.7441]))
                                (.addChildren (doto (HAnimSegment. )
                                    (.setName "l_tarsal_proximal_phalanx_2")
                                    (.setDEF "hanim_l_tarsal_proximal_phalanx_2")
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [3.388 2.908 0.7441]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimSegment. )
                        ...
                        (.addChildren (doto (Transform. )
                            ...
                            (.addChild (doto (Shape. )
                                ...
                                (.setGeometry (doto (IndexedFaceSet. )
                                    (.setCoordIndex (int-array [31 32 33 -1 33 34 28 -1 31 33 28 -1 31 28 29 -1 31 29 30 -1 8 1 0 -1 0 7 8 -1 9 2 1 -1 1 8 9 -1 10 3 2 -1 2 9 10 -1 11 4 3 -1 3 10 11 -1 12 5 4 -1 4 11 12 -1 13 6 5 -1 5 12 13 -1 7 0 6 -1 6 13 7 -1 15 8 7 -1 7 14 15 -1 16 9 8 -1 8 15 16 -1 17 10 9 -1 9 16 17 -1 18 11 10 -1 10 17 18 -1 19 12 11 -1 11 18 19 -1 20 13 12 -1 12 19 20 -1 14 7 13 -1 13 20 14 -1 22 15 14 -1 14 21 22 -1 23 16 15 -1 15 22 23 -1 24 17 16 -1 16 23 24 -1 25 18 17 -1 17 24 25 -1 26 19 18 -1 18 25 26 -1 27 20 19 -1 19 26 27 -1 21 14 20 -1 20 27 21 -1 1 29 28 -1 28 0 1 -1 2 30 29 -1 29 
                                    ))
                                    (.setTexCoord (doto (TextureCoordinate. )
                ...
                (.addChildren (doto (HAnimJoint. )
                    ...
                    (.setCenter (float-array [0 26.58 -0.5601]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "pelvis")
                        (.setDEF "hanim_pelvis")
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [0 26.58 -0.5601]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        ...
                        (.setCenter (float-array [5.502 45.779999 -0.3559]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l_upperarm")
                            (.setDEF "hanim_l_upperarm")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [5.502 45.779999 -0.3559]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [6.735 35.669998 -0.4487]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_forearm")
                                (.setDEF "hanim_l_forearm")
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [6.735 35.669998 -0.4487]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [6.432 27.83 -0.1589]))
                                (.addChildren (doto (HAnimSegment. )
                                    (.setName "l_carpal")
                                    (.setDEF "hanim_l_carpal")
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [6.432 27.83 -0.1589]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                                            ...
                                            (.setGeometry (doto (IndexedFaceSet. )
                                                (.setCoordIndex (int-array [0 2 4 -1 4 5 0 -1 3 1 6 -1 6 7 3 -1 5 6 1 -1 1 0 5 -1 5 4 8 -1 8 9 5 -1 7 6 10 -1 10 11 7 -1 6 5 9 -1 9 10 6 -1 9 8 12 -1 12 13 9 -1 11 10 14 -1 14 15 11 -1 10 9 13 -1 13 14 10 -1 4 2 16 -1 7 16 2 -1 2 3 7 -1 18 20 17 -1 17 19 18 -1 7 11 21 -1 21 16 7 -1 8 21 12 -1 11 15 12 -1 12 21 11 -1 15 14 13 -1 13 12 15 -1 19 17 8 -1 8 4 19 -1 18 19 4 -1 4 16 18 -1 20 18 16 -1 16 21 20 -1 17 20 21 -1 21 8 17 -1 22 27 23 -1 26 25 24 -1]))
                                                (.setCreaseAngle 1.57)
                                                (.setTexCoordIndex (int-array [5 7 4 -1 4 6 5 -1 1 0 2 -1 2 3 1 -1 15 17 14 -1 14 16 15 -1 6 4 8 -1 8 9 6 -1 39 41 38 -1 38 40 39 -1 36 37 18 -1 18 19 36 -1 9 8 10 -1 10 11 9 -1 40 38 42 -1 42 43 40 -1 19 18 20 -1 20 21 19 -1 22 24 23 -1 25 23 24 -1 24 26 25 -1 28 30 27 -1 27 29 28 -1 25 32 31 -1 31 23 25 -1 33 31 34 -1 32 35 34 -1 34 31 32 -1 35 21 20 -1 20 34 35 -1 12 13 8 -1 8 4 12 -1 28 29 22 -1 22 23 28 -1 30 28 23 -1 23 31 30 -1 27 30 31 -1 31 33 27 -1 14 24 26 -1 14 16 24 -1]))
                                                (.setCoord (doto (Coordinate. )
                                                    (.setPoint (float-array [1.076 0.3804 0.7047 1.042 0.395 -1.192 -0.6516 0.2878 0.7874 -0.6592 0.2892 -1.133 -0.8366 -0.2556 1.306 1.437 -0.0511 1.226 1.385 -0.0228 -1.757 -0.9384 -0.2412 -1.753 -0.7136 -1.939 2.128 1.733 -1.733 1.838 1.681 -1.704 -2.128 -1.039 -2.028 -1.986 -0.4691 -3.205 1.497 0.8189 -3.398 1.547 0.7668 -3.369 -1.83 -0.6579 -3.218 -1.709 -0.9322 -0.2429 -0.1654 -1.437 -1.988 1.715 -1.733 -0.5679 0.0513 -1.7 -0.6266 1.665 -1.443 -1.986 0.1217 -0.9271 -2.022 -0.178 1.042 0.395 -1.192 -0.6592 0.2892 -1.133 -0.6516 0.2878 0.7874 1.076 0.3804 0.7047 1.042 0.395 -1.192 -0.6516 0.2878 0.7874]))
                                                ))
                                                (.setTexCoord (doto (TextureCoordinate. )
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "vl5")
                        (.setDEF "hanim_vl5")
                        (.setCenter (float-array [0 35.77 -0.5028]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l5")
                            (.setDEF "hanim_l5")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [0 35.77 -0.5028]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [0 49.98 -0.5228]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "skull")
                                (.setDEF "hanim_skull")
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [0 49.98 -0.5228]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
...
(.toFileX3D X3D0 "../../../../../data/KoreanCharacter03Hyun.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/KoreanCharacter03Hyun.new.clojure.x3dj")
(defn -main []

(defproject Humanoid4NoSegSite "1.0.0"
  ...
  :main ^:skip-aot Humanoid4NoSegSite
  ...
  :jvm-opts ["-cp" "src/Humanoid4NoSegSite:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "Humanoid4NoSegSite.jar"
                       :main Humanoid4NoSegSite
                       }})

...
(ns x3dclsail.KoreanCharacter09Ru
...
;original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"'
            ...
            (.addSkeleton (doto (HAnimJoint. )
                ...
                (.setCenter (float-array [0 35.950001 -1.712]))
                ...
                (.addChildren (doto (HAnimSegment. )
                    ...
                    (.addChildren (doto (Transform. )
                        (.setTranslation (float-array [0 35.950001 -1.712]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                ...
                                (.setTexture (doto (ImageTexture. )
                                    ...
                                    (.setUrl (into-array ["images/Ru.png" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ru.png"]))
                                ))
                            ))
                ...
                (.addChildren (doto (HAnimJoint. )
                    (.setName "l_hip")
                    (.setDEF "hanim_l_hip")
                    (.setCenter (float-array [3.602 33.740002 -1.967]))
                    (.setUlimit (float-array [0 0 0]))
                    (.setLlimit (float-array [0 0 0]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "l_thigh")
                        ...
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [3.602 33.740002 -1.967]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "l_knee")
                        (.setDEF "hanim_l_knee")
                        (.setCenter (float-array [3.931 18.23 -1.935]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
;weight values go here in HAnimJoint, or within animating HAnimDisplacer
                        (.addChildren (doto (HAnimSegment. )
                            ...
                            (.setDEF "hanim_l_calf")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [3.931 18.23 -1.935]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [4.077 4.031 -1.998]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_talus")
                                ...
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [4.077 4.031 -1.998]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [4.077 3.104 -0.9239]))
                                (.setUlimit (float-array [0 0 0]))
                                (.setLlimit (float-array [0 0 0]))
                                (.addChildren (doto (HAnimSegment. )
                                    ...
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [4.077 3.104 -0.9239]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                ...
                (.addChildren (doto (HAnimJoint. )
                    ...
                    (.setCenter (float-array [0 32.209999 -2.058]))
                    (.setUlimit (float-array [0 0 0]))
                    (.setLlimit (float-array [0 0 0]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "pelvis")
                        (.setDEF "hanim_pelvis")
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [0 32.209999 -2.058]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        ...
                        (.setCenter (float-array [6.479 53.209999 -2.007]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l_upperarm")
                            ...
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [6.479 53.209999 -2.007]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [7.489 44.990002 -2.016]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_forearm")
                                ...
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [7.489 44.990002 -2.016]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [7.938 35.98 -1.856]))
                                (.setUlimit (float-array [0 0 0]))
                                (.setLlimit (float-array [0 0 0]))
                                (.addChildren (doto (HAnimSegment. )
                                    (.setName "l_carpal")
                                    ...
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [7.938 35.98 -1.856]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "vl5")
                        (.setDEF "hanim_vl5")
                        (.setCenter (float-array [0 38.25 -1.903]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l5")
                            (.setDEF "hanim_l5")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [0 38.25 -1.903]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [0 58.450001 -1.829]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "skull")
                                (.setDEF "hanim_skull")
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [0 58.450001 -1.829]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
...
(.toFileX3D X3D0 "../data/KoreanCharacter09Ru.new.clojure.x3d")
(.toFileJSON X3D0 "../data/KoreanCharacter09Ru.new.clojure.json")
(defn -main []

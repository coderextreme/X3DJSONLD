(defproject KoreanCharacter09Ru "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter09Ru
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter09Ru:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter09Ru.jar"
                       :main KoreanCharacter09Ru
                       }})

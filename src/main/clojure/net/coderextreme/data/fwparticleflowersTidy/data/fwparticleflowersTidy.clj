                ...
                (.setAppearance (doto (Appearance. )
                    ...
                    (.addShaders (doto (ComposedShader. )
                        ...
                        (.addParts (doto (ShaderPart. )
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs"]))
                        ))
                        (.addParts (doto (ShaderPart. )
                            (.setType "FRAGMENT")
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"]))
                        ))
                        (.addField (doto (field. )
...
(.toFileX3D X3D0 "../../../../../data/fwparticleflowersTidy.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/fwparticleflowersTidy.new.clojure.x3dj")
(defn -main []

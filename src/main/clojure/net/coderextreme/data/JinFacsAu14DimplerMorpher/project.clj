(defproject JinFacsAu14DimplerMorpher "1.0.0"
  ...
  :main ^:skip-aot JinFacsAu14DimplerMorpher
  ...
  :jvm-opts ["-cp" "src/JinFacsAu14DimplerMorpher:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinFacsAu14DimplerMorpher.jar"
                       :main JinFacsAu14DimplerMorpher
                       }})

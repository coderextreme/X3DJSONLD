(defproject JinLOA4_scaled1 "1.0.0"
  ...
  :jvm-opts ["-cp" "src/JinLOA4_scaled1:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinLOA4_scaled1.jar"
                       :main JinLOA4_scaled1
                       }})

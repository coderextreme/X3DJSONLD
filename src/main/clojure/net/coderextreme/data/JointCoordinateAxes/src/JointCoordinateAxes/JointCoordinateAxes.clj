    ...
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (Group. )
            (.addChildren (doto (Group. )
                ...
                (.addChildren (doto (Transform. )
                    (.setTranslation (float-array [0 -1 0]))
                    (.setRotation (float-array [1 0 0 3.1416]))
                    (.addChild (doto (Shape. )
        ...
        (.addChildren (doto (Transform. )
            (.setRotation (float-array [0 0 1 -1.5708]))
            (.addChildren (doto (Group. )
                (.addChildren (doto (Group. )
                    (.setUSE "ARROW")
                ))
        ...
        (.addChildren (doto (Transform. )
            (.setRotation (float-array [1 0 0 1.5708]))
            (.addChildren (doto (Group. )
                (.addChildren (doto (Group. )
                    (.setUSE "ARROW")
                ))
...
(.toFileX3D X3D0 "../../../../../data/JointCoordinateAxes.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/JointCoordinateAxes.new.clojure.json")
(defn -main []

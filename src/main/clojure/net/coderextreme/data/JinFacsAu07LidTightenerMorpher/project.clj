(defproject JinFacsAu07LidTightenerMorpher "1.0.0"
  ...
  :main ^:skip-aot JinFacsAu07LidTightenerMorpher
  ...
  :jvm-opts ["-cp" "src/JinFacsAu07LidTightenerMorpher:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinFacsAu07LidTightenerMorpher.jar"
                       :main JinFacsAu07LidTightenerMorpher
                       }})

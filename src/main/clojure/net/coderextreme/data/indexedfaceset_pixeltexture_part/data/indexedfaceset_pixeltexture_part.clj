...
(ns x3dclsail.indexedfaceset_pixeltexture_part
...
(.toFileX3D X3D0 "../data/indexedfaceset_pixeltexture_part.new.clojure.x3d")
(.toFileJSON X3D0 "../data/indexedfaceset_pixeltexture_part.new.clojure.json")
(defn -main []

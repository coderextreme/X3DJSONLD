(defproject JinFacsAu13CheekPufferMorpher "1.0.0"
  ...
  :main ^:skip-aot JinFacsAu13CheekPufferMorpher
  ...
  :jvm-opts ["-cp" "src/JinFacsAu13CheekPufferMorpher:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinFacsAu13CheekPufferMorpher.jar"
                       :main JinFacsAu13CheekPufferMorpher
                       }})

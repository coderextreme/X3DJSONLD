(defproject JoeDemo5JoeSkin5_Final "1.0.0"
  ...
  :main ^:skip-aot JoeDemo5JoeSkin5_Final
  ...
  :jvm-opts ["-cp" "src/JoeDemo5JoeSkin5_Final:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JoeDemo5JoeSkin5_Final.jar"
                       :main JoeDemo5JoeSkin5_Final
                       }})

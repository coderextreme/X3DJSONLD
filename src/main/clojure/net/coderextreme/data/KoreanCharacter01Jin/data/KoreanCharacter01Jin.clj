...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "KoreanCharacter01Jin.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "creator")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "Image")
            (.setContent "../Poses/images/HAnimPoseExampleKoreanCharacter01Jin.png")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "reference")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter01Jin.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
    ...
    (.setScene (doto (Scene. )
        (.addChildren (doto (WorldInfo. )
            (.setTitle "KoreanCharacter01Jin.x3d")
        ))
...
(.addComments "original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'")
            ...
            (.addSkeleton (doto (HAnimJoint. )
                ...
                (.addChildren (doto (HAnimJoint. )
                    ...
                    (.setCenter (float-array [0 30.530001 -0.7076]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "pelvis")
                        (.setDEF "hanim_pelvis")
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [0 30.530001 -0.7076]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [8.093 40.380001 -0.2502]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_forearm")
                                (.setDEF "hanim_l_forearm")
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [8.093 40.380001 -0.2502]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [7.808 31.459999 -0.05849]))
                                (.addChildren (doto (HAnimSegment. )
                                    (.setName "l_carpal")
                                    (.setDEF "hanim_l_carpal")
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [7.808 31.459999 -0.05849]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "vl5")
                        (.setDEF "hanim_vl5")
                        (.setCenter (float-array [0 40.23 -0.8527]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l5")
                            (.setDEF "hanim_l5")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [0 40.23 -0.8527]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
        ...
        (.addChildren (doto (EXPORT. )
            (.setAS "KoreanCharacter01Jin")
            (.setLocalDEF "hanim_Jin")
        ))
    ))
))
(.toFileX3D X3D0 "../../../../../data/KoreanCharacter01Jin.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/KoreanCharacter01Jin.new.clojure.x3dj")
(defn -main []

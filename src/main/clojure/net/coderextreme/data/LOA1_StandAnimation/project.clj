(defproject LOA1_StandAnimation "1.0.0"
  ...
  :main ^:skip-aot LOA1_StandAnimation
  ...
  :jvm-opts ["-cp" "src/LOA1_StandAnimation:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "LOA1_StandAnimation.jar"
                       :main LOA1_StandAnimation
                       }})

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "LOA1_StandAnimation.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "creator")
            (.setContent "Cindy Ballreich cindy@ballreich.net 3Name3D, Joe Williams, Don Brutzman")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "rights")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "TODO")
            (.setContent "consider adding eyeball animation")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "reference")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "subject")
            (.setContent "Nancy Stand Animation HAnim 2001")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/LOA1_StandAnimation.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
            ...
            (.setProtoBody (doto (ProtoBody. )
                (.addChildren (doto (Group. )
                    ...
                    (.addChildren (doto (OrientationInterpolator. )
                        ...
                        (.setKey (float-array [0 1]))
                        (.setKeyValue (float-array [1 0 0 0 1 0 0 0]))
                        (.setIS (doto (IS. )
                            (.addConnect (doto (connect. )
                                (.setNodeField "value_changed")
        ...
        (.addChildren (doto (Anchor. )
            ...
            (.addChildren (doto (Shape. )
                (.setGeometry (doto (Text. )
                    (.setString (into-array ["LOA1_StandAnimation.x3d" "defines a prototype" "for animating a humanoid." "" "Click this text to see" "InterchangableActorsViaDynamicRouting example."]))
...
(.toFileX3D X3D0 "../../../../../data/LOA1_StandAnimation.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/LOA1_StandAnimation.new.clojure.json")
(defn -main []

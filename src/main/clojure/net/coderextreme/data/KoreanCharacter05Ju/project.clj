(defproject KoreanCharacter05Ju "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter05Ju
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter05Ju:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter05Ju.jar"
                       :main KoreanCharacter05Ju
                       }})

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "Image")
            (.setContent "../Poses/images/HAnimPoseExampleKoreanCharacter05Ju.png")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "reference")
...
(.addComments "original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'")
        ...
        (.addChildren (doto (EXPORT. )
            (.setAS "KoreanCharacter05Ju")
            (.setLocalDEF "hanim_Ju")
        ))
    ))
))
(.toFileX3D X3D0 "../../../../../data/KoreanCharacter05Ju.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/KoreanCharacter05Ju.new.clojure.x3dj")
(defn -main []

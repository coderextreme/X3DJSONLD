(ns x3dclsail.KoreanCharacter05Ju
...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "KoreanCharacter05Ju.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "creator")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "warning")
            (.setContent "HAnimJoint and HAnimSegment names upgraded to HAnim2 but graph topology has inconsistencies that do not match loa=1 specification hierarchy")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter05Ju.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
    ...
    (.setScene (doto (Scene. )
        (.addChildren (doto (WorldInfo. )
            (.setTitle "KoreanCharacter05Ju.x3d")
        ))
...
;original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'
            ...
            (.addSkeleton (doto (HAnimJoint. )
                ...
                (.setCenter (float-array [0 36 -0.008798]))
                ...
                (.addChildren (doto (HAnimSegment. )
                    ...
                    (.addChildren (doto (Transform. )
                        (.setTranslation (float-array [0 36 -0.008798]))
                        (.addChild (doto (Shape. )
                ...
                (.addChildren (doto (HAnimJoint. )
                    (.setName "l_hip")
                    (.setDEF "hanim_l_hip")
                    (.setCenter (float-array [3.22 33.619999 -0.2832]))
                    (.setUlimit (float-array [0 0 0]))
                    (.setLlimit (float-array [0 0 0]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "l_thigh")
                        ...
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [3.22 33.619999 -0.2832]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                                    ...
                                    (.setTexture (doto (ImageTexture. )
                                        (.setUSE "JuTextureAtlas")
                                    ))
                                ))
                                (.setGeometry (doto (IndexedFaceSet. )
                                    (.setCoordIndex (int-array [33 32 31 -1 31 30 29 -1 31 29 28 -1 33 31 28 -1 34 33 28 -1 0 1 8 -1 8 7 0 -1 1 2 9 -1 9 8 1 -1 2 3 10 -1 10 9 2 -1 3 4 11 -1 11 10 3 -1 4 5 12 -1 12 11 4 -1 5 6 13 -1 13 12 5 -1 6 0 7 -1 7 13 6 -1 7 8 15 -1 15 14 7 -1 8 9 16 -1 16 15 8 -1 9 10 17 -1 17 16 9 -1 10 11 18 -1 18 17 10 -1 11 12 19 -1 19 18 11 -1 12 13 20 -1 20 19 12 -1 13 7 14 -1 14 20 13 -1 14 15 22 -1 22 21 14 -1 15 16 23 -1 23 22 15 -1 16 17 24 -1 24 23 16 -1 17 18 25 -1 25 24 17 -1 18 19 26 -1 26 25 18 -1 19 20 27 -1 27 26 19 -1 20 14 21 -1 21 27 20 -1 28 29 1 -1 1 0 28 -1 29 30 2 -1 2 1 29 -1 30 31 3 -1 3 2 30 -1 31 32 4 -1 4 3 31 -1 32 33 5 -1 5 4 32 -1 33 34 6 -1 6 5 33 -1 34 28 0 -1 0 6 34 -1 21 22 35 -1 35 36 21 -1 22 23 37 -1 37 35 22 -1 23 24 38 -1 38 37 23 -1 24 25 39 -1 39 38 24 -1 25 26 40 -1 40 39 25 -1 26 27 41 -1 41 40 26 -1 27 21 36
 2.415 -2.206 4.073 1.24 -2.206 4.073 -0.6446 -0.7536 4.073 -1.819 1.058 4.073 -1.4 1.033 -14.67 1.883 1.786 -14.67 0.2976 -0.6591 -14.67 2.275 -1.657 -14.67 1.178 -1.657 -14.67 -0.5825 -0.6591 -14.67 -1.68 1.033 -14.67 -1.288 0.4256 -15.99 1.041 0.7788 -15.99 0.2976 -0.3682 -15.99 1.225 -0.8362 -15.99 0.7104 -0.8362 -15.99 -0.1152 -0.3682 -15.99 -0.63 0.4256 -15.99 -0.4463 -0.1114 -16.17 0.2976]))
                                    ))
                                    (.setTexCoord (doto (TextureCoordinate. )
                                        (.setPoint (float-array [0.7387 0.5078 0.7519 0.5078 0.7092 0.5078 0.6855 0.5078 0.6855 0.5078 0.7092 0.5078 0.7387 0.5078 0.7641 0.4868 0.7464 0.4472 0.7641 0.4472 0.7464 0.4868 0.7065 0.4472 0.7065 0.4868 0.6788 0.4472 0.6788 0.4868 0.6788 0.4472 0.6788 0.4868 0.7065 0.4472 0.7065 0.4868 0.7464 0.4472 0.7464 0.4868 0.7464 0.3861 0.7641 0.3861 0.7065 0.3861 0.6788 0.3861 0.6788 0.3861 0.7065 0.3861 0.7464 0.3861 0.743 0.3252 0.7584 0.3252 0.7085 0.3252 0.6882 0.3252 0.6882 0.3252 0.7085 0.3252 0.743 0.3252 0.7383 0.2938 0.7506 0.2938 0.7107 0.2938 0.6945 0.2938 0.6945 0.2938 0.7107 0.2938 0.7383 0.2938 0.7284 0.2787 0.7342 0.2787 0.7155 0.2787 0.7079 0.2787 0.7079 0.2787 0.7155 0.2787 0.7284 0.2787 0.7197 0.2768]))
                                    ))
                                ))
                            ))
                        ))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "l_knee")
                        (.setDEF "hanim_l_knee")
                        (.setCenter (float-array [3.454 18.67 -0.02158]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l_calf")
                            (.setDEF "hanim_l_calf")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [3.454 18.67 -0.02158]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [3.467 3.522 0.118]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_talus")
                                ...
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [3.467 3.522 0.118]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [3.467 3.251 1.465]))
                                (.setUlimit (float-array [0 0 0]))
                                (.setLlimit (float-array [0 0 0]))
                                (.addChildren (doto (HAnimSegment. )
                                    ...
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [3.467 3.251 1.465]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
-1 2 12 14 -1 14 3 2 -1 3 14 16 -1 16 4 3 -1 4 16 18 -1 18 5 4 -1 5 18 20 -1 20 6 5 -1 6 20 7 -1 7 1 6 -1 29 36 35 -1 35 28 29 -1 28 35 37 -1 37 30 28 -1 30 37 38 -1 38 31 30 -1 31 38 39 -1 39 32 31 -1 32 39 40 -1 40 33 32 -1 33 40 41 -1 41 34 33 -1 34 41 36 -1 36 29 34 -1 36 43 42 -1 42 35 36 -1 35 42 44 -1 44 37 35 -1 37 44 45 -1 45 38 37 -1 38 45 46 -1 46 39 38 -1 39 46 47 -1 47 40 39 -1 40 47 48 -1 48 41 40 -1 41 48 43 -1 43 36 41 -1 43 49 42 -1 42 49 44 -1 44 49 45 -1 45 49 46 -1 46 49 47 -1 47 49 48 -1 48 49 43 -1]))
                                    (.setCoord (doto (Coordinate. )
                                        (.setPoint (float-array [-2.617 2.231 0.2976 -1.527 2.231 2.592 0.9211 2.231 3.159 2.617 2.231 1.571 2.617 2.231 -1.571 0.9211 2.231 -3.159 -1.527 2.231 -2.29 -2.617 -1.238 0.2976 -1.527 -1.238 2.592 0.9211 -1.238 3.159 2.617 -1.238 1.571 2.617 -1.238 -0.9758 0.9211 -1.238 -3.009 -1.527 -1.238 -2.442 -2.617 -6.593 0.2976 -1.527 -6.593 2.58 0.9211 -6.593 3.147 2.617 -6.593 1.571 2.617 -6.593 -0.9758 0.9211 -6.593 -2.564 -1.527 -6.593 -1.997 -2.264 -11.92 0.2976 -1.321 -11.92 2.282 0.7969 -11.92 2.773 2.046 -11.92 1.399 2.046 -11.92 -0.8039 0.7969 -11.92 -2.177 -1.321 -11.92 -1.687 -1.864 4.073 0.2976 -1.058 4.073 1.995 0.7536 4.073 2.415 2.206 4.073 1.24 2.206 4.073 -0.6446 0.7536 4.073 -1.819 -1.058 4.073 -1.4 -1.033 -14.67 1.883 -1.786 -14.67 0.2976 0.6591 -14.67 2.275 1.657 -14.67 1.178 1.657 -14.67 -0.5825 0.6591 -14.67 -1.68 -1.033 -14.67 -1.288 -0.4256 -15.99 1.041 -0.7788 -15.99 0.2976 0.3682 -15.99 1.225 0.8362 -15.99 0.7104 0.8362 -15.99 -0.1152 0.3682 -15.99 -0.63 -0.4256 -15.99 -0.4463 0.1114 -16.17 0.2976]))
                                    ))
                                    (.setTexCoord (doto (TextureCoordinate. )
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [-3.679 3.522 0.118]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "r_talus")
                                ...
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [-3.679 3.522 0.118]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
908 0 -0.5447 -1.908 1.293 -1.746 -2.684 0 -1.746 -2.684 1.018 -0.5447 -1.908 1.293 -3.579 -1.568 -2.687 -1.746 0.4019 -1.918 -3.579 0.4019 -1.877 -0.5447 0.4019 2.687 -1.746 0.4019 1.877 -0.5447 0.4019 1.918 -3.579 0.4019 0 -3.579 0.4019 -1.708 -3.439 1.272 -2.332 -1.78 1.272 2.332 -1.78 1.272 1.708 -3.439 1.272 0 -3.439 1.272 -1.469 -0.8455 1.311 1.469 -0.8455 1.311 0 -0.5969 1.593]))
                                            ))
                                            (.setTexCoord (doto (TextureCoordinate. )
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [-3.679 3.251 1.465]))
                                (.setUlimit (float-array [0 0 0]))
                                (.setLlimit (float-array [0 0 0]))
                                (.addChildren (doto (HAnimSegment. )
                                    ...
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [-3.679 3.251 1.465]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                                            ...
                                            (.setGeometry (doto (IndexedFaceSet. )
                                                (.setCoordIndex (int-array [25 4 3 -1 26 25 3 -1 0 26 3 -1 1 10 26 -1 26 0 1 -1 1 9 12 -1 12 10 1 -1 2 4 25 -1 25 34 2 -1 6 8 31 -1 6 31 32 -1 5 6 32 -1 7 5 32 -1 32 11 7 -1 7 11 12 -1 12 9 7 -1 2 34 31 -1 31 8 2 -1 14 13 19 -1 17 16 15 -1 18 17 15 -1 19 18 15 -1 14 19 15 -1 0 13 14 -1 14 1 0 -1 1 14 15 -1 15 9 1 -1 9 15 16 -1 16 7 9 -1 7 16 17 -1 17 5 7 -1 5 17 18 -1 18 6 5 -1 6 18 19 -1 19 3 6 -1 3 19 13 -1 13 0 3 -1 2 8 6 -1 2 6 3 -1 4 2 3 -1 23 24 20 -1 20 21 23 -1 29 23 21 -1 21 22 29 -1 22 33 29 -1 20 25 26 -1 26 21 20 -1 26 10 22 -1 22 21 26 -1 10 12 33 -1 33 22 10 -1 34 25 20 -1 20 24 34 -1 23 27 28 -1 28 24 23 -1 29 30 27 -1 27 23 29 -1 30 29 33 -1 28 27 32 -1 32 31 28 -1 32 27 30 -1 30 11 32 -1 11 30 33 -1 33 12 11 -1 34 24 28 -1 28 31 34 -1]))
                                                (.setCreaseAngle 1.57)
                                                (.setTexCoordIndex (int-array [12 5 4 -1 13 12 4 -1 0 13 4 -1 1 14 13 -1 13 0 1 -1 1 3 18 -1 18 14 1 -1 2 5 12 -1 12 20 2 -1 7 10 12 -1 7 12 15 -1 6 7 15 -1 8 6 15 -1 15 16 8 -1 8 16 17 -1 17 11 8 -1 9 19 12 -1 12 10 9 -1 22 21 27 -1 25 24 23 -1 26 25 23 -1 27 26 23 -1 22 27 23 -1 0 21 22 -1 22 1 0 -1 1 22 23 -1 23 3 1 -1 11 23 24 -1 24 8 11 -1 8 24 25 -1 25 6 8 -1 6 25 26 -1 26 7 6 -1 7 26 27 -1 27 4 7 -1 4 27 21 -1 21 0 4 -1 9 10 7 -1 9 7 4 -1 5 9 4 -1 29 28 12 -1 12 30 29 -1 31 29 30 -1 30 32 31 -1 32 33 31 -1 12 12 34 -1 34 30 12 -1 34 35 32 -1 32 30 34 -1 35 36 33 -1 33 32 35 -1 37 12 12 -1 12 28 37 -1 38 39 12 -1 12 40 38 -1 41 42 39 -1 39 38 41 -1 42 41 45 -1 12 39 43 -1 43 12 12 -1 43 39 42 -1 42 44 43 -1 44 42 45 -1 45 46 44 -1 47 40 12 -1 12 12 47 -1]))
                                                (.setCoord (doto (Coordinate. )
                                                    (.setPoint (float-array [-2.687 -1.475 -0.9449 -1.918 -3.308 -0.9449 0 0.2536 0.2858 -1.877 -0.2736 -0.9449 -1.556 0.0026 -0.0141 2.687 -1.475 -0.9449 1.877 -0.2736 -0.9449 1.918 -3.308 -0.9449 1.556 0.0026 -0.0141 0 -3.308 -0.9449 -1.965 -3.308 0.8573 1.965 -3.308 0.8573 0 -3.308 0.8573 -2.208 -1.501 -1.786 -1.607 -2.668 -1.786 0 -2.668 -1.786 1.607 -2.668 -1.786 2.208 -1.501 -1.786 1.599 -0.5151 -1.786 -1.599 -0.5151 -1.786 -1.638 -0.5877 2.175 -2.034 -2.055 3.865 -2.034 -3.308 3.522 0 -2.055 5.096 0 -0.4955 3.684 -1.597 -0.2925 1.08 -2.442 -1.692 0.8573 2.034 -2.055 3.865 1.638 -0.5877 2.175 0 -3.308 4.753 2.034 -3.308 3.522 1.597 -0.2925 1.08 2.442 -1.692 0.8573 0 -3.308 3.522 0 -0.0249 1.55]))
                                                ))
                                                (.setTexCoord (doto (TextureCoordinate. )
                ...
                (.addChildren (doto (HAnimJoint. )
                    ...
                    (.setCenter (float-array [0.000034 31.26 -0.008798]))
                    (.setUlimit (float-array [0 0 0]))
                    (.setLlimit (float-array [0 0 0]))
                    (.addChildren (doto (HAnimSegment. )
                        (.setName "pelvis")
                        (.setDEF "hanim_pelvis")
                        (.addChildren (doto (Transform. )
                            (.setTranslation (float-array [0.000034 31.26 -0.008798]))
                            (.addChild (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
                                    (.setMaterial (doto (Material. )
                                        (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        ...
                        (.setCenter (float-array [4.778 51.029999 -2.069]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l_upperarm")
                            ...
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [4.778 51.029999 -2.069]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [5.297 40.119999 -2.055]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "l_forearm")
                                ...
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [5.297 40.119999 -2.055]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                            ...
                            (.addChildren (doto (HAnimJoint. )
                                ...
                                (.setCenter (float-array [5.07 31.99 -1.559]))
                                (.setUlimit (float-array [0 0 0]))
                                (.setLlimit (float-array [0 0 0]))
                                (.addChildren (doto (HAnimSegment. )
                                    (.setName "l_carpal")
                                    ...
                                    (.addChildren (doto (Transform. )
                                        (.setTranslation (float-array [5.07 31.99 -1.559]))
                                        (.addChild (doto (Shape. )
                                            (.setAppearance (doto (Appearance. )
                                                (.setMaterial (doto (Material. )
                                                    (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                                            ...
                                            (.setGeometry (doto (IndexedFaceSet. )
                                                ...
                                                (.setCreaseAngle 1.57)
                                                (.setTexCoordIndex (int-array [0 2 1 -1 1 3 0 -1 36 38 37 -1 37 39 36 -1 28 30 29 -1 29 31 28 -1 4 5 2 -1 2 0 4 -1 40 41 38 -1 38 36 40 -1 32 33 31 -1 31 29 32 -1 6 7 5 -1 5 4 6 -1 42 43 41 -1 41 40 42 -1 34 35 33 -1 33 32 34 -1 10 12 11 -1 12 14 13 -1 13 11 12 -1 15 17 16 -1 16 18 15 -1 19 11 13 -1 13 20 19 -1 21 19 22 -1 22 19 20 -1 20 23 22 -1 24 22 23 -1 23 25 24 -1 4 0 8 -1 8 9 4 -1 10 11 16 -1 16 17 10 -1 11 19 18 -1 18 16 11 -1 19 21 15 -1 15 18 19 -1 14 12 26 -1 26 27 14 -1]))
                                                (.setCoord (doto (Coordinate. )
                                                    (.setPoint (float-array [0.8732 0.4437 0.6298 0.8463 0.4584 -1.065 -0.5135 0.3661 0.7037 -0.5196 0.3675 -1.013 -0.6654 -0.1688 1.167 1.16 0.015 1.096 1.119 0.0434 -1.571 -0.747 -0.1537 -1.566 -0.5777 -1.832 1.902 1.387 -1.647 1.643 1.345 -1.619 -1.902 -0.8391 -1.916 -1.775 -0.3897 -3.083 1.338 0.6425 -3.283 1.382 0.6009 -3.255 -1.636 -0.5412 -3.094 -1.527 -0.742 -0.1555 -0.1478 -1.159 -1.873 1.533 -1.387 -0.4699 0.0458 -1.361 -0.5281 1.488 -1.163 -1.872 0.1088 -0.7494 -1.912 -0.1591]))
                                                ))
                                                (.setTexCoord (doto (TextureCoordinate. )
                                                    (.setPoint (float-array [0.4675 0.2229 0.4534 0.3224 0.4709 0.3268 0.4579 0.2308 0.5552 0.233 0.5504 0.3288 0.6215 0.2576 0.6159 0.3282 0.478 0.1884 0.5527 0.2007 0.4618 0.1862 0.4629 0.1191 0.4583 0.192 0.4802 0.0435 0.4672 0.0405 0.5177 0.1794 0.4789 0.1246 0.4811 0.1812 0.515 0.132 0.538 0.1232 0.5459 0.0341 0.5348 0.1824 0.6006 0.1887 0.5977 0.0452 0.6323 0.1888 0.629 0.0403 0.4501 0.1899 0.4535 0.0388 0.5577 0.3108 0.5496 0.3395 0.5573 0.3333 0.5503 0.3041 0.5263 0.3468 0.527 0.2997 0.5106 0.3433 0.5113 0.3032 0.4584 0.3225 0.4544 0.2224 0.4607 0.2253 0.4525 0.325 0.5365 0.3334 0.5532 0.2053 0.6323 0.3251 0.6179 0.2145]))
                                                ))
                                            ))
                                        ))
                                    ))
                                    ...
                                    (.addChildren (doto (Transform. )
                                        ...
                                        (.addChild (doto (Shape. )
                                            ...
                                            (.setGeometry (doto (IndexedFaceSet. )
                                                ...
                                                (.setCreaseAngle 1.57)
                                                (.setTexCoordIndex (int-array [0 3 1 -1 1 2 0 -1 36 39 37 -1 37 38 36 -1 28 31 29 -1 29 30 28 -1 4 0 2 -1 2 5 4 -1 40 36 38 -1 38 41 40 -1 32 29 31 -1 31 33 32 -1 6 4 5 -1 5 7 6 -1 42 40 41 -1 41 43 42 -1 34 32 33 -1 33 35 34 -1 10 11 12 -1 12 11 13 -1 13 14 12 -1 15 18 16 -1 16 17 15 -1 19 20 13 -1 13 11 19 -1 21 22 19 -1 22 23 20 -1 20 19 22 -1 24 25 23 -1 23 22 24 -1 4 9 8 -1 8 0 4 -1 10 17 16 -1 16 11 10 -1 11 16 18 -1 18 19 11 -1 19 18 15 -1 15 21 19 -1 14 27 26 -1 26 12 14 -1]))
                                                (.setCoord (doto (Coordinate. )
                                                    (.setPoint (float-array [-0.8732 0.4437 0.6298 -0.8463 0.4584 -1.065 0.5135 0.3661 0.7037 0.5196 0.3675 -1.013 0.6654 -0.1688 1.167 -1.16 0.015 1.096 -1.119 0.0434 -1.571 0.747 -0.1537 -1.566 0.5777 -1.832 1.902 -1.387 -1.647 1.643 -1.345 -1.619 -1.902 0.8391 -1.916 -1.775 0.3897 -3.083 1.338 -0.6425 -3.283 1.382 -0.6009 -3.255 -1.636 0.5412 -3.094 -1.527 0.742 -0.1555 -0.1478 1.159 -1.873 1.533 1.387 -0.4699 0.0458 1.361 -0.5281 1.488 1.163 -1.872 0.1088 0.7494 -1.912 -0.1591]))
                                                ))
                                                (.setTexCoord (doto (TextureCoordinate. )
                    ...
                    (.addChildren (doto (HAnimJoint. )
                        (.setName "vl5")
                        (.setDEF "hanim_vl5")
                        (.setCenter (float-array [0.000025 39.84 0.1163]))
                        (.setUlimit (float-array [0 0 0]))
                        (.setLlimit (float-array [0 0 0]))
                        (.addChildren (doto (HAnimSegment. )
                            (.setName "l5")
                            (.setDEF "hanim_l5")
                            (.addChildren (doto (Transform. )
                                (.setTranslation (float-array [0.000025 39.84 0.1163]))
                                (.addChild (doto (Shape. )
                                    (.setAppearance (doto (Appearance. )
                                        (.setMaterial (doto (Material. )
                                            (.setDiffuseColor (float-array [0.588 0.588 0.588]))
                        ...
                        (.addChildren (doto (HAnimJoint. )
                            ...
                            (.setCenter (float-array [0.000025 56.07 -1.554]))
                            (.setUlimit (float-array [0 0 0]))
                            (.setLlimit (float-array [0 0 0]))
                            (.addChildren (doto (HAnimSegment. )
                                (.setName "skull")
                                (.setDEF "hanim_skull")
                                (.addChildren (doto (Transform. )
                                    (.setTranslation (float-array [0.000025 56.07 -1.554]))
                                    (.addChild (doto (Shape. )
                                        (.setAppearance (doto (Appearance. )
                                            (.setMaterial (doto (Material. )
                                                (.setDiffuseColor (float-array [0.588 0.588 0.588]))
...
(.toFileX3D X3D0 "../data/KoreanCharacter05Ju.new.clojure.x3d")
(.toFileJSON X3D0 "../data/KoreanCharacter05Ju.new.clojure.json")
(defn -main []

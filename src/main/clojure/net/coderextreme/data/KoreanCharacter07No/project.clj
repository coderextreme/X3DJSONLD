(defproject KoreanCharacter07No "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter07No
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter07No:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter07No.jar"
                       :main KoreanCharacter07No
                       }})

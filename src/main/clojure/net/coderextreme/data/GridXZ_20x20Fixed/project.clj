(defproject GridXZ_20x20Fixed "1.0.0"
  ...
  :main ^:skip-aot GridXZ_20x20Fixed
  ...
  :jvm-opts ["-cp" "src/GridXZ_20x20Fixed:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "GridXZ_20x20Fixed.jar"
                       :main GridXZ_20x20Fixed
                       }})

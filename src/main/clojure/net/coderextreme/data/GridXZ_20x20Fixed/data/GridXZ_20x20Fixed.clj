...
(def X3D0 (doto (X3D.)
    ...
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (Viewpoint. )
            ...
            (.setPosition (float-array [0 10 25]))
        ))
            ...
            (.addChildren (doto (Group. )
                (.addChildren (doto (Shape. )
                    ...
                    (.setGeometry (doto (IndexedLineSet. )
                        (.setColorIndex (int-array [1 0 0 0 0 2 0 0 0 0 1 0 0 0 0 2 0 0 0 0 1]))
                        (.setColorPerVertex false)
                        (.setCoordIndex (int-array [1 22 -1 2 23 -1 3 24 -1 4 25 -1 5 26 -1 6 27 -1 7 28 -1 8 29 -1 9 30 -1 10 31 -1 11 32 -1 12 33 -1 13 34 -1 14 35 -1 15 36 -1 16 37 -1 17 38 -1 18 39 -1 19 40 -1 20 41 -1 21 42 -1]))
                        (.setCoord (doto (Coordinate. )
                            (.setDEF "EndPoints")
                            (.setPoint (float-array [0 0 0 -10 0 10 -9 0 10 -8 0 10 -7 0 10 -6 0 10 -5 0 10 -4 0 10 -3 0 10 -2 0 10 -1 0 10 0 0 10 1 0 10 2 0 10 3 0 10 4 0 10 5 0 10 6 0 10 7 0 10 8 0 10 9 0 10 10 0 10 -10 0 -10 -9 0 -10 -8 0 -10 -7 0 -10 -6 0 -10 -5 0 -10 -4 0 -10 -3 0 -10 -2 0 -10 -1 0 -10 0 0 -10 1 0 -10 2 0 -10 3 0 -10 4 0 -10 5 0 -10 6 0 -10 7 0 -10 8 0 -10 9 0 -10 10 0 -10]))
                        ))
                        (.setColor (doto (Color. )
                            (.setColor (float-array [0.4 0.4 0.4 0.8 0.2 0 0.4 0.1 0.05]))
                        ))
                    ))
                ))
                (.addChildren (doto (Transform. )
                    (.setDEF "LinesAlignedAlongX")
                    (.setRotation (float-array [0 1 0 1.57079]))
                    (.addChild (doto (Shape. )
                ...
                (.addChildren (doto (Transform. )
                    (.setTranslation (float-array [10 -0.5 10]))
                    (.addChildren (doto (Billboard. )
                        (.addChildren (doto (Shape. )
                            (.setGeometry (doto (Text. )
                                (.setString (into-array ["10 0 10"]))
                                (.setFontStyle (doto (FontStyle. )
                                    (.setUSE "FS4")
                                ))
                            ))
...
(.toFileX3D X3D0 "../../../../../data/GridXZ_20x20Fixed.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/GridXZ_20x20Fixed.new.clojure.x3dj")
(defn -main []

(defproject KoreanCharacter06Ga "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter06Ga
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter06Ga:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter06Ga.jar"
                       :main KoreanCharacter06Ga
                       }})

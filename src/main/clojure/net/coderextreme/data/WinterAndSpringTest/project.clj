(defproject WinterAndSpringTest "1.0.0"
  ...
  :main ^:skip-aot WinterAndSpringTest
  ...
  :jvm-opts ["-cp" "src/WinterAndSpringTest:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "WinterAndSpringTest.jar"
                       :main WinterAndSpringTest
                       }})

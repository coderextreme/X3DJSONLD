(defproject conan_with_texture_files "1.0.0"
  ...
  :main ^:skip-aot conan_with_texture_files
  ...
  :jvm-opts ["-cp" "src/conan_with_texture_files:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "conan_with_texture_files.jar"
                       :main conan_with_texture_files
                       }})

(defproject JinFacsAu15LipCornerDepressorMorpher "1.0.0"
  ...
  :main ^:skip-aot JinFacsAu15LipCornerDepressorMorpher
  ...
  :jvm-opts ["-cp" "src/JinFacsAu15LipCornerDepressorMorpher:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinFacsAu15LipCornerDepressorMorpher.jar"
                       :main JinFacsAu15LipCornerDepressorMorpher
                       }})

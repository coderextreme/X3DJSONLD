(defproject New2TemplateNoBoxes "1.0.0"
  ...
  :main ^:skip-aot New2TemplateNoBoxes
  ...
  :jvm-opts ["-cp" "src/New2TemplateNoBoxes:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "New2TemplateNoBoxes.jar"
                       :main New2TemplateNoBoxes
                       }})

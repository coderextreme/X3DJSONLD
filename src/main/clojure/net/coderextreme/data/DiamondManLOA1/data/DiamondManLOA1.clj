...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "DiamondManLOA1.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "HAnim skeletal structure for Level of Action (LOA) one, with diamonds at the Joint centers, also includes HAnimSite feaature points. LOA-1 is typical low-end real-time 3D hierarchy.")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "creator")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA1.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
    ...
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (HAnimHumanoid. )
            ...
            (.addViewpoints (doto (HAnimSite. )
                (.setDEF "hanim_DiamondManLOA1_view")
                (.setName "DiamondManLOA1_view")
...
(.toFileX3D X3D0 "../../../../../data/DiamondManLOA1.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/DiamondManLOA1.new.clojure.x3dj")
(defn -main []

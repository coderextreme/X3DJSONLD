(defproject KoreanCharacter11Min "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter11Min
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter11Min:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter11Min.jar"
                       :main KoreanCharacter11Min
                       }})

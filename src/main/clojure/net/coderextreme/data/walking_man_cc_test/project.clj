(defproject walking_man_cc_test "1.0.0"
  ...
  :main ^:skip-aot walking_man_cc_test
  ...
  :jvm-opts ["-cp" "src/walking_man_cc_test:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "walking_man_cc_test.jar"
                       :main walking_man_cc_test
                       }})

...
(def X3D0 (doto (X3D.)
    ...
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (Transform. )
            ...
            (.setTranslation (float-array [0 -0.165 0.02]))
                ...
                (.addChildren (doto (Shape. )
                    (.setAppearance (doto (Appearance. )
                        ...
                        (.setMaterial (doto (Material. )
                            ...
                            (.setDiffuseColor (float-array [0.372322 0.371574 0.373173]))
                            (.setShininess 0.02)
                            (.setSpecularColor (float-array [0.890909 0.887832 0.890909]))
(.addComments "Universal Media Library: Metals 30")
                ...
                (.addChildren (doto (Shape. )
                    (.setGeometry (doto (IndexedFaceSet. )
                        ...
                        (.setConvex false)
                        (.setCoordIndex (int-array [0 1 13 12 -1 1 2 14 13 -1 2 3 15 14 -1 3 4 16 15 -1 4 5 17 16 -1 5 6 18 17 -1 6 7 19 18 -1 7 8 20 19 -1 8 9 21 20 -1 9 10 22 21 -1 10 11 23 22 -1 11 0 12 23 -1 1 0 24 -1 2 1 24 -1 3 2 24 -1 4 3 24 -1 5 4 24 -1 6 5 24 -1 7 6 24 -1 8 7 24 -1 9 8 24 -1 10 9 24 -1 11 10 24 -1 0 11 24 -1 12 13 25 -1 13 14 25 -1 14 15 25 -1 15 16 25 -1 16 17 25 -1 17 18 25 -1 18 19 25 -1 19 20 25 -1 20 21 25 -1 21 22 25 -1 22 23 25 -1 23 12 25 -1]))
                        (.setCreaseAngle 0.7854)
                        (.setCoord (doto (Coordinate. )
                            (.setDEF "pCylinder1GeoPoints")
                            (.setPoint (float-array [-0.36 -2.39 -0.26 -0.36 -1.77 -0.89 -0.36 0 -1.7 -0.36 0.85 -1.47 -0.36 1.47 -0.85 -0.36 1.7 0 -0.36 1.47 0.85 -0.36 -0.07 2.05 -0.36 -0.92 2.28 -0.36 -1.77 2.05 -0.36 -2.39 1.43 -0.36 -2.62 0.58 0.36 -2.39 -0.26 0.36 -1.77 -0.89 0.36 0 -1.7 0.36 0.85 -1.47 0.36 1.47 -0.85 0.36 1.7 0 0.36 1.47 0.85 0.36 -0.07 2.05 0.36 -0.92 2.28 0.36 -1.77 2.05 0.36 -2.39 1.43 0.36 -2.62 0.58 -0.36 -0.46 0.31 0.36 -0.46 0.31]))
                        ))
                    ))
                    (.setAppearance (doto (Appearance. )
            ...
            (.addChildren (doto (Group. )
                (.addChildren (doto (Transform. )
                    (.setDEF "pCylinder1")
                    (.setRotation (float-array [-1 0 0 0.373518]))
                    (.setTranslation (float-array [-0.038462 3.596312 3.297562]))
                    (.addChild (doto (Shape. )
                        (.setAppearance (doto (Appearance. )
                            (.setUSE "CameraAppearance")
                        ))
                ...
                (.addChildren (doto (Transform. )
                    (.setDEF "pCube1")
                    (.setScale (float-array [1 0.727134 0.801457]))
                    (.setTranslation (float-array [-0.030769 1.738461 1.4436]))
                    (.addChild (doto (Shape. )
                        (.setAppearance (doto (Appearance. )
                            (.setUSE "CameraAppearance")
                        ))
                ...
                (.addChildren (doto (Transform. )
                    (.setDEF "pPipe1")
                    (.setScale (float-array [1 1 0.569444]))
                    (.setTranslation (float-array [0.015385 1.630769 -1.973274]))
                    (.addChild (doto (Shape. )
                        (.setAppearance (doto (Appearance. )
                            (.setUSE "CameraAppearance")
                        ))
                ...
                (.addChildren (doto (Transform. )
                    (.setDEF "pSphere1")
                    (.setScale (float-array [1.1 1.1 0.1]))
                    (.setTranslation (float-array [-0.015385 1.628515 -2.569231]))
                    (.addChild (doto (Shape. )
                        (.setAppearance (doto (Appearance. )
                            (.setUSE "CameraAppearance")
                        ))
...
(.toFileX3D X3D0 "../../../../../data/CameraShape.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/CameraShape.new.clojure.x3dj")
(defn -main []

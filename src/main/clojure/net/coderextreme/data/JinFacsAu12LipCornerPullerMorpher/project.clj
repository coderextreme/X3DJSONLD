(defproject JinFacsAu12LipCornerPullerMorpher "1.0.0"
  ...
  :main ^:skip-aot JinFacsAu12LipCornerPullerMorpher
  ...
  :jvm-opts ["-cp" "src/JinFacsAu12LipCornerPullerMorpher:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinFacsAu12LipCornerPullerMorpher.jar"
                       :main JinFacsAu12LipCornerPullerMorpher
                       }})

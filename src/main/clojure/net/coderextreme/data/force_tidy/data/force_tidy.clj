...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
            (.setContent "x3d-tidy V1.0.175, https://www.npmjs.com/package/x3d-tidy")
        ))
    ))
    (.setScene (doto (Scene. )
...
(.toFileJSON X3D0 "../data/force_tidy.new.clojure.json")
(defn -main []

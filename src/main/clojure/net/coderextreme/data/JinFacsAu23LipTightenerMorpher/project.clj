(defproject JinFacsAu23LipTightenerMorpher "1.0.0"
  ...
  :main ^:skip-aot JinFacsAu23LipTightenerMorpher
  ...
  :jvm-opts ["-cp" "src/JinFacsAu23LipTightenerMorpher:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinFacsAu23LipTightenerMorpher.jar"
                       :main JinFacsAu23LipTightenerMorpher
                       }})

(ns indexedfacesetPixeltexture_entire
        ...
        (.addChildren (doto (Shape. )
            ...
            (.setGeometry (doto (IndexedFaceSet. )
                ...
                (.setCoord (doto (Coordinate. )
                    (.setPoint (float-array [-2 1.5 1 -2 -1.5 1 2 1.5 1 2 -1.5 1 2 1.5 -1 2 -1.5 -1 -2 1.5 -1 -2 -1.5 -1]))
                ))
            ))
        ))
    ))
))
(.toFileX3D X3D0 "../../../../../data/indexedfacesetPixeltexture_entire.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/indexedfacesetPixeltexture_entire.new.clojure.x3dj")
(defn -main []

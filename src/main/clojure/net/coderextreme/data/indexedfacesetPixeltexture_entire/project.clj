(defproject indexedfacesetPixeltexture_entire "1.0.0"
  ...
  :source-paths ["src" "src/indexedfacesetPixeltexture_entire"]
  
  :main ^:skip-aot indexedfacesetPixeltexture_entire

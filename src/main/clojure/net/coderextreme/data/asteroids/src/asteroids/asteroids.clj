...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/data/asteroids.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "asteroids")
        ))
    ))
    (.setScene (doto (Scene. )
...
(.toFileX3D X3D0 "../../../../../data/asteroids.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/asteroids.new.clojure.x3dj")
(defn -main []

...
(ns x3dclsail.indexedfaceset_pixeltexture_entire
...
(.toFileX3D X3D0 "../data/indexedfaceset_pixeltexture_entire.new.clojure.x3d")
(.toFileJSON X3D0 "../data/indexedfaceset_pixeltexture_entire.new.clojure.json")
(defn -main []

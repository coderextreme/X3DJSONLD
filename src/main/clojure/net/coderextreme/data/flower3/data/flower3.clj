...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/data/flower3.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "a flower")
...
(.addComments "<field accessType=\"initializeOnly\" name=\"resolution\" type=\"SFInt32\" value=\"100\"/>")
...
(.toFileX3D X3D0 "../../../../../data/flower3.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/flower3.new.clojure.x3dj")
(defn -main []

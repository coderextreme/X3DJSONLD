...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/data/ThreeDTexture.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "a kind of ThreeDTexture cube with spheres")
        ))
    ))
    (.setScene (doto (Scene. )
...
(.toFileX3D X3D0 "../../../../../data/ThreeDTexture.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/ThreeDTexture.new.clojure.x3dj")
(defn -main []

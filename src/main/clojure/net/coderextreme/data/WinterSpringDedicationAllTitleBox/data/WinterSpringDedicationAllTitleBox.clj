(ns WinterSpringDedicationAllTitleBox
...
(def X3D0 (doto (X3D.)
    ...
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (Transform. )
            ...
            (.setTranslation (float-array [10 10 -10]))
            (.addChild (doto (Shape. )
                (.setAppearance (doto (Appearance. )
                    (.setMaterial (doto (Material. )
                    ))
                    (.setTexture (doto (ImageTexture. )
                        (.setUrl (into-array ["images/WSDedicationAll.png" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSDedicationAll.png"]))
                    ))
                ))
...
(.toFileX3D X3D0 "../../../../../data/WinterSpringDedicationAllTitleBox.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/WinterSpringDedicationAllTitleBox.new.clojure.x3dj")
(defn -main []

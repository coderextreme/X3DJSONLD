...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA2.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
...
(.toFileX3D X3D0 "../../../../../data/JinOriginalLOA2.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/JinOriginalLOA2.new.clojure.x3dj")
(defn -main []

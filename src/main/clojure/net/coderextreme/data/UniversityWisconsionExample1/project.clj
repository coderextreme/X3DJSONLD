(defproject UniversityWisconsionExample1 "1.0.0"
  ...
  :main ^:skip-aot UniversityWisconsionExample1
  ...
  :jvm-opts ["-cp" "src/UniversityWisconsionExample1:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "UniversityWisconsionExample1.jar"
                       :main UniversityWisconsionExample1
                       }})

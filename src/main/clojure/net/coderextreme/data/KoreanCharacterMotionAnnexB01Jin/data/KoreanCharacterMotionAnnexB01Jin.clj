...
(ns x3dclsail.KoreanCharacterMotionAnnexB01Jin
    ...
    (.setScene (doto (Scene. )
                        ...
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                ...
                                (.setTexture (doto (ImageTexture. )
                                    ...
                                    (.setUrl (into-array ["Jin.png" "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/Jin.png"]))
                                ))
                            ))
        ...
        (.addChildren (doto (Group. )
            ...
            (.addChildren (doto (OrientationInterpolator. )
                ...
                (.setKeyValue (float-array [0 0 0 0 -1 0 0 3 0 0 0 0]))
            ))
            (.addChildren (doto (OrientationInterpolator. )
...
(.toFileX3D X3D0 "../data/KoreanCharacterMotionAnnexB01Jin.new.clojure.x3d")
(.toFileJSON X3D0 "../data/KoreanCharacterMotionAnnexB01Jin.new.clojure.json")
(defn -main []

(defproject OrientationInterpolator "1.0.0"
  ...
  :main ^:skip-aot OrientationInterpolator
  ...
  :jvm-opts ["-cp" "src/OrientationInterpolator:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "OrientationInterpolator.jar"
                       :main OrientationInterpolator
                       }})

(defproject IcosahedronSubdivisionLevel5 "1.0.0"
  ...
  :main ^:skip-aot IcosahedronSubdivisionLevel5
  ...
  :jvm-opts ["-cp" "src/IcosahedronSubdivisionLevel5:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "IcosahedronSubdivisionLevel5.jar"
                       :main IcosahedronSubdivisionLevel5
                       }})

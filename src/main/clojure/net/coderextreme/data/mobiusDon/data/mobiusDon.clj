            ...
            (.addChildren (doto (Shape. )
                (.setGeometry (doto (LineSet. )
                    ...
                    (.setCoord (doto (Coordinate. )
                        (.setPoint (float-array [0 0 0 1 0 0]))
                    ))
                ))
                (.setAppearance (doto (Appearance. )
                    (.setMaterial (doto (Material. )
...
(.addComments "linetype='1' solid")
            ...
            (.addChildren (doto (Shape. )
                (.setGeometry (doto (LineSet. )
                    (.setVertexCount (int-array [2]))
                    (.setCoord (doto (Coordinate. )
                        (.setPoint (float-array [0 0 0 0 1 0]))
                    ))
                ))
                (.setAppearance (doto (Appearance. )
                    (.setMaterial (doto (Material. )
...
(.addComments "linetype='1' solid")
            ...
            (.addChildren (doto (Shape. )
                (.setGeometry (doto (LineSet. )
                    (.setVertexCount (int-array [2]))
                    (.setCoord (doto (Coordinate. )
                        (.setPoint (float-array [0 0 0 0 0 1]))
                    ))
                ))
                (.setAppearance (doto (Appearance. )
                    (.setMaterial (doto (Material. )
...
(.toFileX3D X3D0 "../../../../../data/mobiusDon.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/mobiusDon.new.clojure.x3dj")
(defn -main []

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "modified")
            (.setContent "Mon, 09 Feb 2026 12:09:33 GMT")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
        ...
        (.addChildren (doto (Transform. )
            ...
            (.addChildren (doto (Group. )
                ...
                (.addChildren (doto (Transform. )
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble1")
                        (.setTranslation (float-array [0.7994389 0.7994389 0.7994389]))
                        (.addChild (doto (Shape. )
                    ...
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble2")
                        (.setTranslation (float-array [0.2984804 0.4984804 0.4568088]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 1]))
                    ...
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble3")
                        (.setTranslation (float-array [0.6313267 0.6480567 0.0062763]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 1]))
                    ...
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble4")
                        (.setTranslation (float-array [0.626125 0.626125 0.00626125]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 1]))
                    ...
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble5")
                        (.setTranslation (float-array [0.7424167 0.7424167 0.007424167]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 1]))
                    ...
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble6")
                        (.setTranslation (float-array [0.6620353 0.8006624 0.0310758]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 1]))
                    ...
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble7")
                        (.setTranslation (float-array [0.7532547 0.6806429 0.003167512]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 1]))
                    ...
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble8")
                        (.setTranslation (float-array [0.6299029 0.4176025 0.006382725]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 1]))
                    ...
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble9")
                        (.setTranslation (float-array [0.4606465 0.4322842 0.006670406]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 1]))
                    ...
                    (.addChildren (doto (Transform. )
                        (.setDEF "bubble10")
                        (.setTranslation (float-array [0.7289676 0.7244917 0.007337629]))
                        (.addChild (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 1]))

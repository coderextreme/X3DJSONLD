(defproject KoreanCharacter10Mi "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter10Mi
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter10Mi:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter10Mi.jar"
                       :main KoreanCharacter10Mi
                       }})

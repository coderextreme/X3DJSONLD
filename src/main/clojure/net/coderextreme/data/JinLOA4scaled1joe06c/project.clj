(defproject JinLOA4scaled1joe06c "1.0.0"
  ...
  :main ^:skip-aot JinLOA4scaled1joe06c
  ...
  :jvm-opts ["-cp" "src/JinLOA4scaled1joe06c:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinLOA4scaled1joe06c.jar"
                       :main JinLOA4scaled1joe06c
                       }})

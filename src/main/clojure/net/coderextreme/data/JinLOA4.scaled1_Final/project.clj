(defproject JinLOA4.scaled1_Final "1.0.0"
  ...
  :main ^:skip-aot JinLOA4.scaled1_Final
  ...
  :jvm-opts ["-cp" "src/JinLOA4.scaled1_Final:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinLOA4.scaled1_Final.jar"
                       :main JinLOA4.scaled1_Final
                       }})

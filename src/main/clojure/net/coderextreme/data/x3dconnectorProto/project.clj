(defproject x3dconnectorProto "1.0.0"
  ...
  :main ^:skip-aot x3dconnectorProto
  ...
  :jvm-opts ["-cp" "src/x3dconnectorProto:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "x3dconnectorProto.jar"
                       :main x3dconnectorProto
                       }})

(ns indexedfacesetPixeltexture_part
...
(.addComments "<Environment id=\"gamma\" gammaCorrectionDefault=\"none\"></Environment>")
        (.addChildren (doto (Shape. )
            (.setAppearance (doto (Appearance. )
                ...
                (.setTexture (doto (PixelTexture. )
                    ...
                    (.setTextureProperties (doto (TextureProperties. )
            ...
            (.setGeometry (doto (IndexedFaceSet. )
                ...
                (.setTexCoord (doto (TextureCoordinate. )
                    (.setPoint (float-array [0.5 1 0.5 0.5 1 1 1 0.5]))
                ))
            ))
        ))
    ))
))
(.toFileX3D X3D0 "../../../../../data/indexedfacesetPixeltexture_part.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/indexedfacesetPixeltexture_part.new.clojure.x3dj")
(defn -main []

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "modified")
            (.setContent "Mon, 09 Feb 2026 12:24:30 GMT")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "translator")
...
(.toFileX3D X3D0 "../../../../../data/JinNasolabialDeepener.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/JinNasolabialDeepener.new.clojure.x3dj")
(defn -main []

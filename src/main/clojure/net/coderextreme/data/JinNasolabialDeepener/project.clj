(defproject JinNasolabialDeepener "1.0.0"
  ...
  :main ^:skip-aot JinNasolabialDeepener
  ...
  :jvm-opts ["-cp" "src/JinNasolabialDeepener:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinNasolabialDeepener.jar"
                       :main JinNasolabialDeepener
                       }})

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "AllAudioGraphNodesTest.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "List of all X3D4 audio graph nodes to test infrastructure and validation support. Absence of attributes means that checking and removal of default values is working.")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "creator")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "created")
            (.setContent "25 October 2020")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "modified")
            (.setContent "Mon, 15 Sep 2025 05:18:43 GMT")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "warning")
            (.setContent "Developmental test, no actual 3D model expected")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/AllAudioGraphNodesTest.x3d")
        ))
    ))
    (.setScene (doto (Scene. )
        (.addChildren (doto (WorldInfo. )
            (.setTitle "AllAudioGraphNodesTest.x3d")
        ))
        (.addChildren (doto (Shape. )
            (.setAppearance (doto (Appearance. )
                (.setAcousticProperties (doto (AcousticProperties. )
                    (.setDescription "Testing of X3D4 nodes demonstrating W3C Audio API in progress")
                    (.setDiffuse 0.25)
                    (.setSpecular 1.0)
                    (.setRefraction 0.5)
                ))
        ...
        (.addChildren (doto (Sound. )
            ...
            (.setSource (doto (AudioClip. )
                ...
                (.setUrl (into-array ["sound/saxophone.mp3" "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/saxophone.mp3"]))
            ))
        ))
        (.addChildren (doto (Sound. )
            (.setLocation (float-array [0 1.6 0]))
            (.setSource (doto (MovieTexture. )
                (.setDescription "testing")
                (.setUrl (into-array ["bogus.mpg" "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/bogus.mpg"]))
            ))
        ))
...
(.toFileX3D X3D0 "../../../../../data/AllAudioGraphNodesTest.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/AllAudioGraphNodesTest.new.clojure.x3dj")
(defn -main []

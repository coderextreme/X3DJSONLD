        ...
        (.addChildren (doto (Anchor. )
            ...
            (.addChildren (doto (Shape. )
                (.setGeometry (doto (Text. )
                    (.setString (into-array ["LOA1_StopAnimation.x3d" "defines a prototype" "for animating a humanoid." "Click this text to see" "InterchangableActorsViaDynamicRouting example."]))
...
(.toFileX3D X3D0 "../../../../../data/LOA1_StopAnimation.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/LOA1_StopAnimation.new.clojure.x3dj")
(defn -main []

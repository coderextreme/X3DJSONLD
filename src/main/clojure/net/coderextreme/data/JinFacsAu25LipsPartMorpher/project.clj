(defproject JinFacsAu25LipsPartMorpher "1.0.0"
  ...
  :main ^:skip-aot JinFacsAu25LipsPartMorpher
  ...
  :jvm-opts ["-cp" "src/JinFacsAu25LipsPartMorpher:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "JinFacsAu25LipsPartMorpher.jar"
                       :main JinFacsAu25LipsPartMorpher
                       }})

(ns indexedfaceset_pixeltexture_plus
        ...
        (.addChildren (doto (Shape. )
            ...
            (.setGeometry (doto (IndexedFaceSet. )
                ...
                (.setTexCoord (doto (TextureCoordinate. )
                    (.setPoint (float-array [-1 2 -1 -1 2 2 2 -1]))
                ))
            ))
        ))
    ))
))
(.toFileX3D X3D0 "../../../../../data/indexedfaceset_pixeltexture_plus.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/indexedfaceset_pixeltexture_plus.new.clojure.json")
(defn -main []

(defproject indexedfaceset_pixeltexture_plus "1.0.0"
  ...
  :main ^:skip-aot indexedfaceset_pixeltexture_plus
  ...
  :jvm-opts ["-cp" "src/indexedfaceset_pixeltexture_plus:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "indexedfaceset_pixeltexture_plus.jar"
                       :main indexedfaceset_pixeltexture_plus
                       }})

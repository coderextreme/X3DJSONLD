(defproject KoreanCharacter12Sun "1.0.0"
  ...
  :main ^:skip-aot KoreanCharacter12Sun
  ...
  :jvm-opts ["-cp" "src/KoreanCharacter12Sun:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "KoreanCharacter12Sun.jar"
                       :main KoreanCharacter12Sun
                       }})

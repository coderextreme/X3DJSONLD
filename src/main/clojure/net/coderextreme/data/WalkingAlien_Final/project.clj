(defproject WalkingAlien_Final "1.0.0"
  ...
  :main ^:skip-aot WalkingAlien_Final
  ...
  :jvm-opts ["-cp" "src/WalkingAlien_Final:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "WalkingAlien_Final.jar"
                       :main WalkingAlien_Final
                       }})

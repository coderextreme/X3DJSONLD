...
(.addComments "Vertical Y arrow and label")
                    ...
                    (.addChildren (doto (Shape. )
                        ...
                        (.setAppearance (doto (Appearance. )
                            ...
                            (.setMaterial (doto (Material. )
                                (.setDiffuseColor (float-array [0.1 0.6 0.1]))
                                (.setEmissiveColor (float-array [0.05 0.2 0.05]))
                            ))
                        ))
                    ))
                ...
                (.addChildren (doto (Transform. )
                    (.setTranslation (float-array [0 1.08 0]))
                    (.addChildren (doto (Billboard. )
                        (.addChildren (doto (Shape. )
                            (.setAppearance (doto (Appearance. )
                                (.setDEF "LABEL_APPEARANCE")
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [1 1 0.3]))
                                    (.setEmissiveColor (float-array [0.33 0.33 0.1]))
                                ))
                            ))
                            (.setGeometry (doto (Text. )
                                (.setString (into-array ["Y"]))
            ...
            (.setProxy (doto (Transform. )
                (.setRotation (float-array [0 0 1 -1.57079]))
(.addComments "Horizontal X arrow and label")
                (.addChildren (doto (Group. )
                    (.addChildren (doto (Group. )
                        ...
                        (.addChildren (doto (Shape. )
                            ...
                            (.setAppearance (doto (Appearance. )
                                (.setDEF "Red")
                                (.setMaterial (doto (Material. )
                                    (.setDiffuseColor (float-array [0.7 0.1 0.1]))
                                    (.setEmissiveColor (float-array [0.33 0 0]))
                                ))
                            ))
                        ))
                        (.addChildren (doto (Transform. )
                    ...
                    (.addChildren (doto (Transform. )
                        (.setRotation (float-array [0 0 1 1.57079]))
                        (.setTranslation (float-array [0.072 1.1 0]))
(.addComments "note label rotated back to original coordinate frame")
            ...
            (.setProxy (doto (Transform. )
                (.setRotation (float-array [1 0 0 1.57079]))
(.addComments "Perpendicular Z arrow and label, note right-hand rule")
                (.addChildren (doto (Group. )
                        ...
                        (.addChildren (doto (Shape. )
                            ...
                            (.setAppearance (doto (Appearance. )
                                ...
                                (.setMaterial (doto (Material. )
                                    ...
                                    (.setEmissiveColor (float-array [0.1 0.1 0.33]))
                                ))
                            ))
                        ))
                        (.addChildren (doto (Transform. )
                    ...
                    (.addChildren (doto (Transform. )
                        (.setRotation (float-array [1 0 0 -1.57079]))
                        (.setTranslation (float-array [0 1.1 0.072]))
(.addComments "note label rotated back to original coordinate frame")
                        (.addChildren (doto (Billboard. )
                            (.addChildren (doto (Shape. )
                                (.setAppearance (doto (Appearance. )
...
(.toFileX3D X3D0 "../../../../../data/CoordinateAxes.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/CoordinateAxes.new.clojure.x3dj")
(defn -main []

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/data/flowerproto.x3d")
        ))
    ))
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (ProtoDeclare. )
            ...
            (.setProtoInterface (doto (ProtoInterface. )
                (.addField (doto (field. )
                    ...
                    (.setType "MFString")
                    (.setValue "\"../shaders/freewrl_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs\"")
                ))
                (.addField (doto (field. )
                    (.setName "fragment")
                    (.setAccessType "inputOnly")
                    (.setType "MFString")
                    (.setValue "\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"")
                ))
            ))
...
(.toFileX3D X3D0 "../../../../../data/flowerprotofreewrl.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/flowerprotofreewrl.new.clojure.x3dj")
(defn -main []

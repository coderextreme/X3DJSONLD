(defproject HAnimModelFootLeft "1.0.0"
  ...
  :main ^:skip-aot HAnimModelFootLeft
  ...
  :jvm-opts ["-cp" "src/HAnimModelFootLeft:/usr/share/clojure/libexec/clojure-tools-1.12.1.1550.jar:.:/Users/jcarl/X3DJSONLD/X3DJSAIL.4.0.full.jar"]

  :profiles {:uberjar {:aot :all
                       :uberjar-name "HAnimModelFootLeft.jar"
                       :main HAnimModelFootLeft
                       }})

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "title")
            (.setContent "HAnimModelFootLeft.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "Left foot, using high-fidelity definitions for HAnim version 2.0")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "creator")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootLeft.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
    ...
    (.setScene (doto (Scene. )
        (.addChildren (doto (WorldInfo. )
            (.setTitle "HAnimModelFootLeft.x3d")
        ))
        (.addChildren (doto (HAnimHumanoid. )
            (.setName "Foot_Left")
            (.setDEF "hanim_Foot_Left")
            (.setLoa 4)
            (.setVersion "2.0")
                                    ...
                                    (.addChildren (doto (HAnimJoint. )
                                        ...
                                        (.addChildren (doto (HAnimSegment. )
                                            ...
                                            (.addChildren (doto (Shape. )
                                                ...
                                                (.setGeometry (doto (IndexedLineSet. )
                                                    (.setDEF "tiptoe_l_tarsal_distal_interphalangeal_1")
                                                    (.setCoordIndex (int-array [0 1]))
                                                    (.setCoord (doto (Coordinate. )
                                        ...
                                        (.addChildren (doto (HAnimJoint. )
                                            ...
                                            (.addChildren (doto (HAnimSegment. )
                                                ...
                                                (.addChildren (doto (Shape. )
                                                    ...
                                                    (.setGeometry (doto (IndexedLineSet. )
                                                        (.setDEF "tiptoe_l_tarsal_distal_phalanx_2")
                                                        (.setCoordIndex (int-array [0 1]))
                                                        (.setCoord (doto (Coordinate. )
                                        ...
                                        (.addChildren (doto (HAnimJoint. )
                                            ...
                                            (.addChildren (doto (HAnimSegment. )
                                                ...
                                                (.addChildren (doto (Shape. )
                                                    ...
                                                    (.setGeometry (doto (IndexedLineSet. )
                                                        (.setDEF "tiptoe_l_tarsal_distal_interphalangeal_3")
                                                        (.setCoordIndex (int-array [0 1]))
                                                        (.setCoord (doto (Coordinate. )
                                        ...
                                        (.addChildren (doto (HAnimJoint. )
                                            ...
                                            (.addChildren (doto (HAnimSegment. )
                                                ...
                                                (.addChildren (doto (Shape. )
                                                    ...
                                                    (.setGeometry (doto (IndexedLineSet. )
                                                        (.setDEF "tiptoe_l_tarsal_distal_interphalangeal_4")
                                                        (.setCoordIndex (int-array [0 1]))
                                                        (.setCoord (doto (Coordinate. )
                                        ...
                                        (.addChildren (doto (HAnimJoint. )
                                            ...
                                            (.addChildren (doto (HAnimSegment. )
                                                ...
                                                (.addChildren (doto (Shape. )
                                                    ...
                                                    (.setGeometry (doto (IndexedLineSet. )
                                                        (.setDEF "tiptoe_l_tarsal_distal_interphalangeal_5")
                                                        (.setCoordIndex (int-array [0 1]))
                                                        (.setCoord (doto (Coordinate. )
...
(.toFileX3D X3D0 "../../../../../data/HAnimModelFootLeft.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/HAnimModelFootLeft.new.clojure.x3dj")
(defn -main []

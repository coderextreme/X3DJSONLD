...
(.addComments "DEFS for markers of skeleton joints, segments, and sites")
            (.addChildren (doto (Transform. )
(.addComments "<Transform translation='0 2 0'> <Shape DEF='HAnimRootShape'> <Sphere radius='0.02' /> <Appearance> <Material DEF='HAnimRootMaterial' diffuseColor='0.8 0 0' transparency='0.3'/> </Appearance> </Shape> </Transform>")
                (.addChildren (doto (Transform. )

(ns StringArrayEncodingExamples
...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            ...
            (.setContent "https://www.web3d.org/documents/specifications/19775-1/V3.3/Part01/fieldsDef.html#SFStringAndMFString")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "specificationSection")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "specificationUrl")
            (.setContent "https://www.web3d.org/documents/specifications/19776-1/V3.3/Part01/EncodingOfFields.html#SFString")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "specificationSection")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "specificationUrl")
            (.setContent "https://www.web3d.org/documents/specifications/19776-2/V3.3/Part02/EncodingOfFields.html#SFString")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/StringArrayEncodingExamples.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "generator")
    ...
    (.setScene (doto (Scene. )
        ...
        (.addChildren (doto (Background. )
            (.setSkyColor (float-array [0.6 1 0.8]))
        ))
        (.addChildren (doto (Shape. )
            (.setGeometry (doto (Text. )
                (.setString (into-array ["One, Two, Three" "He said, \"Immel did it!\""]))
...
(.addComments "alternative Java source: .setString(new String [] {\"One, Two, Three\", \"\", \"He said, \\\"\"Immel did it!\\\"\"\"})")
            ...
            (.setAppearance (doto (Appearance. )
                (.setMaterial (doto (Material. )
                    (.setDiffuseColor (float-array [0.6 0.4 0.2]))
                ))
            ))
        ))
    ))
))
(.toFileX3D X3D0 "../../../../../data/StringArrayEncodingExamples.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../data/StringArrayEncodingExamples.new.clojure.x3dj")
(defn -main []

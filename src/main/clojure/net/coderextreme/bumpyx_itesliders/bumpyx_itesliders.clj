(ns x3dclsail.bumpyx_itesliders
...
;DIS multiuser facilities
                (.addChildren (doto (DISEntityManager. )
                    ...
                    (.addChildren (doto (DISEntityTypeMapping. )
                        (.setCategory 77)
                        (.setSpecific 1)
                        (.setUrl (into-array ["Leif8Final.x3d"]))
                    ))
                    (.addChildren (doto (DISEntityTypeMapping. )
                        (.setCategory 77)
                        (.setSpecific 2)
                        (.setUrl (into-array ["Lily8Final.x3d"]))
                    ))
                ))
...
(.setSourceCode " function newTranslation(Value) { aValue_changed = Value.x * 30; }\\newline")                ))
                (.addChildren (doto (Script. )
...
(.setSourceCode " function newTranslation(Value) { bValue_changed = Value.x * 30; }\\newline")                ))
                (.addChildren (doto (Script. )
...
(.setSourceCode " function newTranslation(Value) { cValue_changed = Value.x * 5; }\\newline")                ))
                (.addChildren (doto (Script. )
...
(.setSourceCode " function newTranslation(Value) { dValue_changed = Value.x * 5; }\\newline")                ))
                (.addChildren (doto (Script. )
...
(.setSourceCode " function newTranslation(Value) { pdeltaValue_changed = Value.x; }\\newline")                ))
                (.addChildren (doto (Script. )
...
(.setSourceCode " function newTranslation(Value) { tdeltaValue_changed = Value.x; }\\newline")                ))
                (.addChildren (doto (ROUTE. )
...
(.toFileX3D X3D0 ".././bumpyx_itesliders.new.clojure.x3d")
(.toFileJSON X3D0 ".././bumpyx_itesliders.new.clojure.json")
(defn -main []

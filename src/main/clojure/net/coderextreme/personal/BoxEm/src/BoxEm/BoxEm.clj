...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/personal/box.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "3 boxes")
...
(.toFileX3D X3D0 "../../../../../personal/BoxEm.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../personal/BoxEm.new.clojure.json")
(defn -main []

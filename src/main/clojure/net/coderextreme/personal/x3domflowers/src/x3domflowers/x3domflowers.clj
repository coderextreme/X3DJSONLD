...
(.addComments "Images courtesy of Paul Debevec's Light Probe Image Gallery")
        ...
        (.addChildren (doto (Group. )
            (.addChildren (doto (ExternProtoDeclare. )
                (.setName "FlowerProto")
                (.setUrl (into-array ["../personal/flowerproto.json#FlowerProto"]))
                (.addField (doto (field. )
                    (.setName "vertex")
...
(.toFileX3D X3D0 "../../../../../personal/x3domflowers.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../personal/x3domflowers.new.clojure.json")
(defn -main []

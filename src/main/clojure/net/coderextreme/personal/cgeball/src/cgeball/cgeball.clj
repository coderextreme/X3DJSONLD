                ...
                (.setAppearance (doto (Appearance. )
                    ...
                    (.addShaders (doto (ComposedShader. )
                        ...
                        (.addParts (doto (ShaderPart. )
                            (.setUrl (into-array ["../shaders/castle.vs" "https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs"]))
                            (.setType "VERTEX")
                        ))
                        (.addParts (doto (ShaderPart. )
                            (.setDEF "commonfs")
                            (.setUrl (into-array ["../shaders/castle.fs" "https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs"]))
                            (.setType "FRAGMENT")
                        ))
                    ))
                ))
...
(.toFileX3D X3D0 "../../../../../personal/cgeball.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../personal/cgeball.new.clojure.json")
(defn -main []

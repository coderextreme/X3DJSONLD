...
(.addComments "<component name='Shape' level='4'></component>")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/personal/bumpyx_ite.x3d")
        ))
    ))
    (.setScene (doto (Scene. )
...
(.toFileX3D X3D0 "../../../../../personal/bumpyx_ite.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../personal/bumpyx_ite.new.clojure.json")
(defn -main []

...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "A balls proto with configurable shaders")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/personal/particleballs.x3d")
        ))
    ))
    (.setScene (doto (Scene. )
        (.addChildren (doto (WorldInfo. )
            (.setTitle "particleballs.x3d")
        ))
...
(.toFileX3D X3D0 "../personal/particleballs.new.clojure.x3d")
(.toFileJSON X3D0 "../personal/particleballs.new.clojure.json")
(defn -main []

...
;<component name='Shape' level='4'></component>
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/personal/bumpyfreewrl.x3d")
        ))
    ))
    (.setScene (doto (Scene. )
        (.addChildren (doto (WorldInfo. )
            (.setTitle "bumpyfreewrl.x3d")
        ))
...
(.toFileX3D X3D0 "../personal/bumpyfreewrl.new.clojure.x3d")
(.toFileJSON X3D0 "../personal/bumpyfreewrl.new.clojure.json")
(defn -main []

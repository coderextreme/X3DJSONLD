...
(.addComments "<component name='Shape' level='4'></component>")
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/personal/geo.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
            (.setContent "a sphere")
...
(.toFileX3D X3D0 "../../../../../personal/geo.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../personal/geo.new.clojure.json")
(defn -main []

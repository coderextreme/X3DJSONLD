...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/personal/ball.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
                ...
                (.setAppearance (doto (Appearance. )
                    ...
                    (.addShaders (doto (ComposedShader. )
                        ...
                        (.addParts (doto (ShaderPart. )
                            (.setUrl (into-array ["https://coderextreme.net/X3DJSONLD/src/main/shaders/octaga.vs"]))
                            (.setType "VERTEX")
                        ))
                        (.addParts (doto (ShaderPart. )
                            (.setDEF "commonfs")
...
(.toFileX3D X3D0 "../personal/octball.new.clojure.x3d")
(.toFileJSON X3D0 "../personal/octball.new.clojure.json")
(defn -main []

                ...
                (.setAppearance (doto (Appearance. )
                    ...
                    (.setTexture (doto (ComposedCubeMapTexture. )
                        ...
                        (.setBackTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["../resources/images/all_probes/stpeters_cross/stpeters_back.pnghttps://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
                        ))
                        (.setBottomTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["../resources/images/all_probes/stpeters_cross/stpeters_bottom.pnghttps://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
                        ))
                        (.setFrontTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["../resources/images/all_probes/stpeters_cross/stpeters_front.pnghttps://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
                        ))
                        (.setLeftTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["../resources/images/all_probes/stpeters_cross/stpeters_left.pnghttps://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
                        ))
                        (.setRightTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["../resources/images/all_probes/stpeters_cross/stpeters_right.pnghttps://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
                        ))
                        (.setTopTexture (doto (ImageTexture. )
                            (.setUrl (into-array ["../resources/images/all_probes/stpeters_cross/stpeters_top.pnghttps://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
                        ))
                    ))
...
(.toFileX3D X3D0 "../../../../../personal/ball.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../personal/ball.new.clojure.json")
(defn -main []

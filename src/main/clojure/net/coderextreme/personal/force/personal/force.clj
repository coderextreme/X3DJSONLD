...
(def X3D0 (doto (X3D.)
    ...
    (.setHead (doto (head. )
        ...
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "identifier")
            (.setContent "https://coderextreme.net/X3DJSONLD/src/main/personal/force.x3d")
        ))
        (.addMeta (doto (org.web3d.x3d.jsail.Core.meta. )
            (.setName "description")
                ...
                (.addChildren (doto (Group. )
                    (.addChildren (doto (Shape. )
                        (.setGeometry (doto (Extrusion. )
                            ...
                            (.setSpine (float-array [0 -50 0 0 50 0]))
                        ))
                        (.setAppearance (doto (Appearance. )
                            (.setMaterial (doto (Material. )
...
(.toFileX3D X3D0 "../personal/force.new.clojure.x3d")
(.toFileJSON X3D0 "../personal/force.new.clojure.json")
(defn -main []

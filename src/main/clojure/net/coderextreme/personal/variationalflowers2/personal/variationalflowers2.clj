(ns x3dclsail.variationalflowers2
...
(.toFileX3D X3D0 "../personal/variationalflowers2.new.clojure.x3d")
(.toFileJSON X3D0 "../personal/variationalflowers2.new.clojure.json")
(defn -main []

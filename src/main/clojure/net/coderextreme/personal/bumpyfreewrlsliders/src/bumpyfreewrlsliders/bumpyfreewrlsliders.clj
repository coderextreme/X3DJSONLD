...
(.addComments "DIS multiuser facilities")
                (.addChildren (doto (DISEntityManager. )
                    ...
                    (.addChildren (doto (DISEntityTypeMapping. )
                        (.setCategory 77)
                        (.setSpecific 1)
                        (.setUrl (into-array ["../data/Leif8Final.x3dv" "https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3dv"]))
                    ))
                    (.addChildren (doto (DISEntityTypeMapping. )
                        (.setCategory 77)
                        (.setSpecific 2)
                        (.setUrl (into-array ["../data/Lily8Final.x3dv" "https://coderextreme.net/X3DJSONLD/src/main/data/Lily8Final.x3dv"]))
                    ))
                    (.addChildren (doto (DISEntityTypeMapping. )
                        (.setCategory 77)
                        (.setSpecific 3)
                        (.setUrl (into-array ["../data/Tufani8Final.x3dv" "https://coderextreme.net/X3DJSONLD/src/main/data/Tufani8Final.x3dv"]))
                    ))
                    (.addChildren (doto (DISEntityTypeMapping. )
                        (.setCategory 77)
                        (.setSpecific 4)
                        (.setUrl (into-array ["../data/Gramps8Final.x3dv" "https://coderextreme.net/X3DJSONLD/src/main/data/Gramps8Final.x3dv"]))
                    ))
                ))
...
(.toFileX3D X3D0 "../../../../../personal/bumpyfreewrlsliders.new.clojure.x3d")
(.toFileJSON X3D0 "../../../../../personal/bumpyfreewrlsliders.new.clojure.json")
(defn -main []

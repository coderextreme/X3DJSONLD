    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(to_java_string_array(["../data/flowerproto.x3d#FlowerProto", "https://coderextreme.net/X3DJSONLD/src/main/data/flowerproto.x3d#FlowerProto"]))
                .addField(field.new()
                    .setName("vertex")
            ...
            .addChild(Sound.new()
                ...
                .setMinBack(20.0)
                .setMinFront(20.0)
                .setLocation(to_java_float_array([0, 1, 0]))
                .setSource(AudioClip.new()
                    .setDEF("AudioClip")
                    .setDescription("Chandubabamusic #1")
                    .setUrl(to_java_string_array(["../resources/chandubabamusic1.wav", "https://coderextreme.net/X3DJSONLD/src/main/resources/chandubabamusic1.wav"]))
                )
            )
            .addChild(ROUTE.new()
...
x3D0.toFileX3D "../data/sphereflowers.new.truffleruby.x3d"
x3D0.toFileJSON "../data/sphereflowers.new.truffleruby.x3dj"

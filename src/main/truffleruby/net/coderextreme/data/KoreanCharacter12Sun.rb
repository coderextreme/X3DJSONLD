...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("title")
            .setContent("KoreanCharacter12Sun.x3d")
        )
        .addMeta(meta.new()
            .setName("creator")
        ...
        .addMeta(meta.new()
            .setName("TODO")
            .setContent("check connectivity of geometry between upper left arm and shoulder")
        )
        .addMeta(meta.new()
            .setName("Image")
            .setContent("../Poses/images/HAnimPoseExampleKoreanCharacter12Sun.png")
        )
        .addMeta(meta.new()
            .setName("reference")
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter12Sun.x3d")
        )
        .addMeta(meta.new()
            .setName("generator")
    ...
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("KoreanCharacter12Sun.x3d")
        )
        ...
        .addChild(HAnimHumanoid.new()
            .setName("Sun")
            .setDEF("hanim_Sun")
            .setScale(to_java_float_array([0.0225, 0.0225, 0.0225]))
            .setVersion("2.0")
          .addComments(CommentsBlock.new("original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'"))
            .setMetadata(MetadataSet.new()
                ...
                .addValue(MetadataString.new()
                    .setName("authorName")
                    .setValue(to_java_string_array(["Chul Hee Jung and Myeong Won Lee"]))
                )
                .addValue(MetadataString.new()
                    .setName("authorEmail")
                    .setValue(to_java_string_array(["myeongwonlee@gmail.com"]))
                )
                .addValue(MetadataString.new()
                    .setName("creationDate")
                    .setValue(to_java_string_array(["31 March 2011"]))
                )
                .addValue(MetadataString.new()
                    .setName("gender")
                    .setValue(to_java_string_array(["female"]))
                )
                .addValue(MetadataFloat.new()
                    .setName("height")
                    .setValue(to_java_float_array([1.5]))
                )
                .addValue(MetadataString.new()
            ...
            .addSkeleton(HAnimJoint.new()
                ...
                .setCenter(to_java_float_array([0, 29.860001, -0.4567]))
                .setContainerFieldOverride("skeleton")
                .addChild(HAnimSegment.new()
                    .setName("sacrum")
                    .setDEF("hanim_sacrum")
                    .addChild(Transform.new()
                        .setTranslation(to_java_float_array([0, 29.860001, -0.4567]))
                        .addChild(Shape.new()
                ...
                .addChild(HAnimJoint.new()
                    .setName("l_hip")
                    .setDEF("hanim_l_hip")
                    .setCenter(to_java_float_array([2.955, 28.940001, -0.5218]))
                    .addChild(HAnimSegment.new()
                        .setName("l_thigh")
                        .setDEF("hanim_l_thigh")
                        .addChild(Transform.new()
                            .setTranslation(to_java_float_array([2.955, 28.940001, -0.5218]))
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("l_knee")
                        .setDEF("hanim_l_knee")
                        .setCenter(to_java_float_array([2.948, 16.459999, -0.5275]))
                        .addChild(HAnimSegment.new()
                            .setName("l_calf")
                            .setDEF("hanim_l_calf")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([2.948, 16.459999, -0.5275]))
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([2.839, 3.899, -0.4116]))
                            .addChild(HAnimSegment.new()
                                .setName("l_talus")
                                .setDEF("hanim_l_talus")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([2.839, 3.899, -0.4116]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([2.839, 3.312, 1.078]))
                                .addChild(HAnimSegment.new()
                                    .setName("l_tarsal_proximal_phalanx_2")
                                    .setDEF("hanim_l_tarsal_proximal_phalanx_2")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([2.839, 3.312, 1.078]))
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter(to_java_float_array([6.077, 45.880001, -1.319]))
                        .addChild(HAnimSegment.new()
                            .setName("l_upperarm")
                            .setDEF("hanim_l_upperarm")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([6.077, 45.880001, -1.319]))
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([7.076, 38.529999, -1.385]))
                            .addChild(HAnimSegment.new()
                                .setName("l_forearm")
                                .setDEF("hanim_l_forearm")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([7.076, 38.529999, -1.385]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([6.946, 30.889999, -1.308]))
                                .addChild(HAnimSegment.new()
                                    .setName("l_carpal")
                                    .setDEF("hanim_l_carpal")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([6.946, 30.889999, -1.308]))
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("vl5")
                        .setDEF("hanim_vl5")
                        .setCenter(to_java_float_array([0.05249, 34.130001, -0.468]))
                        .addChild(HAnimSegment.new()
                            .setName("l5")
                            .setDEF("hanim_l5")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([0.05249, 34.130001, -0.468]))
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([0, 51.25, -1.124]))
                            .addChild(HAnimSegment.new()
                                .setName("skull")
                                .setDEF("hanim_skull")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([0, 51.25, -1.124]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
        ...
        .addChild(EXPORT.new()
            .setAS("KoreanCharacter12Sun")
            .setLocalDEF("hanim_Sun")
        )
    )
x3D0.toFileX3D "../data/KoreanCharacter12Sun.new.truffleruby.x3d"
x3D0.toFileJSON "../data/KoreanCharacter12Sun.new.truffleruby.x3dj"

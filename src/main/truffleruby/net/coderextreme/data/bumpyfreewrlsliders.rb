          ...
          .addComments(CommentsBlock.new("like a HUD (heads up display)"))
            ...
            .addComments(CommentsBlock.new("basic nodes, which might be present in any scene"))
                .addChild(NavigationInfo.new()
                    .setType(to_java_string_array(["EXAMINE", "FLY", "LOOKAT", "ANY"]))
            ...
            .addComments(CommentsBlock.new("the model that is being reviewed by the users of this scene"))
              ...
              .addComments(CommentsBlock.new("Images courtesy of Paul Debevec's Light Probe Image Gallery"))
                  ...
                  .addComments(CommentsBlock.new("<IndexedFaceSet convex=\"false\" DEF=\"Orbit\" creaseAngle=\"0\">"))
                  .addComments(CommentsBlock.new("<Coordinate DEF=\"OrbitCoordinates\"/>"))
                  .addComments(CommentsBlock.new("</IndexedFaceSet>"))
                            .setAppearance(Appearance.new()
                                ...
                                .setTexture(ComposedCubeMapTexture.new()
                                    ...
                                    .setBackTexture(ImageTexture.new()
                                        .setUrl(to_java_string_array(["../resources/images/all_probes/stpeters_cross/stpeters_back.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
                                    )
                                    .setBottomTexture(ImageTexture.new()
                                        .setUrl(to_java_string_array(["../resources/images/all_probes/stpeters_cross/stpeters_bottom.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
                                    )
                                    .setFrontTexture(ImageTexture.new()
                                        .setUrl(to_java_string_array(["../resources/images/all_probes/stpeters_cross/stpeters_front.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
                                    )
                                    .setLeftTexture(ImageTexture.new()
                                        .setUrl(to_java_string_array(["../resources/images/all_probes/stpeters_cross/stpeters_left.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
                                    )
                                    .setRightTexture(ImageTexture.new()
                                        .setUrl(to_java_string_array(["../resources/images/all_probes/stpeters_cross/stpeters_right.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
                                    )
                                    .setTopTexture(ImageTexture.new()
                                        .setUrl(to_java_string_array(["../resources/images/all_probes/stpeters_cross/stpeters_top.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
                                    )
                                )
                      ...
                      .addComments(CommentsBlock.new("<field name='cube' type='SFNode' accessType=\"inputOutput\">"))
                      .addComments(CommentsBlock.new("<ComposedCubeMapTexture USE=\"texture\"/>"))
                    ...
                    .addComments(CommentsBlock.new("<ComposedShader DEF=\"freewrlShader\" language=\"GLSL\">"))
                    .addComments(CommentsBlock.new("<field name='fw_textureCoordGenType' accessType='inputOutput' type='SFInt32' value='0'></field>"))
                    .addComments(CommentsBlock.new("<field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1.0 1.033'></field>"))
                    .addComments(CommentsBlock.new("<field name='bias' type='SFFloat' accessType='inputOutput' value='0.5'></field>"))
                    .addComments(CommentsBlock.new("<field name='scale' type='SFFloat' accessType='inputOutput' value='0.5'></field>"))
                    .addComments(CommentsBlock.new("<field name='power' type='SFFloat' accessType='inputOutput' value='2'></field>"))
                    .addComments(CommentsBlock.new("<field name='a' type='SFFloat' accessType='inputOutput' value='15'></field>"))
                    .addComments(CommentsBlock.new("<field name='b' type='SFFloat' accessType='inputOutput' value='5'></field>"))
                    .addComments(CommentsBlock.new("<field name='c' type='SFFloat' accessType='inputOutput' value='20'></field>"))
                    .addComments(CommentsBlock.new("<field name='d' type='SFFloat' accessType='inputOutput' value='20'></field>"))
                    .addComments(CommentsBlock.new("<field name='tdelta' type='SFFloat' accessType='inputOutput' value='0'></field>"))
                    .addComments(CommentsBlock.new("<field name='pdelta' type='SFFloat' accessType='inputOutput' value='0'></field>"))
                    .addComments(CommentsBlock.new("<ShaderPart type='VERTEX'>"))
                    .addComments(CommentsBlock.new("<IS>"))
                    .addComments(CommentsBlock.new("<connect nodeField=\"url\" protoField=\"vertex\"/>"))
                    .addComments(CommentsBlock.new("</IS>"))
                    .addComments(CommentsBlock.new("</ShaderPart>"))
                    .addComments(CommentsBlock.new("<ShaderPart type='FRAGMENT'>"))
                    .addComments(CommentsBlock.new("<IS>"))
                    .addComments(CommentsBlock.new("<connect nodeField=\"url\" protoField=\"fragment\"/>"))
                    .addComments(CommentsBlock.new("</IS>"))
                    .addComments(CommentsBlock.new("</ShaderPart>"))
                    .addComments(CommentsBlock.new("</ComposedShader>"))
                            )
                        )
                    )
                )
            .addComments(CommentsBlock.new("<Script DEF=\"OrbitScript\">"))
            .addComments(CommentsBlock.new("<field accessType=\"inputOutput\" name=\"coordinates\" type=\"MFVec3f\"/>"))
            .addComments(CommentsBlock.new("<field accessType=\"outputOnly\" name=\"coordIndexes\" type=\"MFInt32\"/>"))
            .addComments(CommentsBlock.new("<field name='a' type='SFFloat' accessType='inputOutput' value='10'></field>"))
            .addComments(CommentsBlock.new("<field name='b' type='SFFloat' accessType='inputOutput' value='10'></field>"))
            .addComments(CommentsBlock.new("<field name='c' type='SFFloat' accessType='inputOutput' value='2'></field>"))
            .addComments(CommentsBlock.new("<field name='d' type='SFFloat' accessType='inputOutput' value='2'></field>"))
            .addComments(CommentsBlock.new("<field name='pdelta' type='SFFloat' accessType='inputOutput' value='0'></field>"))
            .addComments(CommentsBlock.new("<field name='tdelta' type='SFFloat' accessType='inputOutput' value='0'></field>"))
            .addComments(CommentsBlock.new("<![CDATA[ecmascript: function initialize() { var resolution = 300; var theta = 0.0; var phi = 0.0; var delta = (2 * 3.141592653) / (resolution-1); var crds = new MFVec3f(); for ( i = 0; i < resolution; i++) { for ( j = 0; j < resolution; j++) { var rho = a + b * Math.cos(c * theta + tdelta) * Math.cos(d * phi + pdelta); crds.push(new SFVec3f( rho * Math.cos(phi) * Math.cos(theta), rho * Math.cos(phi) * Math.sin(theta), rho * Math.sin(phi) )); theta += delta; } phi += delta; } coordinates = crds; var cis = new MFInt32(); for ( i = 0; i < resolution-1; i++) { for ( j = 0; j < resolution-1; j++) { cis.push(i*resolution+j); cis.push(i*resolution+j+1); cis.push((i+1)*resolution+j+1); cis.push((i+1)*resolution+j); cis.push(-1); } } coordIndexes = cis; } ]]></Script>"))
            .addComments(CommentsBlock.new("<ROUTE fromField=\"coordIndexes\" fromNode=\"OrbitScript\" toField=\"set_coordIndex\" toNode=\"Orbit\"/>"))
            .addComments(CommentsBlock.new("<ROUTE fromField=\"coordinates\" fromNode=\"OrbitScript\" toField=\"set_point\" toNode=\"OrbitCoordinates\"/>"))
            ...
            .addComments(CommentsBlock.new("first, the slider for scaling the model"))
                .addChild(Transform.new()
                    ...
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setMaterial(Material.new()
                                .setDiffuseColor(to_java_float_array([0.1, 0.1, 0.1]))
                                .setTransparency(1.0)
                            )
                        )
                        .setGeometry(Box.new()
                            ...
                            .addChild(Transform.new()
                                ...
                                .addChild(Transform.new()
                                    ...
                                    .addChild(PlaneSensor.new()
                                        .setDEF("protoSensor")
                                        .setMaxPosition(to_java_float_array([2, 0]))
                                    )
                                    .addChild(Transform.new()
...
"	};")                            )
                ...
                .setLayout(Layout.new()
                    ...
                    .setOffset(to_java_float_array([-0.5, 0]))
                )
...
x3D0.toFileX3D "../data/bumpyfreewrlsliders.new.truffleruby.x3d"
x3D0.toFileJSON "../data/bumpyfreewrlsliders.new.truffleruby.x3dj"

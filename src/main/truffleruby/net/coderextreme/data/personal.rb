...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Switch.new()
            ...
            .setWhichChoice(0)
          .addComments(CommentsBlock.new("<Inline url='\"../data/myextrusion.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/myextrusion.x3d\"'/>"))
          .addComments(CommentsBlock.new("<Inline url='\"../data/ballx_ite.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/ballx_ite.x3d\"'/>"))
          .addComments(CommentsBlock.new("<Inline url='\"../data/flower.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/flower.x3d\"'/>"))
          .addComments(CommentsBlock.new("<Inline url='\"../data/flower3.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/flower3.x3d\"'/>"))
          .addComments(CommentsBlock.new("<Inline url='\"../data/flowers.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/flowers.x3d\"'/>"))
          .addComments(CommentsBlock.new("<Inline url='\"../data/flowers2.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/flowers2.x3d\"'/>"))
          .addComments(CommentsBlock.new("<Inline url='\"../data/flowers4.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/flowers4.x3d\"'/>"))
          .addComments(CommentsBlock.new("<Inline url='\"../data/flowers7.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/flowers7.x3d\"'/>"))
            .addChild(Inline.new()
                .setUrl(to_java_string_array(["../data/force-tidy.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/force-tidy.x3d"]))
            )
        )
        .addComments(CommentsBlock.new("<Script DEF=\"Choice0\">"))
        .addComments(CommentsBlock.new("<field name=\"touchTime\" type=\"SFTime\" accessType=\"inputOnly\"/>"))
        .addComments(CommentsBlock.new("<field name=\"choice\" type=\"SFInt32\" accessType=\"outputOnly\"/>"))
        .addComments(CommentsBlock.new("<![CDATA[ ecmascript: function set_touchTime(value) { choice = 0; } function touchTime(value) { choice = 0; } ]]>"))
        .addComments(CommentsBlock.new("</Script>"))
        .addComments(CommentsBlock.new("<Transform translation=\"0 4 0\">"))
        .addComments(CommentsBlock.new("<TouchSensor description=\"Ball Prism\" DEF=\"BallPrism_Sensor\"/>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"1 1 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<Text string='\"Ball Prism\"'>"))
        .addComments(CommentsBlock.new("<FontStyle size=\"2.4\" spacing=\"1.2\" justify='\"MIDDLE\" \"MIDDLE\"'/>"))
        .addComments(CommentsBlock.new("</Text>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"0 0 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<IndexedFaceSet coordIndex='0 1 2 3 -1'>"))
        .addComments(CommentsBlock.new("<Coordinate point=\"2 1.3833333333333333 -0.1, -2 1.3833333333333333 -0.1, -2 -1.616666666666667 -0.1, 2 -1.616666666666667 -0.1\"/>"))
        .addComments(CommentsBlock.new("</IndexedFaceSet>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("</Transform>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"BallPrism_Sensor\" fromField=\"touchTime\" toNode=\"Choice0\" toField=\"touchTime\"/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Choice0\" fromField=\"choice\" toNode=\"SceneSwitcher\" toField=\"whichChoice\"/>"))
        .addComments(CommentsBlock.new("<Script DEF=\"Choice1\">"))
        .addComments(CommentsBlock.new("<field name=\"touchTime\" type=\"SFTime\" accessType=\"inputOnly\"/>"))
        .addComments(CommentsBlock.new("<field name=\"choice\" type=\"SFInt32\" accessType=\"outputOnly\"/>"))
        .addComments(CommentsBlock.new("<![CDATA[ ecmascript: function set_touchTime(value) { choice = 1; } function touchTime(value) { choice = 1; } ]]>"))
        .addComments(CommentsBlock.new("</Script>"))
        .addComments(CommentsBlock.new("<Transform translation=\"0 3 0\">"))
        .addComments(CommentsBlock.new("<TouchSensor description=\"Floating Extrusion\" DEF=\"FloatingExtrusion_Sensor\"/>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"1 1 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<Text string='\"Floating Extrusion\"'>"))
        .addComments(CommentsBlock.new("<FontStyle size=\"2.4\" spacing=\"1.2\" justify='\"MIDDLE\" \"MIDDLE\"'/>"))
        .addComments(CommentsBlock.new("</Text>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("<Shape>"))
        ...
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("</Transform>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"FloatingExtrusion_Sensor\" fromField=\"touchTime\" toNode=\"Choice1\" toField=\"touchTime\"/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Choice1\" fromField=\"choice\" toNode=\"SceneSwitcher\" toField=\"whichChoice\"/>"))
        .addComments(CommentsBlock.new("<Script DEF=\"Choice2\">"))
        .addComments(CommentsBlock.new("<field name=\"touchTime\" type=\"SFTime\" accessType=\"inputOnly\"/>"))
        .addComments(CommentsBlock.new("<field name=\"choice\" type=\"SFInt32\" accessType=\"outputOnly\"/>"))
        .addComments(CommentsBlock.new("<![CDATA[ ecmascript: function set_touchTime(value) { choice = 2; } function touchTime(value) { choice = 2; } ]]>"))
        .addComments(CommentsBlock.new("</Script>"))
        .addComments(CommentsBlock.new("<Transform translation=\"0 2 0\">"))
        .addComments(CommentsBlock.new("<TouchSensor description=\"Flower\" DEF=\"Flower_Sensor\"/>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"1 1 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<Text string='\"Flower\"'>"))
        .addComments(CommentsBlock.new("<FontStyle size=\"2.4\" spacing=\"1.2\" justify='\"MIDDLE\" \"MIDDLE\"'/>"))
        .addComments(CommentsBlock.new("</Text>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("<Shape>"))
        ...
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("</Transform>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Flower_Sensor\" fromField=\"touchTime\" toNode=\"Choice2\" toField=\"touchTime\"/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Choice2\" fromField=\"choice\" toNode=\"SceneSwitcher\" toField=\"whichChoice\"/>"))
        .addComments(CommentsBlock.new("<Script DEF=\"Choice3\">"))
        .addComments(CommentsBlock.new("<field name=\"touchTime\" type=\"SFTime\" accessType=\"inputOnly\"/>"))
        .addComments(CommentsBlock.new("<field name=\"choice\" type=\"SFInt32\" accessType=\"outputOnly\"/>"))
        .addComments(CommentsBlock.new("<![CDATA[ ecmascript: function set_touchTime(value) { choice = 3; } function touchTime(value) { choice = 3; } ]]>"))
        .addComments(CommentsBlock.new("</Script>"))
        .addComments(CommentsBlock.new("<Transform translation=\"0 1 0\">"))
        .addComments(CommentsBlock.new("<TouchSensor description=\"Flower 3\" DEF=\"Flower3_Sensor\"/>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"1 1 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<Text string='\"Flower 3\"'>"))
        .addComments(CommentsBlock.new("<FontStyle size=\"2.4\" spacing=\"1.2\" justify='\"MIDDLE\" \"MIDDLE\"'/>"))
        .addComments(CommentsBlock.new("</Text>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("<Shape>"))
        ...
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("</Transform>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Flower3_Sensor\" fromField=\"touchTime\" toNode=\"Choice3\" toField=\"touchTime\"/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Choice3\" fromField=\"choice\" toNode=\"SceneSwitcher\" toField=\"whichChoice\"/>"))
        .addComments(CommentsBlock.new("<Script DEF=\"Choice4\">"))
        .addComments(CommentsBlock.new("<field name=\"touchTime\" type=\"SFTime\" accessType=\"inputOnly\"/>"))
        .addComments(CommentsBlock.new("<field name=\"choice\" type=\"SFInt32\" accessType=\"outputOnly\"/>"))
        .addComments(CommentsBlock.new("<![CDATA[ ecmascript: function set_touchTime(value) { choice = 4; } function touchTime(value) { choice = 4; } ]]>"))
        .addComments(CommentsBlock.new("</Script>"))
        .addComments(CommentsBlock.new("<Transform>"))
        .addComments(CommentsBlock.new("<TouchSensor description=\"Flowers\" DEF=\"Flowers_Sensor\"/>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"1 1 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<Text string='\"Flowers\"'>"))
        .addComments(CommentsBlock.new("<FontStyle size=\"2.4\" spacing=\"1.2\" justify='\"MIDDLE\" \"MIDDLE\"'/>"))
        .addComments(CommentsBlock.new("</Text>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("<Shape>"))
        ...
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("</Transform>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Flowers_Sensor\" fromField=\"touchTime\" toNode=\"Choice4\" toField=\"touchTime\"/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Choice4\" fromField=\"choice\" toNode=\"SceneSwitcher\" toField=\"whichChoice\"/>"))
        .addComments(CommentsBlock.new("<Script DEF=\"Choice5\">"))
        .addComments(CommentsBlock.new("<field name=\"touchTime\" type=\"SFTime\" accessType=\"inputOnly\"/>"))
        .addComments(CommentsBlock.new("<field name=\"choice\" type=\"SFInt32\" accessType=\"outputOnly\"/>"))
        .addComments(CommentsBlock.new("<![CDATA[ ecmascript: function set_touchTime(value) { choice = 5; } function touchTime(value) { choice = 5; } ]]>"))
        .addComments(CommentsBlock.new("</Script>"))
        .addComments(CommentsBlock.new("<Transform translation=\"0 -1 0\">"))
        .addComments(CommentsBlock.new("<TouchSensor description=\"Flowers 2\" DEF=\"Flowers2_Sensor\"/>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"1 1 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<Text string='\"Flowers 2\"'>"))
        .addComments(CommentsBlock.new("<FontStyle size=\"2.4\" spacing=\"1.2\" justify='\"MIDDLE\" \"MIDDLE\"'/>"))
        .addComments(CommentsBlock.new("</Text>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("<Shape>"))
        ...
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("</Transform>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Flowers2_Sensor\" fromField=\"touchTime\" toNode=\"Choice5\" toField=\"touchTime\"/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Choice5\" fromField=\"choice\" toNode=\"SceneSwitcher\" toField=\"whichChoice\"/>"))
        .addComments(CommentsBlock.new("<Script DEF=\"Choice6\">"))
        .addComments(CommentsBlock.new("<field name=\"touchTime\" type=\"SFTime\" accessType=\"inputOnly\"/>"))
        .addComments(CommentsBlock.new("<field name=\"choice\" type=\"SFInt32\" accessType=\"outputOnly\"/>"))
        .addComments(CommentsBlock.new("<![CDATA[ ecmascript: function set_touchTime(value) { choice = 6; } function touchTime(value) { choice = 6; } ]]>"))
        .addComments(CommentsBlock.new("</Script>"))
        .addComments(CommentsBlock.new("<Transform translation=\"0 -2 0\">"))
        .addComments(CommentsBlock.new("<TouchSensor description=\"Flowers 4\" DEF=\"Flowers4_Sensor\"/>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"1 1 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<Text string='\"Flowers 4\"'>"))
        .addComments(CommentsBlock.new("<FontStyle size=\"2.4\" spacing=\"1.2\" justify='\"MIDDLE\" \"MIDDLE\"'/>"))
        .addComments(CommentsBlock.new("</Text>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("<Shape>"))
        ...
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("</Transform>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Flowers4_Sensor\" fromField=\"touchTime\" toNode=\"Choice6\" toField=\"touchTime\"/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Choice6\" fromField=\"choice\" toNode=\"SceneSwitcher\" toField=\"whichChoice\"/>"))
        .addComments(CommentsBlock.new("<Script DEF=\"Choice7\">"))
        .addComments(CommentsBlock.new("<field name=\"touchTime\" type=\"SFTime\" accessType=\"inputOnly\"/>"))
        .addComments(CommentsBlock.new("<field name=\"choice\" type=\"SFInt32\" accessType=\"outputOnly\"/>"))
        .addComments(CommentsBlock.new("<![CDATA[ ecmascript: function set_touchTime(value) { choice = 7; } function touchTime(value) { choice = 7; } ]]>"))
        .addComments(CommentsBlock.new("</Script>"))
        .addComments(CommentsBlock.new("<Transform translation=\"0 -3 0\">"))
        .addComments(CommentsBlock.new("<TouchSensor description=\"Flowers 7 Inner Brow Raiser\" DEF=\"Flowers7_Sensor\"/>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"1 1 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<Text string='\"Flowers 7\"'>"))
        .addComments(CommentsBlock.new("<FontStyle size=\"2.4\" spacing=\"1.2\" justify='\"MIDDLE\" \"MIDDLE\"'/>"))
        .addComments(CommentsBlock.new("</Text>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("<Shape>"))
        ...
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("</Transform>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Flowers7_Sensor\" fromField=\"touchTime\" toNode=\"Choice7\" toField=\"touchTime\"/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Choice7\" fromField=\"choice\" toNode=\"SceneSwitcher\" toField=\"whichChoice\"/>"))
        .addComments(CommentsBlock.new("<Script DEF=\"Choice8\">"))
        .addComments(CommentsBlock.new("<field name=\"touchTime\" type=\"SFTime\" accessType=\"inputOnly\"/>"))
        .addComments(CommentsBlock.new("<field name=\"choice\" type=\"SFInt32\" accessType=\"outputOnly\"/>"))
        .addComments(CommentsBlock.new("<![CDATA[ ecmascript: function set_touchTime(value) { choice = 8; } function touchTime(value) { choice = 8; } ]]>"))
        .addComments(CommentsBlock.new("</Script>"))
        .addComments(CommentsBlock.new("<Transform translation=\"0 -4 0\">"))
        .addComments(CommentsBlock.new("<TouchSensor description=\"Force\" DEF=\"Force_Sensor\"/>"))
        .addComments(CommentsBlock.new("<Shape>"))
        .addComments(CommentsBlock.new("<Appearance>"))
        .addComments(CommentsBlock.new("<Material diffuseColor=\"1 1 1\"/>"))
        .addComments(CommentsBlock.new("</Appearance>"))
        .addComments(CommentsBlock.new("<Text string='\"Force\"'>"))
        .addComments(CommentsBlock.new("<FontStyle size=\"2.4\" spacing=\"1.2\" justify='\"MIDDLE\" \"MIDDLE\"'/>"))
        .addComments(CommentsBlock.new("</Text>"))
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("<Shape>"))
        ...
        .addComments(CommentsBlock.new("</Shape>"))
        .addComments(CommentsBlock.new("</Transform>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Force_Sensor\" fromField=\"touchTime\" toNode=\"Choice8\" toField=\"touchTime\"/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode=\"Choice8\" fromField=\"choice\" toNode=\"SceneSwitcher\" toField=\"whichChoice\"/>"))
    )
x3D0.toFileX3D "../data/personal.new.truffleruby.x3d"
x3D0.toFileJSON "../data/personal.new.truffleruby.x3dj"

            ...
            .addChild(Shape.new()
                ...
                .setAppearance(Appearance.new()
                    ...
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setDEF("common")
                            .setUrl(to_java_string_array(["../shaders/common.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs"]))
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../data/ballx3dom.new.truffleruby.x3d"
x3D0.toFileJSON "../data/ballx3dom.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(DirectionalLight.new()
            ...
            .setDirection(to_java_float_array([-0.5, -0.5, -0.5]))
            .setGlobal(true)
        )
        .addChild(DirectionalLight.new()
            .setAmbientIntensity(1.0)
        ...
        .addChild(Viewpoint.new()
            ...
            .setOrientation(to_java_float_array([1, 0, 0, -0.449999988]))
            .setPosition(to_java_float_array([0, 4, 10]))
        )
        .addChild(Viewpoint.new()
            .setDEF("Scene_InclinedView")
            .setDescription("hanim_Inclined View")
            .setOrientation(to_java_float_array([-0.112999998, 0.992999971, 0.034699999, 0.671000004]))
            .setPosition(to_java_float_array([2.619999886, 1.049999952, 4.059999943]))
        )
        .addChild(Viewpoint.new()
            .setDEF("Scene_StageFrontView")
            .setDescription("hanim_Stage Front View")
            .setPosition(to_java_float_array([0, 1, 5]))
        )
        .addChild(Viewpoint.new()
            .setDEF("Scene_FeetStageBottomView")
            .setDescription("hanim_feet View")
            .setOrientation(to_java_float_array([1, 0, 0, 1.570000052]))
        ...
        .addChild(Viewpoint.new()
            ...
            .setOrientation(to_java_float_array([1, 0, 0, -1.570000052]))
            .setPosition(to_java_float_array([0, 15, 0]))
        )
        .addChild(Viewpoint.new()
            .setDEF("Scene_TopFrontCloseView")
            .setDescription("hanim_Head Top View")
            .setOrientation(to_java_float_array([1, 0, 0, -1.100000024]))
            .setPosition(to_java_float_array([0, 8, 3]))
        )
        .addChild(Group.new()
            .setDEF("HAnimStage")
            .addChild(Transform.new()
                .setDEF("cordsysfloor")
                .setScale(to_java_float_array([0.174999997, 0.174999997, 0.174999997]))
                .addChild(Inline.new()
                    .setUrl(to_java_string_array(["JointCoordinateAxes.x3dv"]))
                )
            )
            .addChild(Transform.new()
                .setDEF("StageGeometry")
                .setScale(to_java_float_array([1, 0.01, 1]))
                .setTranslation(to_java_float_array([0, -0.01, 0]))
                .addChild(Shape.new()
                    ...
                    .setGeometry(Box.new()
                        .setSize(to_java_float_array([9, 1, 9]))
                    )
                )
                .addChild(Transform.new()
                    .setDEF("Circle0")
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            ...
                            .setMaterial(Material.new()
                                .setAmbientIntensity(1.0)
                                .setDiffuseColor(to_java_float_array([0.699999988, 0, 0.899999976]))
                                .setEmissiveColor(to_java_float_array([0.449999988, 0.449999988, 1]))
                                .setShininess(1.0)
                                .setSpecularColor(to_java_float_array([0, 0, 1]))
                            )
                        )
                ...
                .addChild(Transform.new()
                    .setDEF("Circle3")
                    .setScale(to_java_float_array([2, 1, 2]))
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setUSE("LineColor")
                        )
                ...
                .addChild(Transform.new()
                    .setDEF("Circle4")
                    .setScale(to_java_float_array([3, 1, 3]))
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setUSE("LineColor")
                        )
...
x3D0.toFileX3D "../data/MainStage.new.truffleruby.x3d"
x3D0.toFileJSON "../data/MainStage.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(DirectionalLight.new()
            .setDirection(to_java_float_array([0, -0.8, -0.2]))
            .setIntensity(0.5)
        )
            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor(to_java_float_array([0, 0.5, 1]))
                        .setSpecularColor(to_java_float_array([0, 0.5, 1]))
                    )
                )
...
x3D0.toFileX3D "../data/flower3.new.truffleruby.x3d"
x3D0.toFileJSON "../data/flower3.new.truffleruby.x3dj"

            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Group.new()
                    .addChild(Transform.new()
                        ...
                        .addChild(Shape.new()
                  .addComments(CommentsBlock.new("comment before Sphere"))
                  .addComments(CommentsBlock.new("comment after Sphere"))
                  .addComments(CommentsBlock.new("comment after Appearance"))
                            .setGeometry(Sphere.new()
                            )
                            .setAppearance(Appearance.new()
                    .addComments(CommentsBlock.new("comment before Material"))
                    .addComments(CommentsBlock.new("comment after Material"))
...
x3D0.toFileX3D "../data/fors2.new.truffleruby.x3d"
x3D0.toFileJSON "../data/fors2.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addLayerSet(LayerSet.new()
            .setActiveLayer(1)
            .setOrder(to_java_int_array([1, 2, 3]))
                            ...
                            .setAppearance(Appearance.new()
                                ...
                                .addShaders(ComposedShader.new()
                                    ...
                                    .addParts(ShaderPart.new()
                                        .setUrl(to_java_string_array(["../shaders/x_ite_flowers_chromatic.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flowers_chromatic.vs"]))
                                        .setType("VERTEX")
                                    )
                                    .addParts(ShaderPart.new()
                                        .setUrl(to_java_string_array(["../shaders/x_ite.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.fs"]))
                                        .setType("FRAGMENT")
                                    )
...
"}")                )
                ...
                .addChild(ProtoDeclare.new()
                    ...
                    .setProtoBody(ProtoBody.new()
                        .addChild(Group.new()
                            ...
                            .addChild(Script.new()
                                .setUrl(to_java_string_array(["../javascripts/X3DUser.js", "https://raw.githubusercontent.com/coderextreme/JSONverse/refs/heads/main/public/javascripts/X3DUser.js"]))
            ...
            .addLayers(Layer.new()
                ...
                .addChild(Viewpoint.new()
                    ...
                    .setFieldOfView(1.570796)
                    .setPosition(to_java_float_array([0, 1.75, 80]))
                )
                .addChild(Script.new()
                    .setUrl(to_java_string_array(["../javascripts/X3DAvatar.js", "https://raw.githubusercontent.com/coderextreme/JSONverse/refs/heads/main/public/javascripts/X3DAvatar.js"]))
...
x3D0.toFileX3D "../data/bumpyx_itesliders.new.truffleruby.x3d"
x3D0.toFileJSON "../data/bumpyx_itesliders.new.truffleruby.x3dj"

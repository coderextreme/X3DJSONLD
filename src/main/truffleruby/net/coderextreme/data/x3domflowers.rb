    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(to_java_string_array(["../data/flowerproto.json#FlowerProto"]))
                .addField(field.new()
                    .setName("vertex")
...
x3D0.toFileX3D "../data/x3domflowers.new.truffleruby.x3d"
x3D0.toFileJSON "../data/x3domflowers.new.truffleruby.x3dj"

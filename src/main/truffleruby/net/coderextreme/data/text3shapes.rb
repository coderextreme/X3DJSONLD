...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        .addChild(Transform.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["Node2", "\\\\\\\\\\\\Node2"]))
                    .setFontStyle(FontStyle.new()
                    )
                )
                .setAppearance(Appearance.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["Node3 \\\\\\\\ \\\\ Node3\"\"\""]))
                    .setFontStyle(FontStyle.new()
                    )
                )
                .setAppearance(Appearance.new()
...
x3D0.toFileX3D "../data/text3shapes.new.truffleruby.x3d"
x3D0.toFileJSON "../data/text3shapes.new.truffleruby.x3dj"

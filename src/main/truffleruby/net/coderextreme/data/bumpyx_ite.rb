...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            .setPosition(to_java_float_array([0, 0, 40]))
        ...
        .addChild(Transform.new()
            .addChild(Shape.new()
                ...
                .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/x_ite.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs\"'></ShaderPart>"))
                .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/x_itebubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs\"' type='FRAGMENT'></ShaderPart>"))
                    )
                )
            )
        )
    )
x3D0.toFileX3D "../data/bumpyx_ite.new.truffleruby.x3d"
x3D0.toFileJSON "../data/bumpyx_ite.new.truffleruby.x3dj"

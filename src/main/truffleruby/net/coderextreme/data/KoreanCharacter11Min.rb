...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("Image")
            .setContent("../Poses/images/HAnimPoseExampleKoreanCharacter11Min.png")
        )
        .addMeta(meta.new()
            .setName("reference")
    ...
    .setScene(Scene.new()
        ...
        .addChild(HAnimHumanoid.new()
          ...
          .addComments(CommentsBlock.new("original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"'"))
            ...
            .addSkeleton(HAnimJoint.new()
                ...
                .setCenter(to_java_float_array([0, 33.689999, -2.063]))
                .setContainerFieldOverride("skeleton")
                .addChild(HAnimSegment.new()
                    .setName("sacrum")
                    .setDEF("hanim_sacrum")
                    .addChild(Transform.new()
                        .setTranslation(to_java_float_array([0, 33.689999, -2.063]))
                        .addChild(Shape.new()
                ...
                .addChild(HAnimJoint.new()
                    .setName("l_hip")
                    .setDEF("hanim_l_hip")
                    .setCenter(to_java_float_array([3.383, 32.919998, -2.063]))
                    .addChild(HAnimSegment.new()
                        .setName("l_thigh")
                        .setDEF("hanim_l_thigh")
                        .addChild(Transform.new()
                            .setTranslation(to_java_float_array([3.383, 32.919998, -2.063]))
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("l_knee")
                        .setDEF("hanim_l_knee")
                        .setCenter(to_java_float_array([3.745, 17.99, -2.063]))
                        .addChild(HAnimSegment.new()
                            .setName("l_calf")
                            .setDEF("hanim_l_calf")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([3.745, 17.99, -2.063]))
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([3.701, 4.188, -1.915]))
                            .addChild(HAnimSegment.new()
                                .setName("l_talus")
                                .setDEF("hanim_l_talus")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([3.701, 4.188, -1.915]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([3.701, 3.418, -0.4009]))
                                .addChild(HAnimSegment.new()
                                    .setName("l_tarsal_proximal_phalanx_2")
                                    .setDEF("hanim_l_tarsal_proximal_phalanx_2")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([3.701, 3.418, -0.4009]))
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(Transform.new()
                            ...
                            .addChild(Shape.new()
                                ...
                                .setGeometry(IndexedFaceSet.new()
                                    ...
                                    .setCoord(Coordinate.new()
                                        .setPoint(to_java_float_array([-2.672, -0.3788, 0.1245, -1.898, -0.6834, -2.358, -0.2782, -1.153, -3.407, 1.905, -1.076, 2.854, -0.4654, -0.4893, 3.592, -2.15, -0.3899, 2.54, 1.908, -3.177, -2.425, -2.709, -2.69, 0.1246, -1.976, -2.808, -2.268, -0.3775, -2.997, -3.189, 2.446, -3.193, 0.1246, 1.88, -3.146, 2.721, -0.4072, -2.946, 3.493, -2.191, -2.755, 2.531, 2.515, -1.706, -1.843, 2.702, -1.707, 0.1246, 0.6965, 2.979, 0.1569, -2.099, -15.6, 0.1207, -1.676, -15.6, -1.353, -0.3545, -15.6, -1.972, 1.53, -15.6, 0.151, 1.084, -15.6, 1.802, -0.3545, -15.6, 2.371, -1.679, -15.6, 1.867, -2.632, -8.374, 0.1246, -1.981, -8.446, -1.985, -0.3067, -8.513, -2.771, 2.158, -8.699, 0.1246, 1.683, -8.659, 2.327, -0.367, -8.581, 3.088, -2.181, -8.427, 2.375, 1.11, -15.6, -1.338, 1.75, -8.694, -1.916, -0.3545, -16.05, 0.1404, 1.664, -1.521, -2.901, -0.9279, 2.885, 1.724, -1.284, 2.997, 0.1569, -0.6394, 2.672, -1.74, 0.0838, 2.302, -2.479, 2.083, 1.044, -1.618, 2.464, 0.6629, 0.1614, 1.501, 1.614, 2.528, 0.0381, 2.462, 2.448, 1.509, 1.606, -2.509, 1.524, -13.99, 2.019, -0.3608, -13.81, 2.757, -2.023, -13.87, 2.043, -0.3545, -14.99, -2.267, -0.3545, -15, 2.826, -1.865, -14.99, 2.11, 1.366, -14.99, -1.597, -1.865, -14.99, -1.597, -2.403, -14.99, 0.1287, 1.856, -14.99, 0.1287, 1.366, -14.99, 2.11]))
                                    )
                                    .setTexCoord(TextureCoordinate.new()
                                        .setPoint(to_java_float_array([0.5137, 0.5362, 0.5435, 0.5314, 0.4871, 0.546, 0.3946, 0.5441, 0.3574, 0.539, 0.4222, 0.5494, 0.5949, 0.5388, 0.564, 0.5292, 0.5509, 0.5109, 0.5881, 0.5171, 0.4869, 0.5205, 0.5135, 0.5161, 0.356, 0.5155, 0.392, 0.516, 0.4207, 0.5192, 0.5494, 0.4352, 0.5806, 0.437, 0.4872, 0.4382, 0.5154, 0.4372, 0.3588, 0.4376, 0.3915, 0.437, 0.4204, 0.4388, 0.4853, 0.5922, 0.4061, 0.5828, 0.504, 0.5771, 0.5152, 0.5689, 0.5373, 0.5612, 0.585, 0.5611, 0.554, 0.5612, 0.3653, 0.5645, 0.3898, 0.5743, 0.5605, 0.3376, 0.4842, 0.3445, 0.5487, 0.3376, 0.5125, 0.3445, 0.554, 0.3454, 0.5434, 0.3444, 0.5689, 0.3454, 0.512, 0.3376, 0.512, 0.3454, 0.5726, 0.3454, 0.4713, 0.3376, 0.3945, 0.3465, 0.4642, 0.3454, 0.4208, 0.3461, 0.3626, 0.3605, 0.3943, 0.3619, 0.423, 0.3606, 0.4596, 0.3376, 0.527, 0.5921, 0.454, 0.5585, 0.3115, 0.5408, 0.3182, 0.5192, 0.4535, 0.5221, 0.3258, 0.439, 0.4543, 0.4395, 0.421, 0.5943, 0.3213, 0.5631, 0.472, 0.3376, 0.4535, 0.3447, 0.4642, 0.3454, 0.4506, 0.3454, 0.512, 0.3375, 0.3793, 0.5941, 0.512, 0.3454, 0.5488, 0.3376, 0.554, 0.3454, 0.512, 0.3316, 0.3656, 0.347, 0.3334, 0.3474]))
                                    )
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .setCenter(to_java_float_array([0, 30.98, -2.063]))
                    .addChild(HAnimSegment.new()
                        .setName("pelvis")
                        .setDEF("hanim_pelvis")
                        .addChild(Transform.new()
                            .setTranslation(to_java_float_array([0, 30.98, -2.063]))
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter(to_java_float_array([5.199, 51.119999, -2.106]))
                        .addChild(HAnimSegment.new()
                            .setName("l_upperarm")
                            .setDEF("hanim_l_upperarm")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([5.199, 51.119999, -2.106]))
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([7.024, 42.73, -2.051]))
                            .addChild(HAnimSegment.new()
                                .setName("l_forearm")
                                .setDEF("hanim_l_forearm")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([7.024, 42.73, -2.051]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([7.221, 34, -2.015]))
                                .addChild(HAnimSegment.new()
                                    .setName("l_carpal")
                                    .setDEF("hanim_l_carpal")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([7.221, 34, -2.015]))
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("vl5")
                        .setDEF("hanim_vl5")
                        .setCenter(to_java_float_array([0, 36.290001, -2.197]))
                        .addChild(HAnimSegment.new()
                            .setName("l5")
                            .setDEF("hanim_l5")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([0, 36.290001, -2.197]))
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([0, 54.84, -1.903]))
                            .addChild(HAnimSegment.new()
                                .setName("skull")
                                .setDEF("hanim_skull")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([0, 54.84, -1.903]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
        ...
        .addChild(EXPORT.new()
            .setAS("KoreanCharacter11Min")
            .setLocalDEF("hanim_Min")
        )
    )
x3D0.toFileX3D "../data/KoreanCharacter11Min.new.truffleruby.x3d"
x3D0.toFileJSON "../data/KoreanCharacter11Min.new.truffleruby.x3dj"

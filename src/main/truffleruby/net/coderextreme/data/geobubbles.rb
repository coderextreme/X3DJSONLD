...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(GeoViewpoint.new()
            .setDEF("Tour")
            .setPosition(to_java_double_array([0, 0, 4]))
        ...
        .addChild(GeoPositionInterpolator.new()
            ...
            .setKeyValue(to_java_double_array([0.0015708, 0, 4, 0, 0.0015708, 4]))
        )
        .addChild(Script.new()
...
x3D0.toFileX3D "../data/geobubbles.new.truffleruby.x3d"
x3D0.toFileJSON "../data/geobubbles.new.truffleruby.x3dj"

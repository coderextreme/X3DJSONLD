        ...
        .addChild(HAnimHumanoid.new()
          ...
          .addComments(CommentsBlock.new("original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"'"))
            ...
            .addSkeleton(HAnimJoint.new()
                ...
                .setCenter(to_java_float_array([0, 44.07, -1.034]))
                .setContainerFieldOverride("skeleton")
                .addChild(HAnimSegment.new()
                    .setName("sacrum")
                    .setDEF("hanim_sacrum")
                    .addChild(Transform.new()
                        .setTranslation(to_java_float_array([0, 44.07, -1.034]))
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                ...
                                .setTexture(ImageTexture.new()
                                    ...
                                    .setUrl(to_java_string_array(["images/Chul.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Chul.png"]))
                                )
                            )
                            .setGeometry(IndexedFaceSet.new()
                                ...
                                .setCoord(Coordinate.new()
                                    .setPoint(to_java_float_array([0, 0.87, 0.0225, 0, 0.7535, -0.4472, -0.3613, 0.7535, -0.3842, -0.6259, 0.7535, -0.3083, -0.7227, 0.7535, 0.0225, -0.6259, 0.7535, 0.3534, -0.3613, 0.7535, 0.4293, 0, 0.7535, 0.4922, 0.3613, 0.7535, 0.4293, 0.6259, 0.7535, 0.3534, 0.7227, 0.7535, 0.0225, 0.6259, 0.7535, -0.3083, 0.3613, 0.7535, -0.3842, 0, 0.435, -0.7303, -0.4673, 0.435, -0.6294, -0.8094, 0.435, -0.3539, -0.9347, 0.435, 0.0225, -0.8094, 0.435, 0.399, -0.4673, 0.435, 0.5769, 0, 0.435, 0.6777, 0.4673, 0.435, 0.5769, 0.8094, 0.435, 0.399, 0.9347, 0.435, 0.0225, 0.8094, 0.435, -0.3539, 0.4673, 0.435, -0.6294, 0, 0, -0.7942, -0.5396, 0, -0.6777, -0.9347, 0, -0.3596, -1.079, 0, 0.0225, -0.9347, 0, 0.4572, -0.5396, 0, 0.6777, 0, 0, 0.7942, 0.5396, 0, 0.6777, 0.9347, 0, 0.4572, 1.079, 0, 0.0225, 0.9347, 0, -0.3596, 0.5396, 0, -0.6777, 0, -0.435, -0.6777, -0.4673, -0.435, -0.5769, -0.8094, -0.435, -0.3013, -0.9347, -0.435, 0.0225, -0.8094, -0.435, 0.399, -0.4673, -0.435, 0.5769, 0, -0.435, 0.6777, 0.4673, -0.435, 0.5769, 0.8094, -0.435, 0.399, 0.9347, -0.435, 0.0225, 0.8094, -0.435, -0.3013, 0.4673, -0.435, -0.5769, 0, -0.7535, -0.3596, -0.2698, -0.7535, -0.3013, -0.4673, -0.7535, -0.1948, -0.5396, -0.7535, 0.0225, -0.4673, -0.7535, 0.2399, -0.2698, -0.7535, 0.399, 0, -0.7535, 0.4572, 0.2698, -0.7535, 0.399, 0.4673, -0.7535, 0.2399, 0.5396, -0.7535, 0.0225, 0.4673, -0.7535, -0.1948, 0.2698, -0.7535, -0.3013, 0, -0.87, 0.0225]))
                                )
                                .setTexCoord(TextureCoordinate.new()
                                    .setPoint(to_java_float_array([0.7418, 0.2139, 0.7309, 0.2139, 0.7342, 0.26, 0.7342, 0.2938, 0.7342, 0.3062, 0.7342, 0.2938, 0.7342, 0.26, 0.7309, 0.2139, 0.7343, 0.2601, 0.7343, 0.2939, 0.7343, 0.3063, 0.7343, 0.2939, 0.7343, 0.2601, 0.7157, 0.2139, 0.7156, 0.2735, 0.7156, 0.3173, 0.7156, 0.3333, 0.7156, 0.3173, 0.7156, 0.2735, 0.7157, 0.2139, 0.7157, 0.2736, 0.7157, 0.3174, 0.7157, 0.3334, 0.7157, 0.3174, 0.7157, 0.2736, 0.7015, 0.2147, 0.7014, 0.2836, 0.7014, 0.3341, 0.7014, 0.3526, 0.7014, 0.3341, 0.7014, 0.2836, 0.7015, 0.2147, 0.7015, 0.2837, 0.7015, 0.3342, 0.7015, 0.3527, 0.7015, 0.3342, 0.7015, 0.2837, 0.6609, 0.2147, 0.6608, 0.2744, 0.6608, 0.3181, 0.6608, 0.3341, 0.6608, 0.3181, 0.6608, 0.2744, 0.6609, 0.2147, 0.6609, 0.2745, 0.6609, 0.3182, 0.6609, 0.3342, 0.6609, 0.3182, 0.6609, 0.2745, 0.6312, 0.2147, 0.6311, 0.2491, 0.6311, 0.2744, 0.6311, 0.2836, 0.6311, 0.2744, 0.6311, 0.2491, 0.6312, 0.2147, 0.6312, 0.2492, 0.6312, 0.2745, 0.6312, 0.2837, 0.6312, 0.2745, 0.6312, 0.2492, 0.6204, 0.2147]))
                                )
                            )
                        )
                    )
                ...
                .addChild(HAnimJoint.new()
                    .setName("l_hip")
                    .setDEF("hanim_l_hip")
                    .setCenter(to_java_float_array([4.001, 41.139999, -1.119]))
                    .addChild(HAnimSegment.new()
                        .setName("l_thigh")
                        .setDEF("hanim_l_thigh")
                        .addChild(Transform.new()
                            .setTranslation(to_java_float_array([4.001, 41.139999, -1.119]))
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("l_knee")
                        .setDEF("hanim_l_knee")
                        .setCenter(to_java_float_array([4.315, 25.190001, -1.119]))
                        .addChild(HAnimSegment.new()
                            .setName("l_calf")
                            .setDEF("hanim_l_calf")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([4.315, 25.190001, -1.119]))
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([4.574, 6.838, -1.463]))
                            .addChild(HAnimSegment.new()
                                .setName("l_talus")
                                .setDEF("hanim_l_talus")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([4.574, 6.838, -1.463]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([4.809, 5.583, 1.492]))
                                .addChild(HAnimSegment.new()
                                    .setName("l_tarsal_proximal_phalanx_2")
                                    .setDEF("hanim_l_tarsal_proximal_phalanx_2")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([4.809, 5.583, 1.492]))
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                                            ...
                                            .setGeometry(IndexedFaceSet.new()
                                                .setCoordIndex(to_java_int_array([0, 1, 19, -1, 19, 18, 0, -1, 1, 2, 20, -1, 20, 19, 1, -1, 22, 5, 25, -1, 4, 24, 25, -1, 25, 5, 4, -1, 3, 0, 18, -1, 18, 21, 3, -1, 6, 9, 7, -1, 7, 8, 6, -1, 22, 20, 2, -1, 2, 5, 22, -1, 6, 11, 10, -1, 10, 9, 6, -1, 0, 13, 12, -1, 12, 1, 0, -1, 1, 12, 14, -1, 14, 2, 1, -1, 3, 4, 15, -1, 15, 16, 3, -1, 5, 17, 15, -1, 15, 4, 5, -1, 3, 16, 13, -1, 13, 0, 3, -1, 2, 14, 17, -1, 17, 5, 2, -1, 15, 6, 8, -1, 8, 16, 15, -1, 16, 8, 7, -1, 7, 13, 16, -1, 13, 7, 9, -1, 9, 12, 13, -1, 15, 17, 11, -1, 11, 6, 15, -1, 12, 9, 10, -1, 10, 14, 12, -1, 14, 10, 11, -1, 11, 17, 14, -1, 4, 3, 23, -1, 23, 24, 4, -1, 23, 3, 21, -1, 18, 19, 27, -1, 27, 26, 18, -1, 19, 20, 28, -1, 28, 27, 19, -1, 20, 22, 29, -1, 29, 28, 20, -1, 22, 25, 29, -1, 23, 21, 30, -1, 21, 18, 26, -1, 26, 30, 21, -1, 23, 25, 24, -1, 29, 25, 23, -1, 23, 30, 29, -1, 27, 28, 29, -1, 26, 27, 29, -1, 30, 26, 29, -1]))
                                                .setCreaseAngle(1.57)
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .setCenter(to_java_float_array([0, 38.639999, -1.034]))
                    .addChild(HAnimSegment.new()
                        .setName("pelvis")
                        .setDEF("hanim_pelvis")
                        .addChild(Transform.new()
                            .setTranslation(to_java_float_array([0, 38.639999, -1.034]))
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter(to_java_float_array([7.699, 59.419998, -1.567]))
                        .addChild(HAnimSegment.new()
                            .setName("l_upperarm")
                            .setDEF("hanim_l_upperarm")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([7.699, 59.419998, -1.567]))
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([8.026, 48.450001, -1.959]))
                            .addChild(HAnimSegment.new()
                                .setName("l_forearm")
                                .setDEF("hanim_l_forearm")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([8.026, 48.450001, -1.959]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                                        ...
                                        .setGeometry(IndexedFaceSet.new()
                                            ...
                                            .setCoord(Coordinate.new()
                                                .setPoint(to_java_float_array([-1.607, -0.3011, -0.7068, -1.816, -1.259, 0.7158, -1.607, -0.3011, 0.7173, -1.816, -1.259, -0.7039, 0.0748, -2.207, 1.664, 0.0977, -1.281, 1.671, 0.0968, -1.282, -1.749, 0.075, -2.207, -1.492, 1.791, -1.616, 0.6505, 1.816, -0.6919, 0.6532, 1.791, -1.616, -0.5319, 1.816, -0.6919, -0.5362, -1.323, -4.528, 1.438, -1.323, -4.528, -0.6341, 0.0101, -4.917, 1.749, 0.01, -4.917, -1.419, 1.599, -4.353, 0.9644, 1.599, -4.353, -0.4902, -1.275, -7.552, 0.9117, -1.275, -7.552, -0.5772, 0.0603, -7.691, 1.6, 0.0602, -7.691, -1.319, 1.34, -7.172, 0.8445, 1.34, -7.172, -0.3992, 0.0847, -10.99, -0.7836, -0.679, -10.66, -0.3055, 0.092, -10.99, 1.088, -0.6772, -10.65, 0.6521, 0.6479, -10.85, -0.4597, 0.652, -10.87, 0.7241, -0.8326, 0.9823, 0.4058, -0.8326, 0.9823, -0.3926, 0.1232, 0.4326, 0.9405, 0.1227, 0.4326, -0.977, 1.087, 0.7632, 0.3698, 1.087, 0.7632, -0.297, 0.1182, 1.187, 0.0082, -0.0134, -11.39, 0.1526]))
                                            )
                                            .setTexCoord(TextureCoordinate.new()
                                                .setPoint(to_java_float_array([0.9014, 0.1592, 0.9207, 0.1477, 0.9221, 0.1592, 0.9028, 0.1477, 0.9498, 0.1348, 0.951, 0.146, 0.8725, 0.146, 0.8736, 0.1348, 0.9793, 0.1407, 0.9796, 0.1519, 0.8426, 0.1407, 0.8423, 0.1519, 0.9299, 0.1077, 0.9022, 0.1077, 0.9466, 0.102, 0.8775, 0.102, 0.9732, 0.1077, 0.8437, 0.1077, 0.9238, 0.071, 0.9036, 0.071, 0.9446, 0.0684, 0.8798, 0.0684, 0.9704, 0.0737, 0.845, 0.0737, 0.8879, 0.0318, 0.9059, 0.0364, 0.939, 0.0318, 0.9232, 0.0366, 0.8712, 0.0331, 0.9514, 0.0329, 0.9243, 0.1741, 0.8994, 0.1741, 0.9551, 0.1668, 0.8685, 0.1668, 0.9806, 0.1701, 0.8414, 0.1701, 0.9871, 0.1759, 0.9173, 0.0271, 0.8271, 0.1519, 0.8268, 0.1407, 0.8268, 0.1407, 0.8207, 0.1077, 0.8207, 0.1077, 0.8264, 0.0737, 0.8264, 0.0737, 0.8397, 0.0329, 0.8281, 0.1701, 0.8271, 0.1519, 0.8346, 0.1759, 0.8346, 0.1759, 0.8281, 0.1701, 0.8346, 0.1759, 0.8346, 0.1759, 0.8397, 0.0329]))
                                            )
                                        )
                                    )
                                )
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([7.617, 37.689999, -1.663]))
                                .addChild(HAnimSegment.new()
                                    .setName("l_carpal")
                                    .setDEF("hanim_l_carpal")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([7.617, 37.689999, -1.663]))
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                                    ...
                                    .addChild(Transform.new()
                                        ...
                                        .addChild(Shape.new()
                                            ...
                                            .setGeometry(IndexedFaceSet.new()
                                                ...
                                                .setCoord(Coordinate.new()
                                                    .setPoint(to_java_float_array([-0.428, -4.043, 1.035, 0.062, -2.76, -0.7256, -0.4283, -4.043, -1.325, 0.0621, -2.759, 0.4786, -0.5207, -5.808, 0.5759, 0.0026, -5.67, -1.325, -0.5208, -5.808, -0.9061, 0.0026, -5.67, 1.035, 0.311, 0.5832, -0.6014, -0.4947, 0.3747, -1.08, -0.3587, -0.8063, -1.077, 0.3511, -0.5647, -0.6024, -0.502, 0.3752, 0.7923, 0.3112, 0.5961, 0.3561, 0.3512, -0.5647, 0.3515, -0.5145, -0.7545, 0.7924, -1.03, 0.5998, -0.7556, -1.03, -0.5583, -0.7457, -1.037, 0.5778, 0.4281, -1.031, -0.5582, 0.4287, -0.3854, -2.321, -1.587, 0.3249, -2.079, -0.8558, -0.2488, -1.494, 1.332, 0.4651, -1.238, 0.8921, 0.7055, -1.95, 1.153, 0.2884, -2.29, 1.587, 0.324, -2.079, 0.6132, -1.057, -2.073, -1.077, -1.049, -2.091, 0.6923, -0.3858, -2.321, 1.292, -0.9501, -4.181, -0.9063, -0.9499, -4.181, 0.5762, -0.2552, -4.694, -1.325, -0.2552, -4.694, 1.035, -0.7786, -4.832, -0.9061, -0.7786, -4.832, 0.5759, -0.6497, -5.32, -0.9061, -0.1263, -5.182, -1.325, -0.6497, -5.32, 0.5759, -0.1263, -5.182, 1.035, 0.6755, -3.115, 0.6119, 0.214, -3.44, 1.081, 0.6399, -3.326, 1.586, 1.057, -2.987, 1.151, 0.8814, -2.469, 1.15, 0.4641, -2.808, 1.587, 0.0383, -2.922, 1.082, 0.4998, -2.597, 0.6126, -0.4437, 0.8321, -0.1433]))
                                                )
                                                .setTexCoord(TextureCoordinate.new()
                                                    .setPoint(to_java_float_array([0.1427, 0.2125, 0.1222, 0.2114, 0.072, 0.2114, 0.0487, 0.2146, 0.1648, 0.2146, 0.1427, 0.2125, 0.072, 0.2114, 0.1648, 0.2146, 0.1856, 0.1891, 0.2639, 0.1883, 0.2484, 0.188, 0.1701, 0.1891, 0.2529, 0.0205, 0.2367, 0.0146, 0.2411, 0.0322, 0.2577, 0.0389, 0.1901, 0.0132, 0.1856, 0.0283, 0.1719, 0.0186, 0.1675, 0.0336, 0.2484, 0.0869, 0.2649, 0.0843, 0.1864, 0.0924, 0.1708, 0.0905, 0.2488, 0.1471, 0.2643, 0.1474, 0.186, 0.1482, 0.1705, 0.1482, 0.2484, 0.1644, 0.2639, 0.1647, 0.1856, 0.1655, 0.1701, 0.1655, 0.2484, 0.1762, 0.2639, 0.1765, 0.1856, 0.1773, 0.1701, 0.1773, 0.1633, 0.1308, 0.1534, 0.1396, 0.1426, 0.1381, 0.1476, 0.1297, 0.1475, 0.0465, 0.1445, 0.0998, 0.1671, 0.1111, 0.1534, 0.127, 0.1633, 0.1182, 0.1426, 0.1255, 0.2062, 0.0097, 0.1009, 0.1405, 0.0196, 0.0979, 0.0057, 0.141, 0.0959, 0.0953, 0.0453, 0.0029, 0.0235, 0.0102, 0.0236, 0.0455, 0.0452, 0.0373, 0.1089, 0.0102, 0.089, 0.0039, 0.0888, 0.0373, 0.1089, 0.0441, 0.005, 0.081, 0.0337, 0.0828, 0.1222, 0.069, 0.1135, 0.0574, 0.1162, 0.0936, 0.1239, 0.0947, 0.102, 0.0746, 0.1039, 0.0949, 0.0057, 0.1603, 0.1009, 0.1598, 0.0057, 0.1748, 0.1009, 0.1743, 0.0057, 0.1892, 0.1009, 0.1888, 0.1179, 0.119, 0.1252, 0.1262, 0.1098, 0.1164, 0.1179, 0.1343, 0.1252, 0.1415, 0.1098, 0.1317]))
                                                )
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("vl5")
                        .setDEF("hanim_vl5")
                        .setCenter(to_java_float_array([0, 47.330002, -0.5744]))
                        .addChild(HAnimSegment.new()
                            .setName("l5")
                            .setDEF("hanim_l5")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([0, 47.330002, -0.5744]))
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([0, 65.510002, -1.446]))
                            .addChild(HAnimSegment.new()
                                .setName("skull")
                                .setDEF("hanim_skull")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([0, 65.510002, -1.446]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
...
x3D0.toFileX3D "../data/KoreanCharacter02Chul.new.truffleruby.x3d"
x3D0.toFileJSON "../data/KoreanCharacter02Chul.new.truffleruby.x3dj"

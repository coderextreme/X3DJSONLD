            ...
            .addChild(Shape.new()
                ...
                .addComments(CommentsBlock.new("<field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field>"))
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs"]))
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs"]))
                            .setType("FRAGMENT")
                        )
                    )
                    .addShaders(ComposedShader.new()
...
x3D0.toFileX3D "../data/flowers7.new.truffleruby.x3d"
x3D0.toFileJSON "../data/flowers7.new.truffleruby.x3dj"

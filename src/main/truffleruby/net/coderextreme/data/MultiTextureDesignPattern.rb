...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        .addMeta(meta.new()
            .setName("title")
            .setContent("MultiTextureDesignPattern.x3d")
        )
        .addMeta(meta.new()
            .setName("description")
            .setContent("Design pattern for MultiTexture, MultiTextureCoordinate, MultiTextureTransform node correspondences")
        )
        .addMeta(meta.new()
            .setName("creator")
        ...
        .addMeta(meta.new()
            .setName("created")
            .setContent("5 March 2011")
        )
        .addMeta(meta.new()
            .setName("modified")
            .setContent("29 October 2023")
        )
        .addMeta(meta.new()
            .setName("TODO")
            .setContent("X3D schematron rules for quality assurance")
        )
        .addMeta(meta.new()
            .setName("Image")
            .setContent("MultiTextureDesignPatternSceneGraph.png")
        )
        .addMeta(meta.new()
            .setName("subject")
            .setContent("MultiTexture, MultiTextureCoordinate, MultiTextureTransform")
        )
        .addMeta(meta.new()
            .setName("reference")
            .setContent("https://www.web3d.org/files/specifications/19775-1/V3.2/Part01/components/texturing.html#MultiTexture")
        )
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/TextureMapping/MultiTextureDesignPattern.x3d")
        )
        .addMeta(meta.new()
            .setName("reference")
            .setContent("https://www.web3d.org/x3d/content/examples/X3dResources.html")
        )
        .addMeta(meta.new()
            .setName("generator")
    ...
    .setScene(Scene.new()
        ...
        .addChild(WorldInfo.new()
            .setTitle("MultiTextureDesignPattern.x3d")
        )
        .addChild(Background.new()
            .setSkyColor(to_java_float_array([0.72549, 1, 0.721569]))
        )
        .addChild(Viewpoint.new()
            .setDescription("MultiTexture design pattern")
        )
        .addChild(Shape.new()
            .setGeometry(Text.new()
                .setString(to_java_string_array(["Source shows design pattern for", "MultiTexture, MultiTextureCoordinate,", " and MultiTextureTransform nodes"]))
            ...
            .setAppearance(Appearance.new()
                .setMaterial(Material.new()
                    .setDiffuseColor(to_java_float_array([0.2, 0.4, 0.8]))
                )
            )
        )
        .addComments(CommentsBlock.new("================================"))
        .addChild(Shape.new()
          .addComments(CommentsBlock.new("add a single geometry node here"))
            .setGeometry(IndexedFaceSet.new()
                .setTexCoord(MultiTextureCoordinate.new()
              .addComments(CommentsBlock.new("add multiple TextureCoordinate nodes here, match corresponding MultiTexture child texture nodes"))
                    .addTexCoord(TextureCoordinate.new()
                        .setPoint(to_java_float_array([0, 0, 1, 0, 1, 1, 0, 1]))
                    )
                    .addTexCoord(TextureCoordinate.new()
                        .setPoint(to_java_float_array([0, 0, 1, 0, 1, 1, 0, 1]))
                    )
            ...
            .setAppearance(Appearance.new()
                ...
                .setTexture(MultiTexture.new()
                    .setAlpha(0.8)
                    .setColor(to_java_float_array([0.9, 1, 0.2]))
                    .setFunction(to_java_string_array(["COMPLEMENT", "ALPHAREPLICATE"]))
                    .setMode(to_java_string_array(["MODULATE", "REPLACE", "BLENDDIFFUSEALPHA"]))
                    .setSource(to_java_string_array(["DIFFUSE", "SPECULAR", "FACTOR"]))
              .addComments(CommentsBlock.new("add multiple texture nodes here"))
                    .addTexture(ImageTexture.new()
                    )
                    .addTexture(MovieTexture.new()
                    )
                    .addTexture(PixelTexture.new()
                    )
                )
                .setTextureTransform(MultiTextureTransform.new()
              .addComments(CommentsBlock.new("add multiple TextureTransform nodes here, match corresponding MultiTexture child texture nodes"))
                    .addTextureTransform(TextureTransform.new()
                    )
                    .addTextureTransform(TextureTransform.new()
                    )
                    .addTextureTransform(TextureTransform.new()
...
x3D0.toFileX3D "../data/MultiTextureDesignPattern.new.truffleruby.x3d"
x3D0.toFileJSON "../data/MultiTextureDesignPattern.new.truffleruby.x3dj"

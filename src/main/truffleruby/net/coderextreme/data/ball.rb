    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            .addChild(Shape.new()
              ...
              .addComments(CommentsBlock.new("<ProgramShader DEF='ProgramShader' containerField='shaders' language='GLSL'>"))
              .addComments(CommentsBlock.new("<ShaderProgram url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"' containerField='programs'>"))
              .addComments(CommentsBlock.new("<field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1 1.033'/>"))
              .addComments(CommentsBlock.new("<field name='bias' accessType='initializeOnly' type='SFFloat' value='0.5'/>"))
              .addComments(CommentsBlock.new("<field name='scale' accessType='initializeOnly' type='SFFloat' value='0.5'/>"))
              .addComments(CommentsBlock.new("<field name='power' accessType='initializeOnly' type='SFFloat' value='2'/>"))
              .addComments(CommentsBlock.new("</ShaderProgram>"))
              .addComments(CommentsBlock.new("<ShaderProgram url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' containerField='programs' type='FRAGMENT'/>"))
              .addComments(CommentsBlock.new("</ProgramShader>"))
              ...
              .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/castle.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'></ShaderPart>"))
              .addComments(CommentsBlock.new("<ShaderPart DEF='commonfs' url='\"../shaders/common.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\"' type='FRAGMENT'></ShaderPart>"))
              .addComments(CommentsBlock.new("</ComposedShader>"))
              .addComments(CommentsBlock.new("<ComposedShader language='GLSL'>"))
              .addComments(CommentsBlock.new("<field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1 1.033'></field>"))
              .addComments(CommentsBlock.new("<field name='fw_Texture_unit0' type='SFNode' accessType=\"initializeOnly\">"))
              .addComments(CommentsBlock.new("<ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture>"))
              .addComments(CommentsBlock.new("</field>"))
              .addComments(CommentsBlock.new("<field name='bias' accessType='initializeOnly' type='SFFloat' value='0.5'></field>"))
              .addComments(CommentsBlock.new("<field name='scale' accessType='initializeOnly' type='SFFloat' value='0.5'></field>"))
              .addComments(CommentsBlock.new("<field name='power' accessType='initializeOnly' type='SFFloat' value='2'></field>"))
              .addComments(CommentsBlock.new("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/contact.vs\"'></ShaderPart>"))
              ...
              .addComments(CommentsBlock.new("<field name='scale' accessType='inputOutput' type='SFFloat' value='0.5'></field>"))
              .addComments(CommentsBlock.new("<field name='power' accessType='inputOutput' type='SFFloat' value='2'></field>"))
              .addComments(CommentsBlock.new("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/octaga.vs\"'></ShaderPart>"))
              .addComments(CommentsBlock.new("<ShaderPart USE='commonfs'></ShaderPart>"))
              .addComments(CommentsBlock.new("</ComposedShader>"))
              .addComments(CommentsBlock.new("<ComposedShader language='GLSL'>"))
              .addComments(CommentsBlock.new("<field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1 1.033'></field>"))
              .addComments(CommentsBlock.new("<field name='cube' accessType='initializeOnly' type='SFInt32' value='0'></field>"))
              .addComments(CommentsBlock.new("<field name='bias' accessType='initializeOnly' type='SFFloat' value='0.5'></field>"))
              .addComments(CommentsBlock.new("<field name='scale' accessType='initializeOnly' type='SFFloat' value='0.5'></field>"))
              .addComments(CommentsBlock.new("<field name='power' accessType='initializeOnly' type='SFFloat' value='2'></field>"))
              .addComments(CommentsBlock.new("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/instant.vs\"'></ShaderPart>"))
              .addComments(CommentsBlock.new("<ShaderPart USE='commonfs'></ShaderPart>"))
              .addComments(CommentsBlock.new("</ComposedShader>"))
              .addComments(CommentsBlock.new("<ComposedShader language='GLSL'>"))
              .addComments(CommentsBlock.new("<field name='chromaticDispertion' accessType='inputOutput' type='SFVec3f' value='0.98 1 1.033'></field>"))
              ...
              .addComments(CommentsBlock.new("<field name='scale' accessType='inputOutput' type='SFFloat' value='0.5'></field>"))
              .addComments(CommentsBlock.new("<field name='power' accessType='inputOutput' type='SFFloat' value='2'></field>"))
              .addComments(CommentsBlock.new("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom.vs\"'></ShaderPart>"))
              .addComments(CommentsBlock.new("<ShaderPart USE=\"commonfs\"></ShaderPart>"))
              .addComments(CommentsBlock.new("</ComposedShader>"))
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs"]))
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setDEF("commonfs")
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/commonnew.fs"]))
                            .setType("FRAGMENT")
                        )
                .addComments(CommentsBlock.new("<ShaderPart USE=\"commonfs\"></ShaderPart>"))
                    )
...
x3D0.toFileX3D "../data/ball.new.truffleruby.x3d"
x3D0.toFileJSON "../data/ball.new.truffleruby.x3dj"

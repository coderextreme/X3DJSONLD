...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/data/bubble.x3d")
        )
    )
    .setScene(Scene.new()
...
x3D0.toFileX3D "../data/bubble.new.truffleruby.x3d"
x3D0.toFileJSON "../data/bubble.new.truffleruby.x3dj"

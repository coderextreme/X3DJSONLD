...
"}")                )
        ...
        .addChild(Background.new()
            .setSkyColor(to_java_float_array([0.282353, 0.380392, 0.470588]))
        )
        .addChild(Anchor.new()
            .setDescription("launch CameraExample scene")
            .setUrl(to_java_string_array(["CameraExamples.x3d", "https://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.x3d", "CameraExamples.wrl", "https://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.wrl"]))
            .addChild(Transform.new()
                .addChild(Shape.new()
                    .setGeometry(Text.new()
                        .setString(to_java_string_array(["CameraPrototypes.x3d", "defines multiple prototype nodes", "Click on this text to see", "CameraExamples.x3d scene"]))
...
x3D0.toFileX3D "../data/CameraPrototypes.new.truffleruby.x3d"
x3D0.toFileJSON "../data/CameraPrototypes.new.truffleruby.x3dj"

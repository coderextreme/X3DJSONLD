...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        .addChild(ProtoDeclare.new()
            ...
            .addComments(CommentsBlock.new("This embedded Script provides the X3D author with additional visibility and control over prototype inputs and outputs"))
                .addChild(Script.new()
                    ...
                    .setUrl(to_java_string_array(["../node/ArchPrototypeScript.js", "https://coderextreme.net/X3DJSONLD/src/main/node/ArchPrototypeScript.js"]))
              .addComments(CommentsBlock.new("INPUT PARAMETERS"))
        ...
        .addChild(Inline.new()
            ...
            .setUrl(to_java_string_array(["../data/CoordinateAxes.x3d"]))
        )
    )
x3D0.toFileX3D "../data/ArchPrototype.new.truffleruby.x3d"
x3D0.toFileJSON "../data/ArchPrototype.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
                ...
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            ...
                            .setDiffuseColor(to_java_float_array([0.3, 0.3, 0.5]))
                            .setShininess(0.1)
                            .setSpecularColor(to_java_float_array([0.7, 0.7, 0.8]))
                        )
                    )
            ...
            .addChild(Transform.new()
                .setTranslation(to_java_float_array([0, 0.35, 0]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setUSE("tank")
            ...
            .addChild(Group.new()
                ...
                .addChild(Transform.new()
                        ...
                        .addChild(Shape.new()
                            ...
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    ...
                                    .setDiffuseColor(to_java_float_array([0.91, 0.91, 0.91]))
                                    .setShininess(0.16)
                                    .setSpecularColor(to_java_float_array([0.91, 0.9, 0.91]))
                                )
                            )
                            .setGeometry(Cylinder.new()
                                .setHeight(0.1)
                    ...
                    .addChild(Transform.new()
                        ...
                        .setTranslation(to_java_float_array([-0.028, 0.462, 0]))
                        .addChild(Transform.new()
                            .addChild(Shape.new()
        ...
        .addChild(Background.new()
            .setSkyColor(to_java_float_array([0.6, 0.6, 0.6]))
        )
    )
x3D0.toFileX3D "../data/ScubaTank.new.truffleruby.x3d"
x3D0.toFileJSON "../data/ScubaTank.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/JinFacsAu16LowerLipDepressorMorpher.x3d")
        )
        .addMeta(meta.new()
            .setName("license")
    ...
    .setScene(Scene.new()
        ...
        .addChild(EXPORT.new()
            ...
            .setAS("JinLowerLipDepressor_Clock")
        )
...
x3D0.toFileX3D "../data/JinLowerLipDepressor.new.truffleruby.x3d"
x3D0.toFileJSON "../data/JinLowerLipDepressor.new.truffleruby.x3dj"

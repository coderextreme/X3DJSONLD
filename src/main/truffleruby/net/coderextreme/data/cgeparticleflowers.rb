    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            .addChild(ParticleSystem.new()
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        ...
                        .setFrontTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["../resources/images/all_probes/stpeters_cross/stpeters_from.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
                        )
                ...
                .addComments(CommentsBlock.new("<field name='cube' type='SFNode' accessType=\"initializeOnly\">"))
                ...
                .addComments(CommentsBlock.new("</field>"))
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs"]))
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setType("FRAGMENT")
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs"]))
                        )
                    )
                )
            )
...
x3D0.toFileX3D "../data/cgeparticleflowers.new.truffleruby.x3d"
x3D0.toFileJSON "../data/cgeparticleflowers.new.truffleruby.x3dj"

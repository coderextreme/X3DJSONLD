...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            .setPosition(to_java_float_array([0, 0, 5]))
            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor(to_java_float_array([0.7, 0.2, 0.2]))
                    )
                )
        ...
        .addChild(Transform.new()
            .setDEF("G2")
            .setTranslation(to_java_float_array([1, -1, 0.01]))
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor(to_java_float_array([0.2, 0.7, 0.2]))
                    )
                )
                .setGeometry(Sphere.new()
                    .setRadius(0.1)
            ...
            .addChild(PlaneSensor.new()
                .setDescription("Grab to move")
                .setOffset(to_java_float_array([1, -1, 0.01]))
                .setDEF("PS2")
            )
            .addChild(ROUTE.new()
                .setFromNode("PS2")
        ...
        .addChild(Transform.new()
            ...
            .addChild(Transform.new()
                ...
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setDiffuseColor(to_java_float_array([0.2, 0.7, 0.7]))
                            .setTransparency(0.5)
                        )
                    )
...
x3D0.toFileX3D "../data/x3dconnectorProto.new.truffleruby.x3d"
x3D0.toFileJSON "../data/x3dconnectorProto.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            .setPosition(to_java_float_array([0, 0, 4]))
            .setOrientation(to_java_float_array([1, 0, 0, 0]))
            .setDescription("Bubbles in action")
        )
        .addChild(Background.new()
            .setBackUrl(to_java_string_array(["../resources/images/BK.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/BK.png"]))
            .setBottomUrl(to_java_string_array(["../resources/images/BT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/BT.png"]))
            .setFrontUrl(to_java_string_array(["../resources/images/FR.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/FR.png"]))
            .setLeftUrl(to_java_string_array(["../resources/images/LF.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/LF.png"]))
            .setRightUrl(to_java_string_array(["../resources/images/RT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/RT.png"]))
            .setTopUrl(to_java_string_array(["../resources/images/TP.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/TP.png"]))
        )
...
x3D0.toFileX3D "../data/bubs2.new.truffleruby.x3d"
x3D0.toFileJSON "../data/bubs2.new.truffleruby.x3dj"

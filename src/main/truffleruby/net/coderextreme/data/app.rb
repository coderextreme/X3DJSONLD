...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("creator")
            .setContent("Carlson, I")
        )
        .addMeta(meta.new()
            .setName("creator")
            .setContent("Carlson, II")
        )
        .addMeta(meta.new()
            .setName("creator")
            .setContent("Carlson, III")
        )
    )
    .setScene(Scene.new()
        .addChild(Group.new()
        ...
        .addChild(Transform.new()
            .setRotation(to_java_float_array([7, 8, 9, 3.14]))
            .setScale(to_java_float_array([4, 5, 6]))
            .setTranslation(to_java_float_array([1, 2, 3]))
        )
    )
x3D0.toFileX3D "../data/app.new.truffleruby.x3d"
x3D0.toFileJSON "../data/app.new.truffleruby.x3dj"

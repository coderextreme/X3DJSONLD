                ...
                .setAppearance(Appearance.new()
                    ...
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs"]))
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"]))
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../data/fwparticleflowers.new.truffleruby.x3d"
x3D0.toFileJSON "../data/fwparticleflowers.new.truffleruby.x3dj"

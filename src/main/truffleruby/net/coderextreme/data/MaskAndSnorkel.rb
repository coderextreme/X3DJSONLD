...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor(to_java_float_array([0, 0, 0.9]))
        )
        .addChild(Transform.new()
            ...
            .addChild(Transform.new()
                ...
                .setTranslation(to_java_float_array([0.075, 0.075, -0.02]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setUSE("frameColor")
            ...
            .addChild(Group.new()
                .setDEF("snorkel")
                .addChild(Transform.new()
                    .setTranslation(to_java_float_array([0, -0.02, 0]))
                    .addChild(Transform.new()
                        .setScale(to_java_float_array([0.9, 0.9, 0.9]))
                        .setTranslation(to_java_float_array([0.035, -0.07, -0.02]))
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    .setDEF("snorkelTube")
                                    .setDiffuseColor(to_java_float_array([0.678, 1, 0.184]))
                                    .setTransparency(0.4)
                                )
                            )
                            .setGeometry(Extrusion.new()
                                .setCrossSection(to_java_float_array([0, 0.013, 0.00494, 0.01196, 0.00923, 0.00923, 0.01196, 0.00494, 0.013, 0, 0.01196, -0.00494, 0.00923, -0.00923, 0.00494, -0.01196, 0, 0.013, -0.00494, -0.01196, -0.00923, -0.00923, -0.01196, -0.00494, -0.013, 0, -0.01196, 0.00494, -0.00923, 0.00923, -0.00494, 0.01196, 0, 0.013]))
                                .setSpine(to_java_float_array([-0.01, -0.04, 0, 0, 0, 0, 0.03, 0.05, 0, 0.05, 0.2, 0, 0.03, 0.4, 0.03]))
                            )
                        )
                    )
                    .addChild(Transform.new()
                        ...
                        .setScale(to_java_float_array([0.9, 0.9, 0.9]))
                        .setTranslation(to_java_float_array([0.01, -0.04, -0.02]))
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    .setDEF("Mouthpiece")
                                    .setDiffuseColor(to_java_float_array([0.678, 1, 0.8]))
                                    .setTransparency(0.4)
                                )
                            )
                            .setGeometry(Extrusion.new()
                                .setCrossSection(to_java_float_array([0, 0.013, 0.00494, 0.01196, 0.00923, 0.00923, 0.01196, 0.00494, 0.013, 0, 0.01196, -0.00494, 0.00923, -0.00923, 0.00494, -0.01196, 0, 0.013, -0.00494, -0.01196, -0.00923, -0.00923, -0.01196, -0.00494, -0.013, 0, -0.01196, 0.00494, -0.00923, 0.00923, -0.00494, 0.01196, 0, 0.013]))
                                .setSpine(to_java_float_array([-0.01, -0.03, 0, 0, 0, 0, 0.02, 0.01, 0]))
                            )
                        )
                    )
                    .addChild(Transform.new()
                        .setRotation(to_java_float_array([0, 0, 1, -0.85]))
                        .setScale(to_java_float_array([0.9, 0.9, 0.9]))
                        .setTranslation(to_java_float_array([0.005, -0.01, -0.02]))
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    .setUSE("Mouthpiece")
                            ...
                            .setGeometry(Extrusion.new()
                                .setCrossSection(to_java_float_array([0, 0.013, 0.00494, 0.01196, 0.00923, 0.00923, 0.01196, 0.00494, 0.013, 0, 0.01196, -0.00494, 0.00923, -0.00923, 0.00494, -0.01196, 0, 0.013]))
                                .setSpine(to_java_float_array([-0.02, -0.03, 0, -0.01, -0.03, 0, 0, -0.0175, 0, 0, -0.0135, 0, -0.01, 0, 0, -0.02, 0, 0]))
                            )
                        )
                    )
                )
            ...
            .addChild(Transform.new()
                .addChild(Shape.new()
                    ...
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setDEF("plastic")
                            .setDiffuseColor(to_java_float_array([0.941, 0.973, 1]))
                            .setTransparency(0.8)
                        )
                    )
                    .setGeometry(IndexedFaceSet.new()
                        .setCoordIndex(to_java_int_array([12, 13, 14, 15, 16, 17, 18, 12, -1]))
                        .setCreaseAngle(1.45)
                        .setSolid(false)
                        .setCoord(Coordinate.new()
                            .setPoint(to_java_float_array([0, 0.08, 0, 0.02, 0.05, 0, 0.05, 0.05, 0, 0.06, 0.06, 0, 0.06, 0.09, 0, 0.05, 0.1, 0, 0, 0.1, 0, -0.05, 0.1, 0, -0.06, 0.09, 0, -0.06, 0.06, 0, -0.05, 0.05, 0, -0.02, 0.05, 0, 0.005, 0.08, 0, 0.02, 0.055, 0, 0.05, 0.055, 0, 0.055, 0.06, 0, 0.055, 0.09, 0, 0.045, 0.095, 0, 0.005, 0.095, 0, -0.005, 0.08, 0, -0.02, 0.055, 0, -0.05, 0.055, 0, -0.055, 0.06, 0, -0.055, 0.09, 0, -0.045, 0.095, 0, -0.005, 0.095, 0]))
            ...
            .addChild(Transform.new()
                .addChild(Shape.new()
                    ...
                    .setGeometry(IndexedFaceSet.new()
                        .setCoordIndex(to_java_int_array([19, 20, 21, 22, 23, 24, 25, 19, -1]))
                        .setCreaseAngle(1.45)
                        .setSolid(false)
                        .setCoord(Coordinate.new()
                            .setPoint(to_java_float_array([0, 0.08, 0, 0.02, 0.05, 0, 0.05, 0.05, 0, 0.06, 0.06, 0, 0.06, 0.09, 0, 0.05, 0.1, 0, 0, 0.1, 0, -0.05, 0.1, 0, -0.06, 0.09, 0, -0.06, 0.06, 0, -0.05, 0.05, 0, -0.02, 0.05, 0, 0.005, 0.08, 0, 0.02, 0.055, 0, 0.05, 0.055, 0, 0.055, 0.06, 0, 0.055, 0.09, 0, 0.045, 0.095, 0, 0.005, 0.095, 0, -0.005, 0.08, 0, -0.02, 0.055, 0, -0.05, 0.055, 0, -0.055, 0.06, 0, -0.055, 0.09, 0, -0.045, 0.095, 0, -0.005, 0.095, 0]))
            ...
            .addChild(Transform.new()
                .addChild(Shape.new()
                    ...
                    .setGeometry(IndexedFaceSet.new()
                        .setCoordIndex(to_java_int_array([0, 37, 26, 0, -1, 0, 36, 26, 0, -1, 36, 37, 26, 36, -1, 0, 1, 37, 0, -1, 0, 11, 36, 0, -1]))
                        .setCreaseAngle(1.45)
                        .setSolid(false)
                        .setCoord(Coordinate.new()
            ...
            .addChild(Transform.new()
                .addChild(Shape.new()
                    ...
                    .setGeometry(IndexedFaceSet.new()
                        .setCoordIndex(to_java_int_array([1, 2, 27, 37, 1, -1, 2, 3, 28, 27, 2, -1, 3, 4, 29, 28, 3, -1, 4, 5, 30, 29, 4, -1, 5, 6, 31, 30, 5, -1, 6, 7, 32, 31, 6, -1, 7, 8, 33, 32, 7, -1, 8, 9, 34, 33, 8, -1, 9, 10, 35, 34, 9, -1, 10, 11, 36, 35, 10, -1]))
                        .setCreaseAngle(1.45)
                        .setSolid(false)
                        .setCoord(Coordinate.new()
            ...
            .addChild(Transform.new()
                .addChild(Shape.new()
                    ...
                    .setGeometry(IndexedFaceSet.new()
                        .setCoordIndex(to_java_int_array([3, 4, 39, 38, 3, -1, 8, 9, 40, 41, 8, -1, 38, 39, 42, 43, 38, -1, 40, 41, 44, 45, 40, -1, 42, 43, 47, 46, 42, -1, 44, 45, 47, 46, 44, -1]))
                        .setCreaseAngle(1.45)
                        .setSolid(false)
                        .setCoord(Coordinate.new()
...
x3D0.toFileX3D "../data/MaskAndSnorkel.new.truffleruby.x3d"
x3D0.toFileJSON "../data/MaskAndSnorkel.new.truffleruby.x3dj"

            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Group.new()
                    ...
                    .addChild(PositionInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([0, 0, 0, 0, -0.049999, 0, 0, -0.195, 0, 0, -0.439997, 0]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
              ...
              .addComments(CommentsBlock.new("no SACROILIAC_ANIMATOR"))
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, -1, 0, 0, 0.619393, -1, 0, 0, 1.069302, -1, 0, 0, 1.937315]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
                    ...
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, 1, 0, 0, 0.615228, 1, 0, 0, 0.984524, 1, 0, 0, 2.076941]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
                    ...
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, -1, 0, 0, 0.017453, -1, 0, 0, 0.069812, 1, 0, 0, 0.261799]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
              ...
              .addComments(CommentsBlock.new("no L_MIDTARSAL_ANIMATOR"))
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, 1, 0, 0, 0.523598, -1, 0, 0, 0.157079]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
                    ...
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, 1, 0, 0, 0.349065, 1, 0, 0, 1.023397, 0.999934, 0.008043, 0.008185, 1.727938]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
                    ...
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, -0.991692, -0.072372, 0.106338, 0.205053, -0.981083, -0.103267, 0.163741, 0.272231, -1, 0, 0, 0.349065]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
              ...
              .addComments(CommentsBlock.new("no R_MIDTARSAL_ANIMATOR"))
                    .addChild(OrientationInterpolator.new()
                        .setDEF("VL5_ANIMATOR")
                        .setKey(to_java_float_array([0, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, 1, 0, 0, 0.174533]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
              ...
              .addComments(CommentsBlock.new("no SKULLBASE_ANIMATOR"))
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, -1, 0, 0, 0.279252, -1, 0, 0, 0.506145, -1, 0, 0, 0.191986]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
                    ...
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, -1, 0, 0, 0.052359, -1, 0, 0, 0.296706, -1, 0, 0, 1.431169]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
              ...
              .addComments(CommentsBlock.new("no L_WRIST_ANIMATOR"))
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, -1, 0, 0, 0.104719, -1, 0, 0, 0.157079, 1, 0, 0, 0.314159]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
                    ...
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 0.3125, 0.625, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, -1, 0, 0, 0.837757, -1, 0, 0, 1.239183, -1, 0, 0, 1.500983]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
        ...
        .addChild(Anchor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["LOA1_KneelAnimation.x3d", "defines a prototype", "for animating a humanoid.", "Click this text to see", "InterchangableActorsViaDynamicRouting example."]))
...
x3D0.toFileX3D "../data/LOA1_KneelAnimation.new.truffleruby.x3d"
x3D0.toFileJSON "../data/LOA1_KneelAnimation.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setPosition(to_java_float_array([0, 40, 0]))
        )
        .addChild(Viewpoint.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setOrientation(to_java_float_array([0.8005, 0.5926, 0.0898, -0.3743]))
            .setPosition(to_java_float_array([-5, 5, 20]))
        )
        ...
        .addChild(ExternProtoDeclare.new()
            ...
            .setUrl(to_java_string_array(["ViewFrustumPrototype.x3d#ViewFrustum"]))
            .addField(field.new()
        ...
        .addComments(CommentsBlock.new("Example use"))
        .addChild(ProtoInstance.new()
            .setName("ViewFrustum")
            .addFieldValue(fieldValue.new()
                .setName("ViewpointNode")
            .addComments(CommentsBlock.new("prefer empty description to prevent entry in player's ViewpointList"))
                .addChild(Viewpoint.new()
        ...
        .addComments(CommentsBlock.new("Visualization assists"))
        .addChild(Inline.new()
            .setDEF("GridXZ")
            .setUrl(to_java_string_array(["GridXZ_20x20Fixed.x3d"]))
        )
        .addChild(Transform.new()
            .setScale(to_java_float_array([5, 5, 5]))
            .addChild(Inline.new()
                .setDEF("CoordinateAxes")
                .setUrl(to_java_string_array(["CoordinateAxes.x3d"]))
            )
        )
    )
x3D0.toFileX3D "../data/ViewFrustumExample.new.truffleruby.x3d"
x3D0.toFileJSON "../data/ViewFrustumExample.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Skin/JoeKick.x3d")
        )
        .addMeta(meta.new()
            .setName("generator")
    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            ...
            .addChild(HAnimHumanoid.new()
                ...
                .addSkeleton(HAnimJoint.new()
                    ...
                    .addChild(HAnimSegment.new()
                      ...
                      .addComments(CommentsBlock.new("removed: RGB lines showing XYZ axes"))
                                )
                            )
                        )
                    )
          ...
          .addComments(CommentsBlock.new("expected best practice: EXPORT AS='fileName' for clarity"))
            .addChild(EXPORT.new()
                .setAS("JoeKick")
                .setLocalDEF("Joe_Kick")
            )
        )
    )
x3D0.toFileX3D "../data/JoeKick.new.truffleruby.x3d"
x3D0.toFileJSON "../data/JoeKick.new.truffleruby.x3dj"

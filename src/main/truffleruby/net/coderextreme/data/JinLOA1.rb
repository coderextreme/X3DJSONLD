        ...
        .addChild(HAnimHumanoid.new()
            ...
            .setMetadata(MetadataSet.new()
                ...
                .addValue(MetadataString.new()
                    .setName("authorName")
                    .setValue(to_java_string_array(["Jin Hoon Lee and Min Joo Lee, Chul Hee Jung and Myeong Won Lee"]))
                )
                .addValue(MetadataString.new()
                    .setName("authorEmail")
                ...
                .addValue(MetadataFloat.new()
                    .setName("weight")
                    .setValue(to_java_float_array([50]))
                )
                .addValue(MetadataString.new()
                    .setName("humanoidVersion")
                    .setValue(to_java_string_array(["validation testing"]))
                )
            )
            .addSkeleton(HAnimJoint.new()
                ...
                .addChild(HAnimJoint.new()
                    .setName("vl5")
                    .setDEF("hanim_vl5")
                    .setCenter(to_java_float_array([0, 40.07, -0.8527]))
                    .addChild(HAnimSegment.new()
                        .setName("l5")
                        .setDEF("hanim_l5")
                        .addChild(Transform.new()
                            .setTranslation(to_java_float_array([0, 40.07, -0.8527]))
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
...
x3D0.toFileX3D "../data/JinLOA1.new.truffleruby.x3d"
x3D0.toFileJSON "../data/JinLOA1.new.truffleruby.x3dj"

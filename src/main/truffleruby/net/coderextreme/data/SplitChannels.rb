...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(NavigationInfo.new()
            .setType(to_java_string_array(["NONE"]))
        )
        .addChild(Background.new()
            .setSkyColor(to_java_float_array([0.2, 0.2, 0.21]))
        )
        .addChild(Viewpoint.new()
            .setOrientation(to_java_float_array([1, 0, 0, -0.5]))
            .setPosition(to_java_float_array([0, 500, 600]))
            .setRetainUserOffsets(true)
        )
        .addChild(Transform.new()
            .setDEF("PowerR")
            .setTranslation(to_java_float_array([100, 400, 400]))
            .addChild(Transform.new()
                .setRotation(to_java_float_array([1, 0, 0, -0.5]))
                .setTranslation(to_java_float_array([0, 40, 0]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setDEF("audio_emit")
                        .setMaterial(Material.new()
                            .setDiffuseColor(to_java_float_array([0, 1, 0]))
                            .setEmissiveColor(to_java_float_array([0.8, 0.8, 0.8]))
                            .setSpecularColor(to_java_float_array([0.01, 0.01, 0.01]))
                        )
                    )
                    .setGeometry(Box.new()
                        .setSize(to_java_float_array([10, 80, 0.01]))
                    )
                )
            )
            .addChild(Transform.new()
                .setRotation(to_java_float_array([1, 0, 0, -0.5]))
                .setTranslation(to_java_float_array([-2.7, 37, 0]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setDEF("audio_emit2")
                        .setMaterial(Material.new()
                        ...
                        .setTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["images/line.png", "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/images/line.png"]))
                        )
                    )
                    .setGeometry(Box.new()
                        .setSize(to_java_float_array([25, 83, 0.01]))
                    )
                )
            )
            .addChild(Transform.new()
                .setDEF("volumeRight")
                .setRotation(to_java_float_array([1, 0, 0, -0.5]))
                .setScale(to_java_float_array([10, 10, 10]))
                .setTranslation(to_java_float_array([0, -10, 0]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setAmbientIntensity(0.0933)
                            .setDiffuseColor(to_java_float_array([0.345, 0.345, 0.882]))
                            .setShininess(0.51)
                            .setSpecularColor(to_java_float_array([0.46, 0.46, 0.46]))
                        )
                    )
                    .setGeometry(Text.new()
                        .setString(to_java_string_array(["Right Channel Volume"]))
        ...
        .addChild(Transform.new()
            ...
            .addChild(Transform.new()
                .setRotation(to_java_float_array([1, 0, 0, -0.5]))
                .setTranslation(to_java_float_array([13.2, 37, 0]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setDEF("audio_emit4")
                        .setMaterial(Material.new()
            ...
            .addChild(Transform.new()
                ...
                .addChild(Shape.new()
                    ...
                    .setGeometry(Text.new()
                        .setString(to_java_string_array(["Left Channel Volume"]))
                        .setFontStyle(FontStyle.new()
            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    ...
                    .setMaterial(Material.new()
                        ...
                        .setShininess(0.8)
                        .setSpecularColor(to_java_float_array([0.5, 0.6, 0.7]))
                    )
                )
                .setGeometry(Box.new()
                    .setSize(to_java_float_array([1500, 10, 500]))
                )
            )
        )
        ...
        .addChild(ChannelSplitter.new()
            ...
            .addOutputs(AudioClip.new()
                .setDescription("Violin")
                .setUrl(to_java_string_array(["sound/violin.mp3", "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/violin.mp3"]))
            )
        )
        .addChild(Transform.new()
            .setDEF("Audio3")
            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setDEF("audio_emit5")
                    .setMaterial(Material.new()
                        .setDiffuseColor(to_java_float_array([0.3, 1, 0.3]))
                        .setEmissiveColor(to_java_float_array([0.8, 0.8, 0.8]))
                        .setSpecularColor(to_java_float_array([0.01, 0.01, 0.01]))
                    )
                    .setTexture(ImageTexture.new()
                        .setUrl(to_java_string_array(["images/loudspeaker.png", "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/images/loudspeaker.png"]))
                    )
                )
                .setGeometry(Box.new()
                    .setSize(to_java_float_array([100, 100, 0.001]))
                )
            )
        )
    )
x3D0.toFileX3D "../data/SplitChannels.new.truffleruby.x3d"
x3D0.toFileJSON "../data/SplitChannels.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addComments(CommentsBlock.new("Viewpoint position='0 0 4' description='sphere in road'/"))
        .addChild(Background.new()
            .setBackUrl(to_java_string_array(["../resources/images/bBK.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBK.png"]))
            .setBottomUrl(to_java_string_array(["../resources/images/bBT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBT.png"]))
            .setFrontUrl(to_java_string_array(["../resources/images/bFR.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bFR.png"]))
            .setLeftUrl(to_java_string_array(["../resources/images/bLF.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bLF.png"]))
            .setRightUrl(to_java_string_array(["../resources/images/bRT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bRT.png"]))
            .setTopUrl(to_java_string_array(["../resources/images/bTP.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bTP.png"]))
        )
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        ...
                        .setBackTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["../resources/images/bBK.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBK.png"]))
                        )
                        .setBottomTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["../resources/images/bBT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBT.png"]))
                        )
                        .setFrontTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["../resources/images/bFR.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bFR.png"]))
                        )
                        .setLeftTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["../resources/images/bLF.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bLF.png"]))
                        )
                        .setRightTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["../resources/images/bRT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bRT.png"]))
                        )
                        .setTopTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["../resources/images/bTP.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bTP.png"]))
                        )
                    )
...
x3D0.toFileX3D "../data/geo.new.truffleruby.x3d"
x3D0.toFileJSON "../data/geo.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/data/BoxEm2.x3d")
        )
        .addMeta(meta.new()
            .setName("description")
            .setContent("3 boxes")
        ...
        .addChild(ProtoInstance.new()
            ...
            .addFieldValue(fieldValue.new()
                ...
                .addChild(Shape.new()
                    .setDEF("box")
                    .setGeometry(Box.new()
                        .setSize(to_java_float_array([1, 1, 1]))
                    )
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
...
x3D0.toFileX3D "../data/BoxEm2.new.truffleruby.x3d"
x3D0.toFileJSON "../data/BoxEm2.new.truffleruby.x3dj"

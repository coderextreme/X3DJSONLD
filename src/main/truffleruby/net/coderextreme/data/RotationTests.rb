...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            .setDEF("Transform1")
            .setRotation(to_java_float_array([0.40671, -0.71645, -0.56683, 2.6753]))
          ...
          .addComments(CommentsBlock.new("RotationCalculator composed rotation: 0.0 0.0 1.0 -1.829527, 1.0 0.0 0.0 -4.400301, 0.0 1.0 0.0 -0.381611"))
            .addChild(Shape.new()
                .setDEF("BoxShape")
                .setGeometry(Box.new()
                    .setSize(to_java_float_array([0.5, 0.5, 0.5]))
                )
        ...
        .addChild(Transform.new()
            .setDEF("Transform2")
            .setRotation(to_java_float_array([-0.96458, 0.07774, 0.25206, 2.59674]))
        ...
        .addChild(Transform.new()
            .setDEF("Transform3")
            .setRotation(to_java_float_array([0.40758, -0.49149, -0.76962, 1.12862]))
            .setTranslation(to_java_float_array([3, 0, 0]))
...
x3D0.toFileX3D "../data/RotationTests.new.truffleruby.x3d"
x3D0.toFileJSON "../data/RotationTests.new.truffleruby.x3dj"

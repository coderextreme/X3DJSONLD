        ...
        .addChild(ProtoDeclare.new()
            ...
            .setProtoInterface(ProtoInterface.new()
                .addField(field.new()
                    ...
                    .setType("MFString")
                    .setValue("\"../shaders/gl_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/gl_flowers_chromatic.vs\"")
                )
                .addField(field.new()
                    .setName("fragment")
                    .setAccessType("inputOnly")
                    .setType("MFString")
                    .setValue("\"../shaders/pc_flowers.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_flowers.fs\"")
                )
            )
                    ...
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            ...
                            .addShaders(ComposedShader.new()
                                .setDEF("shader")
                                .setLanguage("GLSL")
                    .addComments(CommentsBlock.new("<field name='fw_textureCoordGenType' accessType='inputOnly' type='SFInt32' value='0'></field>"))
                                .addField(field.new()
                                    .setName("cube")
                                    .setType("SFNode")
                                    .setAccessType("inputOnly")
...
x3D0.toFileX3D "../data/flowerproto.new.truffleruby.x3d"
x3D0.toFileJSON "../data/flowerproto.new.truffleruby.x3dj"

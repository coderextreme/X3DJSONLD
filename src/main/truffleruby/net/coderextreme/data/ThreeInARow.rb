...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/data/ThreeInARow.x3d")
        )
        .addMeta(meta.new()
            .setName("description")
            .setContent("3 boxes")
...
x3D0.toFileX3D "../data/ThreeInARow.new.truffleruby.x3d"
x3D0.toFileJSON "../data/ThreeInARow.new.truffleruby.x3dj"

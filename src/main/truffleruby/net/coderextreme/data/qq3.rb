...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
                        ...
                        .addChild(Shape.new()
                            ...
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    .setDiffuseColor(to_java_float_array([0.7, 1, 0]))
                                )
                            )
                            .setGeometry(Extrusion.new()
                                .setSpine(to_java_float_array([-2.5, 0, 0, -2, 0, 0, -1.5, 0, 0]))
              ...
              .addComments(CommentsBlock.new("right"))
                    .addChild(Transform.new()
                        ...
                        .addChild(Shape.new()
                            ...
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    .setDiffuseColor(to_java_float_array([0, 0.7, 1]))
                                )
                            )
                            .setGeometry(Extrusion.new()
                                .setSpine(to_java_float_array([1.5, 0, 0, 2, 0, 0, 2.5, 0, 0]))
                                .setCreaseAngle(0.785)
                                .setCrossSection(to_java_float_array([1, 0, 0.92, -0.38, 0.71, -0.71, 0.38, -0.92, 0, -1, -0.38, -0.92, -0.71, -0.71, -0.92, -0.38, -1, 0, -0.92, 0.38, -0.71, 0.71, -0.38, 0.92, 0, 1, 0.38, 0.92, 0.71, 0.71, 0.92, 0.38, 1, 0]))
                            )
                        )
        ...
        .addChild(Viewpoint.new()
            ...
            .setPosition(to_java_float_array([0, 5, 12]))
        )
        .addChild(Transform.new()
...
x3D0.toFileX3D "../data/qq3.new.truffleruby.x3d"
x3D0.toFileJSON "../data/qq3.new.truffleruby.x3dj"

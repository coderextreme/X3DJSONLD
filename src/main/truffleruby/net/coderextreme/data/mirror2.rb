...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/data/mirror2.x3d")
        )
        .addMeta(meta.new()
            .setName("description")
    ...
    .setScene(Scene.new()
        .addChild(Viewpoint.new()
            .setPosition(to_java_float_array([0, 5, 100]))
            .setDescription("Switch background and images texture")
        )
        .addChild(Background.new()
            .setDEF("cube")
            .setLeftUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_left.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"]))
            .setRightUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_right.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"]))
            .setFrontUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_front.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"]))
            .setBackUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_back.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"]))
            .setTopUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_top.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"]))
            .setBottomUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_bottom.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"]))
        )
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        .setBackTexture(ImageTexture.new()
                            .setDEF("backShader")
                            .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_back.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"]))
                        )
                        .setBottomTexture(ImageTexture.new()
                            .setDEF("bottomShader")
                            .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_bottom.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"]))
                        )
                        .setFrontTexture(ImageTexture.new()
                            .setDEF("frontShader")
                            .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_front.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"]))
                        )
                        .setLeftTexture(ImageTexture.new()
                            .setDEF("leftShader")
                            .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_left.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"]))
                        )
                        .setRightTexture(ImageTexture.new()
                            .setDEF("rightShader")
                            .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_right.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"]))
                        )
                        .setTopTexture(ImageTexture.new()
                            .setDEF("topShader")
                            .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_top.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"]))
                        )
                    )
                    .addShaders(ComposedShader.new()
                        .setDEF("x_ite")
                        .setLanguage("GLSL")
                .addComments(CommentsBlock.new("http://hypertextbook.com/facts/2005/JustinChe.shtml"))
                        .addField(field.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["../shaders/x_ite.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs"]))
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["../shaders/x_itemix.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itemix.fs"]))
                            .setType("FRAGMENT")
                        )
                    )
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["../shaders/x3dom.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom.vs"]))
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["../shaders/mix.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/mix.fs"]))
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../data/mirror2.new.truffleruby.x3d"
x3D0.toFileJSON "../data/mirror2.new.truffleruby.x3dj"

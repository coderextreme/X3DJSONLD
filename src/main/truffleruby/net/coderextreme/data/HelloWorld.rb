...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(WorldInfo.new()
            .setInfo(to_java_string_array(["Example scene to illustrate a simple X3D model"]))
        ...
        .addChild(Group.new()
            .addChild(Viewpoint.new()
                ...
                .setPosition(to_java_float_array([0, -1, 7]))
            )
            .addChild(Transform.new()
                .setRotation(to_java_float_array([0, 1, 0, 3]))
                .addChild(Shape.new()
                    ...
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            ...
                            .setDiffuseColor(to_java_float_array([0.1, 0.5, 1]))
                        )
                        .setTexture(ImageTexture.new()
                            .setDEF("ImageCloudlessEarth")
                            .setUrl(to_java_string_array(["earth-topo.png", "earth-topo.jpg", "earth-topo-small.gif", "https://www.web3d.org/x3d/content/examples/Basic/earth-topo.png", "https://www.web3d.org/x3d/content/examples/Basic/earth-topo.jpg", "https://www.web3d.org/x3d/content/examples/Basic/earth-topo-small.gif"]))
                        )
                    )
                )
            )
            .addChild(Transform.new()
                ...
                .addChild(Shape.new()
                    .setGeometry(Text.new()
                        .setDEF("TextMessage")
                        .setString(to_java_string_array(["Hello", "world!"]))
...
x3D0.toFileX3D "../data/HelloWorld.new.truffleruby.x3d"
x3D0.toFileJSON "../data/HelloWorld.new.truffleruby.x3dj"

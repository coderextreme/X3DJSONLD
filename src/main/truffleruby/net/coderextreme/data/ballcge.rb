...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(NavigationInfo.new()
            .setAvatarSize(to_java_float_array([0.25, 1.60000002384186, 0.75]))
            .setType(to_java_string_array(["ANY", "EXAMINE", "FLY", "LOOKAT"]))
        )
        ...
        .addChild(Background.new()
            .setTopUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
            .setBackUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
            .setLeftUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
            .setFrontUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
            .setRightUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
            .setBottomUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
        )
            ...
            .addChild(Shape.new()
                ...
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor(to_java_float_array([0.699999988079071, 0.699999988079071, 0.699999988079071]))
                    ...
                    .addShaders(ComposedShader.new()
                        ...
                        .addField(field.new()
                            ...
                            .addChild(ComposedCubeMapTexture.new()
                                .setBackTexture(ImageTexture.new()
                                    .setUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
                                )
                                .setBottomTexture(ImageTexture.new()
                                    .setUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
                                )
                                .setFrontTexture(ImageTexture.new()
                                    .setUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
                                )
                                .setLeftTexture(ImageTexture.new()
                                    .setUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
                                )
                                .setRightTexture(ImageTexture.new()
                                    .setUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
                                )
                                .setTopTexture(ImageTexture.new()
                                    .setUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
                                )
                            )
                        )
                        .addField(field.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/shaders/castle.vs"]))
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setDEF("commonfs")
                            .setUrl(to_java_string_array(["file:/C:/Users/jcarl/X3DJSONLD/src/main/shaders/castle.fs"]))
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../data/ballcge.new.truffleruby.x3d"
x3D0.toFileJSON "../data/ballcge.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        .addMeta(meta.new()
            .setName("title")
            .setContent("GridXZ_20x20Fixed.x3d")
        )
        .addMeta(meta.new()
            .setName("creator")
            .setContent("MV4204 class")
        )
        .addMeta(meta.new()
            .setName("created")
            .setContent("3 September 2000")
        )
        .addMeta(meta.new()
            .setName("modified")
            .setContent("28 November 2019")
        )
        .addMeta(meta.new()
            .setName("reference")
            .setContent("GridXY_20x20Fixed.x3d")
        )
        .addMeta(meta.new()
            .setName("reference")
            .setContent("GridYZ_20x20Fixed.x3d")
        )
        .addMeta(meta.new()
            .setName("description")
            .setContent("Line grid authoring tool to enable precise visual measurement of objects in 3D space - fixed position. Oriented along XZ plane, size 20m by 20m, default block size 1m by 1m.")
        )
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/Savage/Tools/Authoring/GridXZ_20x20Fixed.x3d")
        )
        .addMeta(meta.new()
            .setName("generator")
    ...
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("GridXZ_20x20Fixed.x3d")
        )
        .addChild(Viewpoint.new()
            .setDescription("XZ horizontal grid, perpendicular to Y axis (seen from 0 10 25)")
            .setOrientation(to_java_float_array([1, 0, 0, -0.4]))
            .setPosition(to_java_float_array([0, 10, 25]))
        )
        .addChild(Transform.new()
            .setDEF("GridLocation")
            .addChild(Group.new()
                .addChild(Shape.new()
                    .setDEF("LinesAlignedAlongZ")
                    .setGeometry(IndexedLineSet.new()
                        .setColorIndex(to_java_int_array([1, 0, 0, 0, 0, 2, 0, 0, 0, 0, 1, 0, 0, 0, 0, 2, 0, 0, 0, 0, 1]))
                        .setColorPerVertex(false)
                        .setCoordIndex(to_java_int_array([1, 22, -1, 2, 23, -1, 3, 24, -1, 4, 25, -1, 5, 26, -1, 6, 27, -1, 7, 28, -1, 8, 29, -1, 9, 30, -1, 10, 31, -1, 11, 32, -1, 12, 33, -1, 13, 34, -1, 14, 35, -1, 15, 36, -1, 16, 37, -1, 17, 38, -1, 18, 39, -1, 19, 40, -1, 20, 41, -1, 21, 42, -1]))
                        .setCoord(Coordinate.new()
                            .setDEF("EndPoints")
                            .setPoint(to_java_float_array([0, 0, 0, -10, 0, 10, -9, 0, 10, -8, 0, 10, -7, 0, 10, -6, 0, 10, -5, 0, 10, -4, 0, 10, -3, 0, 10, -2, 0, 10, -1, 0, 10, 0, 0, 10, 1, 0, 10, 2, 0, 10, 3, 0, 10, 4, 0, 10, 5, 0, 10, 6, 0, 10, 7, 0, 10, 8, 0, 10, 9, 0, 10, 10, 0, 10, -10, 0, -10, -9, 0, -10, -8, 0, -10, -7, 0, -10, -6, 0, -10, -5, 0, -10, -4, 0, -10, -3, 0, -10, -2, 0, -10, -1, 0, -10, 0, 0, -10, 1, 0, -10, 2, 0, -10, 3, 0, -10, 4, 0, -10, 5, 0, -10, 6, 0, -10, 7, 0, -10, 8, 0, -10, 9, 0, -10, 10, 0, -10]))
                        )
                        .setColor(Color.new()
                            .setColor(to_java_float_array([0.4, 0.4, 0.4, 0.8, 0.2, 0, 0.4, 0.1, 0.05]))
                        )
                    )
                )
                .addChild(Transform.new()
                    .setDEF("LinesAlignedAlongX")
                    .setRotation(to_java_float_array([0, 1, 0, 1.57079]))
                    .addChild(Shape.new()
                        .setUSE("LinesAlignedAlongZ")
                    )
                )
                .addChild(Transform.new()
                    ...
                    .addChild(Billboard.new()
                        .addChild(Shape.new()
                            .setGeometry(Text.new()
                                .setDEF("CenterTextNode")
                                .setString(to_java_string_array(["origin"]))
                ...
                .addChild(Transform.new()
                    .setTranslation(to_java_float_array([10, -0.5, 10]))
                    .addChild(Billboard.new()
                        .addChild(Shape.new()
                            .setGeometry(Text.new()
                                .setString(to_java_string_array(["10 0 10"]))
                                .setFontStyle(FontStyle.new()
                                    .setUSE("FS4")
                                )
                            )
...
x3D0.toFileX3D "../data/GridXZ_20x20Fixed.new.truffleruby.x3d"
x3D0.toFileJSON "../data/GridXZ_20x20Fixed.new.truffleruby.x3dj"

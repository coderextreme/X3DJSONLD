...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            ...
            .setTranslation(to_java_float_array([-200, 50, 0]))
            .addChild(Shape.new()
        ...
        .addChild(Transform.new()
            .setDEF("AnimDataBoxM")
            .setTranslation(to_java_float_array([15, 100, 0]))
        )
        .addChild(Transform.new()
            .setDEF("AnimDataBoxL")
            .setTranslation(to_java_float_array([30, 100, 0]))
        )
        .addChild(Transform.new()
                            ...
                            .addChild(Analyser.new()
                                .addChild(BiquadFilter.new()
                                    ...
                                    .addChild(AudioClip.new()
                                        ...
                                        .setLoop(true)
                                        .setUrl(to_java_string_array(["sound/techno_beat.mp3", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/techno_beat.mp3"]))
                                    )
                                )
                            )
                        )
                            ...
                            .addChild(Analyser.new()
                                .addChild(BiquadFilter.new()
                                    ...
                                    .addChild(AudioClip.new()
                                        ...
                                        .setLoop(true)
                                        .setUrl(to_java_string_array(["sound/beat.mp3", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/beat.mp3"]))
                                    )
                                )
                            )
                        )
                            ...
                            .addChild(Analyser.new()
                                .addChild(BiquadFilter.new()
                                    ...
                                    .addChild(AudioClip.new()
                                        ...
                                        .setLoop(true)
                                        .setUrl(to_java_string_array(["sound/wobble_loop.mp3", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/wobble_loop.mp3"]))
                                    )
                                )
                            )
                        )
...
x3D0.toFileX3D "../data/Filters.new.truffleruby.x3d"
x3D0.toFileJSON "../data/Filters.new.truffleruby.x3dj"

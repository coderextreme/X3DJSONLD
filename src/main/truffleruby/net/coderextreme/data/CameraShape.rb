...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            ...
            .setTranslation(to_java_float_array([0, -0.165, 0.02]))
            .addChild(Switch.new()
                .setWhichChoice(-1)
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        ...
                        .setMaterial(Material.new()
                            ...
                            .setDiffuseColor(to_java_float_array([0.372322, 0.371574, 0.373173]))
                            .setShininess(0.02)
                            .setSpecularColor(to_java_float_array([0.890909, 0.887832, 0.890909]))
                ...
                .addChild(Shape.new()
                    .setGeometry(IndexedFaceSet.new()
                        ...
                        .setConvex(false)
                        .setCoordIndex(to_java_int_array([0, 1, 13, 12, -1, 1, 2, 14, 13, -1, 2, 3, 15, 14, -1, 3, 4, 16, 15, -1, 4, 5, 17, 16, -1, 5, 6, 18, 17, -1, 6, 7, 19, 18, -1, 7, 8, 20, 19, -1, 8, 9, 21, 20, -1, 9, 10, 22, 21, -1, 10, 11, 23, 22, -1, 11, 0, 12, 23, -1, 1, 0, 24, -1, 2, 1, 24, -1, 3, 2, 24, -1, 4, 3, 24, -1, 5, 4, 24, -1, 6, 5, 24, -1, 7, 6, 24, -1, 8, 7, 24, -1, 9, 8, 24, -1, 10, 9, 24, -1, 11, 10, 24, -1, 0, 11, 24, -1, 12, 13, 25, -1, 13, 14, 25, -1, 14, 15, 25, -1, 15, 16, 25, -1, 16, 17, 25, -1, 17, 18, 25, -1, 18, 19, 25, -1, 19, 20, 25, -1, 20, 21, 25, -1, 21, 22, 25, -1, 22, 23, 25, -1, 23, 12, 25, -1]))
                        .setCreaseAngle(0.7854)
                        .setCoord(Coordinate.new()
                            .setDEF("pCylinder1GeoPoints")
                            .setPoint(to_java_float_array([-0.36, -2.39, -0.26, -0.36, -1.77, -0.89, -0.36, 0, -1.7, -0.36, 0.85, -1.47, -0.36, 1.47, -0.85, -0.36, 1.7, 0, -0.36, 1.47, 0.85, -0.36, -0.07, 2.05, -0.36, -0.92, 2.28, -0.36, -1.77, 2.05, -0.36, -2.39, 1.43, -0.36, -2.62, 0.58, 0.36, -2.39, -0.26, 0.36, -1.77, -0.89, 0.36, 0, -1.7, 0.36, 0.85, -1.47, 0.36, 1.47, -0.85, 0.36, 1.7, 0, 0.36, 1.47, 0.85, 0.36, -0.07, 2.05, 0.36, -0.92, 2.28, 0.36, -1.77, 2.05, 0.36, -2.39, 1.43, 0.36, -2.62, 0.58, -0.36, -0.46, 0.31, 0.36, -0.46, 0.31]))
                        )
                    )
                    .setAppearance(Appearance.new()
            ...
            .addChild(Group.new()
                .addChild(Transform.new()
                    .setDEF("pCylinder1")
                    .setRotation(to_java_float_array([-1, 0, 0, 0.373518]))
                    .setTranslation(to_java_float_array([-0.038462, 3.596312, 3.297562]))
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setUSE("CameraAppearance")
                        )
                ...
                .addChild(Transform.new()
                    .setDEF("pCube1")
                    .setScale(to_java_float_array([1, 0.727134, 0.801457]))
                    .setTranslation(to_java_float_array([-0.030769, 1.738461, 1.4436]))
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setUSE("CameraAppearance")
                        )
                ...
                .addChild(Transform.new()
                    .setDEF("pPipe1")
                    .setScale(to_java_float_array([1, 1, 0.569444]))
                    .setTranslation(to_java_float_array([0.015385, 1.630769, -1.973274]))
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setUSE("CameraAppearance")
                        )
                ...
                .addChild(Transform.new()
                    .setDEF("pSphere1")
                    .setScale(to_java_float_array([1.1, 1.1, 0.1]))
                    .setTranslation(to_java_float_array([-0.015385, 1.628515, -2.569231]))
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setUSE("CameraAppearance")
                        )
...
x3D0.toFileX3D "../data/CameraShape.new.truffleruby.x3d"
x3D0.toFileJSON "../data/CameraShape.new.truffleruby.x3dj"

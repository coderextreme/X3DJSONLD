...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(NavigationInfo.new()
            .setAvatarSize(to_java_float_array([0.15, 1.53, 0.75]))
            .setSpeed(0.5)
            .setType(to_java_string_array(["EXAMINE"]))
        )
        .addChild(Transform.new()
            .setDEF("Floor")
            .setScale(to_java_float_array([1, 0.0125, 1]))
            .setTranslation(to_java_float_array([0, -0.0125, 0]))
            .addChild(Shape.new()
                .setGeometry(Box.new()
                )
...
x3D0.toFileX3D "../data/AllenBox.new.truffleruby.x3d"
x3D0.toFileJSON "../data/AllenBox.new.truffleruby.x3dj"

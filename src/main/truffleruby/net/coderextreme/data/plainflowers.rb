...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d")
        )
    )
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(to_java_string_array(["../data/flowerproto.x3d#FlowerProto"]))
                .addField(field.new()
                    .setName("vertex")
                    ...
                    .addChild(Group.new()
                        .addChild(ProtoInstance.new()
                            ...
                            .addFieldValue(fieldValue.new()
                                .setName("vertex")
                                .setValue("\"../shaders/gl_flowers_plain.vs\"")
                            )
                            .addFieldValue(fieldValue.new()
                                .setName("fragment")
                                .setValue("\"../shaders/plain.fs\"")
                            )
                        )
                    )
                )
...
x3D0.toFileX3D "../data/plainflowers.new.truffleruby.x3d"
x3D0.toFileJSON "../data/plainflowers.new.truffleruby.x3dj"

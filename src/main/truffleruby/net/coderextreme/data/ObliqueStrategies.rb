...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor(to_java_float_array([0.419608, 0.427451, 1]))
        )
        .addChild(Transform.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["Oblique Strategies", "(Over One Hundred Worthwhile Dilemmas)", "by Brian Eno and Peter Schmidt"]))
            ...
            .addChild(Transform.new()
                .setScale(to_java_float_array([10, 3, 1]))
                .addChild(Shape.new()
                    ...
                    .setGeometry(IndexedFaceSet.new()
                        ...
                        .setCoord(Coordinate.new()
                            .setPoint(to_java_float_array([1, 1, 0, 1, -1, 0, -1, -1, 0, -1, 1, 0]))
                        )
                    )
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setAmbientIntensity(0.245763)
                            .setDiffuseColor(to_java_float_array([0.34773, 0.090909, 0.005289]))
                            .setShininess(0.07)
                            .setSpecularColor(to_java_float_array([0.336735, 0.051091, 0.051091]))
                            .setTransparency(0.8)
                        )
                    )
                )
        ...
        .addChild(Script.new()
            .setDEF("TextScript")
            .setUrl(to_java_string_array(["ObliqueStrategiesScript.js", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategiesScript.js"]))
        ...
        .addChild(Transform.new()
            ...
            .addComments(CommentsBlock.new("%20 is space character used in uri/url encoding"))
                .setSource(AudioClip.new()
                    ...
                    .setUrl(to_java_string_array(["http://translate.google.com/translate_tts?tl=en&amp;q=Feed%20the%20recording%20back%20out%20of%20the%20medium", "translate_tts_mp3FileFormatNotSupported.wav", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/translate_tts_mp3FileFormatNotSupported.wav"]))
                )
            )
            .addChild(ROUTE.new()
        ...
        .addChild(Transform.new()
            .setScale(to_java_float_array([0.4, 0.4, 0.4]))
            .setTranslation(to_java_float_array([-3.2, 2.5, 0]))
            .addChild(TouchSensor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["previous"]))
                    .setFontStyle(FontStyle.new()
                        .setUSE("MessageFont")
                    )
                )
                .setAppearance(Appearance.new()
                    ...
                    .setMaterial(Material.new()
                        .setDiffuseColor(to_java_float_array([1, 0, 0.6]))
                    )
                )
            )
            .addChild(Transform.new()
                .setScale(to_java_float_array([2, 0.6, 1]))
                .addChild(Shape.new()
        ...
        .addChild(Transform.new()
            .setScale(to_java_float_array([0.4, 0.4, 0.4]))
            .setTranslation(to_java_float_array([3.5, 2.5, 0]))
            .addChild(TouchSensor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["next"]))
                    .setFontStyle(FontStyle.new()
                        .setUSE("MessageFont")
                    )
                )
            ...
            .addChild(Transform.new()
                .setScale(to_java_float_array([1.2, 0.6, 1]))
                .addChild(Shape.new()
        ...
        .addChild(Transform.new()
            .setScale(to_java_float_array([0.4, 0.4, 0.4]))
            .setTranslation(to_java_float_array([-3.3, -0.5, 0]))
            .addChild(TouchSensor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["random"]))
                    .setFontStyle(FontStyle.new()
                        .setUSE("MessageFont")
                    )
                )
            ...
            .addChild(Transform.new()
                .setScale(to_java_float_array([1.8, 0.6, 1]))
                .addChild(Shape.new()
                    .setUSE("TransparentClickSurface")
                )
            )
        ...
        .addChild(Transform.new()
            ...
            .addChild(Anchor.new()
                ...
                .setUrl(to_java_string_array(["http://translate.google.com/translate_tts?tl=en&amp;q=Overtly%20resist%20change"]))
                .addChild(ROUTE.new()
                    .setFromField("textToSpeechUrl")
                    .setFromNode("TextScript")
                    .setToField("url")
                ...
                .addChild(Shape.new()
                    .setGeometry(Text.new()
                        .setString(to_java_string_array(["speech"]))
                        .setFontStyle(FontStyle.new()
                            .setUSE("MessageFont")
                        )
                    )
...
x3D0.toFileX3D "../data/ObliqueStrategies.new.truffleruby.x3d"
x3D0.toFileJSON "../data/ObliqueStrategies.new.truffleruby.x3dj"

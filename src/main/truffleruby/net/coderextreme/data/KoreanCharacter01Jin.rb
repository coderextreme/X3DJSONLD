        ...
        .addChild(HAnimHumanoid.new()
          ...
          .addComments(CommentsBlock.new("original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'"))
            ...
            .addSkeleton(HAnimJoint.new()
                ...
                .setCenter(to_java_float_array([0, 35.799999, -0.7076]))
                .setContainerFieldOverride("skeleton")
                .addChild(HAnimSegment.new()
                    .setName("sacrum")
                    .setDEF("hanim_sacrum")
                    .addChild(Transform.new()
                        .setTranslation(to_java_float_array([0, 35.799999, -0.7076]))
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                ...
                                .setTexture(ImageTexture.new()
                                    ...
                                    .setUrl(to_java_string_array(["images/Jin.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Jin.png"]))
                                )
                            )
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .setCenter(to_java_float_array([0, 30.530001, -0.7076]))
                    .addChild(HAnimSegment.new()
                        .setName("pelvis")
                        .setDEF("hanim_pelvis")
                        .addChild(Transform.new()
                            .setTranslation(to_java_float_array([0, 30.530001, -0.7076]))
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([8.093, 40.380001, -0.2502]))
                            .addChild(HAnimSegment.new()
                                .setName("l_forearm")
                                .setDEF("hanim_l_forearm")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([8.093, 40.380001, -0.2502]))
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([7.808, 31.459999, -0.05849]))
                                .addChild(HAnimSegment.new()
                                    .setName("l_carpal")
                                    .setDEF("hanim_l_carpal")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([7.808, 31.459999, -0.05849]))
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
...
x3D0.toFileX3D "../data/KoreanCharacter01Jin.new.truffleruby.x3d"
x3D0.toFileJSON "../data/KoreanCharacter01Jin.new.truffleruby.x3dj"

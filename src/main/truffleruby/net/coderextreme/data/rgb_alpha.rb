    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(Transform.new()
                .setTranslation(to_java_float_array([6.14221, 0.0694613, -0.000999451]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        ...
                        .setTexture(PixelTexture.new()
                            ...
                            .setImage(to_java_int_array([2, 2, 4, -16776961, -65536, -65536, -16776961]))
                        )
                    )
                    .setGeometry(Box.new()
                    )
            ...
            .addChild(Transform.new()
                .setTranslation(to_java_float_array([-4.85443, 0.0694381, -0.00149918]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                        )
            ...
            .addChild(Transform.new()
                .setTranslation(to_java_float_array([-1.47341, 0.036672, -0.00175095]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                        )
            ...
            .addChild(Transform.new()
                .setTranslation(to_java_float_array([2.31094, 0.0694206, -0.00187683]))
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                        )
...
x3D0.toFileX3D "../data/rgb_alpha.new.truffleruby.x3d"
x3D0.toFileJSON "../data/rgb_alpha.new.truffleruby.x3dj"

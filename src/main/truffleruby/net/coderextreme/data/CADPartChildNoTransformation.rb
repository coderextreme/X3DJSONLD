...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor(to_java_float_array([0.9607843, 1, 0.9607843]))
        )
        .addChild(Viewpoint.new()
            .setDescription("Hello CAD bushing")
            .setOrientation(to_java_float_array([1, 0, 0, -0.321751]))
            .setPosition(to_java_float_array([0, 5, 15]))
        )
...
x3D0.toFileX3D "../data/CADPartChildNoTransformation.new.truffleruby.x3d"
x3D0.toFileJSON "../data/CADPartChildNoTransformation.new.truffleruby.x3dj"

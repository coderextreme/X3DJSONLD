            ...
            .addComments(CommentsBlock.new("Might consider putting a HAnimSegment here, but that doesn't help with re-use of this hand model"))
                        ...
                        .addChild(Shape.new()
                            ...
                            .setGeometry(IndexedLineSet.new()
                                ...
                                .setCoord(Coordinate.new()
                                    .setPoint(to_java_float_array([0, 0, 0, -0.1, 0.1, 0]))
                                )
                            )
                        )
                        .addChild(Shape.new()
                            ...
                            .setGeometry(IndexedLineSet.new()
                                ...
                                .setCoordIndex(to_java_int_array([0, 1]))
                                .setCoord(Coordinate.new()
                                    .setPoint(to_java_float_array([0, 0, 0, 0, 0.07, 0]))
                                )
                            )
                        )
                        .addChild(Shape.new()
              ...
              .addComments(CommentsBlock.new("MC1"))
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter(to_java_float_array([-0.14, 0.09, 0]))
                        .addChild(HAnimSegment.new()
                            .setName("r_trapezium")
                            .setDEF("hanim_r_trapezium")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([-0.14, 0.09, 0]))
                                .addChild(Shape.new()
                            ...
                            .addChild(Shape.new()
                                ...
                                .setGeometry(IndexedLineSet.new()
                                    ...
                                    .setCoordIndex(to_java_int_array([0, 1]))
                                    .setCoord(Coordinate.new()
                                        .setPoint(to_java_float_array([-0.1, 0.1, 0, -0.2, 0.15, 0]))
                                    )
                                )
                            )
                        )
                .addComments(CommentsBlock.new("thumb finger"))
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([-0.2, 0.15, 0]))
                            .addChild(HAnimSegment.new()
                                .setName("r_metacarpal_1")
                                .setDEF("hanim_r_metacarpal_1")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([-0.2, 0.15, 0]))
                                    .addChild(Shape.new()
                                ...
                                .addChild(Shape.new()
                                    ...
                                    .setGeometry(IndexedLineSet.new()
                                        ...
                                        .setCoordIndex(to_java_int_array([0, 1]))
                                        .setCoord(Coordinate.new()
                                            .setPoint(to_java_float_array([-0.2, 0.15, 0, -0.3, 0.3, 0]))
                                        )
                                    )
                                )
                            )
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([-0.3, 0.3, 0]))
                                .addChild(HAnimSegment.new()
                                    .setName("r_carpal_proximal_phalanx_1")
                                    .setDEF("hanim_r_carpal_proximal_phalanx_1")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([-0.3, 0.3, 0]))
                                        .addChild(Shape.new()
                                            .setUSE("HAnimJointShape")
                                        )
                                    )
                                    .addChild(Shape.new()
                                        ...
                                        .setGeometry(IndexedLineSet.new()
                                            ...
                                            .setCoordIndex(to_java_int_array([0, 1]))
                                            .setCoord(Coordinate.new()
                                                .setPoint(to_java_float_array([-0.3, 0.3, 0, -0.35, 0.4, 0]))
                                            )
                                        )
                                    )
                                )
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setCenter(to_java_float_array([-0.35, 0.4, 0]))
                                    .addChild(HAnimSegment.new()
                                        ...
                                        .addChild(Shape.new()
                                            ...
                                            .setGeometry(IndexedLineSet.new()
                                                ...
                                                .setCoordIndex(to_java_int_array([0, 1]))
                                                .setCoord(Coordinate.new()
                                                    .setPoint(to_java_float_array([-0.35, 0.4, 0, -0.36, 0.45, 0]))
                                                )
                                            )
                                        )
                                    )
              ...
              .addComments(CommentsBlock.new("MC2"))
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter(to_java_float_array([-0.07, 0.07, 0]))
                        .addChild(HAnimSegment.new()
                            .setName("r_trapezoid")
                            .setDEF("hanim_r_trapezoid")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([-0.07, 0.07, 0]))
                                .addChild(Shape.new()
                            ...
                            .addChild(Shape.new()
                                ...
                                .setGeometry(IndexedLineSet.new()
                                    ...
                                    .setCoordIndex(to_java_int_array([0, 1]))
                                    .setCoord(Coordinate.new()
                                        .setPoint(to_java_float_array([-0.1, 0.1, 0, -0.1, 0.2, 0]))
                                    )
                                )
                            )
                        )
                .addComments(CommentsBlock.new("index finger"))
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([-0.1, 0.2, 0]))
                            .addChild(HAnimSegment.new()
                                .setName("r_metacarpal_2")
                                .setDEF("hanim_r_metacarpal_2")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([-0.1, 0.2, 0]))
                                    .addChild(Shape.new()
                                        .setUSE("HAnimJointShape")
                                    )
                                )
                                .addChild(Shape.new()
                                    ...
                                    .setGeometry(IndexedLineSet.new()
                                        ...
                                        .setCoordIndex(to_java_int_array([0, 1]))
                                        .setCoord(Coordinate.new()
                                            .setPoint(to_java_float_array([-0.1, 0.2, 0, -0.15, 0.5, 0]))
                                        )
                                    )
                                )
                            )
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([-0.15, 0.5, 0]))
                                .addChild(HAnimSegment.new()
                                    .setName("r_carpal_proximal_phalanx_2")
                                    .setDEF("hanim_r_carpal_proximal_phalanx_2")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([-0.15, 0.5, 0]))
                                        .addChild(Shape.new()
                                            .setUSE("HAnimJointShape")
                                        )
                                    )
                                    .addChild(Shape.new()
                                        ...
                                        .setGeometry(IndexedLineSet.new()
                                            ...
                                            .setCoordIndex(to_java_int_array([0, 1]))
                                            .setCoord(Coordinate.new()
                                                .setPoint(to_java_float_array([-0.15, 0.5, 0, -0.2, 0.7, 0]))
                                            )
                                        )
                                    )
                                )
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setCenter(to_java_float_array([-0.2, 0.7, 0]))
                                    .addChild(HAnimSegment.new()
                                        .setName("r_carpal_middle_phalanx_2")
                                        .setDEF("hanim_r_carpal_middle_phalanx_2")
                                        .addChild(Transform.new()
                                            .setTranslation(to_java_float_array([-0.2, 0.7, 0]))
                                            .addChild(Shape.new()
                                                .setUSE("HAnimJointShape")
                                            )
                                        )
                                        .addChild(Shape.new()
                                            ...
                                            .setGeometry(IndexedLineSet.new()
                                                ...
                                                .setCoordIndex(to_java_int_array([0, 1]))
                                                .setCoord(Coordinate.new()
                                                    .setPoint(to_java_float_array([-0.2, 0.7, 0, -0.24, 0.87, 0]))
                                                )
                                            )
                                        )
                                    )
                                    .addChild(HAnimJoint.new()
                                        ...
                                        .setCenter(to_java_float_array([-0.24, 0.87, 0]))
                                        .addChild(HAnimSegment.new()
                                            ...
                                            .addChild(Shape.new()
                                                ...
                                                .setGeometry(IndexedLineSet.new()
                                                    ...
                                                    .setCoordIndex(to_java_int_array([0, 1]))
                                                    .setCoord(Coordinate.new()
                                                        .setPoint(to_java_float_array([-0.24, 0.87, 0, -0.26, 0.93, 0]))
                                                    )
                                                )
                                            )
                                        )
              ...
              .addComments(CommentsBlock.new("MC3"))
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter(to_java_float_array([0, 0.07, 0]))
                        .addChild(HAnimSegment.new()
                            .setName("r_capitate")
                            .setDEF("hanim_r_capitate")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([0, 0.07, 0]))
                                .addChild(Shape.new()
                                    .setUSE("HAnimNewJointShape")
                                )
                            )
                            .addChild(Shape.new()
                                ...
                                .setGeometry(IndexedLineSet.new()
                                    ...
                                    .setCoordIndex(to_java_int_array([0, 1]))
                                    .setCoord(Coordinate.new()
                                        .setPoint(to_java_float_array([0, 0.07, 0, 0, 0.2, 0]))
                                    )
                                )
                            )
                        )
                .addComments(CommentsBlock.new("Middle fingle"))
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([0, 0.2, 0]))
                            .addChild(HAnimSegment.new()
                                ...
                                .addChild(Shape.new()
                                    ...
                                    .setGeometry(IndexedLineSet.new()
                                        ...
                                        .setCoordIndex(to_java_int_array([0, 1]))
                                        .setCoord(Coordinate.new()
                                            .setPoint(to_java_float_array([0, 0.2, 0, -0.03, 0.5, 0]))
                                        )
                                    )
                                )
                            )
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([-0.03, 0.5, 0]))
                                .addChild(HAnimSegment.new()
                                    .setName("r_carpal_proximal_phalanx_3")
                                    .setDEF("hanim_r_carpal_proximal_phalanx_3")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([-0.03, 0.5, 0]))
                                        .addChild(Shape.new()
                                            .setUSE("HAnimJointShape")
                                        )
                                    )
                                    .addChild(Shape.new()
                                        ...
                                        .setGeometry(IndexedLineSet.new()
                                            ...
                                            .setCoordIndex(to_java_int_array([0, 1]))
                                            .setCoord(Coordinate.new()
                                                .setPoint(to_java_float_array([-0.03, 0.5, 0, -0.05, 0.75, 0]))
                                            )
                                        )
                                    )
                                )
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setCenter(to_java_float_array([-0.05, 0.75, 0]))
                                    .addChild(HAnimSegment.new()
                                        .setName("r_carpal_middle_phalanx_3")
                                        .setDEF("hanim_r_carpal_middle_phalanx_3")
                                        .addChild(Transform.new()
                                            .setTranslation(to_java_float_array([-0.05, 0.75, 0]))
                                            .addChild(Shape.new()
                                                .setUSE("HAnimJointShape")
                                            )
                                        )
                                        .addChild(Shape.new()
                                            ...
                                            .setGeometry(IndexedLineSet.new()
                                                ...
                                                .setCoordIndex(to_java_int_array([0, 1]))
                                                .setCoord(Coordinate.new()
                                                    .setPoint(to_java_float_array([-0.05, 0.75, 0, -0.08, 0.96, 0]))
                                                )
                                            )
                                        )
                                    )
                                    .addChild(HAnimJoint.new()
                                        ...
                                        .setCenter(to_java_float_array([-0.08, 0.96, 0]))
                                        .addChild(HAnimSegment.new()
                                            ...
                                            .addChild(Shape.new()
                                                ...
                                                .setGeometry(IndexedLineSet.new()
                                                    ...
                                                    .setCoordIndex(to_java_int_array([0, 1]))
                                                    .setCoord(Coordinate.new()
                                                        .setPoint(to_java_float_array([-0.08, 0.96, 0, -0.09, 1.05, 0]))
                                                    )
                                                )
                                            )
                                        )
              ...
              .addComments(CommentsBlock.new("MC4_5"))
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter(to_java_float_array([0.1, 0.1, 0]))
                        .addChild(HAnimSegment.new()
                            .setName("r_hamate")
                            .setDEF("hanim_r_hamate")
                            .addChild(Transform.new()
                                .setTranslation(to_java_float_array([0.1, 0.1, 0]))
                                .addChild(Shape.new()
                                    .setUSE("HAnimNewJointShape")
                                )
                            )
                            ...
                            .addChild(Shape.new()
                                ...
                                .setGeometry(IndexedLineSet.new()
                                    ...
                                    .setCoordIndex(to_java_int_array([0, 1]))
                                    .setCoord(Coordinate.new()
                                        .setPoint(to_java_float_array([0.1, 0.1, 0, 0.15, 0.17, 0]))
                                    )
                                )
                            )
                        )
                .addComments(CommentsBlock.new("ring finger"))
                        .addChild(HAnimJoint.new()
                            ...
                            .addChild(HAnimSegment.new()
                                ...
                                .addChild(Shape.new()
                                    ...
                                    .setGeometry(IndexedLineSet.new()
                                        ...
                                        .setCoordIndex(to_java_int_array([0, 1]))
                                        .setCoord(Coordinate.new()
                                            .setPoint(to_java_float_array([0.1, 0.2, 0, 0.1, 0.47, 0]))
                                        )
                                    )
                                )
                            )
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([0.1, 0.47, 0]))
                                .addChild(HAnimSegment.new()
                                    .setName("r_carpal_proximal_phalanx_4")
                                    .setDEF("hanim_r_carpal_proximal_phalanx_4")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([0.1, 0.47, 0]))
                                        .addChild(Shape.new()
                                            .setUSE("HAnimJointShape")
                                        )
                                    )
                                    .addChild(Shape.new()
                                        ...
                                        .setGeometry(IndexedLineSet.new()
                                            ...
                                            .setCoordIndex(to_java_int_array([0, 1]))
                                            .setCoord(Coordinate.new()
                                                .setPoint(to_java_float_array([0.1, 0.47, 0, 0.1, 0.7, 0]))
                                            )
                                        )
                                    )
                                )
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setCenter(to_java_float_array([0.1, 0.7, 0]))
                                    .addChild(HAnimSegment.new()
                                        .setName("r_carpal_middle_phalanx_4")
                                        .setDEF("hanim_r_carpal_middle_phalanx_4")
                                        .addChild(Transform.new()
                                            .setTranslation(to_java_float_array([0.1, 0.7, 0]))
                                            .addChild(Shape.new()
                                                .setUSE("HAnimJointShape")
                                            )
                                        )
                                        .addChild(Shape.new()
                                            ...
                                            .setGeometry(IndexedLineSet.new()
                                                ...
                                                .setCoordIndex(to_java_int_array([0, 1]))
                                                .setCoord(Coordinate.new()
                                                    .setPoint(to_java_float_array([0.1, 0.7, 0, 0.1, 0.93, 0]))
                                                )
                                            )
                                        )
                                    )
                                    .addChild(HAnimJoint.new()
                                        ...
                                        .setCenter(to_java_float_array([0.1, 0.93, 0]))
                                        .addChild(HAnimSegment.new()
                                            ...
                                            .addChild(Shape.new()
                                                ...
                                                .setGeometry(IndexedLineSet.new()
                                                    ...
                                                    .setCoordIndex(to_java_int_array([0, 1]))
                                                    .setCoord(Coordinate.new()
                                                        .setPoint(to_java_float_array([0.1, 0.93, 0, 0.1, 1, 0]))
                                                    )
                                                )
                                            )
                                        )
                ...
                .addComments(CommentsBlock.new("pinky finger"))
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter(to_java_float_array([0.15, 0.17, 0]))
                            .addChild(HAnimSegment.new()
                                .setName("r_metacarpal_5")
                                .setDEF("hanim_r_metacarpal_5")
                                .addChild(Transform.new()
                                    .setTranslation(to_java_float_array([0.15, 0.17, 0]))
                                    .addChild(Shape.new()
                                        .setUSE("HAnimJointShape")
                                    )
                                )
                                .addChild(Shape.new()
                                    ...
                                    .setGeometry(IndexedLineSet.new()
                                        ...
                                        .setCoordIndex(to_java_int_array([0, 1]))
                                        .setCoord(Coordinate.new()
                                            .setPoint(to_java_float_array([0.15, 0.17, 0, 0.2, 0.4, 0]))
                                        )
                                    )
                                )
                            )
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter(to_java_float_array([0.2, 0.4, 0]))
                                .addChild(HAnimSegment.new()
                                    .setName("r_carpal_proximal_phalanx_5")
                                    .setDEF("hanim_r_carpal_proximal_phalanx_5")
                                    .addChild(Transform.new()
                                        .setTranslation(to_java_float_array([0.2, 0.4, 0]))
                                        .addChild(Shape.new()
                                            .setUSE("HAnimJointShape")
                                        )
                                    )
                                    .addChild(Shape.new()
                                        ...
                                        .setGeometry(IndexedLineSet.new()
                                            ...
                                            .setCoordIndex(to_java_int_array([0, 1]))
                                            .setCoord(Coordinate.new()
                                                .setPoint(to_java_float_array([0.2, 0.4, 0, 0.23, 0.63, 0]))
                                            )
                                        )
                                    )
                                )
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setCenter(to_java_float_array([0.23, 0.63, 0]))
                                    .addChild(HAnimSegment.new()
                                        .setName("r_carpal_middle_phalanx_5")
                                        .setDEF("hanim_r_carpal_middle_phalanx_5")
                                        .addChild(Transform.new()
                                            .setTranslation(to_java_float_array([0.23, 0.63, 0]))
                                            .addChild(Shape.new()
                                                .setUSE("HAnimJointShape")
                                            )
                                        )
                                        .addChild(Shape.new()
                                            ...
                                            .setGeometry(IndexedLineSet.new()
                                                ...
                                                .setCoordIndex(to_java_int_array([0, 1]))
                                                .setCoord(Coordinate.new()
                                                    .setPoint(to_java_float_array([0.23, 0.63, 0, 0.25, 0.79, 0]))
                                                )
                                            )
                                        )
                                    )
                                    .addChild(HAnimJoint.new()
                                        ...
                                        .setCenter(to_java_float_array([0.25, 0.79, 0]))
                                        .addChild(HAnimSegment.new()
                                            ...
                                            .addChild(Shape.new()
                                                ...
                                                .setGeometry(IndexedLineSet.new()
                                                    ...
                                                    .setCoordIndex(to_java_int_array([0, 1]))
                                                    .setCoord(Coordinate.new()
                                                        .setPoint(to_java_float_array([0.25, 0.79, 0, 0.26, 0.85, 0]))
                                                    )
                                                )
                                            )
                                        )
...
x3D0.toFileX3D "../data/HAnimModelHandRight.new.truffleruby.x3d"
x3D0.toFileJSON "../data/HAnimModelHandRight.new.truffleruby.x3dj"

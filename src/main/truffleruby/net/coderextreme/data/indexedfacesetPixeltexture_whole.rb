        ...
        .addChild(Shape.new()
            ...
            .setGeometry(IndexedFaceSet.new()
                ...
                .setTexCoord(TextureCoordinate.new()
                    .setPoint(to_java_float_array([0, 1, 0, 0, 1, 1, 1, 0]))
                )
            )
        )
    )
x3D0.toFileX3D "../data/indexedfacesetPixeltexture_whole.new.truffleruby.x3d"
x3D0.toFileJSON "../data/indexedfacesetPixeltexture_whole.new.truffleruby.x3dj"

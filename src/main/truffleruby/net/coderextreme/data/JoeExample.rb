...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        .addChild(Script.new()
            ...
            .addField(field.new()
                .setName("combinationEntered")
                .setType("SFBool")
                .setAccessType("inputOnly")
            )
            .addField(field.new()
                .setName("vaultUnlocked")
                .setType("SFTime")
...
"      }")        )
        ...
        .addChild(Sound.new()
            ...
            .setSource(AudioClip.new()
                .setDEF("Click")
                .setStopTime(1.0)
                .setDescription("clicking sound")
                .setUrl(to_java_string_array(["../resources/chandubabamusic1.wav"]))
            )
        )
        ...
        .addChild(ROUTE.new()
            ...
            .setFromField("isOver")
            .setToNode("OpenVault")
            .setToField("combinationEntered")
        )
        .addChild(ROUTE.new()
            .setFromNode("TS")
            .setFromField("touchTime")
            .setToNode("OpenVault")
            .setToField("openVault")
        )
        .addChild(ROUTE.new()
            .setFromNode("OpenVault")
            .setFromField("vaultUnlocked")
            .setToNode("Click")
            .setToField("startTime")
        )
    )
x3D0.toFileX3D "../data/JoeExample.new.truffleruby.x3d"
x3D0.toFileJSON "../data/JoeExample.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor(to_java_float_array([0.6, 1, 0.8]))
        )
        .addChild(Shape.new()
            .setGeometry(Text.new()
                .setString(to_java_string_array(["One, Two, Three", "He said, \"Immel did it!\""]))
            ...
            .setAppearance(Appearance.new()
                .setMaterial(Material.new()
                    .setDiffuseColor(to_java_float_array([0.6, 0.4, 0.2]))
                )
            )
        )
    )
x3D0.toFileX3D "../data/StringArrayEncodingExamples.new.truffleruby.x3d"
x3D0.toFileJSON "../data/StringArrayEncodingExamples.new.truffleruby.x3dj"

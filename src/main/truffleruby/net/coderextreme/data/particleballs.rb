...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setBackUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
            .setBottomUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
            .setFrontUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
            .setLeftUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
            .setRightUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
            .setTopUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
        )
        .addChild(Transform.new()
            ...
            .addComments(CommentsBlock.new("<Shape>"))
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        ...
                        .setBackTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
                        )
                        .setBottomTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
                        )
                        .setFrontTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
                        )
                        .setLeftTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
                        )
                        .setRightTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
                        )
                        .setTopTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
                        )
                    )
              ...
              .addComments(CommentsBlock.new("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"'></ShaderPart>"))
              .addComments(CommentsBlock.new("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' type='FRAGMENT'></ShaderPart>"))
              ...
              .addComments(CommentsBlock.new("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/>"))
              .addComments(CommentsBlock.new("<ShaderPart type='FRAGMENT' url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/>"))
              .addComments(CommentsBlock.new("</ComposedShader>"))
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["../shaders/x_iteparticles.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_iteparticles.vs"]))
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setDEF("commonfs")
...
x3D0.toFileX3D "../data/particleballs.new.truffleruby.x3d"
x3D0.toFileJSON "../data/particleballs.new.truffleruby.x3dj"

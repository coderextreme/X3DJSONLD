                        ...
                        .addChild(Transform.new()
                            ...
                            .addChild(Shape.new()
                                ...
                                .setGeometry(Text.new()
                                    .setDEF("RightString")
                                    .setString(to_java_string_array(["r"]))
                                )
                            )
                        )
                    ...
                    .addChild(Transform.new()
                        ...
                        .addChild(Shape.new()
                            ...
                            .setGeometry(Extrusion.new()
                                .setCreaseAngle(0.785)
                                .setCrossSection(to_java_float_array([1, 0, 0.92, -0.38, 0.71, -0.71, 0.38, -0.92, 0, -1, -0.38, -0.92, -0.71, -0.71, -0.92, -0.38, -1, 0, -0.92, 0.38, -0.71, 0.71, -0.38, 0.92, 0, 1, 0.38, 0.92, 0.71, 0.71, 0.92, 0.38, 1, 0]))
                                .setSpine(to_java_float_array([0, 1.5, 0, 0, 2, 0, 0, 2.5, 0]))
                            )
                        )
                        .addChild(Transform.new()
                            .setTranslation(to_java_float_array([-0.5, 2, 0]))
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                ...
                                .setGeometry(Text.new()
                                    .setDEF("UpString")
                                    .setString(to_java_string_array(["u"]))
                                )
                            )
                        )
                        .addChild(StringSensor.new()
                    ...
                    .addChild(Transform.new()
                        ...
                        .addChild(Shape.new()
                            ...
                            .setGeometry(Extrusion.new()
                                .setCreaseAngle(0.785)
                                .setCrossSection(to_java_float_array([1, 0, 0.92, -0.38, 0.71, -0.71, 0.38, -0.92, 0, -1, -0.38, -0.92, -0.71, -0.71, -0.92, -0.38, -1, 0, -0.92, 0.38, -0.71, 0.71, -0.38, 0.92, 0, 1, 0.38, 0.92, 0.71, 0.71, 0.92, 0.38, 1, 0]))
                                .setSpine(to_java_float_array([0, -2.5, 0, 0, -2, 0, 0, -1.5, 0]))
                            )
                        )
              ...
              .addComments(CommentsBlock.new("center"))
                    .addChild(Transform.new()
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    .setDiffuseColor(to_java_float_array([1, 0, 0.7]))
                                )
                            )
...
x3D0.toFileX3D "../data/pp3.new.truffleruby.x3d"
x3D0.toFileJSON "../data/pp3.new.truffleruby.x3dj"

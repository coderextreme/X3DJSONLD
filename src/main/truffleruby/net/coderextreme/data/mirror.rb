    ...
    .setScene(Scene.new()
        ...
        .addChild(TextureBackground.new()
            .setLeftTexture(ImageTexture.new()
                ...
                .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_left.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"]))
            )
            .setRightTexture(ImageTexture.new()
                .setDEF("rightBackgroundTexture")
                .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_right.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"]))
            )
            .setFrontTexture(ImageTexture.new()
                .setDEF("frontBackgroundTexture")
                .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_front.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"]))
            )
            .setBackTexture(ImageTexture.new()
                .setDEF("backBackgroundTexture")
                .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_back.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"]))
            )
            .setTopTexture(ImageTexture.new()
                .setDEF("topBackgroundTexture")
                .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_top.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"]))
            )
            .setBottomTexture(ImageTexture.new()
                .setDEF("bottomBackgroundTexture")
                .setUrl(to_java_string_array(["../resources/images/all_probes/beach_cross/beach_bottom.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"]))
            )
        )
...
x3D0.toFileX3D "../data/mirror.new.truffleruby.x3d"
x3D0.toFileJSON "../data/mirror.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        .addMeta(meta.new()
            .setName("title")
            .setContent("LOA1_StopAnimation.x3d")
        )
        .addMeta(meta.new()
            .setName("description")
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/LOA1_StopAnimation.x3d")
        )
        .addMeta(meta.new()
            .setName("generator")
    ...
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("LOA1_StopAnimation.x3d")
        )
        .addChild(ProtoDeclare.new()
            .setName("LOA1_StopAnimation")
            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Group.new()
                    ...
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKey(to_java_float_array([0, 1]))
                        .setKeyValue(to_java_float_array([1, 0, 0, 0, 1, 0, 0, 0]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
        ...
        .addChild(Anchor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["LOA1_StopAnimation.x3d", "defines a prototype", "for animating a humanoid.", "Click this text to see", "InterchangableActorsViaDynamicRouting example."]))
...
x3D0.toFileX3D "../data/LOA1_StopAnimation.new.truffleruby.x3d"
x3D0.toFileJSON "../data/LOA1_StopAnimation.new.truffleruby.x3dj"

        ...
        .addChild(Shape.new()
            ...
            .setGeometry(IndexedFaceSet.new()
                ...
                .setTexCoord(TextureCoordinate.new()
                    .setPoint(to_java_float_array([-1, 2, -1, -1, 2, 2, 2, -1]))
                )
            )
        )
    )
x3D0.toFileX3D "../data/indexedfacesetPixeltexture_plus.new.truffleruby.x3d"
x3D0.toFileJSON "../data/indexedfacesetPixeltexture_plus.new.truffleruby.x3dj"

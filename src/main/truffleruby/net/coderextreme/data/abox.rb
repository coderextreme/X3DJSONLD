...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/data/abox.x3d")
        )
        .addMeta(meta.new()
            .setName("description")
            .setContent("a box")
    ...
    .setScene(Scene.new()
        ...
        .addChild(ProtoInstance.new()
            ...
            .addFieldValue(fieldValue.new()
                ...
                .addChild(Shape.new()
                    .setGeometry(Box.new()
                        .setSize(to_java_float_array([140, 140, 140]))
                    )
                )
            )
        )
    )
x3D0.toFileX3D "../data/abox.new.truffleruby.x3d"
x3D0.toFileJSON "../data/abox.new.truffleruby.x3dj"

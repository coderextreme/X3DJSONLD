...
"}")            )
            ...
            .addChild(ROUTE.new()
                ...
                .setToNode("DECLBubble_transformA")
...
"}")            )
            ...
            .addChild(ROUTE.new()
                ...
                .setFromField("translation_changed")
                .setToNode("DECLBubble_transformB")
                .setToField("set_translation")
            )
            .addChild(ROUTE.new()
                .setFromNode("DECLBubble_bubbleB_bounce")
...
"}")            )
            ...
            .addChild(ROUTE.new()
                ...
                .setFromField("translation_changed")
                .setToNode("DECLBubble_transformC")
                .setToField("set_translation")
            )
            .addChild(ROUTE.new()
                .setFromNode("DECLBubble_bubbleC_bounce")
...
"}")            )
            ...
            .addChild(ROUTE.new()
                ...
                .setFromField("translation_changed")
                .setToNode("DECLBubble_transformD")
                .setToField("set_translation")
            )
            .addChild(ROUTE.new()
                .setFromNode("DECLBubble_bubbleD_bounce")
...
x3D0.toFileX3D "../data/bubs3.new.truffleruby.x3d"
x3D0.toFileJSON "../data/bubs3.new.truffleruby.x3dj"

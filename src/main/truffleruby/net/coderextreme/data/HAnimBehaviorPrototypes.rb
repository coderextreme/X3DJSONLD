        ...
        .addChild(ProtoDeclare.new()
            ...
            .addComments(CommentsBlock.new("note that other nodes following the first node in the ProtoBody are not rendered but remain active nevertheless"))
                ...
                .addChild(Script.new()
                    ...
                    .setUrl(to_java_string_array(["HAnimBehaviorPrototypesScript.js", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/HAnimBehaviorPrototypesScript.js"]))
                    .addField(field.new()
                        .setName("HumanoidArray")
                        .setAccessType("initializeOnly")
                        .setAppinfo("[HAnimHumanoid] nodes only")
...
x3D0.toFileX3D "../data/HAnimBehaviorPrototypes.new.truffleruby.x3d"
x3D0.toFileJSON "../data/HAnimBehaviorPrototypes.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyAngle(to_java_float_array([1.57]))
            .setSkyColor(to_java_float_array([0.15, 0.25, 0.8, 0.9, 0.9, 0.9]))
        )
        .addChild(Viewpoint.new()
            .setDescription("Initial Camera")
            .setPosition(to_java_float_array([-70, 15, -25]))
            .setOrientation(to_java_float_array([0.147, 0.989, 0.005, -1.82]))
            .setFieldOfView(0.349)
        )
        .addChild(DirectionalLight.new()
            .setDirection(to_java_float_array([-0.5, -1, -0.5]))
            .setIntensity(2.0)
        )
        .addComments(CommentsBlock.new("Static objects"))
        .addChild(Transform.new()
            .setTranslation(to_java_float_array([0, -1000, -1]))
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(PhysicalMaterial.new()
                        .setBaseColor(to_java_float_array([0.5, 0.5, 0.5]))
                    )
                )
        ...
        .addChild(Transform.new()
            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(PhysicalMaterial.new()
                        .setBaseColor(to_java_float_array([0.9, 0.9, 0.9]))
        ...
        .addChild(Transform.new()
            .setTranslation(to_java_float_array([-4, 1, 0]))
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(PhysicalMaterial.new()
                        .setBaseColor(to_java_float_array([1, 0.95, 0.9]))
        ...
        .addChild(Transform.new()
            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(PhysicalMaterial.new()
                        .setBaseColor(to_java_float_array([0.7, 0.6, 0.5]))
                        .setRoughness(0.1)
                    )
                )
                .setGeometry(Sphere.new()
        ...
        .addChild(Transform.new()
            .setDEF("T_0")
            .setTranslation(to_java_float_array([-10.871, 0.2, -10.453]))
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(PhysicalMaterial.new()
                        .setDEF("M_0")
                        .setBaseColor(to_java_float_array([0.627, 0.003, 0.165]))
                    )
                )
                .setGeometry(Sphere.new()
                    .setRadius(0.2)
        ...
        .addChild(PositionInterpolator.new()
            ...
            .setKeyValue(to_java_float_array([-10.871, 0.2, -10.453, -10.871, 0.6, -10.453, -10.871, 0.2, -10.453]))
        )
        .addChild(ColorInterpolator.new()
            .setDEF("CI_0")
            .setKey(to_java_float_array([0, 0.5, 1]))
            .setKeyValue(to_java_float_array([0.627, 0.003, 0.165, 0.011, 0.583, 0.443, 0.627, 0.003, 0.165]))
        )
        .addChild(ScalarInterpolator.new()
            .setDEF("SI_0")
            .setKey(to_java_float_array([0, 0.5, 1]))
            .setKeyValue(to_java_float_array([1, 0.4, 1]))
        )
        .addChild(Script.new()
            .setDEF("Animator_0")
            .addField(field.new()
...
"        }")        )
        ...
        .addChild(Transform.new()
            .setDEF("T_1")
            .setTranslation(to_java_float_array([-10.411, 0.2, -9.16]))
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(PhysicalMaterial.new()
                        .setDEF("M_1")
                        .setBaseColor(to_java_float_array([0.707, 0.888, 0.536]))
                        .setRoughness(0.2)
                    )
                )
                .setGeometry(Sphere.new()
        ...
        .addChild(PositionInterpolator.new()
            .setDEF("PI_1")
            .setKey(to_java_float_array([0, 0.5, 1]))
            .setKeyValue(to_java_float_array([-10.411, 0.2, -9.16, -10.411, 0.6, -9.16, -10.411, 0.2, -9.16]))
        )
        .addChild(ScalarInterpolator.new()
            .setDEF("SI_1")
            .setKey(to_java_float_array([0, 0.5, 1]))
            .setKeyValue(to_java_float_array([0.5, 0, 0.5]))
        )
        .addChild(Script.new()
            .setDEF("Animator_1")
            .addField(field.new()
...
"        }")        )
        ...
        .addChild(Transform.new()
            .setDEF("T_2")
            .setTranslation(to_java_float_array([-10.155, 0.2, -8.324]))
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(PhysicalMaterial.new()
        ...
        .addChild(PositionInterpolator.new()
            .setDEF("PI_2")
            .setKey(to_java_float_array([0, 0.5, 1]))
            .setKeyValue(to_java_float_array([-10.155, 0.2, -8.324, -10.155, 0.6, -8.324, -10.155, 0.2, -8.324]))
        )
        .addChild(ScalarInterpolator.new()
            .setDEF("SI_2")
            .setKey(to_java_float_array([0, 0.5, 1]))
            .setKeyValue(to_java_float_array([1.4, 1.7, 1.4]))
        )
        .addChild(ROUTE.new()
            .setFromNode("C_2")
            .setFromField("fraction_changed")
        ...
        .addChild(Transform.new()
            .setDEF("T_3")
            .setTranslation(to_java_float_array([-10.518, 0.2, -7.283]))
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(PhysicalMaterial.new()
                        .setTransmissionFactor("0.95")
        ...
        .addChild(PositionInterpolator.new()
            .setDEF("PI_3")
            .setKey(to_java_float_array([0, 0.5, 1]))
            .setKeyValue(to_java_float_array([-10.518, 0.2, -7.283, -10.518, 0.6, -7.283, -10.518, 0.2, -7.283]))
        )
        .addChild(ScalarInterpolator.new()
            .setDEF("SI_3")
            .setKey(to_java_float_array([0, 0.5, 1]))
            .setKeyValue(to_java_float_array([100, 700, 100]))
        )
        .addChild(ROUTE.new()
            .setFromNode("C_3")
            .setFromField("fraction_changed")
...
x3D0.toFileX3D "../data/bobblespheres.new.truffleruby.x3d"
x3D0.toFileJSON "../data/bobblespheres.new.truffleruby.x3dj"

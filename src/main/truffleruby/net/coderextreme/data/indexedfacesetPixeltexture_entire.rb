...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_entire.x3d")
        )
        .addMeta(meta.new()
            .setName("generator")
        ...
        .addChild(Shape.new()
            ...
            .setGeometry(IndexedFaceSet.new()
                ...
                .setCoord(Coordinate.new()
                    .setPoint(to_java_float_array([-2, 1.5, 1, -2, -1.5, 1, 2, 1.5, 1, 2, -1.5, 1, 2, 1.5, -1, 2, -1.5, -1, -2, 1.5, -1, -2, -1.5, -1]))
                )
            )
        )
    )
x3D0.toFileX3D "../data/indexedfacesetPixeltexture_entire.new.truffleruby.x3d"
x3D0.toFileJSON "../data/indexedfacesetPixeltexture_entire.new.truffleruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            .setPosition(to_java_float_array([0, 0, 20]))
                ...
                .addChild(Transform.new()
                  ...
                  .addComments(CommentsBlock.new("</ComposedShader>"))
                            .addShaders(ComposedShader.new()
                                ...
                                .addParts(ShaderPart.new()
                                    .setUrl(to_java_string_array(["../shaders/pc_bubbles.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_bubbles.fs"]))
                                    .setType("FRAGMENT")
                                )
                            )
                            .addShaders(ComposedShader.new()
                                ...
                                .addParts(ShaderPart.new()
                                    .setUrl(to_java_string_array(["../shaders/x_itebubbles.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs"]))
                                    .setType("FRAGMENT")
                                )
                            )
                        )
...
x3D0.toFileX3D "../data/bub.new.truffleruby.x3d"
x3D0.toFileJSON "../data/bub.new.truffleruby.x3dj"

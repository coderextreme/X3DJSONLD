...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setCenter(to_java_float_array([7.808, 31.46, -0.0585]))
                                    .addChild(HAnimSegment.new()
                                        .setName("l_carpal")
                                        .setDEF("hanim_l_carpal")
                                        .addChild(Transform.new()
                                            .setTranslation(to_java_float_array([7.808, 31.46, -0.0585]))
                                            .addChild(Shape.new()
                                                .setAppearance(Appearance.new()
                                                    .setMaterial(Material.new()
                                                        .setDiffuseColor(to_java_float_array([0.588, 0.588, 0.588]))
        ...
        .addChild(RigidBodyCollection.new()
            ...
            .setCollider(CollisionCollection.new()
                .setAppliedParameters(to_java_string_array(["FRICTION_COEFFICIENT_1", "SLIP_COEFFICIENTS"]))
            )
            .addBodies(RigidBody.new()
                .setDEF("sphere_rb")
                .setMass(0.0)
                .addGeometry(CollidableShape.new()
                    .setDEF("sphere_cs")
                    .setShape(Shape.new()
                        .setDEF("box")
                        .setAppearance(Appearance.new()
                            .setMaterial(Material.new()
                                .setDiffuseColor(to_java_float_array([0.5, 0.5, 0.5]))
                            )
                        )
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([-7.808, 31.46, -0.0585]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([-8.093, 40.38, -0.2502]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([-5.975, 52, -0.1452]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([0, 57.43, -0.6863]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([-3.854, 3.64, 0.7402]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([-3.854, 3.939, -0.7038]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([-4.116, 17.26, -0.8639]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([-4.207, 32.02, -0.8155]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                .setDEF("hanim_vl5_rb")
                .setPosition(to_java_float_array([0, 40.07, -0.8527]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
                    .setDEF("hanim_l5_cs")
                    .setShape(Shape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([0, 35.8, -0.7076]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition(to_java_float_array([0, 30.53, -0.7076]))
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([0, 35.8, -0.7076]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
                    .setUSE("hanim_humanoid_root_rb")
                )
                .setBody2(RigidBody.new()
                    .setUSE("hanim_sacroiliac_rb")
                )
            )
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([4.207, 32.02, -0.8155]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([4.116, 17.26, -0.8639]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([3.854, 3.939, -0.7038]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([3.854, 3.64, 0.7402]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([0, 40.07, -0.8527]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([0, 57.43, -0.6863]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([5.975, 52, -0.1452]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([8.093, 40.38, -0.2502]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint(to_java_float_array([7.808, 31.46, -0.0585]))
                .setAxis(to_java_float_array([0, 0, 1]))
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
...
x3D0.toFileX3D "../data/JinLOA1RigidBody.new.truffleruby.x3d"
x3D0.toFileJSON "../data/JinLOA1RigidBody.new.truffleruby.x3dj"

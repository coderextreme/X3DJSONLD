...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setPosition(to_java_float_array([0, 0, 50]))
        )
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(to_java_string_array(["../data/flowerprotofreewrl.x3d#FlowerProto", "https://coderextreme.net/X3DJSONLD/src/main/data/flowerprotofreewrl.x3d#FlowerProto"]))
                .addField(field.new()
                    .setName("vertex")
...
x3D0.toFileX3D "../data/freewrlflowers.new.truffleruby.x3d"
x3D0.toFileJSON "../data/freewrlflowers.new.truffleruby.x3dj"

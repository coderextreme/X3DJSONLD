...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        .addMeta(meta.new()
            .setName("converter")
            .setContent("x3d-tidy V1.0.56, https://www.npmjs.com/package/x3d-tidy")
        )
        .addMeta(meta.new()
            .setName("converted")
            .setContent("Mon, 31 Jul 2023 03:48:04 GMT")
        )
    )
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(Group.new()
                ...
                .addChild(Transform.new()
                    ...
                    .addChild(Shape.new()
                        .setDEF("ARROW_POINTER")
                        .setAppearance(Appearance.new()
                            .setUSE("ARROW_APPEARANCE")
                        )
                ...
                .addChild(Transform.new()
                    .setTranslation(to_java_float_array([0, -1, 0]))
                    .setRotation(to_java_float_array([1, 0, 0, 3.1416]))
                    .addChild(Shape.new()
                        .setUSE("ARROW_POINTER")
                    )
                )
            )
            .addChild(Transform.new()
                .setTranslation(to_java_float_array([0, 1.08, 0]))
                .addChild(Billboard.new()
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setDEF("LABEL_APPEARANCE")
                            .setMaterial(Material.new()
                                .setDiffuseColor(to_java_float_array([1, 1, 0.3]))
                                .setEmissiveColor(to_java_float_array([0.33, 0.33, 0.1]))
                            )
                        )
                        .setGeometry(Text.new()
                            .setString(to_java_string_array(["Y"]))
                            .setFontStyle(FontStyle.new()
                                .setDEF("LABEL_FONT")
                                .setFamily(to_java_string_array(["SANS"]))
                                .setSize(0.2)
                                .setJustify(to_java_string_array(["MIDDLE"]))
                            )
                        )
                    )
                )
        ...
        .addChild(Transform.new()
            .setRotation(to_java_float_array([0, 0, 1, -1.5708]))
            .addChild(Group.new()
                .addChild(Group.new()
                    .setUSE("ARROW")
                )
                .addChild(Transform.new()
                    .setTranslation(to_java_float_array([0.072, 1.1, 0]))
                    .setRotation(to_java_float_array([0, 0, 1, 1.5708]))
                    .addChild(Billboard.new()
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                            ...
                            .setGeometry(Text.new()
                                .setString(to_java_string_array(["X"]))
                                .setFontStyle(FontStyle.new()
                                    .setUSE("LABEL_FONT")
                                )
                            )
        ...
        .addChild(Transform.new()
            .setRotation(to_java_float_array([1, 0, 0, 1.5708]))
            .addChild(Group.new()
                .addChild(Group.new()
                    .setUSE("ARROW")
                )
                .addChild(Transform.new()
                    .setTranslation(to_java_float_array([0, 1.1, 0.072]))
                    .setRotation(to_java_float_array([1, 0, 0, -1.5708]))
                    .addChild(Billboard.new()
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                            ...
                            .setGeometry(Text.new()
                                .setString(to_java_string_array(["Z"]))
                                .setFontStyle(FontStyle.new()
                                    .setUSE("LABEL_FONT")
                                )
                            )
...
x3D0.toFileX3D "../data/JointCoordinateAxes.new.truffleruby.x3d"
x3D0.toFileJSON "../data/JointCoordinateAxes.new.truffleruby.x3dj"

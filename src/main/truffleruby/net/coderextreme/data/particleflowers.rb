...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setBackUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png", "../resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
            .setBottomUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png", "../resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
            .setFrontUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png", "../resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
            .setLeftUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png", "../resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
            .setRightUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png", "../resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
            .setTopUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png", "../resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
        )
        .addChild(Group.new()
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        ...
                        .setBackTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png", "../resources/images/all_probes/stpeters_cross/stpeters_back.png"]))
                        )
                        .setBottomTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png", "../resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))
                        )
                        .setFrontTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png", "../resources/images/all_probes/stpeters_cross/stpeters_front.png"]))
                        )
                        .setLeftTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png", "../resources/images/all_probes/stpeters_cross/stpeters_left.png"]))
                        )
                        .setRightTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png", "../resources/images/all_probes/stpeters_cross/stpeters_right.png"]))
                        )
                        .setTopTexture(ImageTexture.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png", "../resources/images/all_probes/stpeters_cross/stpeters_top.png"]))
                        )
                    )
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flower_particles.vs", "../shaders/x_ite_flower_particles.vs"]))
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/commonnew.fs", "../shaders/commonnew.fs"]))
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../data/particleflowers.new.truffleruby.x3d"
x3D0.toFileJSON "../data/particleflowers.new.truffleruby.x3dj"

        ...
        .addChild(Transform.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["Compare special character escaping"]))
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setMaterial(Material.new()
                        .setDiffuseColor(to_java_float_array([0.1, 0.7, 0.7]))
                    )
                )
            )
        )
        .addChild(Transform.new()
            .setTranslation(to_java_float_array([-3, 0, 0]))
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["I don't think so", "he said \"Hi\""]))
                    .setFontStyle(FontStyle.new()
...
x3D0.toFileX3D "../data/TextExamples.new.truffleruby.x3d"
x3D0.toFileJSON "../data/TextExamples.new.truffleruby.x3dj"

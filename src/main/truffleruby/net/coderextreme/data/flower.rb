...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            .setTranslation(to_java_float_array([0, -1, 1]))
            .setRotation(to_java_float_array([0, 1, 0, 3.1415926]))
            .setScale(to_java_float_array([1.5, 1.5, 1.5]))
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setTransparency(0.1)
                        .setDiffuseColor(to_java_float_array([0.9, 0.3, 0.3]))
                        .setSpecularColor(to_java_float_array([0.8, 0.8, 0.8]))
                        .setShininess(0.145)
                    )
                )
...
x3D0.toFileX3D "../data/flower.new.truffleruby.x3d"
x3D0.toFileJSON "../data/flower.new.truffleruby.x3dj"

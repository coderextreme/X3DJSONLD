                    ...
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setMaterial(Material.new()
                                .setDiffuseColor(to_java_float_array([0.5, 0.5, 0.9]))
                            )
            ...
            .setMetadata(MetadataSet.new()
                ...
                .addValue(MetadataSet.new()
                    ...
                    .addValue(MetadataString.new()
                        ...
                        .setDEF("type")
                        .setReference("http://titania.create3000.de")
                        .setValue(to_java_string_array(["EXAMINE"]))
                    )
                )
                .addValue(MetadataSet.new()
                    .setName("Viewpoint")
                    ...
                    .addValue(MetadataDouble.new()
                        ...
                        .setDEF("position")
                        .setReference("http://titania.create3000.de")
                        .setValue(to_java_double_array([6.24067728185014, 0.00250837343276661, 2.92117542307615]))
                    )
                    .addValue(MetadataDouble.new()
                        .setName("orientation")
                        .setDEF("orientation")
                        .setReference("http://titania.create3000.de")
                        .setValue(to_java_double_array([-0.110173424710488, 0.990158061907379, -0.0863065984000336, 1.21146676119191]))
                    )
                    .addValue(MetadataDouble.new()
                        .setName("centerOfRotation")
                        .setDEF("centerOfRotation")
                        .setReference("http://titania.create3000.de")
                        .setValue(to_java_double_array([-0.808320198626341, -0.358072370409949, 0.22817191560906]))
                    )
                )
            )
        )
...
x3D0.toFileX3D "../data/SimpleShader.new.truffleruby.x3d"
x3D0.toFileJSON "../data/SimpleShader.new.truffleruby.x3dj"

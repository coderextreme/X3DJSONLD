                ...
                .setProtoBody(ProtoBody.new()
                    .addChild(Group.new()
                        ...
                        .addChild(OrientationInterpolator.new()
                            ...
                            .setKeyValue(to_java_float_array([1, 0, 0, 0, 1, 0, 0, 3.14, 1, 0, 0, 6.28]))
                        )
                    ...
                    .addComments(CommentsBlock.new("<IndexedFaceSet DEF=\"Orbit\">"))
                    ...
                    .addComments(CommentsBlock.new("</IndexedFaceSet>"))
                                .setGeometry(IndexedFaceSet.new()
                                    .setCcw(false)
                                    .setConvex(false)
                                    .setCoordIndex(to_java_int_array([0, 1, 2, -1]))
                                    .setDEF("Orbit")
                                    .setCoord(Coordinate.new()
                                        .setDEF("OrbitCoordinates")
                                        .setPoint(to_java_float_array([0, 0, 1, 0, 1, 0, 1, 0, 0]))
                                    )
                                )
                            )
                        )
...
x3D0.toFileX3D "../data/flowers2.new.truffleruby.x3d"
x3D0.toFileJSON "../data/flowers2.new.truffleruby.x3dj"

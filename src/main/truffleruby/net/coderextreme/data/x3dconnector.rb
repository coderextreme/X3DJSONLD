...
"        }")                )
        ...
        .addChild(ProtoInstance.new()
          ...
          .addComments(CommentsBlock.new("<fieldValue name='set_startpoint'>"))
          .addComments(CommentsBlock.new("</fieldValue>"))
          .addComments(CommentsBlock.new("<fieldValue name='set_endpoint'>"))
          .addComments(CommentsBlock.new("</fieldValue>"))
        )
        .addChild(ROUTE.new()
            .setFromNode("G1")
...
x3D0.toFileX3D "../data/x3dconnector.new.truffleruby.x3d"
x3D0.toFileJSON "../data/x3dconnector.new.truffleruby.x3dj"

            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Group.new()
                    ...
                    .addChild(OrientationInterpolator.new()
                        ...
                        .setKeyValue(to_java_float_array([0, 0, 1, 0, -1, 0, 0, 0.5, 0, 0, 1, 0]))
                        .setIS(IS.new()
                            .addConnect(connect.new()
                                .setNodeField("value_changed")
        ...
        .addChild(Anchor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(to_java_string_array(["LOA1_StandAnimation.x3d", "defines a prototype", "for animating a humanoid.", "Click this text to see", "InterchangableActorsViaDynamicRouting example."]))
...
x3D0.toFileX3D "../data/LOA1_StandAnimation.new.truffleruby.x3d"
x3D0.toFileJSON "../data/LOA1_StandAnimation.new.truffleruby.x3dj"

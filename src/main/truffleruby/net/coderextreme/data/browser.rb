...
x3D0 = X3D.new
    ...
    .setHead(head.new()
        ...
        .addMeta(meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/data/browser.x3d")
        )
        .addMeta(meta.new()
            .setName("description")
...
x3D0.toFileX3D "../data/browser.new.truffleruby.x3d"
x3D0.toFileJSON "../data/browser.new.truffleruby.x3dj"

        ...
        .addChild(Collision.new()
          ...
          .addComments(CommentsBlock.new("Note each label rotates about the scene's vertical Y axis for consistency, enabling local orientation by user"))
                    ...
                    .addChild(Shape.new()
                        ...
                        .setAppearance(Appearance.new()
                            ...
                            .setMaterial(Material.new()
                                .setDiffuseColor(to_java_float_array([0.1, 0.6, 0.1]))
                                .setEmissiveColor(to_java_float_array([0.05, 0.2, 0.05]))
                            )
                        )
                    )
            ...
            .setProxy(Transform.new()
                .setRotation(to_java_float_array([0, 0, 1, -1.57079]))
                    ...
                    .addChild(Group.new()
                        ...
                        .addChild(Shape.new()
                            ...
                            .setAppearance(Appearance.new()
                                .setDEF("Red")
                                .setMaterial(Material.new()
                                    .setDiffuseColor(to_java_float_array([0.7, 0.1, 0.1]))
                                    .setEmissiveColor(to_java_float_array([0.33, 0, 0]))
                                )
                            )
                        )
                        .addChild(Transform.new()
            ...
            .setProxy(Transform.new()
                .setRotation(to_java_float_array([1, 0, 0, 1.57079]))
                        ...
                        .addChild(Shape.new()
                            ...
                            .setAppearance(Appearance.new()
                                ...
                                .setMaterial(Material.new()
                                    ...
                                    .setEmissiveColor(to_java_float_array([0.1, 0.1, 0.33]))
                                )
                            )
                        )
                        .addChild(Transform.new()
...
x3D0.toFileX3D "../data/CoordinateAxes.new.truffleruby.x3d"
x3D0.toFileJSON "../data/CoordinateAxes.new.truffleruby.x3dj"

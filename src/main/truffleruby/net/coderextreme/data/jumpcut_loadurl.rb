...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            ...
            .setGroundColor(to_java_float_array([0, 0.5, 0, 0, 0.5, 0]))
            .setSkyColor(to_java_float_array([0, 0, 1]))
        )
        ...
        .addChild(Script.new()
            .setDEF("MYSCRIPT")
            .setUrl(to_java_string_array(["jumpcut_loadurl.js", "https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/jumpcut_loadurl.js"]))
            .addField(field.new()
                .setName("myParameter")
...
x3D0.toFileX3D "../data/jumpcut_loadurl.new.truffleruby.x3d"
x3D0.toFileJSON "../data/jumpcut_loadurl.new.truffleruby.x3dj"

        ...
        .addChild(Transform.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Extrusion.new()
                    ...
                    .setCrossSection(to_java_float_array([0, 0.8, 0.2, 1, 0.7, 0.95, 1, 0.5, 0.8, 0, 0.5, -0.3, 0, -0.7, -0.5, -0.3, -0.8, 0, -1, 0.5, -0.7, 0.95, -0.2, 1, 0, 0.8]))
                    .setScale(to_java_float_array([0.01, 0.01, 0.8, 0.8, 1, 1, 0.8, 0.8, 0.01, 0.01]))
                    .setSolid(false)
                    .setSpine(to_java_float_array([0, 0, 0, 0, 0.1, 0, 0, 0.5, 0, 0, 0.9, 0, 0, 1, 0]))
                )
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor(to_java_float_array([0.8, 0.3, 0.3]))
                    )
                )
            )
        )
    )
x3D0.toFileX3D "../data/ExtrusionHeart.new.truffleruby.x3d"
x3D0.toFileJSON "../data/ExtrusionHeart.new.truffleruby.x3dj"

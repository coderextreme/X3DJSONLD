...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        .addChild(Viewpoint.new()
            ...
            .setPosition(to_java_float_array([0, 0, 800]))
        )
        .addChild(Viewpoint.new()
            .setDEF("cam1")
            .setDescription("cam1 description")
            .setPosition(to_java_float_array([0, 0, 2000]))
        )
        .addChild(Viewpoint.new()
            .setDEF("cam2")
            .setDescription("cam2 description")
            .setPosition(to_java_float_array([0, 200, 1000]))
        )
        .addChild(Background.new()
            .setGroundAngle(to_java_float_array([0.9, 1.5, 1.57]))
            .setGroundColor(to_java_float_array([0.21, 0.18, 0.66, 0.2, 0.44, 0.85, 0.51, 0.81, 0.95, 0.51, 0.81, 0.95]))
            .setSkyAngle(to_java_float_array([0.9, 1.5, 1.57]))
            .setSkyColor(to_java_float_array([0.21, 0.18, 0.66, 0.2, 0.44, 0.85, 0.51, 0.81, 0.95, 0.51, 0.81, 0.95]))
        )
...
x3D0.toFileX3D "../data/flipp.new.truffleruby.x3d"
x3D0.toFileJSON "../data/flipp.new.truffleruby.x3dj"

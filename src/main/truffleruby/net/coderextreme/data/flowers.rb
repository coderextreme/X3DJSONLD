        ...
        .addChild(ProtoDeclare.new()
            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Transform.new()
                  ...
                  .addComments(CommentsBlock.new("<ComposedShader DEF='x3dom' language=\"GLSL\">"))
                  ...
                  .addComments(CommentsBlock.new("<field name='b' type='SFFloat' accessType='inputOutput' value='1'></field>"))
                  ...
                  .addComments(CommentsBlock.new("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs\"'></ShaderPart>"))
                  .addComments(CommentsBlock.new("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\"' type='FRAGMENT'></ShaderPart>"))
                  .addComments(CommentsBlock.new("</ComposedShader>"))
                            .addShaders(ComposedShader.new()
                                ...
                                .addParts(ShaderPart.new()
                                    .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flowers_chromatic.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flowers_chromatic.vs"]))
                                    .setType("VERTEX")
                                )
                                .addParts(ShaderPart.new()
                                    .setUrl(to_java_string_array(["https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.fs"]))
                                    .setType("FRAGMENT")
                                )
                            )
                        )
...
"			}")                )
            ...
            .addComments(CommentsBlock.new("<ROUTE fromNode='Animate' fromField='a' toNode='x3dom' toField='a'/>"))
            .addComments(CommentsBlock.new("<ROUTE fromNode='Animate' fromField='b' toNode='x3dom' toField='b'/>"))
            .addComments(CommentsBlock.new("<ROUTE fromNode='Animate' fromField='c' toNode='x3dom' toField='c'/>"))
            .addComments(CommentsBlock.new("<ROUTE fromNode='Animate' fromField='d' toNode='x3dom' toField='d'/>"))
            .addComments(CommentsBlock.new("<ROUTE fromNode='Animate' fromField='pdelta' toNode='x3dom' toField='pdelta'/>"))
            .addComments(CommentsBlock.new("<ROUTE fromNode='Animate' fromField='tdelta' toNode='x3dom' toField='tdelta'/>"))
            )
        )
...
x3D0.toFileX3D "../data/flowers.new.truffleruby.x3d"
x3D0.toFileJSON "../data/flowers.new.truffleruby.x3dj"

            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Group.new()
                    .addChild(Transform.new()
                        ...
                        .setTranslation(to_java_float_array([48, 27, 0]))
                        ...
                        .addChild(Shape.new()
                            ...
                            .setGeometry(IndexedFaceSet.new()
                                ...
                                .setCoord(Coordinate.new()
                                    .setPoint(to_java_float_array([25, 36, -0.01, -25, 36, -0.01, -25, -51, -0.01, 25, -51, -0.01]))
                                )
                            )
                        )
                    )
...
x3D0.toFileX3D "../data/Menu.new.truffleruby.x3d"
x3D0.toFileJSON "../data/Menu.new.truffleruby.x3dj"

...
children[2] = HAnimHumanoid23;

Group Group204 = createNode("Group");
Group204.DEF = "KeyframeAnimation";
TimeSensor TimeSensor205 = createNode("TimeSensor");
...
PositionInterpolator PositionInterpolator206 = createNode("PositionInterpolator");

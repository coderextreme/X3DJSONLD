...
HAnimHumanoid30.info = new MFString(new java.lang.String["humanoidVersion=2.0"]);
...
HAnimJoint31.center = new SFVec3f(new float[0,0.824,0.0277]);
...
HAnimJoint33.center = new SFVec3f(new float[0.0961,0.9124,-0.0001]);
...
HAnimJoint35.center = new SFVec3f(new float[0.1101,0.0656,-0.0736]);
...
HAnimJoint36.children[1] = HAnimJoint41;
...
HAnimJoint36.children[2] = HAnimJoint46;
...
HAnimJoint35.children[1] = HAnimJoint51;
...
HAnimJoint61.center = new SFVec3f(new float[-0.095,0.9171,0.0029]);
...
HAnimJoint62.center = new SFVec3f(new float[-0.0867,0.4913,0.0318]);
...
HAnimJoint63.center = new SFVec3f(new float[-0.0801,0.0712,-0.0766]);
...
HAnimJoint64.children[2] = HAnimJoint74;
...
HAnimJoint63.children[1] = HAnimJoint79;
...
HAnimJoint32.children[1] = HAnimJoint61;
...
HAnimJoint89.center = new SFVec3f(new float[0.0028,1.0568,-0.0776]);
...
HAnimJoint90.center = new SFVec3f(new float[0.0035,1.0925,-0.0787]);
...
HAnimJoint91.center = new SFVec3f(new float[0.0041,1.1276,-0.0796]);
...
HAnimJoint92.center = new SFVec3f(new float[0.0045,1.1546,-0.08]);
...
HAnimJoint93.center = new SFVec3f(new float[0.0048,1.1912,-0.0805]);
...
HAnimJoint94.center = new SFVec3f(new float[0.0051,1.2278,-0.0808]);
...
HAnimJoint95.center = new SFVec3f(new float[0.0053,1.2679,-0.081]);
...
HAnimJoint96.center = new SFVec3f(new float[0.0056,1.2848,-0.0822]);
...
HAnimJoint98.center = new SFVec3f(new float[0.0057,1.3382,-0.0845]);
...
HAnimJoint99.center = new SFVec3f(new float[0.0058,1.3625,-0.0833]);
...
HAnimJoint100.center = new SFVec3f(new float[0.0059,1.3866,-0.08]);
...
HAnimJoint101.center = new SFVec3f(new float[0.006,1.4102,-0.0745]);
...
HAnimJoint102.center = new SFVec3f(new float[0.0061,1.432,-0.0675]);
...
HAnimJoint103.center = new SFVec3f(new float[0.0062,1.4583,-0.057]);
...
HAnimJoint104.center = new SFVec3f(new float[0.0063,1.4761,-0.0484]);
...
HAnimJoint105.center = new SFVec3f(new float[0.0065,1.4951,-0.0387]);
...
HAnimJoint106.center = new SFVec3f(new float[0.0066,1.5132,-0.0301]);
...
HAnimJoint107.center = new SFVec3f(new float[0.0066,1.5357,-0.0143]);
...
HAnimJoint108.center = new SFVec3f(new float[0.0066,1.552,-0.0082]);
...
HAnimJoint109.center = new SFVec3f(new float[0.0066,1.5662,-0.0084]);
...
HAnimJoint110.center = new SFVec3f(new float[0.0066,1.58,-0.0103]);
...
HAnimJoint111.center = new SFVec3f(new float[0.0066,1.5928,-0.0103]);
...
HAnimJoint112.center = new SFVec3f(new float[0.0066,1.6144,-0.0034]);
...
HAnimJoint113.center = new SFVec3f(new float[0.0044,1.6209,0.0236]);
...
HAnimJoint113.children[2] = HAnimJoint116;
...
HAnimJoint113.children[3] = HAnimJoint117;
...
HAnimJoint113.children[4] = HAnimJoint118;
...
HAnimJoint113.children[5] = HAnimJoint119;
...
HAnimJoint113.children[6] = HAnimJoint120;
...
HAnimJoint121.center = new SFVec3f(new float[0.082,1.4488,-0.0353]);
...
HAnimJoint122.center = new SFVec3f(new float[0.0962,1.4269,-0.0424]);
...
HAnimJoint123.center = new SFVec3f(new float[0.2029,1.4376,-0.0387]);
...
HAnimJoint124.center = new SFVec3f(new float[0.2014,1.1357,-0.0682]);
...
HAnimJoint125.center = new SFVec3f(new float[0.1984,0.8663,-0.0583]);
...
HAnimJoint126.center = new SFVec3f(new float[0,1,0]);
...
HAnimJoint127.center = new SFVec3f(new float[0.1924,0.8472,-0.0534]);
...
HAnimJoint128.center = new SFVec3f(new float[0.1951,0.8226,0.0246]);
...
HAnimJoint129.center = new SFVec3f(new float[0.1955,0.8159,0.0464]);
...
HAnimJoint130.center = new SFVec3f(new float[0,1,0]);
...
HAnimJoint131.center = new SFVec3f(new float[0.1983,0.8024,-0.028]);
...
HAnimJoint132.center = new SFVec3f(new float[0.1983,0.7815,-0.028]);
...
HAnimJoint133.center = new SFVec3f(new float[0.2017,0.7363,-0.0248]);
...
HAnimJoint134.center = new SFVec3f(new float[0.2028,0.7139,-0.0236]);
...
HAnimJoint136.center = new SFVec3f(new float[0.1987,0.8029,-0.053]);
...
HAnimJoint137.center = new SFVec3f(new float[0.1987,0.7818,-0.053]);
...
HAnimJoint138.center = new SFVec3f(new float[0.2013,0.7273,-0.0503]);
...
HAnimJoint139.center = new SFVec3f(new float[0.2026,0.7011,-0.0494]);
...
HAnimJoint141.center = new SFVec3f(new float[0.1956,0.8019,-0.0794]);
...
HAnimJoint142.center = new SFVec3f(new float[0.1956,0.7815,-0.0794]);
...
HAnimJoint143.center = new SFVec3f(new float[0.1973,0.7287,-0.0777]);
...
HAnimJoint144.center = new SFVec3f(new float[0.1983,0.7045,-0.0767]);
...
HAnimJoint145.center = new SFVec3f(new float[0.1925,0.8066,-0.1036]);
...
HAnimJoint146.center = new SFVec3f(new float[0.1925,0.7866,-0.1036]);
...
HAnimJoint147.center = new SFVec3f(new float[0.1938,0.7452,-0.1024]);
...
HAnimJoint148.center = new SFVec3f(new float[0.1948,0.7277,-0.1017]);
...
HAnimJoint140.children[1] = HAnimJoint145;

HAnimJoint125.children[3] = HAnimJoint140;
...
HAnimJoint105.children[1] = HAnimJoint121;
...
HAnimJoint149.center = new SFVec3f(new float[-0.0694,1.46,-0.033]);
...
HAnimJoint150.center = new SFVec3f(new float[-0.0836,1.4281,-0.0401]);
...
HAnimJoint151.center = new SFVec3f(new float[-0.1907,1.4407,-0.0325]);
...
HAnimJoint152.center = new SFVec3f(new float[-0.1949,1.1388,-0.062]);
...
HAnimJoint153.center = new SFVec3f(new float[-0.1959,0.8694,-0.0521]);
...
HAnimJoint155.center = new SFVec3f(new float[-0.1899,0.8502,-0.0473]);
...
HAnimJoint156.center = new SFVec3f(new float[-0.1874,0.8256,0.0306]);
...
HAnimJoint157.center = new SFVec3f(new float[-0.1864,0.819,0.0506]);
...
HAnimJoint158.center = new SFVec3f(new float[0,1,0]);
...
HAnimJoint159.center = new SFVec3f(new float[-0.1961,0.8055,-0.0218]);
...
HAnimJoint160.center = new SFVec3f(new float[-0.1961,0.7846,-0.0218]);
...
HAnimJoint161.center = new SFVec3f(new float[-0.1954,0.7393,-0.0185]);
...
HAnimJoint162.center = new SFVec3f(new float[-0.1945,0.7169,-0.0173]);
...
HAnimJoint164.center = new SFVec3f(new float[-0.1972,0.806,-0.0468]);
...
HAnimJoint165.center = new SFVec3f(new float[-0.1972,0.7849,-0.0468]);
...
HAnimJoint166.center = new SFVec3f(new float[-0.195,0.7304,-0.0441]);
...
HAnimJoint167.center = new SFVec3f(new float[-0.1939,0.7042,-0.0432]);
...
HAnimJoint169.center = new SFVec3f(new float[-0.1951,0.8049,-0.0732]);
...
HAnimJoint170.center = new SFVec3f(new float[-0.1951,0.7845,-0.0732]);
...
HAnimJoint171.center = new SFVec3f(new float[-0.192,0.7318,-0.0716]);
...
HAnimJoint172.center = new SFVec3f(new float[-0.1908,0.7077,-0.0706]);
...
HAnimJoint173.center = new SFVec3f(new float[-0.1926,0.8096,-0.0975]);
...
HAnimJoint174.center = new SFVec3f(new float[-0.1926,0.7896,-0.0975]);
...
HAnimJoint175.center = new SFVec3f(new float[-0.1902,0.7483,-0.0963]);
...
HAnimJoint176.center = new SFVec3f(new float[-0.1908,0.754,-0.096]);
...
HAnimJoint168.children[1] = HAnimJoint173;

HAnimJoint153.children[3] = HAnimJoint168;
...
HAnimJoint105.children[2] = HAnimJoint149;
...
HAnimJoint31.children[1] = HAnimJoint89;

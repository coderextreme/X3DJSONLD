...
meta2.name = "title";
meta2.content = "WinterAndSpringThanksAllTitleBox.x3d";
...
meta9.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringThanksAllTitleBox.x3d";
head1.meta[7] = meta9;
...
Viewpoint12.position = new SFVec3f(new float[10,11,-10]);
...
Transform13.translation = new SFVec3f(new float[10,10,-15]);
...
ImageTexture17.url = new MFString(new java.lang.String["images/WSThanksR2trimmed.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSThanksR2trimmed.png"]);

...
meta13.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/KoreanCharacterMotionAnnexD01Jin.x3d";
...
WorldInfo20.title = "KoreanCharacterMotionAnnexD01Jin.x3d";
children = new MFNode();
...
Viewpoint22.description = "AnnexD01Jin";
...
HAnimHumanoid23.name = "AnnexD01Jin";
HAnimHumanoid23.DEF = "hanim_AnnexD01Jin";
...
HAnimJoint26.center = new SFVec3f(new float[0,30.53,-0.7076]);
HAnimJoint26.ulimit = new SFVec3f(new float[0,0,0]);
HAnimJoint26.llimit = new SFVec3f(new float[0,0,0]);
...
Transform28.translation = new SFVec3f(new float[0,30.53,-0.7076]);
...
ImageTexture32.DEF = "Annex01JinTextureAtlas";
ImageTexture32.url = new MFString(new java.lang.String["Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/HAnimSpecification/Jin.png"]);
...
HAnimJoint36.center = new SFVec3f(new float[0,35.8,-0.7076]);
HAnimJoint36.ulimit = new SFVec3f(new float[0,0,0]);
HAnimJoint36.llimit = new SFVec3f(new float[0,0,0]);
...
Transform38.translation = new SFVec3f(new float[0,35.8,-0.7076]);
...
ImageTexture42.USE = "Annex01JinTextureAtlas";
...
Coordinate44.point = new MFVec3f(new float[0,1.053,0.0273,0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.875,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0,0.9123,0.596,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.875,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.98,0.5267,-0.4285,-1.132,0.5267,0.0273,-0.98,0.5267,0.483,-0.5658,0.5267,0.6985,0,0.5267,0.8206,0.5658,0.5267,0.6985,0.98,0.5267,0.483,1.132,0.5267,0.0273,0.98,0.5267,-0.4285,0.5658,0.5267,-0.7621,0,0,-0.9616,-0.6534,0,-0.8206,-1.132,0,-0.4353,-1.307,0,0.0273,-1.132,0,0.5536,-0.6534,0,0.8206,0,0,0.9616,0.6534,0,0.8206,1.132,0,0.5536,1.307,0,0.0273,1.132,0,-0.4353,0.6534,0,-0.8206,0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0,-1.053,0.0273]);
IndexedFaceSet43.coord = Coordinate44;

TextureCoordinate TextureCoordinate45 = createNode("TextureCoordinate");
TextureCoordinate45.point = new MFVec2f(new float[0.6211,0.5754,0.7851,0.572,0.7614,0.572,0.6907,0.5698,0.62,0.5698,0.6158,0.5702,0.5451,0.5702,0.4167,0.5698,0.5451,0.5702,0.6158,0.5702,0.62,0.5698,0.6907,0.5698,0.7614,0.572,0.8036,0.5346,0.7761,0.5346,0.6989,0.4838,0.6219,0.4428,0.6154,0.4438,0.5492,0.4639,0.4166,0.5346,0.5492,0.4639,0.6154,0.4438,0.6219,0.4428,0.6989,0.4838,0.7761,0.5346,0.7912,0.4044,0.7635,0.4044,0.7042,0.3925,0.6194,0.3907,0.6148,0.3907,0.545,0.3974,0.4163,0.4938,0.545,0.3974,0.6148,0.3907,0.6194,0.3907,0.7042,0.3925,0.7635,0.4044,0.795,0.3772,0.7662,0.3772,0.6945,0.3645,0.6236,0.3695,0.616,0.3695,0.5438,0.378,0.416,0.453,0.5438,0.378,0.616,0.3695,0.6236,0.3695,0.6945,0.3645,0.7662,0.3772,0.7887,0.3451,0.7635,0.3451,0.698,0.3508,0.6262,0.3508,0.6297,0.3503,0.5389,0.3503,0.4181,0.3884,0.5389,0.3503,0.6297,0.3503,0.6262,0.3508,0.698,0.3508,0.7635,0.3451,0.6237,0.3398]);
...
HAnimJoint46.center = new SFVec3f(new float[4.207,32.02,-0.8155]);
...
Transform48.translation = new SFVec3f(new float[4.207,32.02,-0.8155]);
...
ImageTexture52.USE = "Annex01JinTextureAtlas";
...
HAnimJoint56.center = new SFVec3f(new float[4.116,17.26,-0.8639]);
...
Transform58.translation = new SFVec3f(new float[4.116,17.26,-0.8639]);
...
ImageTexture62.USE = "Annex01JinTextureAtlas";
...
HAnimJoint66.center = new SFVec3f(new float[3.854,3.939,-0.7038]);
...
Transform68.translation = new SFVec3f(new float[3.854,3.939,-0.7038]);
...
ImageTexture72.USE = "Annex01JinTextureAtlas";
...
HAnimJoint76.name = "l_metatarsophalangeal_2";
HAnimJoint76.DEF = "hanim_l_metatarsophalangeal_2";
HAnimJoint76.center = new SFVec3f(new float[3.854,3.64,0.7402]);
...
HAnimSegment77.name = "l_tarsal_proximal_phalanx_2";
HAnimSegment77.DEF = "hanim_l_tarsal_proximal_phalanx_2";
Transform Transform78 = createNode("Transform");
Transform78.translation = new SFVec3f(new float[3.854,3.64,0.7402]);
...
ImageTexture82.USE = "Annex01JinTextureAtlas";
...
HAnimJoint86.center = new SFVec3f(new float[-4.207,32.02,-0.8155]);
...
Transform88.translation = new SFVec3f(new float[-4.207,32.02,-0.8155]);
...
ImageTexture92.USE = "Annex01JinTextureAtlas";
...
Coordinate94.point = new MFVec3f(new float[-2.96,3.738,0,-1.643,3.738,3.209,1.316,3.738,4.002,3.367,3.738,1.781,3.367,3.738,-1.781,1.316,3.738,-4.002,-1.643,3.738,-3.209,-2.96,-0.0114,0,-1.643,-0.0114,3.209,1.316,-0.0114,4.002,3.367,-0.0114,1.781,3.367,-0.0114,-1.781,1.316,-0.0114,-4.002,-1.643,-0.0114,-3.209,-2.96,-6.507,0,-1.643,-6.507,3.209,1.316,-6.507,4.002,3.367,-6.507,1.781,3.367,-6.507,-1.781,1.316,-6.507,-4.002,-1.643,-6.507,-3.209,-3.367,-13.13,0,-1.897,-13.13,3.582,1.407,-13.13,4.467,3.355,-13.13,1.988,3.355,-13.13,-1.988,1.407,-13.13,-4.467,-1.897,-13.13,-3.582,-2.146,-4.985,0,-1.136,-4.985,2.462,1.135,-4.985,3.07,2.633,-4.985,1.366,2.633,-4.985,-1.366,1.135,-4.985,-3.07,-1.136,-4.985,-2.462,-2.156,-11.45,0,-1.225,-11.45,1.956,0.8662,-11.45,2.439,2.543,-11.45,1.085,2.543,-11.45,-1.085,0.8662,-11.45,-2.439,-1.225,-11.45,-1.956,-2.051,5.729,0,-1.076,5.729,2.375,1.114,5.729,2.961,2.87,5.729,1.318,2.87,5.729,-1.318,1.114,5.729,-2.961,-1.076,5.729,-2.375,-1.842,-15.12,0,-1.03,-15.12,1.873,0.7965,-15.12,2.295,2.261,-15.12,1.113,2.261,-15.12,-0.9478,0.7965,-15.12,-2.13,-1.03,-15.12,-1.708,-0.6277,-16.1,0,-0.2723,-16.1,0.912,0.5262,-16.1,1.096,1.167,-16.1,0.5796,1.167,-16.1,-0.4145,0.5262,-16.1,-0.9313,-0.2723,-16.1,-0.7469]);
IndexedFaceSet93.coord = Coordinate94;

TextureCoordinate TextureCoordinate95 = createNode("TextureCoordinate");
TextureCoordinate95.point = new MFVec2f(new float[0.719,0.5576,0.6284,0.5576,0.7414,0.5576,0.6787,0.5576,0.5781,0.5576,0.5154,0.5576,0.5378,0.5576,0.6284,0.5029,0.7509,0.3997,0.6284,0.3997,0.7509,0.5029,0.7811,0.3997,0.7811,0.5029,0.6964,0.3997,0.6964,0.5029,0.5604,0.3997,0.5604,0.5029,0.4756,0.3997,0.4756,0.5029,0.5059,0.3997,0.5059,0.5029,0.7509,0.3197,0.6284,0.3197,0.7811,0.3197,0.6964,0.3197,0.5604,0.3197,0.4756,0.3197,0.5059,0.3197,0.7651,0.2166,0.6284,0.2166,0.7989,0.2166,0.7043,0.2166,0.5525,0.2166,0.4579,0.2166,0.4917,0.2166,0.7224,0.263,0.6284,0.263,0.7456,0.263,0.6805,0.263,0.5762,0.263,0.5112,0.263,0.5344,0.263,0.8705,0.5452,0.8705,0.5383,0.8705,0.5369,0.8705,0.5408,0.8705,0.5483,0.8705,0.5522,0.8705,0.5509,0.917,0.5452,0.917,0.5266,0.89,0.5304,0.89,0.5452,0.917,0.522,0.89,0.5268,0.917,0.5349,0.89,0.537,0.917,0.5555,0.89,0.5534,0.917,0.5684,0.89,0.5636,0.917,0.5638,0.89,0.56,0.8746,0.531,0.8746,0.5452,0.8746,0.5279,0.8746,0.5368,0.8746,0.5524,0.8746,0.5613,0.8746,0.5581]);
...
HAnimJoint96.DEF = "hanim_r_knee";
HAnimJoint96.center = new SFVec3f(new float[-4.116,17.26,-0.8639]);
...
HAnimSegment97.DEF = "hanim_r_calf";
Transform Transform98 = createNode("Transform");
Transform98.translation = new SFVec3f(new float[-4.116,17.26,-0.8639]);
...
ImageTexture102.USE = "Annex01JinTextureAtlas";
...
Coordinate104.point = new MFVec3f(new float[-0.7186,0.9688,0.0234,-0.3632,0.9688,0.9354,0.4353,0.9688,1.12,1.076,0.9688,0.603,1.076,0.9688,-0.3911,0.4353,0.9688,-0.9079,-0.3632,0.9688,-0.7235,-2.337,-4.613,0.0234,-1.46,-3.622,2.019,-1.236,-1.628,2.42,-2.118,-1.912,0.0234,0.8111,-3.622,2.567,0.7468,-1.628,2.903,2.254,-4.613,1.255,2.337,-1.912,0.9793,2.254,-5.383,-1.368,2.337,-1.912,-0.9325,0.8111,-5.383,-2.903,0.7468,-1.912,-2.368,-1.46,-5.383,-2.355,-1.236,-1.912,-1.885,-1.121,-0.0032,1.896,-1.933,-0.0032,0.0234,0.7056,-0.0032,2.318,2.17,-0.0032,1.136,2.17,-0.0032,-0.9244,0.7056,-0.0032,-2.061,-1.121,-0.0032,-1.64,-1.607,-12.92,0.0032,-0.9216,-12.91,1.565,0.619,-12.91,1.951,1.854,-12.92,0.8701,1.854,-12.94,-0.9762,0.619,-12.94,-1.742,-0.9216,-12.94,-1.356,-0.7072,-14.53,0.0239,-0.3604,-14.53,0.814,0.4188,-14.53,1.009,1.044,-14.53,0.4624,1.044,-14.54,-0.4714,0.4188,-14.54,-0.8587,-0.3604,-14.54,-0.6635]);
IndexedFaceSet103.coord = Coordinate104;

TextureCoordinate TextureCoordinate105 = createNode("TextureCoordinate");
TextureCoordinate105.point = new MFVec2f(new float[0.9309,0.5848,0.919,0.5848,0.8921,0.5848,0.8706,0.5848,0.8706,0.5848,0.8921,0.5848,0.919,0.5848,0.9845,0.5321,0.955,0.5475,0.9491,0.5599,0.9788,0.5571,0.8787,0.5475,0.8825,0.5599,0.8302,0.5321,0.8291,0.5571,0.8302,0.52,0.8291,0.5571,0.8787,0.52,0.8825,0.5571,0.955,0.52,0.9491,0.5571,0.9444,0.5755,0.9717,0.5755,0.8831,0.5755,0.8339,0.5755,0.8339,0.5755,0.8831,0.5755,0.9444,0.5755,0.9679,0.2444,0.9449,0.2445,0.8931,0.2445,0.8516,0.2444,0.8516,0.2442,0.8931,0.2442,0.9449,0.2442,0.9372,0.2243,0.9255,0.2244,0.8993,0.2244,0.8783,0.2243,0.8783,0.2243,0.8993,0.2243,0.9255,0.2243]);
...
HAnimJoint106.name = "r_talocrural";
HAnimJoint106.DEF = "hanim_r_talocrural";
HAnimJoint106.center = new SFVec3f(new float[-3.854,3.939,-0.7038]);
...
HAnimSegment107.name = "r_talus";
HAnimSegment107.DEF = "hanim_r_talus";
Transform Transform108 = createNode("Transform");
Transform108.translation = new SFVec3f(new float[-3.854,3.939,-0.7038]);
...
ImageTexture112.USE = "Annex01JinTextureAtlas";
...
Coordinate114.point = new MFVec3f(new float[-0.9768,-0.0192,-1.681,-1.657,-0.0192,0.4309,0,-0.0192,-1.681,-1.403,0.7316,0.354,-0.8174,0.7316,-1.463,0,0.7316,-1.463,0,0.7316,1.471,1.657,-0.0192,0.4309,1.403,0.7316,0.354,0.8174,0.7316,-1.463,0.9768,-0.0192,-1.681,0,-0.0192,1.75,-1.109,-0.6007,-2.046,-2.045,-0.6007,0.4309,-1.695,-0.296,1.429,0,-0.6007,-2.046,1.109,-0.6007,-2.046,2.045,-0.6007,0.4309,1.695,-0.296,1.429,0,-1.207,-1.841,-1.023,-1.207,-1.841,-1.913,-1.223,0.5161,-1.601,-0.9325,1.406,0,-0.6582,1.708,1.601,-0.9325,1.406,1.913,-1.223,0.5161,1.023,-1.207,-1.841,-1.409,-1.925,-2.878,-1.409,-3.947,-1.681,0,-3.947,-1.681,-1.109,-0.6007,-2.046,0,-0.6007,-2.046,1.409,-1.925,-2.878,0,-1.925,-2.878,1.109,-0.6007,-2.046,1.409,-3.947,-1.681,-2.927,-1.925,0.4309,-2.089,-3.947,0.4309,-2.045,-0.6007,0.4309,2.927,-1.925,0.4309,2.045,-0.6007,0.4309,2.089,-3.947,0.4309,0,-3.947,0.4309,-0.9442,-0.3153,-1.692,0,-0.3153,-1.692,0.9442,-0.3153,-1.692,1.7,-0.3153,0.3093,-1.7,-0.3153,0.3093,-1.86,-3.793,1.364,-2.541,-1.963,1.364,-1.861,-0.9431,1.364,1.861,-0.9431,1.364,2.541,-1.963,1.364,1.86,-3.793,1.364,0,-3.793,1.364]);
...
HAnimJoint116.name = "r_metatarsophalangeal_2";
HAnimJoint116.DEF = "hanim_r_metatarsophalangeal_2";
HAnimJoint116.center = new SFVec3f(new float[-3.854,3.64,0.7402]);
...
HAnimSegment117.name = "r_tarsal_proximal_phalanx_2";
HAnimSegment117.DEF = "hanim_r_tarsal_proximal_phalanx_2";
Transform Transform118 = createNode("Transform");
Transform118.translation = new SFVec3f(new float[-3.854,3.64,0.7402]);
...
ImageTexture122.USE = "Annex01JinTextureAtlas";
...
TextureCoordinate125.point = new MFVec2f(new float[0.433,0.0595,0.4411,0.0186,0.4637,0.1714,0.4411,0.0186,0.4244,0.1312,0.4394,0.1472,0.433,0.0595,0.4244,0.1312,0.4411,0.0186,0.4637,0.1714,0.4394,0.1472,0.4411,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4949,0.0186,0.4868,0.1432,0.4868,0.1432,0.433,0.0595,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.433,0.0595,0.4244,0.1312,0.4244,0.1312,0.532,0.098,0.5645,0.0707,0.4885,0.102,0.5026,0.044,0.5945,0.0186,0.5487,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4868,0.1432,0.5645,0.0707,0.5026,0.044,0.4885,0.102,0.532,0.098,0.5945,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.5487,0.0186,0.4949,0.0186,0.4868,0.1432]);
...
HAnimJoint36.children[2] = HAnimJoint86;

HAnimJoint HAnimJoint126 = createNode("HAnimJoint");
HAnimJoint126.name = "vl5";
HAnimJoint126.DEF = "hanim_vl5";
HAnimJoint126.center = new SFVec3f(new float[0,40.23,-0.8527]);
...
HAnimSegment127.name = "l5";
HAnimSegment127.DEF = "hanim_l5";
Transform Transform128 = createNode("Transform");
Transform128.translation = new SFVec3f(new float[0,40.23,-0.8527]);
...
ImageTexture132.USE = "Annex01JinTextureAtlas";
...
HAnimJoint136.name = "skullbase";
HAnimJoint136.DEF = "hanim_skullbase";
HAnimJoint136.center = new SFVec3f(new float[0,57.43,-0.6863]);
...
HAnimSegment137.name = "skull";
HAnimSegment137.DEF = "hanim_skull";
Transform Transform138 = createNode("Transform");
Transform138.translation = new SFVec3f(new float[0,57.43,-0.6863]);
...
ImageTexture142.USE = "Annex01JinTextureAtlas";
...
HAnimJoint146.name = "l_shoulder";
HAnimJoint146.DEF = "hanim_l_shoulder";
HAnimJoint146.center = new SFVec3f(new float[5.975,52,-0.1452]);
HAnimJoint146.ulimit = new SFVec3f(new float[0,0,0]);
HAnimJoint146.llimit = new SFVec3f(new float[0,0,0]);
HAnimSegment HAnimSegment147 = createNode("HAnimSegment");
HAnimSegment147.name = "l_upperarm";
HAnimSegment147.DEF = "hanim_l_upperarm";
Transform Transform148 = createNode("Transform");
Transform148.translation = new SFVec3f(new float[5.975,52,-0.1452]);
...
ImageTexture152.USE = "Annex01JinTextureAtlas";
...
HAnimJoint156.name = "l_elbow";
HAnimJoint156.DEF = "hanim_l_elbow";
HAnimJoint156.center = new SFVec3f(new float[8.093,40.38,-0.2502]);
...
HAnimSegment157.name = "l_forearm";
HAnimSegment157.DEF = "hanim_l_forearm";
Transform Transform158 = createNode("Transform");
Transform158.translation = new SFVec3f(new float[8.093,40.38,-0.2502]);
...
ImageTexture162.USE = "Annex01JinTextureAtlas";
...
HAnimJoint166.name = "l_radiocarpal";
HAnimJoint166.DEF = "hanim_l_radiocarpal";
HAnimJoint166.center = new SFVec3f(new float[7.808,31.46,-0.05849]);
...
HAnimSegment167.name = "l_carpal";
HAnimSegment167.DEF = "hanim_l_carpal";
Transform Transform168 = createNode("Transform");
Transform168.translation = new SFVec3f(new float[7.808,31.46,-0.05849]);
...
ImageTexture172.USE = "Annex01JinTextureAtlas";
...
HAnimJoint126.children[2] = HAnimJoint146;

HAnimJoint HAnimJoint176 = createNode("HAnimJoint");
HAnimJoint176.name = "r_shoulder";
HAnimJoint176.DEF = "hanim_r_shoulder";
HAnimJoint176.center = new SFVec3f(new float[-5.975,52,-0.1452]);
HAnimJoint176.ulimit = new SFVec3f(new float[0,0,0]);
HAnimJoint176.llimit = new SFVec3f(new float[0,0,0]);
...
Transform178.translation = new SFVec3f(new float[-5.975,52,-0.1452]);
...
ImageTexture182.USE = "Annex01JinTextureAtlas";
...
Coordinate184.point = new MFVec3f(new float[-2.525,1.246,-1.68,-3.681,1.236,0.0337,-2.408,1.247,1.663,-0.4657,1.264,0.9556,-0.5379,1.264,-1.11,-2.743,-0.0209,-2.31,-4.339,-0.0351,0.057,-2.581,-0.0195,2.307,0.1009,0.0044,1.33,0.0013,0.0035,-1.523,-2.72,-2.534,-2.31,-4.317,-2.548,0.057,-2.559,-2.533,2.307,0.1233,-2.509,1.33,0.0237,-2.51,-1.523,-2.759,-3.609,-2.442,-4.448,-3.624,0.0619,-2.588,-3.608,2.442,0.2497,-3.583,1.409,0.1443,-3.583,-1.61,-2.245,-1.758,-1.939,-3.465,-1.769,-0.4543,-2.834,-1.763,1.629,-1.223,-1.749,1.432,-0.8596,-1.746,-0.7734,-2.263,-7.566,-1.569,-3.531,-7.577,-0.378,-2.875,-7.571,1.293,-1.202,-7.556,1.135,-0.8242,-7.553,-0.6339,-2.267,-11.62,-1.511,-3.487,-11.63,-0.3651,-2.856,-11.62,1.243,-1.245,-11.61,1.091,-0.8817,-11.6,-0.6115,-2.213,-12.17,-0.8985,-2.928,-12.17,-0.2266,-2.558,-12.17,0.7161,-1.614,-12.16,0.6268,-1.401,-12.16,-0.3711]);
IndexedFaceSet183.coord = Coordinate184;

TextureCoordinate TextureCoordinate185 = createNode("TextureCoordinate");
TextureCoordinate185.point = new MFVec2f(new float[0.2986,0.2114,0.2726,0.2114,0.3201,0.2114,0.3415,0.2114,0.2466,0.2114,0.2979,0.2417,0.2726,0.2417,0.3197,0.2417,0.3418,0.2417,0.2473,0.2417,0.2979,0.3018,0.2726,0.3018,0.3197,0.3018,0.3418,0.3018,0.2473,0.3018,0.2978,0.3276,0.2726,0.3276,0.3197,0.3276,0.3419,0.3276,0.2474,0.3276,0.2932,0.2834,0.2689,0.2834,0.316,0.2834,0.3322,0.2834,0.245,0.2834,0.2251,0.2114,0.2255,0.2417,0.2255,0.2417,0.2255,0.3018,0.2255,0.3018,0.2255,0.3276,0.2255,0.3276,0.2159,0.2834,0.4315,0.6736,0.442,0.6736,0.3947,0.6736,0.4041,0.6736,0.418,0.6736,0.4296,0.6167,0.4409,0.6167,0.4415,0.6485,0.4303,0.6485,0.3965,0.6167,0.3953,0.6485,0.4047,0.6167,0.4053,0.6485,0.4189,0.6167,0.418,0.6485,0.4415,0.6706,0.4306,0.6706,0.395,0.6706,0.4051,0.6706,0.4182,0.6706,0.3746,0.6736,0.3851,0.6736,0.384,0.6167,0.3845,0.6485,0.3845,0.6485,0.3846,0.6706,0.3846,0.6706,0.3851,0.6736,0.3481,0.2114]);
...
HAnimJoint186.name = "r_elbow";
HAnimJoint186.DEF = "hanim_r_elbow";
HAnimJoint186.center = new SFVec3f(new float[-8.093,40.38,-0.2502]);
...
HAnimSegment187.name = "r_forearm";
HAnimSegment187.DEF = "hanim_r_forearm";
Transform Transform188 = createNode("Transform");
Transform188.translation = new SFVec3f(new float[-8.093,40.38,-0.2502]);
...
ImageTexture192.USE = "Annex01JinTextureAtlas";
...
Coordinate194.point = new MFVec3f(new float[-0.215,0.3047,-1.152,-1.155,0.2966,-0.2588,-0.6199,0.3013,1.04,0.6505,0.3122,0.9491,0.9008,0.3143,-0.4054,-0.1442,-0.8448,-1.625,-1.472,-0.8561,-0.4271,-0.7164,-0.8496,1.625,1.079,-0.8342,1.482,1.433,-0.8312,-0.6588,-0.1328,-3.5,-1.607,-1.551,-3.513,-0.4225,-0.781,-2.925,1.61,1.136,-2.909,1.468,1.551,-3.486,-0.6519,-0.0592,-8.713,-1.437,-1.093,-8.722,-0.1279,-0.5047,-8.716,1.51,0.8932,-8.704,1.377,1.169,-8.702,-0.3428,-0.0092,-9.336,-0.8855,-0.7154,-9.342,0.0084,-0.3135,-9.339,1.043,0.6412,-9.331,0.9519,0.8292,-9.329,-0.1383]);
IndexedFaceSet193.coord = Coordinate194;

TextureCoordinate TextureCoordinate195 = createNode("TextureCoordinate");
TextureCoordinate195.point = new MFVec2f(new float[0.4222,0.6201,0.4327,0.6201,0.3884,0.6201,0.3987,0.6201,0.4103,0.6201,0.4213,0.6265,0.4321,0.6265,0.3894,0.6265,0.399,0.6265,0.4105,0.6265,0.4214,0.6413,0.4323,0.6413,0.389,0.6381,0.3992,0.6381,0.4103,0.6413,0.4213,0.6705,0.4336,0.6705,0.3899,0.6705,0.3981,0.6705,0.4094,0.6705,0.4215,0.674,0.4346,0.674,0.3899,0.674,0.398,0.674,0.4083,0.674,0.3787,0.6201,0.3682,0.6201,0.3787,0.6201,0.3782,0.6265,0.3782,0.6265,0.3783,0.6413,0.3783,0.6413,0.3796,0.6705,0.3676,0.674,0.3806,0.674,0.3796,0.6705,0.3806,0.674]);
IndexedFaceSet193.texCoord = TextureCoordinate195;
...
HAnimJoint196.name = "r_radiocarpal";
HAnimJoint196.DEF = "hanim_r_radiocarpal";
HAnimJoint196.center = new SFVec3f(new float[-7.808,31.46,-0.05849]);
HAnimJoint196.ulimit = new SFVec3f(new float[0,0,0]);
HAnimJoint196.llimit = new SFVec3f(new float[0,0,0]);
HAnimSegment HAnimSegment197 = createNode("HAnimSegment");
HAnimSegment197.name = "r_carpal";
HAnimSegment197.DEF = "hanim_r_carpal";
Transform Transform198 = createNode("Transform");
Transform198.translation = new SFVec3f(new float[-7.808,31.46,-0.05849]);
...
ImageTexture202.USE = "Annex01JinTextureAtlas";
...
Coordinate204.point = new MFVec3f(new float[-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912,0.7183,0.0002,-1.283,0.9295,-0.613,1.478,-1.647,-0.4252,1.388,-1.589,-0.3921,-1.989,1.044,-0.5947,-1.984,0.8227,-2.521,2.408,-1.951,-2.334,2.08,-1.892,-2.301,-2.409,1.192,-2.614,-2.248,0.5703,-3.958,1.694,-0.8836,-4.2,1.75,-0.8251,-4.167,-2.071,0.7842,-3.968,-1.934,1.037,-0.5968,-0.1872,1.642,-2.561,1.941,1.951,-0.9492,0.058,1.914,-1.016,1.885,1.649,-2.56,0.1377,1.066,-2.61,-0.2014,-1.209,0.0872,-1.349,0.7183,0.0002,-1.283,0.7098,-0.0015,0.8912,-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912]);
IndexedFaceSet203.coord = Coordinate204;

TextureCoordinate TextureCoordinate205 = createNode("TextureCoordinate");
TextureCoordinate205.point = new MFVec2f(new float[0.8107,0.9924,0.8122,0.9033,0.7694,0.9912,0.7683,0.9026,0.1329,0.0347,0.0307,0.0051,0.0134,0.0353,0.1366,0.0058,0.1249,0.1081,0.0147,0.117,0.1349,0.1856,0.0462,0.1842,0.1559,0.0454,0.148,0.1033,0.3244,0.0096,0.1758,0.0039,0.1759,0.011,0.3241,0.0033,0.173,0.1764,0.3074,0.1757,0.1732,0.1519,0.3074,0.1513,0.1756,0.032,0.2159,0.0368,0.1791,0.0165,0.3169,0.0458,0.3158,0.0193,0.172,0.0594,0.2087,0.0476,0.1736,0.0504,0.2073,0.064,0.2362,0.0821,0.3267,0.0796,0.1717,0.0822,0.1726,0.1297,0.3077,0.1289,0.3074,0.1865,0.1742,0.184,0.0061,0.1086,0.1366,0.0368,0.1241,0.1189,0.0168,0.0309,0.0211,0.1882,0.14,0.1857]);
IndexedFaceSet203.texCoord = TextureCoordinate205;
...
HAnimJoint126.children[3] = HAnimJoint176;

HAnimJoint36.children[3] = HAnimJoint126;

HAnimJoint26.children[1] = HAnimJoint36;

HAnimHumanoid23.joints = new MFNode();

HAnimHumanoid23.joints[0] = HAnimJoint26;

HAnimJoint HAnimJoint206 = createNode("HAnimJoint");
HAnimJoint206.USE = "hanim_humanoid_root";
HAnimHumanoid23.joints[1] = HAnimJoint206;

HAnimJoint HAnimJoint207 = createNode("HAnimJoint");
HAnimJoint207.USE = "hanim_sacroiliac";
HAnimHumanoid23.joints[2] = HAnimJoint207;

HAnimJoint HAnimJoint208 = createNode("HAnimJoint");
HAnimJoint208.USE = "hanim_vl5";
HAnimHumanoid23.joints[3] = HAnimJoint208;

HAnimJoint HAnimJoint209 = createNode("HAnimJoint");
HAnimJoint209.USE = "hanim_skullbase";
HAnimHumanoid23.joints[4] = HAnimJoint209;

HAnimJoint HAnimJoint210 = createNode("HAnimJoint");
HAnimJoint210.USE = "hanim_l_elbow";
HAnimHumanoid23.joints[5] = HAnimJoint210;

HAnimJoint HAnimJoint211 = createNode("HAnimJoint");
HAnimJoint211.USE = "hanim_r_elbow";
HAnimHumanoid23.joints[6] = HAnimJoint211;

HAnimJoint HAnimJoint212 = createNode("HAnimJoint");
HAnimJoint212.USE = "hanim_l_hip";
HAnimHumanoid23.joints[7] = HAnimJoint212;

HAnimJoint HAnimJoint213 = createNode("HAnimJoint");
HAnimJoint213.USE = "hanim_r_hip";
HAnimHumanoid23.joints[8] = HAnimJoint213;

HAnimJoint HAnimJoint214 = createNode("HAnimJoint");
HAnimJoint214.USE = "hanim_l_knee";
HAnimHumanoid23.joints[9] = HAnimJoint214;

HAnimJoint HAnimJoint215 = createNode("HAnimJoint");
HAnimJoint215.USE = "hanim_r_knee";
HAnimHumanoid23.joints[10] = HAnimJoint215;

HAnimJoint HAnimJoint216 = createNode("HAnimJoint");
HAnimJoint216.USE = "hanim_l_metatarsophalangeal_2";
HAnimHumanoid23.joints[11] = HAnimJoint216;

HAnimJoint HAnimJoint217 = createNode("HAnimJoint");
HAnimJoint217.USE = "hanim_r_metatarsophalangeal_2";
HAnimHumanoid23.joints[12] = HAnimJoint217;

HAnimJoint HAnimJoint218 = createNode("HAnimJoint");
HAnimJoint218.USE = "hanim_l_radiocarpal";
HAnimHumanoid23.joints[13] = HAnimJoint218;

HAnimJoint HAnimJoint219 = createNode("HAnimJoint");
HAnimJoint219.USE = "hanim_r_radiocarpal";
HAnimHumanoid23.joints[14] = HAnimJoint219;

HAnimJoint HAnimJoint220 = createNode("HAnimJoint");
HAnimJoint220.USE = "hanim_l_shoulder";
HAnimHumanoid23.joints[15] = HAnimJoint220;

HAnimJoint HAnimJoint221 = createNode("HAnimJoint");
HAnimJoint221.USE = "hanim_r_shoulder";
HAnimHumanoid23.joints[16] = HAnimJoint221;

HAnimJoint HAnimJoint222 = createNode("HAnimJoint");
HAnimJoint222.USE = "hanim_l_talocrural";
HAnimHumanoid23.joints[17] = HAnimJoint222;

HAnimJoint HAnimJoint223 = createNode("HAnimJoint");
HAnimJoint223.USE = "hanim_r_talocrural";
HAnimHumanoid23.joints[18] = HAnimJoint223;

HAnimSegment HAnimSegment224 = createNode("HAnimSegment");
HAnimSegment224.USE = "hanim_sacrum";
HAnimHumanoid23.segments[19] = HAnimSegment224;

HAnimSegment HAnimSegment225 = createNode("HAnimSegment");
HAnimSegment225.USE = "hanim_pelvis";
HAnimHumanoid23.segments[20] = HAnimSegment225;

HAnimSegment HAnimSegment226 = createNode("HAnimSegment");
HAnimSegment226.USE = "hanim_l5";
HAnimHumanoid23.segments[21] = HAnimSegment226;

HAnimSegment HAnimSegment227 = createNode("HAnimSegment");
HAnimSegment227.USE = "hanim_skull";
HAnimHumanoid23.segments[22] = HAnimSegment227;

HAnimSegment HAnimSegment228 = createNode("HAnimSegment");
HAnimSegment228.USE = "hanim_l_calf";
HAnimHumanoid23.segments[23] = HAnimSegment228;

HAnimSegment HAnimSegment229 = createNode("HAnimSegment");
HAnimSegment229.USE = "hanim_r_calf";
HAnimHumanoid23.segments[24] = HAnimSegment229;

HAnimSegment HAnimSegment230 = createNode("HAnimSegment");
HAnimSegment230.USE = "hanim_l_carpal";
HAnimHumanoid23.segments[25] = HAnimSegment230;

HAnimSegment HAnimSegment231 = createNode("HAnimSegment");
HAnimSegment231.USE = "hanim_r_carpal";
HAnimHumanoid23.segments[26] = HAnimSegment231;

HAnimSegment HAnimSegment232 = createNode("HAnimSegment");
HAnimSegment232.USE = "hanim_l_forearm";
HAnimHumanoid23.segments[27] = HAnimSegment232;

HAnimSegment HAnimSegment233 = createNode("HAnimSegment");
HAnimSegment233.USE = "hanim_r_forearm";
HAnimHumanoid23.segments[28] = HAnimSegment233;

HAnimSegment HAnimSegment234 = createNode("HAnimSegment");
HAnimSegment234.USE = "hanim_l_talus";
HAnimHumanoid23.segments[29] = HAnimSegment234;

HAnimSegment HAnimSegment235 = createNode("HAnimSegment");
HAnimSegment235.USE = "hanim_r_talus";
HAnimHumanoid23.segments[30] = HAnimSegment235;

HAnimSegment HAnimSegment236 = createNode("HAnimSegment");
HAnimSegment236.USE = "hanim_l_tarsal_proximal_phalanx_2";
HAnimHumanoid23.segments[31] = HAnimSegment236;

HAnimSegment HAnimSegment237 = createNode("HAnimSegment");
HAnimSegment237.USE = "hanim_r_tarsal_proximal_phalanx_2";
HAnimHumanoid23.segments[32] = HAnimSegment237;

HAnimSegment HAnimSegment238 = createNode("HAnimSegment");
HAnimSegment238.USE = "hanim_l_thigh";
HAnimHumanoid23.segments[33] = HAnimSegment238;

HAnimSegment HAnimSegment239 = createNode("HAnimSegment");
HAnimSegment239.USE = "hanim_r_thigh";
HAnimHumanoid23.segments[34] = HAnimSegment239;

HAnimSegment HAnimSegment240 = createNode("HAnimSegment");
HAnimSegment240.USE = "hanim_l_upperarm";
HAnimHumanoid23.segments[35] = HAnimSegment240;

HAnimSegment HAnimSegment241 = createNode("HAnimSegment");
HAnimSegment241.USE = "hanim_r_upperarm";
HAnimHumanoid23.segments[36] = HAnimSegment241;

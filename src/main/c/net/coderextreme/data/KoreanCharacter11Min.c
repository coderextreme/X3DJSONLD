...
meta10.name = "Image";
meta10.content = "../Poses/images/HAnimPoseExampleKoreanCharacter11Min.png";
head1.meta[8] = meta10;
...
meta14.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter11Min.x3d";
...
WorldInfo21.title = "KoreanCharacter11Min.x3d";
children = new MFNode();
...
HAnimHumanoid24.name = "Min";
HAnimHumanoid24.DEF = "hanim_Min";
...
HAnimJoint32.center = new SFVec3f(new float[0,33.689999,-2.063]);
...
Transform34.translation = new SFVec3f(new float[0,33.689999,-2.063]);
...
ImageTexture38.DEF = "MinTextureAtlas";
ImageTexture38.url = new MFString(new java.lang.String["images/Min.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Min.png"]);
...
HAnimJoint42.center = new SFVec3f(new float[3.383,32.919998,-2.063]);
...
Transform44.translation = new SFVec3f(new float[3.383,32.919998,-2.063]);
...
ImageTexture48.USE = "MinTextureAtlas";
...
HAnimJoint52.center = new SFVec3f(new float[3.745,17.99,-2.063]);
...
Transform54.translation = new SFVec3f(new float[3.745,17.99,-2.063]);
...
ImageTexture58.USE = "MinTextureAtlas";
...
HAnimJoint62.center = new SFVec3f(new float[3.701,4.188,-1.915]);
...
Transform64.translation = new SFVec3f(new float[3.701,4.188,-1.915]);
...
ImageTexture68.USE = "MinTextureAtlas";
...
HAnimJoint72.center = new SFVec3f(new float[3.701,3.418,-0.4009]);
...
Transform74.translation = new SFVec3f(new float[3.701,3.418,-0.4009]);
...
ImageTexture78.USE = "MinTextureAtlas";
...
HAnimJoint82.center = new SFVec3f(new float[-3.383,32.919998,-2.063]);
...
Transform84.translation = new SFVec3f(new float[-3.383,32.919998,-2.063]);
...
ImageTexture88.USE = "MinTextureAtlas";
...
HAnimJoint92.center = new SFVec3f(new float[-3.745,17.99,-2.063]);
...
Transform94.translation = new SFVec3f(new float[-3.745,17.99,-2.063]);
...
ImageTexture98.USE = "MinTextureAtlas";
...
HAnimJoint102.center = new SFVec3f(new float[-3.701,4.188,-1.915]);
...
Transform104.translation = new SFVec3f(new float[-3.701,4.188,-1.915]);
...
ImageTexture108.USE = "MinTextureAtlas";
...
HAnimJoint112.center = new SFVec3f(new float[-3.701,3.418,-0.4009]);
...
Transform114.translation = new SFVec3f(new float[-3.701,3.418,-0.4009]);
...
ImageTexture118.USE = "MinTextureAtlas";
...
Coordinate120.point = new MFVec3f(new float[-1.769,-0.6918,0.7987,-1.758,-3.427,-1.249,-2.066,-2.766,-1.386,-1.847,-0.2455,-1.475,-1.516,0.0194,-0.018,-1.301,-2.629,-2.164,-1.191,-0.8667,-2.209,1.769,-0.6918,0.7987,1.516,0.0194,-0.018,1.847,-0.2455,-1.475,2.066,-2.766,-1.386,1.758,-3.427,-1.249,0,-3.426,-1.249,0,-3.418,0.8189,0,0.2209,-1.272,0,0.4548,-0.0643,1.301,-2.629,-2.164,0,-2.996,-2.02,0,-1.433,-2.387,1.191,-0.8667,-2.209,0,-0.6593,-2.02,0,0.2177,0.6159,-1.999,-1.38,2.185,-2.176,-3.43,2.255,-2.086,-1.904,3.481,-2.135,-3.43,3.55,-1.752,-2.236,4.789,-1.822,-3.43,5.142,-2.268,-2.793,2.238,-2.196,-2.812,3.511,-1.896,-2.795,5.11,-1.824,-3.427,0.8189,-2.006,-2.767,0.795,1.752,-2.236,4.789,0,-2.01,5.204,0,-2.79,5.66,1.896,-2.795,5.11,0,-3.43,5.622,1.822,-3.43,5.142,1.824,-3.427,0.8189,2.006,-2.767,0.795,2.268,-2.793,2.238,2.163,-1.38,2.185,2.086,-1.904,3.481,2.196,-2.812,3.511,0,-3.43,2.255,2.013,-3.43,2.255,2.135,-3.43,3.55,0,-3.43,3.55,0,-1.536,3.789,0,-0.2974,1.296,0,-0.9464,2.441,-1.954,-1.469,-1.432,1.954,-1.469,-1.431]);
IndexedFaceSet119.coord = Coordinate120;

TextureCoordinate TextureCoordinate121 = createNode("TextureCoordinate");
TextureCoordinate121.point = new MFVec2f(new float[0.1332,0.111,0.1385,0.0844,0.1146,0.1052,0.0718,0.0975,0.0744,0.0238,0.1384,0.0238,0.0784,0.0045,0.1384,0.0045,0.0777,0.1111,0.1132,0.1179,0.0516,0.0322,0.0558,0.0214,0.045,0.0628,0.0521,0.0813,0.2264,0.2171,0.2264,0.1898,0.288,0.1984,0.2792,0.2323,0.1736,0.2323,0.1648,0.1984,0.2556,0.0393,0.2873,0.0895,0.2812,0.0232,0.2651,0.023,0.2801,0.0044,0.266,0.0044,0.1808,0.0221,0.1792,0.0644,0.2172,0.049,0.2181,0.0225,0.1813,0.0044,0.2193,0.0044,0.2268,0.0825,0.2268,0.064,0.288,0.0793,0.2988,0.1248,0.2268,0.1162,0.2268,0.1899,0.2268,0.1537,0.2958,0.1609,0.2879,0.1996,0.1662,0.0895,0.1655,0.0793,0.1547,0.1248,0.1656,0.1996,0.1577,0.1609,0.0731,0.0615]);
...
HAnimJoint122.center = new SFVec3f(new float[0,30.98,-2.063]);
...
Transform124.translation = new SFVec3f(new float[0,30.98,-2.063]);
...
ImageTexture128.USE = "MinTextureAtlas";
...
HAnimJoint132.center = new SFVec3f(new float[5.199,51.119999,-2.106]);
...
Transform134.translation = new SFVec3f(new float[5.199,51.119999,-2.106]);
...
ImageTexture138.USE = "MinTextureAtlas";
...
HAnimJoint142.center = new SFVec3f(new float[7.024,42.73,-2.051]);
...
Transform144.translation = new SFVec3f(new float[7.024,42.73,-2.051]);
...
ImageTexture148.USE = "MinTextureAtlas";
...
HAnimJoint152.center = new SFVec3f(new float[7.221,34,-2.015]);
...
Transform154.translation = new SFVec3f(new float[7.221,34,-2.015]);
...
ImageTexture158.USE = "MinTextureAtlas";
...
HAnimJoint162.center = new SFVec3f(new float[-5.199,51.119999,-2.106]);
...
Transform164.translation = new SFVec3f(new float[-5.199,51.119999,-2.106]);
...
ImageTexture168.USE = "MinTextureAtlas";
...
HAnimJoint172.center = new SFVec3f(new float[-7.024,42.73,-2.051]);
...
Transform174.translation = new SFVec3f(new float[-7.024,42.73,-2.051]);
...
ImageTexture178.USE = "MinTextureAtlas";
...
HAnimJoint182.center = new SFVec3f(new float[-7.221,34,-2.015]);
...
Transform184.translation = new SFVec3f(new float[-7.221,34,-2.015]);
...
ImageTexture188.USE = "MinTextureAtlas";
...
Coordinate190.point = new MFVec3f(new float[-0.6858,-0.0091,1.043,-0.8572,-0.0091,0.3582,0.582,-0.0091,0.3582,0.5216,-0.0091,1.043,0.679,-2.66,0.2822,-0.9542,-2.992,0.2822,-0.7672,-2.714,1.233,0.603,-2.435,1.233,0.8768,-1.907,1.4,-1.041,-1.907,1.4,-1.041,-0.5983,1.4,0.8768,-0.5983,1.4,-1.281,-2.03,0.2845,-1.281,-0.5489,0.2845,-1.097,-1.908,-1.452,0.8213,-1.908,-1.452,0.8213,-0.5991,-1.452,-1.097,-0.5991,-1.452,1.005,-2.03,0.2845,1.005,-0.5489,0.2845,0.4661,-0.0091,-1.084,-0.7414,-0.0091,-1.084,-0.8227,-2.714,-1.198,0.5474,-2.436,-1.198,1.272,-1.761,1.213,1.272,-0.7447,1.213,1.476,-0.7234,0.4714,1.476,-1.856,0.4714]);
IndexedFaceSet189.coord = Coordinate190;

TextureCoordinate TextureCoordinate191 = createNode("TextureCoordinate");
TextureCoordinate191.point = new MFVec2f(new float[0.9934,0.082,0.9951,0.0877,0.9456,0.0877,0.9473,0.082,0.9034,0.0905,0.8766,0.0919,0.9942,0.009,0.945,0.0157,0.9371,0.0285,0.9969,0.0285,0.9969,0.0684,0.9371,0.0684,0.9993,0.0256,0.9993,0.0715,0.9975,0.0285,0.9365,0.0285,0.9365,0.0684,0.9975,0.0684,0.9312,0.0256,0.9312,0.0715,0.9489,0.082,0.9939,0.082,0.9948,0.009,0.9466,0.0157,0.9256,0.0321,0.9256,0.0648,0.9198,0.0672,0.9198,0.0298,0.8753,0.0485,0.9025,0.0502,0.9023,0.0288,0.8757,0.0269,0.8373,0.0909,0.8768,0.1071,0.8372,0.1061,0.8367,0.0504,0.837,0.0294,0.9035,0.1061,0.9975,0.0285,0.9387,0.0285,0.9387,0.0684,0.9975,0.0684,0.9489,0.082,0.9939,0.082]);
...
HAnimJoint192.center = new SFVec3f(new float[0,36.290001,-2.197]);
...
Transform194.translation = new SFVec3f(new float[0,36.290001,-2.197]);
...
ImageTexture198.USE = "MinTextureAtlas";
...
HAnimJoint202.center = new SFVec3f(new float[0,54.84,-1.903]);
...
Transform204.translation = new SFVec3f(new float[0,54.84,-1.903]);
...
ImageTexture208.USE = "MinTextureAtlas";
...
EXPORT230.AS = "KoreanCharacter11Min";
EXPORT230.localDEF = "hanim_Min";

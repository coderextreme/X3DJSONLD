...
Transform22.translation = new SFVec3f(new float[1,1.5,0]);
...
Material26.diffuseColor = new SFColor(new float[0.9,0.9,0.9]);
Appearance25.material = Material26;

Shape24.appearance = Appearance25;

Text Text27 = createNode("Text");
Text27.string = new MFString(new java.lang.String["Diamond Man Key"]);
FontStyle FontStyle28 = createNode("FontStyle");
FontStyle28.family = new MFString(new java.lang.String["SANS"]);
...
Transform29.translation = new SFVec3f(new float[0,-0.3,0]);
...
Transform34.translation = new SFVec3f(new float[0.2,0,0]);
...
Text38.string = new MFString(new java.lang.String["Minimal Humanoid Joints"]);
...
Billboard23.children[1] = Transform29;

Transform Transform40 = createNode("Transform");
Transform40.translation = new SFVec3f(new float[0,-0.5,0]);
...
Transform45.translation = new SFVec3f(new float[0.2,0,0]);
...
Text49.string = new MFString(new java.lang.String["Humanoid Joints"]);
FontStyle FontStyle50 = createNode("FontStyle");
FontStyle50.family = new MFString(new java.lang.String["SANS"]);
...
Billboard23.children[2] = Transform40;

Transform Transform51 = createNode("Transform");
Transform51.translation = new SFVec3f(new float[0,-0.7,0]);
...
Transform56.translation = new SFVec3f(new float[0.2,0,0]);
...
Text60.string = new MFString(new java.lang.String["Recommended Spinal Joints"]);
...
Transform51.children[1] = Transform56;

Billboard23.children[3] = Transform51;

Transform Transform62 = createNode("Transform");
Transform62.translation = new SFVec3f(new float[0,-0.9,0]);
...
Transform67.translation = new SFVec3f(new float[0.2,0,0]);
...
Text71.string = new MFString(new java.lang.String["Spinal Joints"]);
FontStyle FontStyle72 = createNode("FontStyle");
FontStyle72.family = new MFString(new java.lang.String["SANS"]);
...
Transform62.children[1] = Transform67;

Billboard23.children[4] = Transform62;

Transform Transform73 = createNode("Transform");
Transform73.translation = new SFVec3f(new float[0,-1.3,0]);
...
Transform78.translation = new SFVec3f(new float[0.2,0,0]);
...
Text82.string = new MFString(new java.lang.String["Humanoid Sites"]);
FontStyle FontStyle83 = createNode("FontStyle");
FontStyle83.family = new MFString(new java.lang.String["SANS"]);
...
Transform73.children[1] = Transform78;

Billboard23.children[5] = Transform73;

Transform Transform84 = createNode("Transform");
Transform84.translation = new SFVec3f(new float[0,-1.1,0]);
...
Sphere Sphere88 = createNode("Sphere");
...
Transform89.translation = new SFVec3f(new float[0.2,0,0]);
...
Text93.string = new MFString(new java.lang.String["Hand & Feet Joints"]);
FontStyle FontStyle94 = createNode("FontStyle");
FontStyle94.family = new MFString(new java.lang.String["SANS"]);
...
Billboard23.children[6] = Transform84;
...
HAnimHumanoid HAnimHumanoid95 = createNode("HAnimHumanoid");
HAnimHumanoid95.DEF = "hanim_humanoid";
HAnimHumanoid95.name = "humanoid";
HAnimHumanoid95.version = "1.0";
MetadataSet MetadataSet96 = createNode("MetadataSet");
...
MetadataSet96.value = new MFNode();

MetadataSet96.value[0] = MetadataString97;

HAnimHumanoid95.metadata = new SFNode();

HAnimHumanoid95.metadata[0] = MetadataSet96;
...
HAnimHumanoid95.viewpoints[166] = HAnimSite1059;

children[4] = HAnimHumanoid95;

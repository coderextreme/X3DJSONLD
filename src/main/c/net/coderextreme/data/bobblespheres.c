...
PhysicalMaterial71.extensions = new MFNode();

PhysicalMaterial71.extensions[0] = IORMaterialExtension72;
...
PhysicalMaterial84.extensions = new MFNode();

PhysicalMaterial84.extensions[0] = IridescenceMaterialExtension85;

...
Transform13.translation = new SFVec3f(new float[10,10,-10]);
...
ImageTexture17.url = new MFString(new java.lang.String["images/WSDedicationAll.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSDedicationAll.png"]);

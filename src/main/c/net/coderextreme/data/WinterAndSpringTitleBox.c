...
Viewpoint12.position = new SFVec3f(new float[10,11,5]);
...
Transform13.translation = new SFVec3f(new float[10,10,0]);
...
ImageTexture17.url = new MFString(new java.lang.String["images/WinterAndSpring.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WinterAndSpring.png"]);

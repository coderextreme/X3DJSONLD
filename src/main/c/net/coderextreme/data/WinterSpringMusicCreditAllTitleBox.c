...
Viewpoint12.position = new SFVec3f(new float[10,11,-15]);
...
Transform13.translation = new SFVec3f(new float[10,10,-20]);
...
ImageTexture17.url = new MFString(new java.lang.String["images/WSMusicCreditAll.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSMusicCreditAll.png"]);

...
meta11.name = "Image";
meta11.content = "../Poses/images/HAnimPoseExampleKoreanCharacter05Ju.png";
head1.meta[9] = meta11;
...
meta15.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter05Ju.x3d";
...
meta17.content = "Suwon University HAnim Editor";
...
meta19.content = "X3D-Edit 3.3, https://www.web3d.org/x3d/tools/X3D-Edit";
...
children[1] = NavigationInfo23;

Viewpoint Viewpoint24 = createNode("Viewpoint");
Viewpoint24.centerOfRotation = new SFVec3f(new float[0,1,0]);
Viewpoint24.description = "Ju";
Viewpoint24.position = new SFVec3f(new float[0,1,3]);
children[2] = Viewpoint24;

HAnimHumanoid HAnimHumanoid25 = createNode("HAnimHumanoid");
HAnimHumanoid25.name = "Ju";
HAnimHumanoid25.DEF = "hanim_Ju";
HAnimHumanoid25.scale = new SFVec3f(new float[0.0225,0.0225,0.0225]);
...
MetadataString27.value = new MFString(new java.lang.String["Chul Hee Jung and Myeong Won Lee"]);
...
MetadataString28.value = new MFString(new java.lang.String["myeongwonlee@gmail.com"]);
MetadataSet26.value[1] = MetadataString28;

MetadataString MetadataString29 = createNode("MetadataString");
MetadataString29.name = "creationDate";
MetadataString29.value = new MFString(new java.lang.String["31 March 2011"]);
MetadataSet26.value[2] = MetadataString29;

MetadataString MetadataString30 = createNode("MetadataString");
MetadataString30.name = "gender";
MetadataString30.value = new MFString(new java.lang.String["female"]);
MetadataSet26.value[3] = MetadataString30;

MetadataFloat MetadataFloat31 = createNode("MetadataFloat");
MetadataFloat31.name = "height";
MetadataFloat31.value = new MFFloat(new float[1.5]);
MetadataSet26.value[4] = MetadataFloat31;

MetadataString MetadataString32 = createNode("MetadataString");
MetadataString32.name = "humanoidVersion";
MetadataString32.value = new MFString(new java.lang.String["2.0"]);
MetadataSet26.value[5] = MetadataString32;
...
HAnimJoint33.center = new SFVec3f(new float[0,36,-0.008798]);
...
Transform35.translation = new SFVec3f(new float[0,36,-0.008798]);
Shape Shape36 = createNode("Shape");
Appearance Appearance37 = createNode("Appearance");
Material Material38 = createNode("Material");
Material38.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance37.material = Material38;

ImageTexture ImageTexture39 = createNode("ImageTexture");
ImageTexture39.DEF = "JuTextureAtlas";
ImageTexture39.url = new MFString(new java.lang.String["images/Ju.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ju.png"]);
Appearance37.texture = ImageTexture39;
...
HAnimJoint43.center = new SFVec3f(new float[3.22,33.619999,-0.2832]);
...
Transform45.translation = new SFVec3f(new float[3.22,33.619999,-0.2832]);
Shape Shape46 = createNode("Shape");
Appearance Appearance47 = createNode("Appearance");
Material Material48 = createNode("Material");
Material48.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
IndexedFaceSet50.texCoord = TextureCoordinate52;
...
HAnimJoint53.center = new SFVec3f(new float[3.454,18.67,-0.02158]);
...
Transform55.translation = new SFVec3f(new float[3.454,18.67,-0.02158]);
Shape Shape56 = createNode("Shape");
Appearance Appearance57 = createNode("Appearance");
Material Material58 = createNode("Material");
Material58.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint63.center = new SFVec3f(new float[3.467,3.522,0.118]);
...
HAnimJoint73.center = new SFVec3f(new float[3.467,3.251,1.465]);
...
HAnimJoint53.children[1] = HAnimJoint63;

HAnimJoint43.children[1] = HAnimJoint53;

HAnimJoint33.children[1] = HAnimJoint43;

HAnimJoint HAnimJoint83 = createNode("HAnimJoint");
HAnimJoint83.name = "r_hip";
HAnimJoint83.DEF = "hanim_r_hip";
HAnimJoint83.center = new SFVec3f(new float[-3.22,33.619999,-0.2832]);
...
Transform85.translation = new SFVec3f(new float[-3.22,33.619999,-0.2832]);
Shape Shape86 = createNode("Shape");
Appearance Appearance87 = createNode("Appearance");
Material Material88 = createNode("Material");
Material88.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint93.center = new SFVec3f(new float[-3.454,18.67,-0.02158]);
...
Transform95.translation = new SFVec3f(new float[-3.454,18.67,-0.02158]);
Shape Shape96 = createNode("Shape");
Appearance Appearance97 = createNode("Appearance");
Material Material98 = createNode("Material");
Material98.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
IndexedFaceSet100.texCoordIndex = new MFInt32(new int[0,1,2,-1,2,3,4,-1,0,2,4,-1,0,4,5,-1,6,0,5,-1,9,10,7,-1,7,8,9,-1,12,9,8,-1,8,11,12,-1,14,12,11,-1,11,13,14,-1,16,14,13,-1,13,15,16,-1,18,16,15,-1,15,17,18,-1,20,18,17,-1,17,19,20,-1,10,20,19,-1,19,7,10,-1,21,22,10,-1,10,9,21,-1,23,21,9,-1,9,12,23,-1,24,23,12,-1,12,14,24,-1,25,24,14,-1,14,16,25,-1,26,25,16,-1,16,18,26,-1,27,26,18,-1,18,20,27,-1,22,27,20,-1,20,10,22,-1,1,0,22,-1,22,21,1,-1,2,1,21,-1,21,23,2,-1,3,2,23,-1,23,24,3,-1,4,3,24,-1,24,25,4,-1,5,4,25,-1,25,26,5,-1,6,5,26,-1,26,27,6,-1,0,6,27,-1,27,22,0,-1,8,7,28,-1,28,29,8,-1,11,8,29,-1,29,30,11,-1,13,11,30,-1,30,31,13,-1,15,13,31,-1,31,32,15,-1,17,15,32,-1,32,33,17,-1,19,17,33,-1,33,34,19,-1,7,19,34,-1,34,28,7,-1,29,28,35,-1,35,36,29,-1,30,29,36,-1,36,37,30,-1,31,30,37,-1,37,38,31,-1,32,31,38,-1,38,39,32,-1,33,32,39,-1,39,40,33,-1,34,33,40,-1,40,41,34,-1,28,34,41,-1,41,35,28,-1]);
Coordinate Coordinate101 = createNode("Coordinate");
Coordinate101.point = new MFVec3f(new float[-0.7406,0.9639,0.0216,-0.4117,0.9639,0.8655,0.3272,0.9639,1.036,0.9197,0.9639,0.5579,0.9197,0.9639,-0.3619,0.3272,0.9639,-0.8401,-0.4117,0.9639,-0.6694,-2.238,-4.201,0.0216,-1.426,-3.284,1.868,-1.219,-1.439,2.239,-2.036,-1.701,0.0216,0.6748,-3.284,2.375,0.6153,-1.439,2.686,2.01,-4.201,1.161,2.086,-1.701,0.9061,2.01,-4.913,-1.265,2.086,-1.701,-0.8628,0.6748,-4.913,-2.686,0.6153,-1.701,-2.191,-1.426,-4.913,-2.179,-1.219,-1.701,-1.744,-1.112,0.0646,1.755,-1.864,0.0646,0.0216,0.5772,0.0646,2.145,1.932,0.0646,1.051,1.932,0.0646,-0.8553,0.5772,0.0646,-1.907,-1.112,0.0646,-1.517,-2.345,-14.69,-0.0151,-1.416,-14.67,2.102,0.6712,-14.67,2.624,2.345,-14.69,1.16,2.345,-14.71,-1.342,0.6712,-14.71,-2.38,-1.416,-14.71,-1.857,-0.73,-16.18,0.0221,-0.4092,-16.17,0.7532,0.3118,-16.17,0.9337,0.89,-16.18,0.4278,0.89,-16.19,-0.4362,0.3118,-16.19,-0.7945,-0.4092,-16.19,-0.614]);
IndexedFaceSet100.coord = Coordinate101;

TextureCoordinate TextureCoordinate102 = createNode("TextureCoordinate");
TextureCoordinate102.point = new MFVec2f(new float[0.7637,0.172,0.755,0.172,0.7356,0.172,0.72,0.172,0.72,0.172,0.7356,0.172,0.755,0.172,0.8032,0.2271,0.7818,0.2173,0.7763,0.1976,0.7978,0.2004,0.7264,0.2173,0.728,0.1976,0.6912,0.2271,0.6892,0.2004,0.6912,0.2347,0.6892,0.2004,0.7264,0.2347,0.728,0.2004,0.7818,0.2347,0.7763,0.2004,0.7735,0.1816,0.7933,0.1816,0.729,0.1816,0.6933,0.1816,0.6933,0.1816,0.729,0.1816,0.7735,0.1816,0.806,0.339,0.7815,0.3388,0.7265,0.3388,0.6824,0.339,0.6824,0.3392,0.7265,0.3392,0.7815,0.3392,0.7634,0.3549,0.755,0.3548,0.736,0.3548,0.7207,0.3549,0.7207,0.355,0.736,0.355,0.755,0.355]);
IndexedFaceSet100.texCoord = TextureCoordinate102;
...
HAnimJoint103.center = new SFVec3f(new float[-3.679,3.522,0.118]);
...
Transform105.translation = new SFVec3f(new float[-3.679,3.522,0.118]);
Shape Shape106 = createNode("Shape");
Appearance Appearance107 = createNode("Appearance");
Material Material108 = createNode("Material");
Material108.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance107.material = Material108;

ImageTexture ImageTexture109 = createNode("ImageTexture");
ImageTexture109.USE = "JuTextureAtlas";
Appearance107.texture = ImageTexture109;
...
HAnimJoint113.center = new SFVec3f(new float[-3.679,3.251,1.465]);
...
Transform115.translation = new SFVec3f(new float[-3.679,3.251,1.465]);
Shape Shape116 = createNode("Shape");
Appearance Appearance117 = createNode("Appearance");
Material Material118 = createNode("Material");
Material118.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint93.children[1] = HAnimJoint103;

HAnimJoint83.children[1] = HAnimJoint93;

HAnimJoint33.children[2] = HAnimJoint83;

HAnimJoint HAnimJoint123 = createNode("HAnimJoint");
HAnimJoint123.name = "sacroiliac";
HAnimJoint123.DEF = "hanim_sacroiliac";
HAnimJoint123.center = new SFVec3f(new float[0.000034,31.26,-0.008798]);
...
Transform125.translation = new SFVec3f(new float[0.000034,31.26,-0.008798]);
Shape Shape126 = createNode("Shape");
Appearance Appearance127 = createNode("Appearance");
Material Material128 = createNode("Material");
Material128.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
Coordinate131.point = new MFVec3f(new float[0,10.03,0.1297,0,9.057,-2.567,-2.075,9.057,-2.206,-3.594,9.057,-1.77,-4.15,9.057,0.1297,-3.594,9.057,2.03,-2.075,9.057,2.465,0,9.057,2.827,2.075,9.057,2.465,3.594,9.057,2.03,4.15,9.057,0.1297,3.594,9.057,-1.77,2.075,9.057,-2.206,0,6.725,-4.193,-2.684,7.001,-3.614,-4.648,7.228,-2.032,-5.367,7.228,0.1297,-4.648,7.4,2.189,-2.684,7.228,3.313,0,7.024,4.004,2.684,7.228,3.313,4.648,7.4,2.189,5.367,7.228,0.1297,4.648,7.228,-2.032,2.684,7.001,-3.614,0,4.745,-4.3,-2.936,4.743,-3.667,-5.089,4.738,-2.28,-5.874,4.731,0.133,-5.102,4.731,2.476,-2.963,4.731,3.656,0,4.73,4.3,2.963,4.73,3.656,5.102,4.73,2.476,5.874,4.731,0.134,5.088,4.737,-2.281,2.936,4.743,-3.667,0,2.358,-3.663,-2.543,2.356,-3.113,-4.402,2.355,-1.613,-5.084,2.358,0.134,-4.415,2.354,2.157,-2.562,2.341,3.097,0,2.339,3.654,2.56,2.347,3.101,4.417,2.357,2.158,5.083,2.357,0.1338,4.404,2.356,-1.611,2.542,2.358,-3.115,0,0.6228,-1.923,-1.478,0.6244,-1.603,-2.538,0.622,-1.037,-2.926,0.6243,0.1308,-2.535,0.6248,1.308,-1.464,0.6148,2.154,0,0.6102,2.466,1.455,0.6123,2.154,2.534,0.6219,1.301,2.927,0.6248,0.1297,2.539,0.6184,-1.027,1.471,0.6221,-1.602,0,-0.0048,0.1335,0,6.687,-3.936,-2.527,6.96,-3.39,-4.378,7.174,-1.899,-5.055,7.161,0.1297,-4.396,7.33,2.041,-2.558,7.161,3.082,0,6.834,3.759,2.555,7.163,3.083,4.397,7.332,2.039,5.054,7.163,0.1318,4.376,7.176,-1.9,2.527,6.96,-3.39]);
IndexedFaceSet130.coord = Coordinate131;

TextureCoordinate TextureCoordinate132 = createNode("TextureCoordinate");
TextureCoordinate132.point = new MFVec2f(new float[0.2061,0.2498,0.2067,0.1822,0.1471,0.1822,0.1035,0.1822,0.0875,0.1822,0.1035,0.1822,0.1471,0.1822,0.2067,0.1822,0.2663,0.1822,0.31,0.1822,0.3259,0.1822,0.31,0.1822,0.2663,0.1822,0.208,0.1494,0.1373,0.1495,0.0855,0.1495,0.0666,0.1495,0.0855,0.1496,0.1373,0.1495,0.208,0.1495,0.2788,0.1495,0.3305,0.1496,0.3495,0.1495,0.3305,0.1495,0.2788,0.1495,0.208,0.1494,0.1414,0.1495,0.0926,0.1495,0.0748,0.1495,0.0922,0.1495,0.1406,0.1495,0.208,0.1495,0.2754,0.1495,0.3239,0.1495,0.3412,0.1495,0.3234,0.1495,0.2746,0.1495,0.995,0.6227,0.9911,0.5634,0.9445,0.5634,0.9587,0.6143,0.8611,0.5667,0.8645,0.6158,0.8296,0.5725,0.8297,0.6181,0.7843,0.5725,0.7986,0.6221,0.7343,0.5716,0.7402,0.6181,0.6899,0.5733,0.7033,0.6238,0.7343,0.5716,0.7402,0.6181,0.7843,0.5724,0.7986,0.6221,0.8296,0.5725,0.8297,0.6181,0.8611,0.5667,0.8646,0.6158,0.9445,0.5634,0.9587,0.6143,0.9874,0.5161,0.9409,0.5169,0.8667,0.527,0.8296,0.5279,0.7882,0.5304,0.7381,0.5276,0.6693,0.5234,0.738,0.5277,0.7882,0.5305,0.8296,0.5279,0.8666,0.5271,0.9409,0.517,0.9852,0.4793,0.8833,0.4954,0.8658,0.4954,0.8297,0.4954,0.7933,0.4954,0.7672,0.4952,0.6706,0.4859,0.7672,0.4952,0.7936,0.4954,0.8297,0.4954,0.8655,0.4953,0.8832,0.4954,0.8296,0.4836]);
...
HAnimJoint133.center = new SFVec3f(new float[4.778,51.029999,-2.069]);
...
Transform135.translation = new SFVec3f(new float[4.778,51.029999,-2.069]);
Shape Shape136 = createNode("Shape");
Appearance Appearance137 = createNode("Appearance");
Material Material138 = createNode("Material");
Material138.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint143.center = new SFVec3f(new float[5.297,40.119999,-2.055]);
...
Transform145.translation = new SFVec3f(new float[5.297,40.119999,-2.055]);
Shape Shape146 = createNode("Shape");
Appearance Appearance147 = createNode("Appearance");
Material Material148 = createNode("Material");
Material148.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint153.center = new SFVec3f(new float[5.07,31.99,-1.559]);
...
Transform155.translation = new SFVec3f(new float[5.07,31.99,-1.559]);
Shape Shape156 = createNode("Shape");
Appearance Appearance157 = createNode("Appearance");
Material Material158 = createNode("Material");
Material158.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint143.children[1] = HAnimJoint153;

HAnimJoint133.children[1] = HAnimJoint143;
...
HAnimJoint163.center = new SFVec3f(new float[-4.778,51.029999,-2.069]);
...
TextureCoordinate172.point = new MFVec2f(new float[0.2661,0.1332,0.3717,0.1332,0.1245,0.1332,0.0067,0.1321,0.2119,0.1332,0.2707,0.1099,0.3728,0.1099,0.1275,0.1099,0.0049,0.1088,0.2167,0.1099,0.271,0.0284,0.3751,0.0284,0.1295,0.0284,0.0061,0.0273,0.2178,0.0284,0.2716,0.0086,0.3751,0.0086,0.1299,0.0086,0.0058,0.0075,0.2184,0.0086,0.2836,0.0426,0.3685,0.0426,0.1368,0.0426,0.0085,0.0415,0.2198,0.0426,0.0067,0.1343,0.0084,0.111,0.0084,0.111,0.0073,0.0295,0.0073,0.0295,0.0076,0.0097,0.0076,0.0097,0.0065,0.0437,0.6285,0.3174,0.6285,0.3316,0.6285,0.3312,0.6285,0.3167,0.6285,0.3082,0.5864,0.3116,0.5864,0.3376,0.6087,0.339,0.6087,0.3139,0.5864,0.3394,0.6087,0.3383,0.5864,0.3146,0.6087,0.3128,0.5864,0.2974,0.6087,0.2977,0.6261,0.339,0.6261,0.3148,0.6261,0.3383,0.6261,0.3137,0.6261,0.2992,0.0441,0.1287,-0.1162,0.128]);
IndexedFaceSet170.texCoord = TextureCoordinate172;

Shape166.geometry = IndexedFaceSet170;
...
HAnimJoint173.center = new SFVec3f(new float[-5.297,40.119999,-2.055]);
...
Transform175.translation = new SFVec3f(new float[-5.297,40.119999,-2.055]);
Shape Shape176 = createNode("Shape");
Appearance Appearance177 = createNode("Appearance");
Material Material178 = createNode("Material");
Material178.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance177.material = Material178;

ImageTexture ImageTexture179 = createNode("ImageTexture");
ImageTexture179.USE = "JuTextureAtlas";
Appearance177.texture = ImageTexture179;
...
Coordinate181.point = new MFVec3f(new float[-0.1284,0.6566,-0.794,-0.7947,0.6566,-0.1619,-0.4154,0.6566,0.757,0.4852,0.6566,0.6929,0.6626,0.6566,-0.2657,-0.0855,-0.4623,-1.129,-1.027,-0.4623,-0.281,-0.4911,-0.4623,1.171,0.7817,-0.4623,1.07,1.032,-0.4623,-0.445,-0.0941,-3.046,-1.116,-1.1,-3.046,-0.2777,-0.55,-2.481,1.16,0.8091,-2.481,1.06,1.1,-3.046,-0.4401,-0.084,-8.01,-1.171,-1.025,-7.982,-0.1359,-0.3907,-8.118,1.09,0.6003,-8.118,0.9957,0.9132,-8.109,-0.2244,-0.0434,-8.725,-0.6054,-0.5441,-8.725,0.0272,-0.2591,-8.725,0.759,0.4177,-8.725,0.6949,0.551,-8.725,-0.0767]);
IndexedFaceSet180.coord = Coordinate181;

TextureCoordinate TextureCoordinate182 = createNode("TextureCoordinate");
TextureCoordinate182.point = new MFVec2f(new float[0.5159,0.3385,0.5159,0.3244,0.5159,0.3332,0.5159,0.3157,0.5159,0.3103,0.521,0.3428,0.521,0.3229,0.521,0.3355,0.521,0.3108,0.521,0.3029,0.5327,0.3442,0.5327,0.3231,0.5302,0.3366,0.5302,0.3103,0.5327,0.3016,0.5558,0.339,0.5558,0.323,0.5558,0.3334,0.5558,0.3141,0.5558,0.3079,0.5585,0.3232,0.5585,0.3341,0.5585,0.3302,0.5585,0.317,0.5585,0.3129]);
IndexedFaceSet180.texCoord = TextureCoordinate182;

Shape176.geometry = IndexedFaceSet180;
...
HAnimJoint183.center = new SFVec3f(new float[-5.07,31.99,-1.559]);
...
Transform185.translation = new SFVec3f(new float[-5.07,31.99,-1.559]);
Shape Shape186 = createNode("Shape");
Appearance Appearance187 = createNode("Appearance");
Material Material188 = createNode("Material");
Material188.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance187.material = Material188;

ImageTexture ImageTexture189 = createNode("ImageTexture");
ImageTexture189.USE = "JuTextureAtlas";
Appearance187.texture = ImageTexture189;
...
HAnimJoint173.children[1] = HAnimJoint183;

HAnimJoint163.children[1] = HAnimJoint173;

HAnimJoint123.children[2] = HAnimJoint163;

HAnimJoint HAnimJoint193 = createNode("HAnimJoint");
HAnimJoint193.name = "vl5";
HAnimJoint193.DEF = "hanim_vl5";
HAnimJoint193.center = new SFVec3f(new float[0.000025,39.84,0.1163]);
...
Transform195.translation = new SFVec3f(new float[0.000025,39.84,0.1163]);
Shape Shape196 = createNode("Shape");
Appearance Appearance197 = createNode("Appearance");
Material Material198 = createNode("Material");
Material198.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
...
HAnimJoint203.center = new SFVec3f(new float[0.000025,56.07,-1.554]);
...
Transform205.translation = new SFVec3f(new float[0.000025,56.07,-1.554]);
Shape Shape206 = createNode("Shape");
Appearance Appearance207 = createNode("Appearance");
Material Material208 = createNode("Material");
Material208.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);

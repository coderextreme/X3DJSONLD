...
meta2.name = "title";
meta2.content = "KoreanCharacter02Chul.x3d";
...
meta12.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter02Chul.x3d";
...
WorldInfo19.title = "KoreanCharacter02Chul.x3d";
children = new MFNode();
...
HAnimHumanoid22.DEF = "hanim_Chul";
HAnimHumanoid22.version = "2.0";
HAnimHumanoid22.name = "Chul";
...
HAnimJoint25.center = new SFVec3f(new float[0,44.07,-1.034]);
HAnimSegment HAnimSegment26 = createNode("HAnimSegment");
HAnimSegment26.DEF = "hanim_sacrum";
HAnimSegment26.name = "sacrum";
Transform Transform27 = createNode("Transform");
Transform27.translation = new SFVec3f(new float[0,44.07,-1.034]);
Shape Shape28 = createNode("Shape");
Appearance Appearance29 = createNode("Appearance");
Material Material30 = createNode("Material");
Material30.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance29.material = Material30;

ImageTexture ImageTexture31 = createNode("ImageTexture");
ImageTexture31.DEF = "ChulTextureAtlas";
ImageTexture31.url = new MFString(new java.lang.String["images/Chul.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Chul.png"]);
Appearance29.texture = ImageTexture31;

Shape28.appearance = Appearance29;

IndexedFaceSet IndexedFaceSet32 = createNode("IndexedFaceSet");
IndexedFaceSet32.creaseAngle = 1.57;
...
Coordinate34.point = new MFVec3f(new float[0,0.87,0.0225,0,0.7535,-0.4472,-0.3613,0.7535,-0.3842,-0.6259,0.7535,-0.3083,-0.7227,0.7535,0.0225,-0.6259,0.7535,0.3534,-0.3613,0.7535,0.4293,0,0.7535,0.4922,0.3613,0.7535,0.4293,0.6259,0.7535,0.3534,0.7227,0.7535,0.0225,0.6259,0.7535,-0.3083,0.3613,0.7535,-0.3842,0,0.435,-0.7303,-0.4673,0.435,-0.6294,-0.8094,0.435,-0.3539,-0.9347,0.435,0.0225,-0.8094,0.435,0.399,-0.4673,0.435,0.5769,0,0.435,0.6777,0.4673,0.435,0.5769,0.8094,0.435,0.399,0.9347,0.435,0.0225,0.8094,0.435,-0.3539,0.4673,0.435,-0.6294,0,0,-0.7942,-0.5396,0,-0.6777,-0.9347,0,-0.3596,-1.079,0,0.0225,-0.9347,0,0.4572,-0.5396,0,0.6777,0,0,0.7942,0.5396,0,0.6777,0.9347,0,0.4572,1.079,0,0.0225,0.9347,0,-0.3596,0.5396,0,-0.6777,0,-0.435,-0.6777,-0.4673,-0.435,-0.5769,-0.8094,-0.435,-0.3013,-0.9347,-0.435,0.0225,-0.8094,-0.435,0.399,-0.4673,-0.435,0.5769,0,-0.435,0.6777,0.4673,-0.435,0.5769,0.8094,-0.435,0.399,0.9347,-0.435,0.0225,0.8094,-0.435,-0.3013,0.4673,-0.435,-0.5769,0,-0.7535,-0.3596,-0.2698,-0.7535,-0.3013,-0.4673,-0.7535,-0.1948,-0.5396,-0.7535,0.0225,-0.4673,-0.7535,0.2399,-0.2698,-0.7535,0.399,0,-0.7535,0.4572,0.2698,-0.7535,0.399,0.4673,-0.7535,0.2399,0.5396,-0.7535,0.0225,0.4673,-0.7535,-0.1948,0.2698,-0.7535,-0.3013,0,-0.87,0.0225]);
...
HAnimSegment26.children[0] = Transform27;
...
HAnimJoint35.DEF = "hanim_l_hip";
HAnimJoint35.name = "l_hip";
HAnimJoint35.center = new SFVec3f(new float[4.001,41.14,-1.119]);
HAnimSegment HAnimSegment36 = createNode("HAnimSegment");
HAnimSegment36.DEF = "hanim_l_thigh";
HAnimSegment36.name = "l_thigh";
Transform Transform37 = createNode("Transform");
Transform37.translation = new SFVec3f(new float[4.001,41.14,-1.119]);
Shape Shape38 = createNode("Shape");
Appearance Appearance39 = createNode("Appearance");
Material Material40 = createNode("Material");
Material40.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance39.material = Material40;

ImageTexture ImageTexture41 = createNode("ImageTexture");
ImageTexture41.USE = "ChulTextureAtlas";
...
HAnimSegment36.children[0] = Transform37;
...
HAnimJoint55.center = new SFVec3f(new float[4.574,6.838,-1.463]);
...
HAnimJoint55.children[1] = HAnimJoint65;

HAnimJoint45.children[1] = HAnimJoint55;

HAnimJoint35.children[1] = HAnimJoint45;

HAnimJoint25.children[1] = HAnimJoint35;

HAnimJoint HAnimJoint75 = createNode("HAnimJoint");
HAnimJoint75.DEF = "hanim_r_hip";
HAnimJoint75.name = "r_hip";
HAnimJoint75.center = new SFVec3f(new float[-4.001,41.14,-1.119]);
HAnimSegment HAnimSegment76 = createNode("HAnimSegment");
HAnimSegment76.DEF = "hanim_r_thigh";
HAnimSegment76.name = "r_thigh";
Transform Transform77 = createNode("Transform");
Transform77.translation = new SFVec3f(new float[-4.001,41.14,-1.119]);
Shape Shape78 = createNode("Shape");
Appearance Appearance79 = createNode("Appearance");
Material Material80 = createNode("Material");
Material80.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance79.material = Material80;

ImageTexture ImageTexture81 = createNode("ImageTexture");
ImageTexture81.USE = "ChulTextureAtlas";
...
HAnimJoint85.center = new SFVec3f(new float[-4.315,25.19,-1.119]);
...
Coordinate94.point = new MFVec3f(new float[-2.59,-0.0184,0,-1.415,-0.0184,2.862,1.224,-0.0184,3.569,3.033,-0.0184,1.588,3.033,-0.0184,-1.588,1.224,-0.0184,-3.569,-1.415,-0.0184,-2.862,-2.59,-3.362,0,-1.415,-3.362,2.862,1.224,-3.362,3.569,3.033,-3.362,1.588,3.033,-3.362,-1.588,1.224,-3.362,-3.569,-1.415,-3.362,-2.862,-2.59,-13.66,0,-1.415,-13.66,2.862,1.224,-13.66,3.569,3.033,-13.66,1.588,3.033,-13.66,-1.588,1.224,-13.66,-3.569,-1.415,-13.66,-2.862,-3.239,-19.57,0,-1.813,-19.57,3.472,1.389,-19.57,4.33,3.239,-19.57,1.927,3.239,-19.57,-1.927,1.389,-19.57,-4.33,-1.813,-19.57,-3.472,-1.863,-12.3,0,-0.9622,-12.3,2.196,1.063,-12.3,2.738,2.378,-12.3,1.219,2.378,-12.3,-1.219,1.063,-12.3,-2.738,-0.9622,-12.3,-2.196,-1.778,1.756,0,-0.9091,1.756,2.118,1.044,1.756,2.641,2.61,1.756,1.175,2.61,1.756,-1.175,1.044,1.756,-2.641,-0.9091,1.756,-2.118]);
...
HAnimJoint95.center = new SFVec3f(new float[-4.574,6.838,-1.463]);
...
IndexedFaceSet102.creaseAngle = 1.57;
...
Coordinate104.point = new MFVec3f(new float[-0.8202,-6.687,-3.411,-2.567,-6.814,0.3665,-0.4068,-6.835,0.5953,2.033,-6.8,0.7383,-2.347,-6.742,-2.364,2.159,-6.722,-2.362,-1.391,0.0721,-0.2632,-2.329,-3.518,-2.264,-1.029,0.4254,-1.355,-2.148,-3.639,0.4281,-0.578,-3.439,-3.248,-0.1667,-0.7673,-2.634,-0.6108,-0.1555,0.5745,1.165,-0.0864,1.722,2.436,-3.539,-2.293,1.3,-0.7319,-2.864,2.025,-3.634,0.7655,2.416,-1.184,-1.037,2.567,-0.7486,1.337,0.5315,0.4359,-0.5649,-1.591,-1.917,2.128,0.6895,-0.8855,3.411,2.449,-2.096,3.113,-0.575,-6.557,1.961,-2.022,-6.548,1.82,-1.675,-4.087,1.579,-1.205,-2.631,3.158,0.5196,-1.891,4.248,1.582,-2.617,4.058,1.245,-3.851,1.847,1.226,-6.514,2.023]);
...
HAnimJoint105.DEF = "hanim_r_metatarsophalangeal_1";
HAnimJoint105.name = "r_metatarsophalangeal_2";
HAnimJoint105.center = new SFVec3f(new float[-4.809,5.583,1.492]);
HAnimSegment HAnimSegment106 = createNode("HAnimSegment");
HAnimSegment106.DEF = "hanim_r_tarsal_proximal_phalanx_1";
HAnimSegment106.name = "r_tarsal_proximal_phalanx_2";
Transform Transform107 = createNode("Transform");
Transform107.translation = new SFVec3f(new float[-4.809,5.583,1.492]);
Shape Shape108 = createNode("Shape");
Appearance Appearance109 = createNode("Appearance");
Material Material110 = createNode("Material");
Material110.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance109.material = Material110;

ImageTexture ImageTexture111 = createNode("ImageTexture");
ImageTexture111.USE = "ChulTextureAtlas";
...
Coordinate114.point = new MFVec3f(new float[-2.803,-5.588,0.6731,-0.2267,-5.589,2.081,2.411,-5.604,1.896,-2.336,-2.423,0.7256,0.4491,-0.4293,2.144,2.566,-2.188,1.933,0.2886,-2.342,8.508,-2.628,-5.51,5.676,-2.567,-2.341,5.71,0.0624,-5.51,8.465,1.743,-5.522,7.68,1.73,-2.103,7.711,0.0387,-5.541,5.353,-2.584,-5.536,2.735,2.525,-5.553,5.417,0.265,-1.11,5.396,-2.299,-2.375,2.776,2.512,-2.385,5.448,-2.332,-5.559,-2.589,-0.1713,-5.58,-2.36,2.269,-5.545,-2.217,-1.912,-2.384,-2.527,2.26,-2.379,-2.19,-1.356,-0.6618,-0.8278,0.925,0.3698,0.4552,2.684,-0.8406,0.1573,-1.828,-3.703,-4.62,-0.0134,-3.719,-4.434,1.422,-3.68,-4.33,1.411,-0.7578,-4.754,-0.2889,-0.8748,-4.705]);
...
HAnimJoint95.children[1] = HAnimJoint105;

HAnimJoint85.children[1] = HAnimJoint95;

HAnimJoint75.children[1] = HAnimJoint85;

HAnimJoint25.children[2] = HAnimJoint75;

HAnimJoint HAnimJoint115 = createNode("HAnimJoint");
HAnimJoint115.DEF = "hanim_sacroiliac";
HAnimJoint115.name = "sacroiliac";
HAnimJoint115.center = new SFVec3f(new float[0,38.64,-1.034]);
HAnimSegment HAnimSegment116 = createNode("HAnimSegment");
HAnimSegment116.DEF = "hanim_pelvis";
HAnimSegment116.name = "pelvis";
Transform Transform117 = createNode("Transform");
Transform117.translation = new SFVec3f(new float[0,38.64,-1.034]);
Shape Shape118 = createNode("Shape");
Appearance Appearance119 = createNode("Appearance");
Material Material120 = createNode("Material");
Material120.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance119.material = Material120;

ImageTexture ImageTexture121 = createNode("ImageTexture");
ImageTexture121.USE = "ChulTextureAtlas";
...
IndexedFaceSet122.creaseAngle = 1.57;
...
HAnimJoint125.DEF = "hanim_l_shoulder";
HAnimJoint125.name = "l_shoulder";
HAnimJoint125.center = new SFVec3f(new float[7.699,59.42,-1.567]);
HAnimSegment HAnimSegment126 = createNode("HAnimSegment");
HAnimSegment126.DEF = "hanim_l_upperarm";
HAnimSegment126.name = "l_upperarm";
Transform Transform127 = createNode("Transform");
Transform127.translation = new SFVec3f(new float[7.699,59.42,-1.567]);
Shape Shape128 = createNode("Shape");
Appearance Appearance129 = createNode("Appearance");
Material Material130 = createNode("Material");
Material130.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance129.material = Material130;

ImageTexture ImageTexture131 = createNode("ImageTexture");
ImageTexture131.USE = "ChulTextureAtlas";
...
IndexedFaceSet142.creaseAngle = 1.57;
...
HAnimJoint145.DEF = "hanim_l_radiocarpal";
HAnimJoint145.name = "l_radiocarpal";
HAnimJoint145.center = new SFVec3f(new float[7.617,37.69,-1.663]);
HAnimSegment HAnimSegment146 = createNode("HAnimSegment");
HAnimSegment146.DEF = "hanim_l_carpal";
HAnimSegment146.name = "l_carpal";
Transform Transform147 = createNode("Transform");
Transform147.translation = new SFVec3f(new float[7.617,37.69,-1.663]);
Shape Shape148 = createNode("Shape");
Appearance Appearance149 = createNode("Appearance");
Material Material150 = createNode("Material");
Material150.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance149.material = Material150;

ImageTexture ImageTexture151 = createNode("ImageTexture");
ImageTexture151.USE = "ChulTextureAtlas";
...
HAnimJoint135.children[1] = HAnimJoint145;

HAnimJoint125.children[1] = HAnimJoint135;

HAnimJoint115.children[1] = HAnimJoint125;

HAnimJoint HAnimJoint155 = createNode("HAnimJoint");
HAnimJoint155.DEF = "hanim_r_shoulder";
HAnimJoint155.name = "r_shoulder";
HAnimJoint155.center = new SFVec3f(new float[-7.699,59.42,-1.567]);
...
Transform157.translation = new SFVec3f(new float[-7.699,59.42,-1.567]);
Shape Shape158 = createNode("Shape");
Appearance Appearance159 = createNode("Appearance");
Material Material160 = createNode("Material");
Material160.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance159.material = Material160;

ImageTexture ImageTexture161 = createNode("ImageTexture");
ImageTexture161.USE = "ChulTextureAtlas";
...
HAnimJoint165.DEF = "hanim_r_elbow";
HAnimJoint165.name = "r_elbow";
HAnimJoint165.center = new SFVec3f(new float[-8.026,48.45,-1.959]);
HAnimSegment HAnimSegment166 = createNode("HAnimSegment");
HAnimSegment166.DEF = "hanim_r_forearm";
HAnimSegment166.name = "r_forearm";
Transform Transform167 = createNode("Transform");
Transform167.translation = new SFVec3f(new float[-8.026,48.45,-1.959]);
Shape Shape168 = createNode("Shape");
Appearance Appearance169 = createNode("Appearance");
Material Material170 = createNode("Material");
Material170.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance169.material = Material170;

ImageTexture ImageTexture171 = createNode("ImageTexture");
ImageTexture171.USE = "ChulTextureAtlas";
...
IndexedFaceSet172.creaseAngle = 1.57;
...
Coordinate174.point = new MFVec3f(new float[1.607,-0.3011,-0.7068,1.816,-1.259,0.7158,1.607,-0.3011,0.7173,1.816,-1.259,-0.7039,-0.0748,-2.207,1.664,-0.0977,-1.281,1.671,-0.0968,-1.282,-1.749,-0.075,-2.207,-1.492,-1.791,-1.616,0.6505,-1.816,-0.6919,0.6532,-1.791,-1.616,-0.5319,-1.816,-0.6919,-0.5362,1.323,-4.528,1.438,1.323,-4.528,-0.6341,-0.0101,-4.917,1.749,-0.01,-4.917,-1.419,-1.599,-4.353,0.9644,-1.599,-4.353,-0.4902,1.275,-7.552,0.9117,1.275,-7.552,-0.5772,-0.0603,-7.691,1.6,-0.0602,-7.691,-1.319,-1.34,-7.172,0.8445,-1.34,-7.172,-0.3992,-0.0847,-10.99,-0.7836,0.679,-10.66,-0.3055,-0.092,-10.99,1.088,0.6772,-10.65,0.6521,-0.6479,-10.85,-0.4597,-0.652,-10.87,0.7241,0.8326,0.9823,0.4058,0.8326,0.9823,-0.3926,-0.1232,0.4326,0.9405,-0.1227,0.4326,-0.977,-1.087,0.7632,0.3698,-1.087,0.7632,-0.297,-0.1182,1.187,0.0082,0.0134,-11.39,0.1526]);
...
HAnimJoint175.DEF = "hanim_r_radiocarpal";
HAnimJoint175.name = "r_radiocarpal";
HAnimJoint175.center = new SFVec3f(new float[-7.617,37.69,-1.663]);
HAnimSegment HAnimSegment176 = createNode("HAnimSegment");
HAnimSegment176.DEF = "hanim_r_carpal";
HAnimSegment176.name = "r_carpal";
Transform Transform177 = createNode("Transform");
Transform177.translation = new SFVec3f(new float[-7.617,37.69,-1.663]);
Shape Shape178 = createNode("Shape");
Appearance Appearance179 = createNode("Appearance");
Material Material180 = createNode("Material");
Material180.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance179.material = Material180;

ImageTexture ImageTexture181 = createNode("ImageTexture");
ImageTexture181.USE = "ChulTextureAtlas";
...
Coordinate184.point = new MFVec3f(new float[-0.428,-4.043,1.035,0.062,-2.76,-0.7256,-0.4283,-4.043,-1.325,0.0621,-2.759,0.4786,-0.5207,-5.808,0.5759,0.0026,-5.67,-1.325,-0.5208,-5.808,-0.9061,0.0026,-5.67,1.035,0.311,0.5832,-0.6014,-0.4947,0.3747,-1.08,-0.3587,-0.8063,-1.077,0.3511,-0.5647,-0.6024,-0.502,0.3752,0.7923,0.3112,0.5961,0.3561,0.3512,-0.5647,0.3515,-0.5145,-0.7545,0.7924,-1.03,0.5998,-0.7556,-1.03,-0.5583,-0.7457,-1.037,0.5778,0.4281,-1.031,-0.5582,0.4287,-0.3854,-2.321,-1.587,0.3249,-2.079,-0.8558,-0.2488,-1.494,1.332,0.4651,-1.238,0.8921,0.7055,-1.95,1.153,0.2884,-2.29,1.587,0.324,-2.079,0.6132,-1.057,-2.073,-1.077,-1.049,-2.091,0.6923,-0.3858,-2.321,1.292,-0.9501,-4.181,-0.9063,-0.9499,-4.181,0.5762,-0.2552,-4.694,-1.325,-0.2552,-4.694,1.035,-0.7786,-4.832,-0.9061,-0.7786,-4.832,0.5759,-0.6497,-5.32,-0.9061,-0.1263,-5.182,-1.325,-0.6497,-5.32,0.5759,-0.1263,-5.182,1.035,0.6755,-3.115,0.6119,0.214,-3.44,1.081,0.6399,-3.326,1.586,1.057,-2.987,1.151,0.8814,-2.469,1.15,0.4641,-2.808,1.587,0.0383,-2.922,1.082,0.4998,-2.597,0.6126,-0.4437,0.8321,-0.1433]);
...
HAnimJoint165.children[1] = HAnimJoint175;

HAnimJoint155.children[1] = HAnimJoint165;

HAnimJoint115.children[2] = HAnimJoint155;

HAnimJoint HAnimJoint185 = createNode("HAnimJoint");
HAnimJoint185.DEF = "hanim_vl5";
HAnimJoint185.name = "vl5";
HAnimJoint185.center = new SFVec3f(new float[0,47.33,-0.5744]);
HAnimSegment HAnimSegment186 = createNode("HAnimSegment");
HAnimSegment186.DEF = "hanim_l5";
HAnimSegment186.name = "l5";
Transform Transform187 = createNode("Transform");
Transform187.translation = new SFVec3f(new float[0,47.33,-0.5744]);
Shape Shape188 = createNode("Shape");
Appearance Appearance189 = createNode("Appearance");
Material Material190 = createNode("Material");
Material190.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance189.material = Material190;

ImageTexture ImageTexture191 = createNode("ImageTexture");
ImageTexture191.USE = "ChulTextureAtlas";
...
IndexedFaceSet192.creaseAngle = 1.57;
...
HAnimJoint195.DEF = "hanim_skullbase";
HAnimJoint195.name = "skullbase";
HAnimJoint195.center = new SFVec3f(new float[0,65.51,-1.446]);
HAnimSegment HAnimSegment196 = createNode("HAnimSegment");
HAnimSegment196.DEF = "hanim_skull";
HAnimSegment196.name = "skull";
Transform Transform197 = createNode("Transform");
Transform197.translation = new SFVec3f(new float[0,65.51,-1.446]);
Shape Shape198 = createNode("Shape");
Appearance Appearance199 = createNode("Appearance");
Material Material200 = createNode("Material");
Material200.diffuseColor = new SFColor(new float[0.588,0.588,0.588]);
Appearance199.material = Material200;

ImageTexture ImageTexture201 = createNode("ImageTexture");
ImageTexture201.USE = "ChulTextureAtlas";
...
HAnimJoint185.children[1] = HAnimJoint195;

HAnimJoint115.children[3] = HAnimJoint185;

HAnimJoint25.children[3] = HAnimJoint115;

HAnimHumanoid22.joints[1] = HAnimJoint25;

HAnimSegment HAnimSegment205 = createNode("HAnimSegment");
HAnimSegment205.USE = "hanim_l5";
HAnimHumanoid22.segments[2] = HAnimSegment205;

HAnimSegment HAnimSegment206 = createNode("HAnimSegment");
HAnimSegment206.USE = "hanim_pelvis";
HAnimHumanoid22.segments[3] = HAnimSegment206;

HAnimSegment HAnimSegment207 = createNode("HAnimSegment");
HAnimSegment207.USE = "hanim_sacrum";
HAnimHumanoid22.segments[4] = HAnimSegment207;

HAnimSegment HAnimSegment208 = createNode("HAnimSegment");
HAnimSegment208.USE = "hanim_skull";
HAnimHumanoid22.segments[5] = HAnimSegment208;

HAnimSegment HAnimSegment209 = createNode("HAnimSegment");
HAnimSegment209.USE = "hanim_l_calf";
HAnimHumanoid22.segments[6] = HAnimSegment209;

HAnimSegment HAnimSegment210 = createNode("HAnimSegment");
HAnimSegment210.USE = "hanim_r_calf";
HAnimHumanoid22.segments[7] = HAnimSegment210;

HAnimSegment HAnimSegment211 = createNode("HAnimSegment");
HAnimSegment211.USE = "hanim_l_carpal";
HAnimHumanoid22.segments[8] = HAnimSegment211;

HAnimSegment HAnimSegment212 = createNode("HAnimSegment");
HAnimSegment212.USE = "hanim_r_carpal";
HAnimHumanoid22.segments[9] = HAnimSegment212;

HAnimSegment HAnimSegment213 = createNode("HAnimSegment");
HAnimSegment213.USE = "hanim_l_forearm";
HAnimHumanoid22.segments[10] = HAnimSegment213;

HAnimSegment HAnimSegment214 = createNode("HAnimSegment");
HAnimSegment214.USE = "hanim_r_forearm";
HAnimHumanoid22.segments[11] = HAnimSegment214;

HAnimSegment HAnimSegment215 = createNode("HAnimSegment");
HAnimSegment215.USE = "hanim_l_talus";
HAnimHumanoid22.segments[12] = HAnimSegment215;

HAnimSegment HAnimSegment216 = createNode("HAnimSegment");
HAnimSegment216.USE = "hanim_r_talus";
HAnimHumanoid22.segments[13] = HAnimSegment216;

HAnimSegment HAnimSegment217 = createNode("HAnimSegment");
HAnimSegment217.USE = "hanim_l_tarsal_proximal_phalanx_1";
HAnimHumanoid22.segments[14] = HAnimSegment217;

HAnimSegment HAnimSegment218 = createNode("HAnimSegment");
HAnimSegment218.USE = "hanim_r_tarsal_proximal_phalanx_1";
HAnimHumanoid22.segments[15] = HAnimSegment218;

HAnimSegment HAnimSegment219 = createNode("HAnimSegment");
HAnimSegment219.USE = "hanim_l_thigh";
HAnimHumanoid22.segments[16] = HAnimSegment219;

HAnimSegment HAnimSegment220 = createNode("HAnimSegment");
HAnimSegment220.USE = "hanim_r_thigh";
HAnimHumanoid22.segments[17] = HAnimSegment220;

HAnimSegment HAnimSegment221 = createNode("HAnimSegment");
HAnimSegment221.USE = "hanim_l_upperarm";
HAnimHumanoid22.segments[18] = HAnimSegment221;

HAnimSegment HAnimSegment222 = createNode("HAnimSegment");
HAnimSegment222.USE = "hanim_r_upperarm";
HAnimHumanoid22.segments[19] = HAnimSegment222;

HAnimJoint HAnimJoint223 = createNode("HAnimJoint");
HAnimJoint223.USE = "hanim_humanoid_root";
HAnimHumanoid22.joints[20] = HAnimJoint223;

HAnimJoint HAnimJoint224 = createNode("HAnimJoint");
HAnimJoint224.USE = "hanim_sacroiliac";
HAnimHumanoid22.joints[21] = HAnimJoint224;

HAnimJoint HAnimJoint225 = createNode("HAnimJoint");
HAnimJoint225.USE = "hanim_skullbase";
HAnimHumanoid22.joints[22] = HAnimJoint225;

HAnimJoint HAnimJoint226 = createNode("HAnimJoint");
HAnimJoint226.USE = "hanim_vl5";
HAnimHumanoid22.joints[23] = HAnimJoint226;

HAnimJoint HAnimJoint227 = createNode("HAnimJoint");
HAnimJoint227.USE = "hanim_l_elbow";
HAnimHumanoid22.joints[24] = HAnimJoint227;

HAnimJoint HAnimJoint228 = createNode("HAnimJoint");
HAnimJoint228.USE = "hanim_r_elbow";
HAnimHumanoid22.joints[25] = HAnimJoint228;

HAnimJoint HAnimJoint229 = createNode("HAnimJoint");
HAnimJoint229.USE = "hanim_l_hip";
HAnimHumanoid22.joints[26] = HAnimJoint229;

HAnimJoint HAnimJoint230 = createNode("HAnimJoint");
HAnimJoint230.USE = "hanim_r_hip";
HAnimHumanoid22.joints[27] = HAnimJoint230;

HAnimJoint HAnimJoint231 = createNode("HAnimJoint");
HAnimJoint231.USE = "hanim_l_knee";
HAnimHumanoid22.joints[28] = HAnimJoint231;

HAnimJoint HAnimJoint232 = createNode("HAnimJoint");
HAnimJoint232.USE = "hanim_r_knee";
HAnimHumanoid22.joints[29] = HAnimJoint232;

HAnimJoint HAnimJoint233 = createNode("HAnimJoint");
HAnimJoint233.USE = "hanim_l_metatarsophalangeal_1";
HAnimHumanoid22.joints[30] = HAnimJoint233;

HAnimJoint HAnimJoint234 = createNode("HAnimJoint");
HAnimJoint234.USE = "hanim_r_metatarsophalangeal_1";
HAnimHumanoid22.joints[31] = HAnimJoint234;

HAnimJoint HAnimJoint235 = createNode("HAnimJoint");
HAnimJoint235.USE = "hanim_l_radiocarpal";
HAnimHumanoid22.joints[32] = HAnimJoint235;

HAnimJoint HAnimJoint236 = createNode("HAnimJoint");
HAnimJoint236.USE = "hanim_r_radiocarpal";
HAnimHumanoid22.joints[33] = HAnimJoint236;

HAnimJoint HAnimJoint237 = createNode("HAnimJoint");
HAnimJoint237.USE = "hanim_l_shoulder";
HAnimHumanoid22.joints[34] = HAnimJoint237;

HAnimJoint HAnimJoint238 = createNode("HAnimJoint");
HAnimJoint238.USE = "hanim_r_shoulder";
HAnimHumanoid22.joints[35] = HAnimJoint238;

HAnimJoint HAnimJoint239 = createNode("HAnimJoint");
HAnimJoint239.USE = "hanim_l_talocrural";
HAnimHumanoid22.joints[36] = HAnimJoint239;

HAnimJoint HAnimJoint240 = createNode("HAnimJoint");
HAnimJoint240.USE = "hanim_r_talocrural";
HAnimHumanoid22.joints[37] = HAnimJoint240;

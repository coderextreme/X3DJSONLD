...
<ProtoDeclare name="LOA1_RunAnimation" ><ProtoInterface><field accessType="inputOutput" type="SFTime" name="cycleInterval" value="1"></field>
...
ProtoDeclare17.name = "LOA1_RunAnimation";
...
PositionInterpolator56.key = new MFFloat(new float[0,0.2182,0.2909,0.3091,0.7091,0.8,0.8182,1]);
PositionInterpolator56.keyValue = new MFVec3f(new float[0,-0.0351,0,0,-0.0351,0,0,-0.04087,0,0,-0.04886,0,0,-0.04051,0,0,-0.03666,0,0,-0.03666,0,0,-0.0351,0]);
...
OrientationInterpolator62.keyValue = new MFRotation(new float[0.9969,-0.05444,0.05596,0.07687,0.9969,-0.05444,0.05596,0.07687]);
...
OrientationInterpolator65.key = new MFFloat(new float[0,0.2182,0.4909,0.7455,1]);
OrientationInterpolator65.keyValue = new MFRotation(new float[-0.9986,0.03354,0.04001,1.212,-0.9889,0.1328,0.06696,0.4025,0.9894,0.1453,0.009351,0.4114,-0.9963,0.07032,0.05003,0.7035,-0.9986,0.03354,0.04001,1.212]);
...
OrientationInterpolator68.key = new MFFloat(new float[0,0.2182,0.4909,0.7455,1]);
OrientationInterpolator68.keyValue = new MFRotation(new float[1,0,0,1.108,1,0,0,0.4265,1,0,0,0.7052,1,0,0,2.179,1,0,0,1.108]);
...
OrientationInterpolator71.key = new MFFloat(new float[0,0.2182,0.3091,0.4909,1]);
OrientationInterpolator71.keyValue = new MFRotation(new float[1,0,0,0.03543,-1,0,0,0.1037,-1,0,0,0.4328,1,0,0,0.1929,1,0,0,0.03543]);
...
OrientationInterpolator77.key = new MFFloat(new float[0,0.2182,0.4909,0.7455,1]);
OrientationInterpolator77.keyValue = new MFRotation(new float[0.9999,0.00293,-0.00989,0.402,-1,0.004977,-0.00497,0.5943,-1,0.003265,-0.001752,1.178,-0.9999,0.00815,-0.01093,0.3031,0.9999,0.00293,-0.00989,0.402]);
...
OrientationInterpolator80.key = new MFFloat(new float[0,0.03636,0.2182,0.4909,0.7455,1]);
OrientationInterpolator80.keyValue = new MFRotation(new float[1,0,0,0.7004,1,0,0,1.011,1,0,0,1.892,1,0,0,1.188,1,0,0,0.3964,1,0,0,0.7004]);
...
OrientationInterpolator83.key = new MFFloat(new float[0,0.4909,0.7091,0.8,0.8182,1]);
OrientationInterpolator83.keyValue = new MFRotation(new float[1,0,0,0.2323,-1,0,0,0.07843,-1,0,0,0.09676,-1,0,0,0.3274,-1,0,0,0.3278,1,0,0,0.2323]);
...
OrientationInterpolator89.key = new MFFloat(new float[0,0.2545,0.4909,0.7636,1]);
OrientationInterpolator89.keyValue = new MFRotation(new float[0.7651,0.6382,0.08586,0.2712,0.9999,0.002845,-0.01547,0.3756,0.7459,-0.6505,-0.1432,0.2416,0.9984,0.05536,-0.01154,0.3488,0.7651,0.6382,0.08586,0.2712]);
...
OrientationInterpolator92.key = new MFFloat(new float[0,0.4909,1]);
OrientationInterpolator92.keyValue = new MFRotation(new float[0.6517,-0.7559,0.06211,0.2508,0.6467,0.7527,-0.1238,0.2344,0.6517,-0.7559,0.06211,0.2508]);
...
OrientationInterpolator95.key = new MFFloat(new float[0,0.2182,0.4909,0.7455,1]);
OrientationInterpolator95.keyValue = new MFRotation(new float[0.9907,-0.07264,0.115,1.135,0.9291,-0.1222,0.349,0.1695,-0.9892,0.1364,-0.05394,0.5112,0.9942,-0.0002052,0.1073,0.4975,0.9907,-0.07264,0.115,1.135]);
...
OrientationInterpolator98.key = new MFFloat(new float[0,0.2182,0.4909,0.7455,1]);
OrientationInterpolator98.keyValue = new MFRotation(new float[0.9985,0.03887,0.03802,4.689,-0.965,-0.1889,-0.1821,1.415,0.9758,0.1563,0.1529,4.666,-0.9956,-0.0936,0.009826,1.126,0.9985,0.03887,0.03802,4.689]);
...
OrientationInterpolator101.keyValue = new MFRotation(new float[-0.0240995,-0.999682,0.00741506,0.120409,-0.0240995,-0.999682,0.00741506,0.120409]);
...
OrientationInterpolator104.key = new MFFloat(new float[0,0.2182,0.4909,0.7455,1]);
OrientationInterpolator104.keyValue = new MFRotation(new float[-1,0,0,0.6979,0.9094,0.2062,-0.3613,0.4157,0.9637,0.1537,-0.2185,1.353,0.4864,0.08841,-0.8693,0.1716,-1,0,0,0.6979]);
...
OrientationInterpolator107.key = new MFFloat(new float[0,0.2182,0.4909,0.7455,1]);
OrientationInterpolator107.keyValue = new MFRotation(new float[0.9353,-0.2978,-0.191,4.222,-0.9362,0.2924,-0.1952,1.05,0.9941,-0.09719,-0.04725,4.512,-0.9594,0.2653,0.09579,1.525,0.9353,-0.2978,-0.191,4.222]);
...
OrientationInterpolator110.keyValue = new MFRotation(new float[-0.917742,-0.237244,-0.318536,0.214273,-0.917742,-0.237244,-0.318536,0.214273]);
...
WorldInfo132.title = "LOA1_RunAnimation.x3d";
...
Text137.string = new MFString(new java.lang.String["LOA1_RunAnimation.x3d","defines a prototype","for animating a humanoid.","","Click this text to see","InterchangableActorsViaDynamicRouting example."]);

...
HAnimJoint33.children[1] = HAnimJoint39;
...
HAnimJoint73.center = new SFVec3f(new float[0,1.5823,-0.0185]);
...
HAnimJoint33.children[2] = HAnimJoint52;
...
Material135.diffuseColor = new SFColor(new float[0.3,0.3,0.6]);
Material135.emissiveColor = new SFColor(new float[0.3,0.3,0.6]);
...
ImageTexture136.url = new MFString(new java.lang.String["JoeBodyTexture29.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JoeBodyTexture29.png"]);
...
EXPORT EXPORT238 = createNode("EXPORT");
EXPORT238.AS = "JoeKick";
EXPORT238.localDEF = "Joe_Kick";
Group29.children[1] = EXPORT238;

...
Viewpoint7.position = new SFVec3f(new float[0,0,12]);
children = new MFNode();

children[0] = Viewpoint7;

Switch Switch8 = createNode("Switch");
...
Inline9.url = new MFString(new java.lang.String["../data/force-tidy.x3d","https://coderextreme.net/X3DJSONLD/src/main/data/force-tidy.x3d"]);
Switch8.children = new MFNode();

Switch8.children[0] = Inline9;

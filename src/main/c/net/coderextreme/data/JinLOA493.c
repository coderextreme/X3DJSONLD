...
HAnimJoint31.center = new SFVec3f(new float[-0.008499999999999952,1.0797302137294733,-0.24309999999999998]);
...
Transform33.translation = new SFVec3f(new float[-0.008499999999999952,1.0797302137294733,-0.24309999999999998]);
...
HAnimJoint41.center = new SFVec3f(new float[-0.008499999999999952,0.9228056676129409,-0.24309999999999998]);
...
Transform43.translation = new SFVec3f(new float[-0.008499999999999952,0.9228056676129409,-0.24309999999999998]);
...
HAnimJoint51.center = new SFVec3f(new float[4.1985,1.0806219197993292,-0.351]);
...
Transform53.translation = new SFVec3f(new float[4.1985,1.0806219197993292,-0.351]);
...
HAnimJoint61.center = new SFVec3f(new float[4.1075,0.5287109942038704,-0.3994]);
...
Transform63.translation = new SFVec3f(new float[4.1075,0.5287109942038704,-0.3994]);
...
HAnimJoint71.center = new SFVec3f(new float[3.9395,0.11476298430631864,0]);
...
Transform73.translation = new SFVec3f(new float[3.9395,0.11476298430631864,0]);
...
HAnimJoint81.center = new SFVec3f(new float[3.4715,0.03743007780478005,0.6807000000000001]);
...
Transform83.translation = new SFVec3f(new float[3.4715,0.03743007780478005,0.6807000000000001]);
...
HAnimJoint91.center = new SFVec3f(new float[2.9855,0.031099597756806294,1.2819]);
...
Transform93.translation = new SFVec3f(new float[2.9855,0.031099597756806294,1.2819]);
...
HAnimJoint101.center = new SFVec3f(new float[2.8635,0.019389695696235113,2.4285]);
...
Transform103.translation = new SFVec3f(new float[2.8635,0.019389695696235113,2.4285]);
...
HAnimJoint111.center = new SFVec3f(new float[2.7525000000000004,0.007742206819235512,4.6255]);
...
Transform113.translation = new SFVec3f(new float[2.7525000000000004,0.007742206819235512,4.6255]);
...
HAnimJoint121.center = new SFVec3f(new float[2.7525000000000004,0.004719625500555083,5.5895]);
...
Transform123.translation = new SFVec3f(new float[2.7525000000000004,0.004719625500555083,5.5895]);
...
HAnimJoint131.center = new SFVec3f(new float[3.6105,0.032971993263953454,1.4168]);
...
Transform133.translation = new SFVec3f(new float[3.6105,0.032971993263953454,1.4168]);
...
HAnimJoint141.center = new SFVec3f(new float[3.5555000000000003,0.02316420727413496,2.2895]);
...
Transform143.translation = new SFVec3f(new float[3.5555000000000003,0.02316420727413496,2.2895]);
...
HAnimJoint151.center = new SFVec3f(new float[3.6595000000000004,0.008470360627570521,4.8125]);
...
Transform153.translation = new SFVec3f(new float[3.6595000000000004,0.008470360627570521,4.8125]);
...
HAnimJoint161.center = new SFVec3f(new float[3.7385,0.0053942822944001755,5.5315]);
...
Transform163.translation = new SFVec3f(new float[3.7385,0.0053942822944001755,5.5315]);
...
HAnimJoint171.center = new SFVec3f(new float[3.7385,0.0016673236182691443,5.9505]);
...
Transform173.translation = new SFVec3f(new float[3.7385,0.0016673236182691443,5.9505]);
...
HAnimJoint181.center = new SFVec3f(new float[4.1235,0.032793669882320395,1.3453]);
...
Transform183.translation = new SFVec3f(new float[4.1235,0.032793669882320395,1.3453]);
...
HAnimJoint191.center = new SFVec3f(new float[4.1955,0.02316420727413496,2.2155]);
...
Transform193.translation = new SFVec3f(new float[4.1955,0.02316420727413496,2.2155]);
...
HAnimJoint201.center = new SFVec3f(new float[4.2795000000000005,0.008577354656550362,4.7055]);
...
Transform203.translation = new SFVec3f(new float[4.2795000000000005,0.008577354656550362,4.7055]);
...
HAnimJoint211.center = new SFVec3f(new float[4.3855,0.004437280146302734,5.3745]);
...
Transform213.translation = new SFVec3f(new float[4.3855,0.004437280146302734,5.3745]);
...
HAnimJoint221.center = new SFVec3f(new float[4.4545,0.0016673236182691443,5.7845]);
...
Transform223.translation = new SFVec3f(new float[4.4545,0.0016673236182691443,5.7845]);
...
HAnimJoint231.center = new SFVec3f(new float[3.9515000000000002,0.06527824590314349,-0.6894999999999999]);
...
Transform233.translation = new SFVec3f(new float[3.9515000000000002,0.06527824590314349,-0.6894999999999999]);
...
HAnimJoint241.center = new SFVec3f(new float[4.9085,0.03529019722518329,0.55735]);
...
Transform243.translation = new SFVec3f(new float[4.9085,0.03529019722518329,0.55735]);
...
HAnimJoint251.center = new SFVec3f(new float[4.7245,0.021113488385354727,2.1725]);
...
Transform253.translation = new SFVec3f(new float[4.7245,0.021113488385354727,2.1725]);
...
HAnimJoint261.center = new SFVec3f(new float[4.8745,0.007647101015697879,4.5165]);
...
Transform263.translation = new SFVec3f(new float[4.8745,0.007647101015697879,4.5165]);
...
HAnimJoint271.center = new SFVec3f(new float[5.0655,0.004862284205861535,5.1895]);
...
Transform273.translation = new SFVec3f(new float[5.0655,0.004862284205861535,5.1895]);
...
HAnimJoint281.center = new SFVec3f(new float[5.1325,0.0010639961770772795,5.5175]);
...
Transform283.translation = new SFVec3f(new float[5.1325,0.0010639961770772795,5.5175]);
...
HAnimJoint291.center = new SFVec3f(new float[5.3615,0.016355226152112483,2.0085]);
...
Transform293.translation = new SFVec3f(new float[5.3615,0.016355226152112483,2.0085]);
...
HAnimJoint301.center = new SFVec3f(new float[5.5055000000000005,0.0067465679384509075,4.3115]);
...
Transform303.translation = new SFVec3f(new float[5.5055000000000005,0.0067465679384509075,4.3115]);
...
HAnimJoint311.center = new SFVec3f(new float[5.6085,0.00302852543140153,4.6485]);
...
Transform313.translation = new SFVec3f(new float[5.6085,0.00302852543140153,4.6485]);
...
HAnimJoint321.center = new SFVec3f(new float[5.6485,0,4.9925]);
...
Transform323.translation = new SFVec3f(new float[5.6485,0,4.9925]);
...
HAnimJoint331.center = new SFVec3f(new float[-4.2155,1.0806219197993292,-0.351]);
...
Transform333.translation = new SFVec3f(new float[-4.2155,1.0806219197993292,-0.351]);
...
HAnimJoint341.center = new SFVec3f(new float[-4.124499999999999,0.5287109942038704,-0.3994]);
...
Transform343.translation = new SFVec3f(new float[-4.124499999999999,0.5287109942038704,-0.3994]);
...
HAnimJoint351.center = new SFVec3f(new float[-3.9395,0.11476298430631864,0]);
...
Transform353.translation = new SFVec3f(new float[-3.9395,0.11476298430631864,0]);
...
HAnimJoint361.center = new SFVec3f(new float[-3.4725,0.03743007780478005,0.6807000000000001]);
...
Transform363.translation = new SFVec3f(new float[-3.4725,0.03743007780478005,0.6807000000000001]);
...
HAnimJoint371.center = new SFVec3f(new float[-2.9855,0.031099597756806294,1.2819]);
...
Transform373.translation = new SFVec3f(new float[-2.9855,0.031099597756806294,1.2819]);
...
HAnimJoint381.center = new SFVec3f(new float[-2.8644999999999996,0.019389695696235113,2.4285]);
...
Transform383.translation = new SFVec3f(new float[-2.8644999999999996,0.019389695696235113,2.4285]);
...
HAnimJoint391.center = new SFVec3f(new float[-2.7535,0.007742206819235512,4.6255]);
...
Transform393.translation = new SFVec3f(new float[-2.7535,0.007742206819235512,4.6255]);
...
HAnimJoint401.center = new SFVec3f(new float[-2.7525000000000004,0.004719625500555083,5.5895]);
...
Transform403.translation = new SFVec3f(new float[-2.7525000000000004,0.004719625500555083,5.5895]);
...
HAnimJoint411.center = new SFVec3f(new float[-3.6105,0.032971993263953454,1.4168]);
...
Transform413.translation = new SFVec3f(new float[-3.6105,0.032971993263953454,1.4168]);
...
HAnimJoint421.center = new SFVec3f(new float[-3.5564999999999998,0.02316420727413496,2.2895]);
...
Transform423.translation = new SFVec3f(new float[-3.5564999999999998,0.02316420727413496,2.2895]);
...
HAnimJoint431.center = new SFVec3f(new float[-3.6594999999999995,0.008470360627570521,4.8125]);
...
Transform433.translation = new SFVec3f(new float[-3.6594999999999995,0.008470360627570521,4.8125]);
...
HAnimJoint441.center = new SFVec3f(new float[-3.7385,0.0053942822944001755,5.5315]);
...
Transform443.translation = new SFVec3f(new float[-3.7385,0.0053942822944001755,5.5315]);
...
HAnimJoint451.center = new SFVec3f(new float[-3.7385,0.0016673236182691443,5.9505]);
...
Transform453.translation = new SFVec3f(new float[-3.7385,0.0016673236182691443,5.9505]);
...
HAnimJoint461.center = new SFVec3f(new float[-4.124499999999999,0.032793669882320395,1.3453]);
...
Transform463.translation = new SFVec3f(new float[-4.124499999999999,0.032793669882320395,1.3453]);
...
HAnimJoint471.center = new SFVec3f(new float[-4.1964999999999995,0.02316420727413496,2.2155]);
...
Transform473.translation = new SFVec3f(new float[-4.1964999999999995,0.02316420727413496,2.2155]);
...
HAnimJoint481.center = new SFVec3f(new float[-4.2795,0.008577354656550362,4.7055]);
...
Transform483.translation = new SFVec3f(new float[-4.2795,0.008577354656550362,4.7055]);
...
HAnimJoint491.center = new SFVec3f(new float[-4.3865,0.004437280146302734,5.3745]);
...
Transform493.translation = new SFVec3f(new float[-4.3865,0.004437280146302734,5.3745]);
...
HAnimJoint501.center = new SFVec3f(new float[-4.4544999999999995,0.0016673236182691443,5.7845]);
...
Transform503.translation = new SFVec3f(new float[-4.4544999999999995,0.0016673236182691443,5.7845]);
...
HAnimJoint511.center = new SFVec3f(new float[-3.9515000000000002,0.06527824590314349,-0.6894999999999999]);
...
Transform513.translation = new SFVec3f(new float[-3.9515000000000002,0.06527824590314349,-0.6894999999999999]);
...
HAnimJoint521.center = new SFVec3f(new float[-4.9094999999999995,0.03529019722518329,0.55735]);
...
Transform523.translation = new SFVec3f(new float[-4.9094999999999995,0.03529019722518329,0.55735]);
...
HAnimJoint531.center = new SFVec3f(new float[-4.725499999999999,0.021113488385354727,2.1725]);
...
Transform533.translation = new SFVec3f(new float[-4.725499999999999,0.021113488385354727,2.1725]);
...
HAnimJoint541.center = new SFVec3f(new float[-4.8755,0.007647101015697879,4.5165]);
...
Transform543.translation = new SFVec3f(new float[-4.8755,0.007647101015697879,4.5165]);
...
HAnimJoint551.center = new SFVec3f(new float[-5.0655,0.004862284205861535,5.1895]);
...
Transform553.translation = new SFVec3f(new float[-5.0655,0.004862284205861535,5.1895]);
...
HAnimJoint561.center = new SFVec3f(new float[-5.1335,0.0010639961770772795,5.5175]);
...
Transform563.translation = new SFVec3f(new float[-5.1335,0.0010639961770772795,5.5175]);
...
HAnimJoint571.center = new SFVec3f(new float[-5.3614999999999995,0.016355226152112483,2.0085]);
...
Transform573.translation = new SFVec3f(new float[-5.3614999999999995,0.016355226152112483,2.0085]);
...
HAnimJoint581.center = new SFVec3f(new float[-5.5055,0.0067465679384509075,4.3115]);
...
Transform583.translation = new SFVec3f(new float[-5.5055,0.0067465679384509075,4.3115]);
...
HAnimJoint591.center = new SFVec3f(new float[-5.608499999999999,0.00302852543140153,4.6485]);
...
Transform593.translation = new SFVec3f(new float[-5.608499999999999,0.00302852543140153,4.6485]);
...
HAnimJoint601.center = new SFVec3f(new float[-5.6495,0,4.9925]);
...
Transform603.translation = new SFVec3f(new float[-5.6495,0,4.9925]);
...
HAnimJoint611.center = new SFVec3f(new float[-0.008499999999999952,1.2110951643069572,-0.1472]);
...
Transform613.translation = new SFVec3f(new float[-0.008499999999999952,1.2110951643069572,-0.1472]);
...
HAnimJoint621.center = new SFVec3f(new float[-0.008499999999999952,1.2431933135597817,-0.1472]);
...
Transform623.translation = new SFVec3f(new float[-0.008499999999999952,1.2431933135597817,-0.1472]);
...
HAnimJoint631.center = new SFVec3f(new float[-0.008499999999999952,1.2645921490763128,-0.1472]);
...
Transform633.translation = new SFVec3f(new float[-0.008499999999999952,1.2645921490763128,-0.1472]);
...
HAnimJoint641.center = new SFVec3f(new float[-0.008499999999999952,1.2862881605083354,-0.1472]);
...
Transform643.translation = new SFVec3f(new float[-0.008499999999999952,1.2862881605083354,-0.1472]);
...
HAnimJoint651.center = new SFVec3f(new float[-0.008499999999999952,1.3091729944845787,-0.1472]);
...
Transform653.translation = new SFVec3f(new float[-0.008499999999999952,1.3091729944845787,-0.1472]);
...
HAnimJoint661.center = new SFVec3f(new float[-0.008499999999999952,1.3400824103548734,-0.1472]);
...
Transform663.translation = new SFVec3f(new float[-0.008499999999999952,1.3400824103548734,-0.1472]);
...
HAnimJoint671.center = new SFVec3f(new float[-0.008499999999999952,1.3712889724200958,-0.1472]);
...
Transform673.translation = new SFVec3f(new float[-0.008499999999999952,1.3712889724200958,-0.1472]);
...
HAnimJoint681.center = new SFVec3f(new float[-0.008499999999999952,1.3938765710397203,-0.1482]);
...
Transform683.translation = new SFVec3f(new float[-0.008499999999999952,1.3938765710397203,-0.1482]);
...
HAnimJoint691.center = new SFVec3f(new float[-0.008499999999999952,1.4131949671038657,-0.1472]);
...
Transform693.translation = new SFVec3f(new float[-0.008499999999999952,1.4131949671038657,-0.1472]);
...
HAnimJoint701.center = new SFVec3f(new float[-0.008499999999999952,1.432513392888575,-0.1472]);
...
Transform703.translation = new SFVec3f(new float[-0.008499999999999952,1.432513392888575,-0.1472]);
...
HAnimJoint711.center = new SFVec3f(new float[-0.008499999999999952,1.4533176982507414,-0.1472]);
...
Transform713.translation = new SFVec3f(new float[-0.008499999999999952,1.4533176982507414,-0.1472]);
...
HAnimJoint721.center = new SFVec3f(new float[-0.008499999999999952,1.470258389785319,-0.1472]);
...
Transform723.translation = new SFVec3f(new float[-0.008499999999999952,1.470258389785319,-0.1472]);
...
HAnimJoint731.center = new SFVec3f(new float[-0.008499999999999952,1.490765667834812,-0.1472]);
...
Transform733.translation = new SFVec3f(new float[-0.008499999999999952,1.490765667834812,-0.1472]);
...
HAnimJoint741.center = new SFVec3f(new float[-0.008499999999999952,1.5109756510865595,-0.1472]);
...
Transform743.translation = new SFVec3f(new float[-0.008499999999999952,1.5109756510865595,-0.1472]);
...
HAnimJoint751.center = new SFVec3f(new float[-0.008499999999999952,1.535346513243078,-0.1472]);
...
Transform753.translation = new SFVec3f(new float[-0.008499999999999952,1.535346513243078,-0.1472]);
...
HAnimJoint761.center = new SFVec3f(new float[-0.008499999999999952,1.5680390737680125,-0.1482]);
...
Transform763.translation = new SFVec3f(new float[-0.008499999999999952,1.5680390737680125,-0.1482]);
...
HAnimJoint771.center = new SFVec3f(new float[-0.008499999999999952,1.599542930630981,-0.1472]);
...
Transform773.translation = new SFVec3f(new float[-0.008499999999999952,1.599542930630981,-0.1472]);
...
HAnimJoint781.center = new SFVec3f(new float[-0.008499999999999952,1.6337214896156271,-0.20499999999999996]);
...
Transform783.translation = new SFVec3f(new float[-0.008499999999999952,1.6337214896156271,-0.20499999999999996]);
...
HAnimJoint791.center = new SFVec3f(new float[-0.008499999999999952,1.6497706236831666,-0.20499999999999996]);
...
Transform793.translation = new SFVec3f(new float[-0.008499999999999952,1.6497706236831666,-0.20499999999999996]);
...
HAnimJoint801.center = new SFVec3f(new float[-0.008499999999999952,1.6661169336661974,-0.20499999999999996]);
...
Transform803.translation = new SFVec3f(new float[-0.008499999999999952,1.6661169336661974,-0.20499999999999996]);
...
HAnimJoint811.center = new SFVec3f(new float[-0.008499999999999952,1.6824633328109189,-0.20499999999999996]);
...
Transform813.translation = new SFVec3f(new float[-0.008499999999999952,1.6824633328109189,-0.20499999999999996]);
...
HAnimJoint821.center = new SFVec3f(new float[-0.008499999999999952,1.6994040243454964,-0.20499999999999996]);
...
Transform823.translation = new SFVec3f(new float[-0.008499999999999952,1.6994040243454964,-0.20499999999999996]);
...
HAnimJoint831.center = new SFVec3f(new float[-0.008499999999999952,1.7148587471409256,-0.20499999999999996]);
...
Transform833.translation = new SFVec3f(new float[-0.008499999999999952,1.7148587471409256,-0.20499999999999996]);
...
HAnimJoint841.center = new SFVec3f(new float[-0.008499999999999952,1.7303133213335367,-0.20499999999999996]);
...
Transform843.translation = new SFVec3f(new float[-0.008499999999999952,1.7303133213335367,-0.20499999999999996]);
...
HAnimJoint851.center = new SFVec3f(new float[-0.008499999999999952,1.7225860342372314,-0.2218]);
...
Transform853.translation = new SFVec3f(new float[-0.008499999999999952,1.7225860342372314,-0.2218]);
...
HAnimJoint861.center = new SFVec3f(new float[2.2365000000000004,1.87,1.9285]);
...
Transform863.translation = new SFVec3f(new float[2.2365000000000004,1.87,1.9285]);
...
HAnimJoint871.center = new SFVec3f(new float[-2.2535,1.87,1.9285]);
...
Transform873.translation = new SFVec3f(new float[-2.2535,1.87,1.9285]);
...
HAnimJoint881.center = new SFVec3f(new float[2.1304999999999996,1.844440315299261,4.1555]);
...
Transform883.translation = new SFVec3f(new float[2.1304999999999996,1.844440315299261,4.1555]);
...
HAnimJoint891.center = new SFVec3f(new float[-2.1475,1.844440315299261,4.1555]);
...
Transform893.translation = new SFVec3f(new float[-2.1475,1.844440315299261,4.1555]);
...
HAnimJoint901.center = new SFVec3f(new float[0.9581000000000001,1.856328570462029,5.2175]);
...
Transform903.translation = new SFVec3f(new float[0.9581000000000001,1.856328570462029,5.2175]);
...
HAnimJoint911.center = new SFVec3f(new float[-0.9751,1.856328570462029,5.2175]);
...
Transform913.translation = new SFVec3f(new float[-0.9751,1.856328570462029,5.2175]);
...
HAnimJoint921.center = new SFVec3f(new float[-0.008499999999999952,1.722883180432159,1.1480000000000001]);
...
Transform923.translation = new SFVec3f(new float[-0.008499999999999952,1.722883180432159,1.1480000000000001]);
...
HAnimJoint931.center = new SFVec3f(new float[1.7015,1.5852770601003359,-0.1482]);
...
Transform933.translation = new SFVec3f(new float[1.7015,1.5852770601003359,-0.1482]);
...
HAnimJoint941.center = new SFVec3f(new float[5.455500000000001,1.562986637396203,-0.10870000000000002]);
...
Transform943.translation = new SFVec3f(new float[5.455500000000001,1.562986637396203,-0.10870000000000002]);
...
HAnimJoint951.center = new SFVec3f(new float[7.327500000000001,1.5454515048689517,0.31930000000000003]);
...
Transform953.translation = new SFVec3f(new float[7.327500000000001,1.5454515048689517,0.31930000000000003]);
...
HAnimJoint961.center = new SFVec3f(new float[8.0845,1.2155531894066565,0.21430000000000005]);
...
Transform963.translation = new SFVec3f(new float[8.0845,1.2155531894066565,0.21430000000000005]);
...
HAnimJoint971.center = new SFVec3f(new float[8.0775,0.9453932662325654,0.24120000000000003]);
...
Transform973.translation = new SFVec3f(new float[8.0775,0.9453932662325654,0.24120000000000003]);
...
HAnimJoint981.center = new SFVec3f(new float[8.0485,0.9213196097121018,1.3235000000000001]);
...
Transform983.translation = new SFVec3f(new float[8.0485,0.9213196097121018,1.3235000000000001]);
...
HAnimJoint991.center = new SFVec3f(new float[8.0135,0.9034873309899225,1.6195]);
...
Transform993.translation = new SFVec3f(new float[8.0135,0.9034873309899225,1.6195]);
...
HAnimJoint1001.center = new SFVec3f(new float[8.0375,0.8773332052965095,2.0545]);
...
Transform1003.translation = new SFVec3f(new float[8.0375,0.8773332052965095,2.0545]);
...
HAnimJoint1011.center = new SFVec3f(new float[8.1095,0.8526651375039358,2.6715]);
...
Transform1013.translation = new SFVec3f(new float[8.1095,0.8526651375039358,2.6715]);
...
HAnimJoint1021.center = new SFVec3f(new float[8.0485,0.9225084619768859,0.8386]);
...
Transform1023.translation = new SFVec3f(new float[8.0485,0.9225084619768859,0.8386]);
...
HAnimJoint1031.center = new SFVec3f(new float[8.0485,0.8969487475555831,0.8969]);
...
Transform1033.translation = new SFVec3f(new float[8.0485,0.8969487475555831,0.8969]);
...
HAnimJoint1041.center = new SFVec3f(new float[8.1575,0.830374714799803,1.1345]);
...
Transform1043.translation = new SFVec3f(new float[8.1575,0.830374714799803,1.1345]);
...
HAnimJoint1051.center = new SFVec3f(new float[8.0675,0.7902519242118,1.0949]);
...
Transform1053.translation = new SFVec3f(new float[8.0675,0.7902519242118,1.0949]);
...
HAnimJoint1061.center = new SFVec3f(new float[8.0215,0.7569649226941918,1.0594000000000001]);
...
Transform1063.translation = new SFVec3f(new float[8.0215,0.7569649226941918,1.0594000000000001]);
...
HAnimJoint1071.center = new SFVec3f(new float[8.0395,0.9245889014292714,0.2513]);
...
Transform1073.translation = new SFVec3f(new float[8.0395,0.9245889014292714,0.2513]);
...
HAnimJoint1081.center = new SFVec3f(new float[8.0395,0.8945711321877058,0.18660000000000004]);
...
Transform1083.translation = new SFVec3f(new float[8.0395,0.8945711321877058,0.18660000000000004]);
...
HAnimJoint1091.center = new SFVec3f(new float[8.1555,0.8274026287186883,0.2904]);
...
Transform1093.translation = new SFVec3f(new float[8.1555,0.8274026287186883,0.2904]);
...
HAnimJoint1101.center = new SFVec3f(new float[8.0675,0.7854966340349183,0.3073]);
...
Transform1103.translation = new SFVec3f(new float[8.0675,0.7854966340349183,0.3073]);
...
HAnimJoint1111.center = new SFVec3f(new float[8.0215,0.7486431648846488,0.2974]);
...
Transform1113.translation = new SFVec3f(new float[8.0215,0.7486431648846488,0.2974]);
...
HAnimJoint1121.center = new SFVec3f(new float[8.0395,0.9210224635171738,-0.6794999999999999]);
...
Transform1123.translation = new SFVec3f(new float[8.0395,0.9210224635171738,-0.6794999999999999]);
...
HAnimJoint1131.center = new SFVec3f(new float[8.0395,0.895165543459816,-0.42079999999999995]);
...
Transform1133.translation = new SFVec3f(new float[8.0395,0.895165543459816,-0.42079999999999995]);
...
HAnimJoint1141.center = new SFVec3f(new float[8.1555,0.8262138358950314,-0.48839999999999995]);
...
Transform1143.translation = new SFVec3f(new float[8.1555,0.8262138358950314,-0.48839999999999995]);
...
HAnimJoint1151.center = new SFVec3f(new float[8.0675,0.7899547185757448,-0.45309999999999995]);
...
Transform1153.translation = new SFVec3f(new float[8.0675,0.7899547185757448,-0.45309999999999995]);
...
HAnimJoint1161.center = new SFVec3f(new float[8.0215,0.7557760704294078,-0.4145]);
...
Transform1163.translation = new SFVec3f(new float[8.0215,0.7557760704294078,-0.4145]);
...
HAnimJoint1171.center = new SFVec3f(new float[8.0645,0.8978403941843119,-0.9925]);
...
Transform1173.translation = new SFVec3f(new float[8.0645,0.8978403941843119,-0.9925]);
...
HAnimJoint1181.center = new SFVec3f(new float[8.1395,0.831563567064587,-1.1825]);
...
Transform1183.translation = new SFVec3f(new float[8.1395,0.831563567064587,-1.1825]);
...
HAnimJoint1191.center = new SFVec3f(new float[8.0655,0.8089759090038352,-1.1865]);
...
Transform1193.translation = new SFVec3f(new float[8.0655,0.8089759090038352,-1.1865]);
...
HAnimJoint1201.center = new SFVec3f(new float[8.0275,0.7843078412112614,-1.1785]);
...
Transform1203.translation = new SFVec3f(new float[8.0275,0.7843078412112614,-1.1785]);
...
HAnimJoint1211.center = new SFVec3f(new float[-1.7185,1.5852770601003359,-0.1482]);
...
Transform1213.translation = new SFVec3f(new float[-1.7185,1.5852770601003359,-0.1482]);
...
HAnimJoint1221.center = new SFVec3f(new float[-5.4725,1.562986637396203,-0.10870000000000002]);
...
Transform1223.translation = new SFVec3f(new float[-5.4725,1.562986637396203,-0.10870000000000002]);
...
HAnimJoint1231.center = new SFVec3f(new float[-7.3285,1.5454515048689517,0.31930000000000003]);
...
Transform1233.translation = new SFVec3f(new float[-7.3285,1.5454515048689517,0.31930000000000003]);
...
HAnimJoint1241.center = new SFVec3f(new float[-8.0855,1.2155531894066565,0.21430000000000005]);
...
Transform1243.translation = new SFVec3f(new float[-8.0855,1.2155531894066565,0.21430000000000005]);
...
HAnimJoint1251.center = new SFVec3f(new float[-8.0785,0.9453932662325654,0.24130000000000001]);
...
Transform1253.translation = new SFVec3f(new float[-8.0785,0.9453932662325654,0.24130000000000001]);
...
HAnimJoint1261.center = new SFVec3f(new float[-8.051499999999999,0.9213196097121018,1.3235000000000001]);
...
Transform1263.translation = new SFVec3f(new float[-8.051499999999999,0.9213196097121018,1.3235000000000001]);
...
HAnimJoint1271.center = new SFVec3f(new float[-8.0145,0.9034873309899225,1.6195]);
...
Transform1273.translation = new SFVec3f(new float[-8.0145,0.9034873309899225,1.6195]);
...
HAnimJoint1281.center = new SFVec3f(new float[-8.0375,0.8773332052965095,2.0545]);
...
Transform1283.translation = new SFVec3f(new float[-8.0375,0.8773332052965095,2.0545]);
...
HAnimJoint1291.center = new SFVec3f(new float[-8.1095,0.8526651375039358,2.6715]);
...
Transform1293.translation = new SFVec3f(new float[-8.1095,0.8526651375039358,2.6715]);
...
HAnimJoint1301.center = new SFVec3f(new float[-8.051499999999999,0.9225084619768859,0.8386]);
...
Transform1303.translation = new SFVec3f(new float[-8.051499999999999,0.9225084619768859,0.8386]);
...
HAnimJoint1311.center = new SFVec3f(new float[-8.048499999999999,0.8969487475555831,0.8969]);
...
Transform1313.translation = new SFVec3f(new float[-8.048499999999999,0.8969487475555831,0.8969]);
...
HAnimJoint1321.center = new SFVec3f(new float[-8.157499999999999,0.830374714799803,1.1345]);
...
Transform1323.translation = new SFVec3f(new float[-8.157499999999999,0.830374714799803,1.1345]);
...
HAnimJoint1331.center = new SFVec3f(new float[-8.067499999999999,0.7902519242118,1.0949]);
...
Transform1333.translation = new SFVec3f(new float[-8.067499999999999,0.7902519242118,1.0949]);
...
HAnimJoint1341.center = new SFVec3f(new float[-8.0215,0.7569649226941918,1.0594000000000001]);
...
Transform1343.translation = new SFVec3f(new float[-8.0215,0.7569649226941918,1.0594000000000001]);
...
HAnimJoint1351.center = new SFVec3f(new float[-8.0405,0.9245889014292714,0.2513]);
...
Transform1353.translation = new SFVec3f(new float[-8.0405,0.9245889014292714,0.2513]);
...
HAnimJoint1361.center = new SFVec3f(new float[-8.0405,0.8945711321877058,0.18660000000000004]);
...
Transform1363.translation = new SFVec3f(new float[-8.0405,0.8945711321877058,0.18660000000000004]);
...
HAnimJoint1371.center = new SFVec3f(new float[-8.1555,0.8274026287186883,0.2904]);
...
Transform1373.translation = new SFVec3f(new float[-8.1555,0.8274026287186883,0.2904]);
...
HAnimJoint1381.center = new SFVec3f(new float[-8.067499999999999,0.7854966340349183,0.3073]);
...
Transform1383.translation = new SFVec3f(new float[-8.067499999999999,0.7854966340349183,0.3073]);
...
HAnimJoint1391.center = new SFVec3f(new float[-8.0215,0.7486431648846488,0.2974]);
...
Transform1393.translation = new SFVec3f(new float[-8.0215,0.7486431648846488,0.2974]);
...
HAnimJoint1401.center = new SFVec3f(new float[-8.0405,0.9210224635171738,-0.6794999999999999]);
...
Transform1403.translation = new SFVec3f(new float[-8.0405,0.9210224635171738,-0.6794999999999999]);
...
HAnimJoint1411.center = new SFVec3f(new float[-8.0405,0.895165543459816,-0.42079999999999995]);
...
Transform1413.translation = new SFVec3f(new float[-8.0405,0.895165543459816,-0.42079999999999995]);
...
HAnimJoint1421.center = new SFVec3f(new float[-8.1555,0.8262138358950314,-0.48839999999999995]);
...
Transform1423.translation = new SFVec3f(new float[-8.1555,0.8262138358950314,-0.48839999999999995]);
...
HAnimJoint1431.center = new SFVec3f(new float[-8.067499999999999,0.7899547185757448,-0.45309999999999995]);
...
Transform1433.translation = new SFVec3f(new float[-8.067499999999999,0.7899547185757448,-0.45309999999999995]);
...
HAnimJoint1441.center = new SFVec3f(new float[-8.0215,0.7557760704294078,-0.4145]);
...
Transform1443.translation = new SFVec3f(new float[-8.0215,0.7557760704294078,-0.4145]);
...
HAnimJoint1451.center = new SFVec3f(new float[-8.064499999999999,0.8978403941843119,-0.9925]);
...
Transform1453.translation = new SFVec3f(new float[-8.064499999999999,0.8978403941843119,-0.9925]);
...
HAnimJoint1461.center = new SFVec3f(new float[-8.1405,0.831563567064587,-1.1825]);
...
Transform1463.translation = new SFVec3f(new float[-8.1405,0.831563567064587,-1.1825]);
...
HAnimJoint1471.center = new SFVec3f(new float[-8.0665,0.8089759090038352,-1.1865]);
...
Transform1473.translation = new SFVec3f(new float[-8.0665,0.8089759090038352,-1.1865]);
...
HAnimJoint1481.center = new SFVec3f(new float[-8.0285,0.7843078412112614,-1.1785]);
...
Transform1483.translation = new SFVec3f(new float[-8.0285,0.7843078412112614,-1.1785]);

...
Viewpoint21.position = new SFVec3f(new float[0,20,60]);
children = new MFNode();

children[0] = Viewpoint21;
...
children[1] = TimeSensor22;

EXPORT EXPORT23 = createNode("EXPORT");
EXPORT23.localDEF = "JinMouthStretch_Clock";
EXPORT23.AS = "JinMouthStretch_Clock";
children[2] = EXPORT23;

ScalarInterpolator ScalarInterpolator24 = createNode("ScalarInterpolator");
ScalarInterpolator24.DEF = "AnimationAdapter_JinMouthStretch";
ScalarInterpolator24.key = new MFFloat(new float[0,0.25,0.5,0.75,1]);
ScalarInterpolator24.keyValue = new MFFloat(new float[0,0.5,1,0.5,0]);
children[3] = ScalarInterpolator24;
...
HAnimSegment27.children[0] = WorldInfo28;

Background Background29 = createNode("Background");
Background29.skyColor = new MFColor(new float[0.8,0.9,1]);
HAnimSegment27.children[1] = Background29;

NavigationInfo NavigationInfo30 = createNode("NavigationInfo");
NavigationInfo30.type = new MFString(new java.lang.String["EXAMINE"]);
HAnimSegment27.children[2] = NavigationInfo30;
...
Transform33.translation = new SFVec3f(new float[0,8.886,11.1]);
...
ImageTexture37.url = new MFString(new java.lang.String["JinImageAtlas.jpg","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/JinImageAtlas.jpg"]);
...
HAnimHumanoid25.joints[1] = HAnimJoint43;

HAnimJoint HAnimJoint44 = createNode("HAnimJoint");
HAnimJoint44.USE = "hanim_skullbase";
HAnimHumanoid25.joints[2] = HAnimJoint44;

children[4] = HAnimHumanoid25;

...
meta6.content = "file:///home/holger/Projekte/Library/Tests/Components/Follower/TexCoordDamper.x3d";
head1.meta[4] = meta6;

meta meta7 = createNode("meta");
meta7.name = "modified";
meta7.content = "Sun, 25 Feb 2018 06:58:18 GMT";
head1.meta[5] = meta7;
...
TexCoordDamper2D TexCoordDamper2D64 = createNode("TexCoordDamper2D");
TexCoordDamper2D64.DEF = "_5";
TexCoordDamper2D64.initialValue = new MFVec2f(new float[-1,-1,1,-1,1,1,-1,1]);
TexCoordDamper2D64.initialDestination = new MFVec2f(new float[-1,-1,1,-1,1,1,-1,1]);
children[9] = TexCoordDamper2D64;
...
ROUTE72.toNode = "_6";
ROUTE72.toField = "set_point";
children[11] = ROUTE72;

ROUTE ROUTE73 = createNode("ROUTE");
ROUTE73.fromNode = "Touch3";
...
ROUTE76.fromNode = "Touch";
ROUTE76.fromField = "touchTime";
ROUTE76.toNode = "_1";
ROUTE76.toField = "set_triggerTime";
children[15] = ROUTE76;
...
ROUTE80.toNode = "_5";
ROUTE80.toField = "set_destination";
children[19] = ROUTE80;

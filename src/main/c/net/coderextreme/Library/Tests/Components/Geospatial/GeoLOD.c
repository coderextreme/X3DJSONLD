...
meta3.name = "created";
meta3.content = "Sat, 16 Apr 2016 03:08:26 GMT";
head1.meta[1] = meta3;
...
meta6.content = "file:///home/holger/Projekte/Cobweb/excite/tests/Components/Geospatial/GeoLOD.x3d";
head1.meta[4] = meta6;

meta meta7 = createNode("meta");
meta7.name = "modified";
meta7.content = "Sat, 16 Apr 2016 10:27:25 GMT";
head1.meta[5] = meta7;

head = head1;

WorldInfo WorldInfo9 = createNode("WorldInfo");
WorldInfo9.title = "GeoLOD";
...
MetadataDouble14.value = new MFDouble(new double[3.4243814624459,4.70306799888223,4.97005948513556]);
...
MetadataDouble15.value = new MFDouble(new double[-0.752038455961314,0.63921920036136,0.160738839876076,0.875970352523691]);
...
Viewpoint20.DEF = "_1";
Viewpoint20.description = "Viewpoint";
Viewpoint20.position = new SFVec3f(new float[4.21584,5.79006,6.11876]);
Viewpoint20.orientation = new SFRotation(new float[-0.752038455961314,0.63921920036136,0.160738839876076,0.875970352523691]);
MetadataSet19.value = Viewpoint20;
...
Viewpoint34.USE = "_1";
Group23.children[1] = Viewpoint34;

children[3] = Group23;

GeoLOD GeoLOD35 = createNode("GeoLOD");
GeoLOD35.geoSystem = new MFString(new java.lang.String["GC"]);
GeoLOD35.rootUrl = new MFString(new java.lang.String["root.x3dv"]);
GeoLOD35.child1Url = new MFString(new java.lang.String["child1.x3dv"]);
GeoLOD35.child2Url = new MFString(new java.lang.String["child2.x3dv"]);
GeoLOD35.child3Url = new MFString(new java.lang.String["child3.x3dv"]);
GeoLOD35.child4Url = new MFString(new java.lang.String["child4.x3dv"]);
children[4] = GeoLOD35;
...
ROUTE41.toNode = "PositionInterpolator";
ROUTE41.toField = "set_fraction";
children[6] = ROUTE41;

ROUTE ROUTE42 = createNode("ROUTE");
ROUTE42.fromNode = "PositionInterpolator";
ROUTE42.fromField = "value_changed";
ROUTE42.toNode = "_1";
ROUTE42.toField = "set_position";
children[7] = ROUTE42;

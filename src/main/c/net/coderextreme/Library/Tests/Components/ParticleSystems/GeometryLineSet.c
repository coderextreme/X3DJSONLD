...
meta10.content = "Tue, 23 Apr 2024 10:21:55 GMT";
head1.meta[8] = meta10;
...
ParticleSystem28.geometry = IndexedLineSet32;

children[3] = ParticleSystem28;

ParticleSystem ParticleSystem35 = createNode("ParticleSystem");
ParticleSystem35.geometryType = "GEOMETRY";
ParticleSystem35.maxParticles = 10;
ParticleSystem35.particleLifetime = 4;
ParticleSystem35.lifetimeVariation = 0.5;
ParticleSystem35.particleSize = new SFVec2f(new float[1,1]);
PointEmitter PointEmitter36 = createNode("PointEmitter");
PointEmitter36.USE = "_1";
ParticleSystem35.emitter = PointEmitter36;

WindPhysicsModel WindPhysicsModel37 = createNode("WindPhysicsModel");
WindPhysicsModel37.USE = "_2";
ParticleSystem35.physics = new MFNode();

ParticleSystem35.physics[0] = WindPhysicsModel37;

WindPhysicsModel WindPhysicsModel38 = createNode("WindPhysicsModel");
WindPhysicsModel38.USE = "_3";
ParticleSystem35.physics[1] = WindPhysicsModel38;

Appearance Appearance39 = createNode("Appearance");
LineProperties LineProperties40 = createNode("LineProperties");
LineProperties40.linewidthScaleFactor = 2;
Appearance39.lineProperties = LineProperties40;

ParticleSystem35.appearance = Appearance39;

IndexedLineSet IndexedLineSet41 = createNode("IndexedLineSet");
IndexedLineSet41.USE = "_4";
ParticleSystem35.geometry = IndexedLineSet41;

children[4] = ParticleSystem35;

Transform Transform42 = createNode("Transform");
Transform42.DEF = "IndexedLineSet";
Shape Shape43 = createNode("Shape");
IndexedLineSet IndexedLineSet44 = createNode("IndexedLineSet");
IndexedLineSet44.USE = "_4";
...
children[5] = Transform42;

ProtoInstance ProtoInstance45 = createNode("ProtoInstance");
ProtoInstance45.name = "Grid";
children[6] = ProtoInstance45;

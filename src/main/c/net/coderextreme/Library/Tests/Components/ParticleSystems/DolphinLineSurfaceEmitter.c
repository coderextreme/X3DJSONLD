...
meta5.content = "Titania V1.4.4, http://titania.create3000.de";
head1.meta[3] = meta5;

meta meta6 = createNode("meta");
meta6.name = "identifier";
meta6.content = "file:///home/holger/Projekte/Cobweb/excite/tests/Components/ParticleSystems/DolphinLineSurfaceEmitter.x3d";
head1.meta[4] = meta6;

meta meta7 = createNode("meta");
meta7.name = "modified";
meta7.content = "Tue, 17 May 2016 08:14:35 GMT";
head1.meta[5] = meta7;
...
MetadataDouble21.value = new MFDouble(new double[209.085708618164,-284.294311523438,251.209625244141]);
...
MetadataDouble22.value = new MFDouble(new double[0.832041258895059,0.311619716372351,0.458912296484134,1.01485308574234]);
...
ParticleSystem27.DEF = "_1";
ParticleSystem27.geometryType = "LINE";
ParticleSystem27.maxParticles = 15000;
ParticleSystem27.particleSize = new SFVec2f(new float[6,6]);
SurfaceEmitter SurfaceEmitter28 = createNode("SurfaceEmitter");
SurfaceEmitter28.speed = 2;
SurfaceEmitter28.mass = 0.01;
SurfaceEmitter28.surfaceArea = 0.01;
ProtoInstance ProtoInstance29 = createNode("ProtoInstance");
ProtoInstance29.name = "Dolphin";
ProtoInstance29.DEF = "_2";
SurfaceEmitter28.surface = ProtoInstance29;

ParticleSystem27.emitter = SurfaceEmitter28;

Appearance Appearance30 = createNode("Appearance");
Material Material31 = createNode("Material");
Material31.DEF = "Rococo17";
Material31.ambientIntensity = 0.187004;
Material31.diffuseColor = new SFColor(new float[0,0,0]);
Material31.emissiveColor = new SFColor(new float[0.640987,0.460097,0.748016]);
Material31.shininess = 0.612121;
Appearance30.material = Material31;

ParticleSystem27.appearance = Appearance30;

MetadataSet26.value = ParticleSystem27;
...
Material38.transparency = 0.884393;
Appearance37.material = Material38;

Shape36.appearance = Appearance37;

ProtoInstance ProtoInstance39 = createNode("ProtoInstance");
ProtoInstance39.name = "Dolphin";
ProtoInstance39.USE = "_2";
Shape36.geometry = ProtoInstance39;
...
ParticleSystem ParticleSystem40 = createNode("ParticleSystem");
ParticleSystem40.USE = "_1";
children[6] = ParticleSystem40;

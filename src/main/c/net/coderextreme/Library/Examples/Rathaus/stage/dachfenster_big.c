...
meta3.name = "created";
meta3.content = "Sun, 15 Mar 2015 09:33:53 GMT";
head1.meta[1] = meta3;
...
meta6.name = "modified";
meta6.content = "Sun, 15 Mar 2015 09:33:53 GMT";
head1.meta[4] = meta6;
...
Transform10.DEF = "nurbsToPoly162";
...
IndexedFaceSet14.DEF = "nurbsToPoly162_0Geo";
...
Coordinate15.DEF = "nurbsToPoly162GeoPoints";
Coordinate15.point = new MFVec3f(new float[-0.683,4.401,13.552,-0.681,4.401,15.434,0.678,4.959,15.432,0.675,4.959,13.55,-0.683,5.02,13.552,0.675,5.579,13.55,-0.681,5.02,15.434,0.678,5.579,15.432]);
...
IndexedFaceSet19.DEF = "nurbsToPoly162_1Geo";
IndexedFaceSet19.convex = False;
IndexedFaceSet19.coordIndex = new MFInt32(new int[1,6,4,0,-1]);
Coordinate Coordinate20 = createNode("Coordinate");
Coordinate20.USE = "nurbsToPoly162GeoPoints";
...
Transform21.DEF = "nurbsToPoly154";
...
IndexedFaceSet25.DEF = "nurbsToPoly154_0Geo";
...
Coordinate26.DEF = "nurbsToPoly154GeoPoints";
Coordinate26.point = new MFVec3f(new float[1.165,6.286,14.27,1.165,6.286,14.637,2.222,6.72,14.636,2.222,6.72,14.269,1.165,6.768,14.27,2.222,7.203,14.269,1.165,6.768,14.637,2.222,7.203,14.636]);
...
Transform27.DEF = "nurbsToPoly153";
...
IndexedFaceSet31.DEF = "nurbsToPoly153_0Geo";
...
Coordinate32.DEF = "nurbsToPoly153GeoPoints";
Coordinate32.point = new MFVec3f(new float[2.061,7.648,14.27,2.061,7.648,14.637,3.118,8.083,14.636,3.118,8.083,14.269,2.061,8.13,14.27,3.118,8.565,14.269,2.061,8.13,14.637,3.118,8.565,14.636]);
...
Coordinate38.point = new MFVec3f(new float[1.165,6.768,14.27,1.165,6.286,14.27,1.165,6.286,14.637,1.165,6.768,14.637]);
...
Coordinate44.point = new MFVec3f(new float[2.061,8.13,14.27,2.061,7.648,14.27,2.061,7.648,14.637,2.061,8.13,14.637]);

...
<ProtoDeclare name="Unless" ><ProtoInterface><field name="value" accessType="inputOutput" type="SFBool" value="true"></field>
<field name="touchTime" accessType="outputOnly" type="SFTime"></field>
</ProtoInterface>
<ProtoBody><ProtoDeclare name="Data"><ProtoInterface><field name="value" accessType="inputOutput" type="SFBool" value="true"></field>
</ProtoInterface>
<ProtoBody><Group></Group>
</ProtoBody>
</ProtoDeclare>
<Script DEF="_unless" directOutput="true"><field name="touchTime" accessType="outputOnly" type="SFTime"></field>
<field name="set_value" accessType="inputOnly" type="SFBool"></field>
...
function initialize() { set_value(data.value, 0); }]]></Script>
<ROUTE fromNode="Data" fromField="value_changed" toNode="_unless" toField="set_value"></ROUTE>
</ProtoBody>
</ProtoDeclare>`);
ProtoDeclare8.name = "Unless";
...
<!DOCTYPE X3D PUBLIC "ISO//Web3D//DTD X3D undefined//EN" "https://www.web3d.org/specifications/x3d-undefined.dtd">
<ProtoDeclare name="Data" ><ProtoInterface><field name="value" accessType="inputOutput" type="SFBool" value="true"></field>
</ProtoInterface>
<ProtoBody><Group></Group>
</ProtoBody>
</ProtoDeclare>`);
...
connect26.nodeField = "touchTime";
connect26.protoField = "touchTime";

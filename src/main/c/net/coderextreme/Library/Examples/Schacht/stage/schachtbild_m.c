...
ImageTexture39.url = new MFString(new java.lang.String["busy-ape-512.jpg"]);
...
TextureCoordinate41.point = new MFVec2f(new float[0.314065,0.544841,0.652179,0.544841,0.652179,0.768937,0.314065,0.768937]);
...
TextureCoordinate49.point = new MFVec2f(new float[0.189888,0.396978,0.350445,0.396978,0.350445,0.616758,0.189888,0.616758]);
...
TextureCoordinate57.point = new MFVec2f(new float[0.605089,0.382986,0.793862,0.382986,0.793862,0.627253,0.605089,0.627253]);
...
TextureCoordinate73.point = new MFVec2f(new float[0.101275,0.224853,0.872576,0.224853,0.872576,0.419975,0.101275,0.419975]);
...
TextureCoordinate81.point = new MFVec2f(new float[0.307175,0.132377,0.657426,0.132377,0.657426,0.238935,0.307175,0.238935]);
...
TextureCoordinate89.point = new MFVec2f(new float[0.00252092,-0.00484368,1.9929,-0.00484368,1.9929,0.99911,0.00252092,0.99911]);
...
TextureCoordinate105.point = new MFVec2f(new float[0,0,0.988054,0,0.988054,0.476856,0,0.476856]);
...
TextureCoordinate113.point = new MFVec2f(new float[0,0,4.99271,0,4.99271,2.99489,0,2.99489]);
...
Transform126.translation = new SFVec3f(new float[-0.00000340492,-0.0552902,0.279499]);

...
<Script DEF="_1" directOutput="true"><field name="isActive" accessType="outputOnly" type="SFBool"></field>
<field name="exitTime" accessType="outputOnly" type="SFTime"></field>
...
<field name="timeSensor" accessType="initializeOnly" type="SFNode"><TimeSensor DEF="_2"><IS><connect nodeField="enabled" protoField="enabled"></connect>
</IS>
</TimeSensor>
</field>
<field name="data" accessType="initializeOnly" type="SFNode"><ProtoInstance name="Data" DEF="_3"><IS><connect nodeField="cycleInterval" protoField="cycleInterval"></connect>
...
<ROUTE fromNode="_3" fromField="startTime_changed" toNode="_1" toField="set_startTime"></ROUTE>
<ROUTE fromNode="_3" fromField="stopTime_changed" toNode="_1" toField="set_stopTime"></ROUTE>
<ROUTE fromNode="_2" fromField="time" toNode="_1" toField="set_time"></ROUTE>
</ProtoBody>
</ProtoDeclare>`);
...
ROUTE43.fromNode = "_3";
ROUTE43.fromField = "startTime_changed";
ROUTE43.toNode = "_1";
...
ROUTE44.fromNode = "_3";
ROUTE44.fromField = "stopTime_changed";
ROUTE44.toNode = "_1";

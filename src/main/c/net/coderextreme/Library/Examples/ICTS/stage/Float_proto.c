...
<ProtoDeclare name="Float" ><ProtoInterface><field name="startTime" accessType="inputOnly" type="SFTime"></field>
...
<ProtoBody><ProtoDeclare name="Data"><ProtoInterface><field name="keyValue" accessType="inputOutput" type="SFFloat"></field>
</ProtoInterface>
...
<!DOCTYPE X3D PUBLIC "ISO//Web3D//DTD X3D undefined//EN" "https://www.web3d.org/specifications/x3d-undefined.dtd">
<ProtoDeclare name="Data" ><ProtoInterface><field name="keyValue" accessType="inputOutput" type="SFFloat"></field>
</ProtoInterface>
<ProtoBody><Group></Group>
</ProtoBody>
</ProtoDeclare>`);

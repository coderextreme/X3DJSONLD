...
Transform9.translation = new SFVec3f(new float[0,0,0.005]);
Transform9.scale = new SFVec3f(new float[0.0313628,0.0313628,0.31363]);
...
ImageTexture12.url = new MFString(new java.lang.String["move.gif"]);

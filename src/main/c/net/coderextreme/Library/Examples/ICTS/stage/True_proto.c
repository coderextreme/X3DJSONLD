...
<ProtoDeclare name="True" ><ProtoInterface><field name="set_SFBool" accessType="inputOnly" type="SFBool"></field>
<field name="startTime" accessType="outputOnly" type="SFTime"></field>
</ProtoInterface>
<ProtoBody><Script DEF="_true"><field name="startTime" accessType="outputOnly" type="SFTime"></field>

...
<ProtoDeclare name="Not" ><ProtoInterface><field name="set_SFBool" accessType="inputOnly" type="SFBool"></field>
<field name="value_changed" accessType="outputOnly" type="SFBool"></field>
</ProtoInterface>
<ProtoBody><Script DEF="_not"><field name="set_SFBool" accessType="inputOnly" type="SFBool"></field>
<field name="value_changed" accessType="outputOnly" type="SFBool"></field>
<IS><connect nodeField="set_SFBool" protoField="set_SFBool"></connect>
...
connect17.nodeField = "set_SFBool";
connect17.protoField = "set_SFBool";

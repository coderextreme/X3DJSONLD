...
Text55.string = new MFString(new java.lang.String[", ","Kino, Filme, Stars. Und was gibt's neues?, ","Wenn du nah genug an einem Filmplakat, ","bist, bekommst du noch mehr Info., ","Das neueste Filmchen kannst du dir hiergleich um die Ecke anschauen, aber ..."]);
...
Text61.string = new MFString(new java.lang.String[", ","warte ab bis der Film da ist, dass kann,, ","noch einen Moment dauern. Klick doch, ","mal auf ein Filmplakat., ","Du kannst überall herumlaufen und Dichumschauen. Ich kann Dir erklären ..."]);
...
Transform63.DEF = "t3";
Transform63.translation = new SFVec3f(new float[-0.125213,0.0301585,-0.296962]);
Transform63.scale = new SFVec3f(new float[0.00267326,0.00272434,0.00272354]);
...
Text67.string = new MFString(new java.lang.String[", ","... wie das geht: Klicke einfach mit Deiner, ","Maus in die Mitte des Bildes und ziehe, ","mit gedrückt gehaltener Maustaste, ","in die Richtung, in die Du laufen möchtestoder benutze die Pfeiltasten."]);
...
ROUTE78.fromNode = "_7";
ROUTE78.fromField = "whichChoice_changed";
ROUTE78.toNode = "_6";

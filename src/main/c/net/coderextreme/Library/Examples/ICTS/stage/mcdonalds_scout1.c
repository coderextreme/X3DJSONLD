...
Inline10.url = new MFString(new java.lang.String["helpScout.x3d"]);
Inline10.bboxSize = new SFVec3f(new float[5,3.8,5]);
...
Inline19.url = new MFString(new java.lang.String["cs_help-txt.x3d"]);
Inline19.bboxSize = new SFVec3f(new float[0.537486,0.144576,0.0317884]);
Inline19.bboxCenter = new SFVec3f(new float[0.00359547,-0.0934332,-0.276017]);
...
ProximitySensor22.size = new SFVec3f(new float[7,2,7]);

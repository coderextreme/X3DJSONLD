...
Transform9.DEF = "on";
Transform9.translation = new SFVec3f(new float[0.183659,0.0636474,-0.296069]);
Transform9.scale = new SFVec3f(new float[0.0162762,0.0162762,0.162762]);
...
ImageTexture12.url = new MFString(new java.lang.String["close.gif"]);

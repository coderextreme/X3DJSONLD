...
<ProtoDeclare name="Random" ><ProtoInterface><field name="minValue" accessType="inputOutput" type="SFFloat"></field>
...
<ProtoBody><ProtoDeclare name="Data"><ProtoInterface><field name="minValue" accessType="inputOutput" type="SFFloat"></field>
<field name="maxValue" accessType="inputOutput" type="SFFloat" value="1"></field>
<field name="startTime" accessType="inputOutput" type="SFTime" value="1"></field>
</ProtoInterface>
...
<IS><connect nodeField="fraction_changed" protoField="fraction_changed"></connect>
</IS>
<![CDATA[vrmlscript:
...
<!DOCTYPE X3D PUBLIC "ISO//Web3D//DTD X3D undefined//EN" "https://www.web3d.org/specifications/x3d-undefined.dtd">
<ProtoDeclare name="Data" ><ProtoInterface><field name="minValue" accessType="inputOutput" type="SFFloat"></field>
<field name="maxValue" accessType="inputOutput" type="SFFloat" value="1"></field>
<field name="startTime" accessType="inputOutput" type="SFTime" value="1"></field>
</ProtoInterface>
<ProtoBody><Group></Group>
...
connect33.nodeField = "fraction_changed";
connect33.protoField = "fraction_changed";

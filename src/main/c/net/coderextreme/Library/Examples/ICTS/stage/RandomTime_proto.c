...
<ProtoDeclare name="RandomTime" ><ProtoInterface><field name="minTime" accessType="inputOutput" type="SFTime"></field>
<field name="maxTime" accessType="inputOutput" type="SFTime" value="1"></field>
<field name="startTime" accessType="inputOutput" type="SFTime"></field>
<field name="randomTime" accessType="outputOnly" type="SFTime"></field>
</ProtoInterface>
<ProtoBody><ProtoDeclare name="Data"><ProtoInterface><field name="minTime" accessType="inputOutput" type="SFTime"></field>
<field name="maxTime" accessType="inputOutput" type="SFTime" value="1"></field>
...
<Group><Script DEF="_randomTime" directOutput="true"><field name="set_startTime" accessType="inputOnly" type="SFTime"></field>
<field name="randomTime" accessType="outputOnly" type="SFTime"></field>
<field name="data" accessType="initializeOnly" type="SFNode"><ProtoInstance name="Data" DEF="Data"><IS><connect nodeField="minTime" protoField="minTime"></connect>
<connect nodeField="maxTime" protoField="maxTime"></connect>
<connect nodeField="startTime" protoField="startTime"></connect>
</IS>
</ProtoInstance>
</field>
<IS><connect nodeField="randomTime" protoField="randomTime"></connect>
</IS>
<![CDATA[vrmlscript:
...
<ROUTE fromNode="Data" fromField="startTime_changed" toNode="_randomTime" toField="set_startTime"></ROUTE>
</ProtoBody>
</ProtoDeclare>`);
ProtoDeclare8.name = "RandomTime";
ProtoInterface ProtoInterface9 = createNode("ProtoInterface");
field field10 = createNode("field");
field10.name = "minTime";
...
<!DOCTYPE X3D PUBLIC "ISO//Web3D//DTD X3D undefined//EN" "https://www.web3d.org/specifications/x3d-undefined.dtd">
<ProtoDeclare name="Data" ><ProtoInterface><field name="minTime" accessType="inputOutput" type="SFTime"></field>
<field name="maxTime" accessType="inputOutput" type="SFTime" value="1"></field>
<field name="startTime" accessType="inputOutput" type="SFTime" value="1"></field>
</ProtoInterface>
<ProtoBody><Group></Group>
...
connect29.nodeField = "minTime";
connect29.protoField = "minTime";
IS28.connect = new MFNode();

IS28.connect[0] = connect29;

connect connect30 = createNode("connect");
connect30.nodeField = "maxTime";
connect30.protoField = "maxTime";
...
connect33.nodeField = "randomTime";
connect33.protoField = "randomTime";

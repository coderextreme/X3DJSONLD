...
<ProtoDeclare name="EnableTouch" ><ProtoInterface><field name="touchTime" accessType="inputOnly" type="SFTime"></field>
...
<ProtoBody><Script DEF="_enableTouch"><field name="touchTime" accessType="inputOnly" type="SFTime"></field>
<field name="isActive" accessType="inputOnly" type="SFBool"></field>
<field name="enabled_changed" accessType="outputOnly" type="SFBool"></field>
...
ProtoDeclare8.name = "EnableTouch";
...
connect19.nodeField = "touchTime";
connect19.protoField = "touchTime";
IS18.connect = new MFNode();

IS18.connect[0] = connect19;

connect connect20 = createNode("connect");
connect20.nodeField = "isActive";
connect20.protoField = "isActive";

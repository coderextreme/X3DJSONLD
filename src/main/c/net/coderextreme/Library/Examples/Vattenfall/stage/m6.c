...
TextureCoordinate15.point = new MFVec2f(new float[0,0,1,0,1,0.147102,0,0.147102]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[-0.5,-0.5,0,0.5,-0.5,0,0.5,-0.352898,0,-0.5,-0.352898,0]);

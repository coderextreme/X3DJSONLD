...
meta6.name = "modified";
meta6.content = "Sat, 25 Apr 2015 12:38:15 GMT";
head1.meta[4] = meta6;
...
ImageTexture12.url = new MFString(new java.lang.String["menu-cam-on.png"]);
...
Color14.color = new MFColor(new float[1,1,1]);
IndexedFaceSet13.color = Color14;

TextureCoordinate TextureCoordinate15 = createNode("TextureCoordinate");
TextureCoordinate15.point = new MFVec2f(new float[0.28267,0,0.374974,0,0.374974,1,0.28267,1]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[-0.21733,-0.5,0,-0.125026,-0.5,0,-0.125026,0.5,0,-0.21733,0.5,0]);

...
Transform9.DEF = "btn-cam";
Transform9.translation = new SFVec3f(new float[0.126316,0.113851,-0.299736]);
...
ImageTexture12.url = new MFString(new java.lang.String["btn-cam.png"]);
...
TextureCoordinate14.point = new MFVec2f(new float[0.999634,0.0149957,1,1,0.389588,1,0.612131,0.0149957]);
IndexedFaceSet13.texCoord = TextureCoordinate14;

Coordinate Coordinate15 = createNode("Coordinate");
Coordinate15.point = new MFVec3f(new float[0.5,-0.5,0,0.5,0.5,0,-0.110412,0.5,0,0.112497,-0.5,0]);

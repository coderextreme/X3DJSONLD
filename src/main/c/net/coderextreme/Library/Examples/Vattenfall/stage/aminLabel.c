...
TextureCoordinate15.point = new MFVec2f(new float[0,0,0.190368,0,0.190368,1,0,1]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[-0.5,-0.5,0,-0.309632,-0.5,0,-0.309632,0.5,0,-0.5,0.5,0]);

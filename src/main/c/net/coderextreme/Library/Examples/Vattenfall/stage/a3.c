...
meta3.name = "created";
meta3.content = "Sat, 25 Apr 2015 12:38:16 GMT";
head1.meta[1] = meta3;
...
meta6.name = "modified";
meta6.content = "Sat, 25 Apr 2015 12:38:16 GMT";
head1.meta[4] = meta6;
...
Transform9.DEF = "a3on";
Transform9.translation = new SFVec3f(new float[0.0862359,0.114095,-0.299906]);
...
TextureCoordinate15.point = new MFVec2f(new float[0.374974,0,0.467277,0,0.467277,1,0.374974,1]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[-0.125026,-0.5,0,-0.0327225,-0.5,0,-0.0327227,0.5,0,-0.125026,0.5,0]);

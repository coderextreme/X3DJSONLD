...
meta6.name = "modified";
meta6.content = "Sat, 14 Nov 2015 11:32:07 GMT";
head1.meta[4] = meta6;
...
ImageTexture19.url = new MFString(new java.lang.String["menu-cam.png"]);
...
Color21.color = new MFColor(new float[0,0.985749,1]);

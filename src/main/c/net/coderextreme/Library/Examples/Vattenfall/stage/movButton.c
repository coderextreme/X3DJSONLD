...
Transform9.DEF = "btn-film";
Transform9.translation = new SFVec3f(new float[0.208545,0.113851,-0.299736]);
Transform9.scale = new SFVec3f(new float[0.0820083,0.020502,0.0320341]);
...
ImageTexture12.url = new MFString(new java.lang.String["btn-film.png"]);
...
IndexedFaceSet13.coordIndex = new MFInt32(new int[0,2,3,1,-1]);
TextureCoordinate TextureCoordinate14 = createNode("TextureCoordinate");
TextureCoordinate14.point = new MFVec2f(new float[0.0000980757,0.0145581,0,1,0.38331,0.0145581,0.606851,1]);
IndexedFaceSet13.texCoord = TextureCoordinate14;

Coordinate Coordinate15 = createNode("Coordinate");
Coordinate15.point = new MFVec3f(new float[-0.5,-0.5,0,-0.5,0.5,0,-0.116788,-0.5,0,0.106851,0.5,0]);

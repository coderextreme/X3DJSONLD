...
TextureCoordinate15.point = new MFVec2f(new float[0.467277,0,0.623897,0,0.623897,1,0.467277,1]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[-0.0327225,-0.5,0,0.123897,-0.5,0,0.123897,0.5,0,-0.0327227,0.5,0]);

...
TextureCoordinate15.point = new MFVec2f(new float[1,0.73711,1,0.887401,0,0.887401,0,0.73711]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[0.5,0.23711,0,0.5,0.387401,0,-0.5,0.387401,0,-0.5,0.23711,0]);

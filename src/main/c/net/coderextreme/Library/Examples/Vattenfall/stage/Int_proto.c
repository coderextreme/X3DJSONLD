...
<ProtoDeclare name="Int" ><ProtoInterface><field name="value" accessType="inputOutput" type="SFInt32"></field>
...
<Script DEF="_int" directOutput="true"><field name="set_startTime" accessType="inputOnly" type="SFTime"></field>
...
<ROUTE fromNode="Data" fromField="startTime_changed" toNode="_int" toField="set_startTime"></ROUTE>
</ProtoBody>
</ProtoDeclare>`);
...
connect29.nodeField = "i";
connect29.protoField = "int";

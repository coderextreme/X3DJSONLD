...
TextureCoordinate15.point = new MFVec2f(new float[1,0.4437,1,0.590405,0,0.590405,0,0.4437]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[0.5,-0.0562996,0,0.5,0.0904053,0,-0.5,0.0904054,0,-0.5,-0.0562996,0]);

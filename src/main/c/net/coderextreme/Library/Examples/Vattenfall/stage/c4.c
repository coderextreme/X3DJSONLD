...
meta3.name = "created";
meta3.content = "Sat, 25 Apr 2015 12:38:19 GMT";
head1.meta[1] = meta3;
...
meta6.name = "modified";
meta6.content = "Sat, 25 Apr 2015 12:38:19 GMT";
head1.meta[4] = meta6;
...
Transform9.DEF = "c4on";
Transform9.translation = new SFVec3f(new float[0.0862364,0.114095,-0.299906]);
Transform9.scale = new SFVec3f(new float[0.163145,0.0203932,0.0318644]);
...
ImageTexture12.url = new MFString(new java.lang.String["menu-cam.png"]);
...
IndexedFaceSet13.coordIndex = new MFInt32(new int[3,0,1,2,-1]);
...
TextureCoordinate15.point = new MFVec2f(new float[1,0,1,1,0.902474,1,0.902474,0]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[0.5,-0.5,0,0.5,0.5,0,0.402474,0.5,0,0.402474,-0.5,0]);

...
TextureCoordinate15.point = new MFVec2f(new float[1,0.590405,1,0.73711,0,0.73711,0,0.590405]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[0.5,0.0904053,0,0.5,0.23711,0,-0.5,0.23711,0,-0.5,0.0904054,0]);

...
TextureCoordinate15.point = new MFVec2f(new float[0.623897,0,0.718658,0,0.718658,1,0.623897,1]);
IndexedFaceSet13.texCoord = TextureCoordinate15;

Coordinate Coordinate16 = createNode("Coordinate");
Coordinate16.point = new MFVec3f(new float[0.123897,-0.5,0,0.218658,-0.5,0,0.218658,0.5,0,0.123897,0.5,0]);

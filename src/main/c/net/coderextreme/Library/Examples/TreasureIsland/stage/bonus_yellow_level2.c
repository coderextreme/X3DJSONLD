...
TimeSensor16.startTime = 952972804.863;
...
IndexedFaceSet21.colorIndex = new MFInt32(new int[0,1,2,2,1,0,3,4,5,5,4,6]);
...
Color22.color = new MFColor(new float[1,0.544676,0,1,0.347574,0,0.8,0.462602,0,1,0.719854,0,1,0.691608,0,1,0.456295,0,1,0.780794,0]);
IndexedFaceSet21.color = Color22;

Coordinate Coordinate23 = createNode("Coordinate");
Coordinate23.point = new MFVec3f(new float[-0.2,0.0965052,-0.1,-0.3,0.0965052,0,-0.2,0.205105,0,-0.2,0.0965052,0.1,0.2,0.205105,0,0.2,0.0965052,-0.1,0.2,0.0965052,0.1,0.3,0.0965052,0,0,-0.302545,0]);
...
ImageTexture30.url = new MFString(new java.lang.String["bp-glow.png"]);
...
IndexedFaceSet31.texCoordIndex = new MFInt32(new int[1,2,0,-1,2,3,0,-1]);

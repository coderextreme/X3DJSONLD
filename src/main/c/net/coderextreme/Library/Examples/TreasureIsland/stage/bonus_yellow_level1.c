...
WorldInfo9.info = new MFString(new java.lang.String[", ","Packaged by CosmoPackagePackaged by CosmoPackage"]);
...
ImageTexture17.url = new MFString(new java.lang.String["bp-glow.png"]);

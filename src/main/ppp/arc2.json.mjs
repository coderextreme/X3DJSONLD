...
if (typeof X3DJSON['Scene../data/arc2.json'] === 'undefined') {
	X3DJSON['Scene../data/arc2.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/arc2.json'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/arc2.json'] = {};
}

X3DJSON['Script']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json'] = {};
}

X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1'] = new X3DJSON['Script']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']['ACTION'],X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1'] = function() {
	this.set_translation = function (value) {
		try {
			this.proxy.translation = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1'] = new X3DJSON['Script']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']['ACTION'],X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/arc2.json']['DECLx3dconnector_connector1_S1'] = function() {
	...
	this.transC1_changed = function () {
		var value = this.transC1;
		return value;
	};
	try {
	...
	this.rotscaleC1_changed = function () {
		var value = this.rotscaleC1;
		return value;
	};
	try {
...
;
	...
	this.recompute_and_route = function (startpoint, endpoint) {
	      ...
	      X3DJSON.nodeUtil("Scene","X3DJSON.nodeUtil("Scene","transC1", "")", "translation",  trafo.translation);
	      X3DJSON.nodeUtil("Scene","X3DJSON.nodeUtil("Scene","rotscaleC1", "")", "rotation",  trafo.rotation);
	      X3DJSON.nodeUtil("Scene","X3DJSON.nodeUtil("Scene","rotscaleC1", "")", "scale",  trafo.scale);
	}
       ;
...
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLx3dconnector_connector1_S1'] = new X3DJSON['Script']['Scene']['../data/arc2.json']['DECLx3dconnector_connector1_S1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLx3dconnector_connector1_S1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLx3dconnector_connector1_S1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLx3dconnector_connector1_S1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLx3dconnector_connector1_S1']['ACTION'] = {};
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']['ACTION']['keyValue'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']['ACTION']['keyValue'] = [];
}
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']['ACTION']['keyValue'].push(function(property, value) {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']['ACTION']['translation'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']['ACTION']['translation'] = [];
}
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE_MB1']['ACTION']['translation'].push(function(property, value) {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']['ACTION']['keyValue'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']['ACTION']['keyValue'] = [];
}
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']['ACTION']['keyValue'].push(function(property, value) {
		if (property === 'keyValue') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']['ACTION']['translation'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']['ACTION']['translation'] = [];
}
X3DJSON['Obj']['Scene']['../data/arc2.json']['DECLpoint_INSTANCE1000_MB1']['ACTION']['translation'].push(function(property, value) {
		if (property === 'translation') {

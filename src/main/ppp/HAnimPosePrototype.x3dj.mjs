...
if (typeof X3DJSON['Scene../data/HAnimPosePrototype.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/HAnimPosePrototype.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/HAnimPosePrototype.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/HAnimPosePrototype.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations'] = function() {
	...
	this.set_setPose = function (value) {
		try {
			this.proxy.setPose = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting setPose '+e);
			console.error('Problems setting setPose',e);
		}
	};
	this.setPose_changed = function () {
		var value = this.setPose;
		return value;
	};
	try {
		this.setPose = new SFBool();
	} catch (e) {
		console.log('Problems setting setPose '+e);
		console.error('Problems setting setPose',e);
	}
	...
	this.set_namesPoseJoints = function (value) {
		try {
			this.proxy.namesPoseJoints = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting namesPoseJoints '+e);
			console.error('Problems setting namesPoseJoints',e);
		}
	};
	this.namesPoseJoints_changed = function () {
		var value = this.namesPoseJoints;
		return value;
	};
	try {
		this.namesPoseJoints = new MFString();
	} catch (e) {
		console.log('Problems setting namesPoseJoints '+e);
		console.error('Problems setting namesPoseJoints',e);
	}
	this.set_positionsPoseJoints = function (value) {
		try {
			this.proxy.positionsPoseJoints = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting positionsPoseJoints '+e);
			console.error('Problems setting positionsPoseJoints',e);
		}
	};
	this.positionsPoseJoints_changed = function () {
		var value = this.positionsPoseJoints;
		return value;
	};
	try {
		this.positionsPoseJoints = new MFVec3f();
	} catch (e) {
		console.log('Problems setting positionsPoseJoints '+e);
		console.error('Problems setting positionsPoseJoints',e);
	}
	this.set_rotationsPoseJoints = function (value) {
		try {
			this.proxy.rotationsPoseJoints = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting rotationsPoseJoints '+e);
			console.error('Problems setting rotationsPoseJoints',e);
		}
	};
	this.rotationsPoseJoints_changed = function () {
		var value = this.rotationsPoseJoints;
		return value;
	};
	try {
		this.rotationsPoseJoints = new MFRotation();
	} catch (e) {
		console.log('Problems setting rotationsPoseJoints '+e);
		console.error('Problems setting rotationsPoseJoints',e);
	}
	...
	this.set_addChildren = function (value) {
		try {
			this.proxy.addChildren = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting addChildren '+e);
			console.error('Problems setting addChildren',e);
		}
	};
	this.addChildren_changed = function () {
		var value = this.addChildren;
		return value;
	};
	try {
	...
	this.set_removeChildren = function (value) {
		try {
			this.proxy.removeChildren = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting removeChildren '+e);
			console.error('Problems setting removeChildren',e);
		}
	};
	this.removeChildren_changed = function () {
		var value = this.removeChildren;
		return value;
	};
	try {
	...
	this.initialize = function ()
{
    ...
    // check that array sizes are identical for this.proxy.namesPoseJoints, this.proxy.positionsPoseJoints, this.proxy.rotationsPoseJoints
	...
	this.set_enabled = function (eventValue)
{
    // input eventValue received for inputOutput field this.proxy.enabled
	...
	this.setPose = function (eventValue)
{
    // input eventValue received for inputOnly field this.proxy.setPose
    this.proxy.setPose = eventValue;

    this.tracePrint ('this.proxy.setPose = ' + this.proxy.setPose);
	...
	this.set_name = function (eventValue)
{
	...
	this.set_namesPoseJoints = function (eventValue)
{
    // input eventValue received for inputOutput field this.proxy.namesPoseJoints
    this.proxy.namesPoseJoints = eventValue;
    this.tracePrint ('this.proxy.namesPoseJoints = ' + this.proxy.namesPoseJoints);

    // TODO author code (if any) goes here
};

	this.set_positionsPoseJoints = function (eventValue)
{
    // input eventValue received for inputOutput field this.proxy.positionsPoseJoints
    this.proxy.positionsPoseJoints = eventValue;
    this.tracePrint ('this.proxy.positionsPoseJoints = ' + this.proxy.positionsPoseJoints);

    // TODO author code (if any) goes here
};

	this.set_rotationsPoseJoints = function (eventValue)
{
    // input eventValue received for inputOutput field this.proxy.rotationsPoseJoints
    this.proxy.rotationsPoseJoints = eventValue;
    this.tracePrint ('this.proxy.rotationsPoseJoints = ' + this.proxy.rotationsPoseJoints);

    // TODO author code (if any) goes here
};

	this.set_humanoid = function (eventValue)
{
    // input eventValue received for inputOutput field humanoid
    humanoid = eventValue;
    this.tracePrint ('humanoid = ' + humanoid);
	...
	this.tracePrint = function (outputString)
{
   ...
   if (this.proxy.traceEnabled)
      console.error ('[' + scriptName.toString()' ' + this.proxy.name.toString()': ' + outputString.toString() + ']');
};
...
if (typeof X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations'] = new X3DJSON['Script']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations']['ACTION'],X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations'].initialize === "function") X3DJSON['Obj']['Scene']['../data/HAnimPosePrototype.x3dj']['HAnimPoseScriptOperations'].initialize();

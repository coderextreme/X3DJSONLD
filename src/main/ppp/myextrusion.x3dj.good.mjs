...
if (typeof X3DJSON['Scene../data/myextrusion.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/myextrusion.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/myextrusion.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/myextrusion.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'] = new X3DJSON['Script']['Scene']['../data/myextrusion.x3dj']['MoveCylinder']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder']['ACTION'],X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].initialize === "function") X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].initialize();
    if (X3DJSON.nodeUtil("Scene","TourTime")) {
X3DJSON.nodeUtil("Scene","TourTime").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].set_cycle(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].set_cycle(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder']['ACTION']['spine'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder']['ACTION']['spine'] = [];
}
X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder']['ACTION']['spine'].push(function(property, value) {
		if (property === 'spine') {
			X3DJSON.nodeUtil("Scene","myextrusion","spine",typeof X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].spine_changed === "function" ? X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].spine_changed() : X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].spine, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","myextrusion","spine",typeof X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].spine_changed === "function" ? X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].spine_changed() : X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].spine, __eventTime);
			X3DJSON['Obj']['Scene']['../data/myextrusion.x3dj']['MoveCylinder'].set_cycle(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);

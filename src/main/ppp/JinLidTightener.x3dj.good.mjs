...
if (typeof X3DJSON['Scene../data/JinLidTightener.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinLidTightener.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidTightener").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLidTightener_Clock")) {
X3DJSON.nodeUtil("Scene","JinLidTightener_Clock").addEventListener('outputchange', function(event) {
}, false);
}

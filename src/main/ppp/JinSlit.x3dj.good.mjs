...
if (typeof X3DJSON['Scene../data/JinSlit.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinSlit.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSlit").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinSlit_Clock")) {
X3DJSON.nodeUtil("Scene","JinSlit_Clock").addEventListener('outputchange', function(event) {
}, false);
}

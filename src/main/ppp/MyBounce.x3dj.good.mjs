...
if (typeof X3DJSON['Scene../data/MyBounce.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/MyBounce.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/MyBounce.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/MyBounce.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/MyBounce.x3dj']['Bounce2'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'] = new X3DJSON['Script']['Scene']['../data/MyBounce.x3dj']['Bounce2']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2']['ACTION'],X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].initialize === "function") X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].initialize();
    if (X3DJSON.nodeUtil("Scene","TourTime")) {
X3DJSON.nodeUtil("Scene","TourTime").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2']['ACTION']['translation'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2']['ACTION']['translation'] = [];
}
X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2']['ACTION']['translation'].push(function(property, value) {
		if (property === 'translation') {
			X3DJSON.nodeUtil("Scene","transform","translation",typeof X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].translation_changed() : X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].translation, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","transform","translation",typeof X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].translation_changed() : X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].translation, __eventTime);
			X3DJSON['Obj']['Scene']['../data/MyBounce.x3dj']['Bounce2'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);

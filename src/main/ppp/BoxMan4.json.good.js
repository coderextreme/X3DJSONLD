...
if (typeof X3DJSON['Scene../data/BoxMan4.json'] === 'undefined') {
	X3DJSON['Scene../data/BoxMan4.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/BoxMan4.json'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/BoxMan4.json'] = {};
}

X3DJSON['Script']['Scene']['../data/BoxMan4.json']['ENGINE'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/BoxMan4.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/BoxMan4.json'] = {};
}

X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE'] = new X3DJSON['Script']['Scene']['../data/BoxMan4.json']['ENGINE']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE']['ACTION'],X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE'].initialize === "function") X3DJSON['Obj']['Scene']['../data/BoxMan4.json']['ENGINE'].initialize();

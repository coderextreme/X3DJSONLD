...
if (typeof X3DJSON['Scene../data/JinLidDroop.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinLidDroop.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidDroop").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLidDroop_Clock")) {
X3DJSON.nodeUtil("Scene","JinLidDroop_Clock").addEventListener('outputchange', function(event) {
}, false);
}

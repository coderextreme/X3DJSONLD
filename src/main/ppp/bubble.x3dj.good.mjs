...
if (typeof X3DJSON['Scene../data/bubble.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/bubble.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/bubble.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/bubble.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/bubble.x3dj']['bounce'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubble.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'] = new X3DJSON['Script']['Scene']['../data/bubble.x3dj']['bounce']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']['ACTION'],X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].initialize === "function") X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].initialize();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']['ACTION']['translation'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']['ACTION']['translation'] = [];
}
X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']['ACTION']['translation'].push(function(property, value) {
		if (property === 'translation') {
			X3DJSON.nodeUtil("Scene","transform","translation",typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].translation, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","transform","translation",typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].translation, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']['ACTION']['scale'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']['ACTION']['scale'] = [];
}
X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce']['ACTION']['scale'].push(function(property, value) {
		if (property === 'scale') {
			X3DJSON.nodeUtil("Scene","transform","scale",typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].scale_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].scale_changed() : X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].scale, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","transform","scale",typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].scale_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].scale_changed() : X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].scale, __eventTime);
    if (X3DJSON.nodeUtil("Scene","bubbleClock")) {
X3DJSON.nodeUtil("Scene","bubbleClock").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].set_fraction(X3DJSON.nodeUtil("Scene","bubbleClock","fraction"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].set_fraction(X3DJSON.nodeUtil("Scene","bubbleClock","fraction"), __eventTime);
			X3DJSON.nodeUtil("Scene","transform","translation",typeof X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bubble.x3dj']['bounce'].translation, __eventTime);

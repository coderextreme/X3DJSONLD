...
if (typeof X3DJSON['Scene../data/browser.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/browser.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/browser.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/browser.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/browser.x3dj']['Browser'] = function() {
ecmascript:
...
if (typeof X3DJSON['Obj']['Scene']['../data/browser.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/browser.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser'] = new X3DJSON['Script']['Scene']['../data/browser.x3dj']['Browser']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser']['ACTION'],X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser'].initialize === "function") X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Browser'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/browser.x3dj']['Clouds'] = function() {
...
X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds'] = new X3DJSON['Script']['Scene']['../data/browser.x3dj']['Clouds']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds']['ACTION'],X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds'].initialize === "function") X3DJSON['Obj']['Scene']['../data/browser.x3dj']['Clouds'].initialize();

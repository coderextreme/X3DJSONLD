...
if (typeof X3DJSON['Scene../data/MultiFacialAnimationMenu.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/MultiFacialAnimationMenu.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/MultiFacialAnimationMenu.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/MultiFacialAnimationMenu.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'] = function() {
	...
	this.set_adapters = function (value) {
		try {
			this.proxy.adapters = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting adapters '+e);
			console.error('Problems setting adapters',e);
		}
	};
	this.adapters_changed = function () {
		var value = this.adapters;
		return value;
	};
	try {
		this.adapters = new MFNode();
	} catch (e) {
		console.log('Problems setting adapters '+e);
		console.error('Problems setting adapters',e);
	}
ecmascript:
	...
	this.inTime = function (value) {
            ...
            var num_adapters = this.proxy.adapters.length;
            console.error("in", this.proxy.checked, num_adapters, this.proxy.diffuseColor.g, this.proxy.diffuseColor.b);
            for (var adapter = 0; adapter < num_adapters; adapter++) {
                console.error("adapter", adapter, this.proxy.adapters[adapter].metadata)
            }
            if (this.proxy.checked) {
                for (var adapter = 0; adapter < num_adapters; adapter++) {
                    Browser.addRoute(scene.getNamedNode("Main_Clock"), 'fraction_changed', this.proxy.adapters[adapter], 'set_fraction');
                    this.proxy.adapters[adapter].set_fraction = 0;
                }
                this.proxy.diffuseColor.g = 1;
                this.proxy.diffuseColor.b = 0;
            } else {
                for (var adapter = 0; adapter < num_adapters; adapter++) {
                    Browser.deleteRoute(scene.getNamedNode("Main_Clock"), 'fraction_changed', this.proxy.adapters[adapter], 'set_fraction');
                    this.proxy.adapters[adapter].set_fraction = 0;
                }
...
if (typeof X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'] = new X3DJSON['Script']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION'],X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].initialize === "function") X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].initialize();
...
X3DJSON.nodeUtil("Scene","StartStopAnimationUnit_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].inTime(X3DJSON.nodeUtil("Scene","StartStopAnimationUnit_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].inTime(X3DJSON.nodeUtil("Scene","StartStopAnimationUnit_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","MenuBackground_Material")) {
X3DJSON.nodeUtil("Scene","MenuBackground_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].set_diffuseColor(X3DJSON.nodeUtil("Scene","MenuBackground_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].set_diffuseColor(X3DJSON.nodeUtil("Scene","MenuBackground_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","MenuBackground_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","MenuBackground_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/MultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor, __eventTime);
    if (X3DJSON.nodeUtil("Scene","StartStopAnimationUnit_Sensor")) {

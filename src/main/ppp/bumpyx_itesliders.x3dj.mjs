...
if (typeof X3DJSON['Scene../data/bumpyx_itesliders.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/bumpyx_itesliders.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/bumpyx_itesliders.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/bumpyx_itesliders.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'] = function() {
	this.set_protoScale = function (value) {
		try {
			this.proxy.protoScale = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting protoScale '+e);
			console.error('Problems setting protoScale',e);
		}
	};
	this.protoScale_changed = function () {
		var value = this.protoScale;
		return value;
	};
	try {
		this.protoScale = new SFFloat();
	} catch (e) {
		console.log('Problems setting protoScale '+e);
		console.error('Problems setting protoScale',e);
	}
	this.set_petNames = function (value) {
		try {
			this.proxy.petNames = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting petNames '+e);
			console.error('Problems setting petNames',e);
		}
	};
	this.petNames_changed = function () {
		var value = this.petNames;
		return value;
	};
	try {
		this.petNames = new MFString();
	} catch (e) {
		console.log('Problems setting petNames '+e);
		console.error('Problems setting petNames',e);
	}
	this.set_protoParameterName = function (value) {
		try {
			this.proxy.protoParameterName = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting protoParameterName '+e);
			console.error('Problems setting protoParameterName',e);
		}
	};
	this.protoParameterName_changed = function () {
		var value = this.protoParameterName;
		return value;
	};
	try {
		this.protoParameterName = new SFString();
	} catch (e) {
		console.log('Problems setting protoParameterName '+e);
		console.error('Problems setting protoParameterName',e);
	}
	this.set_shader = function (value) {
		try {
			this.proxy.shader = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting shader '+e);
			console.error('Problems setting shader',e);
		}
	};
	this.shader_changed = function () {
		var value = this.shader;
		return value;
	};
	try {
		this.shader = new SFNode();
	} catch (e) {
		console.log('Problems setting shader '+e);
		console.error('Problems setting shader',e);
	}
	...
	try {
		this.newTranslation = new SFVec3f();
	} catch (e) {
		console.log('Problems setting newTranslation '+e);
		console.error('Problems setting newTranslation',e);
	}
	this.set_protoValue = function (value) {
		try {
			this.proxy.protoValue = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting protoValue '+e);
			console.error('Problems setting protoValue',e);
		}
	};
	this.protoValue_changed = function () {
		var value = this.protoValue;
		return value;
	};
	try {
		this.protoValue = undefined;
	} catch (e) {
		console.log('Problems setting protoValue '+e);
		console.error('Problems setting protoValue',e);
	}
	this.set_protoText = function (value) {
		try {
			this.proxy.protoText = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting protoText '+e);
			console.error('Problems setting protoText',e);
		}
	};
	this.protoText_changed = function () {
		var value = this.protoText;
		return value;
	};
	try {
		this.protoText = undefined;
	} catch (e) {
		console.log('Problems setting protoText '+e);
		console.error('Problems setting protoText',e);
	}
...
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'] = new X3DJSON['Script']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'] = function() {
...
ecmascript:
	this.initialize = function () {
     ...
     for ( i = 0; i < resolution; i++) {
		...
		var rho = this.proxy.a + this.proxy.b * Math.cos(this.proxy.c * theta + this.proxy.tdelta) * Math.cos(this.proxy.d * phi + this.proxy.pdelta);
...
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'] = new X3DJSON['Script']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript'] = function() {
};
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
...
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript'] = new X3DJSON['Script']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['HumanoidScript'].initialize();
    if (X3DJSON.nodeUtil("Scene","protoSensor")) {
X3DJSON.nodeUtil("Scene","protoSensor").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","protoSensor")) {
X3DJSON.nodeUtil("Scene","protoSensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].newTranslation(X3DJSON.nodeUtil("Scene","protoSensor","translation"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].newTranslation(X3DJSON.nodeUtil("Scene","protoSensor","translation"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript']['ACTION']['protoText'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript']['ACTION']['protoText'] = [];
}
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript']['ACTION']['protoText'].push(function(property, value) {
		if (property === 'protoText') {
			X3DJSON.nodeUtil("Scene","protoText","string",typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].protoText_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].protoText_changed() : X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].protoText, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","protoText","string",typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].protoText_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].protoText_changed() : X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].protoText, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']['ACTION']['coordIndexes'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']['ACTION']['coordIndexes'] = [];
}
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']['ACTION']['coordIndexes'].push(function(property, value) {
		if (property === 'coordIndexes') {
			X3DJSON.nodeUtil("Scene","Orbit","coordIndex",typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordIndexes === "function" ? X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordIndexes() : X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordIndexes, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","Orbit","coordIndex",typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordIndexes === "function" ? X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordIndexes() : X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordIndexes, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']['ACTION']['coordinates'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']['ACTION']['coordinates'] = [];
}
X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript']['ACTION']['coordinates'].push(function(property, value) {
		if (property === 'coordinates') {
			X3DJSON.nodeUtil("Scene","OrbitCoordinates","point",typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordinates_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordinates_changed() : X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordinates, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","OrbitCoordinates","point",typeof X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordinates_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordinates_changed() : X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['OrbitScript'].coordinates, __eventTime);
			X3DJSON['Obj']['Scene']['../data/bumpyx_itesliders.x3dj']['protoValueTransformerScript'].newTranslation(X3DJSON.nodeUtil("Scene","protoSensor","translation"), __eventTime);

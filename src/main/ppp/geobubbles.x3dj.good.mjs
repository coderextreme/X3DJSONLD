...
if (typeof X3DJSON['Scene../data/geobubbles.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/geobubbles.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/geobubbles.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/geobubbles.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'] = new X3DJSON['Script']['Scene']['../data/geobubbles.x3dj']['RandomTourTime']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime']['ACTION'],X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].initialize === "function") X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].initialize();
    if (X3DJSON.nodeUtil("Scene","TourTime")) {
X3DJSON.nodeUtil("Scene","TourTime").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].set_cycle(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].set_cycle(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime']['ACTION']['position'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime']['ACTION']['position'] = [];
}
X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime']['ACTION']['position'].push(function(property, value) {
		if (property === 'position') {
			X3DJSON.nodeUtil("Scene","TourPosition","keyValue",typeof X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].position_changed === "function" ? X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].position_changed() : X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].position, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","TourPosition","keyValue",typeof X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].position_changed === "function" ? X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].position_changed() : X3DJSON['Obj']['Scene']['../data/geobubbles.x3dj']['RandomTourTime'].position, __eventTime);
    if (X3DJSON.nodeUtil("Scene","TourTime")) {

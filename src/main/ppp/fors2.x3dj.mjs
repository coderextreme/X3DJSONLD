...
if (typeof X3DJSON['Scene../data/fors2.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/fors2.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/fors2.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/fors2.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/fors2.x3dj']['MoveBall'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fors2.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'] = new X3DJSON['Script']['Scene']['../data/fors2.x3dj']['MoveBall']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall']['ACTION'],X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].initialize === "function") X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/fors2.x3dj']['MoveCylinder'] = function() {
...
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'] = new X3DJSON['Script']['Scene']['../data/fors2.x3dj']['MoveCylinder']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder']['ACTION'],X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'].initialize === "function") X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'].initialize();
    if (X3DJSON.nodeUtil("Scene","nodeClock")) {
X3DJSON.nodeUtil("Scene","nodeClock").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].set_cycle(X3DJSON.nodeUtil("Scene","nodeClock","cycleTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].set_cycle(X3DJSON.nodeUtil("Scene","nodeClock","cycleTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","nodeClock")) {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall']['ACTION']['keyValue'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall']['ACTION']['keyValue'] = [];
}
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall']['ACTION']['keyValue'].push(function(property, value) {
		if (property === 'keyValue') {
			X3DJSON.nodeUtil("Scene","NodePosition","keyValue",typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].keyValue === "function" ? X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].keyValue() : X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].keyValue, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","NodePosition","keyValue",typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].keyValue === "function" ? X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].keyValue() : X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveBall'].keyValue, __eventTime);
...
if (typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder']['ACTION']['spine'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder']['ACTION']['spine'] = [];
}
X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder']['ACTION']['spine'].push(function(property, value) {
		if (property === 'spine') {
			X3DJSON.nodeUtil("Scene","extrusion","spine",typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'].spine_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'].spine_changed() : X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'].spine, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","extrusion","spine",typeof X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'].spine_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'].spine_changed() : X3DJSON['Obj']['Scene']['../data/fors2.x3dj']['MoveCylinder'].spine, __eventTime);

...
if (typeof X3DJSON['Scene../data/Menu.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/Menu.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/Menu.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/Menu.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/Menu.x3dj']['MenuScript'] = function() {
	this.set_menuItems = function (value) {
		try {
			this.proxy.menuItems = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting menuItems '+e);
			console.error('Problems setting menuItems',e);
		}
	};
	this.menuItems_changed = function () {
		var value = this.menuItems;
		return value;
	};
	try {
		this.menuItems = new MFString();
	} catch (e) {
		console.log('Problems setting menuItems '+e);
		console.error('Problems setting menuItems',e);
	}
	...
	this.set_touchPoint = function (value) {
		try {
			this.proxy.touchPoint = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting touchPoint '+e);
			console.error('Problems setting touchPoint',e);
		}
	};
	this.touchPoint_changed = function () {
		var value = this.touchPoint;
		return value;
	};
	try {
		this.touchPoint = new SFVec3f();
	} catch (e) {
		console.log('Problems setting touchPoint '+e);
		console.error('Problems setting touchPoint',e);
	}
	this.set_spacing = function (value) {
		try {
			this.proxy.spacing = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting spacing '+e);
			console.error('Problems setting spacing',e);
		}
	};
	this.spacing_changed = function () {
		var value = this.spacing;
		return value;
	};
	try {
		this.spacing = new SFFloat(1.2);
	} catch (e) {
		console.log('Problems setting spacing '+e);
		console.error('Problems setting spacing',e);
	}
	...
	try {
		this.size = new SFFloat(2.4);
	} catch (e) {
		console.log('Problems setting size '+e);
		console.error('Problems setting size',e);
	}
	this.set_menuCenterY = function (value) {
		try {
			this.proxy.menuCenterY = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting menuCenterY '+e);
			console.error('Problems setting menuCenterY',e);
		}
	};
	this.menuCenterY_changed = function () {
		var value = this.menuCenterY;
		return value;
	};
	try {
		this.menuCenterY = new SFFloat();
	} catch (e) {
		console.log('Problems setting menuCenterY '+e);
		console.error('Problems setting menuCenterY',e);
	}
	this.set_itemHeight = function (value) {
		try {
			this.proxy.itemHeight = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting itemHeight '+e);
			console.error('Problems setting itemHeight',e);
		}
	};
	this.itemHeight_changed = function () {
		var value = this.itemHeight;
		return value;
	};
	try {
		this.itemHeight = new SFFloat();
	} catch (e) {
		console.log('Problems setting itemHeight '+e);
		console.error('Problems setting itemHeight',e);
	}
ecmascript:
	...
	this.initialize = function () {
          ...
          var spacingBetweenGlyphs = this.proxy.size * this.proxy.spacing - this.proxy.size; // Spacing calculation
          var menuHeight = (this.proxy.size + spacingBetweenGlyphs) * this.proxy.menuItems.length;
          this.proxy.menuCenterY = menuHeight / 2;
          this.proxy.itemHeight = menuHeight / this.proxy.menuItems.length;
        }

       ;

	this.touchPoint = function (value) {
          console.error("Hit "+value+" "+this.proxy.selection+"\n");
          var index = Math.floor((this.proxy.menuCenterY - value.y) / this.proxy.itemHeight - 0.5);

          this.proxy.selection = index - 2;
          if (this.proxy.selection >= 0 && this.proxy.selection < this.proxy.menuItems.length) {
            console.error("Selected "+value+" "+this.proxy.selection+" "+this.proxy.menuItems[this.proxy.selection]+"\n");
          }
        }
      ;
...
if (typeof X3DJSON['Obj']['Scene']['../data/Menu.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Menu.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'] = new X3DJSON['Script']['Scene']['../data/Menu.x3dj']['MenuScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].initialize();
    if (X3DJSON.nodeUtil("Scene","MenuTouchSensor")) {
X3DJSON.nodeUtil("Scene","MenuTouchSensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].touchPoint(X3DJSON.nodeUtil("Scene","MenuTouchSensor","hitPoint"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].touchPoint(X3DJSON.nodeUtil("Scene","MenuTouchSensor","hitPoint"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript']['ACTION']['selection'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript']['ACTION']['selection'] = [];
}
X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript']['ACTION']['selection'].push(function(property, value) {
		if (property === 'selection') {
			X3DJSON.nodeUtil("Scene","SceneSwitcher","whichChoice",typeof X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].selection === "function" ? X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].selection() : X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].selection, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","SceneSwitcher","whichChoice",typeof X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].selection === "function" ? X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].selection() : X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].selection, __eventTime);
			X3DJSON['Obj']['Scene']['../data/Menu.x3dj']['MenuScript'].touchPoint(X3DJSON.nodeUtil("Scene","MenuTouchSensor","hitPoint"), __eventTime);

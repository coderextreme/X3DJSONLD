...
if (typeof X3DJSON['Scene../data/JinLipStretcher.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinLipStretcher.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipStretcher").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipStretcher_Clock")) {
X3DJSON.nodeUtil("Scene","JinLipStretcher_Clock").addEventListener('outputchange', function(event) {
}, false);
}

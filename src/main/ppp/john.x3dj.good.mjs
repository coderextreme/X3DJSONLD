...
if (typeof X3DJSON['Scene../data/john.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/john.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/john.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/john.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/john.x3dj']['UrlSelector'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'] = new X3DJSON['Script']['Scene']['../data/john.x3dj']['UrlSelector']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION'],X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].initialize === "function") X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].initialize();
    if (X3DJSON.nodeUtil("Scene","Clock")) {
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].set_fraction(X3DJSON.nodeUtil("Scene","Clock","fraction"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].set_fraction(X3DJSON.nodeUtil("Scene","Clock","fraction"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['front'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['front'] = [];
}
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['front'].push(function(property, value) {
		if (property === 'front') {
			X3DJSON.nodeUtil("Scene","background","frontUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","frontUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['back'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['back'] = [];
}
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['back'].push(function(property, value) {
		if (property === 'back') {
			X3DJSON.nodeUtil("Scene","background","backUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","backUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['left'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['left'] = [];
}
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['left'].push(function(property, value) {
		if (property === 'left') {
			X3DJSON.nodeUtil("Scene","background","leftUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","leftUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['right'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['right'] = [];
}
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['right'].push(function(property, value) {
		if (property === 'right') {
			X3DJSON.nodeUtil("Scene","background","rightUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","rightUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['top'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['top'] = [];
}
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['top'].push(function(property, value) {
		if (property === 'top') {
			X3DJSON.nodeUtil("Scene","background","topUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","topUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['bottom'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['bottom'] = [];
}
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['bottom'].push(function(property, value) {
		if (property === 'bottom') {
			X3DJSON.nodeUtil("Scene","background","bottomUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","background","bottomUrl",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['front'].push(function(property, value) {
		if (property === 'front') {
			X3DJSON.nodeUtil("Scene","front","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","front","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].front, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['back'].push(function(property, value) {
		if (property === 'back') {
			X3DJSON.nodeUtil("Scene","back","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","back","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].back, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['left'].push(function(property, value) {
		if (property === 'left') {
			X3DJSON.nodeUtil("Scene","left","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","left","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].left, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['right'].push(function(property, value) {
		if (property === 'right') {
			X3DJSON.nodeUtil("Scene","right","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","right","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].right, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['top'].push(function(property, value) {
		if (property === 'top') {
			X3DJSON.nodeUtil("Scene","top","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","top","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].top, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector']['ACTION']['bottom'].push(function(property, value) {
		if (property === 'bottom') {
			X3DJSON.nodeUtil("Scene","bottom","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","bottom","url",typeof X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom_changed === "function" ? X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom_changed() : X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].bottom, __eventTime);
			X3DJSON['Obj']['Scene']['../data/john.x3dj']['UrlSelector'].set_fraction(X3DJSON.nodeUtil("Scene","Clock","fraction"), __eventTime);

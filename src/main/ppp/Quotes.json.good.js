...
if (typeof X3DJSON['Scene../data/Quotes.json'] === 'undefined') {
	X3DJSON['Scene../data/Quotes.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/Quotes.json'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/Quotes.json'] = {};
}

X3DJSON['Script']['Scene']['../data/Quotes.json']['colorTypeConversionScript'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/Quotes.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Quotes.json'] = {};
}

X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'] = new X3DJSON['Script']['Scene']['../data/Quotes.json']['colorTypeConversionScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'] = function() {
...
X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'] = new X3DJSON['Script']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/Quotes.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'].initialize();
...
if (typeof X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript']['ACTION']['colorsOutput'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript']['ACTION']['colorsOutput'] = [];
}
X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript']['ACTION']['colorsOutput'].push(function(property, value) {
		if (property === 'colorsOutput') {
			X3DJSON.nodeUtil('Scene','GradualBackground','skyColor',typeof X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].colorsOutput === "function" ? X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].colorsOutput() : X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].colorsOutput, __eventTime);
		}
});
			X3DJSON.nodeUtil('Scene','GradualBackground','skyColor',typeof X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].colorsOutput === "function" ? X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].colorsOutput() : X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].colorsOutput, __eventTime);
    if (X3DJSON.nodeUtil('Scene','ColorAnimator')) {
X3DJSON.nodeUtil('Scene','ColorAnimator').addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].colorInput(X3DJSON.nodeUtil('Scene','ColorAnimator','value'), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/Quotes.json']['colorTypeConversionScript'].colorInput(X3DJSON.nodeUtil('Scene','ColorAnimator','value'), __eventTime);

...
if (typeof X3DJSON['Scene../data/jumpcut_loadurl.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/jumpcut_loadurl.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/jumpcut_loadurl.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/jumpcut_loadurl.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'] = new X3DJSON['Script']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT']['ACTION'],X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'].initialize === "function") X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'].initialize();
    if (X3DJSON.nodeUtil("Scene","STARTER")) {
X3DJSON.nodeUtil("Scene","STARTER").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'].trigger_event(X3DJSON.nodeUtil("Scene","STARTER","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'].trigger_event(X3DJSON.nodeUtil("Scene","STARTER","isActive"), __eventTime);
			X3DJSON['Obj']['Scene']['../data/jumpcut_loadurl.x3dj']['MYSCRIPT'].trigger_event(X3DJSON.nodeUtil("Scene","STARTER","isActive"), __eventTime);
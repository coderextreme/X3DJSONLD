...
if (typeof X3DJSON['Scene../data/fwparticleflowersTidy.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/fwparticleflowersTidy.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/fwparticleflowersTidy.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/fwparticleflowersTidy.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'] = new X3DJSON['Script']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION'],X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].initialize === "function") X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].initialize();
    if (X3DJSON.nodeUtil("Scene","TourTime")) {
X3DJSON.nodeUtil("Scene","TourTime").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","fraction"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","fraction"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['a'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['a'] = [];
}
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['a'].push(function(property, value) {
		if (property === 'a') {
			X3DJSON.nodeUtil("Scene","fw","a",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].a_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].a_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].a, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","fw","a",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].a_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].a_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].a, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['b'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['b'] = [];
}
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['b'].push(function(property, value) {
		if (property === 'b') {
			X3DJSON.nodeUtil("Scene","fw","b",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].b_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].b_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].b, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","fw","b",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].b_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].b_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].b, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['c'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['c'] = [];
}
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['c'].push(function(property, value) {
		if (property === 'c') {
			X3DJSON.nodeUtil("Scene","fw","c",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].c_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].c_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].c, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","fw","c",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].c_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].c_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].c, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['d'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['d'] = [];
}
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['d'].push(function(property, value) {
		if (property === 'd') {
			X3DJSON.nodeUtil("Scene","fw","d",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].d_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].d_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].d, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","fw","d",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].d_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].d_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].d, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['pdelta'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['pdelta'] = [];
}
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['pdelta'].push(function(property, value) {
		if (property === 'pdelta') {
			X3DJSON.nodeUtil("Scene","fw","pdelta",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].pdelta_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].pdelta_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].pdelta, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","fw","pdelta",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].pdelta_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].pdelta_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].pdelta, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['tdelta'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['tdelta'] = [];
}
X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate']['ACTION']['tdelta'].push(function(property, value) {
		if (property === 'tdelta') {
			X3DJSON.nodeUtil("Scene","fw","tdelta",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].tdelta_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].tdelta_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].tdelta, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","fw","tdelta",typeof X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].tdelta_changed === "function" ? X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].tdelta_changed() : X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].tdelta, __eventTime);
			X3DJSON['Obj']['Scene']['../data/fwparticleflowersTidy.x3dj']['Animate'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","fraction"), __eventTime);

...
if (typeof X3DJSON['Scene../data/JinInnerBrowRaiser.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinInnerBrowRaiser.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinInnerBrowRaiser").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Clock")) {
X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Clock").addEventListener('outputchange', function(event) {
}, false);
}

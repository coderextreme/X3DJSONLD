...
if (typeof X3DJSON['Scene../data/variationalflowers2.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/variationalflowers2.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/variationalflowers2.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/variationalflowers2.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/variationalflowers2.x3dj']['Animate'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'] = new X3DJSON['Script']['Scene']['../data/variationalflowers2.x3dj']['Animate']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate']['ACTION'],X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].initialize === "function") X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].initialize();
    if (X3DJSON.nodeUtil("Scene","TourTime")) {
X3DJSON.nodeUtil("Scene","TourTime").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","fraction"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","fraction"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate']['ACTION']['values'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate']['ACTION']['values'] = [];
}
X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate']['ACTION']['values'].push(function(property, value) {
		if (property === 'values') {
			X3DJSON.nodeUtil("Scene","x_ite","x3d_ParticleValues",typeof X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].values_changed === "function" ? X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].values_changed() : X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].values, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","x_ite","x3d_ParticleValues",typeof X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].values_changed === "function" ? X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].values_changed() : X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].values, __eventTime);
			X3DJSON['Obj']['Scene']['../data/variationalflowers2.x3dj']['Animate'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","fraction"), __eventTime);

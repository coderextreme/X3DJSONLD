...
if (typeof X3DJSON['Scene../data/arc.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/arc.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/arc.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/arc.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/arc.x3dj']['MB1'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'] = new X3DJSON['Script']['Scene']['../data/arc.x3dj']['MB1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1']['ACTION'],X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/arc.x3dj']['S1'] = function() {
...
X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1'] = new X3DJSON['Script']['Scene']['../data/arc.x3dj']['S1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1']['ACTION'],X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/arc.x3dj']['S1'].initialize();
    if (X3DJSON.nodeUtil("Scene","CL1")) {
X3DJSON.nodeUtil("Scene","CL1").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].set_location(X3DJSON.nodeUtil("Scene","CL1","cycleTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].set_location(X3DJSON.nodeUtil("Scene","CL1","cycleTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","CL1")) {
...
if (typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1']['ACTION']['keyValue'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1']['ACTION']['keyValue'] = [];
}
X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1']['ACTION']['keyValue'].push(function(property, value) {
		if (property === 'keyValue') {
			X3DJSON.nodeUtil("Scene","PI1","keyValue",typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].keyValue_changed === "function" ? X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].keyValue_changed() : X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].keyValue, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","PI1","keyValue",typeof X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].keyValue_changed === "function" ? X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].keyValue_changed() : X3DJSON['Obj']['Scene']['../data/arc.x3dj']['MB1'].keyValue, __eventTime);

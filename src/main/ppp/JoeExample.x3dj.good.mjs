...
if (typeof X3DJSON['Scene../data/JoeExample.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JoeExample.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/JoeExample.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/JoeExample.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/JoeExample.x3dj']['OpenVault'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'] = new X3DJSON['Script']['Scene']['../data/JoeExample.x3dj']['OpenVault']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault']['ACTION'],X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].initialize === "function") X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].initialize();
    if (X3DJSON.nodeUtil("Scene","TS")) {
X3DJSON.nodeUtil("Scene","TS").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].combinationEntered(X3DJSON.nodeUtil("Scene","TS","isOver"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].combinationEntered(X3DJSON.nodeUtil("Scene","TS","isOver"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","TS")) {
X3DJSON.nodeUtil("Scene","TS").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].openVault(X3DJSON.nodeUtil("Scene","TS","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].openVault(X3DJSON.nodeUtil("Scene","TS","touchTime"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault']['ACTION']['vaultUnlocked'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault']['ACTION']['vaultUnlocked'] = [];
}
X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault']['ACTION']['vaultUnlocked'].push(function(property, value) {
		if (property === 'vaultUnlocked') {
			X3DJSON.nodeUtil("Scene","Click","startTime",typeof X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].vaultUnlocked === "function" ? X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].vaultUnlocked() : X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].vaultUnlocked, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","Click","startTime",typeof X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].vaultUnlocked === "function" ? X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].vaultUnlocked() : X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].vaultUnlocked, __eventTime);
			X3DJSON['Obj']['Scene']['../data/JoeExample.x3dj']['OpenVault'].combinationEntered(X3DJSON.nodeUtil("Scene","TS","isOver"), __eventTime);

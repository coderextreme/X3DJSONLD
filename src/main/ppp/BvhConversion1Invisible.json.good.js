...
if (typeof X3DJSON['Scene../data/BvhConversion1Invisible.json'] === 'undefined') {
	X3DJSON['Scene../data/BvhConversion1Invisible.json'] = {};
}
...
X3DJSON.nodeUtil('Scene','FrameStepper').addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil('Scene','Interpolator0_HumanoidRoot')) {
X3DJSON.nodeUtil('Scene','Interpolator0_HumanoidRoot').addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil('Scene','RealTimer')) {
X3DJSON.nodeUtil('Scene','RealTimer').addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil('Scene','FrameStepper').addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil('Scene','Interpolator1_HumanoidRoot')) {
X3DJSON.nodeUtil('Scene','Interpolator1_HumanoidRoot').addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil('Scene','RealTimer')) {
X3DJSON.nodeUtil('Scene','RealTimer').addEventListener('outputchange', function(event) {

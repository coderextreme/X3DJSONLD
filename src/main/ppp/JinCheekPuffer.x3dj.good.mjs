...
if (typeof X3DJSON['Scene../data/JinCheekPuffer.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinCheekPuffer.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekPuffer").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinCheekPuffer_Clock")) {
X3DJSON.nodeUtil("Scene","JinCheekPuffer_Clock").addEventListener('outputchange', function(event) {
}, false);
}

...
if (typeof X3DJSON['Scene../data/AllenStandShootRifleM24.json'] === 'undefined') {
	X3DJSON['Scene../data/AllenStandShootRifleM24.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/AllenStandShootRifleM24.json'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/AllenStandShootRifleM24.json'] = {};
}

X3DJSON['Script']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json'] = {};
}

X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'] = new X3DJSON['Script']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].initialize();
...
X3DJSON.nodeUtil('Scene','FireTouchSensor').addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].enabled(X3DJSON.nodeUtil('Scene','FireTouchSensor','isOver'), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].enabled(X3DJSON.nodeUtil('Scene','FireTouchSensor','isOver'), __eventTime);
    if (X3DJSON.nodeUtil('Scene','FireTouchSensor')) {
...
if (typeof X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript']['ACTION']['fire'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript']['ACTION']['fire'] = [];
}
X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript']['ACTION']['fire'].push(function(property, value) {
		if (property === 'fire') {
			X3DJSON.nodeUtil('Scene','DECLRifleM24_rifleM24','trigger',typeof X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].fire === "function" ? X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].fire() : X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].fire, __eventTime);
		}
});
			X3DJSON.nodeUtil('Scene','DECLRifleM24_rifleM24','trigger',typeof X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].fire === "function" ? X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].fire() : X3DJSON['Obj']['Scene']['../data/AllenStandShootRifleM24.json']['FireScript'].fire, __eventTime);

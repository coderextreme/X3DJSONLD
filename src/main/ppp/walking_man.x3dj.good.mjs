...
if (typeof X3DJSON['Scene../data/walking_man.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/walking_man.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","LHipAnimator")) {
X3DJSON.nodeUtil("Scene","LHipAnimator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Clock")) {
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","RHipAnimator")) {
X3DJSON.nodeUtil("Scene","RHipAnimator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Clock")) {
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","KneeAnimator")) {
X3DJSON.nodeUtil("Scene","KneeAnimator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","KneeAnimator")) {
X3DJSON.nodeUtil("Scene","KneeAnimator").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","LShoulderAnimator")) {
X3DJSON.nodeUtil("Scene","LShoulderAnimator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Clock")) {
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","RShoulderAnimator")) {
X3DJSON.nodeUtil("Scene","RShoulderAnimator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Clock")) {
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","ElbowAnimator")) {
X3DJSON.nodeUtil("Scene","ElbowAnimator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","ElbowAnimator")) {
X3DJSON.nodeUtil("Scene","ElbowAnimator").addEventListener('outputchange', function(event) {

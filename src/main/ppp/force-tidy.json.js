...
if (typeof X3DJSON['Scene../data/force-tidy.json'] === 'undefined') {
	X3DJSON['Scene../data/force-tidy.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/force-tidy.json'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/force-tidy.json'] = {};
}

X3DJSON['Script']['Scene']['../data/force-tidy.json']['MoveBall'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/force-tidy.json'] = {};
}

X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'] = new X3DJSON['Script']['Scene']['../data/force-tidy.json']['MoveBall']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall']['ACTION'],X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].initialize === "function") X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/force-tidy.json']['MoveCylinder'] = function() {
...
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'] = new X3DJSON['Script']['Scene']['../data/force-tidy.json']['MoveCylinder']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder']['ACTION'],X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'].initialize === "function") X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/force-tidy.json']['clickHandler'] = function() {
...
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler'] = new X3DJSON['Script']['Scene']['../data/force-tidy.json']['clickHandler']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler']['ACTION'],X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler'].initialize === "function") X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler'].initialize();
    if (X3DJSON.nodeUtil("Scene","nodeClock")) {
X3DJSON.nodeUtil("Scene","nodeClock").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].set_cycle(X3DJSON.nodeUtil("Scene","nodeClock","cycleTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].set_cycle(X3DJSON.nodeUtil("Scene","nodeClock","cycleTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","nodeClock")) {
...
if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall']['ACTION']['keyValue'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall']['ACTION']['keyValue'] = [];
}
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall']['ACTION']['keyValue'].push(function(property, value) {
		if (property === 'keyValue') {
			X3DJSON.nodeUtil("Scene","NodePosition","keyValue",typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].keyValue === "function" ? X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].keyValue() : X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].keyValue, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","NodePosition","keyValue",typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].keyValue === "function" ? X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].keyValue() : X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveBall'].keyValue, __eventTime);
...
if (typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder']['ACTION']['spine'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder']['ACTION']['spine'] = [];
}
X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder']['ACTION']['spine'].push(function(property, value) {
		if (property === 'spine') {
			X3DJSON.nodeUtil("Scene","extrusion","spine",typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'].spine_changed === "function" ? X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'].spine_changed() : X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'].spine, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","extrusion","spine",typeof X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'].spine_changed === "function" ? X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'].spine_changed() : X3DJSON['Obj']['Scene']['../data/force-tidy.json']['MoveCylinder'].spine, __eventTime);
...
X3DJSON.nodeUtil("Scene","clickGenerator").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler'].add_node(X3DJSON.nodeUtil("Scene","clickGenerator","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/force-tidy.json']['clickHandler'].add_node(X3DJSON.nodeUtil("Scene","clickGenerator","isActive"), __eventTime);

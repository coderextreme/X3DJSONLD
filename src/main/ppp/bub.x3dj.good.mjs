...
if (typeof X3DJSON['Scene../data/bub.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/bub.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/bub.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/bub.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/bub.x3dj']['Bounce'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bub.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bub.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'] = new X3DJSON['Script']['Scene']['../data/bub.x3dj']['Bounce']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce']['ACTION'],X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].initialize === "function") X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].initialize();
    if (X3DJSON.nodeUtil("Scene","TourTime")) {
X3DJSON.nodeUtil("Scene","TourTime").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce']['ACTION']['translation'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce']['ACTION']['translation'] = [];
}
X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce']['ACTION']['translation'].push(function(property, value) {
		if (property === 'translation') {
			X3DJSON.nodeUtil("Scene","transform","translation",typeof X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].translation, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","transform","translation",typeof X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].translation, __eventTime);
			X3DJSON['Obj']['Scene']['../data/bub.x3dj']['Bounce'].set_fraction(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);

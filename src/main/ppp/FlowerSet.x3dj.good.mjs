...
if (typeof X3DJSON['Scene../data/FlowerSet.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/FlowerSet.x3dj'] = {};
}

    if (X3DJSON.nodeUtil("Scene","FlowerStartTIME")) {
X3DJSON.nodeUtil("Scene","FlowerStartTIME").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","FlowerStartTIME")) {
X3DJSON.nodeUtil("Scene","FlowerStartTIME").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","FlowerDelayTIME")) {
X3DJSON.nodeUtil("Scene","FlowerDelayTIME").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","FlowerDelayFILTER")) {
X3DJSON.nodeUtil("Scene","FlowerDelayFILTER").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","FlowerTRIGGER")) {
X3DJSON.nodeUtil("Scene","FlowerTRIGGER").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","PetalTime")) {
X3DJSON.nodeUtil("Scene","PetalTime").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","PetalTime")) {
X3DJSON.nodeUtil("Scene","PetalTime").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","PetalTime").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Petal01Move")) {
X3DJSON.nodeUtil("Scene","Petal01Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal02Move")) {
X3DJSON.nodeUtil("Scene","Petal02Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal03Move")) {
X3DJSON.nodeUtil("Scene","Petal03Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal04Move")) {
X3DJSON.nodeUtil("Scene","Petal04Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal05Move")) {
X3DJSON.nodeUtil("Scene","Petal05Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal06Move")) {
X3DJSON.nodeUtil("Scene","Petal06Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal07Move")) {
X3DJSON.nodeUtil("Scene","Petal07Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal08Move")) {
X3DJSON.nodeUtil("Scene","Petal08Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal09Move")) {
X3DJSON.nodeUtil("Scene","Petal09Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal10Move")) {
X3DJSON.nodeUtil("Scene","Petal10Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal11Move")) {
X3DJSON.nodeUtil("Scene","Petal11Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal12Move")) {
X3DJSON.nodeUtil("Scene","Petal12Move").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Petal01Move")) {
X3DJSON.nodeUtil("Scene","Petal01Move").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","Petal12Move").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","FlowerHeartTimer")) {
X3DJSON.nodeUtil("Scene","FlowerHeartTimer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","FlowerHeartTimer")) {
X3DJSON.nodeUtil("Scene","FlowerHeartTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FlowerHeartTimer").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","lFlower01_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","lFlower01_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","lFlower02_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","lFlower02_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","lFlower03_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","lFlower03_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","lFlower04_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","lFlower04_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","lFlower05_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","lFlower05_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","lFlower06_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","lFlower06_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","lFlower07_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","lFlower07_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","lFlower08_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","lFlower08_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","rFlower01_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","rFlower01_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","rFlower02_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","rFlower02_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","rFlower03_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","rFlower03_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","rFlower04_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","rFlower04_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","rFlower05_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","rFlower05_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","rFlower06_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","rFlower06_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","rFlower07_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","rFlower07_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","rFlower08_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","rFlower08_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}

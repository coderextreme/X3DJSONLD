...
if (typeof X3DJSON['Scene../data/JinFacsAu44SquintMorpher.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinFacsAu44SquintMorpher.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","ReversingClock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","__2_MorphInterpolator")) {
X3DJSON.nodeUtil("Scene","__2_MorphInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","__2_AnimationAdapter")) {
X3DJSON.nodeUtil("Scene","__2_AnimationAdapter").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","__2_Clock")) {
X3DJSON.nodeUtil("Scene","__2_Clock").addEventListener('outputchange', function(event) {
}, false);
}

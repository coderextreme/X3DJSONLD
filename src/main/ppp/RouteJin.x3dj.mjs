...
const dom = new JSDOM(`<!DOCTYPE html><html><body><div id="myDiv">Hello JSDOM</div></body></html>`);
...
X3DJSON.nodeUtil = function(selector, node, field, value) {
		...
		if (element === null) {
			...
			document.querySelector(selector).setAttribute(field, value);
...
if (typeof X3DJSON['Scene../data/RouteJin.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/RouteJin.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/RouteJin.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script0'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting inTime '+e);
			console.error('Problems setting inTime',e);
		}
	};
	this.inTime_changed = function () {
		var value = this.inTime;
		return value;
	};
	try {
		this.inTime = new SFTime();
	} catch (e) {
		console.log('Problems setting inTime '+e);
		console.error('Problems setting inTime',e);
	}
	...
	try {
		this.diffuseColor = new SFColor(0,0,1);
	} catch (e) {
		console.log('Problems setting diffuseColor '+e);
		console.error('Problems setting diffuseColor',e);
	}
	this.set_checked = function (value) {
		try {
			this.proxy.checked = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting checked '+e);
			console.error('Problems setting checked',e);
		}
	};
	this.checked_changed = function () {
		var value = this.checked;
		return value;
	};
	try {
		this.checked = new SFBool();
	} catch (e) {
		console.log('Problems setting checked '+e);
		console.error('Problems setting checked',e);
	}
ecmascript:
	...
	this.inTime = function (value) {
            // console.error("in", this.proxy.diffuseColor.g, this.proxy.diffuseColor.b);
            if (value) {
                this.proxy.checked = !this.proxy.checked;
            }
            scene = Browser.currentScene;
            if (this.proxy.checked) {
        Browser.addRoute(scene.getNamedNode("Main_Clock"), 'fraction_changed', scene.getNamedNode("AnimationAdapter_JinBlink"), 'set_fraction');
                ...
                this.proxy.diffuseColor.g = 1;
                this.proxy.diffuseColor.b = 0;
        ...
        Browser.deleteRoute(scene.getNamedNode("Main_Clock"), 'fraction_changed', scene.getNamedNode("AnimationAdapter_JinBlink"), 'set_fraction');
                ...
                this.proxy.diffuseColor.g = 0;
                this.proxy.diffuseColor.b = 1;
                this.proxy.fraction = 0;
            }
        }
     ;
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script0']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script1'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script2'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script2']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script3'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script3']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script4'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script4']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script5'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script5']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script6'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script6']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script7'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script7']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script8'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script8']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script9'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script9']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script10'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script10']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script11'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script11']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script12'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script12']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script13'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script13']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script14'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script14']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script15'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script15']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script16'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script16']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script17'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script17']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script18'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script18']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script19'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script19']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script20'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script20']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script21'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script21']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script22'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script22']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script23'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script23']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script24'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script24']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script25'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script25']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script26'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script26']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script27'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script27']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script28'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script28']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script29'] = function() {
	this.set_inTime = function (value) {
		try {
			this.proxy.inTime = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'] = new X3DJSON['Script']['Scene']['../data/RouteJin.x3dj']['Script29']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']['ACTION'],X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].initialize === "function") X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].initialize();
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBlink")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBlink").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBlink")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBlink").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBlink").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBrowLowerer")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBrowLowerer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBrowLowerer")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBrowLowerer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBrowLowerer").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekPuffer")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekPuffer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekPuffer")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekPuffer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekPuffer").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekRaiser").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekRaiser").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekRaiser").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinChinRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinChinRaiser").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinChinRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinChinRaiser").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinChinRaiser").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinDimpler")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinDimpler").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinDimpler")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinDimpler").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinDimpler").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinEyesClosed")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinEyesClosed").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinEyesClosed")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinEyesClosed").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinEyesClosed").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinInnerBrowRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinInnerBrowRaiser").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinInnerBrowRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinInnerBrowRaiser").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinInnerBrowRaiser").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinJawDrop")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinJawDrop").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinJawDrop")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinJawDrop").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinJawDrop").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidDroop")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidDroop").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidDroop")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidDroop").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidDroop").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidTightener")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidTightener").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidTightener")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidTightener").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidTightener").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerDepressor")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerDepressor").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerDepressor")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerDepressor").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerDepressor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerPuller")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerPuller").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerPuller")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerPuller").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerPuller").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipFunneler")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipFunneler").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipFunneler")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipFunneler").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipFunneler").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPressor")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPressor").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPressor")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPressor").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPressor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPuckerer")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPuckerer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPuckerer")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPuckerer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPuckerer").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipsPart")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipsPart").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipsPart")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipsPart").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipsPart").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipStretcher")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipStretcher").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipStretcher")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipStretcher").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipStretcher").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipSuck")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipSuck").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipSuck")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipSuck").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipSuck").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipTightener")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipTightener").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipTightener")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipTightener").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipTightener").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLowerLipDepressor")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLowerLipDepressor").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLowerLipDepressor")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLowerLipDepressor").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLowerLipDepressor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinMouthStretch")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinMouthStretch").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinMouthStretch")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinMouthStretch").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinMouthStretch").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNasolabialDeepener")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNasolabialDeepener").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNasolabialDeepener")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNasolabialDeepener").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNasolabialDeepener").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNoseWrinkler")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNoseWrinkler").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNoseWrinkler")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNoseWrinkler").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNoseWrinkler").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinOuterBrowRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinOuterBrowRaiser").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinOuterBrowRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinOuterBrowRaiser").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinOuterBrowRaiser").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSlit")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSlit").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSlit")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSlit").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSlit").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSquint")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSquint").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSquint")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSquint").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSquint").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLidRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLidRaiser").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLidRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLidRaiser").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLidRaiser").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLipRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLipRaiser").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLipRaiser")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLipRaiser").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLipRaiser").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinWink")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinWink").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","AnimationAdapter_JinWink")) {
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinWink").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinWink").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinBlink_Sensor")) {
X3DJSON.nodeUtil("Scene","JinBlink_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].inTime(X3DJSON.nodeUtil("Scene","JinBlink_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].inTime(X3DJSON.nodeUtil("Scene","JinBlink_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinBlink_Material")) {
X3DJSON.nodeUtil("Scene","JinBlink_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinBlink_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinBlink_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinBlink_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinBlink_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBlink","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBlink","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script0'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinBlink_Sensor")) {
X3DJSON.nodeUtil("Scene","JinBlink_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinBrowLowerer_Sensor")) {
X3DJSON.nodeUtil("Scene","JinBrowLowerer_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].inTime(X3DJSON.nodeUtil("Scene","JinBrowLowerer_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].inTime(X3DJSON.nodeUtil("Scene","JinBrowLowerer_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinBrowLowerer_Material")) {
X3DJSON.nodeUtil("Scene","JinBrowLowerer_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinBrowLowerer_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinBrowLowerer_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinBrowLowerer_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinBrowLowerer_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBrowLowerer","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinBrowLowerer","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script1'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinBrowLowerer_Sensor")) {
X3DJSON.nodeUtil("Scene","JinBrowLowerer_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinCheekPuffer_Sensor")) {
X3DJSON.nodeUtil("Scene","JinCheekPuffer_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].inTime(X3DJSON.nodeUtil("Scene","JinCheekPuffer_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].inTime(X3DJSON.nodeUtil("Scene","JinCheekPuffer_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinCheekPuffer_Material")) {
X3DJSON.nodeUtil("Scene","JinCheekPuffer_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinCheekPuffer_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinCheekPuffer_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinCheekPuffer_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinCheekPuffer_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekPuffer","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekPuffer","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script2'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinCheekPuffer_Sensor")) {
X3DJSON.nodeUtil("Scene","JinCheekPuffer_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinCheekRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinCheekRaiser_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].inTime(X3DJSON.nodeUtil("Scene","JinCheekRaiser_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].inTime(X3DJSON.nodeUtil("Scene","JinCheekRaiser_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinCheekRaiser_Material")) {
X3DJSON.nodeUtil("Scene","JinCheekRaiser_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinCheekRaiser_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinCheekRaiser_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinCheekRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinCheekRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinCheekRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script3'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinCheekRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinCheekRaiser_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinChinRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinChinRaiser_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].inTime(X3DJSON.nodeUtil("Scene","JinChinRaiser_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].inTime(X3DJSON.nodeUtil("Scene","JinChinRaiser_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinChinRaiser_Material")) {
X3DJSON.nodeUtil("Scene","JinChinRaiser_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinChinRaiser_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinChinRaiser_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinChinRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinChinRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinChinRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinChinRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script4'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinChinRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinChinRaiser_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinDimpler_Sensor")) {
X3DJSON.nodeUtil("Scene","JinDimpler_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].inTime(X3DJSON.nodeUtil("Scene","JinDimpler_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].inTime(X3DJSON.nodeUtil("Scene","JinDimpler_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinDimpler_Material")) {
X3DJSON.nodeUtil("Scene","JinDimpler_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinDimpler_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinDimpler_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinDimpler_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinDimpler_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinDimpler","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinDimpler","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script5'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinDimpler_Sensor")) {
X3DJSON.nodeUtil("Scene","JinDimpler_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinEyesClosed_Sensor")) {
X3DJSON.nodeUtil("Scene","JinEyesClosed_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].inTime(X3DJSON.nodeUtil("Scene","JinEyesClosed_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].inTime(X3DJSON.nodeUtil("Scene","JinEyesClosed_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinEyesClosed_Material")) {
X3DJSON.nodeUtil("Scene","JinEyesClosed_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinEyesClosed_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinEyesClosed_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinEyesClosed_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinEyesClosed_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinEyesClosed","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinEyesClosed","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script6'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinEyesClosed_Sensor")) {
X3DJSON.nodeUtil("Scene","JinEyesClosed_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].inTime(X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].inTime(X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Material")) {
X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinInnerBrowRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinInnerBrowRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script7'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinInnerBrowRaiser_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinJawDrop_Sensor")) {
X3DJSON.nodeUtil("Scene","JinJawDrop_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].inTime(X3DJSON.nodeUtil("Scene","JinJawDrop_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].inTime(X3DJSON.nodeUtil("Scene","JinJawDrop_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinJawDrop_Material")) {
X3DJSON.nodeUtil("Scene","JinJawDrop_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinJawDrop_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinJawDrop_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinJawDrop_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinJawDrop_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinJawDrop","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinJawDrop","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script8'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinJawDrop_Sensor")) {
X3DJSON.nodeUtil("Scene","JinJawDrop_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLidDroop_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLidDroop_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].inTime(X3DJSON.nodeUtil("Scene","JinLidDroop_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].inTime(X3DJSON.nodeUtil("Scene","JinLidDroop_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLidDroop_Material")) {
X3DJSON.nodeUtil("Scene","JinLidDroop_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLidDroop_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLidDroop_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLidDroop_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLidDroop_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidDroop","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidDroop","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script9'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLidDroop_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLidDroop_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLidTightener_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLidTightener_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].inTime(X3DJSON.nodeUtil("Scene","JinLidTightener_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].inTime(X3DJSON.nodeUtil("Scene","JinLidTightener_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLidTightener_Material")) {
X3DJSON.nodeUtil("Scene","JinLidTightener_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLidTightener_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLidTightener_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLidTightener_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLidTightener_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidTightener","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLidTightener","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script10'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLidTightener_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLidTightener_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].inTime(X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].inTime(X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Material")) {
X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerDepressor","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerDepressor","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script11'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].inTime(X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].inTime(X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Material")) {
X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerPuller","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerPuller","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script12'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipCornerPuller_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipFunneler_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipFunneler_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].inTime(X3DJSON.nodeUtil("Scene","JinLipFunneler_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].inTime(X3DJSON.nodeUtil("Scene","JinLipFunneler_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipFunneler_Material")) {
X3DJSON.nodeUtil("Scene","JinLipFunneler_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipFunneler_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipFunneler_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLipFunneler_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLipFunneler_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipFunneler","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipFunneler","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script13'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipFunneler_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipFunneler_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipPressor_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipPressor_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].inTime(X3DJSON.nodeUtil("Scene","JinLipPressor_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].inTime(X3DJSON.nodeUtil("Scene","JinLipPressor_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipPressor_Material")) {
X3DJSON.nodeUtil("Scene","JinLipPressor_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipPressor_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipPressor_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLipPressor_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLipPressor_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPressor","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPressor","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script14'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipPressor_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipPressor_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipPuckerer_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipPuckerer_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].inTime(X3DJSON.nodeUtil("Scene","JinLipPuckerer_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].inTime(X3DJSON.nodeUtil("Scene","JinLipPuckerer_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipPuckerer_Material")) {
X3DJSON.nodeUtil("Scene","JinLipPuckerer_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipPuckerer_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipPuckerer_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLipPuckerer_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLipPuckerer_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPuckerer","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPuckerer","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script15'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipPuckerer_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipPuckerer_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipsPart_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipsPart_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].inTime(X3DJSON.nodeUtil("Scene","JinLipsPart_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].inTime(X3DJSON.nodeUtil("Scene","JinLipsPart_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipsPart_Material")) {
X3DJSON.nodeUtil("Scene","JinLipsPart_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipsPart_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipsPart_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLipsPart_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLipsPart_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipsPart","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipsPart","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script16'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipsPart_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipsPart_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipStretcher_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipStretcher_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].inTime(X3DJSON.nodeUtil("Scene","JinLipStretcher_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].inTime(X3DJSON.nodeUtil("Scene","JinLipStretcher_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipStretcher_Material")) {
X3DJSON.nodeUtil("Scene","JinLipStretcher_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipStretcher_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipStretcher_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLipStretcher_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLipStretcher_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipStretcher","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipStretcher","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script17'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipStretcher_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipStretcher_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipSuck_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipSuck_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].inTime(X3DJSON.nodeUtil("Scene","JinLipSuck_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].inTime(X3DJSON.nodeUtil("Scene","JinLipSuck_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipSuck_Material")) {
X3DJSON.nodeUtil("Scene","JinLipSuck_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipSuck_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipSuck_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLipSuck_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLipSuck_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipSuck","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipSuck","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script18'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipSuck_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipSuck_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipTightener_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipTightener_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].inTime(X3DJSON.nodeUtil("Scene","JinLipTightener_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].inTime(X3DJSON.nodeUtil("Scene","JinLipTightener_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipTightener_Material")) {
X3DJSON.nodeUtil("Scene","JinLipTightener_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipTightener_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLipTightener_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLipTightener_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLipTightener_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipTightener","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipTightener","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script19'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLipTightener_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLipTightener_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].inTime(X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].inTime(X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Material")) {
X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLowerLipDepressor","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLowerLipDepressor","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script20'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Sensor")) {
X3DJSON.nodeUtil("Scene","JinLowerLipDepressor_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinMouthStretch_Sensor")) {
X3DJSON.nodeUtil("Scene","JinMouthStretch_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].inTime(X3DJSON.nodeUtil("Scene","JinMouthStretch_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].inTime(X3DJSON.nodeUtil("Scene","JinMouthStretch_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinMouthStretch_Material")) {
X3DJSON.nodeUtil("Scene","JinMouthStretch_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinMouthStretch_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinMouthStretch_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinMouthStretch_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinMouthStretch_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinMouthStretch","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinMouthStretch","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script21'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinMouthStretch_Sensor")) {
X3DJSON.nodeUtil("Scene","JinMouthStretch_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Sensor")) {
X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].inTime(X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].inTime(X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Material")) {
X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNasolabialDeepener","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNasolabialDeepener","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script22'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Sensor")) {
X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Sensor")) {
X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].inTime(X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].inTime(X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Material")) {
X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNoseWrinkler","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNoseWrinkler","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script23'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Sensor")) {
X3DJSON.nodeUtil("Scene","JinNoseWrinkler_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].inTime(X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].inTime(X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Material")) {
X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinOuterBrowRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinOuterBrowRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script24'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinSlit_Sensor")) {
X3DJSON.nodeUtil("Scene","JinSlit_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].inTime(X3DJSON.nodeUtil("Scene","JinSlit_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].inTime(X3DJSON.nodeUtil("Scene","JinSlit_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinSlit_Material")) {
X3DJSON.nodeUtil("Scene","JinSlit_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinSlit_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinSlit_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinSlit_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinSlit_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSlit","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSlit","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script25'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinSlit_Sensor")) {
X3DJSON.nodeUtil("Scene","JinSlit_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinSquint_Sensor")) {
X3DJSON.nodeUtil("Scene","JinSquint_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].inTime(X3DJSON.nodeUtil("Scene","JinSquint_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].inTime(X3DJSON.nodeUtil("Scene","JinSquint_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinSquint_Material")) {
X3DJSON.nodeUtil("Scene","JinSquint_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinSquint_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinSquint_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinSquint_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinSquint_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSquint","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinSquint","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script26'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinSquint_Sensor")) {
X3DJSON.nodeUtil("Scene","JinSquint_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].inTime(X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].inTime(X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Material")) {
X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLidRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLidRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script27'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinUpperLidRaiser_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].inTime(X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].inTime(X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Material")) {
X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLipRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLipRaiser","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script28'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Sensor")) {
X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Sensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinWink_Sensor")) {
X3DJSON.nodeUtil("Scene","JinWink_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].inTime(X3DJSON.nodeUtil("Scene","JinWink_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].inTime(X3DJSON.nodeUtil("Scene","JinWink_Sensor","touchTime"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinWink_Material")) {
X3DJSON.nodeUtil("Scene","JinWink_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinWink_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].set_diffuseColor(X3DJSON.nodeUtil("Scene","JinWink_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","JinWink_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","JinWink_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].diffuseColor, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']['ACTION']['fraction'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']['ACTION']['fraction'] = [];
}
X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29']['ACTION']['fraction'].push(function(property, value) {
		if (property === 'fraction') {
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinWink","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].fraction, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","AnimationAdapter_JinWink","fraction",typeof X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].fraction_changed === "function" ? X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].fraction_changed() : X3DJSON['Obj']['Scene']['../data/RouteJin.x3dj']['Script29'].fraction, __eventTime);
    if (X3DJSON.nodeUtil("Scene","JinWink_Sensor")) {

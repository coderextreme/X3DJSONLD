...
if (typeof X3DJSON['Scene../data/TestCycleTimeStart.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/TestCycleTimeStart.x3dj'] = {};
}

    if (X3DJSON.nodeUtil("Scene","REDTIME1")) {
X3DJSON.nodeUtil("Scene","REDTIME1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","REDTIME1")) {
X3DJSON.nodeUtil("Scene","REDTIME1").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","GREENTIME2")) {
X3DJSON.nodeUtil("Scene","GREENTIME2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","GREENFILTER")) {
X3DJSON.nodeUtil("Scene","GREENFILTER").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","BLUETRIGGER")) {
X3DJSON.nodeUtil("Scene","BLUETRIGGER").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","REDTIME1")) {
X3DJSON.nodeUtil("Scene","REDTIME1").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","REDINTERP1")) {
X3DJSON.nodeUtil("Scene","REDINTERP1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","GREENTIME2")) {
X3DJSON.nodeUtil("Scene","GREENTIME2").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","GREENINTERP2")) {
X3DJSON.nodeUtil("Scene","GREENINTERP2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","BLUETIME3")) {
X3DJSON.nodeUtil("Scene","BLUETIME3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","BLUEINTERP3")) {
X3DJSON.nodeUtil("Scene","BLUEINTERP3").addEventListener('outputchange', function(event) {
}, false);
}

...
if (typeof X3DJSON['Scene../data/JinLipTightener.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinLipTightener.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipTightener").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipTightener_Clock")) {
X3DJSON.nodeUtil("Scene","JinLipTightener_Clock").addEventListener('outputchange', function(event) {
}, false);
}

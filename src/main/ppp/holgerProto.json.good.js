...
if (typeof X3DJSON['Scene../data/holgerProto.json'] === 'undefined') {
	X3DJSON['Scene../data/holgerProto.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/holgerProto.json'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/holgerProto.json'] = {};
}

X3DJSON['Script']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/holgerProto.json'] = {};
}

X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'] = new X3DJSON['Script']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1']['ACTION'],X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'] = function() {
	this.set_startnode = function (value) {
		try {
			this.proxy.startnode = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'] = new X3DJSON['Script']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1']['ACTION'],X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'] = function() {
	this.set_startnode = function (value) {
		try {
			this.proxy.startnode = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'] = new X3DJSON['Script']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1']['ACTION'],X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'].initialize();
...
X3DJSON.nodeUtil("Scene","G1").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'].set_startpoint(X3DJSON.nodeUtil("Scene","G1","translation"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'].set_startpoint(X3DJSON.nodeUtil("Scene","G1","translation"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","G2")) {
X3DJSON.nodeUtil("Scene","G2").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'].set_endpoint(X3DJSON.nodeUtil("Scene","G2","translation"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'].set_endpoint(X3DJSON.nodeUtil("Scene","G2","translation"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","G1")) {
X3DJSON.nodeUtil("Scene","G1").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'].set_startpoint(X3DJSON.nodeUtil("Scene","G1","translation"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'].set_startpoint(X3DJSON.nodeUtil("Scene","G1","translation"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","G3")) {
X3DJSON.nodeUtil("Scene","G3").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'].set_endpoint(X3DJSON.nodeUtil("Scene","G3","translation"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector2_S1'].set_endpoint(X3DJSON.nodeUtil("Scene","G3","translation"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","G1")) {
X3DJSON.nodeUtil("Scene","G1").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'].set_startpoint(X3DJSON.nodeUtil("Scene","G1","translation"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'].set_startpoint(X3DJSON.nodeUtil("Scene","G1","translation"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","G4")) {
X3DJSON.nodeUtil("Scene","G4").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'].set_endpoint(X3DJSON.nodeUtil("Scene","G4","translation"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector3_S1'].set_endpoint(X3DJSON.nodeUtil("Scene","G4","translation"), __eventTime);
			X3DJSON['Obj']['Scene']['../data/holgerProto.json']['DECLx3dconnector_connector1_S1'].set_startpoint(X3DJSON.nodeUtil("Scene","G1","translation"), __eventTime);

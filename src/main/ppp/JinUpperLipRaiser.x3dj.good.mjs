...
if (typeof X3DJSON['Scene../data/JinUpperLipRaiser.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinUpperLipRaiser.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinUpperLipRaiser").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Clock")) {
X3DJSON.nodeUtil("Scene","JinUpperLipRaiser_Clock").addEventListener('outputchange', function(event) {
}, false);
}

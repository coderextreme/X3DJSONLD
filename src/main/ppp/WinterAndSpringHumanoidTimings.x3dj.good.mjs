...
if (typeof X3DJSON['Scene../data/WinterAndSpringHumanoidTimings.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/WinterAndSpringHumanoidTimings.x3dj'] = {};
}

    if (X3DJSON.nodeUtil("Scene","Background3Sequencer")) {
X3DJSON.nodeUtil("Scene","Background3Sequencer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Background4Sequencer")) {
X3DJSON.nodeUtil("Scene","Background4Sequencer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Background5Sequencer")) {
X3DJSON.nodeUtil("Scene","Background5Sequencer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Background6Sequencer")) {
X3DJSON.nodeUtil("Scene","Background6Sequencer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Clock10Seconds")) {
X3DJSON.nodeUtil("Scene","Clock10Seconds").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Clock10Seconds")) {
X3DJSON.nodeUtil("Scene","Clock10Seconds").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","Clock10Seconds").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Clock100Seconds")) {
X3DJSON.nodeUtil("Scene","Clock100Seconds").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Clock100Seconds")) {
X3DJSON.nodeUtil("Scene","Clock100Seconds").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","Clock100Seconds").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Gramps_HumanoidRoot_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","Gramps_HumanoidRoot_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Leif_HumanoidRoot_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","Leif_HumanoidRoot_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Lily_HumanoidRoot_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","Lily_HumanoidRoot_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Tufani_HumanoidRoot_TranslationInterpolator")) {
X3DJSON.nodeUtil("Scene","Tufani_HumanoidRoot_TranslationInterpolator").addEventListener('outputchange', function(event) {
}, false);
}

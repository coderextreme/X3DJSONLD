...
if (typeof X3DJSON['Scene../data/JinLipPuckerer.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinLipPuckerer.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipPuckerer").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipPuckerer_Clock")) {
X3DJSON.nodeUtil("Scene","JinLipPuckerer_Clock").addEventListener('outputchange', function(event) {
}, false);
}

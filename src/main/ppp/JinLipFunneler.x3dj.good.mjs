...
if (typeof X3DJSON['Scene../data/JinLipFunneler.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinLipFunneler.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipFunneler").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipFunneler_Clock")) {
X3DJSON.nodeUtil("Scene","JinLipFunneler_Clock").addEventListener('outputchange', function(event) {
}, false);
}

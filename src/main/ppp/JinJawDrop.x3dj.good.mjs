...
if (typeof X3DJSON['Scene../data/JinJawDrop.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinJawDrop.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinJawDrop").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinJawDrop_Clock")) {
X3DJSON.nodeUtil("Scene","JinJawDrop_Clock").addEventListener('outputchange', function(event) {
}, false);
}

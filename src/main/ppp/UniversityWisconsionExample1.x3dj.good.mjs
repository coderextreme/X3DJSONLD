...
if (typeof X3DJSON['Scene../data/UniversityWisconsionExample1.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/UniversityWisconsionExample1.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator2_vl5")) {
X3DJSON.nodeUtil("Scene","Interpolator2_vl5").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator3_Neck")) {
X3DJSON.nodeUtil("Scene","Interpolator3_Neck").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator4_skullbase")) {
X3DJSON.nodeUtil("Scene","Interpolator4_skullbase").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator5_LeftCollar")) {
X3DJSON.nodeUtil("Scene","Interpolator5_LeftCollar").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator6_LeftUpArm")) {
X3DJSON.nodeUtil("Scene","Interpolator6_LeftUpArm").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator7_LeftLowArm")) {
X3DJSON.nodeUtil("Scene","Interpolator7_LeftLowArm").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator8_LeftHand")) {
X3DJSON.nodeUtil("Scene","Interpolator8_LeftHand").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator9_RightCollar")) {
X3DJSON.nodeUtil("Scene","Interpolator9_RightCollar").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator10_RightUpArm")) {
X3DJSON.nodeUtil("Scene","Interpolator10_RightUpArm").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator11_RightLowArm")) {
X3DJSON.nodeUtil("Scene","Interpolator11_RightLowArm").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator12_RightHand")) {
X3DJSON.nodeUtil("Scene","Interpolator12_RightHand").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator13_LeftUpLeg")) {
X3DJSON.nodeUtil("Scene","Interpolator13_LeftUpLeg").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator14_LeftLowLeg")) {
X3DJSON.nodeUtil("Scene","Interpolator14_LeftLowLeg").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator15_LeftFoot")) {
X3DJSON.nodeUtil("Scene","Interpolator15_LeftFoot").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator16_RightUpLeg")) {
X3DJSON.nodeUtil("Scene","Interpolator16_RightUpLeg").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator17_RightLowLeg")) {
X3DJSON.nodeUtil("Scene","Interpolator17_RightLowLeg").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","RealTimer")) {
X3DJSON.nodeUtil("Scene","RealTimer").addEventListener('outputchange', function(event) {
...
X3DJSON.nodeUtil("Scene","FrameStepper").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Interpolator18_RightFoot")) {
X3DJSON.nodeUtil("Scene","Interpolator18_RightFoot").addEventListener('outputchange', function(event) {
}, false);
}

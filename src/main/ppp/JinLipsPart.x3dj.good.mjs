...
if (typeof X3DJSON['Scene../data/JinLipsPart.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinLipsPart.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipsPart").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipsPart_Clock")) {
X3DJSON.nodeUtil("Scene","JinLipsPart_Clock").addEventListener('outputchange', function(event) {
}, false);
}

...
if (typeof X3DJSON['Scene../data/HAnimDisplacerExamples.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/HAnimDisplacerExamples.x3dj'] = {};
}

    if (X3DJSON.nodeUtil("Scene","skull_tipTimer")) {
X3DJSON.nodeUtil("Scene","skull_tipTimer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","skull_tipInterp")) {
X3DJSON.nodeUtil("Scene","skull_tipInterp").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","L_finger_tipsTimer")) {
X3DJSON.nodeUtil("Scene","L_finger_tipsTimer").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","L_finger_tipsInterp")) {
X3DJSON.nodeUtil("Scene","L_finger_tipsInterp").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","L_finger_tipsTimer")) {
X3DJSON.nodeUtil("Scene","L_finger_tipsTimer").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","L_shoulderDispRotInterp")) {
X3DJSON.nodeUtil("Scene","L_shoulderDispRotInterp").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","L_shoulderDispRotInterp")) {
X3DJSON.nodeUtil("Scene","L_shoulderDispRotInterp").addEventListener('outputchange', function(event) {

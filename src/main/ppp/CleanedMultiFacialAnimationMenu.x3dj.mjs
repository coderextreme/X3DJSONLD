...
if (typeof X3DJSON['Scene../data/CleanedMultiFacialAnimationMenu.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/CleanedMultiFacialAnimationMenu.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'] = function() {
	...
	this.set_adapter = function (value) {
		try {
			this.proxy.adapter = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting adapter '+e);
			console.error('Problems setting adapter',e);
		}
	};
	this.adapter_changed = function () {
		var value = this.adapter;
		return value;
	};
	try {
		this.adapter = new SFNode();
	} catch (e) {
		console.log('Problems setting adapter '+e);
		console.error('Problems setting adapter',e);
	}
	...
	this.inTime = function (value) {
            ...
            if (this.proxy.checked) {
                Browser.addRoute(scene.getNamedNode("Main_Clock"), 'fraction_changed', this.proxy.adapter, 'set_fraction');
                this.proxy.diffuseColor.g = 1;
                this.proxy.diffuseColor.b = 0;
                this.proxy.adapter.set_fraction = 0;
            } else {
                Browser.deleteRoute(scene.getNamedNode("Main_Clock"), 'fraction_changed', this.proxy.adapter, 'set_fraction');
...
if (typeof X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'] = new X3DJSON['Script']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION'],X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].initialize === "function") X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].initialize();
...
X3DJSON.nodeUtil("Scene","StartStopAnimationUnit_Sensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].inTime(X3DJSON.nodeUtil("Scene","StartStopAnimationUnit_Sensor","touchTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].inTime(X3DJSON.nodeUtil("Scene","StartStopAnimationUnit_Sensor","touchTime"), __eventTime);
...
X3DJSON.nodeUtil("Scene","MenuBackground_Material").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].set_diffuseColor(X3DJSON.nodeUtil("Scene","MenuBackground_Material","diffuseColor"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].set_diffuseColor(X3DJSON.nodeUtil("Scene","MenuBackground_Material","diffuseColor"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION']['diffuseColor'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION']['diffuseColor'] = [];
}
X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle']['ACTION']['diffuseColor'].push(function(property, value) {
		if (property === 'diffuseColor') {
			X3DJSON.nodeUtil("Scene","MenuBackground_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","MenuBackground_Material","diffuseColor",typeof X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor_changed === "function" ? X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor_changed() : X3DJSON['Obj']['Scene']['../data/CleanedMultiFacialAnimationMenu.x3dj']['ScriptToggle'].diffuseColor, __eventTime);
    if (X3DJSON.nodeUtil("Scene","StartStopAnimationUnit_Sensor")) {

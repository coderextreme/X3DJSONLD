...
if (typeof X3DJSON['Scene../data/JinNasolabialDeepener.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinNasolabialDeepener.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinNasolabialDeepener").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Clock")) {
X3DJSON.nodeUtil("Scene","JinNasolabialDeepener_Clock").addEventListener('outputchange', function(event) {
}, false);
}

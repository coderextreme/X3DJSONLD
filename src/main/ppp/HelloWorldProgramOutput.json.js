...
if (typeof X3DJSON['Scene../data/HelloWorldProgramOutput.json'] === 'undefined') {
	X3DJSON['Scene../data/HelloWorldProgramOutput.json'] = {};
}
...
X3DJSON['Script']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'] = function() {
	this.set_colorInput = function (value) {
		try {
			...
			alert('Problems setting colorInput '+e);
	...
	this.set_colorsOutput = function (value) {
		try {
			...
			alert('Problems setting colorsOutput '+e);
...
X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'] = new X3DJSON['Script']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/HelloWorldProgramOutput.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'] = function() {
	...
	this.set_diffuseColor = function (value) {
		try {
			...
			alert('Problems setting diffuseColor '+e);
	...
	this.set_newColor = function (value) {
		try {
			...
			alert('Problems setting newColor '+e);
	...
	this.set_clockTrigger = function (value) {
		try {
			...
			alert('Problems setting clockTrigger '+e);
...
X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'] = new X3DJSON['Script']['Scene']['../data/HelloWorldProgramOutput.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['DECLMaterialModulator_MyMaterialModulator_MaterialModulatorScript']['ACTION'] = {};
...
if (typeof X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript']['ACTION']['colorsOutput'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript']['ACTION']['colorsOutput'] = [];
}
X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript']['ACTION']['colorsOutput'].push(function(property, value) {
		if (property === 'colorsOutput') {
			X3DJSON.nodeUtil('Scene','GradualBackground','skyColor',typeof X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].colorsOutput === "function" ? X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].colorsOutput() : X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].colorsOutput, __eventTime);
		}
});
			X3DJSON.nodeUtil('Scene','GradualBackground','skyColor',typeof X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].colorsOutput === "function" ? X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].colorsOutput() : X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].colorsOutput, __eventTime);
X3DJSON.nodeUtil('Scene','ColorAnimator').addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].colorInput(X3DJSON.nodeUtil('Scene','ColorAnimator','value'), __eventTime);
}, false);
			X3DJSON['Obj']['Scene']['../data/HelloWorldProgramOutput.json']['colorTypeConversionScript'].colorInput(X3DJSON.nodeUtil('Scene','ColorAnimator','value'), __eventTime);

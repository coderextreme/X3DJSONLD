...
if (typeof X3DJSON['Scene../data/GrampsAnimations.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/GrampsAnimations.x3dj'] = {};
}

    if (X3DJSON.nodeUtil("Scene","humanoid_root_Close")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Close").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_sacroiliac")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_sacroiliac").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_hip")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_hip").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_knee")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_knee").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_talocrural")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_talocrural").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metatarsophalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metatarsophalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_tarsal_distal_interphalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_tarsal_distal_interphalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_hip")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_hip").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_knee")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_knee").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_talocrural")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_talocrural").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metatarsophalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metatarsophalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_tarsal_distal_interphalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_tarsal_distal_interphalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_vl5")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_vl5").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_vl3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_vl3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_vt12")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_vt12").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_vt9")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_vt9").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_vt4")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_vt4").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_vc7")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_vc7").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_vc3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_vc3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_skullbase")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_skullbase").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_sternoclavicular")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_sternoclavicular").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_shoulder")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_shoulder").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_elbow")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_elbow").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_radiocarpal")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_radiocarpal").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_1")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_1")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_interphalangeal_1")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_interphalangeal_1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_proximal_interphalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_proximal_interphalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_distal_interphalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_distal_interphalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_proximal_interphalangeal_3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_proximal_interphalangeal_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_distal_interphalangeal_3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_distal_interphalangeal_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_4")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_4").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_4")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_4").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_proximal_interphalangeal_4")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_proximal_interphalangeal_4").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_distal_interphalangeal_4")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_distal_interphalangeal_4").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_5")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpometacarpal_5").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_5")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_metacarpophalangeal_5").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_proximal_interphalangeal_5")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_proximal_interphalangeal_5").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_distal_interphalangeal_5")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_l_carpal_distal_interphalangeal_5").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_sternoclavicular")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_sternoclavicular").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_shoulder")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_shoulder").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_elbow")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_elbow").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_radiocarpal")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_radiocarpal").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_1")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_1")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_interphalangeal_1")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_interphalangeal_1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_proximal_interphalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_proximal_interphalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_distal_interphalangeal_2")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_distal_interphalangeal_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_proximal_interphalangeal_3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_proximal_interphalangeal_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_distal_interphalangeal_3")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_distal_interphalangeal_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_4")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_4").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_4")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_4").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_proximal_interphalangeal_4")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_proximal_interphalangeal_4").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_distal_interphalangeal_4")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_distal_interphalangeal_4").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_5")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpometacarpal_5").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_5")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_metacarpophalangeal_5").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_proximal_interphalangeal_5")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_proximal_interphalangeal_5").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","humanoid_root_Clock")) {
X3DJSON.nodeUtil("Scene","humanoid_root_Clock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_distal_interphalangeal_5")) {
X3DJSON.nodeUtil("Scene","humanoid_root_OI_r_carpal_distal_interphalangeal_5").addEventListener('outputchange', function(event) {
}, false);
}

...
if (typeof X3DJSON['Scene../data/bobblespheres.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/bobblespheres.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/bobblespheres.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/bobblespheres.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/bobblespheres.x3dj']['Animator_0'] = function() {
	...
	this.set_roughness = function (value) {
		try {
			this.proxy.roughness = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting roughness '+e);
			console.error('Problems setting roughness',e);
		}
	};
	this.roughness_changed = function () {
		var value = this.roughness;
		return value;
	};
	try {
	...
	this.set_targetMaterial = function (value) {
		try {
			this.proxy.targetMaterial = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting targetMaterial '+e);
			console.error('Problems setting targetMaterial',e);
		}
	};
	this.targetMaterial_changed = function () {
		var value = this.targetMaterial;
		return value;
	};
	try {
		this.targetMaterial = X3DJSON.nodeUtil("Scene","M_0");
	} catch (e) {
		console.log('Problems setting targetMaterial '+e);
		console.error('Problems setting targetMaterial',e);
	}
	...
	this.initialize = function () {
          // This functino runs AFTER the X3DJSON.nodeUtil("Scene","M_0", "ield") is connected.
          // We safely store the reference to the actual material node.
          matNode = X3DJSON.nodeUtil("Scene","M_0", "value");
        }
	...
	this.set_roughness = function (value, timestamp) {
          if (matNode) {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'] = new X3DJSON['Script']['Scene']['../data/bobblespheres.x3dj']['Animator_0']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0']['ACTION'],X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'].initialize === "function") X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/bobblespheres.x3dj']['Animator_1'] = function() {
	this.set_roughness = function (value) {
		try {
			this.proxy.roughness = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
	...
	try {
		this.targetMaterial = X3DJSON.nodeUtil("Scene","M_1");
	} catch (e) {
		console.log('Problems setting targetMaterial '+e);
		console.error('Problems setting targetMaterial',e);
	}
	...
	this.initialize = function () {
          matNode = X3DJSON.nodeUtil("Scene","M_1", "value");
        }
...
X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1'] = new X3DJSON['Script']['Scene']['../data/bobblespheres.x3dj']['Animator_1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1']['ACTION'],X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1'].initialize();
    if (X3DJSON.nodeUtil("Scene","C_0")) {
X3DJSON.nodeUtil("Scene","C_0").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","PI_0")) {
X3DJSON.nodeUtil("Scene","PI_0").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","C_0")) {
X3DJSON.nodeUtil("Scene","C_0").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","CI_0")) {
X3DJSON.nodeUtil("Scene","CI_0").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'].set_color(X3DJSON.nodeUtil("Scene","CI_0","value"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'].set_color(X3DJSON.nodeUtil("Scene","CI_0","value"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","C_0")) {
X3DJSON.nodeUtil("Scene","C_0").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","SI_0")) {
X3DJSON.nodeUtil("Scene","SI_0").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'].set_roughness(X3DJSON.nodeUtil("Scene","SI_0","value"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'].set_roughness(X3DJSON.nodeUtil("Scene","SI_0","value"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","C_1")) {
X3DJSON.nodeUtil("Scene","C_1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","PI_1")) {
X3DJSON.nodeUtil("Scene","PI_1").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","C_1")) {
X3DJSON.nodeUtil("Scene","C_1").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","SI_1")) {
X3DJSON.nodeUtil("Scene","SI_1").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1'].set_roughness(X3DJSON.nodeUtil("Scene","SI_1","value"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_1'].set_roughness(X3DJSON.nodeUtil("Scene","SI_1","value"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","C_2")) {
X3DJSON.nodeUtil("Scene","C_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","PI_2")) {
X3DJSON.nodeUtil("Scene","PI_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","C_2")) {
X3DJSON.nodeUtil("Scene","C_2").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","SI_2")) {
X3DJSON.nodeUtil("Scene","SI_2").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","C_3")) {
X3DJSON.nodeUtil("Scene","C_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","PI_3")) {
X3DJSON.nodeUtil("Scene","PI_3").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","C_3")) {
X3DJSON.nodeUtil("Scene","C_3").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","SI_3")) {
X3DJSON.nodeUtil("Scene","SI_3").addEventListener('outputchange', function(event) {
}, false);
}
			X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'].set_color(X3DJSON.nodeUtil("Scene","CI_0","value"), __eventTime);
			X3DJSON['Obj']['Scene']['../data/bobblespheres.x3dj']['Animator_0'].set_roughness(X3DJSON.nodeUtil("Scene","SI_0","value"), __eventTime);

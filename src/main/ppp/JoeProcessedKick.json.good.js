...
if (typeof X3DJSON['Scene../data/JoeProcessedKick.json'] === 'undefined') {
	X3DJSON['Scene../data/JoeProcessedKick.json'] = {};
}
...
X3DJSON.nodeUtil('Scene','KickTimer').addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil('Scene','SkinInterpolator')) {
X3DJSON.nodeUtil('Scene','SkinInterpolator').addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil('Scene','KickTimer')) {
X3DJSON.nodeUtil('Scene','KickTimer').addEventListener('outputchange', function(event) {

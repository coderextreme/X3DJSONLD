...
if (typeof X3DJSON['Scene../data/text3shapes.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/text3shapes.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/text3shapes.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/text3shapes.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/text3shapes.x3dj'][''] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj'][''] = new X3DJSON['Script']['Scene']['../data/text3shapes.x3dj']['']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj']['']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj']['']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj'][''].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj']['']['ACTION'],X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj']['']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj'][''].initialize === "function") X3DJSON['Obj']['Scene']['../data/text3shapes.x3dj'][''].initialize();

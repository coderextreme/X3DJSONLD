...
if (typeof X3DJSON['Scene../data/JinMouthStretch.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinMouthStretch.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinMouthStretch").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinMouthStretch_Clock")) {
X3DJSON.nodeUtil("Scene","JinMouthStretch_Clock").addEventListener('outputchange', function(event) {
}, false);
}

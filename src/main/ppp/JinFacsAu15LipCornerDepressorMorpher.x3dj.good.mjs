...
if (typeof X3DJSON['Scene../data/JinFacsAu15LipCornerDepressorMorpher.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinFacsAu15LipCornerDepressorMorpher.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","ReversingClock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","Right_upper_vermillion_lip_MorphInterpolator")) {
X3DJSON.nodeUtil("Scene","Right_upper_vermillion_lip_MorphInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","ReversingClock")) {
X3DJSON.nodeUtil("Scene","ReversingClock").addEventListener('outputchange', function(event) {

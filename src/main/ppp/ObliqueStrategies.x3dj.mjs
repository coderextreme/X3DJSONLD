...
if (typeof X3DJSON['Scene../data/ObliqueStrategies.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/ObliqueStrategies.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/ObliqueStrategies.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/ObliqueStrategies.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'] = new X3DJSON['Script']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].initialize();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['string'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['string'] = [];
}
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['string'].push(function(property, value) {
		if (property === 'string') {
			X3DJSON.nodeUtil("Scene","CardText","string",typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].string_changed === "function" ? X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].string_changed() : X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].string, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","CardText","string",typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].string_changed === "function" ? X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].string_changed() : X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].string, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['textToSpeechUrl'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['textToSpeechUrl'] = [];
}
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['textToSpeechUrl'].push(function(property, value) {
		if (property === 'textToSpeechUrl') {
			X3DJSON.nodeUtil("Scene","TextToSpeechAudioClip","url",typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl === "function" ? X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl() : X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","TextToSpeechAudioClip","url",typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl === "function" ? X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl() : X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['newCardTime'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['newCardTime'] = [];
}
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['newCardTime'].push(function(property, value) {
		if (property === 'newCardTime') {
			X3DJSON.nodeUtil("Scene","TextToSpeechAudioClip","startTime",typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].newCardTime === "function" ? X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].newCardTime() : X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].newCardTime, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","TextToSpeechAudioClip","startTime",typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].newCardTime === "function" ? X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].newCardTime() : X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].newCardTime, __eventTime);
...
X3DJSON.nodeUtil("Scene","PreviousTextClickedSensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].selectPreviousCard(X3DJSON.nodeUtil("Scene","PreviousTextClickedSensor","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].selectPreviousCard(X3DJSON.nodeUtil("Scene","PreviousTextClickedSensor","isActive"), __eventTime);
...
X3DJSON.nodeUtil("Scene","NextTextClickedSensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].selectNextCard(X3DJSON.nodeUtil("Scene","NextTextClickedSensor","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].selectNextCard(X3DJSON.nodeUtil("Scene","NextTextClickedSensor","isActive"), __eventTime);
...
X3DJSON.nodeUtil("Scene","RandomTextClickedSensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].selectRandomCard(X3DJSON.nodeUtil("Scene","RandomTextClickedSensor","isActive"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].selectRandomCard(X3DJSON.nodeUtil("Scene","RandomTextClickedSensor","isActive"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript']['ACTION']['textToSpeechUrl'].push(function(property, value) {
		if (property === 'textToSpeechUrl') {
			X3DJSON.nodeUtil("Scene","TextToSpeechAnchor","url",typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl === "function" ? X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl() : X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","TextToSpeechAnchor","url",typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl === "function" ? X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl() : X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].textToSpeechUrl, __eventTime);
			X3DJSON.nodeUtil("Scene","CardText","string",typeof X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].string_changed === "function" ? X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].string_changed() : X3DJSON['Obj']['Scene']['../data/ObliqueStrategies.x3dj']['TextScript'].string, __eventTime);

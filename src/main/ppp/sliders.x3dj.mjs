...
if (typeof X3DJSON['Scene../data/sliders.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/sliders.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/sliders.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/sliders.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'] = function() {
	...
	this.set_protoScript = function (value) {
		try {
			this.proxy.protoScript = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
			console.log('Problems setting protoScript '+e);
			console.error('Problems setting protoScript',e);
		}
	};
	this.protoScript_changed = function () {
		var value = this.protoScript;
		return value;
	};
	try {
		this.protoScript = new SFNode();
	} catch (e) {
		console.log('Problems setting protoScript '+e);
		console.error('Problems setting protoScript',e);
	}
	...
	try {
		this.protoText = new MFString("1.0");
	} catch (e) {
		console.log('Problems setting protoText '+e);
		console.error('Problems setting protoText',e);
	}
ecmascript:
	this.set_protoScale = function (value) {
	this.proxy.protoScale = value;
}
;

	this.set_protoParameterName = function (value) {
	this.proxy.protoParameterName = value;
}
;

	this.set_protoScript = function (value) {
	this.proxy.protoScript = value;
}
;

	this.set_protoValue = function (value) {
	this.proxy.protoValue = value;
}
;

	this.set_protoText = function (value) {
	this.proxy.protoText = value;
}
;

	this.newTranslation = function (value) {
       	this.set_protoValue(value.x * this.proxy.protoScale);
       	this.set_protoText(new MFString(this.proxy.protoParameterName+'='+this.proxy.protoValue.toFixed(2)));
	this.proxy.protoScript[this.proxy.protoParameterName] = this.proxy.protoValue;
};
;
...
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/sliders.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'] = new X3DJSON['Script']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/sliders.x3dj']['OrbitScript'] = function() {
...
ecmascript:
	...
	this.initialize = function () {
				...
				for (var j = 0; j < this.proxy.resolution-1; j++) {
				     this.proxy.coordIndexes[arrIndex++] = i*this.proxy.resolution+j;
				     this.proxy.coordIndexes[arrIndex++] = i*this.proxy.resolution+j+1;
				     this.proxy.coordIndexes[arrIndex++] = (i+1)*this.proxy.resolution+j+1;
				     this.proxy.coordIndexes[arrIndex++] = (i+1)*this.proxy.resolution+j;
				     this.proxy.coordIndexes[arrIndex++] = -1;
				}
			    }
			}
		;
	...
	this.generateCoordinates = function () {
				...
				for (var j = 0; j < this.proxy.resolution; j++) {
					var rho = this.proxy.e + this.proxy.f * Math.cos(this.proxy.g * theta + this.proxy.tdelta) * Math.cos(this.proxy.h * phi + this.proxy.pdelta);
					this.proxy.coordinates[arrIndex++] = new SFVec3f(
...
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'] = new X3DJSON['Script']['Scene']['../data/sliders.x3dj']['OrbitScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/sliders.x3dj'][''] = function() {
};
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
...
X3DJSON['Obj']['Scene']['../data/sliders.x3dj'][''] = new X3DJSON['Script']['Scene']['../data/sliders.x3dj']['']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/sliders.x3dj'][''].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['']['ACTION'],X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj'][''].initialize === "function") X3DJSON['Obj']['Scene']['../data/sliders.x3dj'][''].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON.nodeUtil("Scene","protoSensor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","protoSensor")) {
X3DJSON.nodeUtil("Scene","protoSensor").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].newTranslation(X3DJSON.nodeUtil("Scene","protoSensor","translation"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].newTranslation(X3DJSON.nodeUtil("Scene","protoSensor","translation"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript']['ACTION']['protoText'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript']['ACTION']['protoText'] = [];
}
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript']['ACTION']['protoText'].push(function(property, value) {
		if (property === 'protoText') {
			X3DJSON.nodeUtil("Scene","protoText","string",typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].protoText_changed === "function" ? X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].protoText_changed() : X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].protoText, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","protoText","string",typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].protoText_changed === "function" ? X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].protoText_changed() : X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].protoText, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']['ACTION']['coordIndexes'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']['ACTION']['coordIndexes'] = [];
}
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']['ACTION']['coordIndexes'].push(function(property, value) {
		if (property === 'coordIndexes') {
			X3DJSON.nodeUtil("Scene","Orbit","coordIndex",typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordIndexes_changed === "function" ? X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordIndexes_changed() : X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordIndexes, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","Orbit","coordIndex",typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordIndexes_changed === "function" ? X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordIndexes_changed() : X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordIndexes, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']['ACTION']['coordinates'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']['ACTION']['coordinates'] = [];
}
X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript']['ACTION']['coordinates'].push(function(property, value) {
		if (property === 'coordinates') {
			X3DJSON.nodeUtil("Scene","OrbitCoordinates","point",typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordinates_changed === "function" ? X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordinates_changed() : X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordinates, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","OrbitCoordinates","point",typeof X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordinates_changed === "function" ? X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordinates_changed() : X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['OrbitScript'].coordinates, __eventTime);
			X3DJSON['Obj']['Scene']['../data/sliders.x3dj']['protoValueTransformerScript'].newTranslation(X3DJSON.nodeUtil("Scene","protoSensor","translation"), __eventTime);

...
if (typeof X3DJSON['Scene../data/JinFacsAu06CheekRaiserMorpher.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinFacsAu06CheekRaiserMorpher.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","ReversingClock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","__0_MorphInterpolator")) {
X3DJSON.nodeUtil("Scene","__0_MorphInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","__0_AnimationAdapter")) {
X3DJSON.nodeUtil("Scene","__0_AnimationAdapter").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","__0_Clock")) {
X3DJSON.nodeUtil("Scene","__0_Clock").addEventListener('outputchange', function(event) {
}, false);
}

...
if (typeof X3DJSON['Scene../data/bubs.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/bubs.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/bubs.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/bubs.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/bubs.x3dj']['bounce1'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubs.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'] = new X3DJSON['Script']['Scene']['../data/bubs.x3dj']['bounce1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']['ACTION'],X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].initialize();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']['ACTION']['translation'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']['ACTION']['translation'] = [];
}
X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']['ACTION']['translation'].push(function(property, value) {
		if (property === 'translation') {
			X3DJSON.nodeUtil("Scene","body_trans","translation",typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].translation, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","body_trans","translation",typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].translation, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']['ACTION']['scale'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']['ACTION']['scale'] = [];
}
X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1']['ACTION']['scale'].push(function(property, value) {
		if (property === 'scale') {
			X3DJSON.nodeUtil("Scene","body_trans","scale",typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].scale_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].scale_changed() : X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].scale, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","body_trans","scale",typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].scale_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].scale_changed() : X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].scale, __eventTime);
    if (X3DJSON.nodeUtil("Scene","bubbleClock")) {
X3DJSON.nodeUtil("Scene","bubbleClock").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].set_fraction(X3DJSON.nodeUtil("Scene","bubbleClock","fraction"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].set_fraction(X3DJSON.nodeUtil("Scene","bubbleClock","fraction"), __eventTime);
			X3DJSON.nodeUtil("Scene","body_trans","translation",typeof X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].translation_changed === "function" ? X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].translation_changed() : X3DJSON['Obj']['Scene']['../data/bubs.x3dj']['bounce1'].translation, __eventTime);

...
X3DJSON['Script']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'] = function() {
...
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'] = new X3DJSON['Script']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder']['ACTION'],X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].initialize === "function") X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'] = function() {
	this.set_spine = function (value) {
		try {
			this.proxy.spine = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'] = new X3DJSON['Script']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder']['ACTION'],X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].initialize === "function") X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
X3DJSON['Script']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'] = function() {
	this.set_spine = function (value) {
		try {
			this.proxy.spine = (typeof value === 'string' && typeof value.indexOf === 'function' && value.indexOf(',') >= 0 ? value.split(/[ ,]+/) : value);
		} catch (e) {
...
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'] = new X3DJSON['Script']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder']['ACTION'],X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].initialize === "function") X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].initialize();
if (typeof X3DJSON['Script'] === 'undefined') {
X3DJSON['Script'] = {};
}
if (typeof X3DJSON['Script']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder']['ACTION']['spine'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder']['ACTION']['spine'] = [];
}
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder']['ACTION']['spine'].push(function(property, value) {
		if (property === 'spine') {
			X3DJSON.nodeUtil('Scene','DECLcylinder_linkA_extrusion','spine',typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].spine === "function" ? X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].spine() : X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].spine, __eventTime);
		}
});
			X3DJSON.nodeUtil('Scene','DECLcylinder_linkA_extrusion','spine',typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].spine === "function" ? X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].spine() : X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].spine, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder']['ACTION']['spine'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder']['ACTION']['spine'] = [];
}
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder']['ACTION']['spine'].push(function(property, value) {
		if (property === 'spine') {
			X3DJSON.nodeUtil('Scene','DECLcylinder_linkB_extrusion','spine',typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].spine === "function" ? X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].spine() : X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].spine, __eventTime);
		}
});
			X3DJSON.nodeUtil('Scene','DECLcylinder_linkB_extrusion','spine',typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].spine === "function" ? X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].spine() : X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].spine, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder']['ACTION']['spine'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder']['ACTION']['spine'] = [];
}
X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder']['ACTION']['spine'].push(function(property, value) {
		if (property === 'spine') {
			X3DJSON.nodeUtil('Scene','DECLcylinder_linkC_extrusion','spine',typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].spine === "function" ? X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].spine() : X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].spine, __eventTime);
		}
});
			X3DJSON.nodeUtil('Scene','DECLcylinder_linkC_extrusion','spine',typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].spine === "function" ? X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].spine() : X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].spine, __eventTime);
...
X3DJSON.nodeUtil('Scene','DECLnode_nodeA_transform').addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].set_endA(X3DJSON.nodeUtil('Scene','DECLnode_nodeA_transform','translation'), __eventTime);
}, false);
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].set_endA(X3DJSON.nodeUtil('Scene','DECLnode_nodeA_transform','translation'), __eventTime);
X3DJSON.nodeUtil('Scene','DECLnode_nodeB_transform').addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].set_endB(X3DJSON.nodeUtil('Scene','DECLnode_nodeB_transform','translation'), __eventTime);
}, false);
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkA_MoveCylinder'].set_endB(X3DJSON.nodeUtil('Scene','DECLnode_nodeB_transform','translation'), __eventTime);
X3DJSON.nodeUtil('Scene','DECLnode_nodeA_transform').addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].set_endA(X3DJSON.nodeUtil('Scene','DECLnode_nodeA_transform','translation'), __eventTime);
}, false);
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].set_endA(X3DJSON.nodeUtil('Scene','DECLnode_nodeA_transform','translation'), __eventTime);
X3DJSON.nodeUtil('Scene','DECLnode_nodeC_transform').addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].set_endB(X3DJSON.nodeUtil('Scene','DECLnode_nodeC_transform','translation'), __eventTime);
}, false);
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkB_MoveCylinder'].set_endB(X3DJSON.nodeUtil('Scene','DECLnode_nodeC_transform','translation'), __eventTime);
X3DJSON.nodeUtil('Scene','DECLnode_nodeA_transform').addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].set_endA(X3DJSON.nodeUtil('Scene','DECLnode_nodeA_transform','translation'), __eventTime);
}, false);
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].set_endA(X3DJSON.nodeUtil('Scene','DECLnode_nodeA_transform','translation'), __eventTime);
X3DJSON.nodeUtil('Scene','DECLnode_nodeD_transform').addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].set_endB(X3DJSON.nodeUtil('Scene','DECLnode_nodeD_transform','translation'), __eventTime);
}, false);
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLcylinder_linkC_MoveCylinder'].set_endB(X3DJSON.nodeUtil('Scene','DECLnode_nodeD_transform','translation'), __eventTime);
			X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLnode_nodeA_MoveBall'].set_cycle(X3DJSON.nodeUtil('Scene','DECLnode_nodeA_nodeClock','cycleTime'), __eventTime);
			X3DJSON.nodeUtil('Scene','DECLnode_nodeA_NodePosition','keyValue',typeof X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLnode_nodeA_MoveBall'].keyValue === "function" ? X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLnode_nodeA_MoveBall'].keyValue() : X3DJSON['Obj']['Scene']['../data/forcenode.json']['DECLnode_nodeA_MoveBall'].keyValue, __eventTime);

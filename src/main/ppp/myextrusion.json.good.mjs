...
if (typeof X3DJSON['Scene../data/myextrusion.json'] === 'undefined') {
	X3DJSON['Scene../data/myextrusion.json'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/myextrusion.json'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/myextrusion.json'] = {};
}

X3DJSON['Script']['Scene']['../data/myextrusion.json']['MoveCylinder'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.json'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/myextrusion.json'] = {};
}

X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'] = new X3DJSON['Script']['Scene']['../data/myextrusion.json']['MoveCylinder']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder']['ACTION'],X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].initialize === "function") X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].initialize();
    if (X3DJSON.nodeUtil("Scene","TourTime")) {
X3DJSON.nodeUtil("Scene","TourTime").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].set_cycle(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].set_cycle(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder']['ACTION']['spine'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder']['ACTION']['spine'] = [];
}
X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder']['ACTION']['spine'].push(function(property, value) {
		if (property === 'spine') {
			X3DJSON.nodeUtil("Scene","myextrusion","spine",typeof X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].spine_changed === "function" ? X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].spine_changed() : X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].spine, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","myextrusion","spine",typeof X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].spine_changed === "function" ? X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].spine_changed() : X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].spine, __eventTime);
			X3DJSON['Obj']['Scene']['../data/myextrusion.json']['MoveCylinder'].set_cycle(X3DJSON.nodeUtil("Scene","TourTime","cycleTime"), __eventTime);

...
if (typeof X3DJSON['Scene../data/JinLipCornerDepressor.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinLipCornerDepressor.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinLipCornerDepressor").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Clock")) {
X3DJSON.nodeUtil("Scene","JinLipCornerDepressor_Clock").addEventListener('outputchange', function(event) {
}, false);
}

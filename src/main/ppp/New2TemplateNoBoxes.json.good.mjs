...
if (typeof X3DJSON['Scene../data/New2TemplateNoBoxes.json'] === 'undefined') {
	X3DJSON['Scene../data/New2TemplateNoBoxes.json'] = {};
}

    if (X3DJSON.nodeUtil("Scene","Toddler_Pitch012Interpolator")) {
X3DJSON.nodeUtil("Scene","Toddler_Pitch012Interpolator").addEventListener('outputchange', function(event) {
}, false);
}

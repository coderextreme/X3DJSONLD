...
if (typeof X3DJSON['Scene../data/JinFacsAu25LipsPartMorpher.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinFacsAu25LipsPartMorpher.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","ReversingClock").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","__4_MorphInterpolator")) {
X3DJSON.nodeUtil("Scene","__4_MorphInterpolator").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","__4_Clock")) {
X3DJSON.nodeUtil("Scene","__4_Clock").addEventListener('outputchange', function(event) {
}, false);
}

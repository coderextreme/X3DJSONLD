...
if (typeof X3DJSON['Scene../data/JinOuterBrowRaiser.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/JinOuterBrowRaiser.x3dj'] = {};
}
...
X3DJSON.nodeUtil("Scene","AnimationAdapter_JinOuterBrowRaiser").addEventListener('outputchange', function(event) {
    ...
    if (X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Clock")) {
X3DJSON.nodeUtil("Scene","JinOuterBrowRaiser_Clock").addEventListener('outputchange', function(event) {
}, false);
}

...
if (typeof X3DJSON['Scene../data/x3dconnectorProto.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/x3dconnectorProto.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/x3dconnectorProto.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/x3dconnectorProto.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/x3dconnectorProto.x3dj']['S1'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1'] = new X3DJSON['Script']['Scene']['../data/x3dconnectorProto.x3dj']['S1']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1']['ACTION'],X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1'].initialize === "function") X3DJSON['Obj']['Scene']['../data/x3dconnectorProto.x3dj']['S1'].initialize();

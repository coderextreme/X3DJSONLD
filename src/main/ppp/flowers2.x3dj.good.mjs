...
if (typeof X3DJSON['Scene../data/flowers2.x3dj'] === 'undefined') {
	X3DJSON['Scene../data/flowers2.x3dj'] = {};
}
...
if (typeof X3DJSON['Script']['Scene']['../data/flowers2.x3dj'] === 'undefined') {
X3DJSON['Script']['Scene']['../data/flowers2.x3dj'] = {};
}

X3DJSON['Script']['Scene']['../data/flowers2.x3dj']['OrbitScript'] = function() {
...
if (typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/flowers2.x3dj'] = {};
}

X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'] = new X3DJSON['Script']['Scene']['../data/flowers2.x3dj']['OrbitScript']();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'] = {};
}

if (typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']['ACTION'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']['ACTION'] = {};
X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].proxy = X3DJSON.createProxy(X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']['ACTION'],X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']);
}
if (typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].initialize === "function") X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].initialize();
if (typeof X3DJSON['Obj'] === 'undefined') {
X3DJSON['Obj'] = {};
}
if (typeof X3DJSON['Obj']['Scene'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']['ACTION']['coordIndexes'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']['ACTION']['coordIndexes'] = [];
}
X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']['ACTION']['coordIndexes'].push(function(property, value) {
		if (property === 'coordIndexes') {
			X3DJSON.nodeUtil("Scene","Orbit","coordIndex",typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordIndexes_changed === "function" ? X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordIndexes_changed() : X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordIndexes, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","Orbit","coordIndex",typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordIndexes_changed === "function" ? X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordIndexes_changed() : X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordIndexes, __eventTime);
if (typeof X3DJSON['Obj'] === 'undefined') {
...
if (typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']['ACTION']['coordinates'] === 'undefined') {
X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']['ACTION']['coordinates'] = [];
}
X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript']['ACTION']['coordinates'].push(function(property, value) {
		if (property === 'coordinates') {
			X3DJSON.nodeUtil("Scene","OrbitCoordinates","point",typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordinates_changed === "function" ? X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordinates_changed() : X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordinates, __eventTime);
		}
});
			X3DJSON.nodeUtil("Scene","OrbitCoordinates","point",typeof X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordinates_changed === "function" ? X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordinates_changed() : X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].coordinates, __eventTime);
    if (X3DJSON.nodeUtil("Scene","Clock")) {
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {
			X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].set_fraction(X3DJSON.nodeUtil("Scene","Clock","fraction"), __eventTime);
}, false);
}
			X3DJSON['Obj']['Scene']['../data/flowers2.x3dj']['OrbitScript'].set_fraction(X3DJSON.nodeUtil("Scene","Clock","fraction"), __eventTime);
    if (X3DJSON.nodeUtil("Scene","OrbitPath")) {
X3DJSON.nodeUtil("Scene","OrbitPath").addEventListener('outputchange', function(event) {
}, false);
}
    if (X3DJSON.nodeUtil("Scene","Clock")) {
X3DJSON.nodeUtil("Scene","Clock").addEventListener('outputchange', function(event) {

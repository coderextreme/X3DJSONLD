...
Someta11->setContent(QString("../Poses/images/HAnimPoseExampleKoreanCharacter05Ju.png"));
...
Someta15->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter05Ju.x3d"));
...
SoWorldInfo22->setTitle(QString("KoreanCharacter05Ju.x3d"));
...
SoViewpoint24->setDescription(QString("Ju"));
...
SoHAnimHumanoid25->X3DNode::setName(QString("Ju"));
SoHAnimHumanoid25->setDEF(QString("hanim_Ju"));
...
SoHAnimJoint33->setCenter(new float[]{0.0,36.0,-0.008798});
...
SoTransform35->setTranslation(new float[]{0.0,36.0,-0.008798});
...
SoImageTexture39->setDEF(QString("JuTextureAtlas"));
SoImageTexture39->setUrl(new QString[]{QString("images/Ju.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ju.png")}, 2);
...
SoHAnimJoint43->setCenter(new float[]{3.22,33.619999,-0.2832});
...
SoTransform45->setTranslation(new float[]{3.22,33.619999,-0.2832});
...
SoImageTexture49->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint53->setCenter(new float[]{3.454,18.67,-0.02158});
...
SoTransform55->setTranslation(new float[]{3.454,18.67,-0.02158});
...
SoImageTexture59->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint63->setCenter(new float[]{3.467,3.522,0.118});
...
SoTransform65->setTranslation(new float[]{3.467,3.522,0.118});
...
SoImageTexture69->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint73->setCenter(new float[]{3.467,3.251,1.465});
...
SoTransform75->setTranslation(new float[]{3.467,3.251,1.465});
...
SoImageTexture79->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint83->setCenter(new float[]{-3.22,33.619999,-0.2832});
...
SoTransform85->setTranslation(new float[]{-3.22,33.619999,-0.2832});
...
SoImageTexture89->setUSE(QString("JuTextureAtlas"));
...
SoCoordinate91->setPoint(new float[]{-2.617,2.231,0.2976,-1.527,2.231,2.592,0.9211,2.231,3.159,2.617,2.231,1.571,2.617,2.231,-1.571,0.9211,2.231,-3.159,-1.527,2.231,-2.29,-2.617,-1.238,0.2976,-1.527,-1.238,2.592,0.9211,-1.238,3.159,2.617,-1.238,1.571,2.617,-1.238,-0.9758,0.9211,-1.238,-3.009,-1.527,-1.238,-2.442,-2.617,-6.593,0.2976,-1.527,-6.593,2.58,0.9211,-6.593,3.147,2.617,-6.593,1.571,2.617,-6.593,-0.9758,0.9211,-6.593,-2.564,-1.527,-6.593,-1.997,-2.264,-11.92,0.2976,-1.321,-11.92,2.282,0.7969,-11.92,2.773,2.046,-11.92,1.399,2.046,-11.92,-0.8039,0.7969,-11.92,-2.177,-1.321,-11.92,-1.687,-1.864,4.073,0.2976,-1.058,4.073,1.995,0.7536,4.073,2.415,2.206,4.073,1.24,2.206,4.073,-0.6446,0.7536,4.073,-1.819,-1.058,4.073,-1.4,-1.033,-14.67,1.883,-1.786,-14.67,0.2976,0.6591,-14.67,2.275,1.657,-14.67,1.178,1.657,-14.67,-0.5825,0.6591,-14.67,-1.68,-1.033,-14.67,-1.288,-0.4256,-15.99,1.041,-0.7788,-15.99,0.2976,0.3682,-15.99,1.225,0.8362,-15.99,0.7104,0.8362,-15.99,-0.1152,0.3682,-15.99,-0.63,-0.4256,-15.99,-0.4463,0.1114,-16.17,0.2976}, 150);
SoIndexedFaceSet90->setCoord(*SoCoordinate91);

SoTextureCoordinate* SoTextureCoordinate92 = new SoTextureCoordinate();
SoTextureCoordinate92->setPoint(new float[]{0.7387,0.5078,0.7519,0.5078,0.7092,0.5078,0.6855,0.5078,0.6855,0.5078,0.7092,0.5078,0.7387,0.5078,0.7641,0.4868,0.7464,0.4472,0.7641,0.4472,0.7464,0.4868,0.7065,0.4472,0.7065,0.4868,0.6788,0.4472,0.6788,0.4868,0.6788,0.4472,0.6788,0.4868,0.7065,0.4472,0.7065,0.4868,0.7464,0.4472,0.7464,0.4868,0.7464,0.3861,0.7641,0.3861,0.7065,0.3861,0.6788,0.3861,0.6788,0.3861,0.7065,0.3861,0.7464,0.3861,0.743,0.3252,0.7584,0.3252,0.7085,0.3252,0.6882,0.3252,0.6882,0.3252,0.7085,0.3252,0.743,0.3252,0.7383,0.2938,0.7506,0.2938,0.7107,0.2938,0.6945,0.2938,0.6945,0.2938,0.7107,0.2938,0.7383,0.2938,0.7284,0.2787,0.7342,0.2787,0.7155,0.2787,0.7079,0.2787,0.7079,0.2787,0.7155,0.2787,0.7284,0.2787,0.7197,0.2768}, 100);
...
SoHAnimJoint93->setCenter(new float[]{-3.454,18.67,-0.02158});
...
SoTransform95->setTranslation(new float[]{-3.454,18.67,-0.02158});
...
SoImageTexture99->setUSE(QString("JuTextureAtlas"));
...
SoCoordinate101->setPoint(new float[]{-0.7406,0.9639,0.0216,-0.4117,0.9639,0.8655,0.3272,0.9639,1.036,0.9197,0.9639,0.5579,0.9197,0.9639,-0.3619,0.3272,0.9639,-0.8401,-0.4117,0.9639,-0.6694,-2.238,-4.201,0.0216,-1.426,-3.284,1.868,-1.219,-1.439,2.239,-2.036,-1.701,0.0216,0.6748,-3.284,2.375,0.6153,-1.439,2.686,2.01,-4.201,1.161,2.086,-1.701,0.9061,2.01,-4.913,-1.265,2.086,-1.701,-0.8628,0.6748,-4.913,-2.686,0.6153,-1.701,-2.191,-1.426,-4.913,-2.179,-1.219,-1.701,-1.744,-1.112,0.0646,1.755,-1.864,0.0646,0.0216,0.5772,0.0646,2.145,1.932,0.0646,1.051,1.932,0.0646,-0.8553,0.5772,0.0646,-1.907,-1.112,0.0646,-1.517,-2.345,-14.69,-0.0151,-1.416,-14.67,2.102,0.6712,-14.67,2.624,2.345,-14.69,1.16,2.345,-14.71,-1.342,0.6712,-14.71,-2.38,-1.416,-14.71,-1.857,-0.73,-16.18,0.0221,-0.4092,-16.17,0.7532,0.3118,-16.17,0.9337,0.89,-16.18,0.4278,0.89,-16.19,-0.4362,0.3118,-16.19,-0.7945,-0.4092,-16.19,-0.614}, 126);
SoIndexedFaceSet100->setCoord(*SoCoordinate101);

SoTextureCoordinate* SoTextureCoordinate102 = new SoTextureCoordinate();
SoTextureCoordinate102->setPoint(new float[]{0.7637,0.172,0.755,0.172,0.7356,0.172,0.72,0.172,0.72,0.172,0.7356,0.172,0.755,0.172,0.8032,0.2271,0.7818,0.2173,0.7763,0.1976,0.7978,0.2004,0.7264,0.2173,0.728,0.1976,0.6912,0.2271,0.6892,0.2004,0.6912,0.2347,0.6892,0.2004,0.7264,0.2347,0.728,0.2004,0.7818,0.2347,0.7763,
...
SoImageTexture119->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint123->setCenter(new float[]{0.000034,31.26,-0.008798});
...
SoTransform125->setTranslation(new float[]{0.000034,31.26,-0.008798});
...
SoImageTexture129->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint133->setCenter(new float[]{4.778,51.029999,-2.069});
...
SoTransform135->setTranslation(new float[]{4.778,51.029999,-2.069});
...
SoImageTexture139->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint143->setCenter(new float[]{5.297,40.119999,-2.055});
...
SoTransform145->setTranslation(new float[]{5.297,40.119999,-2.055});
...
SoImageTexture149->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint153->setCenter(new float[]{5.07,31.99,-1.559});
...
SoTransform155->setTranslation(new float[]{5.07,31.99,-1.559});
...
SoImageTexture159->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint163->setCenter(new float[]{-4.778,51.029999,-2.069});
...
SoTransform165->setTranslation(new float[]{-4.778,51.029999,-2.069});
...
SoImageTexture169->setUSE(QString("JuTextureAtlas"));
...
SoTextureCoordinate172->setPoint(new float[]{0.2661,0.1332,0.3717,0.1332,0.1245,0.1332,0.0067,0.1321,0.2119,0.1332,0.2707,0.1099,0.3728,0.1099,0.1275,0.1099,0.0049,0.1088,0.2167,0.1099,0.271,0.0284,0.3751,0.0284,0.1295,0.0284,0.0061,0.0273,0.2178,0.0284,0.2716,0.0086,0.3751,0.0086,0.1299,0.0086,0.0058,0.0075,0.2184,0.0086,0.2836,0.0426,0.3685,0.0426,0.1368,0.0426,0.0085,0.0415,0.2198,0.0426,0.0067,0.1343,0.0084,0.111,0.0084,0.111,0.0073,0.0295,0.0073,0.0295,0.0076,0.0097,0.0076,0.0097,0.0065,0.0437,0.6285,0.3174,0.6285,0.3316,0.6285,0.3312,0.6285,0.3167,0.6285,0.3082,0.5864,0.3116,0.5864,0.3376,0.6087,0.339,0.6087,0.3139,0.5864,0.3394,0.6087,0.3383,0.5864,0.3146,0.6087,0.3128,0.5864,0.2974,0.6087,0.2977,0.6261,0.339,0.6261,0.3148,0.6261,0.3383,0.6261,0.3137,0.6261,0.2992,0.0441,0.1287,-0.1162,0.128}, 110);
...
SoHAnimJoint173->setCenter(new float[]{-5.297,40.119999,-2.055});
...
SoTransform175->setTranslation(new float[]{-5.297,40.119999,-2.055});
...
SoImageTexture179->setUSE(QString("JuTextureAtlas"));
...
SoCoordinate181->setPoint(new float[]{-0.1284,0.6566,-0.794,-0.7947,0.6566,-0.1619,-0.4154,0.6566,0.757,0.4852,0.6566,0.6929,0.6626,0.6566,-0.2657,-0.0855,-0.4623,-1.129,-1.027,-0.4623,-0.281,-0.4911,-0.4623,1.171,0.7817,-0.4623,1.07,1.032,-0.4623,-0.445,-0.0941,-3.046,-1.116,-1.1,-3.046,-0.2777,-0.55,-2.481,1.16,0.8091,-2.481,1.06,1.1,-3.046,-0.4401,-0.084,-8.01,-1.171,-1.025,-7.982,-0.1359,-0.3907,-8.118,1.09,0.6003,-8.118,0.9957,0.9132,-8.109,-0.2244,-0.0434,-8.725,-0.6054,-0.5441,-8.725,0.0272,-0.2591,-8.725,0.759,0.4177,-8.725,0.6949,0.551,-8.725,-0.0767}, 75);
SoIndexedFaceSet180->setCoord(*SoCoordinate181);

SoTextureCoordinate* SoTextureCoordinate182 = new SoTextureCoordinate();
SoTextureCoordinate182->setPoint(new float[]{0.5159,0.3385,0.5159,0.3244,0.5159,0.3332,0.5159,0.3157,0.5159,0.3103,0.521,0.3428,0.521,0.3229,0.521,0.3355,0.521,0.3108,0.521,0.3029,0.5327,0.3442,0.5327,0.3231,0.5302,0.3366,0.5302,0.3103,0.5327,0.3016,0.5558,0.339,0.5558,0.323,0.5558,0.3334,0.5558,0.3141,0.5558,0.3079,0.5585,0.3232,0.5585,0.3341,0.5585,0.3302,0.5585,0.317,0.5585,0.3129}, 50);
...
SoHAnimJoint183->setCenter(new float[]{-5.07,31.99,-1.559});
...
SoTransform185->setTranslation(new float[]{-5.07,31.99,-1.559});
...
SoImageTexture189->setUSE(QString("JuTextureAtlas"));
...
SoCoordinate191->setPoint(new float[]{-0.8732,0.4437,0.6298,-0.8463,0.4584,-1.065,0.5135,0.3661,0.7037,0.5196,0.3675,-1.013,0.6654,-0.1688,1.167,-1.16,0.015,1.096,-1.119,0.0434,-1.571,0.747,-0.1537,-1.566,0.5777,-1.832,1.902,-1.387,-1.647,1.643,-1.345,-1.619,-1.902,0.8391,-1.916,-1.775,0.3897,-3.083,1.338,-0.6425,-3.283,1.382,-0.6009,-3.255,-1.636,0.5412,-3.094,-1.527,0.742,-0.1555,-0.1478,1.159,-1.873,1.533,1.387,-0.4699,0.0458,1.361,-0.5281,1.488,1.163,-1.872,0.1088,0.7494,-1.912,-0.1591}, 66);
SoIndexedFaceSet190->setCoord(*SoCoordinate191);

SoTextureCoordinate* SoTextureCoordinate192 = new SoTextureCoordinate();
SoTextureCoordinate192->setPoint(new float[]{0.4675,0.2229,0.4534,0.3224,0.4709,0.3268,0.4579,0.2308,0.5552,0.233,0.5504,0.3288,0.6215,0.2576,0.6159,0.3282,0.478,0.1884,0.5527,0.2007,0.4618,0.1862,0.4629,0.1191,0.4583,0.192,0.4802,0.0435,0.4672,0.0405,0.5177,0.1794,0.4789,0.1246,0.4811,0.1812,0.515,0.132,0.538,0.1232,0.5459,0.0341,0.5348,0.1824,0.6006,0.1887,0.5977,0.0452,0.6323,0.1888,0.629,0.0403,0.4501,0.1899,0.4535,0.0388,0.5577,0.3108,0.5496,0.3395,0.5573,0.3333,0.5503,0.3041,0.5263,0.3468,0.527,0.2997,0.5106,0.3433,0.5113,0.3032,0.4584,0.3225,0.4544,0.2224,0.4607,0.2253,0.4525,0.325,0.5365,0.3334,0.5532,0.2053,0.6323,0.3251,0.6179,0.2145}, 88);
...
SoHAnimJoint193->setCenter(new float[]{0.000025,39.84,0.1163});
...
SoTransform195->setTranslation(new float[]{0.000025,39.84,0.1163});
...
SoImageTexture199->setUSE(QString("JuTextureAtlas"));
...
SoHAnimJoint203->setCenter(new float[]{0.000025,56.07,-1.554});
...
SoTransform205->setTranslation(new float[]{0.000025,56.07,-1.554});
...
SoImageTexture209->setUSE(QString("JuTextureAtlas"));
...
SoEXPORT231->setAS(QString("KoreanCharacter05Ju"));
SoEXPORT231->setLocalDEF(QString("hanim_Ju"));

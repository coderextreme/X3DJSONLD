...
Someta2->setContent(QString("arc3.x3d"));
...
SoGroup51->setUSE(QString("DECLpoint_G1_node"));
Sofield50->addChild(*SoGroup51);

SoScript49->addChild(*Sofield50);

Sofield* Sofield52 = new Sofield();
Sofield52->setName(QString("endnode"));
Sofield52->setAccessType(QString("initializeOnly"));
Sofield52->setType(QString("SFNode"));
SoGroup* SoGroup53 = new SoGroup();
SoGroup53->setUSE(QString("DECLpoint_G2_node"));
Sofield52->addChild(*SoGroup53);
...
SoROUTE60->setFromNode(QString("DECLpoint_G1_node"));
SoROUTE60->setFromField(QString("translation"));
SoROUTE60->setToNode(QString("DECLx3dconnector_connector1_S1"));
SoROUTE60->setToField(QString("set_startpoint"));
SoNode7->addChild(*SoROUTE60);

SoROUTE* SoROUTE61 = new SoROUTE();
SoROUTE61->setFromNode(QString("DECLpoint_G2_node"));
SoROUTE61->setFromField(QString("translation"));
SoROUTE61->setToNode(QString("DECLx3dconnector_connector1_S1"));
SoROUTE61->setToField(QString("set_endpoint"));
SoNode7->addChild(*SoROUTE61);

...
Someta3->setContent(QString("JinOriginalLOA1.x3d"));
...
Someta14->setContent(QString("JinLOA1.x3d"));
...
Someta16->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA1.x3d"));
...
SoWorldInfo21->setTitle(QString("JinOriginalLOA1.x3d"));
...
SoViewpoint23->setDescription(QString("JinLOA1"));
...
SoHAnimHumanoid24->setDEF(QString("hanim_JinLOA1"));
SoHAnimHumanoid24->X3DNode::setName(QString("JinLOA1"));
SoHAnimHumanoid24->setLoa(1);
...
SoMetadataFloat31->X3DNode::setName(QString("weight"));
SoMetadataFloat31->setValue(new float[]{50.0}, 1);
SoMetadataSet25->setValue((X3DNode *)&SoMetadataFloat31);

SoMetadataString* SoMetadataString32 = new SoMetadataString();
SoMetadataString32->X3DNode::setName(QString("humanoidVersion"));
SoMetadataString32->setValue(new QString[]{QString("validation testing")}, 1);
SoMetadataSet25->setValue((X3DNode *)&SoMetadataString32);
...
SoHAnimJoint33->setCenter(new float[]{0.0,30.53,-0.7076});
...
SoTransform35->setTranslation(new float[]{0.0,30.53,-0.7076});
...
SoImageTexture39->setDEF(QString("JinLOA1TextureAtlas"));
SoImageTexture39->setUrl(new QString[]{QString("images/Jin.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Jin.png")}, 2);
...
SoIndexedFaceSet40->setCreaseAngle(3.14159);
...
SoHAnimJoint43->setDEF(QString("hanim_sacroiliac"));
SoHAnimJoint43->X3DNode::setName(QString("sacroiliac"));
SoHAnimJoint43->setCenter(new float[]{0.0,35.8,-0.7076});
SoHAnimSegment* SoHAnimSegment44 = new SoHAnimSegment();
SoHAnimSegment44->setDEF(QString("hanim_pelvis"));
SoHAnimSegment44->X3DNode::setName(QString("pelvis"));
SoTransform* SoTransform45 = new SoTransform();
SoTransform45->setTranslation(new float[]{0.0,35.8,-0.7076});
...
SoImageTexture49->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet50->setCreaseAngle(3.14159);
...
SoTextureCoordinate51->setPoint(new float[]{0.6211,0.5754,0.7851,0.572,0.7614,0.572,0.6907,0.5698,0.62,0.5698,0.6158,0.5702,0.5451,0.5702,0.4167,0.5698,0.5451,0.5702,0.6158,0.5702,0.62,0.5698,0.6907,0.5698,0.7614,0.572,0.8036,0.5346,0.7761,0.5346,0.6989,0.4838,0.6219,0.4428,0.6154,0.4438,0.5492,0.4639,0.4166,0.5346,0.5492,0.4639,0.6154,0.4438,0.6219,0.4428,0.6989,0.4838,0.7761,0.5346,0.7912,0.4044,0.7635,0.4044,0.7042,0.3925,0.6194,0.3907,0.6148,0.3907,0.545,0.3974,0.4163,0.4938,0.545,0.3974,0.6148,0.3907,0.6194,0.3907,0.7042,0.3925,0.7635,0.4044,0.795,0.3772,0.7662,0.3772,0.6945,0.3645,0.6236,0.3695,0.616,0.3695,0.5438,0.378,0.416,0.453,0.5438,0.378,0.616,0.3695,0.6236,0.3695,0.6945,0.3645,0.7662,0.3772,0.7887,0.3451,0.7635,0.3451,0.698,0.3508,0.6262,0.3508,0.6297,0.3503,0.5389,0.3503,0.4181,0.3884,0.5389,0.3503,0.6297,0.3503,0.6262,0.3508,0.698,0.3508,0.7635,0.3451,0.6237,0.3398}, 124);
SoIndexedFaceSet50->setTexCoord(*SoTextureCoordinate51);

SoCoordinate* SoCoordinate52 = new SoCoordinate();
SoCoordinate52->setPoint(new float[]{0.0,1.053,0.0273,0.0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.875,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0.0,0.9123,0.596,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.875,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0.0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.98,0.5267,-0.4285,-1.132,0.5267,0.0273,-0.98,0.5267,0.483,-0.5658,0.5267,0.6985,0.0,0.5267,0.8206,0.5658,0.5267,0.6985,0.98,0.5267,0.483,1.132,0.5267,0.0273,0.98,0.5267,-0.4285,0.5658,0.5267,-0.7621,0.0,0.0,-0.9616,-0.6534,0.0,-0.8206,-1.132,0.0,-0.4353,-1.307,0.0,0.0273,-1.132,0.0,0.5536,-0.6534,0.0,0.8206,0.0,0.0,0.9616,0.6534,0.0,0.8206,1.132,0.0,0.5536,1.307,0.0,0.0273,1.132,0.0,-0.4353,0.6534,0.0,-0.8206,0.0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.98,-0.5267,-0.3648,-1.132,-0.5267,0.0273,-0.98,-0.5267,0.483,-0.5658,-0.5267,0.6985,0.0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.98,-0.5267,0.483,1.132,-0.5267,0.0273,0.98,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0.0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.483,0.0,-0.9123,0.5536,0.3267,-0.9123,0.483,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0.0,-1.053,0.0273}, 186);
SoIndexedFaceSet50->setCoord(*SoCoordinate52);
...
SoHAnimJoint53->setDEF(QString("hanim_l_hip"));
SoHAnimJoint53->X3DNode::setName(QString("l_hip"));
SoHAnimJoint53->setCenter(new float[]{4.207,32.02,-0.8155});
SoHAnimSegment* SoHAnimSegment54 = new SoHAnimSegment();
SoHAnimSegment54->setDEF(QString("hanim_l_thigh"));
SoHAnimSegment54->X3DNode::setName(QString("l_thigh"));
SoTransform* SoTransform55 = new SoTransform();
SoTransform55->setTranslation(new float[]{4.207,32.02,-0.8155});
...
SoImageTexture59->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet60->setCreaseAngle(3.14159);
...
SoIndexedFaceSet60->setCoord(*SoCoordinate62);
...
SoHAnimJoint63->setDEF(QString("hanim_l_knee"));
SoHAnimJoint63->X3DNode::setName(QString("l_knee"));
SoHAnimJoint63->setCenter(new float[]{4.116,17.26,-0.8639});
SoHAnimSegment* SoHAnimSegment64 = new SoHAnimSegment();
SoHAnimSegment64->setDEF(QString("hanim_l_calf"));
SoHAnimSegment64->X3DNode::setName(QString("l_calf"));
SoTransform* SoTransform65 = new SoTransform();
SoTransform65->setTranslation(new float[]{4.116,17.26,-0.8639});
...
SoImageTexture69->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet70->setCreaseAngle(3.14159);
...
SoTextureCoordinate71->setPoint(new float[]{0.9309,0.5848,0.919,0.5848,0.8921,0.5848,0.8706,0.5848,0.8706,0.5848,0.8921,0.5848,0.919,0.5848,0.9845,0.5321,0.955,0.5475,0.9491,0.5599,0.9788,0.5571,0.8787,0.5475,0.8825,0.5599,0.8302,0.5321,0.8291,0.5571,0.8302,0.52,0.8291,0.5571,0.8787,0.52,0.8825,0.5571,0.955,0.52,0.9491,0.5571,0.9444,0.5755,0.9717,0.5755,0.8831,0.5755,0.8339,0.5755,0.8339,0.5755,0.8831,0.5755,0.9444,0.5755,0.9679,0.2444,0.9449,0.2445,0.8931,0.2445,0.8516,0.2444,0.8516,0.2442,0.8931,0.2442,0.9449,0.2442,0.9372,0.2243,0.9255,0.2244,0.8993,0.2244,0.8783,0.2243,0.8783,0.2243,0.8993,0.2243,0.9255,0.2243}, 84);
SoIndexedFaceSet70->setTexCoord(*SoTextureCoordinate71);

SoCoordinate* SoCoordinate72 = new SoCoordinate();
SoCoordinate72->setPoint(new float[]{0.7186,0.9688,0.0234,0.3632,0.9688,0.9354,-0.4353,0.9688,1.12,-1.076,0.9688,0.603,-1.076,0.9688,-0.3911,-0.4353,0.9688,-0.9079,0.3632,0.9688,-0.7235,2.337,-4.613,0.0234,1.46,-3.622,2.019,1.236,-1.628,2.42,2.118,-1.912,0.0234,-0.8111,-3.622,2.567,-0.7468,-1.628,2.903,-2.254,-4.613,1.255,-2.337,-1.912,0.9793,-2.254,-5.383,-1.368,-2.337,-1.912,-0.9325,-0.8111,-5.383,-2.903,-0.7468,-1.912,-2.368,1.46,-5.383,-2.355,1.236,-1.912,-1.885,1.121,-0.0032,1.896,1.933,-0.0032,0.0234,-0.7056,-0.0032,2.318,-2.17,-0.0032,1.136,-2.17,-0.0032,-0.9244,-0.7056,-0.0032,-2.061,1.121,-0.0032,-1.64,1.607,-12.92,0.0032,0.9216,-12.91,1.565,-0.619,-12.91,1.951,-1.854,-12.92,0.8701,-1.854,-12.94,-0.9762,-0.619,-12.94,-1.742,0.9216,-12.94,-1.356,0.7072,-14.53,0.0239,0.3604,-14.53,0.814,-0.4188,-14.53,1.009,-1.044,-14.53,0.4624,-1.044,-14.54,-0.4714,-0.4188,-14.54,-0.8587,0.3604,-14.54,-0.6635}, 126);
SoIndexedFaceSet70->setCoord(*SoCoordinate72);
...
SoHAnimJoint73->setDEF(QString("hanim_l_talocrural"));
SoHAnimJoint73->X3DNode::setName(QString("l_talocrural"));
SoHAnimJoint73->setCenter(new float[]{3.854,3.939,-0.7038});
SoHAnimSegment* SoHAnimSegment74 = new SoHAnimSegment();
SoHAnimSegment74->setDEF(QString("hanim_l_talus"));
SoHAnimSegment74->X3DNode::setName(QString("l_talus"));
SoTransform* SoTransform75 = new SoTransform();
SoTransform75->setTranslation(new float[]{3.854,3.939,-0.7038});
...
SoImageTexture79->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet80->setCreaseAngle(3.14159);
...
SoHAnimJoint83->setDEF(QString("hanim_l_metatarsophalangeal_2"));
SoHAnimJoint83->X3DNode::setName(QString("l_metatarsophalangeal_2"));
SoHAnimJoint83->setCenter(new float[]{3.854,3.64,0.7402});
SoHAnimSegment* SoHAnimSegment84 = new SoHAnimSegment();
SoHAnimSegment84->setDEF(QString("hanim_l_tarsal_proximal_phalanx_2"));
SoHAnimSegment84->X3DNode::setName(QString("l_tarsal_proximal_phalanx_2"));
SoTransform* SoTransform85 = new SoTransform();
SoTransform85->setTranslation(new float[]{3.854,3.64,0.7402});
...
SoImageTexture89->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet90->setCreaseAngle(3.14159);
...
SoHAnimJoint73->addChildren(*SoHAnimJoint83);
...
SoHAnimJoint93->setDEF(QString("hanim_r_hip"));
SoHAnimJoint93->X3DNode::setName(QString("r_hip"));
SoHAnimJoint93->setCenter(new float[]{-4.207,32.02,-0.8155});
SoHAnimSegment* SoHAnimSegment94 = new SoHAnimSegment();
SoHAnimSegment94->setDEF(QString("hanim_r_thigh"));
SoHAnimSegment94->X3DNode::setName(QString("r_thigh"));
SoTransform* SoTransform95 = new SoTransform();
SoTransform95->setTranslation(new float[]{-4.207,32.02,-0.8155});
...
SoImageTexture99->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet100->setCreaseAngle(3.14159);
...
SoIndexedFaceSet100->setTexCoord(*SoTextureCoordinate101);

SoCoordinate* SoCoordinate102 = new SoCoordinate();
SoCoordinate102->setPoint(new float[]{-2.96,3.738,0.0,-1.643,3.738,3.209,1.316,3.738,4.002,3.367,3.738,1.781,3.367,3.738,-1.781,1.316,3.738,-4.002,-1.643,3.738,-3.209,-2.96,-0.0114,0.0,-1.643,-0.0114,3.209,1.316,-0.0114,4.002,3.367,-0.0114,1.781,3.367,-0.0114,-1.781,1.316,-0.0114,-4.002,-1.643,-0.0114,-3.209,-2.96,-6.507,0.0,-1.643,-6.507,3.209,1.316,-6.507,4.002,3.367,-6.507,1.781,3.367,-6.507,-1.781,1.316,-6.507,-4.002,-1.643,-6.507,-3.209,-3.367,-13.13,0.0,-1.897,-13.13,3.582,1.407,-13.13,4.467,3.355,-13.13,1.988,3.355,-13.13,-1.988,1.407,-13.13,-4.467,-1.897,-13.13,-3.582,-2.146,-4.985,0.0,-1.136,-4.985,2.462,1.135,-4.985,3.07,2.633,-4.985,1.366,2.633,-4.985,-1.366,1.135,-4.985,-3.07,-1.136,-4.985,-2.462,-2.156,-11.45,0.0,-1.225,-11.45,1.956,0.8662,-11.45,2.439,2.543,-11.45,1.085,2.543,-11.45,-1.085,0.8662,-11.45,-2.439,-1.225,-11.45,-1.956,-2.051,5.729,0.0,-1.076,5.729,2.375,1.114,5.729,2.961,2.87,5.729,1.318,2.87,5.729,-1.318,1.114,5.729,-2.961,-1.076,5.729,-2.375,-1.842,-15.12,0.0,-1.03,-15.12,1.873,0.7965,-15.12,2.295,2.261,-15.12,1.113,2.261,-15.12,-0.9478,0.7965,-15.12,-2.13,-1.03,-15.12,-1.708,-0.6277,-16.1,0.0,-0.2723,-16.1,0.912,0.5262,-16.1,1.096,1.167,-16.1,0.5796,1.167,-16.1,-0.4145,0.5262,-16.1,-0.9313,-0.2723,-16.1,-0.7469}, 189);
SoIndexedFaceSet100->setCoord(*SoCoordinate102);
...
SoHAnimJoint103->setDEF(QString("hanim_r_knee"));
SoHAnimJoint103->X3DNode::setName(QString("r_knee"));
SoHAnimJoint103->setCenter(new float[]{-4.116,17.26,-0.8639});
SoHAnimSegment* SoHAnimSegment104 = new SoHAnimSegment();
SoHAnimSegment104->setDEF(QString("hanim_r_calf"));
SoHAnimSegment104->X3DNode::setName(QString("r_calf"));
SoTransform* SoTransform105 = new SoTransform();
SoTransform105->setTranslation(new float[]{-4.116,17.26,-0.8639});
...
SoImageTexture109->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet110->setCreaseAngle(3.14159);
...
SoTextureCoordinate111->setPoint(new float[]{0.9309,0.5848,0.919,0.5848,0.8921,0.5848,0.8706,0.5848,0.8706,0.5848,0.8921,0.5848,0.919,0.5848,0.9845,0.5321,0.955,0.5475,0.9491,0.5599,0.9788,0.5571,0.8787,0.5475,0.8825,0.5599,0.8302,0.5321,0.8291,0.5571,0.8302,0.52,0.8291,0.5571,0.8787,0.52,0.8825,0.5571,0.955,0.52,0.9491,0.5571,0.9444,0.5755,0.9717,0.5755,0.8831,0.5755,0.8339,0.5755,0.8339,0.5755,0.8831,0.5755,0.9444,0.5755,0.9679,0.2444,0.9449,0.2445,0.8931,0.2445,0.8516,0.2444,0.8516,0.2442,0.8931,0.2442,0.9449,0.2442,0.9372,0.2243,0.9255,0.2244,0.8993,0.2244,0.8783,0.2243,0.8783,0.2243,0.8993,0.2243,0.9255,0.2243}, 84);
SoIndexedFaceSet110->setTexCoord(*SoTextureCoordinate111);

SoCoordinate* SoCoordinate112 = new SoCoordinate();
SoCoordinate112->setPoint(new float[]{-0.7186,0.9688,0.0234,-0.3632,0.9688,0.9354,0.4353,0.9688,1.12,1.076,0.9688,0.603,1.076,0.9688,-0.3911,0.4353,0.9688,-0.9079,-0.3632,0.9688,-0.7235,-2.337,-4.613,0.0234,-1.46,-3.622,2.019,-1.236,-1.628,2.42,-2.118,-1.912,0.0234,0.8111,-3.622,2.567,0.7468,-1.628,2.903,2.254,-4.613,1.255,2.337,-1.912,0.9793,2.254,-5.383,-1.368,2.337,-1.912,-0.9325,0.8111,-5.383,-2.903,0.7468,-1.912,-2.368,-1.46,-5.383,-2.355,-1.236,-1.912,-1.885,-1.121,-0.0032,1.896,-1.933,-0.0032,0.0234,0.7056,-0.0032,2.318,2.17,-0.0032,1.136,2.17,-0.0032,-0.9244,0.7056,-0.0032,-2.061,-1.121,-0.0032,-1.64,-1.607,-12.92,0.0032,-0.9216,-12.91,1.565,0.619,-12.91,1.951,1.854,-12.92,0.8701,1.854,-12.94,-0.9762,0.619,-12.94,-1.742,-0.9216,-12.94,-1.356,-0.7072,-14.53,0.0239,-0.3604,-14.53,0.814,0.4188,-14.53,1.009,1.044,-14.53,0.4624,1.044,-14.54,-0.4714,0.4188,-14.54,-0.8587,-0.3604,-14.54,-0.6635}, 126);
SoIndexedFaceSet110->setCoord(*SoCoordinate112);
...
SoHAnimJoint113->setDEF(QString("hanim_r_talocrural"));
SoHAnimJoint113->X3DNode::setName(QString("r_talocrural"));
SoHAnimJoint113->setCenter(new float[]{-3.854,3.939,-0.7038});
SoHAnimSegment* SoHAnimSegment114 = new SoHAnimSegment();
SoHAnimSegment114->setDEF(QString("hanim_r_talus"));
SoHAnimSegment114->X3DNode::setName(QString("r_talus"));
SoTransform* SoTransform115 = new SoTransform();
SoTransform115->setTranslation(new float[]{-3.854,3.939,-0.7038});
...
SoImageTexture119->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet120->setCreaseAngle(3.14159);
...
SoTextureCoordinate121->setPoint(new float[]{0.3819,0.171,0.4216,0.1651,0.3819,0.171,0.4216,0.1651,0.3819,0.171,0.3819,0.171,0.4637,0.1714,0.4216,0.1651,0.4637,0.1714,0.4216,0.1651,0.3819,0.171,0.3819,0.171,0.3819,0.171,0.3819,0.171,0.4637,0.1714,0.4637,0.1714,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.3836,0.1404,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4394,0.1472,0.4637,0.1714,0.4394,0.1472,0.4244,0.1312,0.3861,0.1398,0.3873,0.0706,0.3871,0.0221,0.3873,0.0706,0.3871,0.0221,0.3871,0.0221,0.3861,0.1398,0.3836,0.1404,0.3873,0.0706,0.3873,0.0706,0.3836,0.1404,0.3861,0.1398,0.3871,0.0221,0.3871,0.0221,0.3871,0.0221,0.433,0.0595,0.4411,0.0186,0.4244,0.1312,0.433,0.0595,0.4244,0.1312,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.3861,0.1398,0.3836,0.1404,0.3861,0.1398,0.4244,0.1312,0.4244,0.1312,0.4411,0.0186,0.433,0.0595,0.4244,0.1312,0.4244,0.1312,0.433,0.0595,0.4411,0.0186,0.4411,0.0186}, 132);
SoIndexedFaceSet120->setTexCoord(*SoTextureCoordinate121);

SoCoordinate* SoCoordinate122 = new SoCoordinate();
SoCoordinate122->setPoint(new float[]{-0.9768,-0.0192,-1.681,-1.657,-0.0192,0.4309,0.0,-0.0192,-1.681,-1.403,0.7316,0.354,-0.8174,0.7316,-1.463,0.0,0.7316,-1.463,0.0,0.7316,1.471,1.657,-0.0192,0.4309,1.403,0.7316,0.354,0.8174,0.7316,-1.463,0.9768,-0.0192,-1.681,0.0,-0.0192,1.75,-1.109,-0.6007,-2.046,-2.045,-0.6007,0.4309,-1.695,-0.296,1.429,0.0,-0.6007,-2.046,1.109,-0.6007,-2.046,2.045,-0.6007,0.4309,1.695,-0.296,1.429,0.0,-1.207,-1.841,-1.023,-1.207,-1.841,-1.913,-1.223,0.5161,-1.601,-0.9325,1.406,0.0,-0.6582,1.708,1.601,-0.9325,1.406,1.913,-1.223,0.5161,1.023,-1.207,-1.841,-1.409,-1.925,-2.878,-1.409,-3.947,-1.681,0.0,-3.947,-1.681,-1.109,-0.6007,-2.046,0.0,-0.6007,-2.046,1.409,-1.925,-2.878,0.0,-1.925,-2.878,1.109,-0.6007,-2.046,1.409,-3.947,-1.681,-2.927,-1.925,0.4309,-2.089,-3.947,0.4309,-2.045,-0.6007,0.4309,2.927,-1.925,0.4309,2.045,-0.6007,0.4309,2.089,-3.947,0.4309,0.0,-3.947,0.4309,-0.9442,-0.3153,-1.692,0.0,-0.3153,-1.692,0.9442,-0.3153,-1.692,1.7,-0.3153,0.3093,-1.7,-0.3153,0.3093,-1.86,-3.793,1.364,-2.541,-1.963,1.364,-1.861,-0.9431,1.364,1.861,-0.9431,1.364,2.541,-1.963,1.364,1.86,-3.793,1.364,0.0,-3.793,1.364}, 165);
SoIndexedFaceSet120->setCoord(*SoCoordinate122);
...
SoHAnimJoint123->setDEF(QString("hanim_r_metatarsophalangeal_2"));
SoHAnimJoint123->X3DNode::setName(QString("r_metatarsophalangeal_2"));
SoHAnimJoint123->setCenter(new float[]{-3.854,3.64,0.7402});
SoHAnimSegment* SoHAnimSegment124 = new SoHAnimSegment();
SoHAnimSegment124->setDEF(QString("hanim_r_tarsal_proximal_phalanx_2"));
SoHAnimSegment124->X3DNode::setName(QString("r_tarsal_proximal_phalanx_2"));
SoTransform* SoTransform125 = new SoTransform();
SoTransform125->setTranslation(new float[]{-3.854,3.64,0.7402});
...
SoImageTexture129->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet130->setCreaseAngle(3.14159);
...
SoTextureCoordinate131->setPoint(new float[]{0.433,0.0595,0.4411,0.0186,0.4637,0.1714,0.4411,0.0186,0.4244,0.1312,0.4394,0.1472,0.433,0.0595,0.4244,0.1312,0.4411,0.0186,0.4637,0.1714,0.4394,0.1472,0.4411,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4949,0.0186,0.4868,0.1432,0.4868,0.1432,0.433,0.0595,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.433,0.0595,0.4244,0.1312,0.4244,0.1312,0.532,0.098,0.5645,0.0707,0.4885,0.102,0.5026,0.044,0.5945,0.0186,0.5487,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4868,0.1432,0.5645,0.0707,0.5026,0.044,0.4885,0.102,0.532,0.098,0.5945,0.0186,0.5487,0.0186,0.464,0.1246,0.4607,0.0558,0.4904,0.0166,0.5487,0.0186,0.4949,0.0186,0.4868,0.1432}, 106);
SoIndexedFaceSet130->setTexCoord(*SoTextureCoordinate131);

SoCoordinate* SoCoordinate132 = new SoCoordinate();
SoCoordinate132->setPoint(new float[]{-2.927,-1.627,-1.013,-2.089,-3.648,-1.013,0.0,0.2797,0.3064,-2.045,-0.3017,-1.013,-1.695,0.0029,-0.0151,2.927,-1.627,-1.013,2.045,-0.3017,-1.013,2.089,-3.648,-1.013,1.695,0.0029,-0.0151,0.0,-3.648,-1.013,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0.0,-3.648,0.9192,0.0,-0.0274,1.661,-2.405,-1.656,-1.915,-1.75,-2.942,-1.915,0.0,-2.942,-1.915,1.75,-2.942,-1.915,2.405,-1.656,-1.915,1.742,-0.5681,-1.915,-1.742,-0.5681,-1.915,-1.784,-0.648,2.332,-2.216,-2.267,4.144,-2.216,-3.648,3.776,0.0,-2.267,5.463,0.0,-0.5463,3.95,-1.74,-0.3226,1.158,-2.661,-1.866,0.9192,-2.14,-3.648,0.9192,2.216,-2.267,4.144,1.784,-0.648,2.332,0.0,-3.648,5.096,2.216,-3.648,3.776,1.74,-0.3226,1.158,2.661,-1.866,0.9192,2.14,-3.648,0.9192,0.0,-3.648,3.776,0.0,-3.648,0.9192,0.0,-0.0274,1.661}, 129);
SoIndexedFaceSet130->setCoord(*SoCoordinate132);
...
SoHAnimJoint113->addChildren(*SoHAnimJoint123);

SoHAnimJoint103->addChildren(*SoHAnimJoint113);

SoHAnimJoint93->addChildren(*SoHAnimJoint103);

SoHAnimJoint43->addChildren(*SoHAnimJoint93);

SoHAnimJoint33->addChildren(*SoHAnimJoint43);

SoHAnimJoint* SoHAnimJoint133 = new SoHAnimJoint();
SoHAnimJoint133->setDEF(QString("hanim_vl5"));
SoHAnimJoint133->X3DNode::setName(QString("vl5"));
SoHAnimJoint133->setCenter(new float[]{0.0,40.07,-0.8527});
SoHAnimSegment* SoHAnimSegment134 = new SoHAnimSegment();
SoHAnimSegment134->setDEF(QString("hanim_l5"));
SoHAnimSegment134->X3DNode::setName(QString("l5"));
SoTransform* SoTransform135 = new SoTransform();
SoTransform135->setTranslation(new float[]{0.0,40.07,-0.8527});
...
SoImageTexture139->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet140->setCreaseAngle(3.14159);
...
SoHAnimJoint143->setDEF(QString("hanim_skullbase"));
SoHAnimJoint143->X3DNode::setName(QString("skullbase"));
SoHAnimJoint143->setCenter(new float[]{0.0,57.43,-0.6863});
SoHAnimSegment* SoHAnimSegment144 = new SoHAnimSegment();
SoHAnimSegment144->setDEF(QString("hanim_skull"));
SoHAnimSegment144->X3DNode::setName(QString("skull"));
SoTransform* SoTransform145 = new SoTransform();
SoTransform145->setTranslation(new float[]{0.0,57.43,-0.6863});
...
SoImageTexture149->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet150->setCreaseAngle(3.14159);
...
SoHAnimJoint153->setDEF(QString("hanim_l_shoulder"));
SoHAnimJoint153->X3DNode::setName(QString("l_shoulder"));
SoHAnimJoint153->setCenter(new float[]{5.975,52.0,-0.1452});
SoHAnimSegment* SoHAnimSegment154 = new SoHAnimSegment();
SoHAnimSegment154->setDEF(QString("hanim_l_upperarm"));
SoHAnimSegment154->X3DNode::setName(QString("l_upperarm"));
SoTransform* SoTransform155 = new SoTransform();
SoTransform155->setTranslation(new float[]{5.975,52.0,-0.1452});
...
SoImageTexture159->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet160->setCreaseAngle(3.14159);
...
SoHAnimJoint163->setDEF(QString("hanim_l_elbow"));
SoHAnimJoint163->X3DNode::setName(QString("l_elbow"));
SoHAnimJoint163->setCenter(new float[]{8.093,40.38,-0.2502});
SoHAnimSegment* SoHAnimSegment164 = new SoHAnimSegment();
SoHAnimSegment164->setDEF(QString("hanim_l_forearm"));
SoHAnimSegment164->X3DNode::setName(QString("l_forearm"));
SoTransform* SoTransform165 = new SoTransform();
SoTransform165->setTranslation(new float[]{8.093,40.38,-0.2502});
...
SoImageTexture169->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet170->setCreaseAngle(3.14159);
...
SoHAnimJoint173->setDEF(QString("hanim_l_radiocarpal"));
SoHAnimJoint173->X3DNode::setName(QString("l_radiocarpal"));
SoHAnimJoint173->setCenter(new float[]{7.808,31.46,-0.05849});
SoHAnimSegment* SoHAnimSegment174 = new SoHAnimSegment();
SoHAnimSegment174->setDEF(QString("hanim_l_carpal"));
SoHAnimSegment174->X3DNode::setName(QString("l_carpal"));
SoTransform* SoTransform175 = new SoTransform();
SoTransform175->setTranslation(new float[]{7.808,31.46,-0.05849});
...
SoImageTexture179->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet180->setCreaseAngle(3.14159);
...
SoHAnimJoint183->setDEF(QString("hanim_r_shoulder"));
SoHAnimJoint183->X3DNode::setName(QString("r_shoulder"));
SoHAnimJoint183->setCenter(new float[]{-5.975,52.0,-0.1452});
SoHAnimSegment* SoHAnimSegment184 = new SoHAnimSegment();
SoHAnimSegment184->setDEF(QString("hanim_r_upperarm"));
SoHAnimSegment184->X3DNode::setName(QString("r_upperarm"));
SoTransform* SoTransform185 = new SoTransform();
SoTransform185->setTranslation(new float[]{-5.975,52.0,-0.1452});
...
SoImageTexture189->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet190->setCreaseAngle(3.14159);
...
SoTextureCoordinate191->setPoint(new float[]{0.2986,0.2114,0.2726,0.2114,0.3201,0.2114,0.3415,0.2114,0.2466,0.2114,0.2979,0.2417,0.2726,0.2417,0.3197,0.2417,0.3418,0.2417,0.2473,0.2417,0.2979,0.3018,0.2726,0.3018,0.3197,0.3018,0.3418,0.3018,0.2473,0.3018,0.2978,0.3276,0.2726,0.3276,0.3197,0.3276,0.3419,0.3276,0.2474,0.3276,0.2932,0.2834,0.2689,0.2834,0.316,0.2834,0.3322,0.2834,0.245,0.2834,0.2251,0.2114,0.2255,0.2417,0.2255,0.2417,0.2255,0.3018,0.2255,0.3018,0.2255,0.3276,0.2255,0.3276,0.2159,0.2834,0.4315,0.6736,0.442,0.6736,0.3947,0.6736,0.4041,0.6736,0.418,0.6736,0.4296,0.6167,0.4409,0.6167,0.4415,0.6485,0.4303,0.6485,0.3965,0.6167,0.3953,0.6485,0.4047,0.6167,0.4053,0.6485,0.4189,0.6167,0.418,0.6485,0.4415,0.6706,0.4306,0.6706,0.395,0.6706,0.4051,0.6706,0.4182,0.6706,0.3746,0.6736,0.3851,0.6736,0.384,0.6167,0.3845,0.6485,0.3845,0.6485,0.3846,0.6706,0.3846,0.6706,0.3851,0.6736,0.3481,0.2114}, 124);
SoIndexedFaceSet190->setTexCoord(*SoTextureCoordinate191);

SoCoordinate* SoCoordinate192 = new SoCoordinate();
SoCoordinate192->setPoint(new float[]{-2.525,1.246,-1.68,-3.681,1.236,0.0337,-2.408,1.247,1.663,-0.4657,1.264,0.9556,-0.5379,1.264,-1.11,-2.743,-0.0209,-2.31,-4.339,-0.0351,0.057,-2.581,-0.0195,2.307,0.1009,0.0044,1.33,0.0013,0.0036,-1.523,-2.72,-2.534,-2.31,-4.317,-2.548,0.057,-2.559,-2.533,2.307,0.1233,-2.509,1.33,0.0237,-2.51,-1.523,-2.759,-3.609,-2.442,-4.448,-3.624,0.0619,-2.588,-3.608,2.442,0.2497,-3.583,1.409,0.1443,-3.583,-1.61,-2.245,-1.758,-1.939,-3.465,-1.769,-0.4543,-2.834,-1.763,1.629,-1.223,-1.749,1.432,-0.8596,-1.746,-0.7734,-2.263,-7.566,-1.569,-3.531,-7.577,-0.378,-2.875,-7.571,1.293,-1.202,-7.556,1.135,-0.8242,-7.553,-0.634,-2.267,-11.62,-1.511,-3.487,-11.63,-0.3651,-2.856,-11.62,1.243,-1.245,-11.61,1.091,-0.8817,-11.6,-0.6115,-2.213,-12.17,-0.8985,-2.928,-12.17,-0.2267,-2.558,-12.17,0.716,-1.614,-12.16,0.6268,-1.401,-12.16,-0.3711}, 120);
SoIndexedFaceSet190->setCoord(*SoCoordinate192);
...
SoHAnimJoint193->setDEF(QString("hanim_r_elbow"));
SoHAnimJoint193->X3DNode::setName(QString("r_elbow"));
SoHAnimJoint193->setCenter(new float[]{-8.093,40.38,-0.2502});
SoHAnimSegment* SoHAnimSegment194 = new SoHAnimSegment();
SoHAnimSegment194->setDEF(QString("hanim_r_forearm"));
SoHAnimSegment194->X3DNode::setName(QString("r_forearm"));
SoTransform* SoTransform195 = new SoTransform();
SoTransform195->setTranslation(new float[]{-8.093,40.38,-0.2502});
...
SoImageTexture199->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet200->setCreaseAngle(3.14159);
...
SoIndexedFaceSet200->setTexCoord(*SoTextureCoordinate201);

SoCoordinate* SoCoordinate202 = new SoCoordinate();
SoCoordinate202->setPoint(new float[]{-0.215,0.3047,-1.152,-1.155,0.2966,-0.2588,-0.6199,0.3013,1.04,0.6505,0.3122,0.9491,0.9008,0.3143,-0.4054,-0.1442,-0.8448,-1.625,-1.472,-0.8561,-0.4271,-0.7164,-0.8496,1.625,1.079,-0.8342,1.482,1.433,-0.8312,-0.6588,-0.1328,-3.5,-1.607,-1.551,-3.513,-0.4225,-0.781,-2.925,1.61,1.136,-2.909,1.468,1.551,-3.486,-0.6519,-0.0592,-8.713,-1.437,-1.093,-8.722,-0.1279,-0.5047,-8.716,1.51,0.8932,-8.704,1.377,1.169,-8.702,-0.3428,-0.0092,-9.336,-0.8855,-0.7154,-9.342,0.0084,-0.3135,-9.339,1.043,0.6412,-9.331,0.9519,0.8292,-9.329,-0.1383}, 75);
SoIndexedFaceSet200->setCoord(*SoCoordinate202);
...
SoHAnimJoint203->setDEF(QString("hanim_r_radiocarpal"));
SoHAnimJoint203->X3DNode::setName(QString("r_radiocarpal"));
SoHAnimJoint203->setCenter(new float[]{-7.808,31.46,-0.05849});
SoHAnimSegment* SoHAnimSegment204 = new SoHAnimSegment();
SoHAnimSegment204->setDEF(QString("hanim_r_carpal"));
SoHAnimSegment204->X3DNode::setName(QString("r_carpal"));
SoTransform* SoTransform205 = new SoTransform();
SoTransform205->setTranslation(new float[]{-7.808,31.46,-0.05849});
...
SoImageTexture209->setUSE(QString("JinLOA1TextureAtlas"));
...
SoIndexedFaceSet210->setCreaseAngle(3.14159);
...
SoTextureCoordinate211->setPoint(new float[]{0.8107,0.9924,0.8122,0.9033,0.7694,0.9912,0.7683,0.9026,0.1329,0.0347,0.0307,0.0051,0.0134,0.0353,0.1366,0.0058,0.1249,0.1081,0.0147,0.117,0.1349,0.1856,0.0462,0.1842,0.1559,0.0454,0.148,0.1033,0.3244,0.0096,0.1758,0.0039,0.1759,0.011,0.3241,0.0033,0.173,0.1764,0.3074,0.1757,0.1732,0.1519,0.3074,0.1513,0.1756,0.032,0.2159,0.0368,0.1791,0.0165,0.3169,0.0458,0.3158,0.0193,0.172,0.0594,0.2087,0.0476,0.1736,0.0504,0.2073,0.064,0.2362,0.0821,0.3267,0.0796,0.1717,0.0822,0.1726,0.1297,0.3077,0.1289,0.3074,0.1865,0.1742,0.184,0.0061,0.1086,0.1366,0.0368,0.1241,0.1189,0.0168,0.0309,0.0211,0.1882,0.14,0.1857}, 88);
SoIndexedFaceSet210->setTexCoord(*SoTextureCoordinate211);

SoCoordinate* SoCoordinate212 = new SoCoordinate();
SoCoordinate212->setPoint(new float[]{-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912,0.7183,0.0002,-1.283,0.9295,-0.613,1.478,-1.647,-0.4252,1.388,-1.589,-0.3921,-1.989,1.044,-0.5947,-1.984,0.8227,-2.521,2.408,-1.951,-2.334,2.08,-1.892,-2.301,-2.409,1.192,-2.614,-2.248,0.5703,-3.958,1.694,-0.8836,-4.2,1.75,-0.8251,-4.167,-2.071,0.7842,-3.968,-1.934,1.037,-0.5968,-0.1872,1.642,-2.561,1.941,1.951,-0.9492,0.058,1.914,-1.016,1.885,1.649,-2.56,0.1377,1.066,-2.61,-0.2014,-1.209,0.0872,-1.349,0.7183,0.0002,-1.283,0.7098,-0.0015,0.8912,-1.247,0.07,0.7975,-1.209,0.0872,-1.349,0.7098,-0.0015,0.8912}, 84);
SoIndexedFaceSet210->setCoord(*SoCoordinate212);
...
SoHAnimJoint183->addChildren(*SoHAnimJoint193);

SoHAnimJoint143->addChildren(*SoHAnimJoint183);

SoHAnimJoint133->addChildren(*SoHAnimJoint143);

SoHAnimJoint33->addChildren(*SoHAnimJoint133);

SoHAnimHumanoid24->setSkeleton(*SoHAnimJoint33);
...
SoHAnimJoint216->setUSE(QString("hanim_skullbase"));
...
SoHAnimHumanoid24->setJoints(*SoHAnimJoint230);

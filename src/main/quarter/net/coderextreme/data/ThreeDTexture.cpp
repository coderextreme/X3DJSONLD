...
Someta2->setContent(QString("ThreeDTexture.x3d"));
...
Someta5->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/data/ThreeDTexture.x3d"));
Sohead1->addMeta(*Someta5);

Someta* Someta6 = new Someta();
Someta6->setName(QString("description"));
Someta6->setContent(QString("a kind of ThreeDTexture cube with spheres"));

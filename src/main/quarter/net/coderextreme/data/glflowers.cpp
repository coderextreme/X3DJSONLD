...
Someta2->setContent(QString("glflowers.x3d"));
...
Someta6->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/data/glflowers.x3d"));
...
SoField18->setValue(QString("\"../shaders/gl_flowers_chromatic.vs\""));
SoProtoInstance17->addChild(*SoField18);

SoField* SoField19 = new SoField();
SoField19->setName(QString("fragment"));
SoField19->setValue(QString("\"../shaders/common.fs\""));

...
SoText124->setString(new QString[]{QString("ArtDecoExamples.x3d"), QString("is a Materials Prototype declaration file."), QString("For an example scene using these node,"), QString("click this text and view"), QString("ArtDecoExamples.x3d")}, 5);

...
Someta14->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/data/x3domflowers.x3d"));
...
SoExternProtoDeclare19->setUrl(new QString[]{QString("../data/flowerproto.json#FlowerProto")}, 1);

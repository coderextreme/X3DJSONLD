...
Someta2->setContent(QString("WinterAndSpringTitleBox.x3d"));
...
Someta9->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringTitleBox.x3d"));
...
SoWorldInfo11->setTitle(QString("WinterAndSpringTitleBox.x3d"));
SoNode10->addChild(*SoWorldInfo11);

SoViewpoint* SoViewpoint12 = new SoViewpoint();
SoViewpoint12->setDEF(QString("WinterAndSpringTitleView"));
SoViewpoint12->setDescription(QString("Look at main title"));
SoViewpoint12->setPosition(new float[]{10.0,11.0,5.0});
...
SoTransform13->setDEF(QString("WinterAndSpringTitle"));
SoTransform13->setTranslation(new float[]{10.0,10.0,0.0});
...
SoImageTexture17->setUrl(new QString[]{QString("images/WinterAndSpring.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WinterAndSpring.png")}, 2);

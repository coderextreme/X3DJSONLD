...
Someta2->setContent(QString("WinterAndSpringThanksAllTitleBox.x3d"));
Sohead1->addMeta(*Someta2);

Someta* Someta3 = new Someta();
Someta3->setName(QString("description"));
Someta3->setContent(QString("Credits for scene."));
...
Someta9->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringThanksAllTitleBox.x3d"));
...
SoWorldInfo11->setTitle(QString("WinterAndSpringThanksAllTitleBox.x3d"));
SoNode10->addChild(*SoWorldInfo11);

SoViewpoint* SoViewpoint12 = new SoViewpoint();
SoViewpoint12->setDEF(QString("WSThanksAllView"));
SoViewpoint12->setDescription(QString("Look at Thanks title"));
SoViewpoint12->setPosition(new float[]{10.0,11.0,-10.0});
...
SoTransform13->setDEF(QString("WSThanksAllTitle"));
SoTransform13->setTranslation(new float[]{10.0,10.0,-15.0});
...
SoImageTexture17->setUrl(new QString[]{QString("images/WSThanksR2trimmed.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSThanksR2trimmed.png")}, 2);

...
Someta3->setContent(QString("DiamondManLOA_2.x3d"));
Sohead1->addMeta(*Someta3);

Someta* Someta4 = new Someta();
Someta4->setName(QString("description"));
Someta4->setContent(QString("hanim skeletal structure at level of articulation two, one diamond at the base node for the structure"));
...
Someta9->setContent(QString("Tue, 09 Sep 2025 19:37:54 GMT"));
Sohead1->addMeta(*Someta9);

Someta* Someta10 = new Someta();
Someta10->setName(QString("reference"));
Someta10->setContent(QString("../Templates/DiamondManLOA_2.x3d"));
Sohead1->addMeta(*Someta10);

Someta* Someta11 = new Someta();
Someta11->setName(QString("reference"));
Someta11->setContent(QString("The joint centers of this figure are based on the work of Norman Badler, director of the Center for Human Modeling and Simulation at the University of Pennsylvania. The original document which these joint centers are based on can be found at: http://www.cis.upenn.edu/~badler/anthro/89-71.ps"));
Sohead1->addMeta(*Someta11);

Someta* Someta12 = new Someta();
Someta12->setName(QString("error"));
Someta12->setContent(QString("Legacy model, not valid as X3D4 HAnim version 2.0 since HAnim version 1.0 has significant differences and is no longer directly supported"));
Sohead1->addMeta(*Someta12);

Someta* Someta13 = new Someta();
Someta13->setName(QString("Image"));
Someta13->setContent(QString("DiamondManLOA_2.png"));
Sohead1->addMeta(*Someta13);

Someta* Someta14 = new Someta();
Someta14->setName(QString("Image"));
Someta14->setContent(QString("images/BonesAllSkeletonFrontViewLOA2.png"));
Sohead1->addMeta(*Someta14);

Someta* Someta15 = new Someta();
Someta15->setName(QString("motto"));
Someta15->setContent(QString("(a) \"Diamonds are a girl's best friend.\" (b) \"Gosh, it sure is chilly in here.\""));
Sohead1->addMeta(*Someta15);

Someta* Someta16 = new Someta();
Someta16->setName(QString("subject"));
Someta16->setContent(QString("human animation, x3d, vrml, animation"));
Sohead1->addMeta(*Someta16);

Someta* Someta17 = new Someta();
Someta17->setName(QString("identifier"));
Someta17->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA_2.x3d"));
...
SoViewpoint21->setDescription(QString("Diamond Man, LOA 2"));
SoViewpoint21->setPosition(new float[]{0.0,1.0,3.0});
SoViewpoint21->setCenterOfRotation(new float[]{0.0,1.0,0.0});
SoNode18->addChild(*SoViewpoint21);

SoTransform* SoTransform22 = new SoTransform();
SoTransform22->setTranslation(new float[]{1.0,1.5,0.0});
SoBillboard* SoBillboard23 = new SoBillboard();
...
SoMaterial26->setDEF(QString("TextMaterial"));
SoMaterial26->setDiffuseColor(new float[]{0.9,0.9,0.9});
SoVRMLAppearance25->addChild(*SoMaterial26);

SoShape24->addChild(*SoVRMLAppearance25);

SoText* SoText27 = new SoText();
SoText27->setString(new QString[]{QString("Diamond Man Key")}, 1);
SoFontStyle* SoFontStyle28 = new SoFontStyle();
SoFontStyle28->setFamily(new QString[]{QString("SANS")}, 1);
SoFontStyle28->setSize(0.1);
SoText27->setFontStyle(*SoFontStyle28);

SoShape24->setGeometry(*SoText27);

SoBillboard23->addChild(*SoShape24);

SoTransform* SoTransform29 = new SoTransform();
SoTransform29->setTranslation(new float[]{0.0,-0.3,0.0});
...
SoMaterial37->setUSE(QString("TextMaterial"));
SoVRMLAppearance36->addChild(*SoMaterial37);

SoShape35->addChild(*SoVRMLAppearance36);

SoText* SoText38 = new SoText();
SoText38->setString(new QString[]{QString("Minimal Humanoid Joints")}, 1);
SoFontStyle* SoFontStyle39 = new SoFontStyle();
SoFontStyle39->setFamily(new QString[]{QString("SANS")}, 1);
SoFontStyle39->setSize(0.1);
...
SoTransform29->addChild(*SoTransform34);

SoBillboard23->addChild(*SoTransform29);

SoTransform* SoTransform40 = new SoTransform();
SoTransform40->setTranslation(new float[]{0.0,-0.5,0.0});
...
SoMaterial43->setDEF(QString("JOINT_COLOR"));
SoMaterial43->setDiffuseColor(new float[]{1.0,1.0,0.0});
SoVRMLAppearance42->addChild(*SoMaterial43);

SoShape41->addChild(*SoVRMLAppearance42);

SoSphere* SoSphere44 = new SoSphere();
SoSphere44->setRadius(0.08);
SoShape41->setGeometry(*SoSphere44);

SoTransform40->addChild(*SoShape41);

SoTransform* SoTransform45 = new SoTransform();
SoTransform45->setTranslation(new float[]{0.2,0.0,0.0});
...
SoMaterial48->setUSE(QString("TextMaterial"));
SoVRMLAppearance47->addChild(*SoMaterial48);

SoShape46->addChild(*SoVRMLAppearance47);

SoText* SoText49 = new SoText();
SoText49->setString(new QString[]{QString("Humanoid Joints")}, 1);
SoFontStyle* SoFontStyle50 = new SoFontStyle();
SoFontStyle50->setFamily(new QString[]{QString("SANS")}, 1);
SoFontStyle50->setSize(0.1);
SoText49->setFontStyle(*SoFontStyle50);

SoShape46->setGeometry(*SoText49);

SoTransform45->addChild(*SoShape46);

SoTransform40->addChild(*SoTransform45);

SoBillboard23->addChild(*SoTransform40);

SoTransform* SoTransform51 = new SoTransform();
SoTransform51->setTranslation(new float[]{0.0,-0.7,0.0});
...
SoMaterial65->setDEF(QString("SPINAL_COLOR"));
...
SoSphere* SoSphere66 = new SoSphere();
SoSphere66->setRadius(0.08);
SoShape63->setGeometry(*SoSphere66);

SoTransform62->addChild(*SoShape63);

SoTransform* SoTransform67 = new SoTransform();
SoTransform67->setTranslation(new float[]{0.2,0.0,0.0});
...
SoMaterial70->setUSE(QString("TextMaterial"));
SoVRMLAppearance69->addChild(*SoMaterial70);

SoShape68->addChild(*SoVRMLAppearance69);

SoText* SoText71 = new SoText();
SoText71->setString(new QString[]{QString("Spinal Joints")}, 1);
SoFontStyle* SoFontStyle72 = new SoFontStyle();
SoFontStyle72->setFamily(new QString[]{QString("SANS")}, 1);
SoFontStyle72->setSize(0.1);
SoText71->setFontStyle(*SoFontStyle72);

SoShape68->setGeometry(*SoText71);

SoTransform67->addChild(*SoShape68);

SoTransform62->addChild(*SoTransform67);

SoBillboard23->addChild(*SoTransform62);

SoTransform* SoTransform73 = new SoTransform();
SoTransform73->setTranslation(new float[]{0.0,-1.3,0.0});
...
SoMaterial81->setUSE(QString("TextMaterial"));
SoVRMLAppearance80->addChild(*SoMaterial81);

SoShape79->addChild(*SoVRMLAppearance80);

SoText* SoText82 = new SoText();
SoText82->setString(new QString[]{QString("Humanoid Sites")}, 1);
SoFontStyle* SoFontStyle83 = new SoFontStyle();
SoFontStyle83->setFamily(new QString[]{QString("SANS")}, 1);
SoFontStyle83->setSize(0.1);
SoText82->setFontStyle(*SoFontStyle83);

SoShape79->setGeometry(*SoText82);

SoTransform78->addChild(*SoShape79);

SoTransform73->addChild(*SoTransform78);

SoBillboard23->addChild(*SoTransform73);

SoTransform* SoTransform84 = new SoTransform();
SoTransform84->setTranslation(new float[]{0.0,-1.1,0.0});
...
SoMaterial87->setDEF(QString("HAND_FEET_COLOR"));
SoMaterial87->setDiffuseColor(new float[]{0.0,1.0,1.0});
SoVRMLAppearance86->addChild(*SoMaterial87);

SoShape85->addChild(*SoVRMLAppearance86);

SoSphere* SoSphere88 = new SoSphere();
SoSphere88->setRadius(0.08);
SoShape85->setGeometry(*SoSphere88);

SoTransform84->addChild(*SoShape85);

SoTransform* SoTransform89 = new SoTransform();
SoTransform89->setTranslation(new float[]{0.2,0.0,0.0});
...
SoMaterial92->setUSE(QString("TextMaterial"));
SoVRMLAppearance91->addChild(*SoMaterial92);

SoShape90->addChild(*SoVRMLAppearance91);

SoText* SoText93 = new SoText();
SoText93->setString(new QString[]{QString("Hand & Feet Joints")}, 1);
SoFontStyle* SoFontStyle94 = new SoFontStyle();
SoFontStyle94->setFamily(new QString[]{QString("SANS")}, 1);
SoFontStyle94->setSize(0.1);
SoText93->setFontStyle(*SoFontStyle94);

SoShape90->setGeometry(*SoText93);

SoTransform89->addChild(*SoShape90);

SoTransform84->addChild(*SoTransform89);

SoBillboard23->addChild(*SoTransform84);

SoTransform22->addChild(*SoBillboard23);

SoNode18->addChild(*SoTransform22);

SoHAnimHumanoid* SoHAnimHumanoid95 = new SoHAnimHumanoid();
SoHAnimHumanoid95->setDEF(QString("hanim_humanoid"));
SoHAnimHumanoid95->X3DNode::setName(QString("humanoid"));
SoHAnimHumanoid95->setVersion(QString("1.0"));
SoMetadataSet* SoMetadataSet96 = new SoMetadataSet();
SoMetadataSet96->X3DNode::setName(QString("HAnimHumanoid.info"));
SoMetadataSet96->X3DNode::setReference(QString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid"));
SoMetadataString* SoMetadataString97 = new SoMetadataString();
SoMetadataString97->X3DNode::setName(QString("authorName"));
SoMetadataSet96->setMetadata(*SoMetadataString97);

SoHAnimHumanoid95->setMetadata(*SoMetadataSet96);

SoHAnimJoint* SoHAnimJoint98 = new SoHAnimJoint();
SoHAnimJoint98->setDEF(QString("hanim_HumanoidRoot"));
...
SoHAnimSite189->setDEF(QString("hanim_l_femoral_lateral_epicn_pt"));
SoHAnimSite189->X3DNode::setName(QString("l_femoral_lateral_epicn_pt"));
...
SoHAnimSite195->setDEF(QString("hanim_l_femoral_medial_epicn_pt"));
SoHAnimSite195->X3DNode::setName(QString("l_femoral_medial_epicn_pt"));
...
SoHAnimJoint209->setDEF(QString("hanim_l_ankle"));
SoHAnimJoint209->X3DNode::setName(QString("l_ankle"));
SoHAnimJoint209->setCenter(new float[]{0.1101,0.0656,-0.0736});
SoHAnimSegment* SoHAnimSegment210 = new SoHAnimSegment();
SoHAnimSegment210->setDEF(QString("hanim_l_hindfoot"));
SoHAnimSegment210->X3DNode::setName(QString("l_hindfoot"));
...
SoHAnimSite235->setDEF(QString("hanim_l_calcaneous_post_pt"));
SoHAnimSite235->X3DNode::setName(QString("l_calcaneous_post_pt"));
...
SoHAnimJoint241->setDEF(QString("hanim_l_subtalar"));
SoHAnimJoint241->X3DNode::setName(QString("l_subtalar"));
SoHAnimJoint241->setCenter(new float[]{0.1086,0.0001,-0.0368});
SoHAnimSegment* SoHAnimSegment242 = new SoHAnimSegment();
SoHAnimSegment242->setDEF(QString("hanim_midproximal"));
SoHAnimSegment242->X3DNode::setName(QString("midproximal"));
...
SoHAnimJoint249->setDEF(QString("hanim_l_midtarsal"));
SoHAnimJoint249->X3DNode::setName(QString("l_midtarsal"));
SoHAnimJoint249->setCenter(new float[]{0.1086,0.0001,0.0368});
SoHAnimSegment* SoHAnimSegment250 = new SoHAnimSegment();
SoHAnimSegment250->setDEF(QString("hanim_l_middistal"));
SoHAnimSegment250->X3DNode::setName(QString("l_middistal"));
...
SoHAnimSite263->setDEF(QString("hanim_l_metatarsal_pha1_pt"));
SoHAnimSite263->X3DNode::setName(QString("l_metatarsal_pha1_pt"));
...
SoHAnimJoint269->setDEF(QString("hanim_l_metatarsal"));
SoHAnimJoint269->X3DNode::setName(QString("l_metatarsal"));
SoHAnimJoint269->setCenter(new float[]{0.1086,0.0,0.0762});
SoHAnimSegment* SoHAnimSegment270 = new SoHAnimSegment();
SoHAnimSegment270->setDEF(QString("hanim_l_forefoot"));
SoHAnimSegment270->X3DNode::setName(QString("l_forefoot"));
...
SoHAnimSite283->setDEF(QString("hanim_l_metatarsal_pha5_pt"));
SoHAnimSite283->X3DNode::setName(QString("l_metatarsal_pha5_pt"));
...
SoHAnimSite289->setDEF(QString("hanim_l_digit2_pt"));
SoHAnimSite289->X3DNode::setName(QString("l_digit2_pt"));
...
SoHAnimSite309->setDEF(QString("hanim_r_femoral_lateral_epicn_pt"));
SoHAnimSite309->X3DNode::setName(QString("r_femoral_lateral_epicn_pt"));
...
SoHAnimSite315->setDEF(QString("hanim_r_femoral_medial_epicn_pt"));
SoHAnimSite315->X3DNode::setName(QString("r_femoral_medial_epicn_pt"));
...
SoHAnimJoint329->setDEF(QString("hanim_r_ankle"));
SoHAnimJoint329->X3DNode::setName(QString("r_ankle"));
SoHAnimJoint329->setCenter(new float[]{-0.0801,0.0712,-0.0766});
SoHAnimSegment* SoHAnimSegment330 = new SoHAnimSegment();
SoHAnimSegment330->setDEF(QString("hanim_r_hindfoot"));
SoHAnimSegment330->X3DNode::setName(QString("r_hindfoot"));
...
SoHAnimSite355->setDEF(QString("hanim_r_calcaneous_post_pt"));
SoHAnimSite355->X3DNode::setName(QString("r_calcaneous_post_pt"));
...
SoHAnimJoint361->setDEF(QString("hanim_r_midtarsal"));
SoHAnimJoint361->X3DNode::setName(QString("r_midtarsal"));
SoHAnimJoint361->setCenter(new float[]{-0.0801,0.0,0.0368});
SoHAnimSegment* SoHAnimSegment362 = new SoHAnimSegment();
SoHAnimSegment362->setDEF(QString("hanim_r_middistal"));
SoHAnimSegment362->X3DNode::setName(QString("r_middistal"));
...
SoHAnimSite375->setDEF(QString("hanim_r_metatarsal_pha5_pt"));
SoHAnimSite375->X3DNode::setName(QString("r_metatarsal_pha5_pt"));
...
SoHAnimSite381->setDEF(QString("hanim_r_metatarsal_pha1_pt"));
SoHAnimSite381->X3DNode::setName(QString("r_metatarsal_pha1_pt"));
...
SoHAnimSite387->setDEF(QString("hanim_r_digit2_pt"));
SoHAnimSite387->X3DNode::setName(QString("r_digit2_pt"));
...
SoHAnimSite538->setDEF(QString("hanim_l_humeral_lateral_epicn_pt"));
SoHAnimSite538->X3DNode::setName(QString("l_humeral_lateral_epicn_pt"));
...
SoHAnimSite565->setDEF(QString("hanim_l_humeral_medial_epicn_pt"));
SoHAnimSite565->X3DNode::setName(QString("l_humeral_medial_epicn_pt"));
...
SoHAnimJoint577->setDEF(QString("hanim_l_wrist"));
SoHAnimJoint577->X3DNode::setName(QString("l_wrist"));
SoHAnimJoint577->setCenter(new float[]{0.1984,0.8663,-0.0583});
SoHAnimSegment* SoHAnimSegment578 = new SoHAnimSegment();
SoHAnimSegment578->setDEF(QString("hanim_l_hand"));
SoHAnimSegment578->X3DNode::setName(QString("l_hand"));
...
SoHAnimSite592->setDEF(QString("hanim_l_metacarpal_pha2_pt"));
SoHAnimSite592->X3DNode::setName(QString("l_metacarpal_pha2_pt"));
...
SoHAnimSite610->setDEF(QString("hanim_l_metacarpal_pha5_pt"));
SoHAnimSite610->X3DNode::setName(QString("l_metacarpal_pha5_pt"));
...
SoHAnimJoint616->setDEF(QString("hanim_l_thumb1"));
SoHAnimJoint616->X3DNode::setName(QString("l_thumb1"));
SoHAnimJoint616->setCenter(new float[]{0.1924,0.8472,-0.0534});
SoHAnimSegment* SoHAnimSegment617 = new SoHAnimSegment();
SoHAnimSegment617->setDEF(QString("hanim_l_thumb_metacarpal"));
SoHAnimSegment617->X3DNode::setName(QString("l_thumb_metacarpal"));
...
SoHAnimJoint624->setDEF(QString("hanim_l_thumb2"));
SoHAnimJoint624->X3DNode::setName(QString("l_thumb2"));
SoHAnimJoint624->setCenter(new float[]{0.1951,0.8226,0.0246});
SoHAnimSegment* SoHAnimSegment625 = new SoHAnimSegment();
SoHAnimSegment625->setDEF(QString("hanim_l_thumb_proximal"));
SoHAnimSegment625->X3DNode::setName(QString("l_thumb_proximal"));
...
SoHAnimJoint632->setDEF(QString("hanim_l_thumb3"));
SoHAnimJoint632->X3DNode::setName(QString("l_thumb3"));
SoHAnimJoint632->setCenter(new float[]{0.1955,0.8159,0.0464});
SoHAnimSegment* SoHAnimSegment633 = new SoHAnimSegment();
SoHAnimSegment633->setDEF(QString("hanim_l_thumb_distal"));
SoHAnimSegment633->X3DNode::setName(QString("l_thumb_distal"));
...
SoHAnimSite640->setDEF(QString("hanim_l_thumb_distal_tip"));
SoHAnimSite640->X3DNode::setName(QString("l_thumb_distal_tip"));
...
SoHAnimJoint646->setDEF(QString("hanim_l_index0"));
SoHAnimJoint646->X3DNode::setName(QString("l_index0"));
SoHAnimJoint646->setCenter(new float[]{0.1983,0.8024,-0.028});
SoHAnimSegment* SoHAnimSegment647 = new SoHAnimSegment();
SoHAnimSegment647->setDEF(QString("hanim_l_index_metacarpal"));
SoHAnimSegment647->X3DNode::setName(QString("l_index_metacarpal"));
...
SoHAnimJoint654->setDEF(QString("hanim_l_index1"));
SoHAnimJoint654->X3DNode::setName(QString("l_index1"));
SoHAnimJoint654->setCenter(new float[]{0.1983,0.7815,-0.028});
SoHAnimSegment* SoHAnimSegment655 = new SoHAnimSegment();
SoHAnimSegment655->setDEF(QString("hanim_l_index_proximal"));
SoHAnimSegment655->X3DNode::setName(QString("l_index_proximal"));
...
SoHAnimJoint662->setDEF(QString("hanim_l_index2"));
SoHAnimJoint662->X3DNode::setName(QString("l_index2"));
SoHAnimJoint662->setCenter(new float[]{0.2017,0.7363,-0.0248});
SoHAnimSegment* SoHAnimSegment663 = new SoHAnimSegment();
SoHAnimSegment663->setDEF(QString("hanim_l_index_middle"));
SoHAnimSegment663->X3DNode::setName(QString("l_index_middle"));
...
SoHAnimJoint670->setDEF(QString("hanim_l_index3"));
SoHAnimJoint670->X3DNode::setName(QString("l_index3"));
SoHAnimJoint670->setCenter(new float[]{0.2028,0.7139,-0.0236});
SoHAnimSegment* SoHAnimSegment671 = new SoHAnimSegment();
SoHAnimSegment671->setDEF(QString("hanim_l_index_distal"));
SoHAnimSegment671->X3DNode::setName(QString("l_index_distal"));
...
SoHAnimSite678->setDEF(QString("hanim_l_index_distal_tip"));
SoHAnimSite678->X3DNode::setName(QString("l_index_distal_tip"));
...
SoHAnimSite693->setDEF(QString("hanim_r_humeral_lateral_epicn_pt"));
SoHAnimSite693->X3DNode::setName(QString("r_humeral_lateral_epicn_pt"));
...
SoHAnimSite720->setDEF(QString("hanim_r_humeral_medial_epicn_pt"));
SoHAnimSite720->X3DNode::setName(QString("r_humeral_medial_epicn_pt"));
...
SoHAnimJoint732->setDEF(QString("hanim_r_wrist"));
SoHAnimJoint732->X3DNode::setName(QString("r_wrist"));
SoHAnimJoint732->setCenter(new float[]{-0.1959,0.8694,-0.0521});
SoHAnimSegment* SoHAnimSegment733 = new SoHAnimSegment();
SoHAnimSegment733->setDEF(QString("hanim_r_hand"));
SoHAnimSegment733->X3DNode::setName(QString("r_hand"));
...
SoHAnimSite747->setDEF(QString("hanim_r_metacarpal_pha2_pt"));
SoHAnimSite747->X3DNode::setName(QString("r_metacarpal_pha2_pt"));
...
SoHAnimSite765->setDEF(QString("hanim_r_metacarpal_pha5_pt"));
SoHAnimSite765->X3DNode::setName(QString("r_metacarpal_pha5_pt"));
...
SoHAnimSite835->setDEF(QString("hanim_skull_tip"));
SoHAnimSite835->X3DNode::setName(QString("skull_tip"));
...
SoHAnimHumanoid95->setSkeleton(*SoHAnimJoint98);

SoHAnimJoint* SoHAnimJoint895 = new SoHAnimJoint();
SoHAnimJoint895->setUSE(QString("hanim_HumanoidRoot"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint895);

SoHAnimJoint* SoHAnimJoint896 = new SoHAnimJoint();
SoHAnimJoint896->setUSE(QString("hanim_sacroiliac"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint896);

SoHAnimJoint* SoHAnimJoint897 = new SoHAnimJoint();
SoHAnimJoint897->setUSE(QString("hanim_vl1"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint897);

SoHAnimJoint* SoHAnimJoint898 = new SoHAnimJoint();
SoHAnimJoint898->setUSE(QString("hanim_vc4"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint898);

SoHAnimJoint* SoHAnimJoint899 = new SoHAnimJoint();
SoHAnimJoint899->setUSE(QString("hanim_skullbase"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint899);

SoHAnimJoint* SoHAnimJoint900 = new SoHAnimJoint();
SoHAnimJoint900->setUSE(QString("hanim_vl5"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint900);

SoHAnimJoint* SoHAnimJoint901 = new SoHAnimJoint();
SoHAnimJoint901->setUSE(QString("hanim_vl4"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint901);

SoHAnimJoint* SoHAnimJoint902 = new SoHAnimJoint();
SoHAnimJoint902->setUSE(QString("hanim_vl3"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint902);

SoHAnimJoint* SoHAnimJoint903 = new SoHAnimJoint();
SoHAnimJoint903->setUSE(QString("hanim_vl2"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint903);

SoHAnimJoint* SoHAnimJoint904 = new SoHAnimJoint();
SoHAnimJoint904->setUSE(QString("hanim_vt12"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint904);

SoHAnimJoint* SoHAnimJoint905 = new SoHAnimJoint();
SoHAnimJoint905->setUSE(QString("hanim_vt11"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint905);

SoHAnimJoint* SoHAnimJoint906 = new SoHAnimJoint();
SoHAnimJoint906->setUSE(QString("hanim_vt10"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint906);

SoHAnimJoint* SoHAnimJoint907 = new SoHAnimJoint();
SoHAnimJoint907->setUSE(QString("hanim_vt9"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint907);

SoHAnimJoint* SoHAnimJoint908 = new SoHAnimJoint();
SoHAnimJoint908->setUSE(QString("hanim_vt8"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint908);

SoHAnimJoint* SoHAnimJoint909 = new SoHAnimJoint();
SoHAnimJoint909->setUSE(QString("hanim_vt7"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint909);

SoHAnimJoint* SoHAnimJoint910 = new SoHAnimJoint();
SoHAnimJoint910->setUSE(QString("hanim_vt6"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint910);

SoHAnimJoint* SoHAnimJoint911 = new SoHAnimJoint();
SoHAnimJoint911->setUSE(QString("hanim_vt5"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint911);

SoHAnimJoint* SoHAnimJoint912 = new SoHAnimJoint();
SoHAnimJoint912->setUSE(QString("hanim_vt4"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint912);

SoHAnimJoint* SoHAnimJoint913 = new SoHAnimJoint();
SoHAnimJoint913->setUSE(QString("hanim_vt3"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint913);

SoHAnimJoint* SoHAnimJoint914 = new SoHAnimJoint();
SoHAnimJoint914->setUSE(QString("hanim_vt2"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint914);

SoHAnimJoint* SoHAnimJoint915 = new SoHAnimJoint();
SoHAnimJoint915->setUSE(QString("hanim_vt1"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint915);

SoHAnimJoint* SoHAnimJoint916 = new SoHAnimJoint();
SoHAnimJoint916->setUSE(QString("hanim_vc7"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint916);

SoHAnimJoint* SoHAnimJoint917 = new SoHAnimJoint();
SoHAnimJoint917->setUSE(QString("hanim_vc6"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint917);

SoHAnimJoint* SoHAnimJoint918 = new SoHAnimJoint();
SoHAnimJoint918->setUSE(QString("hanim_vc5"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint918);

SoHAnimJoint* SoHAnimJoint919 = new SoHAnimJoint();
SoHAnimJoint919->setUSE(QString("hanim_vc3"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint919);

SoHAnimJoint* SoHAnimJoint920 = new SoHAnimJoint();
SoHAnimJoint920->setUSE(QString("hanim_vc2"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint920);

SoHAnimJoint* SoHAnimJoint921 = new SoHAnimJoint();
SoHAnimJoint921->setUSE(QString("hanim_vc1"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint921);

SoHAnimJoint* SoHAnimJoint922 = new SoHAnimJoint();
SoHAnimJoint922->setUSE(QString("hanim_l_ankle"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint922);

SoHAnimJoint* SoHAnimJoint923 = new SoHAnimJoint();
SoHAnimJoint923->setUSE(QString("hanim_r_ankle"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint923);

SoHAnimJoint* SoHAnimJoint924 = new SoHAnimJoint();
SoHAnimJoint924->setUSE(QString("hanim_l_elbow"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint924);

SoHAnimJoint* SoHAnimJoint925 = new SoHAnimJoint();
SoHAnimJoint925->setUSE(QString("hanim_r_elbow"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint925);

SoHAnimJoint* SoHAnimJoint926 = new SoHAnimJoint();
SoHAnimJoint926->setUSE(QString("hanim_l_hip"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint926);

SoHAnimJoint* SoHAnimJoint927 = new SoHAnimJoint();
SoHAnimJoint927->setUSE(QString("hanim_r_hip"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint927);

SoHAnimJoint* SoHAnimJoint928 = new SoHAnimJoint();
SoHAnimJoint928->setUSE(QString("hanim_l_index0"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint928);

SoHAnimJoint* SoHAnimJoint929 = new SoHAnimJoint();
SoHAnimJoint929->setUSE(QString("hanim_l_index1"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint929);

SoHAnimJoint* SoHAnimJoint930 = new SoHAnimJoint();
SoHAnimJoint930->setUSE(QString("hanim_l_index2"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint930);

SoHAnimJoint* SoHAnimJoint931 = new SoHAnimJoint();
SoHAnimJoint931->setUSE(QString("hanim_l_index3"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint931);

SoHAnimJoint* SoHAnimJoint932 = new SoHAnimJoint();
SoHAnimJoint932->setUSE(QString("hanim_l_knee"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint932);

SoHAnimJoint* SoHAnimJoint933 = new SoHAnimJoint();
SoHAnimJoint933->setUSE(QString("hanim_r_knee"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint933);

SoHAnimJoint* SoHAnimJoint934 = new SoHAnimJoint();
SoHAnimJoint934->setUSE(QString("hanim_l_metatarsal"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint934);

SoHAnimJoint* SoHAnimJoint935 = new SoHAnimJoint();
SoHAnimJoint935->setUSE(QString("hanim_l_midtarsal"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint935);

SoHAnimJoint* SoHAnimJoint936 = new SoHAnimJoint();
SoHAnimJoint936->setUSE(QString("hanim_r_midtarsal"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint936);

SoHAnimJoint* SoHAnimJoint937 = new SoHAnimJoint();
SoHAnimJoint937->setUSE(QString("hanim_l_shoulder"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint937);

SoHAnimJoint* SoHAnimJoint938 = new SoHAnimJoint();
SoHAnimJoint938->setUSE(QString("hanim_r_shoulder"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint938);

SoHAnimJoint* SoHAnimJoint939 = new SoHAnimJoint();
SoHAnimJoint939->setUSE(QString("hanim_l_subtalar"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint939);

SoHAnimJoint* SoHAnimJoint940 = new SoHAnimJoint();
SoHAnimJoint940->setUSE(QString("hanim_l_thumb1"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint940);

SoHAnimJoint* SoHAnimJoint941 = new SoHAnimJoint();
SoHAnimJoint941->setUSE(QString("hanim_l_thumb2"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint941);

SoHAnimJoint* SoHAnimJoint942 = new SoHAnimJoint();
SoHAnimJoint942->setUSE(QString("hanim_l_thumb3"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint942);

SoHAnimJoint* SoHAnimJoint943 = new SoHAnimJoint();
SoHAnimJoint943->setUSE(QString("hanim_l_wrist"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint943);

SoHAnimJoint* SoHAnimJoint944 = new SoHAnimJoint();
SoHAnimJoint944->setUSE(QString("hanim_r_wrist"));
SoHAnimHumanoid95->setJoints(*SoHAnimJoint944);

SoHAnimSegment* SoHAnimSegment945 = new SoHAnimSegment();
SoHAnimSegment945->setUSE(QString("hanim_pelvis"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment945);

SoHAnimSegment* SoHAnimSegment946 = new SoHAnimSegment();
SoHAnimSegment946->setUSE(QString("hanim_c7"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment946);

SoHAnimSegment* SoHAnimSegment947 = new SoHAnimSegment();
SoHAnimSegment947->setUSE(QString("hanim_c4"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment947);

SoHAnimSegment* SoHAnimSegment948 = new SoHAnimSegment();
SoHAnimSegment948->setUSE(QString("hanim_skull"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment948);

SoHAnimSegment* SoHAnimSegment949 = new SoHAnimSegment();
SoHAnimSegment949->setUSE(QString("hanim_sacrum"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment949);

SoHAnimSegment* SoHAnimSegment950 = new SoHAnimSegment();
SoHAnimSegment950->setUSE(QString("hanim_midproximal"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment950);

SoHAnimSegment* SoHAnimSegment951 = new SoHAnimSegment();
SoHAnimSegment951->setUSE(QString("hanim_l5"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment951);

SoHAnimSegment* SoHAnimSegment952 = new SoHAnimSegment();
SoHAnimSegment952->setUSE(QString("hanim_l4"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment952);

SoHAnimSegment* SoHAnimSegment953 = new SoHAnimSegment();
SoHAnimSegment953->setUSE(QString("hanim_l3"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment953);

SoHAnimSegment* SoHAnimSegment954 = new SoHAnimSegment();
SoHAnimSegment954->setUSE(QString("hanim_l2"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment954);

SoHAnimSegment* SoHAnimSegment955 = new SoHAnimSegment();
SoHAnimSegment955->setUSE(QString("hanim_l1"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment955);

SoHAnimSegment* SoHAnimSegment956 = new SoHAnimSegment();
SoHAnimSegment956->setUSE(QString("hanim_t12"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment956);

SoHAnimSegment* SoHAnimSegment957 = new SoHAnimSegment();
SoHAnimSegment957->setUSE(QString("hanim_t11"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment957);

SoHAnimSegment* SoHAnimSegment958 = new SoHAnimSegment();
SoHAnimSegment958->setUSE(QString("hanim_t10"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment958);

SoHAnimSegment* SoHAnimSegment959 = new SoHAnimSegment();
SoHAnimSegment959->setUSE(QString("hanim_t9"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment959);

SoHAnimSegment* SoHAnimSegment960 = new SoHAnimSegment();
SoHAnimSegment960->setUSE(QString("hanim_t8"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment960);

SoHAnimSegment* SoHAnimSegment961 = new SoHAnimSegment();
SoHAnimSegment961->setUSE(QString("hanim_t7"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment961);

SoHAnimSegment* SoHAnimSegment962 = new SoHAnimSegment();
SoHAnimSegment962->setUSE(QString("hanim_t6"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment962);

SoHAnimSegment* SoHAnimSegment963 = new SoHAnimSegment();
SoHAnimSegment963->setUSE(QString("hanim_t5"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment963);

SoHAnimSegment* SoHAnimSegment964 = new SoHAnimSegment();
SoHAnimSegment964->setUSE(QString("hanim_t4"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment964);

SoHAnimSegment* SoHAnimSegment965 = new SoHAnimSegment();
SoHAnimSegment965->setUSE(QString("hanim_t3"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment965);

SoHAnimSegment* SoHAnimSegment966 = new SoHAnimSegment();
SoHAnimSegment966->setUSE(QString("hanim_t2"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment966);

SoHAnimSegment* SoHAnimSegment967 = new SoHAnimSegment();
SoHAnimSegment967->setUSE(QString("hanim_t1"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment967);

SoHAnimSegment* SoHAnimSegment968 = new SoHAnimSegment();
SoHAnimSegment968->setUSE(QString("hanim_c6"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment968);

SoHAnimSegment* SoHAnimSegment969 = new SoHAnimSegment();
SoHAnimSegment969->setUSE(QString("hanim_c5"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment969);

SoHAnimSegment* SoHAnimSegment970 = new SoHAnimSegment();
SoHAnimSegment970->setUSE(QString("hanim_c3"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment970);

SoHAnimSegment* SoHAnimSegment971 = new SoHAnimSegment();
SoHAnimSegment971->setUSE(QString("hanim_c2"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment971);

SoHAnimSegment* SoHAnimSegment972 = new SoHAnimSegment();
SoHAnimSegment972->setUSE(QString("hanim_c1"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment972);

SoHAnimSegment* SoHAnimSegment973 = new SoHAnimSegment();
SoHAnimSegment973->setUSE(QString("hanim_l_calf"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment973);

SoHAnimSegment* SoHAnimSegment974 = new SoHAnimSegment();
SoHAnimSegment974->setUSE(QString("hanim_r_calf"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment974);

SoHAnimSegment* SoHAnimSegment975 = new SoHAnimSegment();
SoHAnimSegment975->setUSE(QString("hanim_l_forearm"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment975);

SoHAnimSegment* SoHAnimSegment976 = new SoHAnimSegment();
SoHAnimSegment976->setUSE(QString("hanim_r_forearm"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment976);

SoHAnimSegment* SoHAnimSegment977 = new SoHAnimSegment();
SoHAnimSegment977->setUSE(QString("hanim_l_forefoot"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment977);

SoHAnimSegment* SoHAnimSegment978 = new SoHAnimSegment();
SoHAnimSegment978->setUSE(QString("hanim_l_hand"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment978);

SoHAnimSegment* SoHAnimSegment979 = new SoHAnimSegment();
SoHAnimSegment979->setUSE(QString("hanim_r_hand"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment979);

SoHAnimSegment* SoHAnimSegment980 = new SoHAnimSegment();
SoHAnimSegment980->setUSE(QString("hanim_l_hindfoot"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment980);

SoHAnimSegment* SoHAnimSegment981 = new SoHAnimSegment();
SoHAnimSegment981->setUSE(QString("hanim_r_hindfoot"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment981);

SoHAnimSegment* SoHAnimSegment982 = new SoHAnimSegment();
SoHAnimSegment982->setUSE(QString("hanim_l_index_distal"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment982);

SoHAnimSegment* SoHAnimSegment983 = new SoHAnimSegment();
SoHAnimSegment983->setUSE(QString("hanim_l_index_metacarpal"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment983);

SoHAnimSegment* SoHAnimSegment984 = new SoHAnimSegment();
SoHAnimSegment984->setUSE(QString("hanim_l_index_middle"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment984);

SoHAnimSegment* SoHAnimSegment985 = new SoHAnimSegment();
SoHAnimSegment985->setUSE(QString("hanim_l_index_proximal"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment985);

SoHAnimSegment* SoHAnimSegment986 = new SoHAnimSegment();
SoHAnimSegment986->setUSE(QString("hanim_l_middistal"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment986);

SoHAnimSegment* SoHAnimSegment987 = new SoHAnimSegment();
SoHAnimSegment987->setUSE(QString("hanim_r_middistal"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment987);

SoHAnimSegment* SoHAnimSegment988 = new SoHAnimSegment();
SoHAnimSegment988->setUSE(QString("hanim_l_thigh"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment988);

SoHAnimSegment* SoHAnimSegment989 = new SoHAnimSegment();
SoHAnimSegment989->setUSE(QString("hanim_r_thigh"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment989);

SoHAnimSegment* SoHAnimSegment990 = new SoHAnimSegment();
SoHAnimSegment990->setUSE(QString("hanim_l_thumb_distal"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment990);

SoHAnimSegment* SoHAnimSegment991 = new SoHAnimSegment();
SoHAnimSegment991->setUSE(QString("hanim_l_thumb_metacarpal"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment991);

SoHAnimSegment* SoHAnimSegment992 = new SoHAnimSegment();
SoHAnimSegment992->setUSE(QString("hanim_l_thumb_proximal"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment992);

SoHAnimSegment* SoHAnimSegment993 = new SoHAnimSegment();
SoHAnimSegment993->setUSE(QString("hanim_l_upperarm"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment993);

SoHAnimSegment* SoHAnimSegment994 = new SoHAnimSegment();
SoHAnimSegment994->setUSE(QString("hanim_r_upperarm"));
SoHAnimHumanoid95->setSegments(*SoHAnimSegment994);

SoHAnimSite* SoHAnimSite995 = new SoHAnimSite();
SoHAnimSite995->setUSE(QString("hanim_crotch_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite995);

SoHAnimSite* SoHAnimSite996 = new SoHAnimSite();
SoHAnimSite996->setUSE(QString("hanim_skull_tip"));
SoHAnimHumanoid95->setSites(*SoHAnimSite996);

SoHAnimSite* SoHAnimSite997 = new SoHAnimSite();
SoHAnimSite997->setUSE(QString("hanim_sellion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite997);

SoHAnimSite* SoHAnimSite998 = new SoHAnimSite();
SoHAnimSite998->setUSE(QString("hanim_supramenton_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite998);

SoHAnimSite* SoHAnimSite999 = new SoHAnimSite();
SoHAnimSite999->setUSE(QString("hanim_nuchale_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite999);

SoHAnimSite* SoHAnimSite1000 = new SoHAnimSite();
SoHAnimSite1000->setUSE(QString("hanim_r_asis_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1000);

SoHAnimSite* SoHAnimSite1001 = new SoHAnimSite();
SoHAnimSite1001->setUSE(QString("hanim_l_asis_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1001);

SoHAnimSite* SoHAnimSite1002 = new SoHAnimSite();
SoHAnimSite1002->setUSE(QString("hanim_l_calcaneous_post_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1002);

SoHAnimSite* SoHAnimSite1003 = new SoHAnimSite();
SoHAnimSite1003->setUSE(QString("hanim_r_calcaneous_post_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1003);

SoHAnimSite* SoHAnimSite1004 = new SoHAnimSite();
SoHAnimSite1004->setUSE(QString("hanim_l_dactylion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1004);

SoHAnimSite* SoHAnimSite1005 = new SoHAnimSite();
SoHAnimSite1005->setUSE(QString("hanim_r_dactylion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1005);

SoHAnimSite* SoHAnimSite1006 = new SoHAnimSite();
SoHAnimSite1006->setUSE(QString("hanim_l_digit2_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1006);

SoHAnimSite* SoHAnimSite1007 = new SoHAnimSite();
SoHAnimSite1007->setUSE(QString("hanim_r_digit2_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1007);

SoHAnimSite* SoHAnimSite1008 = new SoHAnimSite();
SoHAnimSite1008->setUSE(QString("hanim_l_femoral_lateral_epicn_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1008);

SoHAnimSite* SoHAnimSite1009 = new SoHAnimSite();
SoHAnimSite1009->setUSE(QString("hanim_r_femoral_lateral_epicn_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1009);

SoHAnimSite* SoHAnimSite1010 = new SoHAnimSite();
SoHAnimSite1010->setUSE(QString("hanim_l_femoral_medial_epicn_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1010);

SoHAnimSite* SoHAnimSite1011 = new SoHAnimSite();
SoHAnimSite1011->setUSE(QString("hanim_r_femoral_medial_epicn_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1011);

SoHAnimSite* SoHAnimSite1012 = new SoHAnimSite();
SoHAnimSite1012->setUSE(QString("hanim_l_forefoot_tip"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1012);

SoHAnimSite* SoHAnimSite1013 = new SoHAnimSite();
SoHAnimSite1013->setUSE(QString("hanim_r_gonion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1013);

SoHAnimSite* SoHAnimSite1014 = new SoHAnimSite();
SoHAnimSite1014->setUSE(QString("hanim_l_gonion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1014);

SoHAnimSite* SoHAnimSite1015 = new SoHAnimSite();
SoHAnimSite1015->setUSE(QString("hanim_l_hand_tip"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1015);

SoHAnimSite* SoHAnimSite1016 = new SoHAnimSite();
SoHAnimSite1016->setUSE(QString("hanim_r_hand_tip"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1016);

SoHAnimSite* SoHAnimSite1017 = new SoHAnimSite();
SoHAnimSite1017->setUSE(QString("hanim_l_humeral_lateral_epicn_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1017);

SoHAnimSite* SoHAnimSite1018 = new SoHAnimSite();
SoHAnimSite1018->setUSE(QString("hanim_r_humeral_lateral_epicn_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1018);

SoHAnimSite* SoHAnimSite1019 = new SoHAnimSite();
SoHAnimSite1019->setUSE(QString("hanim_l_humeral_medial_epicn_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1019);

SoHAnimSite* SoHAnimSite1020 = new SoHAnimSite();
SoHAnimSite1020->setUSE(QString("hanim_r_humeral_medial_epicn_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1020);

SoHAnimSite* SoHAnimSite1021 = new SoHAnimSite();
SoHAnimSite1021->setUSE(QString("hanim_r_iliocristale_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1021);

SoHAnimSite* SoHAnimSite1022 = new SoHAnimSite();
SoHAnimSite1022->setUSE(QString("hanim_l_iliocristale_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1022);

SoHAnimSite* SoHAnimSite1023 = new SoHAnimSite();
SoHAnimSite1023->setUSE(QString("hanim_l_index_distal_tip"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1023);

SoHAnimSite* SoHAnimSite1024 = new SoHAnimSite();
SoHAnimSite1024->setUSE(QString("hanim_r_infraorbitale_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1024);

SoHAnimSite* SoHAnimSite1025 = new SoHAnimSite();
SoHAnimSite1025->setUSE(QString("hanim_l_infraorbitale_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1025);

SoHAnimSite* SoHAnimSite1026 = new SoHAnimSite();
SoHAnimSite1026->setUSE(QString("hanim_l_knee_crease_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1026);

SoHAnimSite* SoHAnimSite1027 = new SoHAnimSite();
SoHAnimSite1027->setUSE(QString("hanim_r_knee_crease_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1027);

SoHAnimSite* SoHAnimSite1028 = new SoHAnimSite();
SoHAnimSite1028->setUSE(QString("hanim_l_lateral_malleolus_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1028);

SoHAnimSite* SoHAnimSite1029 = new SoHAnimSite();
SoHAnimSite1029->setUSE(QString("hanim_r_lateral_malleolus_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1029);

SoHAnimSite* SoHAnimSite1030 = new SoHAnimSite();
SoHAnimSite1030->setUSE(QString("hanim_l_medial_malleolus_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1030);

SoHAnimSite* SoHAnimSite1031 = new SoHAnimSite();
SoHAnimSite1031->setUSE(QString("hanim_r_medial_malleolus_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1031);

SoHAnimSite* SoHAnimSite1032 = new SoHAnimSite();
SoHAnimSite1032->setUSE(QString("hanim_l_metacarpal_pha2_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1032);

SoHAnimSite* SoHAnimSite1033 = new SoHAnimSite();
SoHAnimSite1033->setUSE(QString("hanim_r_metacarpal_pha2_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1033);

SoHAnimSite* SoHAnimSite1034 = new SoHAnimSite();
SoHAnimSite1034->setUSE(QString("hanim_l_metacarpal_pha5_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1034);

SoHAnimSite* SoHAnimSite1035 = new SoHAnimSite();
SoHAnimSite1035->setUSE(QString("hanim_r_metacarpal_pha5_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1035);

SoHAnimSite* SoHAnimSite1036 = new SoHAnimSite();
SoHAnimSite1036->setUSE(QString("hanim_l_metatarsal_pha1_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1036);

SoHAnimSite* SoHAnimSite1037 = new SoHAnimSite();
SoHAnimSite1037->setUSE(QString("hanim_r_metatarsal_pha1_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1037);

SoHAnimSite* SoHAnimSite1038 = new SoHAnimSite();
SoHAnimSite1038->setUSE(QString("hanim_l_metatarsal_pha5_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1038);

SoHAnimSite* SoHAnimSite1039 = new SoHAnimSite();
SoHAnimSite1039->setUSE(QString("hanim_r_metatarsal_pha5_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1039);

SoHAnimSite* SoHAnimSite1040 = new SoHAnimSite();
SoHAnimSite1040->setUSE(QString("hanim_l_middistal_tip"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1040);

SoHAnimSite* SoHAnimSite1041 = new SoHAnimSite();
SoHAnimSite1041->setUSE(QString("hanim_r_middistal_tip"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1041);

SoHAnimSite* SoHAnimSite1042 = new SoHAnimSite();
SoHAnimSite1042->setUSE(QString("hanim_l_olecranon_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1042);

SoHAnimSite* SoHAnimSite1043 = new SoHAnimSite();
SoHAnimSite1043->setUSE(QString("hanim_r_olecranon_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1043);

SoHAnimSite* SoHAnimSite1044 = new SoHAnimSite();
SoHAnimSite1044->setUSE(QString("hanim_r_psis_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1044);

SoHAnimSite* SoHAnimSite1045 = new SoHAnimSite();
SoHAnimSite1045->setUSE(QString("hanim_l_psis_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1045);

SoHAnimSite* SoHAnimSite1046 = new SoHAnimSite();
SoHAnimSite1046->setUSE(QString("hanim_l_radial_styloid_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1046);

SoHAnimSite* SoHAnimSite1047 = new SoHAnimSite();
SoHAnimSite1047->setUSE(QString("hanim_r_radial_styloid_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1047);

SoHAnimSite* SoHAnimSite1048 = new SoHAnimSite();
SoHAnimSite1048->setUSE(QString("hanim_l_radiale_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1048);

SoHAnimSite* SoHAnimSite1049 = new SoHAnimSite();
SoHAnimSite1049->setUSE(QString("hanim_r_radiale_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1049);

SoHAnimSite* SoHAnimSite1050 = new SoHAnimSite();
SoHAnimSite1050->setUSE(QString("hanim_l_sphyrion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1050);

SoHAnimSite* SoHAnimSite1051 = new SoHAnimSite();
SoHAnimSite1051->setUSE(QString("hanim_r_sphyrion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1051);

SoHAnimSite* SoHAnimSite1052 = new SoHAnimSite();
SoHAnimSite1052->setUSE(QString("hanim_l_thumb_distal_tip"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1052);

SoHAnimSite* SoHAnimSite1053 = new SoHAnimSite();
SoHAnimSite1053->setUSE(QString("hanim_r_tragion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1053);

SoHAnimSite* SoHAnimSite1054 = new SoHAnimSite();
SoHAnimSite1054->setUSE(QString("hanim_l_tragion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1054);

SoHAnimSite* SoHAnimSite1055 = new SoHAnimSite();
SoHAnimSite1055->setUSE(QString("hanim_r_trochanterion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1055);

SoHAnimSite* SoHAnimSite1056 = new SoHAnimSite();
SoHAnimSite1056->setUSE(QString("hanim_l_trochanterion_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1056);

SoHAnimSite* SoHAnimSite1057 = new SoHAnimSite();
SoHAnimSite1057->setUSE(QString("hanim_l_ulnar_styloid_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1057);

SoHAnimSite* SoHAnimSite1058 = new SoHAnimSite();
SoHAnimSite1058->setUSE(QString("hanim_r_ulnar_styloid_pt"));
SoHAnimHumanoid95->setSites(*SoHAnimSite1058);

SoHAnimSite* SoHAnimSite1059 = new SoHAnimSite();
SoHAnimSite1059->setDEF(QString("hanim_DiamondManLOA_2_view"));
SoHAnimSite1059->X3DNode::setName(QString("DiamondManLOA_2_view"));
...
SoHAnimHumanoid95->setViewpoints(*SoHAnimSite1059);

SoNode18->addChild(*SoHAnimHumanoid95);

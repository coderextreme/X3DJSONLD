...
SoLayout227->setOffsetUnits(new QString[]{QString("WORLD"), QString("WORLD")}, 2);
SoLayout227->setScaleMode(new QString[]{QString("NONE"), QString("NONE")}, 2);
SoLayout227->setSize(new float[]{0.4,0.6}, 2);
SoLayout227->setSizeUnits(new QString[]{QString("WORLD"), QString("WORLD")}, 2);

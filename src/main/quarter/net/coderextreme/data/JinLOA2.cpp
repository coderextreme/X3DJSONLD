...
Someta3->setContent(QString("JinLOA2.x3d"));
...
Someta8->setContent(QString("Mon, 15 Sep 2025 05:20:24 GMT"));
...
Someta10->setContent(QString("rescale all contained length values from inches to meters"));
...
Someta14->setContent(QString("JinOriginalLOA2.x3d"));
Sohead1->addMeta(*Someta14);

Someta* Someta15 = new Someta();
Someta15->setName(QString("identifier"));
Someta15->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinLOA2.x3d"));
...
SoNode19->addChild(*SoViewpoint23);
...
SoNode19->addChild(*SoHAnimHumanoid24);

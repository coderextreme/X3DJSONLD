...
SoAnchor62->setDescription(QString("Back to front view"));
...
SoInline64->setUrl(new QString[]{QString("../data/gridBack.json"), QString("../data/gridBack.x3d"), QString("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.x3d"), QString("gridBack.wrl"), QString("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.wrl")}, 5);
...
SoAnchor73->setDescription(QString("ArtDeco00"));
...
SoAnchor87->setDescription(QString("ArtDeco01"));
...
SoAnchor101->setDescription(QString("ArtDeco02"));
...
SoAnchor115->setDescription(QString("ArtDeco03"));
...
SoAnchor129->setDescription(QString("ArtDeco04"));
...
SoAnchor143->setDescription(QString("ArtDeco05"));
...
SoAnchor157->setDescription(QString("ArtDeco06"));
...
SoAnchor171->setDescription(QString("ArtDeco07"));
...
SoAnchor185->setDescription(QString("ArtDeco08"));
...
SoAnchor199->setDescription(QString("ArtDeco09"));
...
SoAnchor213->setDescription(QString("ArtDeco10"));
...
SoAnchor227->setDescription(QString("ArtDeco11"));
...
SoAnchor241->setDescription(QString("ArtDeco12"));
...
SoAnchor255->setDescription(QString("ArtDeco13"));
...
SoAnchor269->setDescription(QString("ArtDeco14"));
...
SoAnchor283->setDescription(QString("ArtDeco15"));
...
SoAnchor297->setDescription(QString("ArtDeco16"));
...
SoAnchor311->setDescription(QString("ArtDeco17"));
...
SoAnchor325->setDescription(QString("ArtDeco18"));
...
SoAnchor339->setDescription(QString("ArtDeco19"));
...
SoAnchor353->setDescription(QString("ArtDeco20"));
...
SoAnchor367->setDescription(QString("ArtDeco21"));
...
SoAnchor381->setDescription(QString("ArtDeco22"));
...
SoAnchor395->setDescription(QString("ArtDeco23"));
...
SoAnchor409->setDescription(QString("ArtDeco24"));
...
SoAnchor423->setDescription(QString("ArtDeco25"));
...
SoAnchor437->setDescription(QString("ArtDeco26"));
...
SoAnchor451->setDescription(QString("ArtDeco27"));
...
SoAnchor465->setDescription(QString("ArtDeco28"));
...
SoAnchor479->setDescription(QString("ArtDeco29"));
...
SoAnchor493->setDescription(QString("ArtDeco30"));
...
SoAnchor507->setDescription(QString("ArtDeco31"));
...
SoAnchor521->setDescription(QString("ArtDeco32"));
...
SoAnchor535->setDescription(QString("ArtDeco33"));
...
SoAnchor549->setDescription(QString("ArtDeco34"));

...
Someta3->setContent(QString("KoreanCharacter03Hyun.x3d"));
...
Someta10->setContent(QString("../Poses/images/HAnimPoseExampleKoreanCharacter03Hyun.png"));
...
Someta14->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter03Hyun.x3d"));
...
SoWorldInfo21->setTitle(QString("KoreanCharacter03Hyun.x3d"));
...
SoViewpoint23->setDescription(QString("Hyun"));
...
SoHAnimHumanoid24->X3DNode::setName(QString("Hyun"));
SoHAnimHumanoid24->setDEF(QString("hanim_Hyun"));
...
SoHAnimJoint32->setCenter(new float[]{0.0,31.43,-0.5601});
...
SoTransform34->setTranslation(new float[]{0.0,31.43,-0.5601});
...
SoImageTexture38->setDEF(QString("HyunTextureAtlas"));
SoImageTexture38->setUrl(new QString[]{QString("images/Hyun.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Hyun.png")}, 2);
...
SoHAnimJoint42->setCenter(new float[]{3.551,29.33,-0.1267});
...
SoTransform44->setTranslation(new float[]{3.551,29.33,-0.1267});
...
SoImageTexture48->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint52->setCenter(new float[]{3.71,15.48,-0.1446});
...
SoTransform54->setTranslation(new float[]{3.71,15.48,-0.1446});
...
SoImageTexture58->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint62->setCenter(new float[]{3.388,3.168,-0.537});
...
SoTransform64->setTranslation(new float[]{3.388,3.168,-0.537});
...
SoImageTexture68->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint72->setCenter(new float[]{3.388,2.908,0.7441});
...
SoTransform74->setTranslation(new float[]{3.388,2.908,0.7441});
...
SoImageTexture78->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint82->setCenter(new float[]{-3.551,29.33,-0.1267});
...
SoTransform84->setTranslation(new float[]{-3.551,29.33,-0.1267});
...
SoImageTexture88->setUSE(QString("HyunTextureAtlas"));
...
SoCoordinate90->setPoint(new float[]{-2.616,1.989,0.0,-1.452,1.989,2.836,1.163,1.989,3.536,2.975,1.989,1.574,2.975,1.989,-1.574,1.163,1.989,-3.536,-1.452,1.989,-2.836,-2.616,-1.325,0.0,-1.452,-1.325,2.836,1.163,-1.325,3.536,2.975,-1.325,1.574,2.975,-1.325,-1.574,1.163,-1.325,-3.536,-1.452,-1.325,-2.836,-2.616,-7.064,0.0,-1.452,-7.064,2.836,1.163,-7.064,3.536,2.975,-7.064,1.574,2.975,-7.064,-1.574,1.163,-7.064,-3.536,-1.452,-7.064,-2.836,-2.975,-11.91,0.0,-1.676,-11.91,3.165,1.243,-11.91,3.947,2.964,-11.91,1.756,2.964,-11.91,-1.756,1.243,-11.91,-3.947,-1.676,-11.91,-3.165,-1.812,3.747,0.0,-0.9506,3.747,2.098,0.9843,3.747,2.616,2.536,3.747,1.164,2.536,3.747,-1.164,0.9843,3.747,-2.616,-0.9506,3.747,-2.098,-0.9661,-14.81,2.027,-1.798,-14.81,0.0,0.9034,-14.81,2.528,2.006,-14.81,1.125,2.006,-14.81,-1.125,0.9034,-14.81,-2.528,-0.9661,-14.81,-2.027,0.2983,-16.16,0.0}, 129);
SoIndexedFaceSet89->setCoord(*SoCoordinate90);

SoTextureCoordinate* SoTextureCoordinate91 = new SoTextureCoordinate();
SoTextureCoordinate101->setPoint(new float[]{0.6566,0.2462,0.6181,0.2462,0.5796,0.2462,0.5411,0.2462,0.5026,0.2462,0.4641,0.2462,0.6951,0.2462,0.6566,0.2951,0.6181,0.2951,0.5796,0.2951,0.5411,0.2951,0.5026,0.2951,0.4641,0.2951,0.6951,0.2951,0.6566,0.3439,0.6181,0.3439,0.5796,0.3439,0.5411,0.3439,0.5026,0.3439,0.4641,0.3439,0.6951,0.3439,0.6566,0.3927,0.6181,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.6951,0.3927,0.4256,0.2462,0.4256,0.2951,0.4256,0.2462,0.4256,0.3439,0.4256,0.2951,0.4256,0.3927,0.4256,0.3439,0.4256,0.3927,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927,0.6566,0.2462,0.6181,0.2462,0.6951,0.2462,0.5796,0.2462,0.5411,0.2462,0.5026,0.2462,0.4641,0.2462,0.4256,0.2462,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927}, 152);
...
SoHAnimJoint102->setCenter(new float[]{-3.388,3.168,-0.537});
...
SoTransform104->setTranslation(new float[]{-3.388,3.168,-0.537});
...
SoImageTexture108->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint112->setCenter(new float[]{-3.388,2.908,0.7441});
...
SoTransform114->setTranslation(new float[]{-3.388,2.908,0.7441});
...
SoImageTexture118->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint122->setCenter(new float[]{0.0,26.58,-0.5601});
...
SoTransform124->setTranslation(new float[]{0.0,26.58,-0.5601});
...
SoImageTexture128->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint132->setCenter(new float[]{5.502,45.779999,-0.3559});
...
SoTransform134->setTranslation(new float[]{5.502,45.779999,-0.3559});
...
SoImageTexture138->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint142->setCenter(new float[]{6.735,35.669998,-0.4487});
...
SoTransform144->setTranslation(new float[]{6.735,35.669998,-0.4487});
...
SoImageTexture148->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint152->setCenter(new float[]{6.432,27.83,-0.1589});
...
SoTransform154->setTranslation(new float[]{6.432,27.83,-0.1589});
...
SoImageTexture158->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint162->setCenter(new float[]{-5.502,45.779999,-0.3559});
...
SoTransform164->setTranslation(new float[]{-5.502,45.779999,-0.3559});
...
SoImageTexture168->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint172->setCenter(new float[]{-6.735,35.669998,-0.4487});
...
SoTransform174->setTranslation(new float[]{-6.735,35.669998,-0.4487});
...
SoImageTexture178->setUSE(QString("HyunTextureAtlas"));
...
SoCoordinate180->setPoint(new float[]{-0.133,0.4969,-1.018,-0.9633,0.5042,-0.2287,-0.4907,0.5001,0.9186,0.6318,0.4904,0.8386,0.8529,0.4884,-0.3582,-0.0877,-0.5196,-1.436,-1.261,-0.5094,-0.3773,-0.5932,-0.515,1.436,0.9931,-0.5288,1.309,1.306,-0.5317,-0.5821,-0.1173,-2.866,-1.42,-1.37,-2.855,-0.3733,-0.6813,-2.348,1.422,1.012,-2.362,1.297,1.37,-2.879,-0.576,-0.1304,-7.472,-1.27,-1.044,-7.464,-0.1131,-0.5241,-7.468,1.334,0.7111,-7.479,1.217,0.9544,-7.481,-0.3029,-0.0956,-8.023,-0.7824,-0.7196,-8.018,0.0074,-0.3644,-8.021,0.9211,0.4791,-8.028,0.841,0.6452,-8.03,-0.1223}, 75);
SoIndexedFaceSet179->setCoord(*SoCoordinate180);

SoTextureCoordinate* SoTextureCoordinate181 = new SoTextureCoordinate();
SoTextureCoordinate181->setPoint(new float[]{0.2667,0.6308,0.2522,0.6308,0.2052,0.6308,0.22,0.6308,0.2355,0.6308,0.266,0.6397,0.2508,0.6397,0.2066,0.6397,0.2205,0.6397,0.2357,0.6397,0.2662,0.6601,0.251,0.6601,0.206,0.6557,0.2208,0.6557,0.2354,0.6601,0.2679,0.7003,0.2509,0.7003,0.2072,0.7003,0.2192,0.7003,0.2343,0.7003,0.2512,0.7051,0.2692,0.7051,0.2072,0.7051,0.219,0.7051,0.2329,0.7051,0.1923,0.6308,0.1778,0.6308,0.1923,0.6308,0.1916,0.6397,0.1916,0.6397,0.1918,0.6601,0.1918,0.6601,0.1935,0.7003,0.1768,0.7051,0.1948,0.7051,0.1935,0.7003,0.1948,0.7051}, 74);
...
SoHAnimJoint182->setCenter(new float[]{-6.432,27.83,-0.1589});
...
SoTransform184->setTranslation(new float[]{-6.432,27.83,-0.1589});
...
SoImageTexture188->setUSE(QString("HyunTextureAtlas"));
...
SoCoordinate190->setPoint(new float[]{-1.076,0.3804,0.7047,-1.042,0.395,-1.192,0.6516,0.2878,0.7874,0.6592,0.2892,-1.133,0.8366,-0.2556,1.306,-1.437,-0.0511,1.226,-1.385,-0.0228,-1.757,0.9384,-0.2412,-1.753,0.7136,-1.939,2.128,-1.733,-1.733,1.838,-1.681,-1.704,-2.128,1.039,-2.028,-1.986,0.4691,-3.205,1.497,-0.8189,-3.398,1.547,-0.7668,-3.369,-1.83,0.6579,-3.218,-1.709,0.9322,-0.2429,-0.1654,1.437,-1.988,1.715,1.733,-0.5679,0.0513,1.7,-0.6266,1.665,1.443,-1.986,0.1217,0.9271,-2.022,-0.178,-1.042,0.395,-1.192,0.6592,0.2892,-1.133,0.6516,0.2878,0.7874,-1.076,0.3804,0.7047,-1.042,0.395,-1.192,0.6516,0.2878,0.7874}, 84);
...
SoHAnimJoint192->setCenter(new float[]{0.0,35.77,-0.5028});
...
SoTransform194->setTranslation(new float[]{0.0,35.77,-0.5028});
...
SoImageTexture198->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint202->setCenter(new float[]{0.0,49.98,-0.5228});
...
SoTransform204->setTranslation(new float[]{0.0,49.98,-0.5228});
...
SoImageTexture208->setUSE(QString("HyunTextureAtlas"));
...
SoEXPORT230->setAS(QString("KoreanCharacter03Hyun"));
SoEXPORT230->setLocalDEF(QString("hanim_Hyun"));

...
Someta13->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter03Hyun.x3d"));
...
SoWorldInfo20->setTitle(QString("KoreanCharacter03Hyun.x3d"));
...
SoViewpoint22->setDescription(QString("Hyun"));
...
SoHAnimHumanoid23->X3DNode::setName(QString("Hyun"));
SoHAnimHumanoid23->setDEF(QString("hanim_Hyun"));
...
SoHAnimJoint31->setCenter(new float[]{0.0,31.43,-0.5601});
...
SoTransform33->setTranslation(new float[]{0.0,31.43,-0.5601});
...
SoImageTexture37->setDEF(QString("HyunTextureAtlas"));
SoImageTexture37->setUrl(new QString[]{QString("images/Hyun.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Hyun.png")}, 2);
...
SoHAnimJoint41->setCenter(new float[]{3.551,29.33,-0.1267});
...
SoTransform43->setTranslation(new float[]{3.551,29.33,-0.1267});
...
SoImageTexture47->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint51->setCenter(new float[]{3.71,15.48,-0.1446});
...
SoTransform53->setTranslation(new float[]{3.71,15.48,-0.1446});
...
SoImageTexture57->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint61->setCenter(new float[]{3.388,3.168,-0.537});
...
SoTransform63->setTranslation(new float[]{3.388,3.168,-0.537});
...
SoImageTexture67->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint71->setCenter(new float[]{3.388,2.908,0.7441});
...
SoTransform73->setTranslation(new float[]{3.388,2.908,0.7441});
...
SoImageTexture77->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint81->setCenter(new float[]{-3.551,29.33,-0.1267});
...
SoTransform83->setTranslation(new float[]{-3.551,29.33,-0.1267});
...
SoImageTexture87->setUSE(QString("HyunTextureAtlas"));
...
SoTextureCoordinate90->setPoint(new float[]{0.7912,0.3382,0.7912,0.364,0.7912,0.2804,0.7912,0.234,0.7912,0.234,0.7912,0.2804,0.7912,0.3382,0.7762,0.388,0.748,0.3532,0.748,0.388,0.7762,0.3532,0.748,0.275,0.7762,0.275,0.748,0.2209,0.7762,0.2209,0.748,0.2209,0.7762,0.2209,0.748,0.275,0.7762,0.275,0.748,0.3532,0.7762,0.3532,0.6856,0.3532,0.6856,0.388,0.6856,0.275,0.6856,0.2209,0.6856,0.2209,0.6856,0.275,0.6856,0.3532,0.6315,0.3608,0.6315,0.3996,0.6315,0.2735,0.6315,0.222,0.6315,0.222,0.6315,0.2735,0.6315,0.3608,0.6248,0.3387,0.6248,0.3636,0.6248,0.2828,0.6248,0.2498,0.6248,0.2498,0.6248,0.2828,0.6248,0.3387,0.6133,0.3009}, 86);
...
SoHAnimJoint91->setCenter(new float[]{-3.71,15.48,-0.1446});
...
SoTransform93->setTranslation(new float[]{-3.71,15.48,-0.1446});
...
SoImageTexture97->setUSE(QString("HyunTextureAtlas"));
...
SoCoordinate99->setPoint(new float[]{-2.616,-0.0823,0.0541,-1.452,-0.0823,2.89,1.163,-0.0823,3.59,2.975,-0.0823,1.628,2.975,-0.0823,-1.52,1.163,-0.0823,-3.482,-1.452,-0.0823,-2.782,-2.616,-3.395,0.0541,-1.452,-3.395,2.89,1.163,-3.395,3.59,2.975,-3.395,1.628,2.975,-3.395,-1.52,1.163,-3.395,-3.482,-1.452,-3.395,-2.782,-2.708,-6.91,0.0541,-1.545,-6.91,2.89,1.071,-6.91,3.59,2.882,-6.91,1.628,2.882,-6.91,-1.52,1.071,-6.91,-3.482,-1.545,-6.91,-2.782,-2.975,-11.77,0.0541,-1.676,-11.77,3.219,1.243,-11.77,4.001,2.964,-11.77,1.81,2.964,-11.77,-1.702,1.243,-11.77,-3.892,-1.676,-11.77,-3.111,-1.896,-7.789,0.0541,-1.003,-7.789,2.23,1.003,-7.789,2.767,2.326,-7.789,1.261,2.326,-7.789,-1.153,1.003,-7.789,-2.659,-1.003,-7.789,-2.122,-1.905,-9.68,0.0541,-1.082,-9.68,1.782,0.7654,-9.68,2.209,2.247,-9.68,1.013,2.247,-9.68,-0.9049,0.7654,-9.68,-2.101,-1.082,-9.68,-1.674,-1.812,1.676,0.0541,-0.9506,1.676,2.152,0.9843,1.676,2.67,2.536,1.676,1.218,2.536,1.676,-1.11,0.9843,1.676,-2.562,-0.9506,1.676,-2.044,-1.628,-12.93,0.0541,-0.9097,-12.93,1.709,0.7038,-12.93,2.082,1.998,-12.93,1.037,1.998,-12.93,-0.7834,0.7038,-12.93,-1.828,-0.9097,-12.93,-1.455,-0.5546,-13.79,0.0541,-0.2406,-13.79,0.8599,0.465,-13.79,1.023,1.031,-13.79,0.5662,1.031,-13.79,-0.3121,0.465,-13.79,-0.7688,-0.2406,-13.79,-0.6058}, 189);
SoIndexedFaceSet98->setCoord(*SoCoordinate99);

SoTextureCoordinate* SoTextureCoordinate100 = new SoTextureCoordinate();
SoTextureCoordinate100->setPoint(new float[]{0.6566,0.2462,0.6181,0.2462,0.5796,0.2462,0.5411,0.2462,0.5026,0.2462,0.4641,0.2462,0.6951,0.2462,0.6566,0.2951,0.6181,0.2951,0.5796,0.2951,0.5411,0.2951,0.5026,0.2951,0.4641,0.2951,0.6951,0.2951,0.6566,0.3439,0.6181,0.3439,0.5796,0.3439,0.5411,0.3439,0.5026,0.3439,0.4641,0.3439,0.6951,0.3439,0.6566,0.3927,0.6181,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.6951,0.3927,0.4256,0.2462,0.4256,0.2951,0.4256,0.2462,0.4256,0.3439,0.4256,0.2951,0.4256,0.3927,0.4256,0.3439,0.4256,0.3927,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927,0.6566,0.2462,0.6181,0.2462,0.6951,0.2462,0.5796,0.2462,0.5411,0.2462,0.5026,0.2462,0.4641,0.2462,0.4256,0.2462,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927,0.6566,0.3927,0.6181,0.3927,0.6951,0.3927,0.5796,0.3927,0.5411,0.3927,0.5026,0.3927,0.4641,0.3927,0.4256,0.3927}, 152);
...
SoHAnimJoint101->setCenter(new float[]{-3.388,3.168,-0.537});
...
SoTransform103->setTranslation(new float[]{-3.388,3.168,-0.537});
...
SoImageTexture107->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint111->setCenter(new float[]{-3.388,2.908,0.7441});
...
SoTransform113->setTranslation(new float[]{-3.388,2.908,0.7441});
...
SoImageTexture117->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint121->setCenter(new float[]{0.0,26.58,-0.5601});
...
SoTransform123->setTranslation(new float[]{0.0,26.58,-0.5601});
...
SoImageTexture127->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint131->setCenter(new float[]{5.502,45.779999,-0.3559});
...
SoTransform133->setTranslation(new float[]{5.502,45.779999,-0.3559});
...
SoImageTexture137->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint141->setCenter(new float[]{6.735,35.669998,-0.4487});
...
SoTransform143->setTranslation(new float[]{6.735,35.669998,-0.4487});
...
SoImageTexture147->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint151->setCenter(new float[]{6.432,27.83,-0.1589});
...
SoTransform153->setTranslation(new float[]{6.432,27.83,-0.1589});
...
SoImageTexture157->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint161->setCenter(new float[]{-5.502,45.779999,-0.3559});
...
SoTransform163->setTranslation(new float[]{-5.502,45.779999,-0.3559});
...
SoImageTexture167->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint171->setCenter(new float[]{-6.735,35.669998,-0.4487});
...
SoTransform173->setTranslation(new float[]{-6.735,35.669998,-0.4487});
...
SoImageTexture177->setUSE(QString("HyunTextureAtlas"));
...
SoCoordinate179->setPoint(new float[]{-0.133,0.4969,-1.018,-0.9633,0.5042,-0.2287,-0.4907,0.5001,0.9186,0.6318,0.4904,0.8386,0.8529,0.4884,-0.3582,-0.0877,-0.5196,-1.436,-1.261,-0.5094,-0.3773,-0.5932,-0.515,1.436,0.9931,-0.5288,1.309,1.306,-0.5317,-0.5821,-0.1173,-2.866,-1.42,-1.37,-2.855,-0.3733,-0.6813,-2.348,1.422,1.012,-2.362,1.297,1.37,-2.879,-0.576,-0.1304,-7.472,-1.27,-1.044,-7.464,-0.1131,-0.5241,-7.468,1.334,0.7111,-7.479,1.217,0.9544,-7.481,-0.3029,-0.0956,-8.023,-0.7824,-0.7196,-8.018,0.0074,-0.3644,-8.021,0.9211,0.4791,-8.028,0.841,0.6452,-8.03,-0.1223}, 75);
SoIndexedFaceSet178->setCoord(*SoCoordinate179);

SoTextureCoordinate* SoTextureCoordinate180 = new SoTextureCoordinate();
SoTextureCoordinate180->setPoint(new float[]{0.2667,0.6308,0.2522,0.6308,0.2052,0.6308,0.22,0.6308,0.2355,0.6308,0.266,0.6397,0.2508,0.6397,0.2066,0.6397,0.2205,0.6397,0.2357,0.6397,0.2662,0.6601,0.251,0.6601,0.206,0.6557,0.2208,0.6557,0.2354,0.6601,0.2679,0.7003,0.2509,0.7003,0.2072,0.7003,0.2192,0.7003,0.2343,0.7003,0.2512,0.7051,0.2692,0.7051,0.2072,0.7051,0.219,0.7051,0.2329,0.7051,0.1923,0.6308,0.1778,0.6308,0.1923,0.6308,0.1916,0.6397,0.1916,0.6397,0.1918,0.6601,0.1918,0.6601,0.1935,0.7003,0.1768,0.7051,0.1948,0.7051,0.1935,0.7003,0.1948,0.7051}, 74);
...
SoHAnimJoint181->setCenter(new float[]{-6.432,27.83,-0.1589});
...
SoTransform183->setTranslation(new float[]{-6.432,27.83,-0.1589});
...
SoImageTexture187->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint191->setCenter(new float[]{0.0,35.77,-0.5028});
...
SoTransform193->setTranslation(new float[]{0.0,35.77,-0.5028});
...
SoImageTexture197->setUSE(QString("HyunTextureAtlas"));
...
SoHAnimJoint201->setCenter(new float[]{0.0,49.98,-0.5228});
...
SoTransform203->setTranslation(new float[]{0.0,49.98,-0.5228});
...
SoImageTexture207->setUSE(QString("HyunTextureAtlas"));

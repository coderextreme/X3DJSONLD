...
Someta13->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter04Young.x3d"));
...
SoWorldInfo20->setTitle(QString("KoreanCharacter04Young.x3d"));
...
SoViewpoint22->setDescription(QString("Young"));
...
SoHAnimHumanoid23->X3DNode::setName(QString("Young"));
SoHAnimHumanoid23->setDEF(QString("hanim_Young"));
...
SoHAnimJoint31->setCenter(new float[]{0.0,31.540001,-0.3172});
...
SoTransform33->setTranslation(new float[]{0.0,31.540001,-0.3172});
...
SoImageTexture37->setDEF(QString("YoungTextureAtlas"));
SoImageTexture37->setUrl(new QString[]{QString("images/Young.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Young.png")}, 2);
...
SoHAnimJoint41->setCenter(new float[]{3.504,29.040001,-0.4027});
...
SoTransform43->setTranslation(new float[]{3.504,29.040001,-0.4027});
...
SoImageTexture47->setUSE(QString("YoungTextureAtlas"));
...
SoHAnimJoint51->setCenter(new float[]{3.414,14.95,-0.4549});
...
SoTransform53->setTranslation(new float[]{3.414,14.95,-0.4549});
...
SoImageTexture57->setUSE(QString("YoungTextureAtlas"));
...
SoCoordinate59->setPoint(new float[]{0.6335,1.142,0.0206,0.3202,1.142,0.8245,-0.3837,1.142,0.9871,-0.9483,1.142,0.5315,-0.9483,1.142,-0.3447,-0.3837,1.142,-0.8003,0.3202,1.142,-0.6377,2.06,-3.778,0.0206,1.287,-2.905,1.78,1.089,-1.147,2.133,1.867,-1.397,0.0206,-0.715,-2.905,2.263,-0.6583,-1.147,2.559,-1.987,-3.778,1.106,-2.06,-1.397,0.8632,-1.987,-4.457,-1.205,-2.06,-1.397,-0.822,-0.715,-4.457,-2.559,-0.6583,-1.397,-2.087,1.287,-4.457,-2.076,1.089,-1.397,-1.661,0.9877,0.2851,1.672,1.704,0.2851,0.0206,-0.622,0.2851,2.043,-1.913,0.2851,1.002,-1.913,0.2851,-0.8149,-0.622,0.2851,-1.817,0.9877,0.2851,-1.445,1.417,-11.1,0.0028,0.8123,-11.09,1.38,-0.5457,-11.09,1.72,-1.635,-11.1,0.767,-1.635,-11.11,-0.8605,-0.5457,-11.11,-1.535,0.8123,-11.11,-1.195,0.6234,-12.52,0.021,0.3177,-12.52,0.7175,-0.3691,-12.52,0.8896,-0.9199,-12.52,0.4076,-0.9199,-12.53,-0.4156,-0.3691,-12.53,-0.7569,0.3177,-12.53,-0.5849}, 126);
...
SoHAnimJoint61->setCenter(new float[]{3.18,3.449,-0.3088});
...
SoTransform63->setTranslation(new float[]{3.18,3.449,-0.3088});
...
SoImageTexture67->setUSE(QString("YoungTextureAtlas"));
...
SoHAnimJoint71->setCenter(new float[]{3.18,3.189,0.9724});
...
SoTransform73->setTranslation(new float[]{3.18,3.189,0.9724});
...
SoImageTexture77->setUSE(QString("YoungTextureAtlas"));
...
SoCoordinate79->setPoint(new float[]{2.548,-1.416,-0.8988,1.819,-3.176,-0.8988,0.0,0.2435,0.2718,1.78,-0.2627,-0.8989,1.476,0.0025,-0.0134,-2.548,-1.416,-0.8988,-1.78,-0.2627,-0.8989,-1.819,-3.176,-0.8988,-1.476,0.0025,-0.0134,0.0,-3.176,-0.8988,1.863,-3.176,0.8155,-1.863,-3.176,0.8155,0.0,-3.176,0.8155,2.094,-1.441,-1.699,1.524,-2.561,-1.699,0.0,-2.561,-1.699,-1.524,-2.561,-1.699,-2
...
SoHAnimJoint121->setCenter(new float[]{0.0,27.07,-0.3172});
...
SoTransform123->setTranslation(new float[]{0.0,27.07,-0.3172});
...
SoImageTexture127->setUSE(QString("YoungTextureAtlas"));
...
SoHAnimJoint131->setCenter(new float[]{5.441,45.830002,0.1786});
...
SoTransform133->setTranslation(new float[]{5.441,45.830002,0.1786});
...
SoImageTexture137->setUSE(QString("YoungTextureAtlas"));
...
SoHAnimJoint141->setCenter(new float[]{6.823,36.080002,0.08607});
...
SoTransform143->setTranslation(new float[]{6.823,36.080002,0.08607});
...
SoImageTexture147->setUSE(QString("YoungTextureAtlas"));
...
SoHAnimJoint151->setCenter(new float[]{6.915,28.41,0.3752});
...
SoTransform153->setTranslation(new float[]{6.915,28.41,0.3752});
...
SoImageTexture157->setUSE(QString("YoungTextureAtlas"));
...
SoHAnimJoint161->setCenter(new float[]{-5.441,45.830002,0.1786});
...
SoTransform163->setTranslation(new float[]{-5.441,45.830002,0.1786});
...
SoImageTexture167->setUSE(QString("YoungTextureAtlas"));
...
SoCoordinate169->setPoint(new float[]{-1.592,1.817,-1.481,-2.611,1.817,0.0297,-1.489,1.817,1.466,0.2232,1.817,0.8423,0.1596,1.817,-0.9787,-1.794,0.7023,-2.036,-3.201,0.7023,0.0503,-1.652,0.7023,2.033,0.7128,0.7023,1.173,0.625,0.7023,-1.342,-1.794,-1.513,-2.036,-3.201,-1.513,0.0503,-1.652,-1.513,2.033,0.7128,-1.513,1.173,0.625,-1.513,-1.342,-1.836,-2.461,-2.153,-3.325,-2.461,0.0546,-1.686,-2.461,2.153,0.8158,-2.461,1.242,0.7229,-2.461,-1.419,-1.369,-0.8329,-1.709,-2.445,-0.8329,-0.4004,-1.888,-0.8329,1.436,-0.4682,-0.8329,1.262,-0.1476,-0.8329,-0.6818,-1.431,-5.952,-1.383,-2.548,-5.952,-0.3332,-1.97,-5.952,1.14,-0.495,-5.952,1.0,-0.162,-5.952,-0.5588,-1.466,-9.522,-1.332,-2.541,-9.522,-0.3218,-1.985,-9.522,1.096,-0.565,-9.522,0.9618,-0.2445,-9.522,-0.539,-1.422,-10.01,-0.792,-2.053,-10.01,-0.1998,-1.726,-10.01,0.6312,-0.8942,-10.01,0.5525,-0.7063,-10.01,-0.3271}, 120);
...
SoHAnimJoint171->setCenter(new float[]{-6.823,36.080002,0.08607});
...
SoTransform173->setTranslation(new float[]{-6.823,36.080002,0.08607});
...
SoImageTexture177->setUSE(QString("YoungTextureAtlas"));
...
SoHAnimJoint181->setCenter(new float[]{-6.915,28.41,0.3752});
...
SoTransform183->setTranslation(new float[]{-6.915,28.41,0.3752});
...
SoImageTexture187->setUSE(QString("YoungTextureAtlas"));
...
SoHAnimJoint191->setCenter(new float[]{0.0,35.75,-0.445});
...
SoTransform193->setTranslation(new float[]{0.0,35.75,-0.445});
...
SoImageTexture197->setUSE(QString("YoungTextureAtlas"));
...
SoHAnimJoint201->setCenter(new float[]{0.0,50.470001,-0.1481});
...
SoTransform203->setTranslation(new float[]{0.0,50.470001,-0.1481});
...
SoImageTexture207->setUSE(QString("YoungTextureAtlas"));

...
SoText21->setString(new QString[]{QString("I don't think so"), QString("he said \"Hi\"")}, 2);
...
SoText26->setString(new QString[]{QString("I don't think so"), QString("he said \"Hi\"")}, 2);

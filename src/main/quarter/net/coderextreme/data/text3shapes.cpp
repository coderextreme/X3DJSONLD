...
Someta4->setContent(QString("text3shapes.x3d"));
Sohead1->addMeta(*Someta4);

Someta* Someta5 = new Someta();
Someta5->setName(QString("identifier"));
Someta5->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/data/text3shapes.x3d"));
Sohead1->addMeta(*Someta5);

Someta* Someta6 = new Someta();
Someta6->setName(QString("description"));
Someta6->setContent(QString("3 text shapes"));
...
SoText16->setString(new QString[]{QString("Node2"), QString("\\\\\\\\\\\\Node2")}, 2);
...
SoText21->setString(new QString[]{QString("Node3 \\\\\\\\ \\\\ Node3\"\"\"")}, 1);

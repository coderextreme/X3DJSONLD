...
Someta10->setContent(QString("bumpyfreewrl.x3d"));
...
Someta14->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/data/bumpfreewrl.x3d"));
...
SoComposedShader32->setDEF(QString("freewrlShader"));
...
Sofield34->setName(QString("fw_textureCoordGenType"));
...
SoShaderPart44->setUrl(new QString[]{QString("../shaders/freewrl_flowers_chromatic.vs"), QString("https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs")}, 2);
SoShaderPart44->setType(QString("VERTEX"));
SoComposedShader32->setParts(*SoShaderPart44);

SoShaderPart* SoShaderPart45 = new SoShaderPart();
SoShaderPart45->setUrl(new QString[]{QString("../shaders/freewrl_bubbles.fs"), QString("https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_bubbles.fs")}, 2);

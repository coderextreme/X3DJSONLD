...
Someta2->setContent(QString("WinterAndSpringAuthorsAllTitleBox.x3d"));
Sohead1->addMeta(*Someta2);

Someta* Someta3 = new Someta();
Someta3->setName(QString("description"));
Someta3->setContent(QString("Credits for scene authors."));
...
Someta9->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringAuthorsAllTitleBox.x3d"));
...
SoWorldInfo11->setTitle(QString("WinterAndSpringAuthorsAllTitleBox.x3d"));
...
SoViewpoint12->setDescription(QString("Look at Authors title"));
SoViewpoint12->setPosition(new float[]{10.0,11.0,0.0});
...
SoTransform13->setDEF(QString("WSAuthorsTitle"));
SoTransform13->setTranslation(new float[]{10.0,10.0,-5.0});
...
SoImageTexture17->setUrl(new QString[]{QString("images/WSAuthorsAll.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSAuthorsAll.png")}, 2);

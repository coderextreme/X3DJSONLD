...
Someta3->setContent(QString("Tongue.x3d"));
Sohead1->addMeta(*Someta3);

Someta* Someta4 = new Someta();
Someta4->setName(QString("description"));
Someta4->setContent(QString("Facial Action Coding System (FACS) example for Action Unit (AU) 27, Mouth Stretch Morpher, Tongue Derivated."));
Sohead1->addMeta(*Someta4);

Someta* Someta5 = new Someta();
Someta5->setName(QString("creator"));
Someta5->setContent(QString("Yujin Jung"));
Sohead1->addMeta(*Someta5);

Someta* Someta6 = new Someta();
Someta6->setName(QString("translator"));
Someta6->setContent(QString("Chul Hee Jung"));
Sohead1->addMeta(*Someta6);

Someta* Someta7 = new Someta();
Someta7->setName(QString("translator"));
Someta7->setContent(QString("Myeong Won Lee"));
Sohead1->addMeta(*Someta7);

Someta* Someta8 = new Someta();
Someta8->setName(QString("created"));
Someta8->setContent(QString("25 April 2022"));
Sohead1->addMeta(*Someta8);

Someta* Someta9 = new Someta();
Someta9->setName(QString("modified"));
Someta9->setContent(QString("27 October 2024"));
Sohead1->addMeta(*Someta9);

Someta* Someta10 = new Someta();
Someta10->setName(QString("translator"));
Someta10->setContent(QString("Don Brutzman"));
...
Someta12->setContent(QString("https://en.wikipedia.org/wiki/Facial_Action_Coding_System"));
Sohead1->addMeta(*Someta12);

Someta* Someta13 = new Someta();
Someta13->setName(QString("reference"));
Someta13->setContent(QString("https://web.cs.wpi.edu/~matt/courses/cs563/talks/face_anim/ekman.html"));
Sohead1->addMeta(*Someta13);

Someta* Someta14 = new Someta();
Someta14->setName(QString("reference"));
Someta14->setContent(QString("Bryn Farnsworth, FACS Visual Guidebook https://imotions.com/blog/learning/research-fundamentals/facial-action-coding-system"));
Sohead1->addMeta(*Someta14);

Someta* Someta15 = new Someta();
Someta15->setName(QString("generator"));
Someta15->setContent(QString("Suwon VRLAB X3D Converter"));
Sohead1->addMeta(*Someta15);

Someta* Someta16 = new Someta();
Someta16->setName(QString("MovingImage"));
Someta16->setContent(QString("originals/SuwonHAnimFacialMotionConverter.mp4"));
...
Someta18->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/Tongue.x3d"));
...
SoViewpoint21->setDEF(QString("HelloJin"));
SoViewpoint21->setDescription(QString("Hello Jin! 안녕하세요 진!"));
SoViewpoint21->setPosition(new float[]{0.0,20.0,60.0});
SoNode20->addChild(*SoViewpoint21);

SoTimeSensor* SoTimeSensor22 = new SoTimeSensor();
SoTimeSensor22->setDEF(QString("JinMouthStretch_Clock"));
SoTimeSensor22->setCycleInterval(0.99);
SoTimeSensor22->setLoop(true);
SoNode20->addChild(*SoTimeSensor22);

SoEXPORT* SoEXPORT23 = new SoEXPORT();
SoEXPORT23->setLocalDEF(QString("JinMouthStretch_Clock"));
SoEXPORT23->setAS(QString("JinMouthStretch_Clock"));
SoNode20->addChild(*SoEXPORT23);

SoScalarInterpolator* SoScalarInterpolator24 = new SoScalarInterpolator();
SoScalarInterpolator24->setDEF(QString("AnimationAdapter_JinMouthStretch"));
...
SoNode20->addChild(*SoScalarInterpolator24);
...
SoHAnimJoint26->X3DNode::setName(QString("humanoid_root"));
SoHAnimJoint26->setDEF(QString("hanim_root"));
...
SoHAnimSegment27->X3DNode::setName(QString("sacrum"));
SoHAnimSegment27->setDEF(QString("hanim_sacrum"));
SoWorldInfo* SoWorldInfo28 = new SoWorldInfo();
SoWorldInfo28->setTitle(QString("Tongue.x3d"));
SoHAnimSegment27->addChild(*SoWorldInfo28);

SoBackground* SoBackground29 = new SoBackground();
SoBackground29->setSkyColor(new float[]{0.8,0.9,1.0}, 3);
SoHAnimSegment27->addChild(*SoBackground29);

SoNavigationInfo* SoNavigationInfo30 = new SoNavigationInfo();
SoNavigationInfo30->setType(new QString[]{QString("EXAMINE")}, 1);
SoHAnimSegment27->addChild(*SoNavigationInfo30);

SoHAnimJoint26->addChildren(*SoHAnimSegment27);

SoHAnimJoint* SoHAnimJoint31 = new SoHAnimJoint();
SoHAnimJoint31->X3DNode::setName(QString("skullbase"));
SoHAnimJoint31->setDEF(QString("hanim_skullbase"));
...
SoHAnimSegment32->X3DNode::setName(QString("tongue"));
SoHAnimSegment32->setDEF(QString("hanim_Tongue"));
SoTransform* SoTransform33 = new SoTransform();
SoTransform33->setDEF(QString("Tongue"));
SoTransform33->setTranslation(new float[]{0.0,8.886,11.1});
SoShape* SoShape34 = new SoShape();
SoVRMLAppearance* SoVRMLAppearance35 = new SoVRMLAppearance();
SoVRMLAppearance35->setDEF(QString("BaseAppearance"));
SoMaterial* SoMaterial36 = new SoMaterial();
SoMaterial36->setDEF(QString("BaseMaterial"));
SoMaterial36->setAmbientIntensity(1);
SoMaterial36->setDiffuseColor(new float[]{0.588,0.588,0.588});
SoMaterial36->setShininess(0.145);
SoVRMLAppearance35->addChild(*SoMaterial36);

SoImageTexture* SoImageTexture37 = new SoImageTexture();
SoImageTexture37->setDEF(QString("JinImageAtlas"));
SoImageTexture37->setUrl(new QString[]{QString("JinImageAtlas.jpg"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/JinImageAtlas.jpg")}, 2);
...
SoIndexedFaceSet38->setDEF(QString("Tongue-FACES"));
...
SoIndexedFaceSet38->setSolid(false);
...
SoTextureCoordinate39->setDEF(QString("Tongue-TEXCOORD"));
SoTextureCoordinate39->setPoint(new float[]{0.6665,0.04796,0.6621,0.05829,0.6755,0.05429,0.678,0.04407,0.6594,0.0736,0.6739,0.06941,0.6934,0.06941,0.6938,0.05429,0.6944,0.04387,0.6665,0.07002,0.678,0.07332,0.6755,0.08631,0.6621,0.08231,0.6944,0.07293,0.6938,0.08631,0.6934,0.103,0.6739,0.103,0.6594,0.09877,0.6775,0.03908,0.6841,0.03457,0.685,0.04057,0.677,0.04467,0.6959,0.03299,0.6961,0.03821,0.6959,0.0483,0.6841,0.05084,0.6775,0.0521,0.7593,0.04796,0.7636,0.05829,0.7681,0.0703,0.7631,0.05909,0.7664,0.0736,0.7713,0.08619,0.7664,0.09877,0.7636,0.08231,0.7593,0.07002,0.6584,0.1215,0.6584,0.09583,0.6535,0.1086,0.6535,0.1343,0.6545,0.08619,0.6584,0.1214,0.6584,0.1471,0.6734,0.09157,0.6734,0.1172,0.6932,0.1172,0.6932,0.09157,0.7673,0.1214,0.7524,0.1256,0.7519,0.103,0.7673,0.1471,0.7524,0.1513,0.7326,0.1513,0.7326,0.1256,0.7324,0.103,0.7673,0.09583,0.7723,0.1086,0.7673,0.1215,0.7723,0.1343,0.6577,0.0703,0.6627,0.05909,0.6813,0.03662,0.6723,0.04066,0.6952,0.03583,0.7565,0.05069,0.7535,0.04066,0.7535,0.05994,0.7482,0.0521,0.7488,0.04467,0.7482,0.03908,0.7478,0.07332,0.7445,0.06163,0.7314,0.07293,0.7306,0.06006,0.7299,0.0483,0.7417,0.05084,0.6693,0.05069,0.6723,0.05994,0.7324,0.06941,0.7519,0.06941,0.7503,0.05429,0.732,0.05429,0.7478,0.04407,0.7314,0.04387,0.7503,0.08631,0.732,0.08631,0.7299,0.03299,0.7417,0.03457,0.7408,0.04057,0.7296,0.03821,0.7326,0.1172,0.7524,0.1172,0.7524,0.09157,0.7326,0.09157,0.6932,0.1513,0.6734,0.1513,0.6734,0.1256,0.6932,0.1256,0.7445,0.03662,0.7306,0.03583,0.6813,0.06163,0.6952,0.06006,0.7129,0.06941,0.7129,0.05429,0.7129,0.04381,0.7129,0.0728,0.7129,0.08631,0.7129,0.103,0.7129,0.03246,0.7129,0.03742,0.7129,0.04745,0.7129,0.1172,0.7129,0.09157,0.7129,0.1513,0.7129,0.1256,0.7129,0.03556,0.7129,0.05954}, 234);
SoIndexedFaceSet38->setTexCoord(*SoTextureCoordinate39);

SoCoordinate* SoCoordinate40 = new SoCoordinate();
SoCoordinate40->setDEF(QString("Tongue_COORD"));
...
SoIndexedFaceSet38->setCoord(*SoCoordinate40);

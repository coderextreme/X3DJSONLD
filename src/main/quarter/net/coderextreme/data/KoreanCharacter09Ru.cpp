...
Someta3->setContent(QString("KoreanCharacter09Ru.x3d"));
...
Someta10->setContent(QString("check connectivity of geometry between upper left arm and shoulder"));
Sohead1->addMeta(*Someta10);

Someta* Someta11 = new Someta();
Someta11->setName(QString("Image"));
Someta11->setContent(QString("../Poses/images/HAnimPoseExampleKoreanCharacter09Ru.png"));
Sohead1->addMeta(*Someta11);

Someta* Someta12 = new Someta();
Someta12->setName(QString("reference"));
Someta12->setContent(QString("KoreanCharacter00ReadMe.txt"));
Sohead1->addMeta(*Someta12);

Someta* Someta13 = new Someta();
Someta13->setName(QString("reference"));
Someta13->setContent(QString("../KoreanCharacterHumanMotion_Infotech2014_140706.pdf"));
Sohead1->addMeta(*Someta13);

Someta* Someta14 = new Someta();
Someta14->setName(QString("reference"));
Someta14->setContent(QString("KoreanCharactersIllustrated.pdf"));
Sohead1->addMeta(*Someta14);

Someta* Someta15 = new Someta();
Someta15->setName(QString("identifier"));
Someta15->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter09Ru.x3d"));
...
Someta17->setContent(QString("Suwon University HAnim Editor"));
...
Someta19->setContent(QString("X3D-Edit 3.3, https://www.web3d.org/x3d/tools/X3D-Edit"));
...
SoWorldInfo* SoWorldInfo22 = new SoWorldInfo();
SoWorldInfo22->setTitle(QString("KoreanCharacter09Ru.x3d"));
SoNode21->addChild(*SoWorldInfo22);

SoNavigationInfo* SoNavigationInfo23 = new SoNavigationInfo();
SoNavigationInfo23->setSpeed(1.5);
SoNode21->addChild(*SoNavigationInfo23);

SoViewpoint* SoViewpoint24 = new SoViewpoint();
SoViewpoint24->setCenterOfRotation(new float[]{0.0,1.0,0.0});
SoViewpoint24->setDescription(QString("Ru"));
SoViewpoint24->setPosition(new float[]{0.0,1.0,3.0});
SoNode21->addChild(*SoViewpoint24);

SoHAnimHumanoid* SoHAnimHumanoid25 = new SoHAnimHumanoid();
SoHAnimHumanoid25->X3DNode::setName(QString("Ru"));
SoHAnimHumanoid25->setDEF(QString("hanim_Ru"));
SoHAnimHumanoid25->setScale(new float[]{0.0225,0.0225,0.0225});
...
SoMetadataSet* SoMetadataSet26 = new SoMetadataSet();
SoMetadataSet26->X3DNode::setName(QString("HAnimHumanoid.info"));
SoMetadataSet26->X3DNode::setReference(QString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid"));
SoMetadataString* SoMetadataString27 = new SoMetadataString();
SoMetadataString27->X3DNode::setName(QString("authorName"));
SoMetadataString27->setValue(new QString[]{QString("Chul Hee Jung and Myeong Won Lee")}, 1);
SoMetadataSet26->setValue((X3DNode *)&SoMetadataString27);

SoMetadataString* SoMetadataString28 = new SoMetadataString();
SoMetadataString28->X3DNode::setName(QString("authorEmail"));
SoMetadataString28->setValue(new QString[]{QString("myeongwonlee@gmail.com")}, 1);
SoMetadataSet26->setValue((X3DNode *)&SoMetadataString28);

SoMetadataString* SoMetadataString29 = new SoMetadataString();
SoMetadataString29->X3DNode::setName(QString("creationDate"));
SoMetadataString29->setValue(new QString[]{QString("31 March 2011")}, 1);
SoMetadataSet26->setValue((X3DNode *)&SoMetadataString29);

SoMetadataString* SoMetadataString30 = new SoMetadataString();
SoMetadataString30->X3DNode::setName(QString("gender"));
SoMetadataString30->setValue(new QString[]{QString("male")}, 1);
SoMetadataSet26->setValue((X3DNode *)&SoMetadataString30);

SoMetadataFloat* SoMetadataFloat31 = new SoMetadataFloat();
SoMetadataFloat31->X3DNode::setName(QString("height"));
SoMetadataFloat31->setValue(new float[]{1.5}, 1);
SoMetadataSet26->setValue((X3DNode *)&SoMetadataFloat31);

SoMetadataString* SoMetadataString32 = new SoMetadataString();
SoMetadataString32->X3DNode::setName(QString("humanoidVersion"));
SoMetadataString32->setValue(new QString[]{QString("2.0")}, 1);
SoMetadataSet26->setValue((X3DNode *)&SoMetadataString32);

SoHAnimHumanoid25->setMetadata(*SoMetadataSet26);
...
SoHAnimJoint33->setCenter(new float[]{0.0,35.950001,-1.712});
...
SoHAnimSegment34->setDEF(QString("hanim_sacrum"));
SoTransform* SoTransform35 = new SoTransform();
SoTransform35->setTranslation(new float[]{0.0,35.950001,-1.712});
...
SoMaterial38->setDiffuseColor(new float[]{0.588,0.588,0.588});
SoVRMLAppearance37->addChild(*SoMaterial38);

SoImageTexture* SoImageTexture39 = new SoImageTexture();
SoImageTexture39->setDEF(QString("RuTextureAtlas"));
SoImageTexture39->setUrl(new QString[]{QString("images/Ru.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ru.png")}, 2);
SoVRMLAppearance37->addChild(*SoImageTexture39);
...
SoHAnimJoint43->setDEF(QString("hanim_l_hip"));
SoHAnimJoint43->setCenter(new float[]{3.602,33.740002,-1.967});
...
SoHAnimSegment44->setDEF(QString("hanim_l_thigh"));
SoTransform* SoTransform45 = new SoTransform();
SoTransform45->setTranslation(new float[]{3.602,33.740002,-1.967});
...
SoHAnimJoint53->X3DNode::setName(QString("l_knee"));
SoHAnimJoint53->setDEF(QString("hanim_l_knee"));
SoHAnimJoint53->setCenter(new float[]{3.931,18.23,-1.935});
...
SoHAnimSegment54->X3DNode::setName(QString("l_calf"));
SoHAnimSegment54->setDEF(QString("hanim_l_calf"));
SoTransform* SoTransform55 = new SoTransform();
SoTransform55->setTranslation(new float[]{3.931,18.23,-1.935});
...
SoMaterial58->setDiffuseColor(new float[]{0.588,0.588,0.588});
SoVRMLAppearance57->addChild(*SoMaterial58);

SoImageTexture* SoImageTexture59 = new SoImageTexture();
SoImageTexture59->setUSE(QString("RuTextureAtlas"));
SoVRMLAppearance57->addChild(*SoImageTexture59);

SoShape56->addChild(*SoVRMLAppearance57);

SoIndexedFaceSet* SoIndexedFaceSet60 = new SoIndexedFaceSet();
SoIndexedFaceSet60->setCoordIndex(new int32_t[]{32,38,1,-1,1,0,32,-1,33,32,0,-1,0,2,33,-1,34,39,14,-1,14,3,34,-1,35,34,3,-1,3,4,35,-1,5,36,35,-1,35,4,5,-1,6,37,36,-1,36,5,6,-1,1,38,37,-1,37,6,1,-1,24,7,8,-1,8,25,24,-1,26,25,8,-1,8,9,26,-1,15,10,27,-1,27,31,15,-1,11,28,27,-1,27,10,11,-1,12,29,28,-1,28,11,12,-1,13,30,29,-1,29,12,13,-1,24,
-6.77,-1.405,2.057,-6.579,0.0221,0.0355,-7.09,-2.115,-2.021,-7.528,-0.1026,-1.592,-7.4,-1.399,-1.559,-7.392,1.458,0.0464,-7.091,2.044,1.588,-6.828,1.431,2.162,0.6392,-0.0205,1.659,0.6662,-1.561,0.1032,0.6473,-2.279,-2.22,0.6402,0.0258,-1.673,0.6576,1.57,0.0642,0.6305,2.263,1.651,0.6333,1.643,-1.706,0.6436,-1.513,1.251,-13.99,-1.252,-0.0065,-13.99,-1.806,-1.765,-13.99,-0.0246,-1.337,-13.99,1.25,-0.0302,-13.99,1.876,1.35,-13.99,1.226,1.865,-13.99,-0.0781,-1.425,-13.99,-1.381,0.0589,1.002,0.1259,0.0075,-14.75,-0.0616}, 126);
SoIndexedFaceSet60->setCoord(*SoCoordinate61);

SoTextureCoordinate* SoTextureCoordinate62 = new SoTextureCoordinate();
SoTextureCoordinate62->setPoint(new float[]{0.6463,0.046,0.6495,0.0509,0.6387,0.0526,0.6389,0.0477,0.6574,0.0396,0.6629,0.0479,0.6737,0.0226,0.6912,0.036,0.6786,0.0436,0.6681,0.033,0.6077,0.0348,0.5971,0.0443,0.617,0.0409,0.6118,0.0489,0.6293,0.0459,0.6272,0.0516,0.6536,0.2562,0.6522,0.265,0.6412,0.2644,0.6406,0.2561,0.6708,0.2596,0.6649,0.2701,0.687,0.2926,0.6797,0.28,0.6919,0.2662,0.7071,0.2736,0.5893,0.2674,0.6011,0.2817,0.6093,0.2616,0.616,0.2723,0.6268,0.257,0.6285,0.2656,0.6804,0.1534,0.7038,0.1483,0.6596,0.1586,0.6418,0.1619,0.72,0.1456,0.5782,0.1504,0.6015,0.1548,0.6244,0.1586,0.6394,0.2899,0.6382,0.0267,0.6022,0.024,0.5845,0.0373,0.5928,0.2944,0.5718,0.2758,0.5583,0.1475}, 94);
SoIndexedFaceSet60->setTexCoord(*SoTextureCoordinate62);

SoShape56->setGeometry(*SoIndexedFaceSet60);

SoTransform55->addChild(*SoShape56);

SoHAnimSegment54->addChild(*SoTransform55);

SoHAnimJoint53->addChildren(*SoHAnimSegment54);

SoHAnimJoint* SoHAnimJoint63 = new SoHAnimJoint();
SoHAnimJoint63->X3DNode::setName(QString("l_talocrural"));
SoHAnimJoint63->setDEF(QString("hanim_l_talocrural"));
SoHAnimJoint63->setCenter(new float[]{4.077,4.031,-1.998});
...
SoHAnimSegment64->X3DNode::setName(QString("l_talus"));
SoHAnimSegment64->setDEF(QString("hanim_l_talus"));
SoTransform* SoTransform65 = new SoTransform();
SoTransform65->setTranslation(new float[]{4.077,4.031,-1.998});
...
SoHAnimJoint73->setDEF(QString("hanim_l_metatarsophalangeal_2"));
SoHAnimJoint73->setCenter(new float[]{4.077,3.104,-0.9239});
...
SoHAnimSegment74->setDEF(QString("hanim_l_tarsal_proximal_phalanx_2"));
SoTransform* SoTransform75 = new SoTransform();
SoTransform75->setTranslation(new float[]{4.077,3.104,-0.9239});
...
SoHAnimJoint53->addChildren(*SoHAnimJoint63);

SoHAnimJoint43->addChildren(*SoHAnimJoint53);

SoHAnimJoint33->addChildren(*SoHAnimJoint43);

SoHAnimJoint* SoHAnimJoint83 = new SoHAnimJoint();
SoHAnimJoint83->X3DNode::setName(QString("r_hip"));
SoHAnimJoint83->setDEF(QString("hanim_r_hip"));
SoHAnimJoint83->setCenter(new float[]{-3.602,33.740002,-1.967});
...
SoHAnimSegment84->X3DNode::setName(QString("r_thigh"));
SoHAnimSegment84->setDEF(QString("hanim_r_thigh"));
SoTransform* SoTransform85 = new SoTransform();
SoTransform85->setTranslation(new float[]{-3.602,33.740002,-1.967});
...
SoHAnimJoint93->X3DNode::setName(QString("r_knee"));
SoHAnimJoint93->setDEF(QString("hanim_r_knee"));
SoHAnimJoint93->setCenter(new float[]{-3.931,18.23,-1.935});
...
SoHAnimSegment94->X3DNode::setName(QString("r_calf"));
SoHAnimSegment94->setDEF(QString("hanim_r_calf"));
SoTransform* SoTransform95 = new SoTransform();
SoTransform95->setTranslation(new float[]{-3.931,18.23,-1.935});
...
SoMaterial98->setDiffuseColor(new float[]{0.588,0.588,0.588});
SoVRMLAppearance97->addChild(*SoMaterial98);

SoImageTexture* SoImageTexture99 = new SoImageTexture();
SoImageTexture99->setUSE(QString("RuTextureAtlas"));
SoVRMLAppearance97->addChild(*SoImageTexture99);

SoShape96->addChild(*SoVRMLAppearance97);

SoIndexedFaceSet* SoIndexedFaceSet100 = new SoIndexedFaceSet();
SoIndexedFaceSet100->setCoordIndex(new int32_t[]{32,0,1,-1,1,38,32,-1,33,2,0,-1,0,32,33,-1,34,3,14,-1,14,39,34,-1,35,4,3,-1,3,34,35,-1,5,4,35,-1,35,36,5,-1,6,5,36,-1,36,37,6,-1,1,6,37,-1,37,38,1,-1,24,25,8,-1,8,7,24,-1,26,9,8,-1,8,25,26,-1,15,31,27,-1,27,10,15,-1,11,10,27,-1,27,28,11,-1,12,11,28,-1,28,29,12,-1,13,12,29,-1,29,30,13,-1,24,7,13,-1,13,30,24,-1,9,15,20,-1,20,18,9,-1,31,15,9,-1,9,26,31,-1,8,16,17,-1,17,7,8,-1,9,18,16,-1,16,8,9,-1,19,20,15,-1,15,10,19,-1,21,19,10,-1,10,11,21,-1,22,21,11,-1,11,12,22,-1,23,22,12,-1,12,13,23,-1,7,17,23,-1,23,13,7,-1,33,18,20,-1,20,39,33,-1,16,32,38,-1,38,17,16,-1,18,33,32,-1,32,16,18,-1,19,34,39,-1,39,20,19,-1,35,34,19,-1,19,21,35,-1,36,35,21,-1,21,22,36,-1,37,36,22,-1,22,23,37,-1,38,37,23,-1,23,17,38,-1,2,33,39,-1,39,14,2,-1,24,40,25,-1,25,40,26,-1,26,40,31,-1,31,40,27,-1,27,40,28,-1,28,40,29,-1,29,40,30,-1,30,40,24,-1,0,41,1,-1,1,41,6,-1,6,41,5,-1,5,41,4,-1,4,41,3,-1,3,41,14,-1,14,41,2,-1,2,41,0,-1}, 320);
SoIndexedFaceSet100->setCreaseAngle(1.57);
SoTextureCoordinate102->setPoint(new float[]{0.6463,0.046,0.6495,0.0509,0.6387,0.0526,0.6389,0.0477,0.6574,0.0396,0.6629,0.0479,0.6737,0.0226,0.6912,0.036,0.6786,0.0436,0.6681,0.033,0.6077,0.0348,0.5971,0.0443,0.617,0.0409,0.6118,0.0489,0.6293,0.0459,0.6272,0.0516,0.6536,0.2562,0.6522,0.265,0.6412,0.2644,0.6406,0.2561,0.6708,0.2596,0.6649,0.2701,0.687,0.2926,0.6797,0.28,0.6919,0.2662,0.7071,0.2736,0.5893,0.2674,0.6011,0.2817,0.6093,0.2616,0.616,0.2723,0.6268,0.257,0.6285,0.2656,0.6804,0.1534,0.7038,0.1483,0.6596,0.1586,0.6418,0.1619,0.72,0.1456,0.5782,0.1504,0.6015,0.1548,0.6244,0.1586,0.6394,0.2899,0.6382,0.0267,0.6022,0.024,0.5845,0.0373,0.5928,0.2944,0.5718,0.2758,0.5583,0.1475}, 94);
SoIndexedFaceSet100->setTexCoord(*SoTextureCoordinate102);

SoShape96->setGeometry(*SoIndexedFaceSet100);
...
SoHAnimJoint103->X3DNode::setName(QString("r_talocrural"));
SoHAnimJoint103->setDEF(QString("hanim_r_talocrural"));
SoHAnimJoint103->setCenter(new float[]{-4.077,4.031,-1.998});
...
SoHAnimSegment104->X3DNode::setName(QString("r_talus"));
SoHAnimSegment104->setDEF(QString("hanim_r_talus"));
SoTransform* SoTransform105 = new SoTransform();
SoTransform105->setTranslation(new float[]{-4.077,4.031,-1.998});
...
SoHAnimJoint113->X3DNode::setName(QString("r_metatarsophalangeal_2"));
SoHAnimJoint113->setDEF(QString("hanim_r_metatarsophalangeal_2"));
SoHAnimJoint113->setCenter(new float[]{-4.077,3.104,-0.9239});
...
SoHAnimSegment114->X3DNode::setName(QString("r_tarsal_proximal_phalanx_2"));
SoHAnimSegment114->setDEF(QString("hanim_r_tarsal_proximal_phalanx_2"));
SoTransform* SoTransform115 = new SoTransform();
SoTransform115->setTranslation(new float[]{-4.077,3.104,-0.9239});
...
SoHAnimJoint103->addChildren(*SoHAnimJoint113);

SoHAnimJoint93->addChildren(*SoHAnimJoint103);

SoHAnimJoint83->addChildren(*SoHAnimJoint93);

SoHAnimJoint33->addChildren(*SoHAnimJoint83);

SoHAnimJoint* SoHAnimJoint123 = new SoHAnimJoint();
SoHAnimJoint123->X3DNode::setName(QString("sacroiliac"));
SoHAnimJoint123->setDEF(QString("hanim_sacroiliac"));
SoHAnimJoint123->setCenter(new float[]{0.0,32.209999,-2.058});
...
SoHAnimSegment124->X3DNode::setName(QString("pelvis"));
SoHAnimSegment124->setDEF(QString("hanim_pelvis"));
SoTransform* SoTransform125 = new SoTransform();
SoTransform125->setTranslation(new float[]{0.0,32.209999,-2.058});
...
SoHAnimJoint133->X3DNode::setName(QString("l_shoulder"));
SoHAnimJoint133->setDEF(QString("hanim_l_shoulder"));
SoHAnimJoint133->setCenter(new float[]{6.479,53.209999,-2.007});
...
SoHAnimSegment134->X3DNode::setName(QString("l_upperarm"));
SoHAnimSegment134->setDEF(QString("hanim_l_upperarm"));
SoTransform* SoTransform135 = new SoTransform();
SoTransform135->setTranslation(new float[]{6.479,53.209999,-2.007});
...
SoHAnimSegment144->X3DNode::setName(QString("l_forearm"));
SoHAnimSegment144->setDEF(QString("hanim_l_forearm"));
SoTransform* SoTransform145 = new SoTransform();
SoTransform145->setTranslation(new float[]{7.489,44.990002,-2.016});
...
SoHAnimJoint153->X3DNode::setName(QString("l_radiocarpal"));
SoHAnimJoint153->setDEF(QString("hanim_l_radiocarpal"));
SoHAnimJoint153->setCenter(new float[]{7.938,35.98,-1.856});
...
SoHAnimSegment154->X3DNode::setName(QString("l_carpal"));
SoHAnimSegment154->setDEF(QString("hanim_l_carpal"));
SoTransform* SoTransform155 = new SoTransform();
SoTransform155->setTranslation(new float[]{7.938,35.98,-1.856});
...
SoHAnimSegment164->X3DNode::setName(QString("r_upperarm"));
SoHAnimSegment164->setDEF(QString("hanim_r_upperarm"));
SoTransform* SoTransform165 = new SoTransform();
SoTransform165->setTranslation(new float[]{-6.479,53.209999,-2.007});
...
SoHAnimJoint173->setCenter(new float[]{-7.489,44.990002,-2.016});
...
SoHAnimSegment174->X3DNode::setName(QString("r_forearm"));
SoHAnimSegment174->setDEF(QString("hanim_r_forearm"));
SoTransform* SoTransform175 = new SoTransform();
SoTransform175->setTranslation(new float[]{-7.489,44.990002,-2.016});
...
SoMaterial178->setDiffuseColor(new float[]{0.588,0.588,0.588});
SoVRMLAppearance177->addChild(*SoMaterial178);

SoImageTexture* SoImageTexture179 = new SoImageTexture();
SoImageTexture179->setUSE(QString("RuTextureAtlas"));
SoVRMLAppearance177->addChild(*SoImageTexture179);

SoShape176->addChild(*SoVRMLAppearance177);

SoIndexedFaceSet* SoIndexedFaceSet180 = new SoIndexedFaceSet();
SoIndexedFaceSet180->setCoordIndex(new int32_t[]{14,20,0,-1,0,12,14,-1,13,15,14,-1,14,12,13,-1,1,21,15,-1,15,13,1,-1,2,22,21,-1,21,1,2,-1,3,23,22,-1,22,2,3,-1,18,16,23,-1,23,3,18,-1,18,19,17,-1,17,16,18,-1,20,17,19,-1,19,0,20,-1,0,35,34,-1,34,12,0,-1,12,34,36,-1,36,13,12,-1,36,37,1,-1,1,13,36,-1,37,38,2,-1,2,1,37,-1,38,39,3,-1,3,2,38,-1,39,40,18,-1,18,3,39,-1,41,35,0,-1,0,19,41,-1,18,40,41,-1,41,19,18,-1,4,24,31,-1,31,11,4,-1,11,31,25,-1,25,5,11,-1,5,25,28,-1,28,8,5,-1,10,30,26,-1,26,6,10,-1,7,27,24,-1,24,4,7,-1,8,28,29,-1,29,9,8,-1,9,29,30,-1,30,10,9,-1,6,26,27,-1,27,7,6,-1,24,32,31,-1,31,32,25,-1,25,32,28,-1,28,32,29,-1,29,32,30,-1,30,32,26,-1,26,32,27,-1,27,32,24,-1,14,33,20,-1,20,33,17,-1,17,33,16,-1,16,33,23,-1,23,33,22,-1,22,33,21,-1,21,33,15,-1,15,33,14,-1,35,4,11,-1,11,34,35,-1,34,11,5,-1,5,36,34,-1,5,8,37,-1,37,36,5,-1,8,9,38,-1,38,37,8,-1,9,10,39,-1,39,38,9,-1,10,6,40,-1,40,39,10,-1,7,4,35,-1,35,41,7,-1,40,6,7,-1,7,41,40,-1}, 320);
SoIndexedFaceSet180->setCreaseAngle(1.57);
SoTextureCoordinate182->setPoint(new float[]{0.9157,0.7044,0.9151,0.6926,0.928,0.6893,0.9222,0.7043,0.898,0.7025,0.8979,0.6938,0.8797,0.7052,0.8796,0.6945,0.8694,0.7049,0.8649,0.694,0.862,0.7093,0.8506,0.6957,0.8505,0.7262,0.8313,0.701,0.9288,0.705,0.9387,0.6908,0.9028,0.5513,0.9105,0.5495,0.8894,0.5563,0.882,0.5554,0.872,0.555,0.8586,0.5534,0.8467,0.5497,0.9198,0.5512,0.8991,0.5423,0.9041,0.5398,0.8883,0.5471,0.8822,0.5465,0.8615,0.5326,0.8677,0.5402,0.9108,0.5387,0.8748,0.5458,0.8877,0.531,0.8968,0.7248,0.9428,0.721,0.9616,0.6952,0.9315,0.546,0.9149,0.5301,0.909,0.6219,0.9193,0.6194,0.8937,0.6251,0.8808,0.6249,0.8684,0.6245,0.8546,0.6246,0.839,0.6253,0.9466,0.6206,0.9292,0.621}, 94);
SoIndexedFaceSet180->setTexCoord(*SoTextureCoordinate182);

SoShape176->setGeometry(*SoIndexedFaceSet180);

SoTransform175->addChild(*SoShape176);

SoHAnimSegment174->addChild(*SoTransform175);

SoHAnimJoint173->addChildren(*SoHAnimSegment174);

SoHAnimJoint* SoHAnimJoint183 = new SoHAnimJoint();
SoHAnimJoint183->X3DNode::setName(QString("r_radiocarpal"));
SoHAnimJoint183->setDEF(QString("hanim_r_radiocarpal"));
SoHAnimJoint183->setCenter(new float[]{-7.938,35.98,-1.856});
...
SoHAnimSegment184->X3DNode::setName(QString("r_carpal"));
SoHAnimSegment184->setDEF(QString("hanim_r_carpal"));
SoTransform* SoTransform185 = new SoTransform();
SoTransform185->setTranslation(new float[]{-7.938,35.98,-1.856});
...
SoHAnimJoint173->addChildren(*SoHAnimJoint183);

SoHAnimJoint163->addChildren(*SoHAnimJoint173);

SoHAnimJoint123->addChildren(*SoHAnimJoint163);

SoHAnimJoint* SoHAnimJoint193 = new SoHAnimJoint();
SoHAnimJoint193->X3DNode::setName(QString("vl5"));
SoHAnimJoint193->setDEF(QString("hanim_vl5"));
SoHAnimJoint193->setCenter(new float[]{0.0,38.25,-1.903});
...
SoHAnimSegment194->X3DNode::setName(QString("l5"));
SoHAnimSegment194->setDEF(QString("hanim_l5"));
SoTransform* SoTransform195 = new SoTransform();
SoTransform195->setTranslation(new float[]{0.0,38.25,-1.903});
...
SoHAnimJoint203->X3DNode::setName(QString("skullbase"));
SoHAnimJoint203->setDEF(QString("hanim_skullbase"));
SoHAnimJoint203->setCenter(new float[]{0.0,58.450001,-1.829});
SoHAnimJoint203->setUlimit(new float[]{0.0,0.0,0.0}, 3);
SoHAnimJoint203->setLlimit(new float[]{0.0,0.0,0.0}, 3);
SoHAnimSegment* SoHAnimSegment204 = new SoHAnimSegment();
SoHAnimSegment204->X3DNode::setName(QString("skull"));
SoHAnimSegment204->setDEF(QString("hanim_skull"));
SoTransform* SoTransform205 = new SoTransform();
SoTransform205->setTranslation(new float[]{0.0,58.450001,-1.829});
...
SoMaterial208->setDiffuseColor(new float[]{0.588,0.588,0.588});
SoVRMLAppearance207->addChild(*SoMaterial208);

SoImageTexture* SoImageTexture209 = new SoImageTexture();
SoImageTexture209->setUSE(QString("RuTextureAtlas"));

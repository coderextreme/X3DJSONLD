...
Someta13->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter12Sun.x3d"));
...
SoWorldInfo20->setTitle(QString("KoreanCharacter12Sun.x3d"));
...
SoViewpoint22->setDescription(QString("Sun"));
...
SoHAnimHumanoid23->X3DNode::setName(QString("Sun"));
SoHAnimHumanoid23->setDEF(QString("hanim_Sun"));
...
SoHAnimJoint31->setCenter(new float[]{0.0,29.860001,-0.4567});
...
SoTransform33->setTranslation(new float[]{0.0,29.860001,-0.4567});
...
SoImageTexture37->setDEF(QString("SunTextureAtlas"));
SoImageTexture37->setUrl(new QString[]{QString("images/Sun.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Sun.png")}, 2);
...
SoHAnimJoint41->setCenter(new float[]{2.955,28.940001,-0.5218});
...
SoTransform43->setTranslation(new float[]{2.955,28.940001,-0.5218});
...
SoImageTexture47->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint51->setCenter(new float[]{2.948,16.459999,-0.5275});
...
SoTransform53->setTranslation(new float[]{2.948,16.459999,-0.5275});
...
SoImageTexture57->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint61->setCenter(new float[]{2.839,3.899,-0.4116});
...
SoTransform63->setTranslation(new float[]{2.839,3.899,-0.4116});
...
SoImageTexture67->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint71->setCenter(new float[]{2.839,3.312,1.078});
...
SoTransform73->setTranslation(new float[]{2.839,3.312,1.078});
...
SoImageTexture77->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint81->setCenter(new float[]{-2.955,28.940001,-0.5218});
...
SoTransform83->setTranslation(new float[]{-2.955,28.940001,-0.5218});
...
SoImageTexture87->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint91->setCenter(new float[]{-2.948,16.459999,-0.5275});
...
SoTransform93->setTranslation(new float[]{-2.948,16.459999,-0.5275});
...
SoImageTexture97->setUSE(QString("SunTextureAtlas"));
...
SoCoordinate99->setPoint(new float[]{-1.375,-5.834,-1.193,-1.477,-4.137,-1.195,-1.952,-4.672,0.1143,-0.6966,-12.16,-0.8887,0.0964,-12.16,-1.304,-0.0075,-6.489,-1.984,0.9748,-12.16,-0.8887,1.329,-6.244,-1.314,1.339,-12.16,0.1054,1.761,-6.229,0.1143,0.9748,-12.16,0.9689,1.217,-6.865,1.222,0.0964,-12.16,1.384,-0.0075,-7.096,1.879,-0.6966,-12.16,0.9689,-1.312,-6.004,1.225,-1.06,-12.16,0.1054,-1.831,0.0045,0.1143,-1.301,0.0045,-1.198,-0.9277,1.148,-0.902,-1.353,1.148,0.1143,-0.0071,0.0045,-1.771,-0.0071,1.148,-1.327,1.396,0.0045,-1.198,1.02,1.148,-0.902,1.885,0.0045,0.1143,1.445,1.148,0.1143,1.396,0.0045,1.551,1.02,1.148,1.396,-0.0071,0.0045,2.125,-0.0071,1.148,1.821,-1.301,0.0045,1.551,-0.9277,1.148,1.396,-0.0071,2.106,0.1143,-0.7952,-13.2,0.1143,-0.5053,-13.2,-0.6746,-0.5053,-13.2,0.749,0.0941,-13.2,1.08,0.7943,-13.2,0.749,1.084,-13.2,0.1143,0.7943,-13.2,-0.6746,0.0941,-13.2,-1.006,0.0941,-13.94,0.1143,-1.319,-1.205,-1.195,-1.928,-1.333,0.1143,0.0092,-1.051,-1.85,-0.0075,-3.792,-2.125,1.423,-1.205,-1.195,1.386,-4.758,-1.344,1.952,-1.333,0.1143,1.391,-1.333,1.308,-0.0071,-1.333,1.881,-1.326,-1.333,1.308,0.0957,-10.22,-1.525,-0.8601,-10.22,-0.9874,1.1,-10.22,-1.026,1.478,-10.22,0.1083,1.065,-10.22,1.051,0.0957,-10.22,1.545,-0.8407,-10.22,1.052,-1.283,-10.22,0.1083}, 183);
SoIndexedFaceSet98->setCoord(*SoCoordinate99);

SoTextureCoordinate* SoTextureCoordinate100 = new SoTextureCoordinate();
SoTextureCoordinate100->setPoint(new float[]{0.9287,0.342,0.9261,0.3817,0.9166,0.3743,0.9312,0.2839,0.9471,0.2839,0.9471,0.3395,0.9648,0.2839,0.9653,0.3367,0.9721,0.2839,0.9756,0.3608,0.9668,0.3526,0.9471,0.3496,0.9261,0.3638,0.9239,0.2839,0.9178,0.4416,0.9263,0.4416,0.9323,0.4565,0.9255,0.4565,0.9471,0.4416,0.9471,0.4565,0.9697,0.4416,0.9637,0.4565,0.9783,0.4416,0.9705,0.4565,0.9471,0.4689,0.932,0.2704,0.937,0.2704,0.9471,0.2704,0.959,0.2704,0.964,0.2704,0.9471,0.2608,0.9261,0.428,0.9162,0.4243,0.9474,0.428,0.9471,0.3767,0.9684,0.428,0.9669,0.3711,0.9771,0.4243,0.9678,0.4243,0.9471,0.4243,0.9259,0.4243,0.9467,0.3066,0.9291,0.3066,0.9659,0.3066,0.9763,0.3066,0.967,0.3066,0.9459,0.3066,0.9267,0.3066,0.9183,0.3066}, 98);
...
SoHAnimJoint101->setCenter(new float[]{-2.839,3.899,-0.4116});
...
SoTransform103->setTranslation(new float[]{-2.839,3.899,-0.4116});
...
SoImageTexture107->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint111->setCenter(new float[]{-2.839,3.312,1.078});
...
SoTransform113->setTranslation(new float[]{-2.839,3.312,1.078});
...
SoImageTexture117->setUSE(QString("SunTextureAtlas"));
...
SoCoordinate119->setPoint(new float[]{-1.388,-0.7441,0.9353,0.0,-0.5418,1.142,0.0,-1.042,2.002,-1.356,-1.234,1.823,-1.286,-1.394,3.004,0.0,-1.212,3.154,0.0,-1.708,3.962,-1.162,-1.8,3.64,-1.65,-1.868,2.671,-1.806,-1.859,1.688,-1.217,-2.657,3.79,0.0,-2.605,4.159,-1.729,-2.767,2.676,-1.984,-2.747,-0.4534,-1.847,-1.879,-0.4111,-1.91,-1.914,0.8074,-2.006,-2.83,0.7644,-1.895,-2.791,1.697,1.388,-0.7441,0.9353,1.356,-1.234,1.823,1.286,-1.394,3.004,1.162,-1.8,3.64,1.91,-1.914,0.8074,1.806,-1.859,1.688,1.217,-2.657,3.79,1.729,-2.767,2.676,2.006,-2.83,0.7644,1.847,-1.879,-0.4111,1.984,-2.747,-0.4534,1.65,-1.868,2.671,1.895,-2.791,1.697,0.0,-3.18,0.7644,-2.006,-3.18,0.7644,-1.729,-3.137,2.71,-1.217,-3.069,3.793,0.0,-2.997,4.162,0.0,-3.18,-0.4554,-1.99,-3.18,-0.4554,1.729,-3.137,2.71,2.006,-3.18,0.7644,1.217,-3.069,3.793,1.99,-3.18,-0.4554,0.0,-3.141,2.71,-1.895,-3.164,1.686,1.895,-3.164,1.686,0.0,-3.164,1.686,-1.486,-0.5175,-1.502,-1.788,-1.797,-1.502,-1.928,-2.585,-1.502,0.0009,0.1637,0.361,-1.326,-0.0186,0.0033,1.486,-0.5175,-1.502,1.788,-1.797,-1.502,1.928,-2.585,-1.502,1.331,-0.0112,0.0089,0.0,-3.164,-1.502,-1.935,-3.164,-1.502,1.934,-3.164,-1.502,-1.153,-0.3082,-2.015,-1.192,-1.388,-2.379,-1.307,-1.876,-2.363,-1.307,-2.129,-2.356,-0.0004,-2.129,-2.356,1.306,-2.129,-2.356,1.306,-1.876,-2.362,1.191,-1.388,-2.378,1.152,-0.3071,-2.014,1.027,0.2573,-1.173,0.0025,0.3479,-0.8576,-1.023,0.2519,-1.179}, 210);
...
SoHAnimJoint121->setCenter(new float[]{0.0,29.860001,-0.4567});
...
SoTransform123->setTranslation(new float[]{0.0,29.860001,-0.4567});
...
SoImageTexture127->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint131->setCenter(new float[]{6.077,45.880001,-1.319});
...
SoTransform133->setTranslation(new float[]{6.077,45.880001,-1.319});
...
SoImageTexture137->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint141->setCenter(new float[]{7.076,38.529999,-1.385});
...
SoTransform143->setTranslation(new float[]{7.076,38.529999,-1.385});
...
SoImageTexture147->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint151->setCenter(new float[]{6.946,30.889999,-1.308});
...
SoTransform153->setTranslation(new float[]{6.946,30.889999,-1.308});
...
SoImageTexture157->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint161->setCenter(new float[]{-6.077,45.880001,-1.319});
...
SoTransform163->setTranslation(new float[]{-6.077,45.880001,-1.319});
...
SoImageTexture167->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint171->setCenter(new float[]{-7.076,38.529999,-1.385});
...
SoTransform173->setTranslation(new float[]{-7.076,38.529999,-1.385});
...
SoImageTexture177->setUSE(QString("SunTextureAtlas"));
...
SoCoordinate179->setPoint(new float[]{-0.896,-3.458,-0.7733,-1.43,-3.283,0.0723,-1.163,-7.27,0.0721,-0.7935,-7.267,-0.5416,0.0234,-3.843,-1.144,0.0262,-7.3,-0.8983,0.6588,-7.609,-0.4491,0.7822,-7.049,-0.481,0.025,-7.07,-0.8149,0.0233,-7.631,-0.7795,0.922,-7.614,0.0729,1.098,-7.053,0.0729,0.6588,-7.612,0.6263,0.7823,-7.05,0.6527,0.9427,-4.174,0.8667,0.8457,-7.28,0.7082,0.0234,-7.282,1.066,0.0234,-3.825,1.273,0.0233,-7.623,0.9572,-0.6122,-7.612,0.6263,-0.7325,-7.043,0.6513,0.0233,-7.057,0.9867,-0.896,-3.452,0.8897,-0.7936,-7.266,0.7058,-0.896,-0.0257,-0.9221,-0.7144,0.4948,-0.6658,-1.02,0.4948,0.0721,-1.277,-0.0257,0.0721,0.0236,-0.0257,-1.334,0.0236,0.4948,-0.9714,0.9432,-0.0257,-0.9221,0.7615,0.4948,-0.6658,1.324,-0.0257,0.0721,1.067,0.4948,0.0721,0.9432,-0.0257,0.9219,0.7615,0.4948,0.8099,0.0236,-0.0257,1.334,0.0236,0.4948,1.116,-0.896,-0.0257,0.9219,-0.7144,0.4948,0.8099,0.0236,0.931,0.0721,-0.6122,-7.609,-0.4491,-0.8754,-7.614,0.0729,-0.583,-8.086,0.0729,-0.4054,-8.063,-0.1612,-0.4054,-8.076,0.3527,0.0233,-8.083,0.5759,0.452,-8.076,0.3527,0.6297,-8.086,0.0729,0.452,-8.063,-0.1612,0.0233,-8.078,-0.3841,0.0233,-8.424,0.0729,-1.403,-0.6344,0.0721,-0.9954,-0.506,-0.8653,0.02,-0.506,-1.277,0.9426,-4.179,-0.7253,1.041,-0.506,-0.8653,1.43,-0.6344,0.0721,1.323,-4.321,0.0723,1.018,-0.6344,0.9221,0.0236,-0.6344,1.334,-0.9707,-0.6344,0.9221,-1.063,-7.046,0.0729,-0.7325,-7.042,-0.4818,0.8456,-7.281,-0.5402,1.188,-7.284,0.0721}, 198);
SoIndexedFaceSet178->setCoord(*SoCoordinate179);

SoTextureCoordinate* SoTextureCoordinate180 = new SoTextureCoordinate();
SoTextureCoordinate180->setPoint(new float[]{0.6214,1.732,0.7319,1.729,0.7045,1.73,0.6763,1.731,0.6737,1.57,0.6695,1.581,0.6525,1.578,0.6596,1.565,0.672,1.648,0.5944,1.731,0.669,1.585,0.692,1.585,0.6985,1.654,0.6909,1.571,0.7076,1.568,0.7136,1.579,0.6917,1.581,0.7251,1.66,0.7149,1.583,0.7334,1.58,0.5663,1.733,0.5738,1.66,0.5479,1.661,0.7502,1.661,0.5667,1.581,0.5849,1.584,0.6006,1.655,0.6078,1.585,0.6259,1.57,0.6303,1.581,0.6081,1.582,0.6088,1.572,0.6784,1.72,0.6987,1.718,0.715,1.723,0.7248,1.738,0.7566,1.727,0.6922,1.739,0.7083,1.553,0.7208,1.562,0.7017,1.557,0.69,1.561,0.6778,1.559,0.6394,1.565,0.6467,1.578,0.6707,1.555,0.6891,1.549,0.5851,1.722,0.5744,1.738,0.5383,1.729,0.6749,1.719,0.7035,1.718,0.732,1.717,0.7566,1.715,0.6497,1.584,0.73,1.574,0.6021,1.717,0.6226,1.719,0.6477,1.727,0.6092,1.739,0.5919,1.569,0.5792,1.563,0.5915,1.554,0.5975,1.558,0.6219,1.559,0.6284,1.556,0.6095,1.561,0.6103,1.55,0.5395,1.716,0.5658,1.721,0.5946,1.722,0.6275,1.648,0.6242,1.723,0.6504,1.719,0.6499,1.645,0.5702,1.575,0.5861,1.579,0.6308,1.586,0.6503,1.731,0.6767,1.711,0.7018,1.71,0.7234,1.719,0.7395,1.728,0.577,1.712,0.5523,1.731,0.5995,1.706,0.6239,1.709,0.6527,1.716}, 176);
...
SoHAnimJoint181->setCenter(new float[]{-6.946,30.889999,-1.308});
...
SoTransform183->setTranslation(new float[]{-6.946,30.889999,-1.308});
...
SoImageTexture187->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint191->setCenter(new float[]{0.05249,34.130001,-0.468});
...
SoTransform193->setTranslation(new float[]{0.05249,34.130001,-0.468});
...
SoImageTexture197->setUSE(QString("SunTextureAtlas"));
...
SoHAnimJoint201->setCenter(new float[]{0.0,51.25,-1.124});
...
SoTransform203->setTranslation(new float[]{0.0,51.25,-1.124});
...
SoImageTexture207->setUSE(QString("SunTextureAtlas"));

...
Someta16->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/data/sphereflowers.x3d"));
...
SoExternProtoDeclare21->setUrl(new QString[]{QString("../data/flowerproto.x3d#FlowerProto"), QString("https://coderextreme.net/X3DJSONLD/src/main/data/flowerproto.x3d#FlowerProto")}, 2);

...
Someta3->setContent(QString("JinOriginalLOA2.x3d"));
...
Someta9->setContent(QString("All length values are rescaled from inches to meters, not compatible with other typical motion animation behavior libraries which are based in meters."));
Sohead1->addMeta(*Someta9);

Someta* Someta10 = new Someta();
Someta10->setName(QString("description"));
Someta10->setContent(QString("Original version of articulated 3D game character designed with a general graphics tool, then converted into an X3D HAnim model."));
...
Someta14->setContent(QString("JinLOA2.x3d"));
...
Someta16->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA2.x3d"));
...
SoWorldInfo21->setTitle(QString("JinOriginalLOA2.x3d"));
...
SoViewpoint23->setDescription(QString("JinLOA2"));
...
SoHAnimHumanoid24->setDEF(QString("hanim_JinLOA2"));
SoHAnimHumanoid24->X3DNode::setName(QString("JinLOA2"));
SoHAnimHumanoid24->setLoa(2);
...
SoImageTexture38->setDEF(QString("JinLOA2TextureAtlas"));
...
SoImageTexture48->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture58->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture68->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture78->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture88->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture98->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture108->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture118->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture128->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture138->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture148->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture158->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture168->setUSE(QString("JinLOA2TextureAtlas"));
...
SoImageTexture178->setUSE(QString("JinLOA2TextureAtlas"));
...
SoCoordinate181->setPoint(new float[]{4.178,1.114,3.711,5.76,1.15,1.754,1.52,0.9575,-3.918,3.95,0.9672,-2.776,5.309,1.072,-0.9797,3.789,0.0396,2.969,5.166,0.0713,1.445,1.593,-0.0798,-2.916,3.6,-0.0573,-2.087,4.841,-0.0103,-0.6841,1.635,1.083,4.322,1.595,0.0009,3.405,0.0,0.0009,3.405,0.0,1.083,4.322,-1.595,0.0009,3.405,-3.789,0.0396,2.969,-4.178,1.114,3.711,-1.635,1.083,4.322,-5.166,0.0713,1.445,-5.76,1.15,1.754,-3.6,-0.0573,-2.087,-1.593,-0.0798,-2.916,-1.52,0.9575,-3.918,-3.95,0.9672,-2.776,-4.841,-0.0103,-0.6841,-5.309,1.072,-0.9797,0.0,-0.0798,-2.916,0.0,0.9575,-3.918,1.609,1.867,3.426,4.053,1.867,2.943,5.524,1.867,1.449,5.098,1.867,-0.671,3.806,1.867,-2.074,1.47,1.867,-2.976,0.0,1.867,-2.976,-1.47,1.867,-2.976,-3.806,1.867,-2.074,-5.098,1.867,-0.671,-5.524,1.867,1.449,-4.053,1.867,2.943,-1.609,1.867,3.426,0.0,1.867,3.426}, 126);
...
SoHAnimJoint182->setDEF(QString("hanim_vl3"));
SoHAnimJoint182->X3DNode::setName(QString("vl3"));
SoHAnimJoint182->setCenter(new float[]{0.0,41.3,-0.6117});
SoHAnimSegment* SoHAnimSegment183 = new SoHAnimSegment();
SoHAnimSegment183->setDEF(QString("hanim_l3"));
SoHAnimSegment183->X3DNode::setName(QString("l3"));
...
SoImageTexture188->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint192->setDEF(QString("hanim_vl1"));
SoHAnimJoint192->X3DNode::setName(QString("vl1"));
SoHAnimJoint192->setCenter(new float[]{0.0,42.76,-0.6117});
SoHAnimSegment* SoHAnimSegment193 = new SoHAnimSegment();
SoHAnimSegment193->setDEF(QString("hanim_l1"));
SoHAnimSegment193->X3DNode::setName(QString("l1"));
SoTransform* SoTransform194 = new SoTransform();
SoTransform194->setTranslation(new float[]{0.0,42.76,-0.6117});
...
SoImageTexture198->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint202->setDEF(QString("hanim_vt10"));
SoHAnimJoint202->X3DNode::setName(QString("vt10"));
SoHAnimJoint202->setCenter(new float[]{0.0,44.58,-0.6127});
SoHAnimSegment* SoHAnimSegment203 = new SoHAnimSegment();
SoHAnimSegment203->setDEF(QString("hanim_t10"));
SoHAnimSegment203->X3DNode::setName(QString("t10"));
SoTransform* SoTransform204 = new SoTransform();
SoTransform204->setTranslation(new float[]{0.0,44.58,-0.6127});
...
SoImageTexture208->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint212->setDEF(QString("hanim_vt6"));
SoHAnimJoint212->X3DNode::setName(QString("vt6"));
SoHAnimJoint212->setCenter(new float[]{0.0,47.04,-0.6117});
SoHAnimSegment* SoHAnimSegment213 = new SoHAnimSegment();
SoHAnimSegment213->setDEF(QString("hanim_t6"));
SoHAnimSegment213->X3DNode::setName(QString("t6"));
SoTransform* SoTransform214 = new SoTransform();
SoTransform214->setTranslation(new float[]{0.0,47.04,-0.6117});
...
SoImageTexture218->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint222->setDEF(QString("hanim_vt1"));
SoHAnimJoint222->X3DNode::setName(QString("vt1"));
SoHAnimJoint222->setCenter(new float[]{0.0,49.62,-0.6117});
SoHAnimSegment* SoHAnimSegment223 = new SoHAnimSegment();
SoHAnimSegment223->setDEF(QString("hanim_t1"));
SoHAnimSegment223->X3DNode::setName(QString("t1"));
SoTransform* SoTransform224 = new SoTransform();
SoTransform224->setTranslation(new float[]{0.0,49.62,-0.6117});
...
SoImageTexture228->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint232->setDEF(QString("hanim_l_acromioclavicular"));
SoHAnimJoint232->X3DNode::setName(QString("l_acromioclavicular"));
SoHAnimJoint232->setCenter(new float[]{1.71,52.82,-0.6127});
SoHAnimSegment* SoHAnimSegment233 = new SoHAnimSegment();
SoHAnimSegment233->setDEF(QString("hanim_l_clavicle"));
SoHAnimSegment233->X3DNode::setName(QString("l_clavicle"));
SoTransform* SoTransform234 = new SoTransform();
SoTransform234->setTranslation(new float[]{1.71,52.82,-0.6127});
...
SoImageTexture238->setUSE(QString("JinLOA2TextureAtlas"));
...
SoIndexedFaceSet239->setTexCoordIndex(new int32_t[]{9,6,1,-1,1,0,9,-1,6,5,2,-1,2,1,6,-1,8,3,2,-1,2,5,8,-1,8,7,4,-1,4,3,8,-1,9,0,4,-1,4,7,9,-1,2,3,4,-1,2,4,0,-1,1,2,0,-1,13,14,10,-1,12,13,10,-1,11,12,10,-1,6,9,11,-1,11,10,6,-1,9,7,12,-1,12,11,9,-1,7,8,13,-1,13,12,7,-1,8,5,14,-1,14,13,8,-1,5,6,10,-1,10,14,5,-1}, 104);
SoIndexedFaceSet239->setCoordIndex(new int32_t[]{9,6,1,-1,1,0,9,-1,6,5,2,-1,2,1,6,-1,8,3,2,-1,2,5,8,-1,8,7,4,-1,4,3,8,-1,9,0,4,-1,4,7,9,-1,2,3,4,-1,2,4,0,-1,1,2,0,-1,13,14,10,-1,12,13,10,-1,11,12,10,-1,6,9,11,-1,11,10,6,-1,9,7,12,-1,12,11,9,-1,7,8,13,-1,13,12,7,-1,8,5,14,-1,14,13,8,-1,5,6,10,-1,10,14,5,-1}, 104);
SoTextureCoordinate* SoTextureCoordinate240 = new SoTextureCoordinate();
SoTextureCoordinate240->setPoint(new float[]{0.1911,0.4797,0.171,0.4832,0.1497,0.4806,0.1519,0.4334,0.1831,0.4416,0.1474,0.4856,0.1708,0.4854,0.1784,0.4249,0.1538,0.4251,0.1963,0.4863,0.19,0.5091,0.1847,0.499,0.172,0.4382,0.1568,0.4457,0.1409,0.4926}, 30);
SoIndexedFaceSet239->setTexCoord(*SoTextureCoordinate240);

SoCoordinate* SoCoordinate241 = new SoCoordinate();
SoCoordinate241->setPoint(new float[]{4.99,0.104,-0.8644,5.073,0.4993,0.047,4.706,0.1695,1.198,4.631,-1.819,1.104,4.586,-1.648,-0.1248,3.376,0.3884,1.771,3.891,0.989,-0.0537,4.193,-2.49,-0.5713,4.388,-2.49,1.429,3.761,0.3238,-1.692,-0.1237,0.6312,-0.1883,-0.1237,0.3007,-0.9426,-0.1237,-1.418,-0.2577,-0.1237,-1.392,0.6264,-0.1237,0.2586,0.8179}, 45);
...
SoHAnimJoint242->setDEF(QString("hanim_l_sternoclavicular"));
SoHAnimJoint242->X3DNode::setName(QString("l_sternoclavicular"));
SoHAnimJoint242->setCenter(new float[]{5.464,52.06,-0.5732});
SoHAnimSegment* SoHAnimSegment243 = new SoHAnimSegment();
SoHAnimSegment243->setDEF(QString("hanim_l_scapula"));
SoHAnimSegment243->X3DNode::setName(QString("l_scapula"));
SoTransform* SoTransform244 = new SoTransform();
SoTransform244->setTranslation(new float[]{5.464,52.06,-0.5732});
...
SoImageTexture248->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint252->setDEF(QString("hanim_l_shoulder"));
SoHAnimJoint252->X3DNode::setName(QString("l_shoulder"));
SoHAnimJoint252->setCenter(new float[]{7.336,51.48,-0.1452});
SoHAnimSegment* SoHAnimSegment253 = new SoHAnimSegment();
SoHAnimSegment253->setDEF(QString("hanim_l_upperarm"));
SoHAnimSegment253->X3DNode::setName(QString("l_upperarm"));
SoTransform* SoTransform254 = new SoTransform();
SoTransform254->setTranslation(new float[]{7.336,51.48,-0.1452});
...
SoImageTexture258->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint262->setDEF(QString("hanim_l_elbow"));
SoHAnimJoint262->X3DNode::setName(QString("l_elbow"));
SoHAnimJoint262->setCenter(new float[]{8.093,40.38,-0.2502});
SoHAnimSegment* SoHAnimSegment263 = new SoHAnimSegment();
SoHAnimSegment263->setDEF(QString("hanim_l_forearm"));
SoHAnimSegment263->X3DNode::setName(QString("l_forearm"));
SoTransform* SoTransform264 = new SoTransform();
SoTransform264->setTranslation(new float[]{8.093,40.38,-0.2502});
...
SoImageTexture268->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint272->setDEF(QString("hanim_l_radiocarpal"));
SoHAnimJoint272->X3DNode::setName(QString("l_radiocarpal"));
SoHAnimJoint272->setCenter(new float[]{7.899,31.43,-0.3809});
SoHAnimSegment* SoHAnimSegment273 = new SoHAnimSegment();
SoHAnimSegment273->setDEF(QString("hanim_l_carpal"));
SoHAnimSegment273->X3DNode::setName(QString("l_carpal"));
SoTransform* SoTransform274 = new SoTransform();
SoTransform274->setTranslation(new float[]{7.899,31.43,-0.3809});
...
SoImageTexture278->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint282->setDEF(QString("hanim_l_carpometacarpal_1"));
SoHAnimJoint282->X3DNode::setName(QString("l_carpometacarpal_1"));
SoHAnimJoint282->setCenter(new float[]{8.205,29.6,1.302});
SoHAnimSegment* SoHAnimSegment283 = new SoHAnimSegment();
SoHAnimSegment283->setDEF(QString("hanim_l_metacarpal_1"));
SoHAnimSegment283->X3DNode::setName(QString("l_metacarpal_1"));
SoTransform* SoTransform284 = new SoTransform();
SoTransform284->setTranslation(new float[]{8.205,29.6,1.302});
...
SoImageTexture288->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint292->setDEF(QString("hanim_l_metacarpophalangeal_1"));
SoHAnimJoint292->X3DNode::setName(QString("l_metacarpophalangeal_1"));
SoHAnimJoint292->setCenter(new float[]{8.08,28.73,1.55});
SoHAnimSegment* SoHAnimSegment293 = new SoHAnimSegment();
SoHAnimSegment293->setDEF(QString("hanim_l_carpal_proximal_phalanx_1"));
SoHAnimSegment293->X3DNode::setName(QString("l_carpal_proximal_phalanx_1"));
SoTransform* SoTransform294 = new SoTransform();
SoTransform294->setTranslation(new float[]{8.08,28.73,1.55});
...
SoImageTexture298->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint302->setDEF(QString("hanim_l_carpal_interphalangeal_1"));
SoHAnimJoint302->X3DNode::setName(QString("l_carpal_interphalangeal_1"));
SoHAnimJoint302->setCenter(new float[]{7.832,27.85,1.735});
SoHAnimSegment* SoHAnimSegment303 = new SoHAnimSegment();
SoHAnimSegment303->setDEF(QString("hanim_l_carpal_distal_phalanx_1"));
SoHAnimSegment303->X3DNode::setName(QString("l_carpal_distal_phalanx_1"));
SoTransform* SoTransform304 = new SoTransform();
SoTransform304->setTranslation(new float[]{7.832,27.85,1.735});
...
SoImageTexture308->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint312->setDEF(QString("hanim_l_carpometacarpal_2"));
SoHAnimJoint312->X3DNode::setName(QString("l_carpometacarpal_2"));
SoHAnimJoint312->setCenter(new float[]{8.376,28.55,0.5997});
SoHAnimSegment* SoHAnimSegment313 = new SoHAnimSegment();
SoHAnimSegment313->setDEF(QString("hanim_l_metacarpal_2"));
SoHAnimSegment313->X3DNode::setName(QString("l_metacarpal_2"));
SoTransform* SoTransform314 = new SoTransform();
SoTransform314->setTranslation(new float[]{8.376,28.55,0.5997});
...
SoImageTexture318->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate320->setPoint(new float[]{0.453,0.6387,0.4487,0.6387,0.4487,0.6388,0.453,0.6389,0.4561,0.6405,0.453,0.6403,0.4561,0.6406,0.4528,0.6407,0.4485,0.6406,0.4453,0.6405,0.4454,0.6403,0.4487,0.6402,0.4563,0.6497,0.4527,0.6495,0.4562,0.6499,0.4525,0.65,0.4474,0.6499,0.4439,0.6497,0.4439,0.6495,0.4476,0.6494,0.4567,0.6512,0.4528,0.651,0.4566,0.6514,0.4526,0.6515,0.4471,0.6514,0.4432,0.6512,0.4433,0.651,0.4473,0.6509,0.4546,0.6527,0.4519,0.6525,0.4546,0.6528,0.4518,0.6529,0.4478,0.6528,0.4451,0.6527,0.4452,0.6525,0.448,0.6524,0.4498,0.6533}, 74);
SoIndexedFaceSet319->setTexCoord(*SoTextureCoordinate320);

SoCoordinate* SoCoordinate321 = new SoCoordinate();
SoCoordinate321->setPoint(new float[]{-0.0229,-1.485,0.1659,-0.0277,-1.493,-0.0662,0.2213,-1.467,0.1625,0.2166,-1.475,-0.0696,-0.2194,-1.321,0.162,-0.0326,-1.302,0.3335,0.2116,-1.284,0.3301,0.3912,-1.276,0.1535,0.3864,-1.284,-0.0786,0.1997,-1.303,-0.2501,-0.0446,-1.321,-0.2467,-0.2242,-1.329,-0.0701,-0.3384,-0.3382,0.1488,-0.1289,-0.3166,0.3412,0.1617,-0.2951,0.3371,0.3631,-0.2862,0.139,0.3574,-0.2953,-0.1371,0.148,-0.3169,-0.3295,-0.1426,-0.3384,-0.3254,-0.3441,-0.3473,-0.1273,-0.3796,-0.1843,0.1553,-0.1523,-0.1608,0.364,0.1629,-0.1375,0.3596,0.3814,-0.1279,0.1446,0.3753,-0.1377,-0.1549,0.148,-0.1611,-0.3636,-0.1672,-0.1845,-0.3592,-0.3858,-0.1941,-0.1442,-0.2808,-0.0217,0.1042,-0.1201,-0.0051,0.2518,0.1029,0.0114,0.2486,0.2574,0.0182,0.0967,0.253,0.0113,-0.1151,0.0923,-0.0053,-0.2627,-0.1306,-0.0218,-0.2596,-0.2851,-0.0286,-0.1076,-0.0187,0.0593,-0.0078}, 111);
...
SoHAnimJoint322->setDEF(QString("hanim_l_metacarpophalangeal_2"));
SoHAnimJoint322->X3DNode::setName(QString("l_metacarpophalangeal_2"));
SoHAnimJoint322->setCenter(new float[]{8.52,27.24,0.6551});
SoHAnimSegment* SoHAnimSegment323 = new SoHAnimSegment();
SoHAnimSegment323->setDEF(QString("hanim_l_carpal_proximal_phalanx_2"));
SoHAnimSegment323->X3DNode::setName(QString("l_carpal_proximal_phalanx_2"));
SoTransform* SoTransform324 = new SoTransform();
SoTransform324->setTranslation(new float[]{8.52,27.24,0.6551});
...
SoImageTexture328->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate330->setPoint(new float[]{0.454,0.6279,0.4498,0.6279,0.4498,0.6277,0.454,0.6277,0.4571,0.6295,0.4539,0.6296,0.4571,0.6293,0.4539,0.6291,0.4496,0.6291,0.4464,0.6292,0.4465,0.6294,0.4497,0.6295,0.4573,0.6381,0.4537,0.6382,0.4572,0.6379,0.4536,0.6377,0.4486,0.6376,0.445,0.6377,0.445,0.6379,0.4486,0.6381,0.4578,0.6395,0.4538,0.6396,0.4577,0.6392,0.4538,0.639,0.4482,0.6389,0.4443,0.639,0.4444,0.6393,0.4483,0.6395,0.4557,0.6408,0.4529,0.6408,0.4557,0.6406,0.4529,0.6404,0.449,0.6404,0.4462,0.6404,0.4462,0.6406,0.449,0.6408,0.4509,0.6412}, 74);
...
SoHAnimJoint332->setDEF(QString("hanim_l_carpal_proximal_interphalangeal_2"));
SoHAnimJoint332->X3DNode::setName(QString("l_carpal_proximal_interphalangeal_2"));
SoHAnimJoint332->setCenter(new float[]{8.45,26.1,0.6956});
SoHAnimSegment* SoHAnimSegment333 = new SoHAnimSegment();
SoHAnimSegment333->setDEF(QString("hanim_l_carpal_middle_phalanx_2"));
SoHAnimSegment333->X3DNode::setName(QString("l_carpal_middle_phalanx_2"));
SoTransform* SoTransform334 = new SoTransform();
SoTransform334->setTranslation(new float[]{8.45,26.1,0.6956});
...
SoImageTexture338->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate340->setPoint(new float[]{0.4546,0.6191,0.4506,0.619,0.4506,0.6185,0.4546,0.6186,0.4575,0.6206,0.4545,0.6209,0.4576,0.6201,0.4545,0.6196,0.4505,0.6196,0.4474,0.6199,0.4474,0.6204,0.4505,0.6209,0.4572,0.6286,0.4541,0.6289,0.4572,0.628,0.4541,0.6276,0.4497,0.6275,0.4466,0.6279,0.4465,0.6284,0.4497,0.6289,0.4558,0.631,0.4534,0.6313,0.4558,0.6306,0.4534,0.6302,0.45,0.6302,0.4475,0.6305,0.4475,0.6309,0.45,0.6312,0.4516,0.6313}, 58);
...
SoHAnimJoint342->setDEF(QString("hanim_l_carpal_distal_interphalangeal_2"));
SoHAnimJoint342->X3DNode::setName(QString("l_carpal_distal_interphalangeal_2"));
SoHAnimJoint342->setCenter(new float[]{8.192,25.17,0.7315});
SoHAnimSegment* SoHAnimSegment343 = new SoHAnimSegment();
SoHAnimSegment343->setDEF(QString("hanim_l_carpal_distal_phalanx_2"));
SoHAnimSegment343->X3DNode::setName(QString("l_carpal_distal_phalanx_2"));
SoTransform* SoTransform344 = new SoTransform();
SoTransform344->setTranslation(new float[]{8.192,25.17,0.7315});
...
SoImageTexture348->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint272->addChildren(*SoHAnimJoint312);

SoHAnimJoint* SoHAnimJoint352 = new SoHAnimJoint();
SoHAnimJoint352->setDEF(QString("hanim_l_carpometacarpal_3"));
SoHAnimJoint352->X3DNode::setName(QString("l_carpometacarpal_3"));
SoHAnimJoint352->setCenter(new float[]{8.344,28.65,-0.194});
SoHAnimSegment* SoHAnimSegment353 = new SoHAnimSegment();
SoHAnimSegment353->setDEF(QString("hanim_l_metacarpal_3"));
SoHAnimSegment353->X3DNode::setName(QString("l_metacarpal_3"));
SoTransform* SoTransform354 = new SoTransform();
SoTransform354->setTranslation(new float[]{8.344,28.65,-0.194});
...
SoImageTexture358->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint362->setDEF(QString("hanim_l_metacarpophalangeal_3"));
SoHAnimJoint362->X3DNode::setName(QString("l_metacarpophalangeal_3"));
SoHAnimJoint362->setCenter(new float[]{8.52,27.26,-0.1959});
SoHAnimSegment* SoHAnimSegment363 = new SoHAnimSegment();
SoHAnimSegment363->setDEF(QString("hanim_l_carpal_proximal_phalanx_3"));
SoHAnimSegment363->X3DNode::setName(QString("l_carpal_proximal_phalanx_3"));
SoTransform* SoTransform364 = new SoTransform();
SoTransform364->setTranslation(new float[]{8.52,27.26,-0.1959});
...
SoImageTexture368->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint372->setDEF(QString("hanim_l_carpal_proximal_interphalangeal_3"));
SoHAnimJoint372->X3DNode::setName(QString("l_carpal_proximal_interphalangeal_3"));
SoHAnimJoint372->setCenter(new float[]{8.477,26.07,-0.2214});
SoHAnimSegment* SoHAnimSegment373 = new SoHAnimSegment();
SoHAnimSegment373->setDEF(QString("hanim_l_carpal_middle_phalanx_3"));
SoHAnimSegment373->X3DNode::setName(QString("l_carpal_middle_phalanx_3"));
SoTransform* SoTransform374 = new SoTransform();
SoTransform374->setTranslation(new float[]{8.477,26.07,-0.2214});
...
SoImageTexture378->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint382->setDEF(QString("hanim_l_carpal_distal_interphalangeal_3"));
SoHAnimJoint382->X3DNode::setName(QString("l_carpal_distal_interphalangeal_3"));
SoHAnimJoint382->setCenter(new float[]{8.25,25.03,-0.2187});
SoHAnimSegment* SoHAnimSegment383 = new SoHAnimSegment();
SoHAnimSegment383->setDEF(QString("hanim_l_carpal_distal_phalanx_3"));
SoHAnimSegment383->X3DNode::setName(QString("l_carpal_distal_phalanx_3"));
SoTransform* SoTransform384 = new SoTransform();
SoTransform384->setTranslation(new float[]{8.25,25.03,-0.2187});
...
SoImageTexture388->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate390->setPoint(new float[]{0.4356,0.6082,0.4321,0.6082,0.4322,0.6074,0.4357,0.6074,0.4383,0.6096,0.4356,0.6102,0.4384,0.6088,0.4359,0.6083,0.4324,0.6083,0.4296,0.6089,0.4295,0.6096,0.4321,0.6102,0.4394,0.6176,0.4364,0.6183,0.4396,0.6167,0.4367,0.6161,0.4325,0.6161,0.4295,0.6168,0.4293,0.6177,0.4322,0.6183,0.4388,0.6192,0.4362,0.6198,0.4389,0.6186,0.4364,0.6181,0.433,0.6182,0.4304,0.6187,0.4303,0.6194,0.4326,0.6199,0.4346,0.6199}, 58);
...
SoHAnimJoint272->addChildren(*SoHAnimJoint352);

SoHAnimJoint* SoHAnimJoint392 = new SoHAnimJoint();
SoHAnimJoint392->setDEF(QString("hanim_l_carpometacarpal_4"));
SoHAnimJoint392->X3DNode::setName(QString("l_carpometacarpal_4"));
SoHAnimJoint392->setCenter(new float[]{8.339,28.57,-0.9243});
SoHAnimSegment* SoHAnimSegment393 = new SoHAnimSegment();
SoHAnimSegment393->setDEF(QString("hanim_l_metacarpal_4"));
SoHAnimSegment393->X3DNode::setName(QString("l_metacarpal_4"));
SoTransform* SoTransform394 = new SoTransform();
SoTransform394->setTranslation(new float[]{8.339,28.57,-0.9243});
...
SoImageTexture398->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint402->setDEF(QString("hanim_l_metacarpophalangeal_4"));
SoHAnimJoint402->X3DNode::setName(QString("l_metacarpophalangeal_4"));
SoHAnimJoint402->setCenter(new float[]{8.428,27.3,-0.9985});
SoHAnimSegment* SoHAnimSegment403 = new SoHAnimSegment();
SoHAnimSegment403->setDEF(QString("hanim_l_carpal_proximal_phalanx_4"));
SoHAnimSegment403->X3DNode::setName(QString("l_carpal_proximal_phalanx_4"));
SoTransform* SoTransform404 = new SoTransform();
SoTransform404->setTranslation(new float[]{8.428,27.3,-0.9985});
...
SoImageTexture408->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint412->setDEF(QString("hanim_l_carpal_proximal_interphalangeal_4"));
SoHAnimJoint412->X3DNode::setName(QString("l_carpal_proximal_interphalangeal_4"));
SoHAnimJoint412->setCenter(new float[]{8.428,26.29,-1.034});
SoHAnimSegment* SoHAnimSegment413 = new SoHAnimSegment();
SoHAnimSegment413->setDEF(QString("hanim_l_carpal_middle_phalanx_4"));
SoHAnimSegment413->X3DNode::setName(QString("l_carpal_middle_phalanx_4"));
SoTransform* SoTransform414 = new SoTransform();
SoTransform414->setTranslation(new float[]{8.428,26.29,-1.034});
...
SoImageTexture418->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint422->setDEF(QString("hanim_l_carpal_distal_interphalangeal_4"));
SoHAnimJoint422->X3DNode::setName(QString("l_carpal_distal_interphalangeal_4"));
SoHAnimJoint422->setCenter(new float[]{8.192,25.31,-1.124});
SoHAnimSegment* SoHAnimSegment423 = new SoHAnimSegment();
SoHAnimSegment423->setDEF(QString("hanim_l_carpal_distal_phalanx_4"));
SoHAnimSegment423->X3DNode::setName(QString("l_carpal_distal_phalanx_4"));
SoTransform* SoTransform424 = new SoTransform();
SoTransform424->setTranslation(new float[]{8.192,25.31,-1.124});
...
SoImageTexture428->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint272->addChildren(*SoHAnimJoint392);

SoHAnimJoint* SoHAnimJoint432 = new SoHAnimJoint();
SoHAnimJoint432->setDEF(QString("hanim_l_carpometacarpal_5"));
SoHAnimJoint432->X3DNode::setName(QString("l_carpometacarpal_5"));
SoHAnimJoint432->setCenter(new float[]{8.197,28.37,-1.528});
SoHAnimSegment* SoHAnimSegment433 = new SoHAnimSegment();
SoHAnimSegment433->setDEF(QString("hanim_l_metacarpal_5"));
SoHAnimSegment433->X3DNode::setName(QString("l_metacarpal_5"));
SoTransform* SoTransform434 = new SoTransform();
SoTransform434->setTranslation(new float[]{8.197,28.37,-1.528});
...
SoImageTexture438->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint442->setDEF(QString("hanim_l_metacarpophalangeal_5"));
SoHAnimJoint442->X3DNode::setName(QString("l_metacarpophalangeal_5"));
SoHAnimJoint442->setCenter(new float[]{8.334,27.5,-1.701});
SoHAnimSegment* SoHAnimSegment443 = new SoHAnimSegment();
SoHAnimSegment443->setDEF(QString("hanim_l_carpal_proximal_phalanx_5"));
SoHAnimSegment443->X3DNode::setName(QString("l_carpal_proximal_phalanx_5"));
SoTransform* SoTransform444 = new SoTransform();
SoTransform444->setTranslation(new float[]{8.334,27.5,-1.701});
...
SoImageTexture448->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint452->setDEF(QString("hanim_l_carpal_proximal_interphalangeal_5"));
SoHAnimJoint452->X3DNode::setName(QString("l_carpal_proximal_interphalangeal_5"));
SoHAnimJoint452->setCenter(new float[]{8.338,26.78,-1.768});
SoHAnimSegment* SoHAnimSegment453 = new SoHAnimSegment();
SoHAnimSegment453->setDEF(QString("hanim_l_carpal_middle_phalanx_5"));
SoHAnimSegment453->X3DNode::setName(QString("l_carpal_middle_phalanx_5"));
SoTransform* SoTransform454 = new SoTransform();
SoTransform454->setTranslation(new float[]{8.338,26.78,-1.768});
...
SoImageTexture458->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint462->setDEF(QString("hanim_l_carpal_distal_interphalangeal_5"));
SoHAnimJoint462->X3DNode::setName(QString("l_carpal_distal_interphalangeal_5"));
SoHAnimJoint462->setCenter(new float[]{8.153,26.04,-1.886});
SoHAnimSegment* SoHAnimSegment463 = new SoHAnimSegment();
SoHAnimSegment463->setDEF(QString("hanim_l_carpal_distal_phalanx_5"));
SoHAnimSegment463->X3DNode::setName(QString("l_carpal_distal_phalanx_5"));
SoTransform* SoTransform464 = new SoTransform();
SoTransform464->setTranslation(new float[]{8.153,26.04,-1.886});
...
SoImageTexture468->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate470->setPoint(new float[]{0.4049,0.6227,0.4021,0.6229,0.4017,0.6225,0.4045,0.6223,0.4072,0.6236,0.4053,0.624,0.4068,0.6232,0.4044,0.623,0.4016,0.6232,0.3997,0.6236,0.4001,0.624,0.4025,0.6242,0.4086,0.6291,0.4066,0.6295,0.4082,0.6286,0.4055,0.6284,0.4022,0.6286,0.4001,0.6291,0.4005,0.6296,0.4032,0.6297,0.4082,0.6302,0.4064,0.6306,0.4078,0.6299,0.4056,0.6298,0.4028,0.63,0.401,0.6304,0.4014,0.6307,0.4036,0.6308,0.4047,0.6309}, 58);
SoIndexedFaceSet469->setTexCoord(*SoTextureCoordinate470);

SoCoordinate* SoCoordinate471 = new SoCoordinate();
SoCoordinate471->setPoint(new float[]{-0.4265,-0.7665,0.0531,-0.4417,-0.7485,-0.0994,-0.2908,-0.8079,0.0337,-0.306,-0.7899,-0.1188,-0.4775,-0.6307,0.0765,-0.3642,-0.6752,0.1764,-0.2285,-0.7166,0.157,-0.1382,-0.7341,0.0281,-0.1534,-0.7161,-0.1244,-0.2667,-0.6716,-0.2242,-0.4024,-0.6302,-0.2049,-0.4927,-0.6127,-0.076,-0.2189,-0.0422,0.1441,-0.0919,-0.0921,0.2561,0.0696,-0.1414,0.2331,0.1709,-0.161,0.0886,0.1528,-0.1396,-0.0929,0.0258,-0.0897,-0.2049,-0.1357,-0.0404,-0.1819,-0.2371,-0.0207,-0.0373,-0.1344,0.069,0.1368,-0.0252,0.0277,0.2322,0.1149,-0.0067,0.2114,0.202,-0.0158,0.0895,0.1878,0.0058,-0.0611,0.082,0.0466,-0.1545,-0.0552,0.083,-0.137,-0.1456,0.0926,-0.0171,0.0613,0.1015,0.0409}, 87);
...
SoHAnimJoint452->addChildren(*SoHAnimJoint462);

SoHAnimJoint442->addChildren(*SoHAnimJoint452);

SoHAnimJoint432->addChildren(*SoHAnimJoint442);

SoHAnimJoint272->addChildren(*SoHAnimJoint432);
...
SoHAnimJoint472->setDEF(QString("hanim_r_acromioclavicular"));
SoHAnimJoint472->X3DNode::setName(QString("r_acromioclavicular"));
SoHAnimJoint472->setCenter(new float[]{-1.71,52.82,-0.6127});
SoHAnimSegment* SoHAnimSegment473 = new SoHAnimSegment();
SoHAnimSegment473->setDEF(QString("hanim_r_clavicle"));
SoHAnimSegment473->X3DNode::setName(QString("r_clavicle"));
SoTransform* SoTransform474 = new SoTransform();
SoTransform474->setTranslation(new float[]{-1.71,52.82,-0.6127});
...
SoImageTexture478->setUSE(QString("JinLOA2TextureAtlas"));
...
SoIndexedFaceSet479->setTexCoordIndex(new int32_t[]{9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1}, 104);
SoIndexedFaceSet479->setCoordIndex(new int32_t[]{9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1}, 104);
SoTextureCoordinate* SoTextureCoordinate480 = new SoTextureCoordinate();
SoTextureCoordinate480->setPoint(new float[]{0.1911,0.4797,0.171,0.4832,0.1497,0.4806,0.1519,0.4334,0.1831,0.4416,0.1474,0.4856,0.1708,0.4854,0.1784,0.4249,0.1538,0.4251,0.1963,0.4863,0.19,0.5091,0.1847,0.499,0.172,0.4382,0.1568,0.4457,0.1409,0.4926}, 30);
...
SoHAnimJoint482->setDEF(QString("hanim_r_sternoclavicular"));
SoHAnimJoint482->X3DNode::setName(QString("r_sternoclavicular"));
SoHAnimJoint482->setCenter(new float[]{-5.464,52.06,-0.5732});
SoHAnimSegment* SoHAnimSegment483 = new SoHAnimSegment();
SoHAnimSegment483->setDEF(QString("hanim_r_scapula"));
SoHAnimSegment483->X3DNode::setName(QString("r_scapula"));
SoTransform* SoTransform484 = new SoTransform();
SoTransform484->setTranslation(new float[]{-5.464,52.06,-0.5732});
...
SoImageTexture488->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate490->setPoint(new float[]{0.1715,0.4655,0.1797,0.4646,0.1569,0.4642,0.1474,0.4856,0.1708,0.4854,0.1963,0.4863,0.1544,0.4288,0.1782,0.4286,0.1538,0.4251,0.1784,0.4249,0.1544,0.4288,0.1782,0.4286,0.1538,0.4251,0.1784,0.4249,0.1703,0.4865,0.1895,0.487,0.1761,0.4271,0.1552,0.4287,0.1491,0.4835,0.1671,0.4618}, 40);
SoIndexedFaceSet489->setTexCoord(*SoTextureCoordinate490);

SoCoordinate* SoCoordinate491 = new SoCoordinate();
SoCoordinate491->setPoint(new float[]{-1.935,1.466,-0.0932,-1.515,0.6492,-1.732,-1.534,0.7105,1.619,0.3782,1.139,1.732,-0.1374,1.74,-0.0932,-0.0076,1.074,-1.731,-0.8341,-1.572,1.39,-0.4391,-1.74,-0.6109,-0.8275,-1.58,-0.6098,-0.6342,-1.74,1.389,1.237,1.407,-0.0712,1.547,0.8515,-1.142,0.7525,-1.603,-0.4744,0.7511,-1.595,1.16,1.51,1.034,1.296,1.59,-0.0185,0.1351}, 48);
...
SoHAnimJoint492->setDEF(QString("hanim_r_shoulder"));
SoHAnimJoint492->X3DNode::setName(QString("r_shoulder"));
SoHAnimJoint492->setCenter(new float[]{-7.336,51.48,-0.1452});
SoHAnimSegment* SoHAnimSegment493 = new SoHAnimSegment();
SoHAnimSegment493->setDEF(QString("hanim_r_upperarm"));
SoHAnimSegment493->X3DNode::setName(QString("r_upperarm"));
SoTransform* SoTransform494 = new SoTransform();
SoTransform494->setTranslation(new float[]{-7.336,51.48,-0.1452});
...
SoImageTexture498->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint502->setDEF(QString("hanim_r_elbow"));
SoHAnimJoint502->X3DNode::setName(QString("r_elbow"));
SoHAnimJoint502->setCenter(new float[]{-8.093,40.38,-0.2502});
SoHAnimSegment* SoHAnimSegment503 = new SoHAnimSegment();
SoHAnimSegment503->setDEF(QString("hanim_r_forearm"));
SoHAnimSegment503->X3DNode::setName(QString("r_forearm"));
SoTransform* SoTransform504 = new SoTransform();
SoTransform504->setTranslation(new float[]{-8.093,40.38,-0.2502});
...
SoImageTexture508->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate510->setPoint(new float[]{0.4222,0.6201,0.4327,0.6201,0.3884,0.6201,0.3987,0.6201,0.4103,0.6201,0.4213,0.6265,0.4321,0.6265,0.3894,0.6265,0.399,0.6265,0.4105,0.6265,0.4214,0.6413,0.4323,0.6413,0.389,0.6381,0.3992,0.6381,0.4103,0.6413,0.4213,0.6705,0.4336,0.6705,0.3899,0.6705,0.3981,0.6705,0.4094,0.6705,0.4215,0.674,0.4346,0.674,0.3899,0.674,0.398,0.674,0.4083,0.674,0.3787,0.6201,0.3682,0.6201,0.3787,0.6201,0.3782,0.6265,0.3782,0.6265,0.3783,0.6413,0.3783,0.6413,0.3796,0.6705,0.3676,0.674,0.3806,0.674,0.3796,0.6705,0.3806,0.674}, 74);
SoIndexedFaceSet509->setTexCoord(*SoTextureCoordinate510);

SoCoordinate* SoCoordinate511 = new SoCoordinate();
SoCoordinate511->setPoint(new float[]{-0.215,0.3047,-1.152,-1.155,0.2966,-0.2588,-0.6199,0.3013,1.04,0.6505,0.3122,0.9491,0.9008,0.3143,-0.4054,-0.1442,-0.8448,-1.625,-1.472,-0.8561,-0.4271,-0.7164,-0.8496,1.625,1.079,-0.8342,1.482,1.433,-0.8312,-0.6588,-0.1328,-3.5,-1.607,-1.551,-3.513,-0.4225,-0.781,-2.925,1.61,1.136,-2.909,1.468,1.551,-3.486,-0.6519,-0.0592,-8.713,-1.437,-1.093,-8.722,-0.1279,-0.5047,-8.716,1.51,0.8932,-8.704,1.377,1.169,-8.702,-0.3428,-0.0092,-9.336,-0.8855,-0.7154,-9.342,0.0084,-0.3135,-9.339,1.043,0.6412,-9.331,0.9519,0.8292,-9.329,-0.1383}, 75);
...
SoHAnimJoint512->setDEF(QString("hanim_r_radiocarpal"));
SoHAnimJoint512->X3DNode::setName(QString("r_radiocarpal"));
SoHAnimJoint512->setCenter(new float[]{-7.899,31.43,-0.3809});
SoHAnimSegment* SoHAnimSegment513 = new SoHAnimSegment();
SoHAnimSegment513->setDEF(QString("hanim_r_carpal"));
SoHAnimSegment513->X3DNode::setName(QString("r_carpal"));
SoTransform* SoTransform514 = new SoTransform();
SoTransform514->setTranslation(new float[]{-7.899,31.43,-0.3809});
...
SoImageTexture518->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate520->setPoint(new float[]{0.4538,0.6821,0.4536,0.6827,0.4366,0.6851,0.4365,0.6843,0.4719,0.6661,0.4711,0.6637,0.4639,0.67,0.4606,0.6487,0.4605,0.6507,0.4603,0.6538,0.4606,0.6529,0.4117,0.6708,0.4117,0.6714,0.4055,0.6612,0.4047,0.6602,0.4025,0.6505,0.4027,0.6493,0.4177,0.6589,0.4355,0.6719,0.431,0.6469,0.4157,0.6482,0.414,0.6419,0.4289,0.6406,0.4346,0.6727,0.4316,0.6601,0.4169,0.6604,0.4607,0.6543,0.4504,0.6593,0.4308,0.6489,0.4498,0.6605,0.4482,0.6491,0.4143,0.6427,0.4297,0.6411,0.4754,0.6565,0.4752,0.6543,0.4024,0.6436,0.4026,0.6446,0.4463,0.6407,0.4467,0.6399,0.4164,0.6496,0.419,0.6831,0.4192,0.6825,0.4346,0.6583,0.4478,0.647,0.4591,0.6409,0.4581,0.6741,0.4578,0.6416,0.4616,0.6733,0.4549,0.6767,0.455,0.6762,0.4365,0.6779,0.4176,0.6767,0.4177,0.6762,0.4368,0.6768,0.46,0.6628}, 110);
SoIndexedFaceSet519->setTexCoord(*SoTextureCoordinate520);

SoCoordinate* SoCoordinate521 = new SoCoordinate();
SoCoordinate521->setPoint(new float[]{-0.615,-0.6885,1.418,0.2519,-0.7698,1.606,-0.894,-4.14,1.405,-0.2357,-4.221,1.472,-0.7106,-2.848,1.537,0.2913,-2.795,1.561,-0.3511,-0.9723,-1.085,0.332,-1.036,-1.083,-0.6255,-3.82,-1.576,-0.076,-3.93,-1.587,-0.5517,-2.055,-1.417,0.1089,-2.163,-1.46,-0.0149,-3.564,0.866,0.0687,-3.436,-0.8707,-0.9147,-4.192,-0.1153,-0.2445,-4.253,-0.1554,-0.7883,-4.028,-0.9461,-0.1878,-4.111,-0.9619,0.1749,-2.558,2.351,-0.5105,-2.795,2.344,0.1613,-2.264,1.005,-0.8473,-3.286,-0.8304,-0.9399,-2.17,-0.0115,-0.979,-3.369,-0.052,0.4715,-0.9186,0.2017,-0.7286,-0.8328,0.1541,0.1459,-2.365,0.1498,0.0501,-3.575,-0.0433,-0.969,-2.127,0.9718,-0.9825,-3.348,0.8866,-0.0909,-3.383,1.556,-0.8371,-3.169,1.547,-0.041,-3.318,-1.568,-0.5921,-3.194,-1.578,0.2264,-2.304,-0.7602,-0.8375,-2.137,-0.8044,0.2818,0.1713,1.187,-0.2277,0.2301,1.179,-0.2277,0.4881,0.2572,-0.1331,0.2707,-0.6889,0.3764,0.2118,-0.6809,0.4614,0.4054,0.2565,-0.9242,-4.241,0.7847,-0.2647,-4.324,0.8047,0.3043,-1.534,2.164,-0.8425,-1.789,2.123,0.201,-0.4603,1.254,-0.3856,-0.405,1.248,-0.4965,-0.283,0.2553,-0.2563,-0.4079,-0.7647,0.3314,-0.4586,-0.758,0.3822,-0.3913,0.2697,0.4485,-1.891,1.52,-0.3893,-2.936,1.555,-0.7623,-1.12,1.731}, 165);
...
SoHAnimJoint522->setDEF(QString("hanim_r_carpometacarpal_1"));
SoHAnimJoint522->X3DNode::setName(QString("r_carpometacarpal_1"));
SoHAnimJoint522->setCenter(new float[]{-8.205,29.6,1.302});
SoHAnimSegment* SoHAnimSegment523 = new SoHAnimSegment();
SoHAnimSegment523->setDEF(QString("hanim_r_metacarpal_1"));
SoHAnimSegment523->X3DNode::setName(QString("r_metacarpal_1"));
SoTransform* SoTransform524 = new SoTransform();
SoTransform524->setTranslation(new float[]{-8.205,29.6,1.302});
...
SoImageTexture528->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate530->setPoint(new float[]{0.469,0.6546,0.4646,0.6538,0.4679,0.6539,0.4723,0.6548,0.4715,0.6565,0.4657,0.6558,0.4749,0.6566,0.4741,0.6561,0.4697,0.6552,0.4639,0.6545,0.4606,0.6544,0.4613,0.655,0.468,0.6634,0.4615,0.6626,0.472,0.6635,0.4712,0.6629,0.466,0.6619,0.4595,0.6611,0.4555,0.661,0.4563,0.6616,0.4678,0.6645,0.4607,0.6637,0.4721,0.6647,0.4712,0.664,0.4655,0.6629,0.4585,0.6621,0.4541,0.6619,0.455,0.6626,0.4658,0.6652,0.4608,0.6646,0.4689,0.6653,0.4682,0.6649,0.4642,0.6641,0.4592,0.6635,0.4561,0.6634,0.4568,0.6639,0.4622,0.6648}, 74);
SoIndexedFaceSet529->setTexCoord(*SoTextureCoordinate530);

SoCoordinate* SoCoordinate531 = new SoCoordinate();
SoCoordinate531->setPoint(new float[]{0.375,-0.9214,0.322,0.212,-1.009,0.0858,0.1385,-0.9095,0.5036,-0.0245,-0.9973,0.2674,0.533,-0.8014,0.1471,0.4779,-0.7267,0.4605,0.2413,-0.7148,0.6421,-0.0584,-0.7717,0.6012,-0.2213,-0.8595,0.365,-0.1662,-0.9342,0.0516,0.0704,-0.9461,-0.13,0.3701,-0.8892,-0.0891,0.4847,-0.0791,-0.0791,0.4228,0.0048,0.2724,0.1414,0.0189,0.4885,-0.1948,-0.0449,0.4426,-0.3887,-0.1493,0.1616,-0.3268,-0.2331,-0.1899,-0.0453,-0.2473,-0.406,0.2908,-0.1835,-0.3601,0.5058,0.0372,-0.1235,0.4385,0.1283,0.2586,0.1325,0.1437,0.4936,-0.233,0.0743,0.4437,-0.4438,-0.0392,0.1381,-0.3765,-0.1303,-0.244,-0.0705,-0.1457,-0.479,0.2949,-0.0763,-0.4291,0.3497,0.1392,-0.1192,0.3021,0.2036,0.1511,0.0857,0.2145,0.3172,-0.1727,0.1654,0.2819,-0.3218,0.0852,0.0659,-0.2742,0.0207,-0.2044,-0.0578,0.0098,-0.3705,0.2006,0.0589,-0.3352,0.0069,0.159,-0.0407}, 111);
...
SoHAnimJoint532->setDEF(QString("hanim_r_metacarpophalangeal_1"));
SoHAnimJoint532->X3DNode::setName(QString("r_metacarpophalangeal_1"));
SoHAnimJoint532->setCenter(new float[]{-8.08,28.73,1.55});
SoHAnimSegment* SoHAnimSegment533 = new SoHAnimSegment();
SoHAnimSegment533->setDEF(QString("hanim_r_carpal_proximal_phalanx_1"));
SoHAnimSegment533->X3DNode::setName(QString("r_carpal_proximal_phalanx_1"));
SoTransform* SoTransform534 = new SoTransform();
SoTransform534->setTranslation(new float[]{-8.08,28.73,1.55});
...
SoImageTexture538->setUSE(QString("JinLOA2TextureAtlas"));
...
SoCoordinate541->setPoint(new float[]{0.5258,-1.001,0.2196,0.3901,-1.074,0.023,0.3376,-1.029,0.3799,0.2019,-1.102,0.1833,0.6244,-0.8415,0.0751,0.585,-0.8078,0.3428,0.3968,-0.8361,0.503,0.1539,-0.912,0.4758,0.0182,-0.985,0.2792,0.0576,-1.019,0.0115,0.2458,-0.9905,-0.1487,0.4887,-0.9145,-0.1215,0.4357,-0.0607,-0.0712,0.3915,-0.0229,0.229,0.1676,-0.0565,0.4196,-0.1048,-0.1417,0.3891,-0.2662,-0.2286,0.1552,-0.222,-0.2663,-0.1451,0.0018,-0.2328,-0.3357,0.2743,-0.1476,-0.3051,0.4293,0.0682,-0.1026,0.3812,0.1092,0.2242,0.1376,0.0727,0.4317,-0.1589,-0.02,0.3984,-0.3346,-0.1146,0.1438,-0.2865,-0.1556,-0.1829,-0.0429,-0.1191,-0.3904,0.2536,-0.0264,-0.3572,0.2801,0.1629,-0.0879,0.2461,0.1919,0.1432,0.0738,0.1661,0.2899,-0.1359,0.1005,0.2664,-0.2601,0.0337,0.0864,-0.2261,0.0046,-0.1447,-0.0538,0.0304,-0.2914,0.1558,0.096,-0.2679,-0.0055,0.1486,-0.0096}, 111);
...
SoHAnimJoint542->setDEF(QString("hanim_r_carpal_interphalangeal_1"));
SoHAnimJoint542->X3DNode::setName(QString("r_carpal_interphalangeal_1"));
SoHAnimJoint542->setCenter(new float[]{-7.832,27.85,1.735});
SoHAnimSegment* SoHAnimSegment543 = new SoHAnimSegment();
SoHAnimSegment543->setDEF(QString("hanim_r_carpal_distal_phalanx_1"));
SoHAnimSegment543->X3DNode::setName(QString("r_carpal_distal_phalanx_1"));
SoTransform* SoTransform544 = new SoTransform();
SoTransform544->setTranslation(new float[]{-7.832,27.85,1.735});
...
SoImageTexture548->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate550->setPoint(new float[]{0.4723,0.6394,0.469,0.6388,0.4716,0.6383,0.4749,0.6389,0.4747,0.6409,0.4703,0.6408,0.4773,0.6404,0.4767,0.6395,0.4734,0.6389,0.469,0.6389,0.4664,0.6394,0.467,0.6402,0.4744,0.647,0.4694,0.6469,0.4774,0.6463,0.4768,0.6454,0.4729,0.6447,0.4679,0.6446,0.4649,0.6452,0.4655,0.6461,0.4734,0.6485,0.4696,0.6485,0.4758,0.6481,0.4753,0.6473,0.4722,0.6468,0.4684,0.6467,0.4661,0.6472,0.4666,0.6479,0.4709,0.648}, 58);
SoIndexedFaceSet549->setTexCoord(*SoTextureCoordinate550);

SoCoordinate* SoCoordinate551 = new SoCoordinate();
SoCoordinate551->setPoint(new float[]{0.5817,-0.8003,0.0727,0.4584,-0.8658,-0.106,0.4372,-0.8552,0.2109,0.314,-0.9207,0.0322,0.6359,-0.6464,-0.0377,0.62,-0.6384,0.2,0.4756,-0.6933,0.3382,0.2748,-0.7836,0.3078,0.1516,-0.8492,0.1291,0.1675,-0.8572,-0.1085,0.3119,-0.8023,-0.2467,0.5127,-0.712,-0.2163,0.374,-0.0036,-0.0838,0.3562,0.0054,0.1827,0.1843,-0.0599,0.3471,-0.0408,-0.1612,0.313,-0.1875,-0.2392,0.1004,-0.1697,-0.2482,-0.1661,0.0022,-0.1829,-0.3305,0.2274,-0.0816,-0.2964,0.2142,0.1671,-0.0744,0.2005,0.174,0.1306,0.0683,0.1238,0.257,-0.1048,0.0459,0.2308,-0.2176,-0.0141,0.0673,-0.2039,-0.021,-0.1376,-0.0717,0.0292,-0.264,0.1014,0.1072,-0.2378,-0.0214,0.1175,-0.006}, 87);
...
SoHAnimJoint552->setDEF(QString("hanim_r_carpometacarpal_2"));
SoHAnimJoint552->X3DNode::setName(QString("r_carpometacarpal_2"));
SoHAnimJoint552->setCenter(new float[]{-8.376,28.55,0.5997});
SoHAnimSegment* SoHAnimSegment553 = new SoHAnimSegment();
SoHAnimSegment553->setDEF(QString("hanim_r_metacarpal_2"));
SoHAnimSegment553->X3DNode::setName(QString("r_metacarpal_2"));
SoTransform* SoTransform554 = new SoTransform();
SoTransform554->setTranslation(new float[]{-8.376,28.55,0.5997});
...
SoImageTexture558->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate560->setPoint(new float[]{0.453,0.6387,0.4487,0.6387,0.4487,0.6388,0.453,0.6389,0.4561,0.6405,0.453,0.6403,0.4561,0.6406,0.4528,0.6407,0.4485,0.6406,0.4453,0.6405,0.4454,0.6403,0.4487,0.6402,0.4563,0.6497,0.4527,0.6495,0.4562,0.6499,0.4525,0.65,0.4474,0.6499,0.4439,0.6497,0.4439,0.6495,0.4476,0.6494,0.4567,0.6512,0.4528,0.651,0.4566,0.6514,0.4526,0.6515,0.4471,0.6514,0.4432,0.6512,0.4433,0.651,0.4473,0.6509,0.4546,0.6527,0.4519,0.6525,0.4546,0.6528,0.4518,0.6529,0.4478,0.6528,0.4451,0.6527,0.4452,0.6525,0.448,0.6524,0.4498,0.6533}, 74);
...
SoHAnimJoint562->setDEF(QString("hanim_r_metacarpophalangeal_2"));
SoHAnimJoint562->X3DNode::setName(QString("r_metacarpophalangeal_2"));
SoHAnimJoint562->setCenter(new float[]{-8.52,27.24,0.6551});
SoHAnimSegment* SoHAnimSegment563 = new SoHAnimSegment();
SoHAnimSegment563->setDEF(QString("hanim_r_carpal_proximal_phalanx_2"));
SoHAnimSegment563->X3DNode::setName(QString("r_carpal_proximal_phalanx_2"));
SoTransform* SoTransform564 = new SoTransform();
SoTransform564->setTranslation(new float[]{-8.52,27.24,0.6551});
...
SoImageTexture568->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate570->setPoint(new float[]{0.454,0.6279,0.4498,0.6279,0.4498,0.6277,0.454,0.6277,0.4571,0.6295,0.4539,0.6296,0.4571,0.6293,0.4539,0.6291,0.4496,0.6291,0.4464,0.6292,0.4465,0.6294,0.4497,0.6295,0.4573,0.6381,0.4537,0.6382,0.4572,0.6379,0.4536,0.6377,0.4486,0.6376,0.445,0.6377,0.445,0.6379,0.4486,0.6381,0.4578,0.6395,0.4538,0.6396,0.4577,0.6392,0.4538,0.639,0.4482,0.6389,0.4443,0.639,0.4444,0.6393,0.4483,0.6395,0.4557,0.6408,0.4529,0.6408,0.4557,0.6406,0.4529,0.6404,0.449,0.6404,0.4462,0.6404,0.4462,0.6406,0.449,0.6408,0.4509,0.6412}, 74);
SoIndexedFaceSet569->setTexCoord(*SoTextureCoordinate570);

SoCoordinate* SoCoordinate571 = new SoCoordinate();
SoCoordinate571->setPoint(new float[]{0.2499,-1.331,0.1644,0.2541,-1.339,-0.0655,0.0349,-1.351,0.1633,0.0391,-1.359,-0.0666,0.3958,-1.152,0.159,0.2314,-1.162,0.3307,0.0165,-1.182,0.3296,-0.1416,-1.203,0.1563,-0.1374,-1.21,-0.0736,0.0269,-1.201,-0.2453,0.2419,-1.181,-0.2442,0.4,-1.16,-0.0709,0.3504,-0.2375,0.1465,0.166,-0.2482,0.3391,-0.0897,-0.2722,0.3377,-0.267,-0.2955,0.1434,-0.2621,-0.3044,-0.1302,-0.0777,-0.2937,-0.3227,0.1781,-0.2697,-0.3214,0.3554,-0.2464,-0.127,0.3661,-0.0905,0.1542,0.1642,-0.1021,0.365,-0.1159,-0.1284,0.3636,-0.3101,-0.1539,0.1508,-0.3046,-0.1637,-0.1488,-0.1027,-0.152,-0.3596,0.1774,-0.1258,-0.3581,0.3715,-0.1003,-0.1453,0.2544,0.0426,0.1044,0.1117,0.0344,0.2535,-0.0864,0.0158,0.2525,-0.2237,-0.0022,0.102,-0.2198,-0.0091,-0.1098,-0.077,-0.0009,-0.2589,0.121,0.0177,-0.2579,0.2583,0.0357,-0.1074,0.0117,0.0763,-0.005}, 111);
...
SoHAnimJoint572->setDEF(QString("hanim_r_carpal_proximal_interphalangeal_2"));
SoHAnimJoint572->X3DNode::setName(QString("r_carpal_proximal_interphalangeal_2"));
SoHAnimJoint572->setCenter(new float[]{-8.45,26.1,0.6956});
SoHAnimSegment* SoHAnimSegment573 = new SoHAnimSegment();
SoHAnimSegment573->setDEF(QString("hanim_r_carpal_middle_phalanx_2"));
SoHAnimSegment573->X3DNode::setName(QString("r_carpal_middle_phalanx_2"));
SoTransform* SoTransform574 = new SoTransform();
SoTransform574->setTranslation(new float[]{-8.45,26.1,0.6956});
...
SoImageTexture578->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate580->setPoint(new float[]{0.4546,0.6191,0.4506,0.619,0.4506,0.6185,0.4546,0.6186,0.4575,0.6206,0.4545,0.6209,0.4576,0.6201,0.4545,0.6196,0.4505,0.6196,0.4474,0.6199,0.4474,0.6204,0.4505,0.6209,0.4572,0.6286,0.4541,0.6289,0.4572,0.628,0.4541,0.6276,0.4497,0.6275,0.4466,0.6279,0.4465,0.6284,0.4497,0.6289,0.4558,0.631,0.4534,0.6313,0.4558,0.6306,0.4534,0.6302,0.45,0.6302,0.4475,0.6305,0.4475,0.6309,0.45,0.6312,0.4516,0.6313}, 58);
SoIndexedFaceSet579->setTexCoord(*SoTextureCoordinate580);

SoCoordinate* SoCoordinate581 = new SoCoordinate();
SoCoordinate581->setPoint(new float[]{0.4479,-1.125,0.1554,0.4519,-1.132,-0.0632,0.2499,-1.18,0.1557,0.2539,-1.187,-0.0629,0.5544,-0.9319,0.1491,0.4029,-0.9674,0.3134,0.2049,-1.022,0.3137,0.0594,-1.068,0.1499,0.0634,-1.075,-0.0687,0.2149,-1.04,-0.2329,0.4129,-0.9852,-0.2333,0.5584,-0.939,-0.0695,0.3333,-0.0803,0.1251,0.1781,-0.1166,0.2933,-0.037,-0.1758,0.2937,-0.186,-0.2231,0.1259,-0.1817,-0.2308,-0.1116,-0.0265,-0.1945,-0.2799,0.1886,-0.1353,-0.2802,0.3376,-0.088,-0.1125,0.2019,0.1709,0.088,0.0815,0.1427,0.2185,-0.0854,0.0967,0.2188,-0.2011,0.06,0.0887,-0.1977,0.054,-0.0957,-0.0773,0.0822,-0.2262,0.0896,0.1281,-0.2265,0.2053,0.1648,-0.0963,-0.0132,0.1679,-0.006}, 87);
...
SoHAnimJoint582->setDEF(QString("hanim_r_carpal_distal_interphalangeal_2"));
SoHAnimJoint582->X3DNode::setName(QString("r_carpal_distal_interphalangeal_2"));
SoHAnimJoint582->setCenter(new float[]{-8.192,25.17,0.7315});
SoHAnimSegment* SoHAnimSegment583 = new SoHAnimSegment();
SoHAnimSegment583->setDEF(QString("hanim_r_carpal_distal_phalanx_2"));
SoHAnimSegment583->X3DNode::setName(QString("r_carpal_distal_phalanx_2"));
SoTransform* SoTransform584 = new SoTransform();
SoTransform584->setTranslation(new float[]{-8.192,25.17,0.7315});
...
SoImageTexture588->setUSE(QString("JinLOA2TextureAtlas"));
...
SoCoordinate591->setPoint(new float[]{0.6187,-1.071,0.1411,0.6221,-1.077,-0.0485,0.4578,-1.147,0.1426,0.4613,-1.153,-0.047,0.6714,-0.8704,0.1341,0.5482,-0.923,0.2774,0.3873,-0.9993,0.2789,0.2693,-1.061,0.1378,0.2727,-1.067,-0.0518,0.396,-1.015,-0.1951,0.5568,-0.9385,-0.1966,0.6749,-0.8765,-0.0555,0.3236,-0.0612,0.1191,0.1854,-0.1202,0.2799,-0.006,-0.211,0.2816,-0.1384,-0.2805,0.1233,-0.1343,-0.2879,-0.1023,0.004,-0.2288,-0.263,0.1953,-0.138,-0.2647,0.3277,-0.0685,-0.1065,0.2135,0.0836,0.0963,0.0945,0.035,0.233,-0.0723,-0.0325,0.2317,-0.1865,-0.0807,0.0968,-0.1843,-0.0816,-0.0912,-0.0691,-0.0336,-0.2249,0.0937,0.0356,-0.2277,0.2116,0.0844,-0.0958,-0.0314,0.0875,-0.0035}, 87);
...
SoHAnimJoint562->addChildren(*SoHAnimJoint572);

SoHAnimJoint552->addChildren(*SoHAnimJoint562);

SoHAnimJoint512->addChildren(*SoHAnimJoint552);

SoHAnimJoint* SoHAnimJoint592 = new SoHAnimJoint();
SoHAnimJoint592->setDEF(QString("hanim_r_carpometacarpal_3"));
SoHAnimJoint592->X3DNode::setName(QString("r_carpometacarpal_3"));
SoHAnimJoint592->setCenter(new float[]{-8.344,28.65,-0.194});
SoHAnimSegment* SoHAnimSegment593 = new SoHAnimSegment();
SoHAnimSegment593->setDEF(QString("hanim_r_metacarpal_3"));
SoHAnimSegment593->X3DNode::setName(QString("r_metacarpal_3"));
SoTransform* SoTransform594 = new SoTransform();
SoTransform594->setTranslation(new float[]{-8.344,28.65,-0.194});
...
SoImageTexture598->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate600->setPoint(new float[]{0.4371,0.6382,0.4328,0.6382,0.4329,0.6384,0.4372,0.6384,0.4403,0.64,0.4369,0.6398,0.4405,0.6401,0.4374,0.6403,0.4331,0.6403,0.4298,0.6402,0.4296,0.64,0.4326,0.6398,0.4413,0.6498,0.4375,0.6497,0.4415,0.65,0.438,0.6502,0.4329,0.6502,0.4291,0.6501,0.4289,0.6499,0.4324,0.6497,0.4418,0.6514,0.4377,0.6512,0.442,0.6516,0.4383,0.6518,0.4327,0.6518,0.4286,0.6517,0.4284,0.6514,0.4321,0.6512,0.4399,0.653,0.437,0.6529,0.4401,0.6531,0.4374,0.6533,0.4335,0.6533,0.4306,0.6532,0.4304,0.653,0.4331,0.6529,0.4352,0.6537}, 74);
SoIndexedFaceSet599->setTexCoord(*SoTextureCoordinate600);

SoCoordinate* SoCoordinate601 = new SoCoordinate();
SoCoordinate601->setPoint(new float[]{-0.0157,-1.601,0.0972,-0.0217,-1.599,-0.1348,-0.2598,-1.581,0.1076,-0.2658,-1.578,-0.1245,0.183,-1.427,0.091,0.0045,-1.414,0.2728,-0.2395,-1.393,0.2832,-0.4271,-1.376,0.1169,-0.4331,-1.374,-0.1151,-0.2546,-1.387,-0.2969,-0.0105,-1.408,-0.3073,0.177,-1.425,-0.1411,0.3164,-0.3793,0.1197,0.1161,-0.3643,0.3236,-0.1742,-0.3403,0.3359,-0.3846,-0.3213,0.1495,-0.3918,-0.3185,-0.1266,-0.1915,-0.3335,-0.3306,0.0988,-0.3575,-0.3429,0.3092,-0.3765,-0.1564,0.3602,-0.2157,0.1315,0.143,-0.1995,0.3527,-0.172,-0.1734,0.3661,-0.4003,-0.1528,0.1638,-0.408,-0.1498,-0.1357,-0.1908,-0.166,-0.357,0.1242,-0.1921,-0.3703,0.3524,-0.2126,-0.168,0.2615,-0.0399,0.0937,0.1079,-0.0284,0.2501,-0.1148,-0.01,0.2596,-0.2762,0.0046,0.1165,-0.2817,0.0068,-0.0952,-0.1281,-0.0047,-0.2517,0.0946,-0.0232,-0.2611,0.256,-0.0377,-0.1181,-0.0044,0.0523,-0.0002}, 111);
...
SoHAnimJoint602->setDEF(QString("hanim_r_metacarpophalangeal_3"));
SoHAnimJoint602->X3DNode::setName(QString("r_metacarpophalangeal_3"));
SoHAnimJoint602->setCenter(new float[]{-8.52,27.26,-0.1959});
SoHAnimSegment* SoHAnimSegment603 = new SoHAnimSegment();
SoHAnimSegment603->setDEF(QString("hanim_r_carpal_proximal_phalanx_3"));
SoHAnimSegment603->X3DNode::setName(QString("r_carpal_proximal_phalanx_3"));
SoTransform* SoTransform604 = new SoTransform();
SoTransform604->setTranslation(new float[]{-8.52,27.26,-0.1959});
...
SoImageTexture608->setUSE(QString("JinLOA2TextureAtlas"));
...
SoCoordinate611->setPoint(new float[]{0.2259,-1.448,0.0923,0.2194,-1.446,-0.1376,0.0106,-1.469,0.1016,0.0041,-1.467,-0.1283,0.3742,-1.258,0.088,0.2177,-1.275,0.2673,0.0024,-1.296,0.2766,-0.1639,-1.31,0.1112,-0.1704,-1.307,-0.1187,-0.0138,-1.29,-0.2981,0.2014,-1.269,-0.3073,0.3677,-1.255,-0.1419,0.3422,-0.2825,0.1227,0.1666,-0.302,0.3239,-0.0895,-0.3267,0.3349,-0.2761,-0.3422,0.1493,-0.2838,-0.3394,-0.1242,-0.1082,-0.3199,-0.3253,0.1479,-0.2952,-0.3364,0.3345,-0.2797,-0.1508,0.3605,-0.1263,0.1367,0.1681,-0.1476,0.357,-0.1123,-0.1747,0.3691,-0.3166,-0.1917,0.1659,-0.3251,-0.1886,-0.1336,-0.1327,-0.1672,-0.3539,0.1477,-0.1401,-0.366,0.352,-0.1232,-0.1627,0.2486,0.0181,0.0994,0.1126,0.003,0.2552,-0.0857,-0.0161,0.2638,-0.2302,-0.0281,0.1201,-0.2362,-0.0259,-0.0917,-0.1002,-0.0108,-0.2475,0.0981,0.0083,-0.256,0.2426,0.0203,-0.1123,0.0014,0.0597,0.0048}, 111);
...
SoHAnimJoint612->setDEF(QString("hanim_r_carpal_proximal_interphalangeal_3"));
SoHAnimJoint612->X3DNode::setName(QString("r_carpal_proximal_interphalangeal_3"));
SoHAnimJoint612->setCenter(new float[]{-8.477,26.07,-0.2214});
SoHAnimSegment* SoHAnimSegment613 = new SoHAnimSegment();
SoHAnimSegment613->setDEF(QString("hanim_r_carpal_middle_phalanx_3"));
SoHAnimSegment613->X3DNode::setName(QString("r_carpal_middle_phalanx_3"));
SoTransform* SoTransform614 = new SoTransform();
SoTransform614->setTranslation(new float[]{-8.477,26.07,-0.2214});
...
SoImageTexture618->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate620->setPoint(new float[]{0.4364,0.617,0.4323,0.6171,0.4325,0.6165,0.4365,0.6165,0.4395,0.6186,0.4363,0.619,0.4397,0.618,0.4367,0.6176,0.4327,0.6176,0.4295,0.6181,0.4294,0.6186,0.4323,0.619,0.4401,0.6271,0.4369,0.6275,0.4403,0.6265,0.4373,0.6261,0.4329,0.6261,0.4297,0.6266,0.4295,0.6271,0.4325,0.6275,0.4391,0.6297,0.4366,0.6301,0.4392,0.6293,0.4369,0.629,0.4335,0.629,0.431,0.6293,0.4308,0.6298,0.4331,0.6301,0.435,0.6301}, 58);
SoIndexedFaceSet619->setTexCoord(*SoTextureCoordinate620);

SoCoordinate* SoCoordinate621 = new SoCoordinate();
SoCoordinate621->setPoint(new float[]{0.4389,-1.268,0.089,0.4327,-1.265,-0.1296,0.2401,-1.325,0.0971,0.234,-1.323,-0.1215,0.5481,-1.062,0.0865,0.4036,-1.106,0.2566,0.2049,-1.164,0.2647,0.0512,-1.205,0.1068,0.045,-1.203,-0.1118,0.1894,-1.158,-0.2818,0.3882,-1.101,-0.2899,0.5419,-1.059,-0.132,0.3388,-0.1526,0.1159,0.1909,-0.1984,0.2901,-0.025,-0.2608,0.2989,-0.1825,-0.3032,0.1372,-0.1892,-0.3008,-0.1003,-0.0412,-0.2549,-0.2744,0.1747,-0.1925,-0.2833,0.3321,-0.1501,-0.1216,0.2096,0.117,0.0982,0.0948,0.0814,0.2333,-0.0727,0.033,0.2402,-0.1949,0.0001,0.1147,-0.2001,0.002,-0.0696,-0.0853,0.0376,-0.2048,0.0823,0.086,-0.2116,0.2044,0.1189,-0.0861,-0.0097,0.1188,0.0156}, 87);
...
SoHAnimJoint622->setDEF(QString("hanim_r_carpal_distal_interphalangeal_3"));
SoHAnimJoint622->X3DNode::setName(QString("r_carpal_distal_interphalangeal_3"));
SoHAnimJoint622->setCenter(new float[]{-8.25,25.03,-0.2187});
SoHAnimSegment* SoHAnimSegment623 = new SoHAnimSegment();
SoHAnimSegment623->setDEF(QString("hanim_r_carpal_distal_phalanx_3"));
SoHAnimSegment623->X3DNode::setName(QString("r_carpal_distal_phalanx_3"));
SoTransform* SoTransform624 = new SoTransform();
SoTransform624->setTranslation(new float[]{-8.25,25.03,-0.2187});
...
SoImageTexture628->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate630->setPoint(new float[]{0.4356,0.6082,0.4321,0.6082,0.4322,0.6074,0.4357,0.6074,0.4383,0.6096,0.4356,0.6102,0.4384,0.6088,0.4359,0.6083,0.4324,0.6083,0.4296,0.6089,0.4295,0.6096,0.4321,0.6102,0.4394,0.6176,0.4364,0.6183,0.4396,0.6167,0.4367,0.6161,0.4325,0.6161,0.4295,0.6168,0.4293,0.6177,0.4322,0.6183,0.4388,0.6192,0.4362,0.6198,0.4389,0.6186,0.4364,0.6181,0.433,0.6182,0.4304,0.6187,0.4303,0.6194,0.4326,0.6199,0.4346,0.6199}, 58);
SoIndexedFaceSet629->setTexCoord(*SoTextureCoordinate630);

SoCoordinate* SoCoordinate631 = new SoCoordinate();
SoCoordinate631->setPoint(new float[]{0.631,-1.169,0.0421,0.6256,-1.167,-0.1475,0.4691,-1.25,0.0483,0.4637,-1.248,-0.1413,0.6864,-0.9557,0.0421,0.569,-1.018,0.1889,0.4071,-1.099,0.1951,0.2817,-1.158,0.0576,0.2763,-1.156,-0.1319,0.3937,-1.094,-0.2788,0.5556,-1.013,-0.285,0.681,-0.9537,-0.1474,0.3504,-0.0919,0.0851,0.2187,-0.1616,0.2498,0.026,-0.2579,0.2572,-0.1147,-0.3243,0.1029,-0.121,-0.322,-0.1226,0.0106,-0.2523,-0.2873,0.2033,-0.156,-0.2946,0.344,-0.0896,-0.1404,0.2414,0.0637,0.0753,0.128,0.0061,0.2155,-0.0399,-0.0652,0.2197,-0.161,-0.1101,0.0888,-0.1675,-0.1027,-0.0988,-0.0577,-0.0458,-0.2359,0.106,0.0275,-0.2439,0.2307,0.0733,-0.1162,-0.0079,0.0731,-0.0112}, 87);
...
SoHAnimJoint602->addChildren(*SoHAnimJoint612);

SoHAnimJoint592->addChildren(*SoHAnimJoint602);

SoHAnimJoint512->addChildren(*SoHAnimJoint592);

SoHAnimJoint* SoHAnimJoint632 = new SoHAnimJoint();
SoHAnimJoint632->setDEF(QString("hanim_r_carpometacarpal_4"));
SoHAnimJoint632->X3DNode::setName(QString("r_carpometacarpal_4"));
SoHAnimJoint632->setCenter(new float[]{-8.339,28.57,-0.9243});
SoHAnimSegment* SoHAnimSegment633 = new SoHAnimSegment();
SoHAnimSegment633->setDEF(QString("hanim_r_metacarpal_4"));
SoHAnimSegment633->X3DNode::setName(QString("r_metacarpal_4"));
SoTransform* SoTransform634 = new SoTransform();
SoTransform634->setTranslation(new float[]{-8.339,28.57,-0.9243});
...
SoImageTexture638->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate640->setPoint(new float[]{0.4223,0.6397,0.4182,0.6398,0.4179,0.64,0.422,0.6399,0.4255,0.6412,0.4227,0.6412,0.4252,0.6414,0.422,0.6417,0.418,0.6418,0.4151,0.6417,0.4154,0.6415,0.4187,0.6413,0.4275,0.6502,0.4244,0.6501,0.4272,0.6504,0.4235,0.6507,0.4187,0.6508,0.4156,0.6508,0.4159,0.6505,0.4196,0.6503,0.4282,0.6516,0.4248,0.6515,0.4279,0.6519,0.4239,0.6522,0.4187,0.6523,0.4153,0.6522,0.4156,0.652,0.4196,0.6517,0.4265,0.6531,0.4241,0.6531,0.4263,0.6533,0.4235,0.6535,0.4198,0.6536,0.4174,0.6536,0.4176,0.6534,0.4204,0.6532,0.422,0.6539}, 74);
...
SoHAnimJoint642->setDEF(QString("hanim_r_metacarpophalangeal_4"));
SoHAnimJoint642->X3DNode::setName(QString("r_metacarpophalangeal_4"));
SoHAnimJoint642->setCenter(new float[]{-8.428,27.3,-0.9985});
SoHAnimSegment* SoHAnimSegment643 = new SoHAnimSegment();
SoHAnimSegment643->setDEF(QString("hanim_r_carpal_proximal_phalanx_4"));
SoHAnimSegment643->X3DNode::setName(QString("r_carpal_proximal_phalanx_4"));
SoTransform* SoTransform644 = new SoTransform();
SoTransform644->setTranslation(new float[]{-8.428,27.3,-0.9985});
...
SoImageTexture648->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate650->setPoint(new float[]{0.4212,0.6288,0.4172,0.6289,0.4169,0.6288,0.4209,0.6287,0.4244,0.6302,0.4216,0.6304,0.4241,0.6301,0.4209,0.63,0.4169,0.6301,0.4141,0.6304,0.4144,0.6305,0.4176,0.6306,0.4261,0.6386,0.423,0.6388,0.4258,0.6384,0.4222,0.6383,0.4174,0.6385,0.4143,0.6387,0.4146,0.6389,0.4182,0.6389,0.4268,0.6399,0.4234,0.6401,0.4265,0.6397,0.4225,0.6396,0.4173,0.6398,0.4139,0.64,0.4142,0.6402,0.4182,0.6403,0.4251,0.6412,0.4226,0.6414,0.4248,0.6411,0.422,0.641,0.4183,0.6411,0.4159,0.6413,0.4162,0.6415,0.419,0.6415,0.4206,0.6418}, 74);
SoIndexedFaceSet649->setTexCoord(*SoTextureCoordinate650);

SoCoordinate* SoCoordinate651 = new SoCoordinate();
SoCoordinate651->setPoint(new float[]{0.1847,-1.253,0.0467,0.1998,-1.241,-0.1693,-0.0227,-1.271,0.0316,-0.0076,-1.259,-0.1844,0.3279,-1.08,0.0673,0.161,-1.102,0.2179,-0.0464,-1.12,0.2028,-0.1906,-1.124,0.0295,-0.1754,-1.112,-0.1865,-0.0085,-1.09,-0.3372,0.1989,-1.072,-0.3221,0.3431,-1.068,-0.1487,0.2967,-0.1902,0.1418,0.1095,-0.215,0.3108,-0.1373,-0.2358,0.2929,-0.299,-0.2404,0.0984,-0.281,-0.2262,-0.1586,-0.0938,-0.2014,-0.3276,0.153,-0.1807,-0.3096,0.3147,-0.176,-0.1151,0.3133,-0.0482,0.1642,0.1083,-0.0753,0.3493,-0.1619,-0.0981,0.3296,-0.339,-0.1032,0.1167,-0.3192,-0.0876,-0.1647,-0.1142,-0.0605,-0.3498,0.156,-0.0377,-0.3301,0.3331,-0.0327,-0.1172,0.2099,0.0863,0.1241,0.0649,0.0671,0.255,-0.1261,0.051,0.2411,-0.2514,0.0474,0.0905,-0.2374,0.0585,-0.1085,-0.0924,0.0776,-0.2393,0.0986,0.0937,-0.2254,0.2239,0.0973,-0.0749,-0.0182,0.1305,0.0112}, 111);
...
SoHAnimJoint652->setDEF(QString("hanim_r_carpal_proximal_interphalangeal_4"));
SoHAnimJoint652->X3DNode::setName(QString("r_carpal_proximal_interphalangeal_4"));
SoHAnimJoint652->setCenter(new float[]{-8.428,26.29,-1.034});
SoHAnimSegment* SoHAnimSegment653 = new SoHAnimSegment();
SoHAnimSegment653->setDEF(QString("hanim_r_carpal_middle_phalanx_4"));
SoHAnimSegment653->X3DNode::setName(QString("r_carpal_middle_phalanx_4"));
SoTransform* SoTransform654 = new SoTransform();
SoTransform654->setTranslation(new float[]{-8.428,26.29,-1.034});
...
SoImageTexture658->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate660->setPoint(new float[]{0.4203,0.6204,0.4166,0.6205,0.4163,0.62,0.42,0.6199,0.4232,0.6217,0.4207,0.6221,0.4229,0.6212,0.4199,0.6209,0.4162,0.621,0.4136,0.6215,0.4139,0.622,0.4169,0.6222,0.4242,0.6295,0.4215,0.6299,0.4239,0.629,0.4208,0.6287,0.4167,0.6288,0.4141,0.6293,0.4144,0.6298,0.4175,0.6301,0.4233,0.6319,0.4212,0.6323,0.423,0.6315,0.4206,0.6313,0.4175,0.6314,0.4154,0.6317,0.4157,0.6321,0.4181,0.6324,0.4194,0.6323}, 58);
SoIndexedFaceSet659->setTexCoord(*SoTextureCoordinate660);

SoCoordinate* SoCoordinate661 = new SoCoordinate();
SoCoordinate661->setPoint(new float[]{0.412,-1.137,0.0335,0.4261,-1.125,-0.1679,0.2243,-1.187,0.0176,0.2385,-1.176,-0.1838,0.5153,-0.9493,0.0522,0.3639,-0.9958,0.1913,0.1762,-1.047,0.1754,0.0461,-1.076,0.0125,0.0602,-1.065,-0.1888,0.2116,-1.019,-0.3279,0.3992,-0.9679,-0.312,0.5294,-0.9381,-0.1491,0.3178,-0.1177,0.1,0.1627,-0.1653,0.2425,-0.0412,-0.2206,0.2252,-0.1745,-0.2511,0.0583,-0.1591,-0.239,-0.1604,-0.0041,-0.1914,-0.3029,0.1998,-0.1361,-0.2856,0.3331,-0.1056,-0.1188,0.1985,0.1307,0.0829,0.0782,0.0937,0.1934,-0.08,0.0508,0.18,-0.1835,0.0271,0.0505,-0.1716,0.0365,-0.1192,-0.0513,0.0735,-0.2298,0.1069,0.1164,-0.2164,0.2104,0.1401,-0.0869,-0.0002,0.1379,-0.0157}, 87);
...
SoHAnimJoint662->setDEF(QString("hanim_r_carpal_distal_interphalangeal_4"));
SoHAnimJoint662->X3DNode::setName(QString("r_carpal_distal_interphalangeal_4"));
SoHAnimJoint662->setCenter(new float[]{-8.192,25.31,-1.124});
SoHAnimSegment* SoHAnimSegment663 = new SoHAnimSegment();
SoHAnimSegment663->setDEF(QString("hanim_r_carpal_distal_phalanx_4"));
SoHAnimSegment663->X3DNode::setName(QString("r_carpal_distal_phalanx_4"));
SoTransform* SoTransform664 = new SoTransform();
SoTransform664->setTranslation(new float[]{-8.192,25.31,-1.124});
...
SoImageTexture668->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate670->setPoint(new float[]{0.4195,0.6124,0.4163,0.6125,0.416,0.6118,0.4193,0.6117,0.422,0.6137,0.4198,0.6143,0.4218,0.613,0.4191,0.6126,0.4159,0.6126,0.4137,0.6132,0.414,0.6139,0.4166,0.6143,0.4231,0.621,0.4207,0.6217,0.4228,0.6202,0.4199,0.6197,0.416,0.6198,0.4135,0.6205,0.4139,0.6213,0.4168,0.6218,0.4225,0.6225,0.4204,0.623,0.4222,0.6219,0.4197,0.6216,0.4165,0.6217,0.4145,0.6223,0.4147,0.6229,0.4172,0.6232,0.4185,0.6232}, 58);
SoIndexedFaceSet669->setTexCoord(*SoTextureCoordinate670);

SoCoordinate* SoCoordinate671 = new SoCoordinate();
SoCoordinate671->setPoint(new float[]{0.5436,-1.006,0.082,0.5559,-0.9964,-0.0922,0.3911,-1.079,0.0671,0.4033,-1.069,-0.1071,0.596,-0.8116,0.0978,0.4725,-0.8732,0.2172,0.3199,-0.9458,0.2024,0.2147,-0.9931,0.0605,0.2269,-0.9834,-0.1137,0.3505,-0.9218,-0.2332,0.503,-0.8491,-0.2183,0.6083,-0.8019,-0.0765,0.2786,-0.0205,0.1427,0.14,-0.0896,0.2768,-0.0415,-0.176,0.2591,-0.1596,-0.229,0.1,-0.1451,-0.2175,-0.1073,-0.0064,-0.1484,-0.2413,0.1751,-0.062,-0.2236,0.2931,-0.009,-0.0645,0.1776,0.1232,0.1297,0.0583,0.0659,0.2438,-0.0996,0.0023,0.2269,-0.2013,-0.0322,0.0923,-0.1903,-0.0176,-0.08,-0.0748,0.0389,-0.1916,0.0796,0.1047,-0.1786,0.185,0.14,-0.0465,-0.0484,0.1379,0.025}, 87);
...
SoHAnimJoint642->addChildren(*SoHAnimJoint652);

SoHAnimJoint632->addChildren(*SoHAnimJoint642);

SoHAnimJoint512->addChildren(*SoHAnimJoint632);

SoHAnimJoint* SoHAnimJoint672 = new SoHAnimJoint();
SoHAnimJoint672->setDEF(QString("hanim_r_carpometacarpal_5"));
SoHAnimJoint672->X3DNode::setName(QString("r_carpometacarpal_5"));
SoHAnimJoint672->setCenter(new float[]{-8.197,28.37,-1.528});
SoHAnimSegment* SoHAnimSegment673 = new SoHAnimSegment();
SoHAnimSegment673->setDEF(QString("hanim_r_metacarpal_5"));
SoHAnimSegment673->X3DNode::setName(QString("r_metacarpal_5"));
SoTransform* SoTransform674 = new SoTransform();
SoTransform674->setTranslation(new float[]{-8.197,28.37,-1.528});
...
SoImageTexture678->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate680->setPoint(new float[]{0.4094,0.6427,0.4058,0.6429,0.4055,0.6432,0.4091,0.643,0.4124,0.6437,0.41,0.6437,0.412,0.644,0.4092,0.6444,0.4056,0.6446,0.4032,0.6445,0.4035,0.6443,0.4064,0.6439,0.4149,0.6501,0.4122,0.65,0.4146,0.6504,0.4113,0.6509,0.4071,0.6511,0.4044,0.651,0.4048,0.6507,0.408,0.6502,0.4157,0.651,0.4127,0.651,0.4153,0.6514,0.4118,0.6519,0.4072,0.6522,0.4043,0.6521,0.4047,0.6517,0.4082,0.6512,0.4143,0.6522,0.4122,0.6522,0.414,0.6525,0.4115,0.6528,0.4083,0.653,0.4062,0.6529,0.4065,0.6527,0.409,0.6523,0.4104,0.653}, 74);
SoIndexedFaceSet679->setTexCoord(*SoTextureCoordinate680);

SoCoordinate* SoCoordinate681 = new SoCoordinate();
SoCoordinate681->setPoint(new float[]{-0.0463,-0.9645,-0.0622,-0.0267,-0.942,-0.253,-0.2519,-0.9328,-0.0794,-0.2324,-0.9103,-0.2702,0.1254,-0.8655,-0.031,-0.0435,-0.8586,0.0992,-0.2492,-0.8269,0.082,-0.3888,-0.7862,-0.074,-0.3693,-0.7638,-0.2648,-0.2004,-0.7707,-0.395,0.0053,-0.8024,-0.3779,0.1449,-0.843,-0.2218,0.2585,-0.1911,0.0918,0.069,-0.1834,0.2379,-0.1757,-0.1456,0.2175,-0.3323,-0.1,0.0425,-0.309,-0.0733,-0.1846,-0.1196,-0.0811,-0.3307,0.1251,-0.1188,-0.3102,0.2817,-0.1644,-0.1352,0.2978,-0.0883,0.1196,0.0923,-0.0799,0.2781,-0.1732,-0.0389,0.2559,-0.343,0.0105,0.066,-0.3178,0.0395,-0.1803,-0.1123,0.0311,-0.3387,0.1532,-0.0098,-0.3166,0.3231,-0.0593,-0.1267,0.223,0.0382,0.0917,0.0776,0.0442,0.2038,-0.1101,0.0732,0.1881,-0.2302,0.1081,0.0539,-0.2124,0.1286,-0.1203,-0.0671,0.1227,-0.2324,0.1207,0.0937,-0.2167,0.2408,0.0588,-0.0824,0.0116,0.1281,-0.0076}, 111);
...
SoHAnimJoint682->setDEF(QString("hanim_r_metacarpophalangeal_5"));
SoHAnimJoint682->X3DNode::setName(QString("r_metacarpophalangeal_5"));
SoHAnimJoint682->setCenter(new float[]{-8.334,27.5,-1.701});
SoHAnimSegment* SoHAnimSegment683 = new SoHAnimSegment();
SoHAnimSegment683->setDEF(QString("hanim_r_carpal_proximal_phalanx_5"));
SoHAnimSegment683->X3DNode::setName(QString("r_carpal_proximal_phalanx_5"));
SoTransform* SoTransform684 = new SoTransform();
SoTransform684->setTranslation(new float[]{-8.334,27.5,-1.701});
...
SoImageTexture688->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate690->setPoint(new float[]{0.4075,0.6349,0.404,0.6351,0.4037,0.6351,0.4072,0.6349,0.4104,0.6358,0.4081,0.6359,0.4101,0.6358,0.4072,0.636,0.4037,0.6362,0.4013,0.6363,0.4017,0.6363,0.4046,0.6362,0.4127,0.6418,0.41,0.6419,0.4123,0.6418,0.409,0.642,0.4048,0.6423,0.4022,0.6424,0.4026,0.6424,0.4058,0.6422,0.4134,0.6427,0.4105,0.6429,0.413,0.6427,0.4094,0.6429,0.4048,0.6432,0.4019,0.6434,0.4024,0.6434,0.4059,0.6432,0.412,0.6438,0.4099,0.6439,0.4116,0.6438,0.4091,0.6439,0.4059,0.6441,0.4038,0.6442,0.4042,0.6442,0.4067,0.6441,0.408,0.6444}, 74);
...
SoHAnimJoint692->setDEF(QString("hanim_r_carpal_proximal_interphalangeal_5"));
SoHAnimJoint692->X3DNode::setName(QString("r_carpal_proximal_interphalangeal_5"));
SoHAnimJoint692->setCenter(new float[]{-8.338,26.78,-1.768});
SoHAnimSegment* SoHAnimSegment693 = new SoHAnimSegment();
SoHAnimSegment693->setDEF(QString("hanim_r_carpal_middle_phalanx_5"));
SoHAnimSegment693->X3DNode::setName(QString("r_carpal_middle_phalanx_5"));
SoTransform* SoTransform694 = new SoTransform();
SoTransform694->setTranslation(new float[]{-8.338,26.78,-1.768});
...
SoImageTexture698->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate700->setPoint(new float[]{0.4061,0.6287,0.4028,0.6289,0.4025,0.6286,0.4057,0.6284,0.4088,0.6296,0.4066,0.6299,0.4084,0.6293,0.4057,0.6293,0.4024,0.6295,0.4002,0.6298,0.4006,0.63,0.4033,0.6301,0.4102,0.6353,0.408,0.6356,0.4098,0.635,0.407,0.635,0.4035,0.6352,0.4012,0.6355,0.4016,0.6358,0.4044,0.6358,0.4096,0.6371,0.4079,0.6374,0.4093,0.6369,0.4071,0.6369,0.4043,0.6371,0.4026,0.6373,0.4029,0.6375,0.4051,0.6375,0.4062,0.6376}, 58);
SoIndexedFaceSet699->setTexCoord(*SoTextureCoordinate700);

SoCoordinate* SoCoordinate701 = new SoCoordinate();
SoCoordinate701->setPoint(new float[]{0.3103,-0.8684,0.0017,0.3279,-0.8476,-0.1746,0.1444,-0.8917,-0.0183,0.162,-0.8709,-0.1946,0.4057,-0.7413,0.0284,0.268,-0.7744,0.1456,0.1021,-0.7977,0.1256,-0.0092,-0.7996,-0.0215,0.0085,-0.7788,-0.1978,0.1461,-0.7457,-0.315,0.3121,-0.7224,-0.295,0.4234,-0.7205,-0.1478,0.2537,-0.1316,0.1027,0.1126,-0.1655,0.2227,-0.0677,-0.1909,0.201,-0.1817,-0.1928,0.0502,-0.1625,-0.1702,-0.1412,-0.0215,-0.1363,-0.2613,0.1588,-0.1109,-0.2396,0.2728,-0.109,-0.0888,0.156,0.0566,0.096,0.0465,0.0303,0.1892,-0.0934,0.0106,0.1723,-0.1818,0.0091,0.0553,-0.1669,0.0266,-0.0933,-0.0575,0.0529,-0.1864,0.0824,0.0726,-0.1696,0.1709,0.0741,-0.0526,-0.016,0.0815,0.0057}, 87);
...
SoHAnimJoint702->setDEF(QString("hanim_r_carpal_distal_interphalangeal_5"));
SoHAnimJoint702->X3DNode::setName(QString("r_carpal_distal_interphalangeal_5"));
SoHAnimJoint702->setCenter(new float[]{-8.153,26.04,-1.886});
SoHAnimSegment* SoHAnimSegment703 = new SoHAnimSegment();
SoHAnimSegment703->setDEF(QString("hanim_r_carpal_distal_phalanx_5"));
SoHAnimSegment703->X3DNode::setName(QString("r_carpal_distal_phalanx_5"));
SoTransform* SoTransform704 = new SoTransform();
SoTransform704->setTranslation(new float[]{-8.153,26.04,-1.886});
...
SoImageTexture708->setUSE(QString("JinLOA2TextureAtlas"));
...
SoTextureCoordinate710->setPoint(new float[]{0.4049,0.6227,0.4021,0.6229,0.4017,0.6225,0.4045,0.6223,0.4072,0.6236,0.4053,0.624,0.4068,0.6232,0.4044,0.623,0.4016,0.6232,0.3997,0.6236,0.4001,0.624,0.4025,0.6242,0.4086,0.6291,0.4066,0.6295,0.4082,0.6286,0.4055,0.6284,0.4022,0.6286,0.4001,0.6291,0.4005,0.6296,0.4032,0.6297,0.4082,0.6302,0.4064,0.6306,0.4078,0.6299,0.4056,0.6298,0.4028,0.63,0.401,0.6304,0.4014,0.6307,0.4036,0.6308,0.4047,0.6309}, 58);
...
SoHAnimJoint682->addChildren(*SoHAnimJoint692);

SoHAnimJoint672->addChildren(*SoHAnimJoint682);

SoHAnimJoint512->addChildren(*SoHAnimJoint672);

SoHAnimJoint502->addChildren(*SoHAnimJoint512);

SoHAnimJoint492->addChildren(*SoHAnimJoint502);

SoHAnimJoint482->addChildren(*SoHAnimJoint492);

SoHAnimJoint472->addChildren(*SoHAnimJoint482);

SoHAnimJoint222->addChildren(*SoHAnimJoint472);

SoHAnimJoint* SoHAnimJoint712 = new SoHAnimJoint();
SoHAnimJoint712->setDEF(QString("hanim_vc4"));
SoHAnimJoint712->X3DNode::setName(QString("vc4"));
SoHAnimJoint712->setCenter(new float[]{0.0,54.42,-0.6695});
SoHAnimSegment* SoHAnimSegment713 = new SoHAnimSegment();
SoHAnimSegment713->setDEF(QString("hanim_c4"));
SoHAnimSegment713->X3DNode::setName(QString("c4"));
SoTransform* SoTransform714 = new SoTransform();
SoTransform714->setTranslation(new float[]{0.0,54.42,-0.6695});
...
SoImageTexture718->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint722->setDEF(QString("hanim_vc2"));
SoHAnimJoint722->X3DNode::setName(QString("vc2"));
SoHAnimJoint722->setCenter(new float[]{0.0,56.02,-0.6695});
SoHAnimSegment* SoHAnimSegment723 = new SoHAnimSegment();
SoHAnimSegment723->setDEF(QString("hanim_c2"));
SoHAnimSegment723->X3DNode::setName(QString("c2"));
SoTransform* SoTransform724 = new SoTransform();
SoTransform724->setTranslation(new float[]{0.0,56.02,-0.6695});
...
SoImageTexture728->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint732->setDEF(QString("hanim_skullbase"));
SoHAnimJoint732->X3DNode::setName(QString("skullbase"));
SoHAnimJoint732->setCenter(new float[]{0.0,57.43,-0.6863});
SoHAnimSegment* SoHAnimSegment733 = new SoHAnimSegment();
SoHAnimSegment733->setDEF(QString("hanim_skull"));
SoHAnimSegment733->X3DNode::setName(QString("skull"));
SoTransform* SoTransform734 = new SoTransform();
SoTransform734->setTranslation(new float[]{0.0,57.43,-0.6863});
...
SoImageTexture738->setUSE(QString("JinLOA2TextureAtlas"));
...
SoHAnimJoint722->addChildren(*SoHAnimJoint732);

SoHAnimJoint712->addChildren(*SoHAnimJoint722);

SoHAnimJoint222->addChildren(*SoHAnimJoint712);
...
SoHAnimJoint742->setUSE(QString("hanim_humanoid_root"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint742);

SoHAnimJoint* SoHAnimJoint743 = new SoHAnimJoint();
SoHAnimJoint743->setUSE(QString("hanim_sacroiliac"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint743);

SoHAnimJoint* SoHAnimJoint744 = new SoHAnimJoint();
SoHAnimJoint744->setUSE(QString("hanim_vl5"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint744);

SoHAnimJoint* SoHAnimJoint745 = new SoHAnimJoint();
SoHAnimJoint745->setUSE(QString("hanim_vl3"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint745);

SoHAnimJoint* SoHAnimJoint746 = new SoHAnimJoint();
SoHAnimJoint746->setUSE(QString("hanim_vl1"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint746);

SoHAnimJoint* SoHAnimJoint747 = new SoHAnimJoint();
SoHAnimJoint747->setUSE(QString("hanim_vt10"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint747);

SoHAnimJoint* SoHAnimJoint748 = new SoHAnimJoint();
SoHAnimJoint748->setUSE(QString("hanim_vt6"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint748);

SoHAnimJoint* SoHAnimJoint749 = new SoHAnimJoint();
SoHAnimJoint749->setUSE(QString("hanim_vt1"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint749);

SoHAnimJoint* SoHAnimJoint750 = new SoHAnimJoint();
SoHAnimJoint750->setUSE(QString("hanim_vc4"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint750);

SoHAnimJoint* SoHAnimJoint751 = new SoHAnimJoint();
SoHAnimJoint751->setUSE(QString("hanim_vc2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint751);

SoHAnimJoint* SoHAnimJoint752 = new SoHAnimJoint();
SoHAnimJoint752->setUSE(QString("hanim_skullbase"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint752);

SoHAnimJoint* SoHAnimJoint753 = new SoHAnimJoint();
SoHAnimJoint753->setUSE(QString("hanim_l_acromioclavicular"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint753);

SoHAnimJoint* SoHAnimJoint754 = new SoHAnimJoint();
SoHAnimJoint754->setUSE(QString("hanim_r_acromioclavicular"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint754);

SoHAnimJoint* SoHAnimJoint755 = new SoHAnimJoint();
SoHAnimJoint755->setUSE(QString("hanim_l_carpal_distal_interphalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint755);

SoHAnimJoint* SoHAnimJoint756 = new SoHAnimJoint();
SoHAnimJoint756->setUSE(QString("hanim_r_carpal_distal_interphalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint756);

SoHAnimJoint* SoHAnimJoint757 = new SoHAnimJoint();
SoHAnimJoint757->setUSE(QString("hanim_l_carpal_distal_interphalangeal_3"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint757);

SoHAnimJoint* SoHAnimJoint758 = new SoHAnimJoint();
SoHAnimJoint758->setUSE(QString("hanim_r_carpal_distal_interphalangeal_3"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint758);

SoHAnimJoint* SoHAnimJoint759 = new SoHAnimJoint();
SoHAnimJoint759->setUSE(QString("hanim_l_carpal_distal_interphalangeal_4"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint759);

SoHAnimJoint* SoHAnimJoint760 = new SoHAnimJoint();
SoHAnimJoint760->setUSE(QString("hanim_r_carpal_distal_interphalangeal_4"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint760);

SoHAnimJoint* SoHAnimJoint761 = new SoHAnimJoint();
SoHAnimJoint761->setUSE(QString("hanim_l_carpal_distal_interphalangeal_5"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint761);

SoHAnimJoint* SoHAnimJoint762 = new SoHAnimJoint();
SoHAnimJoint762->setUSE(QString("hanim_r_carpal_distal_interphalangeal_5"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint762);

SoHAnimJoint* SoHAnimJoint763 = new SoHAnimJoint();
SoHAnimJoint763->setUSE(QString("hanim_l_carpal_interphalangeal_1"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint763);

SoHAnimJoint* SoHAnimJoint764 = new SoHAnimJoint();
SoHAnimJoint764->setUSE(QString("hanim_r_carpal_interphalangeal_1"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint764);

SoHAnimJoint* SoHAnimJoint765 = new SoHAnimJoint();
SoHAnimJoint765->setUSE(QString("hanim_l_carpal_proximal_interphalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint765);

SoHAnimJoint* SoHAnimJoint766 = new SoHAnimJoint();
SoHAnimJoint766->setUSE(QString("hanim_r_carpal_proximal_interphalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint766);

SoHAnimJoint* SoHAnimJoint767 = new SoHAnimJoint();
SoHAnimJoint767->setUSE(QString("hanim_l_carpal_proximal_interphalangeal_3"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint767);

SoHAnimJoint* SoHAnimJoint768 = new SoHAnimJoint();
SoHAnimJoint768->setUSE(QString("hanim_r_carpal_proximal_interphalangeal_3"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint768);

SoHAnimJoint* SoHAnimJoint769 = new SoHAnimJoint();
SoHAnimJoint769->setUSE(QString("hanim_l_carpal_proximal_interphalangeal_4"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint769);

SoHAnimJoint* SoHAnimJoint770 = new SoHAnimJoint();
SoHAnimJoint770->setUSE(QString("hanim_r_carpal_proximal_interphalangeal_4"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint770);

SoHAnimJoint* SoHAnimJoint771 = new SoHAnimJoint();
SoHAnimJoint771->setUSE(QString("hanim_l_carpal_proximal_interphalangeal_5"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint771);

SoHAnimJoint* SoHAnimJoint772 = new SoHAnimJoint();
SoHAnimJoint772->setUSE(QString("hanim_r_carpal_proximal_interphalangeal_5"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint772);

SoHAnimJoint* SoHAnimJoint773 = new SoHAnimJoint();
SoHAnimJoint773->setUSE(QString("hanim_l_carpometacarpal_1"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint773);

SoHAnimJoint* SoHAnimJoint774 = new SoHAnimJoint();
SoHAnimJoint774->setUSE(QString("hanim_r_carpometacarpal_1"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint774);

SoHAnimJoint* SoHAnimJoint775 = new SoHAnimJoint();
SoHAnimJoint775->setUSE(QString("hanim_l_carpometacarpal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint775);

SoHAnimJoint* SoHAnimJoint776 = new SoHAnimJoint();
SoHAnimJoint776->setUSE(QString("hanim_r_carpometacarpal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint776);

SoHAnimJoint* SoHAnimJoint777 = new SoHAnimJoint();
SoHAnimJoint777->setUSE(QString("hanim_l_carpometacarpal_3"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint777);

SoHAnimJoint* SoHAnimJoint778 = new SoHAnimJoint();
SoHAnimJoint778->setUSE(QString("hanim_r_carpometacarpal_3"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint778);

SoHAnimJoint* SoHAnimJoint779 = new SoHAnimJoint();
SoHAnimJoint779->setUSE(QString("hanim_l_carpometacarpal_4"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint779);

SoHAnimJoint* SoHAnimJoint780 = new SoHAnimJoint();
SoHAnimJoint780->setUSE(QString("hanim_r_carpometacarpal_4"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint780);

SoHAnimJoint* SoHAnimJoint781 = new SoHAnimJoint();
SoHAnimJoint781->setUSE(QString("hanim_l_carpometacarpal_5"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint781);

SoHAnimJoint* SoHAnimJoint782 = new SoHAnimJoint();
SoHAnimJoint782->setUSE(QString("hanim_r_carpometacarpal_5"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint782);

SoHAnimJoint* SoHAnimJoint783 = new SoHAnimJoint();
SoHAnimJoint783->setUSE(QString("hanim_l_elbow"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint783);

SoHAnimJoint* SoHAnimJoint784 = new SoHAnimJoint();
SoHAnimJoint784->setUSE(QString("hanim_r_elbow"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint784);

SoHAnimJoint* SoHAnimJoint785 = new SoHAnimJoint();
SoHAnimJoint785->setUSE(QString("hanim_l_hip"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint785);

SoHAnimJoint* SoHAnimJoint786 = new SoHAnimJoint();
SoHAnimJoint786->setUSE(QString("hanim_r_hip"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint786);

SoHAnimJoint* SoHAnimJoint787 = new SoHAnimJoint();
SoHAnimJoint787->setUSE(QString("hanim_l_knee"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint787);

SoHAnimJoint* SoHAnimJoint788 = new SoHAnimJoint();
SoHAnimJoint788->setUSE(QString("hanim_r_knee"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint788);

SoHAnimJoint* SoHAnimJoint789 = new SoHAnimJoint();
SoHAnimJoint789->setUSE(QString("hanim_l_metacarpophalangeal_1"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint789);

SoHAnimJoint* SoHAnimJoint790 = new SoHAnimJoint();
SoHAnimJoint790->setUSE(QString("hanim_r_metacarpophalangeal_1"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint790);

SoHAnimJoint* SoHAnimJoint791 = new SoHAnimJoint();
SoHAnimJoint791->setUSE(QString("hanim_l_metacarpophalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint791);

SoHAnimJoint* SoHAnimJoint792 = new SoHAnimJoint();
SoHAnimJoint792->setUSE(QString("hanim_r_metacarpophalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint792);

SoHAnimJoint* SoHAnimJoint793 = new SoHAnimJoint();
SoHAnimJoint793->setUSE(QString("hanim_l_metacarpophalangeal_3"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint793);

SoHAnimJoint* SoHAnimJoint794 = new SoHAnimJoint();
SoHAnimJoint794->setUSE(QString("hanim_r_metacarpophalangeal_3"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint794);

SoHAnimJoint* SoHAnimJoint795 = new SoHAnimJoint();
SoHAnimJoint795->setUSE(QString("hanim_l_metacarpophalangeal_4"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint795);

SoHAnimJoint* SoHAnimJoint796 = new SoHAnimJoint();
SoHAnimJoint796->setUSE(QString("hanim_r_metacarpophalangeal_4"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint796);

SoHAnimJoint* SoHAnimJoint797 = new SoHAnimJoint();
SoHAnimJoint797->setUSE(QString("hanim_l_metacarpophalangeal_5"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint797);

SoHAnimJoint* SoHAnimJoint798 = new SoHAnimJoint();
SoHAnimJoint798->setUSE(QString("hanim_r_metacarpophalangeal_5"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint798);

SoHAnimJoint* SoHAnimJoint799 = new SoHAnimJoint();
SoHAnimJoint799->setUSE(QString("hanim_l_metatarsophalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint799);

SoHAnimJoint* SoHAnimJoint800 = new SoHAnimJoint();
SoHAnimJoint800->setUSE(QString("hanim_r_metatarsophalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint800);

SoHAnimJoint* SoHAnimJoint801 = new SoHAnimJoint();
SoHAnimJoint801->setUSE(QString("hanim_l_radiocarpal"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint801);

SoHAnimJoint* SoHAnimJoint802 = new SoHAnimJoint();
SoHAnimJoint802->setUSE(QString("hanim_r_radiocarpal"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint802);

SoHAnimJoint* SoHAnimJoint803 = new SoHAnimJoint();
SoHAnimJoint803->setUSE(QString("hanim_l_shoulder"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint803);

SoHAnimJoint* SoHAnimJoint804 = new SoHAnimJoint();
SoHAnimJoint804->setUSE(QString("hanim_r_shoulder"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint804);

SoHAnimJoint* SoHAnimJoint805 = new SoHAnimJoint();
SoHAnimJoint805->setUSE(QString("hanim_l_sternoclavicular"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint805);

SoHAnimJoint* SoHAnimJoint806 = new SoHAnimJoint();
SoHAnimJoint806->setUSE(QString("hanim_r_sternoclavicular"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint806);

SoHAnimJoint* SoHAnimJoint807 = new SoHAnimJoint();
SoHAnimJoint807->setUSE(QString("hanim_l_talocrural"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint807);

SoHAnimJoint* SoHAnimJoint808 = new SoHAnimJoint();
SoHAnimJoint808->setUSE(QString("hanim_r_talocrural"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint808);

SoHAnimJoint* SoHAnimJoint809 = new SoHAnimJoint();
SoHAnimJoint809->setUSE(QString("hanim_l_tarsal_distal_interphalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint809);

SoHAnimJoint* SoHAnimJoint810 = new SoHAnimJoint();
SoHAnimJoint810->setUSE(QString("hanim_r_tarsal_distal_interphalangeal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint810);

SoHAnimJoint* SoHAnimJoint811 = new SoHAnimJoint();
SoHAnimJoint811->setUSE(QString("hanim_l_tarsometatarsal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint811);

SoHAnimJoint* SoHAnimJoint812 = new SoHAnimJoint();
SoHAnimJoint812->setUSE(QString("hanim_r_tarsometatarsal_2"));
SoHAnimHumanoid24->setJoints(*SoHAnimJoint812);

SoHAnimSegment* SoHAnimSegment813 = new SoHAnimSegment();
SoHAnimSegment813->setUSE(QString("hanim_sacrum"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment813);

SoHAnimSegment* SoHAnimSegment814 = new SoHAnimSegment();
SoHAnimSegment814->setUSE(QString("hanim_pelvis"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment814);

SoHAnimSegment* SoHAnimSegment815 = new SoHAnimSegment();
SoHAnimSegment815->setUSE(QString("hanim_l5"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment815);

SoHAnimSegment* SoHAnimSegment816 = new SoHAnimSegment();
SoHAnimSegment816->setUSE(QString("hanim_l3"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment816);

SoHAnimSegment* SoHAnimSegment817 = new SoHAnimSegment();
SoHAnimSegment817->setUSE(QString("hanim_l1"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment817);

SoHAnimSegment* SoHAnimSegment818 = new SoHAnimSegment();
SoHAnimSegment818->setUSE(QString("hanim_t10"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment818);

SoHAnimSegment* SoHAnimSegment819 = new SoHAnimSegment();
SoHAnimSegment819->setUSE(QString("hanim_t6"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment819);

SoHAnimSegment* SoHAnimSegment820 = new SoHAnimSegment();
SoHAnimSegment820->setUSE(QString("hanim_t1"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment820);

SoHAnimSegment* SoHAnimSegment821 = new SoHAnimSegment();
SoHAnimSegment821->setUSE(QString("hanim_c4"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment821);

SoHAnimSegment* SoHAnimSegment822 = new SoHAnimSegment();
SoHAnimSegment822->setUSE(QString("hanim_c2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment822);

SoHAnimSegment* SoHAnimSegment823 = new SoHAnimSegment();
SoHAnimSegment823->setUSE(QString("hanim_skull"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment823);

SoHAnimSegment* SoHAnimSegment824 = new SoHAnimSegment();
SoHAnimSegment824->setUSE(QString("hanim_l_calf"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment824);

SoHAnimSegment* SoHAnimSegment825 = new SoHAnimSegment();
SoHAnimSegment825->setUSE(QString("hanim_r_calf"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment825);

SoHAnimSegment* SoHAnimSegment826 = new SoHAnimSegment();
SoHAnimSegment826->setUSE(QString("hanim_l_carpal"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment826);

SoHAnimSegment* SoHAnimSegment827 = new SoHAnimSegment();
SoHAnimSegment827->setUSE(QString("hanim_r_carpal"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment827);

SoHAnimSegment* SoHAnimSegment828 = new SoHAnimSegment();
SoHAnimSegment828->setUSE(QString("hanim_l_carpal_distal_phalanx_1"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment828);

SoHAnimSegment* SoHAnimSegment829 = new SoHAnimSegment();
SoHAnimSegment829->setUSE(QString("hanim_r_carpal_distal_phalanx_1"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment829);

SoHAnimSegment* SoHAnimSegment830 = new SoHAnimSegment();
SoHAnimSegment830->setUSE(QString("hanim_l_carpal_distal_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment830);

SoHAnimSegment* SoHAnimSegment831 = new SoHAnimSegment();
SoHAnimSegment831->setUSE(QString("hanim_r_carpal_distal_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment831);

SoHAnimSegment* SoHAnimSegment832 = new SoHAnimSegment();
SoHAnimSegment832->setUSE(QString("hanim_l_carpal_distal_phalanx_3"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment832);

SoHAnimSegment* SoHAnimSegment833 = new SoHAnimSegment();
SoHAnimSegment833->setUSE(QString("hanim_r_carpal_distal_phalanx_3"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment833);

SoHAnimSegment* SoHAnimSegment834 = new SoHAnimSegment();
SoHAnimSegment834->setUSE(QString("hanim_l_carpal_distal_phalanx_4"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment834);

SoHAnimSegment* SoHAnimSegment835 = new SoHAnimSegment();
SoHAnimSegment835->setUSE(QString("hanim_r_carpal_distal_phalanx_4"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment835);

SoHAnimSegment* SoHAnimSegment836 = new SoHAnimSegment();
SoHAnimSegment836->setUSE(QString("hanim_l_carpal_distal_phalanx_5"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment836);

SoHAnimSegment* SoHAnimSegment837 = new SoHAnimSegment();
SoHAnimSegment837->setUSE(QString("hanim_r_carpal_distal_phalanx_5"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment837);

SoHAnimSegment* SoHAnimSegment838 = new SoHAnimSegment();
SoHAnimSegment838->setUSE(QString("hanim_l_carpal_middle_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment838);

SoHAnimSegment* SoHAnimSegment839 = new SoHAnimSegment();
SoHAnimSegment839->setUSE(QString("hanim_r_carpal_middle_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment839);

SoHAnimSegment* SoHAnimSegment840 = new SoHAnimSegment();
SoHAnimSegment840->setUSE(QString("hanim_l_carpal_middle_phalanx_3"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment840);

SoHAnimSegment* SoHAnimSegment841 = new SoHAnimSegment();
SoHAnimSegment841->setUSE(QString("hanim_r_carpal_middle_phalanx_3"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment841);

SoHAnimSegment* SoHAnimSegment842 = new SoHAnimSegment();
SoHAnimSegment842->setUSE(QString("hanim_l_carpal_middle_phalanx_4"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment842);

SoHAnimSegment* SoHAnimSegment843 = new SoHAnimSegment();
SoHAnimSegment843->setUSE(QString("hanim_r_carpal_middle_phalanx_4"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment843);

SoHAnimSegment* SoHAnimSegment844 = new SoHAnimSegment();
SoHAnimSegment844->setUSE(QString("hanim_l_carpal_middle_phalanx_5"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment844);

SoHAnimSegment* SoHAnimSegment845 = new SoHAnimSegment();
SoHAnimSegment845->setUSE(QString("hanim_r_carpal_middle_phalanx_5"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment845);

SoHAnimSegment* SoHAnimSegment846 = new SoHAnimSegment();
SoHAnimSegment846->setUSE(QString("hanim_l_carpal_proximal_phalanx_1"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment846);

SoHAnimSegment* SoHAnimSegment847 = new SoHAnimSegment();
SoHAnimSegment847->setUSE(QString("hanim_r_carpal_proximal_phalanx_1"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment847);

SoHAnimSegment* SoHAnimSegment848 = new SoHAnimSegment();
SoHAnimSegment848->setUSE(QString("hanim_l_carpal_proximal_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment848);

SoHAnimSegment* SoHAnimSegment849 = new SoHAnimSegment();
SoHAnimSegment849->setUSE(QString("hanim_r_carpal_proximal_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment849);

SoHAnimSegment* SoHAnimSegment850 = new SoHAnimSegment();
SoHAnimSegment850->setUSE(QString("hanim_l_carpal_proximal_phalanx_3"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment850);

SoHAnimSegment* SoHAnimSegment851 = new SoHAnimSegment();
SoHAnimSegment851->setUSE(QString("hanim_r_carpal_proximal_phalanx_3"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment851);

SoHAnimSegment* SoHAnimSegment852 = new SoHAnimSegment();
SoHAnimSegment852->setUSE(QString("hanim_l_carpal_proximal_phalanx_4"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment852);

SoHAnimSegment* SoHAnimSegment853 = new SoHAnimSegment();
SoHAnimSegment853->setUSE(QString("hanim_r_carpal_proximal_phalanx_4"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment853);

SoHAnimSegment* SoHAnimSegment854 = new SoHAnimSegment();
SoHAnimSegment854->setUSE(QString("hanim_l_carpal_proximal_phalanx_5"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment854);

SoHAnimSegment* SoHAnimSegment855 = new SoHAnimSegment();
SoHAnimSegment855->setUSE(QString("hanim_r_carpal_proximal_phalanx_5"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment855);

SoHAnimSegment* SoHAnimSegment856 = new SoHAnimSegment();
SoHAnimSegment856->setUSE(QString("hanim_l_clavicle"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment856);

SoHAnimSegment* SoHAnimSegment857 = new SoHAnimSegment();
SoHAnimSegment857->setUSE(QString("hanim_r_clavicle"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment857);

SoHAnimSegment* SoHAnimSegment858 = new SoHAnimSegment();
SoHAnimSegment858->setUSE(QString("hanim_l_forearm"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment858);

SoHAnimSegment* SoHAnimSegment859 = new SoHAnimSegment();
SoHAnimSegment859->setUSE(QString("hanim_r_forearm"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment859);

SoHAnimSegment* SoHAnimSegment860 = new SoHAnimSegment();
SoHAnimSegment860->setUSE(QString("hanim_l_metacarpal_1"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment860);

SoHAnimSegment* SoHAnimSegment861 = new SoHAnimSegment();
SoHAnimSegment861->setUSE(QString("hanim_r_metacarpal_1"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment861);

SoHAnimSegment* SoHAnimSegment862 = new SoHAnimSegment();
SoHAnimSegment862->setUSE(QString("hanim_l_metacarpal_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment862);

SoHAnimSegment* SoHAnimSegment863 = new SoHAnimSegment();
SoHAnimSegment863->setUSE(QString("hanim_r_metacarpal_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment863);

SoHAnimSegment* SoHAnimSegment864 = new SoHAnimSegment();
SoHAnimSegment864->setUSE(QString("hanim_l_metacarpal_3"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment864);

SoHAnimSegment* SoHAnimSegment865 = new SoHAnimSegment();
SoHAnimSegment865->setUSE(QString("hanim_r_metacarpal_3"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment865);

SoHAnimSegment* SoHAnimSegment866 = new SoHAnimSegment();
SoHAnimSegment866->setUSE(QString("hanim_l_metacarpal_4"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment866);

SoHAnimSegment* SoHAnimSegment867 = new SoHAnimSegment();
SoHAnimSegment867->setUSE(QString("hanim_r_metacarpal_4"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment867);

SoHAnimSegment* SoHAnimSegment868 = new SoHAnimSegment();
SoHAnimSegment868->setUSE(QString("hanim_l_metacarpal_5"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment868);

SoHAnimSegment* SoHAnimSegment869 = new SoHAnimSegment();
SoHAnimSegment869->setUSE(QString("hanim_r_metacarpal_5"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment869);

SoHAnimSegment* SoHAnimSegment870 = new SoHAnimSegment();
SoHAnimSegment870->setUSE(QString("hanim_r_metatarsal_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment870);

SoHAnimSegment* SoHAnimSegment871 = new SoHAnimSegment();
SoHAnimSegment871->setUSE(QString("hanim_l_metatarsal_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment871);

SoHAnimSegment* SoHAnimSegment872 = new SoHAnimSegment();
SoHAnimSegment872->setUSE(QString("hanim_l_scapula"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment872);

SoHAnimSegment* SoHAnimSegment873 = new SoHAnimSegment();
SoHAnimSegment873->setUSE(QString("hanim_r_scapula"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment873);

SoHAnimSegment* SoHAnimSegment874 = new SoHAnimSegment();
SoHAnimSegment874->setUSE(QString("hanim_l_talus"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment874);

SoHAnimSegment* SoHAnimSegment875 = new SoHAnimSegment();
SoHAnimSegment875->setUSE(QString("hanim_r_talus"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment875);

SoHAnimSegment* SoHAnimSegment876 = new SoHAnimSegment();
SoHAnimSegment876->setUSE(QString("hanim_l_tarsal_distal_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment876);

SoHAnimSegment* SoHAnimSegment877 = new SoHAnimSegment();
SoHAnimSegment877->setUSE(QString("hanim_r_tarsal_distal_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment877);

SoHAnimSegment* SoHAnimSegment878 = new SoHAnimSegment();
SoHAnimSegment878->setUSE(QString("hanim_l_tarsal_proximal_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment878);

SoHAnimSegment* SoHAnimSegment879 = new SoHAnimSegment();
SoHAnimSegment879->setUSE(QString("hanim_r_tarsal_proximal_phalanx_2"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment879);

SoHAnimSegment* SoHAnimSegment880 = new SoHAnimSegment();
SoHAnimSegment880->setUSE(QString("hanim_l_thigh"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment880);

SoHAnimSegment* SoHAnimSegment881 = new SoHAnimSegment();
SoHAnimSegment881->setUSE(QString("hanim_r_thigh"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment881);

SoHAnimSegment* SoHAnimSegment882 = new SoHAnimSegment();
SoHAnimSegment882->setUSE(QString("hanim_l_upperarm"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment882);

SoHAnimSegment* SoHAnimSegment883 = new SoHAnimSegment();
SoHAnimSegment883->setUSE(QString("hanim_r_upperarm"));
SoHAnimHumanoid24->setSegments(*SoHAnimSegment883);

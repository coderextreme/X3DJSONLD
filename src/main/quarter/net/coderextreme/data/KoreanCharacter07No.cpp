...
Someta3->setContent(QString("KoreanCharacter07No.x3d"));
...
Someta10->setContent(QString("../Poses/images/HAnimPoseExampleKoreanCharacter07No.png"));
...
Someta14->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter07No.x3d"));
...
SoWorldInfo21->setTitle(QString("KoreanCharacter07No.x3d"));
...
SoViewpoint23->setDescription(QString("No"));
...
SoHAnimHumanoid24->X3DNode::setName(QString("No"));
SoHAnimHumanoid24->setDEF(QString("hanim_No"));
...
SoHAnimJoint32->setCenter(new float[]{0.0,34.790001,-1.299});
...
SoTransform34->setTranslation(new float[]{0.0,34.790001,-1.299});
...
SoImageTexture38->setDEF(QString("NoTextureAtlas"));
SoImageTexture38->setUrl(new QString[]{QString("images/No.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/No.png")}, 2);
...
SoTextureCoordinate41->setPoint(new float[]{0.8186,0.5634,0.8987,0.5617,0.8871,0.5617,0.8526,0.5606,0.8181,0.5606,0.816,0.5609,0.7815,0.5609,0.7188,0.5606,0.7815,0.5609,0.816,0.5609,0.8181,0.5606,0.8526,0.5606,0.8871,0.5617,0.9077,0.5435,0.8943,0.5435,0.8566,0.5187,0.819,0.4986,0.8158,0.4991,0.7835,0.5089,0.7188,0.5435,0.7835,0.5089,0.8158,0.4991,0.819,0.4986,0.8566,0.5187,0.8943,0.5435,0.9017,0.4799,0.8882,0.4799,0.8592,0.4741,0.8178,0.4732,0.8155,0.4732,0.7814,0.4765,0.7186,0.5235,0.7814,0.4765,0.8155,0.4732,0.8178,0.4732,0.8592,0.4741,0.8882,0.4799,0.9035,0.4666,0.8895,0.4666,0.8545,0.4604,0.8198,0.4629,0.8161,0.4629,0.7809,0.467,0.7185,0.5036,0.7809,0.467,0.8161,0.4629,0.8198,0.4629,0.8545,0.4604,0.8895,0.4666,0.9004,0.451,0.8882,0.451,0.8562,0.4537,0.8211,0.4537,0.8228,0.4535,0.7785,0.4535,0.7195,0.4721,0.7785,0.4535,0.8228,0.4535,0.8211,0.4537,0.8562,0.4537,0.8882,0.451,0.8199,0.4484}, 124);
...
SoHAnimJoint42->setCenter(new float[]{3.785,34.07,-1.57});
...
SoTransform44->setTranslation(new float[]{3.785,34.07,-1.57});
...
SoImageTexture48->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint52->setCenter(new float[]{3.838,18.4,-1.212});
...
SoTransform54->setTranslation(new float[]{3.838,18.4,-1.212});
...
SoImageTexture58->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint62->setCenter(new float[]{3.826,4.044,-1.361});
...
SoTransform64->setTranslation(new float[]{3.826,4.044,-1.361});
...
SoImageTexture68->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint72->setCenter(new float[]{3.826,3.118,-0.2867});
...
SoTransform74->setTranslation(new float[]{3.826,3.118,-0.2867});
...
SoImageTexture78->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint82->setCenter(new float[]{-3.785,34.07,-1.57});
...
SoTransform84->setTranslation(new float[]{-3.785,34.07,-1.57});
...
SoImageTexture88->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint92->setCenter(new float[]{-3.838,18.4,-1.212});
...
SoTransform94->setTranslation(new float[]{-3.838,18.4,-1.212});
...
SoImageTexture98->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint102->setCenter(new float[]{-3.826,4.044,-1.361});
...
SoTransform104->setTranslation(new float[]{-3.826,4.044,-1.361});
...
SoImageTexture108->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint112->setCenter(new float[]{-3.826,3.118,-0.2867});
...
SoTransform114->setTranslation(new float[]{-3.826,3.118,-0.2867});
...
SoImageTexture118->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint122->setCenter(new float[]{0.0,32.91,-1.57});
...
SoTransform124->setTranslation(new float[]{0.0,32.91,-1.57});
...
SoImageTexture128->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint132->setCenter(new float[]{7.266,54.049999,-1.79});
...
SoTransform134->setTranslation(new float[]{7.266,54.049999,-1.79});
...
SoImageTexture138->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint142->setCenter(new float[]{7.834,43.389999,-1.651});
...
SoTransform144->setTranslation(new float[]{7.834,43.389999,-1.651});
...
SoImageTexture148->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint152->setCenter(new float[]{7.738,35.43,-1.558});
...
SoTransform154->setTranslation(new float[]{7.738,35.43,-1.558});
...
SoImageTexture158->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint162->setCenter(new float[]{-7.266,54.049999,-1.79});
...
SoTransform164->setTranslation(new float[]{-7.266,54.049999,-1.79});
...
SoImageTexture168->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint172->setCenter(new float[]{-7.834,43.389999,-1.651});
...
SoTransform174->setTranslation(new float[]{-7.834,43.389999,-1.651});
...
SoImageTexture178->setUSE(QString("NoTextureAtlas"));
...
SoIndexedFaceSet179->setCoordIndex(new int32_t[]{0,4,11,-1,11,12,0,-1,12,11,5,-1,5,13,12,-1,13,5,8,-1,8,1,13,-1,1,8,9,-1,9,2,1,-1,2,9,10,-1,10,3,2,-1,3,10,6,-1,6,14,3,-1,15,7,4,-1,4,0,15,-1,14,6,7,-1,7,15,14,-1,4,16,23,-1,23,11,4,-1,11,23,17,-1,17,5,11,-1,5,17,20,-1,20,8,5,-1,10,22,18,-1,18,6,10,-1,7,19,16,-1,16,4,7,-1,8,20,21,-1,21,9,8,-1,9,21,22,-1,22,10,9,-1,6,18,19,-1,19,7,6,-1,16,24,23,-1,23,24,17,-1,17,24,20,-1,20,24,21,
-0.4165,-7.365,-0.4678,-0.6188,-0.6937,-0.9942,-1.126,-0.5903,0.0001,1.1,-0.8178,0.0254,0.5969,-0.8537,-1.073,0.0602,-7.92,-0.6297,-0.5422,-7.92,0.0623,0.6846,-7.92,0.0627,0.4317,-7.915,-0.4625,-0.3194,-7.915,0.6006,0.0602,-7.92,0.8486,0.4317,-7.915,0.6022,-0.3194,-7.915,-0.398,0.0602,-8.182,0.065,0.0299,-0.0952,-1.393,-0.7675,0.0555,0.847,0.0065,-0.0143,1.165,0.7382,-0.1075,0.8559,-0.7086,0.015,-1.16,-1.198,0.0615,-0.0132,1.198,-0.2053,-0.0002,0.6672,-0.1246,-1.202,-0.4447,0.8519,-0.9853,0.1246,0.7619,-1.165,0.5954,0.7485,-1.024,1.032,0.6748,-0.0338,0.6669,0.7576,0.6468,0.0988,0.8314,0.8871,-0.5047,0.8844,0.639,-0.8466,0.8853,-0.0438,0.1526,1.367,-0.1493}, 126);
SoIndexedFaceSet179->setCoord(*SoCoordinate180);

SoTextureCoordinate* SoTextureCoordinate181 = new SoTextureCoordinate();
SoTextureCoordinate181->setPoint(new float[]{0.0471,0.5348,0.0457,0.5477,0.0517,0.5187,0.0571,0.5017,0.0625,0.4884,0.0657,0.4747,0.0673,0.4552,0.0409,0.557,0.1806,0.5707,0.1797,0.5783,0.1804,0.5567,0.1838,0.5503,0.1875,0.5412,0.1933,0.5295,0.2007,0.5198,0.175,0.5862,0.19,0.5703,0.1907,0.5757,0.1892,0.5587,0.1918,0.5533,0.2114,0.539,0.2025,0.5422,0.1895,0.5821,0.1949,0.5468,0.2041,0.5636,0.0292,0.5765,0.1758,0.5987,0.1959,0.5888,0.0457,0.5477,0.0571,0.5017,0.0625,0.4884,0.0657,0.4747,0.0471,0.5348,0.0517,0.5187,0.0292,0.5765,0.0673,0.4552,0.0409,0.557,0.0471,0.5348,0.0457,0.5477,0.0409,0.557,0.0292,0.5765,0.0657,0.4747,0.0625,0.4884,0.0571,0.5017,0.0517,0.5187,0.05,0.5249}, 92);
...
SoHAnimJoint182->setCenter(new float[]{-7.738,35.43,-1.558});
...
SoTransform184->setTranslation(new float[]{-7.738,35.43,-1.558});
...
SoImageTexture188->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint192->setCenter(new float[]{0.0,37.060001,-1.409});
...
SoTransform194->setTranslation(new float[]{0.0,37.060001,-1.409});
...
SoImageTexture198->setUSE(QString("NoTextureAtlas"));
...
SoHAnimJoint202->setCenter(new float[]{0.0,37.060001,-1.409});
...
SoTransform204->setTranslation(new float[]{0.0,37.060001,-1.409});
...
SoImageTexture208->setUSE(QString("NoTextureAtlas"));
...
SoEXPORT230->setAS(QString("KoreanCharacter07No"));
SoEXPORT230->setLocalDEF(QString("hanim_No"));

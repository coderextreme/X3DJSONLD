...
SoIORMaterialExtension72->setDEF("IOR_2");
SoIORMaterialExtension72->setIndexOfRefraction(1.5);
SoPhysicalMaterial71->addExtensions(SoIORMaterialExtension72);
...
SoIridescenceMaterialExtension85->setDEF("IRI_3");
SoIridescenceMaterialExtension85->setIridescence(1);
SoIridescenceMaterialExtension85->setIridescenceIndexOfRefraction(1.3);
SoIridescenceMaterialExtension85->setIridescenceThicknessMinimum(100);
SoPhysicalMaterial84->addExtensions(SoIridescenceMaterialExtension85);

...
Someta2->setContent(QString("WinterAndSpringDedicationAllTitleBox.x3d"));
Sohead1->addMeta(*Someta2);

Someta* Someta3 = new Someta();
Someta3->setName(QString("description"));
Someta3->setContent(QString("Credits for scene dedications."));
...
Someta9->setContent(QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringDedicationAllTitleBox.x3d"));
...
SoWorldInfo11->setTitle(QString("WinterAndSpringDedicationAllTitleBox.x3d"));
SoNode10->addChild(*SoWorldInfo11);

SoViewpoint* SoViewpoint12 = new SoViewpoint();
SoViewpoint12->setDEF(QString("WSDedicationAllTitleView"));
SoViewpoint12->setDescription(QString("Look at Dedication title"));
...
SoTransform13->setDEF(QString("WSDedicationAllTitle"));
SoTransform13->setTranslation(new float[]{10.0,10.0,-10.0});
...
SoImageTexture17->setUrl(new QString[]{QString("images/WSDedicationAll.png"), QString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSDedicationAll.png")}, 2);

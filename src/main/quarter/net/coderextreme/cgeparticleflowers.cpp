...
SoComposedShader34->addChild(*Sofield37);
...
SoShaderPart47->setUrl(new QString[]{QString("https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs")}, 1);
...
//_T("				}")+
//_T("			}"));
SoTransform19->addChild(*SoScript48);
...
SoTransform19->addChild(*SoTimeSensor58);
...
SoTransform19->addChild(*SoROUTE59);

...
Someta10->setContent(QString("ballx3dom.x3d"));
...
Someta13->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/personal/ballx3dom.x3d"));
...
SoWorldInfo16->setTitle(QString("ballx3dom.x3d"));
...
SoShaderPart39->setUrl(new QString[]{QString("../shaders/x3dom.vs"), QString("https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom.vs")}, 2);
...
SoShaderPart40->setDEF(QString("common"));
SoShaderPart40->setUrl(new QString[]{QString("../shaders/common.fs"), QString("https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs")}, 2);

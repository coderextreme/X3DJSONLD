...
Someta2->setContent(QString("browser.x3d"));
...
Someta5->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/personal/browser.x3d"));
Sohead1->addMeta(*Someta5);

Someta* Someta6 = new Someta();
Someta6->setName(QString("description"));
Someta6->setContent(QString("a script test with embedded \\n between single quotes, a double backslash \\\\ a backslash \\ and a closing quote \""));
Sohead1->addMeta(*Someta6);

SoSceneManager0->setHead(*Sohead1);

SoNode* SoNode7 = new SoNode();
SoScript* SoScript8 = new SoScript();
SoScript8->setDEF(QString("Browser"));

//SoScript8->setSourceCode(QString("ecmascript:")+
//_T("                function initialize() {")+
//_T("		    Browser.print('DUDES\\n'+'\"DUDETTES');")+
//_T("                }"));
SoNode7->addChild(*SoScript8);

SoScript* SoScript9 = new SoScript();
SoScript9->setDEF(QString("Clouds"));

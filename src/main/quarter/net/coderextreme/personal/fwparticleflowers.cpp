...
SoComposedShader34->setDEF(QString("fw"));
...
SoShaderPart47->setUrl(new QString[]{QString("https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs")}, 1);
...
SoShaderPart48->setUrl(new QString[]{QString("https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs")}, 1);
...
//_T("				}")+
//_T("			}"));
SoTransform19->addChild(*SoScript49);
...
SoTransform19->addChild(*SoTimeSensor59);
...
SoROUTE64->setToNode(QString("fw"));
...
SoROUTE65->setToNode(QString("fw"));
...
SoROUTE66->setToNode(QString("fw"));
SoROUTE66->setToField(QString("tdelta"));
SoTransform19->addChild(*SoROUTE66);

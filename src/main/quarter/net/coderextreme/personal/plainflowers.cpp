...
Someta2->setContent(QString("plainflowers.x3d"));
...
Someta6->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/personal/plainflowers.x3d"));
...
SoExternProtoDeclare11->setUrl(new QString[]{QString("../personal/flowerproto.x3d#FlowerProto")}, 1);
...
SoField19->setValue(QString("\"../shaders/plain.fs\""));

...
Someta10->setContent(QString("variationalflowers2.x3d"));
...
Someta12->setContent(QString("A flower variational system"));
Sohead1->addMeta(*Someta12);

Someta* Someta13 = new Someta();
Someta13->setName(QString("identifier"));
Someta13->setContent(QString("https://coderextreme.net/X3DJSONLD/src/main/personal/variationalflowers2.x3d"));
...
SoWorldInfo15->setTitle(QString("variationalflowers2.x3d"));

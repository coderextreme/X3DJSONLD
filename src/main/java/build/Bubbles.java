 ...
 * <p> Bubble animation used by Nancy Diving example. </p>
 <p> Related links:  source Bubbles.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
        <caption>Scene Meta Information</caption>
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">Bubbles&nbsp; Document Metadata </td>
		</tr>
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform("Bubbles")
      .addChild(new Group("Bubble")
        ...
        .addChild(new PositionInterpolator("BubblePath1").setKey(new double[] {0.0,0.5,0.8,0.9,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,0.0,0.75,0.75,0.75,0.86,0.86,0.86,0.99,0.998,0.9876,1.272,1.90440,0.9509})))
        .addChild(new PositionInterpolator("BubblePath2").setKey(new double[] {0.0,0.3,0.64,0.85,1.0}).setKeyValue(new MFVec3f(new double[] {0.1,0.1,0.1,0.2,0.4,0.25,0.3,0.5,0.46,0.75,0.5,.575,.038483478,1.9890,1.0983730})))
        .addChild(new PositionInterpolator("BubblePath3").setKey(new double[] {0.0,0.1,0.45,0.7,1.0}).setKeyValue(new MFVec3f(new double[] {0.01,0.01,0.01,0.25,0.35,0.0045,0.55,0.6,0.0055,0.66,0.665,0.00655,1.5550,1.090430,0.0057340})))
        .addChild(new PositionInterpolator("BubblePath4").setKey(new double[] {0.0,0.5,0.6,0.8,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,0.0,0.5,0.5,0.005,0.6,0.6,0.006,0.75,0.75,0.0075,1.9485940,1.39830,.009009349})))
        .addChild(new PositionInterpolator("BubblePath5").setKey(new double[] {0.0,0.25,0.35,0.65,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,0.0,0.5,0.5,0.005,0.6,0.6,0.006,0.75,0.75,0.0075,1.844440,1.222220,0.1})))
        .addChild(new PositionInterpolator("BubblePath6").setKey(new double[] {0.0,0.15,0.22235,0.55565,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,0.0,0.235,0.3455,0.0055,0.356,0.676,0.00456,0.5675,0.75,0.0074565,1.098,1.0343,0.140})))
        .addChild(new PositionInterpolator("BubblePath7").setKey(new double[] {0.0,0.2425,0.4535,0.6775,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,0.0,0.12345,0.2225,0.00335,0.786,0.456,0.00666,0.74555,0.7335,0.00234575,.08787,1.022,0.12})))
        .addChild(new PositionInterpolator("BubblePath8").setKey(new double[] {0.0,0.1125,0.5535,0.97865,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,0.0,0.1235,0.05,0.00125,0.5666,0.4346,0.005556,0.8975,0.34575,0.0098775,1.87870,1.6860,0.860})))
        .addChild(new PositionInterpolator("BubblePath9").setKey(new double[] {0.0,0.0025,0.035,0.65,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,0.0,0.522,0.5445,0.0057,0.6543,0.226,0.0055,0.45575,0.4375,0.0067,1.87870,2.0,0.1545})))
        .addChild(new PositionInterpolator("BubblePath10").setKey(new double[] {0.0,0.00025,0.035,0.6895,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,0.0,0.8765,0.445,0.00335,0.3336,0.4446,0.005556,0.765,0.75,0.0075,1.0,1.0,0.1})))
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                ...
                // ./Bubbles_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./Bubbles_JavaExport.x3d"; 
                String filenameX3DV = "./Bubbles_JavaExport.x3dv"; 
                String filenameJSON = "./Bubbles_JavaExport.json";

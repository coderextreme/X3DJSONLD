...
"		  </field>"})
            ...
            .addParts(new ShaderPart().setUrl(new String[] {"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs"}))
            .addParts(new ShaderPart().setType("FRAGMENT").setUrl(new String[] {"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs"})))))

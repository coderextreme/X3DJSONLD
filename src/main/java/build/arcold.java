 ...
 * <p> an attempt to implement an arc in a graph. </p>
 <p> Related links:  source arcold.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
        <caption>Scene Meta Information</caption>
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">arcold&nbsp; Document Metadata </td>
		</tr>
...
public class arcold
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("arcold.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/arc.x3d"))
...
""")
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new arcold().getX3dModel();
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                ...
                // ./arcold_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./arcold_JavaExport.x3d"; 
                String filenameX3DV = "./arcold_JavaExport.x3dv"; 
                String filenameJSON = "./arcold_JavaExport.json";

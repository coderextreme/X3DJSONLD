 ...
 <p> Related links: ball.java source, <a href="http://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="http://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="http://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;" summary="Scene Metadata">
		<tr style="background-color:silver; border-color:silver;">
			...
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.ball&nbsp; Document Metadata </td>
		</tr>

		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> title </i> </td>
			<td> <a href="http://coderextreme.net/X3DJSONLD/ball.x3d">ball.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="http://coderextreme.net/X3DJSONLD/ball.x3d" target="_blank">http://coderextreme.net/X3DJSONLD/ball.x3d</a> </td>
		</tr>
		<tr>
...
"                        <ShaderProgram url='\"freewrl.vs\" \"http://coderextreme.net/X3DJSONLD/freewrl.vs\"' containerField='programs' type='VERTEX'>",
...
"                        </ShaderProgram>",
"                        <ShaderProgram url='\"freewrl.fs\" \"http://coderextreme.net/X3DJSONLD/freewrl.fs\"' containerField='programs' type='FRAGMENT'/>",
"		    </ProgramShader>"})
          .addComments(new String[] {"",
...
"		  <ShaderPart url='\"contact.vs\" \"http://coderextreme.net/X3DJSONLD/contact.vs\"' type=\"VERTEX\" containerField='parts'></ShaderPart>",
"		  <ShaderPart url='\"common.fs\" \"http://coderextreme.net/X3DJSONLD/common.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>",
"                </ComposedShader>"})
          .addComments(new String[] {"",
"                <ComposedShader language='GLSL'>",
...
"		  <ShaderPart url='\"octaga.vs\" \"http://coderextreme.net/X3DJSONLD/octaga.vs\"' type=\"VERTEX\" containerField='parts'></ShaderPart>",
"		  <ShaderPart url='\"common.fs\" \"http://coderextreme.net/X3DJSONLD/common.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>",
"                </ComposedShader>"})
          .addComments(new String[] {"",
"                <ComposedShader language='GLSL'>",
...
"		  <field name='scale' accessType='initializeOnly' type='SFFloat' value='0.5'></field>",
"		  <field name='power' accessType='initializeOnly' type='SFFloat' value='2'></field>",
"		  <ShaderPart url='\"instant.vs\" \"http://coderextreme.net/X3DJSONLD/instant.vs\"' type=\"VERTEX\" containerField='parts'></ShaderPart>",
"		  <ShaderPart url='\"common.fs\" \"http://coderextreme.net/X3DJSONLD/common.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>",
"                </ComposedShader>"})
          .addComments(new String[] {""})
          .addShaders(new ComposedShaderObject().setLanguage("GLSL")
            ...
            .addParts(new ShaderPartObject("common").setType("FRAGMENT").setUrl(new MFStringObject("\"common.fs\" \"http://coderextreme.net/X3DJSONLD/common.fs\""))))
          .addShaders(new ComposedShaderObject().setLanguage("GLSL")
  ...
  public String validateSelf()
  {
    ...
    {
		ball testObject = new ball();
		System.out.println ("ball execution self-validation test results: " + testObject.validateSelf());
	}
}

 ...
 * <p> Test of browser ability to map a 3 times multiple of an PixelTexture onto an IndexedFaceSet geometry. A 3 by 3 matrix of four equal sized red, green, white and yellow squares in the pixel texture map all the faces of the cube. </p>
 <p> Related links: <a href="../../../../GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plus.java">indexedfaceset_pixeltexture_plus.java</a> source, <a href="../../../../GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plusIndex.html" target="_top">indexedfaceset_pixeltexture_plus catalog page</a>, <a href="http://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="http://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="http://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
...
public class indexedfaceset_pixeltexture_plus
{
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ShapeObject()
      ...
      .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setColorPerVertex(false).setTexCoordIndex(new int[] {0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1}).setCoordIndex(new int[] {0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1})
        ...
        .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new float[] {-1.0f,2.0f,-1.0f,-1.0f,2.0f,2.0f,2.0f,-1.0f}))))));
  }
  ...
  public String validateSelf()
  {
    ...
    {
		indexedfaceset_pixeltexture_plus testObject = new indexedfaceset_pixeltexture_plus();
		System.out.println ("indexedfaceset_pixeltexture_plus execution self-validation test results: " + testObject.validateSelf());
	}
}

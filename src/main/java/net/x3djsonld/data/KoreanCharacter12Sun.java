 ...
 <p> Related links: KoreanCharacter12Sun.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter12Sun.x3d">KoreanCharacter12Sun.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter12Sun.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter12Sun.x3d</a> </td>
		</tr>
		<tr>
...
public class KoreanCharacter12Sun
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter12Sun.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Sun").setName("Sun").setInfo(new String[] {"authorName=Chul Hee Jung and Myeong Won Lee","authorEmail=myeongwonlee@gmail.com","creationDate=31 March 2011","humanoidVersion=1.0","gender=female","height=1.5"}).setScale(0.0225,0.0225,0.0225).setVersion("1.0")
      .addSkeleton(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,29.860001,-0.456700).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new Transform().setTranslation(0.0,29.860001,-0.456700)
            .addChild(new Shape()
              .setAppearance(new Appearance()
                ...
                .setTexture(new ImageTexture("SunTextureAtlas").setUrl(new String[] {"images/Sun.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/images/Sun.png"})))
        ...
        .addChild(new HAnimJoint("hanim_l_hip").setName("l_hip").setCenter(2.955000,28.940001,-0.521800).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_l_knee").setName("l_knee").setCenter(2.948000,16.459999,-0.527500).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_l_ankle").setName("l_ankle").setCenter(2.839000,3.899000,-0.411600).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_l_midtarsal").setName("l_midtarsal").setCenter(2.839000,3.312000,1.078000).setStiffness(new double[] {0.0,0.0,0.0})
        ...
        .addChild(new HAnimJoint("hanim_r_hip").setName("r_hip").setCenter(-2.955000,28.940001,-0.521800).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new Transform().setTranslation(-2.955000,28.940001,-0.521800)
              .addChild(new Shape()
                ...
                .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_9_74_coordIndex()).setTexCoordIndex(getIndexedFaceSet_9_74_texCoordIndex())
                  ...
                  .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.9180,0.5995,0.9216,0.5192,0.9118,0.5261,0.9076,0.5995,0.9471,0.5995,0.9471,0.5153,0.9763,0.5995,0.9745,0.5192,0.9867,0.5995,0.9841,0.5261,0.9751,0.5995,0.9733,0.5337,0.9471,0.5369,0.9192,0.5995,0.9227,0.5337,0.9178,0.4416,0.9263,0.4416,0.9339,0.4268,0.9271,0.4268,0.9471,0.4416,0.9471,0.4268,0.9697,0.4416,0.9621,0.4268,0.9783,0.4416,0.9689,0.4268,0.9471,0.4144,0.9258,0.4603,0.9166,0.4603,0.9471,0.4603,0.9702,0.4603,0.9794,0.4603,0.9716,0.4970,0.9471,0.4986,0.9244,0.4970,0.9261,0.4603,0.9186,0.6114,0.9253,0.6114,0.9265,0.6114,0.9471,0.6114,0.9678,0.6114,0.9757,0.6114,0.9690,0.6114,0.9471,0.6206,0.9699,0.4603})))))))
          .addChild(new HAnimJoint("hanim_r_knee").setName("r_knee").setCenter(-2.948000,16.459999,-0.527500).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new Transform().setTranslation(-2.948000,16.459999,-0.527500)
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_83_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_83_texCoordIndex())
                    ...
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.9287,0.3420,0.9261,0.3817,0.9166,0.3743,0.9312,0.2839,0.9471,0.2839,0.9471,0.3395,0.9648,0.2839,0.9653,0.3367,0.9721,0.2839,0.9756,0.3608,0.9668,0.3526,0.9471,0.3496,0.9261,0.3638,0.9239,0.2839,0.9178,0.4416,0.9263,0.4416,0.9323,0.4565,0.9255,0.4565,0.9471,0.4416,0.9471,0.4565,0.9697,0.4416,0.9637,0.4565,0.9783,0.4416,0.9705,0.4565,0.9471,0.4689,0.9320,0.2704,0.9370,0.2704,0.9471,0.2704,0.9590,0.2704,0.9640,0.2704,0.9471,0.2608,0.9261,0.4280,0.9162,0.4243,0.9474,0.4280,0.9471,0.3767,0.9684,0.4280,0.9669,0.3711,0.9771,0.4243,0.9678,0.4243,0.9471,0.4243,0.9259,0.4243,0.9467,0.3066,0.9291,0.3066,0.9659,0.3066,0.9763,0.3066,0.9670,0.3066,0.9459,0.3066,0.9267,0.3066,0.9183,0.3066})))))))
            .addChild(new HAnimJoint("hanim_r_ankle").setName("r_ankle").setCenter(-2.839000,3.899000,-0.411600).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_r_midtarsal").setName("r_midtarsal").setCenter(-2.839000,3.312000,1.078000).setStiffness(new double[] {0.0,0.0,0.0})
        ...
        .addChild(new HAnimJoint("hanim_sacroiliac").setName("sacroiliac").setCenter(0.0,29.860001,-0.456700).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_shoulder").setCenter(6.077000,45.880001,-1.319000).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(7.076000,38.529999,-1.385000).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_l_wrist").setName("l_wrist").setCenter(6.946000,30.889999,-1.308000).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_shoulder").setCenter(-6.077000,45.880001,-1.319000).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new Transform().setTranslation(-6.077000,45.880001,-1.319000)
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_153_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_153_texCoordIndex())
                    ...
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.7373,1.9040,0.7454,1.8520,0.7783,1.8580,0.7656,1.8990,0.7152,1.8480,0.7100,1.9010,0.6826,1.9040,0.6851,1.8460,0.7419,1.9270,0.7284,1.9180,0.6909,1.9180,0.6244,1.9050,0.6190,1.8550,0.6525,1.8460,0.6537,1.9120,0.5897,1.8650,0.5966,1.9020,0.5694,1.9050,0.5607,1.8660,0.5430,1.9160,0.5243,1.8610,0.5792,1.9190,0.6768,1.9270,0.7098,1.9150,0.7095,1.9340,0.7427,1.7930,0.5662,1.9300,0.5976,1.9160,0.6166,1.9180,0.6311,1.9280,0.5988,1.9350,0.6179,1.7860,0.6520,1.7840,0.5894,1.7900,0.5606,1.7940,0.5257,1.7960,0.6213,1.7320,0.7737,1.7940,0.7122,1.7890,0.6812,1.7850,0.7323,1.7290,0.7300,1.7190,0.7470,1.7120,0.7045,1.7310,0.7048,1.7240,0.6766,1.7310,0.6789,1.7220,0.6605,1.7150,0.7027,1.7000,0.6206,1.7240,0.6424,1.7170,0.5940,1.7310,0.5953,1.7260,0.5704,1.7230,0.5669,1.7310,0.5513,1.7110,0.5972,1.7000,0.7577,1.7270,0.5392,1.7290,0.6505,1.7310,0.6254,1.7370,0.7371,1.7330,0.7608,1.7310,0.7076,1.7370,0.6768,1.7380,0.5953,1.7400,0.5651,1.7380,0.5290,1.7330,0.6481,1.7380})))))))
            .addChild(new HAnimJoint("hanim_r_elbow").setName("r_elbow").setCenter(-7.076000,38.529999,-1.385000).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_r_wrist").setName("r_wrist").setCenter(-6.946000,30.889999,-1.308000).setStiffness(new double[] {0.0,0.0,0.0})
                  ...
                  .addChild(new Transform().setTranslation(-6.946000,30.889999,-1.308000)
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(new int[] {3,2,1,-1,1,0,3,-1,5,4,7,-1,7,6,5,-1,9,8,11,-1,11,10,9,-1,9,10,13,-1,13,12,9,-1,15,14,17,-1,17,16,15,-1,16,19,18,-1,18,15,16,-1,3,0,10,-1,10,11,3,-1,10,0,1,-1,1,13,10,-1,16,17,21,-1,21,20,16,-1,20,2,19,-1,19,16,20,-1,7,8,9,-1,9,6,7,-1,5,6,9,-1,9,12,5,-1,15,23,22,-1,22,14,15,-1,18,4,23,-1,23,15,18,-1,21,1,2,-1,2,20,21,-1,23,4,5,-1,5,22,23,-1,12,13,17,-1,17,14,12,-1,26,25,24,-1,24,27,26,-1,21,17,13,-1,13,1,21,-1,11,19,2,-1,2,3,11,-1,22,5,12,-1,12,14,22,-1,4,18,8,-1,8,7,4,-1,25,11,8,-1,8,24,25,-1,11,25,26,-1,26,19,11,-1,19,26,27,-1,27,18,19,-1,18,27,24,-1,24,8,18,-1}).setTexCoordIndex(new int[] {3,2,1,-1,1,0,3,-1,28,5,4,-1,4,29,28,-1,9,8,11,-1,11,10,9,-1,9,10,13,-1,13,12,9,-1,39,38,41,-1,41,40,39,-1,16,19,18,-1,18,15,16,-1,3,0,10,-1,10,11,3,-1,10,0,1,-1,1,13,10,-1,40,41,43,-1,43,42,40,-1,20,2,19,-1,19,16,20,-1,7,8,9,-1,9,6,7,-1,28,29,30,-1,30,31,28,-1,39,23,22,-1,22,38,39,-1,33,5,32,-1,32,34,33,-1,21,1,2,-1,2,20,21,-1,32,5,28,-1,28,35,32,-1,12,13,17,-1,17,14,12,-1,26,25,24,-1,24,27,26,-1,21,17,13,-1,13,1,21,-1,11,19,2,-1,2,3,11,-1,35,28,31,-1,31,36,35,-1,5,33,37,-1,37,4,5,-1,25,11,8,-1,8,24,25,-1,11,25,26,-1,26,19,11,-1,19,26,27,-1,27,18,19,-1,18,27,24,-1,24,8,18,-1})
                        ...
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.2291,0.4554,0.2379,0.4639,0.1638,0.4639,0.1669,0.4554,0.1055,0.4675,0.0703,0.4694,0.2333,0.3582,0.1628,0.3683,0.1487,0.3875,0.2473,0.3875,0.2473,0.4350,0.1487,0.4350,0.2598,0.3830,0.2598,0.4396,0.2502,0.3875,0.1477,0.3875,0.1477,0.4350,0.2502,0.4350,0.1383,0.3830,0.1383,0.4396,0.1698,0.4554,0.2320,0.4554,0.2362,0.3582,0.1657,0.3683,0.1283,0.3928,0.1283,0.4296,0.1178,0.4333,0.1178,0.3894,0.0685,0.4095,0.1043,0.4119,0.1041,0.3824,0.0691,0.3798,0.0184,0.4681,0.0704,0.4904,0.0183,0.4889,0.0176,0.4121,0.0180,0.3832,0.1056,0.4890,0.2502,0.3875,0.1515,0.3875,0.1515,0.4350,0.2502,0.4350,0.1698,0.4554,0.2320,0.4554}))))))))))
          .addChild(new HAnimJoint("hanim_vl5").setName("vl5").setCenter(0.052490,34.130001,-0.468000).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_skullbase").setName("skullbase").setCenter(0.0,51.250000,-1.124000).setStiffness(new double[] {0.0,0.0,0.0})
	...
	// end of initialize() method
		...
		private double[] getTextureCoordinate_9_26_point_1()
		{
		...
		private double[] getTextureCoordinate_9_26_point_2()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_13_62_point_1()
		{
		...
		private double[] getTextureCoordinate_13_62_point_2()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_13_102_point_1()
		{
			double[] value = {0.1645,0.2682,0.1190,0.2656,0.1190,0.2333,0.1642,0.2355,0.1585,0.1986,0.1190,0.1964,0.1190,0.1664,0.1572,0.1750,0.1786,0.2029,0.1893,0.2321,0.2954,0.0497,0.2633,0.0308,0.2607,0.0443,0.2924,0.0621,0.2275,0.0325,0.2299,0.0183,0.1375,0.0244,0.1392,0.0478,0.1726,0.0473,0.1726,0.0227,0.1726,0.0066,0.1366,0.0058,0.2807,0.0840,0.2512,0.0670,0.2227,0.0576,0.2601,0.0398,0.2197,0.2888,0.2029,0.2547,0.1996,0.0258,0.2000,0.0107,0.1962,0.0514,0.0735,0.2682,0.0739,0.2355,0.0796,0.1986,0.0809,0.1750,0.0352,0.2547,0.0488,0.2320,0.2918,0.0575,0.2269,0.0279,0.0183,0.2887,0.0595,0.2029,0.9339,0.9522,0.9339,0.9254,0.9339,0.9014,0.9339,0.8697,0.9832,0.9254,0.9789,0.9522,0.9339,0.9904,0.9656,0.9806,0.9857,0.8697,0.9861,0.9014,0.8846,0.9254,0.8818,0.9014,0.9023,0.9806,0.8890,0.9522,0.8822,0.8697,0.1368,0.0198,0.1720,0.0181,0.1989,0.0212,0.1959,0.3397,0.2330,0.3209,0.1086,0.0510,0.1073,0.0299,0.1066,0.0253,0.1188,0.3009,0.1607,0.3056,0.0420,0.3397,0.0049,0.3208,0.0774,0.3058,0.9339,0.8425,0.9842,0.8425,0.1053,0.0075,0.8836,0.8425,0.1925,0.3379,0.0929,0.0472,0.0926,0.0413,0.0916,0.0386,0.0732,0.0453,0.0548,0.0520,0.0558,0.0548,0.0593,0.0595,0.0051,0.3217,0.0786,0.3181,0.1161,0.3130,0.1637,0.3136,0.8849,0.8425,0.9342,0.8425,0.9342,0.8153,0.8926,0.8153,0.9835,0.8425,0.9758,0.8153,0.1064,0.0254,0.1052,0.0081,0.0900,0.0108,0.0907,0.0265,0.1052,0.0081,0.1064,0.0254,0.0907,0.0265,0.0900,0.0108,0.1068,0.0747};
			return value;
		}
		private double[] getTextureCoordinate_13_102_point_2()
		{
			double[] value = {0.1086,0.0517,0.0941,0.0542,0.0982,0.0753,0.1071,0.0300,0.0934,0.0410,0.1071,0.0300,0.1086,0.0517,0.0941,0.0542,0.0934,0.0410,0.1068,0.0747,0.0982,0.0754,0.0683,0.0723,0.0739,0.0833,0.0866,0.0821,0.0970,0.0748,0.0943,0.0628};
			return value;
		}
		...
		private double[] getTextureCoordinate_10_115_point_3()
		{
		...
		private int[] getIndexedFaceSet_11_192_coordIndex_4()
		{
		...
		private int[] getIndexedFaceSet_11_192_texCoordIndex_4()
		{
		...
		private double[] getCoordinate_12_192_point_5()
		{
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=8, element #25, 560 total numbers.
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=8, element #25, 560 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=9, element #25, 216 total numbers made up of 72 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_9_26_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_9_26_point_1()))
				.append(new MFVec2f(getTextureCoordinate_9_26_point_2()));
			return TextureCoordinate_9_26_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #34, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #34, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #34, 159 total numbers made up of 53 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #43, 472 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #43, 472 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #43, 183 total numbers made up of 61 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_11_43_point = new MFVec3f(new double[] {1.3750,-5.8340,-1.1930,1.4770,-4.1370,-1.1950,1.9520,-4.6720,0.1143,0.6966,-12.1600,-0.8887,-0.0964,-12.1600,-1.3040,0.0075,-6.4890,-1.9840,-0.9748,-12.1600,-0.8887,-1.3290,-6.2440,-1.3140,-1.3390,-12.1600,0.1054,-1.7610,-6.2290,0.1143,-0.9748,-12.1600,0.9689,-1.2170,-6.8650,1.2220,-0.0964,-12.1600,1.3840,0.0075,-7.0960,1.8790,0.6966,-12.1600,0.9689,1.3120,-6.0040,1.2250,1.0600,-12.1600,0.1054,1.8310,0.0045,0.1143,1.3010,0.0045,-1.1980,0.9277,1.1480,-0.9020,1.3530,1.1480,0.1143,0.0071,0.0045,-1.7710,0.0071,1.1480,-1.3270,-1.3960,0.0045,-1.1980,-1.0200,1.1480,-0.9020,-1.8850,0.0045,0.1143,-1.4450,1.1480,0.1143,-1.3960,0.0045,1.5510,-1.0200,1.1480,1.3960,0.0071,0.0045,2.1250,0.0071,1.1480,1.8210,1.3010,0.0045,1.5510,0.9277,1.1480,1.3960,0.0071,2.1060,0.1143,0.7952,-13.2000,0.1143,0.5053,-13.2000,-0.6746,0.5053,-13.2000,0.7490,-0.0941,-13.2000,1.0800,-0.7943,-13.2000,0.7490,-1.0840,-13.2000,0.1143,-0.7943,-13.2000,-0.6746,-0.0941,-13.2000,-1.0060,-0.0941,-13.9400,0.1143,1.3190,-1.2050,-1.1950,1.9280,-1.3330,0.1143,-0.0092,-1.0510,-1.8500,0.0075,-3.7920,-2.1250,-1.4230,-1.2050,-1.1950,-1.3860,-4.7580,-1.3440,-1.9520,-1.3330,0.1143,-1.3910,-1.3330,1.3080,0.0071,-1.3330,1.8810,1.3260,-1.3330,1.3080,-0.0957,-10.2200,-1.5250,0.8601,-10.2200,-0.9874,-1.1000,-10.2200,-1.0260,-1.4780,-10.2200,0.1083,-1.0650,-10.2200,1.0510,-0.0957,-10.2200,1.5450,0.8407,-10.2200,1.0520,1.2830,-10.2200,0.1083});
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #53, 152 total numbers made up of 76 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #61, 544 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #61, 210 total numbers made up of 70 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_13_62_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_13_62_point_1()))
				.append(new MFVec2f(getTextureCoordinate_13_62_point_2()));
			return TextureCoordinate_13_62_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #74, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #74, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #74, 159 total numbers made up of 53 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #83, 472 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #83, 183 total numbers made up of 61 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_11_83_point = new MFVec3f(new double[] {-1.3750,-5.8340,-1.1930,-1.4770,-4.1370,-1.1950,-1.9520,-4.6720,0.1143,-0.6966,-12.1600,-0.8887,0.0964,-12.1600,-1.3040,-0.0075,-6.4890,-1.9840,0.9748,-12.1600,-0.8887,1.3290,-6.2440,-1.3140,1.3390,-12.1600,0.1054,1.7610,-6.2290,0.1143,0.9748,-12.1600,0.9689,1.2170,-6.8650,1.2220,0.0964,-12.1600,1.3840,-0.0075,-7.0960,1.8790,-0.6966,-12.1600,0.9689,-1.3120,-6.0040,1.2250,-1.0600,-12.1600,0.1054,-1.8310,0.0045,0.1143,-1.3010,0.0045,-1.1980,-0.9277,1.1480,-0.9020,-1.3530,1.1480,0.1143,-0.0071,0.0045,-1.7710,-0.0071,1.1480,-1.3270,1.3960,0.0045,-1.1980,1.0200,1.1480,-0.9020,1.8850,0.0045,0.1143,1.4450,1.1480,0.1143,1.3960,0.0045,1.5510,1.0200,1.1480,1.3960,-0.0071,0.0045,2.1250,-0.0071,1.1480,1.8210,-1.3010,0.0045,1.5510,-0.9277,1.1480,1.3960,-0.0071,2.1060,0.1143,-0.7952,-13.2000,0.1143,-0.5053,-13.2000,-0.6746,-0.5053,-13.2000,0.7490,0.0941,-13.2000,1.0800,0.7943,-13.2000,0.7490,1.0840,-13.2000,0.1143,0.7943,-13.2000,-0.6746,0.0941,-13.2000,-1.0060,0.0941,-13.9400,0.1143,-1.3190,-1.2050,-1.1950,-1.9280,-1.3330,0.1143,0.0092,-1.0510,-1.8500,-0.0075,-3.7920,-2.1250,1.4230,-1.2050,-1.1950,1.3860,-4.7580,-1.3440,1.9520,-1.3330,0.1143,1.3910,-1.3330,1.3080,-0.0071,-1.3330,1.8810,-1.3260,-1.3330,1.3080,0.0957,-10.2200,-1.5250,-0.8601,-10.2200,-0.9874,1.1000,-10.2200,-1.0260,1.4780,-10.2200,0.1083,1.0650,-10.2200,1.0510,0.0957,-10.2200,1.5450,-0.8407,-10.2200,1.0520,-1.2830,-10.2200,0.1083});
		...
		{
			MFVec2f TextureCoordinate_12_93_point = new MFVec2f(new double[] {0.1096,0.0871,0.1086,0.0510,0.0724,0.0571,0.0703,0.0930,0.0235,0.0750,0.0389,0.1112,0.0537,0.0629,0.0688,0.0153,0.0719,0.0393,0.1073,0.0299,0.1053,0.0075,0.0438,0.0235,0.0507,0.0468,0.0827,0.1223,0.1079,0.1195,0.0638,0.1406,0.1480,0.3335,0.1191,0.3241,0.1188,0.3009,0.1607,0.3056,0.0125,0.0361,0.0195,0.0586,0.1959,0.3397,0.1665,0.3560,0.0896,0.3325,0.0774,0.3058,0.0420,0.3397,0.9339,0.8099,0.9339,0.8425,0.9339,0.7851,0.9639,0.7918,0.9793,0.8097,0.9842,0.8425,0.8885,0.8098,0.9038,0.7913,0.8836,0.8425,0.0713,0.0347,0.1066,0.0253,0.0500,0.0422,0.0189,0.0540,0.1420,0.3577,0.1187,0.3518,0.0703,0.3561,0.0946,0.3567,0.1006,0.1294,0.0944,0.1279,0.1006,0.1210,0.0918,0.1217,0.0937,0.1145,0.0996,0.1127,0.1056,0.1147,0.1091,0.1206,0.1065,0.1264,0.1086,0.0510,0.1096,0.0871,0.1607,0.3056,0.1188,0.3009,0.0774,0.3058,0.0420,0.3397,0.1073,0.0299,0.8837,0.8428,0.9341,0.8428,0.9341,0.8649,0.1066,0.0253,0.1067,0.0250,0.1052,0.0076,0.1262,0.0158,0.1220,0.0264,0.1052,0.0076,0.1067,0.0250,0.1220,0.0264,0.1262,0.0158,0.1262,0.0158,0.9001,0.8648,0.9844,0.8428,0.9680,0.8649});
			return TextureCoordinate_12_93_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=12, element #101, 544 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #101, 544 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #101, 210 total numbers made up of 70 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_13_101_point = new MFVec3f(new double[] {-1.3880,-0.7441,0.9353,0.0000,-0.5418,1.1420,0.0000,-1.0420,2.0020,-1.3560,-1.2340,1.8230,-1.2860,-1.3940,3.0040,0.0000,-1.2120,3.1540,0.0000,-1.7080,3.9620,-1.1620,-1.8000,3.6400,-1.6500,-1.8680,2.6710,-1.8060,-1.8590,1.6880,-1.2170,-2.6570,3.7900,0.0000,-2.6050,4.1590,-1.7290,-2.7670,2.6760,-1.9840,-2.7470,-0.4534,-1.8470,-1.8790,-0.4111,-1.9100,-1.9140,0.8074,-2.0060,-2.8300,0.7644,-1.8950,-2.7910,1.6970,1.3880,-0.7441,0.9353,1.3560,-1.2340,1.8230,1.2860,-1.3940,3.0040,1.1620,-1.8000,3.6400,1.9100,-1.9140,0.8074,1.8060,-1.8590,1.6880,1.2170,-2.6570,3.7900,1.7290,-2.7670,2.6760,2.0060,-2.8300,0.7644,1.8470,-1.8790,-0.4111,1.9840,-2.7470,-0.4534,1.6500,-1.8680,2.6710,1.8950,-2.7910,1.6970,0.0000,-3.1800,0.7644,-2.0060,-3.1800,0.7644,-1.7290,-3.1370,2.7100,-1.2170,-3.0690,3.7930,0.0000,-2.9970,4.1620,0.0000,-3.1800,-0.4554,-1.9900,-3.1800,-0.4554,1.7290,-3.1370,2.7100,2.0060,-3.1800,0.7644,1.2170,-3.0690,3.7930,1.9900,-3.1800,-0.4554,0.0000,-3.1410,2.7100,-1.8950,-3.1640,1.6860,1.8950,-3.1640,1.6860,0.0000,-3.1640,1.6860,-1.4860,-0.5175,-1.5020,-1.7880,-1.7970,-1.5020,-1.9280,-2.5850,-1.5020,0.0009,0.1637,0.3610,-1.3260,-0.0186,0.0033,1.4860,-0.5175,-1.5020,1.7880,-1.7970,-1.5020,1.9280,-2.5850,-1.5020,1.3310,-0.0112,0.0089,0.0000,-3.1640,-1.5020,-1.9350,-3.1640,-1.5020,1.9340,-3.1640,-1.5020,-1.1530,-0.3082,-2.0150,-1.1920,-1.3880,-2.3790,-1.3070,-1.8760,-2.3630,-1.3070,-2.1290,-2.3560,-0.0004,-2.1290,-2.3560,1.3060,-2.1290,-2.3560,1.3060,-1.8760,-2.3620,1.1910,-1.3880,-2.3780,1.1520,-0.3071,-2.0140,1.0270,0.2573,-1.1730,0.0025,0.3479,-0.8576,-1.0230,0.2519,-1.1790});
			return Coordinate_13_101_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=13, element #102, 232 total numbers made up of 116 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_13_102_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_13_102_point_1()))
				.append(new MFVec2f(getTextureCoordinate_13_102_point_2()));
			return TextureCoordinate_13_102_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #114, 1064 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #114, 1064 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #114, 588 total numbers made up of 196 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #115, 448 total numbers made up of 224 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_10_115_point()
		{
			MFVec2f TextureCoordinate_10_115_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_10_115_point_3()));
			return TextureCoordinate_10_115_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #123, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #123, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #132, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #132, 198 total numbers made up of 66 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #153, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #162, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #162, 198 total numbers made up of 66 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_12_162_point = new MFVec3f(new double[] {-0.8960,-3.4580,-0.7733,-1.4300,-3.2830,0.0723,-1.1630,-7.2700,0.0721,-0.7935,-7.2670,-0.5416,0.0234,-3.8430,-1.1440,0.0262,-7.3000,-0.8983,0.6588,-7.6090,-0.4491,0.7822,-7.0490,-0.4810,0.0250,-7.0700,-0.8149,0.0233,-7.6310,-0.7795,0.9220,-7.6140,0.0729,1.0980,-7.0530,0.0729,0.6588,-7.6120,0.6263,0.7823,-7.0500,0.6527,0.9427,-4.1740,0.8667,0.8457,-7.2800,0.7082,0.0234,-7.2820,1.0660,0.0234,-3.8250,1.2730,0.0233,-7.6230,0.9572,-0.6122,-7.6120,0.6263,-0.7325,-7.0430,0.6513,0.0233,-7.0570,0.9867,-0.8960,-3.4520,0.8897,-0.7936,-7.2660,0.7058,-0.8960,-0.0257,-0.9221,-0.7144,0.4948,-0.6658,-1.0200,0.4948,0.0721,-1.2770,-0.0257,0.0721,0.0236,-0.0257,-1.3340,0.0236,0.4948,-0.9714,0.9432,-0.0257,-0.9221,0.7615,0.4948,-0.6658,1.3240,-0.0257,0.0721,1.0670,0.4948,0.0721,0.9432,-0.0257,0.9219,0.7615,0.4948,0.8099,0.0236,-0.0257,1.3340,0.0236,0.4948,1.1160,-0.8960,-0.0257,0.9219,-0.7144,0.4948,0.8099,0.0236,0.9310,0.0721,-0.6122,-7.6090,-0.4491,-0.8754,-7.6140,0.0729,-0.5830,-8.0860,0.0729,-0.4054,-8.0630,-0.1612,-0.4054,-8.0760,0.3527,0.0233,-8.0830,0.5759,0.4520,-8.0760,0.3527,0.6297,-8.0860,0.0729,0.4520,-8.0630,-0.1612,0.0233,-8.0780,-0.3841,0.0233,-8.4240,0.0729,-1.4030,-0.6344,0.0721,-0.9954,-0.5060,-0.8653,0.0200,-0.5060,-1.2770,0.9426,-4.1790,-0.7253,1.0410,-0.5060,-0.8653,1.4300,-0.6344,0.0721,1.3230,-4.3210,0.0723,1.0180,-0.6344,0.9221,0.0236,-0.6344,1.3340,-0.9707,-0.6344,0.9221,-1.0630,-7.0460,0.0729,-0.7325,-7.0420,-0.4818,0.8456,-7.2810,-0.5402,1.1880,-7.2840,0.0721});
			return Coordinate_12_162_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #163, 176 total numbers made up of 88 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_12_163_point = new MFVec2f(new double[] {0.6214,1.7320,0.7319,1.7290,0.7045,1.7300,0.6763,1.7310,0.6737,1.5700,0.6695,1.5810,0.6525,1.5780,0.6596,1.5650,0.6720,1.6480,0.5944,1.7310,0.6690,1.5850,0.6920,1.5850,0.6985,1.6540,0.6909,1.5710,0.7076,1.5680,0.7136,1.5790,0.6917,1.5810,0.7251,1.6600,0.7149,1.5830,0.7334,1.5800,0.5663,1.7330,0.5738,1.6600,0.5479,1.6610,0.7502,1.6610,0.5667,1.5810,0.5849,1.5840,0.6006,1.6550,0.6078,1.5850,0.6259,1.5700,0.6303,1.5810,0.6081,1.5820,0.6088,1.5720,0.6784,1.7200,0.6987,1.7180,0.7150,1.7230,0.7248,1.7380,0.7566,1.7270,0.6922,1.7390,0.7083,1.5530,0.7208,1.5620,0.7017,1.5570,0.6900,1.5610,0.6778,1.5590,0.6394,1.5650,0.6467,1.5780,0.6707,1.5550,0.6891,1.5490,0.5851,1.7220,0.5744,1.7380,0.5383,1.7290,0.6749,1.7190,0.7035,1.7180,0.7320,1.7170,0.7566,1.7150,0.6497,1.5840,0.7300,1.5740,0.6021,1.7170,0.6226,1.7190,0.6477,1.7270,0.6092,1.7390,0.5919,1.5690,0.5792,1.5630,0.5915,1.5540,0.5975,1.5580,0.6219,1.5590,0.6284,1.5560,0.6095,1.5610,0.6103,1.5500,0.5395,1.7160,0.5658,1.7210,0.5946,1.7220,0.6275,1.6480,0.6242,1.7230,0.6504,1.7190,0.6499,1.6450,0.5702,1.5750,0.5861,1.5790,0.6308,1.5860,0.6503,1.7310,0.6767,1.7110,0.7018,1.7100,0.7234,1.7190,0.7395,1.7280,0.5770,1.7120,0.5523,1.7310,0.5995,1.7060,0.6239,1.7090,0.6527,1.7160});
			return TextureCoordinate_12_163_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #183, 1048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #183, 1048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #183, 423 total numbers made up of 141 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=11, element #184, 274 total numbers made up of 137 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=11, element #192, 3104 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_11_192_coordIndex()
		{
			MFInt32 IndexedFaceSet_11_192_coordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_11_192_coordIndex_4()));
			return IndexedFaceSet_11_192_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #192, 3104 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_11_192_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_11_192_texCoordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_11_192_texCoordIndex_4()));
			return IndexedFaceSet_11_192_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #192, 1272 total numbers made up of 424 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec3f getCoordinate_12_192_point()
		{
			MFVec3f Coordinate_12_192_point = new MFVec3f()/*2.finalize*/
				...
				.append(new MFVec3f(getCoordinate_12_192_point_5()));
			return Coordinate_12_192_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #193, 808 total numbers made up of 404 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java

 ...
 <p> Related links:  source KoreanCharacter12Sun.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/../Poses/images/HAnimPoseExampleKoreanCharacter12Sun.png">../Poses/images/HAnimPoseExampleKoreanCharacter12Sun.png</a> </td>
		</tr>
		<tr>
...
public class KoreanCharacter12Sun
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("../Poses/images/HAnimPoseExampleKoreanCharacter12Sun.png"))
  ...
  .setScene(new Scene()
          ...
          .addChild(new Transform().setTranslation(0.0,29.860001,-0.456700)
            .addChild(new Shape()
              ...
              .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_8_34_coordIndex()).setTexCoordIndex(getIndexedFaceSet_8_34_texCoordIndex())
                ...
                .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_9_35_point()))))))
                ...
                .addChild(new Transform().setTranslation(2.839000,3.899000,-0.411600)
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_61_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_61_texCoordIndex())
                      ...
                      .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_12_62_point()))))))
                ...
                .addChild(new Transform().setTranslation(7.076000,38.529999,-1.385000)
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_141_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_141_texCoordIndex())
                      ...
                      .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_12_142_point()))))))
                ...
                .addChild(new Transform().setTranslation(-7.076000,38.529999,-1.385000)
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_171_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_171_texCoordIndex())
                      ...
                      .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_12_172_point()))))))
    ...
    .addChild(new EXPORT().setLocalDEF("hanim_Sun").setAS("KoreanCharacter12Sun")));
            }
            catch (Exception ex)
            {       
	...
	// end of initialize() method
		...
		private double[] getTextureCoordinate_9_35_point_1()
		{
		...
		private double[] getTextureCoordinate_9_35_point_2()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=1 */
		private double[] getTextureCoordinate_13_71_point_1()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=2 */
		private double[] getTextureCoordinate_13_71_point_2()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=1 */
		private double[] getTextureCoordinate_13_111_point_1()
		{
			double[] value = {0.1645,0.2682,0.1190,0.2656,0.1190,0.2333,0.1642,0.2355,0.1585,0.1986,0.1190,0.1964,0.1190,0.1664,0.1572,0.1750,0.1786,0.2029,0.1893,0.2321,0.2954,0.0497,0.2633,0.0308,0.2607,0.0443,0.2924,0.0621,0.2275,0.0325,0.2299,0.0183,0.1375,0.0244,0.1392,0.0478,0.1726,0.0473,0.1726,0.0227,0.1726,0.0066,0.1366,0.0058,0.2807,0.0840,0.2512,0.0670,0.2227,0.0576,0.2601,0.0398,0.2197,0.2888,0.2029,0.2547,0.1996,0.0258,0.2000,0.0107,0.1962,0.0514,0.0735,0.2682,0.0739,0.2355,0.0796,0.1986,0.0809,0.1750,0.0352,0.2547,0.0488,0.2320,0.2918,0.0575,0.2269,0.0279,0.0183,0.2887,0.0595,0.2029,0.9339,0.9522,0.9339,0.9254,0.9339,0.9014,0.9339,0.8697,0.9832,0.9254,0.9789,0.9522,0.9339,0.9904,0.9656,0.9806,0.9857,0.8697,0.9861,0.9014,0.8846,0.9254,0.8818,0.9014,0.9023,0.9806,0.8890,0.9522,0.8822,0.8697,0.1368,0.0198,0.1720,0.0181,0.1989,0.0212,0.1959,0.3397,0.2330,0.3209,0.1086,0.0510,0.1073,0.0299,0.1066,0.0253,0.1188,0.3009,0.1607,0.3056,0.0420,0.3397,0.0049,0.3208,0.0774,0.3058,0.9339,0.8425,0.9842,0.8425,0.1053,0.0075,0.8836,0.8425,0.1925,0.3379,0.0929,0.0472,0.0926,0.0413,0.0916,0.0386,0.0732,0.0453,0.0548,0.0520,0.0558,0.0548,0.0593,0.0595,0.0051,0.3217,0.0786,0.3181,0.1161,0.3130,0.1637,0.3136,0.8849,0.8425,0.9342,0.8425,0.9342,0.8153,0.8926,0.8153,0.9835,0.8425,0.9758,0.8153,0.1064,0.0254,0.1052,0.0081,0.0900,0.0108,0.0907,0.0265,0.1052,0.0081,0.1064,0.0254,0.0907,0.0265,0.0900,0.0108,0.1068,0.0747};
			return value;
		}
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=2 */
		private double[] getTextureCoordinate_13_111_point_2()
		{
			double[] value = {0.1086,0.0517,0.0941,0.0542,0.0982,0.0753,0.1071,0.0300,0.0934,0.0410,0.1071,0.0300,0.1086,0.0517,0.0941,0.0542,0.0934,0.0410,0.1068,0.0747,0.0982,0.0754,0.0683,0.0723,0.0739,0.0833,0.0866,0.0821,0.0970,0.0748,0.0943,0.0628};
			return value;
		}
		...
		private int[] getIndexedFaceSet_9_123_coordIndex_2()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=2 */
		private int[] getIndexedFaceSet_9_123_texCoordIndex_2()
		{
		...
		private double[] getCoordinate_10_123_point_1()
		{
		...
		private double[] getCoordinate_10_123_point_2()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=1 */
		private double[] getTextureCoordinate_10_124_point_1()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=2 */
		private double[] getTextureCoordinate_10_124_point_2()
		{
		...
		private double[] getTextureCoordinate_10_124_point_3()
		{
		...
		private int[] getIndexedFaceSet_11_201_coordIndex_4()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=4 */
		private int[] getIndexedFaceSet_11_201_texCoordIndex_4()
		{
		...
		private double[] getCoordinate_12_201_point_5()
		{
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=8, element #34, 560 total numbers.
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=8, element #34, 560 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=9, element #34, 216 total numbers made up of 72 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_9_35_point()
		{
			MFVec2f TextureCoordinate_9_35_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_9_35_point_1()))
				.append(new MFVec2f(getTextureCoordinate_9_35_point_2()));
			return TextureCoordinate_9_35_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #43, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #43, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #43, 159 total numbers made up of 53 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #52, 472 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #52, 183 total numbers made up of 61 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate
2.7670,2.6760,-1.9840,-2.7470,-0.4534,-1.8470,-1.8790,-0.4111,-1.9100,-1.9140,0.8074,-2.0060,-2.8300,0.7644,-1.8950,-2.7910,1.6970,1.3880,-0.7441,0.9353,1.3560,-1.2340,1.8230,1.2860,-1.3940,3.0040,1.1620,-1.8000,3.6400,1.9100,-1.9140,0.8074,1.8060,-1.8590,1.6880,1.2170,-2.6570,3.7900,1.7290,-2.7670,2.6760,2.0060,-2.8300,0.7644,1.8470,-1.8790,-0.4111,1.9840,-2.7470,-0.4534,1.6500,-1.8680,2.6710,1.8950,-2.7910,1.6970,0.0000,-3.1800,0.7644,-2.0060,-3.1800,0.7644,-1.7290,-3.1370,2.7100,-1.2170,-3.0690,3.7930,0.0000,-2.9970,4.1620,0.0000,-3.1800,-0.4554,-1.9900,-3.1800,-0.4554,1.7290,-3.1370,2.7100,2.0060,-3.1800,0.7644,1.2170,-3.0690,3.7930,1.9900,-3.1800,-0.4554,0.0000,-3.1410,2.7100,-1.8950,-3.1640,1.6860,1.8950,-3.1640,1.6860,0.0000,-3.1640,1.6860,-1.4860,-0.5175,-1.5020,-1.7880,-1.7970,-1.5020,-1.9280,-2.5850,-1.5020,0.0009,0.1637,0.3610,-1.3260,-0.0186,0.0033,1.4860,-0.5175,-1.5020,1.7880,-1.7970,-1.5020,1.9280,-2.5850,-1.5020,1.3310,-0.0112,0.0089,0.0000,-3.1640,-1.5020,-1.9350,-3.1640,-1.5020,1.9340,-3.1640,-1.5020,-1.1530,-0.3082,-2.0150,-1.1920,-1.3880,-2.3790,-1.3070,-1.8760,-2.3630,-1.3070,-2.1290,-2.3560,-0.0004,-2.1290,-2.3560,1.3060,-2.1290,-2.3560,1.3060,-1.8760,-2.3620,1.1910,-1.3880,-2.3780,1.1520,-0.3071,-2.0140,1.0270,0.2573,-1.1730,0.0025,0.3479,-0.8576,-1.0230,0.2519,-1.1790});
			return Coordinate_13_110_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=13, element #111, 232 total numbers made up of 116 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_13_111_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_13_111_point_1()))
				.append(new MFVec2f(getTextureCoordinate_13_111_point_2()));
			return TextureCoordinate_13_111_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #123, 1064 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_9_123_coordIndex()
		{
			MFInt32 IndexedFaceSet_9_123_coordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_9_123_coordIndex_2()));
			return IndexedFaceSet_9_123_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #123, 1064 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_9_123_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_9_123_texCoordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_9_123_texCoordIndex_2()));
			return IndexedFaceSet_9_123_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #123, 588 total numbers made up of 196 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_123_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_123_point_1()))
				.append(new MFVec3f(getCoordinate_10_123_point_2()));
			return Coordinate_10_123_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #124, 448 total numbers made up of 224 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_10_124_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_10_124_point_1()))
				.append(new MFVec2f(getTextureCoordinate_10_124_point_2()))
				.append(new MFVec2f(getTextureCoordinate_10_124_point_3()));
			return TextureCoordinate_10_124_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #132, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #132, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #132, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #141, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #141, 198 total numbers made up of 66 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #162, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #162, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #171, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #171, 198 total numbers made up of 66 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_12_171_point = new MFVec3f(new double[] {-0.8960,-3.4580,-0.7733,-1.4300,-3.2830,0.0723,-1.1630,-7.2700,0.0721,-0.7935,-7.2670,-0.5416,0.0234,-3.8430,-1.1440,0.0262,-7.3000,-0.8983,0.6588,-7.6090,-0.4491,0.7822,-7.0490,-0.4810,0.0250,-7.0700,-0.8149,0.0233,-7.6310,-0.7795,0.9220,-7.6140,0.0729,1.0980,-7.0530,0.0729,0.6588,-7.6120,0.6263,0.7823,-7.0500,0.6527,0.9427,-4.1740,0.8667,0.8457,-7.2800,0.7082,0.0234,-7.2820,1.0660,0.0234,-3.8250,1.2730,0.0233,-7.6230,0.9572,-0.6122,-7.6120,0.6263,-0.7325,-7.0430,0.6513,0.0233,-7.0570,0.9867,-0.8960,-3.4520,0.8897,-0.7936,-7.2660,0.7058,-0.8960,-0.0257,-0.9221,-0.7144,0.4948,-0.6658,-1.0200,0.4948,0.0721,-1.2770,-0.0257,0.0721,0.0236,-0.0257,-1.3340,0.0236,0.4948,-0.9714,0.9432,-0.0257,-0.9221,0.7615,0.4948,-0.6658,1.3240,-0.0257,0.0721,1.0670,0.4948,0.0721,0.9432,-0.0257,0.9219,0.7615,0.4948,0.8099,0.0236,-0.0257,1.3340,0.0236,0.4948,1.1160,-0.8960,-0.0257,0.9219,-0.7144,0.4948,0.8099,0.0236,0.9310,0.0721,-0.6122,-7.6090,-0.4491,-0.8754,-7.6140,0.0729,-0.5830,-8.0860,0.0729,-0.4054,-8.0630,-0.1612,-0.4054,-8.0760,0.3527,0.0233,-8.0830,0.5759,0.4520,-8.0760,0.3527,0.6297,-8.0860,0.0729,0.4520,-8.0630,-0.1612,0.0233,-8.0780,-0.3841,0.0233,-8.4240,0.0729,-1.4030,-0.6344,0.0721,-0.9954,-0.5060,-0.8653,0.0200,-0.5060,-1.2770,0.9426,-4.1790,-0.7253,1.0410,-0.5060,-0.8653,1.4300,-0.6344,0.0721,1.3230,-4.3210,0.0723,1.0180,-0.6344,0.9221,0.0236,-0.6344,1.3340,-0.9707,-0.6344,0.9221,-1.0630,-7.0460,0.0729,-0.7325,-7.0420,-0.4818,0.8456,-7.2810,-0.5402,1.1880,-7.2840,0.0721});
			return Coordinate_12_171_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #172, 176 total numbers made up of 88 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_12_172_point()
		{
			MFVec2f TextureCoordinate_12_172_point = new MFVec2f(new double[] {0.6214,1.7320,0.7319,1.7290,0.7045,1.7300,0.6763,1.7310,0.6737,1.5700,0.6695,1.5810,0.6525,1.5780,0.6596,1.5650,0.6720,1.6480,0.5944,1.7310,0.6690,1.5850,0.6920,1.5850,0.6985,1.6540,0.6909,1.5710,0.7076,1.5680,0.7136,1.5790,0.6917,1.5810,0.7251,1.6600,0.7149,1.5830,0.7334,1.5800,0.5663,1.7330,0.5738,1.6600,0.5479,1.6610,0.7502,1.6610,0.5667,1.5810,0.5849,1.5840,0.6006,1.6550,0.6078,1.5850,0.6259,1.5700,0.6303,1.5810,0.6081,1.5820,0.6088,1.5720,0.6784,1.7200,0.6987,1.7180,0.7150,1.7230,0.7248,1.7380,0.7566,1.7270,0.6922,1.7390,0.7083,1.5530,0.7208,1.5620,0.7017,1.5570,0.6900,1.5610,0.6778,1.5590,0.6394,1.5650,0.6467,1.5780,0.6707,1.5550,0.6891,1.5490,0.5851,1.7220,0.5744,1.7380,0.5383,1.7290,0.6749,1.7190,0.7035,1.7180,0.7320,1.7170,0.7566,1.7150,0.6497,1.5840,0.7300,1.5740,0.6021,1.7170,0.6226,1.7190,0.6477,1.7270,0.6092,1.7390,0.5919,1.5690,0.5792,1.5630,0.5915,1.5540,0.5975,1.5580,0.6219,1.5590,0.6284,1.5560,0.6095,1.5610,0.6103,1.5500,0.5395,1.7160,0.5658,1.7210,0.5946,1.7220,0.6275,1.6480,0.6242,1.7230,0.6504,1.7190,0.6499,1.6450,0.5702,1.5750,0.5861,1.5790,0.6308,1.5860,0.6503,1.7310,0.6767,1.7110,0.7018,1.7100,0.7234,1.7190,0.7395,1.7280,0.5770,1.7120,0.5523,1.7310,0.5995,1.7060,0.6239,1.7090,0.6527,1.7160});
			return TextureCoordinate_12_172_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #192, 1048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #192, 1048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #192, 423 total numbers made up of 141 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=11, element #193, 274 total numbers made up of 137 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=11, element #201, 3104 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_11_201_coordIndex()
		{
			MFInt32 IndexedFaceSet_11_201_coordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_11_201_coordIndex_4()));
			return IndexedFaceSet_11_201_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #201, 3104 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_11_201_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_11_201_texCoordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_11_201_texCoordIndex_4()));
			return IndexedFaceSet_11_201_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #201, 1272 total numbers made up of 424 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec3f getCoordinate_12_201_point()
		{
			MFVec3f Coordinate_12_201_point = new MFVec3f()/*2.finalize*/
				...
				.append(new MFVec3f(getCoordinate_12_201_point_5()));
			return Coordinate_12_201_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #202, 808 total numbers made up of 404 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.KoreanCharacter12Sun self-validation test confirmation: ");

      ...
      .addSkeleton(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,29.860001,-0.456700).setStiffness(new double[] {0.0,0.0,0.0})
        ...
        .addChild(new HAnimJoint("hanim_l_hip").setName("l_hip").setCenter(2.955000,28.940001,-0.521800).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_l_knee").setName("l_knee").setCenter(2.948000,16.459999,-0.527500).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocrural").setCenter(2.839000,3.899000,-0.411600).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(2.839000,3.312000,1.078000).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new Transform().setTranslation(-2.948000,16.459999,-0.527500)
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_90_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_90_texCoordIndex())
                    ...
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.9287,0.3420,0.9261,0.3817,0.9166,0.3743,0.9312,0.2839,0.9471,0.2839,0.9471,0.3395,0.9648,0.2839,0.9653,0.3367,0.9721,0.2839,0.9756,0.3608,0.9668,0.3526,0.9471,0.3496,0.9261,0.3638,0.9239,0.2839,0.9178,0.4416,0.9263,0.4416,0.9323,0.4565,0.9255,0.4565,0.9471,0.4416,0.9471,0.4565,0.9697,0.4416,0.9637,0.4565,0.9783,0.4416,0.9705,0.4565,0.9471,0.4689,0.9320,0.2704,0.9370,0.2704,0.9471,0.2704,0.9590,0.2704,0.9640,0.2704,0.9471,0.2608,0.9261,0.4280,0.9162,0.4243,0.9474,0.4280,0.9471,0.3767,0.9684,0.4280,0.9669,0.3711,0.9771,0.4243,0.9678,0.4243,0.9471,0.4243,0.9259,0.4243,0.9467,0.3066,0.9291,0.3066,0.9659,0.3066,0.9763,0.3066,0.9670,0.3066,0.9459,0.3066,0.9267,0.3066,0.9183,0.3066})))))))
            .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_talocrural").setCenter(-2.839000,3.899000,-0.411600).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(-2.839000,3.312000,1.078000).setStiffness(new double[] {0.0,0.0,0.0})
        ...
        .addChild(new HAnimJoint("hanim_sacroiliac").setName("sacroiliac").setCenter(0.0,29.860001,-0.456700).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_shoulder").setCenter(6.077000,45.880001,-1.319000).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(7.076000,38.529999,-1.385000).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(6.946000,30.889999,-1.308000).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_shoulder").setCenter(-6.077000,45.880001,-1.319000).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_r_elbow").setName("r_elbow").setCenter(-7.076000,38.529999,-1.385000).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(-6.946000,30.889999,-1.308000).setStiffness(new double[] {0.0,0.0,0.0})

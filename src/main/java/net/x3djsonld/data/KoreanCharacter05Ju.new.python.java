...
public class KoreanCharacter05Ju
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Ju").setName("Ju").setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addChild(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,36.0,-0.008798).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})

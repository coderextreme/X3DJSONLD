...
/**
 * <p> Test browser to ignore a reference to a non existing viewpoint. The test should generate some text and a sphere. The sphere is a child of an Anchor node whose url field contains a reference to a viewpoint name that does not exists. The browser should ignore that reference and nothing should happen when the user clicks on the sphere. </p>
 <p> Related links: <a href="../../../../GroupingNodes/Anchor/invalid_viewpoint.java">invalid_viewpoint.java</a> source, <a href="../../../../GroupingNodes/Anchor/invalid_viewpointIndex.html" target="_top">invalid_viewpoint catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GroupingNodes/Anchor/invalid_viewpoint.x3d">invalid_viewpoint.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser to ignore a reference to a non existing viewpoint. The test should generate some text and a sphere. The sphere is a child of an Anchor node whose url field contains a reference to a viewpoint name that does not exists. The browser should ignore that reference and nothing should happen when the user clicks on the sphere. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/invalid_viewpoint.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/invalid_viewpoint.x3d</a> </td>
		</tr>
		<tr>
...
public class invalid_viewpoint
{
	/** Default constructor to create this object. */
	public invalid_viewpoint ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("invalid_viewpoint.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/invalid_viewpoint.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("invalid_viewpoint.x3d"))
    .addChild(new NavigationInfo().setType("\"EXAMINE\" \"WALK\" \"FLY\" \"ANY\""))
    .addChild(new Viewpoint("view1").setDescription("Initial viewpoint").setPosition(0.0,0.0,25.0))
    .addChild(new Viewpoint("view2").setDescription("Referenced viewpoint").setPosition(0.0,0.0,21.0))
    .addChild(new Transform().setTranslation(0.0,4.0,0.0)
      .addChild(new Shape()
        ...
        .setGeometry(new Text().setString(new String[] {"WHEN YOU CLICK ON THE SPHERE","BELOW NOTHING SHOULD HAPPEN"})
          .setFontStyle(new FontStyle().setJustify(FontStyle.JUSTIFY_MIDDLE_MIDDLE)))))
    .addChild(new Anchor().setDescription("bookmark url with non-existing viewpoint name").setUrl(new String[] {"#view3IncorrectName"})
      .addChild(new Shape()
        .setAppearance(new Appearance()
	 ...
	 * @return invalid_viewpoint model
	 */
    ...
    {
        X3D thisExampleX3dModel = new invalid_viewpoint().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.invalid_viewpoint\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.invalid_viewpoint\" self-validation test results: ");

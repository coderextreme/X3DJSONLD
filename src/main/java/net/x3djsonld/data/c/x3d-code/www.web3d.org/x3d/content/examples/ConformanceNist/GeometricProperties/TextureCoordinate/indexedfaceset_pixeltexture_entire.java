...
public class indexedfaceset_pixeltexture_entire
{
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("indexedfaceset_pixeltexture_entire.x3d"))
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.indexedfaceset_pixeltexture_entire\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.indexedfaceset_pixeltexture_entire\" self-validation test results: ");

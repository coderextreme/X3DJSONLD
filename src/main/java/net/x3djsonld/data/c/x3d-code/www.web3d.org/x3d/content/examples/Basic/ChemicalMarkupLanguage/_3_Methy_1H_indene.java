...
public class _3_Methy_1H_indene
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of _3-methyl-1h-indene.x3d scene produced from _3-methyl-1h-indene.xml Chemical Markup Language (CML) source file."))
  ...
  .setScene(new Scene()
    ...
    {
        X3D thisExampleX3dModel = new _3_Methy_1H_indene().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data._3_Methy_1H_indene\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data._3_Methy_1H_indene\" self-validation test results: ");

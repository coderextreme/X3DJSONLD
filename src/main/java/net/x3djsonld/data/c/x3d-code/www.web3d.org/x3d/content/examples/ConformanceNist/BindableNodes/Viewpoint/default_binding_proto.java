...
/**
 * <p> Test a PROTO Viewpoint. A Viewpoint node is defined inside a PROTO definition in this world. That PROTO is then instantiated in the world. The result should be: that Viewpoint should be bound to the Viewpoint stack. A RIGHT side Viewpoint node is defined inside A PROTO definition, then instantiated in the world file. As a result, the viewer should see a cubic geometry with the word RIGHT displayed on its face, and Text geometry at the bottom of the world indicating that the Viewpoint position is 10 0 0. </p>
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/default_binding_proto.java">default_binding_proto.java</a> source, <a href="../../../../BindableNodes/Viewpoint/default_binding_protoIndex.html" target="_top">default_binding_proto catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/default_binding_proto.x3d">default_binding_proto.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../BindableNodes/Viewpoint/default_binding_proto-front.jpg">default_binding_proto-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test a PROTO Viewpoint. A Viewpoint node is defined inside a PROTO definition in this world. That PROTO is then instantiated in the world. The result should be: that Viewpoint should be bound to the Viewpoint stack. A RIGHT side Viewpoint node is defined inside A PROTO definition, then instantiated in the world file. As a result, the viewer should see a cubic geometry with the word RIGHT displayed on its face, and Text geometry at the bottom of the world indicating that the Viewpoint position is 10 0 0. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_proto.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_proto.x3d</a> </td>
		</tr>
		<tr>
...
public class default_binding_proto
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("default_binding_proto-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test a PROTO Viewpoint. A Viewpoint node is defined inside a PROTO definition in this world. That PROTO is then instantiated in the world. The result should be: that Viewpoint should be bound to the Viewpoint stack. A RIGHT side Viewpoint node is defined inside A PROTO definition, then instantiated in the world file. As a result, the viewer should see a cubic geometry with the word RIGHT displayed on its face, and Text geometry at the bottom of the world indicating that the Viewpoint position is 10 0 0."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_proto.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("default_binding_proto.x3d"))
    .addChild(new ProtoDeclare("ViewProto").setName("ViewProto")
    ...
    .addChild(new ProtoInstance("ViewProto", "VIEW1").setContainerField("children"))
    ...
    .addChild(new Shape()
      ...
      .setGeometry(new IndexedFaceSet().setCoordIndex(new int[] {0,6,7,1,-1}).setTexCoordIndex(new int[] {3,0,1,2,-1})
        .setCoord(new Coordinate().setUSE("UnitCube"))
        .setTexCoord(new TextureCoordinate().setUSE("SquareTexCoord"))))
    .addChild(new Script("AVATARSCRIPT").setDirectOutput(true).setUrl(new String[] {"default_binding_proto.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_proto.js"})

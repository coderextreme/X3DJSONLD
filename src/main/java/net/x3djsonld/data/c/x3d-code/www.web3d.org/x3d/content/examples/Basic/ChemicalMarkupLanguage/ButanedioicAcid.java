...
/**
 * <p> Autogenerated version of ButanedioicAcid.x3d scene produced from ButanedioicAcid.xml Chemical Markup Language (CML) version 1.0 source file. </p>
 <p> Related links: <a href="../../../ChemicalMarkupLanguage/ButanedioicAcid.java">ButanedioicAcid.java</a> source, <a href="../../../ChemicalMarkupLanguage/ButanedioicAcidIndex.html" target="_top">ButanedioicAcid catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../ChemicalMarkupLanguage/ButanedioicAcid.x3d">ButanedioicAcid.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> Autogenerated version of ButanedioicAcid.x3d scene produced from ButanedioicAcid.xml Chemical Markup Language (CML) version 1.0 source file. </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="../../../ChemicalMarkupLanguage/ButanedioicAcid.xml">ButanedioicAcid.xml</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/ButanedioicAcid.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/ButanedioicAcid.x3d</a> </td>
		</tr>
		<tr>
...
public class ButanedioicAcid
{
	/** Default constructor to create this object. */
	public ButanedioicAcid ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("ButanedioicAcid.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of ButanedioicAcid.x3d scene produced from ButanedioicAcid.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ButanedioicAcid.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/ButanedioicAcid.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("ButanedioicAcid.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect ButanedioicAcid").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"Butanedioic Acid: C4 H6 O4"}))))
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"molecule weight: 118.09"}))))
      .addChild(new Transform().setTranslation(0.0,4.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"melting point: 185"}))))
      .addChild(new Transform().setTranslation(0.0,3.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"boiling point: 235"}))))
      .addChild(new Transform().setTranslation(0.0,2.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"specific gravity: 1.6"})))))
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "butanedioic_acid_a1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.1343,0.9978,1.7414)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "butanedioic_acid_a2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.966,2.1001,1.1065)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "butanedioic_acid_a3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.6854,1.0825,1.3399)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "butanedioic_acid_a4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(5.4133,2.0195,1.5145)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "butanedioic_acid_a5").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.8984,0.1193,1.8759)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "butanedioic_acid_a6").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.1213,1.8803,0.6125)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "butanedioic_acid_a7").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(6.2033,2.9753,0.9693)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "butanedioic_acid_a8").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(5.9743,1.2314,2.2546))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "butanedioic_acid_b1").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.1343,0.9978,1.7414,3.966,2.1001,1.1065})))))
      .addChild(new ProtoInstance("line", "butanedioic_acid_b2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.1343,0.9978,1.7414,1.6854,1.0825,1.3399})))))
      .addChild(new ProtoInstance("line", "Butanedioic_Acid_b5").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.966,2.1001,1.1065,5.4133,2.0195,1.5145})))))
      .addChild(new ProtoInstance("line", "butanedioic_acid_b8").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.6854,1.0825,1.3399,0.8984,0.1193,1.8759})))))
      .addChild(new ProtoInstance("line", "butanedioic_acid_b9").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.6654,1.0825,1.3399,1.1013,1.8803,0.6125})))))
      .addChild(new ProtoInstance("line", "butanedioic_acid_b9_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.7054,1.0825,1.3399,1.1413,1.8803,0.6125})))))
      .addChild(new ProtoInstance("line", "butanedioic_acid_b10").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {5.4133,2.0195,1.5145,6.2033,2.9753,0.9693})))))
      .addChild(new ProtoInstance("line", "butanedioic_acid_b11").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {5.3933,2.0195,1.5145,5.954300000000001,1.2314,2.2546})))))
      .addChild(new ProtoInstance("line", "butanedioic_acid_b11_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {5.433299999999999,2.0195,1.5145,5.9943,1.2314,2.2546})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new ButanedioicAcid().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.ButanedioicAcid\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.ButanedioicAcid\" self-validation test results: ");

 ...
 * <p> This test addresses the effect of the DirectionalLight ambientIntensity on the ambient of a simple object (Sphere). Two spheres are drawn in the local coordinate system and a DirectionaLight is defined to shine on them along the -Z axis. The sphere to the left contains an ambientIntensity 0.3 and the sphere to the right contains an initial ambientIntensity of 1 The ambientIntensity of the light is increased on both spheres as the animation progresses. Since both materials ambientIntensity are constants, at the end of the animation the one to the right will be brigther than the one to the left. This is because at the end of the animation the sphere to the right will have maximum ambient (both material and light ambientIntensity will be 1). </p>
 <p> Related links: <a href="../../../../Lights/DirectionalLight/test_ambeffect_ambientsim.java">test_ambeffect_ambientsim.java</a> source, <a href="../../../../Lights/DirectionalLight/test_ambeffect_ambientsimIndex.html" target="_top">test_ambeffect_ambientsim catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/DirectionalLight/test_ambeffect_ambientsim.x3d">test_ambeffect_ambientsim.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/test-ambeffect-ambientsim-movie.mpg">test-ambeffect-ambientsim-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_ambeffect_ambientsim.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_ambeffect_ambientsim.x3d</a> </td>
		</tr>
		<tr>
...
public class test_ambeffect_ambientsim
{
	/** Default constructor to create this object. */
	public test_ambeffect_ambientsim ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_ambeffect_ambientsim.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("test-ambeffect-ambientsim-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_ambeffect_ambientsim.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_ambeffect_ambientsim.x3d"))
    .addChild(new Group()
    ...
    .addChild(new Transform().setScale(0.02,0.02,0.02).setTranslation(-3.4,2.0,0.0)
      .addChild(new Shape()
    ...
    .addChild(new Group()
      .addChild(new DirectionalLight("the-light").setAmbientIntensity(0.1).setIntensity(0.5))
	 ...
	 * @return test_ambeffect_ambientsim model
	 */
    ...
    {
        X3D thisExampleX3dModel = new test_ambeffect_ambientsim().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_ambeffect_ambientsim\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_ambeffect_ambientsim\" self-validation test results: ");

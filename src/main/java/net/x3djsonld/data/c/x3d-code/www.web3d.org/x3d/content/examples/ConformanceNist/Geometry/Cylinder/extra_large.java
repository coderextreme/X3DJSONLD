...
/**
 * <p> An extra large cylinder that tests the upper boundary condition. We have specified a viewpoint to keep the test results from being undefined. </p>
 <p> Related links: <a href="../../../../Geometry/Cylinder/extra_large.java">extra_large.java</a> source, <a href="../../../../Geometry/Cylinder/extra_largeIndex.html" target="_top">extra_large catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Cylinder/extra_large.x3d">extra_large.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> An extra large cylinder that tests the upper boundary condition. We have specified a viewpoint to keep the test results from being undefined. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/extra_large.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/extra_large.x3d</a> </td>
		</tr>
		<tr>
...
public class extra_large
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("extra_large.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("An extra large cylinder that tests the upper boundary condition. We have specified a viewpoint to keep the test results from being undefined."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/extra_large.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("extra_large.x3d"))
    .addChild(new NavigationInfo().setType("\"EXAMINE\" \"WALK\" \"FLY\" \"ANY\""))
    .addChild(new Viewpoint().setDescription("extra-large.x3d").setPosition(0.0,0.0,20000.0))
    .addChild(new Shape()
      .setAppearance(new Appearance()
        .setMaterial(new Material()))
      .setGeometry(new Cylinder().setHeight(5000).setRadius(5000))));
    }
    ...
    {
        X3D thisExampleX3dModel = new extra_large().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.extra_large\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.extra_large\" self-validation test results: ");

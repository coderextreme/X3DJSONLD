 ...
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/default_binding_single.java">default_binding_single.java</a> source, <a href="../../../../BindableNodes/Viewpoint/default_binding_singleIndex.html" target="_top">default_binding_single catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/default_binding_single.x3d">default_binding_single.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../BindableNodes/Viewpoint/default_binding_single-front.jpg">default_binding_single-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test a single bound Viewpoint. A single Viewpoint node is present in this world. Because it is the first and only Viewpoint in this world, it should be bound to the top of the Viewpoint stack. As a result, the viewer should get a REAR view of a cubic geometry, with the word REAR appearing on the back face of the cube. In addition, Text at the bottom of the world should indicate the viewers position to be 0 0 -1 (behind the cube). </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_single.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_single.x3d</a> </td>
		</tr>
		<tr>
...
public class default_binding_single
{
	/** Default constructor to create this object. */
	public default_binding_single ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("default_binding_single.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("default_binding_single-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test a single bound Viewpoint. A single Viewpoint node is present in this world. Because it is the first and only Viewpoint in this world, it should be bound to the top of the Viewpoint stack. As a result, the viewer should get a REAR view of a cubic geometry, with the word REAR appearing on the back face of the cube. In addition, Text at the bottom of the world should indicate the viewers position to be 0 0 -1 (behind the cube)."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_single.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("default_binding_single.x3d"))
    .addChild(new NavigationInfo().setType("\"EXAMINE\""))
    .addChild(new Viewpoint().setDescription("Front View").setOrientation(0.0,1.0,0.0,3.14159).setPosition(0.0,0.0,-10.0))
      ...
      .addChild(new Transform().setTranslation(-10.0,-5.0,-20.0)
        .addChild(new Shape()
          ...
          .setGeometry(new Text("TYPESTRING1").setString(new String[] {"message from Script is inserted here"})
            .setFontStyle(new FontStyle().setCssStyle("BOLD"))))))
    .addChild(new Script("AVATARSCRIPT").setDirectOutput(true).setUrl(new String[] {"default_binding_single.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_single.js"})
	 ...
	 * @return default_binding_single model
	 */
    ...
    {
        X3D thisExampleX3dModel = new default_binding_single().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.default_binding_single\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.default_binding_single\" self-validation test results: ");

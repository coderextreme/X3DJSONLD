...
/**
 * <p> A TouchSensor is associated with a white Sphere geometry. The enabled field is set to false. Because the TouchSensor is disabled, it will not generate fields when the pointing device is over the white Sphere, or when the pointing device indicates the geometry. As a result, the isActive event routed to the "on" field of a PointLight will not turn the light on when the pointing device indicates the white Sphere geometry. </p>
 <p> Related links: <a href="../../../../Sensors/TouchSensor/enabled.java">enabled.java</a> source, <a href="../../../../Sensors/TouchSensor/enabledIndex.html" target="_top">enabled catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/TouchSensor/enabled.x3d">enabled.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/TouchSensor/enabled-movie.mpg">enabled-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> A TouchSensor is associated with a white Sphere geometry. The enabled field is set to false. Because the TouchSensor is disabled, it will not generate fields when the pointing device is over the white Sphere, or when the pointing device indicates the geometry. As a result, the isActive event routed to the "on" field of a PointLight will not turn the light on when the pointing device indicates the white Sphere geometry. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/enabled.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/enabled.x3d</a> </td>
		</tr>
		<tr>
...
public class enabled
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("A TouchSensor is associated with a white Sphere geometry. The enabled field is set to false. Because the TouchSensor is disabled, it will not generate fields when the pointing device is over the white Sphere, or when the pointing device indicates the geometry. As a result, the isActive event routed to the \"on\" field of a PointLight will not turn the light on when the pointing device indicates the white Sphere geometry."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/enabled.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Group()
      ...
      .addChild(new Transform().setTranslation(0.0,-2.0,0.0)
        .addChild(new Shape().setUSE("BALL")))
      .addChild(new Group()
        .addChild(new TouchSensor("TOUCH").setEnabled(false))

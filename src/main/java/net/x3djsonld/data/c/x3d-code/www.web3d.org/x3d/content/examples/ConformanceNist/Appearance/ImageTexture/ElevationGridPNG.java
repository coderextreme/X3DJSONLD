...
/**
 * <p> Map a PNG image to an ElevationGrid. An ElevationGrid is default texture mapped by aligning the S (horizontal) axis of the VTS logo with the X axis of the ElevationGrid and the T (vertical) axis of the VTS logo with the Z axis of the ElevationGrid. The bottom of the VTS logo coincides with the first row of grid points and the top of the VTS logo maps to the last row of grid points. </p>
 <p> Related links: <a href="../../../../Appearance/ImageTexture/ElevationGridPNG.java">ElevationGridPNG.java</a> source, <a href="../../../../Appearance/ImageTexture/ElevationGridPNGIndex.html" target="_top">ElevationGridPNG catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/ImageTexture/ElevationGridPNG.x3d">ElevationGridPNG.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/ElevationGridPNG-front.jpg">ElevationGridPNG-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/ElevationGridPNG-rear.jpg">ElevationGridPNG-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/ElevationGridPNG-top.jpg">ElevationGridPNG-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/ElevationGridPNG-bottom.jpg">ElevationGridPNG-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/ElevationGridPNG-left.jpg">ElevationGridPNG-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/ElevationGridPNG-right.jpg">ElevationGridPNG-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Map a PNG image to an ElevationGrid. An ElevationGrid is default texture mapped by aligning the S (horizontal) axis of the VTS logo with the X axis of the ElevationGrid and the T (vertical) axis of the VTS logo with the Z axis of the ElevationGrid. The bottom of the VTS logo coincides with the first row of grid points and the top of the VTS logo maps to the last row of grid points </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/ElevationGridPNG.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/ElevationGridPNG.x3d</a> </td>
		</tr>
		<tr>
...
public class ElevationGridPNG
{
	/** Default constructor to create this object. */
	public ElevationGridPNG ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("ElevationGridPNG.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("ElevationGridPNG-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("ElevationGridPNG-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("ElevationGridPNG-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("ElevationGridPNG-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("ElevationGridPNG-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("ElevationGridPNG-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Map a PNG image to an ElevationGrid. An ElevationGrid is default texture mapped by aligning the S (horizontal) axis of the VTS logo with the X axis of the ElevationGrid and the T (vertical) axis of the VTS logo with the Z axis of the ElevationGrid. The bottom of the VTS logo coincides with the first row of grid points and the top of the VTS logo maps to the last row of grid points"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/ElevationGridPNG.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("ElevationGridPNG.x3d"))
    ...
    {
        X3D thisExampleX3dModel = new ElevationGridPNG().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.ElevationGridPNG\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.ElevationGridPNG\" self-validation test results: ");

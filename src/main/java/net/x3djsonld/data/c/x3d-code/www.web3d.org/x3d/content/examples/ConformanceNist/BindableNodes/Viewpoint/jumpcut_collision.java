...
/**
 * <p> Test jumpcut transition with a Collision node. This world contains a collision node that should NOT send events during a jumpcut. The initial Viewpoint in this world is in front of a red Box geometry. A second Viewpoint exists BEHIND the red Box geometry. Indicating the Box with the pointing device should cause a "jumpcut" from the front to rear Viewpoint. During this jumcput, collision detection should be disabled. As a result, the Box geometry should remain a red color, indicating that no collision detection took place during the jumpcut. If the red Box turns yellow, then that indicates that collision detection occured during the jumpcut, and the browser fails the test. </p>
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/jumpcut_collision.java">jumpcut_collision.java</a> source, <a href="../../../../BindableNodes/Viewpoint/jumpcut_collisionIndex.html" target="_top">jumpcut_collision catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/jumpcut_collision.x3d">jumpcut_collision.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test jumpcut transition with a Collision node. This world contains a collision node that should NOT send events during a jumpcut. The initial Viewpoint in this world is in front of a red Box geometry. A second Viewpoint exists BEHIND the red Box geometry. Indicating the Box with the pointing device should cause a "jumpcut" from the front to rear Viewpoint. During this jumcput, collision detection should be disabled. As a result, the Box geometry should remain a red color, indicating that no collision detection took place during the jumpcut. If the red Box turns yellow, then that indicates that collision detection occured during the jumpcut, and the browser fails the test. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_collision.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_collision.x3d</a> </td>
		</tr>
		<tr>
...
public class jumpcut_collision
{
	/** Default constructor to create this object. */
	public jumpcut_collision ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("jumpcut_collision.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test jumpcut transition with a Collision node. This world contains a collision node that should NOT send events during a jumpcut. The initial Viewpoint in this world is in front of a red Box geometry. A second Viewpoint exists BEHIND the red Box geometry. Indicating the Box with the pointing device should cause a \"jumpcut\" from the front to rear Viewpoint. During this jumcput, collision detection should be disabled. As a result, the Box geometry should remain a red color, indicating that no collision detection took place during the jumpcut. If the red Box turns yellow, then that indicates that collision detection occured during the jumpcut, and the browser fails the test."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_collision.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("jumpcut_collision.x3d"))
    ...
    .addChild(new Viewpoint("VIEW2").setDescription("Behind Origin").setPosition(0.0,0.0,-20.0))
    ...
    .addChild(new Transform("TRANS2").setTranslation(0.0,0.0,-100.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material("BOX2").setDiffuseColor(0.0,1.0,1.0)))
	 ...
	 * @return jumpcut_collision model
	 */
    ...
    {
        X3D thisExampleX3dModel = new jumpcut_collision().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.jumpcut_collision\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.jumpcut_collision\" self-validation test results: ");

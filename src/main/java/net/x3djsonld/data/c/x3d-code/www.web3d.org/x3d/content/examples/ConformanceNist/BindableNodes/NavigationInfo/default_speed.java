...
/**
 * <p> Test default speed. A NavigationInfo node with a default speed field should result in a navigation speed of 1 meter per second for browser average/default speed, when the browser speed control is set to "normal". The speed is measured in the same root coordinate system of the Viewpoint node, to which the NavigationInfo node is parented. </p>
 <p> Related links: <a href="../../../../BindableNodes/NavigationInfo/default_speed.java">default_speed.java</a> source, <a href="../../../../BindableNodes/NavigationInfo/default_speedIndex.html" target="_top">default_speed catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/NavigationInfo/default_speed.x3d">default_speed.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test default speed. A NavigationInfo node with a default speed field should result in a navigation speed of 1 meter per second for browser average/default speed, when the browser speed control is set to "normal". The speed is measured in the same root coordinate system of the Viewpoint node, to which the NavigationInfo node is parented. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/default_speed.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/default_speed.x3d</a> </td>
		</tr>
		<tr>
...
public class default_speed
{
	/** Default constructor to create this object. */
	public default_speed ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("default_speed.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test default speed. A NavigationInfo node with a default speed field should result in a navigation speed of 1 meter per second for browser average/default speed, when the browser speed control is set to \"normal\". The speed is measured in the same root coordinate system of the Viewpoint node, to which the NavigationInfo node is parented."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/default_speed.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("default_speed.x3d"))
    ...
    .addChild(new Transform("TRANS1")
      .addChild(new Transform().setTranslation(-0.5,-0.4,-1.0)
        .addChild(new Shape()
    ...
    .addChild(new Script("AVATARSCRIPT").setDirectOutput(true).setUrl(new String[] {"default_speed.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/default_speed.js"})
    ...
    .addChild(new ROUTE().setFromNode("TIME").setFromField("cycleTime").setToNode("AVATARSCRIPT").setToField("printZero"))
    .addChild(new ROUTE().setFromNode("PROX_SENSOR").setFromField("position_changed").setToNode("AVATARSCRIPT").setToField("printSpeed"))
    ...
    {
        X3D thisExampleX3dModel = new default_speed().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.default_speed\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.default_speed\" self-validation test results: ");

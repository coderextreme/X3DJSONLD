 ...
 <p> Related links: <a href="../../../../Appearance/ImageTexture/threesides.java">threesides.java</a> source, <a href="../../../../Appearance/ImageTexture/threesidesIndex.html" target="_top">threesides catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/ImageTexture/threesides.x3d">threesides.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/3sides-front.jpg">3sides-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/3sides-rear.jpg">3sides-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/3sides-top.jpg">3sides-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/3sides-bottom.jpg">3sides-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/3sides-left.jpg">3sides-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/3sides-right.jpg">3sides-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test JPG texture mapping to 3 equal length sides of a bounding box. The bounding box for this geometry is equal length on all sides. By default the JPG ImageTexture should map the S (horizontal) axis to the X axis, and the T (vertical) axis to the Y axis. IndexedFaceSet. All remaining faces have the "smeared" end pixels of the front and rear textures. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/threesides.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/threesides.x3d</a> </td>
		</tr>
		<tr>
...
public class threesides
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test JPG texture mapping to 3 equal length sides of a bounding box. The bounding box for this geometry is equal length on all sides. By default the JPG ImageTexture should map the S (horizontal) axis to the X axis, and the T (vertical) axis to the Y axis. IndexedFaceSet. All remaining faces have the \"smeared\" end pixels of the front and rear textures."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/threesides.x3d"))

...
/**
 * <p> Test hitTexCoord field. The right Box geometry has a TouchSensor associated with it. the TexCoord_changed field of the right TouchSensor is routed to the translation field of a TextureTransform node associated with the left Box. As a result, passing the pointing device over any of the right Box faces should result in a translation of the intersection of the pointing device and the right Box texture should correspond to the lower left texture coordinate of the translated texture on any of the faces of the left Box. </p>
 <p> Related links: <a href="../../../../Sensors/TouchSensor/hittexcoord.java">hittexcoord.java</a> source, <a href="../../../../Sensors/TouchSensor/hittexcoordIndex.html" target="_top">hittexcoord catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/TouchSensor/hittexcoord.x3d">hittexcoord.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/TouchSensor/hittexcoord-movie.mpg">hittexcoord-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test hitTexCoord field. The right Box geometry has a TouchSensor associated with it. the TexCoord_changed field of the right TouchSensor is routed to the translation field of a TextureTransform node associated with the left Box. As a result, passing the pointing device over any of the right Box faces should result in a translation of the intersection of the pointing device and the right Box texture should correspond to the lower left texture coordinate of the translated texture on any of the faces of the left Box. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/hittexcoord.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/hittexcoord.x3d</a> </td>
		</tr>
		<tr>
...
public class hittexcoord
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("hittexcoord.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("hittexcoord-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test hitTexCoord field. The right Box geometry has a TouchSensor associated with it. the TexCoord_changed field of the right TouchSensor is routed to the translation field of a TextureTransform node associated with the left Box. As a result, passing the pointing device over any of the right Box faces should result in a translation of the intersection of the pointing device and the right Box texture should correspond to the lower left texture coordinate of the translated texture on any of the faces of the left Box."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/hittexcoord.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("hittexcoord.x3d"))
    ...
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new Transform().setTranslation(2.0,0.0,0.0)
          .addChild(new TouchSensor("TCHSENSOR"))
          .addChild(new Shape()
        ...
        .addChild(new Transform().setTranslation(-2.0,0.0,0.0)
          .addChild(new Shape()
            .setAppearance(new Appearance()
              ...
              .setTextureTransform(new TextureTransform("MYTEXT"))
              .setMaterial(new Material()))
            .setGeometry(new Box())))))
    .addChild(new ROUTE().setFromNode("TCHSENSOR").setFromField("hitTexCoord_changed").setToNode("MYTEXT").setToField("set_translation")));
    }
    ...
    {
        X3D thisExampleX3dModel = new hittexcoord().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.hittexcoord\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.hittexcoord\" self-validation test results: ");

...
public class PhysicalUnitRepresentationPrototypes
{
	...
	public PhysicalUnitRepresentationPrototypes ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("PhysicalUnitRepresentationPrototypes.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Prototypes to demonstrate functionality for Real-Length Representation nodes."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("Myeon Won Lee and Sun-Young Cho, \"Real Length Representation for Virtual Objects,\" point paper, University of Suwon, Korea, June 2007."))
    .addMeta(new meta().setName(meta.NAME_SUBJECT    ).setContent("X3D scaling and metadata convenience nodes"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/development/PhysicalUnitRepresentationPrototypes.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addComments(" ==================== ")
    .addComments(" Initial approach: direct scaling ")
    .addChild(new WorldInfo().setTitle("PhysicalUnitRepresentationPrototypes.x3d"))
    .addChild(new Transform("MyZeptoScale").setScale(1.0E-10,1.0E-10,1.0E-10)
      .addChild(new Transform().setScale(1.0E-11,1.0E-11,1.0E-11)
        .setMetadata(new MetadataString().setName("lengthUnit").setValue(new String[] {"ZEPTO meters"}))
    ...
    .addComments(" ==================== ")
    .addChild(new ProtoDeclare("ZeptoScale").setName("ZeptoScale").setAppinfo("ZeptoScale applies a uniform scale factor of 10^-21 to all children")
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Transform("ZeptoScale").setScale(1.0E-10,1.0E-10,1.0E-10)
          .addChild(new Transform().setScale(1.0E-11,1.0E-11,1.0E-11)
            .setIS(new IS()
    ...
    .addChild(new ProtoInstance("ZeptoScale").setContainerField("children")
    ...
    {
        X3D thisExampleX3dModel = new PhysicalUnitRepresentationPrototypes().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.PhysicalUnitRepresentationPrototypes\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.PhysicalUnitRepresentationPrototypes\" self-validation test results: ");

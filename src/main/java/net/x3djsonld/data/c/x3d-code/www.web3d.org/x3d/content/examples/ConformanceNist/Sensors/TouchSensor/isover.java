...
/**
 * <p> Test if a TouchSensor generates an isOver true event when the pointing device bearing intersects the white Sphere geometry. The isOver event of the TouchSensor associated with the white Sphere is routed to the "on" field of a PointLight. When the pointing device is over the central white sphere, the PointLight inside of sphere should turn on, illuminating the red Spheres around it. When the pointing device bearing does not intersect the white Sphere, the PointLight should be off. </p>
 <p> Related links: <a href="../../../../Sensors/TouchSensor/isover.java">isover.java</a> source, <a href="../../../../Sensors/TouchSensor/isoverIndex.html" target="_top">isover catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/TouchSensor/isover.x3d">isover.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/TouchSensor/isover-movie.mpg">isover-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test if a TouchSensor generates an isOver true event when the pointing device bearing intersects the white Sphere geometry. The isOver event of the TouchSensor associated with the white Sphere is routed to the "on" field of a PointLight. When the pointing device is over the central white sphere, the PointLight inside of sphere should turn on, illuminating the red Spheres around it. When the pointing device bearing does not intersect the white Sphere, the PointLight should be off. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/isover.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/isover.x3d</a> </td>
		</tr>
		<tr>
...
public class isover
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("isover.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("isover-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test if a TouchSensor generates an isOver true event when the pointing device bearing intersects the white Sphere geometry. The isOver event of the TouchSensor associated with the white Sphere is routed to the \"on\" field of a PointLight. When the pointing device is over the central white sphere, the PointLight inside of sphere should turn on, illuminating the red Spheres around it. When the pointing device bearing does not intersect the white Sphere, the PointLight should be off."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/isover.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("isover.x3d"))
    ...
    {
        X3D thisExampleX3dModel = new isover().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.isover\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.isover\" self-validation test results: ");

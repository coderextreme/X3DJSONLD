...
/**
 * <p> Test browser ability to completely map one MovieTexture onto the surface of an IndexedFaceSet geometry. The entire "VTS" logo MovieTexture should map once onto the surface of the IndexedFaceSet, with the S (horizontal) axis of the texture corresponding to the X axis of the geometry. </p>
 <p> Related links: <a href="../../../../GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_entire.java">indexedfaceset_movietexture_entire.java</a> source, <a href="../../../../GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_entireIndex.html" target="_top">indexedfaceset_movietexture_entire catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_entire.x3d">indexedfaceset_movietexture_entire.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser ability to completely map one MovieTexture onto the surface of an IndexedFaceSet geometry. The entire "VTS" logo MovieTexture should map once onto the surface of the IndexedFaceSet, with the S (horizontal) axis of the texture corresponding to the X axis of the geometry. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_entire.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_entire.x3d</a> </td>
		</tr>
		<tr>
...
public class indexedfaceset_movietexture_entire
{
	/** Default constructor to create this object. */
	public indexedfaceset_movietexture_entire ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("indexedfaceset_movietexture_entire.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test browser ability to completely map one MovieTexture onto the surface of an IndexedFaceSet geometry. The entire \"VTS\" logo MovieTexture should map once onto the surface of the IndexedFaceSet, with the S (horizontal) axis of the texture corresponding to the X axis of the geometry."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_entire.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("indexedfaceset_movietexture_entire.x3d"))
    ...
    .addChild(new Shape()
      .setAppearance(new Appearance()
        ...
        .setTexture(new MovieTexture().setLoop(true).setRepeatS(false).setRepeatT(false).setSpeed(5).setUrl(new String[] {"vts.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/vts.mpg"})))
	 ...
	 * @return indexedfaceset_movietexture_entire model
	 */
    ...
    {
        X3D thisExampleX3dModel = new indexedfaceset_movietexture_entire().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.indexedfaceset_movietexture_entire\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.indexedfaceset_movietexture_entire\" self-validation test results: ");

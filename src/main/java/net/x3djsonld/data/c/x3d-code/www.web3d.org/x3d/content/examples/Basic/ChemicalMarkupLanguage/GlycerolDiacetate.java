...
/**
 * <p> Autogenerated version of GlycerolDiacetate.x3d scene produced from GlycerolDiacetate.xml Chemical Markup Language (CML) version 1.0 source file. </p>
 <p> Related links: <a href="../../../ChemicalMarkupLanguage/GlycerolDiacetate.java">GlycerolDiacetate.java</a> source, <a href="../../../ChemicalMarkupLanguage/GlycerolDiacetateIndex.html" target="_top">GlycerolDiacetate catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../ChemicalMarkupLanguage/GlycerolDiacetate.x3d">GlycerolDiacetate.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> Autogenerated version of GlycerolDiacetate.x3d scene produced from GlycerolDiacetate.xml Chemical Markup Language (CML) version 1.0 source file. </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="../../../ChemicalMarkupLanguage/GlycerolDiacetate.xml">GlycerolDiacetate.xml</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/GlycerolDiacetate.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/GlycerolDiacetate.x3d</a> </td>
		</tr>
		<tr>
...
public class GlycerolDiacetate
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("GlycerolDiacetate.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of GlycerolDiacetate.x3d scene produced from GlycerolDiacetate.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("GlycerolDiacetate.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/GlycerolDiacetate.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("GlycerolDiacetate.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect GlycerolDiacetate").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"Glycerol Diacetate: C7 H12 O5"}))))
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"molecule weight: 176.17"}))))
      .addChild(new Transform().setTranslation(0.0,4.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"melting point: -30"}))))
      .addChild(new Transform().setTranslation(0.0,3.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"boiling point: 259"}))))
      .addChild(new Transform().setTranslation(0.0,2.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"specific gravity: 1.18"})))))
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "glycerol_diacetate_a1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.2922,1.7366,0.9637)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "glycerol_diacetate_a2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.2046,1.2077,1.9255)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "glycerol_diacetate_a3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.2922,2.3736,2.3677)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "glycerol_diacetate_a4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.4655,0.1545,1.3504)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "glycerol_diacetate_a5").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(4.3235,0.8189,0.7374)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "glycerol_diacetate_a6").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.4626,2.0481,3.4462))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "glycerol_diacetate_b1").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.2922,1.7366,0.9637,2.2046,1.2077,1.9255})))))
      .addChild(new ProtoInstance("line", "glycerol_diacetate_b2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.2922,1.7366,0.9637,4.3235,0.8189,0.7374})))))
      .addChild(new ProtoInstance("line", "glycerol_diacetate_b5").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.2046,1.2077,1.9255,1.2922,2.3736,2.3677})))))
      .addChild(new ProtoInstance("line", "glycerol_diacetate_b6").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.2046,1.2077,1.9255,1.4655,0.1545,1.3504})))))
      .addChild(new ProtoInstance("line", "glycerol_diacetate_b8").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.2922,2.3736,2.3677,0.4626,2.0481,3.4462})))))));
    }
	 ...
	 * @return GlycerolDiacetate model
	 */
    ...
    {
        X3D thisExampleX3dModel = new GlycerolDiacetate().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.GlycerolDiacetate\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.GlycerolDiacetate\" self-validation test results: ");

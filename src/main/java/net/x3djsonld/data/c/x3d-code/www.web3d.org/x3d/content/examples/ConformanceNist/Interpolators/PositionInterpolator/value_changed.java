 ...
 <p> Related links: <a href="../../../../Interpolators/PositionInterpolator/value_changed.java">value_changed.java</a> source, <a href="../../../../Interpolators/PositionInterpolator/value_changedIndex.html" target="_top">value_changed catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Interpolators/PositionInterpolator/value_changed.x3d">value_changed.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Interpolators/PositionInterpolator/value_changed-movie.mpg">value_changed-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test of a PositionInterpolators ability to set its initial "value_changed" field to the correct value prior to receiving any events. Two PositionInterpolator node are associated with two seperate Box geometry. The PositionInterpolator associated with the Box on the left has a keyValue of 0 0 -4, while the PositionInterpolator associated with the right Box has the default of no keyValues, or [ ]. As a result, the PositionInterpolator on the left should initialize its "value_changed" field to the value of its first keyValue, or 0 0 4. Because no keyValues are provided to the right PositionInterpolator, it should initialize its "value_changed" field to the SFVec3f default value of 0 0 0. A Script node reads this value for each PositionInterpolator, and will translate the associated Box by a value equal to its initially read "value_changed" SFVec3f value when the geometry is indicated by the pointing device. When the pointing device passes over the left Box, it should translate by a value of 0 0 4 (move forward) each time it is indicated,then return to its original position when no longer indicated. When the pointing device passes over the right Box, it should translate to a value of 0 0 0 (it should NOT MOVE). </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/PositionInterpolator/value_changed.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/PositionInterpolator/value_changed.x3d</a> </td>
		</tr>
		<tr>
...
public class value_changed
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test of a PositionInterpolators ability to set its initial \"value_changed\" field to the correct value prior to receiving any events. Two PositionInterpolator node are associated with two seperate Box geometry. The PositionInterpolator associated with the Box on the left has a keyValue of 0 0 -4, while the PositionInterpolator associated with the right Box has the default of no keyValues, or [ ]. As a result, the PositionInterpolator on the left should initialize its \"value_changed\" field to the value of its first keyValue, or 0 0 4. Because no keyValues are provided to the right PositionInterpolator, it should initialize its \"value_changed\" field to the SFVec3f default value of 0 0 0. A Script node reads this value for each PositionInterpolator, and will translate the associated Box by a value equal to its initially read \"value_changed\" SFVec3f value when the geometry is indicated by the pointing device. When the pointing device passes over the left Box, it should translate by a value of 0 0 4 (move forward) each time it is indicated,then return to its original position when no longer indicated. When the pointing device passes over the right Box, it should translate to a value of 0 0 0 (it should NOT MOVE)."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/PositionInterpolator/value_changed.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("value_changed.x3d"))
    .addChild(new PositionInterpolator("MOVER1").setKey(new double[] {0.0,0.5,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,2.0,0.0,0.0,2.0,0.0,0.0,2.0})))
    .addChild(new PositionInterpolator("MOVER2"))
      ...
      .addChild(new Transform("TRANS2")
        ...
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material().setDiffuseColor(1.0,0.0,0.0)))
          .setGeometry(new Box()))))
    .addChild(new Script("MOVEIT").setDirectOutput(true).setUrl(new String[] {"value_changed.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/PositionInterpolator/value_changed.js"})
      .addField(new field().setName("nodein1").setType(field.TYPE_SFNODE).setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
        .addChild(new PositionInterpolator().setUSE("MOVER1")))
      .addField(new field().setName("nodein2").setType(field.TYPE_SFNODE).setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
        .addChild(new PositionInterpolator().setUSE("MOVER2")))
      ...
      .addField(new field().setName("reset").setType(field.TYPE_SFVEC3F).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(new SFVec3f(0.0,0.0,0.0)))
      ...
      .addField(new field().setName("translate").setType(field.TYPE_SFVEC3F).setAccessType(field.ACCESSTYPE_OUTPUTONLY)))
    .addChild(new ROUTE().setFromNode("TS1").setFromField("isOver").setToNode("MOVEIT").setToField("isOver1"))
    .addChild(new ROUTE().setFromNode("TS2").setFromField("isOver").setToNode("MOVEIT").setToField("isOver2")));
    }

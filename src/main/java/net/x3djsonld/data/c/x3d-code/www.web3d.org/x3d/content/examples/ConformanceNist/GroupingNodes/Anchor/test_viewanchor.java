 ...
 * <p> This is a collateral file used in other tests for this node. </p>
 <p> Related links: <a href="../../../../GroupingNodes/Anchor/test_viewanchor.java">test_viewanchor.java</a> source, <a href="../../../../GroupingNodes/Anchor/test_viewanchorIndex.html" target="_top">test_viewanchor catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GroupingNodes/Anchor/test_viewanchor.x3d">test_viewanchor.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/test_viewanchor.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/test_viewanchor.x3d</a> </td>
		</tr>
		<tr>
...
public class test_viewanchor
{
	/** Default constructor to create this object. */
	public test_viewanchor ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_viewanchor.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/test_viewanchor.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_viewanchor.x3d"))
    .addChild(new Viewpoint("newview").setDescription("newview").setPosition(0.0,0.0,15.0))
    .addChild(new Transform().setTranslation(0.0,4.5,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(0.0,1.0,0.0).setEmissiveColor(0.0,1.0,0.0)))
        .setGeometry(new Text().setString(new String[] {"A RED BOX AND A RED CONE BELOW","INDICATES THAT THIS BROWSER PASSED"," THIS TEST"})
    ...
    {
        X3D thisExampleX3dModel = new test_viewanchor().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_viewanchor\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_viewanchor\" self-validation test results: ");

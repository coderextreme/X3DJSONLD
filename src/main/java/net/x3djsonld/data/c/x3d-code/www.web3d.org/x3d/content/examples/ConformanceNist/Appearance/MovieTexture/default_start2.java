...
/**
 * <p> Test setting MovieTexture loop to true. By simply setting the loop field to true on a MovieTexture node, the movie should play continuously. </p>
 <p> Related links: <a href="../../../../Appearance/MovieTexture/default_start2.java">default_start2.java</a> source, <a href="../../../../Appearance/MovieTexture/default_start2Index.html" target="_top">default_start2 catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/MovieTexture/default_start2.x3d">default_start2.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Appearance/MovieTexture/default-start2-movie.mpg">default-start2-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test setting MovieTexture loop to true. By simply setting the loop field to true on a MovieTexture node, the movie should play continuously. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/default_start2.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/default_start2.x3d</a> </td>
		</tr>
		<tr>
...
public class default_start2
{
	/** Default constructor to create this object. */
	public default_start2 ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("default_start2.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("default-start2-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test setting MovieTexture loop to true. By simply setting the loop field to true on a MovieTexture node, the movie should play continuously."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/default_start2.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("default_start2.x3d"))
    ...
    {
        X3D thisExampleX3dModel = new default_start2().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.default_start2\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.default_start2\" self-validation test results: ");

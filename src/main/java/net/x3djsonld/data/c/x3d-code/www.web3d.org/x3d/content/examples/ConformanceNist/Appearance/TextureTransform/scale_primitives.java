 ...
 <p> Related links: <a href="../../../../Appearance/TextureTransform/scale_primitives.java">scale_primitives.java</a> source, <a href="../../../../Appearance/TextureTransform/scale_primitivesIndex.html" target="_top">scale_primitives catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/TextureTransform/scale_primitives.x3d">scale_primitives.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/scale_primitives-front.jpg">scale_primitives-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/scale_primitives-rear.jpg">scale_primitives-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/scale_primitives-top.jpg">scale_primitives-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/scale_primitives-bottom.jpg">scale_primitives-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/scale_primitives-left.jpg">scale_primitives-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/scale_primitives-right.jpg">scale_primitives-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test scale field for ImageTexture mapping to primitive geometry. Test browser ability to apply scales of (left to right) -4 -4, -2 -2, .4 .9, 2 2, and 4 4 to an ImageTexture mapped to the faces of primative geometry, using default primitive mapping rules. The result is: a 4 X 4 reversed and inverted matrix of VTS logos should appear on al1 geometry in the first (far left) column. The second colum should display a reversed and inverted 2 X 2 matrix of VTS logos on all geometry faces. The third geometry column should map an upright, enlarged, centered V on the front of all geometry faces. The fourth column should contain an upright 2 X 2 grid of VTS logos on all geometry faces, and the fifth geometry column should contain a 4 X 4 matrix of upright VTS logos on all geometry faces. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/scale_primitives.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/scale_primitives.x3d</a> </td>
		</tr>
		<tr>
...
public class scale_primitives
{
	/** Default constructor to create this object. */
	public scale_primitives ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("scale_primitives.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("scale_primitives-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("scale_primitives-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("scale_primitives-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("scale_primitives-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("scale_primitives-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("scale_primitives-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test scale field for ImageTexture mapping to primitive geometry. Test browser ability to apply scales of (left to right) -4 -4, -2 -2, .4 .9, 2 2, and 4 4 to an ImageTexture mapped to the faces of primative geometry, using default primitive mapping rules. The result is: a 4 X 4 reversed and inverted matrix of VTS logos should appear on al1 geometry in the first (far left) column. The second colum should display a reversed and inverted 2 X 2 matrix of VTS logos on all geometry faces. The third geometry column should map an upright, enlarged, centered V on the front of all geometry faces. The fourth column should contain an upright 2 X 2 grid of VTS logos on all geometry faces, and the fifth geometry column should contain a 4 X 4 matrix of upright VTS logos on all geometry faces."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/scale_primitives.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("scale_primitives.x3d"))
    .addChild(new Group()
    ...
    {
        X3D thisExampleX3dModel = new scale_primitives().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.scale_primitives\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.scale_primitives\" self-validation test results: ");

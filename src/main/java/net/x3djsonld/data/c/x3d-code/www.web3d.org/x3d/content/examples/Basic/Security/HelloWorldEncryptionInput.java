 ...
 * <p> Simple X3D example for XML encryption for security; actual encrypted result is in XML file HelloWorldEncryptionResult.xml. </p>
 <p> Related links: <a href="../../../Security/HelloWorldEncryptionInput.java">HelloWorldEncryptionInput.java</a> source, <a href="../../../Security/HelloWorldEncryptionInputIndex.html" target="_top">HelloWorldEncryptionInput catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../Security/HelloWorldEncryptionInput.x3d">HelloWorldEncryptionInput.x3d</a> </td>
		</tr>
		<tr>
...
public class HelloWorldEncryptionInput
{
	/** Default constructor to create this object. */
	public HelloWorldEncryptionInput ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("HelloWorldEncryptionInput.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("https://www.web3d.org/x3d/content/examples/Basic/Security/HelloWorldDecrypted.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/Security/HelloWorldEncryptionInput.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new WorldInfo().setTitle("HelloWorldEncryptionInput.x3d"))
    .addChild(new Group()
	 ...
	 * @return HelloWorldEncryptionInput model
	 */
    ...
    {
        X3D thisExampleX3dModel = new HelloWorldEncryptionInput().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.HelloWorldEncryptionInput\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.HelloWorldEncryptionInput\" self-validation test results: ");

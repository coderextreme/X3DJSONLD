...
/**
 * <p> Test of the Appearance node ability to accept a MovieTexture in its texture field. The MPEG MovieTexture should be upright and centered on all primitive geometry faces, and should rotate from right to left continuously. </p>
 <p> Related links: <a href="../../../../Appearance/Appearance/movietexture.java">movietexture.java</a> source, <a href="../../../../Appearance/Appearance/movietextureIndex.html" target="_top">movietexture catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Appearance/movietexture.x3d">movietexture.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/movietexture-front.jpg">movietexture-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test of the Appearance node ability to accept a MovieTexture in its texture field. The MPEG MovieTexture should be upright and centered on all primitive geometry faces, and should rotate from right to left continuously. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/movietexture.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/movietexture.x3d</a> </td>
		</tr>
		<tr>
...
public class movietexture
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("movietexture-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test of the Appearance node ability to accept a MovieTexture in its texture field. The MPEG MovieTexture should be upright and centered on all primitive geometry faces, and should rotate from right to left continuously."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/movietexture.x3d"))

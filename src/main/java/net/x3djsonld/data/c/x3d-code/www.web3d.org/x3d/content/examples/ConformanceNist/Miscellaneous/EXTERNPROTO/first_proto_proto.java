 ...
 * <p> This is a collateral file used in other tests for this node. </p>
 <p> Related links: <a href="../../../../Miscellaneous/EXTERNPROTO/first_proto_proto.java">first_proto_proto.java</a> source, <a href="../../../../Miscellaneous/EXTERNPROTO/first_proto_protoIndex.html" target="_top">first_proto_proto catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Miscellaneous/EXTERNPROTO/first_proto_proto.x3d">first_proto_proto.x3d</a> </td>
		</tr>
		<tr>
...
public class first_proto_proto
{
	/** Default constructor to create this object. */
	public first_proto_proto ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("first_proto_proto.x3d"))
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("first_proto_proto.x3d"))
	 ...
	 * @return first_proto_proto model
	 */
    ...
    {
        X3D thisExampleX3dModel = new first_proto_proto().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.first_proto_proto\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.first_proto_proto\" self-validation test results: ");

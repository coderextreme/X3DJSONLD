 ...
 <p> Related links: <a href="../../../../Sensors/SphereSensor/unison.java">unison.java</a> source, <a href="../../../../Sensors/SphereSensor/unisonIndex.html" target="_top">unison catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/SphereSensor/unison.x3d">unison.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/SphereSensor/unison-movie.mpg">unison-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test if a SphereSensor works in "unison" with a "sibling" TouchSensor associated with the same Box geometry. The Box geometry has an associated SphereSensor that routes its "rotation_changed" events to that geometrys Transform node. In addition, a TouchSensor is also a child of the same Transform node. As a result, passing the primary pointing device over the Box should turn on a PointLight. Pressing the primary pointing device button while over the Box and "dragging" should rotate that geometry, while the PointLight remains on. When the cursor is released, the Box should stop rotating. When the pointing device is no longer over the Box, the PointLight should turn off. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/SphereSensor/unison.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/SphereSensor/unison.x3d</a> </td>
		</tr>
		<tr>
...
public class unison
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test if a SphereSensor works in \"unison\" with a \"sibling\" TouchSensor associated with the same Box geometry. The Box geometry has an associated SphereSensor that routes its \"rotation_changed\" events to that geometrys Transform node. In addition, a TouchSensor is also a child of the same Transform node. As a result, passing the primary pointing device over the Box should turn on a PointLight. Pressing the primary pointing device button while over the Box and \"dragging\" should rotate that geometry, while the PointLight remains on. When the cursor is released, the Box should stop rotating. When the pointing device is no longer over the Box, the PointLight should turn off."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/SphereSensor/unison.x3d"))

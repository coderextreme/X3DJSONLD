 ...
 * <p> Test browser to shine light only on objects within its radius. The objects in question are a set of simple geometry (Cone, Sphere, Cylinder, and Box). A set of four simple geometry is drawn in the local coordinate system and four SpotLight node are also defined along the X, Y axis with radius 5.5 and intensity 1 at location 0 0 0 (with different directions). If the implementation under test does NOT ignore the radius, then the last figure of each set should not be illuminated. </p>
 <p> Related links: <a href="../../../../Lights/SpotLight/test_sim_scope.java">test_sim_scope.java</a> source, <a href="../../../../Lights/SpotLight/test_sim_scopeIndex.html" target="_top">test_sim_scope catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/SpotLight/test_sim_scope.x3d">test_sim_scope.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/SpotLight/test-sim-scope-front.jpg">test-sim-scope-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_sim_scope.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_sim_scope.x3d</a> </td>
		</tr>
		<tr>
...
public class test_sim_scope
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_sim_scope.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new SpotLight().setBeamWidth(1.57079).setCutOffAngle(1.57079).setDirection(0.0,1.0,0.0).setRadius(5.5))
    .addChild(new SpotLight().setBeamWidth(1.57079).setCutOffAngle(1.57079).setDirection(-1.0,0.0,0.0).setRadius(5.5))
    .addChild(new SpotLight().setBeamWidth(1.57079).setCutOffAngle(1.57079).setDirection(0.0,-1.0,0.0).setRadius(5.5))
    .addChild(new SpotLight().setBeamWidth(1.57079).setCutOffAngle(1.57079).setRadius(5.5))

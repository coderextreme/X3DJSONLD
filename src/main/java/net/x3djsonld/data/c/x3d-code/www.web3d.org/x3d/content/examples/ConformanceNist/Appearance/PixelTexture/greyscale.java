 ...
 <p> Related links: <a href="../../../../Appearance/PixelTexture/greyscale.java">greyscale.java</a> source, <a href="../../../../Appearance/PixelTexture/greyscaleIndex.html" target="_top">greyscale catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/PixelTexture/greyscale.x3d">greyscale.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale-front.jpg">greyscale-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale-rear.jpg">greyscale-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale-top.jpg">greyscale-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale-bottom.jpg">greyscale-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale-left.jpg">greyscale-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale-right.jpg">greyscale-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser ability to map greyscale pixel values to geometry. A greyscale checkerboard of four squares should map onto a sphere, cone, box and box. The lower left and upper right squares are white, and the upper left and lower right squares are grey. For the sphere, the texture should cover the entire surface, and wrap counterclockwise from the back of the sphere. For the cone, the texture should wrap counterclockwise (from above) starting at the back of the cone. A circle cutout of the texture is applied right side up to the base of the cone when the cone is tilted toward the -z axis. For the cylinder, the texture should wrap counterclockwise (from above) starting at the back of the cylinder. A circle cutout of the texture is applied right side up to the top and bottom caps of the cylinder. For the box, the texture should be applied right side up in its entirety to each face of the box. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/PixelTexture/greyscale.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/PixelTexture/greyscale.x3d</a> </td>
		</tr>
		<tr>
...
public class greyscale
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("greyscale.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test browser ability to map greyscale pixel values to geometry. A greyscale checkerboard of four squares should map onto a sphere, cone, box and box. The lower left and upper right squares are white, and the upper left and lower right squares are grey. For the sphere, the texture should cover the entire surface, and wrap counterclockwise from the back of the sphere. For the cone, the texture should wrap counterclockwise (from above) starting at the back of the cone. A circle cutout of the texture is applied right side up to the base of the cone when the cone is tilted toward the -z axis. For the cylinder, the texture should wrap counterclockwise (from above) starting at the back of the cylinder. A circle cutout of the texture is applied right side up to the top and bottom caps of the cylinder. For the box, the texture should be applied right side up in its entirety to each face of the box."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/PixelTexture/greyscale.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("greyscale.x3d"))
      ...
      .addChild(new Transform().setTranslation(6.14221,0.0694613,-0.000999451)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            ...
            .setTexture(new PixelTexture("GreyscaleCheckerboard").setImage(new int[] {2,2,1,255,128,128,255})))
          .setGeometry(new Box())))
    ...
    {
        X3D thisExampleX3dModel = new greyscale().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.greyscale\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.greyscale\" self-validation test results: ");

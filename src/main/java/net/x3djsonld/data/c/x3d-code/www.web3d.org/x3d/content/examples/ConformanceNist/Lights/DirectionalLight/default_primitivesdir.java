...
/**
 * <p> Test browser to apply all the default values of a DirectionalLight node to simple geometry. A row containing all four simple geometry is drawn in the local coordinate system and a DirectionalLight node is defined at the beggining of the test. All figures should be illuminated with white light. </p>
 <p> Related links: <a href="../../../../Lights/DirectionalLight/default_primitivesdir.java">default_primitivesdir.java</a> source, <a href="../../../../Lights/DirectionalLight/default_primitivesdirIndex.html" target="_top">default_primitivesdir catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/DirectionalLight/default_primitivesdir.x3d">default_primitivesdir.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/default_primitivesdir-front.jpg">default_primitivesdir-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/default_primitivesdir-top.jpg">default_primitivesdir-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/default_primitivesdir-left.jpg">default_primitivesdir-left.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser to apply all the default values of a DirectionalLight node to simple geometry. A row containing all four simple geometry is drawn in the local coordinate system and a DirectionalLight node is defined at the beggining of the test. All figures should be illuminated with white light. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/default_primitivesdir.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/default_primitivesdir.x3d</a> </td>
		</tr>
		<tr>
...
public class default_primitivesdir
{
	/** Default constructor to create this object. */
	public default_primitivesdir ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("default_primitivesdir.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("default_primitivesdir-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("default_primitivesdir-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("default_primitivesdir-left.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/default_primitivesdir.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("default_primitivesdir.x3d"))
    .addChild(new Group()
	 ...
	 * @return default_primitivesdir model
	 */
    ...
    {
        X3D thisExampleX3dModel = new default_primitivesdir().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.default_primitivesdir\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.default_primitivesdir\" self-validation test results: ");

...
/**
 * <p> This tests check the boundary condition of 500 children per grouping node. An Anchor node is defined with 500 children in its "children" field. Section 7.3 (Minimum Support Requirements) of the VRML specifications 500 children within a single grouping node. The test should generate 500 default color spheres and radius 0.3. </p>
 <p> Related links: <a href="../../../../GroupingNodes/Anchor/bound_500.java">bound_500.java</a> source, <a href="../../../../GroupingNodes/Anchor/bound_500Index.html" target="_top">bound_500 catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GroupingNodes/Anchor/bound_500.x3d">bound_500.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GroupingNodes/Anchor/bound-500-front.jpg">bound-500-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This tests check the boundary condition of 500 children per grouping node. An Anchor node is defined with 500 children in its "children" field. Section 7.3 (Minimum Support Requirements) of the VRML specifications 500 children within a single grouping node. The test should generate 500 default color spheres and radius 0.3 </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/bound_500.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/bound_500.x3d</a> </td>
		</tr>
		<tr>
...
public class bound_500
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("bound-500-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("This tests check the boundary condition of 500 children per grouping node. An Anchor node is defined with 500 children in its \"children\" field. Section 7.3 (Minimum Support Requirements) of the VRML specifications 500 children within a single grouping node. The test should generate 500 default color spheres and radius 0.3"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/bound_500.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Anchor().setDescription("Boundary condition of 500 children").setUrl(new String[] {"../../HelloWorld.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/HelloWorld.x3d","../../HelloWorld.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/HelloWorld.wrl"})

 ...
 <p> Related links: <a href="../../../../BindableNodes/NavigationInfo/create_vrml_from_string_navigationinfo.java">create_vrml_from_string_navigationinfo.java</a> source, <a href="../../../../BindableNodes/NavigationInfo/create_vrml_from_string_navigationinfoIndex.html" target="_top">create_vrml_from_string_navigationinfo catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/NavigationInfo/create_vrml_from_string_navigationinfo.x3d">create_vrml_from_string_navigationinfo.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test NOT binding a NavigationInfo node generated by Create_Vrml_From_String. A NavigationInfo node is introduced into this world via the createVrmlFromString method of an EcmaScript script node. The string used in the script contains a NavigationInfo node with a type of EXAMINE. Because the NavigationInfo node is introduced via a createVrmlFromString method, it should not be bound to the top of the stack. As a result, navigation should be of the default type [WALK,ANY] and produce a "walking" type of navigation. In addition, a Text message should appear stating that the scripted NavigationInfo node is not bound, and that its isBound field is set to false. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/create_vrml_from_string_navigationinfo.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/create_vrml_from_string_navigationinfo.x3d</a> </td>
		</tr>
...
public class create_vrml_from_string_navigationinfo
{
	/** Default constructor to create this object. */
	public create_vrml_from_string_navigationinfo ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("create_vrml_from_string_navigationinfo.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test NOT binding a NavigationInfo node generated by Create_Vrml_From_String. A NavigationInfo node is introduced into this world via the createVrmlFromString method of an EcmaScript script node. The string used in the script contains a NavigationInfo node with a type of EXAMINE. Because the NavigationInfo node is introduced via a createVrmlFromString method, it should not be bound to the top of the stack. As a result, navigation should be of the default type [WALK,ANY] and produce a \"walking\" type of navigation. In addition, a Text message should appear stating that the scripted NavigationInfo node is not bound, and that its isBound field is set to false."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/create_vrml_from_string_navigationinfo.x3d"))
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("create_vrml_from_string_navigationinfo.x3d"))
    ...
    .addChild(new Script("MYSCRIPT").setDirectOutput(true).setUrl(new String[] {"create_vrml_from_string_navigationInfo.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/create_vrml_from_string_navigationinfo.js"})
	 ...
	 * @return create_vrml_from_string_navigationinfo model
	 */
    ...
    {
        X3D thisExampleX3dModel = new create_vrml_from_string_navigationinfo().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.create_vrml_from_string_navigationinfo\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.create_vrml_from_string_navigationinfo\" self-validation test results: ");

...
/**
 * <p> Test the function of PlaneSensor if minPosition = maxPosition in its Y component. A red Box geometry has an associated PlaneSensor with minPosition = 0 = maxPosition for Y, and minPosition = -2 and maxPosition = 2 for X. As a result, when pressing over the Box and dragging, the translation of the Box should be constrainted in movement so that it travels in a line only, between X = -2 and X = 2. </p>
 <p> Related links: <a href="../../../../Sensors/PlaneSensor/minmax_y.java">minmax_y.java</a> source, <a href="../../../../Sensors/PlaneSensor/minmax_yIndex.html" target="_top">minmax_y catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/PlaneSensor/minmax_y.x3d">minmax_y.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/PlaneSensor/minmax_y-movie.mpg">minmax_y-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test the function of PlaneSensor if minPosition = maxPosition in its Y component. A red Box geometry has an associated PlaneSensor with minPosition = 0 = maxPosition for Y, and minPosition = -2 and maxPosition = 2 for X. As a result, when pressing over the Box and dragging, the translation of the Box should be constrainted in movement so that it travels in a line only, between X = -2 and X = 2. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/minmax_y.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/minmax_y.x3d</a> </td>
		</tr>
		<tr>
...
public class minmax_y
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("minmax_y.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("minmax_y-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test the function of PlaneSensor if minPosition = maxPosition in its Y component. A red Box geometry has an associated PlaneSensor with minPosition = 0 = maxPosition for Y, and minPosition = -2 and maxPosition = 2 for X. As a result, when pressing over the Box and dragging, the translation of the Box should be constrainted in movement so that it travels in a line only, between X = -2 and X = 2."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/minmax_y.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("minmax_y.x3d"))
    .addChild(new Group()
      ...
      .addChild(new Transform().setTranslation(0.0,-2.0,1.0)
        .addChild(new PlaneSensor("PLANE_SENSOR").setDescription("click and drag to move object").setMaxPosition(2.0,0.0).setMinPosition(-2.0,0.0))
        .addChild(new Transform("BOX")
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(1.0,0.0,0.0)))
            .setGeometry(new Box().setSize(0.5,0.5,0.5))))))
    .addChild(new ROUTE().setFromNode("PLANE_SENSOR").setFromField("translation_changed").setToNode("BOX").setToField("translation")));
    }
    ...
    {
        X3D thisExampleX3dModel = new minmax_y().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.minmax_y\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.minmax_y\" self-validation test results: ");

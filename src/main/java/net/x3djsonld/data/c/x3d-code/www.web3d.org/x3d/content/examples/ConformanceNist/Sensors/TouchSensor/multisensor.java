 ...
 <p> Related links: <a href="../../../../Sensors/TouchSensor/multisensor.java">multisensor.java</a> source, <a href="../../../../Sensors/TouchSensor/multisensorIndex.html" target="_top">multisensor catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/TouchSensor/multisensor.x3d">multisensor.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/TouchSensor/multisensor-movie.mpg">multisensor-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test if a TouchSensor grabs all further motion events from pointing device and "overrides" a PlaneSensor that is higher in the sensor hierarchy. The Box geometry has an associated TouchSensor that routes its "isActive" events to a PointLights on field. In addition, a PlaneSensor, nested higher in the sensor hierarchy routes its trackPoint_changed events to the Boxs parent transform node. Passing the primary pointing device over the Box geometry and pressing down on the primary pointing device button should route and isActive event to a PointLight and illuminate the IndexedFaceSets. Dragging the pointing device over the Box geometry and holding the primary pointing device button should not move the Box. When the pointing device button is released, the PointLight should turn off. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/multisensor.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/multisensor.x3d</a> </td>
		</tr>
		<tr>
...
public class multisensor
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test if a TouchSensor grabs all further motion events from pointing device and \"overrides\" a PlaneSensor that is higher in the sensor hierarchy. The Box geometry has an associated TouchSensor that routes its \"isActive\" events to a PointLights on field. In addition, a PlaneSensor, nested higher in the sensor hierarchy routes its trackPoint_changed events to the Boxs parent transform node. Passing the primary pointing device over the Box geometry and pressing down on the primary pointing device button should route and isActive event to a PointLight and illuminate the IndexedFaceSets. Dragging the pointing device over the Box geometry and holding the primary pointing device button should not move the Box. When the pointing device button is released, the PointLight should turn off."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/multisensor.x3d"))

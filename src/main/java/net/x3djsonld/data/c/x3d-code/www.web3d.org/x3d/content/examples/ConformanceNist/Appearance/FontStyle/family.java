 ...
 <p> Related links: <a href="../../../../Appearance/FontStyle/family.java">family.java</a> source, <a href="../../../../Appearance/FontStyle/familyIndex.html" target="_top">family catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/FontStyle/family.x3d">family.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/FontStyle/family-front.jpg">family-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test range of family values for FontStyle node. A FontStyle node with default values for all of its fields is used to render three lines of a Text geometry. Horizontal lines in this world are spaced 1 unit apart. The green lines represent the X and Y axes of the local coordinate system. With a default family="SERIF", the text should be be a SERIF family font. With horizontal="true", the text should be parallel to the X axis, and advance in the positive X direction. With justify='"BEGIN" "FIRST" ', the text should be justified at the left edge of the line. With leftToRight="true", text should advance in a left to right direction along the major (X) axis. With a default font size="1", the nominal font glyph height should be 1 unit in the local coordinate system. This corresponds to the distance between successive horizontal lines in this world. With a default font spacing="1", the distance between the base of two succesive Text lines should be 1 unit in the local coordinate system. With a default style="PLAIN", the text should not appear bold, or italic, or bold and italic. With a default topToBottom="true", successive lines of text should advance from top to bottom along the minor (Y) axis. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/FontStyle/family.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/FontStyle/family.x3d</a> </td>
		</tr>
		<tr>
...
public class family
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("family.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("family-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test range of family values for FontStyle node. A FontStyle node with default values for all of its fields is used to render three lines of a Text geometry. Horizontal lines in this world are spaced 1 unit apart. The green lines represent the X and Y axes of the local coordinate system. With a default family=\"SERIF\", the text should be be a SERIF family font. With horizontal=\"true\", the text should be parallel to the X axis, and advance in the positive X direction. With justify='\"BEGIN\" \"FIRST\" ', the text should be justified at the left edge of the line. With leftToRight=\"true\", text should advance in a left to right direction along the major (X) axis. With a default font size=\"1\", the nominal font glyph height should be 1 unit in the local coordinate system. This corresponds to the distance between successive horizontal lines in this world. With a default font spacing=\"1\", the distance between the base of two succesive Text lines should be 1 unit in the local coordinate system. With a default style=\"PLAIN\", the text should not appear bold, or italic, or bold and italic. With a default topToBottom=\"true\", successive lines of text should advance from top to bottom along the minor (Y) axis."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/FontStyle/family.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("family.x3d"))
    .addChild(new Viewpoint().setDescription("Family values for FontStyle").setPosition(0.0,0.0,15.0))
    .addChild(new Transform().setTranslation(-7.0,3.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Text().setString(new String[] {"This is SERIF"})
          .setFontStyle(new FontStyle()))))
    .addChild(new Transform().setTranslation(0.0,3.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Text().setString(new String[] {"This is SANS"})
          .setFontStyle(new FontStyle().setFamily(new String[] {"SANS"})))))
    .addChild(new Transform().setTranslation(0.0,-3.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Text().setString(new String[] {"This is TYPEWRITER"})
    ...
    {
        X3D thisExampleX3dModel = new family().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.family\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.family\" self-validation test results: ");

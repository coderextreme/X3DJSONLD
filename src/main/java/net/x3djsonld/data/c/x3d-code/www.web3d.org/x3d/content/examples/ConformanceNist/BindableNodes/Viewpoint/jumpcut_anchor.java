...
/**
 * <p> Test jumpcut transition with an Anchor node. An Anchor node, with a url field of "Top_View" (corresponding to the name of Viewpoint in this world) should create a "jump cut" transition of views when the Box geometry in this world is indicated by the pointing device. As a result, indicating the Box geometry should result in a Viewpoint transition to the top view of the Box geometry. The viewer should see a cubic geometry with the word TOP displayed. </p>
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/jumpcut_anchor.java">jumpcut_anchor.java</a> source, <a href="../../../../BindableNodes/Viewpoint/jumpcut_anchorIndex.html" target="_top">jumpcut_anchor catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/jumpcut_anchor.x3d">jumpcut_anchor.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test jumpcut transition with an Anchor node. An Anchor node, with a url field of "Top_View" (corresponding to the name of Viewpoint in this world) should create a "jump cut" transition of views when the Box geometry in this world is indicated by the pointing device. As a result, indicating the Box geometry should result in a Viewpoint transition to the top view of the Box geometry. The viewer should see a cubic geometry with the word TOP displayed. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_anchor.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_anchor.x3d</a> </td>
		</tr>
		<tr>
...
public class jumpcut_anchor
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test jumpcut transition with an Anchor node. An Anchor node, with a url field of \"Top_View\" (corresponding to the name of Viewpoint in this world) should create a \"jump cut\" transition of views when the Box geometry in this world is indicated by the pointing device. As a result, indicating the Box geometry should result in a Viewpoint transition to the top view of the Box geometry. The viewer should see a cubic geometry with the word TOP displayed."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_anchor.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Anchor().setDescription("select to change viewpoints to Top View").setUrl(new String[] {"#Top_View"})

...
/**
 * <p> Test of browser ability to map an entire MovieTexture onto an IndexedFaceSet geometry. The entire VTS logo texture should map onto all faces of the cube. </p>
 <p> Related links: <a href="../../../../GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_whole.java">indexedfaceset_movietexture_whole.java</a> source, <a href="../../../../GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_wholeIndex.html" target="_top">indexedfaceset_movietexture_whole catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_whole.x3d">indexedfaceset_movietexture_whole.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test of browser ability to map an entire MovieTexture onto an IndexedFaceSet geometry. The entire VTS logo texture should map onto all faces of the cube. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_whole.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_whole.x3d</a> </td>
		</tr>
		<tr>
...
public class indexedfaceset_movietexture_whole
{
	/** Default constructor to create this object. */
	public indexedfaceset_movietexture_whole ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("indexedfaceset_movietexture_whole.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test of browser ability to map an entire MovieTexture onto an IndexedFaceSet geometry. The entire VTS logo texture should map onto all faces of the cube."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_movietexture_whole.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("indexedfaceset_movietexture_whole.x3d"))
	 ...
	 * @return indexedfaceset_movietexture_whole model
	 */
    ...
    {
        X3D thisExampleX3dModel = new indexedfaceset_movietexture_whole().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.indexedfaceset_movietexture_whole\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.indexedfaceset_movietexture_whole\" self-validation test results: ");

 ...
 <p> Related links: <a href="../../../../Appearance/ImageTexture/all_png.java">all_png.java</a> source, <a href="../../../../Appearance/ImageTexture/all_pngIndex.html" target="_top">all_png catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/ImageTexture/all_png.x3d">all_png.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/all_png-front.jpg">all_png-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/all_png-rear.jpg">all_png-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/all_png-bottom.jpg">all_png-bottom.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test mapping PNG ImageTexture to all primitive geometry. Test browser ability to map an RGB (24 bit color) and 8 bit "palette" on a purple background should map onto a sphere, cone, cylinder and box. The "palette" version of the ImageTexture is mapped to the Sphere and the Cone. The RGB 24 bit color ImageTexture is mapped to the Cylinder and Box. For the sphere the texture should cover the entire surface, and wrap counterclockwise from the back of the sphere. For the cone, the texture should wrap counterclockwise (from above) starting at the back of the cone. A circle cutout of the texture is applied right side up to the base of the cone when the cone is tilted toward the -z axis. For the cylinder, the texture should wrap counterclockwise (from above) starting at the back of the cylinder. A circle cutout of the texture is applied right side up to the top and bottom caps of the cylinder. For the box, the texture should be applied right side up in its entirety to each face of the box. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/all_png.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/all_png.x3d</a> </td>
		</tr>
		<tr>
...
public class all_png
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("all_png.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("all_png-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("all_png-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("all_png-bottom.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test mapping PNG ImageTexture to all primitive geometry. Test browser ability to map an RGB (24 bit color) and 8 bit \"palette\" on a purple background should map onto a sphere, cone, cylinder and box. The \"palette\" version of the ImageTexture is mapped to the Sphere and the Cone. The RGB 24 bit color ImageTexture is mapped to the Cylinder and Box. For the sphere the texture should cover the entire surface, and wrap counterclockwise from the back of the sphere. For the cone, the texture should wrap counterclockwise (from above) starting at the back of the cone. A circle cutout of the texture is applied right side up to the base of the cone when the cone is tilted toward the -z axis. For the cylinder, the texture should wrap counterclockwise (from above) starting at the back of the cylinder. A circle cutout of the texture is applied right side up to the top and bottom caps of the cylinder. For the box, the texture should be applied right side up in its entirety to each face of the box."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/all_png.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("all_png.x3d"))
    ...
    .addChild(new Group()
      ...
      .addChild(new Transform().setTranslation(-4.85443,0.0694381,-0.00149918)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material())
            .setTexture(new ImageTexture("image8bcolrp").setUrl(new String[] {"8bcolrp.png","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/8bcolrp.png"})))
          .setGeometry(new Sphere())))
      .addChild(new Transform().setTranslation(-1.47341,0.036672,-0.00175095)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material())
            .setTexture(new ImageTexture().setUSE("image8bcolrp")))
    ...
    {
        X3D thisExampleX3dModel = new all_png().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.all_png\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.all_png\" self-validation test results: ");

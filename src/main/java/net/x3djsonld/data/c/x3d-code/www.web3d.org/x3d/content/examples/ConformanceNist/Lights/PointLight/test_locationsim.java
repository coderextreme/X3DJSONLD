...
/**
 * <p> Test browser to set the location field to a range of values on a set of simple geometry (sphere) The geometry are drawn in the local coordinate system. The location of the light is changed as the animation progresses. The animation is started by clicking on the text above the geometry. The location values used are 0 0 5,5 0 0,0 0 -5,-5 0 0. </p>
 <p> Related links: <a href="../../../../Lights/PointLight/test_locationsim.java">test_locationsim.java</a> source, <a href="../../../../Lights/PointLight/test_locationsimIndex.html" target="_top">test_locationsim catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/PointLight/test_locationsim.x3d">test_locationsim.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Lights/PointLight/test-locationsim-movie.mpg">test-locationsim-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser to set the location field to a range of values on a set of simple geometry (sphere) The geometry are drawn in the local coordinate system. The location of the light is changed as the animation progresses. The animation is started by clicking on the text above the geometry. The location values used are 0 0 5,5 0 0,0 0 -5,-5 0 0. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_locationsim.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_locationsim.x3d</a> </td>
		</tr>
		<tr>
...
public class test_locationsim
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_locationsim.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new PositionInterpolator("the-location").setKey(new double[] {0.25,0.5,0.75,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,5.0,5.0,0.0,0.0,0.0,0.0,-5.0,-5.0,0.0,0.0})))
    ...
    .addChild(new Group()
      .addChild(new PointLight("the-light").setAmbientIntensity(1).setLocation(0.0,0.0,5.0))

...
/**
 * <p> Volume rendering of a brain MR image, rendered with basic edge enhancement style. </p>
 <p> Related links: <a href="../../../VolumeRendering/EdgeBrain.java">EdgeBrain.java</a> source, <a href="../../../VolumeRendering/EdgeBrainIndex.html" target="_top">EdgeBrain catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../VolumeRendering/EdgeBrain.x3d">EdgeBrain.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> Volume rendering of a brain MR image, rendered with basic edge enhancement style </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/EdgeBrain.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/EdgeBrain.x3d</a> </td>
		</tr>
		<tr>
...
public class EdgeBrain
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("EdgeBrain.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Volume rendering of a brain MR image, rendered with basic edge enhancement style"))
    .addMeta(new meta().setName(meta.NAME_CREATED    ).setContent("26 March 2011"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("EdgeBrain.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/EdgeBrain.x3d"))
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("EdgeBrain.x3d"))
    .addChild(new Group()
      .addChild(new Viewpoint("VP").setDescription("Edge Brain").setOrientation(-0.0212122,0.99986,0.012461,3.23009).setPosition(-0.00920216,0.012033,-0.184913))
      ...
      .addChild(new Transform().setScale(0.117188,0.117188,0.117188)
        .addChild(new VolumeData().setDimensions(1.28,1.28,1.0)
          .setRenderStyle(new EdgeEnhancementVolumeStyle())
    ...
    {
        X3D thisExampleX3dModel = new EdgeBrain().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.EdgeBrain\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.EdgeBrain\" self-validation test results: ");

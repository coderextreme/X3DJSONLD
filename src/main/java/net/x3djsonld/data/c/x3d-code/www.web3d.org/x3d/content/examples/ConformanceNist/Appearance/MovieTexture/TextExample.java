 ...
 <p> Related links: <a href="../../../../Appearance/MovieTexture/TextExample.java">TextExample.java</a> source, <a href="../../../../Appearance/MovieTexture/TextExampleIndex.html" target="_top">TextExample catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/MovieTexture/TextExample.x3d">TextExample.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Default map an mpeg MovieTexture to a Text geometry. The top of the text should represent a value of 1 in texture coordinates and the MovieTexture should scale uniformly in the S and T direction. The result is a red and yellow square checkerboard centered vertically, and repeating horizontally left-to-right, with the word TEXT acting as a cookie-cutter, with the lower left corner of the TEXT corresponding to the lower left corner of the first, repeating MovieTexture. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/TextExample.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/TextExample.x3d</a> </td>
		</tr>
		<tr>
...
public class TextExample
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("TextExample.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Default map an mpeg MovieTexture to a Text geometry. The top of the text should represent a value of 1 in texture coordinates and the MovieTexture should scale uniformly in the S and T direction. The result is a red and yellow square checkerboard centered vertically, and repeating horizontally left-to-right, with the word TEXT acting as a cookie-cutter, with the lower left corner of the TEXT corresponding to the lower left corner of the first, repeating MovieTexture."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/TextExample.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape()
      .setAppearance(new Appearance()
        ...
        .setTexture(new MovieTexture().setLoop(true).setUrl(new String[] {"text.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/text.mpg"})))
    ...
    {
        X3D thisExampleX3dModel = new TextExample().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.TextExample\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.TextExample\" self-validation test results: ");

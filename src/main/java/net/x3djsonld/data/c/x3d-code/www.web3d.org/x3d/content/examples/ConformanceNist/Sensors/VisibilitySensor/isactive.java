 ...
 <p> Related links: <a href="../../../../Sensors/VisibilitySensor/isactive.java">isactive.java</a> source, <a href="../../../../Sensors/VisibilitySensor/isactiveIndex.html" target="_top">isactive catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/VisibilitySensor/isactive.x3d">isactive.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/VisibilitySensor/isactive-movie.mpg">isactive-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> A VisibilitySensor should generate an isActive event of true when the VisibilitySensor bounding box is in the field of view. A default Viewpoint places the viewer avatar directly in front of a VisibilitySensor bounding box, represented by a white IndexedLineSet. As a result, an isActive true event is sent to a TimeSensor to start a color animation of the Sphere geometry directly behind the bounding box. Moving to the second Viewpoint directly behind the bounding box should stop the color animation. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/VisibilitySensor/isactive.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/VisibilitySensor/isactive.x3d</a> </td>
		</tr>
		<tr>
...
public class isactive
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/VisibilitySensor/isactive.x3d"))

...
/**
 * <p> Test unlit, greyscale textured geometry. No Material node, no Color node and a greyscale ImageTexture is applied to a row containing primitive geometry, followedy by a row containing an ElevationGrid and an IndexedFaceSet. The result should be all geometry mapped with the greyscale VTS logo. </p>
 <p> Related links: <a href="../../../../Appearance/Appearance/unlit_greyscale_intensity.java">unlit_greyscale_intensity.java</a> source, <a href="../../../../Appearance/Appearance/unlit_greyscale_intensityIndex.html" target="_top">unlit_greyscale_intensity catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Appearance/unlit_greyscale_intensity.x3d">unlit_greyscale_intensity.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/unlit_greyscale_intensity-front.jpg">unlit_greyscale_intensity-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/unlit_greyscale_intensity-rear.jpg">unlit_greyscale_intensity-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/unlit_greyscale_intensity-top.jpg">unlit_greyscale_intensity-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/unlit_greyscale_intensity-bottom.jpg">unlit_greyscale_intensity-bottom.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test unlit, greyscale textured geometry. No Material node, no Color node and a greyscale ImageTexture is applied to a row containing primitive geometry, followedy by a row containing an ElevationGrid and an IndexedFaceSet. The result should be all geometry mapped with the greyscale VTS logo. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_greyscale_intensity.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_greyscale_intensity.x3d</a> </td>
		</tr>
		<tr>
...
public class unlit_greyscale_intensity
{
	/** Default constructor to create this object. */
	public unlit_greyscale_intensity ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("unlit_greyscale_intensity.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("unlit_greyscale_intensity-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("unlit_greyscale_intensity-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("unlit_greyscale_intensity-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("unlit_greyscale_intensity-bottom.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test unlit, greyscale textured geometry. No Material node, no Color node and a greyscale ImageTexture is applied to a row containing primitive geometry, followedy by a row containing an ElevationGrid and an IndexedFaceSet. The result should be all geometry mapped with the greyscale VTS logo."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_greyscale_intensity.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("unlit_greyscale_intensity.x3d"))
    ...
    .addChild(new Group()
      .addChild(new Transform().setTranslation(-3.0,-0.651405,-5.5323)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setTexture(new ImageTexture("greyscalecolor.jpg").setUrl(new String[] {"greyscalecolor.jpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/greyscalecolor.jpg"})))
      ...
      .addChild(new Transform().setScale(0.615111,0.615111,0.615112).setTranslation(1.0,-0.147732,-4.50195)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setTexture(new ImageTexture().setUSE("greyscalecolor.jpg")))
	 ...
	 * @return unlit_greyscale_intensity model
	 */
    ...
    {
        X3D thisExampleX3dModel = new unlit_greyscale_intensity().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.unlit_greyscale_intensity\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.unlit_greyscale_intensity\" self-validation test results: ");

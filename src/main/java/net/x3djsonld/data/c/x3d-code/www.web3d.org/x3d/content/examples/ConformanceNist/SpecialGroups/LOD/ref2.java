 ...
 * <p> This is a collateral file used in other tests of this node. </p>
 <p> Related links: <a href="../../../../SpecialGroups/LOD/ref2.java">ref2.java</a> source, <a href="../../../../SpecialGroups/LOD/ref2Index.html" target="_top">ref2 catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/LOD/ref2.x3d">ref2.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref2.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref2.x3d</a> </td>
		</tr>
		<tr>
...
public class ref2
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref2.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform()
      .addChild(new Shape()
        ...
        .setGeometry(new Box().setSize(8.0,2.0,3.0))))
    ...
    .addChild(new Transform().setTranslation(0.0,4.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,0.0,0.0).setEmissiveColor(1.0,0.0,0.0)))
        .setGeometry(new Box().setSize(8.0,1.0,3.0))))
    .addChild(new Transform().setTranslation(0.0,-0.87,0.0)
      .addChild(new Shape()
        ...
        .setGeometry(new Box().setSize(11.0,0.02,9.0))))
    .addChild(new Transform().setTranslation(-3.5,2.0,1.1)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Cylinder().setHeight(4).setRadius(0.14))))
    .addChild(new Transform().setTranslation(3.5,2.0,1.1)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))

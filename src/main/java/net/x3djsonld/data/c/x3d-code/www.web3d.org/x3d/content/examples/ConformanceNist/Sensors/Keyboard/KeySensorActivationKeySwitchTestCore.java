 ...
 * <p> A simple scene to show KeySensor functionality using Core Profile. </p>
 <p> Related links: <a href="../../../../Sensors/Keyboard/KeySensorActivationKeySwitchTestCore.java">KeySensorActivationKeySwitchTestCore.java</a> source, <a href="../../../../Sensors/Keyboard/KeySensorActivationKeySwitchTestInteractiveIndex.html" target="_top">KeySensorActivationKeySwitchTestInteractive catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
...
public class KeySensorActivationKeySwitchTestCore
{
	/** Default constructor to create this object. */
	public KeySensorActivationKeySwitchTestCore ()
	{
	  initialize();
	}
  ...
  .setScene(new Scene()
    ...
    .addChild(new Billboard()
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new TouchSensor("StartMessageTouched").setDescription("touch to activate"))
	 ...
	 * @return KeySensorActivationKeySwitchTestCore model
	 */
    ...
    {
        X3D thisExampleX3dModel = new KeySensorActivationKeySwitchTestCore().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.KeySensorActivationKeySwitchTestCore\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.KeySensorActivationKeySwitchTestCore\" self-validation test results: ");

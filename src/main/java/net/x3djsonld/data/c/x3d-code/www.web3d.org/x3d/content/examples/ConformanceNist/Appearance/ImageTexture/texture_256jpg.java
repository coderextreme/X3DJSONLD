 ...
 <p> Related links: <a href="../../../../Appearance/ImageTexture/texture_256jpg.java">texture_256jpg.java</a> source, <a href="../../../../Appearance/ImageTexture/texture_256jpgIndex.html" target="_top">texture_256jpg catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/ImageTexture/texture_256jpg.x3d">texture_256jpg.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/256jpg-front.jpg">256jpg-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/256jpg-rear.jpg">256jpg-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/256jpg-top.jpg">256jpg-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/256jpg-bottom.jpg">256jpg-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/256jpg-left.jpg">256jpg-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/256jpg-right.jpg">256jpg-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Map a 256 by 256 pixel JPG image to a box. For the sides, the S texture axis should be parallel to the XZ plane, and the T texture axis should be parallel to the YZ plane. For the top of the box, the S (horizontal) axis of the texture should be parallel with the X axis, and the T (vertical) axis should be parallel with the Z axis. When viewed from the top, S texture values should increase to the right, and T values should increase upward. For the bottom of the box, the S (horizontal) axis of the texture should be parallel with the X axis, and the T (vertical) axis should be parallel with the Z axis. When viewed from the bottom, S values should increase to the right, and T values should incrase upward. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/texture_256jpg.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/texture_256jpg.x3d</a> </td>
		</tr>
		<tr>
...
public class texture_256jpg
{
	/** Default constructor to create this object. */
	public texture_256jpg ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("texture_256jpg.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("256jpg-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("256jpg-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("256jpg-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("256jpg-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("256jpg-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("256jpg-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Map a 256 by 256 pixel JPG image to a box. For the sides, the S texture axis should be parallel to the XZ plane, and the T texture axis should be parallel to the YZ plane. For the top of the box, the S (horizontal) axis of the texture should be parallel with the X axis, and the T (vertical) axis should be parallel with the Z axis. When viewed from the top, S texture values should increase to the right, and T values should increase upward. For the bottom of the box, the S (horizontal) axis of the texture should be parallel with the X axis, and the T (vertical) axis should be parallel with the Z axis. When viewed from the bottom, S values should increase to the right, and T values should incrase upward."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/texture_256jpg.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("texture_256jpg.x3d"))
    ...
    {
        X3D thisExampleX3dModel = new texture_256jpg().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.texture_256jpg\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.texture_256jpg\" self-validation test results: ");

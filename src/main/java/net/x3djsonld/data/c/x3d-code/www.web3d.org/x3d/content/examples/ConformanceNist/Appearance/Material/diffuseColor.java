...
/**
 * <p> Test diffuseColor on primitive geometry. Five diffuseColor values of black, red, green, blue and white are applied from left to right for primitive geometry. The geometry consists of a row of 5 Cones, followed by a row of 5 Cylinders, 5 Spheres, then 5 Boxes. The result is a range of diffuseColor that begins with a black geometry on the left, followed by red, green blue and white geometry on the right, for all four primitive types. </p>
 <p> Related links: <a href="../../../../Appearance/Material/diffuseColor.java">diffuseColor.java</a> source, <a href="../../../../Appearance/Material/diffuseColorIndex.html" target="_top">diffuseColor catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Material/diffuseColor.x3d">diffuseColor.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Material/diffuseColor-front.jpg">diffuseColor-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Material/diffuseColor-rear.jpg">diffuseColor-rear.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test diffuseColor on primitive geometry. Five diffuseColor values of black, red, green, blue and white are applied from left to right for primitive geometry. The geometry consists of a row of 5 Cones, followed by a row of 5 Cylinders, 5 Spheres, then 5 Boxes. The result is a range of diffuseColor that begins with a black geometry on the left, followed by red, green blue and white geometry on the right, for all four primitive types. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/diffuseColor.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/diffuseColor.x3d</a> </td>
		</tr>
		<tr>
...
public class diffuseColor
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("diffuseColor-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("diffuseColor-rear.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test diffuseColor on primitive geometry. Five diffuseColor values of black, red, green, blue and white are applied from left to right for primitive geometry. The geometry consists of a row of 5 Cones, followed by a row of 5 Cylinders, 5 Spheres, then 5 Boxes. The result is a range of diffuseColor that begins with a black geometry on the left, followed by red, green blue and white geometry on the right, for all four primitive types."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/diffuseColor.x3d"))
  ...
  .setScene(new Scene()
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.diffuseColor\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.diffuseColor\" self-validation test results: ");

...
/**
 * <p> Test emissiveColor on primitive geometry. Five emissiveColor values of black, red, green, blue and white are applied from left to right for primitive geometry. The geometry consists of a row of 5 Cones, followed by a row of 5 Cylinders, 5 Spheres, then 5 Boxes. The result is a range of emissiveColor that begins with a black geometry on the left, followed by red, green blue and white geometry on the right, for all four primitive types. </p>
 <p> Related links: <a href="../../../../Appearance/Material/emissiveColor.java">emissiveColor.java</a> source, <a href="../../../../Appearance/Material/emissiveColorIndex.html" target="_top">emissiveColor catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Material/emissiveColor.x3d">emissiveColor.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Material/emissiveColor-front.jpg">emissiveColor-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Material/emissiveColor-rear.jpg">emissiveColor-rear.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test emissiveColor on primitive geometry. Five emissiveColor values of black, red, green, blue and white are applied from left to right for primitive geometry. The geometry consists of a row of 5 Cones, followed by a row of 5 Cylinders, 5 Spheres, then 5 Boxes. The result is a range of emissiveColor that begins with a black geometry on the left, followed by red, green blue and white geometry on the right, for all four primitive types </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/emissiveColor.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/emissiveColor.x3d</a> </td>
		</tr>
		<tr>
...
public class emissiveColor
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("emissiveColor-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("emissiveColor-rear.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test emissiveColor on primitive geometry. Five emissiveColor values of black, red, green, blue and white are applied from left to right for primitive geometry. The geometry consists of a row of 5 Cones, followed by a row of 5 Cylinders, 5 Spheres, then 5 Boxes. The result is a range of emissiveColor that begins with a black geometry on the left, followed by red, green blue and white geometry on the right, for all four primitive types"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/emissiveColor.x3d"))
  ...
  .setScene(new Scene()
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.emissiveColor\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.emissiveColor\" self-validation test results: ");

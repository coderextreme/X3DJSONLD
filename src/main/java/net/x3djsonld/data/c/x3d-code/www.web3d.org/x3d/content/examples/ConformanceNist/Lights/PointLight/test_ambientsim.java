 ...
 * <p> Test browser to set the ambientIntensity field to a range of values on simple geometry (cone, sphere, cylinder and box). One row of the simple geometry is drawn in the local coordinate system. The ambientIntensity of the light should increase as the animation progresses. The animation is started by clicking on the text above the geometry. The ambientIntensity values range from 0 to 1. </p>
 <p> Related links: <a href="../../../..test_ambientsim.java">test_ambientsim.java</a> source, <a href="../../../..test_ambientsimIndex.html" target="_top">test_ambientsim catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../..test_ambientsim.x3d">test_ambientsim.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../..test-ambientsim-movie.mpg">test-ambientsim-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test-ambientsim.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test-ambientsim.x3d</a> </td>
		</tr>
		<tr>
...
public class test_ambientsim
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test-ambientsim.x3d"))

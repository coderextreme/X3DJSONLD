...
public class PyruvicAcid
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("PyruvicAcid.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of PyruvicAcid.x3d scene produced from PyruvicAcid.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("PyruvicAcid.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/PyruvicAcid.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("PyruvicAcid.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect PyruvicAcid").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"Pyruvic Acid: C3 H4 O3"}))))
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"molecule weight: 88.06"}))))
      .addChild(new Transform().setTranslation(0.0,4.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"melting point: 12"}))))
      .addChild(new Transform().setTranslation(0.0,3.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"boiling point: 165"}))))
      .addChild(new Transform().setTranslation(0.0,2.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"specific gravity: 1.265"})))))
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "pyruvic_acid_a1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.2732,0.8302,0.9936)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "pyruvic_acid_a2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.6424,1.5034,0.9854)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "pyruvic_acid_a3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.5974,2.9991,0.9011)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "pyruvic_acid_a4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.6572,0.847,1.0232)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "pyruvic_acid_a5").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.8508,0.4234,2.2078)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "pyruvic_acid_a6").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.5294,0.64,0.052))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "pyruvic_acid_b1").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.2732,0.8302,0.9936,2.6424,1.5034,0.9854})))))
      .addChild(new ProtoInstance("line", "pyruvic_acid_b2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.2732,0.8302,0.9936,0.8508,0.4234,2.2078})))))
      .addChild(new ProtoInstance("line", "pyruvic_acid_b3").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.2532,0.8302,0.9936,0.5094,0.64,0.052})))))
      .addChild(new ProtoInstance("line", "pyruvic_acid_b3_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.2932000000000001,0.8302,0.9936,0.5494,0.64,0.052})))))
      .addChild(new ProtoInstance("line", "pyruvic_acid_b4").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.6424,1.5034,0.9854,2.5974,2.9991,0.9011})))))
      .addChild(new ProtoInstance("line", "pyruvic_acid_b5").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.6224,1.5034,0.9854,3.6372,0.847,1.0232})))))
      .addChild(new ProtoInstance("line", "pyruvic_acid_b5_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.6624,1.5034,0.9854,3.6772,0.847,1.0232})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new PyruvicAcid().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.PyruvicAcid\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.PyruvicAcid\" self-validation test results: ");

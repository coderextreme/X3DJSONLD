 ...
 * <p> This test defines a Transform that specifies an offset along the Y axis from the center of the local coordinate system. The test should draw three cylinders, one at the center of the local coordinate system, one at the bottom and one at the top rotated 1.57 radians along the Z axis. following is the main parent transform with center at origin. </p>
 <p> Related links: <a href="../../../../GroupingNodes/Transform/test_centerY.java">test_centerY.java</a> source, <a href="../../../../GroupingNodes/Transform/test_centerYIndex.html" target="_top">test_centerY catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GroupingNodes/Transform/test_centerY.x3d">test_centerY.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GroupingNodes/Transform/test-centerY-front.jpg">test-centerY-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GroupingNodes/Transform/test-centerY-left.jpg">test-centerY-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GroupingNodes/Transform/test-centerY-right.jpg">test-centerY-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Transform/test_centerY.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Transform/test_centerY.x3d</a> </td>
		</tr>
		<tr>
...
public class test_centerY
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_centerY.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-centerY-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-centerY-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-centerY-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Transform/test_centerY.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_centerY.x3d"))
    ...
    .addChild(new Transform()
      ...
      .addChild(new Transform().setCenter(0.0,-3.0,0.0).setRotation(0.0,0.0,1.0,1.57)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material()))
          .setGeometry(new Cylinder().setHeight(4).setRadius(0.5))))
    ...
    {
        X3D thisExampleX3dModel = new test_centerY().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_centerY\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_centerY\" self-validation test results: ");

 ...
 * <p> Test browser to associate extra entries in the range field with the last entry in the levels field. The test specifies four different range values that indicate at what distance to display the corresponding entry from the level field. The second, third and fourth entries in the range field does not contain a corresponding entry in the level field and therefore should always be associated with the entry named ref2.x3d in the level field regardless of the users avatar location. Each of the two entries in the level field adds a level of detail to the figure in question as the users avatar gets closer to the figure. The distance of the viewer from the object is changed by clicking on the desired buttom as indicated by the text displayed. The test should generate a figure that resembles a temple with white columns, a (this is the figure that is displayed when the highest level of detail is selected. Other levels display a version of the same figure, but with much less details.). </p>
 <p> Related links: <a href="../../../../SpecialGroups/LOD/few_levels.java">few_levels.java</a> source, <a href="../../../../SpecialGroups/LOD/few_levelsIndex.html" target="_top">few_levels catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/LOD/few_levels.x3d">few_levels.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/few_levels.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/few_levels.x3d</a> </td>
		</tr>
		<tr>
...
public class few_levels
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("few_levels.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/few_levels.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("few_levels.x3d"))
    ...
    .addChild(new Transform().setRotation(1.0,0.0,0.0,0.15)
      .addChild(new LOD("intentionally-too-few").setRange(new double[] {17.0,33.0,49.0,55.0})
    ...
    {
        X3D thisExampleX3dModel = new few_levels().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.few_levels\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.few_levels\" self-validation test results: ");

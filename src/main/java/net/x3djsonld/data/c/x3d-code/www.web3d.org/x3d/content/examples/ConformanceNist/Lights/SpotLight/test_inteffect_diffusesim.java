 ...
 * <p> This test addresses the effect of the light intensity on the diffuse color of simple geometry. One row of simple geometry is drawn in the local coordinate system and a SpotLight is also defined with radius 50 and intensity 0 at location 0 0 10. The test starts by clicking on the text above the geometry. The intensity of the light is increased as the test progresses and the diffuse color brightness of the objects should also increase. Intensity ranges from 0 to 1. The geometry are originally defined with a diffuseColor of 0 0 1. </p>
 <p> Related links: <a href="../../../../Lights/SpotLight/test_inteffect_diffusesim.java">test_inteffect_diffusesim.java</a> source, <a href="../../../../Lights/SpotLight/test_inteffect_diffusesimIndex.html" target="_top">test_inteffect_diffusesim catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/SpotLight/test_inteffect_diffusesim.x3d">test_inteffect_diffusesim.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Lights/SpotLight/test-inteffect-diffusesim-movie.mpg">test-inteffect-diffusesim-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_inteffect_diffusesim.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_inteffect_diffusesim.x3d</a> </td>
		</tr>
		<tr>
...
public class test_inteffect_diffusesim
{
	/** Default constructor to create this object. */
	public test_inteffect_diffusesim ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_inteffect_diffusesim.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("test-inteffect-diffusesim-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_inteffect_diffusesim.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_inteffect_diffusesim.x3d"))
    .addChild(new Group()
    ...
    .addChild(new Transform().setScale(0.02,0.02,0.02).setTranslation(-2.3,2.7,0.0)
      .addChild(new Shape()
	 ...
	 * @return test_inteffect_diffusesim model
	 */
    ...
    {
        X3D thisExampleX3dModel = new test_inteffect_diffusesim().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_inteffect_diffusesim\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_inteffect_diffusesim\" self-validation test results: ");

...
/**
 * <p> Test an Anchor to a single URL. This test defines an Anchor node with three Shape node as children. All children are associated with the same url. It basically test the ability of a browser to associate a single url entry with multiple blue box (with some text on top of it). No viewpoints are associated. </p>
 <p> Related links: <a href="../../../../GroupingNodes/Anchor/test_mult_singleurl.java">test_mult_singleurl.java</a> source, <a href="../../../../GroupingNodes/Anchor/test_mult_singleurlIndex.html" target="_top">test_mult_singleurl catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GroupingNodes/Anchor/test_mult_singleurl.x3d">test_mult_singleurl.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test an Anchor to a single URL. This test defines an Anchor node with three Shape node as children. All children are associated with the same url. It basically test the ability of a browser to associate a single url entry with multiple blue box (with some text on top of it). No viewpoints are associated </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/test_mult_singleurl.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/test_mult_singleurl.x3d</a> </td>
		</tr>
		<tr>
...
public class test_mult_singleurl
{
	/** Default constructor to create this object. */
	public test_mult_singleurl ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_mult_singleurl.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test an Anchor to a single URL. This test defines an Anchor node with three Shape node as children. All children are associated with the same url. It basically test the ability of a browser to associate a single url entry with multiple blue box (with some text on top of it). No viewpoints are associated"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/test_mult_singleurl.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_mult_singleurl.x3d"))
    ...
    .addChild(new Transform().setTranslation(0.0,2.0,0.0)
      .addChild(new Shape()
        ...
        .setGeometry(new Text().setString(new String[] {"CLICK ANY SPHERE TO START"})
          .setFontStyle(new FontStyle().setJustify(FontStyle.JUSTIFY_MIDDLE_MIDDLE)))))
    .addChild(new Anchor().setDescription("Multiple chlidren referencing same URL").setUrl(new String[] {"singleurl.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/singleurl.x3d","singleurl.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/singleurl.wrl"})
	 ...
	 * @return test_mult_singleurl model
	 */
    ...
    {
        X3D thisExampleX3dModel = new test_mult_singleurl().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_mult_singleurl\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_mult_singleurl\" self-validation test results: ");

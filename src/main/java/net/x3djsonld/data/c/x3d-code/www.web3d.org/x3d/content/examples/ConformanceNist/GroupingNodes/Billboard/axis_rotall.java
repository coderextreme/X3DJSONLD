 ...
 <p> Related links: <a href="../../../../GroupingNodes/Billboard/axis_rotall.java">axis_rotall.java</a> source, <a href="../../../../GroupingNodes/Billboard/axis_rotallIndex.html" target="_top">axis_rotall catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GroupingNodes/Billboard/axis_rotall.x3d">axis_rotall.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GroupingNodes/Billboard/axis-rotall-front.jpg">axis-rotall-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test defines a Billboard node with two shapes (two Boxes and text) with a rotation axis about all axis (special value of 0 0 0 for the axisOfRotation field). The Billboard should always face the viewer when rotated along any axis. The test should generate a Billboard consisting of two boxes and the string of text "Viewer-alignment". </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Billboard/axis_rotall.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Billboard/axis_rotall.x3d</a> </td>
		</tr>
		<tr>
...
public class axis_rotall
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("axis_rotall.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("axis-rotall-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Billboard/axis_rotall.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("axis_rotall.x3d"))
    ...
    .addChild(new Group()
      ...
      .addChild(new Viewpoint().setDescription("Top View").setOrientation(1.0,0.0,0.0,-1.57).setPosition(0.0,12.0,0.0))
      .addChild(new Viewpoint().setDescription("Bottom View").setOrientation(1.0,0.0,0.0,1.57).setPosition(0.0,-12.0,0.0)))
    .addChild(new Billboard().setAxisOfRotation(0.0,0.0,0.0)
      .addChild(new Transform().setTranslation(0.0,2.0,0.3)
        .addChild(new Shape()
          ...
          .setGeometry(new Text().setString(new String[] {"viewer-alignment"})
    ...
    {
        X3D thisExampleX3dModel = new axis_rotall().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.axis_rotall\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.axis_rotall\" self-validation test results: ");

...
/**
 * <p> Map a PixelTexture A PixelTexture consisting of a square checkerboard of blue (lower left quadrant), yellow (lower right), red (upper right) and green (upper left) to an ElevationGrid. An ElevationGrid is default texture mapped by aligning the +S (horizontal) axis of the PixelTexture with the +X axis of the ElevationGrid and the +T (vertical) axis of the PixelTexture with the +Z axis of the ElevationGrid. The bottom of the PixelTexture coincides with the first row of grid points (along the rear of the ElevationGrid) and the top of the PixelTexture maps to the last row of grid points (along the front). </p>
 <p> Related links: <a href="../../../../Appearance/TextureTransform/elevationgrid_pixeltexture.java">elevationgrid_pixeltexture.java</a> source, <a href="../../../../Appearance/TextureTransform/elevationgrid_pixeltextureIndex.html" target="_top">elevationgrid_pixeltexture catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/TextureTransform/elevationgrid_pixeltexture.x3d">elevationgrid_pixeltexture.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/elevationgrid_pixeltexture-front.jpg">elevationgrid_pixeltexture-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/elevationgrid_pixeltexture-rear.jpg">elevationgrid_pixeltexture-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/elevationgrid_pixeltexture-top.jpg">elevationgrid_pixeltexture-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/elevationgrid_pixeltexture-bottom.jpg">elevationgrid_pixeltexture-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/elevationgrid_pixeltexture-left.jpg">elevationgrid_pixeltexture-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/elevationgrid_pixeltexture-right.jpg">elevationgrid_pixeltexture-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Map a PixelTexture A PixelTexture consisting of a square checkerboard of blue (lower left quadrant), yellow (lower right), red (upper right) and green (upper left) to an ElevationGrid. An ElevationGrid is default texture mapped by aligning the +S (horizontal) axis of the PixelTexture with the +X axis of the ElevationGrid and the +T (vertical) axis of the PixelTexture with the +Z axis of the ElevationGrid. The bottom of the PixelTexture coincides with the first row of grid points (along the rear of the ElevationGrid) and the top of the PixelTexture maps to the last row of grid points (along the front). </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/elevationgrid_pixeltexture.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/elevationgrid_pixeltexture.x3d</a> </td>
		</tr>
		<tr>
...
public class elevationgrid_pixeltexture
{
	/** Default constructor to create this object. */
	public elevationgrid_pixeltexture ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("elevationgrid_pixeltexture.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("elevationgrid_pixeltexture-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("elevationgrid_pixeltexture-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("elevationgrid_pixeltexture-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("elevationgrid_pixeltexture-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("elevationgrid_pixeltexture-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("elevationgrid_pixeltexture-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Map a PixelTexture A PixelTexture consisting of a square checkerboard of blue (lower left quadrant), yellow (lower right), red (upper right) and green (upper left) to an ElevationGrid. An ElevationGrid is default texture mapped by aligning the +S (horizontal) axis of the PixelTexture with the +X axis of the ElevationGrid and the +T (vertical) axis of the PixelTexture with the +Z axis of the ElevationGrid. The bottom of the PixelTexture coincides with the first row of grid points (along the rear of the ElevationGrid) and the top of the PixelTexture maps to the last row of grid points (along the front)."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/elevationgrid_pixeltexture.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("elevationgrid_pixeltexture.x3d"))
    .addChild(new Group()
	 ...
	 * @return elevationgrid_pixeltexture model
	 */
    ...
    {
        X3D thisExampleX3dModel = new elevationgrid_pixeltexture().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.elevationgrid_pixeltexture\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.elevationgrid_pixeltexture\" self-validation test results: ");

 ...
 * <p> This is a test of a PROTO to route events internally within its PROTO body. A blue Sphere geometry has a TouchSensor associated with it. An SFBool field is generated each time the pointing device passes over the geometry. This event is internally routed the the "on" field of a DirectionalLight. The result is: Each time the pointing device passes over the geometry, the blue Sphere should be illuminated. </p>
 <p> Related links: <a href="../../../../Miscellaneous/PROTO/route_inside.java">route_inside.java</a> source, <a href="../../../../Miscellaneous/PROTO/route_insideIndex.html" target="_top">route_inside catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Miscellaneous/PROTO/route_inside.x3d">route_inside.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/PROTO/route_inside.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/PROTO/route_inside.x3d</a> </td>
		</tr>
		<tr>
...
public class route_inside
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("route_inside.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/PROTO/route_inside.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("route_inside.x3d"))
    .addChild(new ProtoDeclare("BallProto").setName("BallProto")
      .setProtoBody(new ProtoBody()
        .addChild(new Group()
          .addChild(new DirectionalLight("LIGHT").setOn(false))
          .addChild(new TouchSensor("TOUCH_SENSOR").setDescription("pointer over geometry enables DirectionalLight"))
          .addChild(new Transform()
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(0.0,0.0,1.0)))
              .setGeometry(new Sphere().setRadius(3)))))
        .addChild(new ROUTE().setFromNode("TOUCH_SENSOR").setFromField("isOver").setToNode("LIGHT").setToField("on"))))
    .addChild(new Group()
      .addChild(new Group()
        .addChild(new NavigationInfo().setType("\"EXAMINE\" \"WALK\" \"FLY\" \"ANY\""))
        .addChild(new Viewpoint().setDescription("Front View").setPosition(0.0,0.0,40.0))
    ...
    {
        X3D thisExampleX3dModel = new route_inside().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.route_inside\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.route_inside\" self-validation test results: ");

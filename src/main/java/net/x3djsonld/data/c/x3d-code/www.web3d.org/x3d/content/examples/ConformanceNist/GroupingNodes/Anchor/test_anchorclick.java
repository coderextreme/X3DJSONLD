...
/**
 * <p> This is a collateral file used for other tests of the Anchor node. </p>
 <p> Related links: <a href="../../../../GroupingNodes/Anchor/test_anchorclick.java">test_anchorclick.java</a> source, <a href="../../../../GroupingNodes/Anchor/test_anchorclickIndex.html" target="_top">test_anchorclick catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GroupingNodes/Anchor/test_anchorclick.x3d">test_anchorclick.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This is a collateral file used for other tests of the Anchor node. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/test_anchorclick.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/test_anchorclick.x3d</a> </td>
		</tr>
		<tr>
...
public class test_anchorclick
{
	/** Default constructor to create this object. */
	public test_anchorclick ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_anchorclick.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("This is a collateral file used for other tests of the Anchor node."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/test_anchorclick.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_anchorclick.x3d"))
    ...
    .addChild(new Transform().setTranslation(0.0,3.5,0.0)
      .addChild(new Shape()
        ...
        .setGeometry(new Text().setString(new String[] {"A RED BOX BELOW INDICATES THAT","THIS BROWSER PASSED THIS TEST"})
          .setFontStyle(new FontStyle().setJustify(FontStyle.JUSTIFY_MIDDLE_MIDDLE)))))
    .addChild(new Shape()
      .setAppearance(new Appearance()
        .setMaterial(new Material().setDiffuseColor(1.0,0.0,0.0).setEmissiveColor(1.0,0.0,0.0)))
      .setGeometry(new Box().setSize(4.0,3.0,3.0))));
    }
    ...
    {
        X3D thisExampleX3dModel = new test_anchorclick().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_anchorclick\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_anchorclick\" self-validation test results: ");

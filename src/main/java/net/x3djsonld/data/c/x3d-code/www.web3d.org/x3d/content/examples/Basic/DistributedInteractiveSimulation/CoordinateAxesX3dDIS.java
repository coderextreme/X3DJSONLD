...
/**
 * <p> X Y Z axis arrows and labels in X3D and DIS coordinate systems. See CoordinateAxesExample for use as an Inline coordinate-system reference frame. </p>
 <p> Related links: <a href="../../../DistributedInteractiveSimulation/CoordinateAxesX3dDIS.java">CoordinateAxesX3dDIS.java</a> source, <a href="../../../DistributedInteractiveSimulation/CoordinateAxesX3dDISIndex.html" target="_top">CoordinateAxesX3dDIS catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../DistributedInteractiveSimulation/CoordinateAxesX3dDIS.x3d">CoordinateAxesX3dDIS.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> X Y Z axis arrows and labels in X3D and DIS coordinate systems. See CoordinateAxesExample for use as an Inline coordinate-system reference frame. </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/CoordinateAxesX3dDIS.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/CoordinateAxesX3dDIS.x3d</a> </td>
		</tr>
		<tr>
...
public class CoordinateAxesX3dDIS
{
	/** Default constructor to create this object. */
	public CoordinateAxesX3dDIS ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("CoordinateAxesX3dDIS.x3d"))
    .addMeta(new meta().setName(meta.NAME_CREATOR    ).setContent("Don Brutzman"))
    .addMeta(new meta().setName(meta.NAME_CREATED    ).setContent("14 July 2000"))
    .addMeta(new meta().setName(meta.NAME_MODIFIED   ).setContent("20 October 2019"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("X Y Z axis arrows and labels in X3D and DIS coordinate systems. See CoordinateAxesExample for use as an Inline coordinate-system reference frame."))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/CoordinateAxesX3dDIS.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new WorldInfo().setTitle("CoordinateAxesX3dDIS.x3d"))
    .addChild(new Group()
    ...
    .addChild(new Transform().setRotation(0.0,0.0,1.0,-1.57079)
      ...
      .addChild(new Group()
        ...
        .addChild(new Transform().setRotation(0.0,0.0,1.0,1.57079).setTranslation(-0.05,1.1,0.0)
          .addComments(" note label rotated back to original coordinate frame ")
          .addChild(new Billboard()
            .addChild(new Shape()
              .setAppearance(new Appearance().setUSE("LABEL_APPEARANCE"))
              .setGeometry(new Text().setString(new String[] {"North","+X X3D","+X DIS"})
      ...
      .addChild(new Group()
        ...
        .addChild(new Transform().setRotation(1.0,0.0,0.0,-1.57079).setTranslation(0.0,1.1,-0.05)
          ...
          .addChild(new Billboard()
            .addChild(new Shape()
              .setAppearance(new Appearance().setUSE("LABEL_APPEARANCE"))
              .setGeometry(new Text().setString(new String[] {"East","+Z X3D","+Y DIS"})
                .setFontStyle(new FontStyle().setUSE("LABEL_FONT")))))))));
    }
	 ...
	 * @return CoordinateAxesX3dDIS model
	 */
    ...
    {
        X3D thisExampleX3dModel = new CoordinateAxesX3dDIS().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.CoordinateAxesX3dDIS\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.CoordinateAxesX3dDIS\" self-validation test results: ");

...
/**
 * <p> Volume rendering of a CT scan of a backpack and contents, rendered with composed edge and silhouette render styles. </p>
 <p> Related links: <a href="../../../VolumeRendering/ComposedBackpack.java">ComposedBackpack.java</a> source, <a href="../../../VolumeRendering/ComposedBackpackIndex.html" target="_top">ComposedBackpack catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../VolumeRendering/ComposedBackpack.x3d">ComposedBackpack.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> Volume rendering of a CT scan of a backpack and contents, rendered with composed edge and silhouette render styles. </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/ComposedBackpack.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/ComposedBackpack.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
...
public class ComposedBackpack
{
	/** Default constructor to create this object. */
	public ComposedBackpack ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("ComposedBackpack.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Volume rendering of a CT scan of a backpack and contents, rendered with composed edge and silhouette render styles."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ComposedBackpack.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/ComposedBackpack.x3d"))
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("ComposedBackpack.x3d"))
    .addChild(new Group()
      .addChild(new Viewpoint("VP").setDescription("Composed Backpack").setOrientation(-0.981013,-0.121179,-0.151425,4.93207).setPosition(0.0469256,-0.208028,0.0503946))
      ...
      .addChild(new Transform().setScale(0.117188,0.117188,0.117188)
        .addChild(new VolumeData()
          .setRenderStyle(new ComposedVolumeStyle()
            .addRenderStyle(new SilhouetteEnhancementVolumeStyle().setSilhouetteBoundaryOpacity(1).setSilhouetteRetainedOpacity(.1).setSilhouetteSharpness(10))
            .addRenderStyle(new EdgeEnhancementVolumeStyle().setEdgeColor(.5,0.0,0.0,1.0).setGradientThreshold(.8)))
    ...
    {
        X3D thisExampleX3dModel = new ComposedBackpack().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.ComposedBackpack\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.ComposedBackpack\" self-validation test results: ");

 ...
 * <p> This test addresses the effect of the PointLight ambientIntensity on the ambient of a complex object (IndexedFaceSet). Two IndexedFaceSets are drawn in the local coordinate system and a PointLight is defined to shine on them along the -Z axis. The IndexedFaceSet to the left contains an ambientIntensity 0.3 and the one to the right contains an initial ambientIntensity of 1. The ambientIntensity of the light is increased on both geometry as the animation progresses. Since both materials ambientIntensity are constants, at the end of the animation the one to the right will be brigther than the one to the left. This is because at the end of the animation the figure to the right will have maximum ambient (both material and light ambientIntensity will be 1). </p>
 <p> Related links: <a href="../../../../Lights/PointLight/test_ambeffect_ambientcom.java">test_ambeffect_ambientcom.java</a> source, <a href="../../../../Lights/PointLight/test_ambeffect_ambientcomIndex.html" target="_top">test_ambeffect_ambientcom catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/PointLight/test_ambeffect_ambientcom.x3d">test_ambeffect_ambientcom.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Lights/PointLight/test-ambeffect-ambientcom-movie.mpg">test-ambeffect-ambientcom-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_ambeffect_ambientcom.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_ambeffect_ambientcom.x3d</a> </td>
		</tr>
		<tr>
...
public class test_ambeffect_ambientcom
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_ambeffect_ambientcom.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Group()
      .addChild(new PointLight("the-light").setAmbientIntensity(0.2).setIntensity(0.5).setLocation(0.0,0.0,10.0).setRadius(50))

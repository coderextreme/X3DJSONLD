 ...
 <p> Related links: <a href="../../../../Appearance/ImageTexture/rgb_alpha_png.java">rgb_alpha_png.java</a> source, <a href="../../../../Appearance/ImageTexture/rgb_alpha_pngIndex.html" target="_top">rgb_alpha_png catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/ImageTexture/rgb_alpha_png.x3d">rgb_alpha_png.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/rgb_alpha_png-front.jpg">rgb_alpha_png-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/rgb_alpha_png-rear.jpg">rgb_alpha_png-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/rgb_alpha_png-top.jpg">rgb_alpha_png-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/rgb_alpha_png-bottom.jpg">rgb_alpha_png-bottom.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser ability to map an RGB PNG file (with background alpha-transparency set to 0 for the two left geometry, and binary transparency onto the faces of primative onto a sphere (RGB plus alpha), cone (RGB plus alpha), cylinder (RGB plus transparency) and box (palette plus transparency). Because the image background is transparent, all geometry, except for the cover the entire surface, and wrap counterclockwise from the back of the sphere. For the cone, the texture should wrap counterclockwise (from above) starting at the back of the cone. A circle cutout of the texture is applied right side up to the base of the cone when the cone is tilted toward the -z axis. For the cylinder, the texture should wrap counterclockwise (from above) starting at the back of the cylinder. A circle cutout of the texture is applied right side up to the top and bottom caps of the cylinder. For the box, the texture should be applied right side up in its entirety to each face of the box. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/rgb_alpha_png.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/rgb_alpha_png.x3d</a> </td>
		</tr>
		<tr>
...
public class rgb_alpha_png
{
	/** Default constructor to create this object. */
	public rgb_alpha_png ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("rgb_alpha_png.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("rgb_alpha_png-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("rgb_alpha_png-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("rgb_alpha_png-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("rgb_alpha_png-bottom.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test browser ability to map an RGB PNG file (with background alpha-transparency set to 0 for the two left geometry, and binary transparency onto the faces of primative onto a sphere (RGB plus alpha), cone (RGB plus alpha), cylinder (RGB plus transparency) and box (palette plus transparency). Because the image background is transparent, all geometry, except for the cover the entire surface, and wrap counterclockwise from the back of the sphere. For the cone, the texture should wrap counterclockwise (from above) starting at the back of the cone. A circle cutout of the texture is applied right side up to the base of the cone when the cone is tilted toward the -z axis. For the cylinder, the texture should wrap counterclockwise (from above) starting at the back of the cylinder. A circle cutout of the texture is applied right side up to the top and bottom caps of the cylinder. For the box, the texture should be applied right side up in its entirety to each face of the box."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/rgb_alpha_png.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("rgb_alpha_png.x3d"))
    ...
    {
        X3D thisExampleX3dModel = new rgb_alpha_png().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.rgb_alpha_png\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.rgb_alpha_png\" self-validation test results: ");

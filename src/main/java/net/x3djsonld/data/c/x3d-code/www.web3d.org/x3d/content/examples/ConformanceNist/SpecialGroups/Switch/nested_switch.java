...
/**
 * <p> Test browser to nest Switch node. A Switch node is defined with two items in its "choice" field. The second item is in turn another Switch node with one item in its "choice" field (which is selected). The outer Switch then selects the second item (the inside Switch node) in its "whichChoice" field. The test should generate a green box with some text on top of it. If a red box is generated, then a failure occurred. </p>
 <p> Related links: <a href="../../../../SpecialGroups/Switch/nested_switch.java">nested_switch.java</a> source, <a href="../../../../SpecialGroups/Switch/nested_switchIndex.html" target="_top">nested_switch catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/Switch/nested_switch.x3d">nested_switch.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../SpecialGroups/Switch/nested-switch-front.jpg">nested-switch-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser to nest Switch node. A Switch node is defined with two items in its "choice" field. The second item is in turn another Switch node with one item in its "choice" field (which is selected). The outer Switch then selects the second item (the inside Switch node) in its "whichChoice" field. The test should generate a green box with some text on top of it. If a red box is generated, then a failure occurred. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Switch/nested_switch.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Switch/nested_switch.x3d</a> </td>
		</tr>
		<tr>
...
public class nested_switch
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("nested_switch.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("nested-switch-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Switch/nested_switch.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("nested_switch.x3d"))
    ...
    {
        X3D thisExampleX3dModel = new nested_switch().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.nested_switch\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.nested_switch\" self-validation test results: ");

 ...
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/jumpcut_loadurl.java">jumpcut_loadurl.java</a> source, <a href="../../../../BindableNodes/Viewpoint/jumpcut_loadurlIndex.html" target="_top">jumpcut_loadurl catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/jumpcut_loadurl.x3d">jumpcut_loadurl.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test jumpcut transition with LoadUrl method. A Script node with a call to the "loadURL" method, with a url corresponding to the MFString "Top_View" (the name of a Viewpoint in this world) should create a "jump cut" transition of views when the Box geometry in this world is indicated by the pointing device. As a result, indicating the Box geometry should result in a Viewpoint transition to the top view of the Box geometry, and the viewer should see a cubic geometry with the word TOP displayed on the face of the cube. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadurl.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadurl.x3d</a> </td>
		</tr>
		<tr>
...
public class jumpcut_loadurl
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test jumpcut transition with LoadUrl method. A Script node with a call to the \"loadURL\" method, with a url corresponding to the MFString \"Top_View\" (the name of a Viewpoint in this world) should create a \"jump cut\" transition of views when the Box geometry in this world is indicated by the pointing device. As a result, indicating the Box geometry should result in a Viewpoint transition to the top view of the Box geometry, and the viewer should see a cubic geometry with the word TOP displayed on the face of the cube."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadurl.x3d"))
    ...
    .addChild(new Transform("ROOT")
      ...
      .addChild(new Shape()
        ...
        .setGeometry(new IndexedFaceSet().setCoordIndex(new int[] {0,6,7,1,-1}).setTexCoordIndex(new int[] {3,0,1,2,-1})
          .setCoord(new Coordinate().setUSE("UnitCube"))
          .setTexCoord(new TextureCoordinate().setUSE("SquareTexCoord")))))
    .addChild(new Script("MYSCRIPT").setUrl(new String[] {"jumpcut_loadurl.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadurl.js"})
      .addField(new field().setName("myurl").setType(field.TYPE_MFSTRING).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(new String[] {"jumpcut_loadurl.x3d#Top_View","jumpcut_loadurl.wrl#Top_View"}))
      .addField(new field().setName("myparameter").setType(field.TYPE_MFSTRING).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(new String[] {"target=_blank"}))

 ...
 <p> Related links: <a href="../../../../BindableNodes/Fog/default_fog.java">default_fog.java</a> source, <a href="../../../../BindableNodes/Fog/default_fogIndex.html" target="_top">default_fog catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Fog/default_fog.x3d">default_fog.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../BindableNodes/Fog/default-movie.mpg">default-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test default Fog properties. A Fog node with a default visibilityRange of "0" is present in this world. A Box geometry moves forward and backward through the world. Because the default value of the "visibilityRange" field is "0", all Fog properties should be disabled. The result should be: Fog is disabled in this world, and the white Box should have a constant white intensity as it moves backward and forward through the world. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Fog/default_fog.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Fog/default_fog.x3d</a> </td>
		</tr>
		<tr>
...
public class default_fog
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("default_fog.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test default Fog properties. A Fog node with a default visibilityRange of \"0\" is present in this world. A Box geometry moves forward and backward through the world. Because the default value of the \"visibilityRange\" field is \"0\", all Fog properties should be disabled. The result should be: Fog is disabled in this world, and the white Box should have a constant white intensity as it moves backward and forward through the world."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Fog/default_fog.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("default_fog.x3d"))
    .addChild(new Fog())
    ...
    {
        X3D thisExampleX3dModel = new default_fog().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.default_fog\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.default_fog\" self-validation test results: ");

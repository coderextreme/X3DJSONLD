 ...
 * <p> Test browser to use its own algorithm when and empty range list is specified in the "range" field. The test "ref4.x3d". The range field specifies an empty list which indicates to the browser to use its own algoritmh to compute the proper distance to display the versions of the figure. Each of the two entries in the level field adds a level of detail to the figure in question as the users avatar gets closer to the figure. The distance of the viewer from the object is changed by clicking on the desired buttom as indicated by the text displayed. The test should generate a figure that resembles a temple with logo mapped to it (this is the figure that is displayed when the highest level of detail is selected. Other levels display a version of the same figure, but with much less details.). </p>
 <p> Related links: <a href="../../../../SpecialGroups/LOD/empty_range.java">empty_range.java</a> source, <a href="../../../../SpecialGroups/LOD/empty_rangeIndex.html" target="_top">empty_range catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/LOD/empty_range.x3d">empty_range.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/empty_range.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/empty_range.x3d</a> </td>
		</tr>
		<tr>
...
public class empty_range
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("empty_range.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/empty_range.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("empty_range.x3d"))
    .addChild(new NavigationInfo().setType("\"EXAMINE\" \"WALK\" \"FLY\" \"ANY\""))
    .addChild(new Group()
      .addChild(new Viewpoint("the-view").setDescription("user avatar position").setPosition(0.0,0.0,200.0)))
    .addChild(new Transform("big-trans1").setTranslation(0.0,0.0,190.0)
      .addChild(new Transform().setScale(0.02,0.02,0.02).setTranslation(-5.2,-2.0,0.0)
        .addChild(new Shape()
      ...
      .addChild(new Transform().setScale(0.02,0.02,0.02).setTranslation(-4.8,-2.7,0.0)
        .addChild(new Shape()
          ...
          .setGeometry(new Text().setString(new String[] {"LOWEST (0 0 200)"})
            .setFontStyle(new FontStyle().setUSE("the-style"))))
        .addChild(new TouchSensor("the-touch1").setDescription("touch 1")))
      .addChild(new Transform().setScale(0.02,0.02,0.02).setTranslation(-4.8,-3.4,0.0)
        .addChild(new Shape()
          ...
          .setGeometry(new Text().setString(new String[] {"MEDIUM LOW (0 0 90)"})
            .setFontStyle(new FontStyle().setUSE("the-style"))))
        .addChild(new TouchSensor("the-touch2").setDescription("touch 2")))
      .addChild(new Transform().setScale(0.02,0.02,0.02).setTranslation(1.0,-2.7,0.0)
        .addChild(new Shape()
          .setAppearance(new Appearance().setUSE("the-appearance"))
          .setGeometry(new Text().setString(new String[] {"MEDIUM (0 0 50)"})
            .setFontStyle(new FontStyle().setUSE("the-style"))))
        .addChild(new TouchSensor("the-touch3").setDescription("touch 3")))
      .addChild(new Transform().setScale(0.02,0.02,0.02).setTranslation(1.0,-3.4,0.0)
        .addChild(new Shape()
          .setAppearance(new Appearance().setUSE("the-appearance"))
          .setGeometry(new Text().setString(new String[] {"HIGHEST (0 0 15)"})
            .setFontStyle(new FontStyle().setUSE("the-style"))))
        .addChild(new TouchSensor("the-touch4").setDescription("touch 4"))))
    ...
    .addChild(new PositionInterpolator("first-position").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,200.0,0.0,0.0,200.0})))
    .addChild(new PositionInterpolator("second-position").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,90.0,0.0,0.0,90.0})))
    .addChild(new PositionInterpolator("third-position").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,50.0,0.0,0.0,50.0})))
    .addChild(new PositionInterpolator("fourth-position").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,15.0,0.0,0.0,15.0})))
    .addChild(new PositionInterpolator("text1").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,190.0,0.0,0.0,190.0})))
    .addChild(new PositionInterpolator("text2").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,80.0,0.0,0.0,80.0})))
    .addChild(new PositionInterpolator("text3").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,40.0,0.0,0.0,40.0})))
    .addChild(new PositionInterpolator("text4").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,5.0,0.0,0.0,5.0})))
    .addChild(new LOD().setCenter(-2.0,0.0,0.0)
      .addChild(new Transform().setRotation(1.0,0.0,0.0,0.15)
        .addChild(new Inline().setUrl(new String[] {"ref1.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/ref1.x3d","ref1.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/ref1.wrl"})))
      .addChild(new Inline().setUrl(new String[] {"ref2.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/ref2.x3d","ref2.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/ref2.wrl"}))
      .addChild(new Inline().setUrl(new String[] {"ref3.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/ref3.x3d","ref3.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/ref3.wrl"}))
      .addChild(new Inline().setUrl(new String[] {"ref4.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/ref4.x3d","ref4.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/ref4.wrl"})))
    ...
    {
        X3D thisExampleX3dModel = new empty_range().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.empty_range\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.empty_range\" self-validation test results: ");

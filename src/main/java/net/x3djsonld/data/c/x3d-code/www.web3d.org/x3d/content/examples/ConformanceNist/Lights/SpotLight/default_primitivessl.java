 ...
 * <p> Test browser to apply all the default values of a SpotLight node to simple geometry (cone, sphere, cylinder, box). A row containing all four simple geometry is drawn in the local coordinate system and a SpotLight node is defined at the beggining of the test. All figures should be illuminated with white light. </p>
 <p> Related links: <a href="../../../../Lights/SpotLight/default_primitivessl.java">default_primitivessl.java</a> source, <a href="../../../../Lights/SpotLight/default_primitivesslIndex.html" target="_top">default_primitivessl catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/SpotLight/default_primitivessl.x3d">default_primitivessl.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/SpotLight/default_primitivessl-front.jpg">default_primitivessl-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/SpotLight/default_primitivessl-top.jpg">default_primitivessl-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/SpotLight/default_primitivessl-left.jpg">default_primitivessl-left.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/default_primitivessl.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/default_primitivessl.x3d</a> </td>
		</tr>
		<tr>
...
public class default_primitivessl
{
	/** Default constructor to create this object. */
	public default_primitivessl ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("default_primitivessl.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("default_primitivessl-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("default_primitivessl-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("default_primitivessl-left.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/default_primitivessl.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("default_primitivessl.x3d"))
    .addChild(new Group()
    ...
    .addChild(new SpotLight().setBeamWidth(1.57079).setCutOffAngle(.785398))
    .addChild(new Transform().setTranslation(6.14221,0.0694613,-3.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Box())))
    .addChild(new Transform().setTranslation(-4.85443,0.0694381,-3.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Sphere())))
    .addChild(new Transform().setTranslation(-1.47341,0.036672,-3.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Cone())))
    .addChild(new Transform().setTranslation(2.31094,0.0694206,-3.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
	 ...
	 * @return default_primitivessl model
	 */
    ...
    {
        X3D thisExampleX3dModel = new default_primitivessl().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.default_primitivessl\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.default_primitivessl\" self-validation test results: ");

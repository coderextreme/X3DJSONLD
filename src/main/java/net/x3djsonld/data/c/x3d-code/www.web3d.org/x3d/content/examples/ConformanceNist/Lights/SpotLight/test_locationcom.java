 ...
 <p> Related links: <a href="../../../../Lights/SpotLight/test_locationcom.java">test_locationcom.java</a> source, <a href="../../../../Lights/SpotLight/test_locationcomIndex.html" target="_top">test_locationcom catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/SpotLight/test_locationcom.x3d">test_locationcom.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Lights/SpotLight/test-locationcom-movie.mpg">test-locationcom-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser to apply different location field values to a complex geometry (ElevationGrid). A set of ElevationGrids arranged in circular pattern along the XY plane are drawn in the local coordinate system. A SpotLight is defined at location 0 6 2 and its location field is changed as the animation progresses. The test is started by clicking on the tests above the geometry. The intensity is set to 1 and the cutOffAngle and beamWidth fields are set to 0.5 and 0.4 respectively. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_locationcom.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_locationcom.x3d</a> </td>
		</tr>
		<tr>
...
public class test_locationcom
{
	/** Default constructor to create this object. */
	public test_locationcom ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_locationcom.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("test-locationcom-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_locationcom.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_locationcom.x3d"))
    .addChild(new Group()
    ...
    .addChild(new Transform().setScale(0.02,0.02,0.02).setTranslation(-2.5,8.0,0.0)
      .addChild(new Shape()
    ...
    .addChild(new SpotLight("the-light").setBeamWidth(0.4).setCutOffAngle(0.5).setLocation(0.0,6.0,2.0).setRadius(50))
    .addChild(new TimeSensor("text-time"))
    .addChild(new TimeSensor("the-time").setCycleInterval(8))
    .addChild(new PositionInterpolator("the-location").setKey(new double[] {0.03,0.06,0.09,0.12,0.15,0.18,0.21,0.24,0.27,0.3,0.33,0.36,0.39,0.42,0.45,0.48,0.51,0.54,0.57,0.6,0.63,0.66,0.69,0.72,0.75,0.78,0.81,0.84,0.88,0.93,0.96,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,6.0,4.0,1.0,5.916,4.0,2.0,5.657,4.0,3.5,5.196,4.0,4.5,4.472,4.0,5.5,3.317,4.0,6.0,2.398,4.0,6.4,1.091,4.0,6.5,0.0,4.0,6.2,-1.091,4.0,6.0,-2.398,4.0,5.5,-3.317,4.0,4.5,-4.472,4.0,3.5,-5.196,4.0,2.5,-5.657,4.0,1.5,-5.916,1.0,0.5,-6.0,5.0,-0.5,-5.916,4.0,-1.5,-5.657,4.0,-2.5,-5.196,4.0,-3.5,-4.472,4.0,-4.5,-3.317,4.0,-5.0,-2.398,4.0,-5.4,-1.091,4.0,-5.5,0.0,4.0,-5.4,1.091,4.0,-5.0,2.398,4.0,-4.5,3.317,4.0,-3.5,4.472,4.0,-2.5,5.196,4.0,-1.5,5.657,4.0,-0.5,5.916,4.0})))
    ...
    .addChild(new Transform().setScale(0.3,0.3,0.3).setTranslation(0.0,6.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance("the-appearance")
          .setMaterial(new Material()))
        .setGeometry(new ElevationGrid("the-geometry").setSolid(false).setXDimension(21).setXSpacing(0.1).setZDimension(21).setZSpacing(0.1).setHeight(getthe_geometry_5_38_height()))))
    .addChild(new Transform().setTranslation(1.0,5.916,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-geometry"))))
    .addChild(new Transform().setTranslation(2.0,5.657,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-geometry"))))
    .addChild(new Transform().setTranslation(3.0,5.196,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-geometry"))))
    .addChild(new Transform().setTranslation(4.0,4.472,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-geometry"))))
    .addChild(new Transform().setTranslation(5.0,3.317,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-geometry"))))
    .addChild(new Transform().setTranslation(5.5,2.398,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-geometry"))))
    ...
    .addChild(new Transform().setTranslation(-5.5,-2.398,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-geometry"))))
    .addChild(new Transform().setTranslation(-5.9,1.091,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-geometry"))))
    .addChild(new Transform().setTranslation(5.9,1.091,0.0)
    ...
    .addChild(new ROUTE().setFromNode("the-time").setFromField("fraction_changed").setToNode("the-location").setToField("set_fraction"))
    .addChild(new ROUTE().setFromNode("the-location").setFromField("value_changed").setToNode("the-light").setToField("location")));
    }
	// end of initialize() method

		/** Define subarrays using type double[] */
		private double[] getthe_geometry_5_38_height_1()
		{
		...
		/** Large attribute array: ElevationGrid DEF='the-geometry' height field, scene-graph level=5, element #38, 441 total numbers.
		 ...
		 */
		private MFFloat getthe_geometry_5_38_height()
		{
			MFFloat the_geometry_5_38_height = new MFFloat()/*2.finalize*/
				.append(new MFFloat(getthe_geometry_5_38_height_1()));
			return the_geometry_5_38_height;
		}
    ...
    {
        X3D thisExampleX3dModel = new test_locationcom().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_locationcom\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_locationcom\" self-validation test results: ");

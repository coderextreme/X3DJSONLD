 ...
 * <p> Script node interface between VRML and EcmaScript: this conformance example tests field-based VRML-EcmaScript functionality. </p>
 <p> Related links: <a href="../../../ScriptConformance/ScriptNodeFieldControl_EcmaScript.java">ScriptNodeFieldControl_EcmaScript.java</a> source, <a href="../../../ScriptConformance/ScriptNodeFieldControl_EcmaScriptIndex.html" target="_top">ScriptNodeFieldControl_EcmaScript catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/ScriptConformance/ScriptNodeFieldControl_EcmaScript.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/ScriptConformance/ScriptNodeFieldControl_EcmaScript.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> ScriptNodeFieldControl_EcmaScript-VrmlConsoleOutput.txt </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="../../../ScriptConformance/ScriptNodeFieldControl_EcmaScriptSnapshots.html">ScriptNodeFieldControl_EcmaScriptSnapshots.html</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
...
public class ScriptNodeFieldControl_EcmaScript
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ScriptConformance/ScriptNodeFieldControl_EcmaScript.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeFieldControl_EcmaScript-VrmlConsoleOutput.txt"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeFieldControl_EcmaScriptSnapshots.html"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeFieldControl_Java.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Group()
      ...
      .addChild(new Transform("TextPosition")
        ...
        .addChild(new Shape()
          .setGeometry(new Text("MessageToUser").setString(new String[] {"Default text in VRML scene will be replaced by","Java initialize() in Script using EventOut control.","This text appears first, if Java initialization fails.",""})

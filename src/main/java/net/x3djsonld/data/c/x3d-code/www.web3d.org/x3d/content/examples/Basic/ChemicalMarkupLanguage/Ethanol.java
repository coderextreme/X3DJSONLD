...
public class Ethanol
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("Ethanol.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of Ethanol.x3d scene produced from Ethanol.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("Ethanol.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Ethanol.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("Ethanol.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect Ethanol").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"Ethanol: C2 H6 O"}))))
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"molecular weight: 46.07"}))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("ano2_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"CAS: 64-17-5"})))))
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "ethanol_karne_a_1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.0303,0.8847,0.9763)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "ethanol_karne_a_2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.8847,1.9889,1.5717)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "ethanol_karne_a_3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.1883,1.4807,1.7425)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Hydrogen", "ethanol_karne_a_4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.0000,1.2330,0.8324)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Hydrogen", "ethanol_karne_a_5").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.9949,0.0000,1.6255)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Hydrogen", "ethanol_karne_a_6").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.4097,0.5558,0.0000)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Hydrogen", "ethanol_karne_a_7").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.9050,2.8742,0.9059)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Hydrogen", "ethanol_karne_a_8").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.4753,2.3225,2.5456)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Hydrogen", "ethanol_karne_a_9").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.7056,2.1820,2.1139))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "ethanol_karne_b_1").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.0303,0.8847,0.9763,1.8847,1.9889,1.5717})))))
      .addChild(new ProtoInstance("line", "ethanol_karne_b_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.0303,0.8847,0.9763,0.0000,1.2330,0.8324})))))
      .addChild(new ProtoInstance("line", "ethanol_karne_b_3").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.0303,0.8847,0.9763,0.9949,0.0000,1.6255})))))
      .addChild(new ProtoInstance("line", "ethanol_karne_b_4").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.0303,0.8847,0.9763,1.4097,0.5558,0.0000})))))
      .addChild(new ProtoInstance("line", "ethanol_karne_b_5").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.8847,1.9889,1.5717,3.1883,1.4807,1.7425})))))
      .addChild(new ProtoInstance("line", "ethanol_karne_b_6").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.8847,1.9889,1.5717,1.9050,2.8742,0.9059})))))
      .addChild(new ProtoInstance("line", "ethanol_karne_b_7").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.8847,1.9889,1.5717,1.4753,2.3225,2.5456})))))
      .addChild(new ProtoInstance("line", "ethanol_karne_b_8").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.1883,1.4807,1.7425,3.7056,2.1820,2.1139})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new Ethanol().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.Ethanol\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.Ethanol\" self-validation test results: ");

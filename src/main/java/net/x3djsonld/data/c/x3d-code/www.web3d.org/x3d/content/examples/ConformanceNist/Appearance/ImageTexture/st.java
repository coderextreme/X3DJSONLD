 ...
 <p> Related links: <a href="../../../../Appearance/ImageTexture/st.java">st.java</a> source, <a href="../../../../Appearance/ImageTexture/stIndex.html" target="_top">st catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/ImageTexture/st.x3d">st.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st-front.jpg">st-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st-rear.jpg">st-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st-top.jpg">st-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st-bottom.jpg">st-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st-left.jpg">st-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st-right.jpg">st-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser default ability to repeat a half-scale JPEG texture horizontally and vertically to fill primitive geometry. A 2 by 2 matrix of VTS logos should map to the cone, sphere, cylinder, and each face of the box. For the cone, cylinder and sphere and sides of the box, the text should face the viewer and be horizontal. The top of the box shall have a 2 by 2 matrix of VTS logos facing the viewer, and reading left-to-right when the box top is tilted toward the initial viewpoint. The bottom of the box shall have a 2 by 2 matrix of VTS logos reading left-to-right when the bottom of the box is tilted toward the initial viewpoint. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/st.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/st.x3d</a> </td>
		</tr>
		<tr>
...
public class st
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test browser default ability to repeat a half-scale JPEG texture horizontally and vertically to fill primitive geometry. A 2 by 2 matrix of VTS logos should map to the cone, sphere, cylinder, and each face of the box. For the cone, cylinder and sphere and sides of the box, the text should face the viewer and be horizontal. The top of the box shall have a 2 by 2 matrix of VTS logos facing the viewer, and reading left-to-right when the box top is tilted toward the initial viewpoint. The bottom of the box shall have a 2 by 2 matrix of VTS logos reading left-to-right when the bottom of the box is tilted toward the initial viewpoint."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/st.x3d"))

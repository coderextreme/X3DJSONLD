 ...
 <p> Related links: <a href="../../../../Lights/DirectionalLight/test_red_on_blue.java">test_red_on_blue.java</a> source, <a href="../../../../Lights/DirectionalLight/test_red_on_blueIndex.html" target="_top">test_red_on_blue catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/DirectionalLight/test_red_on_blue.x3d">test_red_on_blue.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/test-red-on-blue-front.jpg">test-red-on-blue-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test addresses the ability of a browser to apply a colored (red) light on an object of a different color (blue). Four simple geometries are defined in the local coordinate system and the emissive and diffuse color are both set to 0 0 1. A DirectionalLight is also defined and a red color is associated with it. This light illuminates the objects making them look black. The dot product of the light and object color produce a black appearing object. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_red_on_blue.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_red_on_blue.x3d</a> </td>
		</tr>
		<tr>
...
public class test_red_on_blue
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_red_on_blue.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new DirectionalLight("the-light").setColor(1.0,0.0,0.0))

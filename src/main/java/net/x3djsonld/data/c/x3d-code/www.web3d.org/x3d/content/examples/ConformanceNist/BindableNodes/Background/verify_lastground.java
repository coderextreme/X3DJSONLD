...
/**
 * <p> Test browser to make the region between the last angle of the groundAngle field and the equator invisible when the last ground angle is &lt; pi/2. A Background node is defined with a single angle value and two ground colors. The area between 1.35 radians and 1.57 radians should be invisible. The area between 0 radians and 1.37 radians should be light blue. </p>
 <p> Related links: <a href="../../../../BindableNodes/Background/verify_lastground.java">verify_lastground.java</a> source, <a href="../../../../BindableNodes/Background/verify_lastgroundIndex.html" target="_top">verify_lastground catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Background/verify_lastground.x3d">verify_lastground.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../BindableNodes/Background/verify-lastground-front.jpg">verify-lastground-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser to make the region between the last angle of the groundAngle field and the equator invisible when the last ground angle is &lt; pi/2. A Background node is defined with a single angle value and two ground colors. The area between 1.35 radians and 1.57 radians should be invisible. The area between 0 radians and 1.37 radians should be light blue. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Background/verify_lastground.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Background/verify_lastground.x3d</a> </td>
		</tr>
		<tr>
...
public class verify_lastground
{
	/** Default constructor to create this object. */
	public verify_lastground ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("verify_lastground.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("verify-lastground-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Background/verify_lastground.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("verify_lastground.x3d"))
    ...
    .addChild(new Background("blues").setGroundAngle(new double[] {1.35}).setGroundColor(new MFColor(new double[] {0.0,1.0,1.0,1.0,0.0,0.0})).setSkyColor(new MFColor(new double[] {0.0,0.0,1.0}))));
    }
	 ...
	 * @return verify_lastground model
	 */
    ...
    {
        X3D thisExampleX3dModel = new verify_lastground().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.verify_lastground\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.verify_lastground\" self-validation test results: ");

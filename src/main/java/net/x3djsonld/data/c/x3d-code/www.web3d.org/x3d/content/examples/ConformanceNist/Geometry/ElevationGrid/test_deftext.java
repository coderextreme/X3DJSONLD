...
/**
 * <p> Test browser ability to completely map one ImageTexture onto the image texture should map once on the surface of the ElevationGrid. ImageTexture should map once onto the surface of the IndexedFaceSet, with the S (horizontal) axis of the texture corresponding to the X axis of the geometry. </p>
 <p> Related links: <a href="../../../../Geometry/ElevationGrid/test_deftext.java">test_deftext.java</a> source, <a href="../../../../Geometry/ElevationGrid/test_deftextIndex.html" target="_top">test_deftext catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/ElevationGrid/test_deftext.x3d">test_deftext.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Geometry/ElevationGrid/test-deftext-front.jpg">test-deftext-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Geometry/ElevationGrid/test-deftext-rear.jpg">test-deftext-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Geometry/ElevationGrid/test-deftext-top.jpg">test-deftext-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Geometry/ElevationGrid/test-deftext-bottom.jpg">test-deftext-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Geometry/ElevationGrid/test-deftext-left.jpg">test-deftext-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Geometry/ElevationGrid/test-deftext-right.jpg">test-deftext-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser ability to completely map one ImageTexture onto the image texture should map once on the surface of the ElevationGrid. ImageTexture should map once onto the surface of the IndexedFaceSet, with the S (horizontal) axis of the texture corresponding to the X axis of the geometry. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/ElevationGrid/test_deftext.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/ElevationGrid/test_deftext.x3d</a> </td>
		</tr>
		<tr>
...
public class test_deftext
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_deftext.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-deftext-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-deftext-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-deftext-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-deftext-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-deftext-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-deftext-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test browser ability to completely map one ImageTexture onto the image texture should map once on the surface of the ElevationGrid. ImageTexture should map once onto the surface of the IndexedFaceSet, with the S (horizontal) axis of the texture corresponding to the X axis of the geometry."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/ElevationGrid/test_deftext.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_deftext.x3d"))
    ...
    {
        X3D thisExampleX3dModel = new test_deftext().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_deftext\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_deftext\" self-validation test results: ");

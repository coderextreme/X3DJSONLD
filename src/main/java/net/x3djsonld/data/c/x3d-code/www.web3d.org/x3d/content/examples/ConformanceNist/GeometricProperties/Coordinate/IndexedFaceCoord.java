...
/**
 * <p> Generate an IndexedFaceSet using the Coordinate node. Browser should create a 22 square face by 22 square face geometry, elevated in the center toward the + Y direction. </p>
 <p> Related links: <a href="../../../../GeometricProperties/Coordinate/IndexedFaceCoord.java">IndexedFaceCoord.java</a> source, <a href="../../../../GeometricProperties/Coordinate/IndexedFaceCoordIndex.html" target="_top">IndexedFaceCoord catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GeometricProperties/Coordinate/IndexedFaceCoord.x3d">IndexedFaceCoord.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GeometricProperties/Coordinate/IndexedFaceCoord-front.jpg">IndexedFaceCoord-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GeometricProperties/Coordinate/IndexedFaceCoord-rear.jpg">IndexedFaceCoord-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GeometricProperties/Coordinate/IndexedFaceCoord-top.jpg">IndexedFaceCoord-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GeometricProperties/Coordinate/IndexedFaceCoord-bottom.jpg">IndexedFaceCoord-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GeometricProperties/Coordinate/IndexedFaceCoord-left.jpg">IndexedFaceCoord-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../GeometricProperties/Coordinate/IndexedFaceCoord-right.jpg">IndexedFaceCoord-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Generate an IndexedFaceSet using the Coordinate node. Browser should create a 22 square face by 22 square face geometry, elevated in the center toward the + Y direction. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/Coordinate/IndexedFaceCoord.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/Coordinate/IndexedFaceCoord.x3d</a> </td>
		</tr>
		<tr>
...
public class IndexedFaceCoord
{
	/** Default constructor to create this object. */
	public IndexedFaceCoord ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("IndexedFaceCoord.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("IndexedFaceCoord-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("IndexedFaceCoord-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("IndexedFaceCoord-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("IndexedFaceCoord-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("IndexedFaceCoord-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("IndexedFaceCoord-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Generate an IndexedFaceSet using the Coordinate node. Browser should create a 22 square face by 22 square face geometry, elevated in the center toward the + Y direction."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/Coordinate/IndexedFaceCoord.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("IndexedFaceCoord.x3d"))
    .addChild(new Viewpoint().setDescription("Front View"))
    .addChild(new Viewpoint().setDescription("Rear View").setOrientation(0.0,1.0,0.0,3.14).setPosition(0.0,0.0,-1.0))
    .addChild(new Viewpoint().setDescription("Top View").setOrientation(1.0,0.0,0.0,-1.57).setPosition(0.0,10.0,0.0))
    .addChild(new Viewpoint().setDescription("Bottom View").setOrientation(1.0,0.0,0.0,1.57).setPosition(0.0,-1.0,0.0))
    ...
    .addChild(new Shape()
      ...
      .setGeometry(new IndexedFaceSet().setCcw(false).setCreaseAngle(0.5).setSolid(false).setCoordIndex(getIndexedFaceSet_4_32_coordIndex())
        .setCoord(new Coordinate().setPoint(getCoordinate_5_32_point())))));
    }
	// end of initialize() method

		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_4_32_coordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_4_32_coordIndex_2()
		{
		...
		private int[] getIndexedFaceSet_4_32_coordIndex_3()
		{
		 ...
		 */
		private MFInt32 getIndexedFaceSet_4_32_coordIndex()
		{
			MFInt32 IndexedFaceSet_4_32_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_4_32_coordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_4_32_coordIndex_2()))
				.append(new MFInt32(getIndexedFaceSet_4_32_coordIndex_3()));
			return IndexedFaceSet_4_32_coordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=5, element #32, 1680 total numbers made up of 560 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
    ...
    {
        X3D thisExampleX3dModel = new IndexedFaceCoord().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.IndexedFaceCoord\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.IndexedFaceCoord\" self-validation test results: ");

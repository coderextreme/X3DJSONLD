...
/**
 * <p> CT Scan of a human torso. </p>
 <p> Related links: <a href="../../../VolumeRendering/BasicBody.java">BasicBody.java</a> source, <a href="../../../VolumeRendering/BasicBodyIndex.html" target="_top">BasicBody catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../VolumeRendering/BasicBody.x3d">BasicBody.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> CT Scan of a human torso </td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> Get prerequisite dataset, <a href="http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/body.nrrd" target="_blank">http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/body.nrrd</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BasicBody.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BasicBody.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
...
public class BasicBody
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("BasicBody.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("CT Scan of a human torso"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("BasicBody.x3d"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("README.txt"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("Get prerequisite dataset, http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/body.nrrd"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BasicBody.x3d"))
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("BasicBody.x3d"))
    .addChild(new Group()
      .addChild(new Viewpoint("VP").setDescription("Basic Body").setOrientation(0.940022,0.208839,0.269711,1.71637).setPosition(0.108923,-0.189725,-0.0135375))
      ...
      .addChild(new Transform().setScale(0.000292969,0.000292969,0.000292969)
        .addChild(new VolumeData().setDimensions(512.0,512.0,452.0)
          .setVoxels(new ImageTexture3D().setUrl(new String[] {"datasets/nrrd/body.nrrd","http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/body.nrrd","https://savage.nps.edu/Savage/VolumeRendering/datasets/nrrd/body.nrrd"}))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new BasicBody().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.BasicBody\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.BasicBody\" self-validation test results: ");

 ...
 <p> Related links: <a href="../../../../Appearance/Material/transparency.java">transparency.java</a> source, <a href="../../../../Appearance/Material/transparencyIndex.html" target="_top">transparency catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Material/transparency.x3d">transparency.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Material/transparency-front.jpg">transparency-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Material/transparency-rear.jpg">transparency-rear.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test texture color precedence over Color node for primitive geomtry. Five transparency values of 0, .25 .50 .75 and 1.0 are applied from left to right for primitive geometry. The geometry consists of a row of 5 Cones, followed by a row of 5 Cylinders, 5 Spheres, then 5 Boxes. The result is a range of transparency that begins with a completely opaque geometry on the left, followed by increasing transparency on the right, ending with a completely transparent geometry on the right, for all primitive types. If the browser only supports binary transparency, then only two opaque geometry will appear on the left, while the three geometry with transparency values of .50 .75 and 1.0 will not be visible. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/transparency.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/transparency.x3d</a> </td>
		</tr>
		<tr>
...
public class transparency
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("transparency-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("transparency-rear.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test texture color precedence over Color node for primitive geomtry. Five transparency values of 0, .25 .50 .75 and 1.0 are applied from left to right for primitive geometry. The geometry consists of a row of 5 Cones, followed by a row of 5 Cylinders, 5 Spheres, then 5 Boxes. The result is a range of transparency that begins with a completely opaque geometry on the left, followed by increasing transparency on the right, ending with a completely transparent geometry on the right, for all primitive types. If the browser only supports binary transparency, then only two opaque geometry will appear on the left, while the three geometry with transparency values of .50 .75 and 1.0 will not be visible."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/transparency.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform().setTranslation(-4.0,-0.75,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,1.0,1.0).setShininess(0)))
        .setGeometry(new Sphere().setRadius(0.5))))
    .addChild(new Transform().setTranslation(-2.0,-0.75,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,1.0,1.0).setShininess(0).setTransparency(0.25)))
        .setGeometry(new Sphere().setRadius(0.5))))
    .addChild(new Transform().setTranslation(0.0,-0.75,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,1.0,1.0).setShininess(0).setTransparency(0.5)))
        .setGeometry(new Sphere().setRadius(0.5))))
    .addChild(new Transform().setTranslation(2.0,-0.75,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,1.0,1.0).setShininess(0).setTransparency(0.75)))
        .setGeometry(new Sphere().setRadius(0.5))))
    .addChild(new Transform().setTranslation(4.0,-0.75,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,1.0,1.0).setShininess(0).setTransparency(1)))
        .setGeometry(new Sphere().setRadius(0.5))))
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.transparency\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.transparency\" self-validation test results: ");

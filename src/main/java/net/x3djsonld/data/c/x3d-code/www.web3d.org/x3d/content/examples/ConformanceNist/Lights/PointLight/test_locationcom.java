 ...
 <p> Related links: <a href="../../../../Lights/PointLight/test_locationcom.java">test_locationcom.java</a> source, <a href="../../../../Lights/PointLight/test_locationcomIndex.html" target="_top">test_locationcom catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/PointLight/test_locationcom.x3d">test_locationcom.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Lights/PointLight/test-locationcom-movie.mpg">test-locationcom-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser to set the location field to a range of values on a a complex geometry (Extrusion) The geometry is drawn in the local coordinate system and it should be a doughnut like "figure". The location of the light is changed as the animation progresses. The animation is started by clicking on the text above the geometry. The location values used are 0 0 10,10 0 0, 0 0 -10,-10 0 0. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_locationcom.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_locationcom.x3d</a> </td>
		</tr>
		<tr>
...
public class test_locationcom
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_locationcom.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new PositionInterpolator("the-location").setKey(new double[] {0.25,0.5,0.75,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,10.0,10.0,0.0,0.0,0.0,0.0,-10.0,-10.0,0.0,0.0})))
    ...
    .addChild(new Group()
      .addChild(new PointLight("the-light").setAmbientIntensity(1).setLocation(0.0,0.0,10.0).setRadius(50))

...
/**
 * <p> This model was output using the GeoVRML export capabilities of the ESRI 3D Analyst Extension for ArcView/ArcInfo 8.1 product (official release date Q1 2001). This combines coarse resolution image and elevation data for the planet Mars, using lat/long coordinates. </p>
 <p> Related links: <a href="../../../Geospatial/Mars.java">Mars.java</a> source, <a href="../../../Geospatial/MarsIndex.html" target="_top">Mars catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../Geospatial/Mars.x3d">Mars.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> This model was output using the GeoVRML export capabilities of the ESRI 3D Analyst Extension for ArcView/ArcInfo 8.1 product (official release date Q1 2001). This combines coarse resolution image and elevation data for the planet Mars, using lat/long coordinates. </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/Geospatial/Mars.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/Geospatial/Mars.x3d</a> </td>
		</tr>
		<tr>
...
public class Mars
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("Mars.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("This model was output using the GeoVRML export capabilities of the ESRI 3D Analyst Extension for ArcView/ArcInfo 8.1 product (official release date Q1 2001). This combines coarse resolution image and elevation data for the planet Mars, using lat/long coordinates."))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/Geospatial/Mars.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new DirectionalLight().setAmbientIntensity(0.3).setDirection(-0.612372,0.612372,0.5))
    .addChild(new GeoViewpoint().setDescription("default").setFieldOfView(0.3).setOrientation(1.0,0.0,0.0,-1.570796).setPosition(0.000000,0.000000,106528752.000000)
    ...
    .addChild(new Group()
      .addChild(new Group()
        ...
        .addChild(new Group()
          .addChild(new Group()
            .addChild(new GeoLOD().setCenter(-45.000000,-135.000000,200025.000000).setRange(7.2E7).setChild1Url(new String[] {"MarsLOD000.x3d","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/MarsLOD000.x3d"})
              ...
              .addRootNode(new Shape()
                ...
                .setGeometry(new GeoElevationGrid().setCcw(false).setCreaseAngle(0.5).setGeoGridOrigin(-90.000000,-180.000000,0.000000).setSolid(false).setXDimension(16).setXSpacing(6.000000).setYScale(50.0).setZDimension(16).setZSpacing(6.000000).setHeight(getGeoElevationGrid_9_26_height())
                  .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_10_27_point()))))))
          .addChild(new Group()
            .addChild(new GeoLOD().setCenter(45.000000,-135.000000,200450.000000).setRange(7.2E7).setChild1Url(new String[] {"MarsLOD003.x3d","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/MarsLOD003.x3d"})
              .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
              .addRootNode(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.9).setDiffuseColor(1.0,1.0,1.0).setShininess(1.0))
                ...
                .setGeometry(new GeoElevationGrid().setCcw(false).setCreaseAngle(0.5).setGeoGridOrigin(0.000000,-180.000000,0.000000).setSolid(false).setXDimension(16).setXSpacing(6.000000).setYScale(50.0).setZDimension(16).setZSpacing(6.000000).setHeight(getGeoElevationGrid_9_36_height())
                  .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_10_37_point()))))))
          .addChild(new Group()
            .addChild(new GeoLOD().setCenter(-45.000000,-45.000000,21825.000000).setRange(7.2E7).setChild1Url(new String[] {"MarsLOD006.x3d","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/MarsLOD006.x3d"})
              .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
              .addRootNode(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.9).setDiffuseColor(1.0,1.0,1.0).setShininess(1.0))
                ...
                .setGeometry(new GeoElevationGrid().setCcw(false).setCreaseAngle(0.5).setGeoGridOrigin(-90.000000,-90.000000,0.000000).setSolid(false).setXDimension(16).setXSpacing(6.000000).setYScale(50.0).setZDimension(16).setZSpacing(6.000000).setHeight(getGeoElevationGrid_9_46_height())
                  .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_10_47_point()))))))
          .addChild(new Group()
            .addChild(new GeoLOD().setCenter(45.000000,-45.000000,-57050.000000).setRange(7.2E7).setChild1Url(new String[] {"MarsLOD009.x3d","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/MarsLOD009.x3d"})
              .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
              .addRootNode(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.9).setDiffuseColor(1.0,1.0,1.0).setShininess(1.0))
                ...
                .setGeometry(new GeoElevationGrid().setCcw(false).setCreaseAngle(0.5).setGeoGridOrigin(0.000000,-90.000000,0.000000).setSolid(false).setXDimension(16).setXSpacing(6.000000).setYScale(50.0).setZDimension(16).setZSpacing(6.000000).setHeight(getGeoElevationGrid_9_56_height())
                  .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_10_57_point()))))))
          .addChild(new Group()
            .addChild(new GeoLOD().setCenter(-45.000000,45.000000,-100175.000000).setRange(7.2E7).setChild1Url(new String[] {"MarsLOD012.x3d","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/MarsLOD012.x3d"})
              .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
              .addRootNode(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.9).setDiffuseColor(1.0,1.0,1.0).setShininess(1.0))
                ...
                .setGeometry(new GeoElevationGrid().setCcw(false).setCreaseAngle(0.5).setGeoGridOrigin(-90.000000,0.000000,0.000000).setSolid(false).setXDimension(16).setXSpacing(6.000000).setYScale(50.0).setZDimension(16).setZSpacing(6.000000).setHeight(getGeoElevationGrid_9_66_height())
                  .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_10_67_point()))))))
          .addChild(new Group()
            .addChild(new GeoLOD().setCenter(45.000000,45.000000,-72925.000000).setRange(7.2E7).setChild1Url(new String[] {"MarsLOD015.x3d","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/MarsLOD015.x3d"})
              .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
              .addRootNode(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.9).setDiffuseColor(1.0,1.0,1.0).setShininess(1.0))
                ...
                .setGeometry(new GeoElevationGrid().setCcw(false).setCreaseAngle(0.5).setGeoGridOrigin(0.000000,0.000000,0.000000).setSolid(false).setXDimension(16).setXSpacing(6.000000).setYScale(50.0).setZDimension(16).setZSpacing(6.000000).setHeight(getGeoElevationGrid_9_76_height())
                  .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_10_77_point()))))))
          .addChild(new Group()
            .addChild(new GeoLOD().setCenter(-45.000000,135.000000,-73350.000000).setRange(7.2E7).setChild1Url(new String[] {"MarsLOD018.x3d","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/MarsLOD018.x3d"})
              .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
              .addRootNode(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.9).setDiffuseColor(1.0,1.0,1.0).setShininess(1.0))
                ...
                .setGeometry(new GeoElevationGrid().setCcw(false).setCreaseAngle(0.5).setGeoGridOrigin(-90.000000,90.000000,0.000000).setSolid(false).setXDimension(16).setXSpacing(6.000000).setYScale(50.0).setZDimension(16).setZSpacing(6.000000).setHeight(getGeoElevationGrid_9_86_height())
                  .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_10_87_point()))))))
          .addChild(new Group()
            .addChild(new GeoLOD().setCenter(45.000000,135.000000,-13175.000000).setRange(7.2E7).setChild1Url(new String[] {"MarsLOD021.x3d","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/MarsLOD021.x3d"})
              .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
              .addRootNode(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.9).setDiffuseColor(1.0,1.0,1.0).setShininess(1.0))
                ...
                .setGeometry(new GeoElevationGrid().setCcw(false).setCreaseAngle(0.5).setGeoGridOrigin(0.000000,90.000000,0.000000).setSolid(false).setXDimension(16).setXSpacing(6.000000).setYScale(50.0).setZDimension(16).setZSpacing(6.000000).setHeight(getGeoElevationGrid_9_96_height())
                  .setGeoOrigin(new GeoOrigin().setUSE("ORIGIN"))
	...
	// end of initialize() method
		...
		private double[] getTextureCoordinate_10_37_point_3()
		{
			double[] value = {0.53333,0.8,0.6,0.8,0.66667,0.8,0.73333,0.8,0.8,0.8,0.86667,0.8,0.93333,0.8,0.99609,0.8,0.00391,0.86667,0.06667,0.86667,0.13333,0.86667,0.2,0.86667,0.26667,0.86667,0.33333,0.86667,0.4,0.86667,0.46667,0.86667,0.53333,0.86667,0.6,0.86667,0.66667,0.86667,0.73333,0.86667,0.8,0.86667,0.86667,0.86667,0.93333,0.86667,0.99609,0.86667,0.00391,0.93333,0.06667,0.93333,0.13333,0.93333,0.2,0.93333,0.26667,0.93333,0.33333,0.93333,0.4,0.93333,0.46667,0.93333,0.53333,0.93333,0.6,0.93333,0.66667,0.93333,0.73333,0.93333,0.8,0.93333,0.86667,0.93333,0.93333,0.93333,0.99609,0.93333,0.00391,0.99609,0.06667,0.99609,0.13333,0.99609,0.2,0.99609,0.26667,0.99609,0.33333,0.99609,0.4,0.99609,0.46667,0.99609,0.53333,0.99609,0.6,0.99609,0.66667,0.99609,0.73333,0.99609,0.8,0.99609,0.86667,0.99609,0.93333,0.99609,0.99609,0.99609};
			return value;
		}
		...
		private double[] getTextureCoordinate_10_57_point_3()
		{
			double[] value = {0.53333,0.8,0.6,0.8,0.66667,0.8,0.73333,0.8,0.8,0.8,0.86667,0.8,0.93333,0.8,0.99609,0.8,0.00391,0.86667,0.06667,0.86667,0.13333,0.86667,0.2,0.86667,0.26667,0.86667,0.33333,0.86667,0.4,0.86667,0.46667,0.86667,0.53333,0.86667,0.6,0.86667,0.66667,0.86667,0.73333,0.86667,0.8,0.86667,0.86667,0.86667,0.93333,0.86667,0.99609,0.86667,0.00391,0.93333,0.06667,0.93333,0.13333,0.93333,0.2,0.93333,0.26667,0.93333,0.33333,0.93333,0.4,0.93333,0.46667,0.93333,0.53333,0.93333,0.6,0.93333,0.66667,0.93333,0.73333,0.93333,0.8,0.93333,0.86667,0.93333,0.93333,0.93333,0.99609,0.93333,0.00391,0.99609,0.06667,0.99609,0.13333,0.99609,0.2,0.99609,0.26667,0.99609,0.33333,0.99609,0.4,0.99609,0.46667,0.99609,0.53333,0.99609,0.6,0.99609,0.66667,0.99609,0.73333,0.99609,0.8,0.99609,0.86667,0.99609,0.93333,0.99609,0.99609,0.99609};
			return value;
		}
		...
		private double[] getTextureCoordinate_10_67_point_3()
		{
			double[] value = {0.53333,0.8,0.6,0.8,0.66667,0.8,0.73333,0.8,0.8,0.8,0.86667,0.8,0.93333,0.8,0.99609,0.8,0.00391,0.86667,0.06667,0.86667,0.13333,0.86667,0.2,0.86667,0.26667,0.86667,0.33333,0.86667,0.4,0.86667,0.46667,0.86667,0.53333,0.86667,0.6,0.86667,0.66667,0.86667,0.73333,0.86667,0.8,0.86667,0.86667,0.86667,0.93333,0.86667,0.99609,0.86667,0.00391,0.93333,0.06667,0.93333,0.13333,0.93333,0.2,0.93333,0.26667,0.93333,0.33333,0.93333,0.4,0.93333,0.46667,0.93333,0.53333,0.93333,0.6,0.93333,0.66667,0.93333,0.73333,0.93333,0.8,0.93333,0.86667,0.93333,0.93333,0.93333,0.99609,0.93333,0.00391,0.99609,0.06667,0.99609,0.13333,0.99609,0.2,0.99609,0.26667,0.99609,0.33333,0.99609,0.4,0.99609,0.46667,0.99609,0.53333,0.99609,0.6,0.99609,0.66667,0.99609,0.73333,0.99609,0.8,0.99609,0.86667,0.99609,0.93333,0.99609,0.99609,0.99609};
			return value;
		}
		...
		private double[] getTextureCoordinate_10_77_point_3()
		{
			double[] value = {0.53333,0.8,0.6,0.8,0.66667,0.8,0.73333,0.8,0.8,0.8,0.86667,0.8,0.93333,0.8,0.99609,0.8,0.00391,0.86667,0.06667,0.86667,0.13333,0.86667,0.2,0.86667,0.26667,0.86667,0.33333,0.86667,0.4,0.86667,0.46667,0.86667,0.53333,0.86667,0.6,0.86667,0.66667,0.86667,0.73333,0.86667,0.8,0.86667,0.86667,0.86667,0.93333,0.86667,0.99609,0.86667,0.00391,0.93333,0.06667,0.93333,0.13333,0.93333,0.2,0.93333,0.26667,0.93333,0.33333,0.93333,0.4,0.93333,0.46667,0.93333,0.53333,0.93333,0.6,0.93333,0.66667,0.93333,0.73333,0.93333,0.8,0.93333,0.86667,0.93333,0.93333,0.93333,0.99609,0.93333,0.00391,0.99609,0.06667,0.99609,0.13333,0.99609,0.2,0.99609,0.26667,0.99609,0.33333,0.99609,0.4,0.99609,0.46667,0.99609,0.53333,0.99609,0.6,0.99609,0.66667,0.99609,0.73333,0.99609,0.8,0.99609,0.86667,0.99609,0.93333,0.99609,0.99609,0.99609};
			return value;
		}
		...
		private double[] getTextureCoordinate_10_87_point_3()
		{
			double[] value = {0.53333,0.8,0.6,0.8,0.66667,0.8,0.73333,0.8,0.8,0.8,0.86667,0.8,0.93333,0.8,0.99609,0.8,0.00391,0.86667,0.06667,0.86667,0.13333,0.86667,0.2,0.86667,0.26667,0.86667,0.33333,0.86667,0.4,0.86667,0.46667,0.86667,0.53333,0.86667,0.6,0.86667,0.66667,0.86667,0.73333,0.86667,0.8,0.86667,0.86667,0.86667,0.93333,0.86667,0.99609,0.86667,0.00391,0.93333,0.06667,0.93333,0.13333,0.93333,0.2,0.93333,0.26667,0.93333,0.33333,0.93333,0.4,0.93333,0.46667,0.93333,0.53333,0.93333,0.6,0.93333,0.66667,0.93333,0.73333,0.93333,0.8,0.93333,0.86667,0.93333,0.93333,0.93333,0.99609,0.93333,0.00391,0.99609,0.06667,0.99609,0.13333,0.99609,0.2,0.99609,0.26667,0.99609,0.33333,0.99609,0.4,0.99609,0.46667,0.99609,0.53333,0.99609,0.6,0.99609,0.66667,0.99609,0.73333,0.99609,0.8,0.99609,0.86667,0.99609,0.93333,0.99609,0.99609,0.99609};
			return value;
		}
		...
		private double[] getTextureCoordinate_10_97_point_3()
		{
			double[] value = {0.53333,0.8,0.6,0.8,0.66667,0.8,0.73333,0.8,0.8,0.8,0.86667,0.8,0.93333,0.8,0.99609,0.8,0.00391,0.86667,0.06667,0.86667,0.13333,0.86667,0.2,0.86667,0.26667,0.86667,0.33333,0.86667,0.4,0.86667,0.46667,0.86667,0.53333,0.86667,0.6,0.86667,0.66667,0.86667,0.73333,0.86667,0.8,0.86667,0.86667,0.86667,0.93333,0.86667,0.99609,0.86667,0.00391,0.93333,0.06667,0.93333,0.13333,0.93333,0.2,0.93333,0.26667,0.93333,0.33333,0.93333,0.4,0.93333,0.46667,0.93333,0.53333,0.93333,0.6,0.93333,0.66667,0.93333,0.73333,0.93333,0.8,0.93333,0.86667,0.93333,0.93333,0.93333,0.99609,0.93333,0.00391,0.99609,0.06667,0.99609,0.13333,0.99609,0.2,0.99609,0.26667,0.99609,0.33333,0.99609,0.4,0.99609,0.46667,0.99609,0.53333,0.99609,0.6,0.99609,0.66667,0.99609,0.73333,0.99609,0.8,0.99609,0.86667,0.99609,0.93333,0.99609,0.99609,0.99609};
			return value;
		}

		/** Large attribute array: GeoElevationGrid height field, scene-graph level=9, element #26, 256 total numbers.
		...
		private MFDouble getGeoElevationGrid_9_26_height()
		{
			MFDouble GeoElevationGrid_9_26_height = new MFDouble()/*2.finalize*/
				...
				.append(new MFDouble(getGeoElevationGrid_9_26_height_3()));
			return GeoElevationGrid_9_26_height;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #27, 512 total numbers made up of 256 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_10_27_point()
		{
			MFVec2f TextureCoordinate_10_27_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_10_27_point_3()));
			return TextureCoordinate_10_27_point;
		}
		/** Large attribute array: GeoElevationGrid height field, scene-graph level=9, element #36, 256 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFDouble getGeoElevationGrid_9_36_height()
		{
			MFDouble GeoElevationGrid_9_36_height = new MFDouble()/*2.finalize*/
				...
				.append(new MFDouble(getGeoElevationGrid_9_36_height_3()));
			return GeoElevationGrid_9_36_height;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #37, 512 total numbers made up of 256 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_10_37_point()
		{
			MFVec2f TextureCoordinate_10_37_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_10_37_point_3()));
			return TextureCoordinate_10_37_point;
		}
		/** Large attribute array: GeoElevationGrid height field, scene-graph level=9, element #46, 256 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFDouble getGeoElevationGrid_9_46_height()
		{
			MFDouble GeoElevationGrid_9_46_height = new MFDouble()/*2.finalize*/
				...
				.append(new MFDouble(getGeoElevationGrid_9_46_height_3()));
			return GeoElevationGrid_9_46_height;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #47, 512 total numbers made up of 256 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: GeoElevationGrid height field, scene-graph level=9, element #56, 256 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFDouble getGeoElevationGrid_9_56_height()
		{
			MFDouble GeoElevationGrid_9_56_height = new MFDouble()/*2.finalize*/
				...
				.append(new MFDouble(getGeoElevationGrid_9_56_height_3()));
			return GeoElevationGrid_9_56_height;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #57, 512 total numbers made up of 256 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_10_57_point()
		{
			MFVec2f TextureCoordinate_10_57_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_10_57_point_3()));
			return TextureCoordinate_10_57_point;
		}
		/** Large attribute array: GeoElevationGrid height field, scene-graph level=9, element #66, 256 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFDouble getGeoElevationGrid_9_66_height()
		{
			MFDouble GeoElevationGrid_9_66_height = new MFDouble()/*2.finalize*/
				...
				.append(new MFDouble(getGeoElevationGrid_9_66_height_3()));
			return GeoElevationGrid_9_66_height;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #67, 512 total numbers made up of 256 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_10_67_point()
		{
			MFVec2f TextureCoordinate_10_67_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_10_67_point_3()));
			return TextureCoordinate_10_67_point;
		}
		/** Large attribute array: GeoElevationGrid height field, scene-graph level=9, element #76, 256 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFDouble getGeoElevationGrid_9_76_height()
		{
			MFDouble GeoElevationGrid_9_76_height = new MFDouble()/*2.finalize*/
				...
				.append(new MFDouble(getGeoElevationGrid_9_76_height_3()));
			return GeoElevationGrid_9_76_height;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #77, 512 total numbers made up of 256 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_10_77_point()
		{
			MFVec2f TextureCoordinate_10_77_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_10_77_point_3()));
			return TextureCoordinate_10_77_point;
		}
		/** Large attribute array: GeoElevationGrid height field, scene-graph level=9, element #86, 256 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFDouble getGeoElevationGrid_9_86_height()
		{
			MFDouble GeoElevationGrid_9_86_height = new MFDouble()/*2.finalize*/
				...
				.append(new MFDouble(getGeoElevationGrid_9_86_height_3()));
			return GeoElevationGrid_9_86_height;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #87, 512 total numbers made up of 256 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_10_87_point()
		{
			MFVec2f TextureCoordinate_10_87_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_10_87_point_3()));
			return TextureCoordinate_10_87_point;
		}
		/** Large attribute array: GeoElevationGrid height field, scene-graph level=9, element #96, 256 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFDouble getGeoElevationGrid_9_96_height()
		{
			MFDouble GeoElevationGrid_9_96_height = new MFDouble()/*2.finalize*/
				...
				.append(new MFDouble(getGeoElevationGrid_9_96_height_3()));
			return GeoElevationGrid_9_96_height;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #97, 512 total numbers made up of 256 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_10_97_point()
		{
			MFVec2f TextureCoordinate_10_97_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_10_97_point_3()));
    ...
    {
        X3D thisExampleX3dModel = new Mars().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.Mars\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.Mars\" self-validation test results: ");

 ...
 <p> Related links: <a href="../../../../Appearance/PixelTexture/greyscale_alpha.java">greyscale_alpha.java</a> source, <a href="../../../../Appearance/PixelTexture/greyscale_alphaIndex.html" target="_top">greyscale_alpha catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/PixelTexture/greyscale_alpha.x3d">greyscale_alpha.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale_alpha-front.jpg">greyscale_alpha-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale_alpha-rear.jpg">greyscale_alpha-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale_alpha-top.jpg">greyscale_alpha-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale_alpha-bottom.jpg">greyscale_alpha-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale_alpha-left.jpg">greyscale_alpha-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/PixelTexture/greyscale_alpha-right.jpg">greyscale_alpha-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser ability to map greyscale plus alpha opacity pixel values to geometry. A greyscale checkerboard of four squares should map onto a sphere, cone, box and cylinder. The lower left and upper right squares are white, and the upper left and lower right squares are transparent. For the sphere, the texture should cover the entire surface, and wrap counterclockwise from the back of the sphere. For the cone, the texture should wrap counterclockwise (from above) starting at the back of the cone. A circle cutout of the texture is applied right side up to the base of the cone when the cone is tilted toward the -z axis. For the cylinder, the texture should wrap counterclockwise (from above) starting at the back of the cylinder. A circle cutout of the texture is applied right side up to the top and bottom caps of the cylinder. For the box, the texture should be applied right side up in its entirety to each face of the box. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/PixelTexture/greyscale_alpha.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/PixelTexture/greyscale_alpha.x3d</a> </td>
		</tr>
		<tr>
...
public class greyscale_alpha
{
	/** Default constructor to create this object. */
	public greyscale_alpha ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("greyscale_alpha.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale_alpha-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale_alpha-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale_alpha-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale_alpha-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale_alpha-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("greyscale_alpha-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test browser ability to map greyscale plus alpha opacity pixel values to geometry. A greyscale checkerboard of four squares should map onto a sphere, cone, box and cylinder. The lower left and upper right squares are white, and the upper left and lower right squares are transparent. For the sphere, the texture should cover the entire surface, and wrap counterclockwise from the back of the sphere. For the cone, the texture should wrap counterclockwise (from above) starting at the back of the cone. A circle cutout of the texture is applied right side up to the base of the cone when the cone is tilted toward the -z axis. For the cylinder, the texture should wrap counterclockwise (from above) starting at the back of the cylinder. A circle cutout of the texture is applied right side up to the top and bottom caps of the cylinder. For the box, the texture should be applied right side up in its entirety to each face of the box."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/PixelTexture/greyscale_alpha.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("greyscale_alpha.x3d"))
      ...
      .addChild(new Transform().setTranslation(6.14221,0.0694613,-0.000999451)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            ...
            .setTexture(new PixelTexture("GreyscaleAlphaCheckerboard").setImage(new int[] {2,2,2,0xFFFF,0x0000,0x0000,0xFFFF})))
          .setGeometry(new Box())))
      .addChild(new Transform().setTranslation(-4.85443,0.0694381,-0.00149918)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material())
            .setTexture(new PixelTexture().setUSE("GreyscaleAlphaCheckerboard")))
    ...
    {
        X3D thisExampleX3dModel = new greyscale_alpha().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.greyscale_alpha\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.greyscale_alpha\" self-validation test results: ");

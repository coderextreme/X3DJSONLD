 ...
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/default_viewpoint.java">default_viewpoint.java</a> source, <a href="../../../../BindableNodes/Viewpoint/default_viewpointIndex.html" target="_top">default_viewpoint catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/default_viewpoint.x3d">default_viewpoint.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test default Viewpoint properties. This world contains a single default (empty) Viewpoint node. As a result the default position of the Viewpoint should be at 0 0 10 (in front of the origin of the local coordinate system). Its orientation should be at 0 0 1 0 (no variation from the default orientation of looking directly down the Z axis in the negative direction). And any transition to another Viewpoint should result in a "jumpcut" (movement) to the next Viewpoint node, because the "jump" field is by default equal to true. As a result, the viewer should see a cubic geometry, with the word FRONT displayed, Text at the bottom of the world should show the position to be 0 0 10, and indicating the cube geometry with the pointing device should result in a "jumpcut" to the REAR view. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_viewpoint.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_viewpoint.x3d</a> </td>
		</tr>
		<tr>
...
public class default_viewpoint
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("default_viewpoint.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test default Viewpoint properties. This world contains a single default (empty) Viewpoint node. As a result the default position of the Viewpoint should be at 0 0 10 (in front of the origin of the local coordinate system). Its orientation should be at 0 0 1 0 (no variation from the default orientation of looking directly down the Z axis in the negative direction). And any transition to another Viewpoint should result in a \"jumpcut\" (movement) to the next Viewpoint node, because the \"jump\" field is by default equal to true. As a result, the viewer should see a cubic geometry, with the word FRONT displayed, Text at the bottom of the world should show the position to be 0 0 10, and indicating the cube geometry with the pointing device should result in a \"jumpcut\" to the REAR view."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_viewpoint.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("default_viewpoint.x3d"))
    .addChild(new NavigationInfo().setType("\"EXAMINE\" \"WALK\" \"FLY\" \"ANY\""))
    .addChild(new Viewpoint("VIEW1").setDescription("entry view"))
      ...
      .addChild(new Transform().setTranslation(-10.0,-5.0,-20.0)
        .addChild(new Shape()
          ...
          .setGeometry(new Text("TYPESTRING1").setString(new String[] {"(avatar position)"})
            .setFontStyle(new FontStyle().setCssStyle("BOLD"))))))
    .addChild(new Script("AVATARSCRIPT").setDirectOutput(true).setUrl(new String[] {"default_viewpoint.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_viewpoint.js"})
	 ...
	 * @return default_viewpoint model
	 */
    ...
    {
        X3D thisExampleX3dModel = new default_viewpoint().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.default_viewpoint\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.default_viewpoint\" self-validation test results: ");

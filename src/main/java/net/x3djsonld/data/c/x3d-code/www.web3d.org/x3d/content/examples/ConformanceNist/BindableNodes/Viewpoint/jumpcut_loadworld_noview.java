...
/**
 * <p> Test jumpcut to a nonexistent viewpoint in Anchor URL.Because a Viewpoint named "NonExistentView" is specified in the url, the browser should disregard any other Viewpoint node in this world, and load the Viewpoint node with DEF name "NonEXISTENTView" as the default Viewpoint. HOWEVER, because this Viewpoint does not exist in this world, it should default to the first found Viewpoint, DEFed as "RightView". The viewer should see a cubic geometry with the word RIGHT displayed on it face, and Text geometry should indicate that the current Viewpoint position is at 10 0 0. </p>
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/jumpcut_loadworld_noview.java">jumpcut_loadworld_noview.java</a> source, <a href="../../../../BindableNodes/Viewpoint/jumpcut_loadworld_noviewIndex.html" target="_top">jumpcut_loadworld_noview catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/jumpcut_loadworld_noview.x3d">jumpcut_loadworld_noview.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test jumpcut to a nonexistent viewpoint in Anchor URL.Because a Viewpoint named "NonExistentView" is specified in the url, the browser should disregard any other Viewpoint node in this world, and load the Viewpoint node with DEF name "NonEXISTENTView" as the default Viewpoint. HOWEVER, because this Viewpoint does not exist in this world, it should default to the first found Viewpoint, DEFed as "RightView". The viewer should see a cubic geometry with the word RIGHT displayed on it face, and Text geometry should indicate that the current Viewpoint position is at 10 0 0. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.x3d</a> </td>
		</tr>
		<tr>
...
public class jumpcut_loadworld_noview
{
	/** Default constructor to create this object. */
	public jumpcut_loadworld_noview ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("jumpcut_loadworld_noview.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test jumpcut to a nonexistent viewpoint in Anchor URL.Because a Viewpoint named \"NonExistentView\" is specified in the url, the browser should disregard any other Viewpoint node in this world, and load the Viewpoint node with DEF name \"NonEXISTENTView\" as the default Viewpoint. HOWEVER, because this Viewpoint does not exist in this world, it should default to the first found Viewpoint, DEFed as \"RightView\". The viewer should see a cubic geometry with the word RIGHT displayed on it face, and Text geometry should indicate that the current Viewpoint position is at 10 0 0."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("jumpcut_loadworld_noview.x3d"))
    ...
    .addChild(new Anchor().setDescription("click to reload world with nonexistent viewpoint").setUrl(new String[] {"jumpcut_loadworld_noview.x3d#NonExistentView","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.x3d#NonExistentView","jumpcut_loadworld_noview.wrl#NonExistentView","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.wrl#NonExistentView"})
      .addChild(new Shape()
      ...
      .addChild(new Transform().setTranslation(-10.0,-5.0,-20.0)
        .addChild(new Shape()
          ...
          .setGeometry(new Text("TYPESTRING1").setString(new String[] {"message from Script is inserted here"})
            .setFontStyle(new FontStyle().setCssStyle("BOLD"))))))
    .addChild(new Script("AVATARSCRIPT").setDirectOutput(true).setUrl(new String[] {"jumpcut_loadworld_noview.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.js"})
	 ...
	 * @return jumpcut_loadworld_noview model
	 */
    ...
    {
        X3D thisExampleX3dModel = new jumpcut_loadworld_noview().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.jumpcut_loadworld_noview\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.jumpcut_loadworld_noview\" self-validation test results: ");

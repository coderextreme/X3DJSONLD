...
/**
 * <p> A simple cylinder that specifies values other than the default for the radius and height fields. Carmelo Montanez. </p>
 <p> Related links: <a href="../../../../Geometry/Cylinder/extents.java">extents.java</a> source, <a href="../../../../Geometry/Cylinder/extentsIndex.html" target="_top">extents catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Cylinder/extents.x3d">extents.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> A simple cylinder that specifies values other than the default for the radius and height fields. Carmelo Montanez </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/extents.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/extents.x3d</a> </td>
		</tr>
		<tr>
...
public class extents
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("A simple cylinder that specifies values other than the default for the radius and height fields. Carmelo Montanez"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/extents.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape()
      ...
      .setGeometry(new Cylinder().setHeight(4).setRadius(4))));
    }

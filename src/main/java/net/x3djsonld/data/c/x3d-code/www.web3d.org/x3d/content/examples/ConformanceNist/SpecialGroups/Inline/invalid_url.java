...
/**
 * <p> Test skipping a non-existing URL. This defines an Inline node whose url field contains a reference to two files, the first one is a non-existing file, the second one is an existing valid VRML file. When the user loads this file, the browser may ignore the reference to the first file in the url field and access the second one. The test should generate a blue box. </p>
 <p> Related links: <a href="../../../../SpecialGroups/Inline/invalid_url.java">invalid_url.java</a> source, <a href="../../../../SpecialGroups/Inline/invalid_urlIndex.html" target="_top">invalid_url catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/Inline/invalid_url.x3d">invalid_url.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../SpecialGroups/Inline/invalid-url-front.jpg">invalid-url-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test skipping a non-existing URL. This defines an Inline node whose url field contains a reference to two files, the first one is a non-existing file, the second one is an existing valid VRML file. When the user loads this file, the browser may ignore the reference to the first file in the url field and access the second one. The test should generate a blue box. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/invalid_url.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/invalid_url.x3d</a> </td>
		</tr>
		<tr>
...
public class invalid_url
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("invalid_url.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("invalid-url-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test skipping a non-existing URL. This defines an Inline node whose url field contains a reference to two files, the first one is a non-existing file, the second one is an existing valid VRML file. When the user loads this file, the browser may ignore the reference to the first file in the url field and access the second one. The test should generate a blue box."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/invalid_url.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("invalid_url.x3d"))
    ...
    .addChild(new Inline().setUrl(new String[] {"non_existingfile.x3d","existing_file.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/existing_file.x3d","non-existingfile.wrl","existing-file.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/existing-file.wrl"})));
    }
    ...
    {
        X3D thisExampleX3dModel = new invalid_url().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.invalid_url\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.invalid_url\" self-validation test results: ");

 ...
 * <p> Test browser to make the region between the last angle of the skyAngle field and the nadir is clamped using the last angle when the last sky angle is &lt; pi. A Background node is defined with two entries in the skyAngle field and three entries in the skyColor field. The area between 1.35 radians and 3.14 radians should be color blue. </p>
 <p> Related links: <a href="../../../../BindableNodes/Background/verify_clampingsky.java">verify_clampingsky.java</a> source, <a href="../../../../BindableNodes/Background/verify_clampingskyIndex.html" target="_top">verify_clampingsky catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Background/verify_clampingsky.x3d">verify_clampingsky.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../BindableNodes/Background/verify-clampingsky-front.jpg">verify-clampingsky-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Background/verify_clampingsky.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Background/verify_clampingsky.x3d</a> </td>
		</tr>
		<tr>
...
public class verify_clampingsky
{
	/** Default constructor to create this object. */
	public verify_clampingsky ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("verify_clampingsky.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("verify-clampingsky-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Background/verify_clampingsky.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("verify_clampingsky.x3d"))
    ...
    .addChild(new Background("blues").setGroundColor(new MFColor(new double[] {0.0,0.0,0.0})).setSkyAngle(new double[] {1.2,1.35}).setSkyColor(new MFColor(new double[] {0.0,1.0,1.0,1.0,0.0,0.0,0.52941,0.80784,0.92156}))));
    }
	 ...
	 * @return verify_clampingsky model
	 */
    ...
    {
        X3D thisExampleX3dModel = new verify_clampingsky().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.verify_clampingsky\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.verify_clampingsky\" self-validation test results: ");

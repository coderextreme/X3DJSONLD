...
/**
 * <p> Test hight maxExtent value. This test assign four character strings to the string field. The strings are "THE", "VRML", "TEST","SUITE". The maxExtent field is set to 10. This value is higher than the length of any of the strings in the string field, therefore none of the strings should be altered (compressed or expanded) by this value. </p>
 <p> Related links: <a href="../../../../Geometry/Text/set_maxExtent_high.java">set_maxExtent_high.java</a> source, <a href="../../../../Geometry/Text/set_maxExtent_highIndex.html" target="_top">set_maxExtent_high catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Text/set_maxExtent_high.x3d">set_maxExtent_high.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Geometry/Text/set-maxExtent-high-front.jpg">set-maxExtent-high-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test hight maxExtent value. This test assign four character strings to the string field. The strings are "THE", "VRML", "TEST","SUITE". The maxExtent field is set to 10. This value is higher than the length of any of the strings in the string field, therefore none of the strings should be altered (compressed or expanded) by this value. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/set_maxExtent_high.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/set_maxExtent_high.x3d</a> </td>
		</tr>
		<tr>
...
public class set_maxExtent_high
{
	/** Default constructor to create this object. */
	public set_maxExtent_high ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("set_maxExtent_high.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("set-maxExtent-high-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test hight maxExtent value. This test assign four character strings to the string field. The strings are \"THE\", \"VRML\", \"TEST\",\"SUITE\". The maxExtent field is set to 10. This value is higher than the length of any of the strings in the string field, therefore none of the strings should be altered (compressed or expanded) by this value."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/set_maxExtent_high.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("set_maxExtent_high.x3d"))
    ...
    .addChild(new Transform().setTranslation(3.0,0.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Text().setMaxExtent(10).setString(new String[] {"THE","VRML ","TEST","SUITE"})))));
    }
	 ...
	 * @return set_maxExtent_high model
	 */
    ...
    {
        X3D thisExampleX3dModel = new set_maxExtent_high().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.set_maxExtent_high\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.set_maxExtent_high\" self-validation test results: ");

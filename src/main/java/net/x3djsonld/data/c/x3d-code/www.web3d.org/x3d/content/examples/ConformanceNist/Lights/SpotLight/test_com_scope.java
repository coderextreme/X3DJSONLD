 ...
 * <p> Test browser to shade light only on objects within its the radius field. The figure in question is a complex geometry (ElevationGrid). Four sets of ElevationGrrids are drawn in the XY plane forming cross-like figure and a four SpotLights with radius 5.5 and intensity 1 is also defined at the origin. If the implementation under test does NOT ignore the radius, then the last figure of each set (except the ones along the +X axis) should not be illuminated. (the last two figures along the +X axis should not be illuminated). </p>
 <p> Related links: <a href="../../../../Lights/SpotLight/test_com_scope.java">test_com_scope.java</a> source, <a href="../../../../Lights/SpotLight/test_com_scopeIndex.html" target="_top">test_com_scope catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/SpotLight/test_com_scope.x3d">test_com_scope.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/SpotLight/test-com-scope-front.jpg">test-com-scope-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_com_scope.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_com_scope.x3d</a> </td>
		</tr>
		<tr>
...
public class test_com_scope
{
	/** Default constructor to create this object. */
	public test_com_scope ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_com_scope.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-com-scope-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_com_scope.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_com_scope.x3d"))
    .addChild(new Group()
      .addChild(new SpotLight().setBeamWidth(1.57079).setCutOffAngle(.785398).setRadius(5.5))
      .addChild(new SpotLight().setBeamWidth(1.57079).setCutOffAngle(.785398).setDirection(-1.0,0.0,0.0).setRadius(5.5))
      .addChild(new SpotLight().setBeamWidth(1.57079).setCutOffAngle(.785398).setDirection(0.0,1.0,0.0).setRadius(5.5))
      .addChild(new SpotLight().setBeamWidth(1.57079).setCutOffAngle(.785398).setDirection(0.0,-1.0,0.0).setRadius(5.5)))
    ...
    .addChild(new Transform().setTranslation(0.0,-1.5,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance("the-appearance")
          .setMaterial(new Material()))
        .setGeometry(new ElevationGrid("the-grid").setSolid(false).setXDimension(21).setXSpacing(0.1).setZDimension(21).setZSpacing(0.1).setHeight(getthe_grid_5_30_height()))))
    .addChild(new Transform().setTranslation(0.0,-3.5,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setTranslation(0.0,-5.5,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setTranslation(0.0,-7.5,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(0.0,0.0,1.0,-1.57).setTranslation(-1.5,1.0,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(0.0,0.0,1.0,-1.57).setTranslation(-3.5,1.0,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(0.0,0.0,1.0,-1.57).setTranslation(-5.5,1.0,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(0.0,0.0,1.0,-1.57).setTranslation(-7.5,1.0,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(0.0,0.0,1.0,1.57).setTranslation(3.5,-1.0,-1.5)
    ...
    .addChild(new Transform().setRotation(0.0,0.0,1.0,1.57).setTranslation(7.5,-1.0,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(0.0,0.0,1.0,1.57).setTranslation(9.5,-1.0,-1.5)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(1.0,0.0,0.0,3.14).setTranslation(0.0,1.5,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(1.0,0.0,0.0,3.14).setTranslation(0.0,3.5,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(1.0,0.0,0.0,3.14).setTranslation(0.0,5.5,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid"))))
    .addChild(new Transform().setRotation(1.0,0.0,0.0,3.14).setTranslation(0.0,7.5,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance().setUSE("the-appearance"))
        .setGeometry(new ElevationGrid().setUSE("the-grid")))));
    }
	// end of initialize() method
		...
		private double[] getthe_grid_5_30_height_1()
		{
		...
		/** Large attribute array: ElevationGrid DEF='the-grid' height field, scene-graph level=5, element #30, 441 total numbers.
		 ...
		 */
		private MFFloat getthe_grid_5_30_height()
		{
			MFFloat the_grid_5_30_height = new MFFloat()/*2.finalize*/
				.append(new MFFloat(getthe_grid_5_30_height_1()));
			return the_grid_5_30_height;
		}
    ...
    {
        X3D thisExampleX3dModel = new test_com_scope().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_com_scope\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_com_scope\" self-validation test results: ");

...
/**
 * <p> This test sets the on field to true/false for two DirectionalLight node defined using two different Transform node. The test should generate two default color/size spheres. The leftmost one sholud be illuminated while the rightmost one should be dark. </p>
 <p> Related links: <a href="../../../../Lights/DirectionalLight/test_on.java">test_on.java</a> source, <a href="../../../../Lights/DirectionalLight/test_onIndex.html" target="_top">test_on catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/DirectionalLight/test_on.x3d">test_on.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/test-on-front.jpg">test-on-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/test-on-top.jpg">test-on-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/test-on-left.jpg">test-on-left.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test sets the on field to true/false for two DirectionalLight node defined using two different Transform node. The test should generate two default color/size spheres. The leftmost one sholud be illuminated while the rightmost one should be dark. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_on.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_on.x3d</a> </td>
		</tr>
		<tr>
...
public class test_on
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("This test sets the on field to true/false for two DirectionalLight node defined using two different Transform node. The test should generate two default color/size spheres. The leftmost one sholud be illuminated while the rightmost one should be dark."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_on.x3d"))

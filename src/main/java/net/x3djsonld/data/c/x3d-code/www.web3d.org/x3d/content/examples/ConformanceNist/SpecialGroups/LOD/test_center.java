 ...
 * <p> Test browser to set different values for the "center" field. The test defines two LOD node with the level field via the Inline node). The first LOD defines the leftmost figure and it sets the center to location 0 0 0. The second LOD defines the rightmost figure and it defines the center at location 0 0 40. The left most LOD in the level field. The rightmost LOD should only display the figures various options at the bottom of the figures. The test should generate a figure resembling a temple with white columns, a fly of stairs up front generated when the highest level of detail is selected), however the LOD to the right will display this figure for the TWO highest level of details. </p>
 <p> Related links: <a href="../../../../SpecialGroups/LOD/test_center.java">test_center.java</a> source, <a href="../../../../SpecialGroups/LOD/test_centerIndex.html" target="_top">test_center catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/LOD/test_center.x3d">test_center.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/test_center.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/test_center.x3d</a> </td>
		</tr>
		<tr>
...
public class test_center
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_center.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/test_center.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_center.x3d"))
    .addChild(new NavigationInfo().setType("\"EXAMINE\" \"WALK\" \"FLY\" \"ANY\""))
    .addChild(new Group()
      .addChild(new Viewpoint("the-view").setDescription("avatar position of user").setPosition(0.0,0.0,64.0)))
    ...
    .addChild(new PositionInterpolator("fourth-position").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,27.0,0.0,0.0,27.0})))
    ...
    .addChild(new PositionInterpolator("text4").setKey(new double[] {0.0,1.0}).setKeyValue(new MFVec3f(new double[] {0.0,0.0,17.0,0.0,0.0,17.0})))
    .addChild(new Transform().setRotation(1.0,0.0,0.0,0.15).setTranslation(-7.0,2.0,0.0)
      .addChild(new LOD().setRange(new double[] {28.0,33.0,49.0})
        ...
        .addChild(new Inline("ref2").setUrl(new String[] {"ref2.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref2.x3d","ref2.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref2.wrl"}))
        .addChild(new Inline("ref3").setUrl(new String[] {"ref3.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref3.x3d","ref3.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref3.wrl"}))
        .addChild(new Inline("ref4").setUrl(new String[] {"ref4.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref4.x3d","ref4.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref4.wrl"}))))
    .addChild(new Transform().setRotation(1.0,0.0,0.0,0.15).setTranslation(7.0,2.0,0.0)
      .addChild(new LOD().setCenter(0.0,0.0,17.0).setRange(new double[] {28.0,33.0,49.0})
        .addChild(new Inline().setUSE("ref1"))
        .addChild(new Inline().setUSE("ref2"))
        .addChild(new Inline().setUSE("ref3"))
        .addChild(new Inline().setUSE("ref4"))))
    ...
    {
        X3D thisExampleX3dModel = new test_center().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_center\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_center\" self-validation test results: ");

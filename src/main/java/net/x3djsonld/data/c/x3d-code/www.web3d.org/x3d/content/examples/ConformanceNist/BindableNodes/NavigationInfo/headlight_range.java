 ...
 <p> Related links: <a href="../../../../BindableNodes/NavigationInfo/headlight_range.java">headlight_range.java</a> source, <a href="../../../../BindableNodes/NavigationInfo/headlight_rangeIndex.html" target="_top">headlight_range catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/NavigationInfo/headlight_range.x3d">headlight_range.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/NavigationInfo/headlight_rangeOn.png">headlight_rangeOn.png</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../BindableNodes/NavigationInfo/headlight_rangeOff.png">headlight_rangeOff.png</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> This is a test of the default state of the headlight field, and setting headlight to true and false. Initially the Box geometry should be illuminated, indicating that the default headlight value is true. Pressing the pointing device button while over the Box geometry in this world should toggle the headlight field value of the NavigationInfo node from true to false, turning off the headlight, and providing no illumination to the Box geometry. The Box geometry should appear black. Subsequent toggling of the headlight should turn it on and off. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/headlight_range.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/headlight_range.x3d</a> </td>
		</tr>
		<tr>
...
public class headlight_range
{
	/** Default constructor to create this object. */
	public headlight_range ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("headlight_range.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("headlight_rangeOn.png"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("headlight_rangeOff.png"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/headlight_range.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("headlight_range.x3d"))
    ...
    .addChild(new Transform()
      .addChild(new TouchSensor("TOUCH").setDescription("touch to toggle light switch"))
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Box())))
    .addChild(new Script("LIGHTSWITCH").setDirectOutput(true).setUrl(new String[] {"headlight_range.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/headlight_range.js"})
    ...
    .addChild(new ROUTE().setFromNode("TOUCH").setFromField("isActive").setToNode("LIGHTSWITCH").setToField("toggle")));
    }
    ...
    {
        X3D thisExampleX3dModel = new headlight_range().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.headlight_range\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.headlight_range\" self-validation test results: ");

...
/**
 * <p> Volume rendering of a brain MR image, rendered with default (opacityMapped) style. </p>
 <p> Related links: <a href="../../../VolumeRendering/BasicBrain.java">BasicBrain.java</a> source, <a href="../../../VolumeRendering/BasicBrainIndex.html" target="_top">BasicBrain catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../VolumeRendering/BasicBrain.x3d">BasicBrain.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> Volume rendering of a brain MR image, rendered with default (opacityMapped) style </td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> Get prerequisite dataset, <a href="http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/brain2.nrrd" target="_blank">http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/brain2.nrrd</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BasicBrain.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BasicBrain.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
...
public class BasicBrain
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("BasicBrain.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Volume rendering of a brain MR image, rendered with default (opacityMapped) style"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("basicBrain.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("Get prerequisite dataset, http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/brain2.nrrd"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BasicBrain.x3d"))
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("BasicBrain.x3d"))
    .addChild(new Group()
      .addChild(new Viewpoint("VP").setDescription("Basic Brain").setOrientation(-0.0212122,0.99986,0.012461,3.23009).setPosition(-0.00920216,0.012033,-0.184913))
    ...
    {
        X3D thisExampleX3dModel = new BasicBrain().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.BasicBrain\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.BasicBrain\" self-validation test results: ");

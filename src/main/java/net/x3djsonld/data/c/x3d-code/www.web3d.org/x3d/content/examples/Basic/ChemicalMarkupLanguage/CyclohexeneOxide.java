...
/**
 * <p> Autogenerated version of CyclohexeneOxide.x3d scene produced from CyclohexeneOxide.xml Chemical Markup Language (CML) version 1.0 source file. </p>
 <p> Related links: <a href="../../../ChemicalMarkupLanguage/CyclohexeneOxide.java">CyclohexeneOxide.java</a> source, <a href="../../../ChemicalMarkupLanguage/CyclohexeneOxideIndex.html" target="_top">CyclohexeneOxide catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../ChemicalMarkupLanguage/CyclohexeneOxide.x3d">CyclohexeneOxide.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> Autogenerated version of CyclohexeneOxide.x3d scene produced from CyclohexeneOxide.xml Chemical Markup Language (CML) version 1.0 source file. </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="../../../ChemicalMarkupLanguage/CyclohexeneOxide.xml">CyclohexeneOxide.xml</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/CyclohexeneOxide.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/CyclohexeneOxide.x3d</a> </td>
		</tr>
		<tr>
...
public class CyclohexeneOxide
{
	/** Default constructor to create this object. */
	public CyclohexeneOxide ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("CyclohexeneOxide.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of CyclohexeneOxide.x3d scene produced from CyclohexeneOxide.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("CyclohexeneOxide.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/CyclohexeneOxide.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("CyclohexeneOxide.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect CyclohexeneOxide").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"Cyclohexene Oxide: C6 H10 O"}))))
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"molecule weight: 98.14"}))))
      .addChild(new Transform().setTranslation(0.0,4.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"melting point: -40"}))))
      .addChild(new Transform().setTranslation(0.0,3.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"boiling point: 130"}))))
      .addChild(new Transform().setTranslation(0.0,2.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"specific gravity: 0.97"})))))
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclohexene_oxide_a1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.8118,0.9766,1.8854)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclohexene_oxide_a2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.0793,0.7825,3.3416)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "cyclohexene_oxide_a3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.3606,1.93,2.8637)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclohexene_oxide_a4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.9157,1.4197,0.9518)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclohexene_oxide_a5").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.4624,0.9966,3.9062)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclohexene_oxide_a6").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.2987,1.2094,1.5502)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclohexene_oxide_a7").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.381,1.7599,2.9643))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "cyclohexene_oxide_b1").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.0793,0.7825,3.3416,0.8118,0.9766,1.8854})))))
      .addChild(new ProtoInstance("line", "cyclohexene_oxide_b2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {0.8118,0.9766,1.8854,0.3606,1.93,2.8637})))))
      .addChild(new ProtoInstance("line", "cyclohexene_oxide_b3").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {0.8118,0.9766,1.8854,1.9157,1.4197,0.9518})))))
      .addChild(new ProtoInstance("line", "cyclohexene_oxide_b5").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {0.3606,1.93,2.8637,1.0793,0.7825,3.3416})))))
      .addChild(new ProtoInstance("line", "cyclohexene_oxide_b6").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.4624,0.9966,3.9062,1.0793,0.7825,3.3416})))))
      .addChild(new ProtoInstance("line", "cyclohexene_oxide_b8").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.9157,1.4197,0.9518,3.2987,1.2094,1.5502})))))
      .addChild(new ProtoInstance("line", "cyclohexene_oxide_b11").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.381,1.7599,2.9643,2.4624,0.9966,3.9062})))))
      .addChild(new ProtoInstance("line", "cyclohexene_oxide_b14").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.381,1.7599,2.9643,3.2987,1.2094,1.5502})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new CyclohexeneOxide().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.CyclohexeneOxide\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.CyclohexeneOxide\" self-validation test results: ");

...
public class _1_4_Dihydronaphthalene
{
	...
	public _1_4_Dihydronaphthalene ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("_1-4-Dihydronaphthalene.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of _1-4-Dihydronaphthalene.x3d scene produced from _1-4-Dihydronaphthalene.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("_1-4-Dihydronaphthalene.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/_1-4-Dihydronaphthalene.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("_1-4-Dihydronaphthalene.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect _1-4-Dihydronaphthalene").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"_1-4-Dihydronaphthalene: C10 H10"}))))
      ...
      .addChild(new Transform().setTranslation(0.0,4.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"melting point: 207"}))))
      .addChild(new Transform().setTranslation(0.0,3.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"boiling point: -35.8"}))))
    ...
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.9478,1.7879,0.8809)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.9477,3.1805,0.8809)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.1499,1.0958,0.8809)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.1502,3.8723,0.8809)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a5").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.3665,3.1822,0.8809)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a6").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.3665,1.7856,0.8809)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a7").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(4.6338,3.9703,0.8814)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a8").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(4.6336,0.9973,0.8813)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a9").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(5.8696,1.8177,0.8716)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_1_4-dihydronaphthalene_a10").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(5.8698,3.1496,0.8715))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "_1_4-dihydronaphthalene_b11").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.3665,3.1822,0.8809,4.6338,3.9703,0.8814})))))
      .addChild(new ProtoInstance("line", "_1_4-dihydronaphthalene_b12").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {4.6336,0.9973,0.8813,3.3665,1.7856,0.8809})))))
      .addChild(new ProtoInstance("line", "_1_4-dihydronaphthalene_b13").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {4.6338,3.9703,0.8814,5.8698,3.1496,0.8715})))))
      .addChild(new ProtoInstance("line", "_1_4-dihydronaphthalene_b16").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {5.8696,1.8177,0.8716,4.6336,0.9973,0.8813})))))
      .addChild(new ProtoInstance("line", "_1_4-dihydronaphthalene_b19").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {5.8498,3.1496,0.8715,5.849600000000001,1.8177,0.8716})))))
      .addChild(new ProtoInstance("line", "_1_4-dihydronaphthalene_b19_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {5.889799999999999,3.1496,0.8715,5.8896,1.8177,0.8716})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new _1_4_Dihydronaphthalene().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data._1_4_Dihydronaphthalene\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data._1_4_Dihydronaphthalene\" self-validation test results: ");

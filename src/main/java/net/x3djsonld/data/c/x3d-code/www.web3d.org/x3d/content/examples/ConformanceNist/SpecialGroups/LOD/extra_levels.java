 ...
 * <p> Test browser to ignore extra entries in the level field for which there are no corresponding entries in the range field. The test defines an LOD node with the level field ref2.x3d,ref3.x3d,ref4.x3d. The range field specifies two different range values that indicate at what distance to display the corresponding entry from the level field. The fourth entry in the level field does not contain a corresponding entry in the range field and therefore should always be ignore regardless of the users avatar position Each entry in the level field adds a level of detail to the figure in question as the users avatar gets closer to the figure. The distance of the viewer from the object is changed by clicking on the desired buttom as indicated by the text displayed. The test should generate a figure that resembles a temple with white columns, a fly of stairs up front and a displayed when the highest level of detail is selected. Other levels display a version of the same figure, but with much less details.). </p>
 <p> Related links: <a href="../../../../SpecialGroups/LOD/extra_levels.java">extra_levels.java</a> source, <a href="../../../../SpecialGroups/LOD/extra_levelsIndex.html" target="_top">extra_levels catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/LOD/extra_levels.x3d">extra_levels.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/extra_levels.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/extra_levels.x3d</a> </td>
		</tr>
		<tr>
...
public class extra_levels
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("extra_levels.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/extra_levels.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("extra_levels.x3d"))
    ...
    .addChild(new Transform().setRotation(1.0,0.0,0.0,0.15)
      .addChild(new LOD("intentional-extra-level").setRange(new double[] {17.0,33.0})
    ...
    {
        X3D thisExampleX3dModel = new extra_levels().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.extra_levels\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.extra_levels\" self-validation test results: ");

...
public class VitaminK
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("VitaminK.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of VitaminK.x3d scene produced from VitaminK.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("VitaminK.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/VitaminK.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("VitaminK.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect VitaminK").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"Vitamin K: C6 H4 O2"}))))
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"molecule weight: 108.09"}))))
      .addChild(new Transform().setTranslation(0.0,4.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"melting point: 115.7"}))))
      .addChild(new Transform().setTranslation(0.0,3.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"boiling point: 293"}))))
      .addChild(new Transform().setTranslation(0.0,2.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"specific gravity: 1.318"})))))
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "vitamin_k_a1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.0,0.8435,1.207)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "vitamin_k_a2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.0807,0.7866,1.764)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "vitamin_k_a3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.2015,0.3731,3.1873)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "vitamin_k_a4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.3417,1.1235,1.0512)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "vitamin_k_a5").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.3882,0.308,3.7965)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "vitamin_k_a6").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.5268,1.0604,1.6634)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "vitamin_k_a7").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.6493,0.6491,3.0867)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "vitamin_k_a8").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(4.7298,0.5952,3.6443))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "vitamin_k_b1").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {-0.02,0.8435,1.207,1.0607,0.7866,1.764})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b1_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {0.02,0.8435,1.207,1.1007,0.7866,1.764})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.2015,0.3731,3.1873,1.0807,0.7866,1.764})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b3").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.0807,0.7866,1.764,2.3417,1.1235,1.0512})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b4").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.3682,0.308,3.7965,1.1815,0.3731,3.1873})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b4_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.4082,0.308,3.7965,1.2215,0.3731,3.1873})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b6").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.3217,1.1235,1.0512,3.5068,1.0604,1.6634})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b6_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.3617,1.1235,1.0512,3.5468,1.0604,1.6634})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b8").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.6493,0.6491,3.0867,2.3882,0.308,3.7965})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b10").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.5268,1.0604,1.6634,3.6493,0.6491,3.0867})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b12").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.6293,0.6491,3.0867,4.7098,0.5952,3.6443})))))
      .addChild(new ProtoInstance("line", "vitamin_k_b12_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.6693000000000002,0.6491,3.0867,4.7498,0.5952,3.6443})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new VitaminK().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.VitaminK\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.VitaminK\" self-validation test results: ");

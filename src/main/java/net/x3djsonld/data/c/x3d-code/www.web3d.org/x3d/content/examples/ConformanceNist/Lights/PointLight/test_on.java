...
/**
 * <p> This test sets the on field to true/false for two PointLight node defined using two different Transform node. The test should generate two default size Spheres. The leftmost one should be illuminated and the rightmost one should be dark. </p>
 <p> Related links: <a href="../../../../Lights/PointLight/test_on.java">test_on.java</a> source, <a href="../../../../Lights/PointLight/test_onIndex.html" target="_top">test_on catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/PointLight/test_on.x3d">test_on.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/PointLight/test-on-front.jpg">test-on-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/PointLight/test-on-top.jpg">test-on-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/PointLight/test-on-left.jpg">test-on-left.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test sets the on field to true/false for two PointLight node defined using two different Transform node. The test should generate two default size Spheres. The leftmost one should be illuminated and the rightmost one should be dark. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_on.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_on.x3d</a> </td>
		</tr>
		<tr>
...
public class test_on
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("This test sets the on field to true/false for two PointLight node defined using two different Transform node. The test should generate two default size Spheres. The leftmost one should be illuminated and the rightmost one should be dark."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_on.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform().setTranslation(-3.0,0.0,0.0)
      .addChild(new PointLight().setAmbientIntensity(0.1).setLocation(0.5,0.0,2.0).setRadius(3))
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Sphere())))
    .addChild(new Transform().setTranslation(2.0,0.0,0.0)
      .addChild(new PointLight().setLocation(0.0,0.0,1.0).setOn(false))
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Sphere()))));

...
/**
 * <p> This test sets the "choice" field to three "Shape" node, and the "whichChoice" field to 0. Under these conditions the first choice should be chosen from the "choice" field. The test should generate a green sphere with some text on top of it. If any other geometry is generated, then a failure has occurred. </p>
 <p> Related links: <a href="../../../../SpecialGroups/Switch/select_firstchoice.java">select_firstchoice.java</a> source, <a href="../../../../SpecialGroups/Switch/select_firstchoiceIndex.html" target="_top">select_firstchoice catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/Switch/select_firstchoice.x3d">select_firstchoice.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../SpecialGroups/Switch/select-firstchoice-front.jpg">select-firstchoice-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test sets the "choice" field to three "Shape" node, and the "whichChoice" field to 0. Under these conditions the first choice should be chosen from the "choice" field. The test should generate a green sphere with some text on top of it. If any other geometry is generated, then a failure has occurred. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Switch/select_firstchoice.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Switch/select_firstchoice.x3d</a> </td>
		</tr>
		<tr>
...
public class select_firstchoice
{
	/** Default constructor to create this object. */
	public select_firstchoice ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("select_firstchoice.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("select-firstchoice-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Switch/select_firstchoice.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("select_firstchoice.x3d"))
    ...
    .addChild(new Transform().setTranslation(0.0,4.0,0.0)
      .addChild(new Shape()
        ...
        .setGeometry(new Text().setString(new String[] {"A GREEN SPHERE BELOW INDICATES THAT","THIS BROWSER PASSED THIS TEST","(ANYTHING ELSE INDICATES FAILURE)"})
    ...
    .addChild(new Switch().setWhichChoice(0)
      .addChild(new Shape()
        ...
        .setGeometry(new Sphere().setRadius(1.8)))
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(0.0,1.0,0.0).setEmissiveColor(0.0,1.0,0.0)))
	 ...
	 * @return select_firstchoice model
	 */
    ...
    {
        X3D thisExampleX3dModel = new select_firstchoice().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.select_firstchoice\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.select_firstchoice\" self-validation test results: ");

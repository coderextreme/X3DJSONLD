 ...
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/noviewpoint.java">noviewpoint.java</a> source, <a href="../../../../BindableNodes/Viewpoint/noviewpointIndex.html" target="_top">noviewpoint catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/noviewpoint.x3d">noviewpoint.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../BindableNodes/Viewpoint/noviewpoint-front.jpg">noviewpoint-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser state with no Viewpoint node present. No Viewpoint node is present in this world. By default, the browser should set it state to that of a default Viewpoint node, with an initial position of 0 0 10, and and initial orientation of 0 0 1 0 (no change from the initial orientation along the -Z direction, coincident with the Z axis). The viewer should be looking down the Z axis in the negative direction, and be at a distance of 10 meters from the origin. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/noviewpoint.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/noviewpoint.x3d</a> </td>
		</tr>
		<tr>
...
public class noviewpoint
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("noviewpoint.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("noviewpoint-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test browser state with no Viewpoint node present. No Viewpoint node is present in this world. By default, the browser should set it state to that of a default Viewpoint node, with an initial position of 0 0 10, and and initial orientation of 0 0 1 0 (no change from the initial orientation along the -Z direction, coincident with the Z axis). The viewer should be looking down the Z axis in the negative direction, and be at a distance of 10 meters from the origin."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/noviewpoint.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("noviewpoint.x3d"))
      ...
      .addChild(new Transform().setTranslation(-10.0,-5.0,-20.0)
        .addChild(new Shape()
          ...
          .setGeometry(new Text("TYPESTRING1").setString(new String[] {"message from Script is inserted here"})
            .setFontStyle(new FontStyle().setCssStyle("BOLD"))))))
    .addChild(new Script("AVATARSCRIPT").setDirectOutput(true).setUrl(new String[] {"noviewpoint.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/noviewpoint.js"})
    ...
    {
        X3D thisExampleX3dModel = new noviewpoint().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.noviewpoint\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.noviewpoint\" self-validation test results: ");

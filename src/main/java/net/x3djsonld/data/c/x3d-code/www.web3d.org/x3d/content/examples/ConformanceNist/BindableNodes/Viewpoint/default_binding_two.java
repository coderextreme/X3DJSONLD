...
/**
 * <p> Test selection of first Viewpoint found. Two Viewpoint node exist in this world. By default, the first Viewpoint node found in the world will be bound to the stack. The first Viewpoint in thiw world is a RIGHT side Viewpoint. The viewer should see a cube with the word RIGHT displayed on its face. At the bottom of the world, there should be Text stating that the Viewpoint position is 10 0 0. </p>
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/default_binding_two.java">default_binding_two.java</a> source, <a href="../../../../BindableNodes/Viewpoint/default_binding_twoIndex.html" target="_top">default_binding_two catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/default_binding_two.x3d">default_binding_two.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../BindableNodes/Viewpoint/default_binding_two-front.jpg">default_binding_two-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test selection of first Viewpoint found. Two Viewpoint node exist in this world. By default, the first Viewpoint node found in the world will be bound to the stack. The first Viewpoint in thiw world is a RIGHT side Viewpoint. The viewer should see a cube with the word RIGHT displayed on its face. At the bottom of the world, there should be Text stating that the Viewpoint position is 10 0 0. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_two.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_two.x3d</a> </td>
		</tr>
		<tr>
...
public class default_binding_two
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test selection of first Viewpoint found. Two Viewpoint node exist in this world. By default, the first Viewpoint node found in the world will be bound to the stack. The first Viewpoint in thiw world is a RIGHT side Viewpoint. The viewer should see a cube with the word RIGHT displayed on its face. At the bottom of the world, there should be Text stating that the Viewpoint position is 10 0 0."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_two.x3d"))
      ...
      .addChild(new Transform().setTranslation(-10.0,-5.0,-20.0)
        .addChild(new Shape()
          ...
          .setGeometry(new Text("TYPESTRING1").setString(new String[] {"message from Script is inserted here"})
            .setFontStyle(new FontStyle().setCssStyle("BOLD"))))))
    .addChild(new Script("AVATARSCRIPT").setDirectOutput(true).setUrl(new String[] {"default_binding_two.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_two.js"})

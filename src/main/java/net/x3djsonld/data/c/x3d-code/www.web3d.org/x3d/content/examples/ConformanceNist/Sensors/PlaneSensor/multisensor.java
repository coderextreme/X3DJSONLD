 ...
 <p> Related links: <a href="../../../../Sensors/PlaneSensor/multisensor.java">multisensor.java</a> source, <a href="../../../../Sensors/PlaneSensor/multisensorIndex.html" target="_top">multisensor catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/PlaneSensor/multisensor.x3d">multisensor.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/PlaneSensor/multisensor-movie.mpg">multisensor-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test if a PlaneSensor grabs all further motion events from pointing device when the sensor generates "isActive" true event for primitive geometry. The Box geometry has an associated PlaneSensor that routes its "trackPoint_changed" events to that geometrys Transform node. As a result, pressing the primary pointing device button while over the Box should translate that geometry in an XY plane coincident with the intersection point of the pointing device bearing and the geometry surface. In addition, a TouchSensor is assocated with the Box geometry and a PointLight, but is nested "higher" in the sensor hierarchy. Passing the primary pointing device over the Box should route and isActive event to a PointLight and illuminate the IndexedFaceSets. Dragging the pointing device over the Box geometry and holding the primary pointing device button down should generate an isActive = true event for the PlaneSensor and prevent the TouchSensor from activating (and the PointLight from coming ON), When the button is released, and the cursor is over the Box, the PointLight should turn on. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/multisensor.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/multisensor.x3d</a> </td>
		</tr>
		<tr>
...
public class multisensor
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test if a PlaneSensor grabs all further motion events from pointing device when the sensor generates \"isActive\" true event for primitive geometry. The Box geometry has an associated PlaneSensor that routes its \"trackPoint_changed\" events to that geometrys Transform node. As a result, pressing the primary pointing device button while over the Box should translate that geometry in an XY plane coincident with the intersection point of the pointing device bearing and the geometry surface. In addition, a TouchSensor is assocated with the Box geometry and a PointLight, but is nested \"higher\" in the sensor hierarchy. Passing the primary pointing device over the Box should route and isActive event to a PointLight and illuminate the IndexedFaceSets. Dragging the pointing device over the Box geometry and holding the primary pointing device button down should generate an isActive = true event for the PlaneSensor and prevent the TouchSensor from activating (and the PointLight from coming ON), When the button is released, and the cursor is over the Box, the PointLight should turn on."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/multisensor.x3d"))

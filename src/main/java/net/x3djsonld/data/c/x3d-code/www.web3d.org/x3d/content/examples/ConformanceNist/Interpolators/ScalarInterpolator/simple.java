...
/**
 * <p> Test of basic functionality. A ScalarInterpolator node is used to change the intensity of a SpotLight that illuminates a Cylinder geometry. The fraction_changed field of a TimeSensor node is used to change the position from keyValues of [ 0.0, 0.5, 1.0, 0.5 0.0 ] for keys of [ 0, 0.25, 0.5, 0.75 and 1.0 ] respectively. As a result: the Cylinder geometry will increase from no illumination to maximum illumination, then decrease to no illumination over a 5 second time interval. </p>
 <p> Related links: <a href="../../../../Interpolators/ScalarInterpolator/simple.java">simple.java</a> source, <a href="../../../../Interpolators/ScalarInterpolator/simpleIndex.html" target="_top">simple catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Interpolators/ScalarInterpolator/simple.x3d">simple.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Interpolators/ScalarInterpolator/simple-movie.mpg">simple-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test of basic functionality. A ScalarInterpolator node is used to change the intensity of a SpotLight that illuminates a Cylinder geometry. The fraction_changed field of a TimeSensor node is used to change the position from keyValues of [ 0.0, 0.5, 1.0, 0.5 0.0 ] for keys of [ 0, 0.25, 0.5, 0.75 and 1.0 ] respectively. As a result: the Cylinder geometry will increase from no illumination to maximum illumination, then decrease to no illumination over a 5 second time interval. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/ScalarInterpolator/simple.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/ScalarInterpolator/simple.x3d</a> </td>
		</tr>
		<tr>
...
public class simple
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test of basic functionality. A ScalarInterpolator node is used to change the intensity of a SpotLight that illuminates a Cylinder geometry. The fraction_changed field of a TimeSensor node is used to change the position from keyValues of [ 0.0, 0.5, 1.0, 0.5 0.0 ] for keys of [ 0, 0.25, 0.5, 0.75 and 1.0 ] respectively. As a result: the Cylinder geometry will increase from no illumination to maximum illumination, then decrease to no illumination over a 5 second time interval."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/ScalarInterpolator/simple.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new ScalarInterpolator("SCALAR_INTERPOLATOR").setKey(new double[] {0.0,0.25,0.5,0.75,1.0}).setKeyValue(new double[] {0.0,0.5,1.0,0.5,0.0}))
    .addChild(new Group()

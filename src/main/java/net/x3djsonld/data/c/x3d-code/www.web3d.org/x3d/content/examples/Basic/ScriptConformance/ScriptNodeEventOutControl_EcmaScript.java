 ...
 * <p> Script node interface between VRML and EcmaScript: this conformance example tests event-based VRML-EcmaScript functionality. </p>
 <p> Related links: <a href="../../../ScriptConformance/ScriptNodeEventOutControl_EcmaScript.java">ScriptNodeEventOutControl_EcmaScript.java</a> source, <a href="../../../ScriptConformance/ScriptNodeEventOutControl_EcmaScriptIndex.html" target="_top">ScriptNodeEventOutControl_EcmaScript catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../ScriptConformance/ScriptNodeEventOutControl_EcmaScript.x3d">ScriptNodeEventOutControl_EcmaScript.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/ScriptConformance/ScriptNodeEventOutControl_EcmaScript.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/ScriptConformance/ScriptNodeEventOutControl_EcmaScript.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> ScriptNodeEventOutControl_EcmaScript-VrmlConsoleOutput.txt </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="../../../ScriptConformance/ScriptNodeEventOutControl_EcmaScriptSnapshots.html">ScriptNodeEventOutControl_EcmaScriptSnapshots.html</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="../../../ScriptConformance/ScriptNodeEventOutControl_Java.x3d">ScriptNodeEventOutControl_Java.x3d</a> </td>
		</tr>
		<tr>
...
public class ScriptNodeEventOutControl_EcmaScript
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ScriptConformance/ScriptNodeEventOutControl_EcmaScript.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeEventOutControl_EcmaScript-VrmlConsoleOutput.txt"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeEventOutControl_EcmaScriptSnapshots.html"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeEventOutControl_Java.x3d"))

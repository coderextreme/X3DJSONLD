...
/**
 * <p> Script node interface between VRML and EcmaScript: this conformance example tests event-based VRML/EcmaScript functionality. </p>
 <p> Related links: <a href="../../../../Miscellaneous/Script/ScriptNodeEventOutControl_EcmaScript.java">ScriptNodeEventOutControl_EcmaScript.java</a> source, <a href="../../../../Miscellaneous/Script/ScriptNodeEventOutControl_EcmaScriptIndex.html" target="_top">ScriptNodeEventOutControl_EcmaScript catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Miscellaneous/Script/ScriptNodeEventOutControl_EcmaScript.x3d">ScriptNodeEventOutControl_EcmaScript.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ScriptConformance/ScriptNodeEventOutControl_EcmaScript.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ScriptConformance/ScriptNodeEventOutControl_EcmaScript.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/Script/ScriptNodeEventOutControl_EcmaScript.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/Script/ScriptNodeEventOutControl_EcmaScript.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> ScriptNodeEventOutControl_EcmaScript_VrmlConsoleOutput.txt </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="../../../../Miscellaneous/Script/ScriptNodeEventOutControl_EcmaScriptSnapshots.html">ScriptNodeEventOutControl_EcmaScriptSnapshots.html</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="../../../../Miscellaneous/Script/ScriptNodeEventOutControl-Java.x3d">ScriptNodeEventOutControl-Java.x3d</a> </td>
		</tr>
		<tr>
...
public class ScriptNodeEventOutControl_EcmaScript
{
	/** Default constructor to create this object. */
	public ScriptNodeEventOutControl_EcmaScript ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("ScriptNodeEventOutControl_EcmaScript.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Script node interface between VRML and EcmaScript: this conformance example tests event-based VRML/EcmaScript functionality."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("https://www.web3d.org/x3d/content/examples/ScriptConformance/ScriptNodeEventOutControl_EcmaScript.x3d"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/Script/ScriptNodeEventOutControl_EcmaScript.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeEventOutControl_EcmaScript_VrmlConsoleOutput.txt"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeEventOutControl_EcmaScriptSnapshots.html"))
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("ScriptNodeEventOutControl_EcmaScript.x3d"))
    ...
    .addChild(new Group()
      ...
      .addChild(new Transform("TextPosition")
        ...
        .addChild(new Shape()
          .setGeometry(new Text("MessageToUser").setString(new String[] {"Default text in VRML scene will be replaced by","EcmaScript initialize() in Script using EventOut control.","This text appears first, if EcmaScript initialization fails.",""})
...
"}" + "\n")
	 ...
	 * @return ScriptNodeEventOutControl_EcmaScript model
	 */
    ...
    {
        X3D thisExampleX3dModel = new ScriptNodeEventOutControl_EcmaScript().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.ScriptNodeEventOutControl_EcmaScript\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.ScriptNodeEventOutControl_EcmaScript\" self-validation test results: ");

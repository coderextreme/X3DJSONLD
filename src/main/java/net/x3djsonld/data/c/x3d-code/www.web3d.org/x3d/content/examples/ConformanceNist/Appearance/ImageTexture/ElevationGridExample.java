 ...
 * <p> Map a JPG image to an ElevationGrid. An ElevationGrid is default texture mapped by aligning the S (horizontal) axis of the VTS logo with the X axis of the ElevationGrid and the T (vertical) axis of the VTS logo with the Z axis of the ElevationGrid. The bottom of the VTS logo coincides with the first row of grid points and the top of the VTS logo maps to the last row of grid points. </p>
 <p> Related links: <a href="../../../../Appearance/ImageTexture/ElevationGridExample.java">ElevationGridExample.java</a> source, <a href="../../../../Appearance/ImageTexture/ElevationGridExampleIndex.html" target="_top">ElevationGridExample catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/ImageTexture/ElevationGridExample.x3d">ElevationGridExample.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/ElevationGridExample.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/ElevationGridExample.x3d</a> </td>
		</tr>
		<tr>
...
public class ElevationGridExample
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/ElevationGridExample.x3d"))

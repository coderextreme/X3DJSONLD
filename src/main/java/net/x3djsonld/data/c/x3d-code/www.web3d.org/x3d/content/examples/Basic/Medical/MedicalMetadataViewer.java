...
/**
 * <p> Viewer demonstrating sample medical ontology integration with X3D scene graph. </p>
 <p> Related links: <a href="../../../Medical/MedicalMetadataViewer.java">MedicalMetadataViewer.java</a> source, <a href="../../../Medical/MedicalMetadataViewerIndex.html" target="_top">MedicalMetadataViewer catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../Medical/MedicalMetadataViewer.x3d">MedicalMetadataViewer.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> Viewer demonstrating sample medical ontology integration with X3D scene graph. </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/Medical/MedicalMetadataViewer.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/Medical/MedicalMetadataViewer.x3d</a> </td>
		</tr>
		<tr>
...
public class MedicalMetadataViewer
{
	/** Default constructor to create this object. */
	public MedicalMetadataViewer ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("MedicalMetadataViewer.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Viewer demonstrating sample medical ontology integration with X3D scene graph."))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/Medical/MedicalMetadataViewer.x3d"))
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("MedicalMetadataViewer.x3d"))
      ...
      .addChild(new Group("BodyParts")
        .addChild(new Group("RespiratorySystem")
          .setMetadata(new MetadataSet("m7334").setName("Upper_lobe_of_lung").setReference("FMA")
            .setMetadata(new MetadataString().setName("has inherent 3D shape").setValue(new String[] {"true"}))
          ...
          .addChild(new Transform("RespiratoryShape").setRotation(-.995,.102,0.0,3.142).setScale(3.96357,4.0229,6.98914).setTranslation(-9.65146,62.0249,-3.89403)
            ...
            .addChild(new TouchSensor("lungTS").setDescription("Show Info")))
        ...
        .addChild(new Group("DigestiveSystem")
          .addChild(new Group("Liver")
            ...
            .addChild(new Transform("LiverShape").setRotation(.964,.197,-.18,1.86).setScale(2.99435,2.25363,4.39602).setTranslation(10.6182,24.9426,-4.66205)
              ...
              .addChild(new TouchSensor("liverTS").setDescription("Show Info"))))
          .addChild(new Group("Colon")
            ...
            .addChild(new Transform("dad_colon").setRotation(.614,-.789,0.0,.222).setTranslation(-.14727,5.15789,-8.63757)
              .addChild(new Shape("colon")
                ...
                .setGeometry(new IndexedFaceSet("GeoSculptedSurface2").setDEF("GeoSculptedSurface2").setCreaseAngle(1.047).setCoordIndex(getGeoSculptedSurface2_9_127_coordIndex())
                  .setCoord(new Coordinate().setPoint(getCoordinate_10_127_point()))))
              .addChild(new TouchSensor("colonTS").setDescription("Show Info")))))))
    .addChild(new Viewpoint().setPosition(0.0,40.0,145.0))
    .addChild(new Transform("HUD")
      .addChild(new Transform("dad_HUDoffset").setScale(.05,.05,.05).setTranslation(-.3,-0.35,-1.0)
        .addChild(new Transform("dad_Text1").setTranslation(-4.57411,.7,.39084)
          .addChild(new Shape("Text1")
            .setAppearance(new Appearance()
              .setMaterial(new Material().setUSE("White")))
            .setGeometry(new Text("GeoText1").setMaxExtent(0.000).setString(new String[] {"Show / Hide Skin"})
              .setFontStyle(new FontStyle().setFamily(new String[] {"SANS"}).setJustify(FontStyle.JUSTIFY_BEGIN_BEGIN).setSpacing(1.000).setCssStyle("ITALIC")))))
        .addChild(new Transform("dad_Group1").setTranslation(-.06693,0.0,.0019)
          .addChild(new Group("Group1")
            .addChild(new Transform("dad_Sphere1").setTranslation(-5.97145,0.0,.1144)
              .addChild(new Shape("Sphere1")
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setUSE("Red")))
                .setGeometry(new Sphere("GeoSphere1").setRadius(.75))))
            .addChild(new TouchSensor("bodyTS").setDescription("toggle body geometry"))))
        .addChild(new DirectionalLight("Light1").setAmbientIntensity(0.000).setDirection(.11526,-.6393,-.76027).setIntensity(1.000))
        .addChild(new Transform().setTranslation(-8.0,15.0,0.0)
          .addChild(new Shape("Text2")
            .setAppearance(new Appearance()
              .setMaterial(new Material().setUSE("White")))
            .setGeometry(new Text("msg").setMaxExtent(0.000).setString(new String[] {"Metadata Info","line2"})
              .setFontStyle(new FontStyle().setJustify(FontStyle.JUSTIFY_BEGIN_BEGIN).setSize(.7500)))))))
    .addChild(new ProximitySensor("PS").setSize(1000.0,1000.0,1000.0))
    .addChild(new ROUTE().setFromNode("PS").setFromField("position_changed").setToNode("HUD").setToField("set_translation"))
    .addChild(new ROUTE().setFromNode("PS").setFromField("orientation_changed").setToNode("HUD").setToField("set_rotation"))
    .addChild(new Script("toggler").setSourceCode("\n" + 
"      " + "\n" + 
"ecmascript:" + "\n" + 
"\n" + 
"var bit;" + "\n" + 
...
"    }" + "\n" + 
"}" + "\n")
      .addField(new field().setName("hit").setType(field.TYPE_SFTIME).setAccessType(field.ACCESSTYPE_INPUTONLY))
      .addField(new field().setName("tog").setType(field.TYPE_SFINT32).setAccessType(field.ACCESSTYPE_OUTPUTONLY)))
    .addChild(new ROUTE().setFromNode("bodyTS").setFromField("touchTime").setToNode("toggler").setToField("hit"))
    .addChild(new ROUTE().setFromNode("toggler").setFromField("tog").setToNode("SkinSwitch").setToField("whichChoice"))
    .addChild(new Script("viewMetadata").setSourceCode("\n" + 
"      " + "\n" + 
"ecmascript:" + "\n" + 
"\n" + 
"function initialize()" + "\n" + 
...
"function lungTS(val)" + "\n" + 
"{ " + "\n" + 
"    //msg = buildString(lungMeta); " + "\n" + 
"    //msg[0] = lungMeta.reference;" + "\n" + 
"    // works in .x3dv not .x3d??? " + "\n" + 
"    msg[0] = 'FMA parser';" + "\n" + 
"    msg[1] = 'Preferred name: Upper_lobe_of_lung'; " + "\n" + 
"    msg[2] = 'Synonym: Lobus_superior '; " + "\n" + 
"    msg[3] = 'Synonym: Superior_lobe_of_lung'; " + "\n" + 
"} " + "\n" + 
"function liverTS(val)" + "\n" + 
"{ " + "\n" + 
"    //msg = buildString(liverMeta); " + "\n" + 
"    //msg[0] = liverMeta.reference; " + "\n" + 
"    msg[0] = 'FMA mysql';" + "\n" + 
"    msg[1] = 'short_value: Liver';" + "\n" + 
"    msg[2] = 'frame: 26212';" + "\n" + 
"    msg[3] = 'frame_type: 6 ';" + "\n" + 
"} " + "\n" + 
"function colonTS(val)" + "\n" + 
"{ " + "\n" + 
"    //msg = buildString(colonMeta); " + "\n" + 
"    // msg[0] = colonMeta.reference; " + "\n" + 
"    msg[0] ='SNOMED';" + "\n" + 
"    msg[1] = 'conceptId: 369445005 ';" + "\n" + 
"    msg[2] = 'descriptionId: 774149015 ';" + "\n" + 
"    msg[3] = 'fullySpecfiedName: Chronic proctocolitis (disorder)';" + "\n" + 
"} " + "\n" + 
...
"    }" + "\n" + 
"}" + "\n")
      .addField(new field().setName("lungTS").setType(field.TYPE_SFBOOL).setAccessType(field.ACCESSTYPE_INPUTONLY))
      .addField(new field().setName("colonTS").setType(field.TYPE_SFBOOL).setAccessType(field.ACCESSTYPE_INPUTONLY))
      .addField(new field().setName("liverTS").setType(field.TYPE_SFBOOL).setAccessType(field.ACCESSTYPE_INPUTONLY))
      .addField(new field().setName("who").setType(field.TYPE_SFINT32).setAccessType(field.ACCESSTYPE_INPUTOUTPUT))
      .addField(new field().setName("lungMeta").setType(field.TYPE_SFNODE).setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
        .addComments(" initialization node (if any) goes here "))
      .addField(new field().setName("colonMeta").setType(field.TYPE_SFNODE).setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
        .addComments(" initialization node (if any) goes here "))
      .addField(new field().setName("liverMeta").setType(field.TYPE_SFNODE).setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
        .addComments(" initialization node (if any) goes here "))
      .addField(new field().setName("msg").setType(field.TYPE_MFSTRING).setAccessType(field.ACCESSTYPE_OUTPUTONLY)))
    .addChild(new ROUTE().setFromNode("lungTS").setFromField("isOver").setToNode("viewMetadata").setToField("lungTS"))
    .addChild(new ROUTE().setFromNode("liverTS").setFromField("isOver").setToNode("viewMetadata").setToField("liverTS"))
    .addChild(new ROUTE().setFromNode("colonTS").setFromField("isOver").setToNode("viewMetadata").setToField("colonTS"))
    .addChild(new ROUTE().setFromNode("viewMetadata").setFromField("msg").setToNode("msg").setToField("string")));
    }
	// end of initialize() method
		...
		/** Define subarrays using type double[] */
		private double[] getCoordinate_10_72_point_1()
		{
		...
		private double[] getCoordinate_10_72_point_2()
		{
		...
		private double[] getCoordinate_10_72_point_3()
		{
		...
		private double[] getCoordinate_10_72_point_4()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getGeoSculptedSurface2_9_127_coordIndex_1()
		{
		...
		private int[] getGeoSculptedSurface2_9_127_coordIndex_2()
		{
		...
		private int[] getGeoSculptedSurface2_9_127_coordIndex_3()
		{
		...
		private int[] getGeoSculptedSurface2_9_127_coordIndex_4()
		{
		...
		private int[] getGeoSculptedSurface2_9_127_coordIndex_5()
		{
		...
		private int[] getGeoSculptedSurface2_9_127_coordIndex_6()
		{
		...
		private int[] getGeoSculptedSurface2_9_127_coordIndex_7()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getCoordinate_10_127_point_1()
		{
		...
		private double[] getCoordinate_10_127_point_2()
		{
		...
		private double[] getCoordinate_10_127_point_3()
		{
		...
		private double[] getCoordinate_10_127_point_4()
		{
		...
		private double[] getCoordinate_10_127_point_5()
		{
		...
		private double[] getCoordinate_10_127_point_6()
		{
		...
		private double[] getCoordinate_10_127_point_7()
		{
		...
		private double[] getCoordinate_10_127_point_8()
		{
		...
		/** Large attribute array: IndexedFaceSet DEF='airway_Geo' coordIndex field, scene-graph level=8, element #53, 6361 total numbers.
		...
		{
			MFVec3f Coordinate_10_72_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_72_point_1()))
				.append(new MFVec3f(getCoordinate_10_72_point_2()))
				.append(new MFVec3f(getCoordinate_10_72_point_3()))
				.append(new MFVec3f(getCoordinate_10_72_point_4()));
			return Coordinate_10_72_point;
		}
		/** Large attribute array: IndexedFaceSet DEF='GeoSculptedSurface2' coordIndex field, scene-graph level=9, element #127, 6128 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getGeoSculptedSurface2_9_127_coordIndex()
		{
			MFInt32 GeoSculptedSurface2_9_127_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getGeoSculptedSurface2_9_127_coordIndex_1()))
				.append(new MFInt32(getGeoSculptedSurface2_9_127_coordIndex_2()))
				.append(new MFInt32(getGeoSculptedSurface2_9_127_coordIndex_3()))
				.append(new MFInt32(getGeoSculptedSurface2_9_127_coordIndex_4()))
				.append(new MFInt32(getGeoSculptedSurface2_9_127_coordIndex_5()))
				.append(new MFInt32(getGeoSculptedSurface2_9_127_coordIndex_6()))
				.append(new MFInt32(getGeoSculptedSurface2_9_127_coordIndex_7()));
			return GeoSculptedSurface2_9_127_coordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #127, 2400 total numbers made up of 800 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_127_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_127_point_1()))
				.append(new MFVec3f(getCoordinate_10_127_point_2()))
				.append(new MFVec3f(getCoordinate_10_127_point_3()))
				.append(new MFVec3f(getCoordinate_10_127_point_4()))
				.append(new MFVec3f(getCoordinate_10_127_point_5()))
				.append(new MFVec3f(getCoordinate_10_127_point_6()))
				.append(new MFVec3f(getCoordinate_10_127_point_7()))
				.append(new MFVec3f(getCoordinate_10_127_point_8()));
	 ...
	 * @return MedicalMetadataViewer model
	 */
    ...
    {
        X3D thisExampleX3dModel = new MedicalMetadataViewer().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.MedicalMetadataViewer\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.MedicalMetadataViewer\" self-validation test results: ");

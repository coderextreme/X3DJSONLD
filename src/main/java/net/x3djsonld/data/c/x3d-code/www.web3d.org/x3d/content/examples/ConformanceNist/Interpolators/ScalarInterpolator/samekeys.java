...
/**
 * <p> Test keys with same value. A ScalarInterpolator node is used to change the intensity of a SpotLight that illuminates a Cylinder geometry. The fraction_changed field of a TimeSensor node is used to change the position from keyValues of [ 0.0, 0.5, 1.0, 0.5, 0.0 ] for keys of [ 0.0, 0.5, 0.5, 0.5, 1.0 ] respectively. As a result: because of the three identical keys (0.5), the leftmost and rightmost identical keys serve as limits for that key, and result in a 1/4 intensity of light upon the Cylinder for the time interval between the two limits. The Cylinder should NOT reach full illumination intensity, but should begin with no illumination, increase to 1/4 maximum illumination, then decrease again to no illumination over a 5 second period. </p>
 <p> Related links: <a href="../../../../Interpolators/ScalarInterpolator/samekeys.java">samekeys.java</a> source, <a href="../../../../Interpolators/ScalarInterpolator/samekeysIndex.html" target="_top">samekeys catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Interpolators/ScalarInterpolator/samekeys.x3d">samekeys.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Interpolators/ScalarInterpolator/samekeys-movie.mpg">samekeys-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test keys with same value. A ScalarInterpolator node is used to change the intensity of a SpotLight that illuminates a Cylinder geometry. The fraction_changed field of a TimeSensor node is used to change the position from keyValues of [ 0.0, 0.5, 1.0, 0.5, 0.0 ] for keys of [ 0.0, 0.5, 0.5, 0.5, 1.0 ] respectively. As a result: because of the three identical keys (0.5), the leftmost and rightmost identical keys serve as limits for that key, and result in a 1/4 intensity of light upon the Cylinder for the time interval between the two limits. The Cylinder should NOT reach full illumination intensity, but should begin with no illumination, increase to 1/4 maximum illumination, then decrease again to no illumination over a 5 second period. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/ScalarInterpolator/samekeys.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/ScalarInterpolator/samekeys.x3d</a> </td>
		</tr>
		<tr>
...
public class samekeys
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test keys with same value. A ScalarInterpolator node is used to change the intensity of a SpotLight that illuminates a Cylinder geometry. The fraction_changed field of a TimeSensor node is used to change the position from keyValues of [ 0.0, 0.5, 1.0, 0.5, 0.0 ] for keys of [ 0.0, 0.5, 0.5, 0.5, 1.0 ] respectively. As a result: because of the three identical keys (0.5), the leftmost and rightmost identical keys serve as limits for that key, and result in a 1/4 intensity of light upon the Cylinder for the time interval between the two limits. The Cylinder should NOT reach full illumination intensity, but should begin with no illumination, increase to 1/4 maximum illumination, then decrease again to no illumination over a 5 second period."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/ScalarInterpolator/samekeys.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new ScalarInterpolator("SCALAR_INTERPOLATOR").setKey(new double[] {0.0,0.5,0.5,0.5,1.0}).setKeyValue(new double[] {0.0,0.5,1.0,0.5,0.0}))
    .addChild(new Group()

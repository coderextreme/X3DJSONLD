...
/**
 * <p> Test the hitPoint_changed field. A TouchSensor is associated with a yellow Sphere geometry. Its hitPoint_changed field is routed to another red Sphere geometry. When the pointing device bearing intersects the yellow Sphere geometry, the red Sphere should translate (follow) the movement of the pointing device along the surface of the yellow Sphere, following the hitPoint. </p>
 <p> Related links: <a href="../../../../Sensors/TouchSensor/hitpoint.java">hitpoint.java</a> source, <a href="../../../../Sensors/TouchSensor/hitpointIndex.html" target="_top">hitpoint catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/TouchSensor/hitpoint.x3d">hitpoint.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/TouchSensor/hitpoint-movie.mpg">hitpoint-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test the hitPoint_changed field. A TouchSensor is associated with a yellow Sphere geometry. Its hitPoint_changed field is routed to another red Sphere geometry. When the pointing device bearing intersects the yellow Sphere geometry, the red Sphere should translate (follow) the movement of the pointing device along the surface of the yellow Sphere, following the hitPoint. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/hitpoint.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/hitpoint.x3d</a> </td>
		</tr>
		<tr>
...
public class hitpoint
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("hitpoint.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("hitpoint-movie.mpg"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Group()
      .addChild(new Transform()
        ...
        .addChild(new Transform()
          .addChild(new TouchSensor("SPHSENSOR"))
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(1.0,1.0,0.0)))
            .setGeometry(new Sphere())))))
    .addChild(new ROUTE().setFromNode("SPHSENSOR").setFromField("hitPoint_changed").setToNode("MY_BALL").setToField("set_translation")));
    }
    ...
    {
        X3D thisExampleX3dModel = new hitpoint().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.hitpoint\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.hitpoint\" self-validation test results: ");

...
/**
 * <p> This test addresses the ability of a browser to apply a colored (red) light on an object of a different color (blue). Four simple geometries are defined in the local coordinate system and the emissive and diffuse color are both set to 0 0 1. A Spotlight is also defined and a red color is associated with it. The dot product of the light and object color produce a black appearing object. </p>
 <p> Related links: <a href="../../../../Lights/SpotLight/test_red_on_blue.java">test_red_on_blue.java</a> source, <a href="../../../../Lights/SpotLight/test_red_on_blueIndex.html" target="_top">test_red_on_blue catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/SpotLight/test_red_on_blue.x3d">test_red_on_blue.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/SpotLight/test-red-on-blue-front.jpg">test-red-on-blue-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test addresses the ability of a browser to apply a colored (red) light on an object of a different color (blue). Four simple geometries are defined in the local coordinate system and the emissive and diffuse color are both set to 0 0 1. A Spotlight is also defined and a red color is associated with it. The dot product of the light and object color produce a black appearing object. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_red_on_blue.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_red_on_blue.x3d</a> </td>
		</tr>
		<tr>
...
public class test_red_on_blue
{
	/** Default constructor to create this object. */
	public test_red_on_blue ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_red_on_blue.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-red-on-blue-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_red_on_blue.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_red_on_blue.x3d"))
    .addChild(new Group()
    ...
    .addChild(new SpotLight("the-light").setBeamWidth(1.57079).setColor(1.0,0.0,0.0).setCutOffAngle(1.57079).setLocation(0.0,0.0,10.0).setRadius(50))
    ...
    {
        X3D thisExampleX3dModel = new test_red_on_blue().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_red_on_blue\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_red_on_blue\" self-validation test results: ");

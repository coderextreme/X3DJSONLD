...
/**
 * <p> This test sets the on field to true/false for two SpotLight node defined using two different Transform node. The test should generate two default size Spheres. The leftmost one should be illuminated and the rightmost one should be dark. </p>
 <p> Related links: <a href="../../../../Lights/SpotLight/test_on.java">test_on.java</a> source, <a href="../../../../Lights/SpotLight/test_onIndex.html" target="_top">test_on catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/SpotLight/test_on.x3d">test_on.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/SpotLight/test-on-front.jpg">test-on-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/SpotLight/test-on-top.jpg">test-on-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/SpotLight/test-on-left.jpg">test-on-left.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test sets the on field to true/false for two SpotLight node defined using two different Transform node. The test should generate two default size Spheres. The leftmost one should be illuminated and the rightmost one should be dark. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_on.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_on.x3d</a> </td>
		</tr>
		<tr>
...
public class test_on
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_on.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-on-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-on-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("test-on-left.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("This test sets the on field to true/false for two SpotLight node defined using two different Transform node. The test should generate two default size Spheres. The leftmost one should be illuminated and the rightmost one should be dark."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_on.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_on.x3d"))
    .addChild(new Group()
    ...
    .addChild(new Transform().setTranslation(-3.0,0.0,0.0)
      .addChild(new SpotLight().setAmbientIntensity(0.1).setBeamWidth(1.570796).setCutOffAngle(.785398).setLocation(0.5,0.0,2.0).setRadius(3))
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Sphere())))
    .addChild(new Transform().setTranslation(1.0,0.0,0.0)
      .addChild(new SpotLight().setBeamWidth(1.570796).setCutOffAngle(.785398).setLocation(0.0,0.0,1.0).setOn(false))
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Sphere()))));
    ...
    {
        X3D thisExampleX3dModel = new test_on().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_on\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_on\" self-validation test results: ");

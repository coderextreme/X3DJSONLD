...
/**
 * <p> Test rendering when no Material node, no Color node and an ImageTexture is applied to a row containing primitive geometry. This is followedy by a row containing an ElevationGrid and an IndexedFaceSet. The result should be all geometry mapped with the color VTS logo on a purple background. </p>
 <p> Related links: <a href="../../../../Appearance/Appearance/unlit_texture_nocolor.java">unlit_texture_nocolor.java</a> source, <a href="../../../../Appearance/Appearance/unlit_texture_nocolorIndex.html" target="_top">unlit_texture_nocolor catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Appearance/unlit_texture_nocolor.x3d">unlit_texture_nocolor.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/unlit_texture_nocolor-front.jpg">unlit_texture_nocolor-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/unlit_texture_nocolor-rear.jpg">unlit_texture_nocolor-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/unlit_texture_nocolor-top.jpg">unlit_texture_nocolor-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/unlit_texture_nocolor-bottom.jpg">unlit_texture_nocolor-bottom.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test rendering when no Material node, no Color node and an ImageTexture is applied to a row containing primitive geometry. This is followedy by a row containing an ElevationGrid and an IndexedFaceSet. The result should be all geometry mapped with the color VTS logo on a purple background. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_texture_nocolor.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_texture_nocolor.x3d</a> </td>
		</tr>
		<tr>
...
public class unlit_texture_nocolor
{
	/** Default constructor to create this object. */
	public unlit_texture_nocolor ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("unlit_texture_nocolor.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("unlit_texture_nocolor-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("unlit_texture_nocolor-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("unlit_texture_nocolor-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("unlit_texture_nocolor-bottom.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test rendering when no Material node, no Color node and an ImageTexture is applied to a row containing primitive geometry. This is followedy by a row containing an ElevationGrid and an IndexedFaceSet. The result should be all geometry mapped with the color VTS logo on a purple background."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_texture_nocolor.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("unlit_texture_nocolor.x3d"))
	 ...
	 * @return unlit_texture_nocolor model
	 */
    ...
    {
        X3D thisExampleX3dModel = new unlit_texture_nocolor().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.unlit_texture_nocolor\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.unlit_texture_nocolor\" self-validation test results: ");

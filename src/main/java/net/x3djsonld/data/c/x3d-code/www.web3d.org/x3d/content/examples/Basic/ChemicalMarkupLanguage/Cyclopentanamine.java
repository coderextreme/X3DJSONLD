...
public class Cyclopentanamine
{
	/** Default constructor to create this object. */
	public Cyclopentanamine ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("Cyclopentanamine.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of Cyclopentanamine.x3d scene produced from Cyclopentanamine.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("Cyclopentanamine.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Cyclopentanamine.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("Cyclopentanamine.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect Cyclopentanamine").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"Cyclopentanamine: C5 H11 N"}))))
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"molecule weight: 85.15"}))))
      .addChild(new Transform().setTranslation(0.0,4.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"melting point: -6"}))))
      .addChild(new Transform().setTranslation(0.0,3.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"boiling point: 106"}))))
      .addChild(new Transform().setTranslation(0.0,2.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"specific gravity: 0.863"})))))
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Nitrogen", "cyclopentanamine_a1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.6333,2.5818,1.6112)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclopentanamine_a2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.0204,2.1653,1.9102)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclopentanamine_a3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.053,3.047,1.1939)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclopentanamine_a4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(4.2903,2.1762,0.9973)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclopentanamine_a5").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.8619,0.7218,1.1851)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "cyclopentanamine_a6").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.3704,0.7241,1.4997))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "cyclopentanamine_b1").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {0.6333,2.5818,1.6112,2.0204,2.1653,1.9102})))))
      .addChild(new ProtoInstance("line", "cyclopentanamine_b4").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.0204,2.1653,1.9102,3.053,3.047,1.1939})))))
      .addChild(new ProtoInstance("line", "cyclopentanamine_b5").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.3704,0.7241,1.4997,2.0204,2.1653,1.9102})))))
      .addChild(new ProtoInstance("line", "cyclopentanamine_b7").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.053,3.047,1.1939,4.2903,2.1762,0.9973})))))
      .addChild(new ProtoInstance("line", "cyclopentanamine_b10").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {4.2903,2.1762,0.9973,3.8619,0.7218,1.1851})))))
      .addChild(new ProtoInstance("line", "cyclopentanamine_b13").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.8619,0.7218,1.1851,2.3704,0.7241,1.4997})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new Cyclopentanamine().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.Cyclopentanamine\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.Cyclopentanamine\" self-validation test results: ");

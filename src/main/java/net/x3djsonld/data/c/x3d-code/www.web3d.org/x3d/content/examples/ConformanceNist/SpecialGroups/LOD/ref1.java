 ...
 * <p> This is a collateral file used in other tests of this node. </p>
 <p> Related links: <a href="../../../../SpecialGroups/LOD/ref1.java">ref1.java</a> source, <a href="../../../../SpecialGroups/LOD/ref1Index.html" target="_top">ref1 catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/LOD/ref1.x3d">ref1.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref1.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref1.x3d</a> </td>
		</tr>
		<tr>
...
public class ref1
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("ref1.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref1.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("ref1.x3d"))
    ...
    .addChild(new Transform().setTranslation(0.0,2.7,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
    ...
    .addChild(new Group()
      .addChild(new Transform().setTranslation(0.0,-0.75,3.0)
        .addChild(new Shape("the-step")
          .setAppearance(new Appearance()
            .setMaterial(new Material()))
          .setGeometry(new Box().setSize(0.9,0.3,0.5))))
      .addChild(new Transform().setTranslation(0.0,-0.45,2.78)
        .addChild(new Shape("counter-step")
          .setAppearance(new Appearance()
            .setMaterial(new Material().setDiffuseColor(1.0,1.0,1.0).setEmissiveColor(1.0,1.0,1.0)))
          .setGeometry(new Box().setSize(0.9,0.3,0.01))))
      .addChild(new Transform().setTranslation(0.0,-0.43,2.5)
        .addChild(new Shape().setUSE("the-step")))
      .addChild(new Transform().setTranslation(0.0,-0.13,2.28)
        .addChild(new Shape().setUSE("counter-step")))
      .addChild(new Transform().setTranslation(0.0,-0.09,2.06)
        .addChild(new Shape().setUSE("the-step")))
      .addChild(new Transform().setTranslation(0.0,0.2,1.84)
        .addChild(new Shape().setUSE("counter-step")))
      .addChild(new Transform().setTranslation(0.0,0.25,1.62)
        .addChild(new Shape().setUSE("the-step"))))
    .addChild(new Transform().setTranslation(-3.5,2.0,1.1)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Cylinder().setHeight(4).setRadius(0.15))))
    .addChild(new Transform().setTranslation(-3.3,2.0,-1.1)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Cylinder().setHeight(4).setRadius(0.15))))
    ...
    {
        X3D thisExampleX3dModel = new ref1().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.ref1\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.ref1\" self-validation test results: ");

...
/**
 * <p> Test unlit PointSet and IndexedLineSet rendering. No Material node, no Color node and no texture is applied to a row containing an IndexedLineSet and a PointSet. Expected results are undetermined. </p>
 <p> Related links: <a href="../../../../Appearance/Appearance/unlit_pointline.java">unlit_pointline.java</a> source, <a href="../../../../Appearance/Appearance/unlit_pointlineIndex.html" target="_top">unlit_pointline catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Appearance/unlit_pointline.x3d">unlit_pointline.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/unlit_pointline-front.jpg">unlit_pointline-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test unlit PointSet and IndexedLineSet rendering. No Material node, no Color node and no texture is applied to a row containing an IndexedLineSet and a PointSet. Expected results are undetermined. </td>
		</tr>
		<tr style="color:burntorange">
			<td style="text-align:right; vertical-align: text-top;"> <i> warning </i> </td>
			<td> Material nodes, Color nodes and texture nodes are are intentionally omitted to perform this test. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_pointline.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_pointline.x3d</a> </td>
		</tr>
		<tr>
...
public class unlit_pointline
{
	/** Default constructor to create this object. */
	public unlit_pointline ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("unlit_pointline.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("unlit_pointline-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test unlit PointSet and IndexedLineSet rendering. No Material node, no Color node and no texture is applied to a row containing an IndexedLineSet and a PointSet. Expected results are undetermined."))
    .addMeta(new meta().setName(meta.NAME_WARNING    ).setContent("Material nodes, Color nodes and texture nodes are are intentionally omitted to perform this test."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_pointline.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("unlit_pointline.x3d"))
	...
	// end of initialize() method
		...
		/** Large attribute array: Coordinate point field, scene-graph level=7, element #21, 306 total numbers made up of 102 3-tuple values.
    ...
    {
        X3D thisExampleX3dModel = new unlit_pointline().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.unlit_pointline\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.unlit_pointline\" self-validation test results: ");

...
public class _3_Methyl_1H_indene
{
	/** Default constructor to create this object. */
	public _3_Methyl_1H_indene ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("_3-methyl-1h-indene.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of _3-methyl-1h-indene.x3d scene produced from _3-methyl-1h-indene.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("_3-methyl-1h-indene.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/_3-methyl-1h-indene.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("_3-methyl-1h-indene.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect _3-methyl-1h-indene").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"_3-methyl-1h-indene: C10 H10"}))))
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"molecule weight: 130.19"}))))
      .addChild(new Transform().setTranslation(0.0,4.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"melting point: 94"}))))
      .addChild(new Transform().setTranslation(0.0,3.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"boiling point: 266"}))))
      .addChild(new Transform().setTranslation(0.0,2.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"specific gravity: 0.965"})))))
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.0802,4.4808,0.8224)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.7105,3.1539,0.9211)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.153,2.9519,1.1096)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(1.1022,1.9458,0.8602)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a5").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.4,1.5607,1.1621)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a6").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(4.1914,3.8614,1.229)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a7").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.1,0.8281,1.0059)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a8").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(4.6834,1.076,1.3341)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a9").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(5.4842,3.366,1.4022)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "_3-methyl-1h-indene_a10").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(5.7263,1.9964,1.4539))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "_3-methyl-1h-indene_b1").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.0802,4.4808,0.8224,1.7105,3.1539,0.9211})))))
      .addChild(new ProtoInstance("line", "_3-methyl-1h-indene_b5").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.7105,3.1539,0.9211,3.153,2.9519,1.1096})))))
      .addChild(new ProtoInstance("line", "_3-methyl-1h-indene_b6").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.0822,1.9458,0.8602,1.6905,3.1539,0.9211})))))
      .addChild(new ProtoInstance("line", "_3-methyl-1h-indene_b6_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {1.1222,1.9458,0.8602,1.7305,3.1539,0.9211})))))
      .addChild(new ProtoInstance("line", "_3-methyl-1h-indene_b9").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.1,0.8281,1.0059,1.1022,1.9458,0.8602})))))
      .addChild(new ProtoInstance("line", "_3-methyl-1h-indene_b11").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {3.4,1.5607,1.1621,2.1,0.8281,1.0059})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new _3_Methyl_1H_indene().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data._3_Methyl_1H_indene\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data._3_Methyl_1H_indene\" self-validation test results: ");

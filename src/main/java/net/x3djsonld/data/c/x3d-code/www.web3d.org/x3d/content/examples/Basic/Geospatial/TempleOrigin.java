...
/**
 * <p> Temple with GeoOrigin node coregisters columns to same reference frame, eliminating floating-point roundoff errors and avoiding jitter on column positions. </p>
 <p> Related links: <a href="../../../Geospatial/TempleOrigin.java">TempleOrigin.java</a> source, <a href="../../../Geospatial/TempleOriginIndex.html" target="_top">TempleOrigin catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../Geospatial/TempleOrigin.x3d">TempleOrigin.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> description </i> </td>
			<td> Temple with GeoOrigin node coregisters columns to same reference frame, eliminating floating-point roundoff errors and avoiding jitter on column positions. </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/Geospatial/TempleOrigin.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/Geospatial/TempleOrigin.x3d</a> </td>
		</tr>
		<tr>
...
public class TempleOrigin
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("TempleOrigin.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Temple with GeoOrigin node coregisters columns to same reference frame, eliminating floating-point roundoff errors and avoiding jitter on column positions."))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/Geospatial/TempleOrigin.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("TempleOrigin.x3d"))
    .addChild(new NavigationInfo().setAvatarSize(new double[] {1.0E-6,1.0E-6,1.0E-6}).setSpeed(1.0E-4))
      ...
      .addChild(new Transform()
        .addChild(new Shape("COLUMN")
          .setAppearance(new Appearance()
            .setMaterial(new Material().setDiffuseColor(1.0,0.9,0.8))
          ...
          .setGeometry(new Cylinder().setHeight(5.0).setRadius(0.6)))))
    ...
    {
        X3D thisExampleX3dModel = new TempleOrigin().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.TempleOrigin\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.TempleOrigin\" self-validation test results: ");

 ...
 <p> Related links: <a href="../../../../Lights/DirectionalLight/test_attenuationsim.java">test_attenuationsim.java</a> source, <a href="../../../../Lights/DirectionalLight/test_attenuationsimIndex.html" target="_top">test_attenuationsim catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/DirectionalLight/test_attenuationsim.x3d">test_attenuationsim.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/test-attenuationsim-movie.mpg">test-attenuationsim-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser to keep the brightness of the DirectionalLight constant regardless of how far an object is from the light source. The objects used are a set of simple geometry (cone, sphere, cylinder and box). one row of the simple geometry is drawn in the local coordinate system. The objects are moved further away from the light along the -Z axis as the animation progresses. The light should not attenuate at all. The animation is started by clicking on the text above the geometry. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_attenuationsim.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_attenuationsim.x3d</a> </td>
		</tr>
		<tr>
...
public class test_attenuationsim
{
	/** Default constructor to create this object. */
	public test_attenuationsim ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("test_attenuationsim.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("test-attenuationsim-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_attenuationsim.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("test_attenuationsim.x3d"))
	 ...
	 * @return test_attenuationsim model
	 */
    ...
    {
        X3D thisExampleX3dModel = new test_attenuationsim().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.test_attenuationsim\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.test_attenuationsim\" self-validation test results: ");

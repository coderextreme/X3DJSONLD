...
/**
 * <p> Test the browser implementation of a NULL transformation. With the textureTransform field = NULL, for primitive geometry, the VTS logo should display once only, in an upright position, and horizontally and vertically centered for all geometry faces. </p>
 <p> Related links: <a href="../../../../Appearance/Appearance/null_texturetransform.java">null_texturetransform.java</a> source, <a href="../../../../Appearance/Appearance/null_texturetransformIndex.html" target="_top">null_texturetransform catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Appearance/null_texturetransform.x3d">null_texturetransform.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/null_texturetransform-front.jpg">null_texturetransform-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test the browser implementation of a NULL transformation. With the textureTransform field = NULL, for primitive geometry, the VTS logo should display once only, in an upright position, and horizontally and vertically centered for all geometry faces. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/null_texturetransform.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/null_texturetransform.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Appearance/../../license.html">../../license.html</a> </td>
		</tr>
		<tr style="background-color:silver; border-color:silver;">
...
public class null_texturetransform
{
	/** Default constructor to create this object. */
	public null_texturetransform ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("null_texturetransform.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("null_texturetransform-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test the browser implementation of a NULL transformation. With the textureTransform field = NULL, for primitive geometry, the VTS logo should display once only, in an upright position, and horizontally and vertically centered for all geometry faces."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/null_texturetransform.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("null_texturetransform.x3d"))
    .addChild(new Group()
	 ...
	 * @return null_texturetransform model
	 */
    ...
    {
        X3D thisExampleX3dModel = new null_texturetransform().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.null_texturetransform\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.null_texturetransform\" self-validation test results: ");

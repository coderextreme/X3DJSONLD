 ...
 <p> Related links: <a href="../../../../Appearance/TextureTransform/indexedfaceset_movietexture.java">indexedfaceset_movietexture.java</a> source, <a href="../../../../Appearance/TextureTransform/indexedfaceset_movietextureIndex.html" target="_top">indexedfaceset_movietexture catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/TextureTransform/indexedfaceset_movietexture.x3d">indexedfaceset_movietexture.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/indexedfaceset_movietexture-front.jpg">indexedfaceset_movietexture-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/indexedfaceset_movietexture-rear.jpg">indexedfaceset_movietexture-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/indexedfaceset_movietexture-top.jpg">indexedfaceset_movietexture-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/indexedfaceset_movietexture-bottom.jpg">indexedfaceset_movietexture-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/indexedfaceset_movietexture-left.jpg">indexedfaceset_movietexture-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/indexedfaceset_movietexture-right.jpg">indexedfaceset_movietexture-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test default TextureTransform mapping of a MovieTexture to an IndexedFaceSet. The VTS logo should map to an IndexedFaceSet geometry by projecting the image through the geometry bounding box face with the long (X) and second-longest (Y) axes, and onto the IndexedFaceSet geometry. A horizontally reversed VTS logo is mapped to the opposite (rear) side of the IndexedFaceSet. Geometry faces between the front and back are smeared with the projected end-pixels of the ImageTexture. The VTS should face upright on the front face of the IndexedFaceSet and appear reversed on the rear geometry face. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/indexedfaceset_movietexture.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/indexedfaceset_movietexture.x3d</a> </td>
		</tr>
		<tr>
...
public class indexedfaceset_movietexture
{
	/** Default constructor to create this object. */
	public indexedfaceset_movietexture ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("indexedfaceset_movietexture.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("indexedfaceset_movietexture-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("indexedfaceset_movietexture-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("indexedfaceset_movietexture-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("indexedfaceset_movietexture-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("indexedfaceset_movietexture-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("indexedfaceset_movietexture-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/indexedfaceset_movietexture.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("indexedfaceset_movietexture.x3d"))
    .addChild(new Group()
	 ...
	 * @return indexedfaceset_movietexture model
	 */
    ...
    {
        X3D thisExampleX3dModel = new indexedfaceset_movietexture().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.indexedfaceset_movietexture\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.indexedfaceset_movietexture\" self-validation test results: ");

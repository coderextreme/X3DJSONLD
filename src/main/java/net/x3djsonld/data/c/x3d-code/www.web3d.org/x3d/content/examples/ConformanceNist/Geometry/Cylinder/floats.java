...
/**
 * <p> A simple cylinder that specifies floating point values for the radius and height fields. </p>
 <p> Related links: <a href="../../../../Geometry/Cylinder/floats.java">floats.java</a> source, <a href="../../../../Geometry/Cylinder/floatsIndex.html" target="_top">floats catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Cylinder/floats.x3d">floats.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> A simple cylinder that specifies floating point values for the radius and height fields. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/floats.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/floats.x3d</a> </td>
		</tr>
		<tr>
...
public class floats
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("A simple cylinder that specifies floating point values for the radius and height fields."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/floats.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape()
      ...
      .setGeometry(new Cylinder().setHeight(3.4215).setRadius(2.8964))));
    }

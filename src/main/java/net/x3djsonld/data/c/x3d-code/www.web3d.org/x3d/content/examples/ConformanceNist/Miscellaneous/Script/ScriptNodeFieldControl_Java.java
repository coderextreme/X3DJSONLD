 ...
 * <p> Script node interface between VRML and Java: this conformance example tests field-based VRML-Java functionality. </p>
 <p> Related links: <a href="../../../../Miscellaneous/Script/ScriptNodeFieldControl_Java.java">ScriptNodeFieldControl_Java.java</a> source, <a href="../../../../Miscellaneous/Script/ScriptNodeFieldControl-JavaIndex.html" target="_top">ScriptNodeFieldControl-Java catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ScriptConformance/ScriptNodeFieldControl-Java.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ScriptConformance/ScriptNodeFieldControl-Java.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/Script/ScriptNodeFieldControl-Java.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/Script/ScriptNodeFieldControl-Java.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="../../../../Miscellaneous/Script/ScriptNodeFieldControl.java">ScriptNodeFieldControl.java</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> ScriptNodeFieldControl-JavaConsoleOutput.txt </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="../../../../Miscellaneous/Script/ScriptNodeFieldControl-JavaSnapshots.html">ScriptNodeFieldControl-JavaSnapshots.html</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="../../../../Miscellaneous/Script/ScriptNodeFieldControl-EcmaScript.x3d">ScriptNodeFieldControl-EcmaScript.x3d</a> </td>
		</tr>
		<tr>
...
public class ScriptNodeFieldControl_Java
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("ScriptNodeFieldControl-Java.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("https://www.web3d.org/x3d/content/examples/ScriptConformance/ScriptNodeFieldControl-Java.x3d"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/Script/ScriptNodeFieldControl-Java.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeFieldControl-JavaConsoleOutput.txt"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeFieldControl-JavaSnapshots.html"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("ScriptNodeFieldControl-EcmaScript.x3d"))
    .addMeta(new meta().setName(meta.NAME_SUBJECT    ).setContent("VRML X3D Java Script conformance"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("ScriptNodeFieldControl-Java.x3d"))
    ...
    .addChild(new Group()
      ...
      .addChild(new Script("InterfaceScriptNode").setDirectOutput(true).setUrl(new String[] {"ScriptNodeFieldControl.class","https://www.web3d.org/x3d/content/examples/ScriptConformance/ScriptNodeFieldControl.class"})

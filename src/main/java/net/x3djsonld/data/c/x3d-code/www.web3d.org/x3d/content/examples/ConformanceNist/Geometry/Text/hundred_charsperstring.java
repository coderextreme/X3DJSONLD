...
/**
 * <p> This test attempts to write a string made of 100 characters, as required by the VRML specification. The test should write the letters from A thru Z (upper case) twice, it should also write the lower case letters a thru v twice, letters from w thru z should appear only once. </p>
 <p> Related links: <a href="../../../../Geometry/Text/hundred_charsperstring.java">hundred_charsperstring.java</a> source, <a href="../../../../Geometry/Text/hundred_charsperstringIndex.html" target="_top">hundred_charsperstring catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Text/hundred_charsperstring.x3d">hundred_charsperstring.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test attempts to write a string made of 100 characters, as required by the VRML specification. The test should write the letters from A thru Z (upper case) twice, it should also write the lower case letters a thru v twice, letters from w thru z should appear only once. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/hundred_charsperstring.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/hundred_charsperstring.x3d</a> </td>
		</tr>
		<tr>
...
public class hundred_charsperstring
{
	/** Default constructor to create this object. */
	public hundred_charsperstring ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("hundred_charsperstring.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/hundred_charsperstring.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("hundred_charsperstring.x3d"))
    .addChild(new NavigationInfo().setType("\"EXAMINE\" \"WALK\" \"FLY\" \"ANY\""))
    .addChild(new Shape()
      .setAppearance(new Appearance()
        .setMaterial(new Material()))
      .setGeometry(new Text().setString(new String[] {"AABBCCDDEEFFGGHHIIJJKKLLMMNNOOPPQQRRSSTTUUVVWWXXYYZZaabbccddeeffgghhiijjkkllmmnnooppqqrrssttuuvvwxyz"}))));
    }
	 ...
	 * @return hundred_charsperstring model
	 */
    ...
    {
        X3D thisExampleX3dModel = new hundred_charsperstring().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.hundred_charsperstring\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.hundred_charsperstring\" self-validation test results: ");

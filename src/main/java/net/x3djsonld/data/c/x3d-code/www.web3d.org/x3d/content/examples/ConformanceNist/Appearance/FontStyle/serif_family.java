...
/**
 * <p> Test SERIF family rendering for FontStyle node. A "family" type of "NONEXISTENT" is supplied to a FontStyle node. No other family type is contained in the MFString list. Because the browser does not support a "NONEXISTENT" family type, and no other family type is in the list, the browser should default to a "SERIF" family font, and render a 3 line text string with a SERIF family font. </p>
 <p> Related links: <a href="../../../../Appearance/FontStyle/serif_family.java">serif_family.java</a> source, <a href="../../../../Appearance/FontStyle/serif_familyIndex.html" target="_top">serif_family catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/FontStyle/serif_family.x3d">serif_family.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/FontStyle/serif_family-front.jpg">serif_family-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test SERIF family rendering for FontStyle node. A "family" type of "NONEXISTENT" is supplied to a FontStyle node. No other family type is contained in the MFString list. Because the browser does not support a "NONEXISTENT" family type, and no other family type is in the list, the browser should default to a "SERIF" family font, and render a 3 line text string with a SERIF family font. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/FontStyle/serif_family.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/FontStyle/serif_family.x3d</a> </td>
		</tr>
		<tr>
...
public class serif_family
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("serif_family.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("serif_family-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test SERIF family rendering for FontStyle node. A \"family\" type of \"NONEXISTENT\" is supplied to a FontStyle node. No other family type is contained in the MFString list. Because the browser does not support a \"NONEXISTENT\" family type, and no other family type is in the list, the browser should default to a \"SERIF\" family font, and render a 3 line text string with a SERIF family font."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/FontStyle/serif_family.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("serif_family.x3d"))
    .addChild(new Viewpoint().setDescription("FontStyle family default is SERIF").setPosition(0.0,0.0,15.0))
    .addChild(new Transform().setTranslation(0.0,3.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Text("MYTEXT").setString(new String[] {"This should be SERIF"})
    ...
    {
        X3D thisExampleX3dModel = new serif_family().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.serif_family\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.serif_family\" self-validation test results: ");

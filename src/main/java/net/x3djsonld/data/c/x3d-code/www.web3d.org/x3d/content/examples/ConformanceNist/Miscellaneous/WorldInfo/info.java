...
/**
 * <p> This file tests the ability of a browser to parse the WorldInfo node, and its "info" field. Because the WorldInfo node does not affect the loaded world's appearance or behavior, this test simply examines the browser's ability to read the WorldInfo node, parse it, and execute the loaded world properly. The viewer should see a white cube geometry with a black background, centered at the origin of the local coordinate system. In addition, no error or warning messages regarding the WorldInfo node should be displayed. </p>
 <p> Related links: <a href="../../../../Miscellaneous/WorldInfo/info.java">info.java</a> source, <a href="../../../../Miscellaneous/WorldInfo/infoIndex.html" target="_top">info catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Miscellaneous/WorldInfo/info.x3d">info.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Miscellaneous/WorldInfo/info-front.jpg">info-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/WorldInfo/info.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/WorldInfo/info.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="../../../../Miscellaneous/WorldInfo/../../license.html">../../license.html</a> </td>
		</tr>
		<tr style="background-color:silver; border-color:silver;">
...
public class info
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("info.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("info-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/WorldInfo/info.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setInfo(new String[] {"A simple Box","Used to test parsing of the info field"}).setTitle("info.x3d"))
    .addChild(new Shape()
      .setGeometry(new Box())));
    }
    ...
    {
        X3D thisExampleX3dModel = new info().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.info\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.info\" self-validation test results: ");

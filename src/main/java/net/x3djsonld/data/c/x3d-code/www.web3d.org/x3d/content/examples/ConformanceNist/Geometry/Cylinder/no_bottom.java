...
/**
 * <p> A simple cylinder with the bottom field set to false, which indicates that the bottom of the cylinder should not be visible. Carmelo Montanez. </p>
 <p> Related links: <a href="../../../../Geometry/Cylinder/no_bottom.java">no_bottom.java</a> source, <a href="../../../../Geometry/Cylinder/no_bottomIndex.html" target="_top">no_bottom catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Cylinder/no_bottom.x3d">no_bottom.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> A simple cylinder with the bottom field set to false, which indicates that the bottom of the cylinder should not be visible. Carmelo Montanez </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/no_bottom.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/no_bottom.x3d</a> </td>
		</tr>
		<tr>
...
public class no_bottom
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("A simple cylinder with the bottom field set to false, which indicates that the bottom of the cylinder should not be visible. Carmelo Montanez"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/no_bottom.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform().setRotation(1.0,0.0,0.0,-0.57)
      .addChild(new Shape()
        ...
        .setGeometry(new Cylinder().setBottom(false)))));
    }

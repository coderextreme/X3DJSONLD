...
/**
 * <p> Test if a TouchSensor generates an isActive true event when the pointing device indicates a white Sphere geometry. The isActive event of the TouchSensor associated with the white Sphere is routed to the "on" field of a PointLight. When the pointing device indicates the white Sphere (by pressing down on the primary pointing device button while its bearing intersects the white Sphere geometry), the PointLight inside of sphere should turn on, illuminating the red Spheres around it. When the primary pointing device button is released, the PointLight should turn off. </p>
 <p> Related links: <a href="../../../../Sensors/TouchSensor/isactive.java">isactive.java</a> source, <a href="../../../../Sensors/TouchSensor/isactiveIndex.html" target="_top">isactive catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/TouchSensor/isactive.x3d">isactive.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/TouchSensor/isactive-movie.mpg">isactive-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test if a TouchSensor generates an isActive true event when the pointing device indicates a white Sphere geometry. The isActive event of the TouchSensor associated with the white Sphere is routed to the "on" field of a PointLight. When the pointing device indicates the white Sphere (by pressing down on the primary pointing device button while its bearing intersects the white Sphere geometry), the PointLight inside of sphere should turn on, illuminating the red Spheres around it. When the primary pointing device button is released, the PointLight should turn off. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/isactive.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/isactive.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/TouchSensor/../../license.html">../../license.html</a> </td>
		</tr>
		<tr style="background-color:silver; border-color:silver;">
...
public class isactive
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test if a TouchSensor generates an isActive true event when the pointing device indicates a white Sphere geometry. The isActive event of the TouchSensor associated with the white Sphere is routed to the \"on\" field of a PointLight. When the pointing device indicates the white Sphere (by pressing down on the primary pointing device button while its bearing intersects the white Sphere geometry), the PointLight inside of sphere should turn on, illuminating the red Spheres around it. When the primary pointing device button is released, the PointLight should turn off."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/isactive.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new ROUTE().setFromNode("TOUCH").setFromField("isActive").setToNode("LIGHT").setToField("on")));
    }

...
/**
 * <p> A very small cylinder that tests the lower boundary condition. This time, we have set an initial viewpoint of (0 0 1) to help ensure that the cone is initially visible. </p>
 <p> Related links: <a href="../../../../Geometry/Cylinder/small_view.java">small_view.java</a> source, <a href="../../../../Geometry/Cylinder/small_viewIndex.html" target="_top">small_view catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Cylinder/small_view.x3d">small_view.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> A very small cylinder that tests the lower boundary condition. This time, we have set an initial viewpoint of (0 0 1) to help ensure that the cone is initially visible. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/small_view.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/small_view.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Cylinder/../../license.html">../../license.html</a> </td>
		</tr>
		<tr style="background-color:silver; border-color:silver;">
...
public class small_view
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("A very small cylinder that tests the lower boundary condition. This time, we have set an initial viewpoint of (0 0 1) to help ensure that the cone is initially visible."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Cylinder/small_view.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape()
      ...
      .setGeometry(new Cylinder().setHeight(0.01).setRadius(0.01))));
    }

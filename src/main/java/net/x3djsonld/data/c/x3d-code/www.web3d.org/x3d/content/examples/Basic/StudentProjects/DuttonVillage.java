 ...
 * <p> Primitive village. Move mouse over the hut roofs to see a demonstration of sensors and interpolators. </p>
 <p> Related links: <a href="../../../StudentProjects/DuttonVillage.java">DuttonVillage.java</a> source, <a href="../../../StudentProjects/DuttonVillageIndex.html" target="_top">DuttonVillage catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../StudentProjects/DuttonVillage.x3d">DuttonVillage.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/DuttonVillage.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/DuttonVillage.x3d</a> </td>
		</tr>
		<tr>
...
public class DuttonVillage
{
	/** Default constructor to create this object. */
	public DuttonVillage ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("DuttonVillage.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/DuttonVillage.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("DuttonVillage.x3d"))
    ...
    .addChild(new Group()
      .addChild(new Transform().setRotation(0.0,1.0,0.0,2.7).setScale(0.01,0.01,0.01).setTranslation(5.0,12.3,30.0)
        .addChild(new Inline().setUrl(new String[] {"AllenDutton.x3d","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/AllenDutton.x3d","AllenDutton.wrl","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/AllenDutton.wrl"})))
    ...
    .addChild(new Group("HUT")
      .addChild(new Shape()
        .setAppearance(new Appearance()
          ...
          .setTexture(new ImageTexture().setUrl(new String[] {"wood.gif","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/grass.jpg"}))
      ...
      .addChild(new Transform("ROOF_TRANSFORM").setTranslation(0.0,4.0,0.0)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            ...
            .setTexture(new ImageTexture().setUrl(new String[] {"straw.jpg","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/grass.jpg"})))
          .setGeometry(new Cone().setBottomRadius(6).setHeight(4)))
        .addChild(new TouchSensor("MyTouchSensor")))
      ...
      .addChild(new Transform().setTranslation(10.0,0.0,0.0)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            ...
            .setTexture(new ImageTexture("wood").setUrl(new String[] {"wood.jpg","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/wood.jpg"})))
      ...
      .addChild(new Transform().setTranslation(10.0,3.0,0.0)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            ...
            .setTexture(new ImageTexture().setUrl(new String[] {"leaves.jpg","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/leaves.jpg"})))
    ...
    {
        X3D thisExampleX3dModel = new DuttonVillage().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.DuttonVillage\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.DuttonVillage\" self-validation test results: ");

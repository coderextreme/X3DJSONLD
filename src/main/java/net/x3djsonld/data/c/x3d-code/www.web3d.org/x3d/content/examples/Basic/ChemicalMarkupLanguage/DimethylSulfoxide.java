...
public class DimethylSulfoxide
{
	/** Default constructor to create this object. */
	public DimethylSulfoxide ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("DimethylSulfoxide.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Autogenerated version of DimethylSulfoxide.x3d scene produced from DimethylSulfoxide.xml Chemical Markup Language (CML) version 1.0 source file."))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("DimethylSulfoxide.xml"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/DimethylSulfoxide.x3d"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("DimethylSulfoxide.x3d"))
    ...
    .addChild(new Viewpoint().setDescription("Inspect DimethylSulfoxide").setPosition(0.0,2.0,20.0))
    ...
    .addChild(new Transform("infogroupa").setTranslation(-8.0,2.0,-4.0)
      .addChild(new Transform().setTranslation(0.0,6.0,0.0)
        ...
        .addChild(new ProtoInstance("title_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"DimethylSulfoxide: C2 H6 O S"}))))
      .addChild(new Transform().setTranslation(0.0,5.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"molecule weight: 78.13"}))))
      .addChild(new Transform().setTranslation(0.0,4.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"melting point: 18"}))))
      .addChild(new Transform().setTranslation(0.0,3.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"boiling point: 189"}))))
      .addChild(new Transform().setTranslation(0.0,2.0,0.0)
        .addChild(new ProtoInstance("ano1_text").setContainerField("children")
          .addFieldValue(new fieldValue().setName("txt").setValue(new String[] {"specific gravity: 1.101"})))))
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "dimethyl_sulfoxide_a1").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(0.8293,1.3548,0.5856)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Sulphur", "dimethyl_sulfoxide_a2").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.3997,2.0598,0.0)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Carbon", "dimethyl_sulfoxide_a3").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(3.5575,1.0719,0.9948)))))
      .addChild(new Transform()
        .addChild(new ProtoInstance("Oxygen", "dimethyl_sulfoxide_a4").setContainerField("children")
          .addFieldValue(new fieldValue().setName("position").setValue(new SFVec3f(2.4513,3.4791,0.6382))))))
    .addChild(new Group()
      .addChild(new ProtoInstance("line", "dimethyl_sulfoxide_b1").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {0.8293,1.3548,0.5856,2.3997,2.0598,0.0})))))
      .addChild(new ProtoInstance("line", "dimethyl_sulfoxide_b5").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.3997,2.0598,0.0,3.5575,1.0719,0.9948})))))
      .addChild(new ProtoInstance("line", "dimethyl_sulfoxide_b6").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.3797,2.0598,0.0,2.4313,3.4791,0.6382})))))
      .addChild(new ProtoInstance("line", "dimethyl_sulfoxide_b6_2").setContainerField("children")
        .addFieldValue(new fieldValue().setName("bond_set").setValue(new MFVec3f(new MFVec3f(new double[] {2.4197,2.0598,0.0,2.4713,3.4791,0.6382})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new DimethylSulfoxide().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.DimethylSulfoxide\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.DimethylSulfoxide\" self-validation test results: ");

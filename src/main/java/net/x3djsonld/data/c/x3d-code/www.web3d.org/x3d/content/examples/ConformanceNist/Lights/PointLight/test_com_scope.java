 ...
 * <p> Test browser to shade light only on objects within its the radius field. The figures in question are a complex geometry (ElevationGrid). Four sets of ElevationGrrids are drawn in the XY plane forming cross-like figure and a PointLight with radius 5.5 and intensity 1 is also defined at the origin. If the implementation under test does NOT ignore the radius, then the last figure of each set (except the ones along the +X axis) should not be illuminated. (the last two figures along the +X axis should not be illuminated). </p>
 <p> Related links: <a href="../../../../Lights/PointLight/test_com_scope.java">test_com_scope.java</a> source, <a href="../../../../Lights/PointLight/test_com_scopeIndex.html" target="_top">test_com_scope catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/PointLight/test_com_scope.x3d">test_com_scope.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/PointLight/test-com-scope-front.jpg">test-com-scope-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_com_scope.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_com_scope.x3d</a> </td>
		</tr>
		<tr>
...
public class test_com_scope
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_com_scope.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform().setTranslation(0.0,-1.5,-1.5)
      .addChild(new Shape()
        ...
        .setGeometry(new ElevationGrid("the-grid").setSolid(false).setXDimension(21).setXSpacing(0.1).setZDimension(21).setZSpacing(0.1).setHeight(getthe_grid_5_27_height()))))
	...
	// end of initialize() method
		...
		private double[] getthe_grid_5_27_height_1()
		{
		...
		/** Large attribute array: ElevationGrid DEF='the-grid' height field, scene-graph level=5, element #27, 441 total numbers.
		 ...
		 */
		private MFFloat getthe_grid_5_27_height()
		{
			MFFloat the_grid_5_27_height = new MFFloat()/*2.finalize*/
				.append(new MFFloat(getthe_grid_5_27_height_1()));
			return the_grid_5_27_height;
		}

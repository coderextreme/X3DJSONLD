...
/**
 * <p> This test defines an Anchor node whose url field is in turn another Anchor node. The test should generate a red sphere with some text on top. After the user clicks on the sphere, the browser should bring up a red box with some text on top. After the user clicks on the red box, the browser should bring up a blue box with some text on top of it. No viewpoints are associated with the url fields. </p>
 <p> Related links: <a href="../../../../GroupingNodes/Anchor/nested_anchor.java">nested_anchor.java</a> source, <a href="../../../../GroupingNodes/Anchor/nested_anchorIndex.html" target="_top">nested_anchor catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../GroupingNodes/Anchor/nested_anchor.x3d">nested_anchor.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test defines an Anchor node whose url field is in turn another Anchor node. The test should generate a red sphere with some text on top. After the user clicks on the sphere, the browser should bring up a red box with some text on top. After the user clicks on the red box, the browser should bring up a blue box with some text on top of it. No viewpoints are associated with the url fields. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/nested_anchor.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/nested_anchor.x3d</a> </td>
		</tr>
		<tr>
...
public class nested_anchor
{
	/** Default constructor to create this object. */
	public nested_anchor ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("nested_anchor.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/nested_anchor.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("nested_anchor.x3d"))
    ...
    .addChild(new Anchor().setDescription("An Anchor whose URL references is another Anchor").setUrl(new String[] {"new_world.x3d","https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/new_world.x3d","new-world.wrl","https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/new-world.wrl"})
      .addChild(new Shape()
        .setAppearance(new Appearance()
    ...
    {
        X3D thisExampleX3dModel = new nested_anchor().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.nested_anchor\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.nested_anchor\" self-validation test results: ");

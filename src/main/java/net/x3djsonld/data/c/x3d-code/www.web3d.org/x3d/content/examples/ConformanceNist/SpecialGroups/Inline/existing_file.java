...
/**
 * <p> This file is referenced by the "invalid_url" file as part of the invalid url test. This file in particular should generate a blue box with some text on top of it. </p>
 <p> Related links: <a href="../../../../SpecialGroups/Inline/existing_file.java">existing_file.java</a> source, <a href="../../../../SpecialGroups/Inline/existing_fileIndex.html" target="_top">existing_file catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../SpecialGroups/Inline/existing_file.x3d">existing_file.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This file is referenced by the "invalid_url" file as part of the invalid url test. This file in particular should generate a blue box with some text on top of it. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/existing_file.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/existing_file.x3d</a> </td>
		</tr>
		<tr>
...
public class existing_file
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("existing_file.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("This file is referenced by the \"invalid_url\" file as part of the invalid url test. This file in particular should generate a blue box with some text on top of it."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/Inline/existing_file.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("existing_file.x3d"))
    ...
    .addChild(new Transform().setTranslation(0.0,3.0,0.0)
      .addChild(new Shape()
        ...
        .setGeometry(new Text().setString(new String[] {"A BLUE BOX BELOW INDICATES THAT","THIS BROWSER PASSED THIS TEST"})
    ...
    {
        X3D thisExampleX3dModel = new existing_file().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.existing_file\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.existing_file\" self-validation test results: ");

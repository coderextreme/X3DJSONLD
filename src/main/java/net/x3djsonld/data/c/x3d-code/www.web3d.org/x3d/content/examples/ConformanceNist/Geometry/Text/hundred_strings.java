...
/**
 * <p> This test attempts to write 100 strings, as required by the VRML specification. The test should write the strings "string 1", "string 2" thru "string 100". </p>
 <p> Related links: <a href="../../../../Geometry/Text/hundred_strings.java">hundred_strings.java</a> source, <a href="../../../../Geometry/Text/hundred_stringsIndex.html" target="_top">hundred_strings catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Text/hundred_strings.x3d">hundred_strings.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test attempts to write 100 strings, as required by the VRML specification. The test should write the strings "string 1", "string 2" thru "string 100". </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/hundred_strings.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/hundred_strings.x3d</a> </td>
		</tr>
		<tr>
...
public class hundred_strings
{
	/** Default constructor to create this object. */
	public hundred_strings ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("hundred_strings.x3d"))
  ...
  .setScene(new Scene()
    ...
    {
        X3D thisExampleX3dModel = new hundred_strings().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.hundred_strings\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.hundred_strings\" self-validation test results: ");

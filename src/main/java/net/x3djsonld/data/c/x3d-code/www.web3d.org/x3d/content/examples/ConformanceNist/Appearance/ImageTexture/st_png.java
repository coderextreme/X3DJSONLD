...
/**
 * <p> Test browser default ability to repeat a half-scale PNG texture horizontally and vertically to map primitive geometry. A 2 by 2 matrix of VTS logos should map to the cone, sphere, cylinder, and each face of the box. For the cone, cylinder and sphere and sides of the box, the text should face the viewer and be horizontal. The top of the box shall have a 2 by 2 matrix of VTS logos facing the viewer, and reading left-to-right when the box top is tilted toward the initial viewpoint. The bottom of the box shall have a 2 by 2 matrix of VTS logos reading left-to-right when the bottom of the box is tilted toward the initial viewpoint. </p>
 <p> Related links: <a href="../../../../Appearance/ImageTexture/st_png.java">st_png.java</a> source, <a href="../../../../Appearance/ImageTexture/st_pngIndex.html" target="_top">st_png catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/ImageTexture/st_png.x3d">st_png.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st_png-front.jpg">st_png-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st_png-rear.jpg">st_png-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st_png-top.jpg">st_png-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st_png-bottom.jpg">st_png-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st_png-left.jpg">st_png-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/ImageTexture/st_png-right.jpg">st_png-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test browser default ability to repeat a half-scale PNG texture horizontally and vertically to map primitive geometry. A 2 by 2 matrix of VTS logos should map to the cone, sphere, cylinder, and each face of the box. For the cone, cylinder and sphere and sides of the box, the text should face the viewer and be horizontal. The top of the box shall have a 2 by 2 matrix of VTS logos facing the viewer, and reading left-to-right when the box top is tilted toward the initial viewpoint. The bottom of the box shall have a 2 by 2 matrix of VTS logos reading left-to-right when the bottom of the box is tilted toward the initial viewpoint. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/st_png.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/st_png.x3d</a> </td>
		</tr>
		<tr>
...
public class st_png
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("st_png.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("st_png-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("st_png-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("st_png-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("st_png-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("st_png-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("st_png-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test browser default ability to repeat a half-scale PNG texture horizontally and vertically to map primitive geometry. A 2 by 2 matrix of VTS logos should map to the cone, sphere, cylinder, and each face of the box. For the cone, cylinder and sphere and sides of the box, the text should face the viewer and be horizontal. The top of the box shall have a 2 by 2 matrix of VTS logos facing the viewer, and reading left-to-right when the box top is tilted toward the initial viewpoint. The bottom of the box shall have a 2 by 2 matrix of VTS logos reading left-to-right when the bottom of the box is tilted toward the initial viewpoint."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/st_png.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("st_png.x3d"))
    ...
    {
        X3D thisExampleX3dModel = new st_png().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.st_png\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.st_png\" self-validation test results: ");

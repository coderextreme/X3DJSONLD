 ...
 * <p> A simple scene to show KeySensor functionality using Interactive Profile. </p>
 <p> Related links: <a href="../../../../Sensors/Keyboard/KeySensorActivationKeySwitchTestInteractive.java">KeySensorActivationKeySwitchTestInteractive.java</a> source, <a href="../../../../Sensors/Keyboard/KeySensorActivationKeySwitchTestInteractiveIndex.html" target="_top">KeySensorActivationKeySwitchTestInteractive catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/Keyboard/KeySensorActivationKeySwitchTestInteractive.x3d">KeySensorActivationKeySwitchTestInteractive.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/development/KeySensorActivationKeySwitchTestInteractive.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/development/KeySensorActivationKeySwitchTestInteractive.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/Keyboard/KeySensorActivationKeySwitchTestInteractive.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/Keyboard/KeySensorActivationKeySwitchTestInteractive.x3d</a> </td>
		</tr>
		<tr>
...
public class KeySensorActivationKeySwitchTestInteractive
{
	/** Default constructor to create this object. */
	public KeySensorActivationKeySwitchTestInteractive ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("KeySensorActivationKeySwitchTestInteractive.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("A simple scene to show KeySensor functionality using Interactive Profile."))
    ...
    .addMeta(new meta().setName(meta.NAME_SUBJECT    ).setContent("KeySensor Interactive Profile"))
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("https://www.web3d.org/x3d/content/examples/development/KeySensorActivationKeySwitchTestInteractive.x3d"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/Keyboard/KeySensorActivationKeySwitchTestInteractive.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("KeySensorActivationKeySwitchTestInteractive.x3d"))
    ...
    {
        X3D thisExampleX3dModel = new KeySensorActivationKeySwitchTestInteractive().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.KeySensorActivationKeySwitchTestInteractive\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.KeySensorActivationKeySwitchTestInteractive\" self-validation test results: ");

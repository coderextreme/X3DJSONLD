 ...
 * <p> Simple X3D example with XML digital signature for author authentication, also used for example combined with encryption. </p>
 <p> Related links: <a href="../../../Security/HelloWorldSignedDecrypted.java">HelloWorldSignedDecrypted.java</a> source, <a href="../../../Security/HelloWorldSignedDecryptedIndex.html" target="_top">HelloWorldSignedDecrypted catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../Security/HelloWorldSignedDecrypted.x3d">HelloWorldSignedDecrypted.x3d</a> </td>
		</tr>
		<tr>
...
public class HelloWorldSignedDecrypted
{
	/** Default constructor to create this object. */
	public HelloWorldSignedDecrypted ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("HelloWorldSignedDecrypted.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("https://www.web3d.org/x3d/content/examples/Basic/Security/HelloWorldSigned.x3d"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/Security/HelloWorldSignedDecrypted.x3d"))
  ...
  ;
	 ...
	 * @return HelloWorldSignedDecrypted model
	 */
    ...
    {
        X3D thisExampleX3dModel = new HelloWorldSignedDecrypted().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.HelloWorldSignedDecrypted\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.HelloWorldSignedDecrypted\" self-validation test results: ");

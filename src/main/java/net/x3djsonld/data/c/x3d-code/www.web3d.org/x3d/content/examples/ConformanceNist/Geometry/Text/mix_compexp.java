...
/**
 * <p> This test sets the string field to four character strings ("THE", "VRML", "TEST", "SUITE"). Each string is assigned a different length value in the length field causing the string to be compresed, expanded. The strings The strings "THE" and "TEST" should be expanded while the strings "VRML" and "SUITE" should be compressed. </p>
 <p> Related links: <a href="../../../../Geometry/Text/mix_compexp.java">mix_compexp.java</a> source, <a href="../../../../Geometry/Text/mix_compexpIndex.html" target="_top">mix_compexp catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Geometry/Text/mix_compexp.x3d">mix_compexp.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Geometry/Text/mix-compexp-front.jpg">mix-compexp-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test sets the string field to four character strings ("THE", "VRML", "TEST", "SUITE"). Each string is assigned a different length value in the length field causing the string to be compresed, expanded. The strings The strings "THE" and "TEST" should be expanded while the strings "VRML" and "SUITE" should be compressed. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/mix_compexp.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/mix_compexp.x3d</a> </td>
		</tr>
		<tr>
...
public class mix_compexp
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("mix_compexp.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("mix-compexp-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/Text/mix_compexp.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("mix_compexp.x3d"))
    .addChild(new NavigationInfo().setType("\"EXAMINE\" \"WALK\" \"FLY\" \"ANY\""))
    .addChild(new Transform().setTranslation(-3.0,0.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Text().setLength(new double[] {0.0,0.0,0.0,0.0}).setString(new String[] {"THE","VRML","TEST","SUITE"}))))
    .addChild(new Transform().setTranslation(3.0,0.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Text().setLength(new double[] {5.0,2.0,6.0,2.0}).setString(new String[] {"THE","VRML","TEST","SUITE"})))));
    }
    ...
    {
        X3D thisExampleX3dModel = new mix_compexp().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.mix_compexp\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.mix_compexp\" self-validation test results: ");

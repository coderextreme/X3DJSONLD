 ...
 <p> Related links: <a href="../../../../Sensors/SphereSensor/trackpoint_changed.java">trackpoint_changed.java</a> source, <a href="../../../../Sensors/SphereSensor/trackpoint_changedIndex.html" target="_top">trackpoint_changed catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/SphereSensor/trackpoint_changed.x3d">trackpoint_changed.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/SphereSensor/trackpoint_changed-movie.mpg">trackpoint_changed-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test the SphereSensors node ability to send "trackPoint_changed" events to other node. A SphereSensor is associated with a Sphere geometry. In addition, a red Sphere receives the "trackPoint_changed" event as the pointing device is dragged over the geometry. The result is, the red Sphere follows the pointing device while it is over the geometry an the primary button is depressed. The motion will follow the invisible Sphere whose axis is the Y axis, and whose radius is the distance from the Y axis and the intersection of the pointer bearing and the geometry. As a result, the ball will appear to follow the Sphere surface as the cursor is dragged over the geometry. trackPoint_changed events are undefined when the pointing device is dragged outside the bounds of the geometry. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/SphereSensor/trackpoint_changed.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/SphereSensor/trackpoint_changed.x3d</a> </td>
		</tr>
		<tr>
...
public class trackpoint_changed
{
	/** Default constructor to create this object. */
	public trackpoint_changed ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("trackpoint_changed.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("trackpoint_changed-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test the SphereSensors node ability to send \"trackPoint_changed\" events to other node. A SphereSensor is associated with a Sphere geometry. In addition, a red Sphere receives the \"trackPoint_changed\" event as the pointing device is dragged over the geometry. The result is, the red Sphere follows the pointing device while it is over the geometry an the primary button is depressed. The motion will follow the invisible Sphere whose axis is the Y axis, and whose radius is the distance from the Y axis and the intersection of the pointer bearing and the geometry. As a result, the ball will appear to follow the Sphere surface as the cursor is dragged over the geometry. trackPoint_changed events are undefined when the pointing device is dragged outside the bounds of the geometry."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/SphereSensor/trackpoint_changed.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("trackpoint_changed.x3d"))
    ...
    .addChild(new Group()
      .addChild(new Transform()
        .addChild(new Transform("MY_BALL")
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(1.0,0.0,0.0)))
            .setGeometry(new Sphere().setRadius(0.3))))
        .addChild(new SphereSensor("SPHSENSOR").setDescription("click and drag to rotate"))
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material().setDiffuseColor(1.0,1.0,0.0)))
          .setGeometry(new Sphere()))))
    .addChild(new ROUTE().setFromNode("SPHSENSOR").setFromField("trackPoint_changed").setToNode("MY_BALL").setToField("set_translation")));
    }
	 ...
	 * @return trackpoint_changed model
	 */
    ...
    {
        X3D thisExampleX3dModel = new trackpoint_changed().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.trackpoint_changed\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.trackpoint_changed\" self-validation test results: ");

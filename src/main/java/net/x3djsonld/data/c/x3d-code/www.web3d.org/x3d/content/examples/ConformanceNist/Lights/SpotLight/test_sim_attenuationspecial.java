 ...
 * <p> This test checks the special attenuation value of 0 0 0. This value should produce the same behaviour as 1 0 0 (the default value). The light should not attenuate as long as the objects are within the radius of the light. The objects in question are a set of simple geometry (cone, spehere, box and cylinder). The test starts by clicking on the text above the geometry. The objects will move further away from the light along the Z axis and stop at position 0 0 -50. The intensity of the light should not change at any time during the animation. </p>
 <p> Related links: <a href="../../../../Lights/SpotLight/test_sim_attenuationspecial.java">test_sim_attenuationspecial.java</a> source, <a href="../../../../Lights/SpotLight/test_sim_attenuationspecialIndex.html" target="_top">test_sim_attenuationspecial catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/SpotLight/test_sim_attenuationspecial.x3d">test_sim_attenuationspecial.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Lights/SpotLight/test-sim-attenuationspecial-movie.mpg">test-sim-attenuationspecial-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_sim_attenuationspecial.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_sim_attenuationspecial.x3d</a> </td>
		</tr>
		<tr>
...
public class test_sim_attenuationspecial
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_sim_attenuationspecial.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new SpotLight("the-light").setAttenuation(0.0,0.0,0.0).setBeamWidth(1.57079).setCutOffAngle(1.57079).setLocation(0.0,0.0,10.0).setRadius(61))

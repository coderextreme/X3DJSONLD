...
/**
 * <p> Test of Appearance node ability to accept a Material node as an argument for the material field. Browser should generate thee Sphere geometry, with the top Sphere receiving a red diffuseColor, the bottom-right Sphere receiving a yellow emissiveColor, and the bottom-left sphere having a 0.57 transparency value. </p>
 <p> Related links: <a href="../../../../Appearance/Appearance/material.java">material.java</a> source, <a href="../../../../Appearance/Appearance/materialIndex.html" target="_top">material catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Appearance/material.x3d">material.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/material-front.jpg">material-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test of Appearance node ability to accept a Material node as an argument for the material field. Browser should generate thee Sphere geometry, with the top Sphere receiving a red diffuseColor, the bottom-right Sphere receiving a yellow emissiveColor, and the bottom-left sphere having a 0.57 transparency value. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/material.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/material.x3d</a> </td>
		</tr>
		<tr>
...
public class material
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("material.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("material-front.jpg"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform().setTranslation(0.0,2.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setAmbientIntensity(0.25).setDiffuseColor(0.748016,0.0,0.0400871).setShininess(0)))
        .setGeometry(new Sphere())))
    .addChild(new Transform().setTranslation(-2.0,0.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setAmbientIntensity(0.25).setDiffuseColor(0.748016,0.748016,0.748016).setShininess(1).setSpecularColor(0.89697,0.89697,0.89697).setTransparency(0.574468)))
        .setGeometry(new Sphere())))
    .addChild(new Transform().setTranslation(2.0,0.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setAmbientIntensity(0).setDiffuseColor(0.0,0.0,0.0).setEmissiveColor(0.957447,0.916761,0.102624).setShininess(0)))
        .setGeometry(new Sphere()))));
    }
    ...
    {
        X3D thisExampleX3dModel = new material().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.material\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.material\" self-validation test results: ");

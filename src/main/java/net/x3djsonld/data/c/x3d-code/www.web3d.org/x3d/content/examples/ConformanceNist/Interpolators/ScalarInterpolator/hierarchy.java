...
/**
 * <p> Test of a ScalarInterpolator node to continue to generate and receive events when outside the Transform hierarchy. A Switch node is the parent of a ScalarInterpolator node that changes the illumination of a Cylinder geometry by a PointLight. The ScalarInterpolator has been "switched out" by setting the whichChoice field to -1. The result should be, the ScalarInterpolator should continue send and receive events, and animate the illumination of the Cylinder geometry. </p>
 <p> Related links: <a href="../../../../Interpolators/ScalarInterpolator/hierarchy.java">hierarchy.java</a> source, <a href="../../../../Interpolators/ScalarInterpolator/hierarchyIndex.html" target="_top">hierarchy catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Interpolators/ScalarInterpolator/hierarchy.x3d">hierarchy.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Interpolators/ScalarInterpolator/hierarchy-movie.mpg">hierarchy-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test of a ScalarInterpolator node to continue to generate and receive events when outside the Transform hierarchy. A Switch node is the parent of a ScalarInterpolator node that changes the illumination of a Cylinder geometry by a PointLight. The ScalarInterpolator has been "switched out" by setting the whichChoice field to -1. The result should be, the ScalarInterpolator should continue send and receive events, and animate the illumination of the Cylinder geometry. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/ScalarInterpolator/hierarchy.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/ScalarInterpolator/hierarchy.x3d</a> </td>
		</tr>
		<tr>
...
public class hierarchy
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test of a ScalarInterpolator node to continue to generate and receive events when outside the Transform hierarchy. A Switch node is the parent of a ScalarInterpolator node that changes the illumination of a Cylinder geometry by a PointLight. The ScalarInterpolator has been \"switched out\" by setting the whichChoice field to -1. The result should be, the ScalarInterpolator should continue send and receive events, and animate the illumination of the Cylinder geometry."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Interpolators/ScalarInterpolator/hierarchy.x3d"))

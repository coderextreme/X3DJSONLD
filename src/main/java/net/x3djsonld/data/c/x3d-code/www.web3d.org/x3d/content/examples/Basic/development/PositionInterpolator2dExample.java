...
public class PositionInterpolator2dExample
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Example to interpolate a Vector2Float value - click geometry to activate animation loop."))
    ...
    .addMeta(new meta().setName(meta.NAME_SUBJECT    ).setContent("Vector2FloatArray Interpolator"))
    .addMeta(new meta().setName(meta.NAME_SUBJECT    ).setContent("PositionInterpolator2D"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/Basic/development/PositionInterpolator2dExample.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform("ImageAspectRatio").setScale(1.5,1.0,1.0)
      ...
      .addChild(new Shape()
        ...
        .setAppearance(new Appearance()
          .setTexture(new ImageTexture("ContactImage").setUrl(new String[] {"JavaBoardSmileForTheCamera.jpg","https://savage.nps.edu/Savage/Tools/Animation/JavaBoardSmileForTheCamera.jpg","http://faculty.nps.edu/brutzman/images/JavaBoardSmileForTheCamera.jpg"}))
          .setTextureTransform(new TextureTransform("TTN"))))
      .addChild(new ROUTE().setFromNode("InterpolateTTscale").setFromField("value_changed").setToNode("TTN").setToField("set_scale"))));
    }
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.PositionInterpolator2dExample\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.PositionInterpolator2dExample\" self-validation test results: ");

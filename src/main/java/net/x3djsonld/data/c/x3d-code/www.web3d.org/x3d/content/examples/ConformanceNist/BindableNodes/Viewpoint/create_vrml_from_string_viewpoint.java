...
/**
 * <p> Test that a Viewpoint genereated by CreateVrmlFromString should not be bound. A Viewpoint node is introduced into this world via the createVrmlFromString method of an EcmaScript script node. The string used in the script contains a REAR view Viewpoint node with a position of 0 0 -10. Because the Viewpoint node is introduced via a createVrmlFromString method, it should not be bound to the top of the stack. As a result, the default frontal Viewpoint values should be used by the browser, and the viewer should have a FRONT view of the cube geometry. </p>
 <p> Related links: <a href="../../../../BindableNodes/Viewpoint/create_vrml_from_string_viewpoint.java">create_vrml_from_string_viewpoint.java</a> source, <a href="../../../../BindableNodes/Viewpoint/create_vrml_from_string_viewpointIndex.html" target="_top">create_vrml_from_string_viewpoint catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../BindableNodes/Viewpoint/create_vrml_from_string_viewpoint.x3d">create_vrml_from_string_viewpoint.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../BindableNodes/Viewpoint/create_vrml_from_string_viewpoint-front.jpg">create_vrml_from_string_viewpoint-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test that a Viewpoint genereated by CreateVrmlFromString should not be bound. A Viewpoint node is introduced into this world via the createVrmlFromString method of an EcmaScript script node. The string used in the script contains a REAR view Viewpoint node with a position of 0 0 -10. Because the Viewpoint node is introduced via a createVrmlFromString method, it should not be bound to the top of the stack. As a result, the default frontal Viewpoint values should be used by the browser, and the viewer should have a FRONT view of the cube geometry. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/create_vrml_from_string_viewpoint.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/create_vrml_from_string_viewpoint.x3d</a> </td>
		</tr>
		<tr>
...
public class create_vrml_from_string_viewpoint
{
	/** Default constructor to create this object. */
	public create_vrml_from_string_viewpoint ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("create_vrml_from_string_viewpoint.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("create_vrml_from_string_viewpoint-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test that a Viewpoint genereated by CreateVrmlFromString should not be bound. A Viewpoint node is introduced into this world via the createVrmlFromString method of an EcmaScript script node. The string used in the script contains a REAR view Viewpoint node with a position of 0 0 -10. Because the Viewpoint node is introduced via a createVrmlFromString method, it should not be bound to the top of the stack. As a result, the default frontal Viewpoint values should be used by the browser, and the viewer should have a FRONT view of the cube geometry."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/create_vrml_from_string_viewpoint.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("create_vrml_from_string_viewpoint.x3d"))
    ...
    .addChild(new Script("MYSCRIPT").setDirectOutput(true).setUrl(new String[] {"create_vrml_from_string_viewpoint.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/create_vrml_from_string_viewpoint.js"})
	 ...
	 * @return create_vrml_from_string_viewpoint model
	 */
    ...
    {
        X3D thisExampleX3dModel = new create_vrml_from_string_viewpoint().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.create_vrml_from_string_viewpoint\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.create_vrml_from_string_viewpoint\" self-validation test results: ");

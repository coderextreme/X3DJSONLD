...
/**
 * <p> Test if PlaneSensor works for default field values. A PlaneSensor is associated with a red Box geometry. When pressing left mouse button over the red box and dragging, the Box should translate in the X and Y direction by the same amount as the indicating pointing device moves in the XY plane intersected by the bearing line of the pointing device. Movement should not be restricted or "clamped" in the X or Y direction. The Box should not "snap back" to its original position each time it is indicated by the pointing device. </p>
 <p> Related links: <a href="../../../../Sensors/PlaneSensor/default_planesensor.java">default_planesensor.java</a> source, <a href="../../../../Sensors/PlaneSensor/default_planesensorIndex.html" target="_top">default_planesensor catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/PlaneSensor/default_planesensor.x3d">default_planesensor.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/PlaneSensor/default-movie.mpg">default-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test if PlaneSensor works for default field values. A PlaneSensor is associated with a red Box geometry. When pressing left mouse button over the red box and dragging, the Box should translate in the X and Y direction by the same amount as the indicating pointing device moves in the XY plane intersected by the bearing line of the pointing device. Movement should not be restricted or "clamped" in the X or Y direction. The Box should not "snap back" to its original position each time it is indicated by the pointing device. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/default_planesensor.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/default_planesensor.x3d</a> </td>
		</tr>
		<tr>
...
public class default_planesensor
{
	/** Default constructor to create this object. */
	public default_planesensor ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("default_planesensor.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test if PlaneSensor works for default field values. A PlaneSensor is associated with a red Box geometry. When pressing left mouse button over the red box and dragging, the Box should translate in the X and Y direction by the same amount as the indicating pointing device moves in the XY plane intersected by the bearing line of the pointing device. Movement should not be restricted or \"clamped\" in the X or Y direction. The Box should not \"snap back\" to its original position each time it is indicated by the pointing device."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/default_planesensor.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("default_planesensor.x3d"))
    .addChild(new Group()
      .addChild(new PlaneSensor("PLANE_SENSOR"))
	 ...
	 * @return default_planesensor model
	 */
    ...
    {
        X3D thisExampleX3dModel = new default_planesensor().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.default_planesensor\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.default_planesensor\" self-validation test results: ");

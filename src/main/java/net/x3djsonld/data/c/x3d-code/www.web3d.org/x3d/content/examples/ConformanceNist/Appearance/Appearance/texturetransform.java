 ...
 <p> Related links: <a href="../../../../Appearance/Appearance/texturetransform.java">texturetransform.java</a> source, <a href="../../../../Appearance/Appearance/texturetransformIndex.html" target="_top">texturetransform catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Appearance/texturetransform.x3d">texturetransform.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Appearance/texturetransform-front.jpg">texturetransform-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test of the textureTransform field of the Appearance node by applying rotations of (left to right) 0, 90, 180, 270 and 360 degrees to an ImageTexture mapped to the faces of primitive geometry. The result is (for all geometry faces): the first column of geometry should show the VTS logo with the horizontal texture direction corresponding to the -X coordinate direction, and the vertical texture direction corresponding to -Y direction. The second column of geometry should map the VTS logo with the positive horizontal direction corresponding to the -Y direction, and the positive vertical axis in the +X direction. The third column should show the positive horizontal axis at +45 degrees (counterclockwise) from the +X direction, and the vertical texture direction corresponding to +45 degrees (counterclockwise) from the Y direction. The fourth column should show the positive horizontal texture axis in the +Y direction, and the positive vertical axis in the -X direction. The fifth column should show the VTS logo with the horizontal texture direction corresponding to the -X coordinate direction, and the vertical texture direction corresponding to -Y direction. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/texturetransform.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/texturetransform.x3d</a> </td>
		</tr>
		<tr>
...
public class texturetransform
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("texturetransform.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("texturetransform-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_CREATED    ).setContent("21 January 2001"))
    .addMeta(new meta().setName(meta.NAME_MODIFIED   ).setContent("20 October 2019"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test of the textureTransform field of the Appearance node by applying rotations of (left to right) 0, 90, 180, 270 and 360 degrees to an ImageTexture mapped to the faces of primitive geometry. The result is (for all geometry faces): the first column of geometry should show the VTS logo with the horizontal texture direction corresponding to the -X coordinate direction, and the vertical texture direction corresponding to -Y direction. The second column of geometry should map the VTS logo with the positive horizontal direction corresponding to the -Y direction, and the positive vertical axis in the +X direction. The third column should show the positive horizontal axis at +45 degrees (counterclockwise) from the +X direction, and the vertical texture direction corresponding to +45 degrees (counterclockwise) from the Y direction. The fourth column should show the positive horizontal texture axis in the +Y direction, and the positive vertical axis in the -X direction. The fifth column should show the VTS logo with the horizontal texture direction corresponding to the -X coordinate direction, and the vertical texture direction corresponding to -Y direction."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/texturetransform.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("texturetransform.x3d"))
    .addChild(new Group()
    ...
    .addChild(new Transform().setTranslation(-2.0,-0.75,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          ...
          .setTextureTransform(new TextureTransform().setRotation(1.57).setScale(2.0,2.0))
          .setMaterial(new Material()))
        .setGeometry(new Sphere().setRadius(0.5))))
    .addChild(new Transform().setTranslation(0.0,-0.75,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setTexture(new ImageTexture().setUSE("VTS"))
          .setTextureTransform(new TextureTransform().setRotation(3.14).setScale(2.0,2.0))
          .setMaterial(new Material()))
        .setGeometry(new Sphere().setRadius(0.5))))
    .addChild(new Transform().setTranslation(2.0,-0.75,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setTexture(new ImageTexture().setUSE("VTS"))
          .setTextureTransform(new TextureTransform().setRotation(4.71).setScale(2.0,2.0))
          .setMaterial(new Material()))
        .setGeometry(new Sphere().setRadius(0.5))))
    .addChild(new Transform().setTranslation(4.0,-0.75,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setTexture(new ImageTexture().setUSE("VTS"))
          .setTextureTransform(new TextureTransform().setRotation(6.28).setScale(2.0,2.0))
          .setMaterial(new Material()))
        .setGeometry(new Sphere().setRadius(0.5))))
    ...
    {
        X3D thisExampleX3dModel = new texturetransform().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.texturetransform\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.texturetransform\" self-validation test results: ");

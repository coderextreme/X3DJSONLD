 ...
 <p> Related links: <a href="../../../../Sensors/SphereSensor/isactive.java">isactive.java</a> source, <a href="../../../../Sensors/SphereSensor/isactiveIndex.html" target="_top">isactive catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/SphereSensor/isactive.x3d">isactive.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/SphereSensor/isactive-movie.mpg">isactive-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test if the SphereSensor node isActive field can be routed to other node. A Box geometry has an associated SphereSensor, which routes its isActive event to an associated PointLight. When the primary pointing device buttons is depressed while over a geometry, the associated PointLight will turn on. Letting up on the pointing device button should turn the light off. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/SphereSensor/isactive.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/SphereSensor/isactive.x3d</a> </td>
		</tr>
		<tr>
...
public class isactive
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test if the SphereSensor node isActive field can be routed to other node. A Box geometry has an associated SphereSensor, which routes its isActive event to an associated PointLight. When the primary pointing device buttons is depressed while over a geometry, the associated PointLight will turn on. Letting up on the pointing device button should turn the light off."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/SphereSensor/isactive.x3d"))

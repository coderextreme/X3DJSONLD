 ...
 <p> Related links: <a href="../../../../Lights/PointLight/test_red_on_blue.java">test_red_on_blue.java</a> source, <a href="../../../../Lights/PointLight/test_red_on_blueIndex.html" target="_top">test_red_on_blue catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/PointLight/test_red_on_blue.x3d">test_red_on_blue.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Lights/PointLight/test-red-on-blue-front.jpg">test-red-on-blue-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_red_on_blue.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_red_on_blue.x3d</a> </td>
		</tr>
		<tr>
...
public class test_red_on_blue
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_red_on_blue.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new PointLight().setColor(1.0,0.0,0.0).setLocation(0.0,0.0,10.0))

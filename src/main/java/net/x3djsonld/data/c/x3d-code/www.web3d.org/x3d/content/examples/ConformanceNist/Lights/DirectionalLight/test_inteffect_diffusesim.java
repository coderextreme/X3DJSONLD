...
/**
 * <p> This test addresses the effect of the light intensity on the diffuse color of simple geometry. One row of simple geometry is drawn in the local coordinate system and a DirectionalLight is also defined with intensity 0 and color 1 1 1. The test starts by clicking on the text above the geometry. The intensity of the light is increased as the animation progresses and the diffuse color brightness of the objects should also increase. Intensity values range from 0 to 1. The geometry are originally defined with a diffuseColor of 0 0 1. </p>
 <p> Related links: <a href="../../../../Lights/DirectionalLight/test_inteffect_diffusesim.java">test_inteffect_diffusesim.java</a> source, <a href="../../../../Lights/DirectionalLight/test_inteffect_diffusesimIndex.html" target="_top">test_inteffect_diffusesim catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Lights/DirectionalLight/test_inteffect_diffusesim.x3d">test_inteffect_diffusesim.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Lights/DirectionalLight/test-inteffect-diffusesim-movie.mpg">test-inteffect-diffusesim-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> This test addresses the effect of the light intensity on the diffuse color of simple geometry. One row of simple geometry is drawn in the local coordinate system and a DirectionalLight is also defined with intensity 0 and color 1 1 1. The test starts by clicking on the text above the geometry. The intensity of the light is increased as the animation progresses and the diffuse color brightness of the objects should also increase. Intensity values range from 0 to 1. The geometry are originally defined with a diffuseColor of 0 0 1. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_inteffect_diffusesim.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_inteffect_diffusesim.x3d</a> </td>
		</tr>
		<tr>
...
public class test_inteffect_diffusesim
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_inteffect_diffusesim.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Group()
      .addChild(new DirectionalLight("the-light").setIntensity(0))

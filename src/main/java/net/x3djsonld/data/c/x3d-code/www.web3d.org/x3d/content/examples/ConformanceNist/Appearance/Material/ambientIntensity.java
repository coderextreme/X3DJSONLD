 ...
 <p> Related links: <a href="../../../../Appearance/Material/ambientIntensity.java">ambientIntensity.java</a> source, <a href="../../../../Appearance/Material/ambientIntensityIndex.html" target="_top">ambientIntensity catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Material/ambientIntensity.x3d">ambientIntensity.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Material/ambientIntensity-front.jpg">ambientIntensity-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Material/ambientIntensity-rear.jpg">ambientIntensity-rear.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test ambientIntensity on primitive geometry. Five ambientIntensity values of 0, .25 .50 .75 and 1.0 are applied from left to right for primitive geometry. The geometry consists of a row of 5 Cones, followed by a row of 5 Cylinders, 5 Spheres, then 5 Boxes. The result is a horizontal range of illumination that begins with no ambient illumination on the left, to maximum ambient illumination on the right for all four primitive geometry types. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/ambientIntensity.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/ambientIntensity.x3d</a> </td>
		</tr>
		<tr>
...
public class ambientIntensity
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("ambientIntensity-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("ambientIntensity-rear.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/ambientIntensity.x3d"))
  ...
  .setScene(new Scene()
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.ambientIntensity\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.ambientIntensity\" self-validation test results: ");

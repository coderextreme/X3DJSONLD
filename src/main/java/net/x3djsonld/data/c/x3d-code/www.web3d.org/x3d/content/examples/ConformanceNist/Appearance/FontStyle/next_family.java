...
/**
 * <p> Test FontStyle node ability to go to next family in attribute list. A "family" type of "NONEXISTENT" is supplied to a FontStyle node, followed by a TYPEWRITER type. Because the browser does not support a "NONEXISTENT" family type, it should proceed to the next supported type (TYPEWRITER) and render a 3 line text string with a TYPEWRITER family font. </p>
 <p> Related links: <a href="../../../../Appearance/FontStyle/next_family.java">next_family.java</a> source, <a href="../../../../Appearance/FontStyle/next_familyIndex.html" target="_top">next_family catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/FontStyle/next_family.x3d">next_family.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/FontStyle/next_family-front.jpg">next_family-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test FontStyle node ability to go to next family in attribute list. A "family" type of "NONEXISTENT" is supplied to a FontStyle node, followed by a TYPEWRITER type. Because the browser does not support a "NONEXISTENT" family type, it should proceed to the next supported type (TYPEWRITER) and render a 3 line text string with a TYPEWRITER family font. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/FontStyle/next_family.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/FontStyle/next_family.x3d</a> </td>
		</tr>
		<tr>
...
public class next_family
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("next_family.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("next_family-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test FontStyle node ability to go to next family in attribute list. A \"family\" type of \"NONEXISTENT\" is supplied to a FontStyle node, followed by a TYPEWRITER type. Because the browser does not support a \"NONEXISTENT\" family type, it should proceed to the next supported type (TYPEWRITER) and render a 3 line text string with a TYPEWRITER family font."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/FontStyle/next_family.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("next_family.x3d"))
    .addChild(new Viewpoint().setDescription("Changing FontStyle family values").setPosition(0.0,0.0,15.0))
    .addChild(new Group()
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material()))
        .setGeometry(new Text("MYTEXT").setString(new String[] {"This should be TYPEWRITER"})
    ...
    .addChild(new Transform()
      .addChild(new Shape()
        ...
        .setGeometry(new IndexedLineSet("AXES").setDEF("AXES").setCoordIndex(new int[] {0,1,-1,2,3,-1})
          .setCoord(new Coordinate().setPoint(new MFVec3f(new double[] {-200.0,0.0,0.0,20.0,0.0,0.0,0.0,5.0,0.0,0.0,-5.0,0.0})))))));
    }
    ...
    {
        X3D thisExampleX3dModel = new next_family().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.next_family\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.next_family\" self-validation test results: ");

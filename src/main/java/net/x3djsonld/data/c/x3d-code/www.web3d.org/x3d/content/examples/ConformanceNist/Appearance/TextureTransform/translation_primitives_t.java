 ...
 * <p> Test ImageTexture translation along T axis for primitive geometry. Test browser ability to apply translations of (left to right) 0 -100.75, 0 -23.25, 0 0, 0 23.25, and 0 100.75 to an ImageTexture mapped to the faces of primitive geometry, mapping with default primitive mapping rules. The result is: The left column shows primitive geometry mapped with the VTS logo horizontally centered on all faces, with the VTS logo appearing at the bottom of all geometry faces. The second column shows a horizontally centered logo with the VTS logo at the top of all geometry faces. The third column shows a vertically and horizontally centered VTS logo on all faces. The fourth column should be identical to column #1. The fifth column should appear identical to column #2. </p>
 <p> Related links: <a href="../../../../Appearance/TextureTransform/translation_primitives_t.java">translation_primitives_t.java</a> source, <a href="../../../../Appearance/TextureTransform/translation_primitives_tIndex.html" target="_top">translation_primitives_t catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/TextureTransform/translation_primitives_t.x3d">translation_primitives_t.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/translation_primitives_t-front.jpg">translation_primitives_t-front.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/translation_primitives_t-rear.jpg">translation_primitives_t-rear.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/translation_primitives_t-top.jpg">translation_primitives_t-top.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/translation_primitives_t-bottom.jpg">translation_primitives_t-bottom.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/translation_primitives_t-left.jpg">translation_primitives_t-left.jpg</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/TextureTransform/translation_primitives_t-right.jpg">translation_primitives_t-right.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/translation_primitives_t.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/translation_primitives_t.x3d</a> </td>
		</tr>
		<tr>
...
public class translation_primitives_t
{
	/** Default constructor to create this object. */
	public translation_primitives_t ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("translation_primitives_t.x3d"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("translation_primitives_t-front.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("translation_primitives_t-rear.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("translation_primitives_t-top.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("translation_primitives_t-bottom.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("translation_primitives_t-left.jpg"))
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("translation_primitives_t-right.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/translation_primitives_t.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("translation_primitives_t.x3d"))
    .addChild(new Group()
	 ...
	 * @return translation_primitives_t model
	 */
    ...
    {
        X3D thisExampleX3dModel = new translation_primitives_t().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.translation_primitives_t\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.translation_primitives_t\" self-validation test results: ");

...
/**
 * <p> Test emissiveColor for an IndexedLineSet. By providing a value of "red" to the emissiveColor field of the Material node, a red IndexedLineSet box should be visible. </p>
 <p> Related links: <a href="../../../../Appearance/Material/indexedlineset.java">indexedlineset.java</a> source, <a href="../../../../Appearance/Material/indexedlinesetIndex.html" target="_top">indexedlineset catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Appearance/Material/indexedlineset.x3d">indexedlineset.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
			<td> <a href="../../../../Appearance/Material/indexedlineset-front.jpg">indexedlineset-front.jpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test emissiveColor for an IndexedLineSet. By providing a value of "red" to the emissiveColor field of the Material node, a red IndexedLineSet box should be visible. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/indexedlineset.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/indexedlineset.x3d</a> </td>
		</tr>
		<tr>
...
public class indexedlineset
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("indexedlineset-front.jpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test emissiveColor for an IndexedLineSet. By providing a value of \"red\" to the emissiveColor field of the Material node, a red IndexedLineSet box should be visible."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/indexedlineset.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape()
      ...
      .setGeometry(new IndexedLineSet().setCoordIndex(getIndexedLineSet_4_21_coordIndex())
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.indexedlineset\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.indexedlineset\" self-validation test results: ");

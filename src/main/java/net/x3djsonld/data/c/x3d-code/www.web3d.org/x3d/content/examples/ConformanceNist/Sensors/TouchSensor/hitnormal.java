 ...
 <p> Related links: <a href="../../../../Sensors/TouchSensor/hitnormal.java">hitnormal.java</a> source, <a href="../../../../Sensors/TouchSensor/hitnormalIndex.html" target="_top">hitnormal catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="../../../../Sensors/TouchSensor/hitnormal.x3d">hitnormal.x3d</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> MovingImage </i> </td>
			<td> <a href="../../../../Sensors/TouchSensor/hitnormal-movie.mpg">hitnormal-movie.mpg</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> Test hitNormal field. A TouchSensor is associated with a white Box geometry. A SpotLight is inside the Box geometry. Four red Spheres are above, below, to the left and right of the Box. The hitNormal_changed event from the TouchSensor is routed to the direction field of the SpotLight. The result is, when the pointing device is over the top, bottom, left or right face of the Box, the direction of that faces normal is routed to the SpotLight (turning the light). When the top face is indicated, the top Sphere should be illuminated. When the bottom face is indicated, the bottom Sphere should be illuminated. The same is true for the right and left faces. </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> identifier </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/hitnormal.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/hitnormal.x3d</a> </td>
		</tr>
		<tr>
...
public class hitnormal
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("hitnormal.x3d"))
    .addMeta(new meta().setName(meta.NAME_MOVINGIMAGE).setContent("hitnormal-movie.mpg"))
    ...
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("Test hitNormal field. A TouchSensor is associated with a white Box geometry. A SpotLight is inside the Box geometry. Four red Spheres are above, below, to the left and right of the Box. The hitNormal_changed event from the TouchSensor is routed to the direction field of the SpotLight. The result is, when the pointing device is over the top, bottom, left or right face of the Box, the direction of that faces normal is routed to the SpotLight (turning the light). When the top face is indicated, the top Sphere should be illuminated. When the bottom face is indicated, the bottom Sphere should be illuminated. The same is true for the right and left faces."))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/TouchSensor/hitnormal.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("hitnormal.x3d"))
    .addChild(new Group()
      ...
      .addChild(new SpotLight("MYSPOT").setBeamWidth(1.570796).setCutOffAngle(.785398))
      .addChild(new TouchSensor("MYTOUCH"))
      ...
      .addChild(new Transform().setTranslation(0.0,-4.0,0.0)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material().setDiffuseColor(1.0,0.0,0.0)))
          .setGeometry(new Sphere())))
      .addChild(new Transform().setRotation(1.0,1.0,0.0,0.785)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material()))
          .setGeometry(new IndexedFaceSet().setCoordIndex(new int[] {0,1,2,3,-1,4,5,6,7,-1,7,6,1,0,-1,3,2,5,4,-1,7,0,3,4,-1,1,6,5,2,-1})
    ...
    .addChild(new ROUTE().setFromNode("MYTOUCH").setFromField("hitNormal_changed").setToNode("MYSPOT").setToField("set_direction")));
    }
    ...
    {
        X3D thisExampleX3dModel = new hitnormal().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.hitnormal\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.hitnormal\" self-validation test results: ");

 ...
 * <p> 5 or more prismatic flowers. </p>
 <p> Related links: plainflowers.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
...
public class plainflowers
{
  ...
  .setHead(new headObject()
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE      ).setContent("plainflowers.x3d"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d")))
  .setScene(new SceneObject()
        ...
        .setProtoBody(new ProtoBodyObject()
          .addChild(new GroupObject()
            .addChild(new ProtoInstanceObject("FlowerProto")
              .addFieldValue(new fieldValueObject().setName("vertex").setValue(new String[] {"../shaders/x_ite_flowers_plain.vs"}))
              .addFieldValue(new fieldValueObject().setName("fragment").setValue(new String[] {"../shaders/plain.fs"}))))))
    ...
    {
        X3DObject thisExampleX3dObject = new plainflowers().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"plainflowers\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dObject.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"plainflowers\" self-validation test results: ");

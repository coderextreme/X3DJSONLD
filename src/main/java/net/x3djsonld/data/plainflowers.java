 ...
 <p> Related links:  source plainflowers.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d">plainflowers.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d" target="_blank">https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d</a> </td>
		</tr>
		<tr style="background-color:silver; border-color:silver;">
...
public class plainflowers
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("plainflowers.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d")))
  .setScene(new Scene()
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new plainflowers().getX3dModel();
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.plainflowers\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.plainflowers self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./plainflowers_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./plainflowers_JavaExport.x3d"; 
                String filenameX3DV = "./plainflowers_JavaExport.x3dv"; 
                String filenameJSON = "./plainflowers_JavaExport.json";

...
public class JinLOA3
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_JinLOA3").setName("JinLOA3").setLoa(3).setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addChild(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,35.8,-0.7076).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
        ...
        .addChild(new HAnimJoint("hanim_vl5").setName("vl5").setCenter(0.0,40.22,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_vl4").setName("vl4").setCenter(0.0,41.3,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_vl3").setName("vl3").setCenter(0.0,42.03,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
              .addChild(new HAnimSegment("hanim_l3").setName("l3")
                .addChild(new Transform().setTranslation(0.0,42.03,-0.6117)
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                      .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_vl2").setName("vl2").setCenter(0.0,42.76,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new HAnimJoint("hanim_vl1").setName("vl1").setCenter(0.0,43.52,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                  .addChild(new HAnimSegment("hanim_l1").setName("l1")
                    .addChild(new Transform().setTranslation(0.0,43.52,-0.6117)
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                          .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                  ...
                  .addChild(new HAnimJoint("hanim_vt12").setName("vt12").setCenter(0.0,44.57,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                    .addChild(new HAnimSegment("hanim_t12").setName("t12")
                      .addChild(new Transform().setTranslation(0.0,44.57,-0.6117)
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                            .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                    ...
                    .addChild(new HAnimJoint("hanim_vt11").setName("vt11").setCenter(0.0,45.61,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                      .addChild(new HAnimSegment("hanim_t11").setName("t11")
                        .addChild(new Transform().setTranslation(0.0,45.61,-0.6117)
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                              .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_vt10").setName("vt10").setCenter(0.0,46.37,-0.6127).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                        .addChild(new HAnimSegment("hanim_t10").setName("t10")
                          .addChild(new Transform().setTranslation(0.0,46.37,-0.6127)
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_vt9").setName("vt9").setCenter(0.0,47.03,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                          .addChild(new HAnimSegment("hanim_t9").setName("t9")
                            .addChild(new Transform().setTranslation(0.0,47.03,-0.6117)
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                  .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_vt8").setName("vt8").setCenter(0.0,47.68,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                            .addChild(new HAnimSegment("hanim_t8").setName("t8")
                              .addChild(new Transform().setTranslation(0.0,47.68,-0.6117)
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_vt7").setName("vt7").setCenter(0.0,48.37,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                              .addChild(new HAnimSegment("hanim_t7").setName("t7")
                                .addChild(new Transform().setTranslation(0.0,48.37,-0.6117)
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                      .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_vt6").setName("vt6").setCenter(0.0,48.95,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                .addChild(new HAnimSegment("hanim_t6").setName("t6")
                                  .addChild(new Transform().setTranslation(0.0,48.95,-0.6117)
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                        .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                ...
                                .addChild(new HAnimJoint("hanim_vt5").setName("vt5").setCenter(0.0,49.64,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                  .addChild(new HAnimSegment("hanim_t5").setName("t5")
                                    .addChild(new Transform().setTranslation(0.0,49.64,-0.6117)
                                      .addChild(new Shape()
                                        .setAppearance(new Appearance()
                                          .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                          .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt4").setName("vt4").setCenter(0.0,50.31,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                    .addChild(new HAnimSegment("hanim_t4").setName("t4")
                                      .addChild(new Transform().setTranslation(0.0,50.31,-0.6117)
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                            .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt3").setName("vt3").setCenter(0.0,51.13,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                      .addChild(new HAnimSegment("hanim_t3").setName("t3")
                                        .addChild(new Transform().setTranslation(0.0,51.13,-0.6117)
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                              .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt2").setName("vt2").setCenter(0.0,52.23,-0.6127).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                        .addChild(new HAnimSegment("hanim_t2").setName("t2")
                                          .addChild(new Transform().setTranslation(0.0,52.23,-0.6127)
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt1").setName("vt1").setCenter(0.0,53.29,-0.6117).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                          .addChild(new HAnimSegment("hanim_t1").setName("t1")
                                            .addChild(new Transform().setTranslation(0.0,53.29,-0.6117)
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                          ...
                                          .addChild(new HAnimJoint("hanim_vc7").setName("vc7").setCenter(0.0,54.45,-0.6695).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                            .addChild(new HAnimSegment("hanim_c7").setName("c7")
                                              .addChild(new Transform().setTranslation(0.0,54.45,-0.6695)
                                                .addChild(new Shape()
                                                  .setAppearance(new Appearance()
                                                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                            ...
                                            .addChild(new HAnimJoint("hanim_vc6").setName("vc6").setCenter(0.0,54.98,-0.6695).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                              .addChild(new HAnimSegment("hanim_c6").setName("c6")
                                                .addChild(new Transform().setTranslation(0.0,54.98,-0.6695)
                                                  .addChild(new Shape()
                                                    .setAppearance(new Appearance()
                                                      .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                      .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                              ...
                                              .addChild(new HAnimJoint("hanim_vc5").setName("vc5").setCenter(0.0,55.54,-0.6695).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                .addChild(new HAnimSegment("hanim_c5").setName("c5")
                                                  .addChild(new Transform().setTranslation(0.0,55.54,-0.6695)
                                                    .addChild(new Shape()
                                                      .setAppearance(new Appearance()
                                                        .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                        .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                ...
                                                .addChild(new HAnimJoint("hanim_vc4").setName("vc4").setCenter(0.0,56.08,-0.6695).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                  .addChild(new HAnimSegment("hanim_c4").setName("c4")
                                                    .addChild(new Transform().setTranslation(0.0,56.08,-0.6695)
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc3").setName("vc3").setCenter(0.0,56.66,-0.6695).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                    .addChild(new HAnimSegment("hanim_c3").setName("c3")
                                                      .addChild(new Transform().setTranslation(0.0,56.66,-0.6695)
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc2").setName("vc2").setCenter(0.0,57.17,-0.6695).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_c2").setName("c2")
                                                        .addChild(new Transform().setTranslation(0.0,57.17,-0.6695)
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc1").setName("vc1").setCenter(0.0,57.69,-0.6695).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_c1").setName("c1")
                                                          .addChild(new Transform().setTranslation(0.0,57.69,-0.6695)
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_skullbase").setName("skullbase").setCenter(0.0,57.43,-0.6863).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_eyelid_joint").setName("l_eyelid_joint").setCenter(2.245,62.4,1.464).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                            .addChild(new HAnimSegment("hanim_l_eyelid").setName("l_eyelid")
                                                              .addChild(new Transform().setRotation(1.0,0.0,0.0,-0.5236).setTranslation(2.245,62.4,1.464)
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(new int[] {0,1,25,-1,25,24,0,-1,2,26,25,-1,25,1,2,-1,2,3,8,-1,8,26,2,-1,10,27,9,-1,9,4,10,-1,10,0,24,-1,24,27,10,-1,1,0,12,-1,12,13,1,-1,2,1,13,-1,13,14,2,-1,3,2,14,-1,14,15,3,-1,10,4,16,-1,16,22,10,-1,5,6,18,-1,18,17,5,-1,6,7,19,-1,19,18,6,-1,7,8,20,-1,20,19,7,-1,9,11,23,-1,23,21,9,-1,8,3,15,-1,15,20,8,-1,4,9,21,-1,21,16,4,-1,0,10,22,-1,22,12,0,-1,11,5,17,-1,17,23,11,-1,6,5,24,-1,24,25,6,-1,7,6,25,-1,25,26,7,-1,5,11,27,-1,27,24,5,-1,27,11,9,-1,8,7,26,-1}).setTexCoordIndex(new int[] {0,1,2,-1,2,3,0,-1,4,5,2,-1,2,1,4,-1,4,6,7,-1,7,5,4,-1,9,10,11,-1,11,8,9,-1,9,0,3,-1,3,10,9,-1,1,0,12,-1,12,13,1,-1,4,1,13,-1,13,14,4,-1,6,4,14,-1,14,15,6,-1,9,8,16,-1,16,17,9,-1,18,19,20,-1,20,21,18,-1,19,22,23,-1,23,20,19,-1,22,7,24,-1,24,23,22,-1,11,25,26,-1,26,27,11,-1,7,6,15,-1,15,24,7,-1,8,11,27,-1,27,16,8,-1,0,9,17,-1,17,12,0,-1,25,18,21,-1,21,26,25,-1,19,18,3,-1,3,2,19,-1,22,19,2,-1,2,5,22,-1,18,25,10,-1,10,3,18,-1,10,25,11,-1,7,22,5,-1})
                                                                    .setCoord(new Coordinate().setPoint(new MFVec3f(new double[] {0
    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.3562,0.7836,0.3424,0.7815,0.3432,0.7614,0.3553,0.7628,0.3328,0.7723,0.3344,0.7557,0.3248,0.7567,0.3294,0.7475,0.3666,0.7703,0.3614,0.7771,0.3598,0.7618,0.364,0.76,0.3542,0.784,0.3411,0.7782,0.3327,0.7703,0.3246,0.7567,0.3657,0.7703,0.3598,0.7771,0.3534,0.7431,0.3436,0.742,0.3428,0.7423,0.3522,0.7429,0.335,0.743,0.3345,0.743,0.3291,0.7475,0.3576,0.7438,0.3566,0.7438,0.3632,0.7603}))))))))
                                                          .addChild(new HAnimJoint("hanim_l_eyeball_joint").setName("l_eyeball_joint").setCenter(2.139,61.53,3.691).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                            .addChild(new HAnimSegment("hanim_l_eyeball").setName("l_eyeball")
                                                              .addChild(new Transform().setTranslation(2.139,61.53,3.691)
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_eyeball_joint").setName("r_eyeball_joint").setCenter(-2.139,61.53,3.691).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                              ...
                                                              .addChild(new Transform().setTranslation(-2.139,61.53,3.691)
                                                                .addChild(new Shape()
                                                                  ...
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(new int[] {1,11,16,-1,16,6,1,-1,0,10,11,-1,11,1,0,-1,8,18,19,-1,19,9,8,-1,2,12,18,-1,18,8,2,-1,3,13,10,-1,10,0,3,-1,9,19,14,-1,14,4,9,-1,5,15,12,-1,12,2,5,-1,4,14,13,-1,13,3,4,-1,6,16,17,-1,17,7,6,-1,7,17,15,-1,15,5,7,-1,11,20,21,-1,21,16,11,-1,16,21,22,-1,22,17,16,-1,17,22,23,-1,23,15,17,-1,15,23,24,-1,24,12,15,-1,12,24,25,-1,25,18,12,-1,18,25,26,-1,26,19,18,-1,19,26,27,-1,27,14,19,-1,14,27,28,-1,28,13,14,-1,13,28,29,-1,29,10,13,-1,10,29,20,-1,20,11,10,-1,6,30,1,-1,1,30,0,-1,0,30,3,-1,3,30,4,-1,4,30,9,-1,9,30,8,-1,8,30,2,-1,2,30,5,-1,5,30,7,-1,7,30,6,-1}).setTexCoordIndex(new int[] {4,14,13,-1,13,9,4,-1,3,15,14,-1,14,4,3,-1,11,17,16,-1,16,12,11,-1,5,18,17,-1,17,11,5,-1,6,6,15,-1,15,3,6,-1,12,16,19,-1,19,7,12,-1,8,20,18,-1,18,5,8,-1,7,19,21,-1,21,6,7,-1,9,13,22,-1,22,10,9,-1,10,22,20,-1,20,8,10,-1,14,23,24,-1,24,13,14,-1,13,24,25,-1,25,22,13,-1,22,25,26,-1,26,20,22,-1,20,26,27,-1,27,18,20,-1,18,27,28,-1,28,17,18,-1,17,28,29,-1,29,16,17,-1,16,29,30,-1,30,19,16,-1,19,30,31,-1,31,21,19,-1,6,31,32,-1,32,15,6,-1,15,32,23,-1,23,14,15,-1,36,40,1,-1,1,40,0,-1,0,40,33,-1,33,40,34,-1,34,40,39,-1,39,40,38,-1,38,40,2,-1,2,40,35,-1,35,40,37,-1,37,40,36,-1})
                                                                    ...
                                                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.3217,0.8278,0.3482,0.8386,0.3916,0.7984,0.3206,0.8292,0.3482,0.8386,0.3916,0.7984,0.2977,0.8092,0.309,0.8013,0.3985,0.8044,0.3868,0.8428,0.4182,0.8265,0.3778,0.7978,0.3319,0.7987,0.3868,0.8428,0.3482,0.8386,0.3206,0.8292,0.3319,0.7987,0.3778,0.7978,0.3916,0.7984,0.309,0.8013,0.3985,0.8029,0.2977,0.8092,0.4182,0.8263,0.3482,0.8386,0.3868,0.8428,0.4182,0.8265,0.3985,0.8044,0.3916,0.7984,0.3778,0.7978,0.3319,0.7987,0.309,0.8013,0.2977,0.8092,0.3206,0.8292,0.2978,0.8092,0.309,0.8013,0.3985,0.8044,0.3868,0.8428,0.4182,0.8265,0.3778,0.7978,0.3319,0.7986,0.3567,0.819}))))))))
                                                          .addChild(new HAnimJoint("hanim_l_eyebrow_joint").setName("l_eyebrow_joint").setCenter(0.9666,61.93,4.753).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                            .addChild(new HAnimSegment("hanim_l_eyebrow").setName("l_eyebrow")
                                                              .addChild(new Transform().setTranslation(0.9666,61.93,4.753)
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_eyebrow_joint").setName("r_eyebrow_joint").setCenter(-0.9666,61.93,4.753).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                              ...
                                                              .addChild(new Transform().setTranslation(-0.9666,61.93,4.753)
                                                                .addChild(new Shape()
                                                                  ...
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(new int[] {2,7,21,-1,21,20,2,-1,4,10,8,-1,8,3,4,-1,3,8,7,-1,7,2,3,-1,2,20,5,-1,5,1,2,-1,4,3,6,-1,3,2,1,-1,1,6,3,-1,5,14,12,-1,12,1,5,-1,0,11,14,-1,14,5,0,-1,6,15,13,-1,13,4,6,-1,1,12,15,-1,15,6,1,-1,8,17,16,-1,16,7,8,-1,21,7,16,-1,16,22,21,-1,9,18,11,-1,11,0,9,-1,4,13,19,-1,19,10,4,-1,10,19,17,-1,17,8,10,-1,20,21,9,-1,9,0,20,-1,5,20,0,-1,21,22,18,-1,18,9,21,-1}).setTexCoordIndex(new int[] {0,7,21,-1,21,20,0,-1,3,10,8,-1,8,1,3,-1,1,8,7,-1,7,0,1,-1,0,20,5,-1,5,4,0,-1,3,1,6,-1,1,0,4,-1,4,6,1,-1,5,12,11,-1,11,4,5,-1,2,14,12,-1,12,5,2,-1,6,16,15,-1,15,3,6,-1,4,11,16,-1,16,6,4,-1,8,17,13,-1,13,7,8,-1,21,7,13,-1,13,22,21,-1,9,18,14,-1,14,2,9,-1,3,15,19,-1,19,10,3,-1,10,19,17,-1,17,8,10,-1,20,21,9,-1,9,2,20,-1,5,20,2,-1,21,22,18,-1,18,9,21,-1})
                                                                    .setCoord(new Coordinate().setPoint(new MFVec3f(new double[] {0.3218,-0.2298,0.7043,-1.083,0.5974,0.3796,-1.096,0.4225,0.3238,-2.278,0.6308,-0.5919,-2.889,0.6602,-1.322,-0.1489,0.2892,0.6667,-2.301,0.7666,-0.6065,-1.117,0.2554,0.2024,-2.208,0.4503,-0.6419,0.2543,-0.2957,0.5866,-2.872,0.5692,-1.343,0.2774,-0.216,0.4476,-1.079,0.5765,0.1724,-2.807,0.6568,-1.386,-0.1761,0.2697,0.4332,-2.269,0.7395,-0.7309,-1.111,0.2424,0.0098,-2.17,0.434,-0.7637,0.2034,-0.285,0.3399,-2.78,0.5442,-1.406,-0.2769,0.1224,0.5591,-0.3788,-7.0E-4,0.4194,-0.3389,-0.0414,0.2053})))
                                                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.344,0.8611,0.3991,0.8726,0.2757,0.8301,0.4299,0.8749,0.3424,0.8703,0.297,0.8558,0.4,0.8788,0.3445,0.8554,0.397,0.8649,0.2794,0.8281,0.4294,0.8703,0.3456,0.8724,0.3008,0.857,0.3469,0.8565,0.2795,0.829,0.4293,0.8745,0.3996,0.8793,0.3963,0.8659,0.2847,0.831,0.4284,0.8697,0.3046,0.8466,0.3082,0.8407,0.3105,0.8417}))))))))
                                                          .addChild(new HAnimJoint("hanim_temporomandibular").setName("temporomandibular").setCenter(0.0,57.45,0.6835).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                            .addChild(new HAnimSegment("hanim_jaw").setName("jaw")
                                                              .addChild(new Transform().setTranslation(0.0,57.45,0.6835)
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                          ...
                                          .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(1.71,52.82,-0.6127).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                            ...
                                            .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(5.464,52.06,-0.5732).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                          ...
                                          .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(-1.71,52.82,-0.6127).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                              ...
                                              .addChild(new Transform().setTranslation(-1.71,52.82,-0.6127)
                                                .addChild(new Shape()
                                                  ...
                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(new int[] {9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1}).setTexCoordIndex(new int[] {9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1})
                                                    .setCoord(new Coordinate().setPoint(new MFVec3f(new double[] {
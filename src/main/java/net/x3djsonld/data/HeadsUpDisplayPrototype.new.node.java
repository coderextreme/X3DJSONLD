  ...
  .setScene(new Scene()
    .addChild(new ProtoDeclare("HeadsUpDisplay").setName("HeadsUpDisplay").setAppinfo("HeadsUpDisplay positions child geometry in screen space, movable by the user")
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Group()
          .addChild(new ProximitySensor("WhereSensor").setSize(1.0E9,1.0E9,1.0E9)
            .setIS(new IS()
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.HeadsUpDisplayPrototype self-validation test results: ");

...
public class annexdA
{
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ViewpointObject().setDescription("AnnexD01Jin").setCenterOfRotation(0.0f,1.0f,0.0f).setPosition(0.0f,35.0f,113.0f))
    .addComments("Viewpoint centerOfRotation=\"0 1 0\" description=\"AnnexD01Jin\" position=\"0 40 140\" /")

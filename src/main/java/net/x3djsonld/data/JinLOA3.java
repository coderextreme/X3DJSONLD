    ...
    .addChild(new HAnimHumanoid("hanim_JinLOA3").setName("JinLOA3").setLoa(3).setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addSkeleton(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,35.799999,-0.707600).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
        ...
        .addChild(new HAnimJoint("hanim_vl5").setName("vl5").setCenter(0.0,40.220001,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_vl4").setName("vl4").setCenter(0.0,41.299999,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_vl3").setName("vl3").setCenter(0.0,42.029999,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_vl2").setName("vl2").setCenter(0.0,42.759998,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new HAnimJoint("hanim_vl1").setName("vl1").setCenter(0.0,43.520,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                  ...
                  .addChild(new HAnimJoint("hanim_vt12").setName("vt12").setCenter(0.0,44.570,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                    ...
                    .addChild(new HAnimJoint("hanim_vt11").setName("vt11").setCenter(0.0,45.610001,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                      ...
                      .addChild(new HAnimJoint("hanim_vt10").setName("vt10").setCenter(0.0,46.369999,-0.612700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                        ...
                        .addChild(new HAnimJoint("hanim_vt9").setName("vt9").setCenter(0.0,47.029999,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                          ...
                          .addChild(new HAnimJoint("hanim_vt8").setName("vt8").setCenter(0.0,47.680,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                            ...
                            .addChild(new HAnimJoint("hanim_vt7").setName("vt7").setCenter(0.0,48.369999,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                              ...
                              .addChild(new HAnimJoint("hanim_vt6").setName("vt6").setCenter(0.0,48.950001,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                ...
                                .addChild(new HAnimJoint("hanim_vt5").setName("vt5").setCenter(0.0,49.639999,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt4").setName("vt4").setCenter(0.0,50.310001,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt3").setName("vt3").setCenter(0.0,51.130001,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt2").setName("vt2").setCenter(0.0,52.230,-0.612700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt1").setName("vt1").setCenter(0.0,53.290001,-0.611700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                          ...
                                          .addChild(new HAnimJoint("hanim_vc7").setName("vc7").setCenter(0.0,54.450001,-0.669500).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                            ...
                                            .addChild(new HAnimJoint("hanim_vc6").setName("vc6").setCenter(0.0,54.980,-0.669500).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                              ...
                                              .addChild(new HAnimJoint("hanim_vc5").setName("vc5").setCenter(0.0,55.540001,-0.669500).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                ...
                                                .addChild(new HAnimJoint("hanim_vc4").setName("vc4").setCenter(0.0,56.080002,-0.669500).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc3").setName("vc3").setCenter(0.0,56.660,-0.669500).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc2").setName("vc2").setCenter(0.0,57.169998,-0.669500).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc1").setName("vc1").setCenter(0.0,57.689999,-0.669500).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_skullbase").setName("skullbase").setCenter(0.0,57.430,-0.686300).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_eyelid_joint").setName("l_eyelid_joint").setCenter(2.245,62.400002,1.464).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_eyelid_joint").setName("r_eyelid_joint").setCenter(-2.245,62.400002,1.464).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                              ...
                                                              .addChild(new Transform().setRotation(1.0,0.0,0.0,-0.523600).setTranslation(-2.245,62.400002,1.464)
                                                                .addChild(new Shape()
                                                                  ...
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(new int[] {0,24,25,-1,25,1,0,-1,2,1,25,-1,25,26,2,-1,2,26,8,-1,8,3,2,-1,10,4,9,-1,9,27,10,-1,10,27,24,-1,24,0,10,-1,1,13,12,-1,12,0,1,-1,2,14,13,-1,13,1,2,-1,3,15,14,-1,14,2,3,-1,10,22,16,-1,16,4,10,-1,5,17,18,-1,18,6,5,-1,6,18,19,-1,19,7,6,-1,7,19,20,-1,20,8,7,-1,9,21,23,-1,23,11,9,-1,8,20,15,-1,15,3,8,-1,4,16,21,-1,21,9,4,-1,0,12,22,-1,22,10,0,-1,11,23,17,-1,17,5,11,-1,6,25,24,-1,24,5,6,-1,7,26,25,-1,25,6,7,-1,5,24,27,-1,27,11,5,-1,27,9,11,-1,8,26,7,-1}).setTexCoordIndex(new int[] {0,3,2,-1,2,1,0,-1,4,1,2,-1,2,5,4,-1,4,5,7,-1,7,6,4,-1,9,8,11,-1,11,10,9,-1,9,10,3,-1,3,0,9,-1,1,13,12,-1,12,0,1,-1,4,14,13,-1,13,1,4,-1,6,15,14,-1,14,4,6,-1,9,17,16,-1,16,8,9,-1,18,21,20,-1,20,19,18,-1,19,20,23,-1,23,22,19,-1,22,23,24,-1,24,7,22,-1,11,27,26,-1,26,25,11,-1,7,24,15,-1,15,6,7,-1,8,16,27,-1,27,11,8,-1,0,12,17,-1,17,9,0,-1,25,26,21,-1,21,18,25,-1,19,2,3,-1,3,18,19,-1,22,5,2,-1,2,19,22,-1,18,3,10,-1,10,25,18,-1,10,11,25,-1,7,5,22,-1})
                                                                    .setCoord(new Coordinate().setPoint(new MFVec3f(new double[] {-0.7812,-0.3922,2.5710,0.0916,-0.4605,3.2390,0.6939,-0.6908,3.3790,1.2010,-1.0810,3.3040,-1.4400,-0.7409,1.7410,-0.5651,-1.5380,2.3340,0.0316,-1.5600,2.7320,0.5556,-1.4560,2.9940,0.9123,-1.3100,3.1380,-1.2380,-0.9979,1.8260,-1.1250,-0.5541,2.1640,-0.8496,-1.3960,2.0610,-0.6573,-0.3994,2.3770,0.1708,-0.5443,2.9030,0.7043,-0.7411,3.0460,1.2140,-1.0810,3.1720,-1.3820,-0.7409,1.7,-0.5305,-1.5490,2.2550,0.0610,-1.5570,2.5900,0.5907,-1.4570,2.8810,0.9336,-1.3100,3.0230,-1.2260,-0.9910,1.7380,-1.0110,-0.5701,2.0420,-0.8046,-1.4,2.0150,-0.7041,-1.0150,2.4160,0.0583,-1.0310,3.0360,0.5943,-1.1390,3.1660,-0.9909,-1.0050,2.1160})))
                                                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.3562,0.7836,0.3424,0.7815,0.3432,0.7614,0.3553,0.7628,0.3328,0.7723,0.3344,0.7557,0.3248,0.7567,0.3294,0.7475,0.3666,0.7703,0.3614,0.7771,0.3598,0.7618,0.3640,0.7600,0.3542,0.7840,0.3411,0.7782,0.3327,0.7703,0.3246,0.7567,0.3657,0.7703,0.3598,0.7771,0.3534,0.7431,0.3436,0.7420,0.3428,0.7423,0.3522,0.7429,0.3350,0.7430,0.3345,0.7430,0.3291,0.7475,0.3576,0.7438,0.3566,0.7438,0.3632,0.7603}))))))))
                                                          .addChild(new HAnimJoint("hanim_l_eyeball_joint").setName("l_eyeball_joint").setCenter(2.139,61.529999,3.691).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_eyeball_joint").setName("r_eyeball_joint").setCenter(-2.139,61.529999,3.691).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                              ...
                                                              .addChild(new Transform().setTranslation(-2.139,61.529999,3.691)
                                                                .addChild(new Shape()
                                                                  ...
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(new int[] {1,11,16,-1,16,6,1,-1,0,10,11,-1,11,1,0,-1,8,18,19,-1,19,9,8,-1,2,12,18,-1,18,8,2,-1,3,13,10,-1,10,0,3,-1,9,19,14,-1,14,4,9,-1,5,15,12,-1,12,2,5,-1,4,14,13,-1,13,3,4,-1,6,16,17,-1,17,7,6,-1,7,17,15,-1,15,5,7,-1,11,20,21,-1,21,16,11,-1,16,21,22,-1,22,17,16,-1,17,22,23,-1,23,15,17,-1,15,23,24,-1,24,12,15,-1,12,24,25,-1,25,18,12,-1,18,25,26,-1,26,19,18,-1,19,26,27,-1,27,14,19,-1,14,27,28,-1,28,13,14,-1,13,28,29,-1,29,10,13,-1,10,29,20,-1,20,11,10,-1,6,30,1,-1,1,30,0,-1,0,30,3,-1,3,30,4,-1,4,30,9,-1,9,30,8,-1,8,30,2,-1,2,30,5,-1,5,30,7,-1,7,30,6,-1}).setTexCoordIndex(new int[] {4,14,13,-1,13,9,4,-1,3,15,14,-1,14,4,3,-1,11,17,16,-1,16,12,11,-1,5,18,17,-1,17,11,5,-1,6,6,15,-1,15,3,6,-1,12,16,19,-1,19,7,12,-1,8,20,18,-1,18,5,8,-1,7,19,21,-1,21,6,7,-1,9,13,22,-1,22,10,9,-1,10,22,20,-1,20,8,10,-1,14,23,24,-1,24,13,14,-1,13,24,25,-1,25,22,13,-1,22,25,26,-1,26,20,22,-1,20,26,27,-1,27,18,20,-1,18,27,28,-1,28,17,18,-1,17,28,29,-1,29,16,17,-1,16,29,30,-1,30,19,16,-1,19,30,31,-1,31,21,19,-1,6,31,32,-1,32,15,6,-1,15,32,23,-1,23,14,15,-1,36,40,1,-1,1,40,0,-1,0,40,33,-1,33,40,34,-1,34,40,39,-1,39,40,38,-1,38,40,2,-1,2,40,35,-1,35,40,37,-1,37,40,36,-1})
                                                                    ...
                                                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.3217,0.8278,0.3482,0.8386,0.3916,0.7984,0.3206,0.8292,0.3482,0.8386,0.3916,0.7984,0.2977,0.8092,0.3090,0.8013,0.3985,0.8044,0.3868,0.8428,0.4182,0.8265,0.3778,0.7978,0.3319,0.7987,0.3868,0.8428,0.3482,0.8386,0.3206,0.8292,0.3319,0.7987,0.3778,0.7978,0.3916,0.7984,0.3090,0.8013,0.3985,0.8029,0.2977,0.8092,0.4182,0.8263,0.3482,0.8386,0.3868,0.8428,0.4182,0.8265,0.3985,0.8044,0.3916,0.7984,0.3778,0.7978,0.3319,0.7987,0.3090,0.8013,0.2977,0.8092,0.3206,0.8292,0.2978,0.8092,0.3090,0.8013,0.3985,0.8044,0.3868,0.8428,0.4182,0.8265,0.3778,0.7978,0.3319,0.7986,0.3567,0.8190}))))))))
                                                          .addChild(new HAnimJoint("hanim_l_eyebrow_joint").setName("l_eyebrow_joint").setCenter(0.966600,61.930,4.753).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_eyebrow_joint").setName("r_eyebrow_joint").setCenter(-0.966600,61.930,4.753).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                              ...
                                                              .addChild(new Transform().setTranslation(-0.966600,61.930,4.753)
                                                                .addChild(new Shape()
                                                                  ...
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(new int[] {2,7,21,-1,21,20,2,-1,4,10,8,-1,8,3,4,-1,3,8,7,-1,7,2,3,-1,2,20,5,-1,5,1,2,-1,4,3,6,-1,3,2,1,-1,1,6,3,-1,5,14,12,-1,12,1,5,-1,0,11,14,-1,14,5,0,-1,6,15,13,-1,13,4,6,-1,1,12,15,-1,15,6,1,-1,8,17,16,-1,16,7,8,-1,21,7,16,-1,16,22,21,-1,9,18,11,-1,11,0,9,-1,4,13,19,-1,19,10,4,-1,10,19,17,-1,17,8,10,-1,20,21,9,-1,9,0,20,-1,5,20,0,-1,21,22,18,-1,18,9,21,-1}).setTexCoordIndex(new int[] {0,7,21,-1,21,20,0,-1,3,10,8,-1,8,1,3,-1,1,8,7,-1,7,0,1,-1,0,20,5,-1,5,4,0,-1,3,1,6,-1,1,0,4,-1,4,6,1,-1,5,12,11,-1,11,4,5,-1,2,14,12,-1,12,5,2,-1,6,16,15,-1,15,3,6,-1,4,11,16,-1,16,6,4,-1,8,17,13,-1,13,7,8,-1,21,7,13,-1,13,22,21,-1,9,18,14,-1,14,2,9,-1,3,15,19,-1,19,10,3,-1,10,19,17,-1,17,8,10,-1,20,21,9,-1,9,2,20,-1,5,20,2,-1,21,22,18,-1,18,9,21,-1})
                                                                    .setCoord(new Coordinate().setPoint(new MFVec3f(new double[] {0.3218,-0.2298,0.7043,-1.0830,0.5974,0.3796,-1.0960,0.4225,0.3238,-2.2780,0.6308,-0.5919,-2.8890,0.6602,-1.3220,-0.1489,0.2892,0.6667,-2.3010,0.7666,-0.6065,-1.1170,0.2554,0.2024,-2.2080,0.4503,-0.6419,0.2543,-0.2957,0.5866,-2.8720,0.5692,-1.3430,0.2774,-0.2160,0.4476,-1.0790,0.5765,0.1724,-2.8070,0.6568,-1.3860,-0.1761,0.2697,0.4332,-2.2690,0.7395,-0.7309,-1.1110,0.2424,0.0098,-2.1700,0.4340,-0.7637,0.2034,-0.2850,0.3399,-2.7800,0.5442,-1.4060,-0.2769,0.1224,0.5591,-0.3788,-0.0007,0.4194,-0.3389,-0.0414,0.2053})))
                                                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.3440,0.8611,0.3991,0.8726,0.2757,0.8301,0.4299,0.8749,0.3424,0.8703,0.2970,0.8558,0.4,0.8788,0.3445,0.8554,0.3970,0.8649,0.2794,0.8281,0.4294,0.8703,0.3456,0.8724,0.3008,0.8570,0.3469,0.8565,0.2795,0.8290,0.4293,0.8745,0.3996,0.8793,0.3963,0.8659,0.2847,0.8310,0.4284,0.8697,0.3046,0.8466,0.3082,0.8407,0.3105,0.8417}))))))))
                                                          .addChild(new HAnimJoint("hanim_temporomandibular").setName("temporomandibular").setCenter(0.0,57.450001,0.683500).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                          ...
                                          .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(1.710,52.820,-0.612700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                            ...
                                            .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(5.464,52.060001,-0.573200).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                          ...
                                          .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(-1.710,52.820,-0.612700).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                              ...
                                              .addChild(new Transform().setTranslation(-1.710,52.820,-0.612700)
                                                .addChild(new Shape()
                                                  ...
                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(new int[] {9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1}).setTexCoordIndex(new int[] {9,0,1,-1,1,6,9,-1,6,1,2,-1,2,5,6,-1,8,5,2,-1,2,3,8,-1,8,3,4,-1,4,7,8,-1,9,7,4,-1,4,0,9,-1,4,3,2,-1,0,4,2,-1,1,0,2,-1,10,14,13,-1,10,13,12,-1,11,10,12,-1,6,10,11,-1,11,9,6,-1,9,11,12,-1,12,7,9,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,5,8,-1,5,14,10,-1,10,6,5,-1})
                                                    .setCoord(new Coordinate().setPoint(new MFVec3f(new double[] {-4.9900,0.1040,-0.8644,-5.0730,0.4993,0.0470,-4.7060,0.1695,1.1980,-4.6310,-1.8190,1.1040,-4.5860,-1.6480,-0.1248,-3.3760,0.3884,1.7710,-3.8910,0.9890,-0.0537,-4.1930,-2.4900,-0.5713,-4.3880,-2.4900,1.4290,-3.7610,0.3238,-1.6920,0.1237,0.6312,-0.1883,0.1237,0.3007,-0.9426,0.1237,-1.4180,-0.2577,0.1237,-1.3920,0.6264,0.1237,0.2586,0.8179})))
                                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.1911,0.4797,0.1710,0.4832,0.1497,0.4806,0.1519,0.4334,0.1831,0.4416,0.1474,0.4856,0.1708,0.4854,0.1784,0.4249,0.1538,0.4251,0.1963,0.4863,0.1900,0.5091,0.1847,0.4990,0.1720,0.4382,0.1568,0.4457,0.1409,0.4926})))))))
                                            .addChild(new HAnimJoint("hanim_r_acromioclavicular").setName("r_acromioclavicular").setCenter(-5.464,52.060001,-0.573200).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})

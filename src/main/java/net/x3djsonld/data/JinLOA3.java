 ...
 * <p> Articulated 3D game character designed with a general graphics tool, then converted into an X3D HAnim model. </p>
 <p> Related links:  source JinLOA3.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA3.x3d">JinOriginalLOA3.x3d</a> </td>
		</tr>
		<tr>
...
public class JinLOA3
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("JinOriginalLOA3.x3d"))
  ...
  .setScene(new Scene()
              ...
              .addChild(new Transform().setTranslation(0.0,41.299999,-0.611700)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_10_183_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_183_texCoordIndex())
                        ...
                        .addChild(new Transform().setTranslation(0.0,45.610001,-0.611700)
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                              .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_15_228_coordIndex()).setTexCoordIndex(getIndexedFaceSet_15_228_texCoordIndex())
                          ...
                          .addChild(new Transform().setTranslation(0.0,46.369999,-0.612700)
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_16_237_coordIndex()).setTexCoordIndex(getIndexedFaceSet_16_237_texCoordIndex())
                                .setCoord(new Coordinate().setPoint(getCoordinate_17_237_point()))
                            ...
                            .addChild(new Transform().setTranslation(0.0,47.029999,-0.611700)
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                  .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_17_246_coordIndex()).setTexCoordIndex(getIndexedFaceSet_17_246_texCoordIndex())
                                  .setCoord(new Coordinate().setPoint(getCoordinate_18_246_point()))
                              ...
                              .addChild(new Transform().setTranslation(0.0,47.680,-0.611700)
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_18_255_coordIndex()).setTexCoordIndex(getIndexedFaceSet_18_255_texCoordIndex())
                                    .setCoord(new Coordinate().setPoint(getCoordinate_19_255_point()))
                                  ...
                                  .addChild(new Transform().setTranslation(0.0,48.950001,-0.611700)
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                        .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_20_273_coordIndex()).setTexCoordIndex(getIndexedFaceSet_20_273_texCoordIndex())
                                        .setCoord(new Coordinate().setPoint(getCoordinate_21_273_point()))
                                    ...
                                    .addChild(new Transform().setTranslation(0.0,49.639999,-0.611700)
                                      .addChild(new Shape()
                                        .setAppearance(new Appearance()
                                          .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                          .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_21_282_coordIndex()).setTexCoordIndex(getIndexedFaceSet_21_282_texCoordIndex())
                                          .setCoord(new Coordinate().setPoint(getCoordinate_22_282_point()))
                                      ...
                                      .addChild(new Transform().setTranslation(0.0,50.310001,-0.611700)
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                            .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_22_291_coordIndex()).setTexCoordIndex(getIndexedFaceSet_22_291_texCoordIndex())
                                            .setCoord(new Coordinate().setPoint(getCoordinate_23_291_point()))
                                        ...
                                        .addChild(new Transform().setTranslation(0.0,51.130001,-0.611700)
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                              .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_23_300_coordIndex()).setTexCoordIndex(getIndexedFaceSet_23_300_texCoordIndex())
                                              .setCoord(new Coordinate().setPoint(getCoordinate_24_300_point()))
                                              .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_24_301_point()))))))
                                          ...
                                          .addChild(new Transform().setTranslation(0.0,52.230,-0.612700)
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_24_309_coordIndex()).setTexCoordIndex(getIndexedFaceSet_24_309_texCoordIndex())
                                                .setCoord(new Coordinate().setPoint(getCoordinate_25_309_point()))
                                                .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_25_310_point()))))))
                                            ...
                                            .addChild(new Transform().setTranslation(0.0,53.290001,-0.611700)
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_25_318_coordIndex()).setTexCoordIndex(getIndexedFaceSet_25_318_texCoordIndex())
                                                  .setCoord(new Coordinate().setPoint(getCoordinate_26_318_point()))
                                                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_26_319_point()))))))
                                              ...
                                              .addChild(new Transform().setTranslation(0.0,54.450001,-0.669500)
                                                .addChild(new Shape()
                                                  .setAppearance(new Appearance()
                                                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_26_327_coordIndex()).setTexCoordIndex(getIndexedFaceSet_26_327_texCoordIndex())
                                                    .setCoord(new Coordinate().setPoint(getCoordinate_27_327_point()))
                                                ...
                                                .addChild(new Transform().setTranslation(0.0,54.980,-0.669500)
                                                  .addChild(new Shape()
                                                    .setAppearance(new Appearance()
                                                      .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                      .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_27_336_coordIndex()).setTexCoordIndex(getIndexedFaceSet_27_336_texCoordIndex())
                                                      .setCoord(new Coordinate().setPoint(getCoordinate_28_336_point()))
                                                  ...
                                                  .addChild(new Transform().setTranslation(0.0,55.540001,-0.669500)
                                                    .addChild(new Shape()
                                                      .setAppearance(new Appearance()
                                                        .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                        .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_28_345_coordIndex()).setTexCoordIndex(getIndexedFaceSet_28_345_texCoordIndex())
                                                        .setCoord(new Coordinate().setPoint(getCoordinate_29_345_point()))
                                                    ...
                                                    .addChild(new Transform().setTranslation(0.0,56.080002,-0.669500)
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_29_354_coordIndex()).setTexCoordIndex(getIndexedFaceSet_29_354_texCoordIndex())
                                                          .setCoord(new Coordinate().setPoint(getCoordinate_30_354_point()))
                                                      ...
                                                      .addChild(new Transform().setTranslation(0.0,56.660,-0.669500)
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_30_363_coordIndex()).setTexCoordIndex(getIndexedFaceSet_30_363_texCoordIndex())
                                                            .setCoord(new Coordinate().setPoint(getCoordinate_31_363_point()))
                                                        ...
                                                        .addChild(new Transform().setTranslation(0.0,57.169998,-0.669500)
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_31_372_coordIndex()).setTexCoordIndex(getIndexedFaceSet_31_372_texCoordIndex())
                                                              .setCoord(new Coordinate().setPoint(getCoordinate_32_372_point()))
                                                          ...
                                                          .addChild(new Transform().setTranslation(0.0,57.689999,-0.669500)
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_32_381_coordIndex()).setTexCoordIndex(getIndexedFaceSet_32_381_texCoordIndex())
                                                                .setCoord(new Coordinate().setPoint(getCoordinate_33_381_point()))
                                                            ...
                                                            .addChild(new Transform().setTranslation(0.0,57.430,-0.686300)
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_33_390_coordIndex()).setTexCoordIndex(getIndexedFaceSet_33_390_texCoordIndex())
                                                                  .setCoord(new Coordinate().setPoint(getCoordinate_34_390_point()))
                                                                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_34_391_point()))))))
                                                      ...
                                                      .addChild(new Transform().setTranslation(7.899,31.430,-0.380900)
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_30_513_coordIndex()).setTexCoordIndex(getIndexedFaceSet_30_513_texCoordIndex())
                                                            .setCoord(new Coordinate().setPoint(getCoordinate_31_513_point()))
                                                      ...
                                                      .addChild(new Transform().setTranslation(-7.899,31.430,-0.380900)
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_30_753_coordIndex()).setTexCoordIndex(getIndexedFaceSet_30_753_texCoordIndex())
                                                            .setCoord(new Coordinate().setPoint(getCoordinate_31_753_point()))
                                                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.4538,0.6821,0.4536,0.6827,0.4366,0.6851,0.4365,0.6843,0.4719,0.6661,0.4711,0.6637,0.4639,0.6700,0.4606,0.6487,0.4605,0.6507,0.4603,0.6538,0.4606,0.6529,0.4117,0.6708,0.4117,0.6714,0.4055,0.6612,0.4047,0.6602,0.4025,0.6505,0.4027,0.6493,0.4177,0.6589,0.4355,0.6719,0.4310,0.6469,0.4157,0.6482,0.4140,0.6419,0.4289,0.6406,0.4346,0.6727,0.4316,0.6601,0.4169,0.6604,0.4607,0.6543,0.4504,0.6593,0.4308,0.6489,0.4498,0.6605,0.4482,0.6491,0.4143,0.6427,0.4297,0.6411,0.4754,0.6565,0.4752,0.6543,0.4024,0.6436,0.4026,0.6446,0.4463,0.6407,0.4467,0.6399,0.4164,0.6496,0.4190,0.6831,0.4192,0.6825,0.4346,0.6583,0.4478,0.6470,0.4591,0.6409,0.4581,0.6741,0.4578,0.6416,0.4616,0.6733,0.4549,0.6767,0.4550,0.6762,0.4365,0.6779,0.4176,0.6767,0.4177,0.6762,0.4368,0.6768,0.4600,0.6628})))))))
	...
	// end of initialize() method
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_15_228_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_15_228_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_16_237_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_16_237_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_17_246_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_17_246_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_18_255_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_18_255_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_20_273_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_20_273_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_21_282_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_21_282_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_22_291_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_22_291_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_23_300_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_23_300_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_24_309_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_24_309_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_25_318_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_25_318_texCoordIndex_1()
		{
		...
		private double[] getTextureCoordinate_26_319_point_1()
		{
		...
		private double[] getTextureCoordinate_26_319_point_2()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_26_327_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_26_327_texCoordIndex_1()
		{
			int[] value = {5,6,33,-1,33,28,5,-1,34,32,1,-1,1,7,34,-1,30,34,7,-1,7,8,30,-1,28,29,11,-1,11,5,28,-1,29,35,10,-1,10,11,29,-1,14,15,16,-1,16,17,18,-1,18,19,20,-1,16,18,20,-1,20,21,22,-1,22,23,12,-1,20,22,12,-1,16,20,12,-1,14,16,12,-1,13,14,12,-1,1,0,13,-1,13,12,1,-1,0,2,14,-1,14,13,0,-1,2,3,15,-1,15,14,2,-1,3,4,16,-1,16,15,3,-1,4,6,17,-1,17,16,4,-1,6,5,18,-1,18,17,6,-1,5,11,19,-1,19,18,5,-1,11,10,20,-1,20,19,11,-1,10,9,21,-1,
10,6,27,-1,27,26,10,-1,6,7,28,-1,28,27,6,-1,7,11,29,-1,29,28,7,-1,11,5,30,-1,30,29,11,-1,5,4,31,-1,31,30,5,-1,4,9,32,-1,32,31,4,-1,9,3,33,-1,33,32,9,-1,3,2,34,-1,34,33,3,-1,2,1,35,-1,35,34,2,-1,1,0,24,-1,24,35,1,-1,20,12,37,-1,37,36,20,-1,12,13,38,-1,38,37,12,-1,13,14,39,-1,39,38,13,-1,14,15,40,-1,40,39,14,-1,15,21,41,-1,41,40,15,-1,21,16,42,-1,42,41,21,-1,16,17,43,-1,43,42,16,-1,17,23,44,-1,44,43,17,-1,23,19,45,-1,45,44,23,-1,19,18,46,-1,46,45,19,-1,18,22,47,-1,47,46,18,-1,22,20,36,-1,36,47,22,-1};
			return value;
		}
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_32_381_texCoordIndex_1()
		{
			int[] value = {8,0,12,-1,12,20,8,-1,0,1,13,-1,13,12,0,-1,1,2,14,-1,14,13,1,-1,2,3,15,-1,15,14,2,-1,3,9,21,-1,21,15,3,-1,7,6,18,-1,18,19,7,-1,11,7,19,-1,19,23,11,-1,9,4,16,-1,16,21,9,-1,10,8,20,-1,20,22,10,-1,6,10,22,-1,22,18,6,-1,4,5,17,-1,17,16,4,-1,5,11,23,-1,23,17,5,-1,26,27,28,-1,28,29,30,-1,30,31,32,-1,28,30,32,-1,32,33,34,-1,34,35,24,-1,32,34,24,-1,28,32,24,-1,26,28,24,-1,25,26,24,-1,38,39,40,-1,40,41,42,-1,42,43,44,-1,40,42,44,-1,44,45,46,-1,46,47,36,-1,44,46,36,-1,40,44,36,-1,38,40,36,-1,37,38,36,-1,0,8,25,-1,25,24,0,-1,8,10,26,-1,26,25,8,-1,10,6,27,-1,27,26,10,-1,6,7,28,-1,28,27,6,-1,7,11,29,-1,29,28,7,-1,11,5,30,-1,30,29,11,-1,5,4,31,-1,31,30,5,-1,4,9,32,-1,32,31,4,-1,9,3,33,-1,33,32,9,-1,3,2,34,-1,34,33,3,-1,2,1,35,-1,35,34,2,-1,1,0,24,-1,24,35,1,-1,20,12,37,-1,37,36,20,-1,12,13,38,-1,38,37,12,-1,13,14,39,-1,39,38,13,-1,14,15,40,-1,40,39,14,-1,15,21,41,-1,41,40,15,-1,21,16,42,-1,42,41,21,-1,16,17,43,-1,43,42,16,-1,17,23,44,-1,44,43,17,-1,23,19,45,-1,45,44,23,-1,19,18,46,-1,46,45,19,-1,18,22,47,-1,47,46,18,-1,22,20,36,-1,36,47,22,-1};
			return value;
		}
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_33_390_coordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_33_390_coordIndex_2()
		{
		...
		private int[] getIndexedFaceSet_33_390_coordIndex_3()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_33_390_texCoordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_33_390_texCoordIndex_2()
		{
		...
		private int[] getIndexedFaceSet_33_390_texCoordIndex_3()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getCoordinate_34_390_point_1()
		{
		...
		private double[] getCoordinate_34_390_point_2()
		{
		...
		private double[] getCoordinate_34_390_point_3()
		{
		...
		private double[] getCoordinate_34_390_point_4()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_34_391_point_1()
		{
		...
		private double[] getTextureCoordinate_34_391_point_2()
		{
		...
		private double[] getTextureCoordinate_34_391_point_3()
		{
		...
		private double[] getTextureCoordinate_34_391_point_4()
		{
		...
		private double[] getTextureCoordinate_34_391_point_5()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_30_513_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_30_513_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_30_753_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_30_753_texCoordIndex_1()
		{
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #183, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #183, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #192, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #192, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #201, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #201, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_13_201_point = new MFVec3f(new double[] {3.7100,0.7770,2.6480,4.8180,0.7770,-0.5615,5.1280,0.7770,1.3210,1.2930,0.7770,-2.5950,3.5930,0.7770,-1.6960,1.2810,0.7770,3.0920,3.8740,0.0063,3.0200,1.3670,0.0063,-3.0280,3.7100,0.0063,-2.0510,4.9870,0.0063,-0.7054,1.4040,0.0063,3.5170,5.3530,0.0063,1.4750,-1.2930,0.7770,-2.5950,-1.3670,0.0063,-3.0280,0.0,0.0063,-3.0280,0.0,0.7770,-2.5950,-3.8740,0.0063,3.0200,-3.7100,0.7770,2.6480,-1.2810,0.7770,3.0920,-1.4040,0.0063,3.5170,-5.3530,0.0063,1.4750,-5.1280,0.7770,1.3210,-3.5930,0.7770,-1.6960,-3.7100,0.0063,-2.0510,-4.8180,0.7770,-0.5615,-4.9870,0.0063,-0.7054,0.0,0.7770,3.0920,0.0,0.0063,3.5170,1.2610,1.2310,2.8720,3.6060,1.2310,2.4420,4.8910,1.2310,1.2410,4.6120,1.2310,-0.4510,3.4730,1.2310,-1.5060,1.2510,1.2310,-2.3750,0.0,1.2310,-2.3750,-1.2510,1.2310,-2.3750,-3.4730,1.2310,-1.5060,-4.6120,1.2310,-0.4510,-4.8910,1.2310,1.2410,-3.6060,1.2310,2.4420,-1.2610,1.2310,2.8720,0.0,1.2310,2.8720,3.8530,-0.3735,2.8770,1.4150,-0.3735,3.3670,0.0,-0.3735,3.3670,-1.4150,-0.3735,3.3670,-3.8530,-0.3735,2.8770,-5.2400,-0.3735,1.4280,-4.8950,-0.3735,-0.6254,-3.6680,-0.3735,-1.9190,-1.3540,-0.3735,-2.8840,0.0,-0.3735,-2.8840,1.3540,-0.3735,-2.8840,3.6680,-0.3735,-1.9190,4.8950,-0.3735,-0.6254,5.2400,-0.3735,1.4280});
			return Coordinate_13_201_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=13, element #210, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=13, element #210, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=14, element #210, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=14, element #219, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=15, element #219, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_15_228_coordIndex()
		{
			MFInt32 IndexedFaceSet_15_228_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_15_228_coordIndex_1()));
			return IndexedFaceSet_15_228_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=15, element #228, 448 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_15_228_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_15_228_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_15_228_texCoordIndex_1()));
			return IndexedFaceSet_15_228_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=16, element #228, 174 total numbers made up of 58 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_16_237_coordIndex()
		{
			MFInt32 IndexedFaceSet_16_237_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_16_237_coordIndex_1()));
			return IndexedFaceSet_16_237_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=16, element #237, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_16_237_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_16_237_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_16_237_texCoordIndex_1()));
			return IndexedFaceSet_16_237_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=17, element #237, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_17_246_coordIndex()
		{
			MFInt32 IndexedFaceSet_17_246_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_17_246_coordIndex_1()));
			return IndexedFaceSet_17_246_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=17, element #246, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_17_246_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_17_246_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_17_246_texCoordIndex_1()));
			return IndexedFaceSet_17_246_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=18, element #246, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_18_255_coordIndex()
		{
			MFInt32 IndexedFaceSet_18_255_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_18_255_coordIndex_1()));
			return IndexedFaceSet_18_255_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=18, element #255, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_18_255_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_18_255_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_18_255_texCoordIndex_1()));
			return IndexedFaceSet_18_255_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=19, element #255, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=19, element #264, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=20, element #264, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_20_273_coordIndex()
		{
			MFInt32 IndexedFaceSet_20_273_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_20_273_coordIndex_1()));
			return IndexedFaceSet_20_273_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=20, element #273, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_20_273_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_20_273_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_20_273_texCoordIndex_1()));
			return IndexedFaceSet_20_273_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=21, element #273, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_21_282_coordIndex()
		{
			MFInt32 IndexedFaceSet_21_282_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_21_282_coordIndex_1()));
			return IndexedFaceSet_21_282_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=21, element #282, 432 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_21_282_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_21_282_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_21_282_texCoordIndex_1()));
			return IndexedFaceSet_21_282_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=22, element #282, 168 total numbers made up of 56 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_22_291_coordIndex()
		{
			MFInt32 IndexedFaceSet_22_291_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_22_291_coordIndex_1()));
			return IndexedFaceSet_22_291_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=22, element #291, 464 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_22_291_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_22_291_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_22_291_texCoordIndex_1()));
			return IndexedFaceSet_22_291_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=23, element #291, 180 total numbers made up of 60 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_23_300_coordIndex()
		{
			MFInt32 IndexedFaceSet_23_300_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_23_300_coordIndex_1()));
			return IndexedFaceSet_23_300_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=23, element #300, 448 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_23_300_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_23_300_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_23_300_texCoordIndex_1()));
			return IndexedFaceSet_23_300_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=24, element #300, 198 total numbers made up of 66 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_24_309_coordIndex()
		{
			MFInt32 IndexedFaceSet_24_309_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_24_309_coordIndex_1()));
			return IndexedFaceSet_24_309_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=24, element #309, 440 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_24_309_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_24_309_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_24_309_texCoordIndex_1()));
			return IndexedFaceSet_24_309_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=25, element #309, 198 total numbers made up of 66 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_25_318_coordIndex()
		{
			MFInt32 IndexedFaceSet_25_318_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_25_318_coordIndex_1()));
			return IndexedFaceSet_25_318_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=25, element #318, 720 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_25_318_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_25_318_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_25_318_texCoordIndex_1()));
			return IndexedFaceSet_25_318_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=26, element #318, 276 total numbers made up of 92 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_26_319_point()
		{
			MFVec2f TextureCoordinate_26_319_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_26_319_point_1()))
				.append(new MFVec2f(getTextureCoordinate_26_319_point_2()));
			return TextureCoordinate_26_319_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=26, element #327, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_26_327_coordIndex()
		{
			MFInt32 IndexedFaceSet_26_327_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_26_327_coordIndex_1()));
			return IndexedFaceSet_26_327_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=26, element #327, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_26_327_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_26_327_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_26_327_texCoordIndex_1()));
			return IndexedFaceSet_26_327_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=27, element #327, 144 total numbers made up of 48 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_27_336_coordIndex()
		{
			MFInt32 IndexedFaceSet_27_336_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_27_336_coordIndex_1()));
			return IndexedFaceSet_27_336_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=27, element #336, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_27_336_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_27_336_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_27_336_texCoordIndex_1()));
			return IndexedFaceSet_27_336_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=28, element #336, 144 total numbers made up of 48 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_28_345_coordIndex()
		{
			MFInt32 IndexedFaceSet_28_345_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_28_345_coordIndex_1()));
			return IndexedFaceSet_28_345_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=28, element #345, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_28_345_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_28_345_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_28_345_texCoordIndex_1()));
			return IndexedFaceSet_28_345_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=29, element #345, 144 total numbers made up of 48 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_29_354_coordIndex()
		{
			MFInt32 IndexedFaceSet_29_354_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_29_354_coordIndex_1()));
			return IndexedFaceSet_29_354_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=29, element #354, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_29_354_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_29_354_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_29_354_texCoordIndex_1()));
			return IndexedFaceSet_29_354_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=30, element #354, 144 total numbers made up of 48 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_30_363_coordIndex()
		{
			MFInt32 IndexedFaceSet_30_363_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_30_363_coordIndex_1()));
			return IndexedFaceSet_30_363_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=30, element #363, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_30_363_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_30_363_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_30_363_texCoordIndex_1()));
			return IndexedFaceSet_30_363_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=31, element #363, 144 total numbers made up of 48 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_31_372_coordIndex()
		{
			MFInt32 IndexedFaceSet_31_372_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_31_372_coordIndex_1()));
			return IndexedFaceSet_31_372_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=31, element #372, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_31_372_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_31_372_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_31_372_texCoordIndex_1()));
			return IndexedFaceSet_31_372_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=32, element #372, 144 total numbers made up of 48 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_32_381_coordIndex()
		{
			MFInt32 IndexedFaceSet_32_381_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_32_381_coordIndex_1()));
			return IndexedFaceSet_32_381_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=32, element #381, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_32_381_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_32_381_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_32_381_texCoordIndex_1()));
			return IndexedFaceSet_32_381_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=33, element #381, 144 total numbers made up of 48 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_33_390_coordIndex()
		{
			MFInt32 IndexedFaceSet_33_390_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_33_390_coordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_33_390_coordIndex_2()))
				.append(new MFInt32(getIndexedFaceSet_33_390_coordIndex_3()));
			return IndexedFaceSet_33_390_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=33, element #390, 2480 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_33_390_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_33_390_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_33_390_texCoordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_33_390_texCoordIndex_2()))
				.append(new MFInt32(getIndexedFaceSet_33_390_texCoordIndex_3()));
			return IndexedFaceSet_33_390_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=34, element #390, 1068 total numbers made up of 356 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_34_390_point()
		{
			MFVec3f Coordinate_34_390_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_34_390_point_1()))
				.append(new MFVec3f(getCoordinate_34_390_point_2()))
				.append(new MFVec3f(getCoordinate_34_390_point_3()))
				.append(new MFVec3f(getCoordinate_34_390_point_4()));
			return Coordinate_34_390_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=34, element #391, 972 total numbers made up of 486 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_34_391_point()
		{
			MFVec2f TextureCoordinate_34_391_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_34_391_point_1()))
				.append(new MFVec2f(getTextureCoordinate_34_391_point_2()))
				.append(new MFVec2f(getTextureCoordinate_34_391_point_3()))
				.append(new MFVec2f(getTextureCoordinate_34_391_point_4()))
				.append(new MFVec2f(getTextureCoordinate_34_391_point_5()));
			return TextureCoordinate_34_391_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=30, element #513, 424 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_30_513_coordIndex()
		{
			MFInt32 IndexedFaceSet_30_513_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_30_513_coordIndex_1()));
			return IndexedFaceSet_30_513_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=30, element #513, 424 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_30_513_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_30_513_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_30_513_texCoordIndex_1()));
			return IndexedFaceSet_30_513_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=31, element #513, 165 total numbers made up of 55 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_30_753_coordIndex()
		{
			MFInt32 IndexedFaceSet_30_753_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_30_753_coordIndex_1()));
			return IndexedFaceSet_30_753_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=30, element #753, 424 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_30_753_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_30_753_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_30_753_texCoordIndex_1()));
			return IndexedFaceSet_30_753_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=31, element #753, 165 total numbers made up of 55 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_31_753_point()
		{
			MFVec3f Coordinate_31_753_point = new MFVec3f(new double[] {-0.6150,-0.6885,1.4180,0.2519,-0.7698,1.6060,-0.8940,-4.1400,1.4050,-0.2357,-4.2210,1.4720,-0.7106,-2.8480,1.5370,0.2913,-2.7950,1.5610,-0.3511,-0.9723,-1.0850,0.3320,-1.0360,-1.0830,-0.6255,-3.8200,-1.5760,-0.0760,-3.9300,-1.5870,-0.5517,-2.0550,-1.4170,0.1089,-2.1630,-1.4600,-0.0149,-3.5640,0.8660,0.0687,-3.4360,-0.8707,-0.9147,-4.1920,-0.1153,-0.2445,-4.2530,-0.1554,-0.7883,-4.0280,-0.9461,-0.1878,-4.1110,-0.9619,0.1749,-2.5580,2.3510,-0.5105,-2.7950,2.3440,0.1613,-2.2640,1.0050,-0.8473,-3.2860,-0.8304,-0.9399,-2.1700,-0.0115,-0.9790,-3.3690,-0.0520,0.4715,-0.9186,0.2017,-0.7286,-0.8328,0.1541,0.1459,-2.3650,0.1498,0.0501,-3.5750,-0.0433,-0.9690,-2.1270,0.9718,-0.9825,-3.3480,0.8866,-0.0909,-3.3830,1.5560,-0.8371,-3.1690,1.5470,-0.0410,-3.3180,-1.5680,-0.5921,-3.1940,-1.5780,0.2264,-2.3040,-0.7602,-0.8375,-2.1370,-0.8044,0.2818,0.1713,1.1870,-0.2277,0.2301,1.1790,-0.2277,0.4881,0.2572,-0.1331,0.2707,-0.6889,0.3764,0.2118,-0.6809,0.4614,0.4054,0.2565,-0.9242,-4.2410,0.7847,-0.2647,-4.3240,0.8047,0.3043,-1.5340,2.1640,-0.8425,-1.7890,2.1230,0.2010,-0.4603,1.2540,-0.3856,-0.4050,1.2480,-0.4965,-0.2830,0.2553,-0.2563,-0.4079,-0.7647,0.3314,-0.4586,-0.7580,0.3822,-0.3913,0.2697,0.4485,-1.8910,1.5200,-0.3893,-2.9360,1.5550,-0.7623,-1.1200,1.7310});
			return Coordinate_31_753_point;
		}
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.JinLOA3 self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./JinLOA3_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./JinLOA3_JavaExport.x3d"; 
                String filenameX3DV = "./JinLOA3_JavaExport.x3dv"; 
                String filenameJSON = "./JinLOA3_JavaExport.json";

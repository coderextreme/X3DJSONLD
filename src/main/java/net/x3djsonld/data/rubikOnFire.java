  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ProtoDeclareObject("anyShape").setName("anyShape")
      .setProtoInterface(new ProtoInterfaceObject()
        ...
        .addField(new fieldObject().setName("myShape").setType(fieldObject.TYPE_SFNODE).setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT)
    ...
    {
        X3DObject thisExampleX3dObject = new rubikOnFire().getX3dModel();

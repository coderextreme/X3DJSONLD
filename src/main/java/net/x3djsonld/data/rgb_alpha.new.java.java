...
public class rgb_alpha
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new Group()
      .addChild(new Transform().setTranslation(6.14221,0.0694613,-9.99451E-4)
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material())
            .setTexture(new PixelTexture("RgbOpacityCheckerboard").setImage(new int[] {2,2,4,-16776961,-65536,-65536,-16776961})))
          .setGeometry(new Box())))

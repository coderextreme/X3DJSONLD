 ...
 * <p> Simple video camera shape. </p>
 <p> Related links: Catalog page <a href="../../..CameraShapeIndex.html" target="_blank">CameraShape</a>,  source <a href="../../..CameraShape.java">CameraShape.java</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
...
public class CameraShape
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform().setScale(0.1,0.1,0.1).setTranslation(0.0,-0.165,0.02)
      .addChild(new Switch().setWhichChoice(-1)
        ...
        .addChild(new Shape()
          ...
          .setAppearance(new Appearance().setUSE("CameraAppearance")))
        .addChild(new Shape()
          .setGeometry(new IndexedFaceSet("pPipe1_0Geo").setDEF("pPipe1_0Geo").setConvex(false).setCreaseAngle(0.7854).setCoordIndex(getpPipe1_0Geo_6_30_coordIndex())
            .setCoord(new Coordinate("pPipe1GeoPoints").setPoint(getpPipe1GeoPoints_7_30_point())))
          .setAppearance(new Appearance().setUSE("CameraAppearance")))
        .addChild(new Shape()
          .setGeometry(new IndexedFaceSet("pSphere1_0Geo").setDEF("pSphere1_0Geo").setConvex(false).setCreaseAngle(0.7854).setCoordIndex(getpSphere1_0Geo_6_34_coordIndex())
	...
	// end of initialize() method
		...
		private double[] getpPipe1GeoPoints_7_30_point_1()
		{
		...
		private double[] getpPipe1GeoPoints_7_30_point_2()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=3 and $tupleSplitSize=100 for subarray position()=1 */
		private double[] getpSphere1GeoPoints_7_34_point_1()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=3 and $tupleSplitSize=100 for subarray position()=2 */
		private double[] getpSphere1GeoPoints_7_34_point_2()
		{
		...
		private double[] getpSphere1GeoPoints_7_34_point_3()
		{
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.CameraShape self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./CameraShape_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./CameraShape_JavaExport.x3d"; 
                String filenameX3DV = "./CameraShape_JavaExport.x3dv"; 
                String filenameJSON = "./CameraShape_JavaExport.json";

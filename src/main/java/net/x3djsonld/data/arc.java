 ...
 * <p> a generic proto to connect two objects. </p>
 <p> Related links:  source arc.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
...
public class arc
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("arc.x3d"))
...
""")
    ...
    .addChild(new ProtoInstance("x3dconnector", "connector1").setContainerField("children")
      .addFieldValue(new fieldValue().setName("startnode")
        .addChild(new ProtoInstance("point").setUSE("G1").setContainerField("children")))
      .addFieldValue(new fieldValue().setName("endnode")
        .addChild(new ProtoInstance("point").setUSE("G2").setContainerField("children")))
    ...
    .addChild(new ProtoInstance("x3dconnector", "connector2").setContainerField("children")
      .addFieldValue(new fieldValue().setName("startnode")
        .addChild(new ProtoInstance("point").setUSE("G1").setContainerField("children")))
      .addFieldValue(new fieldValue().setName("endnode")
        .addChild(new ProtoInstance("point").setUSE("G3").setContainerField("children")))
      .addFieldValue(new fieldValue().setName("set_startpoint"))
      .addFieldValue(new fieldValue().setName("set_endpoint")))
    .addChild(new ProtoInstance("x3dconnector", "connector3").setContainerField("children")
      .addFieldValue(new fieldValue().setName("startnode")
        .addChild(new ProtoInstance("point").setUSE("G1").setContainerField("children")))
      .addFieldValue(new fieldValue().setName("endnode")
        .addChild(new ProtoInstance("point").setUSE("G4").setContainerField("children")))
      .addFieldValue(new fieldValue().setName("set_startpoint"))
      .addFieldValue(new fieldValue().setName("set_endpoint")))
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.arc self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./arc_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./arc_JavaExport.x3d"; 
                String filenameX3DV = "./arc_JavaExport.x3dv"; 
                String filenameJSON = "./arc_JavaExport.json";

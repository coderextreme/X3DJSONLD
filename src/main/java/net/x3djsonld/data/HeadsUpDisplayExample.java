...
public class HeadsUpDisplayExample
{
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ExternProtoDeclareObject("HeadsUpDisplay").setName("HeadsUpDisplay").setAppinfo("Heads-up display (HUD) keeps child geometry aligned on screen in a consistent location").setUrl(new String[] {"HeadsUpDisplayPrototype.x3d#HeadsUpDisplay","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/HeadsUpDisplayPrototype.x3d#HeadsUpDisplay","HeadsUpDisplayPrototype.wrl#HeadsUpDisplay","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/HeadsUpDisplayPrototype.wrl#HeadsUpDisplay"})
      .addField(new fieldObject().setName("screenOffset").setType(fieldObject.TYPE_SFVEC3F).setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("offset position for HUD relative to current view location, default 0 0 -5"))
      .addField(new fieldObject().setName("children").setType(fieldObject.TYPE_MFNODE).setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("X3D content positioned at HUD offset"))
      .addField(new fieldObject().setName("position_changed").setType(fieldObject.TYPE_SFVEC3F).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("HUD position update (in world coordinates) relative to original location"))
      .addField(new fieldObject().setName("orientation_changed").setType(fieldObject.TYPE_SFROTATION).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("HUD orientation update relative to original location")))
    .addChild(new BackgroundObject("SandyShallowBottom").setGroundAngle(new float[] {0.05f,1.52f,1.56f,1.5707f}).setGroundColor(new MFColorObject(new float[] {0.2f,0.2f,0.0f,0.3f,0.3f,0.0f,0.5f,0.5f,0.3f,0.1f,0.3f,0.4f,0.0f,0.2f,0.4f})).setSkyAngle(new float[] {0.04f,0.05f,0.1f,1.309f,1.570f}).setSkyColor(new MFColorObject(new float[] {0.8f,0.8f,0.2f,0.8f,0.8f,0.2f,0.1f,0.1f,0.6f,0.1f,0.1f,0.6f,0.1f,0.25f,0.8f,0.6f,0.6f,0.9f})))
    ...
    .addChild(new ProtoInstanceObject("HeadsUpDisplay", "HeadsUpDisplayInstance")
      .addComments(" example: upper left-hand corner of screen (x=-2, y=1) and set back z=-5 from user view ")
      .addFieldValue(new fieldValueObject().setName("screenOffset").setValue(new SFVec3fObject(-0.75f,1.0f,-5.0f)))
      .addFieldValue(new fieldValueObject().setName("children")
        .addChild(new ShapeObject()
          .setGeometry(new TextObject().setString(new String[] {"HUD text stays fixed","while user navigates"})
    ...
    .addChild(new InlineObject().setUrl(new String[] {"../HelloWorld.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/HelloWorld.x3d","../HelloWorld.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/HelloWorld.wrl"})));
    }
    ...
    {
        X3DObject thisExampleX3dObject = new HeadsUpDisplayExample().getX3dModel();

...
public class KoreanCharacter07No
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_No").setName("No").setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addChild(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,34.79,-1.299).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})

...
public class MFString
{
  ...
  .setScene(new SceneObject()
    .addChild(new TransformObject("F16Transform")
      .addChild(new TransformObject("MainFrameTransform").setScale(new SFVec3fObject(new float[] {3.0f,3.0f,3.0f}))
        .addChild(new ShapeObject("Nose")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(new SFColorObject(new float[] {.25f,.25f,.25f}))))
        ...
        .addChild(new ShapeObject("Canopy")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(new SFColorObject(new float[] {.25f,.25f,.25f})).setTransparency(0.8f)))
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setNormalIndex(new int[] {2,22,23,-1,24,22,2,-1,25,26,27,-1,28,26,25,-1,29,29,29,-1,27,26,30,-1,2,31,32,-1,23,31,2,-1,33,27,30,34,-1,34,30,35,36,-1,23,33,34,31,-1,31,34,36,32,-1,24,37,38,22,-1,22,38,33,23,-1,37,28,25,38,-1,38,25,27,33,-1}).setCoordIndex(new int[] {2,32,33,-1,34,32,2,-1,35,36,37,-1,38,36,35,-1,39,40,41,-1,37,36,42,-1,2,43,44,-1,33,43,2,-1,45,37,42,46,-1,46,42,47,48,-1,33,45,46,43,-1,43,46,48,44,-1,34,49,50,32,-1,32,50,45,33,-1,49,38,35,50,-1,50,35,37,45,-1})
        ...
        .addChild(new ShapeObject("ExhaustExitFlatPanel")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(new SFColorObject(new float[] {.5f,.5f,.5f}))))
        ...
        .addChild(new ShapeObject("ExhaustEntranceFrontBottomPart")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(new SFColorObject(new float[] {.2304f,.2304f,.2304f}))))
        ...
        .addChild(new ShapeObject("ThirdPartFromNoseUnderCanopy")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(new SFColorObject(new float[] {.6f,.6f,.6f}))))
        ...
        .addChild(new ShapeObject("RearExhaustExitPartLastPartOfMainBody")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(new SFColorObject(new float[] {.37f,.37f,.37f})).setShininess(.5f)))
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setNormalIndex(new int[] {50,118,125,107,-1,130,130,130,130,-1,124,123,91,94,-1,123,122,75,91,-1,73,75,122,121,-1,74,73,121,120,-1,49,119,118,50,-1,131,131,131,131,-1}).setCoordIndex(new int[] {64,186,193,165,-1,203,204,164,163,-1,192,191,138,142,-1,191,190,96,138,-1,94,96,190,189,-1,95,94,189,188,-1,63,187,186,64,-1,62,61,205,206,-1})
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector"))))
        .addChild(new ShapeObject("WingsAndTail")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setEmissiveColor(new SFColorObject(new float[] {.1796f,.1914f,.2382f}))))
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setColorPerVertex(false).setSolid(false).setNormalIndex(new int[] {50,118,125,107,-1,130,130,130,130,-1,124,123,91,94,-1,123,122,75,91,-1,73,75,122,121,-1,74,73,121,120,-1,49,119,118,50,-1,131,131,131,131,-1}).setCoordIndex(new int[] {6,7,8,9,-1,9,8,7,6,-1,20,21,22,23,-1,23,22,21,20,-1,97,20,23,98,99,-1,99,98,23,20,97,-1,108,109,110,111,-1,111,110,109,108,-1,112,113,114,115,-1,115,114,113,112,-1,132,6,9,133,134,-1,134,133,9,6,132,-1,86,139,140,67,-1,67,140,139,86,-1,143,144,145,146,-1,146,145,144,143,-1,177,178,179,-1,179,178,177,-1,178,180,181,182,183,179,-1,179,183,182,181,180,178,-1,182,184,183,-1,183,184,182,-1,177,178,179,-1,179,178,177,-1,178,180,181,182,183,179,-1,179,183,182,181,180,178,-1,182,184,183,-1,183,184,182,-1})
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector"))))
        .addChild(new ShapeObject("SecondPartAfterNose")
          ...
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new int[] {0,1,2,3,-1,4,5,1,0,-1,10,11,12,13,-1,14,15,5,4,-1,13,12,15,14,-1,16,17,11,10,-1,18,19,17,16,-1,3,2,19,18,-1}).setNormalIndex(new int[] {0,1,2,3,-1,4,5,1,0,-1,6,7,8,9,-1,10,11,5,4,-1,9,8,11,10,-1,12,13,7,6,-1,14,15,13,12,-1,3,2,15,14,-1})
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector")))))
      .addChild(new TransformObject("CockpitTransform").setTranslation(new SFVec3fObject(new float[] {0.0f,1.0f,-10.0f})).setScale(new SFVec3fObject(new float[] {0.045f,0.045f,0.045f})).setRotation(new SFRotationObject(new float[] {1.0f,0.0f,0.0f,-0.1f}))
      ...
      .addChild(new TransformObject("SeatTransform").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,-0.1f})).setTranslation(new SFVec3fObject(new float[] {0.0f,0.0f,-8.3f})).setScale(new SFVec3fObject(new float[] {0.9f,0.9f,0.9f}))
      ...
      .addChild(new TransformObject("FrontWheelTransform").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,1.92f})).setCenter(new SFVec3fObject(new float[] {0.0f,2.5f,0.0f})).setTranslation(new SFVec3fObject(new float[] {0.7f,-5.2f,-6.5f}))
      ...
      .addChild(new TransformObject("RearLeftWheelTransform").setTranslation(new SFVec3fObject(new float[] {-2.95f,-5.0f,7.0f})).setCenter(new SFVec3fObject(new float[] {0.0f,2.5f,0.0f})).setRotation(new SFRotationObject(new float[] {1.0f,0.0f,1.0f,1.92f}))
      ...
      .addChild(new TransformObject("RearRightWheelTransform").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,-1.0f,1.92f})).setCenter(new SFVec3fObject(new float[] {0.0f,2.5f,0.0f})).setTranslation(new SFVec3fObject(new float[] {2.95f,-5.0f,7.0f}))
        .addComments(" Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel) ")
      ...
      .addChild(new TransformObject("CockpitButtonsTransform")
        .addChild(new TransformObject("UpButtonTransform").setTranslation(new SFVec3fObject(new float[] {-0.95f,1.05f,-10.0f})).setScale(new SFVec3fObject(new float[] {.008f,.008f,.008f})).setRotation(new SFRotationObject(new float[] {1.0f,0.0f,0.0f,1.57f}))
          .addChild(new ShapeObject()
            .setGeometry(new CylinderObject().setHeight(1f).setRadius(4f))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setShininess(.8f).setDiffuseColor(new SFColorObject(new float[] {1.0f,0.0f,0.0f})))))
          .addChild(new TouchSensorObject("TouchSensorUp").setDescription("click for gears up")))
        .addChild(new TransformObject("DownButtonTransform").setTranslation(new SFVec3fObject(new float[] {-0.83f,1.05f,-10.0f})).setScale(new SFVec3fObject(new float[] {.008f,.008f,.008f})).setRotation(new SFRotationObject(new float[] {1.0f,0.0f,0.0f,1.57f}))
          .addChild(new ShapeObject()
            .setGeometry(new CylinderObject().setHeight(1f).setRadius(4f))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setShininess(.8f).setDiffuseColor(new SFColorObject(new float[] {1.0f,1.0f,0.0f})))))
          .addChild(new TouchSensorObject("TouchSensorDown").setDescription("click for gears down")))
        .addChild(new TransformObject("GearUpTextTransform").setTranslation(new SFVec3fObject(new float[] {-.65f,1.55f,-10.0f})).setScale(new SFVec3fObject(new float[] {.06f,.06f,.06f}))
          .addChild(new ShapeObject()
        ...
        .addChild(new TransformObject("GearDownTextTransform").setTranslation(new SFVec3fObject(new float[] {-.65f,1.35f,-10.0f})).setScale(new SFVec3fObject(new float[] {.06f,.06f,.06f}))
          .addChild(new ShapeObject()
            .setGeometry(new TextObject().setString(new MFStringObject("\"YELLOW Button\" \"Gear Down\"")).setLength(new float[] {5.5f}))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setDiffuseColor(new SFColorObject(new float[] {1.0f,1.0f,0.0f}))))))
        .addChild(new TransformObject("FireButtonTransform").setScale(new SFVec3fObject(new float[] {.008f,.008f,.008f})).setTranslation(new SFVec3fObject(new float[] {.52f,1.6f,-10.0f})).setRotation(new SFRotationObject(new float[] {1.0f,0.0f,0.0f,1.57f}))
          .addChild(new ShapeObject()
            .setGeometry(new CylinderObject().setHeight(1f).setRadius(4f))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setShininess(.8f).setDiffuseColor(new SFColorObject(new float[] {0.0f,.75f,.18f})))))
          .addChild(new TouchSensorObject("FireSensor").setDescription("click to fire")))
        .addChild(new TransformObject("FireTextTransform").setScale(new SFVec3fObject(new float[] {.06f,.06f,.06f})).setTranslation(new SFVec3fObject(new float[] {.36f,1.5f,-10.0f}))
          .addChild(new ShapeObject()
            .setGeometry(new TextObject().setString(new MFStringObject("\"Target Locked\" \"      FIRE!..\" \"(Green Button)\"")))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setDiffuseColor(new SFColorObject(new float[] {0.0f,.75f,.18f})))))))
      .addChild(new ViewpointObject().setDescription("F16 Close Look-up").setOrientation(new SFRotationObject(new float[] {-0.559f,-0.827f,-0.057f,1.3534f})).setPosition(new SFVec3fObject(new float[] {-28.7f,19.9f,17.4f})))
      .addChild(new ViewpointObject().setDescription("Cockpit").setOrientation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,0.1249f})).setPosition(new SFVec3fObject(new float[] {0.0f,1.5f,-7.9f})))
      .addChild(new ViewpointObject("LandingGearAnimationView").setDescription("Landing Gear Animation View").setOrientation(new SFRotationObject(new float[] {-0.003f,1.0f,-0.012f,2.5741f})).setPosition(new SFVec3fObject(new float[] {16.1f,-5.8f,-24.6f})))
      .addChild(new ViewpointObject().setDescription("Cockpit Left View").setOrientation(new SFRotationObject(new float[] {-0.276f,-0.922f,-0.271f,1.2338f})).setPosition(new SFVec3fObject(new float[] {-6.7f,6.1f,-3.9f})))
      .addChild(new ViewpointObject().setDescription("F-16 Front View").setOrientation(new SFRotationObject(new float[] {-0.007f,0.995f,0.102f,3.1152f})).setPosition(new SFVec3fObject(new float[] {-0.1f,13.4f,-65.0f})))
      .addChild(new ViewpointObject().setDescription("Cockpit Target View").setOrientation(new SFRotationObject(new float[] {-0.834f,-0.523f,-0.176f,0.0875f})).setPosition(new SFVec3fObject(new float[] {0.0f,2.4f,-7.9f})))
      .addChild(new TransformObject("NoseAntennaTransform").setTranslation(new SFVec3fObject(new float[] {0.0f,-.275f,-21.0f})).setRotation(new SFRotationObject(new float[] {1.0f,0.0f,0.0f,1.57f}))
        .addChild(new ShapeObject()
          .setGeometry(new CylinderObject().setRadius(.05f))
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setShininess(.5f).setDiffuseColor(new SFColorObject(new float[] {.5f,.5f,.5f})))))))
    ...
    .addChild(new TransformObject("RightmostAmraamTransform").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,1.57f})).setScale(new SFVec3fObject(new float[] {1.4f,1.4f,1.4f})).setTranslation(new SFVec3fObject(new float[] {15.65f,0.0f,4.5f}))
    ...
    .addChild(new TransformObject("LeftmostAmraamTransform").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,1.57f})).setTranslation(new SFVec3fObject(new float[] {-15.65f,0.0f,4.5f})).setScale(new SFVec3fObject(new float[] {1.4f,1.4f,1.4f}))
      .addChild(new InlineObject().setUSE("Amraam")))
    .addChild(new TransformObject("SidewinderHolderTransformRight").setRotation(new SFRotationObject(new float[] {0.0f,1.0f,0.0f,1.57f})).setScale(new SFVec3fObject(new float[] {6.0f,3.0f,3.0f})).setTranslation(new SFVec3fObject(new float[] {9.0f,-1.125f,8.0f}))
    ...
    .addChild(new TransformObject("SidewinderHolderTransformLeft").setTranslation(new SFVec3fObject(new float[] {-8.45f,-1.125f,8.0f})).setRotation(new SFRotationObject(new float[] {0.0f,1.0f,0.0f,1.57f})).setScale(new SFVec3fObject(new float[] {6.0f,3.0f,3.0f}))
      .addChild(new InlineObject().setUSE("SidewinderHolder")))
    .addChild(new TransformObject("TurkishFlagTransformLeft").setTranslation(new SFVec3fObject(new float[] {-.01f,8.0f,19.5f})).setScale(new SFVec3fObject(new float[] {.3f,.25f,.3f})).setRotation(new SFRotationObject(new float[] {0.0f,-1.0f,0.0f,1.57f}))
    ...
    .addChild(new TransformObject("TurkishFlagTransformRight").setTranslation(new SFVec3fObject(new float[] {.01f,8.0f,20.5f})).setScale(new SFVec3fObject(new float[] {.3f,.25f,.3f})).setRotation(new SFRotationObject(new float[] {0.0f,1.0f,0.0f,1.57f}))
    ...
    .addChild(new TransformObject("AmraamHolderTransformLeft").setTranslation(new SFVec3fObject(new float[] {-12.0f,-.176f,10.7f}))
    ...
    .addChild(new TransformObject("AmraamHolderTransformRight").setTranslation(new SFVec3fObject(new float[] {12.0f,-.176f,10.7f}))
      .addChild(new InlineObject().setUSE("AmraamHolder")))
    .addChild(new TransformObject("AmraamInnerTransformRight").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,1.57f})).setScale(new SFVec3fObject(new float[] {1.4f,1.4f,1.4f})).setTranslation(new SFVec3fObject(new float[] {12.0f,-1.6f,4.5f}))
      .addChild(new InlineObject().setUSE("Amraam")))
    .addChild(new TransformObject("AmraamInnerTransformLeft").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,1.57f})).setTranslation(new SFVec3fObject(new float[] {-12.0f,-1.6f,4.5f})).setScale(new SFVec3fObject(new float[] {1.4f,1.4f,1.4f}))
      .addChild(new InlineObject().setUSE("Amraam")))
    .addChild(new TransformObject("SidewinderTransformLeft").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,1.57f})).setTranslation(new SFVec3fObject(new float[] {-8.7f,-2.0f,3.5f})).setScale(new SFVec3fObject(new float[] {1.6f,1.6f,1.6f}))
    ...
    .addChild(new TransformObject("SidewinderTransformRight").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,1.57f})).setScale(new SFVec3fObject(new float[] {1.6f,1.6f,1.6f})).setTranslation(new SFVec3fObject(new float[] {8.7f,-2.0f,3.5f}))
      .addChild(new InlineObject().setUSE("Sidewinder")))
    .addChild(new TransformObject("FuelTankHolderTransformLeft").setTranslation(new SFVec3fObject(new float[] {-4.8f,-1.125f,6.0f})).setRotation(new SFRotationObject(new float[] {0.0f,1.0f,0.0f,1.57f})).setScale(new SFVec3fObject(new float[] {1.5f,1.5f,1.5f}))
    ...
    .addChild(new TransformObject("FuelTankHolderTransformRight").setRotation(new SFRotationObject(new float[] {0.0f,1.0f,0.0f,1.57f})).setScale(new SFVec3fObject(new float[] {1.5f,1.5f,1.5f})).setTranslation(new SFVec3fObject(new float[] {5.3f,-1.125f,6.0f}))
      .addChild(new InlineObject().setUSE("FuelTankHolder")))
    .addChild(new TransformObject("FuelTankTransformRight").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,1.57f})).setScale(new SFVec3fObject(new float[] {1.5f,1.5f,1.5f})).setTranslation(new SFVec3fObject(new float[] {5.0f,-2.85f,5.5f}))
    ...
    .addChild(new TransformObject("FuelTankTransformLeft").setRotation(new SFRotationObject(new float[] {-1.0f,0.0f,0.0f,1.57f})).setTranslation(new SFVec3fObject(new float[] {-5.0f,-2.85f,5.5f})).setScale(new SFVec3fObject(new float[] {1.5f,1.5f,1.5f}))
      .addChild(new InlineObject().setUSE("FuelTank")))
    .addChild(new TransformObject("InlineCoverOfPlaneTansform")
      .addChild(new ShapeObject()
        .setGeometry(new BoxObject().setSize(new SFVec3fObject(new float[] {4.15f,.1f,20.0f})))
        .setAppearance(new AppearanceObject()
          .setMaterial(new MaterialObject().setDiffuseColor(new SFColorObject(new float[] {.25f,.25f,.25f}))))))
    .addChild(new TransformObject("TargetHelicopterTransform").setTranslation(new SFVec3fObject(new float[] {16.0f,-50.0f,-500.0f}))
    ...
    .addChild(new ViewpointObject("MissileLaunchView").setDescription("Missile Fire View").setPosition(new SFVec3fObject(new float[] {-344.3f,-142.8f,-27.7f})).setOrientation(new SFRotationObject(new float[] {0.094f,-0.994f,0.057f,1.1716f})))

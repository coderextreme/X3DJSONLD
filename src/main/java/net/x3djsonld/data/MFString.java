 ...
 * <p> F-16, The Fighting Falcon, Turkish Air Force (TUAF), Turkey. </p>
 <p> Related links: <a href="../../../..MFString.java">MFString.java</a> source, <a href="../../../..MFStringIndex.html" target="_top">MFString catalog page</a>, <a href="http://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="http://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="http://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
...
public class MFString
{
  ...
  .setHead(new headObject()
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE      ).setContent("MFString.x3d"))
    .addMeta(new metaObject().setName(metaObject.NAME_DESCRIPTION).setContent("F-16, The Fighting Falcon, Turkish Air Force (TUAF), Turkey"))
    .addMeta(new metaObject().setName(metaObject.NAME_CREATOR    ).setContent("Murat ONDER, LTJG, Turkish Navy"))
    .addMeta(new metaObject().setName(metaObject.NAME_CREATOR    ).setContent("The coordinates of the main body (Except landing gears, nose antenna, flag, weapons, missile holders, cockpit, cockpit seat and fuel tanks) are mostly similar to the model of Soji Yamakawa and used with permission."))
    .addMeta(new metaObject().setName(metaObject.NAME_CREATED    ).setContent("13 July 2003"))
    .addMeta(new metaObject().setName(metaObject.NAME_MODIFIED   ).setContent("27 November 2015"))
    .addMeta(new metaObject().setName(metaObject.NAME_REFERENCE  ).setContent("http://www.fas.org/man/dod-101/sys/ac/f-16.htm"))
    .addMeta(new metaObject().setName("permission").setContent("Here is a copy of the permission for the usage of the main hull; -----Original Message----- From: Soji Yamakawa [mailto:soji@andrew.cmu.edu] Sent: Tuesday, September 16, 2003 8:00 PM To: Onder, Murat TUR Subject: Re: VRML model points usage permission Sure. No problem. Soji ----- Original Message ----- From: \"Murat Onder\" <monder@nps.navy.mil> To: <Soji_Yamakawa@cmu.edu>; <PEB01130@nifty.ne.jp> Sent: Monday, September 15, 2003 3:50 PM Subject: VRML model points usage permission Hi Sir, I&apos;m a MS student in Naval Postgraduate School. I'm making a model of Turkish F-16 for my project in a VRML course. For the main hull of the F-16, I want to use the coordinate points of your VRML model since I think that model represents well enough F-16. This is going to be only a student project and will not be used for any commercial purposes. Of course I'll make the citation and put the reference links to your page in the meta files of x3d file. I'd like to know if you can give permission to use those points in my model. V/R, Murat Onder LTJG, TU NAVY"))
    .addMeta(new metaObject().setName(metaObject.NAME_REFERENCE  ).setContent("The landing gears are taken from the Savage Archive, from F18 Blue Angel, then modified and re-animated."))
    .addMeta(new metaObject().setName(metaObject.NAME_DRAWING    ).setContent("\"Drawing.jpg\" \"../../../Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Drawing.jpg\" \"https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Drawing.jpg\""))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER ).setContent("https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/F16.x3d"))
    .addMeta(new metaObject().setName(metaObject.NAME_SUBJECT    ).setContent("F16, F-16, Fighting Falcon"))
  ...
  .setScene(new SceneObject()
    .addChild(new TransformObject("F16Transform")
      .addChild(new TransformObject("MainFrameTransform").setScale(3.0f,3.0f,3.0f)
        .addChild(new ShapeObject("Nose")
          ...
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new int[] {24,0,3,-1,4,0,24,-1,25,26,27,-1,28,25,27,-1,27,29,28,-1,27,30,29,-1,27,31,30,-1,3,18,24,-1}).setNormalIndex(new int[] {16,0,3,-1,4,0,16,-1,17,17,17,-1,18,18,18,-1,19,19,19,-1,20,20,20,-1,21,21,21,-1,3,14,16,-1})
            .setCoord(new CoordinateObject("coordinates").setPoint(getcoordinates_7_19_point()))
            .setNormal(new NormalObject("normalVector").setVector(getnormalVector_7_20_vector()))))
        .addChild(new ShapeObject("Canopy")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(.25f,.25f,.25f).setTransparency(0.8f)))
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new int[] {2,32,33,-1,34,32,2,-1,35,36,37,-1,38,36,35,-1,39,40,41,-1,37,36,42,-1,2,43,44,-1,33,43,2,-1,45,37,42,46,-1,46,42,47,48,-1,33,45,46,43,-1,43,46,48,44,-1,34,49,50,32,-1,32,50,45,33,-1,49,38,35,50,-1,50,35,37,45,-1}).setNormalIndex(new int[] {2,22,23,-1,24,22,2,-1,25,26,27,-1,28,26,25,-1,29,29,29,-1,27,26,30,-1,2,31,32,-1,23,31,2,-1,33,27,30,34,-1,34,30,35,36,-1,23,33,34,31,-1,31,34,36,32,-1,24,37,38,22,-1,22,38,33,23,-1,37,28,25,38,-1,38,25,27,33,-1})
        ...
        .addChild(new ShapeObject("MainBodyAndWingEdges")
          ...
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setCoordIndex(getIndexedFaceSet_6_31_coordIndex()).setNormalIndex(getIndexedFaceSet_6_31_normalIndex())
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector"))))
        .addChild(new ShapeObject("ExhaustExitFlatPanel")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(.5f,.5f,.5f)))
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new int[] {186,187,188,189,190,-1,190,191,192,193,186,-1}).setNormalIndex(new int[] {118,119,120,121,122,-1,122,123,124,125,118,-1})
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector"))))
        .addChild(new ShapeObject("ExhaustEntranceFrontBottomPart")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(.2304f,.2304f,.2304f)))
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new int[] {194,130,173,195,196,197,-1,197,198,199,82,81,194,-1}).setNormalIndex(new int[] {126,126,126,126,126,126,-1,126,126,126,126,126,126,-1})
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector"))))
        .addChild(new ShapeObject("ThirdPartFromNoseUnderCanopy")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(.6f,.6f,.6f)))
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new int[] {12,200,201,15,-1,19,48,127,17,-1,15,201,128,5,-1,17,127,202,11,-1,11,202,200,12,-1,5,128,49,1,-1,48,19,44,-1,19,2,44,-1,34,1,49,-1,34,2,1,-1}).setNormalIndex(new int[] {8,127,128,11,-1,15,36,83,13,-1,11,128,85,5,-1,13,83,129,7,-1,7,129,127,8,-1,5,85,37,1,-1,36,15,32,-1,15,2,32,-1,24,1,37,-1,24,2,1,-1})
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector"))))
        .addChild(new ShapeObject("RearExhaustExitPartLastPartOfMainBody")
          ...
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new int[] {64,186,193,165,-1,203,204,164,163,-1,192,191,138,142,-1,191,190,96,138,-1,94,96,190,189,-1,95,94,189,188,-1,63,187,186,64,-1,62,61,205,206,-1}).setNormalIndex(new int[] {50,118,125,107,-1,130,130,130,130,-1,124,123,91,94,-1,123,122,75,91,-1,73,75,122,121,-1,74,73,121,120,-1,49,119,118,50,-1,131,131,131,131,-1})
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector"))))
        .addChild(new ShapeObject("WingsAndTail")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setEmissiveColor(.1796f,.1914f,.2382f)))
          .setGeometry(new IndexedFaceSetObject().setColorPerVertex(false).setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new int[] {6,7,8,9,-1,9,8,7,6,-1,20,21,22,23,-1,23,22,21,20,-1,97,20,23,98,99,-1,99,98,23,20,97,-1,108,109,110,111,-1,111,110,109,108,-1,112,113,114,115,-1,115,114,113,112,-1,132,6,9,133,134,-1,134,133,9,6,132,-1,86,139,140,67,-1,67,140,139,86,-1,143,144,145,146,-1,146,145,144,143,-1,177,178,179,-1,179,178,177,-1,178,180,181,182,183,179,-1,179,183,182,181,180,178,-1,182,184,183,-1,183,184,182,-1,177,178,179,-1,179,178,177,-1,178,180,181,182,183,179,-1,179,183,182,181,180,178,-1,182,184,183,-1,183,184,182,-1}).setNormalIndex(new int[] {50,118,125,107,-1,130,130,130,130,-1,124,123,91,94,-1,123,122,75,91,-1,73,75,122,121,-1,74,73,121,120,-1,49,119,118,50,-1,131,131,131,131,-1})
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector"))))
        .addChild(new ShapeObject("SecondPartAfterNose")
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(.6f,.6f,.6f)))
          .setGeometry(new IndexedFaceSetObject().setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new int[] {0,1,2,3,-1,4,5,1,0,-1,10,11,12,13,-1,14,15,5,4,-1,13,12,15,14,-1,16,17,11,10,-1,18,19,17,16,-1,3,2,19,18,-1}).setNormalIndex(new int[] {0,1,2,3,-1,4,5,1,0,-1,6,7,8,9,-1,10,11,5,4,-1,9,8,11,10,-1,12,13,7,6,-1,14,15,13,12,-1,3,2,15,14,-1})
            .setCoord(new CoordinateObject().setUSE("coordinates"))
            .setNormal(new NormalObject().setUSE("normalVector")))))
      .addChild(new TransformObject("CockpitTransform").setRotation(1.0f,0.0f,0.0f,-0.1f).setScale(0.045f,0.045f,0.045f).setTranslation(0.0f,1.0f,-10.0f)
        .addChild(new InlineObject().setUrl(new String[] {"Cockpit.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Cockpit.x3d","Cockpit.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Cockpit.wrl"})))
      .addChild(new TransformObject("SeatTransform").setRotation(-1.0f,0.0f,0.0f,-0.1f).setScale(0.9f,0.9f,0.9f).setTranslation(0.0f,0.0f,-8.3f)
        .addChild(new InlineObject().setUrl(new String[] {"Seat.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Seat.x3d","Seat.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Seat.wrl"})))
      .addChild(new TransformObject("FrontWheelTransform").setCenter(0.0f,2.5f,0.0f).setRotation(-1.0f,0.0f,0.0f,1.92f).setTranslation(0.7f,-5.2f,-6.5f)
        .addComments(" Front wheel is taken from the Savage Library, modified and re-animated.(from F18 Blue Angel) ")
        .addChild(new InlineObject().setUrl(new String[] {"FrontWheel.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FrontWheel.x3d","FrontWheel.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FrontWheel.wrl"})))
      .addChild(new TransformObject("RearLeftWheelTransform").setCenter(0.0f,2.5f,0.0f).setRotation(1.0f,0.0f,1.0f,1.92f).setTranslation(-2.95f,-5.0f,7.0f)
        .addComments(" Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel) ")
        .addChild(new InlineObject().setUrl(new String[] {"RearLeftWheel.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/RearLeftWheel.x3d","RearLeftWheel.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/RearLeftWheel.wrl"})))
      .addChild(new TransformObject("RearRightWheelTransform").setCenter(0.0f,2.5f,0.0f).setRotation(-1.0f,0.0f,-1.0f,1.92f).setTranslation(2.95f,-5.0f,7.0f)
        .addComments(" Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel) ")
        .addChild(new InlineObject().setUrl(new String[] {"RearRightWheel.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/RearRightWheel.x3d","RearRightWheel.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/RearRightWheel.wrl"})))
      .addChild(new TransformObject("CockpitButtonsTransform")
        .addChild(new TransformObject("UpButtonTransform").setRotation(1.0f,0.0f,0.0f,1.57f).setScale(.008f,.008f,.008f).setTranslation(-0.95f,1.05f,-10.0f)
          .addChild(new ShapeObject()
            .setGeometry(new CylinderObject().setHeight(1f).setRadius(4f))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setDiffuseColor(1.0f,0.0f,0.0f).setShininess(.8f))))
          .addChild(new TouchSensorObject("TouchSensorUp").setDescription("click for gears up")))
        .addChild(new TransformObject("DownButtonTransform").setRotation(1.0f,0.0f,0.0f,1.57f).setScale(.008f,.008f,.008f).setTranslation(-0.83f,1.05f,-10.0f)
          .addChild(new ShapeObject()
            .setGeometry(new CylinderObject().setHeight(1f).setRadius(4f))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setDiffuseColor(1.0f,1.0f,0.0f).setShininess(.8f))))
          .addChild(new TouchSensorObject("TouchSensorDown").setDescription("click for gears down")))
        .addChild(new TransformObject("GearUpTextTransform").setScale(.06f,.06f,.06f).setTranslation(-.65f,1.55f,-10.0f)
          .addChild(new ShapeObject()
            .setGeometry(new TextObject().setString(new String[] {"RED Button","Gear Up"}))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setDiffuseColor(1.0f,0.0f,0.0f)))))
        .addChild(new TransformObject("GearDownTextTransform").setScale(.06f,.06f,.06f).setTranslation(-.65f,1.35f,-10.0f)
          .addChild(new ShapeObject()
            .setGeometry(new TextObject().setLength(new float[] {5.5f}).setString(new String[] {"YELLOW Button","Gear Down"}))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setDiffuseColor(1.0f,1.0f,0.0f)))))
        .addChild(new TransformObject("FireButtonTransform").setRotation(1.0f,0.0f,0.0f,1.57f).setScale(.008f,.008f,.008f).setTranslation(.52f,1.6f,-10.0f)
          .addChild(new ShapeObject()
            .setGeometry(new CylinderObject().setHeight(1f).setRadius(4f))
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setDiffuseColor(0.0f,.75f,.18f).setShininess(.8f))))
        ...
        .addChild(new TransformObject("FireTextTransform").setScale(.06f,.06f,.06f).setTranslation(.36f,1.5f,-10.0f)
          .addChild(new ShapeObject()
            .setGeometry(new TextObject().setString(new String[] {"Target Locked","      FIRE!..","(Green Button)"}))
            .setAppearance(new AppearanceObject()
      ...
      .addChild(new TransformObject("NoseAntennaTransform").setRotation(1.0f,0.0f,0.0f,1.57f).setTranslation(0.0f,-.275f,-21.0f)
        .addChild(new ShapeObject()
          .setGeometry(new CylinderObject().setRadius(.05f))
          .setAppearance(new AppearanceObject()
            .setMaterial(new MaterialObject().setDiffuseColor(.5f,.5f,.5f).setShininess(.5f))))))
    ...
    .addChild(new OrientationInterpolatorObject("RRearInterUp1").setKey(new float[] {0.0f,0.5f,1.0f}).setKeyValue(new MFRotationObject(new float[] {-1.0f,0.0f,-1.0f,0.0f,-1.0f,0.0f,-1.0f,0.44f,-1.0f,0.0f,-1.0f,1.92f})))
    .addChild(new OrientationInterpolatorObject("RRearInterDown1").setKey(new float[] {0.0f,0.5f,1.0f}).setKeyValue(new MFRotationObject(new float[] {-1.0f,0.0f,-1.0f,1.92f,-1.0f,0.0f,-1.0f,0.44f,-1.0f,0.0f,-1.0f,0.0f})))
    ...
    .addChild(new BackgroundObject().setGroundAngle(new float[] {1.309f,1.570796f}).setGroundColor(new MFColorObject(new float[] {0.0f,0.3f,.7f,0.0f,0.35f,0.75f,0.0f,0.4f,0.8f})).setSkyAngle(new float[] {1.309f,1.571f}).setSkyColor(new MFColorObject(new float[] {0.0f,0.3f,0.8f,0.0f,0.5f,1.0f,1.0f,1.0f,1.0f})))
    .addChild(new TransformObject("RightmostAmraamTransform").setRotation(-1.0f,0.0f,0.0f,1.57f).setScale(1.4f,1.4f,1.4f).setTranslation(15.65f,0.0f,4.5f)
      .addChild(new InlineObject("Amraam").setUrl(new String[] {"../../Weapons/Missiles/Amraam.x3d","https://savage.nps.edu/Savage/Weapons/Missiles/Amraam.x3d","../../Weapons/Missiles/Amraam.wrl","https://savage.nps.edu/Savage/Weapons/Missiles/Amraam.wrl"})))
    .addChild(new TransformObject("LeftmostAmraamTransform").setRotation(-1.0f,0.0f,0.0f,1.57f).setScale(1.4f,1.4f,1.4f).setTranslation(-15.65f,0.0f,4.5f)
    ...
    .addChild(new TransformObject("SidewinderHolderTransformRight").setRotation(0.0f,1.0f,0.0f,1.57f).setScale(6.0f,3.0f,3.0f).setTranslation(9.0f,-1.125f,8.0f)
      .addChild(new InlineObject("SidewinderHolder").setUrl(new String[] {"SidewinderHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/SidewinderHolder.x3d","SidewinderHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/SidewinderHolder.wrl"})))
    .addChild(new TransformObject("SidewinderHolderTransformLeft").setRotation(0.0f,1.0f,0.0f,1.57f).setScale(6.0f,3.0f,3.0f).setTranslation(-8.45f,-1.125f,8.0f)
      .addChild(new InlineObject().setUSE("SidewinderHolder")))
    .addChild(new TransformObject("TurkishFlagTransformLeft").setRotation(0.0f,-1.0f,0.0f,1.57f).setScale(.3f,.25f,.3f).setTranslation(-.01f,8.0f,19.5f)
      .addChild(new InlineObject().setUrl(new String[] {"TurkishFlagLeft.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagLeft.x3d","TurkishFlagLeft.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagLeft.wrl"})))
    .addChild(new TransformObject("TurkishFlagTransformRight").setRotation(0.0f,1.0f,0.0f,1.57f).setScale(.3f,.25f,.3f).setTranslation(.01f,8.0f,20.5f)
      .addChild(new InlineObject().setUrl(new String[] {"TurkishFlagRight.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagRight.x3d","TurkishFlagRight.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/TurkishFlagRight.wrl"})))
    .addChild(new TransformObject("AmraamHolderTransformLeft").setTranslation(-12.0f,-.176f,10.7f)
      .addChild(new InlineObject("AmraamHolder").setUrl(new String[] {"AmraamHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/AmraamHolder.x3d","AmraamHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/AmraamHolder.wrl"})))
    ...
    .addChild(new TransformObject("AmraamInnerTransformRight").setRotation(-1.0f,0.0f,0.0f,1.57f).setScale(1.4f,1.4f,1.4f).setTranslation(12.0f,-1.6f,4.5f)
      .addChild(new InlineObject().setUSE("Amraam")))
    .addChild(new TransformObject("AmraamInnerTransformLeft").setRotation(-1.0f,0.0f,0.0f,1.57f).setScale(1.4f,1.4f,1.4f).setTranslation(-12.0f,-1.6f,4.5f)
      .addChild(new InlineObject().setUSE("Amraam")))
    .addChild(new TransformObject("SidewinderTransformLeft").setRotation(-1.0f,0.0f,0.0f,1.57f).setScale(1.6f,1.6f,1.6f).setTranslation(-8.7f,-2.0f,3.5f)
      .addChild(new InlineObject("Sidewinder").setUrl(new String[] {"../../Weapons/Missiles/Sidewinder.x3d","https://savage.nps.edu/Savage/Weapons/Missiles/Sidewinder.x3d","../../Weapons/Missiles/Sidewinder.wrl","https://savage.nps.edu/Savage/Weapons/Missiles/Sidewinder.wrl"})))
    ...
    .addChild(new TransformObject("FuelTankHolderTransformLeft").setRotation(0.0f,1.0f,0.0f,1.57f).setScale(1.5f,1.5f,1.5f).setTranslation(-4.8f,-1.125f,6.0f)
      .addChild(new InlineObject("FuelTankHolder").setUrl(new String[] {"FuelTankHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTankHolder.x3d","FuelTankHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTankHolder.wrl"})))
    ...
    .addChild(new TransformObject("FuelTankTransformRight").setRotation(-1.0f,0.0f,0.0f,1.57f).setScale(1.5f,1.5f,1.5f).setTranslation(5.0f,-2.85f,5.5f)
      .addChild(new InlineObject("FuelTank").setUrl(new String[] {"FuelTank.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTank.x3d","FuelTank.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/FuelTank.wrl"})))
    .addChild(new TransformObject("FuelTankTransformLeft").setRotation(-1.0f,0.0f,0.0f,1.57f).setScale(1.5f,1.5f,1.5f).setTranslation(-5.0f,-2.85f,5.5f)
    ...
    .addChild(new TransformObject("TargetHelicopterTransform").setTranslation(16.0f,-50.0f,-500.0f)
      .addChild(new InlineObject().setUrl(new String[] {"Target.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Target.x3d","Target.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Target.wrl"})))
    .addChild(new TimeSensorObject("FireClock").setCycleInterval(8))
    .addChild(new PositionInterpolatorObject("MissilePath").setKey(new float[] {0.0f,.1f,1.0f}).setKeyValue(new MFVec3fObject(new float[] {-15.65f,0.0f,4.5f,-15.65f,-2.0f,4.5f,16.0f,-50.0f,-500.0f})))
    ...
    .addChild(new ViewpointObject("MissileLaunchView").setDescription("Missile Fire View").setOrientation(0.094f,-0.994f,0.057f,1.1716f).setPosition(-344.3f,-142.8f,-27.7f))
    ...
    {
        X3DObject thisExampleX3dObject = new MFString().getX3dModel();

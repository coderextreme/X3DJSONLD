...
public class Box
{
  ...
  .setScene(new SceneObject()
    ...
    {
        X3DObject thisExampleX3dObject = new Box().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.print("WARNING: \"Box\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");

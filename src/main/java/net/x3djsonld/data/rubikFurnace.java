...
import net.coderextreme.X3DRoots;import java.util.List;import java.util.ArrayList;public class rubikFurnace implements X3DRoots 
{
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.rubikFurnace self-validation test results: ");

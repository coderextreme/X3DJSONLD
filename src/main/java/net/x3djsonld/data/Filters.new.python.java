  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform("TransformAudio1").setTranslation(-200.0,50.0,0.0)
      .addChild(new Shape()
        ...
        .setGeometry(new Sphere().setRadius(30.0))))
    ...
    .addChild(new Transform("TransformAudio3").setTranslation(200.0,50.0,0.0)
      .addChild(new Shape()
        .setAppearance(new Appearance("audio_emit3")
          .setMaterial(new Material().setDiffuseColor(0.1,0.1,0.1).setEmissiveColor(0.8,0.8,0.8).setSpecularColor(0.01,0.01,0.01)))
        .setGeometry(new Sphere().setRadius(30.0))))
    .addChild(new Transform("AnimData").setTranslation(0.0,50.0,0.0))
    ...
    .addChild(new Transform("AnimDataBoxMM").setTranslation(-15.0,100.0,0.0))
    .addChild(new Transform("AnimDataBoxLM").setTranslation(-30.0,100.0,0.0))
    .addChild(new Transform()
      .addChild(new Shape()
        ...
        .setGeometry(new Cylinder().setRadius(500.0))))
          ...
          .addChild(new SpatialSound("Audio1")
            .addChild(new Gain()
              .addChild(new Analyser()
                .addChild(new BiquadFilter().setDetune(50.0).setFrequency(600.0).setQualityFactor(30.0).setType("ALLPASS")
                  .setSource(new AudioClip().setDescription("Techno beat").setLoop(true).setUrl(new String[] {"sound/techno_beat.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/techno_beat.mp3"}))))))
          .addChild(new SpatialSound("Audio2")
            .addChild(new Gain()
              .addChild(new Analyser()
                .addChild(new BiquadFilter().setDetune(15.0).setFrequency(600.0).setQualityFactor(15.0).setType("ALLPASS")
                  .setSource(new AudioClip().setDescription("Simple beat").setLoop(true).setUrl(new String[] {"sound/beat.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/beat.mp3"}))))))
          .addChild(new SpatialSound("Audio3")
            .addChild(new Gain()
              .addChild(new Analyser()
                .addChild(new BiquadFilter().setFrequency(1000.0).setQualityFactor(0.0).setType("ALLPASS")
                  .setSource(new AudioClip().setDescription("Wobble loop").setLoop(true).setUrl(new String[] {"sound/wobble_loop.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/wobble_loop.mp3"}))))))))));
            }
            catch (Exception ex)
            {       
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.Filters self-validation test results: ");

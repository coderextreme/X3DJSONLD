...
public class JinLOA4_5
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_JinLOA4").setName("JinLOA4").setLoa(4).setVersion("2.0")
      ...
      .addChild(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,1631.5555,-31.448889).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})

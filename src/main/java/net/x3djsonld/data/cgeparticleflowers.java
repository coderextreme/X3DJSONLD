...
public class cgeparticleflowers
{
	/** Default constructor to create this object. */
	public cgeparticleflowers ()
	{
	  initialize();
	}
      ...
      .addChild(new ParticleSystem().setGeometryType("GEOMETRY").setMaxParticles(20)
        ...
        .setAppearance(new Appearance()
          ...
          .setTexture(new ComposedCubeMapTexture("texture")
            ...
            .setFrontTexture(new ImageTexture().setUrl(new String[] {"../resources/images/all_probes/stpeters_cross/stpeters_from.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"}))
...
""")
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new cgeparticleflowers().getX3dModel();
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.cgeparticleflowers\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.cgeparticleflowers self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./cgeparticleflowers_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./cgeparticleflowers_JavaExport.x3d"; 
                String filenameX3DV = "./cgeparticleflowers_JavaExport.x3dv"; 
                String filenameJSON = "./cgeparticleflowers_JavaExport.json";

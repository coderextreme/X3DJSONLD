...
/**
 * <p> Example scene . </p>
 <p> Related links: Scripting.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
...
""")
    ...
    .addChild(new Sound().setMaxBack(1000.0).setMaxFront(1000.0).setMinBack(1000.0).setMinFront(1000.0)
      .setSource(new AudioClip("Click").setDescription("clicking sound").setStopTime(1.0).setUrl(new String[] {"../resources/chandubabamusic1.wav"})))

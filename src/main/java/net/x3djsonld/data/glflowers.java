 ...
 * <p> 5 or more prismatic flowers. </p>
 <p> Related links:  source glflowers.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
...
public class glflowers
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("glflowers.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/glflowers.x3d")))
  .setScene(new Scene()
        ...
        .setProtoBody(new ProtoBody()
          .addChild(new Group()
            .addChild(new ProtoInstance("FlowerProto").setContainerField("children")
              .addFieldValue(new fieldValue().setName("vertex").setValue(new String[] {"../shaders/gl_flowers_chromatic.vs"}))
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new glflowers().getX3dModel();
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.glflowers self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./glflowers_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./glflowers_JavaExport.x3d"; 
                String filenameX3DV = "./glflowers_JavaExport.x3dv"; 
                String filenameJSON = "./glflowers_JavaExport.json";

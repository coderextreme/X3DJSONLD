    ...
    .addChild(new Collision("DoNotCollideWithVisualizationWidget")
        ...
        .addChild(new Group("ArrowGreen")
          .addChild(new Shape()
            .setAppearance(new Appearance("Green")
              .setMaterial(new Material().setDiffuseColor(0.1,0.6,0.1).setEmissiveColor(0.05,0.2,0.05)))
            .setGeometry(new Cylinder("ArrowCylinder").setRadius(0.025).setTop(false)))
          .addChild(new Transform().setTranslation(0.0,1.0,0.0)
            .addChild(new Shape()
              .setAppearance(new Appearance().setUSE("Green"))
              .setGeometry(new Cone("ArrowCone").setBottomRadius(0.05).setHeight(0.1)))))
          ...
          .addChild(new Billboard()
            .addChild(new Shape()
              ...
              .setGeometry(new Text().setString(new String[] {"Y"})
                .setFontStyle(new FontStyle("LABEL_FONT").setFamily(new String[] {"SANS"}).setJustify(FontStyle.JUSTIFY_MIDDLE_MIDDLE).setSize(0.2)))))))
      .addChild(new Transform().setRotation(0.0,0.0,1.0,-1.57079)
        ...
        .addChild(new Group()
          .addChild(new Group("ArrowRed")
            .addChild(new Shape()
              .setAppearance(new Appearance("Red")
                .setMaterial(new Material().setDiffuseColor(0.7,0.1,0.1).setEmissiveColor(0.33,0.0,0.0)))
          ...
          .addChild(new Transform().setRotation(0.0,0.0,1.0,1.57079).setTranslation(0.072,1.1,0.0)
          ...
          .addChild(new Group("ArrowBlue")
            .addChild(new Shape()
              .setAppearance(new Appearance("Blue")
                .setMaterial(new Material().setDiffuseColor(0.3,0.3,1.0).setEmissiveColor(0.1,0.1,0.33)))
              .setGeometry(new Cylinder().setUSE("ArrowCylinder")))
            .addChild(new Transform().setTranslation(0.0,1.0,0.0)
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("Blue"))
                .setGeometry(new Cone().setUSE("ArrowCone")))))
          .addChild(new Transform().setRotation(1.0,0.0,0.0,-1.57079).setTranslation(0.0,1.1,0.072)
            .addComments(" note label rotated back to original coordinate frame ")
            .addChild(new Billboard()
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("LABEL_APPEARANCE"))
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.CoordinateAxes self-validation test results: ");

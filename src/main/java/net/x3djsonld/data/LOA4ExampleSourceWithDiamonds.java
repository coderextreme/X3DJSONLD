...
/**
 * <p> Example scene LOA4ExampleSourceWithDiamonds. </p>
 <p> Related links: LOA4ExampleSourceWithDiamonds.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> LOA4ExampleSourceWithDiamonds.wrl </td>
		</tr>
		<tr style="background-color:silver; border-color:silver;">
...
public class LOA4ExampleSourceWithDiamonds
{
	...
	public LOA4ExampleSourceWithDiamonds ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_SOURCE     ).setContent("LOA4ExampleSourceWithDiamonds.wrl")))
  .setScene(new Scene()
    ...
    .addChild(new ProtoInstance("Humanoid", "humanoid_2").setContainerField("children")
      .addFieldValue(new fieldValue().setName("humanoidBody")
        .addChild(new ProtoInstance("Joint", "hanim_humanoid_root_2").setContainerField("humanoidBody")
          ...
          .addFieldValue(new fieldValue().setName("children")
            .addChild(new ProtoInstance("Joint", "hanim_sacroiliac_2").setContainerField("children")
              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
              .addFieldValue(new fieldValue().setName("name").setValue("sacroiliac"))
              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.0,0.914900004863739,0.0015999999595806)))
              .addFieldValue(new fieldValue().setName("children")
                .addChild(new ProtoInstance("Joint", "hanim_l_hip_2").setContainerField("children")
                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                  .addFieldValue(new fieldValue().setName("name").setValue("l_hip"))
                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.0961000025272369,0.912400007247925,-0.0000999999974737875)))
                  .addFieldValue(new fieldValue().setName("children")
                    .addChild(new ProtoInstance("Joint", "hanim_l_knee_2").setContainerField("children")
                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                      .addFieldValue(new fieldValue().setName("name").setValue("l_knee"))
                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.104000002145767,0.486699998378754,0.030799999833107)))
                      .addFieldValue(new fieldValue().setName("children")
                        .addChild(new ProtoInstance("Joint", "hanim_l_talocrural_2").setContainerField("children")
                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                          .addFieldValue(new fieldValue().setName("name").setValue("l_talocrural"))
                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.110100001096725,0.0656000003218651,-0.0736000016331673)))
                          .addFieldValue(new fieldValue().setName("children")
                            .addChild(new ProtoInstance("Joint", "hanim_l_tarsotarsal_interphalangeal__2").setContainerField("children")
                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                              .addFieldValue(new fieldValue().setName("name").setValue("l_tarsotarsal_interphalangeal_"))
                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.108599998056889,0.0000999999974737875,-0.0368000008165836)))
                              .addFieldValue(new fieldValue().setName("children")
                                .addChild(new ProtoInstance("Joint", "hanim_l_metatarsophalangeal__2").setContainerField("children")
                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                  .addFieldValue(new fieldValue().setName("name").setValue("l_metatarsophalangeal_"))
                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.108599998056889,0.0000999999974737875,0.0368000008165836)))
                                  .addFieldValue(new fieldValue().setName("children")
                                    .addChild(new ProtoInstance("Joint", "hanim_l_tarsal_interphalangeal__2").setContainerField("children")
                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                      .addFieldValue(new fieldValue().setName("name").setValue("l_tarsal_interphalangeal_"))
                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.108599998056889,0.0,0.0762000009417534)))
                                      .addFieldValue(new fieldValue().setName("children")
                                        .addChild(new ProtoInstance("Segment", "hanim_l_tarsal_distal_phalanx2").setContainerField("children")
                                          .addFieldValue(new fieldValue().setName("name").setValue("l_tarsal_distal_phalanx_1"))
                                          .addFieldValue(new fieldValue().setName("children")
                                            .addChild(new ProtoInstance("Site", "hanim_l_tarsal_distal_phalanx_1_tip_2").setContainerField("children")
                                              .addFieldValue(new fieldValue().setName("name").setValue("l_tarsal_distal_phalanx_1_tip"))
                                              .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(0.135399997234344,0.0015999999595806,0.147599995136261))))
                                    ...
                                    .addChild(new ProtoInstance("Segment", "hanim_l_middistal_2").setContainerField("children")
                                ...
                                .addChild(new ProtoInstance("Segment", "hanim_l_midproximal_2").setContainerField("children")
                                  .addFieldValue(new fieldValue().setName("name").setValue("l_midproximal")))))
                            .addChild(new ProtoInstance("Segment", "hanim_l_hindfoot_2").setContainerField("children")
                        ...
                        .addChild(new ProtoInstance("Segment", "hanim_l_calf_2").setContainerField("children")
                          .addFieldValue(new fieldValue().setName("name").setValue("l_calf")))))
                    .addChild(new ProtoInstance("Segment", "hanim_l_thigh_2").setContainerField("children")
                ...
                .addChild(new ProtoInstance("Joint", "hanim_r_hip_2").setContainerField("children")
                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                  .addFieldValue(new fieldValue().setName("name").setValue("r_hip"))
                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.0949999988079071,0.917100012302399,0.00289999996311963)))
                  .addFieldValue(new fieldValue().setName("children")
                    .addChild(new ProtoInstance("Joint", "hanim_r_knee_2").setContainerField("children")
                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                      .addFieldValue(new fieldValue().setName("name").setValue("r_knee"))
                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.0866999998688698,0.491299986839294,0.0318000018596649)))
                      .addFieldValue(new fieldValue().setName("children")
                        .addChild(new ProtoInstance("Joint", "hanim_r_talocrural_2").setContainerField("children")
                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                          .addFieldValue(new fieldValue().setName("name").setValue("r_talocrural"))
                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.0800999999046326,0.0711999982595444,-0.0766000002622604)))
                          .addFieldValue(new fieldValue().setName("children")
                            .addChild(new ProtoInstance("Joint", "hanim_r_tarsotarsal_interphalangeal__2").setContainerField("children")
                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                              .addFieldValue(new fieldValue().setName("name").setValue("r_tarsotarsal_interphalangeal_"))
                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.0800999999046326,0.0,-0.0368000008165836)))
                              .addFieldValue(new fieldValue().setName("children")
                                .addChild(new ProtoInstance("Joint", "hanim_r_metatarsophalangeal__2").setContainerField("children")
                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                  .addFieldValue(new fieldValue().setName("name").setValue("r_metatarsophalangeal_"))
                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.0800999999046326,0.0,0.0368000008165836)))
                                  .addFieldValue(new fieldValue().setName("children")
                                    .addChild(new ProtoInstance("Joint", "hanim_r_tarsal_interphalangeal__2").setContainerField("children")
                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                      .addFieldValue(new fieldValue().setName("name").setValue("r_tarsal_interphalangeal_"))
                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.0800999999046326,0.00389999989420176,0.0732000023126602)))
                                      .addFieldValue(new fieldValue().setName("children")
                                        .addChild(new ProtoInstance("Segment", "hanim_r_tarsal_distal_phalanx2").setContainerField("children")
                                          .addFieldValue(new fieldValue().setName("name").setValue("r_tarsal_distal_phalanx_1"))
                                          .addFieldValue(new fieldValue().setName("children")
                                            .addChild(new ProtoInstance("Site", "hanim_r_tarsal_distal_phalanx_1_tip_2").setContainerField("children")
                                              .addFieldValue(new fieldValue().setName("name").setValue("r_tarsal_distal_phalanx_1_tip"))
                                              .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(-0.104299999773502,-0.0227000005543232,0.144999995827675))))
                                    ...
                                    .addChild(new ProtoInstance("Segment", "hanim_r_middistal_2").setContainerField("children")
                                ...
                                .addChild(new ProtoInstance("Segment", "hanim_r_midproximal_2").setContainerField("children")
                                  .addFieldValue(new fieldValue().setName("name").setValue("r_midproximal")))))
                            .addChild(new ProtoInstance("Segment", "hanim_r_hindfoot_2").setContainerField("children")
                        ...
                        .addChild(new ProtoInstance("Segment", "hanim_r_calf_2").setContainerField("children")
                          .addFieldValue(new fieldValue().setName("name").setValue("r_calf")))))
                    .addChild(new ProtoInstance("Segment", "hanim_r_thigh_2").setContainerField("children")
                ...
                .addChild(new ProtoInstance("Segment", "hanim_pelvis_2").setContainerField("children")
            ...
            .addChild(new ProtoInstance("Joint", "hanim_vl5_2").setContainerField("children")
              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
              .addFieldValue(new fieldValue().setName("name").setValue("vl5"))
              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00279999990016222,1.05680000782013,-0.0776000022888184)))
              .addFieldValue(new fieldValue().setName("children")
                .addChild(new ProtoInstance("Joint", "hanim_vl4_2").setContainerField("children")
                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                  .addFieldValue(new fieldValue().setName("name").setValue("vl4"))
                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00350000010803342,1.09249997138977,-0.0786999985575676)))
                  .addFieldValue(new fieldValue().setName("children")
                    .addChild(new ProtoInstance("Joint", "hanim_vl3_2").setContainerField("children")
                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                      .addFieldValue(new fieldValue().setName("name").setValue("vl3"))
                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00410000002011657,1.1275999546051,-0.0795999988913536)))
                      .addFieldValue(new fieldValue().setName("children")
                        .addChild(new ProtoInstance("Joint", "hanim_vl2_2").setContainerField("children")
                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                          .addFieldValue(new fieldValue().setName("name").setValue("vl2"))
                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.0044999998062849,1.15460002422333,-0.0799999982118607)))
                          .addFieldValue(new fieldValue().setName("children")
                            .addChild(new ProtoInstance("Joint", "hanim_vl1_2").setContainerField("children")
                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                              .addFieldValue(new fieldValue().setName("name").setValue("vl1"))
                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00480000022798777,1.19120001792908,-0.0804999992251396)))
                              .addFieldValue(new fieldValue().setName("children")
                                .addChild(new ProtoInstance("Joint", "hanim_vt12_2").setContainerField("children")
                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                  .addFieldValue(new fieldValue().setName("name").setValue("vt12"))
                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00510000018402934,1.22780001163483,-0.0807999968528748)))
                                  .addFieldValue(new fieldValue().setName("children")
                                    .addChild(new ProtoInstance("Joint", "hanim_vt11_2").setContainerField("children")
                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                      .addFieldValue(new fieldValue().setName("name").setValue("vt11"))
                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00529999984428287,1.26789999008179,-0.0810000002384186)))
                                      .addFieldValue(new fieldValue().setName("children")
                                        .addChild(new ProtoInstance("Joint", "hanim_vt10_2").setContainerField("children")
                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                          .addFieldValue(new fieldValue().setName("name").setValue("vt10"))
                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00559999980032444,1.28480005264282,-0.0821999981999397)))
                                          .addFieldValue(new fieldValue().setName("children")
                                            .addChild(new ProtoInstance("Joint", "hanim_vt9_2").setContainerField("children")
                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                              .addFieldValue(new fieldValue().setName("name").setValue("vt9"))
                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00570000009611249,1.31260001659393,-0.0838000029325485)))
                                              .addFieldValue(new fieldValue().setName("children")
                                                .addChild(new ProtoInstance("Joint", "hanim_vt8_2").setContainerField("children")
                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                  .addFieldValue(new fieldValue().setName("name").setValue("vt8"))
                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00570000009611249,1.33819997310638,-0.0844999998807907)))
                                                  .addFieldValue(new fieldValue().setName("children")
                                                    .addChild(new ProtoInstance("Joint", "hanim_vt7_2").setContainerField("children")
                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                      .addFieldValue(new fieldValue().setName("name").setValue("vt7"))
                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00579999992623925,1.36249995231628,-0.0833000019192696)))
                                                      .addFieldValue(new fieldValue().setName("children")
                                                        .addChild(new ProtoInstance("Joint", "hanim_vt6_2").setContainerField("children")
                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                          .addFieldValue(new fieldValue().setName("name").setValue("vt6"))
                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.0059000002220273,1.38660001754761,-0.0799999982118607)))
                                                          .addFieldValue(new fieldValue().setName("children")
                                                            .addChild(new ProtoInstance("Joint", "hanim_vt5_2").setContainerField("children")
                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                              .addFieldValue(new fieldValue().setName("name").setValue("vt5"))
                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00600000005215406,1.41019999980927,-0.0745000019669533)))
                                                              .addFieldValue(new fieldValue().setName("children")
                                                                .addChild(new ProtoInstance("Joint", "hanim_vt4_2").setContainerField("children")
                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                  .addFieldValue(new fieldValue().setName("name").setValue("vt4"))
                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00609999988228083,1.432000041008,-0.067500002682209)))
                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                    .addChild(new ProtoInstance("Joint", "hanim_vt3_2").setContainerField("children")
                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                      .addFieldValue(new fieldValue().setName("name").setValue("vt3"))
                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00620000017806888,1.45829999446869,-0.0570000000298023)))
                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                        .addChild(new ProtoInstance("Joint", "hanim_vt2_2").setContainerField("children")
                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                          .addFieldValue(new fieldValue().setName("name").setValue("vt2"))
                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00630000000819564,1.47609996795654,-0.0483999997377396)))
                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                            .addChild(new ProtoInstance("Joint", "hanim_vt1_2").setContainerField("children")
                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                              .addFieldValue(new fieldValue().setName("name").setValue("vt1"))
                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00650000013411045,1.4951000213623,-0.0386999994516373)))
                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                .addChild(new ProtoInstance("Joint", "hanim_vc7_2").setContainerField("children")
                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("vc7"))
                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00659999996423721,1.51320004463196,-0.0300999991595745)))
                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                    .addChild(new ProtoInstance("Joint", "hanim_vc6_2").setContainerField("children")
                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("vc6"))
                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00659999996423721,1.53569996356964,-0.014299999922514)))
                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                        .addChild(new ProtoInstance("Joint", "hanim_vc5_2").setContainerField("children")
                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("vc5"))
                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00659999996423721,1.55200004577637,-0.00820000004023314)))
                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                            .addChild(new ProtoInstance("Joint", "hanim_vc4_2").setContainerField("children")
                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("vc4"))
                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00659999996423721,1.56620001792908,-0.00839999970048666)))
                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                .addChild(new ProtoInstance("Joint", "hanim_vc3_2").setContainerField("children")
                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("vc3"))
                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00659999996423721,1.58000004291534,-0.0103000001981854)))
                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_vc2_2").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("vc2"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00659999996423721,1.59280002117157,-0.0103000001981854)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_vc1_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("vc1"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00659999996423721,1.61440002918243,-0.00340000004507601)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_skullbase_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("skullbase"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.00439999997615814,1.62090003490448,0.0236000008881092)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_l_eyeball_4").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_eyeball"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.0335999988019466,1.63320004940033,0.0502000004053116)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_l_eyeball_3").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_eyeball")))))
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_r_eyeball_4").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_eyeball"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.0236000008881092,1.6331000328064,0.0509999990463257)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_r_eyeball_3").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_eyeball")))))
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_skull_2").setContainerField("children")
                                                                                                            ...
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_c1_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("c1")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_c2_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("c2")))))
                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_c3_2").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("c3")))))
                                                                                                .addChild(new ProtoInstance("Segment", "hanim_c4_2").setContainerField("children")
                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("c4")))))
                                                                                            .addChild(new ProtoInstance("Segment", "hanim_c5_2").setContainerField("children")
                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("c5")))))
                                                                                        .addChild(new ProtoInstance("Segment", "hanim_c6_2").setContainerField("children")
                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("c6")))))
                                                                                    .addChild(new ProtoInstance("Segment", "hanim_c7_2").setContainerField("children")
                                                                                ...
                                                                                .addChild(new ProtoInstance("Joint", "hanim_l_sternoclavicular_2").setContainerField("children")
                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_sternoclavicular"))
                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.0820000022649765,1.44879996776581,-0.035300001502037)))
                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                    .addChild(new ProtoInstance("Joint", "hanim_l_acromioclavicular_2").setContainerField("children")
                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_acromioclavicular"))
                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.0961999967694283,1.42690002918243,-0.0423999987542629)))
                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                        .addChild(new ProtoInstance("Joint", "hanim_l_shoulder_2").setContainerField("children")
                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_shoulder"))
                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.202900007367134,1.43760001659393,-0.0386999994516373)))
                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                            .addChild(new ProtoInstance("Joint", "hanim_l_elbow_2").setContainerField("children")
                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_elbow"))
                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.201399996876717,1.1356999874115,-0.0681999996304512)))
                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                .addChild(new ProtoInstance("Joint", "hanim_l_radiocarpal_2").setContainerField("children")
                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_radiocarpal"))
                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.198400005698204,0.866299986839294,-0.0582999996840954)))
                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_l_carpometacarpal2").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpometacarpal_1"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.192399993538857,0.847199976444244,-0.0533999986946583)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_l_metacarpophalangeal2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_metacarpophalangeal_1"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.195099994540215,0.82260000705719,0.0245999991893768)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_l_carpal_interphalangeal2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_interphalangeal_1"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.195500001311302,0.815900027751923,0.046399999409914)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_l_carpal_distal_phalanx2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_1"))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Site", "hanim_l_carpal_distal_phalanx_1_tip_2").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_1_tip"))
                                                                                                                      .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(0.19820000231266,0.806100010871887,0.0759000033140183))))))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_l_index_proximal_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_index_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_l_index_proximal_4").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_index_proximal")))))
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_l_carpometacarpal3").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpometacarpal_2"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.198300004005432,0.80239999294281,-0.0280000008642673)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_l_metacarpophalangeal3").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_metacarpophalangeal_2"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.198300004005432,0.781499981880188,-0.0280000008642673)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_l_carpal_proximal_interphalangeal3").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_proximal_interphalangeal_2"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.201700001955032,0.736299991607666,-0.0248000007122755)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_l_carpal_distal_interphalangeal3").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_interphalangeal_2"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.202800005674362,0.713900029659271,-0.0236000008881092)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_l_carpal_distal_phalanx3").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_2"))
                                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                                        .addChild(new ProtoInstance("Site", "hanim_l_carpal_distal_phalanx_2_tip_2").setContainerField("children")
                                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_2_tip"))
                                                                                                                          .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(0.20890000462532,0.685800015926361,-0.0244999993592501))))
                                                                                                                ...
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_l_index_middle_2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_index_middle")))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_l_index_proximal_6").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_index_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_l_index_metacarpal_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_index_metacarpal")))))
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_l_carpometacarpal4").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpometacarpal_3"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.198699995875359,0.802900016307831,-0.0529999993741512)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_l_metacarpophalangeal4").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_metacarpophalangeal_3"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.198699995875359,0.781799972057343,-0.0529999993741512)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_l_carpal_proximal_interphalangeal4").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_proximal_interphalangeal_3"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.201299995183945,0.727299988269806,-0.0502999983727932)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_l_carpal_distal_interphalangeal4").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_interphalangeal_3"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.202600002288818,0.701099991798401,-0.0494000017642975)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_l_carpal_distal_phalanx4").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_3"))
                                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                                        .addChild(new ProtoInstance("Site", "hanim_l_carpal_distal_phalanx_3_tip_2").setContainerField("children")
                                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_3_tip"))
                                                                                                                          .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(0.208000004291534,0.673099994659424,-0.049100000411272))))))))
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_l_middle_middle_2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_middle_middle")))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_l_middle_proximal_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_middle_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_l_middle_metacarpal_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_middle_metacarpal")))))
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_l_carpometacarpal5").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpometacarpal_4"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.195600003004074,0.801900029182434,-0.0794000029563904)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_l_metacarpophalangeal5").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_metacarpophalangeal_4"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.195600003004074,0.781499981880188,-0.0794000029563904)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_l_carpal_proximal_interphalangeal5").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_proximal_interphalangeal_4"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.197300001978874,0.72869998216629,-0.0776999965310097)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_l_carpal_distal_interphalangeal5").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_interphalangeal_4"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.198300004005432,0.704500019550323,-0.0767000019550323)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_l_carpal_distal_phalanx5").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_4"))
                                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                                        .addChild(new ProtoInstance("Site", "hanim_l_carpal_distal_phalanx_4_tip_2").setContainerField("children")
                                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_4_tip"))
                                                                                                                          .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(0.203500002622604,0.675000011920929,-0.0755999982357025))))))))
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_l_ring_middle_2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_ring_middle")))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_l_ring_proximal_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_ring_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_l_ring_metacarpal_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_ring_metacarpal")))))
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_l_carpometacarpal6").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpometacarpal_5"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.192499995231628,0.806599974632263,-0.10360000282526)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_l_metacarpophalangeal6").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_metacarpophalangeal_5"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.192499995231628,0.78659999370575,-0.10360000282526)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_l_carpal_proximal_interphalangeal6").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_proximal_interphalangeal_5"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.193800002336502,0.745199978351593,-0.102399997413158)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_l_carpal_distal_interphalangeal6").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_interphalangeal_5"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(0.19480000436306,0.727699995040894,-0.101700000464916)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_l_carpal_distal_phalanx6").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_5"))
                                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                                        .addChild(new ProtoInstance("Site", "hanim_l_carpal_distal_phalanx_5_tip_2").setContainerField("children")
                                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_carpal_distal_phalanx_5_tip"))
                                                                                                                          .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(0.201399996876717,0.700900018215179,-0.101199999451637))))))))
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_l_pinky_middle_2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("l_pinky_middle")))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_l_pinky_proximal_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("l_pinky_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_l_pinky_metacarpal_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_pinky_metacarpal")))))
                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_l_hand_2").setContainerField("children")
                                                                                                ...
                                                                                                .addChild(new ProtoInstance("Segment", "hanim_l_forearm_2").setContainerField("children")
                                                                                            ...
                                                                                            .addChild(new ProtoInstance("Segment", "hanim_l_upperarm_2").setContainerField("children")
                                                                                        ...
                                                                                        .addChild(new ProtoInstance("Segment", "hanim_l_scapula_2").setContainerField("children")
                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("l_scapula")))))
                                                                                    .addChild(new ProtoInstance("Segment", "hanim_l_clavicle_2").setContainerField("children")
                                                                                ...
                                                                                .addChild(new ProtoInstance("Joint", "hanim_r_sternoclavicular_2").setContainerField("children")
                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_sternoclavicular"))
                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.0693999975919724,1.46000003814697,-0.0329999998211861)))
                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                    .addChild(new ProtoInstance("Joint", "hanim_r_acromioclavicular_2").setContainerField("children")
                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_acromioclavicular"))
                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.0835999995470047,1.42809998989105,-0.0401000007987022)))
                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                        .addChild(new ProtoInstance("Joint", "hanim_r_shoulder_2").setContainerField("children")
                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_shoulder"))
                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.190699994564056,1.4407000541687,-0.0324999988079071)))
                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                            .addChild(new ProtoInstance("Joint", "hanim_r_elbow_2").setContainerField("children")
                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_elbow"))
                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.194900006055832,1.13880002498627,-0.061999998986721)))
                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                .addChild(new ProtoInstance("Joint", "hanim_r_radiocarpal_2").setContainerField("children")
                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_radiocarpal"))
                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.195899993181229,0.869400024414063,-0.0520999990403652)))
                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_r_carpometacarpal2").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpometacarpal_1"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.189899995923042,0.850199997425079,-0.0472999997437)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_r_metacarpophalangeal2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_metacarpophalangeal_1"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.187399998307228,0.825600028038025,0.0306000001728535)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_r_carpal_interphalangeal2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_interphalangeal_1"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.18639999628067,0.819000005722046,0.0505999997258186)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_r_carpal_distal_phalanx2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_1"))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Site", "hanim_r_carpal_distal_phalanx_1_tip_2").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_1_tip"))
                                                                                                                      .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(-0.18690000474453,0.809000015258789,0.0820000022649765))))))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_r_index_proximal_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_index_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_r_index_proximal_4").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_index_proximal")))))
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_r_carpometacarpal3").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpometacarpal_2"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.196099996566772,0.805499970912933,-0.0218000002205372)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_r_metacarpophalangeal3").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_metacarpophalangeal_2"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.196099996566772,0.784600019454956,-0.0218000002205372)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_r_carpal_proximal_interphalangeal3").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_proximal_interphalangeal_2"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.19539999961853,0.739300012588501,-0.0185000002384186)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_r_carpal_distal_interphalangeal3").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_interphalangeal_2"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.194499999284744,0.716899991035461,-0.0173000004142523)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_r_carpal_distal_phalanx3").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_2"))
                                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                                        .addChild(new ProtoInstance("Site", "hanim_r_carpal_distal_phalanx_2_tip_2").setContainerField("children")
                                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_2_tip"))
                                                                                                                          .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(-0.197999998927116,0.688300013542175,-0.0179999992251396))))
                                                                                                                ...
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_r_index_middle_2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_index_middle")))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_r_index_proximal_6").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_index_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_r_index_metacarpal_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_index_metacarpal")))))
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_r_carpometacarpal4").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpometacarpal_3"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.197200000286102,0.805999994277954,-0.0467999987304211)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_r_metacarpophalangeal4").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_metacarpophalangeal_3"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.197200000286102,0.784900009632111,-0.0467999987304211)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_r_carpal_proximal_interphalangeal4").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_proximal_interphalangeal_3"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.194999992847443,0.730400025844574,-0.0441000014543533)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_r_carpal_distal_interphalangeal4").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_interphalangeal_3"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.193900004029274,0.704200029373169,-0.0432000011205673)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_r_carpal_distal_phalanx4").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_3"))
                                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                                        .addChild(new ProtoInstance("Site", "hanim_r_carpal_distal_phalanx_3_tip_2").setContainerField("children")
                                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_3_tip"))
                                                                                                                          .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(-0.196899995207787,0.675800025463104,-0.0427000001072884))))))))
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_r_middle_middle_2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_middle_middle")))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_r_middle_proximal_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_middle_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_r_middle_metacarpal_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_middle_metacarpal")))))
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_r_carpometacarpal5").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpometacarpal_4"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.195099994540215,0.804899990558624,-0.0732000023126602)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_r_metacarpophalangeal5").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_metacarpophalangeal_4"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.195099994540215,0.784500002861023,-0.0732000023126602)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_r_carpal_proximal_interphalangeal5").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_proximal_interphalangeal_4"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.19200000166893,0.731800019741058,-0.0715999975800514)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_r_carpal_distal_interphalangeal5").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_interphalangeal_4"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.190799996256828,0.70770001411438,-0.0706000030040741)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_r_carpal_distal_phalanx5").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_4"))
                                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                                        .addChild(new ProtoInstance("Site", "hanim_r_carpal_distal_phalanx_4_tip_2").setContainerField("children")
                                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_4_tip"))
                                                                                                                          .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(-0.193399995565414,0.677799999713898,-0.069300003349781))))))))
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_r_ring_middle_2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_ring_middle")))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_r_ring_proximal_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_ring_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_r_ring_metacarpal_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_ring_metacarpal")))))
                                                                                                    .addChild(new ProtoInstance("Joint", "hanim_r_carpometacarpal6").setContainerField("children")
                                                                                                      .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpometacarpal_5"))
                                                                                                      .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.1925999969244,0.809599995613098,-0.0974999964237213)))
                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                        .addChild(new ProtoInstance("Joint", "hanim_r_metacarpophalangeal6").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_metacarpophalangeal_5"))
                                                                                                          .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.1925999969244,0.789600014686584,-0.0974999964237213)))
                                                                                                          .addFieldValue(new fieldValue().setName("children")
                                                                                                            .addChild(new ProtoInstance("Joint", "hanim_r_carpal_proximal_interphalangeal6").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_proximal_interphalangeal_5"))
                                                                                                              .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.190200001001358,0.748300015926361,-0.0962999984622002)))
                                                                                                              .addFieldValue(new fieldValue().setName("children")
                                                                                                                .addChild(new ProtoInstance("Joint", "hanim_r_carpal_distal_interphalangeal6").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("stiffness").setValue(new double[] {1.0,1.0,1.0}))
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_interphalangeal_5"))
                                                                                                                  .addFieldValue(new fieldValue().setName("center").setValue(new SFVec3f(-0.190799996256828,0.754000008106232,-0.096000000834465)))
                                                                                                                  .addFieldValue(new fieldValue().setName("children")
                                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_r_carpal_distal_phalanx6").setContainerField("children")
                                                                                                                      .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_5"))
                                                                                                                      .addFieldValue(new fieldValue().setName("children")
                                                                                                                        .addChild(new ProtoInstance("Site", "hanim_r_carpal_distal_phalanx_5_tip_2").setContainerField("children")
                                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_carpal_distal_phalanx_5_tip"))
                                                                                                                          .addFieldValue(new fieldValue().setName("translation").setValue(new SFVec3f(-0.193800002336502,0.703499972820282,-0.0948999971151352))))))))
                                                                                                                .addChild(new ProtoInstance("Segment", "hanim_r_pinky_middle_2").setContainerField("children")
                                                                                                                  .addFieldValue(new fieldValue().setName("name").setValue("r_pinky_middle")))))
                                                                                                            .addChild(new ProtoInstance("Segment", "hanim_r_pinky_proximal_2").setContainerField("children")
                                                                                                              .addFieldValue(new fieldValue().setName("name").setValue("r_pinky_proximal")))))
                                                                                                        .addChild(new ProtoInstance("Segment", "hanim_r_pinky_metacarpal_2").setContainerField("children")
                                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_pinky_metacarpal")))))
                                                                                                    .addChild(new ProtoInstance("Segment", "hanim_r_hand_2").setContainerField("children")
                                                                                                ...
                                                                                                .addChild(new ProtoInstance("Segment", "hanim_r_forearm_2").setContainerField("children")
                                                                                            ...
                                                                                            .addChild(new ProtoInstance("Segment", "hanim_r_upperarm_2").setContainerField("children")
                                                                                        ...
                                                                                        .addChild(new ProtoInstance("Segment", "hanim_r_scapula_2").setContainerField("children")
                                                                                          .addFieldValue(new fieldValue().setName("name").setValue("r_scapula")))))
                                                                                    .addChild(new ProtoInstance("Segment", "hanim_r_clavicle_2").setContainerField("children")
                                                                                ...
                                                                                .addChild(new ProtoInstance("Segment", "hanim_t1_2").setContainerField("children")
                                                                            ...
                                                                            .addChild(new ProtoInstance("Segment", "hanim_t2_2").setContainerField("children")
                                                                              .addFieldValue(new fieldValue().setName("name").setValue("t2")))))
                                                                        .addChild(new ProtoInstance("Segment", "hanim_t3_2").setContainerField("children")
                                                                          .addFieldValue(new fieldValue().setName("name").setValue("t3")))))
                                                                    .addChild(new ProtoInstance("Segment", "hanim_t4_2").setContainerField("children")
                                                                      .addFieldValue(new fieldValue().setName("name").setValue("t4")))))
                                                                .addChild(new ProtoInstance("Segment", "hanim_t5_2").setContainerField("children")
                                                                  .addFieldValue(new fieldValue().setName("name").setValue("t5")))))
                                                            .addChild(new ProtoInstance("Segment", "hanim_t6_2").setContainerField("children")
                                                              .addFieldValue(new fieldValue().setName("name").setValue("t6")))))
                                                        .addChild(new ProtoInstance("Segment", "hanim_t7_2").setContainerField("children")
                                                          .addFieldValue(new fieldValue().setName("name").setValue("t7")))))
                                                    .addChild(new ProtoInstance("Segment", "hanim_t8_2").setContainerField("children")
                                                      .addFieldValue(new fieldValue().setName("name").setValue("t8")))))
                                                .addChild(new ProtoInstance("Segment", "hanim_t9_2").setContainerField("children")
                                            ...
                                            .addChild(new ProtoInstance("Segment", "hanim_t10_2").setContainerField("children")
                                        ...
                                        .addChild(new ProtoInstance("Segment", "hanim_t11_2").setContainerField("children")
                                          .addFieldValue(new fieldValue().setName("name").setValue("t11")))))
                                    .addChild(new ProtoInstance("Segment", "hanim_t12_2").setContainerField("children")
                                      .addFieldValue(new fieldValue().setName("name").setValue("t12")))))
                                .addChild(new ProtoInstance("Segment", "hanim_l1_2").setContainerField("children")
                                  .addFieldValue(new fieldValue().setName("name").setValue("l1")))))
                            .addChild(new ProtoInstance("Segment", "hanim_l2_2").setContainerField("children")
                        ...
                        .addChild(new ProtoInstance("Segment", "hanim_l3_2").setContainerField("children")
                          .addFieldValue(new fieldValue().setName("name").setValue("l3")))))
                    .addChild(new ProtoInstance("Segment", "hanim_l4_2").setContainerField("children")
                      .addFieldValue(new fieldValue().setName("name").setValue("l4")))))
                .addChild(new ProtoInstance("Segment", "hanim_l5_2").setContainerField("children")
      ...
      .addFieldValue(new fieldValue().setName("joints")
        ...
        .addChild(new ProtoInstance().setUSE("hanim_sacroiliac_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_hip_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_knee_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_talocrural_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_tarsotarsal_interphalangeal__2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_metatarsophalangeal__2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_tarsal_interphalangeal__2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_hip_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_knee_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_talocrural_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_tarsotarsal_interphalangeal__2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_metatarsophalangeal__2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_tarsal_interphalangeal__2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vl5_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vl4_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vl3_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vl2_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vl1_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt12_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt11_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt10_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt9_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt8_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt7_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt6_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt5_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt4_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt3_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt2_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vt1_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vc7_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vc6_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vc5_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vc4_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vc3_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vc2_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_vc1_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_skullbase_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_eyeball_4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_eyeball_4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_sternoclavicular_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_acromioclavicular_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_shoulder_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_elbow_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_radiocarpal_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpometacarpal2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_metacarpophalangeal2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_interphalangeal2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpometacarpal3").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_metacarpophalangeal3").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_proximal_interphalangeal3").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_interphalangeal3").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpometacarpal4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_metacarpophalangeal4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_proximal_interphalangeal4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_interphalangeal4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpometacarpal5").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_metacarpophalangeal5").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_proximal_interphalangeal5").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_interphalangeal5").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpometacarpal6").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_metacarpophalangeal6").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_proximal_interphalangeal6").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_interphalangeal6").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_sternoclavicular_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_acromioclavicular_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_shoulder_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_elbow_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_radiocarpal_2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpometacarpal2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_metacarpophalangeal2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_interphalangeal2").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpometacarpal3").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_metacarpophalangeal3").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_proximal_interphalangeal3").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_interphalangeal3").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpometacarpal4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_metacarpophalangeal4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_proximal_interphalangeal4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_interphalangeal4").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpometacarpal5").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_metacarpophalangeal5").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_proximal_interphalangeal5").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_interphalangeal5").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpometacarpal6").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_metacarpophalangeal6").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_proximal_interphalangeal6").setContainerField("joints"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_interphalangeal6").setContainerField("joints")))
      .addFieldValue(new fieldValue().setName("sites")
        .addChild(new ProtoInstance().setUSE("hanim_l_tarsal_distal_phalanx_1_tip_2").setContainerField("sites"))
        ...
        .addChild(new ProtoInstance().setUSE("hanim_r_tarsal_distal_phalanx_1_tip_2").setContainerField("sites"))
        ...
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx_1_tip_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx_2_tip_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_l_dactylion_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx_3_tip_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx_4_tip_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx_5_tip_2").setContainerField("sites"))
        ...
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx_1_tip_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx_2_tip_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_r_dactylion_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx_3_tip_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx_4_tip_2").setContainerField("sites"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx_5_tip_2").setContainerField("sites"))
      ...
      .addFieldValue(new fieldValue().setName("segments")
        .addChild(new ProtoInstance().setUSE("hanim_l_tarsal_distal_phalanx2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_middistal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_midproximal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_hindfoot_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_calf_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_thigh_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_tarsal_distal_phalanx2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_middistal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_midproximal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_hindfoot_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_calf_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_thigh_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_pelvis_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_eyeball_4").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_eyeball_4").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_skull_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_c1_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_c2_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_c3_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_c4_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_c5_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_c6_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_c7_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_index_proximal_6").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_index_proximal_6").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx3").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_index_middle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_index_proximal_6").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_index_metacarpal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx4").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_middle_middle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_middle_proximal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_middle_metacarpal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx5").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_ring_middle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_ring_proximal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_ring_metacarpal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_carpal_distal_phalanx6").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_pinky_middle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_pinky_proximal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_pinky_metacarpal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_hand_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_forearm_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_upperarm_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_scapula_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l_clavicle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_index_proximal_6").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_index_proximal_6").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx3").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_index_middle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_index_proximal_6").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_index_metacarpal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx4").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_middle_middle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_middle_proximal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_middle_metacarpal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx5").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_ring_middle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_ring_proximal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_ring_metacarpal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_carpal_distal_phalanx6").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_pinky_middle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_pinky_proximal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_pinky_metacarpal_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_hand_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_forearm_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_upperarm_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_scapula_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_r_clavicle_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t1_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t2_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t3_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t4_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t5_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t6_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t7_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t8_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t9_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t10_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t11_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_t12_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l1_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l2_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l3_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l4_2").setContainerField("segments"))
        .addChild(new ProtoInstance().setUSE("hanim_l5_2").setContainerField("segments"))
      ...
      .addFieldValue(new fieldValue().setName("info").setValue(new String[] {"authorName=Matthew T. Beitler","authorEmail=beitler@cis.upenn.edu or beitler@acm.org","creationDate=05/12/99","copyright=Copyright 1999-2003, Matthew T. Beitler","humanoidVersion=JointCenters 200x, LOA&#8209;4","usageRestrictions=
   ...
   "}).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;4")))
	 ...
	 * @return LOA4ExampleSourceWithDiamonds model
	 */
    ...
    {
        X3D thisExampleX3dModel = new LOA4ExampleSourceWithDiamonds().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"LOA4ExampleSourceWithDiamonds\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"LOA4ExampleSourceWithDiamonds\" self-validation test results: ");

...
public class bubble
{
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ViewpointObject().setDescription("Bubble in action").setOrientation(1.0f,0.0f,0.0f,0.0f).setPosition(0.0f,0.0f,4.0f))
...
"}" + "\n")
    ...
    {
        X3DObject thisExampleX3dObject = new bubble().getX3dModel();

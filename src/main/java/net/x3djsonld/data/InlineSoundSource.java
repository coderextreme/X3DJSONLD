...
public class InlineSoundSource
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform("InlineScene")
      .addChild(new Inline("inline").setUrl(new String[] {"x3d/example1.x3d"}))));
    }
    ...
    public static void main(String args[])
    {
		...
		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.InlineSoundSource\" self-validation test results: ");

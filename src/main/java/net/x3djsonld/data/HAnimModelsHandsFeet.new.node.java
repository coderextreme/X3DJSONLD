...
public class HAnimModelsHandsFeet
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform().setTranslation(-1.0,1.0,0.0)
      ...
      .addChild(new Transform("GridXY_20x20Fixed_AdjustScale").setScale(0.1,0.1,0.1)
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.HAnimModelsHandsFeet self-validation test results: ");

...
public class x3domflowers
{
  ...
  .setHead(new headObject()
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE      ).setContent("x3domflowers.x3d"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/x3domflowers.x3d")))
  .setScene(new SceneObject()
    ...
    .addChild(new GroupObject()
      .addChild(new ExternProtoDeclareObject("FlowerProto").setName("FlowerProto").setUrl(new String[] {"../data/flowerproto.json#FlowerProto"})
        ...
        .setProtoBody(new ProtoBodyObject()
          .addChild(new GroupObject()
            .addChild(new ProtoInstanceObject("FlowerProto")
              .addFieldValue(new fieldValueObject().setName("vertex").setValue(new String[] {"../shaders/x3dom_flowers_chromatic.vs"}))

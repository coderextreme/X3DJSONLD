...
"			}" + "\n")
              ...
              .addField(new fieldObject().setName("e").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue(5f))
              .addField(new fieldObject().setName("f").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue(5f))
              .addField(new fieldObject().setName("g").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue(5f))
              .addField(new fieldObject().setName("h").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setValue(5f))

...
public class sphere
{
  ...
  .setHead(new headObject()
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE      ).setContent("sphere.x3d"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/sphere.x3d"))
  ...
  .setScene(new SceneObject()
    ...
    {
        X3DObject thisExampleX3dObject = new sphere().getX3dModel();

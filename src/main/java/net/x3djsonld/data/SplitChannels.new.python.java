...
public class SplitChannels
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new ChannelSplitter("ChannelSplitter").setChannelCountMode("EXPLICIT")
      .setSource(new AudioClip().setDescription("Violin").setUrl(new String[] {"sound/violin.mp3","https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/violin.mp3"})))

...
public class indexedfaceset_pixeltexture_part
{
  ...
  .setHead(new headObject()
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE        ).setContent("indexedfaceset_pixeltexture_part.x3d"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_part-front.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_part-rear.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_part-top.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_part-bottom.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_part-left.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_part-right.jpg"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_DESCRIPTION  ).setContent("Test of browser ability to map a partial portion of an PixelTexture onto an IndexedFaceSet geometry. Only the yellow portion of four equal sized red, green, yellow and white squares in the pixel texture map all the faces of the cube."))
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER   ).setContent("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_part.x3d"))
  ...
  .setScene(new SceneObject()
    ...
    {
        X3DObject thisExampleX3dObject = new indexedfaceset_pixeltexture_part().getX3dModel();

  ...
  .setScene(new SceneObject()
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.print("WARNING: \"indexedfaceset_pixeltexture_part\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");

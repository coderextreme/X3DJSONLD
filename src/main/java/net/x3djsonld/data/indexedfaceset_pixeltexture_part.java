...
public class indexedfaceset_pixeltexture_part
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_part.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape()
      ...
      .setGeometry(new IndexedFaceSet().setColorPerVertex(false).setCreaseAngle(0.5f).setCoordIndex(new int[] {0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1}).setTexCoordIndex(new int[] {0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1})
        ...
        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new float[] {0.5f,1.0f,0.5f,0.5f,1.0f,1.0f,1.0f,0.5f}))))));
    }

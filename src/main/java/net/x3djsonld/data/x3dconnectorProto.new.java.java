...
public class x3dconnectorProto
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform("G3").setTranslation(1.0,1.0,0.01)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(0.2,0.7,0.2)))
        .setGeometry(new Sphere().setRadius(0.1)))
      .addChild(new PlaneSensor("PS3").setDescription("Grab to move").setOffset(1.0,1.0,0.01))
      .addChild(new ROUTE().setFromNode("PS3").setFromField("translation_changed").setToNode("G3").setToField("set_translation")))
    .addChild(new Transform("G4").setTranslation(-1.0,1.0,0.01)
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(0.2,0.7,0.2)))
        .setGeometry(new Sphere().setRadius(0.1)))
      .addChild(new PlaneSensor("PS4").setDescription("Grab to move").setOffset(-1.0,1.0,0.01))

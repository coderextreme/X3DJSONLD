  ...
  .setScene(new Scene()
    ...
    .addChild(new StreamAudioDestination().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setHtmlID("AudioDestination")
      .addChild(new Gain().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setHtmlID("Gain3")
        .addChild(new ChannelMerger().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setHtmlID("ChannelMerger")
          .addChild(new ChannelSelector().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setHtmlID("ChannelSelector0")

 ...
 * <p> Original version of articulated 3D game character designed with a general graphics tool, then converted into an X3D HAnim model. </p>
 <p> Related links:  source JinOriginalLOA1.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
        <caption>Scene Meta Information</caption>
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.JinOriginalLOA1&nbsp; Document Metadata </td>
		</tr>

		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> title </i> </td>
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA1.x3d">JinOriginalLOA1.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA1.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA1.x3d</a> </td>
		</tr>
		<tr>
...
public class JinOriginalLOA1
{
	/** Default constructor to create this object. */
	public JinOriginalLOA1 ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("JinOriginalLOA1.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("JinLOA1.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA1.x3d"))
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setTitle("JinOriginalLOA1.x3d"))
        ...
        .addChild(new HAnimSegment("hanim_sacrum").setName("sacrum")
          .addChild(new Transform().setTranslation(0.0,30.530001,-0.707600)
            .addChild(new Shape()
              ...
              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_8_36_coordIndex()).setTexCoordIndex(getIndexedFaceSet_8_36_texCoordIndex())
                .setCoord(new Coordinate().setPoint(getCoordinate_9_36_point()))
          ...
          .addChild(new HAnimSegment("hanim_pelvis").setName("pelvis")
            .addChild(new Transform().setTranslation(0.0,35.799999,-0.707600)
              .addChild(new Shape()
                ...
                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_9_45_coordIndex()).setTexCoordIndex(getIndexedFaceSet_9_45_texCoordIndex())
                  .setCoord(new Coordinate().setPoint(getCoordinate_10_45_point()))
                  .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.6211,0.5754,0.7851,0.5720,0.7614,0.5720,0.6907,0.5698,0.6200,0.5698,0.6158,0.5702,0.5451,0.5702,0.4167,0.5698,0.5451,0.5702,0.6158,0.5702,0.6200,0.5698,0.6907,0.5698,0.7614,0.5720,0.8036,0.5346,0.7761,0.5346,0.6989,0.4838,0.6219,0.4428,0.6154,0.4438,0.5492,0.4639,0.4166,0.5346,0.5492,0.4639,0.6154,0.4438,0.6219,0.4428,0.6989,0.4838,0.7761,0.5346,0.7912,0.4044,0.7635,0.4044,0.7042,0.3925,0.6194,0.3907,0.6148,0.3907,0.5450,0.3974,0.4163,0.4938,0.5450,0.3974,0.6148,0.3907,0.6194,0.3907,0.7042,0.3925,0.7635,0.4044,0.7950,0.3772,0.7662,0.3772,0.6945,0.3645,0.6236,0.3695,0.6160,0.3695,0.5438,0.3780,0.4160,0.4530,0.5438,0.3780,0.6160,0.3695,0.6236,0.3695,0.6945,0.3645,0.7662,0.3772,0.7887,0.3451,0.7635,0.3451,0.6980,0.3508,0.6262,0.3508,0.6297,0.3503,0.5389,0.3503,0.4181,0.3884,0.5389,0.3503,0.6297,0.3503,0.6262,0.3508,0.6980,0.3508,0.7635,0.3451,0.6237,0.3398})))))))
              ...
              .addChild(new Transform().setTranslation(4.207,32.020,-0.815500)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                    .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_10_54_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_54_texCoordIndex())
                    .setCoord(new Coordinate().setPoint(getCoordinate_11_54_point()))
                  ...
                  .addChild(new Transform().setTranslation(3.854,3.939,-0.703800)
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_12_72_coordIndex()).setTexCoordIndex(getIndexedFaceSet_12_72_texCoordIndex())
              ...
              .addChild(new Transform().setTranslation(-4.207,32.020,-0.815500)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                  .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_9_135_coordIndex()).setTexCoordIndex(getIndexedFaceSet_9_135_texCoordIndex())
                  .setCoord(new Coordinate().setPoint(getCoordinate_10_135_point()))
                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_10_136_point()))))))
              ...
              .addChild(new Transform().setTranslation(0.0,57.430,-0.686300)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                    .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_10_144_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_144_texCoordIndex())
                    .setCoord(new Coordinate().setPoint(getCoordinate_11_144_point()))
                    .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_11_145_point()))))))
	...
	// end of initialize() method
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_8_36_texCoordIndex_1()
		{
			int[] value = {0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,5,-1,0,5,6,-1,0,6,7,-1,0,7,8,-1,0,8,9,-1,0,9,10,-1,0,10,11,-1,0,11,12,-1,0,12,1,-1,14,2,1,-1,1,13,14,-1,15,3,2,-1,2,14,15,-1,16,4,3,-1,3,15,16,-1,17,5,4,-1,4,16,17,-1,18,6,5,-1,5,17,18,-1,19,7,6,-1,6,18,19,-1,20,8,7,-1,7,19,20,-1,21,9,8,-1,8,20,21,-1,22,10,9,-1,9,21,22,-1,23,11,10,-1,10,22,23,-1,24,12,11,-1,11,23,24,-1,13,1,12,-1,12,24,13,-1,26,14,13,-1,13,25,26,-1,27,15,14,-1,14,26,27,-1,28,16,15,-1,15,27,28,-1,29,17,16,-1,16,28,29,-1,30,18,17,-1,17,29,30,-1,31,19,18,-1,18,30,31,-1,32,20,19,-1,19,31,32,-1,33,21,20,-1,20,32,33,-1,34,22,21,-1,21,33,34,-1,35,23,22,-1,22,34,35,-1,36,24,23,-1,23,35,36,-1,25,13,24,-1,24,36,25,-1,38,26,25,-1,25,37,38,-1,39,27,26,-1,26,38,39,-1,40,28,27,-1,27,39,40,-1,41,29,28,-1,28,40,41,-1,42,30,29,-1,29,41,42,-1,43,31,30,-1,30,42,43,-1,44,32,31,-1,31,43,44,-1,45,33,32,-1,32,44,45,-1,46,34,33,-1,33,45,46,-1,47,35,34,-1,34,46,47,-1,48,36,35,-1,35,47,48,-1,37,25,36,-1,36,48,37,-1,50,38,37,-1,37,49,50,-1,51,39,38,-1,38,50,51,-1,52,40,39,-1,39,51,52,-1,53,41,40,-1,40,52,53,-1,54,42,41,-1,41,53,54,-1,55,43,42,-1,42,54,55,-1,56,44,43,-1,43,55,56,-1,57,45,44,-1,44,56,57,-1,58,46,45,-1,45,57,58,-1,59,47,46,-1,46,58,59,-1,60,48,47,-1,47,59,60,-1,49,37,48,-1,48,60,49,-1,61,50,49,-1,61,51,50,-1,61,52,51,-1,61,53,52,-1,61,54,53,-1,61,55,54,-1,61,56,55,-1,61,57,56,-1,61,58,57,-1,61,59,58,-1,61,60,59,-1,61,49,60,-1};
			return value;
		}
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_9_45_coordIndex_1()
		{
			int[] value = {0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,5,-1,0,5,6,-1,0,6,7,-1,0,7,8,-1,0,8,9,-1,0,9,10,-1,0,10,11,-1,0,11,12,-1,0,12,1,-1,14,2,1,-1,1,13,14,-1,15,3,2,-1,2,14,15,-1,16,4,3,-1,3,15,16,-1,17,5,4,-1,4,16,17,-1,18,6,5,-1,5,17,18,-1,19,7,6,-1,6,18,19,-1,20
,47,-1,48,36,35,-1,35,47,48,-1,37,25,36,-1,36,48,37,-1,50,38,37,-1,37,49,50,-1,51,39,38,-1,38,50,51,-1,52,40,39,-1,39,51,52,-1,53,41,40,-1,40,52,53,-1,54,42,41,-1,41,53,54,-1,55,43,42,-1,42,54,55,-1,56,44,43,-1,43,55,56,-1,57,45,44,-1,44,56,57,-1,58,46,45,-1,45,57,58,-1,59,47,46,-1,46,58,59,-1,60,48,47,-1,47,59,60,-1,49,37,48,-1,48,60,49,-1,61,50,49,-1,61,51,50,-1,61,52,51,-1,61,53,52,-1,61,54,53,-1,61,55,54,-1,61,56,55,-1,61,57,56,-1,61,58,57,-1,61,59,58,-1,61,60,59,-1,61,49,60,-1};
			return value;
		}
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_54_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_54_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_12_72_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_12_72_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_94_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_94_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_12_112_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_12_112_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_9_135_coordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_9_135_coordIndex_2()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_9_135_texCoordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_9_135_texCoordIndex_2()
		{
		...
		private double[] getCoordinate_10_135_point_1()
		{
		...
		private double[] getCoordinate_10_135_point_2()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_10_136_point_1()
		{
		...
		private double[] getTextureCoordinate_10_136_point_2()
		{
		...
		private double[] getTextureCoordinate_10_136_point_3()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_144_coordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_10_144_coordIndex_2()
		{
		...
		private int[] getIndexedFaceSet_10_144_coordIndex_3()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_144_texCoordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_10_144_texCoordIndex_2()
		{
		...
		private int[] getIndexedFaceSet_10_144_texCoordIndex_3()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getCoordinate_11_144_point_1()
		{
		...
		private double[] getCoordinate_11_144_point_2()
		{
		...
		private double[] getCoordinate_11_144_point_3()
		{
		...
		private double[] getCoordinate_11_144_point_4()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_11_145_point_1()
		{
		...
		private double[] getTextureCoordinate_11_145_point_2()
		{
		...
		private double[] getTextureCoordinate_11_145_point_3()
		{
		...
		private double[] getTextureCoordinate_11_145_point_4()
		{
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=8, element #36, 480 total numbers.
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=8, element #36, 480 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_8_36_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_8_36_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_8_36_texCoordIndex_1()));
			return IndexedFaceSet_8_36_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=9, element #36, 186 total numbers made up of 62 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_9_45_coordIndex()
		{
			MFInt32 IndexedFaceSet_9_45_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_9_45_coordIndex_1()));
			return IndexedFaceSet_9_45_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #45, 480 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_9_45_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_9_45_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_9_45_texCoordIndex_1()));
			return IndexedFaceSet_9_45_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #45, 186 total numbers made up of 62 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_10_45_point()
		{
			MFVec3f Coordinate_10_45_point = new MFVec3f(new double[] {0.0,1.0530,0.0273,0.0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.8750,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0.0,0.9123,0.5960,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.8750,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0.0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.9800,0.5267,-0.4285,-1.1320,0.5267,0.0273,-0.9800,0.5267,0.4830,-0.5658,0.5267,0.6985,0.0,0.5267,0.8206,0.5658,0.5267,0.6985,0.9800,0.5267,0.4830,1.1320,0.5267,0.0273,0.9800,0.5267,-0.4285,0.5658,0.5267,-0.7621,0.0,0.0,-0.9616,-0.6534,0.0,-0.8206,-1.1320,0.0,-0.4353,-1.3070,0.0,0.0273,-1.1320,0.0,0.5536,-0.6534,0.0,0.8206,0.0,0.0,0.9616,0.6534,0.0,0.8206,1.1320,0.0,0.5536,1.3070,0.0,0.0273,1.1320,0.0,-0.4353,0.6534,0.0,-0.8206,0.0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.9800,-0.5267,-0.3648,-1.1320,-0.5267,0.0273,-0.9800,-0.5267,0.4830,-0.5658,-0.5267,0.6985,0.0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.9800,-0.5267,0.4830,1.1320,-0.5267,0.0273,0.9800,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0.0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.4830,0.0,-0.9123,0.5536,0.3267,-0.9123,0.4830,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0.0,-1.0530,0.0273});
			return Coordinate_10_45_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #54, 488 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_54_coordIndex()
		{
			MFInt32 IndexedFaceSet_10_54_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_54_coordIndex_1()));
			return IndexedFaceSet_10_54_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #54, 488 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_54_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_10_54_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_54_texCoordIndex_1()));
			return IndexedFaceSet_10_54_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #54, 189 total numbers made up of 63 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_12_72_coordIndex()
		{
			MFInt32 IndexedFaceSet_12_72_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_72_coordIndex_1()));
			return IndexedFaceSet_12_72_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #72, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_12_72_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_12_72_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_72_texCoordIndex_1()));
			return IndexedFaceSet_12_72_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #72, 165 total numbers made up of 55 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_94_coordIndex()
		{
			MFInt32 IndexedFaceSet_10_94_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_94_coordIndex_1()));
			return IndexedFaceSet_10_94_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #94, 488 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_94_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_10_94_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_94_texCoordIndex_1()));
			return IndexedFaceSet_10_94_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #94, 189 total numbers made up of 63 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_11_94_point()
		{
			MFVec3f Coordinate_11_94_point = new MFVec3f(new double[] {-2.9600,3.7380,0.0,-1.6430,3.7380,3.2090,1.3160,3.7380,4.0020,3.3670,3.7380,1.7810,3.3670,3.7380,-1.7810,1.3160,3.7380,-4.0020,-1.6430,3.7380,-3.2090,-2.9600,-0.0114,0.0,-1.6430,-0.0114,3.2090,1.3160,-0.0114,4.0020,3.3670,-0.0114,1.7810,3.3670,-0.0114,-1.7810,1.3160,-0.0114,-4.0020,-1.6430,-0.0114,-3.2090,-2.9600,-6.5070,0.0,-1.6430,-6.5070,3.2090,1.3160,-6.5070,4.0020,3.3670,-6.5070,1.7810,3.3670,-6.5070,-1.7810,1.3160,-6.5070,-4.0020,-1.6430,-6.5070,-3.2090,-3.3670,-13.1300,0.0,-1.8970,-13.1300,3.5820,1.4070,-13.1300,4.4670,3.3550,-13.1300,1.9880,3.3550,-13.1300,-1.9880,1.
point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #135, 1336 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_9_135_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_9_135_coordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_9_135_coordIndex_2()));
			return IndexedFaceSet_9_135_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #135, 1336 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_9_135_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_9_135_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_9_135_texCoordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_9_135_texCoordIndex_2()));
			return IndexedFaceSet_9_135_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #135, 522 total numbers made up of 174 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_135_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_135_point_1()))
				.append(new MFVec3f(getCoordinate_10_135_point_2()));
			return Coordinate_10_135_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #136, 420 total numbers made up of 210 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_10_136_point()
		{
			MFVec2f TextureCoordinate_10_136_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_10_136_point_1()))
				.append(new MFVec2f(getTextureCoordinate_10_136_point_2()))
				.append(new MFVec2f(getTextureCoordinate_10_136_point_3()));
			return TextureCoordinate_10_136_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #144, 2368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_144_coordIndex()
		{
			MFInt32 IndexedFaceSet_10_144_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_144_coordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_10_144_coordIndex_2()))
				.append(new MFInt32(getIndexedFaceSet_10_144_coordIndex_3()));
			return IndexedFaceSet_10_144_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #144, 2368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_144_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_10_144_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_144_texCoordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_10_144_texCoordIndex_2()))
				.append(new MFInt32(getIndexedFaceSet_10_144_texCoordIndex_3()));
			return IndexedFaceSet_10_144_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #144, 1068 total numbers made up of 356 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_11_144_point()
		{
			MFVec3f Coordinate_11_144_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_11_144_point_1()))
				.append(new MFVec3f(getCoordinate_11_144_point_2()))
				.append(new MFVec3f(getCoordinate_11_144_point_3()))
				.append(new MFVec3f(getCoordinate_11_144_point_4()));
			return Coordinate_11_144_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=11, element #145, 772 total numbers made up of 386 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_11_145_point()
		{
			MFVec2f TextureCoordinate_11_145_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_11_145_point_1()))
				.append(new MFVec2f(getTextureCoordinate_11_145_point_2()))
				.append(new MFVec2f(getTextureCoordinate_11_145_point_3()))
				.append(new MFVec2f(getTextureCoordinate_11_145_point_4()));
			return TextureCoordinate_11_145_point;
		}
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new JinOriginalLOA1().getX3dModel();
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.JinOriginalLOA1\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.JinOriginalLOA1 self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./JinOriginalLOA1_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./JinOriginalLOA1_JavaExport.x3d"; 
                String filenameX3DV = "./JinOriginalLOA1_JavaExport.x3dv"; 
                String filenameJSON = "./JinOriginalLOA1_JavaExport.json";

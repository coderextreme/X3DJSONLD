 ...
 <p> Related links:  source KoreanCharacter07No.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/../Poses/images/HAnimPoseExampleKoreanCharacter07No.png">../Poses/images/HAnimPoseExampleKoreanCharacter07No.png</a> </td>
		</tr>
		<tr>
...
public class KoreanCharacter07No
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("../Poses/images/HAnimPoseExampleKoreanCharacter07No.png"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new EXPORT().setLocalDEF("hanim_No").setAS("KoreanCharacter07No")));
            }
            catch (Exception ex)
            {       
	...
	// end of initialize() method
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_10_51_coordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_10_51_texCoordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_12_69_coordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_12_69_texCoordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_10_91_coordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_10_91_texCoordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_12_109_coordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_12_109_texCoordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_10_131_coordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_10_131_texCoordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_12_149_texCoordIndex_1()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=1 */
		private double[] getTextureCoordinate_13_150_point_1()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=2 */
		private double[] getTextureCoordinate_13_150_point_2()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_10_161_coordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_10_161_texCoordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_12_179_coordIndex_1()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=1 */
		private int[] getIndexedFaceSet_12_179_texCoordIndex_1()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=1 */
		private double[] getTextureCoordinate_13_180_point_1()
		{
			double[] value = {0.2854,0.4170,0.2772,0.4100,0.2831,0.4080,0.2903,0.4146,0.2650,0.4285,0.2586,0.4199,0.2705,0.4138,0.2773,0.4212,0.2523,0.4135,0.2473,0.4093,0.2624,0.4028,0.2621,0.4091,0.1715,0.4268,0.1606,0.4270,0.1557,0.4048,0.1661,0.4058,0.1642,0.3989,0.1542,0.3981,0.2716,0.4031,0.2696,0.4063,0.1787,0.4088,0.1762,0.4019,0.1834,0.4266,0.2945,0.4248,0.2904,0.4267,0.2831,0.4307,0.2689,0.4390,0.1470,0.4291,0.1436,0.4079,0.1429,0.4003,0.2923,0.4372,0.2958,0.4382,0.2727,0.4496,0.2874,0.4405,0.1356,0.4327,0.1330,0.4126,0.1318,0.4062,0.2758,0.4563,0.1279,0.4134,0.2905,0.4451,0.1841,0.4441,0.1730,0.4428,0.2336,0.4239,0.2320,0.4181,0.2553,0.4468,0.1634,0.4452,0.1514,0.4479,0.2509,0.4359,0.1412,0.4529,0.1367,0.4599,0.2432,0.4272,0.2531,0.4616,0.2586,0.4664,0.1365,0.4760,0.1366,0.4681,0.2410,0.4558,0.2368,0.4586,0.1496,0.4794,0.1502,0.4711,0.1836,0.4592,0.1761,0.4601,0.2253,0.4494,0.1684,0.4630,0.2261,0.4579,0.1588,0.4664,0.1796,0.4752,0.1737,0.4740,0.1709,0.4735,0.1663,0.4756,0.1620,0.4762,0.1602,0.4819,0.1617,0.4895,0.2206,0.4327,0.2187,0.4259,0.2227,0.4378,0.2131,0.4560,0.2115,0.4515,0.2119,0.4457,0.2094,0.4437,0.2061,0.4411,0.2017,0.4524,0.1652,0.3951,0.1534,0.3946,0.1894,0.4248,0.1835,0.4079,0.1786,0.3986,0.1411,0.3973,0.1285,0.4039,0.1298,0.4342,0.1930,0.4435,0.1346,0.4831,0.1474,0.4881,0.1921,0.4603,0.1832,0.4783,0.1721,0.4818,0.1111,0.4765,0.1087,0.4729,0.1098,0.4688,0.1162,0.4670,0.1174,0.4712};
			return value;
		}
		...
		/** Define subarray values using type double[] with $tupleSize=2 and $tupleSplitSize=100 for subarray position()=2 */
		private double[] getTextureCoordinate_13_180_point_2()
		{
			double[] value = {0.1140,0.4745,0.2355,0.4800,0.2390,0.4794,0.2410,0.4768,0.2455,0.4762};
			return value;
		}
		...
		private int[] getIndexedFaceSet_10_191_coordIndex_3()
		{
		...
		/** Define subarray values using type int[] with $tupleSize=1 and $tupleSplitSize=100 for subarray position()=3 */
		private int[] getIndexedFaceSet_10_191_texCoordIndex_3()
		{
		...
		private double[] getCoordinate_11_191_point_3()
		{
		...
		private double[] getTextureCoordinate_11_192_point_4()
		{
		...
		{
			MFInt32 IndexedFaceSet_10_51_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_51_coordIndex_1()));
			return IndexedFaceSet_10_51_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #51, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_10_51_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_51_texCoordIndex_1()));
			return IndexedFaceSet_10_51_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #51, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_12_69_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_69_coordIndex_1()));
		...
		{
			MFInt32 IndexedFaceSet_12_69_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_69_texCoordIndex_1()));
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #83, 144 total numbers made up of 72 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #91, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_10_91_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_91_coordIndex_1()));
			return IndexedFaceSet_10_91_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #91, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_10_91_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_91_texCoordIndex_1()));
			return IndexedFaceSet_10_91_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #91, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_11_91_point = new MFVec3f(new double[] {-0.6802,-14.4700,-1.0460,-1.1310,-14.4700,-0.1321,0.1728,-14.4700,-1.4610,1.4400,-14.4700,-0.1770,0.9948,-14.4700,0.7524,0.2093,-14.4700,1.4330,-0.6826,-14.4700,0.8297,-1.7660,-1.6070,-0.1210,-0.9594,-1.5940,-1.5150,0.0470,-1.5800,-2.1360,1.7780,-1.5570,-0.1829,1.1690,-1.6030,1.1930,0.0665,-1.6370,1.9010,-0.9540,-1.5960,1.2040,0.8812,-14.4700,-0.9886,1.0760,-1.5660,-1.6420,-0.8712,-6.9870,-1.4620,-1.5800,-6.8200,-0.1242,0.2167,-7.2650,-2.0160,1.6850,-7.6320,-0.1812,1.0540,-7.5280,-1.4910,1.1070,-7.5530,1.1060,0.1228,-7.2530,1.7730,-0.9062,-7.0280,1.1670,-0.7544,-13.4400,-1.1200,0.1636,-13.4200,-1.6010,1.4650,-13.4500,-0.1774,1.0020,-13.4700,0.7811,0.2213,-13.4600,1.4830,-0.6466,-13.4700,0.8065,-1.1970,-13.4500,-0.1309,0.9586,-13.4700,-1.0840,0.1840,-14.7900,-0.1550,-1.9470,0.0101,-0.1035,-1.0830,0.0162,-1.5340,0.0672,0.0385,-2.0650,1.9470,0.0623,-0.1715,1.2530,0.0335,1.4160,0.0571,0.0079,2.1360,-1.1190,0.0202,1.4490,1.2110,0.0535,-1.6410,-1.6800,1.5440,-0.0900,-0.9219,1.5480,-1.3460,0.0599,1.5680,-1.7990,1.0080,1.5810,-1.4470,1.6540,1.5890,-0.1584,1.0330,1.5620,1.2630,0.0368,1.5390,1.8620,-0.9449,1.5530,1.2880,0.0222,2.1530,-0.0477});
		...
		{
			MFVec3f Coordinate_12_100_point = new MFVec3f(new double[] {-1.7310,-1.8780,0.0290,-1.2220,-1.8780,-1.4950,0.1851,-1.8780,-1.8250,1.3630,-1.8780,-1.5010,1.8830,-1.8780,0.0290,0.9249,-0.0082,0.7476,-1.5020,-4.0210,0.0290,1.6330,-4.0210,0.0290,1.2660,-4.0210,-1.5100,-1.1310,-4.0210,-1.5040,-0.9183,-1.0020,-1.2830,0.1851,-0.9421,-1.6040,1.2020,-0.9993,-1.2830,1.7210,-1.0250,0.0290,1.5200,-0.9401,1.0790,-1.2060,-0.9401,1.0800,-1.3950,-1.0250,0.0290,1.3830,-3.5570,-1.5180,-1.6520
coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_109_coordIndex_1()));
		...
		{
			MFInt32 IndexedFaceSet_12_109_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_109_texCoordIndex_1()));
		...
		{
			MFVec3f Coordinate_13_109_point = new MFVec3f(new double[] {1.6960,-0.8024,0.9010,0.1851,-0.1712,1.3130,-1.4330,-0.8024,0.8928,-1.5850,-3.0950,0.8819,0.1851,-3.0950,0.8819,1.6460,-3.0950,0.8819,-1.8460,-1.2290,2.1820,0.2812,-0.6275,2.4350,1.9680,-1.2290,2.1840,-2.0070,-3.0950,2.1780,0.1851,-3.0950,2.1780,2.1120,-3.0950,2.1780,-1.9310,-1.6330,3.5720,0.2858,-1.1420,3.8450,2.0590,-1.6330,3.5620,-2.1480,-3.0950,3.6280,0.1851,-3.0950,3.6280,2.2500,-3.0950,3.6280,-1.4860,-2.1290,4.5100,0.2858,-1.5970,4.8930,1.7970,-2.1290,4.4460,-1.7810,-3.0950,4.6870,0.2858,-3.0950,5.2560,1.9250,-3.0950,4.6870,-1.7720,-2.6310,0.8819,0.2858,-2.6310,5.4120,1.8570,-2.6310,0.8819,-2.2230,-2.6310,2.1780,2.2930,-2.6310,2.1780,-2.3410,-2.6310,3.6280,2.3940,-2.6310,3.6280,-1.8400,-2.6310,4.7560,2.0170,-2.6310,4.7560,1.5200,-0.0134,0.0048,-1.2060,-0.0134,0.0061,0.1851,0.3576,0.6662,1.7960,-0.9332,-0.1518,-1.5920,-0.9332,-0.1559,-1.5410,-3.0950,-0.1518,1.6390,-3.0950,-0.1518,-1.7080,-2.6310,-0.1518,1.8200,-2.6310,-0.1518,0.1851,-3.0950,-0.1518,0.1828,0.0846,-0.6939,-0.8905,-0.1781,-1.3410,-1.1750,-0.8458,-1.4680,-1.2810,-2.3210,-1.4120,-1.2450,-2.4920,-1.3940,0.1856,-2.4920,-1.3940,1.3520,-2.4920,-1.3940,1.3980,-2.3210,-1.4120,1.3750,-0.8458,-1.4680,1.1780,-0.1781,-1.3410});
			return Coordinate_13_109_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #122, 856 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #122, 856 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #122, 327 total numbers made up of 109 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #123, 256 total numbers made up of 128 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #131, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_10_131_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_131_coordIndex_1()));
			return IndexedFaceSet_10_131_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #131, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_10_131_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_131_texCoordIndex_1()));
			return IndexedFaceSet_10_131_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #131, 222 total numbers made up of 74 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_12_149_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_149_coordIndex_1()));
			return IndexedFaceSet_12_149_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #149, 656 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_12_149_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_149_texCoordIndex_1()));
			return IndexedFaceSet_12_149_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #149, 252 total numbers made up of 84 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_13_150_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_13_150_point_1()))
				.append(new MFVec2f(getTextureCoordinate_13_150_point_2()));
			return TextureCoordinate_13_150_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #161, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_10_161_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_161_coordIndex_1()));
			return IndexedFaceSet_10_161_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #161, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_10_161_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10
7450,0.6589,-0.3549,-4.5930,1.3670,0.0071,-4.4900,1.4290,0.5110,-1.8090,-1.2690,-0.5069,-1.8630,-1.2910,0.1385,-1.8800,-1.4330,-0.8834,-2.0650,-0.6619,-1.0840,-2.0410,-0.0220,0.4454,-2.0400,1.2410,0.8595,-1.4390,0.8284,0.9394,-1.1670,1.1290,0.4703,-2.4920,0.5589,0.5852,-1.1330,1.4940,0.2387,-1.3500,1.6910,-0.0662,-1.6920,1.4610,0.7589,-0.6824,0.1014,0.7016,-0.5391,0.6842,0.5615,-2.5280,-0.1514,0.2145,-0.4170,1.0970,-0.2343,-0.6792,1.1510,-0.5466,-1.9440,1.3970,0.6186,-0.7820,-1.0820,-0.4937,-0.8981,-1.1190,0.1599,-0.9475,-1.2560,-0.7682,-0.9026,-0.6282,-0.8526,-0.8017,-0.0674,-0.9273,-2.0630,0.7753,-0.7028,-0.7443,0.6125,0.5058,-2.2790,-0.8314,0.6034,-0.7674,-0.6877,-0.1927,0.0580,-0.6160,-0.5424,0.0580,-0.3011,-0.6496,0.0580,-0.0830,-0.3722,0.0580,0.5801,0.0857,0.0580,0.6207,0.5588,0.0580,0.2743,0.5350,0.0580,-0.0465,0.4787,0.0580,-0.6034,0.1506,0.0580,-0.6883,-0.5294,0.0580,0.2886,0.4160,0.0580,-0.3860,-0.0434,0.3889,-0.0832,1.5480,-2.4170,1.6760,1.4110,-2.5800,1.5420,1.1350,-2.6190,1.5250,0.8304,-2.4130,1.7100,0.9952,-2.2390,1.9030,1.3400,-2.3120,1.8130});
			return Coordinate_13_179_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=13, element #180, 210 total numbers made up of 105 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_13_180_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_13_180_point_1()))
				.append(new MFVec2f(getTextureCoordinate_13_180_point_2()));
			return TextureCoordinate_13_180_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #191, 2016 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_10_191_coordIndex()
		{
			MFInt32 IndexedFaceSet_10_191_coordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_10_191_coordIndex_3()));
			return IndexedFaceSet_10_191_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #191, 2016 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_10_191_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_10_191_texCoordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_10_191_texCoordIndex_3()));
			return IndexedFaceSet_10_191_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #191, 855 total numbers made up of 285 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec3f getCoordinate_11_191_point()
		{
			MFVec3f Coordinate_11_191_point = new MFVec3f()/*2.finalize*/
				...
				.append(new MFVec3f(getCoordinate_11_191_point_3()));
			return Coordinate_11_191_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=11, element #192, 646 total numbers made up of 323 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_11_192_point()
		{
			MFVec2f TextureCoordinate_11_192_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_11_192_point_4()));
			return TextureCoordinate_11_192_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=11, element #200, 2188 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #200, 2188 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #200, 915 total numbers made up of 305 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #201, 660 total numbers made up of 330 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.KoreanCharacter07No self-validation test confirmation: ");

 ...
 <p> Related links:  source HAnimModelsHandsFeet.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> Kwan Hee YOO and Don Brutzman </td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> reference </i> </td>
			<td> <a href="https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/hanim.html" target="_blank">https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/hanim.html</a> </td>
		</tr>
		<tr>
	...
	* @author Kwan Hee YOO and Don Brutzman
 */
...
public class HAnimModelsHandsFeet
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_CREATOR    ).setContent("Kwan Hee YOO and Don Brutzman"))
    .addMeta(new meta().setName(meta.NAME_CREATED    ).setContent("8 February 2015"))
    .addMeta(new meta().setName(meta.NAME_MODIFIED   ).setContent("28 October 2023"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform().setTranslation(-1.0,1.0,0.0)
      ...
      .addChild(new Transform("GridXY_20x20Fixed_AdjustScale").setScale(.1,.1,.1)
        .addChild(new Inline("GridXY_20x20Fixed").setUrl(new String[] {"../../Savage/Tools/Authoring/GridXY_20x20Fixed.x3d","https://savage.nps.edu/Savage/Tools/Authoring/GridXY_20x20Fixed.x3d","../../Savage/Tools/Authoring/GridXY_20x20Fixed.wrl","https://savage.nps.edu/Savage/Tools/Authoring/GridXY_20x20Fixed.wrl"}))))
    .addChild(new Transform().setTranslation(1.0,1.0,0.0)
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.HAnimModelsHandsFeet self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./HAnimModelsHandsFeet_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./HAnimModelsHandsFeet_JavaExport.x3d"; 
                String filenameX3DV = "./HAnimModelsHandsFeet_JavaExport.x3dv"; 
                String filenameJSON = "./HAnimModelsHandsFeet_JavaExport.json";

...
import net.coderextreme.X3DRoots;import java.util.List;import java.util.ArrayList;public class ArchHalf implements X3DRoots 
{
  ...
  .setScene(new Scene()
	...
	// end of initialize() method
		...
		private double[] getArchChord_5_12_point_1()
		{
		...
		private double[] getArchChord_5_12_point_2()
		{

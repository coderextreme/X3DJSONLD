 ...
 <p> Related links: KoreanCharacter10Mi.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter10Mi.x3d">KoreanCharacter10Mi.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter10Mi.x3d" target="_blank">https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter10Mi.x3d</a> </td>
		</tr>
		<tr>
...
public class KoreanCharacter10Mi
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/KoreanCharacter10Mi.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Mi").setName("Mi").setInfo(new String[] {"authorName=Chul Hee Jung and Myeong Won Lee","authorEmail=myeongwonlee@gmail.com","creationDate=31 March 2011","humanoidVersion=1.0","gender=female","height=1.5"}).setScale(0.0225,0.0225,0.0225).setVersion("1.0")
      .addSkeleton(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,32.680000,-0.707600).setStiffness(new double[] {0.0,0.0,0.0})
        .addChild(new HAnimSegment("hanim_sacrum").setName("sacrum")
          .addChild(new Transform().setTranslation(0.0,32.680000,-0.707600)
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                .setTexture(new ImageTexture("MiTextureAtlas").setUrl(new String[] {"images/Mi.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/images/Mi.png"})))
              .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_8_25_coordIndex()).setTexCoordIndex(getIndexedFaceSet_8_25_texCoordIndex())
                .setCoord(new Coordinate().setPoint(getCoordinate_9_25_point()))
        ...
        .addChild(new HAnimJoint("hanim_l_hip").setName("l_hip").setCenter(3.309000,31.309999,-0.837700).setStiffness(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment("hanim_l_thigh").setName("l_thigh")
            .addChild(new Transform().setTranslation(3.309000,31.309999,-0.837700)
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
          ...
          .addChild(new HAnimJoint("hanim_l_knee").setName("l_knee").setCenter(3.584000,17.160000,-1.037000).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_l_ankle").setName("l_ankle").setCenter(3.602000,4.137000,0.610400).setStiffness(new double[] {0.0,0.0,0.0})
              .addChild(new HAnimSegment("hanim_l_hindfoot").setName("l_hindfoot")
                .addChild(new Transform().setTranslation(3.602000,4.137000,0.610400)
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                      .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_52_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_52_texCoordIndex())
              ...
              .addChild(new HAnimJoint("hanim_l_midtarsal").setName("l_midtarsal").setCenter(3.602000,3.020000,0.070170).setStiffness(new double[] {0.0,0.0,0.0})
                .addChild(new HAnimSegment("hanim_l_middistal").setName("l_middistal")
                  .addChild(new Transform().setTranslation(3.602000,3.020000,0.070170)
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                        .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
        ...
        .addChild(new HAnimJoint("hanim_r_hip").setName("r_hip").setCenter(-3.309000,31.309999,-0.837700).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_r_knee").setName("r_knee").setCenter(-3.584000,17.160000,-1.037000).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new Transform().setTranslation(-3.584000,17.160000,-1.037000)
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_83_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_83_texCoordIndex())
                    ...
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.8940,0.3355,0.9033,0.3536,0.8888,0.3564,0.8848,0.3395,0.9038,0.3291,0.9181,0.3492,0.8482,0.3305,0.8325,0.3485,0.8189,0.3396,0.8422,0.3186,0.8583,0.3389,0.8494,0.3547,0.8628,0.3410,0.8599,0.3566,0.8740,0.3392,0.8747,0.3563,0.9081,0.5043,0.8902,0.5010,0.9231,0.5081,0.8041,0.5143,0.8222,0.5078,0.8436,0.5014,0.8584,0.4989,0.8728,0.4998,0.9302,0.4157,0.9470,0.4098,0.9113,0.4208,0.8904,0.4240,0.8150,0.4077,0.8373,0.4108,0.8539,0.4159,0.8720,0.4201,0.8743,0.3217,0.9269,0.3433,0.9054,0.3232,0.9389,0.5152,0.7964,0.4076,0.8003,0.4609,0.9430,0.4625,0.9097,0.4626,0.9267,0.4619,0.8902,0.5010,0.9081,0.5043,0.9231,0.5081,0.8222,0.5078,0.8436,0.5014,0.8584,0.4989,0.8728,0.4998,0.9389,0.5152,0.8041,0.5143,0.8902,0.5010,0.9081,0.5043,0.9231,0.5081,0.9389,0.5152,0.8222,0.5078,0.8436,0.5014,0.8584,0.4989,0.8728,0.4998,0.8822,0.5045})))))))
            .addChild(new HAnimJoint("hanim_r_ankle").setName("r_ankle").setCenter(-3.602000,4.137000,0.610400).setStiffness(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new Transform().setTranslation(-3.602000,4.137000,0.610400)
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                      .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_92_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_92_texCoordIndex())
                      .setCoord(new Coordinate().setPoint(getCoordinate_12_92_point()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.4523,0.3285,0.4305,0.3327,0.4342,0.3498,0.4016,0.3389,0.4117,0.3596,0.4577,0.3463,0.3636,0.4309,0.3649,0.4221,0.3323,0.5009,0.3464,0.4640,0.4517,0.3097,0.3791,0.4387,0.4894,0.3285,0.4802,0.3480,0.5003,0.3671,0.3639,0.4386,0.3636,0.4309,0.3649,0.4221,0.3205,0.4942,0.4278,0.3176,0.3146,0.4792,0.3910,0.4492,0.3969,0.3186,0.4546,0.2880,0.4234,0.2922,0.3954,0.2960,0.2979,0.4905,0.3121,0.4644,0.2767,0.4647,0.2976,0.4385,0.3319,0.4273,0.5185,0.3543,0.4404,0.3653,0.4298,0.3752,0.4552,0.3612,0.4700,0.3660,0.4545,0.3833,0.4807,0.3791,0.4373,0.3575,0.4565,0.3537,0.4208,0.3674,0.4373,0.3575,0.4565,0.3537,0.4751,0.3570,0.4905,0.3731,0.4751,0.3570,0.4894,0.3285,0.4523,0.3285,0.4517,0.3097,0.4546,0.2880,0.3464,0.4640,0.3319,0.4273,0.5185,0.3543})))))))
              .addChild(new HAnimJoint("hanim_r_midtarsal").setName("r_midtarsal").setCenter(-3.602000,3.020000,0.070170).setStiffness(new double[] {0.0,0.0,0.0})
                  ...
                  .addChild(new Transform().setTranslation(-3.602000,3.020000,0.070170)
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_12_101_coordIndex()).setTexCoordIndex(getIndexedFaceSet_12_101_texCoordIndex())
                        ...
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.3792,0.4637,0.3701,0.4982,0.5611,0.3309,0.5505,0.3087,0.5574,0.2996,0.5797,0.3163,0.4886,0.3024,0.3626,0.4294,0.3994,0.4211,0.3995,0.4635,0.5574,0.2886,0.5848,0.3061,0.3998,0.5058,0.4251,0.4151,0.4863,0.2854,0.5136,0.3164,0.4285,0.4735,0.4287,0.5113,0.4484,0.4206,0.4611,0.4694,0.4496,0.5053,0.5134,0.2940,0.5114,0.2829,0.5332,0.3116,0.5420,0.3424,0.5336,0.2912,0.5373,0.2839,0.5267,0.3502,0.4523,0.3285,0.4894,0.3285,0.3319,0.4273,0.4546,0.2880,0.3323,0.5009,0.5185,0.3543,0.4517,0.3097,0.3464,0.4640,0.4523,0.3285,0.4894,0.3285,0.5185,0.3543,0.4517,0.3097,0.4546,0.2880,0.3464,0.4640,0.3323,0.5009})))))))))))
        .addChild(new HAnimJoint("hanim_sacroiliac").setName("sacroiliac").setCenter(0.050530,30.200001,-1.380000).setStiffness(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment("hanim_pelvis").setName("pelvis")
            .addChild(new Transform().setTranslation(0.050530,30.200001,-1.380000)
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                  .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
          ...
          .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_shoulder").setCenter(6.032000,48.580002,-1.277000).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new Transform().setTranslation(6.032000,48.580002,-1.277000)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                    .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_123_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_123_texCoordIndex())
                    .setCoord(new Coordinate().setPoint(getCoordinate_11_123_point()))
                    .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_11_124_point()))))))
            .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(6.032000,40.810001,-1.412000).setStiffness(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new Transform().setTranslation(6.032000,40.810001,-1.412000)
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                      .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_132_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_132_texCoordIndex())
              ...
              .addChild(new HAnimJoint("hanim_l_wrist").setName("l_wrist").setCenter(6.934000,33.959999,-1.108000).setStiffness(new double[] {0.0,0.0,0.0})
                .addChild(new HAnimSegment("hanim_l_hand").setName("l_hand")
                  .addChild(new Transform().setTranslation(6.934000,33.959999,-1.108000)
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                        .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
          ...
          .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_shoulder").setCenter(-6.032000,48.580002,-1.277000).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new Transform().setTranslation(-6.032000,48.580002,-1.277000)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                    .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_153_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_153_texCoordIndex())
                    .setCoord(new Coordinate().setPoint(getCoordinate_11_153_point()))
                    .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_11_154_point()))))))
            .addChild(new HAnimJoint("hanim_r_elbow").setName("r_elbow").setCenter(-6.032000,40.810001,-1.412000).setStiffness(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new Transform().setTranslation(-6.032000,40.810001,-1.412000)
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(0.588000,0.588000,0.588000))
                      .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_162_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_162_texCoordIndex())
                      .setCoord(new Coordinate().setPoint(getCoordinate_12_162_point()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.5737,0.0472,0.5721,0.0377,0.5736,0.0597,0.5731,0.0730,0.5718,0.0836,0.5723,0.0940,0.5750,0.1083,0.5737,0.0301,0.4707,0.0481,0.4699,0.0424,0.4736,0.0580,0.4725,0.0633,0.4717,0.0706,0.4698,0.0802,0.4664,0.0886,0.4716,0.0358,0.4640,0.0502,0.4625,0.0465,0.4669,0.0583,0.4661,0.0627,0.4549,0.0769,0.4607,0.0728,0.4621,0.0416,0.4652,0.0680,0.4552,0.0578,0.5782,0.0137,0.4685,0.0270,0.4561,0.0381,0.5222,0.0476,0.5210,0.0400,0.5236,0.0589,0.5228,0.0682,0.5218,0.0771,0.5210,0.0871,0.5207,0.0985,0.5234,0.0203,0.5227,0.0329,0.5721,0.0377,0.5731,0.0730,0.5718,0.0836,0.5723,0.0940,0.5737,0.0472,0.5736,0.0597,0.5782,0.0137,0.5750,0.1083,0.5737,0.0301,0.5737,0.0472,0.5721,0.0377,0.5737,0.0301,0.5782,0.0137,0.5723,0.0940,0.5718,0.0836,0.5731,0.0730,0.5736,0.0597,0.5735,0.0549})))))))
              .addChild(new HAnimJoint("hanim_r_wrist").setName("r_wrist").setCenter(-6.934000,33.959999,-1.108000).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_vl5").setName("vl5").setCenter(0.0,35.310001,-2.314000).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_skullbase").setName("skullbase").setCenter(0.0,35.310001,-2.314000).setStiffness(new double[] {0.0,0.0,0.0})
	...
	// end of initialize() method
		...
		private int[] getIndexedFaceSet_8_25_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_8_25_texCoordIndex_1()
		{
			int[] value = {0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,5,-1,0,5,6,-1,0,6,7,-1,0,7,8,-1,0,8,9,-1,0,9,10,-1,0,10,11,-1,0,11,12,-1,0,12,1,-1,14,2,1,-1,1,13,14,-1,15,3,2,-1,2,14,15,-1,16,4,3,-1,3,15,16,-1,17,5,4,-1,4,16,17,-1,18,6,5,-1,5,17,18,-1,19,7,6,-1,6,18,19,-1,20,8,7,-1,7,19,20,-1,21,9,8,-1,8,20,21,-1,22,10,9,-1,9,21,22,-1,23,11,10,-1,10,22,23,-1,24,12,11,-1,11,23,24,-1,13,1,12,-1,12,24,13,-1,26,14,13,-1,13,25,26,-1,27,15,14,-1,14,26,27,-1,28,16,15,-1,15,27,28,-1,29,17,16,-1,16,28,29,-1,30,18,17,-1,17,29,30,-1,31,19,18,-1,18,30,31,-1,32,20,19,-1,19,31,32,-1,33,21,20,-1,20,32,33,-1,34,22,21,-1,21,33,34,-1,35,23,22,-1,22,34,35,-1,36,24,23,-1,23,35,36,-1,25,13,24,-1,24,36,25,-1,38,26,25,-1,25,37,38,-1,39,27,26,-1,26,38,39,-1,40,28,27,-1,27,39,40,-1,41,29,28,-1,28,40,41,-1,42,30,29,-1,29,41,42,-1,43,31,30,-1,30,42,43,-1,44,32,31,-1,31,43,44,-1,45,33,32,-1,32,44,45,-1,46,34,33,-1,33,45,46,-1,47,35,34,-1,34,46,47,-1,48,36,35,-1,35,47,48,-1,37,25,36
810,2.3830,-0.3257,-3.2250,0.6429,0.9376,-0.6880,-1.2880,-13.2800,-1.2690,-1.8830,-13.3000,-0.2055,-0.2600,-13.3000,-1.8220,1.3660,-13.3000,-0.2055,0.7692,-13.2900,0.9552,-0.3090,-13.2900,1.4550,-1.3860,-13.2900,0.9030,-2.3070,-4.0260,-0.0801,-1.4620,-4.1030,-1.9690,0.0294,-4.3930,-2.5520,1.9980,-5.6800,-0.2566,1.2540,-5.4040,1.0750,-0.0591,-4.9490,1.7580,-1.5890,-4.4420,1.2000,0.8262,-13.3000,-1.2480,1.2110,-4.9940,-1.7490,-1.9120,-14.2000,-0.2055,-1.2710,-14.1900,-1.2680,-0.2451,-14.2000,-1.6370,1.3620,-14.2000,-0.2055,0.7527,-14.2300,1.0330,-0.3053,-14.2300,1.5090,-1.3860,-14.2000,0.9918,0.7947,-14.2000,-1.2700,-1.4090,-8.6890,-1.5990,-2.1440,-8.6560,-0.1467,-0.1255,-8.8440,-2.1970,1.7130,-9.4940,-0.3801,1.0360,-9.1480,-1.5160,1.0280,-9.3530,1.0220,-0.1954,-9.1220,1.6480,-1.5240,-8.8660,1.0640,-1.0890,-14.9200,-0.8621,-1.6070,-14.9300,-0.1806,-1.1790,-14.9300,0.5933,-0.3043,-14.9600,0.9257,0.5477,-14.9500,0.6210};
			return value;
		}
		private double[] getCoordinate_10_74_point_2()
		{
			double[] value = {1.0510,-14.9300,-0.1925,0.6004,-14.9300,-0.8652,-0.2468,-14.9300,-1.1030,-0.2786,-15.2600,-0.1290};
			return value;
		}
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_10_75_point_1()
		{
			double[] value = {0.1069,0.3430,0.3185,0.3293,0.3029,0.3225,0.3282,0.3101,0.2734,0.2662,0.2544,0.2888,0.2296,0.2739,0.2396,0.2502,0.3084,0.2869,0.2850,0.3055,0.1408,0.2716,0.1481,0.2767,0.1249,0.3093,0.1714,0.2464,0.1882,0.2699,0.2000,0.2391,0.2031,0.2662,0.0639,0.3017,0.0965,0.2743,0.2453,0.2144,0.2872,0.2285,0.3265,0.2508,0.3593,0.2732,0.1250,0.2431,0.1604,0.2178,0.1995,0.2076,0.0236,0.1943,0.0619,0.1721,0.2458,0.1126,0.2971,0.1274,0.3423,0.1471,0.3777,0.1657,0.1005,0.1443,0.1441,0.1215,0.1906,0.1110,0.0208,0.1880,0.0160,0.1743,0.0567,0.1520,0.0614,0.1652,0.2448,0.1094,0.2452,0.0967,0.2974,0.1079,0.2945,0.1227,0.3441,0.1270,0.3402,0.1414,0.3814,0.1444,0.3778,0.1589,0.0970,0.1267,0.1013,0.1394,0.1422,0.1055,0.1456,0.1183,0.1897,0.0954,0.1915,0.1087,0.0160,0.1679,0.0548,0.1462,0.0961,0.1218,0.1415,0.1013,0.1890,0.0913,0.2453,0.0918,0.2985,0.1032,0.3449,0.1222,0.3819,0.1386,0.2185,0.3428,0.3439,0.3447,0.3832,0.2892,0.4018,0.1748,0.4051,0.1678,0.4081,0.1530,0.4062,0.1467,0.8940,0.6145,0.8705,0.6133,0.9121,0.6128,0.9281,0.6071,0.8164,0.6072,0.7920,0.5946,0.8333,0.6113,0.8519,0.6125,0.9067,0.7832,0.8744,0.7788,0.9293,0.7874,0.9807,0.7952,0.9547,0.7897,0.7989,0.7844,0.8241,0.7790,0.8502,0.7774,0.9432,0.5976,0.7714,0.7941,0.9081,0.5043,0.8902,0.5010,0.9231,0.5081,0.8222,0.5078,0.8041,0.5143,0.8436,0.5014,0.8584,0.4989,0.8728,0.4998,0.9389,0.5152,0.8902,0.5010,0.9081,0.5043,0.9231,0.5081,0.8222,0.5078};
			return value;
		}
		private double[] getTextureCoordinate_10_75_point_2()
		{
			double[] value = {0.8436,0.5014,0.8584,0.4989,0.8728,0.4998,0.9389,0.5152,0.8041,0.5143,0.9003,0.6988,0.8725,0.6960,0.9207,0.7001,0.9620,0.6964,0.7817,0.6943,0.9414,0.6984,0.8077,0.6958,0.8287,0.6951,0.8511,0.6950,0.9081,0.5043,0.8902,0.5010,0.8728,0.4998,0.8584,0.4989,0.8436,0.5014,0.8222,0.5078,0.8041,0.5143,0.9231,0.5081,0.8653,0.5044};
			return value;
		}
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_11_92_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_11_92_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_123_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_123_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_153_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_153_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_11_162_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_11_162_texCoordIndex_1()
		{
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=8, element #25, 480 total numbers.
		 ...
		 */
		private MFInt32 getIndexedFaceSet_8_25_coordIndex()
		{
			MFInt32 IndexedFaceSet_8_25_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_8_25_coordIndex_1()));
			return IndexedFaceSet_8_25_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=8, element #25, 480 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_8_25_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_8_25_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_8_25_texCoordIndex_1()));
			return IndexedFaceSet_8_25_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=9, element #25, 186 total numbers made up of 62 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_9_25_point()
		{
			MFVec3f Coordinate_9_25_point = new MFVec3f(new double[] {0.0000,1.0530,0.0273,0.0000,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.8750,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0.0000,0.9123,0.5960,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.8750,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0.0000,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.9800,0.5267,-0.4285,-1.1320,0.5267,0.0273,-0.9800,0.5267,0.4830,-0.5658,0.5267,0.6985,0.0000,0.5267,0.8206,0.5658,0.5267,0.6985,0.9800,0.5267,0.4830,1.1320,0.5267,0.0273,0.9800,0.5267,-0.4285,0.5658,0.5267,-0.7621,0.0000,0.0000,-0.9616,-0.6534,0.0000,-0.8206,-1.1320,0.0000,-0.4353,-1.3070,0.0000,0.0273,-1.1320,0.0000,0.5536,-0.6534,0.0000,0.8206,0.0000,0.0000,0.9616,0.6534,0.0000,0.8206,1.1320,0.0000,0.5536,1.3070,0.0000,0.0273,1.1320,0.0000,-0.4353,0.6534,0.0000,-0.8206,0.0000,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.9800,-0.5267,-0.3648,-1.1320,-0.5267,0.0273,-0.9800,-0.5267,0.4830,-0.5658,-0.5267,0.6985,0.0000,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.9800,-0.5267,0.4830,1.1320,-0.5267,0.0273,0.9800,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0.0000,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.4830,0.0000,-0.9123,0.5536,0.3267,-0.9123,0.4830,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0.0000,-1.0530,0.0273});
			return Coordinate_9_25_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #34, 748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #34, 748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #34, 312 total numbers made up of 104 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_34_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_34_point_1()))
				.append(new MFVec3f(getCoordinate_10_34_point_2()));
			return Coordinate_10_34_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #35, 246 total numbers made up of 123 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_10_35_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_10_35_point_1()))
				.append(new MFVec2f(getTextureCoordinate_10_35_point_2()));
			return TextureCoordinate_10_35_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #43, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #43, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #43, 159 total numbers made up of 53 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #52, 424 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #52, 165 total numbers made up of 55 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=12, element #61, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #61, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #61, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #74, 748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #74, 312 total numbers made up of 104 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_74_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_74_point_1()))
				.append(new MFVec3f(getCoordinate_10_74_point_2()));
			return Coordinate_10_74_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #75, 246 total numbers made up of 123 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_10_75_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_10_75_point_1()))
				.append(new MFVec2f(getTextureCoordinate_10_75_point_2()));
			return TextureCoordinate_10_75_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #83, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #83, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #83, 159 total numbers made up of 53 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_11_83_point = new MFVec3f(new double[] {-0.6171,-13.0100,-0.6361,-0.9297,-13.0100,-0.0368,0.0153,-13.0100,-0.9006,0.9678,-13.0100,0.0288,0.6522,-13.0100,0.7259,0.0153,-13.0200,0.9953,-0.5988,-13.0200,0.6470,-1.5070,-0.9557,-0.0060,-0.8814,-1.0170,-1.0850,0.0419,-1.0820,-1.4970,1.4730,-0.9549,-0.0060,0.9108,-1.0090,1.1030,-0.0234,-1.0270,1.5560,-1.0030,-0.9617,1.0740,0.6385,-13.0100,-0.6372,0.9338,-1.0190,-1.0870,-0.7548,-6.3090,-1.2550,-1.3660,-6.1280,-0.0060,0.1610,-6.7660,-1.5850,1.3570,-7.3090,-0.0060,0.8665,-7.1490,-1.2050,0.8441,-7.1410,0.9517,0.0368,-6.7660,1.4140,-0.8313,-6.3810,0.9375,-0.6098,-12.4300,-0.6489,0.0262,-12.4300,-0.9480,1.0330,-12.4300,0.0129,0.6686,-12.4300,0.7002,0.0397,-12.4300,1.0380,-0.6666,-12.4
point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=12, element #101, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #101, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #101, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_13_101_point = new MFVec3f(new double[] {-1.3710,-2.8920,-0.0282,0.0288,-2.8920,-0.0282,1.2780,-2.8920,-0.0282,-1.6300,-0.9450,1.2930,1.5770,-1.1300,1.4600,-1.8180,-2.8920,1.3990,0.0288,-2.8920,1.3990,1.7350,-2.8920,1.3990,-1.7030,-1.5380,2.4230,0.0288,-1.1780,2.6530,1.6250,-1.5380,2.3790,-1.8490,-2.8920,2.4040,0.0288,-2.8920,2.4040,1.8050,-2.8920,2.4040,-1.4220,-1.8510,3.4600,0.1410,-1.6500,3.7340,1.4630,-1.8670,3.3900,-1.4810,-2.8920,3.5600,0.3127,-2.8920,4.0330,1.5740,-2.8920,3.5810,-1.6050,-2.4790,-0.0282,0.3127,-2.4790,4.1940,1.6820,-2.4790,-0.0282,-2.0330,-2.4790,1.3990,1.9940,-2.4790,1.3990,-1.9720,-2.4790,2.4040,2.0330,-2.4790,2.4040,-1.5440,-2.4790,3.8170,1.6580,-2.4790,3.7140,0.2038,-0.6584,1.7020,-1.4450,-0.1027,-0.9967,1.4470,-0.1027,-0.9967,1.2740,-0.0025,-0.0073,-1.2460,-0.0085,-0.0073,-0.2310,-2.8920,-0.9871,0.2448,-2.8920,-0.9871,0.0146,0.1618,0.5865,-1.6530,-2.4790,-0.9871,1.6960,-2.4790,-0.9871,0.0244,-2.8920,-0.9871,0.2328,0.3042,-1.5240,0.2100,0.5895,-0.9062,0.0150,0.7752,-0.2115,-0.1815,0.5831,-0.9091,-0.2075,0.3012,-1.5250,-0.2422,-0.6147,-2.3450,-0.2136,-0.8983,-2.2970,0.0244,-0.8983,-2.2970,0.2307,-0.8983,-2.2970,0.2739,-0.5991,-2.3390});
			return Coordinate_13_101_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #114, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #114, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #114, 165 total numbers made up of 55 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_123_coordIndex()
		{
			MFInt32 IndexedFaceSet_10_123_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_123_coordIndex_1()));
			return IndexedFaceSet_10_123_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #123, 448 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_123_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_10_123_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_123_texCoordIndex_1()));
			return IndexedFaceSet_10_123_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #123, 174 total numbers made up of 58 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #132, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #132, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=13, element #142, 248 total numbers made up of 124 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #153, 448 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_153_coordIndex()
		{
			MFInt32 IndexedFaceSet_10_153_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_153_coordIndex_1()));
			return IndexedFaceSet_10_153_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #153, 448 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_153_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_10_153_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_153_texCoordIndex_1()));
			return IndexedFaceSet_10_153_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #153, 174 total numbers made up of 58 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_11_153_point()
		{
			MFVec3f Coordinate_11_153_point = new MFVec3f(new double[] {-1.5350,-7.2490,-0.8051,-0.8614,-7.2080,-1.0530,-1.9240,-7.2760,-0.0892,-1.5250,-7.2490,0.7175,-0.8508,-7.2070,0.9879,-0.2401,-7.1690,0.7042,0.1284,-7.1420,-0.0976,-0.2734,-7.1710,-0.8204,-1.6440,-4.1980,-1.0000,-0.8927,-4.
5731,0.0730,0.5718,0.0836,0.5723,0.0940,0.5750,0.1083,0.5737,0.0301,0.5782,0.0137,0.5721,0.0377,0.5731,0.0730,0.5718,0.0836,0.5723,0.0940,0.5737,0.0472,0.5736,0.0597,0.5782,0.0137,0.5750,0.1083,0.5737,0.0301,0.5721,0.0377,0.5737,0.0472,0.5736,0.0597,0.5731,0.0730,0.5718,0.0836,0.5723,0.0940,0.5750,0.1083,0.5737,0.0301,0.5731,0.0667});
			return TextureCoordinate_11_154_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=11, element #162, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_11_162_coordIndex()
		{
			MFInt32 IndexedFaceSet_11_162_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_11_162_coordIndex_1()));
			return IndexedFaceSet_11_162_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #162, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_11_162_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_11_162_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_11_162_texCoordIndex_1()));
			return IndexedFaceSet_11_162_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #162, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_12_162_point()
		{
			MFVec3f Coordinate_12_162_point = new MFVec3f(new double[] {-0.8210,-0.5909,-0.8822,-1.4270,-0.5940,0.7319,-0.8222,-0.5909,0.9960,-0.2876,-0.5847,0.7126,-0.7753,-6.7490,-0.7027,-1.4430,-6.6720,0.0095,-0.2955,-6.6970,-0.0347,-0.4962,-6.7350,-0.5285,-1.1950,-6.6890,0.4229,-0.8251,-6.7270,0.6277,-0.5299,-6.7170,0.4443,-1.1930,-6.7110,-0.4833,-1.4190,-0.5938,-0.6599,-1.8090,-0.6062,0.0293,0.0834,-0.5804,0.0244,-0.3356,-0.5853,-0.6602,-0.8149,-7.0200,-0.6690,-1.3180,-7.0120,0.0209,-0.3939,-6.9980,-0.0220,-0.6226,-7.0330,-0.5300,-1.1090,-7.0100,0.4196,-0.8288,-7.0190,0.5966,-0.6184,-7.0250,0.4434,-1.0650,-7.0430,-0.4741,-0.8905,-7.1580,-0.0054,-1.2940,-3.7080,-0.5290,-0.7852,-3.7610,-0.8600,-1.6450,-3.6640,0.0347,-1.3400,-3.6920,0.5633,-0.8188,-3.7310,0.8834,-0.4018,-3.7360,0.5990,-0.0819,-3.7060,-0.0521,-0.3634,-3.7170,-0.5775,-0.8469,-0.0133,-0.9988,-1.4790,-0.0529,0.7574,-0.8418,-0.0307,1.0250,-0.2776,-0.0084,0.7411,-1.5340,-0.0371,-0.7635,-1.9080,-0.0564,0.0374,0.1502,0.0257,0.0308,-0.2810,0.0081,-0.7713,-1.4240,0.4666,-0.6148,-0.8709,0.4848,-0.8043,-0.4260,0.5021,-0.6254,-0.0733,0.5182,0.0308,-0.4223,0.4884,0.6105,-0.8677,0.4713,0.8343,-1.3750,0.4535,0.6213,-1.7270,0.4516,0.0325,-0.9079,0.6893,0.0114});
			return Coordinate_12_162_point;
		}
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=13, element #172, 248 total numbers made up of 124 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #183, 3048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #183, 3048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #183, 1254 total numbers made up of 418 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=11, element #184, 988 total numbers made up of 494 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=11, element #192, 1748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #192, 1748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #192, 732 total numbers made up of 244 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #193, 570 total numbers made up of 285 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
    ...
    public static void main(String args[])
    {
		...
		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.KoreanCharacter10Mi\" self-validation test results: ");

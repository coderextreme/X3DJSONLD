...
public class indexedfaceset_pixeltexture_plus
{
  ...
  .setHead(new headObject()
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE        ).setContent("indexedfaceset_pixeltexture_plus.x3d"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_plus-front.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_plus-rear.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_plus-top.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_plus-bottom.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_plus-left.jpg"))
    .addMeta(new metaObject().setName(metaObject.NAME_IMAGE        ).setContent("indexedfaceset_pixeltexture_plus-right.jpg"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_DESCRIPTION  ).setContent("Test of browser ability to map a 3 times multiple of an PixelTexture onto an IndexedFaceSet geometry. A 3 by 3 matrix of four equal sized red, green, white and yellow squares in the pixel texture map all the faces of the cube."))
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER   ).setContent("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plus.x3d"))
  ...
  .setScene(new SceneObject()
    ...
    {
        X3DObject thisExampleX3dObject = new indexedfaceset_pixeltexture_plus().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"indexedfaceset_pixeltexture_plus\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dObject.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"indexedfaceset_pixeltexture_plus\" self-validation test results: ");

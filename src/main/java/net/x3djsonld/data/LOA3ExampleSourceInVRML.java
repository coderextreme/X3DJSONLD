 ...
 <p> Related links: LOA3ExampleSourceInVRML.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> LOA3ExampleSourceInVRML.wrl </td>
		</tr>
		<tr style="background-color:silver; border-color:silver;">
...
public class LOA3ExampleSourceInVRML
{
	/** Default constructor to create this object. */
	public LOA3ExampleSourceInVRML ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_SOURCE     ).setContent("LOA3ExampleSourceInVRML.wrl")))
  .setScene(new Scene()
    ...
    .addChild(new ProtoInstance("Humanoid", "humanoid_2").setContainerField("children")
      ...
      .addFieldValue(new fieldValue().setName("info").setValue(new String[] {"authorName=Matthew T. Beitler","authorEmail=beitler@cis.upenn.edu or beitler@acm.org","creationDate=05/12/99","copyright=Copyright 1999-2003, Matthew T. Beitler","humanoidVersion=JointCenters 200x, LOA&#8209;3","usageRestrictions=
   ...
   "}).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;3")))
	 ...
	 * @return LOA3ExampleSourceInVRML model
	 */
    ...
    {
        X3D thisExampleX3dModel = new LOA3ExampleSourceInVRML().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"LOA3ExampleSourceInVRML\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"LOA3ExampleSourceInVRML\" self-validation test results: ");

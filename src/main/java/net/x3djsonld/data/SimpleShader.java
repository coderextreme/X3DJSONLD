 ...
 * <p> Simple shader example. </p>
 <p> Related links: <a href="../../../Shaders/SimpleShader.java">SimpleShader.java</a> source, <a href="../../../Shaders/SimpleShaderIndex.html" target="_top">SimpleShader catalog page</a>, <a href="http://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="http://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="http://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
    ...
    .addChild(new WorldInfoObject().setTitle("SimpleShader")
      .setMetadata(new MetadataSetObject("Titania").setName("Titania").setReference("http://titania.create3000.de")
        ...
        .addValue(new MetadataSetObject("Viewpoint").setName("Viewpoint").setReference("http://titania.create3000.de")
          .addValue(new MetadataDoubleObject("position").setName("position").setValue(new double[] {6.24067728185014,0.00250837343276661,2.92117542307615}).setReference("http://titania.create3000.de"))
          .addValue(new MetadataDoubleObject("orientation").setName("orientation").setValue(new double[] {-0.110173424710488,0.990158061907379,-0.0863065984000336,1.21146676119191}).setReference("http://titania.create3000.de"))
          .addValue(new MetadataDoubleObject("centerOfRotation").setName("centerOfRotation").setValue(new double[] {-0.808320198626341,-0.358072370409949,0.22817191560906}).setReference("http://titania.create3000.de")))))

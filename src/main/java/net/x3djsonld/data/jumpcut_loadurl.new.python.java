...
public class jumpcut_loadurl
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new Background().setGroundAngle(new double[] {1.0}).setGroundColor(new MFColor(new double[] {0.0,0.5,0.0,0.0,0.5,0.0})).setSkyColor(new MFColor(new double[] {0.0,0.0,1.0})))

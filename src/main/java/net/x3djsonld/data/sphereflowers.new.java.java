...
public class sphereflowers
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("sphereflowers.x3d"))
    .addMeta(new meta().setName(meta.NAME_CREATOR    ).setContent("John Carlson"))
    .addMeta(new meta().setName(meta.NAME_CREATED    ).setContent("Jan 17 2022"))
    .addMeta(new meta().setName(meta.NAME_MODIFIED   ).setContent("Sep 3 2023"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Group()
        ...
        .setProtoBody(new ProtoBody()
          .addChild(new Group()
            .addChild(new ProtoInstance("FlowerProto").setContainerField("children")
              ...
              .addFieldValue(new fieldValue().setName("fragment").setValue(new String[] {"../shaders/x_ite.fs"}))))))
      ...
      .addChild(new Sound().setLocation(0.0,1.0,0.0).setMaxBack(100.0).setMaxFront(100.0).setMinBack(20.0).setMinFront(20.0)
...
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.sphereflowers\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.sphereflowers self-validation test results: ");

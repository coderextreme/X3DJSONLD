...
public class LOA2ExampleSourceInVRML
{
	...
	public LOA2ExampleSourceInVRML ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_SOURCE     ).setContent("LOA2ExampleSourceInVRML.wrl")))
  .setScene(new Scene()
    ...
    .addChild(new ProtoInstance("Humanoid", "humanoid_2").setContainerField("children")
      ...
      .addFieldValue(new fieldValue().setName("info").setValue(new String[] {"authorName=Matthew T. Beitler","authorEmail=beitler@cis.upenn.edu or beitler@acm.org","creationDate=05/12/99","copyright=Copyright 1999-2003, Matthew T. Beitler","humanoidVersion=JointCenters 200x, LOA&#8209;2","usageRestrictions=
   ...
   "}).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;2")))
    ...
    {
        X3D thisExampleX3dModel = new LOA2ExampleSourceInVRML().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"LOA2ExampleSourceInVRML\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"LOA2ExampleSourceInVRML\" self-validation test results: ");

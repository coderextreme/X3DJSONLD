...
public class bubs2
{
  ...
  .setHead(new headObject()
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE      ).setContent("bubs2.x3d"))
...
"}")
    ...
    .addChild(new ProtoInstanceObject("Bubble", "bubbleA"))
    .addChild(new ProtoInstanceObject("Bubble", "bubbleB"))
    .addChild(new ProtoInstanceObject("Bubble", "bubbleC"))
    .addChild(new ProtoInstanceObject("Bubble", "bubbleD")));
    }
    ...
    {
        X3DObject thisExampleX3dObject = new bubs2().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"bubs2\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");

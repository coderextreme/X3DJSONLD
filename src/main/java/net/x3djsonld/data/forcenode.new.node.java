            ...
            .addChild(new Transform().setTranslation(1.0,0.0,1.0)
              .addChild(new Shape()
                ...
                .setGeometry(new Text().setString(new String[] {"Node"})
                  .setFontStyle(new FontStyle().setJustify(FontStyle.JUSTIFY_MIDDLE_MIDDLE).setSize(5.0))))))
...
""")
          ...
          .addChild(new TimeSensor("nodeClock").setCycleInterval(3.0).setLoop(true))

...
public class LOA3ExampleSourceWithDiamonds
{
	...
	public LOA3ExampleSourceWithDiamonds ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_SOURCE     ).setContent("LOA3ExampleSourceWithDiamonds.wrl")))
  .setScene(new Scene()
   ...
   "}).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;3")))
    ...
    {
        X3D thisExampleX3dModel = new LOA3ExampleSourceWithDiamonds().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"LOA3ExampleSourceWithDiamonds\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"LOA3ExampleSourceWithDiamonds\" self-validation test results: ");

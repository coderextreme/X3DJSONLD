...
import net.coderextreme.X3DRoots;import java.util.List;import java.util.ArrayList;public class ThreeDTexture implements X3DRoots 
{
	/** Default constructor to create this object. */
	public ThreeDTexture ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("ThreeDTexture.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/ThreeDTexture.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("a kind of ThreeDTexture cube with spheres")))
  .setScene(new Scene()
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new ThreeDTexture().getX3dModel();
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.ThreeDTexture\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.ThreeDTexture self-validation test results: ");

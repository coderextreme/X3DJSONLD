...
public class KoreanCharacterMotionAnnexD01Jin
{
	/** Default constructor to create this object. */
	public KoreanCharacterMotionAnnexD01Jin ()
	{
	  initialize();
	}
  ...
  .setHead(new headObject()
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE      ).setContent("KoreanCharacterMotionAnnexD01Jin.x3d"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_MODIFIED   ).setContent("10 May 2020"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/KoreanCharacterMotionAnnexD01Jin.x3d"))
          ...
          .addChild(new TransformObject().setTranslation(0.0f,30.53f,-0.7076f)
            .addChild(new ShapeObject()
              .setAppearance(new AppearanceObject()
                ...
                .setTexture(new ImageTextureObject("Annex01JinTextureAtlas").setUrl(new String[] {"Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/HAnimSpecification/Jin.png"})))
              ...
              .addChild(new TransformObject().setTranslation(4.207f,32.02f,-0.8155f)
                .addChild(new ShapeObject()
                  ...
                  .setGeometry(new IndexedFaceSetObject().setCreaseAngle(3.14159f).setCoordIndex(getIndexedFaceSet_10_42_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_42_texCoordIndex())
                    ...
                    .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new float[] {0.719f,0.5576f,0.6284f,0.5576f,0.7414f,0.5576f,0.6787f,0.5576f,0.5781f,0.5576f,0.5154f,0.5576f,0.5378f,0.5576f,0.6284f,0.5029f,0.7509f,0.3997f,0.6284f,0.3997f,0.7509f,0.5029f,0.7811f,0.3997f,0.7811f,0.5029f,0.6964f,0.3997f,0.6964f,0.5029f,0.5604f,0.3997f,0.5604f,0.5029f,0.4756f,0.3997f,0.4756f,0.5029f,0.5059f,0.3997f,0.5059f,0.5029f,0.7509f,0.3197f,0.6284f,0.3197f,0.7811f,0.3197f,0.6964f,0.3197f,0.5604f,0.3197f,0.4756f,0.3197f,0.5059f,0.3197f,0.7651f,0.2166f,0.6284f,0.2166f,0.7989f,0.2166f,0.7043f,0.2166f,0.5525f,0.2166f,0.4579f,0.2166f,0.4917f,0.2166f,0.7224f,0.263f,0.6284f,0.263f,0.7456f,0.263f,0.6805f,0.263f,0.5762f,0.263f,0.5112f,0.263f,0.5344f,0.263f,0.8705f,0.5452f,0.8705f,0.5383f,0.8705f,0.5369f,0.8705f,0.5408f,0.8705f,0.5483f,0.8705f,0.5522f,0.8705f,0.5509f,0.917f,0.5452f,0.917f,0.5266f,0.89f,0.5304f,0.89f,0.5452f,0.917f,0.522f,0.89f,0.5268f,0.917f,0.5349f,0.89f,0.537f,0.917f,0.5555f,0.89f,0.5534f,0.917f,0.5684f,0.89f,0.5636f,0.917f,0.5638f,0.89f,0.56f,0.8746f,0.531f,0.8746f,0.5452f,0.8746f,0.5279f,0.8746f,0.5368f,0.8746f,0.5524f,0.8746f,0.5613f,0.8746f,0.5581f})))))))
...
// [*** X3dToJava.xslt error: encountered incorrect type, HAnimMotion startFrame: $isNumeric=true, $attributeType=, value='0']
    ...
    {
        X3DObject thisExampleX3dObject = new KoreanCharacterMotionAnnexD01Jin().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"KoreanCharacterMotionAnnexD01Jin\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dObject.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"KoreanCharacterMotionAnnexD01Jin\" self-validation test results: ");

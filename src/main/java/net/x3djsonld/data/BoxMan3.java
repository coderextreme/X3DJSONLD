...
public class BoxMan3
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("BoxMan3.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("BoxMan3.js"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Script("ENGINE").setDirectOutput(true).setUrl(new String[] {"BoxMan3.js","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3.js"})
    ...
    {
        X3D thisExampleX3dModel = new BoxMan3().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.BoxMan3\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.BoxMan3\" self-validation test results: ");

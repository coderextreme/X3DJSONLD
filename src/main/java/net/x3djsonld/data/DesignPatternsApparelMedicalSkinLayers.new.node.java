  ...
  .setScene(new Scene()
    ...
    .addChild(new Group("MultipleHumanoids")
      ...
      .addChild(new HAnimHumanoid("a_SimpleSkeleton").setName("SimpleSkeleton").setVersion("2.0")
        .addSkeleton(new HAnimJoint("a_SimpleSkeleton").setName("humanoid_root").setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
      ...
      .addChild(new HAnimHumanoid("b_SimpleSkeletonMesh").setName("SimpleSkeletonMesh").setVersion("2.0")
        .addSkeleton(new HAnimJoint("b_SimpleSkeletonMesh").setName("humanoid_root").setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment().setName("sacrum")
            .addChild(new Shape()
      ...
      .addChild(new HAnimHumanoid("c_SkinIndexedGeometry").setName("SkinIndexedGeometry").setVersion("2.0")
        .addSkeleton(new HAnimJoint("c_SkinIndexedGeometry").setName("humanoid_root").setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment().setName("sacrum")))
      ...
      .addChild(new HAnimHumanoid("d_SkinShapeIndexedGeometry").setName("SkinShapeIndexedGeometry").setVersion("2.0")
        .addSkeleton(new HAnimJoint("d_SkinShapeIndexedGeometry").setName("humanoid_root").setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment().setName("sacrum")))
        .addSkin(new Shape()
      ...
      .addChild(new HAnimHumanoid("e_SkinSwitchShapeIndexedGeometry").setName("SkinSwitchShapeIndexedGeometry").setVersion("2.0")
        ...
        .addSkeleton(new HAnimJoint("e_SkinSwitchShapeIndexedGeometry").setName("humanoid_root").setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment().setName("sacrum")))
        .addSkin(new Shape()
      ...
      .addChild(new HAnimHumanoid("f_SynthesizedSkinShapeIndexedTwoPartGeometry").setName("SynthesizedSkinShapeIndexedTwoPartGeometry").setVersion("2.0")
        .addSkeleton(new HAnimJoint("f_SynthesizedSkinShapeIndexedTwoPartGeometry").setName("humanoid_root").setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment().setName("sacrum")))
        .addSkin(new Shape()
      ...
      .addChild(new HAnimHumanoid("g_ApparelSkinIndexedGeometryMultipleShapes").setName("ApparelSkinIndexedGeometryMultipleShapes").setVersion("2.0")
        ...
        .addSkeleton(new HAnimJoint("g_ApparelSkinIndexedGeometryMultipleShapes").setName("humanoid_root").setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment().setName("sacrum")))
        .addSkin(new Shape()))
      .addComments(" ============================== ")
      .addChild(new HAnimHumanoid("h_AnatomySkinIndexedGeometryMultipleShapes").setName("AnatomySkinIndexedGeometryMultipleShapes").setVersion("2.0")
        ...
        .addSkeleton(new HAnimJoint("h_AnatomySkinIndexedGeometryMultipleShapes").setName("humanoid_root").setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment().setName("sacrum")))
        .addSkin(new Shape()))
      .addComments(" ============================== "))
    ...
    .addChild(new Anchor().setDescription("DesignPatternsApparelMedicalSkinLayers.x3d explores potential apparel approaches").setParameter(new String[] {"target=blank"}).setUrl(new String[] {"https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Skin/DesignPatternsApparelMedicalSkinLayersIndex.html"})
      ...
      .addChild(new Shape()
        ...
        .setGeometry(new Box().setSize(11.0,2.0,0.001)))));
            }
            catch (Exception ex)
            {       

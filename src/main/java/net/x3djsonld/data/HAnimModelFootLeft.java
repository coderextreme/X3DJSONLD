...
public class HAnimModelFootLeft
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("Humanoid_Left_Foot").setName("Humanoid_Left_Foot").setInfo(new String[] {"humanoidVersion=2.0"}).setVersion("2.0")
      .addSkeleton(new HAnimJoint("hanim_HumanoidRoot").setName("humanoid_root")
        .addChild(new HAnimJoint("l_talocrural_joint").setName("l_talocrural_joint")
          ...
          .addComments(" TCN ")
          .addChild(new HAnimJoint("l_talocalcaneonavicular_joint").setName("l_talocalcaneonavicular_joint").setCenter(0.0,-0.3,0.0)
            ...
            .addComments(" CN1 ")
            .addChild(new HAnimJoint("l_cuneonavicular_joint1").setName("l_cuneonavicular_joint1").setCenter(-0.1,-0.45,0.0)
              ...
              .addChild(new HAnimJoint("l_tarsometatarsal_joint1").setName("l_tarsometatarsal_joint1").setCenter(-0.1,-0.6,0.0)
                ...
                .addChild(new HAnimJoint("l_metatarsophalangeal_joint1").setName("l_metatarsophalangeal_joint1").setCenter(-0.1,-0.9,0.0)
                  ...
                  .addChild(new HAnimJoint("l_f_Interphalangeal_joint").setName("l_f_Interphalangeal_joint").setCenter(-0.1,-1.05,0.0)
            ...
            .addComments(" CN2 ")
            .addChild(new HAnimJoint("l_cuneonavicular_joint2").setName("l_cuneonavicular_joint2").setCenter(0.0,-0.45,0.0)
              ...
              .addChild(new HAnimJoint("l_tarsometatarsal_joint2").setName("l_tarsometatarsal_joint2").setCenter(0.05,-0.6,0.0)
                ...
                .addChild(new HAnimJoint("l_metatarsophalangeal_joint2").setName("l_metatarsophalangeal_joint2").setCenter(0.05,-0.9,0.0)
                  ...
                  .addChild(new HAnimJoint("l_f_proximal_Interphalangeal_joint2").setName("l_f_proximal_Interphalangeal_joint2").setCenter(0.05,-1.05,0.0)
                    ...
                    .addChild(new HAnimJoint("l_f_distal_Interphalangeal_joint2").setName("l_f_distal_Interphalangeal_joint2").setCenter(0.05,-1.12,0.0)
            ...
            .addComments(" CN3 ")
            .addChild(new HAnimJoint("l_cuneonavicular_joint3").setName("l_cuneonavicular_joint3").setCenter(0.1,-0.4,0.0)
              ...
              .addChild(new HAnimJoint("l_tarsometatarsal_joint3").setName("l_tarsometatarsal_joint3").setCenter(0.15,-0.6,0.0)
                ...
                .addChild(new HAnimJoint("l_metatarsophalangeal_joint3").setName("l_metatarsophalangeal_joint3").setCenter(0.15,-0.9,0.0)
                  ...
                  .addChild(new HAnimJoint("l_f_proximal_Interphalangeal_joint3").setName("l_f_proximal_Interphalangeal_joint3").setCenter(0.15,-1.05,0.0)
                    ...
                    .addChild(new HAnimJoint("l_f_distal_Interphalangeal_joint3").setName("l_f_distal_Interphalangeal_joint3").setCenter(0.15,-1.13,0.0)
          ...
          .addComments(" CC ")
          .addChild(new HAnimJoint("l_calcaneuscuboid_joint").setName("l_calcaneuscuboid_joint").setCenter(0.2,0.3,0.0)
            ...
            .addComments(" TT ")
            .addChild(new HAnimJoint("l_transverse_tarsal_joint").setName("l_transverse_tarsal_joint").setCenter(0.21,-0.3,0.0)
              ...
              .addComments(" TMT4 ")
              .addChild(new HAnimJoint("l_tarsometatarsal_joint4").setName("l_tarsometatarsal_joint4").setCenter(0.25,-0.58,0.0)
                ...
                .addChild(new HAnimJoint("l_metatarsophalangeal_joint4").setName("l_metatarsophalangeal_joint4").setCenter(0.25,-0.87,0.0)
                  ...
                  .addChild(new HAnimJoint("l_f_proximal_Interphalangeal_joint4").setName("l_f_proximal_Interphalangeal_joint4").setCenter(0.25,-1.0,0.0)
                    ...
                    .addChild(new HAnimJoint("l_f_distal_Interphalangeal_joint4").setName("l_f_distal_Interphalangeal_joint4").setCenter(0.25,-1.1,0.0)
              ...
              .addComments(" TMT5 ")
              .addChild(new HAnimJoint("l_tarsometatarsal_joint5").setName("l_tarsometatarsal_joint5").setCenter(0.33,-0.52,0.0)
                ...
                .addChild(new HAnimJoint("l_metatarsophalangeal_joint5").setName("l_metatarsophalangeal_joint5").setCenter(0.34,-0.8,0.0)
                  ...
                  .addChild(new HAnimJoint("l_f_proximal_Interphalangeal_joint5").setName("l_f_proximal_Interphalangeal_joint5").setCenter(0.34,-0.95,0.0)
                    ...
                    .addChild(new HAnimJoint("l_f_distal_Interphalangeal_joint5").setName("l_f_distal_Interphalangeal_joint5").setCenter(0.34,-1.05,0.0)

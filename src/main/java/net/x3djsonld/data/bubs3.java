...
public class bubs3
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform("DECLBubble_transformA")
      .addChild(new Shape()
...
""")
    ...
    .addChild(new Transform("DECLBubble_transformB")
      .addChild(new Shape()
        .setGeometry(new Sphere().setRadius(0.25))
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,0.0,0.0).setTransparency(0.2))))
...
""")
    ...
    .addChild(new Transform("DECLBubble_transformC")
      .addChild(new Shape()
        .setGeometry(new Sphere().setRadius(0.25))
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,0.0,0.0).setTransparency(0.2))))
...
""")
    ...
    .addChild(new Transform("DECLBubble_transformD")
      .addChild(new Shape()
        .setGeometry(new Sphere().setRadius(0.25))
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,0.0,0.0).setTransparency(0.2))))
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.bubs3 self-validation test confirmation: ");

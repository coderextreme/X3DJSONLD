...
public class arc3
{
  ...
  .setHead(new head()
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("arc3.x3d"))
...
""")
      ...
      .addChild(new TimeSensor("DECLpoint_G1_CL1").setCycleInterval(3.0).setLoop(true))
...
""")
        ...
        .addField(new field().setName("set_location").setType(field.TYPE_SFTIME).setAccessType(field.ACCESSTYPE_INPUTONLY))
        .addField(new field().setName("keyValue").setType(field.TYPE_MFVEC3F).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new MFVec3f(new MFVec3f(new double[] {0.0,0.0,0.0,0.0,5.0,0.0})))))
      .addChild(new TimeSensor("DECLpoint_G2_CL1").setCycleInterval(3.0).setLoop(true))
...
""")
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new arc3().getX3dModel();
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.arc3\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.arc3 self-validation test results: ");

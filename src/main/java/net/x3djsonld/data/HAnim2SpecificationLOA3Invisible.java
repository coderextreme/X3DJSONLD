...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.HAnim2SpecificationLOA3Invisible self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./HAnim2SpecificationLOA3Invisible_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./HAnim2SpecificationLOA3Invisible_JavaExport.x3d"; 
                String filenameX3DV = "./HAnim2SpecificationLOA3Invisible_JavaExport.x3dv"; 
                String filenameJSON = "./HAnim2SpecificationLOA3Invisible_JavaExport.json";

...
public class HAnim2SpecificationLOA3Invisible
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_humanoid").setName("humanoid").setLoa(3).setVersion("2.0")
      ...
      .addSkeleton(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,0.824,0.0277).setStiffness(new double[] {0.0,0.0,0.0})
        ...
        .addChild(new HAnimJoint("hanim_sacroiliac").setName("sacroiliac").setCenter(0.0,0.9149,0.0016).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_l_hip").setName("l_hip").setCenter(0.0961,0.9124,-0.0001).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_l_knee").setName("l_knee").setCenter(0.104,0.4867,0.0308).setStiffness(new double[] {0.0,0.0,0.0})
              .addChild(new HAnimSegment("hanim_l_calf").setName("l_calf"))
              .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocrural").setCenter(0.1101,0.0656,-0.0736).setStiffness(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName("l_tarsometatarsal_2").setCenter(0.1086,0.0001,-0.0368).setStiffness(new double[] {0.0,0.0,0.0})
                  .addChild(new HAnimSegment("hanim_l_metatarsal_2").setName("l_metatarsal_2"))
                  .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(0.1086,0.0001,0.0368).setStiffness(new double[] {0.0,0.0,0.0})
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setCenter(0.1086,0.0,0.0762).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_r_hip").setName("r_hip").setCenter(-0.0961,0.9124,-0.0001).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_r_knee").setName("r_knee").setCenter(-0.104,0.4867,0.0308).setStiffness(new double[] {0.0,0.0,0.0})
              .addChild(new HAnimSegment("hanim_r_calf").setName("r_calf"))
              .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_talocrural").setCenter(-0.1101,0.0656,-0.0736).setStiffness(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setName("r_tarsometatarsal_2").setCenter(-0.1086,0.0001,-0.0368).setStiffness(new double[] {0.0,0.0,0.0})
                  .addChild(new HAnimSegment("hanim_r_metatarsal_2").setName("r_metatarsal_2"))
                  .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(-0.1086,0.0001,0.0368).setStiffness(new double[] {0.0,0.0,0.0})
                    ...
                    .addChild(new HAnimJoint("hanim_r_tarsal_distal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setCenter(-0.1086,0.0,0.0762).setStiffness(new double[] {0.0,0.0,0.0})
        ...
        .addChild(new HAnimJoint("hanim_vl5").setName("vl5").setCenter(0.0028,1.0568,-0.0776).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_vl4").setName("vl4").setCenter(0.0035,1.0925,-0.0787).setStiffness(new double[] {0.0,0.0,0.0})
            .addChild(new HAnimSegment("hanim_l4").setName("l4"))
            .addChild(new HAnimJoint("hanim_vl3").setName("vl3").setCenter(0.0041,1.1276,-0.0796).setStiffness(new double[] {0.0,0.0,0.0})
              .addChild(new HAnimSegment("hanim_l3").setName("l3"))
              .addChild(new HAnimJoint("hanim_vl2").setName("vl2").setCenter(0.0045,1.1546,-0.08).setStiffness(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new HAnimJoint("hanim_vl1").setName("vl1").setCenter(0.0048,1.1912,-0.0805).setStiffness(new double[] {0.0,0.0,0.0})
                  .addChild(new HAnimSegment("hanim_l1").setName("l1"))
                  .addChild(new HAnimJoint("hanim_vt12").setName("vt12").setCenter(0.0051,1.2278,-0.0808).setStiffness(new double[] {0.0,0.0,0.0})
                    .addChild(new HAnimSegment("hanim_t12").setName("t12"))
                    .addChild(new HAnimJoint("hanim_vt11").setName("vt11").setCenter(0.0053,1.2679,-0.081).setStiffness(new double[] {0.0,0.0,0.0})
                      .addChild(new HAnimSegment("hanim_t11").setName("t11"))
                      .addChild(new HAnimJoint("hanim_vt10").setName("vt10").setCenter(0.0056,1.2848,-0.0822).setStiffness(new double[] {0.0,0.0,0.0})
                        ...
                        .addChild(new HAnimJoint("hanim_vt9").setName("vt9").setCenter(0.0057,1.3126,-0.0838).setStiffness(new double[] {0.0,0.0,0.0})
                          ...
                          .addChild(new HAnimJoint("hanim_vt8").setName("vt8").setCenter(0.0057,1.3382,-0.0845).setStiffness(new double[] {0.0,0.0,0.0})
                            .addChild(new HAnimSegment("hanim_t8").setName("t8"))
                            .addChild(new HAnimJoint("hanim_vt7").setName("vt7").setCenter(0.0058,1.3625,-0.0833).setStiffness(new double[] {0.0,0.0,0.0})
                              .addChild(new HAnimSegment("hanim_t7").setName("t7"))
                              .addChild(new HAnimJoint("hanim_vt6").setName("vt6").setCenter(0.0059,1.3866,-0.08).setStiffness(new double[] {0.0,0.0,0.0})
                                .addChild(new HAnimSegment("hanim_t6").setName("t6"))
                                .addChild(new HAnimJoint("hanim_vt5").setName("vt5").setCenter(0.006,1.4102,-0.0745).setStiffness(new double[] {0.0,0.0,0.0})
                                  .addChild(new HAnimSegment("hanim_t5").setName("t5"))
                                  .addChild(new HAnimJoint("hanim_vt4").setName("vt4").setCenter(0.0061,1.432,-0.0675).setStiffness(new double[] {0.0,0.0,0.0})
                                    .addChild(new HAnimSegment("hanim_t4").setName("t4"))
                                    .addChild(new HAnimJoint("hanim_vt3").setName("vt3").setCenter(0.0062,1.4583,-0.057).setStiffness(new double[] {0.0,0.0,0.0})
                                      .addChild(new HAnimSegment("hanim_t3").setName("t3"))
                                      .addChild(new HAnimJoint("hanim_vt2").setName("vt2").setCenter(0.0063,1.4761,-0.0484).setStiffness(new double[] {0.0,0.0,0.0})
                                        .addChild(new HAnimSegment("hanim_t2").setName("t2"))
                                        .addChild(new HAnimJoint("hanim_vt1").setName("vt1").setCenter(0.0065,1.4951,-0.0387).setStiffness(new double[] {0.0,0.0,0.0})
                                          ...
                                          .addChild(new HAnimJoint("hanim_vc7").setName("vc7").setCenter(0.0066,1.5132,-0.0301).setStiffness(new double[] {0.0,0.0,0.0})
                                            ...
                                            .addChild(new HAnimJoint("hanim_vc6").setName("vc6").setCenter(0.0066,1.5357,-0.0143).setStiffness(new double[] {0.0,0.0,0.0})
                                              .addChild(new HAnimSegment("hanim_c6").setName("c6"))
                                              .addChild(new HAnimJoint("hanim_vc5").setName("vc5").setCenter(0.0066,1.552,-0.0082).setStiffness(new double[] {0.0,0.0,0.0})
                                                .addChild(new HAnimSegment("hanim_c5").setName("c5"))
                                                .addChild(new HAnimJoint("hanim_vc4").setName("vc4").setCenter(0.0066,1.5662,-0.0084).setStiffness(new double[] {0.0,0.0,0.0})
                                                  .addChild(new HAnimSegment("hanim_c4").setName("c4"))
                                                  .addChild(new HAnimJoint("hanim_vc3").setName("vc3").setCenter(0.0066,1.58,-0.0103).setStiffness(new double[] {0.0,0.0,0.0})
                                                    .addChild(new HAnimSegment("hanim_c3").setName("c3"))
                                                    .addChild(new HAnimJoint("hanim_vc2").setName("vc2").setCenter(0.0066,1.5928,-0.0103).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_c2").setName("c2"))
                                                      .addChild(new HAnimJoint("hanim_vc1").setName("vc1").setCenter(0.0066,1.6144,-0.0034).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_c1").setName("c1"))
                                                        .addChild(new HAnimJoint("hanim_skullbase").setName("skullbase").setCenter(0.0044,1.6209,0.0236).setStiffness(new double[] {0.0,0.0,0.0})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_eyeball_joint").setName("l_eyeball_joint").setCenter(0.0336,1.6332,0.0502).setStiffness(new double[] {0.0,0.0,0.0})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_eyelid_joint").setName("l_eyelid_joint").setCenter(0.0336,1.6332,0.0502).setStiffness(new double[] {0.0,0.0,0.0})
                                                            .addChild(new HAnimSegment("hanim_l_eyelid").setName("l_eyelid")))
                                                          .addChild(new HAnimJoint("hanim_l_eyebrow_joint").setName("l_eyebrow_joint").setCenter(0.0336,1.635,0.0506).setStiffness(new double[] {0.0,0.0,0.0})
                                                            .addChild(new HAnimSegment("hanim_l_eyebrow").setName("l_eyebrow")))
                                                          .addChild(new HAnimJoint("hanim_r_eyeball_joint").setName("r_eyeball_joint").setCenter(-0.0336,1.6332,0.0502).setStiffness(new double[] {0.0,0.0,0.0})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_eyelid_joint").setName("r_eyelid_joint").setCenter(-0.0336,1.6332,0.0502).setStiffness(new double[] {0.0,0.0,0.0})
                                                            .addChild(new HAnimSegment("hanim_r_eyelid").setName("r_eyelid")))
                                                          .addChild(new HAnimJoint("hanim_r_eyebrow_joint").setName("r_eyebrow_joint").setCenter(-0.0336,1.635,0.0506).setStiffness(new double[] {0.0,0.0,0.0})
                                                            .addChild(new HAnimSegment("hanim_r_eyebrow").setName("r_eyebrow")))
                                                          .addChild(new HAnimJoint("hanim_temporomandibular").setName("temporomandibular").setCenter(0.0,1.63,0.015).setStiffness(new double[] {0.0,0.0,0.0})
                                          ...
                                          .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(0.082,1.4488,-0.0353).setStiffness(new double[] {0.0,0.0,0.0})
                                            ...
                                            .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(0.0962,1.4269,-0.0424).setStiffness(new double[] {0.0,0.0,0.0})
                                              .addChild(new HAnimSegment("hanim_l_scapula").setName("l_scapula"))
                                              .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_shoulder").setCenter(0.2029,1.4376,-0.0387).setStiffness(new double[] {0.0,0.0,0.0})
                                                ...
                                                .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(0.2014,1.1357,-0.0682).setStiffness(new double[] {0.0,0.0,0.0})
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(0.1984,0.8663,-0.0583).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setName("l_carpometacarpal_1").setCenter(0.1924,0.8472,-0.0534).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_l_metacarpal_1").setName("l_metacarpal_1"))
                                                      .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setName("l_metacarpophalangeal_1").setCenter(0.1951,0.8226,0.0246).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_l_carpal_proximal_phalanx_1").setName("l_carpal_proximal_phalanx_1"))
                                                        .addChild(new HAnimJoint("hanim_l_carpal_interphalangeal_1").setName("l_carpal_interphalangeal_1").setCenter(0.1955,0.8159,0.0464).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setName("l_carpometacarpal_2").setCenter(0.1983,0.8024,-0.028).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_l_metacarpal_2").setName("l_metacarpal_2"))
                                                      .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setName("l_metacarpophalangeal_2").setCenter(0.1983,0.7815,-0.028).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_l_carpal_proximal_phalanx_2").setName("l_carpal_proximal_phalanx_2"))
                                                        .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_proximal_interphalangeal_2").setCenter(0.2017,0.7363,-0.0248).setStiffness(new double[] {0.0,0.0,0.0})
                                                          .addChild(new HAnimSegment("hanim_l_carpal_middle_phalanx_2").setName("l_carpal_middle_phalanx_2"))
                                                          .addChild(new HAnimJoint("hanim_l_carpal_distal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_2").setCenter(0.2028,0.7139,-0.0236).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setName("l_carpometacarpal_3").setCenter(0.1987,0.8029,-0.053).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_l_metacarpal_3").setName("l_metacarpal_3"))
                                                      .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setName("l_metacarpophalangeal_3").setCenter(0.1987,0.7818,-0.053).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_l_carpal_proximal_phalanx_3").setName("l_carpal_proximal_phalanx_3"))
                                                        .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_proximal_interphalangeal_3").setCenter(0.2013,0.7273,-0.0503).setStiffness(new double[] {0.0,0.0,0.0})
                                                          .addChild(new HAnimSegment("hanim_l_carpal_middle_phalanx_3").setName("l_carpal_middle_phalanx_3"))
                                                          .addChild(new HAnimJoint("hanim_l_carpal_distal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_3").setCenter(0.2026,0.7011,-0.0494).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setName("l_carpometacarpal_4").setCenter(0.1956,0.8019,-0.0794).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_l_metacarpal_4").setName("l_metacarpal_4"))
                                                      .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setName("l_metacarpophalangeal_4").setCenter(0.1956,0.7815,-0.0794).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_l_carpal_proximal_phalanx_4").setName("l_carpal_proximal_phalanx_4"))
                                                        .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_proximal_interphalangeal_4").setCenter(0.1973,0.7287,-0.0777).setStiffness(new double[] {0.0,0.0,0.0})
                                                          .addChild(new HAnimSegment("hanim_l_carpal_middle_phalanx_4").setName("l_carpal_middle_phalanx_4"))
                                                          .addChild(new HAnimJoint("hanim_l_carpal_distal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_4").setCenter(0.1983,0.7045,-0.0767).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setName("l_carpometacarpal_5").setCenter(0.1925,0.8066,-0.1036).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_l_metacarpal_5").setName("l_metacarpal_5"))
                                                      .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setName("l_metacarpophalangeal_5").setCenter(0.1925,0.7866,-0.1036).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_l_carpal_proximal_phalanx_5").setName("l_carpal_proximal_phalanx_5"))
                                                        .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_5").setName("l_carpal_proximal_interphalangeal_5").setCenter(0.1938,0.7452,-0.1024).setStiffness(new double[] {0.0,0.0,0.0})
                                                          .addChild(new HAnimSegment("hanim_l_carpal_middle_phalanx_5").setName("l_carpal_middle_phalanx_5"))
                                                          .addChild(new HAnimJoint("hanim_l_carpal_distal_interphalangeal_5").setName("l_carpal_distal_interphalangeal_5").setCenter(0.1948,0.7277,-0.1017).setStiffness(new double[] {0.0,0.0,0.0})
                                          ...
                                          .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(-0.082,1.4488,-0.0353).setStiffness(new double[] {0.0,0.0,0.0})
                                            ...
                                            .addChild(new HAnimJoint("hanim_r_acromioclavicular").setName("r_acromioclavicular").setCenter(-0.0962,1.4269,-0.0424).setStiffness(new double[] {0.0,0.0,0.0})
                                              .addChild(new HAnimSegment("hanim_r_scapula").setName("r_scapula"))
                                              .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_shoulder").setCenter(-0.2029,1.4376,-0.0387).setStiffness(new double[] {0.0,0.0,0.0})
                                                ...
                                                .addChild(new HAnimJoint("hanim_r_elbow").setName("r_elbow").setCenter(-0.2014,1.1357,-0.0682).setStiffness(new double[] {0.0,0.0,0.0})
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(-0.1984,0.8663,-0.0583).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setName("r_carpometacarpal_1").setCenter(-0.1924,0.8472,-0.0534).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_r_metacarpal_1").setName("r_metacarpal_1"))
                                                      .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setName("r_metacarpophalangeal_1").setCenter(-0.1951,0.8226,0.0246).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_r_carpal_proximal_phalanx_1").setName("r_carpal_proximal_phalanx_1"))
                                                        .addChild(new HAnimJoint("hanim_r_carpal_interphalangeal_1").setName("r_carpal_interphalangeal_1").setCenter(-0.1955,0.8159,0.0464).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setName("r_carpometacarpal_2").setCenter(-0.1983,0.8024,-0.028).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_r_metacarpal_2").setName("r_metacarpal_2"))
                                                      .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setName("r_metacarpophalangeal_2").setCenter(-0.1983,0.7815,-0.028).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_r_carpal_proximal_phalanx_2").setName("r_carpal_proximal_phalanx_2"))
                                                        .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setCenter(-0.2017,0.7363,-0.0248).setStiffness(new double[] {0.0,0.0,0.0})
                                                          .addChild(new HAnimSegment("hanim_r_carpal_middle_phalanx_2").setName("r_carpal_middle_phalanx_2"))
                                                          .addChild(new HAnimJoint("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setCenter(-0.2028,0.7139,-0.0236).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setName("r_carpometacarpal_3").setCenter(-0.1987,0.8029,-0.053).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_r_metacarpal_3").setName("r_metacarpal_3"))
                                                      .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setName("r_metacarpophalangeal_3").setCenter(-0.1987,0.7818,-0.053).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_r_carpal_proximal_phalanx_3").setName("r_carpal_proximal_phalanx_3"))
                                                        .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setCenter(-0.2013,0.7273,-0.0503).setStiffness(new double[] {0.0,0.0,0.0})
                                                          .addChild(new HAnimSegment("hanim_r_carpal_middle_phalanx_3").setName("r_carpal_middle_phalanx_3"))
                                                          .addChild(new HAnimJoint("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setCenter(-0.2026,0.7011,-0.0494).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setName("r_carpometacarpal_4").setCenter(-0.1956,0.8019,-0.0794).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_r_metacarpal_4").setName("r_metacarpal_4"))
                                                      .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setName("r_metacarpophalangeal_4").setCenter(-0.1956,0.7815,-0.0794).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_r_carpal_proximal_phalanx_4").setName("r_carpal_proximal_phalanx_4"))
                                                        .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setCenter(-0.1973,0.7287,-0.0777).setStiffness(new double[] {0.0,0.0,0.0})
                                                          .addChild(new HAnimSegment("hanim_r_carpal_middle_phalanx_4").setName("r_carpal_middle_phalanx_4"))
                                                          .addChild(new HAnimJoint("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setCenter(-0.1983,0.7045,-0.0767).setStiffness(new double[] {0.0,0.0,0.0})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setName("r_carpometacarpal_5").setCenter(-0.1925,0.8066,-0.1036).setStiffness(new double[] {0.0,0.0,0.0})
                                                      .addChild(new HAnimSegment("hanim_r_metacarpal_5").setName("r_metacarpal_5"))
                                                      .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setName("r_metacarpophalangeal_5").setCenter(-0.1925,0.7866,-0.1036).setStiffness(new double[] {0.0,0.0,0.0})
                                                        .addChild(new HAnimSegment("hanim_r_carpal_proximal_phalanx_5").setName("r_carpal_proximal_phalanx_5"))
                                                        .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setCenter(-0.1938,0.7452,-0.1024).setStiffness(new double[] {0.0,0.0,0.0})
                                                          .addChild(new HAnimSegment("hanim_r_carpal_middle_phalanx_5").setName("r_carpal_middle_phalanx_5"))
                                                          .addChild(new HAnimJoint("hanim_r_carpal_distal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setCenter(-0.1948,0.7277,-0.1017).setStiffness(new double[] {0.0,0.0,0.0})

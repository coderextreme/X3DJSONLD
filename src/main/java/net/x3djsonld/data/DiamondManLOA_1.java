...
public class DiamondManLOA_1
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("DiamondManLOA_1.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("HAnim skeletal structure for Level of Action (LOA) one, with diamonds at the Joint centers. LOA-1 is typical low-end real-time 3D hierarchy."))
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_humanoid").setName("humanoid").setVersion("1.0")
      ...
      .addSkeleton(new HAnimJoint("hanim_HumanoidRoot").setName("HumanoidRoot").setCenter(0.0,0.8240,0.0277).setStiffness(new double[] {0.0,0.0,0.0})
        .addChild(new HAnimJoint("hanim_sacroiliac").setName("sacroiliac").setCenter(0.0,0.9149,0.0016).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_l_hip").setName("l_hip").setCenter(0.0961,0.9124,-0.0001).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_l_knee").setName("l_knee").setCenter(0.1040,0.4867,0.0308).setStiffness(new double[] {0.0,0.0,0.0})
              .addChild(new HAnimSegment("hanim_l_calf").setName("l_calf")
                .addChild(new Transform().setTranslation(0.1040,0.4867,0.0308)
                  .addChild(new Shape().setUSE("DiamondShape"))))
              .addChild(new HAnimJoint("hanim_l_ankle").setName("l_ankle").setCenter(0.1101,0.0656,-0.0736).setStiffness(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new HAnimJoint("hanim_l_midtarsal").setName("l_midtarsal").setCenter(0.1086,0.0001,0.0368).setStiffness(new double[] {0.0,0.0,0.0})
                  .addChild(new HAnimSegment("hanim_l_middistal").setName("l_middistal")
                    ...
                    .addChild(new HAnimSite("hanim_l_metatarsal_pha5_pt").setName("l_metatarsal_pha5_pt").setTranslation(0.1825,0.0070,0.0928))
          ...
          .addChild(new HAnimJoint("hanim_r_hip").setName("r_hip").setCenter(-0.0950,0.9171,0.0029).setStiffness(new double[] {0.0,0.0,0.0})
            .addChild(new HAnimSegment("hanim_r_thigh").setName("r_thigh")
              ...
              .addChild(new HAnimSite("hanim_r_femoral_lateral_epicn_pt").setName("r_femoral_lateral_epicn_pt").setTranslation(-0.1421,0.4992,0.0310))
            ...
            .addChild(new HAnimJoint("hanim_r_knee").setName("r_knee").setCenter(-0.0867,0.4913,0.0318).setStiffness(new double[] {0.0,0.0,0.0})
              .addChild(new HAnimSegment("hanim_r_calf").setName("r_calf")
                .addChild(new Transform().setTranslation(-0.0867,0.4913,0.0318)
                  .addChild(new Shape().setUSE("DiamondShape"))))
              .addChild(new HAnimJoint("hanim_r_ankle").setName("r_ankle").setCenter(-0.0801,0.0712,-0.0766).setStiffness(new double[] {0.0,0.0,0.0})
                ...
                .addChild(new HAnimJoint("hanim_r_midtarsal").setName("r_midtarsal").setCenter(-0.0801,0.0,0.0368).setStiffness(new double[] {0.0,0.0,0.0})
                  .addChild(new HAnimSegment("hanim_r_middistal").setName("r_middistal")
                    ...
                    .addChild(new HAnimSite("hanim_r_metatarsal_pha1_pt").setName("r_metatarsal_pha1_pt").setTranslation(-0.0521,0.0260,0.0127))
                    .addChild(new HAnimSite("hanim_r_digit2_pt").setName("r_digit2_pt").setTranslation(-0.0883,0.0134,0.1383))))))))
        .addChild(new HAnimJoint("hanim_vl1").setName("vl1").setCenter(-0.00405,1.07,-0.0275).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_shoulder").setCenter(0.2029,1.4376,-0.0387).setStiffness(new double[] {0.0,0.0,0.0})
            .addChild(new HAnimSegment("hanim_l_upperarm").setName("l_upperarm")
              ...
              .addChild(new HAnimSite("hanim_l_humeral_lateral_epicn_pt").setName("l_humeral_lateral_epicn_pt").setTranslation(0.2280,1.1482,-0.1100)))
            .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(0.2014,1.1357,-0.0682).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimJoint("hanim_l_wrist").setName("l_wrist").setCenter(0.1984,0.8663,-0.0583).setStiffness(new double[] {0.0,0.0,0.0})
                .addChild(new HAnimSegment("hanim_l_hand").setName("l_hand")
                  ...
                  .addChild(new HAnimSite("hanim_l_metacarpal_pha5_pt").setName("l_metacarpal_pha5_pt").setTranslation(0.1929,0.7860,-0.1122))))))
          .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_shoulder").setCenter(-0.1907,1.4407,-0.0325).setStiffness(new double[] {0.0,0.0,0.0})
            ...
            .addChild(new HAnimJoint("hanim_r_elbow").setName("r_elbow").setCenter(-0.1949,1.1388,-0.0620).setStiffness(new double[] {0.0,0.0,0.0})
              .addChild(new HAnimSegment("hanim_r_forearm").setName("r_forearm")
                ...
                .addChild(new HAnimSite("hanim_r_humeral_medial_epicn_pt").setName("r_humeral_medial_epicn_pt").setTranslation(-0.1680,1.1298,-0.1062))
                .addChild(new HAnimSite("hanim_r_radiale_pt").setName("r_radiale_pt").setTranslation(-0.2130,1.1305,-0.1091)))
              .addChild(new HAnimJoint("hanim_r_wrist").setName("r_wrist").setCenter(-0.1959,0.8694,-0.0521).setStiffness(new double[] {0.0,0.0,0.0})
                .addChild(new HAnimSegment("hanim_r_hand").setName("r_hand")
                  ...
                  .addChild(new HAnimSite("hanim_r_metacarpal_pha5_pt").setName("r_metacarpal_pha5_pt").setTranslation(-0.1929,0.7890,-0.1064))))))
          .addChild(new HAnimJoint("hanim_vc4").setName("vc4").setCenter(0.0,1.43,-0.0458).setStiffness(new double[] {0.0,0.0,0.0})
          ...
          .addChild(new HAnimJoint("hanim_skullbase").setName("skullbase").setCenter(0.0044,1.6209,0.0236).setStiffness(new double[] {0.0,0.0,0.0})
            .addChild(new HAnimSegment("hanim_skull").setName("skull")
              .addChild(new Transform().setTranslation(0.0044,1.6209,0.0236)
                .addChild(new Shape().setUSE("DiamondShape")))
              .addChild(new HAnimSite("hanim_skull_tip").setName("skull_tip").setTranslation(0.0050,1.7504,0.0055))
      ...
      .addViewpoints(new HAnimSite("hanim_DiamondManLOA_1_view").setName("DiamondManLOA_1_view")
    ...
    {
        X3D thisExampleX3dModel = new DiamondManLOA_1().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.DiamondManLOA_1\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.DiamondManLOA_1\" self-validation test results: ");

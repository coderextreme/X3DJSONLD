...
public class x3domflowers
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("x3domflowers.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/x3domflowers.x3d")))
  .setScene(new Scene()
    ...
    .addChild(new Group()
      .addChild(new ExternProtoDeclare("FlowerProto").setName("FlowerProto").setUrl(new String[] {"../data/flowerproto.json#FlowerProto"})
        ...
        .setProtoBody(new ProtoBody()
          .addChild(new Group()
            .addChild(new ProtoInstance("FlowerProto").setContainerField("children")
              .addFieldValue(new fieldValue().setName("vertex").setValue(new String[] {"../shaders/x3dom_flowers_chromatic.vs"}))
...
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.x3domflowers\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.x3domflowers self-validation test results: ");

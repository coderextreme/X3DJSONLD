...
public class CloudsProcedural4
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new DirectionalLight().setAmbientIntensity(1.0).setDirection(-1.0,0.0,0.0).setGlobal(true))
...
""")
      ...
      .addChild(new DirectionalLight().setAmbientIntensity(1.0).setColor(1.0,0.0,0.0).setDirection(-1.0,-1.0,0.0).setGlobal(true))));
            }
            catch (Exception ex)
            {       
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.CloudsProcedural4 self-validation test results: ");

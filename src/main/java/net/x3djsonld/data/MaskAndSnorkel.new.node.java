        ...
        .addChild(new Transform().setTranslation(0.0,-0.02,0.0)
          .addChild(new Transform().setScale(0.9,0.9,0.9).setTranslation(0.035,-0.07,-0.02)
            .addChild(new Shape()
              ...
              .setGeometry(new Extrusion().setCrossSection(new MFVec2f(new double[] {0.0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0.0,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0.0,0.013,-0.00494,-0.01196,-0.00923,-0.00923,-0.01196,-0.00494,-0.013,0.0,-0.01196,0.00494,-0.00923,0.00923,-0.00494,0.01196,0.0,0.013})).setSpine(new MFVec3f(new double[] {-0.01,-0.04,0.0,0.0,0.0,0.0,0.03,0.05,0.0,0.05,0.2,0.0,0.03,0.4,0.03})))))
          .addChild(new Transform().setRotation(0.0,0.0,1.0,1.57).setScale(0.9,0.9,0.9).setTranslation(0.01,-0.04,-0.02)
            .addChild(new Shape()
              ...
              .setGeometry(new Extrusion().setCrossSection(new MFVec2f(new double[] {0.0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0.0,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0.0,0.013,-0.00494,-0.01196,-0.00923,-0.00923,-0.01196,-0.00494,-0.013,0.0,-0.01196,0.00494,-0.00923,0.00923,-0.00494,0.01196,0.0,0.013})).setSpine(new MFVec3f(new double[] {-0.01,-0.03,0.0,0.0,0.0,0.0,0.02,0.01,0.0})))))
          .addChild(new Transform().setRotation(0.0,0.0,1.0,-0.85).setScale(0.9,0.9,0.9).setTranslation(0.005,-0.01,-0.02)
            .addChild(new Shape()
              ...
              .setGeometry(new Extrusion().setCrossSection(new MFVec2f(new double[] {0.0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0.0,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0.0,0.013})).setSpine(new MFVec3f(new double[] {-0.02,-0.03,0.0,-0.01,-0.03,0.0,0.0,-0.0175,0.0,0.0,-0.0135,0.0,-0.01,0.0,0.0,-0.02,0.0,0.0})))))))
      .addChild(new Transform()
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.MaskAndSnorkel self-validation test results: ");

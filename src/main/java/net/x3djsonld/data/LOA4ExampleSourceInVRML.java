...
public class LOA4ExampleSourceInVRML
{
	...
	public LOA4ExampleSourceInVRML ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_SOURCE     ).setContent("LOA4ExampleSourceInVRML.wrl")))
  .setScene(new Scene()
   ...
   "}).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;4")))
    ...
    {
        X3D thisExampleX3dModel = new LOA4ExampleSourceInVRML().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"LOA4ExampleSourceInVRML\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"LOA4ExampleSourceInVRML\" self-validation test results: ");

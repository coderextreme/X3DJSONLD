...
"}" + "\n")
    ...
    .addComments(" <Appearance DEF='DeclarativeAppearanceExample'> ")
    .addComments(" <!- - DeclarativeMaterialExample gets overridden by subsequently added MaterialModulator ProtoInstance - -> ")
    .addComments(" <ProtoInstance DEF='MyMaterialModulator' name='MaterialModulator' containerField='material'/> ")

...
public class SpatialAudioCameraAnimation
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new OrientationInterpolator("Camera001-ROT-INTERP").setKey(new double[] {0.0,0.25,0.5,0.75,1.0}).setKeyValue(new MFRotation(new double[] {1,0,0,-0.523599,0.99999,0.003554,0.002727,-1.309007,0,-0.965926,-0.258819,-3.141593,0.002282,-0.793351,-0.60876,-3.135645,1,-1.0E-6,0.0,-0.523599})))

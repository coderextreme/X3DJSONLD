 ...
 <p> Related links: JinLOA1.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> detect, append _2. rescale smaller than 30m! convert inches to meters? what about motion scaling? </td>
		</tr>
		<tr>
...
public class JinLOA1
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TODO       ).setContent("detect, append _2. rescale smaller than 30m! convert inches to meters? what about motion scaling?"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_JinLOA1").setName("JinLOA1").setLoa(1).setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addSkeleton(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,30.530001,-0.707600)
        .addChild(new HAnimSegment("hanim_sacrum").setName("sacrum")
          .addChild(new Transform().setTranslation(0.0,30.530001,-0.707600)
            .addChild(new Shape()
              ...
              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_8_33_coordIndex()).setTexCoordIndex(getIndexedFaceSet_8_33_texCoordIndex())
        ...
        .addChild(new HAnimJoint("hanim_sacroiliac").setName("sacroiliac").setCenter(0.0,35.799999,-0.707600)
          .addChild(new HAnimSegment("hanim_pelvis").setName("pelvis")
            .addChild(new Transform().setTranslation(0.0,35.799999,-0.707600)
              .addChild(new Shape()
                ...
                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_9_42_coordIndex()).setTexCoordIndex(getIndexedFaceSet_9_42_texCoordIndex())
                  .setCoord(new Coordinate().setPoint(getCoordinate_10_42_point()))
                  .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.6211,0.5754,0.7851,0.5720,0.7614,0.5720,0.6907,0.5698,0.6200,0.5698,0.6158,0.5702,0.5451,0.5702,0.4167,0.5698,0.5451,0.5702,0.6158,0.5702,0.6200,0.5698,0.6907,0.5698,0.7614,0.5720,0.8036,0.5346,0.7761,0.5346,0.6989,0.4838,0.6219,0.4428,0.6154,0.4438,0.5492,0.4639,0.4166,0.5346,0.5492,0.4639,0.6154,0.4438,0.6219,0.4428,0.6989,0.4838,0.7761,0.5346,0.7912,0.4044,0.7635,0.4044,0.7042,0.3925,0.6194,0.3907,0.6148,0.3907,0.5450,0.3974,0.4163,0.4938,0.5450,0.3974,0.6148,0.3907,0.6194,0.3907,0.7042,0.3925,0.7635,0.4044,0.7950,0.3772,0.7662,0.3772,0.6945,0.3645,0.6236,0.3695,0.6160,0.3695,0.5438,0.3780,0.4160,0.4530,0.5438,0.3780,0.6160,0.3695,0.6236,0.3695,0.6945,0.3645,0.7662,0.3772,0.7887,0.3451,0.7635,0.3451,0.6980,0.3508,0.6262,0.3508,0.6297,0.3503,0.5389,0.3503,0.4181,0.3884,0.5389,0.3503,0.6297,0.3503,0.6262,0.3508,0.6980,0.3508,0.7635,0.3451,0.6237,0.3398})))))))
          .addChild(new HAnimJoint("hanim_l_hip").setName("l_hip").setCenter(4.207,32.020,-0.815500)
              ...
              .addChild(new Transform().setTranslation(4.207,32.020,-0.815500)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                    .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_10_51_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_51_texCoordIndex())
                  ...
                  .addChild(new Transform().setTranslation(3.854,3.939,-0.703800)
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_12_69_coordIndex()).setTexCoordIndex(getIndexedFaceSet_12_69_texCoordIndex())
          ...
          .addChild(new HAnimJoint("hanim_r_hip").setName("r_hip").setCenter(-4.207,32.020,-0.815500)
              ...
              .addChild(new Transform().setTranslation(-4.207,32.020,-0.815500)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                    .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_10_91_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_91_texCoordIndex())
                  ...
                  .addChild(new Transform().setTranslation(-3.854,3.939,-0.703800)
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet
1.7500,-2.9420,-1.9150,2.4050,-1.6560,-1.9150,1.7420,-0.5681,-1.9150,-1.7420,-0.5681,-1.9150,-1.7840,-0.6480,2.3320,-2.2160,-2.2670,4.1440,-2.2160,-3.6480,3.7760,0.0,-2.2670,5.4630,0.0,-0.5463,3.9500,-1.7400,-0.3226,1.1580,-2.6610,-1.8660,0.9192,-2.1400,-3.6480,0.9192,2.2160,-2.2670,4.1440,1.7840,-0.6480,2.3320,0.0,-3.6480,5.0960,2.2160,-3.6480,3.7760,1.7400,-0.3226,1.1580,2.6610,-1.8660,0.9192,2.1400,-3.6480,0.9192,0.0,-3.6480,3.7760,0.0,-3.6480,0.9192,0.0,-0.0274,1.6610})))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.4330,0.0595,0.4411,0.0186,0.4637,0.1714,0.4411,0.0186,0.4244,0.1312,0.4394,0.1472,0.4330,0.0595,0.4244,0.1312,0.4411,0.0186,0.4637,0.1714,0.4394,0.1472,0.4411,0.0186,0.4640,0.1246,0.4607,0.0558,0.4904,0.0166,0.4640,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4949,0.0186,0.4868,0.1432,0.4868,0.1432,0.4330,0.0595,0.4411,0.0186,0.4411,0.0186,0.4411,0.0186,0.4330,0.0595,0.4244,0.1312,0.4244,0.1312,0.5320,0.0980,0.5645,0.0707,0.4885,0.1020,0.5026,0.0440,0.5945,0.0186,0.5487,0.0186,0.5487,0.0186,0.4640,0.1246,0.4607,0.0558,0.4904,0.0166,0.4949,0.0186,0.4868,0.1432,0.5645,0.0707,0.5026,0.0440,0.4885,0.1020,0.5320,0.0980,0.5945,0.0186,0.5487,0.0186,0.4640,0.1246,0.4607,0.0558,0.4904,0.0166,0.5487,0.0186,0.4949,0.0186,0.4868,0.1432}))))))))))))
        .addChild(new HAnimJoint("hanim_vl5").setName("vl5").setCenter(0.0,40.070,-0.852700)
            ...
            .addChild(new Transform().setTranslation(0.0,40.070,-0.852700)
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                  .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_9_132_coordIndex()).setTexCoordIndex(getIndexedFaceSet_9_132_texCoordIndex())
                  .setCoord(new Coordinate().setPoint(getCoordinate_10_132_point()))
                  .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_10_133_point()))))))
          .addChild(new HAnimJoint("hanim_skullbase").setName("skullbase").setCenter(0.0,57.430,-0.686300)
              ...
              .addChild(new Transform().setTranslation(0.0,57.430,-0.686300)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                    .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(getIndexedFaceSet_10_141_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_141_texCoordIndex())
                    .setCoord(new Coordinate().setPoint(getCoordinate_11_141_point()))
                    .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_11_142_point()))))))
            .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_shoulder").setCenter(5.975,52.0,-0.145200)
              ...
              .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(8.093,40.380001,-0.250200)
                ...
                .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(7.808,31.459999,-0.058490)
            ...
            .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_shoulder").setCenter(-5.975,52.0,-0.145200)
                  ...
                  .addChild(new Transform().setTranslation(-8.093,40.380001,-0.250200)
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159).setCoordIndex(new int[] {0,1,2,-1,0,2,3,-1,4,0,3,-1,0,5,6,-1,6,1,0,-1,1,6,7,-1,7,2,1,-1,2,7,8,-1,8,3,2,-1,3,8,9,-1,9,4,3,-1,4,9,5,-1,5,0,4,-1,5,10,11,-1,11,6,5,-1,6,11,12,-1,12,7,6,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,9,8,-1,9,14,10,-1,10,5,9,-1,10,15,16,-1,16,11,10,-1,11,16,17,-1,17,12,11,-1,12,17,18,-1,18,13,12,-1,13,18,19,-1,19,14,13,-1,14,19,15,-1,15,10,14,-1,23,22,21,-1,23,21,20,-1,24,23,20,-1,21,16,15,-1,15,20,21,-1,22,17,16,-1,16,21,22,-1,23,18,17,-1,17,22,23,-1,24,19,18,-1,18,23,24,-1,20,15,19,-1,19,24,20,-1}).setTexCoordIndex(new int[] {26,25,2,-1,26,2,3,-1,4,26,3,-1,0,5,6,-1,6,1,0,-1,27,28,7,-1,7,2,27,-1,2,7,8,-1,8,3,2,-1,3,8,9,-1,9,4,3,-1,4,9,5,-1,5,0,4,-1,5,10,11,-1,11,6,5,-1,29,30,12,-1,12,7,29,-1,7,12,13,-1,13,8,7,-1,8,13,14,-1,14,9,8,-1,9,14,10,-1,10,5,9,-1,10,15,16,-1,16,11,10,-1,31,32,17,-1,17,12,31,-1,12,17,18,-1,18,13,12,-1,13,18,19,-1,19,14,13,-1,14,19,15,-1,15,10,14,-1,23,22,34,-1,23,34,33,-1,24,23,33,-1,21,16,15,-1,15,20,21,-1,22,17,35,-1,35,36,22,-1,23,18,17,-1,17,22,23,-1,24,19,18,-1,18,23,24,-1,20,15,19,-1,19,24,20,-1})
                        .setCoord(new Coordinate().setPoint(new MFVec3f(new double[] {-0.2150,0.3047,-1.1520,-1.1550,0.2966,-0.2588,-0.6199,0.3013,1.0400,0.6505,0.3122,0.9491,0.9008,0.3143,-0.4054,-0.1442,-0.8448,-1.6250,-1.4720,-0.8561,-0.4271,-0.7164,-0.8496,1.6250,1.0790,-0.8342,1.4820,1.4330,-0.8312,-0.6588,-0.1328,-3.5,-1.6070,-1.5510,-3.5130,-0.4225,-0.7810,-2.9250,1.6100,1.1360,-2.9090,1.4680,1.5510,-3.4860,-0.6519,-0.0592,-8.7130,-1.4370,-1.0930,-8.7220,-0.1279,-0.5047,-8.7160,1.5100,0.8932,-8.7040,1.3770,1.1690,-8.7020,-0.3428,-0.0092,-9.3360,-0.8855,-0.7154,-9.3420,0.0084,-0.3135,-9.3390,1.0430,0.6412,-9.3310,0.9519,0.8292,-9.3290,-0.1383})))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.4222,0.6201,0.4327,0.6201,0.3884,0.6201,0.3987,0.6201,0.4103,0.6201,0.4213,0.6265,0.4321,0.6265,0.3894,0.6265,0.3990,0.6265,0.4105,0.6265,0.4214,0.6413,0.4323,0.6413,0.3890,0.6381,0.3992,0.6381,0.4103,0.6413,0.4213,0.6705,0.4336,0.6705,0.3899,0.6705,0.3981,0.6705,0.4094,0.6705,0.4215,0.6740,0.4346,0.6740,0.3899,0.6740,0.3980,0.6740,0.4083,0.6740,0.3787,0.6201,0.3682,0.6201,0.3787,0.6201,0.3782,0.6265,0.3782,0.6265,0.3783,0.6413,0.3783,0.6413,0.3796,0.6705,0.3676,0.6740,0.3806,0.6740,0.3796,0.6705,0.3806,0.6740})))))))
                .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(-7.808,31.459999,-0.058490)
	...
	// end of initialize() method
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_9_132_coordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_9_132_coordIndex_2()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_9_132_texCoordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_9_132_texCoordIndex_2()
		{
		...
		private double[] getCoordinate_10_132_point_1()
		{
		...
		private double[] getCoordinate_10_132_point_2()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_10_133_point_1()
		{
		...
		private double[] getTextureCoordinate_10_133_point_2()
		{
		...
		private double[] getTextureCoordinate_10_133_point_3()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_141_coordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_10_141_coordIndex_2()
		{
		...
		private int[] getIndexedFaceSet_10_141_coordIndex_3()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_141_texCoordIndex_1()
		{
		...
		private int[] getIndexedFaceSet_10_141_texCoordIndex_2()
		{
		...
		private int[] getIndexedFaceSet_10_141_texCoordIndex_3()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getCoordinate_11_141_point_1()
		{
		...
		private double[] getCoordinate_11_141_point_2()
		{
		...
		private double[] getCoordinate_11_141_point_3()
		{
		...
		private double[] getCoordinate_11_141_point_4()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_11_142_point_1()
		{
		...
		private double[] getTextureCoordinate_11_142_point_2()
		{
		...
		private double[] getTextureCoordinate_11_142_point_3()
		{
		...
		private double[] getTextureCoordinate_11_142_point_4()
		{
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #42, 480 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #42, 186 total numbers made up of 62 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_42_point = new MFVec3f(new double[] {0.0,1.0530,0.0273,0.0,0.9123,-0.5414,-0.4375,0.9123,-0.4652,-0.7578,0.9123,-0.3733,-0.8750,0.9123,0.0273,-0.7578,0.9123,0.4279,-0.4375,0.9123,0.5198,0.0,0.9123,0.5960,0.4375,0.9123,0.5198,0.7578,0.9123,0.4279,0.8750,0.9123,0.0273,0.7578,0.9123,-0.3733,0.4375,0.9123,-0.4652,0.0,0.5267,-0.8842,-0.5658,0.5267,-0.7621,-0.9800,0.5267,-0.4285,-1.1320,0.5267,0.0273,-0.9800,0.5267,0.4830,-0.5658,0.5267,0.6985,0.0,0.5267,0.8206,0.5658,0.5267,0.6985,0.9800,0.5267,0.4830,1.1320,0.5267,0.0273,0.9800,0.5267,-0.4285,0.5658,0.5267,-0.7621,0.0,0.0,-0.9616,-0.6534,0.0,-0.8206,-1.1320,0.0,-0.4353,-1.3070,0.0,0.0273,-1.1320,0.0,0.5536,-0.6534,0.0,0.8206,0.0,0.0,0.9616,0.6534,0.0,0.8206,1.1320,0.0,0.5536,1.3070,0.0,0.0273,1.1320,0.0,-0.4353,0.6534,0.0,-0.8206,0.0,-0.5267,-0.8206,-0.5658,-0.5267,-0.6985,-0.9800,-0.5267,-0.3648,-1.1320,-0.5267,0.0273,-0.9800,-0.5267,0.4830,-0.5658,-0.5267,0.6985,0.0,-0.5267,0.8206,0.5658,-0.5267,0.6985,0.9800,-0.5267,0.4830,1.1320,-0.5267,0.0273,0.9800,-0.5267,-0.3648,0.5658,-0.5267,-0.6985,0.0,-0.9123,-0.4353,-0.3267,-0.9123,-0.3648,-0.5658,-0.9123,-0.2358,-0.6534,-0.9123,0.0273,-0.5658,-0.9123,0.2904,-0.3267,-0.9123,0.4830,0.0,-0.9123,0.5536,0.3267,-0.9123,0.4830,0.5658,-0.9123,0.2904,0.6534,-0.9123,0.0273,0.5658,-0.9123,-0.2358,0.3267,-0.9123,-0.3648,0.0,-1.0530,0.0273});
			return Coordinate_10_42_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #51, 488 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #51, 488 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #51, 189 total numbers made up of 63 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #69, 165 total numbers made up of 55 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #91, 488 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element
,-2.0460,0.0,-0.6007,-2.0460,1.4090,-1.9250,-2.8780,0.0,-1.9250,-2.8780,1.1090,-0.6007,-2.0460,1.4090,-3.9470,-1.6810,-2.9270,-1.9250,0.4309,-2.0890,-3.9470,0.4309,-2.0450,-0.6007,0.4309,2.9270,-1.9250,0.4309,2.0450,-0.6007,0.4309,2.0890,-3.9470,0.4309,0.0,-3.9470,0.4309,-0.9442,-0.3153,-1.6920,0.0,-0.3153,-1.6920,0.9442,-0.3153,-1.6920,1.7,-0.3153,0.3093,-1.7,-0.3153,0.3093,-1.8600,-3.7930,1.3640,-2.5410,-1.9630,1.3640,-1.8610,-0.9431,1.3640,1.8610,-0.9431,1.3640,2.5410,-1.9630,1.3640,1.8600,-3.7930,1.3640,0.0,-3.7930,1.3640});
			return Coordinate_13_109_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #132, 1336 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFInt32 IndexedFaceSet_9_132_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_9_132_coordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_9_132_coordIndex_2()));
			return IndexedFaceSet_9_132_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #132, 1336 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_9_132_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_9_132_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_9_132_texCoordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_9_132_texCoordIndex_2()));
			return IndexedFaceSet_9_132_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #132, 522 total numbers made up of 174 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_132_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_132_point_1()))
				.append(new MFVec3f(getCoordinate_10_132_point_2()));
			return Coordinate_10_132_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #133, 420 total numbers made up of 210 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_10_133_point()
		{
			MFVec2f TextureCoordinate_10_133_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_10_133_point_1()))
				.append(new MFVec2f(getTextureCoordinate_10_133_point_2()))
				.append(new MFVec2f(getTextureCoordinate_10_133_point_3()));
			return TextureCoordinate_10_133_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #141, 2368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_141_coordIndex()
		{
			MFInt32 IndexedFaceSet_10_141_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_141_coordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_10_141_coordIndex_2()))
				.append(new MFInt32(getIndexedFaceSet_10_141_coordIndex_3()));
			return IndexedFaceSet_10_141_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #141, 2368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_10_141_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_10_141_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_10_141_texCoordIndex_1()))
				.append(new MFInt32(getIndexedFaceSet_10_141_texCoordIndex_2()))
				.append(new MFInt32(getIndexedFaceSet_10_141_texCoordIndex_3()));
			return IndexedFaceSet_10_141_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #141, 1068 total numbers made up of 356 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_11_141_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_11_141_point_1()))
				.append(new MFVec3f(getCoordinate_11_141_point_2()))
				.append(new MFVec3f(getCoordinate_11_141_point_3()))
				.append(new MFVec3f(getCoordinate_11_141_point_4()));
			return Coordinate_11_141_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=11, element #142, 772 total numbers made up of 386 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_11_142_point()
		{
			MFVec2f TextureCoordinate_11_142_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_11_142_point_1()))
				.append(new MFVec2f(getTextureCoordinate_11_142_point_2()))
				.append(new MFVec2f(getTextureCoordinate_11_142_point_3()))
				.append(new MFVec2f(getTextureCoordinate_11_142_point_4()));
			return TextureCoordinate_11_142_point;
		}
    ...
    public static void main(String args[])
    {
		...
		if (validate)
		{
			System.out.print("Java program \"JinLOA1\" self-validation test results: ");

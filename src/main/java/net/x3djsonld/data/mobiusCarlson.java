 ...
 * <p> a mobius of 3 NURBS Patch Surfaces. </p>
 <p> Related links:  source mobiusCarlson.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
        <caption>Scene Meta Information</caption>
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.mobiusCarlson&nbsp; Document Metadata </td>
		</tr>

		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> title </i> </td>
			<td> <a href="https://kshell.com/mobiusCarlson.x3d">mobiusCarlson.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://kshell.com/mobiusCarlson.x3d" target="_blank">https://kshell.com/mobiusCarlson.x3d</a> </td>
		</tr>
		<tr>
...
public class mobiusCarlson
{
	/** Default constructor to create this object. */
	public mobiusCarlson ()
	{
	  initialize();
	}
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("mobiusCarlson.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://kshell.com/mobiusCarlson.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape()
      .setGeometry(new NurbsPatchSurface().setSolid(false).setUDimension(91).setUKnot(getNurbsPatchSurface_4_11_uKnot()).setUOrder(4).setVDimension(3).setVKnot(new double[] {0.0,0.0,0.0,1.0,1.0,1.0}).setWeight(getNurbsPatchSurface_4_11_weight())
        ...
        .setControlPoint(new Coordinate().setPoint(getCoordinate_5_13_point())))
    ...
    .addChild(new Shape()
      .setGeometry(new NurbsPatchSurface().setSolid(false).setUDimension(91).setUKnot(getNurbsPatchSurface_4_18_uKnot()).setUOrder(4).setVDimension(3).setVKnot(new double[] {0.0,0.0,0.0,1.0,1.0,1.0}).setWeight(getNurbsPatchSurface_4_18_weight())
        .setMetadata(new MetadataSet()
          .setMetadata(new MetadataString().setName("INSTANT_PLAYER_MODE").setValue(new String[] {"True"})))
        .setControlPoint(new Coordinate().setPoint(getCoordinate_5_20_point())))
    ...
    .addChild(new Shape()
      .setGeometry(new NurbsPatchSurface().setSolid(false).setUDimension(91).setUKnot(getNurbsPatchSurface_4_25_uKnot()).setUOrder(4).setVDimension(3).setVKnot(new double[] {0.0,0.0,0.0,1.0,1.0,1.0}).setWeight(getNurbsPatchSurface_4_25_weight())
        .setMetadata(new MetadataSet()
          .setMetadata(new MetadataString().setName("INSTANT_PLAYER_MODE").setValue(new String[] {"True"})))
        .setControlPoint(new Coordinate().setPoint(getCoordinate_5_27_point())))
	...
	// end of initialize() method
		...
		/** Large attribute array: Coordinate point field, scene-graph level=5, element #13, 819 total numbers made up of 273 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=5, element #20, 819 total numbers made up of 273 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=5, element #27, 819 total numbers made up of 273 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new mobiusCarlson().getX3dModel();
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.mobiusCarlson\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.mobiusCarlson self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./mobiusCarlson_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./mobiusCarlson_JavaExport.x3d"; 
                String filenameX3DV = "./mobiusCarlson_JavaExport.x3dv"; 
                String filenameJSON = "./mobiusCarlson_JavaExport.json";

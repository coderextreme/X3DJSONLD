...
public class HAnimSpecificationLOA3Invisible
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_MODIFIED   ).setContent("11 July 2020"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/HAnimSpecificationLOA3Invisible.x3d"))

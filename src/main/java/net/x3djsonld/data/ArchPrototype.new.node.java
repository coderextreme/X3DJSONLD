  ...
  .setScene(new Scene()
    .addChild(new ProtoDeclare("ArchPrototype").setName("ArchPrototype").setAppinfo("Create an arch. Can modify general parameters: clearSpanWidth, riseHeight, depth, topAbutmentHeight, pierWidth, pierHeight. - Possibility to create shapes related to an arch: ArchHalf; IntradosOnly; ArchFilled; ArchHalfFilled; Lintel. See the reference file ArchModelingDiagrams.pdf to find further information. See also ArchPrototypeScript_more_readable.js.js.")
      .setProtoInterface(new ProtoInterface()
        ...
        .addField(new field().setName("clearSpanWidth").setType(field.TYPE_SFFLOAT).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(4.0).setAppinfo("clearSpanWidth: clearSpanWidth must be double of riseHeight to obtain an half circumference"))
        .addField(new field().setName("riseHeight").setType(field.TYPE_SFFLOAT).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(2.0).setAppinfo("riseHeight: riseHeight must be half of clearSpanWidth to obtain an half circumference"))
        .addField(new field().setName("depth").setType(field.TYPE_SFFLOAT).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(3.0).setAppinfo("depth"))
        ...
        .addField(new field().setName("pierHeight").setType(field.TYPE_SFFLOAT).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(1.0).setAppinfo("pierHeight: pierHeight=0 means no pierHeight"))
        ...
        .addField(new field().setName("archHalfExtensionWidth").setType(field.TYPE_SFFLOAT).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(0.0).setAppinfo("archHalfExtensionWidth: measure in meters, use only if archHalf=true, it is the width of the etension of the abutment of the archHalf. See the reference file ArchModelingDiagrams.pdf to find further information."))
    ...
    .addChild(new ProtoInstance("ArchPrototype", "ArchInstance").setContainerField("children")
      ...
      .addFieldValue(new fieldValue().setName("clearSpanWidth").setValue(5.0))
      .addFieldValue(new fieldValue().setName("riseHeight").setValue(2.5))
      .addFieldValue(new fieldValue().setName("depth").setValue(2.0))
      .addFieldValue(new fieldValue().setName("topAbutmentHeight").setValue(0.6))
      .addFieldValue(new fieldValue().setName("pierWidth").setValue(1.0))
      .addFieldValue(new fieldValue().setName("pierHeight").setValue(2.0)))
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.ArchPrototype self-validation test results: ");

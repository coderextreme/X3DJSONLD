...
public class indexedfaceset_pixeltexture_entire
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_entire.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape()
      ...
      .setGeometry(new IndexedFaceSet().setCoordIndex(new int[] {0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1})
        .setCoord(new Coordinate().setPoint(new MFVec3f(new float[] {-2.0f,1.5f,1.0f,-2.0f,-1.5f,1.0f,2.0f,1.5f,1.0f,2.0f,-1.5f,1.0f,2.0f,1.5f,-1.0f,2.0f,-1.5f,-1.0f,-2.0f,1.5f,-1.0f,-2.0f,-1.5f,-1.0f}))))));
    }

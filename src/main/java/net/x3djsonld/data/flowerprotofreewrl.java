 ...
 * <p> A flower proto with configurable shaders. </p>
 <p> Related links:  source flowerprotofreewrl.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
        <caption>Scene Meta Information</caption>
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.flowerprotofreewrl&nbsp; Document Metadata </td>
		</tr>
...
public class flowerprotofreewrl
{
	/** Default constructor to create this object. */
	public flowerprotofreewrl ()
	{
	  initialize();
	}
  ...
  .setScene(new Scene()
    ...
    .addChild(new ProtoDeclare("FlowerProto").setName("FlowerProto")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setName("vertex").setType(field.TYPE_MFSTRING).setAccessType(field.ACCESSTYPE_INPUTONLY).setValue(new String[] {"../shaders/freewrl_flowers_chromatic.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs"}))
        .addField(new field().setName("fragment").setType(field.TYPE_MFSTRING).setAccessType(field.ACCESSTYPE_INPUTONLY).setValue(new String[] {"../shaders/freewrl.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"})))
...
""")
            ...
            .addField(new field().setName("set_fraction").setType(field.TYPE_SFFLOAT).setAccessType(field.ACCESSTYPE_INPUTOUTPUT))
    ...
    .addChild(new ProtoInstance("FlowerProto").setContainerField("children")
      .addFieldValue(new fieldValue().setName("vertex").setValue(new String[] {"../shaders/freewrl_flowers_chromatic.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs"}))
      .addFieldValue(new fieldValue().setName("fragment").setValue(new String[] {"../shaders/freewrl.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"}))));
            }
            catch (Exception ex)
            {       
	 ...
	 * @return flowerprotofreewrl model
	 */
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new flowerprotofreewrl().getX3dModel();
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.flowerprotofreewrl\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.flowerprotofreewrl self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./flowerprotofreewrl_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./flowerprotofreewrl_JavaExport.x3d"; 
                String filenameX3DV = "./flowerprotofreewrl_JavaExport.x3dv"; 
                String filenameJSON = "./flowerprotofreewrl_JavaExport.json";

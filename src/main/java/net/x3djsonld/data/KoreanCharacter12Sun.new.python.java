...
public class KoreanCharacter12Sun
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Sun").setName("Sun").setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addChild(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,29.86,-0.4567)
        ...
        .addChild(new HAnimJoint("hanim_l_hip").setName("l_hip").setCenter(2.955,28.94,-0.5218)
          ...
          .addChild(new HAnimJoint("hanim_l_knee").setName("l_knee").setCenter(2.948,16.46,-0.5275)
            ...
            .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocrural").setCenter(2.839,3.899,-0.4116)
              ...
              .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(2.839,3.312,1.078)
                  ...
                  .addChild(new Transform().setTranslation(2.839,3.312,1.078)
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_12_63_coordIndex()).setTexCoordIndex(getIndexedFaceSet_12_63_texCoordIndex())
                        ...
                        .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_13_64_point()))))))))))
        .addChild(new HAnimJoint("hanim_r_hip").setName("r_hip").setCenter(-2.955,28.94,-0.5218)
            ...
            .addChild(new Transform().setTranslation(-2.955,28.94,-0.5218)
              .addChild(new Shape()
                ...
                .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_9_76_coordIndex()).setTexCoordIndex(getIndexedFaceSet_9_76_texCoordIndex())
                  ...
                  .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.918,0.5995,0.9216,0.5192,0.9118,0.5261,0.9076,0.5995,0.9471,0.5995,0.9471,0.5153,0.9763,0.5995,0.9745,0.5192,0.9867,0.5995,0.9841,0.5261,0.9751,0.5995,0.9733,0.5337,0.9471,0.5369,0.9192,0.5995,0.9227,0.5337,0.9178,0.4416,0.9263,0.4416,0.9339,0.4268,0.9271,0.4268,0.9471,0.4416,0.9471,0.4268,0.9697,0.4416,0.9621,0.4268,0.9783,0.4416,0.9689,0.4268,0.9471,0.4144,0.9258,0.4603,0.9166,0.4603,0.9471,0.4603,0.9702,0.4603,0.9794,0.4603,0.9716,0.497,0.9471,0.4986,0.9244,0.497,0.9261,0.4603,0.9186,0.6114,0.9253,0.6114,0.9265,0.6114,0.9471,0.6114,0.9678,0.6114,0.9757,0.6114,0.969,0.6114,0.9471,0.6206,0.9699,0.4603})))))))
          .addChild(new HAnimJoint("hanim_r_knee").setName("r_knee").setCenter(-2.948,16.46,-0.5275)
              ...
              .addChild(new Transform().setTranslation(-2.948,16.46,-0.5275)
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_85_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_85_texCoordIndex())
                    ...
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.9287,0.342,0.9261,0.3817,0.9166,0.3743,0.9312,0.2839,0.9471,0.2839,0.9471,0.3395,0.9648,0.2839,0.9653,0.3367,0.9721,0.2839,0.9756,0.3608,0.9668,0.3526,0.9471,0.3496,0.9261,0.3638,0.9239,0.2839,0.9178,0.4416,0.9263,0.4416,0.9323,0.4565,0.9255,0.4565,0.9471,0.4416,0.9471,0.4565,0.9697,0.4416,0.9637,0.4565,0.9783,0.4416,0.9705,0.4565,0.9471,0.4689,0.932,0.2704,0.937,0.2704,0.9471,0.2704,0.959,0.2704,0.964,0.2704,0.9471,0.2608,0.9261,0.428,0.9162,0.4243,0.9474,0.428,0.9471,0.3767,0.9684,0.428,0.9669,0.3711,0.9771,0.4243,0.9678,0.4243,0.9471,0.4243,0.9259,0.4243,0.9467,0.3066,0.9291,0.3066,0.9659,0.3066,0.9763,0.3066,0.967,0.3066,0.9459,0.3066,0.9267,0.3066,0.9183,0.3066})))))))
            .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_talocrural").setCenter(-2.839,3.899,-0.4116)
              ...
              .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(-2.839,3.312,1.078)
                  ...
                  .addChild(new Transform().setTranslation(-2.839,3.312,1.078)
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_12_103_coordIndex()).setTexCoordIndex(getIndexedFaceSet_12_103_texCoordIndex())
                        ...
                        .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_13_104_point()))))))))))
        .addChild(new HAnimJoint("hanim_sacroiliac").setName("sacroiliac").setCenter(0.0,29.86,-0.4567)
          ...
          .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_shoulder").setCenter(6.077,45.88,-1.319)
            ...
            .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(7.076,38.53,-1.385)
                ...
                .addChild(new Transform().setTranslation(7.076,38.53,-1.385)
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_134_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_134_texCoordIndex())
                      ...
                      .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_12_135_point()))))))
              .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(6.946,30.89,-1.308)
          ...
          .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_shoulder").setCenter(-6.077,45.88,-1.319)
              ...
              .addChild(new Transform().setTranslation(-6.077,45.88,-1.319)
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_155_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_155_texCoordIndex())
                    ...
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.7373,1.904,0.7454,1.852,0.7783,1.858,0.7656,1.899,0.7152,1.848,0.71,1.901,0.6826,1.904,0.6851,1.846,0.7419,1.927,0.7284,1.918,0.6909,1.918,0.6244,1.905,0.619,1.855,0.6525,1.846,0.6537,1.912,0.5897,1.865,0.5966,1.902,0.5694,1.905,0.5607,1.866,0.543,1.916,0.5243,1.861,0.5792,1.919,0.6768,1.927,0.7098,1.915,0.7095,1.934,0.7427,1.793,0.5662,1.93,0.5976,1.916,0.6166,1.918,0.6311,1.928,0.5988,1.935,0.6179,1.786,0.652,1.784,0.5894,1.79,0.5606,1.794,0.5257,1.796,0.6213,1.732,0.7737,1.794,0.7122,1.789,0.6812,1.785,0.7323,1.729,0.73,1.719,0.747,1.712,0.7045,1.731,0.7048,1.724,0.6766,1.731,0.6789,1.722,0.6605,1.715,0.7027,1.7,0.6206,1.724,0.6424,1.717,0.594,1.731,0.5953,1.726,0.5704,1.723,0.5669,1.731,0.5513,1.711,0.5972,1.7,0.7577,1.727,0.5392,1.729,0.6505,1.731,0.6254,1.737,0.7371,1.733,0.7608,1.731,0.7076,1.737,0.6768,1.738,0.5953,1.74,0.5651,1.738,0.529,1.733,0.6481,1.738})))))))
            .addChild(new HAnimJoint("hanim_r_elbow").setName("r_elbow").setCenter(-7.076,38.53,-1.385)
                ...
                .addChild(new Transform().setTranslation(-7.076,38.53,-1.385)
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_164_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_164_texCoordIndex())
                      ...
                      .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_12_165_point()))))))
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(-6.946,30.89,-1.308)
                  ...
                  .addChild(new Transform().setTranslation(-6.946,30.89,-1.308)
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(new int[] {3,2,1,-1,1,0,3,-1,5,4,7,-1,7,6,5,-1,9,8,11,-1,11,10,9,-1,9,10,13,-1,13,12,9,-1,15,14,17,-1,17,16,15,-1,16,19,18,-1,18,15,16,-1,3,0,10,-1,10,11,3,-1,10,0,1,-1,1,13,10,-1,16,17,21,-1,21,20,16,-1,20,2,19,-1,19,16,20,-1,7,8,9,-1,9,6,7,-1,5,6,9,-1,9,12,5,-1,15,23,22,-1,22,14,15,-1,18,4,23,-1,23,15,18,-1,21,1,2,-1,2,20,21,-1,23,4,5,-1,5,22,23,-1,12,13,17,-1,17,14,12,-1,26,25,24,-1,24,27,26,-1,21,17,13,-1,13,1,21,-1,11,19,2,-1,2,3,11,-1,22,5,12,-1,12,14,22,-1,4,18,8,-1,8,7,4,-1,25,11,8,-1,8,24,25,-1,11,25,26,-1,26,19,11,-1,19,26,27,-1,27,18,19,-1,18,27,24,-1,24,8,18,-1}).setTexCoordIndex(new int[] {3,2,1,-1,1,0,3,-1,28,5,4,-1,4,29,28,-1,9,8,11,-1,11,10,9,-1,9,10,13,-1,13,12,9,-1,39,38,41,-1,41,40,39,-1,16,19,18,-1,18,15,16,-1,3,0,10,-1,10,11,3,-1,10,0,1,-1,1,13,10,-1,40,41,43,-1,43,42,40,-1,20,2,19,-1,19,16,20,-1,7,8,9,-1,9,6,7,-1,28,29,30,-1,30,31,28,-1,39,23,22,-1,22,38,39,-1,33,5,32,-1,32,34,33,-1,21,1,2,-1,2,20,21,-1,32,5,28,-1,28,35,32,-1,12,13,17,-1,17,14,12,-1,26,25,24,-1,24,27,26,-1,21,17,13,-1,13,1,21,-1,11,19,2,-1,2,3,11,-1,35,28,31,-1,31,36,35,-1,5,33,37,-1,37,4,5,-1,25,11,8,-1,8,24,25,-1,11,25,26,-1,26,19,11,-1,19,26,27,-1,27,18,19,-1,18,27,24,-1,24,8,18,-1})
                        ...
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.2291,0.4554,0.2379,0.4639,0.1638,0.4639,0.1669,0.4554,0.1055,0.4675,0.0703,0.4694,0.2333,0.3582,0.1628,0.3683,0.1487,0.3875,0.2473,0.3875,0.2473,0.435,0.1487,0.435,0.2598,0.383,0.2598,0.4396,0.2502,0.3875,0.1477,0.3875,0.1477,0.435,0.2502,0.435,0.1383,0.383,0.1383,0.4396,0.1698,0.4554,0.232,0.4554,0.2362,0.3582,0.1657,0.3683,0.1283,0.3928,0.1283,0.4296,0.1178,0.4333,0.1178,0.3894,0.0685,0.4095,0.1043,0.4119,0.1041,0.3824,0.0691,0.3798,0.0184,0.4681,0.0704,0.4904,0.0183,0.4889,0.0176,0.4121,0.018,0.3832,0.1056,0.489,0.2502,0.3875,0.1515,0.3875,0.1515,0.435,0.2502,0.435,0.1698,0.4554,0.232,0.4554}))))))))))
          .addChild(new HAnimJoint("hanim_vl5").setName("vl5").setCenter(0.05249,34.13,-0.468)
            ...
            .addChild(new HAnimJoint("hanim_skullbase").setName("skullbase").setCenter(0.0,51.25,-1.124)
	...
	// end of initialize() method
		...
		private double[] getTextureCoordinate_9_28_point_1()
		{
		...
		private double[] getTextureCoordinate_9_28_point_2()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_13_64_point_1()
		{
		...
		private double[] getTextureCoordinate_13_64_point_2()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_13_104_point_1()
		{
			double[] value = {0.1645,0.2682,0.119,0.2656,0.119,0.2333,0.1642,0.2355,0.1585,0.1986,0.119,0.1964,0.119,0.1664,0.1572,0.175,0.1786,0.2029,0.1893,0.2321,0.2954,0.0497,0.2633,0.0308,0.2607,0.0443,0.2924,0.0621,0.2275,0.0325,0.2299,0.0183,0.1375,0.0244,0.1392,0.0478,0.1726,0.0473,0.1726,0.0227,0.1726,0.0066,0.1366,0.0058,0.2807,0.084,0.2512,0.067,0.2227,0.0576,0.2601,0.0398,0.2197,0.2888,0.2029,0.2547,0.1996,0.0258,0.2,0.0107,0.1962,0.0514,0.0735,0.2682,0.0739,0.2355,0.0796,0.1986,0.0809,0.175,0.0352,0.2547,0.0488,0.232,0.2918,0.0575,0.2269,0.0279,0.0183,0.2887,0.0595,0.2029,0.9339,0.9522,0.9339,0.9254,0.9339,0.9014,0.9339,0.8697,0.9832,0.9254,0.9789,0.9522,0.9339,0.9904,0.9656,0.9806,0.9857,0.8697,0.9861,0.9014,0.8846,0.9254,0.8818,0.9014,0.9023,0.9806,0.889,0.9522,0.8822,0.8697,0.1368,0.0198,0.172,0.0181,0.1989,0.0212,0.1959,0.3397,0.233,0.3209,0.1086,0.051,0.1073,0.0299,0.1066,0.0253,0.1188,0.3009,0.1607,0.3056,0.042,0.3397,0.0049,0.3208,0.0774,0.3058,0.9339,0.8425,0.9842,0.8425,0.1053,0.0075,0.8836,0.8425,0.1925,0.3379,0.0929,0.0472,0.0926,0.0413,0.0916,0.0386,0.0732,0.0453,0.0548,0.052,0.0558,0.0548,0.0593,0.0595,0.0051,0.3217,0.0786,0.3181,0.1161,0.313,0.1637,0.3136,0.8849,0.8425,0.9342,0.8425,0.9342,0.8153,0.8926,0.8153,0.9835,0.8425,0.9758,0.8153,0.1064,0.0254,0.1052,0.0081,0.09,0.0108,0.0907,0.0265,0.1052,0.0081,0.1064,0.0254,0.0907,0.0265,0.09,0.0108,0.1068,0.0747};
			return value;
		}
		private double[] getTextureCoordinate_13_104_point_2()
		{
			double[] value = {0.1086,0.0517,0.0941,0.0542,0.0982,0.0753,0.1071,0.03,0.0934,0.041,0.1071,0.03,0.1086,0.0517,0.0941,0.0542,0.0934,0.041,0.1068,0.0747,0.0982,0.0754,0.0683,0.0723,0.0739,0.0833,0.0866,0.0821,0.097,0.0748,0.0943,0.0628};
			return value;
		}
		...
		private int[] getIndexedFaceSet_9_116_coordIndex_2()
		{
		...
		private int[] getIndexedFaceSet_9_116_texCoordIndex_2()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getCoordinate_10_116_point_1()
		{
		...
		private double[] getCoordinate_10_116_point_2()
		{
		...
		private double[] getTextureCoordinate_10_117_point_3()
		{
		...
		private int[] getIndexedFaceSet_11_194_coordIndex_4()
		{
		...
		private int[] getIndexedFaceSet_11_194_texCoordIndex_4()
		{
		...
		private double[] getCoordinate_12_194_point_4()
		{
		...
		private double[] getCoordinate_12_194_point_5()
		{
		...
		private double[] getTextureCoordinate_12_195_point_5()
		{
			double[] value = {0.3194,0.9376,0.3112,0.9359,0.3009,0.9445,0.3002,0.9515};
			return value;
		}

		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=8, element #27, 560 total numbers.
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=8, element #27, 560 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_9_28_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_9_28_point_1()))
				.append(new MFVec2f(getTextureCoordinate_9_28_point_2()));
			return TextureCoordinate_9_28_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #36, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #36, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #36, 159 total numbers made up of 53 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #45, 472 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #45, 183 total numbers made up of 61 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=12, element #63, 544 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #63, 544 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #63, 210 total numbers made up of 70 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_13_64_point()
		{
			MFVec2f TextureCoordinate_13_64_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_13_64_point_1()))
				.append(new MFVec2f(getTextureCoordinate_13_64_point_2()));
			return TextureCoordinate_13_64_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #76, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #76, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #76, 159 total numbers made up of 53 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #85, 472 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #85, 183 total numbers made up of 61 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_11_85_point = new MFVec3f(new double[] {-1.375,-5.834,-1.193,-1.477,-4.137,-1.195,-1.952,-4.672,0.1143,-0.6966,-12.16,-0.8887,0.0964,-12.16,-1.304,-0.0075,-6.489,-1.984,0.9748,-12.16,-0.8887,1.329,-6.244,-1.314,1.339,-12.16,0.1054,1.761,-6.229,0.1143,0.9748,-12.16,0.9689,1.217,-6.865,1.222,0.0964,-12.16,1.384,-0.0075,-7.096,1.879,-0.6966,-12.16,0.9689,-1.312,-6.004,1.225,-1.06,-12.16,0.1054,-1.831,0.0045,0.1143,-1.301,0.0045,-1.198,-0.9277,1.148,-0.902,-1.353,1.148,0.1143,-0.0071,0.0045,-1.771,-0.0071,1.148,-1.327,1.396,0.0045,-1.198,1.02,1.148,-0.902,1.885,0.0045,0.1143,1.445,1.148,0.1143,1.396,0.0045,1.551,1.02,1.148,1.396,-0.0071,0.0045,2.125,-0.0071,1.148,1.821,-1.301,0.0045,1.551,-0.9277,1.148,1.396,-0.0071,2.106,0.1143,-0.7952,-13.2,0.1143,-0.5053,-13.2,-0.6746,-0.5053,-13.2,0.749,0.0941,-13.2,1.08,0.7943,-13.2,0.749,1.084,-13.2,0.1143,0.7943,-13.2,-0.6746,0.0941,-13.2,-1.006,0.0941,-13.94,0.1143,-1.319,-1.205,-1.195,-1.928,-1.333,0.1143,0.0092,-1.051,-1.85,-0.0075,-3.792,-2.125,1.423,-1.205,-1.195,1.386,-4.758,-1.344,1.952,-1.333,0.1143,1.391,-1.333,1.308,-0.0071,-1.333,1.881,-1.326,-1.333,1.308,0.0957,-10.22,-1.525,-0.8601,-10.22,-0.9874,1.1,-10.22,-1.026,1.478,-10.22,0.1083,1.065,-10.22,1.051,0.0957,-10.22,1.545,-0.8407,-10.22,1.052,-1.283,-10.22,0.1083});
		...
		{
			MFVec2f TextureCoordinate_12_95_point = new MFVec2f(new double[] {0.1096,0.0871,0.1086,0.051,0.0724,0.0571,0.0703,0.093,0.0235,0.075,0.0389,0.1112,0.0537,0.0629,0.0688,0.0153,0.0719,0.0393,0.1073,0.0299,0.1053,0.0075,0.0438,0.0235,0.0507,0.0468,0.0827,0.1223,0.1079,0.1195,0.0638,0.1406,0.148,0.3335,0.1191,0.3241,0.1188,0.3009,0.1607,0.3056,0.0125,0.0361,0.0195,0.0586,0.1959,0.3397,0.1665,0.356,0.0896,0.3325,0.0774,0.3058,0.042,0.3397,0.9339,0.8099,0.9339,0.8425,0.9339,0.7851,0.9639,0.7918,0.9793,0.8097,0.9842,0.8425,0.8885,0.8098,0.9038,0.7913,0.8836,0.8425,0.0713,0.0347,0.1066,0.0253,0.05,0.0422,0.0189,0.054,0.142,0.3577,0.1187,0.3518,0.0703,0.3561,0.0946,0.3567,0.1006,0.1294,0.0944,0.1279,0.1006,0.121,0.0918,0.1217,0.0937,0.1145,0.0996,0.1127,0.1056,0.1147,0.1091,0.1206,0.1065,0.1264,0.1086,0.051,0.1096,0.0871,0.1607,0.3056,0.1188,0.3009,0.0774,0.3058,0.042,0.3397,0.1073,0.0299,0.8837,0.8428,0.9341,0.8428,0.9341,0.8649,0.1066,0.0253,0.1067,0.025,0.1052,0.0076,0.1262,0.0158,0.122,0.0264,0.1052,0.0076,0.1067,0.025,0.122,0.0264,0.1262,0.0158,0.1262,0.0158,0.9001,0.8648,0.9844,0.8428,0.968,0.8649});
			return TextureCoordinate_12_95_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=12, element #103, 544 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #103, 544 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #103, 210 total numbers made up of 70 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_13_103_point = new MFVec3f(new double[] {-1.388,-0.7441,0.9353,0,-0.5418,1.142,0,-1.042,2.002,-1.356,-1.234,1.823,-1.286,-1.394,3.004,0,-1.212,3.154,0,-1.708,3.962,-1.162,-1.8,3.64,-1.65,-1.868,2.671,-1.806,-1.859,1.688,-1.217,-2.657,3.79,0,-2.605,4.159,-1.729,-2.767,2.676,-1.984,-2.747,-0.4534,-1.847,-1.879,-0.4111,-1.91,-1.914,0.8074,-2.006,-2.83,0.7644,-1.895,-2.791,1.697,1.388,-0.7441,0.9353,1.356,-1.234,1.823,1.286,-1.394,3.004,1.162,-1.8,3.64,1.91,-1.914,0.8074,1.806,-1.859,1.688,1.217,-2.657,3.79,1.729,-2.767,2.676,2.006,-2.83,0.7644,1.847,-1.879,-0.4111,1.984,-2.747,-0.4534,1.65,-1.868,2.671,1.895,-2.791,1.697,0,-3.18,0.7644,-2.006,-3.18,0.7644,-1.729,-3.137,2.71,-1.217,-3.069,3.793,0,-2.997,4.162,0,-3.18,-0.4554,-1.99,-3.18,-0.4554,1.729,-3.137,2.71,2.006,-3.18,0.7644,1.217,-3.069,3.793,1.99,-3.18,-0.4554,0,-3.141,2.71,-1.895,-3.164,1.686,1.895,-3.164,1.686,0,-3.164,1.686,-1.486,-0.5175,-1.502,-1.788,-1.797,-1.502,-1.928,-2.585,-1.502,9.0E-4,0.1637,0.361,-1.326,-0.0186,0.0033,1.486,-0.5175,-1.502,1.788,-1.797,-1.502,1.928,-2.585,-1.502,1.331,-0.0112,0.0089,0,-3.164,-1.502,-1.935,-3.164,-1.502,1.934,-3.164,-1.502,-1.153,-0.3082,-2.015,-1.192,-1.388,-2.379,-1.307,-1.876,-2.363,-1.307,-2.129,-2.356,-4.0E-4,-2.129,-2.356,1.306,-2.129,-2.356,1.306,-1.876,-2.362,1.191,-1.388,-2.378,1.152,-0.3071,-2.014,1.027,0.2573,-1.173,0.0025,0.3479,-0.8576,-1.023,0.2519,-1.179});
			return Coordinate_13_103_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=13, element #104, 232 total numbers made up of 116 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_13_104_point()
		{
			MFVec2f TextureCoordinate_13_104_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_13_104_point_1()))
				.append(new MFVec2f(getTextureCoordinate_13_104_point_2()));
			return TextureCoordinate_13_104_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #116, 1064 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_9_116_coordIndex()
		{
			MFInt32 IndexedFaceSet_9_116_coordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_9_116_coordIndex_2()));
			return IndexedFaceSet_9_116_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #116, 1064 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_9_116_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_9_116_texCoordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_9_116_texCoordIndex_2()));
			return IndexedFaceSet_9_116_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #116, 588 total numbers made up of 196 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_116_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_116_point_1()))
				.append(new MFVec3f(getCoordinate_10_116_point_2()));
			return Coordinate_10_116_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #117, 448 total numbers made up of 224 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_10_117_point()
		{
			MFVec2f TextureCoordinate_10_117_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_10_117_point_3()));
			return TextureCoordinate_10_117_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #125, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #125, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #125, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #134, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #134, 198 total numbers made up of 66 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #155, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #155, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #164, 512 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #164, 198 total numbers made up of 66 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_12_164_point = new MFVec3f(new double[] {-0.896,-3.458,-0.7733,-1.43,-3.283,0.0723,-1.163,-7.27,0.0721,-0.7935,-7.267,-0.5416,0.0234,-3.843,-1.144,0.0262,-7.3,-0.8983,0.6588,-7.609,-0.4491,0.7822,-7.049,-0.481,0.025,-7.07,-0.8149,0.0233,-7.631,-0.7795,0.922,-7.614,0.0729,1.098,-7.053,0.0729,0.6588,-7.612,0.6263,0.7823,-7.05,0.6527,0.9427,-4.174,0.8667,0.8457,-7.28,0.7082,0.0234,-7.282,1.066,0.0234,-3.825,1.273,0.0233,-7.623,0.9572,-0.6122,-7.612,0.6263,-0.7325,-7.043,0.6513,0.0233,-7.057,0.9867,-0.896,-3.452,0.8897,-0.7936,-7.266,0.7058,-0.896,-0.0257,-0.9221,-0.7144,0.4948,-0.6658,-1.02,0.4948,0.0721,-1.277,-0.0257,0.0721,0.0236,-0.0257,-1.334,0.0236,0.4948,-0.9714,0.9432,-0.0257,-0.9221,0.7615,0.4948,-0.6658,1.324,-0.0257,0.0721,1.067,0.4948,0.0721,0.9432,-0.0257,0.9219,0.7615,0.4948,0.8099,0.0236,-0.0257,1.334,0.0236,0.4948,1.116,-0.896,-0.0257,0.9219,-0.7144,0.4948,0.8099,0.0236,0.931,0.0721,-0.6122,-7.609,-0.4491,-0.8754,-7.614,0.0729,-0.583,-8.086,0.0729,-0.4054,-8.063,-0.1612,-0.4054,-8.076,0.3527,0.0233,-8.083,0.5759,0.452,-8.076,0.3527,0.6297,-8.086,0.0729,0.452,-8.063,-0.1612,0.0233,-8.078,-0.3841,0.0233,-8.424,0.0729,-1.403,-0.6344,0.0721,-0.9954,-0.506,-0.8653,0.02,-0.506,-1.277,0.9426,-4.179,-0.7253,1.041,-0.506,-0.8653,1.43,-0.6344,0.0721,1.323,-4.321,0.0723,1.018,-0.6344,0.9221,0.0236,-0.6344,1.334,-0.9707,-0.6344,0.9221,-1.063,-7.046,0.0729,-0.7325,-7.042,-0.4818,0.8456,-7.281,-0.5402,1.188,-7.284,0.0721});
			return Coordinate_12_164_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #165, 176 total numbers made up of 88 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_12_165_point()
		{
			MFVec2f TextureCoordinate_12_165_point = new MFVec2f(new double[] {0.6214,1.732,0.7319,1.729,0.7045,1.73,0.6763,1.731,0.6737,1.57,0.6695,1.581,0.6525,1.578,0.6596,1.565,0.672,1.648,0.5944,1.731,0.669,1.585,0.692,1.585,0.6985,1.654,0.6909,1.571,0.7076,1.568,0.7136,1.579,0.6917,1.581,0.7251,1.66,0.7149,1.583,0.7334,1.58,0.5663,1.733,0.5738,1.66,0.5479,1.661,0.7502,1.661,0.5667,1.581,0.5849,1.584,0.6006,1.655,0.6078,1.585,0.6259,1.57,0.6303,1.581,0.6081,1.582,0.6088,1.572,0.6784,1.72,0.6987,1.718,0.715,1.723,0.7248,1.738,0.7566,1.727,0.6922,1.739,0.7083,1.553,0.7208,1.562,0.7017,1.557,0.69,1.561,0.6778,1.559,0.6394,1.565,0.6467,1.578,0.6707,1.555,0.6891,1.549,0.5851,1.722,0.5744,1.738,0.5383,1.729,0.6749,1.719,0.7035,1.718,0.732,1.717,0.7566,1.715,0.6497,1.584,0.73,1.574,0.6021,1.717,0.6226,1.719,0.6477,1.727,0.6092,1.739,0.5919,1.569,0.5792,1.563,0.5915,1.554,0.5975,1.558,0.6219,1.559,0.6284,1.556,0.6095,1.561,0.6103,1.55,0.5395,1.716,0.5658,1.721,0.5946,1.722,0.6275,1.648,0.6242,1.723,0.6504,1.719,0.6499,1.645,0.5702,1.575,0.5861,1.579,0.6308,1.586,0.6503,1.731,0.6767,1.711,0.7018,1.71,0.7234,1.719,0.7395,1.728,0.577,1.712,0.5523,1.731,0.5995,1.706,0.6239,1.709,0.6527,1.716});
			return TextureCoordinate_12_165_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #185, 1048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #185, 1048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #185, 423 total numbers made up of 141 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=11, element #186, 274 total numbers made up of 137 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=11, element #194, 3104 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_11_194_coordIndex()
		{
			MFInt32 IndexedFaceSet_11_194_coordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_11_194_coordIndex_4()));
			return IndexedFaceSet_11_194_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #194, 3104 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_11_194_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_11_194_texCoordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_11_194_texCoordIndex_4()));
			return IndexedFaceSet_11_194_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #194, 1272 total numbers made up of 424 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec3f getCoordinate_12_194_point()
		{
			MFVec3f Coordinate_12_194_point = new MFVec3f()/*2.finalize*/
				...
				.append(new MFVec3f(getCoordinate_12_194_point_4()))
				.append(new MFVec3f(getCoordinate_12_194_point_5()));
			return Coordinate_12_194_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #195, 808 total numbers made up of 404 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec2f getTextureCoordinate_12_195_point()
		{
			MFVec2f TextureCoordinate_12_195_point = new MFVec2f()/*2.finalize*/
				...
				.append(new MFVec2f(getTextureCoordinate_12_195_point_5()));

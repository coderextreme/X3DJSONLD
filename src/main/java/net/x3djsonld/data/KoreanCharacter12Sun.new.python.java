...
public class KoreanCharacter12Sun
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Sun").setName("Sun").setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addChild(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,29.86,-0.4567).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})

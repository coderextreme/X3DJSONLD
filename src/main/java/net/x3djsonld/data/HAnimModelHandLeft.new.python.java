...
public class HAnimModelHandLeft
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Hand_Left").setName("Hand_Left").setLoa(4).setVersion("2.0")
      ...
      .addChild(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
      ...
      .addChild(new HAnimSegment().setUSE("hanim_l_trapezoid"))));
            }
            catch (Exception ex)
            {       

      ...
      .addChild(new Transform()
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material("tank").setAmbientIntensity(0.3).setDiffuseColor(0.3,0.3,0.5).setShininess(0.1).setSpecularColor(0.7,0.7,0.8)))
        ...
        .addChild(new Transform()
          .addChild(new Transform().setTranslation(0.0,0.45,0.0)
            .addChild(new Shape("pressure")
              .setAppearance(new Appearance()
                .setMaterial(new Material("pressureColor").setAmbientIntensity(0.4).setDiffuseColor(0.91,0.91,0.91).setShininess(0.16).setSpecularColor(0.91,0.9,0.91)))
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.ScubaTank self-validation test results: ");

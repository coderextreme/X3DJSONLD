 ...
 <p> Related links:  source KoreanCharacter02Chul.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr>
			...
			<td> <a href="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/../Poses/images/HAnimPoseExampleKoreanCharacter02Chul.png">../Poses/images/HAnimPoseExampleKoreanCharacter02Chul.png</a> </td>
		</tr>
		<tr>
...
public class KoreanCharacter02Chul
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("../Poses/images/HAnimPoseExampleKoreanCharacter02Chul.png"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new EXPORT().setLocalDEF("hanim_Chul").setAS("KoreanCharacter02Chul")));
            }
            catch (Exception ex)
            {       
	...
	// end of initialize() method
		...
		private double[] getCoordinate_10_42_point_1()
		{
		...
		private double[] getCoordinate_10_42_point_2()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=3 and $tupleSplitSize=100 for subarray position()=1 */
		private double[] getCoordinate_10_82_point_1()
		{
		...
		/** Define subarray values using type double[] with $tupleSize=3 and $tupleSplitSize=100 for subarray position()=2 */
		private double[] getCoordinate_10_82_point_2()
		{
		...
		{
			MFVec3f Coordinate_9_33_point = new MFVec3f(new double[] {0.0000,0.8700,0.0225,0.0000,0.7535,-0.4472,-0.3613,0.7535,-0.3842,-0.6259,0.7535,-0.3083,-0.7227,0.7535,0.0225,-0.6259,0.7535,0.3534,-0.3613,0.7535,0.4293,0.0000,0.7535,0.4922,0.3613,0.7535,0.4293,0.6259,0.7535,0.3534,0.7227,0.7535,0.0225,0.6259,0.7535,-0.3083,0.3613,0.7535,-0.3842,0.0000,0.4350,-0.7303,-0.4673,0.4350,-0.6294,-0.8094,0.4350,-0.3539,-0.9347,0.4350,0.0225,-0.8094,0.4350,0.3990,-0.4673,0.4350,0.5769,0.0000,0.4350,0.6777,0.4673,0.4350,0.5769,0.8094,0.4350,0.3990,0.9347,0.4350,0.0225,0.8094,0.4350,-0.3539,0.4673,0.4350,-0.6294,0.0000,0.0000,-0.7942,-0.5396,0.0000,-0.6777,-0.9347,0.0000,-0.3596,-1.0790,0.0000,0.0225,-0.9347,0.0000,0.4572,-0.5396,0.0000,0.6777,0.0000,0.0000,0.7942,0.5396,0.0000,0.6777,0.9347,0.0000,0.4572,1.0790,0.0000,0.0225,0.9347,0.0000,-0.3596,0.5396,0.0000,-0.6777,0.0000,-0.4350,-0.6777,-0.4673,-0.4350,-0.5769,-0.8094,-0.4350,-0.3013,-0.9347,-0.4350,0.0225,-0.8094,-0.4350,0.3990,-0.4673,-0.4350,0.5769,0.0000,-0.4350,0.6777,0.4673,-0.4350,0.5769,0.8094,-0.4350,0.3990,0.9347,-0.4350,0.0225,0.8094,-0.4350,-0.3013,0.4673,-0.4350,-0.5769,0.0000,-0.7535,-0.3596,-0.2698,-0.7535,-0.3013,-0.4673,-0.7535,-0.1948,-0.5396,-0.7535,0.0225,-0.4673,-0.7535,0.2399,-0.2698,-0.7535,0.3990,0.0000,-0.7535,0.4572,0.2698,-0.7535,0.3990,0.4673,-0.7535,0.2399,0.5396,-0.7535,0.0225,0.4673,-0.7535,-0.1948,0.2698,-0.7535,-0.3013,0.0000,-0.8700,0.0225});
			return Coordinate_9_33_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #42, 468 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #42, 468 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #42, 423 total numbers made up of 141 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_42_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_42_point_1()))
				.append(new MFVec3f(getCoordinate_10_42_point_2()));
			return Coordinate_10_42_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #82, 468 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #82, 468 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #82, 423 total numbers made up of 141 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_82_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_82_point_1()))
				.append(new MFVec3f(getCoordinate_10_82_point_2()));
		...
		{
			MFVec3f Coordinate_10_122_point = new MFVec3f(new double[] {0.0000,9.7700,0.1270,0.0000,9.1130,-2.5190,-2.0360,9.1130,-2.1650,-3.5260,9.1130,-1.7370,-4.0720,9.1130,0.1270,-3.5260,9.1130,1.9910,-2.0360,9.1130,2.4190,0.0000,9.1130,2.7730,2.0360,9.1130,2.4190,3.5260,9.1130,1.9910,4.0720,9.1130,0.1270,3.5260,9.1130,-1.7370,2.0360,9.1130,-2.1650,0.0000,7.3180,-4.1150,-2.6330,7.3180,-3.5460,-4.5610,7.3180,-1.9940,-5.2660,7.3180,0.1270,-4.5610,7.3180,2.2480,-2.6330,7.3180,3.2500,0.0000,7.3180,3.8190,2.6330,7.3180,3.2500,4.5610,7.3180,2.2480,5.2660,7.3180,0.1270,4.5610,7.3180,-1.9940,2.6330,7.3180,-3.5460,0.0000,4.8670,-4.4750,-3.0400,4.8670,-3.8190,-5.2660,4.8670,-2.0260,-6.0810,4.8670,0.1270,-5.2660,4.8670,2.5760,-3.0400,4.8670,3.8190,0.0000,4.8670,4.4750,3.0400,4.8670,3.8190,5.2660,4.8670,2.5760,6.0810,4.8670,0.1270,5.2660,4.8670,-2.0260,3.0400,4.8670,-3.8190,0.0000,2.4160,-3.8190,-2.6330,2.4160,-3.2500,-4.5610,2.4160,-1.6980,-5.2660,2.4160,0.1270,-4.5610,2.4160,2.2480,-2.6330,2.4160,3.2500,0.0000,2.4160,3.8190,2.6330,2.4160,3.2500,4.5610,2.4160,2.2480,5.2660,2.4160,0.1270,4.5610,2.4160,-1.6980,2.6330,2.4160,-3.2500,0.0000,0.6221,-2.0260,-1.5200,0.6221,-1.6980,-2.6330,0.6221,-1.0970,-3.0400,0.6221,0.1270,-2.6330,0.6221,1.3510,-1.5200,0.6221,2.2480,0.0000,0.6221,2.5760,1.5200,0.6221,2.2480,2.6330,0.6221,1.3510,3.0400,0.6221,0.1270,2.6330,0.6221,-1.0970,1.5200,0.6221,-1.6980,0.0000,-0.0347,0.1270});
			return Coordinate_10_122_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #131, 372 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #131, 372 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #131, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #149, 376 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #149, 147 total numbers made up of 49 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #161, 372 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #161, 372 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #161, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #179, 376 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #179, 147 total numbers made up of 49 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_13_179_point = new MFVec3f(new double[] {-0.4280,-4.0430,1.0350,0.0620,-2.7600,-0.7256,-0.4283,-4.0430,-1.3250,0.0621,-2.7590,0.4786,-0.5207,-5.8080,0.5759,0.0026,-5.6700,-1.3250,-0.5208,-5.8080,-0.9061,0.0026,-5.6700,1.0350,0.3110,0.5832,-0.6014,-0.4947,0.3747,-1.0800,-0.3587,-0.8063,-1.0770,0.3511,-0.5647,-0.6024,-0.5020,0.3752,0.7923,0.3112,0.5961,0.3561,0.3512,-0.5647,0.3515,-0.5145,-0.7545,0.7924,-1.0300,0.5998,-0.7556,-1.0300,-0.5583,-0.7457,-1.0370,0.5778,0.4281,-1.0310,-0.5582,0.4287,-0.3854,-2.3210,-1.5870,0.3249,-2.0790,-0.8558,-0.2488,-1.4940,1.3320,0.4651,-1.2380,0.8921,0.7055,-1.9500,1.1530,0.2884,-2.2900,1.5870,0.3240,-2.0790,0.6132,-1.0570,-2.0730,-1.0770,-1.0490,-2.0910,0.6923,-0.3858,-2.3210,1.2920,-0.9501,-4.1810,-0.9063,-0.9499,-4.1810,0.5762,-0.2552,-4.6940,-1.3250,-0.2552,-4.6940,1.0350,-0.7786,-4.8320,-0.9061,-0.7786,-4.8320,0.5759,-0.6497,-5.3200,-0.9061,-0.1263,-5.1820,-1.3250,-0.6497,-5.3200,0.5759,-0.1263,-5.1820,1.0350,0.6755,-3.1150,0.6119,0.2140,-3.4400,1.0810,0.6399,-3.3260,1.5860,1.0570,-2.9870,1.1510,0.8814,-2.4690,1.1500,0.4641,-2.8080,1.5870,0.0383,-2.9220,1.0820,0.4998,-2.5970,0.6126,-0.4437,0.8321,-0.1433});
			return Coordinate_13_179_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=13, element #180, 158 total numbers made up of 79 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_13_180_point = new MFVec2f(new double[] {0.1427,0.2125,0.1222,0.2114,0.0720,0.2114,0.0487,0.2146,0.1648,0.2146,0.1427,0.2125,0.0720,0.2114,0.1648,0.2146,0.1856,0.1891,0.2639,0.1883,0.2484,0.1880,0.1701,0.1891,0.2529,0.0205,0.2367,0.0146,0.2411,0.0322,0.2577,0.0389,0.1901,0.0132,0.1856,0.0283,0.1719,0.0186,0.1675,0.0336,0.2484,0.0869,0.2649,0.0843,0.1864,0.0924,0.1708,0.0905,0.2488,0.1471,0.2643,0.1474,0.1860,0.1482,0.1705,0.1482,0.2484,0.1644,0.2639,0.1647,0.1856,0.1655,0.1701,0.1655,0.2484,0.1762,0.2639,0.1765,0.1856,0.1773,0.1701,0.1773,0.1633,0.1308,0.1534,0.1396,0.1426,0.1381,0.1476,0.1297,0.1475,0.0465,0.1445,0.0998,0.1671,0.1111,0.1534,0.1270,0.1633,0.1182,0.1426,0.1255,0.2062,0.0097,0.1009,0.1405,0.0196,0.0979,0.0057,0.1410,0.0959,0.0953,0.0453,0.0029,0.0235,0.0102,0.0236,0.0455,0.0452,0.0373,0.1089,0.0102,0.0890,0.0039,0.0888,0.0373,0.1089,0.0441,0.0050,0.0810,0.0337,0.0828,0.1222,0.0690,0.1135,0.0574,0.1162,0.0936,0.1239,0.0947,0.1020,0.0746,0.1039,0.0949,0.0057,0.1603,0.1009,0.1598,0.0057,0.1748,0.1009,0.1743,0.0057,0.1892,0.1009,0.1888,0.1179,0.1190,0.1252,0.1262,0.1098,0.1164,0.1179,0.1343,0.1252,0.1415,0.1098,0.1317});
			return TextureCoordinate_13_180_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #191, 968 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #191, 968 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #191, 624 total numbers made up of 208 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=11, element #192, 310 total numbers made up of 155 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.KoreanCharacter02Chul self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./KoreanCharacter02Chul_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./KoreanCharacter02Chul_JavaExport.x3d"; 
                String filenameX3DV = "./KoreanCharacter02Chul_JavaExport.x3dv"; 
                String filenameJSON = "./KoreanCharacter02Chul_JavaExport.json";

 ...
 * <p> A flower proto with configurable shaders. </p>
 <p> Related links:  source fwparticleflowersTidy.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
        <caption>Scene Meta Information</caption>
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.fwparticleflowersTidy&nbsp; Document Metadata </td>
		</tr>
...
public class fwparticleflowersTidy
{
	/** Default constructor to create this object. */
	public fwparticleflowersTidy ()
	{
	  initialize();
	}
...
""")
	 ...
	 * @return fwparticleflowersTidy model
	 */
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new fwparticleflowersTidy().getX3dModel();
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.fwparticleflowersTidy\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.fwparticleflowersTidy self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./fwparticleflowersTidy_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./fwparticleflowersTidy_JavaExport.x3d"; 
                String filenameX3DV = "./fwparticleflowersTidy_JavaExport.x3dv"; 
                String filenameJSON = "./fwparticleflowersTidy_JavaExport.json";

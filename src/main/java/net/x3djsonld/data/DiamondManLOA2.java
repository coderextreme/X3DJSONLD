...
public class DiamondManLOA2
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("DiamondManLOA2.x3d"))
    .addMeta(new meta().setName(meta.NAME_DESCRIPTION).setContent("hanim skeletal structure at level of articulation two, one diamond at the base node for the structure"))
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("DiamondManLOA2.png"))
    ...
    .addMeta(new meta().setName(meta.NAME_REFERENCE  ).setContent("The joint centers of this figure are based on the work of Norman Badler, director of the Center for Human Modeling and Simulation at the University of Pennsylvania. The original document which these joint centers are based on can be found at: http://www.cis.upenn.edu/~badler/anthro/89-71.ps"))
    .addMeta(new meta().setName(meta.NAME_SUBJECT    ).setContent("human animation, x3d, vrml, animation"))
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA2.x3d"))
    .addMeta(new meta().setName(meta.NAME_GENERATOR  ).setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
    .addMeta(new meta().setName(meta.NAME_LICENSE    ).setContent("../license.html")))
  .setScene(new Scene()
    .addChild(new WorldInfo().setInfo(new String[] {"HAnim 2.0 Default Joint Centers, Level Of Articulation (LOA) 2 -------------------------------------------------------- HANIM 1.1 (VRML 2.0) Author name: eMpTy (a.k.a. Matthew T. Beitler) HANIM 1.1 (VRML 2.0) Author email: beitler@graphics.cis.upenn.edu or beitler@acm.org HANIM 1.1 (VRML 2.0) Author homepage: http://www.cis.upenn.edu/~beitler HANIM 1.1 (VRML 2.0) Compliance Date: May 12, 1999 HANIM 1.1 Compliance Information: http://ece.uwaterloo.ca/~HAnim/ Construction Info (joint centers): The joint centers of this figure are based on the work of Norman Badler, director of the Center for Human Modeling and Simulation at the University of Pennsylvania. The original document which these joint centers are based on can be found at: http://www.cis.upenn.edu/~badler/anthro/89-71.ps, .pdf"}).setTitle("HANIM 1.1 Default Joint Centers, LOA1"))
    .addChild(new NavigationInfo().setSpeed(1.5))
    .addChild(new Viewpoint().setDescription("Diamond Man, LOA 2").setCenterOfRotation(0.0,1.0,0.0).setPosition(0.0,1.0,3.0))
    .addChild(new Transform().setTranslation(1.0,1.5,0.0)
      .addChild(new Billboard()
        .addChild(new Shape()
          .setGeometry(new Text().setString(new String[] {"Diamond Man Key"})
            .setFontStyle(new FontStyle().setFamily(new String[] {"SANS"}).setSize(0.1)))
          .setAppearance(new Appearance()
            .setMaterial(new Material("TextMaterial").setDiffuseColor(0.9,0.9,0.9))))
        .addChild(new Transform().setTranslation(0.0,-0.3,0.0)
          .addChild(new Shape()
            .setGeometry(new Sphere().setRadius(0.08))
            .setAppearance(new Appearance()
              .setMaterial(new Material("MIN_COLOR").setDiffuseColor(1.0,0.0,0.0))))
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new String[] {"Minimal Humanoid Joints"})
                .setFontStyle(new FontStyle().setFamily(new String[] {"SANS"}).setSize(0.1)))
              .setAppearance(new Appearance()
        ...
        .addChild(new Transform().setTranslation(0.0,-0.5,0.0)
          .addChild(new Shape()
            .setGeometry(new Sphere().setRadius(0.08))
            .setAppearance(new Appearance()
              .setMaterial(new Material("JOINT_COLOR").setDiffuseColor(1.0,1.0,0.0))))
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new String[] {"Humanoid Joints"})
                .setFontStyle(new FontStyle().setFamily(new String[] {"SANS"}).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))
        .addChild(new Transform().setTranslation(0.0,-0.7,0.0)
          .addChild(new Shape()
            .setGeometry(new Sphere().setRadius(0.08))
            .setAppearance(new Appearance()
              .setMaterial(new Material("REC_SPINAL_COLOR").setDiffuseColor(1.0,0.0,1.0))))
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new String[] {"Recommended Spinal Joints"})
                .setFontStyle(new FontStyle().setFamily(new String[] {"SANS"}).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))
        .addChild(new Transform().setTranslation(0.0,-0.9,0.0)
          .addChild(new Shape()
            .setGeometry(new Sphere().setRadius(0.08))
            .setAppearance(new Appearance()
              .setMaterial(new Material("SPINAL_COLOR").setDiffuseColor(0.0,1.0,0.0))))
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new String[] {"Spinal Joints"})
                .setFontStyle(new FontStyle().setFamily(new String[] {"SANS"}).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))
        .addChild(new Transform().setTranslation(0.0,-1.3,0.0)
          .addChild(new Shape()
            .setGeometry(new Sphere().setRadius(0.08))
            .setAppearance(new Appearance()
              .setMaterial(new Material("SITE_COLOR").setDiffuseColor(0.0,0.0,1.0))))
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new String[] {"Humanoid Sites"})
                .setFontStyle(new FontStyle().setFamily(new String[] {"SANS"}).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))
        .addChild(new Transform().setTranslation(0.0,-1.1,0.0)
          .addChild(new Shape()
            .setGeometry(new Sphere().setRadius(0.08))
            .setAppearance(new Appearance()
              .setMaterial(new Material("HAND_FEET_COLOR").setDiffuseColor(0.0,1.0,1.0))))
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new String[] {"Hand & Feet Joints"})
                .setFontStyle(new FontStyle().setFamily(new String[] {"SANS"}).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))))
    .addChild(new HAnimHumanoid("hanim_humanoid").setName("humanoid").setLoa(2).setVersion("2.0")
      ...
      .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
        .setMetadata(new MetadataString().setName("humanoidVersion").setValue(new String[] {"Nancy V1.2b"}))
        .setMetadata(new MetadataString().setName("authorEmail").setValue(new String[] {"cindy@ballreich.net"}))
        .setMetadata(new MetadataString().setName("authorName").setValue(new String[] {"Cindy Ballreich"}))
        .setMetadata(new MetadataString().setName("copyright").setValue(new String[] {"1997 3Name3D / Yglesias Wallock Divekar Inc. all rights reserved."}))
        .setMetadata(new MetadataString().setName("creationDate").setValue(new String[] {"Tue Dec 30 08:30:08 PST 1997"}))
        .setMetadata(new MetadataString().setName("usageRestrictions").setValue(new String[] {"Noncommercial usage is ok if 3Name3D name and logo <www.ballreich.net/vrml/HAnim/small_logo.gif> is present and proper credit is given."})))
      .addSkeleton(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,0.8240,0.0277).setStiffness(new double[] {0.0,0.0,0.0})
        .addChild(new HAnimSegment("hanim_sacrum").setName("sacrum")
          .addChild(new Transform().setTranslation(0.0,0.8240,0.0277)
            .addChild(new Shape("DiamondShape")
              ...
              .setAppearance(new Appearance()
                .setMaterial(new Material("ROOT_COLOR").setDiffuseColor(1.0,1.0,1.0))))
        ...
        .addChild(new HAnimJoint("hanim_sacroiliac").setName("sacroiliac").setCenter(0.0,0.9149,0.0016).setStiffness(new double[] {0.0,0.0,0.0})
          .addChild(new HAnimSegment("hanim_pelvis").setName("pelvis")
            .addChild(new Transform("sacroiliacPos").setTranslation(0.0,0.9149,0.0016)
              .addChild(new Shape()
                .setGeometry(new IndexedFaceSet().setCreaseAngle(0.5).setCoordIndex(new int[] {0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,1,-1,5,2,1,-1,5,3,2,-1,5,4,3,-1,5,1,4,-1})
              ...
              .addChild(new HAnimSegment("hanim_r_calf").setName("r_calf")
                .addChild(new Transform().setTranslation(-0.0867,0.4913,0.0318)
                  .addChild(new Shape()
                    ...
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setUSE("SITE_COLOR"))))))
              .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_talocrural").setCenter(-0.0801,0.0712,-0.0766).setStiffness(new double[] {0.0,0.0,0.0})
                .addChild(new HAnimSegment("hanim_r_talus").setName("r_talus")
                  ...
                  .addChild(new HAnimSite("hanim_r_calcaneus_posterior_pt").setName("r_calcaneus_posterior_pt").setTranslation(-0.0692,0.0297,-0.1221)
                    .addChild(new Shape()
                      ...
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setUSE("HAND_FEET_COLOR"))))))
                .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(-0.0801,0.0,0.0368).setStiffness(new double[] {0.0,0.0,0.0})
              ...
              .addChild(new HAnimSegment("hanim_l3").setName("l3")
                .addChild(new Transform().setTranslation(0.0041,1.1276,-0.0796)
                  .addChild(new Shape()
                    ...
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setUSE("REC_SPINAL_COLOR"))))))
              .addChild(new HAnimJoint("hanim_vl2").setName("vl2").setCenter(0.0045,1.1546,-0.0800).setStiffness(new double[] {0.0,0.0,0.0})
                    ...
                    .addChild(new HAnimSegment("hanim_t12").setName("t12")
                      .addChild(new Transform().setTranslation(0.0051,1.2278,-0.0808)
                        .addChild(new Shape()
                          ...
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setUSE("SPINAL_COLOR"))))))
                    .addChild(new HAnimJoint("hanim_vt11").setName("vt11").setCenter(0.0053,1.2679,-0.0810).setStiffness(new double[] {0.0,0.0,0.0})
                              ...
                              .addChild(new HAnimSegment("hanim_t7").setName("t7")
                                .addChild(new Transform().setTranslation(0.0058,1.3625,-0.0833)
                                  .addChild(new Shape()
                                    ...
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setUSE("SPINAL_COLOR"))))))
                              .addChild(new HAnimJoint("hanim_vt6").setName("vt6").setCenter(0.0059,1.3866,-0.0800).setStiffness(new double[] {0.0,0.0,0.0})
                                .addChild(new HAnimSegment("hanim_t6").setName("t6")
                                  .addChild(new Transform().setTranslation(0.0059,1.3866,-0.0800)
                                    .addChild(new Shape()
                                      ...
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setUSE("REC_SPINAL_COLOR"))))))
                                .addChild(new HAnimJoint("hanim_vt5").setName("vt5").setCenter(0.0060,1.4102,-0.0745).setStiffness(new double[] {0.0,0.0,0.0})
                                  .addChild(new HAnimSegment("hanim_t5").setName("t5")
                                    .addChild(new Transform().setTranslation(0.0060,1.4102,-0.0745)
                                      .addChild(new Shape()
                                        ...
                                        .setAppearance(new Appearance()
                                          .setMaterial(new Material().setUSE("SPINAL_COLOR"))))))
                                  .addChild(new HAnimJoint("hanim_vt4").setName("vt4").setCenter(0.0061,1.4320,-0.0675).setStiffness(new double[] {0.0,0.0,0.0})
                                    .addChild(new HAnimSegment("hanim_t4").setName("t4")
                                      .addChild(new Transform().setTranslation(0.0061,1.4320,-0.0675)
                                        .addChild(new Shape()
                                          ...
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setUSE("SPINAL_COLOR"))))))
                                    .addChild(new HAnimJoint("hanim_vt3").setName("vt3").setCenter(0.0062,1.4583,-0.0570).setStiffness(new double[] {0.0,0.0,0.0})
                                                      ...
                                                      .addChild(new HAnimSegment("hanim_l_carpal_distal_phalanx_1").setName("l_carpal_distal_phalanx_1")
                                                        ...
                                                        .addChild(new HAnimSite("hanim_l_carpal_distal_phalanx_1_tip").setName("l_carpal_distal_phalanx_1_tip").setTranslation(0.1982,0.8061,0.0759)
                                                          .addChild(new Shape()
                                                            ...
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setUSE("HAND_FEET_COLOR")))))))))
                                                .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setName("l_carpometacarpal_2").setCenter(0.1983,0.8024,-0.0280).setStiffness(new double[] {0.0,0.0,0.0})
                                                  .addChild(new HAnimSegment("hanim_l_metacarpal_2").setName("l_metacarpal_2")
                                                    .addChild(new Transform().setTranslation(0.1983,0.8024,-0.0280)
                                                      .addChild(new Shape()
                                                        ...
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setUSE("JOINT_COLOR"))))))
                                                  .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setName("l_metacarpophalangeal_2").setCenter(0.1983,0.7815,-0.0280).setStiffness(new double[] {0.0,0.0,0.0})
                                              ...
                                              .addChild(new HAnimSegment("hanim_r_forearm").setName("r_forearm")
                                                ...
                                                .addChild(new HAnimSite("hanim_r_radiale_pt").setName("r_radiale_pt").setTranslation(-0.2130,1.1305,-0.1091)
                                                  .addChild(new Shape()
                                                    ...
                                                    .setAppearance(new Appearance()
                                                      .setMaterial(new Material().setUSE("SITE_COLOR"))))))
                                              .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(-0.1959,0.8694,-0.0521).setStiffness(new double[] {0.0,0.0,0.0})
                                              ...
                                              .addChild(new HAnimSegment("hanim_c6").setName("c6")
                                                .addChild(new Transform().setTranslation(0.0066,1.5357,-0.0143)
                                                  .addChild(new Shape()
                                                    ...
                                                    .setAppearance(new Appearance()
                                                      .setMaterial(new Material().setUSE("SPINAL_COLOR"))))))
                                              .addChild(new HAnimJoint("hanim_vc5").setName("vc5").setCenter(0.0066,1.5520,-0.0082).setStiffness(new double[] {0.0,0.0,0.0})
                                                  ...
                                                  .addChild(new HAnimSegment("hanim_c4").setName("c4")
                                                    .addChild(new Transform().setTranslation(0.0066,1.5662,-0.0084)
                                                      .addChild(new Shape()
                                                        ...
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setUSE("SPINAL_COLOR"))))))
                                                  .addChild(new HAnimJoint("hanim_vc3").setName("vc3").setCenter(0.0066,1.5800,-0.0103).setStiffness(new double[] {0.0,0.0,0.0})
                                                          ...
                                                          .addChild(new HAnimSegment("hanim_skull").setName("skull")
                                                            ...
                                                            .addChild(new HAnimSite("hanim_nuchale_pt").setName("nuchale_pt").setTranslation(0.0039,1.5972,-0.0796)
                                                              .addChild(new Shape()
                                                                ...
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setUSE("SITE_COLOR"))))))))))))))))))))))))))))))))
      .addViewpoints(new HAnimSite("hanim_DiamondManLOA2_view").setName("DiamondManLOA2_view")
        .addChild(new Viewpoint("FrontView").setDescription("Front View").setPosition(0.35,0.854,2.57665))
        .addChild(new Viewpoint("SideView").setDescription("Side View").setOrientation(0.0,1.0,0.0,1.57079).setPosition(2.0,0.854,0.0))
        .addChild(new Viewpoint("TopView").setDescription("Top View").setOrientation(1.0,0.0,0.0,-1.57079).setPosition(0.0,3.4495,0.0))
        .addChild(new Viewpoint("RootView").setDescription("Humanoid Root View").setPosition(0.0,0.8240,0.277))
    ...
    {
        X3D thisExampleX3dModel = new DiamondManLOA2().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.DiamondManLOA2\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.DiamondManLOA2\" self-validation test results: ");

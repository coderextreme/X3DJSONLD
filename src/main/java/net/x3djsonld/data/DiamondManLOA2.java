  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_humanoid").setName("humanoid").setVersion("2.0")
      ...
      .addSkeleton(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,0.8240,0.0277)
        .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-93").setName("segmentNameNeededTODO-93")
            ...
            .addChild(new HAnimJoint("hanim_l_knee").setName("l_knee").setCenter(0.1040,0.4867,0.0308)
              ...
              .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocrural").setCenter(0.1101,0.0656,-0.0736)
                ...
                .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName("l_tarsometatarsal_2").setCenter(0.1086,0.0001,-0.0368)
                  .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-230").setName("segmentNameNeededTODO-230")
                ...
                .addChild(new HAnimSegment("hanim_r_talus").setName("r_talus")
                  ...
                  .addChild(new HAnimSite("hanim_r_calcaneous_post_pt").setName("r_calcaneous_post_pt").setTranslation(-0.0692,0.0297,-0.1221)
                    .addChild(new Shape()
                      ...
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setUSE("HAND_FEET_COLOR"))))))
                .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(-0.0801,0.0,0.0368)
        ...
        .addChild(new HAnimJoint("hanim_vl5").setName("vl5").setCenter(0.0028,1.0568,-0.0776)
          .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-385").setName("segmentNameNeededTODO-385")
          ...
          .addChild(new HAnimJoint("hanim_vl4").setName("vl4").setCenter(0.0035,1.0925,-0.0787)
            .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-391").setName("segmentNameNeededTODO-391")
            ...
            .addChild(new HAnimJoint("hanim_vl3").setName("vl3").setCenter(0.0041,1.1276,-0.0796)
              .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-397").setName("segmentNameNeededTODO-397")
              ...
              .addChild(new HAnimJoint("hanim_vl2").setName("vl2").setCenter(0.0045,1.1546,-0.0800)
                .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-403").setName("segmentNameNeededTODO-403")
                ...
                .addChild(new HAnimJoint("hanim_vl1").setName("vl1").setCenter(0.0048,1.1912,-0.0805)
                  .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-409").setName("segmentNameNeededTODO-409")
                  ...
                  .addChild(new HAnimJoint("hanim_vt12").setName("vt12").setCenter(0.0051,1.2278,-0.0808)
                    .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-415").setName("segmentNameNeededTODO-415")
                    ...
                    .addChild(new HAnimJoint("hanim_vt11").setName("vt11").setCenter(0.0053,1.2679,-0.0810)
                      .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-421").setName("segmentNameNeededTODO-421")
                      ...
                      .addChild(new HAnimJoint("hanim_vt10").setName("vt10").setCenter(0.0056,1.2848,-0.0822)
                        .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-427").setName("segmentNameNeededTODO-427")
                        ...
                        .addChild(new HAnimJoint("hanim_vt9").setName("vt9").setCenter(0.0057,1.3126,-0.0838)
                          .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-433").setName("segmentNameNeededTODO-433")
                          ...
                          .addChild(new HAnimJoint("hanim_vt8").setName("vt8").setCenter(0.0057,1.3382,-0.0845)
                            .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-439").setName("segmentNameNeededTODO-439")
                            ...
                            .addChild(new HAnimJoint("hanim_vt7").setName("vt7").setCenter(0.0058,1.3625,-0.0833)
                              .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-445").setName("segmentNameNeededTODO-445")
                              ...
                              .addChild(new HAnimJoint("hanim_vt6").setName("vt6").setCenter(0.0059,1.3866,-0.0800)
                                .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-451").setName("segmentNameNeededTODO-451")
                                ...
                                .addChild(new HAnimJoint("hanim_vt5").setName("vt5").setCenter(0.0060,1.4102,-0.0745)
                                  .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-457").setName("segmentNameNeededTODO-457")
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt4").setName("vt4").setCenter(0.0061,1.4320,-0.0675)
                                    .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-463").setName("segmentNameNeededTODO-463")
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt3").setName("vt3").setCenter(0.0062,1.4583,-0.0570)
                                      .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-469").setName("segmentNameNeededTODO-469")
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt2").setName("vt2").setCenter(0.0063,1.4761,-0.0484)
                                        .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-475").setName("segmentNameNeededTODO-475")
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt1").setName("vt1").setCenter(0.0065,1.4951,-0.0387)
                                          .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-481").setName("segmentNameNeededTODO-481")
                                            ...
                                            .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(0.2014,1.1357,-0.0682)
                                              ...
                                              .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(0.1984,0.8663,-0.0583)
                                                ...
                                                .addChild(new HAnimJoint("hanim_l_thumb1").setName("l_thumb1").setCenter(0.1924,0.8472,-0.0534)
                                                  .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-539").setName("segmentNameNeededTODO-539")
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_thumb2").setName("l_thumb2").setCenter(0.1951,0.8226,0.0246)
                                                    .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-545").setName("segmentNameNeededTODO-545")
                                                      ...
                                                      .addChild(new HAnimSegment("hanim_l_carpal_distal_phalanx_1").setName("l_carpal_distal_phalanx_1")
                                                        ...
                                                        .addChild(new HAnimSite("hanim_l_thumb_distal_tip").setName("l_thumb_distal_tip").setTranslation(0.1982,0.8061,0.0759)
                                                          .addChild(new Shape()
                                                            ...
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setUSE("HAND_FEET_COLOR")))))))))
                                                .addChild(new HAnimJoint("hanim_l_index0").setName("l_index0").setCenter(0.1983,0.8024,-0.0280)
                                                  .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-567").setName("segmentNameNeededTODO-567")
                                                    .addChild(new Transform().setTranslation(0.1983,0.8024,-0.0280)
                                                      .addChild(new Shape()
                                                        ...
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setUSE("JOINT_COLOR"))))))
                                                  .addChild(new HAnimJoint("hanim_l_index1").setName("l_index1").setCenter(0.1983,0.7815,-0.0280)
                                                    .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-573").setName("segmentNameNeededTODO-573")
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_index2").setName("l_index2").setCenter(0.2017,0.7363,-0.0248)
                                                      .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-579").setName("segmentNameNeededTODO-579")
                                          ...
                                          .addChild(new HAnimJoint("hanim_vc7").setName("vc7").setCenter(0.0066,1.5132,-0.0301)
                                            ...
                                            .addChild(new HAnimJoint("hanim_vc6").setName("vc6").setCenter(0.0066,1.5357,-0.0143)
                                              .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-731").setName("segmentNameNeededTODO-731")
                                              ...
                                              .addChild(new HAnimJoint("hanim_vc5").setName("vc5").setCenter(0.0066,1.5520,-0.0082)
                                                .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-737").setName("segmentNameNeededTODO-737")
                                                ...
                                                .addChild(new HAnimJoint("hanim_vc4").setName("vc4").setCenter(0.0066,1.5662,-0.0084)
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc3").setName("vc3").setCenter(0.0066,1.5800,-0.0103)
                                                    .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-750").setName("segmentNameNeededTODO-750")
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc2").setName("vc2").setCenter(0.0066,1.5928,-0.0103)
                                                      .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-756").setName("segmentNameNeededTODO-756")
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc1").setName("vc1").setCenter(0.0066,1.6144,-0.0034)
                                                        .addChild(new HAnimSegment("hanim_segmentNameNeededTODO-762").setName("segmentNameNeededTODO-762")
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"DiamondManLOA2\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"DiamondManLOA2\" self-validation test results: ");

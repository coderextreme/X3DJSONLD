...
public class KoreanCharacter10Mi
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Mi").setName("Mi").setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addChild(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,32.68,-0.7076)
        ...
        .addChild(new HAnimJoint("hanim_l_hip").setName("l_hip").setCenter(3.309,31.31,-0.8377)
          ...
          .addChild(new HAnimJoint("hanim_l_knee").setName("l_knee").setCenter(3.584,17.16,-1.037)
              ...
              .addChild(new Transform().setTranslation(3.584,17.16,-1.037)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                    .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_45_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_45_texCoordIndex())
            ...
            .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocrural").setCenter(3.602,4.137,0.6104)
              ...
              .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(3.602,3.02,0.07017)
        ...
        .addChild(new HAnimJoint("hanim_r_hip").setName("r_hip").setCenter(-3.309,31.31,-0.8377)
          ...
          .addChild(new HAnimJoint("hanim_r_knee").setName("r_knee").setCenter(-3.584,17.16,-1.037)
              ...
              .addChild(new Transform().setTranslation(-3.584,17.16,-1.037)
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                    .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_10_85_coordIndex()).setTexCoordIndex(getIndexedFaceSet_10_85_texCoordIndex())
                    .setCoord(new Coordinate().setPoint(getCoordinate_11_85_point()))
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.894,0.3355,0.9033,0.3536,0.8888,0.3564,0.8848,0.3395,0.9038,0.3291,0.9181,0.3492,0.8482,0.3305,0.8325,0.3485,0.8189,0.3396,0.8422,0.3186,0.8583,0.3389,0.8494,0.3547,0.8628,0.341,0.8599,0.3566,0.874,0.3392,0.8747,0.3563,0.9081,0.5043,0.8902,0.501,0.9231,0.5081,0.8041,0.5143,0.8222,0.5078,0.8436,0.5014,0.8584,0.4989,0.8728,0.4998,0.9302,0.4157,0.947,0.4098,0.9113,0.4208,0.8904,0.424,0.815,0.4077,0.8373,0.4108,0.8539,0.4159,0.872,0.4201,0.8743,0.3217,0.9269,0.3433,0.9054,0.3232,0.9389,0.5152,0.7964,0.4076,0.8003,0.4609,0.943,0.4625,0.9097,0.4626,0.9267,0.4619,0.8902,0.501,0.9081,0.5043,0.9231,0.5081,0.8222,0.5078,0.8436,0.5014,0.8584,0.4989,0.8728,0.4998,0.9389,0.5152,0.8041,0.5143,0.8902,0.501,0.9081,0.5043,0.9231,0.5081,0.9389,0.5152,0.8222,0.5078,0.8436,0.5014,0.8584,0.4989,0.8728,0.4998,0.8822,0.5045})))))))
            .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_talocrural").setCenter(-3.602,4.137,0.6104)
                ...
                .addChild(new Transform().setTranslation(-3.602,4.137,0.6104)
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_94_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_94_texCoordIndex())
                      ...
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.4523,0.3285,0.4305,0.3327,0.4342,0.3498,0.4016,0.3389,0.4117,0.3596,0.4577,0.3463,0.3636,0.4309,0.3649,0.4221,0.3323,0.5009,0.3464,0.464,0.4517,0.3097,0.3791,0.4387,0.4894,0.3285,0.4802,0.348,0.5003,0.3671,0.3639,0.4386,0.3636,0.4309,0.3649,0.4221,0.3205,0.4942,0.4278,0.3176,0.3146,0.4792,0.391,0.4492,0.3969,0.3186,0.4546,0.288,0.4234,0.2922,0.3954,0.296,0.2979,0.4905,0.3121,0.4644,0.2767,0.4647,0.2976,0.4385,0.3319,0.4273,0.5185,0.3543,0.4404,0.3653,0.4298,0.3752,0.4552,0.3612,0.47,0.366,0.4545,0.3833,0.4807,0.3791,0.4373,0.3575,0.4565,0.3537,0.4208,0.3674,0.4373,0.3575,0.4565,0.3537,0.4751,0.357,0.4905,0.3731,0.4751,0.357,0.4894,0.3285,0.4523,0.3285,0.4517,0.3097,0.4546,0.288,0.3464,0.464,0.3319,0.4273,0.5185,0.3543})))))))
              .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(-3.602,3.02,0.07017)
                  ...
                  .addChild(new Transform().setTranslation(-3.602,3.02,0.07017)
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_12_103_coordIndex()).setTexCoordIndex(getIndexedFaceSet_12_103_texCoordIndex())
                        ...
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.3792,0.4637,0.3701,0.4982,0.5611,0.3309,0.5505,0.3087,0.5574,0.2996,0.5797,0.3163,0.4886,0.3024,0.3626,0.4294,0.3994,0.4211,0.3995,0.4635,0.5574,0.2886,0.5848,0.3061,0.3998,0.5058,0.4251,0.4151,0.4863,0.2854,0.5136,0.3164,0.4285,0.4735,0.4287,0.5113,0.4484,0.4206,0.4611,0.4694,0.4496,0.5053,0.5134,0.294,0.5114,0.2829,0.5332,0.3116,0.542,0.3424,0.5336,0.2912,0.5373,0.2839,0.5267,0.3502,0.4523,0.3285,0.4894,0.3285,0.3319,0.4273,0.4546,0.288,0.3323,0.5009,0.5185,0.3543,0.4517,0.3097,0.3464,0.464,0.4523,0.3285,0.4894,0.3285,0.5185,0.3543,0.4517,0.3097,0.4546,0.288,0.3464,0.464,0.3323,0.5009})))))))))))
        .addChild(new HAnimJoint("hanim_sacroiliac").setName("sacroiliac").setCenter(0.05053,30.2,-1.38)
          ...
          .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_shoulder").setCenter(6.032,48.58,-1.277)
            ...
            .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(6.032,40.81,-1.412)
                ...
                .addChild(new Transform().setTranslation(6.032,40.81,-1.412)
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                      .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_134_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_134_texCoordIndex())
                      .setCoord(new Coordinate().setPoint(getCoordinate_12_134_point()))
              ...
              .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(6.934,33.96,-1.108)
                  ...
                  .addChild(new Transform().setTranslation(6.934,33.96,-1.108)
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                        .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_12_143_coordIndex()).setTexCoordIndex(getIndexedFaceSet_12_143_texCoordIndex())
                        .setCoord(new Coordinate().setPoint(getCoordinate_13_143_point()))
                        .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_13_144_point())))))))))
          .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_shoulder").setCenter(-6.032,48.58,-1.277)
            ...
            .addChild(new HAnimJoint("hanim_r_elbow").setName("r_elbow").setCenter(-6.032,40.81,-1.412)
                ...
                .addChild(new Transform().setTranslation(-6.032,40.81,-1.412)
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                      .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_11_164_coordIndex()).setTexCoordIndex(getIndexedFaceSet_11_164_texCoordIndex())
                      .setCoord(new Coordinate().setPoint(getCoordinate_12_164_point()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(new double[] {0.5737,0.0472,0.5721,0.0377,0.5736,0.0597,0.5731,0.073,0.5718,0.0836,0.5723,0.094,0.575,0.1083,0.5737,0.0301,0.4707,0.0481,0.4699,0.0424,0.4736,0.058,0.4725,0.0633,0.4717,0.0706,0.4698,0.0802,0.4664,0.0886,0.4716,0.0358,0.464,0.0502,0.4625,0.0465,0.4669,0.0583,0.4661,0.0627,0.4549,0.0769,0.4607,0.0728,0.4621,0.0416,0.4652,0.068,0.4552,0.0578,0.5782,0.0137,0.4685,0.027,0.4561,0.0381,0.5222,0.0476,0.521,0.04,0.5236,0.0589,0.5228,0.0682,0.5218,0.0771,0.521,0.0871,0.5207,0.0985,0.5234,0.0203,0.5227,0.0329,0.5721,0.0377,0.5731,0.073,0.5718,0.0836,0.5723,0.094,0.5737,0.0472,0.5736,0.0597,0.5782,0.0137,0.575,0.1083,0.5737,0.0301,0.5737,0.0472,0.5721,0.0377,0.5737,0.0301,0.5782,0.0137,0.5723,0.094,0.5718,0.0836,0.5731,0.073,0.5736,0.0597,0.5735,0.0549})))))))
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(-6.934,33.96,-1.108)
                  ...
                  .addChild(new Transform().setTranslation(-6.934,33.96,-1.108)
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(0.588,0.588,0.588))
                        .setTexture(new ImageTexture().setUSE("MiTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57).setCoordIndex(getIndexedFaceSet_12_173_coordIndex()).setTexCoordIndex(getIndexedFaceSet_12_173_texCoordIndex())
                        .setCoord(new Coordinate().setPoint(getCoordinate_13_173_point()))
                        .setTexCoord(new TextureCoordinate().setPoint(getTextureCoordinate_13_174_point())))))))))
          .addChild(new HAnimJoint("hanim_vl5").setName("vl5").setCenter(0.0,35.31,-2.314)
            ...
            .addChild(new HAnimJoint("hanim_skullbase").setName("skullbase").setCenter(0.0,35.31,-2.314)
	...
	// end of initialize() method
		...
		private double[] getCoordinate_10_36_point_1()
		{
		...
		private double[] getCoordinate_10_36_point_2()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_85_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_10_85_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_11_134_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_11_134_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_12_143_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_12_143_texCoordIndex_1()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getCoordinate_13_143_point_1()
		{
		...
		private double[] getCoordinate_13_143_point_2()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getTextureCoordinate_13_144_point_1()
		{
		...
		private double[] getTextureCoordinate_13_144_point_2()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_11_164_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_11_164_texCoordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_12_173_coordIndex_1()
		{
		...
		/** Define subarrays using type int[] */
		private int[] getIndexedFaceSet_12_173_texCoordIndex_1()
		{
		...
		/** Define subarrays using type double[] */
		private double[] getCoordinate_13_173_point_1()
		{
			double[] value = {0.1606,-3.119,-1.367,-0.5955,-2.804,-1.364,-0.0283,-4.239,-1.268,-0.4853,-4.459,-1.306,-0.1734,-2.884,-1.472,-0.1914,-4.513,-1.33,0.0546,-3.823,-1.333,-0.6422,-4.008,-1.384,-0.2956,-3.948,-1.447,-1.059,-2.877,-0.8092,-1.131,-3.045,-0.2734,0.0511,-3.415,-0.4283,0.095,-3.29,-0.948,-0.2794,-4.884,-0.4162,-0.2165,-4.621,-0.9125,-0.8146,-4.829,-0.7942,-0.8403,-5.006,-0.3198,-0.526,-4.882
			double[] value = {0.1308,0.0366,0.1241,0.0246,0.1321,0.0249,0.1377,0.0359,0.1011,0.0409,0.0975,0.0277,0.1146,0.0271,0.1192,0.0379,0.0931,0.0172,0.089,0.0099,0.11,0.0091,0.1067,0.0164,0.35,0.0366,0.3489,0.0502,0.3205,0.0534,0.3231,0.0406,0.3143,0.042,0.3121,0.0544,0.1208,0.0139,0.115,0.0168,0.3284,0.0253,0.3195,0.0276,0.3512,0.0217,0.1382,0.0498,0.1325,0.0503,0.122,0.0525,0.101,0.0551,0.3493,0.0655,0.3227,0.0689,0.3131,0.0688,0.1316,0.0637,0.1356,0.0664,0.1016,0.0721,0.1228,0.0653,0.3527,0.0822,0.3272,0.0829,0.3177,0.0834,0.1021,0.0809,0.3277,0.0894,0.1247,0.0729,0.057,0.0846,0.0635,0.0865,0.0654,0.1028,0.39,0.1066,0.3987,0.1078,0.3893,0.1204,0.386,0.1201,0.0617,0.0997,0.0529,0.0851,0.3841,0.1222,0.3856,0.1058,0.3732,0.023,0.3702,0.0366,0.0586,0.1022,0.0659,0.0208,0.0669,0.0132,0.0808,0.0581,0.3719,0.0489,0.3737,0.0643,0.0807,0.0432,0.3787,0.0776,0.387,0.084,0.0756,0.0294,0.0723,0.0743,0.0769,0.0818,0.4078,0.0874,0.3975,0.0862,0.0588,0.0634,0.0512,0.0663,0.4134,0.0715,0.4058,0.0668,0.3921,0.0253,0.3889,0.0377,0.0666,0.0904,0.044,0.0477,0.395,0.0452,0.0403,0.0581,0.3979,0.0573,0.411,0.0299,0.4089,0.037,0.4085,0.0432,0.4106,0.0494,0.4116,0.0545,0.4177,0.0584,0.4271,0.0566,0.0463,0.0248,0.0476,0.0157,0.046,0.0322,0.026,0.0492,0.027,0.0431,0.0287,0.0366,0.0288,0.0303,0.0261,0.0257,0.067,0.1055,0.0159,0.0394,0.3096,0.0404,0.3076,0.0549,0.3497,0.0139,0.3279,0.0192,0.3157,0.024};
			return value;
		}
		private double[] getTextureCoordinate_13_174_point_2()
		{
			double[] value = {0.309,0.0705,0.3144,0.0871,0.3539,0.0882,0.4067,0.1099,0.3933,0.123,0.3734,0.0118,0.4167,0.0905,0.4247,0.0749,0.3941,0.0146,0.4152,0.0259,0.4192,0.043,0.4016,0.0276,0.3989,0.0373,0.4017,0.0442,0.4087,0.0607,0.4156,0.0649,0.4259,0.0658,0.0332,0.0536,0.0355,0.0454,0.0375,0.0276,0.0369,0.0207,0.4046,0.0203,0.4042,0.0533,0.0373,0.0344};
			return value;
		}
		...
		private int[] getIndexedFaceSet_10_185_coordIndex_4()
		{
		...
		private int[] getIndexedFaceSet_10_185_texCoordIndex_4()
		{
		...
		private double[] getCoordinate_11_185_point_5()
		{
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #36, 748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #36, 748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #36, 312 total numbers made up of 104 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec3f Coordinate_10_36_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_10_36_point_1()))
				.append(new MFVec3f(getCoordinate_10_36_point_2()));
			return Coordinate_10_36_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #37, 246 total numbers made up of 123 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #45, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #45, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #45, 159 total numbers made up of 53 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=11, element #54, 424 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #54, 424 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #54, 165 total numbers made up of 55 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #63, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #63, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #76, 748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #76, 312 total numbers made up of 104 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=10, element #77, 246 total numbers made up of 123 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #85, 408 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet
.527,1.696,-3.596,-1.527,0.0288,-3.596,-3.05,-1.159,-3.596,-2.427,-0.007,0.4015,-1.634,0.0691,-4.009,-1.527,0.831,-4.009,-2.327,-0.7387,-0.3236,-2.36,-1.115,-0.3236,-1.605,0.0253,-0.3236,-2.651,0.7919,-0.3236,-2.36,1.146,-0.3236,-1.605,0.8997,-0.3236,-0.7342,-0.0069,-0.3236,-0.4324,-0.8605,-0.3236,-0.7342,0.8273,-1.7,-0.5712,0.8628,-1.967,-0.7779,1.072,-3.315,-0.486,1.075,-3.663,-0.3503,0.0696,-3.663,-0.3504,-1.075,-3.663,-0.3505,-1.038,-3.366,-0.5053,-0.8586,-1.976,-0.7821,-0.8162,-1.71,-0.5729,0.0163,-1.552,-0.1102});
			return Coordinate_12_94_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=12, element #103, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #103, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #103, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_13_103_point()
		{
			MFVec3f Coordinate_13_103_point = new MFVec3f(new double[] {-1.371,-2.892,-0.0282,0.0288,-2.892,-0.0282,1.278,-2.892,-0.0282,-1.63,-0.945,1.293,1.577,-1.13,1.46,-1.818,-2.892,1.399,0.0288,-2.892,1.399,1.735,-2.892,1.399,-1.703,-1.538,2.423,0.0288,-1.178,2.653,1.625,-1.538,2.379,-1.849,-2.892,2.404,0.0288,-2.892,2.404,1.805,-2.892,2.404,-1.422,-1.851,3.46,0.141,-1.65,3.734,1.463,-1.867,3.39,-1.481,-2.892,3.56,0.3127,-2.892,4.033,1.574,-2.892,3.581,-1.605,-2.479,-0.0282,0.3127,-2.479,4.194,1.682,-2.479,-0.0282,-2.033,-2.479,1.399,1.994,-2.479,1.399,-1.972,-2.479,2.404,2.033,-2.479,2.404,-1.544,-2.479,3.817,1.658,-2.479,3.714,0.2038,-0.6584,1.702,-1.445,-0.1027,-0.9967,1.447,-0.1027,-0.9967,1.274,-0.0025,-0.0073,-1.246,-0.0085,-0.0073,-0.231,-2.892,-0.9871,0.2448,-2.892,-0.9871,0.0146,0.1618,0.5865,-1.653,-2.479,-0.9871,1.696,-2.479,-0.9871,0.0244,-2.892,-0.9871,0.2328,0.3042,-1.524,0.21,0.5895,-0.9062,0.015,0.7752,-0.2115,-0.1815,0.5831,-0.9091,-0.2075,0.3012,-1.525,-0.2422,-0.6147,-2.345,-0.2136,-0.8983,-2.297,0.0244,-0.8983,-2.297,0.2307,-0.8983,-2.297,0.2739,-0.5991,-2.339});
			return Coordinate_13_103_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=9, element #116, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=9, element #116, 368 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=10, element #116, 165 total numbers made up of 55 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #125, 448 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #125, 174 total numbers made up of 58 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_11_134_coordIndex()
		{
			MFInt32 IndexedFaceSet_11_134_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_11_134_coordIndex_1()));
			return IndexedFaceSet_11_134_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #134, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_11_134_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_11_134_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_11_134_texCoordIndex_1()));
			return IndexedFaceSet_11_134_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #134, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_12_143_coordIndex()
		{
			MFInt32 IndexedFaceSet_12_143_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_143_coordIndex_1()));
			return IndexedFaceSet_12_143_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #143, 792 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_12_143_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_12_143_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_143_texCoordIndex_1()));
			return IndexedFaceSet_12_143_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #143, 303 total numbers made up of 101 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_13_143_point()
		{
			MFVec3f Coordinate_13_143_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_13_143_point_1()))
				.append(new MFVec3f(getCoordinate_13_143_point_2()));
			return Coordinate_13_143_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=13, element #144, 248 total numbers made up of 124 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_13_144_point()
		{
			MFVec2f TextureCoordinate_13_144_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_13_144_point_1()))
				.append(new MFVec2f(getTextureCoordinate_13_144_point_2()));
			return TextureCoordinate_13_144_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #155, 448 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #155, 448 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #155, 174 total numbers made up of 58 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		{
			MFVec2f TextureCoordinate_11_156_point = new MFVec2f(new double[] {0.5806,0.1531,0.5893,0.1475,0.5653,0.1551,0.5523,0.1539,0.5408,0.1501,0.531,0.1413,0.5194,0.1311,0.6103,0.1278,0.598,0.1395,0.5884,0.2211,0.6032,0.2168,0.5665,0.2255,0.5445,0.2237,0.5286,0.2188,0.5168,0.2148,0.4946,0.2088,0.6175,0.2105,0.6398,0.2042,0.8805,0.864,0.9038,0.8213,0.9347,0.8443,0.897,0.875,0.8495,0.8555,0.8494,0.8095,0.8149,0.8685,0.7931,0.8239,0.7986,0.8794,0.7625,0.8462,0.5933,0.2702,0.6119,0.2609,0.5675,0.2742,0.5383,0.2707,0.5195,0.2617,0.5082,0.2554,0.4847,0.2451,0.6523,0.2396,0.6284,0.2508,0.7852,0.8995,0.742,0.8792,0.7754,0.9475,0.7234,0.9289,0.9127,0.9005,0.9563,0.8809,0.849,0.9239,0.9068,0.8131,0.94,0.8368,0.9636,0.8731,0.9828,0.9217,0.7348,0.8711,0.7565,0.8388,0.7893,0.8149,0.8497,0.8016,0.9212,0.9514,0.9731,0.9326,0.7144,0.9175,0.5721,0.0377,0.5737,0.0472,0.5736,0.0597,0.5731,0.073,0.5718,0.0836,0.5723,0.094,0.575,0.1083,0.5737,0.0301,0.5782,0.0137,0.5721,0.0377,0.5731,0.073,0.5718,0.0836,0.5723,0.094,0.5737,0.0472,0.5736,0.0597,0.5782,0.0137,0.575,0.1083,0.5737,0.0301,0.5721,0.0377,0.5737,0.0472,0.5736,0.0597,0.5731,0.073,0.5718,0.0836,0.5723,0.094,0.575,0.1083,0.5737,0.0301,0.5731,0.0667});
			return TextureCoordinate_11_156_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=11, element #164, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_11_164_coordIndex()
		{
			MFInt32 IndexedFaceSet_11_164_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_11_164_coordIndex_1()));
			return IndexedFaceSet_11_164_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #164, 384 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_11_164_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_11_164_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_11_164_texCoordIndex_1()));
			return IndexedFaceSet_11_164_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #164, 150 total numbers made up of 50 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_12_164_point()
		{
			MFVec3f Coordinate_12_164_point = new MFVec3f(new double[] {-0.821,-0.5909,-0.8822,-1.427,-0.594,0.7319,-0.8222,-0.5909,0.996,-0.2876,-0.5847,0.7126,-0.7753,-6.749,-0.7027,-1.443,-6.672,0.0095,-0.2955,-6.697,-0.0347,-0.4962,-6.735,-0.5285,-1.195,-6.689,0.4229,-0.8251,-6.727,0.6277,-0.5299,-6.717,0.4443,-1.193,-6.711,-0.4833,-1.419,-0.5938,-0.6599,-1.809,-0.6062,0.0293,0.0834,-0.5804,0.0244,-0.3356,-0.5853,-0.6602,-0.8149,-7.02,-0.669,-1.318,-7.012,0.0209,-0.3939,-6.998,-0.022,-0.6226,-7.033,-0.53,-1.109,-7.01,0.4196,-0.8288,-7.019,0.5966,-0.6184,-7.025,0.4434,-1.065,-7.043,-0.4741,-0.8905,-7.158,-0.0054,-1.294,-3.708,-0.529,-0.7852,-3.761,-0.86,-1.645,-3.664,0.0347,-1.34,-3.692,0.5633,-0.8188,-3.731,0.8834,-0.4018,-3.736,0.599,-0.0819,-3.706,-0.0521,-0.3634,-3.717,-0.5775,-0.8469,-0.0133,-0.9988,-1.479,-0.0529,0.7574,-0.8418,-0.0307,1.025,-0.2776,-0.0084,0.7411,-1.534,-0.0371,-0.7635,-1.908,-0.0564,0.0374,0.1502,0.0257,0.0308,-0.281,0.0081,-0.7713,-1.424,0.4666,-0.6148,-0.8709,0.4848,-0.8043,-0.426,0.5021,-0.6254,-0.0733,0.5182,0.0308,-0.4223,0.4884,0.6105,-0.8677,0.4713,0.8343,-1.375,0.4535,0.6213,-1.727,0.4516,0.0325,-0.9079,0.6893,0.0114});
			return Coordinate_12_164_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=12, element #173, 792 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_12_173_coordIndex()
		{
			MFInt32 IndexedFaceSet_12_173_coordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_173_coordIndex_1()));
			return IndexedFaceSet_12_173_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=12, element #173, 792 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFInt32 getIndexedFaceSet_12_173_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_12_173_texCoordIndex = new MFInt32()/*2.finalize*/
				.append(new MFInt32(getIndexedFaceSet_12_173_texCoordIndex_1()));
			return IndexedFaceSet_12_173_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=13, element #173, 303 total numbers made up of 101 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_13_173_point()
		{
			MFVec3f Coordinate_13_173_point = new MFVec3f()/*2.finalize*/
				.append(new MFVec3f(getCoordinate_13_173_point_1()))
				.append(new MFVec3f(getCoordinate_13_173_point_2()));
			return Coordinate_13_173_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=13, element #174, 248 total numbers made up of 124 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec2f getTextureCoordinate_13_174_point()
		{
			MFVec2f TextureCoordinate_13_174_point = new MFVec2f()/*2.finalize*/
				.append(new MFVec2f(getTextureCoordinate_13_174_point_1()))
				.append(new MFVec2f(getTextureCoordinate_13_174_point_2()));
			return TextureCoordinate_13_174_point;
		}
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=10, element #185, 3048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_10_185_coordIndex()
		{
			MFInt32 IndexedFaceSet_10_185_coordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_10_185_coordIndex_4()));
			return IndexedFaceSet_10_185_coordIndex;
		}
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=10, element #185, 3048 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFInt32 getIndexedFaceSet_10_185_texCoordIndex()
		{
			MFInt32 IndexedFaceSet_10_185_texCoordIndex = new MFInt32()/*2.finalize*/
				...
				.append(new MFInt32(getIndexedFaceSet_10_185_texCoordIndex_4()));
			return IndexedFaceSet_10_185_texCoordIndex;
		}
		/** Large attribute array: Coordinate point field, scene-graph level=11, element #185, 1254 total numbers made up of 418 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		private MFVec3f getCoordinate_11_185_point()
		{
			MFVec3f Coordinate_11_185_point = new MFVec3f()/*2.finalize*/
				...
				.append(new MFVec3f(getCoordinate_11_185_point_5()));
			return Coordinate_11_185_point;
		}
		/** Large attribute array: TextureCoordinate point field, scene-graph level=11, element #186, 988 total numbers made up of 494 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet coordIndex field, scene-graph level=11, element #194, 1748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: IndexedFaceSet texCoordIndex field, scene-graph level=11, element #194, 1748 total numbers.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: Coordinate point field, scene-graph level=12, element #194, 732 total numbers made up of 244 3-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java
		...
		/** Large attribute array: TextureCoordinate point field, scene-graph level=12, element #195, 570 total numbers made up of 285 2-tuple values.
		 * Reassemble split array as single method to improve readability and runnability.
		 * Provide large array values via separate methods, hoping to avoid 'code too large' Java compilation errors. 
		 * Individual Java methods (including aggregated initializations) are limited to 64KB.
		 * @see https://stackoverflow.com/questions/2407912/code-too-large-compilation-error-in-java

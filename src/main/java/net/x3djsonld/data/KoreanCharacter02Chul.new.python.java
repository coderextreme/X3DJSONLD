...
public class KoreanCharacter02Chul
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Chul").setName("Chul").setScale(0.0225,0.0225,0.0225).setVersion("2.0")
      ...
      .addChild(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root").setCenter(0.0,44.07,-1.034).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})

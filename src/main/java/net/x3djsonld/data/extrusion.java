...
"                }" + "\n")
    ...
    {
        X3DObject thisExampleX3dObject = new extrusion().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.print("WARNING: \"extrusion\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");

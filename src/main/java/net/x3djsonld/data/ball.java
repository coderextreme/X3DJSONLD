...
public class ball
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new Environment().setGammaCorrectionDefault("none"
// [*** X3dToJava.xslt error: encountered incorrect type, Environment gammaCorrectionDefault: $isNumeric=false, $attributeType=, value='none']
))
...
"                </ComposedShader>"})
          ...
          .addShaders(new ComposedShader().setLanguage("GLSL")
            ...
            .addParts(new ShaderPart().setUrl(new String[] {"../shaders/x3dom.vs","https://coderextreme.net/X3DJSONLD/src/main/src/main/shaders/x3dom.vs"}))

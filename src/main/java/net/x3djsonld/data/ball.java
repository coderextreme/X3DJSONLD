...
public class ball
{
  ...
  .setHead(new headObject()
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE      ).setContent("ball.x3d"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/ball.x3d"))
    .addMeta(new metaObject().setName(metaObject.NAME_DESCRIPTION).setContent("a prismatic sphere")))
...
"                </ComposedShader>"})
          ...
          .addShaders(new ComposedShaderObject().setLanguage("GLSL")
            ...
            .addParts(new ShaderPartObject().setUrl(new String[] {"../shaders/x3dom.vs","https://coderextreme.net/X3DJSONLD/src/main/src/main/shaders/x3dom.vs"}))
    ...
    {
        X3DObject thisExampleX3dObject = new ball().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"ball\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");

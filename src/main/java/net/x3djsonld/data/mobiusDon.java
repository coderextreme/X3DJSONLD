 ...
 * <p> a mobius of 3 NURBS Patch Surfaces. </p>
 <p> Related links:  source mobiusDon.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
        <caption>Scene Meta Information</caption>
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.mobiusDon&nbsp; Document Metadata </td>
		</tr>

		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> title </i> </td>
			<td> <a href="https://kshell.com/mobiusDon.x3d">mobiusDon.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="https://kshell.com/mobiusDon.x3d" target="_blank">https://kshell.com/mobiusDon.x3d</a> </td>
		</tr>
		<tr>
...
public class mobiusDon
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("mobiusDon.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://kshell.com/mobiusDon.x3d"))
  ...
  .setScene(new Scene()
    ...
    public static void main(String args[])
    {
        ...
        X3D thisExampleX3dModel = new mobiusDon().getX3dModel();
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.mobiusDon\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.mobiusDon self-validation test confirmation: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./mobiusDon_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./mobiusDon_JavaExport.x3d"; 
                String filenameX3DV = "./mobiusDon_JavaExport.x3dv"; 
                String filenameJSON = "./mobiusDon_JavaExport.json";

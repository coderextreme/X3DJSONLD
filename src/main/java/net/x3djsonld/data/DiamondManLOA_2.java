...
public class DiamondManLOA_2
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("DiamondManLOA_2.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IMAGE      ).setContent("DiamondManLOA_2.png"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA_2.x3d"))
  ...
  .setScene(new Scene()
                                                      ...
                                                      .addChild(new HAnimSegment("hanim_l_thumb_distal").setName("l_thumb_distal")
                                                        ...
                                                        .addChild(new HAnimSite("hanim_l_thumb_distal_tip").setName("l_thumb_distal_tip").setTranslation(0.1982,0.8061,0.0759)
                                                          .addChild(new Shape()
                                                            ...
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setUSE("HAND_FEET_COLOR")))))))))
                                                .addChild(new HAnimJoint("hanim_l_index0").setName("l_index0").setCenter(0.1983,0.8024,-0.0280).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
                                                  .addChild(new HAnimSegment("hanim_l_index_metacarpal").setName("l_index_metacarpal")
                                                    .addChild(new Transform().setTranslation(0.1983,0.8024,-0.0280)
                                                      .addChild(new Shape()
                                                        ...
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setUSE("JOINT_COLOR"))))))
                                                  .addChild(new HAnimJoint("hanim_l_index1").setName("l_index1").setCenter(0.1983,0.7815,-0.0280).setLlimit(new double[] {0.0,0.0,0.0}).setUlimit(new double[] {0.0,0.0,0.0})
    ...
    {
        X3D thisExampleX3dModel = new DiamondManLOA_2().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"net.x3djsonld.data.DiamondManLOA_2\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		else if (hasArguments) // if no arguments provided, this method produces usage warning
			thisExampleX3dModel.handleArguments(args);

		if (validate)
		{
			System.out.print("Java program \"net.x3djsonld.data.DiamondManLOA_2\" self-validation test results: ");

                                                      ...
                                                      .addChild(new HAnimSegment("hanim_l_thumb_distal").setName("l_thumb_distal")
                                                        ...
                                                        .addChild(new HAnimSite("hanim_l_thumb_distal_tip").setName("l_thumb_distal_tip").setTranslation(0.1982,0.8061,0.0759)
                                                          .addChild(new Shape()
                                                            ...
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setUSE("HAND_FEET_COLOR")))))))))
                                                .addChild(new HAnimJoint("hanim_l_index0").setName("l_index0").setCenter(0.1983,0.8024,-0.0280).setStiffness(new double[] {0.0,0.0,0.0})
                                                  .addChild(new HAnimSegment("hanim_l_index_metacarpal").setName("l_index_metacarpal")
                                                    .addChild(new Transform().setTranslation(0.1983,0.8024,-0.0280)
                                                      .addChild(new Shape()
                                                        ...
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setUSE("JOINT_COLOR"))))))
                                                  .addChild(new HAnimJoint("hanim_l_index1").setName("l_index1").setCenter(0.1983,0.7815,-0.0280).setStiffness(new double[] {0.0,0.0,0.0})

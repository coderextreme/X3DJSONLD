...
public class HelloWorldProgramOutput
{
  ...
  .setHead(new headObject()
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_MODIFIED   ).setContent("28 June 2018"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_REFERENCE  ).setContent("X3dValidator https://savage.nps.edu/X3dValidator?url=http://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_TRANSLATED ).setContent("19 April 2020"))

...
public class CADPartChildNoTransformation
{
  ...
  .setScene(new Scene()
      ...
      .addChild(new CADPart().setName("CADPartExample")
        .addChild(new CADFace().setName("outerSurface")
          .setShape(new Shape()
            ...
            .setGeometry(new Cylinder().setBottom(false).setHeight(3.0).setRadius(2.0).setTop(false))))
        .addChild(new CADFace().setName("innerSurface")
          .setShape(new Shape()
            ...
            .setGeometry(new Cylinder().setBottom(false).setHeight(3.0).setSolid(false).setTop(false))))
        ...
        .addChild(new CADFace().setName("bottomCap")
          .setShape(new Shape()
            .setAppearance(new Appearance().setUSE("AppearanceGrey"))
            .setGeometry(new IndexedTriangleSet().setCcw(true).setColorPerVertex(true).setIndex(new int[] {0,1,2,2,1,3,2,3,4,4,3,5,4,5,6,6,5,7,6,7,8,8,7,9,8,9,10,10,9,11,10,11,12,12,11,13,12,13,14,14,13,15,14,15,16,16,15,17,16,17,18,18,17,19,18,19,20,20,19,21,20,21,22,22,21,23,22,23,24,24,23,25,24,25,26,26,25,27,26,27,28,28,27,29,28,29,30,30,29,31,30,31,32,32,31,33,32,33,34,34,33,35,34,35,36,36,35,37,36,37,38,38,37,39,38,39,40,40,39,41,40,41,42,42,41,43,42,43,44,44,43,45,44,45,46,46,45,47,46,47,48,48,47,49,48,49,50,50,49,51,50,51,52,52,51,53,52,53,54,54,53,55,54,55,56,56,55,57,56,57,58,58,57,59,58,59,60,60,59,61,60,61,62,62,61,63,62,63,64,64,63,65}).setNormalPerVertex(true).setSolid(true)
              .setCoord(new Coordinate().setPoint(getCoordinate_8_33_point()))))))));
            }
            catch (Exception ex)
            {       
	...
	// end of initialize() method
		...
		/** Large attribute array: Coordinate point field, scene-graph level=8, element #28, 198 total numbers made up of 66 3-tuple values.
		 ...
		 * @see https://stackoverflow.com/questions/11437905/java-too-many-constants-jvm-error
		 */
		private MFVec3f getCoordinate_8_33_point()
		{
			MFVec3f Coordinate_8_33_point = new MFVec3f(new double[] {2.0,-1.5,0.0,1.0,-1.5,0.0,1.9616,-1.5,-0.3902,0.9808,-1.5,-0.1951,1.8478,-1.5,-0.7654,0.9239,-1.5,-0.3827,1.6629,-1.5,-1.1111,0.8315,-1.5,-0.5556,1.4142,-1.5,-1.4142,0.7071,-1.5,-0.7071,1.1111,-1.5,-1.6629,0.5556,-1.5,-0.8315,0.7654,-1.5,-1.8478,0.3827,-1.5,-0.9239,0.3902,-1.5,-1.9616,0.1951,-1.5,-0.9808,0.0,-1.5,-2.0,0.0,-1.5,-1.0,-0.3902,-1.5,-1.9616,-0.1951,-1.5,-0.9808,-0.7654,-1.5,-1.8478,-0.3827,-1.5,-0.9239,-1.1111,-1.5,-1.6629,-0.5556,-1.5,-0.8315,-1.4142,-1.5,-1.4142,-0.7071,-1.5,-0.7071,-1.6629,-1.5,-1.1111,-0.8315,-1.5,-0.5556,-1.8478,-1.5,-0.7654,-0.9239,-1.5,-0.3827,-1.9616,-1.5,-0.3902,-0.9808,-1.5,-0.1951,-2.0,-1.5,0.0,-1.0,-1.5,0.0,-1.9616,-1.5,0.3902,-0.9808,-1.5,0.1951,-1.8478,-1.5,0.7654,-0.9239,-1.5,0.3827,-1.6629,-1.5,1.1111,-0.8315,-1.5,0.5556,-1.4142,-1.5,1.4142,-0.7071,-1.5,0.7071,-1.1111,-1.5,1.6629,-0.5556,-1.5,0.8315,-0.7654,-1.5,1.8478,-0.3827,-1.5,0.9239,-0.3902,-1.5,1.9616,-0.1951,-1.5,0.9808,0.0,-1.5,2.0,0.0,-1.5,1.0,0.3902,-1.5,1.9616,0.1951,-1.5,0.9808,0.7654,-1.5,1.8478,0.3827,-1.5,0.9239,1.1111,-1.5,1.6629,0.5556,-1.5,0.8315,1.4142,-1.5,1.4142,0.7071,-1.5,0.7071,1.6629,-1.5,1.1111,0.8315,-1.5,0.5556,1.8478,-1.5,0.7654,0.9239,-1.5,0.3827,1.9616,-1.5,0.3902,0.9808,-1.5,0.1951,2.0,-1.5,0.0,1.0,-1.5,0.0});
			return Coordinate_8_33_point;
		}
...
//      System.out.println("X3D model construction complete.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.CADPartChildNoTransformation self-validation test results: ");

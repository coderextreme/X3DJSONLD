...
public class indexedfaceset_pixeltexture_whole
{
  ...
  public String validateSelf()
  {
    ...
    {
		indexedfaceset_pixeltexture_whole testObject = new indexedfaceset_pixeltexture_whole();
		System.out.println ("indexedfaceset_pixeltexture_whole execution self-validation test results: " + testObject.validateSelf());
	}
}

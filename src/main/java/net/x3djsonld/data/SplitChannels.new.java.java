...
public class SplitChannels
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new Background().setSkyColor(new MFColor(new double[] {0.2,0.2,0.21})))
    ...
    .addChild(new Transform("PowerR").setTranslation(100.0,400.0,400.0)
      .addChild(new Transform().setRotation(1.0,0.0,0.0,-0.5).setTranslation(0.0,40.0,0.0)
        .addChild(new Shape()
    ...
    .addChild(new ChannelSplitter("ChannelSplitter").setChannelCountMode("EXPLICIT")
      .setSource(new AudioClip().setDescription("Violin").setUrl(new String[] {"sound/violin.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/violin.mp3"})))

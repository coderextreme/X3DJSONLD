...
public class bubs3
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/bubs.x3d")))
  .setScene(new Scene()
...
""")
      ...
      .addChild(new TimeSensor("DECLBubble_bubbleA_bubbleClock").setCycleInterval(10.0).setLoop(true))
...
""")
        ...
        .addField(new field().setName("scalvel").setType(field.TYPE_SFVEC3F).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFVec3f(0.0,0.0,0.0)))
        .addField(new field().setName("set_fraction").setType(field.TYPE_SFFLOAT).setAccessType(field.ACCESSTYPE_INPUTONLY)))
      .addChild(new TimeSensor("DECLBubble_bubbleB_bubbleClock").setCycleInterval(10.0).setLoop(true))
...
""")
        ...
        .addField(new field().setName("scalvel").setType(field.TYPE_SFVEC3F).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFVec3f(0.0,0.0,0.0)))
        .addField(new field().setName("set_fraction").setType(field.TYPE_SFFLOAT).setAccessType(field.ACCESSTYPE_INPUTONLY)))
      .addChild(new TimeSensor("DECLBubble_bubbleC_bubbleClock").setCycleInterval(10.0).setLoop(true))
...
""")
        ...
        .addField(new field().setName("scalvel").setType(field.TYPE_SFVEC3F).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFVec3f(0.0,0.0,0.0)))
        .addField(new field().setName("set_fraction").setType(field.TYPE_SFFLOAT).setAccessType(field.ACCESSTYPE_INPUTONLY)))
      .addChild(new TimeSensor("DECLBubble_bubbleD_bubbleClock").setCycleInterval(10.0).setLoop(true))
...
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"net.x3djsonld.data.bubs3\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("net.x3djsonld.data.bubs3 self-validation test results: ");

      ...
      .addChild(new DynamicsCompressor()
        .addChild(new Gain()
          .addChild(new SpatialSound("Audio1")
            .addChild(new Gain()
              .addChild(new Analyser()
                .addChild(new BiquadFilter().setDetune(50.0).setFrequency(600.0).setQualityFactor(30.0).setType("")
          ...
          .addChild(new SpatialSound("Audio2")
            .addChild(new Gain()
              .addChild(new Analyser()
                .addChild(new BiquadFilter().setDetune(15.0).setFrequency(600.0).setQualityFactor(15.0).setType("")
          ...
          .addChild(new SpatialSound("Audio3")
            .addChild(new Gain()
              .addChild(new Analyser()
                .addChild(new BiquadFilter().setFrequency(1000.0).setQualityFactor(0.0).setType("")

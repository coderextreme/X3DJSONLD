...
public class CoordinateAxes
{
  ...
  .setHead(new headObject()
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE        ).setContent("CoordinateAxis.x3d"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER   ).setContent("https://coderextreme.net/X3DJSONLD/CoordinateAxis.x3d"))
          ...
          .addChild(new BillboardObject()
            .addChild(new ShapeObject()
              ...
              .setGeometry(new TextObject().setString(new MFStringObject("\"Y\""))
                .setFontStyle(new FontStyleObject("LABEL_FONT").setJustify(FontStyleObject.JUSTIFY_MIDDLE_MIDDLE).setFamily(new MFStringObject("\"SANS\"")).setSize(.2f)))))))

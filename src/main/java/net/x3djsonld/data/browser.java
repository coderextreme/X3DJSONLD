...
"}" + "\n")));
    ...
    {
        X3DObject thisExampleX3dObject = new browser().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"browser\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");

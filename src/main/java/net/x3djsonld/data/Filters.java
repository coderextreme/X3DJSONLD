...
public class Filters
{
  ...
  .setScene(new Scene()
    ...
    .addChild(new StreamAudioDestination().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setHtmlID("AudioDestination")
      .addChild(new DynamicsCompressor().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setHtmlID("DynamicsCompressor")
        .addChild(new Gain().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS").setHtmlID("Gain4")

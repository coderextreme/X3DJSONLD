      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Group()
          .addChild(new Transform("transform")
            ...
            .addChild(new Transform().setTranslation(1.0f,0.0f,0.0f)
              .addChild(new Shape()
...
"            </field>"}))
    ...
    public static void main(String args[])
    {
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"force\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");

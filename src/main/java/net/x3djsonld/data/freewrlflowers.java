...
public class freewrlflowers
{
  ...
  .setHead(new headObject()
    .addMeta(new metaObject().setName(metaObject.NAME_TITLE      ).setContent("freewrlflowers.x3d"))
    ...
    .addMeta(new metaObject().setName(metaObject.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/freewrlflowers.x3d")))
  .setScene(new SceneObject()
        ...
        .setProtoBody(new ProtoBodyObject()
          .addChild(new GroupObject()
            .addChild(new ProtoInstanceObject("FlowerProto")
              .addFieldValue(new fieldValueObject().setName("vertex").setValue(new String[] {"../shaders/freewrl_flowers_chromatic.vs"}))
              .addFieldValue(new fieldValueObject().setName("fragment").setValue(new String[] {"../shaders/freewrl.fs"}))))))
    ...
    {
        X3DObject thisExampleX3dObject = new freewrlflowers().getX3dModel();
		...
		if      (argumentsLoadNewModel)
			System.out.println("WARNING: \"freewrlflowers\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");

...
public class X3dHeaderPrototypeSyntaxExamples
{
  ...
  public String validateSelf()
  {
    ...
    {
		X3dHeaderPrototypeSyntaxExamples testObject = new X3dHeaderPrototypeSyntaxExamples();
		System.out.println ("X3dHeaderPrototypeSyntaxExamples execution self-validation test results: " + testObject.validateSelf());
	}
}

...
public class indexedfaceset_pixeltexture_entire
{
  ...
  public String validateSelf()
  {
    ...
    {
		indexedfaceset_pixeltexture_entire testObject = new indexedfaceset_pixeltexture_entire();
		System.out.println ("indexedfaceset_pixeltexture_entire execution self-validation test results: " + testObject.validateSelf());
	}
}

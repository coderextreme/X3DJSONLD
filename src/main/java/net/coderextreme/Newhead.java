...
public class Newhead extends org.web3d.x3d.jsail.Core.head {
	private ArrayList<component> componentList = null;
	public ArrayList<component> getComponentList() { componentList = super.getComponentList(); return componentList; }
	public ArrayList<component> removeSelectedComponentList(ArrayList<component> children, HashSet toRemove) { componentList.removeAll(toRemove); return super.getComponentList(); }
	public head setComponentList(ArrayList<component> leftOver) { componentList = leftOver; super.setComponentList(leftOver); return this; }
	private ArrayList<meta> metaList = null;
	public ArrayList<meta> getMetaList() { metaList = super.getMetaList(); return metaList; }
	public ArrayList<meta> removeSelectedMetaList(ArrayList<meta> children, HashSet toRemove) { metaList.removeAll(toRemove); return super.getMetaList(); }
	public head setMetaList(ArrayList<meta> leftOver) { metaList = leftOver; super.setMetaList(leftOver); return this; }
	private ArrayList<unit> unitList = null;
	public ArrayList<unit> getUnitList() { unitList = super.getUnitList(); return unitList; }
	public ArrayList<unit> removeSelectedUnitList(ArrayList<unit> children, HashSet toRemove) { unitList.removeAll(toRemove); return super.getUnitList(); }
	public head setUnitList(ArrayList<unit> leftOver) { unitList = leftOver; super.setUnitList(leftOver); return this; }
	public void removeAll(HashSet toRemove) {
		componentList.removeAll(toRemove);
		metaList.removeAll(toRemove);

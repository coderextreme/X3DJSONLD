...
public class NewCADLayer extends org.web3d.x3d.jsail.CADGeometry.CADLayer {
	...
	public CADLayer setChildren(X3DNode[] leftOver) { children = leftOver; super.setChildren(leftOver); return this; }

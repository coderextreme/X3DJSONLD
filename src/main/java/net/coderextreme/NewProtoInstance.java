...
public class NewProtoInstance extends org.web3d.x3d.jsail.Core.ProtoInstance {
	private ArrayList<fieldValue> fieldValueList = null;
	public ArrayList<fieldValue> getFieldValueList() { fieldValueList = super.getFieldValueList(); return fieldValueList; }
	public ArrayList<fieldValue> removeSelectedFieldValueList(ArrayList<fieldValue> children, HashSet toRemove) { fieldValueList.removeAll(toRemove); return super.getFieldValueList(); }
	public ProtoInstance setFieldValueList(ArrayList<fieldValue> leftOver) { fieldValueList = leftOver; super.setFieldValueList(leftOver); return this; }
	public void removeAll(HashSet toRemove) {
		fieldValueList.removeAll(toRemove);
	}
}

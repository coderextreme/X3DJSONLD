...
public class NewCADAssembly extends org.web3d.x3d.jsail.CADGeometry.CADAssembly {
	...
	public CADAssembly setChildren(X3DNode[] leftOver) { children = leftOver; super.setChildren(leftOver); return this; }

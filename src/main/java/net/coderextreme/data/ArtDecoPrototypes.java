  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Anchor().setDescription("ArtDecoPrototypeExample").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString0().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})

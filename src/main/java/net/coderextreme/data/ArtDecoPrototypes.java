...
public class ArtDecoPrototypes {
  public static void main(String[] args) {
    ...
    new ArtDecoPrototypes().initialize().toFileJSON("../data/ArtDecoPrototypes.new.json");
    }
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new ProtoDeclareObject().setName("ArtDeco01").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.254777f).setDiffuseColor(new float[] {0.685208f,0.134679f,0.332385f}).setShininess(0.071429f).setSpecularColor(new float[] {0.122449f,0.050035f,0.050035f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco02").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          ...
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(1f).setDiffuseColor(new float[] {0.536861f,0.0529f,0.245479f}).setShininess(0.832432f).setSpecularColor(new float[] {0.805292f,0.765198f,0.747416f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco03").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.248649f).setDiffuseColor(new float[] {1f,0.452381f,0.40339f}).setShininess(0.902703f).setSpecularColor(new float[] {0.686486f,0.396903f,0.419275f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco04").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.25f).setDiffuseColor(new float[] {0.748016f,0.298362f,0.342624f}).setShininess(0.69697f).setSpecularColor(new float[] {0.345455f,0.345455f,0.345455f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco05").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.24359f).setDiffuseColor(new float[] {0.945455f,0.318988f,0.321717f}).setShininess(0.018182f).setSpecularColor(new float[] {0.072727f,0.021705f,0.010732f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco06").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.25946f).setDiffuseColor(new float[] {0.228655f,0.195513f,0.425484f}).setShininess(0.542553f).setSpecularColor(new float[] {0.324504f,0.404255f,0.404255f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco07").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.333333f).setDiffuseColor(new float[] {0.200348f,0.100857f,0.320833f}).setShininess(0.133333f).setSpecularColor(new float[] {0.311358f,0.387879f,0.387879f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco08").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.242424f).setDiffuseColor(new float[] {0.330519f,0.3389f,0.6f}).setShininess(0.787879f).setSpecularColor(new float[] {0.290909f,0.290909f,0.290909f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco09").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.333333f).setDiffuseColor(new float[] {0.237059f,0.096273f,0.215625f}).setShininess(0.133333f).setSpecularColor(new float[] {0.311358f,0.387879f,0.387879f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco10").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.242425f).setDiffuseColor(new float[] {0.304f,0.09025f,0.207364f}).setShininess(0.072727f).setSpecularColor(new float[] {0.6665f,0.579046f,0.830303f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco11").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.258928f).setDiffuseColor(new float[] {0.335631f,0.207672f,0.238304f}).setEmissiveColor(new float[] {0.010638f,0.010638f,0.010638f}).setShininess(0.021277f).setSpecularColor(new float[] {0.198631f,0.075403f,0.138803f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco12").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.240838f).setDiffuseColor(new float[] {0.876873f,0.14715f,0.00856f}).setShininess(0.076531f).setSpecularColor(new float[] {0.193878f,0.029416f,0.029416f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco13").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.25f).setDiffuseColor(new float[] {0.794445f,0.249425f,0f}).setShininess(0.551515f).setSpecularColor(new float[] {0.62904f,0.194211f,0.033663f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco14").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.25f).setDiffuseColor(new float[] {0.510609f,0.17264f,0.059872f}).setShininess(0.933333f).setSpecularColor(new float[] {0.533333f,0.533333f,0.533333f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco15").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.255814f).setDiffuseColor(new float[] {0.914894f,0.444404f,0.348914f}).setShininess(0.12766f).setSpecularColor(new float[] {0.345745f,0.143066f,0f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco16").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.240838f).setDiffuseColor(new float[] {0.876873f,0.323147f,0.199564f}).setShininess(0.80102f).setSpecularColor(new float[] {0.816327f,0.278677f,0.278677f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco17").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.242424f).setDiffuseColor(new float[] {0.515625f,0.315496f,0.252441f}).setShininess(0.933333f).setSpecularColor(new float[] {0.533333f,0.533333f,0.533333f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco18").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.264706f).setDiffuseColor(new float[] {0f,0.346939f,0.253624f}).setShininess(0.316327f).setSpecularColor(new float[] {0f,0.311074f,0.357143f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco19").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.259259f).setDiffuseColor(new float[] {0f,0.251004f,0.239248f}).setShininess(0.060606f).setSpecularColor(new float[] {0.177935f,0.249369f,0.229278f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco20").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.24f).setDiffuseColor(new float[] {0.228298f,0.385771f,0.186794f}).setShininess(0.393939f).setSpecularColor(new float[] {0.200464f,0.300145f,0.293518f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco21").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.25f).setDiffuseColor(new float[] {0.315389f,0.544f,0.258052f}).setShininess(0.509389f).setSpecularColor(new float[] {0.456f,0.456f,0.456f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco22").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.246032f).setDiffuseColor(new float[] {0.251104f,0.312562f,0.201724f}).setShininess(0.086735f).setSpecularColor(new float[] {0.209184f,0.113842f,0.111328f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco23").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.242424f).setDiffuseColor(new float[] {0.392348f,0.456f,0.417708f}).setShininess(0.933333f).setSpecularColor(new float[] {0.533333f,0.533333f,0.533333f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco24").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.253968f).setDiffuseColor(new float[] {1f,0.854922f,0f}).setShininess(1f).setSpecularColor(new float[] {0.872449f,0.247119f,0.254214f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco25").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.25641f).setDiffuseColor(new float[] {0.795918f,0.505869f,0.093315f}).setShininess(0.397959f).setSpecularColor(new float[] {0.923469f,0.428866f,0.006369f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco26").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          ...
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(1f).setDiffuseColor(new float[] {0.331633f,0.296582f,0.279057f}).setShininess(0.096939f).setSpecularColor(new float[] {0.311224f,0.25183f,0.133042f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco27").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.263158f).setDiffuseColor(new float[] {0.345455f,0.163262f,0.122622f}).setShininess(0.048649f).setSpecularColor(new float[] {0.212121f,0.107475f,0f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco28").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.240506f).setDiffuseColor(new float[] {0.277281f,0.104336f,0.0799f}).setShininess(0.09697f).setSpecularColor(new float[] {0.305587f,0.141916f,0.270572f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco29").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.215686f).setDiffuseColor(new float[] {0.087034f,0.025888f,0f}).setShininess(0.045918f).setSpecularColor(new float[] {0.224138f,0.104091f,0.104091f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco30").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0f).setDiffuseColor(new float[] {0f,0f,0f}).setShininess(0.081633f).setSpecularColor(new float[] {0.293243f,0.297387f,0.290421f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco31").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.25641f).setDiffuseColor(new float[] {0.236364f,0.236364f,0.236364f}).setShininess(0.054546f).setSpecularColor(new float[] {0.29697f,0.245839f,0.295962f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco32").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.242424f).setDiffuseColor(new float[] {0.38087f,0.382957f,0.417708f}).setShininess(0.933333f).setSpecularColor(new float[] {0.533333f,0.533333f,0.533333f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco33").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.230089f).setDiffuseColor(new float[] {0.610811f,0.610811f,0.610811f}).setShininess(0.897297f).setSpecularColor(new float[] {0.767568f,0.756757f,0.764964f}))))
        .addChild(new ProtoDeclareObject().setName("ArtDeco34").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials")
          .setProtoBody(new ProtoBodyObject()
            .addChild(new MaterialObject().setAmbientIntensity(0.25f).setShininess(0f).setSpecularColor(new float[] {0.2f,0.2f,0.2f}))))
        .addChild(new AnchorObject().setDescription("ArtDecoPrototypeExample").setParameter(new MFStringObject(new MFString0().getArray())).setUrl(new MFStringObject(new MFString1().getArray()))
          .addChild(new ShapeObject()
            ...
            .setGeometry(new TextObject().setString(new MFStringObject(new MFString2().getArray()))
              .setFontStyle(new FontStyleObject().setJustify(new MFStringObject(new MFString3().getArray())).setSize(0.8f))))))      ;
    return X3D0;
    }
...
protected class MFString1 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"../data/ArtDecoExamples.json","../data/ArtDecoExamples.x3d","ArtDecoExamples.json","ArtDecoExamples.x3d"});
  }
}
protected class MFString2 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"ArtDecoExamples.x3d","is a Materials Prototype declaration file.","","For an example scene using these node,","click this text and view","ArtDecoExamples.x3d"});
  }
}

...
ProtoInstance ProtoInstance4 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("LogoGeometryTransform").setTranslation(new float[] {0f,1.5f,0f})
          .addChild(new Anchor("LogoGeometryTransform").setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(new MFString1().getArray())
            .addChild(new Shape().setDEF("BoxShape")
              .setAppearance(new Appearance("BoxShape")
              ...
              .setGeometry(new Box("BoxShape").setDEF("test-NMTOKEN_regex.0123456789").setCssClass("untextured")))))
        .addChild(new Shape().setDEF("LineShape")
          .setAppearance(new Appearance("LineShape")
            .setMaterial(new Material().setEmissiveColor(new float[] {0.6f,0.19607843f,0.8f})))
          .setGeometry(new IndexedLineSet("LineShape").setCoordIndex(new MFInt323().getArray())
        ...
        .addChild(new Transform().setDEF("TextTransform").setTranslation(new float[] {0f,-1.5f,0f})
          .addChild(new Shape("TextTransform")
          ...
          .addChild(new Collision("TextTransform")
            ...
            .setProxy(new Shape().setDEF("ProxyShape")
              ...
              .setGeometry(new Text("ProxyShape").setString(new MFString11().getArray()))))
        ...
        .addChild(new Group().setDEF("BackgroundGroup")
          .addChild(new Background("BackgroundGroup").setDEF("GradualBackground"))
          .addChild(new Script("BackgroundGroup").setDEF("colorTypeConversionScript")
            .addField(new field("colorTypeConversionScript").setType("SFColor").setName("colorInput").setAccessType(field.ACCESSTYPE_INPUTONLY))
            .addField(new field("colorTypeConversionScript").setType("MFColor").setName("colorsOutput").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
...
"}"))
          .addChild(new ColorInterpolator("BackgroundGroup").setDEF("ColorAnimator").setKey(new MFFloat14().getArray()).setKeyValue(new MFColor15().getArray())
            .addComments("AZURE to INDIGO and back again"))
          .addChild(new TimeSensor("BackgroundGroup").setDEF("ColorClock").setCycleInterval(60d).setLoop(true))
          .addChild(new ROUTE("BackgroundGroup").setFromField("colorsOutput").setFromNode("colorTypeConversionScript").setToField("skyColor").setToNode("GradualBackground"))
          .addChild(new ROUTE("BackgroundGroup").setFromField("value_changed").setFromNode("ColorAnimator").setToField("colorInput").setToNode("colorTypeConversionScript"))
          .addChild(new ROUTE("BackgroundGroup").setFromField("fraction_changed").setFromNode("ColorClock").setToField("set_fraction").setToNode("ColorAnimator")))
        ...
        .addChild(new Shape().setDEF("TestShape1")
          .setAppearance(new Appearance("TestShape1").setDEF("TestAppearance1")
            .addComments("ArtDeco01Material prototype goes here... TODO ensure setContainerField is handled in exported Java")
            .setMaterial(ProtoInstance0 = new ProtoInstance("TestAppearance1").setName("ArtDeco01Material")
              .addComments("[HelloWorldProgram diagnostic] ArtDeco01ProtoInstance.getNodeType()=\"Material\"")))
          .setGeometry(new Sphere("TestShape1").setRadius(0.001f)))
        .addChild(new Shape().setDEF("TestShape2")
          .setAppearance(new Appearance("TestShape2").setDEF("TestAppearance2")
            .addComments("ArtDeco02Material prototype goes here... TODO ensure setContainerField is handled in exported Java")
            .setMaterial(ProtoInstance1 = new ProtoInstance("TestAppearance2").setName("ArtDeco02Material").setDEF("ArtDeco02MaterialDEF")
          ...
          .setGeometry(new Cone("TestShape2").setBottomRadius(0.001f).setHeight(0.001f)))
        .addChild(new Shape().setDEF("TestShape3")
          .setAppearance(new Appearance("TestShape3").setDEF("TestAppearance3")
            ...
            .setMaterial(ProtoInstance2 = new ProtoInstance("TestAppearance3").setUSE("ArtDeco02MaterialDEF")))
          .setGeometry(new Cylinder("TestShape3").setHeight(0.001f).setRadius(0.001f)))
        ...
        .addChild(new ProtoDeclare().setName("MaterialModulator").setAppinfo("mimic a Material node and modulate fields as an animation effect").setDocumentation("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html")
          ...
          .setProtoBody(new ProtoBody()
            ...
            .addChild(new Script().setDEF("MaterialModulatorScript")
              .addField(new field("MaterialModulatorScript").setType("SFBool").setName("enabled").setAccessType(field.ACCESSTYPE_INPUTOUTPUT))
              .addField(new field("MaterialModulatorScript").setType("SFColor").setName("diffuseColor").setAccessType(field.ACCESSTYPE_INPUTOUTPUT))
              .addField(new field("MaterialModulatorScript").setType("SFColor").setName("newColor").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .addField(new field("MaterialModulatorScript").setType("SFTime").setName("clockTrigger").setAccessType(field.ACCESSTYPE_INPUTONLY))
              .setIS(new IS("MaterialModulatorScript")
                .addConnect(new connect().setNodeField("enabled").setProtoField("enabled"))
                .addConnect(new connect().setNodeField("diffuseColor").setProtoField("diffuseColor")))
              .setSourceCode("ecmascript:\n"+
"function initialize ()\n"+
...
"}"))))
        ...
        .addChild(new Group().setDEF("DeclarativeGroupExample")
          .addChild(new Shape("DeclarativeGroupExample")
            ...
            .setAppearance(new Appearance().setDEF("DeclarativeAppearanceExample")
              ...
              .setMaterial(ProtoInstance3 = new ProtoInstance("DeclarativeAppearanceExample").setName("MaterialModulator").setDEF("MyMaterialModulator")))
        ...
        .addChild(new Shape().setDEF("ExtrusionShape")
          ...
          .setAppearance(new Appearance("ExtrusionShape").setDEF("TransparentAppearance")
            .setMaterial(new Material("TransparentAppearance").setTransparency(1f)))
          .setGeometry(new Extrusion("ExtrusionShape").setDEF("ExampleExtrusion")))
        .addChild(new Group()
        ...
        .addChild(new Shape()
          .setAppearance(new Appearance()
            ...
            .addShaders(new ProgramShader().setDEF("TestShader1")
              .addPrograms(new ShaderProgram("TestShader1").setType("VERTEX").setDEF("TestShader2")))
            ...
            .addShaders(new ComposedShader().setDEF("TestShader4")
              .addParts(new ShaderPart("TestShader4").setType("VERTEX").setDEF("TestShader5")))))
        .addChild(new Transform().setDEF("SpecialtyNodes")
          .addChild(new CADLayer("SpecialtyNodes")
            .addChild(new CADAssembly()
              .addChild(new CADPart()
                .addChild(new CADFace()))))
          .addChild(new EspduTransform("SpecialtyNodes"))
          .addChild(new ReceiverPdu("SpecialtyNodes"))
          .addChild(new SignalPdu("SpecialtyNodes"))
          .addChild(new TransmitterPdu("SpecialtyNodes"))
          .addChild(new DISEntityManager("SpecialtyNodes")
...
ProtoInstance1
              .addFieldValue(new fieldValue("ArtDeco02MaterialDEF").setName("description").setValue("ArtDeco02Material can substitute for another Material node"));
    return X3D0;
    }

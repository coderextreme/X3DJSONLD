...
public class LOA0ExampleSourceInVRML {
  public static void main(String[] args) {
    ...
    new LOA0ExampleSourceInVRML().initialize().toFileJSON("../data/LOA0ExampleSourceInVRML.new.json");
    }

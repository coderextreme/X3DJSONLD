    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("MultipleHumanoids")
          ...
          .addChild(new HAnimHumanoid("MultipleHumanoids").setDEF("a_SimpleSkeleton").setName("SimpleSkeleton")
          ...
          .addChild(new HAnimHumanoid("MultipleHumanoids").setDEF("b_SimpleSkeletonMesh").setName("SimpleSkeletonMesh")
          ...
          .addChild(new HAnimHumanoid("MultipleHumanoids").setDEF("c_SkinIndexedGeometry").setName("SkinIndexedGeometry")
            .addSkeleton(new HAnimJoint("c_SkinIndexedGeometry").setName("humanoid_root")
              .addChild(new HAnimSegment().setName("sacrum")))
            .addSkin(new IndexedFaceSet().setDEF("SkinMeshIFS")))
          .addChild(new HAnimHumanoid("MultipleHumanoids").setDEF("d_SkinShapeIndexedGeometry").setName("SkinShapeIndexedGeometry")
          ...
          .addChild(new HAnimHumanoid("MultipleHumanoids").setDEF("e_SkinSwitchShapeIndexedGeometry").setName("SkinSwitchShapeIndexedGeometry")
          ...
          .addChild(new HAnimHumanoid("MultipleHumanoids").setDEF("f_SynthesizedSkinShapeIndexedTwoPartGeometry").setName("SynthesizedSkinShapeIndexedTwoPartGeometry")
          ...
          .addChild(new HAnimHumanoid("MultipleHumanoids").setDEF("g_ApparelSkinIndexedGeometryMultipleShapes").setName("ApparelSkinIndexedGeometryMultipleShapes")
            .addSkeleton(new HAnimJoint("g_ApparelSkinIndexedGeometryMultipleShapes").setName("humanoid_root")
              .addChild(new HAnimSegment().setName("sacrum")))
            .addSkin(new Shape()))
          .addChild(new HAnimHumanoid("MultipleHumanoids").setDEF("h_AnatomySkinIndexedGeometryMultipleShapes").setName("AnatomySkinIndexedGeometryMultipleShapes")

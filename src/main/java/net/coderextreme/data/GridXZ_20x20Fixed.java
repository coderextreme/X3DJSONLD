    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("GridLocation")
          .addChild(new Group("GridLocation")
            .addChild(new Shape().setDEF("LinesAlignedAlongZ")
              .setGeometry(new IndexedLineSet("LinesAlignedAlongZ").setColorIndex(new MFInt320().getArray()).setColorPerVertex(false).setCoordIndex(new MFInt321().getArray())
            ...
            .addChild(new Transform().setDEF("LinesAlignedAlongX").setRotation(new float[] {0f,1f,0f,1.57079f})
              .addChild(new Shape("LinesAlignedAlongX").setUSE("LinesAlignedAlongZ")))
              ...
              .addChild(new Billboard()
                .addChild(new Shape()
                  .setGeometry(new Text().setDEF("CenterTextNode").setString(new MFString4().getArray())
                    .setFontStyle(new FontStyle("CenterTextNode").setDEF("FS4").setJustify(new MFString5().getArray()).setSize(0.4f)))
                  .setAppearance(new Appearance().setDEF("DefaultAppearance")
                    .setMaterial(new Material("DefaultAppearance"))))))

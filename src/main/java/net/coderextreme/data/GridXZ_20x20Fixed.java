  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("GridLocation").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Group().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setDEF("LinesAlignedAlongZ").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new IndexedLineSet().setColorIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt320().getArray())).setColorPerVertex(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt321().getArray()))
                .setCoord(new Coordinate().setDEF("EndPoints").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f2().getArray())))
                .setColor(new Color().setColor(new org.web3d.x3d.jsail.fields.MFColor(new MFColor3().getArray())))))
            .addChild(new Transform().setDEF("LinesAlignedAlongX").setRotation(new float[] {0f,1f,0f,1.57079f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setUSE("LinesAlignedAlongZ")))
            .addChild(new Transform().setTranslation(new float[] {0f,-0.5f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Billboard().setAxisOfRotation(new float[] {0f,1f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setGeometry(new Text().setDEF("CenterTextNode").setString(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray()))
                    .setFontStyle(new FontStyle().setDEF("FS4").setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray())).setSize(0.4f)))
                  .setAppearance(new Appearance().setDEF("DefaultAppearance")
                    .setMaterial(new Material())))))
            .addChild(new Transform().setTranslation(new float[] {10f,-0.5f,10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Billboard().setAxisOfRotation(new float[] {0f,1f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .addChild(new Transform().setTranslation(new float[] {-10f,-0.5f,10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Billboard().setAxisOfRotation(new float[] {0f,1f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray()))
                    .setFontStyle(new FontStyle().setUSE("FS4")))
                  .setAppearance(new Appearance().setUSE("DefaultAppearance")))))
            .addChild(new Transform().setTranslation(new float[] {-10f,-0.5f,-10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Billboard().setAxisOfRotation(new float[] {0f,1f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})

...
public class fwparticleflowers implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new fwparticleflowers().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/fwparticleflowers.new.java.x3d");
    model.toFileJSON("../data/fwparticleflowers.new.java.x3dj");
    }
        ...
        .addChild(new Transform()
          .addChild(new ParticleSystem().setMaxParticles(20).setGeometryType(new SFString("GEOMETRY"))
            ...
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setDEF(new SFString("fw")).setLanguage(new SFString("GLSL"))
...
"			}"))
          ...
          .addChild(new ROUTE().setFromNode(new SFString("Animate")).setFromField(new SFString("a")).setToNode(new SFString("fw")).setToField(new SFString("a")))
          .addChild(new ROUTE().setFromNode(new SFString("Animate")).setFromField(new SFString("b")).setToNode(new SFString("fw")).setToField(new SFString("b")))
          .addChild(new ROUTE().setFromNode(new SFString("Animate")).setFromField(new SFString("c")).setToNode(new SFString("fw")).setToField(new SFString("c")))
          .addChild(new ROUTE().setFromNode(new SFString("Animate")).setFromField(new SFString("d")).setToNode(new SFString("fw")).setToField(new SFString("d")))
          .addChild(new ROUTE().setFromNode(new SFString("Animate")).setFromField(new SFString("pdelta")).setToNode(new SFString("fw")).setToField(new SFString("pdelta")))
          .addChild(new ROUTE().setFromNode(new SFString("Animate")).setFromField(new SFString("tdelta")).setToNode(new SFString("fw")).setToField(new SFString("tdelta")))));
    return X3D0;
    }

...
public class LOA3ExampleSourceWithDiamonds {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    new LOA3ExampleSourceWithDiamonds().initialize().toFileJSON("../data/LOA3ExampleSourceWithDiamonds.new.json");
    }
...
ProtoInstance ProtoInstance534 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("source").setContent("LOA3ExampleSourceWithDiamonds.wrl")))
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("JointCenters_WorldInfo")
          .addChild(new WorldInfo().setTitle("HANIM 200x Default Joint Centers, LOA&#8209;3").setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray()))))

    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("JinLOA4").setDEF("hanim_JinLOA4").setLoa(4).setVersion("2.0")
          ...
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_JinLOA4").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new double[] {0,1.0242089721,-0.015921}).setUlimit(new MFFloat6().getArray()).setLlimit(new MFFloat7().getArray()).setContainerFieldOverride("skeleton"))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new double[] {0,0.876897,-0.015921}).setUlimit(new MFFloat13().getArray()).setLlimit(new MFFloat14().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_hip").setDEF("hanim_l_hip").setCenter(new double[] {0.09465749999999999,1.0250460557999999,-0.01834875}).setUlimit(new MFFloat19().getArray()).setLlimit(new MFFloat20().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new double[] {0.09260999999999998,0.506943,-0.01943775}).setUlimit(new MFFloat25().getArray()).setLlimit(new MFFloat26().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new double[] {0.08882999999999999,0.11835180000000001,-0.01045125}).setUlimit(new MFFloat31().getArray()).setLlimit(new MFFloat32().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocalcaneonavicular").setDEF("hanim_l_talocalcaneonavicular").setCenter(new double[] {0.0783,0.045756,0.0048645}).setUlimit(new MFFloat37().getArray()).setLlimit(new MFFloat38().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_1").setDEF("hanim_l_cuneonavicular_1").setCenter(new double[] {0.06736500000000001,0.0398133,0.018391499999999998}).setUlimit(new MFFloat43().getArray()).setLlimit(new MFFloat44().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setName("l_tarsometatarsal_1").setDEF("hanim_l_tarsometatarsal_1").setCenter(new double[] {0.06462,0.028820699999999998,0.04419}).setUlimit(new MFFloat49().getArray()).setLlimit(new MFFloat50().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setName("l_metatarsophalangeal_1").setDEF("hanim_l_metatarsophalangeal_1").setCenter(new double[] {0.0621225,0.01788669,0.09362249999999998}).setUlimit(new MFFloat55().getArray()).setLlimit(new MFFloat56().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setName("l_tarsal_distal_interphalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_1").setCenter(new double[] {0.0621225,0.01504926,0.1153125}).setUlimit(new MFFloat61().getArray()).setLlimit(new MFFloat62().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_2").setDEF("hanim_l_cuneonavicular_2").setCenter(new double[] {0.0814275,0.041571000000000004,0.02142675}).setUlimit(new MFFloat67().getArray()).setLlimit(new MFFloat68().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setName("l_tarsometatarsal_2").setDEF("hanim_l_tarsometatarsal_2").setCenter(new double[] {0.08019,0.032364,0.041062499999999995}).setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new double[] {0.08253,0.01857024,0.09782999999999999}).setUlimit(new MFFloat79().getArray()).setLlimit(new MFFloat80().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setCenter(new double[] {0.0843075,0.015682590000000003,0.1140075}).setUlimit(new MFFloat85().getArray()).setLlimit(new MFFloat86().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setCenter(new double[] {0.0843075,0.012183929999999999,0.12343499999999999}).setUlimit(new MFFloat91().getArray()).setLlimit(new MFFloat92().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_3").setDEF("hanim_l_cuneonavicular_3").setCenter(new double[] {0.09296999999999998,0.0414036,0.019818}).setUlimit(new MFFloat97().getArray()).setLlimit(new MFFloat98().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setName("l_tarsometatarsal_3").setDEF("hanim_l_tarsometatarsal_3").setCenter(new double[] {0.09459,0.032364,0.039397499999999995}).setUlimit(new MFFloat103().getArray()).setLlimit(new MFFloat104().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setName("l_metatarsophalangeal_3").setDEF("hanim_l_metatarsophalangeal_3").setCenter(new double[] {0.09648,0.018670680000000002,0.0954225}).setUlimit(new MFFloat109().getArray()).setLlimit(new MFFloat110().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setName("l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setCenter(new double[] {0.098865,0.014784210000000002,0.110475}).setUlimit(new MFFloat115().getArray()).setLlimit(new MFFloat116().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setCenter(new double[] {0.10041749999999999,0.012183929999999999,0.1197}).setUlimit(new MFFloat121().getArray()).setLlimit(new MFFloat122().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_calcaneocuboid").setDEF("hanim_l_calcaneocuboid").setCenter(new double[] {0.0891,0.0718983,-0.025965}).setUlimit(new MFFloat127().getArray()).setLlimit(new MFFloat128().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setName("l_transversetarsal").setDEF("hanim_l_transversetarsal").setCenter(new double[] {0.1106325,0.04374720000000001,0.002089125}).setUlimit(new MFFloat133().getArray()).setLlimit(new MFFloat134().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_4").setDEF("hanim_l_tarsometatarsal_4").setCenter(new double[] {0.10649249999999999,0.0304389,0.03843}).setUlimit(new MFFloat139().getArray()).setLlimit(new MFFloat140().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setName("l_metatarsophalangeal_4").setDEF("hanim_l_metatarsophalangeal_4").setCenter(new double[] {0.10986749999999999,0.017797410000000003,0.09116999999999999}).setUlimit(new MFFloat145().getArray()).setLlimit(new MFFloat146().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setName("l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setCenter(new double[] {0.11416499999999999,0.015183180000000001,0.10631249999999999}).setUlimit(new MFFloat151().getArray()).setLlimit(new MFFloat152().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setCenter(new double[] {0.1156725,0.01161756,0.11369249999999999}).setUlimit(new MFFloat157().getArray()).setLlimit(new MFFloat158().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_5").setDEF("hanim_l_tarsometatarsal_5").setCenter(new double[] {0.120825,0.02597211,0.03474}).setUlimit(new MFFloat163().getArray()).setLlimit(new MFFloat164().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setName("l_metatarsophalangeal_5").setDEF("hanim_l_metatarsophalangeal_5").setCenter(new double[] {0.124065,0.01695204,0.0865575}).setUlimit(new MFFloat169().getArray()).setLlimit(new MFFloat170().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setName("l_tarsal_proximal_interphalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_5").setCenter(new double[] {0.1263825,0.01346175,0.09414}).setUlimit(new MFFloat175().getArray()).setLlimit(new MFFloat176().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setCenter(new double[] {0.1272825,0.01061874,0.10187999999999998}).setUlimit(new MFFloat181().getArray()).setLlimit(new MFFloat182().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new double[] {-0.09465749999999999,1.0250460557999999,-0.01834875}).setUlimit(new MFFloat187().getArray()).setLlimit(new MFFloat188().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new double[] {-0.09260999999999998,0.506943,-0.01943775}).setUlimit(new MFFloat193().getArray()).setLlimit(new MFFloat194().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new double[] {-0.0884475,0.11835180000000001,-0.01045125}).setUlimit(new MFFloat199().getArray()).setLlimit(new MFFloat200().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_talocalcaneonavicular").setDEF("hanim_r_talocalcaneonavicular").setCenter(new double[] {-0.07794,0.045756,0.0048645}).setUlimit(new MFFloat205().getArray()).setLlimit(new MFFloat206().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_1").setDEF("hanim_r_cuneonavicular_1").setCenter(new double[] {-0.0669825,0.0398133,0.018391499999999998}).setUlimit(new MFFloat211().getArray()).setLlimit(new MFFloat212().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_1").setName("r_tarsometatarsal_1").setDEF("hanim_r_tarsometatarsal_1").setCenter(new double[] {-0.06426,0.028820699999999998,0.04419}).setUlimit(new MFFloat217().getArray()).setLlimit(new MFFloat218().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_1").setName("r_metatarsophalangeal_1").setDEF("hanim_r_metatarsophalangeal_1").setCenter(new double[] {-0.0617625,0.01788669,0.09362249999999998}).setUlimit(new MFFloat223().getArray()).setLlimit(new MFFloat224().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_1").setName("r_tarsal_distal_interphalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_1").setCenter(new double[] {-0.06174,0.01504926,0.1153125}).setUlimit(new MFFloat229().getArray()).setLlimit(new MFFloat230().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_2").setDEF("hanim_r_cuneonavicular_2").setCenter(new double[] {-0.08104499999999999,0.041571000000000004,0.02142675}).setUlimit(new MFFloat235().getArray()).setLlimit(new MFFloat236().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_2").setName("r_tarsometatarsal_2").setDEF("hanim_r_tarsometatarsal_2").setCenter(new double[] {-0.07983,0.032364,0.041062499999999995}).setUlimit(new MFFloat241().getArray()).setLlimit(new MFFloat242().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new double[] {-0.0821475,0.01857024,0.09782999999999999}).setUlimit(new MFFloat247().getArray()).setLlimit(new MFFloat248().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setCenter(new double[] {-0.083925,0.015682590000000003,0.1140075}).setUlimit(new MFFloat253().getArray()).setLlimit(new MFFloat254().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setCenter(new double[] {-0.083925,0.012183929999999999,0.12343499999999999}).setUlimit(new MFFloat259().getArray()).setLlimit(new MFFloat260().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_3").setDEF("hanim_r_cuneonavicular_3").setCenter(new double[] {-0.09260999999999998,0.0414036,0.019818}).setUlimit(new MFFloat265().getArray()).setLlimit(new MFFloat266().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_3").setName("r_tarsometatarsal_3").setDEF("hanim_r_tarsometatarsal_3").setCenter(new double[] {-0.09423,0.032364,0.039397499999999995}).setUlimit(new MFFloat271().getArray()).setLlimit(new MFFloat272().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_3").setName("r_metatarsophalangeal_3").setDEF("hanim_r_metatarsophalangeal_3").setCenter(new double[] {-0.09609749999999999,0.018670680000000002,0.0954225}).setUlimit(new MFFloat277().getArray()).setLlimit(new MFFloat278().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_3").setName("r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setCenter(new double[] {-0.098505,0.014784210000000002,0.110475}).setUlimit(new MFFloat283().getArray()).setLlimit(new MFFloat284().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_3").setName("r_tarsal_distal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setCenter(new double[] {-0.10003499999999999,0.012183929999999999,0.1197}).setUlimit(new MFFloat289().getArray()).setLlimit(new MFFloat290().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_calcaneocuboid").setDEF("hanim_r_calcaneocuboid").setCenter(new double[] {-0.0887175,0.0718983,-0.025965}).setUlimit(new MFFloat295().getArray()).setLlimit(new MFFloat296().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_calcaneocuboid").setName("r_transversetarsal").setDEF("hanim_r_transversetarsal").setCenter(new double[] {-0.1102725,0.04374720000000001,0.002089125}).setUlimit(new MFFloat301().getArray()).setLlimit(new MFFloat302().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName("r_tarsometatarsal_4").setDEF("hanim_r_tarsometatarsal_4").setCenter(new double[] {-0.10613249999999999,0.0304389,0.03843}).setUlimit(new MFFloat307().getArray()).setLlimit(new MFFloat308().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_4").setName("r_metatarsophalangeal_4").setDEF("hanim_r_metatarsophalangeal_4").setCenter(new double[] {-0.1095075,0.017797410000000003,0.09116999999999999}).setUlimit(new MFFloat313().getArray()).setLlimit(new MFFloat314().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_4").setName("r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setCenter(new double[] {-0.11378250000000001,0.015183180000000001,0.10631249999999999}).setUlimit(new MFFloat319().getArray()).setLlimit(new MFFloat320().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_4").setName("r_tarsal_distal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setCenter(new double[] {-0.1153125,0.01161756,0.11369249999999999}).setUlimit(new MFFloat325().getArray()).setLlimit(new MFFloat326().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName("r_tarsometatarsal_5").setDEF("hanim_r_tarsometatarsal_5").setCenter(new double[] {-0.1204425,0.02597211,0.03474}).setUlimit(new MFFloat331().getArray()).setLlimit(new MFFloat332().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_5").setName("r_metatarsophalangeal_5").setDEF("hanim_r_metatarsophalangeal_5").setCenter(new double[] {-0.12368249999999999,0.01695204,0.0865575}).setUlimit(new MFFloat337().getArray()).setLlimit(new MFFloat338().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_5").setName("r_tarsal_proximal_interphalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_5").setCenter(new double[] {-0.126,0.01346175,0.09414}).setUlimit(new MFFloat343().getArray()).setLlimit(new MFFloat344().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_5").setName("r_tarsal_distal_interphalangeal_5").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setCenter(new double[] {-0.1269225,0.01061874,0.10187999999999998}).setUlimit(new MFFloat349().getArray()).setLlimit(new MFFloat350().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("vl5").setDEF("hanim_vl5").setCenter(new double[] {0,1.1475270279,-0.01376325}).setUlimit(new MFFloat355().getArray()).setLlimit(new MFFloat356().getArray())
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("vl4").setDEF("hanim_vl4").setCenter(new double[] {0,1.1776589721000001,-0.01376325}).setUlimit(new MFFloat361().getArray()).setLlimit(new MFFloat362().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_vl4").setName("vl3").setDEF("hanim_vl3").setCenter(new double[] {0,1.1977470000000001,-0.01376325}).setUlimit(new MFFloat367().getArray()).setLlimit(new MFFloat368().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_vl3").setName("vl2").setDEF("hanim_vl2").setCenter(new double[] {0,1.218114,-0.01376325}).setUlimit(new MFFloat373().getArray()).setLlimit(new MFFloat374().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_vl2").setName("vl1").setDEF("hanim_vl1").setCenter(new double[] {0,1.239597,-0.01376325}).setUlimit(new MFFloat379().getArray()).setLlimit(new MFFloat380().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_vl1").setName("vt12").setDEF("hanim_vt12").setCenter(new double[] {0,1.2686130279,-0.01376325}).setUlimit(new MFFloat385().getArray()).setLlimit(new MFFloat386().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_vt12").setName("vt11").setDEF("hanim_vt11").setCenter(new double[] {0,1.297908,-0.01376325}).setUlimit(new MFFloat391().getArray()).setLlimit(new MFFloat392().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_vt11").setName("vt10").setDEF("hanim_vt10").setCenter(new double[] {0,1.3191119721,-0.01378575}).setUlimit(new MFFloat397().getArray()).setLlimit(new MFFloat398().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_vt10").setName("vt9").setDEF("hanim_vt9").setCenter(new double[] {0,1.337247,-0.01376325}).setUlimit(new MFFloat403().getArray()).setLlimit(new MFFloat404().getArray())
                                ...
                                .addChild(new HAnimJoint("hanim_vt9").setName("vt8").setDEF("hanim_vt8").setCenter(new double[] {0,1.3553820558,-0.01376325}).setUlimit(new MFFloat409().getArray()).setLlimit(new MFFloat410().getArray())
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt8").setName("vt7").setDEF("hanim_vt7").setCenter(new double[] {0,1.3749119721,-0.01376325}).setUlimit(new MFFloat415().getArray()).setLlimit(new MFFloat416().getArray())
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt7").setName("vt6").setDEF("hanim_vt6").setCenter(new double[] {0,1.3908149442,-0.01376325}).setUlimit(new MFFloat421().getArray()).setLlimit(new MFFloat422().getArray())
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt6").setName("vt5").setDEF("hanim_vt5").setCenter(new double[] {0,1.4100660279,-0.01376325}).setUlimit(new MFFloat427().getArray()).setLlimit(new MFFloat428().getArray())
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt5").setName("vt4").setDEF("hanim_vt4").setCenter(new double[] {0,1.4290380279000001,-0.01376325}).setUlimit(new MFFloat433().getArray()).setLlimit(new MFFloat434().getArray())
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setName("vt3").setDEF("hanim_vt3").setCenter(new double[] {0,1.4519160279,-0.01376325}).setUlimit(new MFFloat439().getArray()).setLlimit(new MFFloat440().getArray())
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setName("vt2").setDEF("hanim_vt2").setCenter(new double[] {0,1.4826059721000002,-0.01378575}).setUlimit(new MFFloat445().getArray()).setLlimit(new MFFloat446().getArray())
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setName("vt1").setDEF("hanim_vt1").setCenter(new double[] {0,1.5121800279000002,-0.01376325}).setUlimit(new MFFloat451().getArray()).setLlimit(new MFFloat452().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName("vc7").setDEF("hanim_vc7").setCenter(new double[] {0,1.5442649442,-0.015063749999999999}).setUlimit(new MFFloat457().getArray()).setLlimit(new MFFloat458().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc7").setName("vc6").setDEF("hanim_vc6").setCenter(new double[] {0,1.5593309721000002,-0.015063749999999999}).setUlimit(new MFFloat463().getArray()).setLlimit(new MFFloat464().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc6").setName("vc5").setDEF("hanim_vc5").setCenter(new double[] {0,1.5746759721,-0.015063749999999999}).setUlimit(new MFFloat469().getArray()).setLlimit(new MFFloat470().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc5").setName("vc4").setDEF("hanim_vc4").setCenter(new double[] {0,1.5900210558,-0.015063749999999999}).setUlimit(new MFFloat475().getArray()).setLlimit(new MFFloat476().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_vc4").setName("vc3").setDEF("hanim_vc3").setCenter(new double[] {0,1.6059240279,-0.015063749999999999}).setUlimit(new MFFloat481().getArray()).setLlimit(new MFFloat482().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_vc3").setName("vc2").setDEF("hanim_vc2").setCenter(new double[] {0,1.6204320558,-0.015063749999999999}).setUlimit(new MFFloat487().getArray()).setLlimit(new MFFloat488().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_vc2").setName("vc1").setDEF("hanim_vc1").setCenter(new double[] {0,1.6349399442,-0.015063749999999999}).setUlimit(new MFFloat493().getArray()).setLlimit(new MFFloat494().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_vc1").setName("skullbase").setDEF("hanim_skullbase").setCenter(new double[] {0,1.6276860000000002,-0.01544175}).setUlimit(new MFFloat499().getArray()).setLlimit(new MFFloat500().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyelid_joint").setDEF("hanim_l_eyelid_joint").setCenter(new double[] {0.0505125,1.7660699721000002,0.03294}).setUlimit(new MFFloat511().getArray()).setLlimit(new MFFloat512().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyelid_joint").setDEF("hanim_r_eyelid_joint").setCenter(new double[] {-0.0505125,1.7660699721000002,0.03294}).setUlimit(new MFFloat517().getArray()).setLlimit(new MFFloat518().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyeball_joint").setDEF("hanim_l_eyeball_joint").setCenter(new double[] {0.0481275,1.7420759721,0.0830475}).setUlimit(new MFFloat523().getArray()).setLlimit(new MFFloat524().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyeball_joint").setDEF("hanim_r_eyeball_joint").setCenter(new double[] {-0.0481275,1.7420759721,0.0830475}).setUlimit(new MFFloat529().getArray()).setLlimit(new MFFloat530().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyebrow_joint").setDEF("hanim_l_eyebrow_joint").setCenter(new double[] {0.0217485,1.7532360000000002,0.1069425}).setUlimit(new MFFloat535().getArray()).setLlimit(new MFFloat536().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyebrow_joint").setDEF("hanim_r_eyebrow_joint").setCenter(new double[] {-0.0217485,1.7532360000000002,0.1069425}).setUlimit(new MFFloat541().getArray()).setLlimit(new MFFloat542().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("temporomandibular").setDEF("hanim_temporomandibular").setCenter(new double[] {0,1.6279649442000002,0.01537875}).setUlimit(new MFFloat547().getArray()).setLlimit(new MFFloat548().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName("l_acromioclavicular").setDEF("hanim_l_acromioclavicular").setCenter(new double[] {0.038474999999999995,1.4987880279,-0.01378575}).setUlimit(new MFFloat553().getArray()).setLlimit(new MFFloat554().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName("l_sternoclavicular").setDEF("hanim_l_sternoclavicular").setCenter(new double[] {0.12294000000000001,1.4778630279000002,-0.012897}).setUlimit(new MFFloat559().getArray()).setLlimit(new MFFloat560().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new double[] {0.16506,1.4614020279,-0.003267}).setUlimit(new MFFloat565().getArray()).setLlimit(new MFFloat566().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new double[] {0.1820925,1.1517119721,-0.005629499999999999}).setUlimit(new MFFloat571().getArray()).setLlimit(new MFFloat572().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new double[] {0.181935,0.8981009721000001,-0.00502425}).setUlimit(new MFFloat577().getArray()).setLlimit(new MFFloat578().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_1").setDEF("hanim_l_midcarpal_1").setCenter(new double[] {0.1812825,0.8755019721,0.019327499999999997}).setUlimit(new MFFloat583().getArray()).setLlimit(new MFFloat584().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_1").setName("l_carpometacarpal_1").setDEF("hanim_l_carpometacarpal_1").setCenter(new double[] {0.180495,0.8587620279,0.0259875}).setUlimit(new MFFloat589().getArray()).setLlimit(new MFFloat590().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setName("l_metacarpophalangeal_1").setDEF("hanim_l_metacarpophalangeal_1").setCenter(new double[] {0.18103499999999997,0.83421,0.035775}).setUlimit(new MFFloat595().getArray()).setLlimit(new MFFloat596().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setName("l_carpal_interphalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setCenter(new double[] {0.182655,0.811053,0.04965749999999999}).setUlimit(new MFFloat601().getArray()).setLlimit(new MFFloat602().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_2").setDEF("hanim_l_midcarpal_2").setCenter(new double[] {0.1812825,0.8766180000000001,0.00841725}).setUlimit(new MFFloat607().getArray()).setLlimit(new MFFloat608().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_2").setName("l_carpometacarpal_2").setDEF("hanim_l_carpometacarpal_2").setCenter(new double[] {0.1812825,0.8526239721000001,0.009729}).setUlimit(new MFFloat613().getArray()).setLlimit(new MFFloat614().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setName("l_metacarpophalangeal_2").setDEF("hanim_l_metacarpophalangeal_2").setCenter(new double[] {0.183735,0.790128,0.015075}).setUlimit(new MFFloat619().getArray()).setLlimit(new MFFloat620().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setName("l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setCenter(new double[] {0.18171,0.7524629721,0.014183999999999999}).setUlimit(new MFFloat625().getArray()).setLlimit(new MFFloat626().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setCenter(new double[] {0.18067499999999997,0.721215,0.01338525}).setUlimit(new MFFloat631().getArray()).setLlimit(new MFFloat632().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_3").setDEF("hanim_l_midcarpal_3").setCenter(new double[] {0.18108,0.878571,-0.004797}).setUlimit(new MFFloat637().getArray()).setLlimit(new MFFloat638().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_3").setName("l_carpometacarpal_3").setDEF("hanim_l_carpometacarpal_3").setCenter(new double[] {0.18108,0.850392,-0.00625275}).setUlimit(new MFFloat643().getArray()).setLlimit(new MFFloat644().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setName("l_metacarpophalangeal_3").setDEF("hanim_l_metacarpophalangeal_3").setCenter(new double[] {0.18369,0.7873379721000001,-0.00391725}).setUlimit(new MFFloat649().getArray()).setLlimit(new MFFloat650().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setName("l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setCenter(new double[] {0.18171,0.7479989721000001,-0.003537}).setUlimit(new MFFloat655().getArray()).setLlimit(new MFFloat656().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setCenter(new double[] {0.18067499999999997,0.713403,-0.0037597499999999996}).setUlimit(new MFFloat661().getArray()).setLlimit(new MFFloat662().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_4_5").setDEF("hanim_l_midcarpal_4_5").setCenter(new double[] {0.18108,0.8752230279,-0.025739999999999996}).setUlimit(new MFFloat667().getArray()).setLlimit(new MFFloat668().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_4_5").setName("l_carpometacarpal_4").setDEF("hanim_l_carpometacarpal_4").setCenter(new double[] {0.18108,0.85095,-0.01991925}).setUlimit(new MFFloat673().getArray()).setLlimit(new MFFloat674().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setName("l_metacarpophalangeal_4").setDEF("hanim_l_metacarpophalangeal_4").setCenter(new double[] {0.18369,0.786222,-0.021440249999999998}).setUlimit(new MFFloat679().getArray()).setLlimit(new MFFloat680().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setName("l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setCenter(new double[] {0.18171,0.7521839721,-0.020645999999999998}).setUlimit(new MFFloat685().getArray()).setLlimit(new MFFloat686().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setCenter(new double[] {0.18067499999999997,0.7200989721000001,-0.0197775}).setUlimit(new MFFloat691().getArray()).setLlimit(new MFFloat692().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_carpometacarpal_5").setDEF("hanim_l_carpometacarpal_5").setCenter(new double[] {0.1816425,0.853461,-0.0327825}).setUlimit(new MFFloat697().getArray()).setLlimit(new MFFloat698().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setName("l_metacarpophalangeal_5").setDEF("hanim_l_metacarpophalangeal_5").setCenter(new double[] {0.18333,0.7912440279,-0.0370575}).setUlimit(new MFFloat703().getArray()).setLlimit(new MFFloat704().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setName("l_carpal_proximal_interphalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_5").setCenter(new double[] {0.181665,0.7700400000000001,-0.0371475}).setUlimit(new MFFloat709().getArray()).setLlimit(new MFFloat710().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_5").setName("l_carpal_distal_interphalangeal_5").setDEF("hanim_l_carpal_distal_interphalangeal_5").setCenter(new double[] {0.18080999999999997,0.7468830000000001,-0.0369675}).setUlimit(new MFFloat715().getArray()).setLlimit(new MFFloat716().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName("r_acromioclavicular").setDEF("hanim_r_acromioclavicular").setCenter(new double[] {-0.038474999999999995,1.4987880279,-0.01378575}).setUlimit(new MFFloat721().getArray()).setLlimit(new MFFloat722().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_acromioclavicular").setName("r_sternoclavicular").setDEF("hanim_r_sternoclavicular").setCenter(new double[] {-0.12294000000000001,1.4778630279000002,-0.012897}).setUlimit(new MFFloat727().getArray()).setLlimit(new MFFloat728().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new double[] {-0.1647,1.4614020279,-0.003267}).setUlimit(new MFFloat733().getArray()).setLlimit(new MFFloat734().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new double[] {-0.1817325,1.1517119721,-0.005629499999999999}).setUlimit(new MFFloat739().getArray()).setLlimit(new MFFloat740().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new double[] {-0.181575,0.8981009721000001,-0.005022}).setUlimit(new MFFloat745().getArray()).setLlimit(new MFFloat746().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_1").setDEF("hanim_r_midcarpal_1").setCenter(new double[] {-0.18096749999999998,0.8755019721,0.019327499999999997}).setUlimit(new MFFloat751().getArray()).setLlimit(new MFFloat752().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_1").setName("r_carpometacarpal_1").setDEF("hanim_r_carpometacarpal_1").setCenter(new double[] {-0.180135,0.8587620279,0.0259875}).setUlimit(new MFFloat757().getArray()).setLlimit(new MFFloat758().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setName("r_metacarpophalangeal_1").setDEF("hanim_r_metacarpophalangeal_1").setCenter(new double[] {-0.1806525,0.83421,0.035775}).setUlimit(new MFFloat763().getArray()).setLlimit(new MFFloat764().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setName("r_carpal_interphalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setCenter(new double[] {-0.1822725,0.811053,0.04965749999999999}).setUlimit(new MFFloat769().getArray()).setLlimit(new MFFloat770().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_2").setDEF("hanim_r_midcarpal_2").setCenter(new double[] {-0.18096749999999998,0.8766180000000001,0.00841725}).setUlimit(new MFFloat775().getArray()).setLlimit(new MFFloat776().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_2").setName("r_carpometacarpal_2").setDEF("hanim_r_carpometacarpal_2").setCenter(new double[] {-0.18089999999999998,0.8526239721000001,0.009729}).setUlimit(new MFFloat781().getArray()).setLlimit(new MFFloat782().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setName("r_metacarpophalangeal_2").setDEF("hanim_r_metacarpophalangeal_2").setCenter(new double[] {-0.18335249999999997,0.790128,0.015075}).setUlimit(new MFFloat787().getArray()).setLlimit(new MFFloat788().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setCenter(new double[] {-0.18132749999999997,0.7524629721,0.014183999999999999}).setUlimit(new MFFloat793().getArray()).setLlimit(new MFFloat794().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setCenter(new double[] {-0.1802925,0.721215,0.01338525}).setUlimit(new MFFloat799().getArray()).setLlimit(new MFFloat800().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_3").setDEF("hanim_r_midcarpal_3").setCenter(new double[] {-0.18072,0.878571,-0.004797}).setUlimit(new MFFloat805().getArray()).setLlimit(new MFFloat806().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_3").setName("r_carpometacarpal_3").setDEF("hanim_r_carpometacarpal_3").setCenter(new double[] {-0.18072,0.850392,-0.00625275}).setUlimit(new MFFloat811().getArray()).setLlimit(new MFFloat812().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setName("r_metacarpophalangeal_3").setDEF("hanim_r_metacarpophalangeal_3").setCenter(new double[] {-0.1833075,0.7873379721000001,-0.00391725}).setUlimit(new MFFloat817().getArray()).setLlimit(new MFFloat818().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setCenter(new double[] {-0.18132749999999997,0.7479989721000001,-0.003537}).setUlimit(new MFFloat823().getArray()).setLlimit(new MFFloat824().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setCenter(new double[] {-0.1802925,0.713403,-0.0037597499999999996}).setUlimit(new MFFloat829().getArray()).setLlimit(new MFFloat830().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_4_5").setDEF("hanim_r_midcarpal_4_5").setCenter(new double[] {-0.18072,0.8752230279,-0.025739999999999996}).setUlimit(new MFFloat835().getArray()).setLlimit(new MFFloat836().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_4_5").setName("r_carpometacarpal_4").setDEF("hanim_r_carpometacarpal_4").setCenter(new double[] {-0.18072,0.85095,-0.01991925}).setUlimit(new MFFloat841().getArray()).setLlimit(new MFFloat842().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setName("r_metacarpophalangeal_4").setDEF("hanim_r_metacarpophalangeal_4").setCenter(new double[] {-0.1833075,0.786222,-0.021440249999999998}).setUlimit(new MFFloat847().getArray()).setLlimit(new MFFloat848().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setCenter(new double[] {-0.18132749999999997,0.7521839721,-0.020645999999999998}).setUlimit(new MFFloat853().getArray()).setLlimit(new MFFloat854().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setCenter(new double[] {-0.1802925,0.7200989721000001,-0.0197775}).setUlimit(new MFFloat859().getArray()).setLlimit(new MFFloat860().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_carpometacarpal_5").setDEF("hanim_r_carpometacarpal_5").setCenter(new double[] {-0.18125999999999998,0.853461,-0.0327825}).setUlimit(new MFFloat865().getArray()).setLlimit(new MFFloat866().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setName("r_metacarpophalangeal_5").setDEF("hanim_r_metacarpophalangeal_5").setCenter(new double[] {-0.18297,0.7912440279,-0.0370575}).setUlimit(new MFFloat871().getArray()).setLlimit(new MFFloat872().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_5").setCenter(new double[] {-0.181305,0.7700400000000001,-0.0371475}).setUlimit(new MFFloat877().getArray()).setLlimit(new MFFloat878().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setDEF("hanim_r_carpal_distal_interphalangeal_5").setCenter(new double[] {-0.18044999999999997,0.7468830000000001,-0.0369675}).setUlimit(new MFFloat883().getArray()).setLlimit(new MFFloat884().getArray())

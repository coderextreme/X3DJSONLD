    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_JinLOA4").setVersion("2.0").setName("JinLOA4").setLoa(4)
          ...
          .addSkeleton(new HAnimJoint("hanim_JinLOA4").setDEF("hanim_humanoid_root").setName("humanoid_root").setCenter(new float[] {0f,1.024209f,-0.015921f}).setLlimit(new MFFloat2().getArray()).setUlimit(new MFFloat3().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f,0.876897f,-0.015921f}).setLlimit(new MFFloat9().getArray()).setUlimit(new MFFloat10().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_l_hip").setName("l_hip").setCenter(new float[] {0.0946575f,1.025046f,-0.01834875f}).setLlimit(new MFFloat15().getArray()).setUlimit(new MFFloat16().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setDEF("hanim_l_knee").setName("l_knee").setCenter(new float[] {0.09261f,0.506943f,-0.01943775f}).setLlimit(new MFFloat21().getArray()).setUlimit(new MFFloat22().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setDEF("hanim_l_talocrural").setName("l_talocrural").setCenter(new float[] {0.08883f,0.1183518f,-0.01045125f}).setLlimit(new MFFloat27().getArray()).setUlimit(new MFFloat28().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_talocalcaneonavicular").setName("l_talocalcaneonavicular").setCenter(new float[] {0.0783f,0.045756f,0.0048645f}).setLlimit(new MFFloat33().getArray()).setUlimit(new MFFloat34().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_1").setName("l_cuneonavicular_1").setCenter(new float[] {0.067365f,0.0398133f,0.0183915f}).setLlimit(new MFFloat39().getArray()).setUlimit(new MFFloat40().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setDEF("hanim_l_tarsometatarsal_1").setName("l_tarsometatarsal_1").setCenter(new float[] {0.06462f,0.0288207f,0.04419f}).setLlimit(new MFFloat45().getArray()).setUlimit(new MFFloat46().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setDEF("hanim_l_metatarsophalangeal_1").setName("l_metatarsophalangeal_1").setCenter(new float[] {0.0621225f,0.01788669f,0.0936225f}).setLlimit(new MFFloat51().getArray()).setUlimit(new MFFloat52().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_1").setName("l_tarsal_distal_interphalangeal_1").setCenter(new float[] {0.0621225f,0.01504926f,0.1153125f}).setLlimit(new MFFloat57().getArray()).setUlimit(new MFFloat58().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_2").setName("l_cuneonavicular_2").setCenter(new float[] {0.0814275f,0.041571f,0.02142675f}).setLlimit(new MFFloat63().getArray()).setUlimit(new MFFloat64().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setDEF("hanim_l_tarsometatarsal_2").setName("l_tarsometatarsal_2").setCenter(new float[] {0.08019f,0.032364f,0.0410625f}).setLlimit(new MFFloat69().getArray()).setUlimit(new MFFloat70().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setDEF("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(new float[] {0.08253f,0.01857024f,0.09783f}).setLlimit(new MFFloat75().getArray()).setUlimit(new MFFloat76().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_1").setName("l_tarsal_proximal_interphalangeal_2").setCenter(new float[] {0.0843075f,0.01568259f,0.1140075f}).setLlimit(new MFFloat81().getArray()).setUlimit(new MFFloat82().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setCenter(new float[] {0.0843075f,0.01218393f,0.123435f}).setLlimit(new MFFloat87().getArray()).setUlimit(new MFFloat88().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_3").setName("l_cuneonavicular_3").setCenter(new float[] {0.09297f,0.0414036f,0.019818f}).setLlimit(new MFFloat93().getArray()).setUlimit(new MFFloat94().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setDEF("hanim_l_tarsometatarsal_3").setName("l_tarsometatarsal_3").setCenter(new float[] {0.09459f,0.032364f,0.0393975f}).setLlimit(new MFFloat99().getArray()).setUlimit(new MFFloat100().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setDEF("hanim_l_metatarsophalangeal_3").setName("l_metatarsophalangeal_3").setCenter(new float[] {0.09648f,0.01867068f,0.0954225f}).setLlimit(new MFFloat105().getArray()).setUlimit(new MFFloat106().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_proximal_interphalangeal_3").setCenter(new float[] {0.098865f,0.01478421f,0.110475f}).setLlimit(new MFFloat111().getArray()).setUlimit(new MFFloat112().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setCenter(new float[] {0.1004175f,0.01218393f,0.1197f}).setLlimit(new MFFloat117().getArray()).setUlimit(new MFFloat118().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_calcaneocuboid").setName("l_calcaneocuboid").setCenter(new float[] {0.0891f,0.0718983f,-0.025965f}).setLlimit(new MFFloat123().getArray()).setUlimit(new MFFloat124().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setDEF("hanim_l_transversetarsal").setName("l_transversetarsal").setCenter(new float[] {0.1106325f,0.0437472f,0.002089125f}).setLlimit(new MFFloat129().getArray()).setUlimit(new MFFloat130().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_4").setName("l_tarsometatarsal_4").setCenter(new float[] {0.1064925f,0.0304389f,0.03843f}).setLlimit(new MFFloat135().getArray()).setUlimit(new MFFloat136().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setDEF("hanim_l_metatarsophalangeal_4").setName("l_metatarsophalangeal_4").setCenter(new float[] {0.1098675f,0.01779741f,0.09117f}).setLlimit(new MFFloat141().getArray()).setUlimit(new MFFloat142().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_proximal_interphalangeal_4").setCenter(new float[] {0.114165f,0.01518318f,0.1063125f}).setLlimit(new MFFloat147().getArray()).setUlimit(new MFFloat148().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setCenter(new float[] {0.1156725f,0.01161756f,0.1136925f}).setLlimit(new MFFloat153().getArray()).setUlimit(new MFFloat154().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_5").setName("l_tarsometatarsal_5").setCenter(new float[] {0.120825f,0.02597211f,0.03474f}).setLlimit(new MFFloat159().getArray()).setUlimit(new MFFloat160().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setDEF("hanim_l_metatarsophalangeal_5").setName("l_metatarsophalangeal_5").setCenter(new float[] {0.124065f,0.01695204f,0.0865575f}).setLlimit(new MFFloat165().getArray()).setUlimit(new MFFloat166().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_proximal_interphalangeal_5").setCenter(new float[] {0.1263825f,0.01346175f,0.09414f}).setLlimit(new MFFloat171().getArray()).setUlimit(new MFFloat172().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setCenter(new float[] {0.1272825f,0.01061874f,0.10188f}).setLlimit(new MFFloat177().getArray()).setUlimit(new MFFloat178().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-0.0946575f,1.025046f,-0.01834875f}).setLlimit(new MFFloat183().getArray()).setUlimit(new MFFloat184().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-0.09261f,0.506943f,-0.01943775f}).setLlimit(new MFFloat189().getArray()).setUlimit(new MFFloat190().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_talocrural").setName("r_talocrural").setCenter(new float[] {-0.0884475f,0.1183518f,-0.01045125f}).setLlimit(new MFFloat195().getArray()).setUlimit(new MFFloat196().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_talocalcaneonavicular").setName("r_talocalcaneonavicular").setCenter(new float[] {-0.07794f,0.045756f,0.0048645f}).setLlimit(new MFFloat201().getArray()).setUlimit(new MFFloat202().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_1").setName("r_cuneonavicular_1").setCenter(new float[] {-0.0669825f,0.0398133f,0.0183915f}).setLlimit(new MFFloat207().getArray()).setUlimit(new MFFloat208().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_1").setDEF("hanim_r_tarsometatarsal_1").setName("r_tarsometatarsal_1").setCenter(new float[] {-0.06426f,0.0288207f,0.04419f}).setLlimit(new MFFloat213().getArray()).setUlimit(new MFFloat214().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_1").setDEF("hanim_r_metatarsophalangeal_1").setName("r_metatarsophalangeal_1").setCenter(new float[] {-0.0617625f,0.01788669f,0.0936225f}).setLlimit(new MFFloat219().getArray()).setUlimit(new MFFloat220().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_1").setName("r_tarsal_distal_interphalangeal_1").setCenter(new float[] {-0.06174f,0.01504926f,0.1153125f}).setLlimit(new MFFloat225().getArray()).setUlimit(new MFFloat226().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_2").setName("r_cuneonavicular_2").setCenter(new float[] {-0.081045f,0.041571f,0.02142675f}).setLlimit(new MFFloat231().getArray()).setUlimit(new MFFloat232().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_2").setDEF("hanim_r_tarsometatarsal_2").setName("r_tarsometatarsal_2").setCenter(new float[] {-0.07983f,0.032364f,0.0410625f}).setLlimit(new MFFloat237().getArray()).setUlimit(new MFFloat238().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setDEF("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(new float[] {-0.0821475f,0.01857024f,0.09783f}).setLlimit(new MFFloat243().getArray()).setUlimit(new MFFloat244().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_1").setName("r_tarsal_proximal_interphalangeal_2").setCenter(new float[] {-0.083925f,0.01568259f,0.1140075f}).setLlimit(new MFFloat249().getArray()).setUlimit(new MFFloat250().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setCenter(new float[] {-0.083925f,0.01218393f,0.123435f}).setLlimit(new MFFloat255().getArray()).setUlimit(new MFFloat256().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_3").setName("r_cuneonavicular_3").setCenter(new float[] {-0.09261f,0.0414036f,0.019818f}).setLlimit(new MFFloat261().getArray()).setUlimit(new MFFloat262().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_3").setDEF("hanim_r_tarsometatarsal_3").setName("r_tarsometatarsal_3").setCenter(new float[] {-0.09423f,0.032364f,0.0393975f}).setLlimit(new MFFloat267().getArray()).setUlimit(new MFFloat268().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_3").setDEF("hanim_r_metatarsophalangeal_3").setName("r_metatarsophalangeal_3").setCenter(new float[] {-0.0960975f,0.01867068f,0.0954225f}).setLlimit(new MFFloat273().getArray()).setUlimit(new MFFloat274().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setName("r_tarsal_proximal_interphalangeal_3").setCenter(new float[] {-0.098505f,0.01478421f,0.110475f}).setLlimit(new MFFloat279().getArray()).setUlimit(new MFFloat280().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setName("r_tarsal_distal_interphalangeal_3").setCenter(new float[] {-0.100035f,0.01218393f,0.1197f}).setLlimit(new MFFloat285().getArray()).setUlimit(new MFFloat286().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_calcaneocuboid").setName("r_calcaneocuboid").setCenter(new float[] {-0.0887175f,0.0718983f,-0.025965f}).setLlimit(new MFFloat291().getArray()).setUlimit(new MFFloat292().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_calcaneocuboid").setDEF("hanim_r_transversetarsal").setName("r_transversetarsal").setCenter(new float[] {-0.1102725f,0.0437472f,0.002089125f}).setLlimit(new MFFloat297().getArray()).setUlimit(new MFFloat298().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setDEF("hanim_r_tarsometatarsal_4").setName("r_tarsometatarsal_4").setCenter(new float[] {-0.1061325f,0.0304389f,0.03843f}).setLlimit(new MFFloat303().getArray()).setUlimit(new MFFloat304().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_4").setDEF("hanim_r_metatarsophalangeal_4").setName("r_metatarsophalangeal_4").setCenter(new float[] {-0.1095075f,0.01779741f,0.09117f}).setLlimit(new MFFloat309().getArray()).setUlimit(new MFFloat310().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setName("r_tarsal_proximal_interphalangeal_4").setCenter(new float[] {-0.1137825f,0.01518318f,0.1063125f}).setLlimit(new MFFloat315().getArray()).setUlimit(new MFFloat316().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setName("r_tarsal_distal_interphalangeal_4").setCenter(new float[] {-0.1153125f,0.01161756f,0.1136925f}).setLlimit(new MFFloat321().getArray()).setUlimit(new MFFloat322().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setDEF("hanim_r_tarsometatarsal_5").setName("r_tarsometatarsal_5").setCenter(new float[] {-0.1204425f,0.02597211f,0.03474f}).setLlimit(new MFFloat327().getArray()).setUlimit(new MFFloat328().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_5").setDEF("hanim_r_metatarsophalangeal_5").setName("r_metatarsophalangeal_5").setCenter(new float[] {-0.1236825f,0.01695204f,0.0865575f}).setLlimit(new MFFloat333().getArray()).setUlimit(new MFFloat334().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setName("r_tarsal_proximal_interphalangeal_5").setCenter(new float[] {-0.126f,0.01346175f,0.09414f}).setLlimit(new MFFloat339().getArray()).setUlimit(new MFFloat340().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setName("r_tarsal_distal_interphalangeal_5").setCenter(new float[] {-0.1269225f,0.01061874f,0.10188f}).setLlimit(new MFFloat345().getArray()).setUlimit(new MFFloat346().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_vl5").setName("vl5").setCenter(new float[] {0f,1.147527f,-0.01376325f}).setLlimit(new MFFloat351().getArray()).setUlimit(new MFFloat352().getArray())
                ...
                .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_vl4").setName("vl4").setCenter(new float[] {0f,1.177659f,-0.01376325f}).setLlimit(new MFFloat357().getArray()).setUlimit(new MFFloat358().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_vl4").setDEF("hanim_vl3").setName("vl3").setCenter(new float[] {0f,1.197747f,-0.01376325f}).setLlimit(new MFFloat363().getArray()).setUlimit(new MFFloat364().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_vl3").setDEF("hanim_vl2").setName("vl2").setCenter(new float[] {0f,1.218114f,-0.01376325f}).setLlimit(new MFFloat369().getArray()).setUlimit(new MFFloat370().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_vl2").setDEF("hanim_vl1").setName("vl1").setCenter(new float[] {0f,1.239597f,-0.01376325f}).setLlimit(new MFFloat375().getArray()).setUlimit(new MFFloat376().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_vl1").setDEF("hanim_vt12").setName("vt12").setCenter(new float[] {0f,1.268613f,-0.01376325f}).setLlimit(new MFFloat381().getArray()).setUlimit(new MFFloat382().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_vt12").setDEF("hanim_vt11").setName("vt11").setCenter(new float[] {0f,1.297908f,-0.01376325f}).setLlimit(new MFFloat387().getArray()).setUlimit(new MFFloat388().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_vt11").setDEF("hanim_vt10").setName("vt10").setCenter(new float[] {0f,1.319112f,-0.01378575f}).setLlimit(new MFFloat393().getArray()).setUlimit(new MFFloat394().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_vt10").setDEF("hanim_vt9").setName("vt9").setCenter(new float[] {0f,1.337247f,-0.01376325f}).setLlimit(new MFFloat399().getArray()).setUlimit(new MFFloat400().getArray())
                                ...
                                .addChild(new HAnimJoint("hanim_vt9").setDEF("hanim_vt8").setName("vt8").setCenter(new float[] {0f,1.355382f,-0.01376325f}).setLlimit(new MFFloat405().getArray()).setUlimit(new MFFloat406().getArray())
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt8").setDEF("hanim_vt7").setName("vt7").setCenter(new float[] {0f,1.374912f,-0.01376325f}).setLlimit(new MFFloat411().getArray()).setUlimit(new MFFloat412().getArray())
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt7").setDEF("hanim_vt6").setName("vt6").setCenter(new float[] {0f,1.390815f,-0.01376325f}).setLlimit(new MFFloat417().getArray()).setUlimit(new MFFloat418().getArray())
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt6").setDEF("hanim_vt5").setName("vt5").setCenter(new float[] {0f,1.410066f,-0.01376325f}).setLlimit(new MFFloat423().getArray()).setUlimit(new MFFloat424().getArray())
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt5").setDEF("hanim_vt4").setName("vt4").setCenter(new float[] {0f,1.429038f,-0.01376325f}).setLlimit(new MFFloat429().getArray()).setUlimit(new MFFloat430().getArray())
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setDEF("hanim_vt3").setName("vt3").setCenter(new float[] {0f,1.451916f,-0.01376325f}).setLlimit(new MFFloat435().getArray()).setUlimit(new MFFloat436().getArray())
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setDEF("hanim_vt2").setName("vt2").setCenter(new float[] {0f,1.482606f,-0.01378575f}).setLlimit(new MFFloat441().getArray()).setUlimit(new MFFloat442().getArray())
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setDEF("hanim_vt1").setName("vt1").setCenter(new float[] {0f,1.51218f,-0.01376325f}).setLlimit(new MFFloat447().getArray()).setUlimit(new MFFloat448().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_vc7").setName("vc7").setCenter(new float[] {0f,1.544265f,-0.01506375f}).setLlimit(new MFFloat453().getArray()).setUlimit(new MFFloat454().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc7").setDEF("hanim_vc6").setName("vc6").setCenter(new float[] {0f,1.559331f,-0.01506375f}).setLlimit(new MFFloat459().getArray()).setUlimit(new MFFloat460().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc6").setDEF("hanim_vc5").setName("vc5").setCenter(new float[] {0f,1.574676f,-0.01506375f}).setLlimit(new MFFloat465().getArray()).setUlimit(new MFFloat466().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc5").setDEF("hanim_vc4").setName("vc4").setCenter(new float[] {0f,1.590021f,-0.01506375f}).setLlimit(new MFFloat471().getArray()).setUlimit(new MFFloat472().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_vc4").setDEF("hanim_vc3").setName("vc3").setCenter(new float[] {0f,1.605924f,-0.01506375f}).setLlimit(new MFFloat477().getArray()).setUlimit(new MFFloat478().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_vc3").setDEF("hanim_vc2").setName("vc2").setCenter(new float[] {0f,1.620432f,-0.01506375f}).setLlimit(new MFFloat483().getArray()).setUlimit(new MFFloat484().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_vc2").setDEF("hanim_vc1").setName("vc1").setCenter(new float[] {0f,1.63494f,-0.01506375f}).setLlimit(new MFFloat489().getArray()).setUlimit(new MFFloat490().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_vc1").setDEF("hanim_skullbase").setName("skullbase").setCenter(new float[] {0f,1.627686f,-0.01544175f}).setLlimit(new MFFloat495().getArray()).setUlimit(new MFFloat496().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyelid_joint").setName("l_eyelid_joint").setCenter(new float[] {0.0505125f,1.76607f,0.03294f}).setLlimit(new MFFloat507().getArray()).setUlimit(new MFFloat508().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyelid_joint").setName("r_eyelid_joint").setCenter(new float[] {-0.0505125f,1.76607f,0.03294f}).setLlimit(new MFFloat513().getArray()).setUlimit(new MFFloat514().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyeball_joint").setName("l_eyeball_joint").setCenter(new float[] {0.0481275f,1.742076f,0.0830475f}).setLlimit(new MFFloat519().getArray()).setUlimit(new MFFloat520().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyeball_joint").setName("r_eyeball_joint").setCenter(new float[] {-0.0481275f,1.742076f,0.0830475f}).setLlimit(new MFFloat525().getArray()).setUlimit(new MFFloat526().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyebrow_joint").setName("l_eyebrow_joint").setCenter(new float[] {0.0217485f,1.753236f,0.1069425f}).setLlimit(new MFFloat531().getArray()).setUlimit(new MFFloat532().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyebrow_joint").setName("r_eyebrow_joint").setCenter(new float[] {-0.0217485f,1.753236f,0.1069425f}).setLlimit(new MFFloat537().getArray()).setUlimit(new MFFloat538().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_temporomandibular").setName("temporomandibular").setCenter(new float[] {0f,1.627965f,0.01537875f}).setLlimit(new MFFloat543().getArray()).setUlimit(new MFFloat544().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(new float[] {0.038475f,1.498788f,-0.01378575f}).setLlimit(new MFFloat549().getArray()).setUlimit(new MFFloat550().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_acromioclavicular").setDEF("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(new float[] {0.12294f,1.477863f,-0.012897f}).setLlimit(new MFFloat555().getArray()).setUlimit(new MFFloat556().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_sternoclavicular").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {0.16506f,1.461402f,-0.003267f}).setLlimit(new MFFloat561().getArray()).setUlimit(new MFFloat562().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_l_shoulder").setDEF("hanim_l_elbow").setName("l_elbow").setCenter(new float[] {0.1820925f,1.151712f,-0.0056295f}).setLlimit(new MFFloat567().getArray()).setUlimit(new MFFloat568().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_elbow").setDEF("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(new float[] {0.181935f,0.898101f,-0.00502425f}).setLlimit(new MFFloat573().getArray()).setUlimit(new MFFloat574().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_1").setName("l_midcarpal_1").setCenter(new float[] {0.1812825f,0.875502f,0.0193275f}).setLlimit(new MFFloat579().getArray()).setUlimit(new MFFloat580().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_1").setDEF("hanim_l_carpometacarpal_1").setName("l_carpometacarpal_1").setCenter(new float[] {0.180495f,0.858762f,0.0259875f}).setLlimit(new MFFloat585().getArray()).setUlimit(new MFFloat586().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setDEF("hanim_l_metacarpophalangeal_1").setName("l_metacarpophalangeal_1").setCenter(new float[] {0.181035f,0.83421f,0.035775f}).setLlimit(new MFFloat591().getArray()).setUlimit(new MFFloat592().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setName("l_carpal_interphalangeal_1").setCenter(new float[] {0.182655f,0.811053f,0.0496575f}).setLlimit(new MFFloat597().getArray()).setUlimit(new MFFloat598().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_2").setName("l_midcarpal_2").setCenter(new float[] {0.1812825f,0.876618f,0.00841725f}).setLlimit(new MFFloat603().getArray()).setUlimit(new MFFloat604().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_2").setDEF("hanim_l_carpometacarpal_2").setName("l_carpometacarpal_2").setCenter(new float[] {0.1812825f,0.852624f,0.009729f}).setLlimit(new MFFloat609().getArray()).setUlimit(new MFFloat610().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setDEF("hanim_l_metacarpophalangeal_2").setName("l_metacarpophalangeal_2").setCenter(new float[] {0.183735f,0.790128f,0.015075f}).setLlimit(new MFFloat615().getArray()).setUlimit(new MFFloat616().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_1").setName("l_carpal_proximal_interphalangeal_2").setCenter(new float[] {0.18171f,0.752463f,0.014184f}).setLlimit(new MFFloat621().getArray()).setUlimit(new MFFloat622().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_1").setDEF("hanim_l_carpal_distal_interphalangeal_1").setName("l_carpal_distal_interphalangeal_2").setCenter(new float[] {0.180675f,0.721215f,0.01338525f}).setLlimit(new MFFloat627().getArray()).setUlimit(new MFFloat628().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_3").setName("l_midcarpal_3").setCenter(new float[] {0.18108f,0.878571f,-0.004797f}).setLlimit(new MFFloat633().getArray()).setUlimit(new MFFloat634().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_3").setDEF("hanim_l_carpometacarpal_3").setName("l_carpometacarpal_3").setCenter(new float[] {0.18108f,0.850392f,-0.00625275f}).setLlimit(new MFFloat639().getArray()).setUlimit(new MFFloat640().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setDEF("hanim_l_metacarpophalangeal_3").setName("l_metacarpophalangeal_3").setCenter(new float[] {0.18369f,0.787338f,-0.00391725f}).setLlimit(new MFFloat645().getArray()).setUlimit(new MFFloat646().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_proximal_interphalangeal_3").setCenter(new float[] {0.18171f,0.747999f,-0.003537f}).setLlimit(new MFFloat651().getArray()).setUlimit(new MFFloat652().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_3").setCenter(new float[] {0.180675f,0.713403f,-0.00375975f}).setLlimit(new MFFloat657().getArray()).setUlimit(new MFFloat658().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_4_1").setName("l_midcarpal_4_5").setCenter(new float[] {0.18108f,0.875223f,-0.02574f}).setLlimit(new MFFloat663().getArray()).setUlimit(new MFFloat664().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_4_1").setDEF("hanim_l_carpometacarpal_4").setName("l_carpometacarpal_4").setCenter(new float[] {0.18108f,0.85095f,-0.01991925f}).setLlimit(new MFFloat669().getArray()).setUlimit(new MFFloat670().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setDEF("hanim_l_metacarpophalangeal_4").setName("l_metacarpophalangeal_4").setCenter(new float[] {0.18369f,0.786222f,-0.02144025f}).setLlimit(new MFFloat675().getArray()).setUlimit(new MFFloat676().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_proximal_interphalangeal_4").setCenter(new float[] {0.18171f,0.752184f,-0.020646f}).setLlimit(new MFFloat681().getArray()).setUlimit(new MFFloat682().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_4").setCenter(new float[] {0.180675f,0.720099f,-0.0197775f}).setLlimit(new MFFloat687().getArray()).setUlimit(new MFFloat688().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_carpometacarpal_5").setName("l_carpometacarpal_5").setCenter(new float[] {0.1816425f,0.853461f,-0.0327825f}).setLlimit(new MFFloat693().getArray()).setUlimit(new MFFloat694().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setDEF("hanim_l_metacarpophalangeal_5").setName("l_metacarpophalangeal_5").setCenter(new float[] {0.18333f,0.791244f,-0.0370575f}).setLlimit(new MFFloat699().getArray()).setUlimit(new MFFloat700().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.181665f,0.77004f,-0.0371475f}).setLlimit(new MFFloat705().getArray()).setUlimit(new MFFloat706().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_5").setCenter(new float[] {0.18081f,0.746883f,-0.0369675f}).setLlimit(new MFFloat711().getArray()).setUlimit(new MFFloat712().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-0.038475f,1.498788f,-0.01378575f}).setLlimit(new MFFloat717().getArray()).setUlimit(new MFFloat718().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_acromioclavicular").setDEF("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-0.12294f,1.477863f,-0.012897f}).setLlimit(new MFFloat723().getArray()).setUlimit(new MFFloat724().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_sternoclavicular").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-0.1647f,1.461402f,-0.003267f}).setLlimit(new MFFloat729().getArray()).setUlimit(new MFFloat730().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_shoulder").setDEF("hanim_r_elbow").setName("r_elbow").setCenter(new float[] {-0.1817325f,1.151712f,-0.0056295f}).setLlimit(new MFFloat735().getArray()).setUlimit(new MFFloat736().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_elbow").setDEF("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(new float[] {-0.181575f,0.898101f,-0.005022f}).setLlimit(new MFFloat741().getArray()).setUlimit(new MFFloat742().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_1").setName("r_midcarpal_1").setCenter(new float[] {-0.1809675f,0.875502f,0.0193275f}).setLlimit(new MFFloat747().getArray()).setUlimit(new MFFloat748().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_1").setDEF("hanim_r_carpometacarpal_1").setName("r_carpometacarpal_1").setCenter(new float[] {-0.180135f,0.858762f,0.0259875f}).setLlimit(new MFFloat753().getArray()).setUlimit(new MFFloat754().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setDEF("hanim_r_metacarpophalangeal_1").setName("r_metacarpophalangeal_1").setCenter(new float[] {-0.1806525f,0.83421f,0.035775f}).setLlimit(new MFFloat759().getArray()).setUlimit(new MFFloat760().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setName("r_carpal_interphalangeal_1").setCenter(new float[] {-0.1822725f,0.811053f,0.0496575f}).setLlimit(new MFFloat765().getArray()).setUlimit(new MFFloat766().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_2").setName("r_midcarpal_2").setCenter(new float[] {-0.1809675f,0.876618f,0.00841725f}).setLlimit(new MFFloat771().getArray()).setUlimit(new MFFloat772().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_2").setDEF("hanim_r_carpometacarpal_2").setName("r_carpometacarpal_2").setCenter(new float[] {-0.1809f,0.852624f,0.009729f}).setLlimit(new MFFloat777().getArray()).setUlimit(new MFFloat778().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setDEF("hanim_r_metacarpophalangeal_2").setName("r_metacarpophalangeal_2").setCenter(new float[] {-0.1833525f,0.790128f,0.015075f}).setLlimit(new MFFloat783().getArray()).setUlimit(new MFFloat784().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_1").setName("r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-0.1813275f,0.752463f,0.014184f}).setLlimit(new MFFloat789().getArray()).setUlimit(new MFFloat790().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_1").setDEF("hanim_r_carpal_distal_interphalangeal_1").setName("r_carpal_distal_interphalangeal_2").setCenter(new float[] {-0.1802925f,0.721215f,0.01338525f}).setLlimit(new MFFloat795().getArray()).setUlimit(new MFFloat796().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_3").setName("r_midcarpal_3").setCenter(new float[] {-0.18072f,0.878571f,-0.004797f}).setLlimit(new MFFloat801().getArray()).setUlimit(new MFFloat802().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_3").setDEF("hanim_r_carpometacarpal_3").setName("r_carpometacarpal_3").setCenter(new float[] {-0.18072f,0.850392f,-0.00625275f}).setLlimit(new MFFloat807().getArray()).setUlimit(new MFFloat808().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setDEF("hanim_r_metacarpophalangeal_3").setName("r_metacarpophalangeal_3").setCenter(new float[] {-0.1833075f,0.787338f,-0.00391725f}).setLlimit(new MFFloat813().getArray()).setUlimit(new MFFloat814().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-0.1813275f,0.747999f,-0.003537f}).setLlimit(new MFFloat819().getArray()).setUlimit(new MFFloat820().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_3").setCenter(new float[] {-0.1802925f,0.713403f,-0.00375975f}).setLlimit(new MFFloat825().getArray()).setUlimit(new MFFloat826().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_4_1").setName("r_midcarpal_4_5").setCenter(new float[] {-0.18072f,0.875223f,-0.02574f}).setLlimit(new MFFloat831().getArray()).setUlimit(new MFFloat832().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_4_1").setDEF("hanim_r_carpometacarpal_4").setName("r_carpometacarpal_4").setCenter(new float[] {-0.18072f,0.85095f,-0.01991925f}).setLlimit(new MFFloat837().getArray()).setUlimit(new MFFloat838().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setDEF("hanim_r_metacarpophalangeal_4").setName("r_metacarpophalangeal_4").setCenter(new float[] {-0.1833075f,0.786222f,-0.02144025f}).setLlimit(new MFFloat843().getArray()).setUlimit(new MFFloat844().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_proximal_interphalangeal_4").setCenter(new float[] {-0.1813275f,0.752184f,-0.020646f}).setLlimit(new MFFloat849().getArray()).setUlimit(new MFFloat850().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_4").setCenter(new float[] {-0.1802925f,0.720099f,-0.0197775f}).setLlimit(new MFFloat855().getArray()).setUlimit(new MFFloat856().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_carpometacarpal_5").setName("r_carpometacarpal_5").setCenter(new float[] {-0.18126f,0.853461f,-0.0327825f}).setLlimit(new MFFloat861().getArray()).setUlimit(new MFFloat862().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setDEF("hanim_r_metacarpophalangeal_5").setName("r_metacarpophalangeal_5").setCenter(new float[] {-0.18297f,0.791244f,-0.0370575f}).setLlimit(new MFFloat867().getArray()).setUlimit(new MFFloat868().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_proximal_interphalangeal_5").setCenter(new float[] {-0.181305f,0.77004f,-0.0371475f}).setLlimit(new MFFloat873().getArray()).setUlimit(new MFFloat874().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_5").setCenter(new float[] {-0.18045f,0.746883f,-0.0369675f}).setLlimit(new MFFloat879().getArray()).setUlimit(new MFFloat880().getArray())

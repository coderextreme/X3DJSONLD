...
public class JinLOA4_4 implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    X3D model = new JinLOA4_4().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/JinLOA4_4.new.java.x3d");
    model.toFileJSON("../data/JinLOA4_4.new.java.json");
    }
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("JinLOA4").setDEF("hanim_JinLOA4").setLoa(4).setVersion("2.0")
          ...
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_JinLOA4").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new double[] {0,1.0242089721,-0.015921}).setContainerFieldOverride("skeleton"))
            .addChild(new HAnimSegment("hanim_humanoid_root").setName("sacrum").setDEF("hanim_sacrum")
              .addChild(new Transform().setTranslation(new double[] {0,1.0242089721,-0.015921})
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt327().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt328().getArray())
                    .setCoord(new Coordinate().setPoint(new MFVec3f9().getArray()))
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f10().getArray()))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new double[] {0,0.876897,-0.015921})
              .addChild(new HAnimSegment("hanim_sacroiliac").setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new Transform().setTranslation(new double[] {0,0.876897,-0.015921})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3211().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3212().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f13().getArray()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f14().getArray()))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_hip").setDEF("hanim_l_hip").setCenter(new double[] {0.09465749999999999,1.0250460557999999,-0.01834875})
                .addChild(new HAnimSegment("hanim_l_hip").setName("l_thigh").setDEF("hanim_l_thigh")
                  .addChild(new Transform().setTranslation(new double[] {0.09465749999999999,1.0250460557999999,-0.01834875})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new double[] {0.09260999999999998,0.506943,-0.01943775})
                  .addChild(new HAnimSegment("hanim_l_knee").setName("l_calf").setDEF("hanim_l_calf")
                    .addChild(new Transform().setTranslation(new double[] {0.09260999999999998,0.506943,-0.01943775})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3219().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3220().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f21().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f22().getArray()))))))
                  .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new double[] {0.08882999999999999,0.11835180000000001,-0.01045125})
                    .addChild(new HAnimSegment("hanim_l_talocrural").setName("l_talus").setDEF("hanim_l_talus")
                      .addChild(new Transform().setTranslation(new double[] {0.08882999999999999,0.11835180000000001,-0.01045125})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3223().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3224().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f25().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f26().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocalcaneonavicular").setDEF("hanim_l_talocalcaneonavicular").setCenter(new double[] {0.0783,0.045756,0.0048645})
                      .addChild(new HAnimSegment("hanim_l_talocalcaneonavicular").setName("l_navicular").setDEF("hanim_l_navicular")
                        .addChild(new Transform().setTranslation(new double[] {0.0783,0.045756,0.0048645})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_1").setDEF("hanim_l_cuneonavicular_1").setCenter(new double[] {0.06736500000000001,0.0398133,0.018391499999999998})
                        .addChild(new HAnimSegment("hanim_l_cuneonavicular_1").setName("l_cuneiform_1").setDEF("hanim_l_cuneiform_1")
                          .addChild(new Transform().setTranslation(new double[] {0.06736500000000001,0.0398133,0.018391499999999998})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3231().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3232().getArray())
                                .setCoord(new Coordinate().setPoint(new MFVec3f33().getArray()))
                                .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f34().getArray()))))))
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setName("l_tarsometatarsal_1").setDEF("hanim_l_tarsometatarsal_1").setCenter(new double[] {0.06462,0.028820699999999998,0.04419})
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_1").setName("l_metatarsal_1").setDEF("hanim_l_metatarsal_1")
                            .addChild(new Transform().setTranslation(new double[] {0.06462,0.028820699999999998,0.04419})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3235().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3236().getArray())
                                  .setCoord(new Coordinate().setPoint(new MFVec3f37().getArray()))
                                  .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f38().getArray()))))))
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setName("l_metatarsophalangeal_1").setDEF("hanim_l_metatarsophalangeal_1").setCenter(new double[] {0.0621225,0.01788669,0.09362249999999998})
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_1").setName("l_tarsal_proximal_phalanx_1").setDEF("hanim_l_tarsal_proximal_phalanx_1")
                              .addChild(new Transform().setTranslation(new double[] {0.0621225,0.01788669,0.09362249999999998})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setName("l_tarsal_distal_interphalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_1").setCenter(new double[] {0.0621225,0.01504926,0.1153125})
                              .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_1").setName("l_tarsal_distal_phalanx_1").setDEF("hanim_l_tarsal_distal_phalanx_1")
                                .addChild(new Transform().setTranslation(new double[] {0.0621225,0.01504926,0.1153125})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3243().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3244().getArray())
                                      .setCoord(new Coordinate().setPoint(new MFVec3f45().getArray()))
                                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f46().getArray()))))))))))
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_2").setDEF("hanim_l_cuneonavicular_2").setCenter(new double[] {0.0814275,0.041571000000000004,0.02142675})
                        .addChild(new HAnimSegment("hanim_l_cuneonavicular_2").setName("l_cuneiform_2").setDEF("hanim_l_cuneiform_2")
                          .addChild(new Transform().setTranslation(new double[] {0.0814275,0.041571000000000004,0.02142675})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3247().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3248().getArray())
                                .setCoord(new Coordinate().setPoint(new MFVec3f49().getArray()))
                                .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f50().getArray()))))))
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setName("l_tarsometatarsal_2").setDEF("hanim_l_tarsometatarsal_2").setCenter(new double[] {0.08019,0.032364,0.041062499999999995})
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_2").setName("l_metatarsal_2").setDEF("hanim_l_metatarsal_2")
                            .addChild(new Transform().setTranslation(new double[] {0.08019,0.032364,0.041062499999999995})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new double[] {0.08253,0.01857024,0.09782999999999999})
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_2").setName("l_tarsal_proximal_phalanx_2").setDEF("hanim_l_tarsal_proximal_phalanx_2")
                              .addChild(new Transform().setTranslation(new double[] {0.08253,0.01857024,0.09782999999999999})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3255().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3256().getArray())
                                    .setCoord(new Coordinate().setPoint(new MFVec3f57().getArray()))
                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f58().getArray()))))))
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setCenter(new double[] {0.0843075,0.015682590000000003,0.1140075})
                              .addChild(new HAnimSegment("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_middle_phalanx_2").setDEF("hanim_l_tarsal_middle_phalanx_2")
                                .addChild(new Transform().setTranslation(new double[] {0.0843075,0.015682590000000003,0.1140075})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3259().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3260().getArray())
                                      .setCoord(new Coordinate().setPoint(new MFVec3f61().getArray()))
                                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f62().getArray()))))))
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setCenter(new double[] {0.0843075,0.012183929999999999,0.12343499999999999})
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_phalanx_2").setDEF("hanim_l_tarsal_distal_phalanx_2")
                                  .addChild(new Transform().setTranslation(new double[] {0.0843075,0.012183929999999999,0.12343499999999999})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_3").setDEF("hanim_l_cuneonavicular_3").setCenter(new double[] {0.09296999999999998,0.0414036,0.019818})
                        .addChild(new HAnimSegment("hanim_l_cuneonavicular_3").setName("l_cuneiform_3").setDEF("hanim_l_cuneiform_3")
                          .addChild(new Transform().setTranslation(new double[] {0.09296999999999998,0.0414036,0.019818})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setName("l_tarsometatarsal_3").setDEF("hanim_l_tarsometatarsal_3").setCenter(new double[] {0.09459,0.032364,0.039397499999999995})
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_3").setName("l_metatarsal_3").setDEF("hanim_l_metatarsal_3")
                            .addChild(new Transform().setTranslation(new double[] {0.09459,0.032364,0.039397499999999995})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setName("l_metatarsophalangeal_3").setDEF("hanim_l_metatarsophalangeal_3").setCenter(new double[] {0.09648,0.018670680000000002,0.0954225})
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_3").setName("l_tarsal_proximal_phalanx_3").setDEF("hanim_l_tarsal_proximal_phalanx_3")
                              .addChild(new Transform().setTranslation(new double[] {0.09648,0.018670680000000002,0.0954225})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setName("l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setCenter(new double[] {0.098865,0.014784210000000002,0.110475})
                              .addChild(new HAnimSegment("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_middle_phalanx_3").setDEF("hanim_l_tarsal_middle_phalanx_3")
                                .addChild(new Transform().setTranslation(new double[] {0.098865,0.014784210000000002,0.110475})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setCenter(new double[] {0.10041749999999999,0.012183929999999999,0.1197})
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_3").setName("l_tarsal_distal_phalanx_3").setDEF("hanim_l_tarsal_distal_phalanx_3")
                                  .addChild(new Transform().setTranslation(new double[] {0.10041749999999999,0.012183929999999999,0.1197})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_calcaneocuboid").setDEF("hanim_l_calcaneocuboid").setCenter(new double[] {0.0891,0.0718983,-0.025965})
                      .addChild(new HAnimSegment("hanim_l_calcaneocuboid").setName("l_calcaneus").setDEF("hanim_l_calcaneus")
                        .addChild(new Transform().setTranslation(new double[] {0.0891,0.0718983,-0.025965})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setName("l_transversetarsal").setDEF("hanim_l_transversetarsal").setCenter(new double[] {0.1106325,0.04374720000000001,0.002089125})
                        .addChild(new HAnimSegment("hanim_l_transversetarsal").setName("l_cuboid").setDEF("hanim_l_cuboid")
                          .addChild(new Transform().setTranslation(new double[] {0.1106325,0.04374720000000001,0.002089125})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3291().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3292().getArray())
                                .setCoord(new Coordinate().setPoint(new MFVec3f93().getArray()))
                                .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f94().getArray()))))))
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_4").setDEF("hanim_l_tarsometatarsal_4").setCenter(new double[] {0.10649249999999999,0.0304389,0.03843})
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_4").setName("l_metatarsal_4").setDEF("hanim_l_metatarsal_4")
                            .addChild(new Transform().setTranslation(new double[] {0.10649249999999999,0.0304389,0.03843})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setName("l_metatarsophalangeal_4").setDEF("hanim_l_metatarsophalangeal_4").setCenter(new double[] {0.10986749999999999,0.017797410000000003,0.09116999999999999})
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_4").setName("l_tarsal_proximal_phalanx_4").setDEF("hanim_l_tarsal_proximal_phalanx_4")
                              .addChild(new Transform().setTranslation(new double[] {0.10986749999999999,0.017797410000000003,0.09116999999999999})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setName("l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setCenter(new double[] {0.11416499999999999,0.015183180000000001,0.10631249999999999})
                              .addChild(new HAnimSegment("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_middle_phalanx_4").setDEF("hanim_l_tarsal_middle_phalanx_4")
                                .addChild(new Transform().setTranslation(new double[] {0.11416499999999999,0.015183180000000001,0.10631249999999999})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32103().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32104().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setCenter(new double[] {0.1156725,0.01161756,0.11369249999999999})
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_4").setName("l_tarsal_distal_phalanx_4").setDEF("hanim_l_tarsal_distal_phalanx_4")
                                  .addChild(new Transform().setTranslation(new double[] {0.1156725,0.01161756,0.11369249999999999})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_5").setDEF("hanim_l_tarsometatarsal_5").setCenter(new double[] {0.120825,0.02597211,0.03474})
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_5").setName("l_metatarsal_5").setDEF("hanim_l_metatarsal_5")
                            .addChild(new Transform().setTranslation(new double[] {0.120825,0.02597211,0.03474})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setName("l_metatarsophalangeal_5").setDEF("hanim_l_metatarsophalangeal_5").setCenter(new double[] {0.124065,0.01695204,0.0865575})
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_5").setName("l_tarsal_proximal_phalanx_5").setDEF("hanim_l_tarsal_proximal_phalanx_5")
                              .addChild(new Transform().setTranslation(new double[] {0.124065,0.01695204,0.0865575})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32115().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32116().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setName("l_tarsal_proximal_interphalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_5").setCenter(new double[] {0.1263825,0.01346175,0.09414})
                              .addChild(new HAnimSegment("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_middle_phalanx_5").setDEF("hanim_l_tarsal_middle_phalanx_5")
                                .addChild(new Transform().setTranslation(new double[] {0.1263825,0.01346175,0.09414})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setCenter(new double[] {0.1272825,0.01061874,0.10187999999999998})
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_5").setName("l_tarsal_distal_phalanx_5").setDEF("hanim_l_tarsal_distal_phalanx_5")
                                  .addChild(new Transform().setTranslation(new double[] {0.1272825,0.01061874,0.10187999999999998})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new double[] {-0.09465749999999999,1.0250460557999999,-0.01834875})
                  ...
                  .addChild(new Transform().setTranslation(new double[] {-0.09465749999999999,1.0250460557999999,-0.01834875})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32127().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32128().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new double[] {-0.09260999999999998,0.506943,-0.01943775})
                    ...
                    .addChild(new Transform().setTranslation(new double[] {-0.09260999999999998,0.506943,-0.01943775})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32131().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32132().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new double[] {-0.0884475,0.11835180000000001,-0.01045125})
                    .addChild(new HAnimSegment("hanim_r_talocrural").setName("r_talus").setDEF("hanim_r_talus")
                      .addChild(new Transform().setTranslation(new double[] {-0.0884475,0.11835180000000001,-0.01045125})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_talocalcaneonavicular").setDEF("hanim_r_talocalcaneonavicular").setCenter(new double[] {-0.07794,0.045756,0.0048645})
                      .addChild(new HAnimSegment("hanim_r_talocalcaneonavicular").setName("r_navicular").setDEF("hanim_r_navicular")
                        .addChild(new Transform().setTranslation(new double[] {-0.07794,0.045756,0.0048645})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32139().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32140().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_1").setDEF("hanim_r_cuneonavicular_1").setCenter(new double[] {-0.0669825,0.0398133,0.018391499999999998})
                        .addChild(new HAnimSegment("hanim_r_cuneonavicular_1").setName("r_cuneiform_1").setDEF("hanim_r_cuneiform_1")
                          .addChild(new Transform().setTranslation(new double[] {-0.0669825,0.0398133,0.018391499999999998})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32143().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32144().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_1").setName("r_tarsometatarsal_1").setDEF("hanim_r_tarsometatarsal_1").setCenter(new double[] {-0.06426,0.028820699999999998,0.04419})
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_1").setName("r_metatarsal_1").setDEF("hanim_r_metatarsal_1")
                            .addChild(new Transform().setTranslation(new double[] {-0.06426,0.028820699999999998,0.04419})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_1").setName("r_metatarsophalangeal_1").setDEF("hanim_r_metatarsophalangeal_1").setCenter(new double[] {-0.0617625,0.01788669,0.09362249999999998})
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_1").setName("r_tarsal_proximal_phalanx_1").setDEF("hanim_r_tarsal_proximal_phalanx_1")
                              .addChild(new Transform().setTranslation(new double[] {-0.0617625,0.01788669,0.09362249999999998})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32151().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32152().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_1").setName("r_tarsal_distal_interphalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_1").setCenter(new double[] {-0.06174,0.01504926,0.1153125})
                              .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_1").setName("r_tarsal_distal_phalanx_1").setDEF("hanim_r_tarsal_distal_phalanx_1")
                                .addChild(new Transform().setTranslation(new double[] {-0.06174,0.01504926,0.1153125})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32155().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32156().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_2").setDEF("hanim_r_cuneonavicular_2").setCenter(new double[] {-0.08104499999999999,0.041571000000000004,0.02142675})
                        .addChild(new HAnimSegment("hanim_r_cuneonavicular_2").setName("r_cuneiform_2").setDEF("hanim_r_cuneiform_2")
                          .addChild(new Transform().setTranslation(new double[] {-0.08104499999999999,0.041571000000000004,0.02142675})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_2").setName("r_tarsometatarsal_2").setDEF("hanim_r_tarsometatarsal_2").setCenter(new double[] {-0.07983,0.032364,0.041062499999999995})
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_2").setName("r_metatarsal_2").setDEF("hanim_r_metatarsal_2")
                            .addChild(new Transform().setTranslation(new double[] {-0.07983,0.032364,0.041062499999999995})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32163().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32164().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new double[] {-0.0821475,0.01857024,0.09782999999999999})
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_2").setName("r_tarsal_proximal_phalanx_2").setDEF("hanim_r_tarsal_proximal_phalanx_2")
                              .addChild(new Transform().setTranslation(new double[] {-0.0821475,0.01857024,0.09782999999999999})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32167().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32168().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setCenter(new double[] {-0.083925,0.015682590000000003,0.1140075})
                              .addChild(new HAnimSegment("hanim_r_tarsal_proximal_interphalangeal_2").setName("r_tarsal_middle_phalanx_2").setDEF("hanim_r_tarsal_middle_phalanx_2")
                                .addChild(new Transform().setTranslation(new double[] {-0.083925,0.015682590000000003,0.1140075})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setCenter(new double[] {-0.083925,0.012183929999999999,0.12343499999999999})
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_2").setName("r_tarsal_distal_phalanx_2").setDEF("hanim_r_tarsal_distal_phalanx_2")
                                  .addChild(new Transform().setTranslation(new double[] {-0.083925,0.012183929999999999,0.12343499999999999})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32175().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32176().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_3").setDEF("hanim_r_cuneonavicular_3").setCenter(new double[] {-0.09260999999999998,0.0414036,0.019818})
                        .addChild(new HAnimSegment("hanim_r_cuneonavicular_3").setName("r_cuneiform_3").setDEF("hanim_r_cuneiform_3")
                          .addChild(new Transform().setTranslation(new double[] {-0.09260999999999998,0.0414036,0.019818})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32179().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32180().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_3").setName("r_tarsometatarsal_3").setDEF("hanim_r_tarsometatarsal_3").setCenter(new double[] {-0.09423,0.032364,0.039397499999999995})
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_3").setName("r_metatarsal_3").setDEF("hanim_r_metatarsal_3")
                            .addChild(new Transform().setTranslation(new double[] {-0.09423,0.032364,0.039397499999999995})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_3").setName("r_metatarsophalangeal_3").setDEF("hanim_r_metatarsophalangeal_3").setCenter(new double[] {-0.09609749999999999,0.018670680000000002,0.0954225})
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_3").setName("r_tarsal_proximal_phalanx_3").setDEF("hanim_r_tarsal_proximal_phalanx_3")
                              .addChild(new Transform().setTranslation(new double[] {-0.09609749999999999,0.018670680000000002,0.0954225})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32187().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32188().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_3").setName("r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setCenter(new double[] {-0.098505,0.014784210000000002,0.110475})
                              .addChild(new HAnimSegment("hanim_r_tarsal_proximal_interphalangeal_3").setName("r_tarsal_middle_phalanx_3").setDEF("hanim_r_tarsal_middle_phalanx_3")
                                .addChild(new Transform().setTranslation(new double[] {-0.098505,0.014784210000000002,0.110475})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32191().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32192().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_3").setName("r_tarsal_distal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setCenter(new double[] {-0.10003499999999999,0.012183929999999999,0.1197})
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_3").setName("r_tarsal_distal_phalanx_3").setDEF("hanim_r_tarsal_distal_phalanx_3")
                                  .addChild(new Transform().setTranslation(new double[] {-0.10003499999999999,0.012183929999999999,0.1197})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_calcaneocuboid").setDEF("hanim_r_calcaneocuboid").setCenter(new double[] {-0.0887175,0.0718983,-0.025965})
                      .addChild(new HAnimSegment("hanim_r_calcaneocuboid").setName("r_calcaneus").setDEF("hanim_r_calcaneus")
                        .addChild(new Transform().setTranslation(new double[] {-0.0887175,0.0718983,-0.025965})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32199().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32200().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_calcaneocuboid").setName("r_transversetarsal").setDEF("hanim_r_transversetarsal").setCenter(new double[] {-0.1102725,0.04374720000000001,0.002089125})
                        .addChild(new HAnimSegment("hanim_r_transversetarsal").setName("r_cuboid").setDEF("hanim_r_cuboid")
                          .addChild(new Transform().setTranslation(new double[] {-0.1102725,0.04374720000000001,0.002089125})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32203().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32204().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName("r_tarsometatarsal_4").setDEF("hanim_r_tarsometatarsal_4").setCenter(new double[] {-0.10613249999999999,0.0304389,0.03843})
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_4").setName("r_metatarsal_4").setDEF("hanim_r_metatarsal_4")
                            .addChild(new Transform().setTranslation(new double[] {-0.10613249999999999,0.0304389,0.03843})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_4").setName("r_metatarsophalangeal_4").setDEF("hanim_r_metatarsophalangeal_4").setCenter(new double[] {-0.1095075,0.017797410000000003,0.09116999999999999})
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_4").setName("r_tarsal_proximal_phalanx_4").setDEF("hanim_r_tarsal_proximal_phalanx_4")
                              .addChild(new Transform().setTranslation(new double[] {-0.1095075,0.017797410000000003,0.09116999999999999})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32211().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32212().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_4").setName("r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setCenter(new double[] {-0.11378250000000001,0.015183180000000001,0.10631249999999999})
                              .addChild(new HAnimSegment("hanim_r_tarsal_proximal_interphalangeal_4").setName("r_tarsal_middle_phalanx_4").setDEF("hanim_r_tarsal_middle_phalanx_4")
                                .addChild(new Transform().setTranslation(new double[] {-0.11378250000000001,0.015183180000000001,0.10631249999999999})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32215().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32216().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_4").setName("r_tarsal_distal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setCenter(new double[] {-0.1153125,0.01161756,0.11369249999999999})
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_4").setName("r_tarsal_distal_phalanx_4").setDEF("hanim_r_tarsal_distal_phalanx_4")
                                  .addChild(new Transform().setTranslation(new double[] {-0.1153125,0.01161756,0.11369249999999999})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName("r_tarsometatarsal_5").setDEF("hanim_r_tarsometatarsal_5").setCenter(new double[] {-0.1204425,0.02597211,0.03474})
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_5").setName("r_metatarsal_5").setDEF("hanim_r_metatarsal_5")
                            .addChild(new Transform().setTranslation(new double[] {-0.1204425,0.02597211,0.03474})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32223().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32224().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_5").setName("r_metatarsophalangeal_5").setDEF("hanim_r_metatarsophalangeal_5").setCenter(new double[] {-0.12368249999999999,0.01695204,0.0865575})
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_5").setName("r_tarsal_proximal_phalanx_5").setDEF("hanim_r_tarsal_proximal_phalanx_5")
                              .addChild(new Transform().setTranslation(new double[] {-0.12368249999999999,0.01695204,0.0865575})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32227().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32228().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_5").setName("r_tarsal_proximal_interphalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_5").setCenter(new double[] {-0.126,0.01346175,0.09414})
                              .addChild(new HAnimSegment("hanim_r_tarsal_proximal_interphalangeal_5").setName("r_tarsal_middle_phalanx_5").setDEF("hanim_r_tarsal_middle_phalanx_5")
                                .addChild(new Transform().setTranslation(new double[] {-0.126,0.01346175,0.09414})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_5").setName("r_tarsal_distal_interphalangeal_5").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setCenter(new double[] {-0.1269225,0.01061874,0.10187999999999998})
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_5").setName("r_tarsal_distal_phalanx_5").setDEF("hanim_r_tarsal_distal_phalanx_5")
                                  .addChild(new Transform().setTranslation(new double[] {-0.1269225,0.01061874,0.10187999999999998})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32235().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32236().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("vl5").setDEF("hanim_vl5").setCenter(new double[] {0,1.1475270279,-0.01376325})
                .addChild(new HAnimSegment("hanim_vl5").setName("l5").setDEF("hanim_l5")
                  .addChild(new Transform().setTranslation(new double[] {0,1.1475270279,-0.01376325})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32239().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32240().getArray())
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("vl4").setDEF("hanim_vl4").setCenter(new double[] {0,1.1776589721000001,-0.01376325})
                  .addChild(new HAnimSegment("hanim_vl4").setName("l4").setDEF("hanim_l4")
                    .addChild(new Transform().setTranslation(new double[] {0,1.1776589721000001,-0.01376325})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                  ...
                  .addChild(new HAnimJoint("hanim_vl4").setName("vl3").setDEF("hanim_vl3").setCenter(new double[] {0,1.1977470000000001,-0.01376325})
                    .addChild(new HAnimSegment("hanim_vl3").setName("l3").setDEF("hanim_l3")
                      .addChild(new Transform().setTranslation(new double[] {0,1.1977470000000001,-0.01376325})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32247().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32248().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_vl3").setName("vl2").setDEF("hanim_vl2").setCenter(new double[] {0,1.218114,-0.01376325})
                      .addChild(new HAnimSegment("hanim_vl2").setName("l2").setDEF("hanim_l2")
                        .addChild(new Transform().setTranslation(new double[] {0,1.218114,-0.01376325})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32251().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32252().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_vl2").setName("vl1").setDEF("hanim_vl1").setCenter(new double[] {0,1.239597,-0.01376325})
                        .addChild(new HAnimSegment("hanim_vl1").setName("l1").setDEF("hanim_l1")
                          .addChild(new Transform().setTranslation(new double[] {0,1.239597,-0.01376325})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_vl1").setName("vt12").setDEF("hanim_vt12").setCenter(new double[] {0,1.2686130279,-0.01376325})
                          .addChild(new HAnimSegment("hanim_vt12").setName("t12").setDEF("hanim_t12")
                            .addChild(new Transform().setTranslation(new double[] {0,1.2686130279,-0.01376325})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32259().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32260().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_vt12").setName("vt11").setDEF("hanim_vt11").setCenter(new double[] {0,1.297908,-0.01376325})
                            .addChild(new HAnimSegment("hanim_vt11").setName("t11").setDEF("hanim_t11")
                              .addChild(new Transform().setTranslation(new double[] {0,1.297908,-0.01376325})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32263().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32264().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_vt11").setName("vt10").setDEF("hanim_vt10").setCenter(new double[] {0,1.3191119721,-0.01378575})
                              .addChild(new HAnimSegment("hanim_vt10").setName("t10").setDEF("hanim_t10")
                                .addChild(new Transform().setTranslation(new double[] {0,1.3191119721,-0.01378575})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_vt10").setName("vt9").setDEF("hanim_vt9").setCenter(new double[] {0,1.337247,-0.01376325})
                                .addChild(new HAnimSegment("hanim_vt9").setName("t9").setDEF("hanim_t9")
                                  .addChild(new Transform().setTranslation(new double[] {0,1.337247,-0.01376325})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32271().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32272().getArray())
                                ...
                                .addChild(new HAnimJoint("hanim_vt9").setName("vt8").setDEF("hanim_vt8").setCenter(new double[] {0,1.3553820558,-0.01376325})
                                  .addChild(new HAnimSegment("hanim_vt8").setName("t8").setDEF("hanim_t8")
                                    .addChild(new Transform().setTranslation(new double[] {0,1.3553820558,-0.01376325})
                                      .addChild(new Shape()
                                        .setAppearance(new Appearance()
                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32275().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32276().getArray())
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt8").setName("vt7").setDEF("hanim_vt7").setCenter(new double[] {0,1.3749119721,-0.01376325})
                                    .addChild(new HAnimSegment("hanim_vt7").setName("t7").setDEF("hanim_t7")
                                      .addChild(new Transform().setTranslation(new double[] {0,1.3749119721,-0.01376325})
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt7").setName("vt6").setDEF("hanim_vt6").setCenter(new double[] {0,1.3908149442,-0.01376325})
                                      .addChild(new HAnimSegment("hanim_vt6").setName("t6").setDEF("hanim_t6")
                                        .addChild(new Transform().setTranslation(new double[] {0,1.3908149442,-0.01376325})
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32283().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32284().getArray())
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt6").setName("vt5").setDEF("hanim_vt5").setCenter(new double[] {0,1.4100660279,-0.01376325})
                                        .addChild(new HAnimSegment("hanim_vt5").setName("t5").setDEF("hanim_t5")
                                          .addChild(new Transform().setTranslation(new double[] {0,1.4100660279,-0.01376325})
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32287().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32288().getArray())
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt5").setName("vt4").setDEF("hanim_vt4").setCenter(new double[] {0,1.4290380279000001,-0.01376325})
                                          .addChild(new HAnimSegment("hanim_vt4").setName("t4").setDEF("hanim_t4")
                                            .addChild(new Transform().setTranslation(new double[] {0,1.4290380279000001,-0.01376325})
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setName("vt3").setDEF("hanim_vt3").setCenter(new double[] {0,1.4519160279,-0.01376325})
                                            .addChild(new HAnimSegment("hanim_vt3").setName("t3").setDEF("hanim_t3")
                                              .addChild(new Transform().setTranslation(new double[] {0,1.4519160279,-0.01376325})
                                                .addChild(new Shape()
                                                  .setAppearance(new Appearance()
                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32295().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32296().getArray())
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setName("vt2").setDEF("hanim_vt2").setCenter(new double[] {0,1.4826059721000002,-0.01378575})
                                              .addChild(new HAnimSegment("hanim_vt2").setName("t2").setDEF("hanim_t2")
                                                .addChild(new Transform().setTranslation(new double[] {0,1.4826059721000002,-0.01378575})
                                                  .addChild(new Shape()
                                                    .setAppearance(new Appearance()
                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32299().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32300().getArray())
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setName("vt1").setDEF("hanim_vt1").setCenter(new double[] {0,1.5121800279000002,-0.01376325})
                                                .addChild(new HAnimSegment("hanim_vt1").setName("t1").setDEF("hanim_t1")
                                                  .addChild(new Transform().setTranslation(new double[] {0,1.5121800279000002,-0.01376325})
                                                    .addChild(new Shape()
                                                      .setAppearance(new Appearance()
                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName("vc7").setDEF("hanim_vc7").setCenter(new double[] {0,1.5442649442,-0.015063749999999999})
                                                  .addChild(new HAnimSegment("hanim_vc7").setName("c7").setDEF("hanim_c7")
                                                    .addChild(new Transform().setTranslation(new double[] {0,1.5442649442,-0.015063749999999999})
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32307().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32308().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc7").setName("vc6").setDEF("hanim_vc6").setCenter(new double[] {0,1.5593309721000002,-0.015063749999999999})
                                                    .addChild(new HAnimSegment("hanim_vc6").setName("c6").setDEF("hanim_c6")
                                                      .addChild(new Transform().setTranslation(new double[] {0,1.5593309721000002,-0.015063749999999999})
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32311().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32312().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc6").setName("vc5").setDEF("hanim_vc5").setCenter(new double[] {0,1.5746759721,-0.015063749999999999})
                                                      .addChild(new HAnimSegment("hanim_vc5").setName("c5").setDEF("hanim_c5")
                                                        .addChild(new Transform().setTranslation(new double[] {0,1.5746759721,-0.015063749999999999})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc5").setName("vc4").setDEF("hanim_vc4").setCenter(new double[] {0,1.5900210558,-0.015063749999999999})
                                                        .addChild(new HAnimSegment("hanim_vc4").setName("c4").setDEF("hanim_c4")
                                                          .addChild(new Transform().setTranslation(new double[] {0,1.5900210558,-0.015063749999999999})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32319().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32320().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_vc4").setName("vc3").setDEF("hanim_vc3").setCenter(new double[] {0,1.6059240279,-0.015063749999999999})
                                                          .addChild(new HAnimSegment("hanim_vc3").setName("c3").setDEF("hanim_c3")
                                                            .addChild(new Transform().setTranslation(new double[] {0,1.6059240279,-0.015063749999999999})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32323().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32324().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_vc3").setName("vc2").setDEF("hanim_vc2").setCenter(new double[] {0,1.6204320558,-0.015063749999999999})
                                                            .addChild(new HAnimSegment("hanim_vc2").setName("c2").setDEF("hanim_c2")
                                                              .addChild(new Transform().setTranslation(new double[] {0,1.6204320558,-0.015063749999999999})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_vc2").setName("vc1").setDEF("hanim_vc1").setCenter(new double[] {0,1.6349399442,-0.015063749999999999})
                                                              .addChild(new HAnimSegment("hanim_vc1").setName("c1").setDEF("hanim_c1")
                                                                .addChild(new Transform().setTranslation(new double[] {0,1.6349399442,-0.015063749999999999})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32331().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32332().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_vc1").setName("skullbase").setDEF("hanim_skullbase").setCenter(new double[] {0,1.6276860000000002,-0.01544175})
                                                                .addChild(new HAnimSegment("hanim_skullbase").setName("skull").setDEF("hanim_skull")
                                                                  .addChild(new Transform().setTranslation(new double[] {0,1.6276860000000002,-0.01544175})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32335().getArray().append(new MFInt32336().getArray()).append(new MFInt32337().getArray())).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32338().getArray().append(new MFInt32339().getArray()).append(new MFInt32340().getArray()))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyelid_joint").setDEF("hanim_l_eyelid_joint").setCenter(new double[] {0.0505125,1.7660699721000002,0.03294})
                                                                  .addChild(new HAnimSegment("hanim_l_eyelid_joint").setName("l_eyelid").setDEF("hanim_l_eyelid")
                                                                    .addChild(new Transform().setTranslation(new double[] {0.0505125,1.7660699721000002,0.03294})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyelid_joint").setDEF("hanim_r_eyelid_joint").setCenter(new double[] {-0.0505125,1.7660699721000002,0.03294})
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new double[] {-0.0505125,1.7660699721000002,0.03294})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32349().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32350().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyeball_joint").setDEF("hanim_l_eyeball_joint").setCenter(new double[] {0.0481275,1.7420759721,0.0830475})
                                                                  .addChild(new HAnimSegment("hanim_l_eyeball_joint").setName("l_eyeball").setDEF("hanim_l_eyeball")
                                                                    .addChild(new Transform().setTranslation(new double[] {0.0481275,1.7420759721,0.0830475})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32353().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32354().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyeball_joint").setDEF("hanim_r_eyeball_joint").setCenter(new double[] {-0.0481275,1.7420759721,0.0830475})
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyebrow_joint").setDEF("hanim_l_eyebrow_joint").setCenter(new double[] {0.0217485,1.7532360000000002,0.1069425})
                                                                  .addChild(new HAnimSegment("hanim_l_eyebrow_joint").setName("l_eyebrow").setDEF("hanim_l_eyebrow")
                                                                    .addChild(new Transform().setTranslation(new double[] {0.0217485,1.7532360000000002,0.1069425})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32361().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32362().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyebrow_joint").setDEF("hanim_r_eyebrow_joint").setCenter(new double[] {-0.0217485,1.7532360000000002,0.1069425})
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new double[] {-0.0217485,1.7532360000000002,0.1069425})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32365().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32366().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("temporomandibular").setDEF("hanim_temporomandibular").setCenter(new double[] {0,1.6279649442000002,0.01537875})
                                                                  .addChild(new HAnimSegment("hanim_temporomandibular").setName("jaw").setDEF("hanim_jaw")
                                                                    .addChild(new Transform().setTranslation(new double[] {0,1.6279649442000002,0.01537875})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName("l_acromioclavicular").setDEF("hanim_l_acromioclavicular").setCenter(new double[] {0.038474999999999995,1.4987880279,-0.01378575})
                                                  .addChild(new HAnimSegment("hanim_l_acromioclavicular").setName("l_clavicle").setDEF("hanim_l_clavicle")
                                                    .addChild(new Transform().setTranslation(new double[] {0.038474999999999995,1.4987880279,-0.01378575})
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32373().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32374().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName("l_sternoclavicular").setDEF("hanim_l_sternoclavicular").setCenter(new double[] {0.12294000000000001,1.4778630279000002,-0.012897})
                                                    .addChild(new HAnimSegment("hanim_l_sternoclavicular").setName("l_scapula").setDEF("hanim_l_scapula")
                                                      .addChild(new Transform().setTranslation(new double[] {0.12294000000000001,1.4778630279000002,-0.012897})
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32377().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32378().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new double[] {0.16506,1.4614020279,-0.003267})
                                                      .addChild(new HAnimSegment("hanim_l_shoulder").setName("l_upperarm").setDEF("hanim_l_upperarm")
                                                        .addChild(new Transform().setTranslation(new double[] {0.16506,1.4614020279,-0.003267})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new double[] {0.1820925,1.1517119721,-0.005629499999999999})
                                                        .addChild(new HAnimSegment("hanim_l_elbow").setName("l_forearm").setDEF("hanim_l_forearm")
                                                          .addChild(new Transform().setTranslation(new double[] {0.1820925,1.1517119721,-0.005629499999999999})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32385().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32386().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new double[] {0.181935,0.8981009721000001,-0.00502425})
                                                          .addChild(new HAnimSegment("hanim_l_radiocarpal").setName("l_carpal").setDEF("hanim_l_carpal")
                                                            .addChild(new Transform().setTranslation(new double[] {0.181935,0.8981009721000001,-0.00502425})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32389().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32390().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_1").setDEF("hanim_l_midcarpal_1").setCenter(new double[] {0.1812825,0.8755019721,0.019327499999999997})
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_1").setName("l_trapezium").setDEF("hanim_l_trapezium")
                                                              .addChild(new Transform().setTranslation(new double[] {0.1812825,0.8755019721,0.019327499999999997})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_1").setName("l_carpometacarpal_1").setDEF("hanim_l_carpometacarpal_1").setCenter(new double[] {0.180495,0.8587620279,0.0259875})
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_1").setName("l_metacarpal_1").setDEF("hanim_l_metacarpal_1")
                                                                .addChild(new Transform().setTranslation(new double[] {0.180495,0.8587620279,0.0259875})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32397().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32398().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setName("l_metacarpophalangeal_1").setDEF("hanim_l_metacarpophalangeal_1").setCenter(new double[] {0.18103499999999997,0.83421,0.035775})
                                                                .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_1").setName("l_carpal_proximal_phalanx_1").setDEF("hanim_l_carpal_proximal_phalanx_1")
                                                                  .addChild(new Transform().setTranslation(new double[] {0.18103499999999997,0.83421,0.035775})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32401().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32402().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setName("l_carpal_interphalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setCenter(new double[] {0.182655,0.811053,0.04965749999999999})
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_interphalangeal_1").setName("l_carpal_distal_phalanx_1").setDEF("hanim_l_carpal_distal_phalanx_1")
                                                                    .addChild(new Transform().setTranslation(new double[] {0.182655,0.811053,0.04965749999999999})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_2").setDEF("hanim_l_midcarpal_2").setCenter(new double[] {0.1812825,0.8766180000000001,0.00841725})
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_2").setName("l_trapezoid").setDEF("hanim_l_trapezoid")
                                                              .addChild(new Transform().setTranslation(new double[] {0.1812825,0.8766180000000001,0.00841725})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32409().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32410().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_2").setName("l_carpometacarpal_2").setDEF("hanim_l_carpometacarpal_2").setCenter(new double[] {0.1812825,0.8526239721000001,0.009729})
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_2").setName("l_metacarpal_2").setDEF("hanim_l_metacarpal_2")
                                                                .addChild(new Transform().setTranslation(new double[] {0.1812825,0.8526239721000001,0.009729})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32413().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32414().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setName("l_metacarpophalangeal_2").setDEF("hanim_l_metacarpophalangeal_2").setCenter(new double[] {0.183735,0.790128,0.015075})
                                                                .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_2").setName("l_carpal_proximal_phalanx_2").setDEF("hanim_l_carpal_proximal_phalanx_2")
                                                                  .addChild(new Transform().setTranslation(new double[] {0.183735,0.790128,0.015075})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setName("l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setCenter(new double[] {0.18171,0.7524629721,0.014183999999999999})
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_middle_phalanx_2").setDEF("hanim_l_carpal_middle_phalanx_2")
                                                                    .addChild(new Transform().setTranslation(new double[] {0.18171,0.7524629721,0.014183999999999999})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32421().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32422().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setCenter(new double[] {0.18067499999999997,0.721215,0.01338525})
                                                                    .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_2").setName("l_carpal_distal_phalanx_2").setDEF("hanim_l_carpal_distal_phalanx_2")
                                                                      .addChild(new Transform().setTranslation(new double[] {0.18067499999999997,0.721215,0.01338525})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32425().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32426().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_3").setDEF("hanim_l_midcarpal_3").setCenter(new double[] {0.18108,0.878571,-0.004797})
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_3").setName("l_capitate").setDEF("hanim_l_capitate")
                                                              .addChild(new Transform().setTranslation(new double[] {0.18108,0.878571,-0.004797})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_3").setName("l_carpometacarpal_3").setDEF("hanim_l_carpometacarpal_3").setCenter(new double[] {0.18108,0.850392,-0.00625275})
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_3").setName("l_metacarpal_3").setDEF("hanim_l_metacarpal_3")
                                                                .addChild(new Transform().setTranslation(new double[] {0.18108,0.850392,-0.00625275})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32433().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32434().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setName("l_metacarpophalangeal_3").setDEF("hanim_l_metacarpophalangeal_3").setCenter(new double[] {0.18369,0.7873379721000001,-0.00391725})
                                                                .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_3").setName("l_carpal_proximal_phalanx_3").setDEF("hanim_l_carpal_proximal_phalanx_3")
                                                                  .addChild(new Transform().setTranslation(new double[] {0.18369,0.7873379721000001,-0.00391725})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32437().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32438().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setName("l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setCenter(new double[] {0.18171,0.7479989721000001,-0.003537})
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_middle_phalanx_3").setDEF("hanim_l_carpal_middle_phalanx_3")
                                                                    .addChild(new Transform().setTranslation(new double[] {0.18171,0.7479989721000001,-0.003537})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setCenter(new double[] {0.18067499999999997,0.713403,-0.0037597499999999996})
                                                                    .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_3").setName("l_carpal_distal_phalanx_3").setDEF("hanim_l_carpal_distal_phalanx_3")
                                                                      .addChild(new Transform().setTranslation(new double[] {0.18067499999999997,0.713403,-0.0037597499999999996})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32445().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32446().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_4_5").setDEF("hanim_l_midcarpal_4_5").setCenter(new double[] {0.18108,0.8752230279,-0.025739999999999996})
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_4_5").setName("l_hamate").setDEF("hanim_l_hamate")
                                                              .addChild(new Transform().setTranslation(new double[] {0.18108,0.8752230279,-0.025739999999999996})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32449().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32450().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_4_5").setName("l_carpometacarpal_4").setDEF("hanim_l_carpometacarpal_4").setCenter(new double[] {0.18108,0.85095,-0.01991925})
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_4").setName("l_metacarpal_4").setDEF("hanim_l_metacarpal_4")
                                                                .addChild(new Transform().setTranslation(new double[] {0.18108,0.85095,-0.01991925})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setName("l_metacarpophalangeal_4").setDEF("hanim_l_metacarpophalangeal_4").setCenter(new double[] {0.18369,0.786222,-0.021440249999999998})
                                                                .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_4").setName("l_carpal_proximal_phalanx_4").setDEF("hanim_l_carpal_proximal_phalanx_4")
                                                                  .addChild(new Transform().setTranslation(new double[] {0.18369,0.786222,-0.021440249999999998})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32457().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32458().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setName("l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setCenter(new double[] {0.18171,0.7521839721,-0.020645999999999998})
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_middle_phalanx_4").setDEF("hanim_l_carpal_middle_phalanx_4")
                                                                    .addChild(new Transform().setTranslation(new double[] {0.18171,0.7521839721,-0.020645999999999998})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32461().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32462().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setCenter(new double[] {0.18067499999999997,0.7200989721000001,-0.0197775})
                                                                    .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_4").setName("l_carpal_distal_phalanx_4").setDEF("hanim_l_carpal_distal_phalanx_4")
                                                                      .addChild(new Transform().setTranslation(new double[] {0.18067499999999997,0.7200989721000001,-0.0197775})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_carpometacarpal_5").setDEF("hanim_l_carpometacarpal_5").setCenter(new double[] {0.1816425,0.853461,-0.0327825})
                                                            .addChild(new HAnimSegment("hanim_l_carpometacarpal_5").setName("l_metacarpal_5").setDEF("hanim_l_metacarpal_5")
                                                              .addChild(new Transform().setTranslation(new double[] {0.1816425,0.853461,-0.0327825})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32469().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32470().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setName("l_metacarpophalangeal_5").setDEF("hanim_l_metacarpophalangeal_5").setCenter(new double[] {0.18333,0.7912440279,-0.0370575})
                                                              .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_5").setName("l_carpal_proximal_phalanx_5").setDEF("hanim_l_carpal_proximal_phalanx_5")
                                                                .addChild(new Transform().setTranslation(new double[] {0.18333,0.7912440279,-0.0370575})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32473().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32474().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setName("l_carpal_proximal_interphalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_5").setCenter(new double[] {0.181665,0.7700400000000001,-0.0371475})
                                                                .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_5").setName("l_carpal_middle_phalanx_5").setDEF("hanim_l_carpal_middle_phalanx_5")
                                                                  .addChild(new Transform().setTranslation(new double[] {0.181665,0.7700400000000001,-0.0371475})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_5").setName("l_carpal_distal_interphalangeal_5").setDEF("hanim_l_carpal_distal_interphalangeal_5").setCenter(new double[] {0.18080999999999997,0.7468830000000001,-0.0369675})
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_5").setName("l_carpal_distal_phalanx_5").setDEF("hanim_l_carpal_distal_phalanx_5")
                                                                    .addChild(new Transform().setTranslation(new double[] {0.18080999999999997,0.7468830000000001,-0.0369675})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32481().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32482().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName("r_acromioclavicular").setDEF("hanim_r_acromioclavicular").setCenter(new double[] {-0.038474999999999995,1.4987880279,-0.01378575})
                                                    ...
                                                    .addChild(new Transform().setTranslation(new double[] {-0.038474999999999995,1.4987880279,-0.01378575})
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32485().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32486().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_acromioclavicular").setName("r_sternoclavicular").setDEF("hanim_r_sternoclavicular").setCenter(new double[] {-0.12294000000000001,1.4778630279000002,-0.012897})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new double[] {-0.1647,1.4614020279,-0.003267})
                                                      .addChild(new HAnimSegment("hanim_r_shoulder").setName("r_upperarm").setDEF("hanim_r_upperarm")
                                                        .addChild(new Transform().setTranslation(new double[] {-0.1647,1.4614020279,-0.003267})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32493().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32494().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new double[] {-0.1817325,1.1517119721,-0.005629499999999999})
                                                        .addChild(new HAnimSegment("hanim_r_elbow").setName("r_forearm").setDEF("hanim_r_forearm")
                                                          .addChild(new Transform().setTranslation(new double[] {-0.1817325,1.1517119721,-0.005629499999999999})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32497().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32498().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new double[] {-0.181575,0.8981009721000001,-0.005022})
                                                          .addChild(new HAnimSegment("hanim_r_radiocarpal").setName("r_carpal").setDEF("hanim_r_carpal")
                                                            .addChild(new Transform().setTranslation(new double[] {-0.181575,0.8981009721000001,-0.005022})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32501().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32502().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_1").setDEF("hanim_r_midcarpal_1").setCenter(new double[] {-0.18096749999999998,0.8755019721,0.019327499999999997})
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_1").setName("r_trapezium").setDEF("hanim_r_trapezium")
                                                              .addChild(new Transform().setTranslation(new double[] {-0.18096749999999998,0.8755019721,0.019327499999999997})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32505().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32506().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_1").setName("r_carpometacarpal_1").setDEF("hanim_r_carpometacarpal_1").setCenter(new double[] {-0.180135,0.8587620279,0.0259875})
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_1").setName("r_metacarpal_1").setDEF("hanim_r_metacarpal_1")
                                                                .addChild(new Transform().setTranslation(new double[] {-0.180135,0.8587620279,0.0259875})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32509().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32510().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setName("r_metacarpophalangeal_1").setDEF("hanim_r_metacarpophalangeal_1").setCenter(new double[] {-0.1806525,0.83421,0.035775})
                                                                .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_1").setName("r_carpal_proximal_phalanx_1").setDEF("hanim_r_carpal_proximal_phalanx_1")
                                                                  .addChild(new Transform().setTranslation(new double[] {-0.1806525,0.83421,0.035775})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setName("r_carpal_interphalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setCenter(new double[] {-0.1822725,0.811053,0.04965749999999999})
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_interphalangeal_1").setName("r_carpal_distal_phalanx_1").setDEF("hanim_r_carpal_distal_phalanx_1")
                                                                    .addChild(new Transform().setTranslation(new double[] {-0.1822725,0.811053,0.04965749999999999})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32517().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32518().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_2").setDEF("hanim_r_midcarpal_2").setCenter(new double[] {-0.18096749999999998,0.8766180000000001,0.00841725})
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_2").setName("r_trapezoid").setDEF("hanim_r_trapezoid")
                                                              .addChild(new Transform().setTranslation(new double[] {-0.18096749999999998,0.8766180000000001,0.00841725})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32521().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32522().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_2").setName("r_carpometacarpal_2").setDEF("hanim_r_carpometacarpal_2").setCenter(new double[] {-0.18089999999999998,0.8526239721000001,0.009729})
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_2").setName("r_metacarpal_2").setDEF("hanim_r_metacarpal_2")
                                                                .addChild(new Transform().setTranslation(new double[] {-0.18089999999999998,0.8526239721000001,0.009729})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setName("r_metacarpophalangeal_2").setDEF("hanim_r_metacarpophalangeal_2").setCenter(new double[] {-0.18335249999999997,0.790128,0.015075})
                                                                .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_2").setName("r_carpal_proximal_phalanx_2").setDEF("hanim_r_carpal_proximal_phalanx_2")
                                                                  .addChild(new Transform().setTranslation(new double[] {-0.18335249999999997,0.790128,0.015075})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32529().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32530().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setCenter(new double[] {-0.18132749999999997,0.7524629721,0.014183999999999999})
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_middle_phalanx_2").setDEF("hanim_r_carpal_middle_phalanx_2")
                                                                    .addChild(new Transform().setTranslation(new double[] {-0.18132749999999997,0.7524629721,0.014183999999999999})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32533().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32534().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setCenter(new double[] {-0.1802925,0.721215,0.01338525})
                                                                    .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_phalanx_2").setDEF("hanim_r_carpal_distal_phalanx_2")
                                                                      .addChild(new Transform().setTranslation(new double[] {-0.1802925,0.721215,0.01338525})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_3").setDEF("hanim_r_midcarpal_3").setCenter(new double[] {-0.18072,0.878571,-0.004797})
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_3").setName("r_capitate").setDEF("hanim_r_capitate")
                                                              .addChild(new Transform().setTranslation(new double[] {-0.18072,0.878571,-0.004797})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32541().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32542().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_3").setName("r_carpometacarpal_3").setDEF("hanim_r_carpometacarpal_3").setCenter(new double[] {-0.18072,0.850392,-0.00625275})
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_3").setName("r_metacarpal_3").setDEF("hanim_r_metacarpal_3")
                                                                .addChild(new Transform().setTranslation(new double[] {-0.18072,0.850392,-0.00625275})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32545().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32546().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setName("r_metacarpophalangeal_3").setDEF("hanim_r_metacarpophalangeal_3").setCenter(new double[] {-0.1833075,0.7873379721000001,-0.00391725})
                                                                .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_3").setName("r_carpal_proximal_phalanx_3").setDEF("hanim_r_carpal_proximal_phalanx_3")
                                                                  .addChild(new Transform().setTranslation(new double[] {-0.1833075,0.7873379721000001,-0.00391725})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setCenter(new double[] {-0.18132749999999997,0.7479989721000001,-0.003537})
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_middle_phalanx_3").setDEF("hanim_r_carpal_middle_phalanx_3")
                                                                    .addChild(new Transform().setTranslation(new double[] {-0.18132749999999997,0.7479989721000001,-0.003537})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32553().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32554().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setCenter(new double[] {-0.1802925,0.713403,-0.0037597499999999996})
                                                                    .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_phalanx_3").setDEF("hanim_r_carpal_distal_phalanx_3")
                                                                      .addChild(new Transform().setTranslation(new double[] {-0.1802925,0.713403,-0.0037597499999999996})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32557().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32558().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_4_5").setDEF("hanim_r_midcarpal_4_5").setCenter(new double[] {-0.18072,0.8752230279,-0.025739999999999996})
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_4_5").setName("r_hamate").setDEF("hanim_r_hamate")
                                                              .addChild(new Transform().setTranslation(new double[] {-0.18072,0.8752230279,-0.025739999999999996})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_4_5").setName("r_carpometacarpal_4").setDEF("hanim_r_carpometacarpal_4").setCenter(new double[] {-0.18072,0.85095,-0.01991925})
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_4").setName("r_metacarpal_4").setDEF("hanim_r_metacarpal_4")
                                                                .addChild(new Transform().setTranslation(new double[] {-0.18072,0.85095,-0.01991925})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32565().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32566().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setName("r_metacarpophalangeal_4").setDEF("hanim_r_metacarpophalangeal_4").setCenter(new double[] {-0.1833075,0.786222,-0.021440249999999998})
                                                                .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_4").setName("r_carpal_proximal_phalanx_4").setDEF("hanim_r_carpal_proximal_phalanx_4")
                                                                  .addChild(new Transform().setTranslation(new double[] {-0.1833075,0.786222,-0.021440249999999998})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32569().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32570().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setCenter(new double[] {-0.18132749999999997,0.7521839721,-0.020645999999999998})
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_middle_phalanx_4").setDEF("hanim_r_carpal_middle_phalanx_4")
                                                                    .addChild(new Transform().setTranslation(new double[] {-0.18132749999999997,0.7521839721,-0.020645999999999998})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setCenter(new double[] {-0.1802925,0.7200989721000001,-0.0197775})
                                                                    .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_phalanx_4").setDEF("hanim_r_carpal_distal_phalanx_4")
                                                                      .addChild(new Transform().setTranslation(new double[] {-0.1802925,0.7200989721000001,-0.0197775})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32577().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32578().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_carpometacarpal_5").setDEF("hanim_r_carpometacarpal_5").setCenter(new double[] {-0.18125999999999998,0.853461,-0.0327825})
                                                            .addChild(new HAnimSegment("hanim_r_carpometacarpal_5").setName("r_metacarpal_5").setDEF("hanim_r_metacarpal_5")
                                                              .addChild(new Transform().setTranslation(new double[] {-0.18125999999999998,0.853461,-0.0327825})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32581().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32582().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setName("r_metacarpophalangeal_5").setDEF("hanim_r_metacarpophalangeal_5").setCenter(new double[] {-0.18297,0.7912440279,-0.0370575})
                                                              .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_5").setName("r_carpal_proximal_phalanx_5").setDEF("hanim_r_carpal_proximal_phalanx_5")
                                                                .addChild(new Transform().setTranslation(new double[] {-0.18297,0.7912440279,-0.0370575})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_5").setCenter(new double[] {-0.181305,0.7700400000000001,-0.0371475})
                                                                .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_middle_phalanx_5").setDEF("hanim_r_carpal_middle_phalanx_5")
                                                                  .addChild(new Transform().setTranslation(new double[] {-0.181305,0.7700400000000001,-0.0371475})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32589().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32590().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setDEF("hanim_r_carpal_distal_interphalangeal_5").setCenter(new double[] {-0.18044999999999997,0.7468830000000001,-0.0369675})
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_5").setName("r_carpal_distal_phalanx_5").setDEF("hanim_r_carpal_distal_phalanx_5")
                                                                    .addChild(new Transform().setTranslation(new double[] {-0.18044999999999997,0.7468830000000001,-0.0369675})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32593().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32594().getArray())
...
private class MFFloat4 {
  private org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new double[] {1.86});
  }
}
...
private class MFVec3f125 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.00280125,-0.008364420000000001,0.00452925,0.004887,-0.00112158,0.0065115,0.00378,0.00522009,0.00528075,-0.0026955,0.00567207,0.006684749999999999,-0.0025942499999999998,-0.00091791,0.0079335,-0.0028192499999999997,-0.008364420000000001,0.00555525,0.0045135,-0.0085095,-0.00142875,0.0060795,-0.00083142,-0.001701,0.005190749999999999,0.00768366,-0.0014647500000000001,-0.006117749999999999,0.0085095,0.00076275,-0.006932249999999999,-0.0009346500000000001,0.00125775,-0.005168249999999999,-0.00837558,0.00048374999999999997,0.00172575,-0.00532332,-0.00511875,0.0026887499999999997,-0.0006138,-0.0052785,0.0021285,0.00473742,-0.0051277499999999995,-0.004824,0.0052452,-0.00383175,-0.00529875,-0.00060543,-0.0033929999999999997,-0.00422775,-0.00523962,-0.004005});
  }
}
...
private class MFVec3f241 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.09400499999999999,0.031080600000000003,0.08349749999999999,0.1296,0.032084999999999995,0.039465,0.0342,0.026714250000000002,-0.088155,0.088875,0.02698488,-0.062459999999999995,0.1194525,0.029908800000000003,-0.02204325,0.0852525,0.0011048400000000002,0.0668025,0.116235,0.00198927,0.0325125,0.0358425,-0.00222642,-0.06561,0.081,-0.00159867,-0.0469575,0.1089225,-0.00028737,-0.01539225,0.0367875,0.0302157,0.097245,0.035887499999999996,0.000025110000000000002,0.07661249999999999,0,0.000025110000000000002,0.07661249999999999,0,0.0302157,0.097245,-0.035887499999999996,0.000025110000000000002,0.07661249999999999,-0.0852525,0.0011048400000000002,0.0668025,-0.09400499999999999,0.031080600000000003,0.08349749999999999,-0.0367875,0.0302157,0.097245,-0.116235,0.00198927,0.0325125,-0.1296,0.032084999999999995,0.039465,-0.081,-0.00159867,-0.0469575,-0.0358425,-0.00222642,-0.06561,-0.0342,0.026714250000000002,-0.088155,-0.088875,0.02698488,-0.062459999999999995,-0.1089225,-0.00028737,-0.01539225,-0.1194525,0.029908800000000003,-0.02204325,0,-0.00222642,-0.06561,0,0.026714250000000002,-0.088155,0.0362025,0.04109670000000001,0.0922275,0.0911925,0.04109670000000001,0.07901999999999999,0.12429,0.04109670000000001,0.03807,0.11470499999999999,0.04109670000000001,-0.02000925,0.085635,0.04109670000000001,-0.05688,0.033075,0.04109670000000001,-0.08158499999999999,0,0.04109670000000001,-0.08158499999999999,-0.033075,0.04109670000000001,-0.08158499999999999,-0.085635,0.04109670000000001,-0.05688,-0.11470499999999999,0.04109670000000001,-0.02000925,-0.12429,0.04109670000000001,0.03807,-0.0911925,0.04109670000000001,0.07901999999999999,-0.0362025,0.04109670000000001,0.0922275,0,0.04109670000000001,0.0922275});
  }
}
...
private class MFVec3f273 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.031904999999999996,0.00016461,0.075645,0.08757,0.00016461,-0.04185,0.1152225,0.00016461,-0.015732,0.0897075,0.00016461,0.07332749999999999,0.12602249999999998,0.00016461,0.028912499999999997,0.0386325,0.00016461,-0.05688,0,0.00016461,0.0756675,0.033209999999999996,0.01820196,0.0794925,0.0907425,0.01820196,-0.0437175,0.1185975,0.01820196,-0.017880749999999997,0.0925875,0.01820196,0.080595,0.1314,0.01820196,0.029137499999999997,0.0415125,0.01820196,-0.057554999999999995,0,0.01820196,0.0794925,-0.033209999999999996,0.01820196,0.0794925,-0.031904999999999996,0.00016461,0.075645,-0.0897075,0.00016461,0.07332749999999999,-0.0925875,0.01820196,0.080595,-0.0415125,0.01820196,-0.057554999999999995,-0.0386325,0.00016461,-0.05688,0,0.00016461,-0.057217500000000004,0,0.01820196,-0.05805,-0.12602249999999998,0.00016461,0.028912499999999997,-0.1314,0.01820196,0.029137499999999997,-0.0907425,0.01820196,-0.0437175,-0.08757,0.00016461,-0.04185,-0.1185975,0.01820196,-0.017880749999999997,-0.1152225,0.00016461,-0.015732,0.0876375,-0.00791802,0.06916499999999999,0.0318375,-0.00791802,0.0713925,0,-0.00791802,0.0713925,-0.0318375,-0.00791802,0.0713925,-0.0876375,-0.00791802,0.06916499999999999,-0.12138749999999998,-0.00791802,0.027877500000000003,-0.111375,-0.00791802,-0.0135045,-0.085365,-0.00791802,-0.03807,-0.03798,-0.00791802,-0.0526275,0,-0.00791802,-0.052965,0.03798,-0.00791802,-0.0526275,0.085365,-0.00791802,-0.03807,0.111375,-0.00791802,-0.0135045,0.12138749999999998,-0.00791802,0.027877500000000003,0.0885825,0.027185760000000003,-0.039915,0.040905,0.027185760000000003,-0.0533025,0,0.027185760000000003,-0.0537975,-0.040905,0.027185760000000003,-0.0533025,-0.0885825,0.027185760000000003,-0.039915,-0.11481749999999999,0.027185760000000003,-0.015588,-0.1267425,0.027185760000000003,0.028237499999999995,-0.090495,0.027185760000000003,0.0762975,-0.033255,0.027185760000000003,0.07523999999999999,0,0.027185760000000003,0.07523999999999999,0.033255,0.027185760000000003,0.07523999999999999,0.090495,0.027185760000000003,0.0762975,0.1267425,0.027185760000000003,0.028237499999999995,0.11481749999999999,0.027185760000000003,-0.015588});
  }
}
private class MFVec2f274 {
  private org.web3d.x3d.jsail.fields.MFVec2f getArray() {
...
private class MFVec3f317 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.01208025,0.01522224,-0.02529,0.0256275,0.01522224,-0.019134,0.035145,0.01522224,0.00164025,0.0274275,0.01522224,0.01609425,0,0.01522224,0.0268875,-0.0136125,0.01522224,0.0247725,-0.0256275,0.01522224,-0.019134,-0.035145,0.01522224,0.00164025,0,0.01522224,-0.0268875,0.0136125,0.01522224,0.0247725,-0.01208025,0.01522224,-0.02529,-0.0274275,0.01522224,0.01609425,0.01208025,0.00003348,-0.02529,0.0256275,0.00003348,-0.019134,0.035145,0.00003348,0.00164025,0.0274275,0.00003348,0.01609425,0,0.00003348,0.0268875,-0.0136125,0.00003348,0.0247725,-0.0256275,0.00003348,-0.019134,-0.035145,0.00003348,0.00164025,0,0.00003348,-0.0268875,0.0136125,0.00003348,0.0247725,-0.01208025,0.00003348,-0.02529,-0.0274275,0.00003348,0.01609425,0.011130749999999998,0.02074086,-0.021033,0,0.02074086,-0.0225,-0.011130749999999998,0.02074086,-0.021033,-0.02268,0.02074086,-0.015785999999999998,-0.030622499999999997,0.02074086,0.0015525,-0.0245475,0.02074086,0.01290375,-0.0122895,0.02074086,0.0206145,0,0.02074086,0.022522499999999997,0.0122895,0.02074086,0.0206145,0.0245475,0.02074086,0.01290375,0.030622499999999997,0.02074086,0.0015525,0.02268,0.02074086,-0.015785999999999998,0,-0.00636678,-0.0225,0.011130749999999998,-0.00636678,-0.021033,0.02268,-0.00636678,-0.015785999999999998,0.030622499999999997,-0.00636678,0.0015525,0.0245475,-0.00636678,0.01290375,0.0122895,-0.00636678,0.0206145,0,-0.00636678,0.022522499999999997,-0.0122895,-0.00636678,0.0206145,-0.0245475,-0.00636678,0.01290375,-0.030622499999999997,-0.00636678,0.0015525,-0.02268,-0.00636678,-0.015785999999999998,-0.011130749999999998,-0.00636678,-0.021033});
  }
}
...
private class MFVec3f321 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.01208025,0.01611504,-0.02529,0.0256275,0.01611504,-0.019134,0.035145,0.01611504,0.00164025,0.0274275,0.01611504,0.01609425,0,0.01611504,0.0268875,-0.0136125,0.01611504,0.0247725,-0.0256275,0.01611504,-0.019134,-0.035145,0.01611504,0.00164025,0,0.01611504,-0.0268875,0.0136125,0.01611504,0.0247725,-0.01208025,0.01611504,-0.02529,-0.0274275,0.01611504,0.01609425,0.01208025,0.00004743,-0.02529,0.0256275,0.00004743,-0.019134,0.035145,0.00004743,0.00164025,0.0274275,0.00004743,0.01609425,0,0.00004743,0.0268875,-0.0136125,0.00004743,0.0247725,-0.0256275,0.00004743,-0.019134,-0.035145,0.00004743,0.00164025,0,0.00004743,-0.0268875,0.0136125,0.00004743,0.0247725,-0.01208025,0.00004743,-0.02529,-0.0274275,0.00004743,0.01609425,0.011130749999999998,0.02163366,-0.021033,0,0.02163366,-0.0225,-0.011130749999999998,0.02163366,-0.021033,-0.02268,0.02163366,-0.015785999999999998,-0.030622499999999997,0.02163366,0.0015525,-0.0245475,0.02163366,0.01290375,-0.0122895,0.02163366,0.0206145,0,0.02163366,0.022522499999999997,0.0122895,0.02163366,0.0206145,0.0245475,0.02163366,0.01290375,0.030622499999999997,0.02163366,0.0015525,0.02268,0.02163366,-0.015785999999999998,0,-0.006662520000000001,-0.0225,0.011130749999999998,-0.006662520000000001,-0.021033,0.02268,-0.006662520000000001,-0.015785999999999998,0.030622499999999997,-0.006662520000000001,0.0015525,0.0245475,-0.006662520000000001,0.01290375,0.0122895,-0.006662520000000001,0.0206145,0,-0.006662520000000001,0.022522499999999997,-0.0122895,-0.006662520000000001,0.0206145,-0.0245475,-0.006662520000000001,0.01290375,-0.030622499999999997,-0.006662520000000001,0.0015525,-0.02268,-0.006662520000000001,-0.015785999999999998,-0.011130749999999998,-0.006662520000000001,-0.021033});
  }
}
...
private class MFVec3f329 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.01208025,0.014552639999999999,-0.02529,0,0.014552639999999999,-0.0268875,0.0256275,0.014552639999999999,-0.019134,0.035145,0.014552639999999999,0.0016424999999999999,0.0274275,0.014552639999999999,0.01609425,0.0136125,0.014552639999999999,0.0247725,0,0.014552639999999999,0.0268875,-0.01208025,0.014552639999999999,-0.02529,-0.0256275,0.014552639999999999,-0.019134,-0.035145,0.014552639999999999,0.00164025,-0.0274275,0.014552639999999999,0.01609425,-0.0136125,0.014552639999999999,0.0247725,0.0107955,0.021178890000000002,-0.020805749999999998,0,0.021178890000000002,-0.02223675,-0.0107955,0.021178890000000002,-0.020805749999999998,-0.022149000000000002,0.021178890000000002,-0.01564425,-0.0299925,0.021178890000000002,0.001485,-0.02394,0.021178890000000002,0.0128385,-0.011963249999999998,0.021178890000000002,0.020367,0,0.021178890000000002,0.02222325,0.011963249999999998,0.021178890000000002,0.020367,0.02394,0.021178890000000002,0.0128385,0.0299925,0.021178890000000002,0.001485,0.022149000000000002,0.021178890000000002,-0.01564425,0.01208025,0.000050220000000000004,-0.02529,0.0256275,0.000050220000000000004,-0.019134,0.035145,0.000050220000000000004,0.0016424999999999999,0.0274275,0.000050220000000000004,0.01609425,0,0.000050220000000000004,0.0268875,-0.0136125,0.000050220000000000004,0.0247725,-0.0256275,0.000050220000000000004,-0.019134,-0.035145,0.000050220000000000004,0.00164025,0,0.000050220000000000004,-0.0268875,0.0136125,0.000050220000000000004,0.0247725,-0.01208025,0.000050220000000000004,-0.02529,-0.0274275,0.000050220000000000004,0.01609425,0,-0.005987340000000001,-0.0225,0.011130749999999998,-0.005987340000000001,-0.021033,0.02268,-0.005987340000000001,-0.015785999999999998,0.030622499999999997,-0.005987340000000001,0.0015525,0.0245475,-0.005987340000000001,0.01290375,0.0122895,-0.005987340000000001,0.0206145,0,-0.005987340000000001,0.022522499999999997,-0.0122895,-0.005987340000000001,0.0206145,-0.0245475,-0.005987340000000001,0.01290375,-0.030622499999999997,-0.005987340000000001,0.0015525,-0.02268,-0.005987340000000001,-0.015785999999999998,-0.011130749999999998,-0.005987340000000001,-0.021033});
  }
}
...
private class MFVec3f375 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.112275,0.0029016,-0.019448999999999998,0.11414250000000001,0.01393047,0.0010575,0.105885,0.00472905,0.026954999999999996,0.1041975,-0.0507501,0.02484,0.103185,-0.0459792,-0.0028079999999999997,0.07596,0.010836360000000001,0.039847499999999994,0.0875475,0.027593100000000002,-0.00120825,0.09434249999999998,-0.069471,-0.01285425,0.09873,-0.069471,0.0321525,0.0846225,0.00903402,-0.03807,-0.00278325,0.01761048,-0.00423675,-0.00278325,0.008389530000000001,-0.021208499999999998,-0.00278325,-0.0395622,-0.00579825,-0.00278325,-0.0388368,0.014093999999999999,-0.00278325,0.00721494,0.01840275});
  }
}
...
private class MFVec3f535 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0018945,-0.0314433,-0.00812475,0.00955575,-0.031136400000000005,0.0045225000000000005,-0.006606000000000001,-0.0280116,0.0047339999999999995,-0.00864675,-0.00556326,0.005190749999999999,-0.00864675,-0.00541539,-0.0062955,0.009576,0.00031248,-0.0062482499999999995,-0.00945675,0.00322524,-0.0062235,0.009576,0.00016461,0.005238,-0.00945675,0.00308016,0.0052604999999999996,0.0054315,0.00570555,-0.0062032499999999996,0.0054315,0.00555768,0.00528075,-0.00396225,0.0052647300000000005,0.0052785,-0.00396225,0.0054126,-0.006205499999999999,0.0005737499999999999,-0.00034038000000000004,-0.00865125,0.0005737499999999999,-0.0005691600000000001,0.00793575,0.0018877499999999999,-0.0316665,0.007217999999999999,-0.0037957499999999996,-0.0377487,0.004221,0.0016875,-0.038780999999999996,0.0044055,0.00956025,-0.0309969,-0.0057195,0.00801675,-0.0357678,0.0036,0.008019,-0.0356562,-0.004862249999999999,-0.0066015,-0.027866520000000002,-0.0059085,-0.00379125,-0.0376092,-0.00549225,0.001692,-0.0386694,-0.005517});
  }
}

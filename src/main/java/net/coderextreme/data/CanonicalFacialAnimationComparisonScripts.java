...
ProtoInstance ProtoInstance29 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("title").setContent("CanonicalFacialAnimationComparisonScripts.x3d"))
        .addMeta(new meta().setName("identifier").setContent("https://github.com/coderextreme/ci2had/CanonicalFacialAnimationComparisonScripts.x3d"))
        ...
        .addMeta(new meta().setName("modified").setContent("22 December 2024"))
        .addMeta(new meta().setName("creator").setContent("John Carlson, Joe Williams, Gyu Ri Cho, Hyun Ho Chu, Min Joo Lee, Yujin Jung")))
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle("CanonicalFacialAnimationComparisonScripts.x3d"))
        .addChild(new Viewpoint().setPosition(new float[] {0f ,20f ,110f }))
        .addChild(new Background().setSkyColor(new MFColor0().getArray()))
        .addChild(new NavigationInfo().setType("\"EXAMINE\""))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinBlink").setKey(new MFFloat1().getArray()).setKeyValue(new MFFloat2().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinBrowLowerer").setKey(new MFFloat3().getArray()).setKeyValue(new MFFloat4().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinCheekPuffer").setKey(new MFFloat5().getArray()).setKeyValue(new MFFloat6().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinCheekRaiser").setKey(new MFFloat7().getArray()).setKeyValue(new MFFloat8().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinChinRaiser").setKey(new MFFloat9().getArray()).setKeyValue(new MFFloat10().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinDimpler").setKey(new MFFloat11().getArray()).setKeyValue(new MFFloat12().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinEyesClosed").setKey(new MFFloat13().getArray()).setKeyValue(new MFFloat14().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinInnerBrowRaiser").setKey(new MFFloat15().getArray()).setKeyValue(new MFFloat16().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinJawDrop").setKey(new MFFloat17().getArray()).setKeyValue(new MFFloat18().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLidDroop").setKey(new MFFloat19().getArray()).setKeyValue(new MFFloat20().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLidTightener").setKey(new MFFloat21().getArray()).setKeyValue(new MFFloat22().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLipCornerDepressor").setKey(new MFFloat23().getArray()).setKeyValue(new MFFloat24().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLipCornerPuller").setKey(new MFFloat25().getArray()).setKeyValue(new MFFloat26().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLipFunneler").setKey(new MFFloat27().getArray()).setKeyValue(new MFFloat28().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLipPressor").setKey(new MFFloat29().getArray()).setKeyValue(new MFFloat30().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLipPuckerer").setKey(new MFFloat31().getArray()).setKeyValue(new MFFloat32().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLipsPart").setKey(new MFFloat33().getArray()).setKeyValue(new MFFloat34().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLipStretcher").setKey(new MFFloat35().getArray()).setKeyValue(new MFFloat36().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLipSuck").setKey(new MFFloat37().getArray()).setKeyValue(new MFFloat38().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLipTightener").setKey(new MFFloat39().getArray()).setKeyValue(new MFFloat40().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinLowerLipDepressor").setKey(new MFFloat41().getArray()).setKeyValue(new MFFloat42().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinMouthStretch").setKey(new MFFloat43().getArray()).setKeyValue(new MFFloat44().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinNasolabialDeepener").setKey(new MFFloat45().getArray()).setKeyValue(new MFFloat46().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinNoseWrinkler").setKey(new MFFloat47().getArray()).setKeyValue(new MFFloat48().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinOuterBrowRaiser").setKey(new MFFloat49().getArray()).setKeyValue(new MFFloat50().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinSlit").setKey(new MFFloat51().getArray()).setKeyValue(new MFFloat52().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinSquint").setKey(new MFFloat53().getArray()).setKeyValue(new MFFloat54().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinUpperLidRaiser").setKey(new MFFloat55().getArray()).setKeyValue(new MFFloat56().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinUpperLipRaiser").setKey(new MFFloat57().getArray()).setKeyValue(new MFFloat58().getArray()))
        .addChild(new ScalarInterpolator().setDEF("AnimationAdapter_JinWink").setKey(new MFFloat59().getArray()).setKeyValue(new MFFloat60().getArray()))
        .addChild(new Group()
          .addChild(new HAnimHumanoid().setName("humanoid").setDEF("hanim0_humanoid").setVersion("2.0")
            .addSkeleton(new HAnimJoint("hanim0_humanoid").setName("humanoid_root").setDEF("hanim0_humanoid_root").setUlimit(new MFFloat61().getArray()).setLlimit(new MFFloat62().getArray())
              .addChild(new HAnimSegment("hanim0_humanoid_root").setName("sacrum").setDEF("hanim0_sacrum"))
              .addChild(new HAnimJoint("hanim0_humanoid_root").setName("skullbase").setDEF("hanim0_skullbase").setUlimit(new MFFloat63().getArray()).setLlimit(new MFFloat64().getArray())
...
"            }\n"+
"        }"))
              .addChild(new ROUTE().setFromField("touchTime").setFromNode("StartStopAnimationUnit_Sensor").setToField("inTime").setToNode("ScriptToggle"))
              .addChild(new ROUTE().setFromField("diffuseColor").setFromNode("MenuBackground_Material").setToField("diffuseColor").setToNode("ScriptToggle"))
              .addChild(new ROUTE().setFromField("diffuseColor").setFromNode("ScriptToggle").setToField("diffuseColor").setToNode("MenuBackground_Material"))
              .addChild(new ROUTE().setFromField("touchTime").setFromNode("StartStopAnimationUnit_Sensor").setToField("startTime").setToNode("Main_Clock")))))

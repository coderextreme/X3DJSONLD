...
ProtoInstanceObject ProtoInstance3 = null;
      ...
      .setScene(new SceneObject()
        .addChild(new ExternProtoDeclareObject().setName("ViewPositionOrientation").setUrl(new MFStringObject(new MFString0().getArray()))
          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("enabled"))
          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setName("traceEnabled"))
          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setName("set_traceEnabled"))
          .addField(new fieldObject().setType("SFVec3f").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setName("position_changed"))
          .addField(new fieldObject().setType("SFRotation").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setName("orientation_changed"))
          .addField(new fieldObject().setType("MFString").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setName("outputViewpointString")))
        ...
        .addChild(new ProtoDeclareObject().setName("EmissiveMaterial")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setType("SFColor").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("onlyColor").setValue("1 0 0")))
          .setProtoBody(new ProtoBodyObject()

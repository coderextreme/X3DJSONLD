...
ProtoInstance ProtoInstance3 = null;
      ...
      .setScene(new Scene()
        .addChild(new ExternProtoDeclare().setName("ViewPositionOrientation").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString0().getArray()))
        ...
        .addChild(new ProtoDeclare().setName("ShiftGroupUp2m")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("MFNode").setName("children").setAccessType(field.ACCESSTYPE_INPUTOUTPUT)
              .addChild(new Group().setDEF("DefaultNodeValue").setBboxSize(new float[] {2f,2f,2f}).setBboxCenter(new float[] {0f,0f,0f})
        ...
        .addChild(new Group().setDEF("ExampleChildElement").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
        ...
        .addChild(new Transform().setDEF("TransformExampleUSE").setRotation(new float[] {0f,1f,0f,0.78f}).setTranslation(new float[] {0f,2.5f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
        ...
        .addChild(new Collision().setEnabled(true).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .setProxy(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
        ...
        .addChild(new Transform().setTranslation(new float[] {0f,-2.5f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray()))
              .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())).setSize(0.6f)))))
        ...
        .addChild(new OrientationInterpolator().setDEF("Spinner").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat3().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation4().getArray())))
        ...
        .addChild(new Inline().setDEF("someInline").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
        .addChild(new IMPORT().setAS("someInlineRoot").setImportedDEF("someName").setInlineDEF("someInline"))
        .addChild(new PositionInterpolator().setDEF("StayInPlace").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat6().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f7().getArray())))
...
protected class MFString5 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"someUrl.x3d","http://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/someUrl.x3d"});
  }
}

    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("HAnim").setDEF("hanim_HAnim").setInfo(new MFString10().getArray()).setVersion("2.0")
          ...
          .addSkeleton(new HAnimJoint("hanim_HAnim").setName("").setDEF("hanim_").setUlimit(new MFFloat21().getArray()).setLlimit(new MFFloat22().getArray()))
          .addJoints(new HAnimJoint("hanim_HAnim").setUSE("hanim_"))))      ;
    return X3D0;
    }

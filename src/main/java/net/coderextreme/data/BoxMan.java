...
ProtoInstance ProtoInstance0 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new ExternProtoDeclare().setName("LOA1_WalkAnimation").setUrl(new MFString47().getArray())
        ...
        .addChild(new Script().setDEF("ENGINE").setDirectOutput(true).setUrl(new MFString48().getArray())

...
ProtoInstance ProtoInstance0 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Humanoid").setDEF("boxman_Humanoid").setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())).setVersion("1.0")
          .addJoints(new HAnimJoint().setName("humanoid_root").setDEF("boxman_humanoid_root").setCenter(new float[] {0f,0.9723f,-0.0728f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt324().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat5().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addViewpoints(new HAnimSite().setName("BoxMan_view").setDEF("boxman_BoxMan_view").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
        ...
        .addChild(new ExternProtoDeclare().setName("LOA1_WalkAnimation").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString47().getArray()))

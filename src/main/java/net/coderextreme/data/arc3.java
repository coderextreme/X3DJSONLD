...
public class arc3 implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/arc3.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("arc3.x3d")))
        ...
        .addChild(new Group()
          ...
          .addChild(new Script().setDEF(new SFString("DECLx3dconnector_connector1_S1"))
            .addField(new field().setType("SFNode").setName(new SFString("startnode")).setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
              .addChild(new Group().setUSE(new SFString("DECLpoint_G1_node"))))
            .addField(new field().setType("SFNode").setName(new SFString("endnode")).setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
              .addChild(new Group().setUSE(new SFString("DECLpoint_G2_node"))))
...
"        }")))
        .addChild(new ROUTE().setFromNode(new SFString("DECLpoint_G1_node")).setFromField(new SFString("translation")).setToNode(new SFString("DECLx3dconnector_connector1_S1")).setToField(new SFString("set_startpoint")))
        .addChild(new ROUTE().setFromNode(new SFString("DECLpoint_G2_node")).setFromField(new SFString("translation")).setToNode(new SFString("DECLx3dconnector_connector1_S1")).setToField(new SFString("set_endpoint"))));
    return X3D0;
    }

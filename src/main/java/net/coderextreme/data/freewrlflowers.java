...
ProtoInstance ProtoInstance6 = null;
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("freewrlflowers.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/freewrlflowers.x3d"))))
      .setScene(new Scene()
...
ProtoInstance0
                  .addFieldValue(new fieldValue().setName(new SFString("vertex")).setValue(new SFString("\"../shaders/freewrl_flowers_chromatic.vs\"")));
ProtoInstance0
                  .addFieldValue(new fieldValue().setName(new SFString("fragment")).setValue(new SFString("\"../shaders/freewrl.fs\"")));
    return X3D0;
    }

  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("KoreanCharacter03Hyun.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("../Poses/images/HAnimPoseExampleKoreanCharacter03Hyun.png")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter03Hyun.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("KoreanCharacter03Hyun.x3d")))
        .addChild(new NavigationInfo().setSpeed(1.5f ))
        .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,1f ,0f }).setDescription(new SFString("Hyun")).setPosition(new float[] {0f ,1f ,3f }))
        .addChild(new HAnimHumanoid().setName(new SFString("Hyun")).setDEF(new SFString("hanim_Hyun")).setScale(new float[] {0.0225f ,0.0225f ,0.0225f }).setVersion(new SFString("2.0"))
          ...
          .addSkeleton(new HAnimJoint("hanim_Hyun").setName(new SFString("humanoid_root")).setDEF(new SFString("hanim_humanoid_root")).setCenter(new float[] {0f ,31.43f ,-0.5601f }).setUlimit(new MFFloat6().getArray()).setLlimit(new MFFloat7().getArray())
              ...
              .addChild(new Transform().setTranslation(new float[] {0f ,31.43f ,-0.5601f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF(new SFString("HyunTextureAtlas")).setUrl(new MFString8().getArray())))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("l_hip")).setDEF(new SFString("hanim_l_hip")).setCenter(new float[] {3.551f ,29.33f ,-0.1267f }).setUlimit(new MFFloat13().getArray()).setLlimit(new MFFloat14().getArray())
              .addChild(new HAnimSegment("hanim_l_hip").setName(new SFString("l_thigh")).setDEF(new SFString("hanim_l_thigh"))
                .addChild(new Transform().setTranslation(new float[] {3.551f ,29.33f ,-0.1267f })
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                      .setTexture(new ImageTexture().setUSE(new SFString("HyunTextureAtlas"))))
              ...
              .addChild(new HAnimJoint("hanim_l_hip").setName(new SFString("l_knee")).setDEF(new SFString("hanim_l_knee")).setCenter(new float[] {3.71f ,15.48f ,-0.1446f }).setUlimit(new MFFloat19().getArray()).setLlimit(new MFFloat20().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_knee").setName(new SFString("l_talocrural")).setDEF(new SFString("hanim_l_talocrural")).setCenter(new float[] {3.388f ,3.168f ,-0.537f }).setUlimit(new MFFloat25().getArray()).setLlimit(new MFFloat26().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_talocrural").setName(new SFString("l_metatarsophalangeal_2")).setDEF(new SFString("hanim_l_metatarsophalangeal_2")).setCenter(new float[] {3.388f ,2.908f ,0.7441f }).setUlimit(new MFFloat31().getArray()).setLlimit(new MFFloat32().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("r_hip")).setDEF(new SFString("hanim_r_hip")).setCenter(new float[] {-3.551f ,29.33f ,-0.1267f }).setUlimit(new MFFloat37().getArray()).setLlimit(new MFFloat38().getArray())
              ...
              .addChild(new HAnimJoint("hanim_r_hip").setName(new SFString("r_knee")).setDEF(new SFString("hanim_r_knee")).setCenter(new float[] {-3.71f ,15.48f ,-0.1446f }).setUlimit(new MFFloat43().getArray()).setLlimit(new MFFloat44().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_knee").setName(new SFString("r_talocrural")).setDEF(new SFString("hanim_r_talocrural")).setCenter(new float[] {-3.388f ,3.168f ,-0.537f }).setUlimit(new MFFloat49().getArray()).setLlimit(new MFFloat50().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_talocrural").setName(new SFString("r_metatarsophalangeal_2")).setDEF(new SFString("hanim_r_metatarsophalangeal_2")).setCenter(new float[] {-3.388f ,2.908f ,0.7441f }).setUlimit(new MFFloat55().getArray()).setLlimit(new MFFloat56().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("sacroiliac")).setDEF(new SFString("hanim_sacroiliac")).setCenter(new float[] {0f ,26.58f ,-0.5601f }).setUlimit(new MFFloat61().getArray()).setLlimit(new MFFloat62().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("l_shoulder")).setDEF(new SFString("hanim_l_shoulder")).setCenter(new float[] {5.502f ,45.779999f ,-0.3559f }).setUlimit(new MFFloat67().getArray()).setLlimit(new MFFloat68().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_shoulder").setName(new SFString("l_elbow")).setDEF(new SFString("hanim_l_elbow")).setCenter(new float[] {6.735f ,35.669998f ,-0.4487f }).setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_elbow").setName(new SFString("l_radiocarpal")).setDEF(new SFString("hanim_l_radiocarpal")).setCenter(new float[] {6.432f ,27.83f ,-0.1589f }).setUlimit(new MFFloat79().getArray()).setLlimit(new MFFloat80().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("r_shoulder")).setDEF(new SFString("hanim_r_shoulder")).setCenter(new float[] {-5.502f ,45.779999f ,-0.3559f }).setUlimit(new MFFloat85().getArray()).setLlimit(new MFFloat86().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_shoulder").setName(new SFString("r_elbow")).setDEF(new SFString("hanim_r_elbow")).setCenter(new float[] {-6.735f ,35.669998f ,-0.4487f }).setUlimit(new MFFloat91().getArray()).setLlimit(new MFFloat92().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_elbow").setName(new SFString("r_radiocarpal")).setDEF(new SFString("hanim_r_radiocarpal")).setCenter(new float[] {-6.432f ,27.83f ,-0.1589f }).setUlimit(new MFFloat97().getArray()).setLlimit(new MFFloat98().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("vl5")).setDEF(new SFString("hanim_vl5")).setCenter(new float[] {0f ,35.77f ,-0.5028f }).setUlimit(new MFFloat103().getArray()).setLlimit(new MFFloat104().getArray())
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("skullbase")).setDEF(new SFString("hanim_skullbase")).setCenter(new float[] {0f ,49.98f ,-0.5228f }).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())
          ...
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_humanoid_root")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_sacroiliac")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_skullbase")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_vl5")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_l_elbow")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_r_elbow")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_l_hip")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_r_hip")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_l_knee")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_r_knee")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_l_metatarsophalangeal_2")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_r_metatarsophalangeal_2")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_l_radiocarpal")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_r_radiocarpal")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_l_shoulder")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_r_shoulder")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_l_talocrural")))
          .addJoints(new HAnimJoint("hanim_Hyun").setUSE(new SFString("hanim_r_talocrural"))))
        .addChild(new EXPORT().setAS(new SFString("KoreanCharacter03Hyun")).setLocalDEF(new SFString("hanim_Hyun"))));
    return X3D0;
    }

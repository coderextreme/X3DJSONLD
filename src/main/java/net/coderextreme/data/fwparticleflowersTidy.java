...
public class fwparticleflowersTidy implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new fwparticleflowersTidy().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/fwparticleflowersTidy.new.java.x3d");
    model.toFileJSON("../data/fwparticleflowersTidy.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("Tour Views").setPosition(new float[] {0f ,0f ,12f }))
          ...
          .addChild(new ParticleSystem().setGeometryType("GEOMETRY").setMaxParticles(20)
            ...
            .setAppearance(new Appearance()
              ...
              .setTexture(new ComposedCubeMapTexture().setDEF("texture")
                .setFrontTexture(new ImageTexture().setUrl(new MFString6().getArray()))
                .setBackTexture(new ImageTexture().setUrl(new MFString7().getArray()))
                .setLeftTexture(new ImageTexture().setUrl(new MFString8().getArray()))
                .setRightTexture(new ImageTexture().setUrl(new MFString9().getArray()))
                .setTopTexture(new ImageTexture().setUrl(new MFString10().getArray()))
                .setBottomTexture(new ImageTexture().setUrl(new MFString11().getArray())))
              .addShaders(new ComposedShader().setDEF("fw").setLanguage("GLSL")
                .addParts(new ShaderPart().setUrl(new MFString12().getArray()))
                ...
                .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("a").setValue("2"))
                .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("b").setValue("1"))
                .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("c").setValue("5"))
                .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("d").setValue("5"))
...
"			}")))
        ...
        .addChild(new ROUTE().setFromNode("Animate").setFromField("a_changed").setToNode("fw").setToField("set_a"))
        .addChild(new ROUTE().setFromNode("Animate").setFromField("b_changed").setToNode("fw").setToField("set_b"))
        .addChild(new ROUTE().setFromNode("Animate").setFromField("c_changed").setToNode("fw").setToField("set_c"))
        .addChild(new ROUTE().setFromNode("Animate").setFromField("d_changed").setToNode("fw").setToField("set_d"))
        .addChild(new ROUTE().setFromNode("Animate").setFromField("pdelta_changed").setToNode("fw").setToField("set_pdelta"))
        .addChild(new ROUTE().setFromNode("Animate").setFromField("tdelta_changed").setToNode("fw").setToField("set_tdelta")));
    return X3D0;
    }
...
private class MFString12 {
  private org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs"});
  }
}
private class MFString13 {
  private org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"});
  }
}
}

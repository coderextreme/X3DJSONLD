        ...
        .addChild(new Transform()
          .addChild(new ParticleSystem().setMaxParticles(20).setGeometryType(new SFString("GEOMETRY"))
            ...
            .setAppearance(new Appearance()
              ...
              .addComments(new CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"'></ShaderPart>"))
              .addComments(new CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' type='FRAGMENT'></ShaderPart>"))
              .addComments(new CommentsBlock("</ComposedShader>"))
              .addComments(new CommentsBlock("<ComposedShader DEF=\"shader\" language=\"GLSL\">"))
              ...
              .addComments(new CommentsBlock("<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/>"))
              .addComments(new CommentsBlock("<ShaderPart type='FRAGMENT' url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/>"))
              .addComments(new CommentsBlock("</ComposedShader>"))

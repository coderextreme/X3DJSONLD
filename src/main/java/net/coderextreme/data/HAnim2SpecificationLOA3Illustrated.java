    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("humanoid").setDEF("hanim_humanoid").setLoa(3).setVersion("2.0")
          ...
          .addComments(new CommentsBlock("Only one root HAnimJoint is allowed"))
          .addComments(new CommentsBlock("HAnimHumanoid original info='\"authorName=Matthew T. Beitler Joe D. Williams Don Brutzman\" \"authorEmail=HAnim@web3D.org\" \"copyright=none\" \"creationDate=12 May 1999\" \"usageRestrictions=none\" \"humanoidVersion=2.0\" \"height=1.7504\"'"))
          .addComments(new CommentsBlock("Only one root HAnimJoint is allowed"))
          ...
          .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            .setValue(new MetadataString().setName("authorName").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())))
            .addValue(new MetadataString().setName("authorEmail").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())))
            .addValue(new MetadataString().setName("copyright").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray())))
            .addValue(new MetadataString().setName("creationDate").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray())))
            .addValue(new MetadataFloat().setName("height").setValue(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat6().getArray())))
            .addValue(new MetadataString().setName("humanoidVersion").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray())))
            .addValue(new MetadataString().setName("usageRestrictions").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray()))))
            ...
            .addChild(new HAnimSegment().setName("sacrum").setDEF("hanim_sacrum")
              ...
              .addChild(new Shape()
                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt329().getArray()))
                  ...
                  .setColor(new ColorRGBA().setDEF("HAnimSegmentLineColorRGBA").setColor(new org.web3d.x3d.jsail.fields.MFColorRGBA(new MFColorRGBA11().getArray())))))
              ...
              .addChild(new HAnimSegment().setName("pelvis").setDEF("hanim_pelvis")
                ...
                .addChild(new Shape()
                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3218().getArray()))
                    ...
                    .setColor(new ColorRGBA().setDEF("HAnimSiteLineColorRGBA").setColor(new org.web3d.x3d.jsail.fields.MFColorRGBA(new MFColorRGBA20().getArray())))))
                ...
                .addChild(new Shape()
                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3231().getArray()))
                ...
                .addChild(new HAnimSite().setName("r_iliocristale_pt").setDEF("hanim_r_iliocristale_pt").setTranslation(new float[] {-0.1525f,1.0628f,0.0035f})
                  ...
                  .addChild(new Shape().setDEF("HAnimSiteShape")
                    .setGeometry(new IndexedFaceSet().setDEF("DiamondIFS").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3237().getArray())).setCreaseAngle(0.5f).setSolid(false)
                                                          ...
                                                          .addChild(new HAnimJoint().setName("vc1").setDEF("hanim_vc1").setCenter(new float[] {0.0066f,1.6144f,-0.0034f})
                                                            ...
                                                            .addChild(new HAnimJoint().setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0.0044f,1.6209f,0.0236f})
                                                              .addChild(new HAnimSegment().setName("skull").setDEF("hanim_skull")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32209().getArray()))
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32211().getArray()))
                                                              ...
                                                              .addChild(new HAnimJoint().setName("l_eyeball_joint").setDEF("hanim_l_eyeball_joint").setCenter(new float[] {0.0336f,1.6332f,0.0502f})
                                                                .addChild(new HAnimSegment().setName("l_eyeball").setDEF("hanim_l_eyeball")
                                                                  ...
                                                                  .addChild(new Shape()
                                                                    .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32213().getArray()))
                                                                      .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f214().getArray())))
                                                                      .setColor(new ColorRGBA().setDEF("HAnimSiteViewpointLineColorRGBA").setColor(new org.web3d.x3d.jsail.fields.MFColorRGBA(new MFColorRGBA215().getArray())))))
                                                                  .addChild(new HAnimSite().setName("l_eyeball_site_view").setDEF("hanim_l_eyeball_site_view").setTranslation(new float[] {0.034f,1.64f,0.05f})
                                                                    ...
                                                                    .addChild(new Anchor().setDescription("HAnimSite hanim_l_eyeball_site_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString216().getArray()))
                                                                      .addChild(new LOD().setForceTransitions(true).setRange(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat217().getArray()))
                                                                        ...
                                                                        .addChild(new Shape().setDEF("HAnimSiteViewpointShape")
                                                                          .setGeometry(new IndexedFaceSet().setDEF("SiteViewpointDiamondIFS").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32219().getArray())).setCreaseAngle(0.5f)
                                                              ...
                                                              .addChild(new HAnimJoint().setName("r_eyeball_joint").setDEF("hanim_r_eyeball_joint").setCenter(new float[] {-0.0336f,1.6332f,0.0502f})
                                                                .addChild(new HAnimSegment().setName("r_eyeball").setDEF("hanim_r_eyeball")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_eyeball_site_view").setDEF("hanim_r_eyeball_site_view").setTranslation(new float[] {-0.034f,1.64f,0.05f})
                                                                    ...
                                                                    .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
                                                                    .addChild(new Anchor().setDescription("HAnimSite hanim_r_eyeball_site_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString223().getArray()))
                                                                      .addChild(new LOD().setForceTransitions(true).setRange(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat224().getArray()))
                                                                        .addChild(new WorldInfo().setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString225().getArray())))
                                                    ...
                                                    .addChild(new HAnimJoint().setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {0.2014f,1.1357f,-0.0682f})
                                                      ...
                                                      .addChild(new HAnimJoint().setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {0.1984f,0.8663f,-0.0583f})
                                                        .addChild(new HAnimSegment().setName("l_carpal").setDEF("hanim_l_carpal")
                                                          ...
                                                          .addChild(new Shape()
                                                            .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32268().getArray()))
                                                          ...
                                                          .addChild(new HAnimSite().setName("l_hand_front_view").setDEF("hanim_l_hand_front_view").setTranslation(new float[] {0.3f,0.75f,0.45f})
                                                            ...
                                                            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
                                                            .addChild(new Anchor().setDescription("HAnimSite hanim_l_hand_front_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString274().getArray()))
                                                              .addChild(new LOD().setForceTransitions(true).setRange(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat275().getArray()))
                                                                .addChild(new WorldInfo().setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString276().getArray())))
                                                                .addChild(new Shape().setUSE("HAnimSiteViewpointShape"))))))
                                                              ...
                                                              .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setCenter(new float[] {0.2028f,0.7139f,-0.0236f})
                                                                .addChild(new HAnimSegment().setName("l_carpal_distal_phalanx_2").setDEF("hanim_l_carpal_distal_phalanx_2")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("l_dactylion_pt").setDEF("hanim_l_dactylion_pt").setTranslation(new float[] {0.2056f,0.6743f,-0.0482f})
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))))))
                                                        .addChild(new HAnimJoint().setName("l_carpometacarpal_3").setDEF("hanim_l_carpometacarpal_3").setCenter(new float[] {0.1987f,0.8029f,-0.053f})
                                                          .addChild(new HAnimSegment().setName("l_metacarpal_3").setDEF("hanim_l_metacarpal_3")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32293().getArray()))
                                                                ...
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("l_metacarpophalangeal_3").setDEF("hanim_l_metacarpophalangeal_3").setCenter(new float[] {0.1987f,0.7818f,-0.053f})
                                                            .addChild(new HAnimSegment().setName("l_carpal_proximal_phalanx_3").setDEF("hanim_l_carpal_proximal_phalanx_3")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32295().getArray()))
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setCenter(new float[] {0.2013f,0.7273f,-0.0503f})
                                                              .addChild(new HAnimSegment().setName("l_carpal_middle_phalanx_3").setDEF("hanim_l_carpal_middle_phalanx_3")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32297().getArray()))
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setCenter(new float[] {0.2026f,0.7011f,-0.0494f})
                                                                .addChild(new HAnimSegment().setName("l_carpal_distal_phalanx_3").setDEF("hanim_l_carpal_distal_phalanx_3")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("l_carpal_distal_phalanx_3_pt").setDEF("hanim_l_carpal_distal_phalanx_3_pt").setTranslation(new float[] {0.208f,0.6731f,-0.0491f})
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))))))
                                                        .addChild(new HAnimJoint().setName("l_carpometacarpal_4").setDEF("hanim_l_carpometacarpal_4").setCenter(new float[] {0.1956f,0.8019f,-0.0794f})
                                                          .addChild(new HAnimSegment().setName("l_metacarpal_4").setDEF("hanim_l_metacarpal_4")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32301().getArray()))
                                                                ...
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("l_metacarpophalangeal_4").setDEF("hanim_l_metacarpophalangeal_4").setCenter(new float[] {0.1956f,0.7815f,-0.0794f})
                                                            .addChild(new HAnimSegment().setName("l_carpal_proximal_phalanx_4").setDEF("hanim_l_carpal_proximal_phalanx_4")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32303().getArray()))
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setCenter(new float[] {0.1973f,0.7287f,-0.0777f})
                                                              .addChild(new HAnimSegment().setName("l_carpal_middle_phalanx_4").setDEF("hanim_l_carpal_middle_phalanx_4")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32305().getArray()))
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setCenter(new float[] {0.1983f,0.7045f,-0.0767f})
                                                                .addChild(new HAnimSegment().setName("l_carpal_distal_phalanx_4").setDEF("hanim_l_carpal_distal_phalanx_4")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("l_carpal_distal_phalanx_4_pt").setDEF("hanim_l_carpal_distal_phalanx_4_pt").setTranslation(new float[] {0.2035f,0.675f,-0.0756f})
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))))))
                                                        .addChild(new HAnimJoint().setName("l_carpometacarpal_5").setDEF("hanim_l_carpometacarpal_5").setCenter(new float[] {0.1925f,0.8066f,-0.1036f})
                                                          .addChild(new HAnimSegment().setName("l_metacarpal_5").setDEF("hanim_l_metacarpal_5")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32309().getArray()))
                                                                ...
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("l_metacarpophalangeal_5").setDEF("hanim_l_metacarpophalangeal_5").setCenter(new float[] {0.1925f,0.7866f,-0.1036f})
                                                            .addChild(new HAnimSegment().setName("l_carpal_proximal_phalanx_5").setDEF("hanim_l_carpal_proximal_phalanx_5")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32311().getArray()))
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.1938f,0.7452f,-0.1024f})
                                                              .addChild(new HAnimSegment().setName("l_carpal_middle_phalanx_5").setDEF("hanim_l_carpal_middle_phalanx_5")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32313().getArray()))
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_5").setDEF("hanim_l_carpal_distal_interphalangeal_5").setCenter(new float[] {0.1948f,0.7277f,-0.1017f})
                                                    ...
                                                    .addChild(new HAnimJoint().setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-0.2014f,1.1357f,-0.0682f})
                                                      ...
                                                      .addChild(new HAnimJoint().setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-0.1984f,0.8663f,-0.0583f})
                                                        .addChild(new HAnimSegment().setName("r_carpal").setDEF("hanim_r_carpal")
                                                          ...
                                                          .addChild(new Shape()
                                                            .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32355().getArray()))
                                                              .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f356().getArray())))
                                                              .setColor(new ColorRGBA().setUSE("HAnimSiteLineColorRGBA"))))
                                                          ...
                                                          .addChild(new HAnimSite().setName("r_hand_front_view").setDEF("hanim_r_hand_front_view").setTranslation(new float[] {-0.3f,0.75f,0.45f})
                                                            ...
                                                            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
                                                            .addChild(new Anchor().setDescription("HAnimSite hanim_r_hand_front_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString361().getArray()))
                                                              .addChild(new LOD().setForceTransitions(true).setRange(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat362().getArray()))
                                                                .addChild(new WorldInfo().setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString363().getArray())))
                                                                .addChild(new Shape().setUSE("HAnimSiteViewpointShape"))))))
                                                        .addChild(new HAnimJoint().setName("r_carpometacarpal_1").setDEF("hanim_r_carpometacarpal_1").setCenter(new float[] {-0.1924f,0.8472f,-0.0534f})
                                                          .addChild(new HAnimSegment().setName("r_metacarpal_1").setDEF("hanim_r_metacarpal_1")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32364().getArray()))
                                                                ...
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("r_metacarpophalangeal_1").setDEF("hanim_r_metacarpophalangeal_1").setCenter(new float[] {-0.1951f,0.8226f,0.0246f})
                                                            .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_1").setDEF("hanim_r_carpal_proximal_phalanx_1")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32366().getArray()))
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_carpal_interphalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setCenter(new float[] {-0.1955f,0.8159f,0.0464f})
                                                              .addChild(new HAnimSegment().setName("r_carpal_distal_phalanx_1").setDEF("hanim_r_carpal_distal_phalanx_1")
                                                                ...
                                                                .addChild(new HAnimSite().setName("r_carpal_distal_phalanx_1_pt").setDEF("hanim_r_carpal_distal_phalanx_1_pt").setTranslation(new float[] {-0.1869f,0.809f,0.082f})
                                                                  ...
                                                                  .addChild(new Shape().setUSE("HAnimSiteShape")))))))
                                                        .addChild(new HAnimJoint().setName("r_carpometacarpal_2").setDEF("hanim_r_carpometacarpal_2").setCenter(new float[] {-0.1983f,0.8024f,-0.028f})
                                                          .addChild(new HAnimSegment().setName("r_metacarpal_2").setDEF("hanim_r_metacarpal_2")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32370().getArray()))
                                                                ...
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("r_metacarpophalangeal_2").setDEF("hanim_r_metacarpophalangeal_2").setCenter(new float[] {-0.1983f,0.7815f,-0.028f})
                                                            .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_2").setDEF("hanim_r_carpal_proximal_phalanx_2")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32372().getArray()))
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-0.2017f,0.7363f,-0.0248f})
                                                              .addChild(new HAnimSegment().setName("r_carpal_middle_phalanx_2").setDEF("hanim_r_carpal_middle_phalanx_2")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32374().getArray()))
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setCenter(new float[] {-0.2028f,0.7139f,-0.0236f})
                                                                .addChild(new HAnimSegment().setName("r_carpal_distal_phalanx_2").setDEF("hanim_r_carpal_distal_phalanx_2")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_dactylion_pt").setDEF("hanim_r_dactylion_pt").setTranslation(new float[] {-0.1941f,0.6772f,-0.0423f})
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))))))
                                                        .addChild(new HAnimJoint().setName("r_carpometacarpal_3").setDEF("hanim_r_carpometacarpal_3").setCenter(new float[] {-0.1987f,0.8029f,-0.053f})
                                                          .addChild(new HAnimSegment().setName("r_metacarpal_3").setDEF("hanim_r_metacarpal_3")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32380().getArray()))
                                                                ...
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("r_metacarpophalangeal_3").setDEF("hanim_r_metacarpophalangeal_3").setCenter(new float[] {-0.1987f,0.7818f,-0.053f})
                                                            .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_3").setDEF("hanim_r_carpal_proximal_phalanx_3")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32382().getArray()))
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-0.2013f,0.7273f,-0.0503f})
                                                              .addChild(new HAnimSegment().setName("r_carpal_middle_phalanx_3").setDEF("hanim_r_carpal_middle_phalanx_3")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32384().getArray()))
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setCenter(new float[] {-0.2026f,0.7011f,-0.0494f})
                                                                .addChild(new HAnimSegment().setName("r_carpal_distal_phalanx_3").setDEF("hanim_r_carpal_distal_phalanx_3")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_carpal_distal_phalanx_3_pt").setDEF("hanim_r_carpal_distal_phalanx_3_pt").setTranslation(new float[] {-0.1969f,0.6758f,-0.0427f})
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))))))
                                                        .addChild(new HAnimJoint().setName("r_carpometacarpal_4").setDEF("hanim_r_carpometacarpal_4").setCenter(new float[] {-0.1956f,0.8019f,-0.0794f})
                                                          .addChild(new HAnimSegment().setName("r_metacarpal_4").setDEF("hanim_r_metacarpal_4")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32388().getArray()))
                                                                ...
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("r_metacarpophalangeal_4").setDEF("hanim_r_metacarpophalangeal_4").setCenter(new float[] {-0.1956f,0.7815f,-0.0794f})
                                                            .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_4").setDEF("hanim_r_carpal_proximal_phalanx_4")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32390().getArray()))
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setCenter(new float[] {-0.1973f,0.7287f,-0.0777f})
                                                              .addChild(new HAnimSegment().setName("r_carpal_middle_phalanx_4").setDEF("hanim_r_carpal_middle_phalanx_4")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32392().getArray()))
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setCenter(new float[] {-0.1983f,0.7045f,-0.0767f})
                                                                .addChild(new HAnimSegment().setName("r_carpal_distal_phalanx_4").setDEF("hanim_r_carpal_distal_phalanx_4")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_carpal_distal_phalanx_4_pt").setDEF("hanim_r_carpal_distal_phalanx_4_pt").setTranslation(new float[] {-0.1934f,0.6778f,-0.0693f})
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))))))
                                                        .addChild(new HAnimJoint().setName("r_carpometacarpal_5").setDEF("hanim_r_carpometacarpal_5").setCenter(new float[] {-0.1925f,0.8066f,-0.1036f})
                                                          .addChild(new HAnimSegment().setName("r_metacarpal_5").setDEF("hanim_r_metacarpal_5")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32396().getArray()))
                                                                ...
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("r_metacarpophalangeal_5").setDEF("hanim_r_metacarpophalangeal_5").setCenter(new float[] {-0.1925f,0.7866f,-0.1036f})
                                                            .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_5").setDEF("hanim_r_carpal_proximal_phalanx_5")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32398().getArray()))
                                                                  .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f399().getArray())))
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_5").setCenter(new float[] {-0.1938f,0.7452f,-0.1024f})
                                                              .addChild(new HAnimSegment().setName("r_carpal_middle_phalanx_5").setDEF("hanim_r_carpal_middle_phalanx_5")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32400().getArray()))
                                                                    .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f401().getArray())))
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_5").setDEF("hanim_r_carpal_distal_interphalangeal_5").setCenter(new float[] {-0.1948f,0.7277f,-0.1017f})
                                                                .addChild(new HAnimSegment().setName("r_carpal_distal_phalanx_5").setDEF("hanim_r_carpal_distal_phalanx_5")
                                                                  ...
                                                                  .addChild(new Shape()
                                                                    .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32402().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("l_inclined_view").setDEF("hanim_l_inclined_view").setRotation(new float[] {-0.113f,0.993f,0.0347f,0.671f}).setTranslation(new float[] {1.62f,1.05f,2.06f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_l_inclined_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString404().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("r_inclined_view").setDEF("hanim_r_inclined_view").setRotation(new float[] {-0.113f,-0.993f,0.0347f,0.671f}).setTranslation(new float[] {-1.62f,1.05f,2.06f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_r_inclined_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString407().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("front_view").setDEF("hanim_front_view").setTranslation(new float[] {0f,0.85f,2.58f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_front_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString410().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("back_view").setDEF("hanim_back_view").setRotation(new float[] {0f,1f,0f,3.14f}).setTranslation(new float[] {0f,0.85f,-2.58f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_back_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString413().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("l_side_view").setDEF("hanim_l_side_view").setRotation(new float[] {0f,1f,0f,1.5708f}).setTranslation(new float[] {2.6f,0.854f,0f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_l_side_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString416().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("Top_view").setDEF("hanim_Top_view").setRotation(new float[] {1f,0f,0f,-1.57f}).setTranslation(new float[] {0f,3.5f,0f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_Top_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString419().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("front_close_view").setDEF("hanim_front_close_view").setTranslation(new float[] {0f,0.854f,1.575f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_front_close_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString422().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("side_close_view").setDEF("hanim_side_close_view").setRotation(new float[] {0f,1f,0f,1.5708f}).setTranslation(new float[] {1.56f,0.854f,0f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_side_close_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString425().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("head_front_close_view").setDEF("hanim_head_front_close_view").setTranslation(new float[] {0f,1.5f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_head_front_close_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString428().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("chest_front_close_view").setDEF("hanim_chest_front_close_view").setTranslation(new float[] {0f,1.2f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_chest_front_close_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString431().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("pelvis_front_close_view").setDEF("hanim_pelvis_front_close_view").setTranslation(new float[] {0f,0.8f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_pelvis_front_close_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString434().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("knees_front_close_view").setDEF("hanim_knees_front_close_view").setTranslation(new float[] {0f,0.4f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_knees_front_close_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString437().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("feet_front_close_view").setDEF("hanim_feet_front_close_view").setTranslation(new float[] {0f,0f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_feet_front_close_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString440().getArray()))
              .addChild(new LOD().setForceTransitions(true).setRange(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat441().getArray()))
                .addChild(new WorldInfo().setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString442().getArray())))
                .addChild(new Shape().setUSE("HAnimSiteViewpointShape")))))
          .addViewpoints(new HAnimSite().setName("eye_level_view").setDEF("hanim_eye_level_view").setTranslation(new float[] {0f,1.6332f,0.0502f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite hanim_eye_level_view Viewpoint").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString443().getArray()))
              .addChild(new LOD().setForceTransitions(true).setRange(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat444().getArray()))
                .addChild(new WorldInfo().setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString445().getArray())))
                .addChild(new Shape().setUSE("HAnimSiteViewpointShape")))))

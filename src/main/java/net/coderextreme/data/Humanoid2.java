                  ...
                  .addChild(new HAnimSegment("hanim_vl1").setName("l1").setDEF("hanim_l1")
                    ...
                    .addChild(new Shape("hanim_l1")
                      .setGeometry(new LineSet().setVertexCount(new MFInt3287().getArray())
                        ...
                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                    .addChild(new HAnimSite("hanim_l1").setName("substernale_pt").setDEF("hanim_substernale_pt").setTranslation(new float[] {0.0085f,1.2995f,0.1147f})
                    ...
                    .addChild(new HAnimSegment("hanim_vt10").setName("t10").setDEF("hanim_t10")
                      ...
                      .addChild(new Shape("hanim_t10")
                        .setGeometry(new LineSet().setVertexCount(new MFInt3291().getArray())
                          ...
                          .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                      .addChild(new HAnimSite("hanim_t10").setName("l_chest_midsagittal_plane_pt").setDEF("hanim_l_chest_midsagittal_plane_pt")
                      ...
                      .addChild(new HAnimSite("hanim_t10").setName("mesosternale_pt").setDEF("hanim_mesosternale_pt")
                      ...
                      .addChild(new HAnimSite("hanim_t10").setName("r_chest_midsagittal_plane_pt").setDEF("hanim_r_chest_midsagittal_plane_pt")
                      ...
                      .addChild(new HAnimSite("hanim_t10").setName("rear_center_midsagittal_plane_pt").setDEF("hanim_rear_center_midsagittal_plane_pt")
                      ...
                      .addChild(new HAnimSegment("hanim_vt6").setName("t6").setDEF("hanim_t6")
                        ...
                        .addChild(new Shape("hanim_t6")
                          .setGeometry(new LineSet().setVertexCount(new MFInt3295().getArray())
                            ...
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                        .addChild(new HAnimSite("hanim_t6").setName("cervicale_pt").setDEF("hanim_cervicale_pt").setTranslation(new float[] {0.0064f,1.52f,-0.0815f})
                        ...
                        .addChild(new HAnimSite("hanim_t6").setName("suprasternale_pt").setDEF("hanim_suprasternale_pt").setTranslation(new float[] {0.0084f,1.4714f,0.0551f})
                          ...
                          .addChild(new HAnimSegment("hanim_vc4").setName("c4").setDEF("hanim_c4")
                            ...
                            .addChild(new Shape("hanim_c4")
                              .setGeometry(new LineSet().setVertexCount(new MFInt32107().getArray())
                                ...
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                            .addChild(new HAnimSite("hanim_c4").setName("adams_apple_pt").setDEF("hanim_adams_apple_pt")
                            ...
                            .addChild(new HAnimSegment("hanim_vc2").setName("c2").setDEF("hanim_c2")
                              ...
                              .addChild(new Shape("hanim_c2")
                                .setGeometry(new LineSet().setVertexCount(new MFInt32111().getArray())
                                  ...
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                              .addChild(new HAnimSite("hanim_c2").setName("glabella_pt").setDEF("hanim_glabella_pt")
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("l_ectocanthus_pt").setDEF("hanim_l_ectocanthus_pt")
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("l_infraorbitale_pt").setDEF("hanim_l_infraorbitale_pt").setTranslation(new float[] {0.0341f,1.6171f,0.0752f})
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("l_tragion_pt").setDEF("hanim_l_tragion_pt").setTranslation(new float[] {0.0739f,1.6348f,0.0282f})
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("nuchale_pt").setDEF("hanim_nuchale_pt").setTranslation(new float[] {0.0039f,1.5972f,-0.0796f})
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("opisthocranion_pt").setDEF("hanim_opisthocranion_pt")
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("r_ectocanthus_pt").setDEF("hanim_r_ectocanthus_pt")
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("r_infraorbitale_pt").setDEF("hanim_r_infraorbitale_pt").setTranslation(new float[] {-0.0237f,1.6171f,0.0752f})
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("r_tragion_pt").setDEF("hanim_r_tragion_pt").setTranslation(new float[] {-0.0646f,1.6347f,0.0302f})
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("sellion_pt").setDEF("hanim_sellion_pt").setTranslation(new float[] {0.0058f,1.6316f,0.0852f})
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("skull_vertex_pt").setDEF("hanim_skull_vertex_pt").setTranslation(new float[] {0.005f,1.7504f,0.0055f})

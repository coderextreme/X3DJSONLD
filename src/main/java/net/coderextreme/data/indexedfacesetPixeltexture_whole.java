...
public class indexedfacesetPixeltexture_whole implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new indexedfacesetPixeltexture_whole().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/indexedfacesetPixeltexture_whole.new.java.x3d");
    model.toFileJSON("../data/indexedfacesetPixeltexture_whole.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("indexedfaceset_pixeltexture_whole.x3d")))
        .addMeta(new meta().setName(new SFString("warning")).setContent(new SFString("file did not transform to vrml97")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_whole-front.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_whole-rear.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_whole-top.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_whole-bottom.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_whole-left.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_whole-right.jpg")))
        ...
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("Test of browser ability to map the entire portion of an PixelTexture onto an IndexedFaceSet geometry. Four equal sized red (bottom left), green (bottom right) yellow (top left) and white (top right) squares in the pixel texture map all the faces of the cube.")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_whole.x3d")))

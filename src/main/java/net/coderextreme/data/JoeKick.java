  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("Sat, 30 Dec 2023 07:48:57 GMT"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("Joe_Humanoid")
          .addChild(new HAnimHumanoid("Joe_Humanoid").setDEF("Joe_Kick").setName("Kick").setLoa(3)
            ...
            .addSkeleton(new HAnimJoint("Joe_Kick").setDEF("Joe_humanoid_root").setName("humanoid_root").setTranslation(new float[] {-0.1812064f,0.1030161f,0.009048254f}).setRotation(new float[] {-0.999999999999999f,0f,0f,0.5f}).setCenter(new float[] {0f,0.875f,0f})
              ...
              .addChild(new HAnimJoint("Joe_humanoid_root").setDEF("Joe_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f,0.92f,0f}).setSkinCoordIndex(new MFInt326().getArray()).setSkinCoordWeight(new MFFloat7().getArray())
                .addChild(new HAnimJoint("Joe_sacroiliac").setDEF("Joe_l_hip").setName("l_hip").setRotation(new float[] {1f,0f,0f,0.658298824954057f}).setCenter(new float[] {0.1f,0.92f,0f}).setSkinCoordIndex(new MFInt328().getArray()).setSkinCoordWeight(new MFFloat9().getArray())
                  .addChild(new HAnimJoint("Joe_l_hip").setDEF("Joe_l_knee").setName("l_knee").setRotation(new float[] {0.913630660060881f,0f,0.406545221342869f,0.67410463551159f}).setCenter(new float[] {0.115f,0.466f,0f}).setSkinCoordIndex(new MFInt3210().getArray()).setSkinCoordWeight(new MFFloat11().getArray())
                    .addChild(new HAnimJoint("Joe_l_knee").setDEF("Joe_l_talocrural").setName("l_talocrural").setRotation(new float[] {1f,0f,0f,0.498838265736897f}).setCenter(new float[] {0.115f,0.069f,0f}).setSkinCoordIndex(new MFInt3212().getArray()).setSkinCoordWeight(new MFFloat13().getArray())
                      .addChild(new HAnimJoint("Joe_l_talocrural").setDEF("Joe_l_tarsometatarsal_2").setName("l_tarsometatarsal_2").setCenter(new float[] {0.115f,0.031f,0.03f}).setSkinCoordIndex(new MFInt3214().getArray()).setSkinCoordWeight(new MFFloat15().getArray())
                        .addChild(new HAnimJoint("Joe_l_tarsometatarsal_2").setDEF("Joe_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(new float[] {0.115f,0.037f,0.09f}).setSkinCoordIndex(new MFInt3216().getArray()).setSkinCoordWeight(new MFFloat17().getArray())
                          .addChild(new HAnimJoint("Joe_l_metatarsophalangeal_2").setDEF("Joe_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setCenter(new float[] {0.115f,0.02f,0.122f}).setSkinCoordIndex(new MFInt3218().getArray()).setSkinCoordWeight(new MFFloat19().getArray())))))))
                .addChild(new HAnimJoint("Joe_sacroiliac").setDEF("Joe_r_hip").setName("r_hip").setRotation(new float[] {-1f,0f,0f,1f}).setCenter(new float[] {-0.1f,0.92f,0f}).setSkinCoordIndex(new MFInt3220().getArray()).setSkinCoordWeight(new MFFloat21().getArray())
                  .addChild(new HAnimJoint("Joe_r_hip").setDEF("Joe_r_knee").setName("r_knee").setRotation(new float[] {1f,0f,0f,1f}).setCenter(new float[] {-0.05f,0.466f,0f}).setSkinCoordIndex(new MFInt3222().getArray()).setSkinCoordWeight(new MFFloat23().getArray())
                    .addChild(new HAnimJoint("Joe_r_knee").setDEF("Joe_r_talocrural").setName("r_talocrural").setRotation(new float[] {1f,0f,0f,1f}).setCenter(new float[] {-0.115f,0.069f,0f}).setSkinCoordIndex(new MFInt3224().getArray()).setSkinCoordWeight(new MFFloat25().getArray())
                      .addChild(new HAnimJoint("Joe_r_talocrural").setDEF("Joe_r_tarsometatarsal_2").setName("r_tarsometatarsal_2").setCenter(new float[] {-0.1f,0.015f,-0.01f}).setSkinCoordIndex(new MFInt3226().getArray()).setSkinCoordWeight(new MFFloat27().getArray())
                        .addChild(new HAnimJoint("Joe_r_tarsometatarsal_2").setDEF("Joe_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(new float[] {-0.115f,0.037f,0.09f}).setSkinCoordIndex(new MFInt3228().getArray()).setSkinCoordWeight(new MFFloat29().getArray())
                          .addChild(new HAnimJoint("Joe_r_metatarsophalangeal_2").setDEF("Joe_r_tarsal_distal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setCenter(new float[] {-0.1f,0.01f,0.14f}).setSkinCoordIndex(new MFInt3230().getArray()).setSkinCoordWeight(new MFFloat31().getArray()))))))))
                                              ...
                                              .addChild(new HAnimJoint("Joe_vt2").setDEF("Joe_vt1").setName("vt1").setCenter(new float[] {0f,1.497f,-0.09f}).setSkinCoordIndex(new MFInt3242().getArray()).setSkinCoordWeight(new MFFloat43().getArray())
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_vc7").setName("vc7").setCenter(new float[] {0f,1.525f,-0.072f}).setSkinCoordIndex(new MFInt3244().getArray()).setSkinCoordWeight(new MFFloat45().getArray())
                                                  .addChild(new HAnimJoint("Joe_vc7").setDEF("Joe_vc6").setName("vc6").setCenter(new float[] {0f,1.54f,-0.05f})
                                                    .addChild(new HAnimJoint("Joe_vc6").setDEF("Joe_vc5").setName("vc5").setCenter(new float[] {0f,1.552f,-0.035f})
                                                      .addChild(new HAnimJoint("Joe_vc5").setDEF("Joe_vc4").setName("vc4").setRotation(new float[] {0.976196945310223f,0f,0.216885969963455f,0.618434192167135f}).setCenter(new float[] {0f,1.5675f,-0.0256f})
                                                          ...
                                                          .addChild(new HAnimJoint("Joe_vc3").setDEF("Joe_vc2").setName("vc2").setCenter(new float[] {0f,1.595f,-0.0175f})
                                                            .addChild(new HAnimJoint("Joe_vc2").setDEF("Joe_vc1").setName("vc1").setCenter(new float[] {0f,1.61f,-0.015f})
                                                              .addChild(new HAnimJoint("Joe_vc1").setDEF("Joe_skullbase").setName("skullbase").setCenter(new float[] {0f,1.63f,-0.01f}).setSkinCoordIndex(new MFInt3246().getArray()).setSkinCoordWeight(new MFFloat47().getArray())
                                                                .addDisplacers(new HAnimDisplacer("Joe_skullbase").setDEF("Joe_skull_tip_raiser_action").setName("skull_tip_raiser_action").setWeight(0.2482574f).setCoordIndex(new MFInt3248().getArray()).setDisplacements(new MFVec3f49().getArray()))
                                                ...
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_l_acromioclavicular").setCenter(new float[] {0.082f,1.4488f,-0.0353f}).setSkinCoordIndex(new MFInt3250().getArray()).setSkinCoordWeight(new MFFloat51().getArray())
                                                  .addChild(new HAnimJoint("Joe_l_acromioclavicular").setDEF("Joe_l_sternoclavicular").setName("l_acromioclavicular").setCenter(new float[] {0.0962f,1.4269f,-0.0424f}).setSkinCoordIndex(new MFInt3252().getArray()).setSkinCoordWeight(new MFFloat53().getArray())
                                                    .addChild(new HAnimJoint("Joe_l_sternoclavicular").setDEF("Joe_l_shoulder").setName("l_shoulder").setRotation(new float[] {-0.309090292933258f,0f,0.951032697026991f,1.51810633652231f}).setCenter(new float[] {0.2f,1.44f,-0.04f}).setSkinCoordIndex(new MFInt3254().getArray()).setSkinCoordWeight(new MFFloat55().getArray())
                                                      .addChild(new HAnimJoint("Joe_l_shoulder").setDEF("Joe_l_elbow").setName("l_elbow").setRotation(new float[] {-0.990755291218669f,-0.135661169544607f,0f,0.659116353330616f}).setCenter(new float[] {0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new MFInt3256().getArray()).setSkinCoordWeight(new MFFloat57().getArray())
                                                        .addChild(new HAnimJoint("Joe_l_elbow").setDEF("Joe_l_radiocarpal").setName("l_radiocarpal").setRotation(new float[] {0f,0.370284328870799f,0.928918465632317f,0.771008141563299f}).setCenter(new float[] {0.2f,0.87f,-0.04f}).setSkinCoordIndex(new MFInt3258().getArray()).setSkinCoordWeight(new MFFloat59().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("Joe_l_radiocarpal").setDEF("Joe_l_carpometacarpal_2").setName("l_carpometacarpal_2").setCenter(new float[] {0.1983f,0.8024f,-0.028f}).setSkinCoordIndex(new MFInt3266().getArray()).setSkinCoordWeight(new MFFloat67().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_carpometacarpal_2").setDEF("Joe_l_metacarpophalangeal_2").setName("l_metacarpophalangeal_2").setCenter(new float[] {0.1983f,0.7815f,-0.028f}).setSkinCoordIndex(new MFInt3268().getArray()).setSkinCoordWeight(new MFFloat69().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_2").setDEF("Joe_l_carpal_proximal_interphalangeal_2").setName("l_carpal_proximal_interphalangeal_2").setCenter(new float[] {0.2017f,0.7363f,-0.0248f}).setSkinCoordIndex(new MFInt3270().getArray()).setSkinCoordWeight(new MFFloat71().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_2").setDEF("Joe_l_carpal_distal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_2").setCenter(new float[] {0.2028f,0.7139f,-0.0236f}).setSkinCoordIndex(new MFInt3272().getArray()).setSkinCoordWeight(new MFFloat73().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_l_radiocarpal").setDEF("Joe_l_carpometacarpal_3").setName("l_carpometacarpal_3").setCenter(new float[] {0.1987f,0.8029f,-0.053f}).setSkinCoordIndex(new MFInt3274().getArray()).setSkinCoordWeight(new MFFloat75().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_carpometacarpal_3").setDEF("Joe_l_metacarpophalangeal_3").setName("l_metacarpophalangeal_3").setCenter(new float[] {0.1987f,0.7818f,-0.053f}).setSkinCoordIndex(new MFInt3276().getArray()).setSkinCoordWeight(new MFFloat77().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_3").setDEF("Joe_l_carpal_proximal_interphalangeal_3").setName("l_carpal_proximal_interphalangeal_3").setCenter(new float[] {0.2013f,0.7273f,-0.0503f}).setSkinCoordIndex(new MFInt3278().getArray()).setSkinCoordWeight(new MFFloat79().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_3").setDEF("Joe_l_carpal_distal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_3").setCenter(new float[] {0.2026f,0.7011f,-0.0494f}).setSkinCoordIndex(new MFInt3280().getArray()).setSkinCoordWeight(new MFFloat81().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_l_radiocarpal").setDEF("Joe_l_carpometacarpal_4").setName("l_carpometacarpal_4").setCenter(new float[] {0.1956f,0.8019f,-0.0794f}).setSkinCoordIndex(new MFInt3282().getArray()).setSkinCoordWeight(new MFFloat83().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_carpometacarpal_4").setDEF("Joe_l_metacarpophalangeal_4").setName("l_metacarpophalangeal_4").setCenter(new float[] {0.1956f,0.7815f,-0.0794f}).setSkinCoordIndex(new MFInt3284().getArray()).setSkinCoordWeight(new MFFloat85().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_4").setDEF("Joe_l_carpal_proximal_interphalangeal_4").setName("l_carpal_proximal_interphalangeal_4").setCenter(new float[] {0.1973f,0.7287f,-0.0777f}).setSkinCoordIndex(new MFInt3286().getArray()).setSkinCoordWeight(new MFFloat87().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_4").setDEF("Joe_l_carpal_distal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_4").setCenter(new float[] {0.1983f,0.7045f,-0.0767f}).setSkinCoordIndex(new MFInt3288().getArray()).setSkinCoordWeight(new MFFloat89().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_l_radiocarpal").setDEF("Joe_l_carpometacarpal_5").setName("l_carpometacarpal_5").setCenter(new float[] {0.1925f,0.8066f,-0.1036f}).setSkinCoordIndex(new MFInt3290().getArray()).setSkinCoordWeight(new MFFloat91().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_carpometacarpal_5").setDEF("Joe_l_metacarpophalangeal_5").setName("l_metacarpophalangeal_5").setCenter(new float[] {0.1925f,0.7866f,-0.1036f}).setSkinCoordIndex(new MFInt3292().getArray()).setSkinCoordWeight(new MFFloat93().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_5").setDEF("Joe_l_carpal_proximal_interphalangeal_5").setName("l_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.1938f,0.7452f,-0.1024f}).setSkinCoordIndex(new MFInt3294().getArray()).setSkinCoordWeight(new MFFloat95().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_5").setDEF("Joe_l_carpal_distal_interphalangeal_5").setName("l_carpal_distal_interphalangeal_5").setCenter(new float[] {0.1948f,0.7277f,-0.1017f}).setSkinCoordIndex(new MFInt3296().getArray()).setSkinCoordWeight(new MFFloat97().getArray()))))))))))
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-0.03f,1.46f,0f}).setSkinCoordIndex(new MFInt3298().getArray()).setSkinCoordWeight(new MFFloat99().getArray())
                                                  .addChild(new HAnimJoint("Joe_r_sternoclavicular").setDEF("Joe_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-0.09f,1.41f,-0.11f}).setSkinCoordIndex(new MFInt32100().getArray()).setSkinCoordWeight(new MFFloat101().getArray())
                                                    .addChild(new HAnimJoint("Joe_r_acromioclavicular").setDEF("Joe_r_shoulder").setName("r_shoulder").setRotation(new float[] {0f,0f,-1f,1.56206434965134f}).setCenter(new float[] {-0.2f,1.44f,-0.04f}).setSkinCoordIndex(new MFInt32102().getArray()).setSkinCoordWeight(new MFFloat103().getArray())
                                                      .addChild(new HAnimJoint("Joe_r_shoulder").setDEF("Joe_r_elbow").setName("r_elbow").setRotation(new float[] {-0.990755291218669f,-0.135661169544607f,0f,0.659116353330616f}).setCenter(new float[] {-0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new MFInt32104().getArray()).setSkinCoordWeight(new MFFloat105().getArray())
                                                        .addChild(new HAnimJoint("Joe_r_elbow").setDEF("Joe_r_radiocarpal").setName("r_radiocarpal").setRotation(new float[] {0f,0f,-1f,0.620643533506604f}).setCenter(new float[] {-0.2f,0.89f,-0.04f}).setSkinCoordIndex(new MFInt32106().getArray()).setSkinCoordWeight(new MFFloat107().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setDEF("Joe_r_carpometacarpal_2").setName("r_carpometacarpal_2").setRotation(new float[] {0f,0f,1f,0.496514797210693f}).setCenter(new float[] {-0.2f,0.84f,-0.015f}).setSkinCoordIndex(new MFInt32114().getArray()).setSkinCoordWeight(new MFFloat115().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_2").setDEF("Joe_r_metacarpophalangeal_2").setName("r_metacarpophalangeal_2").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.793f,-0.015f}).setSkinCoordIndex(new MFInt32116().getArray()).setSkinCoordWeight(new MFFloat117().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_2").setDEF("Joe_r_carpal_proximal_interphalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.745f,-0.015f}).setSkinCoordIndex(new MFInt32118().getArray()).setSkinCoordWeight(new MFFloat119().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_2").setDEF("Joe_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.72f,-0.015f}).setSkinCoordIndex(new MFInt32120().getArray()).setSkinCoordWeight(new MFFloat121().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setDEF("Joe_r_carpometacarpal_3").setName("r_carpometacarpal_3").setRotation(new float[] {0f,0f,1f,0.496514797210693f}).setCenter(new float[] {-0.2f,0.835f,-0.04f}).setSkinCoordIndex(new MFInt32122().getArray()).setSkinCoordWeight(new MFFloat123().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_3").setDEF("Joe_r_metacarpophalangeal_3").setName("r_metacarpophalangeal_3").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.788f,-0.04f}).setSkinCoordIndex(new MFInt32124().getArray()).setSkinCoordWeight(new MFFloat125().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_3").setDEF("Joe_r_carpal_proximal_interphalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.74f,-0.04f}).setSkinCoordIndex(new MFInt32126().getArray()).setSkinCoordWeight(new MFFloat127().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_3").setDEF("Joe_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.7142f,-0.04f}).setSkinCoordIndex(new MFInt32128().getArray()).setSkinCoordWeight(new MFFloat129().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setDEF("Joe_r_carpometacarpal_4").setName("r_carpometacarpal_4").setRotation(new float[] {0f,0f,1f,0.496514797210693f}).setCenter(new float[] {-0.2f,0.835f,-0.065f}).setSkinCoordIndex(new MFInt32130().getArray()).setSkinCoordWeight(new MFFloat131().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_4").setDEF("Joe_r_metacarpophalangeal_4").setName("r_metacarpophalangeal_4").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.793f,-0.065f}).setSkinCoordIndex(new MFInt32132().getArray()).setSkinCoordWeight(new MFFloat133().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_4").setDEF("Joe_r_carpal_proximal_interphalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.74f,-0.065f}).setSkinCoordIndex(new MFInt32134().getArray()).setSkinCoordWeight(new MFFloat135().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_4").setDEF("Joe_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.7177f,-0.065f}).setSkinCoordIndex(new MFInt32136().getArray()).setSkinCoordWeight(new MFFloat137().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setDEF("Joe_r_carpometacarpal_5").setName("r_carpometacarpal_5").setRotation(new float[] {0f,0f,1f,0.496514797210693f}).setCenter(new float[] {-0.2f,0.84f,-0.085f}).setSkinCoordIndex(new MFInt32138().getArray()).setSkinCoordWeight(new MFFloat139().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_5").setDEF("Joe_r_metacarpophalangeal_5").setName("r_metacarpophalangeal_5").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.79f,-0.085f}).setSkinCoordIndex(new MFInt32140().getArray()).setSkinCoordWeight(new MFFloat141().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_5").setDEF("Joe_r_carpal_proximal_interphalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.755f,-0.085f}).setSkinCoordIndex(new MFInt32142().getArray()).setSkinCoordWeight(new MFFloat143().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_5").setDEF("Joe_r_carpal_distal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setRotation(new float[] {0f,0f,1f,0.74477219581604f}).setCenter(new float[] {-0.2f,0.735f,-0.09f}).setSkinCoordIndex(new MFInt32144().getArray()).setSkinCoordWeight(new MFFloat145().getArray()))))))))))))))))))))))))))))
            ...
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_l_carpal_distal_interphalangeal_5"))
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_r_carpal_distal_interphalangeal_5"))
            ...
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_l_carpal_proximal_interphalangeal_5"))
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_r_carpal_proximal_interphalangeal_5"))
            ...
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_l_metatarsophalangeal_2"))
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_r_metatarsophalangeal_2"))
            ...
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_l_tarsal_distal_interphalangeal_2"))
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_r_tarsal_distal_interphalangeal_2"))
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_l_tarsometatarsal_2"))
            .addJoints(new HAnimJoint("Joe_Kick").setUSE("Joe_r_tarsometatarsal_2"))
            ...
            .addSkin(new Shape().setDEF("Joe_Shape")
              .setAppearance(new Appearance().setDEF("Joe_skin_Appearance")
                ...
                .setTextureTransform(new TextureTransform().setDEF("KickTextureTransform").setRotation(0.2412868f)))
        ...
        .addChild(new Group()
          .addChild(new Transform().setDEF("SBall").setTranslation(new float[] {0.7598155f,1.494191f,3.671879f}).setRotation(new float[] {-0.680273026291233f,0.272868502031902f,-0.680273026291233f,3.10039379148303f}).setScale(new float[] {0.23f,0.23f,0.23f})
        ...
        .addChild(new ROUTE().setFromNode("l_subtalar_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_tarsometatarsal_2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_midtarsal_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_metatarsophalangeal_2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_metatarsal_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_tarsal_distal_interphalangeal_2").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("r_subtalar_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_tarsometatarsal_2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_midtarsal_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_metatarsophalangeal_2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_metatarsal_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_tarsal_distal_interphalangeal_2").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("l_index2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_carpal_proximal_interphalangeal_2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_index3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_carpal_distal_interphalangeal_2").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("l_middle2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_carpal_proximal_interphalangeal_3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_middle3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_carpal_distal_interphalangeal_3").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("l_ring2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_carpal_proximal_interphalangeal_4").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_ring3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_carpal_distal_interphalangeal_4").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("l_pinky2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_carpal_proximal_interphalangeal_5").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_pinky3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_carpal_distal_interphalangeal_5").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("r_index2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_carpal_proximal_interphalangeal_2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_index3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_carpal_distal_interphalangeal_2").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("r_middle2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_carpal_proximal_interphalangeal_3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_middle3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_carpal_distal_interphalangeal_3").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("r_ring2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_carpal_proximal_interphalangeal_4").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_ring3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_carpal_distal_interphalangeal_4").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("r_pinky2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_carpal_proximal_interphalangeal_5").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_pinky3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_carpal_distal_interphalangeal_5").setToField("rotation"))

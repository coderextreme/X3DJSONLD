    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("Joe_Humanoid")
          .addChild(new HAnimHumanoid().setName("Human").setDEF("Joe_Human").setLoa(3).setVersion("2.0").setJointBindingPositions(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f1().getArray())).setJointBindingRotations(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation2().getArray())).setJointBindingScales(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f3().getArray()))
            .setMetadata(new MetadataSet().setName("warnings").setReference("HAnim")
              .addValue(new MetadataString().setName("SymmetricalLeftRight").setReference("correction options: ignore, warn, average, left, right, largest, smallest").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray()))))
            .addJoints(new HAnimJoint().setName("humanoid_root").setDEF("Joe_humanoid_root").setCenter(new float[] {0f,0.875f,0f})
                ...
                .addChild(new HAnimSite().setName("RootFront_view").setDEF("Joe_RootFront_view")
                  .addChild(new Transform().setDEF("hanimcordsys").setScale(new float[] {0.175f,0.175f,0.175f})
                    ...
                    .addChild(new Shape().setDEF("AxisLinesShape")
                      ...
                      .setGeometry(new IndexedLineSet().setColorIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt325().getArray())).setColorPerVertex(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt326().getArray()))
                        .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f7().getArray())))
                        .setColor(new Color().setColor(new org.web3d.x3d.jsail.fields.MFColor(new MFColor8().getArray()))))))))
              .addChild(new HAnimJoint().setName("sacroiliac").setDEF("Joe_sacroiliac").setCenter(new float[] {0f,0.92f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt329().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat10().getArray()))
                .addChild(new HAnimJoint().setName("l_hip").setDEF("Joe_l_hip").setCenter(new float[] {0.1f,0.92f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3211().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat12().getArray()))
                  .addChild(new HAnimJoint().setName("l_knee").setDEF("Joe_l_knee").setCenter(new float[] {0.115f,0.466f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3213().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat14().getArray()))
                    .addChild(new HAnimJoint().setName("l_ankle").setDEF("Joe_l_ankle").setCenter(new float[] {0.115f,0.069f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3215().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat16().getArray()))
                      .addChild(new HAnimJoint().setName("l_subtalar").setDEF("Joe_l_subtalar").setCenter(new float[] {0.115f,0.031f,0.03f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3217().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat18().getArray()))
                        .addChild(new HAnimJoint().setName("l_midtarsal").setDEF("Joe_l_midtarsal").setCenter(new float[] {0.115f,0.037f,0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3219().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat20().getArray()))
                          .addChild(new HAnimJoint().setName("l_metatarsal").setDEF("Joe_l_metatarsal").setCenter(new float[] {0.115f,0.02f,0.122f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3221().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat22().getArray()))))))))
                .addChild(new HAnimJoint().setName("r_hip").setDEF("Joe_r_hip").setCenter(new float[] {-0.1f,0.92f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3223().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat24().getArray()))
                  .addChild(new HAnimJoint().setName("r_knee").setDEF("Joe_r_knee").setCenter(new float[] {-0.05f,0.466f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3225().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat26().getArray()))
                    .addChild(new HAnimJoint().setName("r_ankle").setDEF("Joe_r_ankle").setCenter(new float[] {-0.115f,0.069f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3227().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat28().getArray()))
                      .addChild(new HAnimJoint().setName("r_subtalar").setDEF("Joe_r_subtalar").setCenter(new float[] {-0.1f,0.015f,-0.01f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3229().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat30().getArray()))
                        .addChild(new HAnimJoint().setName("r_midtarsal").setDEF("Joe_r_midtarsal").setCenter(new float[] {-0.115f,0.037f,0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3231().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat32().getArray()))
                          .addChild(new HAnimJoint().setName("r_metatarsal").setDEF("Joe_r_metatarsal").setCenter(new float[] {-0.1f,0.01f,0.14f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3233().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat34().getArray())))))))))
              .addChild(new HAnimJoint().setName("vl5").setDEF("Joe_vl5").setCenter(new float[] {0f,1.045f,-0.095f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3235().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat36().getArray()))
                .addChild(new HAnimJoint().setName("vl4").setDEF("Joe_vl4").setCenter(new float[] {0f,1.068f,-0.085f})
                  .addChild(new HAnimJoint().setName("vl3").setDEF("Joe_vl3").setCenter(new float[] {0f,1.092f,-0.0725f})
                    .addChild(new HAnimJoint().setName("vl2").setDEF("Joe_vl2").setCenter(new float[] {0f,1.12f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3237().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat38().getArray()))
                      .addChild(new HAnimJoint().setName("vl1").setDEF("Joe_vl1").setCenter(new float[] {0f,1.1459f,-0.0625f})
                        .addChild(new HAnimJoint().setName("vt12").setDEF("Joe_vt12").setCenter(new float[] {0f,1.179f,-0.068f})
                          .addChild(new HAnimJoint().setName("vt11").setDEF("Joe_vt11").setCenter(new float[] {0f,1.2679f,-0.081f})
                            .addChild(new HAnimJoint().setName("vt10").setDEF("Joe_vt10").setCenter(new float[] {0f,1.242f,-0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3239().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat40().getArray()))
                              .addChild(new HAnimJoint().setName("vt9").setDEF("Joe_vt9").setCenter(new float[] {0f,1.268f,-0.1f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3241().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat42().getArray()))
                                  ...
                                  .addChild(new HAnimJoint().setName("vt7").setDEF("Joe_vt7").setCenter(new float[] {0f,1.323f,-0.1155f})
                                    .addChild(new HAnimJoint().setName("vt6").setDEF("Joe_vt6").setCenter(new float[] {0f,1.352f,-0.12f})
                                      .addChild(new HAnimJoint().setName("vt5").setDEF("Joe_vt5").setCenter(new float[] {0f,1.381f,-0.1235f})
                                        .addChild(new HAnimJoint().setName("vt4").setDEF("Joe_vt4").setCenter(new float[] {0f,1.41f,-0.1235f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3243().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat44().getArray()))
                                          .addChild(new HAnimJoint().setName("vt3").setDEF("Joe_vt3").setCenter(new float[] {0f,1.438f,-0.12f})
                                            .addChild(new HAnimJoint().setName("vt2").setDEF("Joe_vt2").setCenter(new float[] {0f,1.468f,-0.105f})
                                              .addChild(new HAnimJoint().setName("vt1").setDEF("Joe_vt1").setCenter(new float[] {0f,1.497f,-0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3245().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat46().getArray()))
                                                .addChild(new HAnimJoint().setName("vc7").setDEF("Joe_vc7").setCenter(new float[] {0f,1.525f,-0.072f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3247().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat48().getArray()))
                                                        ...
                                                        .addChild(new HAnimJoint().setName("vc3").setDEF("Joe_vc3").setCenter(new float[] {0f,1.58225f,-0.0185f})
                                                          .addChild(new HAnimJoint().setName("vc2").setDEF("Joe_vc2").setCenter(new float[] {0f,1.595f,-0.0175f})
                                                            .addChild(new HAnimJoint().setName("vc1").setDEF("Joe_vc1").setCenter(new float[] {0f,1.61f,-0.015f})
                                                              .addChild(new HAnimJoint().setName("skullbase").setDEF("Joe_skullbase").setCenter(new float[] {0f,1.63f,-0.01f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3249().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat50().getArray()))
                                                                .addDisplacers(new HAnimDisplacer().setName("skull_tip_raiser_action").setDEF("Joe_skull_tip_raiser_action").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3251().getArray())).setDisplacements(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f52().getArray())))
                                                  ...
                                                  .addChild(new HAnimJoint().setName("l_sternoclavicular").setDEF("Joe_l_sternoclavicular").setCenter(new float[] {0.082f,1.4488f,-0.0353f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3253().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat54().getArray()))
                                                    .addChild(new HAnimJoint().setName("l_acromioclavicular").setDEF("Joe_l_acromioclavicular").setCenter(new float[] {0.0962f,1.4269f,-0.0424f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3255().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat56().getArray()))
                                                      .addChild(new HAnimJoint().setName("l_shoulder").setDEF("Joe_l_shoulder").setCenter(new float[] {0.2f,1.44f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3257().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat58().getArray()))
                                                        .addChild(new HAnimJoint().setName("l_elbow").setDEF("Joe_l_elbow").setCenter(new float[] {0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3259().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat60().getArray()))
                                                          .addChild(new HAnimJoint().setName("l_wrist").setDEF("Joe_l_wrist").setCenter(new float[] {0.2f,0.87f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3261().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat62().getArray()))
                                                            .addChild(new HAnimJoint().setName("l_thumb1").setDEF("Joe_l_thumb1").setCenter(new float[] {0.1924f,0.8472f,-0.0534f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3263().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat64().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_thumb2").setDEF("Joe_l_thumb2").setCenter(new float[] {0.1951f,0.8226f,0.0246f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3265().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat66().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_thumb3").setDEF("Joe_l_thumb3").setCenter(new float[] {0.1955f,0.8159f,0.0464f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3267().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat68().getArray())))))
                                                            .addChild(new HAnimJoint().setName("l_index0").setDEF("Joe_l_index0").setCenter(new float[] {0.1983f,0.8024f,-0.028f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3269().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat70().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_index1").setDEF("Joe_l_index1").setCenter(new float[] {0.1983f,0.7815f,-0.028f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3271().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat72().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_index2").setDEF("Joe_l_index2").setCenter(new float[] {0.2017f,0.7363f,-0.0248f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3273().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat74().getArray()))
                                                                  .addChild(new HAnimJoint().setName("l_index3").setDEF("Joe_l_index3").setCenter(new float[] {0.2028f,0.7139f,-0.0236f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3275().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat76().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("l_middle0").setDEF("Joe_l_middle0").setCenter(new float[] {0.1987f,0.8029f,-0.053f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3277().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat78().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_middle1").setDEF("Joe_l_middle1").setCenter(new float[] {0.1987f,0.7818f,-0.053f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3279().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat80().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_middle2").setDEF("Joe_l_middle2").setCenter(new float[] {0.2013f,0.7273f,-0.0503f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3281().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat82().getArray()))
                                                                  .addChild(new HAnimJoint().setName("l_middle3").setDEF("Joe_l_middle3").setCenter(new float[] {0.2026f,0.7011f,-0.0494f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3283().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat84().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("l_ring0").setDEF("Joe_l_ring0").setCenter(new float[] {0.1956f,0.8019f,-0.0794f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3285().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat86().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_ring1").setDEF("Joe_l_ring1").setCenter(new float[] {0.1956f,0.7815f,-0.0794f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3287().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat88().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_ring2").setDEF("Joe_l_ring2").setCenter(new float[] {0.1973f,0.7287f,-0.0777f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3289().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat90().getArray()))
                                                                  .addChild(new HAnimJoint().setName("l_ring3").setDEF("Joe_l_ring3").setCenter(new float[] {0.1983f,0.7045f,-0.0767f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3291().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat92().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("l_pinky0").setDEF("Joe_l_pinky0").setCenter(new float[] {0.1925f,0.8066f,-0.1036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3293().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat94().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_pinky1").setDEF("Joe_l_pinky1").setCenter(new float[] {0.1925f,0.7866f,-0.1036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3295().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat96().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_pinky2").setDEF("Joe_l_pinky2").setCenter(new float[] {0.1938f,0.7452f,-0.1024f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3297().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat98().getArray()))
                                                                  .addChild(new HAnimJoint().setName("l_pinky3").setDEF("Joe_l_pinky3").setCenter(new float[] {0.1948f,0.7277f,-0.1017f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3299().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat100().getArray())))))))))))
                                                  .addChild(new HAnimJoint().setName("r_sternoclavicular").setDEF("Joe_r_sternoclavicular").setCenter(new float[] {-0.03f,1.46f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32101().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat102().getArray()))
                                                    .addChild(new HAnimJoint().setName("r_acromioclavicular").setDEF("Joe_r_acromioclavicular").setCenter(new float[] {-0.09f,1.41f,-0.11f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32103().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat104().getArray()))
                                                      .addChild(new HAnimJoint().setName("r_shoulder").setDEF("Joe_r_shoulder").setCenter(new float[] {-0.2f,1.44f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32105().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat106().getArray()))
                                                        .addChild(new HAnimJoint().setName("r_elbow").setDEF("Joe_r_elbow").setCenter(new float[] {-0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32107().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat108().getArray()))
                                                          .addChild(new HAnimJoint().setName("r_wrist").setDEF("Joe_r_wrist").setCenter(new float[] {-0.2f,0.89f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32109().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat110().getArray()))
                                                            .addChild(new HAnimJoint().setName("r_thumb1").setDEF("Joe_r_thumb1").setCenter(new float[] {-0.2f,0.85f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32111().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat112().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_thumb2").setDEF("Joe_r_thumb2").setCenter(new float[] {-0.2f,0.82f,0.03f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32113().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat114().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_thumb3").setDEF("Joe_r_thumb3").setCenter(new float[] {-0.2f,0.8f,0.05f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32115().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat116().getArray())))))
                                                            .addChild(new HAnimJoint().setName("r_index0").setDEF("Joe_r_index0").setCenter(new float[] {-0.2f,0.84f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32117().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat118().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_index1").setDEF("Joe_r_index1").setCenter(new float[] {-0.2f,0.793f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32119().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat120().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_index2").setDEF("Joe_r_index2").setCenter(new float[] {-0.2f,0.745f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32121().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat122().getArray()))
                                                                  .addChild(new HAnimJoint().setName("r_index3").setDEF("Joe_r_index3").setCenter(new float[] {-0.2f,0.72f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32123().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat124().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("r_middle0").setDEF("Joe_r_middle0").setCenter(new float[] {-0.2f,0.835f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32125().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat126().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_middle1").setDEF("Joe_r_middle1").setCenter(new float[] {-0.2f,0.788f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32127().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat128().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_middle2").setDEF("Joe_r_middle2").setCenter(new float[] {-0.2f,0.74f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32129().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat130().getArray()))
                                                                  .addChild(new HAnimJoint().setName("r_middle3").setDEF("Joe_r_middle3").setCenter(new float[] {-0.2f,0.7142f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32131().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat132().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("r_ring0").setDEF("Joe_r_ring0").setCenter(new float[] {-0.2f,0.835f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32133().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat134().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_ring1").setDEF("Joe_r_ring1").setCenter(new float[] {-0.2f,0.793f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32135().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat136().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_ring2").setDEF("Joe_r_ring2").setCenter(new float[] {-0.2f,0.74f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32137().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat138().getArray()))
                                                                  .addChild(new HAnimJoint().setName("r_ring3").setDEF("Joe_r_ring3").setCenter(new float[] {-0.2f,0.7177f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32139().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat140().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("r_pinky0").setDEF("Joe_r_pinky0").setCenter(new float[] {-0.2f,0.84f,-0.085f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32141().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat142().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_pinky1").setDEF("Joe_r_pinky1").setCenter(new float[] {-0.2f,0.79f,-0.085f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32143().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat144().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_pinky2").setDEF("Joe_r_pinky2").setCenter(new float[] {-0.2f,0.755f,-0.085f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32145().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat146().getArray()))
                                                                  .addChild(new HAnimJoint().setName("r_pinky3").setDEF("Joe_r_pinky3").setCenter(new float[] {-0.2f,0.735f,-0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32147().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat148().getArray()))))))))))))))))))))))))))))))
            .addSkin(new Shape().setDEF("Joe_Shape")
              .setAppearance(new Appearance().setDEF("Joe_skin_Appearance")
                ...
                .setTexture(new ImageTexture().setDEF("JoeSkinImageTexture").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString149().getArray())))
                .setTextureTransform(new TextureTransform().setDEF("KickTextureTransform")))
              .setGeometry(new IndexedFaceSet().setDEF("Joe_skin_IndexedFaceSet").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32150().getArray()).append(new MFInt32151().getArray()).append(new MFInt32152().getArray()).append(new MFInt32153().getArray())).setCreaseAngle(3.14f)
                .setCoord(new Coordinate().setDEF("Joe_SkinCoord").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f154().getArray()).append(new MFVec3f155().getArray())))
        ...
        .addChild(new Group()
          ...
          .addChild(new OrientationInterpolator().setDEF("HumanoidRootRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat157().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation158().getArray())))
          .addChild(new PositionInterpolator().setDEF("HumanoidRootTransInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat159().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f160().getArray())))
          .addChild(new OrientationInterpolator().setDEF("sacroiliacRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat161().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation162().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_hipRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat163().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation164().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_kneeRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat165().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation166().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ankleRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat167().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation168().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_subtalarRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat169().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation170().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_midtarsalRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat171().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation172().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_metatarsalRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat173().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation174().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_hipRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat175().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation176().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_kneeRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat177().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation178().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ankleRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat179().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation180().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_subtalarRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat181().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation182().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_midtarsalRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat183().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation184().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_metatarsalRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat185().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation186().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl5RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat187().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation188().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl4RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat189().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation190().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat191().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation192().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat193().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation194().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat195().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation196().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt12RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat197().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation198().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt11RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat199().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation200().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt10RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat201().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation202().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt9RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat203().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation204().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt8RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat205().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation206().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt7RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat207().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation208().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt6RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat209().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation210().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt5RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat211().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation212().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt4RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat213().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation214().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat215().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation216().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat217().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation218().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat219().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation220().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc7RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat221().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation222().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc6RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat223().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation224().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc5RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat225().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation226().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc4RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat227().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation228().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat229().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation230().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat231().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation232().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat233().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation234().getArray())))
          .addChild(new OrientationInterpolator().setDEF("skullbaseRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat235().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation236().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_eyelid_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat237().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation238().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_eyeball_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat239().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation240().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_eyebrow_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat241().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation242().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_eyelid_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat243().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation244().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_eyeball_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat245().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation246().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_eyebrow_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat247().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation248().getArray())))
          .addChild(new OrientationInterpolator().setDEF("temporomandibularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat249().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation250().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_sternoclavicularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat251().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation252().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_acromioclavicularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat253().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation254().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_shoulderRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat255().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation256().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_elbowRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat257().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation258().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_wristRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat259().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation260().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_thumb1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat261().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation262().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_thumb2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat263().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation264().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_thumb3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat265().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation266().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_index0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat267().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation268().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_index1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat269().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation270().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_index2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat271().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation272().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_index3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat273().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation274().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_middle0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat275().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation276().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_middle1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat277().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation278().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_middle2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat279().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation280().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_middle3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat281().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation282().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ring0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat283().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation284().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ring1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat285().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation286().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ring2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat287().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation288().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ring3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat289().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation290().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_pinky0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat291().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation292().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_pinky1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat293().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation294().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_pinky2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat295().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation296().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_pinky3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat297().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation298().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_sternoclavicularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat299().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation300().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_acromioclavicularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat301().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation302().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_shoulderRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat303().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation304().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_elbowRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat305().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation306().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_wristRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat307().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation308().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_thumb1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat309().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation310().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_thumb2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat311().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation312().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_thumb3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat313().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation314().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_index0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat315().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation316().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_index1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat317().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation318().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_index2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat319().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation320().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_index3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat321().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation322().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_middle0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat323().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation324().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_middle1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat325().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation326().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_middle2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat327().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation328().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_middle3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat329().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation330().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ring0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat331().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation332().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ring1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat333().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation334().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ring2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat335().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation336().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ring3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat337().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation338().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_pinky0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat339().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation340().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_pinky1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat341().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation342().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_pinky2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat343().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation344().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_pinky3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat345().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation346().getArray()))))
        ...
        .addChild(new Group().setDEF("DisplacersAnimationGroup")
          .addChild(new ScalarInterpolator().setDEF("skull_tipInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat347().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat348().getArray())))
        ...
        .addChild(new Group().setDEF("SkinTextureTransformAnimationGroup")
          .addChild(new ScalarInterpolator().setDEF("SkinInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat349().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat350().getArray())))
        ...
        .addChild(new Group()
          .addChild(new Transform().setDEF("SBall").setRotation(new float[] {0.7f,0f,0.7f,0.1f}).setScale(new float[] {0.23f,0.23f,0.23f}).setTranslation(new float[] {-0.916f,0.37f,-0.92f})
            .addChild(new Shape().setDEF("ball_Shape")
              ...
              .setGeometry(new IndexedFaceSet().setDEF("ball_IndexedFaceSet").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32351().getArray()))
                .setCoord(new Coordinate().setDEF("Ball_Coordinates").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f352().getArray())))))
          ...
          .addChild(new PositionInterpolator().setDEF("ballTransInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat353().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f354().getArray())))
          .addChild(new OrientationInterpolator().setDEF("ballRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat355().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation356().getArray())))
        ...
        .addChild(new Group()
          ...
          .addChild(new Transform().setDEF("Circle0").setScale(new float[] {1.175f,1f,1.175f})
            .addChild(new Shape().setDEF("circle_Shape")
              ...
              .setGeometry(new IndexedLineSet().setDEF("Orbit1").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32357().getArray()))
                .setCoord(new Coordinate().setDEF("circle_Coordinates").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f358().getArray()))))))

      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("Joe_Humanoid")
          .addChild(new HAnimHumanoid("Joe_Humanoid").setName("Kick").setDEF("Joe_Kick").setLoa(3).setVersion("2.0")
            .setMetadata(new MetadataSet("Joe_Kick").setName("warnings").setReference("HAnim")
            ...
            .addSkeleton(new HAnimJoint("Joe_Kick").setName("humanoid_root").setDEF("Joe_humanoid_root").setCenter(new float[] {0f,0.875f,0f}).setUlimit(new MFFloat2().getArray()).setLlimit(new MFFloat3().getArray())
              ...
              .addChild(new HAnimJoint("Joe_humanoid_root").setName("sacroiliac").setDEF("Joe_sacroiliac").setCenter(new float[] {0f,0.92f,0f}).setSkinCoordIndex(new MFInt328().getArray()).setSkinCoordWeight(new MFFloat9().getArray()).setUlimit(new MFFloat10().getArray()).setLlimit(new MFFloat11().getArray())
                .addChild(new HAnimJoint("Joe_sacroiliac").setName("l_hip").setDEF("Joe_l_hip").setCenter(new float[] {0.1f,0.92f,0f}).setSkinCoordIndex(new MFInt3212().getArray()).setSkinCoordWeight(new MFFloat13().getArray()).setUlimit(new MFFloat14().getArray()).setLlimit(new MFFloat15().getArray())
                  .addChild(new HAnimJoint("Joe_l_hip").setName("l_knee").setDEF("Joe_l_knee").setCenter(new float[] {0.115f,0.466f,0f}).setSkinCoordIndex(new MFInt3216().getArray()).setSkinCoordWeight(new MFFloat17().getArray()).setUlimit(new MFFloat18().getArray()).setLlimit(new MFFloat19().getArray())
                    .addChild(new HAnimJoint("Joe_l_knee").setName("l_talocrural").setDEF("Joe_l_talocrural").setCenter(new float[] {0.115f,0.069f,0f}).setSkinCoordIndex(new MFInt3220().getArray()).setSkinCoordWeight(new MFFloat21().getArray()).setUlimit(new MFFloat22().getArray()).setLlimit(new MFFloat23().getArray())
                      .addChild(new HAnimJoint("Joe_l_talocrural").setName("l_tarsometatarsal_2").setDEF("Joe_l_tarsometatarsal_2").setCenter(new float[] {0.115f,0.031f,0.03f}).setSkinCoordIndex(new MFInt3224().getArray()).setSkinCoordWeight(new MFFloat25().getArray()).setUlimit(new MFFloat26().getArray()).setLlimit(new MFFloat27().getArray())
                        .addChild(new HAnimJoint("Joe_l_tarsometatarsal_2").setName("l_metatarsophalangeal_2").setDEF("Joe_l_metatarsophalangeal_2").setCenter(new float[] {0.115f,0.037f,0.09f}).setSkinCoordIndex(new MFInt3228().getArray()).setSkinCoordWeight(new MFFloat29().getArray()).setUlimit(new MFFloat30().getArray()).setLlimit(new MFFloat31().getArray())
                          .addChild(new HAnimJoint("Joe_l_metatarsophalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setDEF("Joe_l_tarsal_distal_interphalangeal_2").setCenter(new float[] {0.115f,0.02f,0.122f}).setSkinCoordIndex(new MFInt3232().getArray()).setSkinCoordWeight(new MFFloat33().getArray()).setUlimit(new MFFloat34().getArray()).setLlimit(new MFFloat35().getArray())))))))
                .addChild(new HAnimJoint("Joe_sacroiliac").setName("r_hip").setDEF("Joe_r_hip").setCenter(new float[] {-0.1f,0.92f,0f}).setSkinCoordIndex(new MFInt3236().getArray()).setSkinCoordWeight(new MFFloat37().getArray()).setUlimit(new MFFloat38().getArray()).setLlimit(new MFFloat39().getArray())
                  .addChild(new HAnimJoint("Joe_r_hip").setName("r_knee").setDEF("Joe_r_knee").setCenter(new float[] {-0.05f,0.466f,0f}).setSkinCoordIndex(new MFInt3240().getArray()).setSkinCoordWeight(new MFFloat41().getArray()).setUlimit(new MFFloat42().getArray()).setLlimit(new MFFloat43().getArray())
                    .addChild(new HAnimJoint("Joe_r_knee").setName("r_talocrural").setDEF("Joe_r_talocrural").setCenter(new float[] {-0.115f,0.069f,0f}).setSkinCoordIndex(new MFInt3244().getArray()).setSkinCoordWeight(new MFFloat45().getArray()).setUlimit(new MFFloat46().getArray()).setLlimit(new MFFloat47().getArray())
                      .addChild(new HAnimJoint("Joe_r_talocrural").setName("r_tarsometatarsal_2").setDEF("Joe_r_tarsometatarsal_2").setCenter(new float[] {-0.1f,0.015f,-0.01f}).setSkinCoordIndex(new MFInt3248().getArray()).setSkinCoordWeight(new MFFloat49().getArray()).setUlimit(new MFFloat50().getArray()).setLlimit(new MFFloat51().getArray())
                        .addChild(new HAnimJoint("Joe_r_tarsometatarsal_2").setName("r_metatarsophalangeal_2").setDEF("Joe_r_metatarsophalangeal_2").setCenter(new float[] {-0.115f,0.037f,0.09f}).setSkinCoordIndex(new MFInt3252().getArray()).setSkinCoordWeight(new MFFloat53().getArray()).setUlimit(new MFFloat54().getArray()).setLlimit(new MFFloat55().getArray())
                          .addChild(new HAnimJoint("Joe_r_metatarsophalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setDEF("Joe_r_tarsal_distal_interphalangeal_2").setCenter(new float[] {-0.1f,0.01f,0.14f}).setSkinCoordIndex(new MFInt3256().getArray()).setSkinCoordWeight(new MFFloat57().getArray()).setUlimit(new MFFloat58().getArray()).setLlimit(new MFFloat59().getArray()))))))))
              .addChild(new HAnimJoint("Joe_humanoid_root").setName("vl5").setDEF("Joe_vl5").setCenter(new float[] {0f,1.045f,-0.095f}).setSkinCoordIndex(new MFInt3260().getArray()).setSkinCoordWeight(new MFFloat61().getArray()).setUlimit(new MFFloat62().getArray()).setLlimit(new MFFloat63().getArray())
                                          ...
                                          .addChild(new HAnimJoint("Joe_vt4").setName("vt3").setDEF("Joe_vt3").setCenter(new float[] {0f,1.438f,-0.12f}).setUlimit(new MFFloat98().getArray()).setLlimit(new MFFloat99().getArray())
                                            .addChild(new HAnimJoint("Joe_vt3").setName("vt2").setDEF("Joe_vt2").setCenter(new float[] {0f,1.468f,-0.105f}).setUlimit(new MFFloat100().getArray()).setLlimit(new MFFloat101().getArray())
                                              .addChild(new HAnimJoint("Joe_vt2").setName("vt1").setDEF("Joe_vt1").setCenter(new float[] {0f,1.497f,-0.09f}).setSkinCoordIndex(new MFInt32102().getArray()).setSkinCoordWeight(new MFFloat103().getArray()).setUlimit(new MFFloat104().getArray()).setLlimit(new MFFloat105().getArray())
                                                ...
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_l_acromioclavicular").setCenter(new float[] {0.082f,1.4488f,-0.0353f}).setSkinCoordIndex(new MFInt32142().getArray()).setSkinCoordWeight(new MFFloat143().getArray()).setUlimit(new MFFloat144().getArray()).setLlimit(new MFFloat145().getArray())
                                                  .addChild(new HAnimJoint("Joe_l_acromioclavicular").setName("l_acromioclavicular").setDEF("Joe_l_sternoclavicular").setCenter(new float[] {0.0962f,1.4269f,-0.0424f}).setSkinCoordIndex(new MFInt32146().getArray()).setSkinCoordWeight(new MFFloat147().getArray()).setUlimit(new MFFloat148().getArray()).setLlimit(new MFFloat149().getArray())
                                                    .addChild(new HAnimJoint("Joe_l_sternoclavicular").setName("l_shoulder").setDEF("Joe_l_shoulder").setCenter(new float[] {0.2f,1.44f,-0.04f}).setSkinCoordIndex(new MFInt32150().getArray()).setSkinCoordWeight(new MFFloat151().getArray()).setUlimit(new MFFloat152().getArray()).setLlimit(new MFFloat153().getArray())
                                                      .addChild(new HAnimJoint("Joe_l_shoulder").setName("l_elbow").setDEF("Joe_l_elbow").setCenter(new float[] {0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new MFInt32154().getArray()).setSkinCoordWeight(new MFFloat155().getArray()).setUlimit(new MFFloat156().getArray()).setLlimit(new MFFloat157().getArray())
                                                        .addChild(new HAnimJoint("Joe_l_elbow").setName("l_radiocarpal").setDEF("Joe_l_radiocarpal").setCenter(new float[] {0.2f,0.87f,-0.04f}).setSkinCoordIndex(new MFInt32158().getArray()).setSkinCoordWeight(new MFFloat159().getArray()).setUlimit(new MFFloat160().getArray()).setLlimit(new MFFloat161().getArray())
                                                          .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_1").setDEF("Joe_l_carpometacarpal_1").setCenter(new float[] {0.1924f,0.8472f,-0.0534f}).setSkinCoordIndex(new MFInt32162().getArray()).setSkinCoordWeight(new MFFloat163().getArray()).setUlimit(new MFFloat164().getArray()).setLlimit(new MFFloat165().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_carpometacarpal_1").setName("l_metacarpophalangeal_1").setDEF("Joe_l_metacarpophalangeal_1").setCenter(new float[] {0.1951f,0.8226f,0.0246f}).setSkinCoordIndex(new MFInt32166().getArray()).setSkinCoordWeight(new MFFloat167().getArray()).setUlimit(new MFFloat168().getArray()).setLlimit(new MFFloat169().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_1").setName("l_carpal_interphalangeal_1").setDEF("Joe_l_carpal_interphalangeal_1").setCenter(new float[] {0.1955f,0.8159f,0.0464f}).setSkinCoordIndex(new MFInt32170().getArray()).setSkinCoordWeight(new MFFloat171().getArray()).setUlimit(new MFFloat172().getArray()).setLlimit(new MFFloat173().getArray()))))
                                                          .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_2").setDEF("Joe_l_carpometacarpal_2").setCenter(new float[] {0.1983f,0.8024f,-0.028f}).setSkinCoordIndex(new MFInt32174().getArray()).setSkinCoordWeight(new MFFloat175().getArray()).setUlimit(new MFFloat176().getArray()).setLlimit(new MFFloat177().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_carpometacarpal_2").setName("l_metacarpophalangeal_2").setDEF("Joe_l_metacarpophalangeal_2").setCenter(new float[] {0.1983f,0.7815f,-0.028f}).setSkinCoordIndex(new MFInt32178().getArray()).setSkinCoordWeight(new MFFloat179().getArray()).setUlimit(new MFFloat180().getArray()).setLlimit(new MFFloat181().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_2").setName("l_carpal_proximal_interphalangeal_2").setDEF("Joe_l_carpal_proximal_interphalangeal_2").setCenter(new float[] {0.2017f,0.7363f,-0.0248f}).setSkinCoordIndex(new MFInt32182().getArray()).setSkinCoordWeight(new MFFloat183().getArray()).setUlimit(new MFFloat184().getArray()).setLlimit(new MFFloat185().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_2").setDEF("Joe_l_carpal_distal_interphalangeal_2").setCenter(new float[] {0.2028f,0.7139f,-0.0236f}).setSkinCoordIndex(new MFInt32186().getArray()).setSkinCoordWeight(new MFFloat187().getArray()).setUlimit(new MFFloat188().getArray()).setLlimit(new MFFloat189().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_3").setDEF("Joe_l_carpometacarpal_3").setCenter(new float[] {0.1987f,0.8029f,-0.053f}).setSkinCoordIndex(new MFInt32190().getArray()).setSkinCoordWeight(new MFFloat191().getArray()).setUlimit(new MFFloat192().getArray()).setLlimit(new MFFloat193().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_carpometacarpal_3").setName("l_metacarpophalangeal_3").setDEF("Joe_l_metacarpophalangeal_3").setCenter(new float[] {0.1987f,0.7818f,-0.053f}).setSkinCoordIndex(new MFInt32194().getArray()).setSkinCoordWeight(new MFFloat195().getArray()).setUlimit(new MFFloat196().getArray()).setLlimit(new MFFloat197().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_3").setName("l_carpal_proximal_interphalangeal_3").setDEF("Joe_l_carpal_proximal_interphalangeal_3").setCenter(new float[] {0.2013f,0.7273f,-0.0503f}).setSkinCoordIndex(new MFInt32198().getArray()).setSkinCoordWeight(new MFFloat199().getArray()).setUlimit(new MFFloat200().getArray()).setLlimit(new MFFloat201().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_3").setDEF("Joe_l_carpal_distal_interphalangeal_3").setCenter(new float[] {0.2026f,0.7011f,-0.0494f}).setSkinCoordIndex(new MFInt32202().getArray()).setSkinCoordWeight(new MFFloat203().getArray()).setUlimit(new MFFloat204().getArray()).setLlimit(new MFFloat205().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_4").setDEF("Joe_l_carpometacarpal_4").setCenter(new float[] {0.1956f,0.8019f,-0.0794f}).setSkinCoordIndex(new MFInt32206().getArray()).setSkinCoordWeight(new MFFloat207().getArray()).setUlimit(new MFFloat208().getArray()).setLlimit(new MFFloat209().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_carpometacarpal_4").setName("l_metacarpophalangeal_4").setDEF("Joe_l_metacarpophalangeal_4").setCenter(new float[] {0.1956f,0.7815f,-0.0794f}).setSkinCoordIndex(new MFInt32210().getArray()).setSkinCoordWeight(new MFFloat211().getArray()).setUlimit(new MFFloat212().getArray()).setLlimit(new MFFloat213().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_5").setDEF("Joe_l_carpometacarpal_5").setCenter(new float[] {0.1925f,0.8066f,-0.1036f}).setSkinCoordIndex(new MFInt32222().getArray()).setSkinCoordWeight(new MFFloat223().getArray()).setUlimit(new MFFloat224().getArray()).setLlimit(new MFFloat225().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_carpometacarpal_5").setName("l_metacarpophalangeal_5").setDEF("Joe_l_metacarpophalangeal_5").setCenter(new float[] {0.1925f,0.7866f,-0.1036f}).setSkinCoordIndex(new MFInt32226().getArray()).setSkinCoordWeight(new MFFloat227().getArray()).setUlimit(new MFFloat228().getArray()).setLlimit(new MFFloat229().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_5").setName("l_carpal_proximal_interphalangeal_5").setDEF("Joe_l_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.1938f,0.7452f,-0.1024f}).setSkinCoordIndex(new MFInt32230().getArray()).setSkinCoordWeight(new MFFloat231().getArray()).setUlimit(new MFFloat232().getArray()).setLlimit(new MFFloat233().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("Joe_r_sternoclavicular").setName("r_acromioclavicular").setDEF("Joe_r_acromioclavicular").setCenter(new float[] {-0.09f,1.41f,-0.11f}).setSkinCoordIndex(new MFInt32242().getArray()).setSkinCoordWeight(new MFFloat243().getArray()).setUlimit(new MFFloat244().getArray()).setLlimit(new MFFloat245().getArray())
                                                    .addChild(new HAnimJoint("Joe_r_acromioclavicular").setName("r_shoulder").setDEF("Joe_r_shoulder").setCenter(new float[] {-0.2f,1.44f,-0.04f}).setSkinCoordIndex(new MFInt32246().getArray()).setSkinCoordWeight(new MFFloat247().getArray()).setUlimit(new MFFloat248().getArray()).setLlimit(new MFFloat249().getArray())
                                                      .addChild(new HAnimJoint("Joe_r_shoulder").setName("r_elbow").setDEF("Joe_r_elbow").setCenter(new float[] {-0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new MFInt32250().getArray()).setSkinCoordWeight(new MFFloat251().getArray()).setUlimit(new MFFloat252().getArray()).setLlimit(new MFFloat253().getArray())
                                                        .addChild(new HAnimJoint("Joe_r_elbow").setName("r_radiocarpal").setDEF("Joe_r_radiocarpal").setCenter(new float[] {-0.2f,0.89f,-0.04f}).setSkinCoordIndex(new MFInt32254().getArray()).setSkinCoordWeight(new MFFloat255().getArray()).setUlimit(new MFFloat256().getArray()).setLlimit(new MFFloat257().getArray())
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setName("r_carpometacarpal_1").setDEF("Joe_r_carpometacarpal_1").setCenter(new float[] {-0.2f,0.85f,0f}).setSkinCoordIndex(new MFInt32258().getArray()).setSkinCoordWeight(new MFFloat259().getArray()).setUlimit(new MFFloat260().getArray()).setLlimit(new MFFloat261().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_1").setName("r_metacarpophalangeal_1").setDEF("Joe_r_metacarpophalangeal_1").setCenter(new float[] {-0.2f,0.82f,0.03f}).setSkinCoordIndex(new MFInt32262().getArray()).setSkinCoordWeight(new MFFloat263().getArray()).setUlimit(new MFFloat264().getArray()).setLlimit(new MFFloat265().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_1").setName("r_carpal_interphalangeal_1").setDEF("Joe_r_carpal_interphalangeal_1").setCenter(new float[] {-0.2f,0.8f,0.05f}).setSkinCoordIndex(new MFInt32266().getArray()).setSkinCoordWeight(new MFFloat267().getArray()).setUlimit(new MFFloat268().getArray()).setLlimit(new MFFloat269().getArray()))))
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setName("r_carpometacarpal_2").setDEF("Joe_r_carpometacarpal_2").setCenter(new float[] {-0.2f,0.84f,-0.015f}).setSkinCoordIndex(new MFInt32270().getArray()).setSkinCoordWeight(new MFFloat271().getArray()).setUlimit(new MFFloat272().getArray()).setLlimit(new MFFloat273().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_2").setName("r_metacarpophalangeal_2").setDEF("Joe_r_metacarpophalangeal_2").setCenter(new float[] {-0.2f,0.793f,-0.015f}).setSkinCoordIndex(new MFInt32274().getArray()).setSkinCoordWeight(new MFFloat275().getArray()).setUlimit(new MFFloat276().getArray()).setLlimit(new MFFloat277().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setDEF("Joe_r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-0.2f,0.745f,-0.015f}).setSkinCoordIndex(new MFInt32278().getArray()).setSkinCoordWeight(new MFFloat279().getArray()).setUlimit(new MFFloat280().getArray()).setLlimit(new MFFloat281().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setName("r_carpometacarpal_3").setDEF("Joe_r_carpometacarpal_3").setCenter(new float[] {-0.2f,0.835f,-0.04f}).setSkinCoordIndex(new MFInt32286().getArray()).setSkinCoordWeight(new MFFloat287().getArray()).setUlimit(new MFFloat288().getArray()).setLlimit(new MFFloat289().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_3").setName("r_metacarpophalangeal_3").setDEF("Joe_r_metacarpophalangeal_3").setCenter(new float[] {-0.2f,0.788f,-0.04f}).setSkinCoordIndex(new MFInt32290().getArray()).setSkinCoordWeight(new MFFloat291().getArray()).setUlimit(new MFFloat292().getArray()).setLlimit(new MFFloat293().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setName("r_carpometacarpal_4").setDEF("Joe_r_carpometacarpal_4").setCenter(new float[] {-0.2f,0.835f,-0.065f}).setSkinCoordIndex(new MFInt32302().getArray()).setSkinCoordWeight(new MFFloat303().getArray()).setUlimit(new MFFloat304().getArray()).setLlimit(new MFFloat305().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_4").setName("r_metacarpophalangeal_4").setDEF("Joe_r_metacarpophalangeal_4").setCenter(new float[] {-0.2f,0.793f,-0.065f}).setSkinCoordIndex(new MFInt32306().getArray()).setSkinCoordWeight(new MFFloat307().getArray()).setUlimit(new MFFloat308().getArray()).setLlimit(new MFFloat309().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setDEF("Joe_r_carpal_proximal_interphalangeal_4").setCenter(new float[] {-0.2f,0.74f,-0.065f}).setSkinCoordIndex(new MFInt32310().getArray()).setSkinCoordWeight(new MFFloat311().getArray()).setUlimit(new MFFloat312().getArray()).setLlimit(new MFFloat313().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setDEF("Joe_r_carpal_distal_interphalangeal_4").setCenter(new float[] {-0.2f,0.7177f,-0.065f}).setSkinCoordIndex(new MFInt32314().getArray()).setSkinCoordWeight(new MFFloat315().getArray()).setUlimit(new MFFloat316().getArray()).setLlimit(new MFFloat317().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setName("r_carpometacarpal_5").setDEF("Joe_r_carpometacarpal_5").setCenter(new float[] {-0.2f,0.84f,-0.085f}).setSkinCoordIndex(new MFInt32318().getArray()).setSkinCoordWeight(new MFFloat319().getArray()).setUlimit(new MFFloat320().getArray()).setLlimit(new MFFloat321().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_5").setName("r_metacarpophalangeal_5").setDEF("Joe_r_metacarpophalangeal_5").setCenter(new float[] {-0.2f,0.79f,-0.085f}).setSkinCoordIndex(new MFInt32322().getArray()).setSkinCoordWeight(new MFFloat323().getArray()).setUlimit(new MFFloat324().getArray()).setLlimit(new MFFloat325().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setDEF("Joe_r_carpal_proximal_interphalangeal_5").setCenter(new float[] {-0.2f,0.755f,-0.085f}).setSkinCoordIndex(new MFInt32326().getArray()).setSkinCoordWeight(new MFFloat327().getArray()).setUlimit(new MFFloat328().getArray()).setLlimit(new MFFloat329().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setDEF("Joe_r_carpal_distal_interphalangeal_5").setCenter(new float[] {-0.2f,0.735f,-0.09f}).setSkinCoordIndex(new MFInt32330().getArray()).setSkinCoordWeight(new MFFloat331().getArray()).setUlimit(new MFFloat332().getArray()).setLlimit(new MFFloat333().getArray()))))))))))))))))))))))))))))
            .addSkin(new Shape("Joe_Kick").setDEF("Joe_Shape")
            ...
            .setSkinCoord(new Coordinate("Joe_Kick").setUSE("Joe_SkinCoord"))
        ...
        .addChild(new Group().setDEF("SkinTextureTransformAnimationGroup")
          .addChild(new ScalarInterpolator("SkinTextureTransformAnimationGroup").setDEF("SkinInterpolator").setKey(new MFFloat534().getArray()).setKeyValue(new MFFloat535().getArray()))
          .addChild(new ROUTE("SkinTextureTransformAnimationGroup").setFromField("fraction_changed").setFromNode("KickTimer").setToField("set_fraction").setToNode("SkinInterpolator"))
          .addChild(new ROUTE("SkinTextureTransformAnimationGroup").setFromField("value_changed").setFromNode("SkinInterpolator").setToField("rotation").setToNode("KickTextureTransform")))
        .addChild(new Group()

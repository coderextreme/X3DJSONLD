                                                      ...
                                                      .addChild(new HAnimJoint().setName("l_shoulder").setDEF("Joe_l_shoulder").setCenter(new float[] {0.2f,1.44f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3254().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat55().getArray()))
                                                        .addChild(new HAnimJoint().setName("l_elbow").setDEF("Joe_l_elbow").setCenter(new float[] {0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3256().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat57().getArray()))
                                                          .addChild(new HAnimJoint().setName("l_radiocarpal").setDEF("Joe_l_radiocarpal").setCenter(new float[] {0.2f,0.87f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3258().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat59().getArray()))
                                                            .addChild(new HAnimJoint().setName("l_carpometacarpal_1").setDEF("Joe_l_carpometacarpal_1").setCenter(new float[] {0.1924f,0.8472f,-0.0534f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3260().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat61().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_metacarpophalangeal_1").setDEF("Joe_l_metacarpophalangeal_1").setCenter(new float[] {0.1951f,0.8226f,0.0246f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3262().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat63().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_carpal_interphalangeal_1").setDEF("Joe_l_carpal_interphalangeal_1").setCenter(new float[] {0.1955f,0.8159f,0.0464f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3264().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat65().getArray())))))
                                                            .addChild(new HAnimJoint().setName("l_carpometacarpal_2").setDEF("Joe_l_carpometacarpal_2").setCenter(new float[] {0.1983f,0.8024f,-0.028f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3266().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat67().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_metacarpophalangeal_2").setDEF("Joe_l_metacarpophalangeal_2").setCenter(new float[] {0.1983f,0.7815f,-0.028f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3268().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat69().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_2").setDEF("Joe_l_carpal_proximal_interphalangeal_2").setCenter(new float[] {0.2017f,0.7363f,-0.0248f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3270().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat71().getArray()))
                                                                  .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_2").setDEF("Joe_l_carpal_distal_interphalangeal_2").setCenter(new float[] {0.2028f,0.7139f,-0.0236f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3272().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat73().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("l_carpometacarpal_3").setDEF("Joe_l_carpometacarpal_3").setCenter(new float[] {0.1987f,0.8029f,-0.053f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3274().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat75().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_metacarpophalangeal_3").setDEF("Joe_l_metacarpophalangeal_3").setCenter(new float[] {0.1987f,0.7818f,-0.053f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3276().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat77().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_3").setDEF("Joe_l_carpal_proximal_interphalangeal_3").setCenter(new float[] {0.2013f,0.7273f,-0.0503f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3278().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat79().getArray()))
                                                                  .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_3").setDEF("Joe_l_carpal_distal_interphalangeal_3").setCenter(new float[] {0.2026f,0.7011f,-0.0494f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3280().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat81().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("l_carpometacarpal_4").setDEF("Joe_l_carpometacarpal_4").setCenter(new float[] {0.1956f,0.8019f,-0.0794f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3282().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat83().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_metacarpophalangeal_4").setDEF("Joe_l_metacarpophalangeal_4").setCenter(new float[] {0.1956f,0.7815f,-0.0794f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3284().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat85().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_4").setDEF("Joe_l_carpal_proximal_interphalangeal_4").setCenter(new float[] {0.1973f,0.7287f,-0.0777f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3286().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat87().getArray()))
                                                                  .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_4").setDEF("Joe_l_carpal_distal_interphalangeal_4").setCenter(new float[] {0.1983f,0.7045f,-0.0767f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3288().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat89().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("l_carpometacarpal_5").setDEF("Joe_l_carpometacarpal_5").setCenter(new float[] {0.1925f,0.8066f,-0.1036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3290().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat91().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_metacarpophalangeal_5").setDEF("Joe_l_metacarpophalangeal_5").setCenter(new float[] {0.1925f,0.7866f,-0.1036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3292().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat93().getArray()))
                                                                .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_5").setDEF("Joe_l_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.1938f,0.7452f,-0.1024f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3294().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat95().getArray()))
                                                                  .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_5").setDEF("Joe_l_carpal_distal_interphalangeal_5").setCenter(new float[] {0.1948f,0.7277f,-0.1017f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3296().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat97().getArray())))))))))))
                                                      ...
                                                      .addChild(new HAnimJoint().setName("r_shoulder").setDEF("Joe_r_shoulder").setCenter(new float[] {-0.2f,1.44f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32102().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat103().getArray()))
                                                        .addChild(new HAnimJoint().setName("r_elbow").setDEF("Joe_r_elbow").setCenter(new float[] {-0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32104().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat105().getArray()))
                                                          .addChild(new HAnimJoint().setName("r_radiocarpal").setDEF("Joe_r_radiocarpal").setCenter(new float[] {-0.2f,0.89f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32106().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat107().getArray()))
                                                            .addChild(new HAnimJoint().setName("r_carpometacarpal_1").setDEF("Joe_r_carpometacarpal_1").setCenter(new float[] {-0.2f,0.85f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32108().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat109().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_metacarpophalangeal_1").setDEF("Joe_r_metacarpophalangeal_1").setCenter(new float[] {-0.2f,0.82f,0.03f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32110().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat111().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_carpal_interphalangeal_1").setDEF("Joe_r_carpal_interphalangeal_1").setCenter(new float[] {-0.2f,0.8f,0.05f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32112().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat113().getArray())))))
                                                            .addChild(new HAnimJoint().setName("r_carpometacarpal_2").setDEF("Joe_r_carpometacarpal_2").setCenter(new float[] {-0.2f,0.84f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32114().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat115().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_metacarpophalangeal_2").setDEF("Joe_r_metacarpophalangeal_2").setCenter(new float[] {-0.2f,0.793f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32116().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat117().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_2").setDEF("Joe_r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-0.2f,0.745f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32118().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat119().getArray()))
                                                                  .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_2").setDEF("Joe_r_carpal_distal_interphalangeal_2").setCenter(new float[] {-0.2f,0.72f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32120().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat121().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("r_carpometacarpal_3").setDEF("Joe_r_carpometacarpal_3").setCenter(new float[] {-0.2f,0.835f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32122().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat123().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_metacarpophalangeal_3").setDEF("Joe_r_metacarpophalangeal_3").setCenter(new float[] {-0.2f,0.788f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32124().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat125().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_3").setDEF("Joe_r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-0.2f,0.74f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32126().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat127().getArray()))
                                                                  .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_3").setDEF("Joe_r_carpal_distal_interphalangeal_3").setCenter(new float[] {-0.2f,0.7142f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32128().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat129().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("r_carpometacarpal_4").setDEF("Joe_r_carpometacarpal_4").setCenter(new float[] {-0.2f,0.835f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32130().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat131().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_metacarpophalangeal_4").setDEF("Joe_r_metacarpophalangeal_4").setCenter(new float[] {-0.2f,0.793f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32132().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat133().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_4").setDEF("Joe_r_carpal_proximal_interphalangeal_4").setCenter(new float[] {-0.2f,0.74f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32134().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat135().getArray()))
                                                                  .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_4").setDEF("Joe_r_carpal_distal_interphalangeal_4").setCenter(new float[] {-0.2f,0.7177f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32136().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat137().getArray()))))))
                                                            .addChild(new HAnimJoint().setName("r_carpometacarpal_5").setDEF("Joe_r_carpometacarpal_5").setCenter(new float[] {-0.2f,0.84f,-0.085f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32138().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat139().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_metacarpophalangeal_5").setDEF("Joe_r_metacarpophalangeal_5").setCenter(new float[] {-0.2f,0.79f,-0.085f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32140().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat141().getArray()))
                                                                .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_5").setDEF("Joe_r_carpal_proximal_interphalangeal_5").setCenter(new float[] {-0.2f,0.755f,-0.085f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32142().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat143().getArray()))
                                                                  .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_5").setDEF("Joe_r_carpal_distal_interphalangeal_5").setCenter(new float[] {-0.2f,0.735f,-0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32144().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat145().getArray()))))))))))))))))))))))))))))))

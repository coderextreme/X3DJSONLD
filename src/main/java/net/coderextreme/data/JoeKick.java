  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("Mon, 15 Sep 2025 05:20:39 GMT"))
        ...
        .addMeta(new meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Skin/JoeKick.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new NavigationInfo().setDEF("Start_NavigationInfo").setSpeed(2.5f ))
        ...
        .addChild(new Group().setDEF("Joe_Humanoid")
          .addChild(new HAnimHumanoid("Joe_Humanoid").setDEF("Joe_Kick").setName("Kick").setLoa(4)
            ...
            .addSkeleton(new HAnimJoint("Joe_Kick").setDEF("Joe_humanoid_root").setName("humanoid_root").setTranslation(new float[] {-0.1962198f ,0.1405496f ,0.1216488f }).setRotation(new float[] {-0.999999999999999f ,0f ,0f ,0.5f }).setCenter(new float[] {0f ,0.875f ,0f })
              ...
              .addChild(new HAnimJoint("Joe_humanoid_root").setDEF("Joe_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f ,0.92f ,0f }).setSkinCoordIndex(new MFInt326().getArray()).setSkinCoordWeight(new MFFloat7().getArray())
                .addChild(new HAnimJoint("Joe_sacroiliac").setDEF("Joe_l_hip").setName("l_hip").setRotation(new float[] {1f ,0f ,0f ,0.931269831413142f }).setCenter(new float[] {0.1f ,0.92f ,0f }).setSkinCoordIndex(new MFInt328().getArray()).setSkinCoordWeight(new MFFloat9().getArray())
                  .addChild(new HAnimJoint("Joe_l_hip").setDEF("Joe_l_knee").setName("l_knee").setRotation(new float[] {0.998863602232125f ,0f ,0.0476602993681761f ,1.24505714055853f }).setCenter(new float[] {0.115f ,0.466f ,0f }).setSkinCoordIndex(new MFInt3210().getArray()).setSkinCoordWeight(new MFFloat11().getArray())
                    .addChild(new HAnimJoint("Joe_l_knee").setDEF("Joe_l_talocrural").setName("l_talocrural").setRotation(new float[] {1f ,0f ,0f ,0.899195750554403f }).setCenter(new float[] {0.115f ,0.069f ,0f }).setSkinCoordIndex(new MFInt3212().getArray()).setSkinCoordWeight(new MFFloat13().getArray())
                ...
                .addChild(new HAnimJoint("Joe_sacroiliac").setDEF("Joe_r_hip").setName("r_hip").setRotation(new float[] {-1f ,0f ,0f ,1f }).setCenter(new float[] {-0.1f ,0.92f ,0f }).setSkinCoordIndex(new MFInt3220().getArray()).setSkinCoordWeight(new MFFloat21().getArray())
                  .addChild(new HAnimJoint("Joe_r_hip").setDEF("Joe_r_knee").setName("r_knee").setRotation(new float[] {1f ,0f ,0f ,1.3487936258316f }).setCenter(new float[] {-0.05f ,0.466f ,0f }).setSkinCoordIndex(new MFInt3222().getArray()).setSkinCoordWeight(new MFFloat23().getArray())
                    .addChild(new HAnimJoint("Joe_r_knee").setDEF("Joe_r_talocrural").setName("r_talocrural").setRotation(new float[] {1f ,0f ,0f ,0.651206374168395f }).setCenter(new float[] {-0.115f ,0.069f ,0f }).setSkinCoordIndex(new MFInt3224().getArray()).setSkinCoordWeight(new MFFloat25().getArray())
                                          ...
                                          .addChild(new HAnimJoint("Joe_vt4").setDEF("Joe_vt3").setName("vt3").setCenter(new float[] {0f ,1.438f ,-0.12f })
                                            .addChild(new HAnimJoint("Joe_vt3").setDEF("Joe_vt2").setName("vt2").setCenter(new float[] {0f ,1.468f ,-0.105f })
                                              .addChild(new HAnimJoint("Joe_vt2").setDEF("Joe_vt1").setName("vt1").setCenter(new float[] {0f ,1.497f ,-0.09f }).setSkinCoordIndex(new MFInt3242().getArray()).setSkinCoordWeight(new MFFloat43().getArray())
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_vc7").setName("vc7").setCenter(new float[] {0f ,1.525f ,-0.072f }).setSkinCoordIndex(new MFInt3244().getArray()).setSkinCoordWeight(new MFFloat45().getArray())
                                                  .addChild(new HAnimJoint("Joe_vc7").setDEF("Joe_vc6").setName("vc6").setCenter(new float[] {0f ,1.54f ,-0.05f })
                                                    .addChild(new HAnimJoint("Joe_vc6").setDEF("Joe_vc5").setName("vc5").setCenter(new float[] {0f ,1.552f ,-0.035f })
                                                      .addChild(new HAnimJoint("Joe_vc5").setDEF("Joe_vc4").setName("vc4").setRotation(new float[] {0.79363313197937f ,0f ,0.608396623778117f ,0.509491241300095f }).setCenter(new float[] {0f ,1.5675f ,-0.0256f })
                                                        .addChild(new HAnimJoint("Joe_vc4").setDEF("Joe_vc3").setName("vc3").setCenter(new float[] {0f ,1.58225f ,-0.0185f })
                                                          .addChild(new HAnimJoint("Joe_vc3").setDEF("Joe_vc2").setName("vc2").setCenter(new float[] {0f ,1.595f ,-0.0175f })
                                                            .addChild(new HAnimJoint("Joe_vc2").setDEF("Joe_vc1").setName("vc1").setCenter(new float[] {0f ,1.61f ,-0.015f })
                                                              .addChild(new HAnimJoint("Joe_vc1").setDEF("Joe_skullbase").setName("skullbase").setRotation(new float[] {0f ,0.999999999999988f ,0f ,0.244155538082126f }).setCenter(new float[] {0f ,1.63f ,-0.01f }).setSkinCoordIndex(new MFInt3246().getArray()).setSkinCoordWeight(new MFFloat47().getArray())
                                                                .addDisplacers(new HAnimDisplacer("Joe_skullbase").setDEF("Joe_skull_tip_raiser_action").setName("skull_tip_raiser_action").setWeight(0.7399469f ).setCoordIndex(new MFInt3248().getArray()).setDisplacements(new MFVec3f49().getArray()))
                                                ...
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_l_acromioclavicular").setName("l_acromioclavicular").setCenter(new float[] {0.082f ,1.4488f ,-0.0353f }).setSkinCoordIndex(new MFInt3250().getArray()).setSkinCoordWeight(new MFFloat51().getArray())
                                                  .addChild(new HAnimJoint("Joe_l_acromioclavicular").setDEF("Joe_l_sternoclavicular").setName("l_sternoclavicular").setCenter(new float[] {0.0962f ,1.4269f ,-0.0424f }).setSkinCoordIndex(new MFInt3252().getArray()).setSkinCoordWeight(new MFFloat53().getArray())
                                                    .addChild(new HAnimJoint("Joe_l_sternoclavicular").setDEF("Joe_l_shoulder").setName("l_shoulder").setRotation(new float[] {-0.643733224193946f ,0f ,0.765249982730394f ,1.6862643538567f }).setCenter(new float[] {0.2f ,1.44f ,-0.04f }).setSkinCoordIndex(new MFInt3254().getArray()).setSkinCoordWeight(new MFFloat55().getArray())
                                                      .addChild(new HAnimJoint("Joe_l_shoulder").setDEF("Joe_l_elbow").setName("l_elbow").setRotation(new float[] {-0.80893714343502f ,-0.587895141986384f ,0f ,0.512375525586369f }).setCenter(new float[] {0.2f ,1.1388f ,-0.04f }).setSkinCoordIndex(new MFInt3256().getArray()).setSkinCoordWeight(new MFFloat57().getArray())
                                                        .addChild(new HAnimJoint("Joe_l_elbow").setDEF("Joe_l_radiocarpal").setName("l_radiocarpal").setRotation(new float[] {0f ,-0.447213595499958f ,0.894427190999917f ,0.491420745338246f }).setCenter(new float[] {0.2f ,0.87f ,-0.04f }).setSkinCoordIndex(new MFInt3258().getArray()).setSkinCoordWeight(new MFFloat59().getArray())
                                                ...
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-0.03f ,1.46f ,0f }).setSkinCoordIndex(new MFInt3298().getArray()).setSkinCoordWeight(new MFFloat99().getArray())
                                                  .addChild(new HAnimJoint("Joe_r_sternoclavicular").setDEF("Joe_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-0.09f ,1.41f ,-0.11f }).setSkinCoordIndex(new MFInt32100().getArray()).setSkinCoordWeight(new MFFloat101().getArray())
                                                    .addChild(new HAnimJoint("Joe_r_acromioclavicular").setDEF("Joe_r_shoulder").setName("r_shoulder").setRotation(new float[] {0f ,0f ,-1f ,1.7121984064579f }).setCenter(new float[] {-0.2f ,1.44f ,-0.04f }).setSkinCoordIndex(new MFInt32102().getArray()).setSkinCoordWeight(new MFFloat103().getArray())
                                                      .addChild(new HAnimJoint("Joe_r_shoulder").setDEF("Joe_r_elbow").setName("r_elbow").setRotation(new float[] {-0.80893714343502f ,-0.587895141986384f ,0f ,0.512375525586369f }).setCenter(new float[] {-0.2f ,1.1388f ,-0.04f }).setSkinCoordIndex(new MFInt32104().getArray()).setSkinCoordWeight(new MFFloat105().getArray())
                                                        .addChild(new HAnimJoint("Joe_r_elbow").setDEF("Joe_r_radiocarpal").setName("r_radiocarpal").setRotation(new float[] {0f ,-0.670839596599646f ,-0.741602478174135f ,0.341691938879626f }).setCenter(new float[] {-0.2f ,0.89f ,-0.04f }).setSkinCoordIndex(new MFInt32106().getArray()).setSkinCoordWeight(new MFFloat107().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setDEF("Joe_r_carpometacarpal_2").setName("r_carpometacarpal_2").setRotation(new float[] {0f ,0f ,1f ,0.302412748336791f }).setCenter(new float[] {-0.2f ,0.84f ,-0.015f }).setSkinCoordIndex(new MFInt32114().getArray()).setSkinCoordWeight(new MFFloat115().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_2").setDEF("Joe_r_metacarpophalangeal_2").setName("r_metacarpophalangeal_2").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.793f ,-0.015f }).setSkinCoordIndex(new MFInt32116().getArray()).setSkinCoordWeight(new MFFloat117().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_2").setDEF("Joe_r_carpal_proximal_interphalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.745f ,-0.015f }).setSkinCoordIndex(new MFInt32118().getArray()).setSkinCoordWeight(new MFFloat119().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_2").setDEF("Joe_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.72f ,-0.015f }).setSkinCoordIndex(new MFInt32120().getArray()).setSkinCoordWeight(new MFFloat121().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setDEF("Joe_r_carpometacarpal_3").setName("r_carpometacarpal_3").setRotation(new float[] {0f ,0f ,1f ,0.302412748336791f }).setCenter(new float[] {-0.2f ,0.835f ,-0.04f }).setSkinCoordIndex(new MFInt32122().getArray()).setSkinCoordWeight(new MFFloat123().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_3").setDEF("Joe_r_metacarpophalangeal_3").setName("r_metacarpophalangeal_3").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.788f ,-0.04f }).setSkinCoordIndex(new MFInt32124().getArray()).setSkinCoordWeight(new MFFloat125().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_3").setDEF("Joe_r_carpal_proximal_interphalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.74f ,-0.04f }).setSkinCoordIndex(new MFInt32126().getArray()).setSkinCoordWeight(new MFFloat127().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_3").setDEF("Joe_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.7142f ,-0.04f }).setSkinCoordIndex(new MFInt32128().getArray()).setSkinCoordWeight(new MFFloat129().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setDEF("Joe_r_carpometacarpal_4").setName("r_carpometacarpal_4").setRotation(new float[] {0f ,0f ,1f ,0.302412748336791f }).setCenter(new float[] {-0.2f ,0.835f ,-0.065f }).setSkinCoordIndex(new MFInt32130().getArray()).setSkinCoordWeight(new MFFloat131().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_4").setDEF("Joe_r_metacarpophalangeal_4").setName("r_metacarpophalangeal_4").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.793f ,-0.065f }).setSkinCoordIndex(new MFInt32132().getArray()).setSkinCoordWeight(new MFFloat133().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_4").setDEF("Joe_r_carpal_proximal_interphalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.74f ,-0.065f }).setSkinCoordIndex(new MFInt32134().getArray()).setSkinCoordWeight(new MFFloat135().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_4").setDEF("Joe_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.7177f ,-0.065f }).setSkinCoordIndex(new MFInt32136().getArray()).setSkinCoordWeight(new MFFloat137().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_radiocarpal").setDEF("Joe_r_carpometacarpal_5").setName("r_carpometacarpal_5").setRotation(new float[] {0f ,0f ,1f ,0.302412748336791f }).setCenter(new float[] {-0.2f ,0.84f ,-0.085f }).setSkinCoordIndex(new MFInt32138().getArray()).setSkinCoordWeight(new MFFloat139().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_carpometacarpal_5").setDEF("Joe_r_metacarpophalangeal_5").setName("r_metacarpophalangeal_5").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.79f ,-0.085f }).setSkinCoordIndex(new MFInt32140().getArray()).setSkinCoordWeight(new MFFloat141().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_5").setDEF("Joe_r_carpal_proximal_interphalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.755f ,-0.085f }).setSkinCoordIndex(new MFInt32142().getArray()).setSkinCoordWeight(new MFFloat143().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_5").setDEF("Joe_r_carpal_distal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setRotation(new float[] {0f ,0f ,1f ,0.453619122505188f }).setCenter(new float[] {-0.2f ,0.735f ,-0.09f }).setSkinCoordIndex(new MFInt32144().getArray()).setSkinCoordWeight(new MFFloat145().getArray()))))))))))))))))))))))))))))
            ...
            .addSkin(new Shape().setDEF("Joe_Shape")
              .setAppearance(new Appearance().setDEF("Joe_skin_Appearance")
                ...
                .setTextureTransform(new TextureTransform().setDEF("KickTextureTransform").setRotation(0.7560319f )))
        ...
        .addChild(new Group()
          .addChild(new Transform().setDEF("SBall").setTranslation(new float[] {1.750548f ,3.495979f ,8.727154f }).setRotation(new float[] {-0.700140042014005f ,0.140028008402801f ,-0.700140042014005f ,3f }).setScale(new float[] {0.23f ,0.23f ,0.23f })
        ...
        .addChild(new ROUTE().setFromNode("skull_tipInterpolator").setFromField("value_changed").setToNode("Joe_skull_tip_raiser_action").setToField("set_weight"))
        ...
        .addChild(new ROUTE().setFromNode("SkinInterpolator").setFromField("value_changed").setToNode("KickTextureTransform").setToField("set_rotation"))

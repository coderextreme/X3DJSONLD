...
public class JinLOA4Canonical {
  public static void main(String[] args) {
    ...
    X3D model = new JinLOA4Canonical().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/JinLOA4Canonical.new.json");
    }
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("JinLOA4").setDEF("hanim_JinLOA4").setScale(new float[] {0.0225f,0.0225f,0.0225f}).setVersion("2.0")
          .addSkeleton(new HAnimJoint("hanim_JinLOA4").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f,36.709999f,-0.7076f}).setUlimit(new MFFloat1().getArray()).setLlimit(new MFFloat2().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new float[] {0f,31.43f,-0.7076f}).setUlimit(new MFFloat8().getArray()).setLlimit(new MFFloat9().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {4.207f,36.740002f,-0.8155f}).setUlimit(new MFFloat14().getArray()).setLlimit(new MFFloat15().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {4.116f,18.17f,-0.8639f}).setUlimit(new MFFloat20().getArray()).setLlimit(new MFFloat21().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new float[] {3.948f,4.242f,-0.4645f}).setUlimit(new MFFloat26().getArray()).setLlimit(new MFFloat27().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocalcaneonavicular").setDEF("hanim_l_talocalcaneonavicular").setCenter(new float[] {3.48f,1.64f,0.2162f}).setUlimit(new MFFloat32().getArray()).setLlimit(new MFFloat33().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_1").setDEF("hanim_l_cuneonavicular_1").setCenter(new float[] {2.994f,1.427f,0.8174f}).setUlimit(new MFFloat38().getArray()).setLlimit(new MFFloat39().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setName("l_tarsometatarsal_1").setDEF("hanim_l_tarsometatarsal_1").setCenter(new float[] {2.872f,1.033f,1.964f}).setUlimit(new MFFloat44().getArray()).setLlimit(new MFFloat45().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setName("l_metatarsophalangeal_1").setDEF("hanim_l_metatarsophalangeal_1").setCenter(new float[] {2.761f,0.6411f,4.161f}).setUlimit(new MFFloat50().getArray()).setLlimit(new MFFloat51().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setName("l_tarsal_distal_interphalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_1").setCenter(new float[] {2.761f,0.5394f,5.125f}).setUlimit(new MFFloat56().getArray()).setLlimit(new MFFloat57().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_2").setDEF("hanim_l_cuneonavicular_2").setCenter(new float[] {3.619f,1.49f,0.9523f}).setUlimit(new MFFloat62().getArray()).setLlimit(new MFFloat63().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setName("l_tarsometatarsal_2").setDEF("hanim_l_tarsometatarsal_2").setCenter(new float[] {3.564f,1.16f,1.825f}).setUlimit(new MFFloat68().getArray()).setLlimit(new MFFloat69().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new float[] {3.668f,0.6656f,4.348f}).setUlimit(new MFFloat74().getArray()).setLlimit(new MFFloat75().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setCenter(new float[] {3.747f,0.5621f,5.067f}).setUlimit(new MFFloat80().getArray()).setLlimit(new MFFloat81().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setCenter(new float[] {3.747f,0.4367f,5.486f}).setUlimit(new MFFloat86().getArray()).setLlimit(new MFFloat87().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_3").setDEF("hanim_l_cuneonavicular_3").setCenter(new float[] {4.132f,1.484f,0.8808f}).setUlimit(new MFFloat92().getArray()).setLlimit(new MFFloat93().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setName("l_tarsometatarsal_3").setDEF("hanim_l_tarsometatarsal_3").setCenter(new float[] {4.204f,1.16f,1.751f}).setUlimit(new MFFloat98().getArray()).setLlimit(new MFFloat99().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setName("l_metatarsophalangeal_3").setDEF("hanim_l_metatarsophalangeal_3").setCenter(new float[] {4.288f,0.6692f,4.241f}).setUlimit(new MFFloat104().getArray()).setLlimit(new MFFloat105().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setName("l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setCenter(new float[] {4.394f,0.5299f,4.91f}).setUlimit(new MFFloat110().getArray()).setLlimit(new MFFloat111().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setCenter(new float[] {4.463f,0.4367f,5.32f}).setUlimit(new MFFloat116().getArray()).setLlimit(new MFFloat117().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_calcaneocuboid").setDEF("hanim_l_calcaneocuboid").setCenter(new float[] {3.96f,2.577f,-1.154f}).setUlimit(new MFFloat122().getArray()).setLlimit(new MFFloat123().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setName("l_transversetarsal").setDEF("hanim_l_transversetarsal").setCenter(new float[] {4.917f,1.568f,0.09285f}).setUlimit(new MFFloat128().getArray()).setLlimit(new MFFloat129().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_4").setDEF("hanim_l_tarsometatarsal_4").setCenter(new float[] {4.733f,1.091f,1.708f}).setUlimit(new MFFloat134().getArray()).setLlimit(new MFFloat135().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setName("l_metatarsophalangeal_4").setDEF("hanim_l_metatarsophalangeal_4").setCenter(new float[] {4.883f,0.6379f,4.052f}).setUlimit(new MFFloat140().getArray()).setLlimit(new MFFloat141().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setName("l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setCenter(new float[] {5.074f,0.5442f,4.725f}).setUlimit(new MFFloat146().getArray()).setLlimit(new MFFloat147().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setCenter(new float[] {5.141f,0.4164f,5.053f}).setUlimit(new MFFloat152().getArray()).setLlimit(new MFFloat153().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_5").setDEF("hanim_l_tarsometatarsal_5").setCenter(new float[] {5.37f,0.9309f,1.544f}).setUlimit(new MFFloat158().getArray()).setLlimit(new MFFloat159().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setName("l_metatarsophalangeal_5").setDEF("hanim_l_metatarsophalangeal_5").setCenter(new float[] {5.514f,0.6076f,3.847f}).setUlimit(new MFFloat164().getArray()).setLlimit(new MFFloat165().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setName("l_tarsal_proximal_interphalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_5").setCenter(new float[] {5.617f,0.4825f,4.184f}).setUlimit(new MFFloat170().getArray()).setLlimit(new MFFloat171().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setCenter(new float[] {5.657f,0.3806f,4.528f}).setUlimit(new MFFloat176().getArray()).setLlimit(new MFFloat177().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-4.207f,36.740002f,-0.8155f}).setUlimit(new MFFloat182().getArray()).setLlimit(new MFFloat183().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-4.116f,18.17f,-0.8639f}).setUlimit(new MFFloat188().getArray()).setLlimit(new MFFloat189().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-3.931f,4.242f,-0.4645f}).setUlimit(new MFFloat194().getArray()).setLlimit(new MFFloat195().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_talocalcaneonavicular").setDEF("hanim_r_talocalcaneonavicular").setCenter(new float[] {-3.464f,1.64f,0.2162f}).setUlimit(new MFFloat200().getArray()).setLlimit(new MFFloat201().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_1").setDEF("hanim_r_cuneonavicular_1").setCenter(new float[] {-2.977f,1.427f,0.8174f}).setUlimit(new MFFloat206().getArray()).setLlimit(new MFFloat207().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_1").setName("r_tarsometatarsal_1").setDEF("hanim_r_tarsometatarsal_1").setCenter(new float[] {-2.856f,1.033f,1.964f}).setUlimit(new MFFloat212().getArray()).setLlimit(new MFFloat213().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_1").setName("r_metatarsophalangeal_1").setDEF("hanim_r_metatarsophalangeal_1").setCenter(new float[] {-2.745f,0.6411f,4.161f}).setUlimit(new MFFloat218().getArray()).setLlimit(new MFFloat219().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_1").setName("r_tarsal_distal_interphalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_1").setCenter(new float[] {-2.744f,0.5394f,5.125f}).setUlimit(new MFFloat224().getArray()).setLlimit(new MFFloat225().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_2").setDEF("hanim_r_cuneonavicular_2").setCenter(new float[] {-3.602f,1.49f,0.9523f}).setUlimit(new MFFloat230().getArray()).setLlimit(new MFFloat231().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_2").setName("r_tarsometatarsal_2").setDEF("hanim_r_tarsometatarsal_2").setCenter(new float[] {-3.548f,1.16f,1.825f}).setUlimit(new MFFloat236().getArray()).setLlimit(new MFFloat237().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new float[] {-3.651f,0.6656f,4.348f}).setUlimit(new MFFloat242().getArray()).setLlimit(new MFFloat243().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setCenter(new float[] {-3.73f,0.5621f,5.067f}).setUlimit(new MFFloat248().getArray()).setLlimit(new MFFloat249().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setCenter(new float[] {-3.73f,0.4367f,5.486f}).setUlimit(new MFFloat254().getArray()).setLlimit(new MFFloat255().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_3").setDEF("hanim_r_cuneonavicular_3").setCenter(new float[] {-4.116f,1.484f,0.8808f}).setUlimit(new MFFloat260().getArray()).setLlimit(new MFFloat261().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_3").setName("r_tarsometatarsal_3").setDEF("hanim_r_tarsometatarsal_3").setCenter(new float[] {-4.188f,1.16f,1.751f}).setUlimit(new MFFloat266().getArray()).setLlimit(new MFFloat267().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_3").setName("r_metatarsophalangeal_3").setDEF("hanim_r_metatarsophalangeal_3").setCenter(new float[] {-4.271f,0.6692f,4.241f}).setUlimit(new MFFloat272().getArray()).setLlimit(new MFFloat273().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_3").setName("r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setCenter(new float[] {-4.378f,0.5299f,4.91f}).setUlimit(new MFFloat278().getArray()).setLlimit(new MFFloat279().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_3").setName("r_tarsal_distal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setCenter(new float[] {-4.446f,0.4367f,5.32f}).setUlimit(new MFFloat284().getArray()).setLlimit(new MFFloat285().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_calcaneocuboid").setDEF("hanim_r_calcaneocuboid").setCenter(new float[] {-3.943f,2.577f,-1.154f}).setUlimit(new MFFloat290().getArray()).setLlimit(new MFFloat291().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_calcaneocuboid").setName("r_transversetarsal").setDEF("hanim_r_transversetarsal").setCenter(new float[] {-4.901f,1.568f,0.09285f}).setUlimit(new MFFloat296().getArray()).setLlimit(new MFFloat297().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName("r_tarsometatarsal_4").setDEF("hanim_r_tarsometatarsal_4").setCenter(new float[] {-4.717f,1.091f,1.708f}).setUlimit(new MFFloat302().getArray()).setLlimit(new MFFloat303().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_4").setName("r_metatarsophalangeal_4").setDEF("hanim_r_metatarsophalangeal_4").setCenter(new float[] {-4.867f,0.6379f,4.052f}).setUlimit(new MFFloat308().getArray()).setLlimit(new MFFloat309().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_4").setName("r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setCenter(new float[] {-5.057f,0.5442f,4.725f}).setUlimit(new MFFloat314().getArray()).setLlimit(new MFFloat315().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_4").setName("r_tarsal_distal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setCenter(new float[] {-5.125f,0.4164f,5.053f}).setUlimit(new MFFloat320().getArray()).setLlimit(new MFFloat321().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName("r_tarsometatarsal_5").setDEF("hanim_r_tarsometatarsal_5").setCenter(new float[] {-5.353f,0.9309f,1.544f}).setUlimit(new MFFloat326().getArray()).setLlimit(new MFFloat327().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_5").setName("r_metatarsophalangeal_5").setDEF("hanim_r_metatarsophalangeal_5").setCenter(new float[] {-5.497f,0.6076f,3.847f}).setUlimit(new MFFloat332().getArray()).setLlimit(new MFFloat333().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_5").setName("r_tarsal_proximal_interphalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_5").setCenter(new float[] {-5.6f,0.4825f,4.184f}).setUlimit(new MFFloat338().getArray()).setLlimit(new MFFloat339().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_5").setName("r_tarsal_distal_interphalangeal_5").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setCenter(new float[] {-5.641f,0.3806f,4.528f}).setUlimit(new MFFloat344().getArray()).setLlimit(new MFFloat345().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f,41.130001f,-0.6117f}).setUlimit(new MFFloat350().getArray()).setLlimit(new MFFloat351().getArray())
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("vl4").setDEF("hanim_vl4").setCenter(new float[] {0f,42.209999f,-0.6117f}).setUlimit(new MFFloat356().getArray()).setLlimit(new MFFloat357().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_vl4").setName("vl3").setDEF("hanim_vl3").setCenter(new float[] {0f,42.93f,-0.6117f}).setUlimit(new MFFloat362().getArray()).setLlimit(new MFFloat363().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_vl3").setName("vl2").setDEF("hanim_vl2").setCenter(new float[] {0f,43.66f,-0.6117f}).setUlimit(new MFFloat368().getArray()).setLlimit(new MFFloat369().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_vl2").setName("vl1").setDEF("hanim_vl1").setCenter(new float[] {0f,44.43f,-0.6117f}).setUlimit(new MFFloat374().getArray()).setLlimit(new MFFloat375().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_vl1").setName("vt12").setDEF("hanim_vt12").setCenter(new float[] {0f,45.470001f,-0.6117f}).setUlimit(new MFFloat380().getArray()).setLlimit(new MFFloat381().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_vt12").setName("vt11").setDEF("hanim_vt11").setCenter(new float[] {0f,46.52f,-0.6117f}).setUlimit(new MFFloat386().getArray()).setLlimit(new MFFloat387().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_vt11").setName("vt10").setDEF("hanim_vt10").setCenter(new float[] {0f,47.279999f,-0.6127f}).setUlimit(new MFFloat392().getArray()).setLlimit(new MFFloat393().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_vt10").setName("vt9").setDEF("hanim_vt9").setCenter(new float[] {0f,47.93f,-0.6117f}).setUlimit(new MFFloat398().getArray()).setLlimit(new MFFloat399().getArray())
                                ...
                                .addChild(new HAnimJoint("hanim_vt9").setName("vt8").setDEF("hanim_vt8").setCenter(new float[] {0f,48.580002f,-0.6117f}).setUlimit(new MFFloat404().getArray()).setLlimit(new MFFloat405().getArray())
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt8").setName("vt7").setDEF("hanim_vt7").setCenter(new float[] {0f,49.279999f,-0.6117f}).setUlimit(new MFFloat410().getArray()).setLlimit(new MFFloat411().getArray())
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt7").setName("vt6").setDEF("hanim_vt6").setCenter(new float[] {0f,49.849998f,-0.6117f}).setUlimit(new MFFloat416().getArray()).setLlimit(new MFFloat417().getArray())
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt6").setName("vt5").setDEF("hanim_vt5").setCenter(new float[] {0f,50.540001f,-0.6117f}).setUlimit(new MFFloat422().getArray()).setLlimit(new MFFloat423().getArray())
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt5").setName("vt4").setDEF("hanim_vt4").setCenter(new float[] {0f,51.220001f,-0.6117f}).setUlimit(new MFFloat428().getArray()).setLlimit(new MFFloat429().getArray())
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setName("vt3").setDEF("hanim_vt3").setCenter(new float[] {0f,52.040001f,-0.6117f}).setUlimit(new MFFloat434().getArray()).setLlimit(new MFFloat435().getArray())
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setName("vt2").setDEF("hanim_vt2").setCenter(new float[] {0f,53.139999f,-0.6127f}).setUlimit(new MFFloat440().getArray()).setLlimit(new MFFloat441().getArray())
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setName("vt1").setDEF("hanim_vt1").setCenter(new float[] {0f,54.200001f,-0.6117f}).setUlimit(new MFFloat446().getArray()).setLlimit(new MFFloat447().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName("vc7").setDEF("hanim_vc7").setCenter(new float[] {0f,55.349998f,-0.6695f}).setUlimit(new MFFloat452().getArray()).setLlimit(new MFFloat453().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc7").setName("vc6").setDEF("hanim_vc6").setCenter(new float[] {0f,55.889999f,-0.6695f}).setUlimit(new MFFloat458().getArray()).setLlimit(new MFFloat459().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc6").setName("vc5").setDEF("hanim_vc5").setCenter(new float[] {0f,56.439999f,-0.6695f}).setUlimit(new MFFloat464().getArray()).setLlimit(new MFFloat465().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc5").setName("vc4").setDEF("hanim_vc4").setCenter(new float[] {0f,56.990002f,-0.6695f}).setUlimit(new MFFloat470().getArray()).setLlimit(new MFFloat471().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_vc4").setName("vc3").setDEF("hanim_vc3").setCenter(new float[] {0f,57.560001f,-0.6695f}).setUlimit(new MFFloat476().getArray()).setLlimit(new MFFloat477().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_vc3").setName("vc2").setDEF("hanim_vc2").setCenter(new float[] {0f,58.080002f,-0.6695f}).setUlimit(new MFFloat482().getArray()).setLlimit(new MFFloat483().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_vc2").setName("vc1").setDEF("hanim_vc1").setCenter(new float[] {0f,58.599998f,-0.6695f}).setUlimit(new MFFloat488().getArray()).setLlimit(new MFFloat489().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_vc1").setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f,58.34f,-0.6863f}).setUlimit(new MFFloat494().getArray()).setLlimit(new MFFloat495().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyelid_joint").setDEF("hanim_l_eyelid_joint").setCenter(new float[] {2.245f,63.299999f,1.464f}).setUlimit(new MFFloat506().getArray()).setLlimit(new MFFloat507().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyelid_joint").setDEF("hanim_r_eyelid_joint").setCenter(new float[] {-2.245f,63.299999f,1.464f}).setUlimit(new MFFloat512().getArray()).setLlimit(new MFFloat513().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyeball_joint").setDEF("hanim_l_eyeball_joint").setCenter(new float[] {2.139f,62.439999f,3.691f}).setUlimit(new MFFloat518().getArray()).setLlimit(new MFFloat519().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyeball_joint").setDEF("hanim_r_eyeball_joint").setCenter(new float[] {-2.139f,62.439999f,3.691f}).setUlimit(new MFFloat524().getArray()).setLlimit(new MFFloat525().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyebrow_joint").setDEF("hanim_l_eyebrow_joint").setCenter(new float[] {0.9666f,62.84f,4.753f}).setUlimit(new MFFloat530().getArray()).setLlimit(new MFFloat531().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyebrow_joint").setDEF("hanim_r_eyebrow_joint").setCenter(new float[] {-0.9666f,62.84f,4.753f}).setUlimit(new MFFloat536().getArray()).setLlimit(new MFFloat537().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("temporomandibular").setDEF("hanim_temporomandibular").setCenter(new float[] {0f,58.349998f,0.6835f}).setUlimit(new MFFloat542().getArray()).setLlimit(new MFFloat543().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName("l_acromioclavicular").setDEF("hanim_l_acromioclavicular").setCenter(new float[] {1.71f,53.720001f,-0.6127f}).setUlimit(new MFFloat548().getArray()).setLlimit(new MFFloat549().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName("l_sternoclavicular").setDEF("hanim_l_sternoclavicular").setCenter(new float[] {5.464f,52.970001f,-0.5732f}).setUlimit(new MFFloat554().getArray()).setLlimit(new MFFloat555().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {7.336f,52.380001f,-0.1452f}).setUlimit(new MFFloat560().getArray()).setLlimit(new MFFloat561().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {8.093f,41.279999f,-0.2502f}).setUlimit(new MFFloat566().getArray()).setLlimit(new MFFloat567().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {8.086f,32.189999f,-0.2233f}).setUlimit(new MFFloat572().getArray()).setLlimit(new MFFloat573().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_1").setDEF("hanim_l_midcarpal_1").setCenter(new float[] {8.057f,31.379999f,0.859f}).setUlimit(new MFFloat578().getArray()).setLlimit(new MFFloat579().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_1").setName("l_carpometacarpal_1").setDEF("hanim_l_carpometacarpal_1").setCenter(new float[] {8.022f,30.780001f,1.155f}).setUlimit(new MFFloat584().getArray()).setLlimit(new MFFloat585().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setName("l_metacarpophalangeal_1").setDEF("hanim_l_metacarpophalangeal_1").setCenter(new float[] {8.046f,29.9f,1.59f}).setUlimit(new MFFloat590().getArray()).setLlimit(new MFFloat591().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setName("l_carpal_interphalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setCenter(new float[] {8.118f,29.07f,2.207f}).setUlimit(new MFFloat596().getArray()).setLlimit(new MFFloat597().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_2").setDEF("hanim_l_midcarpal_2").setCenter(new float[] {8.057f,31.42f,0.3741f}).setUlimit(new MFFloat602().getArray()).setLlimit(new MFFloat603().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_2").setName("l_carpometacarpal_2").setDEF("hanim_l_carpometacarpal_2").setCenter(new float[] {8.057f,30.559999f,0.4324f}).setUlimit(new MFFloat608().getArray()).setLlimit(new MFFloat609().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setName("l_metacarpophalangeal_2").setDEF("hanim_l_metacarpophalangeal_2").setCenter(new float[] {8.166f,28.32f,0.67f}).setUlimit(new MFFloat614().getArray()).setLlimit(new MFFloat615().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setName("l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setCenter(new float[] {8.076f,26.969999f,0.6304f}).setUlimit(new MFFloat620().getArray()).setLlimit(new MFFloat621().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setCenter(new float[] {8.03f,25.85f,0.5949f}).setUlimit(new MFFloat626().getArray()).setLlimit(new MFFloat627().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_3").setDEF("hanim_l_midcarpal_3").setCenter(new float[] {8.048f,31.49f,-0.2132f}).setUlimit(new MFFloat632().getArray()).setLlimit(new MFFloat633().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_3").setName("l_carpometacarpal_3").setDEF("hanim_l_carpometacarpal_3").setCenter(new float[] {8.048f,30.48f,-0.2779f}).setUlimit(new MFFloat638().getArray()).setLlimit(new MFFloat639().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setName("l_metacarpophalangeal_3").setDEF("hanim_l_metacarpophalangeal_3").setCenter(new float[] {8.164f,28.219999f,-0.1741f}).setUlimit(new MFFloat644().getArray()).setLlimit(new MFFloat645().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setName("l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setCenter(new float[] {8.076f,26.809999f,-0.1572f}).setUlimit(new MFFloat650().getArray()).setLlimit(new MFFloat651().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setCenter(new float[] {8.03f,25.57f,-0.1671f}).setUlimit(new MFFloat656().getArray()).setLlimit(new MFFloat657().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_4_5").setDEF("hanim_l_midcarpal_4_5").setCenter(new float[] {8.048f,31.370001f,-1.144f}).setUlimit(new MFFloat662().getArray()).setLlimit(new MFFloat663().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_4_5").setName("l_carpometacarpal_4").setDEF("hanim_l_carpometacarpal_4").setCenter(new float[] {8.048f,30.5f,-0.8853f}).setUlimit(new MFFloat668().getArray()).setLlimit(new MFFloat669().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setName("l_metacarpophalangeal_4").setDEF("hanim_l_metacarpophalangeal_4").setCenter(new float[] {8.164f,28.18f,-0.9529f}).setUlimit(new MFFloat674().getArray()).setLlimit(new MFFloat675().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setName("l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setCenter(new float[] {8.076f,26.959999f,-0.9176f}).setUlimit(new MFFloat680().getArray()).setLlimit(new MFFloat681().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setCenter(new float[] {8.03f,25.809999f,-0.879f}).setUlimit(new MFFloat686().getArray()).setLlimit(new MFFloat687().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_carpometacarpal_5").setDEF("hanim_l_carpometacarpal_5").setCenter(new float[] {8.073f,30.59f,-1.457f}).setUlimit(new MFFloat692().getArray()).setLlimit(new MFFloat693().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setName("l_metacarpophalangeal_5").setDEF("hanim_l_metacarpophalangeal_5").setCenter(new float[] {8.148f,28.360001f,-1.647f}).setUlimit(new MFFloat698().getArray()).setLlimit(new MFFloat699().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setName("l_carpal_proximal_interphalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_5").setCenter(new float[] {8.074f,27.6f,-1.651f}).setUlimit(new MFFloat704().getArray()).setLlimit(new MFFloat705().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_5").setName("l_carpal_distal_interphalangeal_5").setDEF("hanim_l_carpal_distal_interphalangeal_5").setCenter(new float[] {8.036f,26.77f,-1.643f}).setUlimit(new MFFloat710().getArray()).setLlimit(new MFFloat711().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName("r_acromioclavicular").setDEF("hanim_r_acromioclavicular").setCenter(new float[] {-1.71f,53.720001f,-0.6127f}).setUlimit(new MFFloat716().getArray()).setLlimit(new MFFloat717().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_acromioclavicular").setName("r_sternoclavicular").setDEF("hanim_r_sternoclavicular").setCenter(new float[] {-5.464f,52.970001f,-0.5732f}).setUlimit(new MFFloat722().getArray()).setLlimit(new MFFloat723().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-7.32f,52.380001f,-0.1452f}).setUlimit(new MFFloat728().getArray()).setLlimit(new MFFloat729().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-8.077f,41.279999f,-0.2502f}).setUlimit(new MFFloat734().getArray()).setLlimit(new MFFloat735().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-8.07f,32.189999f,-0.2232f}).setUlimit(new MFFloat740().getArray()).setLlimit(new MFFloat741().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_1").setDEF("hanim_r_midcarpal_1").setCenter(new float[] {-8.043f,31.379999f,0.859f}).setUlimit(new MFFloat746().getArray()).setLlimit(new MFFloat747().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_1").setName("r_carpometacarpal_1").setDEF("hanim_r_carpometacarpal_1").setCenter(new float[] {-8.006f,30.780001f,1.155f}).setUlimit(new MFFloat752().getArray()).setLlimit(new MFFloat753().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setName("r_metacarpophalangeal_1").setDEF("hanim_r_metacarpophalangeal_1").setCenter(new float[] {-8.029f,29.9f,1.59f}).setUlimit(new MFFloat758().getArray()).setLlimit(new MFFloat759().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setName("r_carpal_interphalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setCenter(new float[] {-8.101f,29.07f,2.207f}).setUlimit(new MFFloat764().getArray()).setLlimit(new MFFloat765().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_2").setDEF("hanim_r_midcarpal_2").setCenter(new float[] {-8.043f,31.42f,0.3741f}).setUlimit(new MFFloat770().getArray()).setLlimit(new MFFloat771().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_2").setName("r_carpometacarpal_2").setDEF("hanim_r_carpometacarpal_2").setCenter(new float[] {-8.04f,30.559999f,0.4324f}).setUlimit(new MFFloat776().getArray()).setLlimit(new MFFloat777().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setName("r_metacarpophalangeal_2").setDEF("hanim_r_metacarpophalangeal_2").setCenter(new float[] {-8.149f,28.32f,0.67f}).setUlimit(new MFFloat782().getArray()).setLlimit(new MFFloat783().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-8.059f,26.969999f,0.6304f}).setUlimit(new MFFloat788().getArray()).setLlimit(new MFFloat789().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setCenter(new float[] {-8.013f,25.85f,0.5949f}).setUlimit(new MFFloat794().getArray()).setLlimit(new MFFloat795().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_3").setDEF("hanim_r_midcarpal_3").setCenter(new float[] {-8.032f,31.49f,-0.2132f}).setUlimit(new MFFloat800().getArray()).setLlimit(new MFFloat801().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_3").setName("r_carpometacarpal_3").setDEF("hanim_r_carpometacarpal_3").setCenter(new float[] {-8.032f,30.48f,-0.2779f}).setUlimit(new MFFloat806().getArray()).setLlimit(new MFFloat807().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setName("r_metacarpophalangeal_3").setDEF("hanim_r_metacarpophalangeal_3").setCenter(new float[] {-8.147f,28.219999f,-0.1741f}).setUlimit(new MFFloat812().getArray()).setLlimit(new MFFloat813().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-8.059f,26.809999f,-0.1572f}).setUlimit(new MFFloat818().getArray()).setLlimit(new MFFloat819().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setCenter(new float[] {-8.013f,25.57f,-0.1671f}).setUlimit(new MFFloat824().getArray()).setLlimit(new MFFloat825().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_4_5").setDEF("hanim_r_midcarpal_4_5").setCenter(new float[] {-8.032f,31.370001f,-1.144f}).setUlimit(new MFFloat830().getArray()).setLlimit(new MFFloat831().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_4_5").setName("r_carpometacarpal_4").setDEF("hanim_r_carpometacarpal_4").setCenter(new float[] {-8.032f,30.5f,-0.8853f}).setUlimit(new MFFloat836().getArray()).setLlimit(new MFFloat837().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setName("r_metacarpophalangeal_4").setDEF("hanim_r_metacarpophalangeal_4").setCenter(new float[] {-8.147f,28.18f,-0.9529f}).setUlimit(new MFFloat842().getArray()).setLlimit(new MFFloat843().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setCenter(new float[] {-8.059f,26.959999f,-0.9176f}).setUlimit(new MFFloat848().getArray()).setLlimit(new MFFloat849().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setCenter(new float[] {-8.013f,25.809999f,-0.879f}).setUlimit(new MFFloat854().getArray()).setLlimit(new MFFloat855().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_carpometacarpal_5").setDEF("hanim_r_carpometacarpal_5").setCenter(new float[] {-8.056f,30.59f,-1.457f}).setUlimit(new MFFloat860().getArray()).setLlimit(new MFFloat861().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setName("r_metacarpophalangeal_5").setDEF("hanim_r_metacarpophalangeal_5").setCenter(new float[] {-8.132f,28.360001f,-1.647f}).setUlimit(new MFFloat866().getArray()).setLlimit(new MFFloat867().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_5").setCenter(new float[] {-8.058f,27.6f,-1.651f}).setUlimit(new MFFloat872().getArray()).setLlimit(new MFFloat873().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setDEF("hanim_r_carpal_distal_interphalangeal_5").setCenter(new float[] {-8.02f,26.77f,-1.643f}).setUlimit(new MFFloat878().getArray()).setLlimit(new MFFloat879().getArray())

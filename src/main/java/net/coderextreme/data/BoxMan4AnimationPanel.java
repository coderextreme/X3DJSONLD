...
public class BoxMan4AnimationPanel implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new BoxMan4AnimationPanel().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/BoxMan4AnimationPanel.new.java.x3d");
    model.toFileJSON("../data/BoxMan4AnimationPanel.new.java.json");
    }
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle("BoxMan - A Seamless VRML Human").setInfo(new MFString0().getArray()))
              ...
              .addChild(new HAnimJoint("boxman_l_hip").setDEF("boxman_l_knee").setName("l_knee").setCenter(new float[] {0.0956f ,0.5095f ,-0.0036f }).setSkinCoordIndex(new MFInt328().getArray()).setSkinCoordWeight(new MFFloat9().getArray())
                .addChild(new HAnimSegment("boxman_l_knee").setDEF("boxman_l_calf").setName("l_calf")
                  .addChild(new Transform().setTranslation(new float[] {0.0956f ,0.5095f ,-0.0036f })
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint("boxman_l_knee").setDEF("boxman_l_ankle").setName("l_ankle").setRotation(new float[] {-1f ,0f ,0f ,0.888471427100471f }).setCenter(new float[] {0.0946f ,0.0762f ,-0.0261f }).setSkinCoordIndex(new MFInt3210().getArray()).setSkinCoordWeight(new MFFloat11().getArray())
                    ...
                    .addChild(new HAnimSegment("boxman_l_midtarsal").setDEF("boxman_l_middistal").setName("l_middistal")
                      ...
                      .addChild(new HAnimSite("boxman_l_middistal").setDEF("boxman_l_middistal_tip").setName("l_middistal_tip").setTranslation(new float[] {0.095f ,0.0005f ,0.1924f })
                        .addChild(new Shape().setDEF("SphereRed")
                          ...
                          .setGeometry(new Sphere().setRadius(0.02f )))))))))
            .addChild(new HAnimJoint("boxman_humanoid_root").setDEF("boxman_r_hip").setName("r_hip").setRotation(new float[] {-1f ,0f ,0f ,2.01809664178471f }).setCenter(new float[] {-0.0956f ,0.9364f ,0f }).setSkinCoordIndex(new MFInt3214().getArray()).setSkinCoordWeight(new MFFloat15().getArray())
              .addChild(new HAnimSegment("boxman_r_hip").setDEF("boxman_r_thigh").setName("r_thigh")
                .addChild(new Transform().setTranslation(new float[] {-0.0956f ,0.9364f ,0f })
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint("boxman_r_hip").setDEF("boxman_r_knee").setName("r_knee").setRotation(new float[] {1f ,0f ,0f ,1.67652764530233f }).setCenter(new float[] {-0.0956f ,0.5095f ,-0.0036f }).setSkinCoordIndex(new MFInt3216().getArray()).setSkinCoordWeight(new MFFloat17().getArray())
                .addChild(new HAnimSegment("boxman_r_knee").setDEF("boxman_r_calf").setName("r_calf")
                  .addChild(new Transform().setTranslation(new float[] {-0.0956f ,0.5095f ,-0.0036f })
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint("boxman_r_knee").setDEF("boxman_r_ankle").setName("r_ankle").setRotation(new float[] {-1f ,0f ,0f ,0.888471427100471f }).setCenter(new float[] {-0.0946f ,0.0762f ,-0.0261f }).setSkinCoordIndex(new MFInt3218().getArray()).setSkinCoordWeight(new MFFloat19().getArray())
            ...
            .addChild(new HAnimJoint("boxman_humanoid_root").setDEF("boxman_vl5").setName("vl5").setCenter(new float[] {0f ,1.0817f ,-0.0728f }).setSkinCoordIndex(new MFInt3222().getArray()).setSkinCoordWeight(new MFFloat23().getArray())
              .addChild(new HAnimSegment("boxman_vl5").setDEF("boxman_l5").setName("l5")
                .addChild(new Transform().setTranslation(new float[] {0f ,1.0817f ,-0.0728f })
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint("boxman_vl5").setDEF("boxman_skullbase").setName("skullbase").setRotation(new float[] {-0.999999999999998f ,0f ,0f ,0.447704477724534f }).setCenter(new float[] {0f ,1.644f ,0.036f }).setSkinCoordIndex(new MFInt3224().getArray()).setSkinCoordWeight(new MFFloat25().getArray())
                .addChild(new HAnimSegment("boxman_skullbase").setDEF("boxman_skull").setName("skull")
                  ...
                  .addChild(new HAnimSite("boxman_skull").setDEF("boxman_skull_tip").setName("skull_tip").setTranslation(new float[] {-0.0029f ,1.7771f ,0.0274f })
                    .addChild(new Shape().setUSE("SphereYellow")))))
              .addChild(new HAnimJoint("boxman_vl5").setDEF("boxman_l_shoulder").setName("l_shoulder").setRotation(new float[] {-0.235886128343184f ,0f ,0.971780702862154f ,1.74087617232715f }).setCenter(new float[] {0.1968f ,1.4642f ,-0.0265f }).setSkinCoordIndex(new MFInt3226().getArray()).setSkinCoordWeight(new MFFloat27().getArray())
                .addChild(new HAnimSegment("boxman_l_shoulder").setDEF("boxman_l_upperarm").setName("l_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {0.1968f ,1.4642f ,-0.0265f })
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint("boxman_l_shoulder").setDEF("boxman_l_elbow").setName("l_elbow").setRotation(new float[] {-0.970142500145332f ,0.242535625036333f ,0f ,2.45770714065071f }).setCenter(new float[] {0.1982f ,1.1622f ,-0.0557f }).setSkinCoordIndex(new MFInt3228().getArray()).setSkinCoordWeight(new MFFloat29().getArray())
                  .addChild(new HAnimSegment("boxman_l_elbow").setDEF("boxman_l_forearm").setName("l_forearm")
                    .addChild(new Transform().setTranslation(new float[] {0.1982f ,1.1622f ,-0.0557f })
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint("boxman_l_elbow").setDEF("boxman_l_wrist").setName("l_wrist").setRotation(new float[] {0f ,1f ,0f ,0.530093697003094f }).setCenter(new float[] {0.1972f ,0.8929f ,-0.069f }).setSkinCoordIndex(new MFInt3230().getArray()).setSkinCoordWeight(new MFFloat31().getArray())
                    .addChild(new HAnimSegment("boxman_l_wrist").setDEF("boxman_l_hand").setName("l_hand")
                      ...
                      .addChild(new HAnimSite("boxman_l_hand").setDEF("boxman_l_hand_tip").setName("l_hand_tip").setTranslation(new float[] {0.1912f ,0.6976f ,-0.071f })
                        .addChild(new Shape().setUSE("SphereRed")))))))
              .addChild(new HAnimJoint("boxman_vl5").setDEF("boxman_r_shoulder").setName("r_shoulder").setRotation(new float[] {0.235886128343184f ,0f ,0.971780702862155f ,4.54230913485243f }).setCenter(new float[] {-0.1968f ,1.4642f ,-0.0265f }).setSkinCoordIndex(new MFInt3232().getArray()).setSkinCoordWeight(new MFFloat33().getArray())
                .addChild(new HAnimSegment("boxman_r_shoulder").setDEF("boxman_r_upperarm").setName("r_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {-0.1968f ,1.4642f ,-0.0265f })
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint("boxman_r_shoulder").setDEF("boxman_r_elbow").setName("r_elbow").setRotation(new float[] {0.970142500145332f ,0.242535625036333f ,0f ,3.82547816652888f }).setCenter(new float[] {-0.1982f ,1.1622f ,-0.0557f }).setSkinCoordIndex(new MFInt3234().getArray()).setSkinCoordWeight(new MFFloat35().getArray())
                  .addChild(new HAnimSegment("boxman_r_elbow").setDEF("boxman_r_forearm").setName("r_forearm")
                    .addChild(new Transform().setTranslation(new float[] {-0.1982f ,1.1622f ,-0.0557f })
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint("boxman_r_elbow").setDEF("boxman_r_wrist").setName("r_wrist").setRotation(new float[] {0f ,1f ,0f ,5.75309161017649f }).setCenter(new float[] {-0.1972f ,0.8929f ,-0.069f }).setSkinCoordIndex(new MFInt3236().getArray()).setSkinCoordWeight(new MFFloat37().getArray())

...
public class BoxMan4AnimationPanel {
  public static void main(String[] args) {
    ...
    X3D model = new BoxMan4AnimationPanel().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/BoxMan4AnimationPanel.new.json");
    }
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan4AnimationPanel.x3d"))

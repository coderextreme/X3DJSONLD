...
public class Filters {
  public static void main(String[] args) {
    ...
    X3D model = new Filters().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/Filters.new.json");
    }
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("TransformAudio1").setTranslation(new float[] {-200f,50f,0f})
          .addChild(new Shape("TransformAudio1")
            .setAppearance(new Appearance().setDEF("audio_emit")
              .setMaterial(new Material("audio_emit").setDiffuseColor(new float[] {0.1f,0.1f,0.1f}).setEmissiveColor(new float[] {0.8f,0.8f,0.8f}).setSpecularColor(new float[] {0.01f,0.01f,0.01f})))
            .setGeometry(new Sphere().setRadius(30f))))
        .addChild(new Transform().setDEF("TransformAudio2").setTranslation(new float[] {0f,50f,0f})
          .addChild(new Shape("TransformAudio2")
            .setAppearance(new Appearance().setDEF("audio_emit2")
              .setMaterial(new Material("audio_emit2").setDiffuseColor(new float[] {0.1f,0.1f,0.1f}).setEmissiveColor(new float[] {0.8f,0.8f,0.8f}).setSpecularColor(new float[] {0.01f,0.01f,0.01f})))
            .setGeometry(new Sphere().setRadius(30f))))
        .addChild(new Transform().setDEF("TransformAudio3").setTranslation(new float[] {200f,50f,0f})
          .addChild(new Shape("TransformAudio3")
            .setAppearance(new Appearance().setDEF("audio_emit3")
              .setMaterial(new Material("audio_emit3").setDiffuseColor(new float[] {0.1f,0.1f,0.1f}).setEmissiveColor(new float[] {0.8f,0.8f,0.8f}).setSpecularColor(new float[] {0.01f,0.01f,0.01f})))
            .setGeometry(new Sphere().setRadius(30f))))
        ...
        .addChild(new Transform()
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("floor")
              .setMaterial(new Material("floor").setDiffuseColor(new float[] {0.1f,0.1f,0.1f}).setShininess(0.8f).setSpecularColor(new float[] {0.5f,0.6f,0.7f})))
          ...
          .addChild(new DynamicsCompressor().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
            .addChild(new Gain().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
              .addChild(new SpatialSound().setDEF("Audio1").setDistanceModel("INVERSE")
                .addChild(new Gain("Audio1").setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
              ...
              .addChild(new SpatialSound().setDEF("Audio2").setDistanceModel("INVERSE")
                .addChild(new Gain("Audio2").setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                  .addChild(new Analyser().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
              ...
              .addChild(new SpatialSound().setDEF("Audio3").setDistanceModel("INVERSE")
                .addChild(new Gain("Audio3").setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                  .addChild(new Analyser().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")

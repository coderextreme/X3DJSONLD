...
public class skeleton11 {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    new skeleton11().initialize().toFileJSON("../data/skeleton11.new.json");
    }
      ...
      .setScene(new Scene()
        .addChild(new Transform()
          ...
          .addChild(new Shape().setDEF("AxisLinesShape")
            ...
            .setGeometry(new IndexedLineSet().setColorIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt320().getArray())).setColorPerVertex(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt321().getArray()))
          ...
          .addChild(new Transform()
            ...
            .addChild(new Transform().setTranslation(new float[] {0f,2.05f,0f})
              .addChild(new Shape().setDEF("HAnimSegmentLine")
                .setGeometry(new LineSet().setVertexCount(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt324().getArray()))
            ...
            .addChild(new Transform().setTranslation(new float[] {0f,2.1f,0f})
              .addChild(new Shape().setDEF("HAnimSiteShape")
                .setGeometry(new IndexedFaceSet().setDEF("DiamondIFS").setCreaseAngle(0.5f).setSolid(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt327().getArray()))
                  .setColor(new ColorRGBA().setDEF("HAnimSiteColorRGBA").setColor(new org.web3d.x3d.jsail.fields.MFColorRGBA(new MFColorRGBA8().getArray())))

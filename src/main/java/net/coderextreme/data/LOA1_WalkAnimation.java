...
public class LOA1_WalkAnimation implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/LOA1_WalkAnimation.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("LOA1_WalkAnimation.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("creator")).setContent(new SFString("Cindy Ballreich cindy@ballreich.net 3Name3D")))
        ...
        .addMeta(new meta().setName(new SFString("translated")).setContent(new SFString("1 October 2001")))
        ...
        .addMeta(new meta().setName(new SFString("reference")).setContent(new SFString("https://HAnim.org/Specifications/HAnim2001")))
        ...
        .addMeta(new meta().setName(new SFString("subject")).setContent(new SFString("Nancy Walk Animation HAnim 2001")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/LOA1_WalkAnimation.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("LOA1_WalkAnimation.x3d")))
        .addChild(new ProtoDeclare().setName(new SFString("LOA1_WalkAnimation"))

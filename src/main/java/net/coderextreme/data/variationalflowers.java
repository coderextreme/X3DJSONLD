...
public class variationalflowers implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/variationalflowers.new.java.x3d");
    model.toFileJSON("../data/variationalflowers.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform()
          .addChild(new ParticleSystem().setMaxParticles(100).setGeometryType(new SFString("GEOMETRY"))
            ...
            .addComments(new CommentsBlock("* lastFrame - last frame that was rendered (0 for default)"))
            .addComments(new CommentsBlock("* updateRate - update rate is amount of time between frames"))
            .addComments(new CommentsBlock("<VariationPhysicsModel values=\"2 2 5 5 0 0\" varations=\"2 1 3 3 0.1 0.1\" lastFrame='0' updateRate='0.1'>"))
            .addComments(new CommentsBlock("</VariationPhysicsModel>"))
            ...
            .setAppearance(new Appearance()
              ...
              .addComments(new CommentsBlock("<ShaderPart url='\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' type='FRAGMENT'></ShaderPart>"))
              ...
              .addComments(new CommentsBlock("<ShaderPart url='\"../shaders/castle.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/>"))
              .addComments(new CommentsBlock("<ShaderPart type='FRAGMENT' url='\"../shaders/castle.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/>"))
              .addComments(new CommentsBlock("</ComposedShader>"))
              .addShaders(new ComposedShader().setDEF(new SFString("x_ite")).setLanguage(new SFString("GLSL"))
                ...
                .addField(new field().setType("MFFloat").setName(new SFString("x3d_ParticleValues")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFString("2 1 4 4 0 0")))
          ...
          .addChild(new Script().setDEF(new SFString("Animate"))
            ...
            .addField(new field().setType("MFFloat").setName(new SFString("values")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFString("2 2 5 5 0 0")))
            .addField(new field().setType("MFFloat").setName(new SFString("variations")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFString("0.2 0.1 0.3 0.3 0.01 0.01")))
            .addField(new field().setType("SFFloat").setName(new SFString("lastframe")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFString("0")))
            .addField(new field().setType("SFFloat").setName(new SFString("updaterate")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFString("0.1")))
...
"			    }\n"+
"			}"))
          .addChild(new TimeSensor().setDEF(new SFString("TourTime")).setCycleInterval(45d).setLoop(true))
          ...
          .addChild(new ROUTE().setFromNode(new SFString("Animate")).setFromField(new SFString("values")).setToNode(new SFString("x_ite")).setToField(new SFString("x3d_ParticleValues")))));
    return X3D0;
    }

                ...
                .addChild(new Transform().setTranslation(new double[] {1,0,0})
                  .addChild(new Shape()
                    ...
                    .setGeometry(new Text().setString(new MFString0().getArray())
                      .setFontStyle(new FontStyle().setSize(5).setJustify(new MFString1().getArray()))))))
...
"                }")))
        ...
        .addChild(new Transform().setDEF("HoldsContent").setScale(new double[] {0.1,0.1,0.1})
          .addChild(new PlaneSensor().setDEF("clickGenerator").setDescription("click on background to add nodes, click on nodes to add links").setMinPosition(new double[] {-50,-50}).setMaxPosition(new double[] {50,50}))

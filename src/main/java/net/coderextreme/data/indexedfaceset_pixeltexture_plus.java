...
public class indexedfaceset_pixeltexture_plus implements X3DRoots {
  public static void main(String[] args) {
    ...
    X3D model = new indexedfaceset_pixeltexture_plus().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/indexedfaceset_pixeltexture_plus.new.java.x3d");
    model.toFileJSON("../data/indexedfaceset_pixeltexture_plus.new.java.x3dj");
    }

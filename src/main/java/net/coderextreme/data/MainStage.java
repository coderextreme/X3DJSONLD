  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new DirectionalLight().setGlobal(true).setAmbientIntensity(1f).setDirection(new float[] {-0.5f,-0.5f,-0.5f}))
        .addChild(new DirectionalLight().setGlobal(true).setAmbientIntensity(1f).setDirection(new float[] {-1f,-1f,-1f}))
        .addChild(new DirectionalLight().setGlobal(true).setIntensity(0.5f).setAmbientIntensity(1f).setDirection(new float[] {1f,1f,-1f}))
        .addChild(new Viewpoint().setDEF("Scene_StageFrontViewFar").setDescription("hanim_Stage Front View").setPosition(new float[] {0f,4f,10f}).setOrientation(new float[] {1f,0f,0f,-0.449999988f}))
        .addChild(new Viewpoint().setDEF("Scene_InclinedView").setDescription("hanim_Inclined View").setPosition(new float[] {2.62f,1.05f,4.06f}).setOrientation(new float[] {-0.112999998f,0.992999971f,0.034699999f,0.671000004f}))
        .addChild(new Viewpoint().setDEF("Scene_StageFrontView").setDescription("hanim_Stage Front View").setPosition(new float[] {0f,1f,5f}))
        .addChild(new Viewpoint().setDEF("Scene_FeetStageBottomView").setDescription("hanim_feet View").setPosition(new float[] {0f,-10f,0f}).setOrientation(new float[] {1f,0f,0f,1.570000052f}))
        .addChild(new Viewpoint().setDEF("Scene_HeadTopView").setDescription("hanim_Head Top View").setPosition(new float[] {0f,15f,0f}).setOrientation(new float[] {1f,0f,0f,-1.570000052f}))
        .addChild(new Viewpoint().setDEF("Scene_TopFrontCloseView").setDescription("hanim_Head Top View").setPosition(new float[] {0f,8f,3f}).setOrientation(new float[] {1f,0f,0f,-1.100000024f}))
        .addChild(new Group().setDEF("HAnimStage")
          ...
          .addChild(new Transform().setDEF("StageGeometry").setTranslation(new float[] {0f,-0.01f,0f}).setScale(new float[] {1f,0.01f,1f})
            .addChild(new Shape()
            ...
            .addChild(new Transform().setDEF("Circle0")
              .addChild(new Shape()
                .setAppearance(new Appearance().setDEF("LineColor")
                  .setMaterial(new Material().setAmbientIntensity(1f).setDiffuseColor(new float[] {0.7f,0f,0.9f}).setSpecularColor(new float[] {0f,0f,1f}).setEmissiveColor(new float[] {0.45f,0.45f,1f}).setShininess(1f)))

  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("warning").setContent("need to fix HAnimHumanoid metadata form"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("humanoid").setDEF("hanim_humanoid").setVersion("2.0")
          ...
          .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            .setValue(new MetadataString().setName("authorEmail").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray())))
            .addValue(new MetadataString().setName("authorName").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())))
            .addValue(new MetadataString().setName("copyright").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())))
            .addValue(new MetadataString().setName("humanoidVersion").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray())))
            .addValue(new MetadataString().setName("usageRestrictions").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray()))))
              ...
              .addChild(new HAnimSegment().setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new Transform().setTranslation(new float[] {0f,0.9149f,0.0016f})
                  .addChild(new Shape().setDEF("DiamondShape")
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt326().getArray())).setCreaseAngle(0.5f)
                      .setCoord(new Coordinate().setDEF("points").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f7().getArray()))))

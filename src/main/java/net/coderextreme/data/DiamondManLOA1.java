...
public class DiamondManLOA1 implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new DiamondManLOA1().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/DiamondManLOA1.new.java.x3d");
    model.toFileJSON("../data/DiamondManLOA1.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_humanoid").setName("humanoid").setLoa(1)
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_l_hip").setName("l_hip").setCenter(new float[] {0.0961f ,0.9124f ,-0.0001f })
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setDEF("hanim_l_knee").setName("l_knee").setCenter(new float[] {0.104f ,0.4867f ,0.0308f })
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setDEF("hanim_l_talocrural").setName("l_talocrural").setCenter(new float[] {0.1101f ,0.0656f ,-0.0736f })
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(new float[] {0.1086f ,0.0001f ,0.0368f })
                      .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_2").setDEF("hanim_l_tarsal_proximal_phalanx_2").setName("l_tarsal_proximal_phalanx_2")
                        .addChild(new HAnimSite("hanim_l_tarsal_proximal_phalanx_2").setDEF("hanim_l_middistal_tip").setName("l_middistal_tip").setTranslation(new float[] {0.1354f ,0.0016f ,0.1476f }))
                        .addChild(new HAnimSite("hanim_l_tarsal_proximal_phalanx_2").setDEF("hanim_l_metatarsal_phalanx_5_pt").setName("l_metatarsal_phalanx_5_pt").setTranslation(new float[] {0.1825f ,0.007f ,0.0928f }))
                        ...
                        .addChild(new HAnimSite("hanim_l_tarsal_proximal_phalanx_2").setDEF("hanim_l_tarsal_distal_phalanx_2_pt").setName("l_tarsal_distal_phalanx_2_pt").setTranslation(new float[] {0.1195f ,0.0079f ,0.1433f })))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-0.095f ,0.9171f ,0.0029f })
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-0.0867f ,0.4913f ,0.0318f })
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_talocrural").setName("r_talocrural").setCenter(new float[] {-0.0801f ,0.0712f ,-0.0766f })
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(new float[] {-0.0801f ,0f ,0.0368f })
                      .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_2").setDEF("hanim_r_tarsal_proximal_phalanx_2").setName("r_tarsal_proximal_phalanx_2")
                        .addChild(new HAnimSite("hanim_r_tarsal_proximal_phalanx_2").setDEF("hanim_r_middistal_tip").setName("r_middistal_tip").setTranslation(new float[] {-0.1043f ,-0.0227f ,0.145f }))
                        .addChild(new HAnimSite("hanim_r_tarsal_proximal_phalanx_2").setDEF("hanim_r_metatarsal_phalanx_5_pt").setName("r_metatarsal_phalanx_5_pt").setTranslation(new float[] {-0.1523f ,0.0166f ,0.0895f }))
                        ...
                        .addChild(new HAnimSite("hanim_r_tarsal_proximal_phalanx_2").setDEF("hanim_r_tarsal_distal_phalanx_2_pt").setName("r_tarsal_distal_phalanx_2_pt").setTranslation(new float[] {-0.0883f ,0.0134f ,0.1383f }))))))))
                ...
                .addChild(new HAnimJoint("hanim_l_shoulder").setDEF("hanim_l_elbow").setName("l_elbow").setCenter(new float[] {0.2014f ,1.1357f ,-0.0682f })
                  ...
                  .addChild(new HAnimJoint("hanim_l_elbow").setDEF("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(new float[] {0.1984f ,0.8663f ,-0.0583f })
                    .addChild(new HAnimSegment("hanim_l_radiocarpal").setDEF("hanim_l_carpal").setName("l_carpal")
                      ...
                      .addChild(new HAnimSite("hanim_l_carpal").setDEF("hanim_l_hand_tip").setName("l_hand_tip").setTranslation(new float[] {0.208f ,0.6731f ,-0.0491f }))
                      ...
                      .addChild(new HAnimSite("hanim_l_carpal").setDEF("hanim_l_dactylion_pt").setName("l_dactylion_pt").setTranslation(new float[] {0.2056f ,0.6743f ,-0.0482f }))
                ...
                .addChild(new HAnimJoint("hanim_r_shoulder").setDEF("hanim_r_elbow").setName("r_elbow").setCenter(new float[] {-0.1949f ,1.1388f ,-0.062f })
                  ...
                  .addChild(new HAnimJoint("hanim_r_elbow").setDEF("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(new float[] {-0.1959f ,0.8694f ,-0.0521f })
                    .addChild(new HAnimSegment("hanim_r_radiocarpal").setDEF("hanim_r_carpal").setName("r_carpal")
                      ...
                      .addChild(new HAnimSite("hanim_r_carpal").setDEF("hanim_r_hand_tip").setName("r_hand_tip").setTranslation(new float[] {-0.1969f ,0.6758f ,-0.0427f }))
                      ...
                      .addChild(new HAnimSite("hanim_r_carpal").setDEF("hanim_r_dactylion_pt").setName("r_dactylion_pt").setTranslation(new float[] {-0.1941f ,0.6772f ,-0.0423f }))
          ...
          .addViewpoints(new HAnimSite("hanim_humanoid").setDEF("hanim_DiamondManLOA1_view").setName("DiamondManLOA1_view")

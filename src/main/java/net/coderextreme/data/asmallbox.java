...
public class asmallbox implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/asmallbox.new.java.x3d");
    model.toFileJSON("../data/asmallbox.new.java.x3dj");
    }
...
ProtoInstance ProtoInstance1 = null;
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("asmallbox.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/abox.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("a box"))))
      .setScene(new Scene()
        ...
        .addChild(new ProtoDeclare().setName(new SFString("one"))
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("MFNode").setName(new SFString("myShape")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT)
              .addChild(new Shape()
        ...
        .addChild(ProtoInstance1 = new ProtoInstance().setName(new SFString("one"))));
ProtoInstance1

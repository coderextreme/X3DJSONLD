...
public class indexedfaceset_pixeltexture_part {
  public static void main(String[] args) {
    ...
    X3D model = new indexedfaceset_pixeltexture_part().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/indexedfaceset_pixeltexture_part.new.json");
    }
...
protected class MFVec2f4 {
  protected org.web3d.x3d.jsail.fields.MFVec2f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec2f(new float[] {0.5000f,1.0000f,0.5000f,0.5000f,1.0000f,1.0000f,1.0000f,0.5000f});
  }
}
}

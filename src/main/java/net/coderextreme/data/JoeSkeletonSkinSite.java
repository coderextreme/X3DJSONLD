...
public class JoeSkeletonSkinSite implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new JoeSkeletonSkinSite().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/JoeSkeletonSkinSite.new.java.x3d");
    model.toFileJSON("../data/JoeSkeletonSkinSite.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("JoeSkeletonSkinSite.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("Comprehensive LOA4 example showing skeleton, skin, sites with no interpolator animation, includes EXPORT to enable separate Inline/IMPORT usage. All name, DEF, USE, fromNode, toNode values upgraded from legacy HAnim v1 to HAnim v2.")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Skin/JoeSkeletonSkinSite.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setInfo(new MFString0().getArray()).setTitle(new SFString("JoeSkeletonSkinSite.x3d")))
        ...
        .addChild(new Group().setDEF(new SFString("VisualizationShapes")).setVisible(false)
          .addChild(new Transform().setScale(new float[] {5f ,5f ,5f }).setTranslation(new float[] {0f ,2.1f ,0f })
            .addChild(new Shape().setDEF(new SFString("jointbox"))
              ...
              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt324().getArray()).setCreaseAngle(0.1f )
                .setColor(new Color().setColor(new MFColor5().getArray()))
                .setCoord(new Coordinate().setDEF(new SFString("boxCoords")).setPoint(new MFVec3f6().getArray())))))
          .addChild(new Transform().setScale(new float[] {0.1f ,0.1f ,0.1f }).setTranslation(new float[] {-0.2f ,0.773f ,-0.016f })
            .addChild(new Shape().setDEF(new SFString("sitebox"))
              ...
              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt327().getArray()).setCreaseAngle(0.1f )
          ...
          .addChild(new Transform().setScale(new float[] {0.1f ,0.1f ,0.1f }).setTranslation(new float[] {0f ,0.2f ,0f })
            .addChild(new Shape()
              ...
              .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt328().getArray())
          ...
          .addChild(new Group().setDEF(new SFString("JoeISOHumanoid"))
            .addChild(new HAnimHumanoid("JoeISOHumanoid").setName(new SFString("Human")).setDEF(new SFString("Joe_Human")).setLoa(4).setVersion(new SFString("2.0"))
              ...
              .setMetadata(new MetadataSet().setName(new SFString("HAnimHumanoid.info")).setReference(new SFString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid"))
                .setMetadata(new MetadataString().setName(new SFString("humanoidVersion")).setValue(new MFString10().getArray())))
              .addSkeleton(new HAnimJoint("Joe_Human").setName(new SFString("humanoid_root")).setDEF(new SFString("Joe_humanoid_root")).setCenter(new float[] {0f ,0.875f ,0f })
                .addChild(new HAnimSegment("Joe_humanoid_root").setName(new SFString("sacrum")).setDEF(new SFString("Joe_sacrum"))
                  ...
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3211().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0f ,0.87f ,-0.022f })
                    .addChild(new Shape().setUSE(new SFString("skinsphere")))))
                .addChild(new HAnimJoint("Joe_humanoid_root").setName(new SFString("sacroiliac")).setDEF(new SFString("Joe_sacroiliac")).setCenter(new float[] {0f ,0.92f ,0f }).setSkinCoordIndex(new MFInt3213().getArray()).setSkinCoordWeight(new MFFloat14().getArray())
                  .addChild(new HAnimSegment("Joe_sacroiliac").setName(new SFString("pelvis")).setDEF(new SFString("Joe_pelvis"))
                    ...
                    .addChild(new Shape()
                      .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                      .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3215().getArray())
                    ...
                    .addChild(new HAnimSite("Joe_pelvis").setName(new SFString("crotch_pt")).setDEF(new SFString("Joe_crotch_pt")).setTranslation(new float[] {0f ,0.87f ,-0.022f })
                      .addChild(new Shape().setUSE(new SFString("sitebox")))))
                  .addChild(new HAnimJoint("Joe_sacroiliac").setName(new SFString("l_hip")).setDEF(new SFString("Joe_l_hip")).setCenter(new float[] {0.1f ,0.92f ,0f }).setSkinCoordIndex(new MFInt3217().getArray()).setSkinCoordWeight(new MFFloat18().getArray())
                    .addChild(new HAnimSegment("Joe_l_hip").setName(new SFString("l_thigh")).setDEF(new SFString("Joe_l_thigh"))
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                        .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3219().getArray())
                      ...
                      .addChild(new HAnimSite("Joe_l_thigh").setName(new SFString("l_femoral_medial_epicondyle_pt")).setDEF(new SFString("Joe_l_femoral_medial_epicondyle_pt")).setTranslation(new float[] {0.05f ,0.466f ,0f })
                        .addChild(new Shape().setUSE(new SFString("sitebox")))))
                    .addChild(new HAnimJoint("Joe_l_hip").setName(new SFString("l_knee")).setDEF(new SFString("Joe_l_knee")).setCenter(new float[] {0.115f ,0.466f ,0f }).setSkinCoordIndex(new MFInt3221().getArray()).setSkinCoordWeight(new MFFloat22().getArray())
                      .addChild(new HAnimSegment("Joe_l_knee").setName(new SFString("l_calf")).setDEF(new SFString("Joe_l_calf"))
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                          .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3223().getArray())
                        ...
                        .addChild(new HAnimSite("Joe_l_calf").setName(new SFString("l_medial_malleolus_pt")).setDEF(new SFString("Joe_l_medial_malleolus_pt")).setTranslation(new float[] {0.085f ,0.086f ,0.0125f })
                          .addChild(new Shape().setUSE(new SFString("sitebox")))))
                      .addChild(new HAnimJoint("Joe_l_knee").setName(new SFString("l_talocrural")).setDEF(new SFString("Joe_l_talocrural")).setCenter(new float[] {0.115f ,0.069f ,0f }).setSkinCoordIndex(new MFInt3225().getArray()).setSkinCoordWeight(new MFFloat26().getArray())
                        .addChild(new HAnimSegment("Joe_l_talocrural").setName(new SFString("l_talus")).setDEF(new SFString("Joe_l_talus"))
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                            .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3227().getArray())
                          ...
                          .addChild(new HAnimSite("Joe_l_talus").setName(new SFString("l_calcaneus_posterior_pt")).setDEF(new SFString("Joe_l_calcaneus_posterior_pt")).setTranslation(new float[] {0.115f ,0.04f ,-0.055f })
                            .addChild(new Shape().setUSE(new SFString("sitebox")))))
                        .addChild(new HAnimJoint("Joe_l_talocrural").setName(new SFString("l_tarsometatarsal_2")).setDEF(new SFString("Joe_l_tarsometatarsal_2")).setCenter(new float[] {0.115f ,0.031f ,0.03f }).setSkinCoordIndex(new MFInt3229().getArray()).setSkinCoordWeight(new MFFloat30().getArray())
                          .addChild(new HAnimSegment("Joe_l_tarsometatarsal_2").setName(new SFString("l_metatarsal_2")).setDEF(new SFString("Joe_l_metatarsal_2"))
                            ...
                            .addChild(new Transform().setTranslation(new float[] {0.115f ,0.015f ,-0.045f })
                              .addChild(new Shape().setUSE(new SFString("skinsphere")))))
                          .addChild(new HAnimJoint("Joe_l_tarsometatarsal_2").setName(new SFString("l_metatarsophalangeal_2")).setDEF(new SFString("Joe_l_metatarsophalangeal_2")).setCenter(new float[] {0.115f ,0.037f ,0.09f }).setSkinCoordIndex(new MFInt3233().getArray()).setSkinCoordWeight(new MFFloat34().getArray())
                            .addChild(new HAnimSegment("Joe_l_metatarsophalangeal_2").setName(new SFString("l_tarsal_proximal_phalanx_2")).setDEF(new SFString("Joe_l_tarsal_proximal_phalanx_2"))
                              ...
                              .addChild(new Shape()
                                .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3235().getArray())
                              ...
                              .addChild(new HAnimSite("Joe_l_tarsal_proximal_phalanx_2").setName(new SFString("l_metatarsal_phalanx_1_pt")).setDEF(new SFString("Joe_l_metatarsal_phalanx_1_pt")).setTranslation(new float[] {0.087f ,0.01f ,0.122f })
                                .addChild(new Shape().setUSE(new SFString("sitebox")))))
                            .addChild(new HAnimJoint("Joe_l_metatarsophalangeal_2").setName(new SFString("l_metatarsal")).setDEF(new SFString("Joe_l_metatarsal")).setCenter(new float[] {0.115f ,0.02f ,0.122f }).setSkinCoordIndex(new MFInt3237().getArray()).setSkinCoordWeight(new MFFloat38().getArray())
                              .addChild(new HAnimSegment("Joe_l_metatarsal").setName(new SFString("l_tarsal_distal_phalanx_2")).setDEF(new SFString("Joe_l_tarsal_distal_phalanx_2"))
                                ...
                                .addChild(new Shape()
                                  .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                  .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3239().getArray())
                                ...
                                .addChild(new HAnimSite("Joe_l_tarsal_distal_phalanx_2").setName(new SFString("l_tarsal_distal_phalanx_2_pt")).setDEF(new SFString("Joe_l_tarsal_distal_phalanx_2_pt")).setTranslation(new float[] {0.11f ,0.011f ,0.19f })
                                  .addChild(new Shape().setUSE(new SFString("sitebox")))))))))))
                  .addChild(new HAnimJoint("Joe_sacroiliac").setName(new SFString("r_hip")).setDEF(new SFString("Joe_r_hip")).setCenter(new float[] {-0.1f ,0.92f ,0f }).setSkinCoordIndex(new MFInt3241().getArray()).setSkinCoordWeight(new MFFloat42().getArray())
                    .addChild(new HAnimSegment("Joe_r_hip").setName(new SFString("r_thigh")).setDEF(new SFString("Joe_r_thigh"))
                      ...
                      .addChild(new HAnimSite("Joe_r_thigh").setName(new SFString("r_femoral_medial_epicondyle_pt")).setDEF(new SFString("Joe_r_femoral_medial_epicondyle_pt")).setTranslation(new float[] {-0.05f ,0.466f ,0f })
                        .addChild(new Shape().setUSE(new SFString("sitebox")))))
                    .addChild(new HAnimJoint("Joe_r_hip").setName(new SFString("r_knee")).setDEF(new SFString("Joe_r_knee")).setCenter(new float[] {-0.05f ,0.466f ,0f }).setSkinCoordIndex(new MFInt3245().getArray()).setSkinCoordWeight(new MFFloat46().getArray())
                      .addChild(new HAnimSegment("Joe_r_knee").setName(new SFString("r_calf")).setDEF(new SFString("Joe_r_calf"))
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                          .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3247().getArray())
                        ...
                        .addChild(new HAnimSite("Joe_r_calf").setName(new SFString("r_medial_malleolus_pt")).setDEF(new SFString("Joe_r_medial_malleolus_pt")).setTranslation(new float[] {-0.085f ,0.086f ,0.0125f })
                          .addChild(new Shape().setUSE(new SFString("sitebox")))))
                      .addChild(new HAnimJoint("Joe_r_knee").setName(new SFString("r_talocrural")).setDEF(new SFString("Joe_r_talocrural")).setCenter(new float[] {-0.115f ,0.069f ,0f }).setSkinCoordIndex(new MFInt3249().getArray()).setSkinCoordWeight(new MFFloat50().getArray())
                        .addChild(new HAnimSegment("Joe_r_talocrural").setName(new SFString("r_talus")).setDEF(new SFString("Joe_r_talus"))
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                            .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3251().getArray())
                          ...
                          .addChild(new HAnimSite("Joe_r_talus").setName(new SFString("r_calcaneus_posterior_pt")).setDEF(new SFString("Joe_r_calcaneus_posterior_pt")).setTranslation(new float[] {-0.115f ,0.04f ,-0.055f })
                            .addChild(new Shape().setUSE(new SFString("sitebox")))))
                        .addChild(new HAnimJoint("Joe_r_talocrural").setName(new SFString("r_tarsometatarsal_2")).setDEF(new SFString("Joe_r_tarsometatarsal_2")).setCenter(new float[] {-0.1f ,0.015f ,-0.01f }).setSkinCoordIndex(new MFInt3253().getArray()).setSkinCoordWeight(new MFFloat54().getArray())
                          .addChild(new HAnimSegment("Joe_r_tarsometatarsal_2").setName(new SFString("r_metatarsal_2")).setDEF(new SFString("Joe_r_metatarsal_2"))
                            ...
                            .addChild(new Transform().setTranslation(new float[] {-0.095f ,0.006f ,-0.03f })
                              .addChild(new Shape().setUSE(new SFString("skinsphere")))))
                          .addChild(new HAnimJoint("Joe_r_tarsometatarsal_2").setName(new SFString("r_metatarsophalangeal_2")).setDEF(new SFString("Joe_r_metatarsophalangeal_2")).setCenter(new float[] {-0.115f ,0.037f ,0.09f }).setSkinCoordIndex(new MFInt3257().getArray()).setSkinCoordWeight(new MFFloat58().getArray())
                            .addChild(new HAnimSegment("Joe_r_metatarsophalangeal_2").setName(new SFString("r_tarsal_proximal_phalanx_2")).setDEF(new SFString("Joe_r_tarsal_proximal_phalanx_2"))
                              ...
                              .addChild(new Shape()
                                .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3259().getArray())
                              ...
                              .addChild(new HAnimSite("Joe_r_tarsal_proximal_phalanx_2").setName(new SFString("r_metatarsal_phalanx_1_pt")).setDEF(new SFString("Joe_r_metatarsal_phalanx_1_pt")).setTranslation(new float[] {-0.115f ,0.02f ,0.122f })
                                .addChild(new Shape().setUSE(new SFString("sitebox")))))
                            .addChild(new HAnimJoint("Joe_r_metatarsophalangeal_2").setName(new SFString("r_tarsal_distal_interphalangeal_2")).setDEF(new SFString("Joe_r_tarsal_distal_interphalangeal_2")).setCenter(new float[] {-0.1f ,0.01f ,0.14f }).setSkinCoordIndex(new MFInt3261().getArray()).setSkinCoordWeight(new MFFloat62().getArray())
                              .addChild(new HAnimSegment("Joe_r_tarsal_distal_interphalangeal_2").setName(new SFString("r_tarsal_distal_phalanx_2")).setDEF(new SFString("Joe_r_tarsal_distal_phalanx_2"))
                                ...
                                .addChild(new Shape()
                                  .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                  .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3263().getArray())
                                ...
                                .addChild(new HAnimSite("Joe_r_tarsal_distal_phalanx_2").setName(new SFString("r_tarsal_distal_phalanx_2_pt")).setDEF(new SFString("Joe_r_tarsal_distal_phalanx_2_pt")).setTranslation(new float[] {-0.11f ,0.011f ,0.19f })
                                  .addChild(new Shape().setUSE(new SFString("sitebox"))))))))))))
                .addChild(new HAnimJoint("Joe_humanoid_root").setName(new SFString("vl5")).setDEF(new SFString("Joe_vl5")).setCenter(new float[] {0f ,1.045f ,-0.095f }).setSkinCoordIndex(new MFInt3265().getArray()).setSkinCoordWeight(new MFFloat66().getArray())
                    ...
                    .addChild(new HAnimJoint("Joe_vl4").setName(new SFString("vl3")).setDEF(new SFString("Joe_vl3")).setCenter(new float[] {0f ,1.092f ,-0.0725f })
                      .addChild(new HAnimSegment("Joe_vl3").setName(new SFString("l3")).setDEF(new SFString("Joe_l3"))
                        ...
                        .addChild(new Transform().setTranslation(new float[] {0f ,1.092f ,-0.0725f })
                          .addChild(new Shape().setUSE(new SFString("jointbox")))))
                      .addChild(new HAnimJoint("Joe_vl3").setName(new SFString("vl2")).setDEF(new SFString("Joe_vl2")).setCenter(new float[] {0f ,1.12f ,-0.065f }).setSkinCoordIndex(new MFInt3275().getArray()).setSkinCoordWeight(new MFFloat76().getArray())
                        .addChild(new HAnimSegment("Joe_vl2").setName(new SFString("l2")).setDEF(new SFString("Joe_l2"))
                          .addChild(new Shape()
                            .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                            .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3277().getArray())
                            ...
                            .addChild(new HAnimJoint("Joe_vt12").setName(new SFString("vt11")).setDEF(new SFString("Joe_vt11")).setCenter(new float[] {0f ,1.2679f ,-0.081f })
                              .addChild(new HAnimSegment("Joe_vt11").setName(new SFString("t11")).setDEF(new SFString("Joe_t11"))
                                ...
                                .addChild(new Transform().setTranslation(new float[] {0f ,1.2145f ,-0.0755f })
                                  .addChild(new Shape().setUSE(new SFString("jointbox")))))
                              .addChild(new HAnimJoint("Joe_vt11").setName(new SFString("vt10")).setDEF(new SFString("Joe_vt10")).setCenter(new float[] {0f ,1.242f ,-0.09f }).setSkinCoordIndex(new MFInt3285().getArray()).setSkinCoordWeight(new MFFloat86().getArray())
                                .addChild(new HAnimSegment("Joe_vt10").setName(new SFString("t10")).setDEF(new SFString("Joe_t10"))
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                    .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt3287().getArray())
                                  ...
                                  .addChild(new HAnimSite("Joe_t10").setName(new SFString("substernale_pt")).setDEF(new SFString("Joe_substernale_pt")).setTranslation(new float[] {0f ,1.25f ,0.113f })
                                    .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                .addChild(new HAnimJoint("Joe_vt10").setName(new SFString("vt9")).setDEF(new SFString("Joe_vt9")).setCenter(new float[] {0f ,1.268f ,-0.1f }).setSkinCoordIndex(new MFInt3289().getArray()).setSkinCoordWeight(new MFFloat90().getArray())
                                        ...
                                        .addChild(new HAnimJoint("Joe_vt6").setName(new SFString("vt5")).setDEF(new SFString("Joe_vt5")).setCenter(new float[] {0f ,1.381f ,-0.1235f })
                                          .addChild(new HAnimSegment("Joe_vt5").setName(new SFString("t5")).setDEF(new SFString("Joe_t5"))
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {0f ,1.381f ,-0.1235f })
                                              .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                          .addChild(new HAnimJoint("Joe_vt5").setName(new SFString("vt4")).setDEF(new SFString("Joe_vt4")).setCenter(new float[] {0f ,1.41f ,-0.1235f }).setSkinCoordIndex(new MFInt32101().getArray()).setSkinCoordWeight(new MFFloat102().getArray())
                                              ...
                                              .addChild(new HAnimJoint("Joe_vt3").setName(new SFString("vt2")).setDEF(new SFString("Joe_vt2")).setCenter(new float[] {0f ,1.468f ,-0.105f })
                                                .addChild(new HAnimSegment("Joe_vt2").setName(new SFString("t2")).setDEF(new SFString("Joe_t2"))
                                                  ...
                                                  .addChild(new Transform().setTranslation(new float[] {0f ,1.468f ,-0.105f })
                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                .addChild(new HAnimJoint("Joe_vt2").setName(new SFString("vt1")).setDEF(new SFString("Joe_vt1")).setCenter(new float[] {0f ,1.497f ,-0.09f }).setSkinCoordIndex(new MFInt32109().getArray()).setSkinCoordWeight(new MFFloat110().getArray())
                                                  .addChild(new HAnimSegment("Joe_vt1").setName(new SFString("t1")).setDEF(new SFString("Joe_t1"))
                                                    ...
                                                    .addChild(new HAnimSite("Joe_t1").setName(new SFString("cervicale_pt")).setDEF(new SFString("Joe_cervicale_pt")).setTranslation(new float[] {0f ,1.53f ,-0.084f })
                                                      .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                  .addChild(new HAnimJoint("Joe_vt1").setName(new SFString("vc7")).setDEF(new SFString("Joe_vc7")).setCenter(new float[] {0f ,1.525f ,-0.072f }).setSkinCoordIndex(new MFInt32113().getArray()).setSkinCoordWeight(new MFFloat114().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("Joe_vc2").setName(new SFString("vc1")).setDEF(new SFString("Joe_vc1")).setCenter(new float[] {0f ,1.61f ,-0.015f })
                                                                .addChild(new HAnimSegment("Joe_vc1").setName(new SFString("c1")).setDEF(new SFString("Joe_c1"))
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0f ,1.61f ,-0.015f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_vc1").setName(new SFString("skullbase")).setDEF(new SFString("Joe_skullbase")).setCenter(new float[] {0f ,1.63f ,-0.01f }).setSkinCoordIndex(new MFInt32129().getArray()).setSkinCoordWeight(new MFFloat130().getArray())
                                                                  .addChild(new HAnimSegment("Joe_skullbase").setName(new SFString("skull")).setDEF(new SFString("Joe_skull"))
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                      .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32131().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("Joe_skullbase").setName(new SFString("r_eyeball_joint")).setDEF(new SFString("Joe_r_eyeball_joint")).setCenter(new float[] {-0.034f ,1.659f ,0.06f })
                                                                    .addChild(new HAnimSegment("Joe_r_eyeball_joint").setName(new SFString("r_eyeball")).setDEF(new SFString("Joe_r_eyeball"))
                                                                      ...
                                                                      .addChild(new Transform().setScale(new float[] {1f ,1f ,1.4f }).setTranslation(new float[] {-0.034f ,1.655f ,0.065f })
                                                                        .addChild(new Shape().setUSE(new SFString("jointbox"))))))))))))))
                                                  .addChild(new HAnimJoint("Joe_vt1").setName(new SFString("l_sternoclavicular")).setDEF(new SFString("Joe_l_sternoclavicular")).setCenter(new float[] {0.082f ,1.4488f ,-0.0353f }).setSkinCoordIndex(new MFInt32137().getArray()).setSkinCoordWeight(new MFFloat138().getArray())
                                                    .addChild(new HAnimSegment("Joe_l_sternoclavicular").setName(new SFString("l_clavicle")).setDEF(new SFString("Joe_l_clavicle"))
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                        .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32139().getArray())
                                                      ...
                                                      .addChild(new HAnimSite("Joe_l_clavicle").setName(new SFString("l_clavicle_pt")).setDEF(new SFString("Joe_l_clavicle_pt")).setTranslation(new float[] {0.03f ,1.46f ,0.035f })
                                                        .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                    .addChild(new HAnimJoint("Joe_l_sternoclavicular").setName(new SFString("l_acromioclavicular")).setDEF(new SFString("Joe_l_acromioclavicular")).setCenter(new float[] {0.0962f ,1.4269f ,-0.0424f }).setSkinCoordIndex(new MFInt32141().getArray()).setSkinCoordWeight(new MFFloat142().getArray())
                                                      .addChild(new HAnimSegment("Joe_l_acromioclavicular").setName(new SFString("l_scapula")).setDEF(new SFString("Joe_l_scapula"))
                                                        ...
                                                        .addChild(new HAnimSite("Joe_l_scapula").setName(new SFString("l_axilla_distal_pt")).setDEF(new SFString("Joe_l_axilla_distal_pt")).setTranslation(new float[] {0.16f ,1.38f ,-0.125f })
                                                          .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                      .addChild(new HAnimJoint("Joe_l_acromioclavicular").setName(new SFString("l_shoulder")).setDEF(new SFString("Joe_l_shoulder")).setCenter(new float[] {0.2f ,1.44f ,-0.04f }).setSkinCoordIndex(new MFInt32145().getArray()).setSkinCoordWeight(new MFFloat146().getArray())
                                                        .addChild(new HAnimSegment("Joe_l_shoulder").setName(new SFString("l_upperarm")).setDEF(new SFString("Joe_l_upperarm"))
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                            .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32147().getArray())
                                                          ...
                                                          .addChild(new HAnimSite("Joe_l_upperarm").setName(new SFString("l_humeral_lateral_epicondyle_pt")).setDEF(new SFString("Joe_l_humeral_lateral_epicondyle_pt")).setTranslation(new float[] {0.244f ,1.1388f ,-0.04f })
                                                            .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                        .addChild(new HAnimJoint("Joe_l_shoulder").setName(new SFString("l_elbow")).setDEF(new SFString("Joe_l_elbow")).setCenter(new float[] {0.2f ,1.1388f ,-0.04f }).setSkinCoordIndex(new MFInt32149().getArray()).setSkinCoordWeight(new MFFloat150().getArray())
                                                          .addChild(new HAnimSegment("Joe_l_elbow").setName(new SFString("l_forearm")).setDEF(new SFString("Joe_l_forearm"))
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                              .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32151().getArray())
                                                            ...
                                                            .addChild(new HAnimSite("Joe_l_forearm").setName(new SFString("l_olecranon_pt")).setDEF(new SFString("Joe_l_olecranon_pt")).setTranslation(new float[] {0.2f ,1.1388f ,-0.08f })
                                                              .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                          .addChild(new HAnimJoint("Joe_l_elbow").setName(new SFString("l_radiocarpal")).setDEF(new SFString("Joe_l_radiocarpal")).setCenter(new float[] {0.2f ,0.87f ,-0.04f }).setSkinCoordIndex(new MFInt32153().getArray()).setSkinCoordWeight(new MFFloat154().getArray())
                                                            .addChild(new HAnimSegment("Joe_l_radiocarpal").setName(new SFString("l_carpal")).setDEF(new SFString("Joe_l_carpal"))
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32155().getArray())
                                                              ...
                                                              .addChild(new HAnimSite("Joe_l_carpal").setName(new SFString("l_metacarpal_phalanx_5_pt")).setDEF(new SFString("Joe_l_metacarpal_phalanx_5_pt")).setTranslation(new float[] {0.1929f ,0.786f ,-0.1122f })
                                                                .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName(new SFString("l_carpometacarpal_1")).setDEF(new SFString("Joe_l_carpometacarpal_1")).setCenter(new float[] {0.1924f ,0.8472f ,-0.0534f }).setSkinCoordIndex(new MFInt32157().getArray()).setSkinCoordWeight(new MFFloat158().getArray())
                                                              .addChild(new HAnimSegment("Joe_l_carpometacarpal_1").setName(new SFString("l_metacarpal_1")).setDEF(new SFString("Joe_l_metacarpal_1"))
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                  .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32159().getArray())
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.1924f ,0.8472f ,-0.0534f })
                                                                  .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_1").setName(new SFString("l_metacarpophalangeal_1")).setDEF(new SFString("Joe_l_metacarpophalangeal_1")).setCenter(new float[] {0.1951f ,0.8226f ,0.0246f }).setSkinCoordIndex(new MFInt32161().getArray()).setSkinCoordWeight(new MFFloat162().getArray())
                                                                .addChild(new HAnimSegment("Joe_l_metacarpophalangeal_1").setName(new SFString("l_carpal_proximal_phalanx_1")).setDEF(new SFString("Joe_l_carpal_proximal_phalanx_1"))
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                    .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32163().getArray())
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.1951f ,0.8226f ,0.0246f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_1").setName(new SFString("l_carpal_interphalangeal_1")).setDEF(new SFString("Joe_l_carpal_interphalangeal_1")).setCenter(new float[] {0.1955f ,0.8159f ,0.0464f }).setSkinCoordIndex(new MFInt32165().getArray()).setSkinCoordWeight(new MFFloat166().getArray())
                                                                  .addChild(new HAnimSegment("Joe_l_carpal_interphalangeal_1").setName(new SFString("l_carpal_distal_phalanx_1")).setDEF(new SFString("Joe_l_carpal_distal_phalanx_1"))
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                      .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32167().getArray())
                                                                    ...
                                                                    .addChild(new HAnimSite("Joe_l_carpal_distal_phalanx_1").setName(new SFString("l_carpal_distal_phalanx_1_tip")).setDEF(new SFString("Joe_l_carpal_distal_phalanx_1_tip")).setTranslation(new float[] {0.1982f ,0.8061f ,0.0759f })
                                                                      .addChild(new Shape().setUSE(new SFString("sitebox"))))))))
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName(new SFString("l_carpometacarpal_2")).setDEF(new SFString("Joe_l_carpometacarpal_2")).setCenter(new float[] {0.1983f ,0.8024f ,-0.028f }).setSkinCoordIndex(new MFInt32169().getArray()).setSkinCoordWeight(new MFFloat170().getArray())
                                                              .addChild(new HAnimSegment("Joe_l_carpometacarpal_2").setName(new SFString("l_metacarpal_2")).setDEF(new SFString("Joe_l_metacarpal_2"))
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.1983f ,0.8024f ,-0.028f })
                                                                  .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_2").setName(new SFString("l_metacarpophalangeal_2")).setDEF(new SFString("Joe_l_metacarpophalangeal_2")).setCenter(new float[] {0.1983f ,0.7815f ,-0.028f }).setSkinCoordIndex(new MFInt32173().getArray()).setSkinCoordWeight(new MFFloat174().getArray())
                                                                .addChild(new HAnimSegment("Joe_l_metacarpophalangeal_2").setName(new SFString("l_carpal_proximal_phalanx_2")).setDEF(new SFString("Joe_l_carpal_proximal_phalanx_2"))
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.1983f ,0.7815f ,-0.028f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_2").setName(new SFString("l_carpal_proximal_interphalangeal_2")).setDEF(new SFString("Joe_l_carpal_proximal_interphalangeal_2")).setCenter(new float[] {0.2017f ,0.7363f ,-0.0248f }).setSkinCoordIndex(new MFInt32177().getArray()).setSkinCoordWeight(new MFFloat178().getArray())
                                                                  .addChild(new HAnimSegment("Joe_l_carpal_proximal_interphalangeal_2").setName(new SFString("l_carpal_middle_phalanx_2")).setDEF(new SFString("Joe_l_carpal_middle_phalanx_2"))
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new float[] {0.2017f ,0.7363f ,-0.0248f })
                                                                      .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                  .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_2").setName(new SFString("l_carpal_distal_interphalangeal_2")).setDEF(new SFString("Joe_l_carpal_distal_interphalangeal_2")).setCenter(new float[] {0.2028f ,0.7139f ,-0.0236f }).setSkinCoordIndex(new MFInt32181().getArray()).setSkinCoordWeight(new MFFloat182().getArray())
                                                                    .addChild(new HAnimSegment("Joe_l_carpal_distal_interphalangeal_2").setName(new SFString("l_carpal_distal_phalanx_2")).setDEF(new SFString("Joe_l_carpal_distal_phalanx_2"))
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                        .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32183().getArray())
                                                                      ...
                                                                      .addChild(new HAnimSite("Joe_l_carpal_distal_phalanx_2").setName(new SFString("l_dactylion_pt")).setDEF(new SFString("Joe_l_dactylion_pt")).setTranslation(new float[] {0.2056f ,0.6743f ,-0.0482f })
                                                                        .addChild(new Shape().setUSE(new SFString("sitebox")))))))))
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName(new SFString("l_carpometacarpal_3")).setDEF(new SFString("Joe_l_carpometacarpal_3")).setCenter(new float[] {0.1987f ,0.8029f ,-0.053f }).setSkinCoordIndex(new MFInt32185().getArray()).setSkinCoordWeight(new MFFloat186().getArray())
                                                              .addChild(new HAnimSegment("Joe_l_carpometacarpal_3").setName(new SFString("l_metacarpal_3")).setDEF(new SFString("Joe_l_metacarpal_3"))
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                  .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32187().getArray())
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.1987f ,0.8029f ,-0.053f })
                                                                  .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_3").setName(new SFString("l_metacarpophalangeal_3")).setDEF(new SFString("Joe_l_metacarpophalangeal_3")).setCenter(new float[] {0.1987f ,0.7818f ,-0.053f }).setSkinCoordIndex(new MFInt32189().getArray()).setSkinCoordWeight(new MFFloat190().getArray())
                                                                .addChild(new HAnimSegment("Joe_l_metacarpophalangeal_3").setName(new SFString("l_carpal_proximal_phalanx_3")).setDEF(new SFString("Joe_l_carpal_proximal_phalanx_3"))
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.1987f ,0.7818f ,-0.053f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_3").setName(new SFString("l_carpal_proximal_interphalangeal_3")).setDEF(new SFString("Joe_l_carpal_proximal_interphalangeal_3")).setCenter(new float[] {0.2013f ,0.7273f ,-0.0503f }).setSkinCoordIndex(new MFInt32193().getArray()).setSkinCoordWeight(new MFFloat194().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_3").setName(new SFString("l_carpal_distal_interphalangeal_3")).setDEF(new SFString("Joe_l_carpal_distal_interphalangeal_3")).setCenter(new float[] {0.2026f ,0.7011f ,-0.0494f }).setSkinCoordIndex(new MFInt32197().getArray()).setSkinCoordWeight(new MFFloat198().getArray())
                                                                    .addChild(new HAnimSegment("Joe_l_carpal_distal_interphalangeal_3").setName(new SFString("l_carpal_distal_phalanx_3")).setDEF(new SFString("Joe_l_carpal_distal_phalanx_3"))
                                                                      ...
                                                                      .addChild(new Transform().setTranslation(new float[] {0.2026f ,0.7011f ,-0.0494f })
                                                                        .addChild(new Shape().setUSE(new SFString("jointbox")))))))))
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName(new SFString("l_carpometacarpal_4")).setDEF(new SFString("Joe_l_carpometacarpal_4")).setCenter(new float[] {0.1956f ,0.8019f ,-0.0794f }).setSkinCoordIndex(new MFInt32201().getArray()).setSkinCoordWeight(new MFFloat202().getArray())
                                                              .addChild(new HAnimSegment("Joe_l_carpometacarpal_4").setName(new SFString("l_metacarpal_4")).setDEF(new SFString("Joe_l_metacarpal_4"))
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.1956f ,0.8019f ,-0.0794f })
                                                                  .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_4").setName(new SFString("l_metacarpophalangeal_4")).setDEF(new SFString("Joe_l_metacarpophalangeal_4")).setCenter(new float[] {0.1956f ,0.7815f ,-0.0794f }).setSkinCoordIndex(new MFInt32205().getArray()).setSkinCoordWeight(new MFFloat206().getArray())
                                                                .addChild(new HAnimSegment("Joe_l_metacarpophalangeal_4").setName(new SFString("l_carpal_proximal_phalanx_4")).setDEF(new SFString("Joe_l_carpal_proximal_phalanx_4"))
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.1956f ,0.7815f ,-0.0794f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_4").setName(new SFString("l_carpal_proximal_interphalangeal_4")).setDEF(new SFString("Joe_l_carpal_proximal_interphalangeal_4")).setCenter(new float[] {0.1973f ,0.7287f ,-0.0777f }).setSkinCoordIndex(new MFInt32209().getArray()).setSkinCoordWeight(new MFFloat210().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_4").setName(new SFString("l_carpal_distal_interphalangeal_4")).setDEF(new SFString("Joe_l_carpal_distal_interphalangeal_4")).setCenter(new float[] {0.1983f ,0.7045f ,-0.0767f }).setSkinCoordIndex(new MFInt32213().getArray()).setSkinCoordWeight(new MFFloat214().getArray())
                                                                    .addChild(new HAnimSegment("Joe_l_carpal_distal_interphalangeal_4").setName(new SFString("l_carpal_distal_phalanx_4")).setDEF(new SFString("Joe_l_carpal_distal_phalanx_4"))
                                                                      ...
                                                                      .addChild(new HAnimSite("Joe_l_carpal_distal_phalanx_4").setName(new SFString("l_carpal_distal_phalanx_4_tip")).setDEF(new SFString("Joe_l_carpal_distal_phalanx_4_tip")).setTranslation(new float[] {0.2035f ,0.675f ,-0.0756f })
                                                                        .addChild(new Shape().setUSE(new SFString("sitebox")))))))))
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName(new SFString("l_carpometacarpal_5")).setDEF(new SFString("Joe_l_carpometacarpal_5")).setCenter(new float[] {0.1925f ,0.8066f ,-0.1036f }).setSkinCoordIndex(new MFInt32217().getArray()).setSkinCoordWeight(new MFFloat218().getArray())
                                                              .addChild(new HAnimSegment("Joe_l_carpometacarpal_5").setName(new SFString("l_metacarpal_5")).setDEF(new SFString("Joe_l_metacarpal_5"))
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                  .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32219().getArray())
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.1925f ,0.8066f ,-0.1036f })
                                                                  .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_5").setName(new SFString("l_metacarpophalangeal_5")).setDEF(new SFString("Joe_l_metacarpophalangeal_5")).setCenter(new float[] {0.1925f ,0.7866f ,-0.1036f }).setSkinCoordIndex(new MFInt32221().getArray()).setSkinCoordWeight(new MFFloat222().getArray())
                                                                .addChild(new HAnimSegment("Joe_l_metacarpophalangeal_5").setName(new SFString("l_carpal_proximal_phalanx_5")).setDEF(new SFString("Joe_l_carpal_proximal_phalanx_5"))
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                    .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32223().getArray())
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.1925f ,0.7866f ,-0.1036f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_5").setName(new SFString("l_carpal_proximal_interphalangeal_5")).setDEF(new SFString("Joe_l_carpal_proximal_interphalangeal_5")).setCenter(new float[] {0.1938f ,0.7452f ,-0.1024f }).setSkinCoordIndex(new MFInt32225().getArray()).setSkinCoordWeight(new MFFloat226().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_5").setName(new SFString("l_carpal_distal_interphalangeal_5")).setDEF(new SFString("Joe_l_carpal_distal_interphalangeal_5")).setCenter(new float[] {0.1948f ,0.7277f ,-0.1017f }).setSkinCoordIndex(new MFInt32229().getArray()).setSkinCoordWeight(new MFFloat230().getArray())
                                                                    .addChild(new HAnimSegment("Joe_l_carpal_distal_interphalangeal_5").setName(new SFString("l_carpal_distal_phalanx_5")).setDEF(new SFString("Joe_l_carpal_distal_phalanx_5"))
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                        .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32231().getArray())
                                                                      ...
                                                                      .addChild(new HAnimSite("Joe_l_carpal_distal_phalanx_5").setName(new SFString("l_carpal_distal_phalanx_5_tip")).setDEF(new SFString("Joe_l_carpal_distal_phalanx_5_tip")).setTranslation(new float[] {0.2014f ,0.7009f ,-0.1012f })
                                                                        .addChild(new Shape().setUSE(new SFString("sitebox"))))))))))))))
                                                  .addChild(new HAnimJoint("Joe_vt1").setName(new SFString("r_sternoclavicular")).setDEF(new SFString("Joe_r_sternoclavicular")).setCenter(new float[] {-0.03f ,1.46f ,0f }).setSkinCoordIndex(new MFInt32233().getArray()).setSkinCoordWeight(new MFFloat234().getArray())
                                                    .addChild(new HAnimSegment("Joe_r_sternoclavicular").setName(new SFString("r_clavicle")).setDEF(new SFString("Joe_r_clavicle"))
                                                      ...
                                                      .addChild(new HAnimSite("Joe_r_clavicle").setName(new SFString("r_clavicle_pt")).setDEF(new SFString("Joe_r_clavicle_pt")).setTranslation(new float[] {-0.03f ,1.46f ,0.035f })
                                                        .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                    .addChild(new HAnimJoint("Joe_r_sternoclavicular").setName(new SFString("r_acromioclavicular")).setDEF(new SFString("Joe_r_acromioclavicular")).setCenter(new float[] {-0.09f ,1.41f ,-0.11f }).setSkinCoordIndex(new MFInt32237().getArray()).setSkinCoordWeight(new MFFloat238().getArray())
                                                      .addChild(new HAnimSegment("Joe_r_acromioclavicular").setName(new SFString("r_scapula")).setDEF(new SFString("Joe_r_scapula"))
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                          .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32239().getArray())
                                                        ...
                                                        .addChild(new HAnimSite("Joe_r_scapula").setName(new SFString("r_axilla_distal_pt")).setDEF(new SFString("Joe_r_axilla_distal_pt")).setTranslation(new float[] {-0.16f ,1.38f ,-0.127f })
                                                          .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                      .addChild(new HAnimJoint("Joe_r_acromioclavicular").setName(new SFString("r_shoulder")).setDEF(new SFString("Joe_r_shoulder")).setCenter(new float[] {-0.2f ,1.44f ,-0.04f }).setSkinCoordIndex(new MFInt32241().getArray()).setSkinCoordWeight(new MFFloat242().getArray())
                                                        .addChild(new HAnimSegment("Joe_r_shoulder").setName(new SFString("r_upperarm")).setDEF(new SFString("Joe_r_upperarm"))
                                                          .addChild(new Transform().setTranslation(new float[] {-0.2f ,1.44f ,-0.04f })
                                                            .addChild(new Shape().setUSE(new SFString("jointbox"))))
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                            .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32243().getArray())
                                                          ...
                                                          .addChild(new HAnimSite("Joe_r_upperarm").setName(new SFString("r_humeral_lateral_epicondyle_pt")).setDEF(new SFString("Joe_r_humeral_lateral_epicondyle_pt")).setTranslation(new float[] {-0.244f ,1.1388f ,-0.04f })
                                                            .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                        .addChild(new HAnimJoint("Joe_r_shoulder").setName(new SFString("r_elbow")).setDEF(new SFString("Joe_r_elbow")).setCenter(new float[] {-0.2f ,1.1388f ,-0.04f }).setSkinCoordIndex(new MFInt32245().getArray()).setSkinCoordWeight(new MFFloat246().getArray())
                                                          .addChild(new HAnimSegment("Joe_r_elbow").setName(new SFString("r_forearm")).setDEF(new SFString("Joe_r_forearm"))
                                                            ...
                                                            .addChild(new HAnimSite("Joe_r_forearm").setName(new SFString("r_olecranon_pt")).setDEF(new SFString("Joe_r_olecranon_pt")).setTranslation(new float[] {-0.2f ,1.1388f ,-0.08f })
                                                              .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                          .addChild(new HAnimJoint("Joe_r_elbow").setName(new SFString("r_radiocarpal")).setDEF(new SFString("Joe_r_radiocarpal")).setCenter(new float[] {-0.2f ,0.89f ,-0.04f }).setSkinCoordIndex(new MFInt32249().getArray()).setSkinCoordWeight(new MFFloat250().getArray())
                                                            .addChild(new HAnimSegment("Joe_r_radiocarpal").setName(new SFString("r_carpal")).setDEF(new SFString("Joe_r_carpal"))
                                                              ...
                                                              .addChild(new HAnimSite("Joe_r_carpal").setName(new SFString("r_ulnar_styloid_pt")).setDEF(new SFString("Joe_r_ulnar_styloid_pt")).setTranslation(new float[] {-0.2f ,0.9f ,-0.085f })
                                                                .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                            .addChild(new HAnimJoint("Joe_r_radiocarpal").setName(new SFString("r_carpometacarpal_1")).setDEF(new SFString("Joe_r_carpometacarpal_1")).setCenter(new float[] {-0.2f ,0.85f ,0f }).setSkinCoordIndex(new MFInt32253().getArray()).setSkinCoordWeight(new MFFloat254().getArray())
                                                              .addChild(new HAnimSegment("Joe_r_carpometacarpal_1").setName(new SFString("r_metacarpal_1")).setDEF(new SFString("Joe_r_metacarpal_1"))
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                  .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32255().getArray())
                                                                    .setCoord(new Coordinate().setPoint(new MFVec3f256().getArray()))))
                                                                .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.85f ,0f })
                                                                  .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                              .addChild(new HAnimJoint("Joe_r_carpometacarpal_1").setName(new SFString("r_metacarpophalangeal_1")).setDEF(new SFString("Joe_r_metacarpophalangeal_1")).setCenter(new float[] {-0.2f ,0.82f ,0.03f }).setSkinCoordIndex(new MFInt32257().getArray()).setSkinCoordWeight(new MFFloat258().getArray())
                                                                .addChild(new HAnimSegment("Joe_r_metacarpophalangeal_1").setName(new SFString("r_carpal_proximal_phalanx_1")).setDEF(new SFString("Joe_r_carpal_proximal_phalanx_1"))
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.82f ,0.03f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_1").setName(new SFString("r_carpal_interphalangeal_1")).setDEF(new SFString("Joe_r_carpal_interphalangeal_1")).setCenter(new float[] {-0.2f ,0.8f ,0.05f }).setSkinCoordIndex(new MFInt32261().getArray()).setSkinCoordWeight(new MFFloat262().getArray())
                                                                  .addChild(new HAnimSegment("Joe_r_carpal_interphalangeal_1").setName(new SFString("r_carpal_distal_phalanx_1")).setDEF(new SFString("Joe_r_carpal_distal_phalanx_1"))
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                      .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32263().getArray())
                                                                    ...
                                                                    .addChild(new HAnimSite("Joe_r_carpal_distal_phalanx_1").setName(new SFString("r_carpal_distal_phalanx_1_tip")).setDEF(new SFString("Joe_r_carpal_distal_phalanx_1_tip")).setTranslation(new float[] {-0.2f ,0.78f ,0.07f })
                                                                      .addChild(new Shape().setUSE(new SFString("sitebox"))))))))
                                                            .addChild(new HAnimJoint("Joe_r_radiocarpal").setName(new SFString("r_carpometacarpal_2")).setDEF(new SFString("Joe_r_carpometacarpal_2")).setCenter(new float[] {-0.2f ,0.84f ,-0.015f }).setSkinCoordIndex(new MFInt32265().getArray()).setSkinCoordWeight(new MFFloat266().getArray())
                                                              .addChild(new HAnimSegment("Joe_r_carpometacarpal_2").setName(new SFString("r_metacarpal_2")).setDEF(new SFString("Joe_r_metacarpal_2"))
                                                                ...
                                                                .addChild(new HAnimSite("Joe_r_metacarpal_2").setName(new SFString("r_metacarpal_phalanx_2_pt")).setDEF(new SFString("Joe_r_metacarpal_phalanx_2_pt")).setTranslation(new float[] {-0.2f ,0.793f ,-0.005f })
                                                                  .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                              .addChild(new HAnimJoint("Joe_r_carpometacarpal_2").setName(new SFString("r_metacarpophalangeal_2")).setDEF(new SFString("Joe_r_metacarpophalangeal_2")).setCenter(new float[] {-0.2f ,0.793f ,-0.015f }).setSkinCoordIndex(new MFInt32269().getArray()).setSkinCoordWeight(new MFFloat270().getArray())
                                                                .addChild(new HAnimSegment("Joe_r_metacarpophalangeal_2").setName(new SFString("r_carpal_proximal_phalanx_2")).setDEF(new SFString("Joe_r_carpal_proximal_phalanx_2"))
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.793f ,-0.015f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_2").setName(new SFString("r_carpal_proximal_interphalangeal_2")).setDEF(new SFString("Joe_r_carpal_proximal_interphalangeal_2")).setCenter(new float[] {-0.2f ,0.745f ,-0.015f }).setSkinCoordIndex(new MFInt32273().getArray()).setSkinCoordWeight(new MFFloat274().getArray())
                                                                  .addChild(new HAnimSegment("Joe_r_carpal_proximal_interphalangeal_2").setName(new SFString("r_carpal_middle_phalanx_2")).setDEF(new SFString("Joe_r_carpal_middle_phalanx_2"))
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.745f ,-0.015f })
                                                                      .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                  .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_2").setName(new SFString("r_carpal_distal_interphalangeal_2")).setDEF(new SFString("Joe_r_carpal_distal_interphalangeal_2")).setCenter(new float[] {-0.2f ,0.72f ,-0.015f }).setSkinCoordIndex(new MFInt32277().getArray()).setSkinCoordWeight(new MFFloat278().getArray())
                                                                    .addChild(new HAnimSegment("Joe_r_carpal_distal_interphalangeal_2").setName(new SFString("r_carpal_distal_phalanx_2")).setDEF(new SFString("Joe_r_carpal_distal_phalanx_2"))
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                        .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32279().getArray())
                                                                      ...
                                                                      .addChild(new HAnimSite("Joe_r_carpal_distal_phalanx_2").setName(new SFString("r_carpal_distal_phalanx_2_tip")).setDEF(new SFString("Joe_r_carpal_distal_phalanx_2_tip")).setTranslation(new float[] {-0.2f ,0.695f ,-0.015f })
                                                                        .addChild(new Shape().setUSE(new SFString("sitebox")))))))))
                                                            .addChild(new HAnimJoint("Joe_r_radiocarpal").setName(new SFString("r_carpometacarpal_3")).setDEF(new SFString("Joe_r_carpometacarpal_3")).setCenter(new float[] {-0.2f ,0.835f ,-0.04f }).setSkinCoordIndex(new MFInt32281().getArray()).setSkinCoordWeight(new MFFloat282().getArray())
                                                              .addChild(new HAnimSegment("Joe_r_carpometacarpal_3").setName(new SFString("r_metacarpal_3")).setDEF(new SFString("Joe_r_metacarpal_3"))
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.835f ,-0.04f })
                                                                  .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                              .addChild(new HAnimJoint("Joe_r_carpometacarpal_3").setName(new SFString("r_metacarpophalangeal_3")).setDEF(new SFString("Joe_r_metacarpophalangeal_3")).setCenter(new float[] {-0.2f ,0.788f ,-0.04f }).setSkinCoordIndex(new MFInt32285().getArray()).setSkinCoordWeight(new MFFloat286().getArray())
                                                                .addChild(new HAnimSegment("Joe_r_metacarpophalangeal_3").setName(new SFString("r_carpal_proximal_phalanx_3")).setDEF(new SFString("Joe_r_carpal_proximal_phalanx_3"))
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                    .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32287().getArray())
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.788f ,-0.04f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_3").setName(new SFString("r_carpal_proximal_interphalangeal_3")).setDEF(new SFString("Joe_r_carpal_proximal_interphalangeal_3")).setCenter(new float[] {-0.2f ,0.74f ,-0.04f }).setSkinCoordIndex(new MFInt32289().getArray()).setSkinCoordWeight(new MFFloat290().getArray())
                                                                  .addChild(new HAnimSegment("Joe_r_carpal_proximal_interphalangeal_3").setName(new SFString("r_carpal_middle_phalanx_3")).setDEF(new SFString("Joe_r_carpal_middle_phalanx_3"))
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                      .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32291().getArray())
                                                                        .setCoord(new Coordinate().setPoint(new MFVec3f292().getArray()))))
                                                                    .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.74f ,-0.04f })
                                                                      .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                  .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_3").setName(new SFString("r_carpal_distal_interphalangeal_3")).setDEF(new SFString("Joe_r_carpal_distal_interphalangeal_3")).setCenter(new float[] {-0.2f ,0.7142f ,-0.04f }).setSkinCoordIndex(new MFInt32293().getArray()).setSkinCoordWeight(new MFFloat294().getArray())
                                                                    .addChild(new HAnimSegment("Joe_r_carpal_distal_interphalangeal_3").setName(new SFString("r_carpal_distal_phalanx_3")).setDEF(new SFString("Joe_r_carpal_distal_phalanx_3"))
                                                                      ...
                                                                      .addChild(new HAnimSite("Joe_r_carpal_distal_phalanx_3").setName(new SFString("r_carpal_distal_phalanx_3_tip")).setDEF(new SFString("Joe_r_carpal_distal_phalanx_3_tip")).setTranslation(new float[] {-0.2f ,0.68f ,-0.04f })
                                                                        .addChild(new Shape().setUSE(new SFString("sitebox")))))))))
                                                            .addChild(new HAnimJoint("Joe_r_radiocarpal").setName(new SFString("r_carpometacarpal_4")).setDEF(new SFString("Joe_r_carpometacarpal_4")).setCenter(new float[] {-0.2f ,0.835f ,-0.065f }).setSkinCoordIndex(new MFInt32297().getArray()).setSkinCoordWeight(new MFFloat298().getArray())
                                                              .addChild(new HAnimSegment("Joe_r_carpometacarpal_4").setName(new SFString("r_metacarpal_4")).setDEF(new SFString("Joe_r_metacarpal_4"))
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                  .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32299().getArray())
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.835f ,-0.065f })
                                                                  .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                              .addChild(new HAnimJoint("Joe_r_carpometacarpal_4").setName(new SFString("r_metacarpophalangeal_4")).setDEF(new SFString("Joe_r_metacarpophalangeal_4")).setCenter(new float[] {-0.2f ,0.793f ,-0.065f }).setSkinCoordIndex(new MFInt32301().getArray()).setSkinCoordWeight(new MFFloat302().getArray())
                                                                .addChild(new HAnimSegment("Joe_r_metacarpophalangeal_4").setName(new SFString("r_carpal_proximal_phalanx_4")).setDEF(new SFString("Joe_r_carpal_proximal_phalanx_4"))
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.793f ,-0.065f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_4").setName(new SFString("r_carpal_proximal_interphalangeal_4")).setDEF(new SFString("Joe_r_carpal_proximal_interphalangeal_4")).setCenter(new float[] {-0.2f ,0.74f ,-0.065f }).setSkinCoordIndex(new MFInt32305().getArray()).setSkinCoordWeight(new MFFloat306().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_4").setName(new SFString("r_carpal_distal_interphalangeal_4")).setDEF(new SFString("Joe_r_carpal_distal_interphalangeal_4")).setCenter(new float[] {-0.2f ,0.7177f ,-0.065f }).setSkinCoordIndex(new MFInt32309().getArray()).setSkinCoordWeight(new MFFloat310().getArray())
                                                                    .addChild(new HAnimSegment("Joe_r_carpal_distal_interphalangeal_4").setName(new SFString("r_carpal_distal_phalanx_4")).setDEF(new SFString("Joe_r_carpal_distal_phalanx_4"))
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                        .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32311().getArray())
                                                                      ...
                                                                      .addChild(new HAnimSite("Joe_r_carpal_distal_phalanx_4").setName(new SFString("r_carpal_distal_phalanx_4_tip")).setDEF(new SFString("Joe_r_carpal_distal_phalanx_4_tip")).setTranslation(new float[] {-0.2f ,0.695f ,-0.065f })
                                                                        .addChild(new Shape().setUSE(new SFString("sitebox")))))))))
                                                            .addChild(new HAnimJoint("Joe_r_radiocarpal").setName(new SFString("r_carpometacarpal_5")).setDEF(new SFString("Joe_r_carpometacarpal_5")).setCenter(new float[] {-0.2f ,0.84f ,-0.085f }).setSkinCoordIndex(new MFInt32313().getArray()).setSkinCoordWeight(new MFFloat314().getArray())
                                                              .addChild(new HAnimSegment("Joe_r_carpometacarpal_5").setName(new SFString("r_metacarpal_5")).setDEF(new SFString("Joe_r_metacarpal_5"))
                                                                ...
                                                                .addChild(new HAnimSite("Joe_r_metacarpal_5").setName(new SFString("r_metacarpal_phalanx_5_pt")).setDEF(new SFString("Joe_r_metacarpal_phalanx_5_pt")).setTranslation(new float[] {-0.2f ,0.79f ,-0.095f })
                                                                  .addChild(new Shape().setUSE(new SFString("sitebox")))))
                                                              .addChild(new HAnimJoint("Joe_r_carpometacarpal_5").setName(new SFString("r_metacarpophalangeal_5")).setDEF(new SFString("Joe_r_metacarpophalangeal_5")).setCenter(new float[] {-0.2f ,0.79f ,-0.085f }).setSkinCoordIndex(new MFInt32317().getArray()).setSkinCoordWeight(new MFFloat318().getArray())
                                                                .addChild(new HAnimSegment("Joe_r_metacarpophalangeal_5").setName(new SFString("r_carpal_proximal_phalanx_5")).setDEF(new SFString("Joe_r_carpal_proximal_phalanx_5"))
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.79f ,-0.085f })
                                                                    .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                .addChild(new HAnimJoint("Joe_r_metacarpophalangeal_5").setName(new SFString("r_carpal_proximal_interphalangeal_5")).setDEF(new SFString("Joe_r_carpal_proximal_interphalangeal_5")).setCenter(new float[] {-0.2f ,0.755f ,-0.085f }).setSkinCoordIndex(new MFInt32321().getArray()).setSkinCoordWeight(new MFFloat322().getArray())
                                                                  .addChild(new HAnimSegment("Joe_r_carpal_proximal_interphalangeal_5").setName(new SFString("r_carpal_middle_phalanx_5")).setDEF(new SFString("Joe_r_carpal_middle_phalanx_5"))
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance().setUSE(new SFString("SegmentLine")))
                                                                      .setGeometry(new IndexedLineSet().setCoordIndex(new MFInt32323().getArray())
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new float[] {-0.2f ,0.755f ,-0.085f })
                                                                      .addChild(new Shape().setUSE(new SFString("jointbox")))))
                                                                  .addChild(new HAnimJoint("Joe_r_carpal_proximal_interphalangeal_5").setName(new SFString("r_carpal_distal_interphalangeal_5")).setDEF(new SFString("Joe_r_carpal_distal_interphalangeal_5")).setCenter(new float[] {-0.2f ,0.735f ,-0.09f }).setSkinCoordIndex(new MFInt32325().getArray()).setSkinCoordWeight(new MFFloat326().getArray())
              ...
              .addSkin(new Shape().setDEF(new SFString("SkinShape"))
                .setAppearance(new Appearance().setDEF(new SFString("SkinAppearance"))
                  ...
                  .setTexture(new ImageTexture().setDEF(new SFString("zBlueSpiralBkg2")).setDescription(new SFString("Blue Spiral Pattern")).setUrl(new MFString329().getArray())))
                .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32330().getArray().append(new MFInt32331().getArray()).append(new MFInt32332().getArray()).append(new MFInt32333().getArray())).setCreaseAngle(3.1f )
                  .setColor(new Color().setColor(new MFColor334().getArray().append(new MFColor335().getArray()).append(new MFColor336().getArray())))
                  .setCoord(new Coordinate().setDEF(new SFString("TheSkinCoord")).setPoint(new MFVec3f337().getArray().append(new MFVec3f338().getArray())))))
        ...
        .addComments(new CommentsBlock("expected best practice: EXPORT AS='fileName' for clarity"))
        .addChild(new EXPORT().setAS(new SFString("JoeSkeletonSkinSite")).setLocalDEF(new SFString("Joe_Human"))));
    return X3D0;
    }

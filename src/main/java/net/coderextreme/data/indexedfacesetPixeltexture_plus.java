...
public class indexedfacesetPixeltexture_plus implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new indexedfacesetPixeltexture_plus().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/indexedfacesetPixeltexture_plus.new.java.x3d");
    model.toFileJSON("../data/indexedfacesetPixeltexture_plus.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("indexedfaceset_pixeltexture_plus.x3d")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_plus-front.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_plus-rear.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_plus-top.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_plus-bottom.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_plus-left.jpg")))
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("indexedfaceset_pixeltexture_plus-right.jpg")))
        ...
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("Test of browser ability to map a 3 times multiple of an PixelTexture onto an IndexedFaceSet geometry. A 3 by 3 matrix of four equal sized red, green, white and yellow squares in the pixel texture map all the faces of the cube.")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plus.x3d")))
...
private class MFVec2f4 {
  private org.web3d.x3d.jsail.fields.MFVec2f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec2f(new float[] {-1f ,2f ,-1f ,-1f ,2f ,2f ,2f ,-1f });
  }
}
}

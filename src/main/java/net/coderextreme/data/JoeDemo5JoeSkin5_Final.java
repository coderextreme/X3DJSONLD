  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("description").setContent("joe kick into std anims")))
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle("JoeDemo5JoeSkin.x3d, Only Skin"))
        .addChild(new NavigationInfo().setHeadlight(false))
        .addChild(new Background().setDEF("Background1").setSkyColor(new MFColor0().getArray()).setGroundColor(new MFColor1().getArray()))
        ...
        .addChild(new Group().setDEF("SceneViewpoints")
          ...
          .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,0.9f ,0.0016f }).setDescription("JinLOA4 Front").setPosition(new float[] {0f ,0.4f ,4f }))
          .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,0.9f ,0.0016f }).setDescription("JinLOA4 Front Close").setPosition(new float[] {0f ,0.8f ,2f }))
          .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,0.9f ,0.0016f }).setDescription("JinLOA4 Front Closer").setPosition(new float[] {0f ,1.2f ,1f }))
          .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,1.5f ,0.0016f }).setDescription("JinLOA4 Front Face").setPosition(new float[] {0f ,1.63f ,1f }))
          .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,0.9f ,0.0016f }).setDescription("JinLOA4 Right Side").setOrientation(new float[] {0f ,1f ,0f ,1.57f }).setPosition(new float[] {2.6f ,0.8f ,0f }))
          .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,0.9f ,0.0016f }).setDescription("JinLOA4 Right Side Close").setOrientation(new float[] {0f ,1f ,0f ,1.2f }).setPosition(new float[] {1f ,0.8f ,0.5f }))
          .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,0.9f ,0.0016f }).setDescription("JinLOA4 Left Side Close").setOrientation(new float[] {0f ,1f ,0f ,-1.2f }).setPosition(new float[] {-1f ,0.8f ,0.5f }))
          .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,0.9f ,0.0016f }).setDescription("JinLOA4 Left Side").setOrientation(new float[] {0f ,1f ,0f ,-1.57f }).setPosition(new float[] {-2.6f ,0.8f ,0f }))
          .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,0.9f ,0.0016f }).setDescription("JinLOA4 Top").setOrientation(new float[] {1f ,0f ,0f ,-1.5708f }).setPosition(new float[] {0f ,3.5f ,0f })))
        .addChild(new Transform().setDEF("HostCoordSys").setScale(new float[] {0.17f ,0.17f ,0.17f })
          .addChild(new Inline().setUrl(new MFString2().getArray()))
          .addChild(new Viewpoint().setDEF("HostCoordSysView").setDescription("Host 0 0 0 View")))
        .addChild(new Group().setDEF("Joe_Humanoid")
          .addChild(new HAnimHumanoid("Joe_Humanoid").setDEF("JoeHuman").setVersion("2.0")
            .addJoints(new HAnimJoint("JoeHuman").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f ,0.875f ,0f }).setUlimit(new MFFloat3().getArray()).setLlimit(new MFFloat4().getArray())
              .addChild(new HAnimSite("hanim_humanoid_root").setName("RootFront").setDEF("Joe_RootView1")
                .addChild(new Transform().setDEF("HAnimCoordSys").setScale(new float[] {0.17f ,0.17f ,0.17f })
                  .addChild(new Inline().setUrl(new MFString5().getArray()))
                  .addChild(new Viewpoint().setDEF("HAnimCoordSysView").setDescription("HAnim 0 0 0 View"))))
              .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("Joe_sacroiliac").setCenter(new float[] {0f ,0.920000016689301f ,0f }).setSkinCoordIndex(new MFInt326().getArray()).setSkinCoordWeight(new MFFloat7().getArray()).setUlimit(new MFFloat8().getArray()).setLlimit(new MFFloat9().getArray())
                .addChild(new HAnimJoint("Joe_sacroiliac").setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {0.100000001490116f ,0.920000016689301f ,0f }).setSkinCoordIndex(new MFInt3210().getArray()).setSkinCoordWeight(new MFFloat11().getArray()).setUlimit(new MFFloat12().getArray()).setLlimit(new MFFloat13().getArray())
                  .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {0.115000002086163f ,0.465999990701675f ,0f }).setSkinCoordIndex(new MFInt3214().getArray()).setSkinCoordWeight(new MFFloat15().getArray()).setUlimit(new MFFloat16().getArray()).setLlimit(new MFFloat17().getArray())
                    .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new float[] {0.115000002086163f ,0.0689999982714653f ,0f }).setSkinCoordIndex(new MFInt3218().getArray()).setSkinCoordWeight(new MFFloat19().getArray()).setUlimit(new MFFloat20().getArray()).setLlimit(new MFFloat21().getArray())
                      .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_tarsometatarsal_2").setDEF("Joe_l_tarsometatarsal_2").setCenter(new float[] {0.115000002086163f ,0.0309999994933605f ,0.0299999993294477f }).setSkinCoordIndex(new MFInt3222().getArray()).setSkinCoordWeight(new MFFloat23().getArray()).setUlimit(new MFFloat24().getArray()).setLlimit(new MFFloat25().getArray())
                        .addChild(new HAnimJoint("Joe_l_tarsometatarsal_2").setName("l_metatarsophalangeal_2").setDEF("Joe_l_metatarsophalangeal_2").setCenter(new float[] {0.115000002086163f ,0.0370000004768372f ,0.0900000035762787f }).setSkinCoordIndex(new MFInt3226().getArray()).setSkinCoordWeight(new MFFloat27().getArray()).setUlimit(new MFFloat28().getArray()).setLlimit(new MFFloat29().getArray())
                          .addChild(new HAnimJoint("Joe_l_metatarsophalangeal_2").setName("l_metatarsal_2").setDEF("Joe_l_metatarsal_2").setCenter(new float[] {0.115000002086163f ,0.0199999995529652f ,0.122000001370907f }).setSkinCoordIndex(new MFInt3230().getArray()).setSkinCoordWeight(new MFFloat31().getArray()).setUlimit(new MFFloat32().getArray()).setLlimit(new MFFloat33().getArray())))))))
                .addChild(new HAnimJoint("Joe_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-0.100000001490116f ,0.920000016689301f ,0f }).setSkinCoordIndex(new MFInt3234().getArray()).setSkinCoordWeight(new MFFloat35().getArray()).setUlimit(new MFFloat36().getArray()).setLlimit(new MFFloat37().getArray())
                  .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-0.0500000007450581f ,0.465999990701675f ,0f }).setSkinCoordIndex(new MFInt3238().getArray()).setSkinCoordWeight(new MFFloat39().getArray()).setUlimit(new MFFloat40().getArray()).setLlimit(new MFFloat41().getArray())
                    .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-0.115000002086163f ,0.0689999982714653f ,0f }).setSkinCoordIndex(new MFInt3242().getArray()).setSkinCoordWeight(new MFFloat43().getArray()).setUlimit(new MFFloat44().getArray()).setLlimit(new MFFloat45().getArray())
                      .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_tarsometatarsal_2").setDEF("Joe_r_tarsometatarsal_2").setCenter(new float[] {-0.100000001490116f ,0.0149999996647239f ,-0.00999999977648258f }).setSkinCoordIndex(new MFInt3246().getArray()).setSkinCoordWeight(new MFFloat47().getArray()).setUlimit(new MFFloat48().getArray()).setLlimit(new MFFloat49().getArray())
                        .addChild(new HAnimJoint("Joe_r_tarsometatarsal_2").setName("r_metatarsophalangeal_2").setDEF("Joe_r_metatarsophalangeal_2").setCenter(new float[] {-0.115000002086163f ,0.0370000004768372f ,0.0900000035762787f }).setSkinCoordIndex(new MFInt3250().getArray()).setSkinCoordWeight(new MFFloat51().getArray()).setUlimit(new MFFloat52().getArray()).setLlimit(new MFFloat53().getArray())
              ...
              .addChild(new HAnimJoint("hanim_humanoid_root").setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f ,1.04499995708466f ,-0.0949999988079071f }).setSkinCoordIndex(new MFInt3258().getArray()).setSkinCoordWeight(new MFFloat59().getArray()).setUlimit(new MFFloat60().getArray()).setLlimit(new MFFloat61().getArray())
                .addChild(new HAnimJoint("hanim_vl5").setName("vl4").setDEF("hanim_vl4").setCenter(new float[] {0f ,1.067999958992f ,-0.0850000008940697f }).setUlimit(new MFFloat62().getArray()).setLlimit(new MFFloat63().getArray())
                  .addChild(new HAnimJoint("hanim_vl4").setName("vl3").setDEF("hanim_vl3").setCenter(new float[] {0f ,1.09200000762939f ,-0.0724999979138374f }).setUlimit(new MFFloat64().getArray()).setLlimit(new MFFloat65().getArray())
                    .addChild(new HAnimJoint("hanim_vl3").setName("vl2").setDEF("hanim_vl2").setCenter(new float[] {0f ,1.12000000476837f ,-0.0649999976158142f }).setSkinCoordIndex(new MFInt3266().getArray()).setSkinCoordWeight(new MFFloat67().getArray()).setUlimit(new MFFloat68().getArray()).setLlimit(new MFFloat69().getArray())
                      .addChild(new HAnimJoint("hanim_vl2").setName("vl1").setDEF("hanim_vl1").setCenter(new float[] {0f ,1.14590001106262f ,-0.0625f }).setUlimit(new MFFloat70().getArray()).setLlimit(new MFFloat71().getArray())
                        .addChild(new HAnimJoint("hanim_vl1").setName("vt12").setDEF("hanim_vt12").setCenter(new float[] {0f ,1.17900002002716f ,-0.068000003695488f }).setUlimit(new MFFloat72().getArray()).setLlimit(new MFFloat73().getArray())
                          .addChild(new HAnimJoint("hanim_vt12").setName("vt11").setDEF("hanim_vt11").setCenter(new float[] {0f ,1.26789999008179f ,-0.0810000002384186f }).setUlimit(new MFFloat74().getArray()).setLlimit(new MFFloat75().getArray())
                            .addChild(new HAnimJoint("hanim_vt11").setName("vt10").setDEF("hanim_vt10").setCenter(new float[] {0f ,1.24199998378754f ,-0.0900000035762787f }).setSkinCoordIndex(new MFInt3276().getArray()).setSkinCoordWeight(new MFFloat77().getArray()).setUlimit(new MFFloat78().getArray()).setLlimit(new MFFloat79().getArray())
                              .addChild(new HAnimJoint("hanim_vt10").setName("vt9").setDEF("hanim_vt9").setCenter(new float[] {0f ,1.26800000667572f ,-0.100000001490116f }).setSkinCoordIndex(new MFInt3280().getArray()).setSkinCoordWeight(new MFFloat81().getArray()).setUlimit(new MFFloat82().getArray()).setLlimit(new MFFloat83().getArray())
                                .addChild(new HAnimJoint("hanim_vt9").setName("vt8").setDEF("hanim_vt8").setCenter(new float[] {0f ,1.2940000295639f ,-0.109999999403954f }).setUlimit(new MFFloat84().getArray()).setLlimit(new MFFloat85().getArray())
                                  .addChild(new HAnimJoint("hanim_vt8").setName("vt7").setDEF("hanim_vt7").setCenter(new float[] {0f ,1.32299995422363f ,-0.115500003099442f }).setUlimit(new MFFloat86().getArray()).setLlimit(new MFFloat87().getArray())
                                    .addChild(new HAnimJoint("hanim_vt7").setName("vt6").setDEF("hanim_vt6").setCenter(new float[] {0f ,1.35199999809265f ,-0.119999997317791f }).setUlimit(new MFFloat88().getArray()).setLlimit(new MFFloat89().getArray())
                                      .addChild(new HAnimJoint("hanim_vt6").setName("vt5").setDEF("hanim_vt5").setCenter(new float[] {0f ,1.38100004196167f ,-0.123499996960163f }).setUlimit(new MFFloat90().getArray()).setLlimit(new MFFloat91().getArray())
                                        .addChild(new HAnimJoint("hanim_vt5").setName("vt4").setDEF("hanim_vt4").setCenter(new float[] {0f ,1.4099999666214f ,-0.123499996960163f }).setSkinCoordIndex(new MFInt3292().getArray()).setSkinCoordWeight(new MFFloat93().getArray()).setUlimit(new MFFloat94().getArray()).setLlimit(new MFFloat95().getArray())
                                          .addChild(new HAnimJoint("hanim_vt4").setName("vt3").setDEF("hanim_vt3").setCenter(new float[] {0f ,1.43799996376038f ,-0.119999997317791f }).setUlimit(new MFFloat96().getArray()).setLlimit(new MFFloat97().getArray())
                                            .addChild(new HAnimJoint("hanim_vt3").setName("vt2").setDEF("hanim_vt2").setCenter(new float[] {0f ,1.46800005435944f ,-0.104999996721745f }).setUlimit(new MFFloat98().getArray()).setLlimit(new MFFloat99().getArray())
                                              .addChild(new HAnimJoint("hanim_vt2").setName("vt1").setDEF("hanim_vt1").setCenter(new float[] {0f ,1.49699997901917f ,-0.0900000035762787f }).setSkinCoordIndex(new MFInt32100().getArray()).setSkinCoordWeight(new MFFloat101().getArray()).setUlimit(new MFFloat102().getArray()).setLlimit(new MFFloat103().getArray())
                                                .addChild(new HAnimJoint("hanim_vt1").setName("vc7").setDEF("hanim_vc7").setCenter(new float[] {0f ,1.52499997615814f ,-0.0719999969005585f }).setSkinCoordIndex(new MFInt32104().getArray()).setSkinCoordWeight(new MFFloat105().getArray()).setUlimit(new MFFloat106().getArray()).setLlimit(new MFFloat107().getArray())
                                                  .addChild(new HAnimJoint("hanim_vc7").setName("vc6").setDEF("hanim_vc6").setCenter(new float[] {0f ,1.53999996185303f ,-0.0500000007450581f }).setUlimit(new MFFloat108().getArray()).setLlimit(new MFFloat109().getArray())
                                                    .addChild(new HAnimJoint("hanim_vc6").setName("vc5").setDEF("hanim_vc5").setCenter(new float[] {0f ,1.55200004577637f ,-0.0350000001490116f }).setUlimit(new MFFloat110().getArray()).setLlimit(new MFFloat111().getArray())
                                                      .addChild(new HAnimJoint("hanim_vc5").setName("vc4").setDEF("hanim_vc4").setCenter(new float[] {0f ,1.56749999523163f ,-0.0255999993532896f }).setUlimit(new MFFloat112().getArray()).setLlimit(new MFFloat113().getArray())
                                                        .addChild(new HAnimJoint("hanim_vc4").setName("vc3").setDEF("hanim_vc3").setCenter(new float[] {0f ,1.58224999904633f ,-0.0185000002384186f }).setUlimit(new MFFloat114().getArray()).setLlimit(new MFFloat115().getArray())
                                                          .addChild(new HAnimJoint("hanim_vc3").setName("vc2").setDEF("hanim_vc2").setCenter(new float[] {0f ,1.59500002861023f ,-0.0175000000745058f }).setUlimit(new MFFloat116().getArray()).setLlimit(new MFFloat117().getArray())
                                                            .addChild(new HAnimJoint("hanim_vc2").setName("vc1").setDEF("hanim_vc1").setCenter(new float[] {0f ,1.61000001430511f ,-0.0149999996647239f }).setUlimit(new MFFloat118().getArray()).setLlimit(new MFFloat119().getArray())
                                                              .addChild(new HAnimJoint("hanim_vc1").setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f ,1.62999999523163f ,-0.00999999977648258f }).setSkinCoordIndex(new MFInt32120().getArray()).setSkinCoordWeight(new MFFloat121().getArray()).setUlimit(new MFFloat122().getArray()).setLlimit(new MFFloat123().getArray())
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyeball_joint").setDEF("hanim_l_eyeball_joint").setCenter(new float[] {0.034000001847744f ,1.65900003910065f ,0.0599999986588955f }).setUlimit(new MFFloat124().getArray()).setLlimit(new MFFloat125().getArray()))
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyeball_joint").setDEF("hanim_r_eyeball_joint").setCenter(new float[] {-0.034000001847744f ,1.65900003910065f ,0.0599999986588955f }).setUlimit(new MFFloat126().getArray()).setLlimit(new MFFloat127().getArray())))))))))
                                                  .addChild(new HAnimJoint("hanim_vc7").setName("l_sternoclavicular").setDEF("hanim_l_sternoclavicular").setCenter(new float[] {0.0820000022649765f ,1.44879996776581f ,-0.035300001502037f }).setSkinCoordIndex(new MFInt32128().getArray()).setSkinCoordWeight(new MFFloat129().getArray()).setUlimit(new MFFloat130().getArray()).setLlimit(new MFFloat131().getArray())
                                                    .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName("l_acromioclavicular").setDEF("hanim_l_acromioclavicular").setCenter(new float[] {0.0961999967694283f ,1.42690002918243f ,-0.0423999987542629f }).setSkinCoordIndex(new MFInt32132().getArray()).setSkinCoordWeight(new MFFloat133().getArray()).setUlimit(new MFFloat134().getArray()).setLlimit(new MFFloat135().getArray())
                                                      .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {0.200000002980232f ,1.44000005722046f ,-0.0399999991059303f }).setSkinCoordIndex(new MFInt32136().getArray()).setSkinCoordWeight(new MFFloat137().getArray()).setUlimit(new MFFloat138().getArray()).setLlimit(new MFFloat139().getArray())
                                                        .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {0.200000002980232f ,1.13880002498627f ,-0.0399999991059303f }).setSkinCoordIndex(new MFInt32140().getArray()).setSkinCoordWeight(new MFFloat141().getArray()).setUlimit(new MFFloat142().getArray()).setLlimit(new MFFloat143().getArray())
                                                          .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("Joe_l_radiocarpal").setCenter(new float[] {0.200000002980232f ,0.870000004768372f ,-0.0399999991059303f }).setSkinCoordIndex(new MFInt32144().getArray()).setSkinCoordWeight(new MFFloat145().getArray()).setUlimit(new MFFloat146().getArray()).setLlimit(new MFFloat147().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_1").setDEF("Joe_l_carpometacarpal_1").setCenter(new float[] {0.192399993538857f ,0.847199976444244f ,-0.0533999986946583f }).setSkinCoordIndex(new MFInt32148().getArray()).setSkinCoordWeight(new MFFloat149().getArray()).setUlimit(new MFFloat150().getArray()).setLlimit(new MFFloat151().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_1").setName("l_metacarpophalangeal_1").setDEF("Joe_l_metacarpophalangeal_1").setCenter(new float[] {0.195099994540215f ,0.82260000705719f ,0.0245999991893768f }).setSkinCoordIndex(new MFInt32152().getArray()).setSkinCoordWeight(new MFFloat153().getArray()).setUlimit(new MFFloat154().getArray()).setLlimit(new MFFloat155().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_1").setName("l_carpal_interphalangeal_1").setDEF("Joe_l_carpal_interphalangeal_1").setCenter(new float[] {0.195500001311302f ,0.815900027751923f ,0.046399999409914f }).setSkinCoordIndex(new MFInt32156().getArray()).setSkinCoordWeight(new MFFloat157().getArray()).setUlimit(new MFFloat158().getArray()).setLlimit(new MFFloat159().getArray()))))
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_2").setDEF("Joe_l_carpometacarpal_2").setCenter(new float[] {0.198300004005432f ,0.80239999294281f ,-0.0280000008642673f }).setSkinCoordIndex(new MFInt32160().getArray()).setSkinCoordWeight(new MFFloat161().getArray()).setUlimit(new MFFloat162().getArray()).setLlimit(new MFFloat163().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_2").setName("l_metacarpophalangeal_2").setDEF("Joe_l_metacarpophalangeal_2").setCenter(new float[] {0.198300004005432f ,0.781499981880188f ,-0.0280000008642673f }).setSkinCoordIndex(new MFInt32164().getArray()).setSkinCoordWeight(new MFFloat165().getArray()).setUlimit(new MFFloat166().getArray()).setLlimit(new MFFloat167().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_2").setName("l_carpal_proximal_interphalangeal_2").setDEF("Joe_l_carpal_proximal_interphalangeal_2").setCenter(new float[] {0.201700001955032f ,0.736299991607666f ,-0.0248000007122755f }).setSkinCoordIndex(new MFInt32168().getArray()).setSkinCoordWeight(new MFFloat169().getArray()).setUlimit(new MFFloat170().getArray()).setLlimit(new MFFloat171().getArray())
                                                                  .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_2").setDEF("Joe_l_carpal_distal_interphalangeal_2").setCenter(new float[] {0.202800005674362f ,0.713900029659271f ,-0.0236000008881092f }).setSkinCoordIndex(new MFInt32172().getArray()).setSkinCoordWeight(new MFFloat173().getArray()).setUlimit(new MFFloat174().getArray()).setLlimit(new MFFloat175().getArray())))))
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_3").setDEF("Joe_l_carpometacarpal_3").setCenter(new float[] {0.198699995875359f ,0.802900016307831f ,-0.0529999993741512f }).setSkinCoordIndex(new MFInt32176().getArray()).setSkinCoordWeight(new MFFloat177().getArray()).setUlimit(new MFFloat178().getArray()).setLlimit(new MFFloat179().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_3").setName("l_metacarpophalangeal_3").setDEF("Joe_l_metacarpophalangeal_3").setCenter(new float[] {0.198699995875359f ,0.781799972057343f ,-0.0529999993741512f }).setSkinCoordIndex(new MFInt32180().getArray()).setSkinCoordWeight(new MFFloat181().getArray()).setUlimit(new MFFloat182().getArray()).setLlimit(new MFFloat183().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_3").setName("l_carpal_proximal_interphalangeal_3").setDEF("Joe_l_carpal_proximal_interphalangeal_3").setCenter(new float[] {0.201299995183945f ,0.727299988269806f ,-0.0502999983727932f }).setSkinCoordIndex(new MFInt32184().getArray()).setSkinCoordWeight(new MFFloat185().getArray()).setUlimit(new MFFloat186().getArray()).setLlimit(new MFFloat187().getArray())
                                                                  .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_3").setDEF("Joe_l_carpal_distal_interphalangeal_3").setCenter(new float[] {0.202600002288818f ,0.701099991798401f ,-0.0494000017642975f }).setSkinCoordIndex(new MFInt32188().getArray()).setSkinCoordWeight(new MFFloat189().getArray()).setUlimit(new MFFloat190().getArray()).setLlimit(new MFFloat191().getArray())))))
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_4").setDEF("Joe_l_carpometacarpal_4").setCenter(new float[] {0.195600003004074f ,0.801900029182434f ,-0.0794000029563904f }).setSkinCoordIndex(new MFInt32192().getArray()).setSkinCoordWeight(new MFFloat193().getArray()).setUlimit(new MFFloat194().getArray()).setLlimit(new MFFloat195().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_4").setName("l_metacarpophalangeal_4").setDEF("Joe_l_metacarpophalangeal_4").setCenter(new float[] {0.195600003004074f ,0.781499981880188f ,-0.0794000029563904f }).setSkinCoordIndex(new MFInt32196().getArray()).setSkinCoordWeight(new MFFloat197().getArray()).setUlimit(new MFFloat198().getArray()).setLlimit(new MFFloat199().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_4").setName("l_carpal_proximal_interphalangeal_4").setDEF("Joe_l_carpal_proximal_interphalangeal_4").setCenter(new float[] {0.197300001978874f ,0.72869998216629f ,-0.0776999965310097f }).setSkinCoordIndex(new MFInt32200().getArray()).setSkinCoordWeight(new MFFloat201().getArray()).setUlimit(new MFFloat202().getArray()).setLlimit(new MFFloat203().getArray())
                                                                  .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_4").setDEF("Joe_l_carpal_distal_interphalangeal_4").setCenter(new float[] {0.198300004005432f ,0.704500019550323f ,-0.0767000019550323f }).setSkinCoordIndex(new MFInt32204().getArray()).setSkinCoordWeight(new MFFloat205().getArray()).setUlimit(new MFFloat206().getArray()).setLlimit(new MFFloat207().getArray())))))
                                                            .addChild(new HAnimJoint("Joe_l_radiocarpal").setName("l_carpometacarpal_5").setDEF("Joe_l_carpometacarpal_5").setCenter(new float[] {0.192499995231628f ,0.806599974632263f ,-0.10360000282526f }).setSkinCoordIndex(new MFInt32208().getArray()).setSkinCoordWeight(new MFFloat209().getArray()).setUlimit(new MFFloat210().getArray()).setLlimit(new MFFloat211().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_carpometacarpal_5").setName("l_metacarpophalangeal_5").setDEF("Joe_l_metacarpophalangeal_5").setCenter(new float[] {0.192499995231628f ,0.78659999370575f ,-0.10360000282526f }).setSkinCoordIndex(new MFInt32212().getArray()).setSkinCoordWeight(new MFFloat213().getArray()).setUlimit(new MFFloat214().getArray()).setLlimit(new MFFloat215().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_metacarpophalangeal_5").setName("l_carpal_proximal_interphalangeal_5").setDEF("Joe_l_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.193800002336502f ,0.745199978351593f ,-0.102399997413158f }).setSkinCoordIndex(new MFInt32216().getArray()).setSkinCoordWeight(new MFFloat217().getArray()).setUlimit(new MFFloat218().getArray()).setLlimit(new MFFloat219().getArray())
                                                                  .addChild(new HAnimJoint("Joe_l_carpal_proximal_interphalangeal_5").setName("l_carpal_distal_interphalangeal_5").setDEF("Joe_l_carpal_distal_interphalangeal_5").setCenter(new float[] {0.19480000436306f ,0.727699995040894f ,-0.101700000464916f }).setSkinCoordIndex(new MFInt32220().getArray()).setSkinCoordWeight(new MFFloat221().getArray()).setUlimit(new MFFloat222().getArray()).setLlimit(new MFFloat223().getArray()))))))))))
                                                  .addChild(new HAnimJoint("hanim_vc7").setName("r_sternoclavicular").setDEF("hanim_r_sternoclavicular").setCenter(new float[] {-0.0299999993294477f ,1.46000003814697f ,0f }).setSkinCoordIndex(new MFInt32224().getArray()).setSkinCoordWeight(new MFFloat225().getArray()).setUlimit(new MFFloat226().getArray()).setLlimit(new MFFloat227().getArray())
                                                    .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName("r_acromioclavicular").setDEF("hanim_r_acromioclavicular").setCenter(new float[] {-0.0900000035762787f ,1.4099999666214f ,-0.109999999403954f }).setSkinCoordIndex(new MFInt32228().getArray()).setSkinCoordWeight(new MFFloat229().getArray()).setUlimit(new MFFloat230().getArray()).setLlimit(new MFFloat231().getArray())
            ...
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_tarsometatarsal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_metatarsophalangeal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_metatarsal_2"))
            ...
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_tarsometatarsal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_metatarsophalangeal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_tarsal_distal_interphalangeal_2"))
            ...
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_radiocarpal"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpometacarpal_1"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_metacarpophalangeal_1"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpal_interphalangeal_1"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpometacarpal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_metacarpophalangeal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpal_proximal_interphalangeal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpal_distal_interphalangeal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpometacarpal_3"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_metacarpophalangeal_3"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpal_proximal_interphalangeal_3"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpal_distal_interphalangeal_3"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpometacarpal_4"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_metacarpophalangeal_4"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpal_proximal_interphalangeal_4"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpal_distal_interphalangeal_4"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpometacarpal_5"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_metacarpophalangeal_5"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpal_proximal_interphalangeal_5"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_l_carpal_distal_interphalangeal_5"))
            ...
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_radiocarpal"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpometacarpal_1"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_metacarpophalangeal_1"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpal_interphalangeal_1"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpometacarpal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_metacarpophalangeal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpal_proximal_interphalangeal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpal_distal_interphalangeal_2"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpometacarpal_3"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_metacarpophalangeal_3"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpal_proximal_interphalangeal_3"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpal_distal_interphalangeal_3"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpometacarpal_4"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_metacarpophalangeal_4"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpal_proximal_interphalangeal_4"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpal_distal_interphalangeal_4"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpometacarpal_5"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_metacarpophalangeal_5"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpal_proximal_interphalangeal_5"))
            .addJoints(new HAnimJoint("JoeHuman").setUSE("Joe_r_carpal_distal_interphalangeal_5"))
            ...
            .addSkin(new Shape()
              .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32320().getArray().append(new MFInt32321().getArray()).append(new MFInt32322().getArray()).append(new MFInt32323().getArray())).setCreaseAngle(3.09999990463257f ).setColorPerVertex(false)
                .setCoord(new Coordinate().setDEF("JoeSkinCoord").setPoint(new MFVec3f324().getArray().append(new MFVec3f325().getArray()))))
        ...
        .addChild(new Transform().setDEF("SBall").setTranslation(new float[] {-0.42091f ,0.2089f ,-0.42091f }).setRotation(new float[] {-0.70711f ,0f ,-0.70711f ,0.67654f }).setScale(new float[] {0.23f ,0.23f ,0.23f })
          .addChild(new Shape()
            .setAppearance(new Appearance()
            ...
            .setGeometry(new IndexedFaceSet().setDEF("ball").setCoordIndex(new MFInt32328().getArray())
        ...
        .addChild(new Transform().setDEF("Circle0").setScale(new float[] {1.175f ,1f ,1.175f })
          .addChild(new Shape()
            ...
            .setGeometry(new IndexedLineSet().setDEF("Orbit1").setCoordIndex(new MFInt32331().getArray())

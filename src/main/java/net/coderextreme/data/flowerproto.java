      ...
      .setScene(new Scene()
        .addChild(new ProtoDeclare().setName(new SFString("FlowerProto"))
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("MFString").setName(new SFString("vertex")).setAccessType(field.ACCESSTYPE_INPUTONLY).setValue(new SFString("\"../shaders/gl_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/gl_flowers_chromatic.vs\"")))
            .addField(new field().setType("MFString").setName(new SFString("fragment")).setAccessType(field.ACCESSTYPE_INPUTONLY).setValue(new SFString("\"../shaders/pc_flowers.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_flowers.fs\""))))
          .setProtoBody(new ProtoBody()
            .addChild(new Transform().setDEF(new SFString("transform"))
              ...
              .addChild(new Script().setDEF(new SFString("Animate")).setDirectOutput(true)
                ...
                .addField(new field().setType("SFVec3f").setName(new SFString("velocity")).setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue(new SFString("0 0 0")))
                .addField(new field().setType("SFFloat").setName(new SFString("set_fraction")).setAccessType(field.ACCESSTYPE_INPUTONLY))
                .addField(new field().setType("SFFloat").setName(new SFString("a")).setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue(new SFString("0.5")))
                .addField(new field().setType("SFFloat").setName(new SFString("b")).setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue(new SFString("0.5")))
                .addField(new field().setType("SFFloat").setName(new SFString("c")).setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue(new SFString("3")))
                .addField(new field().setType("SFFloat").setName(new SFString("d")).setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue(new SFString("3")))
                .addField(new field().setType("SFFloat").setName(new SFString("tdelta")).setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue(new SFString("0.5")))
                .addField(new field().setType("SFFloat").setName(new SFString("pdelta")).setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue(new SFString("0.5")))

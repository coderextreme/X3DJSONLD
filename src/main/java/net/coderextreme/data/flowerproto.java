              ...
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  ...
                  .setTexture(new ComposedCubeMapTexture().setDEF("texture")
                    .setBack(new ImageTexture().setUrl(new MFString0().getArray()))
                    .setBottom(new ImageTexture().setUrl(new MFString1().getArray()))
                    .setFront(new ImageTexture().setUrl(new MFString2().getArray()))
                    .setLeft(new ImageTexture().setUrl(new MFString3().getArray()))
                    .setRight(new ImageTexture().setUrl(new MFString4().getArray()))
                    .setTop(new ImageTexture().setUrl(new MFString5().getArray())))

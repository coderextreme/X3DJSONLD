...
public class JinLOA4_1 implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/JinLOA4_1.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("JinLOA4_1.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("modified")).setContent(new SFString("13 March 2021")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("JinLOA4_1.x3d")))
        ...
        .addChild(new HAnimHumanoid().setName(new SFString("JinLOA4")).setDEF(new SFString("hanim_JinLOA4")).setLoa(4).setScale(new float[] {0.0225f ,0.0225f ,0.0225f }).setVersion(new SFString("2.0"))
          ...
          .addSkeleton(new HAnimJoint("hanim_JinLOA4").setName(new SFString("humanoid_root")).setDEF(new SFString("hanim_humanoid_root")).setCenter(new float[] {0f ,36.709999f ,-0.7076f }).setUlimit(new MFFloat6().getArray()).setLlimit(new MFFloat7().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("sacroiliac")).setDEF(new SFString("hanim_sacroiliac")).setCenter(new float[] {0f ,31.43f ,-0.7076f }).setUlimit(new MFFloat13().getArray()).setLlimit(new MFFloat14().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("l_hip")).setDEF(new SFString("hanim_l_hip")).setCenter(new float[] {4.207f ,36.740002f ,-0.8155f }).setUlimit(new MFFloat19().getArray()).setLlimit(new MFFloat20().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName(new SFString("l_knee")).setDEF(new SFString("hanim_l_knee")).setCenter(new float[] {4.116f ,18.17f ,-0.8639f }).setUlimit(new MFFloat25().getArray()).setLlimit(new MFFloat26().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setName(new SFString("l_talocrural")).setDEF(new SFString("hanim_l_talocrural")).setCenter(new float[] {3.948f ,4.242f ,-0.4645f }).setUlimit(new MFFloat31().getArray()).setLlimit(new MFFloat32().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName(new SFString("l_talocalcaneonavicular")).setDEF(new SFString("hanim_l_talocalcaneonavicular")).setCenter(new float[] {3.48f ,1.64f ,0.2162f }).setUlimit(new MFFloat37().getArray()).setLlimit(new MFFloat38().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName(new SFString("l_cuneonavicular_1")).setDEF(new SFString("hanim_l_cuneonavicular_1")).setCenter(new float[] {2.994f ,1.427f ,0.8174f }).setUlimit(new MFFloat43().getArray()).setLlimit(new MFFloat44().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setName(new SFString("l_tarsometatarsal_1")).setDEF(new SFString("hanim_l_tarsometatarsal_1")).setCenter(new float[] {2.872f ,1.033f ,1.964f }).setUlimit(new MFFloat49().getArray()).setLlimit(new MFFloat50().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setName(new SFString("l_metatarsophalangeal_1")).setDEF(new SFString("hanim_l_metatarsophalangeal_1")).setCenter(new float[] {2.761f ,0.6411f ,4.161f }).setUlimit(new MFFloat55().getArray()).setLlimit(new MFFloat56().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setName(new SFString("l_tarsal_distal_interphalangeal_1")).setDEF(new SFString("hanim_l_tarsal_distal_interphalangeal_1")).setCenter(new float[] {2.761f ,0.5394f ,5.125f }).setUlimit(new MFFloat61().getArray()).setLlimit(new MFFloat62().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName(new SFString("l_cuneonavicular_2")).setDEF(new SFString("hanim_l_cuneonavicular_2")).setCenter(new float[] {3.619f ,1.49f ,0.9523f }).setUlimit(new MFFloat67().getArray()).setLlimit(new MFFloat68().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setName(new SFString("l_tarsometatarsal_2")).setDEF(new SFString("hanim_l_tarsometatarsal_2")).setCenter(new float[] {3.564f ,1.16f ,1.825f }).setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName(new SFString("l_metatarsophalangeal_2")).setDEF(new SFString("hanim_l_metatarsophalangeal_2")).setCenter(new float[] {3.668f ,0.6656f ,4.348f }).setUlimit(new MFFloat79().getArray()).setLlimit(new MFFloat80().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName(new SFString("l_tarsal_proximal_interphalangeal_2")).setDEF(new SFString("hanim_l_tarsal_proximal_interphalangeal_2")).setCenter(new float[] {3.747f ,0.5621f ,5.067f }).setUlimit(new MFFloat85().getArray()).setLlimit(new MFFloat86().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setName(new SFString("l_tarsal_distal_interphalangeal_2")).setDEF(new SFString("hanim_l_tarsal_distal_interphalangeal_2")).setCenter(new float[] {3.747f ,0.4367f ,5.486f }).setUlimit(new MFFloat91().getArray()).setLlimit(new MFFloat92().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName(new SFString("l_cuneonavicular_3")).setDEF(new SFString("hanim_l_cuneonavicular_3")).setCenter(new float[] {4.132f ,1.484f ,0.8808f }).setUlimit(new MFFloat97().getArray()).setLlimit(new MFFloat98().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setName(new SFString("l_tarsometatarsal_3")).setDEF(new SFString("hanim_l_tarsometatarsal_3")).setCenter(new float[] {4.204f ,1.16f ,1.751f }).setUlimit(new MFFloat103().getArray()).setLlimit(new MFFloat104().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setName(new SFString("l_metatarsophalangeal_3")).setDEF(new SFString("hanim_l_metatarsophalangeal_3")).setCenter(new float[] {4.288f ,0.6692f ,4.241f }).setUlimit(new MFFloat109().getArray()).setLlimit(new MFFloat110().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setName(new SFString("l_tarsal_proximal_interphalangeal_3")).setDEF(new SFString("hanim_l_tarsal_proximal_interphalangeal_3")).setCenter(new float[] {4.394f ,0.5299f ,4.91f }).setUlimit(new MFFloat115().getArray()).setLlimit(new MFFloat116().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setName(new SFString("l_tarsal_distal_interphalangeal_3")).setDEF(new SFString("hanim_l_tarsal_distal_interphalangeal_3")).setCenter(new float[] {4.463f ,0.4367f ,5.32f }).setUlimit(new MFFloat121().getArray()).setLlimit(new MFFloat122().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName(new SFString("l_calcaneocuboid")).setDEF(new SFString("hanim_l_calcaneocuboid")).setCenter(new float[] {3.96f ,2.577f ,-1.154f }).setUlimit(new MFFloat127().getArray()).setLlimit(new MFFloat128().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setName(new SFString("l_transversetarsal")).setDEF(new SFString("hanim_l_transversetarsal")).setCenter(new float[] {4.917f ,1.568f ,0.09285f }).setUlimit(new MFFloat133().getArray()).setLlimit(new MFFloat134().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName(new SFString("l_tarsometatarsal_4")).setDEF(new SFString("hanim_l_tarsometatarsal_4")).setCenter(new float[] {4.733f ,1.091f ,1.708f }).setUlimit(new MFFloat139().getArray()).setLlimit(new MFFloat140().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setName(new SFString("l_metatarsophalangeal_4")).setDEF(new SFString("hanim_l_metatarsophalangeal_4")).setCenter(new float[] {4.883f ,0.6379f ,4.052f }).setUlimit(new MFFloat145().getArray()).setLlimit(new MFFloat146().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setName(new SFString("l_tarsal_proximal_interphalangeal_4")).setDEF(new SFString("hanim_l_tarsal_proximal_interphalangeal_4")).setCenter(new float[] {5.074f ,0.5442f ,4.725f }).setUlimit(new MFFloat151().getArray()).setLlimit(new MFFloat152().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setName(new SFString("l_tarsal_distal_interphalangeal_4")).setDEF(new SFString("hanim_l_tarsal_distal_interphalangeal_4")).setCenter(new float[] {5.141f ,0.4164f ,5.053f }).setUlimit(new MFFloat157().getArray()).setLlimit(new MFFloat158().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName(new SFString("l_tarsometatarsal_5")).setDEF(new SFString("hanim_l_tarsometatarsal_5")).setCenter(new float[] {5.37f ,0.9309f ,1.544f }).setUlimit(new MFFloat163().getArray()).setLlimit(new MFFloat164().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setName(new SFString("l_metatarsophalangeal_5")).setDEF(new SFString("hanim_l_metatarsophalangeal_5")).setCenter(new float[] {5.514f ,0.6076f ,3.847f }).setUlimit(new MFFloat169().getArray()).setLlimit(new MFFloat170().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setName(new SFString("l_tarsal_proximal_interphalangeal_5")).setDEF(new SFString("hanim_l_tarsal_proximal_interphalangeal_5")).setCenter(new float[] {5.617f ,0.4825f ,4.184f }).setUlimit(new MFFloat175().getArray()).setLlimit(new MFFloat176().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_5").setName(new SFString("l_tarsal_distal_interphalangeal_5")).setDEF(new SFString("hanim_l_tarsal_distal_interphalangeal_5")).setCenter(new float[] {5.657f ,0.3806f ,4.528f }).setUlimit(new MFFloat181().getArray()).setLlimit(new MFFloat182().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("r_hip")).setDEF(new SFString("hanim_r_hip")).setCenter(new float[] {-4.207f ,36.740002f ,-0.8155f }).setUlimit(new MFFloat187().getArray()).setLlimit(new MFFloat188().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName(new SFString("r_knee")).setDEF(new SFString("hanim_r_knee")).setCenter(new float[] {-4.116f ,18.17f ,-0.8639f }).setUlimit(new MFFloat193().getArray()).setLlimit(new MFFloat194().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName(new SFString("r_talocrural")).setDEF(new SFString("hanim_r_talocrural")).setCenter(new float[] {-3.931f ,4.242f ,-0.4645f }).setUlimit(new MFFloat199().getArray()).setLlimit(new MFFloat200().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName(new SFString("r_talocalcaneonavicular")).setDEF(new SFString("hanim_r_talocalcaneonavicular")).setCenter(new float[] {-3.464f ,1.64f ,0.2162f }).setUlimit(new MFFloat205().getArray()).setLlimit(new MFFloat206().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName(new SFString("r_cuneonavicular_1")).setDEF(new SFString("hanim_r_cuneonavicular_1")).setCenter(new float[] {-2.977f ,1.427f ,0.8174f }).setUlimit(new MFFloat211().getArray()).setLlimit(new MFFloat212().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_1").setName(new SFString("r_tarsometatarsal_1")).setDEF(new SFString("hanim_r_tarsometatarsal_1")).setCenter(new float[] {-2.856f ,1.033f ,1.964f }).setUlimit(new MFFloat217().getArray()).setLlimit(new MFFloat218().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_1").setName(new SFString("r_metatarsophalangeal_1")).setDEF(new SFString("hanim_r_metatarsophalangeal_1")).setCenter(new float[] {-2.745f ,0.6411f ,4.161f }).setUlimit(new MFFloat223().getArray()).setLlimit(new MFFloat224().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_1").setName(new SFString("r_tarsal_distal_interphalangeal_1")).setDEF(new SFString("hanim_r_tarsal_distal_interphalangeal_1")).setCenter(new float[] {-2.744f ,0.5394f ,5.125f }).setUlimit(new MFFloat229().getArray()).setLlimit(new MFFloat230().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName(new SFString("r_cuneonavicular_2")).setDEF(new SFString("hanim_r_cuneonavicular_2")).setCenter(new float[] {-3.602f ,1.49f ,0.9523f }).setUlimit(new MFFloat235().getArray()).setLlimit(new MFFloat236().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_2").setName(new SFString("r_tarsometatarsal_2")).setDEF(new SFString("hanim_r_tarsometatarsal_2")).setCenter(new float[] {-3.548f ,1.16f ,1.825f }).setUlimit(new MFFloat241().getArray()).setLlimit(new MFFloat242().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setName(new SFString("r_metatarsophalangeal_2")).setDEF(new SFString("hanim_r_metatarsophalangeal_2")).setCenter(new float[] {-3.651f ,0.6656f ,4.348f }).setUlimit(new MFFloat247().getArray()).setLlimit(new MFFloat248().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName(new SFString("r_tarsal_proximal_interphalangeal_2")).setDEF(new SFString("hanim_r_tarsal_proximal_interphalangeal_2")).setCenter(new float[] {-3.73f ,0.5621f ,5.067f }).setUlimit(new MFFloat253().getArray()).setLlimit(new MFFloat254().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_2").setName(new SFString("r_tarsal_distal_interphalangeal_2")).setDEF(new SFString("hanim_r_tarsal_distal_interphalangeal_2")).setCenter(new float[] {-3.73f ,0.4367f ,5.486f }).setUlimit(new MFFloat259().getArray()).setLlimit(new MFFloat260().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName(new SFString("r_cuneonavicular_3")).setDEF(new SFString("hanim_r_cuneonavicular_3")).setCenter(new float[] {-4.116f ,1.484f ,0.8808f }).setUlimit(new MFFloat265().getArray()).setLlimit(new MFFloat266().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_3").setName(new SFString("r_tarsometatarsal_3")).setDEF(new SFString("hanim_r_tarsometatarsal_3")).setCenter(new float[] {-4.188f ,1.16f ,1.751f }).setUlimit(new MFFloat271().getArray()).setLlimit(new MFFloat272().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_3").setName(new SFString("r_metatarsophalangeal_3")).setDEF(new SFString("hanim_r_metatarsophalangeal_3")).setCenter(new float[] {-4.271f ,0.6692f ,4.241f }).setUlimit(new MFFloat277().getArray()).setLlimit(new MFFloat278().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_3").setName(new SFString("r_tarsal_proximal_interphalangeal_3")).setDEF(new SFString("hanim_r_tarsal_proximal_interphalangeal_3")).setCenter(new float[] {-4.378f ,0.5299f ,4.91f }).setUlimit(new MFFloat283().getArray()).setLlimit(new MFFloat284().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_3").setName(new SFString("r_tarsal_distal_interphalangeal_3")).setDEF(new SFString("hanim_r_tarsal_distal_interphalangeal_3")).setCenter(new float[] {-4.446f ,0.4367f ,5.32f }).setUlimit(new MFFloat289().getArray()).setLlimit(new MFFloat290().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName(new SFString("r_calcaneocuboid")).setDEF(new SFString("hanim_r_calcaneocuboid")).setCenter(new float[] {-3.943f ,2.577f ,-1.154f }).setUlimit(new MFFloat295().getArray()).setLlimit(new MFFloat296().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_calcaneocuboid").setName(new SFString("r_transversetarsal")).setDEF(new SFString("hanim_r_transversetarsal")).setCenter(new float[] {-4.901f ,1.568f ,0.09285f }).setUlimit(new MFFloat301().getArray()).setLlimit(new MFFloat302().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName(new SFString("r_tarsometatarsal_4")).setDEF(new SFString("hanim_r_tarsometatarsal_4")).setCenter(new float[] {-4.717f ,1.091f ,1.708f }).setUlimit(new MFFloat307().getArray()).setLlimit(new MFFloat308().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_4").setName(new SFString("r_metatarsophalangeal_4")).setDEF(new SFString("hanim_r_metatarsophalangeal_4")).setCenter(new float[] {-4.867f ,0.6379f ,4.052f }).setUlimit(new MFFloat313().getArray()).setLlimit(new MFFloat314().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_4").setName(new SFString("r_tarsal_proximal_interphalangeal_4")).setDEF(new SFString("hanim_r_tarsal_proximal_interphalangeal_4")).setCenter(new float[] {-5.057f ,0.5442f ,4.725f }).setUlimit(new MFFloat319().getArray()).setLlimit(new MFFloat320().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_4").setName(new SFString("r_tarsal_distal_interphalangeal_4")).setDEF(new SFString("hanim_r_tarsal_distal_interphalangeal_4")).setCenter(new float[] {-5.125f ,0.4164f ,5.053f }).setUlimit(new MFFloat325().getArray()).setLlimit(new MFFloat326().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName(new SFString("r_tarsometatarsal_5")).setDEF(new SFString("hanim_r_tarsometatarsal_5")).setCenter(new float[] {-5.353f ,0.9309f ,1.544f }).setUlimit(new MFFloat331().getArray()).setLlimit(new MFFloat332().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_5").setName(new SFString("r_metatarsophalangeal_5")).setDEF(new SFString("hanim_r_metatarsophalangeal_5")).setCenter(new float[] {-5.497f ,0.6076f ,3.847f }).setUlimit(new MFFloat337().getArray()).setLlimit(new MFFloat338().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_5").setName(new SFString("r_tarsal_proximal_interphalangeal_5")).setDEF(new SFString("hanim_r_tarsal_proximal_interphalangeal_5")).setCenter(new float[] {-5.6f ,0.4825f ,4.184f }).setUlimit(new MFFloat343().getArray()).setLlimit(new MFFloat344().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_5").setName(new SFString("r_tarsal_distal_interphalangeal_5")).setDEF(new SFString("hanim_r_tarsal_distal_interphalangeal_5")).setCenter(new float[] {-5.641f ,0.3806f ,4.528f }).setUlimit(new MFFloat349().getArray()).setLlimit(new MFFloat350().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("vl5")).setDEF(new SFString("hanim_vl5")).setCenter(new float[] {0f ,41.130001f ,-0.6117f }).setUlimit(new MFFloat355().getArray()).setLlimit(new MFFloat356().getArray())
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("vl4")).setDEF(new SFString("hanim_vl4")).setCenter(new float[] {0f ,42.209999f ,-0.6117f }).setUlimit(new MFFloat361().getArray()).setLlimit(new MFFloat362().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_vl4").setName(new SFString("vl3")).setDEF(new SFString("hanim_vl3")).setCenter(new float[] {0f ,42.93f ,-0.6117f }).setUlimit(new MFFloat367().getArray()).setLlimit(new MFFloat368().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_vl3").setName(new SFString("vl2")).setDEF(new SFString("hanim_vl2")).setCenter(new float[] {0f ,43.66f ,-0.6117f }).setUlimit(new MFFloat373().getArray()).setLlimit(new MFFloat374().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_vl2").setName(new SFString("vl1")).setDEF(new SFString("hanim_vl1")).setCenter(new float[] {0f ,44.43f ,-0.6117f }).setUlimit(new MFFloat379().getArray()).setLlimit(new MFFloat380().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_vl1").setName(new SFString("vt12")).setDEF(new SFString("hanim_vt12")).setCenter(new float[] {0f ,45.470001f ,-0.6117f }).setUlimit(new MFFloat385().getArray()).setLlimit(new MFFloat386().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_vt12").setName(new SFString("vt11")).setDEF(new SFString("hanim_vt11")).setCenter(new float[] {0f ,46.52f ,-0.6117f }).setUlimit(new MFFloat391().getArray()).setLlimit(new MFFloat392().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_vt11").setName(new SFString("vt10")).setDEF(new SFString("hanim_vt10")).setCenter(new float[] {0f ,47.279999f ,-0.6127f }).setUlimit(new MFFloat397().getArray()).setLlimit(new MFFloat398().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_vt10").setName(new SFString("vt9")).setDEF(new SFString("hanim_vt9")).setCenter(new float[] {0f ,47.93f ,-0.6117f }).setUlimit(new MFFloat403().getArray()).setLlimit(new MFFloat404().getArray())
                                ...
                                .addChild(new HAnimJoint("hanim_vt9").setName(new SFString("vt8")).setDEF(new SFString("hanim_vt8")).setCenter(new float[] {0f ,48.580002f ,-0.6117f }).setUlimit(new MFFloat409().getArray()).setLlimit(new MFFloat410().getArray())
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt8").setName(new SFString("vt7")).setDEF(new SFString("hanim_vt7")).setCenter(new float[] {0f ,49.279999f ,-0.6117f }).setUlimit(new MFFloat415().getArray()).setLlimit(new MFFloat416().getArray())
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt7").setName(new SFString("vt6")).setDEF(new SFString("hanim_vt6")).setCenter(new float[] {0f ,49.849998f ,-0.6117f }).setUlimit(new MFFloat421().getArray()).setLlimit(new MFFloat422().getArray())
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt6").setName(new SFString("vt5")).setDEF(new SFString("hanim_vt5")).setCenter(new float[] {0f ,50.540001f ,-0.6117f }).setUlimit(new MFFloat427().getArray()).setLlimit(new MFFloat428().getArray())
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt5").setName(new SFString("vt4")).setDEF(new SFString("hanim_vt4")).setCenter(new float[] {0f ,51.220001f ,-0.6117f }).setUlimit(new MFFloat433().getArray()).setLlimit(new MFFloat434().getArray())
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setName(new SFString("vt3")).setDEF(new SFString("hanim_vt3")).setCenter(new float[] {0f ,52.040001f ,-0.6117f }).setUlimit(new MFFloat439().getArray()).setLlimit(new MFFloat440().getArray())
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setName(new SFString("vt2")).setDEF(new SFString("hanim_vt2")).setCenter(new float[] {0f ,53.139999f ,-0.6127f }).setUlimit(new MFFloat445().getArray()).setLlimit(new MFFloat446().getArray())
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setName(new SFString("vt1")).setDEF(new SFString("hanim_vt1")).setCenter(new float[] {0f ,54.200001f ,-0.6117f }).setUlimit(new MFFloat451().getArray()).setLlimit(new MFFloat452().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName(new SFString("vc7")).setDEF(new SFString("hanim_vc7")).setCenter(new float[] {0f ,55.349998f ,-0.6695f }).setUlimit(new MFFloat457().getArray()).setLlimit(new MFFloat458().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc7").setName(new SFString("vc6")).setDEF(new SFString("hanim_vc6")).setCenter(new float[] {0f ,55.889999f ,-0.6695f }).setUlimit(new MFFloat463().getArray()).setLlimit(new MFFloat464().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc6").setName(new SFString("vc5")).setDEF(new SFString("hanim_vc5")).setCenter(new float[] {0f ,56.439999f ,-0.6695f }).setUlimit(new MFFloat469().getArray()).setLlimit(new MFFloat470().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc5").setName(new SFString("vc4")).setDEF(new SFString("hanim_vc4")).setCenter(new float[] {0f ,56.990002f ,-0.6695f }).setUlimit(new MFFloat475().getArray()).setLlimit(new MFFloat476().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_vc4").setName(new SFString("vc3")).setDEF(new SFString("hanim_vc3")).setCenter(new float[] {0f ,57.560001f ,-0.6695f }).setUlimit(new MFFloat481().getArray()).setLlimit(new MFFloat482().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_vc3").setName(new SFString("vc2")).setDEF(new SFString("hanim_vc2")).setCenter(new float[] {0f ,58.080002f ,-0.6695f }).setUlimit(new MFFloat487().getArray()).setLlimit(new MFFloat488().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_vc2").setName(new SFString("vc1")).setDEF(new SFString("hanim_vc1")).setCenter(new float[] {0f ,58.599998f ,-0.6695f }).setUlimit(new MFFloat493().getArray()).setLlimit(new MFFloat494().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_vc1").setName(new SFString("skullbase")).setDEF(new SFString("hanim_skullbase")).setCenter(new float[] {0f ,58.34f ,-0.6863f }).setUlimit(new MFFloat499().getArray()).setLlimit(new MFFloat500().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName(new SFString("l_eyelid_joint")).setDEF(new SFString("hanim_l_eyelid_joint")).setCenter(new float[] {2.245f ,63.299999f ,1.464f }).setUlimit(new MFFloat511().getArray()).setLlimit(new MFFloat512().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName(new SFString("r_eyelid_joint")).setDEF(new SFString("hanim_r_eyelid_joint")).setCenter(new float[] {-2.245f ,63.299999f ,1.464f }).setUlimit(new MFFloat517().getArray()).setLlimit(new MFFloat518().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName(new SFString("l_eyeball_joint")).setDEF(new SFString("hanim_l_eyeball_joint")).setCenter(new float[] {2.139f ,62.439999f ,3.691f }).setUlimit(new MFFloat523().getArray()).setLlimit(new MFFloat524().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName(new SFString("r_eyeball_joint")).setDEF(new SFString("hanim_r_eyeball_joint")).setCenter(new float[] {-2.139f ,62.439999f ,3.691f }).setUlimit(new MFFloat529().getArray()).setLlimit(new MFFloat530().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName(new SFString("l_eyebrow_joint")).setDEF(new SFString("hanim_l_eyebrow_joint")).setCenter(new float[] {0.9666f ,62.84f ,4.753f }).setUlimit(new MFFloat535().getArray()).setLlimit(new MFFloat536().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName(new SFString("r_eyebrow_joint")).setDEF(new SFString("hanim_r_eyebrow_joint")).setCenter(new float[] {-0.9666f ,62.84f ,4.753f }).setUlimit(new MFFloat541().getArray()).setLlimit(new MFFloat542().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setName(new SFString("temporomandibular")).setDEF(new SFString("hanim_temporomandibular")).setCenter(new float[] {0f ,58.349998f ,0.6835f }).setUlimit(new MFFloat547().getArray()).setLlimit(new MFFloat548().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName(new SFString("l_acromioclavicular")).setDEF(new SFString("hanim_l_acromioclavicular")).setCenter(new float[] {1.71f ,53.720001f ,-0.6127f }).setUlimit(new MFFloat553().getArray()).setLlimit(new MFFloat554().getArray())
                                                  .addChild(new HAnimSegment("hanim_l_acromioclavicular").setName(new SFString("l_clavicle")).setDEF(new SFString("hanim_l_clavicle"))
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName(new SFString("l_sternoclavicular")).setDEF(new SFString("hanim_l_sternoclavicular")).setCenter(new float[] {5.464f ,52.970001f ,-0.5732f }).setUlimit(new MFFloat559().getArray()).setLlimit(new MFFloat560().getArray())
                                                    .addChild(new HAnimSegment("hanim_l_sternoclavicular").setName(new SFString("l_scapula")).setDEF(new SFString("hanim_l_scapula"))
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName(new SFString("l_shoulder")).setDEF(new SFString("hanim_l_shoulder")).setCenter(new float[] {7.336f ,52.380001f ,-0.1452f }).setUlimit(new MFFloat565().getArray()).setLlimit(new MFFloat566().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_l_shoulder").setName(new SFString("l_elbow")).setDEF(new SFString("hanim_l_elbow")).setCenter(new float[] {8.093f ,41.279999f ,-0.2502f }).setUlimit(new MFFloat571().getArray()).setLlimit(new MFFloat572().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_elbow").setName(new SFString("l_radiocarpal")).setDEF(new SFString("hanim_l_radiocarpal")).setCenter(new float[] {8.086f ,32.189999f ,-0.2233f }).setUlimit(new MFFloat577().getArray()).setLlimit(new MFFloat578().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName(new SFString("l_midcarpal_1")).setDEF(new SFString("hanim_l_midcarpal_1")).setCenter(new float[] {8.057f ,31.379999f ,0.859f }).setUlimit(new MFFloat583().getArray()).setLlimit(new MFFloat584().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_1").setName(new SFString("l_carpometacarpal_1")).setDEF(new SFString("hanim_l_carpometacarpal_1")).setCenter(new float[] {8.022f ,30.780001f ,1.155f }).setUlimit(new MFFloat589().getArray()).setLlimit(new MFFloat590().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setName(new SFString("l_metacarpophalangeal_1")).setDEF(new SFString("hanim_l_metacarpophalangeal_1")).setCenter(new float[] {8.046f ,29.9f ,1.59f }).setUlimit(new MFFloat595().getArray()).setLlimit(new MFFloat596().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setName(new SFString("l_carpal_interphalangeal_1")).setDEF(new SFString("hanim_l_carpal_interphalangeal_1")).setCenter(new float[] {8.118f ,29.07f ,2.207f }).setUlimit(new MFFloat601().getArray()).setLlimit(new MFFloat602().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName(new SFString("l_midcarpal_2")).setDEF(new SFString("hanim_l_midcarpal_2")).setCenter(new float[] {8.057f ,31.42f ,0.3741f }).setUlimit(new MFFloat607().getArray()).setLlimit(new MFFloat608().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_2").setName(new SFString("l_carpometacarpal_2")).setDEF(new SFString("hanim_l_carpometacarpal_2")).setCenter(new float[] {8.057f ,30.559999f ,0.4324f }).setUlimit(new MFFloat613().getArray()).setLlimit(new MFFloat614().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setName(new SFString("l_metacarpophalangeal_2")).setDEF(new SFString("hanim_l_metacarpophalangeal_2")).setCenter(new float[] {8.166f ,28.32f ,0.67f }).setUlimit(new MFFloat619().getArray()).setLlimit(new MFFloat620().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setName(new SFString("l_carpal_proximal_interphalangeal_2")).setDEF(new SFString("hanim_l_carpal_proximal_interphalangeal_2")).setCenter(new float[] {8.076f ,26.969999f ,0.6304f }).setUlimit(new MFFloat625().getArray()).setLlimit(new MFFloat626().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setName(new SFString("l_carpal_distal_interphalangeal_2")).setDEF(new SFString("hanim_l_carpal_distal_interphalangeal_2")).setCenter(new float[] {8.03f ,25.85f ,0.5949f }).setUlimit(new MFFloat631().getArray()).setLlimit(new MFFloat632().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName(new SFString("l_midcarpal_3")).setDEF(new SFString("hanim_l_midcarpal_3")).setCenter(new float[] {8.048f ,31.49f ,-0.2132f }).setUlimit(new MFFloat637().getArray()).setLlimit(new MFFloat638().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_3").setName(new SFString("l_carpometacarpal_3")).setDEF(new SFString("hanim_l_carpometacarpal_3")).setCenter(new float[] {8.048f ,30.48f ,-0.2779f }).setUlimit(new MFFloat643().getArray()).setLlimit(new MFFloat644().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setName(new SFString("l_metacarpophalangeal_3")).setDEF(new SFString("hanim_l_metacarpophalangeal_3")).setCenter(new float[] {8.164f ,28.219999f ,-0.1741f }).setUlimit(new MFFloat649().getArray()).setLlimit(new MFFloat650().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setName(new SFString("l_carpal_proximal_interphalangeal_3")).setDEF(new SFString("hanim_l_carpal_proximal_interphalangeal_3")).setCenter(new float[] {8.076f ,26.809999f ,-0.1572f }).setUlimit(new MFFloat655().getArray()).setLlimit(new MFFloat656().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setName(new SFString("l_carpal_distal_interphalangeal_3")).setDEF(new SFString("hanim_l_carpal_distal_interphalangeal_3")).setCenter(new float[] {8.03f ,25.57f ,-0.1671f }).setUlimit(new MFFloat661().getArray()).setLlimit(new MFFloat662().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName(new SFString("l_midcarpal_4_5")).setDEF(new SFString("hanim_l_midcarpal_4_5")).setCenter(new float[] {8.048f ,31.370001f ,-1.144f }).setUlimit(new MFFloat667().getArray()).setLlimit(new MFFloat668().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_4_5").setName(new SFString("l_carpometacarpal_4")).setDEF(new SFString("hanim_l_carpometacarpal_4")).setCenter(new float[] {8.048f ,30.5f ,-0.8853f }).setUlimit(new MFFloat673().getArray()).setLlimit(new MFFloat674().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setName(new SFString("l_metacarpophalangeal_4")).setDEF(new SFString("hanim_l_metacarpophalangeal_4")).setCenter(new float[] {8.164f ,28.18f ,-0.9529f }).setUlimit(new MFFloat679().getArray()).setLlimit(new MFFloat680().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setName(new SFString("l_carpal_proximal_interphalangeal_4")).setDEF(new SFString("hanim_l_carpal_proximal_interphalangeal_4")).setCenter(new float[] {8.076f ,26.959999f ,-0.9176f }).setUlimit(new MFFloat685().getArray()).setLlimit(new MFFloat686().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setName(new SFString("l_carpal_distal_interphalangeal_4")).setDEF(new SFString("hanim_l_carpal_distal_interphalangeal_4")).setCenter(new float[] {8.03f ,25.809999f ,-0.879f }).setUlimit(new MFFloat691().getArray()).setLlimit(new MFFloat692().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setName(new SFString("l_carpometacarpal_5")).setDEF(new SFString("hanim_l_carpometacarpal_5")).setCenter(new float[] {8.073f ,30.59f ,-1.457f }).setUlimit(new MFFloat697().getArray()).setLlimit(new MFFloat698().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setName(new SFString("l_metacarpophalangeal_5")).setDEF(new SFString("hanim_l_metacarpophalangeal_5")).setCenter(new float[] {8.148f ,28.360001f ,-1.647f }).setUlimit(new MFFloat703().getArray()).setLlimit(new MFFloat704().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setName(new SFString("l_carpal_proximal_interphalangeal_5")).setDEF(new SFString("hanim_l_carpal_proximal_interphalangeal_5")).setCenter(new float[] {8.074f ,27.6f ,-1.651f }).setUlimit(new MFFloat709().getArray()).setLlimit(new MFFloat710().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_5").setName(new SFString("l_carpal_distal_interphalangeal_5")).setDEF(new SFString("hanim_l_carpal_distal_interphalangeal_5")).setCenter(new float[] {8.036f ,26.77f ,-1.643f }).setUlimit(new MFFloat715().getArray()).setLlimit(new MFFloat716().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName(new SFString("r_acromioclavicular")).setDEF(new SFString("hanim_r_acromioclavicular")).setCenter(new float[] {-1.71f ,53.720001f ,-0.6127f }).setUlimit(new MFFloat721().getArray()).setLlimit(new MFFloat722().getArray())
                                                  .addChild(new HAnimSegment("hanim_r_acromioclavicular").setName(new SFString("r_clavicle")).setDEF(new SFString("hanim_r_clavicle"))
                                                    .addChild(new Transform().setTranslation(new float[] {-1.71f ,53.720001f ,-0.6127f })
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_acromioclavicular").setName(new SFString("r_sternoclavicular")).setDEF(new SFString("hanim_r_sternoclavicular")).setCenter(new float[] {-5.464f ,52.970001f ,-0.5732f }).setUlimit(new MFFloat727().getArray()).setLlimit(new MFFloat728().getArray())
                                                    .addChild(new HAnimSegment("hanim_r_sternoclavicular").setName(new SFString("r_scapula")).setDEF(new SFString("hanim_r_scapula"))
                                                      .addChild(new Transform().setTranslation(new float[] {-5.464f ,52.970001f ,-0.5732f })
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName(new SFString("r_shoulder")).setDEF(new SFString("hanim_r_shoulder")).setCenter(new float[] {-7.32f ,52.380001f ,-0.1452f }).setUlimit(new MFFloat733().getArray()).setLlimit(new MFFloat734().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_shoulder").setName(new SFString("r_elbow")).setDEF(new SFString("hanim_r_elbow")).setCenter(new float[] {-8.077f ,41.279999f ,-0.2502f }).setUlimit(new MFFloat739().getArray()).setLlimit(new MFFloat740().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_elbow").setName(new SFString("r_radiocarpal")).setDEF(new SFString("hanim_r_radiocarpal")).setCenter(new float[] {-8.07f ,32.189999f ,-0.2232f }).setUlimit(new MFFloat745().getArray()).setLlimit(new MFFloat746().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName(new SFString("r_midcarpal_1")).setDEF(new SFString("hanim_r_midcarpal_1")).setCenter(new float[] {-8.043f ,31.379999f ,0.859f }).setUlimit(new MFFloat751().getArray()).setLlimit(new MFFloat752().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_1").setName(new SFString("r_carpometacarpal_1")).setDEF(new SFString("hanim_r_carpometacarpal_1")).setCenter(new float[] {-8.006f ,30.780001f ,1.155f }).setUlimit(new MFFloat757().getArray()).setLlimit(new MFFloat758().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setName(new SFString("r_metacarpophalangeal_1")).setDEF(new SFString("hanim_r_metacarpophalangeal_1")).setCenter(new float[] {-8.029f ,29.9f ,1.59f }).setUlimit(new MFFloat763().getArray()).setLlimit(new MFFloat764().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setName(new SFString("r_carpal_interphalangeal_1")).setDEF(new SFString("hanim_r_carpal_interphalangeal_1")).setCenter(new float[] {-8.101f ,29.07f ,2.207f }).setUlimit(new MFFloat769().getArray()).setLlimit(new MFFloat770().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName(new SFString("r_midcarpal_2")).setDEF(new SFString("hanim_r_midcarpal_2")).setCenter(new float[] {-8.043f ,31.42f ,0.3741f }).setUlimit(new MFFloat775().getArray()).setLlimit(new MFFloat776().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_2").setName(new SFString("r_carpometacarpal_2")).setDEF(new SFString("hanim_r_carpometacarpal_2")).setCenter(new float[] {-8.04f ,30.559999f ,0.4324f }).setUlimit(new MFFloat781().getArray()).setLlimit(new MFFloat782().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setName(new SFString("r_metacarpophalangeal_2")).setDEF(new SFString("hanim_r_metacarpophalangeal_2")).setCenter(new float[] {-8.149f ,28.32f ,0.67f }).setUlimit(new MFFloat787().getArray()).setLlimit(new MFFloat788().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setName(new SFString("r_carpal_proximal_interphalangeal_2")).setDEF(new SFString("hanim_r_carpal_proximal_interphalangeal_2")).setCenter(new float[] {-8.059f ,26.969999f ,0.6304f }).setUlimit(new MFFloat793().getArray()).setLlimit(new MFFloat794().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setName(new SFString("r_carpal_distal_interphalangeal_2")).setDEF(new SFString("hanim_r_carpal_distal_interphalangeal_2")).setCenter(new float[] {-8.013f ,25.85f ,0.5949f }).setUlimit(new MFFloat799().getArray()).setLlimit(new MFFloat800().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName(new SFString("r_midcarpal_3")).setDEF(new SFString("hanim_r_midcarpal_3")).setCenter(new float[] {-8.032f ,31.49f ,-0.2132f }).setUlimit(new MFFloat805().getArray()).setLlimit(new MFFloat806().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_3").setName(new SFString("r_carpometacarpal_3")).setDEF(new SFString("hanim_r_carpometacarpal_3")).setCenter(new float[] {-8.032f ,30.48f ,-0.2779f }).setUlimit(new MFFloat811().getArray()).setLlimit(new MFFloat812().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setName(new SFString("r_metacarpophalangeal_3")).setDEF(new SFString("hanim_r_metacarpophalangeal_3")).setCenter(new float[] {-8.147f ,28.219999f ,-0.1741f }).setUlimit(new MFFloat817().getArray()).setLlimit(new MFFloat818().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setName(new SFString("r_carpal_proximal_interphalangeal_3")).setDEF(new SFString("hanim_r_carpal_proximal_interphalangeal_3")).setCenter(new float[] {-8.059f ,26.809999f ,-0.1572f }).setUlimit(new MFFloat823().getArray()).setLlimit(new MFFloat824().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setName(new SFString("r_carpal_distal_interphalangeal_3")).setDEF(new SFString("hanim_r_carpal_distal_interphalangeal_3")).setCenter(new float[] {-8.013f ,25.57f ,-0.1671f }).setUlimit(new MFFloat829().getArray()).setLlimit(new MFFloat830().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName(new SFString("r_midcarpal_4_5")).setDEF(new SFString("hanim_r_midcarpal_4_5")).setCenter(new float[] {-8.032f ,31.370001f ,-1.144f }).setUlimit(new MFFloat835().getArray()).setLlimit(new MFFloat836().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_4_5").setName(new SFString("r_carpometacarpal_4")).setDEF(new SFString("hanim_r_carpometacarpal_4")).setCenter(new float[] {-8.032f ,30.5f ,-0.8853f }).setUlimit(new MFFloat841().getArray()).setLlimit(new MFFloat842().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setName(new SFString("r_metacarpophalangeal_4")).setDEF(new SFString("hanim_r_metacarpophalangeal_4")).setCenter(new float[] {-8.147f ,28.18f ,-0.9529f }).setUlimit(new MFFloat847().getArray()).setLlimit(new MFFloat848().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setName(new SFString("r_carpal_proximal_interphalangeal_4")).setDEF(new SFString("hanim_r_carpal_proximal_interphalangeal_4")).setCenter(new float[] {-8.059f ,26.959999f ,-0.9176f }).setUlimit(new MFFloat853().getArray()).setLlimit(new MFFloat854().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setName(new SFString("r_carpal_distal_interphalangeal_4")).setDEF(new SFString("hanim_r_carpal_distal_interphalangeal_4")).setCenter(new float[] {-8.013f ,25.809999f ,-0.879f }).setUlimit(new MFFloat859().getArray()).setLlimit(new MFFloat860().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setName(new SFString("r_carpometacarpal_5")).setDEF(new SFString("hanim_r_carpometacarpal_5")).setCenter(new float[] {-8.056f ,30.59f ,-1.457f }).setUlimit(new MFFloat865().getArray()).setLlimit(new MFFloat866().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setName(new SFString("r_metacarpophalangeal_5")).setDEF(new SFString("hanim_r_metacarpophalangeal_5")).setCenter(new float[] {-8.132f ,28.360001f ,-1.647f }).setUlimit(new MFFloat871().getArray()).setLlimit(new MFFloat872().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setName(new SFString("r_carpal_proximal_interphalangeal_5")).setDEF(new SFString("hanim_r_carpal_proximal_interphalangeal_5")).setCenter(new float[] {-8.058f ,27.6f ,-1.651f }).setUlimit(new MFFloat877().getArray()).setLlimit(new MFFloat878().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5").setName(new SFString("r_carpal_distal_interphalangeal_5")).setDEF(new SFString("hanim_r_carpal_distal_interphalangeal_5")).setCenter(new float[] {-8.02f ,26.77f ,-1.643f }).setUlimit(new MFFloat883().getArray()).setLlimit(new MFFloat884().getArray())

...
public class JinLOA4_1 {
  public static void main(String[] args) {
    ...
    X3D model = new JinLOA4_1().initialize();
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName("title").setContent("JinLOA4_1.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_JinLOA4").setVersion("2.0").setName("JinLOA4").setScale(new float[] {0.0225f,0.0225f,0.0225f}).setLoa(4)
          ...
          .addSkeleton(new HAnimJoint("hanim_JinLOA4").setDEF("hanim_humanoid_root").setName("humanoid_root").setCenter(new float[] {0f,36.71f,-0.7076f}).setLlimit(new MFFloat2().getArray()).setUlimit(new MFFloat3().getArray())
            .addChild(new HAnimSegment("hanim_humanoid_root").setDEF("hanim_sacrum").setName("sacrum")
              .addChild(new Transform().setTranslation(new float[] {0f,36.71f,-0.7076f})
                .addChild(new Shape()
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f,31.43f,-0.7076f}).setLlimit(new MFFloat9().getArray()).setUlimit(new MFFloat10().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_l_hip").setName("l_hip").setCenter(new float[] {4.207f,36.74f,-0.8155f}).setLlimit(new MFFloat15().getArray()).setUlimit(new MFFloat16().getArray())
                .addChild(new HAnimSegment("hanim_l_hip").setDEF("hanim_l_thigh").setName("l_thigh")
                  .addChild(new Transform().setTranslation(new float[] {4.207f,36.74f,-0.8155f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setDEF("hanim_l_knee").setName("l_knee").setCenter(new float[] {4.116f,18.17f,-0.8639f}).setLlimit(new MFFloat21().getArray()).setUlimit(new MFFloat22().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setDEF("hanim_l_talocrural").setName("l_talocrural").setCenter(new float[] {3.948f,4.242f,-0.4645f}).setLlimit(new MFFloat27().getArray()).setUlimit(new MFFloat28().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_talocalcaneonavicular").setName("l_talocalcaneonavicular").setCenter(new float[] {3.48f,1.64f,0.2162f}).setLlimit(new MFFloat33().getArray()).setUlimit(new MFFloat34().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_1").setName("l_cuneonavicular_1").setCenter(new float[] {2.994f,1.427f,0.8174f}).setLlimit(new MFFloat39().getArray()).setUlimit(new MFFloat40().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setDEF("hanim_l_tarsometatarsal_1").setName("l_tarsometatarsal_1").setCenter(new float[] {2.872f,1.033f,1.964f}).setLlimit(new MFFloat45().getArray()).setUlimit(new MFFloat46().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setDEF("hanim_l_metatarsophalangeal_1").setName("l_metatarsophalangeal_1").setCenter(new float[] {2.761f,0.6411f,4.161f}).setLlimit(new MFFloat51().getArray()).setUlimit(new MFFloat52().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_1").setName("l_tarsal_distal_interphalangeal_1").setCenter(new float[] {2.761f,0.5394f,5.125f}).setLlimit(new MFFloat57().getArray()).setUlimit(new MFFloat58().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_2").setName("l_cuneonavicular_2").setCenter(new float[] {3.619f,1.49f,0.9523f}).setLlimit(new MFFloat63().getArray()).setUlimit(new MFFloat64().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setDEF("hanim_l_tarsometatarsal_2").setName("l_tarsometatarsal_2").setCenter(new float[] {3.564f,1.16f,1.825f}).setLlimit(new MFFloat69().getArray()).setUlimit(new MFFloat70().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setDEF("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(new float[] {3.668f,0.6656f,4.348f}).setLlimit(new MFFloat75().getArray()).setUlimit(new MFFloat76().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_1").setName("l_tarsal_proximal_interphalangeal_2").setCenter(new float[] {3.747f,0.5621f,5.067f}).setLlimit(new MFFloat81().getArray()).setUlimit(new MFFloat82().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setCenter(new float[] {3.747f,0.4367f,5.486f}).setLlimit(new MFFloat87().getArray()).setUlimit(new MFFloat88().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_3").setName("l_cuneonavicular_3").setCenter(new float[] {4.132f,1.484f,0.8808f}).setLlimit(new MFFloat93().getArray()).setUlimit(new MFFloat94().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setDEF("hanim_l_tarsometatarsal_3").setName("l_tarsometatarsal_3").setCenter(new float[] {4.204f,1.16f,1.751f}).setLlimit(new MFFloat99().getArray()).setUlimit(new MFFloat100().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setDEF("hanim_l_metatarsophalangeal_3").setName("l_metatarsophalangeal_3").setCenter(new float[] {4.288f,0.6692f,4.241f}).setLlimit(new MFFloat105().getArray()).setUlimit(new MFFloat106().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_proximal_interphalangeal_3").setCenter(new float[] {4.394f,0.5299f,4.91f}).setLlimit(new MFFloat111().getArray()).setUlimit(new MFFloat112().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setCenter(new float[] {4.463f,0.4367f,5.32f}).setLlimit(new MFFloat117().getArray()).setUlimit(new MFFloat118().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_calcaneocuboid").setName("l_calcaneocuboid").setCenter(new float[] {3.96f,2.577f,-1.154f}).setLlimit(new MFFloat123().getArray()).setUlimit(new MFFloat124().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setDEF("hanim_l_transversetarsal").setName("l_transversetarsal").setCenter(new float[] {4.917f,1.568f,0.09285f}).setLlimit(new MFFloat129().getArray()).setUlimit(new MFFloat130().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_4").setName("l_tarsometatarsal_4").setCenter(new float[] {4.733f,1.091f,1.708f}).setLlimit(new MFFloat135().getArray()).setUlimit(new MFFloat136().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setDEF("hanim_l_metatarsophalangeal_4").setName("l_metatarsophalangeal_4").setCenter(new float[] {4.883f,0.6379f,4.052f}).setLlimit(new MFFloat141().getArray()).setUlimit(new MFFloat142().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_proximal_interphalangeal_4").setCenter(new float[] {5.074f,0.5442f,4.725f}).setLlimit(new MFFloat147().getArray()).setUlimit(new MFFloat148().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setCenter(new float[] {5.141f,0.4164f,5.053f}).setLlimit(new MFFloat153().getArray()).setUlimit(new MFFloat154().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_5").setName("l_tarsometatarsal_5").setCenter(new float[] {5.37f,0.9309f,1.544f}).setLlimit(new MFFloat159().getArray()).setUlimit(new MFFloat160().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setDEF("hanim_l_metatarsophalangeal_5").setName("l_metatarsophalangeal_5").setCenter(new float[] {5.514f,0.6076f,3.847f}).setLlimit(new MFFloat165().getArray()).setUlimit(new MFFloat166().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_proximal_interphalangeal_5").setCenter(new float[] {5.617f,0.4825f,4.184f}).setLlimit(new MFFloat171().getArray()).setUlimit(new MFFloat172().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setCenter(new float[] {5.657f,0.3806f,4.528f}).setLlimit(new MFFloat177().getArray()).setUlimit(new MFFloat178().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-4.207f,36.74f,-0.8155f}).setLlimit(new MFFloat183().getArray()).setUlimit(new MFFloat184().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-4.116f,18.17f,-0.8639f}).setLlimit(new MFFloat189().getArray()).setUlimit(new MFFloat190().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_talocrural").setName("r_talocrural").setCenter(new float[] {-3.931f,4.242f,-0.4645f}).setLlimit(new MFFloat195().getArray()).setUlimit(new MFFloat196().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_talocalcaneonavicular").setName("r_talocalcaneonavicular").setCenter(new float[] {-3.464f,1.64f,0.2162f}).setLlimit(new MFFloat201().getArray()).setUlimit(new MFFloat202().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_1").setName("r_cuneonavicular_1").setCenter(new float[] {-2.977f,1.427f,0.8174f}).setLlimit(new MFFloat207().getArray()).setUlimit(new MFFloat208().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_1").setDEF("hanim_r_tarsometatarsal_1").setName("r_tarsometatarsal_1").setCenter(new float[] {-2.856f,1.033f,1.964f}).setLlimit(new MFFloat213().getArray()).setUlimit(new MFFloat214().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_1").setDEF("hanim_r_metatarsophalangeal_1").setName("r_metatarsophalangeal_1").setCenter(new float[] {-2.745f,0.6411f,4.161f}).setLlimit(new MFFloat219().getArray()).setUlimit(new MFFloat220().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_1").setName("r_tarsal_distal_interphalangeal_1").setCenter(new float[] {-2.744f,0.5394f,5.125f}).setLlimit(new MFFloat225().getArray()).setUlimit(new MFFloat226().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_2").setName("r_cuneonavicular_2").setCenter(new float[] {-3.602f,1.49f,0.9523f}).setLlimit(new MFFloat231().getArray()).setUlimit(new MFFloat232().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_2").setDEF("hanim_r_tarsometatarsal_2").setName("r_tarsometatarsal_2").setCenter(new float[] {-3.548f,1.16f,1.825f}).setLlimit(new MFFloat237().getArray()).setUlimit(new MFFloat238().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setDEF("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(new float[] {-3.651f,0.6656f,4.348f}).setLlimit(new MFFloat243().getArray()).setUlimit(new MFFloat244().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_1").setName("r_tarsal_proximal_interphalangeal_2").setCenter(new float[] {-3.73f,0.5621f,5.067f}).setLlimit(new MFFloat249().getArray()).setUlimit(new MFFloat250().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setCenter(new float[] {-3.73f,0.4367f,5.486f}).setLlimit(new MFFloat255().getArray()).setUlimit(new MFFloat256().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_3").setName("r_cuneonavicular_3").setCenter(new float[] {-4.116f,1.484f,0.8808f}).setLlimit(new MFFloat261().getArray()).setUlimit(new MFFloat262().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_3").setDEF("hanim_r_tarsometatarsal_3").setName("r_tarsometatarsal_3").setCenter(new float[] {-4.188f,1.16f,1.751f}).setLlimit(new MFFloat267().getArray()).setUlimit(new MFFloat268().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_3").setDEF("hanim_r_metatarsophalangeal_3").setName("r_metatarsophalangeal_3").setCenter(new float[] {-4.271f,0.6692f,4.241f}).setLlimit(new MFFloat273().getArray()).setUlimit(new MFFloat274().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setName("r_tarsal_proximal_interphalangeal_3").setCenter(new float[] {-4.378f,0.5299f,4.91f}).setLlimit(new MFFloat279().getArray()).setUlimit(new MFFloat280().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setName("r_tarsal_distal_interphalangeal_3").setCenter(new float[] {-4.446f,0.4367f,5.32f}).setLlimit(new MFFloat285().getArray()).setUlimit(new MFFloat286().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_calcaneocuboid").setName("r_calcaneocuboid").setCenter(new float[] {-3.943f,2.577f,-1.154f}).setLlimit(new MFFloat291().getArray()).setUlimit(new MFFloat292().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_calcaneocuboid").setDEF("hanim_r_transversetarsal").setName("r_transversetarsal").setCenter(new float[] {-4.901f,1.568f,0.09285f}).setLlimit(new MFFloat297().getArray()).setUlimit(new MFFloat298().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setDEF("hanim_r_tarsometatarsal_4").setName("r_tarsometatarsal_4").setCenter(new float[] {-4.717f,1.091f,1.708f}).setLlimit(new MFFloat303().getArray()).setUlimit(new MFFloat304().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_4").setDEF("hanim_r_metatarsophalangeal_4").setName("r_metatarsophalangeal_4").setCenter(new float[] {-4.867f,0.6379f,4.052f}).setLlimit(new MFFloat309().getArray()).setUlimit(new MFFloat310().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setName("r_tarsal_proximal_interphalangeal_4").setCenter(new float[] {-5.057f,0.5442f,4.725f}).setLlimit(new MFFloat315().getArray()).setUlimit(new MFFloat316().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setName("r_tarsal_distal_interphalangeal_4").setCenter(new float[] {-5.125f,0.4164f,5.053f}).setLlimit(new MFFloat321().getArray()).setUlimit(new MFFloat322().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setDEF("hanim_r_tarsometatarsal_5").setName("r_tarsometatarsal_5").setCenter(new float[] {-5.353f,0.9309f,1.544f}).setLlimit(new MFFloat327().getArray()).setUlimit(new MFFloat328().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_5").setDEF("hanim_r_metatarsophalangeal_5").setName("r_metatarsophalangeal_5").setCenter(new float[] {-5.497f,0.6076f,3.847f}).setLlimit(new MFFloat333().getArray()).setUlimit(new MFFloat334().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setName("r_tarsal_proximal_interphalangeal_5").setCenter(new float[] {-5.6f,0.4825f,4.184f}).setLlimit(new MFFloat339().getArray()).setUlimit(new MFFloat340().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setName("r_tarsal_distal_interphalangeal_5").setCenter(new float[] {-5.641f,0.3806f,4.528f}).setLlimit(new MFFloat345().getArray()).setUlimit(new MFFloat346().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_vl5").setName("vl5").setCenter(new float[] {0f,41.13f,-0.6117f}).setLlimit(new MFFloat351().getArray()).setUlimit(new MFFloat352().getArray())
                .addChild(new HAnimSegment("hanim_vl5").setDEF("hanim_l5").setName("l5")
                  .addChild(new Transform().setTranslation(new float[] {0f,41.13f,-0.6117f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_vl4").setName("vl4").setCenter(new float[] {0f,42.21f,-0.6117f}).setLlimit(new MFFloat357().getArray()).setUlimit(new MFFloat358().getArray())
                  .addChild(new HAnimSegment("hanim_vl4").setDEF("hanim_l4").setName("l4")
                    .addChild(new Transform().setTranslation(new float[] {0f,42.21f,-0.6117f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                  ...
                  .addChild(new HAnimJoint("hanim_vl4").setDEF("hanim_vl3").setName("vl3").setCenter(new float[] {0f,42.93f,-0.6117f}).setLlimit(new MFFloat363().getArray()).setUlimit(new MFFloat364().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_vl3").setDEF("hanim_vl2").setName("vl2").setCenter(new float[] {0f,43.66f,-0.6117f}).setLlimit(new MFFloat369().getArray()).setUlimit(new MFFloat370().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_vl2").setDEF("hanim_vl1").setName("vl1").setCenter(new float[] {0f,44.43f,-0.6117f}).setLlimit(new MFFloat375().getArray()).setUlimit(new MFFloat376().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_vl1").setDEF("hanim_vt12").setName("vt12").setCenter(new float[] {0f,45.47f,-0.6117f}).setLlimit(new MFFloat381().getArray()).setUlimit(new MFFloat382().getArray())
                          .addChild(new HAnimSegment("hanim_vt12").setDEF("hanim_t12").setName("t12")
                            .addChild(new Transform().setTranslation(new float[] {0f,45.47f,-0.6117f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_vt12").setDEF("hanim_vt11").setName("vt11").setCenter(new float[] {0f,46.52f,-0.6117f}).setLlimit(new MFFloat387().getArray()).setUlimit(new MFFloat388().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_vt11").setDEF("hanim_vt10").setName("vt10").setCenter(new float[] {0f,47.28f,-0.6127f}).setLlimit(new MFFloat393().getArray()).setUlimit(new MFFloat394().getArray())
                              .addChild(new HAnimSegment("hanim_vt10").setDEF("hanim_t10").setName("t10")
                                .addChild(new Transform().setTranslation(new float[] {0f,47.28f,-0.6127f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_vt10").setDEF("hanim_vt9").setName("vt9").setCenter(new float[] {0f,47.93f,-0.6117f}).setLlimit(new MFFloat399().getArray()).setUlimit(new MFFloat400().getArray())
                                ...
                                .addChild(new HAnimJoint("hanim_vt9").setDEF("hanim_vt8").setName("vt8").setCenter(new float[] {0f,48.58f,-0.6117f}).setLlimit(new MFFloat405().getArray()).setUlimit(new MFFloat406().getArray())
                                  .addChild(new HAnimSegment("hanim_vt8").setDEF("hanim_t8").setName("t8")
                                    .addChild(new Transform().setTranslation(new float[] {0f,48.58f,-0.6117f})
                                      .addChild(new Shape()
                                        .setAppearance(new Appearance()
                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt8").setDEF("hanim_vt7").setName("vt7").setCenter(new float[] {0f,49.28f,-0.6117f}).setLlimit(new MFFloat411().getArray()).setUlimit(new MFFloat412().getArray())
                                    .addChild(new HAnimSegment("hanim_vt7").setDEF("hanim_t7").setName("t7")
                                      .addChild(new Transform().setTranslation(new float[] {0f,49.28f,-0.6117f})
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt7").setDEF("hanim_vt6").setName("vt6").setCenter(new float[] {0f,49.85f,-0.6117f}).setLlimit(new MFFloat417().getArray()).setUlimit(new MFFloat418().getArray())
                                      .addChild(new HAnimSegment("hanim_vt6").setDEF("hanim_t6").setName("t6")
                                        .addChild(new Transform().setTranslation(new float[] {0f,49.85f,-0.6117f})
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt6").setDEF("hanim_vt5").setName("vt5").setCenter(new float[] {0f,50.54f,-0.6117f}).setLlimit(new MFFloat423().getArray()).setUlimit(new MFFloat424().getArray())
                                        .addChild(new HAnimSegment("hanim_vt5").setDEF("hanim_t5").setName("t5")
                                          .addChild(new Transform().setTranslation(new float[] {0f,50.54f,-0.6117f})
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt5").setDEF("hanim_vt4").setName("vt4").setCenter(new float[] {0f,51.22f,-0.6117f}).setLlimit(new MFFloat429().getArray()).setUlimit(new MFFloat430().getArray())
                                          .addChild(new HAnimSegment("hanim_vt4").setDEF("hanim_t4").setName("t4")
                                            .addChild(new Transform().setTranslation(new float[] {0f,51.22f,-0.6117f})
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setDEF("hanim_vt3").setName("vt3").setCenter(new float[] {0f,52.04f,-0.6117f}).setLlimit(new MFFloat435().getArray()).setUlimit(new MFFloat436().getArray())
                                            .addChild(new HAnimSegment("hanim_vt3").setDEF("hanim_t3").setName("t3")
                                              .addChild(new Transform().setTranslation(new float[] {0f,52.04f,-0.6117f})
                                                .addChild(new Shape()
                                                  .setAppearance(new Appearance()
                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setDEF("hanim_vt2").setName("vt2").setCenter(new float[] {0f,53.14f,-0.6127f}).setLlimit(new MFFloat441().getArray()).setUlimit(new MFFloat442().getArray())
                                              .addChild(new HAnimSegment("hanim_vt2").setDEF("hanim_t2").setName("t2")
                                                .addChild(new Transform().setTranslation(new float[] {0f,53.14f,-0.6127f})
                                                  .addChild(new Shape()
                                                    .setAppearance(new Appearance()
                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setDEF("hanim_vt1").setName("vt1").setCenter(new float[] {0f,54.2f,-0.6117f}).setLlimit(new MFFloat447().getArray()).setUlimit(new MFFloat448().getArray())
                                                .addChild(new HAnimSegment("hanim_vt1").setDEF("hanim_t1").setName("t1")
                                                  .addChild(new Transform().setTranslation(new float[] {0f,54.2f,-0.6117f})
                                                    .addChild(new Shape()
                                                      .setAppearance(new Appearance()
                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_vc7").setName("vc7").setCenter(new float[] {0f,55.35f,-0.6695f}).setLlimit(new MFFloat453().getArray()).setUlimit(new MFFloat454().getArray())
                                                  .addChild(new HAnimSegment("hanim_vc7").setDEF("hanim_c7").setName("c7")
                                                    .addChild(new Transform().setTranslation(new float[] {0f,55.35f,-0.6695f})
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc7").setDEF("hanim_vc6").setName("vc6").setCenter(new float[] {0f,55.89f,-0.6695f}).setLlimit(new MFFloat459().getArray()).setUlimit(new MFFloat460().getArray())
                                                    .addChild(new HAnimSegment("hanim_vc6").setDEF("hanim_c6").setName("c6")
                                                      .addChild(new Transform().setTranslation(new float[] {0f,55.89f,-0.6695f})
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc6").setDEF("hanim_vc5").setName("vc5").setCenter(new float[] {0f,56.44f,-0.6695f}).setLlimit(new MFFloat465().getArray()).setUlimit(new MFFloat466().getArray())
                                                      .addChild(new HAnimSegment("hanim_vc5").setDEF("hanim_c5").setName("c5")
                                                        .addChild(new Transform().setTranslation(new float[] {0f,56.44f,-0.6695f})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc5").setDEF("hanim_vc4").setName("vc4").setCenter(new float[] {0f,56.99f,-0.6695f}).setLlimit(new MFFloat471().getArray()).setUlimit(new MFFloat472().getArray())
                                                        .addChild(new HAnimSegment("hanim_vc4").setDEF("hanim_c4").setName("c4")
                                                          .addChild(new Transform().setTranslation(new float[] {0f,56.99f,-0.6695f})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_vc4").setDEF("hanim_vc3").setName("vc3").setCenter(new float[] {0f,57.56f,-0.6695f}).setLlimit(new MFFloat477().getArray()).setUlimit(new MFFloat478().getArray())
                                                          .addChild(new HAnimSegment("hanim_vc3").setDEF("hanim_c3").setName("c3")
                                                            .addChild(new Transform().setTranslation(new float[] {0f,57.56f,-0.6695f})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_vc3").setDEF("hanim_vc2").setName("vc2").setCenter(new float[] {0f,58.08f,-0.6695f}).setLlimit(new MFFloat483().getArray()).setUlimit(new MFFloat484().getArray())
                                                            .addChild(new HAnimSegment("hanim_vc2").setDEF("hanim_c2").setName("c2")
                                                              .addChild(new Transform().setTranslation(new float[] {0f,58.08f,-0.6695f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_vc2").setDEF("hanim_vc1").setName("vc1").setCenter(new float[] {0f,58.6f,-0.6695f}).setLlimit(new MFFloat489().getArray()).setUlimit(new MFFloat490().getArray())
                                                              .addChild(new HAnimSegment("hanim_vc1").setDEF("hanim_c1").setName("c1")
                                                                .addChild(new Transform().setTranslation(new float[] {0f,58.6f,-0.6695f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_vc1").setDEF("hanim_skullbase").setName("skullbase").setCenter(new float[] {0f,58.34f,-0.6863f}).setLlimit(new MFFloat495().getArray()).setUlimit(new MFFloat496().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyelid_joint").setName("l_eyelid_joint").setCenter(new float[] {2.245f,63.3f,1.464f}).setLlimit(new MFFloat507().getArray()).setUlimit(new MFFloat508().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_eyelid_joint").setDEF("hanim_l_eyelid").setName("l_eyelid")
                                                                    .addChild(new Transform().setTranslation(new float[] {2.245f,63.3f,1.464f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyelid_joint").setName("r_eyelid_joint").setCenter(new float[] {-2.245f,63.3f,1.464f}).setLlimit(new MFFloat513().getArray()).setUlimit(new MFFloat514().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyeball_joint").setName("l_eyeball_joint").setCenter(new float[] {2.139f,62.44f,3.691f}).setLlimit(new MFFloat519().getArray()).setUlimit(new MFFloat520().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_eyeball_joint").setDEF("hanim_l_eyeball").setName("l_eyeball")
                                                                    .addChild(new Transform().setTranslation(new float[] {2.139f,62.44f,3.691f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyeball_joint").setName("r_eyeball_joint").setCenter(new float[] {-2.139f,62.44f,3.691f}).setLlimit(new MFFloat525().getArray()).setUlimit(new MFFloat526().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyebrow_joint").setName("l_eyebrow_joint").setCenter(new float[] {0.9666f,62.84f,4.753f}).setLlimit(new MFFloat531().getArray()).setUlimit(new MFFloat532().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyebrow_joint").setName("r_eyebrow_joint").setCenter(new float[] {-0.9666f,62.84f,4.753f}).setLlimit(new MFFloat537().getArray()).setUlimit(new MFFloat538().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_temporomandibular").setName("temporomandibular").setCenter(new float[] {0f,58.35f,0.6835f}).setLlimit(new MFFloat543().getArray()).setUlimit(new MFFloat544().getArray())
                                                                  .addChild(new HAnimSegment("hanim_temporomandibular").setDEF("hanim_jaw").setName("jaw")
                                                                    .addChild(new Transform().setTranslation(new float[] {0f,58.35f,0.6835f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(new float[] {1.71f,53.72f,-0.6127f}).setLlimit(new MFFloat549().getArray()).setUlimit(new MFFloat550().getArray())
                                                  .addChild(new HAnimSegment("hanim_l_acromioclavicular").setDEF("hanim_l_clavicle").setName("l_clavicle")
                                                    .addChild(new Transform().setTranslation(new float[] {1.71f,53.72f,-0.6127f})
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_acromioclavicular").setDEF("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(new float[] {5.464f,52.97f,-0.5732f}).setLlimit(new MFFloat555().getArray()).setUlimit(new MFFloat556().getArray())
                                                    .addChild(new HAnimSegment("hanim_l_sternoclavicular").setDEF("hanim_l_scapula").setName("l_scapula")
                                                      .addChild(new Transform().setTranslation(new float[] {5.464f,52.97f,-0.5732f})
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_sternoclavicular").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {7.336f,52.38f,-0.1452f}).setLlimit(new MFFloat561().getArray()).setUlimit(new MFFloat562().getArray())
                                                      .addChild(new HAnimSegment("hanim_l_shoulder").setDEF("hanim_l_upperarm").setName("l_upperarm")
                                                        .addChild(new Transform().setTranslation(new float[] {7.336f,52.38f,-0.1452f})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_l_shoulder").setDEF("hanim_l_elbow").setName("l_elbow").setCenter(new float[] {8.093f,41.28f,-0.2502f}).setLlimit(new MFFloat567().getArray()).setUlimit(new MFFloat568().getArray())
                                                        .addChild(new HAnimSegment("hanim_l_elbow").setDEF("hanim_l_forearm").setName("l_forearm")
                                                          .addChild(new Transform().setTranslation(new float[] {8.093f,41.28f,-0.2502f})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_elbow").setDEF("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(new float[] {8.086f,32.19f,-0.2233f}).setLlimit(new MFFloat573().getArray()).setUlimit(new MFFloat574().getArray())
                                                          .addChild(new HAnimSegment("hanim_l_radiocarpal").setDEF("hanim_l_carpal").setName("l_carpal")
                                                            .addChild(new Transform().setTranslation(new float[] {8.086f,32.19f,-0.2233f})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_1").setName("l_midcarpal_1").setCenter(new float[] {8.057f,31.38f,0.859f}).setLlimit(new MFFloat579().getArray()).setUlimit(new MFFloat580().getArray())
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_1").setDEF("hanim_l_trapezium").setName("l_trapezium")
                                                              .addChild(new Transform().setTranslation(new float[] {8.057f,31.38f,0.859f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_1").setDEF("hanim_l_carpometacarpal_1").setName("l_carpometacarpal_1").setCenter(new float[] {8.022f,30.78f,1.155f}).setLlimit(new MFFloat585().getArray()).setUlimit(new MFFloat586().getArray())
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_1").setDEF("hanim_l_metacarpal_1").setName("l_metacarpal_1")
                                                                .addChild(new Transform().setTranslation(new float[] {8.022f,30.78f,1.155f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setDEF("hanim_l_metacarpophalangeal_1").setName("l_metacarpophalangeal_1").setCenter(new float[] {8.046f,29.9f,1.59f}).setLlimit(new MFFloat591().getArray()).setUlimit(new MFFloat592().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setName("l_carpal_interphalangeal_1").setCenter(new float[] {8.118f,29.07f,2.207f}).setLlimit(new MFFloat597().getArray()).setUlimit(new MFFloat598().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_2").setName("l_midcarpal_2").setCenter(new float[] {8.057f,31.42f,0.3741f}).setLlimit(new MFFloat603().getArray()).setUlimit(new MFFloat604().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_2").setDEF("hanim_l_carpometacarpal_2").setName("l_carpometacarpal_2").setCenter(new float[] {8.057f,30.56f,0.4324f}).setLlimit(new MFFloat609().getArray()).setUlimit(new MFFloat610().getArray())
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_2").setDEF("hanim_l_metacarpal_2").setName("l_metacarpal_2")
                                                                .addChild(new Transform().setTranslation(new float[] {8.057f,30.56f,0.4324f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setDEF("hanim_l_metacarpophalangeal_2").setName("l_metacarpophalangeal_2").setCenter(new float[] {8.166f,28.32f,0.67f}).setLlimit(new MFFloat615().getArray()).setUlimit(new MFFloat616().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_1").setName("l_carpal_proximal_interphalangeal_2").setCenter(new float[] {8.076f,26.97f,0.6304f}).setLlimit(new MFFloat621().getArray()).setUlimit(new MFFloat622().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_1").setDEF("hanim_l_carpal_middle_phalanx_1").setName("l_carpal_middle_phalanx_2")
                                                                    .addChild(new Transform().setTranslation(new float[] {8.076f,26.97f,0.6304f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_1").setDEF("hanim_l_carpal_distal_interphalangeal_1").setName("l_carpal_distal_interphalangeal_2").setCenter(new float[] {8.03f,25.85f,0.5949f}).setLlimit(new MFFloat627().getArray()).setUlimit(new MFFloat628().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_3").setName("l_midcarpal_3").setCenter(new float[] {8.048f,31.49f,-0.2132f}).setLlimit(new MFFloat633().getArray()).setUlimit(new MFFloat634().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_3").setDEF("hanim_l_carpometacarpal_3").setName("l_carpometacarpal_3").setCenter(new float[] {8.048f,30.48f,-0.2779f}).setLlimit(new MFFloat639().getArray()).setUlimit(new MFFloat640().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setDEF("hanim_l_metacarpophalangeal_3").setName("l_metacarpophalangeal_3").setCenter(new float[] {8.164f,28.22f,-0.1741f}).setLlimit(new MFFloat645().getArray()).setUlimit(new MFFloat646().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_3").setDEF("hanim_l_carpal_proximal_phalanx_3").setName("l_carpal_proximal_phalanx_3")
                                                                  .addChild(new Transform().setTranslation(new float[] {8.164f,28.22f,-0.1741f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_proximal_interphalangeal_3").setCenter(new float[] {8.076f,26.81f,-0.1572f}).setLlimit(new MFFloat651().getArray()).setUlimit(new MFFloat652().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_middle_phalanx_2").setName("l_carpal_middle_phalanx_3")
                                                                    .addChild(new Transform().setTranslation(new float[] {8.076f,26.81f,-0.1572f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_3").setCenter(new float[] {8.03f,25.57f,-0.1671f}).setLlimit(new MFFloat657().getArray()).setUlimit(new MFFloat658().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_4_1").setName("l_midcarpal_4_5").setCenter(new float[] {8.048f,31.37f,-1.144f}).setLlimit(new MFFloat663().getArray()).setUlimit(new MFFloat664().getArray())
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_4_1").setDEF("hanim_l_hamate").setName("l_hamate")
                                                              .addChild(new Transform().setTranslation(new float[] {8.048f,31.37f,-1.144f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_4_1").setDEF("hanim_l_carpometacarpal_4").setName("l_carpometacarpal_4").setCenter(new float[] {8.048f,30.5f,-0.8853f}).setLlimit(new MFFloat669().getArray()).setUlimit(new MFFloat670().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setDEF("hanim_l_metacarpophalangeal_4").setName("l_metacarpophalangeal_4").setCenter(new float[] {8.164f,28.18f,-0.9529f}).setLlimit(new MFFloat675().getArray()).setUlimit(new MFFloat676().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_proximal_interphalangeal_4").setCenter(new float[] {8.076f,26.96f,-0.9176f}).setLlimit(new MFFloat681().getArray()).setUlimit(new MFFloat682().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_middle_phalanx_3").setName("l_carpal_middle_phalanx_4")
                                                                    .addChild(new Transform().setTranslation(new float[] {8.076f,26.96f,-0.9176f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_4").setCenter(new float[] {8.03f,25.81f,-0.879f}).setLlimit(new MFFloat687().getArray()).setUlimit(new MFFloat688().getArray())
                                                                    .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_3").setDEF("hanim_l_carpal_distal_phalanx_4").setName("l_carpal_distal_phalanx_4")
                                                                      .addChild(new Transform().setTranslation(new float[] {8.03f,25.81f,-0.879f})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_carpometacarpal_5").setName("l_carpometacarpal_5").setCenter(new float[] {8.073f,30.59f,-1.457f}).setLlimit(new MFFloat693().getArray()).setUlimit(new MFFloat694().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setDEF("hanim_l_metacarpophalangeal_5").setName("l_metacarpophalangeal_5").setCenter(new float[] {8.148f,28.36f,-1.647f}).setLlimit(new MFFloat699().getArray()).setUlimit(new MFFloat700().getArray())
                                                              .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_5").setDEF("hanim_l_carpal_proximal_phalanx_5").setName("l_carpal_proximal_phalanx_5")
                                                                .addChild(new Transform().setTranslation(new float[] {8.148f,28.36f,-1.647f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_proximal_interphalangeal_5").setCenter(new float[] {8.074f,27.6f,-1.651f}).setLlimit(new MFFloat705().getArray()).setUlimit(new MFFloat706().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_5").setCenter(new float[] {8.036f,26.77f,-1.643f}).setLlimit(new MFFloat711().getArray()).setUlimit(new MFFloat712().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-1.71f,53.72f,-0.6127f}).setLlimit(new MFFloat717().getArray()).setUlimit(new MFFloat718().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_acromioclavicular").setDEF("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-5.464f,52.97f,-0.5732f}).setLlimit(new MFFloat723().getArray()).setUlimit(new MFFloat724().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_sternoclavicular").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-7.32f,52.38f,-0.1452f}).setLlimit(new MFFloat729().getArray()).setUlimit(new MFFloat730().getArray())
                                                      .addChild(new HAnimSegment("hanim_r_shoulder").setDEF("hanim_r_upperarm").setName("r_upperarm")
                                                        .addChild(new Transform().setTranslation(new float[] {-7.32f,52.38f,-0.1452f})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_shoulder").setDEF("hanim_r_elbow").setName("r_elbow").setCenter(new float[] {-8.077f,41.28f,-0.2502f}).setLlimit(new MFFloat735().getArray()).setUlimit(new MFFloat736().getArray())
                                                        .addChild(new HAnimSegment("hanim_r_elbow").setDEF("hanim_r_forearm").setName("r_forearm")
                                                          .addChild(new Transform().setTranslation(new float[] {-8.077f,41.28f,-0.2502f})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_elbow").setDEF("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(new float[] {-8.07f,32.19f,-0.2232f}).setLlimit(new MFFloat741().getArray()).setUlimit(new MFFloat742().getArray())
                                                          .addChild(new HAnimSegment("hanim_r_radiocarpal").setDEF("hanim_r_carpal").setName("r_carpal")
                                                            .addChild(new Transform().setTranslation(new float[] {-8.07f,32.19f,-0.2232f})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_1").setName("r_midcarpal_1").setCenter(new float[] {-8.043f,31.38f,0.859f}).setLlimit(new MFFloat747().getArray()).setUlimit(new MFFloat748().getArray())
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_1").setDEF("hanim_r_trapezium").setName("r_trapezium")
                                                              .addChild(new Transform().setTranslation(new float[] {-8.043f,31.38f,0.859f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_1").setDEF("hanim_r_carpometacarpal_1").setName("r_carpometacarpal_1").setCenter(new float[] {-8.006f,30.78f,1.155f}).setLlimit(new MFFloat753().getArray()).setUlimit(new MFFloat754().getArray())
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_1").setDEF("hanim_r_metacarpal_1").setName("r_metacarpal_1")
                                                                .addChild(new Transform().setTranslation(new float[] {-8.006f,30.78f,1.155f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setDEF("hanim_r_metacarpophalangeal_1").setName("r_metacarpophalangeal_1").setCenter(new float[] {-8.029f,29.9f,1.59f}).setLlimit(new MFFloat759().getArray()).setUlimit(new MFFloat760().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setName("r_carpal_interphalangeal_1").setCenter(new float[] {-8.101f,29.07f,2.207f}).setLlimit(new MFFloat765().getArray()).setUlimit(new MFFloat766().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_2").setName("r_midcarpal_2").setCenter(new float[] {-8.043f,31.42f,0.3741f}).setLlimit(new MFFloat771().getArray()).setUlimit(new MFFloat772().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_2").setDEF("hanim_r_carpometacarpal_2").setName("r_carpometacarpal_2").setCenter(new float[] {-8.04f,30.56f,0.4324f}).setLlimit(new MFFloat777().getArray()).setUlimit(new MFFloat778().getArray())
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_2").setDEF("hanim_r_metacarpal_2").setName("r_metacarpal_2")
                                                                .addChild(new Transform().setTranslation(new float[] {-8.04f,30.56f,0.4324f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setDEF("hanim_r_metacarpophalangeal_2").setName("r_metacarpophalangeal_2").setCenter(new float[] {-8.149f,28.32f,0.67f}).setLlimit(new MFFloat783().getArray()).setUlimit(new MFFloat784().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_1").setName("r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-8.059f,26.97f,0.6304f}).setLlimit(new MFFloat789().getArray()).setUlimit(new MFFloat790().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_1").setDEF("hanim_r_carpal_middle_phalanx_1").setName("r_carpal_middle_phalanx_2")
                                                                    .addChild(new Transform().setTranslation(new float[] {-8.059f,26.97f,0.6304f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_1").setDEF("hanim_r_carpal_distal_interphalangeal_1").setName("r_carpal_distal_interphalangeal_2").setCenter(new float[] {-8.013f,25.85f,0.5949f}).setLlimit(new MFFloat795().getArray()).setUlimit(new MFFloat796().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_3").setName("r_midcarpal_3").setCenter(new float[] {-8.032f,31.49f,-0.2132f}).setLlimit(new MFFloat801().getArray()).setUlimit(new MFFloat802().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_3").setDEF("hanim_r_carpometacarpal_3").setName("r_carpometacarpal_3").setCenter(new float[] {-8.032f,30.48f,-0.2779f}).setLlimit(new MFFloat807().getArray()).setUlimit(new MFFloat808().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setDEF("hanim_r_metacarpophalangeal_3").setName("r_metacarpophalangeal_3").setCenter(new float[] {-8.147f,28.22f,-0.1741f}).setLlimit(new MFFloat813().getArray()).setUlimit(new MFFloat814().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_3").setDEF("hanim_r_carpal_proximal_phalanx_3").setName("r_carpal_proximal_phalanx_3")
                                                                  .addChild(new Transform().setTranslation(new float[] {-8.147f,28.22f,-0.1741f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-8.059f,26.81f,-0.1572f}).setLlimit(new MFFloat819().getArray()).setUlimit(new MFFloat820().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_middle_phalanx_2").setName("r_carpal_middle_phalanx_3")
                                                                    .addChild(new Transform().setTranslation(new float[] {-8.059f,26.81f,-0.1572f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_3").setCenter(new float[] {-8.013f,25.57f,-0.1671f}).setLlimit(new MFFloat825().getArray()).setUlimit(new MFFloat826().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_4_1").setName("r_midcarpal_4_5").setCenter(new float[] {-8.032f,31.37f,-1.144f}).setLlimit(new MFFloat831().getArray()).setUlimit(new MFFloat832().getArray())
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_4_1").setDEF("hanim_r_hamate").setName("r_hamate")
                                                              .addChild(new Transform().setTranslation(new float[] {-8.032f,31.37f,-1.144f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_4_1").setDEF("hanim_r_carpometacarpal_4").setName("r_carpometacarpal_4").setCenter(new float[] {-8.032f,30.5f,-0.8853f}).setLlimit(new MFFloat837().getArray()).setUlimit(new MFFloat838().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setDEF("hanim_r_metacarpophalangeal_4").setName("r_metacarpophalangeal_4").setCenter(new float[] {-8.147f,28.18f,-0.9529f}).setLlimit(new MFFloat843().getArray()).setUlimit(new MFFloat844().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_proximal_interphalangeal_4").setCenter(new float[] {-8.059f,26.96f,-0.9176f}).setLlimit(new MFFloat849().getArray()).setUlimit(new MFFloat850().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_middle_phalanx_3").setName("r_carpal_middle_phalanx_4")
                                                                    .addChild(new Transform().setTranslation(new float[] {-8.059f,26.96f,-0.9176f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_4").setCenter(new float[] {-8.013f,25.81f,-0.879f}).setLlimit(new MFFloat855().getArray()).setUlimit(new MFFloat856().getArray())
                                                                    .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_phalanx_4").setName("r_carpal_distal_phalanx_4")
                                                                      .addChild(new Transform().setTranslation(new float[] {-8.013f,25.81f,-0.879f})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_carpometacarpal_5").setName("r_carpometacarpal_5").setCenter(new float[] {-8.056f,30.59f,-1.457f}).setLlimit(new MFFloat861().getArray()).setUlimit(new MFFloat862().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setDEF("hanim_r_metacarpophalangeal_5").setName("r_metacarpophalangeal_5").setCenter(new float[] {-8.132f,28.36f,-1.647f}).setLlimit(new MFFloat867().getArray()).setUlimit(new MFFloat868().getArray())
                                                              .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_5").setDEF("hanim_r_carpal_proximal_phalanx_5").setName("r_carpal_proximal_phalanx_5")
                                                                .addChild(new Transform().setTranslation(new float[] {-8.132f,28.36f,-1.647f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_proximal_interphalangeal_5").setCenter(new float[] {-8.058f,27.6f,-1.651f}).setLlimit(new MFFloat873().getArray()).setUlimit(new MFFloat874().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_5").setCenter(new float[] {-8.02f,26.77f,-1.643f}).setLlimit(new MFFloat879().getArray()).setUlimit(new MFFloat880().getArray())

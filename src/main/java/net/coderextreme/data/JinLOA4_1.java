  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("Sat, 30 Dec 2023 07:47:21 GMT"))
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setDEF("hanim_vt3").setName("vt3").setCenter(new float[] {0f,52.04f,-0.6117f})
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setDEF("hanim_vt2").setName("vt2").setCenter(new float[] {0f,53.14f,-0.6127f})
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setDEF("hanim_vt1").setName("vt1").setCenter(new float[] {0f,54.2f,-0.6117f})
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(new float[] {1.71f,53.72f,-0.6127f})
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_acromioclavicular").setDEF("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(new float[] {5.464f,52.97f,-0.5732f})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_sternoclavicular").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {7.336f,52.38f,-0.1452f})
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-1.71f,53.72f,-0.6127f})
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_acromioclavicular").setDEF("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-5.464f,52.97f,-0.5732f})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_sternoclavicular").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-7.32f,52.38f,-0.1452f})

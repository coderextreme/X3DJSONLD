  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setPosition(new float[] {0f ,0f ,12f }).setDescription("Tour Views"))
          ...
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setLanguage("GLSL")
                .addField(new field().setType("SFVec3f").setName("chromaticDispertion").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue("0.980000019073486 1 1.03299999237061"))
                ...
                .addParts(new ShaderPart().setType("FRAGMENT").setDEF("commonfs").setUrl(new MFString14().getArray())))))));
    return X3D0;
    }

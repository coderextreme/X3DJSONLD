...
public class JinOriginalLOA4 implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new JinOriginalLOA4().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/JinOriginalLOA4.new.java.x3d");
    model.toFileJSON("../data/JinOriginalLOA4.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("title").setContent("JinOriginalLOA4.x3d"))
        ...
        .addMeta(new meta().setName("modified").setContent("Mon, 15 Sep 2025 05:20:34 GMT"))
        ...
        .addMeta(new meta().setName("reference").setContent("JinLOA4.x3d"))
        ...
        .addMeta(new meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA4.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_JinLOA4").setName("JinLOA4").setLoa(4).setScale(new float[] {0.0225f ,0.0225f ,0.0225f })
          ...
          .addSkeleton(new HAnimJoint("hanim_JinLOA4").setDEF("hanim_humanoid_root").setName("humanoid_root").setCenter(new float[] {0f ,36.71f ,-0.7076f })
              ...
              .addChild(new Transform().setTranslation(new float[] {0f ,36.71f ,-0.7076f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("JinLOA4TextureAtlas").setUrl(new MFString2().getArray())))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f ,31.43f ,-0.7076f })
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_l_hip").setName("l_hip").setCenter(new float[] {4.207f ,36.74f ,-0.8155f })
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setDEF("hanim_l_knee").setName("l_knee").setCenter(new float[] {4.116f ,18.17f ,-0.8639f })
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setDEF("hanim_l_talocrural").setName("l_talocrural").setCenter(new float[] {3.948f ,4.242f ,-0.4645f })
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_talocalcaneonavicular").setName("l_talocalcaneonavicular").setCenter(new float[] {3.48f ,1.64f ,0.2162f })
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_1").setName("l_cuneonavicular_1").setCenter(new float[] {2.994f ,1.427f ,0.8174f })
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setDEF("hanim_l_tarsometatarsal_1").setName("l_tarsometatarsal_1").setCenter(new float[] {2.872f ,1.033f ,1.964f })
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setDEF("hanim_l_metatarsophalangeal_1").setName("l_metatarsophalangeal_1").setCenter(new float[] {2.761f ,0.6411f ,4.161f })
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_1").setName("l_tarsal_distal_interphalangeal_1").setCenter(new float[] {2.761f ,0.5394f ,5.125f })
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_2").setName("l_cuneonavicular_2").setCenter(new float[] {3.619f ,1.49f ,0.9523f })
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setDEF("hanim_l_tarsometatarsal_2").setName("l_tarsometatarsal_2").setCenter(new float[] {3.564f ,1.16f ,1.825f })
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setDEF("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(new float[] {3.668f ,0.6656f ,4.348f })
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_proximal_interphalangeal_2").setCenter(new float[] {3.747f ,0.5621f ,5.067f })
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setCenter(new float[] {3.747f ,0.4367f ,5.486f })
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_3").setName("l_cuneonavicular_3").setCenter(new float[] {4.132f ,1.484f ,0.8808f })
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setDEF("hanim_l_tarsometatarsal_3").setName("l_tarsometatarsal_3").setCenter(new float[] {4.204f ,1.16f ,1.751f })
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setDEF("hanim_l_metatarsophalangeal_3").setName("l_metatarsophalangeal_3").setCenter(new float[] {4.288f ,0.6692f ,4.241f })
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_proximal_interphalangeal_3").setCenter(new float[] {4.394f ,0.5299f ,4.91f })
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setCenter(new float[] {4.463f ,0.4367f ,5.32f })
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_calcaneocuboid").setName("l_calcaneocuboid").setCenter(new float[] {3.96f ,2.577f ,-1.154f })
                      ...
                      .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setDEF("hanim_l_transversetarsal").setName("l_transversetarsal").setCenter(new float[] {4.917f ,1.568f ,0.09285f })
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_4").setName("l_tarsometatarsal_4").setCenter(new float[] {4.733f ,1.091f ,1.708f })
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setDEF("hanim_l_metatarsophalangeal_4").setName("l_metatarsophalangeal_4").setCenter(new float[] {4.883f ,0.6379f ,4.052f })
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_proximal_interphalangeal_4").setCenter(new float[] {5.074f ,0.5442f ,4.725f })
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setCenter(new float[] {5.141f ,0.4164f ,5.053f })
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_5").setName("l_tarsometatarsal_5").setCenter(new float[] {5.37f ,0.9309f ,1.544f })
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setDEF("hanim_l_metatarsophalangeal_5").setName("l_metatarsophalangeal_5").setCenter(new float[] {5.514f ,0.6076f ,3.847f })
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_proximal_interphalangeal_5").setCenter(new float[] {5.617f ,0.4825f ,4.184f })
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setCenter(new float[] {5.657f ,0.3806f ,4.528f })
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-4.207f ,36.74f ,-0.8155f })
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-4.116f ,18.17f ,-0.8639f })
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_talocrural").setName("r_talocrural").setCenter(new float[] {-3.931f ,4.242f ,-0.4645f })
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_talocalcaneonavicular").setName("r_talocalcaneonavicular").setCenter(new float[] {-3.464f ,1.64f ,0.2162f })
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_1").setName("r_cuneonavicular_1").setCenter(new float[] {-2.977f ,1.427f ,0.8174f })
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_1").setDEF("hanim_r_tarsometatarsal_1").setName("r_tarsometatarsal_1").setCenter(new float[] {-2.856f ,1.033f ,1.964f })
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_1").setDEF("hanim_r_metatarsophalangeal_1").setName("r_metatarsophalangeal_1").setCenter(new float[] {-2.745f ,0.6411f ,4.161f })
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_1").setName("r_tarsal_distal_interphalangeal_1").setCenter(new float[] {-2.744f ,0.5394f ,5.125f })
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_2").setName("r_cuneonavicular_2").setCenter(new float[] {-3.602f ,1.49f ,0.9523f })
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_2").setDEF("hanim_r_tarsometatarsal_2").setName("r_tarsometatarsal_2").setCenter(new float[] {-3.548f ,1.16f ,1.825f })
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setDEF("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(new float[] {-3.651f ,0.6656f ,4.348f })
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setName("r_tarsal_proximal_interphalangeal_2").setCenter(new float[] {-3.73f ,0.5621f ,5.067f })
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setCenter(new float[] {-3.73f ,0.4367f ,5.486f })
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_3").setName("r_cuneonavicular_3").setCenter(new float[] {-4.116f ,1.484f ,0.8808f })
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_3").setDEF("hanim_r_tarsometatarsal_3").setName("r_tarsometatarsal_3").setCenter(new float[] {-4.188f ,1.16f ,1.751f })
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_3").setDEF("hanim_r_metatarsophalangeal_3").setName("r_metatarsophalangeal_3").setCenter(new float[] {-4.271f ,0.6692f ,4.241f })
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setName("r_tarsal_proximal_interphalangeal_3").setCenter(new float[] {-4.378f ,0.5299f ,4.91f })
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setName("r_tarsal_distal_interphalangeal_3").setCenter(new float[] {-4.446f ,0.4367f ,5.32f })
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_calcaneocuboid").setName("r_calcaneocuboid").setCenter(new float[] {-3.943f ,2.577f ,-1.154f })
                      ...
                      .addChild(new HAnimJoint("hanim_r_calcaneocuboid").setDEF("hanim_r_transversetarsal").setName("r_transversetarsal").setCenter(new float[] {-4.901f ,1.568f ,0.09285f })
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setDEF("hanim_r_tarsometatarsal_4").setName("r_tarsometatarsal_4").setCenter(new float[] {-4.717f ,1.091f ,1.708f })
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_4").setDEF("hanim_r_metatarsophalangeal_4").setName("r_metatarsophalangeal_4").setCenter(new float[] {-4.867f ,0.6379f ,4.052f })
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setName("r_tarsal_proximal_interphalangeal_4").setCenter(new float[] {-5.057f ,0.5442f ,4.725f })
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setName("r_tarsal_distal_interphalangeal_4").setCenter(new float[] {-5.125f ,0.4164f ,5.053f })
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setDEF("hanim_r_tarsometatarsal_5").setName("r_tarsometatarsal_5").setCenter(new float[] {-5.353f ,0.9309f ,1.544f })
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_5").setDEF("hanim_r_metatarsophalangeal_5").setName("r_metatarsophalangeal_5").setCenter(new float[] {-5.497f ,0.6076f ,3.847f })
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_5").setName("r_tarsal_proximal_interphalangeal_5").setCenter(new float[] {-5.6f ,0.4825f ,4.184f })
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_5").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setName("r_tarsal_distal_interphalangeal_5").setCenter(new float[] {-5.641f ,0.3806f ,4.528f })
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_vl5").setName("vl5").setCenter(new float[] {0f ,41.13f ,-0.6117f })
                ...
                .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_vl4").setName("vl4").setCenter(new float[] {0f ,42.21f ,-0.6117f })
                  ...
                  .addChild(new HAnimJoint("hanim_vl4").setDEF("hanim_vl3").setName("vl3").setCenter(new float[] {0f ,42.93f ,-0.6117f })
                    ...
                    .addChild(new HAnimJoint("hanim_vl3").setDEF("hanim_vl2").setName("vl2").setCenter(new float[] {0f ,43.66f ,-0.6117f })
                      ...
                      .addChild(new HAnimJoint("hanim_vl2").setDEF("hanim_vl1").setName("vl1").setCenter(new float[] {0f ,44.43f ,-0.6117f })
                        ...
                        .addChild(new HAnimJoint("hanim_vl1").setDEF("hanim_vt12").setName("vt12").setCenter(new float[] {0f ,45.47f ,-0.6117f })
                          ...
                          .addChild(new HAnimJoint("hanim_vt12").setDEF("hanim_vt11").setName("vt11").setCenter(new float[] {0f ,46.52f ,-0.6117f })
                            ...
                            .addChild(new HAnimJoint("hanim_vt11").setDEF("hanim_vt10").setName("vt10").setCenter(new float[] {0f ,47.28f ,-0.6127f })
                              ...
                              .addChild(new HAnimJoint("hanim_vt10").setDEF("hanim_vt9").setName("vt9").setCenter(new float[] {0f ,47.93f ,-0.6117f })
                                ...
                                .addChild(new HAnimJoint("hanim_vt9").setDEF("hanim_vt8").setName("vt8").setCenter(new float[] {0f ,48.58f ,-0.6117f })
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt8").setDEF("hanim_vt7").setName("vt7").setCenter(new float[] {0f ,49.28f ,-0.6117f })
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt7").setDEF("hanim_vt6").setName("vt6").setCenter(new float[] {0f ,49.85f ,-0.6117f })
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt6").setDEF("hanim_vt5").setName("vt5").setCenter(new float[] {0f ,50.54f ,-0.6117f })
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt5").setDEF("hanim_vt4").setName("vt4").setCenter(new float[] {0f ,51.22f ,-0.6117f })
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setDEF("hanim_vt3").setName("vt3").setCenter(new float[] {0f ,52.04f ,-0.6117f })
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setDEF("hanim_vt2").setName("vt2").setCenter(new float[] {0f ,53.14f ,-0.6127f })
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setDEF("hanim_vt1").setName("vt1").setCenter(new float[] {0f ,54.2f ,-0.6117f })
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_vc7").setName("vc7").setCenter(new float[] {0f ,55.35f ,-0.6695f })
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc7").setDEF("hanim_vc6").setName("vc6").setCenter(new float[] {0f ,55.89f ,-0.6695f })
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc6").setDEF("hanim_vc5").setName("vc5").setCenter(new float[] {0f ,56.44f ,-0.6695f })
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc5").setDEF("hanim_vc4").setName("vc4").setCenter(new float[] {0f ,56.99f ,-0.6695f })
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_vc4").setDEF("hanim_vc3").setName("vc3").setCenter(new float[] {0f ,57.56f ,-0.6695f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_vc3").setDEF("hanim_vc2").setName("vc2").setCenter(new float[] {0f ,58.08f ,-0.6695f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_vc2").setDEF("hanim_vc1").setName("vc1").setCenter(new float[] {0f ,58.6f ,-0.6695f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_vc1").setDEF("hanim_skullbase").setName("skullbase").setCenter(new float[] {0f ,58.34f ,-0.6863f })
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0f ,58.34f ,-0.6863f })
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32331().getArray().append(new MFInt32332().getArray()).append(new MFInt32333().getArray())).setCoordIndex(new MFInt32334().getArray().append(new MFInt32335().getArray()).append(new MFInt32336().getArray()))
                                                                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f337().getArray().append(new MFVec2f338().getArray())))
                                                                        .setCoord(new Coordinate().setPoint(new MFVec3f339().getArray().append(new MFVec3f340().getArray())))))))
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyelid_joint").setName("l_eyelid_joint").setCenter(new float[] {2.245f ,63.3f ,1.464f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyelid_joint").setName("r_eyelid_joint").setCenter(new float[] {-2.245f ,63.3f ,1.464f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyeball_joint").setName("l_eyeball_joint").setCenter(new float[] {2.139f ,62.44f ,3.691f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyeball_joint").setName("r_eyeball_joint").setCenter(new float[] {-2.139f ,62.44f ,3.691f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyebrow_joint").setName("l_eyebrow_joint").setCenter(new float[] {0.9666f ,62.84f ,4.753f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyebrow_joint").setName("r_eyebrow_joint").setCenter(new float[] {-0.9666f ,62.84f ,4.753f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_temporomandibular").setName("temporomandibular").setCenter(new float[] {0f ,58.35f ,0.6835f })
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(new float[] {1.71f ,53.72f ,-0.6127f })
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_sternoclavicular").setDEF("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(new float[] {5.464f ,52.97f ,-0.5732f })
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_acromioclavicular").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {7.336f ,52.38f ,-0.1452f })
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_l_shoulder").setDEF("hanim_l_elbow").setName("l_elbow").setCenter(new float[] {8.093f ,41.28f ,-0.2502f })
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_elbow").setDEF("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(new float[] {8.086f ,32.19f ,-0.2233f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_1").setName("l_midcarpal_1").setCenter(new float[] {8.057f ,31.38f ,0.859f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_1").setDEF("hanim_l_carpometacarpal_1").setName("l_carpometacarpal_1").setCenter(new float[] {8.022f ,30.78f ,1.155f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setDEF("hanim_l_metacarpophalangeal_1").setName("l_metacarpophalangeal_1").setCenter(new float[] {8.046f ,29.9f ,1.59f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setName("l_carpal_interphalangeal_1").setCenter(new float[] {8.118f ,29.07f ,2.207f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_2").setName("l_midcarpal_2").setCenter(new float[] {8.057f ,31.42f ,0.3741f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_2").setDEF("hanim_l_carpometacarpal_2").setName("l_carpometacarpal_2").setCenter(new float[] {8.057f ,30.56f ,0.4324f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setDEF("hanim_l_metacarpophalangeal_2").setName("l_metacarpophalangeal_2").setCenter(new float[] {8.166f ,28.32f ,0.67f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_proximal_interphalangeal_2").setCenter(new float[] {8.076f ,26.97f ,0.6304f })
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_2").setCenter(new float[] {8.03f ,25.85f ,0.5949f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_3").setName("l_midcarpal_3").setCenter(new float[] {8.048f ,31.49f ,-0.2132f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_3").setDEF("hanim_l_carpometacarpal_3").setName("l_carpometacarpal_3").setCenter(new float[] {8.048f ,30.48f ,-0.2779f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setDEF("hanim_l_metacarpophalangeal_3").setName("l_metacarpophalangeal_3").setCenter(new float[] {8.164f ,28.22f ,-0.1741f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_proximal_interphalangeal_3").setCenter(new float[] {8.076f ,26.81f ,-0.1572f })
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_3").setCenter(new float[] {8.03f ,25.57f ,-0.1671f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_4_5").setName("l_midcarpal_4_5").setCenter(new float[] {8.048f ,31.37f ,-1.144f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_4_5").setDEF("hanim_l_carpometacarpal_4").setName("l_carpometacarpal_4").setCenter(new float[] {8.048f ,30.5f ,-0.8853f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setDEF("hanim_l_metacarpophalangeal_4").setName("l_metacarpophalangeal_4").setCenter(new float[] {8.164f ,28.18f ,-0.9529f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_proximal_interphalangeal_4").setCenter(new float[] {8.076f ,26.96f ,-0.9176f })
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_4").setCenter(new float[] {8.03f ,25.81f ,-0.879f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_carpometacarpal_5").setName("l_carpometacarpal_5").setCenter(new float[] {8.073f ,30.59f ,-1.457f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setDEF("hanim_l_metacarpophalangeal_5").setName("l_metacarpophalangeal_5").setCenter(new float[] {8.148f ,28.36f ,-1.647f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_5").setName("l_carpal_proximal_interphalangeal_5").setCenter(new float[] {8.074f ,27.6f ,-1.651f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_5").setDEF("hanim_l_carpal_distal_interphalangeal_5").setName("l_carpal_distal_interphalangeal_5").setCenter(new float[] {8.036f ,26.77f ,-1.643f })
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-1.71f ,53.72f ,-0.6127f })
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_sternoclavicular").setDEF("hanim_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-5.464f ,52.97f ,-0.5732f })
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_acromioclavicular").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-7.32f ,52.38f ,-0.1452f })
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_shoulder").setDEF("hanim_r_elbow").setName("r_elbow").setCenter(new float[] {-8.077f ,41.28f ,-0.2502f })
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_elbow").setDEF("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(new float[] {-8.07f ,32.19f ,-0.2232f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_1").setName("r_midcarpal_1").setCenter(new float[] {-8.043f ,31.38f ,0.859f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_1").setDEF("hanim_r_carpometacarpal_1").setName("r_carpometacarpal_1").setCenter(new float[] {-8.006f ,30.78f ,1.155f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setDEF("hanim_r_metacarpophalangeal_1").setName("r_metacarpophalangeal_1").setCenter(new float[] {-8.029f ,29.9f ,1.59f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setName("r_carpal_interphalangeal_1").setCenter(new float[] {-8.101f ,29.07f ,2.207f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_2").setName("r_midcarpal_2").setCenter(new float[] {-8.043f ,31.42f ,0.3741f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_2").setDEF("hanim_r_carpometacarpal_2").setName("r_carpometacarpal_2").setCenter(new float[] {-8.04f ,30.56f ,0.4324f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setDEF("hanim_r_metacarpophalangeal_2").setName("r_metacarpophalangeal_2").setCenter(new float[] {-8.149f ,28.32f ,0.67f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-8.059f ,26.97f ,0.6304f })
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setCenter(new float[] {-8.013f ,25.85f ,0.5949f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_3").setName("r_midcarpal_3").setCenter(new float[] {-8.032f ,31.49f ,-0.2132f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_3").setDEF("hanim_r_carpometacarpal_3").setName("r_carpometacarpal_3").setCenter(new float[] {-8.032f ,30.48f ,-0.2779f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setDEF("hanim_r_metacarpophalangeal_3").setName("r_metacarpophalangeal_3").setCenter(new float[] {-8.147f ,28.22f ,-0.1741f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-8.059f ,26.81f ,-0.1572f })
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setCenter(new float[] {-8.013f ,25.57f ,-0.1671f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_4_5").setName("r_midcarpal_4_5").setCenter(new float[] {-8.032f ,31.37f ,-1.144f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_4_5").setDEF("hanim_r_carpometacarpal_4").setName("r_carpometacarpal_4").setCenter(new float[] {-8.032f ,30.5f ,-0.8853f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setDEF("hanim_r_metacarpophalangeal_4").setName("r_metacarpophalangeal_4").setCenter(new float[] {-8.147f ,28.18f ,-0.9529f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setCenter(new float[] {-8.059f ,26.96f ,-0.9176f })
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setCenter(new float[] {-8.013f ,25.81f ,-0.879f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_carpometacarpal_5").setName("r_carpometacarpal_5").setCenter(new float[] {-8.056f ,30.59f ,-1.457f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setDEF("hanim_r_metacarpophalangeal_5").setName("r_metacarpophalangeal_5").setCenter(new float[] {-8.132f ,28.36f ,-1.647f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setCenter(new float[] {-8.058f ,27.6f ,-1.651f })
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5").setDEF("hanim_r_carpal_distal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setCenter(new float[] {-8.02f ,26.77f ,-1.643f })

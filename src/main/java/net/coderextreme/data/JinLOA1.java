...
public class JinLOA1 {
  public static void main(String[] args) {
    ...
    new JinLOA1().initialize().toFileJSON("../data/JinLOA1.new.json");
    }
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("JinLOA1").setDEF("hanim_JinLOA1").setLoa(1).setScale(new float[] {0.0225f,0.0225f,0.0225f}).setVersion("2.0")
          ...
          .addSkeleton(new HAnimJoint().setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f,30.530001f,-0.7076f}).setStiffness(new float[] {0f,0f,0f})
            .addChild(new HAnimSegment().setName("sacrum").setDEF("hanim_sacrum")
              .addChild(new Transform().setTranslation(new float[] {0f,30.530001f,-0.7076f})
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt328().getArray()).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt329().getArray())
                    .setCoord(new Coordinate().setPoint(new MFVec3f10().getArray()))
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f11().getArray()))))))
            .addChild(new HAnimJoint().setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new float[] {0f,35.799999f,-0.7076f}).setStiffness(new float[] {0f,0f,0f})
              .addChild(new HAnimSegment().setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new Transform().setTranslation(new float[] {0f,35.799999f,-0.7076f})
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3212().getArray()).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3213().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f14().getArray()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f15().getArray()))))))
              .addChild(new HAnimJoint().setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {4.207f,32.02f,-0.8155f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {4.116f,17.26f,-0.8639f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3220().getArray()).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3221().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new float[] {3.854f,3.939f,-0.7038f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3224().getArray()).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3225().getArray())
              ...
              .addChild(new HAnimJoint().setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-4.207f,32.02f,-0.8155f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-4.207f,32.02f,-0.8155f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3232().getArray()).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3233().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-4.116f,17.26f,-0.8639f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3236().getArray()).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3237().getArray())
                        ...
                        .addChild(new Transform().setTranslation(new float[] {-3.854f,3.64f,0.7402f})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3244().getArray()).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3245().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f46().getArray()))
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f47().getArray())))))))))))
            .addChild(new HAnimJoint().setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f,40.07f,-0.8527f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new Transform().setTranslation(new float[] {0f,40.07f,-0.8527f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3248().getArray().append(new MFInt3249().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3250().getArray().append(new MFInt3251().getArray()))
              ...
              .addChild(new HAnimJoint().setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f,57.43f,-0.6863f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0f,57.43f,-0.6863f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3254().getArray().append(new MFInt3255().getArray()).append(new MFInt3256().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3257().getArray().append(new MFInt3258().getArray()).append(new MFInt3259().getArray()))
                ...
                .addChild(new HAnimJoint().setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {5.975f,52f,-0.1452f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {8.093f,40.380001f,-0.2502f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {7.808f,31.459999f,-0.05849f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-5.975f,52f,-0.1452f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-8.093f,40.380001f,-0.2502f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-7.808f,31.459999f,-0.05849f}).setStiffness(new float[] {0f,0f,0f})

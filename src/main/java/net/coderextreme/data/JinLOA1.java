...
public class JinLOA1 implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/JinLOA1.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("JinLOA1.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("TODO")).setContent(new SFString("rescale smaller than 30m! convert inches to meters? what about motion scaling?")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinLOA1.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("JinLOA1.x3d")))
        .addChild(new NavigationInfo().setSpeed(1.5f ))
        .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,1f ,0f }).setDescription(new SFString("JinLOA1")).setPosition(new float[] {0f ,1f ,3f }))
        .addChild(new HAnimHumanoid().setName(new SFString("JinLOA1")).setDEF(new SFString("hanim_JinLOA1")).setLoa(1).setScale(new float[] {0.0225f ,0.0225f ,0.0225f }).setVersion(new SFString("2.0"))
          .setMetadata(new MetadataSet().setName(new SFString("HAnimHumanoid.info")).setReference(new SFString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid"))
            ...
            .addValue(new MetadataFloat().setName(new SFString("weight")).setValue(new MFFloat5().getArray()))
            .setMetadata(new MetadataString().setName(new SFString("humanoidVersion")).setValue(new MFString6().getArray())))
          .addSkeleton(new HAnimJoint("hanim_JinLOA1").setName(new SFString("humanoid_root")).setDEF(new SFString("hanim_humanoid_root")).setCenter(new float[] {0f ,30.530001f ,-0.7076f }).setUlimit(new MFFloat7().getArray()).setLlimit(new MFFloat8().getArray())
              ...
              .addChild(new Transform().setTranslation(new float[] {0f ,30.530001f ,-0.7076f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF(new SFString("JinLOA1TextureAtlas")).setUrl(new MFString9().getArray())))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("sacroiliac")).setDEF(new SFString("hanim_sacroiliac")).setCenter(new float[] {0f ,35.799999f ,-0.7076f }).setUlimit(new MFFloat14().getArray()).setLlimit(new MFFloat15().getArray())
              .addChild(new HAnimSegment("hanim_sacroiliac").setName(new SFString("pelvis")).setDEF(new SFString("hanim_pelvis"))
                .addChild(new Transform().setTranslation(new float[] {0f ,35.799999f ,-0.7076f })
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                      .setTexture(new ImageTexture().setUSE(new SFString("JinLOA1TextureAtlas"))))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("l_hip")).setDEF(new SFString("hanim_l_hip")).setCenter(new float[] {4.207f ,32.02f ,-0.8155f }).setUlimit(new MFFloat20().getArray()).setLlimit(new MFFloat21().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName(new SFString("l_knee")).setDEF(new SFString("hanim_l_knee")).setCenter(new float[] {4.116f ,17.26f ,-0.8639f }).setUlimit(new MFFloat26().getArray()).setLlimit(new MFFloat27().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setName(new SFString("l_talocrural")).setDEF(new SFString("hanim_l_talocrural")).setCenter(new float[] {3.854f ,3.939f ,-0.7038f }).setUlimit(new MFFloat32().getArray()).setLlimit(new MFFloat33().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName(new SFString("l_metatarsophalangeal_2")).setDEF(new SFString("hanim_l_metatarsophalangeal_2")).setCenter(new float[] {3.854f ,3.64f ,0.7402f }).setUlimit(new MFFloat38().getArray()).setLlimit(new MFFloat39().getArray())
                      .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_2").setName(new SFString("l_tarsal_proximal_phalanx_2")).setDEF(new SFString("hanim_l_tarsal_proximal_phalanx_2"))
                        .addComments(new CommentsBlock("TODO append _2"))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("r_hip")).setDEF(new SFString("hanim_r_hip")).setCenter(new float[] {-4.207f ,32.02f ,-0.8155f }).setUlimit(new MFFloat44().getArray()).setLlimit(new MFFloat45().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName(new SFString("r_knee")).setDEF(new SFString("hanim_r_knee")).setCenter(new float[] {-4.116f ,17.26f ,-0.8639f }).setUlimit(new MFFloat50().getArray()).setLlimit(new MFFloat51().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName(new SFString("r_talocrural")).setDEF(new SFString("hanim_r_talocrural")).setCenter(new float[] {-3.854f ,3.939f ,-0.7038f }).setUlimit(new MFFloat56().getArray()).setLlimit(new MFFloat57().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName(new SFString("r_metatarsophalangeal_2")).setDEF(new SFString("hanim_r_metatarsophalangeal_2")).setCenter(new float[] {-3.854f ,3.64f ,0.7402f }).setUlimit(new MFFloat62().getArray()).setLlimit(new MFFloat63().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("vl5")).setDEF(new SFString("hanim_vl5")).setCenter(new float[] {0f ,40.07f ,-0.8527f }).setUlimit(new MFFloat68().getArray()).setLlimit(new MFFloat69().getArray())
              ...
              .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("skullbase")).setDEF(new SFString("hanim_skullbase")).setCenter(new float[] {0f ,57.43f ,-0.6863f }).setUlimit(new MFFloat76().getArray()).setLlimit(new MFFloat77().getArray())
                ...
                .addChild(new HAnimJoint("hanim_skullbase").setName(new SFString("l_shoulder")).setDEF(new SFString("hanim_l_shoulder")).setCenter(new float[] {5.975f ,52f ,-0.1452f }).setUlimit(new MFFloat87().getArray()).setLlimit(new MFFloat88().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_shoulder").setName(new SFString("l_elbow")).setDEF(new SFString("hanim_l_elbow")).setCenter(new float[] {8.093f ,40.380001f ,-0.2502f }).setUlimit(new MFFloat93().getArray()).setLlimit(new MFFloat94().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_elbow").setName(new SFString("l_radiocarpal")).setDEF(new SFString("hanim_l_radiocarpal")).setCenter(new float[] {7.808f ,31.459999f ,-0.05849f }).setUlimit(new MFFloat99().getArray()).setLlimit(new MFFloat100().getArray())
                ...
                .addChild(new HAnimJoint("hanim_skullbase").setName(new SFString("r_shoulder")).setDEF(new SFString("hanim_r_shoulder")).setCenter(new float[] {-5.975f ,52f ,-0.1452f }).setUlimit(new MFFloat105().getArray()).setLlimit(new MFFloat106().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_shoulder").setName(new SFString("r_elbow")).setDEF(new SFString("hanim_r_elbow")).setCenter(new float[] {-8.093f ,40.380001f ,-0.2502f }).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_elbow").setName(new SFString("r_radiocarpal")).setDEF(new SFString("hanim_r_radiocarpal")).setCenter(new float[] {-7.808f ,31.459999f ,-0.05849f }).setUlimit(new MFFloat117().getArray()).setLlimit(new MFFloat118().getArray())
          ...
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_humanoid_root")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_sacroiliac")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_vl5")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_skullbase")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_l_elbow")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_r_elbow")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_l_hip")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_r_hip")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_l_knee")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_r_knee")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_l_metatarsophalangeal_2")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_r_metatarsophalangeal_2")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_l_radiocarpal")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_r_radiocarpal")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_l_shoulder")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_r_shoulder")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_l_talocrural")))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE(new SFString("hanim_r_talocrural")))));
    return X3D0;
    }

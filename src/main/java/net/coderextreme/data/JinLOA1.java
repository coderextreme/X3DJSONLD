    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("JinLOA1").setDEF("hanim_JinLOA1").setLoa(1).setScale(new float[] {0.0225f,0.0225f,0.0225f}).setVersion("2.0")
          .setMetadata(new MetadataSet("hanim_JinLOA1").setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            ...
            .setMetadata(new MetadataString().setName("humanoidVersion").setValue(new MFString6().getArray())))
          .addSkeleton(new HAnimJoint("hanim_JinLOA1").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f,30.530001f,-0.7076f}).setUlimit(new MFFloat7().getArray()).setLlimit(new MFFloat8().getArray())
            .addChild(new HAnimSegment("hanim_humanoid_root").setName("sacrum").setDEF("hanim_sacrum")
              .addChild(new Transform("hanim_sacrum").setTranslation(new float[] {0f,30.530001f,-0.7076f})
                .addChild(new Shape()
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new float[] {0f,35.799999f,-0.7076f}).setUlimit(new MFFloat14().getArray()).setLlimit(new MFFloat15().getArray())
              .addChild(new HAnimSegment("hanim_sacroiliac").setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new Transform("hanim_pelvis").setTranslation(new float[] {0f,35.799999f,-0.7076f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {4.207f,32.02f,-0.8155f}).setUlimit(new MFFloat20().getArray()).setLlimit(new MFFloat21().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {4.116f,17.26f,-0.8639f}).setUlimit(new MFFloat26().getArray()).setLlimit(new MFFloat27().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new float[] {3.854f,3.939f,-0.7038f}).setUlimit(new MFFloat32().getArray()).setLlimit(new MFFloat33().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new float[] {3.854f,3.64f,0.7402f}).setUlimit(new MFFloat38().getArray()).setLlimit(new MFFloat39().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-4.207f,32.02f,-0.8155f}).setUlimit(new MFFloat44().getArray()).setLlimit(new MFFloat45().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-4.116f,17.26f,-0.8639f}).setUlimit(new MFFloat50().getArray()).setLlimit(new MFFloat51().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-3.854f,3.939f,-0.7038f}).setUlimit(new MFFloat56().getArray()).setLlimit(new MFFloat57().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new float[] {-3.854f,3.64f,0.7402f}).setUlimit(new MFFloat62().getArray()).setLlimit(new MFFloat63().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f,40.07f,-0.8527f}).setUlimit(new MFFloat68().getArray()).setLlimit(new MFFloat69().getArray())
              .addChild(new HAnimSegment("hanim_vl5").setName("l5").setDEF("hanim_l5")
                .addChild(new Transform("hanim_l5").setTranslation(new float[] {0f,40.07f,-0.8527f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_vl5").setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f,57.43f,-0.6863f}).setUlimit(new MFFloat76().getArray()).setLlimit(new MFFloat77().getArray())
                ...
                .addChild(new HAnimJoint("hanim_skullbase").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {5.975f,52f,-0.1452f}).setUlimit(new MFFloat87().getArray()).setLlimit(new MFFloat88().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {8.093f,40.380001f,-0.2502f}).setUlimit(new MFFloat93().getArray()).setLlimit(new MFFloat94().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {7.808f,31.459999f,-0.05849f}).setUlimit(new MFFloat99().getArray()).setLlimit(new MFFloat100().getArray())
                ...
                .addChild(new HAnimJoint("hanim_skullbase").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-5.975f,52f,-0.1452f}).setUlimit(new MFFloat105().getArray()).setLlimit(new MFFloat106().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-8.093f,40.380001f,-0.2502f}).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-7.808f,31.459999f,-0.05849f}).setUlimit(new MFFloat117().getArray()).setLlimit(new MFFloat118().getArray())
          ...
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_humanoid_root"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_sacroiliac"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_vl5"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_skullbase"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_l_elbow"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_r_elbow"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_l_hip"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_r_hip"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_l_knee"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_r_knee"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_l_metatarsophalangeal_2"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_r_metatarsophalangeal_2"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_l_radiocarpal"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_r_radiocarpal"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_l_shoulder"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_r_shoulder"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_l_talocrural"))
          .addJoints(new HAnimJoint("hanim_JinLOA1").setUSE("hanim_r_talocrural"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_sacrum"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_pelvis"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_l5"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_skull"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_l_calf"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_r_calf"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_l_carpal"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_r_carpal"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_l_forearm"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_r_forearm"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_l_talus"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_r_talus"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_l_tarsal_proximal_phalanx_2"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_r_tarsal_proximal_phalanx_2"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_l_thigh"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_r_thigh"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_l_upperarm"))
          .addSegments(new HAnimSegment("hanim_JinLOA1").setUSE("hanim_r_upperarm"))))      ;
    return X3D0;
    }
...
protected class MFFloat5 {
  protected org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {50f});
  }
}

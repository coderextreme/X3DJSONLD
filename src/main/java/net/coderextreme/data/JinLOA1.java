    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("JinLOA1").setDEF("hanim_JinLOA1").setLoa(1).setScale(new double[] {0.0225,0.0225,0.0225}).setVersion("2.0")
          ...
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_JinLOA1").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new double[] {0,30.530001,-0.7076}).setContainerFieldOverride("skeleton"))
              ...
              .addChild(new Transform().setTranslation(new double[] {0,30.530001,-0.7076})
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("JinLOA1TextureAtlas").setUrl(new MFString7().getArray())))
                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt328().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt329().getArray())
                    .setCoord(new Coordinate().setPoint(new MFVec3f10().getArray()))
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f11().getArray()))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new double[] {0,35.799999,-0.7076})
              .addChild(new HAnimSegment("hanim_sacroiliac").setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new Transform().setTranslation(new double[] {0,35.799999,-0.7076})
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3212().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3213().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f14().getArray()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f15().getArray()))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_hip").setDEF("hanim_l_hip").setCenter(new double[] {4.207,32.02,-0.8155})
                    ...
                    .addChild(new Transform().setTranslation(new double[] {4.116,17.26,-0.8639})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3220().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3221().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f22().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f23().getArray()))))))
                      ...
                      .addChild(new Transform().setTranslation(new double[] {3.854,3.939,-0.7038})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3224().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3225().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f26().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f27().getArray()))))))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new double[] {-4.207,32.02,-0.8155})
                  ...
                  .addChild(new Transform().setTranslation(new double[] {-4.207,32.02,-0.8155})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3232().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3233().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f34().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f35().getArray()))))))
                    ...
                    .addChild(new Transform().setTranslation(new double[] {-4.116,17.26,-0.8639})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3236().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3237().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f38().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f39().getArray()))))))
                        ...
                        .addChild(new Transform().setTranslation(new double[] {-3.854,3.64,0.7402})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3244().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3245().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f46().getArray()))
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f47().getArray())))))))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("vl5").setDEF("hanim_vl5").setCenter(new double[] {0,40.07,-0.8527})
                ...
                .addChild(new Transform().setTranslation(new double[] {0,40.07,-0.8527})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                      .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3248().getArray().append(new MFInt3249().getArray())).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3250().getArray().append(new MFInt3251().getArray()))
                  ...
                  .addChild(new Transform().setTranslation(new double[] {0,57.43,-0.6863})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3254().getArray().append(new MFInt3255().getArray()).append(new MFInt3256().getArray())).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3257().getArray().append(new MFInt3258().getArray()).append(new MFInt3259().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f60().getArray().append(new MFVec3f61().getArray())))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f62().getArray()))))))
                .addChild(new HAnimJoint("hanim_skullbase").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new double[] {5.975,52,-0.1452})
                      ...
                      .addChild(new Transform().setTranslation(new double[] {8.093,40.380001,-0.2502})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3267().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3268().getArray())
                        ...
                        .addChild(new Transform().setTranslation(new double[] {7.808,31.459999,-0.05849})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3271().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3272().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f73().getArray()))
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f74().getArray())))))))))
                .addChild(new HAnimJoint("hanim_skullbase").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new double[] {-5.975,52,-0.1452})
                      ...
                      .addChild(new Transform().setTranslation(new double[] {-8.093,40.380001,-0.2502})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3279().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3280().getArray())
                        ...
                        .addChild(new Transform().setTranslation(new double[] {-7.808,31.459999,-0.05849})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3283().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3284().getArray())

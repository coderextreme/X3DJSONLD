...
public class JinLOA1 implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/JinLOA1.new.java.x3d");
    model.toFileJSON("../data/JinLOA1.new.java.json");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("17 February 2024"))
        ...
        .addMeta(new meta().setName("reference").setContent("JinOriginalLOA1.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setCenterOfRotation(new double[] {0,1,0}).setDescription("JinLOA1").setPosition(new double[] {0,1,3}))
        .addChild(new HAnimHumanoid().setName("JinLOA1").setDEF("hanim_JinLOA1").setLoa(1).setScale(new double[] {0.0225,0.0225,0.0225}).setVersion("2.0")
          ...
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_JinLOA1").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new double[] {0,30.530001,-0.7076}).setUlimit(new MFFloat7().getArray()).setLlimit(new MFFloat8().getArray()).setContainerFieldOverride("skeleton"))
            .addChild(new HAnimSegment("hanim_humanoid_root").setName("sacrum").setDEF("hanim_sacrum")
              .addChild(new Transform().setTranslation(new double[] {0,30.530001,-0.7076})
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3210().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3211().getArray())
                    .setCoord(new Coordinate().setPoint(new MFVec3f12().getArray()))
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f13().getArray()))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new double[] {0,35.799999,-0.7076}).setUlimit(new MFFloat14().getArray()).setLlimit(new MFFloat15().getArray())
              .addChild(new HAnimSegment("hanim_sacroiliac").setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new Transform().setTranslation(new double[] {0,35.799999,-0.7076})
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3216().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3217().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f18().getArray()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f19().getArray()))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_hip").setDEF("hanim_l_hip").setCenter(new double[] {4.207,32.02,-0.8155}).setUlimit(new MFFloat20().getArray()).setLlimit(new MFFloat21().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new double[] {4.207,32.02,-0.8155})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3222().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3223().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f24().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f25().getArray()))))))
                .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new double[] {4.116,17.26,-0.8639}).setUlimit(new MFFloat26().getArray()).setLlimit(new MFFloat27().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new double[] {4.116,17.26,-0.8639})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3228().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3229().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f30().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f31().getArray()))))))
                  .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new double[] {3.854,3.939,-0.7038}).setUlimit(new MFFloat32().getArray()).setLlimit(new MFFloat33().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new double[] {3.854,3.939,-0.7038})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3234().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3235().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f36().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f37().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new double[] {3.854,3.64,0.7402}).setUlimit(new MFFloat38().getArray()).setLlimit(new MFFloat39().getArray())
                        ...
                        .addChild(new Transform().setTranslation(new double[] {3.854,3.64,0.7402})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3240().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3241().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f42().getArray()))
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f43().getArray()))))))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new double[] {-4.207,32.02,-0.8155}).setUlimit(new MFFloat44().getArray()).setLlimit(new MFFloat45().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new double[] {-4.207,32.02,-0.8155})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3246().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3247().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f48().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f49().getArray()))))))
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new double[] {-4.116,17.26,-0.8639}).setUlimit(new MFFloat50().getArray()).setLlimit(new MFFloat51().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new double[] {-4.116,17.26,-0.8639})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3252().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3253().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f54().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f55().getArray()))))))
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new double[] {-3.854,3.939,-0.7038}).setUlimit(new MFFloat56().getArray()).setLlimit(new MFFloat57().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new double[] {-3.854,3.939,-0.7038})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3258().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3259().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f60().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f61().getArray()))))))
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new double[] {-3.854,3.64,0.7402}).setUlimit(new MFFloat62().getArray()).setLlimit(new MFFloat63().getArray())
                        ...
                        .addChild(new Transform().setTranslation(new double[] {-3.854,3.64,0.7402})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3264().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3265().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f66().getArray()))
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f67().getArray())))))))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("vl5").setDEF("hanim_vl5").setCenter(new double[] {0,40.07,-0.8527}).setUlimit(new MFFloat68().getArray()).setLlimit(new MFFloat69().getArray())
              .addChild(new HAnimSegment("hanim_vl5").setName("l5").setDEF("hanim_l5")
                .addChild(new Transform().setTranslation(new double[] {0,40.07,-0.8527})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                      .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3270().getArray().append(new MFInt3271().getArray())).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3272().getArray().append(new MFInt3273().getArray()))
                      .setCoord(new Coordinate().setPoint(new MFVec3f74().getArray()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f75().getArray()))))))
              .addChild(new HAnimJoint("hanim_vl5").setName("skullbase").setDEF("hanim_skullbase").setCenter(new double[] {0,57.43,-0.6863}).setUlimit(new MFFloat76().getArray()).setLlimit(new MFFloat77().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new double[] {0,57.43,-0.6863})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3278().getArray().append(new MFInt3279().getArray()).append(new MFInt3280().getArray())).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3281().getArray().append(new MFInt3282().getArray()).append(new MFInt3283().getArray()))
                ...
                .addChild(new HAnimJoint("hanim_skullbase").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new double[] {5.975,52,-0.1452}).setUlimit(new MFFloat87().getArray()).setLlimit(new MFFloat88().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new double[] {5.975,52,-0.1452})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3289().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3290().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f91().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f92().getArray()))))))
                  .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new double[] {8.093,40.380001,-0.2502}).setUlimit(new MFFloat93().getArray()).setLlimit(new MFFloat94().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new double[] {8.093,40.380001,-0.2502})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3295().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3296().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f97().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f98().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new double[] {7.808,31.459999,-0.05849}).setUlimit(new MFFloat99().getArray()).setLlimit(new MFFloat100().getArray())
                        ...
                        .addChild(new Transform().setTranslation(new double[] {7.808,31.459999,-0.05849})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32101().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32102().getArray())
                ...
                .addChild(new HAnimJoint("hanim_skullbase").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new double[] {-5.975,52,-0.1452}).setUlimit(new MFFloat105().getArray()).setLlimit(new MFFloat106().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new double[] {-5.975,52,-0.1452})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32107().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32108().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new double[] {-8.093,40.380001,-0.2502}).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new double[] {-8.093,40.380001,-0.2502})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32113().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32114().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new double[] {-7.808,31.459999,-0.05849}).setUlimit(new MFFloat117().getArray()).setLlimit(new MFFloat118().getArray())
                        ...
                        .addChild(new Transform().setTranslation(new double[] {-7.808,31.459999,-0.05849})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("JinLOA1TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32119().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt32120().getArray())
...
private class MFFloat5 {
  private org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new double[] {50});
  }
}

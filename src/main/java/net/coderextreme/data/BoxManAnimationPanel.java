    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Humanoid").setDEF("boxman_Humanoid").setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())).setVersion("1.0")
          .setSkeleton(new HAnimJoint().setName("humanoid_root").setDEF("boxman_humanoid_root").setCenter(new float[] {0f,0.9723f,-0.0728f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt324().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat5().getArray()))
            ...
            .addChild(new HAnimJoint().setName("l_hip").setDEF("boxman_l_hip").setCenter(new float[] {0.0956f,0.9364f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt326().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat7().getArray()))
              ...
              .addChild(new HAnimJoint().setName("l_knee").setDEF("boxman_l_knee").setCenter(new float[] {0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt328().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat9().getArray()))
                .addChild(new HAnimSegment().setName("l_calf").setDEF("boxman_l_calf")
                  .addChild(new Transform().setTranslation(new float[] {0.0956f,0.5095f,-0.0036f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("l_ankle").setDEF("boxman_l_ankle").setCenter(new float[] {0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3210().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat11().getArray()))
                  .addChild(new HAnimSegment().setName("l_hindfoot").setDEF("boxman_l_hindfoot")
                    .addChild(new Transform().setTranslation(new float[] {0.0946f,0.0762f,-0.0261f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("l_midtarsal").setDEF("boxman_l_midtarsal").setCenter(new float[] {0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3212().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat13().getArray()))
                    .addChild(new HAnimSegment().setName("l_middistal").setDEF("boxman_l_middistal")
                      ...
                      .addChild(new HAnimSite().setName("l_middistal_tip").setDEF("boxman_l_middistal_tip").setTranslation(new float[] {0.095f,0.0005f,0.1924f})
                        .addChild(new Shape().setDEF("SphereRed")
                          ...
                          .setGeometry(new Sphere().setRadius(0.02f)))))))))
            .addChild(new HAnimJoint().setName("r_hip").setDEF("boxman_r_hip").setCenter(new float[] {-0.0956f,0.9364f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3214().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat15().getArray()))
              .addChild(new HAnimSegment().setName("r_thigh").setDEF("boxman_r_thigh")
                .addChild(new Transform().setTranslation(new float[] {-0.0956f,0.9364f,0f})
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint().setName("r_knee").setDEF("boxman_r_knee").setCenter(new float[] {-0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3216().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat17().getArray()))
                .addChild(new HAnimSegment().setName("r_calf").setDEF("boxman_r_calf")
                  .addChild(new Transform().setTranslation(new float[] {-0.0956f,0.5095f,-0.0036f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("r_ankle").setDEF("boxman_r_ankle").setCenter(new float[] {-0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3218().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat19().getArray()))
                  .addChild(new HAnimSegment().setName("r_hindfoot").setDEF("boxman_r_hindfoot")
                    .addChild(new Transform().setTranslation(new float[] {-0.0946f,0.0762f,-0.0261f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("r_midtarsal").setDEF("boxman_r_midtarsal").setCenter(new float[] {-0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3220().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat21().getArray()))
            ...
            .addChild(new HAnimJoint().setName("vl5").setDEF("boxman_vl5").setCenter(new float[] {0f,1.0817f,-0.0728f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3222().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat23().getArray()))
              .addChild(new HAnimSegment().setName("l5").setDEF("boxman_l5")
                .addChild(new Transform().setTranslation(new float[] {0f,1.0817f,-0.0728f})
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint().setName("skullbase").setDEF("boxman_skullbase").setCenter(new float[] {0f,1.644f,0.036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3224().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat25().getArray()))
                .addChild(new HAnimSegment().setName("skull").setDEF("boxman_skull")
                  ...
                  .addChild(new HAnimSite().setName("skull_tip").setDEF("boxman_skull_tip").setTranslation(new float[] {-0.0029f,1.7771f,0.0274f})
                    .addChild(new Shape().setUSE("SphereYellow")))))
              .addChild(new HAnimJoint().setName("l_shoulder").setDEF("boxman_l_shoulder").setCenter(new float[] {0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3226().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat27().getArray()))
                .addChild(new HAnimSegment().setName("l_upperarm").setDEF("boxman_l_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {0.1968f,1.4642f,-0.0265f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("l_elbow").setDEF("boxman_l_elbow").setCenter(new float[] {0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3228().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat29().getArray()))
                  .addChild(new HAnimSegment().setName("l_forearm").setDEF("boxman_l_forearm")
                    .addChild(new Transform().setTranslation(new float[] {0.1982f,1.1622f,-0.0557f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("l_wrist").setDEF("boxman_l_wrist").setCenter(new float[] {0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3230().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat31().getArray()))
                    .addChild(new HAnimSegment().setName("l_hand").setDEF("boxman_l_hand")
                      ...
                      .addChild(new HAnimSite().setName("l_hand_tip").setDEF("boxman_l_hand_tip").setTranslation(new float[] {0.1912f,0.6976f,-0.071f})
                        .addChild(new Shape().setUSE("SphereRed")))))))
              .addChild(new HAnimJoint().setName("r_shoulder").setDEF("boxman_r_shoulder").setCenter(new float[] {-0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3232().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat33().getArray()))
                .addChild(new HAnimSegment().setName("r_upperarm").setDEF("boxman_r_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {-0.1968f,1.4642f,-0.0265f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("r_elbow").setDEF("boxman_r_elbow").setCenter(new float[] {-0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3234().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat35().getArray()))
                  .addChild(new HAnimSegment().setName("r_forearm").setDEF("boxman_r_forearm")
                    .addChild(new Transform().setTranslation(new float[] {-0.1982f,1.1622f,-0.0557f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("r_wrist").setDEF("boxman_r_wrist").setCenter(new float[] {-0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3236().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat37().getArray()))
        ...
        .addChild(new Group().setDEF("StopAnimation")
          ...
          .addChild(new PositionInterpolator().setDEF("Stop_humanoid_root_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat47().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f48().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_humanoid_root_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat49().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation50().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_sacroiliac_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat51().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation52().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat53().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation54().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat55().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation56().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat57().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation58().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_subtalar_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat59().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation60().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_midtarsal_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat61().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation62().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_metatarsal_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat63().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation64().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat65().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation66().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat67().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation68().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat69().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation70().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_subtalar_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat71().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation72().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_midtarsal_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat73().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation74().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_metatarsal_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat75().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation76().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl5_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat77().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation78().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl4_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat79().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation80().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat81().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation82().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat83().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation84().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat85().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation86().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt12_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat87().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation88().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt11_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat89().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation90().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt10_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat91().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation92().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt9_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat93().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation94().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt8_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat95().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation96().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt7_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat97().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation98().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt6_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat99().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation100().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt5_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat101().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation102().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt4_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat103().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation104().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat105().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation106().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat107().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation108().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat109().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation110().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc7_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat111().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation112().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc6_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat113().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation114().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc5_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat115().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation116().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc4_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat117().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation118().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat119().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation120().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat121().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation122().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat123().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation124().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_skullbase_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat125().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation126().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_eyeball_joint_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat127().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation128().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_eyeball_joint_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat129().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation130().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_sternoclavicular_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat131().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation132().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_acromioclavicular_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat133().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation134().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat135().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation136().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat137().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation138().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat139().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation140().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_thumb1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat141().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation142().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_thumb2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat143().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation144().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_thumb3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat145().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation146().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_index0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat147().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation148().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_index1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat149().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation150().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_index2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat151().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation152().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_index3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat153().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation154().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_middle0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat155().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation156().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_middle1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat157().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation158().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_middle2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat159().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation160().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_middle3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat161().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation162().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ring0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat163().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation164().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ring1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat165().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation166().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ring2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat167().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation168().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ring3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat169().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation170().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_pinky0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat171().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation172().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_pinky1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat173().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation174().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_pinky2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat175().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation176().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_pinky3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat177().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation178().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_sternoclavicular_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat179().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation180().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_acromioclavicular_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat181().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation182().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat183().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation184().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat185().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation186().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat187().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation188().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_thumb1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat189().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation190().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_thumb2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat191().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation192().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_thumb3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat193().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation194().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_index0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat195().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation196().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_index1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat197().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation198().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_index2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat199().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation200().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_index3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat201().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation202().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_middle0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat203().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation204().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_middle1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat205().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation206().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_middle2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat207().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation208().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_middle3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat209().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation210().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ring0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat211().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation212().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ring1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat213().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation214().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ring2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat215().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation216().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ring3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat217().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation218().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_pinky0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat219().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation220().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_pinky1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat221().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation222().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_pinky2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat223().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation224().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_pinky3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat225().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation226().getArray()))))
        .addChild(new Group().setDEF("StandAnimation")
          .addChild(new TimeSensor().setDEF("StandTimer").setCycleInterval(5.73d).setLoop(true))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat227().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation228().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat229().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation230().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat231().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation232().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat233().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation234().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat235().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation236().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat237().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation238().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat239().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation240().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat241().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation242().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat243().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation244().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat245().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation246().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat247().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation248().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat249().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation250().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat251().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation252().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat253().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation254().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat255().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation256().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_eyeball_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat257().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation258().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_eyeball_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat259().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation260().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat261().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation262().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat263().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation264().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat265().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation266().getArray())))
          .addChild(new PositionInterpolator().setDEF("Stand_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat267().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f268().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat269().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation270().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat271().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation272().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat273().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation274().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat275().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation276().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat277().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation278().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat279().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation280().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat281().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation282().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat283().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation284().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat285().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation286().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_index1_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat287().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation288().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_index2_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat289().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation290().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_index3_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat291().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation292().getArray()))))
        .addChild(new Group().setDEF("PitchesAnimation")
          .addChild(new TimeSensor().setDEF("PitchTimer").setCycleInterval(5.73d).setLoop(true))
          .addChild(new OrientationInterpolator().setDEF("Pitch_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat293().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation294().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat295().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation296().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat297().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation298().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat299().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation300().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat301().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation302().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat303().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation304().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat305().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation306().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat307().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation308().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat309().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation310().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat311().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation312().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat313().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation314().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat315().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation316().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat317().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation318().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat319().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation320().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat321().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation322().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat323().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation324().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat325().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation326().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat327().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation328().getArray())))
          .addChild(new PositionInterpolator().setDEF("Pitches_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat329().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f330().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat331().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation332().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat333().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation334().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat335().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation336().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat337().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation338().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat339().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation340().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat341().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation342().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat343().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation344().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat345().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation346().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat347().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation348().getArray()))))
        .addChild(new Group().setDEF("YawsAnimation")
          .addChild(new TimeSensor().setDEF("YawTimer").setCycleInterval(5.73d).setLoop(true))
          .addChild(new OrientationInterpolator().setDEF("Yaw_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat349().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation350().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat351().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation352().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat353().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation354().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat355().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation356().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat357().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation358().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat359().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation360().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat361().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation362().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat363().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation364().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat365().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation366().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat367().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation368().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat369().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation370().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat371().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation372().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat373().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation374().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat375().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation376().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat377().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation378().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat379().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation380().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat381().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation382().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat383().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation384().getArray())))
          .addChild(new PositionInterpolator().setDEF("Yaws_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat385().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f386().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat387().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation388().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat389().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation390().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat391().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation392().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat393().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation394().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat395().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation396().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat397().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation398().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat399().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation400().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat401().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation402().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat403().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation404().getArray()))))
        .addChild(new Group().setDEF("RollsAnimation")
          .addChild(new TimeSensor().setDEF("RollTimer").setCycleInterval(5.73d).setLoop(true))
          .addChild(new OrientationInterpolator().setDEF("Roll_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat405().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation406().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat407().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation408().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat409().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation410().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat411().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation412().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat413().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation414().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat415().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation416().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat417().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation418().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat419().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation420().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat421().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation422().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat423().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation424().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat425().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation426().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat427().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation428().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat429().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation430().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat431().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation432().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat433().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation434().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat435().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation436().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat437().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation438().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat439().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation440().getArray())))
          .addChild(new PositionInterpolator().setDEF("Rolls_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat441().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f442().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat443().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation444().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat445().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation446().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat447().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation448().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat449().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation450().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat451().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation452().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat453().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation454().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat455().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation456().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat457().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation458().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat459().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation460().getArray()))))
        .addChild(new Group().setDEF("WalkAnimation")
          .addChild(new TimeSensor().setDEF("WalkTimer").setCycleInterval(1.73d).setLoop(true))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat461().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation462().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat463().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation464().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat465().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation466().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat467().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation468().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat469().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation470().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat471().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation472().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat473().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation474().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat475().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation476().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat477().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation478().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat479().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation480().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat481().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation482().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat483().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation484().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat485().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation486().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat487().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation488().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat489().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation490().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat491().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation492().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat493().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation494().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat495().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation496().getArray())))
          .addChild(new PositionInterpolator().setDEF("Walk_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat497().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f498().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat499().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation500().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat501().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation502().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat503().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation504().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat505().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation506().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat507().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation508().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat509().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation510().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat511().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation512().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat513().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation514().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat515().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation516().getArray()))))
        .addChild(new Group().setDEF("RunAnimation")
          .addChild(new TimeSensor().setDEF("RunTimer").setCycleInterval(0.9d).setLoop(true))
          .addChild(new OrientationInterpolator().setDEF("Run_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat517().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation518().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_hip_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat519().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation520().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_knee_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat521().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation522().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_ankle_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat523().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation524().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_hip_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat525().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation526().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_knee_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat527().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation528().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_ankle_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat529().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation530().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_shoulder_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat531().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation532().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_elbow_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat533().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation534().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_wrist_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat535().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation536().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_shoulder_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat537().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation538().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_elbow_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat539().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation540().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_wrist_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat541().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation542().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_lower_body_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat543().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation544().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_head_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat545().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation546().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_neck_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat547().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation548().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_upper_body_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat549().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation550().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_whole_body_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat551().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation552().getArray())))
          .addChild(new PositionInterpolator().setDEF("Run_whole_body_TranslationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat553().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f554().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat555().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation556().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat557().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation558().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat559().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation560().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat561().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation562().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat563().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation564().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat565().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation566().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat567().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation568().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat569().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation570().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat571().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation572().getArray()))))
        .addChild(new Group().setDEF("JumpAnimation")
          .addChild(new TimeSensor().setDEF("JumpTimer").setCycleInterval(3.73d).setLoop(true))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat573().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation574().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat575().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation576().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat577().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation578().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat579().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation580().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat581().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation582().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat583().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation584().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat585().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation586().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat587().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation588().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat589().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation590().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat591().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation592().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat593().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation594().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat595().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation596().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat597().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation598().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat599().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation600().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat601().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation602().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat603().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation604().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat605().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation606().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat607().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation608().getArray())))
          .addChild(new PositionInterpolator().setDEF("Jump_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat609().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f610().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat611().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation612().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat613().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation614().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat615().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation616().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat617().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation618().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat619().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation620().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat621().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation622().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat623().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation624().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat625().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation626().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat627().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation628().getArray()))))
        .addChild(new Group().setDEF("KickAnimation")
          .addChild(new TimeSensor().setDEF("KickTimer").setCycleInterval(3.73d).setLoop(true))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat629().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation630().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat631().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation632().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_shoulder_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat633().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation634().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_ForeArm_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat635().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation636().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_wrist_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat637().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation638().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat639().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation640().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat641().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation642().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat643().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation644().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_shoulder_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat645().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation646().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_ForeArm_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat647().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation648().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_wrist_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat649().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation650().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat651().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation652().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_hip_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat653().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation654().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_knee_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat655().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation656().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_hip_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat657().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation658().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_knee_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat659().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation660().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_ankle_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat661().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation662().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat663().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation664().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat665().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation666().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat667().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation668().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat669().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation670().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat671().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation672().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat673().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation674().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat675().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation676().getArray())))
          .addChild(new PositionInterpolator().setDEF("Kick_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat677().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f678().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat679().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation680().getArray()))))

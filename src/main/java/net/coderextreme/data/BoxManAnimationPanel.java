    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Humanoid").setDEF("boxman_Humanoid").setInfo(new MFString3().getArray()).setVersion("1.0")
          .addSkeleton(new HAnimJoint().setName("humanoid_root").setDEF("boxman_humanoid_root").setCenter(new float[] {0f,0.9723f,-0.0728f}).setSkinCoordIndex(new MFInt324().getArray()).setSkinCoordWeight(new MFFloat5().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
            ...
            .addChild(new HAnimJoint().setName("l_hip").setDEF("boxman_l_hip").setCenter(new float[] {0.0956f,0.9364f,0f}).setSkinCoordIndex(new MFInt326().getArray()).setSkinCoordWeight(new MFFloat7().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
              ...
              .addChild(new HAnimJoint().setName("l_knee").setDEF("boxman_l_knee").setCenter(new float[] {0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new MFInt328().getArray()).setSkinCoordWeight(new MFFloat9().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                .addChild(new HAnimSegment().setName("l_calf").setDEF("boxman_l_calf")
                  .addChild(new Transform().setTranslation(new float[] {0.0956f,0.5095f,-0.0036f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("l_ankle").setDEF("boxman_l_ankle").setCenter(new float[] {0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new MFInt3210().getArray()).setSkinCoordWeight(new MFFloat11().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                  .addChild(new HAnimSegment().setName("l_hindfoot").setDEF("boxman_l_hindfoot")
                    .addChild(new Transform().setTranslation(new float[] {0.0946f,0.0762f,-0.0261f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("l_midtarsal").setDEF("boxman_l_midtarsal").setCenter(new float[] {0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new MFInt3212().getArray()).setSkinCoordWeight(new MFFloat13().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                    .addChild(new HAnimSegment().setName("l_middistal").setDEF("boxman_l_middistal")
                      ...
                      .addChild(new HAnimSite().setName("l_middistal_tip").setDEF("boxman_l_middistal_tip").setTranslation(new float[] {0.095f,0.0005f,0.1924f})
                        .addChild(new Shape().setDEF("SphereRed")
                          ...
                          .setGeometry(new Sphere().setRadius(0.02f)))))))))
            .addChild(new HAnimJoint().setName("r_hip").setDEF("boxman_r_hip").setCenter(new float[] {-0.0956f,0.9364f,0f}).setSkinCoordIndex(new MFInt3214().getArray()).setSkinCoordWeight(new MFFloat15().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
              .addChild(new HAnimSegment().setName("r_thigh").setDEF("boxman_r_thigh")
                .addChild(new Transform().setTranslation(new float[] {-0.0956f,0.9364f,0f})
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint().setName("r_knee").setDEF("boxman_r_knee").setCenter(new float[] {-0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new MFInt3216().getArray()).setSkinCoordWeight(new MFFloat17().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                .addChild(new HAnimSegment().setName("r_calf").setDEF("boxman_r_calf")
                  .addChild(new Transform().setTranslation(new float[] {-0.0956f,0.5095f,-0.0036f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("r_ankle").setDEF("boxman_r_ankle").setCenter(new float[] {-0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new MFInt3218().getArray()).setSkinCoordWeight(new MFFloat19().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                  .addChild(new HAnimSegment().setName("r_hindfoot").setDEF("boxman_r_hindfoot")
                    .addChild(new Transform().setTranslation(new float[] {-0.0946f,0.0762f,-0.0261f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("r_midtarsal").setDEF("boxman_r_midtarsal").setCenter(new float[] {-0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new MFInt3220().getArray()).setSkinCoordWeight(new MFFloat21().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
            ...
            .addChild(new HAnimJoint().setName("vl5").setDEF("boxman_vl5").setCenter(new float[] {0f,1.0817f,-0.0728f}).setSkinCoordIndex(new MFInt3222().getArray()).setSkinCoordWeight(new MFFloat23().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
              .addChild(new HAnimSegment().setName("l5").setDEF("boxman_l5")
                .addChild(new Transform().setTranslation(new float[] {0f,1.0817f,-0.0728f})
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint().setName("skullbase").setDEF("boxman_skullbase").setCenter(new float[] {0f,1.644f,0.036f}).setSkinCoordIndex(new MFInt3224().getArray()).setSkinCoordWeight(new MFFloat25().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                .addChild(new HAnimSegment().setName("skull").setDEF("boxman_skull")
                  ...
                  .addChild(new HAnimSite().setName("skull_tip").setDEF("boxman_skull_tip").setTranslation(new float[] {-0.0029f,1.7771f,0.0274f})
                    .addChild(new Shape().setUSE("SphereYellow")))))
              .addChild(new HAnimJoint().setName("l_shoulder").setDEF("boxman_l_shoulder").setCenter(new float[] {0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new MFInt3226().getArray()).setSkinCoordWeight(new MFFloat27().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                .addChild(new HAnimSegment().setName("l_upperarm").setDEF("boxman_l_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {0.1968f,1.4642f,-0.0265f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("l_elbow").setDEF("boxman_l_elbow").setCenter(new float[] {0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new MFInt3228().getArray()).setSkinCoordWeight(new MFFloat29().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                  .addChild(new HAnimSegment().setName("l_forearm").setDEF("boxman_l_forearm")
                    .addChild(new Transform().setTranslation(new float[] {0.1982f,1.1622f,-0.0557f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("l_wrist").setDEF("boxman_l_wrist").setCenter(new float[] {0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new MFInt3230().getArray()).setSkinCoordWeight(new MFFloat31().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                    .addChild(new HAnimSegment().setName("l_hand").setDEF("boxman_l_hand")
                      ...
                      .addChild(new HAnimSite().setName("l_hand_tip").setDEF("boxman_l_hand_tip").setTranslation(new float[] {0.1912f,0.6976f,-0.071f})
                        .addChild(new Shape().setUSE("SphereRed")))))))
              .addChild(new HAnimJoint().setName("r_shoulder").setDEF("boxman_r_shoulder").setCenter(new float[] {-0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new MFInt3232().getArray()).setSkinCoordWeight(new MFFloat33().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                .addChild(new HAnimSegment().setName("r_upperarm").setDEF("boxman_r_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {-0.1968f,1.4642f,-0.0265f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("r_elbow").setDEF("boxman_r_elbow").setCenter(new float[] {-0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new MFInt3234().getArray()).setSkinCoordWeight(new MFFloat35().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})
                  .addChild(new HAnimSegment().setName("r_forearm").setDEF("boxman_r_forearm")
                    .addChild(new Transform().setTranslation(new float[] {-0.1982f,1.1622f,-0.0557f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("r_wrist").setDEF("boxman_r_wrist").setCenter(new float[] {-0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new MFInt3236().getArray()).setSkinCoordWeight(new MFFloat37().getArray()).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f})

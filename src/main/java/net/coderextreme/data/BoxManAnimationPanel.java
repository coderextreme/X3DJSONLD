  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setContent("BoxManAnimationPanel.x3d").setName("title"))
        .addMeta(new metaObject().setContent("A Seamless VRML Human, demonstrating the H-Anim 2001 Specification, animation panel shows multiple behaviors.").setName("description"))
        .addMeta(new metaObject().setContent("Joe Williams and James Smith - james@vapourtech.com").setName("creator"))
        .addMeta(new metaObject().setContent("Joe Williams and Don Brutzman").setName("translator"))
        .addMeta(new metaObject().setContent(".x3d to .x3d translation used BS Contact Geo 8.203").setName("generator"))
        .addMeta(new metaObject().setContent("1 March 2001").setName("created"))
        .addMeta(new metaObject().setContent("12 January 2017").setName("revision"))
        .addMeta(new metaObject().setContent("14 January 2017").setName("translated"))
        .addMeta(new metaObject().setContent("20 October 2019").setName("modified"))
        .addMeta(new metaObject().setContent("BoxManAnimationPanelInclined.png").setName("Image"))
        .addMeta(new metaObject().setContent("BoxManAnimationPanel.mp4").setName("MovingImage"))
        .addMeta(new metaObject().setContent("https://www.youtube.com/watch?v=8tI83Rtg_DU").setName("MovingImage"))
        .addMeta(new metaObject().setContent("https://twitter.com/Web3DConsortium/status/820638047523913728").setName("reference"))
        .addMeta(new metaObject().setContent("https://twitter.com/Web3DConsortium/status/820642726009978881").setName("reference"))
        .addMeta(new metaObject().setContent("http://h-anim.org").setName("reference"))
        .addMeta(new metaObject().setContent("boxman.original.wrl").setName("reference"))
        .addMeta(new metaObject().setContent("InstantReality Forum Issue: InstantReality is ignoring the Viewpoint nodes in the topmost HAnimSite. http://forum.instantreality.org").setName("TODO"))
        .addMeta(new metaObject().setContent("BoxMan.x3d").setName("reference"))
        .addMeta(new metaObject().setContent("http://h-anim.org/Models/H-Anim2001/boxman").setName("reference"))
        .addMeta(new metaObject().setContent("http://h-anim.org/Models/H-Anim2001/boxman/boxman.wrl").setName("reference"))
        .addMeta(new metaObject().setContent("http://www.vapourtech.com/team/james/boxman.wrl").setName("reference"))
        .addMeta(new metaObject().setContent("http://h-anim.org/Specifications/H-Anim2001").setName("reference"))
        .addMeta(new metaObject().setContent("http://h-anim.org/Models").setName("reference"))
        .addMeta(new metaObject().setContent("http://h-anim.org/Nodes").setName("reference"))
        .addMeta(new metaObject().setContent("https://www.web3d.org/x3d/content/X3dToVrml97.xslt").setName("reference"))
        .addMeta(new metaObject().setContent("(C) 2000 James Smith - james@vapourtech.com").setName("rights"))
        .addMeta(new metaObject().setContent("http://www.vapourtech.com").setName("reference"))
        .addMeta(new metaObject().setContent("BoxMan H-Anim 2.0").setName("subject"))
        .addMeta(new metaObject().setContent("https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/BoxManAnimationPanel.x3d").setName("identifier"))
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new HAnimHumanoidObject().setDEF("boxman_Humanoid").setInfo(new MFStringObject(new MFString3().getArray())).setName("Humanoid").setVersion("2.0")
          .addJoints(new HAnimJointObject().setDEF("boxman_HumanoidRoot").setCenter(new float[] {0f,0.9723f,-0.0728f}).setName("humanoid_root").setSkinCoordIndex(new MFInt32Object(new MFInt324().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat5().getArray()))
            ...
            .addChild(new HAnimJointObject().setDEF("boxman_l_hip").setCenter(new float[] {0.0956f,0.9364f,0f}).setName("l_hip").setSkinCoordIndex(new MFInt32Object(new MFInt326().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat7().getArray()))
              .addChild(new HAnimSegmentObject().setDEF("boxman_l_thigh").setName("l_thigh")
                .addChild(new TransformObject().setTranslation(new float[] {0.0956f,0.9364f,0f})
                  .addChild(new ShapeObject().setUSE("SphereYellow"))))
              .addChild(new HAnimJointObject().setDEF("boxman_l_knee").setCenter(new float[] {0.0956f,0.5095f,-0.0036f}).setName("l_knee").setSkinCoordIndex(new MFInt32Object(new MFInt328().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat9().getArray()))
                .addChild(new HAnimSegmentObject().setDEF("boxman_l_calf").setName("l_calf")
                  .addChild(new TransformObject().setTranslation(new float[] {0.0956f,0.5095f,-0.0036f})
                    .addChild(new ShapeObject().setUSE("SphereYellow"))))
                .addChild(new HAnimJointObject().setDEF("boxman_l_ankle").setCenter(new float[] {0.0946f,0.0762f,-0.0261f}).setName("l_ankle").setSkinCoordIndex(new MFInt32Object(new MFInt3210().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat11().getArray()))
                  .addChild(new HAnimSegmentObject().setDEF("boxman_l_hindfoot").setName("l_hindfoot")
                    .addChild(new TransformObject().setTranslation(new float[] {0.0946f,0.0762f,-0.0261f})
                      .addChild(new ShapeObject().setUSE("SphereYellow"))))
                  .addChild(new HAnimJointObject().setDEF("boxman_l_midtarsal").setCenter(new float[] {0.1079f,0.0317f,0.067f}).setName("l_midtarsal").setSkinCoordIndex(new MFInt32Object(new MFInt3212().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat13().getArray()))
                    .addChild(new HAnimSegmentObject().setDEF("boxman_l_middistal").setName("l_middistal")
                      .addChild(new TransformObject().setTranslation(new float[] {0.1079f,0.0317f,0.067f})
                        .addChild(new ShapeObject().setUSE("SphereYellow")))
                      .addChild(new HAnimSiteObject().setDEF("boxman_l_middistal_tip").setName("l_middistal_tip").setTranslation(new float[] {0.095f,0.0005f,0.1924f})
                        .addChild(new ShapeObject().setDEF("SphereRed")
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setDiffuseColor(new float[] {1f,0f,0f})))
                          .setGeometry(new SphereObject().setRadius(0.02f)))))))))
            .addChild(new HAnimJointObject().setDEF("boxman_r_hip").setCenter(new float[] {-0.0956f,0.9364f,0f}).setName("r_hip").setSkinCoordIndex(new MFInt32Object(new MFInt3214().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat15().getArray()))
              .addChild(new HAnimSegmentObject().setDEF("boxman_r_thigh").setName("r_thigh")
                .addChild(new TransformObject().setTranslation(new float[] {-0.0956f,0.9364f,0f})
                  .addChild(new ShapeObject().setUSE("SphereYellow"))))
              .addChild(new HAnimJointObject().setDEF("boxman_r_knee").setCenter(new float[] {-0.0956f,0.5095f,-0.0036f}).setName("r_knee").setSkinCoordIndex(new MFInt32Object(new MFInt3216().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat17().getArray()))
                .addChild(new HAnimSegmentObject().setDEF("boxman_r_calf").setName("r_calf")
                  .addChild(new TransformObject().setTranslation(new float[] {-0.0956f,0.5095f,-0.0036f})
                    .addChild(new ShapeObject().setUSE("SphereYellow"))))
                .addChild(new HAnimJointObject().setDEF("boxman_r_ankle").setCenter(new float[] {-0.0946f,0.0762f,-0.0261f}).setName("r_ankle").setSkinCoordIndex(new MFInt32Object(new MFInt3218().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat19().getArray()))
                  .addChild(new HAnimSegmentObject().setDEF("boxman_r_hindfoot").setName("r_hindfoot")
                    .addChild(new TransformObject().setTranslation(new float[] {-0.0946f,0.0762f,-0.0261f})
                      .addChild(new ShapeObject().setUSE("SphereYellow"))))
                  .addChild(new HAnimJointObject().setDEF("boxman_r_midtarsal").setCenter(new float[] {-0.1079f,0.0317f,0.067f}).setName("r_midtarsal").setSkinCoordIndex(new MFInt32Object(new MFInt3220().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat21().getArray()))
                    .addChild(new HAnimSegmentObject().setDEF("boxman_r_middistal").setName("r_middistal")
                      .addChild(new TransformObject().setTranslation(new float[] {-0.1079f,0.0317f,0.067f})
                        .addChild(new ShapeObject().setUSE("SphereYellow")))
                      .addChild(new HAnimSiteObject().setDEF("boxman_r_middistal_tip").setName("r_middistal_tip").setTranslation(new float[] {-0.095f,0.0005f,0.1924f})
                        .addChild(new ShapeObject().setUSE("SphereRed"))))))))
            .addChild(new HAnimJointObject().setDEF("boxman_vl5").setCenter(new float[] {0f,1.0817f,-0.0728f}).setName("vl5").setSkinCoordIndex(new MFInt32Object(new MFInt3222().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat23().getArray()))
              .addChild(new HAnimSegmentObject().setDEF("boxman_l5").setName("l5")
                .addChild(new TransformObject().setTranslation(new float[] {0f,1.0817f,-0.0728f})
                  .addChild(new ShapeObject().setUSE("SphereYellow"))))
              .addChild(new HAnimJointObject().setDEF("boxman_skullbase").setCenter(new float[] {0f,1.644f,0.036f}).setName("skullbase").setSkinCoordIndex(new MFInt32Object(new MFInt3224().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat25().getArray()))
                .addChild(new HAnimSegmentObject().setDEF("boxman_skull").setName("skull")
                  .addChild(new TransformObject().setTranslation(new float[] {0f,1.644f,0.036f})
                    .addChild(new ShapeObject().setUSE("SphereYellow")))
                  .addChild(new HAnimSiteObject().setDEF("boxman_skull_tip").setName("skull_tip").setTranslation(new float[] {-0.0029f,1.7771f,0.0274f})
                    .addChild(new ShapeObject().setUSE("SphereYellow")))))
              .addChild(new HAnimJointObject().setDEF("boxman_l_shoulder").setCenter(new float[] {0.1968f,1.4642f,-0.0265f}).setName("l_shoulder").setSkinCoordIndex(new MFInt32Object(new MFInt3226().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat27().getArray()))
                .addChild(new HAnimSegmentObject().setDEF("boxman_l_upperarm").setName("l_upperarm")
                  .addChild(new TransformObject().setTranslation(new float[] {0.1968f,1.4642f,-0.0265f})
                    .addChild(new ShapeObject().setUSE("SphereYellow"))))
                .addChild(new HAnimJointObject().setDEF("boxman_l_elbow").setCenter(new float[] {0.1982f,1.1622f,-0.0557f}).setName("l_elbow").setSkinCoordIndex(new MFInt32Object(new MFInt3228().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat29().getArray()))
                  .addChild(new HAnimSegmentObject().setDEF("boxman_l_forearm").setName("l_forearm")
                    .addChild(new TransformObject().setTranslation(new float[] {0.1982f,1.1622f,-0.0557f})
                      .addChild(new ShapeObject().setUSE("SphereYellow"))))
                  .addChild(new HAnimJointObject().setDEF("boxman_l_wrist").setCenter(new float[] {0.1972f,0.8929f,-0.069f}).setName("l_wrist").setSkinCoordIndex(new MFInt32Object(new MFInt3230().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat31().getArray()))
                    .addChild(new HAnimSegmentObject().setDEF("boxman_l_hand").setName("l_hand")
                      .addChild(new TransformObject().setTranslation(new float[] {0.1972f,0.8929f,-0.069f})
                        .addChild(new ShapeObject().setUSE("SphereYellow")))
                      .addChild(new HAnimSiteObject().setDEF("boxman_l_hand_tip").setName("l_hand_tip").setTranslation(new float[] {0.1912f,0.6976f,-0.071f})
                        .addChild(new ShapeObject().setUSE("SphereRed")))))))
              .addChild(new HAnimJointObject().setDEF("boxman_r_shoulder").setCenter(new float[] {-0.1968f,1.4642f,-0.0265f}).setName("r_shoulder").setSkinCoordIndex(new MFInt32Object(new MFInt3232().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat33().getArray()))
                .addChild(new HAnimSegmentObject().setDEF("boxman_r_upperarm").setName("r_upperarm")
                  .addChild(new TransformObject().setTranslation(new float[] {-0.1968f,1.4642f,-0.0265f})
                    .addChild(new ShapeObject().setUSE("SphereYellow"))))
                .addChild(new HAnimJointObject().setDEF("boxman_r_elbow").setCenter(new float[] {-0.1982f,1.1622f,-0.0557f}).setName("r_elbow").setSkinCoordIndex(new MFInt32Object(new MFInt3234().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat35().getArray()))
                  .addChild(new HAnimSegmentObject().setDEF("boxman_r_forearm").setName("r_forearm")
                    .addChild(new TransformObject().setTranslation(new float[] {-0.1982f,1.1622f,-0.0557f})
                      .addChild(new ShapeObject().setUSE("SphereYellow"))))
                  .addChild(new HAnimJointObject().setDEF("boxman_r_wrist").setCenter(new float[] {-0.1972f,0.8929f,-0.069f}).setName("r_wrist").setSkinCoordIndex(new MFInt32Object(new MFInt3236().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat37().getArray()))
                    .addChild(new HAnimSegmentObject().setDEF("boxman_r_hand").setName("r_hand")
                      .addChild(new TransformObject().setTranslation(new float[] {-0.1972f,0.8929f,-0.069f})
                        .addChild(new ShapeObject().setUSE("SphereYellow")))
                      .addChild(new HAnimSiteObject().setDEF("boxman_r_hand_tip").setName("r_hand_tip").setTranslation(new float[] {-0.1912f,0.6976f,-0.071f})
                        .addChild(new ShapeObject().setUSE("SphereRed")))))))))
          ...
          .addViewpoints(new HAnimSiteObject().setUSE("boxman_l_middistal_tip"))
          .addViewpoints(new HAnimSiteObject().setUSE("boxman_r_middistal_tip"))
          .addViewpoints(new HAnimSiteObject().setUSE("boxman_skull_tip"))
          .addViewpoints(new HAnimSiteObject().setUSE("boxman_l_hand_tip"))
          .addViewpoints(new HAnimSiteObject().setUSE("boxman_r_hand_tip"))
          .setViewpoints(new HAnimSiteObject().setName("BoxMan_view")
            .addChild(new ViewpointObject().setDEF("Inclined_View").setDescription("Inclined View").setOrientation(new float[] {0f,1f,0f,0.78f}).setPosition(new float[] {2f,0.9f,2f}))
            .addChild(new ViewpointObject().setDEF("Front_View").setDescription("Front View").setPosition(new float[] {0f,1f,3f}))
            .addChild(new ViewpointObject().setDEF("Best_View").setDescription("Right-side View").setOrientation(new float[] {0f,1f,0f,-1.57f}).setPosition(new float[] {-3f,1f,0f}))
            .addChild(new ViewpointObject().setDEF("Side_View").setDescription("Left-side View").setOrientation(new float[] {0f,1f,0f,1.57f}).setPosition(new float[] {3f,1f,0f}))
        ...
        .addChild(new GroupObject().setDEF("Interface")
          ...
          .addChild(new TransformObject().setDEF("HudXform").setRotation(new float[] {0f,1f,0f,0.78f}).setTranslation(new float[] {2f,1f,2f})
            .addChild(new TransformObject().setScale(new float[] {0.02f,0.02f,0.02f}).setTranslation(new float[] {-0.4f,-0.01f,-0.75f})
              ...
              .addChild(new TransformObject().setDEF("Stop_Text").setTranslation(new float[] {0f,0.4f,0f})
                ...
                .addChild(new ShapeObject().setDEF("Stop_Back")
                  .setAppearance(new AppearanceObject()
                    .setMaterial(new MaterialObject().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSetObject().setUSE("Backing"))))
              .addChild(new TransformObject().setDEF("SceneLabel").setTranslation(new float[] {1.3f,3f,0f})
                .addChild(new ShapeObject().setDEF("SceneLabelText")
                  .setAppearance(new AppearanceObject()
                    .setMaterial(new MaterialObject().setUSE("text_color")))
                  .setGeometry(new TextObject().setString(new MFStringObject(new MFString705().getArray()))
                    .setFontStyle(new FontStyleObject().setFamily(new MFStringObject(new MFString706().getArray())).setJustify(new MFStringObject(new MFString707().getArray())))))))))
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_HumanoidRootTransInterp").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_HumanoidRootRotInterp").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_l_hipRotInterp").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_l_kneeRotInterp").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_l_ankleRotInterp").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_l_midtarsalRotInterp").setToField("set_rotation").setToNode("boxman_l_midtarsal"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_r_hipRotInterp").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_r_kneeRotInterp").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_r_ankleRotInterp").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_r_midtarsalRotInterp").setToField("set_rotation").setToNode("boxman_r_midtarsal"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_vl5RotInterp").setToField("set_rotation").setToNode("boxman_vl5"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_skullbaseRotInterp").setToField("set_rotation").setToNode("boxman_skullbase"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_l_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_l_elbowRotInterp").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_l_wristRotInterp").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_r_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_r_elbowRotInterp").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stop_r_wristRotInterp").setToField("set_rotation").setToNode("boxman_r_wrist"))
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_r_ankleRotInterp").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_r_kneeRotInterp").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_r_hipRotInterp").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_l_ankleRotInterp").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_l_kneeRotInterp").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_l_hipRotInterp").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_r_wristRotInterp").setToField("set_rotation").setToNode("boxman_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_r_elbowRotInterp").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_r_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_l_wristRotInterp").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_l_elbowRotInterp").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_l_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_headRotInterp").setToField("set_rotation").setToNode("boxman_skullbase"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_whole_bodyRotInterp").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_whole_bodyTransInterp").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Stand_vl5Yaw").setToField("set_rotation").setToNode("boxman_vl5"))
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_r_ankleRotInterp").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_r_kneeRotInterp").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_r_hipRotInterp").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_l_ankleRotInterp").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_l_kneeRotInterp").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_l_hipRotInterp").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_r_wristRotInterp").setToField("set_rotation").setToNode("boxman_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_r_elbowRotInterp").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_r_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_l_wristRotInterp").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_l_elbowRotInterp").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_l_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_headRotInterp").setToField("set_rotation").setToNode("boxman_skullbase"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_whole_bodyRotInterp").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitches_whole_bodyTransInterp").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Pitch_vl5Yaw").setToField("set_rotation").setToNode("boxman_vl5"))
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_r_ankleRotInterp").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_r_kneeRotInterp").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_r_hipRotInterp").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_l_ankleRotInterp").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_l_kneeRotInterp").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_l_hipRotInterp").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_r_wristRotInterp").setToField("set_rotation").setToNode("boxman_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_r_elbowRotInterp").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_r_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_l_wristRotInterp").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_l_elbowRotInterp").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_l_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_headRotInterp").setToField("set_rotation").setToNode("boxman_skullbase"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_whole_bodyRotInterp").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaws_whole_bodyTransInterp").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Yaw_vl5Yaw").setToField("set_rotation").setToNode("boxman_vl5"))
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_r_ankleRotInterp").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_r_kneeRotInterp").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_r_hipRotInterp").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_l_ankleRotInterp").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_l_kneeRotInterp").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_l_hipRotInterp").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_r_wristRotInterp").setToField("set_rotation").setToNode("boxman_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_r_elbowRotInterp").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_r_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_l_wristRotInterp").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_l_elbowRotInterp").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_l_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_headRotInterp").setToField("set_rotation").setToNode("boxman_skullbase"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_whole_bodyRotInterp").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Rolls_whole_bodyTransInterp").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Roll_vl5Yaw").setToField("set_rotation").setToNode("boxman_vl5"))
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_r_ankleRotInterp").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_r_kneeRotInterp").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_r_hipRotInterp").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_l_ankleRotInterp").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_l_kneeRotInterp").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_l_hipRotInterp").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_r_wristRotInterp").setToField("set_rotation").setToNode("boxman_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_r_elbowRotInterp").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_r_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_l_wristRotInterp").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_l_elbowRotInterp").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_l_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_headRotInterp").setToField("set_rotation").setToNode("boxman_skullbase"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_whole_bodyRotInterp").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_whole_bodyTranInterp").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Walk_vl5Yaw").setToField("set_rotation").setToNode("boxman_vl5"))
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_r_ankleRotInterp_Run").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_r_kneeRotInterp_Run").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_r_hipRotInterp_Run").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_l_ankleRotInterp_Run").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_l_kneeRotInterp_Run").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_l_hipRotInterp_Run").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_r_wristRotInterp_Run").setToField("set_rotation").setToNode("boxman_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_r_elbowRotInterp_Run").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_r_shoulderRotInterp_Run").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_l_wristRotInterp_Run").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_l_elbowRotInterp_Run").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_l_shoulderRotInterp_Run").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_headRotInterp_Run").setToField("set_rotation").setToNode("boxman_skullbase"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_whole_bodyRotInterp_Run").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_whole_bodyTranInterp_Run").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Run_vl5Yaw").setToField("set_rotation").setToNode("boxman_vl5"))
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_r_ankleRotInterp").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_r_kneeRotInterp").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_r_hipRotInterp").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_l_ankleRotInterp").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_l_kneeRotInterp").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_l_hipRotInterp").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_r_wristRotInterp").setToField("set_rotation").setToNode("boxman_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_r_elbowRotInterp").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_r_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_l_wristRotInterp").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_l_elbowRotInterp").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_l_shoulderRotInterp").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_headRotInterp").setToField("set_rotation").setToNode("boxman_skullbase"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_whole_bodyRotInterp").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_whole_bodyTranInterp").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Jump_vl5Yaw").setToField("set_rotation").setToNode("boxman_vl5"))
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_l_shoulderRoll").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_l_ForeArmPitch").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_l_wristRoll").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_r_shoulderRoll").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_r_ForeArmPitch").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_r_wristRoll").setToField("set_rotation").setToNode("boxman_r_wrist"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_r_hipPitch").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_r_kneePitch").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_r_anklePitch").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_l_hipPitch").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_l_kneePitch").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_r_anklePitch").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_vl5Yaw").setToField("set_rotation").setToNode("boxman_vl5"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_whole_bodyRotInterp").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("Kick_whole_bodyTransInterp").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
...
protected class MFString705 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"BoxMan","Animation"});
  }
}

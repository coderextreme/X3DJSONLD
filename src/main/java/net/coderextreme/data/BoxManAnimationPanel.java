    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new HAnimHumanoidObject().setName("Humanoid").setDEF("hanim_Humanoid").setInfo(new MFStringObject(new MFString3().getArray())).setVersion("2.0")
          .addJoints(new HAnimJointObject().setName("HumanoidRoot").setDEF("hanim_HumanoidRoot").setCenter(new float[] {0f,0.9723f,-0.0728f}).setSkinCoordIndex(new MFInt32Object(new MFInt324().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat5().getArray()))

...
public class bubs implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/bubs.new.java.x3dj");
    }
...
ProtoInstance ProtoInstance3 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("bubs.x3d")))
        ...
        .addChild(new ProtoDeclare().setName(new SFString("Bubble"))
          .setProtoBody(new ProtoBody()
            .addChild(new Transform().setDEF(new SFString("body_trans"))
              ...
              .addChild(new Script().setDEF(new SFString("bounce1"))
...
"}"))
              ...
              .addChild(new ROUTE().setFromNode(new SFString("bounce1")).setFromField(new SFString("translation_changed")).setToNode(new SFString("body_trans")).setToField(new SFString("set_translation")))
              .addChild(new ROUTE().setFromNode(new SFString("bounce1")).setFromField(new SFString("scale_changed")).setToNode(new SFString("body_trans")).setToField(new SFString("set_scale")))
              .addChild(new ROUTE().setFromNode(new SFString("bubbleClock")).setFromField(new SFString("fraction_changed")).setToNode(new SFString("bounce1")).setToField(new SFString("set_fraction"))))))

        ...
        .addChild(new HAnimHumanoid().setName("JinLOA3").setDEF("hanim_JinLOA3").setLoa(3).setScale(new float[] {0.0225f,0.0225f,0.0225f}).setVersion("2.0")
          ...
          .addSkeleton(new HAnimJoint().setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f,35.799999f,-0.7076f})
              ...
              .addChild(new Transform().setTranslation(new float[] {0f,35.799999f,-0.7076f})
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("JinLOA3TextureAtlas").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString6().getArray()))))
            ...
            .addChild(new HAnimJoint().setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f,40.220001f,-0.6117f})
              ...
              .addChild(new HAnimJoint().setName("vl4").setDEF("hanim_vl4").setCenter(new float[] {0f,41.299999f,-0.6117f})
                ...
                .addChild(new HAnimJoint().setName("vl3").setDEF("hanim_vl3").setCenter(new float[] {0f,42.029999f,-0.6117f})
                  ...
                  .addChild(new HAnimJoint().setName("vl2").setDEF("hanim_vl2").setCenter(new float[] {0f,42.759998f,-0.6117f})
                    ...
                    .addChild(new HAnimJoint().setName("vl1").setDEF("hanim_vl1").setCenter(new float[] {0f,43.52f,-0.6117f})
                      ...
                      .addChild(new HAnimJoint().setName("vt12").setDEF("hanim_vt12").setCenter(new float[] {0f,44.57f,-0.6117f})
                        ...
                        .addChild(new HAnimJoint().setName("vt11").setDEF("hanim_vt11").setCenter(new float[] {0f,45.610001f,-0.6117f})
                          ...
                          .addChild(new HAnimJoint().setName("vt10").setDEF("hanim_vt10").setCenter(new float[] {0f,46.369999f,-0.6127f})
                            ...
                            .addChild(new HAnimJoint().setName("vt9").setDEF("hanim_vt9").setCenter(new float[] {0f,47.029999f,-0.6117f})
                              ...
                              .addChild(new HAnimJoint().setName("vt8").setDEF("hanim_vt8").setCenter(new float[] {0f,47.68f,-0.6117f})
                                ...
                                .addChild(new HAnimJoint().setName("vt7").setDEF("hanim_vt7").setCenter(new float[] {0f,48.369999f,-0.6117f})
                                  ...
                                  .addChild(new HAnimJoint().setName("vt6").setDEF("hanim_vt6").setCenter(new float[] {0f,48.950001f,-0.6117f})
                                    ...
                                    .addChild(new HAnimJoint().setName("vt5").setDEF("hanim_vt5").setCenter(new float[] {0f,49.639999f,-0.6117f})
                                      ...
                                      .addChild(new HAnimJoint().setName("vt4").setDEF("hanim_vt4").setCenter(new float[] {0f,50.310001f,-0.6117f})
                                        ...
                                        .addChild(new HAnimJoint().setName("vt3").setDEF("hanim_vt3").setCenter(new float[] {0f,51.130001f,-0.6117f})
                                          ...
                                          .addChild(new HAnimJoint().setName("vt2").setDEF("hanim_vt2").setCenter(new float[] {0f,52.23f,-0.6127f})
                                            ...
                                            .addChild(new HAnimJoint().setName("vt1").setDEF("hanim_vt1").setCenter(new float[] {0f,53.290001f,-0.6117f})
                                              ...
                                              .addChild(new HAnimJoint().setName("vc7").setDEF("hanim_vc7").setCenter(new float[] {0f,54.450001f,-0.6695f})
                                                ...
                                                .addChild(new HAnimJoint().setName("vc6").setDEF("hanim_vc6").setCenter(new float[] {0f,54.98f,-0.6695f})
                                                  ...
                                                  .addChild(new HAnimJoint().setName("vc5").setDEF("hanim_vc5").setCenter(new float[] {0f,55.540001f,-0.6695f})
                                                    ...
                                                    .addChild(new HAnimJoint().setName("vc4").setDEF("hanim_vc4").setCenter(new float[] {0f,56.080002f,-0.6695f})
                                                      ...
                                                      .addChild(new HAnimJoint().setName("vc3").setDEF("hanim_vc3").setCenter(new float[] {0f,56.66f,-0.6695f})
                                                        ...
                                                        .addChild(new HAnimJoint().setName("vc2").setDEF("hanim_vc2").setCenter(new float[] {0f,57.169998f,-0.6695f})
                                                          ...
                                                          .addChild(new HAnimJoint().setName("vc1").setDEF("hanim_vc1").setCenter(new float[] {0f,57.689999f,-0.6695f})
                                                            ...
                                                            .addChild(new HAnimJoint().setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f,57.43f,-0.6863f})
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0f,57.43f,-0.6863f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32159().getArray()).append(new MFInt32160().getArray()).append(new MFInt32161().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32162().getArray()).append(new MFInt32163().getArray()).append(new MFInt32164().getArray()))
                                                                      .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f165().getArray()).append(new MFVec3f166().getArray())))
                                                                      .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f167().getArray()).append(new MFVec2f168().getArray())))))))
                                                              .addChild(new HAnimJoint().setName("l_eyelid_joint").setDEF("hanim_l_eyelid_joint").setCenter(new float[] {2.245f,62.400002f,1.464f})
                                                              ...
                                                              .addChild(new HAnimJoint().setName("r_eyelid_joint").setDEF("hanim_r_eyelid_joint").setCenter(new float[] {-2.245f,62.400002f,1.464f})
                                                              ...
                                                              .addChild(new HAnimJoint().setName("l_eyeball_joint").setDEF("hanim_l_eyeball_joint").setCenter(new float[] {2.139f,61.529999f,3.691f})
                                                              ...
                                                              .addChild(new HAnimJoint().setName("r_eyeball_joint").setDEF("hanim_r_eyeball_joint").setCenter(new float[] {-2.139f,61.529999f,3.691f})
                                                              ...
                                                              .addChild(new HAnimJoint().setName("l_eyebrow_joint").setDEF("hanim_l_eyebrow_joint").setCenter(new float[] {0.9666f,61.93f,4.753f})
                                                              ...
                                                              .addChild(new HAnimJoint().setName("r_eyebrow_joint").setDEF("hanim_r_eyebrow_joint").setCenter(new float[] {-0.9666f,61.93f,4.753f})
                                                              ...
                                                              .addChild(new HAnimJoint().setName("temporomandibular").setDEF("hanim_temporomandibular").setCenter(new float[] {0f,57.450001f,0.6835f})
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {8.153f,26.040001f,-1.886f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32289().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32290().getArray()))
                                                                        .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f291().getArray())))
                                                                        .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f292().getArray()))))))))))))))))
                                                  ...
                                                  .addChild(new Transform().setTranslation(new float[] {-1.71f,52.82f,-0.6127f})
                                                    .addChild(new Shape()
                                                      .setAppearance(new Appearance()
                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                        .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32293().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32294().getArray()))
                                                        .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f295().getArray())))
                                                        .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f296().getArray())))))))
                                                    ...
                                                    .addChild(new Transform().setTranslation(new float[] {-5.464f,52.060001f,-0.5732f})
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                        .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32297().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32298().getArray()))
                                                          .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f299().getArray())))
                                                          .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f300().getArray())))))))
                                                      ...
                                                      .addChild(new Transform().setTranslation(new float[] {-7.336f,51.48f,-0.1452f})
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                          .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32301().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32302().getArray()))
                                                            .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f303().getArray())))
                                                            .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f304().getArray())))))))
                                                        ...
                                                        .addChild(new Transform().setTranslation(new float[] {-8.093f,40.380001f,-0.2502f})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                            .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32305().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32306().getArray()))
                                                              .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f307().getArray())))
                                                              .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f308().getArray())))))))
                                                          ...
                                                          .addChild(new Transform().setTranslation(new float[] {-7.899f,31.43f,-0.3809f})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32309().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32310().getArray()))
                                                                .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f311().getArray())))
                                                                .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f312().getArray())))))))
                                                            ...
                                                            .addChild(new Transform().setTranslation(new float[] {-8.205f,29.6f,1.302f})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32313().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32314().getArray()))
                                                                  .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f315().getArray())))
                                                                  .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f316().getArray())))))))
                                                              ...
                                                              .addChild(new Transform().setTranslation(new float[] {-8.08f,28.73f,1.55f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32317().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32318().getArray()))
                                                                    .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f319().getArray())))
                                                                    .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f320().getArray())))))))
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {-7.832f,27.85f,1.735f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32321().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32322().getArray()))
                                                                      .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f323().getArray())))
                                                                      .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f324().getArray()))))))))))
                                                            ...
                                                            .addChild(new Transform().setTranslation(new float[] {-8.376f,28.549999f,0.5997f})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32325().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32326().getArray()))
                                                                  .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f327().getArray())))
                                                                  .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f328().getArray())))))))
                                                              ...
                                                              .addChild(new Transform().setTranslation(new float[] {-8.52f,27.24f,0.6551f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32329().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32330().getArray()))
                                                                    .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f331().getArray())))
                                                                    .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f332().getArray())))))))
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {-8.45f,26.1f,0.6956f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32333().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32334().getArray()))
                                                                      .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f335().getArray())))
                                                                      .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f336().getArray())))))))
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-8.192f,25.17f,0.7315f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32337().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32338().getArray()))
                                                                        .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f339().getArray())))
                                                                        .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f340().getArray())))))))))))
                                                            ...
                                                            .addChild(new Transform().setTranslation(new float[] {-8.344f,28.65f,-0.194f})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA3TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32341().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32342().getArray()))
                                                                  .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f343().getArray())))
                                                                  .setTexCoord(new TextureCoordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f344().getArray())))))))

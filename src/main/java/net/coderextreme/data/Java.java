          ...
          .addChild(new ShapeObject()
            ...
            .setGeometry(new TextObject().setString(new MFStringObject(new MFString6().getArray()))
              ...
              .setMetadata(new MetadataSetObject().setName("EscapedQuotationMarksMetadataSet")
                .addValue(new MetadataStringObject().setName("quotesTestC").setValue(new MFStringObject(new MFString7().getArray())))
                .addValue(new MetadataStringObject().setName("extraChildTest").setValue(new MFStringObject(new MFString8().getArray()))))
              .setFontStyle(new FontStyleObject().setFamily(new MFStringObject(new MFString9().getArray())).setJustify(new MFStringObject(new MFString10().getArray())))))
...
"}"))))
        ...
        .addChild(new GroupObject().setDEF("DeclarativeGroupExample")
          .addChild(new ShapeObject()
            .setMetadata(new MetadataStringObject().setDEF("FindableMetadataStringTest").setName("findThisNameValue").setValue(new MFStringObject(new MFString18().getArray())))
        ...
        .addMetadata(new MetadataStringObject().setDEF("scene.addChildMetadata").setName("test").setValue(new MFStringObject(new MFString21().getArray())))
        .addLayerSet(new LayerSetObject().setDEF("scene.addChildLayerSetTest").setOrder(new MFInt32Object(new MFInt3222().getArray()))))      ;
ProtoInstance0

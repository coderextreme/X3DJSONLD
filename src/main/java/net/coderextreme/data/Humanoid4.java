      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("HAnim").setDEF("hanim_HAnim").setInfo(new MFString10().getArray()).setVersion("2.0")
          ...
          .addSkin(new Shape().setDEF("SkinShape")
            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3211().getArray().append(new MFInt3212().getArray()).append(new MFInt3213().getArray()).append(new MFInt3214().getArray())).setCreaseAngle(3.1000f)
            ...
            .setAppearance(new Appearance().setDEF("SkinAppearance")
              ...
              .setMaterial(new Material().setDEF("SkinMaterial").setAmbientIntensity(0.6000f).setDiffuseColor(new float[] {1f,1f,1f}).setShininess(0.6000f).setTransparency(0.2000f))))
                    ...
                    .addChild(new HAnimSegment().setName("l_talus").setDEF("hanim_l_talus")
                      ...
                      .addChild(new Shape()
                        .setGeometry(new LineSet().setVertexCount(new MFInt3245().getArray())
                          ...
                          .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                    .addChild(new HAnimJoint().setName("l_talocalcaneonavicular").setDEF("hanim_l_talocalcaneonavicular").setUlimit(new MFFloat47().getArray()).setLlimit(new MFFloat48().getArray())
                      .addChild(new HAnimSegment().setName("l_navicular").setDEF("hanim_l_navicular")
                        ...
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(new MFInt3249().getArray())
                            ...
                            .addComments("from l_talocalcaneonavicular to l_cuneonavicular_1 vertices 1")
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(new MFInt3251().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f52().getArray()))
                            .addComments("from l_talocalcaneonavicular to l_cuneonavicular_2 vertices 1")
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(new MFInt3253().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f54().getArray()))
                            .addComments("from l_talocalcaneonavicular to l_cuneonavicular_3 vertices 1")
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                      .addChild(new HAnimJoint().setName("l_cuneonavicular_1").setDEF("hanim_l_cuneonavicular_1").setUlimit(new MFFloat55().getArray()).setLlimit(new MFFloat56().getArray())
                        .addChild(new HAnimSegment().setName("l_cuneiform_1").setDEF("hanim_l_cuneiform_1")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt3257().getArray())
                              ...
                              .addComments("from l_cuneonavicular_1 to l_tarsometatarsal_1 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint().setName("l_tarsometatarsal_1").setDEF("hanim_l_tarsometatarsal_1").setUlimit(new MFFloat59().getArray()).setLlimit(new MFFloat60().getArray())
                          .addChild(new HAnimSegment().setName("l_metatarsal_1").setDEF("hanim_l_metatarsal_1")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt3261().getArray())
                                ...
                                .addComments("from l_tarsometatarsal_1 to l_metatarsophalangeal_1 vertices 1")
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                            .addChild(new HAnimSite().setName("l_metatarsal_phalanx_1_pt").setDEF("hanim_l_metatarsal_phalanx_1_pt")
                              ...
                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                          .addChild(new HAnimJoint().setName("l_metatarsophalangeal_1").setDEF("hanim_l_metatarsophalangeal_1").setUlimit(new MFFloat63().getArray()).setLlimit(new MFFloat64().getArray())
                            .addChild(new HAnimSegment().setName("l_tarsal_proximal_phalanx_1").setDEF("hanim_l_tarsal_proximal_phalanx_1")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt3265().getArray())
                                  ...
                                  .addComments("from l_metatarsophalangeal_1 to l_tarsal_interphalangeal_1 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                              .addChild(new HAnimSite().setName("l_tarsal_distal_phalanx_1_tip").setDEF("hanim_l_tarsal_distal_phalanx_1_tip")
                                ...
                                .addChild(new Shape().setUSE("HAnimSiteShape"))))
                            .addChild(new HAnimJoint().setName("l_tarsal_interphalangeal_1").setDEF("hanim_l_tarsal_interphalangeal_1").setUlimit(new MFFloat67().getArray()).setLlimit(new MFFloat68().getArray())))))
                      .addChild(new HAnimJoint().setName("l_cuneonavicular_2").setDEF("hanim_l_cuneonavicular_2").setUlimit(new MFFloat69().getArray()).setLlimit(new MFFloat70().getArray())
                        .addChild(new HAnimSegment().setName("l_cuneiform_2").setDEF("hanim_l_cuneiform_2")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt3271().getArray())
                              ...
                              .addComments("from l_cuneonavicular_2 to l_tarsometatarsal_2 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint().setName("l_tarsometatarsal_2").setDEF("hanim_l_tarsometatarsal_2").setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                          .addChild(new HAnimSegment().setName("l_metatarsal_2").setDEF("hanim_l_metatarsal_2")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt3275().getArray())
                                ...
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                          .addChild(new HAnimJoint().setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setUlimit(new MFFloat77().getArray()).setLlimit(new MFFloat78().getArray())
                            .addChild(new HAnimSegment().setName("l_tarsal_proximal_phalanx_2").setDEF("hanim_l_tarsal_proximal_phalanx_2")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt3279().getArray())
                                  ...
                                  .addComments("from l_metatarsophalangeal_2 to l_tarsal_proximal_interphalangeal_2 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                            .addChild(new HAnimJoint().setName("l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setUlimit(new MFFloat81().getArray()).setLlimit(new MFFloat82().getArray())
                              .addChild(new HAnimSegment().setName("l_tarsal_middle_phalanx_2").setDEF("hanim_l_tarsal_middle_phalanx_2")
                                ...
                                .addChild(new Shape()
                                  .setGeometry(new LineSet().setVertexCount(new MFInt3283().getArray())
                                    ...
                                    .addComments("from l_tarsal_proximal_interphalangeal_2 to l_tarsal_distal_interphalangeal_2 vertices 1")
                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                .addChild(new HAnimSite().setName("l_tarsal_distal_phalanx_2_tip").setDEF("hanim_l_tarsal_distal_phalanx_2_tip").setTranslation(new float[] {0.1195f,0.0079f,0.1433f})
                                  ...
                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                              .addChild(new HAnimJoint().setName("l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setUlimit(new MFFloat85().getArray()).setLlimit(new MFFloat86().getArray()))))))
                      .addChild(new HAnimJoint().setName("l_cuneonavicular_3").setDEF("hanim_l_cuneonavicular_3").setUlimit(new MFFloat87().getArray()).setLlimit(new MFFloat88().getArray())
                        .addChild(new HAnimSegment().setName("l_cuneiform_3").setDEF("hanim_l_cuneiform_3")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt3289().getArray())
                              ...
                              .addComments("from l_cuneonavicular_3 to l_tarsometatarsal_3 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint().setName("l_tarsometatarsal_3").setDEF("hanim_l_tarsometatarsal_3").setUlimit(new MFFloat91().getArray()).setLlimit(new MFFloat92().getArray())
                          .addChild(new HAnimSegment().setName("l_metatarsal_3").setDEF("hanim_l_metatarsal_3")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt3293().getArray())
                                ...
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                          .addChild(new HAnimJoint().setName("l_metatarsophalangeal_3").setDEF("hanim_l_metatarsophalangeal_3").setUlimit(new MFFloat95().getArray()).setLlimit(new MFFloat96().getArray())
                            .addChild(new HAnimSegment().setName("l_tarsal_proximal_phalanx_3").setDEF("hanim_l_tarsal_proximal_phalanx_3")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt3297().getArray())
                                  ...
                                  .addComments("from l_metatarsophalangeal_3 to l_tarsal_proximal_interphalangeal_3 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                            .addChild(new HAnimJoint().setName("l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setUlimit(new MFFloat99().getArray()).setLlimit(new MFFloat100().getArray())
                              .addChild(new HAnimSegment().setName("l_tarsal_middle_phalanx_3").setDEF("hanim_l_tarsal_middle_phalanx_3")
                                ...
                                .addChild(new Shape()
                                  .setGeometry(new LineSet().setVertexCount(new MFInt32101().getArray())
                                    ...
                                    .addComments("from l_tarsal_proximal_interphalangeal_3 to l_tarsal_distal_interphalangeal_3 vertices 1")
                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                .addChild(new HAnimSite().setName("l_tarsal_distal_phalanx_3_tip").setDEF("hanim_l_tarsal_distal_phalanx_3_tip")
                                  ...
                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                              .addChild(new HAnimJoint().setName("l_tarsal_distal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setUlimit(new MFFloat103().getArray()).setLlimit(new MFFloat104().getArray())))))))
                    .addChild(new HAnimJoint().setName("l_calcaneocuboid").setDEF("hanim_l_calcaneocuboid").setUlimit(new MFFloat105().getArray()).setLlimit(new MFFloat106().getArray())
                      .addChild(new HAnimSegment().setName("l_calcaneus").setDEF("hanim_l_calcaneus")
                        ...
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(new MFInt32107().getArray())
                            ...
                            .addComments("from l_calcaneocuboid to l_transversetarsal vertices 1")
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                      .addChild(new HAnimJoint().setName("l_transversetarsal").setDEF("hanim_l_transversetarsal").setUlimit(new MFFloat109().getArray()).setLlimit(new MFFloat110().getArray())
                        .addChild(new HAnimSegment().setName("l_cuboid").setDEF("hanim_l_cuboid")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt32111().getArray())
                              ...
                              .addComments("from l_transversetarsal to l_tarsometatarsal_4 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt32113().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f114().getArray()))
                              .addComments("from l_transversetarsal to l_tarsometatarsal_5 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint().setName("l_tarsometatarsal_4").setDEF("hanim_l_tarsometatarsal_4").setUlimit(new MFFloat115().getArray()).setLlimit(new MFFloat116().getArray())
                          .addChild(new HAnimSegment().setName("l_metatarsal_4").setDEF("hanim_l_metatarsal_4")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt32117().getArray())
                                ...
                                .addComments("from l_tarsometatarsal_4 to l_metatarsophalangeal_4 vertices 1")
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                          .addChild(new HAnimJoint().setName("l_metatarsophalangeal_4").setDEF("hanim_l_metatarsophalangeal_4").setUlimit(new MFFloat119().getArray()).setLlimit(new MFFloat120().getArray())
                            .addChild(new HAnimSegment().setName("l_tarsal_proximal_phalanx_4").setDEF("hanim_l_tarsal_proximal_phalanx_4")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt32121().getArray())
                                  ...
                                  .addComments("from l_metatarsophalangeal_4 to l_tarsal_proximal_interphalangeal_4 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                            .addChild(new HAnimJoint().setName("l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setUlimit(new MFFloat123().getArray()).setLlimit(new MFFloat124().getArray())
                              .addChild(new HAnimSegment().setName("l_tarsal_middle_phalanx_4").setDEF("hanim_l_tarsal_middle_phalanx_4")
                                ...
                                .addChild(new Shape()
                                  .setGeometry(new LineSet().setVertexCount(new MFInt32125().getArray())
                                    ...
                                    .addComments("from l_tarsal_proximal_interphalangeal_4 to l_tarsal_distal_interphalangeal_4 vertices 1")
                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                .addChild(new HAnimSite().setName("l_tarsal_distal_phalanx_4_tip").setDEF("hanim_l_tarsal_distal_phalanx_4_tip")
                                  ...
                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                              .addChild(new HAnimJoint().setName("l_tarsal_distal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setUlimit(new MFFloat127().getArray()).setLlimit(new MFFloat128().getArray())))))
                        .addChild(new HAnimJoint().setName("l_tarsometatarsal_5").setDEF("hanim_l_tarsometatarsal_5").setUlimit(new MFFloat129().getArray()).setLlimit(new MFFloat130().getArray())
                          .addChild(new HAnimSegment().setName("l_metatarsal_5").setDEF("hanim_l_metatarsal_5")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt32131().getArray())
                                ...
                                .addComments("from l_tarsometatarsal_5 to l_metatarsophalangeal_5 vertices 1")
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                            .addChild(new HAnimSite().setName("l_metatarsal_phalanx_5_pt").setDEF("hanim_l_metatarsal_phalanx_5_pt")
                              ...
                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                          .addChild(new HAnimJoint().setName("l_metatarsophalangeal_5").setDEF("hanim_l_metatarsophalangeal_5").setUlimit(new MFFloat133().getArray()).setLlimit(new MFFloat134().getArray())
                            .addChild(new HAnimSegment().setName("l_tarsal_proximal_phalanx_5").setDEF("hanim_l_tarsal_proximal_phalanx_5")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt32135().getArray())
                                  ...
                                  .addComments("from l_metatarsophalangeal_5 to l_tarsal_proximal_interphalangeal_5 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                            .addChild(new HAnimJoint().setName("l_tarsal_proximal_interphalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_5").setUlimit(new MFFloat137().getArray()).setLlimit(new MFFloat138().getArray())
                              .addChild(new HAnimSegment().setName("l_tarsal_middle_phalanx_5").setDEF("hanim_l_tarsal_middle_phalanx_5")
                                ...
                                .addChild(new Shape()
                                  .setGeometry(new LineSet().setVertexCount(new MFInt32139().getArray())
                                    ...
                                    .addComments("from l_tarsal_proximal_interphalangeal_5 to l_tarsal_distal_interphalangeal_5 vertices 1")
                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                .addChild(new HAnimSite().setName("l_tarsal_distal_phalanx_5_tip").setDEF("hanim_l_tarsal_distal_phalanx_5_tip")
                                  ...
                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                              .addChild(new HAnimJoint().setName("l_tarsal_distal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setUlimit(new MFFloat141().getArray()).setLlimit(new MFFloat142().getArray()))))))))))
              .addChild(new HAnimJoint().setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-0.095f,0.9171f,0.0029f}).setUlimit(new MFFloat143().getArray()).setLlimit(new MFFloat144().getArray())
                .addChild(new HAnimSegment().setName("r_thigh").setDEF("hanim_r_thigh")
                  ...
                  .addChild(new HAnimSite().setName("r_tibiale_pt").setDEF("hanim_r_tibiale_pt")
                    ...
                    .addChild(new Shape().setUSE("HAnimSiteShape"))))
                .addChild(new HAnimJoint().setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-0.0867f,0.4913f,0.0318f}).setUlimit(new MFFloat147().getArray()).setLlimit(new MFFloat148().getArray())
                  .addChild(new HAnimSegment().setName("r_calf").setDEF("hanim_r_calf")
                    ...
                    .addChild(new HAnimSite().setName("r_sphyrion_pt").setDEF("hanim_r_sphyrion_pt").setTranslation(new float[] {-0.0603f,0.061f,-0.1002f})
                      ...
                      .addChild(new Shape().setUSE("HAnimSiteShape"))))
                  .addChild(new HAnimJoint().setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-0.0801f,0.0712f,-0.0766f}).setUlimit(new MFFloat151().getArray()).setLlimit(new MFFloat152().getArray())
                    .addChild(new HAnimSegment().setName("r_talus").setDEF("hanim_r_talus")
                      ...
                      .addChild(new Shape()
                        .setGeometry(new LineSet().setVertexCount(new MFInt32155().getArray())
                          ...
                          .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                    .addChild(new HAnimJoint().setName("r_talocalcaneonavicular").setDEF("hanim_r_talocalcaneonavicular").setUlimit(new MFFloat157().getArray()).setLlimit(new MFFloat158().getArray())
                      .addChild(new HAnimSegment().setName("r_navicular").setDEF("hanim_r_navicular")
                        ...
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(new MFInt32159().getArray())
                            ...
                            .addComments("from r_talocalcaneonavicular to r_cuneonavicular_1 vertices 1")
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(new MFInt32161().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f162().getArray()))
                            .addComments("from r_talocalcaneonavicular to r_cuneonavicular_2 vertices 1")
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(new MFInt32163().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f164().getArray()))
                            .addComments("from r_talocalcaneonavicular to r_cuneonavicular_3 vertices 1")
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                      .addChild(new HAnimJoint().setName("r_cuneonavicular_1").setDEF("hanim_r_cuneonavicular_1").setUlimit(new MFFloat165().getArray()).setLlimit(new MFFloat166().getArray())
                        .addChild(new HAnimSegment().setName("r_cuneiform_1").setDEF("hanim_r_cuneiform_1")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt32167().getArray())
                              ...
                              .addComments("from r_cuneonavicular_1 to r_tarsometatarsal_1 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint().setName("r_tarsometatarsal_1").setDEF("hanim_r_tarsometatarsal_1").setUlimit(new MFFloat169().getArray()).setLlimit(new MFFloat170().getArray())
                          .addChild(new HAnimSegment().setName("r_metatarsal_1").setDEF("hanim_r_metatarsal_1")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt32171().getArray())
                                ...
                                .addComments("from r_tarsometatarsal_1 to r_metatarsophalangeal_1 vertices 1")
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                            .addChild(new HAnimSite().setName("r_metatarsal_phalanx_1_pt").setDEF("hanim_r_metatarsal_phalanx_1_pt")
                              ...
                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                          .addChild(new HAnimJoint().setName("r_metatarsophalangeal_1").setDEF("hanim_r_metatarsophalangeal_1").setUlimit(new MFFloat173().getArray()).setLlimit(new MFFloat174().getArray())
                            .addChild(new HAnimSegment().setName("r_tarsal_proximal_phalanx_1").setDEF("hanim_r_tarsal_proximal_phalanx_1")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt32175().getArray())
                                  ...
                                  .addComments("from r_metatarsophalangeal_1 to r_tarsal_interphalangeal_1 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                              .addChild(new HAnimSite().setName("r_tarsal_distal_phalanx_1_tip").setDEF("hanim_r_tarsal_distal_phalanx_1_tip")
                                ...
                                .addChild(new Shape().setUSE("HAnimSiteShape"))))
                            .addChild(new HAnimJoint().setName("r_tarsal_interphalangeal_1").setDEF("hanim_r_tarsal_interphalangeal_1").setUlimit(new MFFloat177().getArray()).setLlimit(new MFFloat178().getArray())))))
                      .addChild(new HAnimJoint().setName("r_cuneonavicular_2").setDEF("hanim_r_cuneonavicular_2").setUlimit(new MFFloat179().getArray()).setLlimit(new MFFloat180().getArray())
                        .addChild(new HAnimSegment().setName("r_cuneiform_2").setDEF("hanim_r_cuneiform_2")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt32181().getArray())
                              ...
                              .addComments("from r_cuneonavicular_2 to r_tarsometatarsal_2 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint().setName("r_tarsometatarsal_2").setDEF("hanim_r_tarsometatarsal_2").setUlimit(new MFFloat183().getArray()).setLlimit(new MFFloat184().getArray())
                          .addChild(new HAnimSegment().setName("r_metatarsal_2").setDEF("hanim_r_metatarsal_2")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt32185().getArray())
                                ...
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                          .addChild(new HAnimJoint().setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setUlimit(new MFFloat187().getArray()).setLlimit(new MFFloat188().getArray())
                            .addChild(new HAnimSegment().setName("r_tarsal_proximal_phalanx_2").setDEF("hanim_r_tarsal_proximal_phalanx_2")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt32189().getArray())
                                  ...
                                  .addComments("from r_metatarsophalangeal_2 to r_tarsal_proximal_interphalangeal_2 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                            .addChild(new HAnimJoint().setName("r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setUlimit(new MFFloat191().getArray()).setLlimit(new MFFloat192().getArray())
                              .addChild(new HAnimSegment().setName("r_tarsal_middle_phalanx_2").setDEF("hanim_r_tarsal_middle_phalanx_2")
                                ...
                                .addChild(new Shape()
                                  .setGeometry(new LineSet().setVertexCount(new MFInt32193().getArray())
                                    ...
                                    .addComments("from r_tarsal_proximal_interphalangeal_2 to r_tarsal_distal_interphalangeal_2 vertices 1")
                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                .addChild(new HAnimSite().setName("r_tarsal_distal_phalanx_2_tip").setDEF("hanim_r_tarsal_distal_phalanx_2_tip").setTranslation(new float[] {-0.0883f,0.0134f,0.1383f})
                                  ...
                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                              .addChild(new HAnimJoint().setName("r_tarsal_distal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setUlimit(new MFFloat195().getArray()).setLlimit(new MFFloat196().getArray()))))))
                      .addChild(new HAnimJoint().setName("r_cuneonavicular_3").setDEF("hanim_r_cuneonavicular_3").setUlimit(new MFFloat197().getArray()).setLlimit(new MFFloat198().getArray())
                        .addChild(new HAnimSegment().setName("r_cuneiform_3").setDEF("hanim_r_cuneiform_3")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt32199().getArray())
                              ...
                              .addComments("from r_cuneonavicular_3 to r_tarsometatarsal_3 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint().setName("r_tarsometatarsal_3").setDEF("hanim_r_tarsometatarsal_3").setUlimit(new MFFloat201().getArray()).setLlimit(new MFFloat202().getArray())
                          .addChild(new HAnimSegment().setName("r_metatarsal_3").setDEF("hanim_r_metatarsal_3")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt32203().getArray())
                                ...
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                          .addChild(new HAnimJoint().setName("r_metatarsophalangeal_3").setDEF("hanim_r_metatarsophalangeal_3").setUlimit(new MFFloat205().getArray()).setLlimit(new MFFloat206().getArray())
                            .addChild(new HAnimSegment().setName("r_tarsal_proximal_phalanx_3").setDEF("hanim_r_tarsal_proximal_phalanx_3")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt32207().getArray())
                                  ...
                                  .addComments("from r_metatarsophalangeal_3 to r_tarsal_proximal_interphalangeal_3 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                            .addChild(new HAnimJoint().setName("r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setUlimit(new MFFloat209().getArray()).setLlimit(new MFFloat210().getArray())
                              .addChild(new HAnimSegment().setName("r_tarsal_middle_phalanx_3").setDEF("hanim_r_tarsal_middle_phalanx_3")
                                ...
                                .addChild(new Shape()
                                  .setGeometry(new LineSet().setVertexCount(new MFInt32211().getArray())
                                    ...
                                    .addComments("from r_tarsal_proximal_interphalangeal_3 to r_tarsal_distal_interphalangeal_3 vertices 1")
                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                .addChild(new HAnimSite().setName("r_tarsal_distal_phalanx_3_tip").setDEF("hanim_r_tarsal_distal_phalanx_3_tip")
                                  ...
                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                              .addChild(new HAnimJoint().setName("r_tarsal_distal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setUlimit(new MFFloat213().getArray()).setLlimit(new MFFloat214().getArray())))))))
                    .addChild(new HAnimJoint().setName("r_calcaneocuboid").setDEF("hanim_r_calcaneocuboid").setUlimit(new MFFloat215().getArray()).setLlimit(new MFFloat216().getArray())
                      .addChild(new HAnimSegment().setName("r_calcaneus").setDEF("hanim_r_calcaneus")
                        ...
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(new MFInt32217().getArray())
                            ...
                            .addComments("from r_calcaneocuboid to r_transversetarsal vertices 1")
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                      .addChild(new HAnimJoint().setName("r_transversetarsal").setDEF("hanim_r_transversetarsal").setUlimit(new MFFloat219().getArray()).setLlimit(new MFFloat220().getArray())
                        .addChild(new HAnimSegment().setName("r_cuboid").setDEF("hanim_r_cuboid")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt32221().getArray())
                              ...
                              .addComments("from r_transversetarsal to r_tarsometatarsal_4 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt32223().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f224().getArray()))
                              .addComments("from r_transversetarsal to r_tarsometatarsal_5 vertices 1")
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint().setName("r_tarsometatarsal_4").setDEF("hanim_r_tarsometatarsal_4").setUlimit(new MFFloat225().getArray()).setLlimit(new MFFloat226().getArray())
                          .addChild(new HAnimSegment().setName("r_metatarsal_4").setDEF("hanim_r_metatarsal_4")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt32227().getArray())
                                ...
                                .addComments("from r_tarsometatarsal_4 to r_metatarsophalangeal_4 vertices 1")
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                          .addChild(new HAnimJoint().setName("r_metatarsophalangeal_4").setDEF("hanim_r_metatarsophalangeal_4").setUlimit(new MFFloat229().getArray()).setLlimit(new MFFloat230().getArray())
                            .addChild(new HAnimSegment().setName("r_tarsal_proximal_phalanx_4").setDEF("hanim_r_tarsal_proximal_phalanx_4")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt32231().getArray())
                                  ...
                                  .addComments("from r_metatarsophalangeal_4 to r_tarsal_proximal_interphalangeal_4 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                            .addChild(new HAnimJoint().setName("r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setUlimit(new MFFloat233().getArray()).setLlimit(new MFFloat234().getArray())
                              .addChild(new HAnimSegment().setName("r_tarsal_middle_phalanx_4").setDEF("hanim_r_tarsal_middle_phalanx_4")
                                ...
                                .addChild(new Shape()
                                  .setGeometry(new LineSet().setVertexCount(new MFInt32235().getArray())
                                    ...
                                    .addComments("from r_tarsal_proximal_interphalangeal_4 to r_tarsal_distal_interphalangeal_4 vertices 1")
                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                .addChild(new HAnimSite().setName("r_tarsal_distal_phalanx_4_tip").setDEF("hanim_r_tarsal_distal_phalanx_4_tip")
                                  ...
                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                              .addChild(new HAnimJoint().setName("r_tarsal_distal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setUlimit(new MFFloat237().getArray()).setLlimit(new MFFloat238().getArray())))))
                        .addChild(new HAnimJoint().setName("r_tarsometatarsal_5").setDEF("hanim_r_tarsometatarsal_5").setUlimit(new MFFloat239().getArray()).setLlimit(new MFFloat240().getArray())
                          .addChild(new HAnimSegment().setName("r_metatarsal_5").setDEF("hanim_r_metatarsal_5")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(new MFInt32241().getArray())
                                ...
                                .addComments("from r_tarsometatarsal_5 to r_metatarsophalangeal_5 vertices 1")
                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                            .addChild(new HAnimSite().setName("r_metatarsal_phalanx_5_pt").setDEF("hanim_r_metatarsal_phalanx_5_pt")
                              ...
                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                          .addChild(new HAnimJoint().setName("r_metatarsophalangeal_5").setDEF("hanim_r_metatarsophalangeal_5").setUlimit(new MFFloat243().getArray()).setLlimit(new MFFloat244().getArray())
                            .addChild(new HAnimSegment().setName("r_tarsal_proximal_phalanx_5").setDEF("hanim_r_tarsal_proximal_phalanx_5")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(new MFInt32245().getArray())
                                  ...
                                  .addComments("from r_metatarsophalangeal_5 to r_tarsal_proximal_interphalangeal_5 vertices 1")
                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                            .addChild(new HAnimJoint().setName("r_tarsal_proximal_interphalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_5").setUlimit(new MFFloat247().getArray()).setLlimit(new MFFloat248().getArray())
                              .addChild(new HAnimSegment().setName("r_tarsal_middle_phalanx_5").setDEF("hanim_r_tarsal_middle_phalanx_5")
                                ...
                                .addChild(new Shape()
                                  .setGeometry(new LineSet().setVertexCount(new MFInt32249().getArray())
                                    ...
                                    .addComments("from r_tarsal_proximal_interphalangeal_5 to r_tarsal_distal_interphalangeal_5 vertices 1")
                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                .addChild(new HAnimSite().setName("r_tarsal_distal_phalanx_5_tip").setDEF("hanim_r_tarsal_distal_phalanx_5_tip")
                                  ...
                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                              .addChild(new HAnimJoint().setName("r_tarsal_distal_interphalangeal_5").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setUlimit(new MFFloat251().getArray()).setLlimit(new MFFloat252().getArray())))))))))))
            .addChild(new HAnimJoint().setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0.0028f,1.0568f,-0.0776f}).setUlimit(new MFFloat253().getArray()).setLlimit(new MFFloat254().getArray())
              .addChild(new HAnimSegment().setName("l5").setDEF("hanim_l5")
                ...
                .addChild(new Shape()
                  .setGeometry(new LineSet().setVertexCount(new MFInt32255().getArray())
                    ...
                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
              .addChild(new HAnimJoint().setName("vl4").setDEF("hanim_vl4").setCenter(new float[] {0.0035f,1.0925f,-0.0787f}).setUlimit(new MFFloat257().getArray()).setLlimit(new MFFloat258().getArray())
                .addChild(new HAnimSegment().setName("l4").setDEF("hanim_l4")
                  ...
                  .addChild(new Shape()
                    .setGeometry(new LineSet().setVertexCount(new MFInt32259().getArray())
                      ...
                      .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                .addChild(new HAnimJoint().setName("vl3").setDEF("hanim_vl3").setCenter(new float[] {0.0041f,1.1276f,-0.0796f}).setUlimit(new MFFloat261().getArray()).setLlimit(new MFFloat262().getArray())
                  .addChild(new HAnimSegment().setName("l3").setDEF("hanim_l3")
                    ...
                    .addChild(new HAnimSite().setName("spine_2_middle_back_pt").setDEF("hanim_spine_2_middle_back_pt")
                      ...
                      .addChild(new Shape().setUSE("HAnimSiteShape"))))
                  .addChild(new HAnimJoint().setName("vl2").setDEF("hanim_vl2").setCenter(new float[] {0.0045f,1.1546f,-0.08f}).setUlimit(new MFFloat265().getArray()).setLlimit(new MFFloat266().getArray())
                    .addChild(new HAnimSegment().setName("l2").setDEF("hanim_l2")
                      ...
                      .addChild(new Shape()
                        .setGeometry(new LineSet().setVertexCount(new MFInt32267().getArray())
                          ...
                          .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                    .addChild(new HAnimJoint().setName("vl1").setDEF("hanim_vl1").setCenter(new float[] {0.0048f,1.1912f,-0.0805f}).setUlimit(new MFFloat269().getArray()).setLlimit(new MFFloat270().getArray())
                      .addChild(new HAnimSegment().setName("l1").setDEF("hanim_l1")
                        ...
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(new MFInt32271().getArray())
                            ...
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                      .addChild(new HAnimJoint().setName("vt12").setDEF("hanim_vt12").setCenter(new float[] {0.0051f,1.2278f,-0.0808f}).setUlimit(new MFFloat273().getArray()).setLlimit(new MFFloat274().getArray())
                        .addChild(new HAnimSegment().setName("t12").setDEF("hanim_t12")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(new MFInt32275().getArray())
                              ...
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint().setName("vt11").setDEF("hanim_vt11").setCenter(new float[] {0.0053f,1.2679f,-0.081f}).setUlimit(new MFFloat277().getArray()).setLlimit(new MFFloat278().getArray())
                          .addChild(new HAnimSegment().setName("t11").setDEF("hanim_t11")
                            ...
                            .addChild(new HAnimSite().setName("substernale_pt").setDEF("hanim_substernale_pt").setTranslation(new float[] {0.0085f,1.2995f,0.1147f})
                              ...
                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                          .addChild(new HAnimJoint().setName("vt10").setDEF("hanim_vt10").setCenter(new float[] {0.0056f,1.2848f,-0.0822f}).setUlimit(new MFFloat281().getArray()).setLlimit(new MFFloat282().getArray())
                            .addChild(new HAnimSegment().setName("t10").setDEF("hanim_t10")
                              ...
                              .addChild(new HAnimSite().setName("r_thelion_pt").setDEF("hanim_r_thelion_pt").setTranslation(new float[] {-0.0736f,1.3385f,0.1217f})
                                ...
                                .addChild(new Shape().setUSE("HAnimSiteShape"))))
                            .addChild(new HAnimJoint().setName("vt9").setDEF("hanim_vt9").setCenter(new float[] {0.0057f,1.3126f,-0.0838f}).setUlimit(new MFFloat285().getArray()).setLlimit(new MFFloat286().getArray())
                              .addChild(new HAnimSegment().setName("t9").setDEF("hanim_t9")
                                ...
                                .addChild(new Shape()
                                  .setGeometry(new LineSet().setVertexCount(new MFInt32287().getArray())
                                    ...
                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                              .addChild(new HAnimJoint().setName("vt8").setDEF("hanim_vt8").setCenter(new float[] {0.0057f,1.3382f,-0.0845f}).setUlimit(new MFFloat289().getArray()).setLlimit(new MFFloat290().getArray())
                                .addChild(new HAnimSegment().setName("t8").setDEF("hanim_t8")
                                  ...
                                  .addChild(new Shape()
                                    .setGeometry(new LineSet().setVertexCount(new MFInt32291().getArray())
                                      ...
                                      .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                .addChild(new HAnimJoint().setName("vt7").setDEF("hanim_vt7").setCenter(new float[] {0.0058f,1.3625f,-0.0833f}).setUlimit(new MFFloat293().getArray()).setLlimit(new MFFloat294().getArray())
                                  .addChild(new HAnimSegment().setName("t7").setDEF("hanim_t7")
                                    ...
                                    .addChild(new HAnimSite().setName("rear_center_midsagittal_plane_pt").setDEF("hanim_rear_center_midsagittal_plane_pt")
                                      ...
                                      .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                  .addChild(new HAnimJoint().setName("vt6").setDEF("hanim_vt6").setCenter(new float[] {0.0059f,1.3866f,-0.08f}).setUlimit(new MFFloat297().getArray()).setLlimit(new MFFloat298().getArray())
                                    .addChild(new HAnimSegment().setName("t6").setDEF("hanim_t6")
                                      ...
                                      .addChild(new HAnimSite().setName("spine_1_middle_back_pt").setDEF("hanim_spine_1_middle_back_pt")
                                        ...
                                        .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                    .addChild(new HAnimJoint().setName("vt5").setDEF("hanim_vt5").setCenter(new float[] {0.006f,1.4102f,-0.0745f}).setUlimit(new MFFloat301().getArray()).setLlimit(new MFFloat302().getArray())
                                      .addChild(new HAnimSegment().setName("t5").setDEF("hanim_t5")
                                        ...
                                        .addChild(new Shape()
                                          .setGeometry(new LineSet().setVertexCount(new MFInt32303().getArray())
                                            ...
                                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                      .addChild(new HAnimJoint().setName("vt4").setDEF("hanim_vt4").setCenter(new float[] {0.0061f,1.432f,-0.0675f}).setUlimit(new MFFloat305().getArray()).setLlimit(new MFFloat306().getArray())
                                        .addChild(new HAnimSegment().setName("t4").setDEF("hanim_t4")
                                          ...
                                          .addChild(new Shape()
                                            .setGeometry(new LineSet().setVertexCount(new MFInt32307().getArray())
                                              ...
                                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                        .addChild(new HAnimJoint().setName("vt3").setDEF("hanim_vt3").setCenter(new float[] {0.0062f,1.4583f,-0.057f}).setUlimit(new MFFloat309().getArray()).setLlimit(new MFFloat310().getArray())
                                          .addChild(new HAnimSegment().setName("t3").setDEF("hanim_t3")
                                            ...
                                            .addChild(new Shape()
                                              .setGeometry(new LineSet().setVertexCount(new MFInt32311().getArray())
                                                ...
                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                          .addChild(new HAnimJoint().setName("vt2").setDEF("hanim_vt2").setCenter(new float[] {0.0063f,1.4761f,-0.0484f}).setUlimit(new MFFloat313().getArray()).setLlimit(new MFFloat314().getArray())
                                            .addChild(new HAnimSegment().setName("t2").setDEF("hanim_t2")
                                              ...
                                              .addChild(new HAnimSite().setName("suprasternale_pt").setDEF("hanim_suprasternale_pt").setTranslation(new float[] {0.0084f,1.4714f,0.0551f})
                                                ...
                                                .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                            .addChild(new HAnimJoint().setName("vt1").setDEF("hanim_vt1").setCenter(new float[] {0.0065f,1.4951f,-0.0387f}).setUlimit(new MFFloat317().getArray()).setLlimit(new MFFloat318().getArray())
                                              .addChild(new HAnimSegment().setName("t1").setDEF("hanim_t1")
                                                ...
                                                .addChild(new HAnimSite().setName("r_clavicale_pt").setDEF("hanim_r_clavicale_pt").setTranslation(new float[] {-0.0115f,1.4943f,0.04f})
                                                  ...
                                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                              .addChild(new HAnimJoint().setName("vc7").setDEF("hanim_vc7").setCenter(new float[] {0.0066f,1.5132f,-0.0301f}).setUlimit(new MFFloat325().getArray()).setLlimit(new MFFloat326().getArray())
                                                .addChild(new HAnimSegment().setName("c7").setDEF("hanim_c7")
                                                  ...
                                                  .addChild(new Shape()
                                                    .setGeometry(new LineSet().setVertexCount(new MFInt32327().getArray())
                                                      ...
                                                      .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                .addChild(new HAnimJoint().setName("vc6").setDEF("hanim_vc6").setCenter(new float[] {0.0066f,1.5357f,-0.0143f}).setUlimit(new MFFloat329().getArray()).setLlimit(new MFFloat330().getArray())
                                                  .addChild(new HAnimSegment().setName("c6").setDEF("hanim_c6")
                                                    ...
                                                    .addChild(new Shape()
                                                      .setGeometry(new LineSet().setVertexCount(new MFInt32331().getArray())
                                                        ...
                                                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                  .addChild(new HAnimJoint().setName("vc5").setDEF("hanim_vc5").setCenter(new float[] {0.0066f,1.552f,-0.0082f}).setUlimit(new MFFloat333().getArray()).setLlimit(new MFFloat334().getArray())
                                                    .addChild(new HAnimSegment().setName("c5").setDEF("hanim_c5")
                                                      ...
                                                      .addChild(new Shape()
                                                        .setGeometry(new LineSet().setVertexCount(new MFInt32335().getArray())
                                                          ...
                                                          .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                    .addChild(new HAnimJoint().setName("vc4").setDEF("hanim_vc4").setCenter(new float[] {0.0066f,1.5662f,-0.0084f}).setUlimit(new MFFloat337().getArray()).setLlimit(new MFFloat338().getArray())
                                                      .addChild(new HAnimSegment().setName("c4").setDEF("hanim_c4")
                                                        ...
                                                        .addChild(new Shape()
                                                          .setGeometry(new LineSet().setVertexCount(new MFInt32339().getArray())
                                                            ...
                                                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                      .addChild(new HAnimJoint().setName("vc3").setDEF("hanim_vc3").setCenter(new float[] {0.0066f,1.58f,-0.0103f}).setUlimit(new MFFloat341().getArray()).setLlimit(new MFFloat342().getArray())
                                                        .addChild(new HAnimSegment().setName("c3").setDEF("hanim_c3")
                                                          ...
                                                          .addChild(new HAnimSite().setName("adams_apple_pt").setDEF("hanim_adams_apple_pt")
                                                            ...
                                                            .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                        .addChild(new HAnimJoint().setName("vc2").setDEF("hanim_vc2").setCenter(new float[] {0.0066f,1.5928f,-0.0103f}).setUlimit(new MFFloat345().getArray()).setLlimit(new MFFloat346().getArray())
                                                          .addChild(new HAnimSegment().setName("c2").setDEF("hanim_c2")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32347().getArray())
                                                                ...
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("vc1").setDEF("hanim_vc1").setCenter(new float[] {0.0066f,1.6144f,-0.0034f}).setUlimit(new MFFloat349().getArray()).setLlimit(new MFFloat350().getArray())
                                                            .addChild(new HAnimSegment().setName("c1").setDEF("hanim_c1")
                                                              ...
                                                              .addChild(new HAnimSite().setName("skull_vertex_pt").setDEF("hanim_skull_vertex_pt").setTranslation(new float[] {0.005f,1.7504f,0.0055f})
                                                                ...
                                                                .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                            .addChild(new HAnimJoint().setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0.0044f,1.6209f,0.0236f}).setUlimit(new MFFloat353().getArray()).setLlimit(new MFFloat354().getArray())
                                                              .addChild(new HAnimSegment().setName("skull").setDEF("hanim_skull")
                                                                ...
                                                                .addChild(new HAnimSite().setName("supramenton_pt").setDEF("hanim_supramenton_pt").setTranslation(new float[] {0.0061f,1.541f,0.0805f})
                                                                  ...
                                                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                              .addChild(new HAnimJoint().setName("l_eyelid_joint").setDEF("hanim_l_eyelid_joint").setUlimit(new MFFloat369().getArray()).setLlimit(new MFFloat370().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_eyelid_joint").setDEF("hanim_r_eyelid_joint").setUlimit(new MFFloat371().getArray()).setLlimit(new MFFloat372().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_eyeball_joint").setDEF("hanim_l_eyeball_joint").setUlimit(new MFFloat373().getArray()).setLlimit(new MFFloat374().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_eyeball_joint").setDEF("hanim_r_eyeball_joint").setUlimit(new MFFloat375().getArray()).setLlimit(new MFFloat376().getArray()))
                                                              .addChild(new HAnimJoint().setName("l_eyebrow_joint").setDEF("hanim_l_eyebrow_joint").setUlimit(new MFFloat377().getArray()).setLlimit(new MFFloat378().getArray()))
                                                              .addChild(new HAnimJoint().setName("r_eyebrow_joint").setDEF("hanim_r_eyebrow_joint").setUlimit(new MFFloat379().getArray()).setLlimit(new MFFloat380().getArray()))
                                                              .addChild(new HAnimJoint().setName("temporomandibular").setDEF("hanim_temporomandibular").setUlimit(new MFFloat381().getArray()).setLlimit(new MFFloat382().getArray()))))))))))
                                              .addChild(new HAnimJoint().setName("l_sternoclavicular").setDEF("hanim_l_sternoclavicular").setCenter(new float[] {0.082f,1.4488f,-0.0353f}).setUlimit(new MFFloat383().getArray()).setLlimit(new MFFloat384().getArray())
                                                .addChild(new HAnimSegment().setName("l_clavicle").setDEF("hanim_l_clavicle")
                                                  ...
                                                  .addChild(new Shape()
                                                    .setGeometry(new LineSet().setVertexCount(new MFInt32385().getArray())
                                                      ...
                                                      .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                .addChild(new HAnimJoint().setName("l_acromioclavicular").setDEF("hanim_l_acromioclavicular").setCenter(new float[] {0.0962f,1.4269f,-0.0424f}).setUlimit(new MFFloat387().getArray()).setLlimit(new MFFloat388().getArray())
                                                  .addChild(new HAnimSegment().setName("l_scapula").setDEF("hanim_l_scapula")
                                                    ...
                                                    .addChild(new HAnimSite().setName("l_humeral_lateral_epicondyles_pt").setDEF("hanim_l_humeral_lateral_epicondyles_pt").setTranslation(new float[] {0.228f,1.1482f,-0.11f})
                                                      ...
                                                      .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                  .addChild(new HAnimJoint().setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {0.2029f,1.4376f,-0.0387f}).setUlimit(new MFFloat391().getArray()).setLlimit(new MFFloat392().getArray())
                                                    .addChild(new HAnimSegment().setName("l_upperarm").setDEF("hanim_l_upperarm")
                                                      ...
                                                      .addChild(new HAnimSite().setName("l_radiale_pt").setDEF("hanim_l_radiale_pt").setTranslation(new float[] {0.2182f,1.1212f,-0.1167f})
                                                        ...
                                                        .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                    .addChild(new HAnimJoint().setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {0.2014f,1.1357f,-0.0682f}).setUlimit(new MFFloat395().getArray()).setLlimit(new MFFloat396().getArray())
                                                      .addChild(new HAnimSegment().setName("l_forearm").setDEF("hanim_l_forearm")
                                                        ...
                                                        .addChild(new HAnimSite().setName("l_ulnar_styloid_pt").setDEF("hanim_l_ulnar_styloid_pt").setTranslation(new float[] {-0.2142f,0.8529f,-0.0648f})
                                                          ...
                                                          .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                      .addChild(new HAnimJoint().setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {0.1984f,0.8663f,-0.0583f}).setUlimit(new MFFloat399().getArray()).setLlimit(new MFFloat400().getArray())
                                                        .addChild(new HAnimSegment().setName("l_carpal").setDEF("hanim_l_carpal")
                                                          ...
                                                          .addChild(new Shape()
                                                            .setGeometry(new LineSet().setVertexCount(new MFInt32407().getArray())
                                                              ...
                                                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                        .addChild(new HAnimJoint().setName("l_midcarpal_1").setDEF("hanim_l_midcarpal_1").setUlimit(new MFFloat409().getArray()).setLlimit(new MFFloat410().getArray())
                                                          .addChild(new HAnimSegment().setName("l_trapezium").setDEF("hanim_l_trapezium")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32411().getArray())
                                                                ...
                                                                .addComments("from l_midcarpal_1 to l_carpometacarpal_1 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("l_carpometacarpal_1").setDEF("hanim_l_carpometacarpal_1").setCenter(new float[] {0.1924f,0.8472f,-0.0534f}).setUlimit(new MFFloat413().getArray()).setLlimit(new MFFloat414().getArray())
                                                            .addChild(new HAnimSegment().setName("l_metacarpal_1").setDEF("hanim_l_metacarpal_1")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32415().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("l_metacarpophalangeal_1").setDEF("hanim_l_metacarpophalangeal_1").setCenter(new float[] {0.1951f,0.8226f,0.0246f}).setUlimit(new MFFloat417().getArray()).setLlimit(new MFFloat418().getArray())
                                                              .addChild(new HAnimSegment().setName("l_carpal_proximal_phalanx_1").setDEF("hanim_l_carpal_proximal_phalanx_1")
                                                                ...
                                                                .addChild(new HAnimSite().setName("l_carpal_distal_phalanx_1_tip").setDEF("hanim_l_carpal_distal_phalanx_1_tip")
                                                                  ...
                                                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                              .addChild(new HAnimJoint().setName("l_carpal_interphalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setCenter(new float[] {0.1955f,0.8159f,0.0464f}).setUlimit(new MFFloat421().getArray()).setLlimit(new MFFloat422().getArray())))))
                                                        .addChild(new HAnimJoint().setName("l_midcarpal_2").setDEF("hanim_l_midcarpal_2").setUlimit(new MFFloat423().getArray()).setLlimit(new MFFloat424().getArray())
                                                          .addChild(new HAnimSegment().setName("l_trapezoid").setDEF("hanim_l_trapezoid")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32425().getArray())
                                                                ...
                                                                .addComments("from l_midcarpal_2 to l_carpometacarpal_2 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                                            .addChild(new HAnimSite().setName("l_metacarpal_phalanx_2_pt").setDEF("hanim_l_metacarpal_phalanx_2_pt").setTranslation(new float[] {0.2009f,0.8139f,-0.0237f})
                                                              ...
                                                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                          .addChild(new HAnimJoint().setName("l_carpometacarpal_2").setDEF("hanim_l_carpometacarpal_2").setCenter(new float[] {0.1983f,0.8024f,-0.028f}).setUlimit(new MFFloat427().getArray()).setLlimit(new MFFloat428().getArray())
                                                            .addChild(new HAnimSegment().setName("l_metacarpal_2").setDEF("hanim_l_metacarpal_2")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32429().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("l_metacarpophalangeal_2").setDEF("hanim_l_metacarpophalangeal_2").setCenter(new float[] {0.1983f,0.7815f,-0.028f}).setUlimit(new MFFloat431().getArray()).setLlimit(new MFFloat432().getArray())
                                                              .addChild(new HAnimSegment().setName("l_carpal_proximal_phalanx_2").setDEF("hanim_l_carpal_proximal_phalanx_2")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new MFInt32433().getArray())
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setCenter(new float[] {0.2017f,0.7363f,-0.0248f}).setUlimit(new MFFloat435().getArray()).setLlimit(new MFFloat436().getArray())
                                                                .addChild(new HAnimSegment().setName("l_carpal_middle_phalanx_2").setDEF("hanim_l_carpal_middle_phalanx_2")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("l_dactylion_pt").setDEF("hanim_l_dactylion_pt").setTranslation(new float[] {0.2056f,0.6743f,-0.0482f})
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                                .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setCenter(new float[] {0.2028f,0.7139f,-0.0236f}).setUlimit(new MFFloat439().getArray()).setLlimit(new MFFloat440().getArray()))))))
                                                        .addChild(new HAnimJoint().setName("l_midcarpal_3").setDEF("hanim_l_midcarpal_3").setUlimit(new MFFloat441().getArray()).setLlimit(new MFFloat442().getArray())
                                                          .addChild(new HAnimSegment().setName("l_capitate").setDEF("hanim_l_capitate")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32443().getArray())
                                                                ...
                                                                .addComments("from l_midcarpal_3 to l_carpometacarpal_3 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                                            .addChild(new HAnimSite().setName("l_metacarpal_phalanx_3_pt").setDEF("hanim_l_metacarpal_phalanx_3_pt")
                                                              ...
                                                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                          .addChild(new HAnimJoint().setName("l_carpometacarpal_3").setDEF("hanim_l_carpometacarpal_3").setCenter(new float[] {0.1987f,0.8029f,-0.053f}).setUlimit(new MFFloat445().getArray()).setLlimit(new MFFloat446().getArray())
                                                            .addChild(new HAnimSegment().setName("l_metacarpal_3").setDEF("hanim_l_metacarpal_3")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32447().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("l_metacarpophalangeal_3").setDEF("hanim_l_metacarpophalangeal_3").setCenter(new float[] {0.1987f,0.7818f,-0.053f}).setUlimit(new MFFloat449().getArray()).setLlimit(new MFFloat450().getArray())
                                                              .addChild(new HAnimSegment().setName("l_carpal_proximal_phalanx_3").setDEF("hanim_l_carpal_proximal_phalanx_3")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new MFInt32451().getArray())
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setCenter(new float[] {0.2013f,0.7273f,-0.0503f}).setUlimit(new MFFloat453().getArray()).setLlimit(new MFFloat454().getArray())
                                                                .addChild(new HAnimSegment().setName("l_carpal_middle_phalanx_3").setDEF("hanim_l_carpal_middle_phalanx_3")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("l_carpal_distal_phalanx_3_tip").setDEF("hanim_l_carpal_distal_phalanx_3_tip")
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                                .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setCenter(new float[] {0.2026f,0.7011f,-0.0494f}).setUlimit(new MFFloat457().getArray()).setLlimit(new MFFloat458().getArray()))))))
                                                        .addChild(new HAnimJoint().setName("l_midcarpal_4_5").setDEF("hanim_l_midcarpal_4_5").setUlimit(new MFFloat459().getArray()).setLlimit(new MFFloat460().getArray())
                                                          .addChild(new HAnimSegment().setName("l_hamate").setDEF("hanim_l_hamate")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32461().getArray())
                                                                ...
                                                                .addComments("from l_midcarpal_4_5 to l_carpometacarpal_4 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32463().getArray())
                                                                .setCoord(new Coordinate().setPoint(new MFVec3f464().getArray()))
                                                                .addComments("from l_midcarpal_4_5 to l_carpometacarpal_5 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                                            .addChild(new HAnimSite().setName("l_metacarpal_phalanx_5_pt").setDEF("hanim_l_metacarpal_phalanx_5_pt").setTranslation(new float[] {0.1929f,0.786f,-0.1122f})
                                                              ...
                                                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                          .addChild(new HAnimJoint().setName("l_carpometacarpal_4").setDEF("hanim_l_carpometacarpal_4").setCenter(new float[] {0.1956f,0.8019f,-0.0794f}).setUlimit(new MFFloat465().getArray()).setLlimit(new MFFloat466().getArray())
                                                            .addChild(new HAnimSegment().setName("l_metacarpal_4").setDEF("hanim_l_metacarpal_4")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32467().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("l_metacarpophalangeal_4").setDEF("hanim_l_metacarpophalangeal_4").setCenter(new float[] {0.1956f,0.7815f,-0.0794f}).setUlimit(new MFFloat469().getArray()).setLlimit(new MFFloat470().getArray())
                                                              .addChild(new HAnimSegment().setName("l_carpal_proximal_phalanx_4").setDEF("hanim_l_carpal_proximal_phalanx_4")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new MFInt32471().getArray())
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setCenter(new float[] {0.1973f,0.7287f,-0.0777f}).setUlimit(new MFFloat473().getArray()).setLlimit(new MFFloat474().getArray())
                                                                .addChild(new HAnimSegment().setName("l_carpal_middle_phalanx_4").setDEF("hanim_l_carpal_middle_phalanx_4")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("l_carpal_distal_phalanx_4_tip").setDEF("hanim_l_carpal_distal_phalanx_4_tip")
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                                .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setCenter(new float[] {0.1983f,0.7045f,-0.0767f}).setUlimit(new MFFloat477().getArray()).setLlimit(new MFFloat478().getArray())))))
                                                          .addChild(new HAnimJoint().setName("l_carpometacarpal_5").setDEF("hanim_l_carpometacarpal_5").setCenter(new float[] {0.1925f,0.8066f,-0.1036f}).setUlimit(new MFFloat479().getArray()).setLlimit(new MFFloat480().getArray())
                                                            .addChild(new HAnimSegment().setName("l_metacarpal_5").setDEF("hanim_l_metacarpal_5")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32481().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("l_metacarpophalangeal_5").setDEF("hanim_l_metacarpophalangeal_5").setCenter(new float[] {0.1925f,0.7866f,-0.1036f}).setUlimit(new MFFloat483().getArray()).setLlimit(new MFFloat484().getArray())
                                                              .addChild(new HAnimSegment().setName("l_carpal_proximal_phalanx_5").setDEF("hanim_l_carpal_proximal_phalanx_5")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new MFInt32485().getArray())
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("l_carpal_proximal_interphalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.1938f,0.7452f,-0.1024f}).setUlimit(new MFFloat487().getArray()).setLlimit(new MFFloat488().getArray())
                                                                .addChild(new HAnimSegment().setName("l_carpal_middle_phalanx_5").setDEF("hanim_l_carpal_middle_phalanx_5")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("l_carpal_distal_phalanx_5_tip").setDEF("hanim_l_carpal_distal_phalanx_5_tip")
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                                .addChild(new HAnimJoint().setName("l_carpal_distal_interphalangeal_5").setDEF("hanim_l_carpal_distal_interphalangeal_5").setCenter(new float[] {0.1948f,0.7277f,-0.1017f}).setUlimit(new MFFloat491().getArray()).setLlimit(new MFFloat492().getArray())))))))))))
                                              .addChild(new HAnimJoint().setName("r_sternoclavicular").setDEF("hanim_r_sternoclavicular").setCenter(new float[] {-0.0694f,1.46f,-0.033f}).setUlimit(new MFFloat493().getArray()).setLlimit(new MFFloat494().getArray())
                                                .addChild(new HAnimSegment().setName("r_clavicle").setDEF("hanim_r_clavicle")
                                                  ...
                                                  .addChild(new Shape()
                                                    .setGeometry(new LineSet().setVertexCount(new MFInt32495().getArray())
                                                      ...
                                                      .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                .addChild(new HAnimJoint().setName("r_acromioclavicular").setDEF("hanim_r_acromioclavicular").setCenter(new float[] {-0.0836f,1.4281f,-0.0401f}).setUlimit(new MFFloat497().getArray()).setLlimit(new MFFloat498().getArray())
                                                  .addChild(new HAnimSegment().setName("r_scapula").setDEF("hanim_r_scapula")
                                                    ...
                                                    .addChild(new HAnimSite().setName("r_humeral_lateral_epicondyles_pt").setDEF("hanim_r_humeral_lateral_epicondyles_pt").setTranslation(new float[] {-0.2224f,1.1517f,-0.1033f})
                                                      ...
                                                      .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                  .addChild(new HAnimJoint().setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-0.1907f,1.4407f,-0.0325f}).setUlimit(new MFFloat501().getArray()).setLlimit(new MFFloat502().getArray())
                                                    .addChild(new HAnimSegment().setName("r_upperarm").setDEF("hanim_r_upperarm")
                                                      ...
                                                      .addChild(new HAnimSite().setName("r_radiale_pt").setDEF("hanim_r_radiale_pt").setTranslation(new float[] {-0.213f,1.1305f,-0.1091f})
                                                        ...
                                                        .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                    .addChild(new HAnimJoint().setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-0.1949f,1.1388f,-0.062f}).setUlimit(new MFFloat505().getArray()).setLlimit(new MFFloat506().getArray())
                                                      .addChild(new HAnimSegment().setName("r_forearm").setDEF("hanim_r_forearm")
                                                        ...
                                                        .addChild(new HAnimSite().setName("r_ulnar_styloid_pt").setDEF("hanim_r_ulnar_styloid_pt").setTranslation(new float[] {-0.2117f,0.8562f,-0.0584f})
                                                          ...
                                                          .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                      .addChild(new HAnimJoint().setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-0.1959f,0.8694f,-0.0521f}).setUlimit(new MFFloat509().getArray()).setLlimit(new MFFloat510().getArray())
                                                        .addChild(new HAnimSegment().setName("r_carpal").setDEF("hanim_r_carpal")
                                                          ...
                                                          .addChild(new Shape()
                                                            .setGeometry(new LineSet().setVertexCount(new MFInt32517().getArray())
                                                              ...
                                                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                        .addChild(new HAnimJoint().setName("r_midcarpal_1").setDEF("hanim_r_midcarpal_1").setUlimit(new MFFloat519().getArray()).setLlimit(new MFFloat520().getArray())
                                                          .addChild(new HAnimSegment().setName("r_trapezium").setDEF("hanim_r_trapezium")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32521().getArray())
                                                                ...
                                                                .addComments("from r_midcarpal_1 to r_carpometacarpal_1 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                          .addChild(new HAnimJoint().setName("r_carpometacarpal_1").setDEF("hanim_r_carpometacarpal_1").setCenter(new float[] {-0.1899f,0.8502f,-0.0473f}).setUlimit(new MFFloat523().getArray()).setLlimit(new MFFloat524().getArray())
                                                            .addChild(new HAnimSegment().setName("r_metacarpal_1").setDEF("hanim_r_metacarpal_1")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32525().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_metacarpophalangeal_1").setDEF("hanim_r_metacarpophalangeal_1").setCenter(new float[] {-0.1874f,0.8256f,0.0306f}).setUlimit(new MFFloat527().getArray()).setLlimit(new MFFloat528().getArray())
                                                              .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_1").setDEF("hanim_r_carpal_proximal_phalanx_1")
                                                                ...
                                                                .addChild(new HAnimSite().setName("r_carpal_distal_phalanx_1_tip").setDEF("hanim_r_carpal_distal_phalanx_1_tip")
                                                                  ...
                                                                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                              .addChild(new HAnimJoint().setName("r_carpal_interphalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setCenter(new float[] {-0.1864f,0.819f,0.0506f}).setUlimit(new MFFloat531().getArray()).setLlimit(new MFFloat532().getArray())))))
                                                        .addChild(new HAnimJoint().setName("r_midcarpal_2").setDEF("hanim_r_midcarpal_2").setUlimit(new MFFloat533().getArray()).setLlimit(new MFFloat534().getArray())
                                                          .addChild(new HAnimSegment().setName("r_trapezoid").setDEF("hanim_r_trapezoid")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32535().getArray())
                                                                ...
                                                                .addComments("from r_midcarpal_2 to r_carpometacarpal_2 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                                            .addChild(new HAnimSite().setName("r_metacarpal_phalanx_2_pt").setDEF("hanim_r_metacarpal_phalanx_2_pt").setTranslation(new float[] {-0.1977f,0.8169f,-0.0177f})
                                                              ...
                                                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                          .addChild(new HAnimJoint().setName("r_carpometacarpal_2").setDEF("hanim_r_carpometacarpal_2").setCenter(new float[] {-0.1961f,0.8055f,-0.0218f}).setUlimit(new MFFloat537().getArray()).setLlimit(new MFFloat538().getArray())
                                                            .addChild(new HAnimSegment().setName("r_metacarpal_2").setDEF("hanim_r_metacarpal_2")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32539().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_metacarpophalangeal_2").setDEF("hanim_r_metacarpophalangeal_2").setCenter(new float[] {-0.1961f,0.7846f,-0.0218f}).setUlimit(new MFFloat541().getArray()).setLlimit(new MFFloat542().getArray())
                                                              .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_2").setDEF("hanim_r_carpal_proximal_phalanx_2")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new MFInt32543().getArray())
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-0.1954f,0.7393f,-0.0185f}).setUlimit(new MFFloat545().getArray()).setLlimit(new MFFloat546().getArray())
                                                                .addChild(new HAnimSegment().setName("r_carpal_middle_phalanx_2").setDEF("hanim_r_carpal_middle_phalanx_2")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_dactylion_pt").setDEF("hanim_r_dactylion_pt").setTranslation(new float[] {-0.1941f,0.6772f,-0.0423f})
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                                .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setCenter(new float[] {-0.1945f,0.7169f,-0.0173f}).setUlimit(new MFFloat549().getArray()).setLlimit(new MFFloat550().getArray()))))))
                                                        .addChild(new HAnimJoint().setName("r_midcarpal_3").setDEF("hanim_r_midcarpal_3").setUlimit(new MFFloat551().getArray()).setLlimit(new MFFloat552().getArray())
                                                          .addChild(new HAnimSegment().setName("r_capitate").setDEF("hanim_r_capitate")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32553().getArray())
                                                                ...
                                                                .addComments("from r_midcarpal_3 to r_carpometacarpal_3 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                                            .addChild(new HAnimSite().setName("r_metacarpal_phalanx_3_pt").setDEF("hanim_r_metacarpal_phalanx_3_pt")
                                                              ...
                                                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                          .addChild(new HAnimJoint().setName("r_carpometacarpal_3").setDEF("hanim_r_carpometacarpal_3").setCenter(new float[] {-0.1972f,0.806f,-0.0468f}).setUlimit(new MFFloat555().getArray()).setLlimit(new MFFloat556().getArray())
                                                            .addChild(new HAnimSegment().setName("r_metacarpal_3").setDEF("hanim_r_metacarpal_3")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32557().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_metacarpophalangeal_3").setDEF("hanim_r_metacarpophalangeal_3").setCenter(new float[] {-0.1972f,0.7849f,-0.0468f}).setUlimit(new MFFloat559().getArray()).setLlimit(new MFFloat560().getArray())
                                                              .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_3").setDEF("hanim_r_carpal_proximal_phalanx_3")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new MFInt32561().getArray())
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-0.195f,0.7304f,-0.0441f}).setUlimit(new MFFloat563().getArray()).setLlimit(new MFFloat564().getArray())
                                                                .addChild(new HAnimSegment().setName("r_carpal_middle_phalanx_3").setDEF("hanim_r_carpal_middle_phalanx_3")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_carpal_distal_phalanx_3_tip").setDEF("hanim_r_carpal_distal_phalanx_3_tip")
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                                .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setCenter(new float[] {-0.1939f,0.7042f,-0.0432f}).setUlimit(new MFFloat567().getArray()).setLlimit(new MFFloat568().getArray()))))))
                                                        .addChild(new HAnimJoint().setName("r_midcarpal_4_5").setDEF("hanim_r_midcarpal_4_5").setUlimit(new MFFloat569().getArray()).setLlimit(new MFFloat570().getArray())
                                                          .addChild(new HAnimSegment().setName("r_hamate").setDEF("hanim_r_hamate")
                                                            ...
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32571().getArray())
                                                                ...
                                                                .addComments("from r_midcarpal_4_5 to r_carpometacarpal_4 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                                            .addChild(new Shape()
                                                              .setGeometry(new LineSet().setVertexCount(new MFInt32573().getArray())
                                                                .setCoord(new Coordinate().setPoint(new MFVec3f574().getArray()))
                                                                .addComments("from r_midcarpal_4_5 to r_carpometacarpal_5 vertices 1")
                                                                .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                                            .addChild(new HAnimSite().setName("r_metacarpal_phalanx_5_pt").setDEF("hanim_r_metacarpal_phalanx_5_pt").setTranslation(new float[] {-0.1929f,0.789f,-0.1064f})
                                                              ...
                                                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                          .addChild(new HAnimJoint().setName("r_carpometacarpal_4").setDEF("hanim_r_carpometacarpal_4").setCenter(new float[] {-0.1951f,0.8049f,-0.0732f}).setUlimit(new MFFloat575().getArray()).setLlimit(new MFFloat576().getArray())
                                                            .addChild(new HAnimSegment().setName("r_metacarpal_4").setDEF("hanim_r_metacarpal_4")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32577().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_metacarpophalangeal_4").setDEF("hanim_r_metacarpophalangeal_4").setCenter(new float[] {-0.1951f,0.7845f,-0.0732f}).setUlimit(new MFFloat579().getArray()).setLlimit(new MFFloat580().getArray())
                                                              .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_4").setDEF("hanim_r_carpal_proximal_phalanx_4")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new MFInt32581().getArray())
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setCenter(new float[] {-0.192f,0.7318f,-0.0716f}).setUlimit(new MFFloat583().getArray()).setLlimit(new MFFloat584().getArray())
                                                                .addChild(new HAnimSegment().setName("r_carpal_middle_phalanx_4").setDEF("hanim_r_carpal_middle_phalanx_4")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_carpal_distal_phalanx_4_tip").setDEF("hanim_r_carpal_distal_phalanx_4_tip")
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                                .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setCenter(new float[] {-0.1908f,0.7077f,-0.0706f}).setUlimit(new MFFloat587().getArray()).setLlimit(new MFFloat588().getArray())))))
                                                          .addChild(new HAnimJoint().setName("r_carpometacarpal_5").setDEF("hanim_r_carpometacarpal_5").setCenter(new float[] {-0.1926f,0.8096f,-0.0975f}).setUlimit(new MFFloat589().getArray()).setLlimit(new MFFloat590().getArray())
                                                            .addChild(new HAnimSegment().setName("r_metacarpal_5").setDEF("hanim_r_metacarpal_5")
                                                              ...
                                                              .addChild(new Shape()
                                                                .setGeometry(new LineSet().setVertexCount(new MFInt32591().getArray())
                                                                  ...
                                                                  .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                            .addChild(new HAnimJoint().setName("r_metacarpophalangeal_5").setDEF("hanim_r_metacarpophalangeal_5").setCenter(new float[] {-0.1926f,0.7896f,-0.0975f}).setUlimit(new MFFloat593().getArray()).setLlimit(new MFFloat594().getArray())
                                                              .addChild(new HAnimSegment().setName("r_carpal_proximal_phalanx_5").setDEF("hanim_r_carpal_proximal_phalanx_5")
                                                                ...
                                                                .addChild(new Shape()
                                                                  .setGeometry(new LineSet().setVertexCount(new MFInt32595().getArray())
                                                                    ...
                                                                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                                                              .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_5").setCenter(new float[] {-0.1902f,0.7483f,-0.0963f}).setUlimit(new MFFloat597().getArray()).setLlimit(new MFFloat598().getArray())
                                                                .addChild(new HAnimSegment().setName("r_carpal_middle_phalanx_5").setDEF("hanim_r_carpal_middle_phalanx_5")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_carpal_distal_phalanx_5_tip").setDEF("hanim_r_carpal_distal_phalanx_5_tip")
                                                                    ...
                                                                    .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                                                .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_5").setDEF("hanim_r_carpal_distal_interphalangeal_5").setCenter(new float[] {-0.1908f,0.754f,-0.096f}).setUlimit(new MFFloat601().getArray()).setLlimit(new MFFloat602().getArray())))))))))))))))))))))))))))))
...
protected class MFColorRGBA8 {
  protected org.web3d.x3d.jsail.fields.MFColorRGBA getArray() {
    return new org.web3d.x3d.jsail.fields.MFColorRGBA(new float[] {1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.1000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.1000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.1000f});
  }
}
...
protected class MFVec3f15 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {0.0000f,1.7700f,0.0000f,0.0000f,1.6650f,0.0900f,-0.0330f,1.6200f,0.0870f,0.0330f,1.6200f,0.0870f,0.0000f,1.5500f,0.0970f,-0.0770f,1.6400f,-0.0100f,-0.0527f,1.5800f,0.0150f,0.0770f,1.6400f,-0.0100f,0.0527f,1.5800f,0.0150f,0.0000f,1.6250f,-0.0925f,-0.0300f,1.4600f,0.0350f,0.0000f,1.4400f,0.0300f,0.0300f,1.4600f,0.0350f,-0.1135f,1.3180f,0.0950f,0.1135f,1.3180f,0.0950f,0.0000f,1.2500f,0.1130f,-0.0870f,1.1900f,0.0900f,-0.0935f,1.0300f,0.0750f,0.0870f,1.1900f,0.0900f,0.0935f,1.0300f,0.0750f,-0.1425f,1.0650f,0.0033f,-0.1500f,0.9000f,-0.0100f,0.1425f,1.0650f,0.0033f,0.1500f,0.9000f,-0.0100f,0.0000f,1.5300f,-0.0840f,0.0049f,1.1908f,-0.1113f,-0.0773f,1.0190f,-0.1200f,0.0773f,1.0190f,-0.1200f,0.0050f,1.0915f,-0.1091f,-0.1780f,1.4825f,-0.0625f,-0.1700f,1.3800f,0.0070f,-0.1884f,0.8676f,-0.0360f,-0.1600f,1.3800f,-0.1270f,-0.2000f,1.1388f,-0.0800f,-0.2440f,1.1388f,-0.0400f,-0.1650f,1.1388f,-0.0400f,-0.2300f,1.1330f,-0.0550f,-0.1977f,0.8169f,-0.0177f,-0.1941f,0.6772f,-0.0423f,-0.2117f,0.8562f,-0.0584f,-0.1929f,0.7890f,-0.1064f,0.1750f,1.4825f,-0.0600f,0.1700f,1.3800f,0.0070f,0.1901f,0.8645f,-0.0415f,0.1600f,1.3800f,-0.1250f,0.2000f,1.1388f,-0.0800f,0.1650f,1.1388f,-0.0400f,0.2440f,1.1388f,-0.0400f,0.2300f,1.1330f,-0.0550f,0.2009f,0.8139f,-0.0237f,0.2056f,0.6743f,-0.0482f,0.2142f,0.8529f,-0.0648f,0.1929f,0.7860f,-0.1122f,-0.1000f,0.4913f,-0.0300f,-0.1700f,0.4660f,0.0000f,-0.0500f,0.4660f,0.0000f,-0.1650f,0.0100f,0.1200f,-0.1500f,0.0700f,0.0000f,-0.0850f,0.0860f,0.0125f,-0.0900f,0.0560f,0.0125f,-0.1150f,0.0200f,0.1220f,-0.1150f,0.0400f,-0.0550f,-0.1100f,0.0110f,0.1900f,0.0993f,0.4881f,-0.0309f,0.1700f,0.4660f,0.0000f,0.0500f,0.4867f,0.0000f,0.1650f,0.0100f,0.1200f,0.1500f,0.0700f,0.0000f,0.0850f,0.0860f,0.0125f,0.0900f,0.0560f,0.0125f,0.1150f,0.0200f,0.1220f,0.1150f,0.0400f,-0.0550f,0.1100f,0.0110f,0.1900f,0.0000f,0.8750f,0.0000f,-0.0646f,1.5149f,-0.0380f,0.0646f,1.5149f,-0.0380f,0.0000f,1.0722f,0.0900f,-0.1100f,1.4270f,-0.1375f,-0.2350f,1.4200f,-0.0625f,0.1100f,1.4270f,-0.1375f,0.2350f,1.4200f,-0.0625f,0.0000f,1.4100f,-0.1450f,0.0000f,0.9250f,0.0800f,-0.0870f,1.1900f,-0.0900f,0.0870f,1.1900f,-0.0900f,0.1720f,1.3200f,-0.0300f,-0.1720f,1.3200f,-0.0300f,0.1500f,1.2300f,-0.0150f,-0.1500f,1.2300f,-0.0150f,0.0790f,0.9200f,-0.1400f,0.1000f,0.9000f,0.0770f,-0.0790f,0.9200f,-0.1400f,-0.1000f,0.9000f,0.0750f,0.0000f,0.8700f,0.0000f,0.1710f,0.6500f,0.0000f,0.0200f,0.6500f,0.0000f,0.1000f,0.6500f,-0.0800f,0.1000f,0.6500f,0.0700f,-0.1710f,0.6500f,0.0000f,-0.0200f,0.6500f,0.0000f,-0.1000f,0.6500f,-0.0800f,-0.1000f,0.6500f,0.0700f,0.2500f,1.2700f,-0.0400f,0.1700f,1.2700f,-0.0400f,0.2000f,1.2700f,-0.0900f,0.2000f,1.2700f,0.0200f,0.2440f,1.1388f,-0.0400f,0.1650f,1.1388f,-0.0400f,0.2000f,1.1388f,-0.0800f,0.2000f,1.1388f,-0.0130f,0.2250f,1.0000f,-0.0100f,0.2250f,1.0000f,-0.0700f,0.1850f,1.0000f,-0.0100f,0.1850f,1.0000f,-0.0700f,0.2000f,1.1388f,-0.0400f,0.2250f,0.9200f,-0.0400f,0.1750f,0.9200f,-0.0400f,0.2000f,0.9200f,-0.0650f,0.2000f,0.9200f,-0.0150f,0.2250f,0.8900f,-0.0400f,0.1750f,0.8900f,-0.0400f,0.2000f,0.8900f,-0.0650f,0.2000f,0.8900f,-0.0150f,0.2180f,0.8600f,-0.0400f,0.1840f,0.8600f,-0.0400f,0.2000f,0.8700f,-0.0700f,0.2000f,0.8700f,0.0000f,0.2100f,0.8500f,0.0000f,0.1854f,0.8500f,0.0000f,0.2120f,0.8400f,-0.0150f,0.1830f,0.8400f,-0.0150f,0.2130f,0.8350f,-0.0400f,0.1900f,0.8350f,-0.0400f,0.2110f,0.8350f,-0.0650f,0.1920f,0.8350f,-0.0650f,0.2080f,0.8400f,-0.0850f,0.1900f,0.8400f,-0.0850f,0.2000f,0.8400f,-0.0950f,0.2150f,0.8200f,0.0000f,0.1930f,0.8150f,0.0050f,0.1980f,0.8000f,0.0120f,0.2100f,0.8200f,0.0300f,0.1900f,0.8200f,0.0300f,0.2000f,0.8350f,0.0390f,0.2120f,0.8000f,0.0500f,0.1880f,0.8000f,0.0500f,0.2000f,0.8070f,0.0570f,0.2000f,0.7930f,0.0350f,0.2000f,0.7740f,0.0760f,0.2120f,0.7800f,0.0700f,0.1880f,0.7800f,0.0700f,0.2000f,0.7850f,0.0750f,0.2000f,0.7700f,0.0620f,0.2150f,0.7930f,-0.0150f,0.1870f,0.7930f,-0.0150f,0.2000f,0.7930f,-0.0050f,0.2150f,0.7880f,-0.0400f,0.1870f,0.7880f,-0.0400f,0.2150f,0.7930f,-0.0650f,0.1870f,0.7930f,-0.0650f,0.2100f,0.7900f,-0.0850f,0.1900f,0.7900f,-0.0850f,0.2000f,0.7900f,-0.0950f,0.1900f,0.7700f,-0.0275f,0.1900f,0.7700f,-0.0525f,0.1900f,0.7800f,-0.0775f,0.2120f,0.7450f,-0.0150f,0.1880f,0.7450f,-0.0200f,0.2000f,0.7450f,-0.0255f,0.2000f,0.7450f,-0.0045f,0.2110f,0.7200f,-0.0150f,0.1890f,0.7200f,-0.0150f,0.2000f,0.7200f,-0.0252f,0.2000f,0.7200f,-0.0048f,0.2100f,0.6950f,-0.0150f,0.1900f,0.6950f,-0.0150f,0.2000f,0.6950f,-0.0250f,0.2000f,0.6950f,-0.0050f,0.2000f,0.6850f,-0.0150f,0.2150f,0.7400f,-0.0400f,0.1850f,0.7400f,-0.0400f,0.2000f,0.7400f,-0.0550f,0.2000f,0.7400f,-0.0250f,0.2100f,0.7142f,-0.0400f,0.1900f,0.7142f,-0.0400f,0.2000f,0.7142f,-0.0530f,0.2000f,0.7142f,-0.0270f,0.2100f,0.6800f,-0.0400f,0.1900f,0.6800f,-0.0400f,0.2000f,0.6800f,-0.0500f,0.2000f,0.6800f,-0.0300f,0.2000f,0.6700f,-0.0400f,0.2120f,0.7400f,-0.0650f,0.1880f,0.7400f,-0.0650f,0.2000f,0.7400f,-0.0756f,0.2000f,0.7400f,-0.0542f,0.2100f,0.7177f,-0.0650f,0.1900f,0.7177f,-0.0650f,0.2000f,0.7177f,-0.0751f,0.2000f,0.7177f,-0.0549f,0.2100f,0.6950f,-0.0650f,0.1900f,0.6950f,-0.0650f,0.2000f,0.6950f,-0.0750f,0.2000f,0.6950f,-0.0550f,0.2000f,0.6850f,-0.0650f,0.2110f,0.7550f,-0.0850f,0.1890f,0.7550f,-0.0850f,0.2000f,0.7550f,-0.0952f,0.2000f,0.7550f,-0.0748f,0.2100f,0.7350f,-0.0850f,0.1900f,0.7350f,-0.0850f,0.2000f,0.7350f,-0.0951f,0.2000f,0.7350f,-0.0749f,0.2100f,0.7200f,-0.0850f,0.1900f,0.7200f,-0.0850f,0.2000f,0.7200f,-0.0950f,0.2000f,0.7200f,-0.0750f,0.2000f,0.7100f,-0.0850f,-0.2300f,1.2300f,-0.0400f,-0.1600f,1.2300f,-0.0400f,-0.2000f,1.2350f,-0.1050f,-0.2000f,1.2350f,0.0200f,-0.2440f,1.1388f,-0.0400f,-0.1650f,1.1388f,-0.0400f,-0.2000f,1.1388f,-0.0800f,-0.2000f,1.1388f,0.0130f,-0.2250f,1.0000f,-0.0100f,-0.2250f,1.0000f,-0.0700f,-0.1850f,1.0000f,-0.0100f,-0.1850f,1.0000f,-0.0700f,-0.2000f,1.1388f,-0.0400f,-0.2250f,0.9200f,-0.0400f,-0.1750f,0.9200f,-0.0400f,-0.2000f,0.9200f,-0.0650f,-0.2000f,0.9200f,-0.0150f,-0.2250f,0.8900f,-0.0400f,-0.1750f,0.8900f,-0.0400f,-0.2000f,0.8900f,-0.0650f,-0.2000f,0.8900f,-0.0150f,-0.2180f,0.8600f,-0.0400f,-0.1840f,0.8600f,-0.0400f,-0.2000f,0.8700f,-0.0700f,-0.2000f,0.8700f,0.0000f,-0.2100f,0.8500f,0.0000f,-0.1854f,0.8500f,0.0000f,-0.2120f,0.8400f,-0.0150f,-0.1830f,0.8400f,-0.0150f,-0.2130f,0.8350f,-0.0400f,-0.1900f,0.8350f,-0.0400f,-0.2110f,0.8350f,-0.0650f,-0.1920f,0.8350f,-0.0650f,-0.2080f,0.8400f,-0.0850f,-0.1900f,0.8400f,-0.0850f,-0.2000f,0.8400f,-0.0950f,-0.2150f,0.8200f,0.0000f,-0.1930f,0.8150f,0.0050f,-0.1980f,0.8000f,0.0120f,-0.2100f,0.8200f,0.0300f,-0.1900f,0.8200f,0.0300f,-0.2000f,0.8350f,0.0390f,-0.2120f,0.8000f,0.0500f,-0.1880f,0.8000f,0.0500f,-0.2000f,0.8070f,0.0570f,-0.2000f,0.7930f,0.0350f,-0.2000f,0.7740f,0.0760f,-0.2120f,0.7800f,0.0700f,-0.1880f,0.7800f,0.0700f,-0.2000f,0.7850f,0.0750f,-0.2000f,0.7700f,0.0620f,-0.2150f,0.7930f,-0.0150f,-0.1870f,0.7930f,-0.0150f,-0.2000f,0.7930f,-0.0050f,-0.2150f,0.7880f,-0.0400f,-0.1870f,0.7880f,-0.0400f,-0.2150f,0.7930f,-0.0650f,-0.1870f,0.7930f,-0.0650f,-0.2100f,0.7900f,-0.0850f,-0.1900f,0.7900f,-0.0850f,-0.2000f,0.7900f,-0.0950f,-0.1900f,0.7700f,-0.0275f});
  }
}
protected class MFVec3f16 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {-0.1900f,0.7700f,-0.0525f,-0.1900f,0.7800f,-0.0775f,-0.2120f,0.7450f,-0.0150f,-0.1880f,0.7450f,-0.0200f,-0.2000f,0.7450f,-0.0255f,-0.2000f,0.7450f,-0.0045f,-0.2110f,0.7200f,-0.0150f,-0.1890f,0.7200f,-0.0150f,-0.2000f,0.7200f,-0.0252f,-0.2000f,0.7200f,-0.0048f,-0.2100f,0.6950f,-0.0150f,-0.1900f,0.6950f,-0.0150f,-0.2000f,0.6950f,-0.0250f,-0.2000f,0.6950f,-0.0050f,-0.2000f,0.6850f,-0.0150f,-0.2150f,0.7400f,-0.0400f,-0.1850f,0.7400f,-0.0400f,-0.2000f,0.7400f,-0.0550f,-0.2000f,0.7400f,-0.0250f,-0.2100f,0.7142f,-0.0400f,-0.1900f,0.7142f,-0.0400f,-0.2000f,0.7142f,-0.0530f,-0.2000f,0.7142f,-0.0270f,-0.2100f,0.6800f,-0.0400f,-0.1900f,0.6800f,-0.0400f,-0.2000f,0.6800f,-0.0500f,-0.2000f,0.6800f,-0.0300f,-0.2000f,0.6700f,-0.0400f,-0.2120f,0.7400f,-0.0650f,-0.1880f,0.7400f,-0.0650f,-0.2000f,0.7400f,-0.0756f,-0.2000f,0.7400f,-0.0542f,-0.2100f,0.7177f,-0.0650f,-0.1900f,0.7177f,-0.0650f,-0.2000f,0.7177f,-0.0751f,-0.2000f,0.7177f,-0.0549f,-0.2100f,0.6950f,-0.0650f,-0.1900f,0.6950f,-0.0650f,-0.2000f,0.6950f,-0.0750f,-0.2000f,0.6950f,-0.0550f,-0.2000f,0.6850f,-0.0650f,-0.2110f,0.7550f,-0.0850f,-0.1890f,0.7550f,-0.0850f,-0.2000f,0.7550f,-0.0952f,-0.2000f,0.7550f,-0.0748f,-0.2100f,0.7350f,-0.0850f,-0.1900f,0.7350f,-0.0850f,-0.2000f,0.7350f,-0.0951f,-0.2000f,0.7350f,-0.0749f,-0.2100f,0.7200f,-0.0850f,-0.1900f,0.7200f,-0.0850f,-0.2000f,0.7200f,-0.0950f,-0.2000f,0.7200f,-0.0750f,-0.2000f,0.7100f,-0.0850f,0.1150f,0.4660f,0.0600f,0.1150f,0.4660f,-0.0550f,0.1500f,0.4660f,0.0000f,0.0500f,0.4660f,0.0000f,0.1700f,0.3000f,0.0000f,0.0600f,0.3000f,0.0000f,0.1000f,0.3000f,-0.0500f,0.1000f,0.3000f,0.0500f,0.1500f,0.0700f,0.0000f,0.0850f,0.0860f,0.0125f,0.1150f,0.0690f,-0.0450f,0.1170f,0.0975f,0.0615f,0.1375f,0.0060f,-0.0300f,0.0950f,0.0060f,-0.0300f,0.1150f,0.0150f,-0.0450f,0.1150f,0.0600f,0.1000f,0.1150f,0.0000f,0.0700f,0.1650f,0.0000f,0.0700f,0.0950f,0.0000f,0.0700f,0.1150f,0.0400f,0.1300f,0.1250f,0.0000f,0.1200f,0.1650f,0.0000f,0.1200f,0.0870f,0.0000f,0.1220f,0.0900f,0.0120f,0.1880f,0.1100f,0.0110f,0.1900f,0.1280f,0.0110f,0.1850f,0.1420f,0.0110f,0.1780f,0.1540f,0.0100f,0.1680f,-0.1150f,0.4660f,0.0600f,-0.1150f,0.4660f,-0.0550f,-0.1700f,0.4660f,0.0000f,-0.0500f,0.4660f,0.0000f,-0.1700f,0.3000f,0.0000f,-0.0600f,0.3000f,0.0000f,-0.1000f,0.3000f,-0.0500f,-0.1000f,0.3000f,0.0500f,-0.1500f,0.0700f,0.0000f,-0.0850f,0.0860f,0.0125f,-0.1150f,0.0690f,-0.0450f,-0.1170f,0.0975f,0.0615f,-0.1375f,0.0060f,-0.0300f,-0.0950f,0.0060f,-0.0300f,-0.0950f,0.0060f,-0.0300f,-0.1150f,0.0600f,0.1000f,-0.1150f,0.0000f,0.0700f,-0.1650f,0.0000f,0.0700f,-0.0950f,0.0000f,0.0700f,-0.1150f,0.0400f,0.1300f,-0.1250f,0.0000f,0.1200f,-0.1650f,0.0000f,0.1200f,-0.0870f,0.0000f,0.1220f,-0.0900f,0.0120f,0.1880f,-0.1100f,0.0110f,0.1900f,-0.1280f,0.0110f,0.1850f,-0.1420f,0.0110f,0.1780f,-0.1540f,0.0100f,0.1680f});
  }
}
protected class MFColor17 {
  protected org.web3d.x3d.jsail.fields.MFColor getArray() {
    return new org.web3d.x3d.jsail.fields.MFColor(new float[] {1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f});
  }
}
protected class MFColor18 {
  protected org.web3d.x3d.jsail.fields.MFColor getArray() {
    return new org.web3d.x3d.jsail.fields.MFColor(new float[] {0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f,0.0000f,1.0000f,0.0000f,1.0000f,0.0000f});
  }
}
...
protected class MFVec3f402 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {0.1984f,0.8663f,-0.0583f,0.1984f,0.8663f,-0.0583f});
  }
}
...
protected class MFVec3f512 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {-0.1959f,0.8694f,-0.0521f,-0.1959f,0.8694f,-0.0521f});
  }
}

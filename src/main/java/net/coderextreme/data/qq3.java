          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              ...
              .addChild(new Transform().setScale(new float[] {0.5f,0.5f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setDEF("ShapeLeftDown").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              ...
              .addChild(new Transform().setScale(new float[] {0.5f,0.5f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setDEF("ShapeUpRight").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()

            ...
            .addChild(new Group()
              ...
              .addChild(new Transform().setScale(new float[] {0.5f,0.5f,0.5f})
                .addChild(new Shape().setDEF("ShapeLeftDown")
                  .setAppearance(new Appearance("ShapeLeftDown")
                    .setMaterial(new Material().setDiffuseColor(new float[] {0.7f,1f,0f})))
                  .setGeometry(new Extrusion("ShapeLeftDown").setSpine(new MFVec3f0().getArray()).setCreaseAngle(0.785f).setCrossSection(new MFVec2f1().getArray()))))
              .addComments("right")
              .addChild(new Transform().setScale(new float[] {0.5f,0.5f,0.5f})
                .addChild(new Shape().setDEF("ShapeUpRight")
                  .setAppearance(new Appearance("ShapeUpRight")
                    .setMaterial(new Material().setDiffuseColor(new float[] {0f,0.7f,1f})))
                  .setGeometry(new Extrusion("ShapeUpRight").setSpine(new MFVec3f2().getArray()).setCreaseAngle(0.785f).setCrossSection(new MFVec2f3().getArray()))))
              .addComments("up")
              .addChild(new Transform().setScale(new float[] {0.5f,0.5f,0.5f})

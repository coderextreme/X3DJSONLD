...
public class particleflowers implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/particleflowers.new.java.x3d");
    model.toFileJSON("../data/particleflowers.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("A flower particle system")))
        ...
        .addMeta(new meta().setName(new SFString("generator")).setContent(new SFString("Vim"))))
      .setScene(new Scene()

              ...
              .addChild(new HAnimSegment("hanim_skullbase").setName(new SFString("tongue")).setDEF(new SFString("hanim_Tongue"))
                .addChild(new Transform().setDEF(new SFString("Tongue")).setTranslation(new float[] {0f ,8.886f ,11.1f })
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setDEF(new SFString("Tongue-FACES")).setCoordIndex(new MFInt328().getArray().append(new MFInt329().getArray())).setCreaseAngle(3.14159f ).setSolid(false).setTexCoordIndex(new MFInt3210().getArray().append(new MFInt3211().getArray()))
                      .setTexCoord(new TextureCoordinate().setDEF(new SFString("Tongue-TEXCOORD")).setPoint(new MFVec2f12().getArray()))
                      .setCoord(new Coordinate().setDEF(new SFString("Tongue_COORD")).setPoint(new MFVec3f13().getArray())))))
                .setCoord(new Coordinate().setUSE(new SFString("Tongue_COORD")))
                .addDisplacers(new HAnimDisplacer("hanim_Tongue").setName(new SFString("tongue_morphinterpolator")).setDEF(new SFString("Tongue_MorphInterpolator_JinMouthStretch")).setCoordIndex(new MFInt3214().getArray()).setDisplacements(new MFVec3f15().getArray())))))

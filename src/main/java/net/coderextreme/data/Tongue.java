  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("Tongue.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("Facial Action Coding System (FACS) example for Action Unit (AU) 27, Mouth Stretch Morpher, Tongue Derivated.")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/Tongue.x3d")))
      ...
      .setScene(new Scene()
        ...
        .addChild(new TimeSensor().setDEF(new SFString("JinMouthStretch_Clock")).setCycleInterval(0.99d).setLoop(true))
        .addChild(new EXPORT().setLocalDEF(new SFString("JinMouthStretch_Clock")).setAS(new SFString("JinMouthStretch_Clock")))
        .addChild(new ScalarInterpolator().setDEF(new SFString("AnimationAdapter_JinMouthStretch")).setKey(new MFFloat0().getArray()).setKeyValue(new MFFloat1().getArray()))
        .addChild(new HAnimHumanoid().setName(new SFString("humanoid")).setDEF(new SFString("hanim_humanoid")).setVersion(new SFString("2.0"))
          .addSkeleton(new HAnimJoint("hanim_humanoid").setName(new SFString("humanoid_root")).setDEF(new SFString("hanim_root"))
            .addChild(new HAnimSegment("hanim_root").setName(new SFString("sacrum")).setDEF(new SFString("hanim_sacrum"))
              .addChild(new WorldInfo().setTitle(new SFString("Tongue.x3d")))
              .addChild(new Background().setSkyColor(new MFColor2().getArray()))
              .addChild(new NavigationInfo().setType("\"EXAMINE\"")))
            .addChild(new HAnimJoint("hanim_root").setName(new SFString("skullbase")).setDEF(new SFString("hanim_skullbase"))
                ...
                .addChild(new Transform().setDEF(new SFString("Tongue")).setTranslation(new float[] {0f ,8.886f ,11.1f })
                  .addChild(new Shape()
                    .setAppearance(new Appearance().setDEF(new SFString("BaseAppearance"))
                      ...
                      .setTexture(new ImageTexture().setDEF(new SFString("JinImageAtlas")).setUrl(new MFString3().getArray())))
                    .setGeometry(new IndexedFaceSet().setDEF(new SFString("Tongue-FACES")).setCoordIndex(new MFInt324().getArray().append(new MFInt325().getArray())).setCreaseAngle(3.14159f ).setSolid(false).setTexCoordIndex(new MFInt326().getArray().append(new MFInt327().getArray()))
                      .setTexCoord(new TextureCoordinate().setDEF(new SFString("Tongue-TEXCOORD")).setPoint(new MFVec2f8().getArray()))
                      .setCoord(new Coordinate().setDEF(new SFString("Tongue_COORD")).setPoint(new MFVec3f9().getArray())))))
                .setCoord(new Coordinate().setUSE(new SFString("Tongue_COORD")))
                .addDisplacers(new HAnimDisplacer("hanim_Tongue").setName(new SFString("tongue_morphinterpolator")).setDEF(new SFString("Tongue_MorphInterpolator_JinMouthStretch")).setCoordIndex(new MFInt3210().getArray()).setDisplacements(new MFVec3f11().getArray())))))

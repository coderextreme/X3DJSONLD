  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("2 January 2023"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("SpecHumanoid")
          .addChild(new Group().setDEF("JoeISOHumanoid")
            .addChild(new HAnimHumanoid().setName("Human").setDEF("Joe_Human").setInfo(new MFString12().getArray()).setVersion("2.0")
              ...
              .addSkeleton(new HAnimJoint().setName("HumanoidRoot").setDEF("Joe_HumanoidRoot").setCenter(new float[] {0f,0.875f,0f}).setUlimit(new MFFloat23().getArray()).setLlimit(new MFFloat24().getArray())
                .addChild(new HAnimSegment().setName("sacrum").setDEF("Joe_sacrum")
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0f,0.87f,-0.022f})
                    .addChild(new Shape().setUSE("skinsphere"))))
                .addChild(new HAnimJoint().setName("sacroiliac").setDEF("Joe_sacroiliac").setCenter(new float[] {0f,0.92f,0f}).setSkinCoordIndex(new MFInt3227().getArray()).setSkinCoordWeight(new MFFloat28().getArray()).setUlimit(new MFFloat29().getArray()).setLlimit(new MFFloat30().getArray())
                  .addChild(new HAnimSegment().setName("pelvis").setDEF("Joe_pelvis")
                    ...
                    .addChild(new Shape()
                      ...
                      .setAppearance(new Appearance().setUSE("SegmentLine")))
                    .addChild(new HAnimSite().setName("l_iliocristale").setDEF("Joe_l_iliocristale").setTranslation(new float[] {0.1425f,1.065f,0.0033f})
                      .addChild(new Shape().setUSE("sitebox")))
                    .addChild(new HAnimSite().setName("l_trochanterion").setDEF("Joe_l_trochanterion").setTranslation(new float[] {0.15f,0.9f,-0.01f})
                      .addChild(new Shape().setUSE("sitebox")))
                    .addChild(new HAnimSite().setName("r_iliocristale").setDEF("Joe_r_iliocristale").setTranslation(new float[] {-0.1425f,1.065f,0.0033f})
                      .addChild(new Shape().setUSE("sitebox")))
                    .addChild(new HAnimSite().setName("r_trochanterion").setDEF("Joe_r_trochanterion").setTranslation(new float[] {-0.15f,0.9f,-0.01f})
                      .addChild(new Shape().setUSE("sitebox")))
                    .addChild(new HAnimSite().setName("l_asis").setDEF("Joe_l_asis").setTranslation(new float[] {0.0935f,1.03f,0.075f})
                      .addChild(new Shape().setUSE("sitebox")))
                    .addChild(new HAnimSite().setName("r_asis").setDEF("Joe_r_asis").setTranslation(new float[] {-0.0935f,1.03f,0.075f})
                      .addChild(new Shape().setUSE("sitebox")))
                    .addChild(new HAnimSite().setName("l_psis").setDEF("Joe_l_psis").setTranslation(new float[] {0.0773f,1.019f,-0.12f})
                      .addChild(new Shape().setUSE("sitebox")))
                    .addChild(new HAnimSite().setName("r_psis").setDEF("Joe_r_psis").setTranslation(new float[] {-0.0773f,1.019f,-0.12f})
                      .addChild(new Shape().setUSE("sitebox")))
                    .addChild(new HAnimSite().setName("floormarker").setDEF("Joe_floormarker")
                      .addChild(new Transform().setScale(new float[] {3f,3f,3f})
                        .addChild(new Shape().setUSE("sitebox"))))
                    .addChild(new HAnimSite().setName("crotch").setDEF("Joe_crotch").setTranslation(new float[] {0f,0.87f,-0.022f})
                      .addChild(new Shape().setUSE("sitebox"))))
                  .addChild(new HAnimJoint().setName("l_hip").setDEF("Joe_l_hip").setCenter(new float[] {0.1f,0.92f,0f}).setSkinCoordIndex(new MFInt3233().getArray()).setSkinCoordWeight(new MFFloat34().getArray()).setUlimit(new MFFloat35().getArray()).setLlimit(new MFFloat36().getArray())
                    .addChild(new HAnimSegment().setName("l_thigh").setDEF("Joe_l_thigh")
                      ...
                      .addChild(new Transform().setTranslation(new float[] {0.1f,0.65f,0.07f})
                        .addChild(new Shape().setUSE("skinsphere")))
                      .addChild(new HAnimSite().setName("l_knee_crease").setDEF("Joe_l_knee_crease").setTranslation(new float[] {0.115f,0.466f,-0.055f})
                        .addChild(new Shape().setUSE("sitebox")))
                      .addChild(new HAnimSite().setName("l_femoral_lateral_epicn").setDEF("Joe_l_femoral_lateral_epicn").setTranslation(new float[] {0.17f,0.466f,0f})
                        .addChild(new Shape().setUSE("sitebox")))
                      .addChild(new HAnimSite().setName("l_femoral_medial_epicn").setDEF("Joe_l_femoral_medial_epicn").setTranslation(new float[] {0.05f,0.466f,0f})
                        .addChild(new Shape().setUSE("sitebox"))))
                    .addChild(new HAnimJoint().setName("l_knee").setDEF("Joe_l_knee").setCenter(new float[] {0.11500000208616257f,0.4659999907016754f,0f}).setSkinCoordIndex(new MFInt3239().getArray()).setSkinCoordWeight(new MFFloat40().getArray()).setUlimit(new MFFloat41().getArray()).setLlimit(new MFFloat42().getArray())
                      .addChild(new HAnimSegment().setName("l_calf").setDEF("Joe_l_calf")
                        ...
                        .addChild(new Transform().setTranslation(new float[] {0.1f,0.3f,0.05f})
                          .addChild(new Shape().setUSE("skinsphere")))
                        .addChild(new HAnimSite().setName("l_lateral_malleolus").setDEF("Joe_l_lateral_malleolus").setTranslation(new float[] {0.15f,0.07f,0f})
                          .addChild(new Shape().setUSE("sitebox")))
                        .addChild(new HAnimSite().setName("l_medial_malleolus").setDEF("Joe_l_medial_malleolus").setTranslation(new float[] {0.085f,0.086f,0.0125f})
                          .addChild(new Shape().setUSE("sitebox"))))
                      .addChild(new HAnimJoint().setName("l_ankle").setDEF("Joe_l_ankle").setCenter(new float[] {0.115f,0.069f,0f}).setSkinCoordIndex(new MFInt3245().getArray()).setSkinCoordWeight(new MFFloat46().getArray()).setUlimit(new MFFloat47().getArray()).setLlimit(new MFFloat48().getArray())
                        .addChild(new HAnimSegment().setName("l_hindfoot").setDEF("Joe_l_hindfoot")
                          ...
                          .addChild(new Transform().setTranslation(new float[] {0.117f,0.0975f,0.0615f})
                            .addChild(new Shape().setUSE("skinsphere")))
                          .addChild(new HAnimSite().setName("l_sphyrion").setDEF("Joe_l_sphyrion").setTranslation(new float[] {0.09f,0.056f,0.0125f})
                            .addChild(new Shape().setUSE("sitebox")))
                          .addChild(new HAnimSite().setName("l_calcaneous_post").setDEF("Joe_l_calcaneous_post").setTranslation(new float[] {0.115f,0.04f,-0.055f})
                            .addChild(new Shape().setUSE("sitebox"))))
                        .addChild(new HAnimJoint().setName("l_subtalar").setDEF("Joe_l_subtalar").setCenter(new float[] {0.115f,0.031f,0.03f}).setSkinCoordIndex(new MFInt3251().getArray()).setSkinCoordWeight(new MFFloat52().getArray()).setUlimit(new MFFloat53().getArray()).setLlimit(new MFFloat54().getArray())
                          .addChild(new HAnimSegment().setName("l_midproximal").setDEF("Joe_l_midproximal")
                            ...
                            .addChild(new Transform().setTranslation(new float[] {0.115f,0.015f,-0.045f})
                              .addChild(new Shape().setUSE("skinsphere"))))
                          .addChild(new HAnimJoint().setName("l_midtarsal").setDEF("Joe_l_midtarsal").setCenter(new float[] {0.115f,0.037f,0.09f}).setSkinCoordIndex(new MFInt3257().getArray()).setSkinCoordWeight(new MFFloat58().getArray()).setUlimit(new MFFloat59().getArray()).setLlimit(new MFFloat60().getArray())
                            ...
                            .addChild(new HAnimJoint().setName("l_metatarsal").setDEF("Joe_l_metatarsal").setCenter(new float[] {0.11500000208616257f,0.019999999552965164f,0.12200000137090683f}).setSkinCoordIndex(new MFInt3263().getArray()).setSkinCoordWeight(new MFFloat64().getArray()).setUlimit(new MFFloat65().getArray()).setLlimit(new MFFloat66().getArray())
                              .addChild(new HAnimSegment().setName("l_forefoot").setDEF("Joe_l_forefoot")
                                ...
                                .addChild(new HAnimSite().setName("l_digit2").setDEF("Joe_l_digit2").setTranslation(new float[] {0.10999999940395355f,0.010999999940395355f,0.1899999976158142f})
                                  .addChild(new Shape().setUSE("sitebox"))))))))))
                  .addChild(new HAnimJoint().setName("r_hip").setDEF("Joe_r_hip").setCenter(new float[] {-0.10000000149011612f,0.9200000166893005f,0f}).setSkinCoordIndex(new MFInt3269().getArray()).setSkinCoordWeight(new MFFloat70().getArray()).setUlimit(new MFFloat71().getArray()).setLlimit(new MFFloat72().getArray())
                    .addChild(new HAnimSegment().setName("r_thigh").setDEF("Joe_r_thigh")
                      ...
                      .addChild(new HAnimSite().setName("r_femoral_medial_epicn").setDEF("Joe_r_femoral_medial_epicn").setTranslation(new float[] {-0.05000000074505806f,0.4659999907016754f,0f})
                        .addChild(new Shape().setUSE("sitebox"))))
                    .addChild(new HAnimJoint().setName("r_knee").setDEF("Joe_r_knee").setCenter(new float[] {-0.05000000074505806f,0.4659999907016754f,0f}).setSkinCoordIndex(new MFInt3275().getArray()).setSkinCoordWeight(new MFFloat76().getArray()).setUlimit(new MFFloat77().getArray()).setLlimit(new MFFloat78().getArray())
                      .addChild(new HAnimSegment().setName("r_calf").setDEF("Joe_r_calf")
                        ...
                        .addChild(new HAnimSite().setName("r_medial_malleolus").setDEF("Joe_r_medial_malleolus").setTranslation(new float[] {-0.08500000089406967f,0.0860000029206276f,0.012500000186264515f})
                          .addChild(new Shape().setUSE("sitebox"))))
                      .addChild(new HAnimJoint().setName("r_ankle").setDEF("Joe_r_ankle").setCenter(new float[] {-0.11500000208616257f,0.0689999982714653f,0f}).setSkinCoordIndex(new MFInt3281().getArray()).setSkinCoordWeight(new MFFloat82().getArray()).setUlimit(new MFFloat83().getArray()).setLlimit(new MFFloat84().getArray())
                        .addChild(new HAnimSegment().setName("r_hindfoot").setDEF("Joe_r_hindfoot")
                          ...
                          .addChild(new HAnimSite().setName("r_calcaneous_post").setDEF("Joe_r_calcaneous_post").setTranslation(new float[] {-0.11500000208616257f,0.03999999910593033f,-0.054999999701976776f})
                            .addChild(new Shape().setUSE("sitebox"))))
                        .addChild(new HAnimJoint().setName("r_subtalar").setDEF("Joe_r_subtalar").setCenter(new float[] {-0.10000000149011612f,0.014999999664723873f,-0.009999999776482582f}).setSkinCoordIndex(new MFInt3287().getArray()).setSkinCoordWeight(new MFFloat88().getArray()).setUlimit(new MFFloat89().getArray()).setLlimit(new MFFloat90().getArray())
                          .addChild(new HAnimSegment().setName("r_midproximal").setDEF("Joe_r_midproximal")
                            ...
                            .addChild(new Transform().setTranslation(new float[] {-0.0949999988079071f,0.006000000052154064f,-0.029999999329447746f})
                              .addChild(new Shape().setUSE("skinsphere"))))
                          .addChild(new HAnimJoint().setName("r_midtarsal").setDEF("Joe_r_midtarsal").setCenter(new float[] {-0.11500000208616257f,0.03700000047683716f,0.09000000357627869f}).setSkinCoordIndex(new MFInt3293().getArray()).setSkinCoordWeight(new MFFloat94().getArray()).setUlimit(new MFFloat95().getArray()).setLlimit(new MFFloat96().getArray())
                            ...
                            .addChild(new HAnimJoint().setName("r_metatarsal").setDEF("Joe_r_metatarsal").setCenter(new float[] {-0.10000000149011612f,0.009999999776482582f,0.14000000059604645f}).setSkinCoordIndex(new MFInt3299().getArray()).setSkinCoordWeight(new MFFloat100().getArray()).setUlimit(new MFFloat101().getArray()).setLlimit(new MFFloat102().getArray())
                              .addChild(new HAnimSegment().setName("r_forefoot").setDEF("Joe_r_forefoot")
                                ...
                                .addChild(new HAnimSite().setName("r_digit2").setDEF("Joe_r_digit2").setTranslation(new float[] {-0.10999999940395355f,0.010999999940395355f,0.1899999976158142f})
                                  .addChild(new Shape().setUSE("sitebox")))))))))))
                .addChild(new HAnimJoint().setName("vl5").setDEF("Joe_vl5").setCenter(new float[] {0f,1.0449999570846558f,-0.0949999988079071f}).setSkinCoordIndex(new MFInt32105().getArray()).setSkinCoordWeight(new MFFloat106().getArray()).setUlimit(new MFFloat107().getArray()).setLlimit(new MFFloat108().getArray())
                  ...
                  .addChild(new HAnimSegment().setName("l5").setDEF("Joe_l5")
                    ...
                    .addChild(new HAnimSite().setName("navel").setDEF("Joe_navel").setTranslation(new float[] {0f,1.0722500085830688f,0.09000000357627869f})
                      .addChild(new Shape().setUSE("sitebox"))))
                  .addChild(new HAnimJoint().setName("vl4").setDEF("Joe_vl4").setCenter(new float[] {0f,1.068f,-0.085f}).setUlimit(new MFFloat113().getArray()).setLlimit(new MFFloat114().getArray())
                    .addChild(new HAnimSegment().setName("l4").setDEF("Joe_l4")
                      ...
                      .addChild(new Transform().setTranslation(new float[] {0f,1.068f,-0.085f})
                        .addChild(new Shape().setUSE("jointbox"))))
                    .addChild(new HAnimJoint().setName("vl3").setDEF("Joe_vl3").setCenter(new float[] {0f,1.092f,-0.0725f}).setUlimit(new MFFloat117().getArray()).setLlimit(new MFFloat118().getArray())
                      .addChild(new HAnimSegment().setName("l3").setDEF("Joe_l3")
                        ...
                        .addChild(new Transform().setTranslation(new float[] {0f,1.092f,-0.0725f})
                          .addChild(new Shape().setUSE("jointbox"))))
                      .addChild(new HAnimJoint().setName("vl2").setDEF("Joe_vl2").setCenter(new float[] {0f,1.12f,-0.065f}).setSkinCoordIndex(new MFInt32121().getArray()).setSkinCoordWeight(new MFFloat122().getArray()).setUlimit(new MFFloat123().getArray()).setLlimit(new MFFloat124().getArray())
                        .addChild(new HAnimSegment().setName("l2").setDEF("Joe_l2")
                          ...
                          .addChild(new HAnimSite().setName("l_rib10").setDEF("Joe_l_rib10").setTranslation(new float[] {0.08699999749660492f,1.190000057220459f,0.09000000357627869f})
                            .addChild(new Shape().setUSE("sitebox")))
                          .addChild(new HAnimSite().setName("rib10_midspine").setDEF("Joe_rib10_midspine").setTranslation(new float[] {0f,1.1908f,-0.1113f})
                            .addChild(new Shape().setUSE("sitebox"))))
                        .addChild(new HAnimJoint().setName("vl1").setDEF("Joe_vl1").setCenter(new float[] {0f,1.1459f,-0.0625f}).setUlimit(new MFFloat127().getArray()).setLlimit(new MFFloat128().getArray())
                          .addChild(new HAnimSegment().setName("l1").setDEF("Joe_l1")
                            ...
                            .addChild(new Transform().setTranslation(new float[] {0f,1.1459f,-0.0625f})
                              .addChild(new Shape().setUSE("jointbox"))))
                          .addChild(new HAnimJoint().setName("vt12").setDEF("Joe_vt12").setCenter(new float[] {0f,1.1790000200271606f,-0.06800000369548798f}).setUlimit(new MFFloat131().getArray()).setLlimit(new MFFloat132().getArray())
                            .addChild(new HAnimSegment().setName("t12").setDEF("Joe_t12")
                              ...
                              .addChild(new Transform().setTranslation(new float[] {0f,1.1790000200271606f,-0.06800000369548798f})
                                .addChild(new Shape().setUSE("jointbox"))))
                            .addChild(new HAnimJoint().setName("vt11").setDEF("Joe_vt11").setCenter(new float[] {0f,1.267899990081787f,-0.08100000023841858f}).setUlimit(new MFFloat135().getArray()).setLlimit(new MFFloat136().getArray())
                              .addChild(new HAnimSegment().setName("t11").setDEF("Joe_t11")
                                ...
                                .addChild(new Transform().setTranslation(new float[] {0f,1.2144999504089355f,-0.0754999965429306f})
                                  .addChild(new Shape().setUSE("jointbox"))))
                              .addChild(new HAnimJoint().setName("vt10").setDEF("Joe_vt10").setCenter(new float[] {0f,1.2419999837875366f,-0.09000000357627869f}).setSkinCoordIndex(new MFInt32139().getArray()).setSkinCoordWeight(new MFFloat140().getArray()).setUlimit(new MFFloat141().getArray()).setLlimit(new MFFloat142().getArray())
                                .addChild(new HAnimSegment().setName("t10").setDEF("Joe_t10")
                                  ...
                                  .addChild(new HAnimSite().setName("substernale").setDEF("Joe_substernale").setTranslation(new float[] {0f,1.25f,0.11299999803304672f})
                                    .addChild(new Shape().setUSE("sitebox"))))
                                .addChild(new HAnimJoint().setName("vt9").setDEF("Joe_vt9").setCenter(new float[] {0f,1.2680000066757202f,-0.10000000149011612f}).setSkinCoordIndex(new MFInt32145().getArray()).setSkinCoordWeight(new MFFloat146().getArray()).setUlimit(new MFFloat147().getArray()).setLlimit(new MFFloat148().getArray())
                                  .addChild(new HAnimSegment().setName("t9").setDEF("Joe_t9")
                                    ...
                                    .addChild(new HAnimSite().setName("l_thelion").setDEF("Joe_l_thelion").setTranslation(new float[] {0.11349999904632568f,1.3179999589920044f,0.0949999988079071f})
                                      .addChild(new Shape().setUSE("sitebox"))))
                                  .addChild(new HAnimJoint().setName("vt8").setDEF("Joe_vt8").setCenter(new float[] {0f,1.2940000295639038f,-0.10999999940395355f}).setUlimit(new MFFloat151().getArray()).setLlimit(new MFFloat152().getArray())
                                    .addChild(new HAnimSegment().setName("t8").setDEF("Joe_t8")
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {0f,1.2940000295639038f,-0.10999999940395355f})
                                        .addChild(new Shape().setUSE("jointbox"))))
                                    .addChild(new HAnimJoint().setName("vt7").setDEF("Joe_vt7").setCenter(new float[] {0f,1.3229999542236328f,-0.11550000309944153f}).setUlimit(new MFFloat155().getArray()).setLlimit(new MFFloat156().getArray())
                                      .addChild(new HAnimSegment().setName("t7").setDEF("Joe_t7")
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {0f,1.3229999542236328f,-0.11550000309944153f})
                                          .addChild(new Shape().setUSE("jointbox"))))
                                      .addChild(new HAnimJoint().setName("vt6").setDEF("Joe_vt6").setCenter(new float[] {0f,1.3519999980926514f,-0.11999999731779099f}).setUlimit(new MFFloat159().getArray()).setLlimit(new MFFloat160().getArray())
                                        .addChild(new HAnimSegment().setName("t6").setDEF("Joe_t6")
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {0f,1.3519999980926514f,-0.11999999731779099f})
                                            .addChild(new Shape().setUSE("jointbox"))))
                                        .addChild(new HAnimJoint().setName("vt5").setDEF("Joe_vt5").setCenter(new float[] {0f,1.38100004196167f,-0.12349999696016312f}).setUlimit(new MFFloat163().getArray()).setLlimit(new MFFloat164().getArray())
                                          .addChild(new HAnimSegment().setName("t5").setDEF("Joe_t5")
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {0f,1.38100004196167f,-0.12349999696016312f})
                                              .addChild(new Shape().setUSE("jointbox"))))
                                          .addChild(new HAnimJoint().setName("vt4").setDEF("Joe_vt4").setCenter(new float[] {0f,1.409999966621399f,-0.12349999696016312f}).setSkinCoordIndex(new MFInt32167().getArray()).setSkinCoordWeight(new MFFloat168().getArray()).setUlimit(new MFFloat169().getArray()).setLlimit(new MFFloat170().getArray())
                                            .addChild(new HAnimSegment().setName("t4").setDEF("Joe_t4")
                                              ...
                                              .addChild(new Transform().setTranslation(new float[] {0f,1.409999966621399f,-0.14499999582767487f})
                                                .addChild(new Shape().setUSE("skinsphere"))))
                                            .addChild(new HAnimJoint().setName("vt3").setDEF("Joe_vt3").setCenter(new float[] {0f,1.437999963760376f,-0.11999999731779099f}).setUlimit(new MFFloat173().getArray()).setLlimit(new MFFloat174().getArray())
                                              .addChild(new HAnimSegment().setName("t3").setDEF("Joe_t3")
                                                ...
                                                .addChild(new Transform().setTranslation(new float[] {0f,1.437999963760376f,-0.11999999731779099f})
                                                  .addChild(new Shape().setUSE("jointbox"))))
                                              .addChild(new HAnimJoint().setName("vt2").setDEF("Joe_vt2").setCenter(new float[] {0f,1.468000054359436f,-0.10499999672174454f}).setUlimit(new MFFloat177().getArray()).setLlimit(new MFFloat178().getArray())
                                                .addChild(new HAnimSegment().setName("t2").setDEF("Joe_t2")
                                                  ...
                                                  .addChild(new Transform().setTranslation(new float[] {0f,1.468000054359436f,-0.10499999672174454f})
                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                .addChild(new HAnimJoint().setName("vt1").setDEF("Joe_vt1").setCenter(new float[] {0f,1.497f,-0.09f}).setSkinCoordIndex(new MFInt32181().getArray()).setSkinCoordWeight(new MFFloat182().getArray()).setUlimit(new MFFloat183().getArray()).setLlimit(new MFFloat184().getArray())
                                                  .addChild(new HAnimSegment().setName("t1").setDEF("Joe_t1")
                                                    ...
                                                    .addChild(new HAnimSite().setName("cervicale").setDEF("Joe_cervicale").setTranslation(new float[] {0f,1.5299999713897705f,-0.08399999886751175f})
                                                      .addChild(new Shape().setUSE("sitebox"))))
                                                  .addChild(new HAnimJoint().setName("vc7").setDEF("Joe_vc7").setCenter(new float[] {0f,1.524999976158142f,-0.07199999690055847f}).setSkinCoordIndex(new MFInt32187().getArray()).setSkinCoordWeight(new MFFloat188().getArray()).setUlimit(new MFFloat189().getArray()).setLlimit(new MFFloat190().getArray())
                                                    .addChild(new HAnimSegment().setName("c7").setDEF("Joe_c7")
                                                      ...
                                                      .addChild(new HAnimSite().setName("l_neck_base").setDEF("Joe_l_neck_base").setTranslation(new float[] {0.06459999829530716f,1.5148999691009521f,-0.03849999979138374f})
                                                        .addChild(new Shape().setUSE("sitebox"))))
                                                    .addChild(new HAnimJoint().setName("vc6").setDEF("Joe_vc6").setCenter(new float[] {0f,1.5399999618530273f,-0.05000000074505806f}).setUlimit(new MFFloat193().getArray()).setLlimit(new MFFloat194().getArray())
                                                      .addChild(new HAnimSegment().setName("c6").setDEF("Joe_c6")
                                                        ...
                                                        .addChild(new Transform().setTranslation(new float[] {0f,1.5399999618530273f,-0.05000000074505806f})
                                                          .addChild(new Shape().setUSE("jointbox"))))
                                                      .addChild(new HAnimJoint().setName("vc5").setDEF("Joe_vc5").setCenter(new float[] {0f,1.5520000457763672f,-0.03500000014901161f}).setUlimit(new MFFloat197().getArray()).setLlimit(new MFFloat198().getArray())
                                                        .addChild(new HAnimSegment().setName("c5").setDEF("Joe_c5")
                                                          ...
                                                          .addChild(new Shape()
                                                            ...
                                                            .setAppearance(new Appearance().setUSE("SegmentLine"))))
                                                        .addChild(new HAnimJoint().setName("vc4").setDEF("Joe_vc4").setCenter(new float[] {0f,1.5674999952316284f,-0.025599999353289604f}).setUlimit(new MFFloat201().getArray()).setLlimit(new MFFloat202().getArray())
                                                          .addChild(new HAnimSegment().setName("c4").setDEF("Joe_c4")
                                                            ...
                                                            .addChild(new Transform().setTranslation(new float[] {0f,1.5674999952316284f,-0.025599999353289604f})
                                                              .addChild(new Shape().setUSE("jointbox"))))
                                                          .addChild(new HAnimJoint().setName("vc3").setDEF("Joe_vc3").setCenter(new float[] {0f,1.5822499990463257f,-0.01850000023841858f}).setUlimit(new MFFloat205().getArray()).setLlimit(new MFFloat206().getArray())
                                                            .addChild(new HAnimSegment().setName("c3").setDEF("Joe_c3")
                                                              ...
                                                              .addChild(new Transform().setTranslation(new float[] {0f,1.5822499990463257f,-0.01850000023841858f})
                                                                .addChild(new Shape().setUSE("jointbox"))))
                                                            .addChild(new HAnimJoint().setName("vc2").setDEF("Joe_vc2").setCenter(new float[] {0f,1.5950000286102295f,-0.017500000074505806f}).setUlimit(new MFFloat209().getArray()).setLlimit(new MFFloat210().getArray())
                                                              .addChild(new HAnimSegment().setName("c2").setDEF("Joe_c2")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0f,1.5950000286102295f,-0.017500000074505806f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("vc1").setDEF("Joe_vc1").setCenter(new float[] {0f,1.6100000143051147f,-0.014999999664723873f}).setUlimit(new MFFloat213().getArray()).setLlimit(new MFFloat214().getArray())
                                                                .addChild(new HAnimSegment().setName("c1").setDEF("Joe_c1")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0f,1.6100000143051147f,-0.014999999664723873f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("skullbase").setDEF("Joe_skullbase").setCenter(new float[] {0f,1.6299999952316284f,-0.009999999776482582f}).setSkinCoordIndex(new MFInt32217().getArray()).setSkinCoordWeight(new MFFloat218().getArray()).setUlimit(new MFFloat219().getArray()).setLlimit(new MFFloat220().getArray())
                                                                  .addChild(new HAnimSegment().setName("skull").setDEF("Joe_skull")
                                                                    ...
                                                                    .addChild(new HAnimSite().setName("nuchale").setDEF("Joe_nuchale").setTranslation(new float[] {0f,1.625f,-0.0925000011920929f})
                                                                      .addChild(new Shape().setUSE("sitebox"))))
                                                                  .addChild(new HAnimJoint().setName("l_eyeball_joint").setDEF("Joe_l_eyeball_joint").setCenter(new float[] {0.034f,1.659f,0.06f}).setUlimit(new MFFloat223().getArray()).setLlimit(new MFFloat224().getArray())
                                                                    .addChild(new HAnimSegment().setName("l_eyeball").setDEF("Joe_l_eyeball")
                                                                      ...
                                                                      .addChild(new Transform().setScale(new float[] {1f,1f,1.4f}).setTranslation(new float[] {0.034f,1.655f,0.065f})
                                                                        .addChild(new Shape().setUSE("jointbox")))))
                                                                  .addChild(new HAnimJoint().setName("r_eyeball_joint").setDEF("Joe_r_eyeball_joint").setCenter(new float[] {-0.034f,1.659f,0.06f}).setUlimit(new MFFloat227().getArray()).setLlimit(new MFFloat228().getArray())
                                                                    .addChild(new HAnimSegment().setName("r_eyeball").setDEF("Joe_r_eyeball")
                                                                      ...
                                                                      .addChild(new Transform().setScale(new float[] {1f,1f,1.4f}).setTranslation(new float[] {-0.034f,1.655f,0.065f})
                                                                        .addChild(new Shape().setUSE("jointbox")))))))))))))
                                                  .addChild(new HAnimJoint().setName("l_sternoclavicular").setDEF("Joe_l_sternoclavicular").setCenter(new float[] {0.082f,1.4488f,-0.0353f}).setSkinCoordIndex(new MFInt32231().getArray()).setSkinCoordWeight(new MFFloat232().getArray()).setUlimit(new MFFloat233().getArray()).setLlimit(new MFFloat234().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint().setName("l_acromioclavicular").setDEF("Joe_l_acromioclavicular").setCenter(new float[] {0.09619999676942825f,1.426900029182434f,-0.042399998754262924f}).setSkinCoordIndex(new MFInt32237().getArray()).setSkinCoordWeight(new MFFloat238().getArray()).setUlimit(new MFFloat239().getArray()).setLlimit(new MFFloat240().getArray())
                                                      .addChild(new HAnimSegment().setName("l_scapula").setDEF("Joe_l_scapula")
                                                        ...
                                                        .addChild(new HAnimSite().setName("l_axilla_post").setDEF("Joe_l_axilla_post").setTranslation(new float[] {0.1599999964237213f,1.3799999952316284f,-0.125f})
                                                          .addChild(new Shape().setUSE("sitebox"))))
                                                      .addChild(new HAnimJoint().setName("l_shoulder").setDEF("Joe_l_shoulder").setCenter(new float[] {0.20000000298023224f,1.440000057220459f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32243().getArray()).setSkinCoordWeight(new MFFloat244().getArray()).setUlimit(new MFFloat245().getArray()).setLlimit(new MFFloat246().getArray())
                                                        .addChild(new HAnimSegment().setName("l_upperarm").setDEF("Joe_l_upperarm")
                                                          ...
                                                          .addChild(new HAnimSite().setName("l_humeral_lateral_epicn").setDEF("Joe_l_humeral_lateral_epicn").setTranslation(new float[] {0.24400000274181366f,1.138800024986267f,-0.03999999910593033f})
                                                            .addChild(new Shape().setUSE("sitebox"))))
                                                        .addChild(new HAnimJoint().setName("l_elbow").setDEF("Joe_l_elbow").setCenter(new float[] {0.20000000298023224f,1.138800024986267f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32249().getArray()).setSkinCoordWeight(new MFFloat250().getArray()).setUlimit(new MFFloat251().getArray()).setLlimit(new MFFloat252().getArray())
                                                          .addChild(new HAnimSegment().setName("l_forearm").setDEF("Joe_l_forearm")
                                                            ...
                                                            .addChild(new HAnimSite().setName("l_olecranon").setDEF("Joe_l_olecranon").setTranslation(new float[] {0.20000000298023224f,1.138800024986267f,-0.07999999821186066f})
                                                              .addChild(new Shape().setUSE("sitebox"))))
                                                          .addChild(new HAnimJoint().setName("l_wrist").setDEF("Joe_l_wrist").setCenter(new float[] {0.20000000298023224f,0.8700000047683716f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32255().getArray()).setSkinCoordWeight(new MFFloat256().getArray()).setUlimit(new MFFloat257().getArray()).setLlimit(new MFFloat258().getArray())
                                                            .addChild(new HAnimSegment().setName("l_hand").setDEF("Joe_l_hand")
                                                              ...
                                                              .addChild(new HAnimSite().setName("l_metacarpal_pha5").setDEF("Joe_l_metacarpal_pha5").setTranslation(new float[] {0.19290000200271606f,0.7860000133514404f,-0.11219999939203262f})
                                                                .addChild(new Shape().setUSE("sitebox"))))
                                                            .addChild(new HAnimJoint().setName("l_thumb1").setDEF("Joe_l_thumb1").setCenter(new float[] {0.1923999935388565f,0.8471999764442444f,-0.05339999869465828f}).setSkinCoordIndex(new MFInt32261().getArray()).setSkinCoordWeight(new MFFloat262().getArray()).setUlimit(new MFFloat263().getArray()).setLlimit(new MFFloat264().getArray())
                                                              .addChild(new HAnimSegment().setName("l_thumb_metacarpal").setDEF("Joe_l_thumb_metacarpal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.1923999935388565f,0.8471999764442444f,-0.05339999869465828f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("l_thumb2").setDEF("Joe_l_thumb2").setCenter(new float[] {0.19509999454021454f,0.8226000070571899f,0.02459999918937683f}).setSkinCoordIndex(new MFInt32267().getArray()).setSkinCoordWeight(new MFFloat268().getArray()).setUlimit(new MFFloat269().getArray()).setLlimit(new MFFloat270().getArray())
                                                                .addChild(new HAnimSegment().setName("l_thumb_distal").setDEF("Joe_l_thumb_proximal")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.19509999454021454f,0.8226000070571899f,0.02459999918937683f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("l_thumb3").setDEF("Joe_l_thumb3").setCenter(new float[] {0.19550000131130219f,0.8159000277519226f,0.04639999940991402f}).setSkinCoordIndex(new MFInt32273().getArray()).setSkinCoordWeight(new MFFloat274().getArray()).setUlimit(new MFFloat275().getArray()).setLlimit(new MFFloat276().getArray())
                                                                  .addChild(new HAnimSegment().setName("l_thumb_distal").setDEF("Joe_l_thumb_distal")
                                                                    ...
                                                                    .addChild(new HAnimSite().setName("l_thumb_distal_tip").setDEF("Joe_l_thumb_distal_tip").setTranslation(new float[] {0.19820000231266022f,0.8061000108718872f,0.07590000331401825f})
                                                                      .addChild(new Shape().setUSE("sitebox")))))))
                                                            .addChild(new HAnimJoint().setName("l_index0").setDEF("Joe_l_index0").setCenter(new float[] {0.19830000400543213f,0.8023999929428101f,-0.02800000086426735f}).setSkinCoordIndex(new MFInt32279().getArray()).setSkinCoordWeight(new MFFloat280().getArray()).setUlimit(new MFFloat281().getArray()).setLlimit(new MFFloat282().getArray())
                                                              .addChild(new HAnimSegment().setName("l_index_metacarpal").setDEF("Joe_l_index_metacarpal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.1983f,0.8024f,-0.028f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("l_index1").setDEF("Joe_l_index1").setCenter(new float[] {0.1983f,0.7815f,-0.028f}).setSkinCoordIndex(new MFInt32285().getArray()).setSkinCoordWeight(new MFFloat286().getArray()).setUlimit(new MFFloat287().getArray()).setLlimit(new MFFloat288().getArray())
                                                                .addChild(new HAnimSegment().setName("l_index_proximal").setDEF("Joe_l_index_proximal")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.1983f,0.7815f,-0.028f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("l_index2").setDEF("Joe_l_index2").setCenter(new float[] {0.2017f,0.7363f,-0.0248f}).setSkinCoordIndex(new MFInt32291().getArray()).setSkinCoordWeight(new MFFloat292().getArray()).setUlimit(new MFFloat293().getArray()).setLlimit(new MFFloat294().getArray())
                                                                  .addChild(new HAnimSegment().setName("l_index_middle").setDEF("Joe_l_index_middle")
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new float[] {0.2017f,0.7363f,-0.0248f})
                                                                      .addChild(new Shape().setUSE("jointbox"))))
                                                                  .addChild(new HAnimJoint().setName("l_index3").setDEF("Joe_l_index3").setCenter(new float[] {0.20280000567436218f,0.7139000296592712f,-0.023600000888109207f}).setSkinCoordIndex(new MFInt32297().getArray()).setSkinCoordWeight(new MFFloat298().getArray()).setUlimit(new MFFloat299().getArray()).setLlimit(new MFFloat300().getArray())
                                                                    .addChild(new HAnimSegment().setName("l_index_distal").setDEF("Joe_l_index_distal")
                                                                      ...
                                                                      .addChild(new HAnimSite().setName("l_dactylion").setDEF("Joe_l_dactylion").setTranslation(new float[] {0.20559999346733093f,0.6743000149726868f,-0.04820000007748604f})
                                                                        .addChild(new Shape().setUSE("sitebox"))))))))
                                                            .addChild(new HAnimJoint().setName("l_middle0").setDEF("Joe_l_middle0").setCenter(new float[] {0.19869999587535858f,0.8029000163078308f,-0.05299999937415123f}).setSkinCoordIndex(new MFInt32303().getArray()).setSkinCoordWeight(new MFFloat304().getArray()).setUlimit(new MFFloat305().getArray()).setLlimit(new MFFloat306().getArray())
                                                              .addChild(new HAnimSegment().setName("l_middle_metacarpal").setDEF("Joe_l_middle_metacarpal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.19869999587535858f,0.8029000163078308f,-0.05299999937415123f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("l_middle1").setDEF("Joe_l_middle1").setCenter(new float[] {0.19869999587535858f,0.7817999720573425f,-0.05299999937415123f}).setSkinCoordIndex(new MFInt32309().getArray()).setSkinCoordWeight(new MFFloat310().getArray()).setUlimit(new MFFloat311().getArray()).setLlimit(new MFFloat312().getArray())
                                                                .addChild(new HAnimSegment().setName("l_middle_proximal").setDEF("Joe_l_middle_proximal")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.19869999587535858f,0.7817999720573425f,-0.05299999937415123f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("l_middle2").setDEF("Joe_l_middle2").setCenter(new float[] {0.2012999951839447f,0.7272999882698059f,-0.0502999983727932f}).setSkinCoordIndex(new MFInt32315().getArray()).setSkinCoordWeight(new MFFloat316().getArray()).setUlimit(new MFFloat317().getArray()).setLlimit(new MFFloat318().getArray())
                                                                  .addChild(new HAnimSegment().setName("l_middle_middle").setDEF("Joe_l_middle_middle")
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new float[] {0.2012999951839447f,0.7272999882698059f,-0.0502999983727932f})
                                                                      .addChild(new Shape().setUSE("jointbox"))))
                                                                  .addChild(new HAnimJoint().setName("l_middle3").setDEF("Joe_l_middle3").setCenter(new float[] {0.20260000228881836f,0.7010999917984009f,-0.049400001764297485f}).setSkinCoordIndex(new MFInt32321().getArray()).setSkinCoordWeight(new MFFloat322().getArray()).setUlimit(new MFFloat323().getArray()).setLlimit(new MFFloat324().getArray())
                                                                    .addChild(new HAnimSegment().setName("l_middle_distal").setDEF("Joe_l_middle_distal")
                                                                      ...
                                                                      .addChild(new Transform().setTranslation(new float[] {0.20260000228881836f,0.7010999917984009f,-0.049400001764297485f})
                                                                        .addChild(new Shape().setUSE("jointbox"))))))))
                                                            .addChild(new HAnimJoint().setName("l_ring0").setDEF("Joe_l_ring0").setCenter(new float[] {0.1956000030040741f,0.8019000291824341f,-0.07940000295639038f}).setSkinCoordIndex(new MFInt32327().getArray()).setSkinCoordWeight(new MFFloat328().getArray()).setUlimit(new MFFloat329().getArray()).setLlimit(new MFFloat330().getArray())
                                                              .addChild(new HAnimSegment().setName("l_ring_metacarpal").setDEF("Joe_l_ring_metacarpal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.1956000030040741f,0.8019000291824341f,-0.07940000295639038f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("l_ring1").setDEF("Joe_l_ring1").setCenter(new float[] {0.1956000030040741f,0.781499981880188f,-0.07940000295639038f}).setSkinCoordIndex(new MFInt32333().getArray()).setSkinCoordWeight(new MFFloat334().getArray()).setUlimit(new MFFloat335().getArray()).setLlimit(new MFFloat336().getArray())
                                                                .addChild(new HAnimSegment().setName("l_ring_proximal").setDEF("Joe_l_ring_proximal")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.1956000030040741f,0.781499981880188f,-0.07940000295639038f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("l_ring2").setDEF("Joe_l_ring2").setCenter(new float[] {0.1973000019788742f,0.7286999821662903f,-0.07769999653100967f}).setSkinCoordIndex(new MFInt32339().getArray()).setSkinCoordWeight(new MFFloat340().getArray()).setUlimit(new MFFloat341().getArray()).setLlimit(new MFFloat342().getArray())
                                                                  .addChild(new HAnimSegment().setName("l_ring_middle").setDEF("Joe_l_ring_middle")
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new float[] {0.1973000019788742f,0.7286999821662903f,-0.07769999653100967f})
                                                                      .addChild(new Shape().setUSE("jointbox"))))
                                                                  .addChild(new HAnimJoint().setName("l_ring3").setDEF("Joe_l_ring3").setCenter(new float[] {0.19830000400543213f,0.7045000195503235f,-0.07670000195503235f}).setSkinCoordIndex(new MFInt32345().getArray()).setSkinCoordWeight(new MFFloat346().getArray()).setUlimit(new MFFloat347().getArray()).setLlimit(new MFFloat348().getArray())
                                                                    .addChild(new HAnimSegment().setName("l_ring_distal").setDEF("Joe_l_ring_distal")
                                                                      ...
                                                                      .addChild(new HAnimSite().setName("l_ring_distal_tip").setDEF("Joe_l_ring_distal_tip").setTranslation(new float[] {0.20350000262260437f,0.675000011920929f,-0.07559999823570251f})
                                                                        .addChild(new Shape().setUSE("sitebox"))))))))
                                                            .addChild(new HAnimJoint().setName("l_pinky0").setDEF("Joe_l_pinky0").setCenter(new float[] {0.1925f,0.8066f,-0.1036f}).setSkinCoordIndex(new MFInt32351().getArray()).setSkinCoordWeight(new MFFloat352().getArray()).setUlimit(new MFFloat353().getArray()).setLlimit(new MFFloat354().getArray())
                                                              .addChild(new HAnimSegment().setName("l_pinky_metacarpal").setDEF("Joe_l_pinky_metacarpal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {0.19249999523162842f,0.8065999746322632f,-0.10360000282526016f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("l_pinky1").setDEF("Joe_l_pinky1").setCenter(new float[] {0.19249999523162842f,0.7865999937057495f,-0.10360000282526016f}).setSkinCoordIndex(new MFInt32357().getArray()).setSkinCoordWeight(new MFFloat358().getArray()).setUlimit(new MFFloat359().getArray()).setLlimit(new MFFloat360().getArray())
                                                                .addChild(new HAnimSegment().setName("l_pinky_proximal").setDEF("Joe_l_pinky_proximal")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {0.19249999523162842f,0.7865999937057495f,-0.10360000282526016f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("l_pinky2").setDEF("Joe_l_pinky2").setCenter(new float[] {0.19380000233650208f,0.745199978351593f,-0.10239999741315842f}).setSkinCoordIndex(new MFInt32363().getArray()).setSkinCoordWeight(new MFFloat364().getArray()).setUlimit(new MFFloat365().getArray()).setLlimit(new MFFloat366().getArray())
                                                                  .addChild(new HAnimSegment().setName("l_pinky_middle").setDEF("Joe_l_pinky_middle")
                                                                    ...
                                                                    .addChild(new Shape()
                                                                      ...
                                                                      .setAppearance(new Appearance().setUSE("SegmentLine"))))
                                                                  .addChild(new HAnimJoint().setName("l_pinky3").setDEF("Joe_l_pinky3").setCenter(new float[] {0.19480000436306f,0.7276999950408936f,-0.10170000046491623f}).setSkinCoordIndex(new MFInt32369().getArray()).setSkinCoordWeight(new MFFloat370().getArray()).setUlimit(new MFFloat371().getArray()).setLlimit(new MFFloat372().getArray())
                                                                    .addChild(new HAnimSegment().setName("l_pinky_distal").setDEF("Joe_l_pinky_distal")
                                                                      ...
                                                                      .addChild(new HAnimSite().setName("l_pinky_distal_tip").setDEF("Joe_l_pinky_distal_tip").setTranslation(new float[] {0.2013999968767166f,0.7009000182151794f,-0.10119999945163727f})
                                                                        .addChild(new Shape().setUSE("sitebox"))))))))))))))
                                                .addChild(new HAnimJoint().setName("r_sternoclavicular").setDEF("Joe_r_sternoclavicular").setCenter(new float[] {-0.029999999329447746f,1.4600000381469727f,0f}).setSkinCoordIndex(new MFInt32375().getArray()).setSkinCoordWeight(new MFFloat376().getArray()).setUlimit(new MFFloat377().getArray()).setLlimit(new MFFloat378().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint().setName("r_acromioclavicular").setDEF("Joe_r_acromioclavicular").setCenter(new float[] {-0.09000000357627869f,1.409999966621399f,-0.10999999940395355f}).setSkinCoordIndex(new MFInt32381().getArray()).setSkinCoordWeight(new MFFloat382().getArray()).setUlimit(new MFFloat383().getArray()).setLlimit(new MFFloat384().getArray())
                                                    .addChild(new HAnimSegment().setName("r_scapula").setDEF("Joe_r_scapula")
                                                      ...
                                                      .addChild(new HAnimSite().setName("r_axilla_post").setDEF("Joe_r_axilla_post").setTranslation(new float[] {-0.1599999964237213f,1.3799999952316284f,-0.12700000405311584f})
                                                        .addChild(new Shape().setUSE("sitebox"))))
                                                    .addChild(new HAnimJoint().setName("r_shoulder").setDEF("Joe_r_shoulder").setCenter(new float[] {-0.20000000298023224f,1.440000057220459f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32387().getArray()).setSkinCoordWeight(new MFFloat388().getArray()).setUlimit(new MFFloat389().getArray()).setLlimit(new MFFloat390().getArray())
                                                      .addChild(new HAnimSegment().setName("r_upperarm").setDEF("Joe_r_upperarm")
                                                        ...
                                                        .addChild(new HAnimSite().setName("r_humeral_lateral_epicn").setDEF("Joe_r_humeral_lateral_epicn").setTranslation(new float[] {-0.24400000274181366f,1.138800024986267f,-0.03999999910593033f})
                                                          .addChild(new Shape().setUSE("sitebox"))))
                                                      .addChild(new HAnimJoint().setName("r_elbow").setDEF("Joe_r_elbow").setCenter(new float[] {-0.20000000298023224f,1.138800024986267f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32393().getArray()).setSkinCoordWeight(new MFFloat394().getArray()).setUlimit(new MFFloat395().getArray()).setLlimit(new MFFloat396().getArray())
                                                        .addChild(new HAnimSegment().setName("r_forearm").setDEF("Joe_r_forearm")
                                                          ...
                                                          .addChild(new HAnimSite().setName("r_olecranon").setDEF("Joe_r_olecranon").setTranslation(new float[] {-0.20000000298023224f,1.138800024986267f,-0.07999999821186066f})
                                                            .addChild(new Shape().setUSE("sitebox"))))
                                                        .addChild(new HAnimJoint().setName("r_wrist").setDEF("Joe_r_wrist").setCenter(new float[] {-0.20000000298023224f,0.8899999856948853f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32399().getArray()).setSkinCoordWeight(new MFFloat400().getArray()).setUlimit(new MFFloat401().getArray()).setLlimit(new MFFloat402().getArray())
                                                          .addChild(new HAnimSegment().setName("r_hand").setDEF("Joe_r_hand")
                                                            ...
                                                            .addChild(new HAnimSite().setName("r_ulnar_styloid").setDEF("Joe_r_ulnar_styloid").setTranslation(new float[] {-0.20000000298023224f,0.8999999761581421f,-0.08500000089406967f})
                                                              .addChild(new Shape().setUSE("sitebox"))))
                                                          .addChild(new HAnimJoint().setName("r_thumb1").setDEF("Joe_r_thumb1").setCenter(new float[] {-0.20000000298023224f,0.8500000238418579f,0f}).setSkinCoordIndex(new MFInt32405().getArray()).setSkinCoordWeight(new MFFloat406().getArray()).setUlimit(new MFFloat407().getArray()).setLlimit(new MFFloat408().getArray())
                                                            .addChild(new HAnimSegment().setName("r_thumb_metacarpal").setDEF("Joe_r_thumb_metacarpal")
                                                              ...
                                                              .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.8500000238418579f,0f})
                                                                .addChild(new Shape().setUSE("jointbox"))))
                                                            .addChild(new HAnimJoint().setName("r_thumb2").setDEF("Joe_r_thumb2").setCenter(new float[] {-0.20000000298023224f,0.8199999928474426f,0.029999999329447746f}).setSkinCoordIndex(new MFInt32411().getArray()).setSkinCoordWeight(new MFFloat412().getArray()).setUlimit(new MFFloat413().getArray()).setLlimit(new MFFloat414().getArray())
                                                              .addChild(new HAnimSegment().setName("r_thumb_proximal").setDEF("Joe_r_thumb_proximal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.8199999928474426f,0.029999999329447746f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("r_thumb3").setDEF("Joe_r_thumb3").setCenter(new float[] {-0.20000000298023224f,0.800000011920929f,0.05000000074505806f}).setSkinCoordIndex(new MFInt32417().getArray()).setSkinCoordWeight(new MFFloat418().getArray()).setUlimit(new MFFloat419().getArray()).setLlimit(new MFFloat420().getArray())
                                                                .addChild(new HAnimSegment().setName("r_thumb_distal").setDEF("Joe_r_thumb_distal")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_thumb_distal_tip").setDEF("Joe_r_thumb_distal_tip").setTranslation(new float[] {-0.20000000298023224f,0.7799999713897705f,0.07000000029802322f})
                                                                    .addChild(new Shape().setUSE("sitebox")))))))
                                                          .addChild(new HAnimJoint().setName("r_index0").setDEF("Joe_r_index0").setCenter(new float[] {-0.20000000298023224f,0.8399999737739563f,-0.014999999664723873f}).setSkinCoordIndex(new MFInt32423().getArray()).setSkinCoordWeight(new MFFloat424().getArray()).setUlimit(new MFFloat425().getArray()).setLlimit(new MFFloat426().getArray())
                                                            .addChild(new HAnimSegment().setName("r_index_metacarpal").setDEF("Joe_r_index_metacarpal")
                                                              ...
                                                              .addChild(new HAnimSite().setName("r_metacarpal_pha2").setDEF("Joe_r_metacarpal_pha2").setTranslation(new float[] {-0.20000000298023224f,0.7929999828338623f,-0.004999999888241291f})
                                                                .addChild(new Shape().setUSE("sitebox"))))
                                                            .addChild(new HAnimJoint().setName("r_index1").setDEF("Joe_r_index1").setCenter(new float[] {-0.20000000298023224f,0.7929999828338623f,-0.014999999664723873f}).setSkinCoordIndex(new MFInt32429().getArray()).setSkinCoordWeight(new MFFloat430().getArray()).setUlimit(new MFFloat431().getArray()).setLlimit(new MFFloat432().getArray())
                                                              .addChild(new HAnimSegment().setName("r_index_proximal").setDEF("Joe_r_index_proximal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.7929999828338623f,-0.014999999664723873f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("r_index2").setDEF("Joe_r_index2").setCenter(new float[] {-0.20000000298023224f,0.7450000047683716f,-0.014999999664723873f}).setSkinCoordIndex(new MFInt32435().getArray()).setSkinCoordWeight(new MFFloat436().getArray()).setUlimit(new MFFloat437().getArray()).setLlimit(new MFFloat438().getArray())
                                                                .addChild(new HAnimSegment().setName("r_index_middle").setDEF("Joe_r_index_middle")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.7450000047683716f,-0.014999999664723873f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("r_index3").setDEF("Joe_r_index3").setCenter(new float[] {-0.20000000298023224f,0.7200000286102295f,-0.014999999664723873f}).setSkinCoordIndex(new MFInt32441().getArray()).setSkinCoordWeight(new MFFloat442().getArray()).setUlimit(new MFFloat443().getArray()).setLlimit(new MFFloat444().getArray())
                                                                  .addChild(new HAnimSegment().setName("r_index_distal").setDEF("Joe_r_index_distal")
                                                                    ...
                                                                    .addChild(new HAnimSite().setName("r_index_distal_tip").setDEF("Joe_r_index_distal_tip").setTranslation(new float[] {-0.20000000298023224f,0.6949999928474426f,-0.014999999664723873f})
                                                                      .addChild(new Shape().setUSE("sitebox"))))))))
                                                          .addChild(new HAnimJoint().setName("r_middle0").setDEF("Joe_r_middle0").setCenter(new float[] {-0.20000000298023224f,0.8349999785423279f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32447().getArray()).setSkinCoordWeight(new MFFloat448().getArray()).setUlimit(new MFFloat449().getArray()).setLlimit(new MFFloat450().getArray())
                                                            .addChild(new HAnimSegment().setName("r_middle_metacarpal").setDEF("Joe_r_middle_metacarpal")
                                                              ...
                                                              .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.8349999785423279f,-0.03999999910593033f})
                                                                .addChild(new Shape().setUSE("jointbox"))))
                                                            .addChild(new HAnimJoint().setName("r_middle1").setDEF("Joe_r_middle1").setCenter(new float[] {-0.20000000298023224f,0.7879999876022339f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32453().getArray()).setSkinCoordWeight(new MFFloat454().getArray()).setUlimit(new MFFloat455().getArray()).setLlimit(new MFFloat456().getArray())
                                                              .addChild(new HAnimSegment().setName("r_middle_proximal").setDEF("Joe_r_middle_proximal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.7879999876022339f,-0.03999999910593033f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("r_middle2").setDEF("Joe_r_middle2").setCenter(new float[] {-0.20000000298023224f,0.7400000095367432f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32459().getArray()).setSkinCoordWeight(new MFFloat460().getArray()).setUlimit(new MFFloat461().getArray()).setLlimit(new MFFloat462().getArray())
                                                                .addChild(new HAnimSegment().setName("r_middle_middle").setDEF("Joe_r_middle_middle")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.7400000095367432f,-0.03999999910593033f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("r_middle3").setDEF("Joe_r_middle3").setCenter(new float[] {-0.20000000298023224f,0.7142000198364258f,-0.03999999910593033f}).setSkinCoordIndex(new MFInt32465().getArray()).setSkinCoordWeight(new MFFloat466().getArray()).setUlimit(new MFFloat467().getArray()).setLlimit(new MFFloat468().getArray())
                                                                  .addChild(new HAnimSegment().setName("r_middle_distal").setDEF("Joe_r_middle_distal")
                                                                    ...
                                                                    .addChild(new HAnimSite().setName("r_middle_distal_tip").setDEF("Joe_r_middle_distal_tip").setTranslation(new float[] {-0.20000000298023224f,0.6800000071525574f,-0.03999999910593033f})
                                                                      .addChild(new Shape().setUSE("sitebox"))))))))
                                                          .addChild(new HAnimJoint().setName("r_ring0").setDEF("Joe_r_ring0").setCenter(new float[] {-0.2f,0.835f,-0.065f}).setSkinCoordIndex(new MFInt32471().getArray()).setSkinCoordWeight(new MFFloat472().getArray()).setUlimit(new MFFloat473().getArray()).setLlimit(new MFFloat474().getArray())
                                                            .addChild(new HAnimSegment().setName("r_ring_metacarpal").setDEF("Joe_r_ring_metacarpal")
                                                              ...
                                                              .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.8349999785423279f,-0.06499999761581421f})
                                                                .addChild(new Shape().setUSE("jointbox"))))
                                                            .addChild(new HAnimJoint().setName("r_ring1").setDEF("Joe_r_ring1").setCenter(new float[] {-0.20000000298023224f,0.7929999828338623f,-0.06499999761581421f}).setSkinCoordIndex(new MFInt32477().getArray()).setSkinCoordWeight(new MFFloat478().getArray()).setUlimit(new MFFloat479().getArray()).setLlimit(new MFFloat480().getArray())
                                                              .addChild(new HAnimSegment().setName("r_ring_proximal").setDEF("Joe_r_ring_proximal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.7929999828338623f,-0.06499999761581421f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("r_ring2").setDEF("Joe_r_ring2").setCenter(new float[] {-0.20000000298023224f,0.7400000095367432f,-0.06499999761581421f}).setSkinCoordIndex(new MFInt32483().getArray()).setSkinCoordWeight(new MFFloat484().getArray()).setUlimit(new MFFloat485().getArray()).setLlimit(new MFFloat486().getArray())
                                                                .addChild(new HAnimSegment().setName("r_ring_middle").setDEF("Joe_r_ring_middle")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.7400000095367432f,-0.06499999761581421f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("r_ring3").setDEF("Joe_r_ring3").setCenter(new float[] {-0.20000000298023224f,0.7177000045776367f,-0.06499999761581421f}).setSkinCoordIndex(new MFInt32489().getArray()).setSkinCoordWeight(new MFFloat490().getArray()).setUlimit(new MFFloat491().getArray()).setLlimit(new MFFloat492().getArray())
                                                                  .addChild(new HAnimSegment().setName("r_ring_distal").setDEF("Joe_r_ring_distal")
                                                                    ...
                                                                    .addChild(new HAnimSite().setName("r_ring_distal_tip").setDEF("Joe_r_ring_distal_tip").setTranslation(new float[] {-0.20000000298023224f,0.6949999928474426f,-0.06499999761581421f})
                                                                      .addChild(new Shape().setUSE("sitebox"))))))))
                                                          .addChild(new HAnimJoint().setName("r_pinky0").setDEF("Joe_r_pinky0").setCenter(new float[] {-0.20000000298023224f,0.8399999737739563f,-0.08500000089406967f}).setSkinCoordIndex(new MFInt32495().getArray()).setSkinCoordWeight(new MFFloat496().getArray()).setUlimit(new MFFloat497().getArray()).setLlimit(new MFFloat498().getArray())
                                                            .addChild(new HAnimSegment().setName("r_pinky_metacarpal").setDEF("Joe_r_pinky_metacarpal")
                                                              ...
                                                              .addChild(new HAnimSite().setName("r_metacarpal_pha5").setDEF("Joe_r_metacarpal_pha5").setTranslation(new float[] {-0.20000000298023224f,0.7900000214576721f,-0.0949999988079071f})
                                                                .addChild(new Shape().setUSE("sitebox"))))
                                                            .addChild(new HAnimJoint().setName("r_pinky1").setDEF("Joe_r_pinky1").setCenter(new float[] {-0.20000000298023224f,0.7900000214576721f,-0.08500000089406967f}).setSkinCoordIndex(new MFInt32501().getArray()).setSkinCoordWeight(new MFFloat502().getArray()).setUlimit(new MFFloat503().getArray()).setLlimit(new MFFloat504().getArray())
                                                              .addChild(new HAnimSegment().setName("r_pinky_proximal").setDEF("Joe_r_pinky_proximal")
                                                                ...
                                                                .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.7900000214576721f,-0.08500000089406967f})
                                                                  .addChild(new Shape().setUSE("jointbox"))))
                                                              .addChild(new HAnimJoint().setName("r_pinky2").setDEF("Joe_r_pinky2").setCenter(new float[] {-0.20000000298023224f,0.7549999952316284f,-0.08500000089406967f}).setSkinCoordIndex(new MFInt32507().getArray()).setSkinCoordWeight(new MFFloat508().getArray()).setUlimit(new MFFloat509().getArray()).setLlimit(new MFFloat510().getArray())
                                                                .addChild(new HAnimSegment().setName("r_pinky_middle").setDEF("Joe_r_pinky_middle")
                                                                  ...
                                                                  .addChild(new Transform().setTranslation(new float[] {-0.20000000298023224f,0.7549999952316284f,-0.08500000089406967f})
                                                                    .addChild(new Shape().setUSE("jointbox"))))
                                                                .addChild(new HAnimJoint().setName("r_pinky3").setDEF("Joe_r_pinky3").setCenter(new float[] {-0.20000000298023224f,0.7350000143051147f,-0.09000000357627869f}).setSkinCoordIndex(new MFInt32513().getArray()).setSkinCoordWeight(new MFFloat514().getArray()).setUlimit(new MFFloat515().getArray()).setLlimit(new MFFloat516().getArray())

...
public class variationalflowers2 implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/variationalflowers2.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("variationalflowers.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/variationalflowers.x3d"))))
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("variationalflowers.x3d")))
        ...
        .addChild(new Transform()
          .addChild(new ParticleSystem().setMaxParticles(20).setGeometryType(new SFString("GEOMETRY"))
            ...
            .addVariationPhysicsModel(new VariationPhysicsModel().setValues(new SFString("2 2 5 5 0 0")).setVariations(new SFString("0.2 0.1 0.3 0.3 0.01 0.01")))

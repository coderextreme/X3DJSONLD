...
public class LOA1_KneelAnimation implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/LOA1_KneelAnimation.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("LOA1_KneelAnimation.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("creator")).setContent(new SFString("Tom Miller")))
        .addMeta(new meta().setName(new SFString("translator")).setContent(new SFString("Curt Blais")))
        .addMeta(new meta().setName(new SFString("translated")).setContent(new SFString("1 December 2001")))
        ...
        .addMeta(new meta().setName(new SFString("reference")).setContent(new SFString("https://www.HAnim.org/Models/HAnim2001/boxman/protos/LOA1_WalkAnimation.wrl")))
        ...
        .addMeta(new meta().setName(new SFString("subject")).setContent(new SFString("Nancy kneel Animation HAnim 2001")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/LOA1_KneelAnimation.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("LOA1_KneelAnimation.x3d")))
        .addChild(new ProtoDeclare().setName(new SFString("LOA1_KneelAnimation"))
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("SFTime").setName(new SFString("cycleInterval")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFString("2")))
            ...
            .addField(new field().setType("SFBool").setName(new SFString("loop")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFString("false")))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              ...
              .addChild(new OrientationInterpolator().setDEF(new SFString("L_HIP_ANIMATOR")).setKey(new MFFloat4().getArray()).setKeyValue(new MFRotation5().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("l_hip_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("L_KNEE_ANIMATOR")).setKey(new MFFloat6().getArray()).setKeyValue(new MFRotation7().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("l_knee_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("L_ANKLE_ANIMATOR")).setKey(new MFFloat8().getArray()).setKeyValue(new MFRotation9().getArray())
                .setIS(new IS()
              ...
              .addChild(new OrientationInterpolator().setDEF(new SFString("R_HIP_ANIMATOR")).setKey(new MFFloat10().getArray()).setKeyValue(new MFRotation11().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("r_hip_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("R_KNEE_ANIMATOR")).setKey(new MFFloat12().getArray()).setKeyValue(new MFRotation13().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("r_knee_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("R_ANKLE_ANIMATOR")).setKey(new MFFloat14().getArray()).setKeyValue(new MFRotation15().getArray())
                .setIS(new IS()
              ...
              .addChild(new OrientationInterpolator().setDEF(new SFString("VL5_ANIMATOR")).setKey(new MFFloat16().getArray()).setKeyValue(new MFRotation17().getArray())
                .setIS(new IS()
              ...
              .addChild(new OrientationInterpolator().setDEF(new SFString("L_SHOULDER_ANIMATOR")).setKey(new MFFloat18().getArray()).setKeyValue(new MFRotation19().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("l_shoulder_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("L_ELBOW_ANIMATOR")).setKey(new MFFloat20().getArray()).setKeyValue(new MFRotation21().getArray())
                .setIS(new IS()
              ...
              .addChild(new OrientationInterpolator().setDEF(new SFString("R_SHOULDER_ANIMATOR")).setKey(new MFFloat22().getArray()).setKeyValue(new MFRotation23().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("r_shoulder_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("R_ELBOW_ANIMATOR")).setKey(new MFFloat24().getArray()).setKeyValue(new MFRotation25().getArray())
                .setIS(new IS()
        ...
        .addChild(new Anchor().setDescription(new SFString("InterchangableActorsViaDynamicRouting")).setParameter(new MFString26().getArray()).setUrl(new MFString27().getArray())
          .addChild(new Shape()
...
private class MFFloat0 {
  private org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f ,0.3125f ,0.625f ,1f });
  }
}
private class MFVec3f1 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {0f ,0f ,0f ,0f ,-0.049999f ,0f ,0f ,-0.195f ,0f ,0f ,-0.439997f ,0f });
  }
}
...
private class MFRotation5 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,-1f ,0f ,0f ,0.619393f ,-1f ,0f ,0f ,1.069302f ,-1f ,0f ,0f ,1.937315f });
  }
}
...
private class MFRotation7 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,1f ,0f ,0f ,0.615228f ,1f ,0f ,0f ,0.984524f ,1f ,0f ,0f ,2.076941f });
  }
}
...
private class MFRotation9 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,-1f ,0f ,0f ,0.017453f ,-1f ,0f ,0f ,0.069812f ,1f ,0f ,0f ,0.261799f });
  }
}
private class MFFloat10 {
  private org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f ,0.3125f ,1f });
  }
}
private class MFRotation11 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,1f ,0f ,0f ,0.523598f ,-1f ,0f ,0f ,0.157079f });
  }
}
...
private class MFRotation13 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,1f ,0f ,0f ,0.349065f ,1f ,0f ,0f ,1.023397f ,0.999934f ,0.008043f ,0.008185f ,1.727938f });
  }
}
...
private class MFRotation15 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,-0.991692f ,-0.072372f ,0.106338f ,0.205053f ,-0.981083f ,-0.103267f ,0.163741f ,0.272231f ,-1f ,0f ,0f ,0.349065f });
  }
}
...
private class MFRotation17 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,1f ,0f ,0f ,0.174533f });
  }
}
...
private class MFRotation19 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,-1f ,0f ,0f ,0.279252f ,-1f ,0f ,0f ,0.506145f ,-1f ,0f ,0f ,0.191986f });
  }
}
...
private class MFRotation21 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,-1f ,0f ,0f ,0.052359f ,-1f ,0f ,0f ,0.296706f ,-1f ,0f ,0f ,1.431169f });
  }
}
...
private class MFRotation23 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,-1f ,0f ,0f ,0.104719f ,-1f ,0f ,0f ,0.157079f ,1f ,0f ,0f ,0.314159f });
  }
}
...
private class MFRotation25 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f ,0f ,0f ,0f ,-1f ,0f ,0f ,0.837757f ,-1f ,0f ,0f ,1.239183f ,-1f ,0f ,0f ,1.500983f });
  }
}

      ...
      .setScene(new Scene()
        .addChild(new ProtoDeclare().setName("LOA1_KneelAnimation")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("SFTime").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("cycleInterval").setValue("2"))
        ...
        .addChild(new Anchor().setDescription("InterchangableActorsViaDynamicRouting").setUrl(new MFString26().getArray()).setParameter(new MFString27().getArray())
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,0.2f})))
            .setGeometry(new Text().setString(new MFString28().getArray())
              .setFontStyle(new FontStyle().setSize(0.8f).setJustify(new MFString29().getArray()))))))      ;
    return X3D0;
    }

...
public class LOA1_KneelAnimation {
  public static void main(String[] args) {
    ...
    new LOA1_KneelAnimation().initialize().toFileJSON("../data/LOA1_KneelAnimation.new.json");
    }
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new ProtoDeclare().setName("LOA1_KneelAnimation")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              ...
              .addChild(new OrientationInterpolator().setDEF("L_HIP_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat4().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation5().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("l_hip_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("L_KNEE_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat6().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation7().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("l_knee_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("L_ANKLE_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat8().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation9().getArray()))
                .setIS(new IS()
              ...
              .addChild(new OrientationInterpolator().setDEF("R_HIP_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat10().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation11().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("r_hip_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("R_KNEE_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat12().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation13().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("r_knee_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("R_ANKLE_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat14().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation15().getArray()))
                .setIS(new IS()
              ...
              .addChild(new OrientationInterpolator().setDEF("VL5_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat16().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation17().getArray()))
                .setIS(new IS()
              ...
              .addChild(new OrientationInterpolator().setDEF("L_SHOULDER_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat18().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation19().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("l_shoulder_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("L_ELBOW_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat20().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation21().getArray()))
                .setIS(new IS()
              ...
              .addChild(new OrientationInterpolator().setDEF("R_SHOULDER_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat22().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation23().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("r_shoulder_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("R_ELBOW_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat24().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation25().getArray()))
                .setIS(new IS()
        ...
        .addChild(new Anchor().setDescription("InterchangableActorsViaDynamicRouting").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString26().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString27().getArray()))
          .addChild(new Shape()
            .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString28().getArray()))
              .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString29().getArray())).setSize(0.8f)))

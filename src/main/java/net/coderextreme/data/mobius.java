...
public class mobius implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new mobius().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/mobius.new.java.x3d");
    model.toFileJSON("../data/mobius.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("mobius.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://kshell.com/mobius.x3d")))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Shape()
          .setGeometry(new NurbsPatchSurface().setVKnot(new MFDouble1().getArray()).setVDimension(3).setWeight(new MFDouble2().getArray()).setSolid(false).setUDimension(91).setUKnot(new MFDouble3().getArray()).setUOrder(4)
            ...
            .setMetadata(new MetadataSet()
              .setMetadata(new MetadataString().setName(new SFString("INSTANT_PLAYER_MODE")).setValue(new MFString5().getArray()))))
        ...
        .addChild(new Shape()
          .setGeometry(new NurbsPatchSurface().setVKnot(new MFDouble6().getArray()).setVDimension(3).setWeight(new MFDouble7().getArray()).setSolid(false).setUDimension(91).setUKnot(new MFDouble8().getArray()).setUOrder(4)
            .setControlPoint(new Coordinate().setPoint(new MFVec3f9().getArray()))
            .setMetadata(new MetadataSet()
              .setMetadata(new MetadataString().setName(new SFString("INSTANT_PLAYER_MODE")).setValue(new MFString10().getArray()))))
          .setAppearance(new Appearance().setDEF(new SFString("ksh_appearance_2"))
            .setMaterial(new Material().setDiffuseColor(new float[] {0f ,0f ,1f }))))
        .addChild(new Shape()
          .setGeometry(new NurbsPatchSurface().setVKnot(new MFDouble11().getArray()).setVDimension(3).setWeight(new MFDouble12().getArray()).setSolid(false).setUDimension(91).setUKnot(new MFDouble13().getArray()).setUOrder(4)
            .setControlPoint(new Coordinate().setPoint(new MFVec3f14().getArray()))
            .setMetadata(new MetadataSet()
              .setMetadata(new MetadataString().setName(new SFString("INSTANT_PLAYER_MODE")).setValue(new MFString15().getArray()))))

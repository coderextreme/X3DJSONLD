  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("title").setContent("mobius.x3d"))
        .addMeta(new meta().setName("creator").setContent("Vince Marchetti"))
        .addMeta(new meta().setName("generator").setContent("manual"))
        .addMeta(new meta().setName("identifier").setContent("https://kshell.com/mobius.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Shape()
          .setGeometry(new NurbsPatchSurface().setVKnot(new MFDouble1().getArray()).setVDimension(3).setWeight(new MFDouble2().getArray()).setSolid(false).setUDimension(91).setUKnot(new MFDouble3().getArray()).setUOrder(4)
            ...
            .setMetadata(new MetadataSet()
              .setMetadata(new MetadataString().setName("INSTANT_PLAYER_MODE").setValue(new MFString5().getArray()))))
        ...
        .addChild(new Shape()
          .setGeometry(new NurbsPatchSurface().setVKnot(new MFDouble6().getArray()).setVDimension(3).setWeight(new MFDouble7().getArray()).setSolid(false).setUDimension(91).setUKnot(new MFDouble8().getArray()).setUOrder(4)
            ...
            .setMetadata(new MetadataSet()
              .setMetadata(new MetadataString().setName("INSTANT_PLAYER_MODE").setValue(new MFString10().getArray()))))
        ...
        .addChild(new Shape()
          .setGeometry(new NurbsPatchSurface().setVKnot(new MFDouble11().getArray()).setVDimension(3).setWeight(new MFDouble12().getArray()).setSolid(false).setUDimension(91).setUKnot(new MFDouble13().getArray()).setUOrder(4)
            ...
            .setMetadata(new MetadataSet()
              .setMetadata(new MetadataString().setName("INSTANT_PLAYER_MODE").setValue(new MFString15().getArray()))))

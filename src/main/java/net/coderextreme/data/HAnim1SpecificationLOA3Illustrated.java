...
public class HAnim1SpecificationLOA3Illustrated implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new HAnim1SpecificationLOA3Illustrated().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/HAnim1SpecificationLOA3Illustrated.new.java.x3d");
    model.toFileJSON("../data/HAnim1SpecificationLOA3Illustrated.new.java.json");
    }
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f ,0.9149f ,0.0016f })
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-0.0961f ,0.9124f ,-0.0001f })
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-0.104f ,0.4867f ,0.0308f })
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_ankle").setName("r_ankle").setCenter(new float[] {-0.1101f ,0.0656f ,-0.0736f })
                      ...
                      .addChild(new HAnimJoint("hanim_r_subtalar").setDEF("hanim_r_midtarsal").setName("r_midtarsal").setCenter(new float[] {-0.1086f ,0.0001f ,0.0368f })
                        .addChild(new HAnimSegment("hanim_r_midtarsal").setDEF("hanim_r_middistal").setName("r_middistal")
                          ...
                          .addChild(new HAnimSite("hanim_r_middistal").setDEF("hanim_r_metatarsal_pha1_pt").setName("r_metatarsal_pha1_pt").setTranslation(new float[] {-0.0521f ,0.026f ,0.0127f })
                            ...
                            .addChild(new Shape().setUSE("HAnimSiteShape"))))
                        .addChild(new HAnimJoint("hanim_r_midtarsal").setDEF("hanim_r_metatarsal").setName("r_metatarsal").setCenter(new float[] {-0.1086f ,0f ,0.0762f })
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_shoulder").setDEF("hanim_r_elbow").setName("r_elbow").setCenter(new float[] {-0.2014f ,1.1357f ,-0.0682f })
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_elbow").setDEF("hanim_r_wrist").setName("r_wrist").setCenter(new float[] {-0.1984f ,0.8663f ,-0.0583f })
                                                          ...
                                                          .addChild(new HAnimSite("hanim_r_hand").setDEF("hanim_r_hand_front_view").setName("r_hand_front_view").setTranslation(new float[] {-0.3f ,0.75f ,0.45f })
                                                            ...
                                                            .addChild(new Anchor().setDescription("HAnimSite hanim_r_hand_front_view Viewpoint").setUrl(new MFString355().getArray())
                                                              .addChild(new LOD().setForceTransitions(true).setRange(new MFFloat356().getArray())
                                                                ...
                                                                .addChild(new Shape().setUSE("HAnimSiteViewpointShape"))))))
                                                        .addChild(new HAnimJoint("hanim_r_wrist").setDEF("hanim_r_thumb1").setName("r_thumb1").setCenter(new float[] {-0.1924f ,0.8472f ,-0.0534f })
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_wrist").setDEF("hanim_r_index0").setName("r_index0").setCenter(new float[] {-0.1983f ,0.8024f ,-0.028f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_index0").setDEF("hanim_r_index1").setName("r_index1").setCenter(new float[] {-0.1983f ,0.7815f ,-0.028f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_index1").setDEF("hanim_r_index2").setName("r_index2").setCenter(new float[] {-0.2017f ,0.7363f ,-0.0248f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_index2").setDEF("hanim_r_index3").setName("r_index3").setCenter(new float[] {-0.2028f ,0.7139f ,-0.0236f })
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_wrist").setDEF("hanim_r_middle0").setName("r_middle0").setCenter(new float[] {-0.1987f ,0.8029f ,-0.053f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_middle0").setDEF("hanim_r_middle1").setName("r_middle1").setCenter(new float[] {-0.1987f ,0.7818f ,-0.053f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_middle1").setDEF("hanim_r_middle2").setName("r_middle2").setCenter(new float[] {-0.2013f ,0.7273f ,-0.0503f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_middle2").setDEF("hanim_r_middle3").setName("r_middle3").setCenter(new float[] {-0.2026f ,0.7011f ,-0.0494f })
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_wrist").setDEF("hanim_r_ring0").setName("r_ring0").setCenter(new float[] {-0.1956f ,0.8019f ,-0.0794f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_ring0").setDEF("hanim_r_ring1").setName("r_ring1").setCenter(new float[] {-0.1956f ,0.7815f ,-0.0794f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_ring1").setDEF("hanim_r_ring2").setName("r_ring2").setCenter(new float[] {-0.1973f ,0.7287f ,-0.0777f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_ring2").setDEF("hanim_r_ring3").setName("r_ring3").setCenter(new float[] {-0.1983f ,0.7045f ,-0.0767f })
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_wrist").setDEF("hanim_r_pinky0").setName("r_pinky0").setCenter(new float[] {-0.1925f ,0.8066f ,-0.1036f })
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_pinky0").setDEF("hanim_r_pinky1").setName("r_pinky1").setCenter(new float[] {-0.1925f ,0.7866f ,-0.1036f })
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_pinky1").setDEF("hanim_r_pinky2").setName("r_pinky2").setCenter(new float[] {-0.1938f ,0.7452f ,-0.1024f })
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_pinky2").setDEF("hanim_r_pinky3").setName("r_pinky3").setCenter(new float[] {-0.1948f ,0.7277f ,-0.1017f })

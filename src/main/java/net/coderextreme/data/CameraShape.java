...
public class CameraShape {
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle("SimpleCamera.x3d").setInfo(new MFString0().getArray()))
        ...
        .addChild(new Viewpoint().setDescription("Camera view from right side").setPosition(new float[] {12f,0f,-4f}).setOrientation(new float[] {0f,1f,0f,1.5708f}))
        .addChild(new Viewpoint().setDescription("Camera view from above").setPosition(new float[] {0f,15f,-5f}).setOrientation(new float[] {1f,0f,0f,-1.5708f}))
        .addChild(new Viewpoint().setDescription("Camera view from left side").setPosition(new float[] {-12f,0f,-4f}).setOrientation(new float[] {0f,1f,0f,-1.5708f}))
        .addChild(new Transform().setTranslation(new float[] {0f,-0.165f,0.02f}).setScale(new float[] {0.1f,0.1f,0.1f})
          .addChild(new Switch()
            .addChild(new Shape()
              .setAppearance(new Appearance().setDEF("CameraAppearance")
                .setMaterial(new Material().setDEF("lambert1_1").setAmbientIntensity(0.25f).setDiffuseColor(new float[] {0.372322f,0.371574f,0.373173f}).setSpecularColor(new float[] {0.890909f,0.887832f,0.890909f}).setShininess(0.02f))))
            .addChild(new Shape()
              .setAppearance(new Appearance().setUSE("CameraAppearance"))
              .setGeometry(new IndexedFaceSet().setDEF("pCylinder1_0Geo").setConvex(false).setCreaseAngle(0.7854f).setCoordIndex(new MFInt321().getArray())
                .setCoord(new Coordinate().setDEF("pCylinder1GeoPoints").setPoint(new MFVec3f2().getArray()))))
            .addChild(new Shape()
              .setAppearance(new Appearance().setUSE("CameraAppearance"))
              .setGeometry(new IndexedFaceSet().setDEF("pCube1_0Geo").setConvex(false).setCreaseAngle(0.7854f).setCoordIndex(new MFInt323().getArray())
                .setCoord(new Coordinate().setDEF("pCube1GeoPoints").setPoint(new MFVec3f4().getArray()))))
            .addChild(new Shape()
              .setAppearance(new Appearance().setUSE("CameraAppearance"))
              .setGeometry(new IndexedFaceSet().setDEF("pPipe1_0Geo").setConvex(false).setCreaseAngle(0.7854f).setCoordIndex(new MFInt325().getArray().append(new MFInt326().getArray()))
                .setCoord(new Coordinate().setDEF("pPipe1GeoPoints").setPoint(new MFVec3f7().getArray()))))
            .addChild(new Shape()
              .setAppearance(new Appearance().setUSE("CameraAppearance"))
              .setGeometry(new IndexedFaceSet().setDEF("pSphere1_0Geo").setConvex(false).setCreaseAngle(0.7854f).setCoordIndex(new MFInt328().getArray().append(new MFInt329().getArray()))
                .setCoord(new Coordinate().setDEF("pSphere1GeoPoints").setPoint(new MFVec3f10().getArray())))))
          .addChild(new Group()
            .addChild(new Transform().setDEF("pCylinder1").setTranslation(new float[] {-0.038462f,3.596312f,3.297562f}).setRotation(new float[] {-1f,0f,0f,0.373518f})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pCylinder1_0Geo"))))
            .addChild(new Transform().setDEF("pCube1").setTranslation(new float[] {-0.030769f,1.738461f,1.4436f}).setScale(new float[] {1f,0.727134f,0.801457f})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pCube1_0Geo"))))
            .addChild(new Transform().setDEF("pPipe1").setTranslation(new float[] {0.015385f,1.630769f,-1.973274f}).setScale(new float[] {1f,1f,0.569444f})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pPipe1_0Geo"))))
            .addChild(new Transform().setDEF("pSphere1").setTranslation(new float[] {-0.015385f,1.628515f,-2.569231f}).setScale(new float[] {1.1f,1.1f,0.1f})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))

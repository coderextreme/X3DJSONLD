  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDEF("CameraShapeView").setDescription("Camera view, over the shoulder").setPosition(new double[] {0,0.75,3}))
        .addChild(new Viewpoint().setDescription("Camera view through lens").setPosition(new double[] {0,0,0}))
        .addChild(new Viewpoint().setDescription("Camera view from right side").setOrientation(new double[] {0,1,0,1.5708}).setPosition(new double[] {12,0,-4}))
        .addChild(new Viewpoint().setDescription("Camera view from above").setOrientation(new double[] {1,0,0,-1.5708}).setPosition(new double[] {0,15,-5}))
        .addChild(new Viewpoint().setDescription("Camera view from left side").setOrientation(new double[] {0,1,0,-1.5708}).setPosition(new double[] {-12,0,-4}))
        .addChild(new Transform().setScale(new double[] {0.1,0.1,0.1}).setTranslation(new double[] {0,-0.165,0.02})
          .addChild(new Switch().setWhichChoice(-1)
            .addChild(new Shape()
              .setAppearance(new Appearance().setDEF("CameraAppearance")
                .setMaterial(new Material().setDEF("lambert1_0").setAmbientIntensity(0.25).setDiffuseColor(new double[] {0.372322,0.371574,0.373173}).setShininess(0.02).setSpecularColor(new double[] {0.890909,0.887832,0.890909})
                  .addComments("Universal Media Library: Metals 30"))))
            .addChild(new Shape()
              .setGeometry(new IndexedFaceSet().setDEF("pCylinder1_0Geo").setConvex(false).setCoordIndex(new MFInt321().getArray()).setCreaseAngle(0.7854)
            ...
            .addChild(new Shape()
              .setGeometry(new IndexedFaceSet().setDEF("pCube1_0Geo").setConvex(false).setCoordIndex(new MFInt323().getArray()).setCreaseAngle(0.7854)
                .setCoord(new Coordinate().setDEF("pCube1GeoPoints").setPoint(new MFVec3f4().getArray())))
              .setAppearance(new Appearance().setUSE("CameraAppearance")))
            .addChild(new Shape()
              .setGeometry(new IndexedFaceSet().setDEF("pPipe1_0Geo").setConvex(false).setCoordIndex(new MFInt325().getArray().append(new MFInt326().getArray())).setCreaseAngle(0.7854)
                .setCoord(new Coordinate().setDEF("pPipe1GeoPoints").setPoint(new MFVec3f7().getArray())))
              .setAppearance(new Appearance().setUSE("CameraAppearance")))
            .addChild(new Shape()
              .setGeometry(new IndexedFaceSet().setDEF("pSphere1_0Geo").setConvex(false).setCoordIndex(new MFInt328().getArray().append(new MFInt329().getArray())).setCreaseAngle(0.7854)
                .setCoord(new Coordinate().setDEF("pSphere1GeoPoints").setPoint(new MFVec3f10().getArray())))
              .setAppearance(new Appearance().setUSE("CameraAppearance"))))
          .addChild(new Group()
            .addChild(new Transform().setDEF("pCylinder1").setRotation(new double[] {-1,0,0,0.373518}).setTranslation(new double[] {-0.038462,3.596312,3.297562})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pCylinder1_0Geo"))))
            .addChild(new Transform().setDEF("pCube1").setScale(new double[] {1,0.727134,0.801457}).setTranslation(new double[] {-0.030769,1.738461,1.4436})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pCube1_0Geo"))))
            .addChild(new Transform().setDEF("pPipe1").setScale(new double[] {1,1,0.569444}).setTranslation(new double[] {0.015385,1.630769,-1.973274})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pPipe1_0Geo"))))
            .addChild(new Transform().setDEF("pSphere1").setScale(new double[] {1.1,1.1,0.1}).setTranslation(new double[] {-0.015385,1.628515,-2.569231})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
...
private class MFVec3f2 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.36,-2.39,-0.26,-0.36,-1.77,-0.89,-0.36,0,-1.7,-0.36,0.85,-1.47,-0.36,1.47,-0.85,-0.36,1.7,0,-0.36,1.47,0.85,-0.36,-0.07,2.05,-0.36,-0.92,2.28,-0.36,-1.77,2.05,-0.36,-2.39,1.43,-0.36,-2.62,0.58,0.36,-2.39,-0.26,0.36,-1.77,-0.89,0.36,0,-1.7,0.36,0.85,-1.47,0.36,1.47,-0.85,0.36,1.7,0,0.36,1.47,0.85,0.36,-0.07,2.05,0.36,-0.92,2.28,0.36,-1.77,2.05,0.36,-2.39,1.43,0.36,-2.62,0.58,-0.36,-0.46,0.31,0.36,-0.46,0.31});
  }
}

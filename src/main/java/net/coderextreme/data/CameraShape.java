...
public class CameraShape implements X3DRoots {
  public static void main(String[] args) {
    ...
    X3D model = new CameraShape().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/CameraShape.new.java.x3d");
    model.toFileJSON("../data/CameraShape.new.java.json");
    }
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDEF("CameraShapeView").setDescription("Camera view, over the shoulder").setPosition(new double[] {0f,0.75f,3f}))
        .addChild(new Viewpoint().setDescription("Camera view through lens").setPosition(new double[] {0f,0f,0f}))
        .addChild(new Viewpoint().setDescription("Camera view from right side").setOrientation(new double[] {0f,1f,0f,1.5708f}).setPosition(new double[] {12f,0f,-4f}))
        .addChild(new Viewpoint().setDescription("Camera view from above").setOrientation(new double[] {1f,0f,0f,-1.5708f}).setPosition(new double[] {0f,15f,-5f}))
        .addChild(new Viewpoint().setDescription("Camera view from left side").setOrientation(new double[] {0f,1f,0f,-1.5708f}).setPosition(new double[] {-12f,0f,-4f}))
        .addChild(new Transform().setScale(new double[] {0.1f,0.1f,0.1f}).setTranslation(new double[] {0f,-0.165f,0.02f})
          .addChild(new Switch().setWhichChoice(-1)
            .addChild(new Shape()
              .setAppearance(new Appearance().setDEF("CameraAppearance")
                .setMaterial(new Material().setDEF("lambert1_0").setAmbientIntensity(0.25f).setDiffuseColor(new double[] {0.372322f,0.371574f,0.373173f}).setShininess(0.02f).setSpecularColor(new double[] {0.890909f,0.887832f,0.890909f})
            ...
            .addChild(new Shape()
              ...
              .setAppearance(new Appearance().setUSE("CameraAppearance"))))
          .addChild(new Group()
            .addChild(new Transform().setDEF("pCylinder1").setRotation(new double[] {-1f,0f,0f,0.373518f}).setTranslation(new double[] {-0.038462f,3.596312f,3.297562f})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pCylinder1_0Geo"))))
            .addChild(new Transform().setDEF("pCube1").setScale(new double[] {1f,0.727134f,0.801457f}).setTranslation(new double[] {-0.030769f,1.738461f,1.4436f})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pCube1_0Geo"))))
            .addChild(new Transform().setDEF("pPipe1").setScale(new double[] {1f,1f,0.569444f}).setTranslation(new double[] {0.015385f,1.630769f,-1.973274f})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pPipe1_0Geo"))))
            .addChild(new Transform().setDEF("pSphere1").setScale(new double[] {1.1f,1.1f,0.1f}).setTranslation(new double[] {-0.015385f,1.628515f,-2.569231f})
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
...
private class MFVec3f2 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.36f,-2.39f,-0.26f,-0.36f,-1.77f,-0.89f,-0.36f,0f,-1.7f,-0.36f,0.85f,-1.47f,-0.36f,1.47f,-0.85f,-0.36f,1.7f,0f,-0.36f,1.47f,0.85f,-0.36f,-0.07f,2.05f,-0.36f,-0.92f,2.28f,-0.36f,-1.77f,2.05f,-0.36f,-2.39f,1.43f,-0.36f,-2.62f,0.58f,0.36f,-2.39f,-0.26f,0.36f,-1.77f,-0.89f,0.36f,0f,-1.7f,0.36f,0.85f,-1.47f,0.36f,1.47f,-0.85f,0.36f,1.7f,0f,0.36f,1.47f,0.85f,0.36f,-0.07f,2.05f,0.36f,-0.92f,2.28f,0.36f,-1.77f,2.05f,0.36f,-2.39f,1.43f,0.36f,-2.62f,0.58f,-0.36f,-0.46f,0.31f,0.36f,-0.46f,0.31f});
  }
}
...
private class MFVec3f10 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0
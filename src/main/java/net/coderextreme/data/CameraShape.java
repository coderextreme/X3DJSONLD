...
public class CameraShape {
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString0().getArray())).setTitle("SimpleCamera.x3d"))
        ...
        .addChild(new Transform().setScale(new float[] {0.1f,0.1f,0.1f}).setTranslation(new float[] {0f,-0.165f,0.02f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Switch().setWhichChoice(-1).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new IndexedFaceSet().setDEF("pCylinder1_0Geo").setConvex(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt321().getArray())).setCreaseAngle(0.7854f)
                .setCoord(new Coordinate().setDEF("pCylinder1GeoPoints").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f2().getArray()))))
              .setAppearance(new Appearance().setUSE("CameraAppearance")))
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new IndexedFaceSet().setDEF("pCube1_0Geo").setConvex(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt323().getArray())).setCreaseAngle(0.7854f)
                .setCoord(new Coordinate().setDEF("pCube1GeoPoints").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f4().getArray()))))
              .setAppearance(new Appearance().setUSE("CameraAppearance")))
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new IndexedFaceSet().setDEF("pPipe1_0Geo").setConvex(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt325().getArray()).append(new MFInt326().getArray())).setCreaseAngle(0.7854f)
                .setCoord(new Coordinate().setDEF("pPipe1GeoPoints").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f7().getArray()))))
              .setAppearance(new Appearance().setUSE("CameraAppearance")))
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new IndexedFaceSet().setDEF("pSphere1_0Geo").setConvex(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt328().getArray()).append(new MFInt329().getArray())).setCreaseAngle(0.7854f)
                .setCoord(new Coordinate().setDEF("pSphere1GeoPoints").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f10().getArray()))))
              .setAppearance(new Appearance().setUSE("CameraAppearance"))))
          .addChild(new Group().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Transform().setDEF("pCylinder1").setRotation(new float[] {-1f,0f,0f,0.373518f}).setTranslation(new float[] {-0.038462f,3.596312f,3.297562f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pCylinder1_0Geo"))))
            .addChild(new Transform().setDEF("pCube1").setScale(new float[] {1f,0.727134f,0.801457f}).setTranslation(new float[] {-0.030769f,1.738461f,1.4436f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pCube1_0Geo"))))
            .addChild(new Transform().setDEF("pPipe1").setScale(new float[] {1f,1f,0.569444f}).setTranslation(new float[] {0.015385f,1.630769f,-1.973274f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance().setUSE("CameraAppearance"))
                .setGeometry(new IndexedFaceSet().setUSE("pPipe1_0Geo"))))
            .addChild(new Transform().setDEF("pSphere1").setScale(new float[] {1.1f,1.1f,0.1f}).setTranslation(new float[] {-0.015385f,1.628515f,-2.569231f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance().setUSE("CameraAppearance"))

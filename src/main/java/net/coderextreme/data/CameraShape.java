  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setContent("SimpleCamera.x3d").setName("title"))
        .addMeta(new metaObject().setContent("Simple video camera shape").setName("description"))
        .addMeta(new metaObject().setContent("Jeff Weekley and Don Brutzman").setName("creator"))
        .addMeta(new metaObject().setContent("2 June 2009").setName("created"))
        .addMeta(new metaObject().setContent("2 June 2009").setName("translated"))
        ...
        .addMeta(new metaObject().setContent("http://www.web3d.org/x3d/content/examples/Basic/development/SimpleCamera.x3d").setName("identifier"))

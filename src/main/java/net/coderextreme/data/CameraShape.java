...
public class CameraShape implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/CameraShape.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      X3D X3D0 =  new X3D().setProfile(new SFString("Interactive")).setVersion(new SFString("4.0"))
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("CameraShape.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("Simple video camera shape")))
        .addMeta(new meta().setName(new SFString("creator")).setContent(new SFString("Jeff Weekley and Don Brutzman")))
        .addMeta(new meta().setName(new SFString("created")).setContent(new SFString("2 June 2009")))
        .addMeta(new meta().setName(new SFString("translated")).setContent(new SFString("2 June 2009")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/Basic/development/SimpleCamera.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setInfo(new MFString0().getArray()).setTitle(new SFString("SimpleCamera.x3d")))
        .addChild(new Viewpoint().setDEF(new SFString("CameraShapeView")).setDescription(new SFString("Camera view, over the shoulder")).setPosition(new float[] {0f ,0.75f ,3f }))
        .addChild(new Viewpoint().setDescription(new SFString("Camera view through lens")).setPosition(new float[] {0f ,0f ,0f }))
        .addChild(new Viewpoint().setDescription(new SFString("Camera view from right side")).setOrientation(new float[] {0f ,1f ,0f ,1.5708f }).setPosition(new float[] {12f ,0f ,-4f }))
        .addChild(new Viewpoint().setDescription(new SFString("Camera view from above")).setOrientation(new float[] {1f ,0f ,0f ,-1.5708f }).setPosition(new float[] {0f ,15f ,-5f }))
        .addChild(new Viewpoint().setDescription(new SFString("Camera view from left side")).setOrientation(new float[] {0f ,1f ,0f ,-1.5708f }).setPosition(new float[] {-12f ,0f ,-4f }))
        .addChild(new Transform().setScale(new float[] {0.1f ,0.1f ,0.1f }).setTranslation(new float[] {0f ,-0.165f ,0.02f })
          .addChild(new Switch().setWhichChoice(-1)
            .addChild(new Shape()
              .setAppearance(new Appearance().setDEF(new SFString("CameraAppearance"))
                .setMaterial(new Material().setDEF(new SFString("lambert1_0")).setAmbientIntensity(0.25f ).setDiffuseColor(new float[] {0.372322f ,0.371574f ,0.373173f }).setShininess(0.02f ).setSpecularColor(new float[] {0.890909f ,0.887832f ,0.890909f })
                  .addComments(new CommentsBlock("Universal Media Library: Metals 30")))))
            .addChild(new Shape()
              .setGeometry(new IndexedFaceSet().setDEF(new SFString("pCylinder1_0Geo")).setConvex(false).setCoordIndex(new MFInt321().getArray()).setCreaseAngle(0.7854f )
                .setCoord(new Coordinate().setDEF(new SFString("pCylinder1GeoPoints")).setPoint(new MFVec3f2().getArray())))
              .setAppearance(new Appearance().setUSE(new SFString("CameraAppearance"))))
            .addChild(new Shape()
              .setGeometry(new IndexedFaceSet().setDEF(new SFString("pCube1_0Geo")).setConvex(false).setCoordIndex(new MFInt323().getArray()).setCreaseAngle(0.7854f )
                .setCoord(new Coordinate().setDEF(new SFString("pCube1GeoPoints")).setPoint(new MFVec3f4().getArray())))
              .setAppearance(new Appearance().setUSE(new SFString("CameraAppearance"))))
            .addChild(new Shape()
              .setGeometry(new IndexedFaceSet().setDEF(new SFString("pPipe1_0Geo")).setConvex(false).setCoordIndex(new MFInt325().getArray().append(new MFInt326().getArray())).setCreaseAngle(0.7854f )
                .setCoord(new Coordinate().setDEF(new SFString("pPipe1GeoPoints")).setPoint(new MFVec3f7().getArray())))
              .setAppearance(new Appearance().setUSE(new SFString("CameraAppearance"))))
            .addChild(new Shape()
              .setGeometry(new IndexedFaceSet().setDEF(new SFString("pSphere1_0Geo")).setConvex(false).setCoordIndex(new MFInt328().getArray().append(new MFInt329().getArray())).setCreaseAngle(0.7854f )
                .setCoord(new Coordinate().setDEF(new SFString("pSphere1GeoPoints")).setPoint(new MFVec3f10().getArray())))
              .setAppearance(new Appearance().setUSE(new SFString("CameraAppearance")))))
          .addChild(new Group()
            .addChild(new Transform().setDEF(new SFString("pCylinder1")).setRotation(new float[] {-1f ,0f ,0f ,0.373518f }).setTranslation(new float[] {-0.038462f ,3.596312f ,3.297562f })
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE(new SFString("CameraAppearance")))
                .setGeometry(new IndexedFaceSet().setUSE(new SFString("pCylinder1_0Geo")))))
            .addChild(new Transform().setDEF(new SFString("pCube1")).setScale(new float[] {1f ,0.727134f ,0.801457f }).setTranslation(new float[] {-0.030769f ,1.738461f ,1.4436f })
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE(new SFString("CameraAppearance")))
                .setGeometry(new IndexedFaceSet().setUSE(new SFString("pCube1_0Geo")))))
            .addChild(new Transform().setDEF(new SFString("pPipe1")).setScale(new float[] {1f ,1f ,0.569444f }).setTranslation(new float[] {0.015385f ,1.630769f ,-1.973274f })
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE(new SFString("CameraAppearance")))
                .setGeometry(new IndexedFaceSet().setUSE(new SFString("pPipe1_0Geo")))))
            .addChild(new Transform().setDEF(new SFString("pSphere1")).setScale(new float[] {1.1f ,1.1f ,0.1f }).setTranslation(new float[] {-0.015385f ,1.628515f ,-2.569231f })
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE(new SFString("CameraAppearance")))
                .setGeometry(new IndexedFaceSet().setUSE(new SFString("pSphere1_0Geo"))))))));
    return X3D0;
    }

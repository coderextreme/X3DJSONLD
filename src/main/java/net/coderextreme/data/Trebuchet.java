      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setRotation(new float[] {0f,1f,0f,1.57f}).setScale(new float[] {0.5f,0.5f,0.5f}).setTranslation(new float[] {10.5f,6.5f,4.5f})
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("TextAppearance")
              .setMaterial(new Material("TextAppearance").setDiffuseColor(new float[] {1f,0f,0f}).setEmissiveColor(new float[] {1f,1f,0f})))
        ...
        .addChild(new Transform().setRotation(new float[] {0f,1f,0f,1.57f}).setTranslation(new float[] {10f,0.5f,4.5f})
          .addChild(new Transform().setDEF("launch").setTranslation(new float[] {0f,2f,5f})
            ...
            .addChild(new TouchSensor("launch").setDEF("Launch").setDescription("launch!")))
          .addChild(new Transform()
            .addChild(new Switch().setDEF("projectilename").setWhichChoice(0)
              .addChild(new Group("projectilename")
                .addChild(new Shape()
                  .setAppearance(new Appearance().setUSE("TextAppearance"))
        ...
        .addChild(new Transform().setRotation(new float[] {0f,1f,0f,-1.67f})
          .addChild(new Transform().setDEF("aft").setTranslation(new float[] {5f,5f,15f})
            .addChild(new Transform("aft").setTranslation(new float[] {-2.5f,-4.5f,-2f})
        ...
        .addChild(new Transform().setTranslation(new float[] {0f,3f,0f})
          .addChild(new Shape().setDEF("plank")
            .setGeometry(new Box("plank").setSize(new float[] {25f,1f,1f}))
            .setAppearance(new Appearance("plank").setDEF("wood")
              .setTexture(new ImageTexture("wood").setDEF("woodTexture").setUrl(new MFString26().getArray()))))
          .addChild(new Transform().setDEF("angledsupport").setRotation(new float[] {0f,0f,1f,1f}).setTranslation(new float[] {-5f,10f,0f})
            .addChild(new Shape("angledsupport").setUSE("plank")))
          .addChild(new Transform().setDEF("angledsupport2").setRotation(new float[] {0f,0f,1f,-1f}).setTranslation(new float[] {5f,10f,0f})
            .addChild(new Shape("angledsupport2").setUSE("plank")))
          .addChild(new Transform().setDEF("verticalsupport").setRotation(new float[] {0f,0f,1f,1.57f}).setScale(new float[] {0.9f,1f,1f}).setTranslation(new float[] {0f,11f,0f})
            .addChild(new Shape("verticalsupport").setUSE("plank"))
          ...
          .addChild(new Transform().setDEF("horizontalsupport").setScale(new float[] {0.4f,1f,1f}).setTranslation(new float[] {0f,10f,0f})
            .addChild(new Shape("horizontalsupport").setUSE("plank")))
          ...
          .addChild(new Transform().setDEF("flinger").setCenter(new float[] {7f,0f,0f}).setRotation(new float[] {0f,0f,1f,0.82f}).setScale(new float[] {0.9f,1f,1f}).setTranslation(new float[] {-7f,18f,2.5f})
            .addChild(new Transform("flinger")
              .addChild(new Shape()
              ...
              .addChild(new Transform().setTranslation(new float[] {7f,0f,0f})
                .addChild(new Shape()
                  ...
                  .setAppearance(new Appearance().setUSE("wood")))))
            .addChild(new Transform("flinger").setRotation(new float[] {1f,0f,0f,1.57f}).setScale(new float[] {0.2f,0.2f,0.2f}).setTranslation(new float[] {-15f,-1f,0f})
              .addChild(new Shape().setDEF("Torus")
                .setAppearance(new Appearance("Torus")
                  .setMaterial(new Material().setSpecularColor(new float[] {1f,1f,1f})))
                .setGeometry(new Extrusion("Torus").setBeginCap(false).setConvex(false).setCreaseAngle(1.57f).setCrossSection(new MFVec2f29().getArray()).setEndCap(false).setSpine(new MFVec3f30().getArray())))
              .addChild(new Transform().setTranslation(new float[] {1f,0f,2f})
                .addChild(new Shape()
                  .setAppearance(new Appearance().setDEF("rope")
                    .setTexture(new ImageTexture("rope").setUSE("woodTexture")))
                  .setGeometry(new Sphere().setRadius(1.5f)))
                .addComments("knott")))
            .addComments("The Unicorn")
            .addChild(new Transform("flinger").setRotation(new float[] {0f,0f,1f,1.2f}).setScale(new float[] {0.2f,0.2f,0.2f}).setTranslation(new float[] {-18.3f,0.3f,0f})
              .addChild(new Shape()
            ...
            .addChild(new Transform("flinger").setRotation(new float[] {1f,0f,0f,-1.7f}).setTranslation(new float[] {-17f,-4.5f,0f})
              .addChild(new Transform().setScale(new float[] {0.2f,0.2f,0.2f})
                ...
                .addChild(new Transform().setTranslation(new float[] {-1f,0f,1.7f})
                  .addChild(new Shape()
                    .setGeometry(new Sphere().setRadius(1.5f))
                    .setAppearance(new Appearance().setUSE("rope"))))))
            .addChild(new Transform("flinger").setDEF("RnS")
              .addChild(new Transform("RnS").setDEF("ropes")
                .addChild(new Transform("ropes").setRotation(new float[] {0f,0f,1f,-0.82f}).setTranslation(new float[] {7f,-26f,-2.5f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance().setUSE("rope"))
              ...
              .addChild(new Transform("RnS").setDEF("sling").setRotation(new float[] {0f,0f,1f,-0.82f}).setTranslation(new float[] {-4f,-15.3f,0f})
                .addChild(new Transform("sling")
                    ...
                    .addChild(new Transform().setRotation(new float[] {0f,0f,1f,1.57f})
                      .addChild(new Transform().setScale(new float[] {0.3f,0.3f,0.3f})
                        .addChild(new Shape().setDEF("halfsling")
                          .setAppearance(new Appearance("halfsling").setDEF("clear")
                            .setMaterial(new Material("clear").setTransparency(0.5f)))
                          .setGeometry(new Extrusion("halfsling").setCrossSection(new MFVec2f37().getArray()).setSpine(new MFVec3f38().getArray())))
                  ...
                  .addChild(new Transform().setDEF("projectiletransform").setScale(new float[] {0.01f,0.01f,0.01f})
                    .addChild(new Switch("projectiletransform").setDEF("projectile").setWhichChoice(0)
                      .addChild(new Group("projectile")
                        .addChild(new Transform().setTranslation(new float[] {0f,0.7f,0f})
                          .addChild(new Shape()
                            ...
                            .setAppearance(new Appearance().setDEF("black")
                              .setMaterial(new Material("black").setDiffuseColor(new float[] {0f,0f,0f}).setSpecularColor(new float[] {1f,1f,1f}))))))
                      .addChild(new Group("projectile")
                        .addChild(new Transform()
          ...
          .addChild(new Transform().setDEF("verticalweight")
            .addChild(new Transform("verticalweight").setTranslation(new float[] {4f,18f,1.8f})
              .addChild(new Shape()
                .setGeometry(new Box().setSize(new float[] {1f,10f,0.5f}))
                .setAppearance(new Appearance().setUSE("wood"))))
            .addChild(new Transform("verticalweight").setTranslation(new float[] {4f,18f,3.2f})
              .addChild(new Shape()
                .setGeometry(new Box().setSize(new float[] {1f,10f,0.5f}))
                .setAppearance(new Appearance().setUSE("wood"))))
            .addChild(new Transform("verticalweight").setTranslation(new float[] {4f,14f,2.5f})
              .addComments("CounterWeight")
              .addChild(new Shape()
                .setGeometry(new Cylinder().setHeight(4f).setRadius(1.5f))
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {0f,0f,0f}).setSpecularColor(new float[] {1f,1f,1f})))))
            .addChild(new Transform("verticalweight").setRotation(new float[] {1f,0f,0f,1.57f}).setTranslation(new float[] {4f,22f,2.5f})
              .addChild(new Shape()
          ...
          .addChild(new Transform().setRotation(new float[] {0f,0f,1f,1.57f}).setScale(new float[] {0.2f,0.2f,0.2f}).setTranslation(new float[] {-11.5f,-1f,2f})
            .addChild(new Transform().setDEF("screw").setRotation(new float[] {1f,0f,0f,1.57f})
              .addChild(new Shape("screw").setUSE("Torus"))
              .addChild(new Transform("screw").setRotation(new float[] {1f,0f,0f,-1.57f}).setTranslation(new float[] {0f,0f,7f})
                .addChild(new Shape()
            ...
            .addChild(new Transform().setDEF("Pin").setRotation(new float[] {1f,0f,0f,-1.57f}).setTranslation(new float[] {0f,0f,-3f})
              .addChild(new Transform("Pin").setUSE("screw"))))
          ...
          .addChild(new Transform().setTranslation(new float[] {10f,-1f,2.5f})
            .addChild(new Shape().setDEF("Axle")
              .setGeometry(new Box("Axle").setSize(new float[] {1f,1f,8f}))
              .setAppearance(new Appearance("Axle").setUSE("wood")))
            .addChild(new Transform().setRotation(new float[] {1f,0f,0f,1.57f}).setTranslation(new float[] {0f,0f,4.5f})
              .addChild(new Shape().setDEF("wheel")
                .setGeometry(new Cylinder("wheel").setRadius(2f))
                .setAppearance(new Appearance("wheel").setUSE("wood")))
              .addChild(new Shape().setDEF("tracks")
                .setGeometry(new Sphere("tracks").setRadius(1.5f))
                .setAppearance(new Appearance("tracks").setUSE("black")))
              .addChild(new Transform().setTranslation(new float[] {0f,0.55f,0f})
                .addChild(new Shape().setDEF("hub")
                  .setGeometry(new Sphere("hub").setRadius(1.5f))
                  .setAppearance(new Appearance("hub").setUSE("black")))))
            .addChild(new Transform().setRotation(new float[] {1f,0f,0f,1.57f}).setTranslation(new float[] {0f,0f,-4.5f})
          ...
          .addChild(new Transform().setTranslation(new float[] {-10f,-1f,2.5f})
            ...
            .addChild(new Transform().setDEF("ProjectileTransform").setTranslation(new float[] {14.25f,1.25f,0f})
              .addChild(new Switch("ProjectileTransform").setUSE("projectile"))
              .addChild(new Transform("ProjectileTransform").setRotation(new float[] {0f,1f,0f,1.57f}).setTranslation(new float[] {0f,1f,0f})
            ...
            .addChild(new Transform().setTranslation(new float[] {20f,2f,0f})
              .addChild(new Transform().setDEF("Front").setRotation(new float[] {0f,1f,0f,1.57f})
                .addChild(new Viewpoint("Front").setDescription("Fore"))))
            ...
            .addChild(new Script().setDEF("WeightScript")
              .addField(new field("WeightScript").setType("SFBool").setName("set_boolean").setAccessType(field.ACCESSTYPE_INPUTONLY))
              .addField(new field("WeightScript").setType("SFInt32").setName("whichchoice").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .addField(new field("WeightScript").setType("SFFloat").setName("CounterWeight").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
...
"}"))
            .addChild(new Script().setDEF("LauncheeScript")
              .addField(new field("LauncheeScript").setType("SFBool").setName("set_boolean").setAccessType(field.ACCESSTYPE_INPUTONLY))
              .addField(new field("LauncheeScript").setType("SFInt32").setName("whichchoice").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .addField(new field("LauncheeScript").setType("SFFloat").setName("ProjectileWeight").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .setSourceCode("ecmascript:\n"+
"\n"+
"function set_boolean (boolean_input, eventTime)\n"+
"{\n"+
...
"}"))
            .addChild(new Script().setDEF("PigdogMonkScript")
              .addField(new field("PigdogMonkScript").setType("SFBool").setName("set_boolean").setAccessType(field.ACCESSTYPE_INPUTONLY))
              .addField(new field("PigdogMonkScript").setType("SFInt32").setName("whichchoice").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .setSourceCode("ecmascript:\n"+
"\n"+
"function set_boolean (boolean_input, eventTime)\n"+
"{\n"+
...
"}"))
            .addChild(new Script().setDEF("Mover")
              .addField(new field("Mover").setType("SFFloat").setName("set_fraction").setAccessType(field.ACCESSTYPE_INPUTONLY))
              .addField(new field("Mover").setType("SFFloat").setName("set_MassCounterWeight").setAccessType(field.ACCESSTYPE_INPUTONLY))
              .addField(new field("Mover").setType("SFFloat").setName("set_MassProjectileWeight").setAccessType(field.ACCESSTYPE_INPUTONLY))
              .addField(new field("Mover").setType("SFFloat").setName("MassCounterWeight").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue("1"))
              .addField(new field("Mover").setType("SFFloat").setName("MassProjectileWeight").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue("1"))
              .addField(new field("Mover").setType("SFVec3f").setName("transparent").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .addField(new field("Mover").setType("SFVec3f").setName("value_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .setSourceCode("ecmascript:\n"+
"\n"+
"function initialize ()\n"+
"{\n"+

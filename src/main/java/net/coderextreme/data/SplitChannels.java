...
public class SplitChannels {
  public static void main(String[] args) {
    ...
    new SplitChannels().initialize().toFileJSON("../data/SplitChannels.new.json");
    }
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("PowerR").setTranslation(new float[] {100f,400f,400f})
          .addChild(new Transform().setDEF("pR").setRotation(new float[] {1f,0f,0f,-0.5f}).setTranslation(new float[] {0f,40f,0f})
            .addChild(new Shape()
          ...
          .addChild(new Transform().setRotation(new float[] {1f,0f,0f,-0.5f}).setTranslation(new float[] {-2.7f,37f,0f})
            .addChild(new Shape()
              .setAppearance(new Appearance().setDEF("audio_emit2")
                .setMaterial(new Material().setDiffuseColor(new float[] {0f,1f,0f}).setEmissiveColor(new float[] {0.8f,0.8f,0.8f}).setSpecularColor(new float[] {0.01f,0.01f,0.01f}))
                .setTexture(new ImageTexture().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray()))))
          ...
          .addChild(new Transform().setDEF("volumeRight").setRotation(new float[] {1f,0f,0f,-0.5f}).setScale(new float[] {10f,10f,10f}).setTranslation(new float[] {0f,-10f,0f})
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new float[] {0.345f,0.345f,0.882f}))
              ...
              .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray()))
                .setFontStyle(new FontStyle().setFamily(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())).setStyle("BOLD"))))))
        .addChild(new Transform().setDEF("PowerL").setTranslation(new float[] {-100f,400f,400f})
          .addChild(new Transform().setDEF("pL").setRotation(new float[] {1f,0f,0f,-0.5f}).setTranslation(new float[] {0f,40f,0f})
            .addChild(new Shape()
          ...
          .addChild(new Transform().setRotation(new float[] {1f,0f,0f,-0.5f}).setTranslation(new float[] {13.2f,37f,0f})
            .addChild(new Shape()
              .setAppearance(new Appearance().setDEF("audio_emit4")
                .setMaterial(new Material().setDiffuseColor(new float[] {0f,1f,0f}).setEmissiveColor(new float[] {0.8f,0.8f,0.8f}).setSpecularColor(new float[] {0.01f,0.01f,0.01f}))
                .setTexture(new ImageTexture().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray()))))
              .setGeometry(new Box().setSize(new float[] {25f,83f,0.01f}))))
          .addChild(new Transform().setDEF("volumeLeft").setRotation(new float[] {1f,0f,0f,-0.5f}).setScale(new float[] {10f,10f,10f}).setTranslation(new float[] {0f,-10f,0f})
            .addChild(new Shape()
              ...
              .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray()))
                .setFontStyle(new FontStyle().setFamily(new org.web3d.x3d.jsail.fields.MFString(new MFString6().getArray())).setStyle("BOLD"))))))
        .addChild(new Transform().setDEF("Audio3").setRotation(new float[] {1f,0f,0f,-0.5f}).setTranslation(new float[] {0f,100f,0f})
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("audio_emit5")
              ...
              .setTexture(new ImageTexture().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray()))))
...
protected class MFString1 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"images/line.png"});
  }
}
...
protected class MFString7 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"images/loudspeaker.png"});
  }
}
}

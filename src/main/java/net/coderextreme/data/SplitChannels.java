...
public class SplitChannels implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/SplitChannels.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("SplitChannels.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("This X3D scene includes a simple sound source which can be moved right and left. Depending on the position of the sound source, the user can hear the produced sound from the corresponding output speaker. Accordingly, there is a source that can be passed through a SpatialSound for the spatialization of the input audio. The approach is based on the relative position of the source and the listener, in comparison to the panner.")))
        ...
        .addMeta(new meta().setName(new SFString("modified")).setContent(new SFString("23 April 2023")))
        ...
        .addMeta(new meta().setName(new SFString("reference")).setContent(new SFString("http://www.medialab.hmu.gr/minipages/x3domAudio")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/SplitChannels.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("SplitChannels.x3d")))
        ...
        .addChild(new Transform().setDEF(new SFString("PowerR")).setTranslation(new float[] {100f ,400f ,400f })
          ...
          .addChild(new Transform().setDEF(new SFString("volumeRight")).setRotation(new float[] {1f ,0f ,0f ,-0.5f }).setScale(new float[] {10f ,10f ,10f }).setTranslation(new float[] {0f ,-10f ,0f })
            .addChild(new Shape()
              ...
              .setGeometry(new Text().setString(new MFString2().getArray())
                .setFontStyle(new FontStyle().setDEF(new SFString("VolumeFontStyle")).setFamily(new MFString3().getArray()).setStyle(new SFString("BOLD")))))))
        .addChild(new Transform().setDEF(new SFString("PowerL")).setTranslation(new float[] {-100f ,400f ,400f })
          .addChild(new Transform().setRotation(new float[] {1f ,0f ,0f ,-0.5f }).setTranslation(new float[] {0f ,40f ,0f })
            .addChild(new Shape()
          ...
          .addChild(new Transform().setRotation(new float[] {1f ,0f ,0f ,-0.5f }).setTranslation(new float[] {13.2f ,37f ,0f })
            .addChild(new Shape()
              .setAppearance(new Appearance().setDEF(new SFString("audio_emit4"))
                .setMaterial(new Material().setDiffuseColor(new float[] {0f ,1f ,0f }).setEmissiveColor(new float[] {0.8f ,0.8f ,0.8f }).setSpecularColor(new float[] {0.01f ,0.01f ,0.01f }))
                .setTexture(new ImageTexture().setUrl(new MFString4().getArray())))
              .setGeometry(new Box().setSize(new float[] {25f ,83f ,0.01f }))))
          .addChild(new Transform().setDEF(new SFString("volumeLeft")).setRotation(new float[] {1f ,0f ,0f ,-0.5f }).setScale(new float[] {10f ,10f ,10f }).setTranslation(new float[] {0f ,-10f ,0f })
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material().setAmbientIntensity(0.0933f ).setDiffuseColor(new float[] {0.345f ,0.345f ,0.882f }).setShininess(0.51f ).setSpecularColor(new float[] {0.46f ,0.46f ,0.46f })))
              .setGeometry(new Text().setString(new MFString5().getArray())
                .setFontStyle(new FontStyle().setUSE(new SFString("VolumeFontStyle")))))))
          ...
          .addChild(new Gain()
            .addChild(new ChannelMerger()
              .addChild(new ChannelSelector()
                .addChild(new Gain().setUSE(new SFString("ChannelSplitter"))))
              .addChild(new ChannelSelector().setChannelSelection(1)
                .addChild(new Gain().setUSE(new SFString("ChannelSplitter")))))))
        .addChild(new ChannelSplitter().setDEF(new SFString("ChannelSplitter")).setChannelCountMode(new SFString("EXPLICIT"))
          .addOutputs(new AudioClip().setDescription(new SFString("Violin")).setUrl(new MFString6().getArray())))
        .addChild(new Transform().setDEF(new SFString("Audio3")).setRotation(new float[] {1f ,0f ,0f ,-0.5f }).setTranslation(new float[] {0f ,100f ,0f })
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF(new SFString("audio_emit5"))

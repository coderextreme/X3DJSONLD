        ...
        .addChild(new GroupObject()
          ...
          .addChild(new ProtoDeclareObject().setName("orbit")
            .setProtoInterface(new ProtoInterfaceObject()
              ...
              .addField(new fieldObject().setType("SFVec3f").setName("diffuseColor").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setValue("1 0.5 0"))
              .addField(new fieldObject().setType("SFVec3f").setName("specularColor").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setValue("1 0.5 0"))
              ...
              .addChild(new GroupObject()
                .addChild(new TransformObject().setDEF("OrbitTransform")
                  ...
                  .addChild(new ShapeObject()
                    ...
                    .setGeometry(new IndexedFaceSetObject().setDEF("Orbit").setCreaseAngle(0f)
                ...
                .addChild(new ScriptObject().setDEF("OrbitScript")
                  ...
                  .addField(new fieldObject().setType("SFFloat").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("e").setValue("5"))
                  .addField(new fieldObject().setType("SFFloat").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("f").setValue("5"))
                  .addField(new fieldObject().setType("SFFloat").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("g").setValue("5"))
                  .addField(new fieldObject().setType("SFFloat").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("h").setValue("5"))
                  .addField(new fieldObject().setType("SFInt32").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("resolution").setValue("50"))
                  .setSourceCode("\n"+
"			ecmascript:\n"+
"\n"+
"			var e = 5;\n"+

...
public class flowers2 {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/flowers2.new.json");
    }
            ...
            .setProtoBody(new ProtoBody()
              .addChild(new Group()
                ...
                .addChild(new Transform().setDEF("OrbitTransform")
                  .setIS(new IS("OrbitTransform")
                    .addConnect(new connect().setNodeField("translation").setProtoField("translation")))
                  .addChild(new Shape("OrbitTransform")
                    ...
                    .setGeometry(new IndexedFaceSet().setCcw(false).setConvex(false).setCoordIndex(new MFInt322().getArray()).setDEF("Orbit")
                      .setCoord(new Coordinate("Orbit").setDEF("OrbitCoordinates").setPoint(new MFVec3f3().getArray())))))
                .addChild(new Script().setDEF("OrbitScript")
                  .addField(new field("OrbitScript").setType("SFFloat").setName("set_fraction").setAccessType(field.ACCESSTYPE_INPUTONLY))
                  .addField(new field("OrbitScript").setType("MFVec3f").setName("coordinates").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
                  .addField(new field("OrbitScript").setType("MFInt32").setName("coordIndexes").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
                  .addField(new field("OrbitScript").setType("SFFloat").setName("e").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("5"))
                  .addField(new field("OrbitScript").setType("SFFloat").setName("f").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("5"))
                  .addField(new field("OrbitScript").setType("SFFloat").setName("g").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("5"))
                  .addField(new field("OrbitScript").setType("SFFloat").setName("h").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("5"))
                  .addField(new field("OrbitScript").setType("SFInt32").setName("resolution").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("50"))

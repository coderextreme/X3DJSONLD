              ...
              .addChild(new GroupObject()
                ...
                .addChild(new TransformObject().setDEF("OrbitTransform")
                  ...
                  .addChild(new ShapeObject()
                    ...
                    .addComments(new CommentsBlock("				  <IndexedFaceSet DEF=\"Orbit\" creaseAngle=\"0\">"))
                    .addComments(new CommentsBlock("				    <Coordinate DEF=\"OrbitCoordinates\"/>"))
                    .addComments(new CommentsBlock("				  </IndexedFaceSet>"))
                    .addComments(new CommentsBlock("				  "))
                    .setGeometry(new IndexedFaceSetObject().setCcw(false).setConvex(false).setCoordIndex(new MFInt32Object(new MFInt322().getArray())).setCreaseAngle(0f).setDEF("Orbit").setSolid(true)

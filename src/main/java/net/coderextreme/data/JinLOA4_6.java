...
public class JinLOA4_6 implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/JinLOA4_6.new.java.x3d");
    model.toFileJSON("../data/JinLOA4_6.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("JinLOA4_6.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("JinLOA4_6.x3d")))
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setName(new SFString("vt3")).setDEF(new SFString("hanim_vt3")).setCenter(new float[] {0f ,52.040001f ,-0.6117f }).setUlimit(new MFFloat439().getArray()).setLlimit(new MFFloat440().getArray())
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setName(new SFString("vt2")).setDEF(new SFString("hanim_vt2")).setCenter(new float[] {0f ,53.139999f ,-0.6127f }).setUlimit(new MFFloat445().getArray()).setLlimit(new MFFloat446().getArray())
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setName(new SFString("vt1")).setDEF(new SFString("hanim_vt1")).setCenter(new float[] {0f ,54.200001f ,-0.6117f }).setUlimit(new MFFloat451().getArray()).setLlimit(new MFFloat452().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName(new SFString("l_sternoclavicular")).setDEF(new SFString("hanim_l_sternoclavicular")).setCenter(new float[] {1.71f ,53.720001f ,-0.6127f }).setUlimit(new MFFloat553().getArray()).setLlimit(new MFFloat554().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName(new SFString("l_acromioclavicular")).setDEF(new SFString("hanim_l_acromioclavicular")).setCenter(new float[] {5.464f ,52.970001f ,-0.5732f }).setUlimit(new MFFloat559().getArray()).setLlimit(new MFFloat560().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName(new SFString("l_shoulder")).setDEF(new SFString("hanim_l_shoulder")).setCenter(new float[] {7.336f ,52.380001f ,-0.1452f }).setUlimit(new MFFloat565().getArray()).setLlimit(new MFFloat566().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setName(new SFString("r_sternoclavicular")).setDEF(new SFString("hanim_r_sternoclavicular")).setCenter(new float[] {-1.71f ,53.720001f ,-0.6127f }).setUlimit(new MFFloat721().getArray()).setLlimit(new MFFloat722().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName(new SFString("r_acromioclavicular")).setDEF(new SFString("hanim_r_acromioclavicular")).setCenter(new float[] {-5.464f ,52.970001f ,-0.5732f }).setUlimit(new MFFloat727().getArray()).setLlimit(new MFFloat728().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_acromioclavicular").setName(new SFString("r_shoulder")).setDEF(new SFString("hanim_r_shoulder")).setCenter(new float[] {-7.32f ,52.380001f ,-0.1452f }).setUlimit(new MFFloat733().getArray()).setLlimit(new MFFloat734().getArray())

...
public class JinLOA4_6 {
  public static void main(String[] args) {
    ...
    X3D model = new JinLOA4_6().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/JinLOA4_6.new.json");
    }
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setDEF("hanim_vt3").setName("vt3").setCenter(new float[] {0f,52.04f,-0.6117f}).setLlimit(new MFFloat435().getArray()).setUlimit(new MFFloat436().getArray())
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setDEF("hanim_vt2").setName("vt2").setCenter(new float[] {0f,53.14f,-0.6127f}).setLlimit(new MFFloat441().getArray()).setUlimit(new MFFloat442().getArray())
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setDEF("hanim_vt1").setName("vt1").setCenter(new float[] {0f,54.2f,-0.6117f}).setLlimit(new MFFloat447().getArray()).setUlimit(new MFFloat448().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(new float[] {1.71f,53.72f,-0.6127f}).setLlimit(new MFFloat549().getArray()).setUlimit(new MFFloat550().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_sternoclavicular").setDEF("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(new float[] {5.464f,52.97f,-0.5732f}).setLlimit(new MFFloat555().getArray()).setUlimit(new MFFloat556().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_acromioclavicular").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {7.336f,52.38f,-0.1452f}).setLlimit(new MFFloat561().getArray()).setUlimit(new MFFloat562().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-1.71f,53.72f,-0.6127f}).setLlimit(new MFFloat717().getArray()).setUlimit(new MFFloat718().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_sternoclavicular").setDEF("hanim_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-5.464f,52.97f,-0.5732f}).setLlimit(new MFFloat723().getArray()).setUlimit(new MFFloat724().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_acromioclavicular").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-7.32f,52.38f,-0.1452f}).setLlimit(new MFFloat729().getArray()).setUlimit(new MFFloat730().getArray())

      ...
      .setScene(new Scene()
              ...
              .addChild(new Shape("TR")
                .setAppearance(new Appearance()
                  ...
                  .addShaders(new ComposedShader().setDEF("Cobweb").setLanguage("GLSL")
                    .addField(new field("Cobweb").setType("SFVec3f").setName("decis").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue("0.95 0.77 0.44"))
                    .addParts(new ShaderPart("Cobweb").setType("VERTEX"))
                    .addParts(new ShaderPart("Cobweb").setType("FRAGMENT").setDEF("_1"))))
        ...
        .addChild(new WorldInfo().setTitle("SimpleShader")
          .setMetadata(new MetadataSet().setName("Titania").setDEF("Titania").setReference("http://titania.create3000.de")
            .setMetadata(new MetadataSet("Titania").setName("Selection").setDEF("Selection").setReference("http://titania.create3000.de")
              .setMetadata(new MetadataSet("Selection").setName("nodes").setDEF("nodes").setReference("http://titania.create3000.de")
                .addComments("NULL")))
            .setMetadata(new MetadataSet("Titania").setName("NavigationInfo").setDEF("NavigationInfo").setReference("http://titania.create3000.de")
              .setMetadata(new MetadataString("NavigationInfo").setName("type").setDEF("type").setReference("http://titania.create3000.de").setValue(new MFString0().getArray())))
            .setMetadata(new MetadataSet("Titania").setName("Viewpoint").setDEF("Viewpoint").setReference("http://titania.create3000.de")
              .addValue(new MetadataDouble("Viewpoint").setName("position").setDEF("position").setReference("http://titania.create3000.de").setValue(new MFDouble1().getArray()))
              .addValue(new MetadataDouble("Viewpoint").setName("orientation").setDEF("orientation").setReference("http://titania.create3000.de").setValue(new MFDouble2().getArray()))
              .addValue(new MetadataDouble("Viewpoint").setName("centerOfRotation").setDEF("centerOfRotation").setReference("http://titania.create3000.de").setValue(new MFDouble3().getArray())))))

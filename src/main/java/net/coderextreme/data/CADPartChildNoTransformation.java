          ...
          .addChild(new CADPart().setName("CADPartExample")
            ...
            .addChild(new CADFace().setName("outerSurface")
              .setShape(new Shape()
                ...
                .setGeometry(new Cylinder().setBottom(false).setHeight(3.0000f).setRadius(2.0000f).setTop(false))
            ...
            .addChild(new CADFace().setName("innerSurface")
              .setShape(new Shape()
                ...
                .setGeometry(new Cylinder().setBottom(false).setHeight(3.0000f).setSolid(false).setTop(false))
...
protected class MFColor0 {
  protected org.web3d.x3d.jsail.fields.MFColor getArray() {
    return new org.web3d.x3d.jsail.fields.MFColor(new float[] {0.9608f,1.0000f,0.9608f});
  }
}
...
protected class MFVec3f2 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {2.0000f,1.5000f,0.0000f,1.0000f,1.5000f,0.0000f,1.9616f,1.5000f,0.3902f,0.9808f,1.5000f,0.1951f,1.8478f,1.5000f,0.7654f,0.9239f,1.5000f,0.3827f,1.6629f,1.5000f,1.1111f,0.8315f,1.5000f,0.5556f,1.4142f,1.5000f,1.4142f,0.7071f,1.5000f,0.7071f,1.1111f,1.5000f,1.6629f,0.5556f,1.5000f,0.8315f,0.7654f,1.5000f,1.8478f,0.3827f,1.5000f,0.9239f,0.3902f,1.5000f,1.9616f,0.1951f,1.5000f,0.9808f,0.0000f,1.5000f,2.0000f,0.0000f,1.5000f,1.0000f,-0.3902f,1.5000f,1.9616f,-0.1951f,1.5000f,0.9808f,-0.7654f,1.5000f,1.8478f,-0.3827f,1.5000f,0.9239f,-1.1111f,1.5000f,1.6629f,-0.5556f,1.5000f,0.8315f,-1.4142f,1.5000f,1.4142f,-0.7071f,1.5000f,0.7071f,-1.6629f,1.5000f,1.1111f,-0.8315f,1.5000f,0.5556f,-1.8478f,1.5000f,0.7654f,-0.9239f,1.5000f,0.3827f,-1.9616f,1.5000f,0.3902f,-0.9808f,1.5000f,0.1951f,-2.0000f,1.5000f,0.0000f,-1.0000f,1.5000f,0.0000f,-1.9616f,1.5000f,-0.3902f,-0.9808f,1.5000f,-0.1951f,-1.8478f,1.5000f,-0.7654f,-0.9239f,1.5000f,-0.3827f,-1.6629f,1.5000f,-1.1111f,-0.8315f,1.5000f,-0.5556f,-1.4142f,1.5000f,-1.4142f,-0.7071f,1.5000f,-0.7071f,-1.1111f,1.5000f,-1.6629f,-0.5556f,1.5000f,-0.8315f,-0.7654f,1.5000f,-1.8478f,-0.3827f,1.5000f,-0.9239f,-0.3902f,1.5000f,-1.9616f,-0.1951f,1.5000f,-0.9808f,0.0000f,1.5000f,-2.0000f,0.0000f,1.5000f,-1.0000f,0.3902f,1.5000f,-1.9616f,0.1951f,1.5000f,-0.9808f,0.7654f,1.5000f,-1.8478f,0.3827f,1.5000f,-0.9239f,1.1111f,1.5000f,-1.6629f,0.5556f,1.5000f,-0.8315f,1.4142f,1.5000f,-1.4142f,0.7071f,1.5000f,-0.7071f,1.6629f,1.5000f,-1.1111f,0.8315f,1.5000f,-0.5556f,1.8478f,1.5000f,-0.7654f,0.9239f,1.5000f,-0.3827f,1.9616f,1.5000f,-0.3902f,0.9808f,1.5000f,-0.1951f,2.0000f,1.5000f,0.0000f,1.0000f,1.5000f,0.0000f});
  }
}

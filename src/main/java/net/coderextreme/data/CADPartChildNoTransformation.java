...
public class CADPartChildNoTransformation implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/CADPartChildNoTransformation.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      X3D X3D0 =  new X3D().setProfile(new SFString("CADInterchange")).setVersion(new SFString("4.0"))
      .setHead(new head()
        .addComponent(new component().setName(new SFString("CADGeometry")).setLevel(2))
        .addComponent(new component().setName(new SFString("EnvironmentalEffects")).setLevel(1))
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("CADPartChildNoTransformation.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("Developer scene to explore Mantis Issue 528, providing a baseline example with no transformation of CADPart children.")))
        .addMeta(new meta().setName(new SFString("creator")).setContent(new SFString("Vince Marchetti, Don Brutzman, Hyokwang Lee, Dick Puk")))
        .addMeta(new meta().setName(new SFString("translator")).setContent(new SFString("Vince Marchetti bushing generation using python scripts")))
        .addMeta(new meta().setName(new SFString("reference")).setContent(new SFString("https://www.web3d.org/member-only/mantis/view.php?id=528")))
        .addMeta(new meta().setName(new SFString("warning")).setContent(new SFString("This scene is intended for specification development only.")))
        .addMeta(new meta().setName(new SFString("created")).setContent(new SFString("29 June 2012")))
        .addMeta(new meta().setName(new SFString("modified")).setContent(new SFString("20 October 2019")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/Basic/CAD/CADPartChildNoTransformation.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("CADPartChildNoTransformation.x3d")))
        .addChild(new Background().setSkyColor(new MFColor0().getArray()))
        .addChild(new Viewpoint().setDescription(new SFString("Hello CAD bushing")).setOrientation(new float[] {1f ,0f ,0f ,-0.321751f }).setPosition(new float[] {0f ,5f ,15f }))
        .addChild(new CADAssembly().setName(new SFString("DesignPatternAssembly"))
          .addChild(new CADPart().setName(new SFString("CADPartExample"))
            .addComments(new CommentsBlock("the rotation and translation attributes serve to position the bushing within the assembly"))
            .addChild(new CADFace().setName(new SFString("outerSurface"))
              .setShape(new Shape()
                ...
                .setAppearance(new Appearance().setDEF(new SFString("AppearanceGrey"))
                  .setMaterial(new Material()))))
            .addChild(new CADFace().setName(new SFString("innerSurface"))
              .setShape(new Shape()
                ...
                .setAppearance(new Appearance().setUSE(new SFString("AppearanceGrey")))))
            .addChild(new CADFace().setName(new SFString("topCap"))
              .setShape(new Shape()
                .setGeometry(new IndexedTriangleSet().setIndex(new MFInt321().getArray())
                  .setCoord(new Coordinate().setPoint(new MFVec3f2().getArray())))
                .setAppearance(new Appearance().setUSE(new SFString("AppearanceGrey")))))
            .addChild(new CADFace().setName(new SFString("bottomCap"))
              .setShape(new Shape()

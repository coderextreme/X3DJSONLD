    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
          ...
          .addChild(new Shape("transform")
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setDEF("shader").setLanguage("GLSL")
                ...
                .addField(new field("shader").setType("SFVec3f").setName("chromaticDispertion").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.98 1 1.033"))
                ...
                .addParts(new ShaderPart("shader").setType("VERTEX").setUrl(new MFString12().getArray()))
                .addParts(new ShaderPart("shader").setType("FRAGMENT").setUrl(new MFString13().getArray()))))
            .addComments("<Sphere>")
        ...
        .addChild(new Script().setDEF("OrbitScript")
          ...
          .addField(new field("OrbitScript").setType("MFVec3f").setName("coordinates").setAccessType(field.ACCESSTYPE_INPUTOUTPUT))

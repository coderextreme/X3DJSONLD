...
public class ballx3dom implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/ballx3dom.new.java.x3d");
    model.toFileJSON("../data/ballx3dom.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("ballx3dom.x3d")))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription(new SFString("Tour Views")))

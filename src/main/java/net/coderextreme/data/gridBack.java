    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        .addChild(new Shape()
          ...
          .setGeometry(new IndexedFaceSet().setColorPerVertex(false).setNormalPerVertex(false).setColorIndex(new MFInt320().getArray()).setCoordIndex(new MFInt321().getArray())

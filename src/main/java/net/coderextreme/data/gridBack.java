...
public class gridBack implements X3DRoots {
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("gridBack.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("Checkerboard grid background for X3D/VRML materials selection.")))
        ...
        .addMeta(new meta().setName(new SFString("created")).setContent(new SFString("8 April 2002")))
        .addMeta(new meta().setName(new SFString("modified")).setContent(new SFString("12 January 2014")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.json")))

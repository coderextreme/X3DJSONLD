...
public class plainflowers {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/plainflowers.new.json");
    }
...
ProtoInstance ProtoInstance6 = null;
      ...
      .setScene(new Scene()
        .addChild(new ExternProtoDeclare().setName("FlowerProto").setUrl(new MFString0().getArray())
          .addField(new field().setType("MFString").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("vertex"))
          .addField(new field().setType("MFString").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("fragment")))
        ...
        .addChild(new Background().setFrontUrl(new MFString1().getArray()).setBackUrl(new MFString2().getArray()).setLeftUrl(new MFString3().getArray()).setRightUrl(new MFString4().getArray()).setTopUrl(new MFString5().getArray()).setBottomUrl(new MFString6().getArray()))
        .addChild(new Group()

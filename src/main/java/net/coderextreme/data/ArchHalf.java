      ...
      .setScene(new Scene()
        ...
        .addChild(new Shape().setDEF("Arch")
          ...
          .setAppearance(new Appearance()
            .setMaterial(new Material().setDEF("MaterialNode").setDiffuseColor(new double[] {1f,0.75f,0.25f})))));
    return X3D0;
    }

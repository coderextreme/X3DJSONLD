  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setContent("16 February 2016").setName("modified"))
        ...
        .addMeta(new metaObject().setContent("http://X3dGraphics.com/examples/X3dForAdvancedModeling/Buildings/ArchHalf.x3d").setName("identifier"))
      ...
      .setScene(new SceneObject()
        .addChild(new ShapeObject().setDEF("Arch")
          ...
          .setGeometry(new IndexedFaceSetObject().setDEF("ArchIndex").setConvex(false).setCoordIndex(new MFInt32Object(new MFInt320().getArray())).setCreaseAngle(0f).setSolid(false)

    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Chul").setDEF("hanim_Chul").setScale(new float[] {0.0225f,0.0225f,0.0225f}).setVersion("2.0")
          ...
          .setMetadata(new MetadataSet("hanim_Chul").setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
          ...
          .addSkeleton(new HAnimJoint("hanim_Chul").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f,44.07f,-1.034f}).setUlimit(new MFFloat6().getArray()).setLlimit(new MFFloat7().getArray())
            .addChild(new HAnimSegment("hanim_humanoid_root").setName("sacrum").setDEF("hanim_sacrum")
              .addChild(new Transform("hanim_sacrum").setTranslation(new float[] {0f,44.07f,-1.034f})
                .addChild(new Shape()
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {4.001f,41.139999f,-1.119f}).setUlimit(new MFFloat13().getArray()).setLlimit(new MFFloat14().getArray())
              .addChild(new HAnimSegment("hanim_l_hip").setName("l_thigh").setDEF("hanim_l_thigh")
                .addChild(new Transform("hanim_l_thigh").setTranslation(new float[] {4.001f,41.139999f,-1.119f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
              ...
              .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {4.315f,25.190001f,-1.119f}).setUlimit(new MFFloat19().getArray()).setLlimit(new MFFloat20().getArray())
                .addChild(new HAnimSegment("hanim_l_knee").setName("l_calf").setDEF("hanim_l_calf")
                  .addChild(new Transform("hanim_l_calf").setTranslation(new float[] {4.315f,25.190001f,-1.119f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new float[] {4.574f,6.838f,-1.463f}).setUlimit(new MFFloat25().getArray()).setLlimit(new MFFloat26().getArray())
                  .addChild(new HAnimSegment("hanim_l_talocrural").setName("l_talus").setDEF("hanim_l_talus")
                    .addChild(new Transform("hanim_l_talus").setTranslation(new float[] {4.574f,6.838f,-1.463f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new float[] {4.809f,5.583f,1.492f}).setUlimit(new MFFloat31().getArray()).setLlimit(new MFFloat32().getArray())
                    .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_2").setName("l_tarsal_proximal_phalanx_2").setDEF("hanim_l_tarsal_proximal_phalanx_2")
                      .addChild(new Transform("hanim_l_tarsal_proximal_phalanx_2").setTranslation(new float[] {4.809f,5.583f,1.492f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-4.001f,41.139999f,-1.119f}).setUlimit(new MFFloat37().getArray()).setLlimit(new MFFloat38().getArray())
              .addChild(new HAnimSegment("hanim_r_hip").setName("r_thigh").setDEF("hanim_r_thigh")
                .addChild(new Transform("hanim_r_thigh").setTranslation(new float[] {-4.001f,41.139999f,-1.119f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-4.315f,25.190001f,-1.119f}).setUlimit(new MFFloat43().getArray()).setLlimit(new MFFloat44().getArray())
                .addChild(new HAnimSegment("hanim_r_knee").setName("r_calf").setDEF("hanim_r_calf")
                  .addChild(new Transform("hanim_r_calf").setTranslation(new float[] {-4.315f,25.190001f,-1.119f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-4.574f,6.838f,-1.463f}).setUlimit(new MFFloat49().getArray()).setLlimit(new MFFloat50().getArray())
                  .addChild(new HAnimSegment("hanim_r_talocrural").setName("r_talus").setDEF("hanim_r_talus")
                    .addChild(new Transform("hanim_r_talus").setTranslation(new float[] {-4.574f,6.838f,-1.463f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
                  ...
                  .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new float[] {-4.809f,5.583f,1.492f}).setUlimit(new MFFloat55().getArray()).setLlimit(new MFFloat56().getArray())
                    .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_2").setName("r_tarsal_proximal_phalanx_2").setDEF("hanim_r_tarsal_proximal_phalanx_2")
                      .addChild(new Transform("hanim_r_tarsal_proximal_phalanx_2").setTranslation(new float[] {-4.809f,5.583f,1.492f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new float[] {0f,38.639999f,-1.034f}).setUlimit(new MFFloat61().getArray()).setLlimit(new MFFloat62().getArray())
              .addChild(new HAnimSegment("hanim_sacroiliac").setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new Transform("hanim_pelvis").setTranslation(new float[] {0f,38.639999f,-1.034f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {7.699f,59.419998f,-1.567f}).setUlimit(new MFFloat67().getArray()).setLlimit(new MFFloat68().getArray())
                .addChild(new HAnimSegment("hanim_l_shoulder").setName("l_upperarm").setDEF("hanim_l_upperarm")
                  .addChild(new Transform("hanim_l_upperarm").setTranslation(new float[] {7.699f,59.419998f,-1.567f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {8.026f,48.450001f,-1.959f}).setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                  .addChild(new HAnimSegment("hanim_l_elbow").setName("l_forearm").setDEF("hanim_l_forearm")
                    .addChild(new Transform("hanim_l_forearm").setTranslation(new float[] {8.026f,48.450001f,-1.959f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {7.617f,37.689999f,-1.663f}).setUlimit(new MFFloat79().getArray()).setLlimit(new MFFloat80().getArray())
                    .addChild(new HAnimSegment("hanim_l_radiocarpal").setName("l_carpal").setDEF("hanim_l_carpal")
                      .addChild(new Transform("hanim_l_carpal").setTranslation(new float[] {7.617f,37.689999f,-1.663f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-7.699f,59.419998f,-1.567f}).setUlimit(new MFFloat85().getArray()).setLlimit(new MFFloat86().getArray())
                .addChild(new HAnimSegment("hanim_r_shoulder").setName("r_upperarm").setDEF("hanim_r_upperarm")
                  .addChild(new Transform("hanim_r_upperarm").setTranslation(new float[] {-7.699f,59.419998f,-1.567f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-8.026f,48.450001f,-1.959f}).setUlimit(new MFFloat91().getArray()).setLlimit(new MFFloat92().getArray())
                  .addChild(new HAnimSegment("hanim_r_elbow").setName("r_forearm").setDEF("hanim_r_forearm")
                    .addChild(new Transform("hanim_r_forearm").setTranslation(new float[] {-8.026f,48.450001f,-1.959f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
                  ...
                  .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-7.617f,37.689999f,-1.663f}).setUlimit(new MFFloat97().getArray()).setLlimit(new MFFloat98().getArray())
                    .addChild(new HAnimSegment("hanim_r_radiocarpal").setName("r_carpal").setDEF("hanim_r_carpal")
                      .addChild(new Transform("hanim_r_carpal").setTranslation(new float[] {-7.617f,37.689999f,-1.663f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f,47.330002f,-0.5744f}).setUlimit(new MFFloat103().getArray()).setLlimit(new MFFloat104().getArray())
                .addChild(new HAnimSegment("hanim_vl5").setName("l5").setDEF("hanim_l5")
                  .addChild(new Transform("hanim_l5").setTranslation(new float[] {0f,47.330002f,-0.5744f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f,65.510002f,-1.446f}).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())
                  .addChild(new HAnimSegment("hanim_skullbase").setName("skull").setDEF("hanim_skull")
                    .addChild(new Transform("hanim_skull").setTranslation(new float[] {0f,65.510002f,-1.446f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("ChulTextureAtlas")))
          ...
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_humanoid_root"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_sacroiliac"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_skullbase"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_vl5"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_l_elbow"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_r_elbow"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_l_hip"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_r_hip"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_l_knee"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_r_knee"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_l_metatarsophalangeal_2"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_r_metatarsophalangeal_2"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_l_radiocarpal"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_r_radiocarpal"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_l_shoulder"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_r_shoulder"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_l_talocrural"))
          .addJoints(new HAnimJoint("hanim_Chul").setUSE("hanim_r_talocrural"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_l5"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_pelvis"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_sacrum"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_skull"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_l_calf"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_r_calf"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_l_carpal"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_r_carpal"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_l_forearm"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_r_forearm"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_l_talus"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_r_talus"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_l_tarsal_proximal_phalanx_2"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_r_tarsal_proximal_phalanx_2"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_l_thigh"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_r_thigh"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_l_upperarm"))
          .addSegments(new HAnimSegment("hanim_Chul").setUSE("hanim_r_upperarm"))))      ;
    return X3D0;
    }

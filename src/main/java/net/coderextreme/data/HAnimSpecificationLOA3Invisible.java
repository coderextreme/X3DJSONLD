...
public class HAnimSpecificationLOA3Invisible {
  public static void main(String[] args) {
    ...
    new HAnimSpecificationLOA3Invisible().initialize().toFileJSON("../data/HAnimSpecificationLOA3Invisible.new.json");
    }
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/HAnimSpecificationLOA3Invisible.x3d"))

...
public class sphereflowers implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/sphereflowers.new.java.x3d");
    model.toFileJSON("../data/sphereflowers.new.java.x3dj");
    }
...
ProtoInstance ProtoInstance6 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("sphereflowers.x3d")))
        .addMeta(new meta().setName(new SFString("creator")).setContent(new SFString("John Carlson")))
        .addMeta(new meta().setName(new SFString("created")).setContent(new SFString("Jan 17 2022")))
        .addMeta(new meta().setName(new SFString("modified")).setContent(new SFString("Sep 3 2023")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/sphereflowers.x3d"))))
      .setScene(new Scene()
        ...
        .addChild(new Group()
          ...
          .addChild(new TimeSensor().setDEF(new SFString("SongTime")).setLoop(true))
          .addChild(new Sound().setMaxBack(100f ).setMaxFront(100f ).setMinBack(20f ).setMinFront(20f ).setLocation(new float[] {0f ,1f ,0f })
            .setSource(new AudioClip().setDEF(new SFString("AudioClip")).setDescription(new SFString("Chandubabamusic #1")).setUrl(new MFString7().getArray())))
          .addChild(new ROUTE().setFromField(new SFString("cycleTime")).setFromNode(new SFString("SongTime")).setToField(new SFString("startTime")).setToNode(new SFString("AudioClip")))));
ProtoInstance0
                  .addFieldValue(new fieldValue().setName(new SFString("vertex")).setValue(new SFString("\"../shaders/x_ite_flowers_chromatic.vs\"")));
ProtoInstance0
                  .addFieldValue(new fieldValue().setName(new SFString("fragment")).setValue(new SFString("\"../shaders/x_ite.fs\"")));
    return X3D0;
    }
...
private class MFString6 {
  private org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"../data/flowerproto.x3d#FlowerProto","https://coderextreme.net/X3DJSONLD/src/main/data/flowerproto.x3d#FlowerProto"});
  }
}

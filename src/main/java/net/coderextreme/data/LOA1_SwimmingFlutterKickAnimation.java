...
public class LOA1_SwimmingFlutterKickAnimation implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/LOA1_SwimmingFlutterKickAnimation.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("LOA1_SwimmingFlutterKickAnimation.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("created")).setContent(new SFString("13 December 2001")))
        .addMeta(new meta().setName(new SFString("modified")).setContent(new SFString("23 May 2020")))
        .addMeta(new meta().setName(new SFString("warning")).setContent(new SFString("not yet tested, need to compare with NancyDivingExample interpolators")))
        ...
        .addMeta(new meta().setName(new SFString("subject")).setContent(new SFString("Swimming flutter kick Animation HAnim 2001")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/LOA1_SwimmingFlutterKickAnimation.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("LOA1_SwimmingFlutterKickAnimation.x3d")))
        .addChild(new ProtoDeclare().setName(new SFString("LOA1_DivingAnimation"))
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("SFTime").setName(new SFString("cycleInterval")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFString("7")))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              ...
              .addChild(new OrientationInterpolator().setDEF(new SFString("SKULLBASE_ANIMATOR")).setKey(new MFFloat18().getArray()).setKeyValue(new MFRotation19().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("skullbase_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("L_SHOULDER_ANIMATOR")).setKey(new MFFloat20().getArray()).setKeyValue(new MFRotation21().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("l_shoulder_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("L_ELBOW_ANIMATOR")).setKey(new MFFloat22().getArray()).setKeyValue(new MFRotation23().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("l_elbow_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("L_WRIST_ANIMATOR")).setKey(new MFFloat24().getArray()).setKeyValue(new MFRotation25().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("l_wrist_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("R_SHOULDER_ANIMATOR")).setKey(new MFFloat26().getArray()).setKeyValue(new MFRotation27().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("r_shoulder_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("R_ELBOW_ANIMATOR")).setKey(new MFFloat28().getArray()).setKeyValue(new MFRotation29().getArray())
                .setIS(new IS()
                  .addConnect(new connect().setNodeField(new SFString("value_changed")).setProtoField(new SFString("r_elbow_rotation_changed")))))
              .addChild(new OrientationInterpolator().setDEF(new SFString("R_WRIST_ANIMATOR")).setKey(new MFFloat30().getArray()).setKeyValue(new MFRotation31().getArray())
                .setIS(new IS()
        ...
        .addChild(new Viewpoint().setDescription(new SFString("LOA1_SwimmingFlutterKickAnimation scene")).setPosition(new float[] {0f ,0f ,12f }))
        .addChild(new Anchor().setDescription(new SFString("Nancy Diving")).setParameter(new MFString32().getArray()).setUrl(new MFString33().getArray())
          .addChild(new Shape()
            .setGeometry(new Text().setString(new MFString34().getArray())
              .setFontStyle(new FontStyle().setJustify(new MFString35().getArray()).setSize(0.8f )))

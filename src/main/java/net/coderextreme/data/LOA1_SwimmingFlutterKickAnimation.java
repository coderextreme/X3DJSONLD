...
public class LOA1_SwimmingFlutterKickAnimation {
  public static void main(String[] args) {
    ...
    new LOA1_SwimmingFlutterKickAnimation().initialize().toFileJSON("../data/LOA1_SwimmingFlutterKickAnimation.new.json");
    }
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new ProtoDeclare().setName("LOA1_DivingAnimation")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              ...
              .addChild(new OrientationInterpolator().setDEF("SKULLBASE_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat18().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation19().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("skullbase_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("L_SHOULDER_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat20().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation21().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("l_shoulder_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("L_ELBOW_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat22().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation23().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("l_elbow_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("L_WRIST_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat24().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation25().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("l_wrist_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("R_SHOULDER_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat26().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation27().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("r_shoulder_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("R_ELBOW_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat28().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation29().getArray()))
                .setIS(new IS()
                  .addConnect(new connect().setNodeField("value_changed").setProtoField("r_elbow_rotation_changed"))))
              .addChild(new OrientationInterpolator().setDEF("R_WRIST_ANIMATOR").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat30().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation31().getArray()))
                .setIS(new IS()
        ...
        .addChild(new Anchor().setDescription("Nancy Diving").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString32().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString33().getArray()))
          .addChild(new Shape()
            .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString34().getArray()))
              .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString35().getArray())).setSize(0.8f)))

      ...
      .setScene(new Scene()
        .addChild(new ProtoDeclare().setName("LOA1_DivingAnimation")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("SFTime").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("cycleInterval").setValue("7"))
        ...
        .addChild(new Anchor().setDescription("Nancy Diving").setUrl(new MFString32().getArray()).setParameter(new MFString33().getArray())
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,0.2f})))
            .setGeometry(new Text().setString(new MFString34().getArray())
              .setFontStyle(new FontStyle().setSize(0.8f).setJustify(new MFString35().getArray()))))))      ;
    return X3D0;
    }

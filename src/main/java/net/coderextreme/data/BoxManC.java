      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Humanoid").setDEF("HUMANOID").setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())).setVersion("2.0")
          .addJoints(new HAnimJoint().setName("HumanoidRoot").setDEF("hanim_HumanoidRoot").setCenter(new float[] {0f,0.9723f,-0.0728f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt324().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat5().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .addChild(new HAnimJoint().setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {0.0956f,0.9364f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt326().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat7().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new HAnimSegment().setName("l_thigh").setDEF("hanim_l_thigh")
                ...
                .addChild(new Transform().setTranslation(new float[] {0.0956f,0.9346f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint().setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt328().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat9().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new HAnimSegment().setName("l_calf").setDEF("hanim_l_calf")
                  .addChild(new Transform().setTranslation(new float[] {0.0956f,0.5095f,-0.0036f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("l_ankle").setDEF("hanim_l_ankle").setCenter(new float[] {0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3210().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat11().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new HAnimSegment().setName("l_hindfoot").setDEF("hanim_l_hindfoot")
                    .addChild(new Transform().setTranslation(new float[] {0.0946f,0.0762f,-0.0261f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("l_midtarsal").setDEF("hanim_l_midtarsal").setCenter(new float[] {0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3212().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat13().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new HAnimSegment().setName("l_middistal").setDEF("hanim_l_middistal")
                      .addChild(new Transform().setTranslation(new float[] {0.1079f,0.0317f,0.067f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new Shape().setUSE("SphereYellow")))
                      .addChild(new HAnimSite().setName("l_middle_distal_tip").setDEF("hanim_l_middle_distal_tip").setTranslation(new float[] {0.095f,0.0005f,0.1924f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                      .addChild(new Transform().setTranslation(new float[] {0.095f,0.0005f,0.1924f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new Shape().setDEF("SphereRed").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                          ...
                          .setGeometry(new Sphere().setRadius(0.02f)))))))))
            .addChild(new HAnimJoint().setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-0.0956f,0.9364f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3214().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat15().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new HAnimSegment().setName("r_thigh").setDEF("hanim_r_thigh")
                .addComments(new CommentsBlock("TODO reconcile z-coordinate mismatch using source anthropometry"))
                .addChild(new Transform().setTranslation(new float[] {-0.0956f,0.9346f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint().setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3216().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat17().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new HAnimSegment().setName("r_calf").setDEF("hanim_r_calf")
                  .addChild(new Transform().setTranslation(new float[] {-0.0956f,0.5095f,-0.0036f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("r_ankle").setDEF("hanim_r_ankle").setCenter(new float[] {-0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3218().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat19().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new HAnimSegment().setName("r_hindfoot").setDEF("hanim_r_hindfoot")
                    .addChild(new Transform().setTranslation(new float[] {-0.0946f,0.0762f,-0.0261f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("r_midtarsal").setDEF("hanim_r_midtarsal").setCenter(new float[] {-0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3220().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat21().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new HAnimSegment().setName("r_middistal").setDEF("hanim_r_middistal")
                      .addChild(new Transform().setTranslation(new float[] {-0.1079f,0.0317f,0.067f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new Shape().setUSE("SphereYellow")))
                      .addChild(new HAnimSite().setName("r_middle_distal_tip").setDEF("hanim_r_middle_distal_tip").setTranslation(new float[] {-0.095f,0.0005f,0.1924f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                      .addChild(new Transform().setTranslation(new float[] {-0.095f,0.0005f,0.1924f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new Shape().setUSE("SphereRed"))))))))
            .addChild(new HAnimJoint().setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f,1.0817f,-0.0728f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3222().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat23().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              ...
              .addChild(new HAnimJoint().setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f,1.644f,0.036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3224().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat25().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                ...
                .addChild(new HAnimSegment().setName("skull").setDEF("hanim_skull")
                  .addComments(new CommentsBlock("TODO reconcile z-coordinate mismatch using source anthropometry"))
                  .addChild(new Transform().setTranslation(new float[] {0f,1.644f,0.0036f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new Shape().setUSE("SphereYellow")))
                  .addChild(new HAnimSite().setName("skull_tip").setDEF("hanim_skull_tip").setTranslation(new float[] {-0.0029f,1.7771f,0.0274f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                  .addChild(new Transform().setTranslation(new float[] {-0.0029f,1.7771f,0.0274f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new Shape().setUSE("SphereYellow")))))
              .addChild(new HAnimJoint().setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3228().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat29().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new HAnimSegment().setName("l_upperarm").setDEF("hanim_l_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {0.1968f,1.4642f,-0.0265f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3230().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat31().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new HAnimSegment().setName("l_forearm").setDEF("hanim_l_forearm")
                    .addChild(new Transform().setTranslation(new float[] {0.1982f,1.1622f,-0.0557f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("l_wrist").setDEF("hanim_l_wrist").setCenter(new float[] {0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3232().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat33().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new HAnimSegment().setName("l_hand").setDEF("hanim_l_hand")
                      .addChild(new Transform().setTranslation(new float[] {0.1972f,0.8929f,-0.069f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new Shape().setUSE("SphereYellow")))
                      .addChild(new HAnimSite().setName("l_hand_tip").setDEF("hanim_l_hand_tip").setTranslation(new float[] {0.1912f,0.6976f,-0.071f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                      .addChild(new Transform().setTranslation(new float[] {0.1912f,0.6976f,-0.071f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new Shape().setUSE("SphereRed")))))))
              .addChild(new HAnimJoint().setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3234().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat35().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new HAnimSegment().setName("r_upperarm").setDEF("hanim_r_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {-0.1968f,1.4642f,-0.0265f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint().setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3236().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat37().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new HAnimSegment().setName("r_forearm").setDEF("hanim_r_forearm")
                    .addChild(new Transform().setTranslation(new float[] {-0.1982f,1.1622f,-0.0557f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint().setName("r_wrist").setDEF("hanim_r_wrist").setCenter(new float[] {-0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3238().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat39().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new HAnimSegment().setName("r_hand").setDEF("hanim_r_hand")
                      .addChild(new Transform().setTranslation(new float[] {-0.1972f,0.8929f,-0.069f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new Shape().setUSE("SphereYellow")))
                      .addChild(new HAnimSite().setName("r_hand_tip").setDEF("hanim_r_hand_tip").setTranslation(new float[] {-0.1912f,0.6976f,-0.071f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                      .addChild(new Transform().setTranslation(new float[] {-0.1912f,0.6976f,-0.071f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new Shape().setUSE("SphereRed")))))))))

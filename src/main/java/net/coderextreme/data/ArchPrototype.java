      ...
      .setScene(new Scene()
        .addChild(new ProtoDeclare().setName("ArchPrototype")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("SFColor").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("diffuseColor").setValue("0.2 0.8 0.8"))
            .addField(new field().setType("SFColor").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setName("emissiveColor").setValue("0.2 0.8 0.8"))
            .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("clearSpanWidth").setValue("4"))
            .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("riseHeight").setValue("2"))
            .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("depth").setValue("3"))
            .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("topAbutmentHeight").setValue("0.5"))
            .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("pierWidth").setValue("0.5"))
            .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("pierHeight").setValue("1"))
            .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("archHalf"))
            .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("archHalfExtensionWidth"))
            .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("onlyIntrados"))
            .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("archFilled"))
            .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("archHalfFilled"))
            .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("lintel")))
          .setProtoBody(new ProtoBody()
            ...
            .addChild(new Script().setDEF("ArchPrototypeScript").setUrl(new MFString0().getArray())
              .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("clearSpanWidth"))
              .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("riseHeight"))
              .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("depth"))
              .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("topAbutmentHeight"))
              .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("pierWidth"))
              .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("pierHeight"))
              .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("archHalf"))
              .addField(new field().setType("SFFloat").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("archHalfExtensionWidth"))
              .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("onlyIntrados"))
              .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("archFilled"))
              .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("archHalfFilled"))
              .addField(new field().setType("SFBool").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setName("lintel"))
              .addField(new field().setType("SFVec3f").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setName("computedScale"))
              .addField(new field().setType("MFVec3f").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setName("pointOut"))
              .addField(new field().setType("MFInt32").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setName("indexOut"))
              .setIS(new IS()
        ...
        .addChild(new Inline().setDEF("CoordinateAxes").setGlobal(true).setUrl(new MFString1().getArray())))      ;
ProtoInstance0

...
public class mirror implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/mirror.new.java.x3d");
    model.toFileJSON("../data/mirror.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("mirror.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/mirror.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("sphere with alternating backgrounds"))))
      .setScene(new Scene()
        .addChild(new Viewpoint().setPosition(new float[] {0f ,5f ,100f }).setDescription(new SFString("Switch background and images texture")))
        .addChild(new TextureBackground()
          .setLeftTexture(new ImageTexture().setDEF(new SFString("leftBackgroundTexture")).setUrl(new MFString0().getArray()))
          .setRightTexture(new ImageTexture().setDEF(new SFString("rightBackgroundTexture")).setUrl(new MFString1().getArray()))
          .setFrontTexture(new ImageTexture().setDEF(new SFString("frontBackgroundTexture")).setUrl(new MFString2().getArray()))
          .setBackTexture(new ImageTexture().setDEF(new SFString("backBackgroundTexture")).setUrl(new MFString3().getArray()))
          .setTopTexture(new ImageTexture().setDEF(new SFString("topBackgroundTexture")).setUrl(new MFString4().getArray()))
          .setBottomTexture(new ImageTexture().setDEF(new SFString("bottomBackgroundTexture")).setUrl(new MFString5().getArray())))
        .addChild(new Transform()
          ...
          .addChild(new Script().setDEF(new SFString("UrlSelector")).setDirectOutput(true)
            ...
            .addField(new field().setType("MFString").setName(new SFString("front_changed")).setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field().setType("MFString").setName(new SFString("back_changed")).setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field().setType("MFString").setName(new SFString("left_changed")).setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field().setType("MFString").setName(new SFString("right_changed")).setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field().setType("MFString").setName(new SFString("top_changed")).setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field().setType("MFString").setName(new SFString("bottom_changed")).setAccessType(field.ACCESSTYPE_OUTPUTONLY))
...
"            }\n"+
"        }"))
          .addChild(new TimeSensor().setDEF(new SFString("Clock")).setCycleInterval(45d).setLoop(true))
          .addChild(new ROUTE().setFromNode(new SFString("Clock")).setFromField(new SFString("fraction_changed")).setToNode(new SFString("UrlSelector")).setToField(new SFString("set_fraction")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("front_changed")).setToNode(new SFString("frontBackgroundTexture")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("back_changed")).setToNode(new SFString("backBackgroundTexture")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("left_changed")).setToNode(new SFString("leftBackgroundTexture")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("right_changed")).setToNode(new SFString("rightBackgroundTexture")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("top_changed")).setToNode(new SFString("topBackgroundTexture")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("bottom_changed")).setToNode(new SFString("bottomBackgroundTexture")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("front_changed")).setToNode(new SFString("frontShader")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("back_changed")).setToNode(new SFString("backShader")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("left_changed")).setToNode(new SFString("leftShader")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("right_changed")).setToNode(new SFString("rightShader")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("top_changed")).setToNode(new SFString("topShader")).setToField(new SFString("url")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("bottom_changed")).setToNode(new SFString("bottomShader")).setToField(new SFString("url")))));
    return X3D0;
    }

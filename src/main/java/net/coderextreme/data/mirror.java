    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new TextureBackground()
          .setLeft(new ImageTexture().setDEF("leftBack").setUrl(new MFString0().getArray()))
          .setRight(new ImageTexture().setDEF("rightBack").setUrl(new MFString1().getArray()))
          .setFront(new ImageTexture().setDEF("frontBack").setUrl(new MFString2().getArray()))
          .setBack(new ImageTexture().setDEF("backBack").setUrl(new MFString3().getArray()))
          .setTop(new ImageTexture().setDEF("topBack").setUrl(new MFString4().getArray()))
          .setBottom(new ImageTexture().setDEF("bottomBack").setUrl(new MFString5().getArray())))
          ...
          .addChild(new Shape()
            .setAppearance(new Appearance()
              ...
              .setTexture(new ComposedCubeMapTexture()
                .setBack(new ImageTexture().setDEF("backShader").setUrl(new MFString6().getArray()))
                .setBottom(new ImageTexture().setDEF("bottomShader").setUrl(new MFString7().getArray()))
                .setFront(new ImageTexture().setDEF("frontShader").setUrl(new MFString8().getArray()))
                .setLeft(new ImageTexture().setDEF("leftShader").setUrl(new MFString9().getArray()))
                .setRight(new ImageTexture().setDEF("rightShader").setUrl(new MFString10().getArray()))
                .setTop(new ImageTexture().setDEF("topShader").setUrl(new MFString11().getArray())))

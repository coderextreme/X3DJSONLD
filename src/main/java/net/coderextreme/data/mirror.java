    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new TextureBackground()
          .setLeftTexture(new ImageTexture().setDEF("leftBackTexture").setUrl(new MFString0().getArray()))
          .setRightTexture(new ImageTexture().setDEF("rightBackTexture").setUrl(new MFString1().getArray()))
          .setFrontTexture(new ImageTexture().setDEF("frontBackTexture").setUrl(new MFString2().getArray()))
          .setBackTexture(new ImageTexture().setDEF("backBackTexture").setUrl(new MFString3().getArray()))
          .setTopTexture(new ImageTexture().setDEF("topBackTexture").setUrl(new MFString4().getArray()))
          .setBottomTexture(new ImageTexture().setDEF("bottomBackTexture").setUrl(new MFString5().getArray())))

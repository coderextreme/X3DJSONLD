...
public class mirror {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/mirror.new.json");
    }
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform()
          .addChild(new Shape()
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setDEF("x3dom").setLanguage("GLSL")
                .addField(new field("x3dom").setType("SFVec3f").setName("chromaticDispertion").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.98 1 1.033"))
              ...
              .addShaders(new ComposedShader().setDEF("x_ite").setLanguage("GLSL")
                ...
                .addField(new field("x_ite").setType("SFVec3f").setName("chromaticDispertion").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.98 1 1.033"))
                .addField(new field("x_ite").setType("SFInt32").setName("cube").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0"))
                .addField(new field("x_ite").setType("SFFloat").setName("bias").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.5"))
                .addField(new field("x_ite").setType("SFFloat").setName("scale").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.5"))
                .addField(new field("x_ite").setType("SFFloat").setName("power").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("2"))
          ...
          .addChild(new Script().setDEF("UrlSelector").setDirectOutput(true)
            ...
            .addField(new field("UrlSelector").setType("MFString").setName("front_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field("UrlSelector").setType("MFString").setName("back_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field("UrlSelector").setType("MFString").setName("left_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field("UrlSelector").setType("MFString").setName("right_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field("UrlSelector").setType("MFString").setName("top_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
            .addField(new field("UrlSelector").setType("MFString").setName("bottom_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
...
protected class MFString0 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_left.png"});
  }
}
protected class MFString1 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_right.png"});
  }
}
protected class MFString2 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_front.png"});
  }
}
protected class MFString3 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_back.png"});
  }
}
protected class MFString4 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_top.png"});
  }
}
protected class MFString5 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"});
  }
}

    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new TextureBackground()
          .setLeftTexture(new ImageTexture().setDEF("leftBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString0().getArray())))
          .setRightTexture(new ImageTexture().setDEF("rightBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray())))
          .setFrontTexture(new ImageTexture().setDEF("frontBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())))
          .setBackTexture(new ImageTexture().setDEF("backBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())))
          .setTopTexture(new ImageTexture().setDEF("topBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray())))
          .setBottomTexture(new ImageTexture().setDEF("bottomBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray()))))
          ...
          .addChild(new Shape()
            .setAppearance(new Appearance()
              ...
              .setTexture(new ComposedCubeMapTexture()
                .setBackTexture(new ImageTexture().setDEF("backShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString6().getArray())))
                .setBottomTexture(new ImageTexture().setDEF("bottomShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray())))
                .setFrontTexture(new ImageTexture().setDEF("frontShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray())))
                .setLeftTexture(new ImageTexture().setDEF("leftShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString9().getArray())))
                .setRightTexture(new ImageTexture().setDEF("rightShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString10().getArray())))
                .setTopTexture(new ImageTexture().setDEF("topShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString11().getArray()))))

  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new TextureBackground().setSkyColor(new org.web3d.x3d.jsail.fields.MFColor(new MFColor0().getArray())).setTransparency(0f)
          .setLeftTexture(new ImageTexture().setDEF("leftBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray())))
          .setRightTexture(new ImageTexture().setDEF("rightBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())))
          .setFrontTexture(new ImageTexture().setDEF("frontBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())))
          .setBackTexture(new ImageTexture().setDEF("backBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray())))
          .setTopTexture(new ImageTexture().setDEF("topBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray())))
          .setBottomTexture(new ImageTexture().setDEF("bottomBack").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString6().getArray()))))
          ...
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setAppearance(new Appearance()
              ...
              .setTexture(new ComposedCubeMapTexture()
                .setBack(new ImageTexture().setDEF("backShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray())))
                .setBottom(new ImageTexture().setDEF("bottomShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray())))
                .setFront(new ImageTexture().setDEF("frontShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString9().getArray())))
                .setLeft(new ImageTexture().setDEF("leftShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString10().getArray())))
                .setRight(new ImageTexture().setDEF("rightShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString11().getArray())))
                .setTop(new ImageTexture().setDEF("topShader").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString12().getArray()))))

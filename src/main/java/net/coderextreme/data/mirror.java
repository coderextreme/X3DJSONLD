    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new TextureBackground()
          .setFrontTexture(new ImageTexture().setDEF("frontBackgroundTexture").setUrl(new MFString0().getArray()))
          .setBackTexture(new ImageTexture().setDEF("backBackgroundTexture").setUrl(new MFString1().getArray()))
          .setLeftTexture(new ImageTexture().setDEF("leftBackgroundTexture").setUrl(new MFString2().getArray()))
          .setRightTexture(new ImageTexture().setDEF("rightBackgroundTexture").setUrl(new MFString3().getArray()))

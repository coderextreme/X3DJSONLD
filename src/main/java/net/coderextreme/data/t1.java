...
ProtoInstance ProtoInstance55 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("looking East").setPosition(new float[] {-140f,30f,0f}).setOrientation(new float[] {0f,0.4000000059604645f,0f,-1.399999976158142f}).setFieldOfView(0.7854f))
        .addChild(new Viewpoint().setDescription("Overhead").setPosition(new float[] {0f,150f,0f}).setOrientation(new float[] {1f,0f,0f,-1.5700000524520874f}).setFieldOfView(0.7854f))
            ...
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setTransparency(0.2000f).setDiffuseColor(new float[] {0.5f,0f,1f})))
        ...
        .addChild(new ProtoDeclare().setName("institute")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setTransparency(0.2000f).setDiffuseColor(new float[] {1f,1f,0f})))
        ...
        .addChild(new Transform().setTranslation(new float[] {-468f,0f,315f})
          ...
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setTransparency(0.2000f).setEmissiveColor(new float[] {1f,0f,0f})))
          ...
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setTransparency(0.2000f).setEmissiveColor(new float[] {0f,1f,0f})))
          ...
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setTransparency(0.2000f).setEmissiveColor(new float[] {1f,0f,1f})))
...
protected class MFVec3f2 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {-0.3500f,-0.3500f,0.3500f,0.3500f,-0.3500f,0.3500f,0.3500f,-0.3500f,-0.3500f,-0.3500f,-0.3500f,-0.3500f,0.0000f,0.3500f,0.0000f});
  }
}
...
protected class MFVec3f57 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {430.0000f,0.0200f,-335.0000f,435.8000f,0.1000f,-335.3000f,430.0000f,0.0200f,-335.0000f,434.6000f,0.1000f,-338.6000f,430.0000f,0.0200f,-335.0000f,432.7000f,0.1000f,-336.6000f,430.0000f,0.0200f,-335.0000f,434.7000f,0.1000f,-336.9000f,429.9000f,0.0200f,-360.3000f,474.7000f,0.1000f,-318.8000f,429.9000f,0.0200f,-360.3000f,485.6000f,0.1000f,-309.0000f,429.9000f,0.0200f,-360.3000f,434.8000f,0.1000f,-371.5000f,454.0000f,0.0200f,-361.3000f,457.4000f,0.1000f,-359.6000f,454.0000f,0.0200f,-361.3000f,454.2000f,0.1000f,-358.6000f,454.0000f,0.0200f,-361.3000f,450.6000f,0.1000f,-358.6000f,458.9000f,0.0200f,-304.3000f,473.5000f,0.1000f,-287.5000f,458.9000f,0.0200f,-304.3000f,458.0000f,0.1000f,-304.5000f,491.6000f,0.0200f,-335.7000f,491.4000f,0.1000f,-336.8000f,491.6000f,0.0200f,-335.7000f,496.9000f,0.1000f,-368.9000f,467.0000f,0.0200f,-243.9000f,477.1000f,0.1000f,-260.0000f,467.0000f,0.0200f,-243.9000f,459.0000f,0.1000f,-236.4000f,458.7000f,0.0200f,-262.7000f,469.5000f,0.1000f,-249.8000f,458.7000f,0.0200f,-262.7000f,456.7000f,0.1000f,-261.8000f});
  }
}
...
protected class MFVec3f59 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {400.0000f,0.0200f,-385.0000f,400.6000f,0.1000f,-392.9000f,400.0000f,0.0200f,-385.0000f,416.7000f,0.1000f,-383.4000f,430.0000f,0.0200f,-335.0000f,438.3000f,0.1000f,-338.6000f,430.0000f,0.0200f,-335.0000f,434.8000f,0.1000f,-336.0000f,430.0000f,0.0200f,-335.0000f,437.6000f,0.1000f,-332.6000f,430.0000f,0.0200f,-335.0000f,436.3000f,0.1000f,-333.4000f,430.0000f,0.0200f,-335.0000f,435.2000f,0.1000f,-336.8000f,430.0000f,0.0200f,-335.0000f,432.5000f,0.1000f,-332.5000f,429.9000f,0.0200f,-360.3000f,436.1000f,0.1000f,-334.9000f,429.9000f,0.0200f,-360.3000f,440.5000f,0.1000f,-355.5000f,429.9000f,0.0200f,-360.3000f,436.3000f,0.1000f,-371.7000f,429.9000f,0.0200f,-360.3000f,431.2000f,0.1000f,-361.2000f,457.1000f,0.0200f,-300.8000f,456.8000f,0.1000f,-302.6000f,457.1000f,0.0200f,-300.8000f,453.3000f,0.1000f,-318.6000f,442.4000f,0.0200f,-314.5000f,444.6000f,0.1000f,-313.7000f,442.4000f,0.0200f,-314.5000f,440.6000f,0.1000f,-310.4000f,467.0000f,0.0200f,-243.9000f,474.7000f,0.1000f,-259.1000f,457.4000f,0.0200f,-262.7000f,466.9000f,0.1000f,-243.8000f});
  }
}
...
protected class MFVec3f61 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {430.0000f,0.0200f,-335.0000f,429.9000f,0.1000f,-360.3000f,442.4000f,0.0200f,-314.5000f,429.9000f,0.1000f,-319.6000f,457.4000f,0.0200f,-262.7000f,467.0000f,0.1000f,-243.9000f,458.7000f,0.0200f,-262.7000f,457.4000f,0.1000f,-262.7000f,458.7000f,0.0200f,-262.7000f,467.0000f,0.1000f,-243.9000f});
  }
}
}

...
ProtoInstance ProtoInstance55 = null;
      ...
      .setScene(new Scene()
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Transform().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                ...
                .setGeometry(new Box().setSize(new float[] {0.699999988079071f,0.699999988079071f,0.699999988079071f}).setSolid(true)))
              .setIS(new IS()
                .addConnect(new connect().setNodeField("translation").setProtoField("pos"))))))
        ...
        .addChild(new Transform().setTranslation(new float[] {-468f,0f,315f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray())).setDescription("Derby Women's Centre").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance4 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray())).setDescription("High Peak Community Arts").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance5 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString6().getArray())).setDescription("Charlesworth Primary School").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance6 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray())).setDescription("Hope Valley College").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance7 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray())).setDescription("People Express").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance8 = new ProtoInstance().setName("i")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString9().getArray())).setDescription("QArts/Studios").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance9 = new ProtoInstance().setName("i")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString10().getArray())).setDescription("Stroke Unit, Derbyshire Royal Infirmary").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance10 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString11().getArray())).setDescription("Park View Primary, Derby").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance11 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString12().getArray())).setDescription("First Movement").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance12 = new ProtoInstance().setName("n")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString13().getArray())).setDescription("St. Benedict R.C. School, Visual Impairment Unit").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance13 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString14().getArray())).setDescription("Beckett Primary, Derby").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance14 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString15().getArray())).setDescription("Brackensdale Junior School, Communty Unit").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance15 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString16().getArray())).setDescription("Moorhead Primary, Derby").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance16 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString17().getArray())).setDescription("Derby Deaf Club").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance17 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString18().getArray())).setDescription("Nightingale Junior, Derby").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance18 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString19().getArray())).setDescription("St Mary's Primary, Derby").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance19 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString20().getArray())).setDescription("Griffe Field Primary, Derby").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance20 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString21().getArray())).setDescription("Leicester Road Day Centre, Melton Mowbray").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance21 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString22().getArray())).setDescription("Ivy House Special School, Derby").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance22 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString23().getArray())).setDescription("Oakham Day Centre, Rutland").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance23 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString24().getArray())).setDescription("Parkwood School, Alfreton").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance24 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString25().getArray())).setDescription("Ash Green, Specialist Learning Disability Resource").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance25 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString26().getArray())).setDescription("Ashgate Croft School, Chesterfield").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance26 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString27().getArray())).setDescription("Highfields School, Matlock").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance27 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString28().getArray())).setDescription("City Arts").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance28 = new ProtoInstance().setName("i")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString29().getArray())).setDescription("Indigo Dance Group (Salamanda Tandem)").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance29 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString30().getArray())).setDescription("Watering Seeds").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance30 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString31().getArray())).setDescription("Red oaks").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance31 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString32().getArray())).setDescription("West Notts College").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance32 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString33().getArray())).setDescription("Willow Wood Day Centre").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance33 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString34().getArray())).setDescription("Fased In The Arts").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance34 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString35().getArray())).setDescription("27a Access Artspace").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance35 = new ProtoInstance().setName("n")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString36().getArray())).setDescription("Roman Way Day Centre, Market Harborough").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance36 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString37().getArray())).setDescription("Mosaic, Leicester Disability Services").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance37 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString38().getArray())).setDescription("Bamboozle Theatre Company").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance38 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString39().getArray())).setDescription("Ellesmere College, Leicester").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance39 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString40().getArray())).setDescription("Ashmount School, Loughborough").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance40 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString41().getArray())).setDescription("Mantle Community Arts").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance41 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString42().getArray())).setDescription("Forrest Way School").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance42 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString43().getArray())).setDescription("Ibstock Community College").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance43 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString44().getArray())).setDescription("Artlink East").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance44 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString45().getArray())).setDescription("United Hospitals and NHS Trust Lincolnshire").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance45 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString46().getArray())).setDescription("Ancaster Day Centre").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance46 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString47().getArray())).setDescription("Creations").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance47 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString48().getArray())).setDescription("Nene Day Centre, Northamtpon").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance48 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString49().getArray())).setDescription("Delapre Middle School, Northampton").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance49 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString50().getArray())).setDescription("The Links, Brackley").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance50 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString51().getArray())).setDescription("New Perspectives").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance51 = new ProtoInstance().setName("n")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString52().getArray())).setDescription("UKan2").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance52 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString53().getArray())).setDescription("Silverstone County Infants School").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance53 = new ProtoInstance().setName("school")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString54().getArray())).setDescription("Riverside Resource Centre, Towcester").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance54 = new ProtoInstance().setName("institute")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString55().getArray())).setDescription("Daventry Tertiary College").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})

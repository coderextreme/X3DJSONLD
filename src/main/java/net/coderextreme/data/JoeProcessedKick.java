...
public class JoeProcessedKick {
  public static void main(String[] args) {
    ...
    new JoeProcessedKick().initialize().toFileJSON("../data/JoeProcessedKick.new.json");
    }
        ...
        .addChild(new Group().setDEF("Joe_Humanoid")
          .addChild(new HAnimHumanoid().setName("Human").setDEF("Joe_Human").setLoa(3).setVersion("2.0")
            .setMetadata(new MetadataSet().setName("warnings").setReference("HAnim")
              .setMetadata(new MetadataString().setName("SymmetricalLeftRight").setReference("correction options: ignore, warn, average, left, right, largest, smallest").setValue(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray()))))

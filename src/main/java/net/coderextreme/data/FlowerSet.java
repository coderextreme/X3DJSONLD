...
public class FlowerSet implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new FlowerSet().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/FlowerSet.new.java.x3d");
    model.toFileJSON("../data/FlowerSet.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName("title").setContent("FlowerSet.x3d"))
        .addMeta(new meta().setName("description").setContent("Set of three flowers for for the aromatic pleasure of the viewer. Carol did coordinates for stage and beginning to end flowers."))
        ...
        .addMeta(new meta().setName("modified").setContent("Mon, 15 Sep 2025 05:18:50 GMT"))
        ...
        .addMeta(new meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/FlowerSet.x3d")))
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle("FlowerSet.x3d"))
        .addChild(new Background().setSkyColor(new MFColor0().getArray()))
        .addChild(new NavigationInfo().setType("\"EXAMINE\"").setSpeed(3f ))
        .addChild(new TimeSensor().setDEF("FlowerStartTIME").setLoop(true).setStopTime(1757913530.194d))
        .addChild(new TimeSensor().setDEF("FlowerDelayTIME").setCycleInterval(2d).setStartTime(1757913530.194d))
        .addChild(new TimeSensor().setDEF("FlowerHeartTimer").setCycleInterval(100d))
        .addChild(new BooleanFilter().setDEF("FlowerDelayFILTER"))
        .addChild(new TimeTrigger().setDEF("FlowerTRIGGER"))
        .addChild(new TimeSensor().setDEF("PetalTime").setCycleInterval(4d).setLoop(true))
        .addChild(new Group().setDEF("FlowerSet")
          ...
          .addChild(new Transform().setDEF("FlowerPetal01").setRotation(new float[] {0.443850035587418f ,0.896101080152242f ,0f ,6.28000595004544f })
          ...
          .addChild(new Transform().setDEF("FlowerPetal02").setRotation(new float[] {0.443820012787074f ,0.896115950226133f ,0f ,0.522657613080648f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal03").setRotation(new float[] {0.443734579863432f ,0.896158257582568f ,0f ,1.04552632941227f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal04").setRotation(new float[] {0.443609062236622f ,0.89622039694572f ,0f ,1.56879714319555f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal05").setRotation(new float[] {0.443471991765267f ,0.896288230715849f ,0f ,2.09259899845629f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal06").setRotation(new float[] {0.443363291286105f ,0.896342006122637f ,0f ,2.61692975073691f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal07").setRotation(new float[] {0.443321552427192f ,0.896362650467736f ,0f ,3.14160001589697f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal08").setRotation(new float[] {0.4433632935451f ,0.896342005005255f ,0f ,3.66627027586694f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal09").setRotation(new float[] {0.443471995415153f ,0.896288228909932f ,0f ,4.19060101505081f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal10").setRotation(new float[] {0.443609066086745f ,0.896220395039996f ,0f ,4.71440285464847f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal11").setRotation(new float[] {0.443734582923915f ,0.896158256067163f ,0f ,5.23767365490645f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal12").setRotation(new float[] {0.443820014451128f ,0.896115949401974f ,0f ,5.76054236247118f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          ...
          .addChild(new Transform().setDEF("FlowerPetal01a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443850035587418f ,0.896101080152242f ,0f ,6.28000595004544f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal02a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443820012787074f ,0.896115950226133f ,0f ,0.522657613080648f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal03a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443734579863432f ,0.896158257582568f ,0f ,1.04552632941227f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal04a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443609062236622f ,0.89622039694572f ,0f ,1.56879714319555f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal05a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443471991765267f ,0.896288230715849f ,0f ,2.09259899845629f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal06a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443363291286105f ,0.896342006122637f ,0f ,2.61692975073691f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal07a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443321552427192f ,0.896362650467736f ,0f ,3.14160001589697f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal08a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.4433632935451f ,0.896342005005255f ,0f ,3.66627027586694f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal09a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443471995415153f ,0.896288228909932f ,0f ,4.19060101505081f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal10a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443609066086745f ,0.896220395039996f ,0f ,4.71440285464847f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal11a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443734582923915f ,0.896158256067163f ,0f ,5.23767365490645f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          .addChild(new Transform().setDEF("FlowerPetal12a").setTranslation(new float[] {0.25f ,0f ,0f }).setRotation(new float[] {0.443820014451128f ,0.896115949401974f ,0f ,5.76054236247118f })
            .addChild(new Shape().setUSE("FlowerPetal")))
          ...
          .addChild(new Transform().setDEF("BorderFlower01")
            .addChild(new Transform().setTranslation(new float[] {0.5f ,0f ,0f })
              .addChild(new Shape().setUSE("Stem1")))
            .addChild(new Transform().setDEF("FlowerPetal01b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443850035587418f ,0.896101080152242f ,0f ,6.28000595004544f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal02b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443820012787074f ,0.896115950226133f ,0f ,0.522657613080648f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal03b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443734579863432f ,0.896158257582568f ,0f ,1.04552632941227f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal04b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443609062236622f ,0.89622039694572f ,0f ,1.56879714319555f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal05b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443471991765267f ,0.896288230715849f ,0f ,2.09259899845629f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal06b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443363291286105f ,0.896342006122637f ,0f ,2.61692975073691f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal07b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443321552427192f ,0.896362650467736f ,0f ,3.14160001589697f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal08b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.4433632935451f ,0.896342005005255f ,0f ,3.66627027586694f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal09b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443471995415153f ,0.896288228909932f ,0f ,4.19060101505081f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal10b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443609066086745f ,0.896220395039996f ,0f ,4.71440285464847f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal11b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443734582923915f ,0.896158256067163f ,0f ,5.23767365490645f })
              .addChild(new Shape().setUSE("FlowerPetal")))
            .addChild(new Transform().setDEF("FlowerPetal12b").setTranslation(new float[] {0.5f ,0f ,0f }).setRotation(new float[] {0.443820014451128f ,0.896115949401974f ,0f ,5.76054236247118f })
              .addChild(new Shape().setUSE("FlowerPetal")))
        ...
        .addChild(new Group().setDEF("BorderFlowers")
          .addChild(new Transform().setDEF("rFlowerSpecial").setTranslation(new float[] {7f ,0.35f ,0f }).setScale(new float[] {2f ,2f ,2f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower01").setTranslation(new float[] {9.198902f ,0.25f ,-0.863062f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower02").setTranslation(new float[] {13.13242f ,0.25f ,0.935333f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower03").setTranslation(new float[] {17.52433f ,0.25f ,1.916645f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower04").setTranslation(new float[] {20.60856f ,0.25f ,5.182358f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower05").setTranslation(new float[] {21.64926f ,0.25f ,9.571372f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower06").setTranslation(new float[] {21.48226f ,0.25f ,14.11668f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower07").setTranslation(new float[] {24.02613f ,0.25f ,17.74993f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower08").setTranslation(new float[] {26.9932f ,0.25f ,21.15544f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower09").setTranslation(new float[] {27.82307f ,0.25f ,25.58628f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("rFlower10").setTranslation(new float[] {27.49279f ,0.25f ,30.1268f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower01").setTranslation(new float[] {-1.441f ,0.25f ,0.1745f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower02").setTranslation(new float[] {0.2505f ,0.25f ,4.274f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower03").setTranslation(new float[] {3.55f ,0.25f ,7.177f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower04").setTranslation(new float[] {7.952796f ,0.25f ,7.761609f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower05").setTranslation(new float[] {11.54255f ,0.25f ,0.060083f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower06").setTranslation(new float[] {12.36343f ,0.25f ,14.36499f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower07").setTranslation(new float[] {12.33216f ,0.25f ,18.81194f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower08").setTranslation(new float[] {14.54865f ,0f ,22.60859f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower09").setTranslation(new float[] {17.73875f ,0.25f ,25.70914f })
            .addChild(new Transform().setUSE("BorderFlower01")))
          .addChild(new Transform().setDEF("lFlower10").setTranslation(new float[] {18.51515f ,0.25f ,30.00324f })
            .addChild(new Transform().setUSE("BorderFlower01"))))
        .addChild(new Group()
          .addChild(new PositionInterpolator().setDEF("lFlower01_TranslationInterpolator").setKey(new MFFloat38().getArray()).setKeyValue(new MFVec3f39().getArray()))
          .addChild(new PositionInterpolator().setDEF("lFlower02_TranslationInterpolator").setKey(new MFFloat40().getArray()).setKeyValue(new MFVec3f41().getArray()))
          .addChild(new PositionInterpolator().setDEF("lFlower03_TranslationInterpolator").setKey(new MFFloat42().getArray()).setKeyValue(new MFVec3f43().getArray()))
          .addChild(new PositionInterpolator().setDEF("lFlower04_TranslationInterpolator").setKey(new MFFloat44().getArray()).setKeyValue(new MFVec3f45().getArray()))
          .addChild(new PositionInterpolator().setDEF("lFlower05_TranslationInterpolator").setKey(new MFFloat46().getArray()).setKeyValue(new MFVec3f47().getArray()))
          .addChild(new PositionInterpolator().setDEF("lFlower06_TranslationInterpolator").setKey(new MFFloat48().getArray()).setKeyValue(new MFVec3f49().getArray()))
          .addChild(new PositionInterpolator().setDEF("lFlower07_TranslationInterpolator").setKey(new MFFloat50().getArray()).setKeyValue(new MFVec3f51().getArray()))
          .addChild(new PositionInterpolator().setDEF("lFlower08_TranslationInterpolator").setKey(new MFFloat52().getArray()).setKeyValue(new MFVec3f53().getArray()))
          .addChild(new PositionInterpolator().setDEF("rFlower01_TranslationInterpolator").setKey(new MFFloat54().getArray()).setKeyValue(new MFVec3f55().getArray()))
          .addChild(new PositionInterpolator().setDEF("rFlower02_TranslationInterpolator").setKey(new MFFloat56().getArray()).setKeyValue(new MFVec3f57().getArray()))
          .addChild(new PositionInterpolator().setDEF("rFlower03_TranslationInterpolator").setKey(new MFFloat58().getArray()).setKeyValue(new MFVec3f59().getArray()))
          .addChild(new PositionInterpolator().setDEF("rFlower04_TranslationInterpolator").setKey(new MFFloat60().getArray()).setKeyValue(new MFVec3f61().getArray()))
          .addChild(new PositionInterpolator().setDEF("rFlower05_TranslationInterpolator").setKey(new MFFloat62().getArray()).setKeyValue(new MFVec3f63().getArray()))
          .addChild(new PositionInterpolator().setDEF("rFlower06_TranslationInterpolator").setKey(new MFFloat64().getArray()).setKeyValue(new MFVec3f65().getArray()))
          .addChild(new PositionInterpolator().setDEF("rFlower07_TranslationInterpolator").setKey(new MFFloat66().getArray()).setKeyValue(new MFVec3f67().getArray()))
          .addChild(new PositionInterpolator().setDEF("rFlower08_TranslationInterpolator").setKey(new MFFloat68().getArray()).setKeyValue(new MFVec3f69().getArray())))
        .addChild(new ROUTE().setFromNode("FlowerStartTIME").setFromField("cycleTime").setToNode("FlowerStartTIME").setToField("set_stopTime"))
        .addChild(new ROUTE().setFromNode("FlowerStartTIME").setFromField("stopTime_changed").setToNode("FlowerDelayTIME").setToField("set_startTime"))
...
private class MFFloat38 {
  private org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f ,0.785f ,0.787f ,0.81f ,1f });
  }
}
private class MFVec3f39 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {-1.441071f ,0.25f ,0.174511f ,-1.441071f ,0.25f ,0.174511f ,5f ,1.25f ,16f ,21.75f ,2.25f ,32f ,21.75f ,2.25f ,32f });
  }
}
private class MFFloat40 {
  private org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f ,0.785f ,0.81f ,1f });
  }
}
private class MFVec3f41 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {0.250537f ,0.25f ,4.273979f ,0.250537f ,0.25f ,4.273979f ,21.55f ,2.35f ,32f ,21.55f ,2.35f ,32f });
  }
}
...
private class MFVec3f43 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {3.550097f ,0.25f ,7.177285f ,3.550097f ,0.25f ,7.177285f ,21.55f ,2.45f ,32f ,21.55f ,2.45f ,32f });
  }
}
...
private class MFVec3f45 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {7.952796f ,0.25f ,7.761609f ,7.952796f ,0.25f ,7.761609f ,21.45f ,2.55f ,32f ,21.45f ,2.55f ,32f });
  }
}
...
private class MFVec3f47 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {11.54255f ,0.25f ,10.06008f ,11.54255f ,0.25f ,10.06008f ,21.55f ,2.45f ,32f ,21.55f ,2.45f ,32f });
  }
}
...
private class MFVec3f49 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {12.36343f ,0.25f ,14.36499f ,12.36343f ,0.25f ,14.36499f ,21.36f ,2.79f ,32f ,21.36f ,2.79f ,32f });
  }
}
...
private class MFVec3f51 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {12.33216f ,0.25f ,18.81194f ,12.33216f ,0.25f ,18.81194f ,21.45f ,2.9f ,32f ,21.45f ,2.9f ,32f });
  }
}
...
private class MFVec3f53 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {14.54865f ,0.25f ,22.60859f ,14.54865f ,0.25f ,22.60859f ,21.59f ,2.86f ,32f ,21.59f ,2.86f ,32f });
  }
}
...
private class MFVec3f55 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {9.198902f ,0.25f ,-0.863062f ,9.198902f ,0.25f ,-0.863062f ,21.85f ,2.35f ,32f ,21.85f ,2.35f ,32f });
  }
}
...
private class MFVec3f57 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {13.13242f ,0.25f ,0.935333f ,13.13242f ,0.25f ,0.935333f ,21.95f ,2.45f ,32f ,21.95f ,2.45f ,32f });
  }
}
...
private class MFVec3f59 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {17.52433f ,0.25f ,1.916645f ,17.52433f ,0.25f ,1.916645f ,22.05f ,2.55f ,32f ,22.05f ,2.55f ,32f });
  }
}
...
private class MFVec3f61 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {20.60856f ,0.25f ,5.182358f ,20.60856f ,0.25f ,5.182358f ,22.15f ,2.65f ,32f ,22.15f ,2.65f ,32f });
  }
}
...
private class MFVec3f63 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {21.64926f ,0.25f ,9.571372f ,21.64926f ,0.25f ,9.571372f ,22.14f ,2.79f ,32f ,22.14f ,2.79f ,32f });
  }
}
...
private class MFVec3f65 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {21.48226f ,0.25f ,14.11668f ,21.48226f ,0.25f ,14.11668f ,22.06f ,2.9f ,32f ,22.06f ,2.9f ,32f });
  }
}
...
private class MFVec3f67 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {24.02613f ,0.25f ,17.74993f ,24.02613f ,0.25f ,17.74993f ,21.91f ,2.86f ,32f ,21.91f ,2.86f ,32f });
  }
}
...
private class MFVec3f69 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {26.9932f ,0.25f ,21.15544f ,26.9932f ,0.25f ,21.15544f ,21.75f ,2.85f ,32f ,21.75f ,2.85f ,32f });
  }
}
}

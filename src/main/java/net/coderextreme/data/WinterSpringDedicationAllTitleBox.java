...
public class WinterSpringDedicationAllTitleBox implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new WinterSpringDedicationAllTitleBox().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/WinterSpringDedicationAllTitleBox.new.java.x3d");
    model.toFileJSON("../data/WinterSpringDedicationAllTitleBox.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDEF("WSDedicationAllTitleView").setDescription("Look at Dedication title").setPosition(new float[] {10f ,11f ,-5f }).setOrientation(new float[] {-0.15f ,0f ,0f ,0.2f }))
        .addChild(new Transform().setDEF("WSDedicationAllTitle").setTranslation(new float[] {10f ,10f ,-10f })
          .addChild(new Shape()
...
private class MFString0 {
  private org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"images/WSDedicationAll.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSDedicationAll.png"});
  }
}
}

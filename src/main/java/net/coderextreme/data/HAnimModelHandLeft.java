      ...
      .setScene(new SceneObject()
        ...
        .addChild(new HAnimHumanoidObject().setName("Humanoid_Left_hand").setDEF("Humanoid_Left_hand").setJointBindingPositions(new MFVec3fObject(new MFVec3f0().getArray())).setJointBindingRotations(new MFRotationObject(new MFRotation1().getArray())).setJointBindingScales(new MFVec3fObject(new MFVec3f2().getArray())).setLoa(-1).setSkeletalConfiguration("BASIC").setVersion("2.0").setDisplayBBox(false)
          .addJoints(new HAnimJointObject().setName("humanoid_root").setDEF("hanim_HumanoidRoot").setDisplayBBox(false)
            .addChild(new HAnimJointObject().setName("l_radiocarpal_joint").setDEF("l_radiocarpal_joint").setDisplayBBox(false)
              .addChild(new HAnimSegmentObject().setName("l_wrist").setDEF("l_wrist").setDisplayBBox(false)
              ...
              .addChild(new HAnimJointObject().setName("l_midcarpal_joint_12").setDEF("l_midcarpal_joint_12").setCenter(new float[] {0.1f,0.1f,0f}).setDisplayBBox(false)
                .addChild(new HAnimSegmentObject().setName("l_trapezoid").setDEF("l_trapezoid").setDisplayBBox(false)
                ...
                .addChild(new HAnimJointObject().setName("l_carpometacarpal_joint_1").setDEF("l_carpometacarpal_joint_1").setCenter(new float[] {0.2f,0.15f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("l_metacarpal_1").setDEF("l_metacarpal_1").setDisplayBBox(false)
                  ...
                  .addChild(new HAnimJointObject().setName("l_metacarpophalangeal_joint_1").setDEF("l_metacarpophalangeal_joint_1").setCenter(new float[] {0.3f,0.3f,0f}).setDisplayBBox(false)
                    ...
                    .addChild(new HAnimJointObject().setName("l_interphalangeal_joint_1").setDEF("l_interphalangeal_joint_1").setCenter(new float[] {0.35f,0.4f,0f}).setDisplayBBox(false)
                ...
                .addChild(new HAnimJointObject().setName("l_carpometacarpal_joint_2").setDEF("l_carpometacarpal_joint_2").setCenter(new float[] {0.1f,0.2f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("l_metacarpal2").setDEF("l_metacarpal2").setDisplayBBox(false)
                  ...
                  .addChild(new HAnimJointObject().setName("l_metacarpophalangeal_joint_2").setDEF("l_metacarpophalangeal_joint_2").setCenter(new float[] {0.15f,0.5f,0f}).setDisplayBBox(false)
                    ...
                    .addChild(new HAnimJointObject().setName("l_proximal_interphalangeal_joint_2").setDEF("l_proximal_interphalangeal_joint_2").setCenter(new float[] {0.2f,0.7f,0f}).setDisplayBBox(false)
                      ...
                      .addChild(new HAnimJointObject().setName("l_distal_interphalangeal_joint_2").setDEF("l_distal_interphalangeal_joint_2").setCenter(new float[] {0.24f,0.87f,0f}).setDisplayBBox(false)
              ...
              .addChild(new HAnimJointObject().setName("l_midcarpal_joint_3").setDEF("l_midcarpal_joint_3").setCenter(new float[] {0f,0.07f,0f}).setDisplayBBox(false)
                .addChild(new HAnimSegmentObject().setName("l_capitate").setDEF("l_capitate").setDisplayBBox(false)
                ...
                .addChild(new HAnimJointObject().setName("l_carpometacarpal_joint_3").setDEF("l_carpometacarpal_joint_3").setCenter(new float[] {0f,0.2f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("l_metacarpal3").setDEF("l_metacarpal3").setDisplayBBox(false)
                  ...
                  .addChild(new HAnimJointObject().setName("l_metacarpophalangeal_joint_3").setDEF("l_metacarpophalangeal_joint_3").setCenter(new float[] {0.03f,0.5f,0f}).setDisplayBBox(false)
                    ...
                    .addChild(new HAnimJointObject().setName("l_proximal_interphalangeal_joint_3").setDEF("l_proximal_interphalangeal_joint_3").setCenter(new float[] {0.05f,0.75f,0f}).setDisplayBBox(false)
                      ...
                      .addChild(new HAnimJointObject().setName("l_distal_interphalangeal_joint_3").setDEF("l_distal_interphalangeal_joint_3").setCenter(new float[] {0.08f,0.96f,0f}).setDisplayBBox(false)
              ...
              .addChild(new HAnimJointObject().setName("l_midcarpal_joint_12").setDEF("l_midcarpal_joint_45").setCenter(new float[] {-0.1f,0.1f,0f}).setDisplayBBox(false)
                .addChild(new HAnimSegmentObject().setName("l_hamate").setDEF("l_hamate").setDisplayBBox(false)
                  .addChild(new TransformObject().setTranslation(new float[] {-0.1f,0.1f,0f}).setDisplayBBox(false)
                    .addChild(new ShapeObject().setUSE("HAnimNewJointShape")))
                  .addChild(new ShapeObject().setDisplayBBox(false)
                    .setAppearance(new AppearanceObject()
                ...
                .addChild(new HAnimJointObject().setName("l_carpometacarpal_joint_4").setDEF("l_carpometacarpal_joint_4").setCenter(new float[] {-0.1f,0.2f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("l_metacarpal4").setDEF("l_metacarpal4").setDisplayBBox(false)
                    .addChild(new TransformObject().setTranslation(new float[] {-0.1f,0.2f,0f}).setDisplayBBox(false)
                      .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                    .addChild(new ShapeObject().setDisplayBBox(false)
                      .setAppearance(new AppearanceObject()
                  ...
                  .addChild(new HAnimJointObject().setName("l_metacarpophalangeal_joint_4").setDEF("l_metacarpophalangeal_joint_4").setCenter(new float[] {-0.1f,0.47f,0f}).setDisplayBBox(false)
                    ...
                    .addChild(new HAnimJointObject().setName("l_proximal_interphalangeal_joint_4").setDEF("l_proximal_interphalangeal_joint_4").setCenter(new float[] {-0.1f,0.7f,0f}).setDisplayBBox(false)
                      ...
                      .addChild(new HAnimJointObject().setName("l_distal_interphalangeal_joint_4").setDEF("l_distal_interphalangeal_joint_4").setCenter(new float[] {-0.1f,0.93f,0f}).setDisplayBBox(false)
                        .addChild(new HAnimSegmentObject().setName("l_distal_phalanx4").setDEF("l_distal_phalanx4").setDisplayBBox(false)
                ...
                .addChild(new HAnimJointObject().setName("l_carpometacarpal_joint_5").setDEF("l_carpometacarpal_joint_5").setCenter(new float[] {-0.15f,0.17f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("l_metacarpal5").setDEF("l_metacarpal5").setDisplayBBox(false)
                  ...
                  .addChild(new HAnimJointObject().setName("l_metacarpophalangeal_joint_5").setDEF("l_metacarpophalangeal_joint_5").setCenter(new float[] {-0.2f,0.4f,0f}).setDisplayBBox(false)
                    .addChild(new HAnimSegmentObject().setName("l_proximal_phalanges2").setDEF("l_proximal_phalanges5").setDisplayBBox(false)
                    ...
                    .addChild(new HAnimJointObject().setName("l_proximal_interphalangeal_joint_5").setDEF("l_proximal_interphalangeal_joint_5").setCenter(new float[] {-0.23f,0.63f,0f}).setDisplayBBox(false)
                      ...
                      .addChild(new HAnimJointObject().setName("l_distal_interphalangeal_joint_5").setDEF("l_distal_interphalangeal_joint_5").setCenter(new float[] {-0.25f,0.79f,0f}).setDisplayBBox(false)

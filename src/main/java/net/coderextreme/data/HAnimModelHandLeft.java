  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_Hand_Left").setVersion("2.0").setName("Hand_Left").setLoa(4)
          .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            .addMetadata(new MetadataString().setName("authorName")))
          .addSkeleton(new HAnimJoint("hanim_Hand_Left").setDEF("hanim_humanoid_root").setName("humanoid_root")
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_l_radiocarpal").setDescription("connection joint of hand to leg above").setName("l_radiocarpal")
              ...
              .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_1").setName("l_midcarpal_1").setCenter(new float[] {0.14f,0.09f,0f})
                .addChild(new HAnimSegment("hanim_l_midcarpal_1").setDEF("hanim_l_trapezium").setName("l_trapezium")
                  ...
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                    .setGeometry(new IndexedLineSet().setDEF("MC1toCMC1").setCoordIndex(new MFInt328().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f9().getArray())))))
                .addChild(new HAnimJoint("hanim_l_midcarpal_1").setDEF("hanim_l_carpometacarpal_1").setName("l_carpometacarpal_1").setCenter(new float[] {0.2f,0.15f,0f})
                  .addChild(new HAnimSegment("hanim_l_carpometacarpal_1").setDEF("hanim_l_metacarpal_1").setName("l_metacarpal_1")
                    ...
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                      .setGeometry(new IndexedLineSet().setDEF("CMC1toMCP1").setCoordIndex(new MFInt3210().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f11().getArray())))))
                  .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setDEF("hanim_l_metacarpophalangeal_1").setName("l_metacarpophalangeal_1").setCenter(new float[] {0.3f,0.3f,0f})
                    .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_1").setDEF("hanim_l_carpal_proximal_phalanx_1").setName("l_carpal_proximal_phalanx_1")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                        .setGeometry(new IndexedLineSet().setDEF("MCP11toIP1").setCoordIndex(new MFInt3212().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f13().getArray())))))
                    .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setName("l_carpal_interphalangeal_1").setCenter(new float[] {0.35f,0.4f,0f})
                      .addChild(new HAnimSegment("hanim_l_carpal_interphalangeal_1").setDEF("hanim_l_carpal_distal_phalanx_1").setName("l_carpal_distal_phalanx_1")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                          .setGeometry(new IndexedLineSet().setDEF("fingertip_l_carpal_interphalangeal_1").setCoordIndex(new MFInt3214().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f15().getArray())))))))))
              .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_2").setName("l_midcarpal_2").setCenter(new float[] {0.07f,0.07f,0f})
                .addChild(new HAnimSegment("hanim_l_midcarpal_2").setDEF("hanim_l_trapezoid").setName("l_trapezoid")
                  ...
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                    .setGeometry(new IndexedLineSet().setDEF("MC2toCMC2").setCoordIndex(new MFInt3216().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f17().getArray())))))
                .addChild(new HAnimJoint("hanim_l_midcarpal_2").setDEF("hanim_l_carpometacarpal_2").setName("l_carpometacarpal_2").setCenter(new float[] {0.1f,0.2f,0f})
                  .addChild(new HAnimSegment("hanim_l_carpometacarpal_2").setDEF("hanim_l_metacarpal_2").setName("l_metacarpal_2")
                    ...
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                      .setGeometry(new IndexedLineSet().setDEF("CMC2toMCP2").setCoordIndex(new MFInt3218().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f19().getArray())))))
                  .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setDEF("hanim_l_metacarpophalangeal_2").setName("l_metacarpophalangeal_2").setCenter(new float[] {0.15f,0.5f,0f})
                    .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_2").setDEF("hanim_l_carpal_proximal_phalanx_2").setName("l_carpal_proximal_phalanx_2")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                        .setGeometry(new IndexedLineSet().setDEF("MCP2toPIP2").setCoordIndex(new MFInt3220().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f21().getArray())))))
                    .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_1").setName("l_carpal_proximal_interphalangeal_2").setCenter(new float[] {0.2f,0.7f,0f})
                      .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_1").setDEF("hanim_l_carpal_middle_phalanx_1").setName("l_carpal_middle_phalanx_2")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                          .setGeometry(new IndexedLineSet().setDEF("PIP2toDIP2").setCoordIndex(new MFInt3222().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f23().getArray())))))
                      .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_1").setDEF("hanim_l_carpal_distal_interphalangeal_1").setName("l_carpal_distal_interphalangeal_2").setCenter(new float[] {0.24f,0.87f,0f})
                        .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_1").setDEF("hanim_l_carpal_distal_phalanx_2").setName("l_carpal_distal_phalanx_2")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_l_carpal_distal_interphalangeal_1").setCoordIndex(new MFInt3224().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f25().getArray()))))))))))
              .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_3").setName("l_midcarpal_3").setCenter(new float[] {0f,0.07f,0f})
                .addChild(new HAnimSegment("hanim_l_midcarpal_3").setDEF("hanim_l_capitate").setName("l_capitate")
                  ...
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                    .setGeometry(new IndexedLineSet().setDEF("MC3toCMC3").setCoordIndex(new MFInt3226().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f27().getArray())))))
                .addChild(new HAnimJoint("hanim_l_midcarpal_3").setDEF("hanim_l_carpometacarpal_3").setName("l_carpometacarpal_3").setCenter(new float[] {0f,0.2f,0f})
                  .addChild(new HAnimSegment("hanim_l_carpometacarpal_3").setDEF("hanim_l_metacarpal_3").setName("l_metacarpal_3")
                    ...
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                      .setGeometry(new IndexedLineSet().setDEF("CMC3toMCP3").setCoordIndex(new MFInt3228().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f29().getArray())))))
                  .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setDEF("hanim_l_metacarpophalangeal_3").setName("l_metacarpophalangeal_3").setCenter(new float[] {0.03f,0.5f,0f})
                    .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_3").setDEF("hanim_l_carpal_proximal_phalanx_3").setName("l_carpal_proximal_phalanx_3")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                        .setGeometry(new IndexedLineSet().setDEF("MCP3toPIP3").setCoordIndex(new MFInt3230().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f31().getArray())))))
                    .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_proximal_interphalangeal_3").setCenter(new float[] {0.05f,0.75f,0f})
                      .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_middle_phalanx_2").setName("l_carpal_middle_phalanx_3")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                          .setGeometry(new IndexedLineSet().setDEF("PIP3toDIP3").setCoordIndex(new MFInt3232().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f33().getArray())))))
                      .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_3").setCenter(new float[] {0.08f,0.96f,0f})
                        .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_2").setDEF("hanim_l_carpal_distal_phalanx_3").setName("l_carpal_distal_phalanx_3")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_l_carpal_distal_interphalangeal_2").setCoordIndex(new MFInt3234().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f35().getArray()))))))))))
              .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_4_1").setName("l_midcarpal_4_5").setCenter(new float[] {-0.1f,0.1f,0f})
                .addChild(new HAnimSegment("hanim_l_midcarpal_4_1").setDEF("hanim_l_hamate").setName("l_hamate")
                  ...
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                    .setGeometry(new IndexedLineSet().setDEF("MC45toCMC4").setCoordIndex(new MFInt3236().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f37().getArray()))))
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                    .setGeometry(new IndexedLineSet().setDEF("MC45toCMC5").setCoordIndex(new MFInt3238().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f39().getArray())))))
                .addChild(new HAnimJoint("hanim_l_midcarpal_4_1").setDEF("hanim_l_carpometacarpal_4").setName("l_carpometacarpal_4").setCenter(new float[] {-0.1f,0.2f,0f})
                  .addChild(new HAnimSegment("hanim_l_carpometacarpal_4").setDEF("hanim_l_metacarpal_4").setName("l_metacarpal_4")
                    ...
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                      .setGeometry(new IndexedLineSet().setDEF("CMC4toMCP4").setCoordIndex(new MFInt3240().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f41().getArray())))))
                  .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setDEF("hanim_l_metacarpophalangeal_4").setName("l_metacarpophalangeal_4").setCenter(new float[] {-0.1f,0.47f,0f})
                    .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_4").setDEF("hanim_l_carpal_proximal_phalanx_4").setName("l_carpal_proximal_phalanx_4")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                        .setGeometry(new IndexedLineSet().setDEF("MCP4toPIP4").setCoordIndex(new MFInt3242().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f43().getArray())))))
                    .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_proximal_interphalangeal_4").setCenter(new float[] {-0.1f,0.7f,0f})
                      .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_middle_phalanx_3").setName("l_carpal_middle_phalanx_4")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                          .setGeometry(new IndexedLineSet().setDEF("PIP4toDIP4").setCoordIndex(new MFInt3244().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f45().getArray())))))
                      .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_4").setCenter(new float[] {-0.1f,0.93f,0f})
                        .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_3").setDEF("hanim_l_carpal_distal_phalanx_4").setName("l_carpal_distal_phalanx_4")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_l_carpal_distal_interphalangeal_3").setCoordIndex(new MFInt3246().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f47().getArray())))))))))
                .addChild(new HAnimJoint("hanim_l_midcarpal_4_1").setDEF("hanim_l_carpometacarpal_5").setName("l_carpometacarpal_5").setCenter(new float[] {-0.15f,0.17f,0f})
                  .addChild(new HAnimSegment("hanim_l_carpometacarpal_5").setDEF("hanim_l_metacarpal_5").setName("l_metacarpal_5")
                    ...
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                      .setGeometry(new IndexedLineSet().setDEF("CMC5toMCP5").setCoordIndex(new MFInt3248().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f49().getArray())))))
                  .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setDEF("hanim_l_metacarpophalangeal_5").setName("l_metacarpophalangeal_5").setCenter(new float[] {-0.2f,0.4f,0f})
                    .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_5").setDEF("hanim_l_carpal_proximal_phalanx_5").setName("l_carpal_proximal_phalanx_5")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                        .setGeometry(new IndexedLineSet().setDEF("MCP5toPIP5").setCoordIndex(new MFInt3250().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f51().getArray())))))
                    .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_proximal_interphalangeal_5").setCenter(new float[] {-0.23f,0.63f,0f})
                      .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_middle_phalanx_4").setName("l_carpal_middle_phalanx_5")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                          .setGeometry(new IndexedLineSet().setDEF("PIP5toDIP5").setCoordIndex(new MFInt3252().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f53().getArray())))))
                      .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_5").setCenter(new float[] {-0.25f,0.79f,0f})
                        .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_4").setDEF("hanim_l_carpal_distal_phalanx_5").setName("l_carpal_distal_phalanx_5")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_l_carpal_distal_interphalangeal_4").setCoordIndex(new MFInt3254().getArray())
          ...
          .addSegments(new HAnimSegment("hanim_Hand_Left").setUSE("hanim_l_carpal_middle_phalanx_1"))
          ...
          .addJoints(new HAnimJoint("hanim_Hand_Left").setUSE("hanim_l_carpal_distal_interphalangeal_1"))
          ...
          .addJoints(new HAnimJoint("hanim_Hand_Left").setUSE("hanim_l_carpal_proximal_interphalangeal_1"))
          ...
          .addJoints(new HAnimJoint("hanim_Hand_Left").setUSE("hanim_l_midcarpal_4_1"))

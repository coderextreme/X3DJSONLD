      ...
      .setScene(new Scene()
        .addChild(new ProtoDeclare().setName("Carbon")
          .setProtoInterface(new ProtoInterface()
            ...
            .addField(new field().setType("SFFloat").setName("materialTransparency").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.6")))
              ...
              .addChild(new Transform().setDEF("atoC")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoC_mat").setDiffuseColor(new float[] {0f ,0f ,0f }).setShininess(0.8f ).setSpecularColor(new float[] {0.29f ,0.3f ,0.29f })
                      .setIS(new IS()
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoH")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoH_mat").setAmbientIntensity(0.0933f ).setDiffuseColor(new float[] {0.38f ,0.38f ,0.42f }).setShininess(0.5f ).setSpecularColor(new float[] {0.53f ,0.53f ,0.53f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoN")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoN_mat").setDiffuseColor(new float[] {0f ,0f ,0.72f }).setEmissiveColor(new float[] {0f ,0f ,0.13f }).setSpecularColor(new float[] {0.5f ,0.5f ,0.5f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoO")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoO_mat").setAmbientIntensity(0.487f ).setDiffuseColor(new float[] {0.54f ,0.05f ,0.25f }).setShininess(0.2f ).setSpecularColor(new float[] {0.81f ,0.77f ,0.75f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoF")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoF_mat").setDiffuseColor(new float[] {1f ,0.48f ,0.79f }).setEmissiveColor(new float[] {0.09f ,0.04f ,0.07f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoSi")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoSi_mat").setDiffuseColor(new float[] {0.8f ,0.8f ,0.8f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoP")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoP_mat").setAmbientIntensity(0.11f ).setDiffuseColor(new float[] {0.9f ,0.41f ,0f }).setEmissiveColor(new float[] {0.1f ,0.04f ,0f }).setShininess(0.8f ).setSpecularColor(new float[] {0.1f ,0.1f ,0.1f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoS")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoS_mat").setAmbientIntensity(0.0467f ).setDiffuseColor(new float[] {0.25f ,0.39f ,0.25f }).setEmissiveColor(new float[] {0.05f ,0.08f ,0.05f }).setShininess(0.6f ).setSpecularColor(new float[] {0.11f ,0.12f ,0.08f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoCl")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoCl_mat").setDiffuseColor(new float[] {0.28f ,0.7f ,0f }).setEmissiveColor(new float[] {0.06f ,0.15f ,0f }).setShininess(0.8f ).setSpecularColor(new float[] {0.5f ,0.5f ,0.5f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoBr")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoBr_mat").setAmbientIntensity(0.0833f ).setDiffuseColor(new float[] {0.5f ,0.3f ,0.19f }).setEmissiveColor(new float[] {0.12f ,0.13f ,0.08f }).setShininess(0.17f ).setSpecularColor(new float[] {0.08f ,0.08f ,0.05f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("atoI")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("atoI_mat").setDiffuseColor(new float[] {0.56f ,0.37f ,0.74f }).setEmissiveColor(new float[] {0.15f ,0.1f ,0.2f }).setShininess(0.09f ).setSpecularColor(new float[] {0.12f ,0.12f ,0.12f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("ato_")
                ...
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("ato__mat").setDiffuseColor(new float[] {1f ,1f ,1f }).setEmissiveColor(new float[] {0.15f ,0.1f ,0.2f }).setShininess(0.09f ).setSpecularColor(new float[] {0.12f ,0.12f ,0.12f })
                      .setIS(new IS()
                        .addConnect(new connect().setNodeField("transparency").setProtoField("materialTransparency")))))
        ...
        .addChild(new ProtoDeclare().setName("line")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("MFVec3f").setName("bond_set").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("-1 0 0 1 0 0")))
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Shape()
                .setAppearance(new Appearance()
        ...
        .addChild(new ProtoDeclare().setName("title_text")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("MFString").setName("txt").setAccessType(field.ACCESSTYPE_INPUTOUTPUT)))
          .setProtoBody(new ProtoBody()
        ...
        .addChild(new Viewpoint().setDescription("Inspect Oxytocin").setPosition(new float[] {0f ,2f ,20f }))
        ...
        .addChild(new Transform().setDEF("infogroupa").setTranslation(new float[] {-8f ,2f ,-4f })
          .addChild(new Transform().setTranslation(new float[] {0f ,6f ,0f })
            .addChild(new Viewpoint().setDescription("title billboard").setPosition(new float[] {6f ,-2f ,10f }))

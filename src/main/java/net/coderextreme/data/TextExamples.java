  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setContent("TextExamples.x3d").setName("title"))
        .addMeta(new metaObject().setContent("Show different escape-character text examples for embedded quotation marks.").setName("description"))
        .addMeta(new metaObject().setContent("Don Brutzman").setName("creator"))
        .addMeta(new metaObject().setContent("7 April 2001").setName("created"))
        .addMeta(new metaObject().setContent("26 April 2016").setName("modified"))
        .addMeta(new metaObject().setContent("Note that X3D Canonicalization (C14N) will scrub alternate XML character representations, be careful to check original encoding into version control.").setName("warning"))
        .addMeta(new metaObject().setContent("Usually this source document needs to be inspected and edited using a plain-text editor in order to see the differences in these XML-equivalent text representations.").setName("warning"))
        .addMeta(new metaObject().setContent("http://www.web3d.org/x3d/content/examples/Basic/development/TextExamples.x3d").setName("identifier"))

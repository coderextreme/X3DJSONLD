...
public class JinLOA4_3 implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/JinLOA4_3.new.java.x3d");
    model.toFileJSON("../data/JinLOA4_3.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("JinLOA4_3.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("JinLOA4_3.x3d")))

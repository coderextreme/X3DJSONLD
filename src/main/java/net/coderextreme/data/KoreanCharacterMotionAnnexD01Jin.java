  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setName("title").setContent("KoreanCharacterMotionAnnexD01Jin.x3d"))
        ...
        .addMeta(new metaObject().setName("modified").setContent("10 May 2020"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/KoreanCharacterMotionAnnexD01Jin.x3d"))
        .addMeta(new metaObject().setName("generator").setContent("3DS MAX, http://www.autodesk.com/products/autodesk-3ds-max/overview"))
        .addMeta(new metaObject().setName("generator").setContent("Suwon HAnim Converter"))
      ...
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("KoreanCharacterMotionAnnexD01Jin.x3d"))
        .addChild(new NavigationInfoObject().setSpeed(1.5f))
        .addChild(new ViewpointObject().setCenterOfRotation(new float[] {0f,1f,0f}).setDescription("AnnexD01Jin").setPosition(new float[] {0f,1f,3f}))
        .addChild(new HAnimHumanoidObject().setName("AnnexD01Jin").setDEF("hanim_AnnexD01Jin").setInfo(new MFStringObject(new MFString0().getArray())).setJointBindingPositions(new MFVec3fObject(new MFVec3f1().getArray())).setJointBindingRotations(new MFRotationObject(new MFRotation2().getArray())).setJointBindingScales(new MFVec3fObject(new MFVec3f3().getArray())).setScale(new float[] {0.0225f,0.0225f,0.0225f}).setVersion("2.0")
              ...
              .addChild(new TransformObject().setTranslation(new float[] {0f,30.53f,-0.7076f})
                .addChild(new ShapeObject()
                  .setAppearance(new AppearanceObject()
                    .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                    .setTexture(new ImageTextureObject().setDEF("Annex01JinTextureAtlas").setUrl(new MFStringObject(new MFString4().getArray()))))
                  .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt325().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt326().getArray()))
                    .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f7().getArray())))
                    .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f8().getArray())))))))
            .addChild(new HAnimJointObject().setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new float[] {0f,35.8f,-0.7076f})
              .addChild(new HAnimSegmentObject().setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new TransformObject().setTranslation(new float[] {0f,35.8f,-0.7076f})
                  .addChild(new ShapeObject()
                    .setAppearance(new AppearanceObject()
                      .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                    .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt329().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3210().getArray()))
              ...
              .addChild(new HAnimJointObject().setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {4.207f,32.02f,-0.8155f})
                .addChild(new HAnimSegmentObject().setName("l_thigh").setDEF("hanim_l_thigh")
                  .addChild(new TransformObject().setTranslation(new float[] {4.207f,32.02f,-0.8155f})
                    .addChild(new ShapeObject()
                      .setAppearance(new AppearanceObject()
                        .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                      .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3213().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3214().getArray()))
                        .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f15().getArray())))
                        .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f16().getArray())))))))
                .addChild(new HAnimJointObject().setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {4.116f,17.26f,-0.8639f})
                  .addChild(new HAnimSegmentObject().setName("l_calf").setDEF("hanim_l_calf")
                    .addChild(new TransformObject().setTranslation(new float[] {4.116f,17.26f,-0.8639f})
                      .addChild(new ShapeObject()
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3217().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3218().getArray()))
                          .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f19().getArray())))
                          .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f20().getArray())))))))
                  .addChild(new HAnimJointObject().setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new float[] {3.854f,3.939f,-0.7038f})
                    .addChild(new HAnimSegmentObject().setName("l_hindfoot").setDEF("hanim_l_hindfoot")
                      .addChild(new TransformObject().setTranslation(new float[] {3.854f,3.939f,-0.7038f})
                        .addChild(new ShapeObject()
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3221().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3222().getArray()))
                            .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f23().getArray())))
                            .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f24().getArray())))))))
                    .addChild(new HAnimJointObject().setName("l_metatarsophalangeal").setDEF("hanim_l_metatarsophalangeal").setCenter(new float[] {3.854f,3.64f,0.7402f})
                      .addChild(new HAnimSegmentObject().setName("l_middistal").setDEF("hanim_l_middistal")
                        .addChild(new TransformObject().setTranslation(new float[] {3.854f,3.64f,0.7402f})
                          .addChild(new ShapeObject()
                            .setAppearance(new AppearanceObject()
                              .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                            .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3225().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3226().getArray()))
                              .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f27().getArray())))
                              .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f28().getArray())))))))))))
              .addChild(new HAnimJointObject().setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-4.207f,32.02f,-0.8155f})
                  ...
                  .addChild(new TransformObject().setTranslation(new float[] {-4.207f,32.02f,-0.8155f})
                    .addChild(new ShapeObject()
                      .setAppearance(new AppearanceObject()
                        .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                      .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3229().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3230().getArray()))
                        .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f31().getArray())))
                        .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f32().getArray())))))))
                .addChild(new HAnimJointObject().setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-4.116f,17.26f,-0.8639f})
                    ...
                    .addChild(new TransformObject().setTranslation(new float[] {-4.116f,17.26f,-0.8639f})
                      .addChild(new ShapeObject()
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3233().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3234().getArray()))
                          .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f35().getArray())))
                          .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f36().getArray())))))))
                  .addChild(new HAnimJointObject().setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-3.854f,3.939f,-0.7038f})
                      ...
                      .addChild(new TransformObject().setTranslation(new float[] {-3.854f,3.939f,-0.7038f})
                        .addChild(new ShapeObject()
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3237().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3238().getArray()))
                            .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f39().getArray())))
                            .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f40().getArray())))))))
                    .addChild(new HAnimJointObject().setName("r_metatarsophalangeal").setDEF("hanim_r_metatarsophalangeal").setCenter(new float[] {-3.854f,3.64f,0.7402f})
                        ...
                        .addChild(new TransformObject().setTranslation(new float[] {-3.854f,3.64f,0.7402f})
                          .addChild(new ShapeObject()
                            .setAppearance(new AppearanceObject()
                              .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                            .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3241().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3242().getArray()))
                              .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f43().getArray())))
                              .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f44().getArray())))))))))))
              .addChild(new HAnimJointObject().setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f,40.23f,-0.8527f})
                .addChild(new HAnimSegmentObject().setName("l5").setDEF("hanim_l5")
                  .addChild(new TransformObject().setTranslation(new float[] {0f,40.23f,-0.8527f})
                    .addChild(new ShapeObject()
                      .setAppearance(new AppearanceObject()
                        .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                      .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3245().getArray()).append(new MFInt3246().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3247().getArray()).append(new MFInt3248().getArray()))
                        .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f49().getArray())))
                        .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f50().getArray())))))))
                .addChild(new HAnimJointObject().setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f,57.43f,-0.6863f})
                  .addChild(new HAnimSegmentObject().setName("skull").setDEF("hanim_skull")
                    .addChild(new TransformObject().setTranslation(new float[] {0f,57.43f,-0.6863f})
                      .addChild(new ShapeObject()
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3251().getArray()).append(new MFInt3252().getArray()).append(new MFInt3253().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3254().getArray()).append(new MFInt3255().getArray()).append(new MFInt3256().getArray()))
                          .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f57().getArray()).append(new MFVec3f58().getArray())))
                          .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f59().getArray()))))))))
                .addChild(new HAnimJointObject().setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {5.975f,52f,-0.1452f})
                  .addChild(new HAnimSegmentObject().setName("l_upperarm").setDEF("hanim_l_upperarm")
                    .addChild(new TransformObject().setTranslation(new float[] {5.975f,52f,-0.1452f})
                      .addChild(new ShapeObject()
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3260().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3261().getArray()))
                  ...
                  .addChild(new HAnimJointObject().setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {8.093f,40.38f,-0.2502f})
                    .addChild(new HAnimSegmentObject().setName("l_forearm").setDEF("hanim_l_forearm")
                      .addChild(new TransformObject().setTranslation(new float[] {8.093f,40.38f,-0.2502f})
                        .addChild(new ShapeObject()
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3264().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3265().getArray()))
                            .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f66().getArray())))
                            .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f67().getArray())))))))
                    .addChild(new HAnimJointObject().setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {7.808f,31.46f,-0.05849f})
                      .addChild(new HAnimSegmentObject().setName("l_hand").setDEF("hanim_l_hand")
                        .addChild(new TransformObject().setTranslation(new float[] {7.808f,31.46f,-0.05849f})
                          .addChild(new ShapeObject()
                            .setAppearance(new AppearanceObject()
                              .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                            .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3268().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3269().getArray()))
                              .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f70().getArray())))
                              .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f71().getArray()))))))))))
                .addChild(new HAnimJointObject().setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-5.975f,52f,-0.1452f})
                    ...
                    .addChild(new TransformObject().setTranslation(new float[] {-5.975f,52f,-0.1452f})
                      .addChild(new ShapeObject()
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3272().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3273().getArray()))
                  ...
                  .addChild(new HAnimJointObject().setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-8.093f,40.38f,-0.2502f})
                      ...
                      .addChild(new TransformObject().setTranslation(new float[] {-8.093f,40.38f,-0.2502f})
                        .addChild(new ShapeObject()
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3276().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3277().getArray()))
                            .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f78().getArray())))
                            .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f79().getArray())))))))
                    .addChild(new HAnimJointObject().setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-7.808f,31.46f,-0.05849f})
                        ...
                        .addChild(new TransformObject().setTranslation(new float[] {-7.808f,31.46f,-0.05849f})
                          .addChild(new ShapeObject()
                            .setAppearance(new AppearanceObject()
                              .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTextureObject().setUSE("Annex01JinTextureAtlas")))
                            .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3280().getArray())).setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32Object(new MFInt3281().getArray()))
                              .setCoord(new CoordinateObject().setPoint(new MFVec3fObject(new MFVec3f82().getArray())))
                              .setTexCoord(new TextureCoordinateObject().setPoint(new MFVec2fObject(new MFVec2f83().getArray())))))))))))))
          ...
          .addJoints(new HAnimJointObject().setUSE("hanim_l_talocrural"))
          .addJoints(new HAnimJointObject().setUSE("hanim_l_metatarsophalangeal"))
          ...
          .addJoints(new HAnimJointObject().setUSE("hanim_r_metatarsophalangeal"))
          ...
          .addJoints(new HAnimJointObject().setUSE("hanim_r_radiocarpal"))
...
protected class MFString4 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/HAnimSpecification/Jin.png"});
  }
}
...
protected class MFInt3237 {
  protected MFInt32Object getArray() {
    return new MFInt32Object(new int[] {1,14,11,-1,3,6,5,-1,5,4,3,-1,1,3,4,-1,4,0,1,-1,0,4,5,-1,5,2,0,-1,11,6,3,-1,3,1,11,-1,15,12,0,-1,0,2,15,-1,0,12,13,-1,13,1,0,-1,13,14,1,-1,7,11,18,-1,8,9,5,-1,5,6,8,-1,7,10,9,-1,9,8,7,-1,10,2,5,-1,5,9,10,-1,11,7,8,-1,8,6,11,-1,15,2,10,-1,10,16,15,-1,10,7,17,-1,17,16,10,-1,17,7,18,-1,19,26,25,-1,25,24,23,-1,19,25,23,-1,23,22,21,-1,19,23,21,-1,20,19,21,-1,15,19,20,-1,20,12,15,-1,12,20,21,-1,21,13,12,-1,13,21,22,-1,22,14,13,-1,14,22,23,-1,23,11,14,-1,11,23,24,-1,24,18,11,-1,18,24,25,-1,25,17,18,-1,17,25,26,-1,26,16,17,-1,16,26,19,-1,19,15,16,-1,33,27,30,-1,30,31,33,-1,36,38,30,-1,30,27,36,-1,29,28,27,-1,27,33,29,-1,37,36,27,-1,27,28,37,-1,28,29,42,-1,42,37,28,-1,33,31,34,-1,34,32,33,-1,39,32,34,-1,34,40,39,-1,29,33,32,-1,32,35,29,-1,41,35,32,-1,32,39,41,-1,35,41,42,-1,42,29,35,-1,44,43,47,-1,44,47,46,-1,44,46,45,-1,51,50,49,-1,49,48,54,-1,49,54,53,-1,51,49,53,-1,51,53,52,-1,30,43,44,-1,44,31,30,-1,31,44,45,-1,45,34,31,-1,34,45,46,-1,46,40,34,-1,40,46,47,-1,47,38,40,-1,38,47,43,-1,43,30,38,-1,37,48,49,-1,49,36,37,-1,36,49,50,-1,50,38,36,-1,38,50,51,-1,51,40,38,-1,40,51,52,-1,52,39,40,-1,39,52,53,-1,53,41,39,-1,41,53,54,-1,54,42,41,-1,42,54,48,-1,48,37,42,-1});
  }
}
protected class MFInt3238 {
  protected MFInt32Object getArray() {
    return new MFInt32Object(new int[] {1,18,14,-1,3,6,5,-1,5,4,3,-1,1,3,4,-1,4,0,1,-1,0,4,5,-1,5,2,0,-1,14,6,3,-1,3,1,14,-1,19,16,0,-1,0,2,19,-1,0,16,17,-1,17,1,0,-1,17,18,1,-1,7,15,23,-1,9,10,11,-1,11,8,9,-1,7,12,10,-1,10,9,7,-1,12,13,11,-1,11,10,12,-1,15,7,9,-1,9,8,15,-1,20,13,12,-1,12,21,20,-1,12,7,22,-1,22,21,12,-1,22,7,23,-1,24,31,30,-1,30,29,28,-1,24,30,28,-1,28,27,26,-1,24,28,26,-1,25,24,26,-1,19,24,25,-1,25,16,19,-1,16,25,26,-1,26,17,16,-1,17,26,27,-1,27,18,17,-1,18,27,28,-1,28,14,18,-1,15,28,29,-1,29,23,15,-1,23,29,30,-1,30,22,23,-1,22,30,31,-1,31,21,22,-1,21,31,24,-1,24,20,21,-1,34,32,37,-1,37,38,34,-1,46,48,37,-1,37,32,46,-1,35,33,32,-1,32,34,35,-1,47,46,32,-1,32,33,47,-1,33,36,53,-1,53,47,33,-1,40,41,42,-1,42,39,40,-1,49,39,42,-1,42,50,49,-1,44,40,39,-1,39,43,44,-1,51,43,39,-1,39,49,51,-1,43,51,52,-1,52,45,43,-1,55,54,58,-1,55,58,57,-1,55,57,56,-1,62,61,60,-1,60,59,65,-1,60,65,64,-1,62,60,64,-1,62,64,63,-1,37,54,55,-1,55,38,37,-1,41,55,56,-1,56,42,41,-1,42,56,57,-1,57,50,42,-1,50,57,58,-1,58,48,50,-1,48,58,54,-1,54,37,48,-1,47,59,60,-1,60,46,47,-1,46,60,61,-1,61,48,46,-1,48,61,62,-1,62,50,48,-1,50,62,63,-1,63,49,50,-1,49,63,64,-1,64,51,49,-1,51,64,65,-1,65,52,51,-1,53,65,59,-1,59,47,53,-1});
  }
}

...
public class abox implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/abox.new.java.x3d");
    model.toFileJSON("../data/abox.new.java.x3dj");
    }
...
ProtoInstance ProtoInstance1 = null;
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("abox.x3d")))

        ...
        .addChild(new Transform().setDEF("ScubaTank")
          ...
          .addChild(new Transform().setTranslation(new float[] {0f,-0.35f,0f})
            .addChild(new Shape().setDEF("tankBottom")
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF("black").setAmbientIntensity(0.3000f).setDiffuseColor(new float[] {0f,0f,0f})))
              .setGeometry(new Cylinder().setHeight(0.0600f).setRadius(0.1150f))))
...
protected class MFColor0 {
  protected org.web3d.x3d.jsail.fields.MFColor getArray() {
    return new org.web3d.x3d.jsail.fields.MFColor(new float[] {0.6000f,0.6000f,0.6000f});
  }
}
}

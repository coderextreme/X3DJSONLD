...
public class bumpyfreewrl implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/bumpyfreewrl.new.java.x3d");
    model.toFileJSON("../data/bumpyfreewrl.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("bumpyfreewrl.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/bumpfreewrl.x3d"))))
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("bumpyx_ite.x3d")))

                        ...
                        .addChild(new Billboard()
                          .addChild(new Shape()
                            .setGeometry(new Text().setString(new MFString53().getArray())
                              .setFontStyle(new FontStyle().setSize(0.035f )))))))
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName(new SFString("l_metatarsophalangeal_2")).setDEF(new SFString("hanim_l_metatarsophalangeal_2")).setCenter(new float[] {0.0824f ,0.0064f ,-0.004f })))))
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName(new SFString("r_talocrural")).setDEF(new SFString("hanim_r_talocrural")).setCenter(new float[] {-0.0801f ,0.0712f ,-0.0766f })
                    .addChild(new HAnimSegment("hanim_r_talocrural").setName(new SFString("r_talus")).setDEF(new SFString("hanim_r_talus"))
                      ...
                      .addChild(new HAnimSite("hanim_r_talus").setName(new SFString("r_calcaneus_posterior")).setDEF(new SFString("hanim_r_calcaneus_posterior")).setTranslation(new float[] {-0.0692f ,0.0297f ,-0.1221f })
                        ...
                        .addChild(new Billboard()
                          .addChild(new Shape()
                            .setGeometry(new Text().setString(new MFString67().getArray())
                              .setFontStyle(new FontStyle().setSize(0.035f ))))))
                        ...
                        .addChild(new Billboard()
                          .addChild(new Shape()
                            .setGeometry(new Text().setString(new MFString68().getArray())
                              .setFontStyle(new FontStyle().setSize(0.035f )))))))
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName(new SFString("r_metatarsophalangeal_2")).setDEF(new SFString("hanim_r_metatarsophalangeal_2")).setCenter(new float[] {-0.0823f ,0.0064f ,-0.004f }))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("vl5")).setDEF(new SFString("hanim_vl5")).setCenter(new float[] {0.0028f ,1.0568f ,-0.0776f })
              .addChild(new HAnimSegment("hanim_vl5").setName(new SFString("l5")).setDEF(new SFString("hanim_l5"))
                ...
                .addChild(new HAnimSite("hanim_l5").setName(new SFString("navel")).setDEF(new SFString("hanim_navel")).setTranslation(new float[] {0.0069f ,1.0966f ,0.1017f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString83().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                ...
                .addChild(new HAnimSite("hanim_l5").setName(new SFString("r_clavicale")).setDEF(new SFString("hanim_r_clavicale")).setTranslation(new float[] {-0.0115f ,1.4943f ,0.04f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString89().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                ...
                .addChild(new HAnimSite("hanim_l5").setName(new SFString("r_rib10")).setDEF(new SFString("hanim_r_rib10")).setTranslation(new float[] {-0.0711f ,1.1941f ,0.1016f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString91().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                ...
                .addChild(new Shape()
                  .setGeometry(new LineSet().setVertexCount(new MFInt32102().getArray())
                    ...
                    .setColor(new ColorRGBA().setUSE(new SFString("HAnimSegmentLineColorRGBA"))))))
              .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("skullbase")).setDEF(new SFString("hanim_skullbase")).setCenter(new float[] {0.0044f ,1.6209f ,0.0236f }))
              .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("l_shoulder")).setDEF(new SFString("hanim_l_shoulder")).setCenter(new float[] {0.2029f ,1.4376f ,-0.0387f })
              ...
              .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("r_shoulder")).setDEF(new SFString("hanim_r_shoulder")).setCenter(new float[] {-0.1907f ,1.4407f ,-0.0325f })

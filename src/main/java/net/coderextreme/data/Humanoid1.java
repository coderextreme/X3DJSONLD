...
public class Humanoid1 implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/Humanoid1.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Humanoid1.x3d"))
                        ...
                        .addChild(new Billboard()
                          .addChild(new Shape()
                            .setGeometry(new Text().setString(new MFString63().getArray())
                              .setFontStyle(new FontStyle().setSize(0.035f )))))))
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new float[] {0.0824f ,0.0064f ,-0.004f }).setUlimit(new MFFloat64().getArray()).setLlimit(new MFFloat65().getArray())))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-0.095f ,0.9171f ,0.0029f }).setUlimit(new MFFloat66().getArray()).setLlimit(new MFFloat67().getArray())
                    ...
                    .addChild(new Billboard()
                      .addChild(new Shape()
                        .setGeometry(new Text().setString(new MFString73().getArray())
                          .setFontStyle(new FontStyle().setSize(0.035f )))))))
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-0.0867f ,0.4913f ,0.0318f }).setUlimit(new MFFloat74().getArray()).setLlimit(new MFFloat75().getArray())
                      ...
                      .addChild(new Billboard()
                        .addChild(new Shape()
                          .setGeometry(new Text().setString(new MFString80().getArray())
                            .setFontStyle(new FontStyle().setSize(0.035f )))))))
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-0.0801f ,0.0712f ,-0.0766f }).setUlimit(new MFFloat81().getArray()).setLlimit(new MFFloat82().getArray())
                        ...
                        .addChild(new Billboard()
                          .addChild(new Shape()
                            .setGeometry(new Text().setString(new MFString86().getArray())
                              .setFontStyle(new FontStyle().setSize(0.035f )))))))
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new float[] {-0.0823f ,0.0064f ,-0.004f }).setUlimit(new MFFloat87().getArray()).setLlimit(new MFFloat88().getArray()))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0.0028f ,1.0568f ,-0.0776f }).setUlimit(new MFFloat89().getArray()).setLlimit(new MFFloat90().getArray())
              .addChild(new HAnimSegment("hanim_vl5").setName("l5").setDEF("hanim_l5")
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString93().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("cervicale").setDEF("hanim_cervicale").setTranslation(new float[] {0.0064f ,1.52f ,-0.0815f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString94().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("l_acromion").setDEF("hanim_l_acromion").setTranslation(new float[] {0.2032f ,1.476f ,-0.049f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString95().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("l_axilla_distal").setDEF("hanim_l_axilla_distal").setTranslation(new float[] {0.1706f ,1.4072f ,-0.0875f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString97().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("l_axilla_proximal").setDEF("hanim_l_axilla_proximal").setTranslation(new float[] {0.1777f ,1.4065f ,-0.0075f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString99().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("l_clavicale").setDEF("hanim_l_clavicale").setTranslation(new float[] {0.0271f ,1.4943f ,0.0394f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString100().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("l_neck_base").setDEF("hanim_l_neck_base").setTranslation(new float[] {0.0646f ,1.5141f ,-0.038f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString101().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("l_rib10").setDEF("hanim_l_rib10").setTranslation(new float[] {0.0871f ,1.1925f ,0.0992f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString102().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("l_thelion").setDEF("hanim_l_thelion").setTranslation(new float[] {0.0918f ,1.3382f ,0.1192f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString105().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("r_acromion").setDEF("hanim_r_acromion").setTranslation(new float[] {-0.1905f ,1.4791f ,-0.0431f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString106().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("r_axilla_distal").setDEF("hanim_r_axilla_distal").setTranslation(new float[] {-0.1603f ,1.4098f ,-0.0826f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString108().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("r_axilla_proximal").setDEF("hanim_r_axilla_proximal").setTranslation(new float[] {-0.1626f ,1.4072f ,-0.0031f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString110().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("r_clavicale").setDEF("hanim_r_clavicale").setTranslation(new float[] {-0.0115f ,1.4943f ,0.04f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString111().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("r_neck_base").setDEF("hanim_r_neck_base").setTranslation(new float[] {-0.0419f ,1.5149f ,-0.022f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString112().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("r_rib10").setDEF("hanim_r_rib10").setTranslation(new float[] {-0.0711f ,1.1941f ,0.1016f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString113().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("r_thelion").setDEF("hanim_r_thelion").setTranslation(new float[] {-0.0736f ,1.3385f ,0.1217f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString117().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("substernale").setDEF("hanim_substernale").setTranslation(new float[] {0.0085f ,1.2995f ,0.1147f })
                  ...
                  .addChild(new Billboard()
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString118().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f ))))))
                .addChild(new HAnimSite("hanim_l5").setName("suprasternale").setDEF("hanim_suprasternale").setTranslation(new float[] {0.0084f ,1.4714f ,0.0551f })
                ...
                .addChild(new Shape()
                  .setGeometry(new LineSet().setVertexCount(new MFInt32124().getArray())
                    ...
                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
              .addChild(new HAnimJoint("hanim_vl5").setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0.0044f ,1.6209f ,0.0236f }).setUlimit(new MFFloat126().getArray()).setLlimit(new MFFloat127().getArray()))
              .addChild(new HAnimJoint("hanim_vl5").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {0.2029f ,1.4376f ,-0.0387f }).setUlimit(new MFFloat128().getArray()).setLlimit(new MFFloat129().getArray())
                    ...
                    .addChild(new Billboard()
                      .addChild(new Shape()
                        .setGeometry(new Text().setString(new MFString133().getArray())
                          .setFontStyle(new FontStyle().setSize(0.035f )))))))
                .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {0.2014f ,1.1357f ,-0.0682f }).setUlimit(new MFFloat134().getArray()).setLlimit(new MFFloat135().getArray())
                      ...
                      .addChild(new Billboard()
                        .addChild(new Shape()
                          .setGeometry(new Text().setString(new MFString141().getArray())
                            .setFontStyle(new FontStyle().setSize(0.035f )))))))
                  .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {0.1984f ,0.8663f ,-0.0583f }).setUlimit(new MFFloat142().getArray()).setLlimit(new MFFloat143().getArray()))))
              .addChild(new HAnimJoint("hanim_vl5").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-0.1907f ,1.4407f ,-0.0325f }).setUlimit(new MFFloat144().getArray()).setLlimit(new MFFloat145().getArray())
                    ...
                    .addChild(new Billboard()
                      .addChild(new Shape()
                        .setGeometry(new Text().setString(new MFString149().getArray())
                          .setFontStyle(new FontStyle().setSize(0.035f )))))))
                .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-0.1949f ,1.1388f ,-0.062f }).setUlimit(new MFFloat150().getArray()).setLlimit(new MFFloat151().getArray())
                      ...
                      .addChild(new Billboard()
                        .addChild(new Shape()
                          .setGeometry(new Text().setString(new MFString157().getArray())
                            .setFontStyle(new FontStyle().setSize(0.035f )))))))
                  .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-0.1959f ,0.8694f ,-0.0521f }).setUlimit(new MFFloat158().getArray()).setLlimit(new MFFloat159().getArray()))))))

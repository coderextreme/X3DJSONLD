          ...
          .setProtoBody(new ProtoBodyObject()
            .addChild(new TransformObject()
              ...
              .addChild(new ShapeObject()
                ...
                .setGeometry(new SphereObject().setRadius(5.699999988079071f))))))
        .addChild(new ProtoDeclareObject().setName("org")
          ...
          .setProtoBody(new ProtoBodyObject()
            .addChild(new TransformObject()
              ...
              .addChild(new ShapeObject()
                .setAppearance(new AppearanceObject()
                  .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0f,1f,1f}).setTransparency(0.400000005960464f)
                    .setIS(new ISObject()

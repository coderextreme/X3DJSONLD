    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setTranslation(new float[] {-468f,0f,315f})
          ...
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())).setDescription("People Express")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                ...
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())).setDescription("QArts/Studios")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0.600000023841858f,0f,0.600000023841858f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray())).setDescription("First Movement")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {1f,0f,0.200000002980232f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray())).setDescription("City Arts")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0.600000023841858f,0f,0.600000023841858f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString6().getArray())).setDescription("Indigo Dance Group (Salamanda Tandem)")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0f,0.300000011920929f,1f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray())).setDescription("Watering Seeds")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0f,0.300000011920929f,1f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray())).setDescription("Fased In The Arts")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0f,0.300000011920929f,1f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString9().getArray())).setDescription("27a Access Artspace")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {1f,0f,0.200000002980232f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString10().getArray())).setDescription("Bamboozle Theatre Company")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0f,0.300000011920929f,1f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString11().getArray())).setDescription("Mantle Community Arts")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0f,0.300000011920929f,1f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString12().getArray())).setDescription("Artlink East")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0f,0.300000011920929f,1f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString13().getArray())).setDescription("Creations")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0f,0.300000011920929f,1f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString14().getArray())).setDescription("New Perspectives")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {1f,0f,0.200000002980232f})))
                .setGeometry(new Sphere().setRadius(5.10000002384186f)))))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString15().getArray())).setDescription("UKan2")
            .addChild(new Transform()
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}).setEmissiveColor(new float[] {0f,0.300000011920929f,1f})))

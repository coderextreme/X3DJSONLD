        ...
        .addChild(new ProtoDeclare().setName("i")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(ProtoInstance2 = new ProtoInstance().setName("org")
              .setIS(new IS()
                .addConnect(new connect().setNodeField("posi").setProtoField("pos"))))))
        .addChild(new Transform().setTranslation(new float[] {-468f,0f,315f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())).setDescription("People Express").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance4 = new ProtoInstance().setName("i")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())).setDescription("QArts/Studios").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance5 = new ProtoInstance().setName("i")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray())).setDescription("First Movement").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance6 = new ProtoInstance().setName("n")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray())).setDescription("City Arts").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance7 = new ProtoInstance().setName("i")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString6().getArray())).setDescription("Indigo Dance Group (Salamanda Tandem)").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance8 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray())).setDescription("Watering Seeds").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance9 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray())).setDescription("Fased In The Arts").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance10 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString9().getArray())).setDescription("27a Access Artspace").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance11 = new ProtoInstance().setName("n")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString10().getArray())).setDescription("Bamboozle Theatre Company").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance12 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString11().getArray())).setDescription("Mantle Community Arts").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance13 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString12().getArray())).setDescription("Artlink East").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance14 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString13().getArray())).setDescription("Creations").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance15 = new ProtoInstance().setName("r")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString14().getArray())).setDescription("New Perspectives").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(ProtoInstance16 = new ProtoInstance().setName("n")))
          .addChild(new Anchor().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString15().getArray())).setDescription("UKan2").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})

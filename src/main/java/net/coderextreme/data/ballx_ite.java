...
public class ballx_ite implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/ballx_ite.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("ballx_ite.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/ballx_ite.x3d")))

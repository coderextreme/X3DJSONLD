      ...
      .setScene(new SceneObject()
        .addChild(new ProtoDeclareObject().setAppinfo("HeadsUpDisplay positions child geometry in screen space, movable by the user").setName("HeadsUpDisplay")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setType("MFNode").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Displayed subscene positioned as a HUD.").setName("children")
              .addComments(new CommentsBlock(" default is null array of nodes ")))
            .addField(new fieldObject().setType("MFNode").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Additional HUD geometry which can be touched and dragged for repositioning. If this geometry goes offscreen (perhaps due to screen resizing) then it snaps back to original position.").setName("dragChildren")
              .addComments(new CommentsBlock(" default is null array of nodes ")))
            .addField(new fieldObject().setType("SFVec3f").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("Modified screen location and distance (for size).").setName("locationOffset").setValue("-2 -2 0"))
            .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("Enable/disable console output for troubleshooting.").setName("traceEnabled").setValue("false")))
                    ...
                    .addChild(new TransformObject().setTranslation(new float[] {0f,0f,-10f})
                      ...
                      .addChild(new GroupObject().setDEF("PlaneMovementSensorGroup")
                        ...
                        .addChild(new ScriptObject().setDEF("VisibilityControlScript")
                          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setName("traceEnabled"))
                          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setName("isVisible").setValue("true"))
                          .addField(new fieldObject().setType("SFVec3f").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setName("planeSensorTranslation").setValue("0 0 0"))
                          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setName("setIsVisible"))
                          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setName("setPlaneSensorIsActive"))
                          .addField(new fieldObject().setType("SFVec3f").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setName("setPlaneSensorTranslation"))
                          .addField(new fieldObject().setType("SFVec3f").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setName("translationChanged"))
                          .addField(new fieldObject().setType("SFVec3f").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setName("translationOffsetChanged"))
                          .setIS(new ISObject()

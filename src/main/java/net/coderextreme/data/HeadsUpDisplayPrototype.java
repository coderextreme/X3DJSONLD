          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new ProximitySensor().setDEF("WhereSensor").setSize(new float[] {1000000000f,1000000000f,1000000000f})
                .setIS(new IS("WhereSensor")
                  .addConnect(new connect().setNodeField("center").setProtoField("locationOffset"))))
              .addChild(new Transform().setDEF("FixedLocation")
                .addChild(new Transform("FixedLocation").setDEF("MovableLocation")
                  .addChild(new Transform("MovableLocation").setDEF("LocationOffset")
                    .setIS(new IS("LocationOffset")
                      .addConnect(new connect().setNodeField("translation").setProtoField("locationOffset")))
                    .addChild(new Transform("LocationOffset").setTranslation(new float[] {0f,0f,-10f})
                      .addChild(new Group()
                        .setIS(new IS()
                          .addConnect(new connect().setNodeField("children").setProtoField("children"))))
                      .addChild(new Group().setDEF("PlaneMovementSensorGroup")
                        .addChild(new Group("PlaneMovementSensorGroup").setDEF("DragGeometry")
                          .setIS(new IS("DragGeometry")
                            .addConnect(new connect().setNodeField("children").setProtoField("dragChildren"))))
                        .addChild(new PlaneSensor("PlaneMovementSensorGroup").setDEF("PlaneMovementSensor").setDescription("click and drag to move interface")
                          .setIS(new IS("PlaneMovementSensor")
                            .addConnect(new connect().setNodeField("offset").setProtoField("locationOffset"))))
                        .addChild(new VisibilitySensor("PlaneMovementSensorGroup").setDEF("MovementVisibilitySensor"))
                        .addChild(new Script("PlaneMovementSensorGroup").setDEF("VisibilityControlScript")
                          .addField(new field("VisibilityControlScript").setType("SFBool").setName("traceEnabled").setAccessType(field.ACCESSTYPE_INITIALIZEONLY))
                          .addField(new field("VisibilityControlScript").setType("SFBool").setName("isVisible").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue("true"))
                          .addField(new field("VisibilityControlScript").setType("SFVec3f").setName("planeSensorTranslation").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue("0 0 0"))
                          .addField(new field("VisibilityControlScript").setType("SFBool").setName("setIsVisible").setAccessType(field.ACCESSTYPE_INPUTONLY))
                          .addField(new field("VisibilityControlScript").setType("SFBool").setName("setPlaneSensorIsActive").setAccessType(field.ACCESSTYPE_INPUTONLY))
                          .addField(new field("VisibilityControlScript").setType("SFVec3f").setName("setPlaneSensorTranslation").setAccessType(field.ACCESSTYPE_INPUTONLY))
                          .addField(new field("VisibilityControlScript").setType("SFVec3f").setName("translationChanged").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
                          .addField(new field("VisibilityControlScript").setType("SFVec3f").setName("translationOffsetChanged").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
                          .setIS(new IS("VisibilityControlScript")
...
"}"))
                        .addChild(new ROUTE("PlaneMovementSensorGroup").setFromField("isActive").setFromNode("PlaneMovementSensor").setToField("setPlaneSensorIsActive").setToNode("VisibilityControlScript"))
                        .addChild(new ROUTE("PlaneMovementSensorGroup").setFromField("translation_changed").setFromNode("PlaneMovementSensor").setToField("setPlaneSensorTranslation").setToNode("VisibilityControlScript"))
                        .addChild(new ROUTE("PlaneMovementSensorGroup").setFromField("isActive").setFromNode("MovementVisibilitySensor").setToField("setIsVisible").setToNode("VisibilityControlScript")))))
                  .addChild(new ROUTE("MovableLocation").setFromField("translation_changed").setFromNode("PlaneMovementSensor").setToField("set_translation").setToNode("MovableLocation"))
                  .addChild(new ROUTE("MovableLocation").setFromField("translationChanged").setFromNode("VisibilityControlScript").setToField("set_translation").setToNode("MovableLocation"))
                  .addChild(new ROUTE("MovableLocation").setFromField("translationOffsetChanged").setFromNode("VisibilityControlScript").setToField("set_offset").setToNode("PlaneMovementSensor"))))

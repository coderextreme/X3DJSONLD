    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Young").setDEF("hanim_Young").setScale(new double[] {0.0225,0.0225,0.0225}).setVersion("2.0")
          ...
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_Young").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new double[] {0,31.540001,-0.3172}).setContainerFieldOverride("skeleton"))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("l_hip").setDEF("hanim_l_hip").setCenter(new double[] {3.504,29.040001,-0.4027})
              ...
              .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new double[] {3.414,14.95,-0.4549})
                ...
                .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new double[] {3.18,3.449,-0.3088})
                  ...
                  .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new double[] {3.18,3.189,0.9724})
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("r_hip").setDEF("hanim_r_hip").setCenter(new double[] {-3.504,29.040001,-0.4027})
              ...
              .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new double[] {-3.414,14.95,-0.4549})
                ...
                .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new double[] {-3.18,3.449,-0.3088})
                  ...
                  .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new double[] {-3.18,3.189,0.9724})
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new double[] {0,27.07,-0.3172})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new double[] {5.441,45.830002,0.1786})
                ...
                .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new double[] {6.823,36.080002,0.08607})
                  ...
                  .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new double[] {6.915,28.41,0.3752})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new double[] {-5.441,45.830002,0.1786})
                ...
                .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new double[] {-6.823,36.080002,0.08607})
                  ...
                  .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new double[] {-6.915,28.41,0.3752})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("vl5").setDEF("hanim_vl5").setCenter(new double[] {0,35.75,-0.445})
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("skullbase").setDEF("hanim_skullbase").setCenter(new double[] {0,50.470001,-0.1481})
                    ...
                    .addChild(new Transform().setTranslation(new double[] {0,50.470001,-0.1481})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3277().getArray().append(new MFInt3278().getArray())).setCreaseAngle(1.57).setTexCoordIndex(new MFInt3279().getArray().append(new MFInt3280().getArray()))

  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("Young").setPosition(new float[] {0f,1f,3f}).setCenterOfRotation(new float[] {0f,1f,0f}))
        .addChild(new HAnimHumanoid().setDEF("hanim_Young").setVersion("2.0").setName("Young").setScale(new float[] {0.0225f,0.0225f,0.0225f})
          .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            .setMetadata(new MetadataString().setName("humanoidVersion").setValue(new MFString0().getArray())))
          .addSkeleton(new HAnimJoint("hanim_Young").setDEF("hanim_humanoid_root").setName("humanoid_root").setCenter(new float[] {0f,31.54f,-0.3172f})
            .addChild(new HAnimSegment("hanim_humanoid_root").setDEF("hanim_sacrum").setName("sacrum")
              .addChild(new Transform().setTranslation(new float[] {0f,31.54f,-0.3172f})
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                    .setTexture(new ImageTexture().setDEF("YoungTextureAtlas").setUrl(new MFString1().getArray())))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt322().getArray()).setCoordIndex(new MFInt323().getArray())
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f4().getArray()))
                    .setCoord(new Coordinate().setPoint(new MFVec3f5().getArray()))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_l_hip").setName("l_hip").setCenter(new float[] {3.504f,29.04f,-0.4027f})
              .addChild(new HAnimSegment("hanim_l_hip").setDEF("hanim_l_thigh").setName("l_thigh")
                .addChild(new Transform().setTranslation(new float[] {3.504f,29.04f,-0.4027f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt326().getArray()).setCoordIndex(new MFInt327().getArray())
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f8().getArray()))
                      .setCoord(new Coordinate().setPoint(new MFVec3f9().getArray()))))))
              .addChild(new HAnimJoint("hanim_l_hip").setDEF("hanim_l_knee").setName("l_knee").setCenter(new float[] {3.414f,14.95f,-0.4549f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {3.414f,14.95f,-0.4549f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3210().getArray()).setCoordIndex(new MFInt3211().getArray())
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f12().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f13().getArray()))))))
                .addChild(new HAnimJoint("hanim_l_knee").setDEF("hanim_l_talocrural").setName("l_talocrural").setCenter(new float[] {3.18f,3.449f,-0.3088f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {3.18f,3.449f,-0.3088f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3214().getArray()).setCoordIndex(new MFInt3215().getArray())
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f16().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f17().getArray()))))))
                  .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_metatarsophalangeal_1").setName("l_metatarsophalangeal_2").setCenter(new float[] {3.18f,3.189f,0.9724f})
                    .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_1").setDEF("hanim_l_tarsal_proximal_phalanx_1").setName("l_tarsal_proximal_phalanx_2")
                      .addChild(new Transform().setTranslation(new float[] {3.18f,3.189f,0.9724f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3218().getArray()).setCoordIndex(new MFInt3219().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f20().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f21().getArray()))))))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-3.504f,29.04f,-0.4027f})
                ...
                .addChild(new Transform().setTranslation(new float[] {-3.504f,29.04f,-0.4027f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3222().getArray()).setCoordIndex(new MFInt3223().getArray())
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f24().getArray()))
                      .setCoord(new Coordinate().setPoint(new MFVec3f25().getArray()))))))
              .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-3.414f,14.95f,-0.4549f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-3.414f,14.95f,-0.4549f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3226().getArray()).setCoordIndex(new MFInt3227().getArray())
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f28().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f29().getArray()))))))
                .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_talocrural").setName("r_talocrural").setCenter(new float[] {-3.18f,3.449f,-0.3088f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-3.18f,3.449f,-0.3088f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3230().getArray()).setCoordIndex(new MFInt3231().getArray())
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f32().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f33().getArray()))))))
                  .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_metatarsophalangeal_1").setName("r_metatarsophalangeal_2").setCenter(new float[] {-3.18f,3.189f,0.9724f})
                    .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_1").setDEF("hanim_r_tarsal_proximal_phalanx_1").setName("r_tarsal_proximal_phalanx_2")
                      .addChild(new Transform().setTranslation(new float[] {-3.18f,3.189f,0.9724f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3234().getArray()).setCoordIndex(new MFInt3235().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f36().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f37().getArray()))))))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f,27.07f,-0.3172f})
                ...
                .addChild(new Transform().setTranslation(new float[] {0f,27.07f,-0.3172f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3238().getArray()).setCoordIndex(new MFInt3239().getArray())
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f40().getArray()))
                      .setCoord(new Coordinate().setPoint(new MFVec3f41().getArray()))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {5.441f,45.83f,0.1786f})
                .addChild(new HAnimSegment("hanim_l_shoulder").setDEF("hanim_l_upperarm").setName("l_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {5.441f,45.83f,0.1786f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3242().getArray()).setCoordIndex(new MFInt3243().getArray())
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f44().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f45().getArray()))))))
                .addChild(new HAnimJoint("hanim_l_shoulder").setDEF("hanim_l_elbow").setName("l_elbow").setCenter(new float[] {6.823f,36.08f,0.08607f})
                  .addChild(new HAnimSegment("hanim_l_elbow").setDEF("hanim_l_forearm").setName("l_forearm")
                    .addChild(new Transform().setTranslation(new float[] {6.823f,36.08f,0.08607f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3246().getArray()).setCoordIndex(new MFInt3247().getArray())
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f48().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f49().getArray()))))))
                  .addChild(new HAnimJoint("hanim_l_elbow").setDEF("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(new float[] {6.915f,28.41f,0.3752f})
                      ...
                      .addChild(new Transform().setTranslation(new float[] {6.915f,28.41f,0.3752f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3250().getArray()).setCoordIndex(new MFInt3251().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f52().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f53().getArray())))))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-5.441f,45.83f,0.1786f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-5.441f,45.83f,0.1786f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3254().getArray()).setCoordIndex(new MFInt3255().getArray())
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f56().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f57().getArray()))))))
                .addChild(new HAnimJoint("hanim_r_shoulder").setDEF("hanim_r_elbow").setName("r_elbow").setCenter(new float[] {-6.823f,36.08f,0.08607f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-6.823f,36.08f,0.08607f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3258().getArray()).setCoordIndex(new MFInt3259().getArray())
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f60().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f61().getArray()))))))
                  .addChild(new HAnimJoint("hanim_r_elbow").setDEF("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(new float[] {-6.915f,28.41f,0.3752f})
                      ...
                      .addChild(new Transform().setTranslation(new float[] {-6.915f,28.41f,0.3752f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3262().getArray()).setCoordIndex(new MFInt3263().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f64().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f65().getArray())))))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_vl5").setName("vl5").setCenter(new float[] {0f,35.75f,-0.445f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0f,35.75f,-0.445f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3266().getArray().append(new MFInt3267().getArray())).setCoordIndex(new MFInt3268().getArray().append(new MFInt3269().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f70().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f71().getArray()))))))
                .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_skullbase").setName("skullbase").setCenter(new float[] {0f,50.47f,-0.1481f})
                  .addChild(new HAnimSegment("hanim_skullbase").setDEF("hanim_skull").setName("skull")
                    .addChild(new Transform().setTranslation(new float[] {0f,50.47f,-0.1481f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3272().getArray().append(new MFInt3273().getArray())).setCoordIndex(new MFInt3274().getArray().append(new MFInt3275().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f76().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f77().getArray()))))))))))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_l5"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_pelvis"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_sacrum"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_skull"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_l_calf"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_r_calf"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_l_carpal"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_r_carpal"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_l_forearm"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_r_forearm"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_l_talus"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_r_talus"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_l_tarsal_proximal_phalanx_1"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_r_tarsal_proximal_phalanx_1"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_l_thigh"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_r_thigh"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_l_upperarm"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_r_upperarm"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_humanoid_root"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_sacroiliac"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_skullbase"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_vl5"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_l_elbow"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_r_elbow"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_l_hip"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_r_hip"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_l_knee"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_r_knee"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_l_metatarsophalangeal_1"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_r_metatarsophalangeal_1"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_l_radiocarpal"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_r_radiocarpal"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_l_shoulder"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_r_shoulder"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_l_talocrural"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_r_talocrural"))))      ;
    return X3D0;
    }

          ...
          .addSkeleton(new HAnimJoint().setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f,31.540001f,-0.3172f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addChild(new Transform().setTranslation(new float[] {0f,31.540001f,-0.3172f})
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("YoungTextureAtlas").setUrl(new MFString6().getArray())))
            ...
            .addChild(new HAnimJoint().setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {3.504f,29.040001f,-0.4027f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addChild(new HAnimJoint().setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {3.414f,14.95f,-0.4549f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new float[] {3.18f,3.449f,-0.3088f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new float[] {3.18f,3.189f,0.9724f}).setStiffness(new float[] {0f,0f,0f})
            ...
            .addChild(new HAnimJoint().setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-3.504f,29.040001f,-0.4027f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addChild(new HAnimJoint().setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-3.414f,14.95f,-0.4549f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-3.18f,3.449f,-0.3088f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new float[] {-3.18f,3.189f,0.9724f}).setStiffness(new float[] {0f,0f,0f})
            ...
            .addChild(new HAnimJoint().setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new float[] {0f,27.07f,-0.3172f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addChild(new HAnimJoint().setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {5.441f,45.830002f,0.1786f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {6.823f,36.080002f,0.08607f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {6.915f,28.41f,0.3752f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addChild(new HAnimJoint().setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-5.441f,45.830002f,0.1786f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-6.823f,36.080002f,0.08607f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-6.915f,28.41f,0.3752f}).setStiffness(new float[] {0f,0f,0f})

  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("Sat, 30 Dec 2023 07:50:46 GMT"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_Young").setName("Young").setScale(new float[] {0.0225f,0.0225f,0.0225f})
              ...
              .addChild(new Transform().setTranslation(new float[] {0f,31.54f,-0.3172f})
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("YoungTextureAtlas").setUrl(new MFString2().getArray())))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt323().getArray()).setCoordIndex(new MFInt324().getArray())
              ...
              .addChild(new HAnimSegment("hanim_l_hip").setDEF("hanim_l_thigh").setName("l_thigh")
                .addChild(new Transform().setTranslation(new float[] {3.504f,29.04f,-0.4027f})
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt327().getArray()).setCoordIndex(new MFInt328().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new float[] {3.414f,14.95f,-0.4549f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3211().getArray()).setCoordIndex(new MFInt3212().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new float[] {3.18f,3.449f,-0.3088f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3215().getArray()).setCoordIndex(new MFInt3216().getArray())
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f17().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f18().getArray()))))))
                  .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(new float[] {3.18f,3.189f,0.9724f})
                      ...
                      .addChild(new Transform().setTranslation(new float[] {3.18f,3.189f,0.9724f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3219().getArray()).setCoordIndex(new MFInt3220().getArray())
                ...
                .addChild(new Transform().setTranslation(new float[] {-3.504f,29.04f,-0.4027f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3223().getArray()).setCoordIndex(new MFInt3224().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-3.414f,14.95f,-0.4549f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3227().getArray()).setCoordIndex(new MFInt3228().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-3.18f,3.449f,-0.3088f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3231().getArray()).setCoordIndex(new MFInt3232().getArray())
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f33().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f34().getArray()))))))
                  .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(new float[] {-3.18f,3.189f,0.9724f})
                      ...
                      .addChild(new Transform().setTranslation(new float[] {-3.18f,3.189f,0.9724f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3235().getArray()).setCoordIndex(new MFInt3236().getArray())
                ...
                .addChild(new Transform().setTranslation(new float[] {0f,27.07f,-0.3172f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3239().getArray()).setCoordIndex(new MFInt3240().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new float[] {5.441f,45.83f,0.1786f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3243().getArray()).setCoordIndex(new MFInt3244().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new float[] {6.823f,36.08f,0.08607f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3247().getArray()).setCoordIndex(new MFInt3248().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new float[] {6.915f,28.41f,0.3752f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3251().getArray()).setCoordIndex(new MFInt3252().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-5.441f,45.83f,0.1786f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3255().getArray()).setCoordIndex(new MFInt3256().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-6.823f,36.08f,0.08607f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3259().getArray()).setCoordIndex(new MFInt3260().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new float[] {-6.915f,28.41f,0.3752f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3263().getArray()).setCoordIndex(new MFInt3264().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0f,35.75f,-0.445f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3267().getArray().append(new MFInt3268().getArray())).setCoordIndex(new MFInt3269().getArray().append(new MFInt3270().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f71().getArray()))
                    ...
                    .addChild(new Transform().setTranslation(new float[] {0f,50.47f,-0.1481f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("YoungTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3273().getArray().append(new MFInt3274().getArray())).setCoordIndex(new MFInt3275().getArray().append(new MFInt3276().getArray()))
          ...
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_l_tarsal_proximal_phalanx_2"))
          .addSegments(new HAnimSegment("hanim_Young").setUSE("hanim_r_tarsal_proximal_phalanx_2"))
          ...
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_l_metatarsophalangeal_2"))
          .addJoints(new HAnimJoint("hanim_Young").setUSE("hanim_r_metatarsophalangeal_2"))

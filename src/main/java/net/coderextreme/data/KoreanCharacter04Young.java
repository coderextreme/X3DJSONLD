...
public class KoreanCharacter04Young implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/KoreanCharacter04Young.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("KoreanCharacter04Young.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("Image")).setContent(new SFString("../Poses/images/HAnimPoseExampleKoreanCharacter04Young.png")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter04Young.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("KoreanCharacter04Young.x3d")))
        .addChild(new NavigationInfo().setSpeed(1.5f ))
        .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,1f ,0f }).setDescription(new SFString("Young")).setPosition(new float[] {0f ,1f ,3f }))
        .addChild(new HAnimHumanoid().setName(new SFString("Young")).setDEF(new SFString("hanim_Young")).setScale(new float[] {0.0225f ,0.0225f ,0.0225f }).setVersion(new SFString("2.0"))
          ...
          .addSkeleton(new HAnimJoint("hanim_Young").setName(new SFString("humanoid_root")).setDEF(new SFString("hanim_humanoid_root")).setCenter(new float[] {0f ,31.540001f ,-0.3172f })
              ...
              .addChild(new Transform().setTranslation(new float[] {0f ,31.540001f ,-0.3172f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF(new SFString("YoungTextureAtlas")).setUrl(new MFString6().getArray())))
                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt327().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt328().getArray())
                    .setCoord(new Coordinate().setPoint(new MFVec3f9().getArray()))
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f10().getArray()))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("l_hip")).setDEF(new SFString("hanim_l_hip")).setCenter(new float[] {3.504f ,29.040001f ,-0.4027f })
              .addChild(new HAnimSegment("hanim_l_hip").setName(new SFString("l_thigh")).setDEF(new SFString("hanim_l_thigh"))
                .addChild(new Transform().setTranslation(new float[] {3.504f ,29.040001f ,-0.4027f })
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                      .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3211().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3212().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f13().getArray()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f14().getArray()))))))
              .addChild(new HAnimJoint("hanim_l_hip").setName(new SFString("l_knee")).setDEF(new SFString("hanim_l_knee")).setCenter(new float[] {3.414f ,14.95f ,-0.4549f })
                ...
                .addChild(new HAnimJoint("hanim_l_knee").setName(new SFString("l_talocrural")).setDEF(new SFString("hanim_l_talocrural")).setCenter(new float[] {3.18f ,3.449f ,-0.3088f })
                    ...
                    .addChild(new Transform().setTranslation(new float[] {3.18f ,3.449f ,-0.3088f })
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                          .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3219().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3220().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f21().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f22().getArray()))))))
                  .addChild(new HAnimJoint("hanim_l_talocrural").setName(new SFString("l_metatarsophalangeal_2")).setDEF(new SFString("hanim_l_metatarsophalangeal_2")).setCenter(new float[] {3.18f ,3.189f ,0.9724f })
                      ...
                      .addChild(new Transform().setTranslation(new float[] {3.18f ,3.189f ,0.9724f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                            .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3223().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3224().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f25().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f26().getArray()))))))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("r_hip")).setDEF(new SFString("hanim_r_hip")).setCenter(new float[] {-3.504f ,29.040001f ,-0.4027f })
              ...
              .addChild(new HAnimJoint("hanim_r_hip").setName(new SFString("r_knee")).setDEF(new SFString("hanim_r_knee")).setCenter(new float[] {-3.414f ,14.95f ,-0.4549f })
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-3.414f ,14.95f ,-0.4549f })
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                        .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3231().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3232().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f33().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f34().getArray()))))))
                .addChild(new HAnimJoint("hanim_r_knee").setName(new SFString("r_talocrural")).setDEF(new SFString("hanim_r_talocrural")).setCenter(new float[] {-3.18f ,3.449f ,-0.3088f })
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-3.18f ,3.449f ,-0.3088f })
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                          .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3235().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3236().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f37().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f38().getArray()))))))
                  .addChild(new HAnimJoint("hanim_r_talocrural").setName(new SFString("r_metatarsophalangeal_2")).setDEF(new SFString("hanim_r_metatarsophalangeal_2")).setCenter(new float[] {-3.18f ,3.189f ,0.9724f })
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName(new SFString("sacroiliac")).setDEF(new SFString("hanim_sacroiliac")).setCenter(new float[] {0f ,27.07f ,-0.3172f })
                ...
                .addChild(new Transform().setTranslation(new float[] {0f ,27.07f ,-0.3172f })
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                      .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3243().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3244().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f45().getArray()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f46().getArray()))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("l_shoulder")).setDEF(new SFString("hanim_l_shoulder")).setCenter(new float[] {5.441f ,45.830002f ,0.1786f })
                  ...
                  .addChild(new Transform().setTranslation(new float[] {5.441f ,45.830002f ,0.1786f })
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                        .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3247().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3248().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f49().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f50().getArray()))))))
                .addChild(new HAnimJoint("hanim_l_shoulder").setName(new SFString("l_elbow")).setDEF(new SFString("hanim_l_elbow")).setCenter(new float[] {6.823f ,36.080002f ,0.08607f })
                  ...
                  .addChild(new HAnimJoint("hanim_l_elbow").setName(new SFString("l_radiocarpal")).setDEF(new SFString("hanim_l_radiocarpal")).setCenter(new float[] {6.915f ,28.41f ,0.3752f })
                      ...
                      .addChild(new Transform().setTranslation(new float[] {6.915f ,28.41f ,0.3752f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                            .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3255().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3256().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f57().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f58().getArray())))))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("r_shoulder")).setDEF(new SFString("hanim_r_shoulder")).setCenter(new float[] {-5.441f ,45.830002f ,0.1786f })
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-5.441f ,45.830002f ,0.1786f })
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                        .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3259().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3260().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f61().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f62().getArray()))))))
                .addChild(new HAnimJoint("hanim_r_shoulder").setName(new SFString("r_elbow")).setDEF(new SFString("hanim_r_elbow")).setCenter(new float[] {-6.823f ,36.080002f ,0.08607f })
                  ...
                  .addChild(new HAnimJoint("hanim_r_elbow").setName(new SFString("r_radiocarpal")).setDEF(new SFString("hanim_r_radiocarpal")).setCenter(new float[] {-6.915f ,28.41f ,0.3752f })
                      ...
                      .addChild(new Transform().setTranslation(new float[] {-6.915f ,28.41f ,0.3752f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                            .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3267().getArray()).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3268().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f69().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f70().getArray())))))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("vl5")).setDEF(new SFString("hanim_vl5")).setCenter(new float[] {0f ,35.75f ,-0.445f })
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0f ,35.75f ,-0.445f })
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                        .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3271().getArray().append(new MFInt3272().getArray())).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3273().getArray().append(new MFInt3274().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f75().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f76().getArray()))))))
                .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("skullbase")).setDEF(new SFString("hanim_skullbase")).setCenter(new float[] {0f ,50.470001f ,-0.1481f })
                    ...
                    .addChild(new Transform().setTranslation(new float[] {0f ,50.470001f ,-0.1481f })
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                          .setTexture(new ImageTexture().setUSE(new SFString("YoungTextureAtlas"))))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3277().getArray().append(new MFInt3278().getArray())).setCreaseAngle(1.57f ).setTexCoordIndex(new MFInt3279().getArray().append(new MFInt3280().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f81().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f82().getArray()))))))))))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_humanoid_root")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_sacroiliac")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_skullbase")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_vl5")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_l_elbow")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_r_elbow")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_l_hip")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_r_hip")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_l_knee")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_r_knee")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_l_metatarsophalangeal_2")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_r_metatarsophalangeal_2")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_l_radiocarpal")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_r_radiocarpal")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_l_shoulder")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_r_shoulder")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_l_talocrural")))
          .addJoints(new HAnimJoint("hanim_Young").setUSE(new SFString("hanim_r_talocrural"))))
        .addChild(new EXPORT().setAS(new SFString("KoreanCharacter04Young")).setLocalDEF(new SFString("hanim_Young"))));
    return X3D0;
    }

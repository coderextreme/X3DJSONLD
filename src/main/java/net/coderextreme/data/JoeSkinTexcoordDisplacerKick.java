  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("info").setContent("Joe No Reservations 20161206 20161111 20160720 20121221 20040109 x3d/hanim"))
        ...
        .addMeta(new meta().setName("modified").setContent("19 October 2018"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setDEF("blue_Background").setSkyColor(new org.web3d.x3d.jsail.fields.MFColor(new MFColor1().getArray())).setTransparency(0f))
        ...
        .addChild(new Viewpoint().setDEF("Scene_ISideView").setCenterOfRotation(new float[] {0f,0.8f,0f}).setDescription("Scene_Side View").setOrientation(new float[] {0f,1f,0f,1.5708f}).setPosition(new float[] {2.6f,0.5f,0f}))
        .addChild(new Viewpoint().setDEF("Scene_BackView").setCenterOfRotation(new float[] {0f,1.5f,0f}).setDescription("Scene_Back View").setOrientation(new float[] {0f,1f,0f,3.14f}).setPosition(new float[] {0f,2.5f,-3f}))
        ...
        .addChild(new Group().setDEF("Joe_Humanoid").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new HAnimHumanoid().setName("Human").setDEF("Joe_Human").setVersion("2.0")
            .addJoints(new HAnimJoint().setName("humanoid_root").setDEF("Joe_HumanoidRoot").setCenter(new float[] {0f,0.875f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new HAnimSegment().setName("sacrum").setDEF("Joe_sacrum")
                .addChild(new HAnimSite().setName("RootFront").setDEF("Joe_RootFront").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new Transform().setDEF("hanimcordsys").setScale(new float[] {0.175f,0.175f,0.175f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new Viewpoint().setDEF("ViewBodyRootAxes").setDescription("Joe_HAnim Root Coordinate Axes View"))
                    .addChild(new Shape().setDEF("AxisLinesShape").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              ...
              .addChild(new HAnimJoint().setName("sacroiliac").setDEF("Joe_sacroiliac").setCenter(new float[] {0f,0.92f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt326().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat7().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new HAnimJoint().setName("l_hip").setDEF("Joe_l_hip").setCenter(new float[] {0.1f,0.92f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt328().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat9().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new HAnimJoint().setName("l_knee").setDEF("Joe_l_knee").setCenter(new float[] {0.115f,0.466f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3210().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat11().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new HAnimJoint().setName("l_ankle").setDEF("Joe_l_ankle").setCenter(new float[] {0.115f,0.069f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3212().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat13().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                      .addChild(new HAnimJoint().setName("l_subtalar").setDEF("Joe_l_subtalar").setCenter(new float[] {0.115f,0.031f,0.03f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3214().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat15().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new HAnimJoint().setName("l_midtarsal").setDEF("Joe_l_midtarsal").setCenter(new float[] {0.115f,0.037f,0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3216().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat17().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                          .addChild(new HAnimJoint().setName("l_metatarsal").setDEF("Joe_l_metatarsal").setCenter(new float[] {0.115f,0.02f,0.122f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3218().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat19().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))))))
                .addChild(new HAnimJoint().setName("r_hip").setDEF("Joe_r_hip").setCenter(new float[] {-0.1f,0.92f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3220().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat21().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new HAnimJoint().setName("r_knee").setDEF("Joe_r_knee").setCenter(new float[] {-0.05f,0.466f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3222().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat23().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new HAnimJoint().setName("r_ankle").setDEF("Joe_r_ankle").setCenter(new float[] {-0.115f,0.069f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3224().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat25().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                      .addChild(new HAnimJoint().setName("r_subtalar").setDEF("Joe_r_subtalar").setCenter(new float[] {-0.1f,0.015f,-0.01f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3226().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat27().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new HAnimJoint().setName("r_midtarsal").setDEF("Joe_r_midtarsal").setCenter(new float[] {-0.115f,0.037f,0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3228().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat29().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                          .addChild(new HAnimJoint().setName("r_metatarsal").setDEF("Joe_r_metatarsal").setCenter(new float[] {-0.1f,0.01f,0.14f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3230().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat31().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))))))))
              .addChild(new HAnimJoint().setName("vl5").setDEF("Joe_vl5").setCenter(new float[] {0f,1.045f,-0.095f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3232().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat33().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new HAnimJoint().setName("vl4").setDEF("Joe_vl4").setCenter(new float[] {0f,1.068f,-0.085f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .addChild(new HAnimJoint().setName("vl3").setDEF("Joe_vl3").setCenter(new float[] {0f,1.092f,-0.0725f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                    .addChild(new HAnimJoint().setName("vl2").setDEF("Joe_vl2").setCenter(new float[] {0f,1.12f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3234().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat35().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                      .addChild(new HAnimJoint().setName("vl1").setDEF("Joe_vl1").setCenter(new float[] {0f,1.1459f,-0.0625f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                        .addChild(new HAnimJoint().setName("vt12").setDEF("Joe_vt12").setCenter(new float[] {0f,1.179f,-0.068f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                          .addChild(new HAnimJoint().setName("vt11").setDEF("Joe_vt11").setCenter(new float[] {0f,1.2679f,-0.081f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                            .addChild(new HAnimJoint().setName("vt10").setDEF("Joe_vt10").setCenter(new float[] {0f,1.242f,-0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3236().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat37().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                              .addChild(new HAnimJoint().setName("vt9").setDEF("Joe_vt9").setCenter(new float[] {0f,1.268f,-0.1f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3238().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat39().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                .addChild(new HAnimJoint().setName("vt8").setDEF("Joe_vt8").setCenter(new float[] {0f,1.294f,-0.11f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                  .addChild(new HAnimJoint().setName("vt7").setDEF("Joe_vt7").setCenter(new float[] {0f,1.323f,-0.1155f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                    .addChild(new HAnimJoint().setName("vt6").setDEF("Joe_vt6").setCenter(new float[] {0f,1.352f,-0.12f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                      .addChild(new HAnimJoint().setName("vt5").setDEF("Joe_vt5").setCenter(new float[] {0f,1.381f,-0.1235f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                        .addChild(new HAnimJoint().setName("vt4").setDEF("Joe_vt4").setCenter(new float[] {0f,1.41f,-0.1235f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3240().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat41().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                          .addChild(new HAnimJoint().setName("vt3").setDEF("Joe_vt3").setCenter(new float[] {0f,1.438f,-0.12f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                            .addChild(new HAnimJoint().setName("vt2").setDEF("Joe_vt2").setCenter(new float[] {0f,1.468f,-0.105f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                              .addChild(new HAnimJoint().setName("vt1").setDEF("Joe_vt1").setCenter(new float[] {0f,1.497f,-0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3242().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat43().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                .addChild(new HAnimJoint().setName("vc7").setDEF("Joe_vc7").setCenter(new float[] {0f,1.525f,-0.072f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3244().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat45().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                  .addChild(new HAnimJoint().setName("vc6").setDEF("Joe_vc6").setCenter(new float[] {0f,1.54f,-0.05f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                    .addChild(new HAnimJoint().setName("vc5").setDEF("Joe_vc5").setCenter(new float[] {0f,1.552f,-0.035f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                      .addChild(new HAnimJoint().setName("vc4").setDEF("Joe_vc4").setCenter(new float[] {0f,1.5675f,-0.0256f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                        .addChild(new HAnimJoint().setName("vc3").setDEF("Joe_vc3").setCenter(new float[] {0f,1.58225f,-0.0185f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                          .addChild(new HAnimJoint().setName("vc2").setDEF("Joe_vc2").setCenter(new float[] {0f,1.595f,-0.0175f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                            .addChild(new HAnimJoint().setName("vc1").setDEF("Joe_vc1").setCenter(new float[] {0f,1.61f,-0.015f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("skullbase").setDEF("Joe_skullbase").setCenter(new float[] {0f,1.63f,-0.01f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3246().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat47().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addDisplacers(new HAnimDisplacer().setName("skull_tip_raiser_action").setDEF("Joe_skull_tipTest").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3248().getArray())).setDisplacements(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f49().getArray())))
                                                                .addChild(new HAnimJoint().setName("l_eyelid_joint").setDEF("Joe_l_eyelid_joint").setCenter(new float[] {0.034f,1.659f,0.06f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                                                                .addChild(new HAnimJoint().setName("l_eyeball_joint").setDEF("Joe_l_eyeball_joint").setCenter(new float[] {0.034f,1.659f,0.06f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                                                                .addChild(new HAnimJoint().setName("l_eyebrow_joint").setDEF("Joe_l_eyebrow_joint").setCenter(new float[] {0.034f,1.659f,0.06f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                                                                .addChild(new HAnimJoint().setName("l_eyelid_joint").setDEF("Joe_r_eyelid_joint").setCenter(new float[] {-0.034f,1.659f,0.06f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                                                                .addChild(new HAnimJoint().setName("l_eyeball_joint").setDEF("Joe_r_eyeball_joint").setCenter(new float[] {-0.034f,1.659f,0.06f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                                                                .addChild(new HAnimJoint().setName("l_eyebrow_joint").setDEF("Joe_r_eyebrow_joint").setCenter(new float[] {-0.034f,1.659f,0.06f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
                                                                .addChild(new HAnimJoint().setName("temporomandibular").setDEF("Joe_temporomandibular").setCenter(new float[] {0.034f,1.659f,0.06f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))))))))
                                                  .addChild(new HAnimJoint().setName("l_sternoclavicular").setDEF("Joe_l_sternoclavicular").setCenter(new float[] {0.082f,1.4488f,-0.0353f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3250().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat51().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                    .addChild(new HAnimJoint().setName("l_acromioclavicular").setDEF("Joe_l_acromioclavicular").setCenter(new float[] {0.0962f,1.4269f,-0.0424f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3252().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat53().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                      .addChild(new HAnimJoint().setName("l_shoulder").setDEF("Joe_l_shoulder").setCenter(new float[] {0.2f,1.44f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3254().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat55().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                        .addChild(new HAnimJoint().setName("l_elbow").setDEF("Joe_l_elbow").setCenter(new float[] {0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3256().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat57().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                          .addChild(new HAnimJoint().setName("l_wrist").setDEF("Joe_l_wrist").setCenter(new float[] {0.2f,0.87f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3258().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat59().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                            .addChild(new HAnimJoint().setName("l_thumb1").setDEF("Joe_l_thumb1").setCenter(new float[] {0.1924f,0.8472f,-0.0534f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3260().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat61().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("l_thumb2").setDEF("Joe_l_thumb2").setCenter(new float[] {0.1951f,0.8226f,0.0246f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3262().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat63().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("l_thumb3").setDEF("Joe_l_thumb3").setCenter(new float[] {0.1955f,0.8159f,0.0464f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3264().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat65().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))))
                                                            .addChild(new HAnimJoint().setName("l_index0").setDEF("Joe_l_index0").setCenter(new float[] {0.1983f,0.8024f,-0.028f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3266().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat67().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("l_index1").setDEF("Joe_l_index1").setCenter(new float[] {0.1983f,0.7815f,-0.028f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3268().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat69().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("l_index2").setDEF("Joe_l_index2").setCenter(new float[] {0.2017f,0.7363f,-0.0248f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3270().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat71().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                  .addChild(new HAnimJoint().setName("l_index3").setDEF("Joe_l_index3").setCenter(new float[] {0.2028f,0.7139f,-0.0236f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3272().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat73().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))))
                                                            .addChild(new HAnimJoint().setName("l_middle0").setDEF("Joe_l_middle0").setCenter(new float[] {0.1987f,0.8029f,-0.053f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3274().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat75().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("l_middle1").setDEF("Joe_l_middle1").setCenter(new float[] {0.1987f,0.7818f,-0.053f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3276().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat77().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("l_middle2").setDEF("Joe_l_middle2").setCenter(new float[] {0.2013f,0.7273f,-0.0503f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3278().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat79().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                  .addChild(new HAnimJoint().setName("l_middle3").setDEF("Joe_l_middle3").setCenter(new float[] {0.2026f,0.7011f,-0.0494f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3280().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat81().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))))
                                                            .addChild(new HAnimJoint().setName("l_ring0").setDEF("Joe_l_ring0").setCenter(new float[] {0.1956f,0.8019f,-0.0794f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3282().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat83().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("l_ring1").setDEF("Joe_l_ring1").setCenter(new float[] {0.1956f,0.7815f,-0.0794f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3284().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat85().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("l_ring2").setDEF("Joe_l_ring2").setCenter(new float[] {0.1973f,0.7287f,-0.0777f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3286().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat87().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                  .addChild(new HAnimJoint().setName("l_ring3").setDEF("Joe_l_ring3").setCenter(new float[] {0.1983f,0.7045f,-0.0767f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3288().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat89().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))))
                                                            .addChild(new HAnimJoint().setName("l_pinky0").setDEF("Joe_l_pinky0").setCenter(new float[] {0.1925f,0.8066f,-0.1036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3290().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat91().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("l_pinky1").setDEF("Joe_l_pinky1").setCenter(new float[] {0.1925f,0.7866f,-0.1036f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3292().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat93().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("l_pinky2").setDEF("Joe_l_pinky2").setCenter(new float[] {0.1938f,0.7452f,-0.1024f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3294().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat95().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                  .addChild(new HAnimJoint().setName("l_pinky3").setDEF("Joe_l_pinky3").setCenter(new float[] {0.1948f,0.7277f,-0.1017f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3296().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat97().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))))))))))
                                                  .addChild(new HAnimJoint().setName("r_sternoclavicular").setDEF("Joe_r_sternoclavicular").setCenter(new float[] {-0.03f,1.46f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3298().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat99().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                    .addChild(new HAnimJoint().setName("r_acromioclavicular").setDEF("Joe_r_acromioclavicular").setCenter(new float[] {-0.09f,1.41f,-0.11f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32100().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat101().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                      .addChild(new HAnimJoint().setName("r_shoulder").setDEF("Joe_r_shoulder").setCenter(new float[] {-0.2f,1.44f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32102().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat103().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                        .addChild(new HAnimJoint().setName("r_elbow").setDEF("Joe_r_elbow").setCenter(new float[] {-0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32104().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat105().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                          .addChild(new HAnimJoint().setName("r_wrist").setDEF("Joe_r_wrist").setCenter(new float[] {-0.2f,0.89f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32106().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat107().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                            .addChild(new HAnimJoint().setName("r_thumb1").setDEF("Joe_r_thumb1").setCenter(new float[] {-0.2f,0.85f,0f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32108().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat109().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("r_thumb2").setDEF("Joe_r_thumb2").setCenter(new float[] {-0.2f,0.82f,0.03f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32110().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat111().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("r_thumb3").setDEF("Joe_r_thumb3").setCenter(new float[] {-0.2f,0.8f,0.05f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32112().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat113().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))))
                                                            .addChild(new HAnimJoint().setName("r_index0").setDEF("Joe_r_index0").setCenter(new float[] {-0.2f,0.84f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32114().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat115().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("r_index1").setDEF("Joe_r_index1").setCenter(new float[] {-0.2f,0.793f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32116().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat117().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("r_index2").setDEF("Joe_r_index2").setCenter(new float[] {-0.2f,0.745f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32118().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat119().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                  .addChild(new HAnimJoint().setName("r_index3").setDEF("Joe_r_index3").setCenter(new float[] {-0.2f,0.72f,-0.015f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32120().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat121().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))))
                                                            .addChild(new HAnimJoint().setName("r_middle0").setDEF("Joe_r_middle0").setCenter(new float[] {-0.2f,0.835f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32122().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat123().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("r_middle1").setDEF("Joe_r_middle1").setCenter(new float[] {-0.2f,0.788f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32124().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat125().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("r_middle2").setDEF("Joe_r_middle2").setCenter(new float[] {-0.2f,0.74f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32126().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat127().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                  .addChild(new HAnimJoint().setName("r_middle3").setDEF("Joe_r_middle3").setCenter(new float[] {-0.2f,0.7142f,-0.04f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32128().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat129().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))))
                                                            .addChild(new HAnimJoint().setName("r_ring0").setDEF("Joe_r_ring0").setCenter(new float[] {-0.2f,0.835f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32130().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat131().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("r_ring1").setDEF("Joe_r_ring1").setCenter(new float[] {-0.2f,0.793f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32132().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat133().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("r_ring2").setDEF("Joe_r_ring2").setCenter(new float[] {-0.2f,0.74f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32134().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat135().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                  .addChild(new HAnimJoint().setName("r_ring3").setDEF("Joe_r_ring3").setCenter(new float[] {-0.2f,0.7177f,-0.065f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32136().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat137().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))))
                                                            .addChild(new HAnimJoint().setName("r_pinky0").setDEF("Joe_r_pinky0").setCenter(new float[] {-0.2f,0.84f,-0.085f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32138().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat139().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                              .addChild(new HAnimJoint().setName("r_pinky1").setDEF("Joe_r_pinky1").setCenter(new float[] {-0.2f,0.79f,-0.085f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32140().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat141().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                .addChild(new HAnimJoint().setName("r_pinky2").setDEF("Joe_r_pinky2").setCenter(new float[] {-0.2f,0.755f,-0.085f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32142().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat143().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                                                                  .addChild(new HAnimJoint().setName("r_pinky3").setDEF("Joe_r_pinky3").setCenter(new float[] {-0.2f,0.735f,-0.09f}).setSkinCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt32144().getArray())).setSkinCoordWeight(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat145().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))))))))))))))))))))))))))))
            .addSkin(new Shape().setDEF("Joe_Shape").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
        ...
        .addChild(new Group().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new OrientationInterpolator().setDEF("HumanoidRootRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat154().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation155().getArray())))
          .addChild(new PositionInterpolator().setDEF("HumanoidRootTransInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat156().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f157().getArray())))
          .addChild(new OrientationInterpolator().setDEF("sacroiliacRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat158().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation159().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_hipRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat160().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation161().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_kneeRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat162().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation163().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ankleRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat164().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation165().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_subtalarRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat166().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation167().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_midtarsalRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat168().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation169().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_metatarsalRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat170().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation171().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_hipRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat172().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation173().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_kneeRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat174().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation175().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ankleRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat176().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation177().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_subtalarRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat178().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation179().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_midtarsalRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat180().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation181().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_metatarsalRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat182().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation183().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl5RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat184().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation185().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl4RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat186().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation187().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat188().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation189().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat190().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation191().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vl1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat192().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation193().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt12RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat194().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation195().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt11RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat196().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation197().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt10RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat198().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation199().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt9RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat200().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation201().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt8RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat202().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation203().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt7RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat204().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation205().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt6RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat206().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation207().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt5RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat208().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation209().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt4RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat210().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation211().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat212().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation213().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat214().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation215().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vt1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat216().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation217().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc7RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat218().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation219().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc6RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat220().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation221().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc5RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat222().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation223().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc4RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat224().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation225().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat226().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation227().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat228().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation229().getArray())))
          .addChild(new OrientationInterpolator().setDEF("vc1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat230().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation231().getArray())))
          .addChild(new OrientationInterpolator().setDEF("skullbaseRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat232().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation233().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_eyelid_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat234().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation235().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_eyeball_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat236().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation237().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_eyebrow_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat238().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation239().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_eyelid_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat240().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation241().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_eyeball_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat242().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation243().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_eyebrow_jointRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat244().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation245().getArray())))
          .addChild(new OrientationInterpolator().setDEF("temporomandibularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat246().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation247().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_sternoclavicularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat248().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation249().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_acromioclavicularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat250().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation251().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_shoulderRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat252().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation253().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_elbowRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat254().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation255().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_wristRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat256().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation257().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_thumb1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat258().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation259().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_thumb2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat260().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation261().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_thumb3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat262().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation263().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_index0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat264().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation265().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_index1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat266().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation267().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_index2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat268().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation269().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_index3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat270().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation271().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_middle0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat272().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation273().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_middle1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat274().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation275().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_middle2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat276().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation277().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_middle3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat278().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation279().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ring0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat280().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation281().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ring1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat282().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation283().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ring2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat284().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation285().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_ring3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat286().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation287().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_pinky0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat288().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation289().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_pinky1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat290().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation291().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_pinky2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat292().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation293().getArray())))
          .addChild(new OrientationInterpolator().setDEF("l_pinky3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat294().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation295().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_sternoclavicularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat296().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation297().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_acromioclavicularRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat298().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation299().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_shoulderRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat300().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation301().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_elbowRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat302().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation303().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_wristRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat304().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation305().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_thumb1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat306().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation307().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_thumb2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat308().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation309().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_thumb3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat310().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation311().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_index0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat312().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation313().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_index1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat314().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation315().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_index2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat316().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation317().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_index3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat318().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation319().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_middle0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat320().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation321().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_middle1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat322().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation323().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_middle2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat324().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation325().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_middle3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat326().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation327().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ring0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat328().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation329().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ring1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat330().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation331().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ring2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat332().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation333().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_ring3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat334().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation335().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_pinky0RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat336().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation337().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_pinky1RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat338().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation339().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_pinky2RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat340().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation341().getArray())))
          .addChild(new OrientationInterpolator().setDEF("r_pinky3RotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat342().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation343().getArray()))))
        ...
        .addChild(new Group().setDEF("DisplacersAnimationGroup").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addComments(new CommentsBlock("TimeSensor DEF='skull_tipTestTimer' cycleInterval='5.73' loop='true' enabled='true'></TimeSensor"))
          .addChild(new ScalarInterpolator().setDEF("skull_tipTest").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat344().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat345().getArray())))
        ...
        .addChild(new Group().setDEF("skintexturetransform_animation").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new ScalarInterpolator().setDEF("skinTexTransTest").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat346().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat347().getArray())))
        ...
        .addChild(new Group().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Transform().setDEF("SBall").setRotation(new float[] {0.7f,0f,0.7f,0.1f}).setScale(new float[] {0.23f,0.23f,0.23f}).setTranslation(new float[] {-0.916f,0.37f,-0.92f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setDEF("ball_Shape").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new PositionInterpolator().setDEF("ballTransInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat350().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f351().getArray())))
          .addChild(new OrientationInterpolator().setDEF("ballRotInterp").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat352().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation353().getArray())))
        ...
        .addChild(new Group().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Transform().setScale(new float[] {0.2f,0.2f,0.2f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setUSE("AxisLinesShape")))
          .addChild(new Transform().setDEF("Circle0").setScale(new float[] {1.175f,1f,1.175f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setDEF("circle_Shape").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Transform().setDEF("Circle1").setScale(new float[] {0.5f,1f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setDEF("circle1_Shape").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Transform().setDEF("Circle2").setScale(new float[] {0.25f,1f,0.25f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setDEF("circle2_Shape").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
...
protected class MFString146 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"JoeBodyTexture29.png","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/JoeBodyTexture29.png"});
  }
}

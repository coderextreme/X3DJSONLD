      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("Joe_Humanoid")
          .addChild(new HAnimHumanoid().setName("Human").setDEF("Joe_Human").setVersion("1.0")
            .addSkeleton(new HAnimJoint().setName("HumanoidRoot").setDEF("Joe_HumanoidRoot").setCenter(new float[] {0f,0.875f,0f}).setUlimit(new MFFloat1().getArray()).setLlimit(new MFFloat2().getArray())

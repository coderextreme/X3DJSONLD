      ...
      .setScene(new SceneObject()
        ...
        .addChild(new GroupObject().setDEF("Joe_Humanoid")
          .addChild(new HAnimHumanoidObject().setName("Human").setDEF("Joe_Human").setVersion("2.0")
            .addJoints(new HAnimJointObject().setName("humanoid_root").setDEF("Joe_HumanoidRoot").setCenter(new float[] {0f,0.875f,0f})
              .addChild(new HAnimSegmentObject().setName("sacrum").setDEF("Joe_sacrum")
                .addChild(new HAnimSiteObject().setName("RootFront").setDEF("Joe_RootFront")
                  .addChild(new TransformObject().setDEF("hanimcordsys").setScale(new float[] {0.175f,0.175f,0.175f})
                    ...
                    .addChild(new ShapeObject().setDEF("AxisLinesShape")
                      ...
                      .setGeometry(new IndexedLineSetObject().setColorIndex(new MFInt32Object(new MFInt321().getArray())).setColorPerVertex(false).setCoordIndex(new MFInt32Object(new MFInt322().getArray()))
            ...
            .addSkin(new ShapeObject().setDEF("Joe_Shape")
              ...
              .setGeometry(new IndexedFaceSetObject().setDEF("Joe_skin_IndexedFaceSet").setCoordIndex(new MFInt32Object(new MFInt32146().getArray()).append(new MFInt32147().getArray()).append(new MFInt32148().getArray()).append(new MFInt32149().getArray())).setCreaseAngle(3.14f)
        ...
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("HumanoidRootRotInterp").setToField("set_rotation").setToNode("Joe_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("value_changed").setFromNode("HumanoidRootTransInterp").setToField("set_translation").setToNode("Joe_HumanoidRoot"))
...
protected class MFString145 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"JoeBodyTexture29.png","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/JoeBodyTexture29.png"});
  }
}

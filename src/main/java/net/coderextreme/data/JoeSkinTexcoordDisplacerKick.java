  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("Sat, 30 Dec 2023 07:49:08 GMT"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDEF("Scene_FrontView").setDescription("Scene Front View").setPosition(new float[] {0f,0.8f,2.58f}).setCenterOfRotation(new float[] {0f,0.8f,0f}))
        .addChild(new Viewpoint().setDEF("Scene_SideView").setDescription("Scene Side View").setPosition(new float[] {2.6f,0.5f,0f}).setOrientation(new float[] {0f,1f,0f,1.5708f}).setCenterOfRotation(new float[] {0f,0.8f,0f}))
        .addChild(new Viewpoint().setDEF("Scene_BackView").setDescription("Scene Back View").setPosition(new float[] {0f,2.5f,-3f}).setOrientation(new float[] {0f,1f,0f,3.14f}).setCenterOfRotation(new float[] {0f,1.5f,0f}))
        .addChild(new Viewpoint().setDEF("Scene_TopView").setDescription("Scene Top View").setPosition(new float[] {0f,3.5f,0f}).setOrientation(new float[] {1f,0f,0f,-1.5708f}).setCenterOfRotation(new float[] {0f,1.5f,0f}))
        .addChild(new Group().setDEF("Joe_Humanoid")
          .addChild(new HAnimHumanoid("Joe_Humanoid").setDEF("Joe_Human").setName("Human")
            .addSkeleton(new HAnimJoint("Joe_Human").setDEF("Joe_HumanoidRoot").setName("HumanoidRoot").setTranslation(new float[] {-0.06765416f,0.07288204f,-0.0774799f}).setRotation(new float[] {-1f,0f,0f,0.345040215995291f}).setCenter(new float[] {0f,0.875f,0f})
              ...
              .addChild(new HAnimJoint("Joe_HumanoidRoot").setDEF("Joe_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f,0.92f,0f}).setSkinCoordIndex(new MFInt326().getArray()).setSkinCoordWeight(new MFFloat7().getArray())
                .addChild(new HAnimJoint("Joe_sacroiliac").setDEF("Joe_l_hip").setName("l_hip").setRotation(new float[] {1f,0f,0f,0.565927395692145f}).setCenter(new float[] {0.1f,0.92f,0f}).setSkinCoordIndex(new MFInt328().getArray()).setSkinCoordWeight(new MFFloat9().getArray())
                  .addChild(new HAnimJoint("Joe_l_hip").setDEF("Joe_l_knee").setName("l_knee").setRotation(new float[] {0.763392428656297f,0f,0.645934981147672f,0.52562724608952f}).setCenter(new float[] {0.115f,0.466f,0f}).setSkinCoordIndex(new MFInt3210().getArray()).setSkinCoordWeight(new MFFloat11().getArray())
                    .addChild(new HAnimJoint("Joe_l_knee").setDEF("Joe_l_ankle").setName("l_ankle").setRotation(new float[] {1f,0f,0f,0.363360166549682f}).setCenter(new float[] {0.115f,0.069f,0f}).setSkinCoordIndex(new MFInt3212().getArray()).setSkinCoordWeight(new MFFloat13().getArray())
                      .addChild(new HAnimJoint("Joe_l_ankle").setDEF("Joe_l_subtalar").setName("l_subtalar").setCenter(new float[] {0.115f,0.031f,0.03f}).setSkinCoordIndex(new MFInt3214().getArray()).setSkinCoordWeight(new MFFloat15().getArray())
                        .addChild(new HAnimJoint("Joe_l_subtalar").setDEF("Joe_l_midtarsal").setName("l_midtarsal").setCenter(new float[] {0.115f,0.037f,0.09f}).setSkinCoordIndex(new MFInt3216().getArray()).setSkinCoordWeight(new MFFloat17().getArray())
                          .addChild(new HAnimJoint("Joe_l_midtarsal").setDEF("Joe_l_metatarsal").setName("l_metatarsal").setCenter(new float[] {0.115f,0.02f,0.122f}).setSkinCoordIndex(new MFInt3218().getArray()).setSkinCoordWeight(new MFFloat19().getArray())))))))
                .addChild(new HAnimJoint("Joe_sacroiliac").setDEF("Joe_r_hip").setName("r_hip").setRotation(new float[] {-1f,0f,0f,1f}).setCenter(new float[] {-0.1f,0.92f,0f}).setSkinCoordIndex(new MFInt3220().getArray()).setSkinCoordWeight(new MFFloat21().getArray())
                  .addChild(new HAnimJoint("Joe_r_hip").setDEF("Joe_r_knee").setName("r_knee").setRotation(new float[] {1f,0f,0f,1f}).setCenter(new float[] {-0.05f,0.466f,0f}).setSkinCoordIndex(new MFInt3222().getArray()).setSkinCoordWeight(new MFFloat23().getArray())
                    .addChild(new HAnimJoint("Joe_r_knee").setDEF("Joe_r_ankle").setName("r_ankle").setRotation(new float[] {1f,0f,0f,1f}).setCenter(new float[] {-0.115f,0.069f,0f}).setSkinCoordIndex(new MFInt3224().getArray()).setSkinCoordWeight(new MFFloat25().getArray())
                      .addChild(new HAnimJoint("Joe_r_ankle").setDEF("Joe_r_subtalar").setName("r_subtalar").setCenter(new float[] {-0.1f,0.015f,-0.01f}).setSkinCoordIndex(new MFInt3226().getArray()).setSkinCoordWeight(new MFFloat27().getArray())
                        .addChild(new HAnimJoint("Joe_r_subtalar").setDEF("Joe_r_midtarsal").setName("r_midtarsal").setCenter(new float[] {-0.115f,0.037f,0.09f}).setSkinCoordIndex(new MFInt3228().getArray()).setSkinCoordWeight(new MFFloat29().getArray())
                          .addChild(new HAnimJoint("Joe_r_midtarsal").setDEF("Joe_r_metatarsal").setName("r_metatarsal").setCenter(new float[] {-0.1f,0.01f,0.14f}).setSkinCoordIndex(new MFInt3230().getArray()).setSkinCoordWeight(new MFFloat31().getArray()))))))))
              .addChild(new HAnimJoint("Joe_HumanoidRoot").setDEF("Joe_vl5").setName("vl5").setCenter(new float[] {0f,1.045f,-0.095f}).setSkinCoordIndex(new MFInt3232().getArray()).setSkinCoordWeight(new MFFloat33().getArray())
                                          ...
                                          .addChild(new HAnimJoint("Joe_vt4").setDEF("Joe_vt3").setName("vt3").setCenter(new float[] {0f,1.438f,-0.12f})
                                            .addChild(new HAnimJoint("Joe_vt3").setDEF("Joe_vt2").setName("vt2").setCenter(new float[] {0f,1.468f,-0.105f})
                                              .addChild(new HAnimJoint("Joe_vt2").setDEF("Joe_vt1").setName("vt1").setCenter(new float[] {0f,1.497f,-0.09f}).setSkinCoordIndex(new MFInt3242().getArray()).setSkinCoordWeight(new MFFloat43().getArray())
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_vc7").setName("vc7").setCenter(new float[] {0f,1.525f,-0.072f}).setSkinCoordIndex(new MFInt3244().getArray()).setSkinCoordWeight(new MFFloat45().getArray())
                                                  .addChild(new HAnimJoint("Joe_vc7").setDEF("Joe_vc6").setName("vc6").setCenter(new float[] {0f,1.54f,-0.05f})
                                                    .addChild(new HAnimJoint("Joe_vc6").setDEF("Joe_vc5").setName("vc5").setCenter(new float[] {0f,1.552f,-0.035f})
                                                      .addChild(new HAnimJoint("Joe_vc5").setDEF("Joe_vc4").setName("vc4").setRotation(new float[] {0.994021384613154f,0f,0.109185561919829f,0.674335589713011f}).setCenter(new float[] {0f,1.5675f,-0.0256f})
                                                          ...
                                                          .addChild(new HAnimJoint("Joe_vc3").setDEF("Joe_vc2").setName("vc2").setCenter(new float[] {0f,1.595f,-0.0175f})
                                                            .addChild(new HAnimJoint("Joe_vc2").setDEF("Joe_vc1").setName("vc1").setCenter(new float[] {0f,1.61f,-0.015f})
                                                              .addChild(new HAnimJoint("Joe_vc1").setDEF("Joe_skullbase").setName("skullbase").setCenter(new float[] {0f,1.63f,-0.01f}).setSkinCoordIndex(new MFInt3246().getArray()).setSkinCoordWeight(new MFFloat47().getArray())
                                                                .addDisplacers(new HAnimDisplacer("Joe_skullbase").setDEF("Joe_skull_tip_raiser_action").setName("skull_tip_raiser_action").setWeight(0.1380161f).setCoordIndex(new MFInt3248().getArray()).setDisplacements(new MFVec3f49().getArray()))
                                                ...
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_l_sternoclavicular").setName("l_sternoclavicular").setCenter(new float[] {0.082f,1.4488f,-0.0353f}).setSkinCoordIndex(new MFInt3250().getArray()).setSkinCoordWeight(new MFFloat51().getArray())
                                                  .addChild(new HAnimJoint("Joe_l_sternoclavicular").setDEF("Joe_l_acromioclavicular").setName("l_acromioclavicular").setCenter(new float[] {0.0962f,1.4269f,-0.0424f}).setSkinCoordIndex(new MFInt3252().getArray()).setSkinCoordWeight(new MFFloat53().getArray())
                                                    .addChild(new HAnimJoint("Joe_l_acromioclavicular").setDEF("Joe_l_shoulder").setName("l_shoulder").setRotation(new float[] {-0.171741892272205f,0f,0.985141980852893f,1.4976478896092f}).setCenter(new float[] {0.2f,1.44f,-0.04f}).setSkinCoordIndex(new MFInt3254().getArray()).setSkinCoordWeight(new MFFloat55().getArray())
                                                      .addChild(new HAnimJoint("Joe_l_shoulder").setDEF("Joe_l_elbow").setName("l_elbow").setRotation(new float[] {-0.999752381846956f,-0.0222525277516283f,0f,0.732659741895115f}).setCenter(new float[] {0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new MFInt3256().getArray()).setSkinCoordWeight(new MFFloat57().getArray())
                                                        .addChild(new HAnimJoint("Joe_l_elbow").setDEF("Joe_l_wrist").setName("l_wrist").setRotation(new float[] {0f,0.879033564588118f,0.476759889595913f,0.863276065544871f}).setCenter(new float[] {0.2f,0.87f,-0.04f}).setSkinCoordIndex(new MFInt3258().getArray()).setSkinCoordWeight(new MFFloat59().getArray())
                                                          .addChild(new HAnimJoint("Joe_l_wrist").setDEF("Joe_l_thumb1").setName("l_thumb1").setCenter(new float[] {0.1924f,0.8472f,-0.0534f}).setSkinCoordIndex(new MFInt3260().getArray()).setSkinCoordWeight(new MFFloat61().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_thumb1").setDEF("Joe_l_thumb2").setName("l_thumb2").setCenter(new float[] {0.1951f,0.8226f,0.0246f}).setSkinCoordIndex(new MFInt3262().getArray()).setSkinCoordWeight(new MFFloat63().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_thumb2").setDEF("Joe_l_thumb3").setName("l_thumb3").setCenter(new float[] {0.1955f,0.8159f,0.0464f}).setSkinCoordIndex(new MFInt3264().getArray()).setSkinCoordWeight(new MFFloat65().getArray()))))
                                                          .addChild(new HAnimJoint("Joe_l_wrist").setDEF("Joe_l_index0").setName("l_index0").setCenter(new float[] {0.1983f,0.8024f,-0.028f}).setSkinCoordIndex(new MFInt3266().getArray()).setSkinCoordWeight(new MFFloat67().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_index0").setDEF("Joe_l_index1").setName("l_index1").setCenter(new float[] {0.1983f,0.7815f,-0.028f}).setSkinCoordIndex(new MFInt3268().getArray()).setSkinCoordWeight(new MFFloat69().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_index1").setDEF("Joe_l_index2").setName("l_index2").setCenter(new float[] {0.2017f,0.7363f,-0.0248f}).setSkinCoordIndex(new MFInt3270().getArray()).setSkinCoordWeight(new MFFloat71().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_index2").setDEF("Joe_l_index3").setName("l_index3").setCenter(new float[] {0.2028f,0.7139f,-0.0236f}).setSkinCoordIndex(new MFInt3272().getArray()).setSkinCoordWeight(new MFFloat73().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_l_wrist").setDEF("Joe_l_middle0").setName("l_middle0").setCenter(new float[] {0.1987f,0.8029f,-0.053f}).setSkinCoordIndex(new MFInt3274().getArray()).setSkinCoordWeight(new MFFloat75().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_middle0").setDEF("Joe_l_middle1").setName("l_middle1").setCenter(new float[] {0.1987f,0.7818f,-0.053f}).setSkinCoordIndex(new MFInt3276().getArray()).setSkinCoordWeight(new MFFloat77().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_middle1").setDEF("Joe_l_middle2").setName("l_middle2").setCenter(new float[] {0.2013f,0.7273f,-0.0503f}).setSkinCoordIndex(new MFInt3278().getArray()).setSkinCoordWeight(new MFFloat79().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_middle2").setDEF("Joe_l_middle3").setName("l_middle3").setCenter(new float[] {0.2026f,0.7011f,-0.0494f}).setSkinCoordIndex(new MFInt3280().getArray()).setSkinCoordWeight(new MFFloat81().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_l_wrist").setDEF("Joe_l_ring0").setName("l_ring0").setCenter(new float[] {0.1956f,0.8019f,-0.0794f}).setSkinCoordIndex(new MFInt3282().getArray()).setSkinCoordWeight(new MFFloat83().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_ring0").setDEF("Joe_l_ring1").setName("l_ring1").setCenter(new float[] {0.1956f,0.7815f,-0.0794f}).setSkinCoordIndex(new MFInt3284().getArray()).setSkinCoordWeight(new MFFloat85().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_ring1").setDEF("Joe_l_ring2").setName("l_ring2").setCenter(new float[] {0.1973f,0.7287f,-0.0777f}).setSkinCoordIndex(new MFInt3286().getArray()).setSkinCoordWeight(new MFFloat87().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_ring2").setDEF("Joe_l_ring3").setName("l_ring3").setCenter(new float[] {0.1983f,0.7045f,-0.0767f}).setSkinCoordIndex(new MFInt3288().getArray()).setSkinCoordWeight(new MFFloat89().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_l_wrist").setDEF("Joe_l_pinky0").setName("l_pinky0").setCenter(new float[] {0.1925f,0.8066f,-0.1036f}).setSkinCoordIndex(new MFInt3290().getArray()).setSkinCoordWeight(new MFFloat91().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_pinky0").setDEF("Joe_l_pinky1").setName("l_pinky1").setCenter(new float[] {0.1925f,0.7866f,-0.1036f}).setSkinCoordIndex(new MFInt3292().getArray()).setSkinCoordWeight(new MFFloat93().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_pinky1").setDEF("Joe_l_pinky2").setName("l_pinky2").setCenter(new float[] {0.1938f,0.7452f,-0.1024f}).setSkinCoordIndex(new MFInt3294().getArray()).setSkinCoordWeight(new MFFloat95().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_pinky2").setDEF("Joe_l_pinky3").setName("l_pinky3").setCenter(new float[] {0.1948f,0.7277f,-0.1017f}).setSkinCoordIndex(new MFInt3296().getArray()).setSkinCoordWeight(new MFFloat97().getArray()))))))))))
                                                .addChild(new HAnimJoint("Joe_vt1").setDEF("Joe_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-0.03f,1.46f,0f}).setSkinCoordIndex(new MFInt3298().getArray()).setSkinCoordWeight(new MFFloat99().getArray())
                                                  .addChild(new HAnimJoint("Joe_r_sternoclavicular").setDEF("Joe_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-0.09f,1.41f,-0.11f}).setSkinCoordIndex(new MFInt32100().getArray()).setSkinCoordWeight(new MFFloat101().getArray())
                                                    .addChild(new HAnimJoint("Joe_r_acromioclavicular").setDEF("Joe_r_shoulder").setName("r_shoulder").setRotation(new float[] {0f,0f,-1f,1.51126006245613f}).setCenter(new float[] {-0.2f,1.44f,-0.04f}).setSkinCoordIndex(new MFInt32102().getArray()).setSkinCoordWeight(new MFFloat103().getArray())
                                                      .addChild(new HAnimJoint("Joe_r_shoulder").setDEF("Joe_r_elbow").setName("r_elbow").setRotation(new float[] {-0.999752381846956f,-0.0222525277516283f,0f,0.732659741895115f}).setCenter(new float[] {-0.2f,1.1388f,-0.04f}).setSkinCoordIndex(new MFInt32104().getArray()).setSkinCoordWeight(new MFFloat105().getArray())
                                                        .addChild(new HAnimJoint("Joe_r_elbow").setDEF("Joe_r_wrist").setName("r_wrist").setRotation(new float[] {0f,0f,-0.999999999999969f,0.112600631272834f}).setCenter(new float[] {-0.2f,0.89f,-0.04f}).setSkinCoordIndex(new MFInt32106().getArray()).setSkinCoordWeight(new MFFloat107().getArray())
                                                          .addChild(new HAnimJoint("Joe_r_wrist").setDEF("Joe_r_thumb1").setName("r_thumb1").setCenter(new float[] {-0.2f,0.85f,0f}).setSkinCoordIndex(new MFInt32108().getArray()).setSkinCoordWeight(new MFFloat109().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_thumb1").setDEF("Joe_r_thumb2").setName("r_thumb2").setCenter(new float[] {-0.2f,0.82f,0.03f}).setSkinCoordIndex(new MFInt32110().getArray()).setSkinCoordWeight(new MFFloat111().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_thumb2").setDEF("Joe_r_thumb3").setName("r_thumb3").setCenter(new float[] {-0.2f,0.8f,0.05f}).setSkinCoordIndex(new MFInt32112().getArray()).setSkinCoordWeight(new MFFloat113().getArray()))))
                                                          .addChild(new HAnimJoint("Joe_r_wrist").setDEF("Joe_r_index0").setName("r_index0").setRotation(new float[] {0f,0f,0.999999999999971f,0.0900804996490504f}).setCenter(new float[] {-0.2f,0.84f,-0.015f}).setSkinCoordIndex(new MFInt32114().getArray()).setSkinCoordWeight(new MFFloat115().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_index0").setDEF("Joe_r_index1").setName("r_index1").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.793f,-0.015f}).setSkinCoordIndex(new MFInt32116().getArray()).setSkinCoordWeight(new MFFloat117().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_index1").setDEF("Joe_r_index2").setName("r_index2").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.745f,-0.015f}).setSkinCoordIndex(new MFInt32118().getArray()).setSkinCoordWeight(new MFFloat119().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_index2").setDEF("Joe_r_index3").setName("r_index3").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.72f,-0.015f}).setSkinCoordIndex(new MFInt32120().getArray()).setSkinCoordWeight(new MFFloat121().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_wrist").setDEF("Joe_r_middle0").setName("r_middle0").setRotation(new float[] {0f,0f,0.999999999999971f,0.0900804996490504f}).setCenter(new float[] {-0.2f,0.835f,-0.04f}).setSkinCoordIndex(new MFInt32122().getArray()).setSkinCoordWeight(new MFFloat123().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_middle0").setDEF("Joe_r_middle1").setName("r_middle1").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.788f,-0.04f}).setSkinCoordIndex(new MFInt32124().getArray()).setSkinCoordWeight(new MFFloat125().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_middle1").setDEF("Joe_r_middle2").setName("r_middle2").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.74f,-0.04f}).setSkinCoordIndex(new MFInt32126().getArray()).setSkinCoordWeight(new MFFloat127().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_middle2").setDEF("Joe_r_middle3").setName("r_middle3").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.7142f,-0.04f}).setSkinCoordIndex(new MFInt32128().getArray()).setSkinCoordWeight(new MFFloat129().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_wrist").setDEF("Joe_r_ring0").setName("r_ring0").setRotation(new float[] {0f,0f,0.999999999999971f,0.0900804996490504f}).setCenter(new float[] {-0.2f,0.835f,-0.065f}).setSkinCoordIndex(new MFInt32130().getArray()).setSkinCoordWeight(new MFFloat131().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_ring0").setDEF("Joe_r_ring1").setName("r_ring1").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.793f,-0.065f}).setSkinCoordIndex(new MFInt32132().getArray()).setSkinCoordWeight(new MFFloat133().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_ring1").setDEF("Joe_r_ring2").setName("r_ring2").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.74f,-0.065f}).setSkinCoordIndex(new MFInt32134().getArray()).setSkinCoordWeight(new MFFloat135().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_ring2").setDEF("Joe_r_ring3").setName("r_ring3").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.7177f,-0.065f}).setSkinCoordIndex(new MFInt32136().getArray()).setSkinCoordWeight(new MFFloat137().getArray())))))
                                                          .addChild(new HAnimJoint("Joe_r_wrist").setDEF("Joe_r_pinky0").setName("r_pinky0").setRotation(new float[] {0f,0f,0.999999999999971f,0.0900804996490504f}).setCenter(new float[] {-0.2f,0.84f,-0.085f}).setSkinCoordIndex(new MFInt32138().getArray()).setSkinCoordWeight(new MFFloat139().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_pinky0").setDEF("Joe_r_pinky1").setName("r_pinky1").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.79f,-0.085f}).setSkinCoordIndex(new MFInt32140().getArray()).setSkinCoordWeight(new MFFloat141().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_pinky1").setDEF("Joe_r_pinky2").setName("r_pinky2").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.755f,-0.085f}).setSkinCoordIndex(new MFInt32142().getArray()).setSkinCoordWeight(new MFFloat143().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_pinky2").setDEF("Joe_r_pinky3").setName("r_pinky3").setRotation(new float[] {0f,0f,1.00000000000001f,0.13512074947357f}).setCenter(new float[] {-0.2f,0.735f,-0.09f}).setSkinCoordIndex(new MFInt32144().getArray()).setSkinCoordWeight(new MFFloat145().getArray()))))))))))))))))))))))))))))
        ...
        .addChild(new Group()
          .addChild(new Transform().setDEF("SBall").setTranslation(new float[] {0.4245588f,0.8168008f,1.96121f}).setRotation(new float[] {-0.640701175204806f,0.423088652864102f,-0.640701175204806f,3.22001831056749f}).setScale(new float[] {0.23f,0.23f,0.23f})
        ...
        .addChild(new ROUTE().setFromNode("HumanoidRoot_RotationInterpolator").setFromField("value_changed").setToNode("Joe_HumanoidRoot").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("HumanoidRoot_TranslationInterpolator").setFromField("value_changed").setToNode("Joe_HumanoidRoot").setToField("translation"))
        ...
        .addChild(new ROUTE().setFromNode("l_ankle_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_ankle").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_subtalar_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_subtalar").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_midtarsal_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_midtarsal").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_metatarsal_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_metatarsal").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("r_ankle_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_ankle").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_subtalar_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_subtalar").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_midtarsal_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_midtarsal").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_metatarsal_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_metatarsal").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("l_wrist_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_wrist").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_thumb1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_thumb1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_thumb2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_thumb2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_thumb3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_thumb3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_index0_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_index0").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_index1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_index1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_index2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_index2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_index3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_index3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_middle0_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_middle0").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_middle1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_middle1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_middle2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_middle2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_middle3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_middle3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_ring0_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_ring0").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_ring1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_ring1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_ring2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_ring2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_ring3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_ring3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_pinky0_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_pinky0").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_pinky1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_pinky1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_pinky2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_pinky2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("l_pinky3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_l_pinky3").setToField("rotation"))
        ...
        .addChild(new ROUTE().setFromNode("r_wrist_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_wrist").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_thumb1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_thumb1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_thumb2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_thumb2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_thumb3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_thumb3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_index0_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_index0").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_index1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_index1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_index2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_index2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_index3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_index3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_middle0_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_middle0").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_middle1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_middle1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_middle2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_middle2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_middle3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_middle3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_ring0_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_ring0").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_ring1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_ring1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_ring2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_ring2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_ring3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_ring3").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_pinky0_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_pinky0").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_pinky1_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_pinky1").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_pinky2_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_pinky2").setToField("rotation"))
        .addChild(new ROUTE().setFromNode("r_pinky3_RotationInterpolator").setFromField("value_changed").setToNode("Joe_r_pinky3").setToField("rotation"))

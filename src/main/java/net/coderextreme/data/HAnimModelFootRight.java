  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new HAnimHumanoidObject().setName("Humanoid_Right_Foot").setDEF("Humanoid_Right_Foot").setJointBindingPositions(new MFVec3fObject(new MFVec3f0().getArray())).setJointBindingRotations(new MFRotationObject(new MFRotation1().getArray())).setJointBindingScales(new MFVec3fObject(new MFVec3f2().getArray())).setVersion("2.0")
          .addJoints(new HAnimJointObject().setName("humanoid_root").setDEF("hanim_HumanoidRoot")
            .addChild(new HAnimJointObject().setName("r_talocrural_joint").setDEF("r_talocrural_joint")
              ...
              .addChild(new HAnimJointObject().setName("r_talocalcaneonavicular_joint").setDEF("r_talocalcaneonavicular_joint").setCenter(new float[] {0f,-0.3f,0f})
                ...
                .addChild(new HAnimJointObject().setName("r_cuneonavicular_joint1").setDEF("r_cuneonavicular_joint1").setCenter(new float[] {0.1f,-0.45f,0f})
                  ...
                  .addChild(new HAnimJointObject().setName("r_tarsometatarsal_joint1").setDEF("r_tarsometatarsal_joint1").setCenter(new float[] {0.1f,-0.6f,0f})
                    ...
                    .addChild(new HAnimJointObject().setName("r_metatarsophalangeal_joint1").setDEF("r_metatarsophalangeal_joint1").setCenter(new float[] {0.1f,-0.9f,0f})
                      ...
                      .addChild(new HAnimJointObject().setName("r_f_Interphalangeal_joint").setDEF("r_f_Interphalangeal_joint").setCenter(new float[] {0.1f,-1.05f,0f})
                ...
                .addChild(new HAnimJointObject().setName("r_cuneonavicular_joint2").setDEF("r_cuneonavicular_joint2").setCenter(new float[] {0f,-0.45f,0f})
                  ...
                  .addChild(new HAnimJointObject().setName("r_tarsometatarsal_joint2").setDEF("r_tarsometatarsal_joint2").setCenter(new float[] {-0.05f,-0.6f,0f})
                    ...
                    .addChild(new HAnimJointObject().setName("r_metatarsophalangeal_joint2").setDEF("r_metatarsophalangeal_joint2").setCenter(new float[] {-0.05f,-0.9f,0f})
                      ...
                      .addChild(new HAnimJointObject().setName("r_f_proximal_Interphalangeal_joint2").setDEF("r_f_proximal_Interphalangeal_joint2").setCenter(new float[] {-0.05f,-1.05f,0f})
                        ...
                        .addChild(new HAnimJointObject().setName("r_f_distal_Interphalangeal_joint2").setDEF("r_f_distal_Interphalangeal_joint2").setCenter(new float[] {-0.05f,-1.12f,0f})
                ...
                .addChild(new HAnimJointObject().setName("r_cuneonavicular_joint3").setDEF("r_cuneonavicular_joint3").setCenter(new float[] {-0.1f,-0.4f,0f})
                  ...
                  .addChild(new HAnimJointObject().setName("r_tarsometatarsal_joint3").setDEF("r_tarsometatarsal_joint3").setCenter(new float[] {-0.15f,-0.6f,0f})
                    ...
                    .addChild(new HAnimJointObject().setName("r_metatarsophalangeal_joint3").setDEF("r_metatarsophalangeal_joint3").setCenter(new float[] {-0.15f,-0.9f,0f})
                      ...
                      .addChild(new HAnimJointObject().setName("r_f_proximal_Interphalangeal_joint3").setDEF("r_f_proximal_Interphalangeal_joint3").setCenter(new float[] {-0.15f,-1.05f,0f})
                        ...
                        .addChild(new HAnimJointObject().setName("r_f_distal_Interphalangeal_joint3").setDEF("r_f_distal_Interphalangeal_joint3").setCenter(new float[] {-0.15f,-1.13f,0f})
              ...
              .addChild(new HAnimJointObject().setName("r_calcaneuscuboid_joint").setDEF("r_calcaneuscuboid_joint").setCenter(new float[] {-0.2f,0.3f,0f})
                ...
                .addChild(new HAnimJointObject().setName("r_transverse_tarsal_joint").setDEF("r_transverse_tarsal_joint").setCenter(new float[] {-0.21f,-0.3f,0f})
                  ...
                  .addChild(new HAnimJointObject().setName("r_tarsometatarsal_joint4").setDEF("r_tarsometatarsal_joint4").setCenter(new float[] {-0.25f,-0.58f,0f})
                    ...
                    .addChild(new HAnimJointObject().setName("r_metatarsophalangeal_joint4").setDEF("r_metatarsophalangeal_joint4").setCenter(new float[] {-0.25f,-0.87f,0f})
                      ...
                      .addChild(new HAnimJointObject().setName("r_f_proximal_Interphalangeal_joint4").setDEF("r_f_proximal_Interphalangeal_joint4").setCenter(new float[] {-0.25f,-1f,0f})
                        ...
                        .addChild(new HAnimJointObject().setName("r_f_distal_Interphalangeal_joint4").setDEF("r_f_distal_Interphalangeal_joint4").setCenter(new float[] {-0.25f,-1.1f,0f})
                  ...
                  .addChild(new HAnimJointObject().setName("r_tarsometatarsal_joint5").setDEF("r_tarsometatarsal_joint5").setCenter(new float[] {-0.33f,-0.52f,0f})
                    ...
                    .addChild(new HAnimJointObject().setName("r_metatarsophalangeal_joint5").setDEF("r_metatarsophalangeal_joint5").setCenter(new float[] {-0.34f,-0.8f,0f})
                      ...
                      .addChild(new HAnimJointObject().setName("r_f_proximal_Interphalangeal_joint5").setDEF("r_f_proximal_Interphalangeal_joint5").setCenter(new float[] {-0.34f,-0.95f,0f})
                        ...
                        .addChild(new HAnimJointObject().setName("r_f_distal_Interphalangeal_joint5").setDEF("r_f_distal_Interphalangeal_joint5").setCenter(new float[] {-0.34f,-1.05f,0f})

      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Foot_Right").setDEF("hanim_Foot_Right").setLoa(4).setVersion("2.0")
          ...
          .addSkeleton(new HAnimJoint().setName("humanoid_root").setDEF("hanim_humanoid_root").setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
            ...
            .addChild(new HAnimJoint().setName("r_talocrural").setDEF("hanim_r_talocrural").setDescription("connection joint of foot to leg above").setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addComments("TCN")
              .addChild(new HAnimJoint().setName("r_talocalcaneonavicular").setDEF("hanim_r_talocalcaneonavicular").setCenter(new float[] {0f,-0.3f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addComments("CN1")
                .addChild(new HAnimJoint().setName("r_cuneonavicular_1").setDEF("hanim_r_cuneonavicular_1").setCenter(new float[] {0.1f,-0.45f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_tarsometatarsal_1").setDEF("hanim_r_tarsometatarsal_1").setCenter(new float[] {0.1f,-0.6f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_metatarsophalangeal_1").setDEF("hanim_r_metatarsophalangeal_1").setCenter(new float[] {0.1f,-0.9f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_tarsal_interphalangeal_1").setDEF("hanim_r_tarsal_interphalangeal_1").setCenter(new float[] {0.1f,-1.05f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                        .addChild(new HAnimSegment().setName("r_tarsal_distal_phalanx_1").setDEF("hanim_r_tarsal_distal_phalanx_1")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("tiptoe_r_interphalangeal_").setCoordIndex(new MFInt3217().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f18().getArray())))))))))
                .addComments("CN2")
                .addChild(new HAnimJoint().setName("r_cuneonavicular_2").setDEF("hanim_r_cuneonavicular_2").setCenter(new float[] {0f,-0.45f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_tarsometatarsal_2").setDEF("hanim_r_tarsometatarsal_2").setCenter(new float[] {-0.05f,-0.6f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new float[] {-0.05f,-0.9f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setCenter(new float[] {-0.05f,-1.05f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                        ...
                        .addChild(new HAnimJoint().setName("r_tarsal_distal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setCenter(new float[] {-0.05f,-1.12f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                          .addChild(new HAnimSegment().setName("r_tarsal_distal_phalanx_2").setDEF("hanim_r_tarsal_distal_phalanx_2")
                            ...
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                              .setGeometry(new IndexedLineSet().setDEF("tiptoe_r_tarsal_distal_interphalangeal_2").setCoordIndex(new MFInt3227().getArray())
                                .setCoord(new Coordinate().setPoint(new MFVec3f28().getArray()))))))))))
                .addComments("CN3")
                .addChild(new HAnimJoint().setName("r_cuneonavicular_3").setDEF("hanim_r_cuneonavicular_3").setCenter(new float[] {-0.1f,-0.4f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_tarsometatarsal_3").setDEF("hanim_r_tarsometatarsal_3").setCenter(new float[] {-0.15f,-0.6f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_metatarsophalangeal_3").setDEF("hanim_r_metatarsophalangeal_3").setCenter(new float[] {-0.15f,-0.9f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setCenter(new float[] {-0.15f,-1.05f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                        ...
                        .addChild(new HAnimJoint().setName("r_tarsal_distal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setCenter(new float[] {-0.15f,-1.13f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                          .addChild(new HAnimSegment().setName("r_tarsal_distal_phalanx_3").setDEF("hanim_r_tarsal_distal_phalanx_3")
                            ...
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                              .setGeometry(new IndexedLineSet().setDEF("tiptoe_r_tarsal_distal_interphalangeal_3").setCoordIndex(new MFInt3237().getArray())
                                .setCoord(new Coordinate().setPoint(new MFVec3f38().getArray())))))))))))
              .addComments("CC")
              .addChild(new HAnimJoint().setName("r_calcaneocuboid").setDEF("hanim_r_calcaneocuboid").setCenter(new float[] {-0.2f,0.3f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addComments("TT")
                .addChild(new HAnimJoint().setName("r_transversetarsal").setDEF("hanim_r_transversetarsal").setCenter(new float[] {-0.21f,-0.3f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addComments("TMT4")
                  .addChild(new HAnimJoint().setName("r_tarsometatarsal_4").setDEF("hanim_r_tarsometatarsal_4").setCenter(new float[] {-0.25f,-0.58f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_metatarsophalangeal_4").setDEF("hanim_r_metatarsophalangeal_4").setCenter(new float[] {-0.25f,-0.87f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setCenter(new float[] {-0.25f,-1f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                        ...
                        .addChild(new HAnimJoint().setName("r_tarsal_distal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setCenter(new float[] {-0.25f,-1.1f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                          .addChild(new HAnimSegment().setName("r_tarsal_distal_phalanx_4").setDEF("hanim_r_tarsal_distal_phalanx_4")
                            ...
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                              .setGeometry(new IndexedLineSet().setDEF("tiptoe_r_tarsal_distal_interphalangeal_4").setCoordIndex(new MFInt3251().getArray())
                                .setCoord(new Coordinate().setPoint(new MFVec3f52().getArray())))))))))
                  .addComments("TMT5")
                  .addChild(new HAnimJoint().setName("r_tarsometatarsal_5").setDEF("hanim_r_tarsometatarsal_5").setCenter(new float[] {-0.33f,-0.52f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_metatarsophalangeal_5").setDEF("hanim_r_metatarsophalangeal_5").setCenter(new float[] {-0.34f,-0.8f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_tarsal_proximal_interphalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_5").setCenter(new float[] {-0.34f,-0.95f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                        ...
                        .addChild(new HAnimJoint().setName("r_tarsal_distal_interphalangeal_5").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setCenter(new float[] {-0.34f,-1.05f,0f}).setUlimit(new float[] {0f,0f,0f}).setLlimit(new float[] {0f,0f,0f}).setStiffness(new float[] {0f,0f,0f})
                          .addChild(new HAnimSegment().setName("r_tarsal_distal_phalanx_5").setDEF("hanim_r_tarsal_distal_phalanx_5")
                            ...
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                              .setGeometry(new IndexedLineSet().setDEF("tiptoe_r_tarsal_distal_interphalangeal_5").setCoordIndex(new MFInt3259().getArray())

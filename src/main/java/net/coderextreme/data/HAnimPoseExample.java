    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimPose().setName(new SFString("T")).setDEF(new SFString("T_Pose")).setDescription(new SFString("arms stretched outward and level similar to letter T")).setLoa(1).setTransitionDuration(1.3d)
          ...
          .addChild(new HAnimJoint("T_Pose").setName(new SFString("l_shoulder")).setDEF(new SFString("PoseJoint_l_shoulder_1")).setDescription(new SFString("left shoulder")).setRotation(new float[] {0f ,0f ,1f ,1.57f }))
          .addChild(new HAnimJoint("T_Pose").setName(new SFString("r_shoulder")).setDEF(new SFString("PoseJoint_r_shoulder_1")).setDescription(new SFString("right shoulder")).setRotation(new float[] {0f ,0f ,-1f ,1.57f })))
        .addChild(new HAnimPose().setName(new SFString("A")).setDEF(new SFString("A_Pose")).setDescription(new SFString("arms stretched outward and downward similar to letter A")).setLoa(1).setTransitionDuration(1.2d)
          .addChild(new HAnimJoint("A_Pose").setName(new SFString("l_shoulder")).setDEF(new SFString("PoseJoint_l_shoulder")).setDescription(new SFString("left shoulder")).setRotation(new float[] {0f ,0f ,1f ,0.5f }))
          .addChild(new HAnimJoint("A_Pose").setName(new SFString("r_shoulder")).setDEF(new SFString("PoseJoint_r_shoulder")).setDescription(new SFString("right shoulder")).setRotation(new float[] {0f ,0f ,-1f ,0.5f })))
        .addChild(new HAnimPose().setName(new SFString("TouchDown")).setDEF(new SFString("TouchDown_Pose")).setDescription(new SFString("arms and legs stretched outward providing a TouchDown gesture")).setLoa(1).setTransitionDuration(1.2d)
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("humanoid_root")).setRotation(new float[] {0f ,1f ,0f ,-0.698132f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("l_hip")).setRotation(new float[] {-1f ,1f ,1f ,1f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("l_knee")).setRotation(new float[] {1f ,0f ,0f ,1f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("l_talocrural")).setRotation(new float[] {-0.2f ,0f ,0.1f ,0.225f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("r_hip")).setRotation(new float[] {-1f ,-1f ,-1f ,1f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("r_knee")).setRotation(new float[] {1f ,0f ,0f ,1f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("r_talocrural")).setRotation(new float[] {-0.2f ,0f ,0.1f ,0.25f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("vl5")).setRotation(new float[] {0f ,0f ,0.01f ,0.2f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("vt10")).setRotation(new float[] {0f ,0f ,0.01f ,0.1f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("vc4")).setRotation(new float[] {0f ,0f ,-0.01f ,0.15f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("l_shoulder")).setRotation(new float[] {-1f ,0.5f ,1f ,2f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("l_elbow")).setRotation(new float[] {-1f ,0f ,0f ,1f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("l_radiocarpal")))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("r_shoulder")).setRotation(new float[] {-1f ,-0.5f ,-1f ,2.6f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("r_elbow")).setRotation(new float[] {-1f ,0f ,0f ,1f }))
          .addChild(new HAnimJoint("TouchDown_Pose").setName(new SFString("r_radiocarpal"))))
        ...
        .addChild(new HAnimPose().setName(new SFString("FaceLeft")).setDEF(new SFString("FaceLeft_Pose")).setDescription(new SFString("Only modify humanoid_root Joint node to face left")).setLoa(0).setTransitionDuration(1.1d)
          .addChild(new HAnimJoint("FaceLeft_Pose").setName(new SFString("humanoid_root")).setDEF(new SFString("FaceLeft_humanoid_root")).setDescription(new SFString("Only rotate the model")).setRotation(new float[] {0f ,1f ,0f ,1.570796f })))
        .addChild(new HAnimPose().setName(new SFString("FaceRight")).setDEF(new SFString("FaceRight_Pose")).setDescription(new SFString("Only modify humanoid_root Joint node to face right")).setLoa(0).setTransitionDuration(1.1d)
          .addChild(new HAnimJoint("FaceRight_Pose").setName(new SFString("humanoid_root")).setDEF(new SFString("FaceRight_humanoid_root")).setDescription(new SFString("Only rotate the model")).setRotation(new float[] {0f ,1f ,0f ,-1.570796f })))
        .addChild(new Group().setDEF(new SFString("InterfaceButtonsGroup"))
          .addChild(new Transform().setDEF(new SFString("DisplayHeader")).setTranslation(new float[] {0f ,2f ,0f })
            .addChild(new Shape()
              .setGeometry(new Text().setString(new MFString4().getArray())
                .setFontStyle(new FontStyle().setDEF(new SFString("HeaderFont")).setFamily(new MFString5().getArray()).setJustify(new MFString6().getArray()).setSize(0.15f ).setStyle(new SFString("BOLD"))))
          ...
          .addChild(new Transform().setDEF(new SFString("T_PoseInterface")).setTranslation(new float[] {-1.5f ,1.5f ,0f })
            .addChild(new Shape()
              .setGeometry(new Text().setString(new MFString7().getArray())
                .setFontStyle(new FontStyle().setDEF(new SFString("SharedFont")).setFamily(new MFString8().getArray()).setJustify(new MFString9().getArray()).setSize(0.1f ).setStyle(new SFString("BOLD"))))
          ...
          .addChild(new Transform().setDEF(new SFString("AnimatePosesInterface")).setTranslation(new float[] {1.5f ,0.5f ,0f })
            ...
            .addChild(new ScalarInterpolator().setDEF(new SFString("AnimatePosesLoopInterpolator")).setKey(new MFFloat16().getArray()).setKeyValue(new MFFloat17().getArray()))
        ...
        .addChild(new HAnimHumanoid().setName(new SFString("HumanoidStub")).setInfo(new MFString19().getArray()).setVersion(new SFString("2.0"))

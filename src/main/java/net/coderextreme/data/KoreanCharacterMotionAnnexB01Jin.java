  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setCenterOfRotation(new double[] {0,1,0}).setDescription("AnnexB01Jin").setPosition(new double[] {0,1,3}))
        .addChild(new HAnimHumanoid().setName("AnnexB01Jin").setDEF("hanim_AnnexB01Jin").setInfo(new MFString0().getArray()).setScale(new double[] {0.0225,0.0225,0.0225}).setVersion("2.0")
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_AnnexB01Jin").setName("humanoid_root").setDEF("hanim_HumanoidRoot").setCenter(new double[] {0,30.53,-0.7076}).setUlimit(new MFFloat1().getArray()).setLlimit(new MFFloat2().getArray()).setContainerFieldOverride("skeleton"))
            .addChild(new HAnimSegment("hanim_HumanoidRoot").setName("sacrum").setDEF("hanim_sacrum")
              .addChild(new Transform().setTranslation(new double[] {0,30.53,-0.7076})
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt324().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt325().getArray())
                    .setCoord(new Coordinate().setPoint(new MFVec3f6().getArray()))
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f7().getArray()))))))
            .addChild(new HAnimJoint("hanim_HumanoidRoot").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new double[] {0,35.8,-0.7076}).setUlimit(new MFFloat8().getArray()).setLlimit(new MFFloat9().getArray())
              .addChild(new HAnimSegment("hanim_sacroiliac").setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new Transform().setTranslation(new double[] {0,35.8,-0.7076})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_hip").setDEF("hanim_l_hip").setCenter(new double[] {4.207,32.02,-0.8155}).setUlimit(new MFFloat14().getArray()).setLlimit(new MFFloat15().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new double[] {4.116,17.26,-0.8639}).setUlimit(new MFFloat20().getArray()).setLlimit(new MFFloat21().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new double[] {3.854,3.939,-0.7038}).setUlimit(new MFFloat26().getArray()).setLlimit(new MFFloat27().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_metatarsophalangeal").setDEF("hanim_l_metatarsophalangeal").setCenter(new double[] {3.854,3.64,0.7402}).setUlimit(new MFFloat32().getArray()).setLlimit(new MFFloat33().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new double[] {-4.207,32.02,-0.8155}).setUlimit(new MFFloat38().getArray()).setLlimit(new MFFloat39().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new double[] {-4.116,17.26,-0.8639}).setUlimit(new MFFloat44().getArray()).setLlimit(new MFFloat45().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new double[] {-3.854,3.939,-0.7038}).setUlimit(new MFFloat50().getArray()).setLlimit(new MFFloat51().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_metatarsophalangeal").setDEF("hanim_r_metatarsophalangeal").setCenter(new double[] {-3.854,3.64,0.7402}).setUlimit(new MFFloat56().getArray()).setLlimit(new MFFloat57().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("vl5").setDEF("hanim_vl5").setCenter(new double[] {0,40.23,-0.8527}).setUlimit(new MFFloat62().getArray()).setLlimit(new MFFloat63().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new double[] {0,40.23,-0.8527})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3264().getArray().append(new MFInt3265().getArray())).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3266().getArray().append(new MFInt3267().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f68().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f69().getArray()))))))
                .addChild(new HAnimJoint("hanim_vl5").setName("skullbase").setDEF("hanim_skullbase").setCenter(new double[] {0,57.43,-0.6863}).setUlimit(new MFFloat70().getArray()).setLlimit(new MFFloat71().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new double[] {0,57.43,-0.6863})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3272().getArray().append(new MFInt3273().getArray()).append(new MFInt3274().getArray())).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3275().getArray().append(new MFInt3276().getArray()).append(new MFInt3277().getArray()))
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new double[] {5.975,52,-0.1452}).setUlimit(new MFFloat81().getArray()).setLlimit(new MFFloat82().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new double[] {8.093,40.38,-0.2502}).setUlimit(new MFFloat87().getArray()).setLlimit(new MFFloat88().getArray())
                    .addChild(new HAnimSegment("hanim_l_elbow").setName("l_forearm").setDEF("hanim_l_forearm")
                      .addChild(new Transform().setTranslation(new double[] {8.093,40.38,-0.2502})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                    ...
                    .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new double[] {7.808,31.46,-0.05849}).setUlimit(new MFFloat93().getArray()).setLlimit(new MFFloat94().getArray())
                      .addChild(new HAnimSegment("hanim_l_radiocarpal").setName("l_hand").setDEF("hanim_l_hand")
                        .addChild(new Transform().setTranslation(new double[] {7.808,31.46,-0.05849})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new double[] {-5.975,52,-0.1452}).setUlimit(new MFFloat99().getArray()).setLlimit(new MFFloat100().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new double[] {-8.093,40.38,-0.2502}).setUlimit(new MFFloat105().getArray()).setLlimit(new MFFloat106().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new double[] {-7.808,31.46,-0.05849}).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())
...
private class MFRotation124 {
  private org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new double[] {0,0,0,0,-1,0,0,3,0,0,0,0});
  }
}

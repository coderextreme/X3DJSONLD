    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("AnnexB01Jin").setDEF("hanim_AnnexB01Jin").setInfo(new MFString0().getArray()).setScale(new double[] {0.0225,0.0225,0.0225}).setVersion("2.0")
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_AnnexB01Jin").setName("humanoid_root").setDEF("hanim_HumanoidRoot").setCenter(new double[] {0,30.53,-0.7076}).setContainerFieldOverride("skeleton"))
              ...
              .addChild(new Transform().setTranslation(new double[] {0,30.53,-0.7076})
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("Annex01JinTextureAtlas").setUrl(new MFString1().getArray())))
                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt322().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt323().getArray())
                    .setCoord(new Coordinate().setPoint(new MFVec3f4().getArray()))
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f5().getArray()))))))
            .addChild(new HAnimJoint("hanim_HumanoidRoot").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new double[] {0,35.8,-0.7076})
              .addChild(new HAnimSegment("hanim_sacroiliac").setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new Transform().setTranslation(new double[] {0,35.8,-0.7076})
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt326().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt327().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new double[] {4.116,17.26,-0.8639})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3214().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3215().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new double[] {3.854,3.939,-0.7038})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3218().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3219().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f20().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f21().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_metatarsophalangeal").setDEF("hanim_l_metatarsophalangeal").setCenter(new double[] {3.854,3.64,0.7402})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new double[] {-4.207,32.02,-0.8155})
                  ...
                  .addChild(new Transform().setTranslation(new double[] {-4.207,32.02,-0.8155})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3226().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3227().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new double[] {-4.116,17.26,-0.8639})
                    ...
                    .addChild(new Transform().setTranslation(new double[] {-4.116,17.26,-0.8639})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3230().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3231().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new double[] {-3.854,3.939,-0.7038})
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_metatarsophalangeal").setDEF("hanim_r_metatarsophalangeal").setCenter(new double[] {-3.854,3.64,0.7402})
                        ...
                        .addChild(new Transform().setTranslation(new double[] {-3.854,3.64,0.7402})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3238().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3239().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("vl5").setDEF("hanim_vl5").setCenter(new double[] {0,40.23,-0.8527})
                  ...
                  .addChild(new Transform().setTranslation(new double[] {0,40.23,-0.8527})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                        .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3242().getArray().append(new MFInt3243().getArray())).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3244().getArray().append(new MFInt3245().getArray()))
                    ...
                    .addChild(new Transform().setTranslation(new double[] {0,57.43,-0.6863})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3248().getArray().append(new MFInt3249().getArray()).append(new MFInt3250().getArray())).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3251().getArray().append(new MFInt3252().getArray()).append(new MFInt3253().getArray()))
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new double[] {5.975,52,-0.1452})
                  ...
                  .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new double[] {8.093,40.38,-0.2502})
                      ...
                      .addChild(new Transform().setTranslation(new double[] {8.093,40.38,-0.2502})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3261().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3262().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f63().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f64().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new double[] {7.808,31.46,-0.05849})
                        ...
                        .addChild(new Transform().setTranslation(new double[] {7.808,31.46,-0.05849})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3265().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3266().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f67().getArray()))
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f68().getArray())))))))))
                .addChild(new HAnimJoint("hanim_vl5").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new double[] {-5.975,52,-0.1452})
                  ...
                  .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new double[] {-8.093,40.38,-0.2502})
                      ...
                      .addChild(new Transform().setTranslation(new double[] {-8.093,40.38,-0.2502})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                            .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3273().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3274().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f75().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f76().getArray()))))))
                    .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new double[] {-7.808,31.46,-0.05849})
                        ...
                        .addChild(new Transform().setTranslation(new double[] {-7.808,31.46,-0.05849})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                              .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3277().getArray()).setCreaseAngle(3.14159).setTexCoordIndex(new MFInt3278().getArray())
        ...
        .addChild(new Group().setDEF("KeyframeAnimation")
          ...
          .addChild(new PositionInterpolator().setDEF("Keyframe_HumanoidRootTranslation").setKey(new MFFloat81().getArray()).setKeyValue(new MFVec3f82().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_HumanoidRootOrientation").setKey(new MFFloat83().getArray()).setKeyValue(new MFRotation84().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_sacroiliac").setKey(new MFFloat85().getArray()).setKeyValue(new MFRotation86().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_shoulder").setKey(new MFFloat87().getArray()).setKeyValue(new MFRotation88().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_elbow").setKey(new MFFloat89().getArray()).setKeyValue(new MFRotation90().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_radiocarpal").setKey(new MFFloat91().getArray()).setKeyValue(new MFRotation92().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_shoulder").setKey(new MFFloat93().getArray()).setKeyValue(new MFRotation94().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_elbow").setKey(new MFFloat95().getArray()).setKeyValue(new MFRotation96().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_radiocarpal").setKey(new MFFloat97().getArray()).setKeyValue(new MFRotation98().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_vl5").setKey(new MFFloat99().getArray()).setKeyValue(new MFRotation100().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_skullbase").setKey(new MFFloat101().getArray()).setKeyValue(new MFRotation102().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_hip").setKey(new MFFloat103().getArray()).setKeyValue(new MFRotation104().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_knee").setKey(new MFFloat105().getArray()).setKeyValue(new MFRotation106().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_talocrural").setKey(new MFFloat107().getArray()).setKeyValue(new MFRotation108().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_metatarsophalangeal").setKey(new MFFloat109().getArray()).setKeyValue(new MFRotation110().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_hip").setKey(new MFFloat111().getArray()).setKeyValue(new MFRotation112().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_knee").setKey(new MFFloat113().getArray()).setKeyValue(new MFRotation114().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_talocrural").setKey(new MFFloat115().getArray()).setKeyValue(new MFRotation116().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_metatarsophalangeal").setKey(new MFFloat117().getArray()).setKeyValue(new MFRotation118().getArray()))

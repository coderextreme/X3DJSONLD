  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("AnnexB01Jin").setPosition(new float[] {0f,1f,3f}).setCenterOfRotation(new float[] {0f,1f,0f}))
        .addChild(new HAnimHumanoid().setDEF("hanim_AnnexB01Jin").setVersion("2.0").setName("AnnexB01Jin").setInfo(new MFString0().getArray()).setScale(new float[] {0.0225f,0.0225f,0.0225f})
          .addSkeleton(new HAnimJoint("hanim_AnnexB01Jin").setDEF("hanim_HumanoidRoot").setName("HumanoidRoot").setCenter(new float[] {0f,30.53f,-0.7076f})
            .addChild(new HAnimSegment("hanim_HumanoidRoot").setDEF("hanim_sacrum").setName("sacrum")
              .addChild(new Transform().setTranslation(new float[] {0f,30.53f,-0.7076f})
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt322().getArray()).setCoordIndex(new MFInt323().getArray())
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f4().getArray()))
                    .setCoord(new Coordinate().setPoint(new MFVec3f5().getArray()))))))
            .addChild(new HAnimJoint("hanim_HumanoidRoot").setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f,35.8f,-0.7076f})
              .addChild(new HAnimSegment("hanim_sacroiliac").setDEF("hanim_pelvis").setName("pelvis")
                .addChild(new Transform().setTranslation(new float[] {0f,35.8f,-0.7076f})
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt326().getArray()).setCoordIndex(new MFInt327().getArray())
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f8().getArray()))
                      .setCoord(new Coordinate().setPoint(new MFVec3f9().getArray()))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_l_hip").setName("l_hip").setCenter(new float[] {4.207f,32.02f,-0.8155f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {4.207f,32.02f,-0.8155f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3210().getArray()).setCoordIndex(new MFInt3211().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setDEF("hanim_l_knee").setName("l_knee").setCenter(new float[] {4.116f,17.26f,-0.8639f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {4.116f,17.26f,-0.8639f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3214().getArray()).setCoordIndex(new MFInt3215().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setDEF("hanim_l_talocrural").setName("l_talocrural").setCenter(new float[] {3.854f,3.939f,-0.7038f})
                    .addChild(new HAnimSegment("hanim_l_talocrural").setDEF("hanim_l_hindfoot").setName("l_hindfoot")
                      .addChild(new Transform().setTranslation(new float[] {3.854f,3.939f,-0.7038f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3218().getArray()).setCoordIndex(new MFInt3219().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f20().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f21().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_metatarsophalangeal").setName("l_metatarsophalangeal").setCenter(new float[] {3.854f,3.64f,0.7402f})
                      .addChild(new HAnimSegment("hanim_l_metatarsophalangeal").setDEF("hanim_l_middistal").setName("l_middistal")
                        .addChild(new Transform().setTranslation(new float[] {3.854f,3.64f,0.7402f})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3222().getArray()).setCoordIndex(new MFInt3223().getArray())
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f24().getArray()))
                              .setCoord(new Coordinate().setPoint(new MFVec3f25().getArray()))))))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-4.207f,32.02f,-0.8155f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-4.207f,32.02f,-0.8155f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3226().getArray()).setCoordIndex(new MFInt3227().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-4.116f,17.26f,-0.8639f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-4.116f,17.26f,-0.8639f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3230().getArray()).setCoordIndex(new MFInt3231().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_talocrural").setName("r_talocrural").setCenter(new float[] {-3.854f,3.939f,-0.7038f})
                    .addChild(new HAnimSegment("hanim_r_talocrural").setDEF("hanim_r_hindfoot").setName("r_hindfoot")
                      .addChild(new Transform().setTranslation(new float[] {-3.854f,3.939f,-0.7038f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3234().getArray()).setCoordIndex(new MFInt3235().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f36().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f37().getArray()))))))
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_metatarsophalangeal").setName("r_metatarsophalangeal").setCenter(new float[] {-3.854f,3.64f,0.7402f})
                      .addChild(new HAnimSegment("hanim_r_metatarsophalangeal").setDEF("hanim_r_middistal").setName("r_middistal")
                        .addChild(new Transform().setTranslation(new float[] {-3.854f,3.64f,0.7402f})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3238().getArray()).setCoordIndex(new MFInt3239().getArray())
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f40().getArray()))
                              .setCoord(new Coordinate().setPoint(new MFVec3f41().getArray()))))))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_vl5").setName("vl5").setCenter(new float[] {0f,40.23f,-0.8527f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0f,40.23f,-0.8527f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3242().getArray().append(new MFInt3243().getArray())).setCoordIndex(new MFInt3244().getArray().append(new MFInt3245().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f46().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f47().getArray()))))))
                .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_skullbase").setName("skullbase").setCenter(new float[] {0f,57.43f,-0.6863f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {0f,57.43f,-0.6863f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3248().getArray().append(new MFInt3249().getArray()).append(new MFInt3250().getArray())).setCoordIndex(new MFInt3251().getArray().append(new MFInt3252().getArray()).append(new MFInt3253().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f54().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f55().getArray().append(new MFVec3f56().getArray()))))))))
                .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {5.975f,52f,-0.1452f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {5.975f,52f,-0.1452f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3257().getArray()).setCoordIndex(new MFInt3258().getArray())
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f59().getArray()))
                      ...
                      .addChild(new Transform().setTranslation(new float[] {8.093f,40.38f,-0.2502f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3261().getArray()).setCoordIndex(new MFInt3262().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f63().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f64().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_elbow").setDEF("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(new float[] {7.808f,31.46f,-0.05849f})
                      .addChild(new HAnimSegment("hanim_l_radiocarpal").setDEF("hanim_l_hand").setName("l_hand")
                ...
                .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-5.975f,52f,-0.1452f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-5.975f,52f,-0.1452f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3269().getArray()).setCoordIndex(new MFInt3270().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new float[] {-8.093f,40.38f,-0.2502f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("Annex01JinTextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3273().getArray()).setCoordIndex(new MFInt3274().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f75().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f76().getArray()))))))
                    .addChild(new HAnimJoint("hanim_r_elbow").setDEF("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(new float[] {-7.808f,31.46f,-0.05849f})
                      .addChild(new HAnimSegment("hanim_r_radiocarpal").setDEF("hanim_r_hand").setName("r_hand")
                        .addChild(new Transform().setTranslation(new float[] {-7.808f,31.46f,-0.05849f})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
        ...
        .addChild(new Group().setDEF("KeyframeAnimation")
          ...
          .addChild(new PositionInterpolator().setDEF("Keyframe_HumanoidRoot_1").setKey(new MFFloat81().getArray()).setKeyValue(new MFVec3f82().getArray()))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_HumanoidRoot").setKey(new MFFloat83().getArray()).setKeyValue(new MFRotation84().getArray()))
...
private class MFString1 {
  private org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"Jin.png","http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/Jin.png"});
  }
}

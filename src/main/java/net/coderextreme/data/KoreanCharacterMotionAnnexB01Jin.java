...
public class KoreanCharacterMotionAnnexB01Jin implements X3DRoots {
  public static void main(String[] args) {
    ...
    X3D model = new KoreanCharacterMotionAnnexB01Jin().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/KoreanCharacterMotionAnnexB01Jin.new.java.x3d");
    model.toFileJSON("../data/KoreanCharacterMotionAnnexB01Jin.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("KoreanCharacterAnnexB01Jin.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("modified")).setContent(new SFString("29 October 2025")))
        ...
        .addMeta(new meta().setName(new SFString("specificationSection")).setContent(new SFString("HAnim 2.0 Part 2: Humanoid animation (HAnim) motion data animation, Annex D (informative) Examples of HAnim motion data animation using a Motion object")))
        .addMeta(new meta().setName(new SFString("specificationUrl")).setContent(new SFString("https://www.web3d.org/documents/specifications/19774/V2.0/MotionDataAnimation/ExampleKeyframeAnimation.html")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/KoreanCharacterAnnexB01Jin.x3d")))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f ,1f ,0f }).setDescription(new SFString("AnnexB01Jin")).setPosition(new float[] {0f ,1f ,3f }))
        .addChild(new HAnimHumanoid().setName(new SFString("AnnexB01Jin")).setDEF(new SFString("hanim_AnnexB01Jin")).setInfo(new MFString0().getArray()).setScale(new float[] {0.0225f ,0.0225f ,0.0225f }).setVersion(new SFString("2.0"))
          .addSkeleton(new HAnimJoint("hanim_AnnexB01Jin").setName(new SFString("humanoid_root")).setDEF(new SFString("hanim_HumanoidRoot")).setCenter(new float[] {0f ,30.53f ,-0.7076f })
            .addChild(new HAnimSegment("hanim_HumanoidRoot").setName(new SFString("sacrum")).setDEF(new SFString("hanim_sacrum"))
              .addChild(new Transform().setTranslation(new float[] {0f ,30.53f ,-0.7076f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF(new SFString("Annex01JinTextureAtlas")).setUrl(new MFString1().getArray())))
                  .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt322().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt323().getArray())
                    .setCoord(new Coordinate().setPoint(new MFVec3f4().getArray()))
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f5().getArray()))))))
            .addChild(new HAnimJoint("hanim_HumanoidRoot").setName(new SFString("sacroiliac")).setDEF(new SFString("hanim_sacroiliac")).setCenter(new float[] {0f ,35.8f ,-0.7076f })
              .addChild(new HAnimSegment("hanim_sacroiliac").setName(new SFString("pelvis")).setDEF(new SFString("hanim_pelvis"))
                .addChild(new Transform().setTranslation(new float[] {0f ,35.8f ,-0.7076f })
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                      .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                    .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt326().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt327().getArray())
                      .setCoord(new Coordinate().setPoint(new MFVec3f8().getArray()))
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f9().getArray()))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("l_hip")).setDEF(new SFString("hanim_l_hip")).setCenter(new float[] {4.207f ,32.02f ,-0.8155f })
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName(new SFString("l_knee")).setDEF(new SFString("hanim_l_knee")).setCenter(new float[] {4.116f ,17.26f ,-0.8639f })
                    ...
                    .addChild(new Transform().setTranslation(new float[] {4.116f ,17.26f ,-0.8639f })
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                          .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3214().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3215().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f16().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f17().getArray()))))))
                  .addChild(new HAnimJoint("hanim_l_knee").setName(new SFString("l_talocrural")).setDEF(new SFString("hanim_l_talocrural")).setCenter(new float[] {3.854f ,3.939f ,-0.7038f })
                    .addChild(new HAnimSegment("hanim_l_talocrural").setName(new SFString("l_hindfoot")).setDEF(new SFString("hanim_l_hindfoot"))
                      .addChild(new Transform().setTranslation(new float[] {3.854f ,3.939f ,-0.7038f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                            .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3218().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3219().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f20().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f21().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName(new SFString("l_metatarsophalangeal")).setDEF(new SFString("hanim_l_metatarsophalangeal")).setCenter(new float[] {3.854f ,3.64f ,0.7402f })
                      .addChild(new HAnimSegment("hanim_l_metatarsophalangeal").setName(new SFString("l_middistal")).setDEF(new SFString("hanim_l_middistal"))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("r_hip")).setDEF(new SFString("hanim_r_hip")).setCenter(new float[] {-4.207f ,32.02f ,-0.8155f })
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-4.207f ,32.02f ,-0.8155f })
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                        .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3226().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3227().getArray())
                        .setCoord(new Coordinate().setPoint(new MFVec3f28().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f29().getArray()))))))
                .addChild(new HAnimJoint("hanim_r_hip").setName(new SFString("r_knee")).setDEF(new SFString("hanim_r_knee")).setCenter(new float[] {-4.116f ,17.26f ,-0.8639f })
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-4.116f ,17.26f ,-0.8639f })
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                          .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3230().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3231().getArray())
                          .setCoord(new Coordinate().setPoint(new MFVec3f32().getArray()))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f33().getArray()))))))
                  .addChild(new HAnimJoint("hanim_r_knee").setName(new SFString("r_talocrural")).setDEF(new SFString("hanim_r_talocrural")).setCenter(new float[] {-3.854f ,3.939f ,-0.7038f })
                    .addChild(new HAnimSegment("hanim_r_talocrural").setName(new SFString("r_hindfoot")).setDEF(new SFString("hanim_r_hindfoot"))
                      .addChild(new Transform().setTranslation(new float[] {-3.854f ,3.939f ,-0.7038f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName(new SFString("r_metatarsophalangeal")).setDEF(new SFString("hanim_r_metatarsophalangeal")).setCenter(new float[] {-3.854f ,3.64f ,0.7402f })
                      .addChild(new HAnimSegment("hanim_r_metatarsophalangeal").setName(new SFString("r_middistal")).setDEF(new SFString("hanim_r_middistal"))
                        .addChild(new Transform().setTranslation(new float[] {-3.854f ,3.64f ,0.7402f })
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                              .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3238().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3239().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f40().getArray()))
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f41().getArray()))))))))))
              .addChild(new HAnimJoint("hanim_sacroiliac").setName(new SFString("vl5")).setDEF(new SFString("hanim_vl5")).setCenter(new float[] {0f ,40.23f ,-0.8527f })
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0f ,40.23f ,-0.8527f })
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                        .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                      .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3242().getArray().append(new MFInt3243().getArray())).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3244().getArray().append(new MFInt3245().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f46().getArray()))
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f47().getArray()))))))
                .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("skullbase")).setDEF(new SFString("hanim_skullbase")).setCenter(new float[] {0f ,57.43f ,-0.6863f })
                    ...
                    .addChild(new Transform().setTranslation(new float[] {0f ,57.43f ,-0.6863f })
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                          .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3248().getArray().append(new MFInt3249().getArray()).append(new MFInt3250().getArray())).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3251().getArray().append(new MFInt3252().getArray()).append(new MFInt3253().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f54().getArray().append(new MFVec3f55().getArray())))
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f56().getArray())))))))
                .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("l_shoulder")).setDEF(new SFString("hanim_l_shoulder")).setCenter(new float[] {5.975f ,52f ,-0.1452f })
                  ...
                  .addChild(new HAnimJoint("hanim_l_shoulder").setName(new SFString("l_elbow")).setDEF(new SFString("hanim_l_elbow")).setCenter(new float[] {8.093f ,40.38f ,-0.2502f })
                      ...
                      .addChild(new Transform().setTranslation(new float[] {8.093f ,40.38f ,-0.2502f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                            .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3261().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3262().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f63().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f64().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_elbow").setName(new SFString("l_radiocarpal")).setDEF(new SFString("hanim_l_radiocarpal")).setCenter(new float[] {7.808f ,31.46f ,-0.05849f })
                      .addChild(new HAnimSegment("hanim_l_radiocarpal").setName(new SFString("l_hand")).setDEF(new SFString("hanim_l_hand"))
                        .addChild(new Transform().setTranslation(new float[] {7.808f ,31.46f ,-0.05849f })
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                              .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3265().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3266().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f67().getArray()))
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f68().getArray())))))))))
                .addChild(new HAnimJoint("hanim_vl5").setName(new SFString("r_shoulder")).setDEF(new SFString("hanim_r_shoulder")).setCenter(new float[] {-5.975f ,52f ,-0.1452f })
                  ...
                  .addChild(new HAnimJoint("hanim_r_shoulder").setName(new SFString("r_elbow")).setDEF(new SFString("hanim_r_elbow")).setCenter(new float[] {-8.093f ,40.38f ,-0.2502f })
                      ...
                      .addChild(new Transform().setTranslation(new float[] {-8.093f ,40.38f ,-0.2502f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                            .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                          .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3273().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3274().getArray())
                            .setCoord(new Coordinate().setPoint(new MFVec3f75().getArray()))
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f76().getArray()))))))
                    .addChild(new HAnimJoint("hanim_r_elbow").setName(new SFString("r_radiocarpal")).setDEF(new SFString("hanim_r_radiocarpal")).setCenter(new float[] {-7.808f ,31.46f ,-0.05849f })
                      .addChild(new HAnimSegment("hanim_r_radiocarpal").setName(new SFString("r_hand")).setDEF(new SFString("hanim_r_hand"))
                        .addChild(new Transform().setTranslation(new float[] {-7.808f ,31.46f ,-0.05849f })
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                              .setTexture(new ImageTexture().setUSE(new SFString("Annex01JinTextureAtlas"))))
                            .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3277().getArray()).setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3278().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f79().getArray()))
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f80().getArray())))))))))))))
        .addChild(new Group().setDEF(new SFString("KeyframeAnimation"))
          .addChild(new TimeSensor().setDEF(new SFString("KeyframeTimer")).setCycleInterval(8.033494d).setLoop(true))
          .addChild(new PositionInterpolator().setDEF(new SFString("Keyframe_HumanoidRootTranslation")).setKey(new MFFloat81().getArray()).setKeyValue(new MFVec3f82().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_HumanoidRootOrientation")).setKey(new MFFloat83().getArray()).setKeyValue(new MFRotation84().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_sacroiliac")).setKey(new MFFloat85().getArray()).setKeyValue(new MFRotation86().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_l_shoulder")).setKey(new MFFloat87().getArray()).setKeyValue(new MFRotation88().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_l_elbow")).setKey(new MFFloat89().getArray()).setKeyValue(new MFRotation90().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_l_radiocarpal")).setKey(new MFFloat91().getArray()).setKeyValue(new MFRotation92().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_r_shoulder")).setKey(new MFFloat93().getArray()).setKeyValue(new MFRotation94().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_r_elbow")).setKey(new MFFloat95().getArray()).setKeyValue(new MFRotation96().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_r_radiocarpal")).setKey(new MFFloat97().getArray()).setKeyValue(new MFRotation98().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_vl5")).setKey(new MFFloat99().getArray()).setKeyValue(new MFRotation100().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_skullbase")).setKey(new MFFloat101().getArray()).setKeyValue(new MFRotation102().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_l_hip")).setKey(new MFFloat103().getArray()).setKeyValue(new MFRotation104().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_l_knee")).setKey(new MFFloat105().getArray()).setKeyValue(new MFRotation106().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_l_talocrural")).setKey(new MFFloat107().getArray()).setKeyValue(new MFRotation108().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_l_metatarsophalangeal")).setKey(new MFFloat109().getArray()).setKeyValue(new MFRotation110().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_r_hip")).setKey(new MFFloat111().getArray()).setKeyValue(new MFRotation112().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_r_knee")).setKey(new MFFloat113().getArray()).setKeyValue(new MFRotation114().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_r_talocrural")).setKey(new MFFloat115().getArray()).setKeyValue(new MFRotation116().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("Keyframe_r_metatarsophalangeal")).setKey(new MFFloat117().getArray()).setKeyValue(new MFRotation118().getArray()))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_HumanoidRootTranslation")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_HumanoidRootOrientation")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_sacroiliac")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_l_shoulder")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_l_elbow")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_l_radiocarpal")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_r_shoulder")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_r_elbow")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_r_radiocarpal")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_vl5")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_skullbase")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_l_hip")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_l_knee")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_l_talocrural")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_l_metatarsophalangeal")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_r_hip")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_r_knee")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_r_talocrural")))
          .addChild(new ROUTE().setFromField(new SFString("fraction_changed")).setFromNode(new SFString("KeyframeTimer")).setToField(new SFString("set_fraction")).setToNode(new SFString("Keyframe_r_metatarsophalangeal")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_HumanoidRootTranslation")).setToField(new SFString("translation")).setToNode(new SFString("hanim_HumanoidRoot")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_HumanoidRootOrientation")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_HumanoidRoot")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_sacroiliac")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_sacroiliac")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_l_shoulder")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_l_shoulder")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_l_elbow")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_l_elbow")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_l_radiocarpal")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_l_radiocarpal")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_r_shoulder")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_r_shoulder")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_r_elbow")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_r_elbow")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_r_radiocarpal")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_r_radiocarpal")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_vl5")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_vl5")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_skullbase")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_skullbase")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_l_hip")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_l_hip")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_l_knee")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_l_knee")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_l_talocrural")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_l_talocrural")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_l_talocrural")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_l_metatarsophalangeal")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_r_hip")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_r_hip")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_r_knee")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_r_knee")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_l_talocrural")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_r_talocrural")))
          .addChild(new ROUTE().setFromField(new SFString("value_changed")).setFromNode(new SFString("Keyframe_l_talocrural")).setToField(new SFString("rotation")).setToNode(new SFString("hanim_r_metatarsophalangeal")))));
    return X3D0;
    }
...
private class MFString1 {
  private org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"Jin.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/Jin.png"});
  }
}

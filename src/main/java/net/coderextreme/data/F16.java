...
public class F16 {
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        .addChild(new Transform().setDEF("F16Transform").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Transform().setDEF("MainFrameTransform").setScale(new float[] {3f,3f,3f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setDEF("Nose").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new float[] {0.25f,0.25f,0.25f})))
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt320().getArray())).setCreaseAngle(0.5f).setNormalIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt321().getArray())).setSolid(false)
                .setCoord(new Coordinate().setDEF("coordinates").setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f2().getArray())))
                .setNormal(new Normal().setDEF("normalVector").setVector(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f3().getArray())))))
            .addChild(new Shape().setDEF("Canopy").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new float[] {0.25f,0.25f,0.25f}).setTransparency(0.8f)))
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt324().getArray())).setCreaseAngle(0.5f).setNormalIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt325().getArray())).setSolid(false)
                .setCoord(new Coordinate().setUSE("coordinates"))
                .setNormal(new Normal().setUSE("normalVector"))))
            .addChild(new Shape().setDEF("MainBodyAndWingEdges").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new float[] {0.1796f,0.1914f,0.2382f})))
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt326().getArray())).setCreaseAngle(0.5f).setNormalIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt327().getArray())).setSolid(false)
                .setCoord(new Coordinate().setUSE("coordinates"))
                .setNormal(new Normal().setUSE("normalVector"))))
            .addChild(new Shape().setDEF("ExhaustExitFlatPanel").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new float[] {0.5f,0.5f,0.5f})))
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt328().getArray())).setCreaseAngle(0.5f).setNormalIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt329().getArray())).setSolid(false)
                .setCoord(new Coordinate().setUSE("coordinates"))
                .setNormal(new Normal().setUSE("normalVector"))))
            .addChild(new Shape().setDEF("ExhaustEntranceFrontBottomPart").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new float[] {0.2304f,0.2304f,0.2304f})))
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3210().getArray())).setCreaseAngle(0.5f).setNormalIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3211().getArray())).setSolid(false)
                .setCoord(new Coordinate().setUSE("coordinates"))
                .setNormal(new Normal().setUSE("normalVector"))))
            .addChild(new Shape().setDEF("ThirdPartFromNoseUnderCanopy").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new float[] {0.6f,0.6f,0.6f})))
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3212().getArray())).setCreaseAngle(0.5f).setNormalIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3213().getArray())).setSolid(false)
                .setCoord(new Coordinate().setUSE("coordinates"))
                .setNormal(new Normal().setUSE("normalVector"))))
            .addChild(new Shape().setDEF("RearExhaustExitPartLastPartOfMainBody").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new float[] {0.37f,0.37f,0.37f}).setShininess(0.5f)))
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3214().getArray())).setCreaseAngle(0.5f).setNormalIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3215().getArray())).setSolid(false)
                .setCoord(new Coordinate().setUSE("coordinates"))
                .setNormal(new Normal().setUSE("normalVector"))))
            .addChild(new Shape().setDEF("WingsAndTail").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setEmissiveColor(new float[] {0.1796f,0.1914f,0.2382f})))
              .setGeometry(new IndexedFaceSet().setColorPerVertex(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3216().getArray())).setCreaseAngle(0.5f).setNormalIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3217().getArray())).setSolid(false)
                .setCoord(new Coordinate().setUSE("coordinates"))
                .setNormal(new Normal().setUSE("normalVector"))))
            .addChild(new Shape().setDEF("SecondPartAfterNose").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new float[] {0.6f,0.6f,0.6f})))
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3218().getArray())).setCreaseAngle(0.5f).setNormalIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3219().getArray())).setSolid(false)
                .setCoord(new Coordinate().setUSE("coordinates"))
                .setNormal(new Normal().setUSE("normalVector")))))
          .addChild(new Transform().setDEF("CockpitTransform").setRotation(new float[] {1f,0f,0f,-0.1f}).setScale(new float[] {0.045f,0.045f,0.045f}).setTranslation(new float[] {0f,1f,-10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString20().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
          .addChild(new Transform().setDEF("SeatTransform").setRotation(new float[] {-1f,0f,0f,-0.1f}).setScale(new float[] {0.9f,0.9f,0.9f}).setTranslation(new float[] {0f,0f,-8.3f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString21().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
          .addChild(new Transform().setDEF("FrontWheelTransform").setCenter(new float[] {0f,2.5f,0f}).setRotation(new float[] {-1f,0f,0f,1.92f}).setTranslation(new float[] {0.7f,-5.2f,-6.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addComments(new CommentsBlock("Front wheel is taken from the Savage Library, modified and re-animated.(from F18 Blue Angel)"))
            .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString22().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
          .addChild(new Transform().setDEF("RearLeftWheelTransform").setCenter(new float[] {0f,2.5f,0f}).setRotation(new float[] {1f,0f,1f,1.92f}).setTranslation(new float[] {-2.95f,-5f,7f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addComments(new CommentsBlock("Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel)"))
            .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString23().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
          .addChild(new Transform().setDEF("RearRightWheelTransform").setCenter(new float[] {0f,2.5f,0f}).setRotation(new float[] {-1f,0f,-1f,1.92f}).setTranslation(new float[] {2.95f,-5f,7f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addComments(new CommentsBlock("Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel)"))
            .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString24().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
          .addChild(new Transform().setDEF("CockpitButtonsTransform").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Transform().setDEF("UpButtonTransform").setRotation(new float[] {1f,0f,0f,1.57f}).setScale(new float[] {0.008f,0.008f,0.008f}).setTranslation(new float[] {-0.95f,1.05f,-10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .addChild(new Transform().setDEF("DownButtonTransform").setRotation(new float[] {1f,0f,0f,1.57f}).setScale(new float[] {0.008f,0.008f,0.008f}).setTranslation(new float[] {-0.83f,1.05f,-10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setGeometry(new Cylinder().setHeight(1f).setRadius(4f))
                .setAppearance(new Appearance()
            ...
            .addChild(new Transform().setDEF("GearUpTextTransform").setScale(new float[] {0.06f,0.06f,0.06f}).setTranslation(new float[] {-0.65f,1.55f,-10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString25().getArray())))
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,0f,0f})))))
            .addChild(new Transform().setDEF("GearDownTextTransform").setScale(new float[] {0.06f,0.06f,0.06f}).setTranslation(new float[] {-0.65f,1.35f,-10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setGeometry(new Text().setLength(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat26().getArray())).setString(new org.web3d.x3d.jsail.fields.MFString(new MFString27().getArray())))
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,0f})))))
            .addChild(new Transform().setDEF("FireButtonTransform").setRotation(new float[] {1f,0f,0f,1.57f}).setScale(new float[] {0.008f,0.008f,0.008f}).setTranslation(new float[] {0.52f,1.6f,-10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setGeometry(new Cylinder().setHeight(1f).setRadius(4f))
                .setAppearance(new Appearance()
            ...
            .addChild(new Transform().setDEF("FireTextTransform").setScale(new float[] {0.06f,0.06f,0.06f}).setTranslation(new float[] {0.36f,1.5f,-10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Transform().setDEF("NoseAntennaTransform").setRotation(new float[] {1f,0f,0f,1.57f}).setTranslation(new float[] {0f,-0.275f,-21f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
        ...
        .addChild(new OrientationInterpolator().setDEF("GearUpInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat29().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation30().getArray())))
        ...
        .addChild(new OrientationInterpolator().setDEF("GearDownInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat31().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation32().getArray())))
        ...
        .addChild(new OrientationInterpolator().setDEF("RRearInterUp1").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat33().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation34().getArray())))
        .addChild(new OrientationInterpolator().setDEF("RRearInterDown1").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat35().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation36().getArray())))
        ...
        .addChild(new OrientationInterpolator().setDEF("LRearInterUp1").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat37().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation38().getArray())))
        .addChild(new OrientationInterpolator().setDEF("LRearInterDown1").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat39().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation40().getArray())))
        ...
        .addChild(new Background().setGroundAngle(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat41().getArray())).setGroundColor(new org.web3d.x3d.jsail.fields.MFColor(new MFColor42().getArray())).setSkyAngle(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat43().getArray())).setSkyColor(new org.web3d.x3d.jsail.fields.MFColor(new MFColor44().getArray())))
        .addChild(new Transform().setDEF("RightmostAmraamTransform").setRotation(new float[] {-1f,0f,0f,1.57f}).setScale(new float[] {1.4f,1.4f,1.4f}).setTranslation(new float[] {15.65f,0f,4.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setDEF("Amraam").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString45().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new Transform().setDEF("LeftmostAmraamTransform").setRotation(new float[] {-1f,0f,0f,1.57f}).setScale(new float[] {1.4f,1.4f,1.4f}).setTranslation(new float[] {-15.65f,0f,4.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUSE("Amraam")))
        .addChild(new Transform().setDEF("SidewinderHolderTransformRight").setRotation(new float[] {0f,1f,0f,1.57f}).setScale(new float[] {6f,3f,3f}).setTranslation(new float[] {9f,-1.125f,8f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setDEF("SidewinderHolder").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString46().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new Transform().setDEF("SidewinderHolderTransformLeft").setRotation(new float[] {0f,1f,0f,1.57f}).setScale(new float[] {6f,3f,3f}).setTranslation(new float[] {-8.45f,-1.125f,8f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUSE("SidewinderHolder")))
        .addChild(new Transform().setDEF("TurkishFlagTransformLeft").setRotation(new float[] {0f,-1f,0f,1.57f}).setScale(new float[] {0.3f,0.25f,0.3f}).setTranslation(new float[] {-0.01f,8f,19.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString47().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new Transform().setDEF("TurkishFlagTransformRight").setRotation(new float[] {0f,1f,0f,1.57f}).setScale(new float[] {0.3f,0.25f,0.3f}).setTranslation(new float[] {0.01f,8f,20.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString48().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new Transform().setDEF("AmraamHolderTransformLeft").setTranslation(new float[] {-12f,-0.176f,10.7f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setDEF("AmraamHolder").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString49().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new Transform().setDEF("AmraamHolderTransformRight").setTranslation(new float[] {12f,-0.176f,10.7f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUSE("AmraamHolder")))
        .addChild(new Transform().setDEF("AmraamInnerTransformRight").setRotation(new float[] {-1f,0f,0f,1.57f}).setScale(new float[] {1.4f,1.4f,1.4f}).setTranslation(new float[] {12f,-1.6f,4.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUSE("Amraam")))
        .addChild(new Transform().setDEF("AmraamInnerTransformLeft").setRotation(new float[] {-1f,0f,0f,1.57f}).setScale(new float[] {1.4f,1.4f,1.4f}).setTranslation(new float[] {-12f,-1.6f,4.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUSE("Amraam")))
        .addChild(new Transform().setDEF("SidewinderTransformLeft").setRotation(new float[] {-1f,0f,0f,1.57f}).setScale(new float[] {1.6f,1.6f,1.6f}).setTranslation(new float[] {-8.7f,-2f,3.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setDEF("Sidewinder").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString50().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new Transform().setDEF("SidewinderTransformRight").setRotation(new float[] {-1f,0f,0f,1.57f}).setScale(new float[] {1.6f,1.6f,1.6f}).setTranslation(new float[] {8.7f,-2f,3.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUSE("Sidewinder")))
        .addChild(new Transform().setDEF("FuelTankHolderTransformLeft").setRotation(new float[] {0f,1f,0f,1.57f}).setScale(new float[] {1.5f,1.5f,1.5f}).setTranslation(new float[] {-4.8f,-1.125f,6f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setDEF("FuelTankHolder").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString51().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new Transform().setDEF("FuelTankHolderTransformRight").setRotation(new float[] {0f,1f,0f,1.57f}).setScale(new float[] {1.5f,1.5f,1.5f}).setTranslation(new float[] {5.3f,-1.125f,6f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUSE("FuelTankHolder")))
        .addChild(new Transform().setDEF("FuelTankTransformRight").setRotation(new float[] {-1f,0f,0f,1.57f}).setScale(new float[] {1.5f,1.5f,1.5f}).setTranslation(new float[] {5f,-2.85f,5.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setDEF("FuelTank").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString52().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new Transform().setDEF("FuelTankTransformLeft").setRotation(new float[] {-1f,0f,0f,1.57f}).setScale(new float[] {1.5f,1.5f,1.5f}).setTranslation(new float[] {-5f,-2.85f,5.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUSE("FuelTank")))
        .addChild(new Transform().setDEF("InlineCoverOfPlaneTansform").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setGeometry(new Box().setSize(new float[] {4.15f,0.1f,20f}).setSolid(true))
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(new float[] {0.25f,0.25f,0.25f})))))
        .addChild(new Transform().setDEF("TargetHelicopterTransform").setTranslation(new float[] {16f,-50f,-500f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString53().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new TimeSensor().setDEF("FireClock").setCycleInterval(8d))
        .addChild(new PositionInterpolator().setDEF("MissilePath").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat54().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f55().getArray())))

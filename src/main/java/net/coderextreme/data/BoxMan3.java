...
public class BoxMan3 implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new BoxMan3().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/BoxMan3.new.java.x3d");
    model.toFileJSON("../data/BoxMan3.new.java.json");
    }
...
ProtoInstance ProtoInstance0 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new WorldInfo().setTitle("BoxMan3 - A Seamless VRML Human").setInfo(new MFString1().getArray()))

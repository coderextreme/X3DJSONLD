...
ProtoInstance ProtoInstance0 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Humanoid").setDEF("boxman_Humanoid").setInfo(new MFString3().getArray()).setVersion("2.0")
          .addSkeleton(new HAnimJoint("boxman_Humanoid").setName("humanoid_root").setDEF("boxman_humanoid_root").setCenter(new float[] {0f,0.9723f,-0.0728f}).setSkinCoordIndex(new MFInt324().getArray()).setSkinCoordWeight(new MFFloat5().getArray()).setUlimit(new MFFloat6().getArray()).setLlimit(new MFFloat7().getArray())
            .addChild(new HAnimSegment("boxman_humanoid_root").setName("sacrum").setDEF("boxman_sacrum")
              .addChild(new Transform("boxman_sacrum").setTranslation(new float[] {0f,0.9723f,-0.0728f})
                .addChild(new Shape().setDEF("SphereYellow")
                  .setAppearance(new Appearance("SphereYellow")
                    .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,0f})))
                  .setGeometry(new Sphere("SphereYellow").setRadius(0.02f)))))
            .addChild(new HAnimJoint("boxman_humanoid_root").setName("l_hip").setDEF("boxman_l_hip").setCenter(new float[] {0.0956f,0.9364f,0f}).setSkinCoordIndex(new MFInt328().getArray()).setSkinCoordWeight(new MFFloat9().getArray()).setUlimit(new MFFloat10().getArray()).setLlimit(new MFFloat11().getArray())
              .addChild(new HAnimSegment("boxman_l_hip").setName("l_thigh").setDEF("boxman_l_thigh")
                .addChild(new Transform("boxman_l_thigh").setTranslation(new float[] {0.0956f,0.9364f,0f})
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint("boxman_l_hip").setName("l_knee").setDEF("boxman_l_knee").setCenter(new float[] {0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new MFInt3212().getArray()).setSkinCoordWeight(new MFFloat13().getArray()).setUlimit(new MFFloat14().getArray()).setLlimit(new MFFloat15().getArray())
                .addChild(new HAnimSegment("boxman_l_knee").setName("l_calf").setDEF("boxman_l_calf")
                  .addChild(new Transform("boxman_l_calf").setTranslation(new float[] {0.0956f,0.5095f,-0.0036f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint("boxman_l_knee").setName("l_ankle").setDEF("boxman_l_ankle").setCenter(new float[] {0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new MFInt3216().getArray()).setSkinCoordWeight(new MFFloat17().getArray()).setUlimit(new MFFloat18().getArray()).setLlimit(new MFFloat19().getArray())
                  .addChild(new HAnimSegment("boxman_l_ankle").setName("l_hindfoot").setDEF("boxman_l_hindfoot")
                    .addChild(new Transform("boxman_l_hindfoot").setTranslation(new float[] {0.0946f,0.0762f,-0.0261f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint("boxman_l_ankle").setName("l_midtarsal").setDEF("boxman_l_midtarsal").setCenter(new float[] {0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new MFInt3220().getArray()).setSkinCoordWeight(new MFFloat21().getArray()).setUlimit(new MFFloat22().getArray()).setLlimit(new MFFloat23().getArray())
                    .addChild(new HAnimSegment("boxman_l_midtarsal").setName("l_middistal").setDEF("boxman_l_middistal")
                      .addChild(new Transform("boxman_l_middistal").setTranslation(new float[] {0.1079f,0.0317f,0.067f})
                        .addChild(new Shape().setUSE("SphereYellow")))
                      .addChild(new HAnimSite("boxman_l_middistal").setName("l_middistal_tip").setDEF("boxman_l_middistal_tip").setTranslation(new float[] {0.095f,0.0005f,0.1924f})
                        .addChild(new Shape("boxman_l_middistal_tip").setDEF("SphereRed")
                          .setAppearance(new Appearance("SphereRed")
                            .setMaterial(new Material().setDiffuseColor(new float[] {1f,0f,0f})))
                          .setGeometry(new Sphere("SphereRed").setRadius(0.02f)))))))))
            .addChild(new HAnimJoint("boxman_humanoid_root").setName("r_hip").setDEF("boxman_r_hip").setCenter(new float[] {-0.0956f,0.9364f,0f}).setSkinCoordIndex(new MFInt3224().getArray()).setSkinCoordWeight(new MFFloat25().getArray()).setUlimit(new MFFloat26().getArray()).setLlimit(new MFFloat27().getArray())
              .addChild(new HAnimSegment("boxman_r_hip").setName("r_thigh").setDEF("boxman_r_thigh")
                .addChild(new Transform("boxman_r_thigh").setTranslation(new float[] {-0.0956f,0.9364f,0f})
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint("boxman_r_hip").setName("r_knee").setDEF("boxman_r_knee").setCenter(new float[] {-0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new MFInt3228().getArray()).setSkinCoordWeight(new MFFloat29().getArray()).setUlimit(new MFFloat30().getArray()).setLlimit(new MFFloat31().getArray())
                .addChild(new HAnimSegment("boxman_r_knee").setName("r_calf").setDEF("boxman_r_calf")
                  .addChild(new Transform("boxman_r_calf").setTranslation(new float[] {-0.0956f,0.5095f,-0.0036f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint("boxman_r_knee").setName("r_ankle").setDEF("boxman_r_ankle").setCenter(new float[] {-0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new MFInt3232().getArray()).setSkinCoordWeight(new MFFloat33().getArray()).setUlimit(new MFFloat34().getArray()).setLlimit(new MFFloat35().getArray())
                  .addChild(new HAnimSegment("boxman_r_ankle").setName("r_hindfoot").setDEF("boxman_r_hindfoot")
                    .addChild(new Transform("boxman_r_hindfoot").setTranslation(new float[] {-0.0946f,0.0762f,-0.0261f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint("boxman_r_ankle").setName("r_midtarsal").setDEF("boxman_r_midtarsal").setCenter(new float[] {-0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new MFInt3236().getArray()).setSkinCoordWeight(new MFFloat37().getArray()).setUlimit(new MFFloat38().getArray()).setLlimit(new MFFloat39().getArray())
                    .addChild(new HAnimSegment("boxman_r_midtarsal").setName("r_middistal").setDEF("boxman_r_middistal")
                      .addChild(new Transform("boxman_r_middistal").setTranslation(new float[] {-0.1079f,0.0317f,0.067f})
                        .addChild(new Shape().setUSE("SphereYellow")))
                      .addChild(new HAnimSite("boxman_r_middistal").setName("r_middistal_tip").setDEF("boxman_r_middistal_tip").setTranslation(new float[] {-0.095f,0.0005f,0.1924f})
                        .addChild(new Shape("boxman_r_middistal_tip").setUSE("SphereRed"))))))))
            .addChild(new HAnimJoint("boxman_humanoid_root").setName("vl5").setDEF("boxman_vl5").setCenter(new float[] {0f,1.0817f,-0.0728f}).setSkinCoordIndex(new MFInt3240().getArray()).setSkinCoordWeight(new MFFloat41().getArray()).setUlimit(new MFFloat42().getArray()).setLlimit(new MFFloat43().getArray())
              .addChild(new HAnimSegment("boxman_vl5").setName("l5").setDEF("boxman_l5")
                .addChild(new Transform("boxman_l5").setTranslation(new float[] {0f,1.0817f,-0.0728f})
                  .addChild(new Shape().setUSE("SphereYellow"))))
              .addChild(new HAnimJoint("boxman_vl5").setName("skullbase").setDEF("boxman_skullbase").setCenter(new float[] {0f,1.644f,0.036f}).setSkinCoordIndex(new MFInt3244().getArray()).setSkinCoordWeight(new MFFloat45().getArray()).setUlimit(new MFFloat46().getArray()).setLlimit(new MFFloat47().getArray())
                .addChild(new HAnimSegment("boxman_skullbase").setName("skull").setDEF("boxman_skull")
                  .addChild(new Transform("boxman_skull").setTranslation(new float[] {0f,1.644f,0.036f})
                    .addChild(new Shape().setUSE("SphereYellow")))
                  .addChild(new HAnimSite("boxman_skull").setName("skull_tip").setDEF("boxman_skull_tip").setTranslation(new float[] {-0.0029f,1.7771f,0.0274f})
                    .addChild(new Shape("boxman_skull_tip").setUSE("SphereYellow")))))
              .addChild(new HAnimJoint("boxman_vl5").setName("l_shoulder").setDEF("boxman_l_shoulder").setCenter(new float[] {0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new MFInt3248().getArray()).setSkinCoordWeight(new MFFloat49().getArray()).setUlimit(new MFFloat50().getArray()).setLlimit(new MFFloat51().getArray())
                .addChild(new HAnimSegment("boxman_l_shoulder").setName("l_upperarm").setDEF("boxman_l_upperarm")
                  .addChild(new Transform("boxman_l_upperarm").setTranslation(new float[] {0.1968f,1.4642f,-0.0265f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint("boxman_l_shoulder").setName("l_elbow").setDEF("boxman_l_elbow").setCenter(new float[] {0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new MFInt3252().getArray()).setSkinCoordWeight(new MFFloat53().getArray()).setUlimit(new MFFloat54().getArray()).setLlimit(new MFFloat55().getArray())
                  .addChild(new HAnimSegment("boxman_l_elbow").setName("l_forearm").setDEF("boxman_l_forearm")
                    .addChild(new Transform("boxman_l_forearm").setTranslation(new float[] {0.1982f,1.1622f,-0.0557f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint("boxman_l_elbow").setName("l_wrist").setDEF("boxman_l_wrist").setCenter(new float[] {0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new MFInt3256().getArray()).setSkinCoordWeight(new MFFloat57().getArray()).setUlimit(new MFFloat58().getArray()).setLlimit(new MFFloat59().getArray())
                    .addChild(new HAnimSegment("boxman_l_wrist").setName("l_hand").setDEF("boxman_l_hand")
                      .addChild(new Transform("boxman_l_hand").setTranslation(new float[] {0.1972f,0.8929f,-0.069f})
                        .addChild(new Shape().setUSE("SphereYellow")))
                      .addChild(new HAnimSite("boxman_l_hand").setName("l_hand_tip").setDEF("boxman_l_hand_tip").setTranslation(new float[] {0.1912f,0.6976f,-0.071f})
                        .addChild(new Shape("boxman_l_hand_tip").setUSE("SphereRed")))))))
              .addChild(new HAnimJoint("boxman_vl5").setName("r_shoulder").setDEF("boxman_r_shoulder").setCenter(new float[] {-0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new MFInt3260().getArray()).setSkinCoordWeight(new MFFloat61().getArray()).setUlimit(new MFFloat62().getArray()).setLlimit(new MFFloat63().getArray())
                .addChild(new HAnimSegment("boxman_r_shoulder").setName("r_upperarm").setDEF("boxman_r_upperarm")
                  .addChild(new Transform("boxman_r_upperarm").setTranslation(new float[] {-0.1968f,1.4642f,-0.0265f})
                    .addChild(new Shape().setUSE("SphereYellow"))))
                .addChild(new HAnimJoint("boxman_r_shoulder").setName("r_elbow").setDEF("boxman_r_elbow").setCenter(new float[] {-0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new MFInt3264().getArray()).setSkinCoordWeight(new MFFloat65().getArray()).setUlimit(new MFFloat66().getArray()).setLlimit(new MFFloat67().getArray())
                  .addChild(new HAnimSegment("boxman_r_elbow").setName("r_forearm").setDEF("boxman_r_forearm")
                    .addChild(new Transform("boxman_r_forearm").setTranslation(new float[] {-0.1982f,1.1622f,-0.0557f})
                      .addChild(new Shape().setUSE("SphereYellow"))))
                  .addChild(new HAnimJoint("boxman_r_elbow").setName("r_wrist").setDEF("boxman_r_wrist").setCenter(new float[] {-0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new MFInt3268().getArray()).setSkinCoordWeight(new MFFloat69().getArray()).setUlimit(new MFFloat70().getArray()).setLlimit(new MFFloat71().getArray())
                    .addChild(new HAnimSegment("boxman_r_wrist").setName("r_hand").setDEF("boxman_r_hand")
                      .addChild(new Transform("boxman_r_hand").setTranslation(new float[] {-0.1972f,0.8929f,-0.069f})
                        .addChild(new Shape().setUSE("SphereYellow")))
                      .addChild(new HAnimSite("boxman_r_hand").setName("r_hand_tip").setDEF("boxman_r_hand_tip").setTranslation(new float[] {-0.1912f,0.6976f,-0.071f})
                        .addChild(new Shape("boxman_r_hand_tip").setUSE("SphereRed")))))))))
          ...
          .setSkinCoord(new Coordinate("boxman_Humanoid").setDEF("SKINCOORD").setPoint(new MFVec3f72().getArray()))
          .addSkin(new Group("boxman_Humanoid")
            .addChild(new Shape().setDEF("TrouserSkin")
              .setAppearance(new Appearance("TrouserSkin")
              ...
              .setGeometry(new IndexedFaceSet("TrouserSkin").setCoordIndex(new MFInt3273().getArray().append(new MFInt3274().getArray()))
                .setCoord(new Coordinate().setUSE("SKINCOORD"))))
            .addChild(new Shape().setDEF("ShoeSkin")
              .setAppearance(new Appearance("ShoeSkin")
              ...
              .setGeometry(new IndexedFaceSet("ShoeSkin").setCoordIndex(new MFInt3275().getArray())
                .setCoord(new Coordinate().setUSE("SKINCOORD"))))
            .addChild(new Shape().setDEF("ShirtSkin")
              .setAppearance(new Appearance("ShirtSkin")
              ...
              .setGeometry(new IndexedFaceSet("ShirtSkin").setCoordIndex(new MFInt3276().getArray())
                .setCoord(new Coordinate().setUSE("SKINCOORD"))))
            .addChild(new Shape().setDEF("HeadHandsFleshToneSkin")
              .setAppearance(new Appearance("HeadHandsFleshToneSkin")
              ...
              .setGeometry(new IndexedFaceSet("HeadHandsFleshToneSkin").setCoordIndex(new MFInt3277().getArray())
                .setCoord(new Coordinate().setUSE("SKINCOORD"))))
            .addChild(new Shape().setDEF("SkinLines")
              .setAppearance(new Appearance("SkinLines")
                .setMaterial(new Material().setDiffuseColor(new float[] {0f,0f,0f})))
              .addComments("Combined set of prior IFS coordIndex values")
              .setGeometry(new IndexedLineSet("SkinLines").setCoordIndex(new MFInt3278().getArray().append(new MFInt3279().getArray()).append(new MFInt3280().getArray()))
                .setCoord(new Coordinate().setUSE("SKINCOORD")))))
          .addViewpoints(new HAnimSite("boxman_Humanoid").setName("BoxMan_view").setDEF("boxman_BoxMan_view")
            .addChild(new Viewpoint("boxman_BoxMan_view").setDEF("Inclined_View").setDescription("Inclined View").setOrientation(new float[] {0f,1f,0f,0.78f}).setPosition(new float[] {2f,0.9f,2f}))
            .addChild(new Viewpoint("boxman_BoxMan_view").setDEF("Front_View").setDescription("Front View").setPosition(new float[] {0f,1f,3f}))
            .addChild(new Viewpoint("boxman_BoxMan_view").setDEF("Right_View").setDescription("Right-side View").setOrientation(new float[] {0f,1f,0f,-1.57f}).setPosition(new float[] {-3f,1f,0f}))
            .addChild(new Viewpoint("boxman_BoxMan_view").setDEF("Left_View").setDescription("Left-side View").setOrientation(new float[] {0f,1f,0f,1.57f}).setPosition(new float[] {3f,1f,0f}))
            .addChild(new Viewpoint("boxman_BoxMan_view").setDEF("Top_View").setDescription("Top View").setOrientation(new float[] {1f,0f,0f,-1.57f}).setPosition(new float[] {0f,3f,0f})))
        ...
        .addChild(new Script().setDEF("ENGINE").setDirectOutput(true).setUrl(new MFString82().getArray())
          .addField(new field("ENGINE").setType("SFRotation").setName("update").setAccessType(field.ACCESSTYPE_INPUTONLY))
          .addField(new field("ENGINE").setType("SFNode").setName("humanoid").setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
            .addChild(new HAnimHumanoid().setUSE("boxman_Humanoid")))
          .addField(new field("ENGINE").setType("MFVec3f").setName("coordList").setAccessType(field.ACCESSTYPE_INITIALIZEONLY))
          .addField(new field("ENGINE").setType("SFNode").setName("joint").setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
            .addComments("initialization node (if any) goes here"))
          .addField(new field("ENGINE").setType("SFVec3f").setName("translation").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue("0 0 0"))
          .addField(new field("ENGINE").setType("SFRotation").setName("rotation").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue("1 0 0 0"))
          .addField(new field("ENGINE").setType("SFVec3f").setName("scale").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue("1 1 1")))

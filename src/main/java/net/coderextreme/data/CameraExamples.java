      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("CameraShapeTransform").setTranslation(new float[] {0f,0.5f,0f})
          ...
          .addChild(new Transform().setDEF("CameraOffsetTransform").setTranslation(new float[] {0f,0f,0.25f})
            ...
            .addChild(new Inline().setDEF("CameraShape").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString23().getArray())))
        ...
        .addChild(new Background().setSkyColor(new org.web3d.x3d.jsail.fields.MFColor(new MFColor28().getArray())))
        ...
        .addChild(new Transform().setScale(new float[] {3f,3f,3f}).setTranslation(new float[] {0f,0.25f,0f})
          .addChild(new Inline().setDEF("CoordinateAxes").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString33().getArray()))))
        ...
        .addChild(new Anchor().setDescription("launch CameraExample scene").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString38().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString39().getArray()))

...
ProtoInstance ProtoInstance34 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new ExternProtoDeclare().setName("CameraShot").setAppinfo("CameraShot collects a specific set of CameraMovement animations that make up an individual shot").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray()))
        ...
        .addChild(new ExternProtoDeclare().setName("CameraMovement").setAppinfo("CameraMovement defines a single camera movement animation").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray()))
        ...
        .addChild(new ExternProtoDeclare().setName("OfflineRender").setAppinfo("OfflineRender defines a parameters for offline rendering of Camera animation output to a movie file (or possibly a still shot)").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray()))
        ...
        .addChild(new Group().setDEF("AnimationGroup.SimpleShots").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Transform().setDEF("Trigger.SimpleShots").setTranslation(new float[] {-4f,4f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray()))
                .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray()))))
            ...
            .addChild(new Shape().setDEF("TransparentBox").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setAppearance(new Appearance()
                .setMaterial(new Material().setTransparency(1f)))
              .setGeometry(new Box().setSize(new float[] {6f,2f,0.0001f}).setSolid(true)))))
        .addChild(new Group().setDEF("SimpleShotsTargets").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Transform().setDEF("TargetBoxZoom").setTranslation(new float[] {-50f,1f,-20f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new Box().setSize(new float[] {2f,2f,2f}).setSolid(true))
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new ImageTexture().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString6().getArray())))))
            .addChild(new Transform().setTranslation(new float[] {0f,2f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray()))
                  .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray()))))
                .setAppearance(new Appearance()
                  .setMaterial(new Material())))))
          .addChild(new Transform().setDEF("TargetBoxDolly").setTranslation(new float[] {-40f,1f,-20f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new Box().setSize(new float[] {2f,2f,2f}).setSolid(true))
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new ImageTexture().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString9().getArray())))))
            .addChild(new Transform().setTranslation(new float[] {0f,2f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString10().getArray()))
                  .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString11().getArray()))))
                .setAppearance(new Appearance()
                  .setMaterial(new Material())))))
          .addChild(new Transform().setDEF("TargetBoxPan").setTranslation(new float[] {-30f,1f,-20f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new Box().setSize(new float[] {2f,2f,2f}).setSolid(true))
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new ImageTexture().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString12().getArray())))))
            .addChild(new Transform().setTranslation(new float[] {0f,2f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString13().getArray()))
                  .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString14().getArray()))))
                .setAppearance(new Appearance()
                  .setMaterial(new Material())))))
          .addChild(new Transform().setDEF("TargetBoxBoom").setTranslation(new float[] {-20f,1f,-20f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new Box().setSize(new float[] {2f,2f,2f}).setSolid(true))
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new ImageTexture().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString15().getArray())))))
            .addChild(new Transform().setTranslation(new float[] {0f,2f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString16().getArray()))
                  .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString17().getArray()))))
                .setAppearance(new Appearance()
                  .setMaterial(new Material())))))
          .addChild(new Transform().setDEF("TargetBoxTilt").setTranslation(new float[] {-10f,1f,-20f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new Box().setSize(new float[] {2f,2f,2f}).setSolid(true))
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new ImageTexture().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString18().getArray())))))
            .addChild(new Transform().setTranslation(new float[] {0f,2f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString19().getArray()))
                  .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString20().getArray()))))
                .setAppearance(new Appearance()
                  .setMaterial(new Material()))))))
        ...
        .addChild(new Group().setDEF("AnimationGroup.AimPointTest").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Transform().setDEF("Trigger.AimPointTest").setTranslation(new float[] {4f,4f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString21().getArray()))
                .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString22().getArray()))))
              .setAppearance(new Appearance()
        ...
        .addChild(new Transform().setDEF("CameraShapeTransform").setTranslation(new float[] {0f,0.5f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Transform().setDEF("CameraOffsetTransform").setTranslation(new float[] {0f,0f,0.25f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new TouchSensor().setDEF("CameraShapeTouched"))
            .addChild(new Inline().setDEF("CameraShape").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString23().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
            .addChild(new Shape().setDEF("SightLine").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new IndexedLineSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3224().getArray()))
          ...
          .addChild(new ExternProtoDeclare().setName("ViewFrustum").setAppinfo("Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString26().getArray()))
        ...
        .addChild(new Background().setSkyColor(new org.web3d.x3d.jsail.fields.MFColor(new MFColor28().getArray())).setTransparency(0f))
        .addChild(new Transform().setRotation(new float[] {1f,0f,0f,-1.57079f}).setScale(new float[] {10f,10f,10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setAppearance(new Appearance()
              .setMaterial(new Material().setAmbientIntensity(0.01f).setDiffuseColor(new float[] {1f,1f,1f}).setShininess(0.05f)))
            .setGeometry(new IndexedFaceSet().setColorIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3229().getArray())).setColorPerVertex(false).setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3230().getArray())).setNormalPerVertex(false).setSolid(false)
              .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f31().getArray())))
              .setColor(new Color().setColor(new org.web3d.x3d.jsail.fields.MFColor(new MFColor32().getArray()))))))
        .addChild(new Transform().setScale(new float[] {3f,3f,3f}).setTranslation(new float[] {0f,0.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Inline().setDEF("CoordinateAxes").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString33().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})))
        .addChild(new Transform().setDEF("MovingBoxTransform").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new PositionInterpolator().setDEF("BoxPath").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat34().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f35().getArray())))
          ...
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .setAppearance(new Appearance()
              .setMaterial(new Material())
              .setTexture(new ImageTexture().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString36().getArray()))))))
        .addComments(new CommentsBlock("================ CrossHair visualization for center of screen ================"))
        .addChild(new ExternProtoDeclare().setName("CrossHair").setAppinfo("CrossHair prototype provides a heads-up display (HUD) crosshair at the view center, which is useful for assessing NavigationInfo lookAt point").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString37().getArray()))
        ...
        .addChild(new Anchor().setDescription("launch CameraExample scene").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString38().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString39().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Transform().setTranslation(new float[] {0f,-3f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString40().getArray()))
                .setFontStyle(new FontStyle().setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString41().getArray())).setSize(0.5f)))
              .setAppearance(new Appearance()
...
ProtoInstance33
            .addFieldValue(new fieldValue().setName("NavigationInfoNode")
              .addChild(new NavigationInfo().setDEF("TestNavigationInfo").setTransitionType(new org.web3d.x3d.jsail.fields.MFString(new MFString27().getArray())).setVisibilityLimit(100f)));
ProtoInstance33

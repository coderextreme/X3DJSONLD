...
public class MaskAndSnorkel {
  public static void main(String[] args) {
    ...
    new MaskAndSnorkel().initialize().toFileJSON("../data/MaskAndSnorkel.new.json");
    }
        ...
        .addChild(new Transform().setDEF("maskAndSnorkel")
          .addChild(new Transform()
            .addChild(new Shape().setDEF("maskFrame")
              ...
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt321().getArray())).setCreaseAngle(1.45f).setSolid(false)
            ...
            .addChild(new Transform().setTranslation(new float[] {0f,-0.02f,0f})
              .addChild(new Transform().setScale(new float[] {0.9f,0.9f,0.9f}).setTranslation(new float[] {0.035f,-0.07f,-0.02f})
                .addChild(new Shape()
                  ...
                  .setGeometry(new Extrusion().setCrossSection(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f3().getArray())).setSpine(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f4().getArray())))))
              .addChild(new Transform().setRotation(new float[] {0f,0f,1f,1.57f}).setScale(new float[] {0.9f,0.9f,0.9f}).setTranslation(new float[] {0.01f,-0.04f,-0.02f})
                .addChild(new Shape()
                  ...
                  .setGeometry(new Extrusion().setCrossSection(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f5().getArray())).setSpine(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f6().getArray())))))
              .addChild(new Transform().setRotation(new float[] {0f,0f,1f,-0.85f}).setScale(new float[] {0.9f,0.9f,0.9f}).setTranslation(new float[] {0.005f,-0.01f,-0.02f})
                .addChild(new Shape()
                  ...
                  .setGeometry(new Extrusion().setCrossSection(new org.web3d.x3d.jsail.fields.MFVec2f(new MFVec2f7().getArray())).setSpine(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f8().getArray())))))))
          .addChild(new Transform()
            .addChild(new Shape().setDEF("maskLensR")
              ...
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt329().getArray())).setCreaseAngle(1.45f).setSolid(false)
          ...
          .addChild(new Transform()
            .addChild(new Shape().setDEF("maskLensL")
              ...
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3211().getArray())).setCreaseAngle(1.45f).setSolid(false)
          ...
          .addChild(new Transform()
            .addChild(new Shape().setDEF("nose")
              ...
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3213().getArray())).setCreaseAngle(1.45f).setSolid(false)
          ...
          .addChild(new Transform()
            .addChild(new Shape().setDEF("faceFit")
              ...
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3215().getArray())).setCreaseAngle(1.45f).setSolid(false)
          ...
          .addChild(new Transform()
            .addChild(new Shape().setDEF("belt")
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("plastic")))
              .setGeometry(new IndexedFaceSet().setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3217().getArray())).setCreaseAngle(1.45f).setSolid(false)

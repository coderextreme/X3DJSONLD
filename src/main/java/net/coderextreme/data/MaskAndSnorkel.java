        ...
        .addChild(new Transform().setDEF("maskAndSnorkel")
          .addChild(new Transform("maskAndSnorkel")
            .addChild(new Shape().setDEF("maskFrame")
              ...
              .setGeometry(new IndexedFaceSet("maskFrame").setCoordIndex(new MFInt321().getArray()).setCreaseAngle(1.45f).setSolid(false)
          ...
          .addChild(new Transform("maskAndSnorkel")
            .addChild(new Shape().setDEF("maskLensR")
              ...
              .setGeometry(new IndexedFaceSet("maskLensR").setCoordIndex(new MFInt329().getArray()).setCreaseAngle(1.45f).setSolid(false)
          ...
          .addChild(new Transform("maskAndSnorkel")
            .addChild(new Shape().setDEF("maskLensL")
              ...
              .setGeometry(new IndexedFaceSet("maskLensL").setCoordIndex(new MFInt3211().getArray()).setCreaseAngle(1.45f).setSolid(false)
          ...
          .addChild(new Transform("maskAndSnorkel")
            .addChild(new Shape().setDEF("nose")
              ...
              .setGeometry(new IndexedFaceSet("nose").setCoordIndex(new MFInt3213().getArray()).setCreaseAngle(1.45f).setSolid(false)
          ...
          .addChild(new Transform("maskAndSnorkel")
            .addChild(new Shape().setDEF("faceFit")
              ...
              .setGeometry(new IndexedFaceSet("faceFit").setCoordIndex(new MFInt3215().getArray()).setCreaseAngle(1.45f).setSolid(false)
                .setCoord(new Coordinate().setPoint(new MFVec3f16().getArray())))))
          .addChild(new Transform("maskAndSnorkel")
            .addChild(new Shape().setDEF("belt")
              .setAppearance(new Appearance("belt")
                .setMaterial(new Material().setUSE("plastic")))
              .setGeometry(new IndexedFaceSet("belt").setCoordIndex(new MFInt3217().getArray()).setCreaseAngle(1.45f).setSolid(false)

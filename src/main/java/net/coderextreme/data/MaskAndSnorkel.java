...
public class MaskAndSnorkel implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/MaskAndSnorkel.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("MaskAndSnorkel.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("Diving mask and snorkel tube.")))
        .addMeta(new meta().setName(new SFString("creator")).setContent(new SFString("Etsuko Lippi")))
        .addMeta(new meta().setName(new SFString("created")).setContent(new SFString("January 24, 2001")))
        .addMeta(new meta().setName(new SFString("modified")).setContent(new SFString("23 May 2020")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/MaskAndSnorkel.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("MaskAndSnorkel.x3d")))
        .addChild(new Background().setSkyColor(new MFColor0().getArray()))
        .addChild(new Transform().setDEF(new SFString("maskAndSnorkel"))
          .addChild(new Transform()
            .addChild(new Shape().setDEF(new SFString("maskFrame"))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF(new SFString("frameColor")).setDiffuseColor(new float[] {0f ,0f ,0f })))
          ...
          .addChild(new Transform().setDEF(new SFString("snorkelHoldRing")).setTranslation(new float[] {0.075f ,0.075f ,-0.02f })
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE(new SFString("frameColor"))))
              .setGeometry(new Cylinder().setHeight(0.003f ).setRadius(0.015f ))))
          .addChild(new Group().setDEF(new SFString("snorkel"))
            .addChild(new Transform().setTranslation(new float[] {0f ,-0.02f ,0f })
              .addChild(new Transform().setScale(new float[] {0.9f ,0.9f ,0.9f }).setTranslation(new float[] {0.035f ,-0.07f ,-0.02f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF(new SFString("snorkelTube")).setDiffuseColor(new float[] {0.678f ,1f ,0.184f }).setTransparency(0.4f )))
              ...
              .addChild(new Transform().setRotation(new float[] {0f ,0f ,1f ,1.57f }).setScale(new float[] {0.9f ,0.9f ,0.9f }).setTranslation(new float[] {0.01f ,-0.04f ,-0.02f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF(new SFString("Mouthpiece")).setDiffuseColor(new float[] {0.678f ,1f ,0.8f }).setTransparency(0.4f )))
              ...
              .addChild(new Transform().setRotation(new float[] {0f ,0f ,1f ,-0.85f }).setScale(new float[] {0.9f ,0.9f ,0.9f }).setTranslation(new float[] {0.005f ,-0.01f ,-0.02f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE(new SFString("Mouthpiece"))))
                  .setGeometry(new Extrusion().setCrossSection(new MFVec2f7().getArray()).setSpine(new MFVec3f8().getArray()))))))
          .addChild(new Transform()
            .addChild(new Shape().setDEF(new SFString("maskLensR"))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF(new SFString("plastic")).setDiffuseColor(new float[] {0.941f ,0.973f ,1f }).setTransparency(0.8f )))
          ...
          .addChild(new Transform()
            .addChild(new Shape().setDEF(new SFString("maskLensL"))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE(new SFString("plastic"))))
          ...
          .addChild(new Transform()
            .addChild(new Shape().setDEF(new SFString("nose"))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF(new SFString("plasticFit")).setDiffuseColor(new float[] {0.678f ,1f ,0.184f }).setTransparency(0.7f )))
          ...
          .addChild(new Transform()
            .addChild(new Shape().setDEF(new SFString("faceFit"))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE(new SFString("plasticFit"))))
          ...
          .addChild(new Transform()
            .addChild(new Shape().setDEF(new SFString("belt"))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE(new SFString("plastic"))))

...
public class JinLOA2 implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new JinLOA2().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/JinLOA2.new.java.x3d");
    model.toFileJSON("../data/JinLOA2.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("Mon, 15 Sep 2025 05:20:24 GMT"))
        ...
        .addMeta(new meta().setName("TODO").setContent("rescale all contained length values from inches to meters"))
        ...
        .addMeta(new meta().setName("reference").setContent("JinOriginalLOA2.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("JinLOA2").setPosition(new float[] {0f ,1f ,3f }).setCenterOfRotation(new float[] {0f ,1f ,0f }))
        .addChild(new HAnimHumanoid().setDEF("hanim_JinLOA2").setName("JinLOA2").setLoa(2).setScale(new float[] {0.0225f ,0.0225f ,0.0225f })
          .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            ...
            .addValue(new MetadataFloat().setName("height").setValue(new MFFloat1().getArray()))
            .setMetadata(new MetadataString().setName("humanoidVersion").setValue(new MFString2().getArray())))
          .addSkeleton(new HAnimJoint("hanim_JinLOA2").setDEF("hanim_humanoid_root").setName("humanoid_root").setCenter(new float[] {0f ,35.8f ,-0.7076f })
              ...
              .addChild(new Transform().setTranslation(new float[] {0f ,35.8f ,-0.7076f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("JinLOA2TextureAtlas").setUrl(new MFString3().getArray())))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt324().getArray()).setCoordIndex(new MFInt325().getArray())
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f6().getArray()))
              ...
              .addChild(new HAnimSegment("hanim_sacroiliac").setDEF("hanim_pelvis").setName("pelvis")
                .addChild(new Transform().setTranslation(new float[] {0f ,30.53f ,-0.7076f })
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt328().getArray()).setCoordIndex(new MFInt329().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new float[] {4.207f ,35.83f ,-0.8155f })
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                        .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3212().getArray()).setCoordIndex(new MFInt3213().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new float[] {4.116f ,17.26f ,-0.8639f })
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                          .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3216().getArray()).setCoordIndex(new MFInt3217().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new float[] {3.854f ,3.939f ,-0.7038f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3220().getArray()).setCoordIndex(new MFInt3221().getArray())
                        ...
                        .addChild(new Transform().setTranslation(new float[] {3.854f ,3.336f ,-1.514f })
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3224().getArray()).setCoordIndex(new MFInt3225().getArray())
                          ...
                          .addChild(new Transform().setTranslation(new float[] {3.854f ,3.64f ,0.7402f })
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3228().getArray()).setCoordIndex(new MFInt3229().getArray())
                            ...
                            .addChild(new Transform().setTranslation(new float[] {3.854f ,1.956f ,1.682f })
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3232().getArray()).setCoordIndex(new MFInt3233().getArray())
                  ...
                  .addChild(new Transform().setTranslation(new float[] {-4.207f ,35.83f ,-0.8155f })
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                        .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3236().getArray()).setCoordIndex(new MFInt3237().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new float[] {-4.116f ,17.26f ,-0.8639f })
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                          .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3240().getArray()).setCoordIndex(new MFInt3241().getArray())
                      ...
                      .addChild(new Transform().setTranslation(new float[] {-3.854f ,3.939f ,-0.7038f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3244().getArray()).setCoordIndex(new MFInt3245().getArray())
                        ...
                        .addChild(new Transform().setTranslation(new float[] {-3.854f ,3.336f ,-1.514f })
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3248().getArray()).setCoordIndex(new MFInt3249().getArray())
                          ...
                          .addChild(new Transform().setTranslation(new float[] {-3.854f ,3.64f ,0.7402f })
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3252().getArray()).setCoordIndex(new MFInt3253().getArray())
                            ...
                            .addChild(new Transform().setTranslation(new float[] {-3.854f ,1.956f ,1.682f })
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3256().getArray()).setCoordIndex(new MFInt3257().getArray())
                ...
                .addChild(new Transform().setTranslation(new float[] {0f ,40.22f ,-0.6117f })
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                      .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3260().getArray()).setCoordIndex(new MFInt3261().getArray())
                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f62().getArray()))
                      .setCoord(new Coordinate().setPoint(new MFVec3f63().getArray()))))))
              .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_vl3").setName("vl3").setCenter(new float[] {0f ,41.3f ,-0.6117f })
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0f ,41.3f ,-0.6117f })
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                        .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3264().getArray()).setCoordIndex(new MFInt3265().getArray())
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f66().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f67().getArray()))))))
                .addChild(new HAnimJoint("hanim_vl3").setDEF("hanim_vl1").setName("vl1").setCenter(new float[] {0f ,42.76f ,-0.6117f })
                    ...
                    .addChild(new Transform().setTranslation(new float[] {0f ,42.76f ,-0.6117f })
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                          .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3268().getArray()).setCoordIndex(new MFInt3269().getArray())
                          .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f70().getArray()))
                          .setCoord(new Coordinate().setPoint(new MFVec3f71().getArray()))))))
                  .addChild(new HAnimJoint("hanim_vl1").setDEF("hanim_vt10").setName("vt10").setCenter(new float[] {0f ,44.58f ,-0.6127f })
                    .addChild(new HAnimSegment("hanim_vt10").setDEF("hanim_t10").setName("t10")
                      .addChild(new Transform().setTranslation(new float[] {0f ,44.58f ,-0.6127f })
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3272().getArray()).setCoordIndex(new MFInt3273().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f74().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f75().getArray()))))))
                    .addChild(new HAnimJoint("hanim_vt10").setDEF("hanim_vt6").setName("vt6").setCenter(new float[] {0f ,47.04f ,-0.6117f })
                      .addChild(new HAnimSegment("hanim_vt6").setDEF("hanim_t6").setName("t6")
                        .addChild(new Transform().setTranslation(new float[] {0f ,47.04f ,-0.6117f })
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3276().getArray()).setCoordIndex(new MFInt3277().getArray())
                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f78().getArray()))
                              .setCoord(new Coordinate().setPoint(new MFVec3f79().getArray()))))))
                      .addChild(new HAnimJoint("hanim_vt6").setDEF("hanim_vt1").setName("vt1").setCenter(new float[] {0f ,49.62f ,-0.6117f })
                        .addChild(new HAnimSegment("hanim_vt1").setDEF("hanim_t1").setName("t1")
                          .addChild(new Transform().setTranslation(new float[] {0f ,49.62f ,-0.6117f })
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3280().getArray().append(new MFInt3281().getArray())).setCoordIndex(new MFInt3282().getArray().append(new MFInt3283().getArray()))
                                .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f84().getArray()))
                                .setCoord(new Coordinate().setPoint(new MFVec3f85().getArray()))))))
                        .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(new float[] {1.71f ,52.82f ,-0.6127f })
                            ...
                            .addChild(new Transform().setTranslation(new float[] {1.71f ,52.82f ,-0.6127f })
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3286().getArray()).setCoordIndex(new MFInt3287().getArray())
                                  .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f88().getArray()))
                                  .setCoord(new Coordinate().setPoint(new MFVec3f89().getArray()))))))
                          .addChild(new HAnimJoint("hanim_l_acromioclavicular").setDEF("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(new float[] {5.464f ,52.06f ,-0.5732f })
                              ...
                              .addChild(new Transform().setTranslation(new float[] {5.464f ,52.06f ,-0.5732f })
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                    .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3290().getArray()).setCoordIndex(new MFInt3291().getArray())
                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f92().getArray()))
                                    .setCoord(new Coordinate().setPoint(new MFVec3f93().getArray()))))))
                            .addChild(new HAnimJoint("hanim_l_sternoclavicular").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {7.336f ,51.48f ,-0.1452f })
                                ...
                                .addChild(new Transform().setTranslation(new float[] {7.336f ,51.48f ,-0.1452f })
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                      .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3294().getArray()).setCoordIndex(new MFInt3295().getArray())
                                  ...
                                  .addChild(new Transform().setTranslation(new float[] {8.093f ,40.38f ,-0.2502f })
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                        .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3298().getArray()).setCoordIndex(new MFInt3299().getArray())
                                    ...
                                    .addChild(new Transform().setTranslation(new float[] {7.899f ,31.43f ,-0.3809f })
                                      .addChild(new Shape()
                                        .setAppearance(new Appearance()
                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                          .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32102().getArray()).setCoordIndex(new MFInt32103().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {8.205f ,29.6f ,1.302f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32106().getArray()).setCoordIndex(new MFInt32107().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {8.08f ,28.73f ,1.55f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32110().getArray()).setCoordIndex(new MFInt32111().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {7.832f ,27.85f ,1.735f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32114().getArray()).setCoordIndex(new MFInt32115().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {8.376f ,28.55f ,0.5997f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32118().getArray()).setCoordIndex(new MFInt32119().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {8.52f ,27.24f ,0.6551f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32122().getArray()).setCoordIndex(new MFInt32123().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {8.45f ,26.1f ,0.6956f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32126().getArray()).setCoordIndex(new MFInt32127().getArray())
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {8.192f ,25.17f ,0.7315f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32130().getArray()).setCoordIndex(new MFInt32131().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {8.344f ,28.65f ,-0.194f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32134().getArray()).setCoordIndex(new MFInt32135().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {8.52f ,27.26f ,-0.1959f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32138().getArray()).setCoordIndex(new MFInt32139().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {8.477f ,26.07f ,-0.2214f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32142().getArray()).setCoordIndex(new MFInt32143().getArray())
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {8.25f ,25.03f ,-0.2187f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32146().getArray()).setCoordIndex(new MFInt32147().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {8.339f ,28.57f ,-0.9243f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32150().getArray()).setCoordIndex(new MFInt32151().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {8.428f ,27.3f ,-0.9985f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32154().getArray()).setCoordIndex(new MFInt32155().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {8.428f ,26.29f ,-1.034f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32158().getArray()).setCoordIndex(new MFInt32159().getArray())
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {8.192f ,25.31f ,-1.124f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32162().getArray()).setCoordIndex(new MFInt32163().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {8.197f ,28.37f ,-1.528f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32166().getArray()).setCoordIndex(new MFInt32167().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {8.334f ,27.5f ,-1.701f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32170().getArray()).setCoordIndex(new MFInt32171().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {8.338f ,26.78f ,-1.768f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32174().getArray()).setCoordIndex(new MFInt32175().getArray())
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {8.153f ,26.04f ,-1.886f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32178().getArray()).setCoordIndex(new MFInt32179().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-1.71f ,52.82f ,-0.6127f })
                            ...
                            .addChild(new Transform().setTranslation(new float[] {-1.71f ,52.82f ,-0.6127f })
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32182().getArray()).setCoordIndex(new MFInt32183().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_acromioclavicular").setDEF("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-5.464f ,52.06f ,-0.5732f })
                              ...
                              .addChild(new Transform().setTranslation(new float[] {-5.464f ,52.06f ,-0.5732f })
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                    .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32186().getArray()).setCoordIndex(new MFInt32187().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_sternoclavicular").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-7.336f ,51.48f ,-0.1452f })
                                ...
                                .addChild(new Transform().setTranslation(new float[] {-7.336f ,51.48f ,-0.1452f })
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                      .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32190().getArray()).setCoordIndex(new MFInt32191().getArray())
                                  ...
                                  .addChild(new Transform().setTranslation(new float[] {-8.093f ,40.38f ,-0.2502f })
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                        .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32194().getArray()).setCoordIndex(new MFInt32195().getArray())
                                    ...
                                    .addChild(new Transform().setTranslation(new float[] {-7.899f ,31.43f ,-0.3809f })
                                      .addChild(new Shape()
                                        .setAppearance(new Appearance()
                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                          .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32198().getArray()).setCoordIndex(new MFInt32199().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {-8.205f ,29.6f ,1.302f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32202().getArray()).setCoordIndex(new MFInt32203().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {-8.08f ,28.73f ,1.55f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32206().getArray()).setCoordIndex(new MFInt32207().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {-7.832f ,27.85f ,1.735f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32210().getArray()).setCoordIndex(new MFInt32211().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {-8.376f ,28.55f ,0.5997f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32214().getArray()).setCoordIndex(new MFInt32215().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {-8.52f ,27.24f ,0.6551f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32218().getArray()).setCoordIndex(new MFInt32219().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {-8.45f ,26.1f ,0.6956f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32222().getArray()).setCoordIndex(new MFInt32223().getArray())
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {-8.192f ,25.17f ,0.7315f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32226().getArray()).setCoordIndex(new MFInt32227().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {-8.344f ,28.65f ,-0.194f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32230().getArray()).setCoordIndex(new MFInt32231().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {-8.52f ,27.26f ,-0.1959f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32234().getArray()).setCoordIndex(new MFInt32235().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {-8.477f ,26.07f ,-0.2214f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32238().getArray()).setCoordIndex(new MFInt32239().getArray())
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {-8.25f ,25.03f ,-0.2187f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32242().getArray()).setCoordIndex(new MFInt32243().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {-8.339f ,28.57f ,-0.9243f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32246().getArray()).setCoordIndex(new MFInt32247().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {-8.428f ,27.3f ,-0.9985f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32250().getArray()).setCoordIndex(new MFInt32251().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {-8.428f ,26.29f ,-1.034f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32254().getArray()).setCoordIndex(new MFInt32255().getArray())
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {-8.192f ,25.31f ,-1.124f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32258().getArray()).setCoordIndex(new MFInt32259().getArray())
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {-8.197f ,28.37f ,-1.528f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32262().getArray()).setCoordIndex(new MFInt32263().getArray())
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {-8.334f ,27.5f ,-1.701f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32266().getArray()).setCoordIndex(new MFInt32267().getArray())
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {-8.338f ,26.78f ,-1.768f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32270().getArray()).setCoordIndex(new MFInt32271().getArray())
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {-8.153f ,26.04f ,-1.886f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32274().getArray()).setCoordIndex(new MFInt32275().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_vc4").setName("vc4").setCenter(new float[] {0f ,54.42f ,-0.6695f })
                          .addChild(new HAnimSegment("hanim_vc4").setDEF("hanim_c4").setName("c4")
                            .addChild(new Transform().setTranslation(new float[] {0f ,54.42f ,-0.6695f })
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32278().getArray()).setCoordIndex(new MFInt32279().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_vc4").setDEF("hanim_vc2").setName("vc2").setCenter(new float[] {0f ,56.02f ,-0.6695f })
                              ...
                              .addChild(new Transform().setTranslation(new float[] {0f ,56.02f ,-0.6695f })
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                    .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32282().getArray()).setCoordIndex(new MFInt32283().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_vc2").setDEF("hanim_skullbase").setName("skullbase").setCenter(new float[] {0f ,57.43f ,-0.6863f })
                                ...
                                .addChild(new Transform().setTranslation(new float[] {0f ,57.43f ,-0.6863f })
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                      .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32286().getArray().append(new MFInt32287().getArray()).append(new MFInt32288().getArray())).setCoordIndex(new MFInt32289().getArray().append(new MFInt32290().getArray()).append(new MFInt32291().getArray()))
                                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f292().getArray()))
                                      .setCoord(new Coordinate().setPoint(new MFVec3f293().getArray().append(new MFVec3f294().getArray())))))))))))))))))

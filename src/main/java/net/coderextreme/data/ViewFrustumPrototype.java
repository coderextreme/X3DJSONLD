        ...
        .addChild(new ProtoDeclare().setName("ViewFrustum").setAppinfo("Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Switch().setDEF("VisibilitySwitch").setWhichChoice(-1)
              .addChild(new Transform("VisibilitySwitch").setDEF("PositionTransform").setRotation(new float[] {0f,1f,0f,3.14159f})
                .addChild(new Transform("PositionTransform").setDEF("OrientationTransform")
                  .addChild(new Shape("OrientationTransform")
                    .setGeometry(new IndexedLineSet().setDEF("FrustumLines").setCoordIndex(new MFInt320().getArray())
                      .setCoord(new Coordinate("FrustumLines").setDEF("FrustumCoordinate").setPoint(new MFVec3f1().getArray())))
                  ...
                  .addChild(new Shape("OrientationTransform")
                    ...
                    .setAppearance(new Appearance().setDEF("FrustumAppearance")
                      .setMaterial(new Material("FrustumAppearance")
                        .setIS(new IS()
            ...
            .addChild(new Script().setDEF("GeometryComputationScript").setDirectOutput(true).setUrl(new MFString2().getArray())
              .addField(new field("GeometryComputationScript").setType("SFBool").setName("visible").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Whether or not frustum geometry is rendered"))
              .addField(new field("GeometryComputationScript").setType("SFInt32").setName("visibilitySwitchSelection").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setAppinfo("Adjust Switch selection to make geometry visible or not"))
              .addField(new field("GeometryComputationScript").setType("SFNode").setName("ViewpointNode").setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
                .addComments("initialization node (if any) goes here"))
              .addField(new field("GeometryComputationScript").setType("SFNode").setName("NavigationInfoNode").setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
                .addComments("initialization node (if any) goes here"))
              .addField(new field("GeometryComputationScript").setType("SFNode").setName("FrustumCoordinate").setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
                .addChild(new Coordinate().setUSE("FrustumCoordinate")))
              .addField(new field("GeometryComputationScript").setType("SFNode").setName("FrustumExtrusion").setAccessType(field.ACCESSTYPE_INITIALIZEONLY)
                .addChild(new Extrusion().setUSE("FrustumExtrusion")))
              .addField(new field("GeometryComputationScript").setType("SFBool").setName("recompute").setAccessType(field.ACCESSTYPE_INPUTONLY))
              .addField(new field("GeometryComputationScript").setType("SFFloat").setName("aspectRatio").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("assumed ratio height/width"))
              .addField(new field("GeometryComputationScript").setType("SFVec3f").setName("position_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .addField(new field("GeometryComputationScript").setType("SFRotation").setName("orientation_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .addField(new field("GeometryComputationScript").setType("MFVec3f").setName("spine_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .addField(new field("GeometryComputationScript").setType("MFVec2f").setName("scale_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .addField(new field("GeometryComputationScript").setType("MFVec3f").setName("point_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY))
              .addField(new field("GeometryComputationScript").setType("SFBool").setName("trace").setAccessType(field.ACCESSTYPE_INITIALIZEONLY))
              .setIS(new IS("GeometryComputationScript")

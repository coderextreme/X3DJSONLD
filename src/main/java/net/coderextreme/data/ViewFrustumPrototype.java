      ...
      .setScene(new Scene()
        ...
        .addChild(new ProtoDeclare().setName("ViewFrustum").setAppinfo("Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes")
          ...
          .setProtoBody(new ProtoBody()
            ...
            .addChild(new Script().setDEF("GeometryComputationScript").setDirectOutput(true).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray()))
        ...
        .addChild(new Anchor().setDescription("ViewFrustum Example").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray()))
          .addChild(new Shape()
            .setAppearance(new Appearance()

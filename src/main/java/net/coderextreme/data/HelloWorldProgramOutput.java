...
ProtoInstanceObject ProtoInstance6 = null;
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setContent("HelloWorldProgramOutput.x3d").setName("title"))
        .addMeta(new metaObject().setContent("continued development and testing in progress").setName("info"))
        .addMeta(new metaObject().setContent("Example HelloWorldProgram creates an X3D model using the X3D Java Scene Access Interface Library (X3DJSAIL)").setName("description"))
        .addMeta(new metaObject().setContent("https://www.web3d.org/specifications/java/X3DJSAIL.html").setName("reference"))
        .addMeta(new metaObject().setContent("HelloWorldProgramOutput.java").setName("generator"))
        .addMeta(new metaObject().setContent("6 September 2016").setName("created"))
        .addMeta(new metaObject().setContent("4 April 2020").setName("modified"))
        .addMeta(new metaObject().setContent("X3D Java Scene Access Interface Library (X3DJSAIL)").setName("generator"))
        .addMeta(new metaObject().setContent("https://www.web3d.org/specifications/java/examples/HelloWorldProgram.java").setName("generator"))
        .addMeta(new metaObject().setContent("Netbeans http://www.netbeans.org").setName("generator"))
        .addMeta(new metaObject().setContent("Don Brutzman").setName("creator"))
        .addMeta(new metaObject().setContent("https://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/java/examples/HelloWorldProgramOutput.x3d").setName("reference"))
        .addMeta(new metaObject().setContent("Console output, ClassicVRML encoding, VRML97 encoding and pretty-print documentation:").setName("reference"))
        .addMeta(new metaObject().setContent("HelloWorldProgramOutput.txt").setName("reference"))
        .addMeta(new metaObject().setContent("HelloWorldProgramOutput.x3dv").setName("reference"))
        .addMeta(new metaObject().setContent("HelloWorldProgramOutput.wrl").setName("reference"))
        .addMeta(new metaObject().setContent("HelloWorldProgramOutput.html").setName("reference"))
        .addMeta(new metaObject().setContent("https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d").setName("reference"))
        .addMeta(new metaObject().setContent("https://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d").setName("identifier"))
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new NavigationInfoObject().setType(new java.lang.String[] {"EXAMINE","FLY","ANY"}).setAvatarSize(new MFFloatObject(new MFFloat0().getArray())).setTransitionType(new MFStringObject(new MFString1().getArray())))
        ...
        .addChild(new TransformObject().setDEF("LogoGeometryTransform").setTranslation(new float[] {0f,1.5f,0f})
          .addChild(new AnchorObject().setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(new MFStringObject(new MFString2().getArray()))
        ...
        .addChild(new PositionInterpolatorObject().setDEF("BoxPathAnimator").setKey(new MFFloatObject(new MFFloat6().getArray())).setKeyValue(new MFVec3fObject(new MFVec3f7().getArray())))
          ...
          .addChild(new ShapeObject()
            ...
            .setGeometry(new TextObject().setString(new MFStringObject(new MFString8().getArray()))
              ...
              .setMetadata(new MetadataSetObject().setName("EscapedQuotationMarksMetadataSet")
                .addValue(new MetadataStringObject().setName("quotesTestC").setValue(new MFStringObject(new MFString9().getArray())))
                .addValue(new MetadataStringObject().setName("extraChildTest").setValue(new MFStringObject(new MFString10().getArray()))))
              .setFontStyle(new FontStyleObject().setFamily(new MFStringObject(new MFString11().getArray())).setJustify(new MFStringObject(new MFString12().getArray())))))
        ...
        .addChild(new OrientationInterpolatorObject().setDEF("SpinInterpolator").setKey(new MFFloatObject(new MFFloat14().getArray())).setKeyValue(new MFRotationObject(new MFRotation15().getArray())))
...
"}"))
          .addChild(new ColorInterpolatorObject().setDEF("ColorAnimator").setKey(new MFFloatObject(new MFFloat16().getArray())).setKeyValue(new MFColorObject(new MFColor17().getArray()))
        ...
        .addChild(new ExternProtoDeclareObject().setName("ArtDeco02Material").setAppinfo("this is a different Material node").setUrl(new MFStringObject(new MFString18().getArray()))
        ...
        .addChild(new ShapeObject().setDEF("TestShape2")
          .setAppearance(new AppearanceObject().setDEF("TestAppearance2")
            ...
            .setMaterial(ProtoInstance1 = new ProtoInstanceObject().setDEF("ArtDeco02MaterialDEF").setName("ArtDeco02Material")
        ...
        .addChild(new InlineObject().setDEF("inlineSceneDef").setUrl(new MFStringObject(new MFString19().getArray())))
...
"}"))))
        ...
        .addChild(new GroupObject().setDEF("DeclarativeGroupExample")
          .addChild(new ShapeObject()
            .setMetadata(new MetadataStringObject().setDEF("FindableMetadataStringTest").setName("findThisNameValue").setValue(new MFStringObject(new MFString20().getArray())))
            .setAppearance(new AppearanceObject().setDEF("DeclarativeAppearanceExample")
              ...
              .setMaterial(ProtoInstance3 = new ProtoInstanceObject().setDEF("MyMaterialModulator").setName("MaterialModulator")))
        ...
        .addChild(new SoundObject().setLocation(new float[] {0f,1.6f,0f})
          ...
          .setSource(new AudioClipObject().setDescription("chimes").setUrl(new MFStringObject(new MFString21().getArray()))
        ...
        .addChild(new SoundObject().setLocation(new float[] {0f,1.6f,0f})
          .addComments(new CommentsBlock(" set sound-ellipsoid location height at 1.6m to match typical avatar height "))
          .setSource(new MovieTextureObject().setDescription("mpgsys.mpg from ConformanceNist suite").setUrl(new MFStringObject(new MFString22().getArray()))
        ...
        .addChild(new GroupObject()
          ...
          .addChild(ProtoInstance4 = new ProtoInstanceObject().setDEF("Proto1").setName("NewWorldInfo"))
          .addChild(new GroupObject().setDEF("Node2")
            .addComments(new CommentsBlock(" intentionally empty ")))
          .addChild(ProtoInstance5 = new ProtoInstanceObject().setDEF("Proto3").setName("NewWorldInfo"))
        ...
        .addChild(new ShapeObject()
          .setAppearance(new AppearanceObject()
            ...
            .addShaders(new ProgramShaderObject().setDEF("TestShader1")
              .setPrograms(new ShaderProgramObject().setDEF("TestShader2")))
            .addShaders(ProtoInstance6 = new ProtoInstanceObject().setDEF("TestShader3").setName("ShaderProto"))
            .addShaders(new ComposedShaderObject().setDEF("TestShader4")
              .setParts(new ShaderPartObject().setDEF("TestShader5")))))
        .addChild(new TransformObject().setDEF("SpecialtyNodes")
          ...
          .addChild(new EspduTransformObject().setGeoSystem(new MFStringObject(new MFString23().getArray())))
          .addChild(new ReceiverPduObject().setGeoSystem(new MFStringObject(new MFString24().getArray())))
          .addChild(new SignalPduObject().setGeoSystem(new MFStringObject(new MFString25().getArray())))
          .addChild(new TransmitterPduObject().setGeoSystem(new MFStringObject(new MFString26().getArray())))
          .addChild(new DISEntityManagerObject()
            .setMapping(new DISEntityTypeMappingObject())))
        .addMetadata(new MetadataStringObject().setDEF("scene.addChildMetadata").setName("test").setValue(new MFStringObject(new MFString27().getArray())))
        .addLayerSet(new LayerSetObject().setDEF("scene.addChildLayerSetTest").setOrder(new MFInt32Object(new MFInt3228().getArray()))))      ;
ProtoInstance0
...
protected class MFFloat0 {
  protected MFFloatObject getArray() {
    return new MFFloatObject(new float[] {0.25f,1.6f,0.75f});
  }
}
protected class MFString1 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"LINEAR"});
  }
}
...
protected class MFString23 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"GD","WE"});
  }
}
...
protected class MFInt3228 {
  protected MFInt32Object getArray() {
    return new MFInt32Object(new int[] {0});
  }
}
}

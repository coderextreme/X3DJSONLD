...
"}"))))
        ...
        .addChild(new GroupObject()
          ...
          .addChild(ProtoInstance4 = new ProtoInstanceObject().setName("NewWorldInfo").setDEF("Proto1"))
          .addChild(new GroupObject().setDEF("Node2")
            .addComments(new CommentsBlock("intentionally empty")))
          .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("NewWorldInfo").setDEF("Proto3"))

...
public class HelloWorldProgramOutput {
  public static void main(String[] args) {
    ...
    X3D model = new HelloWorldProgramOutput().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/HelloWorldProgramOutput.new.json");
    }
...
ProtoInstance ProtoInstance6 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("30 July 2023"))
          ...
          .addChild(new Shape()
            ...
            .setGeometry(new Text().setString(new MFString7().getArray())
              ...
              .setMetadata(new MetadataSet().setName("EscapedQuotationMarksMetadataSet")
                .setMetadata(new MetadataString().setName("quotesTestC").setValue(new MFString8().getArray()))
                .setMetadata(new MetadataString().setName("extraChildTest").setValue(new MFString9().getArray())))

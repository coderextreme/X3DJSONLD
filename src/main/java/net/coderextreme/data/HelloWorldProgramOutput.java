...
ProtoInstance ProtoInstance6 = null;
      ...
      .addComments(new CommentsBlock("x3dVersionComparisonTest for this model: supportsX3dVersion(X3D.VERSION_3_0)=true"))
      .setHead(new head()
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Group().setDEF("Node2").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Transform().setDEF("Node4").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addComments(new CommentsBlock("intentionally empty")))
        ...
        .addChild(new Transform().setDEF("SpecialtyNodes").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new CADLayer()
            .addChild(new CADAssembly()
              .addChild(new CADPart()
                .addChild(new CADFace()))))
          .addChild(new EspduTransform().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
          .addChild(new ReceiverPdu().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
          .addChild(new SignalPdu().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))
          .addChild(new TransmitterPdu().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))

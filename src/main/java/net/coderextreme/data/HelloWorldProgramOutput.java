...
ProtoInstance ProtoInstance6 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("20 December 2020"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("LogoGeometryTransform").setTranslation(new float[] {0f,1.5f,0f})
          .addChild(new Anchor().setDEF("siteAnchor").setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray()))
...
"}"))
        ...
        .addChild(new Inline().setDEF("inlineScene").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString17().getArray())))

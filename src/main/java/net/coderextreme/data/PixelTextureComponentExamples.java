  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setContent("PixelTextureComponentExamples.x3d").setName("title"))
        .addMeta(new metaObject().setContent("This example shows the five PixelTexture components, with 0 to 4 components each, shown in Table 5-18.").setName("description"))
        .addMeta(new metaObject().setContent("Leonard Daly and Don Brutzman").setName("creator"))
        .addMeta(new metaObject().setContent("25 August 2008").setName("created"))
        .addMeta(new metaObject().setContent("7 January 2014").setName("modified"))
        .addMeta(new metaObject().setContent("http://X3dGraphics.com").setName("reference"))
        .addMeta(new metaObject().setContent("X3D for Web Authors, Table 5.18").setName("reference"))
        .addMeta(new metaObject().setContent("http://www.web3d.org/x3d/content/examples/X3dResources.html").setName("reference"))
        .addMeta(new metaObject().setContent("Copyright (c) 2006, Daly Realism and Don Brutzman").setName("rights"))
        .addMeta(new metaObject().setContent("X3D book, X3D graphics, X3D-Edit, http://www.x3dGraphics.com").setName("subject"))
        .addMeta(new metaObject().setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/PixelTextureComponentExamples.x3d").setName("identifier"))

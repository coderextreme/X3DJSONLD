  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setTranslation(new float[] {-6f,0f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Transform().setTranslation(new float[] {0f,-2f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray()))
                .setFontStyle(new FontStyle().setDEF("CenterJustify").setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray()))))
              .setAppearance(new Appearance().setDEF("TextMaterial")
                .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}))))))
        .addChild(new Transform().setTranslation(new float[] {-3f,0f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setAppearance(new Appearance()
        ...
        .addChild(new Transform().setTranslation(new float[] {0f,6f,-2f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setAppearance(new Appearance()
            ...
            .setGeometry(new Box().setSize(new float[] {16f,16f,0.1f}).setSolid(true)))))      ;
    return X3D0;
    }

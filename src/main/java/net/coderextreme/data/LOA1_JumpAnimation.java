...
public class LOA1_JumpAnimation implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/LOA1_JumpAnimation.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("LOA1_JumpAnimation.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("translator")).setContent(new SFString("Scott Tufts")))
        ...
        .addMeta(new meta().setName(new SFString("subject")).setContent(new SFString("InterchangableActorsViaDynamicRouting Nancy jump Animation HAnim 2001")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/LOA1_JumpAnimation.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("LOA1_JumpAnimation.x3d")))
        .addChild(new ProtoDeclare().setName(new SFString("LOA1_JumpAnimation"))
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new TimeSensor().setDEF(new SFString("TIMER")).setLoop(true)
                .setIS(new IS()
        ...
        .addChild(new Anchor().setDescription(new SFString("see InterchangableActorsViaDynamicRouting scene")).setParameter(new MFString38().getArray()).setUrl(new MFString39().getArray())
          .addChild(new Shape()

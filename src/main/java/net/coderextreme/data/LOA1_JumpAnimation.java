...
public class LOA1_JumpAnimation {
  public static void main(String[] args) {
    ...
    new LOA1_JumpAnimation().initialize().toFileJSON("../data/LOA1_JumpAnimation.new.json");
    }
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Anchor().setDescription("see InterchangableActorsViaDynamicRouting scene").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString38().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString39().getArray()))
          .addChild(new Shape()

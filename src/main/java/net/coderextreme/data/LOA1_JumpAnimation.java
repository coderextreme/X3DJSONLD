  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Anchor().setDescription("see InterchangableActorsViaDynamicRouting scene").setUrl(new MFString38().getArray()).setParameter(new MFString39().getArray())
          .addChild(new Shape()

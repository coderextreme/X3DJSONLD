...
public class flowers {
  public static void main(String[] args) {
    ...
    X3D model = new flowers().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/flowers.new.json");
    }
        ...
        .addChild(new ProtoDeclare().setName("flower")
          .setProtoBody(new ProtoBody()
            .addChild(new Transform().setDEF("animate_transform")
              .addChild(new Shape("animate_transform")
                .setAppearance(new Appearance()
                  ...
                  .setTexture(new ComposedCubeMapTexture().setDEF("texture")
                    .setBackTexture(new ImageTexture("texture").setUrl(new MFString6().getArray()))
                    .setBottomTexture(new ImageTexture("texture").setUrl(new MFString7().getArray()))
                    .setFrontTexture(new ImageTexture("texture").setUrl(new MFString8().getArray()))
                    .setLeftTexture(new ImageTexture("texture").setUrl(new MFString9().getArray()))
                    .setRightTexture(new ImageTexture("texture").setUrl(new MFString10().getArray()))
                    .setTopTexture(new ImageTexture("texture").setUrl(new MFString11().getArray())))
            ...
            .addChild(new Script().setDEF("Animate")
              .addField(new field("Animate").setType("SFVec3f").setName("translation").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0 0 0"))
              .addField(new field("Animate").setType("SFVec3f").setName("velocity").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0 0 0"))
              .addField(new field("Animate").setType("SFFloat").setName("set_fraction").setAccessType(field.ACCESSTYPE_INPUTONLY))
              .addField(new field("Animate").setType("SFFloat").setName("a").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.5"))
              .addField(new field("Animate").setType("SFFloat").setName("b").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.5"))
              .addField(new field("Animate").setType("SFFloat").setName("c").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("3"))
              .addField(new field("Animate").setType("SFFloat").setName("d").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("3"))
              .addField(new field("Animate").setType("SFFloat").setName("tdelta").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.5"))
              .addField(new field("Animate").setType("SFFloat").setName("pdelta").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue("0.5"))

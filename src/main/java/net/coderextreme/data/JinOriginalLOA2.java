...
public class JinOriginalLOA2 implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new JinOriginalLOA2().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/JinOriginalLOA2.new.java.x3d");
    model.toFileJSON("../data/JinOriginalLOA2.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("title").setContent("JinOriginalLOA2.x3d"))
        ...
        .addMeta(new meta().setName("reference").setContent("JinLOA2.x3d"))
        ...
        .addMeta(new meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA2.x3d"))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle("JinOriginalLOA2.x3d"))
              ...
              .addChild(new Transform().setTranslation(new float[] {0f ,35.8f ,-0.7076f })
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("JinLOA2TextureAtlas").setUrl(new MFString2().getArray())))
                          ...
                          .addChild(new Transform().setTranslation(new float[] {0f ,49.62f ,-0.6117f })
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3279().getArray().append(new MFInt3280().getArray())).setCoordIndex(new MFInt3281().getArray().append(new MFInt3282().getArray()))
                                .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f83().getArray()))
                            ...
                            .addChild(new Transform().setTranslation(new float[] {1.71f ,52.82f ,-0.6127f })
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3285().getArray()).setCoordIndex(new MFInt3286().getArray())
                                  .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f87().getArray()))
                                ...
                                .addChild(new Transform().setTranslation(new float[] {7.336f ,51.48f ,-0.1452f })
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                      .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3293().getArray()).setCoordIndex(new MFInt3294().getArray())
                                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f95().getArray()))
                                  ...
                                  .addChild(new Transform().setTranslation(new float[] {8.093f ,40.38f ,-0.2502f })
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                        .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt3297().getArray()).setCoordIndex(new MFInt3298().getArray())
                                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f99().getArray()))
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {8.205f ,29.6f ,1.302f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32105().getArray()).setCoordIndex(new MFInt32106().getArray())
                                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f107().getArray()))
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {8.08f ,28.73f ,1.55f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32109().getArray()).setCoordIndex(new MFInt32110().getArray())
                                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f111().getArray()))
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {8.376f ,28.55f ,0.5997f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32117().getArray()).setCoordIndex(new MFInt32118().getArray())
                                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f119().getArray()))
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {8.52f ,27.24f ,0.6551f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32121().getArray()).setCoordIndex(new MFInt32122().getArray())
                                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f123().getArray()))
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {8.192f ,25.17f ,0.7315f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32129().getArray()).setCoordIndex(new MFInt32130().getArray())
                                                  .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f131().getArray()))
                                      ...
                                      .addChild(new Transform().setTranslation(new float[] {8.344f ,28.65f ,-0.194f })
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                            .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32133().getArray()).setCoordIndex(new MFInt32134().getArray())
                                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f135().getArray()))
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {8.477f ,26.07f ,-0.2214f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32141().getArray()).setCoordIndex(new MFInt32142().getArray())
                                                .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f143().getArray()))
                                            ...
                                            .addChild(new Transform().setTranslation(new float[] {8.25f ,25.03f ,-0.2187f })
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32145().getArray()).setCoordIndex(new MFInt32146().getArray())
                                                  .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f147().getArray()))
                                        ...
                                        .addChild(new Transform().setTranslation(new float[] {8.428f ,27.3f ,-0.9985f })
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                              .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32153().getArray()).setCoordIndex(new MFInt32154().getArray())
                                              .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f155().getArray()))
                                          ...
                                          .addChild(new Transform().setTranslation(new float[] {8.428f ,26.29f ,-1.034f })
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                                .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32157().getArray()).setCoordIndex(new MFInt32158().getArray())
                                                .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f159().getArray()))
                                ...
                                .addChild(new Transform().setTranslation(new float[] {0f ,57.43f ,-0.6863f })
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f ,0.588f ,0.588f }))
                                      .setTexture(new ImageTexture().setUSE("JinLOA2TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f ).setTexCoordIndex(new MFInt32285().getArray().append(new MFInt32286().getArray()).append(new MFInt32287().getArray())).setCoordIndex(new MFInt32288().getArray().append(new MFInt32289().getArray()).append(new MFInt32290().getArray()))
                                      .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f291().getArray()))
                                      .setCoord(new Coordinate().setPoint(new MFVec3f292().getArray().append(new MFVec3f293().getArray())))))))))))))))))

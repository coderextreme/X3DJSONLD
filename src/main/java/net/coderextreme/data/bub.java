...
public class bub {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/bub.new.json");
    }
        ...
        .addChild(new ProtoDeclare().setName("Bubble")
          .setProtoBody(new ProtoBody()
            .addChild(new Transform().setDEF("transform")
              .addChild(new Shape("transform").setDEF("myShape")
                .setAppearance(new Appearance("myShape")
                ...
                .setGeometry(new Sphere("myShape"))))
            .addChild(new Script().setDEF("Bounce")
              ...
              .addField(new field("Bounce").setType("SFTime").setName("set_fraction").setAccessType(field.ACCESSTYPE_INPUTONLY))

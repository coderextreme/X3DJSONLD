...
public class JinLOA49 {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    X3D model = new JinLOA49().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/JinLOA49.new.json");
    }
                                          ...
                                          .addChild(new HAnimJoint().setName("vt3").setDEF("hanim_vt3").setCenter(new float[] {0f,2312.888933333333f,-27.186666666666667f}).setUlimit(new MFFloat439().getArray()).setLlimit(new MFFloat440().getArray())
                                            ...
                                            .addChild(new HAnimJoint().setName("vt2").setDEF("hanim_vt2").setCenter(new float[] {0f,2361.7777333333333f,-27.23111111111111f}).setUlimit(new MFFloat445().getArray()).setLlimit(new MFFloat446().getArray())
                                              ...
                                              .addChild(new HAnimJoint().setName("vt1").setDEF("hanim_vt1").setCenter(new float[] {0f,2408.8889333333336f,-27.186666666666667f}).setUlimit(new MFFloat451().getArray()).setLlimit(new MFFloat452().getArray())
                                                ...
                                                .addChild(new HAnimJoint().setName("l_sternoclavicular").setDEF("hanim_l_sternoclavicular").setCenter(new float[] {76f,2387.5556f,-27.23111111111111f}).setUlimit(new MFFloat553().getArray()).setLlimit(new MFFloat554().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint().setName("l_acromioclavicular").setDEF("hanim_l_acromioclavicular").setCenter(new float[] {242.84444444444446f,2354.222266666667f,-25.47555555555556f}).setUlimit(new MFFloat559().getArray()).setLlimit(new MFFloat560().getArray())
                                                ...
                                                .addChild(new HAnimJoint().setName("r_sternoclavicular").setDEF("hanim_r_sternoclavicular").setCenter(new float[] {-76f,2387.5556f,-27.23111111111111f}).setUlimit(new MFFloat721().getArray()).setLlimit(new MFFloat722().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint().setName("r_acromioclavicular").setDEF("hanim_r_acromioclavicular").setCenter(new float[] {-242.84444444444446f,2354.222266666667f,-25.47555555555556f}).setUlimit(new MFFloat727().getArray()).setLlimit(new MFFloat728().getArray())

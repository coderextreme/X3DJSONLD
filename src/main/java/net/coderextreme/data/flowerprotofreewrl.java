      ...
      .setScene(new Scene()
        ...
        .addChild(new ProtoDeclare().setName("FlowerProto")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("MFString").setName("vertex").setAccessType(field.ACCESSTYPE_INPUTONLY).setValue("\"../shaders/freewrl_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs\""))
            .addField(new field().setType("MFString").setName("fragment").setAccessType(field.ACCESSTYPE_INPUTONLY).setValue("\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"")))
          .setProtoBody(new ProtoBody()
            .addChild(new Transform().setDEF("transform")
              ...
              .addChild(new Script().setDEF("Animate").setDirectOutput(true)
                ...
                .addField(new field().setType("SFFloat").setName("set_fraction").setAccessType(field.ACCESSTYPE_INPUTOUTPUT))

    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Hand_Right").setDEF("hanim_Hand_Right").setLoa(4).setVersion("2.0")
          ...
          .setMetadata(new MetadataSet("hanim_Hand_Right").setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            .setMetadata(new MetadataString().setName("authorName").setValue(new MFString0().getArray())))
          .addSkeleton(new HAnimJoint("hanim_Hand_Right").setName("humanoid_root").setDEF("hanim_humanoid_root").setUlimit(new MFFloat1().getArray()).setLlimit(new MFFloat2().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setDescription("connection joint of hand to leg above").setUlimit(new MFFloat3().getArray()).setLlimit(new MFFloat4().getArray())
              .addChild(new HAnimSegment("hanim_r_radiocarpal").setName("r_carpal").setDEF("hanim_r_carpal")
                .addChild(new Transform("hanim_r_carpal")
                  .addChild(new Shape().setDEF("HAnimJointShape")
                    .setGeometry(new Sphere("HAnimJointShape").setRadius(0.025f))
                    .setAppearance(new Appearance("HAnimJointShape").setDEF("HAnimJointAppearanceBlue")
                      .setMaterial(new Material("HAnimJointAppearanceBlue").setDiffuseColor(new float[] {0f,0f,1f})))))
                .addChild(new Shape("hanim_r_carpal")
                  ...
                  .setGeometry(new IndexedLineSet().setDEF("RCToMC12").setCoordIndex(new MFInt325().getArray())
                    .setCoord(new Coordinate("RCToMC12").setPoint(new MFVec3f6().getArray()))))
                .addChild(new Shape("hanim_r_carpal")
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                  .setGeometry(new IndexedLineSet().setDEF("RCToMC3").setCoordIndex(new MFInt327().getArray())
                    .setCoord(new Coordinate("RCToMC3").setPoint(new MFVec3f8().getArray()))))
                .addChild(new Shape("hanim_r_carpal")
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                  .setGeometry(new IndexedLineSet().setDEF("RCToMC45").setCoordIndex(new MFInt329().getArray())
                    .setCoord(new Coordinate("RCToMC45").setPoint(new MFVec3f10().getArray())))))
              .addComments("MC1")
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_1").setDEF("hanim_r_midcarpal_1").setCenter(new float[] {-0.14f,0.09f,0f}).setUlimit(new MFFloat11().getArray()).setLlimit(new MFFloat12().getArray())
                .addChild(new HAnimSegment("hanim_r_midcarpal_1").setName("r_trapezium").setDEF("hanim_r_trapezium")
                  .addChild(new Transform("hanim_r_trapezium").setTranslation(new float[] {-0.14f,0.09f,0f})
                    .addChild(new Shape().setDEF("HAnimNewJointShape")
                      .setGeometry(new Sphere("HAnimNewJointShape").setRadius(0.025f))
                      .setAppearance(new Appearance("HAnimNewJointShape").setDEF("HAnimJointAppearanceRed")
                        .setMaterial(new Material("HAnimJointAppearanceRed").setDiffuseColor(new float[] {1f,0f,0f})))))
                  .addChild(new Shape("hanim_r_trapezium")
                    ...
                    .setGeometry(new IndexedLineSet().setDEF("MC12toCMC1").setCoordIndex(new MFInt3213().getArray())
                      .setCoord(new Coordinate("MC12toCMC1").setPoint(new MFVec3f14().getArray())))))
                .addComments("thumb finger")
                .addChild(new HAnimJoint("hanim_r_midcarpal_1").setName("r_carpometacarpal_1").setDEF("hanim_r_carpometacarpal_1").setCenter(new float[] {-0.2f,0.15f,0f}).setUlimit(new MFFloat15().getArray()).setLlimit(new MFFloat16().getArray())
                  .addChild(new HAnimSegment("hanim_r_carpometacarpal_1").setName("r_metacarpal_1").setDEF("hanim_r_metacarpal_1")
                    .addChild(new Transform("hanim_r_metacarpal_1").setTranslation(new float[] {-0.2f,0.15f,0f})
                    ...
                    .addChild(new Shape("hanim_r_metacarpal_1")
                      ...
                      .setGeometry(new IndexedLineSet().setDEF("CMC1toMCP1xxx").setCoordIndex(new MFInt3217().getArray())
                        .setCoord(new Coordinate("CMC1toMCP1xxx").setPoint(new MFVec3f18().getArray())))))
                  .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setName("r_metacarpophalangeal_1").setDEF("hanim_r_metacarpophalangeal_1").setCenter(new float[] {-0.3f,0.3f,0f}).setUlimit(new MFFloat19().getArray()).setLlimit(new MFFloat20().getArray())
                    .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_1").setName("r_carpal_proximal_phalanx_1").setDEF("hanim_r_carpal_proximal_phalanx_1")
                      .addChild(new Transform("hanim_r_carpal_proximal_phalanx_1").setTranslation(new float[] {-0.3f,0.3f,0f})
                        .addChild(new Shape().setUSE("HAnimJointShape")))
                      .addChild(new Shape("hanim_r_carpal_proximal_phalanx_1")
                        ...
                        .setGeometry(new IndexedLineSet().setDEF("MCP11toIP1").setCoordIndex(new MFInt3221().getArray())
                          .setCoord(new Coordinate("MCP11toIP1").setPoint(new MFVec3f22().getArray())))))
                    .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setName("r_carpal_interphalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setCenter(new float[] {-0.35f,0.4f,0f}).setUlimit(new MFFloat23().getArray()).setLlimit(new MFFloat24().getArray())
                      .addChild(new HAnimSegment("hanim_r_carpal_interphalangeal_1").setName("r_carpal_distal_phalanx_1").setDEF("hanim_r_carpal_distal_phalanx_1")
                        .addChild(new Transform("hanim_r_carpal_distal_phalanx_1").setTranslation(new float[] {-0.35f,0.4f,0f})
                          .addChild(new Shape().setUSE("HAnimJointShape")))
                        .addChild(new Shape("hanim_r_carpal_distal_phalanx_1")
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                          .setGeometry(new IndexedLineSet().setDEF("fingertip_r_carpal_interphalangeal_1").setCoordIndex(new MFInt3225().getArray())
                            .setCoord(new Coordinate("fingertip_r_carpal_interphalangeal_1").setPoint(new MFVec3f26().getArray())))))))))
              .addComments("MC2")
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_2").setDEF("hanim_r_midcarpal_2").setCenter(new float[] {-0.07f,0.07f,0f}).setUlimit(new MFFloat27().getArray()).setLlimit(new MFFloat28().getArray())
                .addChild(new HAnimSegment("hanim_r_midcarpal_2").setName("r_trapezoid").setDEF("hanim_r_trapezoid")
                  .addChild(new Transform("hanim_r_trapezoid").setTranslation(new float[] {-0.07f,0.07f,0f})
                  ...
                  .addChild(new Shape("hanim_r_trapezoid")
                    ...
                    .setGeometry(new IndexedLineSet().setDEF("MC12toCMC2").setCoordIndex(new MFInt3229().getArray())
                      .setCoord(new Coordinate("MC12toCMC2").setPoint(new MFVec3f30().getArray())))))
                .addComments("index finger")
                .addChild(new HAnimJoint("hanim_r_midcarpal_2").setName("r_carpometacarpal_2").setDEF("hanim_r_carpometacarpal_2").setCenter(new float[] {-0.1f,0.2f,0f}).setUlimit(new MFFloat31().getArray()).setLlimit(new MFFloat32().getArray())
                  .addChild(new HAnimSegment("hanim_r_carpometacarpal_2").setName("r_metacarpal_2").setDEF("hanim_r_metacarpal_2")
                    .addChild(new Transform("hanim_r_metacarpal_2").setTranslation(new float[] {-0.1f,0.2f,0f})
                      .addChild(new Shape().setUSE("HAnimJointShape")))
                    .addChild(new Shape("hanim_r_metacarpal_2")
                      ...
                      .setGeometry(new IndexedLineSet().setDEF("CMC2toMCP2").setCoordIndex(new MFInt3233().getArray())
                        .setCoord(new Coordinate("CMC2toMCP2").setPoint(new MFVec3f34().getArray())))))
                  .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setName("r_metacarpophalangeal_2").setDEF("hanim_r_metacarpophalangeal_2").setCenter(new float[] {-0.15f,0.5f,0f}).setUlimit(new MFFloat35().getArray()).setLlimit(new MFFloat36().getArray())
                    .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_2").setName("r_carpal_proximal_phalanx_2").setDEF("hanim_r_carpal_proximal_phalanx_2")
                      .addChild(new Transform("hanim_r_carpal_proximal_phalanx_2").setTranslation(new float[] {-0.15f,0.5f,0f})
                        .addChild(new Shape().setUSE("HAnimJointShape")))
                      .addChild(new Shape("hanim_r_carpal_proximal_phalanx_2")
                        ...
                        .setGeometry(new IndexedLineSet().setDEF("MCP2toPIP2").setCoordIndex(new MFInt3237().getArray())
                          .setCoord(new Coordinate("MCP2toPIP2").setPoint(new MFVec3f38().getArray())))))
                    .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-0.2f,0.7f,0f}).setUlimit(new MFFloat39().getArray()).setLlimit(new MFFloat40().getArray())
                      .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_middle_phalanx_2").setDEF("hanim_r_carpal_middle_phalanx_2")
                        .addChild(new Transform("hanim_r_carpal_middle_phalanx_2").setTranslation(new float[] {-0.2f,0.7f,0f})
                          .addChild(new Shape().setUSE("HAnimJointShape")))
                        .addChild(new Shape("hanim_r_carpal_middle_phalanx_2")
                          ...
                          .setGeometry(new IndexedLineSet().setDEF("PIP2toDIP2").setCoordIndex(new MFInt3241().getArray())
                            .setCoord(new Coordinate("PIP2toDIP2").setPoint(new MFVec3f42().getArray())))))
                      .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setCenter(new float[] {-0.24f,0.87f,0f}).setUlimit(new MFFloat43().getArray()).setLlimit(new MFFloat44().getArray())
                        .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_phalanx_2").setDEF("hanim_r_carpal_distal_phalanx_2")
                          .addChild(new Transform("hanim_r_carpal_distal_phalanx_2").setTranslation(new float[] {-0.24f,0.87f,0f})
                            .addChild(new Shape().setUSE("HAnimJointShape")))
                          .addChild(new Shape("hanim_r_carpal_distal_phalanx_2")
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_carpal_distal_interphalangeal_2").setCoordIndex(new MFInt3245().getArray())
                              .setCoord(new Coordinate("fingertip_r_carpal_distal_interphalangeal_2").setPoint(new MFVec3f46().getArray()))))))))))
              .addComments("MC3")
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_3").setDEF("hanim_r_midcarpal_3").setCenter(new float[] {0f,0.07f,0f}).setUlimit(new MFFloat47().getArray()).setLlimit(new MFFloat48().getArray())
                .addChild(new HAnimSegment("hanim_r_midcarpal_3").setName("r_capitate").setDEF("hanim_r_capitate")
                  .addChild(new Transform("hanim_r_capitate").setTranslation(new float[] {0f,0.07f,0f})
                    .addChild(new Shape().setUSE("HAnimNewJointShape")))
                  .addChild(new Shape("hanim_r_capitate")
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                    .setGeometry(new IndexedLineSet().setDEF("MC3toCMC3").setCoordIndex(new MFInt3249().getArray())
                      .setCoord(new Coordinate("MC3toCMC3").setPoint(new MFVec3f50().getArray())))))
                .addComments("Middle fingle")
                .addChild(new HAnimJoint("hanim_r_midcarpal_3").setName("r_carpometacarpal_3").setDEF("hanim_r_carpometacarpal_3").setCenter(new float[] {0f,0.2f,0f}).setUlimit(new MFFloat51().getArray()).setLlimit(new MFFloat52().getArray())
                  .addChild(new HAnimSegment("hanim_r_carpometacarpal_3").setName("r_metacarpal_3").setDEF("hanim_r_metacarpal_3")
                    .addChild(new Transform("hanim_r_metacarpal_3").setTranslation(new float[] {0f,0.2f,0f})
                      .addChild(new Shape().setUSE("HAnimJointShape")))
                    .addChild(new Shape("hanim_r_metacarpal_3")
                      ...
                      .setGeometry(new IndexedLineSet().setDEF("CMC3toMCP3").setCoordIndex(new MFInt3253().getArray())
                        .setCoord(new Coordinate("CMC3toMCP3").setPoint(new MFVec3f54().getArray())))))
                  .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setName("r_metacarpophalangeal_3").setDEF("hanim_r_metacarpophalangeal_3").setCenter(new float[] {-0.03f,0.5f,0f}).setUlimit(new MFFloat55().getArray()).setLlimit(new MFFloat56().getArray())
                    .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_3").setName("r_carpal_proximal_phalanx_3").setDEF("hanim_r_carpal_proximal_phalanx_3")
                      .addChild(new Transform("hanim_r_carpal_proximal_phalanx_3").setTranslation(new float[] {-0.03f,0.5f,0f})
                        .addChild(new Shape().setUSE("HAnimJointShape")))
                      .addChild(new Shape("hanim_r_carpal_proximal_phalanx_3")
                        ...
                        .setGeometry(new IndexedLineSet().setDEF("MCP3toPIP3").setCoordIndex(new MFInt3257().getArray())
                          .setCoord(new Coordinate("MCP3toPIP3").setPoint(new MFVec3f58().getArray())))))
                    .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-0.05f,0.75f,0f}).setUlimit(new MFFloat59().getArray()).setLlimit(new MFFloat60().getArray())
                      .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_middle_phalanx_3").setDEF("hanim_r_carpal_middle_phalanx_3")
                        .addChild(new Transform("hanim_r_carpal_middle_phalanx_3").setTranslation(new float[] {-0.05f,0.75f,0f})
                          .addChild(new Shape().setUSE("HAnimJointShape")))
                        .addChild(new Shape("hanim_r_carpal_middle_phalanx_3")
                          ...
                          .setGeometry(new IndexedLineSet().setDEF("PIP3toDIP3").setCoordIndex(new MFInt3261().getArray())
                            .setCoord(new Coordinate("PIP3toDIP3").setPoint(new MFVec3f62().getArray())))))
                      .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setCenter(new float[] {-0.08f,0.96f,0f}).setUlimit(new MFFloat63().getArray()).setLlimit(new MFFloat64().getArray())
                        .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_phalanx_3").setDEF("hanim_r_carpal_distal_phalanx_3")
                          .addChild(new Transform("hanim_r_carpal_distal_phalanx_3").setTranslation(new float[] {-0.08f,0.96f,0f})
                            .addChild(new Shape().setUSE("HAnimJointShape")))
                          .addChild(new Shape("hanim_r_carpal_distal_phalanx_3")
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_carpal_distal_interphalangeal_3").setCoordIndex(new MFInt3265().getArray())
                              .setCoord(new Coordinate("fingertip_r_carpal_distal_interphalangeal_3").setPoint(new MFVec3f66().getArray()))))))))))
              .addComments("MC4_5")
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_4_5").setDEF("hanim_r_midcarpal_4_5").setCenter(new float[] {0.1f,0.1f,0f}).setUlimit(new MFFloat67().getArray()).setLlimit(new MFFloat68().getArray())
                .addChild(new HAnimSegment("hanim_r_midcarpal_4_5").setName("r_hamate").setDEF("hanim_r_hamate")
                  .addChild(new Transform("hanim_r_hamate").setTranslation(new float[] {0.1f,0.1f,0f})
                    .addChild(new Shape().setUSE("HAnimNewJointShape")))
                  .addChild(new Shape("hanim_r_hamate")
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                    .setGeometry(new IndexedLineSet().setDEF("MC45toCMC4").setCoordIndex(new MFInt3269().getArray())
                      .setCoord(new Coordinate("MC45toCMC4").setPoint(new MFVec3f70().getArray()))))
                  .addChild(new Shape("hanim_r_hamate")
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                    .setGeometry(new IndexedLineSet().setDEF("MC45toCMC5").setCoordIndex(new MFInt3271().getArray())
                      .setCoord(new Coordinate("MC45toCMC5").setPoint(new MFVec3f72().getArray())))))
                .addComments("ring finger")
                .addChild(new HAnimJoint("hanim_r_midcarpal_4_5").setName("r_carpometacarpal_4").setDEF("hanim_r_carpometacarpal_4").setCenter(new float[] {0.1f,0.2f,0f}).setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                  .addChild(new HAnimSegment("hanim_r_carpometacarpal_4").setName("r_metacarpal_4").setDEF("hanim_r_metacarpal_4")
                    .addChild(new Transform("hanim_r_metacarpal_4").setTranslation(new float[] {0.1f,0.2f,0f})
                      .addChild(new Shape().setUSE("HAnimJointShape")))
                    .addChild(new Shape("hanim_r_metacarpal_4")
                      ...
                      .setGeometry(new IndexedLineSet().setDEF("CMC4toMCP4").setCoordIndex(new MFInt3275().getArray())
                        .setCoord(new Coordinate("CMC4toMCP4").setPoint(new MFVec3f76().getArray())))))
                  .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setName("r_metacarpophalangeal_4").setDEF("hanim_r_metacarpophalangeal_4").setCenter(new float[] {0.1f,0.47f,0f}).setUlimit(new MFFloat77().getArray()).setLlimit(new MFFloat78().getArray())
                    .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_4").setName("r_carpal_proximal_phalanx_4").setDEF("hanim_r_carpal_proximal_phalanx_4")
                      .addChild(new Transform("hanim_r_carpal_proximal_phalanx_4").setTranslation(new float[] {0.1f,0.47f,0f})
                        .addChild(new Shape().setUSE("HAnimJointShape")))
                      .addChild(new Shape("hanim_r_carpal_proximal_phalanx_4")
                        ...
                        .setGeometry(new IndexedLineSet().setDEF("MCP4toPIP4").setCoordIndex(new MFInt3279().getArray())
                          .setCoord(new Coordinate("MCP4toPIP4").setPoint(new MFVec3f80().getArray())))))
                    .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setCenter(new float[] {0.1f,0.7f,0f}).setUlimit(new MFFloat81().getArray()).setLlimit(new MFFloat82().getArray())
                      .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_middle_phalanx_4").setDEF("hanim_r_carpal_middle_phalanx_4")
                        .addChild(new Transform("hanim_r_carpal_middle_phalanx_4").setTranslation(new float[] {0.1f,0.7f,0f})
                          .addChild(new Shape().setUSE("HAnimJointShape")))
                        .addChild(new Shape("hanim_r_carpal_middle_phalanx_4")
                          ...
                          .setGeometry(new IndexedLineSet().setDEF("PIP4toDIP4").setCoordIndex(new MFInt3283().getArray())
                            .setCoord(new Coordinate("PIP4toDIP4").setPoint(new MFVec3f84().getArray())))))
                      .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setCenter(new float[] {0.1f,0.93f,0f}).setUlimit(new MFFloat85().getArray()).setLlimit(new MFFloat86().getArray())
                        .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_phalanx_4").setDEF("hanim_r_carpal_distal_phalanx_4")
                          .addChild(new Transform("hanim_r_carpal_distal_phalanx_4").setTranslation(new float[] {0.1f,0.93f,0f})
                            .addChild(new Shape().setUSE("HAnimJointShape")))
                          .addChild(new Shape("hanim_r_carpal_distal_phalanx_4")
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_carpal_distal_interphalangeal_4").setCoordIndex(new MFInt3287().getArray())
                              .setCoord(new Coordinate("fingertip_r_carpal_distal_interphalangeal_4").setPoint(new MFVec3f88().getArray())))))))))
                .addComments("pinky finger")
                .addChild(new HAnimJoint("hanim_r_midcarpal_4_5").setName("r_carpometacarpal_5").setDEF("hanim_r_carpometacarpal_5").setCenter(new float[] {0.15f,0.17f,0f}).setUlimit(new MFFloat89().getArray()).setLlimit(new MFFloat90().getArray())
                  .addChild(new HAnimSegment("hanim_r_carpometacarpal_5").setName("r_metacarpal_5").setDEF("hanim_r_metacarpal_5")
                    .addChild(new Transform("hanim_r_metacarpal_5").setTranslation(new float[] {0.15f,0.17f,0f})
                      .addChild(new Shape().setUSE("HAnimJointShape")))
                    .addChild(new Shape("hanim_r_metacarpal_5")
                      ...
                      .setGeometry(new IndexedLineSet().setDEF("CMC5toMCP5").setCoordIndex(new MFInt3291().getArray())
                        .setCoord(new Coordinate("CMC5toMCP5").setPoint(new MFVec3f92().getArray())))))
                  .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setName("r_metacarpophalangeal_5").setDEF("hanim_r_metacarpophalangeal_5").setCenter(new float[] {0.2f,0.4f,0f}).setUlimit(new MFFloat93().getArray()).setLlimit(new MFFloat94().getArray())
                    .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_5").setName("r_carpal_proximal_phalanx_5").setDEF("hanim_r_carpal_proximal_phalanx_5")
                      .addChild(new Transform("hanim_r_carpal_proximal_phalanx_5").setTranslation(new float[] {0.2f,0.4f,0f})
                        .addChild(new Shape().setUSE("HAnimJointShape")))
                      .addChild(new Shape("hanim_r_carpal_proximal_phalanx_5")
                        ...
                        .setGeometry(new IndexedLineSet().setDEF("MCP5toPIP5").setCoordIndex(new MFInt3295().getArray())
                          .setCoord(new Coordinate("MCP5toPIP5").setPoint(new MFVec3f96().getArray())))))
                    .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.23f,0.63f,0f}).setUlimit(new MFFloat97().getArray()).setLlimit(new MFFloat98().getArray())
                      .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_middle_phalanx_5").setDEF("hanim_r_carpal_middle_phalanx_5")
                        .addChild(new Transform("hanim_r_carpal_middle_phalanx_5").setTranslation(new float[] {0.23f,0.63f,0f})
                          .addChild(new Shape().setUSE("HAnimJointShape")))
                        .addChild(new Shape("hanim_r_carpal_middle_phalanx_5")
                          ...
                          .setGeometry(new IndexedLineSet().setDEF("PIP5toDIP5").setCoordIndex(new MFInt3299().getArray())
                            .setCoord(new Coordinate("PIP5toDIP5").setPoint(new MFVec3f100().getArray())))))
                      .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setDEF("hanim_r_carpal_distal_interphalangeal_5").setCenter(new float[] {0.25f,0.79f,0f}).setUlimit(new MFFloat101().getArray()).setLlimit(new MFFloat102().getArray())
                        .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_5").setName("r_carpal_distal_phalanx_5").setDEF("hanim_r_carpal_distal_phalanx_5")
                          .addChild(new Transform("hanim_r_carpal_distal_phalanx_5").setTranslation(new float[] {0.25f,0.79f,0f})
                            .addChild(new Shape().setUSE("HAnimJointShape")))
                          .addChild(new Shape("hanim_r_carpal_distal_phalanx_5")
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_carpal_distal_interphalangeal_5").setCoordIndex(new MFInt32103().getArray())
                              .setCoord(new Coordinate("fingertip_r_carpal_distal_interphalangeal_5").setPoint(new MFVec3f104().getArray()))))))))))))

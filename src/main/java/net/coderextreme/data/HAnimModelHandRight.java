  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new HAnimHumanoidObject().setName("Humanoid_Right_hand").setDEF("Humanoid_Right_hand").setJointBindingPositions(new MFVec3fObject(new MFVec3f0().getArray())).setJointBindingRotations(new MFRotationObject(new MFRotation1().getArray())).setJointBindingScales(new MFVec3fObject(new MFVec3f2().getArray())).setLoa(-1).setSkeletalConfiguration("BASIC").setVersion("2.0").setDisplayBBox(false)
          .addJoints(new HAnimJointObject().setName("humanoid_root").setDEF("hanim_HumanoidRoot").setDisplayBBox(false)
            .addChild(new HAnimJointObject().setName("r_radiocarpal_joint").setDEF("r_radiocarpal_joint").setDisplayBBox(false)
              .addChild(new HAnimSegmentObject().setName("r_wrist").setDEF("r_wrist").setDisplayBBox(false)
              ...
              .addChild(new HAnimJointObject().setName("r_midcarpal_joint_12").setDEF("r_midcarpal_joint_12").setCenter(new float[] {-0.1f,0.1f,0f}).setDisplayBBox(false)
                .addChild(new HAnimSegmentObject().setName("r_trapezoid").setDEF("r_trapezoid").setDisplayBBox(false)
                  .addChild(new TransformObject().setTranslation(new float[] {-0.1f,0.1f,0f}).setDisplayBBox(false)
                    .addChild(new ShapeObject().setDEF("HAnimNewJointShape").setDisplayBBox(false)
                      .setGeometry(new SphereObject().setRadius(0.025f))
                ...
                .addChild(new HAnimJointObject().setName("r_carpometacarpal_joint_1").setDEF("r_carpometacarpal_joint_1").setCenter(new float[] {-0.2f,0.15f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("r_metacarpal_1").setDEF("r_metacarpal_1").setDisplayBBox(false)
                    .addChild(new TransformObject().setTranslation(new float[] {-0.2f,0.15f,0f}).setDisplayBBox(false)
                  ...
                  .addChild(new HAnimJointObject().setName("r_metacarpophalangeal_joint_1").setDEF("r_metacarpophalangeal_joint_1").setCenter(new float[] {-0.3f,0.3f,0f}).setDisplayBBox(false)
                    .addChild(new HAnimSegmentObject().setName("r_proximal_phalanges1").setDEF("r_proximal_phalanges1").setDisplayBBox(false)
                      .addChild(new TransformObject().setTranslation(new float[] {-0.3f,0.3f,0f}).setDisplayBBox(false)
                        .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                      .addChild(new ShapeObject().setDisplayBBox(false)
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                    ...
                    .addChild(new HAnimJointObject().setName("r_interphalangeal_joint_1").setDEF("r_interphalangeal_joint_1").setCenter(new float[] {-0.35f,0.4f,0f}).setDisplayBBox(false)
                      .addChild(new HAnimSegmentObject().setName("r_distal_phalanges1").setDEF("r_distal_phalanges1").setDisplayBBox(false)
                        .addChild(new TransformObject().setTranslation(new float[] {-0.35f,0.4f,0f}).setDisplayBBox(false)
                          .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                        .addChild(new ShapeObject().setDisplayBBox(false)
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                ...
                .addChild(new HAnimJointObject().setName("r_carpometacarpal_joint_2").setDEF("r_carpometacarpal_joint_2").setCenter(new float[] {-0.1f,0.2f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("r_metacarpal_2").setDEF("r_metacarpal_2").setDisplayBBox(false)
                    .addChild(new TransformObject().setTranslation(new float[] {-0.1f,0.2f,0f}).setDisplayBBox(false)
                      .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                    .addChild(new ShapeObject().setDisplayBBox(false)
                      .setAppearance(new AppearanceObject()
                        .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                  ...
                  .addChild(new HAnimJointObject().setName("r_metacarpophalangeal_joint_2").setDEF("r_metacarpophalangeal_joint_2").setCenter(new float[] {-0.15f,0.5f,0f}).setDisplayBBox(false)
                    .addChild(new HAnimSegmentObject().setName("r_proximal_phalanges2").setDEF("r_proximal_phalanges2").setDisplayBBox(false)
                      .addChild(new TransformObject().setTranslation(new float[] {-0.15f,0.5f,0f}).setDisplayBBox(false)
                        .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                      .addChild(new ShapeObject().setDisplayBBox(false)
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                    ...
                    .addChild(new HAnimJointObject().setName("r_proximal_interphalangeal_joint_2").setDEF("r_proximal_interphalangeal_joint_2").setCenter(new float[] {-0.2f,0.7f,0f}).setDisplayBBox(false)
                      .addChild(new HAnimSegmentObject().setName("r_middle_phalanges2").setDEF("r_middle_phalanges2").setDisplayBBox(false)
                        .addChild(new TransformObject().setTranslation(new float[] {-0.2f,0.7f,0f}).setDisplayBBox(false)
                          .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                        .addChild(new ShapeObject().setDisplayBBox(false)
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                      ...
                      .addChild(new HAnimJointObject().setName("r_distal_interphalangeal_joint_2").setDEF("r_distal_interphalangeal_joint_2").setCenter(new float[] {-0.24f,0.87f,0f}).setDisplayBBox(false)
                        .addChild(new HAnimSegmentObject().setName("r_distal_phalanges2").setDEF("r_distal_phalanges2").setDisplayBBox(false)
                          .addChild(new TransformObject().setTranslation(new float[] {-0.24f,0.87f,0f}).setDisplayBBox(false)
                            .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                          .addChild(new ShapeObject().setDisplayBBox(false)
                            .setAppearance(new AppearanceObject()
                              .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
              ...
              .addChild(new HAnimJointObject().setName("r_midcarpal_joint_3").setDEF("r_midcarpal_joint_3").setCenter(new float[] {0f,0.07f,0f}).setDisplayBBox(false)
                .addChild(new HAnimSegmentObject().setName("r_capitate").setDEF("r_capitate").setDisplayBBox(false)
                  .addChild(new TransformObject().setTranslation(new float[] {0f,0.07f,0f}).setDisplayBBox(false)
                ...
                .addChild(new HAnimJointObject().setName("r_carpometacarpal_joint_3").setDEF("r_carpometacarpal_joint_3").setCenter(new float[] {0f,0.2f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("r_metacarpal_3").setDEF("r_metacarpal_3").setDisplayBBox(false)
                    .addChild(new TransformObject().setTranslation(new float[] {0f,0.2f,0f}).setDisplayBBox(false)
                      .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                    .addChild(new ShapeObject().setDisplayBBox(false)
                      .setAppearance(new AppearanceObject()
                        .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                  ...
                  .addChild(new HAnimJointObject().setName("r_metacarpophalangeal_joint_3").setDEF("r_metacarpophalangeal_joint_3").setCenter(new float[] {-0.03f,0.5f,0f}).setDisplayBBox(false)
                    .addChild(new HAnimSegmentObject().setName("r_proximal_phalanges3").setDEF("r_proximal_phalanges3").setDisplayBBox(false)
                      .addChild(new TransformObject().setTranslation(new float[] {-0.03f,0.5f,0f}).setDisplayBBox(false)
                        .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                      .addChild(new ShapeObject().setDisplayBBox(false)
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                    ...
                    .addChild(new HAnimJointObject().setName("r_proximal_interphalangeal_joint_3").setDEF("r_proximal_interphalangeal_joint_3").setCenter(new float[] {-0.05f,0.75f,0f}).setDisplayBBox(false)
                      .addChild(new HAnimSegmentObject().setName("r_middle_phalanges3").setDEF("r_middle_phalanges3").setDisplayBBox(false)
                        .addChild(new TransformObject().setTranslation(new float[] {-0.05f,0.75f,0f}).setDisplayBBox(false)
                          .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                        .addChild(new ShapeObject().setDisplayBBox(false)
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                      ...
                      .addChild(new HAnimJointObject().setName("r_distal_interphalangeal_joint_3").setDEF("r_distal_interphalangeal_joint_3").setCenter(new float[] {-0.08f,0.96f,0f}).setDisplayBBox(false)
                        .addChild(new HAnimSegmentObject().setName("r_distal_phalanges3").setDEF("r_distal_phalanges3").setDisplayBBox(false)
                          .addChild(new TransformObject().setTranslation(new float[] {-0.08f,0.96f,0f}).setDisplayBBox(false)
                            .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                          .addChild(new ShapeObject().setDisplayBBox(false)
                            .setAppearance(new AppearanceObject()
                              .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
              ...
              .addChild(new HAnimJointObject().setName("r_midcarpal_joint_45").setDEF("r_midcarpal_joint_45").setCenter(new float[] {0.1f,0.1f,0f}).setDisplayBBox(false)
                .addChild(new HAnimSegmentObject().setName("r_hamate").setDEF("r_hamate").setDisplayBBox(false)
                  .addChild(new TransformObject().setTranslation(new float[] {0.1f,0.1f,0f}).setDisplayBBox(false)
                    .addChild(new ShapeObject().setUSE("HAnimNewJointShape")))
                  .addChild(new ShapeObject().setDisplayBBox(false)
                    .setAppearance(new AppearanceObject()
                ...
                .addChild(new HAnimJointObject().setName("r_carpometacarpal_joint_4").setDEF("r_carpometacarpal_joint_4").setCenter(new float[] {0.1f,0.2f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("r_metacarpal_4").setDEF("r_metacarpal_4").setDisplayBBox(false)
                    .addChild(new TransformObject().setTranslation(new float[] {0.1f,0.2f,0f}).setDisplayBBox(false)
                      .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                    .addChild(new ShapeObject().setDisplayBBox(false)
                      .setAppearance(new AppearanceObject()
                  ...
                  .addChild(new HAnimJointObject().setName("r_metacarpophalangeal_joint_4").setDEF("r_metacarpophalangeal_joint_4").setCenter(new float[] {0.1f,0.47f,0f}).setDisplayBBox(false)
                    .addChild(new HAnimSegmentObject().setName("r_proximal_phalanges4").setDEF("r_proximal_phalanges4").setDisplayBBox(false)
                      .addChild(new TransformObject().setTranslation(new float[] {0.1f,0.47f,0f}).setDisplayBBox(false)
                        .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                      .addChild(new ShapeObject().setDisplayBBox(false)
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                    ...
                    .addChild(new HAnimJointObject().setName("r_proximal_interphalangeal_joint_4").setDEF("r_proximal_interphalangeal_joint_4").setCenter(new float[] {0.1f,0.7f,0f}).setDisplayBBox(false)
                      .addChild(new HAnimSegmentObject().setName("r_middle_phalanges4").setDEF("r_middle_phalanges4").setDisplayBBox(false)
                        .addChild(new TransformObject().setTranslation(new float[] {0.1f,0.7f,0f}).setDisplayBBox(false)
                          .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                        .addChild(new ShapeObject().setDisplayBBox(false)
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                      ...
                      .addChild(new HAnimJointObject().setName("r_distal_interphalangeal_joint_4").setDEF("r_distal_interphalangeal_joint_4").setCenter(new float[] {0.1f,0.93f,0f}).setDisplayBBox(false)
                        .addChild(new HAnimSegmentObject().setName("r_distal_phalanx4").setDEF("r_distal_phalanx4").setDisplayBBox(false)
                          .addChild(new TransformObject().setTranslation(new float[] {0.1f,0.93f,0f}).setDisplayBBox(false)
                            .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                          .addChild(new ShapeObject().setDisplayBBox(false)
                            .setAppearance(new AppearanceObject()
                              .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                ...
                .addChild(new HAnimJointObject().setName("r_carpometacarpal_joint_5").setDEF("r_carpometacarpal_joint_5").setCenter(new float[] {0.15f,0.17f,0f}).setDisplayBBox(false)
                  .addChild(new HAnimSegmentObject().setName("r_metacarpal_5").setDEF("r_metacarpal_5").setDisplayBBox(false)
                    .addChild(new TransformObject().setTranslation(new float[] {0.15f,0.17f,0f}).setDisplayBBox(false)
                      .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                    .addChild(new ShapeObject().setDisplayBBox(false)
                      .setAppearance(new AppearanceObject()
                        .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                  ...
                  .addChild(new HAnimJointObject().setName("r_metacarpophalangeal_joint_5").setDEF("r_metacarpophalangeal_joint_5").setCenter(new float[] {0.2f,0.4f,0f}).setDisplayBBox(false)
                    .addChild(new HAnimSegmentObject().setName("r_proximal_phalanges2").setDEF("r_proximal_phalanges5").setDisplayBBox(false)
                      .addChild(new TransformObject().setTranslation(new float[] {0.2f,0.4f,0f}).setDisplayBBox(false)
                        .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                      .addChild(new ShapeObject().setDisplayBBox(false)
                        .setAppearance(new AppearanceObject()
                          .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                    ...
                    .addChild(new HAnimJointObject().setName("r_proximal_interphalangeal_joint_5").setDEF("r_proximal_interphalangeal_joint_5").setCenter(new float[] {0.23f,0.63f,0f}).setDisplayBBox(false)
                      .addChild(new HAnimSegmentObject().setName("r_middle_phalanges5").setDEF("r_middle_phalanges5").setDisplayBBox(false)
                        .addChild(new TransformObject().setTranslation(new float[] {0.23f,0.63f,0f}).setDisplayBBox(false)
                          .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                        .addChild(new ShapeObject().setDisplayBBox(false)
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))
                      ...
                      .addChild(new HAnimJointObject().setName("r_distal_interphalangeal_joint_5").setDEF("r_distal_interphalangeal_joint_5").setCenter(new float[] {0.25f,0.79f,0f}).setDisplayBBox(false)
                        .addChild(new HAnimSegmentObject().setName("r_distal_phalanges5").setDEF("r_distal_phalanges5").setDisplayBBox(false)
                          .addChild(new TransformObject().setTranslation(new float[] {0.25f,0.79f,0f}).setDisplayBBox(false)
                            .addChild(new ShapeObject().setUSE("HAnimJointShape")))
                          .addChild(new ShapeObject().setDisplayBBox(false)
                            .setAppearance(new AppearanceObject()
                              .setMaterial(new MaterialObject().setEmissiveColor(new float[] {1f,1f,1f})))

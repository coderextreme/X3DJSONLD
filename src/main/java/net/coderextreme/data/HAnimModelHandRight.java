  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Humanoid_Right_hand").setDEF("Humanoid_Right_hand").setJointBindingPositions(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f0().getArray())).setJointBindingRotations(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1().getArray())).setJointBindingScales(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f2().getArray())).setVersion("2.0")
          .addJoints(new HAnimJoint().setName("humanoid_root").setDEF("hanim_HumanoidRoot")
            .addChild(new HAnimJoint().setName("r_radiocarpal_joint").setDEF("r_radiocarpal_joint")
              ...
              .addChild(new HAnimJoint().setName("r_midcarpal_joint_12").setDEF("r_midcarpal_joint_12").setCenter(new float[] {-0.1f,0.1f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_joint_1").setDEF("r_carpometacarpal_joint_1").setCenter(new float[] {-0.2f,0.15f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_joint_1").setDEF("r_metacarpophalangeal_joint_1").setCenter(new float[] {-0.3f,0.3f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_interphalangeal_joint_1").setDEF("r_interphalangeal_joint_1").setCenter(new float[] {-0.35f,0.4f,0f})
                      .addChild(new HAnimSegment().setName("r_distal_phalanges1").setDEF("r_distal_phalanges1")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                          .setGeometry(new IndexedLineSet().setDEF("fingertip_r_interphalangeal_joint_1").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3217().getArray()))
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_joint_2").setDEF("r_carpometacarpal_joint_2").setCenter(new float[] {-0.1f,0.2f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_joint_2").setDEF("r_metacarpophalangeal_joint_2").setCenter(new float[] {-0.15f,0.5f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_proximal_interphalangeal_joint_2").setDEF("r_proximal_interphalangeal_joint_2").setCenter(new float[] {-0.2f,0.7f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_distal_interphalangeal_joint_2").setDEF("r_distal_interphalangeal_joint_2").setCenter(new float[] {-0.24f,0.87f,0f})
                        .addChild(new HAnimSegment().setName("r_distal_phalanges2").setDEF("r_distal_phalanges2")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_distal_interphalangeal_joint_2").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3225().getArray()))
              ...
              .addChild(new HAnimJoint().setName("r_midcarpal_joint_3").setDEF("r_midcarpal_joint_3").setCenter(new float[] {0f,0.07f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_joint_3").setDEF("r_carpometacarpal_joint_3").setCenter(new float[] {0f,0.2f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_joint_3").setDEF("r_metacarpophalangeal_joint_3").setCenter(new float[] {-0.03f,0.5f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_proximal_interphalangeal_joint_3").setDEF("r_proximal_interphalangeal_joint_3").setCenter(new float[] {-0.05f,0.75f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_distal_interphalangeal_joint_3").setDEF("r_distal_interphalangeal_joint_3").setCenter(new float[] {-0.08f,0.96f,0f})
                        .addChild(new HAnimSegment().setName("r_distal_phalanges3").setDEF("r_distal_phalanges3")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_distal_interphalangeal_joint_3").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3235().getArray()))
              ...
              .addChild(new HAnimJoint().setName("r_midcarpal_joint_45").setDEF("r_midcarpal_joint_45").setCenter(new float[] {0.1f,0.1f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_joint_4").setDEF("r_carpometacarpal_joint_4").setCenter(new float[] {0.1f,0.2f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_joint_4").setDEF("r_metacarpophalangeal_joint_4").setCenter(new float[] {0.1f,0.47f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_proximal_interphalangeal_joint_4").setDEF("r_proximal_interphalangeal_joint_4").setCenter(new float[] {0.1f,0.7f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_distal_interphalangeal_joint_4").setDEF("r_distal_interphalangeal_joint_4").setCenter(new float[] {0.1f,0.93f,0f})
                        .addChild(new HAnimSegment().setName("r_distal_phalanx4").setDEF("r_distal_phalanx4")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_distal_interphalangeal_joint_4").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3247().getArray()))
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_joint_5").setDEF("r_carpometacarpal_joint_5").setCenter(new float[] {0.15f,0.17f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_joint_5").setDEF("r_metacarpophalangeal_joint_5").setCenter(new float[] {0.2f,0.4f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_proximal_interphalangeal_joint_5").setDEF("r_proximal_interphalangeal_joint_5").setCenter(new float[] {0.23f,0.63f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_distal_interphalangeal_joint_5").setDEF("r_distal_interphalangeal_joint_5").setCenter(new float[] {0.25f,0.79f,0f})
                        .addChild(new HAnimSegment().setName("r_distal_phalanges5").setDEF("r_distal_phalanges5")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_distal_interphalangeal_joint_5").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt3255().getArray()))

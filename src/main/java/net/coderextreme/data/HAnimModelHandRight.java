      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Hand_Right").setDEF("hanim_Hand_Right").setLoa(4).setVersion("2.0")
          ...
          .addSkeleton(new HAnimJoint().setName("humanoid_root").setDEF("hanim_humanoid_root").setStiffness(new float[] {0f,0f,0f})
            ...
            .addChild(new HAnimJoint().setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setDescription("connection joint of hand to leg above").setStiffness(new float[] {0f,0f,0f})
              ...
              .addComments("MC1")
              .addChild(new HAnimJoint().setName("r_midcarpal_1").setDEF("hanim_r_midcarpal_1").setCenter(new float[] {-0.14f,0.09f,0f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_1").setDEF("hanim_r_carpometacarpal_1").setCenter(new float[] {-0.2f,0.15f,0f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_1").setDEF("hanim_r_metacarpophalangeal_1").setCenter(new float[] {-0.3f,0.3f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_carpal_interphalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setCenter(new float[] {-0.35f,0.4f,0f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addComments("MC2")
              .addChild(new HAnimJoint().setName("r_midcarpal_2").setDEF("hanim_r_midcarpal_2").setCenter(new float[] {-0.07f,0.07f,0f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_2").setDEF("hanim_r_carpometacarpal_2").setCenter(new float[] {-0.1f,0.2f,0f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_2").setDEF("hanim_r_metacarpophalangeal_2").setCenter(new float[] {-0.15f,0.5f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-0.2f,0.7f,0f}).setStiffness(new float[] {0f,0f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setCenter(new float[] {-0.24f,0.87f,0f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addComments("MC3")
              .addChild(new HAnimJoint().setName("r_midcarpal_3").setDEF("hanim_r_midcarpal_3").setCenter(new float[] {0f,0.07f,0f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_3").setDEF("hanim_r_carpometacarpal_3").setCenter(new float[] {0f,0.2f,0f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_3").setDEF("hanim_r_metacarpophalangeal_3").setCenter(new float[] {-0.03f,0.5f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-0.05f,0.75f,0f}).setStiffness(new float[] {0f,0f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setCenter(new float[] {-0.08f,0.96f,0f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addComments("MC4_5")
              .addChild(new HAnimJoint().setName("r_midcarpal_4_5").setDEF("hanim_r_midcarpal_4_5").setCenter(new float[] {0.1f,0.1f,0f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_4").setDEF("hanim_r_carpometacarpal_4").setCenter(new float[] {0.1f,0.2f,0f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_4").setDEF("hanim_r_metacarpophalangeal_4").setCenter(new float[] {0.1f,0.47f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setCenter(new float[] {0.1f,0.7f,0f}).setStiffness(new float[] {0f,0f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setCenter(new float[] {0.1f,0.93f,0f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_carpometacarpal_5").setDEF("hanim_r_carpometacarpal_5").setCenter(new float[] {0.15f,0.17f,0f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metacarpophalangeal_5").setDEF("hanim_r_metacarpophalangeal_5").setCenter(new float[] {0.2f,0.4f,0f}).setStiffness(new float[] {0f,0f,0f})
                    ...
                    .addChild(new HAnimJoint().setName("r_carpal_proximal_interphalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.23f,0.63f,0f}).setStiffness(new float[] {0f,0f,0f})
                      ...
                      .addChild(new HAnimJoint().setName("r_carpal_distal_interphalangeal_5").setDEF("hanim_r_carpal_distal_interphalangeal_5").setCenter(new float[] {0.25f,0.79f,0f}).setStiffness(new float[] {0f,0f,0f})

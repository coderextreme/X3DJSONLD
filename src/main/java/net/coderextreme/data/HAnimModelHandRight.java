    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_Hand_Right").setVersion("2.0").setName("Hand_Right").setLoa(4)
              ...
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_2").setName("r_midcarpal_2").setCenter(new float[] {-0.07f,0.07f,0f})
                ...
                .addChild(new HAnimJoint("hanim_r_midcarpal_2").setDEF("hanim_r_carpometacarpal_2").setName("r_carpometacarpal_2").setCenter(new float[] {-0.1f,0.2f,0f})
                  ...
                  .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setDEF("hanim_r_metacarpophalangeal_2").setName("r_metacarpophalangeal_2").setCenter(new float[] {-0.15f,0.5f,0f})
                    ...
                    .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_1").setName("r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-0.2f,0.7f,0f})
                      ...
                      .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_1").setDEF("hanim_r_carpal_distal_interphalangeal_1").setName("r_carpal_distal_interphalangeal_2").setCenter(new float[] {-0.24f,0.87f,0f})
                        .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_1").setDEF("hanim_r_carpal_distal_phalanx_2").setName("r_carpal_distal_phalanx_2")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_carpal_distal_interphalangeal_1").setCoordIndex(new MFInt3222().getArray())
              ...
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_3").setName("r_midcarpal_3").setCenter(new float[] {0f,0.07f,0f})
                ...
                .addChild(new HAnimJoint("hanim_r_midcarpal_3").setDEF("hanim_r_carpometacarpal_3").setName("r_carpometacarpal_3").setCenter(new float[] {0f,0.2f,0f})
                  ...
                  .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setDEF("hanim_r_metacarpophalangeal_3").setName("r_metacarpophalangeal_3").setCenter(new float[] {-0.03f,0.5f,0f})
                    ...
                    .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-0.05f,0.75f,0f})
                      ...
                      .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_3").setCenter(new float[] {-0.08f,0.96f,0f})
                        .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_phalanx_3").setName("r_carpal_distal_phalanx_3")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_carpal_distal_interphalangeal_2").setCoordIndex(new MFInt3232().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f33().getArray()))))))))))
              .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_4_1").setName("r_midcarpal_4_5").setCenter(new float[] {0.1f,0.1f,0f})
                ...
                .addChild(new HAnimJoint("hanim_r_midcarpal_4_1").setDEF("hanim_r_carpometacarpal_4").setName("r_carpometacarpal_4").setCenter(new float[] {0.1f,0.2f,0f})
                  ...
                  .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setDEF("hanim_r_metacarpophalangeal_4").setName("r_metacarpophalangeal_4").setCenter(new float[] {0.1f,0.47f,0f})
                    ...
                    .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_proximal_interphalangeal_4").setCenter(new float[] {0.1f,0.7f,0f})
                      ...
                      .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_4").setCenter(new float[] {0.1f,0.93f,0f})
                        .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_phalanx_4").setName("r_carpal_distal_phalanx_4")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_carpal_distal_interphalangeal_3").setCoordIndex(new MFInt3244().getArray())
                              .setCoord(new Coordinate().setPoint(new MFVec3f45().getArray())))))))))
                .addChild(new HAnimJoint("hanim_r_midcarpal_4_1").setDEF("hanim_r_carpometacarpal_5").setName("r_carpometacarpal_5").setCenter(new float[] {0.15f,0.17f,0f})
                  ...
                  .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setDEF("hanim_r_metacarpophalangeal_5").setName("r_metacarpophalangeal_5").setCenter(new float[] {0.2f,0.4f,0f})
                    ...
                    .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_proximal_interphalangeal_5").setCenter(new float[] {0.23f,0.63f,0f})
                      ...
                      .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_5").setCenter(new float[] {0.25f,0.79f,0f})
                        .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_phalanx_5").setName("r_carpal_distal_phalanx_5")
                          ...
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                            .setGeometry(new IndexedLineSet().setDEF("fingertip_r_carpal_distal_interphalangeal_4").setCoordIndex(new MFInt3252().getArray())
          ...
          .addSegments(new HAnimSegment("hanim_Hand_Right").setUSE("hanim_r_carpal_middle_phalanx_1"))
          ...
          .addJoints(new HAnimJoint("hanim_Hand_Right").setUSE("hanim_r_carpal_distal_interphalangeal_1"))
          ...
          .addJoints(new HAnimJoint("hanim_Hand_Right").setUSE("hanim_r_carpal_proximal_interphalangeal_1"))
          ...
          .addJoints(new HAnimJoint("hanim_Hand_Right").setUSE("hanim_r_midcarpal_4_1"))

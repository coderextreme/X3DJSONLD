  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new HAnimHumanoidObject().setDEF("Humanoid_Right_hand").setJointBindingPositions(new MFVec3fObject(new MFVec3f0().getArray())).setJointBindingRotations(new MFRotationObject(new MFRotation1().getArray())).setJointBindingScales(new MFVec3fObject(new MFVec3f2().getArray())).setLoa(-1).setName("Humanoid_Right_hand").setSkeletalConfiguration("BASIC").setVersion("2.0")
          .addJoints(new HAnimJointObject().setDEF("hanim_HumanoidRoot").setName("humanoid_root")
            .addChild(new HAnimJointObject().setDEF("r_radiocarpal_joint").setName("r_radiocarpal_joint")
              ...
              .addChild(new HAnimJointObject().setDEF("r_midcarpal_joint_12").setCenter(new float[] {-0.1f,0.1f,0f}).setName("r_midcarpal_joint_12")
                ...
                .addChild(new HAnimJointObject().setDEF("r_carpometacarpal_joint_1").setCenter(new float[] {-0.2f,0.15f,0f}).setName("r_carpometacarpal_joint_1")
                  ...
                  .addChild(new HAnimJointObject().setDEF("r_metacarpophalangeal_joint_1").setCenter(new float[] {-0.3f,0.3f,0f}).setName("r_metacarpophalangeal_joint_1")
                    ...
                    .addChild(new HAnimJointObject().setDEF("r_interphalangeal_joint_1").setCenter(new float[] {-0.35f,0.4f,0f}).setName("r_interphalangeal_joint_1")
                ...
                .addChild(new HAnimJointObject().setDEF("r_carpometacarpal_joint_2").setCenter(new float[] {-0.1f,0.2f,0f}).setName("r_carpometacarpal_joint_2")
                  ...
                  .addChild(new HAnimJointObject().setDEF("r_metacarpophalangeal_joint_2").setCenter(new float[] {-0.15f,0.5f,0f}).setName("r_metacarpophalangeal_joint_2")
                    ...
                    .addChild(new HAnimJointObject().setDEF("r_proximal_interphalangeal_joint_2").setCenter(new float[] {-0.2f,0.7f,0f}).setName("r_proximal_interphalangeal_joint_2")
                      ...
                      .addChild(new HAnimJointObject().setDEF("r_distal_interphalangeal_joint_2").setCenter(new float[] {-0.24f,0.87f,0f}).setName("r_distal_interphalangeal_joint_2")
              ...
              .addChild(new HAnimJointObject().setDEF("r_midcarpal_joint_3").setCenter(new float[] {0f,0.07f,0f}).setName("r_midcarpal_joint_3")
                ...
                .addChild(new HAnimJointObject().setDEF("r_carpometacarpal_joint_3").setCenter(new float[] {0f,0.2f,0f}).setName("r_carpometacarpal_joint_3")
                  ...
                  .addChild(new HAnimJointObject().setDEF("r_metacarpophalangeal_joint_3").setCenter(new float[] {-0.03f,0.5f,0f}).setName("r_metacarpophalangeal_joint_3")
                    ...
                    .addChild(new HAnimJointObject().setDEF("r_proximal_interphalangeal_joint_3").setCenter(new float[] {-0.05f,0.75f,0f}).setName("r_proximal_interphalangeal_joint_3")
                      ...
                      .addChild(new HAnimJointObject().setDEF("r_distal_interphalangeal_joint_3").setCenter(new float[] {-0.08f,0.96f,0f}).setName("r_distal_interphalangeal_joint_3")
              ...
              .addChild(new HAnimJointObject().setDEF("r_midcarpal_joint_45").setCenter(new float[] {0.1f,0.1f,0f}).setName("r_midcarpal_joint_45")
                ...
                .addChild(new HAnimJointObject().setDEF("r_carpometacarpal_joint_4").setCenter(new float[] {0.1f,0.2f,0f}).setName("r_carpometacarpal_joint_4")
                  ...
                  .addChild(new HAnimJointObject().setDEF("r_metacarpophalangeal_joint_4").setCenter(new float[] {0.1f,0.47f,0f}).setName("r_metacarpophalangeal_joint_4")
                    ...
                    .addChild(new HAnimJointObject().setDEF("r_proximal_interphalangeal_joint_4").setCenter(new float[] {0.1f,0.7f,0f}).setName("r_proximal_interphalangeal_joint_4")
                      ...
                      .addChild(new HAnimJointObject().setDEF("r_distal_interphalangeal_joint_4").setCenter(new float[] {0.1f,0.93f,0f}).setName("r_distal_interphalangeal_joint_4")
                ...
                .addChild(new HAnimJointObject().setDEF("r_carpometacarpal_joint_5").setCenter(new float[] {0.15f,0.17f,0f}).setName("r_carpometacarpal_joint_5")
                  ...
                  .addChild(new HAnimJointObject().setDEF("r_metacarpophalangeal_joint_5").setCenter(new float[] {0.2f,0.4f,0f}).setName("r_metacarpophalangeal_joint_5")
                    ...
                    .addChild(new HAnimJointObject().setDEF("r_proximal_interphalangeal_joint_5").setCenter(new float[] {0.23f,0.63f,0f}).setName("r_proximal_interphalangeal_joint_5")
                      ...
                      .addChild(new HAnimJointObject().setDEF("r_distal_interphalangeal_joint_5").setCenter(new float[] {0.25f,0.79f,0f}).setName("r_distal_interphalangeal_joint_5")

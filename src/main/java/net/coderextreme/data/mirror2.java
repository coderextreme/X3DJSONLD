          ...
          .addChild(new Shape()
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setDEF("x_ite").setLanguage("GLSL")
                ...
                .addParts(new ShaderPart("x_ite").setType("VERTEX").setUrl(new MFString12().getArray()))
                .addParts(new ShaderPart("x_ite").setType("FRAGMENT").setUrl(new MFString13().getArray())))
              .addShaders(new ComposedShader().setDEF("x3dom").setLanguage("GLSL")
                ...
                .addParts(new ShaderPart("x3dom").setType("VERTEX").setUrl(new MFString14().getArray()))
                .addParts(new ShaderPart("x3dom").setType("FRAGMENT").setUrl(new MFString15().getArray()))))

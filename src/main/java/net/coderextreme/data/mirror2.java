...
public class mirror2 implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../data/mirror2.new.java.x3d");
    model.toFileJSON("../data/mirror2.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("mirror2.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/mirror2.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("a mirrored sphere"))))
      .setScene(new Scene()
        .addChild(new Viewpoint().setPosition(new float[] {0f ,5f ,100f }).setDescription(new SFString("Switch background and images texture")))
        .addChild(new Background().setDEF(new SFString("cube")).setLeftUrl(new MFString0().getArray()).setRightUrl(new MFString1().getArray()).setFrontUrl(new MFString2().getArray()).setBackUrl(new MFString3().getArray()).setTopUrl(new MFString4().getArray()).setBottomUrl(new MFString5().getArray()))
...
"        }"))
          ...
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("front_changed")).setToNode(new SFString("cube")).setToField(new SFString("frontUrl")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("back_changed")).setToNode(new SFString("cube")).setToField(new SFString("backUrl")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("left_changed")).setToNode(new SFString("cube")).setToField(new SFString("leftUrl")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("right_changed")).setToNode(new SFString("cube")).setToField(new SFString("rightUrl")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("top_changed")).setToNode(new SFString("cube")).setToField(new SFString("topUrl")))
          .addChild(new ROUTE().setFromNode(new SFString("UrlSelector")).setFromField(new SFString("bottom_changed")).setToNode(new SFString("cube")).setToField(new SFString("bottomUrl")))

        ...
        .addChild(new ProtoDeclare().setName("Bubble")
          .setProtoBody(new ProtoBody()
            .addChild(new Transform().setDEF("body_trans")
              ...
              .addChild(new Script("body_trans").setDEF("bounce")
...
"}"))
              ...
              .addChild(new ROUTE("body_trans").setFromNode("bounce").setFromField("translation_changed").setToNode("body_trans").setToField("set_translation"))
              .addChild(new ROUTE("body_trans").setFromNode("bounce").setFromField("scale_changed").setToNode("body_trans").setToField("set_scale"))
              .addChild(new ROUTE("body_trans").setFromNode("bubbleClock").setFromField("fraction_changed").setToNode("bounce").setToField("set_fraction")))))

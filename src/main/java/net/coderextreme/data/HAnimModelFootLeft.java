  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new HAnimHumanoidObject().setDEF("Humanoid_Left_Foot").setInfo(new MFStringObject(new MFString0().getArray())).setJointBindingPositions(new MFVec3fObject(new MFVec3f1().getArray())).setJointBindingRotations(new MFRotationObject(new MFRotation2().getArray())).setJointBindingScales(new MFVec3fObject(new MFVec3f3().getArray())).setLoa(-1).setName("Humanoid_Left_Foot").setSkeletalConfiguration("BASIC").setVersion("2.0")
          .addJoints(new HAnimJointObject().setDEF("hanim_HumanoidRoot").setName("humanoid_root")
            .addChild(new HAnimJointObject().setDEF("l_talocrural_joint").setName("l_talocrural_joint")
              ...
              .addChild(new HAnimJointObject().setDEF("l_talocalcaneonavicular_joint").setCenter(new float[] {0f,-0.3f,0f}).setName("l_talocalcaneonavicular_joint")
                ...
                .addChild(new HAnimJointObject().setDEF("l_cuneonavicular_joint1").setCenter(new float[] {-0.1f,-0.45f,0f}).setName("l_cuneonavicular_joint1")
                  ...
                  .addChild(new HAnimJointObject().setDEF("l_tarsometatarsal_joint1").setCenter(new float[] {-0.1f,-0.6f,0f}).setName("l_tarsometatarsal_joint1")
                    ...
                    .addChild(new HAnimJointObject().setDEF("l_metatarsophalangeal_joint1").setCenter(new float[] {-0.1f,-0.9f,0f}).setName("l_metatarsophalangeal_joint1")
                      ...
                      .addChild(new HAnimJointObject().setDEF("l_f_Interphalangeal_joint").setCenter(new float[] {-0.1f,-1.05f,0f}).setName("l_f_Interphalangeal_joint")
                ...
                .addChild(new HAnimJointObject().setDEF("l_cuneonavicular_joint2").setCenter(new float[] {0f,-0.45f,0f}).setName("l_cuneonavicular_joint2")
                  ...
                  .addChild(new HAnimJointObject().setDEF("l_tarsometatarsal_joint2").setCenter(new float[] {0.05f,-0.6f,0f}).setName("l_tarsometatarsal_joint2")
                    ...
                    .addChild(new HAnimJointObject().setDEF("l_metatarsophalangeal_joint2").setCenter(new float[] {0.05f,-0.9f,0f}).setName("l_metatarsophalangeal_joint2")
                      ...
                      .addChild(new HAnimJointObject().setDEF("l_f_proximal_Interphalangeal_joint2").setCenter(new float[] {0.05f,-1.05f,0f}).setName("l_f_proximal_Interphalangeal_joint2")
                        ...
                        .addChild(new HAnimJointObject().setDEF("l_f_distal_Interphalangeal_joint2").setCenter(new float[] {0.05f,-1.12f,0f}).setName("l_f_distal_Interphalangeal_joint2")
                ...
                .addChild(new HAnimJointObject().setDEF("l_cuneonavicular_joint3").setCenter(new float[] {0.1f,-0.4f,0f}).setName("l_cuneonavicular_joint3")
                  ...
                  .addChild(new HAnimJointObject().setDEF("l_tarsometatarsal_joint3").setCenter(new float[] {0.15f,-0.6f,0f}).setName("l_tarsometatarsal_joint3")
                    ...
                    .addChild(new HAnimJointObject().setDEF("l_metatarsophalangeal_joint3").setCenter(new float[] {0.15f,-0.9f,0f}).setName("l_metatarsophalangeal_joint3")
                      ...
                      .addChild(new HAnimJointObject().setDEF("l_f_proximal_Interphalangeal_joint3").setCenter(new float[] {0.15f,-1.05f,0f}).setName("l_f_proximal_Interphalangeal_joint3")
                        ...
                        .addChild(new HAnimJointObject().setDEF("l_f_distal_Interphalangeal_joint3").setCenter(new float[] {0.15f,-1.13f,0f}).setName("l_f_distal_Interphalangeal_joint3")
              ...
              .addChild(new HAnimJointObject().setDEF("l_calcaneuscuboid_joint").setCenter(new float[] {0.2f,0.3f,0f}).setName("l_calcaneuscuboid_joint")
                ...
                .addChild(new HAnimJointObject().setDEF("l_transverse_tarsal_joint").setCenter(new float[] {0.21f,-0.3f,0f}).setName("l_transverse_tarsal_joint")
                  ...
                  .addChild(new HAnimJointObject().setDEF("l_tarsometatarsal_joint4").setCenter(new float[] {0.25f,-0.58f,0f}).setName("l_tarsometatarsal_joint4")
                    ...
                    .addChild(new HAnimJointObject().setDEF("l_metatarsophalangeal_joint4").setCenter(new float[] {0.25f,-0.87f,0f}).setName("l_metatarsophalangeal_joint4")
                      ...
                      .addChild(new HAnimJointObject().setDEF("l_f_proximal_Interphalangeal_joint4").setCenter(new float[] {0.25f,-1f,0f}).setName("l_f_proximal_Interphalangeal_joint4")
                        ...
                        .addChild(new HAnimJointObject().setDEF("l_f_distal_Interphalangeal_joint4").setCenter(new float[] {0.25f,-1.1f,0f}).setName("l_f_distal_Interphalangeal_joint4")
                  ...
                  .addChild(new HAnimJointObject().setDEF("l_tarsometatarsal_joint5").setCenter(new float[] {0.33f,-0.52f,0f}).setName("l_tarsometatarsal_joint5")
                    ...
                    .addChild(new HAnimJointObject().setDEF("l_metatarsophalangeal_joint5").setCenter(new float[] {0.34f,-0.8f,0f}).setName("l_metatarsophalangeal_joint5")
                      ...
                      .addChild(new HAnimJointObject().setDEF("l_f_proximal_Interphalangeal_joint5").setCenter(new float[] {0.34f,-0.95f,0f}).setName("l_f_proximal_Interphalangeal_joint5")
                        ...
                        .addChild(new HAnimJointObject().setDEF("l_f_distal_Interphalangeal_joint5").setCenter(new float[] {0.34f,-1.05f,0f}).setName("l_f_distal_Interphalangeal_joint5")

                ...
                .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_2").setName("l_cuneonavicular_2").setCenter(new float[] {0f,-0.45f,0f})
                  ...
                  .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setDEF("hanim_l_tarsometatarsal_2").setName("l_tarsometatarsal_2").setCenter(new float[] {0.05f,-0.6f,0f})
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setDEF("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(new float[] {0.05f,-0.9f,0f})
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_proximal_interphalangeal_2").setCenter(new float[] {0.05f,-1.05f,0f})
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setCenter(new float[] {0.05f,-1.12f,0f})
                          .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_phalanx_2").setName("l_tarsal_distal_phalanx_2")
                            ...
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                              .setGeometry(new IndexedLineSet().setDEF("tiptoe_l_tarsal_distal_phalanx_2").setCoordIndex(new MFInt3226().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_3").setName("l_cuneonavicular_3").setCenter(new float[] {0.1f,-0.4f,0f})
                  ...
                  .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setDEF("hanim_l_tarsometatarsal_3").setName("l_tarsometatarsal_3").setCenter(new float[] {0.15f,-0.6f,0f})
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setDEF("hanim_l_metatarsophalangeal_3").setName("l_metatarsophalangeal_3").setCenter(new float[] {0.15f,-0.9f,0f})
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_proximal_interphalangeal_3").setCenter(new float[] {0.15f,-1.05f,0f})
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setCenter(new float[] {0.15f,-1.13f,0f})
                          .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_phalanx_3").setName("l_tarsal_distal_phalanx_3")
                            ...
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                              .setGeometry(new IndexedLineSet().setDEF("tiptoe_l_tarsal_distal_interphalangeal_3").setCoordIndex(new MFInt3236().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setDEF("hanim_l_transversetarsal").setName("l_transversetarsal").setCenter(new float[] {0.21f,-0.3f,0f})
                  ...
                  .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_4").setName("l_tarsometatarsal_4").setCenter(new float[] {0.25f,-0.58f,0f})
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setDEF("hanim_l_metatarsophalangeal_4").setName("l_metatarsophalangeal_4").setCenter(new float[] {0.25f,-0.87f,0f})
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_proximal_interphalangeal_4").setCenter(new float[] {0.25f,-1f,0f})
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setCenter(new float[] {0.25f,-1.1f,0f})
                          .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_phalanx_4").setName("l_tarsal_distal_phalanx_4")
                            ...
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                              .setGeometry(new IndexedLineSet().setDEF("tiptoe_l_tarsal_distal_interphalangeal_4").setCoordIndex(new MFInt3250().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_5").setName("l_tarsometatarsal_5").setCenter(new float[] {0.33f,-0.52f,0f})
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setDEF("hanim_l_metatarsophalangeal_5").setName("l_metatarsophalangeal_5").setCenter(new float[] {0.34f,-0.8f,0f})
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_proximal_interphalangeal_5").setCenter(new float[] {0.34f,-0.95f,0f})
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setCenter(new float[] {0.34f,-1.05f,0f})
                          .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_phalanx_5").setName("l_tarsal_distal_phalanx_5")
                            ...
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setEmissiveColor(new float[] {1f,1f,1f})))
                              .setGeometry(new IndexedLineSet().setDEF("tiptoe_l_tarsal_distal_interphalangeal_5").setCoordIndex(new MFInt3258().getArray())

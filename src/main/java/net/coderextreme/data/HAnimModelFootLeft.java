        ...
        .addChild(new HAnimHumanoid().setName("Foot_Left").setDEF("hanim_Foot_Left").setLoa(4).setVersion("2.0")
          ...
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_Foot_Left").setName("humanoid_root").setDEF("hanim_humanoid_root").setUlimit(new MFFloat1().getArray()).setLlimit(new MFFloat2().getArray()).setContainerFieldOverride("skeleton"))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("l_talocrural").setDEF("hanim_l_talocrural").setDescription("connection joint of foot to leg above").setUlimit(new MFFloat3().getArray()).setLlimit(new MFFloat4().getArray())
              ...
              .addComments("TCN")
              .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocalcaneonavicular").setDEF("hanim_l_talocalcaneonavicular").setCenter(new double[] {0,-0.3,0}).setUlimit(new MFFloat9().getArray()).setLlimit(new MFFloat10().getArray())
                ...
                .addComments("CN1")
                .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_1").setDEF("hanim_l_cuneonavicular_1").setCenter(new double[] {-0.1,-0.45,0}).setUlimit(new MFFloat17().getArray()).setLlimit(new MFFloat18().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setName("l_tarsometatarsal_1").setDEF("hanim_l_tarsometatarsal_1").setCenter(new double[] {-0.1,-0.6,0}).setUlimit(new MFFloat21().getArray()).setLlimit(new MFFloat22().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setName("l_metatarsophalangeal_1").setDEF("hanim_l_metatarsophalangeal_1").setCenter(new double[] {-0.1,-0.9,0}).setUlimit(new MFFloat25().getArray()).setLlimit(new MFFloat26().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setName("l_tarsal_interphalangeal_1").setDEF("hanim_l_tarsal_interphalangeal_1").setCenter(new double[] {-0.1,-1.05,0}).setUlimit(new MFFloat29().getArray()).setLlimit(new MFFloat30().getArray())
                ...
                .addComments("CN2")
                .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_2").setDEF("hanim_l_cuneonavicular_2").setCenter(new double[] {0,-0.45,0}).setUlimit(new MFFloat33().getArray()).setLlimit(new MFFloat34().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setName("l_tarsometatarsal_2").setDEF("hanim_l_tarsometatarsal_2").setCenter(new double[] {0.05,-0.6,0}).setUlimit(new MFFloat37().getArray()).setLlimit(new MFFloat38().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new double[] {0.05,-0.9,0}).setUlimit(new MFFloat41().getArray()).setLlimit(new MFFloat42().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setCenter(new double[] {0.05,-1.05,0}).setUlimit(new MFFloat45().getArray()).setLlimit(new MFFloat46().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setCenter(new double[] {0.05,-1.12,0}).setUlimit(new MFFloat49().getArray()).setLlimit(new MFFloat50().getArray())
                ...
                .addComments("CN3")
                .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_3").setDEF("hanim_l_cuneonavicular_3").setCenter(new double[] {0.1,-0.4,0}).setUlimit(new MFFloat53().getArray()).setLlimit(new MFFloat54().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setName("l_tarsometatarsal_3").setDEF("hanim_l_tarsometatarsal_3").setCenter(new double[] {0.15,-0.6,0}).setUlimit(new MFFloat57().getArray()).setLlimit(new MFFloat58().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setName("l_metatarsophalangeal_3").setDEF("hanim_l_metatarsophalangeal_3").setCenter(new double[] {0.15,-0.9,0}).setUlimit(new MFFloat61().getArray()).setLlimit(new MFFloat62().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setName("l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setCenter(new double[] {0.15,-1.05,0}).setUlimit(new MFFloat65().getArray()).setLlimit(new MFFloat66().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setCenter(new double[] {0.15,-1.13,0}).setUlimit(new MFFloat69().getArray()).setLlimit(new MFFloat70().getArray())
              ...
              .addComments("CC")
              .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_calcaneocuboid").setDEF("hanim_l_calcaneocuboid").setCenter(new double[] {0.2,0.3,0}).setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                ...
                .addComments("TT")
                .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setName("l_transversetarsal").setDEF("hanim_l_transversetarsal").setCenter(new double[] {0.21,-0.3,0}).setUlimit(new MFFloat77().getArray()).setLlimit(new MFFloat78().getArray())
                  ...
                  .addComments("TMT4")
                  .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_4").setDEF("hanim_l_tarsometatarsal_4").setCenter(new double[] {0.25,-0.58,0}).setUlimit(new MFFloat83().getArray()).setLlimit(new MFFloat84().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setName("l_metatarsophalangeal_4").setDEF("hanim_l_metatarsophalangeal_4").setCenter(new double[] {0.25,-0.87,0}).setUlimit(new MFFloat87().getArray()).setLlimit(new MFFloat88().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setName("l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setCenter(new double[] {0.25,-1,0}).setUlimit(new MFFloat91().getArray()).setLlimit(new MFFloat92().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setCenter(new double[] {0.25,-1.1,0}).setUlimit(new MFFloat95().getArray()).setLlimit(new MFFloat96().getArray())
                  ...
                  .addComments("TMT5")
                  .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_5").setDEF("hanim_l_tarsometatarsal_5").setCenter(new double[] {0.33,-0.52,0}).setUlimit(new MFFloat99().getArray()).setLlimit(new MFFloat100().getArray())
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setName("l_metatarsophalangeal_5").setDEF("hanim_l_metatarsophalangeal_5").setCenter(new double[] {0.34,-0.8,0}).setUlimit(new MFFloat103().getArray()).setLlimit(new MFFloat104().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setName("l_tarsal_proximal_interphalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_5").setCenter(new double[] {0.34,-0.95,0}).setUlimit(new MFFloat107().getArray()).setLlimit(new MFFloat108().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setCenter(new double[] {0.34,-1.05,0}).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())

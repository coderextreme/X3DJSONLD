...
public class KoreanCharacterAnnexB01Jin {
  public static void main(String[] args) {
    ...
    new KoreanCharacterAnnexB01Jin().initialize().toFileJSON("../data/KoreanCharacterAnnexB01Jin.new.json");
    }
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("29 December 2014"))
        ...
        .addMeta(new meta().setName("identifier").setContent("http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/KoreanCharacterAnnexB01Jin.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("KeyframeAnimation")
          ...
          .addChild(new PositionInterpolator().setDEF("Keyframe_HumanoidRoot").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat0().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f1().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_HumanoidRoot").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat2().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation3().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_sacroiliac").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat4().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation5().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_shoulder").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat6().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation7().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_elbow").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat8().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation9().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_radiocarpal").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat10().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation11().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_shoulder").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat12().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation13().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_elbow").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat14().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation15().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_radiocarpal").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat16().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation17().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_vl5").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat18().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation19().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_skullbase").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat20().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation21().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_hip").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat22().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation23().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_knee").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat24().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation25().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_talocrural").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat26().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation27().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_metatarsophalangeal").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat28().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation29().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_hip").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat30().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation31().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_knee").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat32().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation33().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_talocrural").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat34().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation35().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_metatarsophalangeal").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat36().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation37().getArray())))

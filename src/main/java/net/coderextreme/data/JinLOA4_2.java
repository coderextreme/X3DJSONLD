...
public class JinLOA4_2 {
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName("title").setContent("JinLOA4_2.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_JinLOA4").setVersion("2.0").setName("JinLOA4").setLoa(4)
          .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            .addMetadata(new MetadataString().setName("humanoidVersion").setValue(new MFString0().getArray()))
            .setMetadata(new MetadataString().setName("authorName").setValue(new MFString1().getArray())))
          .addSkeleton(new HAnimJoint("hanim_JinLOA4").setDEF("hanim_humanoid_root").setName("humanoid_root").setCenter(new float[] {0f,1631.556f,-31.44889f}).setLlimit(new MFFloat2().getArray()).setUlimit(new MFFloat3().getArray())
            .addChild(new HAnimSegment("hanim_humanoid_root").setDEF("hanim_sacrum").setName("sacrum")
              .addChild(new Transform().setTranslation(new float[] {0f,1631.556f,-31.44889f})
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                    .setTexture(new ImageTexture().setDEF("JinLOA4TextureAtlas").setUrl(new MFString4().getArray())))
                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt325().getArray()).setCoordIndex(new MFInt326().getArray())
                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f7().getArray()))
                    .setCoord(new Coordinate().setPoint(new MFVec3f8().getArray()))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(new float[] {0f,1396.889f,-31.44889f}).setLlimit(new MFFloat9().getArray()).setUlimit(new MFFloat10().getArray())
              .addChild(new HAnimSegment("hanim_sacroiliac").setDEF("hanim_pelvis").setName("pelvis")
                .addChild(new Transform().setTranslation(new float[] {0f,1396.889f,-31.44889f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_l_hip").setName("l_hip").setCenter(new float[] {186.9778f,1632.889f,-36.24444f}).setLlimit(new MFFloat15().getArray()).setUlimit(new MFFloat16().getArray())
                .addChild(new HAnimSegment("hanim_l_hip").setDEF("hanim_l_thigh").setName("l_thigh")
                  .addChild(new Transform().setTranslation(new float[] {186.9778f,1632.889f,-36.24444f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3217().getArray()).setCoordIndex(new MFInt3218().getArray())
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f19().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f20().getArray()))))))
                .addChild(new HAnimJoint("hanim_l_hip").setDEF("hanim_l_knee").setName("l_knee").setCenter(new float[] {182.9333f,807.5556f,-38.39556f}).setLlimit(new MFFloat21().getArray()).setUlimit(new MFFloat22().getArray())
                  .addChild(new HAnimSegment("hanim_l_knee").setDEF("hanim_l_calf").setName("l_calf")
                    .addChild(new Transform().setTranslation(new float[] {182.9333f,807.5556f,-38.39556f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setDEF("hanim_l_talocrural").setName("l_talocrural").setCenter(new float[] {175.4667f,188.5333f,-20.64444f}).setLlimit(new MFFloat27().getArray()).setUlimit(new MFFloat28().getArray())
                    .addChild(new HAnimSegment("hanim_l_talocrural").setDEF("hanim_l_talus").setName("l_talus")
                      .addChild(new Transform().setTranslation(new float[] {175.4667f,188.5333f,-20.64444f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3229().getArray()).setCoordIndex(new MFInt3230().getArray())
                            .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f31().getArray()))
                            .setCoord(new Coordinate().setPoint(new MFVec3f32().getArray()))))))
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_talocalcaneonavicular").setName("l_talocalcaneonavicular").setCenter(new float[] {154.6667f,72.88889f,9.608889f}).setLlimit(new MFFloat33().getArray()).setUlimit(new MFFloat34().getArray())
                      .addChild(new HAnimSegment("hanim_l_talocalcaneonavicular").setDEF("hanim_l_navicular").setName("l_navicular")
                        .addChild(new Transform().setTranslation(new float[] {154.6667f,72.88889f,9.608889f})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_1").setName("l_cuneonavicular_1").setCenter(new float[] {133.0667f,63.42222f,36.32889f}).setLlimit(new MFFloat39().getArray()).setUlimit(new MFFloat40().getArray())
                        .addChild(new HAnimSegment("hanim_l_cuneonavicular_1").setDEF("hanim_l_cuneiform_1").setName("l_cuneiform_1")
                          .addChild(new Transform().setTranslation(new float[] {133.0667f,63.42222f,36.32889f})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3241().getArray()).setCoordIndex(new MFInt3242().getArray())
                                .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f43().getArray()))
                                .setCoord(new Coordinate().setPoint(new MFVec3f44().getArray()))))))
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setDEF("hanim_l_tarsometatarsal_1").setName("l_tarsometatarsal_1").setCenter(new float[] {127.6444f,45.91111f,87.28889f}).setLlimit(new MFFloat45().getArray()).setUlimit(new MFFloat46().getArray())
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_1").setDEF("hanim_l_metatarsal_1").setName("l_metatarsal_1")
                            .addChild(new Transform().setTranslation(new float[] {127.6444f,45.91111f,87.28889f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setDEF("hanim_l_metatarsophalangeal_1").setName("l_metatarsophalangeal_1").setCenter(new float[] {122.7111f,28.49333f,184.9333f}).setLlimit(new MFFloat51().getArray()).setUlimit(new MFFloat52().getArray())
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_1").setDEF("hanim_l_tarsal_proximal_phalanx_1").setName("l_tarsal_proximal_phalanx_1")
                              .addChild(new Transform().setTranslation(new float[] {122.7111f,28.49333f,184.9333f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3253().getArray()).setCoordIndex(new MFInt3254().getArray())
                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f55().getArray()))
                                    .setCoord(new Coordinate().setPoint(new MFVec3f56().getArray()))))))
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_1").setName("l_tarsal_distal_interphalangeal_1").setCenter(new float[] {122.7111f,23.97333f,227.7778f}).setLlimit(new MFFloat57().getArray()).setUlimit(new MFFloat58().getArray())
                              .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_1").setDEF("hanim_l_tarsal_distal_phalanx_1").setName("l_tarsal_distal_phalanx_1")
                                .addChild(new Transform().setTranslation(new float[] {122.7111f,23.97333f,227.7778f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_2").setName("l_cuneonavicular_2").setCenter(new float[] {160.8444f,66.22222f,42.32444f}).setLlimit(new MFFloat63().getArray()).setUlimit(new MFFloat64().getArray())
                        .addChild(new HAnimSegment("hanim_l_cuneonavicular_2").setDEF("hanim_l_cuneiform_2").setName("l_cuneiform_2")
                          .addChild(new Transform().setTranslation(new float[] {160.8444f,66.22222f,42.32444f})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3265().getArray()).setCoordIndex(new MFInt3266().getArray())
                                .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f67().getArray()))
                                .setCoord(new Coordinate().setPoint(new MFVec3f68().getArray()))))))
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setDEF("hanim_l_tarsometatarsal_2").setName("l_tarsometatarsal_2").setCenter(new float[] {158.4f,51.55556f,81.11111f}).setLlimit(new MFFloat69().getArray()).setUlimit(new MFFloat70().getArray())
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_2").setDEF("hanim_l_metatarsal_2").setName("l_metatarsal_2")
                            .addChild(new Transform().setTranslation(new float[] {158.4f,51.55556f,81.11111f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setDEF("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(new float[] {163.0222f,29.58222f,193.2444f}).setLlimit(new MFFloat75().getArray()).setUlimit(new MFFloat76().getArray())
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_2").setDEF("hanim_l_tarsal_proximal_phalanx_2").setName("l_tarsal_proximal_phalanx_2")
                              .addChild(new Transform().setTranslation(new float[] {163.0222f,29.58222f,193.2444f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3277().getArray()).setCoordIndex(new MFInt3278().getArray())
                                    .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f79().getArray()))
                                    .setCoord(new Coordinate().setPoint(new MFVec3f80().getArray()))))))
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_1").setName("l_tarsal_proximal_interphalangeal_2").setCenter(new float[] {166.5333f,24.98222f,225.2f}).setLlimit(new MFFloat81().getArray()).setUlimit(new MFFloat82().getArray())
                              .addChild(new HAnimSegment("hanim_l_tarsal_proximal_interphalangeal_1").setDEF("hanim_l_tarsal_middle_phalanx_1").setName("l_tarsal_middle_phalanx_2")
                                .addChild(new Transform().setTranslation(new float[] {166.5333f,24.98222f,225.2f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_1").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setCenter(new float[] {166.5333f,19.40889f,243.8222f}).setLlimit(new MFFloat87().getArray()).setUlimit(new MFFloat88().getArray())
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_phalanx_2").setName("l_tarsal_distal_phalanx_2")
                                  .addChild(new Transform().setTranslation(new float[] {166.5333f,19.40889f,243.8222f})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt3289().getArray()).setCoordIndex(new MFInt3290().getArray())
                                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f91().getArray()))
                                        .setCoord(new Coordinate().setPoint(new MFVec3f92().getArray())))))))))))
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setDEF("hanim_l_cuneonavicular_3").setName("l_cuneonavicular_3").setCenter(new float[] {183.6444f,65.95556f,39.14667f}).setLlimit(new MFFloat93().getArray()).setUlimit(new MFFloat94().getArray())
                        .addChild(new HAnimSegment("hanim_l_cuneonavicular_3").setDEF("hanim_l_cuneiform_3").setName("l_cuneiform_3")
                          .addChild(new Transform().setTranslation(new float[] {183.6444f,65.95556f,39.14667f})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setDEF("hanim_l_tarsometatarsal_3").setName("l_tarsometatarsal_3").setCenter(new float[] {186.8444f,51.55556f,77.82222f}).setLlimit(new MFFloat99().getArray()).setUlimit(new MFFloat100().getArray())
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_3").setDEF("hanim_l_metatarsal_3").setName("l_metatarsal_3")
                            .addChild(new Transform().setTranslation(new float[] {186.8444f,51.55556f,77.82222f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32101().getArray()).setCoordIndex(new MFInt32102().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setDEF("hanim_l_metatarsophalangeal_3").setName("l_metatarsophalangeal_3").setCenter(new float[] {190.5778f,29.74222f,188.4889f}).setLlimit(new MFFloat105().getArray()).setUlimit(new MFFloat106().getArray())
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_3").setDEF("hanim_l_tarsal_proximal_phalanx_3").setName("l_tarsal_proximal_phalanx_3")
                              .addChild(new Transform().setTranslation(new float[] {190.5778f,29.74222f,188.4889f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_proximal_interphalangeal_3").setCenter(new float[] {195.2889f,23.55111f,218.2222f}).setLlimit(new MFFloat111().getArray()).setUlimit(new MFFloat112().getArray())
                              .addChild(new HAnimSegment("hanim_l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_middle_phalanx_2").setName("l_tarsal_middle_phalanx_3")
                                .addChild(new Transform().setTranslation(new float[] {195.2889f,23.55111f,218.2222f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32113().getArray()).setCoordIndex(new MFInt32114().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setCenter(new float[] {198.3556f,19.40889f,236.4444f}).setLlimit(new MFFloat117().getArray()).setUlimit(new MFFloat118().getArray())
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_phalanx_3").setName("l_tarsal_distal_phalanx_3")
                                  .addChild(new Transform().setTranslation(new float[] {198.3556f,19.40889f,236.4444f})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_calcaneocuboid").setName("l_calcaneocuboid").setCenter(new float[] {176f,114.5333f,-51.28889f}).setLlimit(new MFFloat123().getArray()).setUlimit(new MFFloat124().getArray())
                      .addChild(new HAnimSegment("hanim_l_calcaneocuboid").setDEF("hanim_l_calcaneus").setName("l_calcaneus")
                        .addChild(new Transform().setTranslation(new float[] {176f,114.5333f,-51.28889f})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32125().getArray()).setCoordIndex(new MFInt32126().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setDEF("hanim_l_transversetarsal").setName("l_transversetarsal").setCenter(new float[] {218.5333f,69.68889f,4.126667f}).setLlimit(new MFFloat129().getArray()).setUlimit(new MFFloat130().getArray())
                        .addChild(new HAnimSegment("hanim_l_transversetarsal").setDEF("hanim_l_cuboid").setName("l_cuboid")
                          .addChild(new Transform().setTranslation(new float[] {218.5333f,69.68889f,4.126667f})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_4").setName("l_tarsometatarsal_4").setCenter(new float[] {210.3556f,48.48889f,75.91111f}).setLlimit(new MFFloat135().getArray()).setUlimit(new MFFloat136().getArray())
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_4").setDEF("hanim_l_metatarsal_4").setName("l_metatarsal_4")
                            .addChild(new Transform().setTranslation(new float[] {210.3556f,48.48889f,75.91111f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32137().getArray()).setCoordIndex(new MFInt32138().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setDEF("hanim_l_metatarsophalangeal_4").setName("l_metatarsophalangeal_4").setCenter(new float[] {217.0222f,28.35111f,180.0889f}).setLlimit(new MFFloat141().getArray()).setUlimit(new MFFloat142().getArray())
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_4").setDEF("hanim_l_tarsal_proximal_phalanx_4").setName("l_tarsal_proximal_phalanx_4")
                              .addChild(new Transform().setTranslation(new float[] {217.0222f,28.35111f,180.0889f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_proximal_interphalangeal_4").setCenter(new float[] {225.5111f,24.18667f,210f}).setLlimit(new MFFloat147().getArray()).setUlimit(new MFFloat148().getArray())
                              .addChild(new HAnimSegment("hanim_l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_middle_phalanx_3").setName("l_tarsal_middle_phalanx_4")
                                .addChild(new Transform().setTranslation(new float[] {225.5111f,24.18667f,210f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32149().getArray()).setCoordIndex(new MFInt32150().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setCenter(new float[] {228.4889f,18.50667f,224.5778f}).setLlimit(new MFFloat153().getArray()).setUlimit(new MFFloat154().getArray())
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_phalanx_4").setName("l_tarsal_distal_phalanx_4")
                                  .addChild(new Transform().setTranslation(new float[] {228.4889f,18.50667f,224.5778f})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setDEF("hanim_l_tarsometatarsal_5").setName("l_tarsometatarsal_5").setCenter(new float[] {238.6667f,41.37333f,68.62222f}).setLlimit(new MFFloat159().getArray()).setUlimit(new MFFloat160().getArray())
                          .addChild(new HAnimSegment("hanim_l_tarsometatarsal_5").setDEF("hanim_l_metatarsal_5").setName("l_metatarsal_5")
                            .addChild(new Transform().setTranslation(new float[] {238.6667f,41.37333f,68.62222f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32161().getArray()).setCoordIndex(new MFInt32162().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setDEF("hanim_l_metatarsophalangeal_5").setName("l_metatarsophalangeal_5").setCenter(new float[] {245.0667f,27.00444f,170.9778f}).setLlimit(new MFFloat165().getArray()).setUlimit(new MFFloat166().getArray())
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_5").setDEF("hanim_l_tarsal_proximal_phalanx_5").setName("l_tarsal_proximal_phalanx_5")
                              .addChild(new Transform().setTranslation(new float[] {245.0667f,27.00444f,170.9778f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_proximal_interphalangeal_5").setCenter(new float[] {249.6444f,21.44444f,185.9556f}).setLlimit(new MFFloat171().getArray()).setUlimit(new MFFloat172().getArray())
                              .addChild(new HAnimSegment("hanim_l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_middle_phalanx_4").setName("l_tarsal_middle_phalanx_5")
                                .addChild(new Transform().setTranslation(new float[] {249.6444f,21.44444f,185.9556f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setCenter(new float[] {251.4222f,16.91556f,201.2444f}).setLlimit(new MFFloat177().getArray()).setUlimit(new MFFloat178().getArray())
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_phalanx_5").setName("l_tarsal_distal_phalanx_5")
                                  .addChild(new Transform().setTranslation(new float[] {251.4222f,16.91556f,201.2444f})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-186.9778f,1632.889f,-36.24444f}).setLlimit(new MFFloat183().getArray()).setUlimit(new MFFloat184().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-182.9333f,807.5556f,-38.39556f}).setLlimit(new MFFloat189().getArray()).setUlimit(new MFFloat190().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_talocrural").setName("r_talocrural").setCenter(new float[] {-174.7111f,188.5333f,-20.64444f}).setLlimit(new MFFloat195().getArray()).setUlimit(new MFFloat196().getArray())
                    .addChild(new HAnimSegment("hanim_r_talocrural").setDEF("hanim_r_talus").setName("r_talus")
                      .addChild(new Transform().setTranslation(new float[] {-174.7111f,188.5333f,-20.64444f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_talocalcaneonavicular").setName("r_talocalcaneonavicular").setCenter(new float[] {-153.9556f,72.88889f,9.608889f}).setLlimit(new MFFloat201().getArray()).setUlimit(new MFFloat202().getArray())
                      .addChild(new HAnimSegment("hanim_r_talocalcaneonavicular").setDEF("hanim_r_navicular").setName("r_navicular")
                        .addChild(new Transform().setTranslation(new float[] {-153.9556f,72.88889f,9.608889f})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_1").setName("r_cuneonavicular_1").setCenter(new float[] {-132.3111f,63.42222f,36.32889f}).setLlimit(new MFFloat207().getArray()).setUlimit(new MFFloat208().getArray())
                        .addChild(new HAnimSegment("hanim_r_cuneonavicular_1").setDEF("hanim_r_cuneiform_1").setName("r_cuneiform_1")
                          .addChild(new Transform().setTranslation(new float[] {-132.3111f,63.42222f,36.32889f})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_1").setDEF("hanim_r_tarsometatarsal_1").setName("r_tarsometatarsal_1").setCenter(new float[] {-126.9333f,45.91111f,87.28889f}).setLlimit(new MFFloat213().getArray()).setUlimit(new MFFloat214().getArray())
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_1").setDEF("hanim_r_metatarsal_1").setName("r_metatarsal_1")
                            .addChild(new Transform().setTranslation(new float[] {-126.9333f,45.91111f,87.28889f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_1").setDEF("hanim_r_metatarsophalangeal_1").setName("r_metatarsophalangeal_1").setCenter(new float[] {-122f,28.49333f,184.9333f}).setLlimit(new MFFloat219().getArray()).setUlimit(new MFFloat220().getArray())
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_1").setDEF("hanim_r_tarsal_proximal_phalanx_1").setName("r_tarsal_proximal_phalanx_1")
                              .addChild(new Transform().setTranslation(new float[] {-122f,28.49333f,184.9333f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_1").setName("r_tarsal_distal_interphalangeal_1").setCenter(new float[] {-121.9556f,23.97333f,227.7778f}).setLlimit(new MFFloat225().getArray()).setUlimit(new MFFloat226().getArray())
                              .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_1").setDEF("hanim_r_tarsal_distal_phalanx_1").setName("r_tarsal_distal_phalanx_1")
                                .addChild(new Transform().setTranslation(new float[] {-121.9556f,23.97333f,227.7778f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_2").setName("r_cuneonavicular_2").setCenter(new float[] {-160.0889f,66.22222f,42.32444f}).setLlimit(new MFFloat231().getArray()).setUlimit(new MFFloat232().getArray())
                        .addChild(new HAnimSegment("hanim_r_cuneonavicular_2").setDEF("hanim_r_cuneiform_2").setName("r_cuneiform_2")
                          .addChild(new Transform().setTranslation(new float[] {-160.0889f,66.22222f,42.32444f})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_2").setDEF("hanim_r_tarsometatarsal_2").setName("r_tarsometatarsal_2").setCenter(new float[] {-157.6889f,51.55556f,81.11111f}).setLlimit(new MFFloat237().getArray()).setUlimit(new MFFloat238().getArray())
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_2").setDEF("hanim_r_metatarsal_2").setName("r_metatarsal_2")
                            .addChild(new Transform().setTranslation(new float[] {-157.6889f,51.55556f,81.11111f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setDEF("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(new float[] {-162.2667f,29.58222f,193.2444f}).setLlimit(new MFFloat243().getArray()).setUlimit(new MFFloat244().getArray())
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_2").setDEF("hanim_r_tarsal_proximal_phalanx_2").setName("r_tarsal_proximal_phalanx_2")
                              .addChild(new Transform().setTranslation(new float[] {-162.2667f,29.58222f,193.2444f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_1").setName("r_tarsal_proximal_interphalangeal_2").setCenter(new float[] {-165.7778f,24.98222f,225.2f}).setLlimit(new MFFloat249().getArray()).setUlimit(new MFFloat250().getArray())
                              .addChild(new HAnimSegment("hanim_r_tarsal_proximal_interphalangeal_1").setDEF("hanim_r_tarsal_middle_phalanx_1").setName("r_tarsal_middle_phalanx_2")
                                .addChild(new Transform().setTranslation(new float[] {-165.7778f,24.98222f,225.2f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_1").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setCenter(new float[] {-165.7778f,19.40889f,243.8222f}).setLlimit(new MFFloat255().getArray()).setUlimit(new MFFloat256().getArray())
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_phalanx_2").setName("r_tarsal_distal_phalanx_2")
                                  .addChild(new Transform().setTranslation(new float[] {-165.7778f,19.40889f,243.8222f})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setDEF("hanim_r_cuneonavicular_3").setName("r_cuneonavicular_3").setCenter(new float[] {-182.9333f,65.95556f,39.14667f}).setLlimit(new MFFloat261().getArray()).setUlimit(new MFFloat262().getArray())
                        .addChild(new HAnimSegment("hanim_r_cuneonavicular_3").setDEF("hanim_r_cuneiform_3").setName("r_cuneiform_3")
                          .addChild(new Transform().setTranslation(new float[] {-182.9333f,65.95556f,39.14667f})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_3").setDEF("hanim_r_tarsometatarsal_3").setName("r_tarsometatarsal_3").setCenter(new float[] {-186.1333f,51.55556f,77.82222f}).setLlimit(new MFFloat267().getArray()).setUlimit(new MFFloat268().getArray())
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_3").setDEF("hanim_r_metatarsal_3").setName("r_metatarsal_3")
                            .addChild(new Transform().setTranslation(new float[] {-186.1333f,51.55556f,77.82222f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_3").setDEF("hanim_r_metatarsophalangeal_3").setName("r_metatarsophalangeal_3").setCenter(new float[] {-189.8222f,29.74222f,188.4889f}).setLlimit(new MFFloat273().getArray()).setUlimit(new MFFloat274().getArray())
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_3").setDEF("hanim_r_tarsal_proximal_phalanx_3").setName("r_tarsal_proximal_phalanx_3")
                              .addChild(new Transform().setTranslation(new float[] {-189.8222f,29.74222f,188.4889f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setName("r_tarsal_proximal_interphalangeal_3").setCenter(new float[] {-194.5778f,23.55111f,218.2222f}).setLlimit(new MFFloat279().getArray()).setUlimit(new MFFloat280().getArray())
                              .addChild(new HAnimSegment("hanim_r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_middle_phalanx_2").setName("r_tarsal_middle_phalanx_3")
                                .addChild(new Transform().setTranslation(new float[] {-194.5778f,23.55111f,218.2222f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setName("r_tarsal_distal_interphalangeal_3").setCenter(new float[] {-197.6f,19.40889f,236.4444f}).setLlimit(new MFFloat285().getArray()).setUlimit(new MFFloat286().getArray())
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_phalanx_3").setName("r_tarsal_distal_phalanx_3")
                                  .addChild(new Transform().setTranslation(new float[] {-197.6f,19.40889f,236.4444f})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_calcaneocuboid").setName("r_calcaneocuboid").setCenter(new float[] {-175.2444f,114.5333f,-51.28889f}).setLlimit(new MFFloat291().getArray()).setUlimit(new MFFloat292().getArray())
                      .addChild(new HAnimSegment("hanim_r_calcaneocuboid").setDEF("hanim_r_calcaneus").setName("r_calcaneus")
                        .addChild(new Transform().setTranslation(new float[] {-175.2444f,114.5333f,-51.28889f})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                      ...
                      .addChild(new HAnimJoint("hanim_r_calcaneocuboid").setDEF("hanim_r_transversetarsal").setName("r_transversetarsal").setCenter(new float[] {-217.8222f,69.68889f,4.126667f}).setLlimit(new MFFloat297().getArray()).setUlimit(new MFFloat298().getArray())
                        .addChild(new HAnimSegment("hanim_r_transversetarsal").setDEF("hanim_r_cuboid").setName("r_cuboid")
                          .addChild(new Transform().setTranslation(new float[] {-217.8222f,69.68889f,4.126667f})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setDEF("hanim_r_tarsometatarsal_4").setName("r_tarsometatarsal_4").setCenter(new float[] {-209.6444f,48.48889f,75.91111f}).setLlimit(new MFFloat303().getArray()).setUlimit(new MFFloat304().getArray())
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_4").setDEF("hanim_r_metatarsal_4").setName("r_metatarsal_4")
                            .addChild(new Transform().setTranslation(new float[] {-209.6444f,48.48889f,75.91111f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_4").setDEF("hanim_r_metatarsophalangeal_4").setName("r_metatarsophalangeal_4").setCenter(new float[] {-216.3111f,28.35111f,180.0889f}).setLlimit(new MFFloat309().getArray()).setUlimit(new MFFloat310().getArray())
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_4").setDEF("hanim_r_tarsal_proximal_phalanx_4").setName("r_tarsal_proximal_phalanx_4")
                              .addChild(new Transform().setTranslation(new float[] {-216.3111f,28.35111f,180.0889f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setName("r_tarsal_proximal_interphalangeal_4").setCenter(new float[] {-224.7556f,24.18667f,210f}).setLlimit(new MFFloat315().getArray()).setUlimit(new MFFloat316().getArray())
                              .addChild(new HAnimSegment("hanim_r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_middle_phalanx_3").setName("r_tarsal_middle_phalanx_4")
                                .addChild(new Transform().setTranslation(new float[] {-224.7556f,24.18667f,210f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setName("r_tarsal_distal_interphalangeal_4").setCenter(new float[] {-227.7778f,18.50667f,224.5778f}).setLlimit(new MFFloat321().getArray()).setUlimit(new MFFloat322().getArray())
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_phalanx_4").setName("r_tarsal_distal_phalanx_4")
                                  .addChild(new Transform().setTranslation(new float[] {-227.7778f,18.50667f,224.5778f})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setDEF("hanim_r_tarsometatarsal_5").setName("r_tarsometatarsal_5").setCenter(new float[] {-237.9111f,41.37333f,68.62222f}).setLlimit(new MFFloat327().getArray()).setUlimit(new MFFloat328().getArray())
                          .addChild(new HAnimSegment("hanim_r_tarsometatarsal_5").setDEF("hanim_r_metatarsal_5").setName("r_metatarsal_5")
                            .addChild(new Transform().setTranslation(new float[] {-237.9111f,41.37333f,68.62222f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_5").setDEF("hanim_r_metatarsophalangeal_5").setName("r_metatarsophalangeal_5").setCenter(new float[] {-244.3111f,27.00444f,170.9778f}).setLlimit(new MFFloat333().getArray()).setUlimit(new MFFloat334().getArray())
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_5").setDEF("hanim_r_tarsal_proximal_phalanx_5").setName("r_tarsal_proximal_phalanx_5")
                              .addChild(new Transform().setTranslation(new float[] {-244.3111f,27.00444f,170.9778f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32335().getArray()).setCoordIndex(new MFInt32336().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setName("r_tarsal_proximal_interphalangeal_5").setCenter(new float[] {-248.8889f,21.44444f,185.9556f}).setLlimit(new MFFloat339().getArray()).setUlimit(new MFFloat340().getArray())
                              .addChild(new HAnimSegment("hanim_r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_middle_phalanx_4").setName("r_tarsal_middle_phalanx_5")
                                .addChild(new Transform().setTranslation(new float[] {-248.8889f,21.44444f,185.9556f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setName("r_tarsal_distal_interphalangeal_5").setCenter(new float[] {-250.7111f,16.91556f,201.2444f}).setLlimit(new MFFloat345().getArray()).setUlimit(new MFFloat346().getArray())
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_5").setDEF("hanim_r_tarsal_distal_phalanx_5").setName("r_tarsal_distal_phalanx_5")
                                  .addChild(new Transform().setTranslation(new float[] {-250.7111f,16.91556f,201.2444f})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32347().getArray()).setCoordIndex(new MFInt32348().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_vl5").setName("vl5").setCenter(new float[] {0f,1828f,-27.18667f}).setLlimit(new MFFloat351().getArray()).setUlimit(new MFFloat352().getArray())
                .addChild(new HAnimSegment("hanim_vl5").setDEF("hanim_l5").setName("l5")
                  .addChild(new Transform().setTranslation(new float[] {0f,1828f,-27.18667f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_vl4").setName("vl4").setCenter(new float[] {0f,1876f,-27.18667f}).setLlimit(new MFFloat357().getArray()).setUlimit(new MFFloat358().getArray())
                  .addChild(new HAnimSegment("hanim_vl4").setDEF("hanim_l4").setName("l4")
                    .addChild(new Transform().setTranslation(new float[] {0f,1876f,-27.18667f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32359().getArray()).setCoordIndex(new MFInt32360().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_vl4").setDEF("hanim_vl3").setName("vl3").setCenter(new float[] {0f,1908f,-27.18667f}).setLlimit(new MFFloat363().getArray()).setUlimit(new MFFloat364().getArray())
                    .addChild(new HAnimSegment("hanim_vl3").setDEF("hanim_l3").setName("l3")
                      .addChild(new Transform().setTranslation(new float[] {0f,1908f,-27.18667f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                    ...
                    .addChild(new HAnimJoint("hanim_vl3").setDEF("hanim_vl2").setName("vl2").setCenter(new float[] {0f,1940.444f,-27.18667f}).setLlimit(new MFFloat369().getArray()).setUlimit(new MFFloat370().getArray())
                      .addChild(new HAnimSegment("hanim_vl2").setDEF("hanim_l2").setName("l2")
                        .addChild(new Transform().setTranslation(new float[] {0f,1940.444f,-27.18667f})
                          .addChild(new Shape()
                            .setAppearance(new Appearance()
                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32371().getArray()).setCoordIndex(new MFInt32372().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_vl2").setDEF("hanim_vl1").setName("vl1").setCenter(new float[] {0f,1974.667f,-27.18667f}).setLlimit(new MFFloat375().getArray()).setUlimit(new MFFloat376().getArray())
                        .addChild(new HAnimSegment("hanim_vl1").setDEF("hanim_l1").setName("l1")
                          .addChild(new Transform().setTranslation(new float[] {0f,1974.667f,-27.18667f})
                            .addChild(new Shape()
                              .setAppearance(new Appearance()
                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                        ...
                        .addChild(new HAnimJoint("hanim_vl1").setDEF("hanim_vt12").setName("vt12").setCenter(new float[] {0f,2020.889f,-27.18667f}).setLlimit(new MFFloat381().getArray()).setUlimit(new MFFloat382().getArray())
                          .addChild(new HAnimSegment("hanim_vt12").setDEF("hanim_t12").setName("t12")
                            .addChild(new Transform().setTranslation(new float[] {0f,2020.889f,-27.18667f})
                              .addChild(new Shape()
                                .setAppearance(new Appearance()
                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32383().getArray()).setCoordIndex(new MFInt32384().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_vt12").setDEF("hanim_vt11").setName("vt11").setCenter(new float[] {0f,2067.556f,-27.18667f}).setLlimit(new MFFloat387().getArray()).setUlimit(new MFFloat388().getArray())
                            .addChild(new HAnimSegment("hanim_vt11").setDEF("hanim_t11").setName("t11")
                              .addChild(new Transform().setTranslation(new float[] {0f,2067.556f,-27.18667f})
                                .addChild(new Shape()
                                  .setAppearance(new Appearance()
                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                            ...
                            .addChild(new HAnimJoint("hanim_vt11").setDEF("hanim_vt10").setName("vt10").setCenter(new float[] {0f,2101.333f,-27.23111f}).setLlimit(new MFFloat393().getArray()).setUlimit(new MFFloat394().getArray())
                              .addChild(new HAnimSegment("hanim_vt10").setDEF("hanim_t10").setName("t10")
                                .addChild(new Transform().setTranslation(new float[] {0f,2101.333f,-27.23111f})
                                  .addChild(new Shape()
                                    .setAppearance(new Appearance()
                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32395().getArray()).setCoordIndex(new MFInt32396().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_vt10").setDEF("hanim_vt9").setName("vt9").setCenter(new float[] {0f,2130.222f,-27.18667f}).setLlimit(new MFFloat399().getArray()).setUlimit(new MFFloat400().getArray())
                                .addChild(new HAnimSegment("hanim_vt9").setDEF("hanim_t9").setName("t9")
                                  .addChild(new Transform().setTranslation(new float[] {0f,2130.222f,-27.18667f})
                                    .addChild(new Shape()
                                      .setAppearance(new Appearance()
                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                ...
                                .addChild(new HAnimJoint("hanim_vt9").setDEF("hanim_vt8").setName("vt8").setCenter(new float[] {0f,2159.111f,-27.18667f}).setLlimit(new MFFloat405().getArray()).setUlimit(new MFFloat406().getArray())
                                  .addChild(new HAnimSegment("hanim_vt8").setDEF("hanim_t8").setName("t8")
                                    .addChild(new Transform().setTranslation(new float[] {0f,2159.111f,-27.18667f})
                                      .addChild(new Shape()
                                        .setAppearance(new Appearance()
                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32407().getArray()).setCoordIndex(new MFInt32408().getArray())
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt8").setDEF("hanim_vt7").setName("vt7").setCenter(new float[] {0f,2190.222f,-27.18667f}).setLlimit(new MFFloat411().getArray()).setUlimit(new MFFloat412().getArray())
                                    .addChild(new HAnimSegment("hanim_vt7").setDEF("hanim_t7").setName("t7")
                                      .addChild(new Transform().setTranslation(new float[] {0f,2190.222f,-27.18667f})
                                        .addChild(new Shape()
                                          .setAppearance(new Appearance()
                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt7").setDEF("hanim_vt6").setName("vt6").setCenter(new float[] {0f,2215.555f,-27.18667f}).setLlimit(new MFFloat417().getArray()).setUlimit(new MFFloat418().getArray())
                                      .addChild(new HAnimSegment("hanim_vt6").setDEF("hanim_t6").setName("t6")
                                        .addChild(new Transform().setTranslation(new float[] {0f,2215.555f,-27.18667f})
                                          .addChild(new Shape()
                                            .setAppearance(new Appearance()
                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32419().getArray()).setCoordIndex(new MFInt32420().getArray())
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt6").setDEF("hanim_vt5").setName("vt5").setCenter(new float[] {0f,2246.222f,-27.18667f}).setLlimit(new MFFloat423().getArray()).setUlimit(new MFFloat424().getArray())
                                        .addChild(new HAnimSegment("hanim_vt5").setDEF("hanim_t5").setName("t5")
                                          .addChild(new Transform().setTranslation(new float[] {0f,2246.222f,-27.18667f})
                                            .addChild(new Shape()
                                              .setAppearance(new Appearance()
                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt5").setDEF("hanim_vt4").setName("vt4").setCenter(new float[] {0f,2276.444f,-27.18667f}).setLlimit(new MFFloat429().getArray()).setUlimit(new MFFloat430().getArray())
                                          .addChild(new HAnimSegment("hanim_vt4").setDEF("hanim_t4").setName("t4")
                                            .addChild(new Transform().setTranslation(new float[] {0f,2276.444f,-27.18667f})
                                              .addChild(new Shape()
                                                .setAppearance(new Appearance()
                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32431().getArray()).setCoordIndex(new MFInt32432().getArray())
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt4").setDEF("hanim_vt3").setName("vt3").setCenter(new float[] {0f,2312.889f,-27.18667f}).setLlimit(new MFFloat435().getArray()).setUlimit(new MFFloat436().getArray())
                                            .addChild(new HAnimSegment("hanim_vt3").setDEF("hanim_t3").setName("t3")
                                              .addChild(new Transform().setTranslation(new float[] {0f,2312.889f,-27.18667f})
                                                .addChild(new Shape()
                                                  .setAppearance(new Appearance()
                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt3").setDEF("hanim_vt2").setName("vt2").setCenter(new float[] {0f,2361.778f,-27.23111f}).setLlimit(new MFFloat441().getArray()).setUlimit(new MFFloat442().getArray())
                                              .addChild(new HAnimSegment("hanim_vt2").setDEF("hanim_t2").setName("t2")
                                                .addChild(new Transform().setTranslation(new float[] {0f,2361.778f,-27.23111f})
                                                  .addChild(new Shape()
                                                    .setAppearance(new Appearance()
                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32443().getArray()).setCoordIndex(new MFInt32444().getArray())
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt2").setDEF("hanim_vt1").setName("vt1").setCenter(new float[] {0f,2408.889f,-27.18667f}).setLlimit(new MFFloat447().getArray()).setUlimit(new MFFloat448().getArray())
                                                .addChild(new HAnimSegment("hanim_vt1").setDEF("hanim_t1").setName("t1")
                                                  .addChild(new Transform().setTranslation(new float[] {0f,2408.889f,-27.18667f})
                                                    .addChild(new Shape()
                                                      .setAppearance(new Appearance()
                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_vc7").setName("vc7").setCenter(new float[] {0f,2460f,-29.75556f}).setLlimit(new MFFloat453().getArray()).setUlimit(new MFFloat454().getArray())
                                                  .addChild(new HAnimSegment("hanim_vc7").setDEF("hanim_c7").setName("c7")
                                                    .addChild(new Transform().setTranslation(new float[] {0f,2460f,-29.75556f})
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32455().getArray()).setCoordIndex(new MFInt32456().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc7").setDEF("hanim_vc6").setName("vc6").setCenter(new float[] {0f,2484f,-29.75556f}).setLlimit(new MFFloat459().getArray()).setUlimit(new MFFloat460().getArray())
                                                    .addChild(new HAnimSegment("hanim_vc6").setDEF("hanim_c6").setName("c6")
                                                      .addChild(new Transform().setTranslation(new float[] {0f,2484f,-29.75556f})
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc6").setDEF("hanim_vc5").setName("vc5").setCenter(new float[] {0f,2508.444f,-29.75556f}).setLlimit(new MFFloat465().getArray()).setUlimit(new MFFloat466().getArray())
                                                      .addChild(new HAnimSegment("hanim_vc5").setDEF("hanim_c5").setName("c5")
                                                        .addChild(new Transform().setTranslation(new float[] {0f,2508.444f,-29.75556f})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32467().getArray()).setCoordIndex(new MFInt32468().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc5").setDEF("hanim_vc4").setName("vc4").setCenter(new float[] {0f,2532.889f,-29.75556f}).setLlimit(new MFFloat471().getArray()).setUlimit(new MFFloat472().getArray())
                                                        .addChild(new HAnimSegment("hanim_vc4").setDEF("hanim_c4").setName("c4")
                                                          .addChild(new Transform().setTranslation(new float[] {0f,2532.889f,-29.75556f})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_vc4").setDEF("hanim_vc3").setName("vc3").setCenter(new float[] {0f,2558.222f,-29.75556f}).setLlimit(new MFFloat477().getArray()).setUlimit(new MFFloat478().getArray())
                                                          .addChild(new HAnimSegment("hanim_vc3").setDEF("hanim_c3").setName("c3")
                                                            .addChild(new Transform().setTranslation(new float[] {0f,2558.222f,-29.75556f})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32479().getArray()).setCoordIndex(new MFInt32480().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_vc3").setDEF("hanim_vc2").setName("vc2").setCenter(new float[] {0f,2581.333f,-29.75556f}).setLlimit(new MFFloat483().getArray()).setUlimit(new MFFloat484().getArray())
                                                            .addChild(new HAnimSegment("hanim_vc2").setDEF("hanim_c2").setName("c2")
                                                              .addChild(new Transform().setTranslation(new float[] {0f,2581.333f,-29.75556f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_vc2").setDEF("hanim_vc1").setName("vc1").setCenter(new float[] {0f,2604.444f,-29.75556f}).setLlimit(new MFFloat489().getArray()).setUlimit(new MFFloat490().getArray())
                                                              .addChild(new HAnimSegment("hanim_vc1").setDEF("hanim_c1").setName("c1")
                                                                .addChild(new Transform().setTranslation(new float[] {0f,2604.444f,-29.75556f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32491().getArray()).setCoordIndex(new MFInt32492().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_vc1").setDEF("hanim_skullbase").setName("skullbase").setCenter(new float[] {0f,2592.889f,-30.50222f}).setLlimit(new MFFloat495().getArray()).setUlimit(new MFFloat496().getArray())
                                                                .addChild(new HAnimSegment("hanim_skullbase").setDEF("hanim_skull").setName("skull")
                                                                  .addChild(new Transform().setTranslation(new float[] {0f,2592.889f,-30.50222f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32497().getArray().append(new MFInt32498().getArray()).append(new MFInt32499().getArray())).setCoordIndex(new MFInt32500().getArray().append(new MFInt32501().getArray()).append(new MFInt32502().getArray()))
                                                                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f503().getArray().append(new MFVec2f504().getArray())))
                                                                        .setCoord(new Coordinate().setPoint(new MFVec3f505().getArray().append(new MFVec3f506().getArray())))))))
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyelid_joint").setName("l_eyelid_joint").setCenter(new float[] {99.77778f,2813.333f,65.06667f}).setLlimit(new MFFloat507().getArray()).setUlimit(new MFFloat508().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_eyelid_joint").setDEF("hanim_l_eyelid").setName("l_eyelid")
                                                                    .addChild(new Transform().setTranslation(new float[] {99.77778f,2813.333f,65.06667f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyelid_joint").setName("r_eyelid_joint").setCenter(new float[] {-99.77778f,2813.333f,65.06667f}).setLlimit(new MFFloat513().getArray()).setUlimit(new MFFloat514().getArray())
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new float[] {-99.77778f,2813.333f,65.06667f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32515().getArray()).setCoordIndex(new MFInt32516().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyeball_joint").setName("l_eyeball_joint").setCenter(new float[] {95.06667f,2775.111f,164.0444f}).setLlimit(new MFFloat519().getArray()).setUlimit(new MFFloat520().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_eyeball_joint").setDEF("hanim_l_eyeball").setName("l_eyeball")
                                                                    .addChild(new Transform().setTranslation(new float[] {95.06667f,2775.111f,164.0444f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyeball_joint").setName("r_eyeball_joint").setCenter(new float[] {-95.06667f,2775.111f,164.0444f}).setLlimit(new MFFloat525().getArray()).setUlimit(new MFFloat526().getArray())
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new float[] {-95.06667f,2775.111f,164.0444f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32527().getArray()).setCoordIndex(new MFInt32528().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_l_eyebrow_joint").setName("l_eyebrow_joint").setCenter(new float[] {42.96f,2792.889f,211.2444f}).setLlimit(new MFFloat531().getArray()).setUlimit(new MFFloat532().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_eyebrow_joint").setDEF("hanim_l_eyebrow").setName("l_eyebrow")
                                                                    .addChild(new Transform().setTranslation(new float[] {42.96f,2792.889f,211.2444f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_r_eyebrow_joint").setName("r_eyebrow_joint").setCenter(new float[] {-42.96f,2792.889f,211.2444f}).setLlimit(new MFFloat537().getArray()).setUlimit(new MFFloat538().getArray())
                                                                    ...
                                                                    .addChild(new Transform().setTranslation(new float[] {-42.96f,2792.889f,211.2444f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32539().getArray()).setCoordIndex(new MFInt32540().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_skullbase").setDEF("hanim_temporomandibular").setName("temporomandibular").setCenter(new float[] {0f,2593.333f,30.37778f}).setLlimit(new MFFloat543().getArray()).setUlimit(new MFFloat544().getArray())
                                                                  .addChild(new HAnimSegment("hanim_temporomandibular").setDEF("hanim_jaw").setName("jaw")
                                                                    .addChild(new Transform().setTranslation(new float[] {0f,2593.333f,30.37778f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_l_acromioclavicular").setName("l_acromioclavicular").setCenter(new float[] {76f,2387.556f,-27.23111f}).setLlimit(new MFFloat549().getArray()).setUlimit(new MFFloat550().getArray())
                                                  .addChild(new HAnimSegment("hanim_l_acromioclavicular").setDEF("hanim_l_clavicle").setName("l_clavicle")
                                                    .addChild(new Transform().setTranslation(new float[] {76f,2387.556f,-27.23111f})
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32551().getArray()).setCoordIndex(new MFInt32552().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_acromioclavicular").setDEF("hanim_l_sternoclavicular").setName("l_sternoclavicular").setCenter(new float[] {242.8444f,2354.222f,-25.47556f}).setLlimit(new MFFloat555().getArray()).setUlimit(new MFFloat556().getArray())
                                                    .addChild(new HAnimSegment("hanim_l_sternoclavicular").setDEF("hanim_l_scapula").setName("l_scapula")
                                                      .addChild(new Transform().setTranslation(new float[] {242.8444f,2354.222f,-25.47556f})
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_sternoclavicular").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {326.0444f,2328f,-6.453333f}).setLlimit(new MFFloat561().getArray()).setUlimit(new MFFloat562().getArray())
                                                      .addChild(new HAnimSegment("hanim_l_shoulder").setDEF("hanim_l_upperarm").setName("l_upperarm")
                                                        .addChild(new Transform().setTranslation(new float[] {326.0444f,2328f,-6.453333f})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32563().getArray()).setCoordIndex(new MFInt32564().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_l_shoulder").setDEF("hanim_l_elbow").setName("l_elbow").setCenter(new float[] {359.6889f,1834.667f,-11.12f}).setLlimit(new MFFloat567().getArray()).setUlimit(new MFFloat568().getArray())
                                                        .addChild(new HAnimSegment("hanim_l_elbow").setDEF("hanim_l_forearm").setName("l_forearm")
                                                          .addChild(new Transform().setTranslation(new float[] {359.6889f,1834.667f,-11.12f})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_elbow").setDEF("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(new float[] {359.3778f,1430.667f,-9.924444f}).setLlimit(new MFFloat573().getArray()).setUlimit(new MFFloat574().getArray())
                                                          .addChild(new HAnimSegment("hanim_l_radiocarpal").setDEF("hanim_l_carpal").setName("l_carpal")
                                                            .addChild(new Transform().setTranslation(new float[] {359.3778f,1430.667f,-9.924444f})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32575().getArray()).setCoordIndex(new MFInt32576().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_1").setName("l_midcarpal_1").setCenter(new float[] {358.0889f,1394.667f,38.17778f}).setLlimit(new MFFloat579().getArray()).setUlimit(new MFFloat580().getArray())
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_1").setDEF("hanim_l_trapezium").setName("l_trapezium")
                                                              .addChild(new Transform().setTranslation(new float[] {358.0889f,1394.667f,38.17778f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_1").setDEF("hanim_l_carpometacarpal_1").setName("l_carpometacarpal_1").setCenter(new float[] {356.5333f,1368f,51.33333f}).setLlimit(new MFFloat585().getArray()).setUlimit(new MFFloat586().getArray())
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_1").setDEF("hanim_l_metacarpal_1").setName("l_metacarpal_1")
                                                                .addChild(new Transform().setTranslation(new float[] {356.5333f,1368f,51.33333f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32587().getArray()).setCoordIndex(new MFInt32588().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setDEF("hanim_l_metacarpophalangeal_1").setName("l_metacarpophalangeal_1").setCenter(new float[] {357.6f,1328.889f,70.66667f}).setLlimit(new MFFloat591().getArray()).setUlimit(new MFFloat592().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_1").setDEF("hanim_l_carpal_proximal_phalanx_1").setName("l_carpal_proximal_phalanx_1")
                                                                  .addChild(new Transform().setTranslation(new float[] {357.6f,1328.889f,70.66667f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setName("l_carpal_interphalangeal_1").setCenter(new float[] {360.8f,1292f,98.08889f}).setLlimit(new MFFloat597().getArray()).setUlimit(new MFFloat598().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_interphalangeal_1").setDEF("hanim_l_carpal_distal_phalanx_1").setName("l_carpal_distal_phalanx_1")
                                                                    .addChild(new Transform().setTranslation(new float[] {360.8f,1292f,98.08889f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32599().getArray()).setCoordIndex(new MFInt32600().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_2").setName("l_midcarpal_2").setCenter(new float[] {358.0889f,1396.444f,16.62667f}).setLlimit(new MFFloat603().getArray()).setUlimit(new MFFloat604().getArray())
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_2").setDEF("hanim_l_trapezoid").setName("l_trapezoid")
                                                              .addChild(new Transform().setTranslation(new float[] {358.0889f,1396.444f,16.62667f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32605().getArray()).setCoordIndex(new MFInt32606().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_2").setDEF("hanim_l_carpometacarpal_2").setName("l_carpometacarpal_2").setCenter(new float[] {358.0889f,1358.222f,19.21778f}).setLlimit(new MFFloat609().getArray()).setUlimit(new MFFloat610().getArray())
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_2").setDEF("hanim_l_metacarpal_2").setName("l_metacarpal_2")
                                                                .addChild(new Transform().setTranslation(new float[] {358.0889f,1358.222f,19.21778f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32611().getArray()).setCoordIndex(new MFInt32612().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setDEF("hanim_l_metacarpophalangeal_2").setName("l_metacarpophalangeal_2").setCenter(new float[] {362.9333f,1258.667f,29.77778f}).setLlimit(new MFFloat615().getArray()).setUlimit(new MFFloat616().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_2").setDEF("hanim_l_carpal_proximal_phalanx_2").setName("l_carpal_proximal_phalanx_2")
                                                                  .addChild(new Transform().setTranslation(new float[] {362.9333f,1258.667f,29.77778f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32617().getArray()).setCoordIndex(new MFInt32618().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_1").setName("l_carpal_proximal_interphalangeal_2").setCenter(new float[] {358.9333f,1198.667f,28.01778f}).setLlimit(new MFFloat621().getArray()).setUlimit(new MFFloat622().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_1").setDEF("hanim_l_carpal_middle_phalanx_1").setName("l_carpal_middle_phalanx_2")
                                                                    .addChild(new Transform().setTranslation(new float[] {358.9333f,1198.667f,28.01778f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32623().getArray()).setCoordIndex(new MFInt32624().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_1").setDEF("hanim_l_carpal_distal_interphalangeal_1").setName("l_carpal_distal_interphalangeal_2").setCenter(new float[] {356.8889f,1148.889f,26.44f}).setLlimit(new MFFloat627().getArray()).setUlimit(new MFFloat628().getArray())
                                                                    .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_1").setDEF("hanim_l_carpal_distal_phalanx_2").setName("l_carpal_distal_phalanx_2")
                                                                      .addChild(new Transform().setTranslation(new float[] {356.8889f,1148.889f,26.44f})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32629().getArray()).setCoordIndex(new MFInt32630().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_3").setName("l_midcarpal_3").setCenter(new float[] {357.6889f,1399.556f,-9.475556f}).setLlimit(new MFFloat633().getArray()).setUlimit(new MFFloat634().getArray())
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_3").setDEF("hanim_l_capitate").setName("l_capitate")
                                                              .addChild(new Transform().setTranslation(new float[] {357.6889f,1399.556f,-9.475556f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32635().getArray()).setCoordIndex(new MFInt32636().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_3").setDEF("hanim_l_carpometacarpal_3").setName("l_carpometacarpal_3").setCenter(new float[] {357.6889f,1354.667f,-12.35111f}).setLlimit(new MFFloat639().getArray()).setUlimit(new MFFloat640().getArray())
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_3").setDEF("hanim_l_metacarpal_3").setName("l_metacarpal_3")
                                                                .addChild(new Transform().setTranslation(new float[] {357.6889f,1354.667f,-12.35111f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32641().getArray()).setCoordIndex(new MFInt32642().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setDEF("hanim_l_metacarpophalangeal_3").setName("l_metacarpophalangeal_3").setCenter(new float[] {362.8444f,1254.222f,-7.737778f}).setLlimit(new MFFloat645().getArray()).setUlimit(new MFFloat646().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_3").setDEF("hanim_l_carpal_proximal_phalanx_3").setName("l_carpal_proximal_phalanx_3")
                                                                  .addChild(new Transform().setTranslation(new float[] {362.8444f,1254.222f,-7.737778f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32647().getArray()).setCoordIndex(new MFInt32648().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_proximal_interphalangeal_3").setCenter(new float[] {358.9333f,1191.556f,-6.986667f}).setLlimit(new MFFloat651().getArray()).setUlimit(new MFFloat652().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_middle_phalanx_2").setName("l_carpal_middle_phalanx_3")
                                                                    .addChild(new Transform().setTranslation(new float[] {358.9333f,1191.556f,-6.986667f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32653().getArray()).setCoordIndex(new MFInt32654().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_3").setCenter(new float[] {356.8889f,1136.444f,-7.426667f}).setLlimit(new MFFloat657().getArray()).setUlimit(new MFFloat658().getArray())
                                                                    .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_2").setDEF("hanim_l_carpal_distal_phalanx_3").setName("l_carpal_distal_phalanx_3")
                                                                      .addChild(new Transform().setTranslation(new float[] {356.8889f,1136.444f,-7.426667f})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32659().getArray()).setCoordIndex(new MFInt32660().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_midcarpal_4_1").setName("l_midcarpal_4_5").setCenter(new float[] {357.6889f,1394.222f,-50.84444f}).setLlimit(new MFFloat663().getArray()).setUlimit(new MFFloat664().getArray())
                                                            .addChild(new HAnimSegment("hanim_l_midcarpal_4_1").setDEF("hanim_l_hamate").setName("l_hamate")
                                                              .addChild(new Transform().setTranslation(new float[] {357.6889f,1394.222f,-50.84444f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32665().getArray()).setCoordIndex(new MFInt32666().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_midcarpal_4_1").setDEF("hanim_l_carpometacarpal_4").setName("l_carpometacarpal_4").setCenter(new float[] {357.6889f,1355.556f,-39.34667f}).setLlimit(new MFFloat669().getArray()).setUlimit(new MFFloat670().getArray())
                                                              .addChild(new HAnimSegment("hanim_l_carpometacarpal_4").setDEF("hanim_l_metacarpal_4").setName("l_metacarpal_4")
                                                                .addChild(new Transform().setTranslation(new float[] {357.6889f,1355.556f,-39.34667f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32671().getArray()).setCoordIndex(new MFInt32672().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setDEF("hanim_l_metacarpophalangeal_4").setName("l_metacarpophalangeal_4").setCenter(new float[] {362.8444f,1252.444f,-42.35111f}).setLlimit(new MFFloat675().getArray()).setUlimit(new MFFloat676().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_4").setDEF("hanim_l_carpal_proximal_phalanx_4").setName("l_carpal_proximal_phalanx_4")
                                                                  .addChild(new Transform().setTranslation(new float[] {362.8444f,1252.444f,-42.35111f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32677().getArray()).setCoordIndex(new MFInt32678().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_proximal_interphalangeal_4").setCenter(new float[] {358.9333f,1198.222f,-40.78222f}).setLlimit(new MFFloat681().getArray()).setUlimit(new MFFloat682().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_middle_phalanx_3").setName("l_carpal_middle_phalanx_4")
                                                                    .addChild(new Transform().setTranslation(new float[] {358.9333f,1198.222f,-40.78222f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32683().getArray()).setCoordIndex(new MFInt32684().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_4").setCenter(new float[] {356.8889f,1147.111f,-39.06667f}).setLlimit(new MFFloat687().getArray()).setUlimit(new MFFloat688().getArray())
                                                                    .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_3").setDEF("hanim_l_carpal_distal_phalanx_4").setName("l_carpal_distal_phalanx_4")
                                                                      .addChild(new Transform().setTranslation(new float[] {356.8889f,1147.111f,-39.06667f})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32689().getArray()).setCoordIndex(new MFInt32690().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_radiocarpal").setDEF("hanim_l_carpometacarpal_5").setName("l_carpometacarpal_5").setCenter(new float[] {358.8f,1359.556f,-64.75556f}).setLlimit(new MFFloat693().getArray()).setUlimit(new MFFloat694().getArray())
                                                            .addChild(new HAnimSegment("hanim_l_carpometacarpal_5").setDEF("hanim_l_metacarpal_5").setName("l_metacarpal_5")
                                                              .addChild(new Transform().setTranslation(new float[] {358.8f,1359.556f,-64.75556f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32695().getArray()).setCoordIndex(new MFInt32696().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setDEF("hanim_l_metacarpophalangeal_5").setName("l_metacarpophalangeal_5").setCenter(new float[] {362.1333f,1260.444f,-73.2f}).setLlimit(new MFFloat699().getArray()).setUlimit(new MFFloat700().getArray())
                                                              .addChild(new HAnimSegment("hanim_l_metacarpophalangeal_5").setDEF("hanim_l_carpal_proximal_phalanx_5").setName("l_carpal_proximal_phalanx_5")
                                                                .addChild(new Transform().setTranslation(new float[] {362.1333f,1260.444f,-73.2f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32701().getArray()).setCoordIndex(new MFInt32702().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_proximal_interphalangeal_5").setCenter(new float[] {358.8444f,1226.667f,-73.37778f}).setLlimit(new MFFloat705().getArray()).setUlimit(new MFFloat706().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_middle_phalanx_4").setName("l_carpal_middle_phalanx_5")
                                                                  .addChild(new Transform().setTranslation(new float[] {358.8444f,1226.667f,-73.37778f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32707().getArray()).setCoordIndex(new MFInt32708().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_5").setCenter(new float[] {357.1556f,1189.778f,-73.02222f}).setLlimit(new MFFloat711().getArray()).setUlimit(new MFFloat712().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_4").setDEF("hanim_l_carpal_distal_phalanx_5").setName("l_carpal_distal_phalanx_5")
                                                                    .addChild(new Transform().setTranslation(new float[] {357.1556f,1189.778f,-73.02222f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32713().getArray()).setCoordIndex(new MFInt32714().getArray())
                                                ...
                                                .addChild(new HAnimJoint("hanim_vt1").setDEF("hanim_r_acromioclavicular").setName("r_acromioclavicular").setCenter(new float[] {-76f,2387.556f,-27.23111f}).setLlimit(new MFFloat717().getArray()).setUlimit(new MFFloat718().getArray())
                                                    ...
                                                    .addChild(new Transform().setTranslation(new float[] {-76f,2387.556f,-27.23111f})
                                                      .addChild(new Shape()
                                                        .setAppearance(new Appearance()
                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32719().getArray()).setCoordIndex(new MFInt32720().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_acromioclavicular").setDEF("hanim_r_sternoclavicular").setName("r_sternoclavicular").setCenter(new float[] {-242.8444f,2354.222f,-25.47556f}).setLlimit(new MFFloat723().getArray()).setUlimit(new MFFloat724().getArray())
                                                      ...
                                                      .addChild(new Transform().setTranslation(new float[] {-242.8444f,2354.222f,-25.47556f})
                                                        .addChild(new Shape()
                                                          .setAppearance(new Appearance()
                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32725().getArray()).setCoordIndex(new MFInt32726().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_sternoclavicular").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-325.3333f,2328f,-6.453333f}).setLlimit(new MFFloat729().getArray()).setUlimit(new MFFloat730().getArray())
                                                      .addChild(new HAnimSegment("hanim_r_shoulder").setDEF("hanim_r_upperarm").setName("r_upperarm")
                                                        .addChild(new Transform().setTranslation(new float[] {-325.3333f,2328f,-6.453333f})
                                                          .addChild(new Shape()
                                                            .setAppearance(new Appearance()
                                                              .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                              .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                            .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32731().getArray()).setCoordIndex(new MFInt32732().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_shoulder").setDEF("hanim_r_elbow").setName("r_elbow").setCenter(new float[] {-358.9778f,1834.667f,-11.12f}).setLlimit(new MFFloat735().getArray()).setUlimit(new MFFloat736().getArray())
                                                        .addChild(new HAnimSegment("hanim_r_elbow").setDEF("hanim_r_forearm").setName("r_forearm")
                                                          .addChild(new Transform().setTranslation(new float[] {-358.9778f,1834.667f,-11.12f})
                                                            .addChild(new Shape()
                                                              .setAppearance(new Appearance()
                                                                .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                              .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32737().getArray()).setCoordIndex(new MFInt32738().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_elbow").setDEF("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(new float[] {-358.6667f,1430.667f,-9.92f}).setLlimit(new MFFloat741().getArray()).setUlimit(new MFFloat742().getArray())
                                                          .addChild(new HAnimSegment("hanim_r_radiocarpal").setDEF("hanim_r_carpal").setName("r_carpal")
                                                            .addChild(new Transform().setTranslation(new float[] {-358.6667f,1430.667f,-9.92f})
                                                              .addChild(new Shape()
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                  .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32743().getArray()).setCoordIndex(new MFInt32744().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_1").setName("r_midcarpal_1").setCenter(new float[] {-357.4667f,1394.667f,38.17778f}).setLlimit(new MFFloat747().getArray()).setUlimit(new MFFloat748().getArray())
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_1").setDEF("hanim_r_trapezium").setName("r_trapezium")
                                                              .addChild(new Transform().setTranslation(new float[] {-357.4667f,1394.667f,38.17778f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32749().getArray()).setCoordIndex(new MFInt32750().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_1").setDEF("hanim_r_carpometacarpal_1").setName("r_carpometacarpal_1").setCenter(new float[] {-355.8222f,1368f,51.33333f}).setLlimit(new MFFloat753().getArray()).setUlimit(new MFFloat754().getArray())
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_1").setDEF("hanim_r_metacarpal_1").setName("r_metacarpal_1")
                                                                .addChild(new Transform().setTranslation(new float[] {-355.8222f,1368f,51.33333f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32755().getArray()).setCoordIndex(new MFInt32756().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setDEF("hanim_r_metacarpophalangeal_1").setName("r_metacarpophalangeal_1").setCenter(new float[] {-356.8444f,1328.889f,70.66667f}).setLlimit(new MFFloat759().getArray()).setUlimit(new MFFloat760().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_1").setDEF("hanim_r_carpal_proximal_phalanx_1").setName("r_carpal_proximal_phalanx_1")
                                                                  .addChild(new Transform().setTranslation(new float[] {-356.8444f,1328.889f,70.66667f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32761().getArray()).setCoordIndex(new MFInt32762().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setName("r_carpal_interphalangeal_1").setCenter(new float[] {-360.0444f,1292f,98.08889f}).setLlimit(new MFFloat765().getArray()).setUlimit(new MFFloat766().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_interphalangeal_1").setDEF("hanim_r_carpal_distal_phalanx_1").setName("r_carpal_distal_phalanx_1")
                                                                    .addChild(new Transform().setTranslation(new float[] {-360.0444f,1292f,98.08889f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32767().getArray()).setCoordIndex(new MFInt32768().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_2").setName("r_midcarpal_2").setCenter(new float[] {-357.4667f,1396.444f,16.62667f}).setLlimit(new MFFloat771().getArray()).setUlimit(new MFFloat772().getArray())
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_2").setDEF("hanim_r_trapezoid").setName("r_trapezoid")
                                                              .addChild(new Transform().setTranslation(new float[] {-357.4667f,1396.444f,16.62667f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32773().getArray()).setCoordIndex(new MFInt32774().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_2").setDEF("hanim_r_carpometacarpal_2").setName("r_carpometacarpal_2").setCenter(new float[] {-357.3333f,1358.222f,19.21778f}).setLlimit(new MFFloat777().getArray()).setUlimit(new MFFloat778().getArray())
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_2").setDEF("hanim_r_metacarpal_2").setName("r_metacarpal_2")
                                                                .addChild(new Transform().setTranslation(new float[] {-357.3333f,1358.222f,19.21778f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32779().getArray()).setCoordIndex(new MFInt32780().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setDEF("hanim_r_metacarpophalangeal_2").setName("r_metacarpophalangeal_2").setCenter(new float[] {-362.1778f,1258.667f,29.77778f}).setLlimit(new MFFloat783().getArray()).setUlimit(new MFFloat784().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_2").setDEF("hanim_r_carpal_proximal_phalanx_2").setName("r_carpal_proximal_phalanx_2")
                                                                  .addChild(new Transform().setTranslation(new float[] {-362.1778f,1258.667f,29.77778f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32785().getArray()).setCoordIndex(new MFInt32786().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_1").setName("r_carpal_proximal_interphalangeal_2").setCenter(new float[] {-358.1778f,1198.667f,28.01778f}).setLlimit(new MFFloat789().getArray()).setUlimit(new MFFloat790().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_1").setDEF("hanim_r_carpal_middle_phalanx_1").setName("r_carpal_middle_phalanx_2")
                                                                    .addChild(new Transform().setTranslation(new float[] {-358.1778f,1198.667f,28.01778f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32791().getArray()).setCoordIndex(new MFInt32792().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_1").setDEF("hanim_r_carpal_distal_interphalangeal_1").setName("r_carpal_distal_interphalangeal_2").setCenter(new float[] {-356.1333f,1148.889f,26.44f}).setLlimit(new MFFloat795().getArray()).setUlimit(new MFFloat796().getArray())
                                                                    .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_1").setDEF("hanim_r_carpal_distal_phalanx_2").setName("r_carpal_distal_phalanx_2")
                                                                      .addChild(new Transform().setTranslation(new float[] {-356.1333f,1148.889f,26.44f})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32797().getArray()).setCoordIndex(new MFInt32798().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_3").setName("r_midcarpal_3").setCenter(new float[] {-356.9778f,1399.556f,-9.475556f}).setLlimit(new MFFloat801().getArray()).setUlimit(new MFFloat802().getArray())
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_3").setDEF("hanim_r_capitate").setName("r_capitate")
                                                              .addChild(new Transform().setTranslation(new float[] {-356.9778f,1399.556f,-9.475556f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32803().getArray()).setCoordIndex(new MFInt32804().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_3").setDEF("hanim_r_carpometacarpal_3").setName("r_carpometacarpal_3").setCenter(new float[] {-356.9778f,1354.667f,-12.35111f}).setLlimit(new MFFloat807().getArray()).setUlimit(new MFFloat808().getArray())
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_3").setDEF("hanim_r_metacarpal_3").setName("r_metacarpal_3")
                                                                .addChild(new Transform().setTranslation(new float[] {-356.9778f,1354.667f,-12.35111f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32809().getArray()).setCoordIndex(new MFInt32810().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setDEF("hanim_r_metacarpophalangeal_3").setName("r_metacarpophalangeal_3").setCenter(new float[] {-362.0889f,1254.222f,-7.737778f}).setLlimit(new MFFloat813().getArray()).setUlimit(new MFFloat814().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_3").setDEF("hanim_r_carpal_proximal_phalanx_3").setName("r_carpal_proximal_phalanx_3")
                                                                  .addChild(new Transform().setTranslation(new float[] {-362.0889f,1254.222f,-7.737778f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32815().getArray()).setCoordIndex(new MFInt32816().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_proximal_interphalangeal_3").setCenter(new float[] {-358.1778f,1191.556f,-6.986667f}).setLlimit(new MFFloat819().getArray()).setUlimit(new MFFloat820().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_middle_phalanx_2").setName("r_carpal_middle_phalanx_3")
                                                                    .addChild(new Transform().setTranslation(new float[] {-358.1778f,1191.556f,-6.986667f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32821().getArray()).setCoordIndex(new MFInt32822().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_3").setCenter(new float[] {-356.1333f,1136.444f,-7.426667f}).setLlimit(new MFFloat825().getArray()).setUlimit(new MFFloat826().getArray())
                                                                    .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_phalanx_3").setName("r_carpal_distal_phalanx_3")
                                                                      .addChild(new Transform().setTranslation(new float[] {-356.1333f,1136.444f,-7.426667f})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32827().getArray()).setCoordIndex(new MFInt32828().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_midcarpal_4_1").setName("r_midcarpal_4_5").setCenter(new float[] {-356.9778f,1394.222f,-50.84444f}).setLlimit(new MFFloat831().getArray()).setUlimit(new MFFloat832().getArray())
                                                            .addChild(new HAnimSegment("hanim_r_midcarpal_4_1").setDEF("hanim_r_hamate").setName("r_hamate")
                                                              .addChild(new Transform().setTranslation(new float[] {-356.9778f,1394.222f,-50.84444f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32833().getArray()).setCoordIndex(new MFInt32834().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_midcarpal_4_1").setDEF("hanim_r_carpometacarpal_4").setName("r_carpometacarpal_4").setCenter(new float[] {-356.9778f,1355.556f,-39.34667f}).setLlimit(new MFFloat837().getArray()).setUlimit(new MFFloat838().getArray())
                                                              .addChild(new HAnimSegment("hanim_r_carpometacarpal_4").setDEF("hanim_r_metacarpal_4").setName("r_metacarpal_4")
                                                                .addChild(new Transform().setTranslation(new float[] {-356.9778f,1355.556f,-39.34667f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32839().getArray()).setCoordIndex(new MFInt32840().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setDEF("hanim_r_metacarpophalangeal_4").setName("r_metacarpophalangeal_4").setCenter(new float[] {-362.0889f,1252.444f,-42.35111f}).setLlimit(new MFFloat843().getArray()).setUlimit(new MFFloat844().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_4").setDEF("hanim_r_carpal_proximal_phalanx_4").setName("r_carpal_proximal_phalanx_4")
                                                                  .addChild(new Transform().setTranslation(new float[] {-362.0889f,1252.444f,-42.35111f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32845().getArray()).setCoordIndex(new MFInt32846().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_proximal_interphalangeal_4").setCenter(new float[] {-358.1778f,1198.222f,-40.78222f}).setLlimit(new MFFloat849().getArray()).setUlimit(new MFFloat850().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_middle_phalanx_3").setName("r_carpal_middle_phalanx_4")
                                                                    .addChild(new Transform().setTranslation(new float[] {-358.1778f,1198.222f,-40.78222f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32851().getArray()).setCoordIndex(new MFInt32852().getArray())
                                                                  ...
                                                                  .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_4").setCenter(new float[] {-356.1333f,1147.111f,-39.06667f}).setLlimit(new MFFloat855().getArray()).setUlimit(new MFFloat856().getArray())
                                                                    .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_phalanx_4").setName("r_carpal_distal_phalanx_4")
                                                                      .addChild(new Transform().setTranslation(new float[] {-356.1333f,1147.111f,-39.06667f})
                                                                        .addChild(new Shape()
                                                                          .setAppearance(new Appearance()
                                                                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                            .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                          .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32857().getArray()).setCoordIndex(new MFInt32858().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_radiocarpal").setDEF("hanim_r_carpometacarpal_5").setName("r_carpometacarpal_5").setCenter(new float[] {-358.0444f,1359.556f,-64.75556f}).setLlimit(new MFFloat861().getArray()).setUlimit(new MFFloat862().getArray())
                                                            .addChild(new HAnimSegment("hanim_r_carpometacarpal_5").setDEF("hanim_r_metacarpal_5").setName("r_metacarpal_5")
                                                              .addChild(new Transform().setTranslation(new float[] {-358.0444f,1359.556f,-64.75556f})
                                                                .addChild(new Shape()
                                                                  .setAppearance(new Appearance()
                                                                    .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                    .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                  .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32863().getArray()).setCoordIndex(new MFInt32864().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setDEF("hanim_r_metacarpophalangeal_5").setName("r_metacarpophalangeal_5").setCenter(new float[] {-361.4222f,1260.444f,-73.2f}).setLlimit(new MFFloat867().getArray()).setUlimit(new MFFloat868().getArray())
                                                              .addChild(new HAnimSegment("hanim_r_metacarpophalangeal_5").setDEF("hanim_r_carpal_proximal_phalanx_5").setName("r_carpal_proximal_phalanx_5")
                                                                .addChild(new Transform().setTranslation(new float[] {-361.4222f,1260.444f,-73.2f})
                                                                  .addChild(new Shape()
                                                                    .setAppearance(new Appearance()
                                                                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                      .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                    .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32869().getArray()).setCoordIndex(new MFInt32870().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_proximal_interphalangeal_5").setCenter(new float[] {-358.1333f,1226.667f,-73.37778f}).setLlimit(new MFFloat873().getArray()).setUlimit(new MFFloat874().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_middle_phalanx_4").setName("r_carpal_middle_phalanx_5")
                                                                  .addChild(new Transform().setTranslation(new float[] {-358.1333f,1226.667f,-73.37778f})
                                                                    .addChild(new Shape()
                                                                      .setAppearance(new Appearance()
                                                                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                        .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                      .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32875().getArray()).setCoordIndex(new MFInt32876().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_5").setCenter(new float[] {-356.4444f,1189.778f,-73.02222f}).setLlimit(new MFFloat879().getArray()).setUlimit(new MFFloat880().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_phalanx_5").setName("r_carpal_distal_phalanx_5")
                                                                    .addChild(new Transform().setTranslation(new float[] {-356.4444f,1189.778f,-73.02222f})
                                                                      .addChild(new Shape()
                                                                        .setAppearance(new Appearance()
                                                                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                                                                          .setTexture(new ImageTexture().setUSE("JinLOA4TextureAtlas")))
                                                                        .setGeometry(new IndexedFaceSet().setCreaseAngle(3.14159f).setTexCoordIndex(new MFInt32881().getArray()).setCoordIndex(new MFInt32882().getArray())
          ...
          .addSegments(new HAnimSegment("hanim_JinLOA4").setUSE("hanim_l_carpal_middle_phalanx_1"))
          .addSegments(new HAnimSegment("hanim_JinLOA4").setUSE("hanim_r_carpal_middle_phalanx_1"))
          ...
          .addSegments(new HAnimSegment("hanim_JinLOA4").setUSE("hanim_l_tarsal_middle_phalanx_1"))
          .addSegments(new HAnimSegment("hanim_JinLOA4").setUSE("hanim_r_tarsal_middle_phalanx_1"))
          ...
          .addJoints(new HAnimJoint("hanim_JinLOA4").setUSE("hanim_l_carpal_distal_interphalangeal_1"))
          .addJoints(new HAnimJoint("hanim_JinLOA4").setUSE("hanim_r_carpal_distal_interphalangeal_1"))
          ...
          .addJoints(new HAnimJoint("hanim_JinLOA4").setUSE("hanim_l_carpal_proximal_interphalangeal_1"))
          .addJoints(new HAnimJoint("hanim_JinLOA4").setUSE("hanim_r_carpal_proximal_interphalangeal_1"))
          ...
          .addJoints(new HAnimJoint("hanim_JinLOA4").setUSE("hanim_l_midcarpal_4_1"))
          .addJoints(new HAnimJoint("hanim_JinLOA4").setUSE("hanim_r_midcarpal_4_1"))
          ...
          .addJoints(new HAnimJoint("hanim_JinLOA4").setUSE("hanim_l_tarsal_proximal_interphalangeal_1"))
          .addJoints(new HAnimJoint("hanim_JinLOA4").setUSE("hanim_r_tarsal_proximal_interphalangeal_1"))

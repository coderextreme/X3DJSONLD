    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF(new SFString("Joe_Humanoid"))
          .addChild(new HAnimHumanoid("Joe_Humanoid").setName(new SFString("Human")).setDEF(new SFString("Joe_Human")).setVersion(new SFString("2.0"))
            .addSkeleton(new HAnimJoint("Joe_Human").setName(new SFString("HumanoidRoot")).setDEF(new SFString("Joe_HumanoidRoot")).setCenter(new float[] {0f ,0.875f ,0f }).setUlimit(new MFFloat1().getArray()).setLlimit(new MFFloat2().getArray())
              ...
              .addChild(new HAnimJoint("Joe_HumanoidRoot").setName(new SFString("sacroiliac")).setDEF(new SFString("Joe_sacroiliac")).setCenter(new float[] {0f ,0.92f ,0f }).setSkinCoordIndex(new MFInt327().getArray()).setSkinCoordWeight(new MFFloat8().getArray()).setUlimit(new MFFloat9().getArray()).setLlimit(new MFFloat10().getArray())
                .addChild(new HAnimJoint("Joe_sacroiliac").setName(new SFString("l_hip")).setDEF(new SFString("Joe_l_hip")).setCenter(new float[] {0.1f ,0.92f ,0f }).setSkinCoordIndex(new MFInt3211().getArray()).setSkinCoordWeight(new MFFloat12().getArray()).setUlimit(new MFFloat13().getArray()).setLlimit(new MFFloat14().getArray())
                  .addChild(new HAnimJoint("Joe_l_hip").setName(new SFString("l_knee")).setDEF(new SFString("Joe_l_knee")).setCenter(new float[] {0.115f ,0.466f ,0f }).setSkinCoordIndex(new MFInt3215().getArray()).setSkinCoordWeight(new MFFloat16().getArray()).setUlimit(new MFFloat17().getArray()).setLlimit(new MFFloat18().getArray())
                    .addChild(new HAnimJoint("Joe_l_knee").setName(new SFString("l_ankle")).setDEF(new SFString("Joe_l_ankle")).setCenter(new float[] {0.115f ,0.069f ,0f }).setSkinCoordIndex(new MFInt3219().getArray()).setSkinCoordWeight(new MFFloat20().getArray()).setUlimit(new MFFloat21().getArray()).setLlimit(new MFFloat22().getArray())
                      .addChild(new HAnimJoint("Joe_l_ankle").setName(new SFString("l_subtalar")).setDEF(new SFString("Joe_l_subtalar")).setCenter(new float[] {0.115f ,0.031f ,0.03f }).setSkinCoordIndex(new MFInt3223().getArray()).setSkinCoordWeight(new MFFloat24().getArray()).setUlimit(new MFFloat25().getArray()).setLlimit(new MFFloat26().getArray())
                        .addChild(new HAnimJoint("Joe_l_subtalar").setName(new SFString("l_midtarsal")).setDEF(new SFString("Joe_l_midtarsal")).setCenter(new float[] {0.115f ,0.037f ,0.09f }).setSkinCoordIndex(new MFInt3227().getArray()).setSkinCoordWeight(new MFFloat28().getArray()).setUlimit(new MFFloat29().getArray()).setLlimit(new MFFloat30().getArray())
                          .addChild(new HAnimJoint("Joe_l_midtarsal").setName(new SFString("l_metatarsal")).setDEF(new SFString("Joe_l_metatarsal")).setCenter(new float[] {0.115f ,0.02f ,0.122f }).setSkinCoordIndex(new MFInt3231().getArray()).setSkinCoordWeight(new MFFloat32().getArray()).setUlimit(new MFFloat33().getArray()).setLlimit(new MFFloat34().getArray())))))))
                .addChild(new HAnimJoint("Joe_sacroiliac").setName(new SFString("r_hip")).setDEF(new SFString("Joe_r_hip")).setCenter(new float[] {-0.1f ,0.92f ,0f }).setSkinCoordIndex(new MFInt3235().getArray()).setSkinCoordWeight(new MFFloat36().getArray()).setUlimit(new MFFloat37().getArray()).setLlimit(new MFFloat38().getArray())
                  .addChild(new HAnimJoint("Joe_r_hip").setName(new SFString("r_knee")).setDEF(new SFString("Joe_r_knee")).setCenter(new float[] {-0.05f ,0.466f ,0f }).setSkinCoordIndex(new MFInt3239().getArray()).setSkinCoordWeight(new MFFloat40().getArray()).setUlimit(new MFFloat41().getArray()).setLlimit(new MFFloat42().getArray())
                    .addChild(new HAnimJoint("Joe_r_knee").setName(new SFString("r_ankle")).setDEF(new SFString("Joe_r_ankle")).setCenter(new float[] {-0.115f ,0.069f ,0f }).setSkinCoordIndex(new MFInt3243().getArray()).setSkinCoordWeight(new MFFloat44().getArray()).setUlimit(new MFFloat45().getArray()).setLlimit(new MFFloat46().getArray())
                      .addChild(new HAnimJoint("Joe_r_ankle").setName(new SFString("r_subtalar")).setDEF(new SFString("Joe_r_subtalar")).setCenter(new float[] {-0.1f ,0.015f ,-0.01f }).setSkinCoordIndex(new MFInt3247().getArray()).setSkinCoordWeight(new MFFloat48().getArray()).setUlimit(new MFFloat49().getArray()).setLlimit(new MFFloat50().getArray())
                        .addChild(new HAnimJoint("Joe_r_subtalar").setName(new SFString("r_midtarsal")).setDEF(new SFString("Joe_r_midtarsal")).setCenter(new float[] {-0.115f ,0.037f ,0.09f }).setSkinCoordIndex(new MFInt3251().getArray()).setSkinCoordWeight(new MFFloat52().getArray()).setUlimit(new MFFloat53().getArray()).setLlimit(new MFFloat54().getArray())
                          .addChild(new HAnimJoint("Joe_r_midtarsal").setName(new SFString("r_metatarsal")).setDEF(new SFString("Joe_r_metatarsal")).setCenter(new float[] {-0.1f ,0.01f ,0.14f }).setSkinCoordIndex(new MFInt3255().getArray()).setSkinCoordWeight(new MFFloat56().getArray()).setUlimit(new MFFloat57().getArray()).setLlimit(new MFFloat58().getArray()))))))))
              .addChild(new HAnimJoint("Joe_HumanoidRoot").setName(new SFString("vl5")).setDEF(new SFString("Joe_vl5")).setCenter(new float[] {0f ,1.045f ,-0.095f }).setSkinCoordIndex(new MFInt3259().getArray()).setSkinCoordWeight(new MFFloat60().getArray()).setUlimit(new MFFloat61().getArray()).setLlimit(new MFFloat62().getArray())
                .addChild(new HAnimJoint("Joe_vl5").setName(new SFString("vl4")).setDEF(new SFString("Joe_vl4")).setCenter(new float[] {0f ,1.068f ,-0.085f }).setUlimit(new MFFloat63().getArray()).setLlimit(new MFFloat64().getArray())
                  .addChild(new HAnimJoint("Joe_vl4").setName(new SFString("vl3")).setDEF(new SFString("Joe_vl3")).setCenter(new float[] {0f ,1.092f ,-0.0725f }).setUlimit(new MFFloat65().getArray()).setLlimit(new MFFloat66().getArray())
                    .addChild(new HAnimJoint("Joe_vl3").setName(new SFString("vl2")).setDEF(new SFString("Joe_vl2")).setCenter(new float[] {0f ,1.12f ,-0.065f }).setSkinCoordIndex(new MFInt3267().getArray()).setSkinCoordWeight(new MFFloat68().getArray()).setUlimit(new MFFloat69().getArray()).setLlimit(new MFFloat70().getArray())
                      .addChild(new HAnimJoint("Joe_vl2").setName(new SFString("vl1")).setDEF(new SFString("Joe_vl1")).setCenter(new float[] {0f ,1.1459f ,-0.0625f }).setUlimit(new MFFloat71().getArray()).setLlimit(new MFFloat72().getArray())
                        .addChild(new HAnimJoint("Joe_vl1").setName(new SFString("vt12")).setDEF(new SFString("Joe_vt12")).setCenter(new float[] {0f ,1.179f ,-0.068f }).setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                          .addChild(new HAnimJoint("Joe_vt12").setName(new SFString("vt11")).setDEF(new SFString("Joe_vt11")).setCenter(new float[] {0f ,1.2679f ,-0.081f }).setUlimit(new MFFloat75().getArray()).setLlimit(new MFFloat76().getArray())
                            .addChild(new HAnimJoint("Joe_vt11").setName(new SFString("vt10")).setDEF(new SFString("Joe_vt10")).setCenter(new float[] {0f ,1.242f ,-0.09f }).setSkinCoordIndex(new MFInt3277().getArray()).setSkinCoordWeight(new MFFloat78().getArray()).setUlimit(new MFFloat79().getArray()).setLlimit(new MFFloat80().getArray())
                              .addChild(new HAnimJoint("Joe_vt10").setName(new SFString("vt9")).setDEF(new SFString("Joe_vt9")).setCenter(new float[] {0f ,1.268f ,-0.1f }).setSkinCoordIndex(new MFInt3281().getArray()).setSkinCoordWeight(new MFFloat82().getArray()).setUlimit(new MFFloat83().getArray()).setLlimit(new MFFloat84().getArray())
                                .addChild(new HAnimJoint("Joe_vt9").setName(new SFString("vt8")).setDEF(new SFString("Joe_vt8")).setCenter(new float[] {0f ,1.294f ,-0.11f }).setUlimit(new MFFloat85().getArray()).setLlimit(new MFFloat86().getArray())
                                  .addChild(new HAnimJoint("Joe_vt8").setName(new SFString("vt7")).setDEF(new SFString("Joe_vt7")).setCenter(new float[] {0f ,1.323f ,-0.1155f }).setUlimit(new MFFloat87().getArray()).setLlimit(new MFFloat88().getArray())
                                    .addChild(new HAnimJoint("Joe_vt7").setName(new SFString("vt6")).setDEF(new SFString("Joe_vt6")).setCenter(new float[] {0f ,1.352f ,-0.12f }).setUlimit(new MFFloat89().getArray()).setLlimit(new MFFloat90().getArray())
                                      .addChild(new HAnimJoint("Joe_vt6").setName(new SFString("vt5")).setDEF(new SFString("Joe_vt5")).setCenter(new float[] {0f ,1.381f ,-0.1235f }).setUlimit(new MFFloat91().getArray()).setLlimit(new MFFloat92().getArray())
                                        .addChild(new HAnimJoint("Joe_vt5").setName(new SFString("vt4")).setDEF(new SFString("Joe_vt4")).setCenter(new float[] {0f ,1.41f ,-0.1235f }).setSkinCoordIndex(new MFInt3293().getArray()).setSkinCoordWeight(new MFFloat94().getArray()).setUlimit(new MFFloat95().getArray()).setLlimit(new MFFloat96().getArray())
                                          .addChild(new HAnimJoint("Joe_vt4").setName(new SFString("vt3")).setDEF(new SFString("Joe_vt3")).setCenter(new float[] {0f ,1.438f ,-0.12f }).setUlimit(new MFFloat97().getArray()).setLlimit(new MFFloat98().getArray())
                                            .addChild(new HAnimJoint("Joe_vt3").setName(new SFString("vt2")).setDEF(new SFString("Joe_vt2")).setCenter(new float[] {0f ,1.468f ,-0.105f }).setUlimit(new MFFloat99().getArray()).setLlimit(new MFFloat100().getArray())
                                              .addChild(new HAnimJoint("Joe_vt2").setName(new SFString("vt1")).setDEF(new SFString("Joe_vt1")).setCenter(new float[] {0f ,1.497f ,-0.09f }).setSkinCoordIndex(new MFInt32101().getArray()).setSkinCoordWeight(new MFFloat102().getArray()).setUlimit(new MFFloat103().getArray()).setLlimit(new MFFloat104().getArray())
                                                .addChild(new HAnimJoint("Joe_vt1").setName(new SFString("vc7")).setDEF(new SFString("Joe_vc7")).setCenter(new float[] {0f ,1.525f ,-0.072f }).setSkinCoordIndex(new MFInt32105().getArray()).setSkinCoordWeight(new MFFloat106().getArray()).setUlimit(new MFFloat107().getArray()).setLlimit(new MFFloat108().getArray())
                                                  .addChild(new HAnimJoint("Joe_vc7").setName(new SFString("vc6")).setDEF(new SFString("Joe_vc6")).setCenter(new float[] {0f ,1.54f ,-0.05f }).setUlimit(new MFFloat109().getArray()).setLlimit(new MFFloat110().getArray())
                                                    .addChild(new HAnimJoint("Joe_vc6").setName(new SFString("vc5")).setDEF(new SFString("Joe_vc5")).setCenter(new float[] {0f ,1.552f ,-0.035f }).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())
                                                      .addChild(new HAnimJoint("Joe_vc5").setName(new SFString("vc4")).setDEF(new SFString("Joe_vc4")).setCenter(new float[] {0f ,1.5675f ,-0.0256f }).setUlimit(new MFFloat113().getArray()).setLlimit(new MFFloat114().getArray())
                                                        .addChild(new HAnimJoint("Joe_vc4").setName(new SFString("vc3")).setDEF(new SFString("Joe_vc3")).setCenter(new float[] {0f ,1.58225f ,-0.0185f }).setUlimit(new MFFloat115().getArray()).setLlimit(new MFFloat116().getArray())
                                                          .addChild(new HAnimJoint("Joe_vc3").setName(new SFString("vc2")).setDEF(new SFString("Joe_vc2")).setCenter(new float[] {0f ,1.595f ,-0.0175f }).setUlimit(new MFFloat117().getArray()).setLlimit(new MFFloat118().getArray())
                                                            .addChild(new HAnimJoint("Joe_vc2").setName(new SFString("vc1")).setDEF(new SFString("Joe_vc1")).setCenter(new float[] {0f ,1.61f ,-0.015f }).setUlimit(new MFFloat119().getArray()).setLlimit(new MFFloat120().getArray())
                                                              .addChild(new HAnimJoint("Joe_vc1").setName(new SFString("skullbase")).setDEF(new SFString("Joe_skullbase")).setCenter(new float[] {0f ,1.63f ,-0.01f }).setSkinCoordIndex(new MFInt32121().getArray()).setSkinCoordWeight(new MFFloat122().getArray()).setUlimit(new MFFloat123().getArray()).setLlimit(new MFFloat124().getArray())
                                                                .addDisplacers(new HAnimDisplacer("Joe_skullbase").setName(new SFString("skull_tip_raiser_action")).setDEF(new SFString("Joe_skull_tipTest")).setCoordIndex(new MFInt32125().getArray()).setDisplacements(new MFVec3f126().getArray()))
                                                                .addChild(new HAnimJoint("Joe_skullbase").setName(new SFString("l_eyelid_joint")).setDEF(new SFString("Joe_l_eyelid_joint")).setCenter(new float[] {0.034f ,1.659f ,0.06f }).setUlimit(new MFFloat127().getArray()).setLlimit(new MFFloat128().getArray()))
                                                                .addChild(new HAnimJoint("Joe_skullbase").setName(new SFString("l_eyeball_joint")).setDEF(new SFString("Joe_l_eyeball_joint")).setCenter(new float[] {0.034f ,1.659f ,0.06f }).setUlimit(new MFFloat129().getArray()).setLlimit(new MFFloat130().getArray()))
                                                                .addChild(new HAnimJoint("Joe_skullbase").setName(new SFString("l_eyebrow_joint")).setDEF(new SFString("Joe_l_eyebrow_joint")).setCenter(new float[] {0.034f ,1.659f ,0.06f }).setUlimit(new MFFloat131().getArray()).setLlimit(new MFFloat132().getArray()))
                                                                .addChild(new HAnimJoint("Joe_skullbase").setName(new SFString("l_eyelid_joint")).setDEF(new SFString("Joe_r_eyelid_joint")).setCenter(new float[] {-0.034f ,1.659f ,0.06f }).setUlimit(new MFFloat133().getArray()).setLlimit(new MFFloat134().getArray()))
                                                                .addChild(new HAnimJoint("Joe_skullbase").setName(new SFString("l_eyeball_joint")).setDEF(new SFString("Joe_r_eyeball_joint")).setCenter(new float[] {-0.034f ,1.659f ,0.06f }).setUlimit(new MFFloat135().getArray()).setLlimit(new MFFloat136().getArray()))
                                                                .addChild(new HAnimJoint("Joe_skullbase").setName(new SFString("l_eyebrow_joint")).setDEF(new SFString("Joe_r_eyebrow_joint")).setCenter(new float[] {-0.034f ,1.659f ,0.06f }).setUlimit(new MFFloat137().getArray()).setLlimit(new MFFloat138().getArray()))
                                                                .addChild(new HAnimJoint("Joe_skullbase").setName(new SFString("temporomandibular")).setDEF(new SFString("Joe_temporomandibular")).setCenter(new float[] {0.034f ,1.659f ,0.06f }).setUlimit(new MFFloat139().getArray()).setLlimit(new MFFloat140().getArray())))))))))
                                                  .addChild(new HAnimJoint("Joe_vc7").setName(new SFString("l_sternoclavicular")).setDEF(new SFString("Joe_l_sternoclavicular")).setCenter(new float[] {0.082f ,1.4488f ,-0.0353f }).setSkinCoordIndex(new MFInt32141().getArray()).setSkinCoordWeight(new MFFloat142().getArray()).setUlimit(new MFFloat143().getArray()).setLlimit(new MFFloat144().getArray())
                                                    .addChild(new HAnimJoint("Joe_l_sternoclavicular").setName(new SFString("l_acromioclavicular")).setDEF(new SFString("Joe_l_acromioclavicular")).setCenter(new float[] {0.0962f ,1.4269f ,-0.0424f }).setSkinCoordIndex(new MFInt32145().getArray()).setSkinCoordWeight(new MFFloat146().getArray()).setUlimit(new MFFloat147().getArray()).setLlimit(new MFFloat148().getArray())
                                                      .addChild(new HAnimJoint("Joe_l_acromioclavicular").setName(new SFString("l_shoulder")).setDEF(new SFString("Joe_l_shoulder")).setCenter(new float[] {0.2f ,1.44f ,-0.04f }).setSkinCoordIndex(new MFInt32149().getArray()).setSkinCoordWeight(new MFFloat150().getArray()).setUlimit(new MFFloat151().getArray()).setLlimit(new MFFloat152().getArray())
                                                        .addChild(new HAnimJoint("Joe_l_shoulder").setName(new SFString("l_elbow")).setDEF(new SFString("Joe_l_elbow")).setCenter(new float[] {0.2f ,1.1388f ,-0.04f }).setSkinCoordIndex(new MFInt32153().getArray()).setSkinCoordWeight(new MFFloat154().getArray()).setUlimit(new MFFloat155().getArray()).setLlimit(new MFFloat156().getArray())
                                                          .addChild(new HAnimJoint("Joe_l_elbow").setName(new SFString("l_wrist")).setDEF(new SFString("Joe_l_wrist")).setCenter(new float[] {0.2f ,0.87f ,-0.04f }).setSkinCoordIndex(new MFInt32157().getArray()).setSkinCoordWeight(new MFFloat158().getArray()).setUlimit(new MFFloat159().getArray()).setLlimit(new MFFloat160().getArray())
                                                            .addChild(new HAnimJoint("Joe_l_wrist").setName(new SFString("l_thumb1")).setDEF(new SFString("Joe_l_thumb1")).setCenter(new float[] {0.1924f ,0.8472f ,-0.0534f }).setSkinCoordIndex(new MFInt32161().getArray()).setSkinCoordWeight(new MFFloat162().getArray()).setUlimit(new MFFloat163().getArray()).setLlimit(new MFFloat164().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_thumb1").setName(new SFString("l_thumb2")).setDEF(new SFString("Joe_l_thumb2")).setCenter(new float[] {0.1951f ,0.8226f ,0.0246f }).setSkinCoordIndex(new MFInt32165().getArray()).setSkinCoordWeight(new MFFloat166().getArray()).setUlimit(new MFFloat167().getArray()).setLlimit(new MFFloat168().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_thumb2").setName(new SFString("l_thumb3")).setDEF(new SFString("Joe_l_thumb3")).setCenter(new float[] {0.1955f ,0.8159f ,0.0464f }).setSkinCoordIndex(new MFInt32169().getArray()).setSkinCoordWeight(new MFFloat170().getArray()).setUlimit(new MFFloat171().getArray()).setLlimit(new MFFloat172().getArray()))))
                                                            .addChild(new HAnimJoint("Joe_l_wrist").setName(new SFString("l_index0")).setDEF(new SFString("Joe_l_index0")).setCenter(new float[] {0.1983f ,0.8024f ,-0.028f }).setSkinCoordIndex(new MFInt32173().getArray()).setSkinCoordWeight(new MFFloat174().getArray()).setUlimit(new MFFloat175().getArray()).setLlimit(new MFFloat176().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_index0").setName(new SFString("l_index1")).setDEF(new SFString("Joe_l_index1")).setCenter(new float[] {0.1983f ,0.7815f ,-0.028f }).setSkinCoordIndex(new MFInt32177().getArray()).setSkinCoordWeight(new MFFloat178().getArray()).setUlimit(new MFFloat179().getArray()).setLlimit(new MFFloat180().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_index1").setName(new SFString("l_index2")).setDEF(new SFString("Joe_l_index2")).setCenter(new float[] {0.2017f ,0.7363f ,-0.0248f }).setSkinCoordIndex(new MFInt32181().getArray()).setSkinCoordWeight(new MFFloat182().getArray()).setUlimit(new MFFloat183().getArray()).setLlimit(new MFFloat184().getArray())
                                                                  .addChild(new HAnimJoint("Joe_l_index2").setName(new SFString("l_index3")).setDEF(new SFString("Joe_l_index3")).setCenter(new float[] {0.2028f ,0.7139f ,-0.0236f }).setSkinCoordIndex(new MFInt32185().getArray()).setSkinCoordWeight(new MFFloat186().getArray()).setUlimit(new MFFloat187().getArray()).setLlimit(new MFFloat188().getArray())))))
                                                            .addChild(new HAnimJoint("Joe_l_wrist").setName(new SFString("l_middle0")).setDEF(new SFString("Joe_l_middle0")).setCenter(new float[] {0.1987f ,0.8029f ,-0.053f }).setSkinCoordIndex(new MFInt32189().getArray()).setSkinCoordWeight(new MFFloat190().getArray()).setUlimit(new MFFloat191().getArray()).setLlimit(new MFFloat192().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_middle0").setName(new SFString("l_middle1")).setDEF(new SFString("Joe_l_middle1")).setCenter(new float[] {0.1987f ,0.7818f ,-0.053f }).setSkinCoordIndex(new MFInt32193().getArray()).setSkinCoordWeight(new MFFloat194().getArray()).setUlimit(new MFFloat195().getArray()).setLlimit(new MFFloat196().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_middle1").setName(new SFString("l_middle2")).setDEF(new SFString("Joe_l_middle2")).setCenter(new float[] {0.2013f ,0.7273f ,-0.0503f }).setSkinCoordIndex(new MFInt32197().getArray()).setSkinCoordWeight(new MFFloat198().getArray()).setUlimit(new MFFloat199().getArray()).setLlimit(new MFFloat200().getArray())
                                                                  .addChild(new HAnimJoint("Joe_l_middle2").setName(new SFString("l_middle3")).setDEF(new SFString("Joe_l_middle3")).setCenter(new float[] {0.2026f ,0.7011f ,-0.0494f }).setSkinCoordIndex(new MFInt32201().getArray()).setSkinCoordWeight(new MFFloat202().getArray()).setUlimit(new MFFloat203().getArray()).setLlimit(new MFFloat204().getArray())))))
                                                            .addChild(new HAnimJoint("Joe_l_wrist").setName(new SFString("l_ring0")).setDEF(new SFString("Joe_l_ring0")).setCenter(new float[] {0.1956f ,0.8019f ,-0.0794f }).setSkinCoordIndex(new MFInt32205().getArray()).setSkinCoordWeight(new MFFloat206().getArray()).setUlimit(new MFFloat207().getArray()).setLlimit(new MFFloat208().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_ring0").setName(new SFString("l_ring1")).setDEF(new SFString("Joe_l_ring1")).setCenter(new float[] {0.1956f ,0.7815f ,-0.0794f }).setSkinCoordIndex(new MFInt32209().getArray()).setSkinCoordWeight(new MFFloat210().getArray()).setUlimit(new MFFloat211().getArray()).setLlimit(new MFFloat212().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_ring1").setName(new SFString("l_ring2")).setDEF(new SFString("Joe_l_ring2")).setCenter(new float[] {0.1973f ,0.7287f ,-0.0777f }).setSkinCoordIndex(new MFInt32213().getArray()).setSkinCoordWeight(new MFFloat214().getArray()).setUlimit(new MFFloat215().getArray()).setLlimit(new MFFloat216().getArray())
                                                                  .addChild(new HAnimJoint("Joe_l_ring2").setName(new SFString("l_ring3")).setDEF(new SFString("Joe_l_ring3")).setCenter(new float[] {0.1983f ,0.7045f ,-0.0767f }).setSkinCoordIndex(new MFInt32217().getArray()).setSkinCoordWeight(new MFFloat218().getArray()).setUlimit(new MFFloat219().getArray()).setLlimit(new MFFloat220().getArray())))))
                                                            .addChild(new HAnimJoint("Joe_l_wrist").setName(new SFString("l_pinky0")).setDEF(new SFString("Joe_l_pinky0")).setCenter(new float[] {0.1925f ,0.8066f ,-0.1036f }).setSkinCoordIndex(new MFInt32221().getArray()).setSkinCoordWeight(new MFFloat222().getArray()).setUlimit(new MFFloat223().getArray()).setLlimit(new MFFloat224().getArray())
                                                              .addChild(new HAnimJoint("Joe_l_pinky0").setName(new SFString("l_pinky1")).setDEF(new SFString("Joe_l_pinky1")).setCenter(new float[] {0.1925f ,0.7866f ,-0.1036f }).setSkinCoordIndex(new MFInt32225().getArray()).setSkinCoordWeight(new MFFloat226().getArray()).setUlimit(new MFFloat227().getArray()).setLlimit(new MFFloat228().getArray())
                                                                .addChild(new HAnimJoint("Joe_l_pinky1").setName(new SFString("l_pinky2")).setDEF(new SFString("Joe_l_pinky2")).setCenter(new float[] {0.1938f ,0.7452f ,-0.1024f }).setSkinCoordIndex(new MFInt32229().getArray()).setSkinCoordWeight(new MFFloat230().getArray()).setUlimit(new MFFloat231().getArray()).setLlimit(new MFFloat232().getArray())
                                                                  .addChild(new HAnimJoint("Joe_l_pinky2").setName(new SFString("l_pinky3")).setDEF(new SFString("Joe_l_pinky3")).setCenter(new float[] {0.1948f ,0.7277f ,-0.1017f }).setSkinCoordIndex(new MFInt32233().getArray()).setSkinCoordWeight(new MFFloat234().getArray()).setUlimit(new MFFloat235().getArray()).setLlimit(new MFFloat236().getArray()))))))))))
                                                  .addChild(new HAnimJoint("Joe_vc7").setName(new SFString("r_sternoclavicular")).setDEF(new SFString("Joe_r_sternoclavicular")).setCenter(new float[] {-0.03f ,1.46f ,0f }).setSkinCoordIndex(new MFInt32237().getArray()).setSkinCoordWeight(new MFFloat238().getArray()).setUlimit(new MFFloat239().getArray()).setLlimit(new MFFloat240().getArray())
                                                    .addChild(new HAnimJoint("Joe_r_sternoclavicular").setName(new SFString("r_acromioclavicular")).setDEF(new SFString("Joe_r_acromioclavicular")).setCenter(new float[] {-0.09f ,1.41f ,-0.11f }).setSkinCoordIndex(new MFInt32241().getArray()).setSkinCoordWeight(new MFFloat242().getArray()).setUlimit(new MFFloat243().getArray()).setLlimit(new MFFloat244().getArray())
                                                      .addChild(new HAnimJoint("Joe_r_acromioclavicular").setName(new SFString("r_shoulder")).setDEF(new SFString("Joe_r_shoulder")).setCenter(new float[] {-0.2f ,1.44f ,-0.04f }).setSkinCoordIndex(new MFInt32245().getArray()).setSkinCoordWeight(new MFFloat246().getArray()).setUlimit(new MFFloat247().getArray()).setLlimit(new MFFloat248().getArray())
                                                        .addChild(new HAnimJoint("Joe_r_shoulder").setName(new SFString("r_elbow")).setDEF(new SFString("Joe_r_elbow")).setCenter(new float[] {-0.2f ,1.1388f ,-0.04f }).setSkinCoordIndex(new MFInt32249().getArray()).setSkinCoordWeight(new MFFloat250().getArray()).setUlimit(new MFFloat251().getArray()).setLlimit(new MFFloat252().getArray())
                                                          .addChild(new HAnimJoint("Joe_r_elbow").setName(new SFString("r_wrist")).setDEF(new SFString("Joe_r_wrist")).setCenter(new float[] {-0.2f ,0.89f ,-0.04f }).setSkinCoordIndex(new MFInt32253().getArray()).setSkinCoordWeight(new MFFloat254().getArray()).setUlimit(new MFFloat255().getArray()).setLlimit(new MFFloat256().getArray())
                                                            .addChild(new HAnimJoint("Joe_r_wrist").setName(new SFString("r_thumb1")).setDEF(new SFString("Joe_r_thumb1")).setCenter(new float[] {-0.2f ,0.85f ,0f }).setSkinCoordIndex(new MFInt32257().getArray()).setSkinCoordWeight(new MFFloat258().getArray()).setUlimit(new MFFloat259().getArray()).setLlimit(new MFFloat260().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_thumb1").setName(new SFString("r_thumb2")).setDEF(new SFString("Joe_r_thumb2")).setCenter(new float[] {-0.2f ,0.82f ,0.03f }).setSkinCoordIndex(new MFInt32261().getArray()).setSkinCoordWeight(new MFFloat262().getArray()).setUlimit(new MFFloat263().getArray()).setLlimit(new MFFloat264().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_thumb2").setName(new SFString("r_thumb3")).setDEF(new SFString("Joe_r_thumb3")).setCenter(new float[] {-0.2f ,0.8f ,0.05f }).setSkinCoordIndex(new MFInt32265().getArray()).setSkinCoordWeight(new MFFloat266().getArray()).setUlimit(new MFFloat267().getArray()).setLlimit(new MFFloat268().getArray()))))
                                                            .addChild(new HAnimJoint("Joe_r_wrist").setName(new SFString("r_index0")).setDEF(new SFString("Joe_r_index0")).setCenter(new float[] {-0.2f ,0.84f ,-0.015f }).setSkinCoordIndex(new MFInt32269().getArray()).setSkinCoordWeight(new MFFloat270().getArray()).setUlimit(new MFFloat271().getArray()).setLlimit(new MFFloat272().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_index0").setName(new SFString("r_index1")).setDEF(new SFString("Joe_r_index1")).setCenter(new float[] {-0.2f ,0.793f ,-0.015f }).setSkinCoordIndex(new MFInt32273().getArray()).setSkinCoordWeight(new MFFloat274().getArray()).setUlimit(new MFFloat275().getArray()).setLlimit(new MFFloat276().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_index1").setName(new SFString("r_index2")).setDEF(new SFString("Joe_r_index2")).setCenter(new float[] {-0.2f ,0.745f ,-0.015f }).setSkinCoordIndex(new MFInt32277().getArray()).setSkinCoordWeight(new MFFloat278().getArray()).setUlimit(new MFFloat279().getArray()).setLlimit(new MFFloat280().getArray())
                                                                  .addChild(new HAnimJoint("Joe_r_index2").setName(new SFString("r_index3")).setDEF(new SFString("Joe_r_index3")).setCenter(new float[] {-0.2f ,0.72f ,-0.015f }).setSkinCoordIndex(new MFInt32281().getArray()).setSkinCoordWeight(new MFFloat282().getArray()).setUlimit(new MFFloat283().getArray()).setLlimit(new MFFloat284().getArray())))))
                                                            .addChild(new HAnimJoint("Joe_r_wrist").setName(new SFString("r_middle0")).setDEF(new SFString("Joe_r_middle0")).setCenter(new float[] {-0.2f ,0.835f ,-0.04f }).setSkinCoordIndex(new MFInt32285().getArray()).setSkinCoordWeight(new MFFloat286().getArray()).setUlimit(new MFFloat287().getArray()).setLlimit(new MFFloat288().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_middle0").setName(new SFString("r_middle1")).setDEF(new SFString("Joe_r_middle1")).setCenter(new float[] {-0.2f ,0.788f ,-0.04f }).setSkinCoordIndex(new MFInt32289().getArray()).setSkinCoordWeight(new MFFloat290().getArray()).setUlimit(new MFFloat291().getArray()).setLlimit(new MFFloat292().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_middle1").setName(new SFString("r_middle2")).setDEF(new SFString("Joe_r_middle2")).setCenter(new float[] {-0.2f ,0.74f ,-0.04f }).setSkinCoordIndex(new MFInt32293().getArray()).setSkinCoordWeight(new MFFloat294().getArray()).setUlimit(new MFFloat295().getArray()).setLlimit(new MFFloat296().getArray())
                                                                  .addChild(new HAnimJoint("Joe_r_middle2").setName(new SFString("r_middle3")).setDEF(new SFString("Joe_r_middle3")).setCenter(new float[] {-0.2f ,0.7142f ,-0.04f }).setSkinCoordIndex(new MFInt32297().getArray()).setSkinCoordWeight(new MFFloat298().getArray()).setUlimit(new MFFloat299().getArray()).setLlimit(new MFFloat300().getArray())))))
                                                            .addChild(new HAnimJoint("Joe_r_wrist").setName(new SFString("r_ring0")).setDEF(new SFString("Joe_r_ring0")).setCenter(new float[] {-0.2f ,0.835f ,-0.065f }).setSkinCoordIndex(new MFInt32301().getArray()).setSkinCoordWeight(new MFFloat302().getArray()).setUlimit(new MFFloat303().getArray()).setLlimit(new MFFloat304().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_ring0").setName(new SFString("r_ring1")).setDEF(new SFString("Joe_r_ring1")).setCenter(new float[] {-0.2f ,0.793f ,-0.065f }).setSkinCoordIndex(new MFInt32305().getArray()).setSkinCoordWeight(new MFFloat306().getArray()).setUlimit(new MFFloat307().getArray()).setLlimit(new MFFloat308().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_ring1").setName(new SFString("r_ring2")).setDEF(new SFString("Joe_r_ring2")).setCenter(new float[] {-0.2f ,0.74f ,-0.065f }).setSkinCoordIndex(new MFInt32309().getArray()).setSkinCoordWeight(new MFFloat310().getArray()).setUlimit(new MFFloat311().getArray()).setLlimit(new MFFloat312().getArray())
                                                                  .addChild(new HAnimJoint("Joe_r_ring2").setName(new SFString("r_ring3")).setDEF(new SFString("Joe_r_ring3")).setCenter(new float[] {-0.2f ,0.7177f ,-0.065f }).setSkinCoordIndex(new MFInt32313().getArray()).setSkinCoordWeight(new MFFloat314().getArray()).setUlimit(new MFFloat315().getArray()).setLlimit(new MFFloat316().getArray())))))
                                                            .addChild(new HAnimJoint("Joe_r_wrist").setName(new SFString("r_pinky0")).setDEF(new SFString("Joe_r_pinky0")).setCenter(new float[] {-0.2f ,0.84f ,-0.085f }).setSkinCoordIndex(new MFInt32317().getArray()).setSkinCoordWeight(new MFFloat318().getArray()).setUlimit(new MFFloat319().getArray()).setLlimit(new MFFloat320().getArray())
                                                              .addChild(new HAnimJoint("Joe_r_pinky0").setName(new SFString("r_pinky1")).setDEF(new SFString("Joe_r_pinky1")).setCenter(new float[] {-0.2f ,0.79f ,-0.085f }).setSkinCoordIndex(new MFInt32321().getArray()).setSkinCoordWeight(new MFFloat322().getArray()).setUlimit(new MFFloat323().getArray()).setLlimit(new MFFloat324().getArray())
                                                                .addChild(new HAnimJoint("Joe_r_pinky1").setName(new SFString("r_pinky2")).setDEF(new SFString("Joe_r_pinky2")).setCenter(new float[] {-0.2f ,0.755f ,-0.085f }).setSkinCoordIndex(new MFInt32325().getArray()).setSkinCoordWeight(new MFFloat326().getArray()).setUlimit(new MFFloat327().getArray()).setLlimit(new MFFloat328().getArray())
                                                                  .addChild(new HAnimJoint("Joe_r_pinky2").setName(new SFString("r_pinky3")).setDEF(new SFString("Joe_r_pinky3")).setCenter(new float[] {-0.2f ,0.735f ,-0.09f }).setSkinCoordIndex(new MFInt32329().getArray()).setSkinCoordWeight(new MFFloat330().getArray()).setUlimit(new MFFloat331().getArray()).setLlimit(new MFFloat332().getArray())))))))))))))))))))))))))))))
            .addSkin(new Shape().setDEF(new SFString("Joe_Shape"))
              .setAppearance(new Appearance().setDEF(new SFString("Joe_skin_Appearance"))
                ...
                .setTexture(new ImageTexture().setDEF(new SFString("JoeSkinImageTexture")).setUrl(new MFString333().getArray()))
                .setTextureTransform(new TextureTransform().setDEF(new SFString("kicktextrans"))))
              .setGeometry(new IndexedFaceSet().setDEF(new SFString("Joe_skin_IndexedFaceSet")).setCoordIndex(new MFInt32334().getArray().append(new MFInt32335().getArray()).append(new MFInt32336().getArray()).append(new MFInt32337().getArray())).setCreaseAngle(3.14f )
                .setCoord(new Coordinate().setDEF(new SFString("Joe_SkinCoord")).setPoint(new MFVec3f338().getArray().append(new MFVec3f339().getArray())))
        ...
        .addChild(new Group()
          ...
          .addChild(new OrientationInterpolator().setDEF(new SFString("HumanoidRootRotInterp")).setKey(new MFFloat341().getArray()).setKeyValue(new MFRotation342().getArray()))
          .addChild(new PositionInterpolator().setDEF(new SFString("HumanoidRootTransInterp")).setKey(new MFFloat343().getArray()).setKeyValue(new MFVec3f344().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("sacroiliacRotInterp")).setKey(new MFFloat345().getArray()).setKeyValue(new MFRotation346().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_hipRotInterp")).setKey(new MFFloat347().getArray()).setKeyValue(new MFRotation348().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_kneeRotInterp")).setKey(new MFFloat349().getArray()).setKeyValue(new MFRotation350().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_ankleRotInterp")).setKey(new MFFloat351().getArray()).setKeyValue(new MFRotation352().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_subtalarRotInterp")).setKey(new MFFloat353().getArray()).setKeyValue(new MFRotation354().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_midtarsalRotInterp")).setKey(new MFFloat355().getArray()).setKeyValue(new MFRotation356().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_metatarsalRotInterp")).setKey(new MFFloat357().getArray()).setKeyValue(new MFRotation358().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_hipRotInterp")).setKey(new MFFloat359().getArray()).setKeyValue(new MFRotation360().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_kneeRotInterp")).setKey(new MFFloat361().getArray()).setKeyValue(new MFRotation362().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_ankleRotInterp")).setKey(new MFFloat363().getArray()).setKeyValue(new MFRotation364().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_subtalarRotInterp")).setKey(new MFFloat365().getArray()).setKeyValue(new MFRotation366().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_midtarsalRotInterp")).setKey(new MFFloat367().getArray()).setKeyValue(new MFRotation368().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_metatarsalRotInterp")).setKey(new MFFloat369().getArray()).setKeyValue(new MFRotation370().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vl5RotInterp")).setKey(new MFFloat371().getArray()).setKeyValue(new MFRotation372().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vl4RotInterp")).setKey(new MFFloat373().getArray()).setKeyValue(new MFRotation374().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vl3RotInterp")).setKey(new MFFloat375().getArray()).setKeyValue(new MFRotation376().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vl2RotInterp")).setKey(new MFFloat377().getArray()).setKeyValue(new MFRotation378().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vl1RotInterp")).setKey(new MFFloat379().getArray()).setKeyValue(new MFRotation380().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt12RotInterp")).setKey(new MFFloat381().getArray()).setKeyValue(new MFRotation382().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt11RotInterp")).setKey(new MFFloat383().getArray()).setKeyValue(new MFRotation384().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt10RotInterp")).setKey(new MFFloat385().getArray()).setKeyValue(new MFRotation386().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt9RotInterp")).setKey(new MFFloat387().getArray()).setKeyValue(new MFRotation388().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt8RotInterp")).setKey(new MFFloat389().getArray()).setKeyValue(new MFRotation390().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt7RotInterp")).setKey(new MFFloat391().getArray()).setKeyValue(new MFRotation392().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt6RotInterp")).setKey(new MFFloat393().getArray()).setKeyValue(new MFRotation394().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt5RotInterp")).setKey(new MFFloat395().getArray()).setKeyValue(new MFRotation396().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt4RotInterp")).setKey(new MFFloat397().getArray()).setKeyValue(new MFRotation398().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt3RotInterp")).setKey(new MFFloat399().getArray()).setKeyValue(new MFRotation400().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt2RotInterp")).setKey(new MFFloat401().getArray()).setKeyValue(new MFRotation402().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vt1RotInterp")).setKey(new MFFloat403().getArray()).setKeyValue(new MFRotation404().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vc7RotInterp")).setKey(new MFFloat405().getArray()).setKeyValue(new MFRotation406().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vc6RotInterp")).setKey(new MFFloat407().getArray()).setKeyValue(new MFRotation408().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vc5RotInterp")).setKey(new MFFloat409().getArray()).setKeyValue(new MFRotation410().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vc4RotInterp")).setKey(new MFFloat411().getArray()).setKeyValue(new MFRotation412().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vc3RotInterp")).setKey(new MFFloat413().getArray()).setKeyValue(new MFRotation414().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vc2RotInterp")).setKey(new MFFloat415().getArray()).setKeyValue(new MFRotation416().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("vc1RotInterp")).setKey(new MFFloat417().getArray()).setKeyValue(new MFRotation418().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("skullbaseRotInterp")).setKey(new MFFloat419().getArray()).setKeyValue(new MFRotation420().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_eyelid_jointRotInterp")).setKey(new MFFloat421().getArray()).setKeyValue(new MFRotation422().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_eyeball_jointRotInterp")).setKey(new MFFloat423().getArray()).setKeyValue(new MFRotation424().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_eyebrow_jointRotInterp")).setKey(new MFFloat425().getArray()).setKeyValue(new MFRotation426().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_eyelid_jointRotInterp")).setKey(new MFFloat427().getArray()).setKeyValue(new MFRotation428().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_eyeball_jointRotInterp")).setKey(new MFFloat429().getArray()).setKeyValue(new MFRotation430().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_eyebrow_jointRotInterp")).setKey(new MFFloat431().getArray()).setKeyValue(new MFRotation432().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("temporomandibularRotInterp")).setKey(new MFFloat433().getArray()).setKeyValue(new MFRotation434().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_sternoclavicularRotInterp")).setKey(new MFFloat435().getArray()).setKeyValue(new MFRotation436().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_acromioclavicularRotInterp")).setKey(new MFFloat437().getArray()).setKeyValue(new MFRotation438().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_shoulderRotInterp")).setKey(new MFFloat439().getArray()).setKeyValue(new MFRotation440().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_elbowRotInterp")).setKey(new MFFloat441().getArray()).setKeyValue(new MFRotation442().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_wristRotInterp")).setKey(new MFFloat443().getArray()).setKeyValue(new MFRotation444().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_thumb1RotInterp")).setKey(new MFFloat445().getArray()).setKeyValue(new MFRotation446().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_thumb2RotInterp")).setKey(new MFFloat447().getArray()).setKeyValue(new MFRotation448().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_thumb3RotInterp")).setKey(new MFFloat449().getArray()).setKeyValue(new MFRotation450().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_index0RotInterp")).setKey(new MFFloat451().getArray()).setKeyValue(new MFRotation452().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_index1RotInterp")).setKey(new MFFloat453().getArray()).setKeyValue(new MFRotation454().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_index2RotInterp")).setKey(new MFFloat455().getArray()).setKeyValue(new MFRotation456().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_index3RotInterp")).setKey(new MFFloat457().getArray()).setKeyValue(new MFRotation458().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_middle0RotInterp")).setKey(new MFFloat459().getArray()).setKeyValue(new MFRotation460().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_middle1RotInterp")).setKey(new MFFloat461().getArray()).setKeyValue(new MFRotation462().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_middle2RotInterp")).setKey(new MFFloat463().getArray()).setKeyValue(new MFRotation464().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_middle3RotInterp")).setKey(new MFFloat465().getArray()).setKeyValue(new MFRotation466().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_ring0RotInterp")).setKey(new MFFloat467().getArray()).setKeyValue(new MFRotation468().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_ring1RotInterp")).setKey(new MFFloat469().getArray()).setKeyValue(new MFRotation470().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_ring2RotInterp")).setKey(new MFFloat471().getArray()).setKeyValue(new MFRotation472().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_ring3RotInterp")).setKey(new MFFloat473().getArray()).setKeyValue(new MFRotation474().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_pinky0RotInterp")).setKey(new MFFloat475().getArray()).setKeyValue(new MFRotation476().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_pinky1RotInterp")).setKey(new MFFloat477().getArray()).setKeyValue(new MFRotation478().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_pinky2RotInterp")).setKey(new MFFloat479().getArray()).setKeyValue(new MFRotation480().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("l_pinky3RotInterp")).setKey(new MFFloat481().getArray()).setKeyValue(new MFRotation482().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_sternoclavicularRotInterp")).setKey(new MFFloat483().getArray()).setKeyValue(new MFRotation484().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_acromioclavicularRotInterp")).setKey(new MFFloat485().getArray()).setKeyValue(new MFRotation486().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_shoulderRotInterp")).setKey(new MFFloat487().getArray()).setKeyValue(new MFRotation488().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_elbowRotInterp")).setKey(new MFFloat489().getArray()).setKeyValue(new MFRotation490().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_wristRotInterp")).setKey(new MFFloat491().getArray()).setKeyValue(new MFRotation492().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_thumb1RotInterp")).setKey(new MFFloat493().getArray()).setKeyValue(new MFRotation494().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_thumb2RotInterp")).setKey(new MFFloat495().getArray()).setKeyValue(new MFRotation496().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_thumb3RotInterp")).setKey(new MFFloat497().getArray()).setKeyValue(new MFRotation498().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_index0RotInterp")).setKey(new MFFloat499().getArray()).setKeyValue(new MFRotation500().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_index1RotInterp")).setKey(new MFFloat501().getArray()).setKeyValue(new MFRotation502().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_index2RotInterp")).setKey(new MFFloat503().getArray()).setKeyValue(new MFRotation504().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_index3RotInterp")).setKey(new MFFloat505().getArray()).setKeyValue(new MFRotation506().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_middle0RotInterp")).setKey(new MFFloat507().getArray()).setKeyValue(new MFRotation508().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_middle1RotInterp")).setKey(new MFFloat509().getArray()).setKeyValue(new MFRotation510().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_middle2RotInterp")).setKey(new MFFloat511().getArray()).setKeyValue(new MFRotation512().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_middle3RotInterp")).setKey(new MFFloat513().getArray()).setKeyValue(new MFRotation514().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_ring0RotInterp")).setKey(new MFFloat515().getArray()).setKeyValue(new MFRotation516().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_ring1RotInterp")).setKey(new MFFloat517().getArray()).setKeyValue(new MFRotation518().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_ring2RotInterp")).setKey(new MFFloat519().getArray()).setKeyValue(new MFRotation520().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_ring3RotInterp")).setKey(new MFFloat521().getArray()).setKeyValue(new MFRotation522().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_pinky0RotInterp")).setKey(new MFFloat523().getArray()).setKeyValue(new MFRotation524().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_pinky1RotInterp")).setKey(new MFFloat525().getArray()).setKeyValue(new MFRotation526().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_pinky2RotInterp")).setKey(new MFFloat527().getArray()).setKeyValue(new MFRotation528().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("r_pinky3RotInterp")).setKey(new MFFloat529().getArray()).setKeyValue(new MFRotation530().getArray())))
        ...
        .addChild(new Group().setDEF(new SFString("DisplacersAnimationGroup"))
          ...
          .addChild(new ScalarInterpolator().setDEF(new SFString("skull_tipTest")).setKey(new MFFloat531().getArray()).setKeyValue(new MFFloat532().getArray()))
        ...
        .addChild(new Group().setDEF(new SFString("skintexturetransform_animation"))
          .addChild(new ScalarInterpolator().setDEF(new SFString("skinTexTransTest")).setKey(new MFFloat533().getArray()).setKeyValue(new MFFloat534().getArray()))
        ...
        .addChild(new Group()
          .addChild(new Transform().setDEF(new SFString("SBall")).setRotation(new float[] {0.7f ,0f ,0.7f ,0.1f }).setScale(new float[] {0.23f ,0.23f ,0.23f }).setTranslation(new float[] {-0.916f ,0.37f ,-0.92f })
            .addChild(new Shape().setDEF(new SFString("ball_Shape"))
              ...
              .setGeometry(new IndexedFaceSet().setDEF(new SFString("ball_IndexedFaceSet")).setCoordIndex(new MFInt32535().getArray())
                .setCoord(new Coordinate().setDEF(new SFString("Ball_Coordinates")).setPoint(new MFVec3f536().getArray()))))
          ...
          .addChild(new PositionInterpolator().setDEF(new SFString("ballTransInterp")).setKey(new MFFloat537().getArray()).setKeyValue(new MFVec3f538().getArray()))
          .addChild(new OrientationInterpolator().setDEF(new SFString("ballRotInterp")).setKey(new MFFloat539().getArray()).setKeyValue(new MFRotation540().getArray()))
        ...
        .addChild(new Group()
          ...
          .addChild(new Transform().setDEF(new SFString("Circle0")).setScale(new float[] {1.175f ,1f ,1.175f })
            .addChild(new Shape().setDEF(new SFString("circle_Shape"))
              ...
              .setGeometry(new IndexedLineSet().setDEF(new SFString("Orbit1")).setCoordIndex(new MFInt32541().getArray())
                .setCoord(new Coordinate().setDEF(new SFString("circle_Coordinates")).setPoint(new MFVec3f542().getArray())))))

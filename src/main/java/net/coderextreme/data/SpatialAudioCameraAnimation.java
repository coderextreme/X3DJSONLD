...
public class SpatialAudioCameraAnimation {
  public static void main(String[] args) {
    ...
    X3D model = new SpatialAudioCameraAnimation().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/SpatialAudioCameraAnimation.new.json");
    }
        ...
        .addChild(new Transform().setDEF("TransformAudio1").setTranslation(new float[] {-933.123474f,0f,-926.253235f})
          .addChild(new Shape("TransformAudio1")
            .setAppearance(new Appearance().setDEF("WireColor_1")
              .setMaterial(new Material("WireColor_1").setDiffuseColor(new float[] {0.690196f,0.101961f,0.101961f})))
            .setGeometry(new Sphere().setRadius(100f)))
          .addChild(new Billboard("TransformAudio1")
        ...
        .addChild(new Transform().setDEF("TransformAudio2").setTranslation(new float[] {933.475586f,0f,924.423218f})
          .addChild(new Shape("TransformAudio2")
            .setAppearance(new Appearance().setDEF("WireColor_2")
              .setMaterial(new Material("WireColor_2").setDiffuseColor(new float[] {0.105882f,0.694118f,0.580392f})))
            .setGeometry(new Sphere().setRadius(100f)))
          .addChild(new Billboard("TransformAudio2")

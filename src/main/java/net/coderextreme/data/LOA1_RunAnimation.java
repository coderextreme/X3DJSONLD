...
public class LOA1_RunAnimation implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileJSON("../data/LOA1_RunAnimation.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("LOA1_RunAnimation.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("translated")).setContent(new SFString("30 October 2001")))
        ...
        .addMeta(new meta().setName(new SFString("subject")).setContent(new SFString("Nancy Run Animation HAnim 2001")))
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/LOA1_RunAnimation.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("LOA1_RunAnimation.x3d")))
        .addChild(new ProtoDeclare().setName(new SFString("LOA1_RunAnimation"))
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType("SFTime").setName(new SFString("cycleInterval")).setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setValue(new SFString("1")))

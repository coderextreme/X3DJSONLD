...
public class JointCoordinateAxes implements X3DRoots {
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("converter")).setContent(new SFString("x3d-tidy V1.0.56, https://www.npmjs.com/package/x3d-tidy")))
        .addMeta(new meta().setName(new SFString("converted")).setContent(new SFString("Mon, 31 Jul 2023 03:48:04 GMT"))))
      .setScene(new Scene()
        .addChild(new NavigationInfo().setHeadlight(false))
        .addChild(new Group()
          .addChild(new Group().setDEF(new SFString("ARROW"))
            .addChild(new Shape()
              .setAppearance(new Appearance().setDEF(new SFString("ARROW_APPEARANCE"))
            ...
            .addChild(new Transform().setTranslation(new float[] {0f ,1f ,0f })
              .addChild(new Shape().setDEF(new SFString("ARROW_POINTER"))
                .setAppearance(new Appearance().setUSE(new SFString("ARROW_APPEARANCE")))
            ...
            .addChild(new Transform().setTranslation(new float[] {0f ,-1f ,0f }).setRotation(new float[] {1f ,0f ,0f ,3.1416f })
              .addChild(new Shape().setUSE(new SFString("ARROW_POINTER")))))
          .addChild(new Transform().setTranslation(new float[] {0f ,1.08f ,0f })
            .addChild(new Billboard()
              .addChild(new Shape()
                .setAppearance(new Appearance().setDEF(new SFString("LABEL_APPEARANCE"))
                ...
                .setGeometry(new Text().setString(new MFString0().getArray())
                  .setFontStyle(new FontStyle().setDEF(new SFString("LABEL_FONT")).setFamily(new MFString1().getArray()).setSize(0.2f ).setJustify(new MFString2().getArray())))))))
        .addChild(new Transform().setRotation(new float[] {0f ,0f ,1f ,-1.5708f })
          .addChild(new Group()
            .addChild(new Group().setUSE(new SFString("ARROW")))
            .addChild(new Transform().setTranslation(new float[] {0.072f ,1.1f ,0f }).setRotation(new float[] {0f ,0f ,1f ,1.5708f })
              .addChild(new Billboard()
                .addChild(new Shape()
                  .setAppearance(new Appearance().setUSE(new SFString("LABEL_APPEARANCE")))
                  .setGeometry(new Text().setString(new MFString3().getArray())
                    .setFontStyle(new FontStyle().setUSE(new SFString("LABEL_FONT")))))))))

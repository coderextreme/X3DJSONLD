...
public class WinterSpringMusicCreditAllTitleBox implements X3DRoots {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    ConfigurationProperties.setStripTrailingZeroes(true);
    ConfigurationProperties.setStripDefaultAttributes(true);
    X3D model = new WinterSpringMusicCreditAllTitleBox().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../data/WinterSpringMusicCreditAllTitleBox.new.java.x3d");
    model.toFileJSON("../data/WinterSpringMusicCreditAllTitleBox.new.java.x3dj");
    }
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDEF("WSAuthorsAllTitleView").setDescription("Look at Music Credit title").setPosition(new float[] {10f ,11f ,-15f }).setOrientation(new float[] {-0.15f ,0f ,0f ,0.2f }))
        .addChild(new Transform().setDEF("WSMusicCreditAllTitle").setTranslation(new float[] {10f ,10f ,-20f })
          .addChild(new Shape()
...
private class MFString0 {
  private org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"images/WSMusicCreditAll.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSMusicCreditAll.png"});
  }
}
}

...
ProtoInstance0
          .addFieldValue(new fieldValue().setName(new SFString("children"))
            .addChild(new HAnimJoint().setName(new SFString("l_shoulder")).setDEF(new SFString("PoseJoint_l_shoulder_1")).setDescription(new SFString("left shoulder")).setRotation(new float[] {0f ,0f ,1f ,1.57f }))
            .addChild(new HAnimJoint().setName(new SFString("r_shoulder")).setDEF(new SFString("PoseJoint_r_shoulder_1")).setDescription(new SFString("right shoulder")).setRotation(new float[] {0f ,0f ,-1f ,1.57f }))
...
ProtoInstance1
          .addFieldValue(new fieldValue().setName(new SFString("children"))
            .addChild(new HAnimJoint().setName(new SFString("l_shoulder")).setDEF(new SFString("PoseJoint_l_shoulder")).setDescription(new SFString("left shoulder")).setRotation(new float[] {0f ,0f ,1f ,0.5f }))
            .addChild(new HAnimJoint().setName(new SFString("r_shoulder")).setDEF(new SFString("PoseJoint_r_shoulder")).setDescription(new SFString("right shoulder")).setRotation(new float[] {0f ,0f ,-1f ,0.5f })));
ProtoInstance1
...
ProtoInstance2
          .addFieldValue(new fieldValue().setName(new SFString("children"))
            .addChild(new HAnimJoint().setName(new SFString("humanoid_root")).setRotation(new float[] {0f ,1f ,0f ,-0.698132f }))
            .addChild(new HAnimJoint().setName(new SFString("l_hip")).setRotation(new float[] {-1f ,1f ,1f ,1f }))
            .addChild(new HAnimJoint().setName(new SFString("l_knee")).setRotation(new float[] {1f ,0f ,0f ,1f }))
            .addChild(new HAnimJoint().setName(new SFString("l_talocrural")).setRotation(new float[] {-0.2f ,0f ,0.1f ,0.225f }))
            .addChild(new HAnimJoint().setName(new SFString("r_hip")).setRotation(new float[] {-1f ,-1f ,-1f ,1f }))
            .addChild(new HAnimJoint().setName(new SFString("r_knee")).setRotation(new float[] {1f ,0f ,0f ,1f }))
            .addChild(new HAnimJoint().setName(new SFString("r_talocrural")).setRotation(new float[] {-0.2f ,0f ,0.1f ,0.25f }))
            .addChild(new HAnimJoint().setName(new SFString("vl5")).setRotation(new float[] {0f ,0f ,0.01f ,0.2f }))
            .addChild(new HAnimJoint().setName(new SFString("vt10")).setRotation(new float[] {0f ,0f ,0.01f ,0.1f }))
            .addChild(new HAnimJoint().setName(new SFString("vc4")).setRotation(new float[] {0f ,0f ,-0.01f ,0.15f }))
            .addChild(new HAnimJoint().setName(new SFString("l_shoulder")).setRotation(new float[] {-1f ,0.5f ,1f ,2f }))
            .addChild(new HAnimJoint().setName(new SFString("l_elbow")).setRotation(new float[] {-1f ,0f ,0f ,1f }))
            .addChild(new HAnimJoint().setName(new SFString("l_radiocarpal")))
            .addChild(new HAnimJoint().setName(new SFString("r_shoulder")).setRotation(new float[] {-1f ,-0.5f ,-1f ,2.6f }))
            .addChild(new HAnimJoint().setName(new SFString("r_elbow")).setRotation(new float[] {-1f ,0f ,0f ,1f }))
            .addChild(new HAnimJoint().setName(new SFString("r_radiocarpal"))));
ProtoInstance2
          .addFieldValue(new fieldValue().setName(new SFString("transitionDuration")).setValue(new SFString("1.2")));
ProtoInstance2
          .addFieldValue(new fieldValue().setName(new SFString("traceEnabled")).setValue(new SFString("true")));
...
ProtoInstance5
          .addFieldValue(new fieldValue().setName(new SFString("children"))
            .addChild(new HAnimJoint().setName(new SFString("humanoid_root")).setDEF(new SFString("FaceLeft_humanoid_root")).setDescription(new SFString("Only rotate the model")).setRotation(new float[] {0f ,1f ,0f ,1.570796f })));
ProtoInstance5
...
ProtoInstance6
          .addFieldValue(new fieldValue().setName(new SFString("children"))
            .addChild(new HAnimJoint().setName(new SFString("humanoid_root")).setDEF(new SFString("FaceRight_humanoid_root")).setDescription(new SFString("Only rotate the model")).setRotation(new float[] {0f ,1f ,0f ,-1.570796f })));
ProtoInstance6
          .addFieldValue(new fieldValue().setName(new SFString("transitionDuration")).setValue(new SFString("1.1")));
ProtoInstance6
          .addFieldValue(new fieldValue().setName(new SFString("traceEnabled")).setValue(new SFString("true")));

  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("Checkerboard").setTranslation(new float[] {0f,0f,-10f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .setGeometry(new Box().setSize(new float[] {1000f,1000f,0.01f}).setSolid(true))))
        ...
        .addChild(new Transform().setDEF("EmptyImage").setRotation(new float[] {1f,1f,0f,1f}).setTranslation(new float[] {0f,5f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setAppearance(new Appearance()
              .setTexture(new PixelTexture()))
            .setGeometry(new Box().setDEF("StandardBox").setSize(new float[] {2f,2f,2f}).setSolid(true))))
        .addChild(new Viewpoint().setDescription("Black and white PixelTexture").setPosition(new float[] {-5f,0f,5f}))
        .addChild(new Transform().setDEF("BW").setRotation(new float[] {1f,1f,0f,1f}).setTranslation(new float[] {-5f,0f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setAppearance(new Appearance()
        ...
        .addChild(new Transform().setDEF("AlphaBW").setRotation(new float[] {1f,1f,0f,1f}).setTranslation(new float[] {5f,0f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setAppearance(new Appearance()
        ...
        .addChild(new Transform().setDEF("RGB").setRotation(new float[] {1f,1f,0f,1f}).setTranslation(new float[] {-5f,-5f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setAppearance(new Appearance()
        ...
        .addChild(new Transform().setDEF("AlphaRGB").setRotation(new float[] {1f,1f,0f,1f}).setTranslation(new float[] {5f,-5f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .setAppearance(new Appearance()

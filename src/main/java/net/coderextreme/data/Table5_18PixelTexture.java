  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setContent("Table5_18PixelTexture").setName("title"))
        .addMeta(new metaObject().setContent("PixelTexture example for Table 5.18").setName("description"))
        .addMeta(new metaObject().setContent("Leonard Daly and Don Brutzman").setName("creator"))
        .addMeta(new metaObject().setContent("18 December 2006").setName("created"))
        ...
        .addMeta(new metaObject().setContent("X3D, PixelTexture").setName("subject"))
        .addMeta(new metaObject().setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/Table5_18PixelTexture").setName("identifier"))

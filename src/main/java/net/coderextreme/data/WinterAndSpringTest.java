      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("OldMan_Humanoid")
          .addChild(new HAnimHumanoid("OldMan_Humanoid").setName("Walk").setDEF("OldMan").setLoa(3).setVersion("2.0")
            .setMetadata(new MetadataSet("OldMan").setName("warnings").setReference("HAnim")
            ...
            .addSkeleton(new HAnimJoint("OldMan").setName("humanoid_root").setDEF("OldMan_humanoid_root").setUlimit(new MFFloat2().getArray()).setLlimit(new MFFloat3().getArray())
              ...
              .addChild(new HAnimSegment("OldMan_humanoid_root").setName("sacrum").setDEF("OldMan_sacrum")
                .addChild(new HAnimSite("OldMan_sacrum").setName("RootBack_view").setDEF("OldMan_RootBack_view")
                  .addChild(new Transform("OldMan_RootBack_view").setDEF("hanimcordsys").setScale(new float[] {0.175f,0.175f,0.175f})
                    ...
                    .addSkin(new Shape("hanimcordsys").setDEF("OldMan_Shape")
                      .setAppearance(new Appearance("OldMan_Shape").setDEF("OldMan_skin_Appearance")
                        .setMaterial(new Material("OldMan_skin_Appearance").setDEF("OldMan_skin_Material").setDiffuseColor(new float[] {0.3f,0.3f,0.6f}).setEmissiveColor(new float[] {0.3f,0.3f,0.6f}))
                        .setTexture(new ImageTexture("OldMan_skin_Appearance").setDEF("OldManSkinImageTexture").setUrl(new MFString8().getArray()))
                        .setTextureTransform(new TextureTransform("OldMan_skin_Appearance").setDEF("KickTextureTransform")))
                      .setGeometry(new IndexedFaceSet("OldMan_Shape").setDEF("OldMan_skin_IndexedFaceSet"))))))

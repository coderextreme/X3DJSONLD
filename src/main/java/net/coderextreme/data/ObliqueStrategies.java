    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new ScriptObject().setDEF("TextScript").setUrl(new MFStringObject(new MFString6().getArray()))
          ...
          .addField(new fieldObject().setType("SFInt32").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("index for active strategy card, -1 means no selection").setName("index").setValue("0"))
          .addField(new fieldObject().setType("MFString").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("latest strategy card value").setName("string_changed"))
          .addField(new fieldObject().setType("MFString").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("\"url to invoke Google Translate\"").setName("textToSpeechUrl"))
          .addField(new fieldObject().setType("SFTime").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("activate Sound node").setName("newCardTime"))
          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setName("selectPreviousCard"))
          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setName("selectNextCard"))
          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setName("selectRandomCard"))
          .addField(new fieldObject().setType("SFBool").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("controls console tracing").setName("traceEnabled").setValue("true")))

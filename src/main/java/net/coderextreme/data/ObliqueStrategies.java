    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setScale(new float[] {0.4f,0.4f,0.4f}).setTranslation(new float[] {0f,1f,0f})
          ...
          .addChild(new Transform().setScale(new float[] {10f,3f,1f})
            .addChild(new Shape().setDEF("HeadlineClickSurface")
              .setGeometry(new IndexedFaceSet("HeadlineClickSurface").setCoordIndex(new MFInt324().getArray()).setSolid(false)
                .setCoord(new Coordinate().setPoint(new MFVec3f5().getArray())))
              .setAppearance(new Appearance("HeadlineClickSurface")
        ...
        .addChild(new Script().setDEF("TextScript").setUrl(new MFString6().getArray())
          ...
          .addField(new field("TextScript").setType("SFInt32").setName("index").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("index for active strategy card, -1 means no selection").setValue("0"))
          .addField(new field("TextScript").setType("MFString").setName("string_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setAppinfo("latest strategy card value"))
          .addField(new field("TextScript").setType("MFString").setName("textToSpeechUrl").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setAppinfo("\"url to invoke Google Translate\""))
          .addField(new field("TextScript").setType("SFTime").setName("newCardTime").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setAppinfo("activate Sound node"))
          .addField(new field("TextScript").setType("SFBool").setName("selectPreviousCard").setAccessType(field.ACCESSTYPE_INPUTONLY))
          .addField(new field("TextScript").setType("SFBool").setName("selectNextCard").setAccessType(field.ACCESSTYPE_INPUTONLY))
          .addField(new field("TextScript").setType("SFBool").setName("selectRandomCard").setAccessType(field.ACCESSTYPE_INPUTONLY))
          .addField(new field("TextScript").setType("SFBool").setName("traceEnabled").setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setAppinfo("controls console tracing").setValue("true")))
        .addChild(new Transform().setDEF("CardTransform").setScale(new float[] {0.4f,0.4f,0.4f}).setTranslation(new float[] {0f,-1.5f,0f})
          .addChild(new Shape("CardTransform")
            .setGeometry(new Text().setDEF("CardText")
              .setFontStyle(new FontStyle("CardText").setFamily(new MFString7().getArray()).setJustify(new MFString8().getArray()).setStyle("BOLD")))
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}))))
          .addChild(new ROUTE("CardTransform").setFromField("string_changed").setFromNode("TextScript").setToField("string").setToNode("CardText"))
          .addChild(new Sound("CardTransform").setDEF("CardSoundSpatialization").setMaxBack(100f).setMaxFront(100f).setMinBack(20f).setMinFront(20f)
            ...
            .setSource(new AudioClip("CardSoundSpatialization").setDEF("TextToSpeechAudioClip").setDescription("sends strategy text google translate").setUrl(new MFString9().getArray())))
          .addChild(new ROUTE("CardTransform").setFromField("textToSpeechUrl").setFromNode("TextScript").setToField("url").setToNode("TextToSpeechAudioClip"))
          .addChild(new ROUTE("CardTransform").setFromField("newCardTime").setFromNode("TextScript").setToField("startTime").setToNode("TextToSpeechAudioClip")))
        .addChild(new Transform().setScale(new float[] {0.4f,0.4f,0.4f}).setTranslation(new float[] {-3.2f,2.5f,0f})
          ...
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance().setDEF("InterfaceAppearance")
              .setMaterial(new Material("InterfaceAppearance").setDiffuseColor(new float[] {1f,0f,0.6f}))))
          .addChild(new Transform().setScale(new float[] {2f,0.6f,1f})
            .addChild(new Shape().setDEF("TransparentClickSurface")
              ...
              .setGeometry(new IndexedFaceSet("TransparentClickSurface").setCoordIndex(new MFInt3211().getArray()).setSolid(false)
                .setCoord(new Coordinate().setPoint(new MFVec3f12().getArray())))
              .setAppearance(new Appearance("TransparentClickSurface")
        ...
        .addChild(new Transform().setScale(new float[] {0.4f,0.4f,0.4f}).setTranslation(new float[] {3.3f,-0.5f,0f})
          .addChild(new Anchor().setDEF("TextToSpeechAnchor").setDescription("text to speech in browser").setParameter(new MFString15().getArray()).setUrl(new MFString16().getArray())
            .addChild(new ROUTE("TextToSpeechAnchor").setFromField("textToSpeechUrl").setFromNode("TextScript").setToField("url").setToNode("TextToSpeechAnchor"))
            .addChild(new Shape("TextToSpeechAnchor")
              .setGeometry(new Text().setString(new MFString17().getArray())
                .setFontStyle(new FontStyle().setUSE("MessageFont")))
              .setAppearance(new Appearance().setUSE("InterfaceAppearance")))
            .addChild(new Transform("TextToSpeechAnchor").setScale(new float[] {1.8f,0.6f,1f})
              .addChild(new Shape().setUSE("TransparentClickSurface"))))))      ;
    return X3D0;
    }

  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setContent("18 October 2015").setName("modified"))
        ...
        .addMeta(new metaObject().setContent("http://translate.google.com/translate_tts?tl=en&q=hello%20X3D").setName("audio"))
        .addMeta(new metaObject().setContent("translate_tts_HelloX3D.mp3").setName("audio"))
        .addMeta(new metaObject().setContent("translate_tts_HelloX3D.wav").setName("audio"))
        ...
        .addMeta(new metaObject().setContent("BSContact error: Script node TextScript: parse error: line 15 \" var strategy = [];").setName("warning"))
        .addMeta(new metaObject().setContent("http://X3dGraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategies.x3d").setName("identifier"))

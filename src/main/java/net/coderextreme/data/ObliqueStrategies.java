        ...
        .addChild(new Transform().setScale(new float[] {0.4f,0.4f,0.4f}).setTranslation(new float[] {0f,1f,0f})
          ...
          .addChild(new Shape()
            .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray()))
              .setFontStyle(new FontStyle().setDEF("MessageFont").setFamily(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())).setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())).setCssStyle("BOLD")))
        ...
        .addChild(new Transform().setDEF("CardTransform").setScale(new float[] {0.4f,0.4f,0.4f}).setTranslation(new float[] {0f,-1.5f,0f})
          .addChild(new Shape()
            .setGeometry(new Text().setDEF("CardText")
              .setFontStyle(new FontStyle().setFamily(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray())).setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray())).setCssStyle("BOLD")))
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(new float[] {1f,1f,1f}))))

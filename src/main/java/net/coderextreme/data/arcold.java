...
ProtoInstanceObject ProtoInstance12 = null;
      ...
      .setScene(new SceneObject()
        .addChild(new ViewpointObject().setPosition(new float[] {0f,0f,5f}).setOrientation(new float[] {0f,0f,1f,0f}).setDescription("a moving graph"))
...
"		}"))
        ...
        .addChild(new ProtoDeclareObject().setName("x3dconnector")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setType("SFNode").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("startnode"))
            .addField(new fieldObject().setType("SFNode").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("endnode"))
            .addField(new fieldObject().setType("SFNode").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("transnode"))
            .addField(new fieldObject().setType("SFNode").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("rotscalenode"))

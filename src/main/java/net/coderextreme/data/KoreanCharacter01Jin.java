...
public class KoreanCharacter01Jin {
  public static void main(String[] args) {
    ...
    X3D model = new KoreanCharacter01Jin().initialize();
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setCenterOfRotation(new float[] {0f,1f,0f}).setDescription("Jin").setPosition(new float[] {0f,1f,3f}))
        .addChild(new HAnimHumanoid().setName("Jin").setDEF("hanim_Jin").setScale(new float[] {0.0225f,0.0225f,0.0225f}).setVersion("2.0")
          ...
          .setMetadata(new MetadataSet("hanim_Jin").setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
          ...
          .addSkeleton(new HAnimJoint("hanim_Jin").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f,35.799999f,-0.7076f}).setUlimit(new MFFloat6().getArray()).setLlimit(new MFFloat7().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {4.207f,32.02f,-0.8155f}).setUlimit(new MFFloat13().getArray()).setLlimit(new MFFloat14().getArray())
              .addChild(new HAnimSegment("hanim_l_hip").setName("l_thigh").setDEF("hanim_l_thigh")
                .addChild(new Transform("hanim_l_thigh").setTranslation(new float[] {4.207f,32.02f,-0.8155f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
              ...
              .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {4.116f,17.26f,-0.8639f}).setUlimit(new MFFloat19().getArray()).setLlimit(new MFFloat20().getArray())
                ...
                .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new float[] {3.854f,3.939f,-0.7038f}).setUlimit(new MFFloat25().getArray()).setLlimit(new MFFloat26().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new float[] {3.854f,3.64f,0.7402f}).setUlimit(new MFFloat31().getArray()).setLlimit(new MFFloat32().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-4.207f,32.02f,-0.8155f}).setUlimit(new MFFloat37().getArray()).setLlimit(new MFFloat38().getArray())
              .addChild(new HAnimSegment("hanim_r_hip").setName("r_thigh").setDEF("hanim_r_thigh")
                .addChild(new Transform("hanim_r_thigh").setTranslation(new float[] {-4.207f,32.02f,-0.8155f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                      .setTexture(new ImageTexture().setUSE("JinTextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-4.116f,17.26f,-0.8639f}).setUlimit(new MFFloat43().getArray()).setLlimit(new MFFloat44().getArray())
                ...
                .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-3.854f,3.939f,-0.7038f}).setUlimit(new MFFloat49().getArray()).setLlimit(new MFFloat50().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new float[] {-3.854f,3.64f,0.7402f}).setUlimit(new MFFloat55().getArray()).setLlimit(new MFFloat56().getArray())
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new float[] {0f,30.530001f,-0.7076f}).setUlimit(new MFFloat61().getArray()).setLlimit(new MFFloat62().getArray())
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {5.975f,52f,-0.1452f}).setUlimit(new MFFloat67().getArray()).setLlimit(new MFFloat68().getArray())
                .addChild(new HAnimSegment("hanim_l_shoulder").setName("l_upperarm").setDEF("hanim_l_upperarm")
                  .addChild(new Transform("hanim_l_upperarm").setTranslation(new float[] {5.975f,52f,-0.1452f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JinTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {8.093f,40.380001f,-0.2502f}).setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {7.808f,31.459999f,-0.05849f}).setUlimit(new MFFloat79().getArray()).setLlimit(new MFFloat80().getArray())
                    .addChild(new HAnimSegment("hanim_l_radiocarpal").setName("l_carpal").setDEF("hanim_l_carpal")
                      .addChild(new Transform("hanim_l_carpal").setTranslation(new float[] {7.808f,31.459999f,-0.05849f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("JinTextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-5.975f,52f,-0.1452f}).setUlimit(new MFFloat85().getArray()).setLlimit(new MFFloat86().getArray())
                .addChild(new HAnimSegment("hanim_r_shoulder").setName("r_upperarm").setDEF("hanim_r_upperarm")
                  .addChild(new Transform("hanim_r_upperarm").setTranslation(new float[] {-5.975f,52f,-0.1452f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JinTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-8.093f,40.380001f,-0.2502f}).setUlimit(new MFFloat91().getArray()).setLlimit(new MFFloat92().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-7.808f,31.459999f,-0.05849f}).setUlimit(new MFFloat97().getArray()).setLlimit(new MFFloat98().getArray())
                    .addChild(new HAnimSegment("hanim_r_radiocarpal").setName("r_carpal").setDEF("hanim_r_carpal")
                      .addChild(new Transform("hanim_r_carpal").setTranslation(new float[] {-7.808f,31.459999f,-0.05849f})
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                            .setTexture(new ImageTexture().setUSE("JinTextureAtlas")))
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f,40.23f,-0.8527f}).setUlimit(new MFFloat103().getArray()).setLlimit(new MFFloat104().getArray())
                .addChild(new HAnimSegment("hanim_vl5").setName("l5").setDEF("hanim_l5")
                  .addChild(new Transform("hanim_l5").setTranslation(new float[] {0f,40.23f,-0.8527f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JinTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f,57.43f,-0.6863f}).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())
          ...
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_humanoid_root"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_sacroiliac"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_skullbase"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_vl5"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_l_elbow"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_r_elbow"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_l_hip"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_r_hip"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_l_knee"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_r_knee"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_l_metatarsophalangeal_2"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_r_metatarsophalangeal_2"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_l_radiocarpal"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_r_radiocarpal"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_l_shoulder"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_r_shoulder"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_l_talocrural"))
          .addJoints(new HAnimJoint("hanim_Jin").setUSE("hanim_r_talocrural"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_l5"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_pelvis"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_sacrum"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_skull"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_l_calf"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_r_calf"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_l_carpal"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_r_carpal"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_l_forearm"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_r_forearm"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_l_talus"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_r_talus"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_l_tarsal_proximal_phalanx_2"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_r_tarsal_proximal_phalanx_2"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_l_thigh"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_r_thigh"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_l_upperarm"))
          .addSegments(new HAnimSegment("hanim_Jin").setUSE("hanim_r_upperarm"))))      ;
    return X3D0;
    }
...
protected class MFVec3f83 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {1.247f,0.07f,0.7975f,1.209f,0.0872f,-1.349f,-0.7098f,-0.0015f,0.8912f,-0.7183f,0.0002f,-1.283f,-0.9295f,-0.613f,1.478f,1.647f,-0.4252f,1.388f,1.589f,-0.3921f,-1.989f,-1.044f,-0.5947f,-1.984f,-0.8227f,-2.521f,2.408f,1.951f,-2.334f,2.08f,1.892f,-2.301f,-2.409f,-1.192f,-2.614f,-2.248f,-0.5703f,-3.958f,1.694f,0.8836f,-4.2f,1.75f,0.8251f,-4.167f,-2.071f,-0.7842f,-3.968f,-1.934f,-1.037f,-0.5968f,-0.1872f,-1.642f,-2.561f,1.941f,-1.951f,-0.9492f,0.058f,-1.914f,-1.016f,1.885f,-1.649f,-2.56f,0.1377f,-1.066f,-2.61f,-0.2014f,1.209f,0.0872f,-1.349f,-0.7183f,0.0002f,-1.283f,-0.7098f,-0.0015f,0.8912f,1.247f,0.07f,0.7975f,1.209f,0.0872f,-1.349f,-0.7098f,-0.0015f,0.8912f});
  }
}

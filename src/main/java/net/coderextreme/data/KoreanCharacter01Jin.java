      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Jin").setDEF("hanim_Jin").setScale(new float[] {0.0225f,0.0225f,0.0225f}).setVersion("2.0")
          ...
          .addSkeleton(new HAnimJoint().setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f,35.799999f,-0.7076f}).setUlimit(new MFFloat6().getArray()).setLlimit(new MFFloat7().getArray())
            ...
            .addChild(new HAnimJoint().setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {4.207f,32.02f,-0.8155f}).setUlimit(new MFFloat13().getArray()).setLlimit(new MFFloat14().getArray())
              ...
              .addChild(new HAnimJoint().setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {4.116f,17.26f,-0.8639f}).setUlimit(new MFFloat19().getArray()).setLlimit(new MFFloat20().getArray())
                ...
                .addChild(new HAnimJoint().setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new float[] {3.854f,3.939f,-0.7038f}).setUlimit(new MFFloat25().getArray()).setLlimit(new MFFloat26().getArray())
                  ...
                  .addChild(new HAnimJoint().setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new float[] {3.854f,3.64f,0.7402f}).setUlimit(new MFFloat31().getArray()).setLlimit(new MFFloat32().getArray())
            ...
            .addChild(new HAnimJoint().setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-4.207f,32.02f,-0.8155f}).setUlimit(new MFFloat37().getArray()).setLlimit(new MFFloat38().getArray())
              ...
              .addChild(new HAnimJoint().setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-4.116f,17.26f,-0.8639f}).setUlimit(new MFFloat43().getArray()).setLlimit(new MFFloat44().getArray())
                ...
                .addChild(new HAnimJoint().setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-3.854f,3.939f,-0.7038f}).setUlimit(new MFFloat49().getArray()).setLlimit(new MFFloat50().getArray())
                  ...
                  .addChild(new HAnimJoint().setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new float[] {-3.854f,3.64f,0.7402f}).setUlimit(new MFFloat55().getArray()).setLlimit(new MFFloat56().getArray())
            ...
            .addChild(new HAnimJoint().setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new float[] {0f,30.530001f,-0.7076f}).setUlimit(new MFFloat61().getArray()).setLlimit(new MFFloat62().getArray())
              ...
              .addChild(new HAnimJoint().setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {5.975f,52f,-0.1452f}).setUlimit(new MFFloat67().getArray()).setLlimit(new MFFloat68().getArray())
                ...
                .addChild(new HAnimJoint().setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {8.093f,40.380001f,-0.2502f}).setUlimit(new MFFloat73().getArray()).setLlimit(new MFFloat74().getArray())
                  ...
                  .addChild(new HAnimJoint().setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {7.808f,31.459999f,-0.05849f}).setUlimit(new MFFloat79().getArray()).setLlimit(new MFFloat80().getArray())
              ...
              .addChild(new HAnimJoint().setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-5.975f,52f,-0.1452f}).setUlimit(new MFFloat85().getArray()).setLlimit(new MFFloat86().getArray())
                ...
                .addChild(new HAnimJoint().setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-8.093f,40.380001f,-0.2502f}).setUlimit(new MFFloat91().getArray()).setLlimit(new MFFloat92().getArray())
                  ...
                  .addChild(new HAnimJoint().setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-7.808f,31.459999f,-0.05849f}).setUlimit(new MFFloat97().getArray()).setLlimit(new MFFloat98().getArray())
              ...
              .addChild(new HAnimJoint().setName("vl5").setDEF("hanim_vl5").setCenter(new float[] {0f,40.23f,-0.8527f}).setUlimit(new MFFloat103().getArray()).setLlimit(new MFFloat104().getArray())
                ...
                .addChild(new HAnimJoint().setName("skullbase").setDEF("hanim_skullbase").setCenter(new float[] {0f,57.43f,-0.6863f}).setUlimit(new MFFloat111().getArray()).setLlimit(new MFFloat112().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new float[] {0f,57.43f,-0.6863f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("JinTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt32113().getArray().append(new MFInt32114().getArray()).append(new MFInt32115().getArray())).setCreaseAngle(1.5700f).setTexCoordIndex(new MFInt32116().getArray().append(new MFInt32117().getArray()).append(new MFInt32118().getArray()))
...
protected class MFVec3f71 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {2.5250f,1.2460f,-1.6800f,3.6810f,1.2360f,0.0337f,2.4080f,1.2470f,1.6630f,0.4657f,1.2640f,0.9556f,0.5379f,1.2640f,-1.1100f,2.7430f,-0.0209f,-2.3100f,4.3390f,-0.0351f,0.0570f,2.5810f,-0.0195f,2.3070f,-0.1009f,0.0044f,1.3300f,-0.0013f,0.0035f,-1.5230f,2.7200f,-2.5340f,-2.3100f,4.3170f,-2.5480f,0.0570f,2.5590f,-2.5330f,2.3070f,-0.1233f,-2.5090f,1.3300f,-0.0237f,-2.5100f,-1.5230f,2.7590f,-3.6090f,-2.4420f,4.4480f,-3.6240f,0.0619f,2.5880f,-3.6080f,2.4420f,-0.2497f,-3.5830f,1.4090f,-0.1443f,-3.5830f,-1.6100f,2.2450f,-1.7580f,-1.9390f,3.4650f,-1.7690f,-0.4543f,2.8340f,-1.7630f,1.6290f,1.2230f,-1.7490f,1.4320f,0.8596f,-1.7460f,-0.7734f,2.2630f,-7.5660f,-1.5690f,3.5310f,-7.5770f,-0.3780f,2.8750f,-7.5710f,1.2930f,1.2020f,-7.5560f,1.1350f,0.8242f,-7.5530f,-0.6339f,2.2670f,-11.6200f,-1.5110f,3.4870f,-11.6300f,-0.3651f,2.8560f,-11.6200f,1.2430f,1.2450f,-11.6100f,1.0910f,0.8817f,-11.6000f,-0.6115f,2.2130f,-12.1700f,-0.8985f,2.9280f,-12.1700f,-0.2266f,2.5580f,-12.1700f,0.7161f,1.6140f,-12.1600f,0.6268f,1.4010f,-12.1600f,-0.3711f});
  }
}
...
protected class MFVec3f109 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {0
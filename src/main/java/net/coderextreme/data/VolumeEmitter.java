  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new OrthoViewpoint().setDescription("OrthoViewpoint").setFieldOfView(new double[] {-1.5,-1.5,1.5,1.5}))
        .addChild(new Viewpoint().setDescription("Viewpoint").setPosition(new double[] {0,0,8}))
        .addChild(new ParticleSystem().setGeometryType("POINT").setMaxParticles(100000).setParticleLifetime(60).setLifetimeVariation(0.01).setParticleSize(new double[] {0.1,0.1}).setColorKey(new MFFloat5().getArray())
          .setEmitter(new VolumeEmitter().setDirection(new double[] {0,0,0}).setMass(0.01).setSurfaceArea(0.01)
            .setCoord(new Coordinate().setPoint(new MFVec3f6().getArray().append(new MFVec3f7().getArray()))))
        ...
        .addChild(new Transform().setDEF("IndexedLineSet")
          .addChild(new Shape()
            .setGeometry(new IndexedLineSet().setColorPerVertex(false).setColorIndex(new MFInt328().getArray()).setCoordIndex(new MFInt329().getArray())
              .setColor(new Color().setColor(new MFColor10().getArray()))

  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("modified").setContent("Sat, 30 Dec 2023 07:50:57 GMT"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_Ju").setName("Ju").setScale(new float[] {0.0225f,0.0225f,0.0225f})
              ...
              .addChild(new Transform().setTranslation(new float[] {0f,36f,-0.008798f})
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("JuTextureAtlas").setUrl(new MFString2().getArray())))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_l_hip").setName("l_hip").setCenter(new float[] {3.22f,33.62f,-0.2832f})
              ...
              .addChild(new HAnimJoint("hanim_l_hip").setDEF("hanim_l_knee").setName("l_knee").setCenter(new float[] {3.454f,18.67f,-0.02158f})
                ...
                .addChild(new HAnimJoint("hanim_l_knee").setDEF("hanim_l_talocrural").setName("l_talocrural").setCenter(new float[] {3.467f,3.522f,0.118f})
                  ...
                  .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(new float[] {3.467f,3.251f,1.465f})
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-3.22f,33.62f,-0.2832f})
              ...
              .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-3.454f,18.67f,-0.02158f})
                ...
                .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_talocrural").setName("r_talocrural").setCenter(new float[] {-3.679f,3.522f,0.118f})
                  ...
                  .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_metatarsophalangeal_2").setName("r_metatarsophalangeal_2").setCenter(new float[] {-3.679f,3.251f,1.465f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0.000025f,39.84f,0.1163f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JuTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3267().getArray()).setCoordIndex(new MFInt3268().getArray())
                    ...
                    .addChild(new Transform().setTranslation(new float[] {0.000025f,56.07f,-1.554f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("JuTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3271().getArray().append(new MFInt3272().getArray())).setCoordIndex(new MFInt3273().getArray().append(new MFInt3274().getArray()))

  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("Ju").setPosition(new float[] {0f,1f,3f}).setCenterOfRotation(new float[] {0f,1f,0f}))
        .addChild(new HAnimHumanoid().setDEF("hanim_Ju").setVersion("2.0").setName("Ju").setScale(new float[] {0.0225f,0.0225f,0.0225f})
          .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            .setMetadata(new MetadataString().setName("humanoidVersion").setValue(new MFString0().getArray())))
          .addSkeleton(new HAnimJoint("hanim_Ju").setDEF("hanim_humanoid_root").setName("humanoid_root").setCenter(new float[] {0f,36f,-0.008798f})
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_l_hip").setName("l_hip").setCenter(new float[] {3.22f,33.62f,-0.2832f})
              .addChild(new HAnimSegment("hanim_l_hip").setDEF("hanim_l_thigh").setName("l_thigh")
                .addChild(new Transform().setTranslation(new float[] {3.22f,33.62f,-0.2832f})
                  .addChild(new Shape()
                    .setAppearance(new Appearance()
                      .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
              ...
              .addChild(new HAnimJoint("hanim_l_hip").setDEF("hanim_l_knee").setName("l_knee").setCenter(new float[] {3.454f,18.67f,-0.02158f})
                ...
                .addChild(new HAnimJoint("hanim_l_knee").setDEF("hanim_l_talocrural").setName("l_talocrural").setCenter(new float[] {3.467f,3.522f,0.118f})
                  ...
                  .addChild(new HAnimJoint("hanim_l_talocrural").setDEF("hanim_l_metatarsophalangeal_1").setName("l_metatarsophalangeal_2").setCenter(new float[] {3.467f,3.251f,1.465f})
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_r_hip").setName("r_hip").setCenter(new float[] {-3.22f,33.62f,-0.2832f})
              ...
              .addChild(new HAnimJoint("hanim_r_hip").setDEF("hanim_r_knee").setName("r_knee").setCenter(new float[] {-3.454f,18.67f,-0.02158f})
                ...
                .addChild(new HAnimJoint("hanim_r_knee").setDEF("hanim_r_talocrural").setName("r_talocrural").setCenter(new float[] {-3.679f,3.522f,0.118f})
                  ...
                  .addChild(new HAnimJoint("hanim_r_talocrural").setDEF("hanim_r_metatarsophalangeal_1").setName("r_metatarsophalangeal_2").setCenter(new float[] {-3.679f,3.251f,1.465f})
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(new float[] {0.000034f,31.26f,-0.008798f})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_l_shoulder").setName("l_shoulder").setCenter(new float[] {4.778f,51.03f,-2.069f})
                .addChild(new HAnimSegment("hanim_l_shoulder").setDEF("hanim_l_upperarm").setName("l_upperarm")
                  .addChild(new Transform().setTranslation(new float[] {4.778f,51.03f,-2.069f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JuTextureAtlas")))
                ...
                .addChild(new HAnimJoint("hanim_l_shoulder").setDEF("hanim_l_elbow").setName("l_elbow").setCenter(new float[] {5.297f,40.12f,-2.055f})
                  .addChild(new HAnimSegment("hanim_l_elbow").setDEF("hanim_l_forearm").setName("l_forearm")
                    .addChild(new Transform().setTranslation(new float[] {5.297f,40.12f,-2.055f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("JuTextureAtlas")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_elbow").setDEF("hanim_l_radiocarpal").setName("l_radiocarpal").setCenter(new float[] {5.07f,31.99f,-1.559f})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_r_shoulder").setName("r_shoulder").setCenter(new float[] {-4.778f,51.03f,-2.069f})
                ...
                .addChild(new HAnimJoint("hanim_r_shoulder").setDEF("hanim_r_elbow").setName("r_elbow").setCenter(new float[] {-5.297f,40.12f,-2.055f})
                  ...
                  .addChild(new HAnimJoint("hanim_r_elbow").setDEF("hanim_r_radiocarpal").setName("r_radiocarpal").setCenter(new float[] {-5.07f,31.99f,-1.559f})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setDEF("hanim_vl5").setName("vl5").setCenter(new float[] {0.000025f,39.84f,0.1163f})
                  ...
                  .addChild(new Transform().setTranslation(new float[] {0.000025f,39.84f,0.1163f})
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                        .setTexture(new ImageTexture().setUSE("JuTextureAtlas")))
                      .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3266().getArray()).setCoordIndex(new MFInt3267().getArray())
                        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f68().getArray()))
                        .setCoord(new Coordinate().setPoint(new MFVec3f69().getArray()))))))
                .addChild(new HAnimJoint("hanim_vl5").setDEF("hanim_skullbase").setName("skullbase").setCenter(new float[] {0.000025f,56.07f,-1.554f})
                    ...
                    .addChild(new Transform().setTranslation(new float[] {0.000025f,56.07f,-1.554f})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new float[] {0.588f,0.588f,0.588f}))
                          .setTexture(new ImageTexture().setUSE("JuTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCreaseAngle(1.57f).setTexCoordIndex(new MFInt3270().getArray().append(new MFInt3271().getArray())).setCoordIndex(new MFInt3272().getArray().append(new MFInt3273().getArray()))
          ...
          .addSegments(new HAnimSegment("hanim_Ju").setUSE("hanim_l_tarsal_proximal_phalanx_1"))
          .addSegments(new HAnimSegment("hanim_Ju").setUSE("hanim_r_tarsal_proximal_phalanx_1"))
          ...
          .addJoints(new HAnimJoint("hanim_Ju").setUSE("hanim_l_metatarsophalangeal_1"))
          .addJoints(new HAnimJoint("hanim_Ju").setUSE("hanim_r_metatarsophalangeal_1"))

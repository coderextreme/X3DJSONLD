          ...
          .addSkeleton(new HAnimJoint().setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f,36f,-0.008798f}).setStiffness(new float[] {0f,0f,0f})
            ...
            .addChild(new HAnimJoint().setName("l_hip").setDEF("hanim_l_hip").setCenter(new float[] {3.22f,33.619999f,-0.2832f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addChild(new HAnimJoint().setName("l_knee").setDEF("hanim_l_knee").setCenter(new float[] {3.454f,18.67f,-0.02158f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new float[] {3.467f,3.522f,0.118f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new float[] {3.467f,3.251f,1.465f}).setStiffness(new float[] {0f,0f,0f})
            ...
            .addChild(new HAnimJoint().setName("r_hip").setDEF("hanim_r_hip").setCenter(new float[] {-3.22f,33.619999f,-0.2832f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addChild(new HAnimJoint().setName("r_knee").setDEF("hanim_r_knee").setCenter(new float[] {-3.454f,18.67f,-0.02158f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new float[] {-3.679f,3.522f,0.118f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new float[] {-3.679f,3.251f,1.465f}).setStiffness(new float[] {0f,0f,0f})
            ...
            .addChild(new HAnimJoint().setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new float[] {0.000034f,31.26f,-0.008798f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addChild(new HAnimJoint().setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new float[] {4.778f,51.029999f,-2.069f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new float[] {5.297f,40.119999f,-2.055f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new float[] {5.07f,31.99f,-1.559f}).setStiffness(new float[] {0f,0f,0f})
              ...
              .addChild(new HAnimJoint().setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new float[] {-4.778f,51.029999f,-2.069f}).setStiffness(new float[] {0f,0f,0f})
                ...
                .addChild(new HAnimJoint().setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new float[] {-5.297f,40.119999f,-2.055f}).setStiffness(new float[] {0f,0f,0f})
                  ...
                  .addChild(new HAnimJoint().setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new float[] {-5.07f,31.99f,-1.559f}).setStiffness(new float[] {0f,0f,0f})

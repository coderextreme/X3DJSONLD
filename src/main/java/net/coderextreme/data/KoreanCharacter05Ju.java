    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Ju").setDEF("hanim_Ju").setScale(new double[] {0.0225,0.0225,0.0225}).setVersion("2.0")
          ...
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_Ju").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new double[] {0,36,-0.008798}).setContainerFieldOverride("skeleton"))
              ...
              .addChild(new Transform().setTranslation(new double[] {0,36,-0.008798})
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    ...
                    .setTexture(new ImageTexture().setDEF("JuTextureAtlas").setUrl(new MFString6().getArray())))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("l_hip").setDEF("hanim_l_hip").setCenter(new double[] {3.22,33.619999,-0.2832})
              ...
              .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new double[] {3.454,18.67,-0.02158})
                ...
                .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new double[] {3.467,3.522,0.118})
                  ...
                  .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new double[] {3.467,3.251,1.465})
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("r_hip").setDEF("hanim_r_hip").setCenter(new double[] {-3.22,33.619999,-0.2832})
              ...
              .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new double[] {-3.454,18.67,-0.02158})
                ...
                .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new double[] {-3.679,3.522,0.118})
                  ...
                  .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new double[] {-3.679,3.251,1.465})
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new double[] {0.000034,31.26,-0.008798})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new double[] {4.778,51.029999,-2.069})
                ...
                .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new double[] {5.297,40.119999,-2.055})
                  ...
                  .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new double[] {5.07,31.99,-1.559})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new double[] {-4.778,51.029999,-2.069})
                ...
                .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new double[] {-5.297,40.119999,-2.055})
                  ...
                  .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new double[] {-5.07,31.99,-1.559})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("vl5").setDEF("hanim_vl5").setCenter(new double[] {0.000025,39.84,0.1163})
                ...
                .addChild(new HAnimJoint("hanim_vl5").setName("skullbase").setDEF("hanim_skullbase").setCenter(new double[] {0.000025,56.07,-1.554})
                    ...
                    .addChild(new Transform().setTranslation(new double[] {0.000025,56.07,-1.554})
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setDiffuseColor(new double[] {0.588,0.588,0.588}))
                          .setTexture(new ImageTexture().setUSE("JuTextureAtlas")))
                        .setGeometry(new IndexedFaceSet().setCoordIndex(new MFInt3275().getArray().append(new MFInt3276().getArray())).setCreaseAngle(1.57).setTexCoordIndex(new MFInt3277().getArray().append(new MFInt3278().getArray()))

...
ProtoInstance ProtoInstance34 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group()
          ...
          .addChild(new Anchor().setDescription("Back to front view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString37().getArray()))
            .addChild(new Transform().setTranslation(new float[] {0f,0f,-0.5f})
              .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString38().getArray())))))
          ...
          .addChild(new Transform().setTranslation(new float[] {-3.75f,3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco00 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString39().getArray()))
              .addChild(new Shape()
            ...
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco00").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString40().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString41().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
          ...
          .addChild(new Transform().setTranslation(new float[] {-2.25f,3.75f,0f})
            ...
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco01").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString46().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString47().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
          ...
          .addChild(new Transform().setTranslation(new float[] {-0.75f,3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco02 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString49().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance2 = new ProtoInstance().setName("ArtDeco02")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco02").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString50().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString51().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {0.75f,3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco03 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString53().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance3 = new ProtoInstance().setName("ArtDeco03")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco03").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString54().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString55().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {2.25f,3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco04 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString57().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance4 = new ProtoInstance().setName("ArtDeco04")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco04").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString58().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString59().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {3.75f,3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco05 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString61().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance5 = new ProtoInstance().setName("ArtDeco05")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco05").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString62().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString63().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-3.75f,2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco06 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString65().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance6 = new ProtoInstance().setName("ArtDeco06")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco06").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString66().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString67().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-2.25f,2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco07 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString69().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance7 = new ProtoInstance().setName("ArtDeco07")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco07").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString70().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString71().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-0.75f,2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco08 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString73().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance8 = new ProtoInstance().setName("ArtDeco08")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco08").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString74().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString75().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {0.75f,2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco09 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString77().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance9 = new ProtoInstance().setName("ArtDeco09")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco09").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString78().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString79().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {2.25f,2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco10 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString81().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance10 = new ProtoInstance().setName("ArtDeco10")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco10").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString82().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString83().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {3.75f,2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco11 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString85().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance11 = new ProtoInstance().setName("ArtDeco11")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco11").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString86().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString87().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-3.75f,0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco12 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString89().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance12 = new ProtoInstance().setName("ArtDeco12")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco12").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString90().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString91().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-2.25f,0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco13 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString93().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance13 = new ProtoInstance().setName("ArtDeco13")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco13").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString94().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString95().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-0.75f,0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco14 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString97().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance14 = new ProtoInstance().setName("ArtDeco14")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco14").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString98().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString99().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {0.75f,0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco15 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString101().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance15 = new ProtoInstance().setName("ArtDeco15")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco15").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString102().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString103().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {2.25f,0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco16 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString105().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance16 = new ProtoInstance().setName("ArtDeco16")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco16").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString106().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString107().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {3.75f,0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco17 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString109().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance17 = new ProtoInstance().setName("ArtDeco17")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco17").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString110().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString111().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-3.75f,-0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco18 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString113().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance18 = new ProtoInstance().setName("ArtDeco18")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco18").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString114().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString115().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-2.25f,-0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco19 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString117().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance19 = new ProtoInstance().setName("ArtDeco19")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco19").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString118().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString119().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-0.75f,-0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco20 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString121().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance20 = new ProtoInstance().setName("ArtDeco20")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco20").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString122().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString123().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {0.75f,-0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco21 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString125().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance21 = new ProtoInstance().setName("ArtDeco21")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco21").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString126().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString127().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {2.25f,-0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco22 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString129().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance22 = new ProtoInstance().setName("ArtDeco22")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco22").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString130().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString131().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {3.75f,-0.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco23 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString133().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance23 = new ProtoInstance().setName("ArtDeco23")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco23").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString134().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString135().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-3.75f,-2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco24 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString137().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance24 = new ProtoInstance().setName("ArtDeco24")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco24").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString138().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString139().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-2.25f,-2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco25 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString141().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance25 = new ProtoInstance().setName("ArtDeco25")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco25").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString142().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString143().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-0.75f,-2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco26 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString145().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance26 = new ProtoInstance().setName("ArtDeco26")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco26").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString146().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString147().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {0.75f,-2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco27 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString149().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance27 = new ProtoInstance().setName("ArtDeco27")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco27").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString150().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString151().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {2.25f,-2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco28 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString153().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance28 = new ProtoInstance().setName("ArtDeco28")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco28").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString154().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString155().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {3.75f,-2.25f,0f})
            .addChild(new Anchor().setDescription("ArtDeco29 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString157().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance29 = new ProtoInstance().setName("ArtDeco29")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco29").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString158().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString159().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-3.75f,-3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco30 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString161().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance30 = new ProtoInstance().setName("ArtDeco30")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco30").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString162().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString163().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-2.25f,-3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco31 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString165().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance31 = new ProtoInstance().setName("ArtDeco31")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco31").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString166().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString167().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {-0.75f,-3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco32 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString169().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance32 = new ProtoInstance().setName("ArtDeco32")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco32").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString170().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString171().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {0.75f,-3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco33 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString173().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance33 = new ProtoInstance().setName("ArtDeco33")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco33").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString174().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString175().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
          ...
          .addChild(new Transform().setTranslation(new float[] {2.25f,-3.75f,0f})
            .addChild(new Anchor().setDescription("ArtDeco34 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString177().getArray()))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance34 = new ProtoInstance().setName("ArtDeco34")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f})
              .addChild(new Anchor().setDescription("ArtDeco34").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString178().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString179().getArray()))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))

...
ProtoInstance ProtoInstance34 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new ExternProtoDeclare().setName("ArtDeco00").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString0().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco01").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco02").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco03").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco04").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco05").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString5().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco06").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString6().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco07").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString7().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco08").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString8().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco09").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString9().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco10").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString10().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco11").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString11().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco12").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString12().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco13").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString13().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco14").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString14().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco15").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString15().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco16").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString16().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco17").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString17().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco18").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString18().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco19").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString19().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco20").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString20().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco21").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString21().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco22").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString22().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco23").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString23().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco24").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString24().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco25").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString25().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco26").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString26().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco27").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString27().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco28").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString28().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco29").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString29().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco30").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString30().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco31").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString31().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco32").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString32().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco33").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString33().getArray())))
        .addChild(new ExternProtoDeclare().setName("ArtDeco34").setAppinfo("UniversalMediaMaterials prototype").setDocumentation("https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString34().getArray())))
        .addChild(new Group().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
          ...
          .addChild(new Transform().setDEF("Close_travel").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new PositionInterpolator().setDEF("Close_Mover").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat35().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f36().getArray())))
          ...
          .addChild(new Anchor().setDescription("Back to front view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString37().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Transform().setTranslation(new float[] {0f,0f,-0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString38().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}))))
          .addChild(new Viewpoint().setDEF("View00").setDescription("ArtDeco00").setPosition(new float[] {-3.75f,3.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-3.75f,3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco00 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString39().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            ...
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco00").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString40().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString41().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
          ...
          .addChild(new Transform().setTranslation(new float[] {-2.25f,3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco01 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString45().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance1 = new ProtoInstance().setName("ArtDeco01")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco01").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString46().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString47().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString48().getArray()))
          ...
          .addChild(new Transform().setTranslation(new float[] {-0.75f,3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco02 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString49().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance2 = new ProtoInstance().setName("ArtDeco02")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco02").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString50().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString51().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString52().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View03").setDescription("ArtDeco03").setPosition(new float[] {0.75f,3.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {0.75f,3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco03 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString53().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance3 = new ProtoInstance().setName("ArtDeco03")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco03").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString54().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString55().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString56().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View04").setDescription("ArtDeco04").setPosition(new float[] {2.25f,3.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {2.25f,3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco04 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString57().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance4 = new ProtoInstance().setName("ArtDeco04")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco04").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString58().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString59().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString60().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View05").setDescription("ArtDeco05").setPosition(new float[] {3.75f,3.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {3.75f,3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco05 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString61().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance5 = new ProtoInstance().setName("ArtDeco05")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco05").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString62().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString63().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString64().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View06").setDescription("ArtDeco06").setPosition(new float[] {-3.75f,2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-3.75f,2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco06 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString65().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance6 = new ProtoInstance().setName("ArtDeco06")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco06").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString66().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString67().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString68().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View07").setDescription("ArtDeco07").setPosition(new float[] {-2.25f,2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-2.25f,2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco07 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString69().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance7 = new ProtoInstance().setName("ArtDeco07")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco07").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString70().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString71().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString72().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View08").setDescription("ArtDeco08").setPosition(new float[] {-0.75f,2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-0.75f,2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco08 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString73().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance8 = new ProtoInstance().setName("ArtDeco08")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco08").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString74().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString75().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString76().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View09").setDescription("ArtDeco09").setPosition(new float[] {0.75f,2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {0.75f,2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco09 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString77().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance9 = new ProtoInstance().setName("ArtDeco09")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco09").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString78().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString79().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString80().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View10").setDescription("ArtDeco10").setPosition(new float[] {2.25f,2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {2.25f,2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco10 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString81().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance10 = new ProtoInstance().setName("ArtDeco10")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco10").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString82().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString83().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString84().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View11").setDescription("ArtDeco11").setPosition(new float[] {3.75f,2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {3.75f,2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco11 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString85().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance11 = new ProtoInstance().setName("ArtDeco11")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco11").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString86().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString87().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString88().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View12").setDescription("ArtDeco12").setPosition(new float[] {-3.75f,0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-3.75f,0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco12 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString89().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance12 = new ProtoInstance().setName("ArtDeco12")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco12").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString90().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString91().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString92().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View13").setDescription("ArtDeco13").setPosition(new float[] {-2.25f,0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-2.25f,0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco13 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString93().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance13 = new ProtoInstance().setName("ArtDeco13")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco13").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString94().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString95().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString96().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View14").setDescription("ArtDeco14").setPosition(new float[] {-0.75f,0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-0.75f,0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco14 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString97().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance14 = new ProtoInstance().setName("ArtDeco14")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco14").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString98().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString99().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString100().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View15").setDescription("ArtDeco15").setPosition(new float[] {0.75f,0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {0.75f,0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco15 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString101().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance15 = new ProtoInstance().setName("ArtDeco15")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco15").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString102().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString103().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString104().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View16").setDescription("ArtDeco16").setPosition(new float[] {2.25f,0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {2.25f,0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco16 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString105().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance16 = new ProtoInstance().setName("ArtDeco16")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco16").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString106().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString107().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString108().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View17").setDescription("ArtDeco17").setPosition(new float[] {3.75f,0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {3.75f,0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco17 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString109().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance17 = new ProtoInstance().setName("ArtDeco17")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco17").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString110().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString111().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString112().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View18").setDescription("ArtDeco18").setPosition(new float[] {-3.75f,-0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-3.75f,-0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco18 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString113().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance18 = new ProtoInstance().setName("ArtDeco18")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco18").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString114().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString115().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString116().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View19").setDescription("ArtDeco19").setPosition(new float[] {-2.25f,-0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-2.25f,-0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco19 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString117().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance19 = new ProtoInstance().setName("ArtDeco19")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco19").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString118().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString119().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString120().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View20").setDescription("ArtDeco20").setPosition(new float[] {-0.75f,-0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-0.75f,-0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco20 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString121().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance20 = new ProtoInstance().setName("ArtDeco20")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco20").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString122().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString123().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString124().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View21").setDescription("ArtDeco21").setPosition(new float[] {0.75f,-0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {0.75f,-0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco21 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString125().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance21 = new ProtoInstance().setName("ArtDeco21")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco21").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString126().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString127().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString128().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View22").setDescription("ArtDeco22").setPosition(new float[] {2.25f,-0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {2.25f,-0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco22 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString129().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance22 = new ProtoInstance().setName("ArtDeco22")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco22").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString130().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString131().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString132().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View23").setDescription("ArtDeco23").setPosition(new float[] {3.75f,-0.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {3.75f,-0.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco23 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString133().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance23 = new ProtoInstance().setName("ArtDeco23")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco23").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString134().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString135().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString136().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View24").setDescription("ArtDeco24").setPosition(new float[] {-3.75f,-2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-3.75f,-2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco24 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString137().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance24 = new ProtoInstance().setName("ArtDeco24")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco24").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString138().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString139().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString140().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View25").setDescription("ArtDeco25").setPosition(new float[] {-2.25f,-2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-2.25f,-2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco25 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString141().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance25 = new ProtoInstance().setName("ArtDeco25")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco25").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString142().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString143().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString144().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View26").setDescription("ArtDeco26").setPosition(new float[] {-0.75f,-2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-0.75f,-2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco26 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString145().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance26 = new ProtoInstance().setName("ArtDeco26")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco26").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString146().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString147().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString148().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View27").setDescription("ArtDeco27").setPosition(new float[] {0.75f,-2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {0.75f,-2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco27 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString149().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance27 = new ProtoInstance().setName("ArtDeco27")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco27").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString150().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString151().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString152().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View28").setDescription("ArtDeco28").setPosition(new float[] {2.25f,-2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {2.25f,-2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco28 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString153().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance28 = new ProtoInstance().setName("ArtDeco28")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco28").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString154().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString155().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString156().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View29").setDescription("ArtDeco29").setPosition(new float[] {3.75f,-2.25f,3f}))
          .addChild(new Transform().setTranslation(new float[] {3.75f,-2.25f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco29 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString157().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance29 = new ProtoInstance().setName("ArtDeco29")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco29").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString158().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString159().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString160().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View30").setDescription("ArtDeco30").setPosition(new float[] {-3.75f,-3.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-3.75f,-3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco30 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString161().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance30 = new ProtoInstance().setName("ArtDeco30")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco30").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString162().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString163().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString164().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View31").setDescription("ArtDeco31").setPosition(new float[] {-2.25f,-3.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-2.25f,-3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco31 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString165().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance31 = new ProtoInstance().setName("ArtDeco31")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco31").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString166().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString167().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString168().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View32").setDescription("ArtDeco32").setPosition(new float[] {-0.75f,-3.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {-0.75f,-3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco32 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString169().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance32 = new ProtoInstance().setName("ArtDeco32")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco32").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString170().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString171().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString172().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View33").setDescription("ArtDeco33").setPosition(new float[] {0.75f,-3.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {0.75f,-3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco33 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString173().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance33 = new ProtoInstance().setName("ArtDeco33")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco33").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString174().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString175().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString176().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style")))))))
          .addChild(new Viewpoint().setDEF("View34").setDescription("ArtDeco34").setPosition(new float[] {2.25f,-3.75f,3f}))
          .addChild(new Transform().setTranslation(new float[] {2.25f,-3.75f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
            .addChild(new Anchor().setDescription("ArtDeco34 view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString177().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .setAppearance(new Appearance()
                  .setMaterial(ProtoInstance34 = new ProtoInstance().setName("ArtDeco34")))
                .setGeometry(new Sphere().setUSE("Ball"))))
            .addChild(new Transform().setTranslation(new float[] {0f,0.3f,0.5f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
              .addChild(new Anchor().setDescription("ArtDeco34").setParameter(new org.web3d.x3d.jsail.fields.MFString(new MFString178().getArray())).setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString179().getArray())).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                .addChild(new Shape().setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f})
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("TextMat")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString180().getArray()))
                    .setFontStyle(new FontStyle().setUSE("Style"))))))))

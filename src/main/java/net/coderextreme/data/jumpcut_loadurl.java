...
public class jumpcut_loadurl implements X3DRoots {
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("jumpcut_loadurl.x3d")))
      ...
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle(new SFString("jumpcut_loadurl.x3d")))
        ...
        .addChild(new Viewpoint().setDEF(new SFString("Front_View")).setDescription(new SFString("Front View")))
        .addChild(new Viewpoint().setDEF(new SFString("Top_View")).setDescription(new SFString("Top View")).setOrientation(new float[] {1f ,0f ,0f ,-1.57f }).setPosition(new float[] {0f ,10f ,0f }))
        .addChild(new TouchSensor().setDEF(new SFString("STARTER")).setDescription(new SFString("touch to activate")))
        .addChild(new Transform().setDEF(new SFString("ROOT"))
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material()))
            .setGeometry(new Box())))
        .addChild(new Script().setDEF(new SFString("MYSCRIPT")).setUrl(new MFString3().getArray())
          .addField(new field().setType("MFString").setName(new SFString("myParameter")).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(new SFString("\"Top_View\"")))
          .addField(new field().setType("MFString").setName(new SFString("myUrl")).setAccessType(field.ACCESSTYPE_INITIALIZEONLY).setValue(new SFString("\"jumpcut_loadurl.x3d#Top_View\" \"https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/jumpcut_loadurl.x3d#Top_View\" \"jumpcut_loadurl.wrl#Top_View\" \"https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/jumpcut_loadurl.wrl#Top_View\"")))
          .addField(new field().setType("SFBool").setName(new SFString("trigger_event")).setAccessType(field.ACCESSTYPE_INPUTONLY)))
        .addChild(new ROUTE().setFromField(new SFString("isActive")).setFromNode(new SFString("STARTER")).setToField(new SFString("trigger_event")).setToNode(new SFString("MYSCRIPT"))));
    return X3D0;
    }

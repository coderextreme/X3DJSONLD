...
public class MFString {
  public static void main(String[] args) {
    ...
    new MFString().initialize().toFileJSON("../data/MFString.new.json");
    }
    public X3DObject initialize() {
      X3DObject X3D0 =  new X3DObject().setProfile("Immersive").setVersion("3.0")
      .setHead(new headObject()
        .addMeta(new metaObject().setContent("MFString.x3d").setName("title"))
        ...
        .addChild(new TransformObject().setDEF("F16Transform")
          .addChild(new TransformObject().setDEF("MainFrameTransform").setScale(new float[] {3f,3f,3f})
            .addChild(new ShapeObject().setDEF("Nose")
              ...
              .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt320().getArray())).setCreaseAngle(0.5f).setNormalIndex(new MFInt32Object(new MFInt321().getArray())).setSolid(false)
                .setCoord(new CoordinateObject().setDEF("coordinates").setPoint(new MFVec3fObject(new MFVec3f2().getArray())))
                .setNormal(new NormalObject().setDEF("normalVector").setVector(new MFVec3fObject(new MFVec3f3().getArray())))))
            .addChild(new ShapeObject().setDEF("Canopy")
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.25f,0.25f,0.25f}).setTransparency(0.8f)))
              .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt324().getArray())).setCreaseAngle(0.5f).setNormalIndex(new MFInt32Object(new MFInt325().getArray())).setSolid(false)
                .setCoord(new CoordinateObject().setUSE("coordinates"))
                .setNormal(new NormalObject().setUSE("normalVector"))))
            .addChild(new ShapeObject().setDEF("MainBodyAndWingEdges")
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.1796f,0.1914f,0.2382f})))
              .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt326().getArray())).setCreaseAngle(0.5f).setNormalIndex(new MFInt32Object(new MFInt327().getArray())).setSolid(false)
                .setCoord(new CoordinateObject().setUSE("coordinates"))
                .setNormal(new NormalObject().setUSE("normalVector"))))
            .addChild(new ShapeObject().setDEF("ExhaustExitFlatPanel")
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.5f,0.5f,0.5f})))
              .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt328().getArray())).setCreaseAngle(0.5f).setNormalIndex(new MFInt32Object(new MFInt329().getArray())).setSolid(false)
                .setCoord(new CoordinateObject().setUSE("coordinates"))
                .setNormal(new NormalObject().setUSE("normalVector"))))
            .addChild(new ShapeObject().setDEF("ExhaustEntranceFrontBottomPart")
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.2304f,0.2304f,0.2304f})))
              .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3210().getArray())).setCreaseAngle(0.5f).setNormalIndex(new MFInt32Object(new MFInt3211().getArray())).setSolid(false)
                .setCoord(new CoordinateObject().setUSE("coordinates"))
                .setNormal(new NormalObject().setUSE("normalVector"))))
            .addChild(new ShapeObject().setDEF("ThirdPartFromNoseUnderCanopy")
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.6f,0.6f,0.6f})))
              .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3212().getArray())).setCreaseAngle(0.5f).setNormalIndex(new MFInt32Object(new MFInt3213().getArray())).setSolid(false)
                .setCoord(new CoordinateObject().setUSE("coordinates"))
                .setNormal(new NormalObject().setUSE("normalVector"))))
            .addChild(new ShapeObject().setDEF("RearExhaustExitPartLastPartOfMainBody")
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.37f,0.37f,0.37f}).setShininess(0.5f)))
              .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt3214().getArray())).setCreaseAngle(0.5f).setNormalIndex(new MFInt32Object(new MFInt3215().getArray())).setSolid(false)
                .setCoord(new CoordinateObject().setUSE("coordinates"))
                .setNormal(new NormalObject().setUSE("normalVector"))))
            .addChild(new ShapeObject().setDEF("WingsAndTail")
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setEmissiveColor(new float[] {0.1796f,0.1914f,0.2382f})))
              .setGeometry(new IndexedFaceSetObject().setColorPerVertex(false).setCoordIndex(new MFInt32Object(new MFInt3216().getArray())).setCreaseAngle(0.5f).setNormalIndex(new MFInt32Object(new MFInt3217().getArray())).setSolid(false)
                .setCoord(new CoordinateObject().setUSE("coordinates"))
                .setNormal(new NormalObject().setUSE("normalVector"))))
            .addChild(new ShapeObject().setDEF("SecondPartAfterNose")
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.6f,0.6f,0.6f})))
          ...
          .addChild(new TransformObject().setDEF("CockpitButtonsTransform")
            .addChild(new TransformObject().setDEF("UpButtonTransform").setRotation(new float[] {1f,0f,0f,1.57f}).setScale(new float[] {0.008f,0.008f,0.008f}).setTranslation(new float[] {-0.95f,1.05f,-10f})
              .addChild(new ShapeObject()
                ...
                .setAppearance(new AppearanceObject()
                  .setMaterial(new MaterialObject().setDiffuseColor(new float[] {1f,0f,0f}).setShininess(0.8f))))
              .addChild(new TouchSensorObject().setDEF("TouchSensorUp").setDescription("click for gears up")))
            .addChild(new TransformObject().setDEF("DownButtonTransform").setRotation(new float[] {1f,0f,0f,1.57f}).setScale(new float[] {0.008f,0.008f,0.008f}).setTranslation(new float[] {-0.83f,1.05f,-10f})
              .addChild(new ShapeObject()
                .setGeometry(new CylinderObject().setHeight(1f).setRadius(4f))
                .setAppearance(new AppearanceObject()
                  .setMaterial(new MaterialObject().setDiffuseColor(new float[] {1f,1f,0f}).setShininess(0.8f))))
            ...
            .addChild(new TransformObject().setDEF("FireButtonTransform").setRotation(new float[] {1f,0f,0f,1.57f}).setScale(new float[] {0.008f,0.008f,0.008f}).setTranslation(new float[] {0.52f,1.6f,-10f})
              .addChild(new ShapeObject()
                .setGeometry(new CylinderObject().setHeight(1f).setRadius(4f))
                .setAppearance(new AppearanceObject()
                  .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0f,0.75f,0.18f}).setShininess(0.8f))))
          ...
          .addChild(new ViewpointObject().setDescription("Cockpit").setOrientation(new float[] {-1f,0f,0f,0.1249f}).setPosition(new float[] {0f,1.5f,-7.9f}))
          .addChild(new ViewpointObject().setDEF("LandingGearAnimationView").setDescription("Landing Gear Animation View").setOrientation(new float[] {-0.003f,1f,-0.012f,2.5741f}).setPosition(new float[] {16.1f,-5.8f,-24.6f}))
          .addChild(new ViewpointObject().setDescription("Cockpit Left View").setOrientation(new float[] {-0.276f,-0.922f,-0.271f,1.2338f}).setPosition(new float[] {-6.7f,6.1f,-3.9f}))
          .addChild(new ViewpointObject().setDescription("F-16 Front View").setOrientation(new float[] {-0.007f,0.995f,0.102f,3.1152f}).setPosition(new float[] {-0.1f,13.4f,-65f}))
          .addChild(new ViewpointObject().setDescription("Cockpit Target View").setOrientation(new float[] {-0.834f,-0.523f,-0.176f,0.0875f}).setPosition(new float[] {0f,2.4f,-7.9f}))
          .addChild(new TransformObject().setDEF("NoseAntennaTransform").setRotation(new float[] {1f,0f,0f,1.57f}).setTranslation(new float[] {0f,-0.275f,-21f})
            .addChild(new ShapeObject()
...
protected class MFInt3218 {
  protected MFInt32Object getArray() {
    return new MFInt32Object(new int[] {0,1,2,3,-1,4,5,1,0,-1,10,11,12,13,-1,14,15,5,4,-1,13,12,15,14,-1,16,17,11,10,-1,18,19,17,16,-1,3,2,19,18,-1});
  }
}
protected class MFInt3219 {
  protected MFInt32Object getArray() {
    return new MFInt32Object(new int[] {0,1,2,3,-1,4,5,1,0,-1,6,7,8,9,-1,10,11,5,4,-1,9,8,11,10,-1,12,13,7,6,-1,14,15,13,12,-1,3,2,15,14,-1});
  }
}

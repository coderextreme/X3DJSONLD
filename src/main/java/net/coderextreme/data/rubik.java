...
public class rubik implements X3DRoots {
...
ProtoInstance ProtoInstance9 = null;
      ...
      .setHead(new head()
        .addMeta(new meta().setName(new SFString("title")).setContent(new SFString("rubik.x3d")))
        ...
        .addMeta(new meta().setName(new SFString("identifier")).setContent(new SFString("https://coderextreme.net/X3DJSONLD/src/main/data/rubik.x3d")))
        .addMeta(new meta().setName(new SFString("description")).setContent(new SFString("a kind of rubik cube with spheres"))))
      .setScene(new Scene()

...
public class StandardHumanoidNoSegSite {
  public static void main(String[] args) {
    ...
    X3D model = new StandardHumanoidNoSegSite().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/StandardHumanoidNoSegSite.new.json");
    }
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("HAnim").setDEF("hanim_HAnim").setInfo(new MFString10().getArray()).setVersion("2.0")
          ...
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_HAnim").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new float[] {0f ,0.824f ,0.0277f }).setSkinCoordIndex(new MFInt3221().getArray()).setSkinCoordWeight(new MFFloat22().getArray()).setUlimit(new MFFloat23().getArray()).setLlimit(new MFFloat24().getArray()).setContainerFieldOverride("skeleton"))

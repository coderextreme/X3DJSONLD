...
public class BoxMan3AnimationPanel {
  public static void main(String[] args) {
    ...
    X3D model = new BoxMan3AnimationPanel().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/BoxMan3AnimationPanel.new.json");
    }
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3AnimationPanel.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Humanoid").setDEF("boxman_Humanoid").setInfo(new MFString3().getArray()).setVersion("2.0")
          ...
          .addViewpoints(new HAnimSite("boxman_Humanoid").setName("BoxMan_view").setDEF("boxman_BoxMan_view")
            ...
            .addChild(new Viewpoint("boxman_BoxMan_view").setDEF("Best_View").setDescription("Right-side View").setOrientation(new float[] {0f,1f,0f,-1.57f}).setPosition(new float[] {-3f,1f,0f}))
            .addChild(new Viewpoint("boxman_BoxMan_view").setDEF("Side_View").setDescription("Left-side View").setOrientation(new float[] {0f,1f,0f,1.57f}).setPosition(new float[] {3f,1f,0f}))
        ...
        .addChild(new Group().setDEF("StopAnimation")
          .addChild(new TimeSensor("StopAnimation").setDEF("StopTimer").setCycleInterval(5.73d).setLoop(true))
          .addChild(new PositionInterpolator("StopAnimation").setDEF("Stop_humanoid_root_TranslationInterpolator").setKey(new MFFloat81().getArray()).setKeyValue(new MFVec3f82().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_humanoid_root_RotationInterpolator").setKey(new MFFloat83().getArray()).setKeyValue(new MFRotation84().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_sacroiliac_RotationInterpolator").setKey(new MFFloat85().getArray()).setKeyValue(new MFRotation86().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_hip_RotationInterpolator").setKey(new MFFloat87().getArray()).setKeyValue(new MFRotation88().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_knee_RotationInterpolator").setKey(new MFFloat89().getArray()).setKeyValue(new MFRotation90().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_ankle_RotationInterpolator").setKey(new MFFloat91().getArray()).setKeyValue(new MFRotation92().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_subtalar_RotationInterpolator").setKey(new MFFloat93().getArray()).setKeyValue(new MFRotation94().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_midtarsal_RotationInterpolator").setKey(new MFFloat95().getArray()).setKeyValue(new MFRotation96().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_metatarsal_RotationInterpolator").setKey(new MFFloat97().getArray()).setKeyValue(new MFRotation98().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_hip_RotationInterpolator").setKey(new MFFloat99().getArray()).setKeyValue(new MFRotation100().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_knee_RotationInterpolator").setKey(new MFFloat101().getArray()).setKeyValue(new MFRotation102().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_ankle_RotationInterpolator").setKey(new MFFloat103().getArray()).setKeyValue(new MFRotation104().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_subtalar_RotationInterpolator").setKey(new MFFloat105().getArray()).setKeyValue(new MFRotation106().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_midtarsal_RotationInterpolator").setKey(new MFFloat107().getArray()).setKeyValue(new MFRotation108().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_metatarsal_RotationInterpolator").setKey(new MFFloat109().getArray()).setKeyValue(new MFRotation110().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vl5_RotationInterpolator").setKey(new MFFloat111().getArray()).setKeyValue(new MFRotation112().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vl4_RotationInterpolator").setKey(new MFFloat113().getArray()).setKeyValue(new MFRotation114().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vl3_RotationInterpolator").setKey(new MFFloat115().getArray()).setKeyValue(new MFRotation116().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vl2_RotationInterpolator").setKey(new MFFloat117().getArray()).setKeyValue(new MFRotation118().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vl1_RotationInterpolator").setKey(new MFFloat119().getArray()).setKeyValue(new MFRotation120().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt12_RotationInterpolator").setKey(new MFFloat121().getArray()).setKeyValue(new MFRotation122().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt11_RotationInterpolator").setKey(new MFFloat123().getArray()).setKeyValue(new MFRotation124().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt10_RotationInterpolator").setKey(new MFFloat125().getArray()).setKeyValue(new MFRotation126().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt9_RotationInterpolator").setKey(new MFFloat127().getArray()).setKeyValue(new MFRotation128().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt8_RotationInterpolator").setKey(new MFFloat129().getArray()).setKeyValue(new MFRotation130().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt7_RotationInterpolator").setKey(new MFFloat131().getArray()).setKeyValue(new MFRotation132().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt6_RotationInterpolator").setKey(new MFFloat133().getArray()).setKeyValue(new MFRotation134().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt5_RotationInterpolator").setKey(new MFFloat135().getArray()).setKeyValue(new MFRotation136().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt4_RotationInterpolator").setKey(new MFFloat137().getArray()).setKeyValue(new MFRotation138().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt3_RotationInterpolator").setKey(new MFFloat139().getArray()).setKeyValue(new MFRotation140().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt2_RotationInterpolator").setKey(new MFFloat141().getArray()).setKeyValue(new MFRotation142().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vt1_RotationInterpolator").setKey(new MFFloat143().getArray()).setKeyValue(new MFRotation144().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vc7_RotationInterpolator").setKey(new MFFloat145().getArray()).setKeyValue(new MFRotation146().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vc6_RotationInterpolator").setKey(new MFFloat147().getArray()).setKeyValue(new MFRotation148().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vc5_RotationInterpolator").setKey(new MFFloat149().getArray()).setKeyValue(new MFRotation150().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vc4_RotationInterpolator").setKey(new MFFloat151().getArray()).setKeyValue(new MFRotation152().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vc3_RotationInterpolator").setKey(new MFFloat153().getArray()).setKeyValue(new MFRotation154().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vc2_RotationInterpolator").setKey(new MFFloat155().getArray()).setKeyValue(new MFRotation156().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_vc1_RotationInterpolator").setKey(new MFFloat157().getArray()).setKeyValue(new MFRotation158().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_skullbase_RotationInterpolator").setKey(new MFFloat159().getArray()).setKeyValue(new MFRotation160().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_eyeball_joint_RotationInterpolator").setKey(new MFFloat161().getArray()).setKeyValue(new MFRotation162().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_eyeball_joint_RotationInterpolator").setKey(new MFFloat163().getArray()).setKeyValue(new MFRotation164().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_sternoclavicular_RotationInterpolator").setKey(new MFFloat165().getArray()).setKeyValue(new MFRotation166().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_acromioclavicular_RotationInterpolator").setKey(new MFFloat167().getArray()).setKeyValue(new MFRotation168().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_shoulder_RotationInterpolator").setKey(new MFFloat169().getArray()).setKeyValue(new MFRotation170().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_elbow_RotationInterpolator").setKey(new MFFloat171().getArray()).setKeyValue(new MFRotation172().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_wrist_RotationInterpolator").setKey(new MFFloat173().getArray()).setKeyValue(new MFRotation174().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_thumb1_RotationInterpolator").setKey(new MFFloat175().getArray()).setKeyValue(new MFRotation176().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_thumb2_RotationInterpolator").setKey(new MFFloat177().getArray()).setKeyValue(new MFRotation178().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_thumb3_RotationInterpolator").setKey(new MFFloat179().getArray()).setKeyValue(new MFRotation180().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_index0_RotationInterpolator").setKey(new MFFloat181().getArray()).setKeyValue(new MFRotation182().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_index1_RotationInterpolator").setKey(new MFFloat183().getArray()).setKeyValue(new MFRotation184().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_index2_RotationInterpolator").setKey(new MFFloat185().getArray()).setKeyValue(new MFRotation186().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_index3_RotationInterpolator").setKey(new MFFloat187().getArray()).setKeyValue(new MFRotation188().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_middle0_RotationInterpolator").setKey(new MFFloat189().getArray()).setKeyValue(new MFRotation190().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_middle1_RotationInterpolator").setKey(new MFFloat191().getArray()).setKeyValue(new MFRotation192().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_middle2_RotationInterpolator").setKey(new MFFloat193().getArray()).setKeyValue(new MFRotation194().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_middle3_RotationInterpolator").setKey(new MFFloat195().getArray()).setKeyValue(new MFRotation196().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_ring0_RotationInterpolator").setKey(new MFFloat197().getArray()).setKeyValue(new MFRotation198().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_ring1_RotationInterpolator").setKey(new MFFloat199().getArray()).setKeyValue(new MFRotation200().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_ring2_RotationInterpolator").setKey(new MFFloat201().getArray()).setKeyValue(new MFRotation202().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_ring3_RotationInterpolator").setKey(new MFFloat203().getArray()).setKeyValue(new MFRotation204().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_pinky0_RotationInterpolator").setKey(new MFFloat205().getArray()).setKeyValue(new MFRotation206().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_pinky1_RotationInterpolator").setKey(new MFFloat207().getArray()).setKeyValue(new MFRotation208().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_pinky2_RotationInterpolator").setKey(new MFFloat209().getArray()).setKeyValue(new MFRotation210().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_l_pinky3_RotationInterpolator").setKey(new MFFloat211().getArray()).setKeyValue(new MFRotation212().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_sternoclavicular_RotationInterpolator").setKey(new MFFloat213().getArray()).setKeyValue(new MFRotation214().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_acromioclavicular_RotationInterpolator").setKey(new MFFloat215().getArray()).setKeyValue(new MFRotation216().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_shoulder_RotationInterpolator").setKey(new MFFloat217().getArray()).setKeyValue(new MFRotation218().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_elbow_RotationInterpolator").setKey(new MFFloat219().getArray()).setKeyValue(new MFRotation220().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_wrist_RotationInterpolator").setKey(new MFFloat221().getArray()).setKeyValue(new MFRotation222().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_thumb1_RotationInterpolator").setKey(new MFFloat223().getArray()).setKeyValue(new MFRotation224().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_thumb2_RotationInterpolator").setKey(new MFFloat225().getArray()).setKeyValue(new MFRotation226().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_thumb3_RotationInterpolator").setKey(new MFFloat227().getArray()).setKeyValue(new MFRotation228().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_index0_RotationInterpolator").setKey(new MFFloat229().getArray()).setKeyValue(new MFRotation230().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_index1_RotationInterpolator").setKey(new MFFloat231().getArray()).setKeyValue(new MFRotation232().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_index2_RotationInterpolator").setKey(new MFFloat233().getArray()).setKeyValue(new MFRotation234().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_index3_RotationInterpolator").setKey(new MFFloat235().getArray()).setKeyValue(new MFRotation236().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_middle0_RotationInterpolator").setKey(new MFFloat237().getArray()).setKeyValue(new MFRotation238().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_middle1_RotationInterpolator").setKey(new MFFloat239().getArray()).setKeyValue(new MFRotation240().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_middle2_RotationInterpolator").setKey(new MFFloat241().getArray()).setKeyValue(new MFRotation242().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_middle3_RotationInterpolator").setKey(new MFFloat243().getArray()).setKeyValue(new MFRotation244().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_ring0_RotationInterpolator").setKey(new MFFloat245().getArray()).setKeyValue(new MFRotation246().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_ring1_RotationInterpolator").setKey(new MFFloat247().getArray()).setKeyValue(new MFRotation248().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_ring2_RotationInterpolator").setKey(new MFFloat249().getArray()).setKeyValue(new MFRotation250().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_ring3_RotationInterpolator").setKey(new MFFloat251().getArray()).setKeyValue(new MFRotation252().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_pinky0_RotationInterpolator").setKey(new MFFloat253().getArray()).setKeyValue(new MFRotation254().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_pinky1_RotationInterpolator").setKey(new MFFloat255().getArray()).setKeyValue(new MFRotation256().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_pinky2_RotationInterpolator").setKey(new MFFloat257().getArray()).setKeyValue(new MFRotation258().getArray()))
          .addChild(new OrientationInterpolator("StopAnimation").setDEF("Stop_r_pinky3_RotationInterpolator").setKey(new MFFloat259().getArray()).setKeyValue(new MFRotation260().getArray())))
        .addChild(new Group().setDEF("StandAnimation")
          .addChild(new TimeSensor("StandAnimation").setDEF("StandTimer").setCycleInterval(5.73d).setLoop(true))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_metatarsal_PitchInterpolator").setKey(new MFFloat261().getArray()).setKeyValue(new MFRotation262().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_ankle_RotationInterpolator").setKey(new MFFloat263().getArray()).setKeyValue(new MFRotation264().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_knee_RotationInterpolator").setKey(new MFFloat265().getArray()).setKeyValue(new MFRotation266().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_hip_RotationInterpolator").setKey(new MFFloat267().getArray()).setKeyValue(new MFRotation268().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_ankle_RotationInterpolator").setKey(new MFFloat269().getArray()).setKeyValue(new MFRotation270().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_knee_RotationInterpolator").setKey(new MFFloat271().getArray()).setKeyValue(new MFRotation272().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_hip_RotationInterpolator").setKey(new MFFloat273().getArray()).setKeyValue(new MFRotation274().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_wrist_RotationInterpolator").setKey(new MFFloat275().getArray()).setKeyValue(new MFRotation276().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_elbow_RotationInterpolator").setKey(new MFFloat277().getArray()).setKeyValue(new MFRotation278().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_shoulder_RotationInterpolator").setKey(new MFFloat279().getArray()).setKeyValue(new MFRotation280().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_wrist_RotationInterpolator").setKey(new MFFloat281().getArray()).setKeyValue(new MFRotation282().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_elbow_RotationInterpolator").setKey(new MFFloat283().getArray()).setKeyValue(new MFRotation284().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_shoulder_RotationInterpolator").setKey(new MFFloat285().getArray()).setKeyValue(new MFRotation286().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_head_RotationInterpolator").setKey(new MFFloat287().getArray()).setKeyValue(new MFRotation288().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_neck_RotationInterpolator").setKey(new MFFloat289().getArray()).setKeyValue(new MFRotation290().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_eyeball_RotationInterpolator").setKey(new MFFloat291().getArray()).setKeyValue(new MFRotation292().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_eyeball_RotationInterpolator").setKey(new MFFloat293().getArray()).setKeyValue(new MFRotation294().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_lower_body_RotationInterpolator").setKey(new MFFloat295().getArray()).setKeyValue(new MFRotation296().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_upper_body_RotationInterpolator").setKey(new MFFloat297().getArray()).setKeyValue(new MFRotation298().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_whole_body_RotationInterpolator").setKey(new MFFloat299().getArray()).setKeyValue(new MFRotation300().getArray()))
          .addChild(new PositionInterpolator("StandAnimation").setDEF("Stand_whole_body_TranslationInterpolator").setKey(new MFFloat301().getArray()).setKeyValue(new MFVec3f302().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_sternoclavicular_RollInterpolator").setKey(new MFFloat303().getArray()).setKeyValue(new MFRotation304().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_acromioclavicular_RollInterpolator").setKey(new MFFloat305().getArray()).setKeyValue(new MFRotation306().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_sternoclavicular_RollInterpolator").setKey(new MFFloat307().getArray()).setKeyValue(new MFRotation308().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_acromioclavicular_RollInterpolator").setKey(new MFFloat309().getArray()).setKeyValue(new MFRotation310().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_sacroiliac_YawInterpolator").setKey(new MFFloat311().getArray()).setKeyValue(new MFRotation312().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_vl5_YawInterpolator").setKey(new MFFloat313().getArray()).setKeyValue(new MFRotation314().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_vc6_YawInterpolator").setKey(new MFFloat315().getArray()).setKeyValue(new MFRotation316().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_l_thumb1_PitchInterpolator").setKey(new MFFloat317().getArray()).setKeyValue(new MFRotation318().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_thumb1_PitchInterpolator").setKey(new MFFloat319().getArray()).setKeyValue(new MFRotation320().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_index1_RollInterpolator").setKey(new MFFloat321().getArray()).setKeyValue(new MFRotation322().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_index2_RollInterpolator").setKey(new MFFloat323().getArray()).setKeyValue(new MFRotation324().getArray()))
          .addChild(new OrientationInterpolator("StandAnimation").setDEF("Stand_r_index3_RollInterpolator").setKey(new MFFloat325().getArray()).setKeyValue(new MFRotation326().getArray())))
        .addChild(new Group().setDEF("PitchesAnimation")
          .addChild(new TimeSensor("PitchesAnimation").setDEF("PitchTimer").setCycleInterval(5.73d).setLoop(true))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_r_metatarsal_PitchInterpolator").setKey(new MFFloat327().getArray()).setKeyValue(new MFRotation328().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_r_ankle_RotationInterpolator").setKey(new MFFloat329().getArray()).setKeyValue(new MFRotation330().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_r_knee_RotationInterpolator").setKey(new MFFloat331().getArray()).setKeyValue(new MFRotation332().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_r_hip_RotationInterpolator").setKey(new MFFloat333().getArray()).setKeyValue(new MFRotation334().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_l_ankle_RotationInterpolator").setKey(new MFFloat335().getArray()).setKeyValue(new MFRotation336().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_l_knee_RotationInterpolator").setKey(new MFFloat337().getArray()).setKeyValue(new MFRotation338().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_l_hip_RotationInterpolator").setKey(new MFFloat339().getArray()).setKeyValue(new MFRotation340().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_r_wrist_RotationInterpolator").setKey(new MFFloat341().getArray()).setKeyValue(new MFRotation342().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_r_elbow_RotationInterpolator").setKey(new MFFloat343().getArray()).setKeyValue(new MFRotation344().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_r_shoulder_RotationInterpolator").setKey(new MFFloat345().getArray()).setKeyValue(new MFRotation346().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_l_wrist_RotationInterpolator").setKey(new MFFloat347().getArray()).setKeyValue(new MFRotation348().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_l_elbow_RotationInterpolator").setKey(new MFFloat349().getArray()).setKeyValue(new MFRotation350().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_l_shoulder_RotationInterpolator").setKey(new MFFloat351().getArray()).setKeyValue(new MFRotation352().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_head_RotationInterpolator").setKey(new MFFloat353().getArray()).setKeyValue(new MFRotation354().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_neck_RotationInterpolator").setKey(new MFFloat355().getArray()).setKeyValue(new MFRotation356().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_lower_body_RotationInterpolator").setKey(new MFFloat357().getArray()).setKeyValue(new MFRotation358().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_upper_body_RotationInterpolator").setKey(new MFFloat359().getArray()).setKeyValue(new MFRotation360().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitches_whole_body_RotationInterpolator").setKey(new MFFloat361().getArray()).setKeyValue(new MFRotation362().getArray()))
          .addChild(new PositionInterpolator("PitchesAnimation").setDEF("Pitches_whole_body_TranslationInterpolator").setKey(new MFFloat363().getArray()).setKeyValue(new MFVec3f364().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_l_sternoclavicular_RollInterpolator").setKey(new MFFloat365().getArray()).setKeyValue(new MFRotation366().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_l_acromioclavicular_RollInterpolator").setKey(new MFFloat367().getArray()).setKeyValue(new MFRotation368().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_r_sternoclavicular_RollInterpolator").setKey(new MFFloat369().getArray()).setKeyValue(new MFRotation370().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_r_acromioclavicular_RollInterpolator").setKey(new MFFloat371().getArray()).setKeyValue(new MFRotation372().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_sacroiliac_YawInterpolator").setKey(new MFFloat373().getArray()).setKeyValue(new MFRotation374().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_vl5_YawInterpolator").setKey(new MFFloat375().getArray()).setKeyValue(new MFRotation376().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_vc6_YawInterpolator").setKey(new MFFloat377().getArray()).setKeyValue(new MFRotation378().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_l_thumb1_PitchInterpolator").setKey(new MFFloat379().getArray()).setKeyValue(new MFRotation380().getArray()))
          .addChild(new OrientationInterpolator("PitchesAnimation").setDEF("Pitch_r_thumb1_PitchInterpolator").setKey(new MFFloat381().getArray()).setKeyValue(new MFRotation382().getArray())))
        .addChild(new Group().setDEF("YawsAnimation")
          .addChild(new TimeSensor("YawsAnimation").setDEF("YawTimer").setCycleInterval(5.73d).setLoop(true))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_r_metatarsal_PitchInterpolator").setKey(new MFFloat383().getArray()).setKeyValue(new MFRotation384().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_r_ankle_RotationInterpolator").setKey(new MFFloat385().getArray()).setKeyValue(new MFRotation386().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_r_knee_RotationInterpolator").setKey(new MFFloat387().getArray()).setKeyValue(new MFRotation388().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_r_hip_RotationInterpolator").setKey(new MFFloat389().getArray()).setKeyValue(new MFRotation390().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_l_ankle_RotationInterpolator").setKey(new MFFloat391().getArray()).setKeyValue(new MFRotation392().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_l_knee_RotationInterpolator").setKey(new MFFloat393().getArray()).setKeyValue(new MFRotation394().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_l_hip_RotationInterpolator").setKey(new MFFloat395().getArray()).setKeyValue(new MFRotation396().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_r_wrist_RotationInterpolator").setKey(new MFFloat397().getArray()).setKeyValue(new MFRotation398().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_r_elbow_RotationInterpolator").setKey(new MFFloat399().getArray()).setKeyValue(new MFRotation400().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_r_shoulder_RotationInterpolator").setKey(new MFFloat401().getArray()).setKeyValue(new MFRotation402().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_l_wrist_RotationInterpolator").setKey(new MFFloat403().getArray()).setKeyValue(new MFRotation404().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_l_elbow_RotationInterpolator").setKey(new MFFloat405().getArray()).setKeyValue(new MFRotation406().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_l_shoulder_RotationInterpolator").setKey(new MFFloat407().getArray()).setKeyValue(new MFRotation408().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_head_RotationInterpolator").setKey(new MFFloat409().getArray()).setKeyValue(new MFRotation410().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_neck_RotationInterpolator").setKey(new MFFloat411().getArray()).setKeyValue(new MFRotation412().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_upper_body_RotationInterpolator").setKey(new MFFloat413().getArray()).setKeyValue(new MFRotation414().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_lower_body_RotationInterpolator").setKey(new MFFloat415().getArray()).setKeyValue(new MFRotation416().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaws_whole_body_RotationInterpolator").setKey(new MFFloat417().getArray()).setKeyValue(new MFRotation418().getArray()))
          .addChild(new PositionInterpolator("YawsAnimation").setDEF("Yaws_whole_body_TranslationInterpolator").setKey(new MFFloat419().getArray()).setKeyValue(new MFVec3f420().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_l_sternoclavicular_RollInterpolator").setKey(new MFFloat421().getArray()).setKeyValue(new MFRotation422().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_l_acromioclavicular_RollInterpolator").setKey(new MFFloat423().getArray()).setKeyValue(new MFRotation424().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_r_sternoclavicular_RollInterpolator").setKey(new MFFloat425().getArray()).setKeyValue(new MFRotation426().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_r_acromioclavicular_RollInterpolator").setKey(new MFFloat427().getArray()).setKeyValue(new MFRotation428().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_sacroiliac_YawInterpolator").setKey(new MFFloat429().getArray()).setKeyValue(new MFRotation430().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_vl5_YawInterpolator").setKey(new MFFloat431().getArray()).setKeyValue(new MFRotation432().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_vc6_YawInterpolator").setKey(new MFFloat433().getArray()).setKeyValue(new MFRotation434().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_l_thumb1_PitchInterpolator").setKey(new MFFloat435().getArray()).setKeyValue(new MFRotation436().getArray()))
          .addChild(new OrientationInterpolator("YawsAnimation").setDEF("Yaw_r_thumb1_PitchInterpolator").setKey(new MFFloat437().getArray()).setKeyValue(new MFRotation438().getArray())))
        .addChild(new Group().setDEF("RollsAnimation")
          .addChild(new TimeSensor("RollsAnimation").setDEF("RollTimer").setCycleInterval(5.73d).setLoop(true))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_r_metatarsal_PitchInterpolator").setKey(new MFFloat439().getArray()).setKeyValue(new MFRotation440().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_r_ankle_RotationInterpolator").setKey(new MFFloat441().getArray()).setKeyValue(new MFRotation442().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_r_knee_RotationInterpolator").setKey(new MFFloat443().getArray()).setKeyValue(new MFRotation444().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_r_hip_RotationInterpolator").setKey(new MFFloat445().getArray()).setKeyValue(new MFRotation446().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_l_ankle_RotationInterpolator").setKey(new MFFloat447().getArray()).setKeyValue(new MFRotation448().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_l_knee_RotationInterpolator").setKey(new MFFloat449().getArray()).setKeyValue(new MFRotation450().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_l_hip_RotationInterpolator").setKey(new MFFloat451().getArray()).setKeyValue(new MFRotation452().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_r_wrist_RotationInterpolator").setKey(new MFFloat453().getArray()).setKeyValue(new MFRotation454().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_r_elbow_RotationInterpolator").setKey(new MFFloat455().getArray()).setKeyValue(new MFRotation456().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_r_shoulder_RotationInterpolator").setKey(new MFFloat457().getArray()).setKeyValue(new MFRotation458().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_l_wrist_RotationInterpolator").setKey(new MFFloat459().getArray()).setKeyValue(new MFRotation460().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_l_elbow_RotationInterpolator").setKey(new MFFloat461().getArray()).setKeyValue(new MFRotation462().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_l_shoulder_RotationInterpolator").setKey(new MFFloat463().getArray()).setKeyValue(new MFRotation464().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_head_RotationInterpolator").setKey(new MFFloat465().getArray()).setKeyValue(new MFRotation466().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_neck_RotationInterpolator").setKey(new MFFloat467().getArray()).setKeyValue(new MFRotation468().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_lower_body_RotationInterpolator").setKey(new MFFloat469().getArray()).setKeyValue(new MFRotation470().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_upper_body_RotationInterpolator").setKey(new MFFloat471().getArray()).setKeyValue(new MFRotation472().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Rolls_whole_body_RotationInterpolator").setKey(new MFFloat473().getArray()).setKeyValue(new MFRotation474().getArray()))
          .addChild(new PositionInterpolator("RollsAnimation").setDEF("Rolls_whole_body_TranslationInterpolator").setKey(new MFFloat475().getArray()).setKeyValue(new MFVec3f476().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_l_sternoclavicular_RollInterpolator").setKey(new MFFloat477().getArray()).setKeyValue(new MFRotation478().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_l_acromioclavicular_RollInterpolator").setKey(new MFFloat479().getArray()).setKeyValue(new MFRotation480().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_r_sternoclavicular_RollInterpolator").setKey(new MFFloat481().getArray()).setKeyValue(new MFRotation482().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_r_acromioclavicular_RollInterpolator").setKey(new MFFloat483().getArray()).setKeyValue(new MFRotation484().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_sacroiliac_YawInterpolator").setKey(new MFFloat485().getArray()).setKeyValue(new MFRotation486().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_vl5_YawInterpolator").setKey(new MFFloat487().getArray()).setKeyValue(new MFRotation488().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_vc6_YawInterpolator").setKey(new MFFloat489().getArray()).setKeyValue(new MFRotation490().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_l_thumb1_PitchInterpolator").setKey(new MFFloat491().getArray()).setKeyValue(new MFRotation492().getArray()))
          .addChild(new OrientationInterpolator("RollsAnimation").setDEF("Roll_r_thumb1_PitchInterpolator").setKey(new MFFloat493().getArray()).setKeyValue(new MFRotation494().getArray())))
        .addChild(new Group().setDEF("WalkAnimation")
          .addChild(new TimeSensor("WalkAnimation").setDEF("WalkTimer").setCycleInterval(1.73d).setLoop(true))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_metatarsal_PitchInterpolator").setKey(new MFFloat495().getArray()).setKeyValue(new MFRotation496().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_ankle_RotationInterpolator").setKey(new MFFloat497().getArray()).setKeyValue(new MFRotation498().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_knee_RotationInterpolator").setKey(new MFFloat499().getArray()).setKeyValue(new MFRotation500().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_hip_RotationInterpolator").setKey(new MFFloat501().getArray()).setKeyValue(new MFRotation502().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_l_ankle_RotationInterpolator").setKey(new MFFloat503().getArray()).setKeyValue(new MFRotation504().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_l_knee_RotationInterpolator").setKey(new MFFloat505().getArray()).setKeyValue(new MFRotation506().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_l_hip_RotationInterpolator").setKey(new MFFloat507().getArray()).setKeyValue(new MFRotation508().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_lower_body_RotationInterpolator").setKey(new MFFloat509().getArray()).setKeyValue(new MFRotation510().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_wrist_RotationInterpolator").setKey(new MFFloat511().getArray()).setKeyValue(new MFRotation512().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_elbow_RotationInterpolator").setKey(new MFFloat513().getArray()).setKeyValue(new MFRotation514().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_shoulder_RotationInterpolator").setKey(new MFFloat515().getArray()).setKeyValue(new MFRotation516().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_l_wrist_RotationInterpolator").setKey(new MFFloat517().getArray()).setKeyValue(new MFRotation518().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_l_elbow_RotationInterpolator").setKey(new MFFloat519().getArray()).setKeyValue(new MFRotation520().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_l_shoulder_RotationInterpolator").setKey(new MFFloat521().getArray()).setKeyValue(new MFRotation522().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_head_RotationInterpolator").setKey(new MFFloat523().getArray()).setKeyValue(new MFRotation524().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_neck_RotationInterpolator").setKey(new MFFloat525().getArray()).setKeyValue(new MFRotation526().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_upper_body_RotationInterpolator").setKey(new MFFloat527().getArray()).setKeyValue(new MFRotation528().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_whole_body_RotationInterpolator").setKey(new MFFloat529().getArray()).setKeyValue(new MFRotation530().getArray()))
          .addChild(new PositionInterpolator("WalkAnimation").setDEF("Walk_whole_body_TranslationInterpolator").setKey(new MFFloat531().getArray()).setKeyValue(new MFVec3f532().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_l_sternoclavicular_RollInterpolator").setKey(new MFFloat533().getArray()).setKeyValue(new MFRotation534().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_l_acromioclavicular_RollInterpolator").setKey(new MFFloat535().getArray()).setKeyValue(new MFRotation536().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_sternoclavicular_RollInterpolator").setKey(new MFFloat537().getArray()).setKeyValue(new MFRotation538().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_acromioclavicular_RollInterpolator").setKey(new MFFloat539().getArray()).setKeyValue(new MFRotation540().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_sacroiliac_YawInterpolator").setKey(new MFFloat541().getArray()).setKeyValue(new MFRotation542().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_vl5_YawInterpolator").setKey(new MFFloat543().getArray()).setKeyValue(new MFRotation544().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_vc6_YawInterpolator").setKey(new MFFloat545().getArray()).setKeyValue(new MFRotation546().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_l_thumb1_PitchInterpolator").setKey(new MFFloat547().getArray()).setKeyValue(new MFRotation548().getArray()))
          .addChild(new OrientationInterpolator("WalkAnimation").setDEF("Walk_r_thumb1_PitchInterpolator").setKey(new MFFloat549().getArray()).setKeyValue(new MFRotation550().getArray())))
        .addChild(new Group().setDEF("RunAnimation")
          .addChild(new TimeSensor("RunAnimation").setDEF("RunTimer").setCycleInterval(0.9d).setLoop(true))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_metatarsal_PitchInterpolator").setKey(new MFFloat551().getArray()).setKeyValue(new MFRotation552().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_l_hip_RotationInterpolator_Run").setKey(new MFFloat553().getArray()).setKeyValue(new MFRotation554().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_l_knee_RotationInterpolator_Run").setKey(new MFFloat555().getArray()).setKeyValue(new MFRotation556().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_l_ankle_RotationInterpolator_Run").setKey(new MFFloat557().getArray()).setKeyValue(new MFRotation558().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_hip_RotationInterpolator_Run").setKey(new MFFloat559().getArray()).setKeyValue(new MFRotation560().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_knee_RotationInterpolator_Run").setKey(new MFFloat561().getArray()).setKeyValue(new MFRotation562().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_ankle_RotationInterpolator_Run").setKey(new MFFloat563().getArray()).setKeyValue(new MFRotation564().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_l_shoulder_RotationInterpolator_Run").setKey(new MFFloat565().getArray()).setKeyValue(new MFRotation566().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_l_elbow_RotationInterpolator_Run").setKey(new MFFloat567().getArray()).setKeyValue(new MFRotation568().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_l_wrist_RotationInterpolator_Run").setKey(new MFFloat569().getArray()).setKeyValue(new MFRotation570().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_shoulder_RotationInterpolator_Run").setKey(new MFFloat571().getArray()).setKeyValue(new MFRotation572().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_elbow_RotationInterpolator_Run").setKey(new MFFloat573().getArray()).setKeyValue(new MFRotation574().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_wrist_RotationInterpolator_Run").setKey(new MFFloat575().getArray()).setKeyValue(new MFRotation576().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_lower_body_RotationInterpolator_Run").setKey(new MFFloat577().getArray()).setKeyValue(new MFRotation578().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_head_RotationInterpolator_Run").setKey(new MFFloat579().getArray()).setKeyValue(new MFRotation580().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_neck_RotationInterpolator_Run").setKey(new MFFloat581().getArray()).setKeyValue(new MFRotation582().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_upper_body_RotationInterpolator_Run").setKey(new MFFloat583().getArray()).setKeyValue(new MFRotation584().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_whole_body_RotationInterpolator_Run").setKey(new MFFloat585().getArray()).setKeyValue(new MFRotation586().getArray()))
          .addChild(new PositionInterpolator("RunAnimation").setDEF("Run_whole_body_TranslationInterpolator_Run").setKey(new MFFloat587().getArray()).setKeyValue(new MFVec3f588().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_l_sternoclavicular_RollInterpolator").setKey(new MFFloat589().getArray()).setKeyValue(new MFRotation590().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_l_acromioclavicular_RollInterpolator").setKey(new MFFloat591().getArray()).setKeyValue(new MFRotation592().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_sternoclavicular_RollInterpolator").setKey(new MFFloat593().getArray()).setKeyValue(new MFRotation594().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_acromioclavicular_RollInterpolator").setKey(new MFFloat595().getArray()).setKeyValue(new MFRotation596().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_sacroiliac_YawInterpolator").setKey(new MFFloat597().getArray()).setKeyValue(new MFRotation598().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_vl5_YawInterpolator").setKey(new MFFloat599().getArray()).setKeyValue(new MFRotation600().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_vc6_YawInterpolator").setKey(new MFFloat601().getArray()).setKeyValue(new MFRotation602().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_l_thumb1_PitchInterpolator").setKey(new MFFloat603().getArray()).setKeyValue(new MFRotation604().getArray()))
          .addChild(new OrientationInterpolator("RunAnimation").setDEF("Run_r_thumb1_PitchInterpolator").setKey(new MFFloat605().getArray()).setKeyValue(new MFRotation606().getArray())))
        .addChild(new Group().setDEF("JumpAnimation")
          .addChild(new TimeSensor("JumpAnimation").setDEF("JumpTimer").setCycleInterval(3.73d).setLoop(true))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_metatarsal_PitchInterpolator").setKey(new MFFloat607().getArray()).setKeyValue(new MFRotation608().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_ankle_RotationInterpolator").setKey(new MFFloat609().getArray()).setKeyValue(new MFRotation610().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_knee_RotationInterpolator").setKey(new MFFloat611().getArray()).setKeyValue(new MFRotation612().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_hip_RotationInterpolator").setKey(new MFFloat613().getArray()).setKeyValue(new MFRotation614().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_l_ankle_RotationInterpolator").setKey(new MFFloat615().getArray()).setKeyValue(new MFRotation616().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_l_knee_RotationInterpolator").setKey(new MFFloat617().getArray()).setKeyValue(new MFRotation618().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_l_hip_RotationInterpolator").setKey(new MFFloat619().getArray()).setKeyValue(new MFRotation620().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_lower_body_RotationInterpolator").setKey(new MFFloat621().getArray()).setKeyValue(new MFRotation622().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_wrist_RotationInterpolator").setKey(new MFFloat623().getArray()).setKeyValue(new MFRotation624().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_elbow_RotationInterpolator").setKey(new MFFloat625().getArray()).setKeyValue(new MFRotation626().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_shoulder_RotationInterpolator").setKey(new MFFloat627().getArray()).setKeyValue(new MFRotation628().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_l_wrist_RotationInterpolator").setKey(new MFFloat629().getArray()).setKeyValue(new MFRotation630().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_l_elbow_RotationInterpolator").setKey(new MFFloat631().getArray()).setKeyValue(new MFRotation632().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_l_shoulder_RotationInterpolator").setKey(new MFFloat633().getArray()).setKeyValue(new MFRotation634().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_head_RotationInterpolator").setKey(new MFFloat635().getArray()).setKeyValue(new MFRotation636().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_neck_RotationInterpolator").setKey(new MFFloat637().getArray()).setKeyValue(new MFRotation638().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_upper_body_RotationInterpolator").setKey(new MFFloat639().getArray()).setKeyValue(new MFRotation640().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_whole_body_RotationInterpolator").setKey(new MFFloat641().getArray()).setKeyValue(new MFRotation642().getArray()))
          .addChild(new PositionInterpolator("JumpAnimation").setDEF("Jump_whole_body_TranslationInterpolator").setKey(new MFFloat643().getArray()).setKeyValue(new MFVec3f644().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_l_sternoclavicular_RollInterpolator").setKey(new MFFloat645().getArray()).setKeyValue(new MFRotation646().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_l_acromioclavicular_RollInterpolator").setKey(new MFFloat647().getArray()).setKeyValue(new MFRotation648().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_sternoclavicular_RollInterpolator").setKey(new MFFloat649().getArray()).setKeyValue(new MFRotation650().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_acromioclavicular_RollInterpolator").setKey(new MFFloat651().getArray()).setKeyValue(new MFRotation652().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_sacroiliac_YawInterpolator").setKey(new MFFloat653().getArray()).setKeyValue(new MFRotation654().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_vl5_YawInterpolator").setKey(new MFFloat655().getArray()).setKeyValue(new MFRotation656().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_vc6_YawInterpolator").setKey(new MFFloat657().getArray()).setKeyValue(new MFRotation658().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_l_thumb1_PitchInterpolator").setKey(new MFFloat659().getArray()).setKeyValue(new MFRotation660().getArray()))
          .addChild(new OrientationInterpolator("JumpAnimation").setDEF("Jump_r_thumb1_PitchInterpolator").setKey(new MFFloat661().getArray()).setKeyValue(new MFRotation662().getArray())))
        .addChild(new Group().setDEF("KickAnimation")
          .addChild(new TimeSensor("KickAnimation").setDEF("KickTimer").setCycleInterval(3.73d).setLoop(true))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_l_sternoclavicular_RollInterpolator").setKey(new MFFloat663().getArray()).setKeyValue(new MFRotation664().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_l_acromioclavicular_RollInterpolator").setKey(new MFFloat665().getArray()).setKeyValue(new MFRotation666().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_l_shoulder_RollInterpolator").setKey(new MFFloat667().getArray()).setKeyValue(new MFRotation668().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_l_ForeArm_PitchInterpolator").setKey(new MFFloat669().getArray()).setKeyValue(new MFRotation670().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_l_wrist_RollInterpolator").setKey(new MFFloat671().getArray()).setKeyValue(new MFRotation672().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_l_thumb1_PitchInterpolator").setKey(new MFFloat673().getArray()).setKeyValue(new MFRotation674().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_sternoclavicular_RollInterpolator").setKey(new MFFloat675().getArray()).setKeyValue(new MFRotation676().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_acromioclavicular_RollInterpolator").setKey(new MFFloat677().getArray()).setKeyValue(new MFRotation678().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_shoulder_RollInterpolator").setKey(new MFFloat679().getArray()).setKeyValue(new MFRotation680().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_ForeArm_PitchInterpolator").setKey(new MFFloat681().getArray()).setKeyValue(new MFRotation682().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_wrist_RollInterpolator").setKey(new MFFloat683().getArray()).setKeyValue(new MFRotation684().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_thumb1_PitchInterpolator").setKey(new MFFloat685().getArray()).setKeyValue(new MFRotation686().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_hip_PitchInterpolator").setKey(new MFFloat687().getArray()).setKeyValue(new MFRotation688().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_knee_PitchInterpolator").setKey(new MFFloat689().getArray()).setKeyValue(new MFRotation690().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_l_hip_PitchInterpolator").setKey(new MFFloat691().getArray()).setKeyValue(new MFRotation692().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_l_knee_PitchInterpolator").setKey(new MFFloat693().getArray()).setKeyValue(new MFRotation694().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_ankle_PitchInterpolator").setKey(new MFFloat695().getArray()).setKeyValue(new MFRotation696().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_r_metatarsal_PitchInterpolator").setKey(new MFFloat697().getArray()).setKeyValue(new MFRotation698().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_sacroiliac_YawInterpolator").setKey(new MFFloat699().getArray()).setKeyValue(new MFRotation700().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_vl5_YawInterpolator").setKey(new MFFloat701().getArray()).setKeyValue(new MFRotation702().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_vc6_YawInterpolator").setKey(new MFFloat703().getArray()).setKeyValue(new MFRotation704().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_lower_body_RotationInterpolator").setKey(new MFFloat705().getArray()).setKeyValue(new MFRotation706().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_upper_body_RotationInterpolator").setKey(new MFFloat707().getArray()).setKeyValue(new MFRotation708().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_whole_body_RotationInterpolator").setKey(new MFFloat709().getArray()).setKeyValue(new MFRotation710().getArray()))
          .addChild(new PositionInterpolator("KickAnimation").setDEF("Kick_whole_body_TranslationInterpolator").setKey(new MFFloat711().getArray()).setKeyValue(new MFVec3f712().getArray()))
          .addChild(new OrientationInterpolator("KickAnimation").setDEF("Kick_neck_RotationInterpolator").setKey(new MFFloat713().getArray()).setKeyValue(new MFRotation714().getArray())))
        .addChild(new Group().setDEF("Interface")
          .addChild(new Transform("Interface").setDEF("CoordinateSystemFloor").setScale(new float[] {0.1f,0.1f,0.1f})
            .addChild(new Shape("CoordinateSystemFloor").setDEF("AxisLinesShape")
              .addComments("RGB lines showing XYZ axes")
              .setGeometry(new IndexedLineSet("AxisLinesShape").setColorIndex(new MFInt32715().getArray()).setColorPerVertex(false).setCoordIndex(new MFInt32716().getArray())
                .setCoord(new Coordinate().setPoint(new MFVec3f717().getArray()))
                .setColor(new Color().setColor(new MFColor718().getArray())))))
          .addChild(new ProximitySensor("Interface").setDEF("HudProx").setSize(new float[] {50f,50f,50f}))
          .addChild(new Transform("Interface").setDEF("HudXform").setRotation(new float[] {0f,1f,0f,0.78f}).setTranslation(new float[] {2f,1f,2f})
            .addChild(new Transform("HudXform").setScale(new float[] {0.02f,0.02f,0.02f}).setTranslation(new float[] {-0.4f,-0.01f,-0.75f})
              .addChild(new Transform().setDEF("Stand_Text").setTranslation(new float[] {0f,-0.9f,0f})
                .addChild(new TouchSensor("Stand_Text").setDEF("Stand_Touch"))
                .addChild(new Shape("Stand_Text").setDEF("StandText")
                  .setAppearance(new Appearance("StandText")
                  ...
                  .setGeometry(new Text("StandText").setString(new MFString719().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString720().getArray()))))
                .addChild(new Shape("Stand_Text").setDEF("Stand_Back")
                  ...
                  .setGeometry(new IndexedFaceSet("Stand_Back").setDEF("Backing").setCoordIndex(new MFInt32721().getArray())
                    .setCoord(new Coordinate("Backing").setPoint(new MFVec3f722().getArray())))))
              .addChild(new Transform().setDEF("Pitch_Text").setTranslation(new float[] {0f,-2.4f,0f})
                .addChild(new TouchSensor("Pitch_Text").setDEF("Pitch_Touch"))
                .addChild(new Shape("Pitch_Text").setDEF("PitchText")
                  .setAppearance(new Appearance("PitchText")
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text("PitchText").setString(new MFString723().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString724().getArray()))))
                .addChild(new Shape("Pitch_Text").setDEF("Pitch_Back")
                  .setAppearance(new Appearance("Pitch_Back")
                    .setMaterial(new Material().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSet("Pitch_Back").setUSE("Backing"))))
              .addChild(new Transform().setDEF("Yaw_Text").setTranslation(new float[] {0f,-3.8f,0f})
                .addChild(new TouchSensor("Yaw_Text").setDEF("Yaw_Touch"))
                .addChild(new Shape("Yaw_Text").setDEF("YawText")
                  .setAppearance(new Appearance("YawText")
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text("YawText").setString(new MFString725().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString726().getArray()))))
                .addChild(new Shape("Yaw_Text").setDEF("Yaw_Back")
                  .setAppearance(new Appearance("Yaw_Back")
                    .setMaterial(new Material().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSet("Yaw_Back").setUSE("Backing"))))
              .addChild(new Transform().setDEF("Roll_Text").setTranslation(new float[] {0f,-5.2f,0f})
                .addChild(new TouchSensor("Roll_Text").setDEF("Roll_Touch"))
                .addChild(new Shape("Roll_Text").setDEF("RollText")
                  .setAppearance(new Appearance("RollText")
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text("RollText").setString(new MFString727().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString728().getArray()))))
                .addChild(new Shape("Roll_Text").setDEF("Roll_Back")
                  .setAppearance(new Appearance("Roll_Back")
                    .setMaterial(new Material().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSet("Roll_Back").setUSE("Backing"))))
              .addChild(new Transform().setDEF("Walk_Text").setTranslation(new float[] {0f,-6.6f,0f})
                .addChild(new TouchSensor("Walk_Text").setDEF("Walk_Touch"))
                .addChild(new Shape("Walk_Text").setDEF("WalkText")
                  .setAppearance(new Appearance("WalkText")
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text("WalkText").setString(new MFString729().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString730().getArray()))))
                .addChild(new Shape("Walk_Text").setDEF("Walk_Back")
                  .setAppearance(new Appearance("Walk_Back")
                    .setMaterial(new Material().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSet("Walk_Back").setUSE("Backing"))))
              .addChild(new Transform().setDEF("Run_Text").setTranslation(new float[] {0f,-8f,0f})
                .addChild(new TouchSensor("Run_Text").setDEF("Run_Touch"))
                .addChild(new Shape("Run_Text").setDEF("RunText")
                  .setAppearance(new Appearance("RunText")
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text("RunText").setString(new MFString731().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString732().getArray()))))
                .addChild(new Shape("Run_Text").setDEF("Run_Back")
                  .setAppearance(new Appearance("Run_Back")
                    .setMaterial(new Material().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSet("Run_Back").setUSE("Backing"))))
              .addChild(new Transform().setDEF("Jump_Text").setTranslation(new float[] {0f,-9.4f,0f})
                .addChild(new TouchSensor("Jump_Text").setDEF("Jump_Touch"))
                .addChild(new Shape("Jump_Text").setDEF("JumpText")
                  .setAppearance(new Appearance("JumpText")
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text("JumpText").setString(new MFString733().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString734().getArray()))))
                .addChild(new Shape("Jump_Text").setDEF("Jump_Back")
                  .setAppearance(new Appearance("Jump_Back")
                    .setMaterial(new Material().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSet("Jump_Back").setUSE("Backing"))))
              .addChild(new Transform().setDEF("Kick_Text").setTranslation(new float[] {0f,-10.8f,0f})
                .addChild(new TouchSensor("Kick_Text").setDEF("Kick_Touch"))
                .addChild(new Shape("Kick_Text").setDEF("KickText")
                  .setAppearance(new Appearance("KickText")
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text("KickText").setString(new MFString735().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString736().getArray()))))
                .addChild(new Shape("Kick_Text").setDEF("Kick_Back")
                  .setAppearance(new Appearance("Kick_Back")
                    .setMaterial(new Material().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSet("Kick_Back").setUSE("Backing"))))
              .addChild(new Transform().setDEF("Stop_Text").setTranslation(new float[] {0f,0.4f,0f})
                .addChild(new TouchSensor("Stop_Text").setDEF("Stop_Touch"))
                .addChild(new Shape("Stop_Text").setDEF("StopText")
                  .setAppearance(new Appearance("StopText")
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text("StopText").setString(new MFString737().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString738().getArray()))))
                .addChild(new Shape("Stop_Text").setDEF("Stop_Back")
                  .setAppearance(new Appearance("Stop_Back")
                    .setMaterial(new Material().setUSE("Clear")))
                  .setGeometry(new IndexedFaceSet("Stop_Back").setUSE("Backing"))))
              .addChild(new Transform().setDEF("SceneLabel").setTranslation(new float[] {1.3f,3f,0f})
                .addChild(new Shape("SceneLabel").setDEF("SceneLabelText")
                  .setAppearance(new Appearance("SceneLabelText")
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text("SceneLabelText").setString(new MFString739().getArray())
                    .setFontStyle(new FontStyle().setFamily(new MFString740().getArray()).setJustify(new MFString741().getArray()))))))))
...
protected class MFRotation682 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {1f,0f,0f,0f,1f,0f,0f,-0.55f,1f,0.25f,0f,-2.55f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f,0f,0f});
  }
}
protected class MFFloat683 {
  protected org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f,0.2f,0.4f,0.6f,0.8f,1f});
  }
}
protected class MFRotation684 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {0f,0f,1f,0f,0f,0f,1f,0f,0f,1f,0f,-0.55f,0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f});
  }
}
...
protected class MFFloat689 {
  protected org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f,0.2f,0.4f,0.6f,0.8f,1f});
  }
}
protected class MFRotation690 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {
...
protected class MFRotation694 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f});
  }
}
protected class MFFloat695 {
  protected org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f,0.2f,0.4f,0.6f,0.7f,1f});
  }
}
protected class MFRotation696 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {
...
protected class MFRotation700 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {0f,1f,0f,0f,0f,-1f,0f,0.1f,0f,1f,0f,0f,0f,1f,-1f,0.24f,0f,-1f,0f,0.4f,0f,1f,0f,0f});
  }
}
protected class MFFloat701 {
  protected org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f,0.2f,0.4f,0.5f,0.6f,0.8f,1f});
  }
}
protected class MFRotation702 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f});
  }
}
...
protected class MFRotation706 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f});
  }
}
protected class MFFloat707 {
  protected org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f,0.5f,1f});
  }
}
protected class MFRotation708 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {
    return new org.web3d.x3d.jsail.fields.MFRotation(new float[] {0f,0f,1f,0f,0f,0f,1f,0f,0f,0f,1f,0f});
  }
}
...
protected class MFVec3f712 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {0f,0f,0f,0f,0f,0f,0f,0f,0f});
  }
}
protected class MFFloat713 {
  protected org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new float[] {0f,0.25f,0.55f,1f});
  }
}
protected class MFRotation714 {
  protected org.web3d.x3d.jsail.fields.MFRotation getArray() {

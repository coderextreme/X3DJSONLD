...
"					}"))
        ...
        .addChild(new ProtoDeclare().setName("cylinder")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Shape()
              .setGeometry(new Extrusion().setDEF("extrusion").setCreaseAngle(0.7850f).setCrossSection(new MFVec2f2().getArray()).setSpine(new MFVec3f3().getArray()))
              .setAppearance(new Appearance()
...
protected class MFVec3f3 {
  protected org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new float[] {0.0000f,-50.0000f,0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,50.0000f,0.0000f});
  }
}
}

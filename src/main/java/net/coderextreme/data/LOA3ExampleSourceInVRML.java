...
public class LOA3ExampleSourceInVRML {
  public static void main(String[] args) {
    ...
    new LOA3ExampleSourceInVRML().initialize().toFileJSON("../data/LOA3ExampleSourceInVRML.new.json");
    }
...
ProtoInstance ProtoInstance534 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("JointCenters_WorldInfo")
          .addChild(new WorldInfo().setTitle("HANIM 200x Default Joint Centers, LOA&#8209;3").setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString0().getArray()))))

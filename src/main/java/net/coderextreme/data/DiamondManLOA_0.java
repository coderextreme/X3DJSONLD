...
public class DiamondManLOA_0 {
  public static void main(String[] args) {
    ...
    X3D model = new DiamondManLOA_0().initialize();
    System.out.print(model.validationReport().trim());
    model.toFileJSON("../data/DiamondManLOA_0.new.json");
    }
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("humanoid").setDEF("hanim_humanoid").setVersion("1.0")
          ...
          .addSkeleton(new HAnimJoint().setName("HumanoidRoot").setDEF("hanim_HumanoidRoot").setCenter(new float[] {0f,0.824f,0.0277f}).setUlimit(new MFFloat7().getArray()).setLlimit(new MFFloat8().getArray())

                                          ...
                                          .addChild(new HAnimJoint().setName("vt3").setDEF("hanim_vt3").setCenter(new float[] {0f,52.040001f,-0.6117f}).setUlimit(new MFFloat439().getArray()).setLlimit(new MFFloat440().getArray())
                                            ...
                                            .addChild(new HAnimJoint().setName("vt2").setDEF("hanim_vt2").setCenter(new float[] {0f,53.139999f,-0.6127f}).setUlimit(new MFFloat445().getArray()).setLlimit(new MFFloat446().getArray())
                                              ...
                                              .addChild(new HAnimJoint().setName("vt1").setDEF("hanim_vt1").setCenter(new float[] {0f,54.200001f,-0.6117f}).setUlimit(new MFFloat451().getArray()).setLlimit(new MFFloat452().getArray())
                                                ...
                                                .addChild(new HAnimJoint().setName("l_acromioclavicular").setDEF("hanim_l_acromioclavicular").setCenter(new float[] {1.71f,53.720001f,-0.6127f}).setUlimit(new MFFloat553().getArray()).setLlimit(new MFFloat554().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint().setName("l_sternoclavicular").setDEF("hanim_l_sternoclavicular").setCenter(new float[] {5.464f,52.970001f,-0.5732f}).setUlimit(new MFFloat559().getArray()).setLlimit(new MFFloat560().getArray())
                                                ...
                                                .addChild(new HAnimJoint().setName("r_acromioclavicular").setDEF("hanim_r_acromioclavicular").setCenter(new float[] {-1.71f,53.720001f,-0.6127f}).setUlimit(new MFFloat721().getArray()).setLlimit(new MFFloat722().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint().setName("r_sternoclavicular").setDEF("hanim_r_sternoclavicular").setCenter(new float[] {-5.464f,52.970001f,-0.5732f}).setUlimit(new MFFloat727().getArray()).setLlimit(new MFFloat728().getArray())

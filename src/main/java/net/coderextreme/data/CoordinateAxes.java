        ...
        .addChild(new Collision().setDEF("DoNotCollideWithVisualizationWidget")
          ...
          .addChild(new Group()
            ...
            .addChild(new Group().setDEF("ArrowGreen")
              .addChild(new Shape()
                .setGeometry(new Cylinder().setDEF("ArrowCylinder").setRadius(0.0250f).setTop(false))
              ...
              .addChild(new Transform().setTranslation(new float[] {0f,1f,0f})
                .addChild(new Shape()
                  .setGeometry(new Cone().setDEF("ArrowCone").setBottomRadius(0.0500f).setHeight(0.1000f))
              ...
              .addChild(new Billboard()
                .addChild(new Shape()
                  ...
                  .setGeometry(new Text().setString(new MFString0().getArray())
                    .setFontStyle(new FontStyle().setDEF("LABEL_FONT").setFamily(new MFString1().getArray()).setJustify(new MFString2().getArray()).setSize(0.2000f)))))))

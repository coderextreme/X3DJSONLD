  ...
  public static void main(String[] args) {
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setTranslation(new float[] {-1f,1f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true)
          .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString0().getArray())).setRefresh("0").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true))
          ...
          .addChild(new Transform().setDEF("GridXY_20x20Fixed_AdjustScale").setScale(new float[] {0.1f,0.1f,0.1f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true)
            .addChild(new Inline().setDEF("GridXY_20x20Fixed").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray())).setRefresh("0").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true))))
        .addChild(new Transform().setTranslation(new float[] {1f,1f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true)
          .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())).setRefresh("0").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true))
          .addChild(new Transform().setUSE("GridXY_20x20Fixed_AdjustScale")))
        .addChild(new Transform().setTranslation(new float[] {-1f,-1f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true)
          .addComments(new CommentsBlock("rotation='0 0 1 3.141593'"))
          .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString3().getArray())).setRefresh("0").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true))
          .addChild(new Transform().setUSE("GridXY_20x20Fixed_AdjustScale")))
        .addChild(new Transform().setTranslation(new float[] {1f,-1f,0f}).setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true)
          .addComments(new CommentsBlock("rotation='0 0 1 3.141593'"))
          .addChild(new Inline().setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString4().getArray())).setRefresh("0").setBboxCenter(new float[] {0f,0f,0f}).setBboxSize(new float[] {-1f,-1f,-1f}).setBboxDisplay(false).setVisible(true))
          .addChild(new Transform().setUSE("GridXY_20x20Fixed_AdjustScale"))))      ;
    return X3D0;
    }

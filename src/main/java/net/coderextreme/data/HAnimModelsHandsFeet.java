  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new TransformObject().setTranslation(new float[] {-1f,1f,0f}).setDisplayBBox(false)
          .addChild(new InlineObject().setUrl(new MFStringObject(new MFString0().getArray())).setDisplayBBox(false))
          ...
          .addChild(new TransformObject().setDEF("GridXY_20x20Fixed_AdjustScale").setScale(new float[] {0.1f,0.1f,0.1f}).setDisplayBBox(false)
            .addChild(new InlineObject().setDEF("GridXY_20x20Fixed").setUrl(new MFStringObject(new MFString1().getArray())).setDisplayBBox(false))))
        .addChild(new TransformObject().setTranslation(new float[] {1f,1f,0f}).setDisplayBBox(false)
          .addChild(new InlineObject().setUrl(new MFStringObject(new MFString2().getArray())).setDisplayBBox(false))
          .addChild(new TransformObject().setUSE("GridXY_20x20Fixed_AdjustScale")))
        .addChild(new TransformObject().setTranslation(new float[] {-1f,-1f,0f}).setDisplayBBox(false)
          .addComments(new CommentsBlock("rotation='0 0 1 3.141593'"))
          .addChild(new InlineObject().setUrl(new MFStringObject(new MFString3().getArray())).setDisplayBBox(false))
          .addChild(new TransformObject().setUSE("GridXY_20x20Fixed_AdjustScale")))
        .addChild(new TransformObject().setTranslation(new float[] {1f,-1f,0f}).setDisplayBBox(false)
          .addComments(new CommentsBlock("rotation='0 0 1 3.141593'"))
          .addChild(new InlineObject().setUrl(new MFStringObject(new MFString4().getArray())).setDisplayBBox(false))
          .addChild(new TransformObject().setUSE("GridXY_20x20Fixed_AdjustScale"))))      ;
    return X3D0;
    }

    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new Shape()
          ...
          .setGeometry(new Text().setDEF("DefaultText").setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1().getArray()))
            .setFontStyle(new FontStyle().setDEF("CenteredFontStyle").setJustify(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray()))))
...
protected class MFString1 {
  protected org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"Character entity substitutions:","empty string \"\" skips a line:","","apostrophe ' is &apos;","ampersand & is &amp;","quote mark \" is &quot;","backslash \\\\ is X3D escape character","double backslash \\\\\\\\ is X3D backslash \\\\ character","Pi Π is &#928; XML character entity"});
  }
}

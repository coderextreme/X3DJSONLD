...
public class HAnimSpecificationLOA3Motion {
  public static void main(String[] args) {
    ...
    new HAnimSpecificationLOA3Motion().initialize().toFileJSON("../data/HAnimSpecificationLOA3Motion.new.json");
    }
    public X3D initialize() {
      X3D X3D0 =  new X3D().setProfile("Immersive").setVersion("3.3")
      .setHead(new head()
        .addComponent(new component().setName("HAnim").setLevel(1))
        .addMeta(new meta().setName("title").setContent("HAnimSpecificationLOA3Motion.x3d"))
        ...
        .addMeta(new meta().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/HAnimSpecificationLOA3Motion.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("humanoid").setDEF("hanim_humanoid").setInfo(new org.web3d.x3d.jsail.fields.MFString(new MFString2().getArray())).setVersion("1.0")
                                                              ...
                                                              .addChild(new HAnimJoint().setName("l_eyeball_joint").setDEF("hanim_l_eyeball_joint").setCenter(new float[] {0.0336f,1.6332f,0.0502f})
                                                                .addChild(new HAnimSegment().setName("l_eyeball").setDEF("hanim_l_eyeball")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("l_eyeball_site_view").setDEF("hanim_l_eyeball_site_view").setTranslation(new float[] {0.034f,1.64f,0.05f})
                                                                    ...
                                                                    .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_l_eyeball_site_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString210().getArray()))
                                                              ...
                                                              .addChild(new HAnimJoint().setName("r_eyeball_joint").setDEF("hanim_r_eyeball_joint").setCenter(new float[] {-0.0336f,1.6332f,0.0502f})
                                                                .addChild(new HAnimSegment().setName("r_eyeball").setDEF("hanim_r_eyeball")
                                                                  ...
                                                                  .addChild(new HAnimSite().setName("r_eyeball_site_view").setDEF("hanim_r_eyeball_site_view").setTranslation(new float[] {-0.034f,1.64f,0.05f})
                                                                    ...
                                                                    .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
                                                                    .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_r_eyeball_site_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString217().getArray()))
                                                      ...
                                                      .addChild(new HAnimJoint().setName("l_wrist").setDEF("hanim_l_wrist").setCenter(new float[] {0.1984f,0.8663f,-0.0583f})
                                                        .addChild(new HAnimSegment().setName("l_hand").setDEF("hanim_l_hand")
                                                          ...
                                                          .addChild(new HAnimSite().setName("l_hand_front_view").setDEF("hanim_l_hand_front_view").setTranslation(new float[] {0.3f,0.75f,0.45f})
                                                            ...
                                                            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
                                                            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_l_hand_front_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString268().getArray()))
                                                      ...
                                                      .addChild(new HAnimJoint().setName("r_wrist").setDEF("hanim_r_wrist").setCenter(new float[] {-0.1984f,0.8663f,-0.0583f})
                                                        .addChild(new HAnimSegment().setName("r_hand").setDEF("hanim_r_hand")
                                                          ...
                                                          .addChild(new HAnimSite().setName("r_hand_front_view").setDEF("hanim_r_hand_front_view").setTranslation(new float[] {-0.3f,0.75f,0.45f})
                                                            ...
                                                            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
                                                            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_r_hand_front_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString355().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("l_inclined_view").setDEF("hanim_l_inclined_view").setRotation(new float[] {-0.113f,0.993f,0.0347f,0.671f}).setTranslation(new float[] {1.62f,1.05f,2.06f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_l_inclined_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString398().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("r_inclined_view").setDEF("hanim_r_inclined_view").setRotation(new float[] {-0.113f,-0.993f,0.0347f,0.671f}).setTranslation(new float[] {-1.62f,1.05f,2.06f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_r_inclined_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString401().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("front_view").setDEF("hanim_front_view").setTranslation(new float[] {0f,0.85f,2.58f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_front_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString404().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("back_view").setDEF("hanim_back_view").setRotation(new float[] {0f,1f,0f,3.14f}).setTranslation(new float[] {0f,0.85f,-2.58f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_back_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString407().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("l_side_view").setDEF("hanim_l_side_view").setRotation(new float[] {0f,1f,0f,1.5708f}).setTranslation(new float[] {2.6f,0.854f,0f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_l_side_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString410().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("Top_view").setDEF("hanim_Top_view").setRotation(new float[] {1f,0f,0f,-1.57f}).setTranslation(new float[] {0f,3.5f,0f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_Top_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString413().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("front_close_view").setDEF("hanim_front_close_view").setTranslation(new float[] {0f,0.854f,1.575f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_front_close_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString416().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("side_close_view").setDEF("hanim_side_close_view").setRotation(new float[] {0f,1f,0f,1.5708f}).setTranslation(new float[] {1.56f,0.854f,0f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_side_close_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString419().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("head_front_close_view").setDEF("hanim_head_front_close_view").setTranslation(new float[] {0f,1.5f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_head_front_close_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString422().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("chest_front_close_view").setDEF("hanim_chest_front_close_view").setTranslation(new float[] {0f,1.2f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_chest_front_close_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString425().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("pelvis_front_close_view").setDEF("hanim_pelvis_front_close_view").setTranslation(new float[] {0f,0.8f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_pelvis_front_close_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString428().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("knees_front_close_view").setDEF("hanim_knees_front_close_view").setTranslation(new float[] {0f,0.4f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_knees_front_close_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString431().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("feet_front_close_view").setDEF("hanim_feet_front_close_view").setTranslation(new float[] {0f,0f,1f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_feet_front_close_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString434().getArray()))
          ...
          .addViewpoints(new HAnimSite().setName("eye_level_view").setDEF("hanim_eye_level_view").setTranslation(new float[] {0f,1.6332f,0.0502f})
            ...
            .addComments(new CommentsBlock("HAnimSite/Viewpoint visualization shape"))
            .addChild(new Anchor().setDescription("HAnimSite Viewpoint hanim_eye_level_view").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString437().getArray()))
        ...
        .addChild(new Group().setDEF("StopAnimation")
          ...
          .addChild(new PositionInterpolator().setDEF("Stop_HumanoidRoot_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat440().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f441().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_HumanoidRoot_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat442().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation443().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_sacroiliac_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat444().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation445().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat446().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation447().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat448().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation449().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat450().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation451().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_subtalar_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat452().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation453().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_midtarsal_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat454().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation455().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_metatarsal_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat456().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation457().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat458().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation459().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat460().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation461().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat462().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation463().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_subtalar_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat464().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation465().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_midtarsal_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat466().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation467().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_metatarsal_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat468().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation469().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl5_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat470().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation471().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl4_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat472().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation473().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat474().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation475().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat476().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation477().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vl1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat478().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation479().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt12_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat480().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation481().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt11_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat482().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation483().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt10_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat484().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation485().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt9_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat486().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation487().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt8_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat488().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation489().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt7_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat490().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation491().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt6_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat492().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation493().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt5_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat494().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation495().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt4_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat496().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation497().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat498().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation499().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat500().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation501().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vt1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat502().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation503().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc7_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat504().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation505().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc6_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat506().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation507().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc5_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat508().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation509().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc4_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat510().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation511().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat512().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation513().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat514().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation515().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_vc1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat516().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation517().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_skullbase_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat518().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation519().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_eyeball_joint_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat520().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation521().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_eyeball_joint_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat522().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation523().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_sternoclavicular_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat524().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation525().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_acromioclavicular_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat526().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation527().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat528().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation529().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat530().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation531().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat532().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation533().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_thumb1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat534().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation535().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_thumb2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat536().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation537().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_thumb3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat538().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation539().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_index0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat540().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation541().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_index1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat542().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation543().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_index2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat544().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation545().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_index3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat546().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation547().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_middle0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat548().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation549().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_middle1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat550().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation551().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_middle2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat552().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation553().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_middle3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat554().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation555().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ring0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat556().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation557().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ring1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat558().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation559().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ring2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat560().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation561().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_ring3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat562().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation563().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_pinky0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat564().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation565().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_pinky1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat566().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation567().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_pinky2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat568().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation569().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_l_pinky3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat570().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation571().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_sternoclavicular_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat572().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation573().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_acromioclavicular_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat574().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation575().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat576().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation577().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat578().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation579().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat580().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation581().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_thumb1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat582().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation583().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_thumb2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat584().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation585().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_thumb3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat586().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation587().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_index0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat588().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation589().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_index1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat590().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation591().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_index2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat592().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation593().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_index3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat594().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation595().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_middle0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat596().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation597().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_middle1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat598().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation599().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_middle2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat600().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation601().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_middle3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat602().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation603().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ring0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat604().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation605().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ring1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat606().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation607().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ring2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat608().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation609().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_ring3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat610().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation611().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_pinky0_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat612().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation613().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_pinky1_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat614().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation615().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_pinky2_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat616().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation617().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stop_r_pinky3_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat618().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation619().getArray())))
        ...
        .addChild(new Group().setDEF("StandAnimation")
          ...
          .addChild(new OrientationInterpolator().setDEF("Stand_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat620().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation621().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat622().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation623().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat624().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation625().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat626().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation627().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat628().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation629().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat630().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation631().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat632().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation633().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat634().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation635().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat636().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation637().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat638().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation639().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat640().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation641().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat642().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation643().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat644().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation645().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat646().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation647().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat648().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation649().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_eyeball_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat650().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation651().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_eyeball_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat652().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation653().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat654().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation655().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat656().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation657().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat658().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation659().getArray())))
          .addChild(new PositionInterpolator().setDEF("Stand_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat660().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f661().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat662().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation663().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat664().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation665().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat666().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation667().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat668().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation669().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat670().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation671().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat672().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation673().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat674().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation675().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat676().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation677().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat678().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation679().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_index1_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat680().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation681().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_index2_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat682().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation683().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Stand_r_index3_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat684().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation685().getArray())))
        ...
        .addChild(new Group().setDEF("PitchesAnimation")
          ...
          .addChild(new OrientationInterpolator().setDEF("Pitch_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat686().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation687().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat688().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation689().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat690().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation691().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat692().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation693().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat694().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation695().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat696().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation697().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat698().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation699().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat700().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation701().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat702().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation703().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat704().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation705().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat706().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation707().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat708().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation709().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat710().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation711().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat712().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation713().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat714().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation715().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat716().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation717().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat718().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation719().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitches_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat720().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation721().getArray())))
          .addChild(new PositionInterpolator().setDEF("Pitches_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat722().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f723().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat724().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation725().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat726().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation727().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat728().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation729().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat730().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation731().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat732().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation733().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat734().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation735().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat736().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation737().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat738().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation739().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Pitch_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat740().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation741().getArray())))
        ...
        .addChild(new Group().setDEF("YawsAnimation")
          ...
          .addChild(new OrientationInterpolator().setDEF("Yaw_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat742().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation743().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat744().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation745().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat746().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation747().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat748().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation749().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat750().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation751().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat752().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation753().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat754().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation755().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat756().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation757().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat758().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation759().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat760().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation761().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat762().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation763().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat764().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation765().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat766().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation767().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat768().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation769().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat770().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation771().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat772().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation773().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat774().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation775().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaws_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat776().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation777().getArray())))
          .addChild(new PositionInterpolator().setDEF("Yaws_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat778().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f779().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat780().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation781().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat782().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation783().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat784().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation785().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat786().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation787().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat788().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation789().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat790().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation791().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat792().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation793().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat794().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation795().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Yaw_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat796().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation797().getArray())))
        ...
        .addChild(new Group().setDEF("RollsAnimation")
          ...
          .addChild(new OrientationInterpolator().setDEF("Roll_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat798().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation799().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat800().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation801().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat802().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation803().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat804().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation805().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat806().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation807().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat808().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation809().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat810().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation811().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat812().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation813().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat814().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation815().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat816().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation817().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat818().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation819().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat820().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation821().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat822().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation823().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat824().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation825().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat826().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation827().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat828().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation829().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat830().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation831().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Rolls_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat832().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation833().getArray())))
          .addChild(new PositionInterpolator().setDEF("Rolls_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat834().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f835().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat836().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation837().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat838().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation839().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat840().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation841().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat842().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation843().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat844().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation845().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat846().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation847().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat848().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation849().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat850().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation851().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Roll_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat852().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation853().getArray())))
        ...
        .addChild(new Group().setDEF("WalkAnimation")
          ...
          .addChild(new OrientationInterpolator().setDEF("Walk_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat854().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation855().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat856().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation857().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat858().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation859().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat860().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation861().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat862().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation863().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat864().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation865().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat866().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation867().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat868().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation869().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat870().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation871().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat872().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation873().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat874().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation875().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat876().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation877().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat878().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation879().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat880().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation881().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat882().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation883().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat884().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation885().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat886().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation887().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat888().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation889().getArray())))
          .addChild(new PositionInterpolator().setDEF("Walk_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat890().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f891().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat892().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation893().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat894().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation895().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat896().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation897().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat898().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation899().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat900().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation901().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat902().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation903().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat904().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation905().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat906().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation907().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Walk_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat908().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation909().getArray())))
        ...
        .addChild(new Group().setDEF("RunAnimation")
          ...
          .addChild(new OrientationInterpolator().setDEF("Run_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat910().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation911().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_hip_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat912().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation913().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_knee_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat914().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation915().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_ankle_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat916().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation917().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_hip_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat918().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation919().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_knee_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat920().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation921().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_ankle_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat922().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation923().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_shoulder_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat924().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation925().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_elbow_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat926().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation927().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_wrist_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat928().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation929().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_shoulder_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat930().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation931().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_elbow_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat932().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation933().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_wrist_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat934().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation935().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_lower_body_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat936().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation937().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_head_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat938().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation939().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_neck_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat940().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation941().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_upper_body_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat942().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation943().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_whole_body_RotationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat944().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation945().getArray())))
          .addChild(new PositionInterpolator().setDEF("Run_whole_body_TranslationInterpolator_Run").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat946().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f947().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat948().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation949().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat950().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation951().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat952().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation953().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat954().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation955().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat956().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation957().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat958().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation959().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat960().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation961().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat962().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation963().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Run_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat964().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation965().getArray())))
        ...
        .addChild(new Group().setDEF("JumpAnimation")
          ...
          .addChild(new OrientationInterpolator().setDEF("Jump_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat966().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation967().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat968().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation969().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat970().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation971().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat972().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation973().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_ankle_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat974().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation975().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_knee_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat976().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation977().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_hip_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat978().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation979().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat980().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation981().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat982().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation983().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat984().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation985().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat986().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation987().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_wrist_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat988().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation989().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_elbow_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat990().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation991().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_shoulder_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat992().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation993().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_head_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat994().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation995().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat996().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation997().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat998().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation999().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1000().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1001().getArray())))
          .addChild(new PositionInterpolator().setDEF("Jump_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1002().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f1003().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1004().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1005().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1006().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1007().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1008().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1009().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1010().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1011().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1012().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1013().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1014().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1015().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1016().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1017().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1018().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1019().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Jump_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1020().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1021().getArray())))
        ...
        .addChild(new Group().setDEF("KickAnimation")
          ...
          .addChild(new OrientationInterpolator().setDEF("Kick_l_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1022().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1023().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1024().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1025().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_shoulder_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1026().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1027().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_ForeArm_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1028().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1029().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_wrist_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1030().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1031().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1032().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1033().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_sternoclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1034().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1035().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_acromioclavicular_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1036().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1037().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_shoulder_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1038().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1039().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_ForeArm_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1040().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1041().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_wrist_RollInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1042().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1043().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_thumb1_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1044().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1045().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_hip_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1046().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1047().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_knee_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1048().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1049().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_hip_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1050().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1051().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_l_knee_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1052().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1053().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_ankle_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1054().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1055().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_r_metatarsal_PitchInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1056().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1057().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_sacroiliac_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1058().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1059().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_vl5_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1060().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1061().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_vc6_YawInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1062().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1063().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_lower_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1064().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1065().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_upper_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1066().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1067().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_whole_body_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1068().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1069().getArray())))
          .addChild(new PositionInterpolator().setDEF("Kick_whole_body_TranslationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1070().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f1071().getArray())))
          .addChild(new OrientationInterpolator().setDEF("Kick_neck_RotationInterpolator").setKey(new org.web3d.x3d.jsail.fields.MFFloat(new MFFloat1072().getArray())).setKeyValue(new org.web3d.x3d.jsail.fields.MFRotation(new MFRotation1073().getArray())))
        ...
        .addChild(new Group().setDEF("UserInterface")
          ...
          .addChild(new Transform().setDEF("CoordinateAxesAdjustedScale").setScale(new float[] {0.175f,0.175f,0.175f})
            .addChild(new Inline().setDEF("CoordinateAxes").setUrl(new org.web3d.x3d.jsail.fields.MFString(new MFString1074().getArray()))))
          ...
          .addChild(new Transform().setDEF("Stage").setScale(new float[] {1f,0.0125f,1f}).setTranslation(new float[] {0f,-0.0125f,0f})
            ...
            .addChild(new Transform().setDEF("Circle0").setScale(new float[] {1.175f,1f,1.175f})
              .addChild(new Shape()
                ...
                .setGeometry(new IndexedLineSet().setDEF("Orbit1").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt321075().getArray()))
                  .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f1076().getArray()))))))
            ...
            .addChild(new Transform().setScale(new float[] {0.035f,0.035f,0.035f}).setTranslation(new float[] {-0.42f,-0.2f,-0.75f})
              .addChild(new Transform().setDEF("StandTransform").setTranslation(new float[] {0f,-1f,0f})
                ...
                .addChild(new Shape().setDEF("StandTextShape")
                  ...
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1077().getArray()))))
                .addChild(new Shape().setDEF("Stand_Back")
                  ...
                  .setGeometry(new IndexedFaceSet().setDEF("Backing").setCoordIndex(new org.web3d.x3d.jsail.fields.MFInt32(new MFInt321078().getArray()))
                    .setCoord(new Coordinate().setPoint(new org.web3d.x3d.jsail.fields.MFVec3f(new MFVec3f1079().getArray()))))))
              .addChild(new Transform().setDEF("PitchTransform").setTranslation(new float[] {3f,-1f,0f})
                ...
                .addChild(new Shape().setDEF("PitchTextShape")
                  ...
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1080().getArray()))))
              ...
              .addChild(new Transform().setDEF("YawTransform").setTranslation(new float[] {6f,-1f,0f})
                ...
                .addChild(new Shape().setDEF("YawText")
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1081().getArray()))))
              ...
              .addChild(new Transform().setDEF("RollTransform").setTranslation(new float[] {9f,-1f,0f})
                ...
                .addChild(new Shape().setDEF("_RollInterpolator")
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1082().getArray()))))
              ...
              .addChild(new Transform().setDEF("WalkTransform").setTranslation(new float[] {12f,-1f,0f})
                ...
                .addChild(new Shape().setDEF("WalkText")
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1083().getArray()))))
              ...
              .addChild(new Transform().setDEF("RunTransform").setTranslation(new float[] {15f,-1f,0f})
                ...
                .addChild(new Shape().setDEF("RunText")
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1084().getArray()))))
              ...
              .addChild(new Transform().setDEF("JumpTransform").setTranslation(new float[] {18f,-1f,0f})
                ...
                .addChild(new Shape().setDEF("Jump")
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1085().getArray()))))
              ...
              .addChild(new Transform().setDEF("KickTransform").setTranslation(new float[] {21f,-1f,0f})
                ...
                .addChild(new Shape().setDEF("KickText")
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1086().getArray()))))
              ...
              .addChild(new Transform().setDEF("Stop_Text").setTranslation(new float[] {0f,1.4f,0f})
                ...
                .addChild(new Shape().setDEF("StopText")
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("text_color")))
                  .setGeometry(new Text().setString(new org.web3d.x3d.jsail.fields.MFString(new MFString1087().getArray()))))

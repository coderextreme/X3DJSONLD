...
public class NewChannelSelector extends org.web3d.x3d.jsail.Sound.ChannelSelector {
	...
	public ChannelSelector setChildren(X3DNode[] leftOver) { children = leftOver; super.setChildren(leftOver); return this; }

...
public class NewHAnimSegment extends org.web3d.x3d.jsail.HAnim.HAnimSegment {
	...
	public HAnimSegment setChildren(X3DNode[] leftOver) { children = leftOver; super.setChildren(leftOver); return this; }
	private X3DNode[] displacers = null;
	public X3DNode[] getDisplacers() { displacers = super.getDisplacers(); return displacers; }
	public X3DNode[] removeSelectedDisplacers(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = (List<X3DNode>)Arrays.asList(displacers);
		if (list.removeAll(toRemove)) { super.setDisplacers((X3DNode[])(list.toArray())); };
		return super.getDisplacers();
	}
	public HAnimSegment setDisplacers(X3DNode[] leftOver) { displacers = leftOver; super.setDisplacers(leftOver); return this; }

...
public class NewComposedShader extends org.web3d.x3d.jsail.Shaders.ComposedShader {
	...
	public ComposedShader setFieldList(ArrayList<field> leftOver) { fieldList = leftOver; super.setFieldList(leftOver); return this; }
	private X3DNode[] parts = null;
	public X3DNode[] getParts() { parts = super.getParts(); return parts; }
	public X3DNode[] removeSelectedParts(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = Arrays.stream(super.getParts()).collect(Collectors.toList());
		System.err.println("List length = "+list.size());
		if (list.removeAll(toRemove)) { super.setParts(list.toArray(new X3DNode[0])); };
		System.err.println("After list length = "+super.getParts().length);
		return super.getParts();
	}
	public ComposedShader setParts(X3DNode[] leftOver) { parts = leftOver; super.setParts(leftOver); return this; }

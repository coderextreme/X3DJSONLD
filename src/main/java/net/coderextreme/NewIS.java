...
public class NewIS extends org.web3d.x3d.jsail.Core.IS {
	private ArrayList<connect> connectList = null;
	public ArrayList<connect> getConnectList() { connectList = super.getConnectList(); return connectList; }
	public ArrayList<connect> removeSelectedConnectList(ArrayList<connect> children, HashSet toRemove) { connectList.removeAll(toRemove); return super.getConnectList(); }
	public IS setConnectList(ArrayList<connect> leftOver) { connectList = leftOver; super.setConnectList(leftOver); return this; }
	public void removeAll(HashSet toRemove) {
		connectList.removeAll(toRemove);
	}
}

...
public class NewDynamicsCompressor extends org.web3d.x3d.jsail.Sound.DynamicsCompressor {
	...
	public DynamicsCompressor setChildren(X3DNode[] leftOver) { children = leftOver; super.setChildren(leftOver); return this; }

...
public class bumpyx_itesliders implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D(".././bumpyx_itesliders.new.java.x3d");
    model.toFileJSON(".././bumpyx_itesliders.new.java.json");
    }
      ...
      .setScene(new Scene()
        ...
        .addLayerSet(new LayerSet().setActiveLayer(1).setOrder(new MFInt320().getArray())
          ...
          .addLayers(new LayoutLayer().setPickable(true).setObjectType(new MFString19().getArray())
            ...
            .setLayout(new Layout().setAlign(new MFString20().getArray()).setOffset(new MFFloat21().getArray()).setSize(new MFFloat22().getArray()))
            .setViewport(new Viewport().setClipBoundary(new MFFloat23().getArray())))))      ;
    return X3D0;
    }
...
private class MFFloat21 {
  private org.web3d.x3d.jsail.fields.MFFloat getArray() {
    return new org.web3d.x3d.jsail.fields.MFFloat(new double[] {0f,0.2f});
  }
}

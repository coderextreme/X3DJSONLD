...
public class CollisionElement extends org.web3d.x3d.jsail.Navigation.Collision implements VisitableElement
{
	private org.web3d.x3d.jsail.Navigation.Collision delegate = null;
	public CollisionElement(org.web3d.x3d.jsail.Navigation.Collision delegate) {
	...
	public SFNodeElement getProxyElement() { 		 return new SFNodeElement(new org.web3d.x3d.jsail.fields.SFNode(delegate.getProxy()));
}

...
public class OrthoViewpointElement extends org.web3d.x3d.jsail.Navigation.OrthoViewpoint implements VisitableElement
{
	private org.web3d.x3d.jsail.Navigation.OrthoViewpoint delegate = null;
	public OrthoViewpointElement(org.web3d.x3d.jsail.Navigation.OrthoViewpoint delegate) {
	...
	public MFFloatElement getFieldOfViewElement() { 		 return new MFFloatElement(new org.web3d.x3d.jsail.fields.MFFloat(delegate.getFieldOfView()));
}

...
public class AnalyserElement extends org.web3d.x3d.jsail.Sound.Analyser implements VisitableElement
{
	private org.web3d.x3d.jsail.Sound.Analyser delegate = null;
	public AnalyserElement(org.web3d.x3d.jsail.Sound.Analyser delegate) {
	...
	public void accept(Visitor v) {
		...
		getFftSizeElement().accept(v);
		getFrequencyBinCountElement().accept(v);
		getGainElement().accept(v);
		getISElement().accept(v);
		getIsActiveElement().accept(v);
		getIsPausedElement().accept(v);
		getMaxDecibelsElement().accept(v);
		getMetadataElement().accept(v);
		getMinDecibelsElement().accept(v);
		getPauseTimeElement().accept(v);
		getResumeTimeElement().accept(v);
		getSmoothingTimeConstantElement().accept(v);
	...
	public SFInt32Element getFftSizeElement() { 		 return new SFInt32Element(new org.web3d.x3d.jsail.fields.SFInt32(delegate.getFftSize()));
}
	public SFInt32Element getFrequencyBinCountElement() { 		 return new SFInt32Element(new org.web3d.x3d.jsail.fields.SFInt32(delegate.getFrequencyBinCount()));
}
	...
	public SFFloatElement getMaxDecibelsElement() { 		 return new SFFloatElement(new org.web3d.x3d.jsail.fields.SFFloat(delegate.getMaxDecibels()));
}
	public SFNodeElement getMetadataElement() { 		 return new SFNodeElement(new X3DMetadataObjectElement(delegate.getMetadata()));
}
	public SFFloatElement getMinDecibelsElement() { 		 return new SFFloatElement(new org.web3d.x3d.jsail.fields.SFFloat(delegate.getMinDecibels()));
}
	...
	public SFFloatElement getSmoothingTimeConstantElement() { 		 return new SFFloatElement(new org.web3d.x3d.jsail.fields.SFFloat(delegate.getSmoothingTimeConstant()));
}

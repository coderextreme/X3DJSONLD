...
public class TransformSensorElement extends org.web3d.x3d.jsail.EnvironmentalSensor.TransformSensor implements VisitableElement
{
	private org.web3d.x3d.jsail.EnvironmentalSensor.TransformSensor delegate = null;
	public TransformSensorElement(org.web3d.x3d.jsail.EnvironmentalSensor.TransformSensor delegate) {
	...
	public void accept(Visitor v) {
		...
		getTargetObjectElement().accept(v);
	...
	public SFNodeElement getTargetObjectElement() { 		 return new SFNodeElement(new org.web3d.x3d.jsail.fields.SFNode(delegate.getTargetObject()));
}

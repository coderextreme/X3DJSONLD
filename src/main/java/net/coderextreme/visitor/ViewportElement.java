...
public class ViewportElement extends org.web3d.x3d.jsail.Layering.Viewport implements VisitableElement
{
	private org.web3d.x3d.jsail.Layering.Viewport delegate = null;
	public ViewportElement(org.web3d.x3d.jsail.Layering.Viewport delegate) {
	...
	public void accept(Visitor v) {
		...
		getClipBoundaryElement().accept(v);
	...
	public MFFloatElement getClipBoundaryElement() { 		 return new MFFloatElement(new org.web3d.x3d.jsail.fields.MFFloat(delegate.getClipBoundary()));
}

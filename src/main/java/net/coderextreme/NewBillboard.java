...
public class NewBillboard extends org.web3d.x3d.jsail.Navigation.Billboard {
	...
	public Billboard setChildren(X3DNode[] leftOver) { children = leftOver; super.setChildren(leftOver); return this; }

...
public class WorldLow {
  public static void main(String[] args) {
    ...
    new WorldLow().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/Geospatial/WorldLow.new.json");
    }
    public X3DObject initialize() {
      X3DObject X3D0 =  new X3DObject().setProfile("Immersive").setVersion("3.3")
      .setHead(new headObject()
        .addComponent(new componentObject().setName("Geospatial").setLevel(1))
        .addMeta(new metaObject().setName("title").setContent("WorldLow.x3d"))
        .addMeta(new metaObject().setName("description").setContent("World with standard vertical height values."))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/Geospatial/WorldLow.x3d"))
      ...
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("WorldLow.x3d"))

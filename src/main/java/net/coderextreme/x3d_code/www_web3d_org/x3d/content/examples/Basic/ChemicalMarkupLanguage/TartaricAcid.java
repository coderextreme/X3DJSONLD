...
public class TartaricAcid {
  public static void main(String[] args) {
    ...
    new TartaricAcid().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/TartaricAcid.new.json");
    }
...
ProtoInstanceObject ProtoInstance25 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("TartaricAcid.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of TartaricAcid.x3d scene produced from TartaricAcid.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("TartaricAcid.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/TartaricAcid.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("TartaricAcid.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect TartaricAcid").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Oxygen").setDEF("tartaric_acid_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("tartaric_acid_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Carbon").setDEF("tartaric_acid_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Carbon").setDEF("tartaric_acid_a4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Oxygen").setDEF("tartaric_acid_a5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Carbon").setDEF("tartaric_acid_a6")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("Oxygen").setDEF("tartaric_acid_a7")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("Oxygen").setDEF("tartaric_acid_a8")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("Oxygen").setDEF("tartaric_acid_a9")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("Oxygen").setDEF("tartaric_acid_a10"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b1"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b3"))
          .addChild(ProtoInstance17 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b4"))
          .addChild(ProtoInstance18 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b6"))
          .addChild(ProtoInstance19 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b7"))
          .addChild(ProtoInstance20 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b9"))
          .addChild(ProtoInstance21 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b10"))
          .addChild(ProtoInstance22 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b10_2"))
          .addChild(ProtoInstance23 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b12"))
          .addChild(ProtoInstance24 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b13"))
          .addChild(ProtoInstance25 = new ProtoInstanceObject().setName("line").setDEF("tartaric_acid_b13_2"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"Tartaric Acid: C4 H6 O6\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 150.09\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: 170\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 210\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 1.75\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.0926 3.8262 0.6865"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.0709 2.4447 0.9016"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.5158 1.8392 0.8957"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.27 2.0165 2.134"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.5065 0.4829 0.5593"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("4.2769 2.1586 2.1861"));
ProtoInstance11
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.4593 2.9436 2.6771"));
ProtoInstance12
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.265 0.9204 2.6702"));
ProtoInstance13
              .addFieldValue(new fieldValueObject().setName("position").setValue("5.0451 1.1762 2.6931"));
ProtoInstance14
              .addFieldValue(new fieldValueObject().setName("position").setValue("4.284 3.2142 2.798"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.0926 3.8262 0.6865 2.0709 2.4447 0.9016"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.0709 2.4447 0.9016 3.5158 1.8392 0.8957"));
ProtoInstance17
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.0709 2.4447 0.9016 1.27 2.0165 2.134"));
ProtoInstance18
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.5158 1.8392 0.8957 3.5065 0.4829 0.5593"));
ProtoInstance19
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.5158 1.8392 0.8957 4.2769 2.1586 2.1861"));
ProtoInstance20
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.27 2.0165 2.134 0.4593 2.9436 2.6771"));
ProtoInstance21
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.25 2.0165 2.134 1.2449999999999999 0.9204 2.6702"));
ProtoInstance22
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.29 2.0165 2.134 1.285 0.9204 2.6702"));
ProtoInstance23
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("4.2769 2.1586 2.1861 5.0451 1.1762 2.6931"));
ProtoInstance24
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("4.256900000000001 2.1586 2.1861 4.264 3.2142 2.798"));
ProtoInstance25
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("4.2969 2.1586 2.1861 4.303999999999999 3.2142 2.798"));
    return X3D0;
    }

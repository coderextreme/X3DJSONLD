...
public class HelloX3dAuthorsAnimationChain {
  public static void main(String[] args) {
    ...
    new HelloX3dAuthorsAnimationChain().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/course/HelloX3dAuthorsAnimationChain.new.json");
    }
    public X3DObject initialize() {
      X3DObject X3D0 =  new X3DObject().setProfile("Immersive").setVersion("3.0")
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("HelloX3dAuthorsAnimationChain.x3d"))
        .addMeta(new metaObject().setName("creator").setContent("Don Brutzman"))
        .addMeta(new metaObject().setName("created").setContent("5 October 2000"))
        .addMeta(new metaObject().setName("modified").setContent("20 October 2019"))
        .addMeta(new metaObject().setName("description").setContent("Fully developed animation-chain example showing spinning globe and text. Hello!"))
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/course/HelloX3dAuthorsAnimationChain.x3d"))
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new TransformObject().setDEF("EarthCoordinateSystem")
          ...
          .addChild(new TransformObject().setDEF("SimpleGeoStationarySatellite").setRotation(new float[] {1f,0f,0f,0.3f}).setScale(new float[] {0.1f,0.3f,0.1f}).setTranslation(new float[] {0f,0f,5f})
            ...
            .addChild(new TouchSensorObject().setDEF("ClickTriggerTouchSensor").setDescription("Click to start animation"))
            .addChild(new ROUTEObject().setFromField("touchTime").setFromNode("ClickTriggerTouchSensor").setToField("startTime").setToNode("OrbitalTimeInterval")))))      ;
    return X3D0;
    }

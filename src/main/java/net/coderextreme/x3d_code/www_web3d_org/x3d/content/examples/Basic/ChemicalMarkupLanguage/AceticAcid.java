...
public class AceticAcid {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    new AceticAcid().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/AceticAcid.new.json");
    }
...
ProtoInstanceObject ProtoInstance12 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("AceticAcid.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of AceticAcid.x3d scene produced from AceticAcid.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("AceticAcid.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/AceticAcid.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("AceticAcid.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect AceticAcid").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Carbon").setDEF("acetic_acid_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("acetic_acid_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Oxygen").setDEF("acetic_acid_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Oxygen").setDEF("acetic_acid_a4"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("line").setDEF("acetic_acid_b1"))
          .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("line").setDEF("acetic_acid_b5"))
          .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("line").setDEF("acetic_acid_b6"))
          .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("line").setDEF("acetic_acid_b6_2"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"Acetic Acid: C2 H4 O2\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 60.05\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: 16.6\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 117.9\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 1.0492\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.7649 0.9627 1.0051"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.0422 1.7381 0.9144"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.1225 1.026 0.5122"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.2424 2.9166 1.1481"));
ProtoInstance9
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.7649 0.9627 1.0051 2.0422 1.7381 0.9144"));
ProtoInstance10
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.0422 1.7381 0.9144 3.1225 1.026 0.5122"));
ProtoInstance11
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.0221999999999998 1.7381 0.9144 2.2224 2.9166 1.1481"));
ProtoInstance12
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.0622 1.7381 0.9144 2.2624 2.9166 1.1481"));
    return X3D0;
    }

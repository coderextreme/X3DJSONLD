...
public class HelloSiggraph2000 {
  public static void main(String[] args) {
    ...
    new HelloSiggraph2000().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/development/HelloSiggraph2000.new.json");
    }
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new TransformObject().setDEF("EarthCoordinateSystem")
          .addChild(new AnchorObject().setDescription("launch the SDK site").setParameter(new MFStringObject(new MFString1().getArray())).setUrl(new MFStringObject(new MFString2().getArray()))
            .addChild(new TransformObject().setDEF("SimpleGeoStationarySatellite").setRotation(new float[] {1f,0f,0f,0.3f}).setScale(new float[] {0.1f,0.3f,0.1f}).setTranslation(new float[] {0f,0f,5f})
              .addChild(new ShapeObject()
                ...
                .setGeometry(new TextObject().setString(new MFStringObject(new MFString3().getArray()))
                  .setFontStyle(new FontStyleObject().setJustify(new MFStringObject(new MFString4().getArray())).setSize(2.5f)))))
...
protected class MFString3 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"Hello SIGGRAPH 2000 !!","https://www.web3d.org/x3d/content/examples/X3dResources.html#Showcase"});
  }
}

...
public class Tetrahydrofuran {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    new Tetrahydrofuran().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Tetrahydrofuran.new.json");
    }
...
ProtoInstanceObject ProtoInstance20 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("tetrahydrofuran.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of tetrahydrofuran.x3d scene produced from tetrahydrofuran.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("tetrahydrofuran.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/tetrahydrofuran.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("tetrahydrofuran.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect tetrahydrofuran").setPosition(new float[] {0f,2f,20f}))
        .addComments(new CommentsBlock("<?xml-stylesheet type=\"text/xsl\" href=\"generic.xsl\" ?>"))
        .addComments(new CommentsBlock("CML document - tetrahydrofuran - karne - 7/8/00"))
        ...
        .addChild(new TransformObject().setDEF("infogroupa").setTranslation(new float[] {-8f,2f,-4f})
          ...
          .addChild(new TransformObject().setTranslation(new float[] {0f,1f,0f})
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("ano1_text")))
          .addChild(new TransformObject()
          ...
          .addChild(new TransformObject().setTranslation(new float[] {0f,-2f,0f})
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("ano2_text")))
          .addChild(new TransformObject().setTranslation(new float[] {0f,-3f,0f})
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("ano2_text")))
          .addChild(new TransformObject().setTranslation(new float[] {0f,-4f,0f})
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("ano2_text"))))
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("Oxygen").setDEF("tetrahydrofuran_karne_a_1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("Carbon").setDEF("tetrahydrofuran_karne_a_2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("Carbon").setDEF("tetrahydrofuran_karne_a_3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("Carbon").setDEF("tetrahydrofuran_karne_a_4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("Carbon").setDEF("tetrahydrofuran_karne_a_5"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("tetrahydrofuran_karne_b_1"))
          .addChild(ProtoInstance17 = new ProtoInstanceObject().setName("line").setDEF("tetrahydrofuran_karne_b_2"))
          .addChild(ProtoInstance18 = new ProtoInstanceObject().setName("line").setDEF("tetrahydrofuran_karne_b_3"))
          .addChild(ProtoInstance19 = new ProtoInstanceObject().setName("line").setDEF("tetrahydrofuran_karne_b_4"))
          .addChild(ProtoInstance20 = new ProtoInstanceObject().setName("line").setDEF("tetrahydrofuran_karne_b_5"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"tetrahydrofuran: C4 H8 O\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecular weight: 72.1066\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: -108.3\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 65\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 0.886\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"water solubility: 30\""));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"CAS: 109-99-9\""));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"ACX: I1001473\""));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"DOT: UN 2056\""));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"RTECS: LU5950000\""));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"comments: Colorless liquid with an ether-like odor detectable at 2 to 50 ppm. HYGROSCOPIC\""));
ProtoInstance11
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.03 -1.17 0"));
ProtoInstance12
              .addFieldValue(new fieldValueObject().setName("position").setValue("-1.22 -0.29 0"));
ProtoInstance13
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.24 -0.28 0"));
ProtoInstance14
              .addFieldValue(new fieldValueObject().setName("position").setValue("-0.77 1.16 0"));
ProtoInstance15
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.77 1.16 0"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("-1.22 -0.29 0 0.03 -1.17 0"));
ProtoInstance17
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.24 -0.28 0 0.03 -1.17 0"));
ProtoInstance18
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("-0.77 1.16 0 -1.22 -0.29 0"));
ProtoInstance19
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.77 1.16 0 1.24 -0.28 0"));
ProtoInstance20
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("-0.77 1.16 0 0.77 1.16 0"));
    return X3D0;
    }

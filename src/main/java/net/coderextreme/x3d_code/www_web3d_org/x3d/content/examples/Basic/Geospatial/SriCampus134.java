...
public class SriCampus134 {
  public static void main(String[] args) {
    ...
    new SriCampus134().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/Geospatial/SriCampus134.new.json");
    }
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setName("title").setContent("SriCampus134.x3d"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/Geospatial/SriCampus134.x3d"))
        .addMeta(new metaObject().setName("generator").setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("SriCampus134.x3d"))
        .addChild(new TouchSensorObject().setDEF("MouseOverPopupDescription").setDescription("Cube-75").setEnabled(false))
        .addChild(new ShapeObject()
          ...
          .setGeometry(new IndexedFaceSetObject().setConvex(false).setCoordIndex(new MFInt32Object(new MFInt320().getArray())).setSolid(false)
            .setCoord(new CoordinateObject().setDEF("OBJECT-134-VERTICES").setPoint(new MFVec3fObject(new MFVec3f1().getArray()))))))      ;
    return X3D0;
    }
...
protected class MFVec3f1 {
  protected MFVec3fObject getArray() {
    return new MFVec3fObject(new float[] {-2.5257928f,-2.2170022f,3.459932f,2.5257928f,-2.2170022f,3.459932f,2.5257928f,-2.2170022f,-3.459932f,-2.5257928f,-2.2170022f,-3.459932f,-2.5257928f,2.2170022f,3.459932f,2.5257928f,2.2170022f,3.459932f,2.5257928f,2.2170022f,-3.459932f,-2.5257928f,2.2170022f,-3.459932f});
  }
}
}

...
public class VitaminK {
  public static void main(String[] args) {
    ...
    new VitaminK().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/VitaminK.new.json");
    }
...
ProtoInstanceObject ProtoInstance24 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("VitaminK.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of VitaminK.x3d scene produced from VitaminK.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("VitaminK.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/VitaminK.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("VitaminK.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect VitaminK").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Oxygen").setDEF("vitamin_k_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("vitamin_k_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Carbon").setDEF("vitamin_k_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Carbon").setDEF("vitamin_k_a4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Carbon").setDEF("vitamin_k_a5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Carbon").setDEF("vitamin_k_a6")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("Carbon").setDEF("vitamin_k_a7")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("Oxygen").setDEF("vitamin_k_a8"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b1"))
          .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b1_2"))
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b2"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b3"))
          .addChild(ProtoInstance17 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b4"))
          .addChild(ProtoInstance18 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b4_2"))
          .addChild(ProtoInstance19 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b6"))
          .addChild(ProtoInstance20 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b6_2"))
          .addChild(ProtoInstance21 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b8"))
          .addChild(ProtoInstance22 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b10"))
          .addChild(ProtoInstance23 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b12"))
          .addChild(ProtoInstance24 = new ProtoInstanceObject().setName("line").setDEF("vitamin_k_b12_2"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"Vitamin K: C6 H4 O2\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 108.09\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: 115.7\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 293\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 1.318\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("0 0.8435 1.207"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.0807 0.7866 1.764"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.2015 0.3731 3.1873"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.3417 1.1235 1.0512"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.3882 0.308 3.7965"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.5268 1.0604 1.6634"));
ProtoInstance11
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.6493 0.6491 3.0867"));
ProtoInstance12
              .addFieldValue(new fieldValueObject().setName("position").setValue("4.7298 0.5952 3.6443"));
ProtoInstance13
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("-0.02 0.8435 1.207 1.0607 0.7866 1.764"));
ProtoInstance14
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.02 0.8435 1.207 1.1007 0.7866 1.764"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.2015 0.3731 3.1873 1.0807 0.7866 1.764"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.0807 0.7866 1.764 2.3417 1.1235 1.0512"));
ProtoInstance17
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.3682 0.308 3.7965 1.1815 0.3731 3.1873"));
ProtoInstance18
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.4082 0.308 3.7965 1.2215 0.3731 3.1873"));
ProtoInstance19
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.3217 1.1235 1.0512 3.5068 1.0604 1.6634"));
ProtoInstance20
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.3617 1.1235 1.0512 3.5468 1.0604 1.6634"));
ProtoInstance21
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.6493 0.6491 3.0867 2.3882 0.308 3.7965"));
ProtoInstance22
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.5268 1.0604 1.6634 3.6493 0.6491 3.0867"));
ProtoInstance23
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.6293 0.6491 3.0867 4.7098 0.5952 3.6443"));
ProtoInstance24
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.6693000000000002 0.6491 3.0867 4.7498 0.5952 3.6443"));
    return X3D0;
    }

...
public class HelloSiggraph2003 {
  public static void main(String[] args) {
    ...
    new HelloSiggraph2003().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/development/HelloSiggraph2003.new.json");
    }
    public X3DObject initialize() {
      X3DObject X3D0 =  new X3DObject().setProfile("Immersive").setVersion("3.0")
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("HelloSiggraph2003.x3d"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/development/HelloSiggraph2003.x3d"))
          ...
          .addChild(new TransformObject().setDEF("SimpleGeoStationarySatellite").setRotation(new float[] {1f,0f,0f,0.3f}).setScale(new float[] {0.1f,0.3f,0.1f}).setTranslation(new float[] {0f,0f,5f})
            .addChild(new ShapeObject()
              ...
              .setGeometry(new TextObject().setString(new MFStringObject(new MFString4().getArray()))
                .setFontStyle(new FontStyleObject().setJustify(new MFStringObject(new MFString5().getArray())).setSize(3f))))))
...
protected class MFString4 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"Hello SIGGRAPH","2003!!"});
  }
}

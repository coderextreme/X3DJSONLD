...
public class _1_4_Dihydronaphthalene {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    new _1_4_Dihydronaphthalene().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/_1_4_Dihydronaphthalene.new.json");
    }
...
ProtoInstanceObject ProtoInstance20 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("_1-4-Dihydronaphthalene.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of _1-4-Dihydronaphthalene.x3d scene produced from _1-4-Dihydronaphthalene.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("_1-4-Dihydronaphthalene.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/_1-4-Dihydronaphthalene.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("_1-4-Dihydronaphthalene.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect _1-4-Dihydronaphthalene").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a6")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a7")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a8")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a9")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("Carbon").setDEF("_1_4-dihydronaphthalene_a10"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("_1_4-dihydronaphthalene_b11"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("_1_4-dihydronaphthalene_b12"))
          .addChild(ProtoInstance17 = new ProtoInstanceObject().setName("line").setDEF("_1_4-dihydronaphthalene_b13"))
          .addChild(ProtoInstance18 = new ProtoInstanceObject().setName("line").setDEF("_1_4-dihydronaphthalene_b16"))
          .addChild(ProtoInstance19 = new ProtoInstanceObject().setName("line").setDEF("_1_4-dihydronaphthalene_b19"))
          .addChild(ProtoInstance20 = new ProtoInstanceObject().setName("line").setDEF("_1_4-dihydronaphthalene_b19_2"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"_1-4-Dihydronaphthalene: C10 H10\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 130.19\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: 207\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: -35.8\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 0.965\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.9478 1.7879 0.8809"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.9477 3.1805 0.8809"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.1499 1.0958 0.8809"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.1502 3.8723 0.8809"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.3665 3.1822 0.8809"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.3665 1.7856 0.8809"));
ProtoInstance11
              .addFieldValue(new fieldValueObject().setName("position").setValue("4.6338 3.9703 0.8814"));
ProtoInstance12
              .addFieldValue(new fieldValueObject().setName("position").setValue("4.6336 0.9973 0.8813"));
ProtoInstance13
              .addFieldValue(new fieldValueObject().setName("position").setValue("5.8696 1.8177 0.8716"));
ProtoInstance14
              .addFieldValue(new fieldValueObject().setName("position").setValue("5.8698 3.1496 0.8715"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.3665 3.1822 0.8809 4.6338 3.9703 0.8814"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("4.6336 0.9973 0.8813 3.3665 1.7856 0.8809"));
ProtoInstance17
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("4.6338 3.9703 0.8814 5.8698 3.1496 0.8715"));
ProtoInstance18
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("5.8696 1.8177 0.8716 4.6336 0.9973 0.8813"));
ProtoInstance19
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("5.8498 3.1496 0.8715 5.849600000000001 1.8177 0.8716"));
ProtoInstance20
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("5.889799999999999 3.1496 0.8715 5.8896 1.8177 0.8716"));
    return X3D0;
    }

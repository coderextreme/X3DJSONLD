...
public class DimethylSulfoxide {
  public static void main(String[] args) {
    ...
    new DimethylSulfoxide().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/DimethylSulfoxide.new.json");
    }
...
ProtoInstanceObject ProtoInstance12 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("DimethylSulfoxide.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of DimethylSulfoxide.x3d scene produced from DimethylSulfoxide.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("DimethylSulfoxide.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/DimethylSulfoxide.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("DimethylSulfoxide.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect DimethylSulfoxide").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Carbon").setDEF("dimethyl_sulfoxide_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Sulphur").setDEF("dimethyl_sulfoxide_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Carbon").setDEF("dimethyl_sulfoxide_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Oxygen").setDEF("dimethyl_sulfoxide_a4"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("line").setDEF("dimethyl_sulfoxide_b1"))
          .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("line").setDEF("dimethyl_sulfoxide_b5"))
          .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("line").setDEF("dimethyl_sulfoxide_b6"))
          .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("line").setDEF("dimethyl_sulfoxide_b6_2"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"DimethylSulfoxide: C2 H6 O S\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 78.13\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: 18\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 189\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 1.101\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.8293 1.3548 0.5856"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.3997 2.0598 0"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.5575 1.0719 0.9948"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.4513 3.4791 0.6382"));
ProtoInstance9
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.8293 1.3548 0.5856 2.3997 2.0598 0"));
ProtoInstance10
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.3997 2.0598 0 3.5575 1.0719 0.9948"));
ProtoInstance11
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.3797 2.0598 0 2.4313 3.4791 0.6382"));
ProtoInstance12
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.4197 2.0598 0 2.4713 3.4791 0.6382"));
    return X3D0;
    }

...
public class CreateX3DFromStringRandomSpheres {
  public static void main(String[] args) {
    ...
    new CreateX3DFromStringRandomSpheres().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/course/CreateX3DFromStringRandomSpheres.new.json");
    }
    public X3DObject initialize() {
      X3DObject X3D0 =  new X3DObject().setProfile("Immersive").setVersion("3.1")
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("CreateX3DFromStringRandomSpheres.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Sample world constructed in a Script node using the EcmaScript Browser call createX3DFromString."))
        .addMeta(new metaObject().setName("creator").setContent("originally by Vincent Gardet, revised by Curt Blais, adapted to X3D by Don Brutzman and MV4205 class"))
        .addMeta(new metaObject().setName("created").setContent("3 May 2007"))
        .addMeta(new metaObject().setName("modified").setContent("20 October 2019"))
        .addMeta(new metaObject().setName("reference").setContent("CreateVrmlFromStringRandomBoxes.x3d"))
        .addMeta(new metaObject().setName("Image").setContent("CreateX3DFromStringRandomSpheres.png"))
        ...
        .addMeta(new metaObject().setName("subject").setContent("create X3D from string, ecmascript"))
        .addMeta(new metaObject().setName("warning").setContent("X3D browser support for Browser.createX3DFromString() is poor"))
        .addMeta(new metaObject().setName("warning").setContent("Xj3D fails on embedded quote marks in sceneString Script"))
        .addMeta(new metaObject().setName("warning").setContent("this scene will not work in VRML97 browsers"))
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/course/CreateX3DFromStringRandomSpheres.x3d"))
        .addMeta(new metaObject().setName("generator").setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("CreateX3DFromStringRandomSpheres.x3d"))
        ...
        .addChild(new TransformObject().setTranslation(new float[] {50f,1.6f,140f})
          .addComments(new CommentsBlock("the following is a common interaction design pattern in X3D"))
          .addChild(new BillboardObject()
            ...
            .addChild(new TouchSensorObject().setDEF("TouchText").setDescription("Touch text to recompute random spheres"))
        ...
        .addChild(new ScriptObject().setDEF("SphereGeneratorScript").setDirectOutput(true)
...
"  }\n"+
"}"))
        .addChild(new ROUTEObject().setFromField("isActive").setFromNode("TouchText").setToField("recompute").setToNode("SphereGeneratorScript")))      ;
    return X3D0;
    }
...
protected class MFString3 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"Ten random spheres","computed at runtime"});
  }
}

...
public class WorldTestSolid {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    new WorldTestSolid().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/Geospatial/WorldTestSolid.new.json");
    }
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addComponent(new componentObject().setName("Geospatial").setLevel(1))
        .addMeta(new metaObject().setName("title").setContent("WorldTestSolid.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Simple globe using GeoElevationGrid."))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/Geospatial/WorldTestSolid.x3d"))
      ...
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("WorldTestSolid.x3d"))
        .addChild(new GroupObject()
          .addChild(new GeoViewpointObject().setDescription("Initial GeoViewpoint").setOrientation(new float[] {1f,0f,0f,-1.57f}).setPosition(new double[] {25d,-70d,13000000d}))
          ...
          .addChild(new TransformObject().setDEF("GeoXform")
            .addChild(new ShapeObject()
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setDiffuseColor(new float[] {0.4f,0.8f,1f})))
              .setGeometry(new GeoElevationGridObject().setDEF("GEOEG").setGeoGridOrigin(new double[] {-90d,-180d,0d}).setHeight(new MFDoubleObject(new MFDouble0().getArray()).append(new MFDouble1().getArray()).append(new MFDouble2().getArray()).append(new MFDouble3().getArray()).append(new MFDouble4().getArray())).setXDimension(84).setXSpacing(4.34d).setZDimension(42).setZSpacing(4.34d)))))
        .addChild(new ROUTEObject().setFromField("rotation_changed").setFromNode("GeoSphere").setToField("set_rotation").setToNode("GeoXform")))      ;
    return X3D0;
    }
protected class MFDouble0 {

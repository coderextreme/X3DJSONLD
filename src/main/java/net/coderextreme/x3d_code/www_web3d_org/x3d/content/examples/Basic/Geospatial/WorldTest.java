...
public class WorldTest {
  public static void main(String[] args) {
    ...
    new WorldTest().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/Geospatial/WorldTest.new.json");
    }
    public X3DObject initialize() {
      X3DObject X3D0 =  new X3DObject().setProfile("Immersive").setVersion("3.3")
      .setHead(new headObject()
        .addComponent(new componentObject().setName("Geospatial").setLevel(1))
        .addMeta(new metaObject().setName("title").setContent("WorldTest.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Simple globe using GeoElevationGrid with drag/rotate capability."))
        .addMeta(new metaObject().setName("creator").setContent("Martin Reddy, SRI International"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/Geospatial/WorldTest.x3d"))
      ...
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("WorldTest.x3d"))
          ...
          .addChild(new TransformObject().setDEF("GeoXform")
            .addChild(new ShapeObject()
              .setAppearance(new AppearanceObject()
                ...
                .setTexture(new ImageTextureObject().setDEF("TEX").setUrl(new MFStringObject(new MFString1().getArray()))))
              .setGeometry(new GeoElevationGridObject().setDEF("GEOEG").setGeoGridOrigin(new double[] {-90d,-180d,0d}).setHeight(new MFDoubleObject(new MFDouble2().getArray()).append(new MFDouble3().getArray()).append(new MFDouble4().getArray()).append(new MFDouble5().getArray()).append(new MFDouble6().getArray())).setSolid(false).setXDimension(84).setXSpacing(4.34d).setZDimension(42).setZSpacing(4.34d)))))
...
"function set_value( value ) \n"+
"{\n"+
"	if ( value == true ) value_changed = \n"+
"		new MFString ('images/earth.gif', 'https://www.web3d.org/x3d/content/examples/Basic/Geospatial/images/earth.gif'); \n"+
...
protected class MFString1 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"images/earth3.jpg","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/images/earth3.jpg"});
  }
}

...
public class Cyclopentanamine {
  public static void main(String[] args) {
    ...
    new Cyclopentanamine().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Cyclopentanamine.new.json");
    }
...
ProtoInstanceObject ProtoInstance16 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("Cyclopentanamine.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of Cyclopentanamine.x3d scene produced from Cyclopentanamine.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("Cyclopentanamine.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Cyclopentanamine.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("Cyclopentanamine.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect Cyclopentanamine").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Nitrogen").setDEF("cyclopentanamine_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclopentanamine_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclopentanamine_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclopentanamine_a4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclopentanamine_a5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclopentanamine_a6"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("line").setDEF("cyclopentanamine_b1"))
          .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("line").setDEF("cyclopentanamine_b4"))
          .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("line").setDEF("cyclopentanamine_b5"))
          .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("line").setDEF("cyclopentanamine_b7"))
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("cyclopentanamine_b10"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("cyclopentanamine_b13"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"Cyclopentanamine: C5 H11 N\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 85.15\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: -6\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 106\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 0.863\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.6333 2.5818 1.6112"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.0204 2.1653 1.9102"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.053 3.047 1.1939"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("4.2903 2.1762 0.9973"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.8619 0.7218 1.1851"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.3704 0.7241 1.4997"));
ProtoInstance11
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.6333 2.5818 1.6112 2.0204 2.1653 1.9102"));
ProtoInstance12
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.0204 2.1653 1.9102 3.053 3.047 1.1939"));
ProtoInstance13
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.3704 0.7241 1.4997 2.0204 2.1653 1.9102"));
ProtoInstance14
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.053 3.047 1.1939 4.2903 2.1762 0.9973"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("4.2903 2.1762 0.9973 3.8619 0.7218 1.1851"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.8619 0.7218 1.1851 2.3704 0.7241 1.4997"));
    return X3D0;
    }

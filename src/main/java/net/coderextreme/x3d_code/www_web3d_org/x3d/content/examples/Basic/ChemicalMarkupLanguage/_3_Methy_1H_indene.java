...
public class _3_Methy_1H_indene {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    new _3_Methy_1H_indene().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/_3_Methy_1H_indene.new.json");
    }
...
ProtoInstanceObject ProtoInstance20 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("_3-methyl-1h-indene.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of _3-methyl-1h-indene.x3d scene produced from _3-methyl-1h-indene.xml Chemical Markup Language (CML) source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("_3-methyl-1h-indene.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/_3-methyl-1h-indene.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("_3-methyl-1h-indene.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect _3-methyl-1h-indene").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a6")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a7")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a8")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a9")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("Carbon").setDEF("_3-methyl-1h-indene_a10"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("_3-methyl-1h-indene_b1"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("_3-methyl-1h-indene_b5"))
          .addChild(ProtoInstance17 = new ProtoInstanceObject().setName("line").setDEF("_3-methyl-1h-indene_b6"))
          .addChild(ProtoInstance18 = new ProtoInstanceObject().setName("line").setDEF("_3-methyl-1h-indene_b6_2"))
          .addChild(ProtoInstance19 = new ProtoInstanceObject().setName("line").setDEF("_3-methyl-1h-indene_b9"))
          .addChild(ProtoInstance20 = new ProtoInstanceObject().setName("line").setDEF("_3-methyl-1h-indene_b11"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"_3-methyl-1h-indene: C10 H10\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 130.19\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: 94\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 266\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 0.965\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.0802 4.4808 0.8224"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.7105 3.1539 0.9211"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.153 2.9519 1.1096"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.1022 1.9458 0.8602"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.4 1.5607 1.1621"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("4.1914 3.8614 1.229"));
ProtoInstance11
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.1 0.8281 1.0059"));
ProtoInstance12
              .addFieldValue(new fieldValueObject().setName("position").setValue("4.6834 1.076 1.3341"));
ProtoInstance13
              .addFieldValue(new fieldValueObject().setName("position").setValue("5.4842 3.366 1.4022"));
ProtoInstance14
              .addFieldValue(new fieldValueObject().setName("position").setValue("5.7263 1.9964 1.4539"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.0802 4.4808 0.8224 1.7105 3.1539 0.9211"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.7105 3.1539 0.9211 3.153 2.9519 1.1096"));
ProtoInstance17
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.0822 1.9458 0.8602 1.6905 3.1539 0.9211"));
ProtoInstance18
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.1222 1.9458 0.8602 1.7305 3.1539 0.9211"));
ProtoInstance19
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.1 0.8281 1.0059 1.1022 1.9458 0.8602"));
ProtoInstance20
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.4 1.5607 1.1621 2.1 0.8281 1.0059"));
    return X3D0;
    }

...
public class Ethanol {
  public static void main(String[] args) {
    ...
    new Ethanol().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Ethanol.new.json");
    }
...
ProtoInstanceObject ProtoInstance19 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("Ethanol.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of Ethanol.x3d scene produced from Ethanol.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("Ethanol.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Ethanol.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("Ethanol.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect Ethanol").setPosition(new float[] {0f,2f,20f}))
        .addComments(new CommentsBlock("<?xml-stylesheet type=\"text/xsl\" href=\"generic.xsl\" ?>"))
        .addComments(new CommentsBlock("CML document - ethanol - karne - 7/8/00"))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance3 = new ProtoInstanceObject().setName("Carbon").setDEF("ethanol_karne_a_1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance4 = new ProtoInstanceObject().setName("Carbon").setDEF("ethanol_karne_a_2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Oxygen").setDEF("ethanol_karne_a_3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Hydrogen").setDEF("ethanol_karne_a_4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Hydrogen").setDEF("ethanol_karne_a_5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Hydrogen").setDEF("ethanol_karne_a_6")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Hydrogen").setDEF("ethanol_karne_a_7")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Hydrogen").setDEF("ethanol_karne_a_8")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("Hydrogen").setDEF("ethanol_karne_a_9"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("line").setDEF("ethanol_karne_b_1"))
          .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("line").setDEF("ethanol_karne_b_2"))
          .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("line").setDEF("ethanol_karne_b_3"))
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("ethanol_karne_b_4"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("ethanol_karne_b_5"))
          .addChild(ProtoInstance17 = new ProtoInstanceObject().setName("line").setDEF("ethanol_karne_b_6"))
          .addChild(ProtoInstance18 = new ProtoInstanceObject().setName("line").setDEF("ethanol_karne_b_7"))
          .addChild(ProtoInstance19 = new ProtoInstanceObject().setName("line").setDEF("ethanol_karne_b_8"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"Ethanol: C2 H6 O\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecular weight: 46.07\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"CAS: 64-17-5\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.0303 0.8847 0.9763"));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.8847 1.9889 1.5717"));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.1883 1.4807 1.7425"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("0 1.233 0.8324"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.9949 0 1.6255"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.4097 0.5558 0"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.905 2.8742 0.9059"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.4753 2.3225 2.5456"));
ProtoInstance11
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.7056 2.182 2.1139"));
ProtoInstance12
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.0303 0.8847 0.9763 1.8847 1.9889 1.5717"));
ProtoInstance13
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.0303 0.8847 0.9763 0 1.233 0.8324"));
ProtoInstance14
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.0303 0.8847 0.9763 0.9949 0 1.6255"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.0303 0.8847 0.9763 1.4097 0.5558 0"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.8847 1.9889 1.5717 3.1883 1.4807 1.7425"));
ProtoInstance17
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.8847 1.9889 1.5717 1.905 2.8742 0.9059"));
ProtoInstance18
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.8847 1.9889 1.5717 1.4753 2.3225 2.5456"));
ProtoInstance19
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.1883 1.4807 1.7425 3.7056 2.182 2.1139"));
    return X3D0;
    }

...
public class PyruvicAcid {
  public static void main(String[] args) {
    ...
    new PyruvicAcid().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/PyruvicAcid.new.json");
    }
...
ProtoInstanceObject ProtoInstance17 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("PyruvicAcid.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of PyruvicAcid.x3d scene produced from PyruvicAcid.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("PyruvicAcid.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/PyruvicAcid.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("PyruvicAcid.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect PyruvicAcid").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Carbon").setDEF("pyruvic_acid_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("pyruvic_acid_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Carbon").setDEF("pyruvic_acid_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Oxygen").setDEF("pyruvic_acid_a4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Oxygen").setDEF("pyruvic_acid_a5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Oxygen").setDEF("pyruvic_acid_a6"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("line").setDEF("pyruvic_acid_b1"))
          .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("line").setDEF("pyruvic_acid_b2"))
          .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("line").setDEF("pyruvic_acid_b3"))
          .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("line").setDEF("pyruvic_acid_b3_2"))
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("pyruvic_acid_b4"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("pyruvic_acid_b5"))
          .addChild(ProtoInstance17 = new ProtoInstanceObject().setName("line").setDEF("pyruvic_acid_b5_2"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"Pyruvic Acid: C3 H4 O3\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 88.06\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: 12\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 165\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 1.265\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.2732 0.8302 0.9936"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.6424 1.5034 0.9854"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.5974 2.9991 0.9011"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.6572 0.847 1.0232"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.8508 0.4234 2.2078"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.5294 0.64 0.052"));
ProtoInstance11
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.2732 0.8302 0.9936 2.6424 1.5034 0.9854"));
ProtoInstance12
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.2732 0.8302 0.9936 0.8508 0.4234 2.2078"));
ProtoInstance13
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.2532 0.8302 0.9936 0.5094 0.64 0.052"));
ProtoInstance14
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.2932000000000001 0.8302 0.9936 0.5494 0.64 0.052"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.6424 1.5034 0.9854 2.5974 2.9991 0.9011"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.6224 1.5034 0.9854 3.6372 0.847 1.0232"));
ProtoInstance17
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.6624 1.5034 0.9854 3.6772 0.847 1.0232"));
    return X3D0;
    }

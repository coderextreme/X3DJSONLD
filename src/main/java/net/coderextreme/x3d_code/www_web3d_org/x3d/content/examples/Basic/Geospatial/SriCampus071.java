...
public class SriCampus071 {
  public static void main(String[] args) {
    ...
    new SriCampus071().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/Geospatial/SriCampus071.new.json");
    }
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setName("title").setContent("SriCampus071.x3d"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/Geospatial/SriCampus071.x3d"))
        .addMeta(new metaObject().setName("generator").setContent("Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("SriCampus071.x3d"))
        .addChild(new TouchSensorObject().setDEF("MouseOverPopupDescription").setDescription("House-34").setEnabled(false))
        .addChild(new ShapeObject()
          ...
          .setGeometry(new IndexedFaceSetObject().setConvex(false).setCoordIndex(new MFInt32Object(new MFInt320().getArray())).setSolid(false)
            .setCoord(new CoordinateObject().setDEF("OBJECT-71-VERTICES").setPoint(new MFVec3fObject(new MFVec3f1().getArray()))))))      ;
    return X3D0;
    }
...
protected class MFVec3f1 {
  protected MFVec3fObject getArray() {
    return new MFVec3fObject(new float[] {-1.1905087f,-4.0517235f,15.795633f,1.1905087f,-4.0517235f,15.795633f,1.1905087f,-4.0517235f,-15.795633f,-1.1905087f,-4.0517235f,-15.795633f,-1.1905087f,2.8612146f,15.795633f,1.1905087f,4.0517235f,15.795633f,1.1905087f,4.0517235f,-15.795633f,-1.1905087f,2.8612146f,-15.795633f,-1.1905087f,2.8612146f,15.795633f,1.1905087f,4.0517235f,15.795633f,1.1905087f,4.0517235f,-15.795633f,-1.1905087f,2.8612146f,-15.795633f});
  }
}
}

...
public class CADPartChildTransformationAlternativeA {
  public static void main(String[] args) {
    ...
    new CADPartChildTransformationAlternativeA().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/CAD/CADPartChildTransformationAlternativeA.new.json");
    }
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setName("title").setContent("CADPartChildTransformationAlternativeA.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Developer scene to explore Mantis Issue 528 Alternative A for transformation of CADFace children: allow Transform node as child of CADFace."))
        ...
        .addMeta(new metaObject().setName("information").setContent("This scene was produced for specification development, and is expected to validate and work."))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/CAD/CADPartChildTransformationAlternativeA.x3d"))
        .addMeta(new metaObject().setName("generator").setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("CADPartChildTransformationAlternativeA.x3d"))
        ...
        .addChild(new CADAssemblyObject().setName("DesignPatternAssembly")
          .addChild(new CADPartObject().setName("CADPartExample")
            ...
            .addChild(new CADFaceObject().setName("topCap")
              .setShape(new TransformObject().setRotation(new float[] {1f,0f,0f,1.5708f}).setTranslation(new float[] {0f,1.5f,0f})

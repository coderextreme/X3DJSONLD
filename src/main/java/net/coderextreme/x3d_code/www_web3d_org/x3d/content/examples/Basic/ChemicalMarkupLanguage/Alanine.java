...
public class Alanine {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    new Alanine().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Alanine.new.json");
    }
...
ProtoInstanceObject ProtoInstance16 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("Alanine.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of Alanine.x3d scene produced from Alanine.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("Alanine.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Alanine.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("Alanine.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect Alanine").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Carbon").setDEF("alanine_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("alanine_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Carbon").setDEF("alanine_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Nitrogen").setDEF("alanine_a4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Oxygen").setDEF("alanine_a5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Oxygen").setDEF("alanine_a6"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("line").setDEF("alanine_b1"))
          .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("line").setDEF("alanine_b2"))
          .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("line").setDEF("alanine_b3"))
          .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("line").setDEF("alanine_b3_2"))
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("alanine_b4"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("alanine_b5"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"Alanine: C3 H7 N O2\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 89.09\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: 264\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 314\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 1.42\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.1133 2.7796 1.817"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.0036 2.0206 1.1013"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.964 0.5868 1.6215"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.7338 2.7669 1.2777"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("4.1888 3.0708 1.0506"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.171 3.1403 2.9781"));
ProtoInstance11
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.1133 2.7796 1.817 2.0036 2.0206 1.1013"));
ProtoInstance12
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.1133 2.7796 1.817 4.1888 3.0708 1.0506"));
ProtoInstance13
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.0933 2.7796 1.817 3.151 3.1403 2.9781"));
ProtoInstance14
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.1333 2.7796 1.817 3.191 3.1403 2.9781"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.0036 2.0206 1.1013 1.964 0.5868 1.6215"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.0036 2.0206 1.1013 0.7338 2.7669 1.2777"));
    return X3D0;
    }

...
public class CameraShape {
  public static void main(String[] args) {
    ...
    new CameraShape().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/development/CameraShape.new.json");
    }
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/development/SimpleCamera.x3d"))

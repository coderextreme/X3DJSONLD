...
public class ButanedioicAcid {
  public static void main(String[] args) {
    ...
    new ButanedioicAcid().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/ButanedioicAcid.new.json");
    }
...
ProtoInstanceObject ProtoInstance21 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("ButanedioicAcid.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of ButanedioicAcid.x3d scene produced from ButanedioicAcid.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("ButanedioicAcid.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/ButanedioicAcid.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("ButanedioicAcid.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect ButanedioicAcid").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Carbon").setDEF("butanedioic_acid_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("butanedioic_acid_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Carbon").setDEF("butanedioic_acid_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Carbon").setDEF("butanedioic_acid_a4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Oxygen").setDEF("butanedioic_acid_a5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Oxygen").setDEF("butanedioic_acid_a6")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("Oxygen").setDEF("butanedioic_acid_a7")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("Oxygen").setDEF("butanedioic_acid_a8"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("line").setDEF("butanedioic_acid_b1"))
          .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("line").setDEF("butanedioic_acid_b2"))
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("Butanedioic_Acid_b5"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("butanedioic_acid_b8"))
          .addChild(ProtoInstance17 = new ProtoInstanceObject().setName("line").setDEF("butanedioic_acid_b9"))
          .addChild(ProtoInstance18 = new ProtoInstanceObject().setName("line").setDEF("butanedioic_acid_b9_2"))
          .addChild(ProtoInstance19 = new ProtoInstanceObject().setName("line").setDEF("butanedioic_acid_b10"))
          .addChild(ProtoInstance20 = new ProtoInstanceObject().setName("line").setDEF("butanedioic_acid_b11"))
          .addChild(ProtoInstance21 = new ProtoInstanceObject().setName("line").setDEF("butanedioic_acid_b11_2"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"Butanedioic Acid: C4 H6 O4\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 118.09\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: 185\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 235\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 1.6\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.1343 0.9978 1.7414"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.966 2.1001 1.1065"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.6854 1.0825 1.3399"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("5.4133 2.0195 1.5145"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.8984 0.1193 1.8759"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.1213 1.8803 0.6125"));
ProtoInstance11
              .addFieldValue(new fieldValueObject().setName("position").setValue("6.2033 2.9753 0.9693"));
ProtoInstance12
              .addFieldValue(new fieldValueObject().setName("position").setValue("5.9743 1.2314 2.2546"));
ProtoInstance13
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.1343 0.9978 1.7414 3.966 2.1001 1.1065"));
ProtoInstance14
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.1343 0.9978 1.7414 1.6854 1.0825 1.3399"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.966 2.1001 1.1065 5.4133 2.0195 1.5145"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.6854 1.0825 1.3399 0.8984 0.1193 1.8759"));
ProtoInstance17
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.6654 1.0825 1.3399 1.1013 1.8803 0.6125"));
ProtoInstance18
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.7054 1.0825 1.3399 1.1413 1.8803 0.6125"));
ProtoInstance19
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("5.4133 2.0195 1.5145 6.2033 2.9753 0.9693"));
ProtoInstance20
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("5.3933 2.0195 1.5145 5.954300000000001 1.2314 2.2546"));
ProtoInstance21
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("5.433299999999999 2.0195 1.5145 5.9943 1.2314 2.2546"));
    return X3D0;
    }

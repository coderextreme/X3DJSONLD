...
public class HelloX3dDay2001 {
  public static void main(String[] args) {
    ...
    new HelloX3dDay2001().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/development/HelloX3dDay2001.new.json");
    }
    public X3DObject initialize() {
      X3DObject X3D0 =  new X3DObject().setProfile("Immersive").setVersion("3.0")
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("HelloSiggraph2000.x3d"))
        .addMeta(new metaObject().setName("creator").setContent("Don Brutzman"))
        .addMeta(new metaObject().setName("created").setContent("14 July 2000"))
        .addMeta(new metaObject().setName("modified").setContent("20 October 2019"))
        .addMeta(new metaObject().setName("description").setContent("A simple VRML/X3D scene-graph example."))
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/development/HelloSiggraph2000.x3d"))
        ...
        .addChild(new TransformObject().setDEF("EarthCoordinateSystem")
          .addChild(new TransformObject().setDEF("SimpleGeoStationarySatellite").setRotation(new float[] {1f,0f,0f,0.3f}).setScale(new float[] {0.1f,0.3f,0.1f}).setTranslation(new float[] {0f,0f,5f})
            .addChild(new ShapeObject()
              .setAppearance(new AppearanceObject().setDEF("TEXT_MATERIAL")
              ...
              .setGeometry(new TextObject().setString(new MFStringObject(new MFString1().getArray()))
                .setFontStyle(new FontStyleObject().setJustify(new MFStringObject(new MFString2().getArray())).setSize(3f))))
            .addChild(new ShapeObject()
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject()))
              .setGeometry(new IndexedFaceSetObject())))
          .addChild(new AnchorObject().setDescription("launch the SDK site").setParameter(new MFStringObject(new MFString3().getArray())).setUrl(new MFStringObject(new MFString4().getArray()))
            .addChild(new GroupObject().setDEF("MiniWorld")
              .addChild(new ShapeObject()
                .setAppearance(new AppearanceObject()
                  ...
                  .setMaterial(new MaterialObject().setEmissiveColor(new float[] {0.05f,0.05f,0.1f})))
                .setGeometry(new SphereObject())))))
        .addChild(new TimeSensorObject().setDEF("OrbitalTimeInterval").setCycleInterval(20d).setLoop(true))
        .addChild(new OrientationInterpolatorObject().setDEF("SpinThoseThings").setKey(new MFFloatObject(new MFFloat6().getArray())).setKeyValue(new MFRotationObject(new MFRotation7().getArray())))
...
protected class MFString1 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"Hello X3D Day Santa Clara !!","https://www.web3d.org/x3d"});
  }
}
...
protected class MFString4 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"https://www.web3d.org/x3d/content/examples/X3dResources.html#Showcase"});
  }
}

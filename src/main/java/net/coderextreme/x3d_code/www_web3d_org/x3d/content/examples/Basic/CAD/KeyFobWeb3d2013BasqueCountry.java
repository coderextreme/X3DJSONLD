...
public class KeyFobWeb3d2013BasqueCountry {
  public static void main(String[] args) {
    ConfigurationProperties.setXsltEngine(ConfigurationProperties.XSLT_ENGINE_NATIVE_JAVA);
    ConfigurationProperties.setDeleteIntermediateFiles(false);
    new KeyFobWeb3d2013BasqueCountry().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/CAD/KeyFobWeb3d2013BasqueCountry.new.json");
    }
    public X3DObject initialize() {
      X3DObject X3D0 =  new X3DObject().setProfile("Interchange").setVersion("3.3")
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("KeyFobWeb3d2013BasqueCountry.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Model of a key chain fob with with WEB3D 2013 conference lettering, using the colors of the Basque Country flag."))
        ...
        .addMeta(new metaObject().setName("Image").setContent("KeyFobWeb3d2013BasqueCountry.png"))
        .addMeta(new metaObject().setName("photo").setContent("KeyFobWeb3d2013BasqueCountryPhoto.jpg"))
        ...
        .addMeta(new metaObject().setName("reference").setContent("http://www.shapeways.com/model/1139964/keyfobweb3d2013basquecountry.html"))
        .addMeta(new metaObject().setName("reference").setContent("http://web3D2013.org"))
        .addMeta(new metaObject().setName("reference").setContent("KeyFobWeb3d2013Spain.x3d"))
        .addMeta(new metaObject().setName("reference").setContent("http://en.wikipedia.org/wiki/Keychain#Key_fob"))
        .addMeta(new metaObject().setName("reference").setContent("http://en.wikipedia.org/wiki/Basque_Country_(autonomous_community)"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/CAD/KeyFobWeb3d2013BasqueCountry.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("KeyFobWeb3d2013BasqueCountry.x3d"))
        ...
        .addChild(new TransformObject().setScale(new float[] {0.0254f,0.0254f,0.0254f})
          ...
          .addChild(new ShapeObject()
            .setAppearance(new AppearanceObject().setDEF("characters2013Appearance")
              .setMaterial(new MaterialObject().setAmbientIntensity(1f).setDiffuseColor(new float[] {0f,0.584f,0.263f}).setShininess(1f)))
          ...
          .addChild(new ShapeObject()
            .setAppearance(new AppearanceObject().setDEF("sidebarAppearance")
              .setMaterial(new MaterialObject().setAmbientIntensity(1f).setDiffuseColor(new float[] {0f,0.7686f,0.263f}).setShininess(1f)))
...
protected class MFColor0 {
  protected MFColorObject getArray() {
    return new MFColorObject(new float[] {0.3f,0.4f,0.5f});
  }
}

  ...
  public static void main(String[] args) {
    ...
    public X3DObject initialize() {
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setName("Image").setContent("TripsAroundWorld.png"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/Geospatial/TripsAroundWorld.x3d"))
      ...
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("TripsAroundWorld.x3d"))
        .addChild(new GroupObject()
          .addChild(new GeoViewpointObject().setDescription("Initial GeoViewpoint").setOrientation(new float[] {1f,0f,0f,-1.57f}).setPosition(new double[] {35d,-70d,8000000d}))
          ...
          .addChild(new GeoLocationObject().setGeoCoords(new double[] {25d,-63.5d,4000000d})
            .addChild(new TransformObject().setTranslation(new float[] {-1000000f,0f,-600000f})
              .addChild(new BillboardObject().setAxisOfRotation(new float[] {0f,0f,0f})
                .addChild(new AnchorObject().setDescription("Trip photographs").setParameter(new MFStringObject(new MFString3().getArray())).setUrl(new MFStringObject(new MFString4().getArray()))
                  .addChild(new ShapeObject()
                    ...
                    .setGeometry(new TextObject().setString(new MFStringObject(new MFString5().getArray()))
                      .setFontStyle(new FontStyleObject().setFamily(new MFStringObject(new MFString6().getArray())).setSize(100000f))))))))
...
protected class MFColor2 {
  protected MFColorObject getArray() {
    return new MFColorObject(new float[] {0f,1f,1f,0f,0f,0.18f});
  }
}
...
protected class MFString4 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"http://www.ai.sri.com/~reddy/photos"});
  }
}
protected class MFString5 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"Martin's trips","http://www.ai.sri.com/~reddy/photos"});
  }
}
protected class MFString6 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"SANSERIF"});
  }
}
protected class MFString7 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"images/earthTrips.gif","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/images/earthTrips.gif"});
  }
}
...
protected class MFString13 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"TripsModel.x3d","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/TripsModel.x3d","TripsModel.wrl","https://www.web3d.org/x3d/content/examples/Basic/Geospatial/TripsModel.wrl"});
  }
}
}

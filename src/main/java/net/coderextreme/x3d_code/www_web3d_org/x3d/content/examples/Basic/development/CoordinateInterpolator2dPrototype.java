...
public class CoordinateInterpolator2dPrototype {
  public static void main(String[] args) {
    ...
    new CoordinateInterpolator2dPrototype().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/development/CoordinateInterpolator2dPrototype.new.json");
    }
    public X3DObject initialize() {
      X3DObject X3D0 =  new X3DObject().setProfile("Immersive").setVersion("3.0")
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("CoordinateInterpolator2dPrototype.x3d"))
        .addMeta(new metaObject().setName("description").setContent("CoordinateInterpolator2D prototype declaration, to interpolate across an array of Vector2FloatArray/MFVec2f values to produce an interpolated Vector2FloatArray - click text to see example."))
        .addMeta(new metaObject().setName("creator").setContent("Don Brutzman, Jeff Weekley, Jane Wu"))
        .addMeta(new metaObject().setName("created").setContent("28 June 2001"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/development/CoordinateInterpolator2dPrototype.x3d"))
        .addMeta(new metaObject().setName("generator").setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("CoordinateInterpolator2dPrototype.x3d"))
        .addChild(new ProtoDeclareObject().setName("CoordinateInterpolator2D").setAppinfo("Provide interpolation capability for Vector2FloatArray/MFVec2f values").setDocumentation("https://www.web3d.org/technicalinfo/specifications/vrml97/part1/concepts.html#4.6.8")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setType("SFFloat").setName("set_fraction").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setAppinfo("Regular interpolator-style input, the set_fraction eventIn receives an SFFloat event and causes the interpolator function to evaluate resulting in a value_changed eventOut with the same timestamp as the set_fraction event."))
            ...
            .addField(new fieldObject().setType("MFVec2f").setName("keyValue").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("keyValue holds the array of Vector2FloatArrays that match each animation key."))
            ...
            .addField(new fieldObject().setType("MFVec2f").setName("value_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("Regular interpolator-style output, the interpolator function averages between respective keyValue Vector2FloatArrays resulting in a Vector2FloatArray value_changed eventOut with the same timestamp as the set_fraction event.")))
            ...
            .addChild(new GroupObject()
              .addChild(new SwitchObject().setWhichChoice(-1)
                ...
                .addChild(new ShapeObject()
                  ...
                  .setAppearance(new AppearanceObject().setDEF("DefaultAppearance")
              ...
              .addChild(new ScriptObject().setDEF("InterpolationScript").setDirectOutput(true)
                ...
                .addField(new fieldObject().setType("MFVec2f").setName("value_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
                .setIS(new ISObject()
...
"}")))))
        ...
        .addChild(new AnchorObject().setDescription("CoordinateInterpolator2dExample").setParameter(new MFStringObject(new MFString0().getArray())).setUrl(new MFStringObject(new MFString1().getArray()))
          .addChild(new ShapeObject()
...
protected class MFString1 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"CoordinateInterpolator2dExample.x3d","https://savage.nps.edu/Savage/Tools/Animation/CoordinateInterpolator2dExample.x3d","CoordinateInterpolator2dExample.wrl","https://savage.nps.edu/Savage/Tools/Animation/CoordinateInterpolator2dExample.wrl"});
  }
}
protected class MFString2 {
  protected MFStringObject getArray() {
    return new MFStringObject(new java.lang.String[] {"CoordinateInterpolator2dPrototype","defines a prototype","","Click on this text to see","CoordinateInterpolator2dExample"," scene"});
  }
}

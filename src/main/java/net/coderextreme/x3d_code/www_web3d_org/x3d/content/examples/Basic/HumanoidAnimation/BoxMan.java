...
public class BoxMan {
  public static void main(String[] args) {
    ...
    new BoxMan().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/HumanoidAnimation/BoxMan.new.json");
    }
...
ProtoInstanceObject ProtoInstance0 = null;
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setName("description").setContent("A Seamless VRML Human, demonstrating the H-Anim 2001 Specification, animation scripting via an external prototype (ExternProtoDeclare)."))
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new HAnimHumanoidObject().setName("Humanoid").setDEF("boxman_Humanoid").setInfo(new MFStringObject(new MFString3().getArray())).setVersion("2.0")
          ...
          .addViewpoints(new HAnimSiteObject().setName("BoxMan_view")
            ...
            .addChild(new ViewpointObject().setDEF("Right_View").setDescription("Right-side View").setOrientation(new float[] {0f,1f,0f,-1.57f}).setPosition(new float[] {-3f,1f,0f}))
            .addChild(new ViewpointObject().setDEF("Left_View").setDescription("Left-side View").setOrientation(new float[] {0f,1f,0f,1.57f}).setPosition(new float[] {3f,1f,0f}))
        ...
        .addChild(new ExternProtoDeclareObject().setName("LOA1_WalkAnimation").setUrl(new MFStringObject(new MFString47().getArray()))
          .addField(new fieldObject().setType("SFTime").setName("cycleInterval").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT))
          .addField(new fieldObject().setType("SFBool").setName("enabled").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT))
          .addField(new fieldObject().setType("SFBool").setName("loop").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT))
          .addField(new fieldObject().setType("SFTime").setName("startTime").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT))
          .addField(new fieldObject().setType("SFTime").setName("stopTime").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT))
          .addField(new fieldObject().setType("SFFloat").setName("fraction_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFVec3f").setName("HumanoidRoot_translation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("HumanoidRoot_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("l_hip_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("l_knee_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("l_ankle_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("l_midtarsal_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("r_hip_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("r_knee_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("r_ankle_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("r_midtarsal_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("vl5_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("skullbase_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("l_shoulder_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("l_elbow_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("l_wrist_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("r_shoulder_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("r_elbow_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFRotation").setName("r_wrist_rotation_changed").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))
          .addField(new fieldObject().setType("SFBool").setName("isActive").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY)))
        .addChild(ProtoInstance0 = new ProtoInstanceObject().setName("LOA1_WalkAnimation").setDEF("ANIMATOR"))
        .addComments(new CommentsBlock("Animation ROUTEs"))
        .addChild(new ROUTEObject().setFromField("HumanoidRoot_translation_changed").setFromNode("ANIMATOR").setToField("set_translation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("HumanoidRoot_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_HumanoidRoot"))
        .addChild(new ROUTEObject().setFromField("l_hip_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_l_hip"))
        .addChild(new ROUTEObject().setFromField("l_knee_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_l_knee"))
        .addChild(new ROUTEObject().setFromField("l_ankle_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_l_ankle"))
        .addChild(new ROUTEObject().setFromField("l_midtarsal_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_l_midtarsal"))
        .addChild(new ROUTEObject().setFromField("r_hip_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_r_hip"))
        .addChild(new ROUTEObject().setFromField("r_knee_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_r_knee"))
        .addChild(new ROUTEObject().setFromField("r_ankle_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_r_ankle"))
        .addChild(new ROUTEObject().setFromField("r_midtarsal_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_r_midtarsal"))
        .addChild(new ROUTEObject().setFromField("vl5_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_vl5"))
        .addChild(new ROUTEObject().setFromField("skullbase_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_skullbase"))
        .addChild(new ROUTEObject().setFromField("l_shoulder_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_l_shoulder"))
        .addChild(new ROUTEObject().setFromField("l_elbow_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_l_elbow"))
        .addChild(new ROUTEObject().setFromField("l_wrist_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_l_wrist"))
        .addChild(new ROUTEObject().setFromField("r_shoulder_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_r_shoulder"))
        .addChild(new ROUTEObject().setFromField("r_elbow_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_r_elbow"))
        .addChild(new ROUTEObject().setFromField("r_wrist_rotation_changed").setFromNode("ANIMATOR").setToField("set_rotation").setToNode("boxman_r_wrist"))
        .addChild(new ScriptObject().setDEF("ENGINE").setDirectOutput(true).setUrl(new MFStringObject(new MFString48().getArray()))
          .addField(new fieldObject().setType("SFRotation").setName("update").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY))
          .addField(new fieldObject().setType("SFNode").setName("humanoid").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY)
            .addChild(new HAnimHumanoidObject().setUSE("boxman_Humanoid")))
          .addField(new fieldObject().setType("MFVec3f").setName("coordList").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY))
          .addField(new fieldObject().setType("SFNode").setName("joint").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY)
            .addComments(new CommentsBlock("initialization node (if any) goes here")))
          .addField(new fieldObject().setType("SFVec3f").setName("translation").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setValue("0 0 0"))
          .addField(new fieldObject().setType("SFRotation").setName("rotation").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setValue("1 0 0 0"))
          .addField(new fieldObject().setType("SFVec3f").setName("scale").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setValue("1 1 1")))
        .addComments(new CommentsBlock("Trigger calculation after each animation change"))
        .addComments(new CommentsBlock("<ROUTE fromField='rotation_changed' fromNode='boxman_r_wrist' toField='update' toNode='ENGINE'/>")))      ;
    return X3D0;
    }

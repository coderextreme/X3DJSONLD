...
public class CyclohexeneOxide {
  public static void main(String[] args) {
    ...
    new CyclohexeneOxide().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/CyclohexeneOxide.new.json");
    }
...
ProtoInstanceObject ProtoInstance19 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("CyclohexeneOxide.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of CyclohexeneOxide.x3d scene produced from CyclohexeneOxide.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("CyclohexeneOxide.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/CyclohexeneOxide.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("CyclohexeneOxide.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect CyclohexeneOxide").setPosition(new float[] {0f,2f,20f}))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclohexene_oxide_a1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclohexene_oxide_a2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("Oxygen").setDEF("cyclohexene_oxide_a3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclohexene_oxide_a4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclohexene_oxide_a5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclohexene_oxide_a6")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("Carbon").setDEF("cyclohexene_oxide_a7"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("line").setDEF("cyclohexene_oxide_b1"))
          .addChild(ProtoInstance13 = new ProtoInstanceObject().setName("line").setDEF("cyclohexene_oxide_b2"))
          .addChild(ProtoInstance14 = new ProtoInstanceObject().setName("line").setDEF("cyclohexene_oxide_b3"))
          .addChild(ProtoInstance15 = new ProtoInstanceObject().setName("line").setDEF("cyclohexene_oxide_b5"))
          .addChild(ProtoInstance16 = new ProtoInstanceObject().setName("line").setDEF("cyclohexene_oxide_b6"))
          .addChild(ProtoInstance17 = new ProtoInstanceObject().setName("line").setDEF("cyclohexene_oxide_b8"))
          .addChild(ProtoInstance18 = new ProtoInstanceObject().setName("line").setDEF("cyclohexene_oxide_b11"))
          .addChild(ProtoInstance19 = new ProtoInstanceObject().setName("line").setDEF("cyclohexene_oxide_b14"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"Cyclohexene Oxide: C6 H10 O\""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"molecule weight: 98.14\""));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"melting point: -40\""));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"boiling point: 130\""));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"specific gravity: 0.97\""));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.8118 0.9766 1.8854"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.0793 0.7825 3.3416"));
ProtoInstance7
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.3606 1.93 2.8637"));
ProtoInstance8
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.9157 1.4197 0.9518"));
ProtoInstance9
              .addFieldValue(new fieldValueObject().setName("position").setValue("2.4624 0.9966 3.9062"));
ProtoInstance10
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.2987 1.2094 1.5502"));
ProtoInstance11
              .addFieldValue(new fieldValueObject().setName("position").setValue("3.381 1.7599 2.9643"));
ProtoInstance12
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.0793 0.7825 3.3416 0.8118 0.9766 1.8854"));
ProtoInstance13
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.8118 0.9766 1.8854 0.3606 1.93 2.8637"));
ProtoInstance14
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.8118 0.9766 1.8854 1.9157 1.4197 0.9518"));
ProtoInstance15
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.3606 1.93 2.8637 1.0793 0.7825 3.3416"));
ProtoInstance16
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("2.4624 0.9966 3.9062 1.0793 0.7825 3.3416"));
ProtoInstance17
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.9157 1.4197 0.9518 3.2987 1.2094 1.5502"));
ProtoInstance18
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.381 1.7599 2.9643 2.4624 0.9966 3.9062"));
ProtoInstance19
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("3.381 1.7599 2.9643 3.2987 1.2094 1.5502"));
    return X3D0;
    }

...
public class BoxManAnimationPanel {
  public static void main(String[] args) {
    ...
    new BoxManAnimationPanel().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/HumanoidAnimation/BoxManAnimationPanel.new.json");
    }
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new HAnimHumanoidObject().setName("Humanoid").setDEF("boxman_Humanoid").setInfo(new MFStringObject(new MFString3().getArray())).setVersion("2.0")
          .addJoints(new HAnimJointObject().setName("humanoid_root").setDEF("boxman_HumanoidRoot").setCenter(new float[] {0f,0.9723f,-0.0728f}).setSkinCoordIndex(new MFInt32Object(new MFInt324().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat5().getArray()))
            .addChild(new HAnimSegmentObject().setName("sacrum").setDEF("boxman_sacrum")
            ...
            .addChild(new HAnimJointObject().setName("l_hip").setDEF("boxman_l_hip").setCenter(new float[] {0.0956f,0.9364f,0f}).setSkinCoordIndex(new MFInt32Object(new MFInt326().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat7().getArray()))
              .addChild(new HAnimSegmentObject().setName("l_thigh").setDEF("boxman_l_thigh")
                .addChild(new TransformObject().setTranslation(new float[] {0.0956f,0.9364f,0f})
                  .addChild(new ShapeObject().setUSE("SphereYellow"))))
              .addChild(new HAnimJointObject().setName("l_knee").setDEF("boxman_l_knee").setCenter(new float[] {0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new MFInt32Object(new MFInt328().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat9().getArray()))
                .addChild(new HAnimSegmentObject().setName("l_calf").setDEF("boxman_l_calf")
                  .addChild(new TransformObject().setTranslation(new float[] {0.0956f,0.5095f,-0.0036f})
                    .addChild(new ShapeObject().setUSE("SphereYellow"))))
                .addChild(new HAnimJointObject().setName("l_ankle").setDEF("boxman_l_ankle").setCenter(new float[] {0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new MFInt32Object(new MFInt3210().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat11().getArray()))
                  .addChild(new HAnimSegmentObject().setName("l_hindfoot").setDEF("boxman_l_hindfoot")
                    .addChild(new TransformObject().setTranslation(new float[] {0.0946f,0.0762f,-0.0261f})
                      .addChild(new ShapeObject().setUSE("SphereYellow"))))
                  .addChild(new HAnimJointObject().setName("l_midtarsal").setDEF("boxman_l_midtarsal").setCenter(new float[] {0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new MFInt32Object(new MFInt3212().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat13().getArray()))
                    .addChild(new HAnimSegmentObject().setName("l_middistal").setDEF("boxman_l_middistal")
                      .addChild(new TransformObject().setTranslation(new float[] {0.1079f,0.0317f,0.067f})
                        .addChild(new ShapeObject().setUSE("SphereYellow")))
                      .addChild(new HAnimSiteObject().setName("l_middistal_tip").setDEF("boxman_l_middistal_tip").setTranslation(new float[] {0.095f,0.0005f,0.1924f})
                        .addChild(new ShapeObject().setDEF("SphereRed")
                          .setAppearance(new AppearanceObject()
                            .setMaterial(new MaterialObject().setDiffuseColor(new float[] {1f,0f,0f})))
                          .setGeometry(new SphereObject().setRadius(0.02f)))))))))
            .addChild(new HAnimJointObject().setName("r_hip").setDEF("boxman_r_hip").setCenter(new float[] {-0.0956f,0.9364f,0f}).setSkinCoordIndex(new MFInt32Object(new MFInt3214().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat15().getArray()))
              .addChild(new HAnimSegmentObject().setName("r_thigh").setDEF("boxman_r_thigh")
                .addChild(new TransformObject().setTranslation(new float[] {-0.0956f,0.9364f,0f})
                  .addChild(new ShapeObject().setUSE("SphereYellow"))))
              .addChild(new HAnimJointObject().setName("r_knee").setDEF("boxman_r_knee").setCenter(new float[] {-0.0956f,0.5095f,-0.0036f}).setSkinCoordIndex(new MFInt32Object(new MFInt3216().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat17().getArray()))
                .addChild(new HAnimSegmentObject().setName("r_calf").setDEF("boxman_r_calf")
                  .addChild(new TransformObject().setTranslation(new float[] {-0.0956f,0.5095f,-0.0036f})
                    .addChild(new ShapeObject().setUSE("SphereYellow"))))
                .addChild(new HAnimJointObject().setName("r_ankle").setDEF("boxman_r_ankle").setCenter(new float[] {-0.0946f,0.0762f,-0.0261f}).setSkinCoordIndex(new MFInt32Object(new MFInt3218().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat19().getArray()))
                  .addChild(new HAnimSegmentObject().setName("r_hindfoot").setDEF("boxman_r_hindfoot")
                    .addChild(new TransformObject().setTranslation(new float[] {-0.0946f,0.0762f,-0.0261f})
                      .addChild(new ShapeObject().setUSE("SphereYellow"))))
                  .addChild(new HAnimJointObject().setName("r_midtarsal").setDEF("boxman_r_midtarsal").setCenter(new float[] {-0.1079f,0.0317f,0.067f}).setSkinCoordIndex(new MFInt32Object(new MFInt3220().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat21().getArray()))
                    .addChild(new HAnimSegmentObject().setName("r_middistal").setDEF("boxman_r_middistal")
                      .addChild(new TransformObject().setTranslation(new float[] {-0.1079f,0.0317f,0.067f})
                        .addChild(new ShapeObject().setUSE("SphereYellow")))
                      .addChild(new HAnimSiteObject().setName("r_middistal_tip").setDEF("boxman_r_middistal_tip").setTranslation(new float[] {-0.095f,0.0005f,0.1924f})
                        .addChild(new ShapeObject().setUSE("SphereRed"))))))))
            .addChild(new HAnimJointObject().setName("vl5").setDEF("boxman_vl5").setCenter(new float[] {0f,1.0817f,-0.0728f}).setSkinCoordIndex(new MFInt32Object(new MFInt3222().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat23().getArray()))
              .addChild(new HAnimSegmentObject().setName("l5").setDEF("boxman_l5")
                .addChild(new TransformObject().setTranslation(new float[] {0f,1.0817f,-0.0728f})
                  .addChild(new ShapeObject().setUSE("SphereYellow"))))
              .addChild(new HAnimJointObject().setName("skullbase").setDEF("boxman_skullbase").setCenter(new float[] {0f,1.644f,0.036f}).setSkinCoordIndex(new MFInt32Object(new MFInt3224().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat25().getArray()))
                .addChild(new HAnimSegmentObject().setName("skull").setDEF("boxman_skull")
                  .addChild(new TransformObject().setTranslation(new float[] {0f,1.644f,0.036f})
                    .addChild(new ShapeObject().setUSE("SphereYellow")))
                  .addChild(new HAnimSiteObject().setName("skull_tip").setDEF("boxman_skull_tip").setTranslation(new float[] {-0.0029f,1.7771f,0.0274f})
                    .addChild(new ShapeObject().setUSE("SphereYellow")))))
              .addChild(new HAnimJointObject().setName("l_shoulder").setDEF("boxman_l_shoulder").setCenter(new float[] {0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new MFInt32Object(new MFInt3226().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat27().getArray()))
                .addChild(new HAnimSegmentObject().setName("l_upperarm").setDEF("boxman_l_upperarm")
                  .addChild(new TransformObject().setTranslation(new float[] {0.1968f,1.4642f,-0.0265f})
                    .addChild(new ShapeObject().setUSE("SphereYellow"))))
                .addChild(new HAnimJointObject().setName("l_elbow").setDEF("boxman_l_elbow").setCenter(new float[] {0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new MFInt32Object(new MFInt3228().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat29().getArray()))
                  .addChild(new HAnimSegmentObject().setName("l_forearm").setDEF("boxman_l_forearm")
                    .addChild(new TransformObject().setTranslation(new float[] {0.1982f,1.1622f,-0.0557f})
                      .addChild(new ShapeObject().setUSE("SphereYellow"))))
                  .addChild(new HAnimJointObject().setName("l_wrist").setDEF("boxman_l_wrist").setCenter(new float[] {0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new MFInt32Object(new MFInt3230().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat31().getArray()))
                    .addChild(new HAnimSegmentObject().setName("l_hand").setDEF("boxman_l_hand")
                      .addChild(new TransformObject().setTranslation(new float[] {0.1972f,0.8929f,-0.069f})
                        .addChild(new ShapeObject().setUSE("SphereYellow")))
                      .addChild(new HAnimSiteObject().setName("l_hand_tip").setDEF("boxman_l_hand_tip").setTranslation(new float[] {0.1912f,0.6976f,-0.071f})
                        .addChild(new ShapeObject().setUSE("SphereRed")))))))
              .addChild(new HAnimJointObject().setName("r_shoulder").setDEF("boxman_r_shoulder").setCenter(new float[] {-0.1968f,1.4642f,-0.0265f}).setSkinCoordIndex(new MFInt32Object(new MFInt3232().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat33().getArray()))
                .addChild(new HAnimSegmentObject().setName("r_upperarm").setDEF("boxman_r_upperarm")
                  .addChild(new TransformObject().setTranslation(new float[] {-0.1968f,1.4642f,-0.0265f})
                    .addChild(new ShapeObject().setUSE("SphereYellow"))))
                .addChild(new HAnimJointObject().setName("r_elbow").setDEF("boxman_r_elbow").setCenter(new float[] {-0.1982f,1.1622f,-0.0557f}).setSkinCoordIndex(new MFInt32Object(new MFInt3234().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat35().getArray()))
                  .addChild(new HAnimSegmentObject().setName("r_forearm").setDEF("boxman_r_forearm")
                    .addChild(new TransformObject().setTranslation(new float[] {-0.1982f,1.1622f,-0.0557f})
                      .addChild(new ShapeObject().setUSE("SphereYellow"))))
                  .addChild(new HAnimJointObject().setName("r_wrist").setDEF("boxman_r_wrist").setCenter(new float[] {-0.1972f,0.8929f,-0.069f}).setSkinCoordIndex(new MFInt32Object(new MFInt3236().getArray())).setSkinCoordWeight(new MFFloatObject(new MFFloat37().getArray()))
                    .addChild(new HAnimSegmentObject().setName("r_hand").setDEF("boxman_r_hand")
                      .addChild(new TransformObject().setTranslation(new float[] {-0.1972f,0.8929f,-0.069f})
                        .addChild(new ShapeObject().setUSE("SphereYellow")))
                      .addChild(new HAnimSiteObject().setName("r_hand_tip").setDEF("boxman_r_hand_tip").setTranslation(new float[] {-0.1912f,0.6976f,-0.071f})
                        .addChild(new ShapeObject().setUSE("SphereRed")))))))))

...
public class TransDCE {
  public static void main(String[] args) {
    ...
    new TransDCE().initialize().toFileJSON("../x3d_code/www_web3d_org/x3d/content/examples/Basic/ChemicalMarkupLanguage/TransDCE.new.json");
    }
...
ProtoInstanceObject ProtoInstance12 = null;
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setName("title").setContent("TransDCE.x3d"))
        .addMeta(new metaObject().setName("description").setContent("Autogenerated version of TransDCE.x3d scene produced from TransDCE.xml Chemical Markup Language (CML) version 1.0 source file."))
        ...
        .addMeta(new metaObject().setName("reference").setContent("TransDCE.xml"))
        ...
        .addMeta(new metaObject().setName("identifier").setContent("https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/TransDCE.x3d"))
        .addMeta(new metaObject().setName("license").setContent("../license.html")))
      .setScene(new SceneObject()
        .addChild(new WorldInfoObject().setTitle("TransDCE.x3d"))
        ...
        .addChild(new ViewpointObject().setDescription("Inspect TransDCE").setPosition(new float[] {0f,2f,20f}))
        .addComments(new CommentsBlock("<?xml-stylesheet type=\"text/xsl\" href=\"generic.xsl\" ?>"))
        .addComments(new CommentsBlock("CML document - trans_dce - karne - 7/8/00"))
        ...
        .addChild(new GroupObject()
          .addChild(new TransformObject()
            .addChild(ProtoInstance1 = new ProtoInstanceObject().setName("Carbon").setDEF("trans_dce_karne_a_1")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance2 = new ProtoInstanceObject().setName("Carbon").setDEF("trans_dce_karne_a_2")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance3 = new ProtoInstanceObject().setName("Hydrogen").setDEF("trans_dce_karne_a_3")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance4 = new ProtoInstanceObject().setName("Chlorine").setDEF("trans_dce_karne_a_4")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance5 = new ProtoInstanceObject().setName("Chlorine").setDEF("trans_dce_karne_a_5")))
          .addChild(new TransformObject()
            .addChild(ProtoInstance6 = new ProtoInstanceObject().setName("Hydrogen").setDEF("trans_dce_karne_a_6"))))
        .addChild(new GroupObject()
          .addChild(ProtoInstance7 = new ProtoInstanceObject().setName("line").setDEF("trans_dce_karne_b_1"))
          .addChild(ProtoInstance8 = new ProtoInstanceObject().setName("line").setDEF("trans_dce_karne_b_2"))
          .addChild(ProtoInstance9 = new ProtoInstanceObject().setName("line").setDEF("trans_dce_karne_b_3"))
          .addChild(ProtoInstance10 = new ProtoInstanceObject().setName("line").setDEF("trans_dce_karne_b_4"))
          .addChild(ProtoInstance11 = new ProtoInstanceObject().setName("line").setDEF("trans_dce_karne_b_5"))
          .addChild(ProtoInstance12 = new ProtoInstanceObject().setName("line").setDEF("trans_dce_karne_b_5_2"))))      ;
ProtoInstance0
              .addFieldValue(new fieldValueObject().setName("txt").setValue("\"TransDCE: \""));
ProtoInstance1
              .addFieldValue(new fieldValueObject().setName("position").setValue("0 0.664 0"));
ProtoInstance2
              .addFieldValue(new fieldValueObject().setName("position").setValue("0 -0.664 0"));
ProtoInstance3
              .addFieldValue(new fieldValueObject().setName("position").setValue("0.9 1.26 0"));
ProtoInstance4
              .addFieldValue(new fieldValueObject().setName("position").setValue("-1.468 1.568 0"));
ProtoInstance5
              .addFieldValue(new fieldValueObject().setName("position").setValue("1.468 -1.568 0"));
ProtoInstance6
              .addFieldValue(new fieldValueObject().setName("position").setValue("-0.9 -1.26 0"));
ProtoInstance7
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("-0.9 -1.26 0 0 -0.664 0"));
ProtoInstance8
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("1.468 -1.568 0 0 -0.664 0"));
ProtoInstance9
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("-1.468 1.568 0 0 0.664 0"));
ProtoInstance10
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.9 1.26 0 0 0.664 0"));
ProtoInstance11
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("-0.02 -0.664 0 -0.02 0.664 0"));
ProtoInstance12
            .addFieldValue(new fieldValueObject().setName("bond_set").setValue("0.02 -0.664 0 0.02 0.664 0"));
    return X3D0;
    }

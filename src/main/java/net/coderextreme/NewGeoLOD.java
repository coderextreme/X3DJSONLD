...
public class NewGeoLOD extends org.web3d.x3d.jsail.Geospatial.GeoLOD {
	private X3DNode[] children = null;
	public X3DNode[] getChildren() { children = super.getChildren(); return children; }
	private X3DNode[] rootNode = null;
	public X3DNode[] getRootNode() { rootNode = super.getRootNode(); return rootNode; }
	public X3DNode[] removeSelectedRootNode(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = Arrays.stream(super.getRootNode()).collect(Collectors.toList());
		System.err.println("List length = "+list.size());
		if (list.removeAll(toRemove)) { super.setRootNode(list.toArray(new X3DNode[0])); };
		System.err.println("After list length = "+super.getRootNode().length);
		return super.getRootNode();
	}
	public GeoLOD setRootNode(X3DNode[] leftOver) { rootNode = leftOver; super.setRootNode(leftOver); return this; }

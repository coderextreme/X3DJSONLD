...
public class rubikFurnace implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../personal/rubikFurnace.new.java.x3d");
    model.toFileJSON("../personal/rubikFurnace.new.java.json");
    }
...
ProtoInstance ProtoInstance9 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/rubikFurnace.x3d"))

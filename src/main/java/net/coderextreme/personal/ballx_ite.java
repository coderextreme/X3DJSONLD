...
public class ballx_ite implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../personal/ballx_ite.new.java.x3d");
    model.toFileJSON("../personal/ballx_ite.new.java.json");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/ballx_ite.x3d"))
        .addMeta(new meta().setName("description").setContent("a prismatic sphere")))
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle("ballx_ite.x3d"))

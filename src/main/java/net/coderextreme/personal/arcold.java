...
public class arcold implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../personal/arcold.new.java.x3d");
    model.toFileJSON("../personal/arcold.new.java.json");
    }
...
ProtoInstance ProtoInstance12 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/arc.x3d"))
        .addMeta(new meta().setName("description").setContent("an attempt to implement an arc in a graph")))
      .setScene(new Scene()
        .addChild(new Viewpoint().setPosition(new double[] {0f,0f,5f}).setDescription("a moving graph"))
        .addChild(new Background().setSkyColor(new MFColor0().getArray()))
        .addChild(new Transform().setDEF("trans1")
          .addChild(new Transform().setDEF("rotscale1")
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDiffuseColor(new double[] {0.2f,0.7f,0.7f})))

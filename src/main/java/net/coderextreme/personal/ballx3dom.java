...
public class ballx3dom implements X3DRoots {
  public static void main(String[] args) {
    ...
    X3D model = new ballx3dom().getRootNodeList().get(0); // only get one root node
    System.out.print(model.validationReport().trim());
    model.toFileX3D("../personal/ballx3dom.new.java.x3d");
    model.toFileJSON("../personal/ballx3dom.new.java.json");
    }
    ...
    public X3D initialize() {
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/ballx3dom.x3d"))
        .addMeta(new meta().setName("description").setContent("a prismatic sphere")))
      .setScene(new Scene()
        .addChild(new WorldInfo().setTitle("ballx3dom.x3d"))

...
public class plainflowers implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D("../personal/plainflowers.new.java.x3d");
    model.toFileJSON("../personal/plainflowers.new.java.json");
    }
...
ProtoInstance ProtoInstance6 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/plainflowers.x3d")))
      .setScene(new Scene()
...
private class MFString6 {
  private org.web3d.x3d.jsail.fields.MFString getArray() {
    return new org.web3d.x3d.jsail.fields.MFString(new java.lang.String[] {"../personal/flowerproto.x3d#FlowerProto"});
  }
}
}

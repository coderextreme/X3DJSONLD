...
public class flowerproto {
  public static void main(String[] args) {
    ...
    new flowerproto().initialize().toFileJSON("../new/orig/flowerproto.new.json");
    }
      ...
      .setScene(new SceneObject()
        .addChild(new ProtoDeclareObject().setName("FlowerProto")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setType("MFString").setName("vertex").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setValue("\"gl_flowers_chromatic.vs\""))
            .addField(new fieldObject().setType("MFString").setName("fragment").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setValue("\"pc_flowers.fs\"")))

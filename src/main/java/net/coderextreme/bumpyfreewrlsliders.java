...
public class bumpyfreewrlsliders implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D(".././bumpyfreewrlsliders.new.java.x3d");
    model.toFileJSON(".././bumpyfreewrlsliders.new.java.json");
    }
      ...
      .setScene(new Scene()
        ...
        .addLayerSet(new LayerSet().setActiveLayer(1).setOrder(new MFInt320().getArray())
          ...
          .addLayers(new LayoutLayer().setPickable(true).setObjectType(new MFString21().getArray())
            ...
            .setLayout(new Layout().setAlign(new MFString22().getArray()).setOffset(new MFFloat23().getArray()).setSize(new MFFloat24().getArray()))
            .setViewport(new Viewport().setClipBoundary(new MFFloat25().getArray())))))      ;
    return X3D0;
    }

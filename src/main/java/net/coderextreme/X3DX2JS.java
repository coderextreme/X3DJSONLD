...
// Convert X3DUOM to X3D SAX-Like Parser (X3DX2JS)

class X3DX2JSHandler extends DefaultHandler2 {

    private OutputStreamWriter writer = null;

    public X3DX2JSHandler(OutputStreamWriter writer) {
	this.writer = writer;
    }
...
public class X3DX2JS {
    public static void main (String argv []) throws Exception {
	    ...
	    X3DX2JSHandler handler   = new X3DX2JSHandler(writer);

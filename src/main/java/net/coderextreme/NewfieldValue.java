...
public class NewfieldValue extends org.web3d.x3d.jsail.Core.fieldValue {
	private ArrayList<X3DNode> children = null;
	public ArrayList<X3DNode> getChildren() { children = super.getChildren(); return children; }
	public ArrayList<X3DNode> removeSelectedChildren(ArrayList<X3DNode> children, HashSet toRemove) { children.removeAll(toRemove); return super.getChildren(); }
	public fieldValue setChildren(ArrayList<X3DNode> leftOver) { children = leftOver; super.setChildren(leftOver); return this; }

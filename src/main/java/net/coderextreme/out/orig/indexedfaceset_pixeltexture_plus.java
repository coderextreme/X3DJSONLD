...
public class indexedfaceset_pixeltexture_plus {
  public static void main(String[] args) {
    ...
    new indexedfaceset_pixeltexture_plus().initialize().toFileJSON("../out/orig/indexedfaceset_pixeltexture_plus.new.json");
    }
...
protected class MFVec2f4 {
  protected MFVec2fObject getArray() {
    return new MFVec2fObject(new float[] {-1f,2f,-1f,-1f,2f,2f,2f,-1f});
  }
}
}

...
public class force {
  public static void main(String[] args) {
    ...
    new force().initialize().toFileJSON("../out/orig/force.new.json");
    }
...
""))
        ...
        .addChild(new ScriptObject().setDEF("clickHandler")
          ...
          .addField(new fieldObject().setType("SFNode").setName("ModifiableNode").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT)

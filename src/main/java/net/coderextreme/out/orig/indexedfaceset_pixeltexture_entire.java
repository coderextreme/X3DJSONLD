...
public class indexedfaceset_pixeltexture_entire {
  public static void main(String[] args) {
    ...
    new indexedfaceset_pixeltexture_entire().initialize().toFileJSON("../out/orig/indexedfaceset_pixeltexture_entire.new.json");
    }
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new ShapeObject()
          .setAppearance(new AppearanceObject()
            ...
            .setTexture(new PixelTextureObject().setImage(new int[] {2,2,4,0xFF0000FF,16711935,0xFFFFFFFF,0xFFFF00FF}).setRepeatS(false).setRepeatT(false)))
          .setGeometry(new IndexedFaceSetObject().setCoordIndex(new MFInt32Object(new MFInt320().getArray()))
...
protected class MFVec3f1 {
  protected MFVec3fObject getArray() {
    return new MFVec3fObject(new float[] {-2f,1.5f,1f,-2f,-1.5f,1f,2f,1.5f,1f,2f,-1.5f,1f,2f,1.5f,-1f,2f,-1.5f,-1f,-2f,1.5f,-1f,-2f,-1.5f,-1f});
  }
}
}

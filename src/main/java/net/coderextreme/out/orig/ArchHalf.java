...
public class ArchHalf {
  public static void main(String[] args) {
    ...
    new ArchHalf().initialize().toFileJSON("../out/orig/ArchHalf.new.json");
    }
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        .addChild(new ShapeObject().setDEF("Arch")
          ...
          .setGeometry(new IndexedFaceSetObject().setDEF("ArchIndex").setConvex(false).setCoordIndex(new MFInt32Object(new MFInt320().getArray())).setSolid(false)

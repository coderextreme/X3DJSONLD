...
public class NewCollisionSensor extends org.web3d.x3d.jsail.RigidBodyPhysics.CollisionSensor {
	private X3DNode[] contacts = null;
	public X3DNode[] getContacts() { contacts = super.getContacts(); return contacts; }
	private X3DNode[] intersections = null;
	public X3DNode[] getIntersections() { intersections = super.getIntersections(); return intersections; }

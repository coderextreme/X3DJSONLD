...
public class NewSpecularGlossinessMaterial extends org.web3d.x3d.jsail.X_ITE.SpecularGlossinessMaterial {
	private X3DMaterialExtensionNode extensions = null;
	public X3DMaterialExtensionNode getExtensions() { extensions = super.getExtensions(); return extensions; }
	public X3DMaterialExtensionNode removeSelectedExtensions(X3DMaterialExtensionNode children, HashSet toRemove) { /*extensions.removeAll(toRemove);*/ return super.getExtensions(); }
	public SpecularGlossinessMaterial setExtensions(X3DMaterialExtensionNode leftOver) { extensions = leftOver; super.setExtensions(leftOver); return this; }

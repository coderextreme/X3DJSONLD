...
public class NewLoadSensor extends org.web3d.x3d.jsail.Networking.LoadSensor {
	...
	public LoadSensor setChildren(X3DNode[] leftOver) { children = leftOver; super.setChildren(leftOver); return this; }

...
public class NewLayoutLayer extends org.web3d.x3d.jsail.Layout.LayoutLayer {
	...
	public LayoutLayer setChildren(X3DNode[] leftOver) { children = leftOver; super.setChildren(leftOver); return this; }

...
public class NewViewport extends org.web3d.x3d.jsail.Layering.Viewport {
	...
	public Viewport setChildren(X3DNode[] leftOver) { children = leftOver; super.setChildren(leftOver); return this; }

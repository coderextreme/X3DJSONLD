...
public class NewHAnimHumanoid extends org.web3d.x3d.jsail.HAnim.HAnimHumanoid {
	private HAnimPose children = null;
	public HAnimPose getChildren() { children = super.getChildren(); return children; }
	public HAnimPose removeSelectedChildren(HAnimPose children, HashSet toRemove) { /*children.removeAll(toRemove);*/ return super.getChildren(); }
	public HAnimHumanoid setChildren(HAnimPose leftOver) { children = leftOver; super.setChildren(leftOver); return this; }
	...
	public HAnimHumanoid setJoints(X3DNode[] leftOver) { joints = leftOver; super.setJoints(leftOver); return this; }
	private X3DNode[] motions = null;
	public X3DNode[] getMotions() { motions = super.getMotions(); return motions; }
	public X3DNode[] removeSelectedMotions(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = Arrays.stream(super.getMotions()).collect(Collectors.toList());
		System.err.println("List length = "+list.size());
		if (list.removeAll(toRemove)) { super.setMotions(list.toArray(new X3DNode[0])); };
		System.err.println("After list length = "+super.getMotions().length);
		return super.getMotions();
	}
	public HAnimHumanoid setMotions(X3DNode[] leftOver) { motions = leftOver; super.setMotions(leftOver); return this; }
	private X3DNode[] segments = null;
	public X3DNode[] getSegments() { segments = super.getSegments(); return segments; }
	public X3DNode[] removeSelectedSegments(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = Arrays.stream(super.getSegments()).collect(Collectors.toList());
		System.err.println("List length = "+list.size());
		if (list.removeAll(toRemove)) { super.setSegments(list.toArray(new X3DNode[0])); };
		System.err.println("After list length = "+super.getSegments().length);
		return super.getSegments();
	}
	public HAnimHumanoid setSegments(X3DNode[] leftOver) { segments = leftOver; super.setSegments(leftOver); return this; }
	private X3DNode[] sites = null;
	public X3DNode[] getSites() { sites = super.getSites(); return sites; }
	public X3DNode[] removeSelectedSites(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = Arrays.stream(super.getSites()).collect(Collectors.toList());
		System.err.println("List length = "+list.size());
		if (list.removeAll(toRemove)) { super.setSites(list.toArray(new X3DNode[0])); };
		System.err.println("After list length = "+super.getSites().length);
		return super.getSites();
	}
	public HAnimHumanoid setSites(X3DNode[] leftOver) { sites = leftOver; super.setSites(leftOver); return this; }
	private X3DNode[] skeleton = null;
	public X3DNode[] getSkeleton() { skeleton = super.getSkeleton(); return skeleton; }
	public X3DNode[] removeSelectedSkeleton(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = Arrays.stream(super.getSkeleton()).collect(Collectors.toList());
		System.err.println("List length = "+list.size());
		if (list.removeAll(toRemove)) { super.setSkeleton(list.toArray(new X3DNode[0])); };
		System.err.println("After list length = "+super.getSkeleton().length);
		return super.getSkeleton();
	}
	public HAnimHumanoid setSkeleton(X3DNode[] leftOver) { skeleton = leftOver; super.setSkeleton(leftOver); return this; }
	private X3DNode[] skin = null;
	public X3DNode[] getSkin() { skin = super.getSkin(); return skin; }
	public X3DNode[] removeSelectedSkin(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = Arrays.stream(super.getSkin()).collect(Collectors.toList());
		System.err.println("List length = "+list.size());
		if (list.removeAll(toRemove)) { super.setSkin(list.toArray(new X3DNode[0])); };
		System.err.println("After list length = "+super.getSkin().length);
		return super.getSkin();
	}
	public HAnimHumanoid setSkin(X3DNode[] leftOver) { skin = leftOver; super.setSkin(leftOver); return this; }
	private X3DNode[] viewpoints = null;
	public X3DNode[] getViewpoints() { viewpoints = super.getViewpoints(); return viewpoints; }
	public X3DNode[] removeSelectedViewpoints(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = Arrays.stream(super.getViewpoints()).collect(Collectors.toList());
		System.err.println("List length = "+list.size());
		if (list.removeAll(toRemove)) { super.setViewpoints(list.toArray(new X3DNode[0])); };
		System.err.println("After list length = "+super.getViewpoints().length);
		return super.getViewpoints();
	}
	public HAnimHumanoid setViewpoints(X3DNode[] leftOver) { viewpoints = leftOver; super.setViewpoints(leftOver); return this; }

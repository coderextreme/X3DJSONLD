...
public class NewHAnimHumanoid extends org.web3d.x3d.jsail.HAnim.HAnimHumanoid {
	...
	public X3DNode[] removeSelectedMotions(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = (List<X3DNode>)Arrays.asList(motions);
		if (list.removeAll(toRemove)) { super.setMotions((X3DNode[])(list.toArray())); };
	...
	public X3DNode[] removeSelectedSegments(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = (List<X3DNode>)Arrays.asList(segments);
		if (list.removeAll(toRemove)) { super.setSegments((X3DNode[])(list.toArray())); };
	...
	public X3DNode[] removeSelectedSites(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = (List<X3DNode>)Arrays.asList(sites);
		if (list.removeAll(toRemove)) { super.setSites((X3DNode[])(list.toArray())); };
	...
	public X3DNode[] removeSelectedSkeleton(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = (List<X3DNode>)Arrays.asList(skeleton);
		if (list.removeAll(toRemove)) { super.setSkeleton((X3DNode[])(list.toArray())); };
	...
	public X3DNode[] removeSelectedSkin(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = (List<X3DNode>)Arrays.asList(skin);
		if (list.removeAll(toRemove)) { super.setSkin((X3DNode[])(list.toArray())); };
	...
	public X3DNode[] removeSelectedViewpoints(X3DNode[] children, HashSet toRemove) {
		List<X3DNode> list = (List<X3DNode>)Arrays.asList(viewpoints);
		if (list.removeAll(toRemove)) { super.setViewpoints((X3DNode[])(list.toArray())); };

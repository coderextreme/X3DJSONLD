...
public class bumpyfreewrljsonverse implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D(".././bumpyfreewrljsonverse.new.java.x3d");
    model.toFileJSON(".././bumpyfreewrljsonverse.new.java.json");
    }
...
"}"))
            ...
            .setLayout(new Layout().setAlign(new MFString24().getArray()).setOffset(new MFFloat25().getArray()).setSize(new MFFloat26().getArray()))
            .setViewport(new Viewport().setClipBoundary(new MFFloat27().getArray())))))      ;
ProtoInstance0

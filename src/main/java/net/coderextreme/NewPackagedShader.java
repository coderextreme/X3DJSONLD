...
public class NewPackagedShader extends org.web3d.x3d.jsail.Shaders.PackagedShader {
	private ArrayList<field> fieldList = null;
	public ArrayList<field> getFieldList() { fieldList = super.getFieldList(); return fieldList; }
	public ArrayList<field> removeSelectedFieldList(ArrayList<field> children, HashSet toRemove) { fieldList.removeAll(toRemove); return super.getFieldList(); }
	public PackagedShader setFieldList(ArrayList<field> leftOver) { fieldList = leftOver; super.setFieldList(leftOver); return this; }

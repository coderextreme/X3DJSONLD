...
public class Jin20fSegmented implements X3DRoots {
  public static void main(String[] args) {
    ...
    model.toFileX3D(".././Jin20fSegmented.new.java.x3d");
    model.toFileJSON(".././Jin20fSegmented.new.java.json");
    }
    ...
    public X3D initialize() {
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("JinLOA4S").setDEF("hanim_JinLOA4S").setLoa(4).setVersion("2.0")
          .addSkeleton(((HAnimJoint)new HAnimJoint("hanim_JinLOA4S").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(new double[] {0f,0.77f,0f}).setUlimit(new MFFloat4().getArray()).setLlimit(new MFFloat5().getArray()).setContainerFieldOverride("skeleton"))
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("sacroiliac").setDEF("hanim_sacroiliac").setCenter(new double[] {0f,0.826f,0.02f}).setUlimit(new MFFloat6().getArray()).setLlimit(new MFFloat7().getArray())
              .addChild(new HAnimSegment("hanim_sacroiliac").setName("pelvis").setDEF("hanim_pelvis")
                .addChild(new HAnimSite("hanim_pelvis").setName("l_iliocristale").setDEF("hanim_l_iliocristale_pt").setTranslation(new double[] {0.13f,0.92f,0.0035f})
                ...
                .addChild(new HAnimSite("hanim_pelvis").setName("r_iliocristale").setDEF("hanim_r_iliocristale_pt").setTranslation(new double[] {-0.13f,0.92f,0.0035f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString15().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_pelvis").setName("l_trochanterion").setDEF("hanim_l_trochanterion_pt").setTranslation(new double[] {0.14f,0.8f,0.0035f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString19().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_pelvis").setName("r_trochanterion").setDEF("hanim_r_trochanterion_pt").setTranslation(new double[] {-0.14f,0.8f,0.0035f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString23().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_pelvis").setName("l_asis").setDEF("hanim_l_asis_pt").setTranslation(new double[] {0.1f,0.86f,0.0035f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString27().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_pelvis").setName("r_asis").setDEF("hanim_r_asis_pt").setTranslation(new double[] {-0.1f,0.86f,0.0035f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString31().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_pelvis").setName("l_psis").setDEF("hanim_l_psis_pt").setTranslation(new double[] {0.05f,0.84f,-0.11f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString35().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_pelvis").setName("r_psis").setDEF("hanim_r_psis_pt").setTranslation(new double[] {-0.05f,0.84f,-0.11f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString39().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_pelvis").setName("crotch").setDEF("hanim_crotch_pt").setTranslation(new double[] {0f,0.703f,0f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString43().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_pelvis").setName("buttocks_standing_wall_contact_point").setDEF("hanim_buttocks_standing_wall_contact_point_pt").setTranslation(new double[] {0f,0.8f,-0.15f})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("l_hip").setDEF("hanim_l_hip").setCenter(new double[] {0.095f,0.8266f,-0.0183f}).setUlimit(new MFFloat51().getArray()).setLlimit(new MFFloat52().getArray())
                .addChild(new HAnimSegment("hanim_l_hip").setName("l_thigh").setDEF("hanim_l_thigh")
                  .addChild(new HAnimSite("hanim_l_thigh").setName("l_knee_crease").setDEF("hanim_l_knee_crease_pt").setTranslation(new double[] {0.09f,0.41f,-0.056f})
                    ...
                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                      .addChild(new Shape()
                        .setGeometry(new Text().setString(new MFString56().getArray())
                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                  .addChild(new HAnimSite("hanim_l_thigh").setName("l_femoral_medial_epicondyle").setDEF("hanim_l_femoral_medial_epicondyle_pt").setTranslation(new double[] {0.039f,0.41f,-0.01f})
                    ...
                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                      .addChild(new Shape()
                        .setGeometry(new Text().setString(new MFString60().getArray())
                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                  .addChild(new HAnimSite("hanim_l_thigh").setName("l_femoral_lateral_epicondyle").setDEF("hanim_l_femoral_lateral_epicondyle_pt").setTranslation(new double[] {0.127f,0.41f,-0.01f})
                    ...
                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                      .addChild(new Shape()
                        .setGeometry(new Text().setString(new MFString64().getArray())
                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                  .addChild(new HAnimSite("hanim_l_thigh").setName("l_suprapatella").setDEF("hanim_l_suprapatella_pt").setTranslation(new double[] {0.085f,0.41f,0.042f})
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(new double[] {0.0926f,0.4088f,-0.01944f}).setUlimit(new MFFloat72().getArray()).setLlimit(new MFFloat73().getArray())
                  .addChild(new HAnimSegment("hanim_l_knee").setName("l_calf").setDEF("hanim_l_calf")
                    .addChild(new HAnimSite("hanim_l_calf").setName("l_tibiale").setDEF("hanim_l_tibiale_pt").setTranslation(new double[] {0.09f,0.31f,0.038f})
                      ...
                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                        .addChild(new Shape()
                          .setGeometry(new Text().setString(new MFString77().getArray())
                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                    .addChild(new HAnimSite("hanim_l_calf").setName("l_medial_malleolus").setDEF("hanim_l_medial_malleolus_pt").setTranslation(new double[] {0.061f,0.095f,-0.02f})
                      ...
                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                        .addChild(new Shape()
                          .setGeometry(new Text().setString(new MFString81().getArray())
                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                    .addChild(new HAnimSite("hanim_l_calf").setName("l_lateral_malleolus").setDEF("hanim_l_lateral_malleolus_pt").setTranslation(new double[] {0.12f,0.095f,-0.02f})
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(new double[] {0.0888f,0.09545f,-0.01045f}).setUlimit(new MFFloat89().getArray()).setLlimit(new MFFloat90().getArray())
                    .addChild(new HAnimSegment("hanim_l_talocrural").setName("l_talus").setDEF("hanim_l_talus")
                      .addChild(new HAnimSite("hanim_l_talus").setName("l_sphyrion").setDEF("hanim_l_sphyrion_pt").setTranslation(new double[] {0.054f,0.065f,-0.02f})
                        ...
                        .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                          .addChild(new Shape()
                            .setGeometry(new Text().setString(new MFString94().getArray())
                              .setFontStyle(new FontStyle().setSize(0.035f))))))
                      .addChild(new HAnimSite("hanim_l_talus").setName("l_calcaneus_posterior").setDEF("hanim_l_calcaneus_posterior_pt").setTranslation(new double[] {0.09f,0.03f,-0.06f})
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocalcaneonavicular").setDEF("hanim_l_talocalcaneonavicular").setCenter(new double[] {0.0783f,0.0369f,0.0049f}).setUlimit(new MFFloat102().getArray()).setLlimit(new MFFloat103().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_1").setDEF("hanim_l_cuneonavicular_1").setCenter(new double[] {0.0674f,0.0321f,0.0184f}).setUlimit(new MFFloat107().getArray()).setLlimit(new MFFloat108().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setName("l_tarsometatarsal_1").setDEF("hanim_l_tarsometatarsal_1").setCenter(new double[] {0.0646f,0.02324f,0.0442f}).setUlimit(new MFFloat112().getArray()).setLlimit(new MFFloat113().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setName("l_metatarsophalangeal_1").setDEF("hanim_l_metatarsophalangeal_1").setCenter(new double[] {0.0621f,0.01442f,0.0936f}).setUlimit(new MFFloat117().getArray()).setLlimit(new MFFloat118().getArray())
                            .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_1").setName("l_tarsal_proximal_phalanx_1").setDEF("hanim_l_tarsal_proximal_phalanx_1")
                              .addChild(new HAnimSite("hanim_l_tarsal_proximal_phalanx_1").setName("l_metatarsal_phalanx_1").setDEF("hanim_l_metatarsal_phalanx_1_pt").setTranslation(new double[] {0.062f,0.012f,0.1f})
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setName("l_tarsal_interphalangeal_1").setDEF("hanim_l_tarsal_interphalangeal_1").setCenter(new double[] {0.062f,0.012f,0.115f}).setUlimit(new MFFloat126().getArray()).setLlimit(new MFFloat127().getArray())
                              .addChild(new HAnimSegment("hanim_l_tarsal_interphalangeal_1").setName("l_tarsal_distal_phalanx_1").setDEF("hanim_l_tarsal_distal_phalanx_1")
                                .addChild(new HAnimSite("hanim_l_tarsal_distal_phalanx_1").setName("l_tarsal_distal_phalanx_1").setDEF("hanim_l_tarsal_distal_phalanx_1_tip").setTranslation(new double[] {0.062f,0.012f,0.134f})
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_2").setDEF("hanim_l_cuneonavicular_2").setCenter(new double[] {0.0814f,0.0335f,0.02143f}).setUlimit(new MFFloat135().getArray()).setLlimit(new MFFloat136().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setName("l_tarsometatarsal_2").setDEF("hanim_l_tarsometatarsal_2").setCenter(new double[] {0.0802f,0.0261f,0.0411f}).setUlimit(new MFFloat140().getArray()).setLlimit(new MFFloat141().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(new double[] {0.0825f,0.01497f,0.09783f}).setUlimit(new MFFloat145().getArray()).setLlimit(new MFFloat146().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setCenter(new double[] {0.0843f,0.01265f,0.114f}).setUlimit(new MFFloat150().getArray()).setLlimit(new MFFloat151().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setCenter(new double[] {0.0843f,0.00982f,0.123435f}).setUlimit(new MFFloat155().getArray()).setLlimit(new MFFloat156().getArray())
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_phalanx_2").setDEF("hanim_l_tarsal_distal_phalanx_2")
                                  .addChild(new HAnimSite("hanim_l_tarsal_distal_phalanx_2").setName("l_tarsal_distal_phalanx_2").setDEF("hanim_l_tarsal_distal_phalanx_2_tip").setTranslation(new double[] {0.08f,0.016f,0.14f})
                      ...
                      .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_3").setDEF("hanim_l_cuneonavicular_3").setCenter(new double[] {0.09297f,0.0334f,0.01982f}).setUlimit(new MFFloat164().getArray()).setLlimit(new MFFloat165().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setName("l_tarsometatarsal_3").setDEF("hanim_l_tarsometatarsal_3").setCenter(new double[] {0.09459f,0.0261f,0.0394f}).setUlimit(new MFFloat169().getArray()).setLlimit(new MFFloat170().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setName("l_metatarsophalangeal_3").setDEF("hanim_l_metatarsophalangeal_3").setCenter(new double[] {0.0965f,0.01505f,0.0954f}).setUlimit(new MFFloat174().getArray()).setLlimit(new MFFloat175().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setName("l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setCenter(new double[] {0.09886f,0.01192f,0.11047f}).setUlimit(new MFFloat179().getArray()).setLlimit(new MFFloat180().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setCenter(new double[] {0.1004f,0.00983f,0.1197f}).setUlimit(new MFFloat184().getArray()).setLlimit(new MFFloat185().getArray())
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_3").setName("l_tarsal_distal_phalanx_3").setDEF("hanim_l_tarsal_distal_phalanx_3")
                                  .addChild(new HAnimSite("hanim_l_tarsal_distal_phalanx_3").setName("l_tarsal_distal_phalanx_3").setDEF("hanim_l_tarsal_distal_phalanx_3_tip").setTranslation(new double[] {0.1f,0.016f,0.14f})
                    ...
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_calcaneocuboid").setDEF("hanim_l_calcaneocuboid").setCenter(new double[] {0.0891f,0.05798f,-0.0259f}).setUlimit(new MFFloat193().getArray()).setLlimit(new MFFloat194().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setName("l_transversetarsal").setDEF("hanim_l_transversetarsal").setCenter(new double[] {0.11063f,0.03528f,0.0021f}).setUlimit(new MFFloat198().getArray()).setLlimit(new MFFloat199().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_4").setDEF("hanim_l_tarsometatarsal_4").setCenter(new double[] {0.10649f,0.02454f,0.03843f}).setUlimit(new MFFloat203().getArray()).setLlimit(new MFFloat204().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setName("l_metatarsophalangeal_4").setDEF("hanim_l_metatarsophalangeal_4").setCenter(new double[] {0.109867f,0.01435f,0.09117f}).setUlimit(new MFFloat208().getArray()).setLlimit(new MFFloat209().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setName("l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setCenter(new double[] {0.11416f,0.01224f,0.10631f}).setUlimit(new MFFloat213().getArray()).setLlimit(new MFFloat214().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setCenter(new double[] {0.11567f,0.00936f,0.11369f}).setUlimit(new MFFloat218().getArray()).setLlimit(new MFFloat219().getArray())
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_4").setName("l_tarsal_distal_phalanx_4").setDEF("hanim_l_tarsal_distal_phalanx_4")
                                  .addChild(new HAnimSite("hanim_l_tarsal_distal_phalanx_4").setName("l_tarsal_distal_phalanx_4").setDEF("hanim_l_tarsal_distal_phalanx_4_tip").setTranslation(new double[] {0.115f,0.016f,0.13f})
                        ...
                        .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_5").setDEF("hanim_l_tarsometatarsal_5").setCenter(new double[] {0.1208f,0.02094f,0.03474f}).setUlimit(new MFFloat227().getArray()).setLlimit(new MFFloat228().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setName("l_metatarsophalangeal_5").setDEF("hanim_l_metatarsophalangeal_5").setCenter(new double[] {0.124065f,0.01367f,0.08656f}).setUlimit(new MFFloat232().getArray()).setLlimit(new MFFloat233().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setName("l_tarsal_proximal_interphalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_5").setCenter(new double[] {0.12638f,0.01086f,0.09414f}).setUlimit(new MFFloat237().getArray()).setLlimit(new MFFloat238().getArray())
                              .addChild(new HAnimSegment("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_middle_phalanx_5").setDEF("hanim_l_tarsal_middle_phalanx_5")
                                .addChild(new HAnimSite("hanim_l_tarsal_middle_phalanx_5").setName("l_metatarsal_phalanx_5").setDEF("hanim_l_metatarsal_phalanx_5_pt").setTranslation(new double[] {0.12f,0.02f,0.04f})
                              ...
                              .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setCenter(new double[] {0.12728f,0.00856f,0.10188f}).setUlimit(new MFFloat246().getArray()).setLlimit(new MFFloat247().getArray())
                                .addChild(new HAnimSegment("hanim_l_tarsal_distal_interphalangeal_5").setName("l_tarsal_distal_phalanx_5").setDEF("hanim_l_tarsal_distal_phalanx_5")
                                  .addChild(new HAnimSite("hanim_l_tarsal_distal_phalanx_5").setName("l_tarsal_distal_phalanx_5").setDEF("hanim_l_tarsal_distal_phalanx_5_tip").setTranslation(new double[] {0.125f,0.016f,0.115f})
              ...
              .addChild(new HAnimJoint("hanim_sacroiliac").setName("r_hip").setDEF("hanim_r_hip").setCenter(new double[] {-0.09466f,0.82665f,-0.01835f}).setUlimit(new MFFloat255().getArray()).setLlimit(new MFFloat256().getArray())
                .addChild(new HAnimSegment("hanim_r_hip").setName("r_thigh").setDEF("hanim_r_thigh")
                  .addChild(new HAnimSite("hanim_r_thigh").setName("r_knee_crease").setDEF("hanim_r_knee_crease_pt").setTranslation(new double[] {-0.09f,0.41f,-0.056f})
                    ...
                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                      .addChild(new Shape()
                        .setGeometry(new Text().setString(new MFString260().getArray())
                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                  .addChild(new HAnimSite("hanim_r_thigh").setName("r_femoral_medial_epicondyle").setDEF("hanim_r_femoral_medial_epicondyle_pt").setTranslation(new double[] {-0.039f,0.41f,-0.01f})
                    ...
                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                      .addChild(new Shape()
                        .setGeometry(new Text().setString(new MFString264().getArray())
                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                  .addChild(new HAnimSite("hanim_r_thigh").setName("r_femoral_lateral_epicondyle").setDEF("hanim_r_femoral_lateral_epicondyle_pt").setTranslation(new double[] {-0.127f,0.41f,-0.01f})
                    ...
                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                      .addChild(new Shape()
                        .setGeometry(new Text().setString(new MFString268().getArray())
                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                  .addChild(new HAnimSite("hanim_r_thigh").setName("r_suprapatella").setDEF("hanim_r_suprapatella_pt").setTranslation(new double[] {-0.085f,0.41f,0.042f})
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(new double[] {-0.0926f,0.408825f,-0.01944f}).setUlimit(new MFFloat276().getArray()).setLlimit(new MFFloat277().getArray())
                  .addChild(new HAnimSegment("hanim_r_knee").setName("r_calf").setDEF("hanim_r_calf")
                    .addChild(new HAnimSite("hanim_r_calf").setName("r_tibiale").setDEF("hanim_r_tibiale_pt").setTranslation(new double[] {-0.09f,0.31f,0.038f})
                      ...
                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                        .addChild(new Shape()
                          .setGeometry(new Text().setString(new MFString281().getArray())
                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                    .addChild(new HAnimSite("hanim_r_calf").setName("r_medial_malleolus").setDEF("hanim_r_medial_malleolus_pt").setTranslation(new double[] {-0.061f,0.095f,-0.02f})
                      ...
                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                        .addChild(new Shape()
                          .setGeometry(new Text().setString(new MFString285().getArray())
                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                    .addChild(new HAnimSite("hanim_r_calf").setName("r_lateral_malleolus").setDEF("hanim_r_lateral_malleolus_pt").setTranslation(new double[] {-0.12f,0.095f,-0.02f})
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(new double[] {-0.08845f,0.09544f,-0.01045f}).setUlimit(new MFFloat293().getArray()).setLlimit(new MFFloat294().getArray())
                    .addChild(new HAnimSegment("hanim_r_talocrural").setName("r_talus").setDEF("hanim_r_talus")
                      .addChild(new HAnimSite("hanim_r_talus").setName("r_sphyrion").setDEF("hanim_r_sphyrion_pt").setTranslation(new double[] {-0.054f,0.065f,-0.02f})
                        ...
                        .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                          .addChild(new Shape()
                            .setGeometry(new Text().setString(new MFString298().getArray())
                              .setFontStyle(new FontStyle().setSize(0.035f))))))
                      .addChild(new HAnimSite("hanim_r_talus").setName("r_calcaneus_posterior").setDEF("hanim_r_calcaneus_posterior_pt").setTranslation(new double[] {-0.09f,0.03f,-0.06f})
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_talocalcaneonavicular").setDEF("hanim_r_talocalcaneonavicular").setCenter(new double[] {-0.07794f,0.0369f,0.00486f}).setUlimit(new MFFloat306().getArray()).setLlimit(new MFFloat307().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_1").setDEF("hanim_r_cuneonavicular_1").setCenter(new double[] {-0.06698f,0.032107f,0.01839f}).setUlimit(new MFFloat311().getArray()).setLlimit(new MFFloat312().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_1").setName("r_tarsometatarsal_1").setDEF("hanim_r_tarsometatarsal_1").setCenter(new double[] {-0.064f,0.02324f,0.04419f}).setUlimit(new MFFloat316().getArray()).setLlimit(new MFFloat317().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_1").setName("r_metatarsophalangeal_1").setDEF("hanim_r_metatarsophalangeal_1").setCenter(new double[] {-0.06176f,0.014425f,0.09362f}).setUlimit(new MFFloat321().getArray()).setLlimit(new MFFloat322().getArray())
                            .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_1").setName("r_tarsal_proximal_phalanx_1").setDEF("hanim_r_tarsal_proximal_phalanx_1")
                              .addChild(new HAnimSite("hanim_r_tarsal_proximal_phalanx_1").setName("r_metatarsal_phalanx_1").setDEF("hanim_r_metatarsal_phalanx_1_pt").setTranslation(new double[] {-0.062f,0.012f,0.1f})
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_1").setName("r_tarsal_interphalangeal_1").setDEF("hanim_r_tarsal_interphalangeal_1").setCenter(new double[] {-0.06174f,0.0121f,0.1153f}).setUlimit(new MFFloat330().getArray()).setLlimit(new MFFloat331().getArray())
                              .addChild(new HAnimSegment("hanim_r_tarsal_interphalangeal_1").setName("r_tarsal_distal_phalanx_1").setDEF("hanim_r_tarsal_distal_phalanx_1")
                                .addChild(new HAnimSite("hanim_r_tarsal_distal_phalanx_1").setName("r_tarsal_distal_phalanx_1").setDEF("hanim_r_tarsal_distal_phalanx_1_tip").setTranslation(new double[] {-0.06f,0.012f,0.14f})
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_2").setDEF("hanim_r_cuneonavicular_2").setCenter(new double[] {-0.081f,0.0335f,0.02142f}).setUlimit(new MFFloat339().getArray()).setLlimit(new MFFloat340().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_2").setName("r_tarsometatarsal_2").setDEF("hanim_r_tarsometatarsal_2").setCenter(new double[] {-0.07983f,0.0261f,0.04106f}).setUlimit(new MFFloat344().getArray()).setLlimit(new MFFloat345().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(new double[] {-0.0821f,0.01497f,0.09783f}).setUlimit(new MFFloat349().getArray()).setLlimit(new MFFloat350().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_tarsal_proximal_interphalangeal_2").setDEF("hanim_r_tarsal_proximal_interphalangeal_2").setCenter(new double[] {-0.0839f,0.012647f,0.114f}).setUlimit(new MFFloat354().getArray()).setLlimit(new MFFloat355().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setCenter(new double[] {-0.0839f,0.009825f,0.123435f}).setUlimit(new MFFloat359().getArray()).setLlimit(new MFFloat360().getArray())
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_2").setName("r_tarsal_distal_phalanx_2").setDEF("hanim_r_tarsal_distal_phalanx_2")
                                  .addChild(new HAnimSite("hanim_r_tarsal_distal_phalanx_2").setName("r_tarsal_distal_phalanx_2").setDEF("hanim_r_tarsal_distal_phalanx_2_tip").setTranslation(new double[] {-0.08f,0.016f,0.14f})
                      ...
                      .addChild(new HAnimJoint("hanim_r_talocalcaneonavicular").setName("r_cuneonavicular_3").setDEF("hanim_r_cuneonavicular_3").setCenter(new double[] {-0.09261f,0.03339f,0.01982f}).setUlimit(new MFFloat368().getArray()).setLlimit(new MFFloat369().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_cuneonavicular_3").setName("r_tarsometatarsal_3").setDEF("hanim_r_tarsometatarsal_3").setCenter(new double[] {-0.09423f,0.0261f,0.0394f}).setUlimit(new MFFloat373().getArray()).setLlimit(new MFFloat374().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_3").setName("r_metatarsophalangeal_3").setDEF("hanim_r_metatarsophalangeal_3").setCenter(new double[] {-0.0961f,0.01505f,0.09542f}).setUlimit(new MFFloat378().getArray()).setLlimit(new MFFloat379().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_3").setName("r_tarsal_proximal_interphalangeal_3").setDEF("hanim_r_tarsal_proximal_interphalangeal_3").setCenter(new double[] {-0.0985f,0.01192f,0.11047f}).setUlimit(new MFFloat383().getArray()).setLlimit(new MFFloat384().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_3").setName("r_tarsal_distal_interphalangeal_3").setDEF("hanim_r_tarsal_distal_interphalangeal_3").setCenter(new double[] {-0.100035f,0.00982f,0.1197f}).setUlimit(new MFFloat388().getArray()).setLlimit(new MFFloat389().getArray())
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_3").setName("r_tarsal_distal_phalanx_3").setDEF("hanim_r_tarsal_distal_phalanx_3")
                                  .addChild(new HAnimSite("hanim_r_tarsal_distal_phalanx_3").setName("r_tarsal_distal_phalanx_3").setDEF("hanim_r_tarsal_distal_phalanx_3_tip").setTranslation(new double[] {-0.1f,0.016f,0.14f})
                    ...
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_calcaneocuboid").setDEF("hanim_r_calcaneocuboid").setCenter(new double[] {-0.088717f,0.05798f,-0.025965f}).setUlimit(new MFFloat397().getArray()).setLlimit(new MFFloat398().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_r_calcaneocuboid").setName("r_transversetarsal").setDEF("hanim_r_transversetarsal").setCenter(new double[] {-0.11027f,0.03528f,0.0021f}).setUlimit(new MFFloat402().getArray()).setLlimit(new MFFloat403().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName("r_tarsometatarsal_4").setDEF("hanim_r_tarsometatarsal_4").setCenter(new double[] {-0.10613f,0.02454f,0.03843f}).setUlimit(new MFFloat407().getArray()).setLlimit(new MFFloat408().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_4").setName("r_metatarsophalangeal_4").setDEF("hanim_r_metatarsophalangeal_4").setCenter(new double[] {-0.1095f,0.01435f,0.09117f}).setUlimit(new MFFloat412().getArray()).setLlimit(new MFFloat413().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_4").setName("r_tarsal_proximal_interphalangeal_4").setDEF("hanim_r_tarsal_proximal_interphalangeal_4").setCenter(new double[] {-0.11378f,0.01224f,0.1063f}).setUlimit(new MFFloat417().getArray()).setLlimit(new MFFloat418().getArray())
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_4").setName("r_tarsal_distal_interphalangeal_4").setDEF("hanim_r_tarsal_distal_interphalangeal_4").setCenter(new double[] {-0.1153f,0.00937f,0.11369f}).setUlimit(new MFFloat422().getArray()).setLlimit(new MFFloat423().getArray())
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_4").setName("r_tarsal_distal_phalanx_4").setDEF("hanim_r_tarsal_distal_phalanx_4")
                                  .addChild(new HAnimSite("hanim_r_tarsal_distal_phalanx_4").setName("r_tarsal_distal_phalanx_4").setDEF("hanim_r_tarsal_distal_phalanx_4_tip").setTranslation(new double[] {-0.115f,0.016f,0.13f})
                        ...
                        .addChild(new HAnimJoint("hanim_r_transversetarsal").setName("r_tarsometatarsal_5").setDEF("hanim_r_tarsometatarsal_5").setCenter(new double[] {-0.12044f,0.020945f,0.03474f}).setUlimit(new MFFloat431().getArray()).setLlimit(new MFFloat432().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_r_tarsometatarsal_5").setName("r_metatarsophalangeal_5").setDEF("hanim_r_metatarsophalangeal_5").setCenter(new double[] {-0.12368f,0.01367f,0.08656f}).setUlimit(new MFFloat436().getArray()).setLlimit(new MFFloat437().getArray())
                            ...
                            .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_5").setName("r_tarsal_proximal_interphalangeal_5").setDEF("hanim_r_tarsal_proximal_interphalangeal_5").setCenter(new double[] {-0.126f,0.01086f,0.09414f}).setUlimit(new MFFloat441().getArray()).setLlimit(new MFFloat442().getArray())
                              .addChild(new HAnimSegment("hanim_r_tarsal_proximal_interphalangeal_5").setName("r_tarsal_middle_phalanx_5").setDEF("hanim_r_tarsal_middle_phalanx_5")
                                .addChild(new HAnimSite("hanim_r_tarsal_middle_phalanx_5").setName("r_metatarsal_phalanx_5").setDEF("hanim_r_metatarsal_phalanx_5_pt").setTranslation(new double[] {-0.12f,0.02f,0.04f})
                              ...
                              .addChild(new HAnimJoint("hanim_r_tarsal_proximal_interphalangeal_5").setName("r_tarsal_distal_interphalangeal_5").setDEF("hanim_r_tarsal_distal_interphalangeal_5").setCenter(new double[] {-0.1269f,0.00856f,0.10188f}).setUlimit(new MFFloat450().getArray()).setLlimit(new MFFloat451().getArray())
                                .addChild(new HAnimSegment("hanim_r_tarsal_distal_interphalangeal_5").setName("r_tarsal_distal_phalanx_5").setDEF("hanim_r_tarsal_distal_phalanx_5")
                                  .addChild(new HAnimSite("hanim_r_tarsal_distal_phalanx_5").setName("r_tarsal_distal_phalanx_5").setDEF("hanim_r_tarsal_distal_phalanx_5_tip").setTranslation(new double[] {-0.125f,0.016f,0.115f})
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("vl5").setDEF("hanim_vl5").setCenter(new double[] {0f,0.9254f,-0.01376f}).setUlimit(new MFFloat459().getArray()).setLlimit(new MFFloat460().getArray())
              .addChild(new HAnimSegment("hanim_vl5").setName("l5").setDEF("hanim_l5")
                .addChild(new HAnimSite("hanim_l5").setName("spine_1_middle_back").setDEF("hanim_spine_1_middle_back_pt").setTranslation(new double[] {0f,1f,-0.1f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString464().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_l5").setName("spine_2_lower_back").setDEF("hanim_spine_2_lower_back_pt").setTranslation(new double[] {0f,0.95f,-0.1f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString468().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_l5").setName("waist_preferred_anterior").setDEF("hanim_waist_preferred_anterior_pt").setTranslation(new double[] {0f,0.9f,0.1f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString472().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_l5").setName("waist_preferred_posterior").setDEF("hanim_waist_preferred_posterior_pt").setTranslation(new double[] {0f,0.9f,-0.1f})
                  ...
                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                    .addChild(new Shape()
                      .setGeometry(new Text().setString(new MFString476().getArray())
                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                .addChild(new HAnimSite("hanim_l5").setName("navel").setDEF("hanim_navel_pt").setTranslation(new double[] {0f,0.9f,-0.1f})
              ...
              .addChild(new HAnimJoint("hanim_vl5").setName("vl4").setDEF("hanim_vl4").setCenter(new double[] {0f,0.9497f,-0.01376f}).setUlimit(new MFFloat484().getArray()).setLlimit(new MFFloat485().getArray())
                ...
                .addChild(new HAnimJoint("hanim_vl4").setName("vl3").setDEF("hanim_vl3").setCenter(new double[] {0f,0.9659f,-0.01376f}).setUlimit(new MFFloat489().getArray()).setLlimit(new MFFloat490().getArray())
                  ...
                  .addChild(new HAnimJoint("hanim_vl3").setName("vl2").setDEF("hanim_vl2").setCenter(new double[] {0f,0.98235f,-0.01376f}).setUlimit(new MFFloat494().getArray()).setLlimit(new MFFloat495().getArray())
                    .addChild(new HAnimSegment("hanim_vl2").setName("l2").setDEF("hanim_l2")
                      .addChild(new HAnimSite("hanim_l2").setName("l_rib10").setDEF("hanim_l_rib10_pt").setTranslation(new double[] {0.09f,1f,0.04f})
                        ...
                        .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                          .addChild(new Shape()
                            .setGeometry(new Text().setString(new MFString499().getArray())
                              .setFontStyle(new FontStyle().setSize(0.035f))))))
                      .addChild(new HAnimSite("hanim_l2").setName("r_rib10").setDEF("hanim_r_rib10_pt").setTranslation(new double[] {-0.09f,1f,0.04f})
                    ...
                    .addChild(new HAnimJoint("hanim_vl2").setName("vl1").setDEF("hanim_vl1").setCenter(new double[] {0f,0.99967f,-0.01376f}).setUlimit(new MFFloat507().getArray()).setLlimit(new MFFloat508().getArray())
                      ...
                      .addChild(new HAnimJoint("hanim_vl1").setName("vt12").setDEF("hanim_vt12").setCenter(new double[] {0f,1.0231f,-0.01376f}).setUlimit(new MFFloat512().getArray()).setLlimit(new MFFloat513().getArray())
                        ...
                        .addChild(new HAnimJoint("hanim_vt12").setName("vt11").setDEF("hanim_vt11").setCenter(new double[] {0f,1.0467f,-0.01376f}).setUlimit(new MFFloat517().getArray()).setLlimit(new MFFloat518().getArray())
                          ...
                          .addChild(new HAnimJoint("hanim_vt11").setName("vt10").setDEF("hanim_vt10").setCenter(new double[] {0f,1.0638f,-0.01378f}).setUlimit(new MFFloat522().getArray()).setLlimit(new MFFloat523().getArray())
                            .addChild(new HAnimSegment("hanim_vt10").setName("t10").setDEF("hanim_t10")
                              .addChild(new HAnimSite("hanim_t10").setName("substernale").setDEF("hanim_substernale_pt").setTranslation(new double[] {0f,1.08f,0.076f})
                                ...
                                .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                  .addChild(new Shape()
                                    .setGeometry(new Text().setString(new MFString527().getArray())
                                      .setFontStyle(new FontStyle().setSize(0.035f))))))
                              .addChild(new HAnimSite("hanim_t10").setName("mesosternale").setDEF("hanim_mesosternale_pt").setTranslation(new double[] {0f,1.15f,0.076f})
                            ...
                            .addChild(new HAnimJoint("hanim_vt10").setName("vt9").setDEF("hanim_vt9").setCenter(new double[] {0f,1.0784f,-0.01376f}).setUlimit(new MFFloat535().getArray()).setLlimit(new MFFloat536().getArray())
                              .addChild(new HAnimSegment("hanim_vt9").setName("t9").setDEF("hanim_t9")
                                .addChild(new HAnimSite("hanim_t9").setName("l_thelion").setDEF("hanim_l_thelion_pt").setTranslation(new double[] {0.07f,1.12f,0.09f})
                                  ...
                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                    .addChild(new Shape()
                                      .setGeometry(new Text().setString(new MFString540().getArray())
                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                .addChild(new HAnimSite("hanim_t9").setName("r_thelion").setDEF("hanim_r_thelion_pt").setTranslation(new double[] {-0.07f,1.12f,0.09f})
                                  ...
                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                    .addChild(new Shape()
                                      .setGeometry(new Text().setString(new MFString544().getArray())
                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                .addChild(new HAnimSite("hanim_t9").setName("rear_center_midsagittal_plane").setDEF("hanim_rear_center_midsagittal_plane_pt").setTranslation(new double[] {0f,1.1f,-0.1f})
                                  ...
                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                    .addChild(new Shape()
                                      .setGeometry(new Text().setString(new MFString548().getArray())
                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                .addChild(new HAnimSite("hanim_t9").setName("l_chest_midsagittal_plane").setDEF("hanim_l_chest_midsagittal_plane_pt").setTranslation(new double[] {0.13f,1.12f,0f})
                                  ...
                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                    .addChild(new Shape()
                                      .setGeometry(new Text().setString(new MFString552().getArray())
                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                .addChild(new HAnimSite("hanim_t9").setName("r_chest_midsagittal_plane").setDEF("hanim_r_chest_midsagittal_plane_pt").setTranslation(new double[] {-0.13f,1.12f,0f})
                              ...
                              .addChild(new HAnimJoint("hanim_vt9").setName("vt8").setDEF("hanim_vt8").setCenter(new double[] {0f,1.093f,-0.01376f}).setUlimit(new MFFloat560().getArray()).setLlimit(new MFFloat561().getArray())
                                ...
                                .addChild(new HAnimJoint("hanim_vt8").setName("vt7").setDEF("hanim_vt7").setCenter(new double[] {0f,1.1088f,-0.01376f}).setUlimit(new MFFloat565().getArray()).setLlimit(new MFFloat566().getArray())
                                  ...
                                  .addChild(new HAnimJoint("hanim_vt7").setName("vt6").setDEF("hanim_vt6").setCenter(new double[] {0f,1.1216f,-0.01376f}).setUlimit(new MFFloat570().getArray()).setLlimit(new MFFloat571().getArray())
                                    ...
                                    .addChild(new HAnimJoint("hanim_vt6").setName("vt5").setDEF("hanim_vt5").setCenter(new double[] {0f,1.137f,-0.01376f}).setUlimit(new MFFloat575().getArray()).setLlimit(new MFFloat576().getArray())
                                      ...
                                      .addChild(new HAnimJoint("hanim_vt5").setName("vt4").setDEF("hanim_vt4").setCenter(new double[] {0f,1.1524f,-0.01376f}).setUlimit(new MFFloat580().getArray()).setLlimit(new MFFloat581().getArray())
                                        ...
                                        .addChild(new HAnimJoint("hanim_vt4").setName("vt3").setDEF("hanim_vt3").setCenter(new double[] {0f,1.1709f,-0.01376f}).setUlimit(new MFFloat585().getArray()).setLlimit(new MFFloat586().getArray())
                                          ...
                                          .addChild(new HAnimJoint("hanim_vt3").setName("vt2").setDEF("hanim_vt2").setCenter(new double[] {0f,1.1956f,-0.01378f}).setUlimit(new MFFloat590().getArray()).setLlimit(new MFFloat591().getArray())
                                            ...
                                            .addChild(new HAnimJoint("hanim_vt2").setName("vt1").setDEF("hanim_vt1").setCenter(new double[] {0f,1.22f,-0.0138f}).setUlimit(new MFFloat595().getArray()).setLlimit(new MFFloat596().getArray())
                                              .addChild(new HAnimSegment("hanim_vt1").setName("t1").setDEF("hanim_t1")
                                                .addChild(new HAnimSite("hanim_t1").setName("suprasternale").setDEF("hanim_suprasternale_pt").setTranslation(new double[] {0f,1.22f,0.08f})
                                                  ...
                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                    .addChild(new Shape()
                                                      .setGeometry(new Text().setString(new MFString600().getArray())
                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                .addChild(new HAnimSite("hanim_t1").setName("cervicale").setDEF("hanim_cervicale_pt").setTranslation(new double[] {0f,1.22f,-0.08f})
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt1").setName("vc7").setDEF("hanim_vc7").setCenter(new double[] {0f,1.2453f,-0.01506f}).setUlimit(new MFFloat608().getArray()).setLlimit(new MFFloat609().getArray())
                                                .addChild(new HAnimSegment("hanim_vc7").setName("c7").setDEF("hanim_c7")
                                                  .addChild(new HAnimSite("hanim_c7").setName("l_neck_base").setDEF("hanim_l_neck_base_pt").setTranslation(new double[] {0.06f,1.26f,0f})
                                                    ...
                                                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                      .addChild(new Shape()
                                                        .setGeometry(new Text().setString(new MFString613().getArray())
                                                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                  .addChild(new HAnimSite("hanim_c7").setName("r_neck_base").setDEF("hanim_r_neck_base_pt").setTranslation(new double[] {-0.06f,1.26f,0f})
                                                ...
                                                .addChild(new HAnimJoint("hanim_vc7").setName("vc6").setDEF("hanim_vc6").setCenter(new double[] {0f,1.2575f,-0.01506f}).setUlimit(new MFFloat621().getArray()).setLlimit(new MFFloat622().getArray())
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_vc6").setName("vc5").setDEF("hanim_vc5").setCenter(new double[] {0f,1.2699f,-0.01506f}).setUlimit(new MFFloat626().getArray()).setLlimit(new MFFloat627().getArray())
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_vc5").setName("vc4").setDEF("hanim_vc4").setCenter(new double[] {0f,1.28227f,-0.01506f}).setUlimit(new MFFloat631().getArray()).setLlimit(new MFFloat632().getArray())
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_vc4").setName("vc3").setDEF("hanim_vc3").setCenter(new double[] {0f,1.2951f,-0.01506f}).setUlimit(new MFFloat636().getArray()).setLlimit(new MFFloat637().getArray())
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_vc3").setName("vc2").setDEF("hanim_vc2").setCenter(new double[] {0f,1.307f,-0.015f}).setUlimit(new MFFloat641().getArray()).setLlimit(new MFFloat642().getArray())
                                                          .addChild(new HAnimSegment("hanim_vc2").setName("c2").setDEF("hanim_c2")
                                                            .addChild(new HAnimSite("hanim_c2").setName("adams_apple").setDEF("hanim_adams_apple_pt").setTranslation(new double[] {0f,1.29f,0.04f})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_vc2").setName("vc1").setDEF("hanim_vc1").setCenter(new double[] {0f,1.3185f,-0.0151f}).setUlimit(new MFFloat650().getArray()).setLlimit(new MFFloat651().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_vc1").setName("skullbase").setDEF("hanim_skullbase").setCenter(new double[] {0f,1.3126f,-0.0154f}).setUlimit(new MFFloat655().getArray()).setLlimit(new MFFloat656().getArray())
                                                              .addChild(new HAnimSegment("hanim_skullbase").setName("skull").setDEF("hanim_skull")
                                                                .addChild(new HAnimSite("hanim_skull").setName("skull_vertex").setDEF("hanim_skull_vertex_pt").setTranslation(new double[] {0f,1.612f,-0.03f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString660().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("glabella").setDEF("hanim_glabella_pt").setTranslation(new double[] {0f,1.454f,0.128f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString664().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("sellion").setDEF("hanim_sellion_pt").setTranslation(new double[] {0f,1.4f,0.12f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString668().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("l_infraorbitale").setDEF("hanim_l_infraorbitale_pt").setTranslation(new double[] {0.039f,1.38f,0.09f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString672().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("l_tragion").setDEF("hanim_l_tragion_pt").setTranslation(new double[] {0.1f,1.38f,0.0282f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString676().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("r_infraorbitale").setDEF("hanim_r_infraorbitale_pt").setTranslation(new double[] {-0.039f,1.38f,0.09f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString680().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("r_tragion").setDEF("hanim_r_tragion_pt").setTranslation(new double[] {-0.1f,1.38f,0.0282f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString684().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("nuchale").setDEF("hanim_nuchale_pt").setTranslation(new double[] {0.0039f,1.35f,-0.16f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString688().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("opisthocranion").setDEF("hanim_opisthocranion_pt").setTranslation(new double[] {0.0039f,1.4588f,-0.18f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString692().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("l_ectocanthus").setDEF("hanim_l_ectocanthus_pt").setTranslation(new double[] {0.086f,1.399f,0.074f})
                                                                  ...
                                                                  .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                    .addChild(new Shape()
                                                                      .setGeometry(new Text().setString(new MFString696().getArray())
                                                                        .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                .addChild(new HAnimSite("hanim_skull").setName("r_ectocanthus").setDEF("hanim_r_ectocanthus_pt").setTranslation(new double[] {-0.086f,1.399f,0.074f})
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyelid_joint").setDEF("hanim_l_eyelid_joint").setCenter(new double[] {0.0505f,1.42425f,0.03294f}).setUlimit(new MFFloat704().getArray()).setLlimit(new MFFloat705().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_eyelid_joint").setName("l_eyelid").setDEF("hanim_l_eyelid")
                                                                  .addChild(new HAnimSite("hanim_l_eyelid").setName("l_eyelid_tip").setDEF("hanim_l_eyelid_tip").setTranslation(new double[] {0f,2.64f,0f})
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyelid_joint").setDEF("hanim_r_eyelid_joint").setCenter(new double[] {-0.0505f,1.42425f,0.03294f}).setUlimit(new MFFloat713().getArray()).setLlimit(new MFFloat714().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_eyelid_joint").setName("r_eyelid").setDEF("hanim_r_eyelid")
                                                                  .addChild(new HAnimSite("hanim_r_eyelid").setName("r_eyelid_tip").setDEF("hanim_r_eyelid_tip").setTranslation(new double[] {0f,2.68f,0f})
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyeball_joint").setDEF("hanim_l_eyeball_joint").setCenter(new double[] {0.048127f,1.4049f,0.08305f}).setUlimit(new MFFloat722().getArray()).setLlimit(new MFFloat723().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_eyeball_joint").setName("l_eyeball").setDEF("hanim_l_eyeball")
                                                                  .addChild(new HAnimSite("hanim_l_eyeball").setName("l_eyeball_tip").setDEF("hanim_l_eyeball_tip").setTranslation(new double[] {0f,2.72f,0f})
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyeball_joint").setDEF("hanim_r_eyeball_joint").setCenter(new double[] {-0.04813f,1.4049f,0.08305f}).setUlimit(new MFFloat731().getArray()).setLlimit(new MFFloat732().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_eyeball_joint").setName("r_eyeball").setDEF("hanim_r_eyeball")
                                                                  .addChild(new HAnimSite("hanim_r_eyeball").setName("r_eyeball_tip").setDEF("hanim_r_eyeball_tip").setTranslation(new double[] {0f,2.76f,0f})
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_skullbase").setName("l_eyebrow_joint").setDEF("hanim_l_eyebrow_joint").setCenter(new double[] {0.02175f,1.4139f,0.1069f}).setUlimit(new MFFloat740().getArray()).setLlimit(new MFFloat741().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_eyebrow_joint").setName("l_eyebrow").setDEF("hanim_l_eyebrow")
                                                                  .addChild(new HAnimSite("hanim_l_eyebrow").setName("l_eyebrow_tip").setDEF("hanim_l_eyebrow_tip").setTranslation(new double[] {0f,2.8f,0f})
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_skullbase").setName("r_eyebrow_joint").setDEF("hanim_r_eyebrow_joint").setCenter(new double[] {-0.02175f,1.4139f,0.10694f}).setUlimit(new MFFloat749().getArray()).setLlimit(new MFFloat750().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_eyebrow_joint").setName("r_eyebrow").setDEF("hanim_r_eyebrow")
                                                                  .addChild(new HAnimSite("hanim_r_eyebrow").setName("r_eyebrow_tip").setDEF("hanim_r_eyebrow_tip").setTranslation(new double[] {0f,2.84f,0f})
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_skullbase").setName("temporomandibular").setDEF("hanim_temporomandibular").setCenter(new double[] {0f,1.3128f,0.01538f}).setUlimit(new MFFloat758().getArray()).setLlimit(new MFFloat759().getArray())
                                                                .addChild(new HAnimSegment("hanim_temporomandibular").setName("jaw").setDEF("hanim_jaw")
                                                                  .addChild(new HAnimSite("hanim_jaw").setName("l_gonion").setDEF("hanim_l_gonion_pt").setTranslation(new double[] {0.068f,1.346f,0.033f})
                                                                    ...
                                                                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                      .addChild(new Shape()
                                                                        .setGeometry(new Text().setString(new MFString763().getArray())
                                                                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                  .addChild(new HAnimSite("hanim_jaw").setName("r_gonion").setDEF("hanim_r_gonion_pt").setTranslation(new double[] {-0.068f,1.346f,0.033f})
                                                                    ...
                                                                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                      .addChild(new Shape()
                                                                        .setGeometry(new Text().setString(new MFString767().getArray())
                                                                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                  .addChild(new HAnimSite("hanim_jaw").setName("supramenton").setDEF("hanim_supramenton_pt").setTranslation(new double[] {0f,1.32f,0.086f})
                                                                    ...
                                                                    .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                      .addChild(new Shape()
                                                                        .setGeometry(new Text().setString(new MFString771().getArray())
                                                                          .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                  .addChild(new HAnimSite("hanim_jaw").setName("menton").setDEF("hanim_menton_pt").setTranslation(new double[] {0f,1.3f,0.08f})
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt1").setName("l_sternoclavicular").setDEF("hanim_l_sternoclavicular").setCenter(new double[] {0.03847f,1.2087f,-0.01378f}).setUlimit(new MFFloat779().getArray()).setLlimit(new MFFloat780().getArray())
                                                .addChild(new HAnimSegment("hanim_l_sternoclavicular").setName("l_clavicle").setDEF("hanim_l_clavicle")
                                                  .addChild(new HAnimSite("hanim_l_clavicle").setName("l_clavicale").setDEF("hanim_l_clavicale_pt").setTranslation(new double[] {0.03f,1.2f,0.04f})
                                                ...
                                                .addChild(new HAnimJoint("hanim_l_sternoclavicular").setName("l_acromioclavicular").setDEF("hanim_l_acromioclavicular").setCenter(new double[] {0.12294f,1.191825f,-0.0129f}).setUlimit(new MFFloat788().getArray()).setLlimit(new MFFloat789().getArray())
                                                  .addChild(new HAnimSegment("hanim_l_acromioclavicular").setName("l_scapula").setDEF("hanim_l_scapula")
                                                    .addChild(new HAnimSite("hanim_l_scapula").setName("l_acromion").setDEF("hanim_l_acromion_pt").setTranslation(new double[] {0.15f,1.222f,-0.02f})
                                                      ...
                                                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                        .addChild(new Shape()
                                                          .setGeometry(new Text().setString(new MFString793().getArray())
                                                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                    .addChild(new HAnimSite("hanim_l_scapula").setName("l_axilla_proximal").setDEF("hanim_l_axilla_proximal_pt").setTranslation(new double[] {0.15f,1.16f,0.04f})
                                                      ...
                                                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                        .addChild(new Shape()
                                                          .setGeometry(new Text().setString(new MFString797().getArray())
                                                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                    .addChild(new HAnimSite("hanim_l_scapula").setName("l_axilla_distal").setDEF("hanim_l_axilla_distal_pt").setTranslation(new double[] {0.17f,1.14f,0f})
                                                      ...
                                                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                        .addChild(new Shape()
                                                          .setGeometry(new Text().setString(new MFString801().getArray())
                                                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                    .addChild(new HAnimSite("hanim_l_scapula").setName("l_axilla_posterior_folds").setDEF("hanim_l_axilla_posterior_folds_pt").setTranslation(new double[] {0.15f,1.145f,-0.04f})
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_l_acromioclavicular").setName("l_shoulder").setDEF("hanim_l_shoulder").setCenter(new double[] {0.16506f,1.17855f,-0.00327f}).setUlimit(new MFFloat809().getArray()).setLlimit(new MFFloat810().getArray())
                                                    .addChild(new HAnimSegment("hanim_l_shoulder").setName("l_upperarm").setDEF("hanim_l_upperarm")
                                                      .addChild(new HAnimSite("hanim_l_upperarm").setName("l_humeral_lateral_epicondyle").setDEF("hanim_l_humeral_lateral_epicondyle_pt").setTranslation(new double[] {0.2f,0.95f,-0.03f})
                                                        ...
                                                        .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                          .addChild(new Shape()
                                                            .setGeometry(new Text().setString(new MFString814().getArray())
                                                              .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                      .addChild(new HAnimSite("hanim_l_upperarm").setName("l_humeral_medial_epicondyle").setDEF("hanim_l_humeral_medial_epicondyle_pt").setTranslation(new double[] {0.18f,0.93f,-0.03f})
                                                        ...
                                                        .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                          .addChild(new Shape()
                                                            .setGeometry(new Text().setString(new MFString818().getArray())
                                                              .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                      .addChild(new HAnimSite("hanim_l_upperarm").setName("l_radiale").setDEF("hanim_l_radiale_pt").setTranslation(new double[] {0.2f,0.91f,-0.03f})
                                                        ...
                                                        .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                          .addChild(new Shape()
                                                            .setGeometry(new Text().setString(new MFString822().getArray())
                                                              .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                      .addChild(new HAnimSite("hanim_l_upperarm").setName("l_bideltoid").setDEF("hanim_l_bideltoid_pt").setTranslation(new double[] {0.225f,1.185f,0f})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(new double[] {0.18209f,0.9288f,-0.00563f}).setUlimit(new MFFloat830().getArray()).setLlimit(new MFFloat831().getArray())
                                                      .addChild(new HAnimSegment("hanim_l_elbow").setName("l_forearm").setDEF("hanim_l_forearm")
                                                        .addChild(new HAnimSite("hanim_l_forearm").setName("l_radial_styloid").setDEF("hanim_l_radial_styloid_pt").setTranslation(new double[] {0.18f,0.725f,0.025f})
                                                          ...
                                                          .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                            .addChild(new Shape()
                                                              .setGeometry(new Text().setString(new MFString835().getArray())
                                                                .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                        .addChild(new HAnimSite("hanim_l_forearm").setName("l_olecranon").setDEF("hanim_l_olecranon_pt").setTranslation(new double[] {0.2f,0.92f,-0.03f})
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(new double[] {0.1819f,0.72427f,-0.005f}).setUlimit(new MFFloat843().getArray()).setLlimit(new MFFloat844().getArray())
                                                        .addChild(new HAnimSegment("hanim_l_radiocarpal").setName("l_carpal").setDEF("hanim_l_carpal")
                                                          .addChild(new HAnimSite("hanim_l_carpal").setName("l_ulnar_styloid").setDEF("hanim_l_ulnar_styloid_pt").setTranslation(new double[] {0.2f,0.725f,0f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_1").setDEF("hanim_l_midcarpal_1").setCenter(new double[] {0.1813f,0.706f,0.0193f}).setUlimit(new MFFloat852().getArray()).setLlimit(new MFFloat853().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_midcarpal_1").setName("l_carpometacarpal_1").setDEF("hanim_l_carpometacarpal_1").setCenter(new double[] {0.1805f,0.69255f,0.026f}).setUlimit(new MFFloat857().getArray()).setLlimit(new MFFloat858().getArray())
                                                            .addChild(new HAnimSegment("hanim_l_carpometacarpal_1").setName("l_metacarpal_1").setDEF("hanim_l_metacarpal_1")
                                                              .addChild(new HAnimSite("hanim_l_metacarpal_1").setName("l_metacarpal_phalanx_2").setDEF("hanim_l_metacarpal_phalanx_2_pt").setTranslation(new double[] {0.2f,0.665f,0.012f})
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_1").setName("l_metacarpophalangeal_1").setDEF("hanim_l_metacarpophalangeal_1").setCenter(new double[] {0.181f,0.6727f,0.03577f}).setUlimit(new MFFloat866().getArray()).setLlimit(new MFFloat867().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_1").setName("l_carpal_interphalangeal_1").setDEF("hanim_l_carpal_interphalangeal_1").setCenter(new double[] {0.1826f,0.654f,0.04966f}).setUlimit(new MFFloat871().getArray()).setLlimit(new MFFloat872().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_carpal_interphalangeal_1").setName("l_carpal_distal_phalanx_1").setDEF("hanim_l_carpal_distal_phalanx_1")
                                                                  .addChild(new HAnimSite("hanim_l_carpal_distal_phalanx_1").setName("l_carpal_distal_phalanx_1").setDEF("hanim_l_carpal_distal_phalanx_1_tip").setTranslation(new double[] {0.18f,0.64f,0.06f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_2").setDEF("hanim_l_midcarpal_2").setCenter(new double[] {0.18128f,0.70695f,0.00842f}).setUlimit(new MFFloat880().getArray()).setLlimit(new MFFloat881().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_midcarpal_2").setName("l_carpometacarpal_2").setDEF("hanim_l_carpometacarpal_2").setCenter(new double[] {0.18128f,0.6876f,0.0098f}).setUlimit(new MFFloat885().getArray()).setLlimit(new MFFloat886().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_2").setName("l_metacarpophalangeal_2").setDEF("hanim_l_metacarpophalangeal_2").setCenter(new double[] {0.1837f,0.6372f,0.01507f}).setUlimit(new MFFloat890().getArray()).setLlimit(new MFFloat891().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_2").setName("l_carpal_proximal_interphalangeal_2").setDEF("hanim_l_carpal_proximal_interphalangeal_2").setCenter(new double[] {0.18171f,0.6068f,0.01418f}).setUlimit(new MFFloat895().getArray()).setLlimit(new MFFloat896().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_2").setName("l_carpal_distal_interphalangeal_2").setDEF("hanim_l_carpal_distal_interphalangeal_2").setCenter(new double[] {0.18067f,0.5816f,0.01338f}).setUlimit(new MFFloat900().getArray()).setLlimit(new MFFloat901().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_2").setName("l_carpal_distal_phalanx_2").setDEF("hanim_l_carpal_distal_phalanx_2")
                                                                    .addChild(new HAnimSite("hanim_l_carpal_distal_phalanx_2").setName("l_dactylion").setDEF("hanim_l_dactylion_pt").setTranslation(new double[] {0.17f,0.558f,0.017f})
                                                                      ...
                                                                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                        .addChild(new Shape()
                                                                          .setGeometry(new Text().setString(new MFString905().getArray())
                                                                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                    .addChild(new HAnimSite("hanim_l_carpal_distal_phalanx_2").setName("l_carpal_distal_phalanx_2").setDEF("hanim_l_carpal_distal_phalanx_2_tip").setTranslation(new double[] {0.172f,0.558f,0.017f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_3").setDEF("hanim_l_midcarpal_3").setCenter(new double[] {0.18108f,0.708525f,-0.0048f}).setUlimit(new MFFloat913().getArray()).setLlimit(new MFFloat914().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_midcarpal_3").setName("l_carpometacarpal_3").setDEF("hanim_l_carpometacarpal_3").setCenter(new double[] {0.18108f,0.6858f,-0.00625f}).setUlimit(new MFFloat918().getArray()).setLlimit(new MFFloat919().getArray())
                                                            .addChild(new HAnimSegment("hanim_l_carpometacarpal_3").setName("l_metacarpal_3").setDEF("hanim_l_metacarpal_3")
                                                              .addChild(new HAnimSite("hanim_l_metacarpal_3").setName("l_metacarpal_phalanx_3").setDEF("hanim_l_metacarpal_phalanx_3_pt").setTranslation(new double[] {0.2f,0.665f,-0.039f})
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_3").setName("l_metacarpophalangeal_3").setDEF("hanim_l_metacarpophalangeal_3").setCenter(new double[] {0.18369f,0.6349f,-0.0039f}).setUlimit(new MFFloat927().getArray()).setLlimit(new MFFloat928().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_3").setName("l_carpal_proximal_interphalangeal_3").setDEF("hanim_l_carpal_proximal_interphalangeal_3").setCenter(new double[] {0.18171f,0.6032f,-0.0035f}).setUlimit(new MFFloat932().getArray()).setLlimit(new MFFloat933().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_3").setName("l_carpal_distal_interphalangeal_3").setDEF("hanim_l_carpal_distal_interphalangeal_3").setCenter(new double[] {0.1807f,0.5753f,-0.0037f}).setUlimit(new MFFloat937().getArray()).setLlimit(new MFFloat938().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_3").setName("l_carpal_distal_phalanx_3").setDEF("hanim_l_carpal_distal_phalanx_3")
                                                                    .addChild(new HAnimSite("hanim_l_carpal_distal_phalanx_3").setName("l_carpal_distal_phalanx_3").setDEF("hanim_l_carpal_distal_phalanx_3_tip").setTranslation(new double[] {0.172f,0.555f,-0.006f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_midcarpal_4_5").setDEF("hanim_l_midcarpal_4_5").setCenter(new double[] {0.18108f,0.70582f,-0.02574f}).setUlimit(new MFFloat946().getArray()).setLlimit(new MFFloat947().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_midcarpal_4_5").setName("l_carpometacarpal_4").setDEF("hanim_l_carpometacarpal_4").setCenter(new double[] {0.1811f,0.68625f,-0.0199f}).setUlimit(new MFFloat951().getArray()).setLlimit(new MFFloat952().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_carpometacarpal_4").setName("l_metacarpophalangeal_4").setDEF("hanim_l_metacarpophalangeal_4").setCenter(new double[] {0.18369f,0.63405f,-0.02144f}).setUlimit(new MFFloat956().getArray()).setLlimit(new MFFloat957().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_4").setName("l_carpal_proximal_interphalangeal_4").setDEF("hanim_l_carpal_proximal_interphalangeal_4").setCenter(new double[] {0.1817f,0.6066f,-0.02064f}).setUlimit(new MFFloat961().getArray()).setLlimit(new MFFloat962().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_4").setName("l_carpal_distal_interphalangeal_4").setDEF("hanim_l_carpal_distal_interphalangeal_4").setCenter(new double[] {0.18067f,0.580725f,-0.01977f}).setUlimit(new MFFloat966().getArray()).setLlimit(new MFFloat967().getArray())
                                                                  .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_4").setName("l_carpal_distal_phalanx_4").setDEF("hanim_l_carpal_distal_phalanx_4")
                                                                    .addChild(new HAnimSite("hanim_l_carpal_distal_phalanx_4").setName("l_carpal_distal_phalanx_4").setDEF("hanim_l_carpal_distal_phalanx_4_tip").setTranslation(new double[] {0.172f,0.559f,-0.024f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_carpometacarpal_5").setDEF("hanim_l_carpometacarpal_5").setCenter(new double[] {0.18164f,0.68827f,-0.03278f}).setUlimit(new MFFloat975().getArray()).setLlimit(new MFFloat976().getArray())
                                                          .addChild(new HAnimSegment("hanim_l_carpometacarpal_5").setName("l_metacarpal_5").setDEF("hanim_l_metacarpal_5")
                                                            .addChild(new HAnimSite("hanim_l_metacarpal_5").setName("l_metacarpal_phalanx_5").setDEF("hanim_l_metacarpal_phalanx_5_pt").setTranslation(new double[] {0.2f,0.665f,-0.036f})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_l_carpometacarpal_5").setName("l_metacarpophalangeal_5").setDEF("hanim_l_metacarpophalangeal_5").setCenter(new double[] {0.1833f,0.6381f,-0.037f}).setUlimit(new MFFloat984().getArray()).setLlimit(new MFFloat985().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_l_metacarpophalangeal_5").setName("l_carpal_proximal_interphalangeal_5").setDEF("hanim_l_carpal_proximal_interphalangeal_5").setCenter(new double[] {0.18166f,0.621f,-0.03715f}).setUlimit(new MFFloat989().getArray()).setLlimit(new MFFloat990().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_l_carpal_proximal_interphalangeal_5").setName("l_carpal_distal_interphalangeal_5").setDEF("hanim_l_carpal_distal_interphalangeal_5").setCenter(new double[] {0.1808f,0.6023f,-0.0369f}).setUlimit(new MFFloat994().getArray()).setLlimit(new MFFloat995().getArray())
                                                                .addChild(new HAnimSegment("hanim_l_carpal_distal_interphalangeal_5").setName("l_carpal_distal_phalanx_5").setDEF("hanim_l_carpal_distal_phalanx_5")
                                                                  .addChild(new HAnimSite("hanim_l_carpal_distal_phalanx_5").setName("l_carpal_distal_phalanx_5").setDEF("hanim_l_carpal_distal_phalanx_5_tip").setTranslation(new double[] {0.172f,0.58f,-0.039f})
                                              ...
                                              .addChild(new HAnimJoint("hanim_vt1").setName("r_sternoclavicular").setDEF("hanim_r_sternoclavicular").setCenter(new double[] {-0.03847f,1.2087f,-0.0138f}).setUlimit(new MFFloat1003().getArray()).setLlimit(new MFFloat1004().getArray())
                                                .addChild(new HAnimSegment("hanim_r_sternoclavicular").setName("r_clavicle").setDEF("hanim_r_clavicle")
                                                  .addChild(new HAnimSite("hanim_r_clavicle").setName("r_clavicale").setDEF("hanim_r_clavicale_pt").setTranslation(new double[] {-0.03f,1.2f,0.04f})
                                                ...
                                                .addChild(new HAnimJoint("hanim_r_sternoclavicular").setName("r_acromioclavicular").setDEF("hanim_r_acromioclavicular").setCenter(new double[] {-0.1229f,1.19182f,-0.0129f}).setUlimit(new MFFloat1012().getArray()).setLlimit(new MFFloat1013().getArray())
                                                  .addChild(new HAnimSegment("hanim_r_acromioclavicular").setName("r_scapula").setDEF("hanim_r_scapula")
                                                    .addChild(new HAnimSite("hanim_r_scapula").setName("r_acromion").setDEF("hanim_r_acromion_pt").setTranslation(new double[] {-0.15f,1.222f,-0.02f})
                                                      ...
                                                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                        .addChild(new Shape()
                                                          .setGeometry(new Text().setString(new MFString1017().getArray())
                                                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                    .addChild(new HAnimSite("hanim_r_scapula").setName("r_axilla_proximal").setDEF("hanim_r_axilla_proximal_pt").setTranslation(new double[] {-0.15f,1.16f,0.04f})
                                                      ...
                                                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                        .addChild(new Shape()
                                                          .setGeometry(new Text().setString(new MFString1021().getArray())
                                                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                    .addChild(new HAnimSite("hanim_r_scapula").setName("r_axilla_distal").setDEF("hanim_r_axilla_distal_pt").setTranslation(new double[] {-0.17f,1.14f,0f})
                                                      ...
                                                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                        .addChild(new Shape()
                                                          .setGeometry(new Text().setString(new MFString1025().getArray())
                                                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                    .addChild(new HAnimSite("hanim_r_scapula").setName("r_axilla_posterior_folds").setDEF("hanim_r_axilla_posterior_folds_pt").setTranslation(new double[] {-0.15f,1.145f,-0.04f})
                                                  ...
                                                  .addChild(new HAnimJoint("hanim_r_acromioclavicular").setName("r_shoulder").setDEF("hanim_r_shoulder").setCenter(new double[] {-0.1647f,1.17855f,-0.00327f}).setUlimit(new MFFloat1033().getArray()).setLlimit(new MFFloat1034().getArray())
                                                    .addChild(new HAnimSegment("hanim_r_shoulder").setName("r_upperarm").setDEF("hanim_r_upperarm")
                                                      .addChild(new HAnimSite("hanim_r_upperarm").setName("r_humeral_lateral_epicondyle").setDEF("hanim_r_humeral_lateral_epicondyle_pt").setTranslation(new double[] {-0.2f,0.95f,-0.03f})
                                                        ...
                                                        .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                          .addChild(new Shape()
                                                            .setGeometry(new Text().setString(new MFString1038().getArray())
                                                              .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                      .addChild(new HAnimSite("hanim_r_upperarm").setName("r_humeral_medial_epicondyle").setDEF("hanim_r_humeral_medial_epicondyle_pt").setTranslation(new double[] {-0.18f,0.93f,-0.03f})
                                                        ...
                                                        .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                          .addChild(new Shape()
                                                            .setGeometry(new Text().setString(new MFString1042().getArray())
                                                              .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                      .addChild(new HAnimSite("hanim_r_upperarm").setName("r_radiale").setDEF("hanim_r_radiale_pt").setTranslation(new double[] {-0.2f,0.91f,-0.03f})
                                                        ...
                                                        .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                          .addChild(new Shape()
                                                            .setGeometry(new Text().setString(new MFString1046().getArray())
                                                              .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                      .addChild(new HAnimSite("hanim_r_upperarm").setName("r_bideltoid").setDEF("hanim_r_bideltoid_pt").setTranslation(new double[] {-0.225f,1.185f,0f})
                                                    ...
                                                    .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(new double[] {-0.1817f,0.9288f,-0.00564f}).setUlimit(new MFFloat1054().getArray()).setLlimit(new MFFloat1055().getArray())
                                                      .addChild(new HAnimSegment("hanim_r_elbow").setName("r_forearm").setDEF("hanim_r_forearm")
                                                        .addChild(new HAnimSite("hanim_r_forearm").setName("r_radial_styloid").setDEF("hanim_r_radial_styloid_pt").setTranslation(new double[] {-0.18f,0.725f,0.025f})
                                                          ...
                                                          .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                            .addChild(new Shape()
                                                              .setGeometry(new Text().setString(new MFString1059().getArray())
                                                                .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                        .addChild(new HAnimSite("hanim_r_forearm").setName("r_olecranon").setDEF("hanim_r_olecranon_pt").setTranslation(new double[] {-0.2f,0.92f,-0.03f})
                                                      ...
                                                      .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(new double[] {-0.1816f,0.7242f,-0.005f}).setUlimit(new MFFloat1067().getArray()).setLlimit(new MFFloat1068().getArray())
                                                        .addChild(new HAnimSegment("hanim_r_radiocarpal").setName("r_carpal").setDEF("hanim_r_carpal")
                                                          .addChild(new HAnimSite("hanim_r_carpal").setName("r_ulnar_styloid").setDEF("hanim_r_ulnar_styloid_pt").setTranslation(new double[] {-0.2f,0.725f,0f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_1").setDEF("hanim_r_midcarpal_1").setCenter(new double[] {-0.18097f,0.70605f,0.0193f}).setUlimit(new MFFloat1076().getArray()).setLlimit(new MFFloat1077().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_midcarpal_1").setName("r_carpometacarpal_1").setDEF("hanim_r_carpometacarpal_1").setCenter(new double[] {-0.18f,0.69255f,0.02598f}).setUlimit(new MFFloat1081().getArray()).setLlimit(new MFFloat1082().getArray())
                                                            .addChild(new HAnimSegment("hanim_r_carpometacarpal_1").setName("r_metacarpal_1").setDEF("hanim_r_metacarpal_1")
                                                              .addChild(new HAnimSite("hanim_r_metacarpal_1").setName("r_metacarpal_phalanx_2").setDEF("hanim_r_metacarpal_phalanx_2_pt").setTranslation(new double[] {-0.2f,0.665f,0.012f})
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setName("r_metacarpophalangeal_1").setDEF("hanim_r_metacarpophalangeal_1").setCenter(new double[] {-0.18065f,0.67275f,0.03577f}).setUlimit(new MFFloat1090().getArray()).setLlimit(new MFFloat1091().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setName("r_carpal_interphalangeal_1").setDEF("hanim_r_carpal_interphalangeal_1").setCenter(new double[] {-0.18227f,0.654f,0.0496f}).setUlimit(new MFFloat1095().getArray()).setLlimit(new MFFloat1096().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_carpal_interphalangeal_1").setName("r_carpal_distal_phalanx_1").setDEF("hanim_r_carpal_distal_phalanx_1")
                                                                  .addChild(new HAnimSite("hanim_r_carpal_distal_phalanx_1").setName("r_carpal_distal_phalanx_1").setDEF("hanim_r_carpal_distal_phalanx_1_tip").setTranslation(new double[] {-0.18f,0.64f,0.06f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_2").setDEF("hanim_r_midcarpal_2").setCenter(new double[] {-0.18097f,0.70695f,0.0084f}).setUlimit(new MFFloat1104().getArray()).setLlimit(new MFFloat1105().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_midcarpal_2").setName("r_carpometacarpal_2").setDEF("hanim_r_carpometacarpal_2").setCenter(new double[] {-0.1809f,0.6876f,0.0097f}).setUlimit(new MFFloat1109().getArray()).setLlimit(new MFFloat1110().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setName("r_metacarpophalangeal_2").setDEF("hanim_r_metacarpophalangeal_2").setCenter(new double[] {-0.18335f,0.6372f,0.01507f}).setUlimit(new MFFloat1114().getArray()).setLlimit(new MFFloat1115().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setDEF("hanim_r_carpal_proximal_interphalangeal_2").setCenter(new double[] {-0.1813f,0.6068f,0.01418f}).setUlimit(new MFFloat1119().getArray()).setLlimit(new MFFloat1120().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setDEF("hanim_r_carpal_distal_interphalangeal_2").setCenter(new double[] {-0.1803f,0.5816f,0.01338f}).setUlimit(new MFFloat1124().getArray()).setLlimit(new MFFloat1125().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_phalanx_2").setDEF("hanim_r_carpal_distal_phalanx_2")
                                                                    .addChild(new HAnimSite("hanim_r_carpal_distal_phalanx_2").setName("r_dactylion").setDEF("hanim_r_dactylion_pt").setTranslation(new double[] {-0.17f,0.558f,0.017f})
                                                                      ...
                                                                      .addChild(new Billboard().setAxisOfRotation(new double[] {0f,0f,0f})
                                                                        .addChild(new Shape()
                                                                          .setGeometry(new Text().setString(new MFString1129().getArray())
                                                                            .setFontStyle(new FontStyle().setSize(0.035f))))))
                                                                    .addChild(new HAnimSite("hanim_r_carpal_distal_phalanx_2").setName("r_carpal_distal_phalanx_2").setDEF("hanim_r_carpal_distal_phalanx_2_tip").setTranslation(new double[] {-0.172f,0.558f,0.017f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_3").setDEF("hanim_r_midcarpal_3").setCenter(new double[] {-0.18072f,0.708525f,-0.004797f}).setUlimit(new MFFloat1137().getArray()).setLlimit(new MFFloat1138().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_midcarpal_3").setName("r_carpometacarpal_3").setDEF("hanim_r_carpometacarpal_3").setCenter(new double[] {-0.18072f,0.6858f,-0.00625f}).setUlimit(new MFFloat1142().getArray()).setLlimit(new MFFloat1143().getArray())
                                                            .addChild(new HAnimSegment("hanim_r_carpometacarpal_3").setName("r_metacarpal_3").setDEF("hanim_r_metacarpal_3")
                                                              .addChild(new HAnimSite("hanim_r_metacarpal_3").setName("r_metacarpal_phalanx_3").setDEF("hanim_r_metacarpal_phalanx_3_pt").setTranslation(new double[] {-0.2f,0.665f,0.016f})
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setName("r_metacarpophalangeal_3").setDEF("hanim_r_metacarpophalangeal_3").setCenter(new double[] {-0.1833f,0.63495f,-0.0039f}).setUlimit(new MFFloat1151().getArray()).setLlimit(new MFFloat1152().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setDEF("hanim_r_carpal_proximal_interphalangeal_3").setCenter(new double[] {-0.1813f,0.6032f,-0.0035f}).setUlimit(new MFFloat1156().getArray()).setLlimit(new MFFloat1157().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setDEF("hanim_r_carpal_distal_interphalangeal_3").setCenter(new double[] {-0.18029f,0.5753f,-0.00375f}).setUlimit(new MFFloat1161().getArray()).setLlimit(new MFFloat1162().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_phalanx_3").setDEF("hanim_r_carpal_distal_phalanx_3")
                                                                    .addChild(new HAnimSite("hanim_r_carpal_distal_phalanx_3").setName("r_carpal_distal_phalanx_3").setDEF("hanim_r_carpal_distal_phalanx_3_tip").setTranslation(new double[] {-0.17f,0.555f,-0.006f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_midcarpal_4_5").setDEF("hanim_r_midcarpal_4_5").setCenter(new double[] {-0.18072f,0.70583f,-0.02574f}).setUlimit(new MFFloat1170().getArray()).setLlimit(new MFFloat1171().getArray())
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_midcarpal_4_5").setName("r_carpometacarpal_4").setDEF("hanim_r_carpometacarpal_4").setCenter(new double[] {-0.18072f,0.68625f,-0.01992f}).setUlimit(new MFFloat1175().getArray()).setLlimit(new MFFloat1176().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setName("r_metacarpophalangeal_4").setDEF("hanim_r_metacarpophalangeal_4").setCenter(new double[] {-0.1833f,0.63405f,-0.02144f}).setUlimit(new MFFloat1180().getArray()).setLlimit(new MFFloat1181().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setDEF("hanim_r_carpal_proximal_interphalangeal_4").setCenter(new double[] {-0.1813f,0.6066f,-0.02064f}).setUlimit(new MFFloat1185().getArray()).setLlimit(new MFFloat1186().getArray())
                                                                ...
                                                                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setDEF("hanim_r_carpal_distal_interphalangeal_4").setCenter(new double[] {-0.18029f,0.5807f,-0.01978f}).setUlimit(new MFFloat1190().getArray()).setLlimit(new MFFloat1191().getArray())
                                                                  .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_phalanx_4").setDEF("hanim_r_carpal_distal_phalanx_4")
                                                                    .addChild(new HAnimSite("hanim_r_carpal_distal_phalanx_4").setName("r_carpal_distal_phalanx_4").setDEF("hanim_r_carpal_distal_phalanx_4_tip").setTranslation(new double[] {-0.172f,0.559f,-0.024f})
                                                        ...
                                                        .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_carpometacarpal_5").setDEF("hanim_r_carpometacarpal_5").setCenter(new double[] {-0.18126f,0.68827f,-0.03278f}).setUlimit(new MFFloat1199().getArray()).setLlimit(new MFFloat1200().getArray())
                                                          .addChild(new HAnimSegment("hanim_r_carpometacarpal_5").setName("r_metacarpal_5").setDEF("hanim_r_metacarpal_5")
                                                            .addChild(new HAnimSite("hanim_r_metacarpal_5").setName("r_metacarpal_phalanx_5").setDEF("hanim_r_metacarpal_phalanx_5_pt").setTranslation(new double[] {-0.2f,0.665f,-0.036f})
                                                          ...
                                                          .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setName("r_metacarpophalangeal_5").setDEF("hanim_r_metacarpophalangeal_5").setCenter(new double[] {-0.18297f,0.6381f,-0.0371f}).setUlimit(new MFFloat1208().getArray()).setLlimit(new MFFloat1209().getArray())
                                                            ...
                                                            .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setDEF("hanim_r_carpal_proximal_interphalangeal_5").setCenter(new double[] {-0.1813f,0.621f,-0.03715f}).setUlimit(new MFFloat1213().getArray()).setLlimit(new MFFloat1214().getArray())
                                                              ...
                                                              .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setDEF("hanim_r_carpal_distal_interphalangeal_5").setCenter(new double[] {-0.18045f,0.602325f,-0.03697f}).setUlimit(new MFFloat1218().getArray()).setLlimit(new MFFloat1219().getArray())
                                                                .addChild(new HAnimSegment("hanim_r_carpal_distal_interphalangeal_5").setName("r_carpal_distal_phalanx_5").setDEF("hanim_r_carpal_distal_phalanx_5")
                                                                  .addChild(new HAnimSite("hanim_r_carpal_distal_phalanx_5").setName("r_carpal_distal_phalanx_5").setDEF("hanim_r_carpal_distal_phalanx_5_tip").setTranslation(new double[] {-0.172f,0.58f,-0.039f})
        ...
        .addChild(new Transform().setDEF("Landmark000")
          ...
          .addChild(new Shape().setDEF("HAnim000Landmark")
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(new double[] {0f,1f,0f}).setEmissiveColor(new double[] {0f,1f,0f})))
...
private class MFColorRGBA49 {
  private org.web3d.x3d.jsail.fields.MFColorRGBA getArray() {
    return new org.web3d.x3d.jsail.fields.MFColorRGBA(new double[] {1f,1f,0f,1f,1f,1f,0f,1f});
  }
}
private class MFVec3f50 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,0.826f,0.02f,0f,0.77f,0f});
  }
}
...
private class MFVec3f71 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.095f,0.8266f,-0.0183f,0f,0.826f,0.02f});
  }
}
...
private class MFVec3f88 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0926f,0.4088f,-0.01944f,0.095f,0.8266f,-0.0183f});
  }
}
...
private class MFVec3f101 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0888f,0.09545f,-0.01045f,0.0926f,0.4088f,-0.01944f});
  }
}
...
private class MFVec3f106 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0783f,0.0369f,0.0049f,0.0888f,0.09545f,-0.01045f});
  }
}
...
private class MFVec3f111 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0674f,0.0321f,0.0184f,0.0783f,0.0369f,0.0049f});
  }
}
...
private class MFVec3f116 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0646f,0.02324f,0.0442f,0.0674f,0.0321f,0.0184f});
  }
}
...
private class MFVec3f125 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0621f,0.01442f,0.0936f,0.0646f,0.02324f,0.0442f});
  }
}
...
private class MFVec3f134 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.062f,0.012f,0.115f,0.0621f,0.01442f,0.0936f});
  }
}
...
private class MFVec3f139 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0814f,0.0335f,0.02143f,0.0783f,0.0369f,0.0049f});
  }
}
...
private class MFVec3f144 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0802f,0.0261f,0.0411f,0.0814f,0.0335f,0.02143f});
  }
}
...
private class MFVec3f149 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0825f,0.01497f,0.09783f,0.0802f,0.0261f,0.0411f});
  }
}
...
private class MFVec3f154 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0843f,0.01265f,0.114f,0.0825f,0.01497f,0.09783f});
  }
}
...
private class MFVec3f163 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0843f,0.00982f,0.123435f,0.0843f,0.01265f,0.114f});
  }
}
...
private class MFVec3f168 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.09297f,0.0334f,0.01982f,0.0783f,0.0369f,0.0049f});
  }
}
...
private class MFVec3f173 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.09459f,0.0261f,0.0394f,0.09297f,0.0334f,0.01982f});
  }
}
...
private class MFVec3f178 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0965f,0.01505f,0.0954f,0.09459f,0.0261f,0.0394f});
  }
}
...
private class MFVec3f183 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.09886f,0.01192f,0.11047f,0.0965f,0.01505f,0.0954f});
  }
}
...
private class MFVec3f192 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1004f,0.00983f,0.1197f,0.09886f,0.01192f,0.11047f});
  }
}
...
private class MFVec3f197 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0891f,0.05798f,-0.0259f,0.0888f,0.09545f,-0.01045f});
  }
}
...
private class MFVec3f202 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.11063f,0.03528f,0.0021f,0.0891f,0.05798f,-0.0259f});
  }
}
...
private class MFVec3f207 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.10649f,0.02454f,0.03843f,0.11063f,0.03528f,0.0021f});
  }
}
...
private class MFVec3f212 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.109867f,0.01435f,0.09117f,0.10649f,0.02454f,0.03843f});
  }
}
...
private class MFVec3f217 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.11416f,0.01224f,0.10631f,0.109867f,0.01435f,0.09117f});
  }
}
...
private class MFVec3f226 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.11567f,0.00936f,0.11369f,0.11416f,0.01224f,0.10631f});
  }
}
...
private class MFVec3f231 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1208f,0.02094f,0.03474f,0.11063f,0.03528f,0.0021f});
  }
}
...
private class MFVec3f236 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.124065f,0.01367f,0.08656f,0.1208f,0.02094f,0.03474f});
  }
}
...
private class MFVec3f245 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.12638f,0.01086f,0.09414f,0.124065f,0.01367f,0.08656f});
  }
}
...
private class MFVec3f254 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.12728f,0.00856f,0.10188f,0.12638f,0.01086f,0.09414f});
  }
}
...
private class MFVec3f275 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.09466f,0.82665f,-0.01835f,0f,0.826f,0.02f});
  }
}
...
private class MFVec3f292 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.0926f,0.408825f,-0.01944f,-0.09466f,0.82665f,-0.01835f});
  }
}
...
private class MFVec3f305 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.08845f,0.09544f,-0.01045f,-0.0926f,0.408825f,-0.01944f});
  }
}
...
private class MFVec3f310 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.07794f,0.0369f,0.00486f,-0.08845f,0.09544f,-0.01045f});
  }
}
...
private class MFVec3f315 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.06698f,0.032107f,0.01839f,-0.07794f,0.0369f,0.00486f});
  }
}
...
private class MFVec3f320 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.064f,0.02324f,0.04419f,-0.06698f,0.032107f,0.01839f});
  }
}
...
private class MFVec3f329 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.06176f,0.014425f,0.09362f,-0.064f,0.02324f,0.04419f});
  }
}
...
private class MFVec3f338 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.06174f,0.0121f,0.1153f,-0.06176f,0.014425f,0.09362f});
  }
}
...
private class MFVec3f343 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.081f,0.0335f,0.02142f,-0.07794f,0.0369f,0.00486f});
  }
}
...
private class MFVec3f348 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.07983f,0.0261f,0.04106f,-0.081f,0.0335f,0.02142f});
  }
}
...
private class MFVec3f353 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.0821f,0.01497f,0.09783f,-0.07983f,0.0261f,0.04106f});
  }
}
...
private class MFVec3f358 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.0839f,0.012647f,0.114f,-0.0821f,0.01497f,0.09783f});
  }
}
...
private class MFVec3f367 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.0839f,0.009825f,0.123435f,-0.0839f,0.012647f,0.114f});
  }
}
...
private class MFVec3f372 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.09261f,0.03339f,0.01982f,-0.07794f,0.0369f,0.00486f});
  }
}
...
private class MFVec3f377 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.09423f,0.0261f,0.0394f,-0.09261f,0.03339f,0.01982f});
  }
}
...
private class MFVec3f382 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.0961f,0.01505f,0.09542f,-0.09423f,0.0261f,0.0394f});
  }
}
...
private class MFVec3f387 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.0985f,0.01192f,0.11047f,-0.0961f,0.01505f,0.09542f});
  }
}
...
private class MFVec3f396 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.100035f,0.00982f,0.1197f,-0.0985f,0.01192f,0.11047f});
  }
}
...
private class MFVec3f401 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.088717f,0.05798f,-0.025965f,-0.08845f,0.09544f,-0.01045f});
  }
}
...
private class MFVec3f406 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.11027f,0.03528f,0.0021f,-0.088717f,0.05798f,-0.025965f});
  }
}
...
private class MFVec3f411 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.10613f,0.02454f,0.03843f,-0.11027f,0.03528f,0.0021f});
  }
}
...
private class MFVec3f416 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1095f,0.01435f,0.09117f,-0.10613f,0.02454f,0.03843f});
  }
}
...
private class MFVec3f421 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.11378f,0.01224f,0.1063f,-0.1095f,0.01435f,0.09117f});
  }
}
...
private class MFVec3f430 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1153f,0.00937f,0.11369f,-0.11378f,0.01224f,0.1063f});
  }
}
...
private class MFVec3f435 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.12044f,0.020945f,0.03474f,-0.11027f,0.03528f,0.0021f});
  }
}
...
private class MFVec3f440 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.12368f,0.01367f,0.08656f,-0.12044f,0.020945f,0.03474f});
  }
}
...
private class MFVec3f449 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.126f,0.01086f,0.09414f,-0.12368f,0.01367f,0.08656f});
  }
}
...
private class MFVec3f458 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1269f,0.00856f,0.10188f,-0.126f,0.01086f,0.09414f});
  }
}
...
private class MFVec3f483 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,0.9254f,-0.01376f,0f,0.77f,0f});
  }
}
...
private class MFVec3f488 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,0.9497f,-0.01376f,0f,0.9254f,-0.01376f});
  }
}
...
private class MFVec3f493 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,0.9659f,-0.01376f,0f,0.9497f,-0.01376f});
  }
}
...
private class MFVec3f506 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,0.98235f,-0.01376f,0f,0.9659f,-0.01376f});
  }
}
...
private class MFVec3f511 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,0.99967f,-0.01376f,0f,0.98235f,-0.01376f});
  }
}
...
private class MFVec3f516 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.0231f,-0.01376f,0f,0.99967f,-0.01376f});
  }
}
...
private class MFVec3f521 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.0467f,-0.01376f,0f,1.0231f,-0.01376f});
  }
}
...
private class MFVec3f534 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.0638f,-0.01378f,0f,1.0467f,-0.01376f});
  }
}
...
private class MFVec3f559 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.0784f,-0.01376f,0f,1.0638f,-0.01378f});
  }
}
...
private class MFVec3f564 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.093f,-0.01376f,0f,1.0784f,-0.01376f});
  }
}
...
private class MFVec3f569 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.1088f,-0.01376f,0f,1.093f,-0.01376f});
  }
}
...
private class MFVec3f574 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.1216f,-0.01376f,0f,1.1088f,-0.01376f});
  }
}
...
private class MFVec3f579 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.137f,-0.01376f,0f,1.1216f,-0.01376f});
  }
}
...
private class MFVec3f584 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.1524f,-0.01376f,0f,1.137f,-0.01376f});
  }
}
...
private class MFVec3f589 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.1709f,-0.01376f,0f,1.1524f,-0.01376f});
  }
}
...
private class MFVec3f594 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.1956f,-0.01378f,0f,1.1709f,-0.01376f});
  }
}
...
private class MFVec3f607 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.22f,-0.0138f,0f,1.1956f,-0.01378f});
  }
}
...
private class MFVec3f620 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.2453f,-0.01506f,0f,1.22f,-0.0138f});
  }
}
...
private class MFVec3f625 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.2575f,-0.01506f,0f,1.2453f,-0.01506f});
  }
}
...
private class MFVec3f630 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.2699f,-0.01506f,0f,1.2575f,-0.01506f});
  }
}
...
private class MFVec3f635 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.28227f,-0.01506f,0f,1.2699f,-0.01506f});
  }
}
...
private class MFVec3f640 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.2951f,-0.01506f,0f,1.28227f,-0.01506f});
  }
}
...
private class MFVec3f649 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.307f,-0.015f,0f,1.2951f,-0.01506f});
  }
}
...
private class MFVec3f654 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.3185f,-0.0151f,0f,1.307f,-0.015f});
  }
}
...
private class MFVec3f703 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.3126f,-0.0154f,0f,1.3185f,-0.0151f});
  }
}
...
private class MFVec3f712 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.0505f,1.42425f,0.03294f,0f,1.3126f,-0.0154f});
  }
}
...
private class MFVec3f730 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.048127f,1.4049f,0.08305f,0f,1.3126f,-0.0154f});
  }
}
...
private class MFVec3f739 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.04813f,1.4049f,0.08305f,0f,1.3126f,-0.0154f});
  }
}
...
private class MFVec3f748 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.02175f,1.4139f,0.1069f,0f,1.3126f,-0.0154f});
  }
}
...
private class MFVec3f757 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.02175f,1.4139f,0.10694f,0f,1.3126f,-0.0154f});
  }
}
...
private class MFVec3f778 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0f,1.3128f,0.01538f,0f,1.3126f,-0.0154f});
  }
}
...
private class MFVec3f787 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.03847f,1.2087f,-0.01378f,0f,1.22f,-0.0138f});
  }
}
...
private class MFVec3f808 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.12294f,1.191825f,-0.0129f,0.03847f,1.2087f,-0.01378f});
  }
}
...
private class MFVec3f829 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.16506f,1.17855f,-0.00327f,0.12294f,1.191825f,-0.0129f});
  }
}
...
private class MFVec3f842 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18209f,0.9288f,-0.00563f,0.16506f,1.17855f,-0.00327f});
  }
}
...
private class MFVec3f851 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1819f,0.72427f,-0.005f,0.18209f,0.9288f,-0.00563f});
  }
}
...
private class MFVec3f856 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1813f,0.706f,0.0193f,0.1819f,0.72427f,-0.005f});
  }
}
...
private class MFVec3f865 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1805f,0.69255f,0.026f,0.1813f,0.706f,0.0193f});
  }
}
...
private class MFVec3f870 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.181f,0.6727f,0.03577f,0.1805f,0.69255f,0.026f});
  }
}
...
private class MFVec3f879 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1826f,0.654f,0.04966f,0.181f,0.6727f,0.03577f});
  }
}
...
private class MFVec3f884 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18128f,0.70695f,0.00842f,0.1819f,0.72427f,-0.005f});
  }
}
...
private class MFVec3f889 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18128f,0.6876f,0.0098f,0.18128f,0.70695f,0.00842f});
  }
}
...
private class MFVec3f894 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1837f,0.6372f,0.01507f,0.18128f,0.6876f,0.0098f});
  }
}
...
private class MFVec3f899 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18171f,0.6068f,0.01418f,0.1837f,0.6372f,0.01507f});
  }
}
...
private class MFVec3f912 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18067f,0.5816f,0.01338f,0.18171f,0.6068f,0.01418f});
  }
}
...
private class MFVec3f917 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18108f,0.708525f,-0.0048f,0.1819f,0.72427f,-0.005f});
  }
}
...
private class MFVec3f926 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18108f,0.6858f,-0.00625f,0.18108f,0.708525f,-0.0048f});
  }
}
...
private class MFVec3f931 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18369f,0.6349f,-0.0039f,0.18108f,0.6858f,-0.00625f});
  }
}
...
private class MFVec3f936 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18171f,0.6032f,-0.0035f,0.18369f,0.6349f,-0.0039f});
  }
}
...
private class MFVec3f945 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1807f,0.5753f,-0.0037f,0.18171f,0.6032f,-0.0035f});
  }
}
...
private class MFVec3f950 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18108f,0.70582f,-0.02574f,0.1819f,0.72427f,-0.005f});
  }
}
...
private class MFVec3f955 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1811f,0.68625f,-0.0199f,0.18108f,0.70582f,-0.02574f});
  }
}
...
private class MFVec3f960 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18369f,0.63405f,-0.02144f,0.1811f,0.68625f,-0.0199f});
  }
}
...
private class MFVec3f965 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1817f,0.6066f,-0.02064f,0.18369f,0.63405f,-0.02144f});
  }
}
...
private class MFVec3f974 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18067f,0.580725f,-0.01977f,0.1817f,0.6066f,-0.02064f});
  }
}
...
private class MFVec3f983 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18164f,0.68827f,-0.03278f,0.1819f,0.72427f,-0.005f});
  }
}
...
private class MFVec3f988 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1833f,0.6381f,-0.037f,0.18164f,0.68827f,-0.03278f});
  }
}
...
private class MFVec3f993 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.18166f,0.621f,-0.03715f,0.1833f,0.6381f,-0.037f});
  }
}
...
private class MFVec3f1002 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {0.1808f,0.6023f,-0.0369f,0.18166f,0.621f,-0.03715f});
  }
}
...
private class MFVec3f1011 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.03847f,1.2087f,-0.0138f,0f,1.22f,-0.0138f});
  }
}
...
private class MFVec3f1032 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1229f,1.19182f,-0.0129f,-0.03847f,1.2087f,-0.0138f});
  }
}
...
private class MFVec3f1053 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1647f,1.17855f,-0.00327f,-0.1229f,1.19182f,-0.0129f});
  }
}
...
private class MFVec3f1066 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1817f,0.9288f,-0.00564f,-0.1647f,1.17855f,-0.00327f});
  }
}
...
private class MFVec3f1075 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1816f,0.7242f,-0.005f,-0.1817f,0.9288f,-0.00564f});
  }
}
...
private class MFVec3f1080 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18097f,0.70605f,0.0193f,-0.1816f,0.7242f,-0.005f});
  }
}
...
private class MFVec3f1089 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18f,0.69255f,0.02598f,-0.18097f,0.70605f,0.0193f});
  }
}
...
private class MFVec3f1094 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18065f,0.67275f,0.03577f,-0.18f,0.69255f,0.02598f});
  }
}
...
private class MFVec3f1103 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18227f,0.654f,0.0496f,-0.18065f,0.67275f,0.03577f});
  }
}
...
private class MFVec3f1108 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18097f,0.70695f,0.0084f,-0.1816f,0.7242f,-0.005f});
  }
}
...
private class MFVec3f1113 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1809f,0.6876f,0.0097f,-0.18097f,0.70695f,0.0084f});
  }
}
...
private class MFVec3f1118 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18335f,0.6372f,0.01507f,-0.1809f,0.6876f,0.0097f});
  }
}
...
private class MFVec3f1123 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1813f,0.6068f,0.01418f,-0.18335f,0.6372f,0.01507f});
  }
}
...
private class MFVec3f1136 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1803f,0.5816f,0.01338f,-0.1813f,0.6068f,0.01418f});
  }
}
...
private class MFVec3f1141 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18072f,0.708525f,-0.004797f,-0.1816f,0.7242f,-0.005f});
  }
}
...
private class MFVec3f1150 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18072f,0.6858f,-0.00625f,-0.18072f,0.708525f,-0.004797f});
  }
}
...
private class MFVec3f1155 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1833f,0.63495f,-0.0039f,-0.18072f,0.6858f,-0.00625f});
  }
}
...
private class MFVec3f1160 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1813f,0.6032f,-0.0035f,-0.1833f,0.63495f,-0.0039f});
  }
}
...
private class MFVec3f1169 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18029f,0.5753f,-0.00375f,-0.1813f,0.6032f,-0.0035f});
  }
}
...
private class MFVec3f1174 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18072f,0.70583f,-0.02574f,-0.1816f,0.7242f,-0.005f});
  }
}
...
private class MFVec3f1179 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18072f,0.68625f,-0.01992f,-0.18072f,0.70583f,-0.02574f});
  }
}
...
private class MFVec3f1184 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1833f,0.63405f,-0.02144f,-0.18072f,0.68625f,-0.01992f});
  }
}
...
private class MFVec3f1189 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1813f,0.6066f,-0.02064f,-0.1833f,0.63405f,-0.02144f});
  }
}
...
private class MFVec3f1198 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18029f,0.5807f,-0.01978f,-0.1813f,0.6066f,-0.02064f});
  }
}
...
private class MFVec3f1207 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18126f,0.68827f,-0.03278f,-0.1816f,0.7242f,-0.005f});
  }
}
...
private class MFVec3f1212 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18297f,0.6381f,-0.0371f,-0.18126f,0.68827f,-0.03278f});
  }
}
...
private class MFVec3f1217 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.1813f,0.621f,-0.03715f,-0.18297f,0.6381f,-0.0371f});
  }
}
...
private class MFVec3f1226 {
  private org.web3d.x3d.jsail.fields.MFVec3f getArray() {
    return new org.web3d.x3d.jsail.fields.MFVec3f(new double[] {-0.18045f,0.602325f,-0.03697f,-0.1813f,0.621f,-0.03715f});
  }
}
private class MFColor1227 {
  private org.web3d.x3d.jsail.fields.MFColor getArray() {
    return new org.web3d.x3d.jsail.fields.MFColor(new double[] {0.5f,0.5f,0.5f});
  }
}

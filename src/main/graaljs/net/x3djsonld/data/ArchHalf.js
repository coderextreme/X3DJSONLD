...
ArchHalf.prototype = {
  ...
  initialize : function ()
  {
	...
	this.ArchChord_5_13_point = new MFVec3f() /* splitting up long array to improve readability */
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape("Arch")
      ...
      .setGeometry(new IndexedFaceSet("ArchIndex").setDEF("ArchIndex").setConvex(false).setSolid(false).setCoordIndex(this.ArchIndex_4_13_coordIndex)
        .setCoord(new Coordinate("ArchChord").setPoint(this.ArchChord_5_13_point)))

...
indexedfaceset_pixeltexture_whole.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new Shape()
      ...
      .setGeometry(new IndexedFaceSet().setColorPerVertex(false).setCreaseAngle(0.5).setCoordIndex(Java.to([0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1], Java.type("int[]"))).setTexCoordIndex(Java.to([0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1,0,1,3,2,-1], Java.type("int[]")))
        ...
        .setTexCoord(new TextureCoordinate().setPoint(new MFVec2f(Java.to([doubleToFloat(0.0),doubleToFloat(1.0),doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(1.0),doubleToFloat(1.0),doubleToFloat(1.0),doubleToFloat(0.0)], Java.type("float[]"))))))));
  },
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		print ("indexedfaceset_pixeltexture_whole execution self-validation test results: " + testObject.validateSelf());
	}
}

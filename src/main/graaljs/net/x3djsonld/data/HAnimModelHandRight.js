    ...
    .addChild(new HAnimHumanoid("hanim_Hand_Right").setName("Hand_Right").setLoa(4).setVersion("2.0")
      ...
      .addSkeleton(new HAnimJoint("hanim_humanoid_root").setName("humanoid_root")
        ...
        .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_radiocarpal").setDescription("connection joint of hand to leg above")
          .addChild(new HAnimSegment("hanim_r_carpal").setName("r_carpal")
            ...
            .addChild(new Shape()
              ...
              .setGeometry(new IndexedLineSet("RCToMC45").setDEF("RCToMC45").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(0.1),doubleToFloat(0.1),doubleToFloat(0.0)], Java.type("float[]"))))))))
          .addComments(" MC1 ")
          .addChild(new HAnimJoint("hanim_r_midcarpal_1").setName("r_midcarpal_1").setCenter(doubleToFloat(-0.14),doubleToFloat(0.09),doubleToFloat(0.0))
            ...
            .addChild(new HAnimJoint("hanim_r_carpometacarpal_1").setName("r_carpometacarpal_1").setCenter(doubleToFloat(-0.2),doubleToFloat(0.15),doubleToFloat(0.0))
              ...
              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_1").setName("r_metacarpophalangeal_1").setCenter(doubleToFloat(-0.3),doubleToFloat(0.3),doubleToFloat(0.0))
                ...
                .addChild(new HAnimJoint("hanim_r_carpal_interphalangeal_1").setName("r_carpal_interphalangeal_1").setCenter(doubleToFloat(-0.35),doubleToFloat(0.4),doubleToFloat(0.0))
          ...
          .addComments(" MC2 ")
          .addChild(new HAnimJoint("hanim_r_midcarpal_2").setName("r_midcarpal_2").setCenter(doubleToFloat(-0.07),doubleToFloat(0.07),doubleToFloat(0.0))
            ...
            .addChild(new HAnimJoint("hanim_r_carpometacarpal_2").setName("r_carpometacarpal_2").setCenter(doubleToFloat(-0.1),doubleToFloat(0.2),doubleToFloat(0.0))
              ...
              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_2").setName("r_metacarpophalangeal_2").setCenter(doubleToFloat(-0.15),doubleToFloat(0.5),doubleToFloat(0.0))
                ...
                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_2").setName("r_carpal_proximal_interphalangeal_2").setCenter(doubleToFloat(-0.2),doubleToFloat(0.7),doubleToFloat(0.0))
                  ...
                  .addChild(new HAnimJoint("hanim_r_carpal_distal_interphalangeal_2").setName("r_carpal_distal_interphalangeal_2").setCenter(doubleToFloat(-0.24),doubleToFloat(0.87),doubleToFloat(0.0))
          ...
          .addComments(" MC3 ")
          .addChild(new HAnimJoint("hanim_r_midcarpal_3").setName("r_midcarpal_3").setCenter(doubleToFloat(0.0),doubleToFloat(0.07),doubleToFloat(0.0))
            ...
            .addChild(new HAnimJoint("hanim_r_carpometacarpal_3").setName("r_carpometacarpal_3").setCenter(doubleToFloat(0.0),doubleToFloat(0.2),doubleToFloat(0.0))
              ...
              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_3").setName("r_metacarpophalangeal_3").setCenter(doubleToFloat(-0.03),doubleToFloat(0.5),doubleToFloat(0.0))
                ...
                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_3").setName("r_carpal_proximal_interphalangeal_3").setCenter(doubleToFloat(-0.05),doubleToFloat(0.75),doubleToFloat(0.0))
                  ...
                  .addChild(new HAnimJoint("hanim_r_carpal_distal_interphalangeal_3").setName("r_carpal_distal_interphalangeal_3").setCenter(doubleToFloat(-0.08),doubleToFloat(0.96),doubleToFloat(0.0))
          ...
          .addComments(" MC4_5 ")
          .addChild(new HAnimJoint("hanim_r_midcarpal_4_5").setName("r_midcarpal_4_5").setCenter(doubleToFloat(0.1),doubleToFloat(0.1),doubleToFloat(0.0))
            ...
            .addChild(new HAnimJoint("hanim_r_carpometacarpal_4").setName("r_carpometacarpal_4").setCenter(doubleToFloat(0.1),doubleToFloat(0.2),doubleToFloat(0.0))
              ...
              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_4").setName("r_metacarpophalangeal_4").setCenter(doubleToFloat(0.1),doubleToFloat(0.47),doubleToFloat(0.0))
                ...
                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_4").setName("r_carpal_proximal_interphalangeal_4").setCenter(doubleToFloat(0.1),doubleToFloat(0.7),doubleToFloat(0.0))
                  ...
                  .addChild(new HAnimJoint("hanim_r_carpal_distal_interphalangeal_4").setName("r_carpal_distal_interphalangeal_4").setCenter(doubleToFloat(0.1),doubleToFloat(0.93),doubleToFloat(0.0))
            ...
            .addChild(new HAnimJoint("hanim_r_carpometacarpal_5").setName("r_carpometacarpal_5").setCenter(doubleToFloat(0.15),doubleToFloat(0.17),doubleToFloat(0.0))
              ...
              .addChild(new HAnimJoint("hanim_r_metacarpophalangeal_5").setName("r_metacarpophalangeal_5").setCenter(doubleToFloat(0.2),doubleToFloat(0.4),doubleToFloat(0.0))
                ...
                .addChild(new HAnimJoint("hanim_r_carpal_proximal_interphalangeal_5").setName("r_carpal_proximal_interphalangeal_5").setCenter(doubleToFloat(0.23),doubleToFloat(0.63),doubleToFloat(0.0))
                  ...
                  .addChild(new HAnimJoint("hanim_r_carpal_distal_interphalangeal_5").setName("r_carpal_distal_interphalangeal_5").setCenter(doubleToFloat(0.25),doubleToFloat(0.79),doubleToFloat(0.0))

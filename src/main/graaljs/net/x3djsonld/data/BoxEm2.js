...
BoxEm2.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new Viewpoint().setDescription("Cubes on Fire").setPosition(doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(12.0)))
    .addChild(new ProtoDeclare().setName("anyShape")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setName("xtranslation").setType("SFVec3f").setAccessType("inputOutput").setValue("0 0 0"))
    ...
    .addChild(new ProtoDeclare().setName("three")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setName("ytranslation").setType("SFVec3f").setAccessType("inputOutput").setValue("0 0 0"))
        .addField(new field().setName("myShape").setType("MFNode").setAccessType("inputOutput")
          .addChild(new Shape()
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Transform()
          ...
          .addChild(new ProtoInstance()
            ...
            .setIS(new IS()
              .addConnect(new connect().setNodeField("myShape").setProtoField("myShape")))))))
    .addChild(new ProtoInstance("threepi", "three")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new BoxEm2();
		print ("BoxEm2 execution self-validation test results: " + testObject.validateSelf());
	}
}
new BoxEm2().main();
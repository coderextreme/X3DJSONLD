...
flower.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform().setRotation(doubleToFloat(0.0),doubleToFloat(1.0),doubleToFloat(0.0),doubleToFloat(3.1415926)).setScale(doubleToFloat(1.5),doubleToFloat(1.5),doubleToFloat(1.5)).setTranslation(doubleToFloat(0.0),doubleToFloat(-1.0),doubleToFloat(1.0))
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(doubleToFloat(0.9),doubleToFloat(0.3),doubleToFloat(0.3)).setShininess(0.145).setSpecularColor(doubleToFloat(0.8),doubleToFloat(0.8),doubleToFloat(0.8)).setTransparency(0.1)))

...
"			    ecmascript:" + "\n" + 
"			    var me = '\"1\" \"\\\"2\" \"\\n3\"';" + "\n")
        .addField(new field().setName("frontUrls").setType("MFString").setAccessType("initializeOnly").setValue("\"rnl_front.png\" \"uffizi_front.png\"")))));
  },
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		print ("text3shapes execution self-validation test results: " + testObject.validateSelf());
	}
}

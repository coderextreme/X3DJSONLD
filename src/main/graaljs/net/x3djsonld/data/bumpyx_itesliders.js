 ...
 * <p> *enter description here, short-sentence summaries preferred*. </p>
 <p> Related links: bumpyx_itesliders.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
    ...
    .addChild(new LayerSet().setActiveLayer(1).setOrder(Java.to([1,2], Java.type("int[]")))
      ...
      .addLayers(new Layer()
        ...
        .addChild(new Transform("FlowerTransform")
          .addComments(Java.to(["",
"        <Inline DEF=\"Flower\" url='\"bumpyx_ite.x3d\"' />"], Java.type("java.lang.String[]")))
...
"                  <ShaderPart url='\"../shaders/x_itebubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>"], Java.type("java.lang.String[]"))))))))
        ...
        .addChild(new DISEntityManager("EntityManager").setNetworkMode("networkReader")
          .addMapping(new DISEntityTypeMapping().setCategory(77).setSpecific(1).setUrl(new MFString("\"Leif8Final.x3d\"")))
          .addMapping(new DISEntityTypeMapping().setCategory(77).setSpecific(2).setUrl(new MFString("\"Lily8Final.x3d\""))))
...
"         like a HUD (heads up display) ], Java.type("java.lang.String[]")))
      .addLayers(new LayoutLayer()
        ...
        .setLayout(new Layout().setAlign(new MFString("\"RIGHT\",\"BOTTOM\"")).setOffset(Java.to([doubleToFloat(0.0),doubleToFloat(.0),doubleToFloat(0.2)], Java.type("float[]"))).setOffsetUnits(new MFString("\"WORLD\",\"WORLD\"")).setScaleMode(new MFString("\"NONE\",\"NONE\"")).setSize(Java.to([doubleToFloat(0.4),doubleToFloat(.0),doubleToFloat(0.6)], Java.type("float[]"))).setSizeUnits(new MFString("\"WORLD\",\"WORLD\"")))
...
"	  ecmascript: function newTranslation(Value) { aValue_changed = Value.x * 30; }" + "\n")
          ...
          .addField(new field().setName("aValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { bValue_changed = Value.x * 30; }" + "\n")
          .addField(new field().setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField(new field().setName("bValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { cValue_changed = Value.x * 5; }" + "\n")
          .addField(new field().setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField(new field().setName("cValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { dValue_changed = Value.x * 5; }" + "\n")
          .addField(new field().setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField(new field().setName("dValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { pdeltaValue_changed = Value.x; }" + "\n")
          .addField(new field().setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField(new field().setName("pdeltaValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
...
"	  ecmascript: function newTranslation(Value) { tdeltaValue_changed = Value.x; }" + "\n")
          .addField(new field().setName("newTranslation").setType("SFVec3f").setAccessType("inputOnly").setValue("1.0 1.0 1.0"))
          .addField(new field().setName("tdeltaValue_changed").setType("SFFloat").setAccessType("outputOnly").setValue("1.0")))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new bumpyx_itesliders();
		print ("bumpyx_itesliders execution self-validation test results: " + testObject.validateSelf());
	}
}
new bumpyx_itesliders().main();
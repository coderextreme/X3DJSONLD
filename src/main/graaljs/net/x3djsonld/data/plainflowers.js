...
plainflowers.prototype = {
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d")))
  .setScene(new Scene()
    ...
    .addChild(new Group()
      .addChild(new ExternProtoDeclare().setName("FlowerProto").setUrl(new MFString("\"../data/flowerproto.x3d#FlowerProto\""))

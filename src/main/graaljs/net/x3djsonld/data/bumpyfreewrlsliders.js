...
"        <Inline DEF=\"Flower\" url='\"bumpyfreewrl.x3d\"' />"], Java.type("java.lang.String[]")))
        ...
        .addChild(new DISEntityManager("EntityManager").setNetworkMode("networkReader")
          .addMapping(new DISEntityTypeMapping().setCategory(77).setSpecific(1).setUrl(new MFString("\"../data/Leif8Final.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3d\"")))
          .addMapping(new DISEntityTypeMapping().setCategory(77).setSpecific(2).setUrl(new MFString("\"../data/Lily8Final.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3d\""))))

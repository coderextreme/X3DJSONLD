  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform("G1")
      .addChild(new Transform("DECLpoint_INSTANCE_node")
        ...
        .addChild(new PositionInterpolator("DECLpoint_INSTANCE_PI1").setKey(Java.to([doubleToFloat(0.0),doubleToFloat(1.0)], Java.type("float[]"))).setKeyValue(new MFVec3f(Java.to([doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(5.0),doubleToFloat(0.0)], Java.type("float[]")))))
    ...
    .addChild(new Transform("G2")
      .addChild(new Transform("DECLpoint_INSTANCE1000_node")
        .addChild(new Shape()
          ...
          .setAppearance(new Appearance()
            .setMaterial(new Material().setDiffuseColor(doubleToFloat(1.0),doubleToFloat(0.0),doubleToFloat(0.0)))))
        .addChild(new PositionInterpolator("DECLpoint_INSTANCE1000_PI1").setKey(Java.to([doubleToFloat(0.0),doubleToFloat(1.0)], Java.type("float[]"))).setKeyValue(new MFVec3f(Java.to([doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(5.0),doubleToFloat(0.0)], Java.type("float[]")))))
...
"        }" + "\n")
      ...
      .addField(new field().setName("transC1").setType("SFNode").setAccessType("initializeOnly")
        .addChild(new Transform().setUSE("transC1")))
      .addField(new field().setName("rotscaleC1").setType("SFNode").setAccessType("initializeOnly")

  ...
  .setScene(new Scene()
    .addChild(new ProtoDeclare().setName("FlowerProto")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setName("vertex").setType("MFString").setAccessType("inputOutput").setValue("\"../shaders/gl_flowers_chromatic.vs\""))
        .addField(new field().setName("fragment").setType("MFString").setAccessType("inputOutput").setValue("\"../shaders/pc_flowers.fs\"")))

...
x3dconnectorProto.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new Transform("G3").setTranslation(doubleToFloat(1.0),doubleToFloat(1.0),doubleToFloat(.01))
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(doubleToFloat(0.2),doubleToFloat(0.7),doubleToFloat(0.2))))
        .setGeometry(new Sphere().setRadius(.1)))
      .addChild(new PlaneSensor("PS3").setDescription("Grab to move").setOffset(doubleToFloat(1.0),doubleToFloat(1.0),doubleToFloat(.01)))
      .addChild(new ROUTE().setFromNode("PS3").setFromField("translation_changed").setToNode("G3").setToField("set_translation")))
    .addChild(new Transform("G4").setTranslation(doubleToFloat(-1.0),doubleToFloat(1.0),doubleToFloat(.01))
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(doubleToFloat(0.2),doubleToFloat(0.7),doubleToFloat(0.2))))
        .setGeometry(new Sphere().setRadius(.1)))
      .addChild(new PlaneSensor("PS4").setDescription("Grab to move").setOffset(doubleToFloat(-1.0),doubleToFloat(1.0),doubleToFloat(.01)))

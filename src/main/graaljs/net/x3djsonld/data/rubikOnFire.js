  ...
  .setScene(new Scene()
    ...
    .addChild(new ProtoDeclare().setName("anyShape")
      .setProtoInterface(new ProtoInterface()
        ...
        .addField(new field().setName("myShape").setType("SFNode").setAccessType("inputOutput")
          .addChild(new Sphere())))
    ...
    .addChild(new ProtoInstance()
      ...
      .addFieldValue(new fieldValue().setName("myShape")
        .addChild(new Box().setSize(doubleToFloat(1.0),doubleToFloat(1.0),doubleToFloat(1.0))))));
  },

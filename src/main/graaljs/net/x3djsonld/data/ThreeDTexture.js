...
ThreeDTexture.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new Viewpoint().setDescription("Rubiks Cube").setPosition(doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(12.0)))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		print ("ThreeDTexture execution self-validation test results: " + testObject.validateSelf());
	}
}

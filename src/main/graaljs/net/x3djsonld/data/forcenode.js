      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Group()
          .addChild(new Transform("transform")
            ...
            .addChild(new Transform().setTranslation(doubleToFloat(1.0),doubleToFloat(0.0),doubleToFloat(1.0))
              .addChild(new Shape()
...
"					}" + "\n")
    ...
    .addChild(new ProtoDeclare().setName("cyl")
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Group()
          .addChild(new Shape()
            .setGeometry(new Extrusion("extrusion").setCreaseAngle(0.785).setCrossSection(this.extrusion_7_40_crossSection).setSpine(new MFVec3f(Java.to([doubleToFloat(0.0),doubleToFloat(-50.0),doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(50.0),doubleToFloat(0.0)], Java.type("float[]")))))
            .setAppearance(new Appearance()

...
arcold.prototype = {
  ...
  .setScene(new Scene()
    .addChild(new Viewpoint().setDescription("a moving graph").setPosition(doubleToFloat(0.0),doubleToFloat(0.0),doubleToFloat(5.0)))
      ...
      .addChild(new Transform("rotscale1")
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material().setDiffuseColor(doubleToFloat(0.2),doubleToFloat(0.7),doubleToFloat(0.7))))
...
"		}" + "\n")
    ...
    .addChild(new ProtoDeclare().setName("x3dconnector")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setName("startnode").setType("SFNode").setAccessType("inputOutput"))
        .addField(new field().setName("endnode").setType("SFNode").setAccessType("inputOutput"))
...
"        }" + "\n")
    ...
    .addChild(new ProtoInstance("G1", "point"))
    .addChild(new ProtoInstance("G2", "point"))
    .addChild(new ProtoInstance("G3", "point"))
    .addChild(new ProtoInstance("G4", "point"))

  ...
  .setScene(new Scene()
    ...
    .addChild(new ProtoDeclare().setName("HAnimBehavior").setAppinfo(this.ProtoDeclare_HAnimBehavior_3_19_appinfo).setDocumentation("https://www.web3d.org/files/specifications/19774/V1.0/")
      .setProtoInterface(new ProtoInterface()
        ...
        .addField(new field().setName("supportedLOA").setType("SFInt32").setAccessType("inputOutput").setValue("-1").setAppinfo(this.field_supportedLOA_5_19_appinfo))
        ...
        .addField(new field().setName("enabled").setType("SFBool").setAccessType("inputOutput").setValue("true").setAppinfo("is this behavior enabled?"))
        .addField(new field().setName("cycleInterval").setType("SFTime").setAccessType("inputOutput").setValue("1.0").setAppinfo("how long do these interpolators take to execute?"))
        .addField(new field().setName("loop").setType("SFBool").setAccessType("inputOutput").setValue("false").setAppinfo("whether or not this behavior loops (e.g. walking) or is single shot (e.g. shake hands)."))
        .addField(new field().setName("startTime").setType("SFTime").setAccessType("inputOutput").setValue("0").setAppinfo("when time now >= startTime isActive becomes true and TimeSensor becomes active"))
        .addField(new field().setName("stopTime").setType("SFTime").setAccessType("inputOutput").setValue("0").setAppinfo("when stopTime becomes <= time now isActive becomes false and TimeSensor becomes inactive"))
        .addField(new field().setName("pauseTime").setType("SFTime").setAccessType("inputOutput").setValue("0").setAppinfo("when time now >= pauseTime isPaused becomes true and TimeSensor becomes paused"))
        .addField(new field().setName("resumeTime").setType("SFTime").setAccessType("inputOutput").setValue("0").setAppinfo("when resumeTime becomes <= time now isPaused becomes false and TimeSensor becomes inactive"))
        .addField(new field().setName("cycleTime").setType("SFTime").setAccessType("outputOnly").setAppinfo("cycleTime sends a time outputOnly at startTime and also at the beginning of each new cycle"))
        .addField(new field().setName("isActive").setType("SFBool").setAccessType("outputOnly").setAppinfo("isActive true/false events are sent when TimeSensor starts/stops running"))
        .addField(new field().setName("isPaused").setType("SFBool").setAccessType("outputOnly").setAppinfo("isPaused true/false events are sent when TimeSensor is paused/resumed"))
        .addField(new field().setName("elapsedTime").setType("SFBool").setAccessType("outputOnly").setAppinfo(this.field_elapsedTime_5_30_appinfo))
        .addField(new field().setName("time").setType("SFBool").setAccessType("outputOnly").setAppinfo("continuously sends the absolute time (since January 1 1970)"))
        .addField(new field().setName("fraction_changed").setType("SFFloat").setAccessType("outputOnly").setAppinfo("fraction_changed continuously sends value in range [0 1] showing time progress in the current cycle."))
        .addComments(" pass in key/keyValue array pairs for single PositionInterpolator ")
        .addField(new field().setName("HumanoidRoot_translation_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("HumanoidRoot_translation_keyValue").setType("MFVec3f").setAccessType("inputOutput")
          .addComments(" no default value "))
        ...
        .addField(new field().setName("HumanoidRoot_rotation_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("HumanoidRoot_rotation_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("HumanoidRoot_rotation_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("c1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("c2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("c3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("c4_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c4_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c4_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("c5_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c5_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c5_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("c6_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c6_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c6_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("c7_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c7_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("c7_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("jaw_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("jaw_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("jaw_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l4_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l4_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l4_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l5_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l5_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l5_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_acromioclavicular_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_acromioclavicular_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_acromioclavicular_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_ankle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ankle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ankle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_calf_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_calf_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_calf_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_clavicle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_clavicle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_clavicle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_elbow_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_elbow_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_elbow_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_eyeball_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyeball_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyeball_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_eyeball_joint_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyeball_joint_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyeball_joint_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_eyebrow_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyebrow_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyebrow_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_eyebrow_joint_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyebrow_joint_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyebrow_joint_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_eyelid_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyelid_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyelid_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_eyelid_joint_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyelid_joint_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_eyelid_joint_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_forearm_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_forearm_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_forearm_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_forefoot_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_forefoot_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_forefoot_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_hand_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_hand_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_hand_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_hindfoot_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_hindfoot_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_hindfoot_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_hip_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_hip_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_hip_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_index0_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index0_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index0_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_index1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_index2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_index3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_index_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_index_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_index_middle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index_middle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index_middle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_index_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_index_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_knee_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_knee_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_knee_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_metatarsal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_metatarsal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_metatarsal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_middistal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middistal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middistal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_middle0_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle0_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle0_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_middle1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_middle2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_middle3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_middle_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_middle_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_middle_middle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle_middle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle_middle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_middle_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_middle_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_midproximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_midproximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_midproximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_midtarsal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_midtarsal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_midtarsal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_pinky0_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky0_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky0_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_pinky1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_pinky2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_pinky3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_pinky_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_pinky_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_pinky_middle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky_middle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky_middle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_pinky_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_pinky_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_ring0_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring0_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring0_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_ring1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_ring2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_ring3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_ring_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_ring_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_ring_middle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring_middle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring_middle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_ring_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_ring_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_scapula_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_scapula_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_scapula_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_shoulder_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_shoulder_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_shoulder_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_sternoclavicular_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_sternoclavicular_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_sternoclavicular_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_subtalar_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_subtalar_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_subtalar_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_thigh_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thigh_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thigh_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_thumb1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_thumb2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_thumb3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_thumb_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_thumb_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_thumb_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_thumb_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_upperarm_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_upperarm_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_upperarm_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("l_wrist_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_wrist_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("l_wrist_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("pelvis_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("pelvis_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("pelvis_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_acromioclavicular_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_acromioclavicular_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_acromioclavicular_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_ankle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ankle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ankle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_calf_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_calf_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_calf_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_clavicle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_clavicle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_clavicle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_elbow_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_elbow_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_elbow_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_eyeball_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyeball_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyeball_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_eyeball_joint_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyeball_joint_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyeball_joint_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_eyebrow_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyebrow_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyebrow_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_eyebrow_joint_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyebrow_joint_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyebrow_joint_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_eyelid_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyelid_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyelid_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_eyelid_joint_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyelid_joint_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_eyelid_joint_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_forearm_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_forearm_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_forearm_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_forefoot_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_forefoot_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_forefoot_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_hand_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_hand_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_hand_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_hindfoot_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_hindfoot_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_hindfoot_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_hip_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_hip_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_hip_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_index0_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index0_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index0_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_index1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_index2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_index3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_index_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_index_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_index_middle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index_middle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index_middle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_index_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_index_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_knee_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_knee_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_knee_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_metatarsal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_metatarsal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_metatarsal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_middistal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middistal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middistal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_middle0_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle0_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle0_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_middle1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_middle2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_middle3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_middle_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_middle_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_middle_middle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle_middle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle_middle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_middle_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_middle_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_midproximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_midproximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_midproximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_midtarsal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_midtarsal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_midtarsal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_pinky0_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky0_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky0_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_pinky1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_pinky2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_pinky3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_pinky_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_pinky_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_pinky_middle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky_middle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky_middle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_pinky_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_pinky_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_ring0_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring0_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring0_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_ring1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_ring2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_ring3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_ring_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_ring_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_ring_middle_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring_middle_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring_middle_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_ring_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_ring_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_scapula_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_scapula_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_scapula_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_shoulder_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_shoulder_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_shoulder_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_sternoclavicular_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_sternoclavicular_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_sternoclavicular_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_subtalar_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_subtalar_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_subtalar_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_thigh_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thigh_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thigh_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_thumb1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_thumb2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_thumb3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_thumb_distal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb_distal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb_distal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_thumb_metacarpal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb_metacarpal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb_metacarpal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_thumb_proximal_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb_proximal_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_thumb_proximal_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_upperarm_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_upperarm_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_upperarm_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("r_wrist_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_wrist_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("r_wrist_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("sacroiliac_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("sacroiliac_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("sacroiliac_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("sacrum_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("sacrum_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("sacrum_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("skull_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("skull_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("skull_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("skullbase_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("skullbase_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("skullbase_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t10_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t10_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t10_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t11_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t11_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t11_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t12_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t12_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t12_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t4_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t4_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t4_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t5_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t5_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t5_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t6_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t6_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t6_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t7_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t7_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t7_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t8_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t8_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t8_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("t9_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t9_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("t9_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("temporomandibular_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("temporomandibular_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("temporomandibular_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vc1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vc2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vc3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vc4_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc4_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc4_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vc5_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc5_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc5_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vc6_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc6_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc6_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vc7_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc7_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vc7_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vl1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vl2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vl3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vl4_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl4_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl4_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vl5_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl5_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vl5_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt10_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt10_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt10_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt11_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt11_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt11_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt12_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt12_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt12_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt1_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt1_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt1_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt2_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt2_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt2_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt3_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt3_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt3_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt4_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt4_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt4_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt5_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt5_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt5_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt6_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt6_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt6_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt7_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt7_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt7_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt8_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt8_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt8_changed").setType("SFRotation").setAccessType("outputOnly"))
        .addField(new field().setName("vt9_key").setType("MFFloat").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt9_keyValue").setType("MFRotation").setAccessType("inputOutput")
          .addComments(" no default value "))
        .addField(new field().setName("vt9_changed").setType("SFRotation").setAccessType("outputOnly")))
    ...
    .addChild(new ProtoDeclare().setName("HAnimBodyBehaviorChooser").setAppinfo(this.ProtoDeclare_HAnimBodyBehaviorChooser_3_1755_appinfo)
      .setProtoInterface(new ProtoInterface()
        ...
        .addField(new field().setName("supportedLOA").setType("SFInt32").setAccessType("inputOutput").setValue("-1").setAppinfo(this.field_supportedLOA_5_1755_appinfo))
        .addField(new field().setName("HumanoidArray").setType("MFNode").setAccessType("initializeOnly").setAppinfo("[HAnimHumanoid] nodes only")
        ...
        .addField(new field().setName("whichBody").setType("SFInt32").setAccessType("initializeOnly").setValue("-1").setAppinfo("whichBody is selected default is initial member of HumanoidArray"))
        .addField(new field().setName("set_whichBody").setType("SFInt32").setAccessType("inputOnly").setAppinfo("whichBody is selected default is none"))
        .addField(new field().setName("whichBody_changed").setType("SFInt32").setAccessType("outputOnly").setAppinfo("whichBody is selected default is none"))
        .addField(new field().setName("hAnimBehaviorNodes").setType("MFNode").setAccessType("initializeOnly").setAppinfo(this.field_hAnimBehaviorNodes_5_1760_appinfo)
          .addComments(" default NULL "))
        .addField(new field().setName("enabledBehaviorsArray").setType("MFBool").setAccessType("initializeOnly").setAppinfo("indicate which HAnimBehavior nodes are activated, empty indicates all enabled true")
          .addComments(" no default values "))
        .addField(new field().setName("enableBehavior").setType("SFInt32").setAccessType("inputOnly").setAppinfo("enable corresponding behavior identified by index number"))
        .addField(new field().setName("disableBehavior").setType("SFInt32").setAccessType("inputOnly").setAppinfo("disable corresponding behavior identified by index number"))
        ...
        .addField(new field().setName("stopTime").setType("SFTime").setAccessType("inputOutput").setValue("0"))
      ...
      .setProtoBody(new ProtoBody()
        ...
        .addChild(new Script("BehaviorSelectionScript").setDirectOutput(true).setUrl(new MFString("\"HAnimBehaviorPrototypesScript.js\" \"https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/HAnimBehaviorPrototypesScript.js\""))
          .addField(new field().setName("HumanoidArray").setType("MFNode").setAccessType("initializeOnly").setAppinfo("[HAnimHumanoid] nodes only"))
          .addField(new field().setName("whichBody").setType("SFInt32").setAccessType("initializeOnly").setAppinfo("whichBody is selected default is none"))
          .addField(new field().setName("set_whichBody").setType("SFInt32").setAccessType("inputOnly").setAppinfo("whichBody is selected default is none"))
          .addField(new field().setName("whichBody_changed").setType("SFInt32").setAccessType("outputOnly").setAppinfo("whichBody is selected default is none"))
          .addField(new field().setName("hAnimBehaviorNodes").setType("MFNode").setAccessType("initializeOnly").setAppinfo("[HAnimBehavior] nodes only")
            .addComments(" TODO: might consider accessType=\"inputOutput\" if VRML97 compatibility not needed "))
          .addField(new field().setName("enabledBehaviorsArray").setType("MFBool").setAccessType("initializeOnly"))
    ...
    .addChild(new ProtoInstance("BehaviorTest1", "HAnimBehavior")
    ...
    .addChild(new ProtoInstance("ChooserTest", "HAnimBodyBehaviorChooser")

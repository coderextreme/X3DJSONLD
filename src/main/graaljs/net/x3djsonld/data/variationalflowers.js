...
"			    * updateRate - update rate is amount of time between frames"], Java.type("java.lang.String[]")))
        .addComments(Java.to(["",
"			<VariationPhysicsModel values=\"2 2 5 5 0 0\" varations=\"2 1 3 3 0.1 0.1\" lastFrame='0' updateRate='0.1'>",
"			</VariationPhysicsModel>"], Java.type("java.lang.String[]")))
...
"	  		    </ComposedShader>"], Java.type("java.lang.String[]")))
          .addShaders(new ComposedShader("x_ite").setLanguage("GLSL")
            ...
            .addParts(new ShaderPart().setUrl(new MFString("\"../shaders/x_ite_variations.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_variations.vs\"")))
            .addParts(new ShaderPart().setType("FRAGMENT").setUrl(new MFString("\"../shaders/commonnew.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/commonnew.fs\""))))))
...
"			}" + "\n")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		print ("variationalflowers execution self-validation test results: " + testObject.validateSelf());
	}
}

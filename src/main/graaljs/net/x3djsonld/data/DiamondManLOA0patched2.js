 ...
 * <p> HAnim skeletal structure for Level of Action (LOA) zero, with one diamond at the base node for the structure. HumanoidRoot only, so this is the minimum legal HAnim humanoid. </p>
 <p> Related links: DiamondManLOA0patched2.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;" summary="Scene Metadata">
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.DiamondManLOA0patched2&nbsp; Document Metadata </td>
		</tr>

		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> title </i> </td>
			<td> <a href="DiamondManLOA0patched2.x3d">DiamondManLOA0patched2.x3d</a> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <a href="humanoid_landmark_locations.gif">humanoid_landmark_locations.gif</a> </td>
		</tr>
		<tr>
			<td style="text-align:right; vertical-align: text-top;"> <i> Image </i> </td>
...
function DiamondManLOA0patched2
...
DiamondManLOA0patched2.prototype = {
  /** Create and initialize the X3D model. */
  initialize : function ()
  {

	/** Large attribute array: WorldInfo info field, scene-graph level=3, element #26, 100 total values */
	this.WorldInfo_3_26_info = new MFString(new MFString("\"HAnim 2.0 Default Joint Centers, Level Of Articulation (LOA) 0 -------------------------------------------------------- HANIM 1.1 (VRML 2.0) Author name: eMpTy (a.k.a. Matthew T. Beitler) HANIM 1.1 (VRML 2.0) Author email: beitler@graphics.cis.upenn.edu or beitler@acm.org HANIM 1.1 (VRML 2.0) Author homepage: http://www.cis.upenn.edu/~beitler HANIM 1.1 (VRML 2.0) Compliance Date: May 12, 1999 HANIM 1.1 Compliance Information: http://ece.uwaterloo.ca/~HAnim/ Construction Info (joint centers): The joint centers of this figure are based on the work of Norman Badler, director of the Center for Human Modeling and Simulation at the University of Pennsylvania. The original document which these joint centers are based on can be found at: http://www.cis.upenn.edu/~badler/anthro/89-71.ps, .pdf\""));

	/** Large attribute array: MetadataSet reference field, scene-graph level=4, element #29, 1 total value */
	this.MetadataSet_HAnimHumanoid.info_4_29_reference = new SFString("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid");

	/** Large attribute array: MetadataString value field, scene-graph level=5, element #34, 51 total values */
	this.MetadataString_usageRestrictions_5_34_value = new MFString(new MFString("\"PERMISSION TO FULLY USE THIS SCENE GRAPH IS GRANTED PROVIDED THIS COPYRIGHT INFORMATION AND DOCUMENTATION OF THE ORIGINAL AUTHOR IS INCLUDED. This humanoid scene graph is provided _as-is_ and without warranty of any kind express implied or otherwise including without limitation any warranty of merchantability or fitness for a particular purpose.\""));
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setInfo(this.WorldInfo_3_26_info).setTitle("HANIM 2.0 Default Joint Centers, LOA0"))
    .addChild(new NavigationInfo().setSpeed(1.5))
    .addChild(new Viewpoint().setDescription("Diamond Man, LOA 0").setCenterOfRotation(doubleToFloat(0.0),doubleToFloat(1.0),doubleToFloat(0.0)).setPosition(doubleToFloat(0.0),doubleToFloat(1.0),doubleToFloat(3.0)))
    .addChild(new HAnimHumanoid("hanim_humanoid").setName("humanoid").setLoa(0).setVersion("2.0")
      ...
      .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference(this.MetadataSet_HAnimHumanoid.info_4_29_reference)
        .addValue(new MetadataString().setName("authorEmail").setValue(new MFString("\"beitler@graphics.cis.upenn.edu beitler@acm.org\"")))
        .addValue(new MetadataString().setName("authorName").setValue(new MFString("\"Matthew T. Beitler\"")))
        .addValue(new MetadataString().setName("copyright").setValue(new MFString("\"Copyright 1999 Matthew T. Beitler\"")))
            ...
            .addChild(new Transform().setTranslation(doubleToFloat(0.0),doubleToFloat(0.9149),doubleToFloat(0.0016))
              .addChild(new Shape("DiamondShape")
                ...
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setDiffuseColor(doubleToFloat(1.0),doubleToFloat(1.0),doubleToFloat(0.0)))))))))
      .addViewpoints(new HAnimSite("hanim_site_view").setName("site_view")
        .addChild(new Viewpoint("InclinedView").setDescription("Inclined View").setOrientation(doubleToFloat(-0.113),doubleToFloat(0.993),doubleToFloat(0.0347),doubleToFloat(0.671)).setPosition(doubleToFloat(1.62),doubleToFloat(1.05),doubleToFloat(2.06)))
   ...
   * @return DiamondManLOA0patched2 model
   */
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new DiamondManLOA0patched2();
		print ("DiamondManLOA0patched2 execution self-validation test results: " + testObject.validateSelf());
	}
}
new DiamondManLOA0patched2().main();
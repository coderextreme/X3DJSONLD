...
var ProtoInstance6 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/glflowers.x3d")))
      .setScene(new Scene()
...
ProtoInstance0
    ...
    X3D0.toFileX3D("../personal/glflowers.new.graal.x3d");
    X3D0.toFileJSON("../personal/glflowers.new.graal.json");

...
var ProtoInstance9 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/rubik.x3d"))
...
ProtoInstance9
    ...
    X3D0.toFileX3D("../personal/rubik.new.graal.x3d");
    X3D0.toFileJSON("../personal/rubik.new.graal.json");

...
var ProtoInstance0 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/asteroids.x3d"))
    ...
    X3D0.toFileX3D("../personal/asteroids.new.graal.x3d");
    X3D0.toFileJSON("../personal/asteroids.new.graal.json");

...
function doubleToFloat(d) {
	...
	return new Float32Array(d);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setSkyColor(Java.to(doubleToFloat([0,0,0.9]), Java.type("float[]"))))
        .addChild(new Transform().setDEF("maskAndSnorkel")
          .addChild(new Transform()
            .addChild(new Shape().setDEF("maskFrame")
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF("frameColor").setDiffuseColor(Java.to(doubleToFloat([0,0,0]), Java.type("float[]")))))
          ...
          .addChild(new Group().setDEF("snorkel")
            .addChild(new Transform().setTranslation(Java.to(doubleToFloat([0,-0.02,0]), Java.type("float[]")))
              .addChild(new Transform().setScale(Java.to(doubleToFloat([0.9,0.9,0.9]), Java.type("float[]"))).setTranslation(Java.to(doubleToFloat([0.035,-0.07,-0.02]), Java.type("float[]")))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("snorkelTube").setDiffuseColor(Java.to(doubleToFloat([0.678,1,0.184]), Java.type("float[]"))).setTransparency(0.4)))
                  .setGeometry(new Extrusion().setCrossSection(Java.to(doubleToFloat([0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0,0.013,-0.00494,-0.01196,-0.00923,-0.00923,-0.01196,-0.00494,-0.013,0,-0.01196,0.00494,-0.00923,0.00923,-0.00494,0.01196,0,0.013]), Java.type("float[]"))).setSpine(Java.to(doubleToFloat([-0.01,-0.04,0,0,0,0,0.03,0.05,0,0.05,0.2,0,0.03,0.4,0.03]), Java.type("float[]"))))))
              .addChild(new Transform().setRotation(Java.to(doubleToFloat([0,0,1,1.57]), Java.type("float[]"))).setScale(Java.to(doubleToFloat([0.9,0.9,0.9]), Java.type("float[]"))).setTranslation(Java.to(doubleToFloat([0.01,-0.04,-0.02]), Java.type("float[]")))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setDEF("Mouthpiece").setDiffuseColor(Java.to(doubleToFloat([0.678,1,0.8]), Java.type("float[]"))).setTransparency(0.4)))
                  .setGeometry(new Extrusion().setCrossSection(Java.to(doubleToFloat([0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0,0.013,-0.00494,-0.01196,-0.00923,-0.00923,-0.01196,-0.00494,-0.013,0,-0.01196,0.00494,-0.00923,0.00923,-0.00494,0.01196,0,0.013]), Java.type("float[]"))).setSpine(Java.to(doubleToFloat([-0.01,-0.03,0,0,0,0,0.02,0.01,0]), Java.type("float[]"))))))
              .addChild(new Transform().setRotation(Java.to(doubleToFloat([0,0,1,-0.85]), Java.type("float[]"))).setScale(Java.to(doubleToFloat([0.9,0.9,0.9]), Java.type("float[]"))).setTranslation(Java.to(doubleToFloat([0.005,-0.01,-0.02]), Java.type("float[]")))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setUSE("Mouthpiece")))
                  .setGeometry(new Extrusion().setCrossSection(Java.to(doubleToFloat([0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0,0.013]), Java.type("float[]"))).setSpine(Java.to(doubleToFloat([-0.02,-0.03,0,-0.01,-0.03,0,0,-0.0175,0,0,-0.0135,0,-0.01,0,0,-0.02,0,0]), Java.type("float[]"))))))))
          .addChild(new Transform()
            .addChild(new Shape().setDEF("maskLensR")
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF("plastic").setDiffuseColor(Java.to(doubleToFloat([0.941,0.973,1]), Java.type("float[]"))).setTransparency(0.8)))
          ...
          .addChild(new Transform()
            .addChild(new Shape().setDEF("nose")
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF("plasticFit").setDiffuseColor(Java.to(doubleToFloat([0.678,1,0.184]), Java.type("float[]"))).setTransparency(0.7)))

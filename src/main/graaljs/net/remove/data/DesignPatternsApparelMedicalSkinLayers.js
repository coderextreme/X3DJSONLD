      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("MultipleHumanoids")
          ...
          .addChild(new HAnimHumanoid().setName("SimpleSkeleton").setDEF("a_SimpleSkeleton").setVersion("2.0")
            .addSkeleton(new HAnimJoint().setName("humanoid_root").setUlimit(Java.to(doubleToFloat([0,0,0]), Java.type("float[]"))).setLlimit(Java.to(doubleToFloat([0,0,0]), Java.type("float[]"))).setContainerFieldOverride("skeleton")

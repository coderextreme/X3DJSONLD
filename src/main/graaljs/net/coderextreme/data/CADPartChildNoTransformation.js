...
function doubleToFloat(d) {
	...
	return new Float32Array([d])[0];
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setSkyColor(Java.to([doubleToFloat(0.9607843),doubleToFloat(1),doubleToFloat(0.9607843)], Java.type("float[]"))))
        .addChild(new Viewpoint().setDescription("Hello CAD bushing").setOrientation(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0),doubleToFloat(-0.321751)], Java.type("float[]"))).setPosition(Java.to([doubleToFloat(0),doubleToFloat(5),doubleToFloat(15)], Java.type("float[]"))))
            ...
            .addChild(new CADFace().setName("topCap")
              .setShape(new Shape()
                .setGeometry(new IndexedTriangleSet().setIndex(Java.to([0,1,2,2,1,3,2,3,4,4,3,5,4,5,6,6,5,7,6,7,8,8,7,9,8,9,10,10,9,11,10,11,12,12,11,13,12,13,14,14,13,15,14,15,16,16,15,17,16,17,18,18,17,19,18,19,20,20,19,21,20,21,22,22,21,23,22,23,24,24,23,25,24,25,26,26,25,27,26,27,28,28,27,29,28,29,30,30,29,31,30,31,32,32,31,33,32,33,34,34,33,35,34,35,36,36,35,37,36,37,38,38,37,39,38,39,40,40,39,41,40,41,42,42,41,43,42,43,44,44,43,45,44,45,46,46,45,47,46,47,48,48,47,49,48,49,50,50,49,51,50,51,52,52,51,53,52,53,54,54,53,55,54,55,56,56,55,57,56,57,58,58,57,59,58,59,60,60,59,61,60,61,62,62,61,63,62,63,64,64,63,65], Java.type("int[]")))
                  .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(2),doubleToFloat(1.5),doubleToFloat(0),doubleToFloat(1),doubleToFloat(1.5),doubleToFloat(0),doubleToFloat(1.9616),doubleToFloat(1.5),doubleToFloat(0.3902),doubleToFloat(0.9808),doubleToFloat(1.5),doubleToFloat(0.1951),doubleToFloat(1.8478),doubleToFloat(1.5),doubleToFloat(0.7654),doubleToFloat(0.9239),doubleToFloat(1.5),doubleToFloat(0.3827),doubleToFloat(1.6629),doubleToFloat(1.5),doubleToFloat(1.1111),doubleToFloat(0.8315),doubleToFloat(1.5),doubleToFloat(0.5556),doubleToFloat(1.4142),doubleToFloat(1.5),doubleToFloat(1.4142),doubleToFloat(0.7071),doubleToFloat(1.5),doubleToFloat(0.7071),doubleToFloat(1.1111),doubleToFloat(1.5),doubleToFloat(1.6629),doubleToFloat(0.5556),doubleToFloat(1.5),doubleToFloat(0.8315),doubleToFloat(0.7654),doubleToFloat(1.5),doubleToFloat(1.8478),doubleToFloat(0.3827),doubleToFloat(1.5),doubleToFloat(0.9239),doubleToFloat(0.3902),doubleToFloat(1.5),doubleToFloat(1.9616),doubleToFloat(0.1951),doubleToFloat(1.5),doubleToFloat(0.9808),doubleToFloat(0),doubleToFloat(1.5),doubleToFloat(2),doubleToFloat(0),doubleToFloat(1.5),doubleToFloat(1),doubleToFloat(-0.3902),doubleToFloat(1.5),doubleToFloat(1.9616),doubleToFloat(-0.1951),doubleToFloat(1.5),doubleToFloat(0.9808),doubleToFloat(-0.7654),doubleToFloat(1.5),doubleToFloat(1.8478),doubleToFloat(-0.3827),doubleToFloat(1.5),doubleToFloat(0.9239),doubleToFloat(-1.1111),doubleToFloat(1.5),doubleToFloat(1.6629),doubleToFloat(-0.5556),doubleToFloat(1.5),doubleToFloat(0.8315),doubleToFloat(-1.4142),doubleToFloat(1.5),doubleToFloat(1.4142),doubleToFloat(-0.7071),doubleToFloat(1.5),doubleToFloat(0.7071),doubleToFloat(-1.6629),doubleToFloat(1.5),doubleToFloat(1.1111),doubleToFloat(-0.8315),doubleToFloat(1.5),doubleToFloat(0.5556),doubleToFloat(-1.8478),doubleToFloat(1.5),doubleToFloat(0.7654),doubleToFloat(-0.9239),doubleToFloat(1.5),doubleToFloat(0.3827),doubleToFloat(-1.9616),doubleToFloat(1.5),doubleToFloat(0.3902),doubleToFloat(-0.9808),doubleToFloat(1.5),doubleToFloat(0.1951),doubleToFloat(-2),doubleToFloat(1.5),doubleToFloat(0),doubleToFloat(-1),doubleToFloat(1.5),doubleToFloat(0),doubleToFloat(-1.9616),doubleToFloat(1.5),doubleToFloat(-0.3902),doubleToFloat(-0.9808),doubleToFloat(1.5),doubleToFloat(-0.1951),doubleToFloat(-1.8478),doubleToFloat(1.5),doubleToFloat(-0.7654),doubleToFloat(-0.9239),doubleToFloat(1.5),doubleToFloat(-0.3827),doubleToFloat(-1.6629),doubleToFloat(1.5),doubleToFloat(-1.1111),doubleToFloat(-0.8315),doubleToFloat(1.5),doubleToFloat(-0.5556),doubleToFloat(-1.4142),doubleToFloat(1.5),doubleToFloat(-1.4142),doubleToFloat(-0.7071),doubleToFloat(1.5),doubleToFloat(-0.7071),doubleToFloat(-1.1111),doubleToFloat(1.5),doubleToFloat(-1.6629),doubleToFloat(-0.5556),doubleToFloat(1.5),doubleToFloat(-0.8315),doubleToFloat(-0.7654),doubleToFloat(1.5),doubleToFloat(-1.8478),doubleToFloat(-0.3827),doubleToFloat(1.5),doubleToFloat(-0.9239),doubleToFloat(-0.3902),doubleToFloat(1.5),doubleToFloat(-1.9616),doubleToFloat(-0.1951),doubleToFloat(1.5),doubleToFloat(-0.9808),doubleToFloat(0),doubleToFloat(1.5),doubleToFloat(-2),doubleToFloat(0),doubleToFloat(1.5),doubleToFloat(-1),doubleToFloat(0.3902),doubleToFloat(1.5),doubleToFloat(-1.9616),doubleToFloat(0.1951),doubleToFloat(1.5),doubleToFloat(-0.9808),doubleToFloat(0.7654),doubleToFloat(1.5),doubleToFloat(-1.8478),doubleToFloat(0.3827),doubleToFloat(1.5),doubleToFloat(-0.9239),doubleToFloat(1.1111),doubleToFloat(1.5),doubleToFloat(-1.6629),doubleToFloat(0.5556),doubleToFloat(1.5),doubleToFloat(-0.8315),doubleToFloat(1.4142),doubleToFloat(1.5),doubleToFloat(-1.4142),doubleToFloat(0.7071),doubleToFloat(1.5),doubleToFloat(-0.7071),doubleToFloat(1.6629),doubleToFloat(1.5),doubleToFloat(-1.1111),doubleToFloat(0.8315),doubleToFloat(1.5),doubleToFloat(-0.5556),doubleToFloat(1.8478),doubleToFloat(1.5),doubleToFloat(-0.7654),doubleToFloat(0.9239),doubleToFloat(1.5),doubleToFloat(-0.3827),doubleToFloat(1.9616),doubleToFloat(1.5),doubleToFloat(-0.3902),doubleToFloat(0.9808),doubleToFloat(1.5),doubleToFloat(-0.1951),doubleToFloat(2),doubleToFloat(1.5),doubleToFloat(0),doubleToFloat(1),doubleToFloat(1.5),doubleToFloat(0)], Java.type("float[]")))))
                .setAppearance(new Appearance().setUSE("AppearanceGrey"))))

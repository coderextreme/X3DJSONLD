	...
	return new Float32Array([d])[0];
      ...
      .setScene(new Scene()
        ...
        .addChild(new Collision().setDEF("DoNotCollideWithVisualizationWidget")
            ...
            .addChild(new Group().setDEF("ArrowGreen")
              .addChild(new Shape()
                ...
                .setAppearance(new Appearance().setDEF("Green")
                  .setMaterial(new Material().setDiffuseColor(Java.to([doubleToFloat(0.1),doubleToFloat(0.6),doubleToFloat(0.1)], Java.type("float[]"))).setEmissiveColor(Java.to([doubleToFloat(0.05),doubleToFloat(0.2),doubleToFloat(0.05)], Java.type("float[]"))))))
          ...
          .addChild(new Transform().setRotation(Java.to([doubleToFloat(0),doubleToFloat(0),doubleToFloat(1),doubleToFloat(-1.57079)], Java.type("float[]")))
              ...
              .addChild(new Group().setDEF("ArrowRed")
                .addChild(new Shape()
                  ...
                  .setAppearance(new Appearance().setDEF("Red")
                    .setMaterial(new Material().setDiffuseColor(Java.to([doubleToFloat(0.7),doubleToFloat(0.1),doubleToFloat(0.1)], Java.type("float[]"))).setEmissiveColor(Java.to([doubleToFloat(0.33),doubleToFloat(0),doubleToFloat(0)], Java.type("float[]"))))))
                .addChild(new Transform().setTranslation(Java.to([doubleToFloat(0),doubleToFloat(1),doubleToFloat(0)], Java.type("float[]")))
                  .addChild(new Shape()
                    .setGeometry(new Cone().setUSE("ArrowCone"))
                    .setAppearance(new Appearance().setUSE("Red")))))
              .addChild(new Transform().setRotation(Java.to([doubleToFloat(0),doubleToFloat(0),doubleToFloat(1),doubleToFloat(1.57079)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(0.072),doubleToFloat(1.1),doubleToFloat(0)], Java.type("float[]")))
          ...
          .addChild(new Transform().setRotation(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0),doubleToFloat(1.57079)], Java.type("float[]")))
              ...
              .addChild(new Group().setDEF("ArrowBlue")
                .addChild(new Shape()
                  ...
                  .setAppearance(new Appearance().setDEF("Blue")
                    .setMaterial(new Material().setDiffuseColor(Java.to([doubleToFloat(0.3),doubleToFloat(0.3),doubleToFloat(1)], Java.type("float[]"))).setEmissiveColor(Java.to([doubleToFloat(0.1),doubleToFloat(0.1),doubleToFloat(0.33)], Java.type("float[]"))))))
                .addChild(new Transform().setTranslation(Java.to([doubleToFloat(0),doubleToFloat(1),doubleToFloat(0)], Java.type("float[]")))
                  .addChild(new Shape()
                    .setGeometry(new Cone().setUSE("ArrowCone"))
                    .setAppearance(new Appearance().setUSE("Blue")))))
              .addChild(new Transform().setRotation(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0),doubleToFloat(-1.57079)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(0),doubleToFloat(1.1),doubleToFloat(0.072)], Java.type("float[]")))
                .addComments(new CommentsBlock("note label rotated back to original coordinate frame"))
                .addChild(new Billboard()
                  .addChild(new Shape()
                    .setAppearance(new Appearance().setUSE("LABEL_APPEARANCE"))

...
function doubleToFloat(d) {
      ...
      .setScene(new Scene()
        ...
        .addLayerSet(new LayerSet().setActiveLayer(1).setOrder(Java.to([1,2], Java.type("int[]")))
          ...
          .addLayers(new LayoutLayer()
            ...
            .setLayout(new Layout().setAlign(Java.to(["RIGHT","BOTTOM"], Java.type("java.lang.String[]"))).setOffset(Java.to([doubleToFloat(0),doubleToFloat(0.2)], Java.type("float[]"))).setOffsetUnits(Java.to(["WORLD","WORLD"], Java.type("java.lang.String[]"))).setScaleMode(Java.to(["NONE","NONE"], Java.type("java.lang.String[]"))).setSize(Java.to([doubleToFloat(0.4),doubleToFloat(0.6)], Java.type("float[]"))).setSizeUnits(Java.to(["WORLD","WORLD"], Java.type("java.lang.String[]"))))
    ...
    X3D0.toFileJSON("../data/bumpyx_itesliders.new.graal.json");

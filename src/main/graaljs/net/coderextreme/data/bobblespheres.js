          ...
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new PhysicalMaterial().setTransmissionFactor("0.95").setRoughness(0.05)
                .addExtensions(new IORMaterialExtension().setDEF("IOR_2").setIndexOfRefraction(1.5))))
            .setGeometry(new Sphere().setRadius(0.2))))
          ...
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new PhysicalMaterial().setTransmissionFactor("0.95").setRoughness(0.05).setIndexOfRefraction("1.33")
                .addExtensions(new IridescenceMaterialExtension().setDEF("IRI_3").setIridescence(1).setIridescenceIndexOfRefraction(1.3).setIridescenceThicknessMinimum(100))))
            .setGeometry(new Sphere().setRadius(0.2))))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group()
          .addChild(new Transform().setTranslation(Java.to([6.14221f,0.0694613f,-0.000999451f], Java.type("float[]")))
            .addChild(new Shape()
              ...
              .setGeometry(new Box())))
          .addChild(new Transform().setTranslation(Java.to([-4.85443f,0.0694381f,-0.00149918f], Java.type("float[]")))
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new PixelTexture().setUSE("RgbOpacityCheckerboard")))
              .setGeometry(new Sphere())))
          .addChild(new Transform().setTranslation(Java.to([-1.47341f,0.036672f,-0.00175095f], Java.type("float[]")))
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new PixelTexture().setUSE("RgbOpacityCheckerboard")))
              .setGeometry(new Cone())))
          .addChild(new Transform().setTranslation(Java.to([2.31094f,0.0694206f,-0.00187683f], Java.type("float[]")))
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new PixelTexture().setUSE("RgbOpacityCheckerboard")))

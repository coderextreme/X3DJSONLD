        ...
        .addChild(new Transform().setScale(Java.to([doubleToFloat(10),doubleToFloat(10),doubleToFloat(1)], Java.type("float[]"))).setRotation(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0),doubleToFloat(3.14)], Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(Java.to([doubleToFloat(0.8),doubleToFloat(0.5),doubleToFloat(0.5)], Java.type("float[]"))))
              .setTexture(new ImageTexture().setUrl(Java.to(["./face1.jpg"], Java.type("java.lang.String[]")))))
            .setGeometry(new Sphere()))))      ;
    X3D0.toFileX3D("../data/smiley1.new.graal.x3d");
    X3D0.toFileJSON("../data/smiley1.new.graal.json");

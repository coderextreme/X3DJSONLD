...
var ProtoInstance2 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new ProtoDeclare().setName("cyl")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType(field.TYPE_SFVEC3F).setName("positionA").setAccessType(field.ACCESSTYPE_INPUTOUTPUT))
            .addField(new field().setType(field.TYPE_SFVEC3F).setName("positionB").setAccessType(field.ACCESSTYPE_INPUTOUTPUT)))
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Shape()
...
ProtoInstance1
            .addFieldValue(new fieldValue().setName("position").setValue("50 50 50"));
    X3D0.toFileX3D("../data/fors2.new.graal.x3d");
    X3D0.toFileJSON("../data/fors2.new.graal.json");

...
var ProtoInstance9 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("Rubiks Cube on Fire").setPosition(Java.to([0f,0f,12f], Java.type("float[]"))))
...
ProtoInstance9
          .addFieldValue(new fieldValue().setName("myShape")
            .addChild(new Box().setDEF("_4").setSize(Java.to([1f,1f,1f], Java.type("float[]")))));

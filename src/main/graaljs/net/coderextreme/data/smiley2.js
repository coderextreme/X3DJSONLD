...
function doubleToFloat(d) {
	...
	return new Float32Array(d);
      ...
      .setHead(new head())
      .setScene(new Scene()
        .addChild(new Transform().setScale(Java.to(doubleToFloat([10,10,1]), Java.type("float[]"))).setRotation(Java.to(doubleToFloat([1,0,0,3.14]), Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(Java.to(doubleToFloat([0.5,0.8,0.5]), Java.type("float[]"))))

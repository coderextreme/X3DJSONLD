...
function doubleToFloat(d) {
	...
	return new Float32Array([d])[0];
      ...
      var X3D0 =  new X3D().setProfile("Interchange")
      .setHead(new head())
      .setScene(new Scene()
        .addChild(new Transform().setScale(Java.to([doubleToFloat(10),doubleToFloat(10),doubleToFloat(1)], Java.type("float[]"))).setRotation(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0),doubleToFloat(3.14)], Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(Java.to([doubleToFloat(0.5),doubleToFloat(0.8),doubleToFloat(0.5)], Java.type("float[]"))))
              .setTexture(new ImageTexture().setUrl(Java.to(["./face2.jpg"], Java.type("java.lang.String[]")))))
            .setGeometry(new Sphere()))))      ;
    X3D0.toFileX3D("../data/smiley2.new.graal.x3d");
    X3D0.toFileJSON("../data/smiley2.new.graal.json");

        ...
        .addChild(new ProtoDeclare().setName("LOA1_StandAnimation")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              ...
              .addChild(new OrientationInterpolator().setDEF("SKULLBASE_ANIMATOR").setKey(Java.to(doubleToFloat([0,0.5,1]), Java.type("float[]"))).setKeyValue(Java.to(doubleToFloat([0,0,1,0,-1,0,0,0.5,0,0,1,0]), Java.type("float[]")))
                .setIS(new IS()

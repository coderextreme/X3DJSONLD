        ...
        .addChild(new HAnimHumanoid().setName("Foot_Left").setDEF("hanim_Foot_Left").setLoa(4).setVersion("2.0")
          ...
          .addSkeleton(new HAnimJoint("hanim_Foot_Left").setName("humanoid_root").setDEF("hanim_humanoid_root").setContainerFieldOverride("skeleton")
            ...
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("l_talocrural").setDEF("hanim_l_talocrural").setDescription("connection joint of foot to leg above")
              ...
              .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_talocalcaneonavicular").setDEF("hanim_l_talocalcaneonavicular").setCenter(Java.to(doubleToFloat([0,-0.3,0]), Java.type("float[]")))
                ...
                .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_1").setDEF("hanim_l_cuneonavicular_1").setCenter(Java.to(doubleToFloat([-0.1,-0.45,0]), Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_cuneonavicular_1").setName("l_tarsometatarsal_1").setDEF("hanim_l_tarsometatarsal_1").setCenter(Java.to(doubleToFloat([-0.1,-0.6,0]), Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_1").setName("l_metatarsophalangeal_1").setDEF("hanim_l_metatarsophalangeal_1").setCenter(Java.to(doubleToFloat([-0.1,-0.9,0]), Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_1").setName("l_tarsal_interphalangeal_1").setDEF("hanim_l_tarsal_interphalangeal_1").setCenter(Java.to(doubleToFloat([-0.1,-1.05,0]), Java.type("float[]")))
                ...
                .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_2").setDEF("hanim_l_cuneonavicular_2").setCenter(Java.to(doubleToFloat([0,-0.45,0]), Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_cuneonavicular_2").setName("l_tarsometatarsal_2").setDEF("hanim_l_tarsometatarsal_2").setCenter(Java.to(doubleToFloat([0.05,-0.6,0]), Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(Java.to(doubleToFloat([0.05,-0.9,0]), Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_tarsal_proximal_interphalangeal_2").setDEF("hanim_l_tarsal_proximal_interphalangeal_2").setCenter(Java.to(doubleToFloat([0.05,-1.05,0]), Java.type("float[]")))
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setCenter(Java.to(doubleToFloat([0.05,-1.12,0]), Java.type("float[]")))
                ...
                .addChild(new HAnimJoint("hanim_l_talocalcaneonavicular").setName("l_cuneonavicular_3").setDEF("hanim_l_cuneonavicular_3").setCenter(Java.to(doubleToFloat([0.1,-0.4,0]), Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_cuneonavicular_3").setName("l_tarsometatarsal_3").setDEF("hanim_l_tarsometatarsal_3").setCenter(Java.to(doubleToFloat([0.15,-0.6,0]), Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_3").setName("l_metatarsophalangeal_3").setDEF("hanim_l_metatarsophalangeal_3").setCenter(Java.to(doubleToFloat([0.15,-0.9,0]), Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_3").setName("l_tarsal_proximal_interphalangeal_3").setDEF("hanim_l_tarsal_proximal_interphalangeal_3").setCenter(Java.to(doubleToFloat([0.15,-1.05,0]), Java.type("float[]")))
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setDEF("hanim_l_tarsal_distal_interphalangeal_3").setCenter(Java.to(doubleToFloat([0.15,-1.13,0]), Java.type("float[]")))
              ...
              .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_calcaneocuboid").setDEF("hanim_l_calcaneocuboid").setCenter(Java.to(doubleToFloat([0.2,0.3,0]), Java.type("float[]")))
                ...
                .addChild(new HAnimJoint("hanim_l_calcaneocuboid").setName("l_transversetarsal").setDEF("hanim_l_transversetarsal").setCenter(Java.to(doubleToFloat([0.21,-0.3,0]), Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_4").setDEF("hanim_l_tarsometatarsal_4").setCenter(Java.to(doubleToFloat([0.25,-0.58,0]), Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_4").setName("l_metatarsophalangeal_4").setDEF("hanim_l_metatarsophalangeal_4").setCenter(Java.to(doubleToFloat([0.25,-0.87,0]), Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_4").setName("l_tarsal_proximal_interphalangeal_4").setDEF("hanim_l_tarsal_proximal_interphalangeal_4").setCenter(Java.to(doubleToFloat([0.25,-1,0]), Java.type("float[]")))
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setDEF("hanim_l_tarsal_distal_interphalangeal_4").setCenter(Java.to(doubleToFloat([0.25,-1.1,0]), Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_transversetarsal").setName("l_tarsometatarsal_5").setDEF("hanim_l_tarsometatarsal_5").setCenter(Java.to(doubleToFloat([0.33,-0.52,0]), Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint("hanim_l_tarsometatarsal_5").setName("l_metatarsophalangeal_5").setDEF("hanim_l_metatarsophalangeal_5").setCenter(Java.to(doubleToFloat([0.34,-0.8,0]), Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_5").setName("l_tarsal_proximal_interphalangeal_5").setDEF("hanim_l_tarsal_proximal_interphalangeal_5").setCenter(Java.to(doubleToFloat([0.34,-0.95,0]), Java.type("float[]")))
                        ...
                        .addChild(new HAnimJoint("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setDEF("hanim_l_tarsal_distal_interphalangeal_5").setCenter(Java.to(doubleToFloat([0.34,-1.05,0]), Java.type("float[]")))

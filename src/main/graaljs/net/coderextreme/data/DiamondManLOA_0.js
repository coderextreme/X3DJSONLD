...
function doubleToFloat(d) {
	...
	return new Float32Array(d);
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setDEF("hanim_humanoid").setName("humanoid").setVersion("1.0")
          ...
          .addSkeleton(new HAnimJoint("hanim_humanoid").setContainerFieldOverride("skeleton").setDEF("hanim_HumanoidRoot").setName("humanoid_root").setCenter(Java.to(doubleToFloat([0,0.824,0.0277]), Java.type("float[]")))
            .addChild(new HAnimJoint("hanim_HumanoidRoot").setDEF("hanim_sacroiliac").setName("sacroiliac").setCenter(Java.to(doubleToFloat([0,0.9149,0.0016]), Java.type("float[]")))
          ...
          .addJoints(new HAnimJoint("hanim_humanoid").setContainerFieldOverride("joints").setUSE("hanim_HumanoidRoot"))
          ...
          .addViewpoints(new HAnimSite("hanim_humanoid").setContainerFieldOverride("viewpoints").setDEF("hanim_site_view").setName("site_view")
    ...
    X3D0.toFileX3D("../data/DiamondManLOA_0.new.graal.x3d");
    X3D0.toFileJSON("../data/DiamondManLOA_0.new.graal.json");

      ...
      .setScene(new Scene()
        .addChild(new Shape()
          .setAppearance(new Appearance()
            .setMaterial(new Material().setAmbientIntensity(0.01).setDiffuseColor(Java.to(doubleToFloat([1,1,1]), Java.type("float[]"))).setShininess(0.05)))

...
ProtoInstance0
          .addFieldValue(new fieldValue().setName("children")
            .addChild(new HAnimJoint().setName("l_shoulder").setDEF("PoseJoint_l_shoulder_1").setDescription("left shoulder").setRotation(Java.to(doubleToFloat([0,0,1,1.57]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("r_shoulder").setDEF("PoseJoint_r_shoulder_1").setDescription("right shoulder").setRotation(Java.to(doubleToFloat([0,0,-1,1.57]), Java.type("float[]"))))
...
ProtoInstance1
          .addFieldValue(new fieldValue().setName("children")
            .addChild(new HAnimJoint().setName("l_shoulder").setDEF("PoseJoint_l_shoulder").setDescription("left shoulder").setRotation(Java.to(doubleToFloat([0,0,1,0.5]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("r_shoulder").setDEF("PoseJoint_r_shoulder").setDescription("right shoulder").setRotation(Java.to(doubleToFloat([0,0,-1,0.5]), Java.type("float[]")))));
ProtoInstance1
...
ProtoInstance2
          .addFieldValue(new fieldValue().setName("children")
            .addChild(new HAnimJoint().setName("humanoid_root").setRotation(Java.to(doubleToFloat([0,1,0,-0.698132]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("l_hip").setRotation(Java.to(doubleToFloat([-1,1,1,1]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("l_knee").setRotation(Java.to(doubleToFloat([1,0,0,1]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("l_talocrural").setRotation(Java.to(doubleToFloat([-0.2,0,0.1,0.225]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("r_hip").setRotation(Java.to(doubleToFloat([-1,-1,-1,1]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("r_knee").setRotation(Java.to(doubleToFloat([1,0,0,1]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("r_talocrural").setRotation(Java.to(doubleToFloat([-0.2,0,0.1,0.25]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("vl5").setRotation(Java.to(doubleToFloat([0,0,0.01,0.2]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("vt10").setRotation(Java.to(doubleToFloat([0,0,0.01,0.1]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("vc4").setRotation(Java.to(doubleToFloat([0,0,-0.01,0.15]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("l_shoulder").setRotation(Java.to(doubleToFloat([-1,0.5,1,2]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("l_elbow").setRotation(Java.to(doubleToFloat([-1,0,0,1]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("l_radiocarpal"))
            .addChild(new HAnimJoint().setName("r_shoulder").setRotation(Java.to(doubleToFloat([-1,-0.5,-1,2.6]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("r_elbow").setRotation(Java.to(doubleToFloat([-1,0,0,1]), Java.type("float[]"))))
            .addChild(new HAnimJoint().setName("r_radiocarpal")));
ProtoInstance2
          .addFieldValue(new fieldValue().setName("transitionDuration").setValue("1.2"));
ProtoInstance2
          .addFieldValue(new fieldValue().setName("traceEnabled").setValue("true"));
...
ProtoInstance5
          .addFieldValue(new fieldValue().setName("children")
            .addChild(new HAnimJoint().setName("humanoid_root").setDEF("FaceLeft_humanoid_root").setDescription("Only rotate the model").setRotation(Java.to(doubleToFloat([0,1,0,1.570796]), Java.type("float[]")))));
ProtoInstance5
...
ProtoInstance6
          .addFieldValue(new fieldValue().setName("children")
            .addChild(new HAnimJoint().setName("humanoid_root").setDEF("FaceRight_humanoid_root").setDescription("Only rotate the model").setRotation(Java.to(doubleToFloat([0,1,0,-1.570796]), Java.type("float[]")))));
ProtoInstance6
          .addFieldValue(new fieldValue().setName("transitionDuration").setValue("1.1"));
ProtoInstance6
          .addFieldValue(new fieldValue().setName("traceEnabled").setValue("true"));

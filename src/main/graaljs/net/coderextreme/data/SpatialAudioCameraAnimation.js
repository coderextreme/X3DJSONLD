...
function doubleToFloat(d) {
	...
	return new Float32Array([d])[0];
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDEF("Camera001").setDescription("Viewpoint is like camera, prepositioned in locations (and directions) of interest. In this example the camera is the \"ears of the user\". So, if the trackCurrentView field from ListenerPointSource is TRUE then position and orientation matches the users current view").setOrientation(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0),doubleToFloat(-0.523599)], Java.type("float[]"))).setPosition(Java.to([doubleToFloat(0),doubleToFloat(2000),doubleToFloat(3500)], Java.type("float[]"))))
        .addChild(new TimeSensor().setDEF("TIMER").setCycleInterval(33.333332).setLoop(true))
        .addChild(new PositionInterpolator().setDEF("Camera001-POS-INTERP").setKey(Java.to([doubleToFloat(0),doubleToFloat(0.25),doubleToFloat(0.5),doubleToFloat(0.75),doubleToFloat(1)], Java.type("float[]"))).setKeyValue(Java.to([doubleToFloat(0),doubleToFloat(2000),doubleToFloat(3500),doubleToFloat(0),doubleToFloat(2000),doubleToFloat(0),doubleToFloat(0),doubleToFloat(2000),doubleToFloat(-3500),doubleToFloat(0),doubleToFloat(2000),doubleToFloat(0),doubleToFloat(0),doubleToFloat(2000),doubleToFloat(3500)], Java.type("float[]"))))
        .addChild(new OrientationInterpolator().setDEF("Camera001-ROT-INTERP").setKey(Java.to([doubleToFloat(0),doubleToFloat(0.25),doubleToFloat(0.5),doubleToFloat(0.75),doubleToFloat(1)], Java.type("float[]"))).setKeyValue(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0),doubleToFloat(-0.523599),doubleToFloat(0.99999),doubleToFloat(0.003554),doubleToFloat(0.002727),doubleToFloat(-1.309007),doubleToFloat(0),doubleToFloat(-0.965926),doubleToFloat(-0.258819),doubleToFloat(-3.141593),doubleToFloat(0.002282),doubleToFloat(-0.793351),doubleToFloat(-0.60876),doubleToFloat(-3.135645),doubleToFloat(1),doubleToFloat(-0.000001),doubleToFloat(0),doubleToFloat(-0.523599)], Java.type("float[]"))))
        ...
        .addChild(new Transform().setDEF("Floor").setTranslation(Java.to([doubleToFloat(1.241),doubleToFloat(0),doubleToFloat(0.358)], Java.type("float[]")))
          .addChild(new Shape()
            ...
            .setGeometry(new Box().setSize(Java.to([doubleToFloat(2000),doubleToFloat(1),doubleToFloat(2000)], Java.type("float[]"))))))
        .addChild(new Transform().setDEF("TransformAudio1").setTranslation(Java.to([doubleToFloat(-933.123474),doubleToFloat(0),doubleToFloat(-926.253235)], Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("WireColor_1")
              .setMaterial(new Material().setDiffuseColor(Java.to([doubleToFloat(0.690196),doubleToFloat(0.101961),doubleToFloat(0.101961)], Java.type("float[]")))))
            .setGeometry(new Sphere().setRadius(100)))
          .addChild(new Billboard()
            .addChild(new Transform().setDEF("violin").setRotation(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0),doubleToFloat(-0.5)], Java.type("float[]"))).setScale(Java.to([doubleToFloat(100),doubleToFloat(100),doubleToFloat(100)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(0),doubleToFloat(100),doubleToFloat(0)], Java.type("float[]")))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.0933).setDiffuseColor(Java.to([doubleToFloat(1),doubleToFloat(1),doubleToFloat(1)], Java.type("float[]"))).setShininess(0.51).setSpecularColor(Java.to([doubleToFloat(0.46),doubleToFloat(0.46),doubleToFloat(0.46)], Java.type("float[]")))))
        ...
        .addChild(new Transform().setDEF("TransformAudio2").setTranslation(Java.to([doubleToFloat(933.475586),doubleToFloat(0),doubleToFloat(924.423218)], Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("WireColor_2")
              .setMaterial(new Material().setDiffuseColor(Java.to([doubleToFloat(0.105882),doubleToFloat(0.694118),doubleToFloat(0.580392)], Java.type("float[]")))))
            .setGeometry(new Sphere().setRadius(100)))
          .addChild(new Billboard()
            .addChild(new Transform().setDEF("saxophone").setRotation(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0),doubleToFloat(-0.5)], Java.type("float[]"))).setScale(Java.to([doubleToFloat(100),doubleToFloat(100),doubleToFloat(100)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(0),doubleToFloat(100),doubleToFloat(0)], Java.type("float[]")))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.0933).setDiffuseColor(Java.to([doubleToFloat(1),doubleToFloat(1),doubleToFloat(1)], Java.type("float[]"))).setShininess(0.51).setSpecularColor(Java.to([doubleToFloat(0.46),doubleToFloat(0.46),doubleToFloat(0.46)], Java.type("float[]")))))

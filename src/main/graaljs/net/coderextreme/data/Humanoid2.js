          ...
          .addSkeleton(new HAnimJoint("hanim_HAnim").setName("humanoid_root").setDEF("hanim_humanoid_root").setCenter(Java.to([doubleToFloat(0),doubleToFloat(0.824),doubleToFloat(0.0277)], Java.type("float[]"))).setContainerFieldOverride("skeleton")
                ...
                .addChild(new HAnimJoint("hanim_l_hip").setName("l_knee").setDEF("hanim_l_knee").setCenter(Java.to([doubleToFloat(0.104),doubleToFloat(0.4867),doubleToFloat(0.0308)], Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint("hanim_l_knee").setName("l_talocrural").setDEF("hanim_l_talocrural").setCenter(Java.to([doubleToFloat(0.1101),doubleToFloat(0.0656),doubleToFloat(-0.0736)], Java.type("float[]")))
                    .addChild(new HAnimSegment("hanim_l_talocrural").setName("l_talus").setDEF("hanim_l_talus")
                      ...
                      .addChild(new Shape()
                        .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                          .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.1101),doubleToFloat(0.0656),doubleToFloat(-0.0736),doubleToFloat(0.08),doubleToFloat(0.0175),doubleToFloat(-0.0608)], Java.type("float[]"))))
                          .addComments(new CommentsBlock("from l_talocrural to l_tarsometatarsal_2 vertices 2"))
                          .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                    .addChild(new HAnimJoint("hanim_l_talocrural").setName("l_tarsometatarsal_2").setDEF("hanim_l_tarsometatarsal_2").setCenter(Java.to([doubleToFloat(0.08),doubleToFloat(0.0175),doubleToFloat(-0.0608)], Java.type("float[]")))
                      .addChild(new HAnimSegment("hanim_l_tarsometatarsal_2").setName("l_metatarsal_2").setDEF("hanim_l_metatarsal_2")
                        ...
                        .addChild(new HAnimSite("hanim_l_metatarsal_2").setName("l_tarsal_distal_phalanx_1_tip").setDEF("hanim_l_tarsal_distal_phalanx_1_tip")
                          ...
                          .addChild(new Shape().setUSE("HAnimSiteShape")))
                        .addChild(new HAnimSite("hanim_l_metatarsal_2").setName("l_tarsal_distal_phalanx_2_tip").setDEF("hanim_l_tarsal_distal_phalanx_2_tip").setTranslation(Java.to([doubleToFloat(0.1195),doubleToFloat(0.0079),doubleToFloat(0.1433)], Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint("hanim_l_tarsometatarsal_2").setName("l_metatarsophalangeal_2").setDEF("hanim_l_metatarsophalangeal_2").setCenter(Java.to([doubleToFloat(0.0824),doubleToFloat(0.0064),doubleToFloat(-0.004)], Java.type("float[]")))
                        .addChild(new HAnimSegment("hanim_l_metatarsophalangeal_2").setName("l_tarsal_proximal_phalanx_2").setDEF("hanim_l_tarsal_proximal_phalanx_2")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                              .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.0824),doubleToFloat(0.0064),doubleToFloat(-0.004),doubleToFloat(0.0841),doubleToFloat(0.0013),doubleToFloat(0.0216)], Java.type("float[]"))))
                              .addComments(new CommentsBlock("from l_metatarsophalangeal_2 to l_tarsal_distal_interphalangeal_2 vertices 2"))
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint("hanim_l_metatarsophalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setDEF("hanim_l_tarsal_distal_interphalangeal_2").setCenter(Java.to([doubleToFloat(0.0841),doubleToFloat(0.0013),doubleToFloat(0.0216)], Java.type("float[]")))))))))
                ...
                .addChild(new HAnimJoint("hanim_r_hip").setName("r_knee").setDEF("hanim_r_knee").setCenter(Java.to([doubleToFloat(-0.0867),doubleToFloat(0.4913),doubleToFloat(0.0318)], Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint("hanim_r_knee").setName("r_talocrural").setDEF("hanim_r_talocrural").setCenter(Java.to([doubleToFloat(-0.0801),doubleToFloat(0.0712),doubleToFloat(-0.0766)], Java.type("float[]")))
                    .addChild(new HAnimSegment("hanim_r_talocrural").setName("r_talus").setDEF("hanim_r_talus")
                      ...
                      .addChild(new Shape()
                        .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                          .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(-0.0801),doubleToFloat(0.0712),doubleToFloat(-0.0766),doubleToFloat(-0.08),doubleToFloat(0.0175),doubleToFloat(-0.0608)], Java.type("float[]"))))
                          .addComments(new CommentsBlock("from r_talocrural to r_tarsometatarsal_2 vertices 2"))
                          .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                    .addChild(new HAnimJoint("hanim_r_talocrural").setName("r_tarsometatarsal_2").setDEF("hanim_r_tarsometatarsal_2").setCenter(Java.to([doubleToFloat(-0.08),doubleToFloat(0.0175),doubleToFloat(-0.0608)], Java.type("float[]")))
                      .addChild(new HAnimSegment("hanim_r_tarsometatarsal_2").setName("r_metatarsal_2").setDEF("hanim_r_metatarsal_2")
                        ...
                        .addChild(new HAnimSite("hanim_r_metatarsal_2").setName("r_tarsal_distal_phalanx_1_tip").setDEF("hanim_r_tarsal_distal_phalanx_1_tip")
                          ...
                          .addChild(new Shape().setUSE("HAnimSiteShape")))
                        .addChild(new HAnimSite("hanim_r_metatarsal_2").setName("r_tarsal_distal_phalanx_2_tip").setDEF("hanim_r_tarsal_distal_phalanx_2_tip").setTranslation(Java.to([doubleToFloat(-0.0883),doubleToFloat(0.0134),doubleToFloat(0.1383)], Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint("hanim_r_tarsometatarsal_2").setName("r_metatarsophalangeal_2").setDEF("hanim_r_metatarsophalangeal_2").setCenter(Java.to([doubleToFloat(-0.0823),doubleToFloat(0.0064),doubleToFloat(-0.004)], Java.type("float[]")))
                        .addChild(new HAnimSegment("hanim_r_metatarsophalangeal_2").setName("r_tarsal_proximal_phalanx_2").setDEF("hanim_r_tarsal_proximal_phalanx_2")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                              .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(-0.0823),doubleToFloat(0.0064),doubleToFloat(-0.004),doubleToFloat(-0.0841),doubleToFloat(0.0013),doubleToFloat(0.0216)], Java.type("float[]"))))
                              .addComments(new CommentsBlock("from r_metatarsophalangeal_2 to r_tarsal_distal_interphalangeal_2 vertices 2"))
                              .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                        .addChild(new HAnimJoint("hanim_r_metatarsophalangeal_2").setName("r_tarsal_distal_interphalangeal_2").setDEF("hanim_r_tarsal_distal_interphalangeal_2").setCenter(Java.to([doubleToFloat(-0.0841),doubleToFloat(0.0013),doubleToFloat(0.0216)], Java.type("float[]"))))))))))
            .addChild(new HAnimJoint("hanim_humanoid_root").setName("vl5").setDEF("hanim_vl5").setCenter(Java.to([doubleToFloat(0.0028),doubleToFloat(1.0568),doubleToFloat(-0.0776)], Java.type("float[]")))
              .addChild(new HAnimSegment("hanim_vl5").setName("l5").setDEF("hanim_l5")
                ...
                .addChild(new Shape()
                  .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                    .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.0028),doubleToFloat(1.0568),doubleToFloat(-0.0776),doubleToFloat(0.0041),doubleToFloat(1.1276),doubleToFloat(-0.0796)], Java.type("float[]"))))
                    .addComments(new CommentsBlock("from vl5 to vl3 vertices 2"))
                    .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                .addChild(new HAnimSite("hanim_l5").setName("l_rib10").setDEF("hanim_l_rib10").setTranslation(Java.to([doubleToFloat(0.0871),doubleToFloat(1.1925),doubleToFloat(0.0992)], Java.type("float[]")))
                  .addChild(new TouchSensor().setDescription("HAnimSite l_rib10"))
                  .addChild(new Shape().setUSE("HAnimSiteShape")))
                .addChild(new HAnimSite("hanim_l5").setName("r_rib10").setDEF("hanim_r_rib10").setTranslation(Java.to([doubleToFloat(-0.0711),doubleToFloat(1.1941),doubleToFloat(0.1016)], Java.type("float[]")))
                ...
                .addChild(new HAnimSite("hanim_l5").setName("spine_2_middle_back").setDEF("hanim_spine_2_middle_back")
                  ...
                  .addChild(new Shape().setUSE("HAnimSiteShape"))))
              .addChild(new HAnimJoint("hanim_vl5").setName("vl3").setDEF("hanim_vl3").setCenter(Java.to([doubleToFloat(0.0041),doubleToFloat(1.1276),doubleToFloat(-0.0796)], Java.type("float[]")))
                .addChild(new HAnimSegment("hanim_vl3").setName("l3").setDEF("hanim_l3")
                  ...
                  .addChild(new Shape()
                    .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                      .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.0041),doubleToFloat(1.1276),doubleToFloat(-0.0796),doubleToFloat(0.0048),doubleToFloat(1.1912),doubleToFloat(-0.0805)], Java.type("float[]"))))
                      .addComments(new CommentsBlock("from vl3 to vl1 vertices 2"))
                      .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA")))))
                .addChild(new HAnimJoint("hanim_vl3").setName("vl1").setDEF("hanim_vl1").setCenter(Java.to([doubleToFloat(0.0048),doubleToFloat(1.1912),doubleToFloat(-0.0805)], Java.type("float[]")))
                  .addChild(new HAnimSegment("hanim_vl1").setName("l1").setDEF("hanim_l1")
                    ...
                    .addChild(new Shape()
                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.0048),doubleToFloat(1.1912),doubleToFloat(-0.0805),doubleToFloat(0.0056),doubleToFloat(1.2848),doubleToFloat(-0.0822)], Java.type("float[]"))))
                        .addComments(new CommentsBlock("from vl1 to vt10 vertices 2"))
                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                    .addChild(new HAnimSite("hanim_l1").setName("l_thelion").setDEF("hanim_l_thelion").setTranslation(Java.to([doubleToFloat(0.0918),doubleToFloat(1.3382),doubleToFloat(0.1192)], Java.type("float[]")))
                      .addChild(new TouchSensor().setDescription("HAnimSite l_thelion"))
                      .addChild(new Shape().setUSE("HAnimSiteShape")))
                    .addChild(new HAnimSite("hanim_l1").setName("r_thelion").setDEF("hanim_r_thelion").setTranslation(Java.to([doubleToFloat(-0.0736),doubleToFloat(1.3385),doubleToFloat(0.1217)], Java.type("float[]")))
                      .addChild(new TouchSensor().setDescription("HAnimSite r_thelion"))
                      .addChild(new Shape().setUSE("HAnimSiteShape")))
                    .addChild(new HAnimSite("hanim_l1").setName("substernale").setDEF("hanim_substernale").setTranslation(Java.to([doubleToFloat(0.0085),doubleToFloat(1.2995),doubleToFloat(0.1147)], Java.type("float[]")))
                      .addChild(new TouchSensor().setDescription("HAnimSite substernale"))
                      .addChild(new Shape().setUSE("HAnimSiteShape"))))
                  .addChild(new HAnimJoint("hanim_vl1").setName("vt10").setDEF("hanim_vt10").setCenter(Java.to([doubleToFloat(0.0056),doubleToFloat(1.2848),doubleToFloat(-0.0822)], Java.type("float[]")))
                    .addChild(new HAnimSegment("hanim_vt10").setName("t10").setDEF("hanim_t10")
                      ...
                      .addChild(new Shape()
                        .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                          .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.0056),doubleToFloat(1.2848),doubleToFloat(-0.0822),doubleToFloat(0.0059),doubleToFloat(1.3866),doubleToFloat(-0.08)], Java.type("float[]"))))
                      ...
                      .addChild(new HAnimSite("hanim_t10").setName("rear_center_midsagittal_plane").setDEF("hanim_rear_center_midsagittal_plane")
                        ...
                        .addChild(new Shape().setUSE("HAnimSiteShape"))))
                    .addChild(new HAnimJoint("hanim_vt10").setName("vt6").setDEF("hanim_vt6").setCenter(Java.to([doubleToFloat(0.0059),doubleToFloat(1.3866),doubleToFloat(-0.08)], Java.type("float[]")))
                      .addChild(new HAnimSegment("hanim_vt6").setName("t6").setDEF("hanim_t6")
                        ...
                        .addChild(new Shape()
                          .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                            .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.0059),doubleToFloat(1.3866),doubleToFloat(-0.08),doubleToFloat(0.0065),doubleToFloat(1.4951),doubleToFloat(-0.0387)], Java.type("float[]"))))
                            .addComments(new CommentsBlock("from vt6 to vt1 vertices 2"))
                            .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                        .addChild(new HAnimSite("hanim_t6").setName("cervicale").setDEF("hanim_cervicale").setTranslation(Java.to([doubleToFloat(0.0064),doubleToFloat(1.52),doubleToFloat(-0.0815)], Java.type("float[]")))
                          .addChild(new TouchSensor().setDescription("HAnimSite cervicale"))
                          .addChild(new Shape().setUSE("HAnimSiteShape")))
                        .addChild(new HAnimSite("hanim_t6").setName("l_neck_base").setDEF("hanim_l_neck_base").setTranslation(Java.to([doubleToFloat(0.0646),doubleToFloat(1.5141),doubleToFloat(-0.038)], Java.type("float[]")))
                          .addChild(new TouchSensor().setDescription("HAnimSite l_neck_base"))
                          .addChild(new Shape().setUSE("HAnimSiteShape")))
                        .addChild(new HAnimSite("hanim_t6").setName("r_neck_base").setDEF("hanim_r_neck_base").setTranslation(Java.to([doubleToFloat(-0.0419),doubleToFloat(1.5149),doubleToFloat(-0.022)], Java.type("float[]")))
                          .addChild(new TouchSensor().setDescription("HAnimSite r_neck_base"))
                          .addChild(new Shape().setUSE("HAnimSiteShape")))
                        .addChild(new HAnimSite("hanim_t6").setName("suprasternale").setDEF("hanim_suprasternale").setTranslation(Java.to([doubleToFloat(0.0084),doubleToFloat(1.4714),doubleToFloat(0.0551)], Java.type("float[]")))
                          .addChild(new TouchSensor().setDescription("HAnimSite suprasternale"))
                          .addChild(new Shape().setUSE("HAnimSiteShape"))))
                      .addChild(new HAnimJoint("hanim_vt6").setName("vt1").setDEF("hanim_vt1").setCenter(Java.to([doubleToFloat(0.0065),doubleToFloat(1.4951),doubleToFloat(-0.0387)], Java.type("float[]")))
                        .addChild(new HAnimSegment("hanim_vt1").setName("t1").setDEF("hanim_t1")
                          ...
                          .addChild(new Shape()
                            .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                              .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.0065),doubleToFloat(1.4951),doubleToFloat(-0.0387),doubleToFloat(0.0066),doubleToFloat(1.5662),doubleToFloat(-0.0084)], Java.type("float[]"))))
                          ...
                          .addChild(new HAnimSite("hanim_t1").setName("r_clavicale").setDEF("hanim_r_clavicale").setTranslation(Java.to([doubleToFloat(-0.0115),doubleToFloat(1.4943),doubleToFloat(0.04)], Java.type("float[]")))
                            ...
                            .addChild(new Shape().setUSE("HAnimSiteShape"))))
                        .addChild(new HAnimJoint("hanim_vt1").setName("vc4").setDEF("hanim_vc4").setCenter(Java.to([doubleToFloat(0.0066),doubleToFloat(1.5662),doubleToFloat(-0.0084)], Java.type("float[]")))
                          .addChild(new HAnimSegment("hanim_vc4").setName("c4").setDEF("hanim_c4")
                            ...
                            .addChild(new Shape()
                              .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.0066),doubleToFloat(1.5662),doubleToFloat(-0.0084),doubleToFloat(0.0066),doubleToFloat(1.5928),doubleToFloat(-0.0103)], Java.type("float[]"))))
                            ...
                            .addChild(new HAnimSite("hanim_c4").setName("adams_apple").setDEF("hanim_adams_apple")
                              ...
                              .addChild(new Shape().setUSE("HAnimSiteShape"))))
                          .addChild(new HAnimJoint("hanim_vc4").setName("vc2").setDEF("hanim_vc2").setCenter(Java.to([doubleToFloat(0.0066),doubleToFloat(1.5928),doubleToFloat(-0.0103)], Java.type("float[]")))
                            .addChild(new HAnimSegment("hanim_vc2").setName("c2").setDEF("hanim_c2")
                              ...
                              .addChild(new Shape()
                                .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                  .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.0066),doubleToFloat(1.5928),doubleToFloat(-0.0103),doubleToFloat(0.0044),doubleToFloat(1.6209),doubleToFloat(0.0236)], Java.type("float[]"))))
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("l_ectocanthus").setDEF("hanim_l_ectocanthus")
                                ...
                                .addChild(new Shape().setUSE("HAnimSiteShape")))
                              .addChild(new HAnimSite("hanim_c2").setName("l_gonion").setDEF("hanim_l_gonion").setTranslation(Java.to([doubleToFloat(0.0631),doubleToFloat(1.553),doubleToFloat(0.033)], Java.type("float[]")))
                                .addChild(new TouchSensor().setDescription("HAnimSite l_gonion"))
                                .addChild(new Shape().setUSE("HAnimSiteShape")))
                              .addChild(new HAnimSite("hanim_c2").setName("l_infraorbitale").setDEF("hanim_l_infraorbitale").setTranslation(Java.to([doubleToFloat(0.0341),doubleToFloat(1.6171),doubleToFloat(0.0752)], Java.type("float[]")))
                                .addChild(new TouchSensor().setDescription("HAnimSite l_infraorbitale"))
                                .addChild(new Shape().setUSE("HAnimSiteShape")))
                              .addChild(new HAnimSite("hanim_c2").setName("l_tragion").setDEF("hanim_l_tragion").setTranslation(Java.to([doubleToFloat(0.0739),doubleToFloat(1.6348),doubleToFloat(0.0282)], Java.type("float[]")))
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("menton").setDEF("hanim_menton")
                                ...
                                .addChild(new Shape().setUSE("HAnimSiteShape")))
                              .addChild(new HAnimSite("hanim_c2").setName("nuchale").setDEF("hanim_nuchale").setTranslation(Java.to([doubleToFloat(0.0039),doubleToFloat(1.5972),doubleToFloat(-0.0796)], Java.type("float[]")))
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("r_ectocanthus").setDEF("hanim_r_ectocanthus")
                                ...
                                .addChild(new Shape().setUSE("HAnimSiteShape")))
                              .addChild(new HAnimSite("hanim_c2").setName("r_gonion").setDEF("hanim_r_gonion").setTranslation(Java.to([doubleToFloat(-0.052),doubleToFloat(1.5529),doubleToFloat(0.0347)], Java.type("float[]")))
                                .addChild(new TouchSensor().setDescription("HAnimSite r_gonion"))
                                .addChild(new Shape().setUSE("HAnimSiteShape")))
                              .addChild(new HAnimSite("hanim_c2").setName("r_infraorbitale").setDEF("hanim_r_infraorbitale").setTranslation(Java.to([doubleToFloat(-0.0237),doubleToFloat(1.6171),doubleToFloat(0.0752)], Java.type("float[]")))
                                .addChild(new TouchSensor().setDescription("HAnimSite r_infraorbitale"))
                                .addChild(new Shape().setUSE("HAnimSiteShape")))
                              .addChild(new HAnimSite("hanim_c2").setName("r_tragion").setDEF("hanim_r_tragion").setTranslation(Java.to([doubleToFloat(-0.0646),doubleToFloat(1.6347),doubleToFloat(0.0302)], Java.type("float[]")))
                                .addChild(new TouchSensor().setDescription("HAnimSite r_tragion"))
                                .addChild(new Shape().setUSE("HAnimSiteShape")))
                              .addChild(new HAnimSite("hanim_c2").setName("sellion").setDEF("hanim_sellion").setTranslation(Java.to([doubleToFloat(0.0058),doubleToFloat(1.6316),doubleToFloat(0.0852)], Java.type("float[]")))
                              ...
                              .addChild(new HAnimSite("hanim_c2").setName("skull_vertex").setDEF("hanim_skull_vertex")
                                ...
                                .addChild(new Shape().setUSE("HAnimSiteShape")))
                              .addChild(new HAnimSite("hanim_c2").setName("supramenton").setDEF("hanim_supramenton").setTranslation(Java.to([doubleToFloat(0.0061),doubleToFloat(1.541),doubleToFloat(0.0805)], Java.type("float[]")))
                                .addChild(new TouchSensor().setDescription("HAnimSite supramenton"))
                                .addChild(new Shape().setUSE("HAnimSiteShape"))))
                            .addChild(new HAnimJoint("hanim_vc2").setName("skullbase").setDEF("hanim_skullbase").setCenter(Java.to([doubleToFloat(0.0044),doubleToFloat(1.6209),doubleToFloat(0.0236)], Java.type("float[]"))))))
                              ...
                              .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_elbow").setDEF("hanim_l_elbow").setCenter(Java.to([doubleToFloat(0.2014),doubleToFloat(1.1357),doubleToFloat(-0.0682)], Java.type("float[]")))
                                ...
                                .addChild(new HAnimJoint("hanim_l_elbow").setName("l_radiocarpal").setDEF("hanim_l_radiocarpal").setCenter(Java.to([doubleToFloat(0.1984),doubleToFloat(0.8663),doubleToFloat(-0.0583)], Java.type("float[]")))
                                  .addChild(new HAnimSegment("hanim_l_radiocarpal").setName("l_carpal").setDEF("hanim_l_carpal")
                                    ...
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.1984),doubleToFloat(0.8663),doubleToFloat(-0.0583),doubleToFloat(0.1924),doubleToFloat(0.8472),doubleToFloat(-0.0534)], Java.type("float[]"))))
                                        .addComments(new CommentsBlock("from l_radiocarpal to l_carpometacarpal_1 vertices 2"))
                                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.1984),doubleToFloat(0.8663),doubleToFloat(-0.0583),doubleToFloat(0.1983),doubleToFloat(0.8024),doubleToFloat(-0.028)], Java.type("float[]"))))
                                        .addComments(new CommentsBlock("from l_radiocarpal to l_carpometacarpal_2 vertices 2"))
                                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                    .addChild(new HAnimSite("hanim_l_carpal").setName("l_metacarpal_phalanx_2").setDEF("hanim_l_metacarpal_phalanx_2").setTranslation(Java.to([doubleToFloat(0.2009),doubleToFloat(0.8139),doubleToFloat(-0.0237)], Java.type("float[]")))
                                      .addChild(new TouchSensor().setDescription("HAnimSite l_metacarpal_phalanx_2"))
                                      .addChild(new Shape().setUSE("HAnimSiteShape")))
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.1984),doubleToFloat(0.8663),doubleToFloat(-0.0583),doubleToFloat(0.1987),doubleToFloat(0.8029),doubleToFloat(-0.053)], Java.type("float[]"))))
                                    ...
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.1984),doubleToFloat(0.8663),doubleToFloat(-0.0583),doubleToFloat(0.1956),doubleToFloat(0.8019),doubleToFloat(-0.0794)], Java.type("float[]"))))
                                        .addComments(new CommentsBlock("from l_radiocarpal to l_carpometacarpal_4 vertices 2"))
                                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(0.1984),doubleToFloat(0.8663),doubleToFloat(-0.0583),doubleToFloat(0.1925),doubleToFloat(0.8066),doubleToFloat(-0.1036)], Java.type("float[]"))))
                                        .addComments(new CommentsBlock("from l_radiocarpal to l_carpometacarpal_5 vertices 2"))
                                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                    .addChild(new HAnimSite("hanim_l_carpal").setName("l_metacarpal_phalanx_5").setDEF("hanim_l_metacarpal_phalanx_5").setTranslation(Java.to([doubleToFloat(0.1929),doubleToFloat(0.786),doubleToFloat(-0.1122)], Java.type("float[]")))
                                      .addChild(new TouchSensor().setDescription("HAnimSite l_metacarpal_phalanx_5"))
                                      .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                  .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_carpometacarpal_1").setDEF("hanim_l_carpometacarpal_1").setCenter(Java.to([doubleToFloat(0.1924),doubleToFloat(0.8472),doubleToFloat(-0.0534)], Java.type("float[]")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_carpometacarpal_2").setDEF("hanim_l_carpometacarpal_2").setCenter(Java.to([doubleToFloat(0.1983),doubleToFloat(0.8024),doubleToFloat(-0.028)], Java.type("float[]")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_carpometacarpal_3").setDEF("hanim_l_carpometacarpal_3").setCenter(Java.to([doubleToFloat(0.1987),doubleToFloat(0.8029),doubleToFloat(-0.053)], Java.type("float[]")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_carpometacarpal_4").setDEF("hanim_l_carpometacarpal_4").setCenter(Java.to([doubleToFloat(0.1956),doubleToFloat(0.8019),doubleToFloat(-0.0794)], Java.type("float[]")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_l_radiocarpal").setName("l_carpometacarpal_5").setDEF("hanim_l_carpometacarpal_5").setCenter(Java.to([doubleToFloat(0.1925),doubleToFloat(0.8066),doubleToFloat(-0.1036)], Java.type("float[]")))
                              ...
                              .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_elbow").setDEF("hanim_r_elbow").setCenter(Java.to([doubleToFloat(-0.1949),doubleToFloat(1.1388),doubleToFloat(-0.062)], Java.type("float[]")))
                                ...
                                .addChild(new HAnimJoint("hanim_r_elbow").setName("r_radiocarpal").setDEF("hanim_r_radiocarpal").setCenter(Java.to([doubleToFloat(-0.1959),doubleToFloat(0.8694),doubleToFloat(-0.0521)], Java.type("float[]")))
                                  .addChild(new HAnimSegment("hanim_r_radiocarpal").setName("r_carpal").setDEF("hanim_r_carpal")
                                    ...
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(-0.1959),doubleToFloat(0.8694),doubleToFloat(-0.0521),doubleToFloat(-0.1899),doubleToFloat(0.8502),doubleToFloat(-0.0473)], Java.type("float[]"))))
                                        .addComments(new CommentsBlock("from r_radiocarpal to r_carpometacarpal_1 vertices 2"))
                                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(-0.1959),doubleToFloat(0.8694),doubleToFloat(-0.0521),doubleToFloat(-0.1961),doubleToFloat(0.8055),doubleToFloat(-0.0218)], Java.type("float[]"))))
                                        .addComments(new CommentsBlock("from r_radiocarpal to r_carpometacarpal_2 vertices 2"))
                                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                    .addChild(new HAnimSite("hanim_r_carpal").setName("r_metacarpal_phalanx_2").setDEF("hanim_r_metacarpal_phalanx_2").setTranslation(Java.to([doubleToFloat(-0.1977),doubleToFloat(0.8169),doubleToFloat(-0.0177)], Java.type("float[]")))
                                      .addChild(new TouchSensor().setDescription("HAnimSite r_metacarpal_phalanx_2"))
                                      .addChild(new Shape().setUSE("HAnimSiteShape")))
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(-0.1959),doubleToFloat(0.8694),doubleToFloat(-0.0521),doubleToFloat(-0.1972),doubleToFloat(0.806),doubleToFloat(-0.0468)], Java.type("float[]"))))
                                    ...
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(-0.1959),doubleToFloat(0.8694),doubleToFloat(-0.0521),doubleToFloat(-0.1951),doubleToFloat(0.8049),doubleToFloat(-0.0732)], Java.type("float[]"))))
                                        .addComments(new CommentsBlock("from r_radiocarpal to r_carpometacarpal_4 vertices 2"))
                                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                    .addChild(new Shape()
                                      .setGeometry(new LineSet().setVertexCount(Java.to([2], Java.type("int[]")))
                                        .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(-0.1959),doubleToFloat(0.8694),doubleToFloat(-0.0521),doubleToFloat(-0.1926),doubleToFloat(0.8096),doubleToFloat(-0.0975)], Java.type("float[]"))))
                                        .addComments(new CommentsBlock("from r_radiocarpal to r_carpometacarpal_5 vertices 2"))
                                        .setColor(new ColorRGBA().setUSE("HAnimSegmentLineColorRGBA"))))
                                    .addChild(new HAnimSite("hanim_r_carpal").setName("r_metacarpal_phalanx_5").setDEF("hanim_r_metacarpal_phalanx_5").setTranslation(Java.to([doubleToFloat(-0.1929),doubleToFloat(0.789),doubleToFloat(-0.1064)], Java.type("float[]")))
                                      .addChild(new TouchSensor().setDescription("HAnimSite r_metacarpal_phalanx_5"))
                                      .addChild(new Shape().setUSE("HAnimSiteShape"))))
                                  .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_carpometacarpal_1").setDEF("hanim_r_carpometacarpal_1").setCenter(Java.to([doubleToFloat(-0.1899),doubleToFloat(0.8502),doubleToFloat(-0.0473)], Java.type("float[]")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_carpometacarpal_2").setDEF("hanim_r_carpometacarpal_2").setCenter(Java.to([doubleToFloat(-0.1961),doubleToFloat(0.8055),doubleToFloat(-0.0218)], Java.type("float[]")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_carpometacarpal_3").setDEF("hanim_r_carpometacarpal_3").setCenter(Java.to([doubleToFloat(-0.1972),doubleToFloat(0.806),doubleToFloat(-0.0468)], Java.type("float[]")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_carpometacarpal_4").setDEF("hanim_r_carpometacarpal_4").setCenter(Java.to([doubleToFloat(-0.1951),doubleToFloat(0.8049),doubleToFloat(-0.0732)], Java.type("float[]")))
                                  ...
                                  .addChild(new HAnimJoint("hanim_r_radiocarpal").setName("r_carpometacarpal_5").setDEF("hanim_r_carpometacarpal_5").setCenter(Java.to([doubleToFloat(-0.1926),doubleToFloat(0.8096),doubleToFloat(-0.0975)], Java.type("float[]")))

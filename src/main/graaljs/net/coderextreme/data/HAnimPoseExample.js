	...
	return new Float32Array(d);
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimPose().setName("T").setDEF("T_Pose").setDescription("arms stretched outward and level similar to letter T").setLoa(1).setTransitionDuration(1.3)
          ...
          .addChild(new HAnimJoint("T_Pose").setName("l_shoulder").setDEF("PoseJoint_l_shoulder_1").setDescription("left shoulder").setRotation(Java.to(doubleToFloat([0,0,1,1.57]), Java.type("float[]"))))
          .addChild(new HAnimJoint("T_Pose").setName("r_shoulder").setDEF("PoseJoint_r_shoulder_1").setDescription("right shoulder").setRotation(Java.to(doubleToFloat([0,0,-1,1.57]), Java.type("float[]")))))
        .addChild(new HAnimPose().setName("A").setDEF("A_Pose").setDescription("arms stretched outward and downward similar to letter A").setLoa(1).setTransitionDuration(1.2)
          .addChild(new HAnimJoint("A_Pose").setName("l_shoulder").setDEF("PoseJoint_l_shoulder").setDescription("left shoulder").setRotation(Java.to(doubleToFloat([0,0,1,0.5]), Java.type("float[]"))))
          .addChild(new HAnimJoint("A_Pose").setName("r_shoulder").setDEF("PoseJoint_r_shoulder").setDescription("right shoulder").setRotation(Java.to(doubleToFloat([0,0,-1,0.5]), Java.type("float[]")))))
        .addChild(new HAnimPose().setName("TouchDown").setDEF("TouchDown_Pose").setDescription("arms and legs stretched outward providing a TouchDown gesture").setLoa(1).setTransitionDuration(1.2)
          .addChild(new HAnimJoint("TouchDown_Pose").setName("humanoid_root").setRotation(Java.to(doubleToFloat([0,1,0,-0.698132]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("l_hip").setRotation(Java.to(doubleToFloat([-1,1,1,1]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("l_knee").setRotation(Java.to(doubleToFloat([1,0,0,1]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("l_talocrural").setRotation(Java.to(doubleToFloat([-0.2,0,0.1,0.225]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("r_hip").setRotation(Java.to(doubleToFloat([-1,-1,-1,1]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("r_knee").setRotation(Java.to(doubleToFloat([1,0,0,1]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("r_talocrural").setRotation(Java.to(doubleToFloat([-0.2,0,0.1,0.25]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("vl5").setRotation(Java.to(doubleToFloat([0,0,0.01,0.2]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("vt10").setRotation(Java.to(doubleToFloat([0,0,0.01,0.1]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("vc4").setRotation(Java.to(doubleToFloat([0,0,-0.01,0.15]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("l_shoulder").setRotation(Java.to(doubleToFloat([-1,0.5,1,2]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("l_elbow").setRotation(Java.to(doubleToFloat([-1,0,0,1]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("l_radiocarpal"))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("r_shoulder").setRotation(Java.to(doubleToFloat([-1,-0.5,-1,2.6]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("r_elbow").setRotation(Java.to(doubleToFloat([-1,0,0,1]), Java.type("float[]"))))
          .addChild(new HAnimJoint("TouchDown_Pose").setName("r_radiocarpal")))
        ...
        .addChild(new HAnimPose().setName("FaceLeft").setDEF("FaceLeft_Pose").setDescription("Only modify humanoid_root Joint node to face left").setLoa(0).setTransitionDuration(1.1)
          .addChild(new HAnimJoint("FaceLeft_Pose").setName("humanoid_root").setDEF("FaceLeft_humanoid_root").setDescription("Only rotate the model").setRotation(Java.to(doubleToFloat([0,1,0,1.570796]), Java.type("float[]")))))
        .addChild(new HAnimPose().setName("FaceRight").setDEF("FaceRight_Pose").setDescription("Only modify humanoid_root Joint node to face right").setLoa(0).setTransitionDuration(1.1)
          .addChild(new HAnimJoint("FaceRight_Pose").setName("humanoid_root").setDEF("FaceRight_humanoid_root").setDescription("Only rotate the model").setRotation(Java.to(doubleToFloat([0,1,0,-1.570796]), Java.type("float[]")))))

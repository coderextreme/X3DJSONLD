...
function set_fraction(value) {
	...
	initialize();
            ...
            .addChild(new ROUTE().setFromNode("bounce1").setFromField("translation").setToNode("body_trans").setToField("translation"))
            .addChild(new ROUTE().setFromNode("bounce1").setFromField("scale").setToNode("body_trans").setToField("scale"))

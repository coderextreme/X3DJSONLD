...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("Diamond Man, LOA 0").setPosition(Java.to([0,1,3], Java.type("double[]"))).setCenterOfRotation(Java.to([0,1,0], Java.type("double[]"))))
        .addChild(new HAnimHumanoid().setDEF("hanim_humanoid").setName("humanoid").setLoa(0)
          ...
          .addViewpoints(new HAnimSite().setDEF("hanim_site_view").setName("site_view")
            .addChild(new Viewpoint().setDEF("InclinedView").setDescription("Inclined View").setPosition(Java.to([1.62,1.05,2.06], Java.type("double[]"))).setOrientation(Java.to([-0.113,0.993,0.0347,0.671], Java.type("double[]"))))
            .addChild(new Viewpoint().setDEF("FrontView").setDescription("Front View").setPosition(Java.to([0,0.854,2.57665], Java.type("double[]"))))
            .addChild(new Viewpoint().setDEF("SideView").setDescription("Side View").setPosition(Java.to([2.5929,0.854,0], Java.type("double[]"))).setOrientation(Java.to([0,1,0,1.57079], Java.type("double[]"))))
            .addChild(new Viewpoint().setDEF("TopView").setDescription("Top View").setPosition(Java.to([0,3.4495,0], Java.type("double[]"))).setOrientation(Java.to([1,0,0,-1.57079], Java.type("double[]")))))
          .addSegments(new HAnimSegment().setUSE("hanim_pelvis"))
          .addJoints(new HAnimJoint().setUSE("hanim_humanoid_root"))
          .addJoints(new HAnimJoint().setUSE("hanim_sacroiliac"))))      ;
    X3D0.toFileX3D("../data/DiamondManLOA0_patched2.new.graal.x3d");
    X3D0.toFileJSON("../data/DiamondManLOA0_patched2.new.graal.json");

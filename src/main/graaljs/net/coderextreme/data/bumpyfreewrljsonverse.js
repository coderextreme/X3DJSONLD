...
const newTranslation = function(Value) {
	...
	protoText_changed = new MFString(protoParameterName+'='+protoValue_changed.toFixed(2));
        ...
        if (t) {
            ...
            .setLayout(new Layout().setAlign(Java.to(["LEFT","BOTTOM"], Java.type("java.lang.String[]"))).setOffset(Java.to(doubleToFloat([-0.2,0.19]), Java.type("float[]"))).setOffsetUnits(Java.to(["WORLD","WORLD"], Java.type("java.lang.String[]"))).setScaleMode(Java.to(["NONE","NONE"], Java.type("java.lang.String[]"))).setSize(Java.to(doubleToFloat([0.4,0.6]), Java.type("float[]"))).setSizeUnits(Java.to(["WORLD","WORLD"], Java.type("java.lang.String[]"))))

            ...
            .addChild(new Group()
              ...
              .addChild(new Transform().setScale(Java.to(doubleToFloat([0.5,0.5,0.5]), Java.type("float[]")))
                .addChild(new Shape().setDEF("ShapeLeftDown")
                  ...
                  .setGeometry(new Extrusion().setSpine(Java.to(doubleToFloat([-2.5,0,0,-1.5,0,0]), Java.type("float[]"))).setCreaseAngle(0.785).setCrossSection(Java.to(doubleToFloat([1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0]), Java.type("float[]"))))))
              ...
              .addChild(new Transform().setScale(Java.to(doubleToFloat([0.5,0.5,0.5]), Java.type("float[]")))
                .addChild(new Shape().setDEF("ShapeUpRight")
                  ...
                  .setGeometry(new Extrusion().setSpine(Java.to(doubleToFloat([1.5,0,0,2.5,0,0]), Java.type("float[]"))).setCreaseAngle(0.785).setCrossSection(Java.to(doubleToFloat([1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0]), Java.type("float[]"))))))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setSkyColor(Java.to([0f,0f,1f], Java.type("float[]"))).setGroundAngle(Java.to([1.57f], Java.type("float[]"))).setGroundColor(Java.to([0f,0.5f,0f,0f,0.5f,0f], Java.type("float[]"))))
        ...
        .addChild(new Viewpoint().setDEF("Top_View").setDescription("Top View").setPosition(Java.to([0f,10f,0f], Java.type("float[]"))).setOrientation(Java.to([1f,0f,0f,-1.57f], Java.type("float[]"))))

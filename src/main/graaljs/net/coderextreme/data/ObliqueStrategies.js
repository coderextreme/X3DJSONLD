...
function doubleToFloat(d) {
	...
	return new Float32Array([d])[0];
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setSkyColor(Java.to([doubleToFloat(0.419608),doubleToFloat(0.427451),doubleToFloat(1)], Java.type("float[]"))))
        .addChild(new Transform().setScale(Java.to([doubleToFloat(0.4),doubleToFloat(0.4),doubleToFloat(0.4)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(0),doubleToFloat(1),doubleToFloat(0)], Java.type("float[]")))
          ...
          .addChild(new Transform().setScale(Java.to([doubleToFloat(10),doubleToFloat(3),doubleToFloat(1)], Java.type("float[]")))
            .addChild(new Shape().setDEF("HeadlineClickSurface")
              .setGeometry(new IndexedFaceSet().setCoordIndex(Java.to([0,1,2,3,-1], Java.type("int[]"))).setSolid(false)
                .setCoord(new Coordinate().setPoint(Java.to([doubleToFloat(1),doubleToFloat(1),doubleToFloat(0),doubleToFloat(1),doubleToFloat(-1),doubleToFloat(0),doubleToFloat(-1),doubleToFloat(-1),doubleToFloat(0),doubleToFloat(-1),doubleToFloat(1),doubleToFloat(0)], Java.type("float[]")))))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setAmbientIntensity(0.245763).setDiffuseColor(Java.to([doubleToFloat(0.34773),doubleToFloat(0.090909),doubleToFloat(0.005289)], Java.type("float[]"))).setShininess(0.07).setSpecularColor(Java.to([doubleToFloat(0.336735),doubleToFloat(0.051091),doubleToFloat(0.051091)], Java.type("float[]"))).setTransparency(0.8))))))
        ...
        .addChild(new Transform().setDEF("CardTransform").setScale(Java.to([doubleToFloat(0.4),doubleToFloat(0.4),doubleToFloat(0.4)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(0),doubleToFloat(-1.5),doubleToFloat(0)], Java.type("float[]")))
          .addChild(new Shape()
        ...
        .addChild(new Transform().setScale(Java.to([doubleToFloat(0.4),doubleToFloat(0.4),doubleToFloat(0.4)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(-3.2),doubleToFloat(2.5),doubleToFloat(0)], Java.type("float[]")))
          ...
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance().setDEF("InterfaceAppearance")
              .setMaterial(new Material().setDiffuseColor(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(0.6)], Java.type("float[]"))))))
          .addChild(new Transform().setScale(Java.to([doubleToFloat(2),doubleToFloat(0.6),doubleToFloat(1)], Java.type("float[]")))
        ...
        .addChild(new Transform().setScale(Java.to([doubleToFloat(0.4),doubleToFloat(0.4),doubleToFloat(0.4)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(3.5),doubleToFloat(2.5),doubleToFloat(0)], Java.type("float[]")))
          ...
          .addChild(new Transform().setScale(Java.to([doubleToFloat(1.2),doubleToFloat(0.6),doubleToFloat(1)], Java.type("float[]")))
            .addChild(new Shape().setUSE("TransparentClickSurface"))))
        .addChild(new Transform().setScale(Java.to([doubleToFloat(0.4),doubleToFloat(0.4),doubleToFloat(0.4)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(-3.3),doubleToFloat(-0.5),doubleToFloat(0)], Java.type("float[]")))
          ...
          .addChild(new Shape()
            .setGeometry(new Text().setString(Java.to(["random"], Java.type("java.lang.String[]")))
              .setFontStyle(new FontStyle().setUSE("MessageFont")))
            .setAppearance(new Appearance().setUSE("InterfaceAppearance")))
          .addChild(new Transform().setScale(Java.to([doubleToFloat(1.8),doubleToFloat(0.6),doubleToFloat(1)], Java.type("float[]")))
            .addChild(new Shape().setUSE("TransparentClickSurface"))))
        .addChild(new Transform().setScale(Java.to([doubleToFloat(0.4),doubleToFloat(0.4),doubleToFloat(0.4)], Java.type("float[]"))).setTranslation(Java.to([doubleToFloat(3.3),doubleToFloat(-0.5),doubleToFloat(0)], Java.type("float[]")))

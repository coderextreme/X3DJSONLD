        ...
        .addLayerSet(new LayerSet().setActiveLayer(1).setOrder(Java.to([1,2], Java.type("int[]")))
          ...
          .addLayers(new Layer()
            ...
            .addChild(new DISEntityManager().setDEF("EntityManager").setNetworkMode("networkReader")
              .addChild(new DISEntityTypeMapping().setCategory(77).setSpecific(1).setUrl(Java.to(["Leif8Final.x3d"], Java.type("java.lang.String[]"))))
              .addChild(new DISEntityTypeMapping().setCategory(77).setSpecific(2).setUrl(Java.to(["Lily8Final.x3d"], Java.type("java.lang.String[]")))))
          ...
          .addLayers(new LayoutLayer()
            ...
            .addChild(new Script().setDEF("aValueTransformerScript").setDirectOutput(true).setMustEvaluate(true)
              ...
              .addField(new field().setType(field.TYPE_SFFLOAT).setName("aValue_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue("1"))
            ...
            .addChild(new Script().setDEF("bValueTransformerScript").setDirectOutput(true).setMustEvaluate(true)
              .addField(new field().setType(field.TYPE_SFVEC3F).setName("newTranslation").setAccessType(field.ACCESSTYPE_INPUTONLY).setValue("1 1 1"))
              .addField(new field().setType(field.TYPE_SFFLOAT).setName("bValue_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue("1"))
            ...
            .addChild(new Script().setDEF("cValueTransformerScript").setDirectOutput(true).setMustEvaluate(true)
              .addField(new field().setType(field.TYPE_SFVEC3F).setName("newTranslation").setAccessType(field.ACCESSTYPE_INPUTONLY).setValue("1 1 1"))
              .addField(new field().setType(field.TYPE_SFFLOAT).setName("cValue_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue("1"))
            ...
            .addChild(new Script().setDEF("dValueTransformerScript").setDirectOutput(true).setMustEvaluate(true)
              .addField(new field().setType(field.TYPE_SFVEC3F).setName("newTranslation").setAccessType(field.ACCESSTYPE_INPUTONLY).setValue("1 1 1"))
              .addField(new field().setType(field.TYPE_SFFLOAT).setName("dValue_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue("1"))
            ...
            .addChild(new Script().setDEF("pdeltaValueTransformerScript").setDirectOutput(true).setMustEvaluate(true)
              .addField(new field().setType(field.TYPE_SFVEC3F).setName("newTranslation").setAccessType(field.ACCESSTYPE_INPUTONLY).setValue("1 1 1"))
              .addField(new field().setType(field.TYPE_SFFLOAT).setName("pdeltaValue_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue("1"))
            ...
            .addChild(new Script().setDEF("tdeltaValueTransformerScript").setDirectOutput(true).setMustEvaluate(true)
              .addField(new field().setType(field.TYPE_SFVEC3F).setName("newTranslation").setAccessType(field.ACCESSTYPE_INPUTONLY).setValue("1 1 1"))
              .addField(new field().setType(field.TYPE_SFFLOAT).setName("tdeltaValue_changed").setAccessType(field.ACCESSTYPE_OUTPUTONLY).setValue("1"))
            ...
            .setLayout(new Layout().setAlign(Java.to(["RIGHT","BOTTOM"], Java.type("java.lang.String[]"))).setOffset(Java.to(doubleToFloat([0,0.2]), Java.type("float[]"))).setOffsetUnits(Java.to(["WORLD","WORLD"], Java.type("java.lang.String[]"))).setScaleMode(Java.to(["NONE","NONE"], Java.type("java.lang.String[]"))).setSize(Java.to(doubleToFloat([0.4,0.6]), Java.type("float[]"))).setSizeUnits(Java.to(["WORLD","WORLD"], Java.type("java.lang.String[]"))))
            .setViewport(new Viewport().setClipBoundary(Java.to(doubleToFloat([0,1,0,1]), Java.type("float[]")))))))      ;
    X3D0.toFileX3D("../personal/bumpyx_itesliders.new.graal.x3d");
    X3D0.toFileJSON("../personal/bumpyx_itesliders.new.graal.json");

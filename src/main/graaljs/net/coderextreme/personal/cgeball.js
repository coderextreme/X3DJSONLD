          ...
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setLanguage("GLSL")
                ...
                .addParts(new ShaderPart().setType("FRAGMENT").setDEF("commonfs").setUrl(Java.to(["../shaders/castle.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs"], Java.type("java.lang.String[]")))))))))      ;
    X3D0.toFileX3D("../personal/cgeball.new.graal.x3d");
    X3D0.toFileJSON("../personal/cgeball.new.graal.json");

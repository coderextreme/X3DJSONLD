...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead(new head()
        ...
        .addComments(new CommentsBlock("component name='Shaders' level='1'></component"))
        .addComments(new CommentsBlock("component name='CubeMapTexturing' level='1'></component"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("Tour Views").setPosition(Java.to([0,0,12], Java.type("double[]"))))
        ...
        .addChild(new Transform()
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance()
              ...
              .addComments(new CommentsBlock("<ComposedShader language='GLSL'> <field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1 1.033'></field> <field name='fw_Texture_unit0' type='SFNode' accessType=\"initializeOnly\"> <ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture> </field> <field name='bias' accessType='initializeOnly' type='SFFloat' value='0.5'></field> <field name='scale' accessType='initializeOnly' type='SFFloat' value='0.5'></field> <field name='power' accessType='initializeOnly' type='SFFloat' value='2'></field> <ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/contact.vs\"' type=\"VERTEX\" containerField='parts'></ShaderPart> <ShaderPart USE='commonfs'></ShaderPart> </ComposedShader>"))
              ...
              .addShaders(new ComposedShader().setLanguage("GLSL")
                ...
                .addParts(new ShaderPart().setType("VERTEX").setUrl(Java.to(["../shaders/castle.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs"], Java.type("java.lang.String[]"))))
    ...
    X3D0.toFileX3D("../personal/cgefield.new.graal.x3d");
    X3D0.toFileJSON("../personal/cgefield.new.graal.json");

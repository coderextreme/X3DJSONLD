          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              .addChild(new Transform().setDEF("transform")
                ...
                .addChild(new Transform().setTranslation(Java.to([doubleToFloat(1),doubleToFloat(0),doubleToFloat(1)], Java.type("float[]")))
                  .addChild(new Shape()
...
ProtoInstance6
            .addFieldValue(new fieldValue().setName("set_positionB").setValue("50 50 -50"));
    X3D0.toFileX3D("../personal/forcenode.new.graal.x3d");
    X3D0.toFileJSON("../personal/forcenode.new.graal.json");

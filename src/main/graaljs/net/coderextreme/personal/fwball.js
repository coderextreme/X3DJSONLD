          ...
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setLanguage("GLSL")
                ...
                .addParts(new ShaderPart().setType("VERTEX").setUrl(Java.to(["../shaders/freewrl.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs"], Java.type("java.lang.String[]"))))
                .addParts(new ShaderPart().setType("FRAGMENT").setUrl(Java.to(["../shaders/freewrl.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"], Java.type("java.lang.String[]")))))))))      ;
    X3D0.toFileX3D("../personal/fwball.new.graal.x3d");
    X3D0.toFileJSON("../personal/fwball.new.graal.json");

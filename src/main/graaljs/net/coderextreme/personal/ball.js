          ...
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setLanguage("GLSL")
                ...
                .addParts(new ShaderPart().setType("FRAGMENT").setDEF("commonfs").setUrl(Java.to(["../shaders/commonnew.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/commonnew.fs"], Java.type("java.lang.String[]"))))
                .addComments(new CommentsBlock("<ShaderPart USE=\"commonfs\"></ShaderPart>")))))))      ;
    X3D0.toFileX3D("../personal/ball.new.graal.x3d");
    X3D0.toFileJSON("../personal/ball.new.graal.json");

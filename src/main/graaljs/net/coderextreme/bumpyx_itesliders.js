      ...
      .setScene(new Scene()
        ...
        .addLayerSet(new LayerSet().setActiveLayer(1).setOrder(Java.to([1,2], Java.type("int[]")))
          ...
          .addLayers(new LayoutLayer().setPickable(true).setObjectType(Java.to(["ALL"], Java.type("java.lang.String[]")))
            ...
            .setLayout(new Layout().setAlign(Java.to(["RIGHT","BOTTOM"], Java.type("java.lang.String[]"))).setOffset(Java.to(doubleToFloat([0,0.2]), Java.type("float[]"))).setSize(Java.to(doubleToFloat([0.4,0.6]), Java.type("float[]"))))
            .setViewport(new Viewport().setClipBoundary(Java.to(doubleToFloat([0,1,0,1]), Java.type("float[]")))))))      ;
    X3D0.toFileX3D(".././bumpyx_itesliders.new.graal.x3d");
    X3D0.toFileJSON(".././bumpyx_itesliders.new.graal.json");

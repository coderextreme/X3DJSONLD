...
LOA1ExampleSourceWithDiamonds.prototype = {
  ...
  initialize : function ()
  {
	...
	this.fieldValue_info_4_615_value = new SFStringObject("\"authorName=Matthew T. Beitler\" \"authorEmail=beitler@cis.upenn.edu or beitler@acm.org\" \"creationDate=05/12/99\" \"copyright=Copyright 1999-2003, Matthew T. Beitler\" \"humanoidVersion=JointCenters 200x, LOA&#8209;1\" \"usageRestrictions=
	...
	this.WorldInfo_4_617_info = new MFStringObject(new MFStringObject("\"
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ProtoInstanceObject("humanoid_2", "Humanoid").setDEF("humanoid_2").setName("Humanoid")
      ...
      .addFieldValue(new fieldValueObject().setName("info").setValue(this.fieldValue_info_4_615_value)))
    .addChild(new GroupObject("JointCenters_WorldInfo")
      .addChild(new WorldInfoObject().setInfo(this.WorldInfo_4_617_info).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;1")))

...
HAnimModelFootRight.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("Humanoid_Right_Foot").setName("Humanoid_Right_Foot").setJointBindingPositions(new MFVec3f(Java.to([0.0,0.0,0.0], Java.type("float[]")))).setJointBindingRotations(new MFRotation(Java.to([0.0,0.0,1.0,0.0], Java.type("float[]")))).setJointBindingScales(new MFVec3f(Java.to([1.0,1.0,1.0], Java.type("float[]")))).setVersion("2.0")
          ...
          .addChild(new HAnimSegment("r_talus").setName("r_talus")
            ...
            .addChild(new Shape()
              ...
              .setGeometry(new IndexedLineSet("TCtoTCN").setDEF("TCtoTCN").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.0,0.0,0.0,0.0,-0.3,0.0], Java.type("float[]")))))))
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
              .setGeometry(new IndexedLineSet("TCtoCC").setDEF("TCtoCC").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.0,0.0,0.0,-0.2,0.3,0.0], Java.type("float[]"))))))))
          .addComments(" TCN ")
            ...
            .addChild(new HAnimSegment("r_navicular").setName("r_navicular")
              ...
              .addChild(new Shape()
                ...
                .setGeometry(new IndexedLineSet("TCNtoCN1").setDEF("TCNtoCN1").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                  .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.0,-0.3,0.0,0.1,-0.45,0.0], Java.type("float[]")))))))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                .setGeometry(new IndexedLineSet("TCNtoCN2").setDEF("TCNtoCN2").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                  .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.0,-0.3,0.0,0.0,-0.45,0.0], Java.type("float[]")))))))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                .setGeometry(new IndexedLineSet("TCNtoCN3").setDEF("TCNtoCN3").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                  .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.0,-0.3,0.0,-0.1,-0.4,0.0], Java.type("float[]"))))))))
            .addComments(" CN1 ")
              ...
              .addChild(new HAnimSegment("r_cuneiform1").setName("r_cuneiform1")
                ...
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedLineSet("CN1toTMT1").setDEF("CN1toTMT1").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                    .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.1,-0.45,0.0,0.1,-0.6,0.0], Java.type("float[]"))))))))
                ...
                .addChild(new HAnimSegment("r_metatarsal1").setName("r_metatarsal1")
                  ...
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedLineSet("TMT1toMTP1").setDEF("TMT1toMTP1").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                      .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.1,-0.6,0.0,0.1,-0.9,0.0], Java.type("float[]"))))))))
                  ...
                  .addChild(new HAnimSegment("r_proximal_phalanges1").setName("r_proximal_phalanges1")
                    ...
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedLineSet("MTP1toIP1").setDEF("MTP1toIP1").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                        .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.1,-0.9,0.0,0.1,-1.05,0.0], Java.type("float[]"))))))))
                  .addChild(new HAnimJoint("r_f_Interphalangeal_joint").setName("r_f_Interphalangeal_joint").setCenter(0.1,-1.05,0.0)
                    .addChild(new HAnimSegment("r_distal_phalanges1").setName("r_distal_phalanges1")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                        .setGeometry(new IndexedLineSet("tiptoe_r_f_Interphalangeal_joint").setDEF("tiptoe_r_f_Interphalangeal_joint").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                          .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.1,-1.05,0.0,0.1,-1.1,0.0], Java.type("float[]"))))))))))))
            .addComments(" CN2 ")
              ...
              .addChild(new HAnimSegment("r_cuneiform2").setName("r_cuneiform2")
                ...
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedLineSet("CN2toTMT2").setDEF("CN2toTMT2").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                    .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.0,-0.45,0.0,-0.05,-0.6,0.0], Java.type("float[]"))))))))
                ...
                .addChild(new HAnimSegment("r_metatarsal2").setName("r_metatarsal2")
                  ...
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedLineSet("TMT2toMTP2").setDEF("TMT2toMTP2").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                      .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.05,-0.6,0.0,-0.05,-0.9,0.0], Java.type("float[]"))))))))
                  ...
                  .addChild(new HAnimSegment("r_proximal_phalanges2").setName("r_proximal_phalanges2")
                    ...
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedLineSet("MTP2toPIP2").setDEF("MTP2toPIP2").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                        .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.05,-0.9,0.0,-0.05,-1.05,0.0], Java.type("float[]"))))))))
                    ...
                    .addChild(new HAnimSegment("r_middle_phalanges2").setName("r_middle_phalanges2")
                      ...
                      .addChild(new Shape()
                        ...
                        .setGeometry(new IndexedLineSet("PIP2toDIP2").setDEF("PIP2toDIP2").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                          .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.05,-1.05,0.0,-0.05,-1.12,0.0], Java.type("float[]"))))))))
                    .addChild(new HAnimJoint("r_f_distal_Interphalangeal_joint2").setName("r_f_distal_Interphalangeal_joint2").setCenter(-0.05,-1.12,0.0)
                      .addChild(new HAnimSegment("r_distal_phalanges2").setName("r_distal_phalanges2")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                          .setGeometry(new IndexedLineSet("tiptoe_r_f_distal_Interphalangeal_joint2").setDEF("tiptoe_r_f_distal_Interphalangeal_joint2").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                            .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.05,-1.12,0.0,-0.05,-1.16,0.0], Java.type("float[]")))))))))))))
            .addComments(" CN3 ")
              ...
              .addChild(new HAnimSegment("r_cuneiform3").setName("r_cuneiform3")
                ...
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedLineSet("CN3toTMT3").setDEF("CN3toTMT3").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                    .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.1,-0.4,0.0,-0.15,-0.6,0.0], Java.type("float[]"))))))))
                ...
                .addChild(new HAnimSegment("r_metatarsal3").setName("r_metatarsal3")
                  ...
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedLineSet("TMT3toMTP3").setDEF("TMT3toMTP3").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                      .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.15,-0.6,0.0,-0.15,-0.9,0.0], Java.type("float[]"))))))))
                  ...
                  .addChild(new HAnimSegment("r_proximal_phalanges3").setName("r_proximal_phalanges3")
                    ...
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedLineSet("MTP3toPIP3").setDEF("MTP3toPIP3").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                        .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.15,-0.9,0.0,-0.15,-1.05,0.0], Java.type("float[]"))))))))
                    ...
                    .addChild(new HAnimSegment("r_middle_phalanges3").setName("r_middle_phalanges3")
                      ...
                      .addChild(new Shape()
                        ...
                        .setGeometry(new IndexedLineSet("PIP3toDIP3").setDEF("PIP3toDIP3").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                          .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.15,-1.05,0.0,-0.15,-1.13,0.0], Java.type("float[]"))))))))
                    .addChild(new HAnimJoint("r_f_distal_Interphalangeal_joint3").setName("r_f_distal_Interphalangeal_joint3").setCenter(-0.15,-1.13,0.0)
                      .addChild(new HAnimSegment("r_distal_phalanges3").setName("r_distal_phalanges3")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                          .setGeometry(new IndexedLineSet("tiptoe_r_f_distal_Interphalangeal_joint3").setDEF("tiptoe_r_f_distal_Interphalangeal_joint3").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                            .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.15,-1.13,0.0,-0.15,-1.16,0.0], Java.type("float[]"))))))))))))))
          .addComments(" CC ")
            ...
            .addChild(new HAnimSegment("r_calcaneus").setName("r_calcaneus")
              ...
              .addChild(new Shape()
                ...
                .setGeometry(new IndexedLineSet("CCtoTT").setDEF("CCtoTT").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                  .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.2,0.3,0.0,-0.21,-0.3,0.0], Java.type("float[]"))))))))
            .addComments(" TT ")
              ...
              .addChild(new HAnimSegment("r_cuboid").setName("r_cuboid")
                ...
                .addChild(new Shape()
                  ...
                  .setGeometry(new IndexedLineSet("TTtoTMT4").setDEF("TTtoTMT4").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                    .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.21,-0.3,0.0,-0.25,-0.58,0.0], Java.type("float[]")))))))
                .addChild(new Shape()
                  .setAppearance(new Appearance()
                    .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                  .setGeometry(new IndexedLineSet("TTtoTMT5").setDEF("TTtoTMT5").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                    .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.21,-0.3,0.0,-0.33,-0.52,0.0], Java.type("float[]"))))))))
              .addComments(" TMT4 ")
                ...
                .addChild(new HAnimSegment("r_metatarsal4").setName("r_metatarsal4")
                  ...
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedLineSet("TMT4toMTP4").setDEF("TMT4toMTP4").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                      .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.25,-0.58,0.0,-0.25,-0.87,0.0], Java.type("float[]"))))))))
                  ...
                  .addChild(new HAnimSegment("r_proximal_phalanges4").setName("r_proximal_phalanges4")
                    ...
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedLineSet("MTP4toPIP4").setDEF("MTP4toPIP4").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                        .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.25,-0.87,0.0,-0.25,-1.0,0.0], Java.type("float[]"))))))))
                    ...
                    .addChild(new HAnimSegment("r_middle_phalanges4").setName("r_middle_phalanges4")
                      ...
                      .addChild(new Shape()
                        ...
                        .setGeometry(new IndexedLineSet("PIP4toDIP4").setDEF("PIP4toDIP4").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                          .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.25,-1.0,0.0,-0.25,-1.1,0.0], Java.type("float[]"))))))))
                    .addChild(new HAnimJoint("r_f_distal_Interphalangeal_joint4").setName("r_f_distal_Interphalangeal_joint4").setCenter(-0.25,-1.1,0.0)
                      .addChild(new HAnimSegment("r_distal_phalanges4").setName("r_distal_phalanges4")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                          .setGeometry(new IndexedLineSet("tiptoe_r_f_distal_Interphalangeal_joint4").setDEF("tiptoe_r_f_distal_Interphalangeal_joint4").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                            .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.25,-1.1,0.0,-0.25,-1.15,0.0], Java.type("float[]"))))))))))))
              .addComments(" TMT5 ")
                ...
                .addChild(new HAnimSegment("r_metatarsal5").setName("r_metatarsal5")
                  ...
                  .addChild(new Shape()
                    ...
                    .setGeometry(new IndexedLineSet("TMT5toMTP5").setDEF("TMT5toMTP5").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                      .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.33,-0.52,0.0,-0.34,-0.8,0.0], Java.type("float[]"))))))))
                  ...
                  .addChild(new HAnimSegment("r_proximal_phalanges5").setName("r_proximal_phalanges5")
                    ...
                    .addChild(new Shape()
                      ...
                      .setGeometry(new IndexedLineSet("MTP5toPIP5").setDEF("MTP5toPIP5").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                        .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.34,-0.8,0.0,-0.34,-0.95,0.0], Java.type("float[]"))))))))
                    ...
                    .addChild(new HAnimSegment("r_middle_phalanges5").setName("r_middle_phalanges5")
                      ...
                      .addChild(new Shape()
                        ...
                        .setGeometry(new IndexedLineSet("PIP5toDIP5").setDEF("PIP5toDIP5").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                          .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.34,-0.95,0.0,-0.34,-1.05,0.0], Java.type("float[]"))))))))
                    .addChild(new HAnimJoint("r_f_distal_Interphalangeal_joint5").setName("r_f_distal_Interphalangeal_joint5").setCenter(-0.34,-1.05,0.0)
                      .addChild(new HAnimSegment("r_distal_phalanges5").setName("r_distal_phalanges5")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                          .setGeometry(new IndexedLineSet("tiptoe_r_f_distal_Interphalangeal_joint5").setDEF("tiptoe_r_f_distal_Interphalangeal_joint5").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                            .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([-0.34,-1.05,0.0,-0.34,-1.08,0.0], Java.type("float[]"))))))))))))))))

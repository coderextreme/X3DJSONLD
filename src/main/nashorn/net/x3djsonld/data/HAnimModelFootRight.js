...
HAnimModelFootRight.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Foot_Right").setName("Foot_Right").setVersion("2.0").setLoa(4)
      .addComments(" HAnimHumanoid original info='\"authorName=Kwan-Hee YOO, Don Brutzman and Joe Williams\"' ")
      .addChild(new MetadataSet().setName("HAnimHumanoid.info").setReference(this.MetadataSet_HAnimHumanoid.info_4_26_reference)

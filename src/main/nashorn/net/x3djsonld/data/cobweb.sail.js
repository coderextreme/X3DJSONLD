 ...
 * <p> Tour around a prismatic sphere. </p>
 <p> Related links: cobweb_sail.java source, <a href="http://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="http://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="http://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;" summary="Scene Metadata">
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.cobweb_sail&nbsp; Document Metadata </td>
		</tr>
...
cobweb_sail.prototype = {
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ViewpointObject().setDescription("Bubbles in action").setPosition(0.0,0.0,4.0).setOrientation(1.0,0.0,0.0,0.0))
...
"}" + "\n" + "]]>"
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new cobweb_sail();
		print ("cobweb_sail execution self-validation test results: " + testObject.validateSelf());
	}
}
new cobweb_sail().main();
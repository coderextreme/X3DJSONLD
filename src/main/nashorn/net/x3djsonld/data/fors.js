...
"					}" + "\n")
    ...
    .addChild(new ProtoDeclare().setName("cylinder")
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Shape()
          .setGeometry(new Extrusion("extrusion").setSpine(new MFVec3f(Java.to([0.0,-50.0,0.0,0.0,50.0,0.0], Java.type("float[]")))).setCreaseAngle(0.785).setCrossSection(this.extrusion_6_39_crossSection))
          .setAppearance(new Appearance()

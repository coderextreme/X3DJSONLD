 ...
 * <p> a generic proto to connect two objects. </p>
 <p> Related links: arc2_sail.java source, <a href="http://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="http://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="http://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;" summary="Scene Metadata">
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.arc2_sail&nbsp; Document Metadata </td>
		</tr>
...
"		}" + "\n")
    ...
    .addChild(new TransformObject("DECLpoint_G3_node")
      .addChild(new ShapeObject()
        ...
        .setAppearance(new AppearanceObject()
          .setMaterial(new MaterialObject().setDiffuseColor(1.0,0.0,0.0))))
      .addChild(new PositionInterpolatorObject("DECLpoint_G3_PI1").setKeyValue(new MFVec3fObject(Java.to([0.0,0.0,0.0,0.0,5.0,0.0], Java.type("float[]")))).setKey(Java.to([0.0,1.0], Java.type("float[]"))))
...
"		}" + "\n")
    ...
    .addChild(new TransformObject("DECLpoint_G4_node")
      .addChild(new ShapeObject()
        ...
        .setAppearance(new AppearanceObject()
          .setMaterial(new MaterialObject().setDiffuseColor(1.0,0.0,0.0))))
      .addChild(new PositionInterpolatorObject("DECLpoint_G4_PI1").setKeyValue(new MFVec3fObject(Java.to([0.0,0.0,0.0,0.0,5.0,0.0], Java.type("float[]")))).setKey(Java.to([0.0,1.0], Java.type("float[]"))))
...
"        }" + "\n")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new arc2_sail();
		print ("arc2_sail execution self-validation test results: " + testObject.validateSelf());
	}
}
new arc2_sail().main();
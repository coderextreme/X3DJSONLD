...
HelloWorld_sail.prototype = {
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new HelloWorld_sail();
		print ("HelloWorld_sail execution self-validation test results: " + testObject.validateSelf());
	}
}
new HelloWorld_sail().main();
...
t1.prototype = {
  ...
  initialize : function ()
  {
	...
	this.Coordinate_8_13_point = new MFVec3f(Java.to([-0.34999999403953552,-0.34999999403953552,0.34999999403953552,0.34999999403953552,-0.34999999403953552,0.34999999403953552,0.34999999403953552,-0.34999999403953552,-0.34999999403953552,-0.34999999403953552,-0.34999999403953552,-0.34999999403953552,0.0,0.34999999403953552,0.0], Java.type("float[]")));
	...
	.append(new MFVec3f(Java.to([430.0,0.019999999552965164,-335.0,435.79998779296875,0.10000000149011612,-335.29998779296875,430.0,0.019999999552965164,-335.0,434.60000610351563,0.10000000149011612,-338.60000610351563,430.0,0.019999999552965164,-335.0,432.70001220703125,0.10000000149011612,-336.60000610351563,430.0,0.019999999552965164,-335.0,434.70001220703125,0.10000000149011612,-336.89999389648438,429.89999389648438,0.019999999552965164,-360.29998779296875,474.70001220703125,0.10000000149011612,-318.79998779296875], Java.type("float[]"))))
	.append(new MFVec3f(Java.to([429.89999389648438,0.019999999552965164,-360.29998779296875,485.60000610351563,0.10000000149011612,-309.0,429.89999389648438,0.019999999552965164,-360.29998779296875,434.79998779296875,0.10000000149011612,-371.5,454.0,0.019999999552965164,-361.29998779296875,457.39999389648438,0.10000000149011612,-359.60000610351563,454.0,0.019999999552965164,-361.29998779296875,454.20001220703125,0.10000000149011612,-358.60000610351563,454.0,0.019999999552965164,-361.29998779296875,450.60000610351563,0.10000000149011612,-358.60000610351563], Java.type("float[]"))))
	.append(new MFVec3f(Java.to([458.89999389648438,0.019999999552965164,-304.29998779296875,473.5,0.10000000149011612,-287.5,458.89999389648438,0.019999999552965164,-304.29998779296875,458.0,0.10000000149011612,-304.5,491.60000610351563,0.019999999552965164,-335.70001220703125,491.39999389648438,0.10000000149011612,-336.79998779296875,491.60000610351563,0.019999999552965164,-335.70001220703125,496.89999389648438,0.10000000149011612,-368.89999389648438,467.0,0.019999999552965164,-243.89999389648438,477.10000610351563,0.10000000149011612,-260.0], Java.type("float[]"))))
	.append(new MFVec3f(Java.to([467.0,0.019999999552965164,-243.89999389648438,459.0,0.10000000149011612,-236.39999389648438,458.70001220703125,0.019999999552965164,-262.70001220703125,469.5,0.10000000149011612,-249.80000305175781,458.70001220703125,0.019999999552965164,-262.70001220703125,456.70001220703125,0.10000000149011612,-261.79998779296875], Java.type("float[]"))));
	...
	this.Coordinate_6_258_point = new MFVec3f(Java.to([430.0,0.019999999552965164,-335.0,429.89999389648438,0.10000000149011612,-360.29998779296875,442.39999389648438,0.019999999552965164,-314.5,429.89999389648438,0.10000000149011612,-319.60000610351563,457.39999389648438,0.019999999552965164,-262.70001220703125,467.0,0.10000000149011612,-243.89999389648438,458.70001220703125,0.019999999552965164,-262.70001220703125,457.39999389648438,0.10000000149011612,-262.70001220703125,458.70001220703125,0.019999999552965164,-262.70001220703125,467.0,0.10000000149011612,-243.89999389648438], Java.type("float[]")));
  ...
  .setScene(new Scene()
    ...
    .addChild(new Viewpoint().setDescription("looking North").setPosition(0.0,60.0,110.0).setFieldOfView(0.78539812564849854).setOrientation(1.0,0.0,0.0,-0.69999998807907104))
    .addChild(new Viewpoint().setDescription("looking East").setPosition(-140.0,30.0,0.0).setOrientation(0.0,0.40000000596046448,0.0,-1.3999999761581421).setFieldOfView(0.78539812564849854))
    .addChild(new Viewpoint().setDescription("Overhead").setPosition(0.0,150.0,0.0).setFieldOfView(0.78539812564849854).setOrientation(1.0,0.0,0.0,-1.5700000524520874))
        ...
        .addChild(new Transform()
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setTransparency(0.20000000298023224).setDiffuseColor(0.5,0.0,1.0)))
    ...
    .addChild(new ProtoDeclare().setName("institute")
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Transform()
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setTransparency(0.20000000298023224).setDiffuseColor(1.0,1.0,0.0)))
    ...
    .addChild(new ProtoDeclare().setName("l")
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new ProtoInstance().setName("org")
          .addFieldValue(new fieldValue().setName("col").setValue("0 0.60000002384185791 0"))
          .setIS(new IS()
    ...
    .addChild(new ProtoDeclare().setName("i")
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new ProtoInstance().setName("org")
          .addFieldValue(new fieldValue().setName("col").setValue("0.60000002384185791 0 0.60000002384185791"))
          .setIS(new IS()
            .addConnect(new connect().setNodeField("posi").setProtoField("pos"))))))
    .addChild(new Transform().setTranslation(-468.0,0.0,315.0)
      ...
      .addChild(new Anchor().setDescription("Derby Women's Centre").setUrl(new MFString("\"javascript:window.open('./data/566.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("435.29998779296875 0.10000000149011612 -335.60000610351563"))))
      ...
      .addChild(new Anchor().setDescription("Charlesworth Primary School").setUrl(new MFString("\"javascript:window.open('./data/576.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("400.60000610351563 0.10000000149011612 -392.89999389648438"))))
      .addChild(new Anchor().setDescription("Hope Valley College").setUrl(new MFString("\"javascript:window.open('./data/579.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("416.70001220703125 0.10000000149011612 -383.39999389648438"))))
      .addChild(new Anchor().setDescription("People Express").setUrl(new MFString("\"javascript:window.open('./data/583.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("i")
          .addFieldValue(new fieldValue().setName("pos").setValue("429.89999389648438 0.10000000149011612 -319.60000610351563"))))
      ...
      .addChild(new Anchor().setDescription("Park View Primary, Derby").setUrl(new MFString("\"javascript:window.open('./data/592.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("438.29998779296875 0.10000000149011612 -338.60000610351563"))))
      .addChild(new Anchor().setDescription("First Movement").setUrl(new MFString("\"javascript:window.open('./data/593.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("n")
          .addFieldValue(new fieldValue().setName("pos").setValue("429.89999389648438 0.10000000149011612 -360.29998779296875"))))
      .addChild(new Anchor().setDescription("St. Benedict R.C. School, Visual Impairment Unit").setUrl(new MFString("\"javascript:window.open('./data/594.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("434.60000610351563 0.10000000149011612 -338.60000610351563"))))
      ...
      .addChild(new Anchor().setDescription("Brackensdale Junior School, Communty Unit").setUrl(new MFString("\"javascript:window.open('./data/597.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("432.70001220703125 0.10000000149011612 -336.60000610351563"))))
      .addChild(new Anchor().setDescription("Moorhead Primary, Derby").setUrl(new MFString("\"javascript:window.open('./data/598.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("437.60000610351563 0.10000000149011612 -332.60000610351563"))))
      .addChild(new Anchor().setDescription("Derby Deaf Club").setUrl(new MFString("\"javascript:window.open('./data/600.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("434.70001220703125 0.10000000149011612 -336.89999389648438"))))
      .addChild(new Anchor().setDescription("Nightingale Junior, Derby").setUrl(new MFString("\"javascript:window.open('./data/601.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("436.29998779296875 0.10000000149011612 -333.39999389648438"))))
      ...
      .addChild(new Anchor().setDescription("Ivy House Special School, Derby").setUrl(new MFString("\"javascript:window.open('./data/606.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("436.10000610351563 0.10000000149011612 -334.89999389648438"))))
      .addChild(new Anchor().setDescription("Oakham Day Centre, Rutland").setUrl(new MFString("\"javascript:window.open('./data/607.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("485.60000610351563 0.10000000149011612 -309"))))
      ...
      .addChild(new Anchor().setDescription("City Arts").setUrl(new MFString("\"javascript:window.open('./data/612.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("i")
          .addFieldValue(new fieldValue().setName("pos").setValue("455.89999389648438 0.10000000149011612 -341.29998779296875"))))
      .addChild(new Anchor().setDescription("Indigo Dance Group (Salamanda Tandem)").setUrl(new MFString("\"javascript:window.open('./data/615.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("r")
          .addFieldValue(new fieldValue().setName("pos").setValue("456.10000610351563 0.10000000149011612 -341.5"))))
      ...
      .addChild(new Anchor().setDescription("Red oaks").setUrl(new MFString("\"javascript:window.open('./data/625.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("457.39999389648438 0.10000000149011612 -359.60000610351563"))))
      .addChild(new Anchor().setDescription("West Notts College").setUrl(new MFString("\"javascript:window.open('./data/626.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("454.20001220703125 0.10000000149011612 -358.60000610351563"))))
      .addChild(new Anchor().setDescription("Willow Wood Day Centre").setUrl(new MFString("\"javascript:window.open('./data/628.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("450.60000610351563 0.10000000149011612 -358.60000610351563"))))
      ...
      .addChild(new Anchor().setDescription("27a Access Artspace").setUrl(new MFString("\"javascript:window.open('./data/633.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("n")
          .addFieldValue(new fieldValue().setName("pos").setValue("458.89999389648438 0.10000000149011612 -304.29998779296875"))))
      ...
      .addChild(new Anchor().setDescription("Bamboozle Theatre Company").setUrl(new MFString("\"javascript:window.open('./data/638.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("r")
          .addFieldValue(new fieldValue().setName("pos").setValue("457.10000610351563 0.10000000149011612 -300.79998779296875"))))
      .addChild(new Anchor().setDescription("Ellesmere College, Leicester").setUrl(new MFString("\"javascript:window.open('./data/640.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("456.79998779296875 0.10000000149011612 -302.60000610351563"))))
      .addChild(new Anchor().setDescription("Ashmount School, Loughborough").setUrl(new MFString("\"javascript:window.open('./data/642.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("453.29998779296875 0.10000000149011612 -318.60000610351563"))))
      .addChild(new Anchor().setDescription("Mantle Community Arts").setUrl(new MFString("\"javascript:window.open('./data/648.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("r")
          .addFieldValue(new fieldValue().setName("pos").setValue("442.39999389648438 0.10000000149011612 -314.5"))))
      .addChild(new Anchor().setDescription("Forrest Way School").setUrl(new MFString("\"javascript:window.open('./data/650.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("444.60000610351563 0.10000000149011612 -313.70001220703125"))))
      .addChild(new Anchor().setDescription("Ibstock Community College").setUrl(new MFString("\"javascript:window.open('./data/652.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("440.60000610351563 0.10000000149011612 -310.39999389648438"))))
      .addChild(new Anchor().setDescription("Artlink East").setUrl(new MFString("\"javascript:window.open('./data/658.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("r")
          .addFieldValue(new fieldValue().setName("pos").setValue("491.60000610351563 0.10000000149011612 -335.70001220703125"))))
      .addChild(new Anchor().setDescription("United Hospitals and NHS Trust Lincolnshire").setUrl(new MFString("\"javascript:window.open('./data/660.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("491.39999389648438 0.10000000149011612 -336.79998779296875"))))
      .addChild(new Anchor().setDescription("Ancaster Day Centre").setUrl(new MFString("\"javascript:window.open('./data/662.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("496.89999389648438 0.10000000149011612 -368.89999389648438"))))
      ...
      .addChild(new Anchor().setDescription("Nene Day Centre, Northamtpon").setUrl(new MFString("\"javascript:window.open('./data/667.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("477.10000610351563 0.10000000149011612 -260"))))
      .addChild(new Anchor().setDescription("Delapre Middle School, Northampton").setUrl(new MFString("\"javascript:window.open('./data/668.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("474.70001220703125 0.10000000149011612 -259.10000610351563"))))
      ...
      .addChild(new Anchor().setDescription("New Perspectives").setUrl(new MFString("\"javascript:window.open('./data/670.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("n")
          .addFieldValue(new fieldValue().setName("pos").setValue("457.39999389648438 0.10000000149011612 -262.70001220703125"))))
      ...
      .addChild(new Anchor().setDescription("Silverstone County Infants School").setUrl(new MFString("\"javascript:window.open('./data/672.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("school")
          .addFieldValue(new fieldValue().setName("pos").setValue("466.89999389648438 0.10000000149011612 -243.80000305175781"))))
      .addChild(new Anchor().setDescription("Riverside Resource Centre, Towcester").setUrl(new MFString("\"javascript:window.open('./data/677.html','details','height=550,width=400,top=50,left=50,menubar=no,status=no,toolbar=no,titlebar=no');\""))
        .addChild(new ProtoInstance().setName("institute")
          .addFieldValue(new fieldValue().setName("pos").setValue("469.5 0.10000000149011612 -249.80000305175781"))))
      ...
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setTransparency(0.20000000298023224).setEmissiveColor(1.0,0.0,0.0)))
      ...
      .addChild(new Shape()
        .setAppearance(new Appearance()
          .setMaterial(new Material().setTransparency(0.20000000298023224).setEmissiveColor(1.0,0.0,1.0)))

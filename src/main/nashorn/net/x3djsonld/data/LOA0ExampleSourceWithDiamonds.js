...
function LOA0ExampleSourceWithDiamonds
...
LOA0ExampleSourceWithDiamonds.prototype = {
  ...
  initialize : function ()
  {
	...
	/** Large attribute array: fieldValue value field, scene-graph level=4, element #432, 62 total values */
	this.fieldValue_info_4_432_value = new SFStringObject("\"authorName=Matthew T. Beitler\" \"authorEmail=beitler@cis.upenn.edu or beitler@acm.org\" \"creationDate=05/12/99\" \"copyright=Copyright 1999-2003, Matthew T. Beitler\" \"humanoidVersion=JointCenters 200x, LOA&#8209;0\" \"usageRestrictions=
	...
	/** Large attribute array: WorldInfo info field, scene-graph level=4, element #434, 74 total values */
	this.WorldInfo_4_434_info = new MFStringObject(new MFStringObject("\"
  ...
  .setHead(new headObject()
    ...
    .addMeta(new metaObject().setName("source").setContent("LOA0ExampleSourceWithDiamonds.wrl")))
  .setScene(new SceneObject()
    ...
    .addChild(new ProtoInstanceObject("humanoid_2", "Humanoid").setDEF("humanoid_2").setName("Humanoid")
      ...
      .addFieldValue(new fieldValueObject().setName("info").setValue(this.fieldValue_info_4_432_value)))
    .addChild(new GroupObject("JointCenters_WorldInfo")
      .addChild(new WorldInfoObject().setInfo(this.WorldInfo_4_434_info).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;0")))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new LOA0ExampleSourceWithDiamonds();
		print ("LOA0ExampleSourceWithDiamonds execution self-validation test results: " + testObject.validateSelf());
	}
}
new LOA0ExampleSourceWithDiamonds().main();
      ...
      .addChild(new ShapeObject()
        ...
        .setAppearance(new AppearanceObject()
          ...
          .setTexture(new ComposedCubeMapTextureObject("texture")
            .setBackTexture(new ImageTextureObject().setUrl(new MFStringObject("\"resources/images/bBK.png\" \"https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBK.png\"")))
            .setBottomTexture(new ImageTextureObject().setUrl(new MFStringObject("\"resources/images/bBT.png\" \"https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBT.png\"")))
            .setFrontTexture(new ImageTextureObject().setUrl(new MFStringObject("\"resources/images/bFR.png\" \"https://coderextreme.net/X3DJSONLD/src/main/resources/images/bFR.png\"")))
            .setLeftTexture(new ImageTextureObject().setUrl(new MFStringObject("\"resources/images/bLF.png\" \"https://coderextreme.net/X3DJSONLD/src/main/resources/images/bLF.png\"")))
            .setRightTexture(new ImageTextureObject().setUrl(new MFStringObject("\"resources/images/bRT.png\" \"https://coderextreme.net/X3DJSONLD/src/main/resources/images/bRT.png\"")))
            .setTopTexture(new ImageTextureObject().setUrl(new MFStringObject("\"resources/images/bTP.png\" \"https://coderextreme.net/X3DJSONLD/src/main/resources/images/bTP.png\""))))

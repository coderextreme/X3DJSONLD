...
/**
 * <p> a sphere. </p>
 <p> Related links: sphere_sail.java source, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;" summary="Scene Metadata">
		<tr style="background-color:silver; border-color:silver;">
			<td style="text-align:center; padding:10px 0px;"><i>meta tags</i></td>
			<td style="text-align:left;   padding:10px 0px;">net.x3djsonld.data.sphere_sail&nbsp; Document Metadata </td>
		</tr>
...
sphere_sail.prototype = {
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new sphere_sail();
		print ("sphere_sail execution self-validation test results: " + testObject.validateSelf());
	}
}
new sphere_sail().main();
...
HeadsUpDisplayExample.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new ExternProtoDeclare().setName("HeadsUpDisplay").setAppinfo("Heads-up display (HUD) keeps child geometry aligned on screen in a consistent location").setUrl(new MFString("\"HeadsUpDisplayPrototype.x3d#HeadsUpDisplay\" \"http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/HeadsUpDisplayPrototype.x3d#HeadsUpDisplay\" \"HeadsUpDisplayPrototype.wrl#HeadsUpDisplay\" \"http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/HeadsUpDisplayPrototype.wrl#HeadsUpDisplay\""))
      .addField(new field().setAccessType("inputOutput").setName("screenOffset").setType("SFVec3f").setAppinfo("offset position for HUD relative to current view location, default 0 0 -5"))
      .addField(new field().setAccessType("inputOutput").setName("children").setType("MFNode").setAppinfo("X3D content positioned at HUD offset"))
      .addField(new field().setAccessType("outputOnly").setName("position_changed").setType("SFVec3f").setAppinfo("HUD position update (in world coordinates) relative to original location"))
      .addField(new field().setAccessType("outputOnly").setName("orientation_changed").setType("SFRotation").setAppinfo("HUD orientation update relative to original location")))
    .addChild(new Background("SandyShallowBottom").setSkyAngle(Java.to([0.04,0.05,0.1,1.309,1.570], Java.type("float[]"))).setGroundAngle(Java.to([0.05,1.52,1.56,1.5707], Java.type("float[]"))).setGroundColor(new MFColor(Java.to([0.2,0.2,0.0,0.3,0.3,0.0,0.5,0.5,0.3,0.1,0.3,0.4,0.0,0.2,0.4], Java.type("float[]")))).setSkyColor(new MFColor(Java.to([0.8,0.8,0.2,0.8,0.8,0.2,0.1,0.1,0.6,0.1,0.1,0.6,0.1,0.25,0.8,0.6,0.6,0.9], Java.type("float[]")))))
    ...
    .addChild(new ProtoInstance("HeadsUpDisplayInstance", "HeadsUpDisplay").setDEF("HeadsUpDisplayInstance").setName("HeadsUpDisplay")
      ...
      .addFieldValue(new fieldValue().setName("children")
        .addChild(new Shape()
          .setGeometry(new Text().setString(new MFString("\"HUD text stays fixed\" \"while user navigates\""))
            .setFontStyle(new FontStyle().setJustify(new MFString("\"MIDDLE\" \"MIDDLE\"")).setSize(0.3)))
          .setAppearance(new Appearance()
            .setMaterial(new Material().setDiffuseColor(0.894118,0.819608,1.0))))))
    .addChild(new Inline().setUrl(new MFString("\"../HelloWorld.x3d\" \"http://X3dGraphics.com/examples/X3dForWebAuthors/HelloWorld.x3d\" \"../HelloWorld.wrl\" \"http://X3dGraphics.com/examples/X3dForWebAuthors/HelloWorld.wrl\""))));
  },

...
HAnimModelHandLeft.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("hanim_Hand_Left").setName("Hand_Left").setVersion("2.0").setLoa(4)
      .addComments(" HAnimHumanoid original info='\"authorName=Kwan-Hee YOO, Don Brutzman and Joe Williams\"' ")
      .addChild(new MetadataSet().setName("HAnimHumanoid.info").setReference(this.MetadataSet_HAnimHumanoid.info_4_25_reference)

...
rubikOnFire.prototype = {
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/rubikOnFire.x3d"))
  ...
  .setScene(new Scene()
    ...
    .addChild(new ProtoDeclare().setName("anyShape")
      .setProtoInterface(new ProtoInterface()
        ...
        .addField(new field().setAccessType("inputOutput").setName("myShape").setType("SFNode")
          .addChild(new Sphere())))

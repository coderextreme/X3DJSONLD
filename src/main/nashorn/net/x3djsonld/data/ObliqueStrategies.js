...
ObliqueStrategies.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new NavigationInfo().setType(new MFString("\"NONE\"")))
    .addChild(new Background().setSkyColor(new MFColor(Java.to([0.419608,0.427451,1.0], Java.type("float[]")))))
    .addChild(new Transform().setTranslation(0.0,1.0,0.0).setScale(0.4,0.4,0.4)
      ...
      .addChild(new Shape()
        .setGeometry(new Text().setString(new MFString("\"Oblique Strategies\" \"\" \"(Over One Hundred Worthwhile Dilemmas)\" \"\" \"by Brian Eno and Peter Schmidt\""))
          .setFontStyle(new FontStyle("MessageFont").setJustify(new MFString("\"MIDDLE\" \"MIDDLE\"")).setFamily(new MFString("\"SANS\"")).setStyle("BOLD")))
      ...
      .addChild(new Transform().setScale(10.0,3.0,1.0)
        .addChild(new Shape("HeadlineClickSurface")
          .setGeometry(new IndexedFaceSet().setSolid(false).setCoordIndex(Java.to([0,1,2,3,-1], Java.type("int[]")))
            .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([1.0,1.0,0.0,1.0,-1.0,0.0,-1.0,-1.0,0.0,-1.0,1.0,0.0], Java.type("float[]"))))))
          .setAppearance(new Appearance()
            .setMaterial(new Material().setShininess(0.07).setAmbientIntensity(0.245763).setSpecularColor(0.336735,0.051091,0.051091).setDiffuseColor(0.34773,0.090909,0.005289).setTransparency(0.8))))))
    .addChild(new Script("TextScript").setUrl(new MFString("\"ObliqueStrategiesScript.js\" \"https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategiesScript.js\""))
      ...
      .addField(new field().setAccessType("initializeOnly").setName("index").setType("SFInt32").setValue("0").setAppinfo("index for active strategy card, -1 means no selection"))
      .addField(new field().setAccessType("outputOnly").setName("string_changed").setType("MFString").setAppinfo("latest strategy card value"))
      .addField(new field().setAccessType("outputOnly").setName("textToSpeechUrl").setType("MFString").setAppinfo("\"url to invoke Google Translate\""))
      .addField(new field().setAccessType("outputOnly").setName("newCardTime").setType("SFTime").setAppinfo("activate Sound node"))
      .addField(new field().setAccessType("inputOnly").setName("selectPreviousCard").setType("SFBool"))
      .addField(new field().setAccessType("inputOnly").setName("selectNextCard").setType("SFBool"))
      .addField(new field().setAccessType("inputOnly").setName("selectRandomCard").setType("SFBool"))
      .addField(new field().setAccessType("initializeOnly").setName("traceEnabled").setType("SFBool").setValue("true").setAppinfo("controls console tracing")))
    .addChild(new Transform("CardTransform").setTranslation(0.0,-1.5,0.0).setScale(0.4,0.4,0.4)
      .addChild(new Shape()
        .setGeometry(new Text("CardText")
          .setFontStyle(new FontStyle().setJustify(new MFString("\"MIDDLE\" \"MIDDLE\"")).setFamily(new MFString("\"SANS\"")).setStyle("BOLD")))
        .setAppearance(new Appearance()
          .setMaterial(new Material().setDiffuseColor(1.0,1.0,1.0))))
    ...
    .addChild(new Transform().setTranslation(-3.2,2.5,0.0).setScale(0.4,0.4,0.4)
    ...
    .addChild(new Transform().setTranslation(-3.3,-0.5,0.0).setScale(0.4,0.4,0.4)

        ...
        .addChild(new Group("ArrowGreen")
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance("Green")
              .setMaterial(new Material().setEmissiveColor(.05,.2,.05).setDiffuseColor(.1,.6,.1))))
          ...
          .addChild(new Billboard()
            .addChild(new Shape()
              .setAppearance(new Appearance("LABEL_APPEARANCE")
                .setMaterial(new Material().setEmissiveColor(.33,.33,.1).setDiffuseColor(1.0,1.0,.3)))
              .setGeometry(new Text().setString(new MFString("\"Y\""))
                .setFontStyle(new FontStyle("LABEL_FONT").setJustify(new MFString("\"MIDDLE\" \"MIDDLE\"")).setFamily(new MFString("\"SANS\"")).setSize(.2)))))))
          ...
          .addChild(new Group("ArrowRed")
            .addChild(new Shape()
              ...
              .setAppearance(new Appearance("Red")
                .setMaterial(new Material().setEmissiveColor(.33,0.0,0.0).setDiffuseColor(.7,.1,.1))))
            .addChild(new Transform().setTranslation(0.0,1.0,0.0)
              .addChild(new Shape()
                .setGeometry(new Cone().setUSE("ArrowCone"))
                .setAppearance(new Appearance().setUSE("Red")))))
          .addChild(new Transform().setTranslation(.072,1.1,0.0).setRotation(0.0,0.0,1.0,1.57079)
          ...
          .addChild(new Group("ArrowBlue")
            .addChild(new Shape()
              ...
              .setAppearance(new Appearance("Blue")
                .setMaterial(new Material().setEmissiveColor(.1,.1,.33).setDiffuseColor(.3,.3,1.0))))
            .addChild(new Transform().setTranslation(0.0,1.0,0.0)
              .addChild(new Shape()
                .setGeometry(new Cone().setUSE("ArrowCone"))
                .setAppearance(new Appearance().setUSE("Blue")))))
          .addChild(new Transform().setTranslation(0.0,1.1,.072).setRotation(1.0,0.0,0.0,-1.57079)
            .addComments(" note label rotated back to original coordinate frame ")
            .addChild(new Billboard()
              .addChild(new Shape()
                .setAppearance(new Appearance().setUSE("LABEL_APPEARANCE"))

...
DiamondManLOA_1.prototype = {
  ...
  initialize : function ()
  {
	...
	this.WorldInfo_3_26_info = new MFString(new MFString("\"HAnim 2.0 Default Joint Centers, Level Of Articulation (LOA) 1 -------------------------------------------------------- HANIM 1.1 (VRML 2.0) Author name: eMpTy (a.k.a. Matthew T. Beitler) HANIM 1.1 (VRML 2.0) Author email: beitler@graphics.cis.upenn.edu or beitler@acm.org HANIM 1.1 (VRML 2.0) Author homepage: http://www.cis.upenn.edu/~beitler HANIM 1.1 (VRML 2.0) Compliance Date: May 12, 1999 HANIM 1.1 Compliance Information: http://ece.uwaterloo.ca/~HAnim/ Construction Info (joint centers): The joint centers of this figure are based on the work of Norman Badler, director of the Center for Human Modeling and Simulation at the University of Pennsylvania. The original document which these joint centers are based on can be found at: http://www.cis.upenn.edu/~badler/anthro/89-71.ps, .pdf\""));
	...
	this.MetadataString_usageRestrictions_5_33_value = new MFString(new MFString("\"PERMISSION TO FULLY USE THIS SCENE GRAPH IS GRANTED PROVIDED THIS COPYRIGHT INFORMATION AND DOCUMENTATION OF THE ORIGINAL AUTHOR IS INCLUDED. This humanoid scene graph is provided _as-is_ and without warranty of any kind express implied or otherwise including without limitation any warranty of merchantability or fitness for a particular purpose.\""));
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setInfo(this.WorldInfo_3_26_info).setTitle("HANIM 1.1 Default Joint Centers, LOA1"))
    ...
    .addChild(new HAnimHumanoid("hanim_humanoid").setName("humanoid").setVersion("1.0")
      ...
      .addChild(new MetadataSet().setName("HAnimHumanoid.info").setReference(this.MetadataSet_HAnimHumanoid.info_4_29_reference)
        ...
        .addValue(new MetadataString().setName("humanoidVersion").setValue(new MFString("\"JointCenters 1.1 LOA1\"")))
        .addValue(new MetadataString().setName("usageRestrictions").setValue(this.MetadataString_usageRestrictions_5_33_value)))
            ...
            .addChild(new Transform().setTranslation(0.0,0.9149,0.0016)
              .addChild(new Shape("DiamondShape")
                .setGeometry(new IndexedFaceSet().setCreaseAngle(0.5).setCoordIndex(Java.to([0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,1,-1,5,2,1,-1,5,3,2,-1,5,4,3,-1,5,1,4,-1], Java.type("int[]")))
                  .setCoord(new Coordinate("points").setPoint(new MFVec3f(Java.to([0.0,0.01,0.0,-0.01,0.0,0.0,0.0,0.0,0.01,0.01,0.0,0.0,0.0,0.0,-0.01,0.0,-0.01,0.0], Java.type("float[]"))))))
          ...
          .addChild(new HAnimJoint("hanim_l_shoulder").setName("l_shoulder").setCenter(0.2029,1.4376,-0.0387)
            .addChild(new HAnimSegment("hanim_l_upperarm").setName("l_upperarm")
              .addChild(new Transform().setTranslation(0.2029,1.4376,-0.0387)
                .addChild(new Shape().setUSE("DiamondShape")))
              .addChild(new Transform("l_upperarm_adjust").setCenter(0.182,1.22,-0.047).setTranslation(0.2029,1.4376,-0.0387).setRotation(1.0,0.0,0.0,0.119))
            ...
            .addChild(new HAnimJoint("hanim_l_elbow").setName("l_elbow").setCenter(0.2014,1.1357,-0.0682)
              .addChild(new HAnimSegment("hanim_l_forearm").setName("l_forearm")
                .addChild(new Transform().setTranslation(0.2014,1.1357,-0.0682)
                  .addChild(new Shape().setUSE("DiamondShape")))
                .addChild(new Transform("l_forearm_adjust").setRotation(-1.0,0.0,0.0,0.1).setCenter(0.198,0.961,-0.0405).setTranslation(0.2014,1.1357,-0.0682))
              ...
              .addChild(new HAnimJoint("hanim_l_wrist").setName("l_wrist").setCenter(0.1984,0.8663,-0.0583)
                .addChild(new HAnimSegment("hanim_l_hand").setName("l_hand")
                  .addChild(new Transform().setTranslation(0.1984,0.8663,-0.0583)
                    .addChild(new Shape().setUSE("DiamondShape")))
                  .addChild(new Transform("l_hand_adjust").setRotation(-0.06361,-0.9967,0.04988,1.333).setTranslation(0.1984,0.8663,-0.0583).setCenter(0.213,0.811,-0.0338))
          ...
          .addChild(new HAnimJoint("hanim_r_shoulder").setName("r_shoulder").setCenter(-0.1907,1.4407,-0.0325)
            .addChild(new HAnimSegment("hanim_r_upperarm").setName("r_upperarm")
              .addChild(new Transform().setTranslation(-0.1907,1.4407,-0.0325)
                .addChild(new Shape().setUSE("DiamondShape")))
              .addChild(new Transform("r_upperarm_adjust").setCenter(-0.182,1.22,-0.047).setTranslation(-0.1907,1.4407,-0.0325).setRotation(1.0,0.0,0.0,0.0836))
            ...
            .addChild(new HAnimJoint("hanim_r_elbow").setName("r_elbow").setCenter(-0.1949,1.1388,-0.0620)
              .addChild(new HAnimSegment("hanim_r_forearm").setName("r_forearm")
                .addChild(new Transform().setTranslation(-0.1949,1.1388,-0.0620)
                  .addChild(new Shape().setUSE("DiamondShape")))
                .addChild(new Transform("r_forearm_adjust").setTranslation(-0.1949,1.1388,-0.0620).setCenter(-0.198,0.961,-0.0397).setRotation(-1.0,0.0,0.0,0.1254))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		print ("DiamondManLOA_1 execution self-validation test results: " + testObject.validateSelf());
	}
}

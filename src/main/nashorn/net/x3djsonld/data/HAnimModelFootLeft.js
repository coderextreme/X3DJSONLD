...
HAnimModelFootLeft.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("Humanoid_Left_Foot").setName("Humanoid_Left_Foot").setInfo(new MFString("\"humanoidVersion=2.0\"")).setJointBindingPositions(new MFVec3f(Java.to([0.0,0.0,0.0], Java.type("float[]")))).setJointBindingRotations(new MFRotation(Java.to([0.0,0.0,1.0,0.0], Java.type("float[]")))).setJointBindingScales(new MFVec3f(Java.to([1.0,1.0,1.0], Java.type("float[]")))).setVersion("2.0")
                  ...
                  .addChild(new HAnimJoint("l_f_Interphalangeal_joint").setName("l_f_Interphalangeal_joint").setCenter(-0.1,-1.05,0.0)
                    .addChild(new HAnimSegment("l_distal_phalanges1").setName("l_distal_phalanges1")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                        .setGeometry(new IndexedLineSet("tiptoe_l_distal_phalanges1").setDEF("tiptoe_l_distal_phalanges1").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                    ...
                    .addChild(new HAnimJoint("l_f_distal_Interphalangeal_joint2").setName("l_f_distal_Interphalangeal_joint2").setCenter(0.05,-1.12,0.0)
                      .addChild(new HAnimSegment("l_distal_phalanges2").setName("l_distal_phalanges2")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                          .setGeometry(new IndexedLineSet("tiptoe_l_f_distal_Interphalangeal_joint2").setDEF("tiptoe_l_f_distal_Interphalangeal_joint2").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                    ...
                    .addChild(new HAnimJoint("l_f_distal_Interphalangeal_joint3").setName("l_f_distal_Interphalangeal_joint3").setCenter(0.15,-1.13,0.0)
                      .addChild(new HAnimSegment("l_distal_phalanges3").setName("l_distal_phalanges3")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                          .setGeometry(new IndexedLineSet("tiptoe_l_f_distal_Interphalangeal_joint3").setDEF("tiptoe_l_f_distal_Interphalangeal_joint3").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                    ...
                    .addChild(new HAnimJoint("l_f_distal_Interphalangeal_joint4").setName("l_f_distal_Interphalangeal_joint4").setCenter(0.25,-1.1,0.0)
                      .addChild(new HAnimSegment("l_distal_phalanges4").setName("l_distal_phalanges4")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                          .setGeometry(new IndexedLineSet("tiptoe_l_f_distal_Interphalangeal_joint4").setDEF("tiptoe_l_f_distal_Interphalangeal_joint4").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                    ...
                    .addChild(new HAnimJoint("l_f_distal_Interphalangeal_joint5").setName("l_f_distal_Interphalangeal_joint5").setCenter(0.34,-1.05,0.0)
                      .addChild(new HAnimSegment("l_distal_phalanges5").setName("l_distal_phalanges5")
                        ...
                        .addChild(new Shape()
                          .setAppearance(new Appearance()
                            .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                          .setGeometry(new IndexedLineSet("tiptoe_l_f_distal_Interphalangeal_joint5").setDEF("tiptoe_l_f_distal_Interphalangeal_joint5").setCoordIndex(Java.to([0,1], Java.type("int[]")))

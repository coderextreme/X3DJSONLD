...
NeedClassName.prototype = {
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new HAnimHumanoidObject("hanim_Foot_Left").setName("Foot_Left").setVersion("2.0")
      ...
      .addSkeleton(new HAnimJointObject("hanim_humanoid_root").setName("humanoid_root")
        ...
        .addChild(new HAnimJointObject("hanim_l_talocrural").setName("l_talocrural").setDescription("connection joint of foot to leg above")
          ...
          .addComments(" TCN ")
          .addChild(new HAnimJointObject("hanim_l_talocalcaneonavicular").setName("l_talocalcaneonavicular").setCenter(0.0,-0.3,0.0)
            ...
            .addComments(" CN1 ")
            .addChild(new HAnimJointObject("hanim_l_cuneonavicular_1").setName("l_cuneonavicular_1").setCenter(-0.1,-0.45,0.0)
              ...
              .addChild(new HAnimJointObject("hanim_l_tarsometatarsal_1").setName("l_tarsometatarsal_1").setCenter(-0.1,-0.6,0.0)
                ...
                .addChild(new HAnimJointObject("hanim_l_metatarsophalangeal_1").setName("l_metatarsophalangeal_1").setCenter(-0.1,-0.9,0.0)
                  ...
                  .addChild(new HAnimJointObject("hanim_l_tarsal_interphalangeal_1").setName("l_tarsal_interphalangeal_1").setCenter(-0.1,-1.05,0.0)
            ...
            .addComments(" CN2 ")
            .addChild(new HAnimJointObject("hanim_l_cuneonavicular_2").setName("l_cuneonavicular_2").setCenter(0.0,-0.45,0.0)
              ...
              .addChild(new HAnimJointObject("hanim_l_tarsometatarsal_2").setName("l_tarsometatarsal_2").setCenter(0.05,-0.6,0.0)
                ...
                .addChild(new HAnimJointObject("hanim_l_metatarsophalangeal_2").setName("l_metatarsophalangeal_2").setCenter(0.05,-0.9,0.0)
                  ...
                  .addChild(new HAnimJointObject("hanim_l_tarsal_proximal_interphalangeal_2").setName("l_tarsal_proximal_interphalangeal_2").setCenter(0.05,-1.05,0.0)
                    ...
                    .addChild(new HAnimJointObject("hanim_l_tarsal_distal_interphalangeal_2").setName("l_tarsal_distal_interphalangeal_2").setCenter(0.05,-1.12,0.0)
            ...
            .addComments(" CN3 ")
            .addChild(new HAnimJointObject("hanim_l_cuneonavicular_3").setName("l_cuneonavicular_3").setCenter(0.1,-0.4,0.0)
              ...
              .addChild(new HAnimJointObject("hanim_l_tarsometatarsal_3").setName("l_tarsometatarsal_3").setCenter(0.15,-0.6,0.0)
                ...
                .addChild(new HAnimJointObject("hanim_l_metatarsophalangeal_3").setName("l_metatarsophalangeal_3").setCenter(0.15,-0.9,0.0)
                  ...
                  .addChild(new HAnimJointObject("hanim_l_tarsal_proximal_interphalangeal_3").setName("l_tarsal_proximal_interphalangeal_3").setCenter(0.15,-1.05,0.0)
                    ...
                    .addChild(new HAnimJointObject("hanim_l_tarsal_distal_interphalangeal_3").setName("l_tarsal_distal_interphalangeal_3").setCenter(0.15,-1.13,0.0)
          ...
          .addComments(" CC ")
          .addChild(new HAnimJointObject("hanim_l_calcaneocuboid").setName("l_calcaneocuboid").setCenter(0.2,0.3,0.0)
            ...
            .addComments(" TT ")
            .addChild(new HAnimJointObject("hanim_l_transversetarsal").setName("l_transversetarsal").setCenter(0.21,-0.3,0.0)
              ...
              .addComments(" TMT4 ")
              .addChild(new HAnimJointObject("hanim_l_tarsometatarsal_4").setName("l_tarsometatarsal_4").setCenter(0.25,-0.58,0.0)
                ...
                .addChild(new HAnimJointObject("hanim_l_metatarsophalangeal_4").setName("l_metatarsophalangeal_4").setCenter(0.25,-0.87,0.0)
                  ...
                  .addChild(new HAnimJointObject("hanim_l_tarsal_proximal_interphalangeal_4").setName("l_tarsal_proximal_interphalangeal_4").setCenter(0.25,-1.0,0.0)
                    ...
                    .addChild(new HAnimJointObject("hanim_l_tarsal_distal_interphalangeal_4").setName("l_tarsal_distal_interphalangeal_4").setCenter(0.25,-1.1,0.0)
              ...
              .addComments(" TMT5 ")
              .addChild(new HAnimJointObject("hanim_l_tarsometatarsal_5").setName("l_tarsometatarsal_5").setCenter(0.33,-0.52,0.0)
                ...
                .addChild(new HAnimJointObject("hanim_l_metatarsophalangeal_5").setName("l_metatarsophalangeal_5").setCenter(0.34,-0.8,0.0)
                  ...
                  .addChild(new HAnimJointObject("hanim_l_tarsal_proximal_interphalangeal_5").setName("l_tarsal_proximal_interphalangeal_5").setCenter(0.34,-0.95,0.0)
                    ...
                    .addChild(new HAnimJointObject("hanim_l_tarsal_distal_interphalangeal_5").setName("l_tarsal_distal_interphalangeal_5").setCenter(0.34,-1.05,0.0)
      ...
      .addJoints(new HAnimJointObject().setUSE("hanim_l_calcaneocuboid"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_cuneonavicular_1"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_cuneonavicular_2"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_cuneonavicular_3"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_metatarsophalangeal_1"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_metatarsophalangeal_2"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_metatarsophalangeal_3"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_metatarsophalangeal_4"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_metatarsophalangeal_5"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_talocalcaneonavicular"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_talocrural"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsal_distal_interphalangeal_2"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsal_distal_interphalangeal_3"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsal_distal_interphalangeal_4"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsal_distal_interphalangeal_5"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsal_interphalangeal_1"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsal_proximal_interphalangeal_2"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsal_proximal_interphalangeal_3"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsal_proximal_interphalangeal_4"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsal_proximal_interphalangeal_5"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsometatarsal_1"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsometatarsal_2"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsometatarsal_3"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsometatarsal_4"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_tarsometatarsal_5"))
      .addJoints(new HAnimJointObject().setUSE("hanim_l_transversetarsal"))

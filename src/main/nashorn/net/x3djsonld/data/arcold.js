...
"		}" + "\n")
    ...
    .addChild(new ProtoDeclare().setName("x3dconnector")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setAccessType("inputOutput").setName("startnode").setType("SFNode"))
        .addField(new field().setAccessType("inputOutput").setName("endnode").setType("SFNode"))

...
Figure31_7DonutExternalPrototype.prototype = {
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ExternProtoDeclareObject().setName("Donut").setUrl(new MFStringObject("\"Figure31_6DonutPrototype.wrl#Donut\" \"https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter31Prototypes/Figure31_6DonutPrototype.wrl#Donut\" \"Figure31_6DonutPrototype.x3d#Donut\" \"https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter31Prototypes/Figure31_6DonutPrototype.x3d#Donut\""))
      .addField(new fieldObject().setAccessType("initializeOnly").setName("crossSectionRadius").setType("SFFloat"))
      .addField(new fieldObject().setAccessType("initializeOnly").setName("spineRadius").setType("SFFloat"))
      .addField(new fieldObject().setAccessType("initializeOnly").setName("crossSectionResolution").setType("SFInt32"))
      .addField(new fieldObject().setAccessType("initializeOnly").setName("spineResolution").setType("SFInt32"))
      .addField(new fieldObject().setAccessType("inputOnly").setName("set_crossSectionRadius").setType("SFFloat"))
      .addField(new fieldObject().setAccessType("inputOnly").setName("set_spineRadius").setType("SFFloat")))
    .addChild(new ExternProtoDeclareObject().setName("LightOak").setUrl(new MFStringObject("\"Figure31_4WoodAppearancePrototypesLibrary.wrl#LightOak\" \"https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter31Prototypes/Figure31_4WoodAppearancePrototypesLibrary.wrl#LightOak\" \"Figure31_4WoodAppearancePrototypesLibrary.x3d#LightOak\" \"https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter31Prototypes/Figure31_4WoodAppearancePrototypesLibrary.x3d#LightOak\""))
      .addField(new fieldObject().setAccessType("inputOutput").setName("textureTransform").setType("SFNode")))
    .addChild(new ViewpointObject().setDescription("Click to pick a size").setPosition(0.0,7.0,12.0).setOrientation(1.0,0.0,0.0,-0.52))
    .addComments(" Donut instances from prototypes ")
    .addChild(new TransformObject().setTranslation(0.0,2.0,0.0)
      .addChild(new ShapeObject()
        .setGeometry(new ProtoInstanceObject().setName("Donut")
        ...
        .setAppearance(new ProtoInstanceObject().setName("LightOak")
          .addFieldValue(new fieldValueObject().setName("textureTransform")
            .addChild(new TextureTransformObject().setCenter(-0.0,5.0).setTranslation(0.5,0.0).setRotation(0.758).setScale(2.0,0.5))))))
    .addComments(" Hmmm, what size donut do you really want? ")
    .addChild(new TimeSensorObject("Clock").setCycleInterval(10).setLoop(true))
    .addChild(new ScalarInterpolatorObject("DonutThickness").setKey(Java.to([0.0,0.4,0.5,0.9,1.0], Java.type("float[]"))).setKeyValue(Java.to([0.75,1.25,1.25,0.75,0.75], Java.type("float[]"))))
    .addChild(new TransformObject().setTranslation(0.0,-2.0,0.0)
      .addChild(new ShapeObject()
        .setGeometry(new ProtoInstanceObject("SpecialtyOfTheHouse", "Donut").setDEF("SpecialtyOfTheHouse").setName("Donut")
          .addFieldValue(new fieldValueObject().setName("crossSectionRadius").setValue("0.5"))
          .addFieldValue(new fieldValueObject().setName("spineRadius").setValue("2")))
        .setAppearance(new AppearanceObject()
          .setTexture(new ImageTextureObject().setUrl(new MFStringObject("\"../Chapter17Textures/icing.jpg\" \"https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter17Textures/icing.jpg\"")))))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		print ("Figure31_7DonutExternalPrototype execution self-validation test results: " + testObject.validateSelf());
	}
}

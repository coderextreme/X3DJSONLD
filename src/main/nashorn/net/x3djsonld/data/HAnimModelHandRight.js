...
HAnimModelHandRight.prototype = {
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new HAnimHumanoidObject("Humanoid_Right_hand").setName("Humanoid_Right_hand").setJointBindingPositions(new MFVec3fObject(Java.to([0.0,0.0,0.0], Java.type("float[]")))).setJointBindingRotations(new MFRotationObject(Java.to([0.0,0.0,1.0,0.0], Java.type("float[]")))).setJointBindingScales(new MFVec3fObject(Java.to([1.0,1.0,1.0], Java.type("float[]")))).setVersion("2.0")

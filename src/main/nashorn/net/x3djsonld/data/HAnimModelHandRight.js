...
HAnimModelHandRight.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new HAnimHumanoid("Humanoid_Right_hand").setName("Humanoid_Right_hand").setJointBindingPositions(new MFVec3f(Java.to([0.0,0.0,0.0], Java.type("float[]")))).setJointBindingRotations(new MFRotation(Java.to([0.0,0.0,1.0,0.0], Java.type("float[]")))).setJointBindingScales(new MFVec3f(Java.to([1.0,1.0,1.0], Java.type("float[]")))).setVersion("2.0")
                ...
                .addChild(new HAnimJoint("r_interphalangeal_joint_1").setName("r_interphalangeal_joint_1").setCenter(-0.35,0.4,0.0)
                  .addChild(new HAnimSegment("r_distal_phalanges1").setName("r_distal_phalanges1")
                    ...
                    .addChild(new Shape()
                      .setAppearance(new Appearance()
                        .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                      .setGeometry(new IndexedLineSet("fingertip_r_interphalangeal_joint_1").setDEF("fingertip_r_interphalangeal_joint_1").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                  ...
                  .addChild(new HAnimJoint("r_distal_interphalangeal_joint_2").setName("r_distal_interphalangeal_joint_2").setCenter(-0.24,0.87,0.0)
                    .addChild(new HAnimSegment("r_distal_phalanges2").setName("r_distal_phalanges2")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                        .setGeometry(new IndexedLineSet("fingertip_r_distal_interphalangeal_joint_2").setDEF("fingertip_r_distal_interphalangeal_joint_2").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                  ...
                  .addChild(new HAnimJoint("r_distal_interphalangeal_joint_3").setName("r_distal_interphalangeal_joint_3").setCenter(-0.08,0.96,0.0)
                    .addChild(new HAnimSegment("r_distal_phalanges3").setName("r_distal_phalanges3")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                        .setGeometry(new IndexedLineSet("fingertip_r_distal_interphalangeal_joint_3").setDEF("fingertip_r_distal_interphalangeal_joint_3").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                  ...
                  .addChild(new HAnimJoint("r_distal_interphalangeal_joint_4").setName("r_distal_interphalangeal_joint_4").setCenter(0.1,0.93,0.0)
                    .addChild(new HAnimSegment("r_distal_phalanx4").setName("r_distal_phalanx4")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                        .setGeometry(new IndexedLineSet("fingertip_r_distal_interphalangeal_joint_4").setDEF("fingertip_r_distal_interphalangeal_joint_4").setCoordIndex(Java.to([0,1], Java.type("int[]")))
                  ...
                  .addChild(new HAnimJoint("r_distal_interphalangeal_joint_5").setName("r_distal_interphalangeal_joint_5").setCenter(0.25,0.79,0.0)
                    .addChild(new HAnimSegment("r_distal_phalanges5").setName("r_distal_phalanges5")
                      ...
                      .addChild(new Shape()
                        .setAppearance(new Appearance()
                          .setMaterial(new Material().setEmissiveColor(1.0,1.0,1.0)))
                        .setGeometry(new IndexedLineSet("fingertip_r_distal_interphalangeal_joint_5").setDEF("fingertip_r_distal_interphalangeal_joint_5").setCoordIndex(Java.to([0,1], Java.type("int[]")))

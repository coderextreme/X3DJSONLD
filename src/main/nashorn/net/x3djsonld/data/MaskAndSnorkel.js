...
MaskAndSnorkel.prototype = {
  ...
  initialize : function ()
  {
	...
	this.Extrusion_8_35_crossSection = new MFVec2f(Java.to([0.0,0.013,0.00494,0.01196,0.00923,0.00923,0.01196,0.00494,0.013,0.00,0.01196,-0.00494,0.00923,-0.00923,0.00494,-0.01196,0.00,0.013], Java.type("float[]")));
  ...
  .setScene(new Scene()
    ...
    .addChild(new Background().setSkyColor(new MFColor(Java.to([0.0,0.0,0.9], Java.type("float[]")))))
        ...
        .addChild(new Transform().setTranslation(0.0,-0.02,0.0)
          .addChild(new Transform().setTranslation(0.035,-0.07,-0.02).setScale(0.9,0.9,0.9)
            .addChild(new Shape()
              ...
              .setGeometry(new Extrusion().setSpine(new MFVec3f(Java.to([-0.01,-0.04,0.0,0.0,0.0,0.0,0.03,0.05,0.0,0.05,0.2,0.0,0.03,0.4,0.03], Java.type("float[]")))).setCrossSection(this.Extrusion_8_25_crossSection))))
          .addChild(new Transform().setRotation(0.0,0.0,1.0,1.57).setTranslation(0.01,-0.04,-0.02).setScale(0.9,0.9,0.9)
            .addChild(new Shape()
              ...
              .setGeometry(new Extrusion().setSpine(new MFVec3f(Java.to([-0.01,-0.03,0.0,0.0,0.0,0.0,0.02,0.01,0.0], Java.type("float[]")))).setCrossSection(this.Extrusion_8_30_crossSection))))
          .addChild(new Transform().setRotation(0.0,0.0,1.0,-0.85).setTranslation(0.005,-0.01,-0.02).setScale(0.9,0.9,0.9)
            .addChild(new Shape()
              ...
              .setGeometry(new Extrusion().setSpine(new MFVec3f(Java.to([-0.02,-0.03,0.0,-0.01,-0.03,0.0,0.0,-0.0175,0.0,0.0,-0.0135,0.0,-0.01,0.0,0.0,-0.02,0.0,0.0], Java.type("float[]")))).setCrossSection(this.Extrusion_8_35_crossSection))))))
      .addChild(new Transform()

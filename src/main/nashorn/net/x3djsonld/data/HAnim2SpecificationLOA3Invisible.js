...
HAnim2SpecificationLOA3Invisible.prototype = {
  ...
  .setHead(new headObject()
    ...
    .addMeta(new metaObject().setName("title").setContent("HAnim2SpecificationLOA3Invisible.x3d"))
    ...
    .addMeta(new metaObject().setName("reference").setContent("HAnim2SpecificationLOA3Illustrated.x3d"))
    ...
    .addMeta(new metaObject().setName("refere
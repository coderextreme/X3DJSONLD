  ...
  .setScene(new Scene()
    .addChild(new ProtoDeclare().setName("myPrototype")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setAccessType("initializeOnly").setName("myInputRange").setType("SFVec3f").setValue("0.95 0.44 0.22")))
          ...
          .addChild(new Shape()
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setLanguage("GLSL")
                .addField(new field().setAccessType("initializeOnly").setName("decis").setType("SFVec3f"))
                .setIS(new IS()
              ...
              .addShaders(new ComposedShader("Cobweb").setLanguage("GLSL")
                .addField(new field().setAccessType("initializeOnly").setName("decis").setType("SFVec3f").setValue("0.95 0.77 0.44"))
                .addParts(new ShaderPart())
    ...
    .addChild(new WorldInfo().setTitle("SimpleShader")
      .setMetadata(new MetadataSet("Titania").setName("Titania").setReference("http://titania.create3000.de")
        ...
        .addValue(new MetadataSet("NavigationInfo").setName("NavigationInfo").setReference("http://titania.create3000.de")
          .addValue(new MetadataString("type").setName("type").setValue(new MFString("\"EXAMINE\"")).setReference("http://titania.create3000.de")))
        .addValue(new MetadataSet("Viewpoint").setName("Viewpoint").setReference("http://titania.create3000.de")
          .addValue(new MetadataDouble("position").setName("position").setValue(Java.to([6.24067728185014,0.00250837343276661,2.92117542307615], Java.type("double[]"))).setReference("http://titania.create3000.de"))
          .addValue(new MetadataDouble("orientation").setName("orientation").setValue(Java.to([-0.110173424710488,0.990158061907379,-0.0863065984000336,1.21146676119191], Java.type("double[]"))).setReference("http://titania.create3000.de"))
          .addValue(new MetadataDouble("centerOfRotation").setName("centerOfRotation").setValue(Java.to([-0.808320198626341,-0.358072370409949,0.22817191560906], Java.type("double[]"))).setReference("http://titania.create3000.de")))))
    .addChild(new ProtoInstance().setName("myPrototype")));
  },

...
HAnim1SpecificationLOA3Invisible.prototype = {
  ...
  initialize : function ()
  {
	...
	this.hanim_humanoid_3_42_info = new MFString(new MFString("\"authorName=Matthew T. Beitler Joe D. Williams Don Brutzman\" \"authorEmail=HAnim@web3D.org\" \"copyright=none\" \"creationDate=12 May 1999\" \"usageRestrictions=none\" \"humanoidVersion=1.0\" \"height=1.7504\""));
  ...
  .setScene(new Scene()
    ...
    .addChild(new Group("Original_WorldInfo")
      .addChild(new WorldInfo().setInfo(this.WorldInfo_4_31_info).setTitle("HANIM 200x Default Joint Centers, LOA3")))
    ...
    .addChild(new HAnimHumanoid("hanim_humanoid").setName("humanoid").setInfo(this.hanim_humanoid_3_42_info).setVersion("1.0")

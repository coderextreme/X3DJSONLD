...
HAnimPrototypes.prototype = {
  ...
  .setScene(new Scene()
    ...
    .addChild(new ProtoDeclare().setName("Humanoid1_1").setAppinfo(this.ProtoDeclare_Humanoid1_1_3_23_appinfo).setDocumentation("http://HAnim.org/Specifications/HAnim2001/part1/Humanoid.html")
      .setProtoInterface(new ProtoInterface()
        ...
        .addField(new field().setAccessType("inputOutput").setName("version").setType("SFString").setValue("1.1").setAppinfo("legal values: 1.1 or 2.0"))
        ...
        .addField(new field().setAccessType("inputOutput").setName("humanoidBody").setType("MFNode").setAppinfo("HAnim 1.1 field container for body head. Hint: replaced by 2.0 skeleton.").setDocumentation("http://HAnim.org/Specifications/HAnim1.1/#humanoid"))
    ...
    .addChild(new ProtoDeclare().setName("Joint").setAppinfo(this.ProtoDeclare_Joint_3_63_appinfo).setDocumentation("http://HAnim.org/Specifications/HAnim2001/part1/Joint.html")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setAccessType("inputOutput").setName("name").setType("SFString"))
        ...
        .addField(new field().setAccessType("inputOutput").setName("stiffness").setType("MFFloat").setValue("0 0 0"))
        .addField(new field().setAccessType("inputOutput").setName("translation").setType("SFVec3f").setValue("0 0 0"))
        .addField(new field().setAccessType("inputOutput").setName("rotation").setType("SFRotation").setValue("0 0 1 0"))
        .addField(new field().setAccessType("inputOutput").setName("scale").setType("SFVec3f").setValue("1 1 1"))
        .addField(new field().setAccessType("inputOutput").setName("scaleOrientation").setType("SFRotation").setValue("0 0 1 0"))
    ...
    .addChild(new ProtoDeclare().setName("Segment").setAppinfo(this.ProtoDeclare_Segment_3_95_appinfo).setDocumentation("http://HAnim.org/Specifications/HAnim2001/part1/Segment.html")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setAccessType("inputOutput").setName("name").setType("SFString"))
        ...
        .addField(new field().setAccessType("inputOutput").setName("momentsOfInertia").setType("MFFloat").setValue("0 0 0 0 0 0 0 0 0"))
        .addField(new field().setAccessType("initializeOnly").setName("bboxCenter").setType("SFVec3f").setValue("0 0 0"))
        .addField(new field().setAccessType("initializeOnly").setName("bboxSize").setType("SFVec3f").setValue("-1 -1 -1"))
        .addField(new field().setAccessType("inputOutput").setName("children").setType("MFNode"))
        .addField(new field().setAccessType("inputOnly").setName("addChildren").setType("MFNode"))
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Group("SegmentGroup")
          .setIS(new IS()
            ...
            .addConnect(new connect().setNodeField("addChildren").setProtoField("addChildren"))
            .addConnect(new connect().setNodeField("removeChildren").setProtoField("removeChildren"))))))
    .addChild(new ProtoDeclare().setName("Site").setAppinfo(this.ProtoDeclare_Site_3_116_appinfo).setDocumentation("http://HAnim.org/Specifications/HAnim2001/part1/Site.html")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setAccessType("inputOutput").setName("name").setType("SFString"))
        .addField(new field().setAccessType("inputOutput").setName("translation").setType("SFVec3f").setValue("0 0 0"))
        .addField(new field().setAccessType("inputOutput").setName("rotation").setType("SFRotation").setValue("0 0 1 0"))
      ...
      .setProtoBody(new ProtoBody()
        .addChild(new Transform("SiteTransform")
          .setIS(new IS()
            ...
            .addConnect(new connect().setNodeField("addChildren").setProtoField("addChildren"))
            .addConnect(new connect().setNodeField("removeChildren").setProtoField("removeChildren"))))))
    .addChild(new ProtoDeclare().setName("Displacer").setAppinfo(this.ProtoDeclare_Displacer_3_142_appinfo).setDocumentation("http://HAnim.org/Specifications/HAnim2001/part1/Displacer.html")
      .setProtoInterface(new ProtoInterface()
        .addField(new field().setAccessType("inputOutput").setName("name").setType("SFString"))
        .addField(new field().setAccessType("inputOutput").setName("coordIndex").setType("MFInt32"))
        .addField(new field().setAccessType("inputOutput").setName("displacements").setType("MFVec3f")))
      .setProtoBody(new ProtoBody()
        .addChild(new WorldInfo().setInfo(new MFString("\"null body node\"")))))
    .addChild(new Shape()
      .setGeometry(new Text().setString(new MFString("\"Humanoid Animation\" \"(HAnim) prototype\" \"implementations\""))
        .setFontStyle(new FontStyle().setJustify(new MFString("\"MIDDLE\" \"MIDDLE\""))))
      .setAppearance(new Appearance()
        .setMaterial(new Material().setAmbientIntensity(0.25).setShininess(0.39).setDiffuseColor(0.795918,0.505869,0.093315).setSpecularColor(0.923469,0.428866,0.006369)

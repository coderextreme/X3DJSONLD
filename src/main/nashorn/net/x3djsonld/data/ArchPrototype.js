  ...
  .setScene(new Scene()
    .addChild(new ProtoDeclare().setName("ArchPrototype").setAppinfo(this.ProtoDeclare_ArchPrototype_3_13_appinfo)
      .setProtoInterface(new ProtoInterface()
        ...
        .addField(new field().setAccessType("inputOutput").setName("diffuseColor").setType("SFColor").setValue("0.2 0.8 0.8").setAppinfo("color of arch"))
        .addField(new field().setAccessType("inputOutput").setName("emissiveColor").setType("SFColor").setValue("0.2 0.8 0.8").setAppinfo("color of arch"))
        .addComments(" INPUT PARAMETERS ")
        .addComments(" General parameters: measures in meters ")
        .addField(new field().setAccessType("initializeOnly").setName("clearSpanWidth").setType("SFFloat").setValue("4").setAppinfo("clearSpanWidth: clearSpanWidth must be double of riseHeight to obtain an half circumference"))
        .addField(new field().setAccessType("initializeOnly").setName("riseHeight").setType("SFFloat").setValue("2").setAppinfo("riseHeight: riseHeight must be half of clearSpanWidth to obtain an half circumference"))
        .addField(new field().setAccessType("initializeOnly").setName("depth").setType("SFFloat").setValue("3").setAppinfo("depth"))
        .addField(new field().setAccessType("initializeOnly").setName("topAbutmentHeight").setType("SFFloat").setValue("0.5").setAppinfo("topAbutmentHeight:topAbutmentHeight=0 means no topAbutment"))
        .addField(new field().setAccessType("initializeOnly").setName("pierWidth").setType("SFFloat").setValue("0.5").setAppinfo("pierWidth:pierWidtht=0 means no pierWidth"))
        .addField(new field().setAccessType("initializeOnly").setName("pierHeight").setType("SFFloat").setValue("1").setAppinfo("pierHeight: pierHeight=0 means no pierHeight"))
        .addComments(" Parameters to create to create shapes related to arch: put true to apply ")
        .addField(new field().setAccessType("initializeOnly").setName("archHalf").setType("SFBool").setValue("false").setAppinfo(this.field_archHalf_5_21_appinfo))
        .addField(new field().setAccessType("initializeOnly").setName("archHalfExtensionWidth").setType("SFFloat").setValue("0").setAppinfo(this.field_archHalfExtensionWidth_5_22_appinfo))
        .addField(new field().setAccessType("initializeOnly").setName("onlyIntrados").setType("SFBool").setValue("false").setAppinfo(this.field_onlyIntrados_5_23_appinfo))
        .addField(new field().setAccessType("initializeOnly").setName("archFilled").setType("SFBool").setValue("false").setAppinfo(this.field_archFilled_5_24_appinfo))
        .addField(new field().setAccessType("initializeOnly").setName("archHalfFilled").setType("SFBool").setValue("false").setAppinfo(this.field_archHalfFilled_5_25_appinfo))
        .addField(new field().setAccessType("initializeOnly").setName("lintel").setType("SFBool").setValue("false").setAppinfo(this.field_lintel_5_26_appinfo)))
      .setProtoBody(new ProtoBody()
        ...
        .addChild(new Script("ArchPrototypeScript").setUrl(new MFString("\"../node/ArchPrototypeScript.js\" \"https://coderextreme.net/X3DJSONLD/src/main/node/ArchPrototypeScript.js\""))
          ...
          .addField(new field().setAccessType("initializeOnly").setName("clearSpanWidth").setType("SFFloat").setAppinfo("user or default input for clearSpanWidth parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("riseHeight").setType("SFFloat").setAppinfo("user or default input for riseHeight parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("depth").setType("SFFloat").setAppinfo("user or default input for depth parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("topAbutmentHeight").setType("SFFloat").setAppinfo("user or default input for topAbutmentHeight parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("pierWidth").setType("SFFloat").setAppinfo("user or default input for pierWidth parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("pierHeight").setType("SFFloat").setAppinfo("user or default input for pierHeight parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("archHalf").setType("SFBool").setAppinfo("user or default input for archHalf parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("archHalfExtensionWidth").setType("SFFloat").setAppinfo("user or default input for archHalfExtensionWidth parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("onlyIntrados").setType("SFBool").setAppinfo("user or default input for onlyIntrados parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("archFilled").setType("SFBool").setAppinfo("user or default input for archFilled parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("archHalfFilled").setType("SFBool").setAppinfo("user or default input for archHalfFilled parameter"))
          .addField(new field().setAccessType("initializeOnly").setName("lintel").setType("SFBool").setAppinfo("user or default input for lintel parameter"))
          .addField(new field().setAccessType("outputOnly").setName("computedScale").setType("SFVec3f").setAppinfo(this.field_computedScale_6_49_appinfo))
          .addField(new field().setAccessType("outputOnly").setName("pointOut").setType("MFVec3f").setAppinfo("send computed points to the Coordinate node"))
          .addField(new field().setAccessType("outputOnly").setName("indexOut").setType("MFInt32").setAppinfo("send computed indices to the IndexedFaceSet node"))
          .setIS(new IS()
    ...
    .addChild(new ProtoInstance("ArchInstance", "ArchPrototype").setDEF("ArchInstance").setName("ArchPrototype")

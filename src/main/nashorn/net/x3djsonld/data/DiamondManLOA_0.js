...
DiamondManLOA_0.prototype = {
            ...
            .addChild(new Transform().setTranslation(0.0,0.9149,0.0016)
              .addChild(new Shape("DiamondShape")
                .setGeometry(new IndexedFaceSet().setCreaseAngle(0.5).setCoordIndex(Java.to([0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,1,-1,5,2,1,-1,5,3,2,-1,5,4,3,-1,5,1,4,-1], Java.type("int[]")))
                  .setCoord(new Coordinate().setPoint(new MFVec3f(Java.to([0.0,0.01,0.0,-0.01,0.0,0.0,0.0,0.0,0.01,0.01,0.0,0.0,0.0,0.0,-0.01,0.0,-0.01,0.0], Java.type("float[]"))))))
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		print ("DiamondManLOA_0 execution self-validation test results: " + testObject.validateSelf());
	}
}

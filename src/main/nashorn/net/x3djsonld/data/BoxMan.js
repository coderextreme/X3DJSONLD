...
NeedClassName.prototype = {
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ScriptObject("ENGINE").setDirectOutput(true).setUrl(new MFStringObject("\"BoxMan.js\" \"https://www.web3d.org/x3d/content/examples/HumanoidAnimation/CharactersLegacy/BoxMan.js\""))

 ...
 * <p> Simple shader example. </p>
 <p> Related links: <a href="../../../Shaders/SimpleShader_sail.java">SimpleShader_sail.java</a> source, <a href="../../../Shaders/SimpleShaderIndex.html" target="_top">SimpleShader catalog page</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a> and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
          ...
          .addChild(new ShapeObject()
            .setAppearance(new AppearanceObject()
              ...
              .addShaders(new ComposedShaderObject("Cobweb").setLanguage("GLSL")
                ...
                .addParts(new ShaderPartObject().setSourceCode("\n" + 
...
"}" + "\n"))
                .addParts(new ShaderPartObject("_1").setType("FRAGMENT").setSourceCode("\n" + 
"                  data:text/plain;charset=utf-8," + "\n" + 
"\n" + 
"precision mediump float;" + "\n" + 
"\n" + 
...
"} " + "\n"))))
   ...
   * @return SimpleShader_sail model
   */
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		var testObject = new SimpleShader_sail();
		print ("SimpleShader_sail execution self-validation test results: " + testObject.validateSelf());
	}
}
new SimpleShader_sail().main();
...
HAnim2SpecificationLOA3Illustrated.prototype = {
  ...
  .setHead(new headObject()
    ...
    .addMeta(new metaObject().setName("title").setContent("HAnim2SpecificationLOA3Illustrated.x3d"))
    ...
    .addMeta(new metaObject().setName("created").setContent("18 February 2021"))
    .addMeta(new metaObject().setName("modified").setContent("13 March 2021"))
    .addMeta(new metaObject().setName("creator").setContent("Don Brutzman"))
    .addMeta(new metaObject().setName("reference").setContent("HAnim2SpecificationLOA3Invisible.x3d"))
    .addMeta(new metaObject().setName("reference").setContent("HAnim2SpecificationLOA3Animation.x3d"))

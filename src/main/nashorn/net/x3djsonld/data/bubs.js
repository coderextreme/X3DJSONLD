  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ProtoDeclareObject().setName("Bubble")
      .setProtoBody(new ProtoBodyObject()
        .addChild(new TransformObject("body_trans")
...
"}" + "\n")
          ...
          .addChild(new ROUTEObject().setFromNode("bounce1").setFromField("translation_changed").setToNode("body_trans").setToField("set_translation"))
          .addChild(new ROUTEObject().setFromNode("bounce1").setFromField("scale_changed").setToNode("body_trans").setToField("set_scale"))

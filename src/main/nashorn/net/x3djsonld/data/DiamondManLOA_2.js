...
DiamondManLOA_2.prototype = {
  ...
  .setScene(new Scene()
    .addChild(new WorldInfo().setInfo(this.WorldInfo_3_17_info).setTitle("HANIM 1.1 Default Joint Centers, LOA1"))
    ...
    .addChild(new Transform().setTranslation(1.0,1.5,0.0)
      .addChild(new Billboard()
        .addChild(new Shape()
          .setGeometry(new Text().setString(new MFString("\"Diamond Man Key\""))
            .setFontStyle(new FontStyle().setFamily(new MFString("\"SANS\"")).setSize(0.1)))
        ...
        .addChild(new Transform().setTranslation(0.0,-0.3,0.0)
          ...
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new MFString("\"Minimal Humanoid Joints\""))
                .setFontStyle(new FontStyle().setFamily(new MFString("\"SANS\"")).setSize(0.1)))
              .setAppearance(new Appearance()
        ...
        .addChild(new Transform().setTranslation(0.0,-0.5,0.0)
          ...
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new MFString("\"Humanoid Joints\""))
                .setFontStyle(new FontStyle().setFamily(new MFString("\"SANS\"")).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))
        .addChild(new Transform().setTranslation(0.0,-0.7,0.0)
          ...
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new MFString("\"Recommended Spinal Joints\""))
                .setFontStyle(new FontStyle().setFamily(new MFString("\"SANS\"")).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))
        .addChild(new Transform().setTranslation(0.0,-0.9,0.0)
          ...
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new MFString("\"Spinal Joints\""))
                .setFontStyle(new FontStyle().setFamily(new MFString("\"SANS\"")).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))
        .addChild(new Transform().setTranslation(0.0,-1.3,0.0)
          ...
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new MFString("\"Humanoid Sites\""))
                .setFontStyle(new FontStyle().setFamily(new MFString("\"SANS\"")).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))
        .addChild(new Transform().setTranslation(0.0,-1.1,0.0)
          ...
          .addChild(new Transform().setTranslation(0.2,0.0,0.0)
            .addChild(new Shape()
              .setGeometry(new Text().setString(new MFString("\"Hand & Feet Joints\""))
                .setFontStyle(new FontStyle().setFamily(new MFString("\"SANS\"")).setSize(0.1)))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setUSE("TextMaterial"))))))))
    .addChild(new HAnimHumanoid("hanim_humanoid").setName("humanoid").setVersion("1.0")
      ...
      .addChild(new MetadataSet().setName("HAnimHumanoid.info").setReference(this.MetadataSet_HAnimHumanoid.info_4_93_reference)
        .addValue(new MetadataString().setName("humanoidVersion").setValue(new MFString("\"Nancy V1.2b\"")))
        .addValue(new MetadataString().setName("authorEmail").setValue(new MFString("\"cindy@ballreich.net\"")))
        .addValue(new MetadataString().setName("authorName").setValue(new MFString("\"Cindy Ballreich\"")))
        .addValue(new MetadataString().setName("copyright").setValue(new MFString("\"1997 3Name3D / Yglesias Wallock Divekar Inc. all rights reserved.\"")))
        .addValue(new MetadataString().setName("creationDate").setValue(new MFString("\"Tue Dec 30 08:30:08 PST 1997\"")))
        .addValue(new MetadataString().setName("usageRestrictions").setValue(this.MetadataString_usageRestrictions_5_98_value)))
        ...
        .addChild(new HAnimSegment("hanim_sacrum").setName("sacrum")
          .addChild(new Transform().setTranslation(0.0,0.8240,0.0277)
            ...
            .addChild(new Transform().setTranslation(0.0,0.01,0.0)
              .addChild(new Billboard()
                .addChild(new Shape()
                  .setGeometry(new Text().setString(new MFString("\"Humanoid Root\""))
                    .setFontStyle(new FontStyle().setFamily(new MFString("\"SANS\"")).setSize(0.01).setStyle("ITALIC")))
                  .setAppearance(new Appearance()
            ...
            .addChild(new HAnimJoint("hanim_l_knee").setName("l_knee").setCenter(0.1040,0.4867,0.0308)
              ...
              .addChild(new HAnimJoint("hanim_l_ankle").setName("l_ankle").setCenter(0.1101,0.0656,-0.0736)
                ...
                .addChild(new HAnimJoint("hanim_l_subtalar").setName("l_subtalar").setCenter(0.1086,0.0001,-0.0368)
                  .addChild(new HAnimSegment("hanim_midproximal").setName("midproximal")
                                                          ...
                                                          .addChild(new HAnimSegment("hanim_skull").setName("skull")
                                                            ...
                                                            .addChild(new HAnimSite("hanim_nuchale_pt").setName("nuchale_pt").setTranslation(0.0039,1.5972,-0.0796)
                                                              .addChild(new Shape()
                                                                ...
                                                                .setAppearance(new Appearance()
                                                                  .setMaterial(new Material().setUSE("SITE_COLOR"))))))))))))))))))))))))))))))))
      .addViewpoints(new HAnimSite("hanim_DiamondManLOA_2_view").setName("DiamondManLOA_2_view")
  ...
  validateSelf : function()
  {
    ...
    main : function (argv)
    {
		...
		print ("DiamondManLOA_2 execution self-validation test results: " + testObject.validateSelf());
	}
}

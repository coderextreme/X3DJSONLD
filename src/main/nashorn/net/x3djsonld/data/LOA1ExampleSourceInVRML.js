...
LOA1ExampleSourceInVRML.prototype = {
  ...
  initialize : function ()
  {
	...
	/** Large attribute array: fieldValue value field, scene-graph level=4, element #606, 62 total values */
	this.fieldValue_info_4_606_value = new SFStringObject("\"authorName=Matthew T. Beitler\" \"authorEmail=beitler@cis.upenn.edu or beitler@acm.org\" \"creationDate=05/12/99\" \"copyright=Copyright 1999-2003, Matthew T. Beitler\" \"humanoidVersion=JointCenters 200x, LOA&#8209;1\" \"usageRestrictions=
	...
	/** Large attribute array: WorldInfo info field, scene-graph level=4, element #608, 74 total values */
	this.WorldInfo_4_608_info = new MFStringObject(new MFStringObject("\"
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new ProtoInstanceObject("humanoid_2", "Humanoid").setDEF("humanoid_2").setName("Humanoid")
                            ...
                            .addChild(new ProtoInstanceObject("hanim_l_metatarsophalangeal__2", "Joint").setDEF("hanim_l_metatarsophalangeal__2").setName("Joint")
                              ...
                              .addFieldValue(new fieldValueObject().setName("children")
                                .addChild(new ProtoInstanceObject("hanim_l_middistal_2", "Segment").setDEF("hanim_l_middistal_2").setName("Segment")
                                  ...
                                  .addFieldValue(new fieldValueObject().setName("children")
                                    .addChild(new ProtoInstanceObject("hanim_l_middistal_tip_2", "Site").setDEF("hanim_l_middistal_tip_2").setName("Site")
                            ...
                            .addChild(new ProtoInstanceObject("hanim_r_metatarsophalangeal__2", "Joint").setDEF("hanim_r_metatarsophalangeal__2").setName("Joint")
                              ...
                              .addFieldValue(new fieldValueObject().setName("children")
                                .addChild(new ProtoInstanceObject("hanim_r_middistal_2", "Segment").setDEF("hanim_r_middistal_2").setName("Segment")
                                  ...
                                  .addFieldValue(new fieldValueObject().setName("children")
                                    .addChild(new ProtoInstanceObject("hanim_r_middistal_tip_2", "Site").setDEF("hanim_r_middistal_tip_2").setName("Site")
                        ...
                        .addChild(new ProtoInstanceObject("hanim_l_radiocarpal_2", "Joint").setDEF("hanim_l_radiocarpal_2").setName("Joint")
                          ...
                          .addFieldValue(new fieldValueObject().setName("children")
                            .addChild(new ProtoInstanceObject("hanim_l_hand_2", "Segment").setDEF("hanim_l_hand_2").setName("Segment")
                              ...
                              .addFieldValue(new fieldValueObject().setName("children")
                                .addChild(new ProtoInstanceObject("hanim_l_hand_tip_2", "Site").setDEF("hanim_l_hand_tip_2").setName("Site")
                        ...
                        .addChild(new ProtoInstanceObject("hanim_r_radiocarpal_2", "Joint").setDEF("hanim_r_radiocarpal_2").setName("Joint")
                          ...
                          .addFieldValue(new fieldValueObject().setName("children")
                            .addChild(new ProtoInstanceObject("hanim_r_hand_2", "Segment").setDEF("hanim_r_hand_2").setName("Segment")
                              ...
                              .addFieldValue(new fieldValueObject().setName("children")
                                .addChild(new ProtoInstanceObject("hanim_r_hand_tip_2", "Site").setDEF("hanim_r_hand_tip_2").setName("Site")
      ...
      .addFieldValue(new fieldValueObject().setName("sites")
        .addSites(new ProtoInstanceObject().setUSE("hanim_l_middistal_tip_2"))
        ...
        .addSites(new ProtoInstanceObject().setUSE("hanim_r_middistal_tip_2"))
        ...
        .addSites(new ProtoInstanceObject().setUSE("hanim_l_hand_tip_2"))
        ...
        .addSites(new ProtoInstanceObject().setUSE("hanim_r_hand_tip_2"))
      ...
      .addFieldValue(new fieldValueObject().setName("info").setValue(this.fieldValue_info_4_606_value)))
    .addChild(new GroupObject("JointCenters_WorldInfo")
      .addChild(new WorldInfoObject().setInfo(this.WorldInfo_4_608_info).setTitle("HANIM 200x Default Joint Centers, LOA&#8209;1")))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new BackgroundObject().setDEF("cube").setLeftUrl(Java.to(["images/all_probes/beach_cross/beach_left.png","http://coderextreme.net/images/all_probes/beach_cross/beach_left.png"], Java.type("java.lang.String[]"))).setRightUrl(Java.to(["images/all_probes/beach_cross/beach_right.png","http://coderextreme.net/images/all_probes/beach_cross/beach_right.png"], Java.type("java.lang.String[]"))).setFrontUrl(Java.to(["images/all_probes/beach_cross/beach_front.png","http://coderextreme.net/images/all_probes/beach_cross/beach_front.png"], Java.type("java.lang.String[]"))).setBackUrl(Java.to(["images/all_probes/beach_cross/beach_back.png","http://coderextreme.net/images/all_probes/beach_cross/beach_back.png"], Java.type("java.lang.String[]"))).setTopUrl(Java.to(["images/all_probes/beach_cross/beach_top.png","http://coderextreme.net/images/all_probes/beach_cross/beach_top.png"], Java.type("java.lang.String[]"))).setBottomUrl(Java.to(["images/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/images/all_probes/beach_cross/beach_bottom.png"], Java.type("java.lang.String[]"))))
...
""))
    ...
    X3D0.toFileX3D("../new/orig/mirror2.new.x3d");

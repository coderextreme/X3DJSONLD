...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new BackgroundObject().setBackUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_back.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_back.png"], Java.type("java.lang.String[]"))).setBottomUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_bottom.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_bottom.png"], Java.type("java.lang.String[]"))).setFrontUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_front.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_front.png"], Java.type("java.lang.String[]"))).setLeftUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_left.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_left.png"], Java.type("java.lang.String[]"))).setRightUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_right.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_right.png"], Java.type("java.lang.String[]"))).setTopUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_top.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_top.png"], Java.type("java.lang.String[]"))))
          ...
          .addChild(new ShapeObject()
            ...
            .setAppearance(new AppearanceObject().setDEF("_01_-_Default")
              ...
              .setTexture(new ComposedCubeMapTextureObject()
                .setBack(new ImageTextureObject().setUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_back.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_back.png"], Java.type("java.lang.String[]"))))
                .setBottom(new ImageTextureObject().setUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_bottom.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_bottom.png"], Java.type("java.lang.String[]"))))
                .setFront(new ImageTextureObject().setUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_front.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_front.png"], Java.type("java.lang.String[]"))))
                .setLeft(new ImageTextureObject().setUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_left.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_left.png"], Java.type("java.lang.String[]"))))
                .setRight(new ImageTextureObject().setUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_right.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_right.png"], Java.type("java.lang.String[]"))))
                .setTop(new ImageTextureObject().setUrl(Java.to(["images/all_probes/uffizi_cross/uffizi_top.png","http://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_top.png"], Java.type("java.lang.String[]")))))

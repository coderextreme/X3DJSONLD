...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new BackgroundObject().setBackUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_back.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_back.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setBottomUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_bottom.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_bottom.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setFrontUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_front.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_front.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setLeftUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_left.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_left.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setRightUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_right.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_right.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setTopUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_top.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_top.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
          ...
          .addChild(new ShapeObject()
            ...
            .setAppearance(new AppearanceObject().setDEF("_01_-_Default")
              ...
              .setTexture(new ComposedCubeMapTextureObject()
                .setBack(new ImageTextureObject().setUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_back.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_back.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setBottom(new ImageTextureObject().setUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_bottom.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_bottom.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setFront(new ImageTextureObject().setUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_front.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_front.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setLeft(new ImageTextureObject().setUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_left.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_left.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setRight(new ImageTextureObject().setUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_right.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_right.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setTop(new ImageTextureObject().setUrl(Java.to(["../resources/images/all_probes/uffizi_cross/uffizi_top.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/uffizi_cross/uffizi_top.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))

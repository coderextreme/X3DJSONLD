...
var ProtoInstance3 = null;
      ...
      .setHead(new headObject()
        ...
        .addMeta(new metaObject().setName("reference").setContent("X3dValidator https://savage.nps.edu/X3dValidator?url=http://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d"))
        ...
        .addMeta(new metaObject().setName("translated").setContent("06 June 2018"))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new TransformObject().setDEF("G1")
          .addChild(new TransformObject().setDEF("DECLpoint_INSTANCE_node").setTranslation(Java.to([0,0,0], Java.type("float[]")))
...
"               }"))
        ...
        .addChild(new TransformObject().setDEF("G2")
          .addChild(new TransformObject().setDEF("DECLpoint_INSTANCE1000_node").setTranslation(Java.to([0,0,0], Java.type("float[]")))
            .addChild(new ShapeObject()
              .setGeometry(new SphereObject().setRadius(0.1))
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject().setDiffuseColor(Java.to([1,0,0], Java.type("float[]"))))))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
          ...
          .addChild(new Group().setDEF("ARROW")
            .addChild(new Shape()
              .setAppearance(new Appearance().setDEF("ARROW_APPEARANCE")
                .setMaterial(new Material().setDiffuseColor(Java.to([0.3,0.3,1], Java.type("double[]"))).setEmissiveColor(Java.to([0.3,0.3,0.33], Java.type("double[]")))))
            ...
            .addChild(new Transform().setTranslation(Java.to([0,-1,0], Java.type("double[]"))).setRotation(Java.to([1,0,0,3.1416], Java.type("double[]")))
        ...
        .addChild(new Transform().setRotation(Java.to([0,0,1,-1.5708], Java.type("double[]")))
          .addChild(new Group()
            .addChild(new Group().setUSE("ARROW"))
            .addChild(new Transform().setTranslation(Java.to([0.072,1.1,0], Java.type("double[]"))).setRotation(Java.to([0,0,1,1.5708], Java.type("double[]")))
              .addChild(new Billboard()
                .addChild(new Shape()
        ...
        .addChild(new Transform().setRotation(Java.to([1,0,0,1.5708], Java.type("double[]")))
          .addChild(new Group()
            .addChild(new Group().setUSE("ARROW"))
            .addChild(new Transform().setTranslation(Java.to([0,1.1,0.072], Java.type("double[]"))).setRotation(Java.to([1,0,0,-1.5708], Java.type("double[]")))
              .addChild(new Billboard()
                .addChild(new Shape()
                  .setAppearance(new Appearance().setUSE("LABEL_APPEARANCE"))

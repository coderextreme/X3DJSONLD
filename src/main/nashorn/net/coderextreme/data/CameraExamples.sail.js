      ...
      .setScene(new SceneObject()
        ...
        .addChild(new GroupObject().setDEF("SimpleShotsTargets")
          .addChild(new TransformObject().setDEF("TargetBoxZoom").setTranslation(Java.to([-50,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                ...
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMoveZoom.png","https://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveZoom.png"], Java.type("java.lang.String[]"))))))
          ...
          .addChild(new TransformObject().setDEF("TargetBoxDolly").setTranslation(Java.to([-40,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject())
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMoveDolly.png","https://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveDolly.png"], Java.type("java.lang.String[]"))))))
            .addChild(new TransformObject().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new ShapeObject()
          ...
          .addChild(new TransformObject().setDEF("TargetBoxPan").setTranslation(Java.to([-30,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject())
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMovePan.png","https://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMovePan.png"], Java.type("java.lang.String[]"))))))
            .addChild(new TransformObject().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new ShapeObject()
          ...
          .addChild(new TransformObject().setDEF("TargetBoxBoom").setTranslation(Java.to([-20,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject())
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMoveBoom.png","https://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveBoom.png"], Java.type("java.lang.String[]"))))))
            .addChild(new TransformObject().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new ShapeObject()
          ...
          .addChild(new TransformObject().setDEF("TargetBoxTilt").setTranslation(Java.to([-10,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject())
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMoveTilt.png","https://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveTilt.png"], Java.type("java.lang.String[]"))))))
            .addChild(new TransformObject().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new ShapeObject()
        ...
        .addChild(new TransformObject().setDEF("CameraShapeTransform").setTranslation(Java.to([0,0.5,0], Java.type("float[]")))
          ...
          .addChild(new TransformObject().setDEF("CameraOffsetTransform").setTranslation(Java.to([0,0,0.25], Java.type("float[]")))
            ...
            .addChild(new InlineObject().setDEF("CameraShape").setUrl(Java.to(["CameraShape.x3d","https://www.web3d.org/x3d/content/examples/Basic/development/CameraShape.x3d"], Java.type("java.lang.String[]"))))
        ...
        .addChild(new TransformObject().setDEF("MovingBoxTransform")
          ...
          .addChild(new ShapeObject()
            ...
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject())
              .setTexture(new ImageTextureObject().setUrl(Java.to(["../earth-topo.png","https://www.web3d.org/x3d/content/examples/Basic/earth-topo.png"], Java.type("java.lang.String[]")))))))

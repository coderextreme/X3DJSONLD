...
var ProtoInstance34 = null;
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new ExternProtoDeclareObject().setName("CameraShot").setAppinfo("CameraShot collects a specific set of CameraMovement animations that make up an individual shot").setUrl(Java.to(["CameraPrototypes.x3d#CameraShot".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#CameraShot".replace(/\"/g, "\\\""),"CameraPrototypes.wrl#CameraShot".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#CameraShot".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
        ...
        .addChild(new ExternProtoDeclareObject().setName("CameraMovement").setAppinfo("CameraMovement defines a single camera movement animation").setUrl(Java.to(["CameraPrototypes.x3d#CameraMovement".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#CameraMovement".replace(/\"/g, "\\\""),"CameraPrototypes.wrl#CameraMovement".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#CameraMovement".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
        ...
        .addChild(new ExternProtoDeclareObject().setName("OfflineRender").setAppinfo("OfflineRender defines a parameters for offline rendering of Camera animation output to a movie file (or possibly a still shot)").setUrl(Java.to(["CameraPrototypes.x3d#OfflineRender".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#OfflineRender".replace(/\"/g, "\\\""),"CameraPrototypes.wrl#OfflineRender".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#OfflineRender".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
        ...
        .addChild(new GroupObject().setDEF("AnimationGroup.SimpleShots")
          ...
          .addChild(new TransformObject().setDEF("Trigger.SimpleShots").setTranslation(Java.to([-4,4,0], Java.type("float[]")))
            ...
            .addChild(new ShapeObject()
              .setGeometry(new TextObject().setString(Java.to(["Click to animate".replace(/\"/g, "\\\""),"SimpleShotsTest".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
        ...
        .addChild(new GroupObject().setDEF("SimpleShotsTargets")
          .addChild(new TransformObject().setDEF("TargetBoxZoom").setTranslation(Java.to([-50,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                ...
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMoveZoom.png".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveZoom.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))))
            .addChild(new TransformObject().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new ShapeObject()
                .setGeometry(new TextObject().setString(Java.to(["Zoom in, out".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
                  .setFontStyle(new FontStyleObject().setJustify(Java.to(["MIDDLE".replace(/\"/g, "\\\""),"MIDDLE".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
                .setAppearance(new AppearanceObject()
                  .setMaterial(new MaterialObject())))))
          .addChild(new TransformObject().setDEF("TargetBoxDolly").setTranslation(Java.to([-40,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject())
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMoveDolly.png".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveDolly.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))))
            .addChild(new TransformObject().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new ShapeObject()
                .setGeometry(new TextObject().setString(Java.to(["Dolly left, right".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
                  .setFontStyle(new FontStyleObject().setJustify(Java.to(["MIDDLE".replace(/\"/g, "\\\""),"MIDDLE".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
                .setAppearance(new AppearanceObject()
                  .setMaterial(new MaterialObject())))))
          .addChild(new TransformObject().setDEF("TargetBoxPan").setTranslation(Java.to([-30,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject())
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMovePan.png".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMovePan.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))))
            .addChild(new TransformObject().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new ShapeObject()
                .setGeometry(new TextObject().setString(Java.to(["Pan left, right".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
                  .setFontStyle(new FontStyleObject().setJustify(Java.to(["MIDDLE".replace(/\"/g, "\\\""),"MIDDLE".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
                .setAppearance(new AppearanceObject()
                  .setMaterial(new MaterialObject())))))
          .addChild(new TransformObject().setDEF("TargetBoxBoom").setTranslation(Java.to([-20,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject())
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMoveBoom.png".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveBoom.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))))
            .addChild(new TransformObject().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new ShapeObject()
                .setGeometry(new TextObject().setString(Java.to(["Boom up, down".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
                  .setFontStyle(new FontStyleObject().setJustify(Java.to(["MIDDLE".replace(/\"/g, "\\\""),"MIDDLE".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
                .setAppearance(new AppearanceObject()
                  .setMaterial(new MaterialObject())))))
          .addChild(new TransformObject().setDEF("TargetBoxTilt").setTranslation(Java.to([-10,1,-20], Java.type("float[]")))
            .addChild(new ShapeObject()
              ...
              .setAppearance(new AppearanceObject()
                .setMaterial(new MaterialObject())
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/CameraMoveTilt.png".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/images/CameraMoveTilt.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))))
            .addChild(new TransformObject().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new ShapeObject()
                .setGeometry(new TextObject().setString(Java.to(["Tilt left, right".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
                  .setFontStyle(new FontStyleObject().setJustify(Java.to(["MIDDLE".replace(/\"/g, "\\\""),"MIDDLE".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
                .setAppearance(new AppearanceObject()
                  .setMaterial(new MaterialObject()))))))
        ...
        .addChild(new GroupObject().setDEF("AnimationGroup.AimPointTest")
          ...
          .addChild(new TransformObject().setDEF("Trigger.AimPointTest").setTranslation(Java.to([4,4,0], Java.type("float[]")))
            ...
            .addChild(new ShapeObject()
              .setGeometry(new TextObject().setString(Java.to(["Click to animate".replace(/\"/g, "\\\""),"AimPointTest".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
                .setFontStyle(new FontStyleObject().setJustify(Java.to(["MIDDLE".replace(/\"/g, "\\\""),"MIDDLE".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
              .setAppearance(new AppearanceObject()
        ...
        .addChild(new TransformObject().setDEF("CameraShapeTransform").setTranslation(Java.to([0,0.5,0], Java.type("float[]")))
          ...
          .addChild(new TransformObject().setDEF("CameraOffsetTransform").setTranslation(Java.to([0,0,0.25], Java.type("float[]")))
            ...
            .addChild(new InlineObject().setDEF("CameraShape").setUrl(Java.to(["CameraShape.x3d".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/CameraShape.x3d".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
          ...
          .addChild(new ExternProtoDeclareObject().setName("ViewFrustum").setAppinfo("Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes").setUrl(Java.to(["../../X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.x3d#ViewFrustum".replace(/\"/g, "\\\""),"http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.x3d#ViewFrustum".replace(/\"/g, "\\\""),"../../X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.wrl#ViewFrustum".replace(/\"/g, "\\\""),"http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.wrl#ViewFrustum".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
        ...
        .addChild(new TransformObject().setScale(Java.to([3,3,3], Java.type("float[]"))).setTranslation(Java.to([0,0.25,0], Java.type("float[]")))
          .addChild(new InlineObject().setDEF("CoordinateAxes").setUrl(Java.to(["../../X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.x3d".replace(/\"/g, "\\\""),"../../Savage/Tools/Authoring/CoordinateAxes.x3d".replace(/\"/g, "\\\""),"http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.x3d".replace(/\"/g, "\\\""),"https://savage.nps.edu/Savage/Tools/Authoring/CoordinateAxes.x3d".replace(/\"/g, "\\\""),"../../X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.wrl".replace(/\"/g, "\\\""),"../../Savage/Tools/Authoring/CoordinateAxes.wrl".replace(/\"/g, "\\\""),"http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.wrl".replace(/\"/g, "\\\""),"https://savage.nps.edu/Savage/Tools/Authoring/CoordinateAxes.wrl".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
        .addChild(new TransformObject().setDEF("MovingBoxTransform")
          ...
          .addChild(new ShapeObject()
            ...
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject())
              .setTexture(new ImageTextureObject().setUrl(Java.to(["../earth-topo.png".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/earth-topo.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))))
        .addComments(new CommentsBlock("================ CrossHair visualization for center of screen ================"))
        .addChild(new ExternProtoDeclareObject().setName("CrossHair").setAppinfo("CrossHair prototype provides a heads-up display (HUD) crosshair at the view center, which is useful for assessing NavigationInfo lookAt point").setUrl(Java.to(["../../Savage/Tools/HeadsUpDisplays/CrossHairPrototype.x3d#CrossHair".replace(/\"/g, "\\\""),"https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/CrossHairPrototype.x3d#CrossHair".replace(/\"/g, "\\\""),"../../Savage/Tools/HeadsUpDisplays/CrossHairPrototype.wrl#CrossHair".replace(/\"/g, "\\\""),"https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/CrossHairPrototype.wrl#CrossHair".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
        ...
        .addChild(new AnchorObject().setDescription("launch CameraExample scene").setParameter(Java.to(["target=_blank".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setUrl(Java.to(["CameraExample.x3d".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/CameraExample.x3d".replace(/\"/g, "\\\""),"CameraExample.wrl".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/Basic/development/CameraExample.wrl".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
          .addChild(new TransformObject().setTranslation(Java.to([0,-3,0], Java.type("float[]")))
            .addChild(new ShapeObject()
              .setGeometry(new TextObject().setString(Java.to(["CameraPrototype".replace(/\"/g, "\\\""),"defines a prototype".replace(/\"/g, "\\\""),"".replace(/\"/g, "\\\""),"Click on this text to see".replace(/\"/g, "\\\""),"CameraExample scene".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
                .setFontStyle(new FontStyleObject().setJustify(Java.to(["MIDDLE".replace(/\"/g, "\\\""),"MIDDLE".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setSize(0.5)))
              .setAppearance(new AppearanceObject()
...
ProtoInstance33
            .addFieldValue(new fieldValueObject().setName("NavigationInfoNode")
              .addChild(new NavigationInfoObject().setDEF("TestNavigationInfo").setTransitionType(Java.to(["ANIMATE".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setVisibilityLimit(100)));
ProtoInstance33

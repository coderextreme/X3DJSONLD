...
var ProtoInstance2 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("G3").setTranslation(Java.to([1,1,0.01], Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(Java.to([0.2,0.7,0.2], Java.type("float[]")))))
            .setGeometry(new Sphere().setRadius(0.1)))
        ...
        .addChild(new Transform().setDEF("G4").setTranslation(Java.to([-1,1,0.01], Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(Java.to([0.2,0.7,0.2], Java.type("float[]")))))
            .setGeometry(new Sphere().setRadius(0.1)))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setCenterOfRotation(Java.to([0,1,0], Java.type("float[]"))).setDescription("AnnexB01Jin").setPosition(Java.to([0,1,3], Java.type("float[]"))))
        .addChild(new Group().setDEF("KeyframeAnimation")
          ...
          .addChild(new PositionInterpolator().setDEF("Keyframe_HumanoidRoot").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_HumanoidRoot").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_sacroiliac").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_shoulder").setKey(Java.to([0,0.5,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,-1,0,0,3,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_elbow").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_radiocarpal").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_shoulder").setKey(Java.to([0,0.5,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,-1,0,0,3,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_elbow").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_radiocarpal").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_vl5").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_skullbase").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_hip").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_knee").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_talocrural").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_l_metatarsophalangeal").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_hip").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_knee").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_talocrural").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))
          .addChild(new OrientationInterpolator().setDEF("Keyframe_r_metatarsophalangeal").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,0,0,0,0], Java.type("float[]"))))

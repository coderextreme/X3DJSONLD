              ...
              .addChild(new ShapeObject()
                .setAppearance(new AppearanceObject()
                  ...
                  .addShaders(new ComposedShaderObject().setLanguage("GLSL")
                    ...
                    .addParts(new ShaderPartObject().setType("VERTEX").setUrl(Java.to(["../shaders/common.vs".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/shaders/common.vs".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                    .addParts(new ShaderPartObject().setType("FRAGMENT").setUrl(Java.to(["../shaders/gl_flowers_chromatic.fs".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/shaders/gl_flowers_chromatic.fs".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
                  .addShaders(new ComposedShaderObject().setLanguage("GLSL")
                    .addField(new fieldObject().setType(fieldObject.TYPE_SFINT32).setName("xxxcube").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setValue("0"))
                    .addField(new fieldObject().setType(fieldObject.TYPE_SFNODE).setName("cube").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT)
                      .addChild(new ComposedCubeMapTextureObject().setUSE("texture")))
...
""))
            ...
            .addChild(new SoundObject().setMaxBack(100).setMaxFront(100).setMinBack(20).setMinFront(20)
              .setSource(new AudioClipObject().setDEF("AudioClip").setDescription("Chandubabamusic #1").setUrl(Java.to(["../resources/chandubabamusic1.wav".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))

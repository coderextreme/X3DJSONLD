              ...
              .addChild(new ShapeObject()
                .setAppearance(new AppearanceObject()
                  ...
                  .addShaders(new ComposedShaderObject().setLanguage("GLSL")
                    ...
                    .addParts(new ShaderPartObject().setType("VERTEX").setUrl(Java.to(["../shaders/gl_flowers_chromatic.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/gl_flowers_chromatic.vs"], Java.type("java.lang.String[]"))))

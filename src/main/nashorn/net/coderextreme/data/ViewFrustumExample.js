...
var ProtoInstance0 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("ViewFrustum from above, looking down").setOrientation(Java.to([1,0,0,-1.57], Java.type("double[]"))).setPosition(Java.to([0,40,0], Java.type("double[]"))))
        ...
        .addChild(new Viewpoint().setDescription("ViewFrustum oblique side view").setOrientation(Java.to([0.8005,0.5926,0.0898,-0.3743], Java.type("double[]"))).setPosition(Java.to([-5,5,20], Java.type("double[]"))))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("ScubaTank")
          ...
          .addChild(new Transform().setTranslation(Java.to([0,-0.35,0], Java.type("float[]")))
            .addChild(new Shape().setDEF("tankBottom")
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF("black").setAmbientIntensity(0.3).setDiffuseColor(Java.to([0,0,0], Java.type("float[]")))))
        ...
        .addChild(new Background().setSkyColor(Java.to([0.6,0.6,0.6], Java.type("float[]")))))      ;

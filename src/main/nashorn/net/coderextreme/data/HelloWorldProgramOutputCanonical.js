...
var ProtoInstance6 = null;
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("reference").setContent("https://savage.nps.edu/X3dValidator?url=http://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d"))
      ...
      .setScene(new Scene()
        .addChild(new ViewpointGroup().setDescription("Available viewpoints")
          ...
          .addChild(new Viewpoint().setDEF("TopDownView").setDescription("top-down view from above").setOrientation(Java.to([1,0,0,-1.570796], Java.type("double[]"))).setPosition(Java.to([0,100,0], Java.type("double[]")))))
        ...
        .addChild(new Transform().setDEF("LogoGeometryTransform").setTranslation(Java.to([0,1.5,0], Java.type("double[]")))
          .addChild(new Anchor().setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(Java.to(["../X3DJSAIL.html","http://www.web3d.org/specifications/java/X3DJSAIL.html"], Java.type("java.lang.String[]")))
            .addChild(new Shape().setDEF("BoxShape")
              .setAppearance(new Appearance()
                ...
                .setTexture(new ImageTexture().setUrl(Java.to(["images/X3dJavaSceneAccessInterfaceSaiLibrary.png","http://www.web3d.org/specifications/java/examples/images/X3dJavaSceneAccessInterfaceSaiLibrary.png"], Java.type("java.lang.String[]")))))
...
"}"))
        ...
        .addChild(new Inline().setDEF("inlineSceneDef").setUrl(Java.to(["someOtherScene.x3d","http://www.web3d.org/specifications/java/examples/someOtherScene.x3d"], Java.type("java.lang.String[]"))))
...
"}"))))
        ...
        .addChild(new Sound().setLocation(Java.to([0,1.6,0], Java.type("double[]")))
          ...
          .setSource(new AudioClip().setDescription("chimes").setUrl(Java.to(["chimes.wav","http://www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/AudioClip/chimes.wav"], Java.type("java.lang.String[]")))
        ...
        .addChild(new Sound().setLocation(Java.to([0,1.6,0], Java.type("double[]")))
          .addComments(new CommentsBlock("set sound-ellipsoid location height at 1.6m to match typical avatar height"))
          .setSource(new MovieTexture().setDescription("mpgsys.mpg from ConformanceNist suite").setUrl(Java.to(["mpgsys.mpg","http://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpgsys.mpg"], Java.type("java.lang.String[]")))
...
ProtoInstance4
    ...
    X3D0.toFileX3D("../data/HelloWorldProgramOutputCanonical.new.graal.x3d");

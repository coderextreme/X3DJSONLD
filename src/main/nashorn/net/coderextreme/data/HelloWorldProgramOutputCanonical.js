...
var ProtoInstance6 = null;
      ...
      .setScene(new Scene()
        .addChild(new ViewpointGroup().setDescription("Available viewpoints")
          ...
          .addChild(new Viewpoint().setDEF("TopDownView").setDescription("top-down view from above").setOrientation(Java.to([1,0,0,-1.570796], Java.type("float[]"))).setPosition(Java.to([0,100,0], Java.type("float[]")))))
        ...
        .addChild(new Transform().setDEF("LogoGeometryTransform").setTranslation(Java.to([0,1.5,0], Java.type("float[]")))
          .addChild(new Anchor().setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(Java.to(["../X3DJSAIL.html","https://www.web3d.org/specifications/java/X3DJSAIL.html"], Java.type("java.lang.String[]")))
            .addChild(new Shape().setDEF("BoxShape")
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF("GreenMaterial").setDiffuseColor(Java.to([0,1,1], Java.type("float[]"))).setEmissiveColor(Java.to([0.8,0,0], Java.type("float[]"))).setTransparency(0.1))
        ...
        .addChild(new Shape().setDEF("LineShape")
          .setAppearance(new Appearance()
            .setMaterial(new Material().setEmissiveColor(Java.to([0.6,0.19607843,0.8], Java.type("float[]")))))
          .setGeometry(new IndexedLineSet().setCoordIndex(Java.to([0,1,2,3,4,0], Java.type("int[]")))
            ...
            .setCoord(new Coordinate().setPoint(Java.to([0,1.5,0,2,1.5,0,2,1.5,-2,-2,1.5,-2,-2,1.5,0,0,1.5,0], Java.type("float[]"))))))
        .addChild(new PositionInterpolator().setDEF("BoxPathAnimator").setKey(Java.to([0,0.125,0.375,0.625,0.875,1], Java.type("float[]"))).setKeyValue(Java.to([0,1.5,0,2,1.5,0,2,1.5,-2,-2,1.5,-2,-2,1.5,0,0,1.5,0], Java.type("float[]"))))
        ...
        .addChild(new Transform().setDEF("TextTransform").setTranslation(Java.to([0,-1.5,0], Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance()
        ...
        .addChild(new OrientationInterpolator().setDEF("SpinInterpolator").setKey(Java.to([0,0.5,1], Java.type("float[]"))).setKeyValue(Java.to([0,1,0,4.712389,0,1,0,0,0,1,0,1.5707964], Java.type("float[]"))))
...
"}"))
          .addChild(new ColorInterpolator().setDEF("ColorAnimator").setKey(Java.to([0,0.5,1], Java.type("float[]"))).setKeyValue(Java.to([0.9411765,1,1,0.29411766,0,0.50980395,0.9411765,1,1], Java.type("float[]")))
        ...
        .addChild(new ProtoDeclare().setName("ArtDeco01Material").setAppinfo("tooltip: ArtDeco01Material prototype is a Material node")
          ...
          .setProtoBody(new ProtoBody()
            ...
            .addChild(new Material().setAmbientIntensity(0.25).setDiffuseColor(Java.to([0.282435,0.085159,0.134462], Java.type("float[]"))).setShininess(0.127273).setSpecularColor(Java.to([0.276305,0.11431,0.139857], Java.type("float[]"))))
        ...
        .addChild(new ExternProtoDeclare().setName("ArtDeco02Material").setAppinfo("this is a different Material node").setUrl(Java.to(["https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02Material","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02Material"], Java.type("java.lang.String[]")))
        ...
        .addChild(new Inline().setDEF("inlineSceneDef").setUrl(Java.to(["someOtherScene.x3d","https://www.web3d.org/specifications/java/examples/someOtherScene.x3d"], Java.type("java.lang.String[]"))))
...
"}"))))
        ...
        .addChild(new Sound().setLocation(Java.to([0,1.6,0], Java.type("float[]")))

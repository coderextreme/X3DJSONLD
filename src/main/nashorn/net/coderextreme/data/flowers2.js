              ...
              .addChild(new GroupObject()
                ...
                .addChild(new TransformObject().setDEF("OrbitTransform")
                  ...
                  .addChild(new ShapeObject()
                    ...
                    .addComments(new CommentsBlock("				  "))
                    .setGeometry(new IndexedFaceSetObject().setCcw(false).setConvex(false).setCoordIndex(Java.to([0,1,2,-1], Java.type("int[]"))).setCreaseAngle(0).setDEF("Orbit").setSolid(true)

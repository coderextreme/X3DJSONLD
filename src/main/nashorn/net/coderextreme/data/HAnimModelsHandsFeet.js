...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setTranslation(Java.to([-1,1,0], Java.type("float[]")))
          .addChild(new Inline().setUrl(Java.to(["HAnimModelHandLeft.x3d","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/HAnimModelHandLeft.x3d","HAnimModelHandLeft.wrl","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/HAnimModelHandLeft.wrl"], Java.type("java.lang.String[]"))))
        ...
        .addChild(new Transform().setTranslation(Java.to([1,1,0], Java.type("float[]")))
          .addChild(new Inline().setUrl(Java.to(["HAnimModelHandRight.x3d","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/HAnimModelHandRight.x3d","HAnimModelHandRight.wrl","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/HAnimModelHandRight.wrl"], Java.type("java.lang.String[]"))))
          .addChild(new Transform().setUSE("GridXY_20x20Fixed_AdjustScale")))
        .addChild(new Transform().setTranslation(Java.to([-1,-1,0], Java.type("float[]")))
          .addComments(new CommentsBlock("rotation='0 0 1 3.141593'"))
          .addChild(new Inline().setUrl(Java.to(["HAnimModelFootLeft.x3d","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/HAnimModelFootLeft.x3d","HAnimModelFootLeft.wrl","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/HAnimModelFootLeft.wrl"], Java.type("java.lang.String[]"))))
          .addChild(new Transform().setUSE("GridXY_20x20Fixed_AdjustScale")))
        .addChild(new Transform().setTranslation(Java.to([1,-1,0], Java.type("float[]")))
          .addComments(new CommentsBlock("rotation='0 0 1 3.141593'"))
          .addChild(new Inline().setUrl(Java.to(["HAnimModelFootRight.x3d","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/HAnimModelFootRight.x3d","HAnimModelFootRight.wrl","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/HAnimModelFootRight.wrl"], Java.type("java.lang.String[]"))))
          .addChild(new Transform().setUSE("GridXY_20x20Fixed_AdjustScale"))))      ;

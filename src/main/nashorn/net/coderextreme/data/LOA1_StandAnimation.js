        ...
        .addChild(new ProtoDeclare().setName("LOA1_StandAnimation")
          ...
          .setProtoBody(new ProtoBody()
            .addChild(new Group()
              ...
              .addChild(new OrientationInterpolator().setDEF("SKULLBASE_ANIMATOR").setKey(Java.to([0,0.5,1], Java.type("double[]"))).setKeyValue(Java.to([0,0,1,0,-1,0,0,0.5,0,0,1,0], Java.type("double[]")))
                .setIS(new IS()

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Humanoid_Right_Foot").setDEF("Humanoid_Right_Foot").setJointBindingPositions(Java.to([0,0,0], Java.type("float[]"))).setJointBindingRotations(Java.to([0,0,1,0], Java.type("float[]"))).setJointBindingScales(Java.to([1,1,1], Java.type("float[]"))).setVersion("2.0")

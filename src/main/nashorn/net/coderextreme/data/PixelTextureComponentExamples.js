...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        .addChild(new Background().setSkyColor(Java.to([0.1,0.1,0.4], Java.type("float[]"))).setTransparency(0))
        .addChild(new Viewpoint().setDescription("Table 5.18 SFImage component examples").setPosition(Java.to([0,0,14], Java.type("float[]"))))
        .addChild(new Transform().setTranslation(Java.to([-6,0,0], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
        ...
        .addChild(new Transform().setTranslation(Java.to([0,6,-2], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          .addChild(new Shape().setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
            .setAppearance(new Appearance()
            ...
            .setGeometry(new Box().setSize(Java.to([16,16,0.1], Java.type("float[]"))).setSolid(true)))))      ;

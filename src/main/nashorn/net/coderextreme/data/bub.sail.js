              ...
              .addChild(new ShapeObject().setDEF("myShape")
                .setAppearance(new AppearanceObject()
                  ...
                  .addShaders(new ComposedShaderObject().setDEF("cobweb").setLanguage("GLSL")
                    ...
                    .addParts(new ShaderPartObject().setType("FRAGMENT").setUrl(Java.to(["../shaders/pc_bubbles.fs".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/shaders/pc.fs".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))))

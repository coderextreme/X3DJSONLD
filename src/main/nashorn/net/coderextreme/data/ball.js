          ...
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance()
              ...
              .addShaders(new ComposedShader().setLanguage("GLSL")
                ...
                .addParts(new ShaderPart().setType("VERTEX").setUrl(Java.to(["../shaders/x3dom.vs","https://coderextreme.net/X3DJSONLD/src/main/src/main/shaders/x3dom.vs"], Java.type("java.lang.String[]"))))

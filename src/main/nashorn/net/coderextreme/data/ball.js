          ...
          .addChild(new ShapeObject()
            ...
            .setAppearance(new AppearanceObject()
              ...
              .addShaders(new ComposedShaderObject().setLanguage("GLSL")
                ...
                .addParts(new ShaderPartObject().setType("VERTEX").setUrl(Java.to(["../shaders/x3dom.vs","https://coderextreme.net/X3DJSONLD/src/main/src/main/shaders/x3dom.vs"], Java.type("java.lang.String[]"))))

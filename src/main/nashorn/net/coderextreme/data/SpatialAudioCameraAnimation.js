...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("TransformAudio1").setTranslation(Java.to([-933.123474,0,-926.253235], Java.type("double[]")))
          .addChild(new Shape()
          ...
          .addChild(new Billboard()
            .addChild(new Transform().setDEF("violin").setRotation(Java.to([1,0,0,-0.5], Java.type("double[]"))).setScale(Java.to([100,100,100], Java.type("double[]"))).setTranslation(Java.to([0,100,0], Java.type("double[]")))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.0933).setDiffuseColor(Java.to([1,1,1], Java.type("double[]"))).setShininess(0.51).setSpecularColor(Java.to([0.46,0.46,0.46], Java.type("double[]")))))
        ...
        .addChild(new Transform().setDEF("TransformAudio2").setTranslation(Java.to([933.475586,0,924.423218], Java.type("double[]")))
          .addChild(new Shape()
            ...
            .setGeometry(new Sphere().setRadius(100)))
          .addChild(new Billboard()
            .addChild(new Transform().setDEF("saxophone").setRotation(Java.to([1,0,0,-0.5], Java.type("double[]"))).setScale(Java.to([100,100,100], Java.type("double[]"))).setTranslation(Java.to([0,100,0], Java.type("double[]")))
              .addChild(new Shape()
                .setAppearance(new Appearance()
                  .setMaterial(new Material().setAmbientIntensity(0.0933).setDiffuseColor(Java.to([1,1,1], Java.type("double[]"))).setShininess(0.51).setSpecularColor(Java.to([0.46,0.46,0.46], Java.type("double[]")))))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("Rear View").setOrientation(Java.to([0,1,0,3.14], Java.type("double[]"))).setPosition(Java.to([0,0,-10], Java.type("double[]"))))
        .addChild(new Viewpoint().setDescription("Top View").setOrientation(Java.to([1,0,0,-1.57], Java.type("double[]"))).setPosition(Java.to([0,10,0], Java.type("double[]"))))
        .addChild(new Viewpoint().setDescription("Bottom View").setOrientation(Java.to([1,0,0,1.57], Java.type("double[]"))).setPosition(Java.to([0,-10,0], Java.type("double[]"))))
        .addChild(new Viewpoint().setDescription("Right View").setOrientation(Java.to([0,1,0,1.57], Java.type("double[]"))).setPosition(Java.to([10,0,0], Java.type("double[]"))))
        .addChild(new Viewpoint().setDescription("Left View").setOrientation(Java.to([0,1,0,-1.57], Java.type("double[]"))).setPosition(Java.to([-10,0,0], Java.type("double[]"))))

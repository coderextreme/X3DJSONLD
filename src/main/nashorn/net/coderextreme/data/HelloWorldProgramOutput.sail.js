          ...
          .addChild(new ShapeObject()
            ...
            .setGeometry(new TextObject().setString(Java.to(["X3D Java","SAI Library","X3DJSAIL"], Java.type("java.lang.String[]")))
              .setMetadata(new MetadataSetObject().setName("EscapedQuotationMarksMetadataSet")
                .setMetadata(new MetadataStringObject().setName("escapedQuotesTest2").setValue(Java.to(["escaped quotation marks example 2: He said, &quot;Immel did it!&quot;"], Java.type("java.lang.String[]")))))
...
""))
        ...
        .addChild(new ProtoDeclareObject().setName("ArtDeco01Material").setAppinfo("tooltip: ArtDeco01 prototype is a Material node")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setType(fieldObject.TYPE_SFSTRING).setName("description").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("tooltip for descriptionField").setValue("ArtDeco01 prototype is a Material node"))
...
""))))
        ...
        .addChild(new SoundObject()
          .setSource(new AudioClipObject().setUrl(Java.to(["chimes.wav","http://www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/AudioClip/chimes.wav"], Java.type("java.lang.String[]"))))
        ...
        .addChild(new SoundObject()
          .setSource(new MovieTextureObject().setUrl(Java.to(["mpgsys.mpg","http://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpgsys.mpg"], Java.type("java.lang.String[]"))))

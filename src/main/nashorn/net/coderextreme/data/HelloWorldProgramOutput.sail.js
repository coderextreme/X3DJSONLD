...
"}"))
        ...
        .addChild(new InlineObject().setDEF("inlineSceneDef").setUrl(Java.to(["someOtherScene.x3d","http://www.web3d.org/specifications/java/examples/someOtherScene.x3d"], Java.type("java.lang.String[]"))))

...
var ProtoInstance3 = null;
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new TransformObject().setDEF("LogoGeometryTransform").setTranslation(Java.to([0,1.5,0], Java.type("float[]")))
          .addChild(new AnchorObject().setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(Java.to(["../X3DJSAIL.html".replace(/\"/g, "\\\""),"http://www.web3d.org/specifications/java/X3DJSAIL.html".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
            .addChild(new ShapeObject().setDEF("BoxShape")
              .setAppearance(new AppearanceObject()
                ...
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/X3dJavaSceneAccessInterfaceSaiLibrary.png".replace(/\"/g, "\\\""),"http://www.web3d.org/specifications/java/examples/images/X3dJavaSceneAccessInterfaceSaiLibrary.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
        ...
        .addChild(new TransformObject().setDEF("TextTransform").setTranslation(Java.to([0,-1.5,0], Java.type("float[]")))
          .addChild(new ShapeObject()
            ...
            .setGeometry(new TextObject().setString(Java.to(["X3D Java".replace(/\"/g, "\\\""),"SAI Library".replace(/\"/g, "\\\""),"X3DJSAIL".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
              ...
              .setMetadata(new MetadataSetObject().setName("EscapedQuotationMarksMetadataSet")
                .addValue(new MetadataStringObject().setName("escapedQuotesTest1").setValue(Java.to(["escaped quotation marks example 1: He said, \"Immel did it!\"".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .addValue(new MetadataStringObject().setName("escapedQuotesTest2").setValue(Java.to(["escaped quotation marks example 2: He said, &quot;Immel did it!&quot;".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
...
""))
        ...
        .addChild(new InlineObject().setDEF("inlineSceneDef").setUrl(Java.to(["someOtherScene.x3d".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
...
""))))
        ...
        .addChild(new GroupObject().setDEF("DeclarativeGroupExample")
          .addChild(new ShapeObject()
            .setMetadata(new MetadataStringObject().setName("findThisNameValue").setDEF("FindableMetadataStringTest").setValue(Java.to(["test case".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
        ...
        .addChild(new SoundObject().setLocation(Java.to([0,1.6,0], Java.type("float[]")))
          ...
          .setSource(new AudioClipObject().setDescription("chimes").setUrl(Java.to(["chimes.wav".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/AudioClip/chimes.wav".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))
        ...
        .addChild(new SoundObject().setLocation(Java.to([0,1.6,0], Java.type("float[]")))
          .addComments(new CommentsBlock("set sound-ellipsoid location height at 1.6m to match typical avatar height"))
          .setSource(new MovieTextureObject().setDescription("mpgsys.mpg from ConformanceNist suite").setUrl(Java.to(["mpgsys.mpg".replace(/\"/g, "\\\""),"http://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpgsys.mpg".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))

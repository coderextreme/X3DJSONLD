        ...
        .addChild(new Transform().setTranslation(Java.to([0,2,0], Java.type("double[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("LightBlueAppearance")
              .setMaterial(new Material().setDiffuseColor(Java.to([0.1,0.7,0.7], Java.type("double[]")))))
            .setGeometry(new Text().setString(Java.to(["Compare special character escaping"], Java.type("java.lang.String[]")))
              .setFontStyle(new FontStyle().setDEF("testFontStyle").setSize(0.8).setJustify(Java.to(["MIDDLE","MIDDLE"], Java.type("java.lang.String[]")))))))
        .addChild(new Transform().setTranslation(Java.to([-3,0,0], Java.type("double[]")))
          .addChild(new Shape()

...
var ProtoInstance6 = null;
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new NavigationInfoObject().setType(Java.to(["EXAMINE","FLY","ANY"], Java.type("java.lang.String[]"))).setAvatarSize(Java.to([0.25,1.6,0.75], Java.type("float[]"))).setTransitionType(Java.to(["LINEAR"], Java.type("java.lang.String[]"))))
        ...
        .addChild(new TransformObject().setDEF("LogoGeometryTransform").setTranslation(Java.to([0,1.5,0], Java.type("float[]")))
          .addChild(new AnchorObject().setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(Java.to(["../X3DJSAIL.html","https://www.web3d.org/specifications/java/X3DJSAIL.html"], Java.type("java.lang.String[]")))
            .addChild(new ShapeObject().setDEF("BoxShape")
              .setAppearance(new AppearanceObject()
                ...
                .setTexture(new ImageTextureObject().setUrl(Java.to(["images/X3dJavaSceneAccessInterfaceSaiLibrary.png","https://www.web3d.org/specifications/java/examples/images/X3dJavaSceneAccessInterfaceSaiLibrary.png"], Java.type("java.lang.String[]")))))
        ...
        .addChild(new TransformObject().setDEF("TextTransform").setTranslation(Java.to([0,-1.5,0], Java.type("float[]")))
          .addChild(new ShapeObject()
            ...
            .setGeometry(new TextObject().setString(Java.to(["X3D Java","SAI Library","X3DJSAIL"], Java.type("java.lang.String[]")))
              ...
              .setFontStyle(new FontStyleObject().setFamily(Java.to(["SERIF"], Java.type("java.lang.String[]"))).setJustify(Java.to(["MIDDLE","MIDDLE"], Java.type("java.lang.String[]"))))))
...
"}"))
        ...
        .addChild(new InlineObject().setDEF("inlineSceneDef").setUrl(Java.to(["someOtherScene.x3d","https://www.web3d.org/specifications/java/examples/someOtherScene.x3d"], Java.type("java.lang.String[]"))))
...
"}"))))
        ...
        .addChild(new GroupObject().setDEF("DeclarativeGroupExample")
          .addChild(new ShapeObject()
            .setMetadata(new MetadataStringObject().setDEF("FindableMetadataStringTest").setName("findThisNameValue").setValue(Java.to(["test case"], Java.type("java.lang.String[]"))))
        ...
        .addChild(new SoundObject().setLocation(Java.to([0,1.6,0], Java.type("float[]")))
          ...
          .setSource(new AudioClipObject().setDescription("chimes").setUrl(Java.to(["chimes.wav","https://www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/AudioClip/chimes.wav"], Java.type("java.lang.String[]")))
        ...
        .addChild(new SoundObject().setLocation(Java.to([0,1.6,0], Java.type("float[]")))
          .addComments(new CommentsBlock(" set sound-ellipsoid location height at 1.6m to match typical avatar height "))
          .setSource(new MovieTextureObject().setDescription("mpgsys.mpg from ConformanceNist suite").setUrl(Java.to(["mpgsys.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpgsys.mpg"], Java.type("java.lang.String[]")))
        ...
        .addChild(new GroupObject()
          ...
          .addChild(new ProtoDeclareObject().setName("NewWorldInfo")
            .setProtoInterface(new ProtoInterfaceObject()
              .addField(new fieldObject().setType(fieldObject.TYPE_SFSTRING).setName("description").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY)))
            .setProtoBody(new ProtoBodyObject()
        ...
        .addChild(new TransformObject().setDEF("SpecialtyNodes")
          ...
          .addChild(new EspduTransformObject().setGeoSystem(Java.to(["GD","WE"], Java.type("java.lang.String[]"))))
          .addChild(new ReceiverPduObject().setGeoSystem(Java.to(["GD","WE"], Java.type("java.lang.String[]"))))
          .addChild(new SignalPduObject().setGeoSystem(Java.to(["GD","WE"], Java.type("java.lang.String[]"))))
          .addChild(new TransmitterPduObject().setGeoSystem(Java.to(["GD","WE"], Java.type("java.lang.String[]"))))
          .addChild(new DISEntityManagerObject()
            .setMapping(new DISEntityTypeMappingObject())))
        .addMetadata(new MetadataStringObject().setDEF("scene.addChildMetadata").setName("test").setValue(Java.to(["Top-level root Metadata node beneath Scene needs to be one of '-children' in JSON encoding"], Java.type("java.lang.String[]"))))
        .addLayerSet(new LayerSetObject().setDEF("scene.addChildLayerSetTest").setOrder(Java.to([0], Java.type("int[]")))))      ;
ProtoInstance0

      ...
      .setScene(new Scene()
        ...
        .addChild(new ProtoDeclare().setName("Camera").setAppinfo("Camera node provides direct control of scene view to enable cinematic camera animation shot by shot and move by move along with still digital-photography settings for offline rendering of camera images.")
          ...
          .setProtoBody(new ProtoBody()
            ...
            .addChild(new PositionInterpolator().setDEF("CameraPositionInterpolator").setKey(Java.to([0,1], Java.type("double[]"))).setKeyValue(Java.to([0,0,0,0,0,0], Java.type("double[]")))
              .setIS(new IS()
                .addConnect(new connect().setNodeField("set_fraction").setProtoField("set_fraction"))))
            .addChild(new OrientationInterpolator().setDEF("CameraOrientationInterpolator").setKey(Java.to([0,1], Java.type("double[]"))).setKeyValue(Java.to([0,1,0,0,0,1,0,0], Java.type("double[]")))
              .setIS(new IS()
                .addConnect(new connect().setNodeField("set_fraction").setProtoField("set_fraction"))))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setGroundColor(Java.to([0,0,1], Java.type("float[]"))).setSkyColor(Java.to([0,0,1], Java.type("float[]"))))
        ...
        .addChild(new Group().setDEF("Terrain")
          .addChild(new Transform().setScale(Java.to([50,50,50], Java.type("float[]"))).setTranslation(Java.to([25000,0,25000], Java.type("float[]")))
          ...
          .addChild(new Transform().setRotation(Java.to([1,0,0,1.57], Java.type("float[]"))).setTranslation(Java.to([25000,0,25000], Java.type("float[]")))
            .addChild(new Shape()
        ...
        .addChild(new Group().setDEF("Placemarks")
          .addChild(new Transform().setScale(Java.to([50,50,50], Java.type("float[]"))).setTranslation(Java.to([45000,30,44000], Java.type("float[]")))

      ...
      .setScene(new Scene()
        ...
        .addChild(new Shape()
          .setAppearance(new Appearance()
            ...
            .setTexture(new PixelTexture().setImage(Java.to([2,2,4,-16776961,16711935,-1,-65281], Java.type("int[]"))).setRepeatS(false).setRepeatT(false)))
          .setGeometry(new IndexedFaceSet().setCoordIndex(Java.to([0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1], Java.type("int[]")))
            .setCoord(new Coordinate().setPoint(Java.to([-2,1.5,1,-2,-1.5,1,2,1.5,1,2,-1.5,1,2,1.5,-1,2,-1.5,-1,-2,1.5,-1,-2,-1.5,-1], Java.type("double[]")))))))      ;

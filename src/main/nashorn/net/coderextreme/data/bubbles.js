      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("Bubbles")
          .addChild(new Group().setDEF("Bubble")
            ...
            .addChild(new PositionInterpolator().setDEF("BubblePath2").setKey(Java.to([0,0.3,0.64,0.85,1], Java.type("double[]"))).setKeyValue(Java.to([0.1,0.1,0.1,0.2,0.4,0.25,0.3,0.5,0.46,0.75,0.5,0.575,0.03848348,1.989,1.098373], Java.type("double[]"))))

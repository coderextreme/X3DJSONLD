...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("Hello CAD bushing").setPosition(Java.to([0,5,15], Java.type("double[]"))).setOrientation(Java.to([1,0,0,-0.321751], Java.type("double[]"))))
          ...
          .addChild(new CADPart().setName("CADPartExample")
            .addChild(new CADFace().setName("outerSurface")
              .setShape(new Shape()
                ...
                .setGeometry(new Cylinder().setTop(false).setBottom(false).setHeight(3).setRadius(2))))
            .addChild(new CADFace().setName("innerSurface")
              .setShape(new Shape()
                .setAppearance(new Appearance().setUSE("AppearanceGrey"))
                .setGeometry(new Cylinder().setTop(false).setBottom(false).setHeight(3).setSolid(false))))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setDEF("DECLpoint_G1_node")
          ...
          .addChild(new PositionInterpolator().setDEF("DECLpoint_G1_PI1").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,5,0], Java.type("float[]"))))
...
"		}"))
        ...
        .addChild(new Transform().setDEF("DECLpoint_G2_node")
          .addChild(new Shape()
            ...
            .setAppearance(new Appearance()
              .setMaterial(new Material().setDiffuseColor(Java.to([1,0,0], Java.type("float[]"))))))
          .addChild(new PositionInterpolator().setDEF("DECLpoint_G2_PI1").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,5,0], Java.type("float[]"))))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead(new headObject()
        .addMeta(new metaObject().setContent("gridBack.x3d").setName("title"))
        .addMeta(new metaObject().setContent("Checkerboard grid background for X3D/VRML materials selection.").setName("description"))
        .addMeta(new metaObject().setContent("David Roussel").setName("creator"))
        .addMeta(new metaObject().setContent("James Harney, Don Brutzman NPS").setName("translator"))
        .addMeta(new metaObject().setContent("8 April 2002").setName("created"))
        .addMeta(new metaObject().setContent("12 January 2014").setName("modified"))
        .addMeta(new metaObject().setContent("http://vrmlstuff.free.fr/materials").setName("reference"))
        .addMeta(new metaObject().setContent("Universal Media Material Library").setName("subject"))
        .addMeta(new metaObject().setContent("http://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.x3d").setName("identifier"))

      ...
      .setScene(new SceneObject()
        ...
        .addChild(new GroupObject()
          .addChild(new ExternProtoDeclareObject().setName("FlowerProto").setUrl(Java.to(["../data/flowerproto.x3d#FlowerProto"], Java.type("java.lang.String[]")))
            .addField(new fieldObject().setType(fieldObject.TYPE_MFSTRING).setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("vertex"))
            .addField(new fieldObject().setType(fieldObject.TYPE_MFSTRING).setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setName("fragment")))

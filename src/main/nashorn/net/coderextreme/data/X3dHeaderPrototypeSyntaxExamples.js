...
var ProtoInstance3 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new ProtoDeclare().setName("ShiftGroupUp2m")
          .setProtoInterface(new ProtoInterface()
            .addField(new field().setType(field.TYPE_MFNODE).setName("children").setAccessType(field.ACCESSTYPE_INPUTOUTPUT)
              .addChild(new Group().setDEF("DefaultNodeValue").setBboxSize(Java.to([2,2,2], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]")))
        ...
        .addChild(new Group().setDEF("ExampleChildElement").setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
        ...
        .addChild(new Transform().setDEF("TransformExampleUSE").setRotation(Java.to([0,1,0,0.78], Java.type("float[]"))).setTranslation(Java.to([0,2.5,0], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          .addChild(new Group().setUSE("ExampleChildElement")))
        .addChild(new Collision().setEnabled(true).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          .setProxy(new Shape().setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
        ...
        .addChild(new Inline().setDEF("someInline").setUrl(Java.to(["someUrl.x3d","http://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/someUrl.x3d"], Java.type("java.lang.String[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]"))))

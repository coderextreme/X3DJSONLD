...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Transform().setTranslation(Java.to([0,-1,1], Java.type("float[]"))).setRotation(Java.to([0,1,0,3.1415926], Java.type("float[]"))).setScale(Java.to([1.5,1.5,1.5], Java.type("float[]")))
          .addChild(new Shape()

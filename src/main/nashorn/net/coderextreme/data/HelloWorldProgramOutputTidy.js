...
var ProtoInstance6 = null;
      var X3D0 =  new X3D().setProfile("Full").setVersion("4.0").setCssClass("x3dModel.class").setStyle("x3dModel.style")
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("title").setContent("HelloWorldProgramOutputTidy.x3d"))
...
"}"))
        ...
        .addChild(new Inline().setDEF("inlineScene").setUrl(Java.to(["someOtherScene.x3d","https://www.web3d.org/specifications/java/examples/someOtherScene.x3d"], Java.type("java.lang.String[]"))))
...
ProtoInstance4
    ...
    X3D0.toFileX3D("../data/HelloWorldProgramOutputTidy.new.graal.x3d");

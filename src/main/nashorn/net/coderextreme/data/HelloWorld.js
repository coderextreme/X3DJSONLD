...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          .addChild(new Viewpoint().setDEF("ViewUpClose").setCenterOfRotation(Java.to([0,-1,0], Java.type("float[]"))).setDescription("Hello world!").setPosition(Java.to([0,-1,7], Java.type("float[]"))))
          .addChild(new Transform().setRotation(Java.to([0,1,0,3], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
            .addChild(new Shape().setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
              .setGeometry(new Sphere())
              .setAppearance(new Appearance()
                .setMaterial(new Material().setDEF("MaterialLightBlue").setDiffuseColor(Java.to([0.1,0.5,1], Java.type("float[]"))))

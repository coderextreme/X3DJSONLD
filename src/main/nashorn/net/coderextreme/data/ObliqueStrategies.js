...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setSkyColor(Java.to([0.419608,0.427451,1], Java.type("float[]"))))
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([0,1,0], Java.type("float[]")))
          ...
          .addChild(new Transform().setScale(Java.to([10,3,1], Java.type("float[]")))
        ...
        .addChild(new Transform().setDEF("CardTransform").setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([0,-1.5,0], Java.type("float[]")))
          .addChild(new Shape()
        ...
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([-3.2,2.5,0], Java.type("float[]")))
          ...
          .addChild(new Transform().setScale(Java.to([2,0.6,1], Java.type("float[]")))
        ...
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([3.5,2.5,0], Java.type("float[]")))
          ...
          .addChild(new Transform().setScale(Java.to([1.2,0.6,1], Java.type("float[]")))
            .addChild(new Shape().setUSE("TransparentClickSurface"))))
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([-3.3,-0.5,0], Java.type("float[]")))
          ...
          .addChild(new Shape()
            .setGeometry(new Text().setString(Java.to(["random"], Java.type("java.lang.String[]")))
              .setFontStyle(new FontStyle().setUSE("MessageFont")))
            .setAppearance(new Appearance().setUSE("InterfaceAppearance")))
          .addChild(new Transform().setScale(Java.to([1.8,0.6,1], Java.type("float[]")))
            .addChild(new Shape().setUSE("TransparentClickSurface"))))
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([3.3,-0.5,0], Java.type("float[]")))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setSkyColor(Java.to([0.419608,0.427451,1], Java.type("float[]"))).setTransparency(0))
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([0,1,0], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          ...
          .addChild(new Transform().setScale(Java.to([10,3,1], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
            .addChild(new Shape().setDEF("HeadlineClickSurface").setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
              .setGeometry(new IndexedFaceSet().setCoordIndex(Java.to([0,1,2,3,-1], Java.type("int[]"))).setSolid(false)
                .setCoord(new Coordinate().setPoint(Java.to([1,1,0,1,-1,0,-1,-1,0,-1,1,0], Java.type("float[]")))))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setAmbientIntensity(0.245763).setDiffuseColor(Java.to([0.34773,0.090909,0.005289], Java.type("float[]"))).setShininess(0.07).setSpecularColor(Java.to([0.336735,0.051091,0.051091], Java.type("float[]"))).setTransparency(0.8))))))
        .addChild(new Transform().setDEF("CardTransform").setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([0,-1.5,0], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          .addChild(new Shape().setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
        ...
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([-3.2,2.5,0], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          ...
          .addChild(new Shape().setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
            ...
            .setAppearance(new Appearance().setDEF("InterfaceAppearance")
              .setMaterial(new Material().setDiffuseColor(Java.to([1,0,0.6], Java.type("float[]"))))))
          .addChild(new Transform().setScale(Java.to([2,0.6,1], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
            .addChild(new Shape().setDEF("TransparentClickSurface").setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
              .addComments(new CommentsBlock("support Selectable Text with a scalable IFS"))
              .setGeometry(new IndexedFaceSet().setCoordIndex(Java.to([0,1,2,3,-1], Java.type("int[]"))).setSolid(false)
                .setCoord(new Coordinate().setPoint(Java.to([1,1,0,1,-1,0,-1,-1,0,-1,1,0], Java.type("float[]")))))
              .setAppearance(new Appearance()
                .setMaterial(new Material().setTransparency(1))))))
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([3.5,2.5,0], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          ...
          .addChild(new Transform().setScale(Java.to([1.2,0.6,1], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
            .addChild(new Shape().setUSE("TransparentClickSurface"))))
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([-3.3,-0.5,0], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          ...
          .addChild(new Shape().setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
            .setGeometry(new Text().setString(Java.to(["random"], Java.type("java.lang.String[]")))
              .setFontStyle(new FontStyle().setUSE("MessageFont")))
            .setAppearance(new Appearance().setUSE("InterfaceAppearance")))
          .addChild(new Transform().setScale(Java.to([1.8,0.6,1], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
            .addChild(new Shape().setUSE("TransparentClickSurface"))))
        .addChild(new Transform().setScale(Java.to([0.4,0.4,0.4], Java.type("float[]"))).setTranslation(Java.to([3.3,-0.5,0], Java.type("float[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))
          .addChild(new Anchor().setDEF("TextToSpeechAnchor").setDescription("text to speech in browser").setParameter(Java.to(["target=_blank"], Java.type("java.lang.String[]"))).setUrl(Java.to(["http://translate.google.com/translate_tts?tl=en&amp;q=Overtly%20resist%20change"], Java.type("java.lang.String[]"))).setBboxCenter(Java.to([0,0,0], Java.type("float[]"))).setBboxSize(Java.to([-1,-1,-1], Java.type("float[]")))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new BackgroundObject().setDEF("background").setBackUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_back.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_back.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setBottomUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_bottom.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_bottom.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setFrontUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_front.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_front.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setLeftUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_left.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_left.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setRightUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_right.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_right.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))).setTopUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_top.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_top.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
          ...
          .addChild(new ShapeObject()
            .setAppearance(new AppearanceObject()
              ...
              .setTexture(new ComposedCubeMapTextureObject().setDEF("texture")
                .setBack(new ImageTextureObject().setDEF("backShader").setUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_back.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_back.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setBottom(new ImageTextureObject().setDEF("bottomShader").setUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_bottom.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_bottom.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setFront(new ImageTextureObject().setDEF("frontShader").setUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_front.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_front.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setLeft(new ImageTextureObject().setDEF("leftShader").setUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_left.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_left.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setRight(new ImageTextureObject().setDEF("rightShader").setUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_right.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_right.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .setTop(new ImageTextureObject().setDEF("topShader").setUrl(Java.to(["../resources/images/all_probes/beach_cross/beach_top.png".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_top.png".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
              .addShaders(new ComposedShaderObject().setDEF("x3dom").setLanguage("GLSL")
                ...
                .addParts(new ShaderPartObject().setType("VERTEX").setUrl(Java.to(["../shaders/x3dom_flowers_chromatic.vs".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/shaders/x3dom_flowers_chromatic.vs".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .addParts(new ShaderPartObject().setType("FRAGMENT").setUrl(Java.to(["../shaders/pc_bubbles.fs".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/shaders/common.fs".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]")))))
              .addShaders(new ComposedShaderObject().setDEF("cobweb").setLanguage("GLSL")
                ...
                .addParts(new ShaderPartObject().setType("VERTEX").setUrl(Java.to(["../shaders/cobweb_flowers_chromatic.vs".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/shaders/cobweb_flowers_chromatic.vs".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))
                .addParts(new ShaderPartObject().setType("FRAGMENT").setUrl(Java.to(["../shaders/common.fs".replace(/\"/g, "\\\""),"https://coderextreme.net/X3DJSONLD/shaders/common.fs".replace(/\"/g, "\\\"")], Java.type("java.lang.String[]"))))))

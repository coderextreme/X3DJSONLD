          ...
          .addChild(new ShapeObject()
            .setAppearance(new AppearanceObject()
              ...
              .addShaders(new ComposedShaderObject().setDEF("x3dom").setLanguage("GLSL")
                ...
                .addParts(new ShaderPartObject().setType("VERTEX").setUrl(Java.to(["../shaders/x3dom_flowers_chromatic.vs","https://coderextreme.net/X3DJSONLD/shaders/x3dom_flowers_chromatic.vs"], Java.type("java.lang.String[]"))))
                .addParts(new ShaderPartObject().setType("FRAGMENT").setUrl(Java.to(["../shaders/pc_bubbles.fs","https://coderextreme.net/X3DJSONLD/shaders/common.fs"], Java.type("java.lang.String[]")))))
              .addShaders(new ComposedShaderObject().setDEF("cobweb").setLanguage("GLSL")
                ...
                .addParts(new ShaderPartObject().setType("VERTEX").setUrl(Java.to(["../shaders/cobweb_flowers_chromatic.vs","https://coderextreme.net/X3DJSONLD/shaders/cobweb_flowers_chromatic.vs"], Java.type("java.lang.String[]"))))
                .addParts(new ShaderPartObject().setType("FRAGMENT").setUrl(Java.to(["../shaders/common.fs","https://coderextreme.net/X3DJSONLD/shaders/common.fs"], Java.type("java.lang.String[]"))))))

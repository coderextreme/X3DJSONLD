...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group()
          .addChild(new Transform().setTranslation(Java.to([6.14221,0.0694613,-0.000999451], Java.type("double[]")))
            .addChild(new Shape()
              ...
              .setGeometry(new Box())))
          .addChild(new Transform().setTranslation(Java.to([-4.85443,0.0694381,-0.00149918], Java.type("double[]")))
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new PixelTexture().setUSE("RgbOpacityCheckerboard")))
              .setGeometry(new Sphere())))
          .addChild(new Transform().setTranslation(Java.to([-1.47341,0.036672,-0.00175095], Java.type("double[]")))
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new PixelTexture().setUSE("RgbOpacityCheckerboard")))
              .setGeometry(new Cone())))
          .addChild(new Transform().setTranslation(Java.to([2.31094,0.0694206,-0.00187683], Java.type("double[]")))
            .addChild(new Shape()
              .setAppearance(new Appearance()
                .setMaterial(new Material())
                .setTexture(new PixelTexture().setUSE("RgbOpacityCheckerboard")))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setDescription("View entire audio model").setOrientation(Java.to([1,0,0,-0.5], Java.type("double[]"))).setPosition(Java.to([0,500,600], Java.type("double[]"))).setRetainUserOffsets(true))
        .addChild(new Transform().setDEF("TransformAudio1").setTranslation(Java.to([-200,50,0], Java.type("double[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("audio_emit")
              .setMaterial(new Material().setDiffuseColor(Java.to([0.1,0.1,0.1], Java.type("double[]"))).setEmissiveColor(Java.to([0.8,0.8,0.8], Java.type("double[]"))).setSpecularColor(Java.to([0.01,0.01,0.01], Java.type("double[]")))))
          ...
          .addChild(new DynamicsCompressor().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
            .addChild(new Gain().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
              .addChild(new SpatialSound().setDEF("Audio1").setDistanceModel("INVERSE")
                .addChild(new Gain().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                  .addChild(new Analyser().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                    .addChild(new BiquadFilter().setType(field.TYPE_ALLPASS).setDetune(50).setFrequency(600).setQualityFactor(30).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
              ...
              .addChild(new SpatialSound().setDEF("Audio2").setDistanceModel("INVERSE")
                .addChild(new Gain().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                  .addChild(new Analyser().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                    .addChild(new BiquadFilter().setType(field.TYPE_ALLPASS).setDetune(15).setFrequency(600).setQualityFactor(15).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
              ...
              .addChild(new SpatialSound().setDEF("Audio3").setDistanceModel("INVERSE")
                .addChild(new Gain().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                  .addChild(new Analyser().setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")
                    .addChild(new BiquadFilter().setType(field.TYPE_ALLPASS).setFrequency(1000).setQualityFactor(0).setChannelCountMode("MAX").setChannelInterpretation("SPEAKERS")

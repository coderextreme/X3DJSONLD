...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setSkyColor(Java.to([0.2,0.2,0.2], Java.type("double[]"))))
        .addChild(new Viewpoint().setDescription("View entire audio model").setPosition(Java.to([0,500,600], Java.type("double[]"))).setOrientation(Java.to([1,0,0,-0.5], Java.type("double[]"))).setRetainUserOffsets(true))
        .addChild(new Transform().setDEF("TransformAudio1").setTranslation(Java.to([-200,50,0], Java.type("double[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("audio_emit")
              .setMaterial(new Material().setDiffuseColor(Java.to([0.1,0.1,0.1], Java.type("double[]"))).setSpecularColor(Java.to([0.01,0.01,0.01], Java.type("double[]"))).setEmissiveColor(Java.to([0.8,0.8,0.8], Java.type("double[]")))))
            .setGeometry(new Sphere().setRadius(30))))
        .addChild(new Transform().setDEF("TransformAudio2").setTranslation(Java.to([0,50,0], Java.type("double[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("audio_emit2")
              .setMaterial(new Material().setDiffuseColor(Java.to([0.1,0.1,0.1], Java.type("double[]"))).setSpecularColor(Java.to([0.01,0.01,0.01], Java.type("double[]"))).setEmissiveColor(Java.to([0.8,0.8,0.8], Java.type("double[]")))))
            .setGeometry(new Sphere().setRadius(30))))
        .addChild(new Transform().setDEF("TransformAudio3").setTranslation(Java.to([200,50,0], Java.type("double[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("audio_emit3")
              .setMaterial(new Material().setDiffuseColor(Java.to([0.1,0.1,0.1], Java.type("double[]"))).setSpecularColor(Java.to([0.01,0.01,0.01], Java.type("double[]"))).setEmissiveColor(Java.to([0.8,0.8,0.8], Java.type("double[]")))))
            .setGeometry(new Sphere().setRadius(30))))
        .addChild(new Transform().setDEF("AnimData").setTranslation(Java.to([0,50,0], Java.type("double[]"))))
        .addChild(new Transform().setDEF("AnimDataBoxH").setTranslation(Java.to([0,100,0], Java.type("double[]"))))
        .addChild(new Transform().setDEF("AnimDataBoxM").setTranslation(Java.to([15,100,0], Java.type("double[]"))))
        .addChild(new Transform().setDEF("AnimDataBoxL").setTranslation(Java.to([30,100,0], Java.type("double[]"))))
        .addChild(new Transform().setDEF("AnimDataBoxMM").setTranslation(Java.to([-15,100,0], Java.type("double[]"))))
        .addChild(new Transform().setDEF("AnimDataBoxLM").setTranslation(Java.to([-30,100,0], Java.type("double[]"))))
        .addChild(new Transform()
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("floor")
              .setMaterial(new Material().setDiffuseColor(Java.to([0.1,0.1,0.1], Java.type("double[]"))).setSpecularColor(Java.to([0.5,0.6,0.7], Java.type("double[]"))).setShininess(0.8)))
              ...
              .addChild(new SpatialSound().setDEF("Audio1")
                .addChild(new Gain()
                  .addChild(new Analyser()
                    .addChild(new BiquadFilter().setType(field.TYPE_ALLPASS).setDetune(50).setFrequency(600).setQualityFactor(30)
                      .addChild(new AudioClip().setDescription("Techno beat").setUrl(Java.to(["sound/techno_beat.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/techno_beat.mp3"], Java.type("java.lang.String[]"))).setLoop(true))))))
              .addChild(new SpatialSound().setDEF("Audio2")
                .addChild(new Gain()
                  .addChild(new Analyser()
                    .addChild(new BiquadFilter().setType(field.TYPE_ALLPASS).setDetune(15).setFrequency(600).setQualityFactor(15)
                      .addChild(new AudioClip().setDescription("Simple beat").setUrl(Java.to(["sound/beat.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/beat.mp3"], Java.type("java.lang.String[]"))).setLoop(true))))))
              .addChild(new SpatialSound().setDEF("Audio3")
                .addChild(new Gain()
                  .addChild(new Analyser()
                    .addChild(new BiquadFilter().setType(field.TYPE_ALLPASS).setFrequency(1000).setQualityFactor(0)
                      .addChild(new AudioClip().setDescription("Wobble loop").setUrl(Java.to(["sound/wobble_loop.mp3","https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/wobble_loop.mp3"], Java.type("java.lang.String[]"))).setLoop(true))))))))))      ;

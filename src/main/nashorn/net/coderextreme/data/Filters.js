...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setBind("true").setOrientation(Java.to([1,0,0,-0.5], Java.type("float[]"))).setPosition(Java.to([0,500,600], Java.type("float[]"))).setRetainUserOffsets(true))
        .addChild(new Transform().setDEF("Audio1").setTranslation(Java.to([-200,50,0], Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance().setDEF("audio_emit")
              .setMaterial(new Material().setDiffuseColor(Java.to([0.1,0.1,0.1], Java.type("float[]"))).setEmmisiveColor("0.8 0.8 0.8").setSpecularColor(Java.to([0.01,0.01,0.01], Java.type("float[]")))))
                ...
                .addChild(new Gain()
                  .addChild(new Analyser()
                    .addChild(new BiquadFilter().setType(field.TYPE_ALLPASS).setDetune(50).setFrequency(600).setQualityFactor(30)
                      .addChild(new AudioClip().setLoop(true).setPauseTime(-1).setResumeTime(-1).setStopTime(-1).setUrl(Java.to(["sound/techno_beat.mp3"], Java.type("java.lang.String[]"))))))))
                ...
                .addChild(new Gain()
                  .addChild(new Analyser()
                    .addChild(new BiquadFilter().setType(field.TYPE_ALLPASS).setDetune(15).setFrequency(600).setQualityFactor(15)
                      .addChild(new AudioClip().setLoop(true).setPauseTime(-1).setResumeTime(-1).setStopTime(-1).setUrl(Java.to(["sound/beat.mp3"], Java.type("java.lang.String[]"))))))))
                ...
                .addChild(new Gain()
                  .addChild(new Analyser()
                    .addChild(new BiquadFilter().setType(field.TYPE_ALLPASS).setFrequency(1000).setQualityFactor(0)
                      .addChild(new AudioClip().setLoop(true).setPauseTime(-1).setResumeTime(-1).setStopTime(-1).setUrl(Java.to(["sound/wobble_loop.mp3"], Java.type("java.lang.String[]"))))))))))))      ;

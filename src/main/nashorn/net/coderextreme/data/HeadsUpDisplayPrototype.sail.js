      ...
      .setScene(new SceneObject()
        .addChild(new ProtoDeclareObject().setName("HeadsUpDisplay").setAppinfo("HeadsUpDisplay positions child geometry in screen space, movable by the user")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setType(fieldObject.TYPE_MFNODE).setName("children").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Displayed subscene positioned as a HUD.")
              .addComments(new CommentsBlock("default is null array of nodes")))
            .addField(new fieldObject().setType(fieldObject.TYPE_MFNODE).setName("dragChildren").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("Additional HUD geometry which can be touched and dragged for repositioning. If this geometry goes offscreen (perhaps due to screen resizing) then it snaps back to original position.")
              .addComments(new CommentsBlock("default is null array of nodes")))
            .addField(new fieldObject().setType(fieldObject.TYPE_SFVEC3F).setName("locationOffset").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("Modified screen location and distance (for size).").setValue("-2 -2 0"))
            .addField(new fieldObject().setType(fieldObject.TYPE_SFBOOL).setName("traceEnabled").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("Enable/disable console output for troubleshooting.").setValue("false")))
                    ...
                    .addChild(new TransformObject().setTranslation(Java.to([0,0,-10], Java.type("float[]")))
                      ...
                      .addChild(new GroupObject().setDEF("PlaneMovementSensorGroup")
                        ...
                        .addChild(new ScriptObject().setDEF("VisibilityControlScript")
                          ...
                          .addField(new fieldObject().setType(fieldObject.TYPE_SFBOOL).setName("isVisible").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setValue("true"))
                          .addField(new fieldObject().setType(fieldObject.TYPE_SFVEC3F).setName("planeSensorTranslation").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setValue("0 0 0"))
                          .addField(new fieldObject().setType(fieldObject.TYPE_SFBOOL).setName("setIsVisible").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY))
                          .addField(new fieldObject().setType(fieldObject.TYPE_SFBOOL).setName("setPlaneSensorIsActive").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY))
                          .addField(new fieldObject().setType(fieldObject.TYPE_SFVEC3F).setName("setPlaneSensorTranslation").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY))
                          .addField(new fieldObject().setType(fieldObject.TYPE_SFVEC3F).setName("translationChanged").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new BackgroundObject().setBackUrl(Java.to(["bBK.png","https://coderextreme.net/bug/bBK.png"], Java.type("java.lang.String[]"))).setBottomUrl(Java.to(["bBT.png","https://coderextreme.net/bug/bBT.png"], Java.type("java.lang.String[]"))).setFrontUrl(Java.to(["bFR.png","https://coderextreme.net/bug/bFR.png"], Java.type("java.lang.String[]"))).setLeftUrl(Java.to(["bLF.png","https://coderextreme.net/bug/bLF.png"], Java.type("java.lang.String[]"))).setRightUrl(Java.to(["bRT.png","https://coderextreme.net/bug/bRT.png"], Java.type("java.lang.String[]"))).setTopUrl(Java.to(["bTP.png","https://coderextreme.net/bug/bTP.png"], Java.type("java.lang.String[]"))))
          ...
          .addChild(new ShapeObject()
            ...
            .setAppearance(new AppearanceObject().setDEF("_01_-_Default")
              ...
              .setTexture(new ComposedCubeMapTextureObject()
                .setBack(new ImageTextureObject().setUrl(Java.to(["bBK.png","https://coderextreme.net/bug/bBK.png"], Java.type("java.lang.String[]"))))
                .setBottom(new ImageTextureObject().setUrl(Java.to(["bBT.png","https://coderextreme.net/bug/bBT.png"], Java.type("java.lang.String[]"))))
                .setFront(new ImageTextureObject().setUrl(Java.to(["bFR.png","https://coderextreme.net/bug/bFR.png"], Java.type("java.lang.String[]"))))
                .setLeft(new ImageTextureObject().setUrl(Java.to(["bLF.png","https://coderextreme.net/bug/bLF.png"], Java.type("java.lang.String[]"))))
                .setRight(new ImageTextureObject().setUrl(Java.to(["bRT.png","https://coderextreme.net/bug/bRT.png"], Java.type("java.lang.String[]"))))
                .setTop(new ImageTextureObject().setUrl(Java.to(["bTP.png","https://coderextreme.net/bug/bTP.png"], Java.type("java.lang.String[]")))))

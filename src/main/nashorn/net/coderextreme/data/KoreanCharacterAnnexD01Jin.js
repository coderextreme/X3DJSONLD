...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead(new head()
        ...
        .addMeta(new meta().setName("identifier").setContent("http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/KoreanCharacterAnnexD01Jin.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setCenterOfRotation(Java.to([0,1,0], Java.type("float[]"))).setDescription("AnnexD01Jin").setPosition(Java.to([0,1,3], Java.type("float[]")))))      ;
    X3D0.toFileX3D("../data/KoreanCharacterAnnexD01Jin.new.x3d");

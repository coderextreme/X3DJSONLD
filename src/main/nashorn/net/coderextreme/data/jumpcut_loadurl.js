...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Background().setGroundAngle(Java.to([1.57], Java.type("double[]"))).setGroundColor(Java.to([0,0.5,0,0,0.5,0], Java.type("double[]"))).setSkyColor(Java.to([0,0,1], Java.type("double[]"))))
        ...
        .addChild(new Viewpoint().setDEF("Top_View").setDescription("Top View").setOrientation(Java.to([1,0,0,-1.57], Java.type("double[]"))).setPosition(Java.to([0,10,0], Java.type("double[]"))))

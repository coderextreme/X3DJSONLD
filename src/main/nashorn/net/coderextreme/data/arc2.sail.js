...
""))
        ...
        .addChild(new TransformObject().setDEF("DECLpoint_G3_node")
          .addChild(new ShapeObject()
            ...
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setDiffuseColor(Java.to([1,0,0], Java.type("float[]"))))))
          .addChild(new PositionInterpolatorObject().setDEF("DECLpoint_G3_PI1").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,5,0], Java.type("float[]"))))
...
"\n"+
""))
          .addChild(new TimeSensorObject().setDEF("DECLpoint_G3_CL1").setCycleInterval(3).setLoop(true))
        ...
        .addChild(new TransformObject().setDEF("DECLpoint_G4_node")
          .addChild(new ShapeObject()
            ...
            .setAppearance(new AppearanceObject()
              .setMaterial(new MaterialObject().setDiffuseColor(Java.to([1,0,0], Java.type("float[]"))))))
          .addChild(new PositionInterpolatorObject().setDEF("DECLpoint_G4_PI1").setKey(Java.to([0,1], Java.type("float[]"))).setKeyValue(Java.to([0,0,0,0,5,0], Java.type("float[]"))))
...
"\n"+
""))
          .addChild(new TimeSensorObject().setDEF("DECLpoint_G4_CL1").setCycleInterval(3).setLoop(true))

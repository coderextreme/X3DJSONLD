...
var ProtoInstance34 = null;
      ...
      .setScene(new Scene()
        ...
        .addChild(new Group().setDEF("AnimationGroup.SimpleShots")
          ...
          .addChild(new Transform().setDEF("Trigger.SimpleShots").setTranslation(Java.to([-4,4,0], Java.type("float[]")))
            ...
            .addChild(new Shape().setDEF("TransparentBox")
              ...
              .setGeometry(new Box().setSize(Java.to([6,2,0.0001], Java.type("float[]")))))))
        .addChild(new Group().setDEF("SimpleShotsTargets")
          .addChild(new Transform().setDEF("TargetBoxZoom").setTranslation(Java.to([-50,1,-20], Java.type("float[]")))
            .addChild(new Shape()
              .setGeometry(new Box())
              .setAppearance(new Appearance()
            ...
            .addChild(new Transform().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new Shape()
                ...
                .setAppearance(new Appearance()
                  .setMaterial(new Material())))))
          .addChild(new Transform().setDEF("TargetBoxDolly").setTranslation(Java.to([-40,1,-20], Java.type("float[]")))
            .addChild(new Shape()
              .setGeometry(new Box())
              .setAppearance(new Appearance()
                .setMaterial(new Material())
            ...
            .addChild(new Transform().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new Shape()
                ...
                .setAppearance(new Appearance()
                  .setMaterial(new Material())))))
          .addChild(new Transform().setDEF("TargetBoxPan").setTranslation(Java.to([-30,1,-20], Java.type("float[]")))
            .addChild(new Shape()
              .setGeometry(new Box())
              .setAppearance(new Appearance()
                .setMaterial(new Material())
            ...
            .addChild(new Transform().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new Shape()
                ...
                .setAppearance(new Appearance()
                  .setMaterial(new Material())))))
          .addChild(new Transform().setDEF("TargetBoxBoom").setTranslation(Java.to([-20,1,-20], Java.type("float[]")))
            .addChild(new Shape()
              .setGeometry(new Box())
              .setAppearance(new Appearance()
                .setMaterial(new Material())
            ...
            .addChild(new Transform().setTranslation(Java.to([0,2,0], Java.type("float[]")))
              .addChild(new Shape()
                ...
                .setAppearance(new Appearance()
                  .setMaterial(new Material())))))
          .addChild(new Transform().setDEF("TargetBoxTilt").setTranslation(Java.to([-10,1,-20], Java.type("float[]")))
            .addChild(new Shape()
              .setGeometry(new Box())
              .setAppearance(new Appearance()
                .setMaterial(new Material())
        ...
        .addChild(new Group().setDEF("AnimationGroup.AimPointTest")
          ...
          .addChild(new Transform().setDEF("Trigger.AimPointTest").setTranslation(Java.to([4,4,0], Java.type("float[]")))
        ...
        .addChild(new Transform().setDEF("CameraShapeTransform").setTranslation(Java.to([0,0.5,0], Java.type("float[]")))
          ...
          .addChild(new Transform().setDEF("CameraOffsetTransform").setTranslation(Java.to([0,0,0.25], Java.type("float[]")))
        ...
        .addChild(new Background().setSkyColor(Java.to([0.282353,0.380392,0.470588], Java.type("float[]"))))
        .addChild(new Transform().setRotation(Java.to([1,0,0,-1.57079], Java.type("float[]"))).setScale(Java.to([10,10,10], Java.type("float[]")))
          .addChild(new Shape()
            .setAppearance(new Appearance()
        ...
        .addChild(new Transform().setScale(Java.to([3,3,3], Java.type("float[]"))).setTranslation(Java.to([0,0.25,0], Java.type("float[]")))
        ...
        .addChild(new Anchor().setDescription("launch CameraExample scene").setParameter(Java.to(["target=_blank"], Java.type("java.lang.String[]"))).setUrl(Java.to(["CameraExample.x3d","https://www.web3d.org/x3d/content/examples/Basic/development/CameraExample.x3d","CameraExample.wrl","https://www.web3d.org/x3d/content/examples/Basic/development/CameraExample.wrl"], Java.type("java.lang.String[]")))
          .addChild(new Transform().setTranslation(Java.to([0,-3,0], Java.type("float[]")))
            .addChild(new Shape()

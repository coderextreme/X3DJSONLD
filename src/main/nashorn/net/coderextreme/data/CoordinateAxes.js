        ...
        .addChild(new Collision().setDEF("DoNotCollideWithVisualizationWidget")
          ...
          .addChild(new Group()
            ...
            .addChild(new Group().setDEF("ArrowGreen")
              ...
              .addChild(new Transform().setTranslation(Java.to([0,1,0], Java.type("float[]")))
                .addChild(new Shape()
                  .setGeometry(new Cone().setDEF("ArrowCone").setBottomRadius(0.05).setHeight(0.1))
                  .setAppearance(new Appearance().setUSE("Green")))))
            .addChild(new Transform().setTranslation(Java.to([0,1.08,0], Java.type("float[]")))
          ...
          .addChild(new Transform().setRotation(Java.to([0,0,1,-1.57079], Java.type("float[]")))
            ...
            .addChild(new Group()
              ...
              .addChild(new Transform().setRotation(Java.to([0,0,1,1.57079], Java.type("float[]"))).setTranslation(Java.to([0.072,1.1,0], Java.type("float[]")))
          ...
          .addChild(new Transform().setRotation(Java.to([1,0,0,1.57079], Java.type("float[]")))
            ...
            .addChild(new Group()
              ...
              .addChild(new Transform().setRotation(Java.to([1,0,0,-1.57079], Java.type("float[]"))).setTranslation(Java.to([0,1.1,0.072], Java.type("float[]")))
                .addComments(new CommentsBlock("note label rotated back to original coordinate frame"))
                .addChild(new Billboard()
                  .addChild(new Shape()
                    .setAppearance(new Appearance().setUSE("LABEL_APPEARANCE"))

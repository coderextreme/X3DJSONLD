        ...
        .addChild(new Collision().setDEF("DoNotCollideWithVisualizationWidget")
          ...
          .addChild(new Transform().setRotation(Java.to([0,0,1,-1.57079], Java.type("double[]")))
            ...
            .addChild(new Group()
              ...
              .addChild(new Transform().setRotation(Java.to([0,0,1,1.57079], Java.type("double[]"))).setTranslation(Java.to([0.072,1.1,0], Java.type("double[]")))
          ...
          .addChild(new Transform().setRotation(Java.to([1,0,0,1.57079], Java.type("double[]")))
            ...
            .addChild(new Group()
              ...
              .addChild(new Transform().setRotation(Java.to([1,0,0,-1.57079], Java.type("double[]"))).setTranslation(Java.to([0,1.1,0.072], Java.type("double[]")))
                .addComments(new CommentsBlock("note label rotated back to original coordinate frame"))
                .addChild(new Billboard()
                  .addChild(new Shape()
                    .setAppearance(new Appearance().setUSE("LABEL_APPEARANCE"))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new HAnimHumanoid().setName("Humanoid_Left_Foot").setDEF("Humanoid_Left_Foot").setInfo(Java.to(["humanoidVersion=2.0"], Java.type("java.lang.String[]"))).setJointBindingPositions(Java.to([0,0,0], Java.type("float[]"))).setJointBindingRotations(Java.to([0,0,1,0], Java.type("float[]"))).setJointBindingScales(Java.to([1,1,1], Java.type("float[]"))).setVersion("2.0")
          .addJoints(new HAnimJoint().setName("humanoid_root").setDEF("hanim_HumanoidRoot")
            .addChild(new HAnimJoint().setName("l_talocrural_joint").setDEF("l_talocrural_joint")
              ...
              .addChild(new HAnimJoint().setName("l_talocalcaneonavicular_joint").setDEF("l_talocalcaneonavicular_joint").setCenter(Java.to([0,-0.3,0], Java.type("float[]")))
                ...
                .addChild(new HAnimJoint().setName("l_cuneonavicular_joint1").setDEF("l_cuneonavicular_joint1").setCenter(Java.to([-0.1,-0.45,0], Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint().setName("l_tarsometatarsal_joint1").setDEF("l_tarsometatarsal_joint1").setCenter(Java.to([-0.1,-0.6,0], Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint().setName("l_metatarsophalangeal_joint1").setDEF("l_metatarsophalangeal_joint1").setCenter(Java.to([-0.1,-0.9,0], Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint().setName("l_f_Interphalangeal_joint").setDEF("l_f_Interphalangeal_joint").setCenter(Java.to([-0.1,-1.05,0], Java.type("float[]")))
                ...
                .addChild(new HAnimJoint().setName("l_cuneonavicular_joint2").setDEF("l_cuneonavicular_joint2").setCenter(Java.to([0,-0.45,0], Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint().setName("l_tarsometatarsal_joint2").setDEF("l_tarsometatarsal_joint2").setCenter(Java.to([0.05,-0.6,0], Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint().setName("l_metatarsophalangeal_joint2").setDEF("l_metatarsophalangeal_joint2").setCenter(Java.to([0.05,-0.9,0], Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint().setName("l_f_proximal_Interphalangeal_joint2").setDEF("l_f_proximal_Interphalangeal_joint2").setCenter(Java.to([0.05,-1.05,0], Java.type("float[]")))
                        ...
                        .addChild(new HAnimJoint().setName("l_f_distal_Interphalangeal_joint2").setDEF("l_f_distal_Interphalangeal_joint2").setCenter(Java.to([0.05,-1.12,0], Java.type("float[]")))
                ...
                .addChild(new HAnimJoint().setName("l_cuneonavicular_joint3").setDEF("l_cuneonavicular_joint3").setCenter(Java.to([0.1,-0.4,0], Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint().setName("l_tarsometatarsal_joint3").setDEF("l_tarsometatarsal_joint3").setCenter(Java.to([0.15,-0.6,0], Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint().setName("l_metatarsophalangeal_joint3").setDEF("l_metatarsophalangeal_joint3").setCenter(Java.to([0.15,-0.9,0], Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint().setName("l_f_proximal_Interphalangeal_joint3").setDEF("l_f_proximal_Interphalangeal_joint3").setCenter(Java.to([0.15,-1.05,0], Java.type("float[]")))
                        ...
                        .addChild(new HAnimJoint().setName("l_f_distal_Interphalangeal_joint3").setDEF("l_f_distal_Interphalangeal_joint3").setCenter(Java.to([0.15,-1.13,0], Java.type("float[]")))
              ...
              .addChild(new HAnimJoint().setName("l_calcaneuscuboid_joint").setDEF("l_calcaneuscuboid_joint").setCenter(Java.to([0.2,0.3,0], Java.type("float[]")))
                ...
                .addChild(new HAnimJoint().setName("l_transverse_tarsal_joint").setDEF("l_transverse_tarsal_joint").setCenter(Java.to([0.21,-0.3,0], Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint().setName("l_tarsometatarsal_joint4").setDEF("l_tarsometatarsal_joint4").setCenter(Java.to([0.25,-0.58,0], Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint().setName("l_metatarsophalangeal_joint4").setDEF("l_metatarsophalangeal_joint4").setCenter(Java.to([0.25,-0.87,0], Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint().setName("l_f_proximal_Interphalangeal_joint4").setDEF("l_f_proximal_Interphalangeal_joint4").setCenter(Java.to([0.25,-1,0], Java.type("float[]")))
                        ...
                        .addChild(new HAnimJoint().setName("l_f_distal_Interphalangeal_joint4").setDEF("l_f_distal_Interphalangeal_joint4").setCenter(Java.to([0.25,-1.1,0], Java.type("float[]")))
                  ...
                  .addChild(new HAnimJoint().setName("l_tarsometatarsal_joint5").setDEF("l_tarsometatarsal_joint5").setCenter(Java.to([0.33,-0.52,0], Java.type("float[]")))
                    ...
                    .addChild(new HAnimJoint().setName("l_metatarsophalangeal_joint5").setDEF("l_metatarsophalangeal_joint5").setCenter(Java.to([0.34,-0.8,0], Java.type("float[]")))
                      ...
                      .addChild(new HAnimJoint().setName("l_f_proximal_Interphalangeal_joint5").setDEF("l_f_proximal_Interphalangeal_joint5").setCenter(Java.to([0.34,-0.95,0], Java.type("float[]")))
                        ...
                        .addChild(new HAnimJoint().setName("l_f_distal_Interphalangeal_joint5").setDEF("l_f_distal_Interphalangeal_joint5").setCenter(Java.to([0.34,-1.05,0], Java.type("float[]")))

...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new Scene()
        ...
        .addChild(new Viewpoint().setCenterOfRotation(Java.to([0,1,0], Java.type("float[]"))).setDescription("Diamond Man, LOA 0").setPosition(Java.to([0,1,3], Java.type("float[]"))))
        .addChild(new HAnimHumanoid().setName("humanoid").setDEF("hanim_humanoid").setVersion("1.0")
          ...
          .setMetadata(new MetadataSet().setName("HAnimHumanoid.info").setReference("https://www.web3d.org/documents/specifications/19774/V2.0/Architecture/ObjectInterfaces.html#Humanoid")
            .setValue(new MetadataString().setName("authorEmail").setValue(Java.to(["beitler@graphics.cis.upenn.edu beitler@acm.org"], Java.type("java.lang.String[]"))))
          ...
          .setSkeleton(new HAnimJoint().setName("HumanoidRoot").setDEF("hanim_HumanoidRoot").setCenter(Java.to([0,0.824,0.0277], Java.type("float[]")))

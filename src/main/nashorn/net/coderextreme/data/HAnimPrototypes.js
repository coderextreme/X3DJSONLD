...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setHead(new head()
        .addComments(new CommentsBlock("Originally these fundamental prototypes were defined in InterchangableActorsViaDynamicRoutingPrototypes.x3d"))
      ...
      .setScene(new Scene()
        ...
        .addChild(new ProtoDeclare().setName("Humanoid1_1").setAppinfo("The Humanoid node serves as overall container for the Joint Segment Site and Viewpoint nodes which define the skeleton geometry and landmarks of the humanoid figure. Additionally the node provides a means for defining information about the author copyright and usage restrictions of the model.").setDocumentation("http://HAnim.org/Specifications/HAnim2001/part1/Humanoid.html")
          .setProtoInterface(new ProtoInterface()
            ...
            .addField(new field().setType(field.TYPE_MFNODE).setName("humanoidBody").setAccessType(field.ACCESSTYPE_INPUTOUTPUT).setAppinfo("HAnim 1.1 field container for body head. Hint: replaced by 2.0 skeleton.").setDocumentation("http://HAnim.org/Specifications/HAnim1.1/#humanoid"))
        ...
        .addChild(new Shape()
          ...
          .setAppearance(new Appearance()
            .setMaterial(new Material().setAmbientIntensity(0.25).setDiffuseColor(Java.to([0.795918,0.505869,0.093315], Java.type("float[]"))).setShininess(0.39).setSpecularColor(Java.to([0.923469,0.428866,0.006369], Java.type("float[]")))
              .addComments(new CommentsBlock("Universal Media Library: Autumn 9"))))))      ;

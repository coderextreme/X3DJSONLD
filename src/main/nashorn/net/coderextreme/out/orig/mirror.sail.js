...
ConfigurationProperties.setStripTrailingZeroes(true);
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new TextureBackgroundObject()
          .setLeftTexture(new ImageTextureObject().setDEF("leftBack").setUrl(Java.to(["images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/images/all_probes/beach_cross/beach_left.png"], Java.type("java.lang.String[]"))))
          .setRightTexture(new ImageTextureObject().setDEF("rightBack").setUrl(Java.to(["images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/images/all_probes/beach_cross/beach_right.png"], Java.type("java.lang.String[]"))))
          .setFrontTexture(new ImageTextureObject().setDEF("frontBack").setUrl(Java.to(["images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/images/all_probes/beach_cross/beach_front.png"], Java.type("java.lang.String[]"))))
          .setBackTexture(new ImageTextureObject().setDEF("backBack").setUrl(Java.to(["images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/images/all_probes/beach_cross/beach_back.png"], Java.type("java.lang.String[]"))))
          .setTopTexture(new ImageTextureObject().setDEF("topBack").setUrl(Java.to(["images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/images/all_probes/beach_cross/beach_top.png"], Java.type("java.lang.String[]"))))
          .setBottomTexture(new ImageTextureObject().setDEF("bottomBack").setUrl(Java.to(["images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/images/all_probes/beach_cross/beach_bottom.png"], Java.type("java.lang.String[]")))))
          ...
          .addChild(new ShapeObject()
            .setAppearance(new AppearanceObject()
              ...
              .setTexture(new ComposedCubeMapTextureObject()
                .setBack(new ImageTextureObject().setDEF("backShader").setUrl(Java.to(["images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/images/all_probes/beach_cross/beach_back.png"], Java.type("java.lang.String[]"))))
                .setBottom(new ImageTextureObject().setDEF("bottomShader").setUrl(Java.to(["images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/images/all_probes/beach_cross/beach_bottom.png"], Java.type("java.lang.String[]"))))
                .setFront(new ImageTextureObject().setDEF("frontShader").setUrl(Java.to(["images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/images/all_probes/beach_cross/beach_front.png"], Java.type("java.lang.String[]"))))
                .setLeft(new ImageTextureObject().setDEF("leftShader").setUrl(Java.to(["images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/images/all_probes/beach_cross/beach_left.png"], Java.type("java.lang.String[]"))))
                .setRight(new ImageTextureObject().setDEF("rightShader").setUrl(Java.to(["images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/images/all_probes/beach_cross/beach_right.png"], Java.type("java.lang.String[]"))))
                .setTop(new ImageTextureObject().setDEF("topShader").setUrl(Java.to(["images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/images/all_probes/beach_cross/beach_top.png"], Java.type("java.lang.String[]")))))
              .addShaders(new ComposedShaderObject().setDEF("x3dom").setLanguage("GLSL")
                ...
                .addParts(new ShaderPartObject().setType("FRAGMENT").setUrl(Java.to(["shaders/mix.fs","https://coderextreme.net/X3DJSONLD/shaders/mix.fs"], Java.type("java.lang.String[]")))))

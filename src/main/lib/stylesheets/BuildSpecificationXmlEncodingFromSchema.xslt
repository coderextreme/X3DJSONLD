...
<!--
  <head>
   ...
   <meta name="description" content="XSL stylesheet to convert X3D XML Schema to HTML files for X3D specification." />
   <meta name="identifier"  content="https://www.web3d.org/x3d/stylesheets/BuildSpecificationXmlEncodingFromSchema.xslt" />
   <meta name="reference"   content="https://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/BuildSpecificationXmlEncodingFromSchema.xslt?view=markup" />
...
<!-- Configuration values -->
  ...
  <xsl:variable name="nameXmlEncodingOfNodesFile">
    <xsl:text>EncodingOfNodes.html</xsl:text>
  </xsl:variable>
    <!--<xsl:text>part03/EncodingOfNodes.html</xsl:text>-->

  <xsl:variable name="nameXmlEncodingOfStatementsFile">
...
<xsl:result-document href="{$nameXmlEncodingOfNodesFile}" method="html" omit-xml-declaration="yes" encoding="UTF-8" indent="yes">
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
    ...
    <xsl:element name="meta">
      ...
      <xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/XmlEcoding/Part1/EncodingOfNodes.html</xsl:text></xsl:attribute>
    </xsl:element> <!-- meta -->
    <xsl:element name="meta">
...
<!--  <xsl:message>
	...
	<xsl:element name="table">
	  ...
	  <xsl:element name="tbody">
	    ...
	    <xsl:element name="tr">
	      ...
	      <xsl:element name="th">
		<xsl:attribute name="class"><xsl:text>nodes</xsl:text></xsl:attribute>
		<xsl:text>Node, attributes and fields, default&#160;values</xsl:text>
	...
	<xsl:attribute name="alt"><xsl:text>cube</xsl:text></xsl:attribute>
      ...
      <xsl:element name="a">
        <xsl:attribute name="id"><xsl:text>ContentModels</xsl:text></xsl:attribute>
	<xsl:text>6.3&#160;&#160;Content models</xsl:text>
      </xsl:element> <!-- a -->
    </xsl:element> <!-- h1-->
    <xsl:text>&#10;</xsl:text>
    ...
    <xsl:element name="h2">
      <xsl:element name="a">
        <xsl:attribute name="id"><xsl:text>Overview</xsl:text></xsl:attribute>
	<xsl:text>6.3.1&#160;&#160;Overview</xsl:text>
      </xsl:element> <!-- a -->
    </xsl:element> <!-- h2 -->
    <xsl:text>&#10;</xsl:text>
...
<xsl:result-document href="{$nameXmlEncodingOfStatementsFile}" method="html" omit-xml-declaration="yes" encoding="UTF-8" indent="yes">

...
<!--
  <head>
   <meta name="filename"    content="BuildSpecificationLanguageBindingC.xslt" />
   ...
   <meta name="identifier"  content="https://www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingC.xslt" />
   <meta name="reference"   content="http://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingC.xslt?revision=9169&view=markup" />
...
-  cd   C:\www.web3d.org\x3d\stylesheets
   c:\xml\saxon\saxon ../../specifications/x3d-3.3.xsd  BuildSpecificationLanguageBindingC.xslt
...
<xsl:message>
  <xsl:text>BuildSpecificationLanguageBindingC: process X3D schema version </xsl:text>
  <xsl:value-of select="//xs:schema/@version"/>
  <xsl:text> using BuildSpecificationLanguageBindingC.xslt </xsl:text>
 </xsl:message>
...
<xsl:result-document  href="CLanguageBinding.Part3.nodeTypeInterfaces.html" method="html" omit-xml-declaration="yes" encoding="UTF-8" indent="yes">
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="title">
		<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
		<xsl:text disable-output-escaping="yes">ISO/IEC 19777-3 CD -- X3D C language bindings - Annex A Abstract node interfaces </xsl:text>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>identifier</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/documents/specifications/19777-2/V3.3/Part3/nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/CLanguageBinding.Part3.nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
  ...
  <xsl:element name="body">
	...
	<xsl:for-each select="//xs:schema/xs:complexType[ends-with(@name,'Node') or (@name='X3DPrototypeInstance')]">
            ...
            <pre class="listing">
                ...
                <xsl:call-template name="c-source-from-schema-for-specification"/>
...
<pre class="listing">enum X3DFieldTypes {
...
<pre class="listing">struct X3DFieldEvent {
...
<pre class="listing">struct X3DFieldEventListener {
...
<pre class="listing">struct X3DFieldDefinition {
...
<pre class="listing">struct X3DField {
...
<pre class="listing">struct MField {
	...
	<xsl:for-each select="//xs:simpleType[starts-with(@name,'SF') or starts-with(@name,'MF')]">
            ...
            <pre class="listing">
                ...
                <xsl:call-template name="c-source-from-simpleType"/>
...
<pre class="listing">struct BrowserEvent 
{
...
<pre class="listing">struct BrowserFactory
{
...
<pre class="listing">struct Matrix3
{
...
<pre class="listing">struct Matrix4
{
...
<pre class="listing">struct ComponentInfo
{
    char* (*getName)(void* this);
...
<pre class="listing">struct ProfileInfo
{
    char* (*getName)(void* this);
    char* (*getTitle)(void* this);
...
<pre class="listing">struct X3DException 
{
...
<pre class="listing">struct BrowserNotSharedException 
{
...
<pre class="listing">struct ConnectionException
{
    struct X3DException* x3dException;
...
<pre class="listing">struct ImportedNodeException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InsufficientCapabilitiesException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidBrowserException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidDocumentException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidExecutionContextException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidFieldException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidFieldValueException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidNodeException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidOperationTimingException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidProtoException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidRouteException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidURLException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct InvalidX3DException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct NodeInUseException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct NodeUnavailableException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct NoSuchBrowserException 
{
    struct X3DException* x3dException;
...
<pre class="listing">struct NotSupportedException 
{
    struct X3DException* X3DException;
...
<pre class="listing">struct URLUnavailableException 
{
    struct X3DException* X3DException;
...
<xsl:result-document  href="CLanguageBinding.Part3.nodeInterfaces.html" method="html" omit-xml-declaration="yes" encoding="UTF-8" indent="yes">
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="title">
		<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
		<xsl:text disable-output-escaping="yes">ISO/IEC 19777-3 CD -- X3D C language bindings -- Annex B Concrete node interfaces </xsl:text>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>identifier</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/documents/specifications/19777-2/V3.3/Part3/nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/CLanguageBinding.Part3.nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
  ...
  <xsl:element name="body">
	...
	<xsl:element name="p">
		<xsl:text>This annex provides the definition of the rules to generate interface signatures for each interface that represents the concrete node instance as defined in</xsl:text>
		<xsl:text>&#10;</xsl:text>
		<xsl:element name="a">
			<xsl:attribute name="href"><xsl:text>references.html#[I19775_2]</xsl:text></xsl:attribute>
			<xsl:text>ISO/IEC 19775-2.</xsl:text>
...
<h2><a name="PackageDefinition"></a>B.2.1 Library definition</h2>

<p>Each concrete struct shall belong to the library corresponding to the component formal name under the X3D SAI parent library.</p>

<h2><a name="ClassDefinitions"></a>B.2.2 Structure definitions</h2>

<p>Concrete node representations in C are expressed as structs. </p>

<h2><a name="ClassDerivation"></a>B.2.3 Structure derivation</h2>

<p>	Each node interface shall extend the interfaces defined in  <a href="nodeTypeInterfaces.html">Annex A</a> as appropriate
	for the abstract node requirements for each node type.
</p>
<blockquote>
	  <p class="example">EXAMPLE The Inline 
         interface definition is:
      </p>	
<pre>
	struct Inline
	{
	    struct X3DchildNode* x3dchildNode;
	    struct X3DboundedObject* x3dboundedObject;
	    struct X3DurlObject* x3dUrlObject
	...
	}
</pre>
</blockquote>

<h2><a name="MethodDeclarations"></a>B.2.4 Function declarations</h2><p>
	Within each node interface there shall be functions to read and set the values for every field. The naming convention for each field function shall follow the definition in
	<a href="nodeTypeInterfaces.html#Conventions">A.1.2 Conventions</a> for the abstract
	interfaces. Where fields are already covered by the abstract interface, the concrete
	interface is not required to redeclare the same functions. The concrete interface shall
	declare functions that are not defined by the abstract node representation.</p>
...
<xsl:template name="list-restrictions">
    ...
    <xsl:choose>
        ...
        <xsl:when test="(@name='GeoOrigin') or (@name='geoOrigin')">
            <!-- http://docs.oracle.com/javase/8/docs/technotes/guides/cdoc/deprecation/deprecation.html -->
...
<xsl:template name="c-restrictions">
    ...
    <xsl:choose>
        <xsl:when test="(string-length($restrictions) > 0) and not(@type='SFString') and not(@type='MFString')
            ...
            <!-- verbose output, cdoc is sufficient:
...
<xsl:template name="cType-from-schemaType">
    <xsl:param name="schemaType" />
    <xsl:param name="default" select="@default"/>
...
<xsl:template name="c-source-from-simpleType">
    ...
    <xsl:variable name="cType">
        <xsl:call-template name="cType-from-schemaType">
            <xsl:with-param name="schemaType" select="$type"/>
        </xsl:call-template>
    </xsl:variable>
        ...
        <xsl:choose>
	        ...
	        <xsl:choose>
                <xsl:when test="starts-with(@name,'SF')">
                    <xsl:text>   struct X3DField* field</xsl:text>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:text>   struct MField* field</xsl:text>
                </xsl:otherwise>
            </xsl:choose>
        ...
        <xsl:otherwise>
            ...
            <xsl:variable name="cdocProse">
                ...
                <xsl:choose>
                    <xsl:when test="contains($cType,'[]')">
                        ...
                        <xsl:value-of select="substring-before($cType,'[]')"/>
            ...
            <xsl:choose>
                <xsl:when test="contains($type,'FVec') or contains($type,'FColor') or contains($type,'FNode')">
                    ...
                    <xsl:choose>
                        <!-- restore basic cType for SFNode/MFNode in case overridden by schema; a prototype instance might be returned -->
                        <xsl:when test="($type='SFNode')">
                            <xsl:text>struct X3DNode&amp;</xsl:text>
                        </xsl:when>
                        <xsl:when test="($type='MFNode')">
                ...
                <xsl:otherwise>
                    <xsl:value-of select="$cType"/>
                    <xsl:text> </xsl:text>
                    <xsl:text>(*getValue) (void* this)</xsl:text>
                </xsl:otherwise>
            </xsl:choose>
            <xsl:text>;</xsl:text>
            <xsl:text>&#10;</xsl:text>
            ...
            <xsl:if test="(@name='SFTime')">
                ...
                <!-- getter -->
                <xsl:text>&#160;&#160;</xsl:text>
                <xsl:text>long (*getCValue) (void* this);</xsl:text>
            <xsl:text>&#10;</xsl:text>
            </xsl:if>
            ...
            <xsl:if test="starts-with(@name,'MF')">
                ...
                <xsl:choose>
                    <xsl:when test="contains($type,'FVec') or contains($type,'FColor') or contains($type,'FNode')">
                        ...
                        <xsl:text> (void* this, int index, </xsl:text>
                        <xsl:choose>
                            <!-- restore basic cType for SFNode/MFNode in case overridden by schema; a prototype instance might be returned -->
                            <xsl:when test="($type='SFNode')">
                                <xsl:text>struct X3DNode</xsl:text>
                    ...
                    <xsl:otherwise>
                        ...
                        <xsl:text> </xsl:text>
                        <xsl:text>(*get1Value) (void* this, int index)</xsl:text>
                    </xsl:otherwise>
                </xsl:choose>
                <xsl:text>;</xsl:text>
                <xsl:text>&#10;</xsl:text>
            ...
            <xsl:if test="(@name='MFTime')">
                ...
                <!-- getter -->
                <xsl:text>&#160;&#160;</xsl:text>
                <xsl:text>long (*get1CValue) (void* this, int index);</xsl:text>
            <xsl:text>&#10;</xsl:text>
            </xsl:if>
            ...
            <xsl:choose>
                <xsl:when test="contains($cType,'|') and (@type='SFNode')">
                    <xsl:text>struct X3DNode</xsl:text>
                </xsl:when>
                <xsl:when test="contains($cType,'|') and (@type='MFNode')">
                    <xsl:text>struct X3DNode*</xsl:text>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="$cType"/>
            ...
            <xsl:if test="(@name='SFTime')">
                ...
                <!-- getter -->
                <xsl:text>&#160;&#160;</xsl:text>
                <xsl:text>void (*setValue) (void* this, long value);</xsl:text>
                <xsl:text>&#10;</xsl:text>
            </xsl:if>
            <xsl:if test="(@name='MFTime')">
                <!-- http://docs.oracle.com/javase/8/docs/api/java/lang/System.html#nanoTime- - (omit preceding space character from url) -->
                ...
                <!-- getter -->
                <xsl:text>&#160;&#160;</xsl:text>
                <xsl:text>void (*setValue) (void* this, int size, long* values);</xsl:text>
                <xsl:text>&#10;</xsl:text>
            </xsl:if>
            ...
            <xsl:if test="(@type='SFNode') and not((@name='addChildren') or (@name='removeChildren')) and (string-length(@default) > 0)">
                <xsl:text>&#10;</xsl:text>
                <xsl:value-of select="substring-before($cdocProse,' node')"/>
				...
				<xsl:text>2)</xsl:text>
                <!-- <xsl:text> (void* this, struct X3DPrototypeInstance protoInstance) throws InvalidFieldValueException;</xsl:text> -->
				<xsl:text> (void* this, struct X3DPrototypeInstance protoInstance);</xsl:text>
                <xsl:text>&#10;</xsl:text>
            </xsl:if>
            <xsl:if test="starts-with(@name,'MF') and (contains(@name,'Color') or contains(@name,'Rotation') or contains(@name,'FVec') or contains(@name,'Matrix'))">
                <xsl:text>&#10;</xsl:text>
            ...
            <xsl:if test="starts-with(@name,'MF')">
                ...
                <xsl:if test="(@name='MFTime')">
                    ...
                    <!-- getter -->
                    <xsl:text>&#160;&#160;</xsl:text>
                    <xsl:text>void (*set1Value) (void* this, int index, long value) throws ArrayIndexOutOfBoundsException;</xsl:text>
                    <xsl:text>&#10;</xsl:text>
                </xsl:if>
...
<xsl:template name="c-source-from-schema-for-specification">
    ...
    <xsl:choose>
        <xsl:when test="$abstract">
            ...
            <xsl:if test="(string-length($baseInterface) > 0)">
                <xsl:text> that extends structure</xsl:text>
...
<!--        <xsl:for-each select="xs:complexContent//xs:attribute                                     [not(@name='containerField')][not(@name='additionalInterface')][not(@name='componentName')][not(@name='componentLevel')] | 
    ...
    <xsl:choose>
        <xsl:when test="(@name='X3DNode')">
            ...
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            <xsl:text>void (*dispose) (void* this);</xsl:text>
            <xsl:text>&#10;</xsl:text>
            <!-- ========== -->
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            ...
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            <xsl:text>struct X3DField (*getField) (void* this, string name);</xsl:text>
            <xsl:text>&#10;</xsl:text>
            <!-- ========== -->
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            ...
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            <xsl:text>struct X3DFieldDefinition* (*getFieldDefinitions) (void* this);</xsl:text>
            <xsl:text>&#10;</xsl:text>
            <!-- ========== -->
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            ...
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            <xsl:text>string (*getNodeName) (void* this);</xsl:text>
            <xsl:text>&#10;</xsl:text>
            <!-- ========== -->
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            ...
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            <xsl:text>bool (*isRealized) (void* this);</xsl:text>
            <xsl:text>&#10;</xsl:text>
            <!-- ========== -->
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            ...
            <xsl:text>&#10;</xsl:text>
            <xsl:text>&#160;&#160;</xsl:text>
            <xsl:text>void (*realize) (void* this);</xsl:text>
            <xsl:text>&#10;</xsl:text>
            <!-- ========== -->
        </xsl:when>
    </xsl:choose>
...
<xsl:template name="generate-html-meta-tags">
   ...
   [fn:month-from-date(current-date())]"/>
	...
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>X3D Abstract Scene Access Interface (SAI), https://www.web3d.org/documents/specifications/19775-2/V3.3/Part03/X3D_SAI.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>X3D language bindings: C, https://www.web3d.org/documents/specifications/19777-2/V3.3/Part3/X3D_C.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
	...
	<xsl:element name="meta">
		...
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingC.xslt</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>generator</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingC.xslt?view=log</xsl:text></xsl:attribute>
	</xsl:element>
...
<xsl:template name="attribute-signature-output">
        ...
        <xsl:variable name="cSingletonType">
            <xsl:choose>
                <xsl:when test="contains($cType,'|') and (@type='SFNode')">
                    <xsl:text>struct X3DNode</xsl:text>
                </xsl:when>
                ...
                <xsl:when test="starts-with($cType,'MF')">
                    <xsl:text>S</xsl:text>
                    <xsl:value-of select="substring($cType,2)"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="$cType"/>
                </xsl:otherwise>
        ...
        <xsl:if test="not($accessType='outputOnly')">
            ...
            <xsl:if test="starts-with(@type,'MF') and not(contains(@type,'Matrix')) and not(contains(@type,'Color')) and not(contains(@type,'Rotation')) and not(contains(@type,'Vec'))">
                ...
                <xsl:if test="contains(@type,'FNode')">
                    <xsl:text>&#10;</xsl:text>
                    <xsl:choose>
                        <xsl:when test="contains($cdocProse,' nodes')">
                            <xsl:value-of select="substring-before($cdocProse,' nodes')"/>
                            <xsl:text> protoInstance</xsl:text>
                            <xsl:value-of select="substring-after($cdocProse,' nodes')"/>
                        </xsl:when>
                        <xsl:when test="contains($cdocProse,' node')">
                            <xsl:value-of select="substring-before($cdocProse,' node')"/>
                            <xsl:text> protoInstance</xsl:text>
                            <xsl:value-of select="substring-after($cdocProse,' node')"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:value-of select="$cdocProse"/>
                        </xsl:otherwise>
                    ...
                    <xsl:text> (void* this, struct X3DPrototypeInstance </xsl:text>
                    <!-- singular -->
                    <xsl:value-of select="substring($defaultParameterName,1,string-length($defaultParameterName)-1)"/>
                    <xsl:text>)</xsl:text>
                    <xsl:call-template name="c-restrictions"/>

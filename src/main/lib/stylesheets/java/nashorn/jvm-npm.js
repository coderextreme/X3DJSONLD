 ...
 *
 *  I, John Carlson, changed this file.
 */
...
(function () {
  ...
  function readFile (filename, core) {
	...
	input = new java.io.FileInputStream(filename);
      ...
      var MyInputStream = Java.type("net.coderextreme.MyInputStream")
      return new java.lang.String(new MyInputStream(input).readAllBytes());
    } catch (e) {

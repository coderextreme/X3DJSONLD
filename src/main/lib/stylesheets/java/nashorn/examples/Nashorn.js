...
ProtoInstance1
    ...
    X3D0.toFileJSON("./nashorn/examples/Nashorn.json");
    var X3DJSONLD = Java.type("net.coderextreme.X3DJSONLD")
    var loader = new X3DJSONLD();
    var File = Java.type("java.io.File")
    var jsobj = loader.readJsonFile(new File("./nashorn/examples/Nashorn.json"));
    ...
    X3D0.toFileX3D("./nashorn/examples/Nashorn.x3d");

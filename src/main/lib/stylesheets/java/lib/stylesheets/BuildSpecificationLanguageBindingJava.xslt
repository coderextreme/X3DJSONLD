...
<!--
  <head>
   ...
   <meta name="identifier"  content="http://www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingJava.xslt" />
...
<xsl:variable name="specificationIndexUrl">
    <xsl:text>http://www.web3d.org/documents/specifications/19775-1/V3.3/Part01/</xsl:text>
</xsl:variable>
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="meta">
		...
		<xsl:attribute name="content"><xsl:text>http://www.web3d.org/documents/specifications/19777-2/V3.3/Part2/nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://www.web3d.org/x3d/stylesheets/JavaLanguageBinding.Part2.nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
...
<pre class="listing">public class URLUnavailableException extends X3DException
{
	...
	public URLUnavailableException(String);
        ...
        <p>
            ...
            <a href="http://www.web3d.org/specifications/JavaLanguageBinding/Part2/nodeTypeInterfaces.html">http://www.web3d.org/specifications/JavaLanguageBinding/Part2/nodeTypeInterfaces.html</a>
            <br />
            ISO-approved version online at
            <a href="http://www.web3d.org/documents/specifications/19777-2/V3.3/Part2/abstracts.html">http://www.web3d.org/documents/specifications/19777-2/V3.3/Part2/abstracts.html</a>
        </p>
        <hr />
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>identifier</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://www.web3d.org/documents/specifications/19777-2/V3.3/Part2/nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://www.web3d.org/x3d/stylesheets/JavaLanguageBinding.Part2.nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
...
declare methods that are not defined by the abstract node representation.</p>
	...
	<xsl:for-each select="//xs:schema/xs:element[not(@name='TODO')]">
        ...
        <p>
            ...
            See
            <a href="http://www.web3d.org/member-only/mantis/view.php?id=689">Mantis issue 689</a>.
        </p>
        ...
        <p>
            ...
            See
            <a href="http://www.web3d.org/member-only/mantis/view.php?id=690">Mantis issue 690</a>.
        </p>
        ...
        <p>
            ...
            <a href="http://www.web3d.org/documents/specifications/19777-2/V3.0/Part2/compilation.html">Annex A, Constructs in Compilation Order</a>.
            See
            <a href="http://www.web3d.org/member-only/mantis/view.php?id=673">Mantis issue 673</a>.
        </p>
        ...
        <p>
            ...
            <br />
            Autogenerated version online at
            <a href="http://www.web3d.org/specifications/JavaLanguageBinding/Part2/nodeInterfaces.html">http://www.web3d.org/specifications/JavaLanguageBinding/Part2/nodeInterfaces.html</a>
            <br />
            ISO-approved version online at
            <a href="http://www.web3d.org/documents/specifications/19777-2/V3.3/Part2/concretes.html">http://www.web3d.org/documents/specifications/19777-2/V3.3/Part2/concretes.html</a>
        </p>
...
<xsl:template name="generate-html-meta-tags">
   ...
   [fn:month-from-date(current-date())]"/>
	...
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>X3D Abstract Scene Access Interface (SAI), http://www.web3d.org/documents/specifications/19775-2/V3.3/Part02/X3D_SAI.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>X3D language bindings: Java, http://www.web3d.org/documents/specifications/19777-2/V3.3/Part2/X3D_Java.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://www.web3d.org/standards</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
	...
	<xsl:element name="meta">
		...
		<xsl:attribute name="content"><xsl:text>http://www.web3D.org/x3d/stylesheets/BuildSpecificationLanguageBindingJava.xslt</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>generator</xsl:text></xsl:attribute>

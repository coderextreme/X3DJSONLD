			...
			<xsl:element name="html">
				...
				<xsl:element name="head">
					...
					<xsl:element name="title">
						<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
						<xsl:text disable-output-escaping="yes">ISO/IEC 19777-4:20xx -- X3D C++ Binding -- Annex A Node type interfaces </xsl:text>
					</xsl:element>
					...
					<xsl:element name="p">
						...
						<xsl:element name="a">
							<xsl:attribute name="href">
								<xsl:text>references.html#[I19777-4]</xsl:text>
							</xsl:attribute>
		...
		<xsl:result-document  href="CPPLanguageBinding.Part4.nodeInterfaces.html" method="html" omit-xml-declaration="yes" encoding="UTF-8" indent="yes">
			...
			<xsl:element name="html">
				...
				<xsl:element name="head">
					...
					<xsl:element name="title">
						<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
						<xsl:text disable-output-escaping="yes">ISO/IEC 19777-4:202x -- X3D C++ Binding -- Annex B Node interfaces </xsl:text>
					</xsl:element>
					<xsl:element name="meta">
						<xsl:attribute name="name">
							<xsl:text>identifier</xsl:text>
				...
				<xsl:element name="body">
					...
					<xsl:element name="p">
						...
						<xsl:element name="a">
							<xsl:attribute name="href">
								<xsl:text>references.html#[I19777]</xsl:text>
							</xsl:attribute>
					...
					<p>
						DONE.  The node-generation blocks are successfully creating Annex A - Concrete node interfaces.

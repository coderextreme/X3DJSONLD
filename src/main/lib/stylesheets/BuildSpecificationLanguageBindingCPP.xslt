...
<!-- create HTML output -->
  ...
  <xsl:variable name="CppSourceDirectoryTree"> <!-- {$CppSourceDirectoryTree} -->
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="title">
		<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
		<xsl:text disable-output-escaping="yes">ISO/IEC 19777-4:20xx -- X3D C++ Binding -- Annex B Node type interfaces </xsl:text>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>identifier</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/documents/specifications/19777-4/V3.3/Part4/nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/CPPLanguageBinding.Part4.nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
  ...
  <xsl:element name="body">
	...
	<xsl:element name="p">
		...
		<xsl:text>&#10;</xsl:text>
		<xsl:element name="a">
			<xsl:attribute name="href"><xsl:text>references.html#[I19777-4]</xsl:text></xsl:attribute>
			<xsl:text>ISO/IEC Committee Draft 19777-4:202x</xsl:text>
		</xsl:element>
		<xsl:text>.</xsl:text>
		<xsl:text>&#10;</xsl:text>
	</xsl:element>
	...
	<xsl:text>&#10;</xsl:text>
        ...
        <ul>
            ...
            <li>Fields that are represented by primitive value types, setter methods
			    return the appropriate primitive value. </li>
            <li>Fields that are represented by primitive value types, getter methods 
...
<pre class="listing">class X3DFieldTypes {
  public:
    int INPUT_ONLY = 1;
...
<pre class="listing">class X3DFieldEvent : public EventObject {
...
<pre class="listing">class X3DFieldEventListener : public EventListener {
...
<pre class="listing">class X3DFieldDefinition {
...
<pre class="listing">class X3DField {
...
<pre class="listing">class MField : public X3DField {
...
<pre class="listing">class BrowserEvent : public EventObject
{
public:
...
<pre class="listing">class BrowserFactory
{
public:
	BrowserFactory();
...
<pre class="listing">class Matrix3
{
public:
	Matrix3();
	void setIdentity();
...
<pre class="listing">class Matrix4
{
public:	
	Matrix4();
	void setIdentity();
...
<pre class="listing">class ComponentInfo
{
public:
    string getName();
    int getLevel();
...
<pre class="listing">class ProfileInfo
{
public:    
	string getName();
    string getTitle();
...
<pre class="listing">class X3DException : public RuntimeException
{
public:
	X3DException();
	X3DException(String);
...
<pre class="listing">class BrowserNotSharedException : public X3DException
{
public:
...
<pre class="listing">class ConnectionException : public X3DException
{
public:	
	ConnectionException();
...
<pre class="listing">class ImportedNodeException : public X3DException
{
public:	
...
<pre class="listing">class InsufficientCapabilitiesException : public X3DException
{
public:
...
<pre class="listing">class InvalidBrowserException : public X3DException
{
public:
...
<pre class="listing">class InvalidDocumentException : public X3DException
{
public:
...
<pre class="listing">class InvalidExecutionContextException : public X3DException
{
public:	
...
<pre class="listing">class InvalidFieldException : public X3DException
{
public:
...
<pre class="listing">class InvalidFieldValueException : public X3DException
{
public:	
...
<pre class="listing">class InvalidNodeException : public X3DException
{
public:	
...
<pre class="listing">class InvalidOperationTimingException : public X3DException
{
public:	
...
<pre class="listing">class InvalidProtoException : public X3DException
{
public:	
...
<pre class="listing">class InvalidRouteException : public X3DException
{
public:
...
<pre class="listing">class InvalidURLException : public X3DException
{
public:
	InvalidURLException();
...
<pre class="listing">class InvalidX3DException : public X3DException
{
public:
	InvalidX3DException();
...
<pre class="listing">class NodeInUseException : public X3DException
{
public:	
	NodeInUseException();
...
<pre class="listing">class NodeUnavailableException : public X3DException
{
public:
...
<pre class="listing">class NoSuchBrowserException : public X3DException
{
public:
    NoSuchBrowserException();
...
<pre class="listing">class NotSupportedException : public X3DException
{
public:
...
<pre class="listing">class URLUnavailableException : public X3DException
{
public:
	...
	URLUnavailableException(string);
        ...
        <p>
            ...
            <a href="https://www.web3d.org/specifications/CPPLanguageBinding/Part4/nodeTypeInterfaces.html">https://www.web3d.org/specifications/CPPLanguageBinding/Part4/nodeTypeInterfaces.html</a>
            <br />
            ISO-approved version online at
            <a href="https://www.web3d.org/documents/specifications/19777-2/V3.3/Part4/abstracts.html">https://www.web3d.org/documents/specifications/19777-2/V3.3/Part4/abstracts.html</a>
        </p>
        <hr />
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="title">
		<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
		<xsl:text disable-output-escaping="yes">ISO/IEC 19777-4:202x -- X3D C++ Binding -- Annex C Node interfaces </xsl:text>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>identifier</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/documents/specifications/19777-4/V3.3/Part4/nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/CPPLanguageBinding.Part4.nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
  ...
  <xsl:element name="body">
	...
	<xsl:element name="p">
		...
		<xsl:text>(see </xsl:text>
		<xsl:element name="a">
			<xsl:attribute name="href"><xsl:text>references.html#[I19777]</xsl:text></xsl:attribute>
			<xsl:text>2.[19777]</xsl:text>
		</xsl:element>
		<xsl:text>).</xsl:text>
		<xsl:text>&#10;</xsl:text>
	</xsl:element>
	...
	<xsl:element name="div">
		...
		<xsl:element name="a">
			...
			<xsl:text>C.1&#160;&#160;Generation rules</xsl:text>
		</xsl:element>
	</xsl:element>
	<xsl:text>&#10;</xsl:text>
        <xsl:text>&#10;</xsl:text>

<h2><a name="ClassDefinitions"></a>C.2.1 Class definitions</h2>

<p>Concrete node representations in C++ shall be expressed as public classes. </p>

<h2><a name="ClassDerivation"></a>C.2.2 Class derivation</h2>

<p>
	Each concrete node shall extend the classes defined in Annex A as appropriate for the abstract node requirements for each node type. For example, the Inline
...
<h2><a name="MethodDeclarations"></a>C.2.3 Method declarations</h2><p>
	...
	<a href="nodeTypeInterfaces.html#Conventions">B.1.2 Conventions</a> for the abstract classes. Where fields are already covered by the abstract class, the concrete 
	class is not required to redeclare the same methods. The concrete class shall declare methods that are not defined by the abstract node representation.
		...
		<xsl:element name="a">
			...
			<xsl:text>C.3&#160;&#160;Node classes</xsl:text>
		</xsl:element>
	</xsl:element>
	<xsl:text>&#10;</xsl:text>
        <xsl:text>&#10;</xsl:text>
	...
	<xsl:for-each select="//xs:schema/xs:element[not(@name='TODO')]">
        ...
        <p>
            ...
            and authors looking for a lightweight way to compile Script code written in C++.
            Also needed for confirming class hierarchy listings in 
            <a href="https://www.web3d.org/documents/specifications/19777-4/V3.0/Part4/compilation.html">Annex A, Constructs in Compilation Order</a>.
            See
        ...
        <p>
            ...
            <br />
            Autogenerated version online at
            <a href="https://www.web3d.org/specifications/CPPLanguageBinding/Part4/nodeInterfaces.html">https://www.web3d.org/specifications/CPPLanguageBinding/Part4/nodeInterfaces.html</a>
            <br />
            ISO-approved version online at
            <a href="https://www.web3d.org/documents/specifications/19777-4/V3.3/Part4/concretes.html">https://www.web3d.org/documents/specifications/19777-4/V3.3/Part4/concretes.html</a>
        </p>
...
<xsl:template name="generate-html-meta-tags">
   ...
   [fn:month-from-date(current-date())]"/>
	...
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>X3D Abstract Scene Access Interface (SAI), https://www.web3d.org/documents/specifications/19775-2/V3.3/Part04/X3D_SAI.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
	...
	<xsl:element name="meta">
		...
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingCPP.xslt</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>generator</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingCPP.xslt?view=log</xsl:text></xsl:attribute>
	</xsl:element>

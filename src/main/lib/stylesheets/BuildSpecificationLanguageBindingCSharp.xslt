...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="title">
		<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
		<xsl:text disable-output-escaping="yes">ISO/IEC 19777-5 -- X3D C# Language Binding -- Annex A Abstract node interfaces </xsl:text>
	</xsl:element>
  ...
  <xsl:element name="body">
	...
	<xsl:text>&#10;</xsl:text>
        ...
        <p>
            ...
            the C# language syntax as would be seen in a C# source file.
        </p>
        ...
        <ul>
            ...
            <li>Fields that are represented by C# primitive value types, setter
                methods return the appropriate primitive value. </li>
            <li>Fields that are represented by C# primitive value types, getter
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="title">
		<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
		<xsl:text disable-output-escaping="yes">ISO/IEC 19777-5 -- X3D C# Language Binding -- Annex B Concrete node interfaces </xsl:text>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>identifier</xsl:text></xsl:attribute>
  ...
  <xsl:element name="body">
	...
	<xsl:element name="div">
		...
		<xsl:element name="p">
			<xsl:attribute name="class"><xsl:text>HeadingClause</xsl:text></xsl:attribute>
			<xsl:text>Concrete node interfaces</xsl:text>
		</xsl:element>
	</xsl:element>
	<xsl:text>&#10;</xsl:text>
...
<h2><a name="ClassDefinitions"></a>B.2.1 Class definitions</h2>

<p>Concrete node representations shall be expressed as public interfaces. </p>

<h2><a name="ClassDerivation"></a>B.2.2 Class derivation</h2>
...
<blockquote>
<pre>
    public interface Inline : X3DChildNode, X3DBoundedObject, X3DUrlObject
    {
      ...
    }
</pre>
    ...
    <xsl:choose>
        ...
        <xsl:when test="xs:simpleType/xs:restriction">
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <xsl:text>(-inf</xsl:text> <!-- &infin; infinity symbol -->
                </xsl:otherwise>
            </xsl:choose>
            <xsl:text>,</xsl:text>
            <xsl:choose>
...
<xsl:template name="generate-html-meta-tags">
   ...
   [fn:month-from-date(current-date())]"/>
	...
	<xsl:element name="meta">
		...
		<xsl:attribute name="content"><xsl:text>This stylesheet generates X3D Scene Access Interface (SAI) bindings in C# the latest X3D Schema to autogenerate all interface definitions.</xsl:text>
                </xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
	...
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>X3D language bindings: C#, https://www.web3d.org/documents/specifications/19777-5/V3.3/Part5/X3D_C#.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>

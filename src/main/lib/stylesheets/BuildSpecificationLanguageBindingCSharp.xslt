...
<!--
  <head>
   <meta name="filename"    content="BuildSpecificationLanguageBindingCSharp.xslt" />
   ...
   <meta name="identifier"  content="https://www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingCSharp.xslt" />
   <meta name="reference"   content="http://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingCSharp.xslt?revision=9169&view=markup" />
...
-  cd   C:\www.web3d.org\x3d\stylesheets
   c:\xml\saxon\saxon ../../specifications/x3d-3.3.xsd  BuildSpecificationLanguageBindingCSharp.xslt
...
<xsl:message>
  <xsl:text>BuildSpecificationLanguageBindingCSharp: process X3D schema version </xsl:text>
  <xsl:value-of select="//xs:schema/@version"/>
  <xsl:text> using BuildSpecificationLanguageBindingCSharp.xslt </xsl:text>
 </xsl:message>
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="meta">
		...
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/documents/specifications/19777-2/V3.3/Part5/nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/JavaLanguageBinding.Part5.nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
...
<pre class="listing">public class URLUnavailableException : X3DException
{
	...
	public URLUnavailableException(String);
        ...
        <p>
            ...
            <a href="https://www.web3d.org/specifications/JavaLanguageBinding/Part5/nodeTypeInterfaces.html">https://www.web3d.org/specifications/JavaLanguageBinding/Part5/nodeTypeInterfaces.html</a>
            <br />
            ISO-approved version online at
            <a href="https://www.web3d.org/documents/specifications/19777-2/V3.3/Part5/abstracts.html">https://www.web3d.org/documents/specifications/19777-2/V3.3/Part5/abstracts.html</a>
        </p>
        <hr />
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>identifier</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/documents/specifications/19777-2/V3.3/Part5/nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/JavaLanguageBinding.Part5.nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
...
declare methods that are not defined by the abstract node representation.</p>
	...
	<xsl:for-each select="//xs:schema/xs:element[not(@name='TODO')]">
        ...
        <p>
            ...
            <a href="https://www.web3d.org/documents/specifications/19777-2/V3.0/Part5/compilation.html">Annex A, Constructs in Compilation Order</a>.
            See
        ...
        <p>
            ...
            <br />
            Autogenerated version online at
            <a href="https://www.web3d.org/specifications/JavaLanguageBinding/Part5/nodeInterfaces.html">https://www.web3d.org/specifications/JavaLanguageBinding/Part5/nodeInterfaces.html</a>
            <br />
            ISO-approved version online at
            <a href="https://www.web3d.org/documents/specifications/19777-2/V3.3/Part5/concretes.html">https://www.web3d.org/documents/specifications/19777-2/V3.3/Part5/concretes.html</a>
        </p>
...
<xsl:template name="generate-html-meta-tags">
   ...
   [fn:month-from-date(current-date())]"/>
	...
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>X3D language bindings: C#, https://www.web3d.org/documents/specifications/19777-2/V3.3/Part5/X3D_CSharp.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
	...
	<xsl:element name="meta">
		...
		<xsl:attribute name="content"><xsl:text>https://www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingCSharp.xslt</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>generator</xsl:text></xsl:attribute>

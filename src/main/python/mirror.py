...
X3D0.setHead(head1)
Scene8 = SceneObject()
Viewpoint9 = ViewpointObject().setPosition([0,5,100]).setDescription("Switch background and cubemap texture")
Scene8.addChild(Viewpoint9)
TextureBackground10 = TextureBackgroundObject()
ImageTexture11 = ImageTextureObject().setDEF("leftBack").setUrl(["cubemap/all_probes/beach_cross/beach_left.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_left.png"])
TextureBackground10.setLeftTexture(ImageTexture11)
ImageTexture12 = ImageTextureObject().setDEF("rightBack").setUrl(["cubemap/all_probes/beach_cross/beach_right.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_right.png"])
TextureBackground10.setRightTexture(ImageTexture12)
ImageTexture13 = ImageTextureObject().setDEF("frontBack").setUrl(["cubemap/all_probes/beach_cross/beach_front.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_front.png"])
TextureBackground10.setFrontTexture(ImageTexture13)
ImageTexture14 = ImageTextureObject().setDEF("backBack").setUrl(["cubemap/all_probes/beach_cross/beach_back.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_back.png"])
TextureBackground10.setBackTexture(ImageTexture14)
ImageTexture15 = ImageTextureObject().setDEF("topBack").setUrl(["cubemap/all_probes/beach_cross/beach_top.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_top.png"])
TextureBackground10.setTopTexture(ImageTexture15)
ImageTexture16 = ImageTextureObject().setDEF("bottomBack").setUrl(["cubemap/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_bottom.png"])
...
ImageTexture22 = ImageTextureObject().setDEF("backShader").setUrl(["cubemap/all_probes/beach_cross/beach_back.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_back.png"])
ComposedCubeMapTexture21.setBack(ImageTexture22)
ImageTexture23 = ImageTextureObject().setDEF("bottomShader").setUrl(["cubemap/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_bottom.png"])
ComposedCubeMapTexture21.setBottom(ImageTexture23)
ImageTexture24 = ImageTextureObject().setDEF("frontShader").setUrl(["cubemap/all_probes/beach_cross/beach_front.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_front.png"])
ComposedCubeMapTexture21.setFront(ImageTexture24)
ImageTexture25 = ImageTextureObject().setDEF("leftShader").setUrl(["cubemap/all_probes/beach_cross/beach_left.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_left.png"])
ComposedCubeMapTexture21.setLeft(ImageTexture25)
ImageTexture26 = ImageTextureObject().setDEF("rightShader").setUrl(["cubemap/all_probes/beach_cross/beach_right.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_right.png"])
ComposedCubeMapTexture21.setRight(ImageTexture26)
ImageTexture27 = ImageTextureObject().setDEF("topShader").setUrl(["cubemap/all_probes/beach_cross/beach_top.png","http://coderextreme.net/cubemap/all_probes/beach_cross/beach_top.png"])

...
newModel=X3D(profile='Full',version='3.3',
  head=head(
    ...
    meta(name='identifier',content='file:///home/holger/Projekte/Cobweb/excite/tests/Components/ParticleSystems/DolphinSurfaceEmitter.x3d'),
    meta(name='modified',content='Sat, 30 Apr 2016 11:54:15 GMT')]),
  Scene=Scene(
    children=[
          ...
          MetadataSet(DEF='children',name='children',reference='http://titania.create3000.de',
            ...
            Transform(DEF='Box',
              ...
              Shape(
                ...
                geometry=ProtoInstance(name='Dolphin',DEF='_1'))])])])])),
    ...
    TimeSensor(DEF='_2',cycleInterval=10,loop=True),
    Transform(USE='Box'),
    ParticleSystem(geometryType='SPRITE',maxParticles=2000,particleLifetime=1,particleSize=(6,6),
      emitter=SurfaceEmitter(speed=2,mass=0.01,surfaceArea=0.01,
        surface=ProtoInstance(name='Dolphin',USE='_1')),
      appearance=Appearance(
    ...
    ROUTE(fromNode='_2',fromField='fraction_changed',toNode='_1',toField='set_fraction')])
) # X3D model complete

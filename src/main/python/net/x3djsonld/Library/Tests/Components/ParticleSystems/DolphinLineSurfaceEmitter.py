    ...
    WorldInfo(
      metadata=MetadataSet(DEF='Titania',name='Titania',reference='http://titania.create3000.de',
        ...
        MetadataSet(DEF='Viewpoint',name='Viewpoint',reference='http://titania.create3000.de',
          value=[
          MetadataDouble(DEF='position',name='position',reference='http://titania.create3000.de',value=[209.085708618164,-284.294311523438,251.209625244141]),
          MetadataDouble(DEF='orientation',name='orientation',reference='http://titania.create3000.de',value=[0.832041258895059,0.311619716372351,0.458912296484134,1.01485308574234]),
          ...
          MetadataSet(DEF='children',name='children',reference='http://titania.create3000.de',
            ...
            ParticleSystem(DEF='_1',geometryType='LINE',maxParticles=15000,particleSize=(6,6),
              ...
              appearance=Appearance(
                material=Material(DEF='Rococo17',ambientIntensity=0.187004,diffuseColor=(0,0,0),emissiveColor=(0.640987,0.460097,0.748016),shininess=0.612121)))])])])),

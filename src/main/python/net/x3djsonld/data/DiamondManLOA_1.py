...
newModel=X3D(profile='Immersive',version='3.3',
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='hanim_humanoid',name='humanoid',version='1.0',
      ...
      skeleton=[
      HAnimJoint(DEF='hanim_HumanoidRoot',center=(0.0,0.8240,0.0277),name='HumanoidRoot',ulimit=[0,0,0],llimit=[0,0,0],
        children=[
            ...
            HAnimJoint(DEF='hanim_r_knee',center=(-0.0867,0.4913,0.0318),name='r_knee',ulimit=[0,0,0],llimit=[0,0,0],
              ...
              HAnimSegment(DEF='hanim_r_calf',name='r_calf',
                ...
                Transform(translation=(-0.0867,0.4913,0.0318),
                  children=[
                  Shape(USE='DiamondShape')])]),
              HAnimJoint(DEF='hanim_r_ankle',center=(-0.0801,0.0712,-0.0766),name='r_ankle',ulimit=[0,0,0],llimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_midtarsal',center=(-0.0801,0.0,0.0368),name='r_midtarsal',ulimit=[0,0,0],llimit=[0,0,0],
                  children=[
        ...
        HAnimJoint(DEF='hanim_vl1',center=(-0.00405,1.07,-0.0275),name='vl1',ulimit=[0,0,0],llimit=[0,0,0],
          children=[
          ...
          HAnimJoint(DEF='hanim_r_shoulder',center=(-0.1907,1.4407,-0.0325),name='r_shoulder',ulimit=[0,0,0],llimit=[0,0,0],
            ...
            HAnimJoint(DEF='hanim_r_elbow',center=(-0.1949,1.1388,-0.0620),name='r_elbow',ulimit=[0,0,0],llimit=[0,0,0],
              ...
              HAnimJoint(DEF='hanim_r_wrist',center=(-0.1959,0.8694,-0.0521),name='r_wrist',ulimit=[0,0,0],llimit=[0,0,0],
                children=[
          ...
          HAnimJoint(DEF='hanim_vc4',center=(0,1.43,-0.0458),name='vc4',ulimit=[0,0,0],llimit=[0,0,0],
            children=[
      ...
      joints=[
      HAnimJoint(USE='hanim_HumanoidRoot',ulimit=[0,0,0],llimit=[0,0,0]),
...
print('Self-test diagnostics for DiamondManLOA_1.py:')
...
print("python DiamondManLOA_1.py load and self-test diagnostics complete.")

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumExample.x3d',name='identifier'),
...
print('Self-test diagnostics for ViewFrustumExample.py:')
...
print("python ViewFrustumExample.py load and self-test diagnostics complete.")

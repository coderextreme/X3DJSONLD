...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='Quotes.x3d',name='title'),
    ...
    meta(content='X3dValidator https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d',name='reference'),
...
print('Self-test diagnostics for Quotes.py:')
...
print("python Quotes.py load and self-test diagnostics complete.")

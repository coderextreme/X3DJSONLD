...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='X3dValidator https://savage.nps.edu/X3dValidator?url=http://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d',name='reference'),

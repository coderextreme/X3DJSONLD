  ...
  Scene=Scene(
    ...
    Shape(
      appearance=Appearance(
        acousticProperties=AcousticProperties(description='Testing of X3D4 nodes demonstrating W3C Audio API in progress',diffuse=0.25,refraction=0.5,specular=1.0),
        material=Material(),),
      geometry=Box(),),

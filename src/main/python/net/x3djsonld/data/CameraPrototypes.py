...
newModel=X3D(profile='Immersive',version='3.2',
  head=head(
    ...
    meta(content='http://www.web3d.org/x3d/specifications/ISO-IEC-FDIS-19775-1.2-X3D-AbstractSpecification/Part01/components/navigation.html',name='reference'),
    meta(content='Camera nodes for Viewpoint navigation control',name='subject'),
    meta(content='CameraExamples.x3d',name='reference'),
    meta(content='http://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Anchor(description='launch CameraExample scene',url=["CameraExamples.x3d","http://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.x3d","CameraExamples.wrl","http://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.wrl"],
      children=[
      Transform(
        children=[
        Shape(

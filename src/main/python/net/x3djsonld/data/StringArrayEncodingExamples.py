...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://www.web3d.org/documents/specifications/19775-1/V3.3/Part01/fieldsDef.html#SFStringAndMFString',name='specificationUrl'),
    meta(content='X3D encodings, ISO/IEC 19776-1.3, Part 1: XML encoding, 5.3.14 SFString and MFString',name='specificationSection'),
    meta(content='http://www.web3d.org/documents/specifications/19776-1/V3.3/Part01/EncodingOfFields.html#SFString',name='specificationUrl'),
    ...
    meta(content='http://www.web3d.org/documents/specifications/19776-2/V3.3/Part02/EncodingOfFields.html#SFString',name='specificationUrl'),
    meta(content='http://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/StringArrayEncodingExamples.x3d',name='identifier'),
...
print ("python x3d.py load successful for StringArrayEncodingExamples.py")

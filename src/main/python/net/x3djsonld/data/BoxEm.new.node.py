...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://coderextreme.net/X3DJSONLD/src/main/data/box.x3d',name='identifier'),
...
print('Self-test diagnostics for BoxEm.py:')
...
print("python BoxEm.py load and self-test diagnostics complete.")

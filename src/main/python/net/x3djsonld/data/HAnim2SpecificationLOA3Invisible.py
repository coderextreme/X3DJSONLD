...
newModel=X3D(profile='Immersive',version='4.0',
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='hanim_humanoid',loa=3,name='humanoid',version='2.0',
      ...
      skeleton=[
      HAnimJoint(DEF='hanim_humanoid_root',center=(0,0.824,0.0277),name='humanoid_root',stiffness=[0,0,0],
        children=[
        HAnimSegment(DEF='hanim_sacrum',name='sacrum'),
        HAnimJoint(DEF='hanim_sacroiliac',center=(0,0.9149,0.0016),name='sacroiliac',stiffness=[0,0,0],
          children=[
          ...
          HAnimJoint(DEF='hanim_l_hip',center=(0.0961,0.9124,-0.0001),name='l_hip',stiffness=[0,0,0],
            ...
            HAnimJoint(DEF='hanim_l_knee',center=(0.104,0.4867,0.0308),name='l_knee',stiffness=[0,0,0],
              children=[
              HAnimSegment(DEF='hanim_l_calf',name='l_calf'),
              HAnimJoint(DEF='hanim_l_talocrural',center=(0.1101,0.0656,-0.0736),name='l_talocrural',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_l_tarsometatarsal_2',center=(0.1086,0.0001,-0.0368),name='l_tarsometatarsal_2',stiffness=[0,0,0],
                  children=[
                  HAnimSegment(DEF='hanim_l_metatarsal_2',name='l_metatarsal_2'),
                  HAnimJoint(DEF='hanim_l_metatarsophalangeal_2',center=(0.1086,0.0001,0.0368),name='l_metatarsophalangeal_2',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_2',center=(0.1086,0,0.0762),name='l_tarsal_distal_interphalangeal_2',stiffness=[0,0,0],
                      children=[
          ...
          HAnimJoint(DEF='hanim_r_hip',center=(-0.0961,0.9124,-0.0001),name='r_hip',stiffness=[0,0,0],
            children=[
            ...
            HAnimJoint(DEF='hanim_r_knee',center=(-0.104,0.4867,0.0308),name='r_knee',stiffness=[0,0,0],
              children=[
              HAnimSegment(DEF='hanim_r_calf',name='r_calf'),
              HAnimJoint(DEF='hanim_r_talocrural',center=(-0.1101,0.0656,-0.0736),name='r_talocrural',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_tarsometatarsal_2',center=(-0.1086,0.0001,-0.0368),name='r_tarsometatarsal_2',stiffness=[0,0,0],
                  children=[
                  HAnimSegment(DEF='hanim_r_metatarsal_2',name='r_metatarsal_2'),
                  HAnimJoint(DEF='hanim_r_metatarsophalangeal_2',center=(-0.1086,0.0001,0.0368),name='r_metatarsophalangeal_2',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_2',center=(-0.1086,0,0.0762),name='r_tarsal_distal_interphalangeal_2',stiffness=[0,0,0],
                      children=[
        ...
        HAnimJoint(DEF='hanim_vl5',center=(0.0028,1.0568,-0.0776),name='vl5',stiffness=[0,0,0],
          ...
          HAnimJoint(DEF='hanim_vl4',center=(0.0035,1.0925,-0.0787),name='vl4',stiffness=[0,0,0],
            children=[
            HAnimSegment(DEF='hanim_l4',name='l4'),
            HAnimJoint(DEF='hanim_vl3',center=(0.0041,1.1276,-0.0796),name='vl3',stiffness=[0,0,0],
              children=[
              HAnimSegment(DEF='hanim_l3',name='l3'),
              HAnimJoint(DEF='hanim_vl2',center=(0.0045,1.1546,-0.08),name='vl2',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_vl1',center=(0.0048,1.1912,-0.0805),name='vl1',stiffness=[0,0,0],
                  children=[
                  HAnimSegment(DEF='hanim_l1',name='l1'),
                  HAnimJoint(DEF='hanim_vt12',center=(0.0051,1.2278,-0.0808),name='vt12',stiffness=[0,0,0],
                    children=[
                    HAnimSegment(DEF='hanim_t12',name='t12'),
                    HAnimJoint(DEF='hanim_vt11',center=(0.0053,1.2679,-0.081),name='vt11',stiffness=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_t11',name='t11'),
                      HAnimJoint(DEF='hanim_vt10',center=(0.0056,1.2848,-0.0822),name='vt10',stiffness=[0,0,0],
                        children=[
                        ...
                        HAnimJoint(DEF='hanim_vt9',center=(0.0057,1.3126,-0.0838),name='vt9',stiffness=[0,0,0],
                          children=[
                          ...
                          HAnimJoint(DEF='hanim_vt8',center=(0.0057,1.3382,-0.0845),name='vt8',stiffness=[0,0,0],
                            children=[
                            HAnimSegment(DEF='hanim_t8',name='t8'),
                            HAnimJoint(DEF='hanim_vt7',center=(0.0058,1.3625,-0.0833),name='vt7',stiffness=[0,0,0],
                              children=[
                              HAnimSegment(DEF='hanim_t7',name='t7'),
                              HAnimJoint(DEF='hanim_vt6',center=(0.0059,1.3866,-0.08),name='vt6',stiffness=[0,0,0],
                                children=[
                                HAnimSegment(DEF='hanim_t6',name='t6'),
                                HAnimJoint(DEF='hanim_vt5',center=(0.006,1.4102,-0.0745),name='vt5',stiffness=[0,0,0],
                                  children=[
                                  HAnimSegment(DEF='hanim_t5',name='t5'),
                                  HAnimJoint(DEF='hanim_vt4',center=(0.0061,1.432,-0.0675),name='vt4',stiffness=[0,0,0],
                                    children=[
                                    HAnimSegment(DEF='hanim_t4',name='t4'),
                                    HAnimJoint(DEF='hanim_vt3',center=(0.0062,1.4583,-0.057),name='vt3',stiffness=[0,0,0],
                                      children=[
                                      HAnimSegment(DEF='hanim_t3',name='t3'),
                                      HAnimJoint(DEF='hanim_vt2',center=(0.0063,1.4761,-0.0484),name='vt2',stiffness=[0,0,0],
                                        children=[
                                        HAnimSegment(DEF='hanim_t2',name='t2'),
                                        HAnimJoint(DEF='hanim_vt1',center=(0.0065,1.4951,-0.0387),name='vt1',stiffness=[0,0,0],
                                          children=[
                                          ...
                                          HAnimJoint(DEF='hanim_vc7',center=(0.0066,1.5132,-0.0301),name='vc7',stiffness=[0,0,0],
                                            children=[
                                            ...
                                            HAnimJoint(DEF='hanim_vc6',center=(0.0066,1.5357,-0.0143),name='vc6',stiffness=[0,0,0],
                                              children=[
                                              HAnimSegment(DEF='hanim_c6',name='c6'),
                                              HAnimJoint(DEF='hanim_vc5',center=(0.0066,1.552,-0.0082),name='vc5',stiffness=[0,0,0],
                                                children=[
                                                HAnimSegment(DEF='hanim_c5',name='c5'),
                                                HAnimJoint(DEF='hanim_vc4',center=(0.0066,1.5662,-0.0084),name='vc4',stiffness=[0,0,0],
                                                  children=[
                                                  HAnimSegment(DEF='hanim_c4',name='c4'),
                                                  HAnimJoint(DEF='hanim_vc3',center=(0.0066,1.58,-0.0103),name='vc3',stiffness=[0,0,0],
                                                    children=[
                                                    HAnimSegment(DEF='hanim_c3',name='c3'),
                                                    HAnimJoint(DEF='hanim_vc2',center=(0.0066,1.5928,-0.0103),name='vc2',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_c2',name='c2'),
                                                      HAnimJoint(DEF='hanim_vc1',center=(0.0066,1.6144,-0.0034),name='vc1',stiffness=[0,0,0],
                                                        children=[
                                                        ...
                                                        HAnimJoint(DEF='hanim_skullbase',center=(0.0044,1.6209,0.0236),name='skullbase',stiffness=[0,0,0],
                                                          ...
                                                          HAnimJoint(DEF='hanim_l_eyeball_joint',center=(0.0336,1.6332,0.0502),name='l_eyeball_joint',stiffness=[0,0,0],
                                                            children=[
                                                          ...
                                                          HAnimJoint(DEF='hanim_l_eyelid_joint',center=(0.0336,1.6332,0.0502),name='l_eyelid_joint',stiffness=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_l_eyelid',name='l_eyelid')]),
                                                          HAnimJoint(DEF='hanim_l_eyebrow_joint',center=(0.0336,1.635,0.0506),name='l_eyebrow_joint',stiffness=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_l_eyebrow',name='l_eyebrow')]),
                                                          HAnimJoint(DEF='hanim_r_eyeball_joint',center=(-0.0336,1.6332,0.0502),name='r_eyeball_joint',stiffness=[0,0,0],
                                                            children=[
                                                          ...
                                                          HAnimJoint(DEF='hanim_r_eyelid_joint',center=(-0.0336,1.6332,0.0502),name='r_eyelid_joint',stiffness=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_r_eyelid',name='r_eyelid')]),
                                                          HAnimJoint(DEF='hanim_r_eyebrow_joint',center=(-0.0336,1.635,0.0506),name='r_eyebrow_joint',stiffness=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_r_eyebrow',name='r_eyebrow')]),
                                                          HAnimJoint(DEF='hanim_temporomandibular',center=(0.0,1.63,0.015),name='temporomandibular',stiffness=[0,0,0],
                                          ...
                                          HAnimJoint(DEF='hanim_l_sternoclavicular',center=(0.082,1.4488,-0.0353),name='l_sternoclavicular',stiffness=[0,0,0],
                                            children=[
                                            ...
                                            HAnimJoint(DEF='hanim_l_acromioclavicular',center=(0.0962,1.4269,-0.0424),name='l_acromioclavicular',stiffness=[0,0,0],
                                              children=[
                                              ...
                                              HAnimJoint(DEF='hanim_l_shoulder',center=(0.2029,1.4376,-0.0387),name='l_shoulder',stiffness=[0,0,0],
                                                ...
                                                HAnimJoint(DEF='hanim_l_elbow',center=(0.2014,1.1357,-0.0682),name='l_elbow',stiffness=[0,0,0],
                                                  ...
                                                  HAnimJoint(DEF='hanim_l_radiocarpal',center=(0.1984,0.8663,-0.0583),name='l_radiocarpal',stiffness=[0,0,0],
                                                    children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_l_carpometacarpal_1',center=(0.1924,0.8472,-0.0534),name='l_carpometacarpal_1',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_l_metacarpal_1',name='l_metacarpal_1'),
                                                      HAnimJoint(DEF='hanim_l_metacarpophalangeal_1',center=(0.1951,0.8226,0.0246),name='l_metacarpophalangeal_1',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_1',name='l_carpal_proximal_phalanx_1'),
                                                        HAnimJoint(DEF='hanim_l_carpal_interphalangeal_1',center=(0.1955,0.8159,0.0464),name='l_carpal_interphalangeal_1',stiffness=[0,0,0],
                                                          children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_l_carpometacarpal_2',center=(0.1983,0.8024,-0.028),name='l_carpometacarpal_2',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_l_metacarpal_2',name='l_metacarpal_2'),
                                                      HAnimJoint(DEF='hanim_l_metacarpophalangeal_2',center=(0.1983,0.7815,-0.028),name='l_metacarpophalangeal_2',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_2',name='l_carpal_proximal_phalanx_2'),
                                                        HAnimJoint(DEF='hanim_l_carpal_proximal_interphalangeal_2',center=(0.2017,0.7363,-0.0248),name='l_carpal_proximal_interphalangeal_2',stiffness=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_l_carpal_middle_phalanx_2',name='l_carpal_middle_phalanx_2'),
                                                          HAnimJoint(DEF='hanim_l_carpal_distal_interphalangeal_2',center=(0.2028,0.7139,-0.0236),name='l_carpal_distal_interphalangeal_2',stiffness=[0,0,0],
                                                            children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_l_carpometacarpal_3',center=(0.1987,0.8029,-0.053),name='l_carpometacarpal_3',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_l_metacarpal_3',name='l_metacarpal_3'),
                                                      HAnimJoint(DEF='hanim_l_metacarpophalangeal_3',center=(0.1987,0.7818,-0.053),name='l_metacarpophalangeal_3',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_3',name='l_carpal_proximal_phalanx_3'),
                                                        HAnimJoint(DEF='hanim_l_carpal_proximal_interphalangeal_3',center=(0.2013,0.7273,-0.0503),name='l_carpal_proximal_interphalangeal_3',stiffness=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_l_carpal_middle_phalanx_3',name='l_carpal_middle_phalanx_3'),
                                                          HAnimJoint(DEF='hanim_l_carpal_distal_interphalangeal_3',center=(0.2026,0.7011,-0.0494),name='l_carpal_distal_interphalangeal_3',stiffness=[0,0,0],
                                                            children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_l_carpometacarpal_4',center=(0.1956,0.8019,-0.0794),name='l_carpometacarpal_4',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_l_metacarpal_4',name='l_metacarpal_4'),
                                                      HAnimJoint(DEF='hanim_l_metacarpophalangeal_4',center=(0.1956,0.7815,-0.0794),name='l_metacarpophalangeal_4',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_4',name='l_carpal_proximal_phalanx_4'),
                                                        HAnimJoint(DEF='hanim_l_carpal_proximal_interphalangeal_4',center=(0.1973,0.7287,-0.0777),name='l_carpal_proximal_interphalangeal_4',stiffness=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_l_carpal_middle_phalanx_4',name='l_carpal_middle_phalanx_4'),
                                                          HAnimJoint(DEF='hanim_l_carpal_distal_interphalangeal_4',center=(0.1983,0.7045,-0.0767),name='l_carpal_distal_interphalangeal_4',stiffness=[0,0,0],
                                                            children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_l_carpometacarpal_5',center=(0.1925,0.8066,-0.1036),name='l_carpometacarpal_5',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_l_metacarpal_5',name='l_metacarpal_5'),
                                                      HAnimJoint(DEF='hanim_l_metacarpophalangeal_5',center=(0.1925,0.7866,-0.1036),name='l_metacarpophalangeal_5',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_5',name='l_carpal_proximal_phalanx_5'),
                                                        HAnimJoint(DEF='hanim_l_carpal_proximal_interphalangeal_5',center=(0.1938,0.7452,-0.1024),name='l_carpal_proximal_interphalangeal_5',stiffness=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_l_carpal_middle_phalanx_5',name='l_carpal_middle_phalanx_5'),
                                                          HAnimJoint(DEF='hanim_l_carpal_distal_interphalangeal_5',center=(0.1948,0.7277,-0.1017),name='l_carpal_distal_interphalangeal_5',stiffness=[0,0,0],
                                                            children=[
                                          ...
                                          HAnimJoint(DEF='hanim_r_sternoclavicular',center=(-0.082,1.4488,-0.0353),name='r_sternoclavicular',stiffness=[0,0,0],
                                            children=[
                                            ...
                                            HAnimJoint(DEF='hanim_r_acromioclavicular',center=(-0.0962,1.4269,-0.0424),name='r_acromioclavicular',stiffness=[0,0,0],
                                              children=[
                                              HAnimSegment(DEF='hanim_r_scapula',name='r_scapula'),
                                              HAnimJoint(DEF='hanim_r_shoulder',center=(-0.2029,1.4376,-0.0387),name='r_shoulder',stiffness=[0,0,0],
                                                children=[
                                                ...
                                                HAnimJoint(DEF='hanim_r_elbow',center=(-0.2014,1.1357,-0.0682),name='r_elbow',stiffness=[0,0,0],
                                                  children=[
                                                  ...
                                                  HAnimJoint(DEF='hanim_r_radiocarpal',center=(-0.1984,0.8663,-0.0583),name='r_radiocarpal',stiffness=[0,0,0],
                                                    children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_r_carpometacarpal_1',center=(-0.1924,0.8472,-0.0534),name='r_carpometacarpal_1',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_r_metacarpal_1',name='r_metacarpal_1'),
                                                      HAnimJoint(DEF='hanim_r_metacarpophalangeal_1',center=(-0.1951,0.8226,0.0246),name='r_metacarpophalangeal_1',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_1',name='r_carpal_proximal_phalanx_1'),
                                                        HAnimJoint(DEF='hanim_r_carpal_interphalangeal_1',center=(-0.1955,0.8159,0.0464),name='r_carpal_interphalangeal_1',stiffness=[0,0,0],
                                                          children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_r_carpometacarpal_2',center=(-0.1983,0.8024,-0.028),name='r_carpometacarpal_2',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_r_metacarpal_2',name='r_metacarpal_2'),
                                                      HAnimJoint(DEF='hanim_r_metacarpophalangeal_2',center=(-0.1983,0.7815,-0.028),name='r_metacarpophalangeal_2',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_2',name='r_carpal_proximal_phalanx_2'),
                                                        HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_2',center=(-0.2017,0.7363,-0.0248),name='r_carpal_proximal_interphalangeal_2',stiffness=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_r_carpal_middle_phalanx_2',name='r_carpal_middle_phalanx_2'),
                                                          HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_2',center=(-0.2028,0.7139,-0.0236),name='r_carpal_distal_interphalangeal_2',stiffness=[0,0,0],
                                                            children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_r_carpometacarpal_3',center=(-0.1987,0.8029,-0.053),name='r_carpometacarpal_3',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_r_metacarpal_3',name='r_metacarpal_3'),
                                                      HAnimJoint(DEF='hanim_r_metacarpophalangeal_3',center=(-0.1987,0.7818,-0.053),name='r_metacarpophalangeal_3',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_3',name='r_carpal_proximal_phalanx_3'),
                                                        HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_3',center=(-0.2013,0.7273,-0.0503),name='r_carpal_proximal_interphalangeal_3',stiffness=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_r_carpal_middle_phalanx_3',name='r_carpal_middle_phalanx_3'),
                                                          HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_3',center=(-0.2026,0.7011,-0.0494),name='r_carpal_distal_interphalangeal_3',stiffness=[0,0,0],
                                                            children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_r_carpometacarpal_4',center=(-0.1956,0.8019,-0.0794),name='r_carpometacarpal_4',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_r_metacarpal_4',name='r_metacarpal_4'),
                                                      HAnimJoint(DEF='hanim_r_metacarpophalangeal_4',center=(-0.1956,0.7815,-0.0794),name='r_metacarpophalangeal_4',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_4',name='r_carpal_proximal_phalanx_4'),
                                                        HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_4',center=(-0.1973,0.7287,-0.0777),name='r_carpal_proximal_interphalangeal_4',stiffness=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_r_carpal_middle_phalanx_4',name='r_carpal_middle_phalanx_4'),
                                                          HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_4',center=(-0.1983,0.7045,-0.0767),name='r_carpal_distal_interphalangeal_4',stiffness=[0,0,0],
                                                            children=[
                                                    ...
                                                    HAnimJoint(DEF='hanim_r_carpometacarpal_5',center=(-0.1925,0.8066,-0.1036),name='r_carpometacarpal_5',stiffness=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_r_metacarpal_5',name='r_metacarpal_5'),
                                                      HAnimJoint(DEF='hanim_r_metacarpophalangeal_5',center=(-0.1925,0.7866,-0.1036),name='r_metacarpophalangeal_5',stiffness=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_5',name='r_carpal_proximal_phalanx_5'),
                                                        HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_5',center=(-0.1938,0.7452,-0.1024),name='r_carpal_proximal_interphalangeal_5',stiffness=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_r_carpal_middle_phalanx_5',name='r_carpal_middle_phalanx_5'),
                                                          HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_5',center=(-0.1948,0.7277,-0.1017),name='r_carpal_distal_interphalangeal_5',stiffness=[0,0,0],
                                                            children=[
      ...
      HAnimJoint(USE='hanim_vl4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vl3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vl2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vl1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt12',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt11',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt10',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt9',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt8',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt7',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt6',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vt1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vc7',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vc6',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vc5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vc4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vc3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vc2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_vc1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_skullbase',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_temporomandibular',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_acromioclavicular',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_acromioclavicular',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpal_distal_interphalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpal_distal_interphalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpal_distal_interphalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpal_distal_interphalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpal_distal_interphalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpal_distal_interphalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpal_distal_interphalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpal_distal_interphalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpal_interphalangeal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpal_interphalangeal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpal_proximal_interphalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpal_proximal_interphalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpal_proximal_interphalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpal_proximal_interphalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpal_proximal_interphalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpal_proximal_interphalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpal_proximal_interphalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpal_proximal_interphalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpometacarpal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpometacarpal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpometacarpal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpometacarpal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpometacarpal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpometacarpal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpometacarpal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpometacarpal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_carpometacarpal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_carpometacarpal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_elbow',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_elbow',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_eyeball_joint',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_eyeball_joint',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_eyebrow_joint',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_eyebrow_joint',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_eyelid_joint',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_eyelid_joint',stiffness=[0,0,0]),
      ...
      HAnimJoint(USE='hanim_l_metacarpophalangeal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metacarpophalangeal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metacarpophalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metacarpophalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metacarpophalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metacarpophalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metacarpophalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metacarpophalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metacarpophalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metacarpophalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metatarsophalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metatarsophalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_radiocarpal',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_radiocarpal',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_shoulder',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_shoulder',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_sternoclavicular',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_sternoclavicular',stiffness=[0,0,0]),

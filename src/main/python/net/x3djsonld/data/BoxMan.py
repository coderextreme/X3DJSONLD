...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='A Seamless VRML Human, demonstrating the H-Anim 2001 Specification, animation scripting via an external prototype (ExternProtoDeclare).',name='description'),
    ...
    meta(content='Skin mesh is split across multiple shapes within a Group, should that be allowed?',name='warning'),
    meta(content='What does the original animation script accomplish? It is not hooked up, script source contains errors...',name='TODO'),
    ...
    meta(content='BoxManViewInclined.png',name='Image'),
    meta(content='BoxManViewFront.png',name='Image'),
    meta(content='BoxManViewRight.png',name='Image'),
    meta(content='BoxManViewLeft.png',name='Image'),
    meta(content='BoxManViewTop.png',name='Image'),
    meta(content='BoxManAnimationPanel.x3d',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/HumanoidAnimation/CharactersLegacy/BoxMan.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    #  Animation ROUTEs 
    ROUTE(fromField='HumanoidRoot_translation_changed',fromNode='ANIMATOR',toField='set_translation',toNode='boxman_HumanoidRoot'),
    ROUTE(fromField='HumanoidRoot_rotation_changed',fromNode='ANIMATOR',toField='set_rotation',toNode='boxman_HumanoidRoot'),
    ...
    Script(DEF='ENGINE',directOutput=True,url=["BoxMan.js","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/CharactersLegacy/BoxMan.js"],
      field=[

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/BoxMan.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Script(DEF='ENGINE',directOutput=True,url=["BoxMan.js","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/BoxMan.js"],
      field=[

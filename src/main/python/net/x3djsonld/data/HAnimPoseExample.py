...
newModel=X3D(profile='Full',version='4.1',
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(info=["humanoidVersion=2.0"],name='HumanoidStub',version='2.0',
      children=[
      HAnimPose(USE='A_Pose',loa=-1,transitionDuration=0),
      HAnimPose(USE='T_Pose',loa=-1,transitionDuration=0),
      HAnimPose(USE='I_Pose',loa=-1,transitionDuration=0),
      HAnimPose(USE='H_Pose',loa=-1,transitionDuration=0),
      HAnimPose(USE='FaceLeft_Pose',loa=-1,transitionDuration=0),
      HAnimPose(USE='FaceRight_Pose',loa=-1,transitionDuration=0),
      HAnimPose(USE='TouchDown_Pose',loa=-1,transitionDuration=0)],)])
)

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(name='identifier',content='https://www.web3d.org/x3d/content/examples/HumanoidAnimation/JohnBoy.x3d'),
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='STD_HAnim',info=["humanoidVersion=2.0"],name='HAnim',version='2.0',
              ...
              HAnimJoint(DEF='STD_Joint_l_talocrural',name='l_talocrural',center=(0.1101,0.0656,-0.0736),
                ...
                HAnimSegment(DEF='STD_Segment_l_talus',name='l_talus',
                  ...
                  HAnimSite(DEF='STD_Site_l_calcaneus_posterior_pt',name='l_calcaneus_posterior_pt',translation=(0.0974,0.0259,-0.1171),
                    ...
                    Shape(USE='HAnimSiteShape')])]),
                HAnimJoint(DEF='STD_Joint_l_talocalcaneonavicular',name='l_talocalcaneonavicular',
                  children=[
                  HAnimSegment(DEF='STD_Segment_l_navicular',name='l_navicular'),
                  HAnimJoint(DEF='STD_Joint_l_cuneonavicular_1',name='l_cuneonavicular_1',
                    children=[
                    HAnimSegment(DEF='STD_Segment_l_cuneiform_1',name='l_cuneiform_1'),
                    HAnimJoint(DEF='STD_Joint_l_tarsometatarsal_1',name='l_tarsometatarsal_1',
                      children=[
                      HAnimSegment(DEF='STD_Segment_l_metatarsal_1',name='l_metatarsal_1'),
                      HAnimJoint(DEF='STD_Joint_l_metatarsophalangeal_1',name='l_metatarsophalangeal_1',
                        children=[
                        HAnimSegment(DEF='STD_Segment_l_tarsal_proximal_phalanx_1',name='l_tarsal_proximal_phalanx_1',
                          ...
                          HAnimSite(DEF='STD_Site_l_metatarsal_phalanx_1_pt',name='l_metatarsal_phalanx_1_pt',
                            ...
                            Shape(USE='HAnimSiteShape')])]),
                        HAnimJoint(DEF='STD_Joint_l_tarsal_interphalangeal_1',name='l_tarsal_interphalangeal_1',
                          children=[
                          HAnimSegment(DEF='STD_Segment_l_tarsal_distal_phalanx_1',name='l_tarsal_distal_phalanx_1',
                            ...
                            HAnimSite(DEF='STD_Site_l_tarsal_distal_phalanx_1_tip',name='l_tarsal_distal_phalanx_1_tip',
                              ...
                              Shape(USE='HAnimSiteShape')])])])])])]),
                  HAnimJoint(DEF='STD_Joint_l_cuneonavicular_2',name='l_cuneonavicular_2',
                    children=[
                    HAnimSegment(DEF='STD_Segment_l_cuneiform_2',name='l_cuneiform_2'),
                    HAnimJoint(DEF='STD_Joint_l_tarsometatarsal_2',name='l_tarsometatarsal_2',
                      children=[
                      ...
                      HAnimJoint(DEF='STD_Joint_l_metatarsophalangeal_2',name='l_metatarsophalangeal_2',
                        ...
                        HAnimJoint(DEF='STD_Joint_l_tarsal_proximal_interphalangeal_2',name='l_tarsal_proximal_interphalangeal_2',
                          children=[
                          HAnimSegment(DEF='STD_Segment_l_tarsal_middle_phalanx_2',name='l_tarsal_middle_phalanx_2'),
                          HAnimJoint(DEF='STD_Joint_l_tarsal_distal_interphalangeal_2',name='l_tarsal_distal_interphalangeal_2',
                            children=[
                            HAnimSegment(DEF='STD_Segment_l_tarsal_distal_phalanx_2',name='l_tarsal_distal_phalanx_2',
                              ...
                              HAnimSite(DEF='STD_Site_l_tarsal_distal_phalanx_2_tip',name='l_tarsal_distal_phalanx_2_tip',translation=(0.1195,0.0079,0.1433),
                                ...
                                Shape(USE='HAnimSiteShape')])])])])])])]),
                  HAnimJoint(DEF='STD_Joint_l_cuneonavicular_3',name='l_cuneonavicular_3',
                    children=[
                    HAnimSegment(DEF='STD_Segment_l_cuneiform_3',name='l_cuneiform_3'),
                    HAnimJoint(DEF='STD_Joint_l_tarsometatarsal_3',name='l_tarsometatarsal_3',
                      children=[
                      HAnimSegment(DEF='STD_Segment_l_metatarsal_3',name='l_metatarsal_3'),
                      HAnimJoint(DEF='STD_Joint_l_metatarsophalangeal_3',name='l_metatarsophalangeal_3',
                        children=[
                        HAnimSegment(DEF='STD_Segment_l_tarsal_proximal_phalanx_3',name='l_tarsal_proximal_phalanx_3'),
                        HAnimJoint(DEF='STD_Joint_l_tarsal_proximal_interphalangeal_3',name='l_tarsal_proximal_interphalangeal_3',
                          children=[
                          HAnimSegment(DEF='STD_Segment_l_tarsal_middle_phalanx_3',name='l_tarsal_middle_phalanx_3'),
                          HAnimJoint(DEF='STD_Joint_l_tarsal_distal_interphalangeal_3',name='l_tarsal_distal_interphalangeal_3',
                            children=[
                            HAnimSegment(DEF='STD_Segment_l_tarsal_distal_phalanx_3',name='l_tarsal_distal_phalanx_3',
                              ...
                              HAnimSite(DEF='STD_Site_l_tarsal_distal_phalanx_3_tip',name='l_tarsal_distal_phalanx_3_tip',
                                ...
                                Shape(USE='HAnimSiteShape')])])])])])])])]),
                HAnimJoint(DEF='STD_Joint_l_calcaneocuboid',name='l_calcaneocuboid',
                  children=[
                  HAnimSegment(DEF='STD_Segment_l_calcaneus',name='l_calcaneus'),
                  HAnimJoint(DEF='STD_Joint_l_transversetarsal',name='l_transversetarsal',
                    children=[
                    HAnimSegment(DEF='STD_Segment_l_cuboid',name='l_cuboid'),
                    HAnimJoint(DEF='STD_Joint_l_tarsometatarsal_4',name='l_tarsometatarsal_4',
                      children=[
                      HAnimSegment(DEF='STD_Segment_l_metatarsal_4',name='l_metatarsal_4'),
                      HAnimJoint(DEF='STD_Joint_l_metatarsophalangeal_4',name='l_metatarsophalangeal_4',
                        children=[
                        HAnimSegment(DEF='STD_Segment_l_tarsal_proximal_phalanx_4',name='l_tarsal_proximal_phalanx_4'),
                        HAnimJoint(DEF='STD_Joint_l_tarsal_proximal_interphalangeal_4',name='l_tarsal_proximal_interphalangeal_4',
                          children=[
                          HAnimSegment(DEF='STD_Segment_l_tarsal_middle_phalanx_4',name='l_tarsal_middle_phalanx_4'),
                          HAnimJoint(DEF='STD_Joint_l_tarsal_distal_interphalangeal_4',name='l_tarsal_distal_interphalangeal_4',
                            children=[
                            HAnimSegment(DEF='STD_Segment_l_tarsal_distal_phalanx_4',name='l_tarsal_distal_phalanx_4',
                              ...
                              HAnimSite(DEF='STD_Site_l_tarsal_distal_phalanx_4_tip',name='l_tarsal_distal_phalanx_4_tip',
                                ...
                                Shape(USE='HAnimSiteShape')])])])])])]),
                    HAnimJoint(DEF='STD_Joint_l_tarsometatarsal_5',name='l_tarsometatarsal_5',
                      children=[
                      HAnimSegment(DEF='STD_Segment_l_metatarsal_5',name='l_metatarsal_5'),
                      HAnimJoint(DEF='STD_Joint_l_metatarsophalangeal_5',name='l_metatarsophalangeal_5',
                        children=[
                        HAnimSegment(DEF='STD_Segment_l_tarsal_proximal_phalanx_5',name='l_tarsal_proximal_phalanx_5',
                          ...
                          HAnimSite(DEF='STD_Site_l_metatarsal_phalanx_5_pt',name='l_metatarsal_phalanx_5_pt',
                            ...
                            Shape(USE='HAnimSiteShape')])]),
                        HAnimJoint(DEF='STD_Joint_l_tarsal_proximal_interphalangeal_5',name='l_tarsal_proximal_interphalangeal_5',
                          children=[
                          HAnimSegment(DEF='STD_Segment_l_tarsal_middle_phalanx_5',name='l_tarsal_middle_phalanx_5'),
                          HAnimJoint(DEF='STD_Joint_l_tarsal_distal_interphalangeal_5',name='l_tarsal_distal_interphalangeal_5',
                            children=[
              ...
              HAnimJoint(DEF='STD_Joint_r_talocrural',name='r_talocrural',center=(-0.0801,0.0712,-0.0766),
                ...
                HAnimSegment(DEF='STD_Segment_r_talus',name='r_talus',
                  ...
                  HAnimSite(DEF='STD_Site_r_calcaneus_posterior_pt',name='r_calcaneus_posterior_pt',translation=(-0.0692,0.0297,-0.1221),
                    ...
                    Shape(USE='HAnimSiteShape')])]),
                HAnimJoint(DEF='STD_Joint_r_talocalcaneonavicular',name='r_talocalcaneonavicular',
                  children=[
                  HAnimSegment(DEF='STD_Segment_r_navicular',name='r_navicular'),
                  HAnimJoint(DEF='STD_Joint_r_cuneonavicular_1',name='r_cuneonavicular_1',
                    children=[
                    HAnimSegment(DEF='STD_Segment_r_cuneiform_1',name='r_cuneiform_1'),
                    HAnimJoint(DEF='STD_Joint_r_tarsometatarsal_1',name='r_tarsometatarsal_1',
                      children=[
                      HAnimSegment(DEF='STD_Segment_r_metatarsal_1',name='r_metatarsal_1'),
                      HAnimJoint(DEF='STD_Joint_r_metatarsophalangeal_1',name='r_metatarsophalangeal_1',
                        children=[
                        HAnimSegment(DEF='STD_Segment_r_tarsal_proximal_phalanx_1',name='r_tarsal_proximal_phalanx_1',
                          ...
                          HAnimSite(DEF='STD_Site_r_metatarsal_phalanx_1_pt',name='r_metatarsal_phalanx_1_pt',
                            ...
                            Shape(USE='HAnimSiteShape')])]),
                        HAnimJoint(DEF='STD_Joint_r_tarsal_interphalangeal_1',name='r_tarsal_interphalangeal_1',
                          children=[
                          HAnimSegment(DEF='STD_Segment_r_tarsal_distal_phalanx_1',name='r_tarsal_distal_phalanx_1',
                            ...
                            HAnimSite(DEF='STD_Site_r_tarsal_distal_phalanx_1_tip',name='r_tarsal_distal_phalanx_1_tip',
                              ...
                              Shape(USE='HAnimSiteShape')])])])])])]),
                  HAnimJoint(DEF='STD_Joint_r_cuneonavicular_2',name='r_cuneonavicular_2',
                    children=[
                    HAnimSegment(DEF='STD_Segment_r_cuneiform_2',name='r_cuneiform_2'),
                    HAnimJoint(DEF='STD_Joint_r_tarsometatarsal_2',name='r_tarsometatarsal_2',
                      children=[
                      ...
                      HAnimJoint(DEF='STD_Joint_r_metatarsophalangeal_2',name='r_metatarsophalangeal_2',
                        ...
                        HAnimJoint(DEF='STD_Joint_r_tarsal_proximal_interphalangeal_2',name='r_tarsal_proximal_interphalangeal_2',
                          children=[
                          HAnimSegment(DEF='STD_Segment_r_tarsal_middle_phalanx_2',name='r_tarsal_middle_phalanx_2'),
                          HAnimJoint(DEF='STD_Joint_r_tarsal_distal_interphalangeal_2',name='r_tarsal_distal_interphalangeal_2',
                            children=[
                            HAnimSegment(DEF='STD_Segment_r_tarsal_distal_phalanx_2',name='r_tarsal_distal_phalanx_2',
                              ...
                              HAnimSite(DEF='STD_Site_r_tarsal_distal_phalanx_2_tip',name='r_tarsal_distal_phalanx_2_tip',translation=(-0.0883,0.0134,0.1383),
                                ...
                                Shape(USE='HAnimSiteShape')])])])])])])]),
                  HAnimJoint(DEF='STD_Joint_r_cuneonavicular_3',name='r_cuneonavicular_3',
                    children=[
                    HAnimSegment(DEF='STD_Segment_r_cuneiform_3',name='r_cuneiform_3'),
                    HAnimJoint(DEF='STD_Joint_r_tarsometatarsal_3',name='r_tarsometatarsal_3',
                      children=[
                      HAnimSegment(DEF='STD_Segment_r_metatarsal_3',name='r_metatarsal_3'),
                      HAnimJoint(DEF='STD_Joint_r_metatarsophalangeal_3',name='r_metatarsophalangeal_3',
                        children=[
                        HAnimSegment(DEF='STD_Segment_r_tarsal_proximal_phalanx_3',name='r_tarsal_proximal_phalanx_3'),
                        HAnimJoint(DEF='STD_Joint_r_tarsal_proximal_interphalangeal_3',name='r_tarsal_proximal_interphalangeal_3',
                          children=[
                          HAnimSegment(DEF='STD_Segment_r_tarsal_middle_phalanx_3',name='r_tarsal_middle_phalanx_3'),
                          HAnimJoint(DEF='STD_Joint_r_tarsal_distal_interphalangeal_3',name='r_tarsal_distal_interphalangeal_3',
                            children=[
                            HAnimSegment(DEF='STD_Segment_r_tarsal_distal_phalanx_3',name='r_tarsal_distal_phalanx_3',
                              ...
                              HAnimSite(DEF='STD_Site_r_tarsal_distal_phalanx_3_tip',name='r_tarsal_distal_phalanx_3_tip',
                                ...
                                Shape(USE='HAnimSiteShape')])])])])])])])]),
                HAnimJoint(DEF='STD_Joint_r_calcaneocuboid',name='r_calcaneocuboid',
                  children=[
                  HAnimSegment(DEF='STD_Segment_r_calcaneus',name='r_calcaneus'),
                  HAnimJoint(DEF='STD_Joint_r_transversetarsal',name='r_transversetarsal',
                    children=[
                    HAnimSegment(DEF='STD_Segment_r_cuboid',name='r_cuboid'),
                    HAnimJoint(DEF='STD_Joint_r_tarsometatarsal_4',name='r_tarsometatarsal_4',
                      children=[
                      HAnimSegment(DEF='STD_Segment_r_metatarsal_4',name='r_metatarsal_4'),
                      HAnimJoint(DEF='STD_Joint_r_metatarsophalangeal_4',name='r_metatarsophalangeal_4',
                        children=[
                        HAnimSegment(DEF='STD_Segment_r_tarsal_proximal_phalanx_4',name='r_tarsal_proximal_phalanx_4'),
                        HAnimJoint(DEF='STD_Joint_r_tarsal_proximal_interphalangeal_4',name='r_tarsal_proximal_interphalangeal_4',
                          children=[
                          HAnimSegment(DEF='STD_Segment_r_tarsal_middle_phalanx_4',name='r_tarsal_middle_phalanx_4'),
                          HAnimJoint(DEF='STD_Joint_r_tarsal_distal_interphalangeal_4',name='r_tarsal_distal_interphalangeal_4',
                            children=[
                            HAnimSegment(DEF='STD_Segment_r_tarsal_distal_phalanx_4',name='r_tarsal_distal_phalanx_4',
                              ...
                              HAnimSite(DEF='STD_Site_r_tarsal_distal_phalanx_4_tip',name='r_tarsal_distal_phalanx_4_tip',
                                ...
                                Shape(USE='HAnimSiteShape')])])])])])]),
                    HAnimJoint(DEF='STD_Joint_r_tarsometatarsal_5',name='r_tarsometatarsal_5',
                      children=[
                      HAnimSegment(DEF='STD_Segment_r_metatarsal_5',name='r_metatarsal_5'),
                      HAnimJoint(DEF='STD_Joint_r_metatarsophalangeal_5',name='r_metatarsophalangeal_5',
                        children=[
                        HAnimSegment(DEF='STD_Segment_r_tarsal_proximal_phalanx_5',name='r_tarsal_proximal_phalanx_5',
                          ...
                          HAnimSite(DEF='STD_Site_r_metatarsal_phalanx_5_pt',name='r_metatarsal_phalanx_5_pt',
                            ...
                            Shape(USE='HAnimSiteShape')])]),
                        HAnimJoint(DEF='STD_Joint_r_tarsal_proximal_interphalangeal_5',name='r_tarsal_proximal_interphalangeal_5',
                          children=[
                          HAnimSegment(DEF='STD_Segment_r_tarsal_middle_phalanx_5',name='r_tarsal_middle_phalanx_5'),
                          HAnimJoint(DEF='STD_Joint_r_tarsal_distal_interphalangeal_5',name='r_tarsal_distal_interphalangeal_5',
                            children=[
        ...
        HAnimJoint(DEF='STD_Joint_vl5',name='vl5',center=(0.0028,1.0568,-0.0776),
          ...
          HAnimSegment(DEF='STD_Segment_l5',name='l5',
            ...
            HAnimSite(DEF='STD_Site_navel_pt',name='navel_pt',translation=(0.0069,1.0966,0.1017),
              ...
              Shape(USE='HAnimSiteShape')])]),
          HAnimJoint(DEF='STD_Joint_vl4',name='vl4',center=(0.0035,1.0925,-0.0787),
            children=[
            HAnimSegment(DEF='STD_Segment_l4',name='l4'),
            HAnimJoint(DEF='STD_Joint_vl3',name='vl3',center=(0.0041,1.1276,-0.0796),
              children=[
              HAnimSegment(DEF='STD_Segment_l3',name='l3'),
              HAnimJoint(DEF='STD_Joint_vl2',name='vl2',center=(0.0045,1.1546,-0.0800),
                children=[
                HAnimSegment(DEF='STD_Segment_l2',name='l2',
                  ...
                  HAnimSite(DEF='STD_Site_l_rib10_pt',name='l_rib10_pt',translation=(0.0871,1.1925,0.0992),
                    ...
                    Shape(USE='HAnimSiteShape')])]),
                HAnimJoint(DEF='STD_Joint_vl1',name='vl1',center=(0.0048,1.1912,-0.0805),
                  children=[
                  HAnimSegment(DEF='STD_Segment_l1',name='l1'),
                  HAnimJoint(DEF='STD_Joint_vt12',name='vt12',center=(0.0051,1.2278,-0.0808),
                    children=[
                    HAnimSegment(DEF='STD_Segment_t12',name='t12'),
                    HAnimJoint(DEF='STD_Joint_vt11',name='vt11',center=(0.0053,1.2679,-0.0810),
                      children=[
                      HAnimSegment(DEF='STD_Segment_t11',name='t11'),
                      HAnimJoint(DEF='STD_Joint_vt10',name='vt10',center=(0.0056,1.2848,-0.0822),
                        children=[
                        HAnimSegment(DEF='STD_Segment_t10',name='t10',
                          ...
                          HAnimSite(DEF='STD_Site_substernale_pt',name='substernale_pt',translation=(0.0085,1.2995,0.1147),
                            ...
                            Shape(USE='HAnimSiteShape')])]),
                        HAnimJoint(DEF='STD_Joint_vt9',name='vt9',center=(0.0057,1.3126,-0.0838),
                          children=[
                          HAnimSegment(DEF='STD_Segment_t9',name='t9',
                            ...
                            HAnimSite(DEF='STD_Site_l_thelion_pt',name='l_thelion_pt',translation=(0.0918,1.3382,0.1192),
                              ...
                              Shape(USE='HAnimSiteShape')])]),
                          HAnimJoint(DEF='STD_Joint_vt8',name='vt8',center=(0.0057,1.3382,-0.0845),
                            children=[
                            HAnimSegment(DEF='STD_Segment_t8',name='t8'),
                            HAnimJoint(DEF='STD_Joint_vt7',name='vt7',center=(0.0058,1.3625,-0.0833),
                              children=[
                              HAnimSegment(DEF='STD_Segment_t7',name='t7'),
                              HAnimJoint(DEF='STD_Joint_vt6',name='vt6',center=(0.0059,1.3866,-0.0800),
                                children=[
                                HAnimSegment(DEF='STD_Segment_t6',name='t6',
                                  ...
                                  HAnimSite(DEF='STD_Site_mesosternale_pt',name='mesosternale_pt',
                                    ...
                                    Shape(USE='HAnimSiteShape')])]),
                                HAnimJoint(DEF='STD_Joint_vt5',name='vt5',center=(0.0060,1.4102,-0.0745),
                                  children=[
                                  HAnimSegment(DEF='STD_Segment_t5',name='t5',
                                    ...
                                    HAnimSite(DEF='STD_Site_spine_1_middle_back_pt',name='spine_1_middle_back_pt',
                                      ...
                                      Shape(USE='HAnimSiteShape')])]),
                                  HAnimJoint(DEF='STD_Joint_vt4',name='vt4',center=(0.0061,1.4320,-0.0675),
                                    children=[
                                    HAnimSegment(DEF='STD_Segment_t4',name='t4'),
                                    HAnimJoint(DEF='STD_Joint_vt3',name='vt3',center=(0.0062,1.4583,-0.0570),
                                      children=[
                                      HAnimSegment(DEF='STD_Segment_t3',name='t3'),
                                      HAnimJoint(DEF='STD_Joint_vt2',name='vt2',center=(0.0063,1.4761,-0.0484),
                                        children=[
                                        HAnimSegment(DEF='STD_Segment_t2',name='t2'),
                                        HAnimJoint(DEF='STD_Joint_vt1',name='vt1',center=(0.0065,1.4951,-0.0387),
                                          children=[
                                          HAnimSegment(DEF='STD_Segment_t1',name='t1',
                                            ...
                                            HAnimSite(DEF='STD_Site_suprasternale_pt',name='suprasternale_pt',translation=(0.0084,1.4714,0.0551),
                                              ...
                                              Shape(USE='HAnimSiteShape')])]),
                                          HAnimJoint(DEF='STD_Joint_vc7',name='vc7',center=(0.0066,1.5132,-0.0301),
                                            children=[
                                            HAnimSegment(DEF='STD_Segment_c7',name='c7',
                                              ...
                                              HAnimSite(DEF='STD_Site_r_neck_base_pt',name='r_neck_base_pt',translation=(-0.0419,1.5149,-0.0220),
                                                ...
                                                Shape(USE='HAnimSiteShape')])]),
                                            HAnimJoint(DEF='STD_Joint_vc6',name='vc6',center=(0.0066,1.5357,-0.0143),
                                              children=[
                                              HAnimSegment(DEF='STD_Segment_c6',name='c6'),
                                              HAnimJoint(DEF='STD_Joint_vc5',name='vc5',center=(0.0066,1.5520,-0.0082),
                                                children=[
                                                HAnimSegment(DEF='STD_Segment_c5',name='c5'),
                                                HAnimJoint(DEF='STD_Joint_vc4',name='vc4',center=(0.0066,1.5662,-0.0084),
                                                  children=[
                                                  HAnimSegment(DEF='STD_Segment_c4',name='c4'),
                                                  HAnimJoint(DEF='STD_Joint_vc3',name='vc3',center=(0.0066,1.5800,-0.0103),
                                                    children=[
                                                    HAnimSegment(DEF='STD_Segment_c3',name='c3'),
                                                    HAnimJoint(DEF='STD_Joint_vc2',name='vc2',center=(0.0066,1.5928,-0.0103),
                                                      children=[
                                                      HAnimSegment(DEF='STD_Segment_c2',name='c2',
                                                        ...
                                                        HAnimSite(DEF='STD_Site_adams_apple_pt',name='adams_apple_pt',
                                                          ...
                                                          Shape(USE='HAnimSiteShape')])]),
                                                      HAnimJoint(DEF='STD_Joint_vc1',name='vc1',center=(0.0066,1.6144,-0.0034),
                                                        children=[
                                                        ...
                                                        HAnimJoint(DEF='STD_Joint_skullbase',name='skullbase',center=(0.0044,1.6209,0.0236),
                                                          ...
                                                          HAnimSegment(DEF='STD_Segment_skull',name='skull',
                                                            ...
                                                            HAnimSite(DEF='STD_Site_opisthocranion_pt',name='opisthocranion_pt',
                                                              ...
                                                              Shape(USE='HAnimSiteShape')])]),
                                                          HAnimJoint(DEF='STD_Joint_l_eyelid_joint',name='l_eyelid_joint',
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_l_eyelid',name='l_eyelid'),
                                                            HAnimJoint(DEF='STD_Joint_r_eyelid_joint',name='r_eyelid_joint',
                                                              children=[
                                                              HAnimSegment(DEF='STD_Segment_r_eyelid',name='r_eyelid'),
                                                              HAnimJoint(DEF='STD_Joint_l_eyeball_joint',name='l_eyeball_joint',
                                                                children=[
                                                                HAnimSegment(DEF='STD_Segment_l_eyeball',name='l_eyeball'),
                                                                HAnimJoint(DEF='STD_Joint_r_eyeball_joint',name='r_eyeball_joint',
                                                                  children=[
                                                                  HAnimSegment(DEF='STD_Segment_r_eyeball',name='r_eyeball'),
                                                                  HAnimJoint(DEF='STD_Joint_l_eyebrow_joint',name='l_eyebrow_joint',
                                                                    children=[
                                                                    HAnimSegment(DEF='STD_Segment_l_eyebrow',name='l_eyebrow'),
                                                                    HAnimJoint(DEF='STD_Joint_r_eyebrow_joint',name='r_eyebrow_joint',
                                                                      children=[
                                                                      HAnimSegment(DEF='STD_Segment_r_eyebrow',name='r_eyebrow'),
                                                                      HAnimJoint(DEF='STD_Joint_temporomandibular',name='temporomandibular',
                                                                        children=[
                                                                        HAnimSegment(DEF='STD_Segment_jaw',name='jaw',
                                                                          ...
                                                                          HAnimSite(DEF='STD_Site_l_gonion_pt',name='l_gonion_pt',translation=(0.0631,1.5530,0.0330),
                                                                            ...
                                                                            Shape(USE='HAnimSiteShape')])])])])])])])])])])])])])])])])]),
                                          HAnimJoint(DEF='STD_Joint_l_sternoclavicular',name='l_sternoclavicular',center=(0.0820,1.4488,-0.0353),
                                            children=[
                                            HAnimSegment(DEF='STD_Segment_l_clavicle',name='l_clavicle',
                                              ...
                                              HAnimSite(DEF='STD_Site_l_clavicale_pt',name='l_clavicale_pt',translation=(0.0271,1.4943,0.0394),
                                                ...
                                                Shape(USE='HAnimSiteShape')])]),
                                            HAnimJoint(DEF='STD_Joint_l_acromioclavicular',name='l_acromioclavicular',center=(0.0962,1.4269,-0.0424),
                                              children=[
                                                  ...
                                                  HAnimJoint(DEF='STD_Joint_l_radiocarpal',name='l_radiocarpal',center=(0.1984,0.8663,-0.0583),
                                                    ...
                                                    HAnimSegment(DEF='STD_Segment_l_carpal',name='l_carpal',
                                                      ...
                                                      HAnimSite(DEF='STD_Site_l_ulnar_styloid_pt',name='l_ulnar_styloid_pt',translation=(-0.2142,0.8529,-0.0648),
                                                        ...
                                                        Shape(USE='HAnimSiteShape')])]),
                                                    HAnimJoint(DEF='STD_Joint_l_midcarpal_1',name='l_midcarpal_1',
                                                      children=[
                                                      HAnimSegment(DEF='STD_Segment_l_trapezium',name='l_trapezium'),
                                                      HAnimJoint(DEF='STD_Joint_l_carpometacarpal_1',name='l_carpometacarpal_1',center=(0.1924,0.8472,-0.0534),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_l_metacarpal_1',name='l_metacarpal_1'),
                                                        HAnimJoint(DEF='STD_Joint_l_metacarpophalangeal_1',name='l_metacarpophalangeal_1',center=(0.1951,0.8226,0.0246),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_l_carpal_proximal_phalanx_1',name='l_carpal_proximal_phalanx_1'),
                                                          HAnimJoint(DEF='STD_Joint_l_carpal_interphalangeal_1',name='l_carpal_interphalangeal_1',center=(0.1955,0.8159,0.0464),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_l_carpal_distal_phalanx_1',name='l_carpal_distal_phalanx_1',
                                                              ...
                                                              HAnimSite(DEF='STD_Site_l_carpal_distal_phalanx_1_tip',name='l_carpal_distal_phalanx_1_tip',
                                                                ...
                                                                Shape(USE='HAnimSiteShape')])])])])])]),
                                                    HAnimJoint(DEF='STD_Joint_l_midcarpal_2',name='l_midcarpal_2',
                                                      children=[
                                                      HAnimSegment(DEF='STD_Segment_l_trapezoid',name='l_trapezoid'),
                                                      HAnimJoint(DEF='STD_Joint_l_carpometacarpal_2',name='l_carpometacarpal_2',center=(0.1983,0.8024,-0.0280),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_l_metacarpal_2',name='l_metacarpal_2',
                                                          ...
                                                          HAnimSite(DEF='STD_Site_l_metacarpal_phalanx_2_pt',name='l_metacarpal_phalanx_2_pt',translation=(0.2009,0.8139,-0.0237),
                                                            ...
                                                            Shape(USE='HAnimSiteShape')])]),
                                                        HAnimJoint(DEF='STD_Joint_l_metacarpophalangeal_2',name='l_metacarpophalangeal_2',center=(0.1983,0.7815,-0.0280),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_l_carpal_proximal_phalanx_2',name='l_carpal_proximal_phalanx_2'),
                                                          HAnimJoint(DEF='STD_Joint_l_carpal_proximal_interphalangeal_2',name='l_carpal_proximal_interphalangeal_2',center=(0.2017,0.7363,-0.0248),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_l_carpal_middle_phalanx_2',name='l_carpal_middle_phalanx_2'),
                                                            HAnimJoint(DEF='STD_Joint_l_carpal_distal_interphalangeal_2',name='l_carpal_distal_interphalangeal_2',center=(0.2028,0.7139,-0.0236),
                                                              children=[
                                                              HAnimSegment(DEF='STD_Segment_l_carpal_distal_phalanx_2',name='l_carpal_distal_phalanx_2',
                                                                ...
                                                                HAnimSite(DEF='STD_Site_l_carpal_distal_phalanx_2_tip',name='l_carpal_distal_phalanx_2_tip',
                                                                  ...
                                                                  Shape(USE='HAnimSiteShape')])])])])])])]),
                                                    HAnimJoint(DEF='STD_Joint_l_midcarpal_3',name='l_midcarpal_3',
                                                      children=[
                                                      HAnimSegment(DEF='STD_Segment_l_capitate',name='l_capitate'),
                                                      HAnimJoint(DEF='STD_Joint_l_carpometacarpal_3',name='l_carpometacarpal_3',center=(0.1987,0.8029,-0.0530),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_l_metacarpal_3',name='l_metacarpal_3',
                                                          ...
                                                          HAnimSite(DEF='STD_Site_l_metacarpal_phalanx_3_pt',name='l_metacarpal_phalanx_3_pt',
                                                            ...
                                                            Shape(USE='HAnimSiteShape')])]),
                                                        HAnimJoint(DEF='STD_Joint_l_metacarpophalangeal_3',name='l_metacarpophalangeal_3',center=(0.1987,0.7818,-0.0530),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_l_carpal_proximal_phalanx_3',name='l_carpal_proximal_phalanx_3'),
                                                          HAnimJoint(DEF='STD_Joint_l_carpal_proximal_interphalangeal_3',name='l_carpal_proximal_interphalangeal_3',center=(0.2013,0.7273,-0.0503),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_l_carpal_middle_phalanx_3',name='l_carpal_middle_phalanx_3'),
                                                            HAnimJoint(DEF='STD_Joint_l_carpal_distal_interphalangeal_3',name='l_carpal_distal_interphalangeal_3',center=(0.2026,0.7011,-0.0494),
                                                              children=[
                                                              HAnimSegment(DEF='STD_Segment_l_carpal_distal_phalanx_3',name='l_carpal_distal_phalanx_3',
                                                                ...
                                                                HAnimSite(DEF='STD_Site_l_carpal_distal_phalanx_3_tip',name='l_carpal_distal_phalanx_3_tip',
                                                                  ...
                                                                  Shape(USE='HAnimSiteShape')])])])])])])]),
                                                    HAnimJoint(DEF='STD_Joint_l_midcarpal_4_5',name='l_midcarpal_4_5',
                                                      children=[
                                                      HAnimSegment(DEF='STD_Segment_l_hamate',name='l_hamate'),
                                                      HAnimJoint(DEF='STD_Joint_l_carpometacarpal_4',name='l_carpometacarpal_4',center=(0.1956,0.8019,-0.0794),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_l_metacarpal_4',name='l_metacarpal_4'),
                                                        HAnimJoint(DEF='STD_Joint_l_metacarpophalangeal_4',name='l_metacarpophalangeal_4',center=(0.1956,0.7815,-0.0794),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_l_carpal_proximal_phalanx_4',name='l_carpal_proximal_phalanx_4'),
                                                          HAnimJoint(DEF='STD_Joint_l_carpal_proximal_interphalangeal_4',name='l_carpal_proximal_interphalangeal_4',center=(0.1973,0.7287,-0.0777),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_l_carpal_middle_phalanx_4',name='l_carpal_middle_phalanx_4'),
                                                            HAnimJoint(DEF='STD_Joint_l_carpal_distal_interphalangeal_4',name='l_carpal_distal_interphalangeal_4',center=(0.1983,0.7045,-0.0767),
                                                              children=[
                                                              HAnimSegment(DEF='STD_Segment_l_carpal_distal_phalanx_4',name='l_carpal_distal_phalanx_4',
                                                                ...
                                                                HAnimSite(DEF='STD_Site_l_carpal_distal_phalanx_4_tip',name='l_carpal_distal_phalanx_4_tip',
                                                                  ...
                                                                  Shape(USE='HAnimSiteShape')])])])])])]),
                                                      HAnimJoint(DEF='STD_Joint_l_carpometacarpal_5',name='l_carpometacarpal_5',center=(0.1925,0.8066,-0.1036),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_l_metacarpal_5',name='l_metacarpal_5',
                                                          ...
                                                          HAnimSite(DEF='STD_Site_l_metacarpal_phalanx_5_pt',name='l_metacarpal_phalanx_5_pt',translation=(0.1929,0.7860,-0.1122),
                                                            ...
                                                            Shape(USE='HAnimSiteShape')])]),
                                                        HAnimJoint(DEF='STD_Joint_l_metacarpophalangeal_5',name='l_metacarpophalangeal_5',center=(0.1925,0.7866,-0.1036),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_l_carpal_proximal_phalanx_5',name='l_carpal_proximal_phalanx_5'),
                                                          HAnimJoint(DEF='STD_Joint_l_carpal_proximal_interphalangeal_5',name='l_carpal_proximal_interphalangeal_5',center=(0.1938,0.7452,-0.1024),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_l_carpal_middle_phalanx_5',name='l_carpal_middle_phalanx_5'),
                                                            HAnimJoint(DEF='STD_Joint_l_carpal_distal_interphalangeal_5',name='l_carpal_distal_interphalangeal_5',center=(0.1948,0.7277,-0.1017),
                                                              children=[
                                                              HAnimSegment(DEF='STD_Segment_l_carpal_distal_phalanx_5',name='l_carpal_distal_phalanx_5',
                                                                ...
                                                                HAnimSite(DEF='STD_Site_l_carpal_distal_phalanx_5_tip',name='l_carpal_distal_phalanx_5_tip',
                                                                  ...
                                                                  Shape(USE='HAnimSiteShape')])])])])])])])])])])])]),
                                          HAnimJoint(DEF='STD_Joint_r_sternoclavicular',name='r_sternoclavicular',center=(-0.0694,1.4600,-0.0330),
                                            children=[
                                            HAnimSegment(DEF='STD_Segment_r_clavicle',name='r_clavicle',
                                              ...
                                              HAnimSite(DEF='STD_Site_r_clavicale_pt',name='r_clavicale_pt',translation=(-0.0115,1.4943,0.0400),
                                                ...
                                                Shape(USE='HAnimSiteShape')])]),
                                            HAnimJoint(DEF='STD_Joint_r_acromioclavicular',name='r_acromioclavicular',center=(-0.0836,1.4281,-0.0401),
                                              children=[
                                                  ...
                                                  HAnimJoint(DEF='STD_Joint_r_radiocarpal',name='r_radiocarpal',center=(-0.1959,0.8694,-0.0521),
                                                    ...
                                                    HAnimSegment(DEF='STD_Segment_r_carpal',name='r_carpal',
                                                      ...
                                                      HAnimSite(DEF='STD_Site_r_ulnar_styloid_pt',name='r_ulnar_styloid_pt',translation=(-0.2117,0.8562,-0.0584),
                                                        ...
                                                        Shape(USE='HAnimSiteShape')])]),
                                                    HAnimJoint(DEF='STD_Joint_r_midcarpal_1',name='r_midcarpal_1',
                                                      children=[
                                                      HAnimSegment(DEF='STD_Segment_r_trapezium',name='r_trapezium'),
                                                      HAnimJoint(DEF='STD_Joint_r_carpometacarpal_1',name='r_carpometacarpal_1',center=(-0.1899,0.8502,-0.0473),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_r_metacarpal_1',name='r_metacarpal_1'),
                                                        HAnimJoint(DEF='STD_Joint_r_metacarpophalangeal_1',name='r_metacarpophalangeal_1',center=(-0.1874,0.8256,0.0306),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_r_carpal_proximal_phalanx_1',name='r_carpal_proximal_phalanx_1'),
                                                          HAnimJoint(DEF='STD_Joint_r_carpal_interphalangeal_1',name='r_carpal_interphalangeal_1',center=(-0.1864,0.8190,0.0506),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_r_carpal_distal_phalanx_1',name='r_carpal_distal_phalanx_1',
                                                              ...
                                                              HAnimSite(DEF='STD_Site_r_carpal_distal_phalanx_1_tip',name='r_carpal_distal_phalanx_1_tip',
                                                                ...
                                                                Shape(USE='HAnimSiteShape')])])])])])]),
                                                    HAnimJoint(DEF='STD_Joint_r_midcarpal_2',name='r_midcarpal_2',
                                                      children=[
                                                      HAnimSegment(DEF='STD_Segment_r_trapezoid',name='r_trapezoid'),
                                                      HAnimJoint(DEF='STD_Joint_r_carpometacarpal_2',name='r_carpometacarpal_2',center=(-0.1961,0.8055,-0.0218),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_r_metacarpal_2',name='r_metacarpal_2',
                                                          ...
                                                          HAnimSite(DEF='STD_Site_r_metacarpal_phalanx_2_pt',name='r_metacarpal_phalanx_2_pt',translation=(-0.1977,0.8169,-0.0177),
                                                            ...
                                                            Shape(USE='HAnimSiteShape')])]),
                                                        HAnimJoint(DEF='STD_Joint_r_metacarpophalangeal_2',name='r_metacarpophalangeal_2',center=(-0.1961,0.7846,-0.0218),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_r_carpal_proximal_phalanx_2',name='r_carpal_proximal_phalanx_2'),
                                                          HAnimJoint(DEF='STD_Joint_r_carpal_proximal_interphalangeal_2',name='r_carpal_proximal_interphalangeal_2',center=(-0.1954,0.7393,-0.0185),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_r_carpal_middle_phalanx_2',name='r_carpal_middle_phalanx_2'),
                                                            HAnimJoint(DEF='STD_Joint_r_carpal_distal_interphalangeal_2',name='r_carpal_distal_interphalangeal_2',center=(-0.1945,0.7169,-0.0173),
                                                              children=[
                                                              HAnimSegment(DEF='STD_Segment_r_carpal_distal_phalanx_2',name='r_carpal_distal_phalanx_2',
                                                                ...
                                                                HAnimSite(DEF='STD_Site_r_carpal_distal_phalanx_2_tip',name='r_carpal_distal_phalanx_2_tip',
                                                                  ...
                                                                  Shape(USE='HAnimSiteShape')])])])])])])]),
                                                    HAnimJoint(DEF='STD_Joint_r_midcarpal_3',name='r_midcarpal_3',
                                                      children=[
                                                      HAnimSegment(DEF='STD_Segment_r_capitate',name='r_capitate'),
                                                      HAnimJoint(DEF='STD_Joint_r_carpometacarpal_3',name='r_carpometacarpal_3',center=(-0.1972,0.8060,-0.0468),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_r_metacarpal_3',name='r_metacarpal_3',
                                                          ...
                                                          HAnimSite(DEF='STD_Site_r_metacarpal_phalanx_3_pt',name='r_metacarpal_phalanx_3_pt',
                                                            ...
                                                            Shape(USE='HAnimSiteShape')])]),
                                                        HAnimJoint(DEF='STD_Joint_r_metacarpophalangeal_3',name='r_metacarpophalangeal_3',center=(-0.1972,0.7849,-0.0468),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_r_carpal_proximal_phalanx_3',name='r_carpal_proximal_phalanx_3'),
                                                          HAnimJoint(DEF='STD_Joint_r_carpal_proximal_interphalangeal_3',name='r_carpal_proximal_interphalangeal_3',center=(-0.1950,0.7304,-0.0441),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_r_carpal_middle_phalanx_3',name='r_carpal_middle_phalanx_3'),
                                                            HAnimJoint(DEF='STD_Joint_r_carpal_distal_interphalangeal_3',name='r_carpal_distal_interphalangeal_3',center=(-0.1939,0.7042,-0.0432),
                                                              children=[
                                                              HAnimSegment(DEF='STD_Segment_r_carpal_distal_phalanx_3',name='r_carpal_distal_phalanx_3',
                                                                ...
                                                                HAnimSite(DEF='STD_Site_r_carpal_distal_phalanx_3_tip',name='r_carpal_distal_phalanx_3_tip',
                                                                  ...
                                                                  Shape(USE='HAnimSiteShape')])])])])])])]),
                                                    HAnimJoint(DEF='STD_Joint_r_midcarpal_4_5',name='r_midcarpal_4_5',
                                                      children=[
                                                      HAnimSegment(DEF='STD_Segment_r_hamate',name='r_hamate'),
                                                      HAnimJoint(DEF='STD_Joint_r_carpometacarpal_4',name='r_carpometacarpal_4',center=(-0.1951,0.8049,-0.0732),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_r_metacarpal_4',name='r_metacarpal_4'),
                                                        HAnimJoint(DEF='STD_Joint_r_metacarpophalangeal_4',name='r_metacarpophalangeal_4',center=(-0.1951,0.7845,-0.0732),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_r_carpal_proximal_phalanx_4',name='r_carpal_proximal_phalanx_4'),
                                                          HAnimJoint(DEF='STD_Joint_r_carpal_proximal_interphalangeal_4',name='r_carpal_proximal_interphalangeal_4',center=(-0.1920,0.7318,-0.0716),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_r_carpal_middle_phalanx_4',name='r_carpal_middle_phalanx_4'),
                                                            HAnimJoint(DEF='STD_Joint_r_carpal_distal_interphalangeal_4',name='r_carpal_distal_interphalangeal_4',center=(-0.1908,0.7077,-0.0706),
                                                              children=[
                                                              HAnimSegment(DEF='STD_Segment_r_carpal_distal_phalanx_4',name='r_carpal_distal_phalanx_4',
                                                                ...
                                                                HAnimSite(DEF='STD_Site_r_carpal_distal_phalanx_4_tip',name='r_carpal_distal_phalanx_4_tip',
                                                                  ...
                                                                  Shape(USE='HAnimSiteShape')])])])])])]),
                                                      HAnimJoint(DEF='STD_Joint_r_carpometacarpal_5',name='r_carpometacarpal_5',center=(-0.1926,0.8096,-0.0975),
                                                        children=[
                                                        HAnimSegment(DEF='STD_Segment_r_metacarpal_5',name='r_metacarpal_5',
                                                          ...
                                                          HAnimSite(DEF='STD_Site_r_metacarpal_phalanx_5_pt',name='r_metacarpal_phalanx_5_pt',translation=(-0.1929,0.7890,-0.1064),
                                                            ...
                                                            Shape(USE='HAnimSiteShape')])]),
                                                        HAnimJoint(DEF='STD_Joint_r_metacarpophalangeal_5',name='r_metacarpophalangeal_5',center=(-0.1926,0.7896,-0.0975),
                                                          children=[
                                                          HAnimSegment(DEF='STD_Segment_r_carpal_proximal_phalanx_5',name='r_carpal_proximal_phalanx_5'),
                                                          HAnimJoint(DEF='STD_Joint_r_carpal_proximal_interphalangeal_5',name='r_carpal_proximal_interphalangeal_5',center=(-0.1902,0.7483,-0.0963),
                                                            children=[
                                                            HAnimSegment(DEF='STD_Segment_r_carpal_middle_phalanx_5',name='r_carpal_middle_phalanx_5'),
                                                            HAnimJoint(DEF='STD_Joint_r_carpal_distal_interphalangeal_5',name='r_carpal_distal_interphalangeal_5',center=(-0.1908,0.7540,-0.0960),
                                                              children=[
      ...
      HAnimJoint(USE='STD_Joint_l_talocalcaneonavicular'),
      HAnimSegment(USE='STD_Segment_l_navicular'),
      HAnimJoint(USE='STD_Joint_l_cuneonavicular_1'),
      HAnimSegment(USE='STD_Segment_l_cuneiform_1'),
      HAnimJoint(USE='STD_Joint_l_tarsometatarsal_1'),
      HAnimSegment(USE='STD_Segment_l_metatarsal_1'),
      HAnimJoint(USE='STD_Joint_l_metatarsophalangeal_1'),
      HAnimSegment(USE='STD_Segment_l_tarsal_proximal_phalanx_1'),
      HAnimJoint(USE='STD_Joint_l_tarsal_interphalangeal_1'),
      HAnimSegment(USE='STD_Segment_l_tarsal_distal_phalanx_1'),
      HAnimJoint(USE='STD_Joint_l_cuneonavicular_2'),
      HAnimSegment(USE='STD_Segment_l_cuneiform_2'),
      HAnimJoint(USE='STD_Joint_l_tarsometatarsal_2'),
      ...
      HAnimJoint(USE='STD_Joint_l_tarsal_proximal_interphalangeal_2'),
      HAnimSegment(USE='STD_Segment_l_tarsal_middle_phalanx_2'),
      HAnimJoint(USE='STD_Joint_l_tarsal_distal_interphalangeal_2'),
      HAnimSegment(USE='STD_Segment_l_tarsal_distal_phalanx_2'),
      HAnimJoint(USE='STD_Joint_l_cuneonavicular_3'),
      HAnimSegment(USE='STD_Segment_l_cuneiform_3'),
      HAnimJoint(USE='STD_Joint_l_tarsometatarsal_3'),
      HAnimSegment(USE='STD_Segment_l_metatarsal_3'),
      HAnimJoint(USE='STD_Joint_l_metatarsophalangeal_3'),
      HAnimSegment(USE='STD_Segment_l_tarsal_proximal_phalanx_3'),
      HAnimJoint(USE='STD_Joint_l_tarsal_proximal_interphalangeal_3'),
      HAnimSegment(USE='STD_Segment_l_tarsal_middle_phalanx_3'),
      HAnimJoint(USE='STD_Joint_l_tarsal_distal_interphalangeal_3'),
      HAnimSegment(USE='STD_Segment_l_tarsal_distal_phalanx_3'),
      HAnimJoint(USE='STD_Joint_l_calcaneocuboid'),
      HAnimSegment(USE='STD_Segment_l_calcaneus'),
      HAnimJoint(USE='STD_Joint_l_transversetarsal'),
      HAnimSegment(USE='STD_Segment_l_cuboid'),
      HAnimJoint(USE='STD_Joint_l_tarsometatarsal_4'),
      HAnimSegment(USE='STD_Segment_l_metatarsal_4'),
      HAnimJoint(USE='STD_Joint_l_metatarsophalangeal_4'),
      HAnimSegment(USE='STD_Segment_l_tarsal_proximal_phalanx_4'),
      HAnimJoint(USE='STD_Joint_l_tarsal_proximal_interphalangeal_4'),
      HAnimSegment(USE='STD_Segment_l_tarsal_middle_phalanx_4'),
      HAnimJoint(USE='STD_Joint_l_tarsal_distal_interphalangeal_4'),
      HAnimSegment(USE='STD_Segment_l_tarsal_distal_phalanx_4'),
      HAnimJoint(USE='STD_Joint_l_tarsometatarsal_5'),
      HAnimSegment(USE='STD_Segment_l_metatarsal_5'),
      HAnimJoint(USE='STD_Joint_l_metatarsophalangeal_5'),
      HAnimSegment(USE='STD_Segment_l_tarsal_proximal_phalanx_5'),
      HAnimJoint(USE='STD_Joint_l_tarsal_proximal_interphalangeal_5'),
      HAnimSegment(USE='STD_Segment_l_tarsal_middle_phalanx_5'),
      HAnimJoint(USE='STD_Joint_l_tarsal_distal_interphalangeal_5'),
      ...
      HAnimJoint(USE='STD_Joint_r_talocalcaneonavicular'),
      HAnimSegment(USE='STD_Segment_r_navicular'),
      HAnimJoint(USE='STD_Joint_r_cuneonavicular_1'),
      HAnimSegment(USE='STD_Segment_r_cuneiform_1'),
      HAnimJoint(USE='STD_Joint_r_tarsometatarsal_1'),
      HAnimSegment(USE='STD_Segment_r_metatarsal_1'),
      HAnimJoint(USE='STD_Joint_r_metatarsophalangeal_1'),
      HAnimSegment(USE='STD_Segment_r_tarsal_proximal_phalanx_1'),
      HAnimJoint(USE='STD_Joint_r_tarsal_interphalangeal_1'),
      HAnimSegment(USE='STD_Segment_r_tarsal_distal_phalanx_1'),
      HAnimJoint(USE='STD_Joint_r_cuneonavicular_2'),
      HAnimSegment(USE='STD_Segment_r_cuneiform_2'),
      HAnimJoint(USE='STD_Joint_r_tarsometatarsal_2'),
      ...
      HAnimJoint(USE='STD_Joint_l_midcarpal_1'),
      HAnimSegment(USE='STD_Segment_l_trapezium'),
      HAnimJoint(USE='STD_Joint_l_carpometacarpal_1'),
      HAnimSegment(USE='STD_Segment_l_metacarpal_1'),
      HAnimJoint(USE='STD_Joint_l_metacarpophalangeal_1'),
      HAnimSegment(USE='STD_Segment_l_carpal_proximal_phalanx_1'),
      HAnimJoint(USE='STD_Joint_l_carpal_interphalangeal_1'),
      HAnimSegment(USE='STD_Segment_l_carpal_distal_phalanx_1'),
      HAnimJoint(USE='STD_Joint_l_midcarpal_2'),
      HAnimSegment(USE='STD_Segment_l_trapezoid'),
      HAnimJoint(USE='STD_Joint_l_carpometacarpal_2'),
      HAnimSegment(USE='STD_Segment_l_metacarpal_2'),
      HAnimJoint(USE='STD_Joint_l_metacarpophalangeal_2'),
      HAnimSegment(USE='STD_Segment_l_carpal_proximal_phalanx_2'),
      HAnimJoint(USE='STD_Joint_l_carpal_proximal_interphalangeal_2'),
      HAnimSegment(USE='STD_Segment_l_carpal_middle_phalanx_2'),
      HAnimJoint(USE='STD_Joint_l_carpal_distal_interphalangeal_2'),
      HAnimSegment(USE='STD_Segment_l_carpal_distal_phalanx_2'),
      HAnimJoint(USE='STD_Joint_l_midcarpal_3'),
      HAnimSegment(USE='STD_Segment_l_capitate'),
      HAnimJoint(USE='STD_Joint_l_carpometacarpal_3'),
      HAnimSegment(USE='STD_Segment_l_metacarpal_3'),
      HAnimJoint(USE='STD_Joint_l_metacarpophalangeal_3'),
      HAnimSegment(USE='STD_Segment_l_carpal_proximal_phalanx_3'),
      HAnimJoint(USE='STD_Joint_l_carpal_proximal_interphalangeal_3'),
      HAnimSegment(USE='STD_Segment_l_carpal_middle_phalanx_3'),
      HAnimJoint(USE='STD_Joint_l_carpal_distal_interphalangeal_3'),
      HAnimSegment(USE='STD_Segment_l_carpal_distal_phalanx_3'),
      HAnimJoint(USE='STD_Joint_l_midcarpal_4_5'),
      HAnimSegment(USE='STD_Segment_l_hamate'),
      HAnimJoint(USE='STD_Joint_l_carpometacarpal_4'),
      HAnimSegment(USE='STD_Segment_l_metacarpal_4'),
      HAnimJoint(USE='STD_Joint_l_metacarpophalangeal_4'),
      HAnimSegment(USE='STD_Segment_l_carpal_proximal_phalanx_4'),
      HAnimJoint(USE='STD_Joint_l_carpal_proximal_interphalangeal_4'),
      HAnimSegment(USE='STD_Segment_l_carpal_middle_phalanx_4'),
      HAnimJoint(USE='STD_Joint_l_carpal_distal_interphalangeal_4'),
      HAnimSegment(USE='STD_Segment_l_carpal_distal_phalanx_4'),
      HAnimJoint(USE='STD_Joint_l_carpometacarpal_5'),
      HAnimSegment(USE='STD_Segment_l_metacarpal_5'),
      HAnimJoint(USE='STD_Joint_l_metacarpophalangeal_5'),
      HAnimSegment(USE='STD_Segment_l_carpal_proximal_phalanx_5'),
      HAnimJoint(USE='STD_Joint_l_carpal_proximal_interphalangeal_5'),
      HAnimSegment(USE='STD_Segment_l_carpal_middle_phalanx_5'),
      HAnimJoint(USE='STD_Joint_l_carpal_distal_interphalangeal_5'),
      HAnimSegment(USE='STD_Segment_l_carpal_distal_phalanx_5'),
      HAnimJoint(USE='STD_Joint_r_sternoclavicular'),
      HAnimSegment(USE='STD_Segment_r_clavicle'),
      HAnimJoint(USE='STD_Joint_r_acromioclavicular'),
      ...
      HAnimJoint(USE='STD_Joint_r_midcarpal_1'),
      HAnimSegment(USE='STD_Segment_r_trapezium'),
      HAnimJoint(USE='STD_Joint_r_carpometacarpal_1'),
      HAnimSegment(USE='STD_Segment_r_metacarpal_1'),
      HAnimJoint(USE='STD_Joint_r_metacarpophalangeal_1'),
      HAnimSegment(USE='STD_Segment_r_carpal_proximal_phalanx_1'),
      HAnimJoint(USE='STD_Joint_r_carpal_interphalangeal_1'),
      HAnimSegment(USE='STD_Segment_r_carpal_distal_phalanx_1'),
      HAnimJoint(USE='STD_Joint_r_midcarpal_2'),
      HAnimSegment(USE='STD_Segment_r_trapezoid'),
      HAnimJoint(USE='STD_Joint_r_carpometacarpal_2'),
      HAnimSegment(USE='STD_Segment_r_metacarpal_2'),
      HAnimJoint(USE='STD_Joint_r_metacarpophalangeal_2'),
      HAnimSegment(USE='STD_Segment_r_carpal_proximal_phalanx_2'),
      HAnimJoint(USE='STD_Joint_r_carpal_proximal_interphalangeal_2'),
      HAnimSegment(USE='STD_Segment_r_carpal_middle_phalanx_2'),
      HAnimJoint(USE='STD_Joint_r_carpal_distal_interphalangeal_2'),
      HAnimSegment(USE='STD_Segment_r_carpal_distal_phalanx_2'),
      HAnimJoint(USE='STD_Joint_r_midcarpal_3'),
      HAnimSegment(USE='STD_Segment_r_capitate'),
      HAnimJoint(USE='STD_Joint_r_carpometacarpal_3'),
      HAnimSegment(USE='STD_Segment_r_metacarpal_3'),
      HAnimJoint(USE='STD_Joint_r_metacarpophalangeal_3'),
      HAnimSegment(USE='STD_Segment_r_carpal_proximal_phalanx_3'),
      HAnimJoint(USE='STD_Joint_r_carpal_proximal_interphalangeal_3'),
      HAnimSegment(USE='STD_Segment_r_carpal_middle_phalanx_3'),
      HAnimJoint(USE='STD_Joint_r_carpal_distal_interphalangeal_3'),
      HAnimSegment(USE='STD_Segment_r_carpal_distal_phalanx_3'),
      HAnimJoint(USE='STD_Joint_r_midcarpal_4_5'),
      HAnimSegment(USE='STD_Segment_r_hamate'),
      HAnimJoint(USE='STD_Joint_r_carpometacarpal_4'),
      HAnimSegment(USE='STD_Segment_r_metacarpal_4'),
      HAnimJoint(USE='STD_Joint_r_metacarpophalangeal_4'),
      HAnimSegment(USE='STD_Segment_r_carpal_proximal_phalanx_4'),
      HAnimJoint(USE='STD_Joint_r_carpal_proximal_interphalangeal_4'),
      HAnimSegment(USE='STD_Segment_r_carpal_middle_phalanx_4'),
      HAnimJoint(USE='STD_Joint_r_carpal_distal_interphalangeal_4'),
      HAnimSegment(USE='STD_Segment_r_carpal_distal_phalanx_4'),
      HAnimJoint(USE='STD_Joint_r_carpometacarpal_5'),
      HAnimSegment(USE='STD_Segment_r_metacarpal_5'),
      HAnimJoint(USE='STD_Joint_r_metacarpophalangeal_5'),
      HAnimSegment(USE='STD_Segment_r_carpal_proximal_phalanx_5'),
      HAnimJoint(USE='STD_Joint_r_carpal_proximal_interphalangeal_5'),
      HAnimSegment(USE='STD_Segment_r_carpal_middle_phalanx_5'),
      HAnimJoint(USE='STD_Joint_r_carpal_distal_interphalangeal_5')],

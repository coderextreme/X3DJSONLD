...
#
#   $ python AllAudioGraphNodesTest.py
#
...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(content='17 December 2023',name='modified'),
  ...
  Scene=Scene(
    ...
    Sound(location=(0,1.6,0),
      source=AudioClip(description='testing',url=["sound/saxophone.mp3","https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/saxophone.mp3"])),
    Sound(location=(0,1.6,0),
      source=MovieTexture(description='testing',url=["bogus.mpg","https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/bogus.mpg"])),
    SpatialSound(
      children=[
      Analyser(
        children=[
...
print('Self-test diagnostics for AllAudioGraphNodesTest.py:')
...
print("python AllAudioGraphNodesTest.py load and self-test diagnostics complete.")

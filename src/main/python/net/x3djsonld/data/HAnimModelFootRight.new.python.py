...
newModel=X3D(profile='Immersive',version='4.0',
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='hanim_Foot_Right',name='Foot_Right',loa=4,version='2.0',
      ...
      HAnimJoint(DEF='hanim_humanoid_root',name='humanoid_root',llimit=[0,0,0],ulimit=[0,0,0],
        children=[
        HAnimJoint(DEF='hanim_r_talocrural',name='r_talocrural',description='connection joint of foot to leg above',llimit=[0,0,0],ulimit=[0,0,0],
          children=[
          ...
          HAnimJoint(DEF='hanim_r_talocalcaneonavicular',name='r_talocalcaneonavicular',center=(0,-0.3,0),llimit=[0,0,0],ulimit=[0,0,0],
            children=[
            ...
            HAnimJoint(DEF='hanim_r_cuneonavicular_1',name='r_cuneonavicular_1',center=(0.1,-0.45,0),llimit=[0,0,0],ulimit=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_tarsometatarsal_1',name='r_tarsometatarsal_1',center=(0.1,-0.6,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_1',name='r_metatarsophalangeal_1',center=(0.1,-0.9,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_interphalangeal_1',name='r_tarsal_interphalangeal_1',center=(0.1,-1.05,0),llimit=[0,0,0],ulimit=[0,0,0],
                    children=[
            ...
            HAnimJoint(DEF='hanim_r_cuneonavicular_2',name='r_cuneonavicular_2',center=(0,-0.45,0),llimit=[0,0,0],ulimit=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_tarsometatarsal_2',name='r_tarsometatarsal_2',center=(-0.05,-0.6,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_2',name='r_metatarsophalangeal_2',center=(-0.05,-0.9,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_2',name='r_tarsal_proximal_interphalangeal_2',center=(-0.05,-1.05,0),llimit=[0,0,0],ulimit=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_2',name='r_tarsal_distal_interphalangeal_2',center=(-0.05,-1.12,0),llimit=[0,0,0],ulimit=[0,0,0],
                      children=[
            ...
            HAnimJoint(DEF='hanim_r_cuneonavicular_3',name='r_cuneonavicular_3',center=(-0.1,-0.4,0),llimit=[0,0,0],ulimit=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_tarsometatarsal_3',name='r_tarsometatarsal_3',center=(-0.15,-0.6,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_3',name='r_metatarsophalangeal_3',center=(-0.15,-0.9,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_3',name='r_tarsal_proximal_interphalangeal_3',center=(-0.15,-1.05,0),llimit=[0,0,0],ulimit=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_3',name='r_tarsal_distal_interphalangeal_3',center=(-0.15,-1.13,0),llimit=[0,0,0],ulimit=[0,0,0],
                      children=[
          ...
          HAnimJoint(DEF='hanim_r_calcaneocuboid',name='r_calcaneocuboid',center=(-0.2,0.3,0),llimit=[0,0,0],ulimit=[0,0,0],
            children=[
            ...
            HAnimJoint(DEF='hanim_r_transversetarsal',name='r_transversetarsal',center=(-0.21,-0.3,0),llimit=[0,0,0],ulimit=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_tarsometatarsal_4',name='r_tarsometatarsal_4',center=(-0.25,-0.58,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_4',name='r_metatarsophalangeal_4',center=(-0.25,-0.87,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_4',name='r_tarsal_proximal_interphalangeal_4',center=(-0.25,-1,0),llimit=[0,0,0],ulimit=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_4',name='r_tarsal_distal_interphalangeal_4',center=(-0.25,-1.1,0),llimit=[0,0,0],ulimit=[0,0,0],
                      children=[
              ...
              HAnimJoint(DEF='hanim_r_tarsometatarsal_5',name='r_tarsometatarsal_5',center=(-0.33,-0.52,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_5',name='r_metatarsophalangeal_5',center=(-0.34,-0.8,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_5',name='r_tarsal_proximal_interphalangeal_5',center=(-0.34,-0.95,0),llimit=[0,0,0],ulimit=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_5',name='r_tarsal_distal_interphalangeal_5',center=(-0.34,-1.05,0),llimit=[0,0,0],ulimit=[0,0,0],
                      children=[

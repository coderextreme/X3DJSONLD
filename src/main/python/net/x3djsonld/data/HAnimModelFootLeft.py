  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='hanim_Foot_Left',loa=4,name='Foot_Left',version='2.0',
      ...
      HAnimJoint(DEF='hanim_humanoid_root',name='humanoid_root',stiffness=[0,0,0],
        ...
        children=[
        HAnimJoint(DEF='hanim_l_talocrural',description='connection joint of foot to leg above',name='l_talocrural',stiffness=[0,0,0],
          children=[
          ...
          #  TCN 
          HAnimJoint(DEF='hanim_l_talocalcaneonavicular',center=(0.0,-0.3,0),name='l_talocalcaneonavicular',stiffness=[0,0,0],
            children=[
            ...
            #  CN1 
            HAnimJoint(DEF='hanim_l_cuneonavicular_1',center=(-0.1,-0.45,0),name='l_cuneonavicular_1',stiffness=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_l_tarsometatarsal_1',center=(-0.1,-0.6,0),name='l_tarsometatarsal_1',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_l_metatarsophalangeal_1',center=(-0.1,-0.9,0),name='l_metatarsophalangeal_1',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_l_tarsal_interphalangeal_1',center=(-0.1,-1.05,0),name='l_tarsal_interphalangeal_1',stiffness=[0,0,0],
                    children=[
            ...
            #  CN2 
            HAnimJoint(DEF='hanim_l_cuneonavicular_2',center=(0.0,-0.45,0),name='l_cuneonavicular_2',stiffness=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_l_tarsometatarsal_2',center=(0.05,-0.6,0),name='l_tarsometatarsal_2',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_l_metatarsophalangeal_2',center=(0.05,-0.9,0),name='l_metatarsophalangeal_2',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_l_tarsal_proximal_interphalangeal_2',center=(0.05,-1.05,0),name='l_tarsal_proximal_interphalangeal_2',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_2',center=(0.05,-1.12,0),name='l_tarsal_distal_interphalangeal_2',stiffness=[0,0,0],
                      children=[
            ...
            #  CN3 
            HAnimJoint(DEF='hanim_l_cuneonavicular_3',center=(0.1,-0.4,0),name='l_cuneonavicular_3',stiffness=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_l_tarsometatarsal_3',center=(0.15,-0.6,0),name='l_tarsometatarsal_3',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_l_metatarsophalangeal_3',center=(0.15,-0.9,0),name='l_metatarsophalangeal_3',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_l_tarsal_proximal_interphalangeal_3',center=(0.15,-1.05,0),name='l_tarsal_proximal_interphalangeal_3',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_3',center=(0.15,-1.13,0),name='l_tarsal_distal_interphalangeal_3',stiffness=[0,0,0],
                      children=[
          ...
          #  CC 
          HAnimJoint(DEF='hanim_l_calcaneocuboid',center=(0.2,0.3,0),name='l_calcaneocuboid',stiffness=[0,0,0],
            children=[
            ...
            #  TT 
            HAnimJoint(DEF='hanim_l_transversetarsal',center=(0.21,-0.3,0),name='l_transversetarsal',stiffness=[0,0,0],
              children=[
              ...
              #  TMT4 
              HAnimJoint(DEF='hanim_l_tarsometatarsal_4',center=(0.25,-0.58,0),name='l_tarsometatarsal_4',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_l_metatarsophalangeal_4',center=(0.25,-0.87,0),name='l_metatarsophalangeal_4',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_l_tarsal_proximal_interphalangeal_4',center=(0.25,-1.0,0),name='l_tarsal_proximal_interphalangeal_4',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_4',center=(0.25,-1.1,0),name='l_tarsal_distal_interphalangeal_4',stiffness=[0,0,0],
                      children=[
              ...
              #  TMT5 
              HAnimJoint(DEF='hanim_l_tarsometatarsal_5',center=(0.33,-0.52,0),name='l_tarsometatarsal_5',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_l_metatarsophalangeal_5',center=(0.34,-0.8,0),name='l_metatarsophalangeal_5',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_l_tarsal_proximal_interphalangeal_5',center=(0.34,-0.95,0),name='l_tarsal_proximal_interphalangeal_5',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_5',center=(0.34,-1.05,0),name='l_tarsal_distal_interphalangeal_5',stiffness=[0,0,0],
                      children=[
      ...
      HAnimJoint(USE='hanim_l_calcaneocuboid',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_cuneonavicular_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_cuneonavicular_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_cuneonavicular_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metatarsophalangeal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metatarsophalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metatarsophalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metatarsophalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_metatarsophalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_talocalcaneonavicular',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_talocrural',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsal_distal_interphalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsal_distal_interphalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsal_distal_interphalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsal_distal_interphalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsal_interphalangeal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsal_proximal_interphalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsal_proximal_interphalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsal_proximal_interphalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsal_proximal_interphalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsometatarsal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsometatarsal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsometatarsal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsometatarsal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_tarsometatarsal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_l_transversetarsal',stiffness=[0,0,0])],
      segments=[

...
newModel=X3D(profile='Full',version='3.3',
  head=head(
    ...
    meta(name='created',content='Mon, 18 Apr 2016 18:51:12 GMT'),
    meta(name='creator',content='Holger Seelig'),
    meta(name='generator',content='Titania V1.4.1, http://titania.create3000.de'),
    meta(name='identifier',content='file:///home/holger/Projekte/Cobweb/excite/tests/Components/ParticleSystems/PointEmitter.x3d'),
    meta(name='modified',content='Wed, 20 Apr 2016 01:44:22 GMT')]),
  Scene=Scene(
    children=[
    ...
    WorldInfo(
      metadata=MetadataSet(DEF='Titania',name='Titania',reference='http://titania.create3000.de',
        ...
        MetadataSet(DEF='Viewpoint',name='Viewpoint',reference='http://titania.create3000.de',
          value=[
          MetadataDouble(DEF='position',name='position',reference='http://titania.create3000.de',value=[6.95441767781059,-10.9455192646649,38.1205570962763]),
          MetadataDouble(DEF='orientation',name='orientation',reference='http://titania.create3000.de',value=[0.267526168119517,0.886841256272589,-0.376752353070482,0.231331896046484]),
          MetadataDouble(DEF='centerOfRotation',name='centerOfRotation',reference='http://titania.create3000.de',value=[-0.49056801199913,-8.33930015563965,1.86343002319336])]),
          ...
          MetadataSet(DEF='children',name='children',reference='http://titania.create3000.de',
            ...
            Transform(DEF='TransparencyText',translation=(1.675,-0.95,-3.49096e-06),scale=(0.0672307,0.0672307,0.0672307),
              ...
              Shape(
                ...
                geometry=Text(DEF='_1',string=["numParticles 2337"],solid=True,
                  fontStyle=FontStyle(DEF='_2',family=["SANS"],justify=["END"])))])])]),
    ...
    LayerSet(activeLayer=1,order=[0,1,2,3],
      layers=Layer(
        ...
        ParticleSystem(DEF='Fountain',geometryType='SPRITE',maxParticles=2337,particleLifetime=2,lifetimeVariation=0.1,particleSize=(1,1),colorKey=[0,0.1,0.4,1],bboxSize=(65.18,52.41,52.41),bboxCenter=(0,-16.74,0),
          emitter=PointEmitter(direction=(0,0,0),speed=10,variation=0.01,mass=0.01,surfaceArea=0.1),
          ...
          color=ColorRGBA(color=[(0,0.38,1,0),(0.06,0.58,1,0.1),(0,0.37,1,0.2),(0,0.05,1,0.2)]),
          appearance=Appearance(
        ...
        Transform(DEF='TransparancySlider',translation=(0.025,-0.923,-3.49096e-06),center=(0,-0.027,0),
          ...
          Group(
            ...
            Script(DEF='NumParticlesyScript',
              ...
              field(accessType='initializeOnly',type='SFInt32',name='currentValue',value=2337)],

...
newModel=X3D(profile='Immersive',version='4.0',
  ...
  Scene=Scene(
    ...
    Group(
      children=[
      Shape(
        geometry=Extrusion(DEF='myextrusion',spine=[(-50,-50,0),(50,50,0)],creaseAngle=0.785,crossSection=[(1.00,0.00),(0.92,-0.38),(0.71,-0.71),(0.38,-0.92),(0.00,-1.00),(-0.38,-0.92),(-0.71,-0.71),(-0.92,-0.38),(-1.00,-0.00),(-0.92,0.38),(-0.71,0.71),(-0.38,0.92),(0.00,1.00),(0.38,0.92),(0.71,0.71),(0.92,0.38),(1.00,0.00)]),
...
print('Self-test diagnostics for myextrusion.py:')
...
print("python myextrusion.py load and self-test diagnostics complete.")

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(name='identifier',content='https://www.web3d.org/x3d/content/examples/HumanoidAnimation/JohnJoint2.x3d'),
  ...
  Scene=Scene(
    ...
    Group(
      ...
      Transform(
        ...
        Comment(' <Shape DEF=\'HAnimRootShape\'> '),
        Comment(' <Sphere radius=\'0.02\'  /> '),
        Comment(' <Appearance> '),
        Comment(' <Material DEF=\'HAnimRootMaterial\' diffuseColor=\'0.8 0 0\' transparency=\'0.3\'/> '),
        Comment(' </Appearance> '),
        Comment(' </Shape> '),
        Comment(' </Transform> '),
        ...
        Comment(' <Transform translation=\'0 2.1 0\'> '),
        Comment(' <Shape DEF=\'HAnimSiteShape\'> '),
        Comment(' <IndexedFaceSet DEF=\'DiamondIFS\' creaseAngle=\'0.5\' solid=\'false\' coordIndex=\'0 1 2 -1 0 2 3 -1 0 3 4 -1 0 4 1 -1 5 2 1 -1 5 3 2 -1 5 4 3 -1 5 1 4 -1\'> '),
        Comment(' <ColorRGBA DEF=\'HAnimSiteColorRGBA\' color=\'1 1 0 1 1 1 0 0.1\'/> '),
        Comment(' <Coordinate point=\'0 0.01 0 -0.01 0 0 0 0 0.01 0.01 0 0 0 0 -0.01 0 -0.01 0\'/> '),
        Comment(' </IndexedFaceSet> '),
        Comment(' <Appearance> '),
        Comment(' <Material diffuseColor=\'1 1 0\' transparency=\'0.3\'/> '),
        Comment(' </Appearance> '),
        Comment(' </Shape> '),
        Comment(' </Transform> ')
        )]),

        ...
        Group(DEF='ArrowGreen',
          ...
          Shape(
            appearance=Appearance(DEF='Green',
              material=Material(diffuseColor=(0.1,0.6,0.1),emissiveColor=(0.05,0.2,0.05))),
            geometry=Cylinder(DEF='ArrowCylinder',radius=0.025,top=False)),
          Transform(translation=(0,1,0),
            children=[
            Shape(
              appearance=Appearance(USE='Green'),
              geometry=Cone(DEF='ArrowCone',bottomRadius=0.05,height=0.1))])]),
          ...
          Billboard(
            ...
            Shape(
              ...
              geometry=Text(string=["Y"],
                fontStyle=FontStyle(DEF='LABEL_FONT',family=["SANS"],justify=["MIDDLE","MIDDLE"],size=0.2)))])])]),
          ...
          Group(DEF='ArrowRed',
            ...
            Shape(
              appearance=Appearance(DEF='Red',
                material=Material(diffuseColor=(0.7,0.1,0.1),emissiveColor=(0.33,0,0))),
          ...
          Group(DEF='ArrowBlue',
            ...
            Shape(
              appearance=Appearance(DEF='Blue',
                material=Material(diffuseColor=(0.3,0.3,1),emissiveColor=(0.1,0.1,0.33))),
              geometry=Cylinder(USE='ArrowCylinder')),
            Transform(translation=(0,1,0),
              children=[
              Shape(

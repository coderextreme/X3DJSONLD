        ...
        Group(
          ...
          Transform(scale=(0.5,0.5,0.5),
            ...
            Shape(
              ...
              geometry=Extrusion(creaseAngle=0.785,crossSection=[(1,0),(0.92,-0.38),(0.71,-0.71),(0.38,-0.92),(0,-1),(-0.38,-0.92),(-0.71,-0.71),(-0.92,-0.38),(-1,0),(-0.92,0.38),(-0.71,0.71),(-0.38,0.92),(0,1),(0.38,0.92),(0.71,0.71),(0.92,0.38),(1,0)],spine=[(1.5,0,0),(2.0,0,0),(2.5,0,0)])),
          ...
          Transform(scale=(0.5,0.5,0.5),
            ...
            Shape(
              appearance=Appearance(
                material=Material(diffuseColor=(0,0.7,1),transparency=0.5)),
              geometry=Extrusion(creaseAngle=0.785,crossSection=[(1,0),(0.92,-0.38),(0.71,-0.71),(0.38,-0.92),(0,-1),(-0.38,-0.92),(-0.71,-0.71),(-0.92,-0.38),(-1,0),(-0.92,0.38),(-0.71,0.71),(-0.38,0.92),(0,1),(0.38,0.92),(0.71,0.71),(0.92,0.38),(1,0)],spine=[(0,1.5,0),(0,2.0,0),(0,2.5,0)])),
...
print('Self-test diagnostics for pp3.py:')
...
print("python pp3.py load and self-test diagnostics complete.")

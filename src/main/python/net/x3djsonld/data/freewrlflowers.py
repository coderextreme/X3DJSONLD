...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    children=[
    meta(name='title',content='freewrlflowers.x3d'),
    meta(name='creator',content='John Carlson'),
    meta(name='description',content='5 or more prismatic flowers'),
    meta(name='generator',content='X3D-Edit, https://savage.nps.edu/X3D-Edit'),
    meta(name='identifier',content='https://coderextreme.net/X3DJSONLD/src/main/data/freewrlflowers.x3d')]),
  Scene=Scene(
    children=[
    NavigationInfo(),
    Viewpoint(description='Tour Views',position=(0,0,50)),
    ...
    Group(
      children=[
      ExternProtoDeclare(name='FlowerProto',url=["../data/flowerprotofreewrl.x3d#FlowerProto","https://coderextreme.net/X3DJSONLD/src/main/data/flowerprotofreewrl.x3d#FlowerProto"],
        field=[
        ...
        ProtoBody=ProtoBody(
          ...
          Group(
            ...
            ProtoInstance(name='FlowerProto',
              fieldValue=[
              fieldValue(name='vertex',value=["../shaders/freewrl_flowers_chromatic.vs"]),
              fieldValue(name='fragment',value=["../shaders/freewrl.fs"])])])])),
...
print('Self-test diagnostics for freewrlflowers.py:')
...
print("python freewrlflowers.py load and self-test diagnostics complete.")

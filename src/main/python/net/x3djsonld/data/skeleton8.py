...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(content='skeleton8.x3d',name='title'),
    meta(name='identifier',content='http://www.web3d.org/x3d/content/examples/HumanoidAnimation/skeleton8.x3d'),
            ...
            HAnimJoint(DEF='hanim_l_knee',name='l_knee',center=(0.1040,0.4867,0.0308),ulimit=[0,0,0],llimit=[0,0,0],
              ...
              HAnimJoint(DEF='hanim_l_talocrural',name='l_talocrural',center=(0.1101,0.0656,-0.0736),ulimit=[0,0,0],llimit=[0,0,0],
                ...
                HAnimSegment(DEF='hanim_l_talus',name='l_talus',
                  ...
                  Shape(
                    geometry=LineSet(vertexCount=[2],
                      coord=Coordinate(point=[(0.1101,0.0656,-0.0736),(0.0,-0.3,0)]),
                      #  from l_talocrural to l_talocalcaneonavicular 
                      color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                  Shape(
                    geometry=LineSet(vertexCount=[2],
                      coord=Coordinate(point=[(0.1101,0.0656,-0.0736),(0.2,0.3,0)]),
                      #  from l_talocrural to l_calcaneocuboid 
                      color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                HAnimJoint(DEF='hanim_l_talocalcaneonavicular',name='l_talocalcaneonavicular',center=(0.0,-0.3,0),ulimit=[0,0,0],llimit=[0,0,0],
                  children=[
                  HAnimSegment(DEF='hanim_l_navicular',name='l_navicular',
                    ...
                    Shape(
                      geometry=LineSet(vertexCount=[2],
                        ...
                        color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                  HAnimJoint(DEF='hanim_l_cuneonavicular_1',name='l_cuneonavicular_1',center=(-0.1,-0.45,0),ulimit=[0,0,0],llimit=[0,0,0],
                    children=[
                    HAnimSegment(DEF='hanim_l_cuneiform_1',name='l_cuneiform_1',
                      ...
                      Shape(
                        geometry=LineSet(vertexCount=[2],
                          ...
                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                    HAnimJoint(DEF='hanim_l_tarsometatarsal_1',name='l_tarsometatarsal_1',center=(-0.1,-0.6,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_l_metatarsal_1',name='l_metatarsal_1',
                        ...
                        HAnimSite(DEF='hanim_l_metatarsal_phalanx_1_pt',name='l_metatarsal_phalanx_1_pt',translation=(0,1,0),
                          ...
                          Shape(USE='HAnimSiteShape')])]),
                      HAnimJoint(DEF='hanim_l_metatarsophalangeal_1',name='l_metatarsophalangeal_1',center=(-0.1,-0.9,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_l_tarsal_proximal_phalanx_1',name='l_tarsal_proximal_phalanx_1',
                          ...
                          Shape(
                            geometry=LineSet(vertexCount=[2],
                              ...
                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                          HAnimSite(DEF='hanim_l_tarsal_distal_phalanx_1_tip',name='l_tarsal_distal_phalanx_1_tip',translation=(-0.1,-1.05,0),
                            children=[
                            TouchSensor(description='HAnimSite l_tarsal_distal_phalanx_1_tip'),
                            Shape(USE='HAnimSiteShape')])]),
                        HAnimJoint(DEF='hanim_l_tarsal_interphalangeal_1',name='l_tarsal_interphalangeal_1',center=(-0.1,-1.05,0),ulimit=[0,0,0],llimit=[0,0,0])])])]),
                  HAnimJoint(DEF='hanim_l_cuneonavicular_2',name='l_cuneonavicular_2',center=(0.0,-0.45,0),ulimit=[0,0,0],llimit=[0,0,0],
                    children=[
                    HAnimSegment(DEF='hanim_l_cuneiform_2',name='l_cuneiform_2',
                      ...
                      Shape(
                        geometry=LineSet(vertexCount=[2],
                          ...
                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                    HAnimJoint(DEF='hanim_l_tarsometatarsal_2',name='l_tarsometatarsal_2',center=(0.05,-0.6,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_l_metatarsal_2',name='l_metatarsal_2',
                        ...
                        Shape(
                          geometry=LineSet(vertexCount=[2],
                            ...
                            color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                      HAnimJoint(DEF='hanim_l_metatarsophalangeal_2',name='l_metatarsophalangeal_2',center=(0.05,-0.9,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_l_tarsal_proximal_phalanx_2',name='l_tarsal_proximal_phalanx_2',
                          ...
                          Shape(
                            geometry=LineSet(vertexCount=[2],
                              ...
                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                        HAnimJoint(DEF='hanim_l_tarsal_proximal_interphalangeal_2',name='l_tarsal_proximal_interphalangeal_2',center=(0.05,-1.05,0),ulimit=[0,0,0],llimit=[0,0,0],
                          children=[
                          HAnimSegment(DEF='hanim_l_tarsal_middle_phalanx_2',name='l_tarsal_middle_phalanx_2',
                            ...
                            Shape(
                              geometry=LineSet(vertexCount=[2],
                                ...
                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                            HAnimSite(DEF='hanim_l_tarsal_distal_phalanx_2_tip',name='l_tarsal_distal_phalanx_2_tip',translation=(0.05,-1.12,0),
                              children=[
                              TouchSensor(description='HAnimSite l_tarsal_distal_phalanx_2_tip'),
                              Shape(USE='HAnimSiteShape')])]),
                          HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_2',name='l_tarsal_distal_interphalangeal_2',center=(0.05,-1.12,0),ulimit=[0,0,0],llimit=[0,0,0])])])])]),
                  HAnimJoint(DEF='hanim_l_cuneonavicular_3',name='l_cuneonavicular_3',center=(0.1,-0.4,0),ulimit=[0,0,0],llimit=[0,0,0],
                    children=[
                    HAnimSegment(DEF='hanim_l_cuneiform_3',name='l_cuneiform_3',
                      ...
                      Shape(
                        geometry=LineSet(vertexCount=[2],
                          ...
                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                    HAnimJoint(DEF='hanim_l_tarsometatarsal_3',name='l_tarsometatarsal_3',center=(0.15,-0.6,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_l_metatarsal_3',name='l_metatarsal_3',
                        ...
                        Shape(
                          geometry=LineSet(vertexCount=[2],
                            ...
                            color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                      HAnimJoint(DEF='hanim_l_metatarsophalangeal_3',name='l_metatarsophalangeal_3',center=(0.15,-0.9,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_l_tarsal_proximal_phalanx_3',name='l_tarsal_proximal_phalanx_3',
                          ...
                          Shape(
                            geometry=LineSet(vertexCount=[2],
                              ...
                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                        HAnimJoint(DEF='hanim_l_tarsal_proximal_interphalangeal_3',name='l_tarsal_proximal_interphalangeal_3',center=(0.15,-1.05,0),ulimit=[0,0,0],llimit=[0,0,0],
                          children=[
                          HAnimSegment(DEF='hanim_l_tarsal_middle_phalanx_3',name='l_tarsal_middle_phalanx_3',
                            ...
                            Shape(
                              geometry=LineSet(vertexCount=[2],
                                ...
                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                            HAnimSite(DEF='hanim_l_tarsal_distal_phalanx_3_tip',name='l_tarsal_distal_phalanx_3_tip',translation=(0.15,-1.13,0),
                              children=[
                              TouchSensor(description='HAnimSite l_tarsal_distal_phalanx_3_tip'),
                              Shape(USE='HAnimSiteShape')])]),
                          HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_3',name='l_tarsal_distal_interphalangeal_3',center=(0.15,-1.13,0),ulimit=[0,0,0],llimit=[0,0,0])])])])])]),
                HAnimJoint(DEF='hanim_l_calcaneocuboid',name='l_calcaneocuboid',center=(0.2,0.3,0),ulimit=[0,0,0],llimit=[0,0,0],
                  children=[
                  HAnimSegment(DEF='hanim_l_calcaneus',name='l_calcaneus',
                    ...
                    Shape(
                      geometry=LineSet(vertexCount=[2],
                        ...
                        color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                  HAnimJoint(DEF='hanim_l_transversetarsal',name='l_transversetarsal',center=(0.21,-0.3,0),ulimit=[0,0,0],llimit=[0,0,0],
                    children=[
                    HAnimSegment(DEF='hanim_l_cuboid',name='l_cuboid',
                      ...
                      Shape(
                        geometry=LineSet(vertexCount=[2],
                          ...
                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                    HAnimJoint(DEF='hanim_l_tarsometatarsal_4',name='l_tarsometatarsal_4',center=(0.25,-0.58,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_l_metatarsal_4',name='l_metatarsal_4',
                        ...
                        Shape(
                          geometry=LineSet(vertexCount=[2],
                            ...
                            color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                      HAnimJoint(DEF='hanim_l_metatarsophalangeal_4',name='l_metatarsophalangeal_4',center=(0.25,-0.87,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_l_tarsal_proximal_phalanx_4',name='l_tarsal_proximal_phalanx_4',
                          ...
                          Shape(
                            geometry=LineSet(vertexCount=[2],
                              ...
                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                        HAnimJoint(DEF='hanim_l_tarsal_proximal_interphalangeal_4',name='l_tarsal_proximal_interphalangeal_4',center=(0.25,-1.0,0),ulimit=[0,0,0],llimit=[0,0,0],
                          children=[
                          HAnimSegment(DEF='hanim_l_tarsal_middle_phalanx_4',name='l_tarsal_middle_phalanx_4',
                            ...
                            Shape(
                              geometry=LineSet(vertexCount=[2],
                                ...
                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                            HAnimSite(DEF='hanim_l_tarsal_distal_phalanx_4_tip',name='l_tarsal_distal_phalanx_4_tip',translation=(0.25,-1.1,0),
                              children=[
                              TouchSensor(description='HAnimSite l_tarsal_distal_phalanx_4_tip'),
                              Shape(USE='HAnimSiteShape')])]),
                          HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_4',name='l_tarsal_distal_interphalangeal_4',center=(0.25,-1.1,0),ulimit=[0,0,0],llimit=[0,0,0])])])]),
                    HAnimJoint(DEF='hanim_l_tarsometatarsal_5',name='l_tarsometatarsal_5',center=(0.33,-0.52,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_l_metatarsal_5',name='l_metatarsal_5',
                        ...
                        HAnimSite(DEF='hanim_l_metatarsal_phalanx_5_pt',name='l_metatarsal_phalanx_5_pt',translation=(0,1,0),
                          ...
                          Shape(USE='HAnimSiteShape')])]),
                      HAnimJoint(DEF='hanim_l_metatarsophalangeal_5',name='l_metatarsophalangeal_5',center=(0.34,-0.8,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_l_tarsal_proximal_phalanx_5',name='l_tarsal_proximal_phalanx_5',
                          ...
                          Shape(
                            geometry=LineSet(vertexCount=[2],
                              ...
                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                        HAnimJoint(DEF='hanim_l_tarsal_proximal_interphalangeal_5',name='l_tarsal_proximal_interphalangeal_5',center=(0.34,-0.95,0),ulimit=[0,0,0],llimit=[0,0,0],
                          children=[
                          HAnimSegment(DEF='hanim_l_tarsal_middle_phalanx_5',name='l_tarsal_middle_phalanx_5',
                            ...
                            Shape(
                              geometry=LineSet(vertexCount=[2],
                                ...
                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                            HAnimSite(DEF='hanim_l_tarsal_distal_phalanx_5_tip',name='l_tarsal_distal_phalanx_5_tip',translation=(0.34,-1.05,0),
                              children=[
                              TouchSensor(description='HAnimSite l_tarsal_distal_phalanx_5_tip'),
                              Shape(USE='HAnimSiteShape')])]),
                          HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_5',name='l_tarsal_distal_interphalangeal_5',center=(0.34,-1.05,0),ulimit=[0,0,0],llimit=[0,0,0])])])])])])])])]),
            ...
            HAnimJoint(DEF='hanim_r_knee',name='r_knee',center=(-0.0867,0.4913,0.0318),ulimit=[0,0,0],llimit=[0,0,0],
              ...
              HAnimJoint(DEF='hanim_r_talocrural',name='r_talocrural',center=(-0.0801,0.0712,-0.0766),ulimit=[0,0,0],llimit=[0,0,0],
                ...
                HAnimSegment(DEF='hanim_r_talus',name='r_talus',
                  ...
                  Shape(
                    geometry=LineSet(vertexCount=[2],
                      coord=Coordinate(point=[(-0.0801,0.0712,-0.0766),(0.0,-0.3,0)]),
                      #  from r_talocrural to r_talocalcaneonavicular 
                      color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                  Shape(
                    geometry=LineSet(vertexCount=[2],
                      coord=Coordinate(point=[(-0.0801,0.0712,-0.0766),(-0.2,0.3,0)]),
                      #  from r_talocrural to r_calcaneocuboid 
                      color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                HAnimJoint(DEF='hanim_r_talocalcaneonavicular',name='r_talocalcaneonavicular',center=(0.0,-0.3,0),ulimit=[0,0,0],llimit=[0,0,0],
                  children=[
                  HAnimSegment(DEF='hanim_r_navicular',name='r_navicular',
                    ...
                    Shape(
                      geometry=LineSet(vertexCount=[2],
                        ...
                        color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                  HAnimJoint(DEF='hanim_r_cuneonavicular_1',name='r_cuneonavicular_1',center=(0.1,-0.45,0),ulimit=[0,0,0],llimit=[0,0,0],
                    children=[
                    HAnimSegment(DEF='hanim_r_cuneiform_1',name='r_cuneiform_1',
                      ...
                      Shape(
                        geometry=LineSet(vertexCount=[2],
                          ...
                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                    HAnimJoint(DEF='hanim_r_tarsometatarsal_1',name='r_tarsometatarsal_1',center=(0.1,-0.6,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_r_metatarsal_1',name='r_metatarsal_1',
                        ...
                        HAnimSite(DEF='hanim_r_metatarsal_phalanx_1_pt',name='r_metatarsal_phalanx_1_pt',translation=(0,1,0),
                          ...
                          Shape(USE='HAnimSiteShape')])]),
                      HAnimJoint(DEF='hanim_r_metatarsophalangeal_1',name='r_metatarsophalangeal_1',center=(0.1,-0.9,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_r_tarsal_proximal_phalanx_1',name='r_tarsal_proximal_phalanx_1',
                          ...
                          HAnimSite(DEF='hanim_r_tarsal_distal_phalanx_1_tip',name='r_tarsal_distal_phalanx_1_tip',translation=(0.1,-1.05,0),
                            ...
                            Shape(USE='HAnimSiteShape')])]),
                        HAnimJoint(DEF='hanim_r_tarsal_interphalangeal_1',name='r_tarsal_interphalangeal_1',center=(0.1,-1.05,0),ulimit=[0,0,0],llimit=[0,0,0])])])]),
                  HAnimJoint(DEF='hanim_r_cuneonavicular_2',name='r_cuneonavicular_2',center=(0.0,-0.45,0),ulimit=[0,0,0],llimit=[0,0,0],
                    children=[
                    HAnimSegment(DEF='hanim_r_cuneiform_2',name='r_cuneiform_2',
                      ...
                      Shape(
                        geometry=LineSet(vertexCount=[2],
                          ...
                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                    HAnimJoint(DEF='hanim_r_tarsometatarsal_2',name='r_tarsometatarsal_2',center=(-0.05,-0.6,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_r_metatarsal_2',name='r_metatarsal_2',
                        ...
                        Shape(
                          geometry=LineSet(vertexCount=[2],
                            ...
                            color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                      HAnimJoint(DEF='hanim_r_metatarsophalangeal_2',name='r_metatarsophalangeal_2',center=(-0.05,-0.9,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_r_tarsal_proximal_phalanx_2',name='r_tarsal_proximal_phalanx_2',
                          ...
                          Shape(
                            geometry=LineSet(vertexCount=[2],
                              ...
                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                        HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_2',name='r_tarsal_proximal_interphalangeal_2',center=(-0.05,-1.05,0),ulimit=[0,0,0],llimit=[0,0,0],
                          children=[
                          HAnimSegment(DEF='hanim_r_tarsal_middle_phalanx_2',name='r_tarsal_middle_phalanx_2',
                            ...
                            HAnimSite(DEF='hanim_r_tarsal_distal_phalanx_2_tip',name='r_tarsal_distal_phalanx_2_tip',translation=(-0.05,-1.12,0),
                              ...
                              Shape(USE='HAnimSiteShape')])]),
                          HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_2',name='r_tarsal_distal_interphalangeal_2',center=(-0.05,-1.12,0),ulimit=[0,0,0],llimit=[0,0,0])])])])]),
                  HAnimJoint(DEF='hanim_r_cuneonavicular_3',name='r_cuneonavicular_3',center=(-0.1,-0.4,0),ulimit=[0,0,0],llimit=[0,0,0],
                    children=[
                    HAnimSegment(DEF='hanim_r_cuneiform_3',name='r_cuneiform_3',
                      ...
                      Shape(
                        geometry=LineSet(vertexCount=[2],
                          ...
                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                    HAnimJoint(DEF='hanim_r_tarsometatarsal_3',name='r_tarsometatarsal_3',center=(-0.15,-0.6,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_r_metatarsal_3',name='r_metatarsal_3',
                        ...
                        Shape(
                          geometry=LineSet(vertexCount=[2],
                            ...
                            color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                      HAnimJoint(DEF='hanim_r_metatarsophalangeal_3',name='r_metatarsophalangeal_3',center=(-0.15,-0.9,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_r_tarsal_proximal_phalanx_3',name='r_tarsal_proximal_phalanx_3',
                          ...
                          Shape(
                            geometry=LineSet(vertexCount=[2],
                              ...
                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                        HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_3',name='r_tarsal_proximal_interphalangeal_3',center=(-0.15,-1.05,0),ulimit=[0,0,0],llimit=[0,0,0],
                          children=[
                          HAnimSegment(DEF='hanim_r_tarsal_middle_phalanx_3',name='r_tarsal_middle_phalanx_3',
                            ...
                            HAnimSite(DEF='hanim_r_tarsal_distal_phalanx_3_tip',name='r_tarsal_distal_phalanx_3_tip',translation=(-0.15,-1.13,0),
                              ...
                              Shape(USE='HAnimSiteShape')])]),
                          HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_3',name='r_tarsal_distal_interphalangeal_3',center=(-0.15,-1.13,0),ulimit=[0,0,0],llimit=[0,0,0])])])])])]),
                HAnimJoint(DEF='hanim_r_calcaneocuboid',name='r_calcaneocuboid',center=(-0.2,0.3,0),ulimit=[0,0,0],llimit=[0,0,0],
                  children=[
                  HAnimSegment(DEF='hanim_r_calcaneus',name='r_calcaneus',
                    ...
                    Shape(
                      geometry=LineSet(vertexCount=[2],
                        ...
                        color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                  HAnimJoint(DEF='hanim_r_transversetarsal',name='r_transversetarsal',center=(-0.21,-0.3,0),ulimit=[0,0,0],llimit=[0,0,0],
                    children=[
                    HAnimSegment(DEF='hanim_r_cuboid',name='r_cuboid',
                      ...
                      Shape(
                        geometry=LineSet(vertexCount=[2],
                          ...
                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                    HAnimJoint(DEF='hanim_r_tarsometatarsal_4',name='r_tarsometatarsal_4',center=(-0.25,-0.58,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_r_metatarsal_4',name='r_metatarsal_4',
                        ...
                        Shape(
                          geometry=LineSet(vertexCount=[2],
                            ...
                            color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                      HAnimJoint(DEF='hanim_r_metatarsophalangeal_4',name='r_metatarsophalangeal_4',center=(-0.25,-0.87,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_r_tarsal_proximal_phalanx_4',name='r_tarsal_proximal_phalanx_4',
                          ...
                          Shape(
                            geometry=LineSet(vertexCount=[2],
                              ...
                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                        HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_4',name='r_tarsal_proximal_interphalangeal_4',center=(-0.25,-1.0,0),ulimit=[0,0,0],llimit=[0,0,0],
                          children=[
                          HAnimSegment(DEF='hanim_r_tarsal_middle_phalanx_4',name='r_tarsal_middle_phalanx_4',
                            ...
                            HAnimSite(DEF='hanim_r_tarsal_distal_phalanx_4_tip',name='r_tarsal_distal_phalanx_4_tip',translation=(-0.25,-1.1,0),
                              ...
                              Shape(USE='HAnimSiteShape')])]),
                          HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_4',name='r_tarsal_distal_interphalangeal_4',center=(-0.25,-1.1,0),ulimit=[0,0,0],llimit=[0,0,0])])])]),
                    HAnimJoint(DEF='hanim_r_tarsometatarsal_5',name='r_tarsometatarsal_5',center=(-0.33,-0.52,0),ulimit=[0,0,0],llimit=[0,0,0],
                      children=[
                      HAnimSegment(DEF='hanim_r_metatarsal_5',name='r_metatarsal_5',
                        ...
                        HAnimSite(DEF='hanim_r_metatarsal_phalanx_5_pt',name='r_metatarsal_phalanx_5_pt',translation=(0,1,0),
                          ...
                          Shape(USE='HAnimSiteShape')])]),
                      HAnimJoint(DEF='hanim_r_metatarsophalangeal_5',name='r_metatarsophalangeal_5',center=(-0.34,-0.8,0),ulimit=[0,0,0],llimit=[0,0,0],
                        children=[
                        HAnimSegment(DEF='hanim_r_tarsal_proximal_phalanx_5',name='r_tarsal_proximal_phalanx_5',
                          ...
                          Shape(
                            geometry=LineSet(vertexCount=[2],
                              ...
                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                        HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_5',name='r_tarsal_proximal_interphalangeal_5',center=(-0.34,-0.95,0),ulimit=[0,0,0],llimit=[0,0,0],
                          children=[
                          HAnimSegment(DEF='hanim_r_tarsal_middle_phalanx_5',name='r_tarsal_middle_phalanx_5',
                            ...
                            HAnimSite(DEF='hanim_r_tarsal_distal_phalanx_5_tip',name='r_tarsal_distal_phalanx_5_tip',translation=(-0.34,-1.05,0),
                              ...
                              Shape(USE='HAnimSiteShape')])]),
                          HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_5',name='r_tarsal_distal_interphalangeal_5',center=(-0.34,-1.05,0),ulimit=[0,0,0],llimit=[0,0,0])])])])])])])])])]),
                                                ...
                                                HAnimJoint(DEF='hanim_l_elbow',name='l_elbow',center=(0.2014,1.1357,-0.0682),ulimit=[0,0,0],llimit=[0,0,0],
                                                  ...
                                                  HAnimJoint(DEF='hanim_l_radiocarpal',name='l_radiocarpal',center=(0.1984,0.8663,-0.0583),ulimit=[0,0,0],llimit=[0,0,0],
                                                    ...
                                                    HAnimSegment(DEF='hanim_l_carpal',name='l_carpal',
                                                      ...
                                                      Shape(
                                                        geometry=LineSet(vertexCount=[2],
                                                          coord=Coordinate(point=[(0.1984,0.8663,-0.0583),(0.1,0.1,0)]),
                                                          #  from l_radiocarpal to l_midcarpal_2 
                                                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                                                      Shape(
                                                        geometry=LineSet(vertexCount=[2],
                                                          coord=Coordinate(point=[(0.1984,0.8663,-0.0583),(0.0,0.07,0)]),
                                                      ...
                                                      HAnimSegment(DEF='hanim_l_trapezium',name='l_trapezium',
                                                        ...
                                                        Shape(
                                                          geometry=LineSet(vertexCount=[1],
                                                            coord=Coordinate(point=[(0.2,0.15,0)]),
                                                            #  from l_midcarpal_1 to l_carpometacarpal_1 
                                                            color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                      HAnimJoint(DEF='hanim_l_carpometacarpal_1',name='l_carpometacarpal_1',center=(0.2,0.15,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_metacarpal_1',name='l_metacarpal_1',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_l_metacarpophalangeal_1',name='l_metacarpophalangeal_1',center=(0.3,0.3,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_1',name='l_carpal_proximal_phalanx_1',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                                                            HAnimSite(DEF='hanim_l_carpal_distal_phalanx_1_tip',name='l_carpal_distal_phalanx_1_tip',translation=(0.35,0.4,0),
                                                              children=[
                                                              TouchSensor(description='HAnimSite l_carpal_distal_phalanx_1_tip'),
                                                              Shape(USE='HAnimSiteShape')])]),
                                                          HAnimJoint(DEF='hanim_l_carpal_interphalangeal_1',name='l_carpal_interphalangeal_1',center=(0.35,0.4,0),ulimit=[0,0,0],llimit=[0,0,0])])])]),
                                                    HAnimJoint(DEF='hanim_l_midcarpal_2',name='l_midcarpal_2',center=(0.1,0.1,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_l_trapezoid',name='l_trapezoid',
                                                        ...
                                                        HAnimSite(DEF='hanim_l_metacarpal_phalanx_2_pt',name='l_metacarpal_phalanx_2_pt',translation=(0.2009,0.8139,-0.0237),
                                                          ...
                                                          Shape(USE='HAnimSiteShape')])]),
                                                      HAnimJoint(DEF='hanim_l_carpometacarpal_2',name='l_carpometacarpal_2',center=(0.1,0.2,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_metacarpal_2',name='l_metacarpal_2',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_l_metacarpophalangeal_2',name='l_metacarpophalangeal_2',center=(0.15,0.5,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_2',name='l_carpal_proximal_phalanx_2',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                          HAnimJoint(DEF='hanim_l_carpal_proximal_interphalangeal_2',name='l_carpal_proximal_interphalangeal_2',center=(0.2,0.7,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_l_carpal_middle_phalanx_2',name='l_carpal_middle_phalanx_2',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_l_carpal_distal_phalanx_2_tip',name='l_carpal_distal_phalanx_2_tip',translation=(0.24,0.87,0),
                                                                children=[
                                                              ...
                                                              HAnimSite(DEF='hanim_l_dactylion_pt',name='l_dactylion_pt',translation=(0.2056,0.6743,-0.0482),
                                                                ...
                                                                Shape(USE='HAnimSiteShape')])]),
                                                            HAnimJoint(DEF='hanim_l_carpal_distal_interphalangeal_2',name='l_carpal_distal_interphalangeal_2',center=(0.24,0.87,0),ulimit=[0,0,0],llimit=[0,0,0])])])])]),
                                                    HAnimJoint(DEF='hanim_l_midcarpal_3',name='l_midcarpal_3',center=(0.0,0.07,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_l_capitate',name='l_capitate',
                                                        ...
                                                        HAnimSite(DEF='hanim_l_metacarpal_phalanx_3_pt',name='l_metacarpal_phalanx_3_pt',translation=(0,1,0),
                                                          ...
                                                          Shape(USE='HAnimSiteShape')])]),
                                                      HAnimJoint(DEF='hanim_l_carpometacarpal_3',name='l_carpometacarpal_3',center=(0.0,0.2,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_metacarpal_3',name='l_metacarpal_3',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_l_metacarpophalangeal_3',name='l_metacarpophalangeal_3',center=(0.03,0.5,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_3',name='l_carpal_proximal_phalanx_3',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                          HAnimJoint(DEF='hanim_l_carpal_proximal_interphalangeal_3',name='l_carpal_proximal_interphalangeal_3',center=(0.05,0.75,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_l_carpal_middle_phalanx_3',name='l_carpal_middle_phalanx_3',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_l_carpal_distal_phalanx_3_tip',name='l_carpal_distal_phalanx_3_tip',translation=(0.08,0.96,0),
                                                                children=[
                                                                TouchSensor(description='HAnimSite l_carpal_distal_phalanx_3_tip'),
                                                                Shape(USE='HAnimSiteShape')])]),
                                                            HAnimJoint(DEF='hanim_l_carpal_distal_interphalangeal_3',name='l_carpal_distal_interphalangeal_3',center=(0.08,0.96,0),ulimit=[0,0,0],llimit=[0,0,0])])])])]),
                                                    HAnimJoint(DEF='hanim_l_midcarpal_4_5',name='l_midcarpal_4_5',center=(-0.1,0.1,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_l_hamate',name='l_hamate',
                                                        ...
                                                        HAnimSite(DEF='hanim_l_metacarpal_phalanx_5_pt',name='l_metacarpal_phalanx_5_pt',translation=(0.1929,0.7860,-0.1122),
                                                          ...
                                                          Shape(USE='HAnimSiteShape')])]),
                                                      HAnimJoint(DEF='hanim_l_carpometacarpal_4',name='l_carpometacarpal_4',center=(-0.1,0.2,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_metacarpal_4',name='l_metacarpal_4',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_l_metacarpophalangeal_4',name='l_metacarpophalangeal_4',center=(-0.1,0.47,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_4',name='l_carpal_proximal_phalanx_4',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                          HAnimJoint(DEF='hanim_l_carpal_proximal_interphalangeal_4',name='l_carpal_proximal_interphalangeal_4',center=(-0.1,0.7,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_l_carpal_middle_phalanx_4',name='l_carpal_middle_phalanx_4',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_l_carpal_distal_phalanx_4_tip',name='l_carpal_distal_phalanx_4_tip',translation=(-0.1,0.93,0),
                                                                children=[
                                                                TouchSensor(description='HAnimSite l_carpal_distal_phalanx_4_tip'),
                                                                Shape(USE='HAnimSiteShape')])]),
                                                            HAnimJoint(DEF='hanim_l_carpal_distal_interphalangeal_4',name='l_carpal_distal_interphalangeal_4',center=(-0.1,0.93,0),ulimit=[0,0,0],llimit=[0,0,0])])])]),
                                                      HAnimJoint(DEF='hanim_l_carpometacarpal_5',name='l_carpometacarpal_5',center=(-0.15,0.17,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_l_metacarpal_5',name='l_metacarpal_5',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_l_metacarpophalangeal_5',name='l_metacarpophalangeal_5',center=(-0.2,0.4,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_l_carpal_proximal_phalanx_5',name='l_carpal_proximal_phalanx_5',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                          HAnimJoint(DEF='hanim_l_carpal_proximal_interphalangeal_5',name='l_carpal_proximal_interphalangeal_5',center=(-0.23,0.63,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_l_carpal_middle_phalanx_5',name='l_carpal_middle_phalanx_5',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_l_carpal_distal_phalanx_5_tip',name='l_carpal_distal_phalanx_5_tip',translation=(-0.25,0.79,0),
                                                                children=[
                                                                TouchSensor(description='HAnimSite l_carpal_distal_phalanx_5_tip'),
                                                                Shape(USE='HAnimSiteShape')])]),
                                                            HAnimJoint(DEF='hanim_l_carpal_distal_interphalangeal_5',name='l_carpal_distal_interphalangeal_5',center=(-0.25,0.79,0),ulimit=[0,0,0],llimit=[0,0,0])])])])])])])])])]),
                                                ...
                                                HAnimJoint(DEF='hanim_r_elbow',name='r_elbow',center=(-0.1949,1.1388,-0.0620),ulimit=[0,0,0],llimit=[0,0,0],
                                                  ...
                                                  HAnimJoint(DEF='hanim_r_radiocarpal',name='r_radiocarpal',center=(-0.1959,0.8694,-0.0521),ulimit=[0,0,0],llimit=[0,0,0],
                                                    ...
                                                    HAnimSegment(DEF='hanim_r_carpal',name='r_carpal',
                                                      ...
                                                      Shape(
                                                        geometry=LineSet(vertexCount=[2],
                                                          coord=Coordinate(point=[(-0.1959,0.8694,-0.0521),(0.0,0.07,0)]),
                                                          #  from r_radiocarpal to r_midcarpal_3 
                                                          color=ColorRGBA(USE='HAnimSegmentLineColorRGBA'))),
                                                      Shape(
                                                        geometry=LineSet(vertexCount=[2],
                                                          coord=Coordinate(point=[(-0.1959,0.8694,-0.0521),(0.1,0.1,0)]),
                                                      ...
                                                      HAnimSegment(DEF='hanim_r_trapezium',name='r_trapezium',
                                                        ...
                                                        Shape(
                                                          geometry=LineSet(vertexCount=[1],
                                                            ...
                                                            color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                      HAnimJoint(DEF='hanim_r_carpometacarpal_1',name='r_carpometacarpal_1',center=(-0.2,0.15,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_metacarpal_1',name='r_metacarpal_1',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_r_metacarpophalangeal_1',name='r_metacarpophalangeal_1',center=(-0.3,0.3,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_1',name='r_carpal_proximal_phalanx_1',
                                                            ...
                                                            HAnimSite(DEF='hanim_r_carpal_distal_phalanx_1_tip',name='r_carpal_distal_phalanx_1_tip',translation=(-0.35,0.4,0),
                                                              ...
                                                              Shape(USE='HAnimSiteShape')])]),
                                                          HAnimJoint(DEF='hanim_r_carpal_interphalangeal_1',name='r_carpal_interphalangeal_1',center=(-0.35,0.4,0),ulimit=[0,0,0],llimit=[0,0,0])])])]),
                                                    HAnimJoint(DEF='hanim_r_midcarpal_2',name='r_midcarpal_2',center=(0,1,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                      ...
                                                      HAnimSegment(DEF='hanim_r_trapezoid',name='r_trapezoid',
                                                        ...
                                                        Shape(
                                                          geometry=LineSet(vertexCount=[1],
                                                            coord=Coordinate(point=[(-0.1,0.2,0)]),
                                                        ...
                                                        HAnimSite(DEF='hanim_r_metacarpal_phalanx_2_pt',name='r_metacarpal_phalanx_2_pt',translation=(-0.1977,0.8169,-0.0177),
                                                          ...
                                                          Shape(USE='HAnimSiteShape')])]),
                                                      HAnimJoint(DEF='hanim_r_carpometacarpal_2',name='r_carpometacarpal_2',center=(-0.1,0.2,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_metacarpal_2',name='r_metacarpal_2',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_r_metacarpophalangeal_2',name='r_metacarpophalangeal_2',center=(-0.15,0.5,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_2',name='r_carpal_proximal_phalanx_2',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                          HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_2',name='r_carpal_proximal_interphalangeal_2',center=(-0.2,0.7,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_r_carpal_middle_phalanx_2',name='r_carpal_middle_phalanx_2',
                                                              ...
                                                              HAnimSite(DEF='hanim_r_dactylion_pt',name='r_dactylion_pt',translation=(-0.1941,0.6772,-0.0423),
                                                                ...
                                                                Shape(USE='HAnimSiteShape')])]),
                                                            HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_2',name='r_carpal_distal_interphalangeal_2',center=(-0.24,0.87,0),ulimit=[0,0,0],llimit=[0,0,0])])])])]),
                                                    HAnimJoint(DEF='hanim_r_midcarpal_3',name='r_midcarpal_3',center=(0.0,0.07,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_r_capitate',name='r_capitate',
                                                        ...
                                                        HAnimSite(DEF='hanim_r_metacarpal_phalanx_3_pt',name='r_metacarpal_phalanx_3_pt',translation=(0,1,0),
                                                          ...
                                                          Shape(USE='HAnimSiteShape')])]),
                                                      HAnimJoint(DEF='hanim_r_carpometacarpal_3',name='r_carpometacarpal_3',center=(0.0,0.2,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_metacarpal_3',name='r_metacarpal_3',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_r_metacarpophalangeal_3',name='r_metacarpophalangeal_3',center=(-0.03,0.5,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_3',name='r_carpal_proximal_phalanx_3',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                          HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_3',name='r_carpal_proximal_interphalangeal_3',center=(-0.05,0.75,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_r_carpal_middle_phalanx_3',name='r_carpal_middle_phalanx_3',
                                                              ...
                                                              HAnimSite(DEF='hanim_r_carpal_distal_phalanx_3_tip',name='r_carpal_distal_phalanx_3_tip',translation=(-0.08,0.96,0),
                                                                ...
                                                                Shape(USE='HAnimSiteShape')])]),
                                                            HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_3',name='r_carpal_distal_interphalangeal_3',center=(-0.08,0.96,0),ulimit=[0,0,0],llimit=[0,0,0])])])])]),
                                                    HAnimJoint(DEF='hanim_r_midcarpal_4_5',name='r_midcarpal_4_5',center=(0.1,0.1,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                      children=[
                                                      HAnimSegment(DEF='hanim_r_hamate',name='r_hamate',
                                                        ...
                                                        HAnimSite(DEF='hanim_r_metacarpal_phalanx_5_pt',name='r_metacarpal_phalanx_5_pt',translation=(-0.1929,0.7890,-0.1064),
                                                          ...
                                                          Shape(USE='HAnimSiteShape')])]),
                                                      HAnimJoint(DEF='hanim_r_carpometacarpal_4',name='r_carpometacarpal_4',center=(0.1,0.2,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_metacarpal_4',name='r_metacarpal_4',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_r_metacarpophalangeal_4',name='r_metacarpophalangeal_4',center=(0.1,0.47,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_4',name='r_carpal_proximal_phalanx_4',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                          HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_4',name='r_carpal_proximal_interphalangeal_4',center=(0.1,0.7,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_r_carpal_middle_phalanx_4',name='r_carpal_middle_phalanx_4',
                                                              ...
                                                              HAnimSite(DEF='hanim_r_carpal_distal_phalanx_4_tip',name='r_carpal_distal_phalanx_4_tip',translation=(0.1,0.93,0),
                                                                ...
                                                                Shape(USE='HAnimSiteShape')])]),
                                                            HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_4',name='r_carpal_distal_interphalangeal_4',center=(0.1,0.93,0),ulimit=[0,0,0],llimit=[0,0,0])])])]),
                                                      HAnimJoint(DEF='hanim_r_carpometacarpal_5',name='r_carpometacarpal_5',center=(0.15,0.17,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                        children=[
                                                        HAnimSegment(DEF='hanim_r_metacarpal_5',name='r_metacarpal_5',
                                                          ...
                                                          Shape(
                                                            geometry=LineSet(vertexCount=[2],
                                                              ...
                                                              color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                        HAnimJoint(DEF='hanim_r_metacarpophalangeal_5',name='r_metacarpophalangeal_5',center=(0.2,0.4,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                          children=[
                                                          HAnimSegment(DEF='hanim_r_carpal_proximal_phalanx_5',name='r_carpal_proximal_phalanx_5',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSegmentLineColorRGBA')))]),
                                                          HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_5',name='r_carpal_proximal_interphalangeal_5',center=(0.23,0.63,0),ulimit=[0,0,0],llimit=[0,0,0],
                                                            children=[
                                                            HAnimSegment(DEF='hanim_r_carpal_middle_phalanx_5',name='r_carpal_middle_phalanx_5',
                                                              ...
                                                              HAnimSite(DEF='hanim_r_carpal_distal_phalanx_5_tip',name='r_carpal_distal_phalanx_5_tip',translation=(0.25,0.79,0),
                                                                ...
                                                                Shape(USE='HAnimSiteShape')])]),
                                                            HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_5',name='r_carpal_distal_interphalangeal_5',center=(0.25,0.79,0),ulimit=[0,0,0],llimit=[0,0,0])])])])])])])])])])])])])])])])])])])])])])])])])])])])],
      joints=[
...
print('Self-test diagnostics for skeleton8.py:')
...
print("python skeleton8.py load and self-test diagnostics complete.")

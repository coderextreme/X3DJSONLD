    ...
    Transform(
      ...
      ParticleSystem(geometryType='GEOMETRY',maxParticles=20,
        ...
        appearance=Appearance(
          ...
          shaders=[
          ComposedShader(DEF='fw',language='GLSL',
            field=[
            field(accessType='inputOutput',name='chromaticDispertion',type='SFVec3f',value=(0.98,1,1.033)),
            ...
            parts=[
            ShaderPart(url=["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs"]),
            ShaderPart(type='FRAGMENT',url=["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"])])])),
      Script(DEF='Animate',
        field=[
...
""")]),
    ...
    ROUTE(fromField='a',fromNode='Animate',toField='a',toNode='fw'),
    ROUTE(fromField='b',fromNode='Animate',toField='b',toNode='fw'),
    ROUTE(fromField='c',fromNode='Animate',toField='c',toNode='fw'),
    ROUTE(fromField='d',fromNode='Animate',toField='d',toNode='fw'),
    ROUTE(fromField='pdelta',fromNode='Animate',toField='pdelta',toNode='fw'),
    ROUTE(fromField='tdelta',fromNode='Animate',toField='tdelta',toNode='fw')])
) # X3D model complete

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(content='skeleton9original.x3d',name='title'),
    meta(name='identifier',content='http://www.web3d.org/x3d/content/examples/HumanoidAnimation/skeleton9original.x3d'),
...
print('Self-test diagnostics for skeleton9original.py:')
...
print("python skeleton9original.py load and self-test diagnostics complete.")

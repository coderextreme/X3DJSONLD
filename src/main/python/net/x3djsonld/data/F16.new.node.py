...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='F16.x3d',name='title'),
    meta(content='F-16, The Fighting Falcon, Turkish Air Force (TUAF), Turkey',name='description'),
    ...
    meta(content='"Drawing.jpg" "../../../Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Drawing.jpg" "https://savage.nps.edu/Savage/AircraftFixedWing/F16-FightingFalcon-Turkey/Drawing.jpg"',name='drawing'),
  ...
  Scene=Scene(
    ...
    Transform(DEF='F16Transform',
      ...
      Transform(DEF='SeatTransform',rotation=(-1,0,0,-0.1),scale=(0.9,0.9,0.9),translation=(0,0,-8.3),
        children=[
      ...
      Transform(DEF='FrontWheelTransform',center=(0,2.5,0),rotation=(-1,0,0,1.92),translation=(0.7,-5.2,-6.5),
      ...
      Transform(DEF='RearLeftWheelTransform',center=(0,2.5,0),rotation=(1,0,1,1.92),translation=(-2.95,-5,7),
      ...
      Transform(DEF='RearRightWheelTransform',center=(0,2.5,0),rotation=(-1,0,-1,1.92),translation=(2.95,-5,7),
        #  Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel) 
        children=[
      ...
      Transform(DEF='CockpitButtonsTransform',
        children=[
        Transform(DEF='UpButtonTransform',rotation=(1,0,0,1.57),scale=(0.008,0.008,0.008),translation=(-0.95,1.05,-10),
          children=[
          Shape(
            appearance=Appearance(
              material=Material(diffuseColor=(1,0,0),shininess=0.8)),
            geometry=Cylinder(height=1.0,radius=4.0)),
          TouchSensor(DEF='TouchSensorUp',description='click for gears up')]),
        Transform(DEF='DownButtonTransform',rotation=(1,0,0,1.57),scale=(0.008,0.008,0.008),translation=(-0.83,1.05,-10),
          children=[
          Shape(
            appearance=Appearance(
        ...
        Transform(DEF='GearUpTextTransform',scale=(0.06,0.06,0.06),translation=(-0.65,1.55,-10),
          children=[
          Shape(
            appearance=Appearance(
              material=Material(diffuseColor=(1,0,0))),
            geometry=Text(string=["RED Button","Gear Up"]))]),
        Transform(DEF='GearDownTextTransform',scale=(0.06,0.06,0.06),translation=(-0.65,1.35,-10),
          children=[
          Shape(
            appearance=Appearance(
              material=Material(diffuseColor=(1,1,0))),
            geometry=Text(length=[5.5],string=["YELLOW Button","Gear Down"]))]),
        Transform(DEF='FireButtonTransform',rotation=(1,0,0,1.57),scale=(0.008,0.008,0.008),translation=(0.52,1.6,-10),
          children=[
          Shape(
            appearance=Appearance(
              material=Material(diffuseColor=(0,0.75,0.18),shininess=0.8)),
            geometry=Cylinder(height=1.0,radius=4.0)),
          TouchSensor(DEF='FireSensor',description='click to fire')]),
        Transform(DEF='FireTextTransform',scale=(0.06,0.06,0.06),translation=(0.36,1.5,-10),
          children=[
          Shape(
            appearance=Appearance(
              material=Material(diffuseColor=(0,0.75,0.18))),
            geometry=Text(string=["Target Locked"," FIRE!..","(Green Button)"]))])]),
      ...
      Transform(DEF='NoseAntennaTransform',rotation=(1,0,0,1.57),translation=(0,-0.275,-21),
        children=[
        Shape(
          appearance=Appearance(
            material=Material(diffuseColor=(0.5,0.5,0.5),shininess=0.5)),
          geometry=Cylinder(radius=0.05))])]),
    TimeSensor(DEF='WheelUp',cycleInterval=8.0),
    OrientationInterpolator(DEF='GearUpInterpolator',key=[0,0.5,1],keyValue=[(1,0,0,0),(1,0,0,-0.79),(1,0,0,-1.92)]),
    ...
    TimeSensor(DEF='WheelDown',cycleInterval=8.0),
    OrientationInterpolator(DEF='GearDownInterpolator',key=[0,0.5,1],keyValue=[(1,0,0,-1.92),(1,0,0,-0.79),(1,0,0,0)]),
    ...
    TimeSensor(DEF='RRearUp1',cycleInterval=8.0),
    TimeSensor(DEF='RRearDown1',cycleInterval=8.0),
    OrientationInterpolator(DEF='RRearInterUp1',key=[0,0.5,1],keyValue=[(-1,0,-1,0),(-1,0,-1,0.44),(-1,0,-1,1.92)]),
    OrientationInterpolator(DEF='RRearInterDown1',key=[0,0.5,1],keyValue=[(-1,0,-1,1.92),(-1,0,-1,0.44),(-1,0,-1,0)]),
    ...
    TimeSensor(DEF='LRearUp1',cycleInterval=8.0),
    TimeSensor(DEF='LRearDown1',cycleInterval=8.0),
    OrientationInterpolator(DEF='LRearInterUp1',key=[0,0.5,1],keyValue=[(1,0,1,0),(1,0,1,0.44),(1,0,1,1.92)]),
    OrientationInterpolator(DEF='LRearInterDown1',key=[0,0.5,1],keyValue=[(1,0,1,1.92),(1,0,1,0.44),(1,0,1,0)]),
    ...
    Background(groundAngle=[1.309,1.570796],groundColor=[(0,0.3,0.7),(0,0.35,0.75),(0,0.4,0.8)],skyAngle=[1.309,1.571],skyColor=[(0,0.3,0.8),(0,0.5,1),(1,1,1)]),
    Transform(DEF='RightmostAmraamTransform',rotation=(-1,0,0,1.57),scale=(1.4,1.4,1.4),translation=(15.65,0,4.5),
      children=[
    ...
    Transform(DEF='LeftmostAmraamTransform',rotation=(-1,0,0,1.57),scale=(1.4,1.4,1.4),translation=(-15.65,0,4.5),
      children=[
      Inline(USE='Amraam')]),
    Transform(DEF='SidewinderHolderTransformRight',rotation=(0,1,0,1.57),scale=(6,3,3),translation=(9,-1.125,8),
      children=[
    ...
    Transform(DEF='SidewinderHolderTransformLeft',rotation=(0,1,0,1.57),scale=(6,3,3),translation=(-8.45,-1.125,8),
      children=[
      Inline(USE='SidewinderHolder')]),
    Transform(DEF='TurkishFlagTransformLeft',rotation=(0,-1,0,1.57),scale=(0.3,0.25,0.3),translation=(-0.01,8,19.5),
      children=[
    ...
    Transform(DEF='TurkishFlagTransformRight',rotation=(0,1,0,1.57),scale=(0.3,0.25,0.3),translation=(0.01,8,20.5),
      children=[
    ...
    Transform(DEF='AmraamHolderTransformLeft',translation=(-12,-0.176,10.7),
      children=[
    ...
    Transform(DEF='AmraamHolderTransformRight',translation=(12,-0.176,10.7),
      children=[
      Inline(USE='AmraamHolder')]),
    Transform(DEF='AmraamInnerTransformRight',rotation=(-1,0,0,1.57),scale=(1.4,1.4,1.4),translation=(12,-1.6,4.5),
      children=[
      Inline(USE='Amraam')]),
    Transform(DEF='AmraamInnerTransformLeft',rotation=(-1,0,0,1.57),scale=(1.4,1.4,1.4),translation=(-12,-1.6,4.5),
      children=[
      Inline(USE='Amraam')]),
    Transform(DEF='SidewinderTransformLeft',rotation=(-1,0,0,1.57),scale=(1.6,1.6,1.6),translation=(-8.7,-2,3.5),
      children=[
    ...
    Transform(DEF='SidewinderTransformRight',rotation=(-1,0,0,1.57),scale=(1.6,1.6,1.6),translation=(8.7,-2,3.5),
      children=[
      Inline(USE='Sidewinder')]),
    Transform(DEF='FuelTankHolderTransformLeft',rotation=(0,1,0,1.57),scale=(1.5,1.5,1.5),translation=(-4.8,-1.125,6),
      children=[
    ...
    Transform(DEF='FuelTankHolderTransformRight',rotation=(0,1,0,1.57),scale=(1.5,1.5,1.5),translation=(5.3,-1.125,6),
      children=[
      Inline(USE='FuelTankHolder')]),
    Transform(DEF='FuelTankTransformRight',rotation=(-1,0,0,1.57),scale=(1.5,1.5,1.5),translation=(5,-2.85,5.5),
      children=[
    ...
    Transform(DEF='FuelTankTransformLeft',rotation=(-1,0,0,1.57),scale=(1.5,1.5,1.5),translation=(-5,-2.85,5.5),
      children=[
      Inline(USE='FuelTank')]),
    Transform(DEF='InlineCoverOfPlaneTansform',
      children=[
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(0.25,0.25,0.25))),
        geometry=Box(size=(4.15,0.1,20)))]),
    Transform(DEF='TargetHelicopterTransform',translation=(16,-50,-500),
      children=[
    ...
    TimeSensor(DEF='FireClock',cycleInterval=8.0),
    PositionInterpolator(DEF='MissilePath',key=[0,0.1,1],keyValue=[(-15.65,0,4.5),(-15.65,-2,4.5),(16,-50,-500)]),
...
print('Self-test diagnostics for F16.py:')
...
print("python F16.py load and self-test diagnostics complete.")

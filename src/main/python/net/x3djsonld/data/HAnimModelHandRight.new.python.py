  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='hanim_Hand_Right',name='Hand_Right',loa=4,version='2.0',
      ...
      HAnimJoint(DEF='hanim_humanoid_root',name='humanoid_root',llimit=[0,0,0],ulimit=[0,0,0],
        children=[
        HAnimJoint(DEF='hanim_r_radiocarpal',name='r_radiocarpal',description='connection joint of hand to leg above',llimit=[0,0,0],ulimit=[0,0,0],
          children=[
          HAnimSegment(DEF='hanim_r_carpal',name='r_carpal',
            ...
            Shape(
              ...
              geometry=IndexedLineSet(DEF='RCToMC45',coordIndex=[0,1],
                coord=Coordinate(point=[(0,0,0),(0.1,0.1,0)])))]),
          HAnimJoint(DEF='hanim_r_midcarpal_1',name='r_midcarpal_1',center=(-0.14,0.09,0),llimit=[0,0,0],ulimit=[0,0,0],
            children=[
            ...
            HAnimJoint(DEF='hanim_r_carpometacarpal_1',name='r_carpometacarpal_1',center=(-0.2,0.15,0),llimit=[0,0,0],ulimit=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_metacarpophalangeal_1',name='r_metacarpophalangeal_1',center=(-0.3,0.3,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_carpal_interphalangeal_1',name='r_carpal_interphalangeal_1',center=(-0.35,0.4,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
          ...
          HAnimJoint(DEF='hanim_r_midcarpal_2',name='r_midcarpal_2',center=(-0.07,0.07,0),llimit=[0,0,0],ulimit=[0,0,0],
            children=[
            ...
            HAnimJoint(DEF='hanim_r_carpometacarpal_2',name='r_carpometacarpal_2',center=(-0.1,0.2,0),llimit=[0,0,0],ulimit=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_metacarpophalangeal_2',name='r_metacarpophalangeal_2',center=(-0.15,0.5,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_2',name='r_carpal_proximal_interphalangeal_2',center=(-0.2,0.7,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_2',name='r_carpal_distal_interphalangeal_2',center=(-0.24,0.87,0),llimit=[0,0,0],ulimit=[0,0,0],
                    children=[
          ...
          HAnimJoint(DEF='hanim_r_midcarpal_3',name='r_midcarpal_3',center=(0,0.07,0),llimit=[0,0,0],ulimit=[0,0,0],
            children=[
            ...
            HAnimJoint(DEF='hanim_r_carpometacarpal_3',name='r_carpometacarpal_3',center=(0,0.2,0),llimit=[0,0,0],ulimit=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_metacarpophalangeal_3',name='r_metacarpophalangeal_3',center=(-0.03,0.5,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_3',name='r_carpal_proximal_interphalangeal_3',center=(-0.05,0.75,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_3',name='r_carpal_distal_interphalangeal_3',center=(-0.08,0.96,0),llimit=[0,0,0],ulimit=[0,0,0],
                    children=[
          ...
          HAnimJoint(DEF='hanim_r_midcarpal_4_5',name='r_midcarpal_4_5',center=(0.1,0.1,0),llimit=[0,0,0],ulimit=[0,0,0],
            children=[
            ...
            HAnimJoint(DEF='hanim_r_carpometacarpal_4',name='r_carpometacarpal_4',center=(0.1,0.2,0),llimit=[0,0,0],ulimit=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_metacarpophalangeal_4',name='r_metacarpophalangeal_4',center=(0.1,0.47,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_4',name='r_carpal_proximal_interphalangeal_4',center=(0.1,0.7,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_4',name='r_carpal_distal_interphalangeal_4',center=(0.1,0.93,0),llimit=[0,0,0],ulimit=[0,0,0],
                    children=[
            ...
            HAnimJoint(DEF='hanim_r_carpometacarpal_5',name='r_carpometacarpal_5',center=(0.15,0.17,0),llimit=[0,0,0],ulimit=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_metacarpophalangeal_5',name='r_metacarpophalangeal_5',center=(0.2,0.4,0),llimit=[0,0,0],ulimit=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_carpal_proximal_interphalangeal_5',name='r_carpal_proximal_interphalangeal_5',center=(0.23,0.63,0),llimit=[0,0,0],ulimit=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_carpal_distal_interphalangeal_5',name='r_carpal_distal_interphalangeal_5',center=(0.25,0.79,0),llimit=[0,0,0],ulimit=[0,0,0],
                    children=[
...
print('Self-test diagnostics for HAnimModelHandRight.py:')
...
print("python HAnimModelHandRight.py load and self-test diagnostics complete.")

...
newModel=X3D(profile='Full',version='4.0',
  head=head(
    ...
    meta(name='title',content='variationalflowers.x3d'),
    meta(name='creator',content='John Carlson'),
    meta(name='description',content='A flower particle system'),
    meta(name='identifier',content='https://coderextreme.net/X3DJSONLD/src/main/data/variationalflowers.x3d')]),
  Scene=Scene(
    children=[
      ...
      ParticleSystem(maxParticles=20,geometryType='GEOMETRY',
        ...
        appearance=Appearance(
          ...
          ComposedShader(DEF='x_ite',language='GLSL',
            ...
            ShaderPart(url=["../shaders/commonnew.fs"],type='FRAGMENT')])])),
      Script(DEF='Animate',
        field=[
...
print('Self-test diagnostics for variationalflowers.py:')
...
print("python variationalflowers.py load and self-test diagnostics complete.")

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(content='HAnim skeletal structure at level of articulation two, one diamond at the base node for the structure, blue spheres for HAnimSite feaature points',name='description'),
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='hanim_humanoid',loa=2,name='humanoid',version='2.0',
      ...
      #  adapted from original HAnimHumanoid info='"humanoidVersion=Nancy V1.2b" "authorName=Cindy Ballreich" "authorEmail=cindy@ballreich.net" "copyright=1997 3Name3D / Yglesias Wallock Divekar Inc. all rights reserved." 
      joints=[

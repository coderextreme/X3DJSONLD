...
#
#   $ python HelloWorldProgramOutputCanonical.py
#
...
print('Self-test diagnostics for HelloWorldProgramOutputCanonical.py:')
...
print("python HelloWorldProgramOutputCanonical.py load and self-test diagnostics complete.")

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(name='title',content='text3shapes.x3d'),
    meta(name='identifier',content='https://coderextreme.net/X3DJSONLD/src/main/data/text3shapes.x3d'),
    meta(name='description',content='3 text shapes'),
...
print('Self-test diagnostics for text3shapes.py:')
...
print("python text3shapes.py load and self-test diagnostics complete.")

  ...
  Scene=Scene(
    ...
    ProtoDeclare(name='FlowerProto',
      ProtoInterface=ProtoInterface(
        field=[
        field(accessType='inputOnly',name='vertex',type='MFString',value=["../shaders/freewrl_flowers_chromatic.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs"]),
        field(accessType='inputOnly',name='fragment',type='MFString',value=["../shaders/freewrl.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"])]),
      ProtoBody=ProtoBody(
        children=[
...
""")])]),
          ...
          Script(DEF='Animate',directOutput=True,
            ...
            field(name='set_fraction',accessType='inputOutput',type='SFFloat'),

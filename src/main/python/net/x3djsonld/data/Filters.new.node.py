  ...
  Scene=Scene(
    ...
    Transform(
      ...
      Shape(
        ...
        geometry=Cylinder(radius=500.0))]),
        ...
        Gain(
          ...
          SpatialSound(DEF='Audio1',
            ...
            Gain(
              ...
              Analyser(
                children=[
                BiquadFilter(detune=50.0,frequency=600.0,qualityFactor=30.0,type='',
                  children=[
          ...
          SpatialSound(DEF='Audio2',
            ...
            Gain(
              ...
              Analyser(
                children=[
                BiquadFilter(detune=15.0,frequency=600.0,qualityFactor=15.0,type='',
                  children=[
          ...
          SpatialSound(DEF='Audio3',
            ...
            Gain(
              ...
              Analyser(
                children=[
                BiquadFilter(frequency=1000.0,qualityFactor=0.0,type='',
                  children=[
...
print('Self-test diagnostics for Filters.py:')
...
print("python Filters.py load and self-test diagnostics complete.")

...
print('Self-test diagnostics for HAnim1SpecificationLOA3Illustrated.py:')
...
print("python HAnim1SpecificationLOA3Illustrated.py load and self-test diagnostics complete.")

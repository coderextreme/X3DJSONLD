...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='HAnimSpecificationLOA3Illustrated.x3d',name='title'),
    ...
    meta(content='HAnimSpecificationLOA3Illustrated.png',name='Image'),
    meta(content='HAnimSpecificationLOA3IllustratedLeftSide.png',name='Image'),
    meta(content='HAnimSpecificationLOA3Invisible.x3d',name='reference'),
    meta(content='HAnimSpecificationLOA3Animation.x3d',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/HAnimSpecificationLOA3Illustrated.x3d',name='identifier'),
...
print ("python x3d.py load successful for HAnimSpecificationLOA3Illustrated.py")

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(name='identifier',content='https://coderextreme.net/X3DJSONLD/src/main/data/ThreeDTexture.x3d'),
...
print('Self-test diagnostics for ThreeDTexture.py:')
...
print("python ThreeDTexture.py load and self-test diagnostics complete.")

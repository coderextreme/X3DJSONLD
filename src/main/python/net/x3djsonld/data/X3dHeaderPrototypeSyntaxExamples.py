...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://www.web3d.org/documents/specifications/19776-1/V3.3/Part01/concepts.html#XMLFileSyntax',name='specificationUrl'),
    meta(content='http://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/X3dHeaderPrototypeSyntaxExamples.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Inline(DEF='someInline',url=["someUrl.x3d","http://www.web3d.org/x3d/content/examples/Basic/X3dSpecifications/someUrl.x3d"]),
...
print ("python x3d.py load successful for X3dHeaderPrototypeSyntaxExamples.py")

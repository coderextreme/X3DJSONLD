...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(content='Kwan Hee YOO and Don Brutzman',name='creator'),
    ...
    meta(content='https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/hanim.html',name='reference'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(-1,1,0),
      ...
      Transform(DEF='GridXY_20x20Fixed_AdjustScale',scale=(.1,.1,.1),
        children=[
        Inline(DEF='GridXY_20x20Fixed',url=["../../Savage/Tools/Authoring/GridXY_20x20Fixed.x3d","https://savage.nps.edu/Savage/Tools/Authoring/GridXY_20x20Fixed.x3d","../../Savage/Tools/Authoring/GridXY_20x20Fixed.wrl","https://savage.nps.edu/Savage/Tools/Authoring/GridXY_20x20Fixed.wrl"])])]),
    Transform(translation=(1,1,0),
      children=[

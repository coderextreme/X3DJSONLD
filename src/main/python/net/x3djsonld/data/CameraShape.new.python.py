...
newModel=X3D(profile='Interactive',version='3.1',
  ...
  Scene=Scene(
    ...
    Transform(scale=(0.1,0.1,0.1),translation=(0,-0.165,0.02),
      ...
      Switch(whichChoice=-1,
        ...
        Shape(
          ...
          geometry=IndexedFaceSet(DEF='pCylinder1_0Geo',convex=False,coordIndex=[0,1,13,12,-1,1,2,14,13,-1,2,3,15,14,-1,3,4,16,15,-1,4,5,17,16,-1,5,6,18,17,-1,6,7,19,18,-1,7,8,20,19,-1,8,9,21,20,-1,9,10,22,21,-1,10,11,23,22,-1,11,0,12,23,-1,1,0,24,-1,2,1,24,-1,3,2,24,-1,4,3,24,-1,5,4,24,-1,6,5,24,-1,7,6,24,-1,8,7,24,-1,9,8,24,-1,10,9,24,-1,11,10,24,-1,0,11,24,-1,12,13,25,-1,13,14,25,-1,14,15,25,-1,15,16,25,-1,16,17,25,-1,17,18,25,-1,18,19,25,-1,19,20,25,-1,20,21,25,-1,21,22,25,-1,22,23,25,-1,23,12,25,-1],creaseAngle=0.7854,
            coord=Coordinate(DEF='pCylinder1GeoPoints',point=[(-0.36,-2.39,-0.26),(-0.36,-1.77,-0.89),(-0.36,0,-1.7),(-0.36,0.85,-1.47),(-0.36,1.47,-0.85),(-0.36,1.7,0),(-0.36,1.47,0.85),(-0.36,-0.07,2.05),(-0.36,-0.92,2.28),(-0.36,-1.77,2.05),(-0.36,-2.39,1.43),(-0.36,-2.62,0.58),(0.36,-2.39,-0.26),(0.36,-1.77,-0.89),(0.36,0,-1.7),(0.36,0.85,-1.47),(0.36,1.47,-0.85),(0.36,1.7,0),(0.36,1.47,0.85),(0.36,-0.07,2.05),(0.36,-0.92,2.28),(0.36,-1.77,2.05),(0.36,-2.39,1.43),(0.36,-2.62,0.58),(-0.36,-0.46,0.31),(0.36,-0.46,0.31)]))),
        Shape(
          appearance=Appearance(USE='CameraAppearance'),
      ...
      Group(
        children=[
        Transform(DEF='pCylinder1',rotation=(-1,0,0,0.373518),translation=(-0.038462,3.596312,3.297562),
          children=[
          Shape(
            appearance=Appearance(USE='CameraAppearance'),
            geometry=IndexedFaceSet(USE='pCylinder1_0Geo'))]),
        Transform(DEF='pCube1',scale=(1,0.727134,0.801457),translation=(-0.030769,1.738461,1.4436),
          children=[
          Shape(
            appearance=Appearance(USE='CameraAppearance'),
            geometry=IndexedFaceSet(USE='pCube1_0Geo'))]),
        Transform(DEF='pPipe1',scale=(1,1,0.569444),translation=(0.015385,1.630769,-1.973274),
          children=[
          Shape(
            appearance=Appearance(USE='CameraAppearance'),

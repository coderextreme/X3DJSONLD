        ...
        ProtoBody=ProtoBody(
          ...
          Group(
            ...
            ProtoInstance(name='FlowerProto',
              fieldValue=[
              fieldValue(name='vertex',value=["../shaders/x_ite_flowers_plain.vs"]),
...
print('Self-test diagnostics for plainflowers.py:')
...
print("python plainflowers.py load and self-test diagnostics complete.")

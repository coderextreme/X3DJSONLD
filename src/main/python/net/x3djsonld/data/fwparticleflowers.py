      ...
      ParticleSystem(maxParticles=20,geometryType='GEOMETRY',
        ...
        appearance=Appearance(
          ...
          ComposedShader(DEF='fw',language='GLSL',
            ...
            ShaderPart(url=["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"],type='FRAGMENT')])])),
      Script(DEF='Animate',
        field=[
...
"""),
      ...
      ROUTE(fromNode='Animate',fromField='a',toNode='fw',toField='a'),
      ROUTE(fromNode='Animate',fromField='b',toNode='fw',toField='b'),
      ROUTE(fromNode='Animate',fromField='c',toNode='fw',toField='c'),
      ROUTE(fromNode='Animate',fromField='d',toNode='fw',toField='d'),
      ROUTE(fromNode='Animate',fromField='pdelta',toNode='fw',toField='pdelta'),
      ROUTE(fromNode='Animate',fromField='tdelta',toNode='fw',toField='tdelta')])])
)

...
# print(prependLineNumbers(newModelVRML), file=sys.stderr)
x3dfile = open("DiamondManLOA0PythonToX3d.x3d","wt")
...
#   print('check newModel.VRML() serialization...', file=sys.stderr)
    ...
    print(prependLineNumbers(newModelVRML), file=sys.stderr) # debug
    vrmlfile = open("DiamondManLOA0PythonToVRML.wrl","wt")
...
#   print(prependLineNumbers(newModelJSON), file=sys.stderr) # debug
    print(prependLineNumbers(newModelJSON), file=sys.stderr) # debug
    jsonfile = open("DiamondManLOA0PythonToJSON.json","wt")

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(content='DiamondManLOA1.x3d',name='title'),
    meta(content='HAnim skeletal structure for Level of Action (LOA) one, with diamonds at the Joint centers, also includes HAnimSite feaature points. LOA-1 is typical low-end real-time 3D hierarchy.',name='description'),
    ...
    meta(content='18 February 2024',name='modified'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA1.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='hanim_humanoid',loa=1,name='humanoid',version='2.0',
      ...
      viewpoints=[
      HAnimSite(DEF='hanim_DiamondManLOA1_view',name='DiamondManLOA1_view',
        children=[
...
print('Self-test diagnostics for DiamondManLOA1.py:')
...
print("python DiamondManLOA1.py load and self-test diagnostics complete.")

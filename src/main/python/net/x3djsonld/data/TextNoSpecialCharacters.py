...
newModel=X3D(profile='Immersive',version='3.3',
  ...
  Scene=Scene(
    ...
    Shape(
      ...
      geometry=Text(DEF='DefaultText',string=["Character entity substitutions:"         "empty string \"\" skips a line:"         ""         "apostrophe  \'  is &apos;"          "ampersand & is &amp;"         "quote mark  \"  is &quot;"         "backslash \\ is X3D escape character"         "double backslash \\\\ is X3D backslash \\ character"         "Pi is pi is pi XML character entity"],
...
print('Self-test diagnostics for TextSpecialCharacters.py:')
...
print("python TextSpecialCharacters.py load and self-test diagnostics complete.")

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(content='18 February 2021',name='modified'),
                    ...
                    HAnimJoint(DEF='hanim_l_tarsal_distal_interphalangeal_2',center=(0.1086,0,0.0762),name='l_tarsal_distal_interphalangeal_2',
                      ...
                      HAnimSegment(DEF='hanim_l_tarsal_distal_phalanx_2',name='l_tarsal_distal_phalanx_2',
                        ...
                        HAnimSite(DEF='hanim_l_forefoot_tip',name='l_forefoot_tip_pt',translation=(0.1354,0.0016,0.1476),
                          ...
                          Shape(USE='HAnimSiteShape')]),
                        HAnimSite(DEF='hanim_l_metatarsal_pha5_pt',name='l_metatarsal_pha5_pt_pt',translation=(0.1825,0.007,0.0928),
                          #  HAnimSite visualization shape 
                          children=[
          ...
          HAnimJoint(DEF='hanim_r_hip',center=(-0.0961,0.9124,-0.0001),name='r_hip',
            ...
            HAnimSegment(DEF='hanim_r_thigh',name='r_thigh',
              ...
              HAnimSite(DEF='hanim_r_knee_crease_pt',name='r_knee_crease_pt_pt',translation=(-0.0825,0.4932,-0.0326),
                ...
                Shape(USE='HAnimSiteShape')]),
              HAnimSite(DEF='hanim_r_femoral_lateral_epicn_pt',name='r_femoral_lateral_epicn_pt_pt',translation=(-0.1421,0.4992,0.031),
                #  HAnimSite visualization shape 
                children=[
                    ...
                    HAnimSegment(DEF='hanim_r_tarsal_proximal_phalanx_2',name='r_tarsal_proximal_phalanx_2',
                      ...
                      Shape(
                        geometry=LineSet(vertexCount=[2],
                          ...
                          color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                      HAnimSite(DEF='hanim_r_metatarsal_pha1_pt',name='r_metatarsal_pha1_pt_pt',translation=(-0.0521,0.026,0.0127),
                        #  HAnimSite visualization shape 
                        children=[
          ...
          HAnimSegment(DEF='hanim_l5',name='l5',
            ...
            Shape(
              geometry=LineSet(vertexCount=[2],
                ...
                color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
            HAnimSite(DEF='hanim_waist_preferred_post_pt',name='waist_preferred_post_pt_pt',translation=(0,1.0915,-0.1091),
              #  HAnimSite visualization shape 
              children=[
                                                          ...
                                                          HAnimSegment(DEF='hanim_skull',name='skull',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                            HAnimSite(DEF='hanim_skull_tip',name='skull_tip_pt',translation=(0.005,1.7504,0.0055),
                                            ...
                                            HAnimSegment(DEF='hanim_l_clavicle',name='l_clavicle',
                                              ...
                                              Shape(
                                                geometry=LineSet(vertexCount=[2],
                                                  ...
                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                              HAnimSite(DEF='hanim_l_clavicale_pt',name='l_clavicale_pt_pt',translation=(0.0271,1.4943,0.0394),
                                                #  HAnimSite visualization shape 
                                                children=[
                                              ...
                                              HAnimSite(DEF='hanim_l_acromion_pt',name='l_acromion_pt_pt',translation=(0.2032,1.476,-0.049),
                                                ...
                                                Shape(USE='HAnimSiteShape')]),
                                              HAnimSite(DEF='hanim_l_axilla_ant_pt',name='l_axilla_ant_pt_pt',translation=(0.1777,1.4065,-0.0075),
                                                #  HAnimSite visualization shape 
                                                children=[
                                                TouchSensor(description='HAnimSite l_axilla_ant_pt'),
                                                Shape(USE='HAnimSiteShape')]),
                                              HAnimSite(DEF='hanim_l_axilla_post_pt',name='l_axilla_post_pt_pt',translation=(0.1706,1.4072,-0.0875),
                                                #  HAnimSite visualization shape 
                                                children=[
                                                ...
                                                HAnimSegment(DEF='hanim_l_upperarm',name='l_upperarm',
                                                  ...
                                                  Shape(
                                                    geometry=LineSet(vertexCount=[2],
                                                      ...
                                                      color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                  HAnimSite(DEF='hanim_l_humeral_lateral_epicn_pt',name='l_humeral_lateral_epicn_pt_pt',translation=(0.228,1.1482,-0.11),
                                                    #  HAnimSite visualization shape 
                                                    children=[
                                                  ...
                                                  HAnimJoint(DEF='hanim_l_radiocarpal',center=(0.1984,0.8663,-0.0583),name='l_radiocarpal',
                                                    ...
                                                    HAnimSegment(DEF='hanim_l_carpal',name='l_carpal',
                                                      ...
                                                      HAnimSite(DEF='hanim_l_ulnar_styloid_pt',name='l_ulnar_styloid_pt_pt',translation=(0.2142,0.8529,-0.0648),
                                                        ...
                                                        Shape(USE='HAnimSiteShape')]),
                                                      HAnimSite(DEF='hanim_l_metacarpal_pha5_pt',name='l_metacarpal_pha5_pt_pt',translation=(0.1929,0.786,-0.1122),
                                                        #  HAnimSite visualization shape 
                                                        children=[
                                                          ...
                                                          HAnimSegment(DEF='hanim_l_carpal_distal_phalanx_1',name='l_carpal_distal_phalanx_1',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                            HAnimSite(DEF='hanim_l_thumb_distal_tip',name='l_thumb_distal_tip_pt',translation=(0.1982,0.8061,0.0759),
                                                              #  HAnimSite visualization shape 
                                                              children=[
                                                            ...
                                                            HAnimSegment(DEF='hanim_l_carpal_distal_phalanx_2',name='l_carpal_distal_phalanx_2',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_l_index_distal_tip',name='l_index_distal_tip_pt',translation=(0.2089,0.6858,-0.0245),
                                                                #  HAnimSite visualization shape 
                                                                children=[
                                                            ...
                                                            HAnimSegment(DEF='hanim_l_carpal_distal_phalanx_3',name='l_carpal_distal_phalanx_3',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_l_middle_distal_tip',name='l_middle_distal_tip_pt',translation=(0.208,0.6731,-0.0491),
                                                                #  HAnimSite visualization shape 
                                                                children=[
                                                            ...
                                                            HAnimSegment(DEF='hanim_l_carpal_distal_phalanx_4',name='l_carpal_distal_phalanx_4',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_l_ring_distal_tip',name='l_ring_distal_tip_pt',translation=(0.2035,0.675,-0.0756),
                                                                #  HAnimSite visualization shape 
                                                                children=[
                                                            ...
                                                            HAnimSegment(DEF='hanim_l_carpal_distal_phalanx_5',name='l_carpal_distal_phalanx_5',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_l_pinky_distal_tip',name='l_pinky_distal_tip_pt',translation=(0.2014,0.7009,-0.1012),
                                                                #  HAnimSite visualization shape 
                                                                children=[
                                            ...
                                            HAnimSegment(DEF='hanim_r_clavicle',name='r_clavicle',
                                              ...
                                              Shape(
                                                geometry=LineSet(vertexCount=[2],
                                                  ...
                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                              HAnimSite(DEF='hanim_r_clavicale_pt',name='r_clavicale_pt_pt',translation=(-0.0115,1.4943,0.04),
                                                #  HAnimSite visualization shape 
                                                children=[
                                              ...
                                              HAnimSite(DEF='hanim_r_acromion_pt',name='r_acromion_pt_pt',translation=(-0.1905,1.4791,-0.0431),
                                                ...
                                                Shape(USE='HAnimSiteShape')]),
                                              HAnimSite(DEF='hanim_r_axilla_ant_pt',name='r_axilla_ant_pt_pt',translation=(-0.1626,1.4072,-0.0031),
                                                #  HAnimSite visualization shape 
                                                children=[
                                                TouchSensor(description='HAnimSite r_axilla_ant_pt'),
                                                Shape(USE='HAnimSiteShape')]),
                                              HAnimSite(DEF='hanim_r_axilla_post_pt',name='r_axilla_post_pt_pt',translation=(-0.1603,1.4098,-0.0826),
                                                #  HAnimSite visualization shape 
                                                children=[
                                                ...
                                                HAnimSegment(DEF='hanim_r_upperarm',name='r_upperarm',
                                                  ...
                                                  Shape(
                                                    geometry=LineSet(vertexCount=[2],
                                                      ...
                                                      color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                  HAnimSite(DEF='hanim_r_humeral_lateral_epicn_pt',name='r_humeral_lateral_epicn_pt_pt',translation=(-0.2224,1.1517,-0.1033),
                                                    #  HAnimSite visualization shape 
                                                    children=[
                                                ...
                                                HAnimJoint(DEF='hanim_r_elbow',center=(-0.2014,1.1357,-0.0682),name='r_elbow',
                                                  ...
                                                  HAnimSegment(DEF='hanim_r_forearm',name='r_forearm',
                                                    ...
                                                    HAnimSite(DEF='hanim_r_olecranon_pt',name='r_olecranon_pt_pt',translation=(-0.1907,1.1405,-0.1065),
                                                      ...
                                                      Shape(USE='HAnimSiteShape')]),
                                                    HAnimSite(DEF='hanim_r_humeral_medial_epicn_pt',name='r_humeral_medial_epicn_pt_pt',translation=(-0.168,1.1298,-0.1062),
                                                      #  HAnimSite visualization shape 
                                                      children=[
                                                  ...
                                                  HAnimJoint(DEF='hanim_r_radiocarpal',center=(-0.1984,0.8663,-0.0583),name='r_radiocarpal',
                                                    ...
                                                    HAnimSegment(DEF='hanim_r_carpal',name='r_carpal',
                                                      ...
                                                      HAnimSite(DEF='hanim_r_ulnar_styloid_pt',name='r_ulnar_styloid_pt_pt',translation=(-0.2117,0.8562,-0.0584),
                                                        ...
                                                        Shape(USE='HAnimSiteShape')]),
                                                      HAnimSite(DEF='hanim_r_metacarpal_pha5_pt',name='r_metacarpal_pha5_pt_pt',translation=(-0.1929,0.789,-0.1064),
                                                        #  HAnimSite visualization shape 
                                                        children=[
                                                          ...
                                                          HAnimSegment(DEF='hanim_r_carpal_distal_phalanx_1',name='r_carpal_distal_phalanx_1',
                                                            ...
                                                            Shape(
                                                              geometry=LineSet(vertexCount=[2],
                                                                ...
                                                                color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                            HAnimSite(DEF='hanim_r_thumb_distal_tip',name='r_thumb_distal_tip_pt',translation=(-0.1869,0.809,0.082),
                                                              #  HAnimSite visualization shape 
                                                              children=[
                                                            ...
                                                            HAnimSegment(DEF='hanim_r_carpal_distal_phalanx_2',name='r_carpal_distal_phalanx_2',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_r_index_distal_tip',name='r_index_distal_tip_pt',translation=(-0.198,0.6883,-0.018),
                                                                #  HAnimSite visualization shape 
                                                                children=[
                                                            ...
                                                            HAnimSegment(DEF='hanim_r_carpal_distal_phalanx_3',name='r_carpal_distal_phalanx_3',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_r_middle_distal_tip',name='r_middle_distal_tip_pt',translation=(-0.1969,0.6758,-0.0427),
                                                                #  HAnimSite visualization shape 
                                                                children=[
                                                            ...
                                                            HAnimSegment(DEF='hanim_r_carpal_distal_phalanx_4',name='r_carpal_distal_phalanx_4',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_r_ring_distal_tip',name='r_ring_distal_tip_pt',translation=(-0.1934,0.6778,-0.0693),
                                                                #  HAnimSite visualization shape 
                                                                children=[
                                                            ...
                                                            HAnimSegment(DEF='hanim_r_carpal_distal_phalanx_5',name='r_carpal_distal_phalanx_5',
                                                              ...
                                                              Shape(
                                                                geometry=LineSet(vertexCount=[2],
                                                                  ...
                                                                  color=ColorRGBA(USE='HAnimSiteLineColorRGBA'))),
                                                              HAnimSite(DEF='hanim_r_pinky_distal_tip',name='r_pinky_distal_tip_pt',translation=(-0.1938,0.7035,-0.0949),
                                                                #  HAnimSite visualization shape 
                                                                children=[

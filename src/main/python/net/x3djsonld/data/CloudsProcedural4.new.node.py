...
newModel=X3D(profile='Immersive',version='3.2',
  ...
  Scene=Scene(
    ...
    DirectionalLight(ambientIntensity=1.0,direction=(-1,0,0),global_=True),
    Group(DEF='Terrain',
      children=[
    ...
    Group(DEF='Clouds',
      ...
      Script(DEF='PixelScript',directOutput=True,
        field=[
        field(name='Cumulus',accessType='initializeOnly',type='SFNode',
          children=[
          Transform(USE='Cumulus')]),
        field(name='Cirrus',accessType='initializeOnly',type='SFNode',
          children=[
...
"""),
      DirectionalLight(ambientIntensity=1.0,color=(1,0,0),direction=(-1,-1,0),global_=True)])])
) # X3D model complete

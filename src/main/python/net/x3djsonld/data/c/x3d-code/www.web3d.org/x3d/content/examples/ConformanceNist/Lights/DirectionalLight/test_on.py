...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    ...
    meta(content='This test sets the on field to true/false for two DirectionalLight node defined using two different Transform node. The test should generate two default color/size spheres. The leftmost one sholud be illuminated while the rightmost one should be dark.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_on.x3d',name='identifier'),

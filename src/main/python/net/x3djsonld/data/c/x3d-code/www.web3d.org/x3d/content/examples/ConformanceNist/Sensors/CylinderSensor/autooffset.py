    ...
    Group(
      ...
      Transform(
        ...
        Transform(DEF='MYCYLINDER1',
          ...
          CylinderSensor(DEF='CYLINDER1SENSOR',autoOffset=False,description='click and drag to rotate'),
          Shape(
            appearance=Appearance(
              material=Material(emissiveColor=(1,1,1))),
            geometry=IndexedLineSet(colorIndex=[0],colorPerVertex=False,coordIndex=[0,1],
...
print ("python x3d.py load successful for autooffset.py")

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='Manta.x3d',name='title'),
...
print ("python x3d.py load successful for Manta.py")

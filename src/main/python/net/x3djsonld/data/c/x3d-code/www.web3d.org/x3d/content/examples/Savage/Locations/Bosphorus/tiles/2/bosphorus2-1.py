...
newModel=X3D(profile='Immersive',version='3.1',
  ...
  Scene=Scene(
    children=[
    GeoViewpoint(description='GeoViewpoint_2_21',geoSystem=['GDC'],position=(41.171586403296146,28.882589547476528,28604.634182705922),orientation=(-1,0,0,1.57),
      geoOrigin=GeoOrigin(DEF='ORIGIN',geoCoords=(41.06225017873692,29.030952729968703,0),geoSystem=['GDC'])),
    GeoLOD(center=(41.171586403296146,28.882589547476528,0.0),range=34325.562,child1Url=['../../tiles/3/bosphorus4-2.x3d'],child2Url=['../../tiles/3/bosphorus4-3.x3d'],child3Url=['../../tiles/3/bosphorus5-2.x3d'],child4Url=['../../tiles/3/bosphorus5-3.x3d'],
      ...
      Group(
        ...
        Shape(
          appearance=Appearance(
            ...
            texture=ImageTexture(url=['../../images/2/bosphorus2-1.jpg'],repeatS=False,repeatT=False)),

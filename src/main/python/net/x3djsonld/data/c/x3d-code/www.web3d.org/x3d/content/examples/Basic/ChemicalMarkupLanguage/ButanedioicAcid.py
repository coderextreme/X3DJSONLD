...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='ButanedioicAcid.x3d',name='title'),
    meta(content='Autogenerated version of ButanedioicAcid.x3d scene produced from ButanedioicAcid.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='ButanedioicAcid.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/ButanedioicAcid.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='ButanedioicAcid.x3d'),
    ...
    Viewpoint(description='Inspect ButanedioicAcid',position=(0,2,20)),
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["Butanedioic Acid: C4 H6 O4"])])]),
      Transform(translation=(0,5,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["molecule weight: 118.09"])])]),
      Transform(translation=(0,4,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["melting point: 185"])])]),
      Transform(translation=(0,3,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["boiling point: 235"])])]),
      Transform(translation=(0,2,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["specific gravity: 1.6"])])])]),
    Group(
      children=[
      Transform(
        children=[
        ProtoInstance(DEF='butanedioic_acid_a1',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.1343,0.9978,1.7414))])]),
      Transform(
        children=[
        ProtoInstance(DEF='butanedioic_acid_a2',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.966,2.1001,1.1065))])]),
      Transform(
        children=[
        ProtoInstance(DEF='butanedioic_acid_a3',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(1.6854,1.0825,1.3399))])]),
      Transform(
        children=[
        ProtoInstance(DEF='butanedioic_acid_a4',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(5.4133,2.0195,1.5145))])]),
      Transform(
        children=[
        ProtoInstance(DEF='butanedioic_acid_a5',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(0.8984,0.1193,1.8759))])]),
      Transform(
        children=[
        ProtoInstance(DEF='butanedioic_acid_a6',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(1.1213,1.8803,0.6125))])]),
      Transform(
        children=[
        ProtoInstance(DEF='butanedioic_acid_a7',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(6.2033,2.9753,0.9693))])]),
      Transform(
        children=[
        ProtoInstance(DEF='butanedioic_acid_a8',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(5.9743,1.2314,2.2546))])])]),
    Group(
      children=[
      ProtoInstance(DEF='butanedioic_acid_b1',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.1343,0.9978,1.7414),(3.966,2.1001,1.1065)])]),
      ProtoInstance(DEF='butanedioic_acid_b2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.1343,0.9978,1.7414),(1.6854,1.0825,1.3399)])]),
      ProtoInstance(DEF='Butanedioic_Acid_b5',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.966,2.1001,1.1065),(5.4133,2.0195,1.5145)])]),
      ProtoInstance(DEF='butanedioic_acid_b8',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.6854,1.0825,1.3399),(0.8984,0.1193,1.8759)])]),
      ProtoInstance(DEF='butanedioic_acid_b9',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.6654,1.0825,1.3399),(1.1013,1.8803,0.6125)])]),
      ProtoInstance(DEF='butanedioic_acid_b9_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.7054,1.0825,1.3399),(1.1413,1.8803,0.6125)])]),
      ProtoInstance(DEF='butanedioic_acid_b10',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(5.4133,2.0195,1.5145),(6.2033,2.9753,0.9693)])]),
      ProtoInstance(DEF='butanedioic_acid_b11',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(5.3933,2.0195,1.5145),(5.954300000000001,1.2314,2.2546)])]),
      ProtoInstance(DEF='butanedioic_acid_b11_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(5.433299999999999,2.0195,1.5145),(5.9943,1.2314,2.2546)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for ButanedioicAcid.py")

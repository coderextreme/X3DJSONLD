...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='ExampleGreyCobra.x3d',name='title'),
    meta(content="Instantiates an example of the Super Cobra AH-1Z Helicopter's prototype in Grey Color.",name='description'),
    meta(content='Jane Wu',name='creator'),
    meta(content='16 January 2001',name='created'),
    meta(content='9 March 2004',name='modified'),
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/AH1SuperCobraUnitedStates/ExampleGreyCobra.x3d',name='identifier'),
    ...
    Transform(
      ...
      ProtoInstance(DEF='ExampleHelicopter',name='SuperCobra',
        ...
        fieldValue(name='cowlingColor',
          ...
          Appearance(
            material=Material(diffuseColor=(0.5,0.5,0.5)))]),
        fieldValue(name='helicopterName',value='"Grey Cobra"')])]),
...
print ("python x3d.py load successful for ExampleGreyCobra.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='ArleighBurkePropellers.x3d',name='title'),
    meta(content='Props and hub built in scale 1:1 in feet. Both shafts modeled to length of the longest shaft for now...',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/DDGArleighBurkeUnitedStates/ArleighBurkePropellers.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    #  LOD used to decrease framerate in combined file later. Set to 100m. >100m draws nothing. 
    children=[
    LOD(range=[100],
      children=[
      Transform(
...
print ("python x3d.py load successful for ArleighBurkePropellers.py")

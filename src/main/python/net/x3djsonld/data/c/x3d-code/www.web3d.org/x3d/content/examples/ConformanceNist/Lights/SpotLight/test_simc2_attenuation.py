...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_simc2_attenuation.x3d',name='title'),
    meta(content='test-simc2-attenuation-movie.mpg',name='MovingImage'),
    ...
    meta(content='Test browser to apply attenuation values to a set of simple geometry. The third index of the attenuation field is set to 0.1, which should cause the attenuation to decrease inversively proportional to the square of the distance from the light. The light brightness should decrease rapidly as the objects move away from the light. The intensity and the ambientIntensity are set to 1 for all geometry.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_simc2_attenuation.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='test_simc2_attenuation.x3d'),
    ...
    SpotLight(attenuation=(0,0,0.1),beamWidth=1.57079,cutOffAngle=1.57079,location=(0,0,4),radius=101),
...
print ("python x3d.py load successful for test_simc2_attenuation.py")

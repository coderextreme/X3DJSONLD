...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='null_texturetransform.x3d',name='title'),
    meta(content='null_texturetransform-front.jpg',name='Image'),
    ...
    meta(content='Test the browser implementation of a NULL transformation. With the textureTransform field = NULL, for primitive geometry, the VTS logo should display once only, in an upright position, and horizontally and vertically centered for all geometry faces.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/null_texturetransform.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='null_texturetransform.x3d'),
    Group(
      children=[
...
print ("python x3d.py load successful for null_texturetransform.py")

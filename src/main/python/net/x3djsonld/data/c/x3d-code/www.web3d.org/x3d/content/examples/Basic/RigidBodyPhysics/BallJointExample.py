...
newModel=X3D(profile='Immersive',version='3.2',
  ...
  Scene=Scene(
    ...
    RigidBodyCollection(
      bodies=[
      RigidBody(DEF='BODY-1',mass=10000.0,useGlobalGravity=False,
        geometry=CollidableShape(USE='BOX-GEOM-1')),
      RigidBody(DEF='BODY-2',angularDampingFactor=0,position=(0.3,0.0,0.0),
        geometry=CollidableShape(USE='BOX-GEOM-2')),
      RigidBody(DEF='BODY-3',angularDampingFactor=0,mass=0.1,orientation=(0.0,1.0,0.0,0.7071),position=(0.52,0.0,0.2),
        geometry=CollidableShape(USE='BOX-GEOM-3'))],
      joints=[
      BallJoint(anchorPoint=(0.15,0.0,0.0),
        body1=RigidBody(USE='BODY-1'),
        body2=RigidBody(USE='BODY-2')),
      BallJoint(anchorPoint=(0.4,0.0,0.1),
...
print ("python x3d.py load successful for BallJointExample.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='Test of browser ability to default map a MovieTexture onto an entire IndexedFaceSet geometry. The entire VTS logo texture should map once onto the surface of the IndexedFaceSet, with the S axis corresponding to the X axis of the IndexedFaceSet.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/IndexedFaceSetExample.x3d',name='identifier'),

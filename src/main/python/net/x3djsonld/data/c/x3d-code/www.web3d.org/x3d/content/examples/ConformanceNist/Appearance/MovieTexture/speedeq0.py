...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='speedeq0.x3d',name='title'),
    meta(content='speedeq0-movie.mpg',name='MovingImage'),
    ...
    meta(content='Test speed equal to 0. With the speed field equal to 0, the movie will not play, and frame 0 will be displayed when "now" is clicked.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/speedeq0.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='speedeq0.x3d'),
      ...
      Transform(DEF='Cube',
        ...
        Shape(
          appearance=Appearance(
            texture=MovieTexture(DEF='Movie',loop=True,speed=0,url=["vts.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/vts.mpg"])),
          geometry=Box(),)])]),
    Group(
      children=[
...
print ("python x3d.py load successful for speedeq0.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='Water surface for ArleighBurke model.',name='description'),
    meta(content='Modified for a smaller period and different coloring to be used for DDG51 model.',name='description'),
    meta(content='Keith J Ho, modified by James Harney',name='creator'),
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/Water.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    Viewpoint(description='Water view',position=(0,0,20)),
    Group(
      children=[

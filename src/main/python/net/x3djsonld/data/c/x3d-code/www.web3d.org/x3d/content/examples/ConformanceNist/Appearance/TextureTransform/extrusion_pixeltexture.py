...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='extrusion_pixeltexture.x3d',name='title'),
    meta(content='extrusion_pixeltexture-front.jpg',name='Image'),
    meta(content='extrusion_pixeltexture-rear.jpg',name='Image'),
    meta(content='extrusion_pixeltexture-top.jpg',name='Image'),
    meta(content='extrusion_pixeltexture-bottom.jpg',name='Image'),
    meta(content='extrusion_pixeltexture-left.jpg',name='Image'),
    meta(content='extrusion_pixeltexture-right.jpg',name='Image'),
    ...
    meta(content='Test default TextureTransform mapping of a PixelTexture to an Extrusion geometry. A PixelTexture consisting of a square checkerboard of blue (lower left quadrant), yellow (lower right), red (upper right) and green (upper left) is applied to an Extrusion by aligning the bottom of the PixelTexture with the first cross-section at the first spine point, and the top of the PixelTexture coincides with the last cross-section at the last spine point. The left side of the PixelTexture is aligned with the first cross-section point of all spine points (beginning on the far right side), and the right side of the PixelTexture coincides with the last cross-section point for all spine points (also on the far right side). For the ends of the extrusion, The PixelTexture will map with the +S (horizontal) texture axis aligning with the +X axis of the cap, and the +T (vertical) texture axis aligning with the +Z axis of the cap.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/extrusion_pixeltexture.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='extrusion_pixeltexture.x3d'),
    Group(
      children=[
...
print ("python x3d.py load successful for extrusion_pixeltexture.py")

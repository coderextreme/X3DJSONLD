...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='lastframe.x3d',name='title'),
    meta(content='lastframe-front.jpg',name='Image'),
    ...
    meta(content='Test showing last MovieTexture frame at load time. With the movie inactive at load time, and speed a negative value (negative 1), the last frame will be displayed at load time.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/lastframe.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='lastframe.x3d'),
      ...
      Transform(DEF='Cube',
        ...
        Shape(
          appearance=Appearance(
            texture=MovieTexture(DEF='Movie',loop=True,speed=-1,stopTime=1,url=["vts.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/vts.mpg"])),
          geometry=Box(),)])]),
    Group(
      children=[
...
print ("python x3d.py load successful for lastframe.py")

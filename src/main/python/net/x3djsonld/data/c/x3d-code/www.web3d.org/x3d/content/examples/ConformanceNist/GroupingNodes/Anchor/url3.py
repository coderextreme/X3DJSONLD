...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='url3.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Anchor/url3.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='url3.x3d'),
    ...
    Transform(translation=(0,1.5,0),
      ...
      Shape(
        ...
        geometry=Text(string=["THIRD SPHERE WAS CLICKED"],
...
print ("python x3d.py load successful for url3.py")

...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    ...
    meta(content='Test the "center" field of a ProximitySensor. A ProximitySensor (represented by an IndexedLineSet box) encloses a red Sphere geometry. The "center" field of the ProximitySensor is located at -100 -100 100 in the world coordinate system. All viewpoints should be orthographically correct (at 90 degree angles) to the ProximitySensor bounding box.When the viewers avatar enters the ProximitySensor bounding box, the sensor should route events to a TimeSensor node and start an animation that would change the color of the Sphere from red to blue.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/ProximitySensor/centersize_1.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ProximitySensor(DEF='PROX_SENSOR',center=(-100,-100,100),size=(4,4,4)),
...
print ("python x3d.py load successful for centersize_1.py")

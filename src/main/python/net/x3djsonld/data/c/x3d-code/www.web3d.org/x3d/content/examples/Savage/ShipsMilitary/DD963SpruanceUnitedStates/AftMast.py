...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='AftMast.x3d',name='title'),
    meta(content='Spruance Aft Mast',name='description'),
    meta(content='LT Josh Hansen',name='creator'),
    meta(content='17 September 2001',name='created'),
    meta(content='14 January 2014',name='modified'),
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/DD963SpruanceUnitedStates/AftMast.x3d',name='identifier'),
        ...
        Transform(translation=(0,15,-1),
          ...
          Transform(translation=(0,0,-4),
            ...
            Shape(
              ...
              appearance=Appearance(
                material=Material(diffuseColor=(.5,.5,.5))))]),
          Transform(scale=(1.2,1.2,1.2),translation=(0,2.2,0),
            children=[
            Inline(url=["AirRadarLw08.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DD963SpruanceUnitedStates/AirRadarLw08.wrl","AirRadarLw08.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DD963SpruanceUnitedStates/AirRadarLw08.x3d"])])])]),
...
print ("python x3d.py load successful for AftMast.py")

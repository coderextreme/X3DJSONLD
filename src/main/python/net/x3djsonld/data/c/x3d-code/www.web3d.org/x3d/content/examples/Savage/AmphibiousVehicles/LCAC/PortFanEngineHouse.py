...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='PortFanEngineHouse.x3d',name='title'),
    meta(content='Port Engine House for the LCAC',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AmphibiousVehicles/LCAC/PortFanEngineHouse.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(DEF='RearBoxOfUnknownUse',translation=(-2.5,1,-1),
      children=[
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(0.425,0.425,0.45),shininess=1)),
        geometry=Box(size=(1,2,2))),
      Transform(rotation=(0,0,1,1.57),translation=(0,1.25,0.45),
        children=[
        Shape(
          geometry=Cylinder(height=0.75,radius=0.5),
          appearance=Appearance(
            material=Material(diffuseColor=(0.425,0.425,0.45),shininess=1)))])])])
) # X3D model complete
...
print ("python x3d.py load successful for PortFanEngineHouse.py")

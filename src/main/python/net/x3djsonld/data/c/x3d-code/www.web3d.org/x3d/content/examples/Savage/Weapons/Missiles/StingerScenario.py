...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='StingerScenario.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/Weapons/Missiles/StingerScenario.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(rotation=(0,0,1,1.57),
        ...
        Transform(DEF='cockpit_seat_cover_plate_transf',rotation=(0,0,1,1.57079),
          ...
          Shape(DEF='cockpit_seat_cover_plate',
            ...
            appearance=Appearance(
              material=Material(),
              texture=ImageTexture(USE='cammie1')))]),
        Transform(DEF='cockpit_right_wall_transf',translation=(0,-.01,0),
          children=[
      ...
      Transform(translation=(3,0,0),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(emissiveColor=(0,0.5,0.5)))),
    ...
    ROUTE(fromField='value_changed',fromNode='MoverUsingScript',toField='set_translation',toNode='StingerMissile'),
    ROUTE(fromField='fraction_changed',fromNode='Clock',toField='set_fraction',toNode='MoverUsingScript'),
    ROUTE(fromField='touchTime',fromNode='FireButton',toField='set_startTime',toNode='Clock'),
    ROUTE(fromField='fraction_changed',fromNode='Clock',toField='set_fraction',toNode='Plane'),
    ROUTE(fromField='value_changed',fromNode='Plane',toField='set_translation',toNode='AV8B_transform')])
) # X3D model complete
...
print ("python x3d.py load successful for StingerScenario.py")

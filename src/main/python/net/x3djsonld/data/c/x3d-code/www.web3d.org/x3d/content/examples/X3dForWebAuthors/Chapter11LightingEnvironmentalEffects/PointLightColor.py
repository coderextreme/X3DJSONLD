...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/PointLightColor.x3d',name='identifier'),
...
print ("python x3d.py load successful for PointLightColor.py")

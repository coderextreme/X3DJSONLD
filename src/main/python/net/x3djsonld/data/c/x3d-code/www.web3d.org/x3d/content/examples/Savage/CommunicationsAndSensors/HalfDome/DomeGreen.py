...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='DomeGreen.x3d',name='title'),
    ...
    meta(content='Green Signal Dome',name='description'),
    meta(content='https://savage.nps.edu/Savage/CommunicationsAndSensors/HalfDome/DomeGreen.x3d',name='identifier'),
...
print ("python x3d.py load successful for DomeGreen.py")

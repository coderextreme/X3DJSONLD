...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    ...
    meta(content='Test if a PlaneSensor generates an isActive field when indicated by a pointing device. A red Box geometry has a default PlaneSensor node associated with it. Pressing the primary pointing device button down while the pointing device is over the Box should generate an isActive field, and turn a PointLight on.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/isactive.x3d',name='identifier'),

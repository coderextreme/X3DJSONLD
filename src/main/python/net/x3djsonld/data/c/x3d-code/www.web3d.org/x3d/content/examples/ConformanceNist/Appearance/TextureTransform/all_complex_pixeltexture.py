...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='all_complex_pixeltexture.x3d',name='title'),
    meta(content='all_complex_pixeltexture-front.jpg',name='Image'),
    meta(content='all_complex_pixeltexture-rear.jpg',name='Image'),
    meta(content='all_complex_pixeltexture-top.jpg',name='Image'),
    meta(content='all_complex_pixeltexture-bottom.jpg',name='Image'),
    meta(content='all_complex_pixeltexture-left.jpg',name='Image'),
    meta(content='all_complex_pixeltexture-right.jpg',name='Image'),
    ...
    meta(content='Test rotation, center and scale transform to PixelTexture. Test browser ability to apply a +45 degree rotation, with a center of 1 1, a scale of .5 .5 (creating a double sized image), and a translation of .5 .5 to a PixelTexture consisting of a square checkerboard of blue (lower left quadrant), yellow (lower right), red (upper right) and green (upper left) mapped to the faces of complex geometry. The result is: Using the default complex geometry mapping rules (for the bottom face of the ElevationGrid, the side and bottom end cap of the Extrusion, and the front of the IndexedFaceSet) : these geometry faces should display four adjacent right triangles, all with 90 degree central angles and joined at the central vertex. The top triangle should be RED, the bottom BLUE, the left YELLOW and the right GREEN. Opposite geometry faces should show reversed mapping, and side faces for the IndexedFaceSet should show smeared end pixels of the front and back faces.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/all_complex_pixeltexture.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='all_complex_pixeltexture.x3d'),
    Group(
      children=[
...
print ("python x3d.py load successful for all_complex_pixeltexture.py")

...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='elevationgrid_texture_first.x3d',name='title'),
    meta(content='elevationgrid_texture_first-top.jpg',name='Image'),
    meta(content='elevationgrid_texture_first-bottom.jpg',name='Image'),
    ...
    meta(content='A browser should select a Material node texture field over the color field of an ElevationGrid, and generate the VTS logo texture on the ElevationGrid surface. A solid red ElevationGrid fails the test.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/Color/elevationgrid_texture_first.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='elevationgrid_texture_first.x3d'),
...
print ("python x3d.py load successful for elevationgrid_texture_first.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='OmniReceiverPrototype.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/CommunicationsAndSensors/OmniDirectional/OmniReceiverPrototype.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    ProtoDeclare(appinfo='Omnidirectional hemispherical receiver.',name='OmniReceiver',
...
print ("python x3d.py load successful for OmniReceiverPrototype.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='RadioFrequencyDisplay.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/OH58dKiowaWarriorUnitedStates/RadioFrequencyDisplay.x3d',name='identifier'),
...
print ("python x3d.py load successful for RadioFrequencyDisplay.py")

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/HelloX3dAuthorsAnimationChain.x3d',name='identifier'),
      ...
      Group(DEF='MiniWorld',
        ...
        Shape(
          appearance=Appearance(
            texture=ImageTexture(url=["../../earth-topo.png","../../earth-topo.gif","../../earth-topo-small.gif","http://X3dGraphics.com/examples/X3dForWebAuthors/earth-topo.png","http://X3dGraphics.com/examples/X3dForWebAuthors/earth-topo.gif","http://X3dGraphics.com/examples/X3dForWebAuthors/earth-topo-small.gif"])),
          geometry=Sphere(),)]),

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_directioncom.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(scale=(0.02,0.02,0.02),translation=(-2.5,8,0),
      ...
      TouchSensor(DEF='the-touch',description='touch to animate')]),
    SpotLight(DEF='the-light',beamWidth=0.4,cutOffAngle=0.4,location=(0,0,2),radius=50),

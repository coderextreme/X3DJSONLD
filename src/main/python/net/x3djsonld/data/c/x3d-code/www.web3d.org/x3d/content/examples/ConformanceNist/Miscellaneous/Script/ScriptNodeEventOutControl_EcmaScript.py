...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ScriptConformance/ScriptNodeEventOutControl_EcmaScript.x3d',name='reference'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/Script/ScriptNodeEventOutControl_EcmaScript.x3d',name='identifier'),
    ...
    meta(content='ScriptNodeEventOutControl_EcmaScript_VrmlConsoleOutput.txt',name='reference'),
  ...
  Scene=Scene(
    ...
    Group(
      ...
      Transform(DEF='TextPosition',
        ...
        children=[
        Shape(
          geometry=Text(DEF='MessageToUser',string=["Default text in VRML scene will be replaced by","EcmaScript initialize() in Script using EventOut control.","This text appears first, if EcmaScript initialization fails.",""],
...
print ("python x3d.py load successful for ScriptNodeEventOutControl_EcmaScript.py")

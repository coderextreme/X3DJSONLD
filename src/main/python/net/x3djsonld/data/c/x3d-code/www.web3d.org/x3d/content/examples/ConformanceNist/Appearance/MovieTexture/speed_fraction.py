...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='speed_fraction.x3d',name='title'),
    meta(content='speed_fraction-movie.mpg',name='MovingImage'),
      ...
      Transform(DEF='Cube',
        ...
        Shape(
          appearance=Appearance(
            texture=MovieTexture(DEF='Movie',loop=True,speed=0.25,url=["vts.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/vts.mpg"])),
          geometry=Box(),)])]),
    Group(
      children=[
...
print ("python x3d.py load successful for speed_fraction.py")

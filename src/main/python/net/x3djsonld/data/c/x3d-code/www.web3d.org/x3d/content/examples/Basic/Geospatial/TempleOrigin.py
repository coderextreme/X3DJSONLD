...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='TempleOrigin.x3d',name='title'),
    meta(content='Temple with GeoOrigin node coregisters columns to same reference frame, eliminating floating-point roundoff errors and avoiding jitter on column positions.',name='description'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/Geospatial/TempleOrigin.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='TempleOrigin.x3d'),
...
print ("python x3d.py load successful for TempleOrigin.py")

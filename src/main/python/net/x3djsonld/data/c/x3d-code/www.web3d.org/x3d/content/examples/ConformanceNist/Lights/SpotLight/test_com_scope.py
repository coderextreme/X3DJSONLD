...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='test_com_scope.x3d',name='title'),
    meta(content='test-com-scope-front.jpg',name='Image'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_com_scope.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='test_com_scope.x3d'),
    Group(
      children=[
      SpotLight(beamWidth=1.57079,cutOffAngle=.785398,radius=5.5),
      SpotLight(beamWidth=1.57079,cutOffAngle=.785398,direction=(-1,0,0),radius=5.5),
      SpotLight(beamWidth=1.57079,cutOffAngle=.785398,direction=(0,1,0),radius=5.5),
      SpotLight(beamWidth=1.57079,cutOffAngle=.785398,direction=(0,-1,0),radius=5.5)]),
    ...
    Transform(rotation=(0,0,1,1.57),translation=(7.5,-1,-1.5),
      ...
      Shape(
        appearance=Appearance(USE='the-appearance'),
        geometry=ElevationGrid(USE='the-grid'))]),
    Transform(rotation=(0,0,1,1.57),translation=(9.5,-1,-1.5),
      children=[
      Shape(
        appearance=Appearance(USE='the-appearance'),
        geometry=ElevationGrid(USE='the-grid'))]),
    Transform(rotation=(1,0,0,3.14),translation=(0,1.5,0),
      children=[
      Shape(
        appearance=Appearance(USE='the-appearance'),
        geometry=ElevationGrid(USE='the-grid'))]),
    Transform(rotation=(1,0,0,3.14),translation=(0,3.5,0),
      children=[
      Shape(
        appearance=Appearance(USE='the-appearance'),
        geometry=ElevationGrid(USE='the-grid'))]),
    Transform(rotation=(1,0,0,3.14),translation=(0,5.5,0),
      children=[
      Shape(
        appearance=Appearance(USE='the-appearance'),
        geometry=ElevationGrid(USE='the-grid'))]),
    Transform(rotation=(1,0,0,3.14),translation=(0,7.5,0),
      children=[
      Shape(
        appearance=Appearance(USE='the-appearance'),
        geometry=ElevationGrid(USE='the-grid'))])])
...
print ("python x3d.py load successful for test_com_scope.py")

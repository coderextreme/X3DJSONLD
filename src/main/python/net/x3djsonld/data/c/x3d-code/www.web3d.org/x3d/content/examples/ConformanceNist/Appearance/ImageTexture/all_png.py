...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='all_png.x3d',name='title'),
    meta(content='all_png-front.jpg',name='Image'),
    meta(content='all_png-rear.jpg',name='Image'),
    meta(content='all_png-bottom.jpg',name='Image'),
    ...
    Group(
      ...
      Transform(translation=(-4.85443,0.0694381,-0.00149918),
        ...
        Shape(
          appearance=Appearance(
            material=Material(),
            texture=ImageTexture(DEF='image8bcolrp',url=["8bcolrp.png","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/8bcolrp.png"])),
          geometry=Sphere(),)]),
      Transform(translation=(-1.47341,0.036672,-0.00175095),
        ...
        Shape(
          appearance=Appearance(
            material=Material(),
            texture=ImageTexture(USE='image8bcolrp')),
          geometry=Cone(),)]),
...
print ("python x3d.py load successful for all_png.py")

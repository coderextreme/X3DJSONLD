...
newModel=X3D(profile='Immersive',version='3.1',
  head=head(
    children=[
    meta(content='ArleighBurkePrototype.x3d',name='title'),
    meta(content="Arleigh Burke Prototype model without missiles and corresponding routes, built for USS Cole Model. Click on ship's hull to trigger explosion on port side.",name='description'),
    meta(content='James Harney',name='creator'),
    meta(content='16 October 2001',name='created'),
    meta(content='14 January 2014',name='modified'),
    meta(content='Verify mast height',name='TODO'),
    meta(content='Fix Exploder ExternProtoDeclare',name='TODO'),
    meta(content='http://www.fas.org/man/dod-101/sys/ship/ddg-51.htm',name='reference'),
    meta(content='http://www.foia.navy.mil/usscole/',name='reference'),
    ...
    meta(content='http://www.dtic.mil/cgi-bin/GetTRDoc?AD=ADA322386 pg 8',name='reference'),
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/ArleighBurkePrototype.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    ExternProtoDeclare(appinfo='Prototype to explode different pieces and parts in different ways.',name='Exploder',url=["../../Tools/Explosions/MultipleTimerExplodingBuildingPrototype.x3d#Exploder","https://savage.nps.edu/Savage/Tools/Explosions/MultipleTimerExplodingBuildingPrototype.x3d#Exploder","../../Tools/Explosions/MultipleTimerExplodingBuildingPrototype.wrl#Exploder","https://savage.nps.edu/Savage/Tools/Explosions/MultipleTimerExplodingBuildingPrototype.wrl#Exploder"],
      field=[
    ...
    ProtoDeclare(appinfo='Arleigh Burke class destroyer',name='ArleighBurke',
      ProtoInterface=ProtoInterface(
        field=[
        field(accessType='inputOnly',name='startExplosion',type='SFTime')]),
      ProtoBody=ProtoBody(
        children=[
        Transform(DEF='BurkeGroup',scale=(0.963,1.05,0.625),translation=(-75,10,0),
          children=[
          Transform(rotation=(0,1,0,-1.57),
            ...
            Transform(
              children=[
              Viewpoint(description='DDG STBD view',orientation=(0,1,0,1.57),position=(300,40,-80)),
              ...
              Viewpoint(DEF='PORT',description='DDG PORT view',orientation=(0,1,0,-1.57),position=(-300,40,-80)),
              Viewpoint(DEF='FRONT',description='DDG Front View',orientation=(0,1,0,3.14),position=(0,20,-300)),
              Viewpoint(description='DDG Top down view',orientation=(1,0,0,-1.57),position=(0,220,-80)),
              Viewpoint(description='View from Flight Deck',orientation=(0,1,0,.75),position=(-6,-1,0))]),
            Transform(DEF='ShockTransform',
              ...
              Transform(translation=(0,-10,0),
                ...
                Group(DEF='PROPS',
                  ...
                  Transform(scale=(1.1,1.1,1.1),translation=(2,-4,-5),
                    children=[
                    Inline(url=["Propellers.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/Propellers.x3d","Propellers.wrl","../../ShipsMilitary/DDGArleighBurkeUnitedStates/Propellers.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/Propellers.wrl"])])]),
                Group(DEF='MAINDECKHULL',
                  ...
                  Transform(translation=(0,12,0),
                    ...
                    Shape(
                      ...
                      geometry=Extrusion(creaseAngle=.85,crossSection=[(9,0),(8,-3.5),(6.5,-10.45),(-6.5,-10.45),(-8,-3.5),(-9,0)],scale=[(1.3,1),(1.7,1),(1.7,1)],spine=[(0,0,-23.92),(0,0,-71.76),(0,0,-78.808)]))]),
                  Transform(translation=(0,12,0),
                    children=[
                    Shape(
                      appearance=Appearance(USE='HAZEGREY'),
                      geometry=Extrusion(creaseAngle=.85,crossSection=[(9,0),(8,-3.5),(6.5,-10.45),(-6.5,-10.45),(-8,-3.5),(-9,0)],scale=[(1.7,1),(1.7,1),(1.3,1),(.5,1),(.4,1),(.05,.1)],spine=[(0,0,-91.00),(0,0,-95.68),(0,0,-119.6),(0,0,-142),(0,0,-145),(0,0,-155.8)]))]),
                  Transform(translation=(0,12,0),
                    children=[
                    Shape(
                      appearance=Appearance(USE='HAZEGREY'),
                      geometry=Extrusion(beginCap=False,creaseAngle=0.85,crossSection=[(-7.485,-5.828),(-9,0),(9,0),(8,-3.5),(6.5,-10.45),(-6.5,-10.45),(-7.485,-5.828)],endCap=False,scale=[(1.7,1),(1.7,1)],solid=False,spine=[(0,0,-78.608002),(0,0,-91.199997)]))]),
                  Transform(DEF='DamagedSide',scale=(0.0001,0.0001,0.0001),translation=(0,12,0),
                    children=[
                    Shape(
                      geometry=IndexedFaceSet(coordIndex=[0,1,2,3,0,-1],creaseAngle=.85,solid=False,texCoordIndex=[1,2,3,0,1,-1],
                        coord=Coordinate(point=[(-11.1,-10.45,-78.508),(-12.95,-5.28,-78.508),(-12.95,-5.28,-91.3),(-11.1,-10.45,-91.3)]),
                        texCoord=TextureCoordinate(point=[(0,0),(1,0),(1,1),(0,1)])),
                      appearance=Appearance(
                        texture=ImageTexture(url=["ColeDamage.jpg","../../ShipsMilitary/DDGArleighBurkeUnitedStates/ColeDamage.jpg","http://web.nps.navy.mil~brutzman/Savage/Scenarios/UssColeTerroristAttack/ColeDamage.jpg"]),
                        material=Material(),))]),
                  ProtoInstance(DEF='ColePortSide',name='Exploder',
                    fieldValue=[
                    fieldValue(name='geometry',
                      children=[
                      IndexedFaceSet(DEF='ColeSide',coordIndex=[0,1,2,3,0,-1],creaseAngle=.85,solid=False,
                        coord=Coordinate(point=[(-11.1,-10.45,-78.508),(-12.95,-5.28,-78.508),(-12.95,-5.28,-91.3),(-11.1,-10.45,-91.3)]))]),
                    fieldValue(name='material',
                      children=[
                      Material(diffuseColor=(.7,.7,.7),shininess=.3)]),
                    fieldValue(name='initialPosition',value=(0,12,0)),
                    fieldValue(name='finalPosition',value=(65,5,-41)),
                ...
                Group(DEF='MAINDECKNONSKID',
                  ...
                  Transform(translation=(0,12,0),
                    ...
                    Shape(
                      appearance=Appearance(
                        texture=ImageTexture(DEF='NONSKID',url=["nonskid.jpg","../../ShipsMilitary/DDGArleighBurkeUnitedStates/nonskid.jpg","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/nonskid.jpg"])),
                    ...
                    Shape(
                      geometry=IndexedFaceSet(coordIndex=[2,3,7,6],solid=False,texCoordIndex=[0,1,2,3],
                        ...
                        texCoord=TextureCoordinate(point=[(0,0),(1,0),(1,1),(0,1)])),
                      appearance=Appearance(
                        texture=ImageTexture(url=["../../ShipsMilitary/DDGArleighBurkeUnitedStates/forwardvertrep.jpg","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/forwardvertrep.jpg"])))])]),
                Group(DEF='THREEGTG',
                  children=[
              ...
              LOD(range=[8000],
                ...
                Transform(
                  children=[
                  Inline(url=["FlightDeck.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/FlightDeck.x3d","FlightDeck.wrl","../../ShipsMilitary/DDGArleighBurkeUnitedStates/FlightDeck.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/FlightDeck.wrl"])]),
                Transform(),]),
              LOD(range=[8000],
                children=[
                Transform(rotation=(0,1,0,1.57),scale=(.7,.7,.7),translation=(2,4.6,-121),
                  children=[
                  Inline(url=["Gun.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/Gun.x3d","Gun.wrl","../../ShipsMilitary/DDGArleighBurkeUnitedStates/Gun.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/Gun.wrl"])]),
                Transform(),]),
                  ...
                  LOD(range=[450],
                    ...
                    Group(DEF='AFTDIRECTORS',
                      ...
                      Transform(translation=(0,17,-50),
                        children=[
                        Inline(DEF='DIRECTOR',url=["MissileDirector.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/MissileDirector.x3d","MissileDirector.wrl","../../ShipsMilitary/DDGArleighBurkeUnitedStates/MissileDirector.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/MissileDirector.wrl"])]),
                ...
                Transform(
                  ...
                  Group(DEF='FWDDECKHOUSE',
                    ...
                    Transform(DEF='FWDSTACK',
                      children=[
                      Shape(DEF='StackSupport',
                        appearance=Appearance(USE='TOPGREY'),
                        geometry=Extrusion(ccw=False,creaseAngle=.85,crossSection=[(-2.5,10.45),(-1.5,20.45),(1.5,20.45),(2.5,10.45),(-2.5,10.45)],scale=[(1.3,.1),(1.3,1),(1.3,1),(1.3,1)],solid=False,spine=[(0,0,-70.9),(0,0,-71.9),(0,0,-77.9),(0,0,-82.9)])),
              ...
              Transform(translation=(0,3.5,-24),
                #  Gun is based on Cruiser model from Savage. 
                children=[
                Inline(url=["../../Weapons/Missiles/Launchers.x3d","https://savage.nps.edu/Savage/Weapons/Missiles/Launchers.x3d","../../Weapons/Missiles/Launchers.wrl","https://savage.nps.edu/Savage/Weapons/Missiles/Launchers.wrl"])])]),
            TimeSensor(DEF='ExplosionClock',
              IS=IS(
                connect=[
                connect(nodeField='startTime',protoField='startExplosion')])),
            ROUTE(fromField='fraction_changed',fromNode='ExplosionClock',toField='set_fraction',toNode='ColePortSide'),
            PositionInterpolator(DEF='SideInterp',key=[0,0.1,1],keyValue=[(0.0001,0.0001,0.0001),(1,1,1),(1,1,1)]),
            ROUTE(fromField='fraction_changed',fromNode='ExplosionClock',toField='set_fraction',toNode='SideInterp'),
            ROUTE(fromField='value_changed',fromNode='SideInterp',toField='set_scale',toNode='DamagedSide'),
            ROUTE(fromField='startTime',fromNode='ExplosionClock',toField='startTime',toNode='ShockClock'),
            ROUTE(fromField='fraction_changed',fromNode='ShockClock',toField='set_fraction',toNode='ShockRockingInterpolator'),
            ROUTE(fromField='value_changed',fromNode='ShockRockingInterpolator',toField='set_rotation',toNode='ShockTransform')])])])),
    ProtoInstance(DEF='DDG-51',name='ArleighBurke'),
    TouchSensor(DEF='MyTouch',description='touch to activate'),
    ROUTE(fromField='touchTime',fromNode='MyTouch',toField='startExplosion',toNode='DDG-51')])
) # X3D model complete
...
print ("python x3d.py load successful for ArleighBurkePrototype.py")

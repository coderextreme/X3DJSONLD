...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_simc2_attenuation.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    PointLight(attenuation=(0,0,0.1),location=(0,0,4),radius=101),

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/GaribaldiRemoteNoTexture.x3d',name='identifier'),
...
print ("python x3d.py load successful for GaribaldiRemoteNoTexture.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure27_1VisibilitySensorDungeonSlidingDoors.x3d',name='title'),
    ...
    meta(content='Figure27_1VisibilitySensorDungeonSlidingDoors.png',name='Image'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter27SensingVisibilityProximityCollision/Figure27_1VisibilitySensorDungeonSlidingDoors.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(
      ...
      Sound(maxBack=60,maxFront=60,minBack=20,minFront=20,
        source=AudioClip(DEF='OpenSound',description='door clunks open',url=["clunk1.wav","../Chapter27SensingVisibilityProximityCollision/clunk1.wav","https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter27SensingVisibilityProximityCollision/clunk1.wav"])),
      Sound(maxBack=60,maxFront=60,minBack=20,minFront=20,
        source=AudioClip(DEF='CloseSound',description='door clunks shut',url=["clunk1.wav","../Chapter27SensingVisibilityProximityCollision/clunk1.wav","https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter27SensingVisibilityProximityCollision/clunk1.wav"])),
...
print ("python x3d.py load successful for Figure27_1VisibilitySensorDungeonSlidingDoors.py")

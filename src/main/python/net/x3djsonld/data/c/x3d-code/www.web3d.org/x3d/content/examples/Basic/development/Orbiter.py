...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Orbiter.x3d',name='title'),
    meta(content='Don Brutzman',name='creator'),
    meta(content='21 July 2001',name='created'),
    meta(content='20 October 2019',name='modified'),
    meta(content='A simple VRML/X3D scene graph example, used to illustrate and discuss schema suitability for X3D.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/development/Orbiter.x3d',name='identifier'),
      ...
      Group(DEF='MiniWorld',
        ...
        Shape(
          appearance=Appearance(
            texture=ImageTexture(url=["earth-topo.png","earth-topo.gif","https://www.web3d.org/x3d/content/examples/Basic/earth-topo.png","https://www.web3d.org/x3d/content/examples/Basic/earth-topo.gif"])),
          geometry=Sphere(),)]),
...
print ("python x3d.py load successful for Orbiter.py")

...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='default_primitivespl.x3d',name='title'),
    meta(content='default_primitivespl-front.jpg',name='Image'),
    meta(content='default_primitivespl-top.jpg',name='Image'),
    meta(content='default_primitivespl-left.jpg',name='Image'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/default_primitivespl.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='default_primitivespl.x3d'),
    Group(
      children=[
...
print ("python x3d.py load successful for default_primitivespl.py")

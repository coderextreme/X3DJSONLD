...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/development/KeySensorActivationKeySwitchTestInterchange.x3d',name='identifier'),
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ConformanceNist/Sensors/Keyboard/KeySensorActivationKeySwitchTestInterchange.x3d',name='reference'),
...
print ("python x3d.py load successful for KeySensorActivationKeySwitchTestInterchange.py")

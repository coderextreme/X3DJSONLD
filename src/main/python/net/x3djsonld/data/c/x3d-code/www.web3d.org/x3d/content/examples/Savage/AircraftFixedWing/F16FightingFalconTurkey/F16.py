...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='5 November 2018',name='modified'),
    ...
    meta(content='F16Drawing.jpg',name='drawing'),
    meta(content='F16FrontView.jpg',name='Image'),
    meta(content='F16FrontView2.jpg',name='Image'),
    meta(content='F16Missiles.jpg',name='Image'),
    meta(content='https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/F16.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(DEF='F16Transform',
      ...
      Transform(DEF='MainFrameTransform',scale=(3,3,3),
        ...
        Shape(DEF='Canopy',
          appearance=Appearance(
            material=Material(diffuseColor=(.25,.25,.25),transparency=0.8)),
        ...
        Shape(DEF='MainBodyAndWingEdges',
          appearance=Appearance(
            material=Material(diffuseColor=(.1796,.1914,.2382))),
        ...
        Shape(DEF='ExhaustEntranceFrontBottomPart',
          appearance=Appearance(
            material=Material(diffuseColor=(.2304,.2304,.2304))),
        ...
        Shape(DEF='RearExhaustExitPartLastPartOfMainBody',
          appearance=Appearance(
            material=Material(diffuseColor=(.37,.37,.37),shininess=.5)),
        ...
        Shape(DEF='WingsAndTail',
          appearance=Appearance(
            material=Material(emissiveColor=(.1796,.1914,.2382))),
      ...
      Transform(DEF='CockpitTransform',rotation=(1,0,0,-0.1),scale=(0.045,0.045,0.045),translation=(0,1,-10),
        children=[
        Inline(url=["Cockpit.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/Cockpit.x3d","Cockpit.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/Cockpit.wrl"])]),
      Transform(DEF='SeatTransform',rotation=(-1,0,0,-0.1),scale=(0.9,0.9,0.9),translation=(0,0,-8.3),
        children=[
        Inline(url=["Seat.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/Seat.x3d","Seat.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/Seat.wrl"])]),
      Transform(DEF='FrontWheelTransform',center=(0,2.5,0),rotation=(-1,0,0,1.92),translation=(0.7,-5.2,-6.5),
        ...
        children=[
        Inline(url=["FrontWheel.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/FrontWheel.x3d","FrontWheel.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/FrontWheel.wrl"])]),
      Transform(DEF='RearLeftWheelTransform',center=(0,2.5,0),rotation=(1,0,1,1.92),translation=(-2.95,-5,7),
        ...
        children=[
        Inline(url=["RearLeftWheel.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/RearLeftWheel.x3d","RearLeftWheel.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/RearLeftWheel.wrl"])]),
      Transform(DEF='RearRightWheelTransform',center=(0,2.5,0),rotation=(-1,0,-1,1.92),translation=(2.95,-5,7),
        #  Rear wheels are taken from the Savage Library and re-animated (from F18 Blue Angel) 
        children=[
        Inline(url=["RearRightWheel.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/RearRightWheel.x3d","RearRightWheel.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/RearRightWheel.wrl"])]),
      Transform(DEF='CockpitButtonsTransform',
        children=[
        Transform(DEF='UpButtonTransform',rotation=(1,0,0,1.57),scale=(.008,.008,.008),translation=(-0.95,1.05,-10),
          children=[
          Shape(
            geometry=Cylinder(height=1,radius=4),
            appearance=Appearance(
              material=Material(diffuseColor=(1,0,0),shininess=.8))),
          TouchSensor(DEF='TouchSensorUp',description='click for gears up')]),
        Transform(DEF='DownButtonTransform',rotation=(1,0,0,1.57),scale=(.008,.008,.008),translation=(-0.83,1.05,-10),
          children=[
          Shape(
            geometry=Cylinder(height=1,radius=4),
            appearance=Appearance(
              material=Material(diffuseColor=(1,1,0),shininess=.8))),
          TouchSensor(DEF='TouchSensorDown',description='click for gears down')]),
        Transform(DEF='GearUpTextTransform',scale=(.06,.06,.06),translation=(-.65,1.55,-10),
          children=[
          Shape(
            geometry=Text(string=["RED Button","Gear Up"]),
            appearance=Appearance(
              material=Material(diffuseColor=(1,0,0))))]),
        Transform(DEF='GearDownTextTransform',scale=(.06,.06,.06),translation=(-.65,1.35,-10),
          children=[
          Shape(
            geometry=Text(length=[5.5],string=["YELLOW Button","Gear Down"]),
            appearance=Appearance(
              material=Material(diffuseColor=(1,1,0))))]),
        Transform(DEF='FireButtonTransform',rotation=(1,0,0,1.57),scale=(.008,.008,.008),translation=(.52,1.6,-10),
          children=[
          Shape(
            geometry=Cylinder(height=1,radius=4),
            appearance=Appearance(
              material=Material(diffuseColor=(0,.75,.18),shininess=.8))),
          TouchSensor(DEF='FireSensor',description='click to fire')]),
        Transform(DEF='FireTextTransform',scale=(.06,.06,.06),translation=(.36,1.5,-10),
          children=[
          Shape(
            geometry=Text(string=["Target Locked","      FIRE!..","(Green Button)"]),
            appearance=Appearance(
              material=Material(diffuseColor=(0,.75,.18))))])]),
      ...
      Viewpoint(description='F16 Front View',orientation=(-0.007,0.995,0.102,3.1152),position=(-0.1,13.4,-65)),
      Viewpoint(description='Cockpit Target View',orientation=(-0.834,-0.523,-0.176,0.0875),position=(0,2.4,-7.9)),
      Transform(DEF='NoseAntennaTransform',rotation=(1,0,0,1.57),translation=(0,-.275,-21),
        children=[
        Shape(
    ...
    OrientationInterpolator(DEF='GearUpInterpolator',key=[0,0.5,1.0],keyValue=[(1,0,0,0.0),(1,0,0,-0.79),(1,0,0,-1.92)]),
    ...
    OrientationInterpolator(DEF='GearDownInterpolator',key=[0,0.5,1.0],keyValue=[(1,0,0,-1.92),(1,0,0,-0.79),(1,0,0,0.0)]),
    ...
    OrientationInterpolator(DEF='RRearInterUp1',key=[0,0.5,1.0],keyValue=[(-1,0,-1,0.0),(-1,0,-1,0.44),(-1,0,-1,1.92)]),
    OrientationInterpolator(DEF='RRearInterDown1',key=[0,0.5,1.0],keyValue=[(-1,0,-1,1.92),(-1,0,-1,0.44),(-1,0,-1,0.0)]),
    ...
    OrientationInterpolator(DEF='LRearInterUp1',key=[0,0.5,1.0],keyValue=[(1,0,1,0.0),(1,0,1,0.44),(1,0,1,1.92)]),
    OrientationInterpolator(DEF='LRearInterDown1',key=[0,0.5,1.0],keyValue=[(1,0,1,1.92),(1,0,1,0.44),(1,0,1,0.0)]),
    ...
    Transform(DEF='RightmostAmraamTransform',rotation=(-1,0,0,1.57),scale=(1.4,1.4,1.4),translation=(15,-1.5,9.5),
      children=[
    ...
    Transform(DEF='LeftmostAmraamTransform',rotation=(-1,0,0,1.57),scale=(1.4,1.4,1.4),translation=(-15,-1.5,9.5),
      children=[
      Transform(rotation=(0,0,1,1.570796),
        children=[
        Inline(USE='Amraam')])]),
    Transform(DEF='SidewinderHolderTransformRight',rotation=(0,1,0,1.57),scale=(6,3,3),translation=(9,-1.125,8),
      children=[
      Inline(DEF='SidewinderHolder',url=["SidewinderHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/SidewinderHolder.x3d","SidewinderHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/SidewinderHolder.wrl"])]),
    ...
    Transform(DEF='TurkishFlagTransformLeft',rotation=(0,-1,0,1.57),scale=(.3,.25,.3),translation=(-.01,8,19.5),
      children=[
      Inline(url=["TurkishFlagLeft.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/TurkishFlagLeft.x3d","TurkishFlagLeft.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/TurkishFlagLeft.wrl"])]),
    Transform(DEF='TurkishFlagTransformRight',rotation=(0,1,0,1.57),scale=(.3,.25,.3),translation=(.01,8,20.5),
      children=[
      Inline(url=["TurkishFlagRight.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/TurkishFlagRight.x3d","TurkishFlagRight.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/TurkishFlagRight.wrl"])]),
    Transform(DEF='AmraamHolderTransformLeft',translation=(-12,-.176,10.7),
      children=[
      Inline(DEF='AmraamHolder',url=["AmraamHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/AmraamHolder.x3d","AmraamHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/AmraamHolder.wrl"])]),
    Transform(DEF='AmraamHolderTransformRight',translation=(12,-.176,10.7),
      children=[
      Inline(USE='AmraamHolder')]),
    Transform(DEF='AmraamInnerTransformRight',rotation=(-1,0,0,1.57),scale=(1.4,1.4,1.4),translation=(12,-1.6,8.4),
      children=[
      Transform(rotation=(0,0,1,1.570796),
        children=[
        Inline(USE='Amraam')])]),
    Transform(DEF='AmraamInnerTransformLeft',rotation=(-1,0,0,1.57),scale=(1.4,1.4,1.4),translation=(-12,-1.6,8.4),
      children=[
      Transform(rotation=(0,0,1,1.570796),
        children=[
        Inline(USE='Amraam')])]),
    Transform(DEF='SidewinderTransformLeft',rotation=(-1,0,0,1.57),scale=(1.6,1.6,1.6),translation=(-8.7,-2.6,8),
      children=[
      Transform(rotation=(0,0,1,1.570796),
        children=[
    ...
    Transform(DEF='SidewinderTransformRight',rotation=(-1,0,0,1.57),scale=(1.6,1.6,1.6),translation=(8.7,-2.6,8),
      children=[
      Transform(rotation=(0,0,1,1.570796),
        children=[
    ...
    Transform(DEF='FuelTankHolderTransformLeft',rotation=(0,1,0,1.57),scale=(1.5,1.5,1.5),translation=(-4.8,-1.125,6),
      children=[
      Inline(DEF='FuelTankHolder',url=["FuelTankHolder.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/FuelTankHolder.x3d","FuelTankHolder.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/FuelTankHolder.wrl"])]),
    ...
    Transform(DEF='FuelTankTransformRight',rotation=(-1,0,0,1.57),scale=(1.5,1.5,1.5),translation=(5,-2.85,5.5),
      children=[
      Inline(DEF='FuelTank',url=["FuelTank.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/FuelTank.x3d","FuelTank.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/FuelTank.wrl"])]),
    Transform(DEF='FuelTankTransformLeft',rotation=(-1,0,0,1.57),scale=(1.5,1.5,1.5),translation=(-5,-2.85,5.5),
      children=[
      Inline(USE='FuelTank')]),
    Transform(DEF='InlineCoverOfPlaneTransform',
      children=[
      Shape(
        geometry=Box(size=(4.15,.1,20)),
        appearance=Appearance(
          material=Material(diffuseColor=(.25,.25,.25))))]),
    Transform(DEF='TargetHelicopterTransform',translation=(16,-50,-500),
      children=[
      Inline(url=["Target.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/Target.x3d","Target.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/Target.wrl"])]),
    TimeSensor(DEF='FireClock',cycleInterval=8),
    PositionInterpolator(DEF='MissilePath',key=[0.0,.1,1.0],keyValue=[(-15.65,0,4.5),(-15.65,-2,4.5),(16,-50,-500)]),
...
print ("python x3d.py load successful for F16.py")

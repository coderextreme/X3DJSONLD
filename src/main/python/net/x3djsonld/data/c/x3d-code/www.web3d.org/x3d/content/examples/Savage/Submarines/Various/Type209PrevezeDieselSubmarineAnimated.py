...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='Alper SINAV',name='creator'),
    meta(content='https://savage.nps.edu/Savage/Submarines/Various/Type209PrevezeDieselSubmarineAnimated.x3d',name='identifier'),
...
print ("python x3d.py load successful for Type209PrevezeDieselSubmarineAnimated.py")

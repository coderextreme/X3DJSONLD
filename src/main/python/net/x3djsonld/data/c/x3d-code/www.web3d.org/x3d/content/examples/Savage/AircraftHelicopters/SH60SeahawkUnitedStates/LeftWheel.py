...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='LeftWheel.x3d',name='title'),
    meta(content='Michael Collins',name='creator'),
    meta(content='LT Terry D. Norbraten, USN',name='.modifier'),
    meta(content='20 March 2001',name='created'),
    meta(content='12 January 2014',name='modified'),
    meta(content='Helicopter left main wheel. Black taurus for wheel and grey cylinders for axil and strut support. Box for floatation pylons.',name='description'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='http://www.fas.org/man/dod-101/sys/ac/sh-60.htm',name='reference'),
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/SH60SeahawkUnitedStates/LeftWheel.x3d',name='identifier'),
...
print ("python x3d.py load successful for LeftWheel.py")

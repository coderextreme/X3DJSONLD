...
newModel=X3D(profile='Immersive',version='3.1',
  head=head(
    ...
    meta(content='PhoenixEspduExample.x3d',name='title'),
    meta(content='Extern prototype declaration for a DIS enabled Phoenix AUV for cut and paste into a VRML scene. Also includes an example instantiation.',name='description'),
    ...
    meta(content='AriesEspduExample.x3d',name='reference'),
    meta(content='Distributed Interactive Simulation DIS ESPDU Phoenix AUV',name='subject'),
    meta(content='https://savage.nps.edu/Savage/Robots/UnmannedUnderwaterVehicles/PhoenixEspduExample.x3d',name='identifier'),
...
print ("python x3d.py load successful for PhoenixEspduExample.py")

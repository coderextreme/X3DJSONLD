...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    children=[
    meta(content='GroupExample.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/GroupExample.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Group.x3d'),
    Background(skyColor=[(1,1,1)]),
    Viewpoint(description='Book View',orientation=(-0.668,-0.724,-0.174,0.7),position=(-1.93,1.78,3.28)),
    Group(DEF='BoxAndSphereTogether',
      children=[
      Shape(
      ...
      Shape(
        appearance=Appearance(
          material=Material(DEF='Pulsar',diffuseColor=(0,0,1))),
...
print ("python x3d.py load successful for GroupExample.py")

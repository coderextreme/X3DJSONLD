...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/CockpitTop.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(
      ...
      Shape(
        ...
        geometry=Extrusion(beginCap=False,convex=False,creaseAngle=1.5,crossSection=[(-0.700,1.2),(-0.625,1.3),(0.625,1.3),(0.700,1.2)],endCap=False,solid=False,spine=[(0.0,0.0,0.0),(0.0,0.6,0.0)])),
      Transform(rotation=(1.0,0.0,0.0,1.57),translation=(0.0,0.600,1.3),
        children=[
        Shape(
          appearance=Appearance(USE='GREEN'),
          geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,-1,3,2,1,0,-1,1,4,5,2,-1,2,5,4,1,-1],
            coord=Coordinate(point=[(0.0,0.0,0.0),(0.0,-0.2,-0.5),(-0.05,-0.2,-0.5),(-0.05,0.0,0.0),(0.0,-0.5,-0.7),(-0.05,-0.5,-0.7)])))]),
      Transform(center=(0.0,0.0,0.45),rotation=(1.0,0.0,0.0,0.8),translation=(-0.67,0.560,0.80),
        children=[
        Shape(DEF='DOOR_BAR',
          appearance=Appearance(USE='GREEN'),
          geometry=Box(size=(0.05,0.02,0.9)))]),
      Transform(center=(0.0,0.0,0.45),rotation=(1.0,0.0,0.0,0.8),translation=(0.67,0.560,0.80),
        children=[
        Shape(USE='DOOR_BAR')]),

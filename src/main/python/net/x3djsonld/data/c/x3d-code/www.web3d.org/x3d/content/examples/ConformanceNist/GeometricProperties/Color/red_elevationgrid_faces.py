...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='red_elevationgrid_faces.x3d',name='title'),
    meta(content='red_elevationgrid_faces-front.jpg',name='Image'),
    meta(content='red_elevationgrid_faces-rear.jpg',name='Image'),
    meta(content='red_elevationgrid_faces-top.jpg',name='Image'),
    meta(content='red_elevationgrid_faces-bottom.jpg',name='Image'),
    meta(content='red_elevationgrid_faces-left.jpg',name='Image'),
    meta(content='red_elevationgrid_faces-right.jpg',name='Image'),
    ...
    meta(content='This world tests browser ability to apply a single color to an ElevationGrid, applying the color red to all faces.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/Color/red_elevationgrid_faces.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='red_elevationgrid_faces.x3d'),
...
print ("python x3d.py load successful for red_elevationgrid_faces.py")

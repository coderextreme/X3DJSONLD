...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='tetrahydrofuran.x3d',name='title'),
    meta(content='Autogenerated version of tetrahydrofuran.x3d scene produced from tetrahydrofuran.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='tetrahydrofuran.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/tetrahydrofuran.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='tetrahydrofuran.x3d'),
    ...
    Viewpoint(description='Inspect tetrahydrofuran',position=(0,2,20)),
    #  <?xml-stylesheet type="text/xsl" href="generic.xsl" ?> 
    #  CML document - tetrahydrofuran - karne - 7/8/00 
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["tetrahydrofuran: C4 H8 O"])])]),
      Transform(translation=(0,5,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["molecular weight: 72.1066"])])]),
      Transform(translation=(0,4,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["melting point: -108.3"])])]),
      Transform(translation=(0,3,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["boiling point: 65"])])]),
      Transform(translation=(0,2,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["specific gravity: 0.886"])])]),
      Transform(translation=(0,1,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["water solubility: 30"])])]),
      Transform(
        children=[
        ProtoInstance(name='ano2_text',
          fieldValue=[
          fieldValue(name='txt',value=["CAS: 109-99-9"])])]),
      Transform(translation=(0,-1,0),
        children=[
        ProtoInstance(name='ano2_text',
          fieldValue=[
          fieldValue(name='txt',value=["ACX: I1001473"])])]),
      Transform(translation=(0,-2,0),
        children=[
        ProtoInstance(name='ano2_text',
          fieldValue=[
          fieldValue(name='txt',value=["DOT: UN 2056"])])]),
      Transform(translation=(0,-3,0),
        children=[
        ProtoInstance(name='ano2_text',
          fieldValue=[
          fieldValue(name='txt',value=["RTECS: LU5950000"])])]),
      Transform(translation=(0,-4,0),
        children=[
        ProtoInstance(name='ano2_text',
          fieldValue=[
          fieldValue(name='txt',value=["comments: Colorless liquid with an ether-like odor detectable at 2 to 50 ppm. HYGROSCOPIC"])])])]),
    Group(
      children=[
      Transform(
        children=[
        ProtoInstance(DEF='tetrahydrofuran_karne_a_1',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(0.0300,-1.1700,0.0000))])]),
      Transform(
        children=[
        ProtoInstance(DEF='tetrahydrofuran_karne_a_2',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(-1.2200,-0.2900,0.0000))])]),
      Transform(
        children=[
        ProtoInstance(DEF='tetrahydrofuran_karne_a_3',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(1.2400,-0.2800,0.0000))])]),
      Transform(
        children=[
        ProtoInstance(DEF='tetrahydrofuran_karne_a_4',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(-0.7700,1.1600,0.0000))])]),
      Transform(
        children=[
        ProtoInstance(DEF='tetrahydrofuran_karne_a_5',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(0.7700,1.1600,0.0000))])])]),
    Group(
      children=[
      ProtoInstance(DEF='tetrahydrofuran_karne_b_1',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(-1.2200,-0.2900,0.0000),(0.0300,-1.1700,0.0000)])]),
      ProtoInstance(DEF='tetrahydrofuran_karne_b_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.2400,-0.2800,0.0000),(0.0300,-1.1700,0.0000)])]),
      ProtoInstance(DEF='tetrahydrofuran_karne_b_3',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(-0.7700,1.1600,0.0000),(-1.2200,-0.2900,0.0000)])]),
      ProtoInstance(DEF='tetrahydrofuran_karne_b_4',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(0.7700,1.1600,0.0000),(1.2400,-0.2800,0.0000)])]),
      ProtoInstance(DEF='tetrahydrofuran_karne_b_5',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(-0.7700,1.1600,0.0000),(0.7700,1.1600,0.0000)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for tetrahydrofuran.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Water.x3d',name='title'),
    meta(content='Translucent water mass with motion',name='description'),
    meta(content='modified by Scott Rosetti, LT USNR',name='creator'),
    meta(content='20 July 2003',name='created'),
    meta(content='2 January 2019',name='modified'),
    meta(content='James Harney: http://faculty.nps.edu/brutzman/ShipsMilitary/DDGArleighBurkeUnitedStates/water.wrl',name='reference'),
    meta(content='Osa-II, missile boat, patrol craft, SAVAGE, X3D',name='subject'),
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/MissileAttackBoatOsaII/Water.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(
      ...
      Group(DEF='WATER',
        children=[
        Transform(scale=(1,.5,1),translation=(0,-30.5,-.1),
          children=[
          Transform(scale=(20,20,.3),
            children=[
            Group(
              children=[
              Transform(
                ...
                Shape(
                  ...
                  appearance=Appearance(
                    material=Material(emissiveColor=(0,.6,.95),shininess=.3,transparency=.3)))])])])]),
...
print ("python x3d.py load successful for Water.py")

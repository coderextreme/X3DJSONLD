...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='TerroristBoatBoxManOnboardPrototype.x3d',name='title'),
    ...
    meta(content='Simple model of fiberglass skiff used by terrorists to attack the USS COLE in Aden Harbor, Yemen with Boxman driving. Aligned down positive x axis as required for Savage vehicle models.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/Scenarios/UssColeTerroristAttack/TerroristBoatBoxManOnboardPrototype.x3d',name='identifier'),
    ...
    ProtoDeclare(name='TerroristBoat',
      ...
      ProtoBody=ProtoBody(
        ...
        Group(
          ...
          PositionInterpolator(DEF='BoatPosit',key=[0,.325,.91],keyValue=[(0,0,0),(0,-15,0),(0,-.5,0)]),
          ...
          OrientationInterpolator(DEF='DeadOrient',key=[.4,.9,1],keyValue=[(1,0,0,0.00),(1,0,0,3.14),(1,0,0,3.14)]),
          Transform(DEF='BoatTransform',
            ...
            Transform(rotation=(0,1,0,1.57),translation=(1,-.1,0),
              children=[
              Inline(url=["../../../Basic/HumanoidAnimation/BoxMan.x3d","http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/BoxMan.x3d","../../../Basic/HumanoidAnimation/BoxMan.wrl","http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/BoxMan.wrl"])])]),
...
print ("python x3d.py load successful for TerroristBoatBoxManOnboardPrototype.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='SkidLeft.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/AH1SuperCobraUnitedStates/SkidLeft.x3d',name='identifier'),
...
print ("python x3d.py load successful for SkidLeft.py")

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='ArcClose2dExample.x3d',name='title'),
    meta(content='Example of ArcClose2D showing PIE or CHORD subsections of circular geometry.',name='description'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter10Geometry2D/ArcClose2dExample.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Viewpoint(description='ArcClose2D example'),
...
print ("python x3d.py load successful for ArcClose2dExample.py")

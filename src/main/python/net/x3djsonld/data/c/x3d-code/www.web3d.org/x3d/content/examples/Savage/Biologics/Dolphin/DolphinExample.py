...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='DolphinExample.x3d',name='title'),
    ...
    meta(content='29 December 2002',name='modified'),
    ...
    meta(content='https://savage.nps.edu/Savage/Biologics/Dolphin/DolphinExample.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    ExternProtoDeclare(name='Dolphin',url=["DolphinPrototype.wrl#Dolphin","https://savage.nps.edu/Savage/Biologics/Dolphin/DolphinPrototype.wrl#Dolphin","DolphinPrototype.x3d#Dolphin","https://savage.nps.edu/Savage/Biologics/Dolphin/DolphinPrototype.x3d#Dolphin"],
      field=[
...
print ("python x3d.py load successful for DolphinExample.py")

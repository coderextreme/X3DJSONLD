...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='default_fog.x3d',name='title'),
...
print ("python x3d.py load successful for default_fog.py")

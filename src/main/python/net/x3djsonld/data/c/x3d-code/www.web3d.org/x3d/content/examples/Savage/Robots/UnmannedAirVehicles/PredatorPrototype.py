...
newModel=X3D(profile='Immersive',version='3.1',
  head=head(
    children=[
    meta(content='PredatorPrototype.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/Robots/UnmannedAirVehicles/PredatorPrototype.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    ProtoDeclare(appinfo='Predator unmanned air vehicle (UAV)',name='Predator',
      ...
      ProtoBody=ProtoBody(
        children=[
        Transform(DEF='PredatorTransform',
          IS=IS(
            connect=[
              ...
              Transform(rotation=(1,0,0,-1.571),
                ...
                Group(DEF='RideAlongViewpoints',
                  ...
                  Transform(translation=(0,1,3),
                    children=[
                    Viewpoint(description='Predator Starboard Side, 3m')]),
                  Transform(translation=(0,0,15),
                    children=[
                    Viewpoint(description='Predator Starboard Side, 15m')]),
                  Transform(rotation=(0,1,0,0.7854),translation=(5,0,5),
                    children=[
                    Viewpoint(description='Predator Starboard Bow, 7m')]),
                  Transform(rotation=(0,1,0,-0.7854),translation=(-5,1,5),
                    children=[
                    Viewpoint(description='Predator Starboard Stern, 7m')]),
                  Transform(rotation=(0,1,0,3.1415927),translation=(0,1,-3),
                    children=[
                    Viewpoint(description='Predator Port Side, 3m')]),
                  Transform(rotation=(0,1,0,3.1415927),translation=(0,1,-15),
                    children=[
                    Viewpoint(description='Predator Port Side, 15m')]),
                  Transform(rotation=(0,1,0,2.3562),translation=(5,0,-5),
                    children=[
                    Viewpoint(description='Predator Port Bow, 7m')]),
                  Transform(rotation=(0,1,0,-2.3562),translation=(-5,1,-5),
                    children=[
                    Viewpoint(description='Predator Starboard Stern, 7m')]),
                  Transform(rotation=(0,1,0,1.571),translation=(10,0,0),
                    children=[
                    Viewpoint(description='Predator Bow On')])])])])])])])),
    #  ========== 
    Viewpoint(description='Predator Prototype'),
    Group(
      children=[
    ...
    Anchor(description='Predator example: AriesOffPanamaCity.x3d',url=["../../AuvWorkbench/OperatingAreas/AriesOffPanamaCity.x3d","https://savage.nps.edu/Savage/AuvWorkbench/OperatingAreas/AriesOffPanamaCity.x3d","../../AuvWorkbench/OperatingAreas/AriesOffPanamaCity.wrl","https://savage.nps.edu/Savage/AuvWorkbench/OperatingAreas/AriesOffPanamaCity.wrl"],
      children=[
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(0,1,1),emissiveColor=(0,1,1))),
        geometry=Text(string=["PredatorPrototype","is a prototype definition file","","click on text to view","Predator example"],
...
print ("python x3d.py load successful for PredatorPrototype.py")

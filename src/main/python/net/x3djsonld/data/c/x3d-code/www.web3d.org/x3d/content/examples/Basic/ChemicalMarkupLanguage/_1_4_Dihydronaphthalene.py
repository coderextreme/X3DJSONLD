...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='_1-4-Dihydronaphthalene.x3d',name='title'),
    meta(content='Autogenerated version of _1-4-Dihydronaphthalene.x3d scene produced from _1-4-Dihydronaphthalene.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='_1-4-Dihydronaphthalene.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/_1-4-Dihydronaphthalene.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='_1-4-Dihydronaphthalene.x3d'),
    ...
    Viewpoint(description='Inspect _1-4-Dihydronaphthalene',position=(0,2,20)),
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["_1-4-Dihydronaphthalene: C10 H10"])])]),
      ...
      Transform(translation=(0,4,0),
        ...
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["melting point: 207"])])]),
      Transform(translation=(0,3,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["boiling point: -35.8"])])]),
    ...
    Group(
      ...
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a1',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(0.9478,1.7879,0.8809))])]),
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a2',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(0.9477,3.1805,0.8809))])]),
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a3',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.1499,1.0958,0.8809))])]),
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a4',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.1502,3.8723,0.8809))])]),
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a5',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.3665,3.1822,0.8809))])]),
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a6',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.3665,1.7856,0.8809))])]),
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a7',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(4.6338,3.9703,0.8814))])]),
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a8',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(4.6336,0.9973,0.8813))])]),
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a9',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(5.8696,1.8177,0.8716))])]),
      Transform(
        children=[
        ProtoInstance(DEF='_1_4-dihydronaphthalene_a10',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(5.8698,3.1496,0.8715))])])]),
    Group(
      children=[
      ProtoInstance(DEF='_1_4-dihydronaphthalene_b11',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.3665,3.1822,0.8809),(4.6338,3.9703,0.8814)])]),
      ProtoInstance(DEF='_1_4-dihydronaphthalene_b12',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(4.6336,0.9973,0.8813),(3.3665,1.7856,0.8809)])]),
      ProtoInstance(DEF='_1_4-dihydronaphthalene_b13',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(4.6338,3.9703,0.8814),(5.8698,3.1496,0.8715)])]),
      ProtoInstance(DEF='_1_4-dihydronaphthalene_b16',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(5.8696,1.8177,0.8716),(4.6336,0.9973,0.8813)])]),
      ProtoInstance(DEF='_1_4-dihydronaphthalene_b19',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(5.8498,3.1496,0.8715),(5.849600000000001,1.8177,0.8716)])]),
      ProtoInstance(DEF='_1_4-dihydronaphthalene_b19_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(5.889799999999999,3.1496,0.8715),(5.8896,1.8177,0.8716)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for _1-4-Dihydronaphthalene.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='PortBlowerHouse.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/AmphibiousVehicles/LCAC/PortBlowerHouse.x3d',name='identifier'),
  ...
  Scene=Scene(
      ...
      Transform(DEF='FourthRear',translation=(-4.43,0,0),
        ...
        Transform(
          ...
          Transform(
            ...
            Shape(
              appearance=Appearance(
                material=Material(diffuseColor=(0.15,0.66,0.66))),
              geometry=IndexedFaceSet(coordIndex=[0,1,2,3,4,-1],solid=False,
                coord=Coordinate(point=[(0,-2,1.6125),(0,-1,1.2125),(0,-1,-1.2125),(0,-2,-1.6125),(0,-2,1.6125)])))]),
          Transform(
            children=[
    ...
    Transform(DEF='CenterThingy',rotation=(0,0,1,1.57),translation=(-1.64,-3,0),
      ...
      Shape(
        ...
        appearance=Appearance(
          material=Material(diffuseColor=(0.4,0.4,0.45))))]),
...
print ("python x3d.py load successful for PortBlowerHouse.py")

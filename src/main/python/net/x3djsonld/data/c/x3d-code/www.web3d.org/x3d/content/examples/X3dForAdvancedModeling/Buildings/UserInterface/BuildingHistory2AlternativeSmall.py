...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='User interface panel for architectural models - Example historic building inside the interface panel - Earlier age model 2 - Alternative',name='description'),

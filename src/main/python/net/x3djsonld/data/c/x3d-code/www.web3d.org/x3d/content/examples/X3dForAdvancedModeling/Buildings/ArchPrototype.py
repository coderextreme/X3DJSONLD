...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://x3dgraphics.com/examples/X3dForAdvancedModeling/Buildings/ArchPrototype.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ProtoDeclare(appinfo='Create an arch. Can modify general parameters: clearSpanWidth, riseHeight, depth, topAbutmentHeight, pierWidth, pierHeight. - Possibility to create shapes related to an arch: ArchHalf; IntradosOnly; ArchFilled; ArchHalfFilled; Lintel. See the reference file ArchModelingDiagrams.pdf to find further information. See also ArchPrototypeScript_more_readable.js.js.',name='ArchPrototype',
      ...
      ProtoBody=ProtoBody(
        ...
        Script(DEF='ArchPrototypeScript',url=["ArchPrototypeScript.js","https://x3dgraphics.com/examples/X3dForAdvancedModeling/Buildings/ArchPrototypeScript.js"],
          #  INPUT PARAMETERS 
          #  General parameters 
    ...
    Shape(
      geometry=Text(string=["TODO: internal and external","prototype tests","ArchPrototype.x3d"],
...
print ("python x3d.py load successful for ArchPrototype.py")

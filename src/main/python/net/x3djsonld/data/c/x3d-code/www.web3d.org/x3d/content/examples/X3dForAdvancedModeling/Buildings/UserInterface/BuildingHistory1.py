...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='BuildingHistory1.x3d',name='title'),
    meta(content='User interface panel for architectural models - Example historic building - Earlier age model 1',name='description'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(0,1.3,-10),
      ...
      Shape(DEF='BackWall2',
        ...
        appearance=Appearance(
          material=Material(diffuseColor=(1,0.75,0.25))))]),
    Transform(translation=(10,1.3,-10),
      children=[
      Shape(DEF='BackWall3',
        geometry=Box(size=(11.5,2.52,0.9)),
        appearance=Appearance(
          material=Material(diffuseColor=(1,0.75,0.25))))]),
    Transform(translation=(10.5,1.3,-0.45),
      children=[
      Shape(DEF='FrontWall',
        geometry=Box(size=(10.9,2.52,0.9)),
        appearance=Appearance(
          material=Material(diffuseColor=(1,0.75,0.25))))]),
    Transform(translation=(15.5,1.3,-5.45),
      children=[
      Shape(DEF='rightWall',
        geometry=Box(size=(0.9,2.52,10)),
        appearance=Appearance(
          material=Material(diffuseColor=(1,0.75,0.25))))]),
    Transform(translation=(5.09,2.51,-5),
      children=[
      Shape(DEF='roof2',
        geometry=Box(size=(21.68,0.1,10.02)),
        appearance=Appearance(
          material=Material(diffuseColor=(1,0.75,0.25))))])])
) # X3D model complete
...
print ("python x3d.py load successful for BuildingHistory1.py")

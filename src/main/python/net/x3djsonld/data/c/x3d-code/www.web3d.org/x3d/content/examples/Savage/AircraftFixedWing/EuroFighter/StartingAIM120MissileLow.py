...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='11 October 2004',name='modified'),
  ...
  Scene=Scene(
    #  A rotating missile with flame tail 
    children=[
    ...
    Viewpoint(description='Default View started missile low',position=(10,0,40))])
) # X3D model complete
...
print ("python x3d.py load successful for StartingAIM120MissileLow.py")

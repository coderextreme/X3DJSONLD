...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='scale_primitives.x3d',name='title'),
    meta(content='scale_primitives-front.jpg',name='Image'),
    meta(content='scale_primitives-rear.jpg',name='Image'),
    meta(content='scale_primitives-top.jpg',name='Image'),
    meta(content='scale_primitives-bottom.jpg',name='Image'),
    meta(content='scale_primitives-left.jpg',name='Image'),
    meta(content='scale_primitives-right.jpg',name='Image'),
...
print ("python x3d.py load successful for scale_primitives.py")

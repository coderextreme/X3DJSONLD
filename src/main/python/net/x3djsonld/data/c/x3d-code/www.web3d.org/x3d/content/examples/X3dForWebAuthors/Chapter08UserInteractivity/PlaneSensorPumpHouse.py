...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter08UserInteractivity/PlaneSensorPumpHouse.x3d',name='identifier'),
...
print ("python x3d.py load successful for PlaneSensorPumpHouse.py")

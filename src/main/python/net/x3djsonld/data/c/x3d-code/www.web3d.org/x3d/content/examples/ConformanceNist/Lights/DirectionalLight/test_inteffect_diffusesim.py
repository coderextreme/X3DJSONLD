...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='This test addresses the effect of the light intensity on the diffuse color of simple geometry. One row of simple geometry is drawn in the local coordinate system and a DirectionalLight is also defined with intensity 0 and color 1 1 1. The test starts by clicking on the text above the geometry. The intensity of the light is increased as the animation progresses and the diffuse color brightness of the objects should also increase. Intensity values range from 0 to 1. The geometry are originally defined with a diffuseColor of 0 0 1.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_inteffect_diffusesim.x3d',name='identifier'),

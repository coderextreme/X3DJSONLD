...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='default_binding_proto-movie.mpg',name='MovingImage'),
    ...
    meta(content='Test Fog PROTO binding. This world has a single Fog node inside of a PROTO. The Fog node has a color value of 1 0 0 (red). The PROTO is instantiated in this file. Because this is the first and only Fog node in the file, and the PROTO is instantiated, the Fog node should bind to the current local coordinate system. The result should be : a Box geometry, colored red by the Fog node, should be rendered in this world.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Fog/default_binding_proto.x3d',name='identifier'),

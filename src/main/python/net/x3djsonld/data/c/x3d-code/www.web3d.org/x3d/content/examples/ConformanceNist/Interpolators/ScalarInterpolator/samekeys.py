...
newModel=X3D(profile='Interactive',version='3.0',
  ...
  Scene=Scene(
    ...
    ScalarInterpolator(DEF='SCALAR_INTERPOLATOR',key=[0,0.5,0.5,0.5,1],keyValue=[0,0.5,1,0.5,0]),
    Group(
      children=[
      Transform(DEF='TRANS',
        children=[

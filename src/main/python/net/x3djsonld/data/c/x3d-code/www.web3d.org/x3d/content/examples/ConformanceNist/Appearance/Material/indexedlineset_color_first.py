...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='indexedlineset_color_first.x3d',name='title'),
    meta(content='indexedlineset_color_first-front.jpg',name='Image'),
    ...
    meta(content='Test precedence of the Color node over emissiveColor for an IndexedLineSet. The IndexedLineSet geometry has a Color node defining all points as "blue". This should take prededence over the emissiveColor value of "red". The result should be a blue IndexedLineSet geometry.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/indexedlineset_color_first.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='indexedlineset_color_first.x3d'),
...
print ("python x3d.py load successful for indexedlineset_color_first.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='HelixEaiJava.x3d',name='title'),
    meta(content='HelixEaiJavaPage.html',name='example'),
    meta(content='External Authoring Interface (EAI) Java example from VRML 97 Amendment 2 specification.',name='description'),
    meta(content='Vilius Jagminas and Martin Reddy',name='creator'),
    ...
    meta(content='HelixEai.java',name='reference'),
    meta(content='javadoc/index.html',name='reference'),
    meta(content='originals/helix/',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ExternalAuthoringInterface/HelixEaiJava.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='HelixEaiJava.x3d'),
    Viewpoint(description='HelixEai',orientation=(1.0,0.0,0.0,-0.5),position=(0.0,4.0,5.0)),
    Shape(
      appearance=Appearance(
        material=Material(diffuseColor=(0.8,0.8,0.9),shininess=1.0)),
      geometry=Extrusion(DEF='Coil',creaseAngle=3.14))])
) # X3D model complete
...
print ("python x3d.py load successful for HelixEaiJava.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/LandingShipTankEnduranceSingapore/RadarNavigation.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(
      ...
      Transform(DEF='Scanner',
        children=[
        Shape(
          geometry=Extrusion(crossSection=[(-0.1,-0.8),(-0.1,0.8),(0.1,0.8),(0.1,-0.8),(-0.1,-0.8)],orientation=[(0,0,1,0.5),(0,0,1,0.5)],spine=[(-0.3,0,0),(0.3,0,0)]),
          appearance=Appearance(
            material=Material(diffuseColor=(0.9,0.9,0.9),shininess=0.5)))]),
      ...
      Transform(translation=(0,-0.26,0),
        children=[
        Shape(DEF='Support',
          geometry=Cone(bottomRadius=0.15,height=0.73),
          appearance=Appearance(
...
print ("python x3d.py load successful for RadarNavigation.py")

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='PositionInterpolatorPrototype.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/PositionInterpolatorPrototype.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='PositionInterpolatorPrototype.x3d'),
      ...
      ProtoBody=ProtoBody(
        ...
        Transform(DEF='Way',
          ...
          Group(DEF='AnimationGroup',
            ...
            OrientationInterpolator(DEF='CirclefishRotations',
              IS=IS(
                connect=[
            ...
            ROUTE(fromField='fraction_changed',fromNode='OrbitClock',toField='set_fraction',toNode='CirclefishRotations'),
            ROUTE(fromField='value_changed',fromNode='CirclefishRotations',toField='set_rotation',toNode='Way')])])])),
    #  ==================== 
...
print ("python x3d.py load successful for PositionInterpolatorPrototype.py")

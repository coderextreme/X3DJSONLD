...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='YardArmBlack.x3d',name='title'),
    ...
    meta(content='Superstructure Yardarm for Sovremenny Ship Antenna Mast',name='description'),
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/YardArmBlack.x3d',name='identifier'),
...
print ("python x3d.py load successful for YardArmBlack.py")

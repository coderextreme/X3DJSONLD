...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='SriCampus133.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/Geospatial/SriCampus133.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='SriCampus133.x3d'),
    TouchSensor(DEF='MouseOverPopupDescription',description='House-7',enabled=False),
    Shape(
      ...
      geometry=IndexedFaceSet(convex=False,coordIndex=[10,11,13,-1,9,12,8,-1,9,10,13,12,-1,8,12,13,11,-1,10,2,3,11,-1,8,0,1,9,-1,2,10,9,1,-1,0,8,11,3,-1,0,3,2,1,-1],solid=False,
        coord=Coordinate(DEF='OBJECT-133-VERTICES',point=[(-9.445177,-66.307915,9.445177),(9.445177,-66.307915,9.445177),(9.445177,-66.307915,-9.445177),(-9.445177,-66.307915,-9.445177),(-9.445177,47.984272,9.445177),(9.445177,47.984272,9.445177),(9.445177,47.984272,-9.445177),(-9.445177,47.984272,-9.445177),(-9.445177,47.984272,9.445177),(9.445177,47.984272,9.445177),(9.445177,47.984272,-9.445177),(-9.445177,47.984272,-9.445177),(0.0,66.307915,0.0),(0.0,66.307915,0.0)])))])
) # X3D model complete
...
print ("python x3d.py load successful for SriCampus133.py")

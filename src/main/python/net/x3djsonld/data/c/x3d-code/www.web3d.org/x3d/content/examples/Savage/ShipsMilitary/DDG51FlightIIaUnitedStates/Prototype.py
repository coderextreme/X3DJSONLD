...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='DDG-51 Flight IIA Helo hangers and deck with movable hanger doors and RASTs',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/DDG51FlightIIaUnitedStates/Prototype.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Viewpoint(description='MK 45 5 Inch Gun',orientation=(-1,0.016,0.003,0.9041),position=(0,12.5,-120.6)),

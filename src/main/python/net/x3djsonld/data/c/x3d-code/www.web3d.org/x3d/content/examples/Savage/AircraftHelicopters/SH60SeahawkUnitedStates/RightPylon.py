...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='RightPylon.x3d',name='title'),
    ...
    meta(content='Right pylon for torpedo',name='description'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/SH60SeahawkUnitedStates/RightPylon.x3d',name='identifier'),
...
print ("python x3d.py load successful for RightPylon.py")

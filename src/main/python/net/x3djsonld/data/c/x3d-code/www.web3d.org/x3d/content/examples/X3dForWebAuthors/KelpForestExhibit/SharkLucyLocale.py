...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SharkLucyLocale.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(DEF='_0',translation=(0.0,-8.0,-1.0),
      children=[
      Inline(url=["SharkLucy.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SharkLucy.x3d","SharkLucy.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SharkLucy.wrl"]),
      Group(
        children=[
...
print ("python x3d.py load successful for SharkLucyLocale.py")

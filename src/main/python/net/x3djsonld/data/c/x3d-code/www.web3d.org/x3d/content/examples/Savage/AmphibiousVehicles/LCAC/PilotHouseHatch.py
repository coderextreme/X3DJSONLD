...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='PilotHouseHatch.x3d',name='title'),
    meta(content='Starboard Pilot House Hatch for the LCAC',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AmphibiousVehicles/LCAC/PilotHouseHatch.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ProtoInstance(name='ArbitraryAxisCylinderSensor',
      fieldValue=[
      fieldValue(name='minAngle',value=-3),
      fieldValue(name='maxAngle',value=0.01),
        ...
        Group(DEF='PilotHouseHatch',
          ...
          Transform(translation=(0.53125,0,-0.1),
            ...
            Transform(rotation=(0.58,0.58,0.58,2.09),
              children=[
              Transform(DEF='Hatch',translation=(0,0,-0.1),
                children=[
                Shape(
              ...
              Transform(DEF='HatchPorthole',translation=(0.5,0.07,-0.1),
                children=[
                Shape(
                  appearance=Appearance(
              ...
              Transform(DEF='Hinges',scale=(0.9,1,0.9),
                children=[
                Transform(DEF='Upperhinge',translation=(0.5,0.1,-0.425),
                  children=[
                  Shape(
                    appearance=Appearance(
                      material=Material(diffuseColor=(0.7,0.75,0.85))),
                ...
                Transform(DEF='LowerHinge',translation=(-0.5,0.1,-0.425),
                  children=[
                  Shape(
                    appearance=Appearance(
                      material=Material(diffuseColor=(0.7,0.75,0.85))),
                  ...
                  Transform(rotation=(0,0,1,1.57),translation=(0,0,-0.125),
                    ...
                    Shape(
                      appearance=Appearance(
                        material=Material(diffuseColor=(0.7,0.75,0.85))),
                      geometry=Cylinder(height=0.05,radius=0.1))])]),
                Transform(DEF='HatchHandle',translation=(0.3,0.1,0.3),
                  children=[
                  Shape(
...
print ("python x3d.py load successful for PilotHouseHatch.py")

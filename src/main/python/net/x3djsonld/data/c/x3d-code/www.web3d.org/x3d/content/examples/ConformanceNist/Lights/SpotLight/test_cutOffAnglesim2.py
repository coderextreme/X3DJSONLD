...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_cutOffAnglesim2.x3d',name='title'),
    meta(content='test-cutOffAnglesim2-movie.mpg',name='MovingImage'),
  ...
  Scene=Scene(
    ...
    SpotLight(DEF='the-light',beamWidth=0.2,cutOffAngle=0.2,location=(0,0,7),radius=7),
    TimeSensor(DEF='text-time'),
    TimeSensor(DEF='the-time',cycleInterval=8),
    ScalarInterpolator(DEF='the-cutoff',key=[0,0.2,0.4,0.6,0.8,1],keyValue=[0.1,0.3,0.6,0.9,1.4,1.57079]),
    ...
    ROUTE(fromField='fraction_changed',fromNode='the-time',toField='set_fraction',toNode='the-cutoff'),
    ROUTE(fromField='value_changed',fromNode='the-cutoff',toField='cutOffAngle',toNode='the-light')])
) # X3D model complete
...
print ("python x3d.py load successful for test_cutOffAnglesim2.py")

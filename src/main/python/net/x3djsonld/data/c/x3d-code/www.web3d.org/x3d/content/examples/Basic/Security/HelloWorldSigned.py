...
newModel=X3D(profile='Immersive',version='3.2',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/Security/HelloWorldSignedDecrypted.x3d',name='reference'),
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/Security/HelloWorldSigned.x3d',name='identifier'),
...
print ("python x3d.py load successful for HelloWorldSigned.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Couch.x3d',name='title'),
    meta(content='Maroon couch',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/Buildings/HouseBarisAktop/Couch.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(
      children=[
      Transform(scale=(2,1,1),translation=(0,0.2,0),
        children=[
        Shape(
      ...
      Transform(DEF='bottom',scale=(2,1,1),translation=(-1,-0.1,-0.55),
        children=[
        Shape(
          appearance=Appearance(
...
print ("python x3d.py load successful for Couch.py")

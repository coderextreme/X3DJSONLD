...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='TurkishFlagRight.x3d',name='title'),
    ...
    Transform(rotation=(-1,0,0,3.14),
      ...
      Shape(
        ...
        appearance=Appearance(
          texture=ImageTexture(repeatS=False,repeatT=False,url=["TurkishFlag2.gif","https://savage.nps.edu/Savage/AircraftFixedWing/F16FightingFalconTurkey/TurkishFlag2.gif"])))])])
) # X3D model complete
...
print ("python x3d.py load successful for TurkishFlagRight.py")

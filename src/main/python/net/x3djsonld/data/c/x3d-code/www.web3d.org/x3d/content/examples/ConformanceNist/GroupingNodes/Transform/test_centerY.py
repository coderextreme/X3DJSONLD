...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='test_centerY.x3d',name='title'),
    meta(content='test-centerY-front.jpg',name='Image'),
    meta(content='test-centerY-left.jpg',name='Image'),
    meta(content='test-centerY-right.jpg',name='Image'),
  ...
  Scene=Scene(
    ...
    Transform(
      ...
      Transform(center=(0,-3,0),rotation=(0,0,1,1.57),
        children=[
        Shape(
          appearance=Appearance(
            material=Material(),),
...
print ("python x3d.py load successful for test_centerY.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/Tools/Authoring/GridXY_20x20Fixed.x3d',name='identifier'),
        ...
        Billboard(
          ...
          Shape(
            ...
            appearance=Appearance(DEF='DefaultAppearance',
              material=Material(),))])]),
      Transform(translation=(10,10.2,0),
        children=[
        Billboard(
          children=[
          Shape(
            geometry=Text(string=["10 10 0"],
...
print ("python x3d.py load successful for GridXY_20x20Fixed.py")

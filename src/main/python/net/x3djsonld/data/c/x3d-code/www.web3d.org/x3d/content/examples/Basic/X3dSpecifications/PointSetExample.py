...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://www.web3d.org/documents/specifications/19776-1/V3.3/Part01/examples.html#PointSet',name='specificationUrl'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(2.0,0.0,0.0),
      ...
      Shape(
        geometry=PointSet(
          color=Color(color=[(0.5,0.5,0),(0.5,0,0.5),(0,0.5,0.5)]),

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_inteffect_diffusesim.x3d',name='title'),
    meta(content='test-inteffect-diffusesim-movie.mpg',name='MovingImage'),
    ...
    meta(content='This test addresses the effect of the light intensity on the diffuse color of simple geometry. One row of simple geometry is drawn in the local coordinate system and PointLight is also defined with radius 50 and intensity 0 at location 0 0 10. The test starts by clicking on the text above the geometry. The intensity of the light is increased as the test progresses and the diffuse color brightness of the objects should also increase. Intensity ranges from 0 to 1. The geometry are originally defined with a diffuseColor of 0 0 1.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_inteffect_diffusesim.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='test_inteffect_diffusesim.x3d'),
    Group(
      children=[
    ...
    Transform(scale=(0.02,0.02,0.02),translation=(-2.3,2.7,0),
      children=[
      Shape(
...
print ("python x3d.py load successful for test_inteffect_diffusesim.py")

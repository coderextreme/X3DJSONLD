...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='CircleFishPTPrototype.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/CircleFishPTPrototype.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ProtoDeclare(name='CircleFishPT',
      ProtoInterface=ProtoInterface(
        field=[
        field(accessType='inputOutput',name='skinPixelTexture',type='SFImage',value=[0,0,0]),
            ...
            Transform(DEF='FishTransform',
              ...
              Shape(
                appearance=Appearance(
                  ...
                  texture=PixelTexture(DEF='FishTexture',
                    IS=IS(
                      connect=[
                      connect(nodeField='image',protoField='skinPixelTexture')]))),
...
print ("python x3d.py load successful for CircleFishPTPrototype.py")

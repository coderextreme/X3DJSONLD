...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='SupertankerHighDetail.x3d',name='title'),
    meta(content='Andrew Wiest',name='creator'),
    meta(content='6 May 2001',name='created'),
    meta(content='21 February 2016',name='modified'),
    meta(content='Supertanker model based on the Exxon Valdez, high detail.',name='description'),
    meta(content='https://savage.nps.edu/Savage/ShipsCivilian/Supertanker/SupertankerHighDetail.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    Background(skyColor=[(.7,.8,.95)]),
    Viewpoint(description='Supertanker High Detail',orientation=(-0.429808,0.899118,0.0827735,0.422004),position=(150,50,250)),
    ...
    Transform(DEF='ShipSupertankerMasterNode',
      ...
      Transform(DEF='MainHull',
        ...
        Transform(rotation=(0,1,0,.7),translation=(153,3,23.7),
          children=[
          Shape(
            geometry=Text(string=["Exxon Valdez"],
              fontStyle=FontStyle(size=2.2,style_='BOLD')),
            appearance=Appearance(
              material=Material(diffuseColor=(1,1,1)))),
          Viewpoint(description='Starboard side ship name',orientation=(-0.365482,0.92973,0.0449929,0.263289),position=(7,2,20))]),
        Transform(rotation=(0,1,0,2.47),translation=(153,3,-23.5),
          children=[
          Shape(
            geometry=Text(string=["Exxon Valdez"],
              fontStyle=FontStyle(justify=["END","MIDDLE"],size=2.2,style_='BOLD')),
            appearance=Appearance(
              material=Material(diffuseColor=(1,1,1)))),
          Viewpoint(description='Port side ship name',orientation=(0,1,0,.5),position=(7,3,20))])]),
      ...
      Transform(DEF='Deck',scale=(1.01,1.0,1.0),translation=(0,7,0),
        ...
        Shape(
          appearance=Appearance(
            texture=ImageTexture(DEF='DeckPlate',url=["DeckPlate.jpg","https://savage.nps.edu/Savage/ShipsCivilian/Supertanker/DeckPlate.jpg"]),
        ...
        Transform(DEF='cranes',
          children=[
          Transform(translation=(10,0,-20),
            children=[
            Transform(DEF='portcrane',
              children=[
              Transform(
                children=[
                Transform(scale=(3,1,3),translation=(0,-1,0),
                  children=[
                  Shape(DEF='yellowcylinderpiece',
                    geometry=Cylinder(height=15,radius=.2),
                    appearance=Appearance(DEF='yellowstuff',
                      material=Material(diffuseColor=(1,.8,.3),shininess=.1,specularColor=(.2,.2,0))))]),
                Transform(rotation=(0,0,1,-1.571),scale=(2,.7,2),translation=(4,6,0),
                  children=[
                  Shape(USE='yellowcylinderpiece')])])])]),
          Transform(DEF='stbdcrane',translation=(10,0,20),
            children=[
            Transform(USE='portcrane')]),
          Transform(translation=(150,5,0),
            children=[
            Shape(USE='yellowcylinderpiece'),
            Transform(translation=(0,-5,0),
              ...
              Shape(
                appearance=Appearance(
                  material=Material(USE='Rustyreddeck'),
                  texture=ImageTexture(USE='DeckPlate')),
                geometry=Box(size=(10,5,10)))])]),
          Transform(translation=(40,0,-15),
            children=[
            Shape(USE='yellowcylinderpiece')]),
          Transform(translation=(40,0,15),
            children=[
            Shape(USE='yellowcylinderpiece')]),
          Transform(translation=(100,0,-15),
            children=[
            Shape(USE='yellowcylinderpiece')]),
          Transform(translation=(100,0,15),
            children=[
      ...
      Transform(DEF='superstructure',
        ...
        Transform(DEF='SS2',translation=(-85.8,26.4,0),
          ...
          Transform(DEF='bridgewindows',scale=(.5,1.2,1.2),translation=(8.5,.2,0),
            children=[
            Transform(
              children=[
              Shape(
                geometry=Box(size=(.5,.8,.8)),
                appearance=Appearance(DEF='windowblue',
                  material=Material(diffuseColor=(0,0,.9),emissiveColor=(0,0,.2),specularColor=(0,0,.2),transparency=.5)))]),
            Transform(translation=(0,0,-1),
              children=[
              Shape(
                geometry=Box(size=(.5,.8,.8)),
                appearance=Appearance(USE='windowblue'))]),
            ...
            Transform(translation=(0,0,4),
              ...
              Shape(
                geometry=Box(size=(.5,.8,.8)),
                appearance=Appearance(USE='windowblue'))])]),
          Transform(DEF='lowerwindows',scale=(.5,1.2,1.2),translation=(8.0,-4,0),
            children=[
            Transform(
              children=[
              Shape(
            ...
            Transform(translation=(0,0,8),
              ...
              Shape(
                geometry=Box(size=(.5,.8,.8)),
                appearance=Appearance(USE='windowblue'))])]),
          Transform(DEF='bottomwindows',scale=(.5,1.2,1.2),translation=(8.0,-10,0),
            children=[
            Transform(
              children=[
              Shape(
            ...
            Transform(translation=(0,0,8),
              ...
              Shape(
                geometry=Box(size=(.5,.8,.8)),
                appearance=Appearance(USE='windowblue'))])]),
          Transform(DEF='StbdSideWindows',rotation=(0,1,0,-1.571),scale=(1,.5,.5),translation=(-4,0,6.3),
            children=[
            Transform(USE='bottomwindows')]),
          Transform(DEF='PortSideWindows',rotation=(0,1,0,1.571),scale=(1,.5,.5),translation=(-4,0,-6.3),
            children=[
            Transform(USE='bottomwindows')]),
          Transform(DEF='mastassembly',center=(-86,27,0),
            children=[
            Transform(DEF='leftsidemast',rotation=(1,0,0,.3),
              children=[
              Transform(DEF='leftfrontleg',rotation=(0,0,1,.6),translation=(2.2,0,-2),
                children=[
                Shape(USE='yellowcylinderpiece')]),
              Transform(DEF='leftrearleg',translation=(-2,-1,-2),
                children=[
                Shape(USE='yellowcylinderpiece')])]),
            Transform(DEF='rightsidemast',rotation=(1,0,0,-.3),
              children=[
              Transform(DEF='rightrearleg',translation=(-2,-1,2),
                children=[
                Shape(USE='yellowcylinderpiece')]),
              Transform(DEF='righfrontleg',rotation=(0,0,1,.6),translation=(2.2,0,2),
                children=[
                Shape(USE='yellowcylinderpiece')])]),
            Transform(DEF='uppermastarea',translation=(-2.2,-3.4,0),
              children=[
              Transform(rotation=(1,0,0,1.571),translation=(0,10,0),
                children=[
              ...
              Transform(rotation=(0,1,0,1.571),
                ...
                Transform(rotation=(1,0,0,1.571),translation=(0,10,0),
                  ...
                  Transform(scale=(1,.5,1),
                    children=[
                    Shape(USE='yellowcylinderpiece')])])]),
              Transform(scale=(1,.7,1),translation=(-4,12,0),
                children=[
                Transform(scale=(1,.5,1),
                  children=[
                  Shape(USE='yellowcylinderpiece')])]),
              Transform(scale=(1,1.1,1),translation=(0,9,0),
                children=[
                Transform(scale=(1,.5,1),
                  children=[
                  Shape(USE='yellowcylinderpiece')])]
              ...
              Transform(rotation=(1,0,0,1.571),scale=(1,.4,1),translation=(0,13,0),
                children=[
                Transform(scale=(1,.5,1),
                  children=[
                  Shape(USE='yellowcylinderpiece')])]
        ...
        Transform(DEF='bridgewings',center=(-75.9,25.8,0),scale=(1,1.03,1),translation=(-5,-.2,0),
          ...
          Transform(DEF='antennas',translation=(-76,29,0),
            children=[
            Transform(translation=(0,0,10),
              children=[
              Transform(DEF='antennanode',
                children=[
                Shape(
                  geometry=Cone(DEF='genericantenna',bottomRadius=.1,height=20),
                  appearance=Appearance(
                    material=Material(USE='offwhite')))])]),
            Transform(translation=(0,0,-10),
              children=[
              Transform(USE='antennanode')]),
            Transform(scale=(1,.5,1),translation=(0,4,20),
              children=[
              Transform(USE='antennanode')]),
            Transform(scale=(1,.5,1),translation=(0,4,-20),
              children=[
              Transform(USE='antennanode')]),
            Viewpoint(description='look at the masts',orientation=(-0.413724,0.810966,0.413724,1.77881),position=(40,70,0))]),
          Transform(DEF='radar',translation=(-77,28,5),
            children=[
            Transform(DEF='radarPost',
              children=[
              Shape(
                geometry=Cylinder(bottom=False,height=5,radius=.2,top=False),
                appearance=Appearance(USE='yellowstuff'))]),
...
print ("python x3d.py load successful for SupertankerHighDetail.py")

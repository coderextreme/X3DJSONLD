...
newModel=X3D(profile='Immersive',version='3.2',
  head=head(
    children=[
    meta(content='CloudsProcedural3.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/Environment/Atmosphere/CloudsProcedural3.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    PointLight(location=(25000,100,25000),radius=1000000),
    Group(DEF='Terrain',
      children=[
      ...
      Transform(rotation=(1,0,0,1.57),translation=(25000,0,25000),
        children=[
        Collision(bboxSize=(100000,100000,100000),
          children=[
          Shape(
...
print ("python x3d.py load successful for CloudsProcedural3.py")

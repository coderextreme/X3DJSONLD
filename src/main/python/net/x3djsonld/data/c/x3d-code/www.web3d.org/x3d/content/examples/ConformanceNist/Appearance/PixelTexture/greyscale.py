...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='greyscale.x3d',name='title'),
    meta(content='greyscale-front.jpg',name='Image'),
    meta(content='greyscale-rear.jpg',name='Image'),
    meta(content='greyscale-top.jpg',name='Image'),
    meta(content='greyscale-bottom.jpg',name='Image'),
    meta(content='greyscale-left.jpg',name='Image'),
    meta(content='greyscale-right.jpg',name='Image'),
      ...
      Transform(translation=(6.14221,0.0694613,-0.000999451),
        ...
        Shape(
          appearance=Appearance(
            material=Material(),
            texture=PixelTexture(DEF='GreyscaleCheckerboard',image=[2,2,1,255,128,128,255])),
          geometry=Box(),)]),
...
print ("python x3d.py load successful for greyscale.py")

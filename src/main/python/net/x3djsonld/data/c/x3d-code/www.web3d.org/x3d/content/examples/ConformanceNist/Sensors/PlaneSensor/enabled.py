...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    ...
    meta(content='Test the action of PlaneSensors field enabled. The world includes a PlaneSensor which has enabled false and a red box. When pressing left mouse button over the red box and dragging, the box should not move.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/PlaneSensor/enabled.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(
      ...
      Transform(DEF='MYBOX',
        children=[
        CylinderSensor(DEF='BOXSENSOR',description='click and drag to rotate',enabled=False),
        Shape(

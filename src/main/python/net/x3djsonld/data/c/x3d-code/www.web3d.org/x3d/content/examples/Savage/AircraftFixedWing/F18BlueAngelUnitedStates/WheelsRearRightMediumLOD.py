...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='WheelsRearRightMediumLOD.x3d',name='title'),
    meta(content='The medium Level-of-Detail(LOD) of right side rear wheels and axle. It will be shown at the point of view of 600 meters. It does not include any animation.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearRightMediumLOD.x3d',name='identifier'),
    meta(content='rear right wheel',name='subject'),
  ...
  Scene=Scene(
    ...
    Group(
      children=[
      Transform(DEF='WheelsRearTransform',center=(0,3.7,0),
        children=[
...
print ("python x3d.py load successful for WheelsRearRightMediumLOD.py")

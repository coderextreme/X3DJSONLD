...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='mpeg1_video.x3d',name='title'),
    meta(content='mpeg1-video-movie.mpg',name='MovingImage'),
    ...
    meta(content='fails X3D Canonicalization (C14N) processing, cause unclear',name='warning'),
    meta(content='Test mpeg1 video playback. The VTS logo should appear on all faces of the Box geometry, and rotatate nearly 360 degrees (from right to left) in a single loop when the user clicks on the -now- Text.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpeg1_video.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='mpeg1_video.x3d'),
...
print ("python x3d.py load successful for mpeg1_video.py")

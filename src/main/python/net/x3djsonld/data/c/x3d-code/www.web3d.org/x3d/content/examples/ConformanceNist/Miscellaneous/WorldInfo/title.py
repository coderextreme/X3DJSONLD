...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='title-front.jpg',name='Image'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Miscellaneous/WorldInfo/title.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='A simple Box'),
    Shape(
      geometry=Box(),)])
) # X3D model complete
...
print ("python x3d.py load successful for title.py")

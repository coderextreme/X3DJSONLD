...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='UpperBody.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/HovercraftSnr6Singapore/UpperBody.x3d',name='identifier'),
    meta(content='Creates the Upper Body segment of the Hovercraft',name='description'),
  ...
  Scene=Scene(
    ...
    Group(DEF='RightTop',
      ...
      Transform(translation=(0,0,8),
        children=[
        Group(USE='TopSeg')])]),
    Transform(DEF='LeftTop',rotation=(0,1,0,3.14),translation=(0,0,8),
      children=[
      Group(USE='RightTop')]),
    Transform(translation=(0,0,12),
      children=[
      Inline(DEF='TopFront',url=["TopFront.x3d","TopFront.wrl","https://savage.nps.edu/Savage/ShipsMilitary/HovercraftSnr6Singapore/TopFront.x3d","https://savage.nps.edu/Savage/ShipsMilitary/HovercraftSnr6Singapore/TopFront.wrl"])]),
    Transform(DEF='TopBack',rotation=(0,1,0,3.14),translation=(0,0,-4),
      children=[
      Inline(USE='TopFront')])])
) # X3D model complete
...
print ("python x3d.py load successful for UpperBody.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='indexedfaceset_movietexture.x3d',name='title'),
    meta(content='indexedfaceset_movietexture-front.jpg',name='Image'),
    meta(content='indexedfaceset_movietexture-rear.jpg',name='Image'),
    meta(content='indexedfaceset_movietexture-top.jpg',name='Image'),
    meta(content='indexedfaceset_movietexture-bottom.jpg',name='Image'),
    meta(content='indexedfaceset_movietexture-left.jpg',name='Image'),
    meta(content='indexedfaceset_movietexture-right.jpg',name='Image'),
...
print ("python x3d.py load successful for indexedfaceset_movietexture.py")

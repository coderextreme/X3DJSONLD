...
newModel=X3D(profile='Immersive',version='3.0',
  ...
  Scene=Scene(
        ...
        Group(
          ...
          Transform(DEF='LayoutDirectionTransform',
            ...
            Transform(DEF='BottomEndTransform',
              ...
              Shape(DEF='EndShape',
                appearance=Appearance(
                  material=Material(DEF='EndMaterial',
                    IS=IS(
                      connect=[
    ...
    Anchor(description='SliderIntegerExample',parameter=["target=_blank"],url=["SliderIntegerExample.x3d","https://savage.nps.edu/Savage/Tools/Animation/SliderIntegerExample.x3d","SliderIntegerExample.wrl","https://savage.nps.edu/Savage/Tools/Animation/SliderIntegerExample.wrl"],
      children=[
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(0,1,1),emissiveColor=(0,1,1))),
        geometry=Text(string=["SliderIntegerPrototype is a","Prototype definition file.","","To see an example scene","using this new node","click this text and view","SliderIntegerExample.x3d"],
...
print ("python x3d.py load successful for SliderIntegerPrototype.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_direffect_specularcom.x3d',name='title'),
    meta(content='test-direffect-specularcom-movie.mpg',name='MovingImage'),
  ...
  Scene=Scene(
    ...
    Transform(scale=(0.02,0.02,0.02),translation=(-3.1,1.5,-4.5),
      children=[
      Shape(
    ...
    Group(
      ...
      Transform(rotation=(1,0,0,0.5),scale=(1.5,1.5,1.5),translation=(-1.5,0,-5.5323),
        children=[
        Shape(
...
print ("python x3d.py load successful for test_direffect_specularcom.py")

...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='elevationgrid_pixeltexture.x3d',name='title'),
    meta(content='elevationgrid_pixeltexture-front.jpg',name='Image'),
    meta(content='elevationgrid_pixeltexture-rear.jpg',name='Image'),
    meta(content='elevationgrid_pixeltexture-top.jpg',name='Image'),
    meta(content='elevationgrid_pixeltexture-bottom.jpg',name='Image'),
    meta(content='elevationgrid_pixeltexture-left.jpg',name='Image'),
    meta(content='elevationgrid_pixeltexture-right.jpg',name='Image'),
    ...
    meta(content='Map a PixelTexture A PixelTexture consisting of a square checkerboard of blue (lower left quadrant), yellow (lower right), red (upper right) and green (upper left) to an ElevationGrid. An ElevationGrid is default texture mapped by aligning the +S (horizontal) axis of the PixelTexture with the +X axis of the ElevationGrid and the +T (vertical) axis of the PixelTexture with the +Z axis of the ElevationGrid. The bottom of the PixelTexture coincides with the first row of grid points (along the rear of the ElevationGrid) and the top of the PixelTexture maps to the last row of grid points (along the front).',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/elevationgrid_pixeltexture.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='elevationgrid_pixeltexture.x3d'),
    Group(
      children=[
...
print ("python x3d.py load successful for elevationgrid_pixeltexture.py")

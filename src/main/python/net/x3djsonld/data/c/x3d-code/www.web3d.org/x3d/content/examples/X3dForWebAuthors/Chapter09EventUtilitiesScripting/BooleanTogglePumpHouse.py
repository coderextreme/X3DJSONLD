...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanTogglePumpHouse.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Script(DEF='Dump',url=["BooleanTogglePumpHouseScript.js","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanTogglePumpHouseScript.js"],
      field=[
...
print ("python x3d.py load successful for BooleanTogglePumpHouse.py")

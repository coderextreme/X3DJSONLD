...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_binding1.x3d',name='title'),
    meta(content='test-binding1-movie.mpg',name='MovingImage'),
  ...
  Scene=Scene(
    ...
    Group(
      children=[
      Viewpoint(DEF='the-view',description='Back View',position=(0,0,20))]),
    Group(
      children=[
...
print ("python x3d.py load successful for test_binding1.py")

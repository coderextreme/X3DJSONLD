...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='WheelsRearRightPrototype.x3d',name='title'),
    meta(content='This prototype performs to raise and lower rear right wheels and axle. The clickable axle triggers an animation.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearRightPrototype.x3d',name='identifier'),
    meta(content='rear right wheel, animation of gear up and down, Prototype',name='subject'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    ProtoDeclare(name='WheelsRearRight',
    ...
    Anchor(description='WheelsRearRightExample',parameter=["target=_blank"],url=["WheelsRearRightExample.wrl","../../AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearRightExample.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearRightExample.wrl","WheelsRearRightExample.x3d","../../AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearRightExample.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearRightExample.x3d"],
      children=[
      Shape(
        geometry=Text(string=["WheelsRearRightPrototype","is a prototype definition file","","To see an example scene","click on this text and view","WheelsRearRightExample"],
...
print ("python x3d.py load successful for WheelsRearRightPrototype.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/WeaponsPylon.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Shape(
      appearance=Appearance(
        material=Material(DEF='TEAL',diffuseColor=(0.0,1.0,1.0))),

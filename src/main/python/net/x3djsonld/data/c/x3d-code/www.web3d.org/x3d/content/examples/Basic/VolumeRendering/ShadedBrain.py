...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/ShadedBrain.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='ShadedBrain.x3d'),
    Group(
      children=[
      ...
      Transform(scale=(0.117188,0.117188,0.117188),
        ...
        VolumeData(dimensions=(1.28,1.28,1.0),
          ...
          ShadedVolumeStyle(lighting=True,shadows=True,
            material=Material(ambientIntensity=0.8,diffuseColor=(0,.5,1),shininess=0.08,specularColor=(1,1,1))),],
...
print ("python x3d.py load successful for ShadedBrain.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Referee.x3d',name='title'),
    meta(content='Referee of the game',name='description'),
    meta(content='Ignazio Locatelli, Bergamo, Italia LT Christos Kalogrias - Hellenic Navy',name='creator'),
    meta(content='28 August 2003',name='created'),
    ...
    meta(content='https://savage.nps.edu/Savage/Buildings/SoccerStadium/Referee.x3d',name='identifier'),
    meta(content='http://www.web3d.org/x3d/content/README.X3D-Edit.html',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    Transform(DEF='Referee',scale=(0.0107,0.0107,0.0107),
      children=[
      Group(
        children=[
              ...
              Transform(DEF='busto_z',
                ...
                Transform(DEF='clavicola_sinistra',rotation=(0.707,2.10734E-8,0.707,3.14159),translation=(3.68,44.23,4.295),
                  ...
                  Transform(DEF='brsup_sin',rotation=(0.707,2.10734E-8,0.707,-3.14159),
                    #  Left hand 
                    children=[
                    Transform(DEF='spalla_sin',rotation=(1,-0.3,0,-1.57),translation=(16.14,1.03,0.0),
                      ...
                      Transform(DEF='spalla_sinistra',rotation=(0.577,-0.577,0.577,2.094),
                        ...
                        Transform(rotation=(0.577,-0.577,0.577,-2.0944),
                          children=[
                          Transform(DEF='braccio_sin',rotation=(0,0,1,-2.4),translation=(0.0,-31.34,0.0),
                            #  L lower hand + palm. 
                            #  L Ellbow rotation 
                            children=[
                ...
                Transform(DEF='clavicola_destra',rotation=(-2.185573E-8,-1.0,7.9466E-9,1.57079),translation=(-3.68,44.23,4.295),
                  ...
                  Transform(rotation=(-2.185573E-8,-1.0,7.9466E-9,-1.57079),
                    #  R hand 
                    children=[
                    Transform(DEF='spalla_des',rotation=(1.0,0.0,0.0,-3),translation=(-16.14,1.03,0.0),
                      #  rotation of R hand 
                      children=[
                        ...
                        Transform(rotation=(0.577,-0.577,0.577,-2.0944),
                          ...
                          Transform(DEF='braccio_des',rotation=(1.0,0.0,0.0,0),translation=(0.0,-31.34,0.0),
                            ...
                            Transform(DEF='brinf_des',rotation=(0.577,-0.577,0.577,2.0944),
                              ...
                              Transform(rotation=(0.57735,-0.57735,0.57735,-2.0944),scale=(0.6,0.6,0.6),
                                children=[
                                Transform(DEF='mano_destra',rotation=(0,1,0,3.14),scale=(0.6,1.1,1.0),translation=(0.0,-45.0,0),
                                  #  R palm 
                                  #  rotation of R palm 
                                  children=[
                                  Shape(USE='palmo'),
...
print ("python x3d.py load successful for Referee.py")

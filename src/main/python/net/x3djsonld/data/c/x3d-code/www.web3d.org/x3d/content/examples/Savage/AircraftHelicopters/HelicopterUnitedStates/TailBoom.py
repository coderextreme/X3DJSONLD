...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/TailBoom.x3d',name='identifier'),
    meta(content='HfAntenna.wrl',name='reference'),
    meta(content='TailRotorDriveShaft.wrl',name='reference'),
    meta(content='HorizontalStabilizer.wrl',name='reference'),
    meta(content='VerticalFin.wrl',name='reference'),
    meta(content='TailRotor.wrl',name='reference'),
  ...
  Scene=Scene(
    ...
    Group(DEF='TAILBOOM',
      ...
      Transform(DEF='HF_ANTENA',translation=(0.35,2.2,0.0),
        children=[
        Inline(url=["HfAntenna.x3d","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/HfAntenna.x3d","HfAntenna.wrl","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/HfAntenna.wrl"])]),
      Transform(DEF='TAIL_ROTOR_DRIVE_SHAFT',center=(0.0,2.2,0.0),rotation=(0.0,0.0,1.0,0.03),translation=(-0.325,2.2,0.0),
        children=[
        Inline(url=["TailRotorDriveShaft.x3d","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/TailRotorDriveShaft.x3d","TailRotorDriveShaft.wrl","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/TailRotorDriveShaft.wrl"])]),
      Transform(DEF='HORIZONTAL_STABILIZER',rotation=(0.0,1.0,0.0,1.57),translation=(0.0,2.5,0.0),
        children=[
        Inline(url=["HorizontalStabilizer.x3d","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/HorizontalStabilizer.x3d","HorizontalStabilizer.wrl","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/HorizontalStabilizer.wrl"])]),
      Transform(DEF='VERTICAL_FIN',rotation=(1.0,0.0,0.0,-0.09),scale=(2.5,2.5,2.5),translation=(0.7,0.125,0.3),
        children=[
        Inline(url=["VerticalFin.x3d","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/VerticalFin.x3d","VerticalFin.wrl","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/VerticalFin.wrl"])]),
      Transform(rotation=(0.0,1.0,0.0,3.142),translation=(-0.2,0.4,-0.35),
        children=[
        Inline(url=["TailRotor.x3d","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/TailRotor.x3d","TailRotor.wrl","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/TailRotor.wrl"])])])])
) # X3D model complete

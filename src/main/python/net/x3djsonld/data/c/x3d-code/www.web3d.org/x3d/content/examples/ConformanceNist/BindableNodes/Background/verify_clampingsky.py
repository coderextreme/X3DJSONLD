...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='verify_clampingsky.x3d',name='title'),
    meta(content='verify-clampingsky-front.jpg',name='Image'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Background/verify_clampingsky.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='verify_clampingsky.x3d'),
    NavigationInfo(headlight=False,type=["EXAMINE","WALK","FLY","ANY"]),
    Group(
      children=[
      Viewpoint(description='Front View',position=(0,0,20))]),
    Background(DEF='blues',groundColor=[(0,0,0)],skyAngle=[1.2,1.35],skyColor=[(0,1,1),(1,0,0),(0.52941,0.80784,0.92156)])])
) # X3D model complete
...
print ("python x3d.py load successful for verify_clampingsky.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='viewinline.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/viewinline.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='viewinline.x3d'),
        ...
        Transform(translation=(-10,-4,-20),
          ...
          Shape(
            ...
            geometry=Text(DEF='TYPESTRING0',string=["current position is:"],
              fontStyle=FontStyle(justify=["BEGIN","MIDDLE"],style_='BOLD')))])]),
      Transform(DEF='TRANS1',
        ...
        Transform(translation=(-10,-5,-20),
          ...
          Shape(
            appearance=Appearance(
              material=Material(),),
            geometry=Text(DEF='TYPESTRING1',string=[""],
              fontStyle=FontStyle(justify=["BEGIN","MIDDLE"],style_='BOLD')))])])])])
) # X3D model complete
...
print ("python x3d.py load successful for viewinline.py")

...
newModel=X3D(profile='Immersive',version='3.1',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/AuvWorkbench/OperatingAreas/MultipleUnmannedVehiclesOffPanamaCity.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ExternProtoDeclare(appinfo='Predator unmanned air vehicle (UAV) with DIS ESPDU network connections',name='PredatorEspdu',url=["../../../Savage/Robots/UnmannedAirVehicles/PredatorEspduPrototype.x3d#PredatorEspdu","https://savage.nps.edu/Savage/Robots/UnmannedAirVehicles/PredatorEspduPrototype.x3d#PredatorEspdu","../../../Savage/Robots/UnmannedAirVehicles/PredatorEspduPrototype.wrl#PredatorEspdu","https://savage.nps.edu/Savage/Robots/UnmannedAirVehicles/PredatorEspduPrototype.wrl#PredatorEspdu"],
      field=[
    ...
    #  <Inline url='"../../../Savage/Locations/PanamaCityFlorida/PanamaCityChartlet.x3d" "https://savage.nps.edu/Savage/Locations/PanamaCityFlorida/PanamaCityChartlet.x3d" "../../../Savage/Locations/PanamaCityFlorida/PanamaCityChartlet.wrl" "https://savage.nps.edu/Savage/Locations/PanamaCityFlorida/PanamaCityChartlet.wrl"'/> 
    Inline(url=["../../../Savage/Locations/PanamaCityFlorida/PanamaCity.x3d","https://savage.nps.edu/Savage/Locations/PanamaCityFlorida/PanamaCity.x3d","../../../Savage/Locations/PanamaCityFlorida/PanamaCity.wrl","https://savage.nps.edu/Savage/Locations/PanamaCityFlorida/PanamaCity.wrl"]),
    ProtoInstance(name='GridXZ',
      fieldValue=[
      fieldValue(name='description',value='GridXZ for AUV in Open Ocean'),
      fieldValue(name='labelColor',value=(1.0,1.0,1.0)),
...
print ("python x3d.py load successful for MultipleUnmannedVehiclesOffPanamaCity.py")

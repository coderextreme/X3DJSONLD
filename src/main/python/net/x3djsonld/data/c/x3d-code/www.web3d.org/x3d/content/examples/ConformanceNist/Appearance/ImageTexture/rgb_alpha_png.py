...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='rgb_alpha_png.x3d',name='title'),
    meta(content='rgb_alpha_png-front.jpg',name='Image'),
    meta(content='rgb_alpha_png-rear.jpg',name='Image'),
    meta(content='rgb_alpha_png-top.jpg',name='Image'),
    meta(content='rgb_alpha_png-bottom.jpg',name='Image'),
...
print ("python x3d.py load successful for rgb_alpha_png.py")

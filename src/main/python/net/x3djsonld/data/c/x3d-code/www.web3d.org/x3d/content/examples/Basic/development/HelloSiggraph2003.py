...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/development/HelloSiggraph2003.x3d',name='identifier'),
    ...
    Transform(DEF='EarthCoordinateSystem',
      ...
      Transform(DEF='SimpleGeoStationarySatellite',rotation=(1,0,0,.3),scale=(0.1,0.3,0.1),translation=(0,0,5),
        ...
        Shape(
          ...
          geometry=Text(string=["Hello SIGGRAPH","2003!!"],
...
print ("python x3d.py load successful for HelloSiggraph2003.py")

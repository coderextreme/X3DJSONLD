...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_cutOffAnglesim1.x3d',name='title'),
    meta(content='test-cutOffAnglesim1-movie.mpg',name='MovingImage'),
    ...
    meta(content='Test browser to set the cutOffAngle field to a range of values on a set of a simple geometry (sphere) Seven rows of spheres are drawn in the local coordinate system and a single SpotLight is defined at the center. The lights cutOffAngle is increased as the animation progesses. The animation is started by clicking on the text above the geometry. The beamWidth is set to 1.570796 for the light and is never changed. This should cause the whole area illuminated by the light to be lighted at full intensity. The area of illumination shall be no larger than the maximum value for the cutOffAngle (0.4). A browser may choose to ignore the beamWidth field.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_cutOffAnglesim1.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='test_cutOffAnglesim1.x3d'),
    Group(
      children=[
    ...
    SpotLight(DEF='the-light',beamWidth=1.57079,cutOffAngle=0.01,location=(0,0,7),radius=7),
    TimeSensor(DEF='text-time'),
    TimeSensor(DEF='the-time',cycleInterval=8),
    ScalarInterpolator(DEF='the-cutoff',key=[0,0.2,0.4,0.6,0.8,1],keyValue=[0.1,0.15,0.2,0.25,0.3,0.4]),
...
print ("python x3d.py load successful for test_cutOffAnglesim1.py")

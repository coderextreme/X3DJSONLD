...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='elevationgrid_movietexture.x3d',name='title'),
    meta(content='elevationgrid_movietexture-front.jpg',name='Image'),
    meta(content='elevationgrid_movietexture-rear.jpg',name='Image'),
    meta(content='elevationgrid_movietexture-top.jpg',name='Image'),
    meta(content='elevationgrid_movietexture-bottom.jpg',name='Image'),
    meta(content='elevationgrid_movietexture-left.jpg',name='Image'),
    meta(content='elevationgrid_movietexture-right.jpg',name='Image'),
...
print ("python x3d.py load successful for elevationgrid_movietexture.py")

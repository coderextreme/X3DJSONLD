...
newModel=X3D(profile='Immersive',version='3.2',
  head=head(
    children=[
    meta(content='TestOrientationFollower.x3d',name='title'),
    ...
    meta(content='originals/test_OriFollower.wrl',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/Followers/TestOrientationFollower.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='TestOrientationFollower.x3d'),
    Viewpoint(description='TestOrientationFollower',fieldOfView=0.716,position=(0.155,0.364,7.642)),
    NavigationInfo(type=["NONE"]),
    ProtoDeclare(name='Monkey',
      ProtoInterface=ProtoInterface(
        field=[
        field(accessType='inputOutput',name='appearance',type='SFNode',
          children=[
          Appearance(
            material=Material(ambientIntensity=0.04,diffuseColor=(0.44,0.27,0.17),emissiveColor=(0.21,0.13,0.08),shininess=0.19,specularColor=(0.29,0.31,0.05)))]),
        field(accessType='initializeOnly',name='credits',type='MFString',value=["The model was created using Blender software"])]),
      ProtoBody=ProtoBody(
        children=[
        Transform(rotation=(0.0,0.0,1.0,0.01),
          children=[
          Transform(rotation=(-0.074,0.991,0.113,-1.1),
            children=[
            Shape(
              IS=IS(
                connect=[
      ...
      Transform(DEF='TrMonkeyChaser',
        ...
        ProtoInstance(name='Monkey',
          ...
          fieldValue(name='appearance',
            children=[
            Appearance(
              material=Material(ambientIntensity=0.0,diffuseColor=(0.48,0.8,0.0),emissiveColor=(0.09,0.15,0.0),specularColor=(0.3,0.3,0.3)))])])])]),
    ProtoDeclare(name='OriSetter',
      ProtoInterface=ProtoInterface(
        field=[
        field(accessType='inputOnly',name='Stop',type='SFTime'),
        field(accessType='outputOnly',name='Ori',type='SFRotation'),
        field(accessType='outputOnly',name='isActive',type='SFBool')]),
      ProtoBody=ProtoBody(
        children=[
        Group(
          children=[
          PlaneSensor(DEF='Sens',description='touch to activate'),
          Transform(DEF='TrMonkey',scale=(0.25,0.25,0.25),
            children=[
            ProtoInstance(name='Monkey',
              fieldValue=[
              fieldValue(name='appearance',
                children=[
                Appearance(
                  material=Material(ambientIntensity=0.0,diffuseColor=(0.0,0.48,0.8),emissiveColor=(0.0,0.09,0.15),specularColor=(0.3,0.3,0.3)))])])]),
          Shape(
            appearance=Appearance(
              material=Material(diffuseColor=(0.0,0.0,0.0),transparency=1.0)),
            geometry=Sphere(radius=0.3))]),
        PositionDamper(DEF='PositionDamperNode',order=1,tau=0.15),
        Script(DEF='ScrOriSetter',
          field=[
          field(accessType='initializeOnly',name='LastPos',type='SFVec3f',value=(0.0,0.0,0.0)),
          field(accessType='outputOnly',name='OriOt',type='SFRotation'),
          field(accessType='inputOnly',name='PosIn',type='SFVec3f')]),
        ROUTE(fromField='translation_changed',fromNode='Sens',toField='set_destination',toNode='PositionDamperNode'),
        ROUTE(fromField='value_changed',fromNode='PositionDamperNode',toField='PosIn',toNode='ScrOriSetter'),
        ROUTE(fromField='OriOt',fromNode='ScrOriSetter',toField='rotation',toNode='TrMonkey'),
        Script(DEF='ScrStopper',directOutput=True,
          field=[
          field(accessType='inputOnly',name='OriIn',type='SFRotation'),
          field(accessType='initializeOnly',name='Damper',type='SFNode',
            children=[
            PositionDamper(USE='PositionDamperNode')]),
          field(accessType='inputOnly',name='Stop',type='SFTime'),
          field(accessType='inputOnly',name='SensorIsActive',type='SFBool'),
          field(accessType='initializeOnly',name='Stopped',type='SFBool',value=False),
          field(accessType='outputOnly',name='OriOt',type='SFRotation')],
          IS=IS(
            connect=[
            connect(nodeField='Stop',protoField='Stop'),
            connect(nodeField='OriOt',protoField='Ori')])),
        ROUTE(fromField='OriOt',fromNode='ScrOriSetter',toField='OriIn',toNode='ScrStopper'),
        ROUTE(fromField='isActive',fromNode='Sens',toField='SensorIsActive',toNode='ScrStopper')])),
    Transform(translation=(0.0,2.0,0.0),
      children=[
      Transform(translation=(-2.0,0.0,0.0),
        children=[
        ProtoInstance(DEF='OseA',name='OriSetter')]),
      Transform(translation=(-1.0,0.0,0.0),
        children=[
        ProtoInstance(DEF='OseB',name='OriSetter')]),
      Transform(
        children=[
        ProtoInstance(DEF='OseC',name='OriSetter')]),
      Transform(translation=(1.0,0.0,0.0),
        children=[
        ProtoInstance(DEF='OseD',name='OriSetter')]),
      Transform(translation=(2.0,0.0,0.0),
        children=[
        ProtoInstance(DEF='OseE',name='OriSetter')])]),
    ProtoDeclare(name='SelectButton',
      ProtoInterface=ProtoInterface(
        field=[
        field(accessType='outputOnly',name='touched',type='SFTime')]),
      ProtoBody=ProtoBody(
        children=[
        Transform(scale=(1.0,1.0,0.2),
          children=[
          TouchSensor(DEF='Tch',description='touch to activate'),
          Shape(
            appearance=Appearance(
              material=Material(DEF='Mat',ambientIntensity=0.0,diffuseColor=(0.0,0.24,0.4),emissiveColor=(0.0,0.045,0.075),specularColor=(0.5,0.5,0.5))),
            geometry=Sphere(radius=0.17)),
          Shape(
            appearance=Appearance(
              material=Material(transparency=1.0)),
            geometry=Sphere(radius=0.27))]),
        ColorDamper(DEF='DampDiffuse',order=1,tau=0.15),
        ColorDamper(DEF='DampEmissive',order=1,tau=0.15),
        ColorDamper(DEF='DampSpecular',order=1,tau=0.15),
        Script(DEF='ScrSelectBtn',
          field=[
          field(accessType='inputOnly',name='DampEmissive_sThere',type='SFBool'),
          field(accessType='initializeOnly',name='cEmissiveHot',type='SFColor',value=(0.0,0.135,0.225)),
          field(accessType='outputOnly',name='DiffuseValue',type='SFColor'),
          field(accessType='initializeOnly',name='SpecularHot',type='SFColor',value=(0.75,0.75,0.75)),
          field(accessType='initializeOnly',name='cEmissiveCold',type='SFColor',value=(0.0,0.045,0.075)),
          field(accessType='initializeOnly',name='cDiffuseHot',type='SFColor',value=(0.0,0.72,0.6)),
          field(accessType='initializeOnly',name='cDiffuseCold',type='SFColor',value=(0.0,0.24,0.4)),
          field(accessType='inputOnly',name='DampSpecular_sThere',type='SFBool'),
          field(accessType='outputOnly',name='DiffuseDest',type='SFColor'),
          field(accessType='outputOnly',name='EmissiveValue',type='SFColor'),
          field(accessType='outputOnly',name='SpecularDest',type='SFColor'),
          field(accessType='inputOnly',name='DampDiffuse_sThere',type='SFBool'),
          field(accessType='outputOnly',name='SpecularValue',type='SFColor'),
          field(accessType='inputOnly',name='touched',type='SFTime'),
          field(accessType='outputOnly',name='EmissiveDest',type='SFColor'),
          field(accessType='initializeOnly',name='cSpecularCold',type='SFColor',value=(0.5,0.5,0.5))]),
        ROUTE(fromField='touchTime',fromNode='Tch',toField='touched',toNode='ScrSelectBtn'),
        ROUTE(fromField='DiffuseDest',fromNode='ScrSelectBtn',toField='set_destination',toNode='DampDiffuse'),
        ROUTE(fromField='DiffuseValue',fromNode='ScrSelectBtn',toField='set_value',toNode='DampDiffuse'),
        ROUTE(fromField='EmissiveDest',fromNode='ScrSelectBtn',toField='set_destination',toNode='DampEmissive'),
        ROUTE(fromField='EmissiveValue',fromNode='ScrSelectBtn',toField='set_value',toNode='DampEmissive'),
        ROUTE(fromField='SpecularDest',fromNode='ScrSelectBtn',toField='set_destination',toNode='DampSpecular'),
        ROUTE(fromField='SpecularValue',fromNode='ScrSelectBtn',toField='set_value',toNode='DampSpecular'),
        ROUTE(fromField='value_changed',fromNode='DampDiffuse',toField='diffuseColor',toNode='Mat'),
        ROUTE(fromField='value_changed',fromNode='DampEmissive',toField='emissiveColor',toNode='Mat'),
        ROUTE(fromField='value_changed',fromNode='DampSpecular',toField='specularColor',toNode='Mat'),
        ROUTE(fromField='isActive',fromNode='DampDiffuse',toField='DampDiffuse_sThere',toNode='ScrSelectBtn'),
        ROUTE(fromField='isActive',fromNode='DampEmissive',toField='DampEmissive_sThere',toNode='ScrSelectBtn'),
        ROUTE(fromField='isActive',fromNode='DampSpecular',toField='DampSpecular_sThere',toNode='ScrSelectBtn')])),
    Transform(translation=(0.0,2.5,0.0),
      children=[
      Transform(translation=(-2.0,0.0,0.0),
        children=[
        ProtoInstance(DEF='BtnA',name='SelectButton')]),
      Transform(translation=(-1.0,0.0,0.0),
        children=[
        ProtoInstance(DEF='BtnB',name='SelectButton')]),
      Transform(
        children=[
        ProtoInstance(DEF='BtnC',name='SelectButton')]),
      Transform(translation=(1.0,0.0,0.0),
        children=[
        ProtoInstance(DEF='BtnD',name='SelectButton')]),
      Transform(translation=(2.0,0.0,0.0),
        children=[
        ProtoInstance(DEF='BtnE',name='SelectButton')])]),
    Script(DEF='ScrMain',
      field=[
      field(accessType='outputOnly',name='RandomOri_selected',type='SFRotation'),
      field(accessType='initializeOnly',name='OriE',type='SFRotation',value=(0.0,0.0,1.0,0.0)),
      field(accessType='initializeOnly',name='OriD',type='SFRotation',value=(0.0,0.0,1.0,0.0)),
      field(accessType='initializeOnly',name='OriC',type='SFRotation',value=(0.0,0.0,1.0,0.0)),
      field(accessType='initializeOnly',name='OriB',type='SFRotation',value=(0.0,0.0,1.0,0.0)),
      field(accessType='initializeOnly',name='OriA',type='SFRotation',value=(0.0,0.0,1.0,0.0)),
      field(accessType='inputOnly',name='BtnD_touched',type='SFTime'),
      field(accessType='inputOnly',name='BtnA_touched',type='SFTime'),
      field(accessType='inputOnly',name='BtnRandom_touched',type='SFTime'),
      field(accessType='outputOnly',name='Ori_toSet',type='SFRotation'),
      field(accessType='inputOnly',name='BtnE_touched',type='SFTime'),
      field(accessType='inputOnly',name='BtnC_touched',type='SFTime'),
      field(accessType='inputOnly',name='BtnB_touched',type='SFTime'),
      field(accessType='outputOnly',name='Stop_Continous',type='SFTime'),
      field(accessType='inputOnly',name='set_OriE',type='SFRotation'),
      field(accessType='inputOnly',name='set_OriD',type='SFRotation'),
      field(accessType='inputOnly',name='set_OriC',type='SFRotation'),
      field(accessType='inputOnly',name='set_OriContinous',type='SFRotation'),
      field(accessType='inputOnly',name='set_OriB',type='SFRotation'),
      field(accessType='inputOnly',name='set_OriA',type='SFRotation')]),
    ROUTE(fromField='touched',fromNode='BtnA',toField='BtnA_touched',toNode='ScrMain'),
    ROUTE(fromField='touched',fromNode='BtnB',toField='BtnB_touched',toNode='ScrMain'),
    ROUTE(fromField='touched',fromNode='BtnC',toField='BtnC_touched',toNode='ScrMain'),
    ROUTE(fromField='touched',fromNode='BtnD',toField='BtnD_touched',toNode='ScrMain'),
    ROUTE(fromField='touched',fromNode='BtnE',toField='BtnE_touched',toNode='ScrMain'),
    ROUTE(fromField='Ori',fromNode='OseA',toField='set_OriA',toNode='ScrMain'),
    ROUTE(fromField='Ori',fromNode='OseB',toField='set_OriB',toNode='ScrMain'),
    ROUTE(fromField='Ori',fromNode='OseC',toField='set_OriC',toNode='ScrMain'),
    ROUTE(fromField='Ori',fromNode='OseD',toField='set_OriD',toNode='ScrMain'),
    ROUTE(fromField='Ori',fromNode='OseE',toField='set_OriE',toNode='ScrMain'),
    Transform(translation=(3.0,0.5,0.0),
      children=[
      ProtoInstance(DEF='BtnRandom',name='SelectButton'),
      Transform(DEF='TrRandom',scale=(0.25,0.25,0.25),translation=(-0.7,0.0,0.0),
        children=[
        ProtoInstance(name='Monkey',
          fieldValue=[
          fieldValue(name='appearance',
            ...
            Appearance(
              material=Material(ambientIntensity=0.0,diffuseColor=(0.0,0.48,0.8),emissiveColor=(0.0,0.09,0.15),specularColor=(0.3,0.3,0.3)))])])]),
      Transform(translation=(0.5,-0.1,0.0),
        children=[
        Shape(
          appearance=Appearance(
            material=Material(ambientIntensity=0.0,diffuseColor=(0.0,0.48,0.8),emissiveColor=(0.0,0.09,0.15),specularColor=(0.3,0.3,0.3))),
          geometry=Text(string=["Random"],
            fontStyle=FontStyle(family=["Arial","SANS"],size=0.3)))])]),
    OrientationDamper(DEF='DampRandomInd',order=1,tau=0.05),
    ROUTE(fromField='touched',fromNode='BtnRandom',toField='BtnRandom_touched',toNode='ScrMain'),
    ROUTE(fromField='RandomOri_selected',fromNode='ScrMain',toField='set_destination',toNode='DampRandomInd'),
    ROUTE(fromField='value_changed',fromNode='DampRandomInd',toField='rotation',toNode='TrRandom')])
) # X3D model complete
...
print ("python x3d.py load successful for TestOrientationFollower.py")

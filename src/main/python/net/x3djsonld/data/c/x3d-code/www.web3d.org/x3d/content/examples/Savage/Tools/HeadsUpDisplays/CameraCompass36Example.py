  ...
  Scene=Scene(
    ...
    Transform(DEF='CenterInstructions',translation=(0,0.75,0),
      ...
      Billboard(
        children=[
        Shape(
          geometry=Text(string=["Walk and rotate to move scene while","compass heads-up display (HUD)","CameraCompass36 stays overhead"],
...
print ("python x3d.py load successful for CameraCompass36Example.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  ...
  Scene=Scene(
    ...
    Transform(DEF='dad_GROUND',
      ...
      Group(DEF='GROUND',
        children=[
        Transform(DEF='dad_CSG11',rotation=(1,0,0,1.571),
          children=[
          Shape(DEF='CSG11',
            appearance=Appearance(
              texture=ImageTexture(repeatS=False,repeatT=False,url=["CSG11.jpg"]),
              textureTransform=TextureTransform(scale=(1.036,1.023),translation=(.03524,.02188),center=(-1.62,-1.389)),

    ...
    Group(
      ...
      Transform(translation=(3,0,0),
        ...
        Shape(
          appearance=Appearance(
            material=Material(),
            texture=ImageTexture(DEF='greyscale_trans.png',url=["greyscale_trans.png","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/greyscale_trans.png"])),
          geometry=Box(),)]),
      Transform(translation=(-3,0,0),
        children=[
        Shape(
      ...
      Transform(translation=(1,0,0),
        ...
        Shape(
          appearance=Appearance(
            material=Material(),
            texture=ImageTexture(USE='greyscale_trans.png')),
          geometry=Cylinder(),)])])])
) # X3D model complete
...
print ("python x3d.py load successful for greyscale_alpha_png.py")

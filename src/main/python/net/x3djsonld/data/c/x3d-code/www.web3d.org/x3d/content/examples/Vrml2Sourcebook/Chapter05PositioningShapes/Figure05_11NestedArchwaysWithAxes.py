...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure05_11NestedArchwaysWithAxes.x3d',name='title'),
    ...
    meta(content='Nesting coordinate systems, coordinate axes superimposed to show X3D/VRML directions.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter05PositioningShapes/Figure05_11NestedArchwaysWithAxes.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure05_11NestedArchwaysWithAxes.x3d'),
    ...
    Group(
      ...
      #  Possible improvement: rename LEFT_COLUMN to LEFT_COLUMN_TRANSFORM for clarity. 
...
print ("python x3d.py load successful for Figure05_11NestedArchwaysWithAxes.py")

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='Datasets, http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/nrrd/internals.nrrd',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BlendedBodyInternals.x3d',name='identifier'),
  ...
  Scene=Scene(
    children=[
    WorldInfo(title='BlendedBodyInternals.x3d'),
    Group(
      children=[
      ...
      Transform(scale=(0.000292969,0.000292969,0.000292969),
        ...
        VolumeData(dimensions=(512,512,452),
          renderStyle=[
          BlendedVolumeStyle(weightConstant1=0.51,
            renderStyle=[
            ToneMappedVolumeStyle(),],
            voxels=ImageTexture3D(url=["datasets/nrrd/internals.nrrd","http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/nrrd/internals.nrrd","https://savage.nps.edu/Savage/VolumeRendering/datasets/nrrd/.nrrd"])),],
...
print ("python x3d.py load successful for BlendedBodyInternals.py")

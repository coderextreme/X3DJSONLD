    ...
    Transform(translation=(-4,0,-4),
      ...
      Shape(
        ...
        appearance=Appearance(
          ...
          texture=ImageTexture(url=["../earth-topo.png","http://X3dGraphics.com/examples/X3dForWebAuthors/earth-topo.png"]))),
...
print ("python x3d.py load successful for ExtrusionPentagonCrossSectionItssTexture.py")

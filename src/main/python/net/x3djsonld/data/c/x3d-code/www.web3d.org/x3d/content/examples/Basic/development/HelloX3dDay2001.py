...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='HelloSiggraph2000.x3d',name='title'),
    meta(content='Don Brutzman',name='creator'),
    meta(content='14 July 2000',name='created'),
    meta(content='20 October 2019',name='modified'),
    meta(content='A simple VRML/X3D scene-graph example.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/development/HelloSiggraph2000.x3d',name='identifier'),
    ...
    Transform(DEF='EarthCoordinateSystem',
      ...
      Transform(DEF='SimpleGeoStationarySatellite',rotation=(1,0,0,.3),scale=(0.1,0.3,0.1),translation=(0,0,5),
        ...
        Shape(
          ...
          geometry=Text(string=["Hello X3D Day Santa Clara !!","https://www.web3d.org/x3d"],
            fontStyle=FontStyle(justify=["MIDDLE","MIDDLE"],size=3))),
        Shape(
          appearance=Appearance(
            material=Material(),),
          geometry=IndexedFaceSet(),)]),
      Anchor(description='launch the SDK site',parameter=["target=_blank"],url=["https://www.web3d.org/x3d/content/examples/X3dResources.html#Showcase"],
        children=[
        Group(DEF='MiniWorld',
          children=[
          Shape(
...
print ("python x3d.py load successful for HelloSiggraph2000.py")

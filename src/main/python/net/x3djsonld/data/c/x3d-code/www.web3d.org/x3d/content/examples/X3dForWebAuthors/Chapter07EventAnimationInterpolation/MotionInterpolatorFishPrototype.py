...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='MotionInterpolatorFishPrototype.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/MotionInterpolatorFishPrototype.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='MotionInterpolatorFishPrototype.x3d'),
        ...
        Transform(DEF='Way',
          ...
          Transform(rotation=(1,0,0,1.395),
            ...
            Transform(DEF='FishTransform',
              ...
              ROUTE(fromField='fraction_changed',fromNode='TransparencyTimer',toField='set_fraction',toNode='TransparencyValue'),
              ROUTE(fromField='value_changed',fromNode='TransparencyValue',toField='transparency',toNode='FishColor'),
              Shape(
...
print ("python x3d.py load successful for MotionInterpolatorFishPrototype.py")

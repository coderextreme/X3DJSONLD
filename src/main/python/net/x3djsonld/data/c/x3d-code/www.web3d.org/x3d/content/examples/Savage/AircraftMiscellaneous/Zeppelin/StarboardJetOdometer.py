...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='StarboardJetOdometer.x3d',name='title'),
    meta(content='Selcuk OZTURK',name='creator'),
    meta(content='Starboard jet odometer.',name='description'),
    meta(content='16 September 2002',name='created'),
    meta(content='12 January 2012',name='modified'),
    meta(content='https://savage.nps.edu/Savage/AircraftMiscellaneous/Zeppelin/StarboardJetOdometer.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(DEF='SCALE',
      children=[
      Transform(rotation=(0,0,1,-1.57),scale=(1,1,0.1),translation=(0.8,0,0.1),
        children=[
        Shape(
          appearance=Appearance(
            material=Material(diffuseColor=(0,1,0))),
          geometry=Cone(bottomRadius=0.1,height=0.2))]),
      Transform(rotation=(0,0,1,-1.57),scale=(1,1,0.1),translation=(0.3,0,0.1),
        children=[
        Shape(
          appearance=Appearance(
            material=Material(diffuseColor=(0,1,0))),
...
print ("python x3d.py load successful for StarboardJetOdometer.py")

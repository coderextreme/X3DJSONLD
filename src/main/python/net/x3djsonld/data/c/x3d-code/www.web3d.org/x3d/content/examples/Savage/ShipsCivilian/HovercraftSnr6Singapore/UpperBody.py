...
newModel=X3D(profile='Interactive',version='3.0',
  ...
  Scene=Scene(
    ...
    Transform(translation=(0,0,12),
      children=[
      Inline(DEF='TopFront',url=["TopFront.x3d","https://savage.nps.edu/Savage/ShipsMilitary/HovercraftSnr6Singapore/TopFront.x3d","TopFront.wrl","https://savage.nps.edu/Savage/ShipsMilitary/HovercraftSnr6Singapore/TopFront.wrl"])]),

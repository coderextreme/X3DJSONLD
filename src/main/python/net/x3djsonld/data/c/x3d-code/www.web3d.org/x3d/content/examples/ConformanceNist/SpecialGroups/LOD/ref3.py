...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/SpecialGroups/LOD/ref3.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(-3.5,2,1.1),
      ...
      Shape(
        appearance=Appearance(
          material=Material(),),
        geometry=Cylinder(height=4,radius=0.11))]),
    Transform(translation=(3.5,2,1.1),
      children=[
      Shape(
        appearance=Appearance(
          material=Material(),),
        geometry=Cylinder(height=4,radius=0.11))]),
    Transform(translation=(0,-0.75,1.62),
      children=[
      Shape(
        appearance=Appearance(
          material=Material(),),

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_ambeffect_ambientcom.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(
      children=[
      PointLight(DEF='the-light',ambientIntensity=0.2,intensity=0.5,location=(0,0,10),radius=50),
      Transform(scale=(0.7,0.7,0.7),translation=(-2.87,-0.147732,0),
        children=[
        Shape(
          appearance=Appearance(
            material=Material(ambientIntensity=0.3)),
          geometry=IndexedFaceSet(DEF='the-set',coordIndex=[0,1,3,2,-1,4,5,7,6,-1,6,7,1,0,-1,2,3,5,4,-1,6,0,2,4,-1,1,7,5,3,-1],creaseAngle=0.5,
...
print ("python x3d.py load successful for test_ambeffect_ambientcom.py")

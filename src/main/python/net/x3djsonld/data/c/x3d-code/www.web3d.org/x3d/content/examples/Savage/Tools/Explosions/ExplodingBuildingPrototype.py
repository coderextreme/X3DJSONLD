...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/Tools/Explosions/ExplodingBuildingPrototype.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Anchor(description='ExplodingBuilding Example',parameter=["target=_blank"],url=["ExplodingBuildingExample.x3d","https://savage.nps.edu/Savage/Tools/Explosions/ExplodingBuildingExample.x3d","ExplodingBuildingExample.wrl","https://savage.nps.edu/Savage/Tools/Explosions/ExplodingBuildingExample.wrl"],
      children=[
      Shape(
        geometry=Text(string=["ExplodingBuildingPrototype","is a prototype definition file","","Click this text to see","ExplodingBuildingExample"],
...
print ("python x3d.py load successful for ExplodingBuildingPrototype.py")

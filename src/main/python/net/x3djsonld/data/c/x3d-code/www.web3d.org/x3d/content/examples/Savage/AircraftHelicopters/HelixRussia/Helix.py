...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='Michael Perry, Jeff Lark',name='creator'),
    meta(content='25 Sept 2000',name='created'),
    meta(content='12 January 2014',name='modified'),
    meta(content='Extrusion problems in Xj3D',name='warning'),
    meta(content='HelixModelingProjectReport.pdf',name='reference'),
    meta(content='HelixModelingProjectReport.doc',name='reference'),
    meta(content='HelixQueryJanesOnline.pdf',name='reference'),
    meta(content='HelixQueryJanesOnline.doc',name='reference'),
    meta(content='http://avia.russian.ee/helix/ka-27.html',name='reference'),
    meta(content='Simple model of Russian Anti-Submarine Warfare (ASW) helicopter. KA-27 NATO name: Helix.',name='description'),
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/HelixRussia/Helix.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(
      ...
      Shape(
        appearance=Appearance(
          material=Material(DEF='grey',diffuseColor=(.4,.4,.4))),
        geometry=Extrusion(DEF='Extrusion1',creaseAngle=2.0,crossSection=[(0,-1),(-.38,-.92),(-.71,-.71),(-.92,-.38),(-1,0),(-.92,.38),(-.71,.71),(-.38,.92),(0,1),(.38,.92),(.71,.71),(.92,.38),(1,0),(.92,-.38),(.71,-.71),(.38,-.92),(0,-1)],scale=[(.6,.6),(.5,.5),(.4,.4),(.3,.3),(.2,.2)],solid=False,spine=[(-2.3,.3,0),(-3,.3,0),(-4,.3,0),(-5,.3,0),(-6,.3,0)]))]),
    ...
    #  TODO fix 
    Transform(rotation=(1,0,0,1.57),scale=(.6,1.2,.1),translation=(-5.5,.3,1.1),
      children=[
      Shape(DEF='AftFuselage',
        appearance=Appearance(
          material=Material(USE='grey')),
    ...
    Transform(
      ...
      Shape(
        appearance=Appearance(
          material=Material(USE='grey')),
        geometry=Extrusion(DEF='Extrusion2',creaseAngle=2.0,crossSection=[(0,-1),(-.38,-.92),(-.71,-.71),(-.92,-.38),(-1,0),(-.92,.38),(-.71,.71),(-.38,.92),(0,1),(.38,.92),(.71,.71),(.92,.38),(1,0),(.92,-.38),(.71,-.71),(.38,-.92),(0,-1)],scale=[(.1,.2),(.4,.5),(.62,.7),(.75,.82),(.85,.9),(.93,.95),(.97,.96),(.98,.98),(.99,.99),(1,1),(1,1)],spine=[(-3.0,0,0),(-2.9,0,0),(-2.8,0,0),(-2.7,0,0),(-2.6,0,0),(-2.5,0,0),(-2.4,0,0),(-2.3,0,0),(-2.2,0,0),(-2.1,0,0),(-2,0,0)]))]),
    #  Fuselage 
    Transform(
      children=[
      Shape(
        appearance=Appearance(
          material=Material(USE='grey')),
        geometry=Extrusion(DEF='Extrusion3',creaseAngle=2.0,crossSection=[(0,-1),(-.38,-.92),(-.71,-.71),(-.92,-.38),(-1,0),(-.92,.38),(-.71,.71),(-.38,.92),(0,1),(.38,.92),(.71,.71),(.92,.38),(1,0),(.92,-.38),(.71,-.71),(.38,-.92),(0,-1)],spine=[(3,0,0),(-2,0,0)]))]),
    #  Cabin Door 
    ...
    Transform(translation=(0,1.5,0),
      ...
      Transform(scale=(1,.001,1),translation=(0,.14,0),
        children=[
        Shape(DEF='Rotor',
          appearance=Appearance(
            material=Material(diffuseColor=(1,1,1),transparency=.35)),
          geometry=Sphere(radius=6.5))]),
      Transform(scale=(1,.005,1),translation=(0,.92,0),
        children=[
        Shape(USE='Rotor')]),
      Transform(translation=(0,1.5,0),
        children=[
    ...
    Transform(translation=(3.2,0,.5),
      ...
      Shape(DEF='Body',
        appearance=Appearance(
          material=Material(diffuseColor=(0,.4,0))),
        geometry=Box(size=(.1,.5,.43)))]),
    Transform(translation=(3.2,.4,-.5),
      children=[
      Shape(USE='helmet')]),
    Transform(translation=(3.2,0,-.5),
      children=[
      Shape(USE='Body')]),
    Background(groundAngle=[1.309,1.570796],groundColor=[(.1,.10,0),(0.4,.25,.2),(.6,.60,.6)],skyAngle=[1.309,1.571],skyColor=[(0,.2,.7),(0,.5,1),(1,1,1)]),
    #  Camera Views 
    Transform(
      children=[
      Viewpoint(description='Two Thirty Low',position=(0,0,12))]),
    Viewpoint(description="Nine O'Clock Level",orientation=(0,1,0,3.142),position=(0,2,-12)),
    Transform(rotation=(0,0,1,-.175),
      children=[
      Viewpoint(description="Six O'clock High",orientation=(0,1,0,-1.571),position=(-15,2,0))]),
    Viewpoint(description="Twelve O'Clock level",orientation=(0,1,0,1.571),position=(12,1,0)),
    Viewpoint(description='Ground View',orientation=(1,0,0,.624),position=(0,-12,15)),
    Viewpoint(description='Crewcam',fieldOfView=.8727,orientation=(0,1,0,1.571),position=(3.95,0.2,0)),
    #  Aircrew Name tags 
    Transform(rotation=(0,1,0,1.571),translation=(3.255,0.21,.4),
      children=[
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(0,0,0))),
        geometry=Text(string=["MAJOR","IVAN"],
          fontStyle=FontStyle(size=.03,style_='BOLD')))]),
    Transform(rotation=(0,1,0,1.571),translation=(3.255,0.21,-.55),
      children=[
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(0,0,0))),
        geometry=Text(string=["CAPTAIN","BORIS"],
          fontStyle=FontStyle(size=.03,style_='BOLD')))]),
    #  Side Number 

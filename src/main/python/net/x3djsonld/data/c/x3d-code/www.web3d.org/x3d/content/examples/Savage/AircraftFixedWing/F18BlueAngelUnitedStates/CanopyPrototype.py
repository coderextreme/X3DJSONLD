...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='canopy opening and closing, Prototype',name='subject'),
        ...
        Transform(scale=(1.4,1,1),
          ...
          Group(
            ...
            Script(DEF='CanopyScript',
              field=[
              field(accessType='inputOnly',appinfo='eventIn: boolean true: canopy open false: canopy close',name='canopyOpen',type='SFBool'),
              field(accessType='outputOnly',name='canopyOut',type='SFBool'),
              field(accessType='outputOnly',name='keyValue',type='MFRotation'),
              field(accessType='initializeOnly',name='kV1',type='SFRotation',value=(0,1,0,0)),
              field(accessType='initializeOnly',name='kV2',type='SFRotation',value=(0,1,0,0)),
              field(accessType='initializeOnly',name='kV3',type='SFRotation',value=(0,1,0,0)),
              ...
              IS=IS(
                connect=[
                connect(nodeField='canopyOpen',protoField='canopyOpen'),
                connect(nodeField='animationStartTime',protoField='animationStartTime'),
                connect(nodeField='canopyOut',protoField='canopyOut'),
                connect(nodeField='traceEnabled',protoField='traceEnabled')])),
            OrientationInterpolator(DEF='CanopyInterpolator',key=[0,0.5,1.0],keyValue=[(1,0,0,0.0),(1,0,0,0.52),(1,0,0,0.79)]),
            TimeSensor(DEF='Clock',cycleInterval=4),
            ROUTE(fromField='clockStartTime',fromNode='CanopyScript',toField='set_startTime',toNode='Clock'),
            ROUTE(fromField='canopyOut',fromNode='CanopyScript',toField='set_enabled',toNode='Clock'),
            ROUTE(fromField='keyValue',fromNode='CanopyScript',toField='set_keyValue',toNode='CanopyInterpolator'),
            ROUTE(fromField='fraction_changed',fromNode='Clock',toField='set_fraction',toNode='CanopyInterpolator'),
            ROUTE(fromField='fraction_changed',fromNode='Clock',toField='set_fraction',toNode='CanopyScript'),
            ROUTE(fromField='value_changed',fromNode='CanopyInterpolator',toField='set_rotation',toNode='CanopyTransform')])])])),
    Background(skyColor=[(0.6,0.6,0.6)]),
    Anchor(description='Canopy Example',parameter=["target=_blank"],url=["CanopyExample.wrl","../../AircraftFixedWing/F18BlueAngelUnitedStates/CanopyExample.wrl","https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/CanopyExample.wrl","CanopyExample.x3d","../../AircraftFixedWing/F18BlueAngelUnitedStates/CanopyExample.x3d","https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/CanopyExample.x3d"],
      children=[
      Shape(
        geometry=Text(string=["CanopyPrototype","is a prototype definition file","","To see an example scene","click on this text and view","CanopyExample"],

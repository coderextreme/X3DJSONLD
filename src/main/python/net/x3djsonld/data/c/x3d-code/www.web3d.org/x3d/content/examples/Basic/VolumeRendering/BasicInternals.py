...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='BasicInternals.x3d',name='title'),
    meta(content='PET scan of human torso exibiting several abnormalities',name='description'),
    ...
    meta(content='BasicInternals.x3d',name='reference'),
    meta(content='README.txt',name='reference'),
    meta(content='Get prerequisite dataset, http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/nrrd/internals.nrrd',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BasicInternals.x3d',name='identifier'),
  ...
  Scene=Scene(
    children=[
    WorldInfo(title='BasicInternals.x3d'),
    Group(
      children=[
      Viewpoint(DEF='VP',description='Basic Internals',orientation=(0.940022,0.208839,0.269711,1.71637),position=(0.108923,-0.189725,-0.0135375)),
      Background(DEF='BG'),
...
print ("python x3d.py load successful for BasicInternals.py")

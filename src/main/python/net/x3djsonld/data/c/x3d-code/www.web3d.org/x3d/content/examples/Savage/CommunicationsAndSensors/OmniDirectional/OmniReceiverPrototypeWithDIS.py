...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='OmniReceiverPrototypeWithDIS.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/CommunicationsAndSensors/OmniDirectional/OmniReceiverPrototypeWithDIS.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    ProtoDeclare(appinfo='Omnidirectional hemispherical receiver with integrated DIS ReceiverPdu functionality.',name='OmniReceiverDIS',
      ...
      ProtoBody=ProtoBody(
        ...
        Group(
          ...
          ReceiverPdu(DEF='RECEIVER',address='224.2.181.145',entityID=1,port=62040,readInterval=1,whichGeometry=0,receivedPower=0.0,
            IS=IS(
              connect=[
        ...
        ROUTE(fromField='receiverState',fromNode='RECEIVER',toField='transState',toNode='TransmitScript'),
    ...
    ProtoInstance(name='OmniReceiverDIS',
      fieldValue=[
...
print ("python x3d.py load successful for OmniReceiverPrototypeWithDIS.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='SatelliteTripod.x3d',name='title'),
    meta(content='Mike Hunsberger',name='creator'),
    meta(content='5 June 2001',name='created'),
    meta(content='29 August 2003',name='modified'),
    meta(content='Simple tripod stand for satellite dish.',name='description'),
    meta(content='https://savage.nps.edu/Savage/CommunicationsAndSensors/Satellite/SatelliteTripod.x3d',name='identifier'),
...
print ("python x3d.py load successful for SatelliteTripod.py")

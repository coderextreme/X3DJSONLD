...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='ambientIntensity-front.jpg',name='Image'),
    meta(content='ambientIntensity-rear.jpg',name='Image'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(-2,-0.75,0),
      ...
      Shape(
        appearance=Appearance(
          material=Material(ambientIntensity=0.25)),
        geometry=Sphere(radius=0.5))]),
    ...
    Transform(translation=(2,-0.75,0),
      ...
      Shape(
        appearance=Appearance(
          material=Material(ambientIntensity=0.75)),
        geometry=Sphere(radius=0.5))]),
    Transform(translation=(4,-0.75,0),
      children=[
      Shape(

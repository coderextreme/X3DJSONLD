...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='indexedfaceset_imagetexture_entire.x3d',name='title'),
    ...
    meta(content='Test of browser ability to map an ImageTexture onto an entireIndexedFaceSet geometry. The entire VTS logo texture should map once onto the surface of the IndexedFaceSet, with the S axis corresponding to the X axis of the IndexedFaceSet.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_imagetexture_entire.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='indexedfaceset_imagetexture_entire.x3d'),
...
print ("python x3d.py load successful for indexedfaceset_imagetexture_entire.py")

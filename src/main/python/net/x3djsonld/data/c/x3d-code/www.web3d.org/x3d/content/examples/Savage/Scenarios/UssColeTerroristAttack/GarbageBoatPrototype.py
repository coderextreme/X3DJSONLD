...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='GarbageBoatPrototype.x3d',name='title'),
    meta(content='James Harney',name='creator'),
    meta(content='17 December 2001',name='created'),
    meta(content='27 March 2016',name='modified'),
    meta(content='Simple model of a presumed Garbage boat present on the day of the terrorist attack on the USS COLE in Aden, Yemen Aligned down positive x axis as required for Savage vehicle models.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/Scenarios/UssColeTerroristAttack/GarbageBoatPrototype.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    ProtoDeclare(name='GarbageBoat',
      ...
      ProtoBody=ProtoBody(
        ...
        Group(
          ...
          Transform(
            children=[
            Viewpoint(DEF='STBD',description='Garbage Boat stbd View',jump=False,orientation=(1,0,0,-0.2),position=(5,10,35)),
            Viewpoint(DEF='REAR',description='Garbage Boat Rear View',jump=False,orientation=(0,1,0,-1.57),position=(-30,8,0)),
            Viewpoint(description='Garbage Boat Port View',jump=False,orientation=(0,1,0,3.14),position=(5,8,-30)),
            Viewpoint(DEF='FRONT',description='Garbage Boat Front View',jump=False,orientation=(0,1,0,1.57),position=(32,8,0))]),
            ...
            Transform(scale=(.5,.5,.5),
              ...
              Shape(
                ...
                appearance=Appearance(
                  ...
                  texture=ImageTexture(DEF='TEXTURE',url=["BoatTexture.jpg","../../Scenarios/UssColeTerroristAttack/BoatTexture.jpg","https://savage.nps.edu/Savage/Scenarios/UssColeTerroristAttack/BoatTexture.jpg"]))),
              Shape(
                ...
                appearance=Appearance(
                  ...
                  texture=ImageTexture(url=["BoatTextureGreen.jpg","../../Scenarios/UssColeTerroristAttack/BoatTextureGreen.jpg","https://savage.nps.edu/Savage/Scenarios/UssColeTerroristAttack/BoatTextureGreen.jpg"])))]),
            Transform(scale=(.5,.75,.5),translation=(0,-.2,0),
              children=[
              Shape(
    ...
    ProtoInstance(DEF='Boat',name='GarbageBoat'),
    Viewpoint(description='Garbage Boat View',jump=False,orientation=(1,0,0,-0.2),position=(0,10,35)),
...
print ("python x3d.py load successful for GarbageBoatPrototype.py")

      ...
      Transform(scale=(2.2,1.3,2.2),
        ...
        Shape(
          ...
          appearance=Appearance(
            texture=ImageTexture(DEF='WorldImage',url=["earth-topo.png","earth-topo-small.gif","https://www.web3d.org/x3d/content/examples/Basic/earth-topo.png","https://www.web3d.org/x3d/content/examples/Basic/earth-topo-small.gif"])))]),
      Transform(translation=(0,-0.5,0),
        children=[
        Shape(
          geometry=Box(size=(4.4,1.2,4.4)),
          appearance=Appearance(
            material=Material(diffuseColor=(0.9,0.9,0.95))))])]),
    Transform(translation=(0,0,-5),
      children=[
      Transform(translation=(0,2.25,0),
        children=[
        Shape(
          geometry=Cylinder(height=1.2,radius=2.2),
          appearance=Appearance(
            texture=ImageTexture(USE='WorldImage')))]),
...
print ("python x3d.py load successful for LfovDisplayExemplars.py")

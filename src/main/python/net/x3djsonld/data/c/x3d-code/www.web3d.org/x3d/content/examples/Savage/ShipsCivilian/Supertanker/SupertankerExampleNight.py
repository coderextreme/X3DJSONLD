...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='SupertankerExampleNight.x3d',name='title'),
    meta(content='Andrew Wiest',name='creator'),
    meta(content='6 May 2001',name='created'),
    meta(content='30 May 2009',name='modified'),
    meta(content='Supertanker scene during the nighttime.',name='description'),
    meta(content='https://savage.nps.edu/Savage/ShipsCivilian/Supertanker/SupertankerExampleNight.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Background(groundAngle=[1.57],groundColor=[(.1,.1,.1),(0,0,0)],skyAngle=[1.57],skyColor=[(.2,.2,.2),(.1,.1,.1)]),
    ...
    Viewpoint(description='Supertanker Example Night',orientation=(-0.429808,0.899118,0.0827735,0.422004),position=(150,50,250)),
...
print ("python x3d.py load successful for SupertankerExampleNight.py")

...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='default_proximitysensor.x3d',name='title'),
...
print ("python x3d.py load successful for default_proximitysensor.py")

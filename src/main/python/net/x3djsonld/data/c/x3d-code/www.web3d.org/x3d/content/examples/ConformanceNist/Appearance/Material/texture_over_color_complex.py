...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='texture_over_color_complex.x3d',name='title'),
    meta(content='texture_over_color_complex-front.jpg',name='Image'),
    meta(content='texture_over_color_complex-rear.jpg',name='Image'),
    ...
    meta(content='Test texture color over Color node for complex geometry. The purple VTS logo should supersede the blue Color node defined in the geometry color field for an ElevationGrid and an IndexedFaceSet.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/texture_over_color_complex.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='texture_over_color_complex.x3d'),
...
print ("python x3d.py load successful for texture_over_color_complex.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='JetSki.x3d',name='title'),
    meta(content='Jet Ski',name='description'),
    meta(content='Planet 9 Studios, Inc.',name='creator'),
    meta(content='Xeena VRML importer, X3D-Edit 3.1, http://www.web3d.org/x3d/content/README.X3D-Edit.html',name='translator'),
    meta(content='4 May 2005',name='created'),
    meta(content='4 May 2005',name='translated'),
    meta(content='14 November 2015',name='modified'),
    meta(content='https://savage.nps.edu/Savage/ShipsCivilian/PersonalWaterCraft/JetSki.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(info=["Created 2005. Planet 9 Studios, Inc.","http://www.motorsports-network.com/kawasaki/99wc/Kaw99wc.htm"],title='JetSki',
      metadata=MetadataSet(name='SMAL',reference='https://savage.nps.edu/Savage/Tools/SMAL/SMAL.html',
        ...
        MetadataSet(name='EntityDefinition',
          ...
          MetadataSet(name='Classification',
            ...
            MetadataString(name='reference',value=["http://www.motorsports-network.com/kawasaki/99wc/Kaw99wc.htm"],
          ...
          MetadataSet(name='IdentificationParameters',
            value=[
            MetadataString(name='name',value=["Kawasaki 900 STX Jet Ski"],
          ...
          MetadataSet(name='PhysicalParameters',
            ...
            MetadataSet(name='PhysicalConstraints',
              value=[
              MetadataFloat(name='height',value=[.99],
              ...
              MetadataFloat(name='width',value=[1.18],
              ...
              MetadataFloat(name='length',value=[3.1],
              ...
              MetadataFloat(name='draft',value=[.05],
              ...
              MetadataFloat(name='grossWeight',value=[278.05],
          ...
          MetadataSet(name='NetworkedCommunicationParameterSet',
            ...
            MetadataSet(name='DisConfiguration',
              ...
              MetadataInteger(name='entityCategory',value=[3],
              ...
              MetadataInteger(name='entitySubCategory',value=[61],
    ...
    Transform(DEF='JetSki',rotation=(0.0,-1.0,0.0,-1.57079),scale=(0.198054,0.198054,0.198054),scaleOrientation=(0.259991,0.135265,0.95609,-0.811937),translation=(0.217623,0.0,0.140104),
      ...
      Shape(
        appearance=Appearance(
          material=Material(USE='Def7'),
          texture=ImageTexture(url=["textures/BoatJetSki05.jpg","https://savage.nps.edu/Savage/ShipsCivilian/SmallBoats/textures/BoatJetSki05.jpg"])),
        geometry=IndexedFaceSet(coordIndex=[25,67,28,-1,70,26,28,-1,67,69,28,-1,69,70,28,-1,26,68,27,-1,68,26,70,-1,71,25,31,-1,25,71,67,-1,64,35,21,-1,35,64,74,-1],normalIndex=[9,9,13,-1,96,95,13,-1,9,13,13,-1,13,96,13,-1,95,64,64,-1,64,95,96,-1,107,9,107,-1,9,107,9,-1,121,121,121,-1,121,121,121,-1],texCoordIndex=[108,109,110,-1,111,112,110,-1,109,113,110,-1,113,111,110,-1,112,114,115,-1,114,112,111,-1,116,108,117,-1,108,116,109,-1,274,275,276,-1,275,274,277,-1],
          coord=Coordinate(USE='JetSki-COORD'),
          normal=Normal(USE='Def6'),
          texCoord=TextureCoordinate(USE='JetSki-TEXCOORD'))),
      Shape(
        appearance=Appearance(
          material=Material(USE='Def7'),
          texture=ImageTexture(url=["textures/BoatJetSki06.jpg","https://savage.nps.edu/Savage/ShipsCivilian/SmallBoats/textures/BoatJetSki06.jpg"])),
        geometry=IndexedFaceSet(coordIndex=[17,11,36,-1,36,34,17,-1,35,34,36,-1,34,35,74,-1],normalIndex=[2,2,2,-1,2,2,2,-1,86,82,46,-1,82,86,126,-1],texCoordIndex=[118,119,120,-1,120,121,118,-1,122,121,120,-1,121,122,123,-1],
          coord=Coordinate(USE='JetSki-COORD'),
          normal=Normal(USE='Def6'),
          texCoord=TextureCoordinate(USE='JetSki-TEXCOORD'))),
      Shape(
        appearance=Appearance(
          material=Material(USE='Def5'),
          texture=ImageTexture(url=["textures/BoatJetSki07.jpg","https://savage.nps.edu/Savage/ShipsCivilian/SmallBoats/textures/BoatJetSki07.jpg"])),
        geometry=IndexedFaceSet(coordIndex=[45,44,18,-1,45,18,23,-1,46,18,44,-1,6,85,46,-1,85,6,52,-1,84,83,82,-1,84,65,83,-1,46,83,18,-1,46,85,83,-1,85,82,83,-1],normalIndex=[37,157,155,-1,37,155,79,-1,83,155,157,-1,44,45,83,-1,45,44,60,-1,129,92,98,-1,129,120,92,-1,83,92,155,-1,83,45,92,-1,45,98,92,-1],texCoordIndex=[144,145,146,-1,144,146,147,-1,148,146,145,-1,149,150,148,-1,150,149,151,-1,152,153,154,-1,152,155,153,-1,148,153,146,-1,148,150,153,-1,150,154,153,-1],
          coord=Coordinate(USE='JetSki-COORD'),
          normal=Normal(USE='Def6'),
          texCoord=TextureCoordinate(USE='JetSki-TEXCOORD'))),
      Shape(
        appearance=Appearance(
          material=Material(USE='Def5'),
          texture=ImageTexture(url=["textures/BoatJetSki08.jpg","https://savage.nps.edu/Savage/ShipsCivilian/SmallBoats/textures/BoatJetSki08.jpg"])),
        geometry=IndexedFaceSet(coordIndex=[14,45,23,-1,23,24,14,-1,14,24,20,-1,13,14,20,-1,59,65,84,-1,65,59,66,-1,59,62,66,-1,58,62,59,-1],normalIndex=[23,37,79,-1,79,91,23,-1,23,91,130,-1,49,23,130,-1,62,120,129,-1,120,62,54,-1,62,1,54,-1,84,1,62,-1],texCoordIndex=[162,163,164,-1,164,165,162,-1,162,165,166,-1,167,162,166,-1,156,157,158,-1,157,156,159,-1,156,160,159,-1,161,160,156,-1],
          coord=Coordinate(USE='JetSki-COORD'),
          normal=Normal(USE='Def6'),
          texCoord=TextureCoordinate(USE='JetSki-TEXCOORD'))),
      Shape(
        appearance=Appearance(
          material=Material(USE='Def5'),
          texture=ImageTexture(url=["textures/BoatJetSki09.jpg","https://savage.nps.edu/Savage/ShipsCivilian/SmallBoats/textures/BoatJetSki09.jpg"])),
        geometry=IndexedFaceSet(coordIndex=[12,11,0,-1,15,19,12,-1,16,0,11,-1,16,11,17,-1,19,11,12,-1,57,16,17,-1,60,57,61,-1,61,57,17,-1,75,27,68,-1,27,75,37,-1],normalIndex=[24,53,114,-1,70,34,24,-1,149,114,53,-1,149,53,89,-1,34,53,24,-1,65,149,89,-1,104,65,76,-1,76,65,89,-1,4,4,4,-1,4,4,4,-1],texCoordIndex=[168,169,170,-1,171,172,168,-1,173,170,169,-1,173,169,174,-1,172,169,168,-1,175,173,174,-1,176,175,177,-1,177,175,174,-1,178,179,180,-1,179,178,181,-1],
          coord=Coordinate(USE='JetSki-COORD'),
          normal=Normal(USE='Def6'),
          texCoord=TextureCoordinate(USE='JetSki-TEXCOORD')))]),
    Viewpoint(DEF='VP1',description='Jet Ski Starboard View',position=(0,.5,3.5)),
    Viewpoint(DEF='VP2',description='Jet Ski Front View',orientation=(0,1,0,1.571),position=(3.5,.5,0)),
    Viewpoint(DEF='VP3',description='Jet Ski Port View',orientation=(0,1,0,3.142),position=(0,.5,-3.5)),
    Viewpoint(DEF='VP4',description='Jet Ski Back View',orientation=(0,1,0,-1.571),position=(-3.5,.5,0)),
    Viewpoint(DEF='VP5',description='Jet Ski Top View',orientation=(1,0,0,-1.571),position=(0,3.5,0)),
    Viewpoint(DEF='VP6',description='Jet Ski Bottom View',orientation=(1,0,0,1.571),position=(0,-3.5,0)),
    Viewpoint(DEF='VP7',description='Jet Ski Three-Quarter',fieldOfView=0.60243,orientation=(0.124491,-0.945607,-0.300549,-2.39496),position=(3.5,3.5,-3.5))])
) # X3D model complete
...
print ("python x3d.py load successful for JetSki.py")

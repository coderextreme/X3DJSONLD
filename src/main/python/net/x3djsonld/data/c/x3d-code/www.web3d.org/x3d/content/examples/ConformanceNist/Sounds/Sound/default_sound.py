...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='default_sound.x3d',name='title'),
    ...
    meta(content='Test default properties. A Sound node with default field and field values should generate two sound ellipsoids that have the shape of concentric spheres, whose focus is at the origin of the local coordinate system (0 0 0). The inner or "min" ellipsoid has a radius of 1 meter. The outer or "max" ellipsoid has a radius of generates a "chime" sound that should not be audible outside of the outer "max" ellipsoid. Between the outer and inner ellipsoids, the chime sound should linearly degrade to a minimum of "max sound" -20dB, as the viewer moves from the outer to inner ellipsoid. Inside the inner ellipsoid, sound should have a volume of "max sound" decibels, anywhere inside the inner ellipsoid. There should be no "scaling" of sound intensity, maximum sound intensity is the default.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='default_sound.x3d'),
    Viewpoint(DEF='OUTSIDEMAXFRONT',description='FRONT: Outside maxFront (no sound)',position=(0,0,60)),
    Viewpoint(DEF='JUSTOUTSIDEMAXFRONT',description='Just outside maxFront (no sound)',position=(0,0,10.1)),
    Viewpoint(DEF='BETWEENFRONT',description='Midway between maxFront and minFront, (max sound -10dB)',position=(0,0,5.5)),
    Viewpoint(DEF='MINFRONT',description='At minFront, (max sound volume)',position=(0,0,1)),
    Viewpoint(DEF='MINCENTERFRONT',description='Center of min ellipsoid, (max sound volume)',position=(0,0,0)),
    Viewpoint(DEF='OUTSIDEMAXRIGHT',description='RIGHT: Outside max ellipsoid, (no sound)',orientation=(0,1,0,1.57),position=(60,0,0)),
    Viewpoint(DEF='JUSTOUTSIDEMAXRIGHT',description='Just outside max ellipsoid, (no sound)',orientation=(0,1,0,1.57),position=(10.1,0,0)),
    Viewpoint(DEF='BETWEENRIGHT',description='Midway between ellipsoids (max sound -10dB)',orientation=(0,1,0,1.57),position=(5.5,0,0)),
    Viewpoint(DEF='MINRIGHT',description='At min ellipsoid (max sound)',orientation=(0,1,0,1.57),position=(1,0,0)),
    Viewpoint(DEF='MINCENTERRIGHT',description='At ellipsoid focus, (max sound volume)',orientation=(0,1,0,1.57),position=(0,0,0)),
    Viewpoint(DEF='OUTSIDEMAXREAR',description='REAR: Outside maxBack (no sound)',orientation=(0,1,0,3.14),position=(0,0,-60)),
    ...
    Viewpoint(DEF='OUTSIDEMAXLEFT',description='LEFT: Outside max ellipsoid, (no sound)',orientation=(0,1,0,-1.57),position=(-60,0,0)),
    Viewpoint(DEF='JUSTOUTSIDEMAXLEFT',description='Just outside max ellipsoid, (no sound)',orientation=(0,1,0,-1.57),position=(-10.1,0,0)),
    Viewpoint(DEF='BETWEENLEFT',description='Midway between ellipsoids (max sound -10dB)',orientation=(0,1,0,-1.57),position=(-5.5,0,0)),
    Viewpoint(DEF='MINLEFT',description='At min ellipsoid (max sound)',orientation=(0,1,0,-1.57),position=(-1,0,0)),
    ...
    Viewpoint(DEF='JUSTOUTSIDEMAXTOP',description='Just outside max ellipsoid, (no sound)',orientation=(1,0,0,-1.57),position=(0,10,0)),
    Viewpoint(DEF='BETWEENTOP',description='Midway between ellipsoids (max sound -10dB)',orientation=(1,0,0,-1.57),position=(0,5.5,0)),
    Viewpoint(DEF='MINTOP',description='At min ellipsoid (max sound)',orientation=(1,0,0,-1.57),position=(0,1,0)),
    Viewpoint(DEF='MINCENTERTOP',description='At ellipsoid focus, (max sound volume)',orientation=(1,0,0,-1.57),position=(0,0,0)),
    Viewpoint(DEF='OUTSIDEMAXBOTTOM',description='BOTTOM: Outside max ellipsoid, (no sound)',orientation=(1,0,0,1.57),position=(0,-60,0)),
    Viewpoint(DEF='JUSTOUTSIDEMAXBOTTOM',description='Just outside max ellipsoid, (no sound)',orientation=(1,0,0,1.57),position=(0,-10.1,0)),
    Viewpoint(DEF='BETWEENBOTTOM',description='Midway between ellipsoids (max sound -10dB)',orientation=(1,0,0,1.57),position=(0,-5.5,0)),
    Viewpoint(DEF='MINBOTTOM',description='At min ellipsoid (max sound)',orientation=(1,0,0,1.57),position=(0,-1,0)),
    ...
    Script(DEF='AVATARSCRIPT',directOutput=True,url=["default_sound.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/default_sound.js"],
      field=[
      field(accessType='initializeOnly',name='outsideFront',type='SFVec3f',value=(0.0,0.0,60.0)),
      ...
      field(accessType='initializeOnly',name='outsideMaxFront',type='SFNode',
        children=[
        Viewpoint(USE='OUTSIDEMAXFRONT')]),
      ...
      field(accessType='initializeOnly',name='minLeftString',type='MFString',value=["At min ellipsoid left (max sound)"]),
      ...
      field(accessType='initializeOnly',name='minCenterBottomString',type='MFString',value=["At min ellipsoid bottom (max sound)"])]),
...
print ("python x3d.py load successful for default_sound.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  ...
  Scene=Scene(
    children=[
    WorldInfo(title='DESRON31Starboard',info=["This Web3D World was created with Vizx3D, a Web3D authoring tool","www.vizx3d.com"]),
        ...
        Transform(DEF='dad_DESRON32',rotation=(-1,0,0,1.571),translation=(-2.78641,-.50063,0),
          ...
          Shape(DEF='DESRON32',
            appearance=Appearance(
              texture=ImageTexture(repeatS=False,repeatT=False,url=["newsealtest.jpg"]),
              textureTransform=TextureTransform(scale=(.912,.981),translation=(-.086,.009),center=(-1.092,-.057)),

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='ScriptNodeFieldControl_Java.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ScriptConformance/ScriptNodeFieldControl_Java.x3d',name='identifier'),
    ...
    meta(content='ScriptNodeFieldControl_JavaConsoleOutput.txt',name='reference'),
    meta(content='ScriptNodeFieldControl_JavaSnapshots.html',name='reference'),
    meta(content='ScriptNodeFieldControl_EcmaScript.x3d',name='reference'),
  ...
  Scene=Scene(
    ...
    Group(
      ...
      Transform(DEF='TextPosition',
        ...
        children=[
        Shape(
          geometry=Text(DEF='MessageToUser',string=["Default text in VRML scene will be replaced by","Java initialize() in Script using field control.","This text appears first, if Java initialization fails.",""],
...
print ("python x3d.py load successful for ScriptNodeFieldControl_Java.py")

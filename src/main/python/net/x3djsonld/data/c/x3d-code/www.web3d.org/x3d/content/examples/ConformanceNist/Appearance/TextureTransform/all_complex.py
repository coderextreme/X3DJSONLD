...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='all_complex.x3d',name='title'),
    meta(content='all_complex-front.jpg',name='Image'),
    meta(content='all_complex-rear.jpg',name='Image'),
    meta(content='all_complex-top.jpg',name='Image'),
    meta(content='all_complex-bottom.jpg',name='Image'),
    meta(content='all_complex-left.jpg',name='Image'),
    meta(content='all_complex-right.jpg',name='Image'),
    ...
    meta(content='Test TextureTransform of scale, rotation, center and translation to an ImageTexture. Test browser ability to apply a +90 degree rotation, with a center of 1 3, a scale of .33 1, and a translation of 0 4.9 to an MovieTexture mapped to the faces of primative geometry. The result is (using the primitive mapping rules: All geometry faces should map a single, centered V that is 3 times wider than its height, oriented down for its horizontal axis, and right for its vertical axis.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/all_complex.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='all_complex.x3d'),
    Group(
      children=[
    ...
    Transform(translation=(-5,0,0),
      ...
      Shape(
        appearance=Appearance(
          texture=ImageTexture(DEF='MYTEXT',url=["../../vts.jpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/vts.jpg"]),
    ...
    Transform(
      ...
      Shape(
        appearance=Appearance(
          texture=ImageTexture(USE='MYTEXT'),
          textureTransform=TextureTransform(center=(1,3),rotation=1.57,scale=(0.33,1),translation=(0,4.9)),
          material=Material(),),
...
print ("python x3d.py load successful for all_complex.py")

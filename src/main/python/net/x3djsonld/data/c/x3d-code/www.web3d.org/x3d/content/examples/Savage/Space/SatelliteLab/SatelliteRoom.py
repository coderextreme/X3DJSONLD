...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='SatelliteRoom.x3d',name='title'),
  ...
  Scene=Scene(
    ...
    ExternProtoDeclare(name='HeadsUpDisplay',url=["../../Tools/HeadsUpDisplays/HeadsUpDisplayPrototype.x3d#HeadsUpDisplay","https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/HeadsUpDisplayPrototype.x3d#HeadsUpDisplay","../../Tools/HeadsUpDisplays/HeadsUpDisplayPrototype.wrl#HeadsUpDisplay","https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/HeadsUpDisplayPrototype.wrl#HeadsUpDisplay"],
      field=[
    ...
    ExternProtoDeclare(name='HTVSCMG',url=["HTVSCMGPrototype.x3d#HTVSCMG","https://savage.nps.edu/Savage/Space/SatelliteLab/HTVSCMGPrototype.x3d#HTVSCMG","HTVSCMGPrototype.wrl#HTVSCMG","https://savage.nps.edu/Savage/Space/SatelliteLab/HTVSCMGPrototype.wrl#HTVSCMG"]),
    ExternProtoDeclare(name='ManualXYZBalanceBlock',url=["ManualXYZBalanceBlockPrototype.x3d#ManualXYZBalanceBlock","https://savage.nps.edu/Savage/Space/SatelliteLab/ManualXYZBalanceBlockPrototype.x3d#ManualXYZBalanceBlock","ManualXYZBalanceBlockPrototype.wrl#ManualXYZBalanceBlock","https://savage.nps.edu/Savage/Space/SatelliteLab/ManualXYZBalanceBlockPrototype.wrl#ManualXYZBalanceBlock"]),
    ExternProtoDeclare(name='ManualXZBalanceBlock',url=["ManualXZBalanceBlockPrototype.x3d#ManualXZBalanceBlock","https://savage.nps.edu/Savage/Space/SatelliteLab/ManualXZBalanceBlockPrototype.x3d#ManualXZBalanceBlock","ManualXZBalanceBlockPrototype.wrl#ManualXZBalanceBlock","https://savage.nps.edu/Savage/Space/SatelliteLab/ManualXZBalanceBlockPrototype.wrl#ManualXZBalanceBlock"]),
    Collision(DEF='Room',
      children=[
      Group(DEF='RoomGroup',
        children=[
        Group(DEF='Wall1',
          children=[
          Shape(DEF='WallDesign',
            appearance=Appearance(
              texture=ImageTexture(url=["Wall3.jpg","https://savage.nps.edu/Savage/Space/SatelliteLab/Wall3.jpg"]),
              textureTransform=TextureTransform(),),
            geometry=IndexedFaceSet(DEF='GenericFace',coordIndex=[0,1,2,3,4],solid=False,texCoordIndex=[0,1,2,3,4],
              coord=Coordinate(point=[(0,0,0),(0,4,0),(2,4,0),(2,0,0),(0,0,0)]))),
          Transform(translation=(2,0,0),
            children=[
            Shape(USE='WallDesign')]),
        ...
        Group(DEF='Wall2',
          children=[
          Transform(rotation=(0,1,0,-1.5707963),translation=(8,0,0),
            children=[
            Group(USE='Wall1')])]),
        Group(DEF='Wall3',
          children=[
        ...
        Group(DEF='RoomFloor',
          children=[
          Group(DEF='FloorSection',
            children=[
            Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),
              children=[
              Shape(DEF='Floor',
                appearance=Appearance(
                  texture=ImageTexture(url=["Floor.jpg","https://savage.nps.edu/Savage/Space/SatelliteLab/Floor.jpg"])),
                geometry=IndexedFaceSet(USE='GenericFace'))]),
            Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),translation=(1,0,0),
              children=[
              Shape(USE='Floor')]),
            Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),translation=(2,0,0),
              children=[
              Shape(USE='Floor')]),
            Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),translation=(3,0,0),
              children=[
              Shape(USE='Floor')]),
            Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),translation=(4,0,0),
              children=[
              Shape(USE='Floor')]),
            Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),translation=(5,0,0),
              children=[
              Shape(USE='Floor')]),
            Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),translation=(6,0,0),
              children=[
              Shape(USE='Floor')]),
            Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),translation=(7,0,0),
              children=[
              Shape(USE='Floor')])]),
          Transform(translation=(0,0,2),
            children=[
            Group(USE='FloorSection')]),
          ...
          Transform(translation=(0,0,6),
            children=[
            Group(USE='FloorSection')])]),
        Group(DEF='RoomCeiling',
          children=[
          Transform(translation=(0,4,0),
            children=[
            Group(DEF='CeilingSection',
              children=[
              Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),
                children=[
                Shape(DEF='Ceiling',
                  appearance=Appearance(
                    texture=ImageTexture(url=["CeilingTile.jpg","https://savage.nps.edu/Savage/Space/SatelliteLab/CeilingTile.jpg"])),
                  geometry=IndexedFaceSet(USE='GenericFace'))]),
              Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),translation=(1,0,0),
                children=[
                Shape(USE='Ceiling')]),
              ...
              Transform(rotation=(1,0,0,1.5707963),scale=(.5,.5,.5),translation=(7,0,0),
                children=[
                Shape(USE='Ceiling')])]),
            Transform(rotation=(0,1,0,3.1416),translation=(8,0,4),
              children=[
              Group(USE='CeilingSection'),
              Transform(rotation=(1,0,0,1.5709),scale=(.5,.5,.5),translation=(2,-.01,0),
                children=[
                Shape(
                  appearance=Appearance(DEF='Light',
                    texture=ImageTexture(url=["Light.jpg","https://savage.nps.edu/Savage/Space/SatelliteLab/Light.jpg"])),
                  geometry=IndexedFaceSet(USE='GenericFace'))])]),
            Transform(translation=(0,0,4),
              children=[
              Group(USE='CeilingSection'),
              Transform(rotation=(1,0,0,1.5709),scale=(.5,.5,.5),translation=(2,-.01,0),
                children=[
                Shape(
                  appearance=Appearance(USE='Light'),
                  geometry=IndexedFaceSet(USE='GenericFace'))])]),
            Transform(rotation=(0,1,0,3.1416),translation=(8,0,8),
              children=[
              Group(USE='CeilingSection')])])]),
        Group(DEF='Wall1Extension',
          children=[
          Transform(translation=(-8,0,0),
            children=[
            Group(USE='Wall1')])]),
        Group(DEF='RoomFloorExtension',
          children=[
          Transform(translation=(-8,0,0),
            children=[
            Group(USE='RoomFloor')])]),
        Group(DEF='RoomCeilingExtension',
          children=[
          Transform(translation=(-8,0,0),
            children=[
            Group(USE='RoomCeiling')])])])]),
    Group(DEF='TargetGroup',
      children=[
      Collision(
        children=[
        Transform(rotation=(0,1,0,-1.5707),scale=(.58,.58,.58),translation=(7,.14,4.3),
          children=[
          ...
          Group(DEF='TrackSupport',
            ...
            Transform(scale=(.45,.45,.45),translation=(-3.25,0,0),
              children=[
              Inline(DEF='TargetTrackSupport',url=["LaserTargetTrackSupport.x3d","https://savage.nps.edu/Savage/Space/SatelliteLab/LaserTargetTrackSupport.x3d","LaserTargetTrackSupport.wrl","https://savage.nps.edu/Savage/Space/SatelliteLab/LaserTargetTrackSupport.wrl"])]),
    ...
    Group(DEF='PlatformGroup',
      children=[
      Transform(rotation=(0,1,0,1.571),scale=(.2,.2,.2),translation=(-6,0,1.6),
        children=[
        Inline(DEF='BaseStand',url=["BaseStand.x3d","https://savage.nps.edu/Savage/Space/SatelliteLab/BaseStand.x3d","BaseStand.wrl","https://savage.nps.edu/Savage/Space/SatelliteLab/BaseStand.wrl"]),
        Transform(translation=(0,5.45,0),
          children=[
          Transform(DEF='MovableDeck',center=(0,1.11,0),
            children=[
            Group(
              children=[
              Shape(DEF='Bearing',
            ...
            Group(
              ...
              Group(DEF='HTVSCMGs',
                children=[
                Transform(rotation=(0,1,0,1.571),translation=(5,0.3,0),
                  children=[
                  ProtoInstance(name='HTVSCMG')]),
                Transform(rotation=(0,1,0,-1.571),translation=(-5,0.3,0),
                  children=[
                  ProtoInstance(name='HTVSCMG')]),
                Transform(translation=(0,0.3,5),
                  children=[
                  ProtoInstance(name='HTVSCMG')]),
                Transform(rotation=(0,1,0,3.142),translation=(0,0.3,-5),
                  children=[
                  ProtoInstance(name='HTVSCMG')])]),
              Group(DEF='ManualXYZBalanceBlocks',
                children=[
                Transform(rotation=(0,1,0,0.785),translation=(3.54,2.04,3.54),
                  children=[
                  ProtoInstance(name='ManualXYZBalanceBlock')]),
                Transform(rotation=(0,1,0,-0.785),translation=(-3.54,2.04,3.54),
                  children=[
                  ProtoInstance(name='ManualXYZBalanceBlock')]),
                Transform(rotation=(0,1,0,-2.356),translation=(-3.54,2.04,-3.54),
                  children=[
                  ProtoInstance(name='ManualXYZBalanceBlock')]),
                Transform(rotation=(0,1,0,2.356),translation=(3.54,2.04,-3.54),
                  children=[
                  ProtoInstance(name='ManualXYZBalanceBlock')])]),
              Group(DEF='ManualXZBalanceBlocks',
                children=[
                Transform(rotation=(0,1,0,1.571),translation=(5,2.04,0),
                  children=[
                  ProtoInstance(name='ManualXZBalanceBlock')]),
                Transform(rotation=(0,1,0,-1.571),translation=(-5,2.04,0),
                  children=[
                  ProtoInstance(name='ManualXZBalanceBlock')])]),
              Group(DEF='OpticalDeckVibrationIsolators',
                children=[
                Transform(translation=(0,2.495,3.47),
                  children=[
                  Inline(DEF='VibrationIsolator',url=["VibrationIsolator.x3d","https://savage.nps.edu/Savage/Space/SatelliteLab/VibrationIsolator.x3d","VibrationIsolator.wrl","https://savage.nps.edu/Savage/Space/SatelliteLab/VibrationIsolator.wrl"])]),
                Transform(translation=(0,2.495,-3.47),
                  children=[
                  Inline(USE='VibrationIsolator')]),
                Transform(translation=(3.47,2.495,0),
                  children=[
                  Inline(USE='VibrationIsolator')]),
                Transform(translation=(-3.47,2.495,0),
                  children=[
                  Inline(USE='VibrationIsolator')])]),
              Transform(translation=(0,2.76,0),
                children=[
                Inline(DEF='CenterPost',url=["CenterPost.x3d","https://savage.nps.edu/Savage/Space/SatelliteLab/CenterPost.x3d","CenterPost.wrl","https://savage.nps.edu/Savage/Space/SatelliteLab/CenterPost.wrl"])]),
              Transform(translation=(0,2.75,3.0),
                children=[
                Shape(DEF='LaserCylinder',
                  appearance=Appearance(
                    material=Material(diffuseColor=(0.2,0.2,0.2))),
                  geometry=IndexedFaceSet(coordIndex=[0,1,33,-1,0,33,32,-1,0,31,30,-1,0,30,29,-1,0,29,28,-1,0,28,27,-1,0,27,26,-1,0,26,25,-1,0,25,24,-1,0,24,23,-1,0,23,22,-1,0,22,21,-1,0,21,20,-1,0,20,19,-1,0,19,18,-1,0,18,17,-1,0,17,16,-1,0,16,15,-1,0,15,14,-1,0,14,13,-1,0,13,12,-1,0,12,11,-1,0,11,10,-1,0,10,9,-1,0,9,8,-1,0,8,7,-1,0,7,6,-1,0,6,5,-1,0,5,4,-1,0,4,3,-1,0,3,2,-1,0,2,1,-1,0,32,63,-1,0,63,31,-1,1,2,34,-1,1,34,33,-1,2,3,35,-1,2,35,34,-1,3,4,36,-1,3,36,35,-1,4,5,37,-1,4,37,36,-1,5,6,38,-1,5,38,37,-1,6,7,39,-1,6,39,38,-1,7,8,40,-1,7,40,39,-1,8,9,41,-1,8,41,40,-1,9,10,42,-1,9,42,41,-1,10,11,43,-1,10,43,42,-1,11,12,44,-1,11,44,43,-1,12,13,45,-1,12,45,44,-1,13,14,46,-1,13,46,45,-1,14,15,47,-1,14,47,46,-1,15,16,48,-1,15,48,47,-1,16,17,49,-1,16,49,48,-1,17,18,50,-1,17,50,49,-1,18,19,51,-1,18,51,50,-1,19,20,52,-1,19,52,51,-1,20,21,53,-1,20,53,52,-1,21,22,54,-1,21,54,53,-1,22,23,55,-1,22,55,54,-1,23,24,56,-1,23,56,55,-1,24,25,57,-1,24,57,56,-1,25,26,58,-1,25,58,57,-1,26,27,59,-1,26,59,58,-1,27,28,60,-1,27,60,59,-1,28,29,61,-1,28,61,60,-1,29,30,62,-1,29,62,61,-1,30,31,63,-1,30,63,62,-1,32,33,34,-1,32,34,35,-1,32,35,36,-1,32,36,37,-1,32,37,38,-1,32,38,39,-1,32,39,40,-1,32,40,41,-1,32,41,42,-1,32,42,43,-1,32,43,44,-1,32,44,45,-1,32,45,46,-1,32,46,47,-1,32,47,48,-1,32,48,49,-1,32,49,50,-1,32,50,51,-1,32,51,52,-1,32,52,53,-1,32,53,54,-1,32,54,55,-1,32,55,56,-1,32,56,57,-1,32,57,58,-1,32,58,59,-1,32,59,60,-1,32,60,61,-1,32,61,62,-1,32,62,63,-1],creaseAngle=0.524,
                    coord=Coordinate(point=[(.46,.46,1.05),(.45116,.37026,1.05),(.42499,.28397,1.05),(.38248,.20444,1.05),(.32527,.13473,1.05),(.25556,.07752,1.05),(.17603,.03502,1.05),(.08974,.00884,1.05),(-0,0,1.05),(-.08974,.00884,1.05),(-.17603,.03502,1.05),(-.25556,.07752,1.05),(-.32527,.13473,1.05),(-.38248,.20444,1.05),(-.42499,.28397,1.05),(-.45116,.37026,1.05),(-.46,.46,1.05),(-.45116,.54974,1.05),(-.42499,.63603,1.05),(-.38248,.71556,1.05),(-.32527,.78527,1.05),(-.25556,.84248,1.05),(-.17603,.88499,1.05),(-.08974,.91116,1.05),(-0,.92,1.05),(.08974,.91116,1.05),(.17603,.88499,1.05),(.25556,.84248,1.05),(.32527,.78527,1.05),(.38248,.71556,1.05),(.42499,.63603,1.05),(.45116,.54974,1.05),(.46,.46,-1.05),(.45116,.37026,-1.05),(.42499,.28397,-1.05),(.38248,.20444,-1.05),(.32527,.13473,-1.05),(.25556,.07752,-1.05),(.17603,.03502,-1.05),(.08974,.00884,-1.05),(-0,0,-1.05),(-.08974,.00884,-1.05),(-.17603,.03502,-1.05),(-.25556,.07752,-1.05),(-.32527,.13473,-1.05),(-.38248,.20444,-1.05),(-.42499,.28397,-1.05),(-.45116,.37026,-1.05),(-.46,.46,-1.05),(-.45116,.54974,-1.05),(-.42499,.63603,-1.05),(-.38248,.71556,-1.05),(-.32527,.78527,-1.05),(-.25556,.84248,-1.05),(-.17603,.88499,-1.05),(-.08974,.91116,-1.05),(-0,.92,-1.05),(.08974,.91116,-1.05),(.17603,.88499,-1.05),(.25556,.84248,-1.05),(.32527,.78527,-1.05),(.38248,.71556,-1.05),(.42499,.63603,-1.05),(.45116,.54974,-1.05)])))])])])]),
        Transform(DEF='MovableUpperDeck',rotation=(0,1,0,-0.205),
          children=[
          Transform(translation=(0,9.76,0),
            children=[
            Shape(DEF='UpperDeck',
              appearance=Appearance(
                material=Material(DEF='DefaultColor',diffuseColor=(0.2,0.2,0.2))),
            ...
            Transform(translation=(0,0.1,1.36),
              children=[
              Shape(DEF='ReturnLaserCylinder',
                appearance=Appearance(
                  material=Material(USE='DefaultColor')),
                geometry=IndexedFaceSet(coordIndex=[0,1,33,-1,0,33,32,-1,0,31,30,-1,0,30,29,-1,0,29,28,-1,0,28,27,-1,0,27,26,-1,0,26,25,-1,0,25,24,-1,0,24,23,-1,0,23,22,-1,0,22,21,-1,0,21,20,-1,0,20,19,-1,0,19,18,-1,0,18,17,-1,0,17,16,-1,0,16,15,-1,0,15,14,-1,0,14,13,-1,0,13,12,-1,0,12,11,-1,0,11,10,-1,0,10,9,-1,0,9,8,-1,0,8,7,-1,0,7,6,-1,0,6,5,-1,0,5,4,-1,0,4,3,-1,0,3,2,-1,0,2,1,-1,0,32,63,-1,0,63,31,-1,1,2,34,-1,1,34,33,-1,2,3,35,-1,2,35,34,-1,3,4,36,-1,3,36,35,-1,4,5,37,-1,4,37,36,-1,5,6,38,-1,5,38,37,-1,6,7,39,-1,6,39,38,-1,7,8,40,-1,7,40,39,-1,8,9,41,-1,8,41,40,-1,9,10,42,-1,9,42,41,-1,10,11,43,-1,10,43,42,-1,11,12,44,-1,11,44,43,-1,12,13,45,-1,12,45,44,-1,13,14,46,-1,13,46,45,-1,14,15,47,-1,14,47,46,-1,15,16,48,-1,15,48,47,-1,16,17,49,-1,16,49,48,-1,17,18,50,-1,17,50,49,-1,18,19,51,-1,18,51,50,-1,19,20,52,-1,19,52,51,-1,20,21,53,-1,20,53,52,-1,21,22,54,-1,21,54,53,-1,22,23,55,-1,22,55,54,-1,23,24,56,-1,23,56,55,-1,24,25,57,-1,24,57,56,-1,25,26,58,-1,25,58,57,-1,26,27,59,-1,26,59,58,-1,27,28,60,-1,27,60,59,-1,28,29,61,-1,28,61,60,-1,29,30,62,-1,29,62,61,-1,30,31,63,-1,30,63,62,-1,32,33,34,-1,32,34,35,-1,32,35,36,-1,32,36,37,-1,32,37,38,-1,32,38,39,-1,32,39,40,-1,32,40,41,-1,32,41,42,-1,32,42,43,-1,32,43,44,-1,32,44,45,-1,32,45,46,-1,32,46,47,-1,32,47,48,-1,32,48,49,-1,32,49,50,-1,32,50,51,-1,32,51,52,-1,32,52,53,-1,32,53,54,-1,32,54,55,-1,32,55,56,-1,32,56,57,-1,32,57,58,-1,32,58,59,-1,32,59,60,-1,32,60,61,-1,32,61,62,-1,32,62,63,-1],creaseAngle=0.524,
                  coord=Coordinate(point=[(.46,.46,1.05),(.45116,.37026,1.05),(.42499,.28397,1.05),(.38248,.20444,1.05),(.32527,.13473,1.05),(.25556,.07752,1.05),(.17603,.03502,1.05),(.08974,.00884,1.05),(-0,0,1.05),(-.08974,.00884,1.05),(-.17603,.03502,1.05),(-.25556,.07752,1.05),(-.32527,.13473,1.05),(-.38248,.20444,1.05),(-.42499,.28397,1.05),(-.45116,.37026,1.05),(-.46,.46,1.05),(-.45116,.54974,1.05),(-.42499,.63603,1.05),(-.38248,.71556,1.05),(-.32527,.78527,1.05),(-.25556,.84248,1.05),(-.17603,.88499,1.05),(-.08974,.91116,1.05),(-0,.92,1.05),(.08974,.91116,1.05),(.17603,.88499,1.05),(.25556,.84248,1.05),(.32527,.78527,1.05),(.38248,.71556,1.05),(.42499,.63603,1.05),(.45116,.54974,1.05),(.46,.46,-1.05),(.45116,.37026,-1.05),(.42499,.28397,-1.05),(.38248,.20444,-1.05),(.32527,.13473,-1.05),(.25556,.07752,-1.05),(.17603,.03502,-1.05),(.08974,.00884,-1.05),(-0,0,-1.05),(-.08974,.00884,-1.05),(-.17603,.03502,-1.05),(-.25556,.07752,-1.05),(-.32527,.13473,-1.05),(-.38248,.20444,-1.05),(-.42499,.28397,-1.05),(-.45116,.37026,-1.05),(-.46,.46,-1.05),(-.45116,.54974,-1.05),(-.42499,.63603,-1.05),(-.38248,.71556,-1.05),(-.32527,.78527,-1.05),(-.25556,.84248,-1.05),(-.17603,.88499,-1.05),(-.08974,.91116,-1.05),(-0,.92,-1.05),(.08974,.91116,-1.05),(.17603,.88499,-1.05),(.25556,.84248,-1.05),(.32527,.78527,-1.05),(.38248,.71556,-1.05),(.42499,.63603,-1.05),(.45116,.54974,-1.05)]))),
              Transform(rotation=(1,0,0,1.571),translation=(-1,1.46,-0.5),
                children=[
                Transform(DEF='Laser2Main',
                  children=[
                  Shape(
                    appearance=Appearance(
                      material=Material(DEF='LaserColor',ambientIntensity=0.8,diffuseColor=(.8,0,0),transparency=0.3)),
                    geometry=Cylinder(DEF='ReturnBeam',height=0.5,radius=.15))])])])])])])]),
    Group(DEF='LaserGroup',
      children=[
      Transform(rotation=(0,1,0,-1.5707),translation=(8.4,2.3,.4),
        children=[
        Transform(rotation=(1,0,0,1.5707),
          children=[
          Group(DEF='LaserBeam',
            children=[
            Transform(DEF='BeamMain',scale=(.2,.5,.2),translation=(.99,1,.37),
              children=[
              Group(DEF='SourceLaser',
                children=[
                Transform(DEF='Laser1Main',translation=(1,1,1),
                  children=[
                  Shape(DEF='SourceLaserBeam',
                    appearance=Appearance(
                      material=Material(DEF='LightColor',ambientIntensity=0.8,diffuseColor=(.8,0,0),transparency=0.3)),
                    geometry=Cylinder(DEF='Beam',height=.5,radius=.15))]),
                TimeSensor(DEF='LaserTimeInterval',cycleInterval=2,loop=True),
                PositionInterpolator(DEF='BeamSize',key=[0.0,0.125,0.2,0.275,0.35,0.425,0.5,1.0],keyValue=[(1,1.0,1),(1,14.0,1),(1,14.0,1),(1,14.0,1),(1,13.0,1),(1,8.0,1),(1,1,1),(1,1,1)]),
                PositionInterpolator(DEF='BeamPath',key=[0.0,0.125,0.2,0.275,0.35,0.425,0.50,1.0],keyValue=[(1,1,1),(1,4.5,1),(1,9.75,1),(1,14.0,1),(1,19.0,1),(1,23.5,1),(1,25.5,1),(1,25.5,1)]),
                ROUTE(fromField='fraction_changed',fromNode='LaserTimeInterval',toField='set_fraction',toNode='BeamSize'),
                ROUTE(fromField='value_changed',fromNode='BeamSize',toField='set_scale',toNode='Laser1Main'),
                ROUTE(fromField='fraction_changed',fromNode='LaserTimeInterval',toField='set_fraction',toNode='BeamPath'),
                ROUTE(fromField='value_changed',fromNode='BeamPath',toField='set_translation',toNode='Laser1Main')]),
              Transform(rotation=(0,0,1,3.1416),translation=(1,1.2,1),
                children=[
                Shape(
                  geometry=Cylinder(bottom=False,height=1.2,radius=.3),
                  appearance=Appearance(
                    material=Material(diffuseColor=(0.5,0.55,0.55)))),
                Shape(
                  geometry=Cylinder(height=1.15,radius=.285),
                  appearance=Appearance(
                    material=Material(diffuseColor=(0,0,0))))])]),
            Transform(DEF='SourceLaserStand',
              children=[
              Shape(),])])])]),
      Group(DEF='ReturnLaserRoutes',
        children=[
        TimeSensor(DEF='Laser2TimeInterval',cycleInterval=2,loop=True),
        PositionInterpolator(DEF='Beam2Size',key=[0.0,0.6,0.675,0.75,0.825,0.9,0.975,1.0],keyValue=[(1,1.0,1),(1,1.0,1),(1,30.0,1),(1,30.0,1),(1,28.0,1),(1,26.0,1),(1,11,1),(1,1,1)]),
        PositionInterpolator(DEF='Beam2Path',key=[0.0,0.6,0.675,0.75,0.825,0.9,0.975,1.0],keyValue=[(1,1,1),(1,1,1),(1,17,1),(1,30.5,1),(1,43,1),(1,56,1),(1,68,1),(1,70.5,1)]),
        ROUTE(fromField='fraction_changed',fromNode='Laser2TimeInterval',toField='set_fraction',toNode='Beam2Size'),
        ROUTE(fromField='value_changed',fromNode='Beam2Size',toField='set_scale',toNode='Laser2Main'),
        ROUTE(fromField='fraction_changed',fromNode='Laser2TimeInterval',toField='set_fraction',toNode='Beam2Path'),
        ROUTE(fromField='value_changed',fromNode='Beam2Path',toField='set_translation',toNode='Laser2Main')]),
      Transform(DEF='SourceLaserSupport',rotation=(0,1,0,-1.5707),scale=(.21,.21,.21),translation=(7,0.05,1.59),
        children=[
        Inline(url=["SourceLaserSupport.x3d","https://savage.nps.edu/Savage/Space/SatelliteLab/SourceLaserSupport.x3d","SourceLaserSupport.wrl","https://savage.nps.edu/Savage/Space/SatelliteLab/SourceLaserSupport.wrl"])])]),
    Group(DEF='ControlGroup',
      children=[
      ProtoInstance(name='HeadsUpDisplay',
        ...
        fieldValue(name='children',
          ...
          Transform(rotation=(1,0,0,1.5707),
            ...
            TouchSensor(DEF='LaserStartSwitch',description='This button will start the laser.'),
            ROUTE(fromField='touchTime',fromNode='LaserStartSwitch',toField='startTime',toNode='LaserTimeInterval'),
            ROUTE(fromField='touchTime',fromNode='LaserStartSwitch',toField='startTime',toNode='Laser2TimeInterval')]),
          Transform(rotation=(1,0,0,1.5707),translation=(0,-.3,0),
            children=[
            Shape(
              geometry=Cylinder(height=.05,radius=.1),
              appearance=Appearance(
                material=Material(diffuseColor=(1,0,0)))),
            TouchSensor(DEF='LaserStopSwitch',description='This button will stop the laser.'),
            ROUTE(fromField='touchTime',fromNode='LaserStopSwitch',toField='stopTime',toNode='LaserTimeInterval'),
            ROUTE(fromField='touchTime',fromNode='LaserStopSwitch',toField='stopTime',toNode='Laser2TimeInterval')]),
          Transform(translation=(0,.5,0),
            children=[
            Shape(
              appearance=Appearance(
                material=Material(diffuseColor=(.2,.2,.2),emissiveColor=(1,1,1))),
              geometry=Text(string=["Laser Control"],
                fontStyle=FontStyle(justify=["MIDDLE","MIDDLE"],size=0.1)))])]),
        fieldValue(name='dragChildren',
          children=[
          Transform(translation=(0,0,-0.2),
            children=[
            Shape(
              geometry=Box(size=(1.1,1.3,0.001)),
              appearance=Appearance(
                material=Material(diffuseColor=(.5,0,1),transparency=0.9)))])]),
        fieldValue(name='locationOffset',value=(1.3,-.6,7.5))])]),
    Group(DEF='RotationRouting',
      children=[
      Script(DEF='TargetPositionScript',
        field=[
        field(accessType='inputOnly',name='set_translation',type='SFVec3f'),
        field(accessType='outputOnly',name='set_rotation',type='SFRotation')]),
      ROUTE(fromField='translation_changed',fromNode='TargetPlaneSensor',toField='set_translation',toNode='TargetPositionScript'),
      ROUTE(fromField='set_rotation',fromNode='TargetPositionScript',toField='set_rotation',toNode='MovableUpperDeck')])])
) # X3D model complete
...
print ("python x3d.py load successful for SatelliteRoom.py")

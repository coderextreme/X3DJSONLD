...
newModel=X3D(profile='Immersive',version='3.2',
  head=head(
    ...
    meta(content='StraitsOfMalaccaGeospatialCoordinateAxesNsew.x3d',name='title'),
...
print ("python x3d.py load successful for StraitsOfMalaccaGeospatialCoordinateAxesNsew.py")

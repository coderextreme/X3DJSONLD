...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='CreateSphereEaiJava.x3d',name='title'),
    meta(content='CreateSphereEaiJavaPage.html',name='example'),
    ...
    meta(content='CreateSphereEai.java',name='reference'),
    meta(content='javadoc/index.html',name='reference'),
    meta(content='originals/create/',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ExternalAuthoringInterface/CreateSphereEaiJava.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='CreateSphereEaiJava.x3d'),
    Group(DEF='NewNode'),
    Shape(
      appearance=Appearance(
        material=Material(DEF='BoxMaterial',diffuseColor=(1.0,0.0,0.0))),
      geometry=Box(size=(2.0,2.0,1.0)))])
) # X3D model complete
...
print ("python x3d.py load successful for CreateSphereEaiJava.py")

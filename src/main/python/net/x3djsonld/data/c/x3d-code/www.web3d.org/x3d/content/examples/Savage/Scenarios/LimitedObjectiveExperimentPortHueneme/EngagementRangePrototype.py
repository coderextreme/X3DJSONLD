...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='EngagementRangePrototype.x3d',name='title'),
    meta(content='Visually displays effective engagement range for a sentry armed with a 50 calibre machine gun.',name='description'),
    meta(content='James Harney',name='creator'),
    meta(content='6 February 2002',name='created'),
    meta(content='14 January 2014',name='modified'),
    meta(content='https://savage.nps.edu/Savage/Scenarios/LimitedObjectiveExperimentPortHueneme/EngagementRangePrototype.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ProtoDeclare(appinfo='Sense-Decide-Act Engagement Range',name='SenseDecideActEngagePrototype',
      ProtoInterface=ProtoInterface(
        field=[
        field(accessType='inputOutput',name='engagementPosition',type='SFVec3f',value=(0.0,0.0,0.0)),
        field(accessType='inputOutput',name='engagementTextPosition',type='SFVec3f',value=(0.0,0.0,0.0))]),
      ProtoBody=ProtoBody(
        children=[
        Group(
          children=[
    ...
    Transform(
      ...
      Transform(translation=(0,2,0),
        ...
        Transform(translation=(1,-.5,0),
          children=[
          Inline(url=["../../../Basic/HumanoidAnimation/NancyStandShootRifleM24.x3d","http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/NancyStandShootRifleM24.x3d","../../../Basic/HumanoidAnimation/NancyStandShootRifleM24.wrl","http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/NancyStandShootRifleM24.wrl"]),
...
print ("python x3d.py load successful for EngagementRangePrototype.py")

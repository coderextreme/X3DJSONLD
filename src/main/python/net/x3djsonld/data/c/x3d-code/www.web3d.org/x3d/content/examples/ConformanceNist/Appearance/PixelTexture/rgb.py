...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='rgb.x3d',name='title'),
    meta(content='rgb-front.jpg',name='Image'),
    meta(content='rgb-rear.jpg',name='Image'),
    meta(content='rgb-top.jpg',name='Image'),
    meta(content='rgb-bottom.jpg',name='Image'),
    meta(content='rgb-left.jpg',name='Image'),
    meta(content='rgb-right.jpg',name='Image'),
    ...
    Group(
      ...
      Transform(translation=(6.14221,0.0694613,-0.000999451),
        ...
        Shape(
          appearance=Appearance(
            material=Material(),
            texture=PixelTexture(DEF='RedYellowCheckerboard',image=[2,2,3,0xFF0000,0xFFFF00,0xFFFF00,0xFF0000])),
          geometry=Box(),)]),
      Transform(translation=(-4.85443,0.0694381,-0.00149918),
        ...
        Shape(
          appearance=Appearance(
            material=Material(),
            texture=PixelTexture(USE='RedYellowCheckerboard')),
          geometry=Sphere(),)]),
...
print ("python x3d.py load successful for rgb.py")

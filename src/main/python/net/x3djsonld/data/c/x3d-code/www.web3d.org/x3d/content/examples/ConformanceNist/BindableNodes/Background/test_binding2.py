...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_binding2.x3d',name='title'),
    meta(content='test-binding2-movie.mpg',name='MovingImage'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(0.5,3,0),
      ...
      Shape(
        ...
        geometry=Text(string=["Background 1 sending false Event"],
    ...
    ROUTE(fromField='isBound',fromNode='sky-back1',toField='enabled',toNode='timer1'),
...
print ("python x3d.py load successful for test_binding2.py")

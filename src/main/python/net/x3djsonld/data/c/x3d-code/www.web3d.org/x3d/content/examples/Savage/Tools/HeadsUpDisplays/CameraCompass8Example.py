...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='CameraCompass8Example.x3d',name='title'),
  ...
  Scene=Scene(
    ...
    ProtoInstance(name='CameraCompass8',
      fieldValue=[
    ...
    Transform(DEF='CenterInstructions',translation=(0,0.75,0),
      ...
      Billboard(
        children=[
        Shape(
          geometry=Text(string=["Walk and rotate to move scene while","compass heads-up display (HUD)","CameraCompass8 stays overhead"],
...
print ("python x3d.py load successful for CameraCompass8Example.py")

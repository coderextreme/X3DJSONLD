...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='TulipCluster2.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/Buildings/PlayGround/TulipCluster2.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(
      children=[
      Transform(scale=(0.7,0.7,0.7),translation=(0,-0.8,0),
        children=[
    ...
    Transform(
      children=[
      Transform(scale=(0.95,0.95,0.95),translation=(0,-0.8,0.2),
        children=[
...
print ("python x3d.py load successful for TulipCluster2.py")

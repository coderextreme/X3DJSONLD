...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='DDG51prop.x3d',name='title'),
    meta(content='Props and hub built in scale 1:1 in feet. Both shafts modeled to length of the longest shaft, shafts turn Inward.',name='description'),
  ...
  Scene=Scene(
    children=[
    Transform(DEF='STBDSHAFT',scale=(.3,.3,.3),
      children=[
      Group(DEF='PROP',
        children=[
        Transform(DEF='HUB',
...
print ("python x3d.py load successful for DDG51prop.py")

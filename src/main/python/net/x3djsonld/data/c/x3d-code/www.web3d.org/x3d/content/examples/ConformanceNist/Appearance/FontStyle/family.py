...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='family.x3d',name='title'),
    meta(content='family-front.jpg',name='Image'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(0,3,0),
      ...
      Shape(
        appearance=Appearance(
          material=Material(),),
        geometry=Text(string=["This is SANS"],
    ...
    Transform(translation=(0,-3,0),
      ...
      Shape(
        appearance=Appearance(
          material=Material(),),
        geometry=Text(string=["This is TYPEWRITER"],
...
print ("python x3d.py load successful for family.py")

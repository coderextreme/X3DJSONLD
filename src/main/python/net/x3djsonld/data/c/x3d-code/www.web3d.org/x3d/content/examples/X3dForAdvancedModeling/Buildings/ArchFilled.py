...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    children=[
    meta(content='ArchFilled.x3d',name='title'),
...
print ("python x3d.py load successful for ArchFilled.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_sim_attenuationspecial.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    PointLight(DEF='the-light',attenuation=(0,0,0),location=(0,0,10)),
...
print ("python x3d.py load successful for test_sim_attenuationspecial.py")

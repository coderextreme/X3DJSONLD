...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/CircleFishPositionInterpolator.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='CircleFishPositionInterpolator.x3d'),
    ExternProtoDeclare(name='CircleFish',url=["PositionInterpolatorPrototype.x3d#CircleFish","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/PositionInterpolatorPrototype.x3d#CircleFish","PositionInterpolatorPrototype.wrl#CircleFish","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/PositionInterpolatorPrototype.wrl#CircleFish"],
      field=[
...
print ("python x3d.py load successful for CircleFishPositionInterpolator.py")

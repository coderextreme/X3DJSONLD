...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_direffect_diffusecom.x3d',name='title'),
    meta(content='test-direffect-diffusecom-movie.mpg',name='MovingImage'),
  ...
  Scene=Scene(
    ...
    Transform(scale=(0.02,0.02,0.02),translation=(-2.8,1.5,-4.5),
      children=[
      Shape(
    ...
    Group(
      ...
      Transform(scale=(1.5,1.5,1.5),translation=(-1.18587,-0.651405,-5.5323),
        children=[
        Shape(
...
print ("python x3d.py load successful for test_direffect_diffusecom.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_simc1_attenuation.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    PointLight(attenuation=(0,0.2,0),location=(0,0,10),radius=101),

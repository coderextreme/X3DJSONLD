...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='test_deftext.x3d',name='title'),
    meta(content='test-deftext-front.jpg',name='Image'),
    meta(content='test-deftext-rear.jpg',name='Image'),
    meta(content='test-deftext-top.jpg',name='Image'),
    meta(content='test-deftext-bottom.jpg',name='Image'),
    meta(content='test-deftext-left.jpg',name='Image'),
    meta(content='test-deftext-right.jpg',name='Image'),
    ...
    meta(content='Test browser ability to completely map one ImageTexture onto the image texture should map once on the surface of the ElevationGrid. ImageTexture should map once onto the surface of the IndexedFaceSet, with the S (horizontal) axis of the texture corresponding to the X axis of the geometry.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/ElevationGrid/test_deftext.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='test_deftext.x3d'),
...
print ("python x3d.py load successful for test_deftext.py")

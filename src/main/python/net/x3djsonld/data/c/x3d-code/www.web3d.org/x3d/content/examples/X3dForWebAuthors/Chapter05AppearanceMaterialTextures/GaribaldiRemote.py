...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='GaribaldiRemote.x3d',name='title'),
    meta(content='Instantiate the Garibaldi fish prototype using a separate skin texture image file.',name='description'),
    meta(content='Instancing a prototype to match a specific fish.',name='description'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/GaribaldiRemote.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='GaribaldiRemote.x3d'),
    ...
    ProtoInstance(name='CircleFish',
      fieldValue=[
      fieldValue(name='skinTextureUrl',value=["http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/GaribaldiPatch.jpg"]),
...
print ("python x3d.py load successful for GaribaldiRemote.py")

...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='translation_changed.x3d',name='title'),
    meta(content='translation_changed-movie.mpg',name='MovingImage'),
  ...
  Scene=Scene(
    ...
    Group(
      ...
      Transform(DEF='MYBOX',
        ...
        PlaneSensor(DEF='BOXSENSOR',description='click and drag to move object',offset=(0,0,1)),
        Shape(
          appearance=Appearance(
            material=Material(diffuseColor=(1,1,0))),
          geometry=Box(),)])]),
    ROUTE(fromField='translation_changed',fromNode='BOXSENSOR',toField='set_translation',toNode='BOX_BALL')])
) # X3D model complete
...
print ("python x3d.py load successful for translation_changed.py")

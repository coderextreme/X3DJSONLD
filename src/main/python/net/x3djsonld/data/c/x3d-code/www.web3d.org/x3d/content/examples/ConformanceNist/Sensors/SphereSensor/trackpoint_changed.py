  ...
  Scene=Scene(
    ...
    Group(
      ...
      Transform(
        ...
        SphereSensor(DEF='SPHSENSOR',description='click and drag to rotate'),
        Shape(
          appearance=Appearance(
            material=Material(diffuseColor=(1,1,0))),
          geometry=Sphere(),)])]),
    ROUTE(fromField='trackPoint_changed',fromNode='SPHSENSOR',toField='set_translation',toNode='MY_BALL')])
) # X3D model complete

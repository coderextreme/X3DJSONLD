...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='proxynochildren.x3d',name='title'),
    meta(content='proxynochildren-movie.mpg',name='MovingImage'),
  ...
  Scene=Scene(
    ...
    Script(DEF='COLORSCRIPT',directOutput=True,url=["proxynochildren.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Collision/proxynochildren.js"],
      field=[
...
print ("python x3d.py load successful for proxynochildren.py")

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='CaliforniaCampusesTour4Altitudes.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/Geospatial/CaliforniaCampusesTour4Altitudes.x3d',name='identifier'),
  ...
  Scene=Scene(
    children=[
    WorldInfo(title='CaliforniaCampusesTour4Altitudes.x3d'),
...
print ("python x3d.py load successful for CaliforniaCampusesTour4Altitudes.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='st_png.x3d',name='title'),
    meta(content='st_png-front.jpg',name='Image'),
    meta(content='st_png-rear.jpg',name='Image'),
    meta(content='st_png-top.jpg',name='Image'),
    meta(content='st_png-bottom.jpg',name='Image'),
    meta(content='st_png-left.jpg',name='Image'),
    meta(content='st_png-right.jpg',name='Image'),
...
print ("python x3d.py load successful for st_png.py")

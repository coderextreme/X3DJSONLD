...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='Building.x3d',name='title'),
    meta(content='User interface panel for architectural models - Example building',name='description'),
  ...
  Scene=Scene(
    children=[
    ProtoDeclare(appinfo='Create an arch. Can modify general parameters: clearSpanWidth, riseHeight, depth, topAbutmentHeight, pierWidth, pierHeight. - Possibility to create shapes related to an arch: ArchHalf; IntradosOnly; ArchFilled; ArchHalfFilled; Lintel. See the reference file ArchModelingDiagrams.pdf to find further information. See also ArchScript_more_readable.js.',name='ArchPrototype',
    ...
    Transform(translation=(0,0,-5),
      children=[
      Shape(DEF='floor',
        geometry=Box(size=(35,0.1,35)),
        appearance=Appearance(
          material=Material(diffuseColor=(1,0.75,0.25))))]),
    Transform(
      children=[
      Shape(
        geometry=Extrusion(beginCap=False,crossSection=[(14.5,0),(15,0),(15,-10),(-15,-10),(-15,0),(-14.5,0),(-14.5,-9.5),(14.5,-9.5),(14.5,0)],endCap=False,solid=False,spine=[(0,0,0),(0,2.5,0)]),
        appearance=Appearance(
          material=Material(diffuseColor=(1,0.75,0.25))))]),
    Transform(translation=(0,1.75,-0.49),
      ...
      ProtoInstance(DEF='arc3D1',name='ArchPrototype',
        ...
        fieldValue(name='pierWidth',value=14.125),
...
print ("python x3d.py load successful for Building.py")

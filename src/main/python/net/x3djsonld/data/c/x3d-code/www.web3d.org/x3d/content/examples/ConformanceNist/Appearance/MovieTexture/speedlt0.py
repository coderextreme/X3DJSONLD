...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='speedlt0.x3d',name='title'),
    meta(content='speedlt0-movie.mpg',name='MovingImage'),
    ...
    meta(content='Test speed less than zero. With the speed field value less than 0 (in this case -2), the movie will play in reverse, at a speed proportional to the value of the speed field value (double speed, left to right) when "now" is clicked.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/speedlt0.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='speedlt0.x3d'),
      ...
      Transform(DEF='Cube',
        ...
        Shape(
          appearance=Appearance(
            texture=MovieTexture(DEF='Movie',loop=True,speed=-2,stopTime=1,url=["vts.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/vts.mpg"])),
          geometry=Box(),)])]),
    Group(
      children=[
...
print ("python x3d.py load successful for speedlt0.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='Test image mapping with 2 equal length sides of a bounding box. The bounding box for this geometry has two equal length long sides (Y and Z) and one short side (X). The JPG image VTS logo will be projected onto the bounding box with the S (image horizontal) axis parallel with the Y axis, the T (image vertical) axis parallel to the Z axis. The result: the VTS logo should appear "sideways" on the sides of the IndexedFaceSet, with the bottom of the logo along the Y axis. All remaining faces have the "smeared" end pixels of the front and rear textures.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/twosidesbig.x3d',name='identifier'),

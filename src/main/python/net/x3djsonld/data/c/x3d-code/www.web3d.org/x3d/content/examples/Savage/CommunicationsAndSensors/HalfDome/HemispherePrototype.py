...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='HemispherePrototype.x3d',name='title'),
    meta(content='Don Brutzman, David W. Laflam',name='creator'),
    meta(content='12 May 2009',name='created'),
    meta(content='8 September 2014',name='modified'),
  ...
  Scene=Scene(
    ...
    Anchor(description='Touch text for example',url=["HemisphereExample.x3d","https://savage.nps.edu/Savage/CommunicationsAndSensors/HalfDome/HemisphereExample.x3d","HemisphereExample.wrl","https://savage.nps.edu/Savage/CommunicationsAndSensors/HalfDome/HemisphereExample.wrl"],
      children=[
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(0,1,1),emissiveColor=(0,1,1))),
        geometry=Text(string=["HemispherePrototype.x3d","is a Prototype (PROTO) definition file.","","To see an example scene using this new node","click this text and view","HemisphereExample.x3d"],
...
print ("python x3d.py load successful for HemispherePrototype.py")

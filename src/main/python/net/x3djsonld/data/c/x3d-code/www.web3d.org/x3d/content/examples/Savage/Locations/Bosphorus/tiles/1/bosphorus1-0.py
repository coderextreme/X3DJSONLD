...
newModel=X3D(profile='Immersive',version='3.1',
  ...
  Scene=Scene(
    children=[
    GeoViewpoint(description='GeoViewpoint_1_10',geoSystem=['GDC'],position=(41.280922627855375,28.73422636498435,57209.268365411845),orientation=(-1,0,0,1.57),
      geoOrigin=GeoOrigin(DEF='ORIGIN',geoCoords=(41.06225017873692,29.030952729968703,0),geoSystem=['GDC'])),
    GeoLOD(center=(41.280922627855375,28.73422636498435,0.0),range=68651.125,child1Url=['../../tiles/2/bosphorus2-0.x3d'],child2Url=['../../tiles/2/bosphorus2-1.x3d'],child3Url=['../../tiles/2/bosphorus3-0.x3d'],child4Url=['../../tiles/2/bosphorus3-1.x3d'],
      ...
      Group(
        ...
        Shape(
          appearance=Appearance(
            ...
            texture=ImageTexture(url=['../../images/1/bosphorus1-0.jpg'],repeatS=False,repeatT=False)),

...
newModel=X3D(profile='CADInterchange',version='3.1',
  head=head(
    ...
    meta(content='CADPartChildTransformationAlternativeC.x3d',name='title'),
    meta(content='Developer scene to explore Mantis Issue 528 Alternative C for transformation of of CADFace children: allow Transform between CADPart and CADFace nodes.',name='description'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/CAD/CADPartChildTransformationAlternativeC.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='CADPartChildTransformationAlternativeC.x3d'),
    ...
    CADAssembly(name='DesignPatternAssembly',
      ...
      CADPart(name='CADPartExample',
        ...
        Transform(rotation=(1,0,0,1.5708),translation=(0,1.5,0),
          children=[
          CADFace(name='topCap',
            shape=Shape(
...
print ("python x3d.py load successful for CADPartChildTransformationAlternativeC.py")

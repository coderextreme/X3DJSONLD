...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='Autogenerated version of _3-methyl-1h-indene.x3d scene produced from _3-methyl-1h-indene.xml Chemical Markup Language (CML) source file.',name='description'),

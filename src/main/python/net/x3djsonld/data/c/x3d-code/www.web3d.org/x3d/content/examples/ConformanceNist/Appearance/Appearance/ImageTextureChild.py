...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='ImageTextureChild.x3d',name='title'),
...
print ("python x3d.py load successful for ImageTextureChild.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='WheelsRearRight.x3d',name='title'),
    meta(content='The right side of rear wheels and axle performs GearUp or GearDown when user clicks the text, and wheels spin when a cursor is over the wheels.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearRight.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(DEF='Texts',
      children=[
      Transform(DEF='GearUp',rotation=(0,1,0,3.14),scale=(2,2,2),translation=(-2.5,0.5,3),
        children=[
        Shape(
        ...
        OrientationInterpolator(DEF='AxleGearUpInterpolator',key=[0,0.5,0.75,1.0],keyValue=[(0,-1,0,0.0),(0,-1,0,0.44),(0,-1,0,1.22),(0.21,-0.96,-0.19,1.72)]),
        ...
        OrientationInterpolator(DEF='AxleGearUpInterpolator2',key=[0,0.25,0.5,1.0],keyValue=[(0,0,-1,0.0),(0,0,-1,0.44),(0,0,-1,0.80),(-0.21,0.18,-0.95,1.62)]),
      ...
      Transform(DEF='GearDown',rotation=(0,1,0,3.14),scale=(2,2,2),translation=(-2.5,-0.5,3),
        children=[
        Shape(
        ...
        OrientationInterpolator(DEF='AxleGearDownInterpolator2',key=[0,0.25,0.5,1.0],keyValue=[(-0.21,0.18,-0.95,1.62),(0,0,-1,0.80),(0,0,-1,0.44),(0,0,-1,0.0)]),
...
print ("python x3d.py load successful for WheelsRearRight.py")

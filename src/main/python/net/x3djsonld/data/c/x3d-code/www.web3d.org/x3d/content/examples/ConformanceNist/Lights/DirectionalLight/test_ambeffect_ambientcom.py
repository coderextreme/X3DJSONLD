...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_ambeffect_ambientcom.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(
      children=[
      DirectionalLight(DEF='the-light',ambientIntensity=0.2,intensity=0.5),

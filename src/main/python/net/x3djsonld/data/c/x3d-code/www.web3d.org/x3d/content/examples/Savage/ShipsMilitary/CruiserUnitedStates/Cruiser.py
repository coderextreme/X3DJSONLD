...
newModel=X3D(profile='Immersive',version='3.1',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/CruiserUnitedStates/Cruiser.x3d',name='identifier'),
    ...
    Transform(translation=(1.13,1,1),
      ...
      Transform(DEF='CRUSIERMAINBODY',
        ...
        Shape(DEF='BelowWaterHull',
          ...
          geometry=Extrusion(creaseAngle=0.85,crossSection=[(0,8.4),(4.412,6.65),(4.412,-6.65),(0,-8.4),(0,8.4)],orientation=[(0,0,1,.45),(0,0,1,0),(0,0,1,-.785)],scale=[(1.1,1),(1,1),(1.9,.02)],solid=False,spine=[(-82.0,0,0),(45,0,0),(70,0,0)])),
      ...
      Transform(DEF='FRONTGUN',rotation=(1,0.05,0,-1.57),scale=(0.7,0.7,0.7),translation=(55,9.4,1.5),
        ...
        Transform(DEF='FrontGunBody',scale=(0.5,0.5,0.7),
          ...
          Shape(
            appearance=Appearance(USE='HullGrey'),
            geometry=Extrusion(creaseAngle=1.5,crossSection=[(-6.0,0.0),(-5.9,0.7),(-5.7,1.2),(-5.3,1.7),(-5,2.1),(-4,2.2),(-3,2.3),(-2,2.40),(2.5,1),(2.6,2),(2.653,2.25),(4,1.75),(16,0),(7,-2.5),(-5.5,-2.5),(-6,0)],spine=[(0,1,0),(0,7,0)]))]),
        ...
        Group(DEF='Rear-Superstructure-grouping',
          ...
          Transform(DEF='Rear-Superstructure',translation=(-55,10,0),
            ...
            Transform(DEF='Rear-Large-Structure-Top',
              ...
              Shape(
                appearance=Appearance(USE='HullGrey'),
                geometry=IndexedFaceSet(ccw=False,coordIndex=[4,5,67,-1,0,1,2,3,-1,0,1,5,4,-1,1,2,6,5,-1,2,3,7,6,-1,0,4,7,3],solid=False,
        ...
        Group(DEF='Front-Superstructure-Grouping',
          ...
          Transform(DEF='Front-Superstructure',translation=(4,10,0),
            ...
            Transform(DEF='Front-Super-antenna',scale=(1,1.2,1),translation=(21,13,0),
              children=[
              Inline(DEF='AntennaMast',url=["../DestroyerSovremennyRussia/AntennaMast.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/AntennaMast.x3d","../DestroyerSovremennyRussia/AntennaMast.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/AntennaMast.wrl"])])])]),
...
print ("python x3d.py load successful for Cruiser.py")

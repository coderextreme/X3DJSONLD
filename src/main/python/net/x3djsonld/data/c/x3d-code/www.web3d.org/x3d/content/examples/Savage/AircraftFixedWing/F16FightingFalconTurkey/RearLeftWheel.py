...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='RearLeftWheel.x3d',name='title'),
  ...
  Scene=Scene(
    ...
    Group(
      children=[
      Transform(DEF='WheelsRearTransform',center=(0,3.8,0),rotation=(0,1,0,1.57),
        children=[
          ...
          Group(
            ...
            Transform(DEF='WheelTransform',scale=(1.2,1.2,1.2),
              ...
              Transform(translation=(0,0,-0.30),
                children=[
                Inline(USE='Hub')]),
              TouchSensor(DEF='WheelTouchSensor',description='When the mouse comes onto the wheel it starts to turn.'),
...
print ("python x3d.py load successful for RearLeftWheel.py")

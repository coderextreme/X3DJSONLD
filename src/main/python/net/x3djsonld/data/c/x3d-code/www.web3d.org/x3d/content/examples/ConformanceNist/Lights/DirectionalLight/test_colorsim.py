...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_colorsim.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(
      children=[
      DirectionalLight(DEF='the-light',color=(0,0,0)),

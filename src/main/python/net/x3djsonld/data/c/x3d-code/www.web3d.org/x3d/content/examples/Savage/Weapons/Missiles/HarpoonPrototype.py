...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='HarpoonPrototype.x3d',name='title'),
    meta(content='RGM-84D, Harpoon Anti-Ship Cruise missile prototype with built-in animation.',name='description'),
    ...
    meta(content='http://www.fas.org/man/dod-101/sys/smart/harpn01.jpg',name='reference'),
    meta(content='harpn01.jpg',name='reference'),
    meta(content='AGM-84-Harpoon-SLAM-SmartWeapons_files',name='reference'),
    ...
    meta(content='https://savage.nps.edu/Savage/Weapons/Missiles/HarpoonPrototype.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ProtoDeclare(name='RGM-84D',
      ...
      ProtoBody=ProtoBody(
        children=[
        Transform(DEF='RGMSSM',rotation=(0,0,1,-1.57),translation=(2.5,0,0),
          children=[
          Transform(
            ...
            Sound(maxBack=50000,maxFront=50000,
              source=AudioClip(DEF='RGMSOUND',description='Missile flight',url=["MISSILE1.wav","https://savage.nps.edu/Savage/Weapons/Missiles/MISSILE1.wav"])),
            Transform(translation=(0,-2.22,0),
              ...
              Group(DEF='MISSILEBODY',
                ...
                Transform(
                  children=[
                  Shape(
                    appearance=Appearance(DEF='RGMCOLOR',
            ...
            Transform(scale=(1.31,1.31,1.31),
              ...
              Group(DEF='CONE',
                children=[
                Shape(
                  appearance=Appearance(USE='RGMCOLOR'),
            ...
            Transform(
                ...
                Transform(translation=(.34,-3.02,0),
                  ...
                  Shape(DEF='FIN',
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,3,4,-1],solid=False,
                      coord=Coordinate(point=[(0,0,0),(0,1.1,0),(.5,.75,0),(.5,.25,0),(0,0,0)])),
              ...
              Group(DEF='AFTFIN',
                children=[
                Transform(translation=(.34,-4.4,0),
                  children=[
                  Shape(DEF='BACKFIN',
                    appearance=Appearance(USE='FINCOLOR'),
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,3,4,-1],solid=False,
                      coord=Coordinate(point=[(0,0,0),(0,.5,0),(.5,.35,0),(.5,.15,0),(0,0,0)])))]),
                Transform(rotation=(0,1,0,1.57),translation=(0,-4.4,-.34),
                  children=[
                  Shape(USE='BACKFIN')]),
                Transform(rotation=(0,1,0,3.14),translation=(-.34,-4.4,0),
                  children=[
                  Shape(USE='BACKFIN')]),
                Transform(rotation=(0,1,0,-1.57),translation=(0,-4.4,.34),
                  children=[
                  Shape(USE='BACKFIN')]),
                Transform(translation=(0,-4.45,0),
                  children=[
                  Shape(
              ...
              Group(DEF='BOOSTER',
                ...
                Group(DEF='BOOSTERFIN',
                  ...
                  Transform(rotation=(0,1,0,-1.57),translation=(0,-5.2,.34),
                    children=[
                    Shape(USE='BFIN')])])]),
              Transform(DEF='EXHAUST',rotation=(0,1,0,3.14),scale=(0.5,0.5,0.5),translation=(0,-7.51,0),
            ...
            Transform(
              ...
              Group(DEF='BANDS',
                children=[
                Transform(translation=(0,-1.87,0),
                  children=[
                  Shape(
                    geometry=Cylinder(height=.1,radius=.35),
                    appearance=Appearance(
                      material=Material(diffuseColor=(1,0,0))))]),
                Transform(translation=(0,-1.62,0),
                  children=[
                  Shape(
                    geometry=Cylinder(height=.1,radius=.35),
                    appearance=Appearance(
        ...
        ROUTE(fromField='startEventTime',fromNode='TimeFilter2',toField='set_startTime',toNode='RGMCLOCK'),
        ROUTE(fromField='startTime',fromNode='RGMCLOCK',toField='startTime',toNode='RGMSOUND'),
        ROUTE(fromField='stopTime',fromNode='RGMCLOCK',toField='set_stopTime',toNode='RGMSOUND'),
    ...
    Anchor(description='Harpoon Example',parameter=["target=_blank"],url=["HarpoonExample.x3d","../../Weapons/Missiles/HarpoonExample.x3d","https://savage.nps.edu/Savage/Weapons/Missiles/HarpoonExample.x3d","HarpoonExample.wrl","../../Weapons/Missiles/HarpoonExample.wrl","https://savage.nps.edu/Savage/Weapons/Missiles/HarpoonExample.wrl"],
      children=[
      Shape(
        geometry=Text(string=["HarpoonPrototype","is a prototype declaration file","","To see an example scene","click on this text and view","HarpoonExample"],
...
print ("python x3d.py load successful for HarpoonPrototype.py")

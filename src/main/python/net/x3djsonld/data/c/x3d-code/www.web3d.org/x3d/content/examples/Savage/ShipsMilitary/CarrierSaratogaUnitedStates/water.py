...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='Water surface.',name='description'),
    meta(content='Keith J Ho',name='creator'),
    meta(content='25 January 2001',name='created'),
    meta(content='14 January 2014',name='modified'),
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/water.x3d',name='identifier'),
              ...
              Transform(
                ...
                Shape(
                  ...
                  appearance=Appearance(
                    texture=ImageTexture(url=["water.gif","https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/water.gif"])))])])])])])]),

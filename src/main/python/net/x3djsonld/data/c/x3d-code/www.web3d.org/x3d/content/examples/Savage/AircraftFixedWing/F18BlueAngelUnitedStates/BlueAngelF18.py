...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='BlueAngelF18.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/BlueAngelF18.x3d',name='identifier'),
...
print ("python x3d.py load successful for BlueAngelF18.py")

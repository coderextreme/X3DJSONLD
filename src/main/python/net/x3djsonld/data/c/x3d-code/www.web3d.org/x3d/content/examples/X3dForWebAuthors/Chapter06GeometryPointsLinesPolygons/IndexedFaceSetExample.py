...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/IndexedFaceSetExample.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(
      ...
      Shape(
        ...
        geometry=IndexedFaceSet(DEF='PumpHouseIFS',coordIndex=[0,1,5,4,-1,5,1,2,6,-1,6,2,3,7,-1,3,0,4,7,-1,1,12,13,2,-1,2,13,14,-1,12,15,16,13,-1,15,0,3,16,-1,16,3,17,-1,9,5,6,10,-1,8,9,10,11,-1,4,8,11,7,-1,4,5,9,8,-1,11,10,6,7,-1,3,2,14,17,-1,13,16,17,14,-1],
      ...
      Transform(scale=(0.91,0.6,0.3),translation=(0.8,-0.65,0.5),
        ...
        Shape(
          ...
          geometry=Cylinder(DEF='PistonOuterShell',bottom=False,height=1,solid=False,top=False))])]),
    Group(
      children=[
        ...
        Transform(DEF='PistonTransform',
          ...
          Transform(scale=(1.8,1.2,0.6),translation=(0.0,-0.2,0.0),
            ...
            Shape(
              ...
              geometry=Cylinder(DEF='Piston',height=1,radius=0.98))]),

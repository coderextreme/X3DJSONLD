...
<Viewpoint position='-1.5 7 -1.2'/>
    ...
    <Transform DEF="MuroFrontSotto" translation='0 0 0'>
      ...
      Transform(DEF='Strozzatura2',translation=(0.19,-2,-3.739),
        ...
        Shape(
          geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,5,4,-1,1,2,6,5,-1,2,3,7,6,-1,3,0,4,7,-1,0,1,2,3,-1,4,5,6,7,-1],solid=False,
            coord=Coordinate(point=[(0,0,0.2),(2,0,0.2),(2,0,0.81),(0,0,1.11),(0,6.4,0.2),(2,6.4,0.2),(2,6.4,0.81),(0,6.4,1.11)])),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='MuroDietro1',translation=(-1.31,1.08,-2.77),
        children=[
        Shape(
      ...
      Transform(DEF='Pavimento31',translation=(-1.7,4.392,-1.6),
        children=[
        Shape(
      ...
      Transform(DEF='Pavimento32',translation=(-0.1,4.392,-1.36),rotation=(0,1,0,1.72),
        children=[
        Shape(
          geometry=Box(size=(1,0.1,2)),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='Pavimento322',translation=(-0.4,4.392,-2.5),rotation=(0,1,0,1.72),
        children=[
        Shape(
          geometry=Box(size=(2,0.1,1)),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='Pavimento323',translation=(-2.7,4.392,-1.7),
        children=[
        Shape(
          geometry=Box(size=(1,0.1,3)),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='Pavimento324',translation=(-2.2,4.392,-2.9),
        children=[
        Shape(
          geometry=Box(size=(2.5,0.1,1)),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='Soffitto2',translation=(-1.57,8.532,-1.55),
        children=[
        Shape(
          geometry=Box(size=(3.09,0.64,3.55)),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      #  Enter any text between the end tags
      ...
      Transform(DEF='Scale3',translation=(2.2,2.25,-0.6),rotation=(0,1,0,1.72),
        ...
        Transform(translation=(0,1.778,-2.24),
          geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,-1,2,3,4,5,-1],solid=False,
            coord=Coordinate(point=[(-0.1,0,0.15),(0.8,0,0.15),(0.8,0.254,0.15),(-0.1,0.254,0.15),(-0.1,0.254,-0.2625),(0.8,0.254,-0.2625)]))),
        Transform(translation=(0,2.032,-2.56),
          children=[
          Shape(DEF='scal3e',
            geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,-1,2,3,4,5,-1],solid=False,
    ...
    <Transform DEF="Strozzatura5" translation='0.38 4.8 -1' rotation="0 1 0 0">
      ...
      Transform(DEF='muro',translation=(0.4,4.9,-0.972),rotation=(0,1,0,1.72),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='box',translation=(-0.19,3.83,-1.11),
        children=[
        Shape(
          geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,-1,0,4,7,3,-1,0,1,5,4,-1],solid=False,
            coord=Coordinate(point=[(-0.1,0,0),(0.45,0,0),(0.45,0.5,0),(-0.1,0.45,0),(-0.1,0,0.6),(0.45,0,0.6),(0.45,0.5,0.6),(-0.1,0.5,0.6)])),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
   ...
   <Transform DEF="MuroLateraleDX2" translation='0.94 7.156 -1.7'>
      ...
      Transform(DEF='MuroDietro5SX',translation=(-3.285,6.507,-3.2595),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='MuroDietro5DX',translation=(0.69,6.507,-3.51),
        children=[
        Shape(
          geometry=Box(size=(1,3.61,0.5)),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      ...
      Transform(DEF='MuroLat5SX2Centro',translation=(-3.285,6.507,-1.545),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='MuroLat5DX',translation=(0.049,6.207,0.165),
        children=[
        Shape(
          geometry=Box(size=(0.74,4.21,1.01)),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='MuroLat6DX',translation=(0.169,7.13,-0.845),
        children=[
        Shape(
          geometry=Box(size=(0.5,2,1.01)),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='MuroLat7DX',translation=(-0.081,6.507,-3.76),
        ...
        Shape(
          geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,5,4,-1,1,2,6,5,-1,2,3,7,6,-1,3,0,4,7,-1,0,1,2,3,-1,4,5,6,7,-1],solid=False,
            coord=Coordinate(point=[(0,-2.1,0),(0.5,-2.1,0),(0.5,-2.1,2.83),(0,-2.1,2.83),(0,1.805,0),(0.5,1.805,0),(0.5,1.805,2.83),(0,1.805,2.83)])),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      ...
      Transform(DEF='FacciataSX',translation=(-3.65,-2.134,0.67),
        ...
        Transform(DEF='FacciataSXint',
          children=[
          Shape(
            geometry=IndexedFaceSet(convex=False,coordIndex=[6,22,17,16,19,18,23,11,-1,22,23,10,26,28,27,7,-1],solid=False,
              coord=Coordinate(point=[(0,0,0),(7.3,0,0),(7.3,7.73,0),(4.07,7.73,0),(4.07,6.44,0),(0,6.44,0),(0,0,-1.34),(7.3,0,-1.34),(7.3,7.73,-1.34),(4.07,7.73,-1.34),(4.07,6,-1.34),(0,6.44,-1.34),(1.603,4.27,0),(2.461,4.27,0),(2.461,5.233,0),(1.603,5.233,0),(1.603,4.27,-1.34),(2.461,4.27,-1.34),(2.461,5.233,-1.34),(1.603,5.233,-1.34),(2.461,0,0),(2.461,6.44,0),(2.461,0,-1.34),(2.461,6.44,-1.34),(4.07,5.52,0),(7.3,5.52,0),(4.07,5.52,-1.34),(7.3,4,-1.34),(4.07,4,-1.34)])),
            appearance=Appearance(
              material=Material(diffuseColor=(1,0.75,0.25))))]),
        ...
        Transform(DEF='FacciataSXestDIETRO',translation=(0,0,-0.2),
          ...
          Shape(
            ...
            appearance=Appearance(
              material=Material(diffuseColor=(1,0.75,0.25))))]),
        Transform(DEF='FacciataDXestDIETRO',translation=(7.03,0,-0.2),
          children=[
          Shape(
            geometry=IndexedFaceSet(convex=False,coordIndex=[3,2,25,24,-1],solid=False,
              coord=Coordinate(point=[(0,0,0),(7.3,0,0),(7.3,7.73,0),(4.07,7.73,0),(4.07,6.43,0),(0,6.43,0),(0,0,-1.34),(7.3,0,-1.34),(7.3,7.73,-1.34),(4.07,7.73,-1.34),(4.07,6.43,-1.34),(0,6.43,-1.34),(1.603,4.27,0),(2.461,4.27,0),(2.461,5.233,0),(1.603,5.233,0),(1.603,4.27,-1.34),(2.461,4.27,-1.34),(2.461,5.233,-1.34),(1.603,5.233,-1.34),(2.461,0,0),(2.461,6.43,0),(2.461,0,-1.34),(2.461,6.43,-1.34),(4.07,5.52,0),(7.3,5.52,0)])),

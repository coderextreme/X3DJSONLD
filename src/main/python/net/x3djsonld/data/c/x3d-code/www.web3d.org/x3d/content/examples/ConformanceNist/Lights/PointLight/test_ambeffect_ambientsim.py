...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test_ambeffect_ambientsim.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(
      children=[
      PointLight(DEF='the-light',ambientIntensity=0.1,intensity=0.5,location=(0,0,10),radius=50),

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='http://www.web3d.org/x3d/content/examples/UniversalMediaPanoramas/ocean3.x3d',name='reference'),
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/CH46E-SeaKnight-UnitedStates/CH46.x3d',name='identifier'),
    ...
    Group(
      ...
      Transform(rotation=(-1,0,0,1.57),translation=(0,0,-0.6),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(.5,.5,.5),shininess=.5),
            texture=ImageTexture(DEF='camo-wood2',url=["camo-wood2.jpg","https://savage.nps.edu/Savage/AircraftHelicopters/CH46E-SeaKnight-UnitedStates/camo-wood2.jpg"])))]),
      Transform(scale=(2.2,1.4,2.8),translation=(0,-0.65,6.5),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(.5,.5,.5),shininess=.5),
            texture=ImageTexture(DEF='camo-wood3',url=["camo-wood3.jpg","https://savage.nps.edu/Savage/AircraftHelicopters/CH46E-SeaKnight-UnitedStates/camo-wood3.jpg"]),
      ...
      Transform(scale=(2.2,2,3),translation=(0,0.5,5.0),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(.5,.5,.5),shininess=.5),
            texture=ImageTexture(DEF='camo-wood4',url=["camo-wood4.jpg","https://savage.nps.edu/Savage/AircraftHelicopters/CH46E-SeaKnight-UnitedStates/camo-wood4.jpg"])))]),

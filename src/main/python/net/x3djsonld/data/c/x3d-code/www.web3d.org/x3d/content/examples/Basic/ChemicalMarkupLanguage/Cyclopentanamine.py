...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='Cyclopentanamine.x3d',name='title'),
    meta(content='Autogenerated version of Cyclopentanamine.x3d scene produced from Cyclopentanamine.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='Cyclopentanamine.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Cyclopentanamine.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Cyclopentanamine.x3d'),
    ...
    Viewpoint(description='Inspect Cyclopentanamine',position=(0,2,20)),
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["Cyclopentanamine: C5 H11 N"])])]),
      Transform(translation=(0,5,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["molecule weight: 85.15"])])]),
      Transform(translation=(0,4,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["melting point: -6"])])]),
      Transform(translation=(0,3,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["boiling point: 106"])])]),
      Transform(translation=(0,2,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["specific gravity: 0.863"])])])]),
    Group(
      children=[
      Transform(
        children=[
        ProtoInstance(DEF='cyclopentanamine_a1',name='Nitrogen',
          fieldValue=[
          fieldValue(name='position',value=(0.6333,2.5818,1.6112))])]),
      Transform(
        children=[
        ProtoInstance(DEF='cyclopentanamine_a2',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.0204,2.1653,1.9102))])]),
      Transform(
        children=[
        ProtoInstance(DEF='cyclopentanamine_a3',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.053,3.047,1.1939))])]),
      Transform(
        children=[
        ProtoInstance(DEF='cyclopentanamine_a4',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(4.2903,2.1762,0.9973))])]),
      Transform(
        children=[
        ProtoInstance(DEF='cyclopentanamine_a5',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.8619,0.7218,1.1851))])]),
      Transform(
        children=[
        ProtoInstance(DEF='cyclopentanamine_a6',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.3704,0.7241,1.4997))])])]),
    Group(
      children=[
      ProtoInstance(DEF='cyclopentanamine_b1',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(0.6333,2.5818,1.6112),(2.0204,2.1653,1.9102)])]),
      ProtoInstance(DEF='cyclopentanamine_b4',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.0204,2.1653,1.9102),(3.053,3.047,1.1939)])]),
      ProtoInstance(DEF='cyclopentanamine_b5',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.3704,0.7241,1.4997),(2.0204,2.1653,1.9102)])]),
      ProtoInstance(DEF='cyclopentanamine_b7',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.053,3.047,1.1939),(4.2903,2.1762,0.9973)])]),
      ProtoInstance(DEF='cyclopentanamine_b10',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(4.2903,2.1762,0.9973),(3.8619,0.7218,1.1851)])]),
      ProtoInstance(DEF='cyclopentanamine_b13',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.8619,0.7218,1.1851),(2.3704,0.7241,1.4997)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for Cyclopentanamine.py")

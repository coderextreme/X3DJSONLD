...
newModel=X3D(profile='Immersive',version='3.0',
  ...
  Scene=Scene(
    ...
    Anchor(description='ArtDecoPrototypeExample',parameter=["target=_blank"],url=["ArtDecoExamples.x3d","https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/ArtDecoExamples.x3d","ArtDecoExamples.wrl","https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/ArtDecoExamples.wrl"],
      children=[
      Shape(
...
print ("python x3d.py load successful for ArtDecoPrototypes.py")

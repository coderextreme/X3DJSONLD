...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Lightweight155mmHowitzer.x3d',name='title'),
    ...
    meta(content='http://www.fas.org/man/dod-101/sys/land/xm777-3.gif',name='Image'),
    meta(content='155 millimeter Howitzer',name='subject'),
    meta(content='https://savage.nps.edu/Savage/Weapons/Guns/Lightweight155mmHowitzer.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Background(skyColor=[(0.3,0.6,0.85)]),
            ...
            Transform(rotation=(0.58,0.58,-0.58,2.09),scale=(0.75,0.75,0.75),translation=(0.667,0,0),
              ...
              Transform(DEF='ElevationGear',translation=(-0.25,-0.4,0.45),
                ...
                Transform(scale=(0.33,0.33,0.33),translation=(-0.08,-0.15,0.175),
                  children=[
                  Inline(DEF='Crank',url=["Lightweight155mmHowitzerCrank.wrl","https://savage.nps.edu/Savage/Weapons/Guns/Lightweight155mmHowitzerCrank.wrl","Lightweight155mmHowitzerCrank.x3d","https://savage.nps.edu/Savage/Weapons/Guns/Lightweight155mmHowitzerCrank.x3d"])])]),
...
print ("python x3d.py load successful for Lightweight155mmHowitzer.py")

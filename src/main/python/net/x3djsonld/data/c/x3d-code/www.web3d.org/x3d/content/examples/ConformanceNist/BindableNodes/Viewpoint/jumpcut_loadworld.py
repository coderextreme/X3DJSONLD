...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='jumpcut_loadworld.x3d',name='title'),
    ...
    meta(content='Test jumpcut to viewpoint in Anchor URL. This world contains an Anchor link to itself, with the Anchor containing the addition of RearView at the end of the url. When the cubic geometry is selected by the pointing device, the world reloads itself, with the initial Viewpoint now being the rear Viewpoint instead of the first encountered front Viewpoint. Because the "RearView" is specified at the end of the url in the Anchor node, the browser should disregard any other Viewpoint node in this world, and load the Viewpoint node with the DEF name "RearView" as the default Viewpoint. As a result, the viewer should see a cubic geometry with the word REAR appearing on its face, and Text at the bottom of the world should indicate the Viewpoint position to be at coordinates 0 0 -10.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='jumpcut_loadworld.x3d'),
    NavigationInfo(type=["EXAMINE"]),
    Viewpoint(DEF='FrontView',description='Front View'),
    Viewpoint(DEF='RearView',description='Rear View',orientation=(0,1,0,3.14159),position=(0,0,-10)),
    ...
    Anchor(description='reload scene for RearView viewpoint',url=["jumpcut_loadworld.x3d#RearView","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld.x3d#RearView","jumpcut_loadworld.wrl#RearView","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld.wrl#RearView"],
      children=[
      Shape(
      ...
      Transform(translation=(-10,-5,-20),
        ...
        Shape(
          ...
          geometry=Text(DEF='TYPESTRING1',string=["message from Script is inserted here"],
            fontStyle=FontStyle(style_='BOLD')))])]),
    Script(DEF='AVATARSCRIPT',directOutput=True,url=["jumpcut_loadworld.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld.js"],
      field=[
...
print ("python x3d.py load successful for jumpcut_loadworld.py")

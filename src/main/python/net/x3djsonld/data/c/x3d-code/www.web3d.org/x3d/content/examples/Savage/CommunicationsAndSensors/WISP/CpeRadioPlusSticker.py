...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='CpeRadioPlusSticker.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/CommunicationsAndSensors/WISP/CpeRadioPlusSticker.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    Viewpoint(description='CpeRadioPlusSticker',position=(0,0,0.50)),
    Group(
      children=[
      ...
      Transform(DEF='StickerforRadioFace',translation=(0,0,.00901),
        children=[
        Shape(
          appearance=Appearance(
            #  Sticker for front of radio 
            texture=ImageTexture(DEF='CpeRadio',url=["aBO.gif","https://savage.nps.edu/Savage/CommunicationsAndSensors/WISP/aBO.gif"])),
...
print ("python x3d.py load successful for CpeRadioPlusSticker.py")

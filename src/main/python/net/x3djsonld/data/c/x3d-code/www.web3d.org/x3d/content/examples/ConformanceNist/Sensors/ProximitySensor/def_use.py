...
newModel=X3D(profile='Interactive',version='3.0',
  ...
  Scene=Scene(
    ...
    Viewpoint(description='Outside ProximitySensors',position=(0,0,20)),
    Viewpoint(description='Inside Center ProximitySensor',position=(0,0,0)),
    Viewpoint(description='Outside ProximitySensors',position=(0,0,20)),
    Viewpoint(description='Inside Left ProximitySensor',position=(-5,0,0)),
    Viewpoint(description='Outside ProximitySensors',position=(0,0,20)),
    Viewpoint(description='Inside Right ProximitySensor',position=(5,0,0)),
    Group(
      children=[

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='TulipCluster3.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/Buildings/PlayGround/TulipCluster3.x3d',name='identifier'),
...
print ("python x3d.py load successful for TulipCluster3.py")

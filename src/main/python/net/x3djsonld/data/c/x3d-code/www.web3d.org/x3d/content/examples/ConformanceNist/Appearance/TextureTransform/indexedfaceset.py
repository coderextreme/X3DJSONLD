...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='Test default TextureTransform mapping of a JPG image to an IndexedFaceSet. The result is: The VTS logo should appear upright on the front face and appear reversed on the rear face of the geometry. All other faces should have smeared end pixels of the front and rear faces.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/TextureTransform/indexedfaceset.x3d',name='identifier'),

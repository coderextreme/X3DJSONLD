...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='NarragansettBayBathymetry.x3d',name='title'),
    meta(content='Bathymetry model of Narragansett Bay, Rhode Island with large-area terrain',name='description'),
    meta(content='Byounghyun Yoo',name='creator'),
    meta(content='21 April 2008',name='created'),
    meta(content='9 July 2018',name='modified'),
    meta(content='Rez, http://www.rez3d.com',name='generator'),
    meta(content='https://savage.nps.edu/Savage/Locations/NarragansettBayRhodeIslandBathymetry/NarragansettBayBathymetry.x3d',name='identifier'),
...
print ("python x3d.py load successful for NarragansettBayBathymetry.py")

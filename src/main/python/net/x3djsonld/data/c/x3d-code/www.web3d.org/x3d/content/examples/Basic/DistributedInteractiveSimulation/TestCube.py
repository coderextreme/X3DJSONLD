    ...
    Group(
      ...
      Shape(DEF='Front',
        ...
        appearance=Appearance(
          texture=ImageTexture(url=["images/front.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/images/front.png","https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/images/front.png"]),
      ...
      Shape(DEF='Back',
        ...
        appearance=Appearance(
          texture=ImageTexture(url=["images/back.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/images/back.png","https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/images/back.png"]),
      ...
      Shape(DEF='Left',
        geometry=IndexedFaceSet(coordIndex=[3,2,6,7],texCoordIndex=[0,1,2,3],
          ...
          texCoord=TextureCoordinate(USE='DefaultTextureCoordinate')),
        appearance=Appearance(
          texture=ImageTexture(url=["images/left.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/images/left.png","https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/images/left.png"]),
          textureTransform=TextureTransform(USE='RotateRight'))),
      ...
      Shape(DEF='Right',
        geometry=IndexedFaceSet(coordIndex=[0,4,5,1],texCoordIndex=[0,1,2,3],
          ...
          texCoord=TextureCoordinate(USE='DefaultTextureCoordinate')),
        appearance=Appearance(
          texture=ImageTexture(url=["images/right.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/images/right.png","https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/images/right.png"]),
      ...
      Shape(DEF='Top',
        geometry=IndexedFaceSet(coordIndex=[0,3,7,4],texCoordIndex=[0,1,2,3],
          ...
          texCoord=TextureCoordinate(USE='DefaultTextureCoordinate')),
        appearance=Appearance(
          texture=ImageTexture(url=["images/top.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/images/top.png","https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/images/top.png"]),
      ...
      Shape(DEF='Bottom',
        geometry=IndexedFaceSet(coordIndex=[1,5,6,2],texCoordIndex=[0,1,2,3],
          ...
          texCoord=TextureCoordinate(USE='DefaultTextureCoordinate')),
        appearance=Appearance(
          texture=ImageTexture(url=["images/bottom.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/images/bottom.png","https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/images/bottom.png"]),
...
print ("python x3d.py load successful for TestCube.py")

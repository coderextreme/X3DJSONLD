...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='center_primitives.x3d',name='title'),
    meta(content='center_primitives-front.jpg',name='Image'),
    meta(content='center_primitives-rear.jpg',name='Image'),
    meta(content='center_primitives-top.jpg',name='Image'),
    meta(content='center_primitives-bottom.jpg',name='Image'),
    meta(content='center_primitives-left.jpg',name='Image'),
    meta(content='center_primitives-right.jpg',name='Image'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(-2,-0.75,0),
      ...
      Shape(
        appearance=Appearance(
          ...
          textureTransform=TextureTransform(DEF='TextureTransformRecenterRotate',center=(-101.66,-101.66),rotation=1.57),
          material=Material(),),
        geometry=Sphere(radius=0.5))]),
    ...
    Transform(translation=(-2,-2.5,0),
      ...
      Shape(
        appearance=Appearance(
          texture=ImageTexture(USE='VTS'),
          textureTransform=TextureTransform(USE='TextureTransformRecenterRotate'),
          material=Material(),),
        geometry=Box(size=(1,1,1)))]),
...
print ("python x3d.py load successful for center_primitives.py")

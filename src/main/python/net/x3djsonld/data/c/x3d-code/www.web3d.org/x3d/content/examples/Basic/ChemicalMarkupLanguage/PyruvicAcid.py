...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='PyruvicAcid.x3d',name='title'),
    meta(content='Autogenerated version of PyruvicAcid.x3d scene produced from PyruvicAcid.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='PyruvicAcid.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/PyruvicAcid.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='PyruvicAcid.x3d'),
    ...
    Viewpoint(description='Inspect PyruvicAcid',position=(0,2,20)),
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["Pyruvic Acid: C3 H4 O3"])])]),
      Transform(translation=(0,5,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["molecule weight: 88.06"])])]),
      Transform(translation=(0,4,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["melting point: 12"])])]),
      Transform(translation=(0,3,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["boiling point: 165"])])]),
      Transform(translation=(0,2,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["specific gravity: 1.265"])])])]),
    Group(
      children=[
      Transform(
        children=[
        ProtoInstance(DEF='pyruvic_acid_a1',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(1.2732,0.8302,0.9936))])]),
      Transform(
        children=[
        ProtoInstance(DEF='pyruvic_acid_a2',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.6424,1.5034,0.9854))])]),
      Transform(
        children=[
        ProtoInstance(DEF='pyruvic_acid_a3',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.5974,2.9991,0.9011))])]),
      Transform(
        children=[
        ProtoInstance(DEF='pyruvic_acid_a4',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(3.6572,0.847,1.0232))])]),
      Transform(
        children=[
        ProtoInstance(DEF='pyruvic_acid_a5',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(0.8508,0.4234,2.2078))])]),
      Transform(
        children=[
        ProtoInstance(DEF='pyruvic_acid_a6',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(0.5294,0.64,0.052))])])]),
    Group(
      children=[
      ProtoInstance(DEF='pyruvic_acid_b1',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.2732,0.8302,0.9936),(2.6424,1.5034,0.9854)])]),
      ProtoInstance(DEF='pyruvic_acid_b2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.2732,0.8302,0.9936),(0.8508,0.4234,2.2078)])]),
      ProtoInstance(DEF='pyruvic_acid_b3',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.2532,0.8302,0.9936),(0.5094,0.64,0.052)])]),
      ProtoInstance(DEF='pyruvic_acid_b3_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.2932000000000001,0.8302,0.9936),(0.5494,0.64,0.052)])]),
      ProtoInstance(DEF='pyruvic_acid_b4',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.6424,1.5034,0.9854),(2.5974,2.9991,0.9011)])]),
      ProtoInstance(DEF='pyruvic_acid_b5',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.6224,1.5034,0.9854),(3.6372,0.847,1.0232)])]),
      ProtoInstance(DEF='pyruvic_acid_b5_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.6624,1.5034,0.9854),(3.6772,0.847,1.0232)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for PyruvicAcid.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='set_creaseangle.x3d',name='title'),
    meta(content='set-creaseangle-front.jpg',name='Image'),
    meta(content='set-creaseangle-rear.jpg',name='Image'),
    meta(content='set-creaseangle-top.jpg',name='Image'),
    meta(content='set-creaseangle-bottom.jpg',name='Image'),
    meta(content='set-creaseangle-left.jpg',name='Image'),
    meta(content='set-creaseangle-right.jpg',name='Image'),
    ...
    meta(content='This tests redefines the value for the creaseAngle for an IndexedFaceSet (sphere). This value (1.5) will result in rendering a smoother figure along adjacent faces.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/IndexedFaceSet/set_creaseangle.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='set_creaseangle.x3d'),
...
print ("python x3d.py load successful for set_creaseangle.py")

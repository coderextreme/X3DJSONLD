...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='OmniTransmitterPrototype.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/CommunicationsAndSensors/OmniDirectional/OmniTransmitterPrototype.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    ProtoDeclare(appinfo='Omnidirectional hemispherical transmitter.',name='OmniTransmitter',
      ...
      ProtoBody=ProtoBody(
        ...
        Group(
          ...
          Transform(scale=(.1,.1,.1),
            children=[
            Inline(DEF='LightningBolt',url=["../../CommunicationsAndSensors/OmniDirectional/LightningBolt.x3d","https://savage.nps.edu/Savage/CommunicationsAndSensors/OmniDirectional/LightningBolt.x3d","../../CommunicationsAndSensors/OmniDirectional/LightningBolt.wrl","https://savage.nps.edu/Savage/CommunicationsAndSensors/OmniDirectional/LightningBolt.wrl"])]),
...
print ("python x3d.py load successful for OmniTransmitterPrototype.py")

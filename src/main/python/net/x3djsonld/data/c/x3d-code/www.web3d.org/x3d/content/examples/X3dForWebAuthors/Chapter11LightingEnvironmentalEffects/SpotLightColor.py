...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/SpotLightColor.x3d',name='identifier'),
...
print ("python x3d.py load successful for SpotLightColor.py")

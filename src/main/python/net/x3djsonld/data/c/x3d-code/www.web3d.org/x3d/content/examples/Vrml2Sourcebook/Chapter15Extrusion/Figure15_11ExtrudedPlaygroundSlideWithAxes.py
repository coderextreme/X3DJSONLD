...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure15_11ExtrudedPlaygroundSlideWithAxes.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter15Extrusion/Figure15_11ExtrudedPlaygroundSlideWithAxes.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    children=[
    WorldInfo(title='Figure15_11ExtrudedPlaygroundSlideWithAxes.x3d'),
...
print ("python x3d.py load successful for Figure15_11ExtrudedPlaygroundSlideWithAxes.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/OH58dKiowaWarriorUnitedStates/VerticalFin.x3d',name='identifier'),
    ...
    Group(DEF='VERTICAL_FIN',
      ...
      Transform(rotation=(0.0,0.0,1.0,1.57),
        ...
        Shape(
          ...
          #  right, left, bottom, upper front, lower front, top, lower back, upper back 
          geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,4,5,-1,6,11,10,9,8,7,-1,0,6,7,1,-1,1,7,8,2,-1,2,8,9,3,-1,3,9,10,4,-1,0,5,11,6,-1,5,4,10,11,-1],
            #  right side view points, left side view points 

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/Tools/Authoring/CoordinateAxesNSEW.x3d',name='identifier'),
...
print ("python x3d.py load successful for CoordinateAxesNSEW.py")

...
newModel=X3D(profile='Immersive',version='3.2',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/Security/HelloWorldEncryptionInput.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    children=[
    WorldInfo(title='HelloWorldEncryptionInput.x3d'),
    Group(
      children=[
...
print ("python x3d.py load successful for HelloWorldEncryptionInput.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='fly_type.x3d',name='title'),
    meta(content='fly_type-movie.mpg',name='MovingImage'),
...
print ("python x3d.py load successful for fly_type.py")

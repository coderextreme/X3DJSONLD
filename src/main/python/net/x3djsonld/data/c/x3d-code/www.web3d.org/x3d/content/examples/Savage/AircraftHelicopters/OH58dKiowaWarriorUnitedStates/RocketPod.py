...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='This file defines a 2.75 inch rocket weapon system that is inlined to create a helicopter',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/OH58dKiowaWarriorUnitedStates/RocketPod.x3d',name='identifier'),
      ...
      Transform(translation=(0.0,0.2,0.0),
        ...
        Group(DEF='ROCKET',
          ...
          Transform(translation=(0.0,0.875,0.0),
            children=[
            Shape(
              appearance=Appearance(DEF='DARK_BLUE',
                material=Material(diffuseColor=(0.0,0.0,0.25))),

  ...
  Scene=Scene(
    ...
    ProtoDeclare(appinfo='Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes',name='ViewFrustum',
      ...
      ProtoBody=ProtoBody(
        ...
        Script(DEF='GeometryComputationScript',directOutput=True,url=["ViewFrustumPrototypeScript.js","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototypeScript.js"],
          field=[
    ...
    Anchor(description='ViewFrustum Example',url=["ViewFrustumExample.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumExample.x3d","ViewFrustumExample.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumExample.wrl"],
      children=[
      Shape(
        appearance=Appearance(

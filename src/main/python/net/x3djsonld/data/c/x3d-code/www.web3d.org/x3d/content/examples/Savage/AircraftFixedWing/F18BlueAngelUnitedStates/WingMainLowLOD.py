...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='WingMainLowLOD.x3d',name='title'),
    meta(content="The low Level-of-Detail(LOD)of a Blue Angels' main wing. The low LOD omits U.S. Navy insignia and is shown at the point of view of 1000 meters.",name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WingMainLowLOD.x3d',name='identifier'),
...
print ("python x3d.py load successful for WingMainLowLOD.py")

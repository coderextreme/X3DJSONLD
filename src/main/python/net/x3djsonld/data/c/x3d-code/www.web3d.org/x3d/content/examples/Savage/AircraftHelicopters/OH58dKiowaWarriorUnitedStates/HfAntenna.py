...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='This file defines an HF Antenna that is inlined to create the tail boom for a helicopter.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/OH58dKiowaWarriorUnitedStates/HfAntenna.x3d',name='identifier'),

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='default_fontstyle.x3d',name='title'),
    meta(content='default-front.jpg',name='Image'),
    ...
    Transform(
      ...
      Shape(
        ...
        geometry=IndexedLineSet(DEF='LINES',coordIndex=[0,1,-1,1,2,-1,3,4,-1,4,5,-1,6,7,-1,7,8,-1,9,10,-1,10,11,-1,12,13,-1,13,14,-1,15,16,-1,16,17,-1,18,19,-1,19,20,-1,21,22,-1,22,23,-1,24,25,-1,25,26,-1,27,28,-1,28,29,-1],
          coord=Coordinate(point=[(-10,-5,0),(0,-5,0),(10,-5,0),(-10,-4,0),(0,-4,0),(10,-4,0),(-10,-3,0),(0,-3,0),(10,-3,0),(-10,-2,0),(0,-2,0),(10,-2,0),(-10,-1,0),(0,-1,0),(10,-1,0),(-10,1,0),(0,1,0),(10,1,0),(-10,2,0),(0,2,0),(10,2,0),(-10,3,0),(0,3,0),(10,3,0),(-10,4,0),(0,4,0),(10,4,0),(-10,5,0),(0,5,0),(10,5,0)])))]),
    Transform(
      children=[
      Shape(
        appearance=Appearance(
        ...
        geometry=IndexedLineSet(DEF='AXES',coordIndex=[0,1,-1,2,3,-1],
          coord=Coordinate(point=[(-10,0,0),(10,0,0),(0,5,0),(0,-5,0)])))])])
) # X3D model complete
...
print ("python x3d.py load successful for default_fontstyle.py")

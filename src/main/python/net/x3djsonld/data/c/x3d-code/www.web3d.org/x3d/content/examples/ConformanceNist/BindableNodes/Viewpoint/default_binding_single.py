...
newModel=X3D(profile='Immersive',version='3.0',
  ...
  Scene=Scene(
    ...
    Viewpoint(description='Front View',orientation=(0,1,0,3.14159),position=(0,0,-10)),
      ...
      Transform(translation=(-10,-5,-20),
        ...
        Shape(
          ...
          geometry=Text(DEF='TYPESTRING1',string=["message from Script is inserted here"],
            fontStyle=FontStyle(style_='BOLD')))])]),
    Script(DEF='AVATARSCRIPT',directOutput=True,url=["default_binding_single.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/default_binding_single.js"],
      field=[

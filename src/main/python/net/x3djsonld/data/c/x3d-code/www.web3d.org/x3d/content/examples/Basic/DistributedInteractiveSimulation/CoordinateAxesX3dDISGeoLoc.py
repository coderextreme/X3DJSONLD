...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='CoordinateAxesX3dDISGeoLoc.x3d',name='title'),
    meta(content='Don Brutzman',name='creator'),
    meta(content='14 July 2000',name='created'),
    meta(content='20 October 2019',name='modified'),
    meta(content='X Y Z axis arrows and labels in X3D, DIS and GeoLocation coordinate systems. See CoordinateAxesExample for use as an Inline coordinate-system reference frame.',name='description'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/DistributedInteractiveSimulation/CoordinateAxesX3dDISGeoLoc.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    #  Consult Section 25.3.3 GeoLocation for the Geospatial component's adjustment from X3D to GeoLocation coordinates 
    children=[
    WorldInfo(title='CoordinateAxesX3dDISGeoLoc.x3d'),
    Group(
      ...
      Transform(translation=(0,1.7,0),
        ...
        Billboard(
          ...
          Shape(
            ...
            geometry=Text(string=["Up","+Y X3D","-Z DIS","+Y GeoLocation"],
    ...
    Transform(rotation=(0,0,1,-1.57079),
      ...
      Group(
        ...
        Transform(rotation=(0,0,1,1.57079),translation=(0,1.2,0),
          ...
          Billboard(
            ...
            Shape(
              ...
              geometry=Text(string=["North","+X X3D","+X DIS","-Z GeoLocation"],
      ...
      Group(
        ...
        Transform(rotation=(1,0,0,-1.57079),translation=(0,1.1,-0.05),
          ...
          Billboard(
            ...
            Shape(
              appearance=Appearance(USE='LABEL_APPEARANCE'),
              geometry=Text(string=["East","+Z X3D","+Y DIS","+X GeoLocation"],
                fontStyle=FontStyle(USE='LABEL_FONT')))])])])])])
) # X3D model complete
...
print ("python x3d.py load successful for CoordinateAxesX3dDISGeoLoc.py")

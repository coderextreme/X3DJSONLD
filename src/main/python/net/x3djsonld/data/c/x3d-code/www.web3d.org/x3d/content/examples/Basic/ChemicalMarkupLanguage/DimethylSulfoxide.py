...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='DimethylSulfoxide.x3d',name='title'),
    meta(content='Autogenerated version of DimethylSulfoxide.x3d scene produced from DimethylSulfoxide.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='DimethylSulfoxide.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/DimethylSulfoxide.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='DimethylSulfoxide.x3d'),
    ...
    Viewpoint(description='Inspect DimethylSulfoxide',position=(0,2,20)),
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["DimethylSulfoxide: C2 H6 O S"])])]),
      Transform(translation=(0,5,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["molecule weight: 78.13"])])]),
      Transform(translation=(0,4,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["melting point: 18"])])]),
      Transform(translation=(0,3,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["boiling point: 189"])])]),
      Transform(translation=(0,2,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["specific gravity: 1.101"])])])]),
    Group(
      children=[
      Transform(
        children=[
        ProtoInstance(DEF='dimethyl_sulfoxide_a1',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(0.8293,1.3548,0.5856))])]),
      Transform(
        children=[
        ProtoInstance(DEF='dimethyl_sulfoxide_a2',name='Sulphur',
          fieldValue=[
          fieldValue(name='position',value=(2.3997,2.0598,0.0))])]),
      Transform(
        children=[
        ProtoInstance(DEF='dimethyl_sulfoxide_a3',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.5575,1.0719,0.9948))])]),
      Transform(
        children=[
        ProtoInstance(DEF='dimethyl_sulfoxide_a4',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(2.4513,3.4791,0.6382))])])]),
    Group(
      children=[
      ProtoInstance(DEF='dimethyl_sulfoxide_b1',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(0.8293,1.3548,0.5856),(2.3997,2.0598,0.0)])]),
      ProtoInstance(DEF='dimethyl_sulfoxide_b5',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.3997,2.0598,0.0),(3.5575,1.0719,0.9948)])]),
      ProtoInstance(DEF='dimethyl_sulfoxide_b6',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.3797,2.0598,0.0),(2.4313,3.4791,0.6382)])]),
      ProtoInstance(DEF='dimethyl_sulfoxide_b6_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.4197,2.0598,0.0),(2.4713,3.4791,0.6382)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for DimethylSulfoxide.py")

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='LoadSensorKelpForestMain.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/LoadSensorKelpForestMain.x3d',name='identifier'),
  ...
  Scene=Scene(
      ...
      Collision(enabled=False,
        ...
        Transform(DEF='K2_LOCALE',translation=(-4.0,0.0,1.0),
          ...
          Transform(DEF='K2_MIDWATER',scale=(0.2,0.2,0.2),translation=(-1.0,-4.0,-4.0),
            children=[
            Inline(DEF='LoadSardine',url=["../KelpForestExhibit/SardineSchool.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SardineSchool.x3d","../KelpForestExhibit/SardineSchool.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SardineSchool.wrl"])]),
    ...
    Group(DEF='Nancy',
      ...
      Transform(DEF='NancyTransform',rotation=(-0.45,0.77,-0.45,1.82),scale=(1.3,1.3,1.3),translation=(3,-6.5,-2),
        children=[
        Inline(DEF='LoadNancy',url=["../HumanoidAnimation/NancyDiving.x3d","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/NancyDiving.x3d","../HumanoidAnimation/NancyDiving.wrl","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/NancyDiving.wrl"])]),
    ...
    LoadSensor(DEF='LoadExternal',
      children=[
      Inline(USE='LoadIntro')],
      children=[
      Inline(USE='LoadLefty')],
      children=[
      Inline(USE='LoadLucy')],
      children=[
      Inline(USE='LoadTank')],
      children=[
      Inline(USE='LoadFloor')],
      children=[
      Inline(USE='LoadSardine')],
      children=[
      Inline(USE='KelpExamplesNoBase')],
      children=[
      Inline(USE='LoadHalfMoon')],
      children=[
      Inline(USE='LoadRubberLip')],
      children=[
      Inline(USE='LoadStripedPerch')],
      children=[
      Inline(USE='LoadSeaStar')],
      children=[
      Inline(USE='LoadBlackPerch')],
      children=[
      Inline(USE='LoadSeaStar2')],
      children=[
      Inline(USE='LoadRockfish')],
      children=[
      Inline(USE='LoadPerch')],
      children=[
      Inline(USE='LoadGaribaldi')],
      children=[
      Inline(USE='LoadBass')],
      children=[
      Inline(USE='LoadNancy')]),
    Script(DEF='Display',url=["LoadSensorKelpForestMainScript.js","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/LoadSensorKelpForestMainScript.js"],
      field=[
      field(accessType='inputOnly',name='progress',type='SFFloat')]),
    ROUTE(fromField='progress',fromNode='LoadExternal',toField='progress',toNode='Display')])
) # X3D model complete
...
print ("python x3d.py load successful for LoadSensorKelpForestMain.py")

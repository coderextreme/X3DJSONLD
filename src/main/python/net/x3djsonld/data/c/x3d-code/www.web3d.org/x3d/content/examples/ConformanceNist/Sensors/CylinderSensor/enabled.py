...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    ...
    meta(content='Test the function of CylinderSensors field "enabled". An IndexedFaceSet geometry has an associated CylinderSensor node, with the "enabled" field set to false, and its rotation_changed field routed to the geometrys Transform node. As a result, despite the routing of the rotation_changed event from the CylinderSensor node, the geometry should not rotate when the pointing device is "dragged" over the geometry.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Sensors/CylinderSensor/enabled.x3d',name='identifier'),

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/Geospatial/HelloEarth.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    #  a simple Inline node is all that is needed for any scene to use X3D Earth assets 
    children=[
    WorldInfo(title='HelloEarth.x3d'),
...
print ("python x3d.py load successful for HelloEarth.py")

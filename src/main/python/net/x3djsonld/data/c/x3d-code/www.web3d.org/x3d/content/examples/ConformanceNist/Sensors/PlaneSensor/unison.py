  ...
  Scene=Scene(
    ...
    Group(
      ...
      Transform(DEF='MYBOX',
        ...
        PlaneSensor(DEF='BOXSENSOR',description='touch to drag'),
        Shape(
          appearance=Appearance(
            material=Material(diffuseColor=(1,1,0))),
          geometry=Box(),)])]),
    ROUTE(fromField='trackPoint_changed',fromNode='BOXSENSOR',toField='set_translation',toNode='MYBOX'),
...
print ("python x3d.py load successful for unison.py")

    ...
    Group(
      ...
      Transform(DEF='MYCYL',
        ...
        Shape(
          ...
          geometry=Cylinder(),)])]),
    ROUTE(fromField='trackPoint_changed',fromNode='CYLSENSOR',toField='set_translation',toNode='CYL_BALL')])
) # X3D model complete
...
print ("python x3d.py load successful for trackpoint_changed.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='XvlShellAttributeShellType.x3d',name='title'),
    meta(content='Examples of XvlShell shellType attribute values.',name='description'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/LatticeXvl/XvlShellAttributeShellType.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='XvlShellAttributeShellType.x3d'),
    ...
    Transform(translation=(0,1.5,0),
      ...
      Shape(
        ...
        geometry=Text(string=["XvlShell Shell Types"],
...
print ("python x3d.py load successful for XvlShellAttributeShellType.py")

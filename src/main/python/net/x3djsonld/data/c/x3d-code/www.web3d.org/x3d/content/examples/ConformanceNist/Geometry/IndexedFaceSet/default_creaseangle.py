...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='default_creaseangle.x3d',name='title'),
    meta(content='default-creaseangle-front.jpg',name='Image'),
    meta(content='default-creaseangle-rear.jpg',name='Image'),
    meta(content='default-creaseangle-top.jpg',name='Image'),
    meta(content='default-creaseangle-bottom.jpg',name='Image'),
    meta(content='default-creaseangle-left.jpg',name='Image'),
    meta(content='default-creaseangle-right.jpg',name='Image'),
    ...
    meta(content='This test uses the default value for the creaseAngle field for an IndexedFaceSet (Sphere). This value (0.0) will result in rendering a faceted figure along adjacent faces.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Geometry/IndexedFaceSet/default_creaseangle.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='default_creaseangle.x3d'),
...
print ("python x3d.py load successful for default_creaseangle.py")

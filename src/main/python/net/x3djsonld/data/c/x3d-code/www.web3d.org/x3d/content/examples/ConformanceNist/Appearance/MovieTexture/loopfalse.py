...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='loopfalse.x3d',name='title'),
    meta(content='loopfalse-movie.mpg',name='MovingImage'),
    ...
    meta(content='Test a loop value of false for MovieTexture. With the default loop field value set to false, a MovieTexture movie will only play once when started by clicking the now text. The VTS logo should revolve once, right to left, and stop.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/loopfalse.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='loopfalse.x3d'),
...
print ("python x3d.py load successful for loopfalse.py")

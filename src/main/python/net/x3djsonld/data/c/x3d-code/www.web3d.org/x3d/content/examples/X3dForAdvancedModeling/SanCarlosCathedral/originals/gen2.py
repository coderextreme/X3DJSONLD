      ...
      Transform(DEF='Presbiterio1Int',translation=(9.295,-2.135,-39.52),rotation=(0,1,0,-1.57),
        ...
        Shape(
          geometry=IndexedFaceSet(convex=False,coordIndex=[6,15,12,11,5,4,13,14,-1,7,8,12,11,-1],solid=False,
            coord=Coordinate(point=[(0,0,0),(3.05,0,0),(4.96,0,0),(6.4,0,0),(6.4,0,0.95),(4.96,0,0.95),(0,0,0.95),(4.96,2.71,0),(3.05,2.71,0),(6.4,7.73,0),(0,7.73,0),(4.96,2.51,0.95),(3.05,2.51,0.95),(6.4,7.73,0.95),(0,7.73,0.95),(3.05,0,0.95)])),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='Presbiterio1Est',translation=(9.2995,-2.135,-39.52),rotation=(0,1,0,-1.57),
        ...
        Shape(
          geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,8,7,2,3,9,10,-1],solid=False,
            coord=Coordinate(point=[(0,0,0),(3.05,0,0),(4.96,0,0),(6.4,0,0),(6.4,0,0.95),(4.96,0,0.95),(0,0,0.95),(4.96,2.51,0),(3.05,2.51,0),(6.4,7.73,0),(0,7.73,0),(4.96,2.51,0.95),(3.05,2.51,0.95),(6.4,7.73,0.95),(0,7.73,0.95),(3.05,0,0.95)])),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='Presbiterio2Int',translation=(0.03,-2.135,-39.52),rotation=(0,1,0,-1.57),
        children=[
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='Presbiterio2Est',translation=(0.03,-2.135,-39.52),rotation=(0,1,0,-1.57),
        children=[
        Shape(
    ...
    Transform(DEF='Retro',translation=(0.95,0,-8.623),
      ...
      Transform(DEF='Retro2Int',translation=(9.295,-2.135,-39.52),rotation=(0,1,0,3.14),
        ...
        Shape(
          geometry=IndexedFaceSet(convex=False,coordIndex=[5,11,10,4,-1,4,10,9,3,-1],solid=False,
            coord=Coordinate(point=[(0,0,0),(9.26,0,0),(9.26,0,-3.17),(8.31,0,-3.17),(8.31,0,-0.95),(0,0,-0.95),(0,7.73,0),(9.26,7.73,0),(9.26,7.73,-3.17),(8.31,7.73,-3.17),(8.31,7.73,-0.95),(0,7.73,-0.95)])),
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))]),
      Transform(DEF='Retro2Est',translation=(9.295,-2.135,-39.52),rotation=(0,1,0,3.14),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))])]),
    Transform(DEF='AbsideDX',translation=(18.67,0,-84.475),rotation=(0,1,0,3.14),
      children=[
      ...
      Transform(DEF='AbsideDXest',translation=(9.295,-2.135,-39.52),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))])]),
    Transform(DEF='Fronte',translation=(-3.12,-4.025,-5.599),
      children=[
      ...
      Transform(DEF='ArcoFronte2',translation=(8.738,7.415,-39.529),scale=(1.394,0.82,1),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))])]),
    Transform(DEF='AbsideSX',translation=(13.375,0,-84.475),rotation=(0,1,0,3.14),
      children=[
    ...
    Transform(DEF='PortaRetro',translation=(10.2473,-2.135,-45.612),
      ...
      Transform(DEF='terminexpor2',translation=(0,0,-1.633),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(1,0.75,0.25))))])]),
    Transform(DEF='FinestraA1',translation=(-7.43,1.95,-34.15),
      children=[

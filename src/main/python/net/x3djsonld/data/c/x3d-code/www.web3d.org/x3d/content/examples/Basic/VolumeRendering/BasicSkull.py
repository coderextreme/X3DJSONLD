...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='BasicSkull.x3d',name='title'),
    meta(content='Volume rendering of a CT scan of a skull, rendered with default (opacity map) render style',name='description'),
    ...
    meta(content='BasicSkull.x3d',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BasicSkull.x3d',name='identifier'),
  ...
  Scene=Scene(
    children=[
    WorldInfo(title='BasicSkull.x3d'),
    Group(
      children=[
      Viewpoint(DEF='VP',description='Basic Skull',orientation=(-0.675123,0.549845,0.491812,4.56937),position=(-0.294435,-0.11334,0.0508642)),
      Background(DEF='BG'),
...
print ("python x3d.py load successful for BasicSkull.py")

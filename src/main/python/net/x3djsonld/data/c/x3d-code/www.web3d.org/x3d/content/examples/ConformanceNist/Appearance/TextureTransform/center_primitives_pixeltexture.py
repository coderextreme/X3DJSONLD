...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='center_primitives_pixeltexture.x3d',name='title'),
    meta(content='center_primitives_pixeltexture-front.jpg',name='Image'),
    meta(content='center_primitives_pixeltexture-rear.jpg',name='Image'),
    meta(content='center_primitives_pixeltexture-top.jpg',name='Image'),
    meta(content='center_primitives_pixeltexture-bottom.jpg',name='Image'),
    meta(content='center_primitives_pixeltexture-left.jpg',name='Image'),
    meta(content='center_primitives_pixeltexture-right.jpg',name='Image'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(-2,-0.75,0),
      ...
      Shape(
        appearance=Appearance(
          ...
          textureTransform=TextureTransform(center=(0.33,0.33),rotation=1.57),
          material=Material(),),
        geometry=Sphere(radius=0.5))]),
    Transform(translation=(0,-0.75,0),
      ...
      Shape(
        appearance=Appearance(
          texture=PixelTexture(USE='PIXTEX'),
          textureTransform=TextureTransform(center=(0.5,0.5),rotation=1.57),
          material=Material(),),
        geometry=Sphere(radius=0.5))]),
    Transform(translation=(2,-0.75,0),
      children=[
      Shape(
        appearance=Appearance(
          texture=PixelTexture(USE='PIXTEX'),
          textureTransform=TextureTransform(center=(0.66,0.66),rotation=1.57),
          material=Material(),),
        geometry=Sphere(radius=0.5))]),
    Transform(translation=(4,-0.75,0),
      children=[
      Shape(
        appearance=Appearance(
          texture=PixelTexture(USE='PIXTEX'),
          textureTransform=TextureTransform(center=(1,1),rotation=1.57),
          material=Material(),),
        geometry=Sphere(radius=0.5))]),
...
print ("python x3d.py load successful for center_primitives_pixeltexture.py")

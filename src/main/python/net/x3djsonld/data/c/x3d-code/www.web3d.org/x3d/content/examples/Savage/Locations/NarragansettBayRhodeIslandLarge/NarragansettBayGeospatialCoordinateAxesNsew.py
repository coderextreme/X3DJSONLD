...
newModel=X3D(profile='Immersive',version='3.3',
  ...
  Scene=Scene(
    children=[
    Inline(DEF='NarragansettBayLarge',url=["NarragansettBayLarge.x3d","https://savage.nps.edu/Savage/Locations/NarragansettBayRhodeIslandLarge/NarragansettBayLarge.x3d"]),
    Group(
      children=[
      GeoLocation(geoCoords=(41.56722223554018,-71.30572987125981,0),
        children=[
        Transform(DEF='CoordinateAxes',scale=(3000,3000,3000),
          children=[

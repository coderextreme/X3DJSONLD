...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='TranslatedAv8bHarrier.x3d',name='title'),
    meta(content='Harrier Av8b, originally translated from web model authored by Soji Yamakawa and used as part of Saratoga carrier animation.',name='description'),
    meta(content='Soji Yamakawa',name='creator'),
    meta(content='Daniel Siew',name='translator'),
    meta(content='7 March 2001',name='created'),
    meta(content='21 October 2018',name='modified'),
    meta(content='http://ciel.me.cmu.edu/soji/aircraft/aircrafte.html',name='reference'),
    meta(content='../../ShipsMilitary/Carrier-UnitedStates-Saratoga/chapter.html',name='reference'),
    meta(content='https://savage.nps.edu/Savage/AircraftFixedWing/AV8bHarrierUnitedStates/TranslatedAv8bHarrier.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(rotation=(0,1,0,3.14),
      ...
      Shape(DEF='Cockpit',
        geometry=IndexedFaceSet(coordIndex=[9,300,10,-1,10,300,301,-1,16,17,112,302,-1,108,107,303,-1,301,304,305,306,-1,306,305,186,179,-1,304,307,257,305,-1,305,257,187,186,-1,301,306,10,-1,2,308,309,-1,302,112,307,304,-1,9,16,302,300,-1,300,302,304,301,-1,303,107,256,-1],creaseAngle=1.78,solid=False,
          coord=Coordinate(USE='BI_COORD')),
        appearance=Appearance(
...
print ("python x3d.py load successful for TranslatedAv8bHarrier.py")

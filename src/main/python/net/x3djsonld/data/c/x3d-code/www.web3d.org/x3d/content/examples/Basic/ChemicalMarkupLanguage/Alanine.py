...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='Alanine.x3d',name='title'),
    meta(content='Autogenerated version of Alanine.x3d scene produced from Alanine.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='Alanine.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/Alanine.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Alanine.x3d'),
    ...
    Viewpoint(description='Inspect Alanine',position=(0,2,20)),
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["Alanine: C3 H7 N O2"])])]),
      Transform(translation=(0,5,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["molecule weight: 89.09"])])]),
      Transform(translation=(0,4,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["melting point: 264"])])]),
      Transform(translation=(0,3,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["boiling point: 314"])])]),
      Transform(translation=(0,2,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["specific gravity: 1.42"])])])]),
    Group(
      children=[
      Transform(
        children=[
        ProtoInstance(DEF='alanine_a1',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.1133,2.7796,1.817))])]),
      Transform(
        children=[
        ProtoInstance(DEF='alanine_a2',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.0036,2.0206,1.1013))])]),
      Transform(
        children=[
        ProtoInstance(DEF='alanine_a3',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(1.964,0.5868,1.6215))])]),
      Transform(
        children=[
        ProtoInstance(DEF='alanine_a4',name='Nitrogen',
          fieldValue=[
          fieldValue(name='position',value=(0.7338,2.7669,1.2777))])]),
      Transform(
        children=[
        ProtoInstance(DEF='alanine_a5',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(4.1888,3.0708,1.0506))])]),
      Transform(
        children=[
        ProtoInstance(DEF='alanine_a6',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(3.171,3.1403,2.9781))])])]),
    Group(
      children=[
      ProtoInstance(DEF='alanine_b1',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.1133,2.7796,1.817),(2.0036,2.0206,1.1013)])]),
      ProtoInstance(DEF='alanine_b2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.1133,2.7796,1.817),(4.1888,3.0708,1.0506)])]),
      ProtoInstance(DEF='alanine_b3',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.0933,2.7796,1.817),(3.151,3.1403,2.9781)])]),
      ProtoInstance(DEF='alanine_b3_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.1333,2.7796,1.817),(3.191,3.1403,2.9781)])]),
      ProtoInstance(DEF='alanine_b4',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.0036,2.0206,1.1013),(1.964,0.5868,1.6215)])]),
      ProtoInstance(DEF='alanine_b5',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.0036,2.0206,1.1013),(0.7338,2.7669,1.2777)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for Alanine.py")

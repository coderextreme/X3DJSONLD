...
newModel=X3D(profile='Immersive',version='3.2',
  ...
  Scene=Scene(
    ...
    ProtoInstance(name='Vertex',
      fieldValue=[
      fieldValue(name='name',value='2010-01-15-ARMY.MIL'),
    ...
    ProtoInstance(name='Vertex',
      fieldValue=[
      fieldValue(name='name',value='2010-01-15-BLOGS.STATE.GOV-INDEX.PHP'),
    ...
    ProtoInstance(name='Vertex',
      fieldValue=[
      fieldValue(name='name',value='2010-01-15-FEEDS.FEEDBURNER.COM-DIPNOTE'),

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='indexedfaceset_texture_first.x3d',name='title'),
    meta(content='indexedfaceset_texture_first-front.jpg',name='Image'),
    ...
    meta(content='This world tests browser ability to choose a Material node texture field over the color field of an IndexedFaceSet if both are present. A browser should select a Material node texture field and generate the VTS logo texture on the cube faces. A solid green cube fails the test.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/Color/indexedfaceset_texture_first.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='indexedfaceset_texture_first.x3d'),
...
print ("python x3d.py load successful for indexedfaceset_texture_first.py")

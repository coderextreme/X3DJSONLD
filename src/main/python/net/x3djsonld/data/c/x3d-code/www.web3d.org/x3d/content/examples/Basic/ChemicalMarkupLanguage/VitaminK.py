...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='VitaminK.x3d',name='title'),
    meta(content='Autogenerated version of VitaminK.x3d scene produced from VitaminK.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='VitaminK.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/VitaminK.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='VitaminK.x3d'),
    ...
    Viewpoint(description='Inspect VitaminK',position=(0,2,20)),
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["Vitamin K: C6 H4 O2"])])]),
      Transform(translation=(0,5,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["molecule weight: 108.09"])])]),
      Transform(translation=(0,4,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["melting point: 115.7"])])]),
      Transform(translation=(0,3,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["boiling point: 293"])])]),
      Transform(translation=(0,2,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["specific gravity: 1.318"])])])]),
    Group(
      children=[
      Transform(
        children=[
        ProtoInstance(DEF='vitamin_k_a1',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(0.0,0.8435,1.207))])]),
      Transform(
        children=[
        ProtoInstance(DEF='vitamin_k_a2',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(1.0807,0.7866,1.764))])]),
      Transform(
        children=[
        ProtoInstance(DEF='vitamin_k_a3',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(1.2015,0.3731,3.1873))])]),
      Transform(
        children=[
        ProtoInstance(DEF='vitamin_k_a4',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.3417,1.1235,1.0512))])]),
      Transform(
        children=[
        ProtoInstance(DEF='vitamin_k_a5',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.3882,0.308,3.7965))])]),
      Transform(
        children=[
        ProtoInstance(DEF='vitamin_k_a6',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.5268,1.0604,1.6634))])]),
      Transform(
        children=[
        ProtoInstance(DEF='vitamin_k_a7',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.6493,0.6491,3.0867))])]),
      Transform(
        children=[
        ProtoInstance(DEF='vitamin_k_a8',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(4.7298,0.5952,3.6443))])])]),
    Group(
      children=[
      ProtoInstance(DEF='vitamin_k_b1',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(-0.02,0.8435,1.207),(1.0607,0.7866,1.764)])]),
      ProtoInstance(DEF='vitamin_k_b1_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(0.02,0.8435,1.207),(1.1007,0.7866,1.764)])]),
      ProtoInstance(DEF='vitamin_k_b2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.2015,0.3731,3.1873),(1.0807,0.7866,1.764)])]),
      ProtoInstance(DEF='vitamin_k_b3',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.0807,0.7866,1.764),(2.3417,1.1235,1.0512)])]),
      ProtoInstance(DEF='vitamin_k_b4',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.3682,0.308,3.7965),(1.1815,0.3731,3.1873)])]),
      ProtoInstance(DEF='vitamin_k_b4_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.4082,0.308,3.7965),(1.2215,0.3731,3.1873)])]),
      ProtoInstance(DEF='vitamin_k_b6',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.3217,1.1235,1.0512),(3.5068,1.0604,1.6634)])]),
      ProtoInstance(DEF='vitamin_k_b6_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.3617,1.1235,1.0512),(3.5468,1.0604,1.6634)])]),
      ProtoInstance(DEF='vitamin_k_b8',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.6493,0.6491,3.0867),(2.3882,0.308,3.7965)])]),
      ProtoInstance(DEF='vitamin_k_b10',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.5268,1.0604,1.6634),(3.6493,0.6491,3.0867)])]),
      ProtoInstance(DEF='vitamin_k_b12',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.6293,0.6491,3.0867),(4.7098,0.5952,3.6443)])]),
      ProtoInstance(DEF='vitamin_k_b12_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.6693000000000002,0.6491,3.0867),(4.7498,0.5952,3.6443)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for VitaminK.py")

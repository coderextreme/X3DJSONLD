        ...
        Transform(DEF='dad_DESRON31',rotation=(1,0,0,1.571),translation=(0,0,-.106),
          ...
          Shape(DEF='DESRON31',
            appearance=Appearance(
              texture=ImageTexture(repeatS=False,repeatT=False,url=["MIDPAC.jpg"
"https://savage.nps.edu/Savage/ModelDetailing/MilitaryCrestsAndSeals/CNSGMIDPAC/MIDPAC.jpg"]),
              textureTransform=TextureTransform(center=(-1.398,-.076),scale=(.885,.977),translation=(-.129,.013)),
...
print ("python x3d.py load successful for CNSGMIDPAC.py")

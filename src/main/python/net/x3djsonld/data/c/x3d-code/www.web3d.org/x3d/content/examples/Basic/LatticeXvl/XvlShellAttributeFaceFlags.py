...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='XvlShellAttributeFaceFlags.x3d',name='title'),
    meta(content='Examples of XvlShell faceEmpty and faceHidden attribute values.',name='description'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/LatticeXvl/XvlShellAttributeFaceFlags.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='XvlShellAttributeFaceFlags.x3d'),
    ...
    Transform(translation=(0,1.5,0),
      ...
      Shape(
        ...
        geometry=Text(string=["XvlShell Face Flags"],
    ...
    Transform(translation=(-3,-1,0),
      ...
      Transform(translation=(0,1.75,0),
        ...
        Shape(
          appearance=Appearance(
            material=Material(emissiveColor=(1,1,1))),
          geometry=Text(maxExtent=2,string=["No Flags"],
    ...
    Transform(translation=(0,-1,0),
      ...
      Transform(translation=(0,1.75,0),
        ...
        Shape(
          appearance=Appearance(
            material=Material(emissiveColor=(1,1,1))),
          geometry=Text(maxExtent=2,string=["Top Face Empty"],
            fontStyle=FontStyle(justify=["MIDDLE","MIDDLE"],size=0.5)))]),
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(.5,1,1))),
        geometry=XvlShell(faceCoordIndex=[3,7,6,2,-1,7,3,1,5,-1,6,4,0,2,-1,1,3,2,0,-1,5,1,0,4,-1,7,5,4,6,-1],faceEmpty=[True,False,False,False,False,False],shellType='LATTICE_MESH',
          coord=Coordinate(USE='MESH_COORD'))),
      Shape(
        appearance=Appearance(
          material=Material(emissiveColor=(1,1,1))),
    ...
    Transform(translation=(3,-1,0),
      ...
      Transform(translation=(0,1.75,0),
        ...
        Shape(
          appearance=Appearance(
            material=Material(emissiveColor=(1,1,1))),
          geometry=Text(maxExtent=2,string=["Top Face Hidden"],
            fontStyle=FontStyle(justify=["MIDDLE","MIDDLE"],size=0.5)))]),
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(.5,1,1))),
        geometry=XvlShell(faceCoordIndex=[3,7,6,2,-1,7,3,1,5,-1,6,4,0,2,-1,1,3,2,0,-1,5,1,0,4,-1,7,5,4,6,-1],faceHidden=[True,False,False,False,False,False],shellType='LATTICE_MESH',
          coord=Coordinate(USE='MESH_COORD'))),
      Shape(
        appearance=Appearance(
          material=Material(emissiveColor=(1,1,1))),
...
print ("python x3d.py load successful for XvlShellAttributeFaceFlags.py")

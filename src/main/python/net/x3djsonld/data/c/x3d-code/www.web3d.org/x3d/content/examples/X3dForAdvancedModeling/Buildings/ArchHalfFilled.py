...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    children=[
    meta(content='ArchHalfFilled.x3d',name='title'),
    meta(content='Create an half filled arch. Note it is a quarter cylinder. Parameters are: clearSpanWidth=4; riseHeight=2; depth=3p. clearSpanWidth measure refers to a full arc, consider clearSpanWidth/2 for the archHalfFilled width. Modify them with Transform scale or by editing the IndexedFileSet node. See the reference file ArchModelingDiagrams.pdf and the ArchScript_more_readable.js script to find further information.',name='description'),
...
print ("python x3d.py load successful for ArchHalfFilled.py")

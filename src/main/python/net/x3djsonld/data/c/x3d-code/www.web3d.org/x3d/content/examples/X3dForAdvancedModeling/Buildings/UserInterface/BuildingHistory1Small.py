...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='BuildingHistory1Small.x3d',name='title'),
    meta(content='User interface panel for architectural models - Example historic building inside the interface panel - Earlier age model 1',name='description'),
...
print ("python x3d.py load successful for BuildingHistory1Small.py")

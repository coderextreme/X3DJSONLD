...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='22 February 2016',name='modified'),
    meta(content='Project for VRML CVN Tower',name='description'),
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/Bridge.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(rotation=(0,0,1,1.571),scale=(0.6,0.6,0.6),translation=(-5,5,-15),
      ...
      Transform(rotation=(0,1,0,1.571),
        children=[
        Inline(url=["CaptainSeat.x3d","https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/CaptainSeat.x3d","CaptainSeat.wrl","https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/CaptainSeat.wrl"])])]),
    #  "Navigator's Desk" 
    Transform(rotation=(0,0,1,1.571),scale=(0.6,0.6,0.6),translation=(3,4.45,-15),
      children=[
      Transform(rotation=(0,1,0,1.571),
        children=[
        Inline(url=["NavigatorTable.x3d","https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/NavigatorTable.x3d","NavigatorTable.wrl","https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/NavigatorTable.wrl"])])]),
    #  "Main Door to Bridge" 
    Transform(rotation=(1,0,0,1.571),scale=(0.56,0.56,0.56),translation=(-5,4.7,-12.25),
      children=[
      Transform(rotation=(1,0,0,3.142),
        children=[
        Inline(url=["Door.x3d","https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/Door.x3d","Door.wrl","https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/Door.wrl"])])]),
    #  MainStructure 

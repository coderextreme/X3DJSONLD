...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='single_elevation_face_normals.x3d',name='title'),
    meta(content='single_elevation_face_normals-front.jpg',name='Image'),
    meta(content='single_elevation_face_normals-rear.jpg',name='Image'),
    meta(content='single_elevation_face_normals-top.jpg',name='Image'),
    meta(content='single_elevation_face_normals-bottom.jpg',name='Image'),
    meta(content='single_elevation_face_normals-left.jpg',name='Image'),
    meta(content='single_elevation_face_normals-right.jpg',name='Image'),
    ...
    meta(content='Test of browser ability to generate normals to faces for an ElevationGrid geometry. The ElevationGrid has an upward (+Y) perpendicular normal applied to all faces of this ElevationGrid. The result is a figure that is illuminated when viewed from the top or bottom, but is not illuminated when viewed from any side.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/Normal/single_elevation_face_normals.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='single_elevation_face_normals.x3d'),
...
print ("python x3d.py load successful for single_elevation_face_normals.py")

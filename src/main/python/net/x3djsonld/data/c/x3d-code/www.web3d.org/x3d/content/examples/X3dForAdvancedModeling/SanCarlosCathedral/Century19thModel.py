...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='Century19thModel.x3d',name='title'),
    ...
    meta(content='https://x3dgraphics.com/examples/X3dForAdvancedModeling/SanCarlosCathedral/Century19thModel.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Century19thModel.x3d'),
    Transform(DEF='Transform',scale=(0.1,0.1,0.1),
      ...
      Transform(DEF='scalinoq',translation=(5.8,-2,-26.5),
        children=[
        Shape(
          geometry=Box(size=(7.3,0.2,9)),
          appearance=Appearance(
            material=Material(USE='SandStone')))]),
      Transform(DEF='scalinoq2',translation=(5.8,-1.85,-28.5),
        children=[
        Shape(
      ...
      #  Enter any text between the end tags <Transform DEF='TramezzoSX' translation='3.365 0.68 -2.1'> <Shape> <Box size='2.35 2.63 0.22'/> <Appearance> <Material USE="SandStone"/> </Appearance> </Shape> </Transform> 
      ...
      Group(DEF='STEC',
        ...
        Group(DEF='STec',
          ...
          Group(DEF='stec',
            ...
            Transform(DEF='steccato1',translation=(-3.8,-1.2,-12.3),
              ...
              Shape(
                ...
                appearance=Appearance(
                  material=Material(USE='SandStone')))])]),
          Transform(DEF='steccato2333',translation=(0.15,0,0),
            children=[
            Group(USE='stec')]),
          Transform(DEF='steccato3',translation=(0.3,0,0),
            children=[
            Group(USE='stec')]),
          ...
          Transform(DEF='steccato8',translation=(1.05,0,0),
            children=[
            Group(USE='stec')]),
          Transform(DEF='steccato9',translation=(1.2,0,0),
            children=[
            Group(USE='stec')]),
          Transform(DEF='steccato10',translation=(1.35,0,0),
            children=[
            Group(USE='stec')]),
          Transform(DEF='steccato11',translation=(1.5,0,0),
            children=[
            Group(USE='stec')]),
          Transform(DEF='steccato12',translation=(1.65,0,0),
            children=[
            Group(USE='stec')])]),
        Transform(DEF='steccato2',translation=(1.65,0,0),
          children=[
          Group(USE='STec')]),
        Transform(DEF='steccato21',translation=(2.7,0,0),
          children=[
          Group(USE='STec')])]),
      Transform(DEF='steccato31',rotation=(0,1,0,1.57),translation=(8.4,0,-16.1),
        children=[
        Group(USE='STEC')]),
      Transform(DEF='steccato32',rotation=(0,1,0,1.57),translation=(8.4,0,-17),
        children=[
        Group(USE='STEC')]),
      ...
      Group(DEF='stecOrizz',
        children=[
        Transform(DEF='steccatOrizzr',translation=(-1.5,-1.7,-12.3),
          children=[
          Shape(
            geometry=Box(size=(4.5,0.07,0.04)),
            appearance=Appearance(
              material=Material(USE='SandStone')))])]),
      Transform(DEF='steccatOrizz2r',translation=(0,1,0),
        children=[
        Group(USE='stecOrizz')]),
      Group(DEF='stecOrizz2',
        children=[
        Transform(DEF='steccatOrizz24r',rotation=(0,1,0,1.57),translation=(-3.902,-1.7,-14.95),
          children=[
          Shape(
            geometry=Box(size=(5.3,0.07,0.04)),
            appearance=Appearance(
              material=Material(USE='SandStone')))])]),
      Transform(DEF='steccatOrizz224r',translation=(0,1,0),
        children=[
        Group(USE='stecOrizz2')]),
      Group(DEF='stecOrizz3',
        children=[
        Transform(DEF='steccatOrizzrr',translation=(-2.15,-1.7,-17.6),
          children=[
          Shape(
            geometry=Box(size=(3.3,0.07,0.04)),
            appearance=Appearance(
              material=Material(USE='SandStone')))])]),
      Transform(DEF='steccatOrizz32rr',translation=(0,1,0),
        children=[
...
print ("python x3d.py load successful for Century19thModel.py")

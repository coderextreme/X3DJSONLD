...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='TextureLocalGaribaldi.x3d',name='title'),
    meta(content='Instantiate the Garibaldi fish prototype using a local texture file.',name='description'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/TextureLocalGaribaldi.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='TextureLocalGaribaldi.x3d'),
    ...
    Viewpoint(description='Garibaldi',orientation=(0,1,0,0.42),position=(0.66,0,0.42)),
...
print ("python x3d.py load successful for TextureLocalGaribaldi.py")

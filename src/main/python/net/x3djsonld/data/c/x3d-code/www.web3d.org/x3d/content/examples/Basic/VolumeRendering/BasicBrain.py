...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='BasicBrain.x3d',name='title'),
    meta(content='Volume rendering of a brain MR image, rendered with default (opacityMapped) style',name='description'),
    ...
    meta(content='basicBrain.x3d',name='reference'),
    meta(content='get brain2.nrrd on savage server',name='TODO'),
    meta(content='README.txt',name='reference'),
    meta(content='Get prerequisite dataset, http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/brain2.nrrd',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/BasicBrain.x3d',name='identifier'),
  ...
  Scene=Scene(
    children=[
    WorldInfo(title='BasicBrain.x3d'),
    Group(
      children=[
...
print ("python x3d.py load successful for BasicBrain.py")

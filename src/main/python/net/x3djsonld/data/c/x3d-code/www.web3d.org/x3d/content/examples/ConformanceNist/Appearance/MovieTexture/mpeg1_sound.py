    ...
    Group(
      ...
      Transform(translation=(-2,0,0),
        ...
        Shape(
          ...
          geometry=Text(string=["Play mpeg1 audio"],
            fontStyle=FontStyle(style_='BOLD'))),
        Sound(maxBack=100,maxFront=100,
          source=MovieTexture(DEF='Movie',description='VTS spinning logo, voice',loop=True,url=["mpgsys.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpgsys.mpg"]))]),
...
print ("python x3d.py load successful for mpeg1_sound.py")

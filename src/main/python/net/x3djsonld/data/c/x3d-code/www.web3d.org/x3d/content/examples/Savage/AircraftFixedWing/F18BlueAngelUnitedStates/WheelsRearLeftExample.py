...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='WheelsRearLeftExample.x3d',name='title'),
    meta(content='An animation example of rear left wheels and axle Prototype. Clicking the axle triggers an animation for gear to go up or gear down on rear left wheels and axle.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearLeftExample.x3d',name='identifier'),
    meta(content="rear wheels' animation, gear up and down",name='subject'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    ExternProtoDeclare(name='WheelsRearLeft',url=["WheelsRearLeftPrototype.x3d#WheelsRearLeft","https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearLeftPrototype.x3d#WheelsRearLeft","WheelsRearLeftPrototype.wrl#WheelsRearLeft","https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearLeftPrototype.wrl#WheelsRearLeft"],
      field=[
    ...
    Group(
      ...
      ProtoInstance(DEF='WP',name='WheelsRearLeft',
        fieldValue=[
...
print ("python x3d.py load successful for WheelsRearLeftExample.py")

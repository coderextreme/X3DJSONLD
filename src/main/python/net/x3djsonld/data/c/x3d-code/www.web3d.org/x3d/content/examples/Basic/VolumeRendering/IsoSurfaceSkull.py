...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='IsoSurfaceSkull.x3d',name='title'),
    meta(content='Volume rendering of a CT scan of a skull, rendered as an isosurface with cartoon render style',name='description'),
    ...
    meta(content='IsoSurfaceSkull.x3d',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/VolumeRendering/IsoSurfaceSkull.x3d',name='identifier'),
  ...
  Scene=Scene(
    children=[
    WorldInfo(title='IsoSurfaceSkull.x3d'),
    Group(
      children=[
      Viewpoint(DEF='VP',description='IsoSurface Skull',orientation=(-0.675123,0.549845,0.491812,4.56937),position=(-0.294435,-0.11334,0.0508642)),
      Background(DEF='BG'),
      Transform(scale=(0.117188,0.117188,0.117188),
        ...
        IsoSurfaceVolumeData(dimensions=(1.28,1.28,1.28),surfaceValues=[.15],
          ...
          voxels=ImageTexture3D(url=["datasets/nrrd/skull.nrrd","http://snoid.sv.vt.edu/medical/X3DVolumes/examples/datasets/nrrd/skull.nrd","https://savage.nps.edu/Savage/VolumeRendering/datasets/nrrd/skull.nrd"]))])])])
) # X3D model complete
...
print ("python x3d.py load successful for IsoSurfaceSkull.py")

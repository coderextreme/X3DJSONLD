...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/DirectionalLight/test_red_on_blue.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    PointLight(on=False),
    DirectionalLight(DEF='the-light',color=(1,0,0)),

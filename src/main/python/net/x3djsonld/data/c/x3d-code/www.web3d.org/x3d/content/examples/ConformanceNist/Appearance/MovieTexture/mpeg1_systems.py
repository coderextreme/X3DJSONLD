      ...
      Transform(DEF='Cube',
        ...
        Shape(
          appearance=Appearance(
            material=Material(),
            texture=MovieTexture(DEF='Movie',description='VRML Test Suite movie',loop=True,url=["mpgsys.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/mpgsys.mpg"])),
          geometry=Box(),)]),
      Sound(maxBack=100,maxFront=100,
        source=MovieTexture(USE='Movie'))]),
    Group(
      children=[
...
print ("python x3d.py load successful for mpeg1_systems.py")

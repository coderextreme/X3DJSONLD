...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='PortStick.x3d',name='title'),
    meta(content='Selcuk OZTURK',name='creator'),
    meta(content='Port control stick.',name='description'),
    meta(content='6 September 2002',name='created'),
    meta(content='22 December 2014',name='modified'),
    meta(content='https://savage.nps.edu/Savage/AircraftMiscellaneous/Zeppelin/PortStick.x3d',name='identifier'),
...
print ("python x3d.py load successful for PortStick.py")

...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='CollisionKelpForestMain.x3d',name='title'),
    meta(content='Disabled collision with all objects with a Collision node in the Kelp Forest world.',name='description'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/CollisionKelpForestMain.x3d',name='identifier'),
  ...
  Scene=Scene(
      ...
      Transform(translation=(0,-3.5,-2),
        ...
        Shape(
          appearance=Appearance(
            material=Material(diffuseColor=(1,.5,0),transparency=.9)),
          geometry=Box(size=(20,11,11)))])]),
    ...
    Group(DEF='Root',
      ...
      Fog(color=(.8,.8,.8),visibilityRange=60),
      ...
      Collision(enabled=False,
        ...
        Transform(DEF='K2_LOCALE',translation=(-4.0,0.0,1.0),
          ...
          Transform(DEF='K2_MIDWATER',scale=(0.2,0.2,0.2),translation=(-1.0,-4.0,-4.0),
            children=[
            Inline(url=["../KelpForestExhibit/SardineSchool.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SardineSchool.x3d","../KelpForestExhibit/SardineSchool.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SardineSchool.wrl"])]),
    ...
    Group(DEF='Nancy',
      ...
      Transform(DEF='NancyTransform',rotation=(-0.45,0.77,-0.45,1.82),scale=(1.3,1.3,1.3),translation=(3,-6.5,-2),
        children=[
        Inline(url=["../../Basic/HumanoidAnimation/NancyDiving.x3d","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/NancyDiving.x3d","../../Basic/HumanoidAnimation/NancyDiving.wrl","https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/NancyDiving.wrl"])]),
...
print ("python x3d.py load successful for CollisionKelpForestMain.py")

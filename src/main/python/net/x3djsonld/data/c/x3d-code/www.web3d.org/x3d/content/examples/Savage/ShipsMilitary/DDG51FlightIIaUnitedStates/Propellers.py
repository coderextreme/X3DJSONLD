...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Propellers.x3d',name='title'),
    meta(content='DDG-51 Arleigh Burke Flight IIA propellers and shafts modified from from DDG-51 Arleigh Burke form Savage DB.',name='description'),
    meta(content='James Harney Modified for use on DDG-51 Flight IIA by LT Joe Sears, USN',name='creator'),
    meta(content='1 August 2001',name='created'),
    meta(content='modified 8 August 2003 by LT Joe Sears for DDG-51FlightIIA',name='info'),
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/DDGArleighBurkeUnitedStates/Propellers.x3d',name='identifier'),
...
print ("python x3d.py load successful for Propellers.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='default_type.x3d',name='title'),
    meta(content='default_type-movie.mpg',name='MovingImage'),
    ...
    meta(content='Test default type. A NavigationInfo node with a default "type" field exists in this world. As a result, a type of [WALK,ANY] should be used as the navigation mode. The type of navigation should appear at the top of the world as Text, and the navigation through the world should be a "walking" type experience. Collision detection must be supported. To test collision support, the Box geometry collides with the viewer avatar. The Box should turn red upon collision, showing that collision detection between a moving geometry, and a stationary avatar is supported. In addition, the viewer should be able to navigate toward the Box geometry in a "walking" type of motion, and collide with the Box geometry. This should also cause the Box to turn red, indicating that collision detection between a stationary geometry and a moving (navigating) avatar is supported.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/default_type.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='default_type.x3d'),
...
print ("python x3d.py load successful for default_type.py")

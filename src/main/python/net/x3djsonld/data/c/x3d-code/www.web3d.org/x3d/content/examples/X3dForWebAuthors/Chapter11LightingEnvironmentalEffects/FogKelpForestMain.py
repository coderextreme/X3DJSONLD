...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='FogKelpForestMain.x3d',name='title'),
    meta(content='Added fog to the KelpForest world to simulate the typical weather pattern in June in Monterey, CA.',name='description'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/FogKelpForestMain.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(DEF='Nancy',
      ...
      Transform(DEF='NancyTransform',rotation=(-0.45,0.77,-0.45,1.82),scale=(1.3,1.3,1.3),translation=(3,-6.5,-2),
        children=[
        Inline(url=["../../Basic/HumanoidAnimation/NancyDiving.x3d","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/NancyDiving.x3d","../../Basic/HumanoidAnimation/NancyDiving.wrl","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/NancyDiving.wrl"])]),
...
print ("python x3d.py load successful for FogKelpForestMain.py")

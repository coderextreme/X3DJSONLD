...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='rotation_primitives_movietexture.x3d',name='title'),
    meta(content='rotation_primitives_movietexture-front.jpg',name='Image'),
    meta(content='rotation_primitives_movietexture-rear.jpg',name='Image'),
    meta(content='rotation_primitives_movietexture-top.jpg',name='Image'),
    meta(content='rotation_primitives_movietexture-bottom.jpg',name='Image'),
    meta(content='rotation_primitives_movietexture-left.jpg',name='Image'),
    meta(content='rotation_primitives_movietexture-right.jpg',name='Image'),
...
print ("python x3d.py load successful for rotation_primitives_movietexture.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='Test bboxSize parsing only. A Group node with a Shape node (IndexedFaceSet geometry) as a child is defined in the local coordinate system. A bboxSize of 2 2 2 and a bboxCenter of 0 0 0 is given to the Group node. The browser should parse the Group node without error and display the IndexedFaceSet',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Group/test_bboxsizesame.x3d',name='identifier'),

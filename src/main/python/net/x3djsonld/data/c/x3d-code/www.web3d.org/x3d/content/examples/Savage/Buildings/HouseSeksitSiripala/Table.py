...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='Round table',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/Buildings/HouseSeksitSiripala/Table.x3d',name='identifier'),

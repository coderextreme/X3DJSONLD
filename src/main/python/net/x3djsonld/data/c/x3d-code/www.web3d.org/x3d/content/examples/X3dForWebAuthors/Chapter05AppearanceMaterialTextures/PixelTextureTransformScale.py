...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/PixelTextureTransformScale.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='PixelTextureTransformScale.x3d'),
    ...
    Transform(
      ...
      Shape(
        appearance=Appearance(
          texture=PixelTexture(image=[2,2,1,0xcc,0x00,0x00,0xcc]),
...
print ("python x3d.py load successful for PixelTextureTransformScale.py")

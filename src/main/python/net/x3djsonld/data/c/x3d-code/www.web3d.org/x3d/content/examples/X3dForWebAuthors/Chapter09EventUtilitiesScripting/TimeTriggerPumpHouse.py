...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    children=[
    meta(content='TimeTriggerPumpHouse.x3d',name='title'),
    meta(content='Pump house animation activated by a TimeTrigger node.',name='description'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/TimeTriggerPumpHouse.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ROUTE(fromField='triggerTime',fromNode='Filter',toField='startTime',toNode='PistonClock'),
...
print ("python x3d.py load successful for TimeTriggerPumpHouse.py")

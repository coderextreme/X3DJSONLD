...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='ElevationGridPNG.x3d',name='title'),
    meta(content='ElevationGridPNG-front.jpg',name='Image'),
    meta(content='ElevationGridPNG-rear.jpg',name='Image'),
    meta(content='ElevationGridPNG-top.jpg',name='Image'),
    meta(content='ElevationGridPNG-bottom.jpg',name='Image'),
    meta(content='ElevationGridPNG-left.jpg',name='Image'),
    meta(content='ElevationGridPNG-right.jpg',name='Image'),
    ...
    meta(content='Map a PNG image to an ElevationGrid. An ElevationGrid is default texture mapped by aligning the S (horizontal) axis of the VTS logo with the X axis of the ElevationGrid and the T (vertical) axis of the VTS logo with the Z axis of the ElevationGrid. The bottom of the VTS logo coincides with the first row of grid points and the top of the VTS logo maps to the last row of grid points',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/ImageTexture/ElevationGridPNG.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='ElevationGridPNG.x3d'),
...
print ("python x3d.py load successful for ElevationGridPNG.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  ...
  Scene=Scene(
    ...
    Viewpoint(DEF='OUTSIDEMAXFRONT',description='FRONT: Outside max ellipsoid (no sound)',position=(0,0,50)),
    Viewpoint(DEF='JUSTOUTSIDEMAXFRONT',description='Just outside max ellipsoid (no sound)',position=(0,0,-5.9)),
    Viewpoint(DEF='BETWEENFRONT',description='Midway between max and min ellipsoids, (max sound -10dB)',position=(0,0,-8)),
    Viewpoint(DEF='MINFRONT',description='At min ellipsoid, (max sound volume)',position=(0,0,-9.6)),
    Viewpoint(DEF='MINCENTERFRONT',description='Center of both ellipsoids, (max sound volume)',position=(0,0,-10)),
    Viewpoint(DEF='OUTSIDEMAXRIGHT',description='RIGHT: Outside max ellipsoid, (no sound)',orientation=(0,1,0,1.57),position=(50,0,-10)),
    Viewpoint(DEF='JUSTOUTSIDEMAXRIGHT',description='Just outside max ellipsoid, (no sound)',orientation=(0,1,0,1.57),position=(17.6,0,-10)),
    Viewpoint(DEF='BETWEENRIGHT',description='Midway between ellipsoids (max sound -10dB)',orientation=(0,1,0,1.57),position=(9.625,0,-10)),
    Viewpoint(DEF='MINRIGHT',description='At min ellipsoid (max sound)',orientation=(0,1,0,1.57),position=(1.75,0,-10)),
    Viewpoint(DEF='MINCENTERRIGHT',description='At center of both ellipsoids, (max sound volume)',orientation=(0,1,0,1.57),position=(0,0,-10)),
    Viewpoint(DEF='OUTSIDEMAXREAR',description='REAR: Outside max ellipsoid (no sound)',orientation=(0,1,0,3.14),position=(0,0,-50)),
    Viewpoint(DEF='JUSTOUTSIDEMAXREAR',description='Just outside max ellipsoid (no sound)',orientation=(0,1,0,3.14),position=(0,0,-14.1)),
    Viewpoint(DEF='BETWEENREAR',description='Midway between max and min ellipsoids, (max sound -10dB)',orientation=(0,1,0,3.14),position=(0,0,-12.2)),
    Viewpoint(DEF='MINREAR',description='At min ellipsoid, (max sound volume)',orientation=(0,1,0,3.14),position=(0,0,-10.4)),
    Viewpoint(DEF='MINCENTERREAR',description='Center of bot ellipsoids, (max sound volume)',orientation=(0,1,0,3.14),position=(0,0,-10)),
    Viewpoint(DEF='OUTSIDEMAXLEFT',description='LEFT: Outside max ellipsoid, (no sound)',orientation=(0,1,0,-1.57),position=(-50,0,-10)),
    Viewpoint(DEF='JUSTOUTSIDEMAXLEFT',description='Just outside max ellipsoid, (no sound)',orientation=(0,1,0,-1.57),position=(-17.6,0,-10)),
    Viewpoint(DEF='BETWEENLEFT',description='Midway between ellipsoids (max sound -10dB)',orientation=(0,1,0,-1.57),position=(-9.625,0,-10)),
    Viewpoint(DEF='MINLEFT',description='At min ellipsoid (max sound)',orientation=(0,1,0,-1.57),position=(-1.75,0,-10)),
    Viewpoint(DEF='MINCENTERLEFT',description='At ellipsoid center, (max sound volume)',orientation=(0,1,0,-1.57),position=(0,0,-10)),
    Viewpoint(DEF='OUTSIDEMAXTOP',description='TOP: Outside max ellipsoid, (no sound)',orientation=(1,0,0,-1.57),position=(0,50,-10)),
    Viewpoint(DEF='JUSTOUTSIDEMAXTOP',description='Just outside max ellipsoid, (no sound)',orientation=(1,0,0,-1.57),position=(0,4.1,-10)),
    Viewpoint(DEF='BETWEENTOP',description='Midway between ellipsoids (max sound -10dB)',orientation=(1,0,0,-1.57),position=(0,2.2,-10)),
    Viewpoint(DEF='MINTOP',description='At min ellipsoid (max sound)',orientation=(1,0,0,-1.57),position=(0,0.4,-10)),
    Viewpoint(DEF='MINCENTERTOP',description='At ellipsoid center, (max sound volume)',orientation=(1,0,0,-1.57),position=(0,0,-10)),
    Viewpoint(DEF='OUTSIDEMAXBOTTOM',description='BOTTOM: Outside max ellipsoid, (no sound)',orientation=(1,0,0,1.57),position=(0,-50,-10)),
    Viewpoint(DEF='JUSTOUTSIDEMAXBOTTOM',description='Just outside max ellipsoid, (no sound)',orientation=(1,0,0,1.57),position=(0,-4.1,-10)),
    Viewpoint(DEF='BETWEENBOTTOM',description='Midway between ellipsoids (max sound -10dB)',orientation=(1,0,0,1.57),position=(0,-2.2,-10)),
    Viewpoint(DEF='MINBOTTOM',description='At min ellipsoid (max sound)',orientation=(1,0,0,1.57),position=(0,-0.4,-10)),
    Viewpoint(DEF='MINCENTERBOTTOM',description='At ellipsoid center, (max sound volume)',orientation=(1,0,0,1.57),position=(0,0,-10)),
    Transform(DEF='TRANS3',rotation=(0,1,0,1.57),scale=(0.4,0.4,1.75),translation=(0,0,-10),
      children=[
      Sound(DEF='MYSOUND',
    ...
    Script(DEF='AVATARSCRIPT',directOutput=True,url=["hierarchy.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/Sounds/Sound/hierarchy.js"],
      field=[

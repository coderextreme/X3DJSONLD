...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/Tools/Authoring/GridYZ_20x20Fixed.x3d',name='identifier'),
        ...
        Billboard(
          ...
          Shape(
            ...
            appearance=Appearance(DEF='DefaultAppearance',
              material=Material(),))])]),
      Transform(translation=(0,10.2,10),
        children=[
        Billboard(
          children=[
          Shape(
            geometry=Text(string=["0 10 10"],
...
print ("python x3d.py load successful for GridYZ_20x20Fixed.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_ambientsim.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    SpotLight(DEF='the-light',beamWidth=1.57079,cutOffAngle=1.57079,intensity=0.6,location=(0,0,10),radius=50),

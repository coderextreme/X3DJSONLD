...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='This file defines an MFD screen that is inlined to create the cockpit console of a helicopter',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/MfdScreen.x3d',name='identifier'),
    meta(content='JT-62-2.JPG',name='Image'),
    meta(content='JM1-3.JPG',name='Image'),
    meta(content='MFD.JPG',name='Image'),
    meta(content='50CAL.WAV',name='sound'),
  ...
  Scene=Scene(
        ...
        Switch(DEF='MFD_SCREEN',whichChoice=3,
          ...
          Shape(
            appearance=Appearance(
              ...
              texture=ImageTexture(url=["JT-62-2.JPG","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/JT-62-2.JPG"])),
            geometry=IndexedFaceSet(USE='MFD_GEOMETRY')),
          Shape(
            appearance=Appearance(
              material=Material(USE='GREEN_COLOR'),
              texture=ImageTexture(url=["JM1-3.JPG","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/JM1-3.JPG"])),
            geometry=IndexedFaceSet(USE='MFD_GEOMETRY')),
          Shape(
            appearance=Appearance(
              material=Material(USE='GREEN_COLOR'),
              texture=ImageTexture(url=["MFD.JPG","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/MFD.JPG"])),
            geometry=IndexedFaceSet(USE='MFD_GEOMETRY'))])]),
      Switch(DEF='FIFTY_CAL_SOUND',whichChoice=-1,
        children=[
        Sound(
          source=AudioClip(description='50 caliber machine gun',loop=True,url=["50CAL.WAV","https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/50CAL.WAV"]))]),
    ...
    Script(DEF='FiftyCalOnOffToggle',
      field=[
      field(accessType='initializeOnly',name='value',type='SFInt32',value=-1),
      field(accessType='inputOnly',name='set_boolean',type='SFBool'),
      field(accessType='outputOnly',name='value_changed',type='SFInt32')]),

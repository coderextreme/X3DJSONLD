...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_ambientsim.x3d',name='title'),
    meta(content='test-ambientsim-movie.mpg',name='MovingImage'),
  ...
  Scene=Scene(
    ...
    Transform(scale=(0.02,0.02,0.02),translation=(-2.3,2,0),
      children=[
      Shape(
    ...
    ScalarInterpolator(DEF='the-ambient',key=[0.1,0.2,0.4,0.6,0.8,1],keyValue=[0,0.2,0.4,0.6,0.8,1]),
    ColorInterpolator(key=[0,0.5,1],keyValue=[(0,0,1),(1,1,1),(0,0,1)]),
    Group(
      children=[
      DirectionalLight(DEF='the-light',intensity=0.5),
...
print ("python x3d.py load successful for test_ambientsim.py")

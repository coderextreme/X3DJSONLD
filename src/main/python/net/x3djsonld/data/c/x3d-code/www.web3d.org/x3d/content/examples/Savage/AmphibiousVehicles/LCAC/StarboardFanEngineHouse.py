...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='StarboardFanEngineHouse.x3d',name='title'),
    meta(content='Starboard Engine House for the LCAC',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AmphibiousVehicles/LCAC/StarboardFanEngineHouse.x3d',name='identifier'),
    meta(content='LCAC Starboard Fan Engine House',name='subject'),
  ...
  Scene=Scene(
    ...
    Group(DEF='ForwardCover',
      ...
      Transform(
        ...
        Transform(DEF='Outside',
          ...
          Shape(
            ...
            geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,4,5,6,7,-1],solid=False,
              coord=Coordinate(point=[(0,0,0),(-4,0,0),(-4,1.25,0),(1,1.25,0),(1,3,0),(4,3,0),(4,0,0),(0,0,0)]))),
          Transform(DEF='RailingWall',
            ...
            Shape(
              ...
              geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,4,-1],solid=False,
                coord=Coordinate(point=[(-4,0,-0.1),(-4,1.25,-0.1),(-2,1.25,-0.1),(-2,0,-0.1),(-4,0,-0.1)])))]),
          Transform(DEF='TopRailingWall',
            ...
            Shape(
              appearance=Appearance(
                material=Material(),),
              geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,4,-1],solid=False,
                coord=Coordinate(point=[(-4,1.25,-0.1),(-4,1.25,0),(-2,1.25,0),(-2,1.25,-0.1),(-4,1.25,-0.1)])))]),
          Transform(DEF='EndRailingWall',
            ...
            Shape(
              appearance=Appearance(
                material=Material(),),
              geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,4,-1],solid=False,
                coord=Coordinate(point=[(-4,1.25,-0.1),(-4,1.25,0),(-4,0,0),(-4,0,-0.1),(-4,1.25,-0.1)])))])]),
        Transform(DEF='Inside',
          ...
          Shape(
            appearance=Appearance(
              material=Material(),),
            geometry=IndexedFaceSet(convex=False,coordIndex=[0,1,2,3,4,5,6,7,-1],solid=False,
              coord=Coordinate(point=[(0,0,-2.5),(-2,0,-2.5),(-2,1.25,-2.5),(1,1.25,-2.5),(1,3,-2.5),(4,3,-2.5),(4,0,-2.5),(0,0,-2.5)])))]),
        ...
        Transform(DEF='Posts',
          children=[
          Transform(translation=(-4,0.625,-0.05),
            children=[
            Shape(
              appearance=Appearance(
                material=Material(diffuseColor=(0.4,0.5,0.5))),
              geometry=Cylinder(height=1.26,radius=0.075))]),
          Transform(translation=(-3,0.625,-0.05),
            children=[
            Shape(
              appearance=Appearance(
                material=Material(diffuseColor=(0.4,0.5,0.5))),
              geometry=Cylinder(height=1.26,radius=0.075))]),
          Transform(translation=(-2.1,0.625,-0.05),
            children=[
            Shape(
              appearance=Appearance(
                material=Material(diffuseColor=(0.4,0.5,0.5))),
    ...
    Group(DEF='Stacks',
      children=[
      Transform(DEF='ExhaustStack',rotation=(0,-1,0,1.57),translation=(1.5,3,-0.5),
        children=[
      ...
      Transform(translation=(3.66,3.167,-1.75),
        children=[
        Shape(
    ...
    Transform(DEF='RearBoxOfUnknownUse',rotation=(0,1,0,3.14),translation=(-2.5,1,-1.5),
      children=[
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(0.425,0.425,0.45),shininess=1,specularColor=(0.85,0.85,0.9))),
      ...
      Transform(rotation=(0,0,1,1.57),translation=(0,1.25,0.45),
        ...
        Shape(
          ...
          appearance=Appearance(
            material=Material(diffuseColor=(0.625,0.625,0.75),shininess=1,specularColor=(0.85,0.85,0.9))))])])])
) # X3D model complete
...
print ("python x3d.py load successful for StarboardFanEngineHouse.py")

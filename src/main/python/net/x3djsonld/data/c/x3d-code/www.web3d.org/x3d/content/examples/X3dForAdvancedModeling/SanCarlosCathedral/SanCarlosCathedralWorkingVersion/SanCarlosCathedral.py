...
newModel=X3D(profile='Immersive',version='3.3',
  ...
  Scene=Scene(
    ...
    Switch(DEF='PresentToHistorichChurch',whichChoice=0,
      ...
      Group(
        ...
        Switch(DEF='MainmenuToMainpanel',whichChoice=0,
          children=[
          ProtoInstance(DEF='HudMainMenu',name='HeadsUpDisplay',
            fieldValue=[
            fieldValue(name='screenOffset',value=(3,1.7,-5)),
            fieldValue(name='children',
              children=[
              ProtoInstance(DEF='TouchMainMenu',name='TouchSensorSelected',
                fieldValue=[
                fieldValue(name='description',value='Main menu')]),
              ROUTE(fromField='isSelected4',fromNode='TouchMainMenu',toField='whichChoice',toNode='MainmenuToMainpanel'),
              Shape(
              ...
              Transform(DEF='MainMenuSphereRight',rotation=(1,0,0,-0.23),scale=(0.88,1,1.5),translation=(0.589,0.039,0.1),
                ...
                Shape(
                  ...
                  appearance=Appearance(
                    material=Material(emissiveColor=(1,1,1))))])])]),
          ProtoInstance(DEF='HudMainPanel',name='HeadsUpDisplay',
            fieldValue=[
            fieldValue(name='screenOffset',value=(0,0.2,-5.5)),
            fieldValue(name='children',
              children=[
              Transform(scale=(0.25,0.25,0.25),translation=(0,0,3),
                ...
                Transform(DEF='FirstPanel',translation=(0,0,0.2),
                  ...
                  Transform(translation=(-1.2,0,0),
                    ...
                    Transform(DEF='LightingButton',translation=(-0.8,0.68,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLighting',toField='headlight',toNode='FLYnavigation'),
                ...
                Transform(DEF='NavigatingPanel',
                  ...
                  Transform(translation=(-1.2,0,0),
                    ...
                    Transform(DEF='FlyModeButton',translation=(-0.8,1.08,0),
                      ...
                      ROUTE(fromField='isSelected',fromNode='touchFlyMode',toField='set_bind',toNode='FLYnavigation'),
                      Shape(
                        geometry=Sphere(radius=0.1),
                        appearance=Appearance(
                    ...
                    Transform(DEF='WalkModeButton',translation=(-0.8,0.68,0),
                      ...
                      ROUTE(fromField='isSelected',fromNode='touchWalkMode',toField='set_bind',toNode='WALKnavigation'),
                      Shape(
                        geometry=Sphere(radius=0.1),
                        appearance=Appearance(
                    ...
                    Transform(DEF='ExamineModeButton',translation=(-0.8,0.28,0),
                      ...
                      ROUTE(fromField='isSelected',fromNode='touchExamineMode',toField='set_bind',toNode='EXAMINEnavigation'),
                      Shape(
                        geometry=Sphere(radius=0.1),
                        appearance=Appearance(
                ...
                Transform(DEF='LightingPanel',
                  ...
                  Transform(translation=(-1.2,0,0),
                    ...
                    Transform(DEF='ExteriorNavigationButton',translation=(-0.8,1.08,0),
                      ...
                      ROUTE(fromField='isSelected',fromNode='touchExteriorNavigation',toField='headlight',toNode='FLYnavigation'),
                    ...
                    Transform(DEF='Light1Button',translation=(-0.8,0.68,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight1',toField='headlight',toNode='FLYnavigation'),
                    ...
                    Transform(DEF='Light2button',translation=(-0.8,0.28,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight2',toField='headlight',toNode='FLYnavigation'),
                    ...
                    Transform(DEF='Light3Button',translation=(-0.8,-0.12,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight3',toField='headlight',toNode='FLYnavigation'),
                    ...
                    Transform(DEF='Light4Button',translation=(-0.8,-0.52,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight4',toField='headlight',toNode='FLYnavigation'),
                    ...
                    Transform(DEF='Light5Button',translation=(-0.8,-0.92,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight5',toField='headlight',toNode='FLYnavigation'),
                ...
                Transform(DEF='LightingPanelBis',
                  ...
                  Transform(translation=(-1.2,0,0),
                    ...
                    Transform(DEF='Light6Button',translation=(-0.8,1.08,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight6',toField='headlight',toNode='FLYnavigation'),
                    ...
                    Transform(DEF='Light7Button',translation=(-0.8,0.68,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight7',toField='headlight',toNode='FLYnavigation'),
                    ...
                    Transform(DEF='Light8Button',translation=(-0.8,0.28,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight8',toField='headlight',toNode='FLYnavigation'),
                    ...
                    Transform(DEF='Light9Button',translation=(-0.8,-0.12,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight9',toField='headlight',toNode='FLYnavigation'),
                    ...
                    Transform(DEF='Light10Button',translation=(-0.8,-0.52,0),
                      ...
                      ROUTE(fromField='isSelected6',fromNode='touchLight10',toField='headlight',toNode='FLYnavigation'),
                ...
                Transform(DEF='HistoricChurchPanel',
                  ...
                  Transform(translation=(-1.2,0,0),
                    ...
                    Transform(DEF='Mid19thCenturyButton',translation=(-0.8,0.68,0),
                      ...
                      ROUTE(fromField='isSelected',fromNode='touchMid19thCentury',toField='headlight',toNode='FLYnavigation'),
                ...
                #  Coordinate System Panel, it appears clicking on the Coordinate System button on the First panel (). It brings you in front of the facade of the church. Clicking the left part you can see the center of the coordynate system' 
      ...
      Group(
        ...
        Switch(DEF='MainmenuToMainPanelPast',whichChoice=0,
          children=[
          ProtoInstance(DEF='HudMainpanelPast',name='HeadsUpDisplay',
            fieldValue=[
            fieldValue(name='screenOffset',value=(0,0.2,-5.5)),
            fieldValue(name='children',
              #  Red pyramids are links to differents viewpoints. They are positioned in the small model of the church, on the yellow panel 
                ...
                Transform(DEF='PresentAndHistoricChurchPanel',translation=(0,0,0.2),
                  ...
                  Transform(translation=(-1.2,0,0),
                    ...
                    Transform(DEF='HidePanelText15',translation=(3.2,1.2,0),
                      ...
                      Shape(
                        geometry=Text(string=["Hide Panel"],
                          fontStyle=FontStyle(justify=["BEGIN","MIDDLE"],size=0.3)),
                        appearance=Appearance(
                          material=Material(diffuseColor=(0,0,0))))]),
                  ...
                  Transform(translation=(-1.2,0,0),
                    ...
                    Transform(DEF='FlyModeButtonPast',translation=(-0.8,1.08,0),
                      ...
                      ProtoInstance(DEF='touchFlyModePast',name='TouchSensorSelected',
                        fieldValue=[
                        fieldValue(name='description',value='Fly')]),
                      ROUTE(fromField='isSelected',fromNode='touchFlyModePast',toField='set_bind',toNode='FLYnavigation'),
                      Shape(
                        geometry=Sphere(radius=0.1),
                        appearance=Appearance(
                    ...
                    Transform(DEF='WalkModeButtonPast',translation=(-0.8,0.68,0),
                      ...
                      ProtoInstance(DEF='touchWalkModePast',name='TouchSensorSelected',
                        fieldValue=[
                        fieldValue(name='description',value='Walk')]),
                      ROUTE(fromField='isSelected',fromNode='touchWalkModePast',toField='set_bind',toNode='WALKnavigation'),
                    ...
                    Transform(DEF='ExamineModeButtonPast',translation=(-0.8,0.28,0),
                      ...
                      ROUTE(fromField='isSelected',fromNode='touchExamineModePast',toField='set_bind',toNode='EXAMINEnavigation'),
                      Shape(
                        geometry=Sphere(radius=0.1),
                        appearance=Appearance(
                  ...
                  Transform(translation=(-1.2,0,0),
                    ...
                    Transform(DEF='PreviousPanelButton7',translation=(-0.8,-1.25,0),
                      ...
                      Shape(
                        ...
                        appearance=Appearance(
                          material=Material(diffuseColor=(0,0,0))))])])])])])]),
          ProtoInstance(DEF='HudMainPanelHidden',name='HeadsUpDisplay',
            #  example: upper left-hand corner of screen (x=-2, y=1) and set back z=-5 from user view 
            fieldValue=[
            fieldValue(name='screenOffset',value=(3,1.7,-5)),
            fieldValue(name='children',
              children=[
              ProtoInstance(DEF='TouchMainMenuPast',name='TouchSensorSelected',
                fieldValue=[
                fieldValue(name='description',value='Main menu')]),
              ROUTE(fromField='isSelected5',fromNode='TouchMainMenuPast',toField='whichChoice',toNode='MainmenuToMainPanelPast'),
              Shape(
                geometry=Text(string=["Main Menu"],
                  fontStyle=FontStyle(justify=["MIDDLE","MIDDLE"],size=0.3)),
                appearance=Appearance(
    ...
    #  ViewPointSequencer 
    Transform(scale=(0.5,0.5,0.5),translation=(0,0,5),
      children=[

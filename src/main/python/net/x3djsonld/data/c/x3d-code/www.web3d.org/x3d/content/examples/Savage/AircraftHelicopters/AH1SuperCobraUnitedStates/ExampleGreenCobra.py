...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='ExampleGreenCobra.x3d',name='title'),
    meta(content="Instantiates an example of the Super Cobra AH-1Z Helicopter's prototype in Green Color.",name='description'),
    meta(content='Jane Wu',name='creator'),
    meta(content='16 January 2001',name='created'),
    meta(content='22 October 2003',name='modified'),
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/AH1SuperCobraUnitedStates/ExampleGreenCobra.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(
      children=[
      TouchSensor(DEF='Sensor',description='start flight mode'),
      ProtoInstance(DEF='ExampleHelicopter',name='SuperCobra',
        fieldValue=[
        fieldValue(name='helicopterName',value='"Green Cobra"')])]),
...
print ("python x3d.py load successful for ExampleGreenCobra.py")

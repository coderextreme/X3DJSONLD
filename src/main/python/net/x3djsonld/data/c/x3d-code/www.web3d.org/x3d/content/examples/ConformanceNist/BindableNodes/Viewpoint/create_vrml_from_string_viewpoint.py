...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='create_vrml_from_string_viewpoint.x3d',name='title'),
    meta(content='create_vrml_from_string_viewpoint-front.jpg',name='Image'),
  ...
  Scene=Scene(
    ...
    Shape(
      ...
      geometry=IndexedFaceSet(coordIndex=[0,6,7,1,-1],texCoordIndex=[3,0,1,2,-1],
        ...
        texCoord=TextureCoordinate(USE='SquareTexCoord'))),
    Transform(DEF='TRANS'),
    Script(DEF='MYSCRIPT',directOutput=True,url=["create_vrml_from_string_viewpoint.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/create_vrml_from_string_viewpoint.js"],
      field=[
...
print ("python x3d.py load successful for create_vrml_from_string_viewpoint.py")

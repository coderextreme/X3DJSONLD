...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/Scenarios/UssColeTerroristAttack/LineBoatPrototype.x3d',name='identifier'),
            ...
            Transform(scale=(1.2,1.2,1.2),
              ...
              Shape(
                ...
                appearance=Appearance(
                  ...
                  texture=ImageTexture(DEF='TEXTURE',url=["../../Scenarios/UssColeTerroristAttack/BoatTexture.jpg","BoatTexture.jpg","https://savage.nps.edu/Savage/Scenarios/UssColeTerroristAttack/BoatTexture.jpg"]))),
              Shape(
...
print ("python x3d.py load successful for LineBoatPrototype.py")

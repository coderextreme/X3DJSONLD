...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Type209GlafkosDieselSubmarinePropeller.x3d',name='title'),
    meta(content='Submarine propeller based on a propeller initially created by James Harney for an "Arleigh Burke" type DDG',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/Submarines/Various/Type209GlafkosDieselSubmarinePropeller.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    Background(skyColor=[(0,0,0.5)]),
    #  LOD used to decrease framerate in combined file later. Set to 100m. >500m draws nothing. 
    LOD(range=[500],
      children=[
      Transform(
        children=[
            ...
            Transform(DEF='HUB',
              ...
              Shape(
                appearance=Appearance(
                  material=Material(DEF='BRASS',ambientIntensity=0.4,diffuseColor=(0.22,0.15,0),shininess=0.16,specularColor=(0.71,0.70,0.56))),
...
print ("python x3d.py load successful for Type209GlafkosDieselSubmarinePropeller.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='green_pointset.x3d',name='title'),
    meta(content='green_pointset-front.jpg',name='Image'),
    ...
    meta(content='This world tests browser ability to apply a single color to all points in a PointSet geometry. A green PointSet Sphere should be visible.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/Color/green_pointset.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='green_pointset.x3d'),
...
print ("python x3d.py load successful for green_pointset.py")

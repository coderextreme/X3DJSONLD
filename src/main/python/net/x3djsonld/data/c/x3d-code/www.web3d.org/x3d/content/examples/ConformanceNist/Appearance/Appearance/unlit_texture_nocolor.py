...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='unlit_texture_nocolor.x3d',name='title'),
    meta(content='unlit_texture_nocolor-front.jpg',name='Image'),
    meta(content='unlit_texture_nocolor-rear.jpg',name='Image'),
    meta(content='unlit_texture_nocolor-top.jpg',name='Image'),
    meta(content='unlit_texture_nocolor-bottom.jpg',name='Image'),
...
print ("python x3d.py load successful for unlit_texture_nocolor.py")

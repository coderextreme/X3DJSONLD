...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='BoxEaiJava.x3d',name='title'),
    meta(content='BoxEaiJavaPage.html',name='example'),
    ...
    meta(content='1 September 2002',name='created'),
    meta(content='22 June 2003',name='translated'),
    meta(content='20 October 2019',name='modified'),
    meta(content='Under development. VRML 97 EAI support appears inconsistent for various browsers.',name='warning'),
    meta(content='BoxEai.java',name='reference'),
    meta(content='javadoc/index.html',name='reference'),
    meta(content='originals/box/',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ExternalAuthoringInterface/BoxEaiJava.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='BoxEaiJava.x3d'),
    Shape(
...
print ("python x3d.py load successful for BoxEaiJava.py")

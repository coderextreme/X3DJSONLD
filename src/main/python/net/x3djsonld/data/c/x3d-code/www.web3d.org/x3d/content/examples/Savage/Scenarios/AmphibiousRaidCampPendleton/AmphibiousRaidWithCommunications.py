...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/Scenarios/AmphibiousRaidCampPendleton/AmphibiousRaidWithCommunications.x3d',name='identifier'),
    ...
    Switch(whichChoice=0,
      ...
      Group(DEF='EntireScene',
        ...
        Transform(DEF='LPD',translation=(6600,10,16800),
          children=[
          Inline(url=["../../ShipsMilitary/LandingPlatformDockLPD/LPD.x3d","https://savage.nps.edu/Savage/ShipsMilitary/LandingPlatformDockLPD/LPD.x3d","../../ShipsMilitary/LandingPlatformDockLPD/LPD.wrl","https://savage.nps.edu/Savage/ShipsMilitary/LandingPlatformDockLPD/LPD.wrl"]),
...
print ("python x3d.py load successful for AmphibiousRaidWithCommunications.py")

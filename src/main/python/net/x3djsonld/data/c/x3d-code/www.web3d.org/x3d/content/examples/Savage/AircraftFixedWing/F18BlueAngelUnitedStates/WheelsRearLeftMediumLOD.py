...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='WheelsRearLeftMediumLOD.x3d',name='title'),
    meta(content='The medium Level-of-Detail(LOD) of left side rear wheels and axle. It will be shown at the point of view of 600 meters. It does not include any animation.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftFixedWing/F18BlueAngelUnitedStates/WheelsRearLeftMediumLOD.x3d',name='identifier'),
...
print ("python x3d.py load successful for WheelsRearLeftMediumLOD.py")

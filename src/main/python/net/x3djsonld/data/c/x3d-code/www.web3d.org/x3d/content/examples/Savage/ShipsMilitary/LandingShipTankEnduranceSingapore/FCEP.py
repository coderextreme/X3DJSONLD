...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='FCEP.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/LandingShipTankEnduranceSingapore/FCEP.x3d',name='identifier'),
    meta(content='Fast Craft Equipement Personnel',name='description'),
...
print ("python x3d.py load successful for FCEP.py")

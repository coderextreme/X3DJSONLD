...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='jumpcut_loadworld_noview.x3d',name='title'),
    ...
    meta(content='Test jumpcut to a nonexistent viewpoint in Anchor URL.Because a Viewpoint named "NonExistentView" is specified in the url, the browser should disregard any other Viewpoint node in this world, and load the Viewpoint node with DEF name "NonEXISTENTView" as the default Viewpoint. HOWEVER, because this Viewpoint does not exist in this world, it should default to the first found Viewpoint, DEFed as "RightView". The viewer should see a cubic geometry with the word RIGHT displayed on it face, and Text geometry should indicate that the current Viewpoint position is at 10 0 0.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='jumpcut_loadworld_noview.x3d'),
    ...
    Anchor(description='click to reload world with nonexistent viewpoint',url=["jumpcut_loadworld_noview.x3d#NonExistentView","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.x3d#NonExistentView","jumpcut_loadworld_noview.wrl#NonExistentView","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.wrl#NonExistentView"],
      children=[
      Shape(
      ...
      Transform(translation=(-10,-5,-20),
        ...
        Shape(
          ...
          geometry=Text(DEF='TYPESTRING1',string=["message from Script is inserted here"],
            fontStyle=FontStyle(style_='BOLD')))])]),
    Script(DEF='AVATARSCRIPT',directOutput=True,url=["jumpcut_loadworld_noview.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/jumpcut_loadworld_noview.js"],
      field=[
...
print ("python x3d.py load successful for jumpcut_loadworld_noview.py")

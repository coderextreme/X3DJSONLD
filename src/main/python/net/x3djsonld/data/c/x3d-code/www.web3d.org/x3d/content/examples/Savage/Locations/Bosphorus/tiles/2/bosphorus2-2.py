...
newModel=X3D(profile='Immersive',version='3.1',
  ...
  Scene=Scene(
    children=[
    GeoViewpoint(description='GeoViewpoint_2_22',geoSystem=['GDC'],position=(41.171586403296146,29.17931591246088,28604.634182705922),orientation=(-1,0,0,1.57),
      geoOrigin=GeoOrigin(DEF='ORIGIN',geoCoords=(41.06225017873692,29.030952729968703,0),geoSystem=['GDC'])),
    GeoLOD(center=(41.171586403296146,29.17931591246088,0.0),range=34325.562,child1Url=['../../tiles/3/bosphorus4-4.x3d'],child2Url=['../../tiles/3/bosphorus4-5.x3d'],child3Url=['../../tiles/3/bosphorus5-4.x3d'],child4Url=['../../tiles/3/bosphorus5-5.x3d'],
      ...
      Group(
        ...
        Shape(
          appearance=Appearance(
            ...
            texture=ImageTexture(url=['../../images/2/bosphorus2-2.jpg'],repeatS=False,repeatT=False)),

...
newModel=X3D(profile='Immersive',version='3.2',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/Environment/Atmosphere/CloudsProcedural1.x3d',name='identifier'),
...
print ("python x3d.py load successful for CloudsProcedural1.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_locationcom.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/SpotLight/test_locationcom.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='test_locationcom.x3d'),
    Group(
      children=[
    ...
    Transform(scale=(0.02,0.02,0.02),translation=(-2.5,8,0),
      children=[
      Shape(
...
print ("python x3d.py load successful for test_locationcom.py")

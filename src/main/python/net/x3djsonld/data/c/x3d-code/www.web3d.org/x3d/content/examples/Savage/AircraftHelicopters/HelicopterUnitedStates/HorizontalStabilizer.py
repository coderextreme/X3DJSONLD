...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/AircraftHelicopters/HelicopterUnitedStates/HorizontalStabilizer.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(rotation=(0.0,0.0,1.0,1.57),
      ...
      Shape(DEF='STABILIZER_SHAPE',
        appearance=Appearance(DEF='BLUE_GREEN',
          material=Material(diffuseColor=(0.0,0.3,0.3))),
        geometry=Extrusion(creaseAngle=0.8,crossSection=[(-0.2,0.0),(-0.1,-0.02),(0.0,-0.04),(0.1,-0.045),(0.18,-0.04),(2.0,0.0),(0.18,0.04),(0.1,0.045),(0.0,0.04),(-0.1,0.02),(-0.2,0.0)],solid=False,spine=[(0.0,-1.14,0.0),(0.0,1.14,0.0)])),

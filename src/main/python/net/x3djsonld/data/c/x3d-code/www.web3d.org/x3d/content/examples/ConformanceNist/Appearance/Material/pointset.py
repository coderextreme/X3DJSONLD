...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='pointset-front.jpg',name='Image'),
    ...
    meta(content='Test emissiveColor for PointSet geometry. By providing a value of "red" to the emissiveColor field of the Material node, a red PointSet sphere should be visible.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/pointset.x3d',name='identifier'),

...
newModel=X3D(profile='Immersive',version='3.0',
  ...
  Scene=Scene(
    ...
    Transform(scale=(0.02,0.02,0.02),translation=(-3.3,3,0),
      children=[
      Shape(
    ...
    PositionInterpolator(DEF='the-location',key=[0.25,0.5,0.75,1],keyValue=[(0,0,5),(5,0,0),(0,0,-5),(-5,0,0)]),
    ColorInterpolator(DEF='text-color',key=[0,0.5,1],keyValue=[(0,0,1),(1,1,1),(0,0,1)]),
    Group(
      children=[
      PointLight(DEF='the-light',ambientIntensity=1,location=(0,0,5)),
      Transform(
        children=[
        Shape(

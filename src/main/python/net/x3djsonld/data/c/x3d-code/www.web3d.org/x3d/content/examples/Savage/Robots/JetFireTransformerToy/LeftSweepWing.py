...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='LeftSweepWing.x3d',name='title'),
    meta(content='Left Sweep Wing',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/Robots/JetFireTransformerToy/LeftSweepWing.x3d',name='identifier'),
...
print ("python x3d.py load successful for LeftSweepWing.py")

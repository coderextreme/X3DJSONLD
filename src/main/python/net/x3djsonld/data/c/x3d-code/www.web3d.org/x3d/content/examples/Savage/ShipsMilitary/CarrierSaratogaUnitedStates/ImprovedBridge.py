...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='ImprovedBridge.x3d',name='title'),
    meta(content='CVN Tower',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/ImprovedBridge.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Viewpoint(description='InsideB ridge',position=(0,6,-18)),
    ...
    Viewpoint(description='Door _entrance',position=(-5,6,-12.5)),
...
print ("python x3d.py load successful for ImprovedBridge.py")

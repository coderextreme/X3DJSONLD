...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='indexedlineset.x3d',name='title'),
    meta(content='indexedlineset-front.jpg',name='Image'),
    ...
    meta(content='Test emissiveColor for an IndexedLineSet. By providing a value of "red" to the emissiveColor field of the Material node, a red IndexedLineSet box should be visible.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/indexedlineset.x3d',name='identifier'),
...
print ("python x3d.py load successful for indexedlineset.py")

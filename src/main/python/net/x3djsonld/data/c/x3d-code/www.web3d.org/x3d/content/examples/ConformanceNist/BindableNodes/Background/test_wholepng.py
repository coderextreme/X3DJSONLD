...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='test_wholepng.x3d',name='title'),
    meta(content='test-wholepng-movie.mpg',name='MovingImage'),
...
print ("python x3d.py load successful for test_wholepng.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Lights/PointLight/test-ambientsim.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    PointLight(DEF='the-light',intensity=0.6,location=(0,0,10),radius=50),
    TimeSensor(DEF='text-time'),
    TimeSensor(DEF='the-time',cycleInterval=8),
    ScalarInterpolator(DEF='the-ambient',key=[0.2,0.4,0.6,0.8,1],keyValue=[0,0.25,0.5,0.75,1]),

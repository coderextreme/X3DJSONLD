...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='loopforever.x3d',name='title'),
    meta(content='loopforever-movie.mpg',name='MovingImage'),
    ...
    meta(content='Test MovieTexture looping forever. With the loop field is set to true, and the startTime (clicked by user) greater than stopTime (with a default of 0) and speed is not equal to 0 (with a default of 1), the movie will run forever, right to left, when started.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/loopforever.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='loopforever.x3d'),
...
print ("python x3d.py load successful for loopforever.py")

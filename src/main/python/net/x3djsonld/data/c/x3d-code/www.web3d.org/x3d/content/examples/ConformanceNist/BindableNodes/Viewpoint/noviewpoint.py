...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='noviewpoint.x3d',name='title'),
    meta(content='noviewpoint-front.jpg',name='Image'),
      ...
      Transform(translation=(-10,-5,-20),
        ...
        Shape(
          ...
          geometry=Text(DEF='TYPESTRING1',string=["message from Script is inserted here"],
            fontStyle=FontStyle(style_='BOLD')))])]),
    Script(DEF='AVATARSCRIPT',directOutput=True,url=["noviewpoint.js","https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/Viewpoint/noviewpoint.js"],
      field=[
...
print ("python x3d.py load successful for noviewpoint.py")

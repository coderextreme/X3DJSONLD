...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='ScalarInterpolatorFishPrototype.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/ScalarInterpolatorFishPrototype.x3d',name='identifier'),
...
print ("python x3d.py load successful for ScalarInterpolatorFishPrototype.py")

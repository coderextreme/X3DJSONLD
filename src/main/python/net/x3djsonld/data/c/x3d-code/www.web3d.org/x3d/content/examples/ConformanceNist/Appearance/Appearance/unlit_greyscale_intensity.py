...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='unlit_greyscale_intensity.x3d',name='title'),
    meta(content='unlit_greyscale_intensity-front.jpg',name='Image'),
    meta(content='unlit_greyscale_intensity-rear.jpg',name='Image'),
    meta(content='unlit_greyscale_intensity-top.jpg',name='Image'),
    meta(content='unlit_greyscale_intensity-bottom.jpg',name='Image'),
    ...
    meta(content='Test unlit, greyscale textured geometry. No Material node, no Color node and a greyscale ImageTexture is applied to a row containing primitive geometry, followedy by a row containing an ElevationGrid and an IndexedFaceSet. The result should be all geometry mapped with the greyscale VTS logo.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/unlit_greyscale_intensity.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='unlit_greyscale_intensity.x3d'),
    ...
    Group(
      ...
      Transform(translation=(-3,-0.651405,-5.5323),
        ...
        Shape(
          appearance=Appearance(
            texture=ImageTexture(DEF='greyscalecolor.jpg',url=["greyscalecolor.jpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Appearance/greyscalecolor.jpg"])),
      ...
      Transform(scale=(0.615111,0.615111,0.615112),translation=(1,-0.147732,-4.50195),
        ...
        Shape(
          appearance=Appearance(
            texture=ImageTexture(USE='greyscalecolor.jpg')),
...
print ("python x3d.py load successful for unlit_greyscale_intensity.py")

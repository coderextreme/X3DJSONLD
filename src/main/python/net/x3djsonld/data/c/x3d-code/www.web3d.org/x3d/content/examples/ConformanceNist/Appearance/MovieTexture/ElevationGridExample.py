...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='ElevationGridExample.x3d',name='title'),
    meta(content='ElevationGrid-front.jpg',name='Image'),
    meta(content='ElevationGrid-rear.jpg',name='Image'),
    meta(content='ElevationGrid-top.jpg',name='Image'),
    meta(content='ElevationGrid-bottom.jpg',name='Image'),
    meta(content='ElevationGrid-left.jpg',name='Image'),
    meta(content='ElevationGrid-right.jpg',name='Image'),
...
print ("python x3d.py load successful for ElevationGridExample.py")

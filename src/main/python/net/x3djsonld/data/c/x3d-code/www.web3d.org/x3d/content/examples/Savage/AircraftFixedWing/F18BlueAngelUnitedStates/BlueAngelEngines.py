...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='BlueAngelEngines.x3d',name='title'),
  ...
  Scene=Scene(
    ...
    Transform(rotation=(0.58,-0.58,0.58,2.09),scale=(0.4,0.4,0.4),translation=(0.5,-0.43,-5),
      #  U.S.NAVY title text attached on the side of the tails 
      children=[
      Group(
        children=[
        Transform(rotation=(-1,0,0,1.57),translation=(4.0,-6.5,-0.16),
          children=[
          Transform(rotation=(0,1,0,1.48),
            children=[
            Shape(
              geometry=Text(DEF='USNavyText_US',string=["U.S."],
                fontStyle=FontStyle(family=["SANS"],size=1.5)),
              appearance=Appearance(DEF='USNavy1',
                material=Material(diffuseColor=(1,0.8,0),specularColor=(1,0.8,0))))])]),
        Transform(rotation=(-1,0,0,1.57),translation=(4.2,-9.1,-0.16),
          children=[
          Transform(rotation=(0,1,0,1.62),
            children=[
            Shape(
              geometry=Text(DEF='USNavyText_NA',string=["NA"],
                fontStyle=FontStyle(family=["SANS"],size=1.5)),
              appearance=Appearance(USE='USNavy1'))])]),
        Transform(rotation=(-1,0,0,1.57),translation=(4.12,-10.8,-0.16),
          children=[
          Transform(rotation=(0,1,0,1.61),
            children=[
            Shape(
              geometry=Text(DEF='USNavyText_VY',string=["VY"],
                fontStyle=FontStyle(family=["SANS"],size=1.5)),
              appearance=Appearance(USE='USNavy1'))])])])]),
    Transform(rotation=(0.58,-0.58,0.58,2.09),scale=(0.4,0.4,0.4),translation=(0.5,-0.43,-7.5),
      #  U.S.NAVY title text attached on the side of the tails 
      children=[
      Group(
        children=[
        Transform(rotation=(-1,0,0,1.57),translation=(4.7,-13.8,-0.16),
          children=[
          Transform(rotation=(0,1,0,4.65),
            children=[
            Shape(
              geometry=Text(USE='USNavyText_US'),
              appearance=Appearance(USE='USNavy1'))])]),
        Transform(rotation=(-1,0,0,1.57),translation=(4.5,-11.0,-0.16),
          children=[
          Transform(rotation=(0,1,0,4.65),
            children=[
            Shape(
              geometry=Text(USE='USNavyText_NA'),
              appearance=Appearance(USE='USNavy1'))])]),
        Transform(rotation=(-1,0,0,1.57),translation=(4.35,-9.2,-0.16),
          children=[
          Transform(rotation=(0,1,0,4.78),
            children=[
            Shape(
              geometry=Text(USE='USNavyText_VY'),
              appearance=Appearance(USE='USNavy1'))])])])])])
) # X3D model complete
...
print ("python x3d.py load successful for BlueAngelEngines.py")

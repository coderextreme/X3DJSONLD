...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='AriesExample.x3d',name='title'),
    meta(content='Example showing NPS Aries Unmanned Underwater Vehicle (AUV) prototype.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/Robots/UnmannedUnderwaterVehicles/AriesExample.x3d',name='identifier'),
...
print ("python x3d.py load successful for AriesExample.py")

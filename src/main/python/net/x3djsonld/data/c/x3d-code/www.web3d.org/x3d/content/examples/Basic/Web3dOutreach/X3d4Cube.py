...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/CubeWithLabeledSides.x3d',name='reference'),
    ...
    Group(
      ...
      Shape(DEF='Front',
        ...
        appearance=Appearance(
          texture=ImageTexture(url=["logo/frontGlTF.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/logo/frontGlTF.png","https://www.web3d.org/x3d/content/examples/Basic/Web3dOutreach/logo/frontGlTF.png"]),
      ...
      Shape(DEF='Back',
        ...
        appearance=Appearance(
          texture=ImageTexture(url=["logo/backWebGL.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/logo/backWebGL.png","https://www.web3d.org/x3d/content/examples/Basic/Web3dOutreach/logo/backWebGL.png"]),
      ...
      Shape(DEF='Left',
        geometry=IndexedFaceSet(coordIndex=[3,2,6,7],texCoordIndex=[0,1,2,3],
          ...
          texCoord=TextureCoordinate(USE='DefaultTextureCoordinate')),
        appearance=Appearance(
          texture=ImageTexture(url=["logo/leftHTML5.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/logo/leftHTML5.png","https://www.web3d.org/x3d/content/examples/Basic/Web3dOutreach/logo/leftHTML5.png"]),
          textureTransform=TextureTransform(USE='RotateRight'))),
      ...
      Shape(DEF='Right',
        geometry=IndexedFaceSet(coordIndex=[0,4,5,1],texCoordIndex=[0,1,2,3],
          ...
          texCoord=TextureCoordinate(USE='DefaultTextureCoordinate')),
        appearance=Appearance(
          texture=ImageTexture(url=["logo/rightWebAudio.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/logo/rightWebAudio.png","https://www.web3d.org/x3d/content/examples/Basic/Web3dOutreach/logo/rightWebAudio.png"]),
      ...
      Shape(DEF='Top',
        geometry=IndexedFaceSet(coordIndex=[0,3,7,4],texCoordIndex=[0,1,2,3],
          ...
          texCoord=TextureCoordinate(USE='DefaultTextureCoordinate')),
        appearance=Appearance(
          texture=ImageTexture(url=["logo/topX3D4.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/logo/topX3D4.png","https://www.web3d.org/x3d/content/examples/Basic/Web3dOutreach/logo/topX3D4.png"]),
      ...
      Shape(DEF='Bottom',
        geometry=IndexedFaceSet(coordIndex=[1,5,6,2],texCoordIndex=[0,1,2,3],
          ...
          texCoord=TextureCoordinate(USE='DefaultTextureCoordinate')),
        appearance=Appearance(
          texture=ImageTexture(url=["logo/bottomJoinWeb3D.png","http://x3dGraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/logo/bottomJoinWeb3D.png","https://www.web3d.org/x3d/content/examples/Basic/Web3dOutreach/logo/bottomJoinWeb3D.png"]),

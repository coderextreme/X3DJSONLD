...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='TransDCE.x3d',name='title'),
    meta(content='Autogenerated version of TransDCE.x3d scene produced from TransDCE.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='TransDCE.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/TransDCE.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='TransDCE.x3d'),
    ...
    Viewpoint(description='Inspect TransDCE',position=(0,2,20)),
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["TransDCE: "])])])]),
    Group(
      children=[
      Transform(
        children=[
        ProtoInstance(DEF='trans_dce_karne_a_1',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(0.0000,0.6640,0.0000))])]),
      Transform(
        children=[
        ProtoInstance(DEF='trans_dce_karne_a_2',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(0.0000,-0.6640,0.0000))])]),
      Transform(
        children=[
        ProtoInstance(DEF='trans_dce_karne_a_3',name='Hydrogen',
          fieldValue=[
          fieldValue(name='position',value=(0.9000,1.2600,0.0000))])]),
      Transform(
        children=[
        ProtoInstance(DEF='trans_dce_karne_a_4',name='Chlorine',
          fieldValue=[
          fieldValue(name='position',value=(-1.4680,1.5680,0.0000))])]),
      Transform(
        children=[
        ProtoInstance(DEF='trans_dce_karne_a_5',name='Chlorine',
          fieldValue=[
          fieldValue(name='position',value=(1.4680,-1.5680,0.0000))])]),
      Transform(
        children=[
        ProtoInstance(DEF='trans_dce_karne_a_6',name='Hydrogen',
          fieldValue=[
          fieldValue(name='position',value=(-0.9000,-1.2600,0.0000))])])]),
    Group(
      children=[
      ProtoInstance(DEF='trans_dce_karne_b_1',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(-0.9000,-1.2600,0.0000),(0.0000,-0.6640,0.0000)])]),
      ProtoInstance(DEF='trans_dce_karne_b_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.4680,-1.5680,0.0000),(0.0000,-0.6640,0.0000)])]),
      ProtoInstance(DEF='trans_dce_karne_b_3',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(-1.4680,1.5680,0.0000),(0.0000,0.6640,0.0000)])]),
      ProtoInstance(DEF='trans_dce_karne_b_4',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(0.9000,1.2600,0.0000),(0.0000,0.6640,0.0000)])]),
      ProtoInstance(DEF='trans_dce_karne_b_5',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(-0.02,-0.6640,0.0000),(-0.02,0.6640,0.0000)])]),
      ProtoInstance(DEF='trans_dce_karne_b_5_2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(0.02,-0.6640,0.0000),(0.02,0.6640,0.0000)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for TransDCE.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='BridgeLowResolution.x3d',name='title'),
    ...
    meta(content='Low Resolution details for inline to main Improved Bridge file for LOD effects',name='description'),
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/BridgeLowResolution.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(0,6.3,0),
      children=[
      Shape(DEF='midstruc',
        geometry=Box(size=(12,5,25)),
        appearance=Appearance(
          material=Material(),))]),
    Transform(translation=(0,1,0),
      children=[
      Shape(DEF='bottomstruc',
        geometry=Box(size=(12,7,40)),
        appearance=Appearance(
          material=Material(),))]),
    Transform(translation=(0,10.1,0),
      children=[
      Shape(DEF='MainStruc',
        geometry=Box(size=(12,3,40)),
        appearance=Appearance(
          material=Material(),)),
      Transform(rotation=(0,1,0,-1.571),translation=(-6.1,-8,-4),
        children=[
        Shape(
...
print ("python x3d.py load successful for BridgeLowResolution.py")

    ...
    Group(DEF='HUT',
      ...
      Shape(
        appearance=Appearance(
          ...
          texture=ImageTexture(url=["wood.gif","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/grass.jpg"]),
      ...
      Transform(DEF='ROOF_TRANSFORM',translation=(0,4,0),
        ...
        Shape(
          appearance=Appearance(
            ...
            texture=ImageTexture(url=["straw.jpg","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/grass.jpg"])),
      ...
      Transform(translation=(10,0,0),
        ...
        Shape(
          appearance=Appearance(
            ...
            texture=ImageTexture(DEF='wood',url=["wood.jpg","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/wood.jpg"])),
      ...
      Transform(translation=(10,3,0),
        ...
        Shape(
          appearance=Appearance(
            ...
            texture=ImageTexture(url=["leaves.jpg","https://www.web3d.org/x3d/content/examples/Basic/StudentProjects/leaves.jpg"])),
...
print ("python x3d.py load successful for DuttonVillage.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='ForwardAntenna.x3d',name='title'),
    meta(content='Forward antenna for the AAV7PA1.',name='description'),
    ...
    meta(content='https://savage.nps.edu/Savage/AmphibiousVehicles/AAV/ForwardAntenna.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(DEF='ForwardAntenna',
      children=[
      Transform(DEF='Base',translation=(0,-0.167,0),
        children=[
        Shape(
          geometry=Box(size=(0.25,0.667,0.275)),
          appearance=Appearance(
            material=Material(diffuseColor=(0.2,0.33,0.2))))]),
      Transform(scale=(0.05,0.175,0.05),translation=(0,0.25,0),
        children=[
        Shape(
      ...
      Transform(DEF='WhipAntenna',translation=(0,1.66,0),
        children=[
        Shape(
          geometry=Cylinder(height=2.66,radius=0.007),
          appearance=Appearance(
...
print ("python x3d.py load successful for ForwardAntenna.py")

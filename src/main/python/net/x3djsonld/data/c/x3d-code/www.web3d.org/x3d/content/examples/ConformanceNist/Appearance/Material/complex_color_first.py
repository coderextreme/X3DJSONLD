...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='complex_color_first.x3d',name='title'),
    meta(content='complex_color_first-front.jpg',name='Image'),
    meta(content='complex_color_first-rear.jpg',name='Image'),
    ...
    meta(content='Test Color node precedence over diffuseColor fir complex geometry. An ElevationGrid and IndexedFaceSet geometry have a color field defining them as "blue". This color field should supersede the Material node diffuseColor field of "red". Both geometry in the world should be blue.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/Material/complex_color_first.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='complex_color_first.x3d'),
...
print ("python x3d.py load successful for complex_color_first.py")

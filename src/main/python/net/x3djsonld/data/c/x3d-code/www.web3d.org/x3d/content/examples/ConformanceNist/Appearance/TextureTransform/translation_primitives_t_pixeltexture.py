...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='translation_primitives_t_pixeltexture.x3d',name='title'),
    meta(content='translation_primitives_t_pixeltexture-front.jpg',name='Image'),
    meta(content='translation_primitives_t_pixeltexture-rear.jpg',name='Image'),
    meta(content='translation_primitives_t_pixeltexture-top.jpg',name='Image'),
    meta(content='translation_primitives_t_pixeltexture-bottom.jpg',name='Image'),
    meta(content='translation_primitives_t_pixeltexture-left.jpg',name='Image'),
    meta(content='translation_primitives_t_pixeltexture-right.jpg',name='Image'),
...
print ("python x3d.py load successful for translation_primitives_t_pixeltexture.py")

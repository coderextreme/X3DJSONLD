...
newModel=X3D(profile='Interchange',version='3.1',
  head=head(
    children=[
    meta(content='Hemisphere.x3d',name='title'),
    meta(content='Hemisphere.ply',name='reference'),
    meta(content='Hemisphere is a half sphere. Sphere tessellation algorithms might be insufficient since equatorial triangles may not align with the plane. The original tool or algorithm producing this mesh is not known, unfortunately.',name='description'),
    meta(content='13 September 2014',name='created'),
    meta(content='20 October 2019',name='modified'),
    meta(content='David W. Laflam and Don Brutzman',name='creator'),
    meta(content='https://en.wikipedia.org/wiki/Hemisphere',name='reference'),
    meta(content='https://en.wiktionary.org/wiki/hemisphere',name='reference'),
    ...
    meta(content='http://www.kjmaclean.com/Geometry/Hemisphere.html',name='reference'),
    meta(content='http://polyhedra.org/poly/show/4/hemisphere',name='reference'),
    ...
    meta(content='http://www.domerama.com/software',name='reference'),
    meta(content='http://mathworld.wolfram.com/Hemisphere.html',name='reference'),
    meta(content='https://x3dgraphics.com/examples/X3dForAdvancedModeling/GeometricShapes/Hemisphere.x3d',name='identifier'),
    meta(content='Meshlab X3D Exported, http://meshlab.sourceforge.net',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Hemisphere.x3d'),
    Background(skyColor=[(0.5,1,0.9)]),
    Viewpoint(description='Hemisphere',position=(0,0,6)),
...
print ("python x3d.py load successful for Hemisphere.py")

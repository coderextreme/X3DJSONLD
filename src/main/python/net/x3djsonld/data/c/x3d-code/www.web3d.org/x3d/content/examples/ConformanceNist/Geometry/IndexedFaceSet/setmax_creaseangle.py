...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='setmax_creaseangle.x3d',name='title'),
    meta(content='setmax-creaseangle-front.jpg',name='Image'),
    meta(content='setmax-creaseangle-rear.jpg',name='Image'),
    meta(content='setmax-creaseangle-top.jpg',name='Image'),
    meta(content='setmax-creaseangle-bottom.jpg',name='Image'),
    meta(content='setmax-creaseangle-left.jpg',name='Image'),
    meta(content='setmax-creaseangle-right.jpg',name='Image'),
...
print ("python x3d.py load successful for setmax_creaseangle.py")

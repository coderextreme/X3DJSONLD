...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ScriptConformance/ScriptNodeFieldControl_EcmaScript.x3d',name='identifier'),
    ...
    meta(content='ScriptNodeFieldControl_EcmaScript-VrmlConsoleOutput.txt',name='reference'),
    meta(content='ScriptNodeFieldControl_EcmaScriptSnapshots.html',name='reference'),
    meta(content='ScriptNodeFieldControl_Java.x3d',name='reference'),
...
print ("python x3d.py load successful for ScriptNodeFieldControl_EcmaScript.py")

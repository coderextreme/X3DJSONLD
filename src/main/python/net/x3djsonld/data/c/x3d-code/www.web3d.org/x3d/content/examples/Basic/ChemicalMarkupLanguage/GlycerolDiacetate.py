...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='GlycerolDiacetate.x3d',name='title'),
    meta(content='Autogenerated version of GlycerolDiacetate.x3d scene produced from GlycerolDiacetate.xml Chemical Markup Language (CML) version 1.0 source file.',name='description'),
    ...
    meta(content='GlycerolDiacetate.xml',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/ChemicalMarkupLanguage/GlycerolDiacetate.x3d',name='identifier'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='GlycerolDiacetate.x3d'),
    ...
    Viewpoint(description='Inspect GlycerolDiacetate',position=(0,2,20)),
    ...
    Transform(DEF='infogroupa',translation=(-8,2,-4),
      ...
      Transform(translation=(0,6,0),
        ...
        ProtoInstance(name='title_text',
          fieldValue=[
          fieldValue(name='txt',value=["Glycerol Diacetate: C7 H12 O5"])])]),
      Transform(translation=(0,5,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["molecule weight: 176.17"])])]),
      Transform(translation=(0,4,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["melting point: -30"])])]),
      Transform(translation=(0,3,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["boiling point: 259"])])]),
      Transform(translation=(0,2,0),
        children=[
        ProtoInstance(name='ano1_text',
          fieldValue=[
          fieldValue(name='txt',value=["specific gravity: 1.18"])])])]),
    Group(
      children=[
      Transform(
        children=[
        ProtoInstance(DEF='glycerol_diacetate_a1',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(3.2922,1.7366,0.9637))])]),
      Transform(
        children=[
        ProtoInstance(DEF='glycerol_diacetate_a2',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(2.2046,1.2077,1.9255))])]),
      Transform(
        children=[
        ProtoInstance(DEF='glycerol_diacetate_a3',name='Carbon',
          fieldValue=[
          fieldValue(name='position',value=(1.2922,2.3736,2.3677))])]),
      Transform(
        children=[
        ProtoInstance(DEF='glycerol_diacetate_a4',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(1.4655,0.1545,1.3504))])]),
      Transform(
        children=[
        ProtoInstance(DEF='glycerol_diacetate_a5',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(4.3235,0.8189,0.7374))])]),
      Transform(
        children=[
        ProtoInstance(DEF='glycerol_diacetate_a6',name='Oxygen',
          fieldValue=[
          fieldValue(name='position',value=(0.4626,2.0481,3.4462))])])]),
    Group(
      children=[
      ProtoInstance(DEF='glycerol_diacetate_b1',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.2922,1.7366,0.9637),(2.2046,1.2077,1.9255)])]),
      ProtoInstance(DEF='glycerol_diacetate_b2',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(3.2922,1.7366,0.9637),(4.3235,0.8189,0.7374)])]),
      ProtoInstance(DEF='glycerol_diacetate_b5',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.2046,1.2077,1.9255),(1.2922,2.3736,2.3677)])]),
      ProtoInstance(DEF='glycerol_diacetate_b6',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(2.2046,1.2077,1.9255),(1.4655,0.1545,1.3504)])]),
      ProtoInstance(DEF='glycerol_diacetate_b8',name='line',
        fieldValue=[
        fieldValue(name='bond_set',value=[(1.2922,2.3736,2.3677),(0.4626,2.0481,3.4462)])])])])
) # X3D model complete
...
print ("python x3d.py load successful for GlycerolDiacetate.py")

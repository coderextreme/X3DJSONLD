...
newModel=X3D(profile='Interchange',version='3.1',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsCivilian/CigaretteBoat/CigaretteBoat.x3d',name='identifier'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(info=["http://powerandmotoryacht.com/boattests/0603cigarette/index2.html"],title='Cigarette 46 Rider XP',
      metadata=MetadataSet(name='SMAL',reference='https://savage.nps.edu/Savage/Tools/SMAL/SMAL.html',
        ...
        MetadataSet(name='EntityDefinition',
          ...
          MetadataSet(name='Classification',
            ...
            MetadataString(name='reference',value=["http://powerandmotoryacht.com/boattests/0603cigarette/index2.html"],
          ...
          MetadataSet(name='IdentificationParameters',
            value=[
            MetadataString(name='name',value=["Cigarette 46 Rider XP"],
          ...
          MetadataSet(name='PhysicalParameters',
            ...
            MetadataSet(name='PhysicalConstraints',
              value=[
              MetadataFloat(name='height',value=[2.36],
              ...
              MetadataFloat(name='width',value=[2.44],
              ...
              MetadataFloat(name='length',value=[13.9],
              ...
              MetadataFloat(name='draft',value=[1.22],
              ...
              MetadataFloat(name='grossWeight',value=[5533.83],
            ...
            MetadataSet(name='DynamicResponseConstraints',
              value=[
              MetadataFloat(name='maximumSpeed',value=[171.6],
                metadata=MetadataString(name='appinfo',value=["The maximum rated speed for this vehicle in kph."])),
              MetadataFloat(name='cruiseSpeed',value=[93.5],
                metadata=MetadataString(name='appinfo',value=["The published cruise speed for this vehicle in kph."])),
              MetadataFloat(name='maximumAcceleration',value=[4.4],
                metadata=MetadataString(name='appinfo',value=["The ideal maximum acceleration achievable by this vehicle in meters per second squared, as in at maximum Power excess for aircraft."])),
              MetadataFloat(name='maximumFuelCapacity',value=[1362.75],
                metadata=MetadataString(name='appinfo',value=["The maximum usable fuel capacity in liters."]))]),
          ...
          MetadataSet(name='NetworkedCommunicationParameterSet',
            ...
            MetadataSet(name='DisConfiguration',
              ...
              MetadataInteger(name='entityKind',value=[1],
                metadata=MetadataString(name='appinfo',value=["The DIS enumeration for this objects overall type (for vehicles this value should be 1)."])),
              ...
              MetadataInteger(name='entityCategory',value=[0],
    ...
    Transform(DEF='CigaretteBoat',scale=(.295,.295,.295),
      children=[
      Group(DEF='GROUND',
        children=[
            ...
            Transform(DEF='dad_Group1',
              ...
              Group(DEF='Group1',
                ...
                Transform(DEF='dad_Sqwht01',
                  ...
                  Shape(DEF='Sqwht01',
                    appearance=Appearance(
                      texture=ImageTexture(DEF='HullTexture',url=["CIGRT.JPG","https://savage.nps.edu/Savage/ShipsCivilian/SmallBoats/textures/CIGRT.JPG"]),
                ...
                Transform(DEF='dad_Sqwht01_1',
                  ...
                  Shape(DEF='Sqwht01_1',
                    appearance=Appearance(
                      texture=ImageTexture(USE='HullTexture'),
    ...
    Viewpoint(DEF='VP1',description='Cigarette Boat Starboard',position=(0,2,15)),
    Viewpoint(DEF='VP2',description='Cigarette Boat Front',orientation=(0,1,0,1.571),position=(15,2,0)),
    Viewpoint(DEF='VP3',description='Cigarette Boat Port',orientation=(0,1,0,3.142),position=(0,2,-15)),
    Viewpoint(DEF='VP4',description='Cigarette Boat Back',orientation=(0,1,0,-1.571),position=(-15,2,0)),
    Viewpoint(DEF='VP5',description='Cigarette Boat Top',orientation=(1,0,0,-1.571),position=(0,15,0)),
    Viewpoint(DEF='VP6',description='Cigarette Boat Bottom',orientation=(1,0,0,1.571),position=(0,-15,0))])
) # X3D model complete

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='StarboardPalOdometer.x3d',name='title'),
    meta(content='Selcuk OZTURK',name='creator'),
    meta(content='Starboard Pal Odometer.',name='description'),
    meta(content='16 September 2002',name='created'),
    meta(content='12 January 2012',name='modified'),
    meta(content='https://savage.nps.edu/Savage/AircraftMiscellaneous/Zeppelin/StarboardPalOdometer.x3d',name='identifier'),
...
print ("python x3d.py load successful for StarboardPalOdometer.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='default_primitives_imagetexture.x3d',name='title'),
    meta(content='default_primitives_imagetexture-front.jpg',name='Image'),
    meta(content='default_primitives_imagetexture-rear.jpg',name='Image'),
    meta(content='default_primitives_imagetexture-top.jpg',name='Image'),
    meta(content='default_primitives_imagetexture-bottom.jpg',name='Image'),
    meta(content='default_primitives_imagetexture-left.jpg',name='Image'),
    meta(content='default_primitives_imagetexture-right.jpg',name='Image'),
...
print ("python x3d.py load successful for default_primitives_imagetexture.py")

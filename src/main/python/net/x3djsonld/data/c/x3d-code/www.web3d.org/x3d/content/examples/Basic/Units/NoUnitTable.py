...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='NoUnitTable.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Basic/Units/NoUnitTable.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='NoUnitTable.x3d'),
...
print ("python x3d.py load successful for NoUnitTable.py")

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='ContainerShip.x3d',name='title'),
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsCivilian/CargoShips/ContainerShip.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='VizX3D, http://www.vivaty.com/downloads/studio',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(info=["www.vizx3d.com","http://www.ship-technology.com/projects/contship/specs.html"],title='Container Ship',
      metadata=MetadataSet(name='SMAL',reference='https://savage.nps.edu/Savage/Tools/SMAL/SMAL.html',
        ...
        MetadataSet(name='EntityDefinition',
          ...
          MetadataSet(name='IdentificationParameters',
            value=[
            MetadataString(name='name',value=["Contship Aurora Container Ship"],
          ...
          MetadataSet(name='PhysicalParameters',
            ...
            MetadataSet(name='PhysicalConstraints',
              value=[
              MetadataFloat(name='height',value=[43.5],
              ...
              MetadataFloat(name='width',value=[38.2],
              ...
              MetadataFloat(name='length',value=[249.5],
              ...
              Group(DEF='Group3',
                ...
                Transform(DEF='dad_Box01',
                  ...
                  Shape(DEF='Box01',
                    appearance=Appearance(
                      texture=ImageTexture(DEF='C_SIDE_TEX',url=["textures/C_SIDE.jpg","https://savage.nps.edu/Savage/ShipsCivilian/CargoShips/textures/C_SIDE.jpg"]),
                    ...
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1,2,1,7,-1,7,6,2,-1],creaseAngle=1.178,texCoordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1,8,9,10,-1,10,11,8,-1],
                      coord=Coordinate(point=[(-388.9407,-43.17078,-21.44951),(-388.9407,-43.17078,-59.93058),(-285.70419,-43.17078,-59.93058),(-285.70419,-43.17078,-21.44951),(-388.9407,45.56719,-21.44951),(-285.70419,45.56719,-21.44951),(-285.70419,45.56719,-59.93058),(-388.9407,45.56719,-59.93058)]),
                      texCoord=TextureCoordinate(point=[(3.048,.001),(3.048,1),(.002,1),(.002,.001),(.002,.001),(3.048,.001),(3.048,1),(.002,1),(.002,.001),(3.048,.001),(3.048,1),(.002,1)])))]),
                Transform(DEF='dad_Box02',
                  children=[
                  Shape(DEF='Box02',
                    appearance=Appearance(
                      texture=ImageTexture(DEF='CNTSHIP1_TEX',url=["textures/CNTSHIP1.jpg","https://savage.nps.edu/Savage/ShipsCivilian/CargoShips/textures/CNTSHIP1.jpg"]),
                ...
                Transform(DEF='dad_Box03',
                  ...
                  Shape(DEF='Box03',
                    ...
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1,2,1,7,-1,7,6,2,-1],creaseAngle=1.178,texCoordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1,8,9,10,-1,10,11,8,-1],
                      coord=Coordinate(point=[(-189.90424,-43.17075,-21.18403),(-189.90424,-43.17075,-59.6651),(265.95013,-43.17076,-59.6651),(265.95017,-43.17076,-21.18403),(-189.90424,45.56779,-21.18403),(265.95013,45.56779,-21.18403),(265.95013,45.56779,-59.6651),(-189.90424,45.56779,-59.6651)]),
                      texCoord=TextureCoordinate(point=[(13.953,.001),(13.953,1),(.007,.999),(.007,.001),(.007,.001),(13.953,.001),(13.953,.999),(.007,1),(.007,.001),(13.953,.001),(13.953,1),(.007,1)])))]),
                Transform(DEF='dad_Box04',
                  children=[
                  Shape(DEF='Box04',
                    appearance=Appearance(
                      texture=ImageTexture(USE='CNTSHIP1_TEX'),
                    ...
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1,3,2,6,-1,6,5,3,-1,2,1,7,-1,7,6,2,-1,1,0,4,-1,4,7,1,-1],creaseAngle=1.178,texCoordIndex=[0,1,1,-1,1,2,0,-1,3,3,4,-1,4,4,3,-1,2,1,4,-1,4,3,2,-1,1,1,4,-1,4,4,1,-1,1,0,3,-1,3,4,1,-1],
                      coord=Coordinate(point=[(-210.05501,3.62608,-87.72208),(-209.27867,1.52698,-93.18823),(-209.27867,-1.23773,-93.18823),(-210.05501,-3.33684,-87.72208),(-206.66255,3.62608,-87.72208),(-206.66255,-3.33684,-87.72208),(-207.43889,-1.23773,-93.18823),(-207.43889,1.52698,-93.18823)]),
                      texCoord=TextureCoordinate(point=[(.962,.739),(1.11,.712),(.962,.739),(.962,.621),(1.11,.648)])))]),
                Transform(DEF='dad_Box33',
                  ...
                  Shape(DEF='Box33',
                    ...
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,3,2,1,-1,4,5,6,-1,7,6,5,-1,8,9,10,-1,11,10,9,-1,10,11,4,-1,5,4,11,-1,12,8,13,-1,10,13,8,-1,13,10,6,-1,4,6,10,-1,14,15,16,-1,17,16,15,-1,18,13,7,-1,6,7,13,-1,9,19,11,-1,18,11,19,-1,11,18,5,-1,7,5,18,-1,19,9,1,-1,1,0,19,-1,12,19,0,-1,0,2,12,-1,8,12,2,-1,2,3,8,-1,9,8,3,-1,3,1,9,-1,12,13,17,-1,17,15,12,-1,19,12,15,-1,15,14,19,-1,18,19,14,-1,14,16,18,-1,13,18,16,-1,16,17,13,-1],creaseAngle=1.178,texCoordIndex=[0,1,0,-1,1,0,1,-1,2,2,3,-1,4,3,2,-1,5,5,6,-1,6,6,5,-1,6,6,2,-1,2,2,6,-1,7,5,8,-1,6,8,5,-1,8,6,3,-1,2,3,6,-1,9,9,10,-1,10,10,9,-1,11,8,4,-1,3,4,8,-1,5,12,6,-1,11,6,12,-1,6,11,2,-1,4,2,11,-1,12,5,1,-1,1,0,12,-1,7,12,0,-1,0,0,7,-1,5,7,0,-1,0,1,5,-1,5,5,1,-1,1,1,5,-1,7,8,10,-1,10,9,7,-1,12,7,9,-1,9,9,12,-1,11,12,9,-1,9,10,11,-1,8,11,10,-1,10,10,8,-1],
                      coord=Coordinate(point=[(-228.2204,-63.15356,-29.97303),(-231.16299,-63.15181,-27.26141),(-228.2204,-63.24352,-29.97303),(-231.16299,-63.24177,-27.26141),(-253.55063,-65.672,-27.26141),(-253.55063,-60.75892,-27.26141),(-254.50246,-66.54545,-29.97303),(-254.50246,-59.88679,-29.97303),(-237.57921,-64.88631,-27.26141),(-237.57921,-61.52482,-27.26141),(-245.70786,-65.68843,-27.26141),(-245.70787,-60.554,-27.26141),(-234.55167,-66.11591,-29.97303),(-246.38506,-66.54859,-29.97303),(-237.61462,-61.46545,-31.42196),(-237.61462,-65.03426,-31.42196),(-245.70787,-61.46546,-31.42196),(-245.70787,-65.03426,-31.42196),(-246.38507,-59.86162,-29.97303),(-234.55167,-60.24218,-29.97303)]),
                      texCoord=TextureCoordinate(point=[(.83,.9),(.802,.827),(.592,.827),(.583,.9),(.583,.9),(.742,.827),(.666,.827),(.77,.9),(.659,.9),(.741,.939),(.666,.939),(.659,.9),(.77,.9)])))]),
                ...
                Transform(DEF='dad_Cylinder04',
                  ...
                  Shape(DEF='Cylinder04',
                    ...
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,0,3,1,-1,0,4,3,-1,0,5,4,-1,0,6,5,-1,0,7,6,-1,0,8,7,-1,0,9,8,-1,0,10,9,-1,0,2,10,-1,2,11,12,-1,2,1,11,-1,1,13,11,-1,1,3,13,-1,3,14,13,-1,3,4,14,-1,4,15,14,-1,4,5,15,-1,5,16,15,-1,5,6,16,-1,6,17,16,-1,6,7,17,-1,7,18,17,-1,7,8,18,-1,8,19,18,-1,8,9,19,-1,9,20,19,-1,9,10,20,-1,10,12,20,-1,10,2,12,-1,21,12,11,-1,21,11,13,-1,21,13,14,-1,21,14,15,-1,21,15,16,-1,21,16,17,-1,21,17,18,-1,21,18,19,-1,21,19,20,-1,21,20,12,-1],creaseAngle=1.178,texCoordIndex=[0,1,0,-1,0,2,1,-1,0,2,2,-1,0,1,2,-1,0,0,1,-1,0,3,0,-1,0,4,3,-1,0,4,4,-1,0,3,4,-1,0,0,3,-1,0,5,6,-1,0,1,5,-1,1,7,5,-1,1,2,7,-1,2,7,7,-1,2,2,7,-1,2,5,7,-1,2,1,5,-1,1,6,5,-1,1,0,6,-1,0,8,6,-1,0,3,8,-1,3,9,8,-1,3,4,9,-1,4,9,9,-1,4,4,9,-1,4,8,9,-1,4,3,8,-1,3,6,8,-1,3,0,6,-1,6,6,5,-1,6,5,7,-1,6,7,7,-1,6,7,5,-1,6,5,6,-1,6,6,8,-1,6,8,9,-1,6,9,9,-1,6,9,8,-1,6,8,6,-1],
                      coord=Coordinate(point=[(-208.31857,5.41335,-118.13174),(-208.22511,5.28471,-118.13174),(-208.31857,5.25435,-118.13174),(-208.16736,5.36421,-118.13174),(-208.16736,5.46248,-118.13174),(-208.22511,5.54198,-118.13174),(-208.31857,5.57234,-118.13174),(-208.41203,5.54198,-118.13174),(-208.46979,5.46248,-118.13174),(-208.46979,5.36421,-118.13174),(-208.41203,5.28471,-118.13174),(-208.22511,5.28471,-114.54931),(-208.31857,5.25435,-114.54931),(-208.16736,5.36421,-114.54931),(-208.16736,5.46248,-114.54931),(-208.22511,5.54198,-114.54931),(-208.31857,5.57234,-114.54931),(-208.41203,5.54198,-114.54931),(-208.46979,5.46248,-114.54931),(-208.46979,5.36421,-114.54931),(-208.41203,5.28471,-114.54931),(-208.31857,5.41335,-114.54931)]),
                      texCoord=TextureCoordinate(point=[(.784,.679),(.784,.676),(.784,.674),(.784,.682),(.784,.684),(.687,.676),(.687,.679),(.687,.674),(.687,.682),(.687,.684)])))]),
                Transform(DEF='dad_Line10',
                  children=[
                  Shape(DEF='Line10',
                    appearance=Appearance(
                      texture=ImageTexture(USE='CNTSHIP1_TEX'),
                      material=Material(DEF='material12_mat',ambientIntensity=1,diffuseColor=(1,1,1),shininess=0.100,specularColor=(.89804,.89804,.89804))),
                ...
                Transform(DEF='dad_Name_sb',
                  ...
                  Shape(DEF='Name_sb',
                    appearance=Appearance(
                      texture=ImageTexture(USE='CNTSHIP1_TEX'),
                      material=Material(DEF='material19_mat',ambientIntensity=0.588,diffuseColor=(.58823,.58823,.58823),shininess=0.100,specularColor=(.89804,.89804,.89804),transparency=1)),
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,3,2,1,-1],creaseAngle=1.178,texCoordIndex=[0,1,2,-1,3,2,1,-1],
                      coord=Coordinate(point=[(360.21594,53.52636,-33.98264),(360.30573,36.9357,-21.99017),(393.13037,39.33155,-36.34577),(387.5271,21.8357,-22.43666)]),
                      texCoord=TextureCoordinate(point=[(0,1),(0,0),(1,1),(1,0)])))]),
                Transform(DEF='dad_Name_sn',
                  ...
                  Shape(DEF='Name_sn',
                    appearance=Appearance(
                      texture=ImageTexture(USE='CNTSHIP1_TEX'),
                      material=Material(DEF='material20_mat',ambientIntensity=0.588,diffuseColor=(.58823,.58823,.58823),shininess=0.100,specularColor=(.89804,.89804,.89804),transparency=1)),
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,1,3,-1,4,0,2,-1,2,5,6,-1,3,5,2,-1,2,6,7,-1],creaseAngle=1.178,texCoordIndex=[0,1,2,-1,2,1,3,-1,4,0,2,-1,2,5,6,-1,3,5,2,-1,2,6,7,-1],
                      coord=Coordinate(point=[(-394.78586,-43.43495,-9.71837),(-394.55917,-24.22525,-2.22004),(-394.80875,.07022,-21.91711),(-394.4075,.07022,-1.20362),(-394.78018,-47.51174,-21.91711),(-394.55917,24.36568,-2.22006),(-394.78586,43.57539,-9.71839),(-394.78018,47.65218,-21.91713)]),
                      texCoord=TextureCoordinate(point=[(.043,.411),(.245,.05),(.5,1),(.5,.001),(.001,1),(.755,.05),(.957,.411),(1,1)])))]),
                Transform(DEF='dad_Object01',
                  children=[
                  Shape(DEF='Object01',
                    appearance=Appearance(
                      texture=ImageTexture(DEF='C_END_TEX',url=["textures/C_END.jpg","https://savage.nps.edu/Savage/ShipsCivilian/CargoShips/textures/C_END.jpg"]),
                    ...
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1],creaseAngle=1.178,texCoordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1],
                      coord=Coordinate(point=[(265.95017,-43.17076,-21.18403),(265.95013,-43.17076,-59.6651),(265.95013,45.56779,-59.6651),(265.95013,45.56779,-21.18403),(-189.90424,-43.17076,-59.6651),(-189.90424,-43.17076,-21.18403),(-189.90424,45.56779,-21.18403),(-189.90424,45.56779,-59.6651)]),
                      texCoord=TextureCoordinate(point=[(.008,.056),(.008,1.27),(.832,1.27),(.832,.056),(.008,1.27),(.008,.056),(.832,.056),(.832,1.27)])))]),
                Transform(DEF='dad_Object02',
                  children=[
                  Shape(DEF='Object02',
                    appearance=Appearance(
                      texture=ImageTexture(USE='C_END_TEX'),
                    ...
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1],creaseAngle=1.178,texCoordIndex=[0,1,2,-1,2,3,0,-1,1,0,4,-1,4,5,1,-1],
                      coord=Coordinate(point=[(-285.70419,-43.17078,-21.44951),(-285.70419,-43.17078,-59.93059),(-285.70419,45.56719,-59.93059),(-285.70419,45.56719,-21.44951),(-388.9407,-43.17078,-59.93058),(-388.9407,-43.17078,-21.44951),(-388.9407,45.56719,-21.44951),(-388.9407,45.56719,-59.93058)]),
                      texCoord=TextureCoordinate(point=[(1.812,.795),(1.812,2.009),(.988,2.009),(.988,.795),(.988,.795),(.988,2.009)])))]),
                Transform(DEF='dad_Object03',
                  children=[
                  Shape(DEF='Object03',
                    appearance=Appearance(
                      texture=ImageTexture(USE='CNTSHIP1_TEX'),
                      material=Material(DEF='material23_mat',ambientIntensity=1,diffuseColor=(1,1,1),shininess=0.100,specularColor=(.89804,.89804,.89804))),
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,4,6,7,-1,7,8,9,-1,4,7,9,-1,10,11,12,-1,12,13,10,-1,14,15,16,-1,16,17,14,-1,18,19,6,-1,18,6,5,-1,18,5,20,-1,18,20,21,-1,22,23,24,-1,25,22,24,-1,26,27,28,-1,29,26,28,-1,24,29,28,-1,24,28,30,-1,25,24,30,-1,31,32,33,-1,34,35,36,-1,36,37,38,-1,34,36,38,-1,34,38,39,-1,33,34,39,-1,31,33,39,-1],creaseAngle=1.178,texCoordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,4,6,7,-1,7,8,9,-1,4,7,9,-1,10,11,12,-1,12,13,10,-1,14,15,16,-1,16,17,14,-1,18,14,6,-1,18,6,5,-1,18,5,0,-1,18,0,19,-1,20,21,22,-1,19,20,22,-1,23,13,24,-1,25,23,24,-1,22,25,24,-1,22,24,26,-1,19,22,26,-1,12,27,28,-1,29,30,31,-1,31,32,33,-1,29,31,33,-1,29,33,34,-1,28,29,34,-1,12,28,34,-1],
                      coord=Coordinate(point=[(-197.59161,33.88198,-80.26035),(-197.59163,48.07245,-80.81641),(-197.59161,48.07245,-70.93247),(-197.59161,33.88198,-70.93247),(-195.00232,30.20273,-80.27216),(-195.0045,30.20273,-80.26035),(-195.0045,-29.94847,-80.26036),(-195.00232,-29.94847,-80.27216),(-192.14374,-29.94847,-88.00656),(-192.14375,30.20271,-88.00656),(-195.00232,33.88198,-21.92472),(-195.00232,-33.62777,-21.92472),(-195.0022,-33.62777,-33.46069),(-195.0022,33.88198,-33.46069),(-197.59161,-33.62777,-80.26036),(-197.59161,-33.62777,-70.93247),(-197.59161,-47.87453,-70.93247),(-197.59161,-47.87453,-80.81641),(-195.00223,-33.62777,-35.1833),(-195.00232,-33.62777,-80.26036),(-195.00232,33.88198,-80.26035),(-195.00223,33.88198,-35.1833),(-217.72273,33.882,-37.11952),(-217.72275,33.882,-45.66152),(-217.72273,44.58703,-45.66152),(-217.72273,33.882,-35.1833),(-217.72273,33.882,-22.07918),(-217.72273,33.882,-33.46069),(-217.72273,44.27398,-33.46069),(-217.72273,44.58703,-22.07918),(-217.72273,44.27398,-35.1833),(-217.72273,-33.62775,-33.46069),(-217.72272,-33.62775,-22.07918),(-217.72273,-44.29026,-22.07918),(-217.72273,-44.29026,-45.66151),(-217.72273,-33.62775,-45.66151),(-217.72273,-33.62775,-37.11953),(-217.72273,-33.62775,-35.1833),(-217.72272,-43.98339,-35.1833),(-217.72272,-43.98339,-33.46069)]),
                      texCoord=TextureCoordinate(point=[(.235,.867),(.204,.872),(.204,.787),(.235,.787),(.243,.867),(.243,.867),(.372,.867),(.372,.867),(.372,.933),(.243,.933),(.235,.369),(.38,.369),(.38,.467),(.235,.467),(.38,.867),(.38,.787),(.41,.787),(.41,.872),(.38,.482),(.235,.482),(.235,.498),(.235,.571),(.212,.571),(.235,.37),(.213,.467),(.212,.37),(.213,.482),(.38,.37),(.402,.37),(.402,.571),(.38,.571),(.38,.498),(.38,.482),(.402,.482),(.402,.467)])))]),
                Transform(DEF='dad_Object04',
                  children=[
                  Shape(DEF='Object04',
                    appearance=Appearance(
                      material=Material(DEF='material24_mat',ambientIntensity=0,diffuseColor=(0,0,0),shininess=0.1,specularColor=(0.89804,0.89804,0.89804))),
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,0,2,3,-1,0,3,4,-1,0,4,5,-1,0,5,6,-1,0,6,7,-1,0,7,8,-1,0,8,9,-1,0,9,10,-1,0,10,11,-1,0,11,12,-1,0,12,1,-1],creaseAngle=1.178,
                      coord=Coordinate(point=[(-249.61313,.23909,-91.07054),(-249.61313,-4.69696,-91.07055),(-253.46944,-4.03566,-91.07055),(-256.29242,-2.22894,-91.07054),(-257.32571,.23909,-91.07054),(-256.29242,2.70712,-91.07055),(-253.46944,4.51384,-91.07054),(-249.61313,5.17515,-91.07054),(-245.75684,4.51384,-91.07054),(-242.93384,2.70712,-91.07055),(-241.90053,.23909,-91.07055),(-242.93382,-2.22894,-91.07055),(-245.75684,-4.03566,-91.07055)])))]),
                Transform(DEF='dad_Object05',
                  children=[
                  Shape(DEF='Object05',
                    appearance=Appearance(
                      material=Material(DEF='material25_mat',ambientIntensity=0.906,diffuseColor=(.90588,.90588,.90588),shininess=0.100,specularColor=(.89804,.89804,.89804))),
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1,8,9,10,-1,10,11,8,-1,8,12,13,-1,13,9,8,-1,10,14,15,-1,15,11,10,-1,10,9,16,-1,16,17,10,-1,8,11,18,-1,18,19,8,-1,20,16,9,-1,21,20,9,-1,21,9,13,-1,22,18,11,-1,23,22,11,-1,23,11,15,-1,12,8,19,-1,12,19,24,-1,12,24,25,-1,14,10,17,-1,14,17,26,-1,14,26,27,-1],creaseAngle=1.178,
                      coord=Coordinate(point=[(-210.51686,48.07248,-70.93246),(-210.51686,33.88201,-70.93246),(-197.59163,33.88198,-70.93247),(-197.59163,48.07245,-70.93247),(-197.59161,-33.62777,-70.93247),(-210.51685,-33.62775,-70.93246),(-210.51683,-47.8745,-70.93246),(-197.59161,-47.87453,-70.93247),(-192.58164,44.27398,-35.1833),(-192.58164,44.27398,-33.46069),(-192.5816,-43.98341,-33.46069),(-192.5816,-43.98341,-35.1833),(-217.72275,44.27398,-35.1833),(-217.72275,44.27398,-33.46069),(-217.72272,-43.98339,-33.46069),(-217.72272,-43.98339,-35.1833),(-195.00221,33.88198,-33.46069),(-195.0022,-33.62777,-33.46069),(-195.00223,-33.62777,-35.1833),(-195.00224,33.88198,-35.1833),(-195.61183,33.88198,-33.46069),(-217.72275,33.882,-33.46069),(-195.70282,-33.62777,-35.1833),(-217.72273,-33.62775,-35.1833),(-195.70285,33.88198,-35.1833),(-217.72275,33.882,-35.1833),(-195.61182,-33.62777,-33.46069),(-217.72273,-33.62775,-33.46069)])))]),
                Transform(DEF='dad_Object06',
                  children=[
                  Shape(DEF='Object06',
                    appearance=Appearance(
                      material=Material(DEF='material26_mat',ambientIntensity=0.387,diffuseColor=(.48628,.36863,.27451),shininess=0.100,specularColor=(.89804,.89804,.89804))),
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1,8,9,10,-1,10,11,8,-1,12,13,14,-1,14,15,12,-1,16,17,18,-1,19,16,18,-1,19,18,20,-1,21,19,20,-1,21,20,22,-1,23,21,22,-1,24,23,22,-1,24,22,25,-1,25,26,27,-1,24,25,27,-1],creaseAngle=1.178,
                      coord=Coordinate(point=[(-197.59161,30.20271,-80.26041),(-197.59161,33.88198,-80.26041),(-195.00232,33.88198,-80.26041),(-195.0045,30.20273,-80.26041),(-235.83899,30.2027,-80.26041),(-235.83899,33.882,-80.26041),(-210.51685,33.882,-80.26041),(-210.51685,30.20271,-80.26041),(-235.83897,-33.62775,-80.26041),(-235.83897,-29.94848,-80.26041),(-210.51682,-29.95201,-80.26407),(-210.51682,-33.62775,-80.26041),(-195.0045,-29.94847,-80.26041),(-195.00232,-33.62778,-80.26041),(-197.59161,-33.62777,-80.26041),(-197.59161,-29.95379,-80.26595),(-223.57423,-33.62778,-45.66154),(-217.72272,-33.62775,-45.66154),(-217.72267,-44.29026,-45.66154),(-235.83888,-33.62775,-45.66154),(-278.46924,-44.29028,-45.66153),(-235.83894,-32.12282,-45.66154),(-278.46933,44.58704,-45.66154),(-235.83899,-7.51901,-45.66154),(-235.83899,33.882,-45.66154),(-217.72275,44.58703,-45.66154),(-217.72272,33.882,-45.66154),(-223.57425,33.88197,-45.66154)])))]),
                Transform(DEF='dad_Object07',
                  children=[
                  Shape(DEF='Object07',
                    appearance=Appearance(
                      material=Material(DEF='material27_mat',ambientIntensity=0.906,diffuseColor=(.90588,.90588,.90588),shininess=0.100,specularColor=(.89804,.89804,.89804))),
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,1,0,-1,0,5,4,-1],creaseAngle=1.178,
                      coord=Coordinate(point=[(-235.83899,30.2027,-80.26041),(-235.83899,-29.94848,-80.26041),(-235.83899,-29.94848,-79.95629),(-235.83899,30.2027,-79.95629),(-235.83893,-29.94848,-88.00661),(-235.83899,30.2027,-88.00661)])))]),
                Transform(DEF='dad_Object08',
                  ...
                  Shape(DEF='Object08',
                    ...
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1,8,9,10,-1,10,11,8,-1,4,12,13,-1,4,13,14,-1,5,4,14,-1,15,16,7,-1,7,6,15,-1],creaseAngle=1.178,texCoordIndex=[0,1,2,-1,2,3,0,-1,4,5,6,-1,6,7,4,-1,8,9,10,-1,10,11,8,-1,4,12,0,-1,4,0,13,-1,5,4,13,-1,14,15,7,-1,7,6,14,-1],
                      coord=Coordinate(point=[(-210.51685,-33.62775,-80.26041),(-210.51683,-47.8745,-80.81647),(-210.51683,-47.8745,-70.93247),(-210.51683,-33.62775,-70.93247),(-235.83897,-29.94848,-79.95629),(-235.83897,-32.12282,-45.66154),(-235.83897,-7.51901,-45.66154),(-235.83897,30.2027,-79.95629),(-210.51685,33.882,-80.26041),(-210.51685,33.882,-70.93247),(-210.51685,48.07248,-70.93247),(-210.51685,48.07248,-80.81647),(-235.83897,-29.94848,-80.26041),(-235.83897,-33.62775,-80.26041),(-235.83897,-33.62775,-45.66154),(-235.83897,33.882,-45.66154),(-235.83897,33.882,-80.26041)]),
                      texCoord=TextureCoordinate(point=[(.851,.87),(1,.877),(1,.747),(.851,.747),(.813,.866),(.835,.417),(.579,.417),(.187,.866),(.148,.87),(.148,.747),(.001,.747),(.001,.877),(.813,.87),(.851,.417),(.148,.417),(.148,.87)])))]),
                Transform(DEF='dad_Object09',
                  children=[
                  Shape(DEF='Object09',
                    appearance=Appearance(
                      texture=ImageTexture(USE='CNTSHIP1_TEX'),
                      material=Material(DEF='material29_mat',ambientIntensity=0.588,diffuseColor=(.58823,.58823,.58823),shininess=0.100,specularColor=(.89804,.89804,.89804))),
                    geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,2,3,0,-1],creaseAngle=1.178,texCoordIndex=[0,1,2,-1,2,3,0,-1],
                      coord=Coordinate(point=[(-278.4693,44.58704,-22.07921),(-278.4693,44.58704,-45.66157),(-278.4693,-44.29028,-45.66157),(-278.4693,-44.29028,-22.07921)]),
                      texCoord=TextureCoordinate(point=[(.296,.121),(.296,.379),(.99,.379),(.99,.121)])))]),
                Transform(DEF='dad_Object10',
                  children=[
                  Shape(DEF='Object10',
                    appearance=Appearance(
                      material=Material(DEF='material30_mat',ambientIntensity=0.387,diffuseColor=(.48628,.36863,.27451),shininess=0.100,specularColor=(.89804,.89804,.89804))),
...
print ("python x3d.py load successful for ContainerShip.py")

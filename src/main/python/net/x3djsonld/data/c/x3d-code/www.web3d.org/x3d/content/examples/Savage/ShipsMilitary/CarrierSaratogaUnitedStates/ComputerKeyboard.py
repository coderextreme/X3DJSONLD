...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/CarrierSaratogaUnitedStates/ComputerKeyboard.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(rotation=(1,0,0,1.571),
      ...
      Transform(scale=(1,2,1),translation=(0.286667,-1.8,0.055),
        children=[
        Transform(USE='EscapeButton')])]),
    ROUTE(fromField='touchTime',fromNode='Touch_esc',toField='set_startTime',toNode='push'),

...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='This tests check the boundary condition of 500 children per grouping node. A Group is defined with 500 children in its "children" field. Section 7.3 (Minimum Support Requirements) of the VRML specifications 500 children within a single grouping node. The test should generate 500 default color spheres and radius 0.3 meters.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/GroupingNodes/Group/bound_500.x3d',name='identifier'),

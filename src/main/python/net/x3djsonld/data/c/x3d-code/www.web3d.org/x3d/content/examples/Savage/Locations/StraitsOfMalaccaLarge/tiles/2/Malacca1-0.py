...
newModel=X3D(profile='Immersive',version='3.1',
  ...
  Scene=Scene(
    children=[
    GeoViewpoint(description='GeoViewpoint_2_10',geoSystem=['GDC'],position=(-1.6675815493135304,94.8330000960161,448023.77127998613),orientation=(-1,0,0,1.57),
      geoOrigin=GeoOrigin(DEF='ORIGIN',geoCoords=(0.3471685463819618,100.89750038406439,0),geoSystem=['GDC'])),
    GeoLOD(center=(-1.6675815493135304,94.8330000960161,0.0),range=537628.5,child1Url=['../../tiles/3/Malacca2-0.x3d'],child2Url=['../../tiles/3/Malacca2-1.x3d'],child3Url=['../../tiles/3/Malacca3-0.x3d'],child4Url=['../../tiles/3/Malacca3-1.x3d'],

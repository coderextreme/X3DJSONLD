...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Sovremenny.x3d',name='title'),
    meta(content='Kevin Anderson and Mike Whitecar',name='creator'),
    ...
    meta(content='https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/Sovremenny.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Group(DEF='ViewPoints',
      ...
      Transform(rotation=(1,0,0,-0.2),
        children=[
        Viewpoint(DEF='BroadView',description='Sovremenny Broad View',jump=False,position=(-5,20,170))]),
      Transform(rotation=(1,0,0,-0.65),
        children=[
        Viewpoint(DEF='CloseUpView',description='Close Up View',jump=False,position=(-10,14,80))]),
      Transform(rotation=(1,0,0,-.8),
        children=[
        Viewpoint(DEF='OverHead',description='OverHead',jump=False,position=(-7,30,100))]),
      Transform(rotation=(0,1,0,-1.57),
        children=[
        Transform(rotation=(1,0,0,-.3),
          children=[
          Viewpoint(DEF='BridgeView',description='Bridge View',jump=False,position=(0,23,11))])]),
      Transform(rotation=(0,1,0,1.57),
        children=[
        Transform(rotation=(1,0,0,-.2),
          children=[
          Viewpoint(DEF='FrontView',description='Front View',jump=False,position=(0,23,115))])]),
      Transform(rotation=(0,1,0,1.2),
        children=[
        Transform(rotation=(1,0,0,-.2),
          children=[
          Viewpoint(DEF='FrontOffSet',description='Off Set Front View',jump=False,position=(0,23,115))])]),
      Transform(rotation=(0,1,0,-1.57),
        children=[
        Transform(rotation=(1,0,0,-.1),
          children=[
          Viewpoint(DEF='AftView',description='Aft View',jump=False,position=(0,13,115))])])]),
    Group(DEF='HullGroup',
      children=[
    ...
    Group(DEF='SuperStructureGroup',
      ...
      Transform(scale=(1.5,1,1.5),translation=(-38.2,10.05,0),
        children=[
        Shape(DEF='FlightDeckCircle',
          appearance=Appearance(DEF='White',
            material=Material(diffuseColor=(1,1,1))),
          geometry=Extrusion(ccw=False,creaseAngle=1.3,crossSection=[(-.4,0),(.4,0),(.4,-.1),(-.4,-.1),(-.4,0)],spine=[(2.00,0.0,0.00),(1.85,0.0,0.77),(1.41,0.0,1.41),(0.77,0.0,1.85),(0.00,0.0,2.00),(-0.77,0.0,1.85),(-1.41,0.0,1.41),(-1.85,0.0,0.77),(-2.00,0.0,0.00),(-1.85,0.0,-0.77),(-1.41,0.0,-1.41),(-0.77,0.0,-1.85),(0.00,0.0,-2.00),(0.77,0.0,-1.85),(1.41,0.0,-1.41),(1.85,0.0,-0.77),(2.00,0.0,0.00)])),
        Transform(translation=(0,-.1,0),
          children=[
          Shape(
            appearance=Appearance(USE='White'),
            geometry=Box(size=(.7,.2,8.8)))])]),
      Transform(scale=(3.5,1,3.5),translation=(-38.2,10.05,0),
        children=[
        Shape(
          appearance=Appearance(USE='White'),
          geometry=Extrusion(ccw=False,creaseAngle=1.3,crossSection=[(-.17,0),(.17,0),(.17,-.1),(-.17,-.1),(-.17,0)],spine=[(2.00,0.0,0.00),(1.85,0.0,0.77),(1.41,0.0,1.41),(0.77,0.0,1.85),(0.00,0.0,2.00),(-0.77,0.0,1.85),(-1.41,0.0,1.41),(-1.85,0.0,0.77),(-2.00,0.0,0.00),(-1.85,0.0,-0.77),(-1.41,0.0,-1.41),(-0.77,0.0,-1.85),(0.00,0.0,-2.00),(0.77,0.0,-1.85),(1.41,0.0,-1.41),(1.85,0.0,-0.77),(2.00,0.0,0.00)]))]),
      ...
      Transform(translation=(-21,17,0),
        children=[
        Shape(DEF='RaydomeDeck',
          appearance=Appearance(
            material=Material(diffuseColor=(.55,.53,.5))),
          geometry=Box(size=(2,.25,12)))]),
      ...
      Shape(DEF='InnerExaustStrucure',
        ...
        geometry=Extrusion(creaseAngle=.55,crossSection=[(-24.51,-2.38),(-24.51,2.38),(-23.3,3.63),(-15.93,3.63),(-14.75,2.38),(-14.75,-2.38),(-15.93,-3.63),(-23.3,-3.63),(-24.51,-2.38)],spine=[(0,18.8,0),(0,21,0)])),
    ...
    Group(DEF='AuxEquipment',
      children=[
      Transform(rotation=(0,1,0,1.57),translation=(12.35,16.2,0),
        children=[
        Group(DEF='TwoWindowSection',
          children=[
          Transform(translation=(-.75,0,0),
            children=[
            Shape(DEF='Window',
              appearance=Appearance(DEF='DarkGlass',
                material=Material(diffuseColor=(.15,.15,.15),transparency=.25)),
              geometry=Box(size=(1.3,.9,.2)))]),
          Transform(translation=(.75,0,0),
            children=[
            Shape(USE='Window')])])]),
      Transform(translation=(8.14,16.2,4.9),
        children=[
        Group(USE='TwoWindowSection')]),
      Transform(translation=(8.14,16.2,-4.9),
        children=[
        Group(USE='TwoWindowSection')]),
      Transform(rotation=(0,1,0,.7834),translation=(11.121,16.2,3.625),
        children=[
        Group(USE='TwoWindowSection')]),
      Transform(rotation=(0,1,0,-.7834),translation=(11.121,16.2,-3.625),
        children=[
        Group(USE='TwoWindowSection')]),
      Transform(DEF='BridgeRaydom',translation=(10,18.5,0),
        children=[
        Shape(
          appearance=Appearance(USE='White'),
          geometry=Cylinder(height=2.4,radius=2.1)),
        Transform(translation=(0,1.2,0),
          children=[
          Shape(
            appearance=Appearance(USE='White'),
            geometry=Sphere(radius=2.1))])]),
      Group(DEF='Fwd04LvlDome',
        children=[
        Transform(scale=(.9,1.2,.9),translation=(18.44,12.1,0),
          children=[
          Shape(
            appearance=Appearance(USE='HullGrey'),
            geometry=Sphere(radius=1.6))]),
        Transform(translation=(18.44,13.56,0),
          children=[
          Shape(
            appearance=Appearance(USE='HullGrey'),
            geometry=Cylinder(height=1,radius=.6))]),
        Transform(translation=(18.44,14.21,0),
          children=[
          Shape(
            appearance=Appearance(USE='HullGrey'),
            geometry=Cylinder(height=.3,radius=.9))])]),
      Group(DEF='Fwd04LvlAntenna',
        children=[
        Transform(translation=(21.6,15.4,0),
          children=[
          Shape(
            appearance=Appearance(USE='White'),
            geometry=Cylinder(height=5,radius=.2))]),
        Transform(rotation=(-0.80,-0.18,-0.57,0.75),translation=(20.9,13.9,.75),
          children=[
          Shape(
            appearance=Appearance(USE='White'),
            geometry=Cylinder(height=2.83,radius=.15))]),
        Transform(rotation=(0.80,0.18,-0.57,0.75),translation=(20.9,13.9,-.75),
          children=[
          Shape(
            appearance=Appearance(USE='White'),
            geometry=Cylinder(height=2.83,radius=.15))]),
        Transform(translation=(21.6,18.2,0),
          children=[
          Shape(
            appearance=Appearance(USE='White'),
            geometry=Sphere(radius=.5))])])]),
    Group(DEF='InlineObjects',
      children=[
      Transform(translation=(-7.2,17.2,0),
        children=[
        Inline(url=["Superstructure.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/Superstructure.wrl","Superstructure.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/Superstructure.x3d"])]),
      Transform(scale=(.9,1,.9),translation=(-26.37,18.8,0),
        children=[
        Inline(url=["AntennaMast.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/AntennaMast.wrl","AntennaMast.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/AntennaMast.x3d"])]),
      Transform(scale=(1.1,.9,1),translation=(-10,8.4,7),
        children=[
        Inline(DEF='CaptainsBarge',url=["CaptainsBarge.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/CaptainsBarge.wrl","CaptainsBarge.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/CaptainsBarge.x3d"])]),
      Transform(scale=(1.1,.9,1),translation=(-10,8.4,-7),
        children=[
        Inline(USE='CaptainsBarge')]),
      Transform(translation=(-38,11.5,0),
        children=[
        Inline(url=["Helix.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/Helix.x3d","Helix.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/Helix.wrl"])])]),
    Group(DEF='InlineWeapons',
      children=[
      Transform(translation=(42,7,0),
        children=[
        Inline(DEF='GunAK130',url=["GunAK130.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/GunAK130.wrl","GunAK130.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/GunAK130.x3d"])]),
      Transform(rotation=(0,1,0,3.14),translation=(-65.5,4.1,0),
        children=[
        Inline(USE='GunAK130')]),
      Transform(rotation=(0,0,1,0.2),scale=(1.4,1.3,1.3),translation=(15.9,5.25,7.35),
        children=[
        Inline(DEF='MissileSS-N-22',url=["MissileSSN22.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/MissileSSN22.wrl","MissileSSN22.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/MissileSSN22.x3d"])]),
      Transform(rotation=(0,0,1,0.2),scale=(1.4,1.3,1.3),translation=(15.9,5.25,-7.35),
        children=[
        Inline(USE='MissileSS-N-22')]),
      Transform(translation=(26,10.2,0),
        children=[
        Inline(DEF='MissileSA-N-7',url=["MissileSAN7.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/MissileSAN7.wrl","MissileSAN7.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/MissileSAN7.x3d"])]),
      Transform(rotation=(0,1,0,3.14),translation=(-52.7,7.3,0),
        children=[
        Inline(USE='MissileSA-N-7')]),
      Transform(rotation=(0,-1,0,2.18),translation=(-30.86,10,8.5),
        children=[
        Inline(DEF='GunAK630',url=["GunAK630.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/GunAK630.wrl","GunAK630.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/GunAK630.x3d"])]),
      Transform(rotation=(0,-1,0,0.70),translation=(13,11.2,3.8),
        children=[
        Inline(USE='GunAK630')]),
      Transform(rotation=(0,1,0,2.18),translation=(-30.86,10,-8.5),
        children=[
      ...
      Transform(rotation=(0,1,0,0.70),translation=(13,11.2,-3.8),
        children=[
        Inline(USE='GunAK630')]),
      Transform(translation=(6.16,20,0),
        children=[
        Inline(DEF='MR114Radar',url=["RadarMR114.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/RadarMR114.wrl","RadarMR114.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/RadarMR114.x3d"])]),
      Transform(rotation=(0,1,0,-1.57),scale=(.65,.65,.65),translation=(-10.1,14,3.3),
        children=[
        Inline(USE='MR114Radar')]),
      Transform(rotation=(0,1,0,1.57),scale=(.65,.65,.65),translation=(-10.1,14,-3.3),
        children=[
        Inline(USE='MR114Radar')]),
      Transform(scale=(1.5,1.5,1.5),translation=(-.5,9.8,8),
        children=[
        Inline(DEF='TCylinderRaydome',url=["TCylinderRaydome.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/TCylinderRaydome.wrl","TCylinderRaydome.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/TCylinderRaydome.x3d"])]),
      Transform(rotation=(0,1,0,3.14),scale=(1.5,1.5,1.5),translation=(-.5,9.8,-8),
        children=[
        Inline(USE='TCylinderRaydome')]),
      Transform(rotation=(0,1,0,-1.3),scale=(1.5,1.5,1.5),translation=(-25.5,13,5.8),
        children=[
        Inline(DEF='YBaseRaydome',url=["YBaseRaydome.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/YBaseRaydome.wrl","YBaseRaydome.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/YBaseRaydome.x3d"])]),
      Transform(rotation=(0,1,0,4.44),scale=(1.5,1.5,1.5),translation=(-25.5,13,-5.8),
        children=[
        Inline(USE='YBaseRaydome')]),
      Transform(rotation=(0,1,0,-.9),scale=(1.4,1.4,1.4),translation=(-21,17.1,5),
        children=[
        Inline(DEF='GlobeRaydome',url=["GlobeRaydome.wrl","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/GlobeRaydome.wrl","GlobeRaydome.x3d","https://savage.nps.edu/Savage/ShipsMilitary/DestroyerSovremennyRussia/GlobeRaydome.x3d"])]),
      Transform(rotation=(0,1,0,-.9),scale=(1.4,1.4,1.4),translation=(-21,17.1,-5),
        children=[
        Inline(USE='GlobeRaydome')])])])
) # X3D model complete

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='keeplastframe.x3d',name='title'),
    meta(content='keeplastframe-movie.mpg',name='MovingImage'),
    ...
    meta(content='Test if the last frame loaded when the movie becomes inactive remains as the texture. The VTS logo should appear skewed, with the V appearing closest to the viewer.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/keeplastframe.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='keeplastframe.x3d'),
      ...
      Transform(DEF='Cube',
        ...
        Shape(
          appearance=Appearance(
            texture=MovieTexture(DEF='Movie',loop=True,url=["vts-short.mpg","https://www.web3d.org/x3d/content/examples/ConformanceNist/Appearance/MovieTexture/vts-short.mpg"])),
          geometry=Box(),)])]),
    Group(
      children=[
...
print ("python x3d.py load successful for keeplastframe.py")

...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='SupertankerMediumDetail.x3d',name='title'),
    meta(content='Andrew Wiest',name='creator'),
    meta(content='6 May 2001',name='created'),
    meta(content='21 February 2016',name='modified'),
    meta(content='Supertanker model based on Exxon Valdez, medium detail.',name='description'),
    meta(content='https://savage.nps.edu/Savage/ShipsCivilian/Supertanker/SupertankerMediumDetail.x3d',name='identifier'),
    meta(content='X3D-Edit 3.2, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    Background(skyColor=[(.7,.8,.95)]),
    Viewpoint(description='Supertanker Medium Detail',orientation=(-0.429808,0.899118,0.0827735,0.422004),position=(150,50,250)),
    ...
    Transform(DEF='ShipSUpertankerMasterNode',
      ...
      Transform(DEF='MainHull',
        ...
        Transform(rotation=(0,1,0,.7),translation=(153,3,23.7),
          ...
          Viewpoint(description='Starboard ship name',orientation=(-0.365482,0.92973,0.0449929,0.263289),position=(7,2,20))]),
        Transform(rotation=(0,1,0,2.47),translation=(153,3,-23.5),
          ...
          Shape(
            ...
            appearance=Appearance(
              material=Material(diffuseColor=(1,1,1)))),
          Viewpoint(description='Port ship name',orientation=(0,1,0,.5),position=(7,3,20))])]),
...
print ("python x3d.py load successful for SupertankerMediumDetail.py")

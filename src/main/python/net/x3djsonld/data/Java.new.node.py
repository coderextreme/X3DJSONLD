...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='6 June 2018',name='modified'),
    ...
    meta(content='X3dValidator https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/Java.x3d',name='reference'),
    ...
    meta(content='06 June 2018',name='translated'),
...
print('Self-test diagnostics for Java.py:')
...
print("python Java.py load and self-test diagnostics complete.")

...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    ...
    meta(content='skeleton10.x3d',name='title'),
    meta(name='identifier',content='http://www.web3d.org/x3d/content/examples/HumanoidAnimation/skeleton10.x3d'),
...
print('Self-test diagnostics for skeleton10.py:')
...
print("python skeleton10.py load and self-test diagnostics complete.")

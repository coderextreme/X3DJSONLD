...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    ...
    meta(content='http://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_entire.x3d',name='identifier'),

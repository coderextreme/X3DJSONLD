...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='DiamondManLOA_0.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA_0.x3d',name='identifier'),
...
print('Self-test diagnostics for DiamondManLOA_0.py:')
...
print("python DiamondManLOA_0.py load and self-test diagnostics complete.")

...
#
#   $ python HeadsUpDisplayPrototype.py
#
  ...
  Scene=Scene(
    ...
    ProtoDeclare(name='HeadsUpDisplay',appinfo='HeadsUpDisplay positions child geometry in screen space, movable by the user',
      ProtoInterface=ProtoInterface(
        field=[
        field(name='children',accessType='inputOutput',appinfo='Displayed subscene positioned as a HUD.',type='MFNode',
          #  default is null array of nodes 
          ),
        field(name='dragChildren',accessType='inputOutput',appinfo='Additional HUD geometry which can be touched and dragged for repositioning. If this geometry goes offscreen (perhaps due to screen resizing) then it snaps back to original position.',type='MFNode',
          #  default is null array of nodes 
          ),
      ...
      ProtoBody=ProtoBody(
        ...
        Group(
          children=[
          ProximitySensor(DEF='WhereSensor',size=(1.0E9,1.0E9,1.0E9),
            IS=IS(
              connect=[

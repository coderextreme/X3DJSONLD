...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='BoxMan3.x3d',name='title'),
    ...
    meta(content='6 January 2023',name='modified'),
    meta(content='http://HAnim.org',name='reference'),
    meta(content='originals/boxman.wrl',name='reference'),
    meta(content='BoxMan3.js',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Script(DEF='ENGINE',directOutput=True,url=["BoxMan3.js","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan3.js"],
      field=[
...
print('Self-test diagnostics for BoxMan3.py:')
...
print("python BoxMan3.py load and self-test diagnostics complete.")

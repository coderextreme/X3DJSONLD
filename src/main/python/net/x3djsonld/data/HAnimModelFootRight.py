...
newModel=X3D(profile='Immersive',version='4.0',
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='Humanoid_Right_Foot',jointBindingPositions=[(0,0,0)],jointBindingRotations=[(0,0,1,0)],jointBindingScales=[(1,1,1)],loa=-1,name='Humanoid_Right_Foot',skeletalConfiguration='BASIC',version='2.0',
      skeleton=[
      HAnimJoint(DEF='hanim_HumanoidRoot',name='humanoid_root',
        children=[
        HAnimJoint(DEF='r_talocrural_joint',name='r_talocrural_joint',
          children=[
          HAnimSegment(DEF='r_talus',name='r_talus',
            children=[
            Transform(
              children=[
          ...
          #  TCN 
          HAnimJoint(DEF='r_talocalcaneonavicular_joint',center=(0.0,-0.3,0),name='r_talocalcaneonavicular_joint',
            children=[
            HAnimSegment(DEF='r_navicular',name='r_navicular',
              children=[
            ...
            #  CN1 
            HAnimJoint(DEF='r_cuneonavicular_joint1',center=(0.1,-0.45,0),name='r_cuneonavicular_joint1',
              children=[
              HAnimSegment(DEF='r_cuneiform1',name='r_cuneiform1',
                children=[
              ...
              HAnimJoint(DEF='r_tarsometatarsal_joint1',center=(0.1,-0.6,0),name='r_tarsometatarsal_joint1',
                children=[
                HAnimSegment(DEF='r_metatarsal1',name='r_metatarsal1',
                  children=[
                ...
                HAnimJoint(DEF='r_metatarsophalangeal_joint1',center=(0.1,-0.9,0),name='r_metatarsophalangeal_joint1',
                  children=[
                  ...
                  HAnimJoint(DEF='r_f_Interphalangeal_joint',center=(0.1,-1.05,0),name='r_f_Interphalangeal_joint',
                    children=[
            ...
            #  CN2 
            HAnimJoint(DEF='r_cuneonavicular_joint2',center=(0.0,-0.45,0),name='r_cuneonavicular_joint2',
              children=[
              HAnimSegment(DEF='r_cuneiform2',name='r_cuneiform2',
                children=[
              ...
              HAnimJoint(DEF='r_tarsometatarsal_joint2',center=(-0.05,-0.6,0),name='r_tarsometatarsal_joint2',
                children=[
                HAnimSegment(DEF='r_metatarsal2',name='r_metatarsal2',
                  children=[
                ...
                HAnimJoint(DEF='r_metatarsophalangeal_joint2',center=(-0.05,-0.9,0),name='r_metatarsophalangeal_joint2',
                  children=[
                  ...
                  HAnimJoint(DEF='r_f_proximal_Interphalangeal_joint2',center=(-0.05,-1.05,0),name='r_f_proximal_Interphalangeal_joint2',
                    children=[
                    ...
                    HAnimJoint(DEF='r_f_distal_Interphalangeal_joint2',center=(-0.05,-1.12,0),name='r_f_distal_Interphalangeal_joint2',
                      children=[
            ...
            #  CN3 
            HAnimJoint(DEF='r_cuneonavicular_joint3',center=(-0.1,-0.4,0),name='r_cuneonavicular_joint3',
              children=[
              HAnimSegment(DEF='r_cuneiform3',name='r_cuneiform3',
                children=[
              ...
              HAnimJoint(DEF='r_tarsometatarsal_joint3',center=(-0.15,-0.6,0),name='r_tarsometatarsal_joint3',
                children=[
                HAnimSegment(DEF='r_metatarsal3',name='r_metatarsal3',
                  children=[
                ...
                HAnimJoint(DEF='r_metatarsophalangeal_joint3',center=(-0.15,-0.9,0),name='r_metatarsophalangeal_joint3',
                  children=[
                  ...
                  HAnimJoint(DEF='r_f_proximal_Interphalangeal_joint3',center=(-0.15,-1.05,0),name='r_f_proximal_Interphalangeal_joint3',
                    children=[
                    ...
                    HAnimJoint(DEF='r_f_distal_Interphalangeal_joint3',center=(-0.15,-1.13,0),name='r_f_distal_Interphalangeal_joint3',
                      children=[
          ...
          #  CC 
          HAnimJoint(DEF='r_calcaneuscuboid_joint',center=(-0.2,0.3,0),name='r_calcaneuscuboid_joint',
            children=[
            HAnimSegment(DEF='r_calcaneus',name='r_calcaneus',
              children=[
            ...
            #  TT 
            HAnimJoint(DEF='r_transverse_tarsal_joint',center=(-0.21,-0.3,0),name='r_transverse_tarsal_joint',
              children=[
              HAnimSegment(DEF='r_cuboid',name='r_cuboid',
                children=[
              ...
              #  TMT4 
              HAnimJoint(DEF='r_tarsometatarsal_joint4',center=(-0.25,-0.58,0),name='r_tarsometatarsal_joint4',
                children=[
                HAnimSegment(DEF='r_metatarsal4',name='r_metatarsal4',
                  children=[
                ...
                HAnimJoint(DEF='r_metatarsophalangeal_joint4',center=(-0.25,-0.87,0),name='r_metatarsophalangeal_joint4',
                  children=[
                  ...
                  HAnimJoint(DEF='r_f_proximal_Interphalangeal_joint4',center=(-0.25,-1.0,0),name='r_f_proximal_Interphalangeal_joint4',
                    children=[
                    ...
                    HAnimJoint(DEF='r_f_distal_Interphalangeal_joint4',center=(-0.25,-1.1,0),name='r_f_distal_Interphalangeal_joint4',
                      children=[
                      HAnimSegment(DEF='r_distal_phalanges4',name='r_distal_phalanges4',
                        children=[
              ...
              #  TMT5 
              HAnimJoint(DEF='r_tarsometatarsal_joint5',center=(-0.33,-0.52,0),name='r_tarsometatarsal_joint5',
                children=[
                HAnimSegment(DEF='r_metatarsal5',name='r_metatarsal5',
                  children=[
                ...
                HAnimJoint(DEF='r_metatarsophalangeal_joint5',center=(-0.34,-0.8,0),name='r_metatarsophalangeal_joint5',
                  children=[
                  HAnimSegment(DEF='r_proximal_phalanges5',name='r_proximal_phalanges5',
                    children=[
                  ...
                  HAnimJoint(DEF='r_f_proximal_Interphalangeal_joint5',center=(-0.34,-0.95,0),name='r_f_proximal_Interphalangeal_joint5',
                    children=[
                    ...
                    HAnimJoint(DEF='r_f_distal_Interphalangeal_joint5',center=(-0.34,-1.05,0),name='r_f_distal_Interphalangeal_joint5',
                      children=[
      ...
      HAnimJoint(USE='r_talocrural_joint'),
      HAnimJoint(USE='r_talocalcaneonavicular_joint'),
      HAnimJoint(USE='r_cuneonavicular_joint1'),
      HAnimJoint(USE='r_tarsometatarsal_joint1'),
      HAnimJoint(USE='r_metatarsophalangeal_joint1'),
      HAnimJoint(USE='r_f_Interphalangeal_joint'),
      HAnimJoint(USE='r_cuneonavicular_joint2'),
      HAnimJoint(USE='r_tarsometatarsal_joint2'),
      HAnimJoint(USE='r_metatarsophalangeal_joint2'),
      HAnimJoint(USE='r_f_proximal_Interphalangeal_joint2'),
      HAnimJoint(USE='r_f_distal_Interphalangeal_joint2'),
      HAnimJoint(USE='r_cuneonavicular_joint3'),
      HAnimJoint(USE='r_tarsometatarsal_joint3'),
      HAnimJoint(USE='r_metatarsophalangeal_joint3'),
      HAnimJoint(USE='r_f_proximal_Interphalangeal_joint3'),
      HAnimJoint(USE='r_f_distal_Interphalangeal_joint3'),
      HAnimJoint(USE='r_calcaneuscuboid_joint'),
      HAnimJoint(USE='r_transverse_tarsal_joint'),
      HAnimJoint(USE='r_tarsometatarsal_joint4'),
      HAnimJoint(USE='r_metatarsophalangeal_joint4'),
      HAnimJoint(USE='r_f_proximal_Interphalangeal_joint4'),
      HAnimJoint(USE='r_f_distal_Interphalangeal_joint4'),
      HAnimJoint(USE='r_tarsometatarsal_joint5'),
      HAnimJoint(USE='r_metatarsophalangeal_joint5'),
      HAnimJoint(USE='r_f_proximal_Interphalangeal_joint5'),
      HAnimJoint(USE='r_f_distal_Interphalangeal_joint5')],
      segments=[
      HAnimSegment(USE='r_talus'),
      HAnimSegment(USE='r_navicular'),
      HAnimSegment(USE='r_cuneiform1'),
      HAnimSegment(USE='r_metatarsal1'),
      HAnimSegment(USE='r_proximal_phalanges1'),
      HAnimSegment(USE='r_distal_phalanges1'),
      HAnimSegment(USE='r_cuneiform2'),
      HAnimSegment(USE='r_metatarsal2'),
      HAnimSegment(USE='r_proximal_phalanges2'),
      HAnimSegment(USE='r_middle_phalanges2'),
      HAnimSegment(USE='r_distal_phalanges2'),
      HAnimSegment(USE='r_cuneiform3'),
      HAnimSegment(USE='r_metatarsal3'),
      HAnimSegment(USE='r_proximal_phalanges3'),
      HAnimSegment(USE='r_middle_phalanges3'),
      HAnimSegment(USE='r_distal_phalanges3'),
      HAnimSegment(USE='r_calcaneus'),
      HAnimSegment(USE='r_cuboid'),
      HAnimSegment(USE='r_metatarsal4'),
      HAnimSegment(USE='r_proximal_phalanges4'),
      HAnimSegment(USE='r_middle_phalanges4'),
      HAnimSegment(USE='r_distal_phalanges4'),
      HAnimSegment(USE='r_metatarsal5'),

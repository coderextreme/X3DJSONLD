...
newModel=X3D(profile='Immersive',version='4.0',
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='hanim_Foot_Right',loa=4,name='Foot_Right',version='2.0',
      ...
      skeleton=[
      HAnimJoint(DEF='hanim_humanoid_root',name='humanoid_root',stiffness=[0,0,0],
        #  Might consider putting a HAnimSegment here, but that doesn't help with re-use of this foot model 
        children=[
        HAnimJoint(DEF='hanim_r_talocrural',description='connection joint of foot to leg above',name='r_talocrural',stiffness=[0,0,0],
          children=[
          ...
          #  TCN 
          HAnimJoint(DEF='hanim_r_talocalcaneonavicular',center=(0.0,-0.3,0),name='r_talocalcaneonavicular',stiffness=[0,0,0],
            children=[
            ...
            #  CN1 
            HAnimJoint(DEF='hanim_r_cuneonavicular_1',center=(0.1,-0.45,0),name='r_cuneonavicular_1',stiffness=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_tarsometatarsal_1',center=(0.1,-0.6,0),name='r_tarsometatarsal_1',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_1',center=(0.1,-0.9,0),name='r_metatarsophalangeal_1',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_interphalangeal_1',center=(0.1,-1.05,0),name='r_tarsal_interphalangeal_1',stiffness=[0,0,0],
                    children=[
            ...
            #  CN2 
            HAnimJoint(DEF='hanim_r_cuneonavicular_2',center=(0.0,-0.45,0),name='r_cuneonavicular_2',stiffness=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_tarsometatarsal_2',center=(-0.05,-0.6,0),name='r_tarsometatarsal_2',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_2',center=(-0.05,-0.9,0),name='r_metatarsophalangeal_2',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_2',center=(-0.05,-1.05,0),name='r_tarsal_proximal_interphalangeal_2',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_2',center=(-0.05,-1.12,0),name='r_tarsal_distal_interphalangeal_2',stiffness=[0,0,0],
                      children=[
            ...
            #  CN3 
            HAnimJoint(DEF='hanim_r_cuneonavicular_3',center=(-0.1,-0.4,0),name='r_cuneonavicular_3',stiffness=[0,0,0],
              children=[
              ...
              HAnimJoint(DEF='hanim_r_tarsometatarsal_3',center=(-0.15,-0.6,0),name='r_tarsometatarsal_3',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_3',center=(-0.15,-0.9,0),name='r_metatarsophalangeal_3',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_3',center=(-0.15,-1.05,0),name='r_tarsal_proximal_interphalangeal_3',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_3',center=(-0.15,-1.13,0),name='r_tarsal_distal_interphalangeal_3',stiffness=[0,0,0],
                      children=[
          ...
          #  CC 
          HAnimJoint(DEF='hanim_r_calcaneocuboid',center=(-0.2,0.3,0),name='r_calcaneocuboid',stiffness=[0,0,0],
            children=[
            ...
            #  TT 
            HAnimJoint(DEF='hanim_r_transversetarsal',center=(-0.21,-0.3,0),name='r_transversetarsal',stiffness=[0,0,0],
              children=[
              ...
              #  TMT4 
              HAnimJoint(DEF='hanim_r_tarsometatarsal_4',center=(-0.25,-0.58,0),name='r_tarsometatarsal_4',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_4',center=(-0.25,-0.87,0),name='r_metatarsophalangeal_4',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_4',center=(-0.25,-1.0,0),name='r_tarsal_proximal_interphalangeal_4',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_4',center=(-0.25,-1.1,0),name='r_tarsal_distal_interphalangeal_4',stiffness=[0,0,0],
                      children=[
              ...
              #  TMT5 
              HAnimJoint(DEF='hanim_r_tarsometatarsal_5',center=(-0.33,-0.52,0),name='r_tarsometatarsal_5',stiffness=[0,0,0],
                children=[
                ...
                HAnimJoint(DEF='hanim_r_metatarsophalangeal_5',center=(-0.34,-0.8,0),name='r_metatarsophalangeal_5',stiffness=[0,0,0],
                  children=[
                  ...
                  HAnimJoint(DEF='hanim_r_tarsal_proximal_interphalangeal_5',center=(-0.34,-0.95,0),name='r_tarsal_proximal_interphalangeal_5',stiffness=[0,0,0],
                    children=[
                    ...
                    HAnimJoint(DEF='hanim_r_tarsal_distal_interphalangeal_5',center=(-0.34,-1.05,0),name='r_tarsal_distal_interphalangeal_5',stiffness=[0,0,0],
                      children=[
      ...
      joints=[
      HAnimJoint(USE='hanim_humanoid_root',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_calcaneocuboid',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_cuneonavicular_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_cuneonavicular_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_cuneonavicular_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metatarsophalangeal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metatarsophalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metatarsophalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metatarsophalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_metatarsophalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_talocalcaneonavicular',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_talocrural',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsal_distal_interphalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsal_distal_interphalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsal_distal_interphalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsal_distal_interphalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsal_interphalangeal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsal_proximal_interphalangeal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsal_proximal_interphalangeal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsal_proximal_interphalangeal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsal_proximal_interphalangeal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsometatarsal_1',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsometatarsal_2',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsometatarsal_3',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsometatarsal_4',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_tarsometatarsal_5',stiffness=[0,0,0]),
      HAnimJoint(USE='hanim_r_transversetarsal',stiffness=[0,0,0])],
      segments=[
...
print ("python x3d.py load successful for HAnimModelFootRight.py")

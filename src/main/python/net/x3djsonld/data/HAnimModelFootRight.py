...
newModel=X3D(profile='Immersive',version='4.0',
  ...
  Scene=Scene(
    ...
    HAnimHumanoid(DEF='Humanoid_Right_Foot',jointBindingPositions=[(0,0,0)],jointBindingRotations=[(0,0,1,0)],jointBindingScales=[(1,1,1)],name='Humanoid_Right_Foot',version='2.0',
      skeleton=[

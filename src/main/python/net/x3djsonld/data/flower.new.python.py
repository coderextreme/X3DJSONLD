...
newModel=X3D(profile='Immersive',version='4.0',
  head=head(
    children=[
    meta(content='flower.x3d',name='title'),
    meta(content='John Carlson',name='creator'),
    meta(content='manual',name='generator'),
    meta(content='https://coderextreme.net/X3DJSONLD/src/main/personal/flower.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(rotation=(0,1,0,3.1415925),scale=(1.5,1.5,1.5),translation=(0,-1,1),
      children=[
      Shape(
        appearance=Appearance(
          material=Material(diffuseColor=(0.9,0.3,0.3),shininess=0.145,specularColor=(0.8,0.8,0.8),transparency=0.1)),

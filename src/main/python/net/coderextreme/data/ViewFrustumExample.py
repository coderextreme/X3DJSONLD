...
Scene17.children.append(x3d.Comment("""Example use"""))
...
fieldValue34.children.append(x3d.Comment("""prefer empty description to prevent entry in player's ViewpointList"""))
...
Scene17.children.append(x3d.Comment("""Visualization assists"""))
Inline43 = x3d.Inline(DEF="GridXZ")
Inline43.url = ["GridXZ_20x20Fixed.x3d"]

Scene17.children.append(Inline43)
Transform44 = x3d.Transform()
Transform44.scale = [5,5,5]
Inline45 = x3d.Inline(DEF="CoordinateAxes")

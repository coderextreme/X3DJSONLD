...
meta15.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA_2.x3d")
...
HAnimJoint214.setName("l_ankle")
HAnimJoint214.setDEF("hanim_l_ankle")
HAnimJoint214.setCenter([0.1101,0.0656,-0.0736])
HAnimSegment215 = x3d.HAnimSegment()
HAnimSegment215.setName("l_hindfoot")
HAnimSegment215.setDEF("hanim_l_hindfoot")
...
HAnimJoint246.setName("l_subtalar")
HAnimJoint246.setDEF("hanim_l_subtalar")
...
HAnimJoint254.setName("l_midtarsal")
HAnimJoint254.setDEF("hanim_l_midtarsal")
HAnimJoint254.setCenter([0.1086,0.0001,0.0368])
HAnimSegment255 = x3d.HAnimSegment()
HAnimSegment255.setName("l_middistal")
HAnimSegment255.setDEF("hanim_l_middistal")
...
HAnimJoint274.setName("l_metatarsal")
HAnimJoint274.setDEF("hanim_l_metatarsal")
HAnimJoint274.setCenter([0.1086,0,0.0762])
HAnimSegment275 = x3d.HAnimSegment()
HAnimSegment275.setName("l_forefoot")
HAnimSegment275.setDEF("hanim_l_forefoot")
...
HAnimJoint334.setName("r_ankle")
HAnimJoint334.setDEF("hanim_r_ankle")
HAnimJoint334.setCenter([-0.0801,0.0712,-0.0766])
HAnimSegment335 = x3d.HAnimSegment()
HAnimSegment335.setName("r_hindfoot")
HAnimSegment335.setDEF("hanim_r_hindfoot")
...
HAnimJoint366.setName("r_midtarsal")
HAnimJoint366.setDEF("hanim_r_midtarsal")
HAnimJoint366.setCenter([-0.0801,0,0.0368])
HAnimSegment367 = x3d.HAnimSegment()
HAnimSegment367.setName("r_middistal")
HAnimSegment367.setDEF("hanim_r_middistal")
...
HAnimJoint582.setName("l_wrist")
HAnimJoint582.setDEF("hanim_l_wrist")
HAnimJoint582.setCenter([0.1984,0.8663,-0.0583])
HAnimSegment583 = x3d.HAnimSegment()
HAnimSegment583.setName("l_hand")
HAnimSegment583.setDEF("hanim_l_hand")
...
HAnimJoint737.setName("r_wrist")
HAnimJoint737.setDEF("hanim_r_wrist")
HAnimJoint737.setCenter([-0.1959,0.8694,-0.0521])
HAnimSegment738 = x3d.HAnimSegment()
HAnimSegment738.setName("r_hand")
HAnimSegment738.setDEF("hanim_r_hand")
...
HAnimSite900.setName("DiamondManLOA_2_view")
HAnimSite900.setDEF("hanim_DiamondManLOA_2_view")
...
HAnimSegment1003.setUSE("hanim_l_thumb_distal")
...
X3D0.toFileX3D("../data/DiamondManLOA_2_RoundTrip.x3d")

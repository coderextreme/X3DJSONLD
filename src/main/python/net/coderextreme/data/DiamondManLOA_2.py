...
HAnimSegment(name="midproximal", DEF="hanim_midproximal", children=[
...
material=
Material(USE="HAND_FEET_COLOR")))])]),
HAnimJoint(name="l_metatarsal", DEF="hanim_l_metatarsal", center=((0.1086,0.0,0.0762)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[

...
meta3 = x3d.meta()
meta3.name = "title"
meta3.content = "JinOriginalLOA3.x3d"
...
meta16.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA3.x3d"
...
WorldInfo21.title = "JinOriginalLOA3.x3d"
...
X3D0.Scene = Scene20
f = open("../data/JinOriginalLOA3.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../data/JinOriginalLOA3.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/JinOriginalLOA3.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

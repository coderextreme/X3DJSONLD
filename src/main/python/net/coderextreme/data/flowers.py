...
TimeSensor60.setDEF("SongTime")
TimeSensor60.setLoop(True)

ProtoBody13.addChild(TimeSensor60)
Sound61 = SoundObject()
Sound61.setMaxBack(100)
Sound61.setMaxFront(100)
Sound61.setMinBack(20)
Sound61.setMinFront(20)

AudioClip62 = AudioClipObject()
AudioClip62.setDEF("AudioClip")
AudioClip62.setDescription("Chandubabamusic #1")
AudioClip62.setUrl(["../resources/chandubabamusic1.wav"])

Sound61.setSource(AudioClip62)
ProtoBody13.addChild(Sound61)
ROUTE63 = ROUTEObject()
ROUTE63.setFromField("cycleTime")
ROUTE63.setFromNode("SongTime")
ROUTE63.setToField("startTime")
ROUTE63.setToNode("AudioClip")

ProtoBody13.addChild(ROUTE63)
ROUTE64 = ROUTEObject()
ROUTE64.setFromNode("TourTime")
ROUTE64.setFromField("cycleTime")
ROUTE64.setToNode("Bounce")
ROUTE64.setToField("set_fraction")

ProtoBody13.addChild(ROUTE64)
ROUTE65 = ROUTEObject()
ROUTE65.setFromNode("Bounce")
ROUTE65.setFromField("translation")
ROUTE65.setToNode("transform")
ROUTE65.setToField("set_translation")

ProtoBody13.addChild(ROUTE65)
...
Transform66.addComments(CommentsBlock("<ProtoInstance name=\"flower\"/> <ProtoInstance name=\"flower\"/>"))
Scene9.addChild(Transform66)

...
Scene16.children.append(x3d.Comment("""Images courtesy of Paul Debevec's Light Probe Image Gallery"""))
...
Transform21 = x3d.Transform(DEF="animate_transform")
Shape22 = x3d.Shape()
...
Appearance23.children.append(x3d.Comment("""<ComposedShader DEF='x3dom' language=\"GLSL\">"""))
...
Appearance23.children.append(x3d.Comment("""<ComposedCubeMapTexture USE=\"texture\"/>"""))
...
Appearance23.children.append(x3d.Comment("""<field name='a' type='SFFloat' accessType='inputOutput' value='10'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='b' type='SFFloat' accessType='inputOutput' value='1'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='c' type='SFFloat' accessType='inputOutput' value='20'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='d' type='SFFloat' accessType='inputOutput' value='20'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='tdelta' type='SFFloat' accessType='inputOutput' value='0'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='pdelta' type='SFFloat' accessType='inputOutput' value='0'></field>"""))
Appearance23.children.append(x3d.Comment("""<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs\"'></ShaderPart>"""))
Appearance23.children.append(x3d.Comment("""<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs\"' type='FRAGMENT'></ShaderPart>"""))
...
Script48 = x3d.Script(DEF="Animate")
field49 = x3d.field()
...
TimeSensor58 = x3d.TimeSensor(DEF="TourTime")
...
ProtoBody20.children.append(x3d.Comment("""<ROUTE fromNode='Animate' fromField='a' toNode='x3dom' toField='a'/>"""))
ProtoBody20.children.append(x3d.Comment("""<ROUTE fromNode='Animate' fromField='b' toNode='x3dom' toField='b'/>"""))
ProtoBody20.children.append(x3d.Comment("""<ROUTE fromNode='Animate' fromField='c' toNode='x3dom' toField='c'/>"""))
ProtoBody20.children.append(x3d.Comment("""<ROUTE fromNode='Animate' fromField='d' toNode='x3dom' toField='d'/>"""))
ProtoBody20.children.append(x3d.Comment("""<ROUTE fromNode='Animate' fromField='pdelta' toNode='x3dom' toField='pdelta'/>"""))
ProtoBody20.children.append(x3d.Comment("""<ROUTE fromNode='Animate' fromField='tdelta' toNode='x3dom' toField='tdelta'/>"""))

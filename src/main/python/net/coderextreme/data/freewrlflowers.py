...
head=head(children=[meta(name="title", content="freewrlflowers.x3d"),
...
Group(children=[
ProtoInstance(name="FlowerProto", fieldValue=[fieldValue(name="vertex", value=["../shaders/freewrl_flowers_chromatic.vs"]),

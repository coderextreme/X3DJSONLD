...
head=Pyhead(
children=[
Pymeta(name="title", content="freewrlflowers.x3d"),
...
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/freewrlflowers.x3d"),
...
Group(children=[
ProtoInstance(name="FlowerProto", fieldValue=[PyfieldValue(name="vertex", value=["../shaders/freewrl_flowers_chromatic.vs"]),
PyfieldValue(name="fragment", value=["../shaders/freewrl.fs"])
])])])),

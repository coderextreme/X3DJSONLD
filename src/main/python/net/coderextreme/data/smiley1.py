...
Material6.setDiffuseColor([0.8,0.5,0.5])

Appearance5.setMaterial(Material6)
ImageTexture7 = x3d.ImageTexture()
ImageTexture7.setUrl(["./face1.jpg"])
...
X3D0.toFileX3D("../data/smiley1.new.python.x3d")
X3D0.toFileJSON("../data/smiley1.new.python.json")

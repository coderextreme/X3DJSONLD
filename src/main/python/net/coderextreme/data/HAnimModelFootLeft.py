...
HAnimHumanoid24 = x3d.HAnimHumanoid(DEF="hanim_Foot_Left")
HAnimHumanoid24.name = "Foot_Left"
HAnimHumanoid24.loa = 4
HAnimHumanoid24.version = "2.0"
HAnimHumanoid24.children.append(x3d.Comment("""original HAnimHumanoid info='\"authorName=Kwan-Hee YOO, Don Brutzman and Joe Williams\"'"""))
...
HAnimJoint27.children.append(x3d.Comment("""Might consider putting a HAnimSegment here, but that doesn't help with re-use of this foot model"""))
HAnimJoint28 = x3d.HAnimJoint(DEF="hanim_l_talocrural")
...
HAnimSegment29 = x3d.HAnimSegment(DEF="hanim_l_talus")
...
IndexedLineSet38 = x3d.IndexedLineSet(DEF="TCtoTCN")
...
IndexedLineSet43 = x3d.IndexedLineSet(DEF="TCtoCC")
...
HAnimJoint28.children.append(x3d.Comment("""TCN"""))
HAnimJoint45 = x3d.HAnimJoint(DEF="hanim_l_talocalcaneonavicular")
HAnimJoint45.name = "l_talocalcaneonavicular"
HAnimJoint45.center = [0,-0.3,0]
HAnimJoint45.ulimit = [0,0,0]
HAnimJoint45.llimit = [0,0,0]
HAnimSegment46 = x3d.HAnimSegment(DEF="hanim_l_navicular")
...
IndexedLineSet52 = x3d.IndexedLineSet(DEF="TCNtoCN1")
...
IndexedLineSet57 = x3d.IndexedLineSet(DEF="TCNtoCN2")
...
IndexedLineSet62 = x3d.IndexedLineSet(DEF="TCNtoCN3")
...
IndexedLineSet71 = x3d.IndexedLineSet(DEF="CN1toTMT1")
...
IndexedLineSet80 = x3d.IndexedLineSet(DEF="TMT1toMTP1")
...
IndexedLineSet89 = x3d.IndexedLineSet(DEF="MTP1toIP1")
...
HAnimJoint91 = x3d.HAnimJoint(DEF="hanim_l_tarsal_interphalangeal_1")
...
HAnimSegment92 = x3d.HAnimSegment(DEF="hanim_l_tarsal_distal_phalanx_1")
HAnimSegment92.name = "l_tarsal_distal_phalanx_1"
Transform93 = x3d.Transform()
Transform93.translation = [-0.1,-1.05,0]
Shape94 = x3d.Shape(USE="HAnimJointShape")
...
IndexedLineSet98 = x3d.IndexedLineSet(DEF="tiptoe_l_tarsal_distal_interphalangeal_1")
...
IndexedLineSet107 = x3d.IndexedLineSet(DEF="CN2toTMT2")
...
HAnimJoint109 = x3d.HAnimJoint(DEF="hanim_l_tarsometatarsal_2")
...
IndexedLineSet116 = x3d.IndexedLineSet(DEF="TMT2toMTP2")
...
HAnimJoint118 = x3d.HAnimJoint(DEF="hanim_l_metatarsophalangeal_2")
...
IndexedLineSet125 = x3d.IndexedLineSet(DEF="MTP2toPIP2")
...
HAnimJoint127 = x3d.HAnimJoint(DEF="hanim_l_tarsal_proximal_interphalangeal_2")
...
IndexedLineSet134 = x3d.IndexedLineSet(DEF="PIP2toDIP2")
...
HAnimJoint136 = x3d.HAnimJoint(DEF="hanim_l_tarsal_distal_interphalangeal_2")
...
IndexedLineSet143 = x3d.IndexedLineSet(DEF="tiptoe_l_tarsal_distal_phalanx_2")
...
IndexedLineSet152 = x3d.IndexedLineSet(DEF="CN3toTMT3")
...
HAnimJoint154 = x3d.HAnimJoint(DEF="hanim_l_tarsometatarsal_3")
...
IndexedLineSet161 = x3d.IndexedLineSet(DEF="TMT3toMTP3")
...
HAnimJoint163 = x3d.HAnimJoint(DEF="hanim_l_metatarsophalangeal_3")
...
IndexedLineSet170 = x3d.IndexedLineSet(DEF="MTP3toPIP3")
...
HAnimJoint172 = x3d.HAnimJoint(DEF="hanim_l_tarsal_proximal_interphalangeal_3")
...
IndexedLineSet179 = x3d.IndexedLineSet(DEF="PIP3toDIP3")
...
HAnimJoint181 = x3d.HAnimJoint(DEF="hanim_l_tarsal_distal_interphalangeal_3")
...
HAnimSegment182 = x3d.HAnimSegment(DEF="hanim_l_tarsal_distal_phalanx_3")
...
IndexedLineSet188 = x3d.IndexedLineSet(DEF="tiptoe_l_tarsal_distal_interphalangeal_3")
...
HAnimJoint28.children.append(x3d.Comment("""CC"""))
HAnimJoint190 = x3d.HAnimJoint(DEF="hanim_l_calcaneocuboid")
HAnimJoint190.name = "l_calcaneocuboid"
HAnimJoint190.center = [0.2,0.3,0]
HAnimJoint190.ulimit = [0,0,0]
HAnimJoint190.llimit = [0,0,0]
HAnimSegment191 = x3d.HAnimSegment(DEF="hanim_l_calcaneus")
...
IndexedLineSet197 = x3d.IndexedLineSet(DEF="CCtoTT")
...
IndexedLineSet206 = x3d.IndexedLineSet(DEF="TTtoTMT4")
...
IndexedLineSet211 = x3d.IndexedLineSet(DEF="TTtoTMT5")
...
HAnimJoint199.children.append(x3d.Comment("""TMT4"""))
HAnimJoint213 = x3d.HAnimJoint(DEF="hanim_l_tarsometatarsal_4")
...
IndexedLineSet220 = x3d.IndexedLineSet(DEF="TMT4toMTP4")
...
HAnimJoint222 = x3d.HAnimJoint(DEF="hanim_l_metatarsophalangeal_4")
...
IndexedLineSet229 = x3d.IndexedLineSet(DEF="MTP4toPIP4")
...
HAnimJoint231 = x3d.HAnimJoint(DEF="hanim_l_tarsal_proximal_interphalangeal_4")
...
HAnimSegment232 = x3d.HAnimSegment(DEF="hanim_l_tarsal_middle_phalanx_4")
...
IndexedLineSet238 = x3d.IndexedLineSet(DEF="PIP4toDIP4")
...
HAnimJoint240 = x3d.HAnimJoint(DEF="hanim_l_tarsal_distal_interphalangeal_4")
...
HAnimSegment241 = x3d.HAnimSegment(DEF="hanim_l_tarsal_distal_phalanx_4")
...
IndexedLineSet247 = x3d.IndexedLineSet(DEF="tiptoe_l_tarsal_distal_interphalangeal_4")
...
HAnimJoint199.children.append(x3d.Comment("""TMT5"""))
HAnimJoint249 = x3d.HAnimJoint(DEF="hanim_l_tarsometatarsal_5")
...
HAnimSegment250 = x3d.HAnimSegment(DEF="hanim_l_metatarsal_5")
...
IndexedLineSet256 = x3d.IndexedLineSet(DEF="TMT5toMTP5")
...
HAnimJoint258 = x3d.HAnimJoint(DEF="hanim_l_metatarsophalangeal_5")
...
HAnimSegment259 = x3d.HAnimSegment(DEF="hanim_l_tarsal_proximal_phalanx_5")
...
IndexedLineSet265 = x3d.IndexedLineSet(DEF="MTP5toPIP5")
...
HAnimJoint267 = x3d.HAnimJoint(DEF="hanim_l_tarsal_proximal_interphalangeal_5")
...
IndexedLineSet274 = x3d.IndexedLineSet(DEF="PIP5toDIP5")
...
HAnimJoint276 = x3d.HAnimJoint(DEF="hanim_l_tarsal_distal_interphalangeal_5")
...
IndexedLineSet283 = x3d.IndexedLineSet(DEF="tiptoe_l_tarsal_distal_interphalangeal_5")
...
HAnimJoint285 = x3d.HAnimJoint(USE="hanim_humanoid_root")

HAnimHumanoid24.joints.append(HAnimJoint285)
HAnimJoint286 = x3d.HAnimJoint(USE="hanim_l_calcaneocuboid")

HAnimHumanoid24.joints.append(HAnimJoint286)
HAnimJoint287 = x3d.HAnimJoint(USE="hanim_l_cuneonavicular_1")

HAnimHumanoid24.joints.append(HAnimJoint287)
HAnimJoint288 = x3d.HAnimJoint(USE="hanim_l_cuneonavicular_2")

HAnimHumanoid24.joints.append(HAnimJoint288)
HAnimJoint289 = x3d.HAnimJoint(USE="hanim_l_cuneonavicular_3")

HAnimHumanoid24.joints.append(HAnimJoint289)
HAnimJoint290 = x3d.HAnimJoint(USE="hanim_l_metatarsophalangeal_1")

HAnimHumanoid24.joints.append(HAnimJoint290)
HAnimJoint291 = x3d.HAnimJoint(USE="hanim_l_metatarsophalangeal_2")

HAnimHumanoid24.joints.append(HAnimJoint291)
HAnimJoint292 = x3d.HAnimJoint(USE="hanim_l_metatarsophalangeal_3")

HAnimHumanoid24.joints.append(HAnimJoint292)
HAnimJoint293 = x3d.HAnimJoint(USE="hanim_l_metatarsophalangeal_4")

HAnimHumanoid24.joints.append(HAnimJoint293)
HAnimJoint294 = x3d.HAnimJoint(USE="hanim_l_metatarsophalangeal_5")

HAnimHumanoid24.joints.append(HAnimJoint294)
HAnimJoint295 = x3d.HAnimJoint(USE="hanim_l_talocalcaneonavicular")

HAnimHumanoid24.joints.append(HAnimJoint295)
HAnimJoint296 = x3d.HAnimJoint(USE="hanim_l_talocrural")

HAnimHumanoid24.joints.append(HAnimJoint296)
HAnimJoint297 = x3d.HAnimJoint(USE="hanim_l_tarsal_distal_interphalangeal_2")

HAnimHumanoid24.joints.append(HAnimJoint297)
HAnimJoint298 = x3d.HAnimJoint(USE="hanim_l_tarsal_distal_interphalangeal_3")

HAnimHumanoid24.joints.append(HAnimJoint298)
HAnimJoint299 = x3d.HAnimJoint(USE="hanim_l_tarsal_distal_interphalangeal_4")

HAnimHumanoid24.joints.append(HAnimJoint299)
HAnimJoint300 = x3d.HAnimJoint(USE="hanim_l_tarsal_distal_interphalangeal_5")

HAnimHumanoid24.joints.append(HAnimJoint300)
HAnimJoint301 = x3d.HAnimJoint(USE="hanim_l_tarsal_interphalangeal_1")

HAnimHumanoid24.joints.append(HAnimJoint301)
HAnimJoint302 = x3d.HAnimJoint(USE="hanim_l_tarsal_proximal_interphalangeal_2")

HAnimHumanoid24.joints.append(HAnimJoint302)
HAnimJoint303 = x3d.HAnimJoint(USE="hanim_l_tarsal_proximal_interphalangeal_3")

HAnimHumanoid24.joints.append(HAnimJoint303)
HAnimJoint304 = x3d.HAnimJoint(USE="hanim_l_tarsal_proximal_interphalangeal_4")

HAnimHumanoid24.joints.append(HAnimJoint304)
HAnimJoint305 = x3d.HAnimJoint(USE="hanim_l_tarsal_proximal_interphalangeal_5")

HAnimHumanoid24.joints.append(HAnimJoint305)
HAnimJoint306 = x3d.HAnimJoint(USE="hanim_l_tarsometatarsal_1")

HAnimHumanoid24.joints.append(HAnimJoint306)
HAnimJoint307 = x3d.HAnimJoint(USE="hanim_l_tarsometatarsal_2")

HAnimHumanoid24.joints.append(HAnimJoint307)
HAnimJoint308 = x3d.HAnimJoint(USE="hanim_l_tarsometatarsal_3")

HAnimHumanoid24.joints.append(HAnimJoint308)
HAnimJoint309 = x3d.HAnimJoint(USE="hanim_l_tarsometatarsal_4")

HAnimHumanoid24.joints.append(HAnimJoint309)
HAnimJoint310 = x3d.HAnimJoint(USE="hanim_l_tarsometatarsal_5")

HAnimHumanoid24.joints.append(HAnimJoint310)
HAnimJoint311 = x3d.HAnimJoint(USE="hanim_l_transversetarsal")

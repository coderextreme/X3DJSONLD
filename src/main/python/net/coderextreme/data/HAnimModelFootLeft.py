...
HAnimJoint113.setDisplayBBox(False)
...
HAnimSegment114.setDisplayBBox(False)
Transform115 = x3d.Transform()
Transform115.setTranslation([0.05,-0.9,0])
Transform115.setDisplayBBox(False)
Shape116 = x3d.Shape()
...
HAnimJoint158.setDisplayBBox(False)
...
HAnimSegment159.setDisplayBBox(False)
Transform160 = x3d.Transform()
Transform160.setTranslation([0.15,-0.9,0])
Transform160.setDisplayBBox(False)
Shape161 = x3d.Shape()
...
HAnimJoint217.setDisplayBBox(False)
...
HAnimSegment218.setDisplayBBox(False)
Transform219 = x3d.Transform()
Transform219.setTranslation([0.25,-0.87,0])
Transform219.setDisplayBBox(False)
Shape220 = x3d.Shape()
...
HAnimJoint253.setDisplayBBox(False)
...
HAnimSegment254.setDisplayBBox(False)
Transform255 = x3d.Transform()
Transform255.setTranslation([0.34,-0.8,0])
Transform255.setDisplayBBox(False)
Shape256 = x3d.Shape()

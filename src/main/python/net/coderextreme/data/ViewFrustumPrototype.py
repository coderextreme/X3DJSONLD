...
Switch28.setBboxCenter([0,0,0])
Switch28.setBboxSize([-1,-1,-1])
...
X3DScript48.setDEF("GeometryComputationScript")
X3DScript48.setDirectOutput(True)
X3DScript48.setUrl(["ViewFrustumPrototypeScript.js"])
field49 = x3d.field()
...
X3DScript48.setIS(IS65)

ProtoBody27.addX3DScript(X3DScript48)
ROUTE71 = x3d.ROUTE()
...
Anchor77.setBboxCenter([0,0,0])
Anchor77.setBboxSize([-1,-1,-1])
Shape78 = x3d.Shape()

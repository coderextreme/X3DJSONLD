...
field19.type = "SFNode"
field19.children.append(x3d.Comment("""NULL node, ProtoInstance must provide"""))
...
field20.type = "SFNode"
field20.children.append(x3d.Comment("""NULL node, ProtoInstance must provide"""))
...
Switch28 = x3d.Switch(DEF="VisibilitySwitch")
Switch28.whichChoice = -1
Transform29 = x3d.Transform(DEF="PositionTransform")
Transform29.rotation = [0,1,0,3.14159]
Transform30 = x3d.Transform(DEF="OrientationTransform")
Shape31 = x3d.Shape()
IndexedLineSet32 = x3d.IndexedLineSet(DEF="FrustumLines")
IndexedLineSet32.coordIndex = [0,1,2,3,0,-1,4,5,6,7,4,-1,0,4,-1,1,5,-1,2,6,-1,3,7,-1]
Coordinate33 = x3d.Coordinate(DEF="FrustumCoordinate")
...
Shape38 = x3d.Shape()
Extrusion39 = x3d.Extrusion(DEF="FrustumExtrusion")

Shape38.geometry = Extrusion39
Appearance40 = x3d.Appearance(DEF="FrustumAppearance")
...
Appearance47 = x3d.Appearance(USE="FrustumAppearance")
...
Script48 = x3d.Script(DEF="GeometryComputationScript")
...
field51.type = "SFNode"
field51.children.append(x3d.Comment("""initialization node (if any) goes here"""))
...
field52.type = "SFNode"
field52.children.append(x3d.Comment("""initialization node (if any) goes here"""))
...
field53.type = "SFNode"
Coordinate54 = x3d.Coordinate(USE="FrustumCoordinate")
...
field55.type = "SFNode"
Extrusion56 = x3d.Extrusion(USE="FrustumExtrusion")
...
Scene15.children.append(x3d.Comment("""Example use is in separate scene"""))
Anchor77 = x3d.Anchor()

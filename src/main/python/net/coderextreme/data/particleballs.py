...
ParticleSystem20.children.append(x3d.Comment("""<Shape>"""))
Sphere24 = x3d.Sphere()
...
Appearance25.children.append(x3d.Comment("""<ComposedShader language='GLSL'>"""))
Appearance25.children.append(x3d.Comment("""<field name='chromaticDispertion' accessType='inputOutput' type='SFVec3f' value='0.98 1 1.033'></field>"""))
Appearance25.children.append(x3d.Comment("""<field name='cube' type='SFNode' accessType=\"inputOutput\">"""))
Appearance25.children.append(x3d.Comment("""<ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture>"""))
Appearance25.children.append(x3d.Comment("""</field>"""))
Appearance25.children.append(x3d.Comment("""<field name='bias' accessType='inputOutput' type='SFFloat' value='0.5'></field>"""))
Appearance25.children.append(x3d.Comment("""<field name='scale' accessType='inputOutput' type='SFFloat' value='0.5'></field>"""))
Appearance25.children.append(x3d.Comment("""<field name='power' accessType='inputOutput' type='SFFloat' value='2'></field>"""))
Appearance25.children.append(x3d.Comment("""<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"'></ShaderPart>"""))
Appearance25.children.append(x3d.Comment("""<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' type='FRAGMENT'></ShaderPart>"""))
Appearance25.children.append(x3d.Comment("""</ComposedShader>"""))
Appearance25.children.append(x3d.Comment("""<ComposedShader DEF=\"shader\" language=\"GLSL\">"""))
Appearance25.children.append(x3d.Comment("""<field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field>"""))
Appearance25.children.append(x3d.Comment("""<field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1.0 1.033'></field>"""))
Appearance25.children.append(x3d.Comment("""<field name='bias' type='SFFloat' accessType='inputOutput' value='0.5'></field>"""))
Appearance25.children.append(x3d.Comment("""<field name='scale' type='SFFloat' accessType='inputOutput' value='0.5'></field>"""))
Appearance25.children.append(x3d.Comment("""<field name='power' type='SFFloat' accessType='inputOutput' value='2'></field>"""))
Appearance25.children.append(x3d.Comment("""<ShaderPart url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/>"""))
Appearance25.children.append(x3d.Comment("""<ShaderPart type='FRAGMENT' url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/>"""))
Appearance25.children.append(x3d.Comment("""</ComposedShader>"""))
...
ShaderPart42 = x3d.ShaderPart(DEF="commonfs")
...
Transform19.children.append(x3d.Comment("""</Shape>"""))

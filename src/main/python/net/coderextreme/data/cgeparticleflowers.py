...
ComposedShader34 = x3d.ComposedShader(DEF="shader")
...
ComposedShader34.children.append(x3d.Comment("""<field name='cube' type='SFNode' accessType=\"initializeOnly\">"""))
ComposedShader34.children.append(x3d.Comment("""<ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture>"""))
ComposedShader34.children.append(x3d.Comment("""</field>"""))

...
Transform19 = x3d.Transform(DEF="transform")
Shape20 = x3d.Shape()
...
ComposedShader30 = x3d.ComposedShader(DEF="shader")
...
Shape20.children.append(x3d.Comment("""<Sphere>"""))
IndexedFaceSet38 = x3d.IndexedFaceSet(DEF="Orbit")
IndexedFaceSet38.convex = False
Coordinate39 = x3d.Coordinate(DEF="OrbitCoordinates")
...
Script40 = x3d.Script(DEF="OrbitScript")
field41 = x3d.field()
...
TimeSensor48 = x3d.TimeSensor(DEF="Clock")

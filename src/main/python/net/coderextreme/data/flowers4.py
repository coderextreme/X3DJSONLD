...
Pymeta(name="title", content="flowers4.x3d"),
Pymeta(name="creator", content="John Carlson"),
Pymeta(name="generator", content="manual"),
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/flowers4.x3d"),
Pymeta(name="description", content="an animated flower"),
...
Pyfield(name="chromaticDispertion", accessType="inputOutput", type="SFVec3f", value=(0.98,1.0,1.033)),
...
Pyfield(name="coordinates", accessType="inputOutput", type="MFVec3f"),

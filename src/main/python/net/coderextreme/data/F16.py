...
geometry=
IndexedFaceSet(coordIndex=[24,0,3,-1,4,0,24,-1,25,26,27,-1,28,25,27,-1,27,29,28,-1,27,30,29,-1,27,31,30,-1,3,18,24,-1], creaseAngle=0.5, normalIndex=[16,0,3,-1,4,0,16,-1,17,17,17,-1,18,18,18,-1,19,19,19,-1,20,20,20,-1,21,21,21,-1,3,14,16,-1], solid=False, 
coord=
...
geometry=
IndexedFaceSet(coordIndex=[186,187,188,189,190,-1,190,191,192,193,186,-1], creaseAngle=0.5, normalIndex=[118,119,120,121,122,-1,122,123,124,125,118,-1], solid=False, 
coord=
Coordinate(USE="coordinates"), 
normal=
Normal(USE="normalVector"))),
...
geometry=
IndexedFaceSet(coordIndex=[194,130,173,195,196,197,-1,197,198,199,82,81,194,-1], creaseAngle=0.5, normalIndex=[126,126,126,126,126,126,-1,126,126,126,126,126,126,-1], solid=False, 
coord=
Coordinate(USE="coordinates"), 
normal=
Normal(USE="normalVector"))),
...
geometry=
IndexedFaceSet(coordIndex=[12,200,201,15,-1,19,48,127,17,-1,15,201,128,5,-1,17,127,202,11,-1,11,202,200,12,-1,5,128,49,1,-1,48,19,44,-1,19,2,44,-1,34,1,49,-1,34,2,1,-1], creaseAngle=0.5, normalIndex=[8,127,128,11,-1,15,36,83,13,-1,11,128,85,5,-1,13,83,129,7,-1,7,129,127,8,-1,5,85,37,1,-1,36,15,32,-1,15,2,32,-1,24,1,37,-1,24,2,1,-1], solid=False, 
coord=
Coordinate(USE="coordinates"), 
normal=
Normal(USE="normalVector"))),
...
Material(diffuseColor=((0.6,0.6,0.6)))), 
geometry=
IndexedFaceSet(coordIndex=[0,1,2,3,-1,4,5,1,0,-1,10,11,12,13,-1,14,15,5,4,-1,13,12,15,14,-1,16,17,11,10,-1,18,19,17,16,-1,3,2,19,18,-1], creaseAngle=0.5, normalIndex=[0,1,2,3,-1,4,5,1,0,-1,6,7,8,9,-1,10,11,5,4,-1,9,8,11,10,-1,12,13,7,6,-1,14,15,13,12,-1,3,2,15,14,-1], solid=False, 
coord=
Coordinate(USE="coordinates"), 
normal=
Normal(USE="normalVector")))]),

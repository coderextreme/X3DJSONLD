...
meta13.setContent("http://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/KoreanCharacterAnnexD01Jin.x3d")
...
Viewpoint21.setDescription("AnnexD01Jin")
Viewpoint21.setPosition([0,1,3])

Scene19.addChildren(Viewpoint21)

X3D0.setScene(Scene19)
X3D0.toFileX3D("../data/KoreanCharacterAnnexD01Jin_RoundTrip.x3d")

...
Transform19.setTranslation([25000,0,25000])

Shape20 = ShapeObject()

Rectangle2D21 = Rectangle2DObject()
Rectangle2D21.setSize([77000,55000])

Shape20.setGeometry(Rectangle2D21)
Appearance22 = AppearanceObject()

ImageTexture23 = ImageTextureObject()
ImageTexture23.setUrl(["ocean.png","https://savage.nps.edu/Savage/Environment/Atmosphere/ocean.png"])

Appearance22.setTexture(ImageTexture23)
Shape20.setAppearance(Appearance22)
Transform19.addChild(Shape20)
Group17.addChild(Transform19)
Scene11.addChild(Group17)
Group24 = GroupObject()
Group24.setDEF("Placemarks")

Transform25 = TransformObject()
Transform25.setScale([50,50,50])
Transform25.setTranslation([45000,30,44000])

Group24.addChild(Transform25)
Scene11.addChild(Group24)
Group26 = GroupObject()
Group26.setDEF("Clouds")

Transform27 = TransformObject()
Transform27.setDEF("Cumulus")

Group26.addChild(Transform27)
Transform28 = TransformObject()
Transform28.setDEF("Cirrus")

Group26.addChild(Transform28)
Transform29 = TransformObject()
Transform29.setDEF("Fog")

Group26.addChild(Transform29)
Script30 = ScriptObject()
Script30.setDEF("PixelScript")
Script30.setDirectOutput(True)

field31 = fieldObject()
field31.setType(fieldObject.TYPE_SFNODE)
field31.setName("Cumulus")
field31.setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY)

Transform32 = TransformObject()
Transform32.setUSE("Cumulus")

field31.addChild(Transform32)
Script30.addField(field31)
field33 = fieldObject()
field33.setType(fieldObject.TYPE_SFNODE)
field33.setName("Cirrus")
field33.setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY)

Transform34 = TransformObject()
Transform34.setUSE("Cirrus")
...
"\n"+
"")
Group26.addChild(Script30)
DirectionalLight36 = DirectionalLightObject()
DirectionalLight36.setAmbientIntensity(1)
DirectionalLight36.setColor([1,0,0])
DirectionalLight36.setDirection([-1,-1,0])
DirectionalLight36.setGlobal(True)

Group26.addChild(DirectionalLight36)
Scene11.addChild(Group26)

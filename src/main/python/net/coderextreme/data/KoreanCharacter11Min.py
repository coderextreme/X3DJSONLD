...
HAnimHumanoid24 = x3d.HAnimHumanoid(DEF="hanim_Min")
...
HAnimJoint72.center = [3.701,3.418,-0.4009]
...
Transform74.translation = [3.701,3.418,-0.4009]
Shape75 = x3d.Shape()
...
ImageTexture98 = x3d.ImageTexture(USE="MinTextureAtlas")
...
IndexedFaceSet99.texCoordIndex = [1,0,2,-1,2,26,1,-1,4,3,0,-1,0,1,4,-1,6,5,8,-1,8,7,6,-1,10,9,28,-1,28,29,10,-1,11,9,10,-1,10,12,11,-1,13,11,12,-1,12,14,13,-1,27,13,14,-1,14,26,27,-1,35,41,16,-1,16,15,35,-1,34,17,30,-1,30,33,34,-1,35,15,17,-1,17,34,35,-1,18,16,41,-1,41,36,18,-1,19,31,37,-1,37,20,19,-1,21,19,20,-1,20,22,21,-1,23,21,22,-1,22,24,23,-1,33,24,40,-1,4,15,16,-1,16,7,4,-1,17,1,26,-1,26,30,17,-1,15,4,1,-1,1,17,15,-1,18,6,7,-1,7,16,18,-1,10,29,31,-1,31,19,10,-1,12,10,19,-1,19,21,12,-1,14,12,21,-1,21,23,14,-1,26,14,23,-1,23,30,26,-1,3,4,7,-1,7,8,3,-1,0,25,2,-1,27,32,13,-1,13,32,11,-1,11,32,9,-1,9,32,28,-1,5,25,8,-1,8,25,3,-1,3,25,0,-1,22,20,38,-1,38,39,22,-1,24,22,39,-1,39,40,24,-1,33,30,23,-1,23,24,33,-1,20,37,38,-1,44,43,42,-1,42,45,44,-1,47,46,42,-1,42,43,47,-1,50,49,48,-1,48,51,50,-1,52,51,48,-1,48,53,52,-1,54,52,53,-1,53,55,54,-1,56,54,55,-1,55,57,56,-1,44,45,56,-1,56,57,44,-1,49,50,46,-1,46,47,49,-1,44,58,43,-1,43,58,47,-1,47,58,49,-1,49,58,48,-1,48,58,53,-1,53,58,55,-1,55,58,57,-1,57,58,44,-1]
Coordinate100 = x3d.Coordinate()
Coordinate100.point = [(-1.021, -13.79, -1.071),(-1.368, -13.79, 0.1246),(0.1011, -13.79, -1.478),(1.451, -13.79, 0.1246),(1.111, -13.79, 1.262),(0.1011, -13.79, 1.8),(-0.9931, -13.79, 1.265),(1.141, -13.79, -1.073),(-1.298, -6.497, -1.365),(-1.84, -6.318, 0.1245),(0.0526, -6.797, -2.188),(1.979, -7.206, 0.1246),(1.577, -7.086, -1.36),(1.546, -7.079, 1.679),(0.0424, -6.797, 2.285),(-1.401, -6.551, 1.654),(-1.086, -13.26, -1.222),(0.1011, -13.26, -1.741),(1.739, -13.26, 0.1246),(1.338, -13.26, 1.484),(0.1011, -13.26, 2.071),(-1.178, -13.26, 1.462),(-1.661, -13.26, 0.1246),(1.42, -13.26, -1.224),(0.1011, -13.97, 0.1246),(1.638, -1.084, 1.961),(0.0255, -1.168, 2.594),(-1.452, -1.045, 1.949),(-1.502, -0.0626, -1.597),(0.0086, -0.0622, -2.267),(-1.7, 0.4427, 0.1149),(-1.285, 0.4687, -1.368),(0.0086, 0.4514, -1.977),(1.92, 0.4436, 0.1541),(1.468, 0.4591, 1.778),(0.0086, 0.4334, 2.364),(-1.278, 0.4363, 1.839),(1.496, 0.4475, -1.328),(0.0086, 0.7828, 0.2482),(-2.04, -0.0635, 0.1287),(2.219, -0.0635, 0.1287),(1.729, -0.0645, 2.11),(0.0085, -0.0649, 2.826),(-1.502, -0.0645, 2.11),(1.729, -0.0626, -1.597)]

IndexedFaceSet99.coord = Coordinate100
TextureCoordinate101 = x3d.TextureCoordinate()
TextureCoordinate101.point = [(0.4947, 0.1511),(0.4898, 0.1553),(0.4808, 0.1397),(0.5148, 0.1542),(0.5136, 0.1567),(0.5548, 0.1397),(0.5624, 0.1474),(0.538, 0.154),(0.5349, 0.151),(0.3767, 0.1524),(0.3745, 0.1561),(0.3976, 0.1569),(0.3988, 0.159),(0.4182, 0.1525),(0.4256, 0.1569),(0.5115, 0.2481),(0.5421, 0.242),(0.4829, 0.2521),(0.5687, 0.2356),(0.3697, 0.2448),(0.3657, 0.3328),(0.3981, 0.2507),(0.3946, 0.332),(0.4262, 0.2532),(0.4217, 0.3331),(0.5194, 0.1371),(0.4591, 0.1503),(0.4304, 0.1417),(0.3563, 0.1417),(0.3487, 0.1494),(0.4545, 0.2546),(0.3424, 0.2376),(0.3918, 0.1391),(0.4535, 0.3447),(0.4842, 0.3445),(0.5125, 0.3445),(0.5726, 0.3454),(0.3334, 0.3474),(0.3656, 0.347),(0.3945, 0.3465),(0.4208, 0.3461),(0.5434, 0.3444),(0.554, 0.3454),(0.5479, 0.3523),(0.5595, 0.352),(0.5689, 0.3454),(0.512, 0.3454),(0.512, 0.3521),(0.4589, 0.352),(0.4707, 0.352),(0.4642, 0.3454),(0.4506, 0.3454),(0.4642, 0.3454),(0.4714, 0.3522),(0.512, 0.3454),(0.512, 0.3519),(0.554, 0.3454),(0.5477, 0.3519),(0.512, 0.3564)]
...
HAnimJoint112.center = [-3.701,3.418,-0.4009]
...
Transform114.translation = [-3.701,3.418,-0.4009]
Shape115 = x3d.Shape()
...
ImageTexture188 = x3d.ImageTexture(USE="MinTextureAtlas")

Appearance186.texture = ImageTexture188

Shape185.appearance = Appearance186
IndexedFaceSet189 = x3d.IndexedFaceSet()
IndexedFaceSet189.coordIndex = [3,2,1,-1,1,0,3,-1,5,4,7,-1,7,6,5,-1,9,8,11,-1,11,10,9,-1,9,10,13,-1,13,12,9,-1,15,14,17,-1,17,16,15,-1,16,19,18,-1,18,15,16,-1,3,0,10,-1,10,11,3,-1,10,0,1,-1,1,13,10,-1,16,17,21,-1,21,20,16,-1,20,2,19,-1,19,16,20,-1,7,8,9,-1,9,6,7,-1,5,6,9,-1,9,12,5,-1,15,23,22,-1,22,14,15,-1,18,4,23,-1,23,15,18,-1,21,1,2,-1,2,20,21,-1,23,4,5,-1,5,22,23,-1,12,13,17,-1,17,14,12,-1,26,25,24,-1,24,27,26,-1,21,17,13,-1,13,1,21,-1,11,19,2,-1,2,3,11,-1,22,5,12,-1,12,14,22,-1,4,18,8,-1,8,7,4,-1,25,11,8,-1,8,24,25,-1,11,25,26,-1,26,19,11,-1,19,26,27,-1,27,18,19,-1,18,27,24,-1,24,8,18,-1]
IndexedFaceSet189.creaseAngle = 1.57
IndexedFaceSet189.texCoordIndex = [3,2,1,-1,1,0,3,-1,28,5,4,-1,4,29,28,-1,9,8,11,-1,11,10,9,-1,9,10,13,-1,13,12,9,-1,39,38,41,-1,41,40,39,-1,16,19,18,-1,18,15,16,-1,3,0,10,-1,10,11,3,-1,10,0,1,-1,1,13,10,-1,40,41,43,-1,43,42,40,-1,20,2,19,-1,19,16,20,-1,7,8,9,-1,9,6,7,-1,28,29,30,-1,30,31,28,-1,39,23,22,-1,22,38,39,-1,33,5,32,-1,32,34,33,-1,21,1,2,-1,2,20,21,-1,32,5,28,-1,28,35,32,-1,12,13,17,-1,17,14,12,-1,26,25,24,-1,24,27,26,-1,21,17,13,-1,13,1,21,-1,11,19,2,-1,2,3,11,-1,35,28,31,-1,31,36,35,-1,5,33,37,-1,37,4,5,-1,25,11,8,-1,8,24,25,-1,11,25,26,-1,26,19,11,-1,19,26,27,-1,27,18,19,-1,18,27,24,-1,24,8,18,-1]
Coordinate190 = x3d.Coordinate()
Coordinate190.point = [(-0.6858, -0.0091, 1.043),(-0.8572, -0.0091, 0.3582),(0.582, -0.0091, 0.3582),(0.5216, -0.0091, 1.043),(0.679, -2.66, 0.2822),(-0.9542, -2.992, 0.2822),(-0.7672, -2.714, 1.233),(0.603, -2.435, 1.233),(0.8768, -1.907, 1.4),(-1.041, -1.907, 1.4),(-1.041, -0.5983, 1.4),(0.8768, -0.5983, 1.4),(-1.281, -2.03, 0.2845),(-1.281, -0.5489, 0.2845),(-1.097, -1.908, -1.452),(0.8213, -1.908, -1.452),(0.8213, -0.5991, -1.452),(-1.097, -0.5991, -1.452),(1.005, -2.03, 0.2845),(1.005, -0.5489, 0.2845),(0.4661, -0.0091, -1.084),(-0.7414, -0.0091, -1.084),(-0.8227, -2.714, -1.198),(0.5474, -2.436, -1.198),(1.272, -1.761, 1.213),(1.272, -0.7447, 1.213),(1.476, -0.7234, 0.4714),(1.476, -1.856, 0.4714)]

IndexedFaceSet189.coord = Coordinate190
TextureCoordinate191 = x3d.TextureCoordinate()
TextureCoordinate191.point = [(0.9934, 0.082),(0.9951, 0.0877),(0.9456, 0.0877),(0.9473, 0.082),(0.9034, 0.0905),(0.8766, 0.0919),(0.9942, 0.009),(0.945, 0.0157),(0.9371, 0.0285),(0.9969, 0.0285),(0.9969, 0.0684),(0.9371, 0.0684),(0.9993, 0.0256),(0.9993, 0.0715),(0.9975, 0.0285),(0.9365, 0.0285),(0.9365, 0.0684),(0.9975, 0.0684),(0.9312, 0.0256),(0.9312, 0.0715),(0.9489, 0.082),(0.9939, 0.082),(0.9948, 0.009),(0.9466, 0.0157),(0.9256, 0.0321),(0.9256, 0.0648),(0.9198, 0.0672),(0.9198, 0.0298),(0.8753, 0.0485),(0.9025, 0.0502),(0.9023, 0.0288),(0.8757, 0.0269),(0.8373, 0.0909),(0.8768, 0.1071),(0.8372, 0.1061),(0.8367, 0.0504),(0.837, 0.0294),(0.9035, 0.1061),(0.9975, 0.0285),(0.9387, 0.0285),(0.9387, 0.0684),(0.9975, 0.0684),(0.9489, 0.082),(0.9939, 0.082)]
...
f.write(X3D0.XML())
f.close()
f = open("../data/KoreanCharacter11Min.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/KoreanCharacter11Min.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

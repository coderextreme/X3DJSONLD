...
ProtoInstance62 = ProtoInstanceObject().setName("point").setDEF("G3")
Scene7.addChild(ProtoInstance62)
ProtoInstance63 = ProtoInstanceObject().setName("point").setDEF("G4")
Scene7.addChild(ProtoInstance63)
ProtoInstance64 = ProtoInstanceObject().setName("x3dconnector").setDEF("connector1")
fieldValue65 = fieldValueObject().setName("startnode")
ProtoInstance66 = ProtoInstanceObject().setUSE("G1")
fieldValue65.addChild(ProtoInstance66)
ProtoInstance64.addFieldValue(fieldValue65)
fieldValue67 = fieldValueObject().setName("endnode")
ProtoInstance68 = ProtoInstanceObject().setUSE("G2")
fieldValue67.addChild(ProtoInstance68)
ProtoInstance64.addFieldValue(fieldValue67)
fieldValue69 = fieldValueObject().setName("set_startpoint")
ProtoInstance64.addFieldValue(fieldValue69)
fieldValue70 = fieldValueObject().setName("set_endpoint")
ProtoInstance64.addFieldValue(fieldValue70)
Scene7.addChild(ProtoInstance64)
ProtoInstance71 = ProtoInstanceObject().setName("x3dconnector").setDEF("connector2")
fieldValue72 = fieldValueObject().setName("startnode")
ProtoInstance73 = ProtoInstanceObject().setUSE("G1")
...
ProtoInstance75 = ProtoInstanceObject().setUSE("G3")
fieldValue74.addChild(ProtoInstance75)
ProtoInstance71.addFieldValue(fieldValue74)
fieldValue76 = fieldValueObject().setName("set_startpoint")
ProtoInstance71.addFieldValue(fieldValue76)
fieldValue77 = fieldValueObject().setName("set_endpoint")
ProtoInstance71.addFieldValue(fieldValue77)
Scene7.addChild(ProtoInstance71)
ProtoInstance78 = ProtoInstanceObject().setName("x3dconnector").setDEF("connector3")
fieldValue79 = fieldValueObject().setName("startnode")
ProtoInstance80 = ProtoInstanceObject().setUSE("G1")
...
ProtoInstance82 = ProtoInstanceObject().setUSE("G4")
fieldValue81.addChild(ProtoInstance82)
ProtoInstance78.addFieldValue(fieldValue81)
fieldValue83 = fieldValueObject().setName("set_startpoint")
ProtoInstance78.addFieldValue(fieldValue83)
fieldValue84 = fieldValueObject().setName("set_endpoint")
ProtoInstance78.addFieldValue(fieldValue84)
Scene7.addChild(ProtoInstance78)
ROUTE85 = ROUTEObject().setFromNode("G1").setFromField("translation").setToNode("connector1").setToField("set_startpoint")
Scene7.addChild(ROUTE85)
ROUTE86 = ROUTEObject().setFromNode("G2").setFromField("translation").setToNode("connector1").setToField("set_endpoint")
Scene7.addChild(ROUTE86)
ROUTE87 = ROUTEObject().setFromNode("G1").setFromField("translation").setToNode("connector2").setToField("set_startpoint")
Scene7.addChild(ROUTE87)
ROUTE88 = ROUTEObject().setFromNode("G3").setFromField("translation").setToNode("connector2").setToField("set_endpoint")
Scene7.addChild(ROUTE88)
ROUTE89 = ROUTEObject().setFromNode("G1").setFromField("translation").setToNode("connector3").setToField("set_startpoint")
Scene7.addChild(ROUTE89)
ROUTE90 = ROUTEObject().setFromNode("G4").setFromField("translation").setToNode("connector3").setToField("set_endpoint")

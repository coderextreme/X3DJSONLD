...
ProtoInterface=PyProtoInterface(field=[Pyfield(name="translation", accessType="inputOutput", type="SFVec3f", value=(0,0,0))
]), 
ProtoBody=PyProtoBody(children=[
Transform(DEF="node", 
IS=PyIS(connect=[Pyconnect(nodeField="translation", protoField="translation")
]), children=[
Shape(
geometry=
Sphere(radius=0.1), 
...
Script(DEF="MB1", field=[Pyfield(name="translation", accessType="inputOutput", type="SFVec3f", value=(50,50,0)),
...
ProtoInterface=PyProtoInterface(field=[Pyfield(name="startnode", accessType="initializeOnly", type="SFNode"),
...
ProtoBody=PyProtoBody(children=[
Group(children=[
Transform(DEF="trans", children=[
Transform(DEF="rotscale", children=[
Shape(
appearance=
Appearance(
material=
...
Script(DEF="S1", field=[Pyfield(name="startnode", accessType="initializeOnly", type="SFNode"),
Pyfield(name="endnode", accessType="initializeOnly", type="SFNode"),
...
IS=PyIS(connect=[Pyconnect(nodeField="startnode", protoField="startnode"),
Pyconnect(nodeField="endnode", protoField="endnode"),
Pyconnect(nodeField="set_startpoint", protoField="set_startpoint"),
Pyconnect(nodeField="set_endpoint", protoField="set_endpoint")
...
ProtoInstance(name="x3dconnector", DEF="connector1", fieldValue=[PyfieldValue(name="startnode", children=[
ProtoInstance(USE="G1")]),
PyfieldValue(name="endnode", children=[
ProtoInstance(USE="G2")]),
PyfieldValue(name="set_startpoint"),
PyfieldValue(name="set_endpoint")
]),
ProtoInstance(name="x3dconnector", DEF="connector2", fieldValue=[PyfieldValue(name="startnode", children=[
ProtoInstance(USE="G1")]),
PyfieldValue(name="endnode", children=[
...
ProtoInstance(name="x3dconnector", DEF="connector3", fieldValue=[PyfieldValue(name="startnode", children=[
ProtoInstance(USE="G1")]),
PyfieldValue(name="endnode", children=[

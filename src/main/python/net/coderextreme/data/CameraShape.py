...
Viewpoint15 = x3d.Viewpoint(DEF="CameraShapeView")
...
Shape22 = x3d.Shape()
Appearance23 = x3d.Appearance(DEF="CameraAppearance")
Material24 = x3d.Material(DEF="lambert1_0")
...
Material24.children.append(x3d.Comment("""Universal Media Library: Metals 30"""))
...
Shape25 = x3d.Shape()
IndexedFaceSet26 = x3d.IndexedFaceSet(DEF="pCylinder1_0Geo")
...
Coordinate27 = x3d.Coordinate(DEF="pCylinder1GeoPoints")
Coordinate27.point = [(-0.36, -2.39, -0.26),(-0.36, -1.77, -0.89),(-0.36, 0, -1.7),(-0.36, 0.85, -1.47),(-0.36, 1.47, -0.85),(-0.36, 1.7, 0),(-0.36, 1.47, 0.85),(-0.36, -0.07, 2.05),(-0.36, -0.92, 2.28),(-0.36, -1.77, 2.05),(-0.36, -2.39, 1.43),(-0.36, -2.62, 0.58),(0.36, -2.39, -0.26),(0.36, -1.77, -0.89),(0.36, 0, -1.7),(0.36, 0.85, -1.47),(0.36, 1.47, -0.85),(0.36, 1.7, 0),(0.36, 1.47, 0.85),(0.36, -0.07, 2.05),(0.36, -0.92, 2.28),(0.36, -1.77, 2.05),(0.36, -2.39, 1.43),(0.36, -2.62, 0.58),(-0.36, -0.46, 0.31),(0.36, -0.46, 0.31)]
...
Shape29 = x3d.Shape()
IndexedFaceSet30 = x3d.IndexedFaceSet(DEF="pCube1_0Geo")
...
Coordinate31 = x3d.Coordinate(DEF="pCube1GeoPoints")
...
Shape33 = x3d.Shape()
IndexedFaceSet34 = x3d.IndexedFaceSet(DEF="pPipe1_0Geo")
...
Shape37 = x3d.Shape()
IndexedFaceSet38 = x3d.IndexedFaceSet(DEF="pSphere1_0Geo")
...
Coordinate39 = x3d.Coordinate(DEF="pSphere1GeoPoints")
...
Appearance40 = x3d.Appearance(USE="CameraAppearance")
...
Group41 = x3d.Group()
Transform42 = x3d.Transform(DEF="pCylinder1")
Transform42.rotation = [-1,0,0,0.373518]
Transform42.translation = [-0.038462,3.596312,3.297562]
Shape43 = x3d.Shape()
Appearance44 = x3d.Appearance(USE="CameraAppearance")

Shape43.appearance = Appearance44
IndexedFaceSet45 = x3d.IndexedFaceSet(USE="pCylinder1_0Geo")
...
Transform46 = x3d.Transform(DEF="pCube1")
Transform46.scale = [1,0.727134,0.801457]
Transform46.translation = [-0.030769,1.738461,1.4436]
Shape47 = x3d.Shape()
Appearance48 = x3d.Appearance(USE="CameraAppearance")

Shape47.appearance = Appearance48
IndexedFaceSet49 = x3d.IndexedFaceSet(USE="pCube1_0Geo")
...
Transform50 = x3d.Transform(DEF="pPipe1")
Transform50.scale = [1,1,0.569444]
Transform50.translation = [0.015385,1.630769,-1.973274]
Shape51 = x3d.Shape()
Appearance52 = x3d.Appearance(USE="CameraAppearance")

Shape51.appearance = Appearance52
IndexedFaceSet53 = x3d.IndexedFaceSet(USE="pPipe1_0Geo")
...
Transform54 = x3d.Transform(DEF="pSphere1")
Transform54.scale = [1.1,1.1,0.1]
Transform54.translation = [-0.015385,1.628515,-2.569231]
Shape55 = x3d.Shape()
Appearance56 = x3d.Appearance(USE="CameraAppearance")

Shape55.appearance = Appearance56
IndexedFaceSet57 = x3d.IndexedFaceSet(USE="pSphere1_0Geo")

...
WorldInfo12.title = "SimpleCamera.x3d"
WorldInfo12.info = ["VRML2.0 created with Version 1.3, from Alias Maya 2008"]

Scene11.children.append(WorldInfo12)
Viewpoint13 = x3d.Viewpoint(DEF="CameraShapeView")
Viewpoint13.description = "Camera view, over the shoulder"
Viewpoint13.position = [0,0.75,3]

Scene11.children.append(Viewpoint13)
Viewpoint14 = x3d.Viewpoint()
Viewpoint14.description = "Camera view through lens"
Viewpoint14.position = [0,0,0]

Scene11.children.append(Viewpoint14)
Viewpoint15 = x3d.Viewpoint()
Viewpoint15.description = "Camera view from right side"
Viewpoint15.position = [12,0,-4]
Viewpoint15.orientation = [0,1,0,1.5708]

Scene11.children.append(Viewpoint15)
Viewpoint16 = x3d.Viewpoint()
Viewpoint16.description = "Camera view from above"
Viewpoint16.position = [0,15,-5]
Viewpoint16.orientation = [1,0,0,-1.5708]

Scene11.children.append(Viewpoint16)
Viewpoint17 = x3d.Viewpoint()
Viewpoint17.description = "Camera view from left side"
Viewpoint17.position = [-12,0,-4]
Viewpoint17.orientation = [0,1,0,-1.5708]

Scene11.children.append(Viewpoint17)
Transform18 = x3d.Transform()
Transform18.translation = [0,-0.165,0.02]
Transform18.scale = [0.1,0.1,0.1]
Switch19 = x3d.Switch()
Shape20 = x3d.Shape()
Appearance21 = x3d.Appearance(DEF="CameraAppearance")
Material22 = x3d.Material(DEF="lambert1_0")
Material22.ambientIntensity = 0.25
Material22.diffuseColor = [0.372322,0.371574,0.373173]
Material22.specularColor = [0.890909,0.887832,0.890909]
Material22.shininess = 0.02

Appearance21.material = Material22

Shape20.appearance = Appearance21

Switch19.children.append(Shape20)
Shape23 = x3d.Shape()
Appearance24 = x3d.Appearance(USE="CameraAppearance")

Shape23.appearance = Appearance24
IndexedFaceSet25 = x3d.IndexedFaceSet(DEF="pCylinder1_0Geo")
IndexedFaceSet25.convex = False
IndexedFaceSet25.creaseAngle = 0.7854
IndexedFaceSet25.coordIndex = [0,1,13,12,-1,1,2,14,13,-1,2,3,15,14,-1,3,4,16,15,-1,4,5,17,16,-1,5,6,18,17,-1,6,7,19,18,-1,7,8,20,19,-1,8,9,21,20,-1,9,10,22,21,-1,10,11,23,22,-1,11,0,12,23,-1,1,0,24,-1,2,1,24,-1,3,2,24,-1,4,3,24,-1,5,4,24,-1,6,5,24,-1,7,6,24,-1,8,7,24,-1,9,8,24,-1,10,9,24,-1,11,10,24,-1,0,11,24,-1,12,13,25,-1,13,14,25,-1,14,15,25,-1,15,16,25,-1,16,17,25,-1,17,18,25,-1,18,19,25,-1,19,20,25,-1,20,21,25,-1,21,22,25,-1,22,23,25,-1,23,12,25,-1]
Coordinate26 = x3d.Coordinate(DEF="pCylinder1GeoPoints")
Coordinate26.point = [(-0.36, -2.39, -0.26),(-0.36, -1.77, -0.89),(-0.36, 0, -1.7),(-0.36, 0.85, -1.47),(-0.36, 1.47, -0.85),(-0.36, 1.7, 0),(-0.36, 1.47, 0.85),(-0.36, -0.07, 2.05),(-0.36, -0.92, 2.28),(-0.36, -1.77, 2.05),(-0.36, -2.39, 1.43),(-0.36, -2.62, 0.58),(0.36, -2.39, -0.26),(0.36, -1.77, -0.89),(0.36, 0, -1.7),(0.36, 0.85, -1.47),(0.36, 1.47, -0.85),(0.36, 1.7, 0),(0.36, 1.47, 0.85),(0.36, -0.07, 2.05),(0.36, -0.92, 2.28),(0.36, -1.77, 2.05),(0.36, -2.39, 1.43),(0.36, -2.62, 0.58),(-0.36, -0.46, 0.31),(0.36, -0.46, 0.31)]

IndexedFaceSet25.coord = Coordinate26

Shape23.geometry = IndexedFaceSet25

Switch19.children.append(Shape23)
Shape27 = x3d.Shape()
Appearance28 = x3d.Appearance(USE="CameraAppearance")

Shape27.appearance = Appearance28
IndexedFaceSet29 = x3d.IndexedFaceSet(DEF="pCube1_0Geo")
IndexedFaceSet29.convex = False
IndexedFaceSet29.creaseAngle = 0.7854
IndexedFaceSet29.coordIndex = [0,1,13,12,-1,2,3,25,24,-1,4,5,11,10,-1,6,7,19,18,-1,1,29,31,13,-1,6,18,23,14,-1,8,9,3,2,-1,10,11,15,14,-1,9,30,25,3,-1,10,21,16,4,-1,12,13,9,8,-1,13,31,30,9,-1,14,23,21,10,-1,14,15,7,6,-1,16,17,5,4,-1,18,19,29,28,-1,22,19,7,15,-1,23,18,28,27,-1,17,20,11,5,-1,16,21,26,24,-1,20,22,15,11,-1,21,23,27,26,-1,24,25,17,16,-1,31,29,19,22,-1,25,30,20,17,-1,30,31,22,20,-1,28,29,1,0,-1,27,28,0,12,-1,24,26,8,2,-1,26,27,12,8,-1]
Coordinate30 = x3d.Coordinate(DEF="pCube1GeoPoints")

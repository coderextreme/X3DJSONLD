...
Pymeta(name="title", content="DiamondManLOA0.x3d"),
Pymeta(name="description", content="HAnim skeletal structure for Level of Action (LOA) zero, with one diamond at the base node for the structure. HumanoidRoot only, so this is the minimum legal HAnim humanoid."),
Pymeta(name="creator", content="Matthew T. Beitler"),
Pymeta(name="translator", content="Joel S. Pawloski"),
Pymeta(name="created", content="12 November 2001"),
Pymeta(name="modified", content="23 December 2021"),
Pymeta(name="motto", content="(a) \"Diamonds are a girl's best friend.\" (b) \"Gosh, it sure is chilly in here.\""),
Pymeta(name="reference", content="HAnim 2.0 specification, Appendix A: Nominal human body dimensions and levels of articulation (LOAs)"),
Pymeta(name="reference", content="https://www.web3d.org/documents/specifications/19774-1/V2.0/HAnim/BodyDimensionsAndLOAs.html"),
Pymeta(name="reference", content="https://www.web3d.org/documents/specifications/19774-1/V2.0/HAnim/BodyDimensionsAndLOAs.html#LevelOfArticulationZero"),
Pymeta(name="reference", content="HAnim 1.1 specification, Appendix A: Suggested Body Dimensions and Levels of Articulation, Level of Articulation Zero"),
Pymeta(name="reference", content="http://HAnim.org/Specifications/HAnim1.1/appendices.html#appendixa"),
Pymeta(name="reference", content="http://HAnim.org/Specifications/HAnim1.1/JointCenters1_1_LOA0.wrl"),
Pymeta(name="reference", content="http://HAnim.org/Specifications/HAnim1.1/JointCenters1_1_LOA0-diamond.wrl"),
Pymeta(name="reference", content="http://ece.uwaterloo.ca/~HAnim"),
Pymeta(name="reference", content="http://www.cis.upenn.edu/~badler/anthro/89-71.pdf"),
Pymeta(name="reference", content="http://www.cis.upenn.edu/~badler/anthro/89-71.ps"),
Pymeta(name="reference", content="http://www.cis.upenn.edu/~beitler"),
Pymeta(name="Image", content="humanoid_landmark_locations.gif"),
Pymeta(name="Image", content="http://HAnim.org/Specifications/HAnim1.1/humanoid_landmark_locations.gif"),
Pymeta(name="identifier", content="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA0.x3d"),
Pymeta(name="generator", content="X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit"),
Pymeta(name="license", content="../license.html"),
Pymeta(name="translated", content="19 January 2024"),

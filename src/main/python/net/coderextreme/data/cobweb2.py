...
Background12 = BackgroundObject().setBackUrl(["images/BK.png","https://coderextreme.net/X3DJSONLD/images/BK.png"]).setBottomUrl(["images/BT.png","https://coderextreme.net/X3DJSONLD/images/BT.png"]).setFrontUrl(["images/FR.png","https://coderextreme.net/X3DJSONLD/images/FR.png"]).setLeftUrl(["images/LF.png","https://coderextreme.net/X3DJSONLD/images/LF.png"]).setRightUrl(["images/RT.png","https://coderextreme.net/X3DJSONLD/images/RT.png"]).setTopUrl(["images/TP.png","https://coderextreme.net/X3DJSONLD/images/TP.png"])

                  ...
                  children=[#left
                      ...
                      Transform(
                        scale=(0.5,0.5,0.5), children=[
                            Shape(
                              DEF="ShapeLeftDown", appearance=Appearance(
                                  material=Material(
                                      diffuseColor=(0.7,1,0))), geometry=Extrusion(
                                  spine=(-2.5,0,0,-1.5,0,0), creaseAngle=0.785, crossSection=(1.0,0.0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0.0,-1.0,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1.0,-0.0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0.0,1.0,0.38,0.92,0.71,0.71,0.92,0.38,1.0,0.0)))]),#right

                      Transform(
                        scale=(0.5,0.5,0.5), children=[
                            Shape(
                              DEF="ShapeUpRight", appearance=Appearance(
                                  material=Material(
                                      diffuseColor=(0,0.7,1))), geometry=Extrusion(
                                  spine=(1.5,0,0,2.5,0,0), creaseAngle=0.785, crossSection=(1.0,0.0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0.0,-1.0,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1.0,-0.0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0.0,1.0,0.38,0.92,0.71,0.71,0.92,0.38,1.0,0.0)))]),#up

                      Transform(
                        scale=(0.5,0.5,0.5), children=[
                            Shape(
                              USE="ShapeUpRight")]),#down

    ...
    children=[
        Transform(
          children=[
              ...
              Shape(
                geometry=Text(
                    string=["Node2","\","\\","Node2"], fontStyle=FontStyle(
                        )), appearance=Appearance(
                    material=Material(
                        ))),
              Shape(
                geometry=Text(
                    string=["Node3 \\ \ ","Node3\"\"\""], fontStyle=FontStyle(
                        )), appearance=Appearance(
                    material=Material(
                        ))),
              Script(
                field=[
                    field(name="frontUrls", type="MFString", accessType="initializeOnly", value=("rnl_front.png","uffizi_front.png"))], #['', '\t\t\t    ecmascript:', '\t\t\t    var me = \'"1" ""2" "\n3"\';', '\t\t\t    ', '\t\t\t']

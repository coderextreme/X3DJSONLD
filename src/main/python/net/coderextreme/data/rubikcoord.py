                    ...
                    connect=[
                      ...
                      ProtoInstance(
                        name="boxproto", fieldValue=[
                            ...
                            fieldValue(name="diffuseColor", value=(1,0,0), IS=IS(
                              connect=[
                                  connect(nodeField="diffuseColor", protoField="diffuseColor")]))]),
                      ProtoInstance(
                        name="boxproto", fieldValue=[
                    ...
                    connect=[
                      ...
                      ProtoInstance(
                        name="two", fieldValue=[
                            ...
                            fieldValue(name="diffuseColor", value=(0,1,0), IS=IS(
                              connect=[

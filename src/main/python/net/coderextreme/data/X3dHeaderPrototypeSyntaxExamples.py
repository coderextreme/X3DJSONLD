...
Group47.setBboxCenter([0,0,0])
Group47.setBboxSize([-1,-1,-1])
Shape48 = x3d.Shape()
...
Collision54.setEnabled(True)
Collision54.setBboxCenter([0,0,0])
Collision54.setBboxSize([-1,-1,-1])
Shape55 = x3d.Shape()
...
Transform60.setBboxCenter([0,0,0])
Transform60.setBboxSize([-1,-1,-1])
Shape61 = x3d.Shape()
...
Inline73.setBboxCenter([0,0,0])
Inline73.setBboxSize([-1,-1,-1])

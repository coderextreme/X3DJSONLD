...
X3D(
  profile="Immersive", version="3.3", head=head(  children=[
    ...
    children=[
        ...
        Transform(
          DEF="DECLBubble_bubbleA", children=[
              Shape(
                geometry=Sphere(
              ...
              Script(
                DEF="DECLBubble_bubbleA_bounce", field=[
              ...
              TimeSensor(
                DEF="DECLBubble_bubbleA_bubbleClock", cycleInterval=10, loop=True),
              ROUTE(
                fromNode="DECLBubble_bubbleA_bounce", fromField="translation_changed", toNode="DECLBubble_transform", toField="set_translation"),
              ROUTE(
                fromNode="DECLBubble_bubbleA_bounce", fromField="scale_changed", toNode="DECLBubble_transform", toField="set_scale"),
              ROUTE(
                fromNode="DECLBubble_bubbleA_bubbleClock", fromField="fraction_changed", toNode="DECLBubble_bubbleA_bounce", toField="set_fraction")]),
        Transform(
          DEF="DECLBubble_bubbleB", children=[
              Shape(
                geometry=Sphere(
                    radius=0.25), appearance=Appearance(
                    material=Material(
                        diffuseColor=(1,0,0), transparency=0.2))),
              Script(
                DEF="DECLBubble_bubbleB_bounce", field=[
                    field(name="scale", accessType="inputOutput", type="SFVec3f", value=(1,1,1)),
                    field(name="translation", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
                    field(name="velocity", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
                    field(name="scalvel", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
              ...
              TimeSensor(
                DEF="DECLBubble_bubbleB_bubbleClock", cycleInterval=10, loop=True),
              ROUTE(
                fromNode="DECLBubble_bubbleB_bounce", fromField="translation_changed", toNode="DECLBubble_transform", toField="set_translation"),
              ROUTE(
                fromNode="DECLBubble_bubbleB_bounce", fromField="scale_changed", toNode="DECLBubble_transform", toField="set_scale"),
              ROUTE(
                fromNode="DECLBubble_bubbleB_bubbleClock", fromField="fraction_changed", toNode="DECLBubble_bubbleB_bounce", toField="set_fraction")]),
        Transform(
          DEF="DECLBubble_bubbleC", children=[
              Shape(
                geometry=Sphere(
                    radius=0.25), appearance=Appearance(
                    material=Material(
                        diffuseColor=(1,0,0), transparency=0.2))),
              Script(
                DEF="DECLBubble_bubbleC_bounce", field=[
                    field(name="scale", accessType="inputOutput", type="SFVec3f", value=(1,1,1)),
                    field(name="translation", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
                    field(name="velocity", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
                    field(name="scalvel", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
              ...
              TimeSensor(
                DEF="DECLBubble_bubbleC_bubbleClock", cycleInterval=10, loop=True),
              ROUTE(
                fromNode="DECLBubble_bubbleC_bounce", fromField="translation_changed", toNode="DECLBubble_transform", toField="set_translation"),
              ROUTE(
                fromNode="DECLBubble_bubbleC_bounce", fromField="scale_changed", toNode="DECLBubble_transform", toField="set_scale"),
              ROUTE(
                fromNode="DECLBubble_bubbleC_bubbleClock", fromField="fraction_changed", toNode="DECLBubble_bubbleC_bounce", toField="set_fraction")]),
        Transform(
          DEF="DECLBubble_bubbleD", children=[
              Shape(
                geometry=Sphere(
                    radius=0.25), appearance=Appearance(
                    material=Material(
                        diffuseColor=(1,0,0), transparency=0.2))),
              Script(
                DEF="DECLBubble_bubbleD_bounce", field=[
                    field(name="scale", accessType="inputOutput", type="SFVec3f", value=(1,1,1)),
                    field(name="translation", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
                    field(name="velocity", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
                    field(name="scalvel", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
              ...
              TimeSensor(
                DEF="DECLBubble_bubbleD_bubbleClock", cycleInterval=10, loop=True),
              ROUTE(
                fromNode="DECLBubble_bubbleD_bounce", fromField="translation_changed", toNode="DECLBubble_transform", toField="set_translation"),
              ROUTE(
                fromNode="DECLBubble_bubbleD_bounce", fromField="scale_changed", toNode="DECLBubble_transform", toField="set_scale"),
              ROUTE(
                fromNode="DECLBubble_bubbleD_bubbleClock", fromField="fraction_changed", toNode="DECLBubble_bubbleD_bounce", toField="set_fraction")])]))
.XML())

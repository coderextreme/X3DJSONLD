...
head=head(children=[meta(name="title", content="glflowers.x3d"),
...
Group(children=[
ProtoInstance(name="FlowerProto", fieldValue=[fieldValue(name="vertex", value=["../shaders/gl_flowers_chromatic.vs"]),

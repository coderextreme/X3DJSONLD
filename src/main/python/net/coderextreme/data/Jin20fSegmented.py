...
X3D0.head = head1
Scene4 = x3d.Scene()
Scene4.children.append(x3d.Comment("""https://www.web3d.org/documents/specifications/19774/V2.0/index.html"""))
Scene4.children.append(x3d.Comment("""0 0 0 at floor between feet, default I pose (relaxed attention) model gaze toward +Z, +x to model left, +y up, right-hand rule."""))
WorldInfo5 = x3d.WorldInfo()
WorldInfo5.title = "20f Jin v2 loa4 Level 1, Joints, Segments, Sites"

Scene4.children.append(WorldInfo5)
Transform6 = x3d.Transform(DEF="ContainerScene000")
Shape7 = x3d.Shape(DEF="AxisLinesShape")
Shape7.children.append(x3d.Comment("""Red +X, Green +Y, Blue +Z"""))
...
HAnimHumanoid11 = x3d.HAnimHumanoid(DEF="hanim_JinLOA4S")
HAnimHumanoid11.name = "JinLOA4S"
HAnimHumanoid11.loa = 4
HAnimHumanoid11.version = "2.0"
HAnimJoint12 = x3d.HAnimJoint(DEF="hanim_humanoid_root")
HAnimJoint12.name = "humanoid_root"
HAnimJoint12.center = [0,0.77,0]
HAnimJoint12.ulimit = [0,0,0]
HAnimJoint12.llimit = [0,0,0]
HAnimSegment13 = x3d.HAnimSegment(DEF="hanim_sacrum")
HAnimSegment13.name = "sacrum"
Transform14 = x3d.Transform(DEF="Humanoid000")
Shape15 = x3d.Shape(USE="AxisLinesShape")
...
HAnimJoint16 = x3d.HAnimJoint(DEF="hanim_sacroiliac")
HAnimJoint16.name = "sacroiliac"
HAnimJoint16.center = [0,0.826,0.02]
HAnimJoint16.ulimit = [0,0,0]
HAnimJoint16.llimit = [0,0,0]
HAnimSegment17 = x3d.HAnimSegment(DEF="hanim_pelvis")
HAnimSegment17.name = "pelvis"
HAnimSite18 = x3d.HAnimSite(DEF="hanim_l_iliocristale_pt")
...
HAnimSite30 = x3d.HAnimSite(DEF="hanim_r_iliocristale_pt")
...
HAnimSite42 = x3d.HAnimSite(DEF="hanim_l_trochanterion_pt")
...
HAnimSite54 = x3d.HAnimSite(DEF="hanim_r_trochanterion_pt")
...
HAnimSite66 = x3d.HAnimSite(DEF="hanim_l_asis_pt")
...
HAnimSite78 = x3d.HAnimSite(DEF="hanim_r_asis_pt")
...
HAnimSite90 = x3d.HAnimSite(DEF="hanim_l_psis_pt")
...
HAnimSite102 = x3d.HAnimSite(DEF="hanim_r_psis_pt")
...
HAnimSite114 = x3d.HAnimSite(DEF="hanim_crotch_pt")
...
HAnimSite126 = x3d.HAnimSite(DEF="hanim_buttocks_standing_wall_contact_point_pt")
...
HAnimJoint142 = x3d.HAnimJoint(DEF="hanim_l_hip")
HAnimJoint142.name = "l_hip"
HAnimJoint142.center = [0.095,0.8266,-0.0183]
HAnimJoint142.ulimit = [0,0,0]
HAnimJoint142.llimit = [0,0,0]
HAnimSegment143 = x3d.HAnimSegment(DEF="hanim_l_thigh")
HAnimSegment143.name = "l_thigh"
HAnimSite144 = x3d.HAnimSite(DEF="hanim_l_knee_crease_pt")
...
HAnimSite156 = x3d.HAnimSite(DEF="hanim_l_femoral_medial_epicondyle_pt")
...
HAnimSite168 = x3d.HAnimSite(DEF="hanim_l_femoral_lateral_epicondyle_pt")
...
HAnimSite180 = x3d.HAnimSite(DEF="hanim_l_suprapatella_pt")
...
HAnimSite210 = x3d.HAnimSite(DEF="hanim_l_medial_malleolus_pt")
...
HAnimSite222 = x3d.HAnimSite(DEF="hanim_l_lateral_malleolus_pt")
...
HAnimJoint238 = x3d.HAnimJoint(DEF="hanim_l_talocrural")
...
HAnimSegment239 = x3d.HAnimSegment(DEF="hanim_l_talus")
HAnimSegment239.name = "l_talus"
HAnimSite240 = x3d.HAnimSite(DEF="hanim_l_sphyrion_pt")
...
HAnimSite252 = x3d.HAnimSite(DEF="hanim_l_calcaneus_posterior_pt")
...
HAnimJoint268 = x3d.HAnimJoint(DEF="hanim_l_talocalcaneonavicular")
...
HAnimSegment269 = x3d.HAnimSegment(DEF="hanim_l_navicular")
...
HAnimJoint274 = x3d.HAnimJoint(DEF="hanim_l_cuneonavicular_1")
...
HAnimSegment275 = x3d.HAnimSegment(DEF="hanim_l_cuneiform_1")
...
HAnimJoint280 = x3d.HAnimJoint(DEF="hanim_l_tarsometatarsal_1")
...
HAnimSegment281 = x3d.HAnimSegment(DEF="hanim_l_metatarsal_1")
...
HAnimJoint286 = x3d.HAnimJoint(DEF="hanim_l_metatarsophalangeal_1")
...
HAnimSegment287 = x3d.HAnimSegment(DEF="hanim_l_tarsal_proximal_phalanx_1")
HAnimSegment287.name = "l_tarsal_proximal_phalanx_1"
HAnimSite288 = x3d.HAnimSite(DEF="hanim_l_metatarsal_phalanx_1_pt")
...
HAnimJoint304 = x3d.HAnimJoint(DEF="hanim_l_tarsal_interphalangeal_1")
...
HAnimSegment305 = x3d.HAnimSegment(DEF="hanim_l_tarsal_distal_phalanx_1")
HAnimSegment305.name = "l_tarsal_distal_phalanx_1"
HAnimSite306 = x3d.HAnimSite(DEF="hanim_l_tarsal_distal_phalanx_1_tip")
...
HAnimJoint322 = x3d.HAnimJoint(DEF="hanim_l_cuneonavicular_2")
...
HAnimSegment323 = x3d.HAnimSegment(DEF="hanim_l_cuneiform_2")
...
HAnimJoint328 = x3d.HAnimJoint(DEF="hanim_l_tarsometatarsal_2")
...
HAnimSegment329 = x3d.HAnimSegment(DEF="hanim_l_metatarsal_2")
...
HAnimJoint334 = x3d.HAnimJoint(DEF="hanim_l_metatarsophalangeal_2")
...
HAnimSegment335 = x3d.HAnimSegment(DEF="hanim_l_tarsal_proximal_phalanx_2")
...
HAnimJoint340 = x3d.HAnimJoint(DEF="hanim_l_tarsal_proximal_interphalangeal_2")
...
HAnimSegment341 = x3d.HAnimSegment(DEF="hanim_l_tarsal_middle_phalanx_2")
...
HAnimJoint346 = x3d.HAnimJoint(DEF="hanim_l_tarsal_distal_interphalangeal_2")
...
HAnimSegment347 = x3d.HAnimSegment(DEF="hanim_l_tarsal_distal_phalanx_2")
HAnimSegment347.name = "l_tarsal_distal_phalanx_2"
HAnimSite348 = x3d.HAnimSite(DEF="hanim_l_tarsal_distal_phalanx_2_tip")
...
HAnimJoint364 = x3d.HAnimJoint(DEF="hanim_l_cuneonavicular_3")
...
HAnimSegment365 = x3d.HAnimSegment(DEF="hanim_l_cuneiform_3")
...
HAnimJoint370 = x3d.HAnimJoint(DEF="hanim_l_tarsometatarsal_3")
...
HAnimSegment371 = x3d.HAnimSegment(DEF="hanim_l_metatarsal_3")
...
HAnimJoint376 = x3d.HAnimJoint(DEF="hanim_l_metatarsophalangeal_3")
...
HAnimSegment377 = x3d.HAnimSegment(DEF="hanim_l_tarsal_proximal_phalanx_3")
...
HAnimJoint382 = x3d.HAnimJoint(DEF="hanim_l_tarsal_proximal_interphalangeal_3")
...
HAnimSegment383 = x3d.HAnimSegment(DEF="hanim_l_tarsal_middle_phalanx_3")
...
HAnimJoint388 = x3d.HAnimJoint(DEF="hanim_l_tarsal_distal_interphalangeal_3")
...
HAnimSegment389 = x3d.HAnimSegment(DEF="hanim_l_tarsal_distal_phalanx_3")
HAnimSegment389.name = "l_tarsal_distal_phalanx_3"
HAnimSite390 = x3d.HAnimSite(DEF="hanim_l_tarsal_distal_phalanx_3_tip")
...
HAnimJoint406 = x3d.HAnimJoint(DEF="hanim_l_calcaneocuboid")
...
HAnimSegment407 = x3d.HAnimSegment(DEF="hanim_l_calcaneus")
...
HAnimJoint412 = x3d.HAnimJoint(DEF="hanim_l_transversetarsal")
...
HAnimSegment413 = x3d.HAnimSegment(DEF="hanim_l_cuboid")
...
HAnimJoint418 = x3d.HAnimJoint(DEF="hanim_l_tarsometatarsal_4")
...
HAnimSegment419 = x3d.HAnimSegment(DEF="hanim_l_metatarsal_4")
...
HAnimJoint424 = x3d.HAnimJoint(DEF="hanim_l_metatarsophalangeal_4")
...
HAnimSegment425 = x3d.HAnimSegment(DEF="hanim_l_tarsal_proximal_phalanx_4")
...
HAnimJoint430 = x3d.HAnimJoint(DEF="hanim_l_tarsal_proximal_interphalangeal_4")
...
HAnimSegment431 = x3d.HAnimSegment(DEF="hanim_l_tarsal_middle_phalanx_4")
...
HAnimJoint436 = x3d.HAnimJoint(DEF="hanim_l_tarsal_distal_interphalangeal_4")
...
HAnimSegment437 = x3d.HAnimSegment(DEF="hanim_l_tarsal_distal_phalanx_4")
HAnimSegment437.name = "l_tarsal_distal_phalanx_4"
HAnimSite438 = x3d.HAnimSite(DEF="hanim_l_tarsal_distal_phalanx_4_tip")
...
HAnimJoint454 = x3d.HAnimJoint(DEF="hanim_l_tarsometatarsal_5")
...
HAnimSegment455 = x3d.HAnimSegment(DEF="hanim_l_metatarsal_5")
...
HAnimJoint460 = x3d.HAnimJoint(DEF="hanim_l_metatarsophalangeal_5")
...
HAnimSegment461 = x3d.HAnimSegment(DEF="hanim_l_tarsal_proximal_phalanx_5")
...
HAnimJoint466 = x3d.HAnimJoint(DEF="hanim_l_tarsal_proximal_interphalangeal_5")
...
HAnimSegment467 = x3d.HAnimSegment(DEF="hanim_l_tarsal_middle_phalanx_5")
HAnimSegment467.name = "l_tarsal_middle_phalanx_5"
HAnimSite468 = x3d.HAnimSite(DEF="hanim_l_metatarsal_phalanx_5_pt")
...
HAnimJoint484 = x3d.HAnimJoint(DEF="hanim_l_tarsal_distal_interphalangeal_5")
...
HAnimSegment485 = x3d.HAnimSegment(DEF="hanim_l_tarsal_distal_phalanx_5")
HAnimSegment485.name = "l_tarsal_distal_phalanx_5"
HAnimSite486 = x3d.HAnimSite(DEF="hanim_l_tarsal_distal_phalanx_5_tip")
...
HAnimSite516 = x3d.HAnimSite(DEF="hanim_r_femoral_medial_epicondyle_pt")
...
HAnimSite528 = x3d.HAnimSite(DEF="hanim_r_femoral_lateral_epicondyle_pt")
...
HAnimSite540 = x3d.HAnimSite(DEF="hanim_r_suprapatella_pt")
...
HAnimJoint556 = x3d.HAnimJoint(DEF="hanim_r_knee")
...
HAnimSegment557 = x3d.HAnimSegment(DEF="hanim_r_calf")
HAnimSegment557.name = "r_calf"
HAnimSite558 = x3d.HAnimSite(DEF="hanim_r_tibiale_pt")
...
HAnimSite570 = x3d.HAnimSite(DEF="hanim_r_medial_malleolus_pt")
...
HAnimSite582 = x3d.HAnimSite(DEF="hanim_r_lateral_malleolus_pt")
...
HAnimJoint598 = x3d.HAnimJoint(DEF="hanim_r_talocrural")
...
HAnimSegment599 = x3d.HAnimSegment(DEF="hanim_r_talus")
HAnimSegment599.name = "r_talus"
HAnimSite600 = x3d.HAnimSite(DEF="hanim_r_sphyrion_pt")
...
HAnimSite612 = x3d.HAnimSite(DEF="hanim_r_calcaneus_posterior_pt")
...
HAnimJoint628 = x3d.HAnimJoint(DEF="hanim_r_talocalcaneonavicular")
...
HAnimSegment629 = x3d.HAnimSegment(DEF="hanim_r_navicular")
...
HAnimJoint634 = x3d.HAnimJoint(DEF="hanim_r_cuneonavicular_1")
...
HAnimSegment635 = x3d.HAnimSegment(DEF="hanim_r_cuneiform_1")
...
HAnimJoint640 = x3d.HAnimJoint(DEF="hanim_r_tarsometatarsal_1")
...
HAnimSegment641 = x3d.HAnimSegment(DEF="hanim_r_metatarsal_1")
...
HAnimJoint646 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_1")
...
HAnimSegment647 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_1")
HAnimSegment647.name = "r_tarsal_proximal_phalanx_1"
HAnimSite648 = x3d.HAnimSite(DEF="hanim_r_metatarsal_phalanx_1_pt")
...
HAnimJoint664 = x3d.HAnimJoint(DEF="hanim_r_tarsal_interphalangeal_1")
...
HAnimSegment665 = x3d.HAnimSegment(DEF="hanim_r_tarsal_distal_phalanx_1")
HAnimSegment665.name = "r_tarsal_distal_phalanx_1"
HAnimSite666 = x3d.HAnimSite(DEF="hanim_r_tarsal_distal_phalanx_1_tip")
...
HAnimJoint682 = x3d.HAnimJoint(DEF="hanim_r_cuneonavicular_2")
...
HAnimSegment683 = x3d.HAnimSegment(DEF="hanim_r_cuneiform_2")
...
HAnimJoint688 = x3d.HAnimJoint(DEF="hanim_r_tarsometatarsal_2")
...
HAnimSegment689 = x3d.HAnimSegment(DEF="hanim_r_metatarsal_2")
...
HAnimJoint694 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_2")
...
HAnimSegment695 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_2")
...
HAnimJoint700 = x3d.HAnimJoint(DEF="hanim_r_tarsal_proximal_interphalangeal_2")
...
HAnimSegment701 = x3d.HAnimSegment(DEF="hanim_r_tarsal_middle_phalanx_2")
...
HAnimJoint706 = x3d.HAnimJoint(DEF="hanim_r_tarsal_distal_interphalangeal_2")
...
HAnimSegment707 = x3d.HAnimSegment(DEF="hanim_r_tarsal_distal_phalanx_2")
HAnimSegment707.name = "r_tarsal_distal_phalanx_2"
HAnimSite708 = x3d.HAnimSite(DEF="hanim_r_tarsal_distal_phalanx_2_tip")
...
HAnimJoint724 = x3d.HAnimJoint(DEF="hanim_r_cuneonavicular_3")
...
HAnimSegment725 = x3d.HAnimSegment(DEF="hanim_r_cuneiform_3")
...
HAnimJoint730 = x3d.HAnimJoint(DEF="hanim_r_tarsometatarsal_3")
...
HAnimSegment731 = x3d.HAnimSegment(DEF="hanim_r_metatarsal_3")
...
HAnimJoint736 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_3")
...
HAnimSegment737 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_3")
...
HAnimJoint742 = x3d.HAnimJoint(DEF="hanim_r_tarsal_proximal_interphalangeal_3")
...
HAnimSegment743 = x3d.HAnimSegment(DEF="hanim_r_tarsal_middle_phalanx_3")
...
HAnimJoint748 = x3d.HAnimJoint(DEF="hanim_r_tarsal_distal_interphalangeal_3")
...
HAnimSegment749 = x3d.HAnimSegment(DEF="hanim_r_tarsal_distal_phalanx_3")
HAnimSegment749.name = "r_tarsal_distal_phalanx_3"
HAnimSite750 = x3d.HAnimSite(DEF="hanim_r_tarsal_distal_phalanx_3_tip")
...
HAnimJoint766 = x3d.HAnimJoint(DEF="hanim_r_calcaneocuboid")
...
HAnimSegment767 = x3d.HAnimSegment(DEF="hanim_r_calcaneus")
...
HAnimJoint772 = x3d.HAnimJoint(DEF="hanim_r_transversetarsal")
...
HAnimSegment773 = x3d.HAnimSegment(DEF="hanim_r_cuboid")
...
HAnimJoint778 = x3d.HAnimJoint(DEF="hanim_r_tarsometatarsal_4")
...
HAnimSegment779 = x3d.HAnimSegment(DEF="hanim_r_metatarsal_4")
...
HAnimJoint784 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_4")
...
HAnimSegment785 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_4")
...
HAnimJoint790 = x3d.HAnimJoint(DEF="hanim_r_tarsal_proximal_interphalangeal_4")
...
HAnimSegment791 = x3d.HAnimSegment(DEF="hanim_r_tarsal_middle_phalanx_4")
...
HAnimJoint796 = x3d.HAnimJoint(DEF="hanim_r_tarsal_distal_interphalangeal_4")
...
HAnimSegment797 = x3d.HAnimSegment(DEF="hanim_r_tarsal_distal_phalanx_4")
HAnimSegment797.name = "r_tarsal_distal_phalanx_4"
HAnimSite798 = x3d.HAnimSite(DEF="hanim_r_tarsal_distal_phalanx_4_tip")
...
HAnimJoint814 = x3d.HAnimJoint(DEF="hanim_r_tarsometatarsal_5")
...
HAnimSegment815 = x3d.HAnimSegment(DEF="hanim_r_metatarsal_5")
...
HAnimJoint820 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_5")
...
HAnimSegment821 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_5")
...
HAnimJoint826 = x3d.HAnimJoint(DEF="hanim_r_tarsal_proximal_interphalangeal_5")
...
HAnimSegment827 = x3d.HAnimSegment(DEF="hanim_r_tarsal_middle_phalanx_5")
HAnimSegment827.name = "r_tarsal_middle_phalanx_5"
HAnimSite828 = x3d.HAnimSite(DEF="hanim_r_metatarsal_phalanx_5_pt")
...
HAnimJoint844 = x3d.HAnimJoint(DEF="hanim_r_tarsal_distal_interphalangeal_5")
...
HAnimSegment845 = x3d.HAnimSegment(DEF="hanim_r_tarsal_distal_phalanx_5")
HAnimSegment845.name = "r_tarsal_distal_phalanx_5"
HAnimSite846 = x3d.HAnimSite(DEF="hanim_r_tarsal_distal_phalanx_5_tip")
...
HAnimJoint862 = x3d.HAnimJoint(DEF="hanim_vl5")
HAnimJoint862.name = "vl5"
HAnimJoint862.center = [0,0.9254,-0.01376]
HAnimJoint862.ulimit = [0,0,0]
HAnimJoint862.llimit = [0,0,0]
HAnimSegment863 = x3d.HAnimSegment(DEF="hanim_l5")
HAnimSegment863.name = "l5"
HAnimSite864 = x3d.HAnimSite(DEF="hanim_spine_1_middle_back_pt")
...
HAnimSite876 = x3d.HAnimSite(DEF="hanim_spine_2_lower_back_pt")
...
HAnimSite888 = x3d.HAnimSite(DEF="hanim_waist_preferred_anterior_pt")
...
HAnimSite900 = x3d.HAnimSite(DEF="hanim_waist_preferred_posterior_pt")
...
HAnimSite912 = x3d.HAnimSite(DEF="hanim_navel_pt")
...
HAnimSite954 = x3d.HAnimSite(DEF="hanim_r_rib10_pt")
...
HAnimJoint988 = x3d.HAnimJoint(DEF="hanim_vt10")
HAnimJoint988.name = "vt10"
HAnimJoint988.center = [0,1.0638,-0.01378]
HAnimJoint988.ulimit = [0,0,0]
HAnimJoint988.llimit = [0,0,0]
HAnimSegment989 = x3d.HAnimSegment(DEF="hanim_t10")
HAnimSegment989.name = "t10"
HAnimSite990 = x3d.HAnimSite(DEF="hanim_substernale_pt")
...
HAnimSite1002 = x3d.HAnimSite(DEF="hanim_mesosternale_pt")
...
HAnimJoint1018 = x3d.HAnimJoint(DEF="hanim_vt9")
HAnimJoint1018.name = "vt9"
HAnimJoint1018.center = [0,1.0784,-0.01376]
HAnimJoint1018.ulimit = [0,0,0]
HAnimJoint1018.llimit = [0,0,0]
HAnimSegment1019 = x3d.HAnimSegment(DEF="hanim_t9")
HAnimSegment1019.name = "t9"
HAnimSite1020 = x3d.HAnimSite(DEF="hanim_l_thelion_pt")
...
HAnimSite1032 = x3d.HAnimSite(DEF="hanim_r_thelion_pt")
...
HAnimSite1044 = x3d.HAnimSite(DEF="hanim_rear_center_midsagittal_plane_pt")
...
HAnimSite1056 = x3d.HAnimSite(DEF="hanim_l_chest_midsagittal_plane_pt")
...
HAnimSite1068 = x3d.HAnimSite(DEF="hanim_r_chest_midsagittal_plane_pt")
...
HAnimJoint1126 = x3d.HAnimJoint(DEF="hanim_vt1")
HAnimJoint1126.name = "vt1"
HAnimJoint1126.center = [0,1.22,-0.0138]
HAnimJoint1126.ulimit = [0,0,0]
HAnimJoint1126.llimit = [0,0,0]
HAnimSegment1127 = x3d.HAnimSegment(DEF="hanim_t1")
HAnimSegment1127.name = "t1"
HAnimSite1128 = x3d.HAnimSite(DEF="hanim_suprasternale_pt")
...
HAnimSite1140 = x3d.HAnimSite(DEF="hanim_cervicale_pt")
...
HAnimJoint1156 = x3d.HAnimJoint(DEF="hanim_vc7")
HAnimJoint1156.name = "vc7"
HAnimJoint1156.center = [0,1.2453,-0.01506]
HAnimJoint1156.ulimit = [0,0,0]
HAnimJoint1156.llimit = [0,0,0]
HAnimSegment1157 = x3d.HAnimSegment(DEF="hanim_c7")
HAnimSegment1157.name = "c7"
HAnimSite1158 = x3d.HAnimSite(DEF="hanim_l_neck_base_pt")
...
HAnimSite1170 = x3d.HAnimSite(DEF="hanim_r_neck_base_pt")
...
HAnimJoint1210 = x3d.HAnimJoint(DEF="hanim_vc2")
HAnimJoint1210.name = "vc2"
HAnimJoint1210.center = [0,1.307,-0.015]
HAnimJoint1210.ulimit = [0,0,0]
HAnimJoint1210.llimit = [0,0,0]
HAnimSegment1211 = x3d.HAnimSegment(DEF="hanim_c2")
HAnimSegment1211.name = "c2"
HAnimSite1212 = x3d.HAnimSite(DEF="hanim_adams_apple_pt")
...
HAnimJoint1234 = x3d.HAnimJoint(DEF="hanim_skullbase")
HAnimJoint1234.name = "skullbase"
HAnimJoint1234.center = [0,1.3126,-0.0154]
HAnimJoint1234.ulimit = [0,0,0]
HAnimJoint1234.llimit = [0,0,0]
HAnimSegment1235 = x3d.HAnimSegment(DEF="hanim_skull")
HAnimSegment1235.name = "skull"
HAnimSite1236 = x3d.HAnimSite(DEF="hanim_skull_vertex_pt")
...
HAnimSite1248 = x3d.HAnimSite(DEF="hanim_glabella_pt")
...
HAnimSite1260 = x3d.HAnimSite(DEF="hanim_sellion_pt")
...
HAnimSite1272 = x3d.HAnimSite(DEF="hanim_l_infraorbitale_pt")
...
HAnimSite1284 = x3d.HAnimSite(DEF="hanim_l_tragion_pt")
...
HAnimSite1296 = x3d.HAnimSite(DEF="hanim_r_infraorbitale_pt")
...
HAnimSite1308 = x3d.HAnimSite(DEF="hanim_r_tragion_pt")
...
HAnimSite1320 = x3d.HAnimSite(DEF="hanim_nuchale_pt")
...
HAnimSite1332 = x3d.HAnimSite(DEF="hanim_opisthocranion_pt")
...
HAnimSite1344 = x3d.HAnimSite(DEF="hanim_l_ectocanthus_pt")
...
HAnimSite1356 = x3d.HAnimSite(DEF="hanim_r_ectocanthus_pt")
...
HAnimJoint1372 = x3d.HAnimJoint(DEF="hanim_l_eyelid_joint")
...
HAnimSegment1373 = x3d.HAnimSegment(DEF="hanim_l_eyelid")
HAnimSegment1373.name = "l_eyelid"
HAnimSite1374 = x3d.HAnimSite(DEF="hanim_l_eyelid_tip")
...
HAnimJoint1390 = x3d.HAnimJoint(DEF="hanim_r_eyelid_joint")
...
HAnimSegment1391 = x3d.HAnimSegment(DEF="hanim_r_eyelid")
HAnimSegment1391.name = "r_eyelid"
HAnimSite1392 = x3d.HAnimSite(DEF="hanim_r_eyelid_tip")
...
HAnimJoint1408 = x3d.HAnimJoint(DEF="hanim_l_eyeball_joint")
...
HAnimSegment1409 = x3d.HAnimSegment(DEF="hanim_l_eyeball")
HAnimSegment1409.name = "l_eyeball"
HAnimSite1410 = x3d.HAnimSite(DEF="hanim_l_eyeball_tip")
...
HAnimJoint1426 = x3d.HAnimJoint(DEF="hanim_r_eyeball_joint")
...
HAnimSegment1427 = x3d.HAnimSegment(DEF="hanim_r_eyeball")
HAnimSegment1427.name = "r_eyeball"
HAnimSite1428 = x3d.HAnimSite(DEF="hanim_r_eyeball_tip")
...
HAnimJoint1444 = x3d.HAnimJoint(DEF="hanim_l_eyebrow_joint")
...
HAnimSegment1445 = x3d.HAnimSegment(DEF="hanim_l_eyebrow")
HAnimSegment1445.name = "l_eyebrow"
HAnimSite1446 = x3d.HAnimSite(DEF="hanim_l_eyebrow_tip")
...
HAnimJoint1462 = x3d.HAnimJoint(DEF="hanim_r_eyebrow_joint")
...
HAnimSegment1463 = x3d.HAnimSegment(DEF="hanim_r_eyebrow")
HAnimSegment1463.name = "r_eyebrow"
HAnimSite1464 = x3d.HAnimSite(DEF="hanim_r_eyebrow_tip")
...
HAnimJoint1480 = x3d.HAnimJoint(DEF="hanim_temporomandibular")
...
HAnimSegment1481 = x3d.HAnimSegment(DEF="hanim_jaw")
HAnimSegment1481.name = "jaw"
HAnimSite1482 = x3d.HAnimSite(DEF="hanim_l_gonion_pt")
...
HAnimSite1494 = x3d.HAnimSite(DEF="hanim_r_gonion_pt")
...
HAnimSite1506 = x3d.HAnimSite(DEF="hanim_supramenton_pt")
...
HAnimSite1518 = x3d.HAnimSite(DEF="hanim_menton_pt")
...
HAnimJoint1534 = x3d.HAnimJoint(DEF="hanim_l_sternoclavicular")
...
HAnimSegment1535 = x3d.HAnimSegment(DEF="hanim_l_clavicle")
HAnimSegment1535.name = "l_clavicle"
HAnimSite1536 = x3d.HAnimSite(DEF="hanim_l_clavicale_pt")
...
HAnimJoint1552 = x3d.HAnimJoint(DEF="hanim_l_acromioclavicular")
...
HAnimSegment1553 = x3d.HAnimSegment(DEF="hanim_l_scapula")
HAnimSegment1553.name = "l_scapula"
HAnimSite1554 = x3d.HAnimSite(DEF="hanim_l_acromion_pt")
...
HAnimSite1566 = x3d.HAnimSite(DEF="hanim_l_axilla_proximal_pt")
...
HAnimSite1578 = x3d.HAnimSite(DEF="hanim_l_axilla_distal_pt")
...
HAnimSite1590 = x3d.HAnimSite(DEF="hanim_l_axilla_posterior_folds_pt")
...
HAnimJoint1606 = x3d.HAnimJoint(DEF="hanim_l_shoulder")
...
HAnimSegment1607 = x3d.HAnimSegment(DEF="hanim_l_upperarm")
HAnimSegment1607.name = "l_upperarm"
HAnimSite1608 = x3d.HAnimSite(DEF="hanim_l_humeral_lateral_epicondyle_pt")
...
HAnimSite1620 = x3d.HAnimSite(DEF="hanim_l_humeral_medial_epicondyle_pt")
...
HAnimSite1632 = x3d.HAnimSite(DEF="hanim_l_radiale_pt")
...
HAnimSite1644 = x3d.HAnimSite(DEF="hanim_l_bideltoid_pt")
...
HAnimJoint1660 = x3d.HAnimJoint(DEF="hanim_l_elbow")
...
HAnimSegment1661 = x3d.HAnimSegment(DEF="hanim_l_forearm")
HAnimSegment1661.name = "l_forearm"
HAnimSite1662 = x3d.HAnimSite(DEF="hanim_l_radial_styloid_pt")
...
HAnimSite1674 = x3d.HAnimSite(DEF="hanim_l_olecranon_pt")
...
HAnimJoint1690 = x3d.HAnimJoint(DEF="hanim_l_radiocarpal")
...
HAnimSegment1691 = x3d.HAnimSegment(DEF="hanim_l_carpal")
HAnimSegment1691.name = "l_carpal"
HAnimSite1692 = x3d.HAnimSite(DEF="hanim_l_ulnar_styloid_pt")
...
HAnimJoint1708 = x3d.HAnimJoint(DEF="hanim_l_midcarpal_1")
...
HAnimSegment1709 = x3d.HAnimSegment(DEF="hanim_l_trapezium")
...
HAnimJoint1714 = x3d.HAnimJoint(DEF="hanim_l_carpometacarpal_1")
...
HAnimSegment1715 = x3d.HAnimSegment(DEF="hanim_l_metacarpal_1")
HAnimSegment1715.name = "l_metacarpal_1"
HAnimSite1716 = x3d.HAnimSite(DEF="hanim_l_metacarpal_phalanx_2_pt")
...
HAnimJoint1732 = x3d.HAnimJoint(DEF="hanim_l_metacarpophalangeal_1")
...
HAnimSegment1733 = x3d.HAnimSegment(DEF="hanim_l_carpal_proximal_phalanx_1")
...
HAnimJoint1738 = x3d.HAnimJoint(DEF="hanim_l_carpal_interphalangeal_1")
...
HAnimSegment1739 = x3d.HAnimSegment(DEF="hanim_l_carpal_distal_phalanx_1")
HAnimSegment1739.name = "l_carpal_distal_phalanx_1"
HAnimSite1740 = x3d.HAnimSite(DEF="hanim_l_carpal_distal_phalanx_1_tip")
...
HAnimJoint1756 = x3d.HAnimJoint(DEF="hanim_l_midcarpal_2")
...
HAnimSegment1757 = x3d.HAnimSegment(DEF="hanim_l_trapezoid")
...
HAnimJoint1762 = x3d.HAnimJoint(DEF="hanim_l_carpometacarpal_2")
...
HAnimSegment1763 = x3d.HAnimSegment(DEF="hanim_l_metacarpal_2")
...
HAnimJoint1768 = x3d.HAnimJoint(DEF="hanim_l_metacarpophalangeal_2")
...
HAnimSegment1769 = x3d.HAnimSegment(DEF="hanim_l_carpal_proximal_phalanx_2")
...
HAnimJoint1774 = x3d.HAnimJoint(DEF="hanim_l_carpal_proximal_interphalangeal_2")
...
HAnimSegment1775 = x3d.HAnimSegment(DEF="hanim_l_carpal_middle_phalanx_2")
...
HAnimJoint1780 = x3d.HAnimJoint(DEF="hanim_l_carpal_distal_interphalangeal_2")
...
HAnimSegment1781 = x3d.HAnimSegment(DEF="hanim_l_carpal_distal_phalanx_2")
HAnimSegment1781.name = "l_carpal_distal_phalanx_2"
HAnimSite1782 = x3d.HAnimSite(DEF="hanim_l_dactylion_pt")
...
HAnimSite1794 = x3d.HAnimSite(DEF="hanim_l_carpal_distal_phalanx_2_tip")
...
HAnimJoint1810 = x3d.HAnimJoint(DEF="hanim_l_midcarpal_3")
...
HAnimSegment1811 = x3d.HAnimSegment(DEF="hanim_l_capitate")
...
HAnimJoint1816 = x3d.HAnimJoint(DEF="hanim_l_carpometacarpal_3")
...
HAnimSegment1817 = x3d.HAnimSegment(DEF="hanim_l_metacarpal_3")
HAnimSegment1817.name = "l_metacarpal_3"
HAnimSite1818 = x3d.HAnimSite(DEF="hanim_l_metacarpal_phalanx_3_pt")
...
HAnimJoint1834 = x3d.HAnimJoint(DEF="hanim_l_metacarpophalangeal_3")
...
HAnimSegment1835 = x3d.HAnimSegment(DEF="hanim_l_carpal_proximal_phalanx_3")
...
HAnimJoint1840 = x3d.HAnimJoint(DEF="hanim_l_carpal_proximal_interphalangeal_3")
...
HAnimSegment1841 = x3d.HAnimSegment(DEF="hanim_l_carpal_middle_phalanx_3")
...
HAnimJoint1846 = x3d.HAnimJoint(DEF="hanim_l_carpal_distal_interphalangeal_3")
...
HAnimSegment1847 = x3d.HAnimSegment(DEF="hanim_l_carpal_distal_phalanx_3")
HAnimSegment1847.name = "l_carpal_distal_phalanx_3"
HAnimSite1848 = x3d.HAnimSite(DEF="hanim_l_carpal_distal_phalanx_3_tip")
...
HAnimJoint1864 = x3d.HAnimJoint(DEF="hanim_l_midcarpal_4_5")
...
HAnimSegment1865 = x3d.HAnimSegment(DEF="hanim_l_hamate")
...
HAnimJoint1870 = x3d.HAnimJoint(DEF="hanim_l_carpometacarpal_4")
...
HAnimSegment1871 = x3d.HAnimSegment(DEF="hanim_l_metacarpal_4")
...
HAnimJoint1876 = x3d.HAnimJoint(DEF="hanim_l_metacarpophalangeal_4")
...
HAnimSegment1877 = x3d.HAnimSegment(DEF="hanim_l_carpal_proximal_phalanx_4")
...
HAnimJoint1882 = x3d.HAnimJoint(DEF="hanim_l_carpal_proximal_interphalangeal_4")
...
HAnimSegment1883 = x3d.HAnimSegment(DEF="hanim_l_carpal_middle_phalanx_4")
...
HAnimJoint1888 = x3d.HAnimJoint(DEF="hanim_l_carpal_distal_interphalangeal_4")
...
HAnimSegment1889 = x3d.HAnimSegment(DEF="hanim_l_carpal_distal_phalanx_4")
HAnimSegment1889.name = "l_carpal_distal_phalanx_4"
HAnimSite1890 = x3d.HAnimSite(DEF="hanim_l_carpal_distal_phalanx_4_tip")
...
HAnimJoint1906 = x3d.HAnimJoint(DEF="hanim_l_carpometacarpal_5")
...
HAnimSegment1907 = x3d.HAnimSegment(DEF="hanim_l_metacarpal_5")
HAnimSegment1907.name = "l_metacarpal_5"
HAnimSite1908 = x3d.HAnimSite(DEF="hanim_l_metacarpal_phalanx_5_pt")
...
HAnimJoint1924 = x3d.HAnimJoint(DEF="hanim_l_metacarpophalangeal_5")
...
HAnimSegment1925 = x3d.HAnimSegment(DEF="hanim_l_carpal_proximal_phalanx_5")
...
HAnimJoint1930 = x3d.HAnimJoint(DEF="hanim_l_carpal_proximal_interphalangeal_5")
...
HAnimSegment1931 = x3d.HAnimSegment(DEF="hanim_l_carpal_middle_phalanx_5")
...
HAnimJoint1936 = x3d.HAnimJoint(DEF="hanim_l_carpal_distal_interphalangeal_5")
...
HAnimSegment1937 = x3d.HAnimSegment(DEF="hanim_l_carpal_distal_phalanx_5")
HAnimSegment1937.name = "l_carpal_distal_phalanx_5"
HAnimSite1938 = x3d.HAnimSite(DEF="hanim_l_carpal_distal_phalanx_5_tip")
...
HAnimJoint1954 = x3d.HAnimJoint(DEF="hanim_r_sternoclavicular")
...
HAnimSegment1955 = x3d.HAnimSegment(DEF="hanim_r_clavicle")
HAnimSegment1955.name = "r_clavicle"
HAnimSite1956 = x3d.HAnimSite(DEF="hanim_r_clavicale_pt")
...
HAnimJoint1972 = x3d.HAnimJoint(DEF="hanim_r_acromioclavicular")
...
HAnimSegment1973 = x3d.HAnimSegment(DEF="hanim_r_scapula")
HAnimSegment1973.name = "r_scapula"
HAnimSite1974 = x3d.HAnimSite(DEF="hanim_r_acromion_pt")
...
HAnimSite1986 = x3d.HAnimSite(DEF="hanim_r_axilla_proximal_pt")
...
HAnimSite1998 = x3d.HAnimSite(DEF="hanim_r_axilla_distal_pt")
...
HAnimSite2010 = x3d.HAnimSite(DEF="hanim_r_axilla_posterior_folds_pt")
...
HAnimJoint2026 = x3d.HAnimJoint(DEF="hanim_r_shoulder")
...
HAnimSegment2027 = x3d.HAnimSegment(DEF="hanim_r_upperarm")
HAnimSegment2027.name = "r_upperarm"
HAnimSite2028 = x3d.HAnimSite(DEF="hanim_r_humeral_lateral_epicondyle_pt")
...
HAnimSite2040 = x3d.HAnimSite(DEF="hanim_r_humeral_medial_epicondyle_pt")
...
HAnimSite2052 = x3d.HAnimSite(DEF="hanim_r_radiale_pt")
...
HAnimSite2064 = x3d.HAnimSite(DEF="hanim_r_bideltoid_pt")
...
HAnimJoint2080 = x3d.HAnimJoint(DEF="hanim_r_elbow")
...
HAnimSegment2081 = x3d.HAnimSegment(DEF="hanim_r_forearm")
HAnimSegment2081.name = "r_forearm"
HAnimSite2082 = x3d.HAnimSite(DEF="hanim_r_radial_styloid_pt")
...
HAnimSite2094 = x3d.HAnimSite(DEF="hanim_r_olecranon_pt")
...
HAnimJoint2110 = x3d.HAnimJoint(DEF="hanim_r_radiocarpal")
...
HAnimSegment2111 = x3d.HAnimSegment(DEF="hanim_r_carpal")
HAnimSegment2111.name = "r_carpal"
HAnimSite2112 = x3d.HAnimSite(DEF="hanim_r_ulnar_styloid_pt")
...
HAnimJoint2128 = x3d.HAnimJoint(DEF="hanim_r_midcarpal_1")
...
HAnimSegment2129 = x3d.HAnimSegment(DEF="hanim_r_trapezium")
...
HAnimJoint2134 = x3d.HAnimJoint(DEF="hanim_r_carpometacarpal_1")
...
HAnimSegment2135 = x3d.HAnimSegment(DEF="hanim_r_metacarpal_1")
HAnimSegment2135.name = "r_metacarpal_1"
HAnimSite2136 = x3d.HAnimSite(DEF="hanim_r_metacarpal_phalanx_2_pt")
...
HAnimJoint2152 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_1")
...
HAnimSegment2153 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_1")
...
HAnimJoint2158 = x3d.HAnimJoint(DEF="hanim_r_carpal_interphalangeal_1")
...
HAnimSegment2159 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_1")
HAnimSegment2159.name = "r_carpal_distal_phalanx_1"
HAnimSite2160 = x3d.HAnimSite(DEF="hanim_r_carpal_distal_phalanx_1_tip")
...
HAnimJoint2176 = x3d.HAnimJoint(DEF="hanim_r_midcarpal_2")
...
HAnimSegment2177 = x3d.HAnimSegment(DEF="hanim_r_trapezoid")
...
HAnimJoint2182 = x3d.HAnimJoint(DEF="hanim_r_carpometacarpal_2")
...
HAnimSegment2183 = x3d.HAnimSegment(DEF="hanim_r_metacarpal_2")
...
HAnimJoint2188 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_2")
...
HAnimSegment2189 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_2")
...
HAnimJoint2194 = x3d.HAnimJoint(DEF="hanim_r_carpal_proximal_interphalangeal_2")
...
HAnimSegment2195 = x3d.HAnimSegment(DEF="hanim_r_carpal_middle_phalanx_2")
...
HAnimJoint2200 = x3d.HAnimJoint(DEF="hanim_r_carpal_distal_interphalangeal_2")
...
HAnimSegment2201 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_2")
HAnimSegment2201.name = "r_carpal_distal_phalanx_2"
HAnimSite2202 = x3d.HAnimSite(DEF="hanim_r_dactylion_pt")
...
HAnimSite2214 = x3d.HAnimSite(DEF="hanim_r_carpal_distal_phalanx_2_tip")
...
HAnimJoint2230 = x3d.HAnimJoint(DEF="hanim_r_midcarpal_3")
...
HAnimSegment2231 = x3d.HAnimSegment(DEF="hanim_r_capitate")
...
HAnimJoint2236 = x3d.HAnimJoint(DEF="hanim_r_carpometacarpal_3")
...
HAnimSegment2237 = x3d.HAnimSegment(DEF="hanim_r_metacarpal_3")
HAnimSegment2237.name = "r_metacarpal_3"
HAnimSite2238 = x3d.HAnimSite(DEF="hanim_r_metacarpal_phalanx_3_pt")
...
HAnimJoint2254 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_3")
...
HAnimSegment2255 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_3")
...
HAnimJoint2260 = x3d.HAnimJoint(DEF="hanim_r_carpal_proximal_interphalangeal_3")
...
HAnimSegment2261 = x3d.HAnimSegment(DEF="hanim_r_carpal_middle_phalanx_3")
...
HAnimJoint2266 = x3d.HAnimJoint(DEF="hanim_r_carpal_distal_interphalangeal_3")
...
HAnimSegment2267 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_3")
HAnimSegment2267.name = "r_carpal_distal_phalanx_3"
HAnimSite2268 = x3d.HAnimSite(DEF="hanim_r_carpal_distal_phalanx_3_tip")
...
HAnimJoint2284 = x3d.HAnimJoint(DEF="hanim_r_midcarpal_4_5")
...
HAnimSegment2285 = x3d.HAnimSegment(DEF="hanim_r_hamate")
...
HAnimJoint2290 = x3d.HAnimJoint(DEF="hanim_r_carpometacarpal_4")
...
HAnimSegment2291 = x3d.HAnimSegment(DEF="hanim_r_metacarpal_4")
...
HAnimJoint2296 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_4")
...
HAnimSegment2297 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_4")
...
HAnimJoint2302 = x3d.HAnimJoint(DEF="hanim_r_carpal_proximal_interphalangeal_4")
...
HAnimSegment2303 = x3d.HAnimSegment(DEF="hanim_r_carpal_middle_phalanx_4")
...
HAnimJoint2308 = x3d.HAnimJoint(DEF="hanim_r_carpal_distal_interphalangeal_4")
...
HAnimSegment2309 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_4")
HAnimSegment2309.name = "r_carpal_distal_phalanx_4"
HAnimSite2310 = x3d.HAnimSite(DEF="hanim_r_carpal_distal_phalanx_4_tip")
...
HAnimJoint2326 = x3d.HAnimJoint(DEF="hanim_r_carpometacarpal_5")
...
HAnimSegment2327 = x3d.HAnimSegment(DEF="hanim_r_metacarpal_5")
HAnimSegment2327.name = "r_metacarpal_5"
HAnimSite2328 = x3d.HAnimSite(DEF="hanim_r_metacarpal_phalanx_5_pt")
...
HAnimJoint2344 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_5")
...
HAnimSegment2345 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_5")
...
HAnimJoint2350 = x3d.HAnimJoint(DEF="hanim_r_carpal_proximal_interphalangeal_5")
...
HAnimSegment2351 = x3d.HAnimSegment(DEF="hanim_r_carpal_middle_phalanx_5")
...
HAnimJoint2356 = x3d.HAnimJoint(DEF="hanim_r_carpal_distal_interphalangeal_5")
...
HAnimSegment2357 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_5")
HAnimSegment2357.name = "r_carpal_distal_phalanx_5"
HAnimSite2358 = x3d.HAnimSite(DEF="hanim_r_carpal_distal_phalanx_5_tip")
...
Background2375 = x3d.Background(DEF="Background1")
...
Transform2378 = x3d.Transform(DEF="Landmark000")
Transform2378.children.append(x3d.Comment("""Another Parent Scene 0 0 0 landmark"""))
Shape2379 = x3d.Shape(DEF="HAnim000Landmark")

...
Scene16.children.append(x3d.Comment("""<Environment id=\"gamma\" gammaCorrectionDefault=\"none\"></Environment>"""))
Shape24 = x3d.Shape()
...
X3D0.Scene = Scene16
f = open("../data/indexedfacesetPixeltexture_entire.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../data/indexedfacesetPixeltexture_entire.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/indexedfacesetPixeltexture_entire.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

...
print(
X3D(
  profile="Immersive", version="3.2", head=head(  children=[
    ...
    children=[#=============== Camera ==============
        ...
        ProtoDeclare(
          name="Camera", appinfo="Camera node provides direct control of scene view to enable cinematic camera animation shot by shot and move by move along with still digital-photography settings for offline rendering of camera images.", ProtoInterface=ProtoInterface(
            children=[#Viewpoint-related fields, NavigationInfo-related fields and Camera-unique fields
], field=[
                ...
                field(name="shots", accessType="inputOutput", appinfo="Array of CameraShot nodes which in turn contain CameraMovement nodes", type="MFNode", children=[#initialization nodes (if any) go here
]),
                ...
                field(name="offlineRender", accessType="inputOutput", appinfo="OfflineRender node", type="SFNode", children=[#initialization node (if any) goes here
]),
                field(name="traceEnabled", accessType="initializeOnly", appinfo="enable console output to trace script computations and prototype progress", type="SFBool", value=False)]), ProtoBody=ProtoBody(
            children=[
                Viewpoint(
                  DEF="CameraViewpoint", IS=IS(
                    connect=[
                        ...
                        connect(nodeField="isBound", protoField="isBound")])),#NavInfo EXAMINE used since some browsers (InstantReality) try to lock view to vertical when flying to avoid disorientation

                NavigationInfo(
                  DEF="CameraNavInfo", type="\"EXAMINE\" \"FLY\" \"ANY\"", IS=IS(
                    connect=[
                        connect(nodeField="set_bind", protoField="set_bind"),
                        connect(nodeField="headlight", protoField="headlight"),
                        connect(nodeField="visibilityLimit", protoField="farClipPlane")], children=[#No need to bind outputs bindTime, isBound from NavigationInfo since Viewpoint outputs will suffice. TODO inform BitManagement that bindTime field is missing.
])),#this DirectionalLight replaces NavigationInfo headlight in order to add color capability

                DirectionalLight(
                  DEF="CameraDirectionalLight", global=True, children=[#TODO confirm other default field values match NavigationInfo spec
], IS=IS(
                    connect=[
                ...
                PositionInterpolator(
                  DEF="CameraPositionInterpolator", key=[0,1], keyValue=[0,0,0,0,0,0], IS=IS(
                    connect=[
                        connect(nodeField="set_fraction", protoField="set_fraction")])),
                OrientationInterpolator(
                  DEF="CameraOrientationInterpolator", key=[0,1], keyValue=[0,1,0,0,0,1,0,0], IS=IS(
                    connect=[
                        connect(nodeField="set_fraction", protoField="set_fraction")])),
                ROUTE(
                  fromField="value_changed", fromNode="CameraPositionInterpolator", toField="position", toNode="CameraViewpoint"),
                ROUTE(
                  fromField="value_changed", fromNode="CameraOrientationInterpolator", toField="orientation", toNode="CameraViewpoint"),
                Script(
                  DEF="CameraScript", directOutput=True, mustEvaluate=True, children=[#binding is controlled externally, all camera operations proceed the same regardless of whether bound or not
], field=[
                      field(name="description", accessType="inputOutput", appinfo="Text description to be displayed for this Camera", type="SFString"),
                      ...
                      field(name="traceEnabled", accessType="initializeOnly", appinfo="enable console output to trace script computations and prototype progress", type="SFBool")], IS=IS(
                    connect=[
                        connect(nodeField="description", protoField="description"),
                        connect(nodeField="position", protoField="position"),
                        connect(nodeField="orientation", protoField="orientation"),
        ...
        ProtoDeclare(
          name="CameraShot", appinfo="CameraShot collects a specific set of CameraMovement animations that make up an individual shot.", ProtoInterface=ProtoInterface(
            ...
            children=[
                Script(
                  DEF="CameraShotScript", directOutput=True, mustEvaluate=True, field=[
                      field(name="description", accessType="inputOutput", appinfo="Text description to be displayed for this CameraShot", type="SFString"),
                      field(name="enabled", accessType="inputOutput", appinfo="Whether this CameraShot can be activated", type="SFBool"),
                      field(name="moves", accessType="inputOutput", appinfo="Set of CameraMovement nodes", type="MFNode", children=[#initialization nodes (if any) go here
]),
                      ...
                      field(name="key", accessType="inputOutput", appinfo="key array for interpolators", type="MFFloat"),
                      field(name="keyValuePosition", accessType="inputOutput", appinfo="keyValue array for PositionInterpolator", type="MFVec3f"),
                      field(name="keyValueOrientation", accessType="inputOutput", appinfo="keyValue array for OrientationInterpolator", type="MFRotation")], IS=IS(
                    connect=[
                        connect(nodeField="description", protoField="description"),
...
#Script holds CameraMovement initialization values for query by parent CameraShot, and also permits changing values via events
                ...
                Script(
                  DEF="CameraMovementScript", directOutput=True, mustEvaluate=True, field=[
                      field(name="description", accessType="inputOutput", appinfo="Text description to be displayed for this CameraMovement", type="SFString"),
...
#Subsequent nodes do not render, but still must be a valid X3D subgraph
                ...
                Script(
                  DEF="OfflineRenderScript", mustEvaluate=True, field=[
                      field(name="description", accessType="inputOutput", appinfo="Text description to be displayed for this OfflineRender", type="SFString"),
        ...
        Anchor(
          description="launch CameraExample scene", url=["CameraExamples.x3d","https://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.x3d","CameraExamples.wrl","https://www.web3d.org/x3d/content/examples/Basic/development/CameraExamples.wrl"], children=[
              Transform(
                children=[
                    Shape(
                      geometry=Text(
                          string=["CameraPrototypes.x3d","defines multiple prototype nodes","","Click on this text to see","CameraExamples.x3d scene"], fontStyle=FontStyle(

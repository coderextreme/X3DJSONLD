...
X3D0.head = head1
Scene16 = x3d.Scene()
Scene16.children.append(x3d.Comment("""=============== Camera =============="""))
...
ProtoInterface18.children.append(x3d.Comment("""Viewpoint-related fields, NavigationInfo-related fields and Camera-unique fields"""))
field19 = x3d.field()
...
field29.type = "MFNode"
field29.children.append(x3d.Comment("""initialization nodes (if any) go here"""))
...
field40.type = "SFNode"
field40.children.append(x3d.Comment("""initialization node (if any) goes here"""))
...
Viewpoint43 = x3d.Viewpoint(DEF="CameraViewpoint")
IS44 = x3d.IS()
...
ProtoBody42.children.append(x3d.Comment("""NavInfo EXAMINE used since some browsers (InstantReality) try to lock view to vertical when flying to avoid disorientation"""))
NavigationInfo52 = x3d.NavigationInfo(DEF="CameraNavInfo")
...
IS53.children.append(x3d.Comment("""No need to bind outputs bindTime, isBound from NavigationInfo since Viewpoint outputs will suffice. TODO inform BitManagement that bindTime field is missing."""))

NavigationInfo52.IS = IS53

ProtoBody42.children.append(NavigationInfo52)
ProtoBody42.children.append(x3d.Comment("""this DirectionalLight replaces NavigationInfo headlight in order to add color capability"""))
DirectionalLight57 = x3d.DirectionalLight(DEF="CameraDirectionalLight")
DirectionalLight57.global_ = True
DirectionalLight57.children.append(x3d.Comment("""TODO confirm other default field values match NavigationInfo spec"""))
IS58 = x3d.IS()
...
PositionInterpolator62 = x3d.PositionInterpolator(DEF="CameraPositionInterpolator")
...
OrientationInterpolator65 = x3d.OrientationInterpolator(DEF="CameraOrientationInterpolator")
...
Script70 = x3d.Script(DEF="CameraScript")
Script70.directOutput = True
Script70.mustEvaluate = True
Script70.children.append(x3d.Comment("""binding is controlled externally, all camera operations proceed the same regardless of whether bound or not"""))
field71 = x3d.field()
...
field79.type = "MFNode"
field79.children.append(x3d.Comment("""initialization nodes (if any) go here"""))
...
field87.type = "SFNode"
field87.children.append(x3d.Comment("""initialization node (if any) goes here"""))
...
field88.type = "SFNode"
Viewpoint89 = x3d.Viewpoint(USE="CameraViewpoint")
...
field90.type = "SFNode"
NavigationInfo91 = x3d.NavigationInfo(USE="CameraNavInfo")
...
field92.type = "SFNode"
PositionInterpolator93 = x3d.PositionInterpolator(USE="CameraPositionInterpolator")
...
field94.type = "SFNode"
OrientationInterpolator95 = x3d.OrientationInterpolator(USE="CameraOrientationInterpolator")
...
Scene16.children.append(x3d.Comment("""=============== CameraShot =============="""))
...
field135.children.append(x3d.Comment("""initializing CameraMovement nodes are inserted here by scene author using ProtoInstance"""))
...
Script146 = x3d.Script(DEF="CameraShotScript")
...
field149.children.append(x3d.Comment("""initialization nodes (if any) go here"""))
...
ProtoBody145.children.append(x3d.Comment("""Add any ROUTEs here, going from Script to other nodes within ProtoBody"""))

ProtoDeclare131.ProtoBody = ProtoBody145

Scene16.children.append(ProtoDeclare131)
Scene16.children.append(x3d.Comment("""=============== CameraMovement =============="""))
...
ProtoBody189.children.append(x3d.Comment("""First node determines node type of this prototype"""))
ProtoBody189.children.append(x3d.Comment("""Subsequent nodes do not render, but still must be a valid X3D subgraph"""))
ProtoBody189.children.append(x3d.Comment("""Script holds CameraMovement initialization values for query by parent CameraShot, and also permits changing values via events"""))
Script190 = x3d.Script(DEF="CameraMovementScript")
...
ProtoBody189.children.append(x3d.Comment("""Add any ROUTEs here, going from Script to other nodes within ProtoBody"""))

ProtoDeclare175.ProtoBody = ProtoBody189

Scene16.children.append(ProtoDeclare175)
Scene16.children.append(x3d.Comment("""=============== OfflineRender =============="""))
...
ProtoInterface217.children.append(x3d.Comment("""TODO non-photorealistic rendering (NPR) parameters"""))
field218 = x3d.field()
...
ProtoBody229.children.append(x3d.Comment("""First node determines node type of this prototype"""))
ProtoBody229.children.append(x3d.Comment("""Subsequent nodes do not render, but still must be a valid X3D subgraph"""))
Script230 = x3d.Script(DEF="OfflineRenderScript")
...
ProtoBody229.children.append(x3d.Comment("""Add any ROUTEs here, going from Script to other nodes within ProtoBody"""))

ProtoDeclare216.ProtoBody = ProtoBody229

Scene16.children.append(ProtoDeclare216)
Scene16.children.append(x3d.Comment("""=============== Launch Prototype Example =============="""))

...
Material14.setDiffuseColor(x3d.doubleToFloat([0.2,0.7,0.7]))
...
Material20.setDiffuseColor(x3d.doubleToFloat([0.2,0.7,0.7]))
...
Material26.setDiffuseColor(x3d.doubleToFloat([0.2,0.7,0.7]))
...
Material38.setDiffuseColor(x3d.doubleToFloat([1,0,0]))
...
PositionInterpolator39.setKey(x3d.doubleToFloat([0,1]))
PositionInterpolator39.setKeyValue(x3d.doubleToFloat([0,0,0,0,5,0]))
...
X3D0.toFileJSON("../data/arcold.new.python.json")

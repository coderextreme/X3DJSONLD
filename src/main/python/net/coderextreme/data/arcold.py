...
head=Pyhead(
children=[
Pymeta(name="title", content="arcold.x3d"),
Pymeta(name="creator", content="John Carlson"),
Pymeta(name="generator", content="manual"),
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/arc.x3d"),
Pymeta(name="description", content="an attempt to implement an arc in a graph"),
...
ProtoInterface=PyProtoInterface(field=[Pyfield(name="startnode", accessType="inputOutput", type="SFNode"),
Pyfield(name="endnode", accessType="inputOutput", type="SFNode"),
Pyfield(name="transnode", accessType="inputOutput", type="SFNode"),
Pyfield(name="rotscalenode", accessType="inputOutput", type="SFNode"),
Pyfield(name="set_startpoint", accessType="inputOnly", type="SFVec3f"),
Pyfield(name="set_endpoint", accessType="inputOnly", type="SFVec3f")
]), 
ProtoBody=PyProtoBody(children=[
Script(DEF="S1", field=[Pyfield(name="startnode", accessType="inputOutput", type="SFNode"),
Pyfield(name="endnode", accessType="inputOutput", type="SFNode"),
Pyfield(name="transnode", accessType="inputOutput", type="SFNode"),
Pyfield(name="rotscalenode", accessType="inputOutput", type="SFNode"),
Pyfield(name="set_startpoint", accessType="inputOnly", type="SFVec3f"),
...
Pyconnect(nodeField="transnode", protoField="transnode"),
Pyconnect(nodeField="rotscalenode", protoField="rotscalenode"),
...
PyfieldValue(name="transnode", children=[
Transform(USE="trans1")]),
PyfieldValue(name="rotscalenode", children=[

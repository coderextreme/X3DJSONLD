...
ParticleSystem20.children.append(x3d.Comment("""* lastFrame - last frame that was rendered (0 for default)"""))
ParticleSystem20.children.append(x3d.Comment("""* updateRate - update rate is amount of time between frames"""))
ParticleSystem20.children.append(x3d.Comment("""<VariationPhysicsModel values=\"2 2 5 5 0 0\" varations=\"2 1 3 3 0.1 0.1\" lastFrame='0' updateRate='0.1'>"""))
ParticleSystem20.children.append(x3d.Comment("""</VariationPhysicsModel>"""))
...
ComposedCubeMapTexture25 = x3d.ComposedCubeMapTexture(DEF="texture")
...
Appearance23.children.append(x3d.Comment("""<ComposedShader language='GLSL'>"""))
Appearance23.children.append(x3d.Comment("""<field name='chromaticDispertion' accessType='inputOutput' type='SFVec3f' value='0.98 1 1.033'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='cube' type='SFNode' accessType=\"inputOutput\">"""))
Appearance23.children.append(x3d.Comment("""<ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture>"""))
Appearance23.children.append(x3d.Comment("""</field>"""))
Appearance23.children.append(x3d.Comment("""<field name='bias' accessType='inputOutput' type='SFFloat' value='0.5'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='scale' accessType='inputOutput' type='SFFloat' value='0.5'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='power' accessType='inputOutput' type='SFFloat' value='2'></field>"""))
Appearance23.children.append(x3d.Comment("""<ShaderPart url='\"../shaders/freewrl.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"'></ShaderPart>"""))
Appearance23.children.append(x3d.Comment("""<ShaderPart url='\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' type='FRAGMENT'></ShaderPart>"""))
Appearance23.children.append(x3d.Comment("""</ComposedShader>"""))
Appearance23.children.append(x3d.Comment("""<ComposedShader DEF=\"shader\" language=\"GLSL\">"""))
Appearance23.children.append(x3d.Comment("""<field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1.0 1.033'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='bias' type='SFFloat' accessType='inputOutput' value='0.5'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='scale' type='SFFloat' accessType='inputOutput' value='0.5'></field>"""))
Appearance23.children.append(x3d.Comment("""<field name='power' type='SFFloat' accessType='inputOutput' value='2'></field>"""))
Appearance23.children.append(x3d.Comment("""<ShaderPart url='\"../shaders/castle.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/>"""))
Appearance23.children.append(x3d.Comment("""<ShaderPart type='FRAGMENT' url='\"../shaders/castle.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/>"""))
Appearance23.children.append(x3d.Comment("""</ComposedShader>"""))
ComposedShader32 = x3d.ComposedShader(DEF="x_ite")
...
TimeSensor48 = x3d.TimeSensor(DEF="TourTime")

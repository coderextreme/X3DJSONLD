...
meta2 = x3d.meta()
meta2.name = "title"
meta2.content = "particleflowers.x3d"
...
WorldInfo6.title = "particleflowers.x3d"
...
ParticleSystem11.maxParticles = 100
...
ShaderPart23.url = ["../shaders/x_ite_variations.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_variations.vs"]

ComposedShader22.parts.append(ShaderPart23)
ShaderPart24 = x3d.ShaderPart()
ShaderPart24.type = "FRAGMENT"
ShaderPart24.url = ["../shaders/commonnew.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/commonnew.fs"]

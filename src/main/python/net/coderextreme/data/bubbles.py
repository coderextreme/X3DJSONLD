...
OrientationInterpolator49 = x3d.OrientationInterpolator()
...
ROUTE58.setToNode("RandomTourTime")
ROUTE58.setToField("set_cycle")

Scene14.addChildren(ROUTE58)
ROUTE59 = x3d.ROUTE()
ROUTE59.setFromNode("RandomTourTime")
ROUTE59.setFromField("orientation_changed")
ROUTE59.setToNode("TourOrientation")
ROUTE59.setToField("set_keyValue")

Scene14.addChildren(ROUTE59)
ROUTE60 = x3d.ROUTE()
ROUTE60.setFromNode("RandomTourTime")
ROUTE60.setFromField("position_changed")
...
ROUTE62 = x3d.ROUTE()
ROUTE62.setFromNode("TourOrientation")
ROUTE62.setFromField("value_changed")
ROUTE62.setToNode("Tour")
ROUTE62.setToField("set_orientation")
...
ROUTE64 = x3d.ROUTE()
ROUTE64.setFromNode("TourPosition")
ROUTE64.setFromField("value_changed")
ROUTE64.setToNode("Tour")
ROUTE64.setToField("set_position")

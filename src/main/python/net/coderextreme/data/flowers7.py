...
Background18 = x3d.Background(DEF="background")
...
ImageTexture26 = x3d.ImageTexture(DEF="bottomShader")
...
ImageTexture27 = x3d.ImageTexture(DEF="frontShader")
...
ImageTexture28 = x3d.ImageTexture(DEF="leftShader")
...
ImageTexture29 = x3d.ImageTexture(DEF="rightShader")
...
ImageTexture30 = x3d.ImageTexture(DEF="topShader")
...
ComposedShader31 = x3d.ComposedShader(DEF="x3dom")
ComposedShader31.language = "GLSL"
ComposedShader31.children.append(x3d.Comment("""TODO VERIFY"""))
ComposedShader31.children.append(x3d.Comment("""<field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field>"""))
field32 = x3d.field()
field32.name = "cube"
field32.type = "SFNode"
field32.accessType = "inputOutput"
ComposedCubeMapTexture33 = x3d.ComposedCubeMapTexture(USE="texture")
...
ComposedShader46 = x3d.ComposedShader(DEF="x_ite")
ComposedShader46.language = "GLSL"
field47 = x3d.field()
field47.name = "cube"
field47.type = "SFNode"
field47.accessType = "inputOutput"
ComposedCubeMapTexture48 = x3d.ComposedCubeMapTexture(USE="texture")
...
Script62 = x3d.Script(DEF="UrlSelector")
...
Scene16.children.append(x3d.Comment("""<TimeSensor DEF=\"Clock\" cycleInterval=\"45\" loop='true'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='Clock' fromField='fraction_changed' toNode='UrlSelector' toField='set_fraction'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='front' toNode='background' toField='frontUrl'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='back' toNode='background' toField='backUrl'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='left' toNode='background' toField='leftUrl'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='right' toNode='background' toField='rightUrl'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='top' toNode='background' toField='topUrl'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='bottom' toNode='background' toField='bottomUrl'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='front' toNode='frontShader' toField='url'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='back' toNode='backShader' toField='url'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='left' toNode='leftShader' toField='url'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='right' toNode='rightShader' toField='url'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='top' toNode='topShader' toField='url'/>"""))
Scene16.children.append(x3d.Comment("""<ROUTE fromNode='UrlSelector' fromField='bottom' toNode='bottomShader' toField='url'/>"""))
Script77 = x3d.Script(DEF="Animate")
...
TimeSensor85 = x3d.TimeSensor(DEF="TourTime")

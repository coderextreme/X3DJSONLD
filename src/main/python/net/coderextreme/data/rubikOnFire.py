  ...
  profile="Immersive", version="3.3", head=head(  children=[
    ...
    children=[
        NavigationInfo(
          type="\"EXAMINE\""),
        Viewpoint(
          description="Rubiks Cube on Fire", position=(0,0,12)),
        ProtoDeclare(
                  ...
                  IS=IS(
                    connect=[
                      ...
                      Shape(
                        IS=IS(
                          connect=[
                              connect(nodeField="geometry", protoField="myShape")]), appearance=Appearance(
                            material=Material(
                                diffuseColor=(1,1,1))))])])),
        ProtoDeclare(
                    ...
                    connect=[
                      ...
                      ProtoInstance(
                        name="three", fieldValue=[
                            fieldValue(name="ytranslation", value=(0,0,0))], IS=IS(
                          connect=[
                              connect(nodeField="myShape", protoField="myShape")])),
                      ProtoInstance(
                        name="three", fieldValue=[
                            fieldValue(name="ytranslation", value=(0,2,0))], IS=IS(
                          connect=[
                              connect(nodeField="myShape", protoField="myShape")])),
                      ProtoInstance(
                        name="three", fieldValue=[
                    ...
                    connect=[
                      ...
                      ProtoInstance(
                        name="nine", fieldValue=[
                            fieldValue(name="ztranslation", value=(0,0,0))], IS=IS(
                          connect=[
                              connect(nodeField="myShape", protoField="myShape")])),
                      ProtoInstance(
                        name="nine", fieldValue=[
                            fieldValue(name="ztranslation", value=(0,0,2))], IS=IS(
                          connect=[
                              connect(nodeField="myShape", protoField="myShape")])),
                      ProtoInstance(
                        name="nine", fieldValue=[

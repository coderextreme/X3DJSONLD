...
X3D(
  profile="Immersive", version="3.3", head=head(  children=[
    ...
    children=[
        ...
        Transform(
          translation=(0,-1,1), rotation=(0,1,0,3.1415926), scale=(1.5,1.5,1.5), children=[
              Shape(
                appearance=Appearance(
                    material=Material(
                        transparency=0.1, diffuseColor=(0.9,0.3,0.3), specularColor=(0.8,0.8,0.8), shininess=0.145)), geometry=IndexedFaceSet(

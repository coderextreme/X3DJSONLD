...
print(
X3D(
  class="x3dModel.class", profile="Full", style="x3dModel.style", version="4.0", children=[#x3dVersionComparisonTest for this model: supportsX3dVersion(X3D.VERSION_3_0)=true
], head=head(  children=[
      children=[#comment #1
#comment #2
#comment #3
#comment #4
          ...
          meta(name="modified", content="9 January 2022"),
    ...
    children=[
        ...
        WorldInfo(
          DEF="WorldInfoDEF", class="worldInfoNode.class", style="worldInfoNode.style", title="HelloWorldProgram produced by X3D Java SAI Library (X3DJSAIL)"),
        WorldInfo(
          USE="WorldInfoDEF"),
        WorldInfo(
          USE="WorldInfoDEF"),
        ...
        Transform(
          DEF="LogoGeometryTransform", translation=(0,1.5,0), children=[
              Anchor(
                DEF="siteAnchor", description="select for X3D Java SAI Library (X3DJSAIL) description", url=["../X3DJSAIL.html","https://www.web3d.org/specifications/java/X3DJSAIL.html"], children=[
                    Shape(
...
#Comment example B, XML character entities: He said, &quot;Immel did it!&quot;
                        ...
                        MetadataSet(
                          name="EscapedQuotationMarksMetadataSet", value=(
                              ...
                              MetadataString(
                                name="extraChildTest", value=("checks MetadataSet addValue() method"))))), fontStyle=FontStyle(
...
#presence of follow-on TouchSensor shows that additional nodes are allowed in ProtoBody after initial node, regardless of node types
        ...
        Inline(
          DEF="inlineScene", url=["someOtherScene.x3d","https://www.web3d.org/specifications/java/examples/someOtherScene.x3d"]),
        IMPORT(
          AS="WorldInfoDEF2", importedDEF="WorldInfoDEF", inlineDEF="inlineScene"),
        EXPORT(
...
#Test satisfactorily creates MFNode shaders array as an ordered list with mixed content
        ...
        LoadSensor(
          children=[#Contained nodes typically must be USE references for nodes previously DEFined in the scene

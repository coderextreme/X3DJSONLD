...
Material20.setTransparency(0.200000002980232)
Material20.setDiffuseColor([0.5,0,1])

Appearance19.setMaterial(Material20)

Shape18.setAppearance(Appearance19)
IndexedFaceSet21 = x3d.IndexedFaceSet()
IndexedFaceSet21.setCoordIndex([0,1,4,-1,1,2,4,-1,2,3,4,-1,3,0,4,-1,0,3,2,1,-1])
Coordinate22 = x3d.Coordinate()
Coordinate22.setPoint([-0.349999994039536,-0.349999994039536,0.349999994039536,0.349999994039536,-0.349999994039536,0.349999994039536,0.349999994039536,-0.349999994039536,-0.349999994039536,-0.349999994039536,-0.349999994039536,-0.349999994039536,0,0.349999994039536,0])
...
Material32.setTransparency(0.200000002980232)
Material32.setDiffuseColor([1,1,0])

Appearance31.setMaterial(Material32)

Shape30.setAppearance(Appearance31)
Box33 = x3d.Box()
Box33.setSize([0.699999988079071,0.699999988079071,0.699999988079071])
...
Sphere44 = x3d.Sphere()
Sphere44.setRadius(5.699999988079071)

Shape41.setGeometry(Sphere44)

Transform38.addChildren(Shape41)
...
connect52.setNodeField("translation")
connect52.setProtoField("posi")
...
Material55.setDiffuseColor([0,1,1])
Material55.setTransparency(0.400000005960464)
IS56 = x3d.IS()
connect57 = x3d.connect()
connect57.setNodeField("emissiveColor")
connect57.setProtoField("col")

IS56.addConnect(connect57)

Material55.setIS(IS56)

Appearance54.setMaterial(Material55)

Shape53.setAppearance(Appearance54)
Sphere58 = x3d.Sphere()
Sphere58.setRadius(5.10000002384186)

Shape53.setGeometry(Sphere58)

Transform50.addChildren(Shape53)

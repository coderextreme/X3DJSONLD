...
meta(name="Image", content="indexedfaceset_pixeltexture_whole-top.jpg"),
meta(name="Image", content="indexedfaceset_pixeltexture_whole-bottom.jpg"),
meta(name="Image", content="indexedfaceset_pixeltexture_whole-left.jpg"),
meta(name="Image", content="indexedfaceset_pixeltexture_whole-right.jpg"),
...
meta(name="description", content="Test of browser ability to map the entire portion of an PixelTexture onto an IndexedFaceSet geometry. Four equal sized red (bottom left), green (bottom right) yellow (top left) and white (top right) squares in the pixel texture map all the faces of the cube."),
meta(name="identifier", content="https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_whole.x3d"),

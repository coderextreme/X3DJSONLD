...
meta10.setContent("http://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.json")
...
Scene13 = x3d.Scene()
Shape14 = x3d.Shape()
Shape14.setBboxCenter([0,0,0])
Shape14.setBboxSize([-1,-1,-1])
...
X3D0.toFileX3D("../data/gridBack_RoundTrip.x3d")

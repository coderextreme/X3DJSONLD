...
Pymeta(name="title", content="bub.x3d"),
Pymeta(name="creator", content="John Carlson"),
Pymeta(name="description", content="3 prismatic spheres"),
Pymeta(name="generator", content="X3D-Edit, https://savage.nps.edu/X3D-Edit"),
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/bub.x3d"),
...
Pyfield(name="chromaticDispertion", type="SFVec3f", accessType="inputOutput", value=(0.98,1.0,1.033)),
...
Pyfield(name="power", type="SFFloat", accessType="inputOutput", value=2.0)
], parts=[
...
geometry=
Sphere())]),
Script(DEF="Bounce", field=[Pyfield(name="translation", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
Pyfield(name="velocity", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
Pyfield(name="set_fraction", accessType="inputOnly", type="SFTime")

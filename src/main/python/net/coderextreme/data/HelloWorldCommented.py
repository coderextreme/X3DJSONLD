...
#WorldInfo begin
        ...
        WorldInfo(
          title="Hello world!"),#WorldInfo complete, Group begin

        Group(
          children=[#Viewpoint begin

              Viewpoint(
                DEF="ViewUpClose", centerOfRotation=(0,-1,0), description="Hello world!", position=(0,-1,7)),#Viewpoint complete, Transform begin

              Transform(
                rotation=(0,1,0,3), children=[#Shape begin

                    Shape(
                      children=[#Sphere begin
#Sphere complete, Appearance begin
#Appearance complete
], geometry=Sphere(
                          ), appearance=Appearance(
                          children=[#Material begin
...
#ImageTexture complete
                              ...
                              DEF="ImageCloudlessEarth", url=["earth-topo.png","earth-topo.jpg","earth-topo-small.gif","https://www.web3d.org/x3d/content/examples/Basic/earth-topo.png","https://www.web3d.org/x3d/content/examples/Basic/earth-topo.jpg","https://www.web3d.org/x3d/content/examples/Basic/earth-topo-small.gif"]))),#Shape complete
]),#Transform complete, Transform begin

              Transform(
                translation=(0,-2,0), children=[#Shape begin
...
#Appearance complete
                          ...
                          DEF="TextMessage", string=["Hello","world!"], children=[#FontStyle begin
#FontStyle complete
], fontStyle=FontStyle(
...
#Material complete
                              ...
                              USE="MaterialLightBlue"))),#Shape complete
]),#Transform complete
]),#Group complete
]))
.XML())

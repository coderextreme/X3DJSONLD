...
X3D0.Scene = Scene6
f = open("../data/asmallbox.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../data/asmallbox.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/asmallbox.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

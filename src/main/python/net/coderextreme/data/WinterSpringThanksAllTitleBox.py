...
Transform13.translation = [10,10,-15]
Shape14 = x3d.Shape()
...
ImageTexture17.url = ["images/WSThanksR2trimmed.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSThanksR2trimmed.png"]
...
X3D0.Scene = Scene10
f = open("../data/WinterSpringThanksAllTitleBox.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../data/WinterSpringThanksAllTitleBox.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/WinterSpringThanksAllTitleBox.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

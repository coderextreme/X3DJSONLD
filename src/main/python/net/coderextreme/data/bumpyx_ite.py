...
Scene15.children.append(x3d.Comment("""Images courtesy of Paul Debevec's Light Probe Image Gallery"""))
...
ComposedShader32 = x3d.ComposedShader(DEF="x_iteShader")
...
ComposedShader32.children.append(x3d.Comment("""TO CONVERT TO A SPHERE"""))
ComposedShader32.children.append(x3d.Comment("""<ShaderPart url='\"../shaders/x_ite.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs\"'></ShaderPart>"""))
ComposedShader32.children.append(x3d.Comment("""<ShaderPart url='\"../shaders/x_itebubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs\"' type='FRAGMENT'></ShaderPart>"""))

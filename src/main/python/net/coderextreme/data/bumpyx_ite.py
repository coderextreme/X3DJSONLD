...
meta14.setContent("https://coderextreme.net/X3DJSONLD/src/main/data/bumpyx_ite.x3d")
...
X3D0.toFileX3D("../data/bumpyx_ite.new.python.x3d")
X3D0.toFileJSON("../data/bumpyx_ite.new.python.json")

...
X3D(
  profile="Immersive", version="4.0", head=head(  children=[
    ...
    children=[
        ProtoDeclare(
          name="FlowerProto", ProtoInterface=ProtoInterface(
            field=[
                field(name="vertex", accessType="inputOutput", type="MFString", value=("../shaders/gl_flowers_chromatic.vs")),
                field(name="fragment", accessType="inputOutput", type="MFString", value=("../shaders/pc_flowers.fs"))]), ProtoBody=ProtoBody(
            children=[
                Transform(
                  DEF="transform", children=[
                                ...
                                ComposedShader(
                                  DEF="shader", language="GLSL", field=[
                                      ...
                                      ShaderPart(
                                        type="FRAGMENT", IS=IS(
                                          connect=[
                                              connect(nodeField="url", protoField="fragment")])))))), geometry=Sphere(
                            )),
                      Script(
                        DEF="Animate", field=[
                      ...
                      ROUTE(
                        fromNode="Animate", fromField="translation_changed", toNode="transform", toField="set_translation"),
                      ROUTE(
                        fromNode="Animate", fromField="a", toNode="shader", toField="a"),
                      ROUTE(
                        fromNode="Animate", fromField="b", toNode="shader", toField="b"),
                      ROUTE(
                        fromNode="Animate", fromField="c", toNode="shader", toField="c"),
                      ROUTE(
                        fromNode="Animate", fromField="d", toNode="shader", toField="d"),
                      ROUTE(
                        fromNode="Animate", fromField="tdelta", toNode="shader", toField="tdelta"),
                      ROUTE(
                        fromNode="Animate", fromField="pdelta", toNode="shader", toField="pdelta")])]))]))
.XML())

...
Transform22 = x3d.Transform(DEF="transform")
Shape23 = x3d.Shape()
...
ComposedShader33 = x3d.ComposedShader(DEF="shader")
ComposedShader33.language = "GLSL"
ComposedShader33.children.append(x3d.Comment("""<field name='fw_textureCoordGenType' accessType='inputOnly' type='SFInt32' value='0'></field>"""))
field34 = x3d.field()
field34.name = "cube"
field34.type = "SFNode"
...
Script53 = x3d.Script(DEF="Animate")
...
TimeSensor63 = x3d.TimeSensor(DEF="TourTime")

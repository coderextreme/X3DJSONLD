...
Pymeta(name="title", content="flowerproto.json"),
Pymeta(name="creator", content="John Carlson"),
Pymeta(name="description", content="A flower proto with configurable shaders"),
Pymeta(name="generator", content="X3D-Edit, https://savage.nps.edu/X3D-Edit"),
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/flowerproto.json"),
Pymeta(name="translated", content="08 January 2024"),
...
ProtoInterface=PyProtoInterface(field=[Pyfield(name="vertex", accessType="inputOutput", type="MFString", value=["../shaders/gl_flowers_chromatic.vs"]),
Pyfield(name="fragment", accessType="inputOutput", type="MFString", value=["../shaders/pc_flowers.fs"])
]), 
...
ComposedShader(DEF="shader", language="GLSL", field=[Pyfield(name="cube", type="SFInt32", accessType="inputOutput", value=0),
...
IS=PyIS(connect=[Pyconnect(nodeField="url", protoField="vertex")
])),
ShaderPart(type="FRAGMENT", 
IS=PyIS(connect=[Pyconnect(nodeField="url", protoField="fragment")
]))])]), 
geometry=
Sphere()),

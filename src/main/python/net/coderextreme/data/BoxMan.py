...
X3D(
  profile="Immersive", version="3.3", head=head(  children=[
          ...
          meta(name="modified", content="7 March 2021"),
    ...
    children=[
        ...
        Background(
          groundColor=(0.6,0.6,0.6), skyColor=(0.75,0.75,0.75)),#When converting to VRML97 (which didn't include HAnim), HAnim node prototypes are provided automatically by the X3dToVrml97.xslt translation stylesheet
...
#top-level site references
            ...
            Coordinate(
              ...
              HAnimSite(
                name="BoxMan_view", DEF="boxman_BoxMan_view", children=[
                    ...
                    Viewpoint(
                      DEF="Right_View", description="Right-side View", orientation=(0,1,0,-1.57), position=(-3,1,0)),
                    Viewpoint(
                      DEF="Left_View", description="Left-side View", orientation=(0,1,0,1.57), position=(3,1,0)),
                    Viewpoint(
        ...
        ExternProtoDeclare(
          name="LOA1_WalkAnimation", url=["LOA1_WalkAnimation.wrl#LOA1_WalkAnimation","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/LOA1_WalkAnimation.wrl#LOA1_WalkAnimation","http://HAnim.org/Models/HAnim2001/boxman/protos/LOA1WalkAnimation.wrl#LOA1WalkAnimation","LOA1_WalkAnimation.x3d#LOA1_WalkAnimation","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/LOA1_WalkAnimation.x3d#LOA1_WalkAnimation","http://HAnim.org/Models/HAnim2001/boxman/protos/LOA1WalkAnimation.x3d#LOA1WalkAnimation"], field=[
        ...
        ProtoInstance(
          name="LOA1_WalkAnimation", DEF="ANIMATOR"),#Animation ROUTEs

        ROUTE(
          fromField="HumanoidRoot_translation_changed", fromNode="ANIMATOR", toField="set_translation", toNode="boxman_humanoid_root"),
        ROUTE(
          fromField="HumanoidRoot_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_humanoid_root"),
        ROUTE(
          fromField="l_hip_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_l_hip"),
        ROUTE(
          fromField="l_knee_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_l_knee"),
        ROUTE(
          fromField="l_ankle_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_l_ankle"),
        ROUTE(
          fromField="l_midtarsal_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_l_midtarsal"),
        ROUTE(
          fromField="r_hip_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_r_hip"),
        ROUTE(
          fromField="r_knee_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_r_knee"),
        ROUTE(
          fromField="r_ankle_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_r_ankle"),
        ROUTE(
          fromField="r_midtarsal_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_r_midtarsal"),
        ROUTE(
          fromField="vl5_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_vl5"),
        ROUTE(
          fromField="skullbase_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_skullbase"),
        ROUTE(
          fromField="l_shoulder_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_l_shoulder"),
        ROUTE(
          fromField="l_elbow_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_l_elbow"),
        ROUTE(
          fromField="l_wrist_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_l_wrist"),
        ROUTE(
          fromField="r_shoulder_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_r_shoulder"),
        ROUTE(
          fromField="r_elbow_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_r_elbow"),
        ROUTE(
          fromField="r_wrist_rotation_changed", fromNode="ANIMATOR", toField="set_rotation", toNode="boxman_r_wrist"),
        Script(
          DEF="ENGINE", directOutput=True, url=["BoxMan.js","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan.js"], field=[
              field(name="update", accessType="inputOnly", type="SFRotation"),
              ...
              field(name="joint", accessType="initializeOnly", type="SFNode", children=[#initialization node (if any) goes here
]),
              ...
              field(name="scale", accessType="initializeOnly", type="SFVec3f", value=(1,1,1))]),#Trigger calculation after each animation change

...
meta2 = x3d.meta()
meta2.name = "title"
meta2.content = "bumpyfreewrl.x3d"
...
ComposedShader22 = x3d.ComposedShader(DEF="freewrlShader")
ComposedShader22.language = "GLSL"
ShaderPart23 = x3d.ShaderPart()
ShaderPart23.url = ["../shaders/freewrl_flowers_chromatic.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs"]

ComposedShader22.parts.append(ShaderPart23)
ShaderPart24 = x3d.ShaderPart()
ShaderPart24.type = "FRAGMENT"
ShaderPart24.url = ["../shaders/freewrl_bubbles.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_bubbles.fs"]
...
field26.name = "fw_textureCoordGenType"
...
f.write(X3D0.XML())
f.close()
f = open("../data/bumpyfreewrl.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/bumpyfreewrl.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

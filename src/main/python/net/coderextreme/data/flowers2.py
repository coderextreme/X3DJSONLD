...
Group23 = x3d.Group()
TimeSensor24 = x3d.TimeSensor(DEF="Clock")
TimeSensor24.cycleInterval = 16
TimeSensor24.loop = True

Group23.children.append(TimeSensor24)
OrientationInterpolator25 = x3d.OrientationInterpolator(DEF="OrbitPath")
OrientationInterpolator25.key = [0,0.5,1]
OrientationInterpolator25.keyValue = [(1, 0, 0, 0),(1, 0, 0, 3.14),(1, 0, 0, 6.28)]

Group23.children.append(OrientationInterpolator25)
Transform26 = x3d.Transform(DEF="OrbitTransform")
IS27 = x3d.IS()
...
Shape29.children.append(x3d.Comment("""<IndexedFaceSet DEF=\"Orbit\">"""))
Shape29.children.append(x3d.Comment("""<Coordinate DEF=\"OrbitCoordinates\"/>"""))
Shape29.children.append(x3d.Comment("""</IndexedFaceSet>"""))
IndexedFaceSet36 = x3d.IndexedFaceSet(DEF="Orbit")
IndexedFaceSet36.ccw = False
IndexedFaceSet36.convex = False
IndexedFaceSet36.coordIndex = [0,1,2,-1]
Coordinate37 = x3d.Coordinate(DEF="OrbitCoordinates")
Coordinate37.point = [(0, 0, 1),(0, 1, 0),(1, 0, 0)]
...
Script38 = x3d.Script(DEF="OrbitScript")
field39 = x3d.field()

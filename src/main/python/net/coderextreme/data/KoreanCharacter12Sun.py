...
meta3 = x3d.meta()
meta3.setName("title")
meta3.setContent("KoreanCharacter12Sun.x3d")
...
meta13.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter12Sun.x3d")
...
WorldInfo20.setTitle("KoreanCharacter12Sun.x3d")
...
MetadataString25.setValue(["Chul Hee Jung and Myeong Won Lee"])
...
HAnimJoint31.setCenter(x3d.doubleToFloat([0,29.860001,-0.4567]))
...
Transform33.setTranslation(x3d.doubleToFloat([0,29.860001,-0.4567]))
Shape34 = x3d.Shape()
...
HAnimJoint41.setCenter(x3d.doubleToFloat([2.955,28.940001,-0.5218]))
...
Transform43.setTranslation(x3d.doubleToFloat([2.955,28.940001,-0.5218]))
Shape44 = x3d.Shape()
...
HAnimJoint51.setCenter(x3d.doubleToFloat([2.948,16.459999,-0.5275]))
...
Transform53.setTranslation(x3d.doubleToFloat([2.948,16.459999,-0.5275]))
Shape54 = x3d.Shape()
...
ImageTexture57.setUSE("SunTextureAtlas")
...
HAnimJoint61.setCenter(x3d.doubleToFloat([2.839,3.899,-0.4116]))
...
Transform63.setTranslation(x3d.doubleToFloat([2.839,3.899,-0.4116]))
Shape64 = x3d.Shape()
...
HAnimJoint71.setCenter(x3d.doubleToFloat([2.839,3.312,1.078]))
...
Transform73.setTranslation(x3d.doubleToFloat([2.839,3.312,1.078]))
Shape74 = x3d.Shape()
...
HAnimJoint81.setCenter(x3d.doubleToFloat([-2.955,28.940001,-0.5218]))
...
Transform83.setTranslation(x3d.doubleToFloat([-2.955,28.940001,-0.5218]))
Shape84 = x3d.Shape()
...
HAnimJoint91.setCenter(x3d.doubleToFloat([-2.948,16.459999,-0.5275]))
...
Transform93.setTranslation(x3d.doubleToFloat([-2.948,16.459999,-0.5275]))
Shape94 = x3d.Shape()
...
HAnimJoint101.setCenter(x3d.doubleToFloat([-2.839,3.899,-0.4116]))
...
Transform103.setTranslation(x3d.doubleToFloat([-2.839,3.899,-0.4116]))
Shape104 = x3d.Shape()
...
HAnimJoint111.setCenter(x3d.doubleToFloat([-2.839,3.312,1.078]))
...
Transform113.setTranslation(x3d.doubleToFloat([-2.839,3.312,1.078]))
Shape114 = x3d.Shape()
...
HAnimJoint121.setCenter(x3d.doubleToFloat([0,29.860001,-0.4567]))
...
Transform123.setTranslation(x3d.doubleToFloat([0,29.860001,-0.4567]))
Shape124 = x3d.Shape()
...
HAnimJoint131.setCenter(x3d.doubleToFloat([6.077,45.880001,-1.319]))
...
Transform133.setTranslation(x3d.doubleToFloat([6.077,45.880001,-1.319]))
Shape134 = x3d.Shape()
...
HAnimJoint141.setCenter(x3d.doubleToFloat([7.076,38.529999,-1.385]))
...
Transform143.setTranslation(x3d.doubleToFloat([7.076,38.529999,-1.385]))
Shape144 = x3d.Shape()
...
HAnimJoint151.setCenter(x3d.doubleToFloat([6.946,30.889999,-1.308]))
...
Transform153.setTranslation(x3d.doubleToFloat([6.946,30.889999,-1.308]))
Shape154 = x3d.Shape()
...
HAnimJoint161.setCenter(x3d.doubleToFloat([-6.077,45.880001,-1.319]))
...
Transform163.setTranslation(x3d.doubleToFloat([-6.077,45.880001,-1.319]))
Shape164 = x3d.Shape()
...
HAnimJoint171.setCenter(x3d.doubleToFloat([-7.076,38.529999,-1.385]))
...
Transform173.setTranslation(x3d.doubleToFloat([-7.076,38.529999,-1.385]))
Shape174 = x3d.Shape()
...
HAnimJoint181.setCenter(x3d.doubleToFloat([-6.946,30.889999,-1.308]))
...
Transform183.setTranslation(x3d.doubleToFloat([-6.946,30.889999,-1.308]))
Shape184 = x3d.Shape()
...
HAnimJoint191.setCenter(x3d.doubleToFloat([0.05249,34.130001,-0.468]))
...
Transform193.setTranslation(x3d.doubleToFloat([0.05249,34.130001,-0.468]))
Shape194 = x3d.Shape()
...
HAnimJoint201.setCenter(x3d.doubleToFloat([0,51.25,-1.124]))
...
Transform203.setTranslation(x3d.doubleToFloat([0,51.25,-1.124]))
Shape204 = x3d.Shape()
...
HAnimHumanoid23.addSegments(HAnimSegment241)
...
HAnimHumanoid23.addSegments(HAnimSegment245)
...
HAnimHumanoid23.addSegments(HAnimSegment246)

Scene19.addChildren(HAnimHumanoid23)

X3D0.setScene(Scene19)
X3D0.toFileX3D("../data/KoreanCharacter12Sun.new.python.x3d")
X3D0.toFileJSON("../data/KoreanCharacter12Sun.new.python.json")

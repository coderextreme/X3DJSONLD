...
meta10 = x3d.meta()
meta10.name = "TODO"
meta10.content = "check connectivity of geometry between upper left arm and shoulder"

head1.children.append(meta10)
meta11 = x3d.meta()
meta11.name = "Image"
meta11.content = "../Poses/images/HAnimPoseExampleKoreanCharacter12Sun.png"
...
meta15.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter12Sun.x3d"
...
HAnimHumanoid25 = x3d.HAnimHumanoid(DEF="hanim_Sun")
HAnimHumanoid25.name = "Sun"
HAnimHumanoid25.scale = [0.0225,0.0225,0.0225]
HAnimHumanoid25.version = "2.0"
HAnimHumanoid25.children.append(x3d.Comment("""original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'"""))
...
MetadataString27.value = ["Chul Hee Jung and Myeong Won Lee"]
...
HAnimJoint93 = x3d.HAnimJoint(DEF="hanim_r_knee")
HAnimJoint93.name = "r_knee"
HAnimJoint93.center = [-2.948,16.459999,-0.5275]
HAnimSegment94 = x3d.HAnimSegment(DEF="hanim_r_calf")
HAnimSegment94.name = "r_calf"
Transform95 = x3d.Transform()
Transform95.translation = [-2.948,16.459999,-0.5275]
Shape96 = x3d.Shape()
...
HAnimJoint193.children.append(HAnimJoint203)

HAnimJoint123.children.append(HAnimJoint193)

HAnimJoint33.children.append(HAnimJoint123)

HAnimHumanoid25.skeleton.append(HAnimJoint33)
HAnimJoint213 = x3d.HAnimJoint(USE="hanim_humanoid_root")

HAnimHumanoid25.joints.append(HAnimJoint213)
HAnimJoint214 = x3d.HAnimJoint(USE="hanim_sacroiliac")

HAnimHumanoid25.joints.append(HAnimJoint214)
HAnimJoint215 = x3d.HAnimJoint(USE="hanim_skullbase")

HAnimHumanoid25.joints.append(HAnimJoint215)
HAnimJoint216 = x3d.HAnimJoint(USE="hanim_vl5")

HAnimHumanoid25.joints.append(HAnimJoint216)
HAnimJoint217 = x3d.HAnimJoint(USE="hanim_l_elbow")

HAnimHumanoid25.joints.append(HAnimJoint217)
HAnimJoint218 = x3d.HAnimJoint(USE="hanim_r_elbow")

HAnimHumanoid25.joints.append(HAnimJoint218)
HAnimJoint219 = x3d.HAnimJoint(USE="hanim_l_hip")

HAnimHumanoid25.joints.append(HAnimJoint219)
HAnimJoint220 = x3d.HAnimJoint(USE="hanim_r_hip")

HAnimHumanoid25.joints.append(HAnimJoint220)
HAnimJoint221 = x3d.HAnimJoint(USE="hanim_l_knee")

HAnimHumanoid25.joints.append(HAnimJoint221)
HAnimJoint222 = x3d.HAnimJoint(USE="hanim_r_knee")

HAnimHumanoid25.joints.append(HAnimJoint222)
HAnimJoint223 = x3d.HAnimJoint(USE="hanim_l_metatarsophalangeal_2")

HAnimHumanoid25.joints.append(HAnimJoint223)
HAnimJoint224 = x3d.HAnimJoint(USE="hanim_r_metatarsophalangeal_2")

HAnimHumanoid25.joints.append(HAnimJoint224)
HAnimJoint225 = x3d.HAnimJoint(USE="hanim_l_radiocarpal")

HAnimHumanoid25.joints.append(HAnimJoint225)
HAnimJoint226 = x3d.HAnimJoint(USE="hanim_r_radiocarpal")

HAnimHumanoid25.joints.append(HAnimJoint226)
HAnimJoint227 = x3d.HAnimJoint(USE="hanim_l_shoulder")

HAnimHumanoid25.joints.append(HAnimJoint227)
HAnimJoint228 = x3d.HAnimJoint(USE="hanim_r_shoulder")

HAnimHumanoid25.joints.append(HAnimJoint228)
HAnimJoint229 = x3d.HAnimJoint(USE="hanim_l_talocrural")

HAnimHumanoid25.joints.append(HAnimJoint229)
HAnimJoint230 = x3d.HAnimJoint(USE="hanim_r_talocrural")

HAnimHumanoid25.joints.append(HAnimJoint230)

Scene21.children.append(HAnimHumanoid25)
EXPORT231 = x3d.EXPORT()
EXPORT231.AS = "KoreanCharacter12Sun"
EXPORT231.localDEF = "hanim_Sun"

Scene21.children.append(EXPORT231)

X3D0.Scene = Scene21
f = open("../data/KoreanCharacter12Sun.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../data/KoreanCharacter12Sun.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/KoreanCharacter12Sun.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

...
PlaneSensor15 = x3d.PlaneSensor(DEF="PS1")
...
Transform17 = x3d.Transform(DEF="G2")
...
PlaneSensor22 = x3d.PlaneSensor(DEF="PS2")
...
Transform24 = x3d.Transform(DEF="transC1")
Transform25 = x3d.Transform(DEF="rotscaleC1")
Shape26 = x3d.Shape()
...
Transform57 = x3d.Transform(USE="G2")
...
Transform59 = x3d.Transform(USE="transC1")
...
Transform61 = x3d.Transform(USE="rotscaleC1")

fieldValue60.children.append(Transform61)

ProtoInstance53.fieldValue.append(fieldValue60)
ProtoInstance53.children.append(x3d.Comment("""<fieldValue name='set_startpoint'>"""))
ProtoInstance53.children.append(x3d.Comment("""</fieldValue>"""))
ProtoInstance53.children.append(x3d.Comment("""<fieldValue name='set_endpoint'>"""))
ProtoInstance53.children.append(x3d.Comment("""</fieldValue>"""))

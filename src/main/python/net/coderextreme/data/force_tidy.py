...
Material22.setDiffuseColor([1,0,0])
...
Transform24.setTranslation([1,0,0])
Shape25 = x3d.Shape()
...
PositionInterpolator30.setKeyValue([0,0,0,0,5,0])
...
Material49.setDiffuseColor([0,1,0])
...
Extrusion50.setCrossSection([1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0])
Extrusion50.setSpine([0,-50,0,0,50,0])
...
Transform59.setScale([0.1,0.1,0.1])
...
PlaneSensor60.setMinPosition([-50,-50])
PlaneSensor60.setMaxPosition([50,50])

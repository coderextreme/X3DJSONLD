...
PositionInterpolator30 = x3d.PositionInterpolator(DEF="NodePosition")
PositionInterpolator30.key = [0,1]
PositionInterpolator30.keyValue = [(0, 0, 0),(0, 5, 0)]

Group16.children.append(PositionInterpolator30)
Script31 = x3d.Script(DEF="MoveBall")
field32 = x3d.field()
...
TimeSensor36 = x3d.TimeSensor(DEF="nodeClock")
...
Extrusion50 = x3d.Extrusion(DEF="extrusion")
Extrusion50.creaseAngle = 0.785
Extrusion50.crossSection = [(1, 0),(0.92, -0.38),(0.71, -0.71),(0.38, -0.92),(0, -1),(-0.38, -0.92),(-0.71, -0.71),(-0.92, -0.38),(-1, 0),(-0.92, 0.38),(-0.71, 0.71),(-0.38, 0.92),(0, 1),(0.38, 0.92),(0.71, 0.71),(0.92, 0.38),(1, 0)]
Extrusion50.spine = [(0, -50, 0),(0, 0, 0),(0, 50, 0)]

Shape47.geometry = Extrusion50

Group46.children.append(Shape47)
Script51 = x3d.Script(DEF="MoveCylinder")
field52 = x3d.field()
field52.name = "spine"
...
Transform59 = x3d.Transform(DEF="HoldsContent")
Transform59.scale = [0.1,0.1,0.1]
PlaneSensor60 = x3d.PlaneSensor(DEF="clickGenerator")
...
ProtoInstance61 = x3d.ProtoInstance(DEF="nodeA")
...
ProtoInstance63 = x3d.ProtoInstance(DEF="nodeB")
...
ProtoInstance65 = x3d.ProtoInstance(DEF="nodeC")
...
ProtoInstance67 = x3d.ProtoInstance(DEF="nodeD")
...
ProtoInstance69 = x3d.ProtoInstance(DEF="linkA")
ProtoInstance69.name = "cyl"

Transform59.children.append(ProtoInstance69)
ProtoInstance70 = x3d.ProtoInstance(DEF="linkB")
...
Script72 = x3d.Script(DEF="clickHandler")
field73 = x3d.field()
...
f.write(X3D0.XML())
f.close()
f = open("../data/force_tidy.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/force_tidy.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

...
Transform9.translation = [0,1.038333,0]
Shape10 = x3d.Shape()
...
Transform21.translation = [0,1.038333,0]
Shape22 = x3d.Shape()
...
Transform42 = x3d.Transform(USE="DECLpoint_G1_node")

field41.children.append(Transform42)

Script40.field.append(field41)
field43 = x3d.field()
field43.accessType = "initializeOnly"
field43.type = "SFNode"
field43.name = "endnode"
Transform44 = x3d.Transform(USE="DECLpoint_G2_node")
...
Transform46 = x3d.Transform(USE="DECLx3dconnector_connector1_trans")
...
field47.type = "SFNode"
field47.name = "rotscale"
Transform48 = x3d.Transform(USE="DECLx3dconnector_connector1_rotscale")

field47.children.append(Transform48)
...
ROUTE51 = x3d.ROUTE()
ROUTE51.fromNode = "DECLpoint_G1_CL1"
ROUTE51.fromField = "cycleTime"
ROUTE51.toNode = "DECLpoint_G1_MB1"
ROUTE51.toField = "set_location"

Scene6.children.append(ROUTE51)
ROUTE52 = x3d.ROUTE()
ROUTE52.fromNode = "DECLpoint_G1_CL1"
ROUTE52.fromField = "fraction_changed"
ROUTE52.toNode = "DECLpoint_G1_PI1"
ROUTE52.toField = "set_fraction"

Scene6.children.append(ROUTE52)
ROUTE53 = x3d.ROUTE()
ROUTE53.fromNode = "DECLpoint_G1_MB1"
ROUTE53.fromField = "keyValue_changed"
ROUTE53.toNode = "DECLpoint_G1_PI1"
ROUTE53.toField = "set_keyValue"

Scene6.children.append(ROUTE53)
ROUTE54 = x3d.ROUTE()
ROUTE54.fromNode = "DECLpoint_G1_PI1"
ROUTE54.fromField = "value_changed"
ROUTE54.toNode = "DECLpoint_G1_node"
ROUTE54.toField = "set_translation"

Scene6.children.append(ROUTE54)
ROUTE55 = x3d.ROUTE()
ROUTE55.fromNode = "DECLpoint_G2_CL1"
ROUTE55.fromField = "cycleTime"
ROUTE55.toNode = "DECLpoint_G2_MB1"
ROUTE55.toField = "set_location"

Scene6.children.append(ROUTE55)
ROUTE56 = x3d.ROUTE()
ROUTE56.fromNode = "DECLpoint_G2_CL1"
ROUTE56.fromField = "fraction_changed"
ROUTE56.toNode = "DECLpoint_G2_PI1"
ROUTE56.toField = "set_fraction"

Scene6.children.append(ROUTE56)
ROUTE57 = x3d.ROUTE()
ROUTE57.fromNode = "DECLpoint_G2_MB1"
ROUTE57.fromField = "keyValue_changed"
ROUTE57.toNode = "DECLpoint_G2_PI1"
ROUTE57.toField = "set_keyValue"

Scene6.children.append(ROUTE57)
ROUTE58 = x3d.ROUTE()
ROUTE58.fromNode = "DECLpoint_G2_PI1"
ROUTE58.fromField = "value_changed"
ROUTE58.toNode = "DECLpoint_G2_node"
ROUTE58.toField = "set_translation"

Scene6.children.append(ROUTE58)
ROUTE59 = x3d.ROUTE()
ROUTE59.fromNode = "DECLpoint_G1_node"
ROUTE59.fromField = "translation_changed"
ROUTE59.toNode = "DECLx3dconnector_connector1_S1"
ROUTE59.toField = "set_startpoint"

Scene6.children.append(ROUTE59)
ROUTE60 = x3d.ROUTE()
ROUTE60.fromNode = "DECLpoint_G2_node"
ROUTE60.fromField = "translation_changed"
ROUTE60.toNode = "DECLx3dconnector_connector1_S1"
ROUTE60.toField = "set_endpoint"

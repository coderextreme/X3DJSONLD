...
head=Pyhead(
children=[
Pymeta(name="title", content="arc3.x3d"),
...
Script(DEF="DECLx3dconnector_connector1_S1", field=[Pyfield(name="startnode", accessType="initializeOnly", type="SFNode", children=[
Group(USE="DECLpoint_G1_node")]),
Pyfield(name="endnode", accessType="initializeOnly", type="SFNode", children=[

...
head=head(children=[meta(name="title", content="arc3.x3d"),
...
Script(DEF="DECLx3dconnector_connector1_S1", field=[field(name="startnode", accessType="initializeOnly", type="SFNode", children=[

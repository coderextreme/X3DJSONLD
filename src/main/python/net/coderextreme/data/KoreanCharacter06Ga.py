...
HAnimJoint31.setCenter(x3d.doubleToFloat([0,32.310001,-0.7076]))
...
Transform33.setTranslation(x3d.doubleToFloat([0,32.310001,-0.7076]))
Shape34 = x3d.Shape()
...
HAnimJoint41.setCenter(x3d.doubleToFloat([2.906,30.18,-0.2966]))
...
Transform43.setTranslation(x3d.doubleToFloat([2.906,30.18,-0.2966]))
Shape44 = x3d.Shape()
...
HAnimJoint51.setCenter(x3d.doubleToFloat([3.116,16.92,-0.2161]))
...
Transform53.setTranslation(x3d.doubleToFloat([3.116,16.92,-0.2161]))
Shape54 = x3d.Shape()
...
HAnimJoint61.setCenter(x3d.doubleToFloat([3.28,4.021,-0.2439]))
...
Transform63.setTranslation(x3d.doubleToFloat([3.28,4.021,-0.2439]))
Shape64 = x3d.Shape()
...
HAnimJoint71.setCenter(x3d.doubleToFloat([3.28,3.095,0.83]))
...
Transform73.setTranslation(x3d.doubleToFloat([3.28,3.095,0.83]))
Shape74 = x3d.Shape()
...
HAnimJoint81.setCenter(x3d.doubleToFloat([-2.906,30.18,-0.2966]))
...
Transform83.setTranslation(x3d.doubleToFloat([-2.906,30.18,-0.2966]))
Shape84 = x3d.Shape()
...
HAnimJoint91.setCenter(x3d.doubleToFloat([-3.116,16.92,-0.2161]))
...
Transform93.setTranslation(x3d.doubleToFloat([-3.116,16.92,-0.2161]))
Shape94 = x3d.Shape()
...
HAnimJoint101.setCenter(x3d.doubleToFloat([-3.28,4.021,-0.2439]))
...
Transform103.setTranslation(x3d.doubleToFloat([-3.28,4.021,-0.2439]))
Shape104 = x3d.Shape()
...
HAnimJoint111.setCenter(x3d.doubleToFloat([-3.28,3.095,0.83]))
...
Transform113.setTranslation(x3d.doubleToFloat([-3.28,3.095,0.83]))
Shape114 = x3d.Shape()
...
HAnimJoint121.setCenter(x3d.doubleToFloat([0,29.389999,-0.3829]))
...
Transform123.setTranslation(x3d.doubleToFloat([0,29.389999,-0.3829]))
Shape124 = x3d.Shape()
...
HAnimJoint131.setCenter(x3d.doubleToFloat([6.499,47.529999,-0.7415]))
...
Transform133.setTranslation(x3d.doubleToFloat([6.499,47.529999,-0.7415]))
Shape134 = x3d.Shape()
...
HAnimJoint141.setCenter(x3d.doubleToFloat([6.851,38.779999,-0.7886]))
...
Transform143.setTranslation(x3d.doubleToFloat([6.851,38.779999,-0.7886]))
Shape144 = x3d.Shape()
...
HAnimJoint151.setCenter(x3d.doubleToFloat([7.219,32.48,-0.434]))
...
Transform153.setTranslation(x3d.doubleToFloat([7.219,32.48,-0.434]))
Shape154 = x3d.Shape()
...
HAnimJoint161.setCenter(x3d.doubleToFloat([-6.499,47.529999,-0.7415]))
...
Transform163.setTranslation(x3d.doubleToFloat([-6.499,47.529999,-0.7415]))
Shape164 = x3d.Shape()
...
HAnimJoint171.setCenter(x3d.doubleToFloat([-6.851,38.779999,-0.7886]))
...
Transform173.setTranslation(x3d.doubleToFloat([-6.851,38.779999,-0.7886]))
Shape174 = x3d.Shape()
...
HAnimJoint181.setCenter(x3d.doubleToFloat([-7.219,32.48,-0.434]))
...
Transform183.setTranslation(x3d.doubleToFloat([-7.219,32.48,-0.434]))
Shape184 = x3d.Shape()
...
HAnimJoint191.setCenter(x3d.doubleToFloat([0,34.389999,-0.1643]))
...
Transform193.setTranslation(x3d.doubleToFloat([0,34.389999,-0.1643]))
Shape194 = x3d.Shape()
...
HAnimJoint201.setCenter(x3d.doubleToFloat([0,52.639999,-0.209]))
...
Transform203.setTranslation(x3d.doubleToFloat([0,52.639999,-0.209]))
Shape204 = x3d.Shape()
...
X3D0.toFileX3D("../data/KoreanCharacter06Ga.new.python.x3d")
X3D0.toFileJSON("../data/KoreanCharacter06Ga.new.python.json")

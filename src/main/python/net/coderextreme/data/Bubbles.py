...
head=Pyhead(
children=[
Pymeta(name="title", content="Bubbles.x3d"),
Pymeta(name="description", content="Bubble animation used by Nancy Diving example."),
Pymeta(name="creator", content="Etsuko Lippi"),
Pymeta(name="created", content="24 January 2001"),
Pymeta(name="modified", content="23 May 2020"),
Pymeta(name="identifier", content="https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/Bubbles.x3d"),

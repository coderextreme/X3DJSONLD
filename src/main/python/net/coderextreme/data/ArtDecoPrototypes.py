...
ProtoDeclare21.children.append(x3d.Comment("""computed conversion ambientIntensity=1.745282, normalized to 1.0"""))
...
ProtoDeclare93.children.append(x3d.Comment("""computed conversion ambientIntensity=2.226234, normalized to 1.0"""))

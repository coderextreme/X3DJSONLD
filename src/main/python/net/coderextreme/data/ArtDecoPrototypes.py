...
ProtoBody103 = ProtoBody()
Material104 = Material()
...
ProtoBody112 = ProtoBody()
Material113 = Material()
...
X3D0.toFileX3D("../data/ArtDecoPrototypes_RoundTrip.x3d")

...
Extrusion18.setSpine(x3d.doubleToFloat([-2.5,0,0,-1.5,0,0]))
...
Extrusion23.setSpine(x3d.doubleToFloat([1.5,0,0,2.5,0,0]))
...
Extrusion35.setSpine(x3d.doubleToFloat([0,1.5,0,0,2.5,0]))
...
Extrusion47.setSpine(x3d.doubleToFloat([0,-2.5,0,0,-1.5,0]))

...
Transform14.children.append(x3d.Comment("""<Transform translation=\"-2.5 0 0\"> <Shape> <Text DEF=\"LeftString\" string='\"l\"'/> </Shape> </Transform> <StringSensor DEF=\"LeftSensor\" enabled=\"false\"/> <TouchSensor DEF=\"LeftTouch\" enabled=\"true\"/>"""))
...
Material27 = x3d.Material(DEF="MaterialLightBlue")
Material27.diffuseColor = [1,1,1]

Appearance26.material = Material27

Shape25.appearance = Appearance26
Text28 = x3d.Text(DEF="RightString")
Text28.string = ["r"]
...
StringSensor29 = x3d.StringSensor(DEF="RightSensor")
StringSensor29.enabled = False

Transform19.children.append(StringSensor29)
TouchSensor30 = x3d.TouchSensor(DEF="RightTouch")
...
Extrusion35.spine = [(0, 1.5, 0),(0, 2, 0),(0, 2.5, 0)]
...
Material39 = x3d.Material(USE="MaterialLightBlue")

Appearance38.material = Material39

Shape37.appearance = Appearance38
Text40 = x3d.Text(DEF="UpString")
Text40.string = ["u"]
...
StringSensor41 = x3d.StringSensor(DEF="UpSensor")
StringSensor41.enabled = False

Transform31.children.append(StringSensor41)
TouchSensor42 = x3d.TouchSensor(DEF="UpTouch")
...
Extrusion47.spine = [(0, -2.5, 0),(0, -2, 0),(0, -1.5, 0)]

Shape44.geometry = Extrusion47

Transform43.children.append(Shape44)
Transform43.children.append(x3d.Comment("""<Transform translation=\"-0.5 -2.5 0\"> <Shape> <Text DEF=\"DownString\" string='\"d\"'/> </Shape> </Transform> <StringSensor DEF=\"DownSensor\" enabled=\"false\"/> <TouchSensor description='touch to activate' DEF=\"DownTouch\" enabled=\"true\"/>"""))

Group13.children.append(Transform43)
Group13.children.append(x3d.Comment("""center"""))
...
Material56 = x3d.Material(USE="MaterialLightBlue")

Appearance55.material = Material56

Shape54.appearance = Appearance55
Text57 = x3d.Text(DEF="CenterString")
...
StringSensor58 = x3d.StringSensor(DEF="CenterSensor")
StringSensor58.enabled = False

Transform48.children.append(StringSensor58)
TouchSensor59 = x3d.TouchSensor(DEF="CenterTouch")
...
Script60 = x3d.Script(DEF="RightSingleToMultiString")
field61 = x3d.field()
...
Script63 = x3d.Script(DEF="UpSingleToMultiString")
field64 = x3d.field()
...
Script66 = x3d.Script(DEF="CenterSingleToMultiString")
field67 = x3d.field()

...
meta8 = x3d.meta()
meta8.name = "modified"
meta8.content = "Mon, 09 Feb 2026 12:24:29 GMT"
...
WorldInfo18.title = "JinLOA4_6.x3d"
...
f.write(X3D0.XML())
f.close()
f = open("../data/JinLOA4_6.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/JinLOA4_6.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

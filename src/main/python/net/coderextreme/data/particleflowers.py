...
Group19.addChildren(ROUTE66)

Scene14.addChildren(Group19)

X3D0.setScene(Scene14)
X3D0.toFileX3D("../data/particleflowers.new.python.x3d")
X3D0.toFileJSON("../data/particleflowers.new.python.json")

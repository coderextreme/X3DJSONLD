...
head=head(children=[meta(name="title", content="MaskAndSnorkel.x3d"),
...
geometry=
IndexedFaceSet(coordIndex=[0,1,13,12,0,-1,1,2,14,13,1,-1,2,3,15,14,2,-1,3,4,16,15,3,-1,4,5,17,16,4,-1,5,6,18,17,5,-1,18,6,25,19,0,12,18,-1,0,19,20,11,0,-1,10,11,20,21,10,-1,9,10,21,22,9,-1,8,9,22,23,8,-1,23,24,7,8,23,-1,6,7,24,25,6,-1], creaseAngle=1.45, solid=False, 
coord=
...
geometry=
IndexedFaceSet(coordIndex=[12,13,14,15,16,17,18,12,-1], creaseAngle=1.45, solid=False, 
coord=
Coordinate(point=[(0,0.08,0),(0.02,0.05,0),(0.05,0.05,0),(0.06,0.06,0),(0.06,0.09,0),(0.05,0.1,0),(0,0.1,0),(-0.05,0.1,0),(-0.06,0.09,0),(-0.06,0.06,0),(-0.05,0.05,0),(-0.02,0.05,0),(0.005,0.08,0),(0.02,0.055,0),(0.05,0.055,0),(0.055,0.06,0),(0.055,0.09,0),(0.045,0.095,0),(0.005,0.095,0),(-0.005,0.08,0),(-0.02,0.055,0),(-0.05,0.055,0),(-0.055,0.06,0),(-0.055,0.09,0),(-0.045,0.095,0),(-0.005,0.095,0)])))]),
Transform(children=[
Shape(DEF="maskLensL", 
...
geometry=
IndexedFaceSet(coordIndex=[19,20,21,22,23,24,25,19,-1], creaseAngle=1.45, solid=False, 
coord=
Coordinate(point=[(0,0.08,0),(0.02,0.05,0),(0.05,0.05,0),(0.06,0.06,0),(0.06,0.09,0),(0.05,0.1,0),(0,0.1,0),(-0.05,0.1,0),(-0.06,0.09,0),(-0.06,0.06,0),(-0.05,0.05,0),(-0.02,0.05,0),(0.005,0.08,0),(0.02,0.055,0),(0.05,0.055,0),(0.055,0.06,0),(0.055,0.09,0),(0.045,0.095,0),(0.005,0.095,0),(-0.005,0.08,0),(-0.02,0.055,0),(-0.05,0.055,0),(-0.055,0.06,0),(-0.055,0.09,0),(-0.045,0.095,0),(-0.005,0.095,0)])))]),
Transform(children=[
Shape(DEF="nose", 
...
geometry=
IndexedFaceSet(coordIndex=[0,37,26,0,-1,0,36,26,0,-1,36,37,26,36,-1,0,1,37,0,-1,0,11,36,0,-1], creaseAngle=1.45, solid=False, 
coord=
...
geometry=
IndexedFaceSet(coordIndex=[1,2,27,37,1,-1,2,3,28,27,2,-1,3,4,29,28,3,-1,4,5,30,29,4,-1,5,6,31,30,5,-1,6,7,32,31,6,-1,7,8,33,32,7,-1,8,9,34,33,8,-1,9,10,35,34,9,-1,10,11,36,35,10,-1], creaseAngle=1.45, solid=False, 
coord=
...
Material(USE="plastic")), 
geometry=
IndexedFaceSet(coordIndex=[3,4,39,38,3,-1,8,9,40,41,8,-1,38,39,42,43,38,-1,40,41,44,45,40,-1,42,43,47,46,42,-1,44,45,47,46,44,-1], creaseAngle=1.45, solid=False, 
coord=

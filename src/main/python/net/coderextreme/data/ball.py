...
ShaderPart27.url = ["https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs"]

ComposedShader26.parts.append(ShaderPart27)
ShaderPart28 = x3d.ShaderPart(DEF="commonfs")
ShaderPart28.type = "FRAGMENT"
ShaderPart28.url = ["https://coderextreme.net/X3DJSONLD/src/main/shaders/commonnew.fs"]

...
meta(name="converted", content="Sat, 02 Sep 2023 10:58:43 GMT")
...
topTexture=(
ImageTexture(url=["../resources/images/all_probes/stpeters_cross/stpeters_top.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"])), 
bottomTexture=(
ImageTexture(url=["../resources/images/all_probes/stpeters_cross/stpeters_bottom.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]))), shaders=[
...
ShaderPart(type="FRAGMENT", url=["../shaders/x_itebubbles.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs"])], field=[field(accessType="initializeOnly", type="SFVec3f", name="chromaticDispertion", value=(0.98,1,1.033)),
field(accessType="initializeOnly", type="SFNode", name="cube", children=[
ComposedCubeMapTexture(USE="texture")]),

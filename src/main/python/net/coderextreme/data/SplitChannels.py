...
Shape26 = x3d.Shape()
Appearance27 = x3d.Appearance(DEF="audio_emit2")
...
Transform31 = x3d.Transform(DEF="volumeRight")
...
FontStyle36 = x3d.FontStyle(DEF="VolumeFontStyle")
...
Shape44 = x3d.Shape()
Appearance45 = x3d.Appearance(DEF="audio_emit4")
...
Transform49 = x3d.Transform(DEF="volumeLeft")
...
FontStyle54 = x3d.FontStyle(USE="VolumeFontStyle")
...
Shape56 = x3d.Shape()
Appearance57 = x3d.Appearance(DEF="floor")
...
Gain65 = x3d.Gain(USE="ChannelSplitter")
...
Gain67 = x3d.Gain(USE="ChannelSplitter")
...
ChannelSplitter68 = x3d.ChannelSplitter(DEF="ChannelSplitter")
...
Transform70 = x3d.Transform(DEF="Audio3")
Transform70.rotation = [1,0,0,-0.5]
Transform70.translation = [0,100,0]
Shape71 = x3d.Shape()
Appearance72 = x3d.Appearance(DEF="audio_emit5")

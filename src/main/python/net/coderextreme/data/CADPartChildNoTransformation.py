...
Background17.setSkyColor(x3d.doubleToFloat([0.9607843,1,0.9607843]))

Scene15.addChildren(Background17)
Viewpoint18 = x3d.Viewpoint()
Viewpoint18.setDescription("Hello CAD bushing")
Viewpoint18.setOrientation(x3d.doubleToFloat([1,0,0,-0.321751]))
Viewpoint18.setPosition(x3d.doubleToFloat([0,5,15]))

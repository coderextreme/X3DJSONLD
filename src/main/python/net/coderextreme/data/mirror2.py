...
X3D(
  profile="Immersive", version="4.0", head=head(  children=[
    ...
    children=[
        ...
        Background(
          DEF="cube", leftUrl=("../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"), rightUrl=("../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"), frontUrl=("../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"), backUrl=("../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"), topUrl=("../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"), bottomUrl=("../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png")),
        Transform(
          children=[
              Shape(
                appearance=Appearance(
                    material=Material(
                        ...
                        back(
                          ImageTexture(
                            DEF="backShader", url=["../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"])), bottom(
                          ImageTexture(
                            DEF="bottomShader", url=["../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"])), front(
                          ImageTexture(
                            DEF="frontShader", url=["../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"])), left(
                          ImageTexture(
                            DEF="leftShader", url=["../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"])), right(
                          ImageTexture(
                            DEF="rightShader", url=["../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"])), top(
                          ImageTexture(
                            DEF="topShader", url=["../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"]))), shaders=(
                        ComposedShader(
                          DEF="x_ite", language="GLSL", children=[#http://hypertextbook.com/facts/2005/JustinChe.shtml
                              ...
                              ShaderPart(
                                url=["../shaders/x_itemix.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itemix.fs"], type="FRAGMENT"))),
                        ComposedShader(
                          DEF="x3dom", language="GLSL", field=[
                              ...
                              ShaderPart(
                                url=["../shaders/mix.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/mix.fs"], type="FRAGMENT"))))), geometry=Sphere(
                    radius=30)),
              Script(
              ...
              ROUTE(
                fromNode="UrlSelector", fromField="front_changed", toNode="cube", toField="frontUrl"),
              ROUTE(
                fromNode="UrlSelector", fromField="back_changed", toNode="cube", toField="backUrl"),
              ROUTE(
                fromNode="UrlSelector", fromField="left_changed", toNode="cube", toField="leftUrl"),
              ROUTE(
                fromNode="UrlSelector", fromField="right_changed", toNode="cube", toField="rightUrl"),
              ROUTE(
                fromNode="UrlSelector", fromField="top_changed", toNode="cube", toField="topUrl"),
              ROUTE(
                fromNode="UrlSelector", fromField="bottom_changed", toNode="cube", toField="bottomUrl"),
              ROUTE(

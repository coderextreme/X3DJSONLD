...
Background17 = x3d.Background(DEF="cube")
...
ImageTexture23 = x3d.ImageTexture(DEF="backShader")
...
ImageTexture24 = x3d.ImageTexture(DEF="bottomShader")
...
ImageTexture25 = x3d.ImageTexture(DEF="frontShader")
...
ComposedShader29 = x3d.ComposedShader(DEF="x_ite")
ComposedShader29.language = "GLSL"
ComposedShader29.children.append(x3d.Comment("""http://hypertextbook.com/facts/2005/JustinChe.shtml"""))
field30 = x3d.field()
...
ComposedShader37 = x3d.ComposedShader(DEF="x3dom")
...
Script46 = x3d.Script(DEF="UrlSelector")
...
TimeSensor61 = x3d.TimeSensor(DEF="Clock")

...
HAnimHumanoid(name="humanoid", DEF="hanim_humanoid", version="1.0", 
metadata=(
...
HAnimSite(name="l_femoral_lateral_epicn_pt", DEF="hanim_l_femoral_lateral_epicn_pt", translation=((0.1598,0.4967,0.0297))),
HAnimSite(name="l_femoral_medial_epicn_pt", DEF="hanim_l_femoral_medial_epicn_pt", translation=((0.0398,0.4946,0.0303)))]),
...
HAnimSite(name="l_calcaneous_post_pt", DEF="hanim_l_calcaneous_post_pt", translation=((0.0974,0.0259,-0.1171)))]),
...
HAnimSite(name="l_middistal_tip", DEF="hanim_l_middistal_tip", translation=((0.1354,0.0016,0.1476))),
HAnimSite(name="l_metatarsal_pha5_pt", DEF="hanim_l_metatarsal_pha5_pt", translation=((0.1825,0.007,0.0928))),
HAnimSite(name="l_metatarsal_pha1_pt", DEF="hanim_l_metatarsal_pha1_pt", translation=((0.0816,0.0232,0.0106))),
HAnimSite(name="l_digit2_pt", DEF="hanim_l_digit2_pt", translation=((0.1195,0.0079,0.1433)))])])])])]),
...
HAnimSite(name="r_femoral_lateral_epicn_pt", DEF="hanim_r_femoral_lateral_epicn_pt", translation=((-0.1421,0.4992,0.031))),
HAnimSite(name="r_femoral_medial_epicn_pt", DEF="hanim_r_femoral_medial_epicn_pt", translation=((-0.0221,0.5014,0.0289)))]),
...
Shape(USE="DiamondShape")])]),
HAnimJoint(name="r_ankle", DEF="hanim_r_ankle", center=((-0.0801,0.0712,-0.0766)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimSite(name="r_calcaneous_post_pt", DEF="hanim_r_calcaneous_post_pt", translation=((-0.0692,0.0297,-0.1221)))]),
HAnimJoint(name="r_midtarsal", DEF="hanim_r_midtarsal", center=((-0.0801,0.0,0.0368)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
HAnimSegment(name="r_middistal", DEF="hanim_r_middistal", children=[
HAnimSite(name="r_middistal_tip", DEF="hanim_r_middistal_tip", translation=((-0.1043,-0.0227,0.145))),
HAnimSite(name="r_metatarsal_pha5_pt", DEF="hanim_r_metatarsal_pha5_pt", translation=((-0.1523,0.0166,0.0895))),
HAnimSite(name="r_metatarsal_pha1_pt", DEF="hanim_r_metatarsal_pha1_pt", translation=((-0.0521,0.026,0.0127))),
HAnimSite(name="r_digit2_pt", DEF="hanim_r_digit2_pt", translation=((-0.0883,0.0134,0.1383)))])])])])])]),
HAnimJoint(name="vl1", DEF="hanim_vl1", center=((-0.00405,1.07,-0.0275)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimSite(name="l_humeral_lateral_epicn_pt", DEF="hanim_l_humeral_lateral_epicn_pt", translation=((0.228,1.1482,-0.11)))]),
...
HAnimSite(name="l_humeral_medial_epicn_pt", DEF="hanim_l_humeral_medial_epicn_pt", translation=((0.1735,1.1272,-0.1113))),
...
HAnimSite(name="l_hand_tip", DEF="hanim_l_hand_tip", translation=((0.208,0.6731,-0.0491))),
HAnimSite(name="l_metacarpal_pha2_pt", DEF="hanim_l_metacarpal_pha2_pt", translation=((0.2009,0.8139,-0.0237))),
...
HAnimSite(name="l_metacarpal_pha5_pt", DEF="hanim_l_metacarpal_pha5_pt", translation=((0.1929,0.786,-0.1122)))])])])]),
...
HAnimSite(name="r_humeral_lateral_epicn_pt", DEF="hanim_r_humeral_lateral_epicn_pt", translation=((-0.2224,1.1517,-0.1033)))]),
...
HAnimSite(name="r_humeral_medial_epicn_pt", DEF="hanim_r_humeral_medial_epicn_pt", translation=((-0.168,1.1298,-0.1062))),
HAnimSite(name="r_radiale_pt", DEF="hanim_r_radiale_pt", translation=((-0.213,1.1305,-0.1091)))]),
HAnimJoint(name="r_wrist", DEF="hanim_r_wrist", center=((-0.1959,0.8694,-0.0521)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimSite(name="r_hand_tip", DEF="hanim_r_hand_tip", translation=((-0.1969,0.6758,-0.0427))),
HAnimSite(name="r_metacarpal_pha2_pt", DEF="hanim_r_metacarpal_pha2_pt", translation=((-0.1977,0.8169,-0.0177))),
...
HAnimSite(name="r_metacarpal_pha5_pt", DEF="hanim_r_metacarpal_pha5_pt", translation=((-0.1929,0.789,-0.1064)))])])])]),
HAnimJoint(name="vc4", DEF="hanim_vc4", center=((0,1.43,-0.0458)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
Shape(USE="DiamondShape")]),
HAnimSite(name="skull_tip", DEF="hanim_skull_tip", translation=((0.005,1.7504,0.0055))),

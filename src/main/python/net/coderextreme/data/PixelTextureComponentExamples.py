...
Shape50 = x3d.Shape()
Shape50.setBboxCenter([0,0,0])
Shape50.setBboxSize([-1,-1,-1])
...
Shape60 = x3d.Shape()
Shape60.setBboxCenter([0,0,0])
Shape60.setBboxSize([-1,-1,-1])
...
Shape65 = x3d.Shape()
Shape65.setBboxCenter([0,0,0])
Shape65.setBboxSize([-1,-1,-1])
Text66 = x3d.Text()
Text66.setString(["4"])

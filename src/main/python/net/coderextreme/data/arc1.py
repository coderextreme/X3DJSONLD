...
head=Pyhead(
children=[
Pymeta(name="title", content="arc1.x3d"),
...
Pyfield(name="endnode", accessType="initializeOnly", type="SFNode"),
Pyfield(name="transnode", accessType="initializeOnly", type="SFNode"),
Pyfield(name="rotscalenode", accessType="initializeOnly", type="SFNode"),
Pyfield(name="set_startpoint", accessType="inputOnly", type="SFVec3f"),
Pyfield(name="set_endpoint", accessType="inputOnly", type="SFVec3f")
], 

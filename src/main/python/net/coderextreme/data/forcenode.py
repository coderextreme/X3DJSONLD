...
Pymeta(name="title", content="forcenode.x3d"),
...
ProtoInstance(name="node", DEF="nodeC", fieldValue=[PyfieldValue(name="position", value=[-50.0,-50.0,-50.0])
]),
ProtoInstance(name="node", DEF="nodeD", fieldValue=[PyfieldValue(name="position", value=[50.0,50.0,-50.0])
]),
...
ProtoInstance(name="cyl", DEF="linkB", fieldValue=[PyfieldValue(name="set_positionA", value=[0,0,0]),
PyfieldValue(name="set_positionB", value=[-50,-50,-50])
]),
ProtoInstance(name="cyl", DEF="linkC", fieldValue=[PyfieldValue(name="set_positionA", value=[50,50,50]),
PyfieldValue(name="set_positionB", value=[50,50,-50])
])]),
Script(DEF="clickHandler", field=[Pyfield(name="counter", accessType="inputOutput", value=0, type="SFInt32"),
Pyfield(name="node_changed", accessType="outputOnly", type="SFNode"),
Pyfield(name="add_node", accessType="inputOnly", value=False, type="SFBool")

...
Transform21.setTranslation(x3d.doubleToFloat([1,0,1]))
Shape22 = x3d.Shape()
Text23 = x3d.Text()
...
Material26.setDiffuseColor(x3d.doubleToFloat([0,0,1]))
...
PositionInterpolator27.setKey(x3d.doubleToFloat([0,1]))
PositionInterpolator27.setKeyValue(x3d.doubleToFloat([0,0,0,0,5,0]))
...
Extrusion45.setCrossSection(x3d.doubleToFloat([1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0]))
Extrusion45.setSpine(x3d.doubleToFloat([0,-50,0,0,50,0]))

Shape44.setGeometry(Extrusion45)
Appearance46 = x3d.Appearance()
Material47 = x3d.Material()
Material47.setDiffuseColor(x3d.doubleToFloat([0,1,0]))
...
PlaneSensor57.setMinPosition(x3d.doubleToFloat([-50,-50]))
PlaneSensor57.setMaxPosition(x3d.doubleToFloat([50,50]))
...
X3D0.toFileJSON("../data/forcenode.new.python.json")

...
Pymeta(name="title", content="bubs.x3d"),
...
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/bubs.x3d"),
...
Script(DEF="bounce1", field=[Pyfield(name="scale", accessType="inputOutput", type="SFVec3f", value=(1,1,1)),

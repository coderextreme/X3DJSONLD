...
X3D(
  profile="Immersive", version="3.3", head=head(  children=[
          ...
          meta(name="title", content="ThreeDTexture.x3d"),
    ...
    children=[
        ...
        ProtoDeclare(
          name="sphereproto", ProtoInterface=ProtoInterface(
            field=[
                field(name="xtranslation", accessType="inputOutput", type="SFVec3f", value=(0.0,0.0,0.0))]), ProtoBody=ProtoBody(
            children=[
                Transform(
                  IS=IS(
                    connect=[
        ...
        ProtoDeclare(
          name="three", ProtoInterface=ProtoInterface(
            field=[
                field(name="ytranslation", accessType="inputOutput", type="SFVec3f", value=(0.0,0.0,0.0))]), ProtoBody=ProtoBody(
            children=[
                Transform(
                  IS=IS(
                    connect=[
                      ...
                      ProtoInstance(
                        name="sphereproto", fieldValue=[
                            fieldValue(name="xtranslation", value=(-2,0,0))])])])),
        ProtoDeclare(
          name="nine", ProtoInterface=ProtoInterface(
            field=[
                field(name="ztranslation", accessType="inputOutput", type="SFVec3f", value=(0.0,0.0,0.0))]), ProtoBody=ProtoBody(
            children=[
                Transform(
                  IS=IS(
                    connect=[
                      ...
                      ProtoInstance(
                        name="three", fieldValue=[
                            fieldValue(name="ytranslation", value=(0,-2,0))])])])),
        ProtoDeclare(
          name="twentyseven", ProtoInterface=ProtoInterface(
            field=[

...
Viewpoint35.setPosition([0,1.75,60])
...
Material76.setDiffuseColor([0.7,0.7,0.7])
Material76.setSpecularColor([0.5,0.5,0.5])
...
Transform119.setTranslation([0,0,-3])
Shape120 = x3d.Shape()
Appearance121 = x3d.Appearance()
Material122 = x3d.Material()
Material122.setDiffuseColor([0,0,0])
...
Transform125.setTranslation([0,0,-20])
Shape126 = x3d.Shape()
Text127 = x3d.Text()
...
Material130.setDiffuseColor([1,1,0])
...
Transform142.setTranslation([0,0.7,0])
IS143 = x3d.IS()
...
Transform145.setTranslation([0,0,0.1])
IS146 = x3d.IS()
...
PlaneSensor148.setMaxPosition([1,0])

Transform145.addChildren(PlaneSensor148)
Transform149 = x3d.Transform()
Transform149.setTranslation([0,0,0])
...
Layout227.setOffsetUnits(["WORLD","WORLD"])
Layout227.setScaleMode(["NONE","NONE"])
Layout227.setSize([0.4,0.6])
Layout227.setSizeUnits(["WORLD","WORLD"])

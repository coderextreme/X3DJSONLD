...
Group(children=[
ExternProtoDeclare(name="FlowerProto", url=["../personal/flowerproto.json#FlowerProto","https://coderextreme.net/X3DJSONLD/src/main/personal/flowerproto.json#FlowerProto"], field=[field(name="vertex", accessType="inputOutput", type="MFString"),

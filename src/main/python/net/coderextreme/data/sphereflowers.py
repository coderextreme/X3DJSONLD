...
Background9.setSkyColor([0,0,0])
Background9.setTransparency(0)

Scene7.addChildren(Background9)
Group10 = x3d.Group()
Group10.setBboxCenter([0,0,0])
Group10.setBboxSize([-1,-1,-1])
...
Group16 = x3d.Group()
Group16.setBboxCenter([0,0,0])
Group16.setBboxSize([-1,-1,-1])
...
AudioClip28.setLoop(False)
AudioClip28.setPitch(1)
AudioClip28.setStartTime(0)
AudioClip28.setStopTime(0)
AudioClip28.setPauseTime(0)
AudioClip28.setResumeTime(0)

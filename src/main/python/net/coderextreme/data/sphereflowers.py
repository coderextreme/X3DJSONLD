        ...
        Group(
          children=[
              ...
              ProtoInstance(
                name="flower"),
              TimeSensor(
                DEF="SongTime", loop=True),
              Sound(
                maxBack=100, maxFront=100, minBack=20, minFront=20, source(
                  AudioClip(
                    DEF="AudioClip", description="Chandubabamusic #1", url=["../resources/chandubabamusic1.wav"]))),
              ROUTE(
                fromField="cycleTime", fromNode="SongTime", toField="startTime", toNode="AudioClip")])]))
.XML())

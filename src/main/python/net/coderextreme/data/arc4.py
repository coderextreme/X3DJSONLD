...
head=Pyhead(
children=[
Pymeta(name="title", content="arc4.x3d"),
Pymeta(name="creator", content="Lost, Doug Sanden I think"),
Pymeta(name="generator", content="manual"),
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/x3dconnectorProto.x3d"),
Pymeta(name="description", content="a generic proto to connect two objects"),
...
Transform(DEF="DECLpoint_G1_node", children=[
Shape(
geometry=
Sphere(radius=0.1), 
appearance=
...
PositionInterpolator(DEF="DECLpoint_G1_PI1", key=[float(0),float(1)], keyValue=[(0,0,0),(0,5,0)]),
Script(DEF="DECLpoint_G1_MB1", field=[Pyfield(name="translation", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
Pyfield(name="old", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
Pyfield(name="set_location", accessType="inputOnly", type="SFTime"),
Pyfield(name="keyValue", accessType="inputOutput", type="MFVec3f", value=[(0,0,0),(0,5,0)])
], sourceCode="""['', 'ecmascript:', '\t\tfunction set_location(value) {', '                    old = translation;', '\t\t    translation = new SFVec3f(Math.random()*10-5, Math.random()*10-5, Math.random()*10-5);', '                    keyValue = new MFVec3f([old, translation]);', '\t\t    // Browser.println(keyValue);', '\t\t}', '', '', '']""",),
...
Transform(DEF="DECLpoint_G2_node", children=[
Shape(
geometry=
Sphere(radius=0.1), 
appearance=
...
material=
Material(diffuseColor=((1,0,0))))),
PositionInterpolator(DEF="DECLpoint_G2_PI1", key=[float(0),float(1)], keyValue=[(0,0,0),(0,5,0)]),
Script(DEF="DECLpoint_G2_MB1", field=[Pyfield(name="translation", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
Pyfield(name="old", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
Pyfield(name="set_location", accessType="inputOnly", type="SFTime"),
Pyfield(name="keyValue", accessType="inputOutput", type="MFVec3f", value=[(0,0,0),(0,5,0)])
], sourceCode="""['', 'ecmascript:', '\t\tfunction set_location(value) {', '                    old = translation;', '\t\t    translation = new SFVec3f(Math.random()*10-5, Math.random()*10-5, Math.random()*10-5);', '                    keyValue = new MFVec3f([old, translation]);', '\t\t    // Browser.println(keyValue);', '\t\t}', '', '', '']""",),
...
Group(children=[
Transform(DEF="DECLx3dconnector_connector1_trans", children=[
Transform(DEF="DECLx3dconnector_connector1_rotscale", children=[
Shape(
appearance=
Appearance(
material=

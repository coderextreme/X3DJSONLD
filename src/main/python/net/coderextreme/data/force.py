...
Group15 = x3d.Group()
Transform16 = x3d.Transform(DEF="transform")
IS17 = x3d.IS()
...
TimeSensor35 = x3d.TimeSensor(DEF="nodeClock")
...
Group45 = x3d.Group()
Shape46 = x3d.Shape()
Extrusion47 = x3d.Extrusion(DEF="extrusion")
...
Script50 = x3d.Script(DEF="MoveCylinder")
field51 = x3d.field()
field51.name = "spine"
...
Transform58 = x3d.Transform(DEF="HoldsContent")
Transform58.scale = [0.1,0.1,0.1]
PlaneSensor59 = x3d.PlaneSensor(DEF="clickGenerator")
...
ProtoInstance60 = x3d.ProtoInstance(DEF="nodeA")
...
ProtoInstance62 = x3d.ProtoInstance(DEF="nodeB")
...
ProtoInstance64 = x3d.ProtoInstance(DEF="nodeC")
...
ProtoInstance66 = x3d.ProtoInstance(DEF="nodeD")
...
Transform58.children.append(ProtoInstance66)
ProtoInstance68 = x3d.ProtoInstance(DEF="linkA")
ProtoInstance68.name = "cyl"

Transform58.children.append(ProtoInstance68)
ProtoInstance69 = x3d.ProtoInstance(DEF="linkB")
ProtoInstance69.name = "cyl"

Transform58.children.append(ProtoInstance69)
ProtoInstance70 = x3d.ProtoInstance(DEF="linkC")
ProtoInstance70.name = "cyl"

Transform58.children.append(ProtoInstance70)

Scene10.children.append(Transform58)
Script71 = x3d.Script(DEF="clickHandler")
field72 = x3d.field()
field72.name = "counter"
field72.accessType = "inputOutput"
field72.value = 0
field72.type = "SFInt32"

Script71.field.append(field72)
field73 = x3d.field()
...
Script71.field.append(field73)
Script71.children.append(x3d.Comment("""<field accessType=\"outputOnly\" name=\"node_changed\" type=\"SFNode\"/>"""))
Script71.children.append(x3d.Comment("""<field name=\"ModifiableNode\" type=\"SFNode\" accessType=\"inputOutput\">"""))
Script71.children.append(x3d.Comment("""<Transform USE=\"HoldsContent\"/>"""))
Script71.children.append(x3d.Comment("""</field>"""))

Script71.sourceCode = '''ecmascript:\n"+
...
Scene10.children.append(Script71)
ROUTE74 = x3d.ROUTE()
...
Scene10.children.append(ROUTE76)
ROUTE77 = x3d.ROUTE()
...
Scene10.children.append(ROUTE77)
ROUTE78 = x3d.ROUTE()
...
Scene10.children.append(ROUTE78)
ROUTE79 = x3d.ROUTE()
...
Scene10.children.append(ROUTE79)
ROUTE80 = x3d.ROUTE()
...
Scene10.children.append(ROUTE80)

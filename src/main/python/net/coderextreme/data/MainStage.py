...
DirectionalLight16.setDirection(x3d.doubleToFloat([-0.5,-0.5,-0.5]))
...
DirectionalLight17.setDirection(x3d.doubleToFloat([-1,-1,-1]))
...
DirectionalLight18.setDirection(x3d.doubleToFloat([1,1,-1]))
...
Viewpoint19.setOrientation(x3d.doubleToFloat([1,0,0,-0.449999988]))
Viewpoint19.setPosition(x3d.doubleToFloat([0,4,10]))
...
Viewpoint20.setOrientation(x3d.doubleToFloat([-0.112999998,0.992999971,0.034699999,0.671000004]))
Viewpoint20.setPosition(x3d.doubleToFloat([2.619999886,1.049999952,4.059999943]))
...
Viewpoint21.setPosition(x3d.doubleToFloat([0,1,5]))
...
Viewpoint22.setOrientation(x3d.doubleToFloat([1,0,0,1.570000052]))
Viewpoint22.setPosition(x3d.doubleToFloat([0,-10,0]))
...
Viewpoint23.setOrientation(x3d.doubleToFloat([1,0,0,-1.570000052]))
Viewpoint23.setPosition(x3d.doubleToFloat([0,15,0]))
...
Viewpoint24.setOrientation(x3d.doubleToFloat([1,0,0,-1.100000024]))
Viewpoint24.setPosition(x3d.doubleToFloat([0,8,3]))
...
Transform26.setScale(x3d.doubleToFloat([0.174999997,0.174999997,0.174999997]))
Inline27 = x3d.Inline()
...
Transform28.setScale(x3d.doubleToFloat([1,0.01,1]))
Transform28.setTranslation(x3d.doubleToFloat([0,-0.01,0]))
Shape29 = x3d.Shape()
...
Box32 = x3d.Box()
Box32.setSize(x3d.doubleToFloat([9,1,9]))
...
Material36.setDiffuseColor(x3d.doubleToFloat([0.699999988,0,0.899999976]))
Material36.setEmissiveColor(x3d.doubleToFloat([0.449999988,0.449999988,1]))
Material36.setShininess(1)
Material36.setSpecularColor(x3d.doubleToFloat([0,0,1]))
...
Transform39.setScale(x3d.doubleToFloat([0.5,1,0.5]))
Shape40 = x3d.Shape()
...
Transform43.setScale(x3d.doubleToFloat([0.25,1,0.25]))
Shape44 = x3d.Shape()
...
Transform47.setScale(x3d.doubleToFloat([2,1,2]))
Shape48 = x3d.Shape()
...
Transform51.setScale(x3d.doubleToFloat([3,1,3]))
Shape52 = x3d.Shape()

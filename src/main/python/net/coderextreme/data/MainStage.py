...
Viewpoint19 = x3d.Viewpoint(DEF="Scene_StageFrontViewFar")
...
Viewpoint20 = x3d.Viewpoint(DEF="Scene_InclinedView")
...
Viewpoint23 = x3d.Viewpoint(DEF="Scene_HeadTopView")
...
Viewpoint24 = x3d.Viewpoint(DEF="Scene_TopFrontCloseView")
...
Group25 = x3d.Group(DEF="HAnimStage")
Transform26 = x3d.Transform(DEF="cordsysfloor")
...
Transform28 = x3d.Transform(DEF="StageGeometry")
...
Transform33 = x3d.Transform(DEF="Circle0")
Shape34 = x3d.Shape()
Appearance35 = x3d.Appearance(DEF="LineColor")
...
IndexedLineSet37 = x3d.IndexedLineSet(DEF="Orbit1")
...
Transform39 = x3d.Transform(DEF="Circle1")
Transform39.scale = [0.5,1,0.5]
Shape40 = x3d.Shape()
Appearance41 = x3d.Appearance(USE="LineColor")

Shape40.appearance = Appearance41
IndexedLineSet42 = x3d.IndexedLineSet(USE="Orbit1")
...
Transform43 = x3d.Transform(DEF="Circle2")
Transform43.scale = [0.25,1,0.25]
Shape44 = x3d.Shape()
Appearance45 = x3d.Appearance(USE="LineColor")

Shape44.appearance = Appearance45
IndexedLineSet46 = x3d.IndexedLineSet(USE="Orbit1")
...
Transform47 = x3d.Transform(DEF="Circle3")
Transform47.scale = [2,1,2]
Shape48 = x3d.Shape()
Appearance49 = x3d.Appearance(USE="LineColor")

Shape48.appearance = Appearance49
IndexedLineSet50 = x3d.IndexedLineSet(USE="Orbit1")
...
Transform51 = x3d.Transform(DEF="Circle4")
Transform51.scale = [3,1,3]
Shape52 = x3d.Shape()
Appearance53 = x3d.Appearance(USE="LineColor")

Shape52.appearance = Appearance53
IndexedLineSet54 = x3d.IndexedLineSet(USE="Orbit1")

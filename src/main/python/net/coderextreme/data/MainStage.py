...
meta(name="created", content="25 May 2023"),
meta(name="modified", content="27 May 2023"),
meta(name="reference", content="originals/0MainStageScene0525.x3dv"),
...
DirectionalLight(ambientIntensity=1.0, direction=((-0.5,-0.5,-0.5)), global_=True),
...
Viewpoint(DEF="Scene_StageFrontViewFar", description="hanim_Stage Front View", orientation=((1,0,0,-0.449999988)), position=((0,4,10))),
Viewpoint(DEF="Scene_InclinedView", description="hanim_Inclined View", orientation=((-0.112999998,0.992999971,0.034699999,0.671000004)), position=((2.619999886,1.049999952,4.059999943))),
...
Group(DEF="HAnimStage", children=[
Transform(DEF="cordsysfloor", scale=((0.174999997,0.174999997,0.174999997)), children=[
Inline(url=["JointCoordinateAxes.x3dv"])]),
Transform(DEF="StageGeometry", scale=((1,0.01,1)), translation=((0,-0.01,0)), children=[
Shape(
appearance=
Appearance(
material=
...
geometry=
Box(size=((9,1,9)))),
Transform(DEF="Circle0", children=[
Shape(
appearance=
Appearance(DEF="LineColor", 
material=
Material(ambientIntensity=1.0, diffuseColor=((0.699999988,0,0.899999976)), emissiveColor=((0.449999988,0.449999988,1)), shininess=1.0, specularColor=((0,0,1)))), 
geometry=
...
geometry=
IndexedLineSet(USE="Orbit1"))]),
Transform(DEF="Circle3", scale=((2,1,2)), children=[
Shape(
appearance=
Appearance(USE="LineColor"), 
geometry=
IndexedLineSet(USE="Orbit1"))]),
Transform(DEF="Circle4", scale=((3,1,3)), children=[
Shape(
appearance=
Appearance(USE="LineColor"), 
geometry=

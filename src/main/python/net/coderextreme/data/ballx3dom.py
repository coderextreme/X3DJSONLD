...
ShaderPart28 = x3d.ShaderPart(DEF="common")
ShaderPart28.type = "FRAGMENT"
ShaderPart28.url = ["../shaders/common.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs"]
...
f.write(X3D0.XML())
f.close()
f = open("../data/ballx3dom.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/ballx3dom.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

...
meta4.content = "http://www.web3d.org/x3d/content/examples/HumanoidAnimation/DonHumanoidNoSegSite.x3d"
...
f.write(X3D0.XML())
f.close()
f = open("../data/DonHumanoidNoSegSite.new.python.json", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

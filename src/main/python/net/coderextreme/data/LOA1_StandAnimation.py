...
Group49 = x3d.Group()
TimeSensor50 = x3d.TimeSensor(DEF="TIMER")
IS51 = x3d.IS()
...
PositionInterpolator59 = x3d.PositionInterpolator(DEF="HUMANOIDROOT_POSITION_ANIMATOR")
...
OrientationInterpolator62 = x3d.OrientationInterpolator(DEF="HUMANOIDROOT_ANIMATOR")
...
OrientationInterpolator65 = x3d.OrientationInterpolator(DEF="SACROILIAC_ANIMATOR")
...
OrientationInterpolator68 = x3d.OrientationInterpolator(DEF="L_HIP_ANIMATOR")
...
OrientationInterpolator71 = x3d.OrientationInterpolator(DEF="L_KNEE_ANIMATOR")
...
OrientationInterpolator74 = x3d.OrientationInterpolator(DEF="L_ANKLE_ANIMATOR")
OrientationInterpolator74.key = [0,1]
OrientationInterpolator74.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS75 = x3d.IS()
...
OrientationInterpolator77 = x3d.OrientationInterpolator(DEF="L_MIDTARSAL_ANIMATOR")
OrientationInterpolator77.key = [0,1]
OrientationInterpolator77.keyValue = [(1, 0, 0, 0),(1, 0, 0, 0)]
IS78 = x3d.IS()
...
OrientationInterpolator80 = x3d.OrientationInterpolator(DEF="R_HIP_ANIMATOR")
...
OrientationInterpolator83 = x3d.OrientationInterpolator(DEF="R_KNEE_ANIMATOR")
...
OrientationInterpolator86 = x3d.OrientationInterpolator(DEF="R_ANKLE_ANIMATOR")
OrientationInterpolator86.key = [0,1]
OrientationInterpolator86.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS87 = x3d.IS()
...
OrientationInterpolator89 = x3d.OrientationInterpolator(DEF="R_MIDTARSAL_ANIMATOR")
OrientationInterpolator89.key = [0,1]
OrientationInterpolator89.keyValue = [(1, 0, 0, 0),(1, 0, 0, 0)]
IS90 = x3d.IS()
...
OrientationInterpolator92 = x3d.OrientationInterpolator(DEF="VL5_ANIMATOR")
OrientationInterpolator92.key = [0,1]
OrientationInterpolator92.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS93 = x3d.IS()
...
OrientationInterpolator95 = x3d.OrientationInterpolator(DEF="SKULLBASE_ANIMATOR")
OrientationInterpolator95.key = [0,0.5,1]
OrientationInterpolator95.keyValue = [(0, 0, 1, 0),(-1, 0, 0, 0.5),(0, 0, 1, 0)]
IS96 = x3d.IS()
...
OrientationInterpolator98 = x3d.OrientationInterpolator(DEF="L_SHOULDER_ANIMATOR")
...
OrientationInterpolator101 = x3d.OrientationInterpolator(DEF="L_ELBOW_ANIMATOR")
...
OrientationInterpolator104 = x3d.OrientationInterpolator(DEF="L_WRIST_ANIMATOR")
...
OrientationInterpolator107 = x3d.OrientationInterpolator(DEF="R_SHOULDER_ANIMATOR")
...
OrientationInterpolator110 = x3d.OrientationInterpolator(DEF="R_ELBOW_ANIMATOR")
...
OrientationInterpolator113 = x3d.OrientationInterpolator(DEF="R_WRIST_ANIMATOR")
OrientationInterpolator113.key = [0,1]
OrientationInterpolator113.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS114 = x3d.IS()
...
Scene18.children.append(x3d.Comment("""======================================"""))
Scene18.children.append(x3d.Comment("""Point to example use in case someone inspects this file"""))

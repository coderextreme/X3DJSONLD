...
X3D(
  profile="Immersive", version="3.3", head=head(  children=[
    ...
    children=[
        ...
        Transform(
          scale=(0.4,0.4,0.4), translation=(0,1,0), children=[
              TouchSensor(
                DEF="RandomTextClickedSensor", description="Select to see a new strategy"),
              Shape(
                geometry=Text(
                    string=["Oblique Strategies","","(Over One Hundred Worthwhile Dilemmas)","","by Brian Eno and Peter Schmidt"], fontStyle=FontStyle(
                        DEF="MessageFont", family=("SANS"), justify=["MIDDLE","MIDDLE"], style="BOLD")), appearance=Appearance(
                    material=Material(
                        diffuseColor=(1,1,1)))),
              Transform(
                scale=(10,3,1), children=[
                    Shape(
                      DEF="HeadlineClickSurface", geometry=IndexedFaceSet(
                          coordIndex=(0,1,2,3,-1), solid=False, coord(
                            Coordinate(
                              point=(1,1,0,1,-1,0,-1,-1,0,-1,1,0)))), appearance=Appearance(
                          material=Material(
                              ambientIntensity=0.245763, diffuseColor=(0.34773,0.090909,0.005289), shininess=0.07, specularColor=(0.336735,0.051091,0.051091), transparency=0.8)))])]),
        Script(
          DEF="TextScript", url=["ObliqueStrategiesScript.js","https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategiesScript.js"], children=[#initialize() method includes unit test to printAllStrategies() to console
#TODO insert field definitions here (index string_changed previous next random) and then animate!
        ...
        Transform(
          DEF="CardTransform", scale=(0.4,0.4,0.4), translation=(0,-1.5,0), children=[
              Shape(
                geometry=Text(
                    DEF="CardText", fontStyle=FontStyle(
                        family=("SANS"), justify=["MIDDLE","MIDDLE"], style="BOLD")), appearance=Appearance(
                    material=Material(
                        diffuseColor=(1,1,1)))),
              ROUTE(
                fromField="string_changed", fromNode="TextScript", toField="string", toNode="CardText"),
              Sound(
                DEF="CardSoundSpatialization", maxBack=100, maxFront=100, minBack=20, minFront=20, children=[#Make sure the sound source AudioClip is audible at the user location
...
#%20 is space character used in uri/url encoding
                  ...
                  AudioClip(
                    DEF="TextToSpeechAudioClip", description="sends strategy text google translate", url=["http://translate.google.com/translate_tts?tl=en&amp;q=Feed%20the%20recording%20back%20out%20of%20the%20medium","translate_tts_mp3FileFormatNotSupported.wav","https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/translate_tts_mp3FileFormatNotSupported.wav"]))),
              ROUTE(
                fromField="textToSpeechUrl", fromNode="TextScript", toField="url", toNode="TextToSpeechAudioClip"),
              ROUTE(
                fromField="newCardTime", fromNode="TextScript", toField="startTime", toNode="TextToSpeechAudioClip")]),
        Transform(
          scale=(0.4,0.4,0.4), translation=(-3.2,2.5,0), children=[
              TouchSensor(
                DEF="PreviousTextClickedSensor", description="Select to see previous strategy"),
              ROUTE(
                fromField="isActive", fromNode="PreviousTextClickedSensor", toField="selectPreviousCard", toNode="TextScript"),
              Shape(
                geometry=Text(
                    string=["previous"], fontStyle=FontStyle(
                        USE="MessageFont")), appearance=Appearance(
                    DEF="InterfaceAppearance", material=Material(
                        diffuseColor=(1,0,0.6)))),
              Transform(
                scale=(2,0.6,1), children=[
                    Shape(
                      DEF="TransparentClickSurface", children=[#support Selectable Text with a scalable IFS
                          ...
                          material=Material(
                              transparency=1)))])]),
        Transform(
          scale=(0.4,0.4,0.4), translation=(3.5,2.5,0), children=[
              TouchSensor(
                DEF="NextTextClickedSensor", description="Select to see next strategy"),
              ROUTE(
                fromField="isActive", fromNode="NextTextClickedSensor", toField="selectNextCard", toNode="TextScript"),
              Shape(
                geometry=Text(
                    string=["next"], fontStyle=FontStyle(
                        USE="MessageFont")), appearance=Appearance(
                    USE="InterfaceAppearance")),
              Transform(
                scale=(1.2,0.6,1), children=[
                    Shape(
                      USE="TransparentClickSurface")])]),
        Transform(
          scale=(0.4,0.4,0.4), translation=(-3.3,-0.5,0), children=[
              TouchSensor(
                USE="RandomTextClickedSensor"),
              ROUTE(
                fromField="isActive", fromNode="RandomTextClickedSensor", toField="selectRandomCard", toNode="TextScript"),
              Shape(
                geometry=Text(
                    string=["random"], fontStyle=FontStyle(
                        USE="MessageFont")), appearance=Appearance(
                    USE="InterfaceAppearance")),
              Transform(
                scale=(1.8,0.6,1), children=[
                    Shape(
                      USE="TransparentClickSurface")])]),
        Transform(
          scale=(0.4,0.4,0.4), translation=(3.3,-0.5,0), children=[
              Anchor(
                DEF="TextToSpeechAnchor", description="text to speech in browser", parameter=("target=_blank"), url=["http://translate.google.com/translate_tts?tl=en&amp;q=Overtly%20resist%20change"], children=[
                    ROUTE(
                      fromField="textToSpeechUrl", fromNode="TextScript", toField="url", toNode="TextToSpeechAnchor"),
                    Shape(
                      geometry=Text(
                          string=["speech"], fontStyle=FontStyle(
                              USE="MessageFont")), appearance=Appearance(
                          USE="InterfaceAppearance")),
                    Transform(
                      scale=(1.8,0.6,1), children=[

...
IntegerSequencer(DEF="TimingSequencer", key=[float(0),float(0.1),float(0.2),float(0.3),float(0.4),float(0.5),float(0.6),float(0.7),float(0.8),float(1.0)], keyValue=[int(0),int(1),int(2),int(3),int(4),int(5),int(6),int(7),int(8),int(10)]),

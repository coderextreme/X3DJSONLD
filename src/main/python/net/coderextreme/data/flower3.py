...
head=Pyhead(
children=[
Pymeta(name="title", content="flower3.x3d"),
Pymeta(name="creator", content="John Carlson"),
Pymeta(name="generator", content="manual"),
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/flower3.x3d"),
Pymeta(name="description", content="a flower"),

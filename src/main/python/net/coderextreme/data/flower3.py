...
X3D(
  profile="Immersive", version="3.3", head=head(  children=[
    ...
    children=[
        ...
        DirectionalLight(
          direction=(0,-0.8,-0.2), intensity=0.5),
        Background(
          skyColor=(1.0,1.0,1.0)),
        Viewpoint(
          description="One mathematical orbital", position=(0,0,50)),
        Transform(
          DEF="OrbitTransform", translation=(8,0,0), children=[
              Shape(
                appearance=Appearance(
                    material=Material(
                        diffuseColor=(0,0.5,1), specularColor=(0,0.5,1))), geometry=IndexedFaceSet(

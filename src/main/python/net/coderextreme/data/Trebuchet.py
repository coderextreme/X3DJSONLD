...
Background19.setGroundAngle(x3d.doubleToFloat([1.309,1.570796]))
Background19.setGroundColor(x3d.doubleToFloat([0.1,0.1,0,0.4,0.25,0.2,0.6,0.6,0.6]))
...
Background19.setSkyAngle(x3d.doubleToFloat([1.309,1.57079]))
Background19.setSkyColor(x3d.doubleToFloat([0,0.2,0.7,0,0.5,1,1,1,1]))
...
Shape22 = x3d.Shape()
Box23 = x3d.Box()
Box23.setSize(x3d.doubleToFloat([10000,1,10000]))
...
Transform26.setRotation(x3d.doubleToFloat([0,1,0,1.57]))
Transform26.setScale(x3d.doubleToFloat([0.5,0.5,0.5]))
Transform26.setTranslation(x3d.doubleToFloat([10.5,6.5,4.5]))
Shape27 = x3d.Shape()
...
Material29.setEmissiveColor(x3d.doubleToFloat([1,1,0]))
...
Transform32.setRotation(x3d.doubleToFloat([0,1,0,1.57]))
Transform32.setScale(x3d.doubleToFloat([0.5,0.5,0.5]))
Transform32.setTranslation(x3d.doubleToFloat([11,5.5,6]))
Switch33 = x3d.Switch()
...
Transform51.setTranslation(x3d.doubleToFloat([8,0,0]))
Shape52 = x3d.Shape()
Box53 = x3d.Box()
Box53.setSize(x3d.doubleToFloat([20,1,1]))
...
Transform56.setRotation(x3d.doubleToFloat([0,1,0,1.57]))
Transform56.setTranslation(x3d.doubleToFloat([10,0.5,4.5]))
Transform57 = x3d.Transform()
Transform57.setDEF("launch")
Transform57.setTranslation(x3d.doubleToFloat([0,2,5]))
Billboard58 = x3d.Billboard()
Shape59 = x3d.Shape()
Appearance60 = x3d.Appearance()
Material61 = x3d.Material()
Material61.setDiffuseColor(x3d.doubleToFloat([1,0,0]))
...
Transform64.setTranslation(x3d.doubleToFloat([2,0.3,0]))
Shape65 = x3d.Shape()
Box66 = x3d.Box()
Box66.setSize(x3d.doubleToFloat([5,1,1]))
...
Transform100.setRotation(x3d.doubleToFloat([0,1,0,-1.67]))
Transform101 = x3d.Transform()
Transform101.setDEF("aft")
Transform101.setTranslation(x3d.doubleToFloat([5,5,15]))
Transform102 = x3d.Transform()
Transform102.setTranslation(x3d.doubleToFloat([-2.5,-4.5,-2]))
...
Transform104.setTranslation(x3d.doubleToFloat([0,3,0]))
Shape105 = x3d.Shape()
Shape105.setDEF("plank")
Box106 = x3d.Box()
Box106.setSize(x3d.doubleToFloat([25,1,1]))
...
Transform109.setRotation(x3d.doubleToFloat([0,0,1,1]))
Transform109.setTranslation(x3d.doubleToFloat([-5,10,0]))
Shape110 = x3d.Shape()
...
Transform111.setRotation(x3d.doubleToFloat([0,0,1,-1]))
Transform111.setTranslation(x3d.doubleToFloat([5,10,0]))
Shape112 = x3d.Shape()
...
Transform113.setRotation(x3d.doubleToFloat([0,0,1,1.57]))
Transform113.setScale(x3d.doubleToFloat([0.9,1,1]))
Transform113.setTranslation(x3d.doubleToFloat([0,11,0]))
Shape114 = x3d.Shape()
...
Transform115.setScale(x3d.doubleToFloat([0.4,1,1]))
Transform115.setTranslation(x3d.doubleToFloat([0,10,0]))
Shape116 = x3d.Shape()
...
Transform117.setRotation(x3d.doubleToFloat([0,0,1,1.57]))
Transform117.setScale(x3d.doubleToFloat([0.6,1,1]))
Transform117.setTranslation(x3d.doubleToFloat([0,5,10]))
Transform118 = x3d.Transform()
Transform118.setRotation(x3d.doubleToFloat([0,1,0,0.4]))
Shape119 = x3d.Shape()
...
Transform120.setTranslation(x3d.doubleToFloat([0,18.2,-0.3]))
Shape121 = x3d.Shape()
Box122 = x3d.Box()
Box122.setSize(x3d.doubleToFloat([5,5,0.5]))
...
Transform124.setRotation(x3d.doubleToFloat([1,0,0,-1.57]))
Transform124.setTranslation(x3d.doubleToFloat([0,0.6,2.5]))
Transform125 = x3d.Transform()
Transform125.setRotation(x3d.doubleToFloat([0,0,1,1.57]))
Shape126 = x3d.Shape()
Extrusion127 = x3d.Extrusion()
Extrusion127.setBeginCap(False)
Extrusion127.setCrossSection(x3d.doubleToFloat([1,-0.38,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,-0.38,-1,-1.1,1,-1.1,1,-0.38]))
Extrusion127.setEndCap(False)
Extrusion127.setSolid(False)
Extrusion127.setSpine(x3d.doubleToFloat([0,6,0,0,-11,0]))
...
Transform129.setCenter(x3d.doubleToFloat([7,0,0]))
Transform129.setRotation(x3d.doubleToFloat([0,0,1,0.82]))
Transform129.setScale(x3d.doubleToFloat([0.9,1,1]))
Transform129.setTranslation(x3d.doubleToFloat([-7,18,2.5]))
Transform130 = x3d.Transform()
Shape131 = x3d.Shape()
Box132 = x3d.Box()
Box132.setSize(x3d.doubleToFloat([35,1,1]))
...
Transform134.setTranslation(x3d.doubleToFloat([7,0,0]))
Shape135 = x3d.Shape()
Box136 = x3d.Box()
Box136.setSize(x3d.doubleToFloat([8,2,2]))
...
Transform138.setRotation(x3d.doubleToFloat([1,0,0,1.57]))
Transform138.setScale(x3d.doubleToFloat([0.2,0.2,0.2]))
Transform138.setTranslation(x3d.doubleToFloat([-15,-1,0]))
Shape139 = x3d.Shape()
Shape139.setDEF("Torus")
Appearance140 = x3d.Appearance()
Material141 = x3d.Material()
Material141.setSpecularColor(x3d.doubleToFloat([1,1,1]))
...
Extrusion142.setCrossSection(x3d.doubleToFloat([0.9,0,0.81,-0.34,0.63,-0.63,0.34,-0.83,0,-0.9,-0.34,-0.81,-0.63,-0.63,-0.81,-0.34,-0.9,0,-0.81,0.34,-0.63,0.63,-0.34,0.81,0,0.9,0.38,0.81,0.63,0.63,0.81,0.34,0.9,0]))
Extrusion142.setEndCap(False)
Extrusion142.setSpine(x3d.doubleToFloat([2,0,0,1.85,0,0.77,1.41,0,1.41,0.77,0,1.85,0,0,2,-0.77,0,1.85,-1.41,0,1.41,-1.85,0,0.77,-2,0,0,-1.85,0,-0.77,-1.41,0,-1.41,-0.77,0,-1.85,0,0,-2,0.77,0,-1.85,1.41,0,-1.41,1.85,0,-0.77,2,0,0]))

Shape139.setGeometry(Extrusion142)

Transform138.addChild(Shape139)
Transform143 = x3d.Transform()
Transform143.setTranslation(x3d.doubleToFloat([1,0,2]))
Shape144 = x3d.Shape()
...
Transform148.setTranslation(x3d.doubleToFloat([-18.3,0.3,0]))
Shape149 = x3d.Shape()
...
Material152.setSpecularColor(x3d.doubleToFloat([1,1,1]))
...
Transform155.setTranslation(x3d.doubleToFloat([-2,0,0]))
Shape156 = x3d.Shape()
...
Transform159.setRotation(x3d.doubleToFloat([0,0,1,1.2]))
Transform159.setTranslation(x3d.doubleToFloat([15,55,-11]))
Transform160 = x3d.Transform()
Transform160.setScale(x3d.doubleToFloat([5,5,5]))
Shape161 = x3d.Shape()
...
Extrusion163.setCrossSection(x3d.doubleToFloat([0.1,0,0.092,-0.038,0.071,-0.071,0.038,-0.092,0,-0.1,-0.038,-0.092,-0.071,-0.071,-0.092,-0.038,-0.1,0,-0.092,0.038,-0.071,0.071,-0.038,0.092,0,0.1,0.038,0.092,0.071,0.071,0.092,0.038,0.1,0]))
Extrusion163.setEndCap(False)
Extrusion163.setSolid(False)
Extrusion163.setSpine(x3d.doubleToFloat([-15.2,1.4,2.2,-12,-0.8,2.2]))
...
Transform164.setRotation(x3d.doubleToFloat([1,0,0,-1.7]))
Transform164.setTranslation(x3d.doubleToFloat([-17,-4.5,0]))
...
Transform167.setTranslation(x3d.doubleToFloat([-1,0,1.7]))
Shape168 = x3d.Shape()
...
Transform173.setRotation(x3d.doubleToFloat([0,0,1,-0.82]))
Transform173.setTranslation(x3d.doubleToFloat([7,-26,-2.5]))
Shape174 = x3d.Shape()
...
Extrusion176.setCrossSection(x3d.doubleToFloat([0.1,0,0.092,-0.038,0.071,-0.071,0.038,-0.092,0,-0.1,-0.038,-0.092,-0.071,-0.071,-0.092,-0.038,-0.1,0,-0.092,0.038,-0.071,0.071,-0.038,0.092,0,0.1,0.038,0.092,0.071,0.071,0.092,0.038,0.1,0]))
Extrusion176.setEndCap(False)
Extrusion176.setSolid(False)
Extrusion176.setSpine(x3d.doubleToFloat([-33,0.9,2.5,-18.5,1.9,2.55]))
...
Extrusion179.setCrossSection(x3d.doubleToFloat([0.1,0,0.092,-0.038,0.071,-0.071,0.038,-0.092,0,-0.1,-0.038,-0.092,-0.071,-0.071,-0.092,-0.038,-0.1,0,-0.092,0.038,-0.071,0.071,-0.038,0.092,0,0.1,0.038,0.092,0.071,0.071,0.092,0.038,0.1,0]))
Extrusion179.setEndCap(False)
Extrusion179.setSolid(False)
Extrusion179.setSpine(x3d.doubleToFloat([-35.7,-0.8,2.5,-18.8,-0.8,2.55]))
...
Transform180.setRotation(x3d.doubleToFloat([0,0,1,-0.82]))
Transform180.setTranslation(x3d.doubleToFloat([-4,-15.3,0]))
Transform181 = x3d.Transform()
Transform182 = x3d.Transform()
Transform182.setRotation(x3d.doubleToFloat([0,1,0,-1.57]))
Transform182.setScale(x3d.doubleToFloat([1,1.3,1]))
Transform182.setTranslation(x3d.doubleToFloat([0.5,0,-1]))
Transform183 = x3d.Transform()
Transform183.setRotation(x3d.doubleToFloat([0,0,1,1.57]))
Transform184 = x3d.Transform()
Transform184.setScale(x3d.doubleToFloat([0.3,0.3,0.3]))
Shape185 = x3d.Shape()
...
Extrusion188.setCrossSection(x3d.doubleToFloat([0,0,0,5,0.5,7,1,8,2,9,3,11,3.5,11.2,4,11,5,9,6,8,6.5,7,6.7,5,6.7,0,0,0]))
Extrusion188.setSpine(x3d.doubleToFloat([0,0,0,0.1,0,0]))

Shape185.setGeometry(Extrusion188)

Transform184.addChild(Shape185)
Transform189 = x3d.Transform()
Transform189.setScale(x3d.doubleToFloat([0.3,0.3,0.3]))
Transform189.setTranslation(x3d.doubleToFloat([0,-3.5,11.5]))
Shape190 = x3d.Shape()
Shape190.setUSE("Torus")

Transform189.addChild(Shape190)
Transform191 = x3d.Transform()
Transform191.setTranslation(x3d.doubleToFloat([0,0,2]))
Shape192 = x3d.Shape()
...
Transform195.setScale(x3d.doubleToFloat([0.3,0.3,0.3]))
Transform195.setTranslation(x3d.doubleToFloat([2,0,0]))
Shape196 = x3d.Shape()
Shape196.setUSE("halfsling")

Transform195.addChild(Shape196)
Transform197 = x3d.Transform()
Transform197.setScale(x3d.doubleToFloat([0.3,0.3,0.3]))
Transform197.setTranslation(x3d.doubleToFloat([0,-3.5,11.3]))
Shape198 = x3d.Shape()
Shape198.setUSE("Torus")

Transform197.addChild(Shape198)
Transform199 = x3d.Transform()
Transform199.setTranslation(x3d.doubleToFloat([0,0,2]))
Shape200 = x3d.Shape()
...
Transform203.setTranslation(x3d.doubleToFloat([1,-1,0]))
Shape204 = x3d.Shape()
Extrusion205 = x3d.Extrusion()
Extrusion205.setBeginCap(False)
Extrusion205.setCreaseAngle(0.785)
Extrusion205.setCrossSection(x3d.doubleToFloat([1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0]))
Extrusion205.setEndCap(False)
Extrusion205.setSolid(False)
Extrusion205.setSpine(x3d.doubleToFloat([0,-1,0,0,1,0]))
...
Transform208.setScale(x3d.doubleToFloat([0.01,0.01,0.01]))
Switch209 = x3d.Switch()
Switch209.setDEF("projectile")
Switch209.setWhichChoice(0)
Group210 = x3d.Group()
Transform211 = x3d.Transform()
Transform211.setTranslation(x3d.doubleToFloat([0,0.7,0]))
Shape212 = x3d.Shape()
...
Transform220.setRotation(x3d.doubleToFloat([0,1,0,1.57]))
Transform220.setScale(x3d.doubleToFloat([0.4,0.4,0.4]))
Transform220.setTranslation(x3d.doubleToFloat([0,0.7,0]))
...
Transform222.setRotation(x3d.doubleToFloat([1,0,0,1.57]))
Transform222.setTranslation(x3d.doubleToFloat([0,18,2.5]))
Shape223 = x3d.Shape()
...
Material226.setDiffuseColor(x3d.doubleToFloat([0,0,0]))
Material226.setSpecularColor(x3d.doubleToFloat([1,1,1]))
...
Transform228.setTranslation(x3d.doubleToFloat([4,18,1.8]))
Shape229 = x3d.Shape()
Box230 = x3d.Box()
Box230.setSize(x3d.doubleToFloat([1,10,0.5]))
...
Transform232.setTranslation(x3d.doubleToFloat([4,18,3.2]))
Shape233 = x3d.Shape()
Box234 = x3d.Box()
Box234.setSize(x3d.doubleToFloat([1,10,0.5]))
...
Material240.setDiffuseColor(x3d.doubleToFloat([0,0,0]))
Material240.setSpecularColor(x3d.doubleToFloat([1,1,1]))
...
Transform241.setRotation(x3d.doubleToFloat([1,0,0,1.57]))
Transform241.setTranslation(x3d.doubleToFloat([4,22,2.5]))
Shape242 = x3d.Shape()
...
Material245.setDiffuseColor(x3d.doubleToFloat([0,0,0]))
Material245.setSpecularColor(x3d.doubleToFloat([1,1,1]))
...
Transform246.setRotation(x3d.doubleToFloat([0,0,1,1.57]))
Transform246.setScale(x3d.doubleToFloat([0.2,0.2,0.2]))
Transform246.setTranslation(x3d.doubleToFloat([-11.5,-1,2]))
Transform247 = x3d.Transform()
Transform247.setDEF("screw")
Transform247.setRotation(x3d.doubleToFloat([1,0,0,1.57]))
Shape248 = x3d.Shape()
Shape248.setUSE("Torus")

Transform247.addChild(Shape248)
Transform249 = x3d.Transform()
Transform249.setRotation(x3d.doubleToFloat([1,0,0,-1.57]))
Transform249.setTranslation(x3d.doubleToFloat([0,0,7]))
Shape250 = x3d.Shape()
...
Material253.setSpecularColor(x3d.doubleToFloat([1,1,1]))
...
Transform254.setTranslation(x3d.doubleToFloat([0,0,7]))
...
Transform256.setTranslation(x3d.doubleToFloat([0,0,-3]))
...
Transform258.setTranslation(x3d.doubleToFloat([0,0,5]))
Shape259 = x3d.Shape()
...
Transform264.setRotation(x3d.doubleToFloat([0,1,0,1.57]))
Transform264.setScale(x3d.doubleToFloat([0.6,1,1]))
Transform264.setTranslation(x3d.doubleToFloat([0,-11,-2.5]))
...
Transform266.setRotation(x3d.doubleToFloat([0,0,1,-1.57]))
Transform266.setScale(x3d.doubleToFloat([0.6,1,1]))
Transform266.setTranslation(x3d.doubleToFloat([0,5,-10]))
Transform267 = x3d.Transform()
Transform267.setRotation(x3d.doubleToFloat([0,1,0,0.4]))
Shape268 = x3d.Shape()
...
Transform269.setTranslation(x3d.doubleToFloat([0,0,0.6]))
...
Transform271.setTranslation(x3d.doubleToFloat([10,-1,2.5]))
Shape272 = x3d.Shape()
Shape272.setDEF("Axle")
Box273 = x3d.Box()
Box273.setSize(x3d.doubleToFloat([1,1,8]))
...
Transform275.setRotation(x3d.doubleToFloat([1,0,0,1.57]))
Transform275.setTranslation(x3d.doubleToFloat([0,0,4.5]))
Shape276 = x3d.Shape()
...
Transform282.setTranslation(x3d.doubleToFloat([0,0.55,0]))
Shape283 = x3d.Shape()
Shape283.setDEF("hub")
...
Transform286.setRotation(x3d.doubleToFloat([1,0,0,1.57]))
Transform286.setTranslation(x3d.doubleToFloat([0,0,-4.5]))
Shape287 = x3d.Shape()
...
Transform289.setTranslation(x3d.doubleToFloat([0,-0.55,0]))
Shape290 = x3d.Shape()
Shape290.setUSE("hub")
...
Transform291.setTranslation(x3d.doubleToFloat([-10,-1,2.5]))
Shape292 = x3d.Shape()
Shape292.setUSE("Axle")

Transform291.addChild(Shape292)
Transform293 = x3d.Transform()
Transform293.setRotation(x3d.doubleToFloat([1,0,0,1.57]))
Transform293.setTranslation(x3d.doubleToFloat([0,0,4.5]))
Shape294 = x3d.Shape()
...
Transform296.setTranslation(x3d.doubleToFloat([0,0.55,0]))
Shape297 = x3d.Shape()
Shape297.setUSE("hub")
...
Transform298.setRotation(x3d.doubleToFloat([1,0,0,1.57]))
Transform298.setTranslation(x3d.doubleToFloat([0,0,-4.5]))
Shape299 = x3d.Shape()
...
Transform301.setTranslation(x3d.doubleToFloat([0,-0.55,0]))
Shape302 = x3d.Shape()
Shape302.setUSE("hub")
...
Transform303.setRotation(x3d.doubleToFloat([0,1,0,-0.6]))
Transform303.setTranslation(x3d.doubleToFloat([0,100,400]))
Transform304 = x3d.Transform()
Transform304.setTranslation(x3d.doubleToFloat([1,3,0]))
...
Transform310.setTranslation(x3d.doubleToFloat([2.5,0,0]))
Shape311 = x3d.Shape()
Box312 = x3d.Box()
Box312.setSize(x3d.doubleToFloat([5,0.5,0.5]))
...
Transform315.setScale(x3d.doubleToFloat([0.5,0.5,0.5]))
Transform315.setTranslation(x3d.doubleToFloat([0,-1,0]))
...
Transform318.setTranslation(x3d.doubleToFloat([8,0,0]))
Shape319 = x3d.Shape()
Box320 = x3d.Box()
Box320.setSize(x3d.doubleToFloat([17,1,0.5]))
...
Transform323.setTranslation(x3d.doubleToFloat([14.25,1.25,0]))
Switch324 = x3d.Switch()
Switch324.setUSE("projectile")

Transform323.addChildren(Switch324)
Transform325 = x3d.Transform()
Transform325.setRotation(x3d.doubleToFloat([0,1,0,1.57]))
Transform325.setTranslation(x3d.doubleToFloat([0,1,0]))
Viewpoint326 = x3d.Viewpoint()
Viewpoint326.setDescription("Projectile Cam")
Viewpoint326.setPosition(x3d.doubleToFloat([0,0,15]))
...
Transform327.setTranslation(x3d.doubleToFloat([20,2,0]))
Transform328 = x3d.Transform()
Transform328.setDEF("Front")
Transform328.setRotation(x3d.doubleToFloat([0,1,0,1.57]))
...
Transform330.setTranslation(x3d.doubleToFloat([-8,4,0]))
Transform331 = x3d.Transform()
Transform331.setRotation(x3d.doubleToFloat([0,1,0,-1.57]))
...
PositionInterpolator353.setKey(x3d.doubleToFloat([0,0.1,0.2,0.2,0.3,0.9]))
PositionInterpolator353.setKeyValue(x3d.doubleToFloat([1.4,1.6,0,1,-8,0,-3.5,-12,0,-3.5,-12,0,1.2,-8,0,1.4,1.6,0]))
...
OrientationInterpolator354.setKey(x3d.doubleToFloat([0,0.1,0.2,0.2,0.3,0.9]))
OrientationInterpolator354.setKeyValue(x3d.doubleToFloat([0,0,1,0.82,0,0,1,-0.77,0,0,1,-1.57,0,0,1,-1.57,0,0,1,-0.77,0,0,1,0.82]))
...
PositionInterpolator355.setKey(x3d.doubleToFloat([0,0.01,0.95,1]))
PositionInterpolator355.setKeyValue(x3d.doubleToFloat([0,0,-3,0,0,-10,0,0,-10,0,0,-3]))
...
OrientationInterpolator356.setKey(x3d.doubleToFloat([0,0.7,1]))
OrientationInterpolator356.setKeyValue(x3d.doubleToFloat([0,0,1,0,0,0,1,-3.14,0,0,1,0]))
...
PositionInterpolator357.setKey(x3d.doubleToFloat([0,0.2,0.98,0.99]))
PositionInterpolator357.setKeyValue(x3d.doubleToFloat([1,1,1,0.01,0.01,0.01,0.01,0.01,0.01,1,1,1]))

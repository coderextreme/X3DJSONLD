...
PositionInterpolator16.setKey(x3d.doubleToFloat([0,1]))
PositionInterpolator16.setKeyValue(x3d.doubleToFloat([0,0,0,0,5,0]))
...
Material33.setDiffuseColor(x3d.doubleToFloat([1,0,0]))
...
PositionInterpolator34.setKey(x3d.doubleToFloat([0,1]))
PositionInterpolator34.setKeyValue(x3d.doubleToFloat([0,0,0,0,5,0]))
...
Material50.setDiffuseColor(x3d.doubleToFloat([0.2,0.7,0.7]))

...
head=Pyhead(
children=[
Pymeta(name="title", content="arc2.x3d"),
Pymeta(name="creator", content="Lost, Doug Sanden I think"),
Pymeta(name="generator", content="manual"),
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/arc1.x3d"),
...
Transform(DEF="DECLpoint_INSTANCE_node", children=[
Shape(
geometry=
Sphere(radius=0.1), 
appearance=
...
PositionInterpolator(DEF="DECLpoint_INSTANCE_PI1", key=[float(0),float(1)], keyValue=[(0,0,0),(0,5,0)]),
Script(DEF="DECLpoint_INSTANCE_MB1", field=[Pyfield(name="translation", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
...
Transform(DEF="G2", children=[
Transform(DEF="DECLpoint_INSTANCE1000_node", children=[
Shape(
geometry=
Sphere(radius=0.1), 
appearance=
...
material=
Material(diffuseColor=((1,0,0))))),
PositionInterpolator(DEF="DECLpoint_INSTANCE1000_PI1", key=[float(0),float(1)], keyValue=[(0,0,0),(0,5,0)]),
Script(DEF="DECLpoint_INSTANCE1000_MB1", field=[Pyfield(name="translation", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
Pyfield(name="old", accessType="inputOutput", type="SFVec3f", value=(0,0,0)),
Pyfield(name="set_location", accessType="inputOnly", type="SFTime"),
Pyfield(name="keyValue", accessType="inputOutput", type="MFVec3f", value=[(0,0,0),(0,5,0)])
], sourceCode="""['', '', '', 'ecmascript:', '               function set_location(value) {', '                    old = translation;', '                    translation = new SFVec3f(Math.random()*10-5, Math.random()*10-5, Math.random()*10-5);', '                    keyValue = new MFVec3f(old, translation);', '               }', '', '', '']""",),
...
Transform(USE="G2")]),
Pyfield(name="transC1", accessType="initializeOnly", type="SFNode", children=[
Transform(USE="transC1")]),
Pyfield(name="rotscaleC1", accessType="initializeOnly", type="SFNode", children=[

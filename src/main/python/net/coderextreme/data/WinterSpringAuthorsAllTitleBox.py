...
Transform13.translation = [10,10,-5]
Shape14 = x3d.Shape()
...
ImageTexture17.url = ["images/WSAuthorsAll.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSAuthorsAll.png"]
...
X3D0.Scene = Scene10
f = open("../data/WinterSpringAuthorsAllTitleBox.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../data/WinterSpringAuthorsAllTitleBox.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/WinterSpringAuthorsAllTitleBox.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

...
ProtoDeclare16.name = "LOA1_StopAnimation"
ProtoInterface17 = x3d.ProtoInterface()
field18 = x3d.field()
field18.accessType = "inputOutput"
field18.type = "SFTime"
field18.name = "cycleInterval"
field18.value = 0.00999999977648258
...
PositionInterpolator55.key = [0,1]
PositionInterpolator55.keyValue = [(0, 0, 0),(0, 0, 0)]
IS56 = x3d.IS()
...
OrientationInterpolator58.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS59 = x3d.IS()
...
OrientationInterpolator61.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS62 = x3d.IS()
...
OrientationInterpolator64.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS65 = x3d.IS()
...
OrientationInterpolator67.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS68 = x3d.IS()
...
OrientationInterpolator70.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS71 = x3d.IS()
...
OrientationInterpolator73.keyValue = [(1, 0, 0, 0),(1, 0, 0, 0)]
IS74 = x3d.IS()
...
OrientationInterpolator76.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS77 = x3d.IS()
...
OrientationInterpolator79.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS80 = x3d.IS()
...
OrientationInterpolator82.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS83 = x3d.IS()
...
OrientationInterpolator85.keyValue = [(1, 0, 0, 0),(1, 0, 0, 0)]
IS86 = x3d.IS()
...
OrientationInterpolator88.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS89 = x3d.IS()
...
OrientationInterpolator91.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS92 = x3d.IS()
...
OrientationInterpolator94.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS95 = x3d.IS()
...
OrientationInterpolator97.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS98 = x3d.IS()
...
OrientationInterpolator100.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS101 = x3d.IS()
...
OrientationInterpolator103.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS104 = x3d.IS()
...
OrientationInterpolator106.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS107 = x3d.IS()
...
OrientationInterpolator109.keyValue = [(0, 0, 1, 0),(0, 0, 1, 0)]
IS110 = x3d.IS()
...
WorldInfo131.title = "LOA1_StopAnimation.x3d"
...
X3D0.Scene = Scene15
f = open("../data/LOA1_StopAnimation.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../data/LOA1_StopAnimation.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/LOA1_StopAnimation.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

...
Transform13.setTranslation([0,2.1,0])
Shape14 = x3d.Shape()
...
ColorRGBA16.setColor([1,1,0,1,1,1,0,0.1])

IndexedFaceSet15.setColor(ColorRGBA16)
Coordinate17 = x3d.Coordinate()
Coordinate17.setPoint([0,0.01,0,-0.01,0,0,0,0,0.01,0.01,0,0,0,0,-0.01,0,-0.01,0])
...
Material19.setDiffuseColor([1,1,0])

...
X3D(
  profile="Immersive", version="3.3", head=head(  children=[
          ...
          meta(name="title", content="CameraExamples.x3d"),
    ...
    children=[#=============== Camera ==============
        ...
        ExternProtoDeclare(
          name="Camera", appinfo="Camera node provides direct control of scene view to enable cinematic camera animation shot by shot and move by move along with still digital-photography settings for offline rendering of camera images", url=["CameraPrototypes.x3d#Camera","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#Camera","CameraPrototypes.wrl#Camera","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#Camera"], field=[
              ...
              field(name="traceEnabled", accessType="initializeOnly", appinfo="enable console output to trace script computations and prototype progress", type="SFBool")], children=[#Viewpoint-related fields, NavigationInfo-related fields and Camera-unique fields
]),#=============== CameraShot ==============

        ExternProtoDeclare(
          name="CameraShot", appinfo="CameraShot collects a specific set of CameraMovement animations that make up an individual shot", url=["CameraPrototypes.x3d#CameraShot","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#CameraShot","CameraPrototypes.wrl#CameraShot","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#CameraShot"], field=[
              ...
              field(name="moves", accessType="inputOutput", appinfo="Set of CameraMovement nodes", type="MFNode", children=[#initializing CameraMovement nodes are inserted here by scene author using ProtoInstance
]),
              ...
              field(name="isActive", accessType="outputOnly", appinfo="Mark start/stop with true/false output respectively useful to trigger external animations", type="SFBool"),
              field(name="traceEnabled", accessType="initializeOnly", appinfo="enable console output to trace script computations and prototype progress", type="SFBool")]),#=============== CameraMovement ==============

        ExternProtoDeclare(
          name="CameraMovement", appinfo="CameraMovement defines a single camera movement animation", url=["CameraPrototypes.x3d#CameraMovement","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#CameraMovement","CameraPrototypes.wrl#CameraMovement","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#CameraMovement"], field=[
              ...
              field(name="isActive", accessType="outputOnly", appinfo="Mark start/stop with true/false output respectively useful to trigger external animations", type="SFBool"),
              field(name="traceEnabled", accessType="initializeOnly", appinfo="enable console output to trace script computations and prototype progress", type="SFBool")]),#=============== OfflineRender ==============

        ExternProtoDeclare(
          name="OfflineRender", appinfo="OfflineRender defines a parameters for offline rendering of Camera animation output to a movie file (or possibly a still shot)", url=["CameraPrototypes.x3d#OfflineRender","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d#OfflineRender","CameraPrototypes.wrl#OfflineRender","https://www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.wrl#OfflineRender"], field=[
              ...
              field(name="traceEnabled", accessType="initializeOnly", appinfo="enable console output to trace script computations and prototype progress", type="SFBool")], children=[#TODO non-photorealistic rendering (NPR) parameters
]),#=============== Lights, camera, action! ==============

        DirectionalLight(
          direction=(0,-1,0), global=True, intensity=0.8),
        NavigationInfo(
          type="\"EXAMINE\" \"FLY\" \"ANY\""),
        Viewpoint(
          description="Camera test scene entry view", position=(0,2,12)),
        Viewpoint(
          description="Camera test scene from above", orientation=(1,0,0,-1.57079), position=(0,150,0)),#Keep prototype instances in same file while developing, then move later
#We will create examples matching those in the paper
#=============== Camera.SimpleShotsTest ==============

        ProtoInstance(
          name="Camera", DEF="Camera.SimpleShotsTest", fieldValue=[
              ...
              fieldValue(name="shots", children=[
                  ProtoInstance(
                    name="CameraShot", DEF="Zoom", fieldValue=[
                        ...
                        fieldValue(name="moves", children=[
                            ProtoInstance(
                              name="CameraMovement", fieldValue=[
                        ...
                        fieldValue(name="moves", children=[
                            ...
                            ProtoInstance(
                              name="CameraMovement", fieldValue=[
                                  ...
                                  fieldValue(name="goalOrientation", value=(0,1,0,0))])])]),
                  ProtoInstance(
                    name="CameraShot", DEF="Pan", fieldValue=[
                        ...
                        fieldValue(name="moves", children=[
                            ProtoInstance(
                              name="CameraMovement", DEF="PanLeft", fieldValue=[
                            ...
                            ProtoInstance(
                              name="CameraMovement", DEF="PanRight", fieldValue=[
                        ...
                        fieldValue(name="moves", children=[
                            ...
                            ProtoInstance(
                              name="CameraMovement", fieldValue=[
                                  ...
                                  fieldValue(name="goalOrientation", value=(0,0,1,-0.785))]),
                            ProtoInstance(
                              name="CameraMovement", DEF="TiltReset", fieldValue=[
                                  fieldValue(name="description", value="Camera Tilt Reset"),
                                  fieldValue(name="duration", value=1),
                                  fieldValue(name="goalPosition", value=(-10,1,-10)),
                                  fieldValue(name="goalOrientation", value=(0,0,1,0))]),
                            ProtoInstance(
                              name="CameraMovement", DEF="TiltUp", fieldValue=[
                                  fieldValue(name="description", value="Return to home"),
                                  fieldValue(name="duration", value=2),
                                  fieldValue(name="goalPosition", value=(0,2,12)),
                                  fieldValue(name="goalOrientation", value=(0,0,1,0))])])])])]),
        Group(
          DEF="AnimationGroup.SimpleShots", children=[
              TimeSensor(
                DEF="CameraTimer.SimpleShots"),#initialize clock to match totalDuration of combined Shot Moves

              ROUTE(
                fromField="totalDuration", fromNode="Camera.SimpleShotsTest", toField="cycleInterval", toNode="CameraTimer.SimpleShots"),#TimeSensor animates the CameraClock since that maintains the computed PositionInterpolator and OrientationInterpolator

              ROUTE(
                fromField="fraction_changed", fromNode="CameraTimer.SimpleShots", toField="set_fraction", toNode="Camera.SimpleShotsTest"),
              Transform(
                DEF="Trigger.SimpleShots", translation=(-4,4,0), children=[
                    BooleanFilter(
                      DEF="TextTouchActive.SimpleShotsFilter"),
                    TouchSensor(
                      DEF="TextTouch.SimpleShots", description="touch to animate Camera SimpleShotsTest"),
                    ROUTE(
                      fromField="inputTrue", fromNode="TextTouchActive.SimpleShotsFilter", toField="set_bind", toNode="Camera.SimpleShotsTest"),
                    ROUTE(
                      fromField="isActive", fromNode="TextTouch.SimpleShots", toField="set_boolean", toNode="TextTouchActive.SimpleShotsFilter"),
                    ROUTE(
                      fromField="touchTime", fromNode="TextTouch.SimpleShots", toField="startTime", toNode="CameraTimer.SimpleShots"),
                    Shape(
                      geometry=Text(
                          string=["Click to animate","SimpleShotsTest"], fontStyle=FontStyle(
                              justify=["MIDDLE","MIDDLE"])), appearance=Appearance(
                          material=Material(
                              DEF="ArtDeco5", ambientIntensity=0.24, diffuseColor=(0.945455,0.318988,0.321717), shininess=0.01, specularColor=(0.072727,0.021705,0.010732), children=[#Universal Media Library: ArtDeco 5
]))),#Simplify intersection test for user selecting text

                    Shape(
                      DEF="TransparentBox", appearance=Appearance(
                          material=Material(
                              transparency=1)), geometry=Box(
                          size=(6,2,0.0001)))])]),
        Group(
          DEF="SimpleShotsTargets", children=[
              Transform(
                DEF="TargetBoxZoom", translation=(-50,1,-20), children=[
                    Shape(
                      geometry=Box(
                    ...
                    Transform(
                      translation=(0,2,0), children=[
                          Shape(
                            geometry=Text(
                                string=["Zoom in, out"], fontStyle=FontStyle(
                                    justify=["MIDDLE","MIDDLE"])), appearance=Appearance(
                                material=Material(
                                    )))])]),
              Transform(
                DEF="TargetBoxDolly", translation=(-40,1,-20), children=[
                    Shape(
                      geometry=Box(
                          ), appearance=Appearance(
                          material=Material(
                    ...
                    Transform(
                      translation=(0,2,0), children=[
                          Shape(
                            geometry=Text(
                                string=["Dolly left, right"], fontStyle=FontStyle(
                                    justify=["MIDDLE","MIDDLE"])), appearance=Appearance(
                                material=Material(
                                    )))])]),
              Transform(
                DEF="TargetBoxPan", translation=(-30,1,-20), children=[
                    Shape(
                      geometry=Box(
                          ), appearance=Appearance(
                          material=Material(
                    ...
                    Transform(
                      translation=(0,2,0), children=[
                          Shape(
                            geometry=Text(
                                string=["Pan left, right"], fontStyle=FontStyle(
                                    justify=["MIDDLE","MIDDLE"])), appearance=Appearance(
                                material=Material(
                                    )))])]),
              Transform(
                DEF="TargetBoxBoom", translation=(-20,1,-20), children=[
                    Shape(
                      geometry=Box(
                          ), appearance=Appearance(
                          material=Material(
                    ...
                    Transform(
                      translation=(0,2,0), children=[
                          Shape(
                            geometry=Text(
                                string=["Boom up, down"], fontStyle=FontStyle(
                                    justify=["MIDDLE","MIDDLE"])), appearance=Appearance(
                                material=Material(
                                    )))])]),
              Transform(
                DEF="TargetBoxTilt", translation=(-10,1,-20), children=[
                    Shape(
                      geometry=Box(
                          ), appearance=Appearance(
                          material=Material(
                        ...
                        fieldValue(name="moves", children=[
                            ProtoInstance(
                              name="CameraMovement", DEF="MoveAimPoint3.1", fieldValue=[
                                  ...
                                  fieldValue(name="goalPosition", value=(6,6,10))], children=[#goalAimPoint modified by ROUTE to match moving Box
]),
                            ProtoInstance(
                              name="CameraMovement", DEF="MoveAimPoint3.2", fieldValue=[
                                  fieldValue(name="description", value="AimPoint 3.2 pan right while tracking"),
                                  fieldValue(name="tracking", value=True),
                                  fieldValue(name="duration", value=8),
                                  fieldValue(name="goalPosition", value=(40,6,12))], children=[#goalAimPoint modified by ROUTE to match moving Box
]),
                            ProtoInstance(
                              name="CameraMovement", DEF="MoveAimPoint3.3", fieldValue=[
                                  fieldValue(name="description", value="AimPoint 3.3 boom up while tracking"),
                                  fieldValue(name="tracking", value=True),
                                  fieldValue(name="duration", value=3),
                                  fieldValue(name="goalPosition", value=(40,20,13))], children=[#goalAimPoint modified by ROUTE to match moving Box
]),
                            ProtoInstance(
                              name="CameraMovement", DEF="MoveAimPoint3.4", fieldValue=[
                                  ...
                                  fieldValue(name="goalOrientation", value=(0,1,0,0))], children=[#can test tracking or not using these values
])])])])]),
        Group(
          DEF="AnimationGroup.AimPointTest", children=[
              TimeSensor(
                DEF="CameraTimer.AimPointTest"),#initialize clock to match totalDuration of combined Shot Moves

              ROUTE(
                fromField="totalDuration", fromNode="Camera.AimPointTest", toField="cycleInterval", toNode="CameraTimer.AimPointTest"),#TimeSensor animates the CameraClock since that maintains the computed PositionInterpolator and OrientationInterpolator

              ROUTE(
                fromField="fraction_changed", fromNode="CameraTimer.AimPointTest", toField="set_fraction", toNode="Camera.AimPointTest"),
              Transform(
                DEF="Trigger.AimPointTest", translation=(4,4,0), children=[
                    BooleanFilter(
                      DEF="TextTouchActive.AimPointFilter"),
                    TouchSensor(
                      DEF="TextTouch.AimPointTest", description="touch to animate Camera AimPointTest"),
                    ROUTE(
                      fromField="inputTrue", fromNode="TextTouchActive.AimPointFilter", toField="set_bind", toNode="Camera.AimPointTest"),
                    ROUTE(
                      fromField="isActive", fromNode="TextTouch.AimPointTest", toField="set_boolean", toNode="TextTouchActive.AimPointFilter"),
                    ROUTE(
                      fromField="touchTime", fromNode="TextTouch.AimPointTest", toField="startTime", toNode="CameraTimer.AimPointTest"),
                    Shape(
                      geometry=Text(
                          string=["Click to animate","AimPointTest"], fontStyle=FontStyle(
                              justify=["MIDDLE","MIDDLE"])), appearance=Appearance(
                          material=Material(
                              USE="ArtDeco5"))),
                    Shape(
                      USE="TransparentBox")])]),#TODO build a test once implemented

        ProtoInstance(
          name="OfflineRender"),#=============== animate a camera shape to visualize view changes ==============

        Transform(
          DEF="CameraShapeTransform", translation=(0,0.5,0), children=[#move CameraShape using active Camera

              ROUTE(
                fromField="position_changed", fromNode="Camera.SimpleShotsTest", toField="translation", toNode="CameraShapeTransform"),
              ROUTE(
                fromField="orientation_changed", fromNode="Camera.SimpleShotsTest", toField="rotation", toNode="CameraShapeTransform"),
              ROUTE(
                fromField="position", fromNode="Camera.AimPointTest", toField="translation", toNode="CameraShapeTransform"),
              ROUTE(
                fromField="orientation_changed", fromNode="Camera.AimPointTest", toField="rotation", toNode="CameraShapeTransform"),
              Transform(
                DEF="CameraOffsetTransform", translation=(0,0,0.25), children=[
                    TouchSensor(
                      DEF="CameraShapeTouched"),
                    Inline(
                      DEF="CameraShape", url=["CameraShape.x3d","https://www.web3d.org/x3d/content/examples/Basic/development/CameraShape.x3d"]),
                    Shape(
                      DEF="SightLine", geometry=IndexedLineSet(
                          coordIndex=(0,1), coord(
                            Coordinate(
                              point=(0,0,0,0,0,-100)))), appearance=Appearance(
                          material=Material(
                              emissiveColor=(0.8,0.8,0.4))))]),#Display frustum to show camera view within the scene, toggled by user selecting CameraShape

              ExternProtoDeclare(
                name="ViewFrustum", appinfo="Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes", url=["../../X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.x3d#ViewFrustum","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.x3d#ViewFrustum","../../X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.wrl#ViewFrustum","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.wrl#ViewFrustum"], field=[
              ...
              ProtoInstance(
                name="ViewFrustum", DEF="ViewFrustumNode", fieldValue=[
                    fieldValue(name="ViewpointNode", children=[
                        Viewpoint(
                          DEF="FrustumViewpoint", description="viewpoint for ViewFrustum", position=(0,0,0))]),
                    fieldValue(name="NavigationInfoNode", children=[
                        NavigationInfo(
                          DEF="TestNavigationInfo", transitionType=("ANIMATE"), visibilityLimit=100)]),
              ...
              ROUTE(
                fromField="isActive", fromNode="CameraShapeTouched", toField="set_boolean", toNode="ViewFrustumToggle"),
              ROUTE(
                fromField="toggle", fromNode="ViewFrustumToggle", toField="set_visible", toNode="ViewFrustumNode")]),#=============== add checkerboard, axes and other things to look at while animating ==============

        Background(
          skyColor=(0.282353,0.380392,0.470588)),
        Transform(
          rotation=(1,0,0,-1.57079), scale=(10,10,10), children=[
              Shape(
                appearance=Appearance(
                    material=Material(
        ...
        Transform(
          scale=(3,3,3), translation=(0,0.25,0), children=[
              Inline(
                DEF="CoordinateAxes", url=["../../X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.x3d","../../Savage/Tools/Authoring/CoordinateAxes.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.x3d","https://savage.nps.edu/Savage/Tools/Authoring/CoordinateAxes.x3d","../../X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.wrl","../../Savage/Tools/Authoring/CoordinateAxes.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.wrl","https://savage.nps.edu/Savage/Tools/Authoring/CoordinateAxes.wrl"])]),
        Transform(
          DEF="MovingBoxTransform", children=[
              PositionInterpolator(
                DEF="BoxPath", key=[0,0.25,0.5,0.75,1], keyValue=[-5,1,5,45,1,5,45,1,-45,-5,1,-45,-5,1,5]),
              TimeSensor(
                DEF="BoxTimer", cycleInterval=10, loop=True),
              ROUTE(
                fromField="value_changed", fromNode="BoxPath", toField="translation", toNode="MovingBoxTransform"),
              ROUTE(
                fromField="value_changed", fromNode="BoxPath", toField="goalAimPoint", toNode="MoveAimPoint3.1"),
              ROUTE(
                fromField="value_changed", fromNode="BoxPath", toField="goalAimPoint", toNode="MoveAimPoint3.2"),
              ROUTE(
                fromField="value_changed", fromNode="BoxPath", toField="goalAimPoint", toNode="MoveAimPoint3.3"),
              ROUTE(
                fromField="fraction_changed", fromNode="BoxTimer", toField="set_fraction", toNode="BoxPath"),
              Shape(
                geometry=Box(
                    ), appearance=Appearance(
                    material=Material(
                        ), texture=ImageTexture(
                        url=["../earth-topo.png","https://www.web3d.org/x3d/content/examples/Basic/earth-topo.png"])))]),#================ CrossHair visualization for center of screen ================

        ExternProtoDeclare(
          name="CrossHair", appinfo="CrossHair prototype provides a heads-up display (HUD) crosshair at the view center, which is useful for assessing NavigationInfo lookAt point", url=["../../Savage/Tools/HeadsUpDisplays/CrossHairPrototype.x3d#CrossHair","https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/CrossHairPrototype.x3d#CrossHair","../../Savage/Tools/HeadsUpDisplays/CrossHairPrototype.wrl#CrossHair","https://savage.nps.edu/Savage/Tools/HeadsUpDisplays/CrossHairPrototype.wrl#CrossHair"], field=[
        ...
        ProtoInstance(
          name="CrossHair", DEF="CrossHairInstance", fieldValue=[
              fieldValue(name="enabled", value=True),
              fieldValue(name="markerColor", value=(1,0.5,0)),
              fieldValue(name="scale", value=(1,1,1)),
              fieldValue(name="positionOffsetFromCamera", value=(0,0,-6))]),#turn on CrossHairInstance when animated camera viewpoints are bound

        ROUTE(
          fromField="isBound", fromNode="Camera.SimpleShotsTest", toField="set_enabled", toNode="CrossHairInstance"),
        ROUTE(
          fromField="isBound", fromNode="Camera.AimPointTest", toField="set_enabled", toNode="CrossHairInstance"),#turn off CrossHairInstance when animated camera viewpoints are unbound <BooleanFilter DEF='NegateCrossHair'/> <ROUTE fromField='isBound' fromNode='Camera.SimpleShotsTest' toField='set_boolean' toNode='NegateCrossHair'/> <ROUTE fromField='isBound' fromNode='Camera.AimPointTest' toField='set_boolean' toNode='NegateCrossHair'/> <ROUTE fromField='inputNegate' fromNode='NegateCrossHair' toField='set_enabled' toNode='CrossHairInstance'/>
#=============== TODO Launch Prototype Example ==============

        Anchor(
          description="launch CameraExample scene", parameter=("target=_blank"), url=["CameraExample.x3d","https://www.web3d.org/x3d/content/examples/Basic/development/CameraExample.x3d","CameraExample.wrl","https://www.web3d.org/x3d/content/examples/Basic/development/CameraExample.wrl"], children=[
              Transform(
                translation=(0,-3,0), children=[
                    Shape(
                      geometry=Text(
                          string=["CameraPrototype","defines a prototype","","Click on this text to see","CameraExample scene"], fontStyle=FontStyle(
                              justify=["MIDDLE","MIDDLE"], size=0.5)), appearance=Appearance(
                          material=Material(

...
meta11 = x3d.meta()
meta11.name = "Image"
meta11.content = "../Poses/images/HAnimPoseExampleKoreanCharacter10Mi.png"
...
meta15.content = "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter10Mi.x3d"
...
WorldInfo22.title = "KoreanCharacter10Mi.x3d"
...
Viewpoint24.description = "Mi"
Viewpoint24.position = [0,1,3]

Scene21.children.append(Viewpoint24)
HAnimHumanoid25 = x3d.HAnimHumanoid(DEF="hanim_Mi")
HAnimHumanoid25.name = "Mi"
...
HAnimJoint33.center = [0,32.68,-0.7076]
...
Transform35.translation = [0,32.68,-0.7076]
Shape36 = x3d.Shape()
...
ImageTexture39 = x3d.ImageTexture(DEF="MiTextureAtlas")
ImageTexture39.url = ["images/Mi.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Mi.png"]
...
HAnimJoint43.center = [3.309,31.309999,-0.8377]
...
Transform45.translation = [3.309,31.309999,-0.8377]
Shape46 = x3d.Shape()
...
HAnimJoint53.center = [3.584,17.16,-1.037]
...
Transform55.translation = [3.584,17.16,-1.037]
Shape56 = x3d.Shape()
...
HAnimJoint63.center = [3.602,4.137,0.6104]
...
Transform65.translation = [3.602,4.137,0.6104]
Shape66 = x3d.Shape()
...
HAnimJoint73.center = [3.602,3.02,0.07017]
...
Transform75.translation = [3.602,3.02,0.07017]
Shape76 = x3d.Shape()
...
HAnimJoint83.center = [-3.309,31.309999,-0.8377]
...
Transform85.translation = [-3.309,31.309999,-0.8377]
Shape86 = x3d.Shape()
...
HAnimJoint93.center = [-3.584,17.16,-1.037]
...
Transform95.translation = [-3.584,17.16,-1.037]
Shape96 = x3d.Shape()
...
HAnimJoint103.center = [-3.602,4.137,0.6104]
...
Transform105.translation = [-3.602,4.137,0.6104]
Shape106 = x3d.Shape()
...
HAnimJoint113.center = [-3.602,3.02,0.07017]
...
Transform115.translation = [-3.602,3.02,0.07017]
Shape116 = x3d.Shape()
...
HAnimJoint123.center = [0.05053,30.200001,-1.38]
...
Transform125.translation = [0.05053,30.200001,-1.38]
Shape126 = x3d.Shape()
...
HAnimJoint133.center = [6.032,48.580002,-1.277]
...
Transform135.translation = [6.032,48.580002,-1.277]
Shape136 = x3d.Shape()
...
HAnimJoint143.center = [6.032,40.810001,-1.412]
...
Transform145.translation = [6.032,40.810001,-1.412]
Shape146 = x3d.Shape()
...
HAnimJoint153.center = [6.934,33.959999,-1.108]
...
Transform155.translation = [6.934,33.959999,-1.108]
Shape156 = x3d.Shape()
...
HAnimJoint163.center = [-6.032,48.580002,-1.277]
...
Transform165.translation = [-6.032,48.580002,-1.277]
Shape166 = x3d.Shape()
...
TextureCoordinate172.point = [(0.5806, 0.1531),(0.5893, 0.1475),(0.5653, 0.1551),(0.5523, 0.1539),(0.5408, 0.1501),(0.531, 0.1413),(0.5194, 0.1311),(0.6103, 0.1278),(0.598, 0.1395),(0.5884, 0.2211),(0.6032, 0.2168),(0.5665, 0.2255),(0.5445, 0.2237),(0.5286, 0.2188),(0.5168, 0.2148),(0.4946, 0.2088),(0.6175, 0.2105),(0.6398, 0.2042),(0.8805, 0.864),(0.9038, 0.8213),(0.9347, 0.8443),(0.897, 0.875),(0.8495, 0.8555),(0.8494, 0.8095),(0.8149, 0.8685),(0.7931, 0.8239),(0.7986, 0.8794),(0.7625, 0.8462),(0.5933, 0.2702),(0.6119, 0.2609),(0.5675, 0.2742),(0.5383, 0.2707),(0.5195, 0.2617),(0.5082, 0.2554),(0.4847, 0.2451),(0.6523, 0.2396),(0.6284, 0.2508),(0.7852, 0.8995),(0.742, 0.8792),(0.7754, 0.9475),(0.7234, 0.9289),(0.9127, 0.9005),(0.9563, 0.8809),(0.849, 0.9239),(0.9068, 0.8131),(0.94, 0.8368),(0.9636, 0.8731),(0.9828, 0.9217),(0.7348, 0.8711),(0.7565, 0.8388),(0.7893, 0.8149),(0.8497, 0.8016),(0.9212, 0.9514),(0.9731, 0.9326),(0.7144, 0.9175),(0.5721, 0.0377),(0.5737, 0.0472),(0.5736, 0.0597),(0.5731, 0.073),(0.5718, 0.0836),(0.5723, 0.094),(0.575, 0.1083),(0.5737, 0.0301),(0.5782, 0.0137),(0.5721, 0.0377),(0.5731, 0.073),(0.5718, 0.0836),(0.5723, 0.094),(0.5737, 0.0472),(0.5736, 0.0597),(0.5782, 0.0137),(0.575, 0.1083),(0.5737, 0.0301),(0.5721, 0.0377),(0.5737, 0.0472),(0.5736, 0.0597),(0.5731, 0.073),(0.5718, 0.0836),(0.5723, 0.094),(0.575, 0.1083),(0.5737, 0.0301),(0.5731, 0.0667)]
...
HAnimJoint173.center = [-6.032,40.810001,-1.412]
...
Transform175.translation = [-6.032,40.810001,-1.412]
Shape176 = x3d.Shape()
...
Coordinate181.point = [(-0.821, -0.5909, -0.8822),(-1.427, -0.594, 0.7319),(-0.8222, -0.5909, 0.996),(-0.2876, -0.5847, 0.7126),(-0.7753, -6.749, -0.7027),(-1.443, -6.672, 0.0095),(-0.2955, -6.697, -0.0347),(-0.4962, -6.735, -0.5285),(-1.195, -6.689, 0.4229),(-0.8251, -6.727, 0.6277),(-0.5299, -6.717, 0.4443),(-1.193, -6.711, -0.4833),(-1.419, -0.5938, -0.6599),(-1.809, -0.6062, 0.0293),(0.0834, -0.5804, 0.0244),(-0.3356, -0.5853, -0.6602),(-0.8149, -7.02, -0.669),(-1.318, -7.012, 0.0209),(-0.3939, -6.998, -0.022),(-0.6226, -7.033, -0.53),(-1.109, -7.01, 0.4196),(-0.8288, -7.019, 0.5966),(-0.6184, -7.025, 0.4434),(-1.065, -7.043, -0.4741),(-0.8905, -7.158, -0.0054),(-1.294, -3.708, -0.529),(-0.7852, -3.761, -0.86),(-1.645, -3.664, 0.0347),(-1.34, -3.692, 0.5633),(-0.8188, -3.731, 0.8834),(-0.4018, -3.736, 0.599),(-0.0819, -3.706, -0.0521),(-0.3634, -3.717, -0.5775),(-0.8469, -0.0133, -0.9988),(-1.479, -0.0529, 0.7574),(-0.8418, -0.0307, 1.025),(-0.2776, -0.0084, 0.7411),(-1.534, -0.0371, -0.7635),(-1.908, -0.0564, 0.0374),(0.1502, 0.0257, 0.0308),(-0.281, 0.0081, -0.7713),(-1.424, 0.4666, -0.6148),(-0.8709, 0.4848, -0.8043),(-0.426, 0.5021, -0.6254),(-0.0733, 0.5182, 0.0308),(-0.4223, 0.4884, 0.6105),(-0.8677, 0.4713, 0.8343),(-1.375, 0.4535, 0.6213),(-1.727, 0.4516, 0.0325),(-0.9079, 0.6893, 0.0114)]

IndexedFaceSet180.coord = Coordinate181
TextureCoordinate182 = x3d.TextureCoordinate()
TextureCoordinate182.point = [(0.5737, 0.0472),(0.5721, 0.0377),(0.5736, 0.0597),(0.5731, 0.073),(0.5718, 0.0836),(0.5723, 0.094),(0.575, 0.1083),(0.5737, 0.0301),(0.4707, 0.0481),(0.4699, 0.0424),(0.4736, 0.058),(0.4725, 0.0633),(0.4717, 0.0706),(0.4698, 0.0802),(0.4664, 0.0886),(0.4716, 0.0358),(0.464, 0.0502),(0.4625, 0.0465),(0.4669, 0.0583),(0.4661, 0.0627),(0.4549, 0.0769),(0.4607, 0.0728),(0.4621, 0.0416),(0.4652, 0.068),(0.4552, 0.0578),(0.5782, 0.0137),(0.4685, 0.027),(0.4561, 0.0381),(0.5222, 0.0476),(0.521, 0.04),(0.5236, 0.0589),(0.5228, 0.0682),(0.5218, 0.0771),(0.521, 0.0871),(0.5207, 0.0985),(0.5234, 0.0203),(0.5227, 0.0329),(0.5721, 0.0377),(0.5731, 0.073),(0.5718, 0.0836),(0.5723, 0.094),(0.5737, 0.0472),(0.5736, 0.0597),(0.5782, 0.0137),(0.575, 0.1083),(0.5737, 0.0301),(0.5737, 0.0472),(0.5721, 0.0377),(0.5737, 0.0301),(0.5782, 0.0137),(0.5723, 0.094),(0.5718, 0.0836),(0.5731, 0.073),(0.5736, 0.0597),(0.5735, 0.0549)]
...
HAnimJoint183.center = [-6.934,33.959999,-1.108]
...
Transform185.translation = [-6.934,33.959999,-1.108]
Shape186 = x3d.Shape()
...
HAnimJoint193.center = [0,35.310001,-2.314]
...
Transform195.translation = [0,35.310001,-2.314]
Shape196 = x3d.Shape()
...
HAnimJoint203.center = [0,35.310001,-2.314]
...
Transform205.translation = [0,35.310001,-2.314]
Shape206 = x3d.Shape()
...
EXPORT231.AS = "KoreanCharacter10Mi"
EXPORT231.localDEF = "hanim_Mi"

Scene21.children.append(EXPORT231)

X3D0.Scene = Scene21
f = open("../data/KoreanCharacter10Mi.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../data/KoreanCharacter10Mi.new.python.x3dv", mode="w", encoding="utf-8")
f.write(X3D0.VRML())
f.close()
f = open("../data/KoreanCharacter10Mi.new.python.x3dj", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

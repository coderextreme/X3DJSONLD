...
ImageTexture18.setUrl(["../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_left.png"])
...
ImageTexture19.setUrl(["../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_right.png"])
...
ImageTexture20.setUrl(["../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_front.png"])
...
ImageTexture21.setUrl(["../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_back.png"])
...
ImageTexture22.setUrl(["../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_top.png"])
...
ImageTexture23.setUrl(["../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"])
...
ImageTexture29.setUrl(["../resources/images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_back.png"])

ComposedCubeMapTexture28.setBackTexture(ImageTexture29)
ImageTexture30 = x3d.ImageTexture()
ImageTexture30.setDEF("bottomShader")
ImageTexture30.setUrl(["../resources/images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"])

ComposedCubeMapTexture28.setBottomTexture(ImageTexture30)
ImageTexture31 = x3d.ImageTexture()
ImageTexture31.setDEF("frontShader")
ImageTexture31.setUrl(["../resources/images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_front.png"])

ComposedCubeMapTexture28.setFrontTexture(ImageTexture31)
ImageTexture32 = x3d.ImageTexture()
ImageTexture32.setDEF("leftShader")
ImageTexture32.setUrl(["../resources/images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_left.png"])

ComposedCubeMapTexture28.setLeftTexture(ImageTexture32)
ImageTexture33 = x3d.ImageTexture()
ImageTexture33.setDEF("rightShader")
ImageTexture33.setUrl(["../resources/images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_right.png"])

ComposedCubeMapTexture28.setRightTexture(ImageTexture33)
ImageTexture34 = x3d.ImageTexture()
ImageTexture34.setDEF("topShader")
ImageTexture34.setUrl(["../resources/images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/src/main/resources/images/all_probes/beach_cross/beach_top.png"])
...
X3D0.toFileX3D("../data/mirror.new.python.x3d")
X3D0.toFileJSON("../data/mirror.new.python.json")

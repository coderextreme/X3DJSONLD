...
Transform18.setTranslation([0,2.1,0])
Shape19 = x3d.Shape()
...
Material22.setDiffuseColor([0,0,0.8])
...
Transform23.setTranslation([0,2.05,0])
Shape24 = x3d.Shape()
...
ColorRGBA26.setColor([1,1,0,1,1,1,0,0.1])

LineSet25.setColor(ColorRGBA26)
Coordinate27 = x3d.Coordinate()
Coordinate27.setPoint([-0.05,0,0,0.05,0,0])
...
Scene10.addChildren(NavigationInfo28)
Viewpoint29 = x3d.Viewpoint()
Viewpoint29.setDescription("default")

Scene10.addChildren(Viewpoint29)

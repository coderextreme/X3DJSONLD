...
#comment #4
          ...
          meta(name="title", content="Quotes.x3d"),
          ...
          meta(name="reference", content="X3dValidator https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/HelloWorldProgramOutput.x3d"),
          ...
          meta(name="translated", content="30 April 2018"),
...
#presence of follow-on TouchSensor shows that additional nodes are allowed in ProtoBody after initial node, regardless of node types
        ...
        Shape(
          DEF="TestShape2", appearance=Appearance(
              DEF="TestAppearance2", children=[#ArtDeco02Material prototype goes here... TODO ensure setContainerField is handled in exported Java
                  ...
                  name="ArtDeco02Material", DEF="ArtDeco02MaterialDEF", children=[#[HelloWorldProgram diagnostic] ArtDeco02ProtoInstance.getNodeType()="ERROR_UNKNOWN_EXTERNPROTODECLARE_NODE_TYPE: ExternProtoDeclare name='ArtDeco02Material' type cannot be remotely accessed at run time, TODO X3DJSAIL needs to add further capability."
], fieldValue=[
        ...
        Shape(
          DEF="TestShape3", appearance=Appearance(
              DEF="TestAppearance3", children=[#ArtDeco02Material ProtoInstance USE goes here...
], material=ProtoInstance(
                  USE="ArtDeco02MaterialDEF")), geometry=Cylinder(
              height=0.001, radius=0.001)),
        Inline(
          DEF="inlineSceneDef", url=["someOtherScene.x3d"]),
        IMPORT(

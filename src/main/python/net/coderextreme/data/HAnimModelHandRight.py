...
HAnimHumanoid26 = x3d.HAnimHumanoid(DEF="hanim_Hand_Right")
...
HAnimJoint30 = x3d.HAnimJoint(DEF="hanim_r_radiocarpal")
...
HAnimSegment31 = x3d.HAnimSegment(DEF="hanim_r_carpal")
...
IndexedLineSet71 = x3d.IndexedLineSet(DEF="CMC1toMCP1xxx")
...
HAnimJoint73 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_1")
HAnimJoint73.name = "r_metacarpophalangeal_1"
HAnimJoint73.center = [-0.3,0.3,0]
HAnimJoint73.ulimit = [0,0,0]
HAnimJoint73.llimit = [0,0,0]
HAnimSegment74 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_1")
...
IndexedLineSet80 = x3d.IndexedLineSet(DEF="MCP11toIP1")
...
HAnimJoint82 = x3d.HAnimJoint(DEF="hanim_r_carpal_interphalangeal_1")
...
HAnimSegment83 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_1")
...
IndexedLineSet89 = x3d.IndexedLineSet(DEF="fingertip_r_carpal_interphalangeal_1")
...
IndexedLineSet98 = x3d.IndexedLineSet(DEF="MC12toCMC2")
...
HAnimJoint91.children.append(x3d.Comment("""index finger"""))
HAnimJoint100 = x3d.HAnimJoint(DEF="hanim_r_carpometacarpal_2")
HAnimJoint100.name = "r_carpometacarpal_2"
HAnimJoint100.center = [-0.1,0.2,0]
HAnimJoint100.ulimit = [0,0,0]
HAnimJoint100.llimit = [0,0,0]
HAnimSegment101 = x3d.HAnimSegment(DEF="hanim_r_metacarpal_2")
...
IndexedLineSet107 = x3d.IndexedLineSet(DEF="CMC2toMCP2")
...
HAnimJoint109 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_2")
...
HAnimSegment110 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_2")
...
IndexedLineSet116 = x3d.IndexedLineSet(DEF="MCP2toPIP2")
...
HAnimJoint118 = x3d.HAnimJoint(DEF="hanim_r_carpal_proximal_interphalangeal_2")
...
HAnimSegment119 = x3d.HAnimSegment(DEF="hanim_r_carpal_middle_phalanx_2")
...
IndexedLineSet125 = x3d.IndexedLineSet(DEF="PIP2toDIP2")
...
HAnimJoint127 = x3d.HAnimJoint(DEF="hanim_r_carpal_distal_interphalangeal_2")
...
HAnimSegment128 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_2")
...
IndexedLineSet134 = x3d.IndexedLineSet(DEF="fingertip_r_carpal_distal_interphalangeal_2")
...
IndexedLineSet143 = x3d.IndexedLineSet(DEF="MC3toCMC3")
...
HAnimJoint136.children.append(x3d.Comment("""Middle fingle"""))
HAnimJoint145 = x3d.HAnimJoint(DEF="hanim_r_carpometacarpal_3")
HAnimJoint145.name = "r_carpometacarpal_3"
HAnimJoint145.center = [0,0.2,0]
HAnimJoint145.ulimit = [0,0,0]
HAnimJoint145.llimit = [0,0,0]
HAnimSegment146 = x3d.HAnimSegment(DEF="hanim_r_metacarpal_3")
...
IndexedLineSet152 = x3d.IndexedLineSet(DEF="CMC3toMCP3")
...
HAnimJoint154 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_3")
...
HAnimSegment155 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_3")
...
IndexedLineSet161 = x3d.IndexedLineSet(DEF="MCP3toPIP3")
...
HAnimJoint163 = x3d.HAnimJoint(DEF="hanim_r_carpal_proximal_interphalangeal_3")
...
HAnimSegment164 = x3d.HAnimSegment(DEF="hanim_r_carpal_middle_phalanx_3")
...
IndexedLineSet170 = x3d.IndexedLineSet(DEF="PIP3toDIP3")
...
HAnimJoint172 = x3d.HAnimJoint(DEF="hanim_r_carpal_distal_interphalangeal_3")
...
HAnimSegment173 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_3")
...
IndexedLineSet179 = x3d.IndexedLineSet(DEF="fingertip_r_carpal_distal_interphalangeal_3")
...
IndexedLineSet188 = x3d.IndexedLineSet(DEF="MC45toCMC4")
...
IndexedLineSet193 = x3d.IndexedLineSet(DEF="MC45toCMC5")
...
HAnimJoint181.children.append(x3d.Comment("""ring finger"""))
HAnimJoint195 = x3d.HAnimJoint(DEF="hanim_r_carpometacarpal_4")
HAnimJoint195.name = "r_carpometacarpal_4"
HAnimJoint195.center = [0.1,0.2,0]
HAnimJoint195.ulimit = [0,0,0]
HAnimJoint195.llimit = [0,0,0]
HAnimSegment196 = x3d.HAnimSegment(DEF="hanim_r_metacarpal_4")
...
IndexedLineSet202 = x3d.IndexedLineSet(DEF="CMC4toMCP4")
...
HAnimJoint204 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_4")
...
HAnimSegment205 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_4")
...
IndexedLineSet211 = x3d.IndexedLineSet(DEF="MCP4toPIP4")
...
HAnimJoint213 = x3d.HAnimJoint(DEF="hanim_r_carpal_proximal_interphalangeal_4")
...
HAnimSegment214 = x3d.HAnimSegment(DEF="hanim_r_carpal_middle_phalanx_4")
...
IndexedLineSet220 = x3d.IndexedLineSet(DEF="PIP4toDIP4")
...
HAnimJoint222 = x3d.HAnimJoint(DEF="hanim_r_carpal_distal_interphalangeal_4")
...
HAnimSegment223 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_4")
...
IndexedLineSet229 = x3d.IndexedLineSet(DEF="fingertip_r_carpal_distal_interphalangeal_4")
...
HAnimJoint181.children.append(x3d.Comment("""pinky finger"""))
HAnimJoint231 = x3d.HAnimJoint(DEF="hanim_r_carpometacarpal_5")
...
HAnimSegment232 = x3d.HAnimSegment(DEF="hanim_r_metacarpal_5")
...
IndexedLineSet238 = x3d.IndexedLineSet(DEF="CMC5toMCP5")
...
HAnimJoint240 = x3d.HAnimJoint(DEF="hanim_r_metacarpophalangeal_5")
...
HAnimSegment241 = x3d.HAnimSegment(DEF="hanim_r_carpal_proximal_phalanx_5")
...
IndexedLineSet247 = x3d.IndexedLineSet(DEF="MCP5toPIP5")
...
HAnimJoint249 = x3d.HAnimJoint(DEF="hanim_r_carpal_proximal_interphalangeal_5")
...
HAnimSegment250 = x3d.HAnimSegment(DEF="hanim_r_carpal_middle_phalanx_5")
...
IndexedLineSet256 = x3d.IndexedLineSet(DEF="PIP5toDIP5")
...
HAnimJoint258 = x3d.HAnimJoint(DEF="hanim_r_carpal_distal_interphalangeal_5")
...
HAnimSegment259 = x3d.HAnimSegment(DEF="hanim_r_carpal_distal_phalanx_5")
...
IndexedLineSet265 = x3d.IndexedLineSet(DEF="fingertip_r_carpal_distal_interphalangeal_5")
...
HAnimJoint267 = x3d.HAnimJoint(USE="hanim_humanoid_root")

HAnimHumanoid26.joints.append(HAnimJoint267)
HAnimJoint268 = x3d.HAnimJoint(USE="hanim_r_carpal_distal_interphalangeal_2")

HAnimHumanoid26.joints.append(HAnimJoint268)
HAnimJoint269 = x3d.HAnimJoint(USE="hanim_r_carpal_distal_interphalangeal_3")

HAnimHumanoid26.joints.append(HAnimJoint269)
HAnimJoint270 = x3d.HAnimJoint(USE="hanim_r_carpal_distal_interphalangeal_4")

HAnimHumanoid26.joints.append(HAnimJoint270)
HAnimJoint271 = x3d.HAnimJoint(USE="hanim_r_carpal_distal_interphalangeal_5")

HAnimHumanoid26.joints.append(HAnimJoint271)
HAnimJoint272 = x3d.HAnimJoint(USE="hanim_r_carpal_interphalangeal_1")

HAnimHumanoid26.joints.append(HAnimJoint272)
HAnimJoint273 = x3d.HAnimJoint(USE="hanim_r_carpal_proximal_interphalangeal_2")

HAnimHumanoid26.joints.append(HAnimJoint273)
HAnimJoint274 = x3d.HAnimJoint(USE="hanim_r_carpal_proximal_interphalangeal_3")

HAnimHumanoid26.joints.append(HAnimJoint274)
HAnimJoint275 = x3d.HAnimJoint(USE="hanim_r_carpal_proximal_interphalangeal_4")

HAnimHumanoid26.joints.append(HAnimJoint275)
HAnimJoint276 = x3d.HAnimJoint(USE="hanim_r_carpal_proximal_interphalangeal_5")

HAnimHumanoid26.joints.append(HAnimJoint276)
HAnimJoint277 = x3d.HAnimJoint(USE="hanim_r_carpometacarpal_1")

HAnimHumanoid26.joints.append(HAnimJoint277)
HAnimJoint278 = x3d.HAnimJoint(USE="hanim_r_carpometacarpal_2")

HAnimHumanoid26.joints.append(HAnimJoint278)
HAnimJoint279 = x3d.HAnimJoint(USE="hanim_r_carpometacarpal_3")

HAnimHumanoid26.joints.append(HAnimJoint279)
HAnimJoint280 = x3d.HAnimJoint(USE="hanim_r_carpometacarpal_4")

HAnimHumanoid26.joints.append(HAnimJoint280)
HAnimJoint281 = x3d.HAnimJoint(USE="hanim_r_carpometacarpal_5")

HAnimHumanoid26.joints.append(HAnimJoint281)
HAnimJoint282 = x3d.HAnimJoint(USE="hanim_r_metacarpophalangeal_1")

HAnimHumanoid26.joints.append(HAnimJoint282)
HAnimJoint283 = x3d.HAnimJoint(USE="hanim_r_metacarpophalangeal_2")

HAnimHumanoid26.joints.append(HAnimJoint283)
HAnimJoint284 = x3d.HAnimJoint(USE="hanim_r_metacarpophalangeal_3")

HAnimHumanoid26.joints.append(HAnimJoint284)
HAnimJoint285 = x3d.HAnimJoint(USE="hanim_r_metacarpophalangeal_4")

HAnimHumanoid26.joints.append(HAnimJoint285)
HAnimJoint286 = x3d.HAnimJoint(USE="hanim_r_metacarpophalangeal_5")

HAnimHumanoid26.joints.append(HAnimJoint286)
HAnimJoint287 = x3d.HAnimJoint(USE="hanim_r_midcarpal_1")

HAnimHumanoid26.joints.append(HAnimJoint287)
HAnimJoint288 = x3d.HAnimJoint(USE="hanim_r_midcarpal_2")

HAnimHumanoid26.joints.append(HAnimJoint288)
HAnimJoint289 = x3d.HAnimJoint(USE="hanim_r_midcarpal_3")

HAnimHumanoid26.joints.append(HAnimJoint289)
HAnimJoint290 = x3d.HAnimJoint(USE="hanim_r_midcarpal_4_5")

HAnimHumanoid26.joints.append(HAnimJoint290)
HAnimJoint291 = x3d.HAnimJoint(USE="hanim_r_radiocarpal")

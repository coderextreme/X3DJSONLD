...
Material16.setDiffuseColor(x3d.doubleToFloat([0.3,0.3,0.5]))
Material16.setShininess(0.1)
Material16.setSpecularColor(x3d.doubleToFloat([0.7,0.7,0.8]))
...
Transform18.setTranslation(x3d.doubleToFloat([0,0.35,0]))
Shape19 = x3d.Shape()
...
Transform23.setTranslation(x3d.doubleToFloat([0,-0.35,0]))
Shape24 = x3d.Shape()
...
Material26.setDiffuseColor(x3d.doubleToFloat([0,0,0]))
...
Transform30.setTranslation(x3d.doubleToFloat([0,0.45,0]))
Shape31 = x3d.Shape()
...
Material33.setDiffuseColor(x3d.doubleToFloat([0.91,0.91,0.91]))
Material33.setShininess(0.16)
Material33.setSpecularColor(x3d.doubleToFloat([0.91,0.9,0.91]))
...
Transform35.setTranslation(x3d.doubleToFloat([0,0.5,0]))
Shape36 = x3d.Shape()
...
Transform40.setRotation(x3d.doubleToFloat([0,0,1,1.57]))
Transform40.setTranslation(x3d.doubleToFloat([-0.028,0.462,0]))
...
Transform46.setTranslation(x3d.doubleToFloat([0,0.02,0]))
Shape47 = x3d.Shape()
...
Transform51.setTranslation(x3d.doubleToFloat([0,0.2,0]))
Shape52 = x3d.Shape()
...
Background56.setSkyColor(x3d.doubleToFloat([0.6,0.6,0.6]))

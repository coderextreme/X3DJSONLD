...
Scene4.children.append(x3d.Comment("""Menu prototype declaration"""))
...
Group10 = x3d.Group()
Transform11 = x3d.Transform(DEF="TextMenuTransform")
Transform11.translation = [48,27,0]
TouchSensor12 = x3d.TouchSensor(DEF="MenuTouchSensor")
...
IndexedFaceSet23 = x3d.IndexedFaceSet(DEF="Backing")
...
Group10.children.append(x3d.Comment("""ROUTEs to connect everything"""))
ROUTE66 = x3d.ROUTE()
...
ProtoInstance68 = x3d.ProtoInstance(DEF="MainMenu")

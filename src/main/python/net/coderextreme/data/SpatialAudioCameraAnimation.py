...
Viewpoint18 = x3d.Viewpoint(DEF="Camera001")
...
TimeSensor19 = x3d.TimeSensor(DEF="TIMER")
TimeSensor19.cycleInterval = 33.333332
TimeSensor19.loop = True

Scene14.children.append(TimeSensor19)
PositionInterpolator20 = x3d.PositionInterpolator(DEF="Camera001-POS-INTERP")
...
OrientationInterpolator21 = x3d.OrientationInterpolator(DEF="Camera001-ROT-INTERP")
...
Transform26 = x3d.Transform(DEF="Floor")
Transform26.translation = [1.241,0,0.358]
Shape27 = x3d.Shape()
Appearance28 = x3d.Appearance(DEF="WireColor")
...
Transform31 = x3d.Transform(DEF="TransformAudio1")
Transform31.translation = [-933.123474,0,-926.253235]
Shape32 = x3d.Shape()
Appearance33 = x3d.Appearance(DEF="WireColor_1")
...
Transform37 = x3d.Transform(DEF="violin")
...
FontStyle42 = x3d.FontStyle(DEF="ModelFontStyle")
...
Transform43 = x3d.Transform(DEF="TransformAudio2")
Transform43.translation = [933.475586,0,924.423218]
Shape44 = x3d.Shape()
Appearance45 = x3d.Appearance(DEF="WireColor_2")
...
Transform49 = x3d.Transform(DEF="saxophone")
...
FontStyle54 = x3d.FontStyle(USE="ModelFontStyle")
...
SpatialSound57 = x3d.SpatialSound(DEF="Audio1")
Gain58 = x3d.Gain()
...
SpatialSound60 = x3d.SpatialSound(DEF="Audio2")
Gain61 = x3d.Gain()

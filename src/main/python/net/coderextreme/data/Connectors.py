...
Material52.setDiffuseColor([0,0,0])
IS53 = x3d.IS()
...
Scene9.addChildren(ProtoDeclare29)
...
Transform69.setTranslation([-1,0,0])
...
Transform74.setTranslation([1,0,0])
...
ProtoBody58.addChildren(ROUTE87)

ProtoDeclare55.setProtoBody(ProtoBody58)

Scene9.addChildren(ProtoDeclare55)
...
Material100.setDiffuseColor([0,0,0])
IS101 = x3d.IS()
...
Coordinate104.setPoint([-1,0,0,1,0,0])
...
Scene9.addChildren(ProtoDeclare88)
NavigationInfo117 = x3d.NavigationInfo()
NavigationInfo117.setType([", ","PLANE_create3000.deANY"])

Scene9.addChildren(NavigationInfo117)
Background118 = x3d.Background()
Background118.setSkyColor([0.2,0.2,0.2])

Scene9.addChildren(Background118)
OrthoViewpoint119 = x3d.OrthoViewpoint()
OrthoViewpoint119.setDescription("OthoViewpoint")
OrthoViewpoint119.setPosition([-3.13496,-4.19776,10])
OrthoViewpoint119.setCenterOfRotation([-3.13496,-4.19776,0])
OrthoViewpoint119.setFieldOfView([0,0,10,10])

Scene9.addChildren(OrthoViewpoint119)
Viewpoint120 = x3d.Viewpoint()
Viewpoint120.setDescription("Viewpoint")

Scene9.addChildren(Viewpoint120)
...
Scene9.addChildren(Transform121)

X3D0.setScene(Scene9)
X3D0.toFileX3D("../data/Connectors.new.python.x3d")
X3D0.toFileJSON("../data/Connectors.new.python.json")

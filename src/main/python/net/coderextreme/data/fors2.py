...
Transform16.IS = IS17
Shape19 = x3d.Shape()
Shape19.children.append(x3d.Comment("""comment before Sphere"""))
Shape19.children.append(x3d.Comment("""comment after Sphere"""))
Shape19.children.append(x3d.Comment("""comment after Appearance"""))
Sphere20 = x3d.Sphere()

Shape19.geometry = Sphere20
Appearance21 = x3d.Appearance()
Appearance21.children.append(x3d.Comment("""comment before Material"""))
Appearance21.children.append(x3d.Comment("""comment after Material"""))
...
PositionInterpolator23 = x3d.PositionInterpolator(DEF="NodePosition")
PositionInterpolator23.key = [0,1]
PositionInterpolator23.keyValue = [(0, 0, 0),(0, 5, 0)]

Group15.children.append(PositionInterpolator23)
Script24 = x3d.Script(DEF="MoveBall")
field25 = x3d.field()
...
TimeSensor29 = x3d.TimeSensor(DEF="nodeClock")
...
Group39 = x3d.Group()
Shape40 = x3d.Shape()
Extrusion41 = x3d.Extrusion(DEF="extrusion")
Extrusion41.creaseAngle = 0.785
Extrusion41.crossSection = [(1, 0),(0.92, -0.38),(0.71, -0.71),(0.38, -0.92),(0, -1),(-0.38, -0.92),(-0.71, -0.71),(-0.92, -0.38),(-1, 0),(-0.92, 0.38),(-0.71, 0.71),(-0.38, 0.92),(0, 1),(0.38, 0.92),(0.71, 0.71),(0.92, 0.38),(1, 0)]
Extrusion41.spine = [(0, -50, 0),(0, 0, 0),(0, 50, 0)]
...
Script44 = x3d.Script(DEF="MoveCylinder")
field45 = x3d.field()
field45.name = "spine"
...
ProtoInstance53 = x3d.ProtoInstance(DEF="nodeA")
...
ProtoInstance55 = x3d.ProtoInstance(DEF="nodeB")
...
ProtoInstance57 = x3d.ProtoInstance(DEF="linkA")

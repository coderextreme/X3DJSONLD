...
Pymeta(name="modified", content="April 18 2017"),
Pymeta(name="title", content="fors2.x3d"),
Pymeta(name="identifier", content="https://coderextreme.net/X3DJSONLD/src/main/data/fors2.x3d"),
...
ProtoInterface=PyProtoInterface(field=[Pyfield(name="positionA", accessType="inputOnly", type="SFVec3f"),
Pyfield(name="positionB", accessType="inputOnly", type="SFVec3f")
]), 
ProtoBody=PyProtoBody(children=[
Shape(
geometry=
...
Script(DEF="MoveCylinder", field=[Pyfield(name="spine", accessType="inputOutput", type="MFVec3f", value=[(0,-50,0),(0,0,0),(0,50,0)]),
Pyfield(name="set_endA", accessType="inputOnly", type="SFVec3f"),
Pyfield(name="set_endB", accessType="inputOnly", type="SFVec3f")
], 
IS=PyIS(connect=[Pyconnect(nodeField="set_endA", protoField="positionA"),
Pyconnect(nodeField="set_endB", protoField="positionB")
...
ProtoInstance(name="node", DEF="nodeA", fieldValue=[PyfieldValue(name="position", value=[-50,-50,-50])
]),
ProtoInstance(name="node", DEF="nodeB", fieldValue=[PyfieldValue(name="position", value=[50,50,50])
]),
ProtoInstance(name="cyl", DEF="linkA", fieldValue=[PyfieldValue(name="positionA", value=[0,0,0]),
PyfieldValue(name="positionB", value=[50,50,50])
])]),

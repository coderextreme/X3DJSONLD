...
Material74.diffuseColor = [0.7,0.7,0.7]
Material74.specularColor = [0.5,0.5,0.5]
...
ImageTexture76.url = ["../resources/images/all_probes/stpeters_cross/stpeters_back.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"]

ComposedCubeMapTexture75.backTexture = ImageTexture76
ImageTexture77 = x3d.ImageTexture()
ImageTexture77.url = ["../resources/images/all_probes/stpeters_cross/stpeters_bottom.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"]

ComposedCubeMapTexture75.bottomTexture = ImageTexture77
ImageTexture78 = x3d.ImageTexture()
ImageTexture78.url = ["../resources/images/all_probes/stpeters_cross/stpeters_front.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"]

ComposedCubeMapTexture75.frontTexture = ImageTexture78
ImageTexture79 = x3d.ImageTexture()
ImageTexture79.url = ["../resources/images/all_probes/stpeters_cross/stpeters_left.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"]

ComposedCubeMapTexture75.leftTexture = ImageTexture79
ImageTexture80 = x3d.ImageTexture()
ImageTexture80.url = ["../resources/images/all_probes/stpeters_cross/stpeters_right.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"]

ComposedCubeMapTexture75.rightTexture = ImageTexture80
ImageTexture81 = x3d.ImageTexture()
ImageTexture81.url = ["../resources/images/all_probes/stpeters_cross/stpeters_top.png","https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"]
...
ComposedShader82.field.append(field83)
field84 = x3d.field()
...
ComposedShader82.field.append(field84)
field85 = x3d.field()
field85.name = "bias"
...
ComposedShader82.field.append(field85)
field86 = x3d.field()
field86.name = "scale"
...
ComposedShader82.field.append(field86)
field87 = x3d.field()
field87.name = "power"
...
ComposedShader82.field.append(field87)
field88 = x3d.field()
field88.name = "a"
...
ComposedShader82.field.append(field88)
field89 = x3d.field()
field89.name = "b"
...
ComposedShader82.field.append(field89)
field90 = x3d.field()
field90.name = "c"
...
ComposedShader82.field.append(field90)
field91 = x3d.field()
field91.name = "d"
...
ComposedShader82.field.append(field91)
field92 = x3d.field()
field92.name = "tdelta"
...
ComposedShader82.field.append(field92)
field93 = x3d.field()
field93.name = "pdelta"
...
ComposedShader82.field.append(field93)
ShaderPart94 = x3d.ShaderPart()
ShaderPart94.url = ["../shaders/freewrl_flowers_chromatic.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs"]
ShaderPart94.type = "VERTEX"

ComposedShader82.parts.append(ShaderPart94)
ShaderPart95 = x3d.ShaderPart()
ShaderPart95.url = ["../shaders/freewrl_bubbles.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_bubbles.fs"]
ShaderPart95.type = "FRAGMENT"

ComposedShader82.parts.append(ShaderPart95)

Appearance73.shaders.append(ComposedShader82)

Shape71.appearance = Appearance73

Transform69.children.append(Shape71)
...
DISEntityTypeMapping97.url = ["../data/Leif8Final.x3d","https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3d"]

DISEntityManager96.children.append(DISEntityTypeMapping97)
DISEntityTypeMapping98 = x3d.DISEntityTypeMapping()
DISEntityTypeMapping98.category = 77
DISEntityTypeMapping98.specific = 2
DISEntityTypeMapping98.url = ["../data/Lily8Final.x3d","https://coderextreme.net/X3DJSONLD/src/main/data/Lily8Final.x3d"]

DISEntityManager96.children.append(DISEntityTypeMapping98)
DISEntityTypeMapping99 = x3d.DISEntityTypeMapping()
DISEntityTypeMapping99.category = 77
DISEntityTypeMapping99.specific = 3
DISEntityTypeMapping99.url = ["../data/Tufani8Final.x3d","https://coderextreme.net/X3DJSONLD/src/main/data/Tufani8Final.x3d"]

DISEntityManager96.children.append(DISEntityTypeMapping99)
DISEntityTypeMapping100 = x3d.DISEntityTypeMapping()
DISEntityTypeMapping100.category = 77
DISEntityTypeMapping100.specific = 4
DISEntityTypeMapping100.url = ["../data/Gramps8Final.x3d","https://coderextreme.net/X3DJSONLD/src/main/data/Gramps8Final.x3d"]

DISEntityManager96.children.append(DISEntityTypeMapping100)

Layer33.children.append(DISEntityManager96)
...
Script224.sourceCode = '''ecmascript: function newTranslation(Value) { aValue = Value.x * 30; }'''
...
Script227.sourceCode = '''ecmascript: function newTranslation(Value) { bValue = Value.x * 30; }'''
...
Script230.sourceCode = '''ecmascript: function newTranslation(Value) { cValue = Value.x * 5; }'''
...
Script233.sourceCode = '''ecmascript: function newTranslation(Value) { dValue = Value.x * 5; }'''
...
Script236.sourceCode = '''ecmascript: function newTranslation(Value) { pdeltaValue = Value.x; }'''
...
Script239.sourceCode = '''ecmascript: function newTranslation(Value) { tdeltaValue = Value.x; }'''
...
f.write(X3D0.XML())
f.close()
f = open("../data/bumpyfreewrlsliders.new.python.json", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

...
X3D(
  profile="Immersive", version="3.3", head=head(  children=[
          ...
          meta(name="title", content="StringArrayEncodingExamples.x3d"),
    ...
    children=[
        Viewpoint(
          DEF="EntryView", description="Hello MFString syntax"),
        Background(
          skyColor=(0.6,1,0.8)),
        Shape(
          geometry=Text(
              string=["One, Two, Three","","He said, \"Immel did it!\""], children=[#alternative XML encoding: Text string='"One, Two, Three" "" "He said, \&quot;Immel did it!\&quot;"'
#alternative Java source: .setString(new String [] {"One, Two, Three", "", "He said, \""Immel did it!\"""})
], fontStyle=FontStyle(
                  justify=["MIDDLE","MIDDLE"], style="BOLD")), appearance=Appearance(
              material=Material(

...
head=head(children=[meta(name="title", content="HeadsUpDisplayExample.x3d"),
...
Comment(value=''' ProtoDeclare is the "cookie cutter" template, ProtoInstance creates an actual occurrence '''),

...
meta3.setContent("LOA3ExampleSourceInVRML.wrl")
...
WorldInfo1300.setTitle("HANIM 200x Default Joint Centers, LOA&#8209;3")
...
X3D0.toFileX3D("../data/LOA3ExampleSourceInVRML_RoundTrip.x3d")

...
WorldInfo21.title = "KoreanCharacter04Young.x3d"
...
Viewpoint23.description = "Young"
Viewpoint23.position = [0,1,3]

Scene20.children.append(Viewpoint23)
HAnimHumanoid24 = x3d.HAnimHumanoid(DEF="hanim_Young")
HAnimHumanoid24.name = "Young"
...
HAnimJoint32.center = [0,31.540001,-0.3172]
...
Transform34.translation = [0,31.540001,-0.3172]
Shape35 = x3d.Shape()
...
ImageTexture38 = x3d.ImageTexture(DEF="YoungTextureAtlas")
ImageTexture38.url = ["images/Young.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Young.png"]
...
HAnimJoint42.center = [3.504,29.040001,-0.4027]
...
Transform44.translation = [3.504,29.040001,-0.4027]
Shape45 = x3d.Shape()
...
HAnimJoint52.center = [3.414,14.95,-0.4549]
...
Transform54.translation = [3.414,14.95,-0.4549]
Shape55 = x3d.Shape()
...
ImageTexture58 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
Coordinate60.point = [(0.6335, 1.142, 0.0206),(0.3202, 1.142, 0.8245),(-0.3837, 1.142, 0.9871),(-0.9483, 1.142, 0.5315),(-0.9483, 1.142, -0.3447),(-0.3837, 1.142, -0.8003),(0.3202, 1.142, -0.6377),(2.06, -3.778, 0.0206),(1.287, -2.905, 1.78),(1.089, -1.147, 2.133),(1.867, -1.397, 0.0206),(-0.715, -2.905, 2.263),(-0.6583, -1.147, 2.559),(-1.987, -3.778, 1.106),(-2.06, -1.397, 0.8632),(-1.987, -4.457, -1.205),(-2.06, -1.397, -0.822),(-0.715, -4.457, -2.559),(-0.6583, -1.397, -2.087),(1.287, -4.457, -2.076),(1.089, -1.397, -1.661),(0.9877, 0.2851, 1.672),(1.704, 0.2851, 0.0206),(-0.622, 0.2851, 2.043),(-1.913, 0.2851, 1.002),(-1.913, 0.2851, -0.8149),(-0.622, 0.2851, -1.817),(0.9877, 0.2851, -1.445),(1.417, -11.1, 0.0028),(0.8123, -11.09, 1.38),(-0.5457, -11.09, 1.72),(-1.635, -11.1, 0.767),(-1.635, -11.11, -0.8605),(-0.5457, -11.11, -1.535),(0.8123, -11.11, -1.195),(0.6234, -12.52, 0.021),(0.3177, -12.52, 0.7175),(-0.3691, -12.52, 0.8896),(-0.9199, -12.52, 0.4076),(-0.9199, -12.53, -0.4156),(-0.3691, -12.53, -0.7569),(0.3177, -12.53, -0.5849)]
...
HAnimJoint62.center = [3.18,3.449,-0.3088]
...
Transform64.translation = [3.18,3.449,-0.3088]
Shape65 = x3d.Shape()
...
ImageTexture68 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
HAnimJoint72.center = [3.18,3.189,0.9724]
...
Transform74.translation = [3.18,3.189,0.9724]
Shape75 = x3d.Shape()
...
ImageTexture78 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
IndexedFaceSet79.texCoordIndex = [4,5,12,-1,4,12,13,-1,0,4,13,-1,1,0,13,-1,13,14,1,-1,1,14,19,-1,19,3,1,-1,2,21,12,-1,12,5,2,-1,15,10,7,-1,16,15,7,-1,6,16,7,-1,8,17,16,-1,16,6,8,-1,8,11,18,-1,18,17,8,-1,9,10,15,-1,15,20,9,-1,24,25,26,-1,24,26,27,-1,24,27,28,-1,23,24,28,-1,23,28,22,-1,0,1,23,-1,23,22,0,-1,1,3,24,-1,24,23,1,-1,11,8,25,-1,25,24,11,-1,8,6,26,-1,26,25,8,-1,6,7,27,-1,27,26,6,-1,7,4,28,-1,28,27,7,-1,4,0,22,-1,22,28,4,-1,7,10,9,-1,4,7,9,-1,5,4,9,-1,30,32,31,-1,31,29,30,-1,33,34,32,-1,32,30,33,-1,34,33,35,-1,31,32,37,-1,37,36,31,-1,37,32,34,-1,34,38,37,-1,38,34,35,-1,35,39,38,-1,40,29,31,-1,31,36,40,-1,41,44,43,-1,43,42,41,-1,45,41,42,-1,42,46,45,-1,46,50,45,-1,43,47,48,-1,48,42,43,-1,48,49,46,-1,46,42,48,-1,49,51,50,-1,50,46,49,-1,52,47,43,-1,43,44,52,-1]
Coordinate80 = x3d.Coordinate()
Coordinate80.point = [(2.548, -1.416, -0.8988),(1.819, -3.176, -0.8988),(0, 0.2435, 0.2718),(1.78, -0.2627, -0.8989),(1.476, 0.0025, -0.0134),(-2.548, -1.416, -0.8988),(-1.78, -0.2627, -0.8989),(-1.819, -3.176, -0.8988),(-1.476, 0.0025, -0.0134),(0, -3.176, -0.8988),(1.863, -3.176, 0.8155),(-1.863, -3.176, 0.8155),(0, -3.176, 0.8155),(2.094, -1.441, -1.699),(1.524, -2.561, -1.699),(0, -2.561, -1.699),(-1.524, -2.561, -1.699),(-2.094, -1.441, -1.699),(-1.516, -0.4945, -1.699),(1.516, -0.4945, -1.699),(1.553, -0.5642, 2.069),(1.929, -1.973, 3.676),(1.929, -3.176, 3.35),(0, -1.973, 4.847),(0, -0.4757, 3.505),(1.514, -0.2808, 1.028),(2.316, -1.625, 0.8155),(-1.929, -1.973, 3.676),(-1.553, -0.5642, 2.069),(0, -3.176, 4.521),(-1.929, -3.176, 3.35),(-1.514, -0.2808, 1.028),(-2.316, -1.625, 0.8155),(0, -3.176, 3.35),(0, -0.0239, 1.474)]

IndexedFaceSet79.coord = Coordinate80
TextureCoordinate81 = x3d.TextureCoordinate()
TextureCoordinate81.point = [(0.433, 0.0595),(0.4411, 0.0186),(0.4637, 0.1714),(0.4411, 0.0186),(0.4244, 0.1312),(0.4394, 0.1472),(0.433, 0.0595),(0.4244, 0.1312),(0.4411, 0.0186),(0.4637, 0.1714),(0.4394, 0.1472),(0.4411, 0.0186),(0.464, 0.1246),(0.4607, 0.0558),(0.4904, 0.0166),(0.464, 0.1246),(0.4607, 0.0558),(0.4904, 0.0166),(0.4949, 0.0186),(0.4949, 0.0186),(0.4868, 0.1432),(0.4868, 0.1432),(0.433, 0.0595),(0.4411, 0.0186),(0.4411, 0.0186),(0.4411, 0.0186),(0.433, 0.0595),(0.4244, 0.1312),(0.4244, 0.1312),(0.532, 0.098),(0.5645, 0.0707),(0.4885, 0.102),(0.5026, 0.044),(0.5945, 0.0186),(0.5487, 0.0186),(0.5487, 0.0186),(0.464, 0.1246),(0.4607, 0.0558),(0.4904, 0.0166),(0.4949, 0.0186),(0.4868, 0.1432),(0.5645, 0.0707),(0.5026, 0.044),(0.4885, 0.102),(0.532, 0.098),(0.5945, 0.0186),(0.5487, 0.0186),(0.464, 0.1246),(0.4607, 0.0558),(0.4904, 0.0166),(0.5487, 0.0186),(0.4949, 0.0186),(0.4868, 0.1432)]
...
HAnimJoint82.center = [-3.504,29.040001,-0.4027]
...
Transform84.translation = [-3.504,29.040001,-0.4027]
Shape85 = x3d.Shape()
...
HAnimJoint92.center = [-3.414,14.95,-0.4549]
...
Transform94.translation = [-3.414,14.95,-0.4549]
Shape95 = x3d.Shape()
...
ImageTexture98 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
Coordinate100.point = [(-0.6335, 1.142, 0.0206),(-0.3202, 1.142, 0.8245),(0.3837, 1.142, 0.9871),(0.9483, 1.142, 0.5315),(0.9483, 1.142, -0.3447),(0.3837, 1.142, -0.8003),(-0.3202, 1.142, -0.6377),(-2.06, -3.778, 0.0206),(-1.287, -2.905, 1.78),(-1.089, -1.147, 2.133),(-1.867, -1.397, 0.0206),(0.715, -2.905, 2.263),(0.6583, -1.147, 2.559),(1.987, -3.778, 1.106),(2.06, -1.397, 0.8632),(1.987, -4.457, -1.205),(2.06, -1.397, -0.822),(0.715, -4.457, -2.559),(0.6583, -1.397, -2.087),(-1.287, -4.457, -2.076),(-1.089, -1.397, -1.661),(-0.9877, 0.2851, 1.672),(-1.704, 0.2851, 0.0206),(0.622, 0.2851, 2.043),(1.913, 0.2851, 1.002),(1.913, 0.2851, -0.8149),(0.622, 0.2851, -1.817),(-0.9877, 0.2851, -1.445),(-1.417, -11.1, 0.0028),(-0.8123, -11.09, 1.38),(0.5457, -11.09, 1.72),(1.635, -11.1, 0.767),(1.635, -11.11, -0.8605),(0.5457, -11.11, -1.535),(-0.8123, -11.11, -1.195),(-0.6234, -12.52, 0.021),(-0.3177, -12.52, 0.7175),(0.3691, -12.52, 0.8896),(0.9199, -12.52, 0.4076),(0.9199, -12.53, -0.4156),(0.3691, -12.53, -0.7569),(-0.3177, -12.53, -0.5849)]

IndexedFaceSet99.coord = Coordinate100
TextureCoordinate101 = x3d.TextureCoordinate()
TextureCoordinate101.point = [(0.9309, 0.5848),(0.919, 0.5848),(0.8921, 0.5848),(0.8706, 0.5848),(0.8706, 0.5848),(0.8921, 0.5848),(0.919, 0.5848),(0.9845, 0.5321),(0.955, 0.5475),(0.9491, 0.5599),(0.9788, 0.5571),(0.8787, 0.5475),(0.8825, 0.5599),(0.8302, 0.5321),(0.8291, 0.5571),(0.8302, 0.52),(0.8291, 0.5571),(0.8787, 0.52),(0.8825, 0.5571),(0.955, 0.52),(0.9491, 0.5571),(0.9444, 0.5755),(0.9717, 0.5755),(0.8831, 0.5755),(0.8339, 0.5755),(0.8339, 0.5755),(0.8831, 0.5755),(0.9444, 0.5755),(0.9679, 0.2444),(0.9449, 0.2445),(0.8931, 0.2445),(0.8516, 0.2444),(0.8516, 0.2442),(0.8931, 0.2442),(0.9449, 0.2442),(0.9372, 0.2243),(0.9255, 0.2244),(0.8993, 0.2244),(0.8783, 0.2243),(0.8783, 0.2243),(0.8993, 0.2243),(0.9255, 0.2243)]
...
HAnimJoint102.center = [-3.18,3.449,-0.3088]
...
Transform104.translation = [-3.18,3.449,-0.3088]
Shape105 = x3d.Shape()
...
ImageTexture108 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
Coordinate110.point = [(-0.8503, -0.0167, -1.492),(-1.443, -0.0167, 0.3823),(0, -0.0167, -1.492),(-1.221, 0.6369, 0.3141),(-0.7115, 0.6369, -1.298),(0, 0.6369, -1.298),(0, 0.6368, 1.305),(1.443, -0.0167, 0.3823),(1.221, 0.6369, 0.3141),(0.7115, 0.6369, -1.298),(0.8503, -0.0167, -1.492),(0, -0.0167, 1.553),(-1.476, -0.2577, 1.268),(1.476, -0.2577, 1.268),(-1.226, -1.676, -2.553),(-1.226, -3.436, -1.492),(0, -3.436, -1.492),(-0.965, -0.5229, -1.815),(0, -0.5229, -1.815),(1.226, -1.676, -2.553),(0, -1.676, -2.553),(0.965, -0.5229, -1.815),(1.226, -3.436, -1.492),(-2.548, -1.676, 0.3823),(-1.819, -3.436, 0.3823),(-1.78, -0.5229, 0.3823),(2.548, -1.676, 0.3823),(1.78, -0.5229, 0.3823),(1.819, -3.436, 0.3823),(0, -3.436, 0.3823),(-1.619, -3.302, 1.21),(-2.212, -1.709, 1.21),(2.212, -1.709, 1.21),(1.619, -3.302, 1.21),(0, -3.302, 1.21),(-1.393, -0.8117, 1.248),(1.393, -0.8117, 1.248),(0, -0.573, 1.515)]

IndexedFaceSet109.coord = Coordinate110
TextureCoordinate111 = x3d.TextureCoordinate()
TextureCoordinate111.point = [(0.3819, 0.171),(0.4216, 0.1651),(0.3819, 0.171),(0.4216, 0.1651),(0.3819, 0.171),(0.3819, 0.171),(0.4637, 0.1714),(0.4216, 0.1651),(0.4637, 0.1714),(0.4216, 0.1651),(0.3819, 0.171),(0.3819, 0.171),(0.3819, 0.171),(0.3819, 0.171),(0.4637, 0.1714),(0.4637, 0.1714),(0.3861, 0.1398),(0.4244, 0.1312),(0.4394, 0.1472),(0.3836, 0.1404),(0.3836, 0.1404),(0.3861, 0.1398),(0.4244, 0.1312),(0.4394, 0.1472),(0.4394, 0.1472),(0.4637, 0.1714),(0.4394, 0.1472),(0.3873, 0.0706),(0.3871, 0.0221),(0.3873, 0.0706),(0.3871, 0.0221),(0.3871, 0.0221),(0.3861, 0.1398),(0.3836, 0.1404),(0.3873, 0.0706),(0.3873, 0.0706),(0.3836, 0.1404),(0.3861, 0.1398),(0.3871, 0.0221),(0.3871, 0.0221),(0.3871, 0.0221),(0.433, 0.0595),(0.4411, 0.0186),(0.4244, 0.1312),(0.433, 0.0595),(0.4244, 0.1312),(0.4411, 0.0186),(0.4411, 0.0186),(0.4411, 0.0186),(0.4411, 0.0186),(0.433, 0.0595),(0.4244, 0.1312),(0.4244, 0.1312),(0.433, 0.0595),(0.4411, 0.0186),(0.4411, 0.0186),(0.4244, 0.1312)]
...
HAnimJoint112.center = [-3.18,3.189,0.9724]
...
Transform114.translation = [-3.18,3.189,0.9724]
Shape115 = x3d.Shape()
...
ImageTexture118 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
IndexedFaceSet119.texCoordIndex = [12,5,4,-1,13,12,4,-1,0,13,4,-1,1,14,13,-1,13,0,1,-1,1,3,19,-1,19,14,1,-1,2,5,12,-1,12,21,2,-1,7,10,15,-1,7,15,16,-1,6,7,16,-1,8,6,16,-1,16,17,8,-1,8,17,18,-1,18,11,8,-1,9,20,15,-1,15,10,9,-1,23,22,28,-1,26,25,24,-1,27,26,24,-1,28,27,24,-1,23,28,24,-1,0,22,23,-1,23,1,0,-1,1,23,24,-1,24,3,1,-1,11,24,25,-1,25,8,11,-1,8,25,26,-1,26,6,8,-1,6,26,27,-1,27,7,6,-1,7,27,28,-1,28,4,7,-1,4,28,22,-1,22,0,4,-1,9,10,7,-1,9,7,4,-1,5,9,4,-1,30,29,31,-1,31,32,30,-1,33,30,32,-1,32,34,33,-1,34,35,33,-1,31,36,37,-1,37,32,31,-1,37,38,34,-1,34,32,37,-1,38,39,35,-1,35,34,38,-1,40,36,31,-1,31,29,40,-1,41,42,43,-1,43,44,41,-1,45,46,42,-1,42,41,45,-1,46,45,50,-1,43,42,48,-1,48,47,43,-1,48,42,46,-1,46,49,48,-1,49,46,50,-1,50,51,49,-1,52,44,43,-1,43,47,52,-1]
Coordinate120 = x3d.Coordinate()
Coordinate120.point = [(-2.548, -1.416, -0.8988),(-1.819, -3.176, -0.8988),(0, 0.2435, 0.2718),(-1.78, -0.2627, -0.8989),(-1.476, 0.0025, -0.0134),(2.548, -1.416, -0.8988),(1.78, -0.2627, -0.8989),(1.819, -3.176, -0.8988),(1.476, 0.0025, -0.0134),(0, -3.176, -0.8988),(-1.863, -3.176, 0.8155),(1.863, -3.176, 0.8155),(0, -3.176, 0.8155),(-2.094, -1.441, -1.699),(-1.524, -2.561, -1.699),(0, -2.561, -1.699),(1.524, -2.561, -1.699),(2.094, -1.441, -1.699),(1.516, -0.4945, -1.699),(-1.516, -0.4945, -1.699),(-1.553, -0.5642, 2.069),(-1.929, -1.973, 3.676),(-1.929, -3.176, 3.35),(0, -1.973, 4.847),(0, -0.4757, 3.505),(-1.514, -0.2808, 1.028),(-2.316, -1.625, 0.8155),(1.929, -1.973, 3.676),(1.553, -0.5642, 2.069),(0, -3.176, 4.521),(1.929, -3.176, 3.35),(1.514, -0.2808, 1.028),(2.316, -1.625, 0.8155),(0, -3.176, 3.35),(0, -0.0239, 1.474)]
...
HAnimJoint122.center = [0,27.07,-0.3172]
...
Transform124.translation = [0,27.07,-0.3172]
Shape125 = x3d.Shape()
...
ImageTexture128 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
HAnimJoint132.center = [5.441,45.830002,0.1786]
...
Transform134.translation = [5.441,45.830002,0.1786]
Shape135 = x3d.Shape()
...
ImageTexture138 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
HAnimJoint142.center = [6.823,36.080002,0.08607]
...
Transform144.translation = [6.823,36.080002,0.08607]
Shape145 = x3d.Shape()
...
ImageTexture148 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
HAnimJoint152.center = [6.915,28.41,0.3752]
...
Transform154.translation = [6.915,28.41,0.3752]
Shape155 = x3d.Shape()
...
ImageTexture158 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
HAnimJoint162.center = [-5.441,45.830002,0.1786]
...
Transform164.translation = [-5.441,45.830002,0.1786]
Shape165 = x3d.Shape()
...
ImageTexture168 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
HAnimJoint172.center = [-6.823,36.080002,0.08607]
...
Transform174.translation = [-6.823,36.080002,0.08607]
Shape175 = x3d.Shape()
...
ImageTexture178 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
HAnimJoint182.center = [-6.915,28.41,0.3752]
...
Transform184.translation = [-6.915,28.41,0.3752]
Shape185 = x3d.Shape()
...
ImageTexture188 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
HAnimJoint192.center = [0,35.75,-0.445]
...
Transform194.translation = [0,35.75,-0.445]
Shape195 = x3d.Shape()
...
ImageTexture198 = x3d.ImageTexture(USE="YoungTextureAtlas")
...
HAnimJoint202.center = [0,50.470001,-0.1481]
...
Transform204.translation = [0,50.470001,-0.1481]
Shape205 = x3d.Shape()
...
EXPORT230.AS = "KoreanCharacter04Young"
EXPORT230.localDEF = "hanim_Young"

...
X3DScript40 = x3d.X3DScript()
X3DScript40.setDEF("ArchPrototypeScript")
X3DScript40.setUrl(["../node/ArchPrototypeScript.js","https://coderextreme.net/X3DJSONLD/src/main/node/ArchPrototypeScript.js"])
#INPUT PARAMETERS
#General parameters
#Parameters to create to create shapes related to arch: put true to apply
#OUTPUT PARAMETERS
...
X3DScript40.setIS(IS56)

ProtoBody30.addX3DScript(X3DScript40)
ROUTE69 = x3d.ROUTE()
...
Inline81.setBboxCenter([0,0,0])
Inline81.setBboxSize([-1,-1,-1])

Scene13.addChildren(Inline81)

X3D0.setScene(Scene13)
X3D0.toFileX3D("../data/ArchPrototype_RoundTrip.x3d")

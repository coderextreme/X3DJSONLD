...
Group6.setDisplayBBox(False)
Group6.setVisible(True)
Shape7 = x3d.Shape()
Shape7.setBboxCenter([0,0,0])
Shape7.setBboxSize([-1,-1,-1])
Shape7.setDisplayBBox(False)
Shape7.setVisible(True)
Appearance8 = x3d.Appearance()
Material9 = x3d.Material()
Material9.setAmbientIntensity(0.2)
Material9.setDiffuseColor([1,0,0])
Material9.setEmissiveColor([0,0,0])
Material9.setShininess(0.2)
Material9.setSpecularColor([0,0,0])
Material9.setTransparency(0)
...
Transform11.setCenter([0,0,0])
Transform11.setDisplayBBox(False)
Transform11.setRotation([7,8,9,3.14])
Transform11.setScale([4,5,6])
Transform11.setScaleOrientation([0,0,1,0])

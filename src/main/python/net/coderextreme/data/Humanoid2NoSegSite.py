...
HAnimJoint67.center = [0.0041,1.1276,-0.0796]
...
HAnimJoint68.center = [0.0048,1.1912,-0.0805]
...
HAnimJoint69.center = [0.0056,1.2848,-0.0822]
...
HAnimJoint70.center = [0.0059,1.3866,-0.08]
...
HAnimJoint71.center = [0.0065,1.4951,-0.0387]
...
HAnimJoint72.center = [0.0066,1.5662,-0.0084]
...
HAnimJoint73.center = [0.0066,1.5928,-0.0103]
...
HAnimJoint74.center = [0.0044,1.6209,0.0236]
...
HAnimJoint75.center = [0.082,1.4488,-0.0353]
...
HAnimJoint76.center = [0.0962,1.4269,-0.0424]
...
HAnimJoint77.center = [0.2029,1.4376,-0.0387]
...
HAnimJoint78.center = [0.2014,1.1357,-0.0682]
...
HAnimJoint79.center = [0.1984,0.8663,-0.0583]
...
HAnimJoint80.center = [0.1924,0.8472,-0.0534]
...
HAnimJoint81.center = [0.1951,0.8226,0.0246]
...
HAnimJoint82.center = [0.1955,0.8159,0.0464]
...
HAnimJoint83.center = [0.1983,0.8024,-0.028]
...
HAnimJoint84.center = [0.1983,0.7815,-0.028]
...
HAnimJoint85.center = [0.2017,0.7363,-0.0248]
...
HAnimJoint86.center = [0.2028,0.7139,-0.0236]
...
HAnimJoint87.center = [0.1987,0.8029,-0.053]
...
HAnimJoint88.center = [0.1987,0.7818,-0.053]
...
HAnimJoint89.center = [0.2013,0.7273,-0.0503]
...
HAnimJoint90.center = [0.2026,0.7011,-0.0494]
...
HAnimJoint91.center = [0.1956,0.8019,-0.0794]
...
HAnimJoint92.center = [0.1956,0.7815,-0.0794]
...
HAnimJoint93.center = [0.1973,0.7287,-0.0777]
...
HAnimJoint94.center = [0.1983,0.7045,-0.0767]
...
HAnimJoint96.center = [0.1925,0.7866,-0.1036]
...
HAnimJoint97.center = [0.1938,0.7452,-0.1024]
...
HAnimJoint98.center = [0.1948,0.7277,-0.1017]
...
HAnimJoint79.children.append(HAnimJoint95)
...
HAnimJoint99.center = [-0.0694,1.46,-0.033]
...
HAnimJoint100.center = [-0.0836,1.4281,-0.0401]
...
HAnimJoint101.center = [-0.1907,1.4407,-0.0325]
...
HAnimJoint102.center = [-0.1949,1.1388,-0.062]
...
HAnimJoint103.center = [-0.1959,0.8694,-0.0521]
...
HAnimJoint104.center = [-0.1899,0.8502,-0.0473]
...
HAnimJoint105.center = [-0.1874,0.8256,0.0306]
...
HAnimJoint106.center = [-0.1864,0.819,0.0506]
...
HAnimJoint107.center = [-0.1961,0.8055,-0.0218]
...
HAnimJoint108.center = [-0.1961,0.7846,-0.0218]
...
HAnimJoint109.center = [-0.1954,0.7393,-0.0185]
...
HAnimJoint110.center = [-0.1945,0.7169,-0.0173]
...
HAnimJoint111.center = [-0.1972,0.806,-0.0468]
...
HAnimJoint112.center = [-0.1972,0.7849,-0.0468]
...
HAnimJoint113.center = [-0.195,0.7304,-0.0441]
...
HAnimJoint114.center = [-0.1939,0.7042,-0.0432]
...
HAnimJoint115.center = [-0.1951,0.8049,-0.0732]
...
HAnimJoint116.center = [-0.1951,0.7845,-0.0732]
...
HAnimJoint117.center = [-0.192,0.7318,-0.0716]
...
HAnimJoint118.center = [-0.1908,0.7077,-0.0706]
...
HAnimJoint120.center = [-0.1926,0.7896,-0.0975]
...
HAnimJoint121.center = [-0.1902,0.7483,-0.0963]
...
HAnimJoint122.center = [-0.1908,0.754,-0.096]
...
HAnimJoint103.children.append(HAnimJoint119)
...
HAnimJoint71.children.append(HAnimJoint99)
...
f.write(X3D0.XML())
f.close()
f = open("../data/Humanoid2NoSegSite.new.python.json", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

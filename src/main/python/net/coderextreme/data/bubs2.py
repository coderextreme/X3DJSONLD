...
Transform16 = x3d.Transform(DEF="body_trans")
Shape17 = x3d.Shape()
Sphere18 = x3d.Sphere()
...
Script21 = x3d.Script(DEF="bounce")
field22 = x3d.field()
field22.name = "scale"
...
TimeSensor27 = x3d.TimeSensor(DEF="bubbleClock")

...
X3D(
  profile="Immersive", version="3.3", head=head(  children=[
          ...
          component(name="Scripting", level=1)]), Scene=Scene(
    children=[
        NavigationInfo(
          type="\"EXAMINE\""),
        Viewpoint(

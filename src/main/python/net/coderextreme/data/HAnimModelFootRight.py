...
HAnimHumanoid(name="Foot_Right", DEF="hanim_Foot_Right", loa=4, version="2.0", 
metadata=(
...
HAnimJoint(name="r_talocrural", DEF="hanim_r_talocrural", description="connection joint of foot to leg above", ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_talocalcaneonavicular", DEF="hanim_r_talocalcaneonavicular", center=((0.0,-0.3,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_cuneonavicular_1", DEF="hanim_r_cuneonavicular_1", center=((0.1,-0.45,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsometatarsal_1", DEF="hanim_r_tarsometatarsal_1", center=((0.1,-0.6,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_metatarsophalangeal_1", DEF="hanim_r_metatarsophalangeal_1", center=((0.1,-0.9,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsal_interphalangeal_1", DEF="hanim_r_tarsal_interphalangeal_1", center=((0.1,-1.05,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
HAnimSegment(name="r_tarsal_distal_phalanx_1", DEF="hanim_r_tarsal_distal_phalanx_1", children=[
...
Material(emissiveColor=((1,1,1)))), 
geometry=
IndexedLineSet(DEF="tiptoe_r_interphalangeal_", coordIndex=[int(0),int(1)], 
coord=
Coordinate(point=[(0.1,-1.05,0),(0.1,-1.1,0)])))])])])])]),
#CN2

HAnimJoint(name="r_cuneonavicular_2", DEF="hanim_r_cuneonavicular_2", center=((0.0,-0.45,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsometatarsal_2", DEF="hanim_r_tarsometatarsal_2", center=((-0.05,-0.6,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_metatarsophalangeal_2", DEF="hanim_r_metatarsophalangeal_2", center=((-0.05,-0.9,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsal_proximal_interphalangeal_2", DEF="hanim_r_tarsal_proximal_interphalangeal_2", center=((-0.05,-1.05,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsal_distal_interphalangeal_2", DEF="hanim_r_tarsal_distal_interphalangeal_2", center=((-0.05,-1.12,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
Material(emissiveColor=((1,1,1)))), 
geometry=
IndexedLineSet(DEF="tiptoe_r_tarsal_distal_interphalangeal_2", coordIndex=[int(0),int(1)], 
coord=
Coordinate(point=[(-0.05,-1.12,0),(-0.05,-1.16,0)])))])])])])])]),
#CN3

HAnimJoint(name="r_cuneonavicular_3", DEF="hanim_r_cuneonavicular_3", center=((-0.1,-0.4,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsometatarsal_3", DEF="hanim_r_tarsometatarsal_3", center=((-0.15,-0.6,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_metatarsophalangeal_3", DEF="hanim_r_metatarsophalangeal_3", center=((-0.15,-0.9,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsal_proximal_interphalangeal_3", DEF="hanim_r_tarsal_proximal_interphalangeal_3", center=((-0.15,-1.05,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsal_distal_interphalangeal_3", DEF="hanim_r_tarsal_distal_interphalangeal_3", center=((-0.15,-1.13,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
HAnimSegment(name="r_tarsal_distal_phalanx_3", DEF="hanim_r_tarsal_distal_phalanx_3", children=[
...
Material(emissiveColor=((1,1,1)))), 
geometry=
IndexedLineSet(DEF="tiptoe_r_tarsal_distal_interphalangeal_3", coordIndex=[int(0),int(1)], 
coord=
Coordinate(point=[(-0.15,-1.13,0),(-0.15,-1.16,0)])))])])])])])]),]),
#CC

HAnimJoint(name="r_calcaneocuboid", DEF="hanim_r_calcaneocuboid", center=((-0.2,0.3,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_transversetarsal", DEF="hanim_r_transversetarsal", center=((-0.21,-0.3,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsometatarsal_4", DEF="hanim_r_tarsometatarsal_4", center=((-0.25,-0.58,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_metatarsophalangeal_4", DEF="hanim_r_metatarsophalangeal_4", center=((-0.25,-0.87,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsal_proximal_interphalangeal_4", DEF="hanim_r_tarsal_proximal_interphalangeal_4", center=((-0.25,-1.0,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsal_distal_interphalangeal_4", DEF="hanim_r_tarsal_distal_interphalangeal_4", center=((-0.25,-1.1,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
HAnimSegment(name="r_tarsal_distal_phalanx_4", DEF="hanim_r_tarsal_distal_phalanx_4", children=[
...
Material(emissiveColor=((1,1,1)))), 
geometry=
IndexedLineSet(DEF="tiptoe_r_tarsal_distal_interphalangeal_4", coordIndex=[int(0),int(1)], 
coord=
Coordinate(point=[(-0.25,-1.1,0),(-0.25,-1.15,0)])))])])])])]),
#TMT5

HAnimJoint(name="r_tarsometatarsal_5", DEF="hanim_r_tarsometatarsal_5", center=((-0.33,-0.52,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_metatarsophalangeal_5", DEF="hanim_r_metatarsophalangeal_5", center=((-0.34,-0.8,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsal_proximal_interphalangeal_5", DEF="hanim_r_tarsal_proximal_interphalangeal_5", center=((-0.34,-0.95,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
...
HAnimJoint(name="r_tarsal_distal_interphalangeal_5", DEF="hanim_r_tarsal_distal_interphalangeal_5", center=((-0.34,-1.05,0)), ulimit=[float(0),float(0),float(0)], llimit=[float(0),float(0),float(0)], children=[
HAnimSegment(name="r_tarsal_distal_phalanx_5", DEF="hanim_r_tarsal_distal_phalanx_5", children=[
...
Material(emissiveColor=((1,1,1)))), 
geometry=
IndexedLineSet(DEF="tiptoe_r_tarsal_distal_interphalangeal_5", coordIndex=[int(0),int(1)], 
coord=
...
HAnimJoint(USE="hanim_r_transversetarsal")), segments=[

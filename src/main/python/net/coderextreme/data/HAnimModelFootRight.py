...
MetadataSet28.addValue(MetadataString29)
...
X3D0.toFileX3D("../data/HAnimModelFootRight.new.python.x3d")
X3D0.toFileJSON("../data/HAnimModelFootRight.new.python.json")

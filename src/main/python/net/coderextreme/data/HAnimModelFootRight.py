...
HAnimHumanoid27 = x3d.HAnimHumanoid(DEF="hanim_Foot_Right")
HAnimHumanoid27.name = "Foot_Right"
HAnimHumanoid27.loa = 4
HAnimHumanoid27.version = "2.0"
HAnimHumanoid27.children.append(x3d.Comment("""original HAnimHumanoid info='\"authorName=Kwan-Hee YOO, Don Brutzman and Joe Williams\"'"""))
...
HAnimJoint30 = x3d.HAnimJoint(DEF="hanim_humanoid_root")
HAnimJoint30.name = "humanoid_root"
HAnimJoint30.ulimit = [0,0,0]
HAnimJoint30.llimit = [0,0,0]
HAnimJoint30.children.append(x3d.Comment("""Might consider putting a HAnimSegment here, but that doesn't help with re-use of this foot model"""))
HAnimJoint31 = x3d.HAnimJoint(DEF="hanim_r_talocrural")
...
HAnimSegment32 = x3d.HAnimSegment(DEF="hanim_r_talus")
HAnimSegment32.name = "r_talus"
Transform33 = x3d.Transform()
Shape34 = x3d.Shape(DEF="HAnimJointShape")
Sphere35 = x3d.Sphere()
Sphere35.radius = 0.025

Shape34.geometry = Sphere35
Appearance36 = x3d.Appearance(DEF="HAnimJointAppearance")
...
IndexedLineSet41 = x3d.IndexedLineSet(DEF="TCtoTCN")
...
IndexedLineSet46 = x3d.IndexedLineSet(DEF="TCtoCC")
...
HAnimJoint31.children.append(x3d.Comment("""TCN"""))
HAnimJoint48 = x3d.HAnimJoint(DEF="hanim_r_talocalcaneonavicular")
HAnimJoint48.name = "r_talocalcaneonavicular"
HAnimJoint48.center = [0,-0.3,0]
HAnimJoint48.ulimit = [0,0,0]
HAnimJoint48.llimit = [0,0,0]
HAnimSegment49 = x3d.HAnimSegment(DEF="hanim_r_navicular")
...
IndexedLineSet55 = x3d.IndexedLineSet(DEF="TCNtoCN1")
...
IndexedLineSet60 = x3d.IndexedLineSet(DEF="TCNtoCN2")
...
IndexedLineSet65 = x3d.IndexedLineSet(DEF="TCNtoCN3")
...
HAnimJoint48.children.append(x3d.Comment("""CN1"""))
HAnimJoint67 = x3d.HAnimJoint(DEF="hanim_r_cuneonavicular_1")
HAnimJoint67.name = "r_cuneonavicular_1"
HAnimJoint67.center = [0.1,-0.45,0]
HAnimJoint67.ulimit = [0,0,0]
HAnimJoint67.llimit = [0,0,0]
HAnimSegment68 = x3d.HAnimSegment(DEF="hanim_r_cuneiform_1")
...
IndexedLineSet74 = x3d.IndexedLineSet(DEF="CN1toTMT1")
...
IndexedLineSet83 = x3d.IndexedLineSet(DEF="TMT1toMTP1")
...
HAnimJoint85 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_1")
HAnimJoint85.name = "r_metatarsophalangeal_1"
HAnimJoint85.center = [0.1,-0.9,0]
HAnimJoint85.ulimit = [0,0,0]
HAnimJoint85.llimit = [0,0,0]
HAnimSegment86 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_1")
...
IndexedLineSet92 = x3d.IndexedLineSet(DEF="MTP1toIP1")
...
HAnimJoint94 = x3d.HAnimJoint(DEF="hanim_r_tarsal_interphalangeal_1")
...
HAnimSegment95 = x3d.HAnimSegment(DEF="hanim_r_tarsal_distal_phalanx_1")
HAnimSegment95.name = "r_tarsal_distal_phalanx_1"
Transform96 = x3d.Transform()
Transform96.translation = [0.1,-1.05,0]
Shape97 = x3d.Shape(USE="HAnimJointShape")
...
IndexedLineSet101 = x3d.IndexedLineSet(DEF="tiptoe_r_interphalangeal_")
...
HAnimJoint48.children.append(x3d.Comment("""CN2"""))
HAnimJoint103 = x3d.HAnimJoint(DEF="hanim_r_cuneonavicular_2")
HAnimJoint103.name = "r_cuneonavicular_2"
HAnimJoint103.center = [0,-0.45,0]
HAnimJoint103.ulimit = [0,0,0]
HAnimJoint103.llimit = [0,0,0]
HAnimSegment104 = x3d.HAnimSegment(DEF="hanim_r_cuneiform_2")
...
IndexedLineSet110 = x3d.IndexedLineSet(DEF="CN2toTMT2")
...
HAnimJoint112 = x3d.HAnimJoint(DEF="hanim_r_tarsometatarsal_2")
...
HAnimSegment113 = x3d.HAnimSegment(DEF="hanim_r_metatarsal_2")
...
IndexedLineSet119 = x3d.IndexedLineSet(DEF="TMT2toMTP2")
...
HAnimJoint121 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_2")
...
HAnimSegment122 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_2")
...
IndexedLineSet128 = x3d.IndexedLineSet(DEF="MTP2toPIP2")
...
HAnimJoint130 = x3d.HAnimJoint(DEF="hanim_r_tarsal_proximal_interphalangeal_2")
...
HAnimSegment131 = x3d.HAnimSegment(DEF="hanim_r_tarsal_middle_phalanx_2")
...
IndexedLineSet137 = x3d.IndexedLineSet(DEF="PIP2toDIP2")
...
HAnimJoint139 = x3d.HAnimJoint(DEF="hanim_r_tarsal_distal_interphalangeal_2")
...
IndexedLineSet146 = x3d.IndexedLineSet(DEF="tiptoe_r_tarsal_distal_interphalangeal_2")
...
HAnimJoint48.children.append(x3d.Comment("""CN3"""))
HAnimJoint148 = x3d.HAnimJoint(DEF="hanim_r_cuneonavicular_3")
HAnimJoint148.name = "r_cuneonavicular_3"
HAnimJoint148.center = [-0.1,-0.4,0]
HAnimJoint148.ulimit = [0,0,0]
HAnimJoint148.llimit = [0,0,0]
HAnimSegment149 = x3d.HAnimSegment(DEF="hanim_r_cuneiform_3")
...
IndexedLineSet155 = x3d.IndexedLineSet(DEF="CN3toTMT3")
...
HAnimJoint157 = x3d.HAnimJoint(DEF="hanim_r_tarsometatarsal_3")
...
HAnimSegment158 = x3d.HAnimSegment(DEF="hanim_r_metatarsal_3")
...
IndexedLineSet164 = x3d.IndexedLineSet(DEF="TMT3toMTP3")
...
HAnimJoint166 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_3")
...
HAnimSegment167 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_3")
...
IndexedLineSet173 = x3d.IndexedLineSet(DEF="MTP3toPIP3")
...
HAnimJoint175 = x3d.HAnimJoint(DEF="hanim_r_tarsal_proximal_interphalangeal_3")
...
HAnimSegment176 = x3d.HAnimSegment(DEF="hanim_r_tarsal_middle_phalanx_3")
...
IndexedLineSet182 = x3d.IndexedLineSet(DEF="PIP3toDIP3")
...
HAnimJoint184 = x3d.HAnimJoint(DEF="hanim_r_tarsal_distal_interphalangeal_3")
...
IndexedLineSet191 = x3d.IndexedLineSet(DEF="tiptoe_r_tarsal_distal_interphalangeal_3")
...
HAnimJoint31.children.append(x3d.Comment("""CC"""))
HAnimJoint193 = x3d.HAnimJoint(DEF="hanim_r_calcaneocuboid")
HAnimJoint193.name = "r_calcaneocuboid"
HAnimJoint193.center = [-0.2,0.3,0]
HAnimJoint193.ulimit = [0,0,0]
HAnimJoint193.llimit = [0,0,0]
HAnimSegment194 = x3d.HAnimSegment(DEF="hanim_r_calcaneus")
...
IndexedLineSet200 = x3d.IndexedLineSet(DEF="CCtoTT")
...
HAnimJoint193.children.append(x3d.Comment("""TT"""))
HAnimJoint202 = x3d.HAnimJoint(DEF="hanim_r_transversetarsal")
HAnimJoint202.name = "r_transversetarsal"
HAnimJoint202.center = [-0.21,-0.3,0]
HAnimJoint202.ulimit = [0,0,0]
HAnimJoint202.llimit = [0,0,0]
HAnimSegment203 = x3d.HAnimSegment(DEF="hanim_r_cuboid")
...
IndexedLineSet209 = x3d.IndexedLineSet(DEF="TTtoTMT4")
...
IndexedLineSet214 = x3d.IndexedLineSet(DEF="TTtoTMT5")
...
HAnimJoint202.children.append(x3d.Comment("""TMT4"""))
HAnimJoint216 = x3d.HAnimJoint(DEF="hanim_r_tarsometatarsal_4")
...
HAnimSegment217 = x3d.HAnimSegment(DEF="hanim_r_metatarsal_4")
...
IndexedLineSet223 = x3d.IndexedLineSet(DEF="TMT4toMTP4")
...
HAnimJoint225 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_4")
...
HAnimSegment226 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_4")
...
IndexedLineSet232 = x3d.IndexedLineSet(DEF="MTP4toPIP4")
...
HAnimJoint234 = x3d.HAnimJoint(DEF="hanim_r_tarsal_proximal_interphalangeal_4")
...
HAnimSegment235 = x3d.HAnimSegment(DEF="hanim_r_tarsal_middle_phalanx_4")
...
IndexedLineSet241 = x3d.IndexedLineSet(DEF="PIP4toDIP4")
...
HAnimJoint243 = x3d.HAnimJoint(DEF="hanim_r_tarsal_distal_interphalangeal_4")
...
HAnimSegment244 = x3d.HAnimSegment(DEF="hanim_r_tarsal_distal_phalanx_4")
...
IndexedLineSet250 = x3d.IndexedLineSet(DEF="tiptoe_r_tarsal_distal_interphalangeal_4")
...
HAnimJoint202.children.append(x3d.Comment("""TMT5"""))
HAnimJoint252 = x3d.HAnimJoint(DEF="hanim_r_tarsometatarsal_5")
...
HAnimSegment253 = x3d.HAnimSegment(DEF="hanim_r_metatarsal_5")
...
IndexedLineSet259 = x3d.IndexedLineSet(DEF="TMT5toMTP5")
...
HAnimJoint261 = x3d.HAnimJoint(DEF="hanim_r_metatarsophalangeal_5")
...
HAnimSegment262 = x3d.HAnimSegment(DEF="hanim_r_tarsal_proximal_phalanx_5")
...
IndexedLineSet268 = x3d.IndexedLineSet(DEF="MTP5toPIP5")
...
HAnimJoint270 = x3d.HAnimJoint(DEF="hanim_r_tarsal_proximal_interphalangeal_5")
...
IndexedLineSet277 = x3d.IndexedLineSet(DEF="PIP5toDIP5")
...
HAnimJoint279 = x3d.HAnimJoint(DEF="hanim_r_tarsal_distal_interphalangeal_5")
...
IndexedLineSet286 = x3d.IndexedLineSet(DEF="tiptoe_r_tarsal_distal_interphalangeal_5")
...
HAnimJoint288 = x3d.HAnimJoint(USE="hanim_humanoid_root")

HAnimHumanoid27.joints.append(HAnimJoint288)
HAnimJoint289 = x3d.HAnimJoint(USE="hanim_r_calcaneocuboid")

HAnimHumanoid27.joints.append(HAnimJoint289)
HAnimJoint290 = x3d.HAnimJoint(USE="hanim_r_cuneonavicular_1")

HAnimHumanoid27.joints.append(HAnimJoint290)
HAnimJoint291 = x3d.HAnimJoint(USE="hanim_r_cuneonavicular_2")

HAnimHumanoid27.joints.append(HAnimJoint291)
HAnimJoint292 = x3d.HAnimJoint(USE="hanim_r_cuneonavicular_3")

HAnimHumanoid27.joints.append(HAnimJoint292)
HAnimJoint293 = x3d.HAnimJoint(USE="hanim_r_metatarsophalangeal_1")

HAnimHumanoid27.joints.append(HAnimJoint293)
HAnimJoint294 = x3d.HAnimJoint(USE="hanim_r_metatarsophalangeal_2")

HAnimHumanoid27.joints.append(HAnimJoint294)
HAnimJoint295 = x3d.HAnimJoint(USE="hanim_r_metatarsophalangeal_3")

HAnimHumanoid27.joints.append(HAnimJoint295)
HAnimJoint296 = x3d.HAnimJoint(USE="hanim_r_metatarsophalangeal_4")

HAnimHumanoid27.joints.append(HAnimJoint296)
HAnimJoint297 = x3d.HAnimJoint(USE="hanim_r_metatarsophalangeal_5")

HAnimHumanoid27.joints.append(HAnimJoint297)
HAnimJoint298 = x3d.HAnimJoint(USE="hanim_r_talocalcaneonavicular")

HAnimHumanoid27.joints.append(HAnimJoint298)
HAnimJoint299 = x3d.HAnimJoint(USE="hanim_r_talocrural")

HAnimHumanoid27.joints.append(HAnimJoint299)
HAnimJoint300 = x3d.HAnimJoint(USE="hanim_r_tarsal_distal_interphalangeal_2")

HAnimHumanoid27.joints.append(HAnimJoint300)
HAnimJoint301 = x3d.HAnimJoint(USE="hanim_r_tarsal_distal_interphalangeal_3")

HAnimHumanoid27.joints.append(HAnimJoint301)
HAnimJoint302 = x3d.HAnimJoint(USE="hanim_r_tarsal_distal_interphalangeal_4")

HAnimHumanoid27.joints.append(HAnimJoint302)
HAnimJoint303 = x3d.HAnimJoint(USE="hanim_r_tarsal_distal_interphalangeal_5")

HAnimHumanoid27.joints.append(HAnimJoint303)
HAnimJoint304 = x3d.HAnimJoint(USE="hanim_r_tarsal_interphalangeal_1")

HAnimHumanoid27.joints.append(HAnimJoint304)
HAnimJoint305 = x3d.HAnimJoint(USE="hanim_r_tarsal_proximal_interphalangeal_2")

HAnimHumanoid27.joints.append(HAnimJoint305)
HAnimJoint306 = x3d.HAnimJoint(USE="hanim_r_tarsal_proximal_interphalangeal_3")

HAnimHumanoid27.joints.append(HAnimJoint306)
HAnimJoint307 = x3d.HAnimJoint(USE="hanim_r_tarsal_proximal_interphalangeal_4")

HAnimHumanoid27.joints.append(HAnimJoint307)
HAnimJoint308 = x3d.HAnimJoint(USE="hanim_r_tarsal_proximal_interphalangeal_5")

HAnimHumanoid27.joints.append(HAnimJoint308)
HAnimJoint309 = x3d.HAnimJoint(USE="hanim_r_tarsometatarsal_1")

HAnimHumanoid27.joints.append(HAnimJoint309)
HAnimJoint310 = x3d.HAnimJoint(USE="hanim_r_tarsometatarsal_2")

HAnimHumanoid27.joints.append(HAnimJoint310)
HAnimJoint311 = x3d.HAnimJoint(USE="hanim_r_tarsometatarsal_3")

HAnimHumanoid27.joints.append(HAnimJoint311)
HAnimJoint312 = x3d.HAnimJoint(USE="hanim_r_tarsometatarsal_4")

HAnimHumanoid27.joints.append(HAnimJoint312)
HAnimJoint313 = x3d.HAnimJoint(USE="hanim_r_tarsometatarsal_5")

HAnimHumanoid27.joints.append(HAnimJoint313)
HAnimJoint314 = x3d.HAnimJoint(USE="hanim_r_transversetarsal")

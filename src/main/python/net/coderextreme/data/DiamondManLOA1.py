...
HAnimHumanoid(name="humanoid", DEF="hanim_humanoid", loa=1, version="2.0", 
metadata=(
...
Shape(USE="DiamondShape")]),
HAnimSite(name="skull_vertex_tip", DEF="hanim_skull_vertex_tip", translation=((0.005,1.7504,0.0055))),
...
HAnimSite(name="DiamondManLOA1_view", DEF="hanim_DiamondManLOA1_view", children=[
...
HAnimJoint(USE="hanim_r_talocrural")), segments=[

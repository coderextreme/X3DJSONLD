...
fieldValue18 = fieldValueObject().setName("vertex").setValue("\"cobweb_flowers_plain.vs\"")
ProtoInstance17.addFieldValue(fieldValue18)
fieldValue19 = fieldValueObject().setName("fragment").setValue("\"plain.fs\"")
...
X3D0.toFileX3D("../out/orig/plainflowers.new.x3d")

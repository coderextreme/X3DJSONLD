...
fieldValue18 = fieldValueObject().setName("vertex").setValue("\"shaders/cobweb_flowers_plain.vs\"")
ProtoInstance17.addFieldValue(fieldValue18)
fieldValue19 = fieldValueObject().setName("fragment").setValue("\"shaders/plain.fs\"")

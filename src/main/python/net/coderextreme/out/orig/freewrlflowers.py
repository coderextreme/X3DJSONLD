...
fieldValue18 = fieldValueObject().setName("vertex").setValue("\"shaders/freewrl_flowers_chromatic.vs\"")
ProtoInstance17.addFieldValue(fieldValue18)
fieldValue19 = fieldValueObject().setName("fragment").setValue("\"shaders/freewrl.fs\"")

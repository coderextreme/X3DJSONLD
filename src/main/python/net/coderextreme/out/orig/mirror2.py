...
Background9 = BackgroundObject().setDEF("cube").setLeftUrl(["images/all_probes/beach_cross/beach_left.png","http://coderextreme.net/images/all_probes/beach_cross/beach_left.png"]).setRightUrl(["images/all_probes/beach_cross/beach_right.png","http://coderextreme.net/images/all_probes/beach_cross/beach_right.png"]).setFrontUrl(["images/all_probes/beach_cross/beach_front.png","http://coderextreme.net/images/all_probes/beach_cross/beach_front.png"]).setBackUrl(["images/all_probes/beach_cross/beach_back.png","http://coderextreme.net/images/all_probes/beach_cross/beach_back.png"]).setTopUrl(["images/all_probes/beach_cross/beach_top.png","http://coderextreme.net/images/all_probes/beach_cross/beach_top.png"]).setBottomUrl(["images/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/images/all_probes/beach_cross/beach_bottom.png"])
...
ImageTexture15 = ImageTextureObject().setDEF("backShader").setUrl(["images/all_probes/beach_cross/beach_back.png","http://coderextreme.net/images/all_probes/beach_cross/beach_back.png"])
ComposedCubeMapTexture14.setBack(ImageTexture15)
ImageTexture16 = ImageTextureObject().setDEF("bottomShader").setUrl(["images/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/images/all_probes/beach_cross/beach_bottom.png"])
ComposedCubeMapTexture14.setBottom(ImageTexture16)
ImageTexture17 = ImageTextureObject().setDEF("frontShader").setUrl(["images/all_probes/beach_cross/beach_front.png","http://coderextreme.net/images/all_probes/beach_cross/beach_front.png"])
ComposedCubeMapTexture14.setFront(ImageTexture17)
ImageTexture18 = ImageTextureObject().setDEF("leftShader").setUrl(["images/all_probes/beach_cross/beach_left.png","http://coderextreme.net/images/all_probes/beach_cross/beach_left.png"])
ComposedCubeMapTexture14.setLeft(ImageTexture18)
ImageTexture19 = ImageTextureObject().setDEF("rightShader").setUrl(["images/all_probes/beach_cross/beach_right.png","http://coderextreme.net/images/all_probes/beach_cross/beach_right.png"])
ComposedCubeMapTexture14.setRight(ImageTexture19)
ImageTexture20 = ImageTextureObject().setDEF("topShader").setUrl(["images/all_probes/beach_cross/beach_top.png","http://coderextreme.net/images/all_probes/beach_cross/beach_top.png"])

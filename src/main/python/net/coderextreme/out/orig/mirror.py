...
head1.addMeta(meta5)
meta6 = metaObject().setName("identifier").setContent("https://coderextreme.net/X3DJSONLD/mirror.x3d")
head1.addMeta(meta6)
...
ImageTexture11 = ImageTextureObject().setDEF("leftBack").setUrl(["images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/images/all_probes/beach_cross/beach_left.png"])
TextureBackground10.setLeftTexture(ImageTexture11)
ImageTexture12 = ImageTextureObject().setDEF("rightBack").setUrl(["images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/images/all_probes/beach_cross/beach_right.png"])
TextureBackground10.setRightTexture(ImageTexture12)
ImageTexture13 = ImageTextureObject().setDEF("frontBack").setUrl(["images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/images/all_probes/beach_cross/beach_front.png"])
TextureBackground10.setFrontTexture(ImageTexture13)
ImageTexture14 = ImageTextureObject().setDEF("backBack").setUrl(["images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/images/all_probes/beach_cross/beach_back.png"])
TextureBackground10.setBackTexture(ImageTexture14)
ImageTexture15 = ImageTextureObject().setDEF("topBack").setUrl(["images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/images/all_probes/beach_cross/beach_top.png"])
TextureBackground10.setTopTexture(ImageTexture15)
ImageTexture16 = ImageTextureObject().setDEF("bottomBack").setUrl(["images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/images/all_probes/beach_cross/beach_bottom.png"])
...
ImageTexture22 = ImageTextureObject().setDEF("backShader").setUrl(["images/all_probes/beach_cross/beach_back.png","https://coderextreme.net/images/all_probes/beach_cross/beach_back.png"])
ComposedCubeMapTexture21.setBack(ImageTexture22)
ImageTexture23 = ImageTextureObject().setDEF("bottomShader").setUrl(["images/all_probes/beach_cross/beach_bottom.png","https://coderextreme.net/images/all_probes/beach_cross/beach_bottom.png"])
ComposedCubeMapTexture21.setBottom(ImageTexture23)
ImageTexture24 = ImageTextureObject().setDEF("frontShader").setUrl(["images/all_probes/beach_cross/beach_front.png","https://coderextreme.net/images/all_probes/beach_cross/beach_front.png"])
ComposedCubeMapTexture21.setFront(ImageTexture24)
ImageTexture25 = ImageTextureObject().setDEF("leftShader").setUrl(["images/all_probes/beach_cross/beach_left.png","https://coderextreme.net/images/all_probes/beach_cross/beach_left.png"])
ComposedCubeMapTexture21.setLeft(ImageTexture25)
ImageTexture26 = ImageTextureObject().setDEF("rightShader").setUrl(["images/all_probes/beach_cross/beach_right.png","https://coderextreme.net/images/all_probes/beach_cross/beach_right.png"])
ComposedCubeMapTexture21.setRight(ImageTexture26)
ImageTexture27 = ImageTextureObject().setDEF("topShader").setUrl(["images/all_probes/beach_cross/beach_top.png","https://coderextreme.net/images/all_probes/beach_cross/beach_top.png"])
...
ShaderPart34 = ShaderPartObject().setType("VERTEX").setUrl(["shaders/x3dom.vs","https://coderextreme.net/X3DJSONLD/shaders/x3dom.vs"])
ComposedShader28.addParts(ShaderPart34)
ShaderPart35 = ShaderPartObject().setType("FRAGMENT").setUrl(["shaders/mix.fs","https://coderextreme.net/X3DJSONLD/shaders/mix.fs"])
...
ShaderPart42 = ShaderPartObject().setType("VERTEX").setUrl(["shaders/cobweb.vs","https://coderextreme.net/X3DJSONLD/shaders/cobweb.vs"])
ComposedShader36.addParts(ShaderPart42)
ShaderPart43 = ShaderPartObject().setType("FRAGMENT").setUrl(["shaders/mix.fs","https://coderextreme.net/X3DJSONLD/shaders/mix.fs"])

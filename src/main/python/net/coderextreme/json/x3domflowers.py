...
fieldValue18 = fieldValueObject().setName("vertex").setValue("\"x3dom_flowers_chromatic.vs\"")
ProtoInstance17.addFieldValue(fieldValue18)
fieldValue19 = fieldValueObject().setName("fragment").setValue("\"common.fs\"")
...
X3D0.toFileX3D("../new/json/x3domflowers.new.x3d")

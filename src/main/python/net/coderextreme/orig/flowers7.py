...
Background9 = BackgroundObject().setDEF("background").setBackUrl(["images/all_probes/beach_cross/beach_back.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_back.png"]).setBottomUrl(["images/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_bottom.png"]).setFrontUrl(["images/all_probes/beach_cross/beach_front.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_front.png"]).setLeftUrl(["images/all_probes/beach_cross/beach_left.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_left.png"]).setRightUrl(["images/all_probes/beach_cross/beach_right.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_right.png"]).setTopUrl(["images/all_probes/beach_cross/beach_top.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_top.png"])
...
ImageTexture16 = ImageTextureObject().setDEF("backShader").setUrl(["images/all_probes/beach_cross/beach_back.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_back.png"])
ComposedCubeMapTexture15.setBack(ImageTexture16)
ImageTexture17 = ImageTextureObject().setDEF("bottomShader").setUrl(["images/all_probes/beach_cross/beach_bottom.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_bottom.png"])
ComposedCubeMapTexture15.setBottom(ImageTexture17)
ImageTexture18 = ImageTextureObject().setDEF("frontShader").setUrl(["images/all_probes/beach_cross/beach_front.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_front.png"])
ComposedCubeMapTexture15.setFront(ImageTexture18)
ImageTexture19 = ImageTextureObject().setDEF("leftShader").setUrl(["images/all_probes/beach_cross/beach_left.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_left.png"])
ComposedCubeMapTexture15.setLeft(ImageTexture19)
ImageTexture20 = ImageTextureObject().setDEF("rightShader").setUrl(["images/all_probes/beach_cross/beach_right.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_right.png"])
ComposedCubeMapTexture15.setRight(ImageTexture20)
ImageTexture21 = ImageTextureObject().setDEF("topShader").setUrl(["images/all_probes/beach_cross/beach_top.png","http://coderextreme.net/X3DJSONLD/images/all_probes/beach_cross/beach_top.png"])
...
ShaderPart34 = ShaderPartObject().setType("VERTEX").setUrl(["cobweb_flowers_input.vs","http://coderextreme.net/X3DJSONLD/cobweb_flowers_input.vs"])
ComposedShader22.addParts(ShaderPart34)
ShaderPart35 = ShaderPartObject().setType("FRAGMENT").setUrl(["pc_input_flowers.fs","http://coderextreme.net/X3DJSONLD/pc_input_flowers.fs"])
...
X3D0.toFileX3D("../new/orig/flowers7.new.x3d")

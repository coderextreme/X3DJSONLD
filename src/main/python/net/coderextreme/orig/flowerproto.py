...
field10 = fieldObject().setType(fieldObject.TYPE_MFSTRING).setName("vertex").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setValue("\"gl_flowers_chromatic.vs\"")
ProtoInterface9.addField(field10)
field11 = fieldObject().setType(fieldObject.TYPE_MFSTRING).setName("fragment").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setValue("\"pc_flowers.fs\"")
...
X3D0.toFileX3D("../new/orig/flowerproto.new.x3d")

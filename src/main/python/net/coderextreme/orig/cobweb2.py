...
Background12 = BackgroundObject().setBackUrl(["images/BK.png","http://coderextreme.net/X3DJSONLD/images/BK.png"]).setBottomUrl(["images/BT.png","http://coderextreme.net/X3DJSONLD/images/BT.png"]).setFrontUrl(["images/FR.png","http://coderextreme.net/X3DJSONLD/images/FR.png"]).setLeftUrl(["images/LF.png","http://coderextreme.net/X3DJSONLD/images/LF.png"]).setRightUrl(["images/RT.png","http://coderextreme.net/X3DJSONLD/images/RT.png"]).setTopUrl(["images/TP.png","http://coderextreme.net/X3DJSONLD/images/TP.png"])

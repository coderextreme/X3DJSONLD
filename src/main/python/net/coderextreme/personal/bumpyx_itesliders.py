...
Material75.setDiffuseColor([0.7,0.7,0.7])
Material75.setSpecularColor([0.5,0.5,0.5])
...
X3D0.toFileX3D("../personal/bumpyx_itesliders.new.python.x3d")
X3D0.toFileJSON("../personal/bumpyx_itesliders.new.python.json")

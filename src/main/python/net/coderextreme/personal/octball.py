...
ShaderPart39.setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/octaga.vs"])
...
X3D0.toFileX3D("../personal/octball.new.python.x3d")
X3D0.toFileJSON("../personal/octball.new.python.json")

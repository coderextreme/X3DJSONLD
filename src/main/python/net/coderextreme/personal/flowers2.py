...
ProtoInterface=ProtoInterface(field=[field(name="translation", accessType="inputOutput", type="SFVec3f", value=(-8,0,0)),
...
OrientationInterpolator(DEF="OrbitPath", key=[float(0.0),float(0.5),float(1.0)], keyValue=[(float(1.0),float(0.0),float(0.0),float(0.0)),(float(1.0),float(0.0),float(0.0),float(3.14)),(float(1.0),float(0.0),float(0.0),float(6.28))]),
...
ProtoInstance(name="orbit", fieldValue=[fieldValue(name="translation", value=[-8,0,0]),

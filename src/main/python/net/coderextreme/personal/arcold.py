...
meta5.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/arc.x3d")
...
X3D0.toFileX3D("../personal/arcold.new.python.x3d")
X3D0.toFileJSON("../personal/arcold.new.python.json")

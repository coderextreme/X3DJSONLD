...
ShaderPart40.setUrl(["../shaders/commonnew.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/commonnew.fs"])
...
X3D0.toFileX3D("../personal/ball.new.python.x3d")
X3D0.toFileJSON("../personal/ball.new.python.json")

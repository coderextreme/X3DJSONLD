...
meta15.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/flowerproto.x3d")
...
X3D0.toFileX3D("../personal/flowerproto.new.python.x3d")
X3D0.toFileJSON("../personal/flowerproto.new.python.json")

...
meta6.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/x3domflowers.x3d")
...
ExternProtoDeclare11.setUrl(["../personal/flowerproto.json#FlowerProto"])
field12 = field()
...
X3D0.toFileX3D("../personal/x3domflowers_RoundTrip.x3d")

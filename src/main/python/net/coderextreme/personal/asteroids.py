...
meta5.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/asteroids.x3d")
...
X3D0.toFileX3D("../personal/asteroids.new.python.x3d")
X3D0.toFileJSON("../personal/asteroids.new.python.json")

...
meta13.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/ballx3dom.x3d")
...
WorldInfo16.setTitle("ballx3dom.x3d")
...
X3D0.toFileX3D("../personal/ballx3dom.new.python.x3d")
X3D0.toFileJSON("../personal/ballx3dom.new.python.json")

...
meta13.content = "https://coderextreme.net/X3DJSONLD/src/main/personal/ballx3dom.x3d"
...
X3D0.Scene = Scene15
f = open("../personal/ballx3dom.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../personal/ballx3dom.new.python.json", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

...
ComposedCubeMapTexture25.bottom.append(ImageTexture27)
...
ComposedCubeMapTexture25.front.append(ImageTexture28)
...
ComposedCubeMapTexture25.left.append(ImageTexture29)
...
ComposedCubeMapTexture25.right.append(ImageTexture30)
...
ComposedCubeMapTexture25.top.append(ImageTexture31)
...
X3D0.Scene = Scene15
f = open("../personal/bumpyfreewrl.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../personal/bumpyfreewrl.new.python.json", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

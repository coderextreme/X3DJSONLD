...
meta5.content = "https://coderextreme.net/X3DJSONLD/src/main/personal/box.x3d"
...
X3D0.Scene = Scene7
f = open("../personal/BoxEm.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../personal/BoxEm.new.python.json", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

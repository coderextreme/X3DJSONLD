...
ExternProtoDeclare21.setUrl(["../personal/flowerproto.json#FlowerProto"])
field22 = x3d.field()
...
AudioClip38.setUrl(["../resources/chandubabamusic1.wav"])
...
X3D0.toFileX3D("../personal/sphereflowers.new.python.x3d")
X3D0.toFileJSON("../personal/sphereflowers.new.python.json")

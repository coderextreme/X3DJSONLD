...
ExternProtoDeclare21.url = ["../personal/flowerproto.x3d#FlowerProto","https://coderextreme.net/X3DJSONLD/src/main/personal/flowerproto.x3d#FlowerProto"]
field22 = x3d.field()
field22.name = "vertex"
...
X3D0.Scene = Scene17
f = open("../personal/sphereflowers.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../personal/sphereflowers.new.python.json", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

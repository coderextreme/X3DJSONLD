...
meta13.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/variationalflowers.x3d")
...
X3D0.toFileX3D("../personal/variationalflowers.new.python.x3d")
X3D0.toFileJSON("../personal/variationalflowers.new.python.json")

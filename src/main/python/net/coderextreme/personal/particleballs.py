...
meta10.setContent("particleballs.x3d")
...
meta12.setContent("A balls proto with configurable shaders")

head1.addMeta(meta12)
meta13 = x3d.meta()
meta13.setName("identifier")
meta13.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/particleballs.x3d")
...
WorldInfo15.setTitle("particleballs.x3d")
...
X3D0.toFileX3D("../personal/particleballs.new.python.x3d")
X3D0.toFileJSON("../personal/particleballs.new.python.json")

...
ComposedCubeMapTexture75.bottom.append(ImageTexture77)
...
ComposedCubeMapTexture75.front.append(ImageTexture78)
...
ComposedCubeMapTexture75.left.append(ImageTexture79)
...
ComposedCubeMapTexture75.right.append(ImageTexture80)
...
ComposedCubeMapTexture75.top.append(ImageTexture81)
...
DISEntityTypeMapping97.url = ["../data/Leif8Final.x3dv","https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3dv"]
...
DISEntityTypeMapping98.url = ["../data/Lily8Final.x3dv","https://coderextreme.net/X3DJSONLD/src/main/data/Lily8Final.x3dv"]
...
DISEntityTypeMapping99.url = ["../data/Tufani8Final.x3dv","https://coderextreme.net/X3DJSONLD/src/main/data/Tufani8Final.x3dv"]
...
DISEntityTypeMapping100.url = ["../data/Gramps8Final.x3dv","https://coderextreme.net/X3DJSONLD/src/main/data/Gramps8Final.x3dv"]
...
X3D0.Scene = Scene31
f = open("../personal/bumpyfreewrlsliders.new.python.x3d", mode="w", encoding="utf-8")
f.write(X3D0.XML())
f.close()
f = open("../personal/bumpyfreewrlsliders.new.python.json", mode="w", encoding="utf-8")
f.write(X3D0.JSON())
f.close()

...
meta11.setContent("../Poses/images/HAnimPoseExampleKoreanCharacter12Sun.png")
...
meta15.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter12Sun.x3d")
...
WorldInfo22.setTitle("KoreanCharacter12Sun.x3d")
...
HAnimJoint33.setCenter(x3d.doubleToFloat([0,29.860001,-0.4567]))
...
Transform35.setTranslation(x3d.doubleToFloat([0,29.860001,-0.4567]))
Shape36 = x3d.Shape()
...
HAnimJoint43.setCenter(x3d.doubleToFloat([2.955,28.940001,-0.5218]))
...
Transform45.setTranslation(x3d.doubleToFloat([2.955,28.940001,-0.5218]))
Shape46 = x3d.Shape()
...
ImageTexture49.setUSE("SunTextureAtlas")
...
HAnimJoint53.setCenter(x3d.doubleToFloat([2.948,16.459999,-0.5275]))
...
Transform55.setTranslation(x3d.doubleToFloat([2.948,16.459999,-0.5275]))
Shape56 = x3d.Shape()
...
HAnimJoint63.setCenter(x3d.doubleToFloat([2.839,3.899,-0.4116]))
...
Transform65.setTranslation(x3d.doubleToFloat([2.839,3.899,-0.4116]))
Shape66 = x3d.Shape()
...
HAnimJoint73.setCenter(x3d.doubleToFloat([2.839,3.312,1.078]))
...
Transform75.setTranslation(x3d.doubleToFloat([2.839,3.312,1.078]))
Shape76 = x3d.Shape()
...
HAnimJoint83.setCenter(x3d.doubleToFloat([-2.955,28.940001,-0.5218]))
...
Transform85.setTranslation(x3d.doubleToFloat([-2.955,28.940001,-0.5218]))
Shape86 = x3d.Shape()
...
HAnimJoint93.setCenter(x3d.doubleToFloat([-2.948,16.459999,-0.5275]))
...
Transform95.setTranslation(x3d.doubleToFloat([-2.948,16.459999,-0.5275]))
Shape96 = x3d.Shape()
...
HAnimJoint103.setCenter(x3d.doubleToFloat([-2.839,3.899,-0.4116]))
...
Transform105.setTranslation(x3d.doubleToFloat([-2.839,3.899,-0.4116]))
Shape106 = x3d.Shape()
...
HAnimJoint113.setCenter(x3d.doubleToFloat([-2.839,3.312,1.078]))
...
Transform115.setTranslation(x3d.doubleToFloat([-2.839,3.312,1.078]))
Shape116 = x3d.Shape()
...
HAnimJoint123.setCenter(x3d.doubleToFloat([0,29.860001,-0.4567]))
...
Transform125.setTranslation(x3d.doubleToFloat([0,29.860001,-0.4567]))
Shape126 = x3d.Shape()
...
HAnimJoint133.setCenter(x3d.doubleToFloat([6.077,45.880001,-1.319]))
...
Transform135.setTranslation(x3d.doubleToFloat([6.077,45.880001,-1.319]))
Shape136 = x3d.Shape()
...
HAnimJoint143.setCenter(x3d.doubleToFloat([7.076,38.529999,-1.385]))
...
Transform145.setTranslation(x3d.doubleToFloat([7.076,38.529999,-1.385]))
Shape146 = x3d.Shape()
...
HAnimJoint153.setCenter(x3d.doubleToFloat([6.946,30.889999,-1.308]))
...
Transform155.setTranslation(x3d.doubleToFloat([6.946,30.889999,-1.308]))
Shape156 = x3d.Shape()
...
HAnimJoint163.setCenter(x3d.doubleToFloat([-6.077,45.880001,-1.319]))
...
Transform165.setTranslation(x3d.doubleToFloat([-6.077,45.880001,-1.319]))
Shape166 = x3d.Shape()
...
HAnimJoint173.setCenter(x3d.doubleToFloat([-7.076,38.529999,-1.385]))
...
Transform175.setTranslation(x3d.doubleToFloat([-7.076,38.529999,-1.385]))
Shape176 = x3d.Shape()
...
ImageTexture179.setUSE("SunTextureAtlas")
...
HAnimJoint183.setCenter(x3d.doubleToFloat([-6.946,30.889999,-1.308]))
...
Transform185.setTranslation(x3d.doubleToFloat([-6.946,30.889999,-1.308]))
Shape186 = x3d.Shape()
...
ImageTexture189.setUSE("SunTextureAtlas")
...
IndexedFaceSet190.setTexCoordIndex([3,2,1,-1,1,0,3,-1,28,5,4,-1,4,29,28,-1,9,8,11,-1,11,10,9,-1,9,10,13,-1,13,12,9,-1,39,38,41,-1,41,40,39,-1,16,19,18,-1,18,15,16,-1,3,0,10,-1,10,11,3,-1,10,0,1,-1,1,13,10,-1,40,41,43,-1,43,42,40,-1,20,2,19,-1,19,16,20,-1,7,8,9,-1,9,6,7,-1,28,29,30,-1,30,31,28,-1,39,23,22,-1,22,38,39,-1,33,5,32,-1,32,34,33,-1,21,1,2,-1,2,20,21,-1,32,5,28,-1,28,35,32,-1,12,13,17,-1,17,14,12,-1,26,25,24,-1,24,27,26,-1,21,17,13,-1,13,1,21,-1,11,19,2,-1,2,3,11,-1,35,28,31,-1,31,36,35,-1,5,33,37,-1,37,4,5,-1,25,11,8,-1,8,24,25,-1,11,25,26,-1,26,19,11,-1,19,26,27,-1,27,18,19,-1,18,27,24,-1,24,8,18,-1])
...
HAnimJoint193.setCenter(x3d.doubleToFloat([0.05249,34.130001,-0.468]))
...
Transform195.setTranslation(x3d.doubleToFloat([0.05249,34.130001,-0.468]))
Shape196 = x3d.Shape()
...
HAnimJoint203.setCenter(x3d.doubleToFloat([0,51.25,-1.124]))
...
Transform205.setTranslation(x3d.doubleToFloat([0,51.25,-1.124]))
Shape206 = x3d.Shape()
...
EXPORT231.setAS("KoreanCharacter12Sun")
EXPORT231.setLocalDEF("hanim_Sun")

Scene21.addChild(EXPORT231)

X3D0.setScene(Scene21)
X3D0.toFileX3D("../data/KoreanCharacter12Sun.new.graalpy.x3d")
X3D0.toFileJSON("../data/KoreanCharacter12Sun.new.graalpy.x3dj")

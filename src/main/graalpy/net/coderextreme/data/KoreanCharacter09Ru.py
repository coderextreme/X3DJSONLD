...
meta11.setContent("../Poses/images/HAnimPoseExampleKoreanCharacter09Ru.png")
...
meta15.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter09Ru.x3d")
...
WorldInfo22.setTitle("KoreanCharacter09Ru.x3d")
...
Viewpoint24.setDescription("Ru")
Viewpoint24.setPosition(x3d.doubleToFloat([0,1,3]))

Scene21.addChild(Viewpoint24)
HAnimHumanoid25 = x3d.HAnimHumanoid()
HAnimHumanoid25.setName("Ru")
HAnimHumanoid25.setDEF("hanim_Ru")
HAnimHumanoid25.setScale(x3d.doubleToFloat([0.0225,0.0225,0.0225]))
HAnimHumanoid25.setVersion("2.0")

HAnimHumanoid25.addComments(x3d.CommentsBlock("""original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"'"""))
...
MetadataString30.setValue(["male"])
...
HAnimJoint33.setCenter(x3d.doubleToFloat([0,35.950001,-1.712]))
...
Transform35.setTranslation(x3d.doubleToFloat([0,35.950001,-1.712]))
Shape36 = x3d.Shape()
...
ImageTexture39.setDEF("RuTextureAtlas")
ImageTexture39.setUrl(["images/Ru.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ru.png"])
...
Coordinate41.setPoint(x3d.doubleToFloat([0,1.234,0,0,0.8727,-0.8727,-0.6171,0.8727,-0.6171,-0.8727,0.8727,0,-0.6171,0.8727,0.6171,0,0.8727,0.8727,0.6171,0.8727,0.6171,0.8727,0.8727,0,0.6171,0.8727,-0.6171,0,0,-1.234,-0.8727,0,-0.8727,-1.234,0,0,-0.8727,0,0.8727,0,0,1.234,0.8727,0,0.8727,1.234,0,0,0.8727,0,-0.8727,0,-0.8727,-0.8727,-0.6171,-0.8727,-0.6171,-0.8727,-0.8727,0,-0.6171,-0.8727,0.6171,0,-0.8727,0.8727,0.6171,-0.8727,0.6171,0.8727,-0.8727,0,0.6171,-0.8727,-0.6171,0,-1.234,0]))
...
HAnimJoint43.setCenter(x3d.doubleToFloat([3.602,33.740002,-1.967]))
...
Transform45.setTranslation(x3d.doubleToFloat([3.602,33.740002,-1.967]))
Shape46 = x3d.Shape()
...
ImageTexture49.setUSE("RuTextureAtlas")
...
HAnimJoint53.setCenter(x3d.doubleToFloat([3.931,18.23,-1.935]))
HAnimJoint53.setUlimit(x3d.doubleToFloat([0,0,0]))
HAnimJoint53.setLlimit(x3d.doubleToFloat([0,0,0]))

HAnimJoint53.addComments(x3d.CommentsBlock("""weight values go here in HAnimJoint, or within animating HAnimDisplacer"""))
HAnimSegment54 = x3d.HAnimSegment()
HAnimSegment54.setName("l_calf")
HAnimSegment54.setDEF("hanim_l_calf")
Transform55 = x3d.Transform()
Transform55.setTranslation(x3d.doubleToFloat([3.931,18.23,-1.935]))
Shape56 = x3d.Shape()
...
ImageTexture59.setUSE("RuTextureAtlas")
...
HAnimJoint63.setCenter(x3d.doubleToFloat([4.077,4.031,-1.998]))
...
Transform65.setTranslation(x3d.doubleToFloat([4.077,4.031,-1.998]))
Shape66 = x3d.Shape()
...
HAnimJoint73.setCenter(x3d.doubleToFloat([4.077,3.104,-0.9239]))
...
Transform75.setTranslation(x3d.doubleToFloat([4.077,3.104,-0.9239]))
Shape76 = x3d.Shape()
...
HAnimJoint83.setCenter(x3d.doubleToFloat([-3.602,33.740002,-1.967]))
...
Transform85.setTranslation(x3d.doubleToFloat([-3.602,33.740002,-1.967]))
Shape86 = x3d.Shape()
...
HAnimJoint93.setCenter(x3d.doubleToFloat([-3.931,18.23,-1.935]))
...
Transform95.setTranslation(x3d.doubleToFloat([-3.931,18.23,-1.935]))
Shape96 = x3d.Shape()
...
ImageTexture99.setUSE("RuTextureAtlas")
...
HAnimJoint103.setCenter(x3d.doubleToFloat([-4.077,4.031,-1.998]))
...
Transform105.setTranslation(x3d.doubleToFloat([-4.077,4.031,-1.998]))
Shape106 = x3d.Shape()
...
HAnimJoint113.setCenter(x3d.doubleToFloat([-4.077,3.104,-0.9239]))
...
Transform115.setTranslation(x3d.doubleToFloat([-4.077,3.104,-0.9239]))
Shape116 = x3d.Shape()
...
HAnimJoint123.setCenter(x3d.doubleToFloat([0,32.209999,-2.058]))
...
Transform125.setTranslation(x3d.doubleToFloat([0,32.209999,-2.058]))
Shape126 = x3d.Shape()
...
HAnimJoint133.setCenter(x3d.doubleToFloat([6.479,53.209999,-2.007]))
...
Transform135.setTranslation(x3d.doubleToFloat([6.479,53.209999,-2.007]))
Shape136 = x3d.Shape()
...
HAnimJoint143.setCenter(x3d.doubleToFloat([7.489,44.990002,-2.016]))
...
Transform145.setTranslation(x3d.doubleToFloat([7.489,44.990002,-2.016]))
Shape146 = x3d.Shape()
...
HAnimJoint153.setCenter(x3d.doubleToFloat([7.938,35.98,-1.856]))
...
Transform155.setTranslation(x3d.doubleToFloat([7.938,35.98,-1.856]))
Shape156 = x3d.Shape()
...
ImageTexture159.setUSE("RuTextureAtlas")
...
HAnimJoint163.setCenter(x3d.doubleToFloat([-6.479,53.209999,-2.007]))
...
Transform165.setTranslation(x3d.doubleToFloat([-6.479,53.209999,-2.007]))
Shape166 = x3d.Shape()
...
HAnimJoint173.setCenter(x3d.doubleToFloat([-7.489,44.990002,-2.016]))
...
Transform175.setTranslation(x3d.doubleToFloat([-7.489,44.990002,-2.016]))
Shape176 = x3d.Shape()
...
ImageTexture179.setUSE("RuTextureAtlas")
...
HAnimJoint183.setCenter(x3d.doubleToFloat([-7.938,35.98,-1.856]))
...
Transform185.setTranslation(x3d.doubleToFloat([-7.938,35.98,-1.856]))
Shape186 = x3d.Shape()
...
ImageTexture189.setUSE("RuTextureAtlas")
...
HAnimJoint193.setCenter(x3d.doubleToFloat([0,38.25,-1.903]))
...
Transform195.setTranslation(x3d.doubleToFloat([0,38.25,-1.903]))
Shape196 = x3d.Shape()
...
HAnimJoint203.setCenter(x3d.doubleToFloat([0,58.450001,-1.829]))
...
Transform205.setTranslation(x3d.doubleToFloat([0,58.450001,-1.829]))
Shape206 = x3d.Shape()
...
ImageTexture209.setUSE("RuTextureAtlas")
...
EXPORT231.setAS("KoreanCharacter09Ru")
EXPORT231.setLocalDEF("hanim_Ru")

Scene21.addChild(EXPORT231)

X3D0.setScene(Scene21)
X3D0.toFileX3D("../data/KoreanCharacter09Ru.new.graalpy.x3d")
X3D0.toFileJSON("../data/KoreanCharacter09Ru.new.graalpy.x3dj")

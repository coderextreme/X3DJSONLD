...
Viewpoint19.setOrientation(x3d.doubleToFloat([1,0,0,-1.57]))
Viewpoint19.setPosition(x3d.doubleToFloat([0,40,0]))
...
Viewpoint21.setPosition(x3d.doubleToFloat([0,0,15]))

Scene17.addChild(Viewpoint21)
Viewpoint22 = x3d.Viewpoint()
Viewpoint22.setDescription("ViewFrustum oblique side view")
Viewpoint22.setOrientation(x3d.doubleToFloat([0.8005,0.5926,0.0898,-0.3743]))
Viewpoint22.setPosition(x3d.doubleToFloat([-5,5,20]))
...
Transform44.setScale(x3d.doubleToFloat([5,5,5]))
Inline45 = x3d.Inline()

...
meta2 = x3d.meta()
meta2.setName("title")
meta2.setContent("WinterAndSpringAuthorsAllTitleBox.x3d")

head1.addMeta(meta2)
meta3 = x3d.meta()
meta3.setName("description")
meta3.setContent("Credits for scene authors.")
...
meta9.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringAuthorsAllTitleBox.x3d")
...
WorldInfo11.setTitle("WinterAndSpringAuthorsAllTitleBox.x3d")

Scene10.addChild(WorldInfo11)
Viewpoint12 = x3d.Viewpoint()
Viewpoint12.setDEF("WSAuthorsAllTitleView")
Viewpoint12.setDescription("Look at Authors title")
Viewpoint12.setPosition(x3d.doubleToFloat([10,11,0]))
Viewpoint12.setOrientation(x3d.doubleToFloat([-0.15,0,0,0.2]))

Scene10.addChild(Viewpoint12)
Transform13 = x3d.Transform()
Transform13.setDEF("WSAuthorsTitle")
Transform13.setTranslation(x3d.doubleToFloat([10,10,-5]))
Shape14 = x3d.Shape()
...
ImageTexture17.setUrl(["images/WSAuthorsAll.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSAuthorsAll.png"])
...
X3D0.toFileX3D("../data/WinterSpringAuthorsAllTitleBox.new.graalpy.x3d")
X3D0.toFileJSON("../data/WinterSpringAuthorsAllTitleBox.new.graalpy.x3dj")

...
meta2 = x3d.meta()
meta2.setName("title")
meta2.setContent("WinterAndSpringThanksAllTitleBox.x3d")
...
meta9.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringThanksAllTitleBox.x3d")
...
WorldInfo11.setTitle("WinterAndSpringThanksAllTitleBox.x3d")

Scene10.addChild(WorldInfo11)
Viewpoint12 = x3d.Viewpoint()
Viewpoint12.setDEF("WSThanksAllView")
Viewpoint12.setDescription("Look at Thanks title")
Viewpoint12.setPosition(x3d.doubleToFloat([10,11,-10]))
Viewpoint12.setOrientation(x3d.doubleToFloat([-0.15,0,0,0.2]))

Scene10.addChild(Viewpoint12)
Transform13 = x3d.Transform()
Transform13.setDEF("WSThanksAllTitle")
Transform13.setTranslation(x3d.doubleToFloat([10,10,-15]))
Shape14 = x3d.Shape()
...
ImageTexture17.setUrl(["images/WSThanksR2trimmed.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSThanksR2trimmed.png"])
...
X3D0.toFileX3D("../data/WinterSpringThanksAllTitleBox.new.graalpy.x3d")
X3D0.toFileJSON("../data/WinterSpringThanksAllTitleBox.new.graalpy.x3dj")

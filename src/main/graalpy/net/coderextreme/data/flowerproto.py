...
ComposedShader33.addComments(x3d.CommentsBlock('''<field name='cube' type='SFNode' accessType=\"inputOutput\"> <ComposedCubeMapTexture USE=\"texture\"/> </field>'''))
...
X3D0.toFileJSON("../data/flowerproto.new.graalpy.json")

...
meta3 = x3d.meta()
meta3.setName("title")
meta3.setContent("Tongue.x3d")

head1.addMeta(meta3)
meta4 = x3d.meta()
meta4.setName("description")
meta4.setContent("Facial Action Coding System (FACS) example for Action Unit (AU) 27, Mouth Stretch Morpher, Tongue Derivated.")

head1.addMeta(meta4)
meta5 = x3d.meta()
meta5.setName("creator")
meta5.setContent("Yujin Jung")

head1.addMeta(meta5)
meta6 = x3d.meta()
meta6.setName("translator")
meta6.setContent("Chul Hee Jung")

head1.addMeta(meta6)
meta7 = x3d.meta()
meta7.setName("translator")
meta7.setContent("Myeong Won Lee")

head1.addMeta(meta7)
meta8 = x3d.meta()
meta8.setName("created")
meta8.setContent("25 April 2022")

head1.addMeta(meta8)
meta9 = x3d.meta()
meta9.setName("modified")
meta9.setContent("27 October 2024")

head1.addMeta(meta9)
meta10 = x3d.meta()
meta10.setName("translator")
meta10.setContent("Don Brutzman")

head1.addMeta(meta10)
meta11 = x3d.meta()
meta11.setName("translator")
meta11.setContent("Joe D. Williams")

head1.addMeta(meta11)
meta12 = x3d.meta()
meta12.setName("reference")
meta12.setContent("https://en.wikipedia.org/wiki/Facial_Action_Coding_System")

head1.addMeta(meta12)
meta13 = x3d.meta()
meta13.setName("reference")
meta13.setContent("https://web.cs.wpi.edu/~matt/courses/cs563/talks/face_anim/ekman.html")

head1.addMeta(meta13)
meta14 = x3d.meta()
meta14.setName("reference")
meta14.setContent("Bryn Farnsworth, FACS Visual Guidebook https://imotions.com/blog/learning/research-fundamentals/facial-action-coding-system")

head1.addMeta(meta14)
meta15 = x3d.meta()
meta15.setName("generator")
meta15.setContent("Suwon VRLAB X3D Converter")

head1.addMeta(meta15)
meta16 = x3d.meta()
meta16.setName("MovingImage")
meta16.setContent("originals/SuwonHAnimFacialMotionConverter.mp4")
...
meta18.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/FacialAnimation/Tongue.x3d")
...
Viewpoint21.setDEF("HelloJin")
Viewpoint21.setDescription("Hello Jin! 안녕하세요 진!")
Viewpoint21.setPosition(x3d.doubleToFloat([0,20,60]))

Scene20.addChild(Viewpoint21)
TimeSensor22 = x3d.TimeSensor()
TimeSensor22.setDEF("JinMouthStretch_Clock")
TimeSensor22.setCycleInterval(0.99)
TimeSensor22.setLoop(True)

Scene20.addChild(TimeSensor22)
EXPORT23 = x3d.EXPORT()
EXPORT23.setLocalDEF("JinMouthStretch_Clock")
EXPORT23.setAS("JinMouthStretch_Clock")

Scene20.addChild(EXPORT23)
ScalarInterpolator24 = x3d.ScalarInterpolator()
ScalarInterpolator24.setDEF("AnimationAdapter_JinMouthStretch")
ScalarInterpolator24.setKey(x3d.doubleToFloat([0,0.25,0.5,0.75,1]))
ScalarInterpolator24.setKeyValue(x3d.doubleToFloat([0,0.5,1,0.5,0]))
...
HAnimJoint26.setDEF("hanim_root")
...
WorldInfo28.setTitle("Tongue.x3d")

HAnimSegment27.addChild(WorldInfo28)
Background29 = x3d.Background()
Background29.setSkyColor(x3d.doubleToFloat([0.8,0.9,1]))
...
HAnimJoint31.setName("skullbase")
HAnimJoint31.setDEF("hanim_skullbase")
...
HAnimSegment32.setName("tongue")
HAnimSegment32.setDEF("hanim_Tongue")
Transform33 = x3d.Transform()
Transform33.setDEF("Tongue")
Transform33.setTranslation(x3d.doubleToFloat([0,8.886,11.1]))
Shape34 = x3d.Shape()
Appearance35 = x3d.Appearance()
Appearance35.setDEF("BaseAppearance")
Material36 = x3d.Material()
Material36.setDEF("BaseMaterial")
...
Coordinate40.setDEF("Tongue_COORD")

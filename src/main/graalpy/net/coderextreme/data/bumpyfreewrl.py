...
meta14.setContent("https://coderextreme.net/X3DJSONLD/src/main/data/bumpfreewrl.x3d")
...
X3D0.toFileX3D("../data/bumpyfreewrl.new.graalpy.x3d")
X3D0.toFileJSON("../data/bumpyfreewrl.new.graalpy.x3dj")

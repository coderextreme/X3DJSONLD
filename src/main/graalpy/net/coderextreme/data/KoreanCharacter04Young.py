...
meta10.setContent("../Poses/images/HAnimPoseExampleKoreanCharacter04Young.png")
...
meta14.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter04Young.x3d")
...
WorldInfo21.setTitle("KoreanCharacter04Young.x3d")
...
HAnimJoint32.setCenter(x3d.doubleToFloat([0,31.540001,-0.3172]))
...
Transform34.setTranslation(x3d.doubleToFloat([0,31.540001,-0.3172]))
Shape35 = x3d.Shape()
...
ImageTexture38.setDEF("YoungTextureAtlas")
ImageTexture38.setUrl(["images/Young.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Young.png"])
...
HAnimJoint42.setCenter(x3d.doubleToFloat([3.504,29.040001,-0.4027]))
...
Transform44.setTranslation(x3d.doubleToFloat([3.504,29.040001,-0.4027]))
Shape45 = x3d.Shape()
...
ImageTexture48.setUSE("YoungTextureAtlas")
...
HAnimJoint52.setCenter(x3d.doubleToFloat([3.414,14.95,-0.4549]))
...
Transform54.setTranslation(x3d.doubleToFloat([3.414,14.95,-0.4549]))
Shape55 = x3d.Shape()
...
ImageTexture58.setUSE("YoungTextureAtlas")
...
HAnimJoint62.setCenter(x3d.doubleToFloat([3.18,3.449,-0.3088]))
...
Transform64.setTranslation(x3d.doubleToFloat([3.18,3.449,-0.3088]))
Shape65 = x3d.Shape()
...
ImageTexture68.setUSE("YoungTextureAtlas")
...
HAnimJoint72.setCenter(x3d.doubleToFloat([3.18,3.189,0.9724]))
...
Transform74.setTranslation(x3d.doubleToFloat([3.18,3.189,0.9724]))
Shape75 = x3d.Shape()
...
ImageTexture78.setUSE("YoungTextureAtlas")
...
HAnimJoint82.setCenter(x3d.doubleToFloat([-3.504,29.040001,-0.4027]))
...
Transform84.setTranslation(x3d.doubleToFloat([-3.504,29.040001,-0.4027]))
Shape85 = x3d.Shape()
...
ImageTexture88.setUSE("YoungTextureAtlas")
...
IndexedFaceSet89.setTexCoordIndex([0,2,3,-1,1,0,3,-1,3,4,5,-1,1,3,5,-1,6,1,5,-1,7,9,8,-1,8,10,7,-1,10,8,11,-1,11,12,10,-1,12,11,13,-1,13,14,12,-1,14,13,15,-1,15,16,14,-1,16,15,17,-1,17,18,16,-1,18,17,19,-1,19,20,18,-1,20,19,9,-1,9,7,20,-1,9,22,21,-1,21,8,9,-1,8,21,23,-1,23,11,8,-1,11,23,24,-1,24,13,11,-1,13,24,25,-1,25,15,13,-1,15,25,26,-1,26,17,15,-1,17,26,27,-1,27,19,17,-1,19,27,22,-1,22,9,19,-1,22,29,28,-1,28,21,22,-1,21,28,30,-1,30,23,21,-1,23,30,31,-1,31,24,23,-1,24,31,32,-1,32,25,24,-1,25,32,33,-1,33,26,25,-1,26,33,34,-1,34,27,26,-1,27,34,29,-1,29,22,27,-1,46,45,44,-1,44,43,42,-1,46,44,42,-1,47,46,42,-1,48,47,42,-1,35,28,29,-1,29,36,35,-1,37,30,28,-1,28,35,37,-1,38,31,30,-1,30,37,38,-1,39,32,31,-1,31,38,39,-1,40,33,32,-1,32,39,40,-1,41,34,33,-1,33,40,41,-1,36,29,34,-1,34,41,36,-1,51,50,49,-1,49,52,51,-1,54,53,50,-1,50,51,54,-1,56,55,53,-1,53,54,56,-1,58,57,55,-1,55,56,58,-1,60,59,57,-1,57,58,60,-1,62,61,59,-1,59,60,62,-1,52,49,61,-1,61,62,52,-1,1,7,10,-1,10,0,1,-1,0,10,12,-1,12,2,0,-1,2,12,14,-1,14,3,2,-1,3,14,16,-1,16,4,3,-1,4,16,18,-1,18,5,4,-1,5,18,20,-1,20,6,5,-1,6,20,7,-1,7,1,6,-1,63,51,52,-1,52,64,63,-1,65,54,51,-1,51,63,65,-1,66,56,54,-1,54,65,66,-1,67,58,56,-1,56,66,67,-1,68,60,58,-1,58,67,68,-1,69,62,60,-1,60,68,69,-1,64,52,62,-1,62,69,64,-1,43,63,64,-1,64,42,43,-1,44,65,63,-1,63,43,44,-1,45,66,65,-1,65,44,45,-1,46,67,66,-1,66,45,46,-1,47,68,67,-1,67,46,47,-1,48,69,68,-1,68,47,48,-1,42,64,69,-1,69,48,42,-1])
...
HAnimJoint92.setCenter(x3d.doubleToFloat([-3.414,14.95,-0.4549]))
...
Transform94.setTranslation(x3d.doubleToFloat([-3.414,14.95,-0.4549]))
Shape95 = x3d.Shape()
...
ImageTexture98.setUSE("YoungTextureAtlas")
...
HAnimJoint102.setCenter(x3d.doubleToFloat([-3.18,3.449,-0.3088]))
...
Transform104.setTranslation(x3d.doubleToFloat([-3.18,3.449,-0.3088]))
Shape105 = x3d.Shape()
...
ImageTexture108.setUSE("YoungTextureAtlas")
...
HAnimJoint112.setCenter(x3d.doubleToFloat([-3.18,3.189,0.9724]))
...
Transform114.setTranslation(x3d.doubleToFloat([-3.18,3.189,0.9724]))
Shape115 = x3d.Shape()
...
ImageTexture118.setUSE("YoungTextureAtlas")
...
HAnimJoint122.setCenter(x3d.doubleToFloat([0,27.07,-0.3172]))
...
Transform124.setTranslation(x3d.doubleToFloat([0,27.07,-0.3172]))
Shape125 = x3d.Shape()
...
ImageTexture128.setUSE("YoungTextureAtlas")
...
HAnimJoint132.setCenter(x3d.doubleToFloat([5.441,45.830002,0.1786]))
...
Transform134.setTranslation(x3d.doubleToFloat([5.441,45.830002,0.1786]))
Shape135 = x3d.Shape()
...
ImageTexture138.setUSE("YoungTextureAtlas")
...
HAnimJoint142.setCenter(x3d.doubleToFloat([6.823,36.080002,0.08607]))
...
Transform144.setTranslation(x3d.doubleToFloat([6.823,36.080002,0.08607]))
Shape145 = x3d.Shape()
...
ImageTexture148.setUSE("YoungTextureAtlas")
...
HAnimJoint152.setCenter(x3d.doubleToFloat([6.915,28.41,0.3752]))
...
Transform154.setTranslation(x3d.doubleToFloat([6.915,28.41,0.3752]))
Shape155 = x3d.Shape()
...
ImageTexture158.setUSE("YoungTextureAtlas")
...
HAnimJoint162.setCenter(x3d.doubleToFloat([-5.441,45.830002,0.1786]))
...
Transform164.setTranslation(x3d.doubleToFloat([-5.441,45.830002,0.1786]))
Shape165 = x3d.Shape()
...
ImageTexture168.setUSE("YoungTextureAtlas")
...
HAnimJoint172.setCenter(x3d.doubleToFloat([-6.823,36.080002,0.08607]))
...
Transform174.setTranslation(x3d.doubleToFloat([-6.823,36.080002,0.08607]))
Shape175 = x3d.Shape()
...
ImageTexture178.setUSE("YoungTextureAtlas")
...
HAnimJoint182.setCenter(x3d.doubleToFloat([-6.915,28.41,0.3752]))
...
Transform184.setTranslation(x3d.doubleToFloat([-6.915,28.41,0.3752]))
Shape185 = x3d.Shape()
...
ImageTexture188.setUSE("YoungTextureAtlas")
...
HAnimJoint192.setCenter(x3d.doubleToFloat([0,35.75,-0.445]))
...
Transform194.setTranslation(x3d.doubleToFloat([0,35.75,-0.445]))
Shape195 = x3d.Shape()
...
ImageTexture198.setUSE("YoungTextureAtlas")
...
HAnimJoint202.setCenter(x3d.doubleToFloat([0,50.470001,-0.1481]))
...
Transform204.setTranslation(x3d.doubleToFloat([0,50.470001,-0.1481]))
Shape205 = x3d.Shape()
...
EXPORT230.setAS("KoreanCharacter04Young")
EXPORT230.setLocalDEF("hanim_Young")

Scene20.addChild(EXPORT230)

X3D0.setScene(Scene20)
X3D0.toFileX3D("../data/KoreanCharacter04Young.new.graalpy.x3d")
X3D0.toFileJSON("../data/KoreanCharacter04Young.new.graalpy.x3dj")

...
meta10.setContent("../Poses/images/HAnimPoseExampleKoreanCharacter06Ga.png")
...
meta14.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter06Ga.x3d")
...
WorldInfo21.setTitle("KoreanCharacter06Ga.x3d")
...
HAnimJoint32.setCenter(x3d.doubleToFloat([0,32.310001,-0.7076]))
...
Transform34.setTranslation(x3d.doubleToFloat([0,32.310001,-0.7076]))
Shape35 = x3d.Shape()
...
ImageTexture38.setDEF("GaTextureAtlas")
ImageTexture38.setUrl(["images/Ga.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ga.png"])
...
HAnimJoint42.setCenter(x3d.doubleToFloat([2.906,30.18,-0.2966]))
...
Transform44.setTranslation(x3d.doubleToFloat([2.906,30.18,-0.2966]))
Shape45 = x3d.Shape()
...
HAnimJoint52.setCenter(x3d.doubleToFloat([3.116,16.92,-0.2161]))
...
Transform54.setTranslation(x3d.doubleToFloat([3.116,16.92,-0.2161]))
Shape55 = x3d.Shape()
...
HAnimJoint62.setCenter(x3d.doubleToFloat([3.28,4.021,-0.2439]))
...
Transform64.setTranslation(x3d.doubleToFloat([3.28,4.021,-0.2439]))
Shape65 = x3d.Shape()
...
ImageTexture68.setUSE("GaTextureAtlas")
...
HAnimJoint72.setCenter(x3d.doubleToFloat([3.28,3.095,0.83]))
...
Transform74.setTranslation(x3d.doubleToFloat([3.28,3.095,0.83]))
Shape75 = x3d.Shape()
...
ImageTexture78.setUSE("GaTextureAtlas")
...
HAnimJoint82.setCenter(x3d.doubleToFloat([-2.906,30.18,-0.2966]))
...
Transform84.setTranslation(x3d.doubleToFloat([-2.906,30.18,-0.2966]))
Shape85 = x3d.Shape()
...
HAnimJoint92.setCenter(x3d.doubleToFloat([-3.116,16.92,-0.2161]))
...
Transform94.setTranslation(x3d.doubleToFloat([-3.116,16.92,-0.2161]))
Shape95 = x3d.Shape()
...
HAnimJoint102.setCenter(x3d.doubleToFloat([-3.28,4.021,-0.2439]))
...
Transform104.setTranslation(x3d.doubleToFloat([-3.28,4.021,-0.2439]))
Shape105 = x3d.Shape()
...
ImageTexture108.setUSE("GaTextureAtlas")
...
IndexedFaceSet109.setTexCoordIndex([0,5,2,-1,2,1,0,-1,3,1,2,-1,2,4,3,-1,1,3,4,-1,4,2,1,-1,0,1,2,-1,2,5,0,-1,33,9,5,-1,5,0,33,-1,0,8,38,-1,38,33,0,-1,10,1,0,-1,0,8,10,-1,11,3,1,-1,1,10,11,-1,10,1,3,-1,3,11,10,-1,8,0,1,-1,1,10,8,-1,8,12,35,-1,35,38,8,-1,13,10,8,-1,8,12,13,-1,14,11,10,-1,10,13,14,-1,13,10,11,-1,11,14,13,-1,12,8,10,-1,10,13,12,-1,2,5,22,-1,22,20,2,-1,4,2,20,-1,20,21,4,-1,2,4,21,-1,21,20,2,-1,5,2,20,-1,20,22,5,-1,19,9,5,-1,5,22,19,-1,24,9,31,-1,31,23,24,-1,22,5,9,-1,9,24,22,-1,15,6,7,-1,7,16,15,-1,17,16,7,-1,7,18,17,-1,18,7,40,-1,40,34,18,-1,25,29,30,-1,30,29,25,-1,25,30,25,-1,25,28,27,-1,25,25,27,-1,26,25,27,-1,22,25,26,-1,26,19,22,-1,19,26,27,-1,27,23,19,-1,23,27,28,-1,28,24,23,-1,24,28,25,-1,25,22,24,-1,22,25,29,-1,29,20,22,-1,20,29,30,-1,30,21,20,-1,21,30,29,-1,29,20,21,-1,20,29,25,-1,25,22,20,-1,31,9,19,-1,19,23,31,-1,6,36,40,-1,40,7,6,-1,0,32,39,-1,39,8,0,-1,8,39,37,-1,37,12,8,-1,0,5,9,-1,9,32,0,-1,42,41,49,-1,42,49,48,-1,48,47,46,-1,48,46,45,-1,42,48,45,-1,45,44,43,-1,42,45,43,-1,42,43,41,-1,9,41,42,-1,42,31,9,-1,31,42,41,-1,41,9,31,-1,9,41,43,-1,43,32,9,-1,32,43,44,-1,44,39,32,-1,39,44,45,-1,45,37,39,-1,36,45,46,-1,46,40,36,-1,40,46,47,-1,47,34,40,-1,35,47,48,-1,48,38,35,-1,38,48,49,-1,49,33,38,-1,33,49,41,-1,41,9,33,-1])
...
HAnimJoint112.setCenter(x3d.doubleToFloat([-3.28,3.095,0.83]))
...
Transform114.setTranslation(x3d.doubleToFloat([-3.28,3.095,0.83]))
Shape115 = x3d.Shape()
...
ImageTexture118.setUSE("GaTextureAtlas")
...
HAnimJoint122.setCenter(x3d.doubleToFloat([0,29.389999,-0.3829]))
...
Transform124.setTranslation(x3d.doubleToFloat([0,29.389999,-0.3829]))
Shape125 = x3d.Shape()
...
HAnimJoint132.setCenter(x3d.doubleToFloat([6.499,47.529999,-0.7415]))
...
Transform134.setTranslation(x3d.doubleToFloat([6.499,47.529999,-0.7415]))
Shape135 = x3d.Shape()
...
HAnimJoint142.setCenter(x3d.doubleToFloat([6.851,38.779999,-0.7886]))
...
Transform144.setTranslation(x3d.doubleToFloat([6.851,38.779999,-0.7886]))
Shape145 = x3d.Shape()
...
HAnimJoint152.setCenter(x3d.doubleToFloat([7.219,32.48,-0.434]))
...
Transform154.setTranslation(x3d.doubleToFloat([7.219,32.48,-0.434]))
Shape155 = x3d.Shape()
...
HAnimJoint162.setCenter(x3d.doubleToFloat([-6.499,47.529999,-0.7415]))
...
Transform164.setTranslation(x3d.doubleToFloat([-6.499,47.529999,-0.7415]))
Shape165 = x3d.Shape()
...
HAnimJoint172.setCenter(x3d.doubleToFloat([-6.851,38.779999,-0.7886]))
...
Transform174.setTranslation(x3d.doubleToFloat([-6.851,38.779999,-0.7886]))
Shape175 = x3d.Shape()
...
HAnimJoint182.setCenter(x3d.doubleToFloat([-7.219,32.48,-0.434]))
...
Transform184.setTranslation(x3d.doubleToFloat([-7.219,32.48,-0.434]))
Shape185 = x3d.Shape()
...
ImageTexture188.setUSE("GaTextureAtlas")
...
HAnimJoint192.setCenter(x3d.doubleToFloat([0,34.389999,-0.1643]))
...
Transform194.setTranslation(x3d.doubleToFloat([0,34.389999,-0.1643]))
Shape195 = x3d.Shape()
...
HAnimJoint202.setCenter(x3d.doubleToFloat([0,52.639999,-0.209]))
...
Transform204.setTranslation(x3d.doubleToFloat([0,52.639999,-0.209]))
Shape205 = x3d.Shape()
...
EXPORT230.setAS("KoreanCharacter06Ga")
EXPORT230.setLocalDEF("hanim_Ga")

Scene20.addChild(EXPORT230)

X3D0.setScene(Scene20)
X3D0.toFileX3D("../data/KoreanCharacter06Ga.new.graalpy.x3d")
X3D0.toFileJSON("../data/KoreanCharacter06Ga.new.graalpy.x3dj")

...
Transform23.setTranslation(x3d.doubleToFloat([6.14221,0.0694613,-0.000999451]))
Shape24 = x3d.Shape()
...
Transform29.setTranslation(x3d.doubleToFloat([-4.85443,0.0694381,-0.00149918]))
Shape30 = x3d.Shape()
...
Transform35.setTranslation(x3d.doubleToFloat([-1.47341,0.036672,-0.00175095]))
Shape36 = x3d.Shape()
...
Transform41.setTranslation(x3d.doubleToFloat([2.31094,0.0694206,-0.00187683]))
Shape42 = x3d.Shape()
...
X3D0.toFileX3D("../data/rgb_alpha.new.graalpy.x3d")
X3D0.toFileJSON("../data/rgb_alpha.new.graalpy.x3dj")

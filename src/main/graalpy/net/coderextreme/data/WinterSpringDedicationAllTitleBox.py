...
meta2 = x3d.meta()
meta2.setName("title")
meta2.setContent("WinterAndSpringDedicationAllTitleBox.x3d")

head1.addMeta(meta2)
meta3 = x3d.meta()
meta3.setName("description")
meta3.setContent("Credits for scene dedications.")
...
meta9.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringDedicationAllTitleBox.x3d")
...
WorldInfo11.setTitle("WinterAndSpringDedicationAllTitleBox.x3d")

Scene10.addChild(WorldInfo11)
Viewpoint12 = x3d.Viewpoint()
Viewpoint12.setDEF("WSDedicationAllTitleView")
Viewpoint12.setDescription("Look at Dedication title")
...
Transform13.setDEF("WSDedicationAllTitle")
Transform13.setTranslation(x3d.doubleToFloat([10,10,-10]))
Shape14 = x3d.Shape()
...
ImageTexture17.setUrl(["images/WSDedicationAll.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSDedicationAll.png"])
...
X3D0.toFileX3D("../data/WinterSpringDedicationAllTitleBox.new.graalpy.x3d")
X3D0.toFileJSON("../data/WinterSpringDedicationAllTitleBox.new.graalpy.x3dj")

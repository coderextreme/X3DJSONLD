...
Background18.setGroundAngle(x3d.doubleToFloat([1.57]))
Background18.setGroundColor(x3d.doubleToFloat([0,0.5,0,0,0.5,0]))
Background18.setSkyColor(x3d.doubleToFloat([0,0,1]))
...
Viewpoint21.setOrientation(x3d.doubleToFloat([1,0,0,-1.57]))
Viewpoint21.setPosition(x3d.doubleToFloat([0,10,0]))
...
X3D0.toFileX3D("../data/jumpcut_loadurl.new.graalpy.x3d")
X3D0.toFileJSON("../data/jumpcut_loadurl.new.graalpy.json")

...
meta11.setContent("../Poses/images/HAnimPoseExampleKoreanCharacter10Mi.png")
...
meta15.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter10Mi.x3d")
...
WorldInfo22.setTitle("KoreanCharacter10Mi.x3d")
...
HAnimJoint33.setCenter(x3d.doubleToFloat([0,32.68,-0.7076]))
...
Transform35.setTranslation(x3d.doubleToFloat([0,32.68,-0.7076]))
Shape36 = x3d.Shape()
...
ImageTexture39.setDEF("MiTextureAtlas")
ImageTexture39.setUrl(["images/Mi.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Mi.png"])
...
HAnimJoint43.setCenter(x3d.doubleToFloat([3.309,31.309999,-0.8377]))
...
Transform45.setTranslation(x3d.doubleToFloat([3.309,31.309999,-0.8377]))
Shape46 = x3d.Shape()
...
ImageTexture49.setUSE("MiTextureAtlas")
...
HAnimJoint53.setCenter(x3d.doubleToFloat([3.584,17.16,-1.037]))
...
Transform55.setTranslation(x3d.doubleToFloat([3.584,17.16,-1.037]))
Shape56 = x3d.Shape()
...
HAnimJoint63.setCenter(x3d.doubleToFloat([3.602,4.137,0.6104]))
...
Transform65.setTranslation(x3d.doubleToFloat([3.602,4.137,0.6104]))
Shape66 = x3d.Shape()
...
HAnimJoint73.setCenter(x3d.doubleToFloat([3.602,3.02,0.07017]))
...
Transform75.setTranslation(x3d.doubleToFloat([3.602,3.02,0.07017]))
Shape76 = x3d.Shape()
...
HAnimJoint83.setCenter(x3d.doubleToFloat([-3.309,31.309999,-0.8377]))
...
Transform85.setTranslation(x3d.doubleToFloat([-3.309,31.309999,-0.8377]))
Shape86 = x3d.Shape()
...
HAnimJoint93.setCenter(x3d.doubleToFloat([-3.584,17.16,-1.037]))
...
Transform95.setTranslation(x3d.doubleToFloat([-3.584,17.16,-1.037]))
Shape96 = x3d.Shape()
...
HAnimJoint103.setCenter(x3d.doubleToFloat([-3.602,4.137,0.6104]))
...
Transform105.setTranslation(x3d.doubleToFloat([-3.602,4.137,0.6104]))
Shape106 = x3d.Shape()
...
HAnimJoint113.setCenter(x3d.doubleToFloat([-3.602,3.02,0.07017]))
...
Transform115.setTranslation(x3d.doubleToFloat([-3.602,3.02,0.07017]))
Shape116 = x3d.Shape()
...
HAnimJoint123.setCenter(x3d.doubleToFloat([0.05053,30.200001,-1.38]))
...
Transform125.setTranslation(x3d.doubleToFloat([0.05053,30.200001,-1.38]))
Shape126 = x3d.Shape()
...
HAnimJoint133.setCenter(x3d.doubleToFloat([6.032,48.580002,-1.277]))
...
Transform135.setTranslation(x3d.doubleToFloat([6.032,48.580002,-1.277]))
Shape136 = x3d.Shape()
...
HAnimJoint143.setCenter(x3d.doubleToFloat([6.032,40.810001,-1.412]))
...
Transform145.setTranslation(x3d.doubleToFloat([6.032,40.810001,-1.412]))
Shape146 = x3d.Shape()
...
HAnimJoint153.setCenter(x3d.doubleToFloat([6.934,33.959999,-1.108]))
...
Transform155.setTranslation(x3d.doubleToFloat([6.934,33.959999,-1.108]))
Shape156 = x3d.Shape()
...
ImageTexture159.setUSE("MiTextureAtlas")
...
HAnimJoint163.setCenter(x3d.doubleToFloat([-6.032,48.580002,-1.277]))
...
Transform165.setTranslation(x3d.doubleToFloat([-6.032,48.580002,-1.277]))
Shape166 = x3d.Shape()
...
HAnimJoint173.setCenter(x3d.doubleToFloat([-6.032,40.810001,-1.412]))
...
Transform175.setTranslation(x3d.doubleToFloat([-6.032,40.810001,-1.412]))
Shape176 = x3d.Shape()
...
ImageTexture179.setUSE("MiTextureAtlas")
...
HAnimJoint183.setCenter(x3d.doubleToFloat([-6.934,33.959999,-1.108]))
...
Transform185.setTranslation(x3d.doubleToFloat([-6.934,33.959999,-1.108]))
Shape186 = x3d.Shape()
...
ImageTexture189.setUSE("MiTextureAtlas")
...
HAnimJoint193.setCenter(x3d.doubleToFloat([0,35.310001,-2.314]))
...
Transform195.setTranslation(x3d.doubleToFloat([0,35.310001,-2.314]))
Shape196 = x3d.Shape()
...
HAnimJoint203.setCenter(x3d.doubleToFloat([0,35.310001,-2.314]))
...
Transform205.setTranslation(x3d.doubleToFloat([0,35.310001,-2.314]))
Shape206 = x3d.Shape()
...
EXPORT231.setAS("KoreanCharacter10Mi")
EXPORT231.setLocalDEF("hanim_Mi")

Scene21.addChild(EXPORT231)

X3D0.setScene(Scene21)
X3D0.toFileX3D("../data/KoreanCharacter10Mi.new.graalpy.x3d")
X3D0.toFileJSON("../data/KoreanCharacter10Mi.new.graalpy.x3dj")

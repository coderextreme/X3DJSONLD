...
Material13.setDiffuseColor(x3d.doubleToFloat([0.7,0.2,0.2]))
...
Transform17.setTranslation(x3d.doubleToFloat([1,-1,0.01]))
Shape18 = x3d.Shape()
Appearance19 = x3d.Appearance()
Material20 = x3d.Material()
Material20.setDiffuseColor(x3d.doubleToFloat([0.2,0.7,0.2]))
...
PlaneSensor22.setOffset(x3d.doubleToFloat([1,-1,0.01]))
...
Material28.setDiffuseColor(x3d.doubleToFloat([0.2,0.7,0.7]))
...
ROUTE62 = x3d.ROUTE()
ROUTE62.setFromNode("G1")
ROUTE62.setFromField("translation_changed")
ROUTE62.setToNode("connector1")
ROUTE62.setToField("set_startpoint")

Scene7.addChild(ROUTE62)
ROUTE63 = x3d.ROUTE()
ROUTE63.setFromNode("G2")
ROUTE63.setFromField("translation_changed")
ROUTE63.setToNode("connector1")
ROUTE63.setToField("set_endpoint")

Scene7.addChild(ROUTE63)

X3D0.setScene(Scene7)
X3D0.toFileX3D("../data/x3dconnector.new.graalpy.x3d")
X3D0.toFileJSON("../data/x3dconnector.new.graalpy.x3dj")

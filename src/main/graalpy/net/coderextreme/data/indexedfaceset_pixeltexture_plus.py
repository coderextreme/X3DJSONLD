...
TextureCoordinate37.setPoint(x3d.doubleToFloat([-1,2,-1,-1,2,2,2,-1]))
...
X3D0.toFileX3D("../data/indexedfaceset_pixeltexture_plus.new.graalpy.x3d")
X3D0.toFileJSON("../data/indexedfaceset_pixeltexture_plus.new.graalpy.json")

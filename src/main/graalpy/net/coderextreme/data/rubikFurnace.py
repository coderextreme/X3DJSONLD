...
NavigationInfo8.setType(["ANY","EXAMINE","WALK","FLY","LOOKAT"])
...
Shape98 = x3d.Shape()
Box99 = x3d.Box()
Box99.setSize(x3d.doubleToFloat([1,1,1]))

Shape98.setGeometry(Box99)
Appearance100 = x3d.Appearance()
Material101 = x3d.Material()
Material101.setDiffuseColor(x3d.doubleToFloat([0,1,0]))
...
X3D0.toFileX3D("../data/rubikFurnace.new.graalpy.x3d")
X3D0.toFileJSON("../data/rubikFurnace.new.graalpy.x3dj")

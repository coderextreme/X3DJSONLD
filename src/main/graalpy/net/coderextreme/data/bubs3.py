...
Transform11.setDEF("DECLBubble_transformA")
Shape12 = x3d.Shape()
Sphere13 = x3d.Sphere()
...
ROUTE23.setToNode("DECLBubble_transformA")
...
ROUTE24.setToNode("DECLBubble_transformA")
...
Transform26.setDEF("DECLBubble_transformB")
Shape27 = x3d.Shape()
Sphere28 = x3d.Sphere()
...
ROUTE38.setToNode("DECLBubble_transformB")
...
ROUTE39.setToNode("DECLBubble_transformB")
...
Transform41.setDEF("DECLBubble_transformC")
Shape42 = x3d.Shape()
Sphere43 = x3d.Sphere()
...
ROUTE53.setToNode("DECLBubble_transformC")
...
ROUTE54.setToNode("DECLBubble_transformC")
...
Transform56.setDEF("DECLBubble_transformD")
Shape57 = x3d.Shape()
Sphere58 = x3d.Sphere()
...
ROUTE68.setToNode("DECLBubble_transformD")
...
ROUTE69.setToNode("DECLBubble_transformD")
...
X3D0.toFileX3D("../data/bubs3.new.graalpy.x3d")
X3D0.toFileJSON("../data/bubs3.new.graalpy.x3dj")

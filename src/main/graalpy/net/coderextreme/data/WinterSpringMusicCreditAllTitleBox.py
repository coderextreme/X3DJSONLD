...
meta2 = x3d.meta()
meta2.setName("title")
meta2.setContent("WinterAndSpringMusicCreditAllTitleBox.x3d")

head1.addMeta(meta2)
meta3 = x3d.meta()
meta3.setName("description")
meta3.setContent("Credits for scene musics clips.")
...
meta9.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringMusicCreditAllTitleBox.x3d")
...
WorldInfo11.setTitle("WinterAndSpringMusicCreditAllTitleBox.x3d")

Scene10.addChild(WorldInfo11)
Viewpoint12 = x3d.Viewpoint()
Viewpoint12.setDEF("WSAuthorsAllTitleView")
Viewpoint12.setDescription("Look at Music Credit title")
Viewpoint12.setPosition(x3d.doubleToFloat([10,11,-15]))
Viewpoint12.setOrientation(x3d.doubleToFloat([-0.15,0,0,0.2]))

Scene10.addChild(Viewpoint12)
Transform13 = x3d.Transform()
Transform13.setDEF("WSMusicCreditAllTitle")
Transform13.setTranslation(x3d.doubleToFloat([10,10,-20]))
Shape14 = x3d.Shape()
...
ImageTexture17.setUrl(["images/WSMusicCreditAll.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSMusicCreditAll.png"])
...
X3D0.toFileX3D("../data/WinterSpringMusicCreditAllTitleBox.new.graalpy.x3d")
X3D0.toFileJSON("../data/WinterSpringMusicCreditAllTitleBox.new.graalpy.x3dj")

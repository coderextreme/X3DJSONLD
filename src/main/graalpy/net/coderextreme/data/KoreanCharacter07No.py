...
meta10.setContent("../Poses/images/HAnimPoseExampleKoreanCharacter07No.png")
...
meta14.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter07No.x3d")
...
WorldInfo21.setTitle("KoreanCharacter07No.x3d")
...
Viewpoint23.setDescription("No")
Viewpoint23.setPosition(x3d.doubleToFloat([0,1,3]))

Scene20.addChild(Viewpoint23)
HAnimHumanoid24 = x3d.HAnimHumanoid()
HAnimHumanoid24.setName("No")
HAnimHumanoid24.setDEF("hanim_No")
HAnimHumanoid24.setScale(x3d.doubleToFloat([0.0225,0.0225,0.0225]))
HAnimHumanoid24.setVersion("2.0")

HAnimHumanoid24.addComments(x3d.CommentsBlock("""original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"'"""))
...
MetadataString29.setValue(["male"])
...
HAnimJoint32.setCenter(x3d.doubleToFloat([0,34.790001,-1.299]))
...
Transform34.setTranslation(x3d.doubleToFloat([0,34.790001,-1.299]))
Shape35 = x3d.Shape()
...
ImageTexture38.setDEF("NoTextureAtlas")
ImageTexture38.setUrl(["images/No.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/No.png"])
...
HAnimJoint42.setCenter(x3d.doubleToFloat([3.785,34.07,-1.57]))
...
Transform44.setTranslation(x3d.doubleToFloat([3.785,34.07,-1.57]))
Shape45 = x3d.Shape()
...
HAnimJoint52.setCenter(x3d.doubleToFloat([3.838,18.4,-1.212]))
...
Transform54.setTranslation(x3d.doubleToFloat([3.838,18.4,-1.212]))
Shape55 = x3d.Shape()
...
HAnimJoint62.setCenter(x3d.doubleToFloat([3.826,4.044,-1.361]))
...
Transform64.setTranslation(x3d.doubleToFloat([3.826,4.044,-1.361]))
Shape65 = x3d.Shape()
...
ImageTexture68.setUSE("NoTextureAtlas")
...
HAnimJoint72.setCenter(x3d.doubleToFloat([3.826,3.118,-0.2867]))
...
Transform74.setTranslation(x3d.doubleToFloat([3.826,3.118,-0.2867]))
Shape75 = x3d.Shape()
...
HAnimJoint82.setCenter(x3d.doubleToFloat([-3.785,34.07,-1.57]))
...
Transform84.setTranslation(x3d.doubleToFloat([-3.785,34.07,-1.57]))
Shape85 = x3d.Shape()
...
HAnimJoint92.setCenter(x3d.doubleToFloat([-3.838,18.4,-1.212]))
...
Transform94.setTranslation(x3d.doubleToFloat([-3.838,18.4,-1.212]))
Shape95 = x3d.Shape()
...
HAnimJoint102.setCenter(x3d.doubleToFloat([-3.826,4.044,-1.361]))
...
Transform104.setTranslation(x3d.doubleToFloat([-3.826,4.044,-1.361]))
Shape105 = x3d.Shape()
...
ImageTexture108.setUSE("NoTextureAtlas")
...
HAnimJoint112.setCenter(x3d.doubleToFloat([-3.826,3.118,-0.2867]))
...
Transform114.setTranslation(x3d.doubleToFloat([-3.826,3.118,-0.2867]))
Shape115 = x3d.Shape()
...
HAnimJoint122.setCenter(x3d.doubleToFloat([0,32.91,-1.57]))
...
Transform124.setTranslation(x3d.doubleToFloat([0,32.91,-1.57]))
Shape125 = x3d.Shape()
...
HAnimJoint132.setCenter(x3d.doubleToFloat([7.266,54.049999,-1.79]))
...
Transform134.setTranslation(x3d.doubleToFloat([7.266,54.049999,-1.79]))
Shape135 = x3d.Shape()
...
HAnimJoint142.setCenter(x3d.doubleToFloat([7.834,43.389999,-1.651]))
...
Transform144.setTranslation(x3d.doubleToFloat([7.834,43.389999,-1.651]))
Shape145 = x3d.Shape()
...
HAnimJoint152.setCenter(x3d.doubleToFloat([7.738,35.43,-1.558]))
...
Transform154.setTranslation(x3d.doubleToFloat([7.738,35.43,-1.558]))
Shape155 = x3d.Shape()
...
HAnimJoint162.setCenter(x3d.doubleToFloat([-7.266,54.049999,-1.79]))
...
Transform164.setTranslation(x3d.doubleToFloat([-7.266,54.049999,-1.79]))
Shape165 = x3d.Shape()
...
HAnimJoint172.setCenter(x3d.doubleToFloat([-7.834,43.389999,-1.651]))
...
Transform174.setTranslation(x3d.doubleToFloat([-7.834,43.389999,-1.651]))
Shape175 = x3d.Shape()
...
HAnimJoint182.setCenter(x3d.doubleToFloat([-7.738,35.43,-1.558]))
...
Transform184.setTranslation(x3d.doubleToFloat([-7.738,35.43,-1.558]))
Shape185 = x3d.Shape()
...
HAnimJoint192.setCenter(x3d.doubleToFloat([0,37.060001,-1.409]))
...
Transform194.setTranslation(x3d.doubleToFloat([0,37.060001,-1.409]))
Shape195 = x3d.Shape()
...
HAnimJoint202.setCenter(x3d.doubleToFloat([0,37.060001,-1.409]))
...
Transform204.setTranslation(x3d.doubleToFloat([0,37.060001,-1.409]))
Shape205 = x3d.Shape()
...
EXPORT230.setAS("KoreanCharacter07No")
EXPORT230.setLocalDEF("hanim_No")

...
meta3 = x3d.meta()
meta3.setName("title")
meta3.setContent("KoreanCharacter07No.x3d")
...
meta13.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter07No.x3d")
...
WorldInfo20.setTitle("KoreanCharacter07No.x3d")
...
Viewpoint22.setDescription("No")
Viewpoint22.setPosition(x3d.doubleToFloat([0,1,3]))

Scene19.addChild(Viewpoint22)
HAnimHumanoid23 = x3d.HAnimHumanoid()
HAnimHumanoid23.setName("No")
HAnimHumanoid23.setDEF("hanim_No")
HAnimHumanoid23.setScale(x3d.doubleToFloat([0.0225,0.0225,0.0225]))
HAnimHumanoid23.setVersion("2.0")

HAnimHumanoid23.addComments(x3d.CommentsBlock('''original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"''''))
...
MetadataString28.setValue(["male"])
...
HAnimJoint31.setCenter(x3d.doubleToFloat([0,34.790001,-1.299]))
...
Transform33.setTranslation(x3d.doubleToFloat([0,34.790001,-1.299]))
Shape34 = x3d.Shape()
...
ImageTexture37.setDEF("NoTextureAtlas")
ImageTexture37.setUrl(["images/No.png","https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/No.png"])
...
HAnimJoint41.setCenter(x3d.doubleToFloat([3.785,34.07,-1.57]))
...
Transform43.setTranslation(x3d.doubleToFloat([3.785,34.07,-1.57]))
Shape44 = x3d.Shape()
...
HAnimJoint51.setCenter(x3d.doubleToFloat([3.838,18.4,-1.212]))
...
Transform53.setTranslation(x3d.doubleToFloat([3.838,18.4,-1.212]))
Shape54 = x3d.Shape()
...
ImageTexture57.setUSE("NoTextureAtlas")
...
HAnimJoint61.setCenter(x3d.doubleToFloat([3.826,4.044,-1.361]))
...
Transform63.setTranslation(x3d.doubleToFloat([3.826,4.044,-1.361]))
Shape64 = x3d.Shape()
...
ImageTexture67.setUSE("NoTextureAtlas")
...
HAnimJoint71.setCenter(x3d.doubleToFloat([3.826,3.118,-0.2867]))
...
Transform73.setTranslation(x3d.doubleToFloat([3.826,3.118,-0.2867]))
Shape74 = x3d.Shape()
...
ImageTexture77.setUSE("NoTextureAtlas")
...
HAnimJoint81.setCenter(x3d.doubleToFloat([-3.785,34.07,-1.57]))
...
Transform83.setTranslation(x3d.doubleToFloat([-3.785,34.07,-1.57]))
Shape84 = x3d.Shape()
...
HAnimJoint91.setCenter(x3d.doubleToFloat([-3.838,18.4,-1.212]))
...
Transform93.setTranslation(x3d.doubleToFloat([-3.838,18.4,-1.212]))
Shape94 = x3d.Shape()
...
ImageTexture97.setUSE("NoTextureAtlas")
...
HAnimJoint101.setCenter(x3d.doubleToFloat([-3.826,4.044,-1.361]))
...
Transform103.setTranslation(x3d.doubleToFloat([-3.826,4.044,-1.361]))
Shape104 = x3d.Shape()
...
ImageTexture107.setUSE("NoTextureAtlas")
...
HAnimJoint111.setCenter(x3d.doubleToFloat([-3.826,3.118,-0.2867]))
...
Transform113.setTranslation(x3d.doubleToFloat([-3.826,3.118,-0.2867]))
Shape114 = x3d.Shape()
...
ImageTexture117.setUSE("NoTextureAtlas")
...
HAnimJoint121.setCenter(x3d.doubleToFloat([0,32.91,-1.57]))
...
Transform123.setTranslation(x3d.doubleToFloat([0,32.91,-1.57]))
Shape124 = x3d.Shape()
...
HAnimJoint131.setCenter(x3d.doubleToFloat([7.266,54.049999,-1.79]))
...
Transform133.setTranslation(x3d.doubleToFloat([7.266,54.049999,-1.79]))
Shape134 = x3d.Shape()
...
HAnimJoint141.setCenter(x3d.doubleToFloat([7.834,43.389999,-1.651]))
...
Transform143.setTranslation(x3d.doubleToFloat([7.834,43.389999,-1.651]))
Shape144 = x3d.Shape()
...
HAnimJoint151.setCenter(x3d.doubleToFloat([7.738,35.43,-1.558]))
...
Transform153.setTranslation(x3d.doubleToFloat([7.738,35.43,-1.558]))
Shape154 = x3d.Shape()
...
HAnimJoint161.setCenter(x3d.doubleToFloat([-7.266,54.049999,-1.79]))
...
Transform163.setTranslation(x3d.doubleToFloat([-7.266,54.049999,-1.79]))
Shape164 = x3d.Shape()
...
HAnimJoint171.setCenter(x3d.doubleToFloat([-7.834,43.389999,-1.651]))
...
Transform173.setTranslation(x3d.doubleToFloat([-7.834,43.389999,-1.651]))
Shape174 = x3d.Shape()
...
HAnimJoint181.setCenter(x3d.doubleToFloat([-7.738,35.43,-1.558]))
...
Transform183.setTranslation(x3d.doubleToFloat([-7.738,35.43,-1.558]))
Shape184 = x3d.Shape()
...
ImageTexture187.setUSE("NoTextureAtlas")
...
HAnimJoint191.setCenter(x3d.doubleToFloat([0,37.060001,-1.409]))
...
Transform193.setTranslation(x3d.doubleToFloat([0,37.060001,-1.409]))
Shape194 = x3d.Shape()
...
HAnimJoint201.setCenter(x3d.doubleToFloat([0,37.060001,-1.409]))
...
Transform203.setTranslation(x3d.doubleToFloat([0,37.060001,-1.409]))
Shape204 = x3d.Shape()
...
X3D0.toFileX3D("../data/KoreanCharacter07No.new.graalpy.x3d")
X3D0.toFileJSON("../data/KoreanCharacter07No.new.graalpy.json")

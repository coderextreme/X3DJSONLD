...
Viewpoint15.setPosition(x3d.doubleToFloat([0,0.75,3]))

Scene13.addChild(Viewpoint15)
Viewpoint16 = x3d.Viewpoint()
Viewpoint16.setDescription("Camera view through lens")
Viewpoint16.setPosition(x3d.doubleToFloat([0,0,0]))

Scene13.addChild(Viewpoint16)
Viewpoint17 = x3d.Viewpoint()
Viewpoint17.setDescription("Camera view from right side")
Viewpoint17.setOrientation(x3d.doubleToFloat([0,1,0,1.5708]))
Viewpoint17.setPosition(x3d.doubleToFloat([12,0,-4]))

Scene13.addChild(Viewpoint17)
Viewpoint18 = x3d.Viewpoint()
Viewpoint18.setDescription("Camera view from above")
Viewpoint18.setOrientation(x3d.doubleToFloat([1,0,0,-1.5708]))
Viewpoint18.setPosition(x3d.doubleToFloat([0,15,-5]))

Scene13.addChild(Viewpoint18)
Viewpoint19 = x3d.Viewpoint()
Viewpoint19.setDescription("Camera view from left side")
Viewpoint19.setOrientation(x3d.doubleToFloat([0,1,0,-1.5708]))
Viewpoint19.setPosition(x3d.doubleToFloat([-12,0,-4]))

Scene13.addChild(Viewpoint19)
Transform20 = x3d.Transform()
Transform20.setScale(x3d.doubleToFloat([0.1,0.1,0.1]))
Transform20.setTranslation(x3d.doubleToFloat([0,-0.165,0.02]))
Switch21 = x3d.Switch()
...
Material24.setDiffuseColor(x3d.doubleToFloat([0.372322,0.371574,0.373173]))
...
Coordinate27.setPoint(x3d.doubleToFloat([-0.36,-2.39,-0.26,-0.36,-1.77,-0.89,-0.36,0,-1.7,-0.36,0.85,-1.47,-0.36,1.47,-0.85,-0.36,1.7,0,-0.36,1.47,0.85,-0.36,-0.07,2.05,-0.36,-0.92,2.28,-0.36,-1.77,2.05,-0.36,-2.39,1.43,-0.36,-2.62,0.58,0.36,-2.39,-0.26,0.36,-1.77,-0.89,0.36,0,-1.7,0.36,0.85,-1.47,0.36,1.47,-0.85,0.36,1.7,0,0.36,1.47,0.85,0.36,-0.07,2.05,0.36,-0.92,2.28,0.36,-1.77,2.05,0.36,-2.39,1.43,0.36,-2.62,0.58,-0.36,-0.46,0.31,0.36,-0.46,0.31]))
...
Transform42.setRotation(x3d.doubleToFloat([-1,0,0,0.373518]))
Transform42.setTranslation(x3d.doubleToFloat([-0.038462,3.596312,3.297562]))
Shape43 = x3d.Shape()
...
Transform46.setScale(x3d.doubleToFloat([1,0.727134,0.801457]))
Transform46.setTranslation(x3d.doubleToFloat([-0.030769,1.738461,1.4436]))
Shape47 = x3d.Shape()
...
Transform50.setScale(x3d.doubleToFloat([1,1,0.569444]))
Transform50.setTranslation(x3d.doubleToFloat([0.015385,1.630769,-1.973274]))
Shape51 = x3d.Shape()
...
Transform54.setScale(x3d.doubleToFloat([1.1,1.1,0.1]))
Transform54.setTranslation(x3d.doubleToFloat([-0.015385,1.628515,-2.569231]))
Shape55 = x3d.Shape()

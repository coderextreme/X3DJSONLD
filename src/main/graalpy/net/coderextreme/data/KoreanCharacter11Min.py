...
meta10.setContent("../Poses/images/HAnimPoseExampleKoreanCharacter11Min.png")
...
meta14.setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/KoreanCharacter11Min.x3d")
...
WorldInfo21.setTitle("KoreanCharacter11Min.x3d")
...
HAnimJoint32.setCenter(x3d.doubleToFloat([0,33.689999,-2.063]))
...
Transform34.setTranslation(x3d.doubleToFloat([0,33.689999,-2.063]))
Shape35 = x3d.Shape()
...
HAnimJoint42.setCenter(x3d.doubleToFloat([3.383,32.919998,-2.063]))
...
Transform44.setTranslation(x3d.doubleToFloat([3.383,32.919998,-2.063]))
Shape45 = x3d.Shape()
...
HAnimJoint52.setCenter(x3d.doubleToFloat([3.745,17.99,-2.063]))
...
Transform54.setTranslation(x3d.doubleToFloat([3.745,17.99,-2.063]))
Shape55 = x3d.Shape()
...
HAnimJoint62.setCenter(x3d.doubleToFloat([3.701,4.188,-1.915]))
...
Transform64.setTranslation(x3d.doubleToFloat([3.701,4.188,-1.915]))
Shape65 = x3d.Shape()
...
ImageTexture68.setUSE("MinTextureAtlas")
...
HAnimJoint72.setCenter(x3d.doubleToFloat([3.701,3.418,-0.4009]))
...
Transform74.setTranslation(x3d.doubleToFloat([3.701,3.418,-0.4009]))
Shape75 = x3d.Shape()
...
HAnimJoint82.setCenter(x3d.doubleToFloat([-3.383,32.919998,-2.063]))
...
Transform84.setTranslation(x3d.doubleToFloat([-3.383,32.919998,-2.063]))
Shape85 = x3d.Shape()
...
HAnimJoint92.setCenter(x3d.doubleToFloat([-3.745,17.99,-2.063]))
...
Transform94.setTranslation(x3d.doubleToFloat([-3.745,17.99,-2.063]))
Shape95 = x3d.Shape()
...
HAnimJoint102.setCenter(x3d.doubleToFloat([-3.701,4.188,-1.915]))
...
Transform104.setTranslation(x3d.doubleToFloat([-3.701,4.188,-1.915]))
Shape105 = x3d.Shape()
...
ImageTexture108.setUSE("MinTextureAtlas")
...
HAnimJoint112.setCenter(x3d.doubleToFloat([-3.701,3.418,-0.4009]))
...
Transform114.setTranslation(x3d.doubleToFloat([-3.701,3.418,-0.4009]))
Shape115 = x3d.Shape()
...
HAnimJoint122.setCenter(x3d.doubleToFloat([0,30.98,-2.063]))
...
Transform124.setTranslation(x3d.doubleToFloat([0,30.98,-2.063]))
Shape125 = x3d.Shape()
...
HAnimJoint132.setCenter(x3d.doubleToFloat([5.199,51.119999,-2.106]))
...
Transform134.setTranslation(x3d.doubleToFloat([5.199,51.119999,-2.106]))
Shape135 = x3d.Shape()
...
HAnimJoint142.setCenter(x3d.doubleToFloat([7.024,42.73,-2.051]))
...
Transform144.setTranslation(x3d.doubleToFloat([7.024,42.73,-2.051]))
Shape145 = x3d.Shape()
...
HAnimJoint152.setCenter(x3d.doubleToFloat([7.221,34,-2.015]))
...
Transform154.setTranslation(x3d.doubleToFloat([7.221,34,-2.015]))
Shape155 = x3d.Shape()
...
HAnimJoint162.setCenter(x3d.doubleToFloat([-5.199,51.119999,-2.106]))
...
Transform164.setTranslation(x3d.doubleToFloat([-5.199,51.119999,-2.106]))
Shape165 = x3d.Shape()
...
HAnimJoint172.setCenter(x3d.doubleToFloat([-7.024,42.73,-2.051]))
...
Transform174.setTranslation(x3d.doubleToFloat([-7.024,42.73,-2.051]))
Shape175 = x3d.Shape()
...
HAnimJoint182.setCenter(x3d.doubleToFloat([-7.221,34,-2.015]))
...
Transform184.setTranslation(x3d.doubleToFloat([-7.221,34,-2.015]))
Shape185 = x3d.Shape()
...
HAnimJoint192.setCenter(x3d.doubleToFloat([0,36.290001,-2.197]))
...
Transform194.setTranslation(x3d.doubleToFloat([0,36.290001,-2.197]))
Shape195 = x3d.Shape()
...
HAnimJoint202.setCenter(x3d.doubleToFloat([0,54.84,-1.903]))
...
Transform204.setTranslation(x3d.doubleToFloat([0,54.84,-1.903]))
Shape205 = x3d.Shape()
...
EXPORT230.setAS("KoreanCharacter11Min")
EXPORT230.setLocalDEF("hanim_Min")

Scene20.addChild(EXPORT230)

X3D0.setScene(Scene20)
X3D0.toFileX3D("../data/KoreanCharacter11Min.new.graalpy.x3d")
X3D0.toFileJSON("../data/KoreanCharacter11Min.new.graalpy.x3dj")

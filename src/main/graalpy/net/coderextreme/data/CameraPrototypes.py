...
PositionInterpolator62.setKey(x3d.doubleToFloat([0,1]))
PositionInterpolator62.setKeyValue(x3d.doubleToFloat([0,0,0,0,0,0]))
IS63 = x3d.IS()
...
OrientationInterpolator65.setKeyValue(x3d.doubleToFloat([0,1,0,0,0,1,0,0]))
IS66 = x3d.IS()
...
Material261.setDiffuseColor(x3d.doubleToFloat([1,1,0.2]))

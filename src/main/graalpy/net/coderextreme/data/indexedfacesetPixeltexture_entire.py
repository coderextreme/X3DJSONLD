...
Viewpoint18.setOrientation(x3d.doubleToFloat([0,1,0,3.14]))
Viewpoint18.setPosition(x3d.doubleToFloat([0,0,-10]))
...
Viewpoint19.setPosition(x3d.doubleToFloat([0,10,0]))

Scene16.addChild(Viewpoint19)
Viewpoint20 = x3d.Viewpoint()
Viewpoint20.setDescription("Bottom View")
Viewpoint20.setOrientation(x3d.doubleToFloat([1,0,0,1.57]))
Viewpoint20.setPosition(x3d.doubleToFloat([0,-10,0]))
...
Viewpoint21.setPosition(x3d.doubleToFloat([10,0,0]))

Scene16.addChild(Viewpoint21)
Viewpoint22 = x3d.Viewpoint()
Viewpoint22.setDescription("Left View")
Viewpoint22.setOrientation(x3d.doubleToFloat([0,1,0,-1.57]))
Viewpoint22.setPosition(x3d.doubleToFloat([-10,0,0]))
...
X3D0.toFileX3D("../data/indexedfacesetPixeltexture_entire.new.graalpy.x3d")
X3D0.toFileJSON("../data/indexedfacesetPixeltexture_entire.new.graalpy.x3dj")

...
Transform12.setTranslation(x3d.doubleToFloat([0,-1,1]))
Transform12.setRotation(x3d.doubleToFloat([0,1,0,3.1415926]))
Transform12.setScale(x3d.doubleToFloat([1.5,1.5,1.5]))
Shape13 = x3d.Shape()
Appearance14 = x3d.Appearance()
Material15 = x3d.Material()
Material15.setTransparency(0.1)
Material15.setDiffuseColor(x3d.doubleToFloat([0.9,0.3,0.3]))
Material15.setSpecularColor(x3d.doubleToFloat([0.8,0.8,0.8]))
...
Coordinate17.setPoint(x3d.doubleToFloat([0,0,1,0,1,0,1,0,0]))
...
X3D0.toFileX3D("../data/flower.new.graalpy.x3d")
X3D0.toFileJSON("../data/flower.new.graalpy.x3dj")

...
Viewpoint25.setPosition(x3d.doubleToFloat([0,0,-10]))
...
Viewpoint27.setOrientation(x3d.doubleToFloat([1,0,0,1.57]))
Viewpoint27.setPosition(x3d.doubleToFloat([0,-10,0]))
...
Viewpoint29.setOrientation(x3d.doubleToFloat([0,1,0,-1.57]))
Viewpoint29.setPosition(x3d.doubleToFloat([-10,0,0]))
...
X3D0.toFileX3D("../data/indexedfacesetPixeltexture_whole.new.graalpy.x3d")
X3D0.toFileJSON("../data/indexedfacesetPixeltexture_whole.new.graalpy.x3dj")

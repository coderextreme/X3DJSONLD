...
Scene22.addComments(x3d.CommentsBlock("""<Environment id=\"gamma\" gammaCorrectionDefault=\"none\"></Environment>"""))
Shape30 = x3d.Shape()
...
TextureProperties34.setMagnificationFilter("NEAREST_PIXEL")
...
TextureCoordinate38.setPoint(x3d.doubleToFloat([-1,2,-1,-1,2,2,2,-1]))
...
X3D0.toFileX3D("../data/indexedfacesetPixeltexture_plus.new.graalpy.x3d")
X3D0.toFileJSON("../data/indexedfacesetPixeltexture_plus.new.graalpy.x3dj")

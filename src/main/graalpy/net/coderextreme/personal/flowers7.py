...
meta14.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/flowers7.x3d")
...
X3D0.toFileX3D("../personal/flowers7.new.graalpy.x3d")
X3D0.toFileJSON("../personal/flowers7.new.graalpy.json")

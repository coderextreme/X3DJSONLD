...
meta6.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/fors2.x3d")
...
Shape17.addComments(x3d.CommentsBlock('''comment before Sphere'''))

Shape17.addComments(x3d.CommentsBlock('''comment after Sphere'''))

Shape17.addComments(x3d.CommentsBlock('''comment after Appearance'''))
Sphere18 = x3d.Sphere()

Shape17.setGeometry(Sphere18)
Appearance19 = x3d.Appearance()

Appearance19.addComments(x3d.CommentsBlock('''comment before Material'''))

Appearance19.addComments(x3d.CommentsBlock('''comment after Material'''))
...
X3D0.toFileX3D("../personal/fors2.new.graalpy.x3d")
X3D0.toFileJSON("../personal/fors2.new.graalpy.json")

...
Material27.setDiffuseColor(x3d.doubleToFloat([0.7,0.7,0.7]))
Material27.setSpecularColor(x3d.doubleToFloat([0.5,0.5,0.5]))
...
ComposedShader43.addComments(x3d.CommentsBlock('''http://hypertextbook.com/facts/2005/JustinChe.shtml'''))
field44 = x3d.field()
...
X3D0.toFileX3D("../personal/mirror.new.graalpy.x3d")
X3D0.toFileJSON("../personal/mirror.new.graalpy.json")

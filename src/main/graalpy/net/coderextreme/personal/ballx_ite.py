...
meta13.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/ballx_ite.x3d")
...
WorldInfo16.setTitle("ballx_ite.x3d")
...
ShaderPart39.setUrl(["../shaders/x_ite.vs","https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs"])
ShaderPart39.setType("VERTEX")

ComposedShader32.addParts(ShaderPart39)
ShaderPart40 = x3d.ShaderPart()
ShaderPart40.setUrl(["../shaders/x_itebubbles.fs","https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs"])
...
X3D0.toFileX3D("../personal/ballx_ite.new.graalpy.x3d")
X3D0.toFileJSON("../personal/ballx_ite.new.graalpy.json")

...
meta6.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/bubs.x3d")
...
Material15.setDiffuseColor(x3d.doubleToFloat([1,0,0]))
...
Material45.setDiffuseColor(x3d.doubleToFloat([1,0,0]))
...
Material60.setDiffuseColor(x3d.doubleToFloat([1,0,0]))
...
X3D0.toFileX3D("../personal/bubs3.new.graalpy.x3d")
X3D0.toFileJSON("../personal/bubs3.new.graalpy.json")

...
meta5.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/rubik.x3d")
...
Material20.setDiffuseColor(x3d.doubleToFloat([1,1,1]))
...
X3D0.toFileX3D("../personal/rubik.new.graalpy.x3d")
X3D0.toFileJSON("../personal/rubik.new.graalpy.json")

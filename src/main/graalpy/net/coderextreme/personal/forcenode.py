...
Script75.addComments(x3d.CommentsBlock('''<field name=\"ModifiableNode\" type=\"SFNode\" accessType=\"inputOutput\"> <Transform USE=\"HoldsContent\"/> </field>'''))
...
X3D0.toFileX3D("../personal/forcenode.new.graalpy.x3d")
X3D0.toFileJSON("../personal/forcenode.new.graalpy.json")

...
meta6.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/plainflowers.x3d")
...
X3D0.toFileX3D("../personal/plainflowers.new.graalpy.x3d")
X3D0.toFileJSON("../personal/plainflowers.new.graalpy.json")

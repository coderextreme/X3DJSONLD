...
meta14.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/bub.x3d")
...
X3D0.toFileX3D("../personal/bub.new.graalpy.x3d")
X3D0.toFileJSON("../personal/bub.new.graalpy.json")

...
meta5.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/force.x3d")
...
Material19.setDiffuseColor(x3d.doubleToFloat([1,0,0]))
...
Transform20.setTranslation(x3d.doubleToFloat([1,0,0]))
Shape21 = x3d.Shape()
Text22 = x3d.Text()
...
Material25.setDiffuseColor(x3d.doubleToFloat([0,0,1]))
...
PositionInterpolator26.setKey(x3d.doubleToFloat([0,1]))
PositionInterpolator26.setKeyValue(x3d.doubleToFloat([0,0,0,0,5,0]))
...
Extrusion43.setCrossSection(x3d.doubleToFloat([1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0]))
Extrusion43.setSpine(x3d.doubleToFloat([0,-50,0,0,50,0]))

Shape42.setGeometry(Extrusion43)
Appearance44 = x3d.Appearance()
Material45 = x3d.Material()
Material45.setDiffuseColor(x3d.doubleToFloat([0,1,0]))
...
Transform54.setScale(x3d.doubleToFloat([0.1,0.1,0.1]))
PlaneSensor55 = x3d.PlaneSensor()
PlaneSensor55.setDEF("clickGenerator")
PlaneSensor55.setMinPosition(x3d.doubleToFloat([-50,-50]))
PlaneSensor55.setMaxPosition(x3d.doubleToFloat([50,50]))
...
X3D0.toFileX3D("../personal/fors.new.graalpy.x3d")
X3D0.toFileJSON("../personal/fors.new.graalpy.json")

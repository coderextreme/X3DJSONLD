...
ComposedShader32.addComments(x3d.CommentsBlock('''TO CONVERT TO A SPHERE <ShaderPart url='\"../shaders/x_ite.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs\"' type=\"VERTEX\" containerField='parts'></ShaderPart> <ShaderPart url='\"../shaders/x_itebubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>'''))
...
X3D0.toFileX3D("../personal/bumpyx_ite.new.graalpy.x3d")
X3D0.toFileJSON("../personal/bumpyx_ite.new.graalpy.json")

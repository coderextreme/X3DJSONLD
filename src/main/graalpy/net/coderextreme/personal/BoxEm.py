...
meta5.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/box.x3d")
...
X3D0.toFileX3D("../personal/BoxEm.new.graalpy.x3d")
X3D0.toFileJSON("../personal/BoxEm.new.graalpy.json")

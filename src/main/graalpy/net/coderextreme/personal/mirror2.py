...
meta13.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/mirror2.x3d")
...
Viewpoint16.setPosition(x3d.doubleToFloat([0,5,100]))
...
Material21.setDiffuseColor(x3d.doubleToFloat([0.7,0.7,0.7]))
Material21.setSpecularColor(x3d.doubleToFloat([0.5,0.5,0.5]))
...
X3D0.toFileX3D("../personal/mirror2.new.graalpy.x3d")
X3D0.toFileJSON("../personal/mirror2.new.graalpy.json")

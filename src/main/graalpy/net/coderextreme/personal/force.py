...
meta6.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/force.x3d")
...
Transform22.setTranslation(x3d.doubleToFloat([1,0,0]))
Shape23 = x3d.Shape()
Text24 = x3d.Text()
...
Extrusion46.setSpine(x3d.doubleToFloat([0,-50,0,0,50,0]))
...
Script76.addComments(x3d.CommentsBlock('''<field name=\"ModifiableNode\" type=\"SFNode\" accessType=\"inputOutput\"> <Transform USE=\"HoldsContent\"/> </field>'''))
...
X3D0.toFileX3D("../personal/force.new.graalpy.x3d")
X3D0.toFileJSON("../personal/force.new.graalpy.json")

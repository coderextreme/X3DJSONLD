...
head1.addComments(x3d.CommentsBlock('''component name='Shaders' level='1'></component'''))

head1.addComments(x3d.CommentsBlock('''component name='CubeMapTexturing' level='1'></component'''))
meta8 = x3d.meta()
meta8.setName("title")
...
X3D0.toFileX3D("../personal/cgeball.new.graalpy.x3d")
X3D0.toFileJSON("../personal/cgeball.new.graalpy.json")

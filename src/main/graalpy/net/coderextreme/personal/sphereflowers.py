...
meta16.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/sphereflowers.x3d")
...
X3D0.toFileX3D("../personal/sphereflowers.new.graalpy.x3d")
X3D0.toFileJSON("../personal/sphereflowers.new.graalpy.json")

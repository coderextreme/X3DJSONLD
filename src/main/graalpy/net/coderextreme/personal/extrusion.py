...
meta5.setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/extrusion.x3d")
...
Extrusion11.setSpine(x3d.doubleToFloat([-50,-50,0,50,50,0]))
Extrusion11.setCreaseAngle(0.785)
Extrusion11.setCrossSection(x3d.doubleToFloat([1,0,0.92,-0.38,0.71,-0.71,0.38,-0.92,0,-1,-0.38,-0.92,-0.71,-0.71,-0.92,-0.38,-1,0,-0.92,0.38,-0.71,0.71,-0.38,0.92,0,1,0.38,0.92,0.71,0.71,0.92,0.38,1,0]))

Shape10.setGeometry(Extrusion11)
Appearance12 = x3d.Appearance()
Material13 = x3d.Material()
Material13.setDiffuseColor(x3d.doubleToFloat([0,1,0]))
...
X3D0.toFileX3D("../personal/extrusion.new.graalpy.x3d")
X3D0.toFileJSON("../personal/extrusion.new.graalpy.json")

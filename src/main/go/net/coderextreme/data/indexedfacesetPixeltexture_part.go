        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("indexedfaceset_pixeltexture_part.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_part-front.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_part-rear.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_part-top.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_part-bottom.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_part-left.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_part-right.jpg"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("Test of browser ability to map a partial portion of an PixelTexture onto an IndexedFaceSet geometry. Only the yellow portion of four equal sized red, green, yellow and white squares in the pixel texture map all the faces of the cube."),
            },
            &x3d.Meta{
                Name: stringPtr("identifier"),
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_part.x3d"),
            },
            &x3d.Meta{
...
//<Environment id="gamma" gammaCorrectionDefault="none"></Environment>
                &x3d.Shape{
                    ...
                    Geometry: &x3d.IndexedFaceSet{
                        ...
                        TexCoord: &x3d.TextureCoordinate{
                            Point: &x3d.MFVec2f{[2]float32{0.5,1.0},[2]float32{0.5,0.5},[2]float32{1.0,1.0},[2]float32{1.0,0.5}},
                        },
                    },
                },
            },
	...
	*/
	filename := "../data/indexedfacesetPixeltexture_part.new.go.x3d"

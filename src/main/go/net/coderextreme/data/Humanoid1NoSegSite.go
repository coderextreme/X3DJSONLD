...
func main() {
        ...
        Head: &x3d.Head{
            ...
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("Humanoid1NoSegSite.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("identifier"),
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Humanoid1NoSegSite.x3d"),
            },
            &x3d.Meta{
	...
	*/
	filename := "../data/Humanoid1NoSegSite.new.go.x3d"

                        ...
                        &x3d.ParticleSystem{
                            ...
                            Appearance: &x3d.Appearance{
                                ...
                                &x3d.ComposedShader{
                                    ...
                                    Parts: []x3d.X3DNode{
                                        &x3d.ShaderPart{
                                            Url: x3d.MFString{"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs"},
                                            Type: stringPtr("VERTEX"),
                                    },
                                    &x3d.ShaderPart{
                                        Url: x3d.MFString{"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"},
...
//			}
	...
	*/
	filename := "../data/fwparticleflowers.new.go.x3d"

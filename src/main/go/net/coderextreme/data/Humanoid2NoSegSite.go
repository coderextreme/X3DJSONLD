...
func main() {
        ...
        Head: &x3d.Head{
            ...
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("Humanoid2NoSegSite.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("identifier"),
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Humanoid2NoSegSite.x3d"),
            },
            &x3d.Meta{
	...
	*/
	filename := "../data/Humanoid2NoSegSite.new.go.x3d"

...
func main() {
        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("rubikOnFire.x3d"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/rubikOnFire.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("description"),
                Content: stringPtr("a white rubik cube"),
            },
            },
        },
        &x3d.Group{
	...
	*/
	filename := "../data/rubikOnFire.new.go.x3d"

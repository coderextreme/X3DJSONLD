    ...
    sceneRoot := &x3d.X3D{
        ...
        Head: &x3d.Head{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/flower.x3d"),
            },
            &x3d.Meta{
        ...
        &x3d.Group{
            Children: []x3d.X3DNode{
                ...
                &x3d.Transform{
                        Translation: &x3d.SFVec3f{0.0, -1.0, 1.0},
                        Rotation: &x3d.SFRotation{0.0, 1.0, 0.0, 3.1415926},
                        Scale: &x3d.SFVec3f{1.5, 1.5, 1.5},
                    Children: []x3d.X3DNode{
                        &x3d.Shape{
                            Appearance: &x3d.Appearance{
                                Material: &x3d.Material{
                                    Transparency: floatPtr(0.1),
                                    DiffuseColor: &x3d.SFColor{0.9, 0.3, 0.3},
                                    SpecularColor: &x3d.SFColor{0.8, 0.8, 0.8},
...
//}
	...
	*/
	filename := "../data/flower.new.go.x3d"

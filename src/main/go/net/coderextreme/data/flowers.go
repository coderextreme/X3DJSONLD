    ...
    sceneRoot := &x3d.X3D{
        ...
        Head: &x3d.Head{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/flowers.x3d"),
            },
            },
        },
        &x3d.Group{
                        ...
                        Children: []x3d.X3DNode{
                            &x3d.Transform{
                                    CoreX3DNode: x3d.CoreX3DNode{
                                        DEF: stringPtr("animate_transform"),
                                    },
                                Children: []x3d.X3DNode{
                                    &x3d.Shape{
...
//			}
                            ...
                            &x3d.X3DRoute{
                                ...
                                ToNode: stringPtr("animate_transform"),
...
//<ROUTE fromNode='Animate' fromField='tdelta' toNode='x3dom' toField='tdelta'/>
	...
	*/
	filename := "../data/flowers.new.go.x3d"

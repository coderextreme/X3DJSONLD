    ...
    sceneRoot := &x3d.X3D{
        ...
        Head: &x3d.Head{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/variationalflowers.x3d"),
            },
            },
        },
        &x3d.Group{
            Children: []x3d.X3DNode{
                ...
                &x3d.Background{
                    BackUrl: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_back.png"},
                    BottomUrl: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_bottom.png"},
                    FrontUrl: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_front.png"},
                    LeftUrl: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_left.png"},
                    RightUrl: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_right.png"},
                    TopUrl: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_top.png"},
                },
                &x3d.Transform{
                    Children: []x3d.X3DNode{
                        &x3d.ParticleSystem{
...
//* variations in values - array of MFFloats to pass to ComposedShader that varies values
                            &x3d.VariationPhysicsModel{
                                Values: stringPtr("2 2 5 5 0 0"),
                                Variations: stringPtr("0.2 0.1 0.3 0.3 0.01 0.01"),
                            },
                            ...
                            Appearance: &x3d.Appearance{
                                ...
                                Texture: &x3d.ComposedCubeMapTexture{
                                    ...
                                    BackTexture: &x3d.ImageTexture{
                                        Url: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_back.png"},
                                    },
                                    BottomTexture: &x3d.ImageTexture{
                                        Url: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_bottom.png"},
                                    },
                                    FrontTexture: &x3d.ImageTexture{
                                        Url: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_front.png"},
                                    },
                                    LeftTexture: &x3d.ImageTexture{
                                        Url: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_left.png"},
                                    },
                                    RightTexture: &x3d.ImageTexture{
                                        Url: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_right.png"},
                                    },
                                    TopTexture: &x3d.ImageTexture{
                                        Url: x3d.MFString{"../resources/images/all_probes/stpeters_cross/stpeters_top.png"},
                                    },
                                },
                                &x3d.ComposedShader{
                                    CoreX3DNode: x3d.CoreX3DNode{
                                    ...
                                    Parts: []x3d.X3DNode{
                                        &x3d.ShaderPart{
                                            Url: x3d.MFString{"../shaders/x_ite_variations.vs"},
                                            Type: stringPtr("VERTEX"),
                                    },
                                    &x3d.ShaderPart{
                                        Url: x3d.MFString{"../shaders/commonnew.fs"},
...
//			}
                        ...
                        &x3d.X3DRoute{
                            ...
                            FromField: stringPtr("values"),
                            ToNode: stringPtr("x_ite"),
                            ToField: stringPtr("x3d_ParticleValues"),
                        },
                    },
                },
            },
	...
	*/
	filename := "../data/variationalflowers2.new.go.x3d"

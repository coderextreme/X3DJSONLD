    ...
    sceneRoot := &x3d.X3D{
        ...
        Head: &x3d.Head{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("an attempt to implement an arc in a graph"),
            },
            },
        },
        &x3d.Group{
            Children: []x3d.X3DNode{
                &x3d.Viewpoint{
                    ...
                    Description: stringPtr("a moving graph"),
                },
                &x3d.Background{
                ...
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("trans1"),
                        },
                    Children: []x3d.X3DNode{
                        &x3d.Transform{
                                CoreX3DNode: x3d.CoreX3DNode{
                                    DEF: stringPtr("rotscale1"),
                                },
                            Children: []x3d.X3DNode{
                                &x3d.Shape{
                ...
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("trans2"),
                        },
                    Children: []x3d.X3DNode{
                        &x3d.Transform{
                                CoreX3DNode: x3d.CoreX3DNode{
                                    DEF: stringPtr("rotscale2"),
                                },
                            Children: []x3d.X3DNode{
                                &x3d.Shape{
                                    Appearance: &x3d.Appearance{
                ...
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("trans3"),
                        },
                    Children: []x3d.X3DNode{
                        &x3d.Transform{
                                CoreX3DNode: x3d.CoreX3DNode{
                                    DEF: stringPtr("rotscale3"),
                                },
                            Children: []x3d.X3DNode{
                                &x3d.Shape{
                                    Appearance: &x3d.Appearance{
...
//        }
	...
	*/
	filename := "../data/arcold.new.go.x3d"

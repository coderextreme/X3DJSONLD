        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("gridBack.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("description"),
                Content: stringPtr("Checkerboard grid background for X3D/VRML materials selection."),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("8 April 2002"),
            },
            &x3d.Meta{
                ...
                &x3d.Shape{
                    Appearance: &x3d.Appearance{
                        Material: &x3d.Material{
                            AmbientIntensity: floatPtr(0.01),
                            DiffuseColor: &x3d.SFColor{1.0, 1.0, 1.0},
                            Shininess: floatPtr(0.05),
                        },
                    },

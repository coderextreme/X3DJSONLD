...
func main() {
        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("WinterAndSpringThanksAllTitleBox.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("description"),
                Content: stringPtr("Credits for scene."),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("Mon, 08 Sep 2025 02:12:19 GMT"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringThanksAllTitleBox.x3d"),
            },
            },
        },
        Scene: &x3d.Scene{
            Children: []x3d.X3DChildNode{
                &x3d.WorldInfo{
                    Title: stringPtr("WinterAndSpringThanksAllTitleBox.x3d"),
                },
                &x3d.Viewpoint{
                    CoreX3DNode: x3d.CoreX3DNode{
                        DEF: stringPtr("WSThanksAllView"),
                    },
                    Description: stringPtr("Look at Thanks title"),
                    Position: &x3d.SFVec3f{10.0, 11.0, -10.0},
                    Orientation: &x3d.SFRotation{-0.15, 0.0, 0.0, 0.2},
                },
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("WSThanksAllTitle"),
                        },
	...
	*/
	filename := "../data/WinterSpringThanksAllTitleBox.new.go.x3d"

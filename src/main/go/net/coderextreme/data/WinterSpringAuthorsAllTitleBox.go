...
func main() {
        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("WinterAndSpringAuthorsAllTitleBox.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("description"),
                Content: stringPtr("Credits for scene authors."),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("Mon, 08 Sep 2025 02:12:14 GMT"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringAuthorsAllTitleBox.x3d"),
            },
            },
        },
        Scene: &x3d.Scene{
            Children: []x3d.X3DChildNode{
                &x3d.WorldInfo{
                    Title: stringPtr("WinterAndSpringAuthorsAllTitleBox.x3d"),
                },
                &x3d.Viewpoint{
                    ...
                    Position: &x3d.SFVec3f{10.0, 11.0, 0.0},
	...
	*/
	filename := "../data/WinterSpringAuthorsAllTitleBox.new.go.x3d"

...
func main() {
        ...
        Head: &x3d.Head{
            ...
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("DiamondManLOA2.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("description"),
                Content: stringPtr("HAnim skeletal structure at level of articulation two, one diamond at the base node for the structure, blue spheres for HAnimSite feaature points"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("DiamondManLOA2.png"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA2.x3d"),
            },
            },
        },
        Scene: &x3d.Scene{
            Children: []x3d.X3DChildNode{
                ...
                &x3d.HAnimHumanoid{
                    ...
                    &x3d.HAnimSite{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("hanim_DiamondManLOA2_view"),
                        },
                        Name: stringPtr("DiamondManLOA2_view"),
                        &x3d.Viewpoint{
                            CoreX3DNode: x3d.CoreX3DNode{
	...
	*/
	filename := "../data/DiamondManLOA2.new.go.x3d"

...
func main() {
        ...
        Head: &x3d.Head{
            ...
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("DiamondManLOA_0.x3d"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("../Templates/DiamondManLOA_0.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("reference"),
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA_0.x3d"),
            },
            },
        },
        Scene: &x3d.Scene{
	...
	*/
	filename := "../data/DiamondManLOA_0.new.go.x3d"

            ...
            Children: []x3d.X3DChildNode{
                ...
                &x3d.Transform{
                    ...
                    Children: []x3d.X3DNode{
                        &x3d.Transform{
                                CoreX3DNode: x3d.CoreX3DNode{
                                    DEF: stringPtr("DECLpoint_INSTANCE_node"),
                                },
                                Translation: &x3d.SFVec3f{0.0, 1.223333, 0.0},
                            Children: []x3d.X3DNode{
                                &x3d.Shape{
                                ...
                                &x3d.PositionInterpolator{
                                    CoreX3DNode: x3d.CoreX3DNode{
                                        DEF: stringPtr("DECLpoint_INSTANCE_PI1"),
                                    },
                                ...
                                &x3d.Script{
                                    CoreX3DNode: x3d.CoreX3DNode{
                                        DEF: stringPtr("DECLpoint_INSTANCE_MB1"),
                                    },
                                    Field: []x3d.X3DNode{
                                        &x3d.Field{
...
//               }
                                ...
                                &x3d.TimeSensor{
                                    CoreX3DNode: x3d.CoreX3DNode{
                                        DEF: stringPtr("DECLpoint_INSTANCE_CL1"),
                                    },
                ...
                &x3d.Transform{
                    ...
                    Children: []x3d.X3DNode{
                        &x3d.Transform{
                                CoreX3DNode: x3d.CoreX3DNode{
                                    DEF: stringPtr("DECLpoint_INSTANCE1000_node"),
                                },
                                Translation: &x3d.SFVec3f{0.0, 1.223333, 0.0},
                            Children: []x3d.X3DNode{
                                &x3d.Shape{
                                ...
                                &x3d.PositionInterpolator{
                                    CoreX3DNode: x3d.CoreX3DNode{
                                        DEF: stringPtr("DECLpoint_INSTANCE1000_PI1"),
                                    },
                                    Key: x3d.MFFloat{0.0, 1.0},
                                    KeyValue: &x3d.MFVec3f{[3]float32{0.0,0.0,0.0},[3]float32{0.0,5.0,0.0}},
                                },
                                &x3d.Script{
                                    CoreX3DNode: x3d.CoreX3DNode{
                                        DEF: stringPtr("DECLpoint_INSTANCE1000_MB1"),
                                    },
                                    Field: []x3d.X3DNode{
                                        &x3d.Field{
                                            AccessType: stringPtr("inputOutput"),
...
//               }
                                ...
                                &x3d.TimeSensor{
                                    CoreX3DNode: x3d.CoreX3DNode{
                                        DEF: stringPtr("DECLpoint_INSTANCE1000_CL1"),
                                    },
                                    CycleInterval: doublePtr(3.0),
                                    Loop: boolPtr(true),
                                },
...
//        }
                ...
                &x3d.ROUTE{
                    FromNode: stringPtr("DECLpoint_INSTANCE_CL1"),
                    FromField: stringPtr("cycleTime"),
                    ToNode: stringPtr("DECLpoint_INSTANCE_MB1"),
                    ToField: stringPtr("set_location"),
                },
                &x3d.ROUTE{
                    FromNode: stringPtr("DECLpoint_INSTANCE_CL1"),
                    FromField: stringPtr("fraction_changed"),
                    ToNode: stringPtr("DECLpoint_INSTANCE_PI1"),
                    ToField: stringPtr("set_fraction"),
                },
                &x3d.ROUTE{
                    FromNode: stringPtr("DECLpoint_INSTANCE_MB1"),
                    FromField: stringPtr("keyValue_changed"),
                    ToNode: stringPtr("DECLpoint_INSTANCE_PI1"),
                    ToField: stringPtr("set_keyValue"),
                },
                &x3d.ROUTE{
                    FromNode: stringPtr("DECLpoint_INSTANCE_PI1"),
                    FromField: stringPtr("value_changed"),
                    ToNode: stringPtr("DECLpoint_INSTANCE_node"),
                ...
                &x3d.ROUTE{
                    FromNode: stringPtr("DECLpoint_INSTANCE1000_CL1"),
                    FromField: stringPtr("cycleTime"),
                    ToNode: stringPtr("DECLpoint_INSTANCE1000_MB1"),
                    ToField: stringPtr("set_location"),
                },
                &x3d.ROUTE{
                    FromNode: stringPtr("DECLpoint_INSTANCE1000_CL1"),
                    FromField: stringPtr("fraction_changed"),
                    ToNode: stringPtr("DECLpoint_INSTANCE1000_PI1"),
                    ToField: stringPtr("set_fraction"),
                },
                &x3d.ROUTE{
                    FromNode: stringPtr("DECLpoint_INSTANCE1000_MB1"),
                    FromField: stringPtr("keyValue_changed"),
                    ToNode: stringPtr("DECLpoint_INSTANCE1000_PI1"),
                    ToField: stringPtr("set_keyValue"),
                },
                &x3d.ROUTE{
                    FromNode: stringPtr("DECLpoint_INSTANCE1000_PI1"),
                    FromField: stringPtr("value_changed"),
                    ToNode: stringPtr("DECLpoint_INSTANCE1000_node"),
                    ToField: stringPtr("set_translation"),
                },
                &x3d.ROUTE{
                    FromNode: stringPtr("DECLpoint_INSTANCE1000_MB1"),

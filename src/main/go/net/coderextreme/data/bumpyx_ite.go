...
//<component name='Shape' level='4'></component>
            ...
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("bumpyx_ite.x3d"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/bumpyx_ite.x3d"),
            },
            },
        },
        &x3d.Group{
...
//<ShaderPart url='"../shaders/x_itebubbles.fs" "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs"' type='FRAGMENT'></ShaderPart>
	...
	*/
	filename := "../data/bumpyx_ite.new.go.x3d"

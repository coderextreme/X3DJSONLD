        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("x3dconnectorProto.x3d"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("Unknown"),
            },
            &x3d.Meta{
                Name: stringPtr("modified"),
                Content: stringPtr("Mon, 08 Sep 2025 02:12:22 GMT"),
            },
            &x3d.Meta{
...
//        }
                ...
                &x3d.WorldInfo{
                    Title: stringPtr("Connector Proto"),
                },
                &x3d.Viewpoint{
                ...
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("transC2"),
                        },
                    Children: []x3d.X3DNode{
                        &x3d.Transform{
                                CoreX3DNode: x3d.CoreX3DNode{
                                    DEF: stringPtr("rotscaleC2"),
                                },
                            Children: []x3d.X3DNode{
                                &x3d.Shape{
                                    Appearance: &x3d.Appearance{
                ...
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("transC3"),
                        },
                    Children: []x3d.X3DNode{
                        &x3d.Transform{
                                CoreX3DNode: x3d.CoreX3DNode{
                                    DEF: stringPtr("rotscaleC3"),
                                },
                            Children: []x3d.X3DNode{
                                &x3d.Shape{
                                    Appearance: &x3d.Appearance{
                ...
                &x3d.ROUTE{
                    FromNode: stringPtr("PS3"),
                    FromField: stringPtr("translation_changed"),
                    ToNode: stringPtr("G3"),
                    ToField: stringPtr("set_translation"),
                },
                &x3d.ROUTE{
                    FromNode: stringPtr("PS4"),
                    FromField: stringPtr("translation_changed"),
                    ToNode: stringPtr("G4"),
                    ToField: stringPtr("set_translation"),
                },
	...
	*/
	filename := "../data/x3dconnectorProto.new.go.x3d"

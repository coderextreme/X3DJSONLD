                    ...
                    Children: []x3d.X3DNode{
                        &x3d.Shape{
                            Appearance: &x3d.Appearance{
                                Material: &x3d.PhysicalMaterial{
                                    Roughness: floatPtr(0.05),
                                    &x3d.IORMaterialExtension{
                                        CoreX3DNode: x3d.CoreX3DNode{
                                        },
                                        IndexOfRefraction: floatPtr(1.5),
                                    },
                                },
                            },
                            Geometry: &x3d.Sphere{
                    ...
                    Children: []x3d.X3DNode{
                        &x3d.Shape{
                            Appearance: &x3d.Appearance{
                                Material: &x3d.PhysicalMaterial{
                                    Roughness: floatPtr(0.05),
                                    &x3d.IridescenceMaterialExtension{
                                        CoreX3DNode: x3d.CoreX3DNode{
                                        },
                                        Iridescence: floatPtr(1.0),
                                        IridescenceIndexOfRefraction: floatPtr(1.3),
                                        IridescenceThicknessMinimum: floatPtr(100.0),
                                    },
                                },
                            },
                            Geometry: &x3d.Sphere{

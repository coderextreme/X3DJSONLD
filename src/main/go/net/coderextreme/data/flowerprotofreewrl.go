        ...
        Head: &x3d.Head{
            ...
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("flowerproto.x3d"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/flowerproto.x3d"),
            },
            },
        },
        &x3d.Group{
                    ...
                    ProtoInterface: &x3d.ProtoInterface{
                        Field: []x3d.X3DNode{
                            &x3d.Field{
                                ...
                                Value: stringPtr("\"../shaders/freewrl_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs\""),
                        },
                        &x3d.Field{
                            Name: stringPtr("fragment"),
                            AccessType: stringPtr("inputOnly"),
                            Type: stringPtr("MFString"),
                            Value: stringPtr("\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\""),
                        },
                        },
                    },
...
//			}
	...
	*/
	filename := "../data/flowerprotofreewrl.new.go.x3d"

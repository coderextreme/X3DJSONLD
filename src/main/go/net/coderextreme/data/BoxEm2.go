...
func main() {
    ...
    sceneRoot := &x3d.X3D{
        ...
        Head: &x3d.Head{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/BoxEm2.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("description"),
                Content: stringPtr("3 boxes"),
            },
            },
        },
        &x3d.Group{
            Children: []x3d.X3DNode{
                ...
                &x3d.Viewpoint{
                    Description: stringPtr("Cubes on Fire"),
	...
	*/
	filename := "../data/BoxEm2.new.go.x3d"

        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("indexedfaceset_pixeltexture_whole.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("warning"),
                Content: stringPtr("file did not transform to vrml97"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_whole-front.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_whole-rear.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_whole-top.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_whole-bottom.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_whole-left.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_whole-right.jpg"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("Test of browser ability to map the entire portion of an PixelTexture onto an IndexedFaceSet geometry. Four equal sized red (bottom left), green (bottom right) yellow (top left) and white (top right) squares in the pixel texture map all the faces of the cube."),
            },
            &x3d.Meta{
                Name: stringPtr("identifier"),
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_whole.x3d"),
            },
            &x3d.Meta{
...
//<Environment id="gamma" gammaCorrectionDefault="none"></Environment>
                &x3d.Shape{
                    ...
                    Geometry: &x3d.IndexedFaceSet{
                        ...
                        TexCoordIndex: []int32{0, 1, 3, 2, -1, 0, 1, 3, 2, -1, 0, 1, 3, 2, -1, 0, 1, 3, 2, -1, 0, 1, 3, 2, -1, 0, 1, 3, 2, -1},
                        Color: &x3d.Color{
                            Color: &x3d.MFColor{[3]float32{0.0,1.0,0.0},[3]float32{0.0,1.0,0.0},[3]float32{0.0,1.0,0.0},[3]float32{0.0,1.0,0.0},[3]float32{0.0,1.0,0.0},[3]float32{0.0,1.0,0.0}},
                        },
                        Coord: &x3d.Coordinate{
                            Point: &x3d.MFVec3f{[3]float32{-2.0,1.0,1.0},[3]float32{-2.0,-1.0,1.0},[3]float32{2.0,1.0,1.0},[3]float32{2.0,-1.0,1.0},[3]float32{2.0,1.0,-1.0},[3]float32{2.0,-1.0,-1.0},[3]float32{-2.0,1.0,-1.0},[3]float32{-2.0,-1.0,-1.0}},
                        },
                        TexCoord: &x3d.TextureCoordinate{
                            Point: &x3d.MFVec2f{[2]float32{0.0,1.0},[2]float32{0.0,0.0},[2]float32{1.0,1.0},[2]float32{1.0,0.0}},
                        },
                    },
                },
            },
	...
	*/
	filename := "../data/indexedfacesetPixeltexture_whole.new.go.x3d"

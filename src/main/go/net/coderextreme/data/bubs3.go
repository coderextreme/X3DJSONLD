            ...
            Children: []x3d.X3DNode{
                ...
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("DECLBubble_transformA"),
                        },
                    Children: []x3d.X3DNode{
                        &x3d.Shape{
                            Geometry: &x3d.Sphere{
                        ...
                        &x3d.Script{
                            CoreX3DNode: x3d.CoreX3DNode{
                                DEF: stringPtr("DECLBubble_bubbleA_bounce"),
                            },
                            Field: []x3d.X3DNode{
                                &x3d.Field{
...
//}
                        ...
                        &x3d.TimeSensor{
                            CoreX3DNode: x3d.CoreX3DNode{
                                DEF: stringPtr("DECLBubble_bubbleA_bubbleClock"),
                            },
                            CycleInterval: doublePtr(10.0),
                            Loop: boolPtr(true),
                        },
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleA_bounce"),
                            FromField: stringPtr("translation_changed"),
                            ToNode: stringPtr("DECLBubble_transformA"),
                        ...
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleA_bubbleClock"),
                            FromField: stringPtr("fraction_changed"),
                            ToNode: stringPtr("DECLBubble_bubbleA_bounce"),
                ...
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("DECLBubble_transformB"),
                        },
                    Children: []x3d.X3DNode{
                        &x3d.Shape{
                            Geometry: &x3d.Sphere{
                        ...
                        &x3d.Script{
                            CoreX3DNode: x3d.CoreX3DNode{
                                DEF: stringPtr("DECLBubble_bubbleB_bounce"),
                            },
                            Field: []x3d.X3DNode{
                                &x3d.Field{
                                    Name: stringPtr("scale"),
...
//}
                        ...
                        &x3d.TimeSensor{
                            CoreX3DNode: x3d.CoreX3DNode{
                                DEF: stringPtr("DECLBubble_bubbleB_bubbleClock"),
                            },
                            CycleInterval: doublePtr(10.0),
                            Loop: boolPtr(true),
                        },
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleB_bounce"),
                            FromField: stringPtr("translation_changed"),
                            ToNode: stringPtr("DECLBubble_transformB"),
                            ToField: stringPtr("set_translation"),
                        },
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleB_bounce"),
                        ...
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleB_bubbleClock"),
                            FromField: stringPtr("fraction_changed"),
                            ToNode: stringPtr("DECLBubble_bubbleB_bounce"),
                            ToField: stringPtr("set_fraction"),
                        },
                    },
                },
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("DECLBubble_transformC"),
                        },
                    Children: []x3d.X3DNode{
                        &x3d.Shape{
                            Geometry: &x3d.Sphere{
                        ...
                        &x3d.Script{
                            CoreX3DNode: x3d.CoreX3DNode{
                                DEF: stringPtr("DECLBubble_bubbleC_bounce"),
                            },
                            Field: []x3d.X3DNode{
                                &x3d.Field{
                                    Name: stringPtr("scale"),
...
//}
                        ...
                        &x3d.TimeSensor{
                            CoreX3DNode: x3d.CoreX3DNode{
                                DEF: stringPtr("DECLBubble_bubbleC_bubbleClock"),
                            },
                            CycleInterval: doublePtr(10.0),
                            Loop: boolPtr(true),
                        },
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleC_bounce"),
                            FromField: stringPtr("translation_changed"),
                            ToNode: stringPtr("DECLBubble_transformC"),
                            ToField: stringPtr("set_translation"),
                        },
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleC_bounce"),
                        ...
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleC_bubbleClock"),
                            FromField: stringPtr("fraction_changed"),
                            ToNode: stringPtr("DECLBubble_bubbleC_bounce"),
                            ToField: stringPtr("set_fraction"),
                        },
                    },
                },
                &x3d.Transform{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("DECLBubble_transformD"),
                        },
                    Children: []x3d.X3DNode{
                        &x3d.Shape{
                            Geometry: &x3d.Sphere{
                        ...
                        &x3d.Script{
                            CoreX3DNode: x3d.CoreX3DNode{
                                DEF: stringPtr("DECLBubble_bubbleD_bounce"),
                            },
                            Field: []x3d.X3DNode{
                                &x3d.Field{
                                    Name: stringPtr("scale"),
...
//}
                        ...
                        &x3d.TimeSensor{
                            CoreX3DNode: x3d.CoreX3DNode{
                                DEF: stringPtr("DECLBubble_bubbleD_bubbleClock"),
                            },
                            CycleInterval: doublePtr(10.0),
                            Loop: boolPtr(true),
                        },
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleD_bounce"),
                            FromField: stringPtr("translation_changed"),
                            ToNode: stringPtr("DECLBubble_transformD"),
                            ToField: stringPtr("set_translation"),
                        },
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleD_bounce"),
                        ...
                        &x3d.X3DRoute{
                            FromNode: stringPtr("DECLBubble_bubbleD_bubbleClock"),
                            FromField: stringPtr("fraction_changed"),
                            ToNode: stringPtr("DECLBubble_bubbleD_bounce"),
                            ToField: stringPtr("set_fraction"),
                        },
                    },
                },
	...
	*/
	filename := "../data/bubs3.new.go.x3d"

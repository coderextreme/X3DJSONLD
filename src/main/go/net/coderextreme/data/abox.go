    ...
    sceneRoot := &x3d.X3D{
        ...
        Head: &x3d.Head{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/abox.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("description"),
                Content: stringPtr("a box"),
            },
            },
        },
        &x3d.Group{
                    ...
                    FieldValue: []x3d.X3DNode{
                        &x3d.FieldValue{
                            ...
                            Children: []x3d.X3DNode{
                                &x3d.Shape{
                                    Geometry: &x3d.Box{
                                        Size: &x3d.SFVec3f{140.0, 140.0, 140.0},
                                    },
                                },
                            },
                    },

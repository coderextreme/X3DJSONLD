...
func main() {
        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("glflowers.x3d"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/glflowers.x3d"),
            },
            },
        },
        &x3d.Group{
                                        ...
                                        Children: []x3d.X3DNode{
                                            &x3d.ProtoInstance{
                                                ...
                                                FieldValue: []x3d.X3DNode{
                                                    &x3d.FieldValue{
                                                        Name: stringPtr("vertex"),
                                                        Value: stringPtr("\"../shaders/gl_flowers_chromatic.vs\""),
                                                },
                                                &x3d.FieldValue{
                                                    Name: stringPtr("fragment"),
	...
	*/
	filename := "../data/glflowers.new.go.x3d"

...
func main() {
        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("plainflowers.x3d"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://coderextreme.net/X3DJSONLD/src/main/data/plainflowers.x3d"),
            },
            },
        },
        &x3d.Group{
                ...
                &x3d.Group{
                    Children: []x3d.X3DNode{
                        &x3d.ExternProtoDeclare{
                            ...
                            Url: x3d.MFString{"../data/flowerproto.x3d#FlowerProto"},
                            Field: []x3d.X3DNode{
                                &x3d.Field{
                                        ...
                                        Children: []x3d.X3DNode{
                                            &x3d.ProtoInstance{
                                                ...
                                                FieldValue: []x3d.X3DNode{
                                                    &x3d.FieldValue{
                                                        Name: stringPtr("vertex"),
                                                        Value: stringPtr("\"../shaders/gl_flowers_plain.vs\""),
                                                },
                                                &x3d.FieldValue{
                                                    Name: stringPtr("fragment"),
                                                    Value: stringPtr("\"../shaders/plain.fs\""),
                                                },
                                                },
                                            },
                                        },
	...
	*/
	filename := "../data/plainflowers.new.go.x3d"

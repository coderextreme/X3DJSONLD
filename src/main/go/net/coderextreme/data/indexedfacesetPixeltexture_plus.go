        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("indexedfaceset_pixeltexture_plus.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_plus-front.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_plus-rear.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_plus-top.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_plus-bottom.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_plus-left.jpg"),
            },
            &x3d.Meta{
                Name: stringPtr("Image"),
                Content: stringPtr("indexedfaceset_pixeltexture_plus-right.jpg"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("Test of browser ability to map a 3 times multiple of an PixelTexture onto an IndexedFaceSet geometry. A 3 by 3 matrix of four equal sized red, green, white and yellow squares in the pixel texture map all the faces of the cube."),
            },
            &x3d.Meta{
                Name: stringPtr("identifier"),
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_plus.x3d"),
            },
            &x3d.Meta{
...
//<Environment id="gamma" gammaCorrectionDefault="none"></Environment>
                &x3d.Shape{
                    ...
                    Geometry: &x3d.IndexedFaceSet{
                        ...
                        TexCoord: &x3d.TextureCoordinate{
                            Point: &x3d.MFVec2f{[2]float32{-1.0,2.0},[2]float32{-1.0,-1.0},[2]float32{2.0,2.0},[2]float32{2.0,-1.0}},
                        },
                    },
                },
            },
	...
	*/
	filename := "../data/indexedfacesetPixeltexture_plus.new.go.x3d"

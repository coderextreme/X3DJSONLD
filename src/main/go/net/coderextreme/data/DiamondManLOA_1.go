...
func main() {
        ...
        Head: &x3d.Head{
            ...
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("DiamondManLOA_1.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("description"),
                Content: stringPtr("HAnim skeletal structure for Level of Action (LOA) one, with diamonds at the Joint centers. LOA-1 is typical low-end real-time 3D hierarchy."),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("Tue, 09 Sep 2025 19:37:54 GMT"),
            },
            &x3d.Meta{
                Name: stringPtr("reference"),
                Content: stringPtr("../Templates/DiamondManLOA_1.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("reference"),
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA_1.x3d"),
            },
            },
        },
        Scene: &x3d.Scene{
            Children: []x3d.X3DChildNode{
                ...
                &x3d.HAnimHumanoid{
                    ...
                    Skeleton: []x3d.X3DNode{
                        &x3d.HAnimJoint{
                            CoreX3DNode: x3d.CoreX3DNode{
                                DEF: stringPtr("hanim_HumanoidRoot"),
                            },
                    ...
                    Joints: []x3d.X3DNode{
                        &x3d.HAnimJoint{
                            CoreX3DNode: x3d.CoreX3DNode{
                                USE: stringPtr("hanim_HumanoidRoot"),
                            },
                    },
                    &x3d.HAnimJoint{
                        CoreX3DNode: x3d.CoreX3DNode{
                    ...
                    &x3d.HAnimSite{
                        CoreX3DNode: x3d.CoreX3DNode{
                            DEF: stringPtr("hanim_DiamondManLOA_1_view"),
                        },
                        Name: stringPtr("DiamondManLOA_1_view"),
                        &x3d.Viewpoint{
                            CoreX3DNode: x3d.CoreX3DNode{
	...
	*/
	filename := "../data/DiamondManLOA_1.new.go.x3d"

...
// downloadSchemaIfNotExists function...
...
// Validation function remains, but is commented out in main.
...
func main() {
			...
			Children: []x3d.X3DChildNode{
				&x3d.ProtoDeclare{
					...
					ProtoInterface: &x3d.ProtoInterface{
						Field: []x3d.X3DNode{
							// FIXED: Added the explicit type &x3d.Field{}
							&x3d.Field{
					...
					ProtoBody: &x3d.ProtoBody{
						Children: []x3d.X3DNode{
							&x3d.Transform{
								...
								IS: &x3d.IS{
									// FIXED: Changed slice type from []*x3d.X3DNode to []x3d.X3DNode
									Connect: []x3d.X3DNode{
										// FIXED: Added the explicit type &x3d.Connect{}
										&x3d.Connect{
								...
								Children: []x3d.X3DNode{
									...
									&x3d.ProtoInstance{
										...
										FieldValue: []x3d.X3DNode{
											// FIXED: Added the explicit type &x3d.FieldValue{}
											&x3d.FieldValue{
												Name:  stringPtr("xtranslation"),
	...
	/*
	// --- XSD Schema Validation (SKIPPED DUE TO LIBRARY BUG) ---
	fmt.Println("\n--- Validating XML against X3D 4.0 Schema (using libxml2) ---")
	err = validateXMLWithSchema(output, schemaFilename)
	if err != nil {
		// Also print the generated XML on failure to help debug

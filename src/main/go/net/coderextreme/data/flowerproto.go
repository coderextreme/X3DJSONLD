                    ...
                    ProtoInterface: &x3d.ProtoInterface{
                        Field: []x3d.X3DNode{
                            &x3d.Field{
                                ...
                                Value: stringPtr("\"../shaders/gl_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/gl_flowers_chromatic.vs\""),
                        },
                        &x3d.Field{
                            Name: stringPtr("fragment"),
                            AccessType: stringPtr("inputOnly"),
                            Type: stringPtr("MFString"),
                            Value: stringPtr("\"../shaders/pc_flowers.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_flowers.fs\""),
                        },
                        },
                    },
...
//			}
	...
	*/
	filename := "../data/flowerproto.new.go.x3d"

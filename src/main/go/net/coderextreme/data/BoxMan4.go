...
func main() {
    ...
    sceneRoot := &x3d.X3D{
        ...
        Head: &x3d.Head{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("Original site http://HAnim.org"),
            },
            &x3d.Meta{
                Name: stringPtr("reference"),
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan.x3d"),
            },
            },
        },
        Scene: &x3d.Scene{
            Children: []x3d.X3DChildNode{
                ...
                &x3d.Script{
                    ...
                    Url: x3d.MFString{"BoxMan.js", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan.js"},
	...
	*/
	filename := "../data/BoxMan4.new.go.x3d"

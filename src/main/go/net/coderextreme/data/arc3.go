        ...
        Scene: &x3d.Scene{
            Children: []x3d.X3DChildNode{
                ...
                &x3d.Transform{
                        ...
                        Translation: &x3d.SFVec3f{0.0, 3.9, 0.0},
                        ...
                        &x3d.Script{
                            ...
                            Field: []x3d.X3DNode{
                                &x3d.Field{
                                    ...
                                    Children: []x3d.X3DNode{
                                        &x3d.Transform{
                                                CoreX3DNode: x3d.CoreX3DNode{
                                                    USE: stringPtr("DECLpoint_G1_node"),
                                                },
                                            Children: []x3d.X3DNode{
                                            },
                                        },
                            ...
                            &x3d.Field{
                                ...
                                Children: []x3d.X3DNode{
                                    &x3d.Transform{
                                            CoreX3DNode: x3d.CoreX3DNode{
                                                USE: stringPtr("DECLpoint_G2_node"),
                                            },
                                        Children: []x3d.X3DNode{
                                        },
                                    },

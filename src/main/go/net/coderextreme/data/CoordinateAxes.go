        ...
        Head: &x3d.Head{
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("CoordinateAxes.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("creator"),
                Content: stringPtr("Don Brutzman, Byounghyun Yoo"),
            },
            &x3d.Meta{
                Name: stringPtr("created"),
                Content: stringPtr("14 July 2000"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("X Y Z axis arrows and labels in X3D coordinate system. See CoordinateAxesExample for use as an Inline coordinate-system reference frame."),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                Name: stringPtr("reference"),
                Content: stringPtr("https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxesNSEW.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("reference"),
                Content: stringPtr("https://savage.nps.edu/Savage/Tools/Authoring/CoordinateAxes.x3d"),
            },
            &x3d.Meta{
                Name: stringPtr("reference"),
                Content: stringPtr("https://savage.nps.edu/Savage/Tools/Authoring/CoordinateAxesNSEW.x3d"),
            },
            &x3d.Meta{
                                    ...
                                    &x3d.Shape{
                                        Appearance: &x3d.Appearance{
                                            ...
                                            Material: &x3d.Material{
                                                DiffuseColor: &x3d.SFColor{0.1, 0.6, 0.1},
                                        ...
                                        Children: []x3d.X3DNode{
                                            &x3d.Shape{
                                                Appearance: &x3d.Appearance{
                                                    ...
                                                    Material: &x3d.Material{
                                                        DiffuseColor: &x3d.SFColor{0.7, 0.1, 0.1},

    ...
    sceneRoot := &x3d.X3D{
        ...
        Head: &x3d.Head{
            ...
            Metas: []*x3d.Meta{
                &x3d.Meta{
                    ...
                    Content: stringPtr("OrientationInterpolator.x3d"),
            },
            &x3d.Meta{
            ...
            &x3d.Meta{
                ...
                Content: stringPtr("29 December 2025"),
            },
            &x3d.Meta{
        ...
        &x3d.Group{
            Children: []x3d.X3DNode{
                &x3d.WorldInfo{
                    Title: stringPtr("OrientationInterpolator.x3d"),
                },
//<OrientationInterpolator DEF='Stop_l_midtarsal_RotationInterpolator' key='0 0.5 1' keyValue='0 0 1 0 0 0 1 0 0 0 1 0'/>
	...
	*/
	filename := "../data/OrientationInterpolator.new.go.x3d"

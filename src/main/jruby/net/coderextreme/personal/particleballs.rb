              ...
              .addComments(CommentsBlock.new("<ComposedShader DEF=\"shader\" language=\"GLSL\"> <field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field> <field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1.0 1.033'></field> <field name='bias' type='SFFloat' accessType='inputOutput' value='0.5'></field> <field name='scale' type='SFFloat' accessType='inputOutput' value='0.5'></field> <field name='power' type='SFFloat' accessType='inputOutput' value='2'></field> <ShaderPart type=\"VERTEX\" url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/> <ShaderPart type='FRAGMENT' url='\"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/> </ComposedShader>"))
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/x_iteparticles.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_iteparticles.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setDEF("commonfs")
...
x3D0.toFileX3D "../personal/particleballs.new.jruby.x3d"
x3D0.toFileJSON "../personal/particleballs.new.jruby.json"

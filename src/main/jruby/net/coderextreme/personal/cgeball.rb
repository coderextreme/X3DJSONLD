...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addComments(CommentsBlock.new("component name='Shaders' level='1'></component"))
        .addComments(CommentsBlock.new("component name='CubeMapTexturing' level='1'></component"))
        .addMeta(Meta.new()
            .setName("title")
            .setContent("ball.x3d")
        )
                ...
                .setAppearance(Appearance.new()
                    ...
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/castle.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setDEF("commonfs")
                            .setUrl(["../shaders/castle.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs"].to_java Java::java.lang.String)
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../personal/cgeball.new.jruby.x3d"
x3D0.toFileJSON "../personal/cgeball.new.jruby.json"

...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/flowers.x3d")
        )
    )
    .setScene(Scene.new()
...
x3D0.toFileX3D "../personal/flowers.new.jruby.x3d"
x3D0.toFileJSON "../personal/flowers.new.jruby.json"

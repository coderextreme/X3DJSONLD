            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Group.new()
                    .addChild(Transform.new()
                        ...
                        .addChild(Transform.new()
                            .setTranslation([1, 0, 1].to_java Java::float)
                            .addChild(Shape.new()
                ...
                .addChild(Group.new()
                    .addChild(Shape.new()
                        .setGeometry(Extrusion.new()
                            ...
                            .setSpine([0, -50, 0, 0, 50, 0].to_java Java::float)
                        )
                        .setAppearance(Appearance.new()
                            .setMaterial(Material.new()
...
x3D0.toFileX3D "../personal/forcenode.new.jruby.x3d"
x3D0.toFileJSON "../personal/forcenode.new.jruby.json"

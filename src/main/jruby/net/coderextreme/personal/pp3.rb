        ...
        .addChild(ProtoDeclare.new()
            ...
            .setProtoBody(ProtoBody.new()
              ...
              .addComments(CommentsBlock.new("left"))
                ...
                .addComments(CommentsBlock.new("<Transform translation=\"-2.5 0 0\"> <Shape> <Text DEF=\"LeftString\" string='\"l\"'/> </Shape> </Transform> <StringSensor DEF=\"LeftSensor\" enabled=\"false\"/> <TouchSensor DEF=\"LeftTouch\" enabled=\"true\"/>"))
                    )
                        ...
                        .addChild(Transform.new()
                            ...
                            .addChild(Shape.new()
                                ...
                                .setGeometry(Text.new()
                                    .setDEF("RightString")
                                    .setString(["r"].to_java Java::java.lang.String)
                                )
                            )
                        )
                    ...
                    .addChild(Transform.new()
                        ...
                        .addChild(Shape.new()
                            ...
                            .setGeometry(Extrusion.new()
                                .setCreaseAngle(0.785)
                                .setCrossSection([1, 0, 0.92, -0.38, 0.71, -0.71, 0.38, -0.92, 0, -1, -0.38, -0.92, -0.71, -0.71, -0.92, -0.38, -1, 0, -0.92, 0.38, -0.71, 0.71, -0.38, 0.92, 0, 1, 0.38, 0.92, 0.71, 0.71, 0.92, 0.38, 1, 0].to_java Java::float)
                                .setSpine([0, 1.5, 0, 0, 2, 0, 0, 2.5, 0].to_java Java::float)
                            )
                        )
                        .addChild(Transform.new()
                            ...
                            .addChild(Shape.new()
                                ...
                                .setGeometry(Text.new()
                                    .setDEF("UpString")
                                    .setString(["u"].to_java Java::java.lang.String)
                                )
                            )
                        )
                        .addChild(StringSensor.new()
                    ...
                    .addChild(Transform.new()
                        ...
                        .addChild(Shape.new()
                            ...
                            .setGeometry(Extrusion.new()
                                .setCreaseAngle(0.785)
                                .setCrossSection([1, 0, 0.92, -0.38, 0.71, -0.71, 0.38, -0.92, 0, -1, -0.38, -0.92, -0.71, -0.71, -0.92, -0.38, -1, 0, -0.92, 0.38, -0.71, 0.71, -0.38, 0.92, 0, 1, 0.38, 0.92, 0.71, 0.71, 0.92, 0.38, 1, 0].to_java Java::float)
                                .setSpine([0, -2.5, 0, 0, -2, 0, 0, -1.5, 0].to_java Java::float)
                            )
                        )
                .addComments(CommentsBlock.new("<Transform translation=\"-0.5 -2.5 0\"> <Shape> <Text DEF=\"DownString\" string='\"d\"'/> </Shape> </Transform> <StringSensor DEF=\"DownSensor\" enabled=\"false\"/> <TouchSensor description='touch to activate' DEF=\"DownTouch\" enabled=\"true\"/>"))
                    )
              .addComments(CommentsBlock.new("center"))
                    .addChild(Transform.new()
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    .setDiffuseColor([1, 0, 0.7].to_java Java::float)
                                )
                            )
...
x3D0.toFileX3D "../personal/pp3.new.jruby.x3d"
x3D0.toFileJSON "../personal/pp3.new.jruby.json"

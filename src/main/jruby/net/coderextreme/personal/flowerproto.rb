...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/flowerproto.x3d")
        )
    )
    .setScene(Scene.new()
        .addChild(ProtoDeclare.new()
            ...
            .setProtoInterface(ProtoInterface.new()
                .addField(Field.new()
                    ...
                    .setType("MFString")
                    .setValue("\"https://coderextreme.net/X3DJSONLD/src/main/shaders/gl_flowers_chromatic.vs\"")
                )
                .addField(Field.new()
                    .setName("fragment")
                    .setAccessType("inputOutput")
                    .setType("MFString")
                    .setValue("\"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_flowers.fs\"")
                )
            )
            .setProtoBody(ProtoBody.new()
                .addChild(Transform.new()
                    ...
                    .addComments(CommentsBlock.new("<field name='cube' type='SFNode' accessType=\"inputOutput\"> <ComposedCubeMapTexture USE=\"texture\"/> </field>"))
...
x3D0.toFileX3D "../personal/flowerproto.new.jruby.x3d"
x3D0.toFileJSON "../personal/flowerproto.new.jruby.json"

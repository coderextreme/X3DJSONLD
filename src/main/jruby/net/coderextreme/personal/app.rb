...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            .setRotation([7, 8, 9, 3.14].to_java Java::float)
            .setScale([4, 5, 6].to_java Java::float)
            .setTranslation([1, 2, 3].to_java Java::float)
        )
    )
x3D0.toFileX3D "../personal/app.new.jruby.x3d"
x3D0.toFileJSON "../personal/app.new.jruby.json"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            .setTranslation([-4, 0, 0].to_java Java::float)
            .addChild(Shape.new()
                .setGeometry(Box.new()
                )
            )
        ...
        .addChild(OrientationInterpolator.new()
            ...
            .setKeyValue([0, 0, 1, 0, 0, 0, 1, 1.57].to_java Java::float)
        )
        .addChild(ROUTE.new()
            .setFromNode("Clock")
...
x3D0.toFileX3D "../personal/localrotation.new.jruby.x3d"
x3D0.toFileJSON "../personal/localrotation.new.jruby.json"

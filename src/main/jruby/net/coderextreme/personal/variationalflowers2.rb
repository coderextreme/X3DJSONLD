...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("title")
            .setContent("variationalflowers2.x3d")
        )
        .addMeta(Meta.new()
            .setName("creator")
        ...
        .addMeta(Meta.new()
            .setName("description")
            .setContent("A flower variational system")
        )
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/variationalflowers2.x3d")
        )
    )
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("variationalflowers2.x3d")
        )
        ...
        .addChild(Background.new()
            .setBackUrl(["../resources/images/all_probes/stpeters_cross/stpeters_back.png"].to_java Java::java.lang.String)
            .setBottomUrl(["../resources/images/all_probes/stpeters_cross/stpeters_bottom.png"].to_java Java::java.lang.String)
            .setFrontUrl(["../resources/images/all_probes/stpeters_cross/stpeters_front.png"].to_java Java::java.lang.String)
            .setLeftUrl(["../resources/images/all_probes/stpeters_cross/stpeters_left.png"].to_java Java::java.lang.String)
            .setRightUrl(["../resources/images/all_probes/stpeters_cross/stpeters_right.png"].to_java Java::java.lang.String)
            .setTopUrl(["../resources/images/all_probes/stpeters_cross/stpeters_top.png"].to_java Java::java.lang.String)
        )
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        ...
                        .setBackTexture(ImageTexture.new()
                            .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_back.png"].to_java Java::java.lang.String)
                        )
                        .setBottomTexture(ImageTexture.new()
                            .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_bottom.png"].to_java Java::java.lang.String)
                        )
                        .setFrontTexture(ImageTexture.new()
                            .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_front.png"].to_java Java::java.lang.String)
                        )
                        .setLeftTexture(ImageTexture.new()
                            .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_left.png"].to_java Java::java.lang.String)
                        )
                        .setRightTexture(ImageTexture.new()
                            .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_right.png"].to_java Java::java.lang.String)
                        )
                        .setTopTexture(ImageTexture.new()
                            .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_top.png"].to_java Java::java.lang.String)
                        )
                    )
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/x_ite_variations.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/commonnew.fs"].to_java Java::java.lang.String)
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../personal/variationalflowers2.new.jruby.x3d"
x3D0.toFileJSON "../personal/variationalflowers2.new.jruby.json"

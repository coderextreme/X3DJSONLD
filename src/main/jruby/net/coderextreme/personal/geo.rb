...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setBackUrl(["../resources/images/bBK.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBK.png"].to_java Java::java.lang.String)
            .setBottomUrl(["../resources/images/bBT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBT.png"].to_java Java::java.lang.String)
            .setFrontUrl(["../resources/images/bFR.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bFR.png"].to_java Java::java.lang.String)
            .setLeftUrl(["../resources/images/bLF.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bLF.png"].to_java Java::java.lang.String)
            .setRightUrl(["../resources/images/bRT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bRT.png"].to_java Java::java.lang.String)
            .setTopUrl(["../resources/images/bTP.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bTP.png"].to_java Java::java.lang.String)
        )
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        ...
                        .setBackTexture(ImageTexture.new()
                            .setUrl(["../resources/images/bBK.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBK.png"].to_java Java::java.lang.String)
                        )
                        .setBottomTexture(ImageTexture.new()
                            .setUrl(["../resources/images/bBT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bBT.png"].to_java Java::java.lang.String)
                        )
                        .setFrontTexture(ImageTexture.new()
                            .setUrl(["../resources/images/bFR.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bFR.png"].to_java Java::java.lang.String)
                        )
                        .setLeftTexture(ImageTexture.new()
                            .setUrl(["../resources/images/bLF.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bLF.png"].to_java Java::java.lang.String)
                        )
                        .setRightTexture(ImageTexture.new()
                            .setUrl(["../resources/images/bRT.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bRT.png"].to_java Java::java.lang.String)
                        )
                        .setTopTexture(ImageTexture.new()
                            .setUrl(["../resources/images/bTP.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/bTP.png"].to_java Java::java.lang.String)
                        )
                    )
...
x3D0.toFileX3D "../personal/geo.new.jruby.x3d"
x3D0.toFileJSON "../personal/geo.new.jruby.json"

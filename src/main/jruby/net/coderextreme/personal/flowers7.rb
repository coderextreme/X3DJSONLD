...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/flowers7.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("a flower")
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setDEF("background")
            .setBackUrl(["../resources/images/all_probes/beach_cross/beach_back.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"].to_java Java::java.lang.String)
            .setBottomUrl(["../resources/images/all_probes/beach_cross/beach_bottom.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"].to_java Java::java.lang.String)
            .setFrontUrl(["../resources/images/all_probes/beach_cross/beach_front.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"].to_java Java::java.lang.String)
            .setLeftUrl(["../resources/images/all_probes/beach_cross/beach_left.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"].to_java Java::java.lang.String)
            .setRightUrl(["../resources/images/all_probes/beach_cross/beach_right.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"].to_java Java::java.lang.String)
            .setTopUrl(["../resources/images/all_probes/beach_cross/beach_top.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"].to_java Java::java.lang.String)
        )
        .addChild(Viewpoint.new()
            .setPosition([0, 0, 40].to_java Java::float)
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        ...
                        .setBackTexture(ImageTexture.new()
                            .setDEF("backShader")
                            .setUrl(["../resources/images/all_probes/beach_cross/beach_back.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"].to_java Java::java.lang.String)
                        )
                        .setBottomTexture(ImageTexture.new()
                            .setDEF("bottomShader")
                            .setUrl(["../resources/images/all_probes/beach_cross/beach_bottom.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"].to_java Java::java.lang.String)
                        )
                        .setFrontTexture(ImageTexture.new()
                            .setDEF("frontShader")
                            .setUrl(["../resources/images/all_probes/beach_cross/beach_front.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"].to_java Java::java.lang.String)
                        )
                        .setLeftTexture(ImageTexture.new()
                            .setDEF("leftShader")
                            .setUrl(["../resources/images/all_probes/beach_cross/beach_left.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"].to_java Java::java.lang.String)
                        )
                        .setRightTexture(ImageTexture.new()
                            .setDEF("rightShader")
                            .setUrl(["../resources/images/all_probes/beach_cross/beach_right.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"].to_java Java::java.lang.String)
                        )
                        .setTopTexture(ImageTexture.new()
                            .setDEF("topShader")
                            .setUrl(["../resources/images/all_probes/beach_cross/beach_top.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"].to_java Java::java.lang.String)
                        )
                    )
                    .addShaders(ComposedShader.new()
                        .setDEF("x3dom")
                        .setLanguage("GLSL")
                .addComments(CommentsBlock.new("TODO VERIFY <field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field>"))
                        .addField(Field.new()
                            .setName("cube")
                            .setType("SFNode")
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom_flowers_chromatic.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs"].to_java Java::java.lang.String)
                            .setType("FRAGMENT")
                        )
                    )
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flowers_chromatic.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_flowers_chromatic.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.fs"].to_java Java::java.lang.String)
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../personal/flowers7.new.jruby.x3d"
x3D0.toFileJSON "../personal/flowers7.new.jruby.json"

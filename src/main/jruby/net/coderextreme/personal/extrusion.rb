...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/extrusion.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
...
x3D0.toFileX3D "../personal/extrusion.new.jruby.x3d"
x3D0.toFileJSON "../personal/extrusion.new.jruby.json"

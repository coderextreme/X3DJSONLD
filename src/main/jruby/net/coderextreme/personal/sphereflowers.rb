    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(["../personal/flowerproto.x3d#FlowerProto", "https://coderextreme.net/X3DJSONLD/src/main/personal/flowerproto.x3d#FlowerProto"].to_java Java::java.lang.String)
                .addField(Field.new()
                    .setName("vertex")
            ...
            .addChild(Sound.new()
                ...
                .setMinBack(20.0)
                .setMinFront(20.0)
                .setLocation([0, 1, 0].to_java Java::float)
                .setSource(AudioClip.new()
                    .setDEF("AudioClip")
                    .setDescription("Chandubabamusic #1")
                    .setUrl(["../resources/chandubabamusic1.wav", "https://coderextreme.net/X3DJSONLD/src/main/resources/chandubabamusic1.wav"].to_java Java::java.lang.String)
                )
            )
            .addChild(ROUTE.new()
...
x3D0.toFileX3D "../personal/sphereflowers.new.jruby.x3d"
x3D0.toFileJSON "../personal/sphereflowers.new.jruby.json"

            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor([0, 0.5, 1].to_java Java::float)
                        .setSpecularColor([0, 0.5, 1].to_java Java::float)
                    )
                )
...
x3D0.toFileX3D "../personal/flower3.new.jruby.x3d"
x3D0.toFileJSON "../personal/flower3.new.jruby.json"

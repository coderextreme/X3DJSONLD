...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/ballx3dom.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            ...
            .addChild(Shape.new()
                ...
                .setAppearance(Appearance.new()
                    ...
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setDEF("common")
                            .setUrl(["../shaders/common.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/common.fs"].to_java Java::java.lang.String)
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../personal/ballx3dom.new.jruby.x3d"
x3D0.toFileJSON "../personal/ballx3dom.new.jruby.json"

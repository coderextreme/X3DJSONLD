...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/x3domflowers.x3d")
        )
    )
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(["../personal/flowerproto.json#FlowerProto"].to_java Java::java.lang.String)
                .addField(Field.new()
                    .setName("vertex")
...
x3D0.toFileX3D "../personal/x3domflowers.new.jruby.x3d"
x3D0.toFileJSON "../personal/x3domflowers.new.jruby.json"

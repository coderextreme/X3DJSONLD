                ...
                .setAppearance(Appearance.new()
                    ...
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/octaga.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setDEF("commonfs")
...
x3D0.toFileX3D "../personal/octball.new.jruby.x3d"
x3D0.toFileJSON "../personal/octball.new.jruby.json"

...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/bub.x3d")
        )
    )
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            .setPosition([0, 0, 20].to_java Java::float)
                ...
                .addChild(Transform.new()
                  ...
                  .addComments(CommentsBlock.new("<ComposedShader DEF='instant' language=\"GLSL\"> <field name='cube' type='SFInt32' accessType=\"inputOutput\" value='0'/> <field name='chromaticDispertion' type='SFVec3f' accessType=\"inputOutput\" value='0.98 1.0 1.033'/> <field name='bias' type='SFFloat' accessType=\"inputOutput\" value='0.5'/> <field name='scale' type='SFFloat' accessType=\"inputOutput\" value='0.5'/> <field name='power' type='SFFloat' accessType=\"inputOutput\" value='2.0'/> <ShaderPart url='\"../shaders/instant.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/instant.vs\"' type='VERTEX'></ShaderPart> <ShaderPart url='\"../shaders/pc_bubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_bubbles.fs\"' type='FRAGMENT'></ShaderPart> </ComposedShader>"))
                            .addShaders(ComposedShader.new()
                                ...
                                .addParts(ShaderPart.new()
                                    .setUrl(["../shaders/pc_bubbles.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_bubbles.fs"].to_java Java::java.lang.String)
                                    .setType("FRAGMENT")
                                )
                            )
                            .addShaders(ComposedShader.new()
                                ...
                                .addParts(ShaderPart.new()
                                    .setUrl(["../shaders/x_itebubbles.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs"].to_java Java::java.lang.String)
                                    .setType("FRAGMENT")
                                )
                            )
                        )
...
x3D0.toFileX3D "../personal/bub.new.jruby.x3d"
x3D0.toFileJSON "../personal/bub.new.jruby.json"

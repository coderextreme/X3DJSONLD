...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/sphere.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("a sphere")
...
x3D0.toFileX3D "../personal/sphere.new.jruby.x3d"
x3D0.toFileJSON "../personal/sphere.new.jruby.json"

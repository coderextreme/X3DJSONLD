...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/flowers2.x3d")
        )
        .addMeta(Meta.new()
            .setName("generator")
                ...
                .setProtoBody(ProtoBody.new()
                    .addChild(Group.new()
                        ...
                        .addChild(OrientationInterpolator.new()
                            ...
                            .setKeyValue([1, 0, 0, 0, 1, 0, 0, 3.14, 1, 0, 0, 6.28].to_java Java::float)
                        )
                    ...
                    .addComments(CommentsBlock.new("<IndexedFaceSet DEF=\"Orbit\" creaseAngle=\"0\"> <Coordinate DEF=\"OrbitCoordinates\"/> </IndexedFaceSet>"))
...
x3D0.toFileX3D "../personal/flowers2.new.jruby.x3d"
x3D0.toFileJSON "../personal/flowers2.new.jruby.json"

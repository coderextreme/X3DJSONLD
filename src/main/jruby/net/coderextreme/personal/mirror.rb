...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/mirror.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
    ...
    .setScene(Scene.new()
        .addChild(Viewpoint.new()
            .setPosition([0, 5, 100].to_java Java::float)
        ...
        .addChild(TextureBackground.new()
            .setLeftTexture(ImageTexture.new()
                ...
                .setUrl(["../resources/images/all_probes/beach_cross/beach_left.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_left.png"].to_java Java::java.lang.String)
            )
            .setRightTexture(ImageTexture.new()
                .setDEF("rightBackgroundTexture")
                .setUrl(["../resources/images/all_probes/beach_cross/beach_right.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_right.png"].to_java Java::java.lang.String)
            )
            .setFrontTexture(ImageTexture.new()
                .setDEF("frontBackgroundTexture")
                .setUrl(["../resources/images/all_probes/beach_cross/beach_front.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_front.png"].to_java Java::java.lang.String)
            )
            .setBackTexture(ImageTexture.new()
                .setDEF("backBackgroundTexture")
                .setUrl(["../resources/images/all_probes/beach_cross/beach_back.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_back.png"].to_java Java::java.lang.String)
            )
            .setTopTexture(ImageTexture.new()
                .setDEF("topBackgroundTexture")
                .setUrl(["../resources/images/all_probes/beach_cross/beach_top.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_top.png"].to_java Java::java.lang.String)
            )
            .setBottomTexture(ImageTexture.new()
                .setDEF("bottomBackgroundTexture")
                .setUrl(["../resources/images/all_probes/beach_cross/beach_bottom.png", "https://coderextrme.net/X3DJSONLD/src/main/resources/images/all_probes/beach_cross/beach_bottom.png"].to_java Java::java.lang.String)
            )
        )
        .addChild(Transform.new()
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    ...
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/x3dom.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x3dom.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/mix.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/mix.fs"].to_java Java::java.lang.String)
                            .setType("FRAGMENT")
                        )
                    )
                    .addShaders(ComposedShader.new()
                ...
                .addComments(CommentsBlock.new("http://hypertextbook.com/facts/2005/JustinChe.shtml"))
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/x_ite.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/x_itemix.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itemix.fs"].to_java Java::java.lang.String)
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../personal/mirror.new.jruby.x3d"
x3D0.toFileJSON "../personal/mirror.new.jruby.json"

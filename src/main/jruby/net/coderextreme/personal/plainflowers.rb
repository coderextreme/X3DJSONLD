...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/plainflowers.x3d")
        )
    )
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(["../personal/flowerproto.x3d#FlowerProto"].to_java Java::java.lang.String)
                .addField(Field.new()
                    .setName("vertex")
                    ...
                    .addChild(Group.new()
                        .addChild(ProtoInstance.new()
                            ...
                            .addFieldValue(FieldValue.new()
                                .setName("vertex")
                                .setValue("\"../shaders/x_ite_flowers_plain.vs\"")
                            )
                            .addFieldValue(FieldValue.new()
                                .setName("fragment")
...
x3D0.toFileX3D "../personal/plainflowers.new.jruby.x3d"
x3D0.toFileJSON "../personal/plainflowers.new.jruby.json"

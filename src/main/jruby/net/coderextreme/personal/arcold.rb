...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/personal/arc.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
...
"		}")                    )
        ...
        .addComments(CommentsBlock.new("from doug sanden"))
        .addChild(ProtoDeclare.new()
...
x3D0.toFileX3D "../personal/arcold.new.jruby.x3d"
x3D0.toFileJSON "../personal/arcold.new.jruby.json"

...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("modified")
            .setContent("Mon, 15 Sep 2025 05:20:33 GMT")
        )
        .addMeta(Meta.new()
            .setName("warning")
            .setContent("All length values are rescaled from inches to meters, not compatible with other typical motion animation behavior libraries which are based in meters.")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("Original version of articulated 3D game character designed with a general graphics tool, then converted into an X3D HAnim model.")
        )
        .addMeta(Meta.new()
            .setName("reference")
        ...
        .addMeta(Meta.new()
            .setName("reference")
            .setContent("[h-anim] Rescaling HAnim Jin models, preserving originals in Legacy directory https://web3d.org/mailman/private/h-anim_web3d.org/2024-February/002317.html")
        )
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA1.x3d")
        )
        .addMeta(Meta.new()
            .setName("generator")
    ...
    .setScene(Scene.new()
        ...
        .addChild(HAnimHumanoid.new()
            ...
            .setMetadata(MetadataSet.new()
                ...
                .addValue(MetadataFloat.new()
                    .setName("weight")
                    .setValue([50].to_java Java::float)
                )
                .addValue(MetadataString.new()
                    .setName("humanoidVersion")
                    .setValue(["validation testing"].to_java Java::java.lang.String)
                )
            )
            .addSkeleton(HAnimJoint.new()
                ...
                .addChild(HAnimJoint.new()
                    .setDEF("hanim_vl5")
                    .setName("vl5")
                    .setCenter([0, 40.07, -0.8527].to_java Java::float)
                    .addChild(HAnimSegment.new()
                        .setDEF("hanim_l5")
                        .setName("l5")
                        .addChild(Transform.new()
                            .setTranslation([0, 40.07, -0.8527].to_java Java::float)
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
...
x3D0.toFileX3D "../data/JinOriginalLOA1.new.jruby.x3d"
x3D0.toFileJSON "../data/JinOriginalLOA1.new.jruby.x3dj"

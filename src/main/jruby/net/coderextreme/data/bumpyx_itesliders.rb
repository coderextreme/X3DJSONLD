...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addComments(CommentsBlock.new("<component name='DIS' level='2'></component>"))
            ...
            .addComments(CommentsBlock.new("the model that is being reviewed by the users of this scene"))
              ...
              .addComments(CommentsBlock.new("Images courtesy of Paul Debevec's Light Probe Image Gallery"))
                  ...
                  .addComments(CommentsBlock.new("<Sphere radius='40'></Sphere>"))
                            ...
                            .setAppearance(Appearance.new()
                                ...
                                .setTexture(ComposedCubeMapTexture.new()
                                    ...
                                    .setBackTexture(ImageTexture.new()
                                        .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_back.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"].to_java Java::java.lang.String)
                                    )
                                    .setBottomTexture(ImageTexture.new()
                                        .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_bottom.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"].to_java Java::java.lang.String)
                                    )
                                    .setFrontTexture(ImageTexture.new()
                                        .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_front.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"].to_java Java::java.lang.String)
                                    )
                                    .setLeftTexture(ImageTexture.new()
                                        .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_left.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"].to_java Java::java.lang.String)
                                    )
                                    .setRightTexture(ImageTexture.new()
                                        .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_right.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"].to_java Java::java.lang.String)
                                    )
                                    .setTopTexture(ImageTexture.new()
                                        .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_top.png", "https://coderextreme.net/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"].to_java Java::java.lang.String)
                                    )
                                )
                      ...
                      .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/x_ite.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs\"' type=\"VERTEX\" containerField='parts'></ShaderPart>"))
                      .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/x_itebubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/xite_bubbles.fs\"' containerField='parts' type='FRAGMENT'></ShaderPart>"))
                                )
                            )
                        )
                    )
...
"}")                )
                ...
                .addChild(ProtoDeclare.new()
                    ...
                    .setProtoBody(ProtoBody.new()
                        .addChild(Group.new()
                            ...
                            .addChild(Script.new()
                                .setUrl(["../javascripts/X3DUser.js", "https://raw.githubusercontent.com/coderextreme/JSONverse/refs/heads/main/public/javascripts/X3DUser.js"].to_java Java::java.lang.String)
            ...
            .addLayers(Layer.new()
                ...
                .addChild(Script.new()
                    .setUrl(["../javascripts/X3DAvatar.js", "https://raw.githubusercontent.com/coderextreme/JSONverse/refs/heads/main/public/javascripts/X3DAvatar.js"].to_java Java::java.lang.String)
...
x3D0.toFileX3D "../data/bumpyx_itesliders.new.jruby.x3d"
x3D0.toFileJSON "../data/bumpyx_itesliders.new.jruby.x3dj"

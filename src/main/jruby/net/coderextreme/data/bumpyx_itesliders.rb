            ...
            .addComments(CommentsBlock.new("the model that is being reviewed by the users of this scene"))
              ...
              .addComments(CommentsBlock.new("Images courtesy of Paul Debevec's Light Probe Image Gallery"))
                    ...
                    .addChild(Transform.new()
                      ...
                      .addComments(CommentsBlock.new("TO CONVERT TO A SPHERE <ShaderPart url='\"../shaders/x_ite.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite.vs\"'></ShaderPart> <ShaderPart url='\"../shaders/x_itebubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/x_itebubbles.fs\"' type='FRAGMENT'></ShaderPart>"))
                                )
                            )
                        )
                    )
...
x3D0.toFileJSON "../data/bumpyx_itesliders.new.jruby.json"

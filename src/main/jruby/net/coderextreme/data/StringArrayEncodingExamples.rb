...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor([0.6, 1, 0.8].to_java Java::float)
        )
        .addChild(Shape.new()
            .setGeometry(Text.new()
                .setString(["One, Two, Three", "", "He said, \"Immel did it!\""].to_java Java::java.lang.String)
            .addComments(CommentsBlock.new("alternative XML encoding: Text string='\"One, Two, Three\" \"\" \"He said, \\&quot;Immel did it!\\&quot;\"'"))
            .addComments(CommentsBlock.new("alternative Java source: .setString(new String [] {\"One, Two, Three\", \"\", \"He said, \\\"\"Immel did it!\\\"\"\"})"))
            ...
            .setAppearance(Appearance.new()
                .setMaterial(Material.new()
                    .setDiffuseColor([0.6, 0.4, 0.2].to_java Java::float)
                )
            )
        )
    )
x3D0.toFileX3D "../data/StringArrayEncodingExamples.new.jruby.x3d"
x3D0.toFileJSON "../data/StringArrayEncodingExamples.new.jruby.x3dj"

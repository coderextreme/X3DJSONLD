...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(NavigationInfo.new()
            .setType(["ANY", "EXAMINE", "FLY", "LOOKAT"].to_java Java::java.lang.String)
        )
        ...
        .addChild(Transform.new()
            ...
            .addComments(CommentsBlock.new("* lastFrame - last frame that was rendered (0 for default)"))
            .addComments(CommentsBlock.new("* updateRate - update rate is amount of time between frames"))
            .addComments(CommentsBlock.new("<VariationPhysicsModel values=\"2 2 5 5 0 0\" varations=\"2 1 3 3 0.1 0.1\" lastFrame='0' updateRate='0.1'>"))
            .addComments(CommentsBlock.new("</VariationPhysicsModel>"))
                .setEmitter(ExplosionEmitter.new()
                    .setSpeed(1.0)
                    .setVariation(0.75)
                )
              ...
              .addComments(CommentsBlock.new("<ComposedShader language='GLSL'>"))
              .addComments(CommentsBlock.new("<field name='chromaticDispertion' accessType='inputOutput' type='SFVec3f' value='0.98 1 1.033'></field>"))
              .addComments(CommentsBlock.new("<field name='cube' type='SFNode' accessType=\"inputOutput\">"))
              .addComments(CommentsBlock.new("<ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture>"))
              .addComments(CommentsBlock.new("</field>"))
              .addComments(CommentsBlock.new("<field name='bias' accessType='inputOutput' type='SFFloat' value='0.5'></field>"))
              .addComments(CommentsBlock.new("<field name='scale' accessType='inputOutput' type='SFFloat' value='0.5'></field>"))
              .addComments(CommentsBlock.new("<field name='power' accessType='inputOutput' type='SFFloat' value='2'></field>"))
              .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/freewrl.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs\"'></ShaderPart>"))
              .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"' type='FRAGMENT'></ShaderPart>"))
              .addComments(CommentsBlock.new("</ComposedShader>"))
              .addComments(CommentsBlock.new("<ComposedShader DEF=\"shader\" language=\"GLSL\">"))
              .addComments(CommentsBlock.new("<field name='cube' type='SFInt32' accessType='inputOutput' value='0'></field>"))
              ...
              .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/castle.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs\"'/>"))
              .addComments(CommentsBlock.new("<ShaderPart type='FRAGMENT' url='\"../shaders/castle.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs\"'/>"))
              .addComments(CommentsBlock.new("</ComposedShader>"))
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/x_ite_variations.vs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/x_ite_variations.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setUrl(["../shaders/commonnew.fs", "https://coderextreme.net/X3DJSONLD/src/main/shaders/commonnew.fs"].to_java Java::java.lang.String)
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../data/variationalflowers.new.jruby.x3d"
x3D0.toFileJSON "../data/variationalflowers.new.jruby.x3dj"

    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(["../data/flowerproto.json#FlowerProto"].to_java Java::java.lang.String)
                .addField(Field.new()
                    .setName("vertex")
...
x3D0.toFileX3D "../data/x3domflowers.new.jruby.x3d"
x3D0.toFileJSON "../data/x3domflowers.new.jruby.json"

        ...
        .addChild(HAnimHumanoid.new()
          ...
          .addComments(CommentsBlock.new("original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'"))
            ...
            .addSkeleton(HAnimJoint.new()
                ...
                .setCenter([0, 36, -0.008798].to_java Java::float)
                ...
                .addChild(HAnimSegment.new()
                    ...
                    .addChild(Transform.new()
                        .setTranslation([0, 36, -0.008798].to_java Java::float)
                        .addChild(Shape.new()
                ...
                .addChild(HAnimJoint.new()
                    .setName("l_hip")
                    .setDEF("hanim_l_hip")
                    .setCenter([3.22, 33.619999, -0.2832].to_java Java::float)
                    .setUlimit([0, 0, 0].to_java Java::float)
                    .setLlimit([0, 0, 0].to_java Java::float)
                    .addChild(HAnimSegment.new()
                        .setName("l_thigh")
                        ...
                        .addChild(Transform.new()
                            .setTranslation([3.22, 33.619999, -0.2832].to_java Java::float)
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("l_knee")
                        .setDEF("hanim_l_knee")
                        .setCenter([3.454, 18.67, -0.02158].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l_calf")
                            .setDEF("hanim_l_calf")
                            .addChild(Transform.new()
                                .setTranslation([3.454, 18.67, -0.02158].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([3.467, 3.522, 0.118].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("l_talus")
                                ...
                                .addChild(Transform.new()
                                    .setTranslation([3.467, 3.522, 0.118].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                        ...
                                        .setGeometry(IndexedFaceSet.new()
                                            ...
                                            .setCoord(Coordinate.new()
                                                .setPoint([0.8966, -0.0174, -1.568, 1.521, -0.0174, 0.4019, 0, -0.0174, -1.568, 1.288, 0.6634, 0.3302, 0.7503, 0.6634, -1.364, 0, 0.6634, -1.364, 0, 0.6634, 1.372, -1.521, -0.0174, 0.4019, -1.288, 0.6634, 0.3302, -0.7503, 0.6634, -1.364, -0.8967, -0.0174, -1.568, 0, -0.0174, 1.633, 1.556, -0.2684, 1.333, -1.556, -0.2684, 1.333, 1.293, -1.746, -2.684, 1.293, -3.579, -1.568, 0, -3.579, -1.568, 1.018, -0.5447, -1.908, 0, -0.5447, -1.908, -1.293, -1.746, -2.684, 0, -1.746, -2.684, -1.018, -0.5447, -1.908, -1.293, -3.579, -1.568, 2.687, -1.746, 0.4019, 1.918, -3.579, 0.4019, 1.877, -0.5447, 0.4019, -2.687, -1.746, 0.4019, -1.877, -0.5447, 0.4019, -1.918, -3.579, 0.4019, 0, -3.579, 0.4019, 1.708, -3.439, 1.272, 2.332, -1.78, 1.272, -2.332, -1.78, 1.272, -1.708, -3.439, 1.272, 0, -3.439, 1.272, 1.469, -0.8455, 1.311, -1.469, -0.8455, 1.311, 0, -0.5969, 1.593].to_java Java::float)
                                            )
                                            .setTexCoord(TextureCoordinate.new()
                                                .setPoint([0.4269, 0.4898, 0.4623, 0.4901, 0.4269, 0.4898, 0.4623, 0.4901, 0.4269, 0.4898, 0.4269, 0.4898, 0.4777, 0.4914, 0.4623, 0.4901, 0.4777, 0.4914, 0.4623, 0.4901, 0.4269, 0.4898, 0.4269, 0.4898, 0.4269, 0.4898, 0.4269, 0.4898, 0.4777, 0.4914, 0.4777, 0.4914, 0.4309, 0.4635, 0.4687, 0.4544, 0.4611, 0.4911, 0.4284, 0.4641, 0.4284, 0.4641, 0.4309, 0.4635, 0.4687, 0.4544, 0.4611, 0.4911, 0.4611, 0.4911, 0.4777, 0.4914, 0.4611, 0.4911, 0.4321, 0.4164, 0.4315, 0.3728, 0.4321, 0.4164, 0.4315, 0.3728, 0.4315, 0.3728, 0.4309, 0.4635, 0.4284, 0.4641, 0.4321, 0.4164, 0.4321, 0.4164, 0.4284, 0.4641, 0.4309, 0.4635, 0.4315, 0.3728, 0.4315, 0.3728, 0.4315, 0.3728, 0.4804, 0.417, 0.4726, 0.3714, 0.4687, 0.4544, 0.4804, 0.417, 0.4687, 0.4544, 0.4726, 0.3714, 0.4726, 0.3714, 0.4726, 0.3714, 0.4726, 0.3714, 0.4804, 0.417, 0.4687, 0.4544, 0.4687, 0.4544, 0.4804, 0.417, 0.4726, 0.3714, 0.4726, 0.3714, 0.4687, 0.4544].to_java Java::float)
                                            )
                                        )
                                    )
                                )
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([3.467, 3.251, 1.465].to_java Java::float)
                                .setUlimit([0, 0, 0].to_java Java::float)
                                .setLlimit([0, 0, 0].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    ...
                                    .addChild(Transform.new()
                                        .setTranslation([3.467, 3.251, 1.465].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([-3.679, 3.522, 0.118].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("r_talus")
                                ...
                                .addChild(Transform.new()
                                    .setTranslation([-3.679, 3.522, 0.118].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([-3.679, 3.251, 1.465].to_java Java::float)
                                .setUlimit([0, 0, 0].to_java Java::float)
                                .setLlimit([0, 0, 0].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    ...
                                    .addChild(Transform.new()
                                        .setTranslation([-3.679, 3.251, 1.465].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .setCenter([0.000034, 31.26, -0.008798].to_java Java::float)
                    .setUlimit([0, 0, 0].to_java Java::float)
                    .setLlimit([0, 0, 0].to_java Java::float)
                    .addChild(HAnimSegment.new()
                        .setName("pelvis")
                        .setDEF("hanim_pelvis")
                        .addChild(Transform.new()
                            .setTranslation([0.000034, 31.26, -0.008798].to_java Java::float)
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter([4.778, 51.029999, -2.069].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l_upperarm")
                            ...
                            .addChild(Transform.new()
                                .setTranslation([4.778, 51.029999, -2.069].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([5.297, 40.119999, -2.055].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("l_forearm")
                                ...
                                .addChild(Transform.new()
                                    .setTranslation([5.297, 40.119999, -2.055].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                        ...
                                        .setGeometry(IndexedFaceSet.new()
                                            ...
                                            .setCreaseAngle(1.57)
                                            .setTexCoordIndex([3, 2, 0, -1, 3, 0, 1, -1, 4, 3, 1, -1, 1, 0, 5, -1, 5, 6, 1, -1, 0, 2, 7, -1, 7, 5, 0, -1, 2, 3, 8, -1, 8, 7, 2, -1, 3, 4, 9, -1, 9, 8, 3, -1, 4, 1, 6, -1, 6, 9, 4, -1, 6, 5, 10, -1, 10, 11, 6, -1, 5, 7, 12, -1, 12, 10, 5, -1, 7, 8, 13, -1, 13, 12, 7, -1, 8, 9, 14, -1, 14, 13, 8, -1, 9, 6, 11, -1, 11, 14, 9, -1, 11, 10, 15, -1, 15, 16, 11, -1, 10, 12, 17, -1, 17, 15, 10, -1, 12, 13, 18, -1, 18, 17, 12, -1, 13, 14, 19, -1, 19, 18, 13, -1, 14, 11, 16, -1, 16, 19, 14, -1, 21, 22, 23, -1, 20, 21, 23, -1, 24, 20, 23, -1, 21, 20, 16, -1, 16, 15, 21, -1, 22, 21, 15, -1, 15, 17, 22, -1, 23, 22, 17, -1, 17, 18, 23, -1, 24, 23, 18, -1, 18, 19, 24, -1, 20, 24, 19, -1, 19, 16, 20, -1].to_java Java::int)
                                            .setCoord(Coordinate.new()
                                                .setPoint([0.1284, 0.6566, -0.794, 0.7947, 0.6566, -0.1619, 0.4154, 0.6566, 0.757, -0.4852, 0.6566, 0.6929, -0.6626, 0.6566, -0.2657, 0.0855, -0.4623, -1.129, 1.027, -0.4623, -0.281, 0.4911, -0.4623, 1.171, -0.7817, -0.4623, 1.07, -1.032, -0.4623, -0.445, 0.0941, -3.046, -1.116, 1.1, -3.046, -0.2777, 0.55, -2.481, 1.16, -0.8091, -2.481, 1.06, -1.1, -3.046, -0.4401, 0.084, -8.01, -1.171, 1.025, -7.982, -0.1359, 0.3907, -8.118, 1.09, -0.6003, -8.118, 0.9957, -0.9132, -8.109, -0.2244, 0.0434, -8.725, -0.6054, 0.5441, -8.725, 0.0272, 0.2591, -8.725, 0.759, -0.4177, -8.725, 0.6949, -0.551, -8.725, -0.0767].to_java Java::float)
                                            )
                                            .setTexCoord(TextureCoordinate.new()
                                                .setPoint([0.5159, 0.3385, 0.5159, 0.3244, 0.5159, 0.3332, 0.5159, 0.3157, 0.5159, 0.3103, 0.521, 0.3428, 0.521, 0.3229, 0.521, 0.3355, 0.521, 0.3108, 0.521, 0.3029, 0.5327, 0.3442, 0.5327, 0.3231, 0.5302, 0.3366, 0.5302, 0.3103, 0.5327, 0.3016, 0.5558, 0.339, 0.5558, 0.323, 0.5558, 0.3334, 0.5558, 0.3141, 0.5558, 0.3079, 0.5585, 0.3232, 0.5585, 0.3341, 0.5585, 0.3302, 0.5585, 0.317, 0.5585, 0.3129].to_java Java::float)
                                            )
                                        )
                                    )
                                )
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([5.07, 31.99, -1.559].to_java Java::float)
                                .setUlimit([0, 0, 0].to_java Java::float)
                                .setLlimit([0, 0, 0].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    .setName("l_carpal")
                                    ...
                                    .addChild(Transform.new()
                                        .setTranslation([5.07, 31.99, -1.559].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                            ...
                                            .setGeometry(IndexedFaceSet.new()
                                                .setCoordIndex([4, 5, 0, -1, 0, 2, 4, -1, 6, 7, 3, -1, 3, 1, 6, -1, 1, 0, 5, -1, 5, 6, 1, -1, 8, 9, 5, -1, 5, 4, 8, -1, 10, 11, 7, -1, 7, 6, 10, -1, 9, 10, 6, -1, 6, 5, 9, -1, 12, 13, 9, -1, 9, 8, 12, -1, 14, 15, 11, -1, 11, 10, 14, -1, 13, 14, 10, -1, 10, 9, 13, -1, 4, 2, 16, -1, 2, 3, 7, -1, 7, 16, 2, -1, 17, 19, 18, -1, 18, 20, 17, -1, 21, 16, 7, -1, 7, 11, 21, -1, 8, 21, 12, -1, 12, 21, 11, -1, 11, 15, 12, -1, 13, 12, 15, -1, 15, 14, 13, -1, 8, 4, 19, -1, 19, 17, 8, -1, 4, 16, 18, -1, 18, 19, 4, -1, 16, 21, 20, -1, 20, 18, 16, -1, 21, 8, 17, -1, 17, 20, 21, -1, 3, 2, 0, -1, 0, 1, 3, -1].to_java Java::int)
                                                .setCreaseAngle(1.57)
                                                .setTexCoordIndex([0, 2, 1, -1, 1, 3, 0, -1, 36, 38, 37, -1, 37, 39, 36, -1, 28, 30, 29, -1, 29, 31, 28, -1, 4, 5, 2, -1, 2, 0, 4, -1, 40, 41, 38, -1, 38, 36, 40, -1, 32, 33, 31, -1, 31, 29, 32, -1, 6, 7, 5, -1, 5, 4, 6, -1, 42, 43, 41, -1, 41, 40, 42, -1, 34, 35, 33, -1, 33, 32, 34, -1, 10, 12, 11, -1, 12, 14, 13, -1, 13, 11, 12, -1, 15, 17, 16, -1, 16, 18, 15, -1, 19, 11, 13, -1, 13, 20, 19, -1, 21, 19, 22, -1, 22, 19, 20, -1, 20, 23, 22, -1, 24, 22, 23, -1, 23, 25, 24, -1, 4, 0, 8, -1, 8, 9, 4, -1, 10, 11, 16, -1, 16, 17, 10, -1, 11, 19, 18, -1, 18, 16, 11, -1, 19, 21, 15, -1, 15, 18, 19, -1, 14, 12, 26, -1, 26, 27, 14, -1].to_java Java::int)
                                                .setCoord(Coordinate.new()
                                                    .setPoint([0.8732, 0.4437, 0.6298, 0.8463, 0.4584, -1.065, -0.5135, 0.3661, 0.7037, -0.5196, 0.3675, -1.013, -0.6654, -0.1688, 1.167, 1.16, 0.015, 1.096, 1.119, 0.0434, -1.571, -0.747, -0.1537, -1.566, -0.5777, -1.832, 1.902, 1.387, -1.647, 1.643, 1.345, -1.619, -1.902, -0.8391, -1.916, -1.775, -0.3897, -3.083, 1.338, 0.6425, -3.283, 1.382, 0.6009, -3.255, -1.636, -0.5412, -3.094, -1.527, -0.742, -0.1555, -0.1478, -1.159, -1.873, 1.533, -1.387, -0.4699, 0.0458, -1.361, -0.5281, 1.488, -1.163, -1.872, 0.1088, -0.7494, -1.912, -0.1591].to_java Java::float)
                                                )
                                                .setTexCoord(TextureCoordinate.new()
                                                    .setPoint([0.4675, 0.2229, 0.4534, 0.3224, 0.4709, 0.3268, 0.4579, 0.2308, 0.5552, 0.233, 0.5504, 0.3288, 0.6215, 0.2576, 0.6159, 0.3282, 0.478, 0.1884, 0.5527, 0.2007, 0.4618, 0.1862, 0.4629, 0.1191, 0.4583, 0.192, 0.4802, 0.0435, 0.4672, 0.0405, 0.5177, 0.1794, 0.4789, 0.1246, 0.4811, 0.1812, 0.515, 0.132, 0.538, 0.1232, 0.5459, 0.0341, 0.5348, 0.1824, 0.6006, 0.1887, 0.5977, 0.0452, 0.6323, 0.1888, 0.629, 0.0403, 0.4501, 0.1899, 0.4535, 0.0388, 0.5577, 0.3108, 0.5496, 0.3395, 0.5573, 0.3333, 0.5503, 0.3041, 0.5263, 0.3468, 0.527, 0.2997, 0.5106, 0.3433, 0.5113, 0.3032, 0.4584, 0.3225, 0.4544, 0.2224, 0.4607, 0.2253, 0.4525, 0.325, 0.5365, 0.3334, 0.5532, 0.2053, 0.6323, 0.3251, 0.6179, 0.2145].to_java Java::float)
                                                )
                                            )
                                        )
                                    )
                                ...
                                .addChild(Transform.new()
                                    ...
                                    .addChild(Shape.new()
                                        ...
                                        .setGeometry(IndexedFaceSet.new()
                                            ...
                                            .setCreaseAngle(1.57)
                                            .setTexCoordIndex([0, 2, 3, -1, 1, 0, 3, -1, 4, 1, 3, -1, 1, 6, 5, -1, 5, 0, 1, -1, 0, 5, 7, -1, 7, 2, 0, -1, 2, 7, 8, -1, 8, 3, 2, -1, 3, 8, 9, -1, 9, 4, 3, -1, 4, 9, 6, -1, 6, 1, 4, -1, 6, 11, 10, -1, 10, 5, 6, -1, 5, 10, 12, -1, 12, 7, 5, -1, 7, 12, 13, -1, 13, 8, 7, -1, 8, 13, 14, -1, 14, 9, 8, -1, 9, 14, 11, -1, 11, 6, 9, -1, 11, 16, 15, -1, 15, 10, 11, -1, 10, 15, 17, -1, 17, 12, 10, -1, 12, 17, 18, -1, 18, 13, 12, -1, 13, 18, 19, -1, 19, 14, 13, -1, 14, 19, 16, -1, 16, 11, 14, -1, 23, 22, 21, -1, 23, 21, 20, -1, 24, 23, 20, -1, 21, 15, 16, -1, 16, 20, 21, -1, 22, 17, 15, -1, 15, 21, 22, -1, 23, 18, 17, -1, 17, 22, 23, -1, 24, 19, 18, -1, 18, 23, 24, -1, 20, 16, 19, -1, 19, 24, 20, -1].to_java Java::int)
                                            .setCoord(Coordinate.new()
                                                .setPoint([-0.1284, 0.6566, -0.794, -0.7947, 0.6566, -0.1619, -0.4154, 0.6566, 0.757, 0.4852, 0.6566, 0.6929, 0.6626, 0.6566, -0.2657, -0.0855, -0.4623, -1.129, -1.027, -0.4623, -0.281, -0.4911, -0.4623, 1.171, 0.7817, -0.4623, 1.07, 1.032, -0.4623, -0.445, -0.0941, -3.046, -1.116, -1.1, -3.046, -0.2777, -0.55, -2.481, 1.16, 0.8091, -2.481, 1.06, 1.1, -3.046, -0.4401, -0.084, -8.01, -1.171, -1.025, -7.982, -0.1359, -0.3907, -8.118, 1.09, 0.6003, -8.118, 0.9957, 0.9132, -8.109, -0.2244, -0.0434, -8.725, -0.6054, -0.5441, -8.725, 0.0272, -0.2591, -8.725, 0.759, 0.4177, -8.725, 0.6949, 0.551, -8.725, -0.0767].to_java Java::float)
                                            )
                                            .setTexCoord(TextureCoordinate.new()
                                ...
                                .addChild(HAnimSegment.new()
                                    ...
                                    .addChild(Transform.new()
                                        ...
                                        .addChild(Shape.new()
                                            ...
                                            .setGeometry(IndexedFaceSet.new()
                                                .setCoordIndex([4, 2, 0, -1, 0, 5, 4, -1, 6, 1, 3, -1, 3, 7, 6, -1, 1, 6, 5, -1, 5, 0, 1, -1, 8, 4, 5, -1, 5, 9, 8, -1, 10, 6, 7, -1, 7, 11, 10, -1, 9, 5, 6, -1, 6, 10, 9, -1, 12, 8, 9, -1, 9, 13, 12, -1, 14, 10, 11, -1, 11, 15, 14, -1, 13, 9, 10, -1, 10, 14, 13, -1, 4, 16, 2, -1, 2, 16, 7, -1, 7, 3, 2, -1, 17, 20, 18, -1, 18, 19, 17, -1, 21, 11, 7, -1, 7, 16, 21, -1, 8, 12, 21, -1, 12, 15, 11, -1, 11, 21, 12, -1, 13, 14, 15, -1, 15, 12, 13, -1, 8, 17, 19, -1, 19, 4, 8, -1, 4, 19, 18, -1, 18, 16, 4, -1, 16, 18, 20, -1, 20, 21, 16, -1, 21, 20, 17, -1, 17, 8, 21, -1, 3, 1, 0, -1, 0, 2, 3, -1].to_java Java::int)
                                                .setCreaseAngle(1.57)
                                                .setTexCoordIndex([0, 3, 1, -1, 1, 2, 0, -1, 36, 39, 37, -1, 37, 38, 36, -1, 28, 31, 29, -1, 29, 30, 28, -1, 4, 0, 2, -1, 2, 5, 4, -1, 40, 36, 38, -1, 38, 41, 40, -1, 32, 29, 31, -1, 31, 33, 32, -1, 6, 4, 5, -1, 5, 7, 6, -1, 42, 40, 41, -1, 41, 43, 42, -1, 34, 32, 33, -1, 33, 35, 34, -1, 10, 11, 12, -1, 12, 11, 13, -1, 13, 14, 12, -1, 15, 18, 16, -1, 16, 17, 15, -1, 19, 20, 13, -1, 13, 11, 19, -1, 21, 22, 19, -1, 22, 23, 20, -1, 20, 19, 22, -1, 24, 25, 23, -1, 23, 22, 24, -1, 4, 9, 8, -1, 8, 0, 4, -1, 10, 17, 16, -1, 16, 11, 10, -1, 11, 16, 18, -1, 18, 19, 11, -1, 19, 18, 15, -1, 15, 21, 19, -1, 14, 27, 26, -1, 26, 12, 14, -1].to_java Java::int)
                                                .setCoord(Coordinate.new()
                                                    .setPoint([-0.8732, 0.4437, 0.6298, -0.8463, 0.4584, -1.065, 0.5135, 0.3661, 0.7037, 0.5196, 0.3675, -1.013, 0.6654, -0.1688, 1.167, -1.16, 0.015, 1.096, -1.119, 0.0434, -1.571, 0.747, -0.1537, -1.566, 0.5777, -1.832, 1.902, -1.387, -1.647, 1.643, -1.345, -1.619, -1.902, 0.8391, -1.916, -1.775, 0.3897, -3.083, 1.338, -0.6425, -3.283, 1.382, -0.6009, -3.255, -1.636, 0.5412, -3.094, -1.527, 0.742, -0.1555, -0.1478, 1.159, -1.873, 1.533, 1.387, -0.4699, 0.0458, 1.361, -0.5281, 1.488, 1.163, -1.872, 0.1088, 0.7494, -1.912, -0.1591].to_java Java::float)
                                                )
                                                .setTexCoord(TextureCoordinate.new()
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("vl5")
                        .setDEF("hanim_vl5")
                        .setCenter([0.000025, 39.84, 0.1163].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l5")
                            .setDEF("hanim_l5")
                            .addChild(Transform.new()
                                .setTranslation([0.000025, 39.84, 0.1163].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([0.000025, 56.07, -1.554].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("skull")
                                .setDEF("hanim_skull")
                                .addChild(Transform.new()
                                    .setTranslation([0.000025, 56.07, -1.554].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
...
x3D0.toFileX3D "../data/KoreanCharacter05Ju.new.jruby.x3d"
x3D0.toFileJSON "../data/KoreanCharacter05Ju.new.jruby.x3dj"

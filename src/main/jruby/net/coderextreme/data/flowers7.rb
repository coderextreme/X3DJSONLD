            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    ...
                    .addShaders(ComposedShader.new()
                        .setDEF("x3dom")
                        .setLanguage("GLSL")
                .addComments(CommentsBlock.new("TODO VERIFY"))
...
"            }\n"+
"        }")        )
        .addComments(CommentsBlock.new("<TimeSensor DEF=\"Clock\" cycleInterval=\"45\" loop='true'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='Clock' fromField='fraction_changed' toNode='UrlSelector' toField='set_fraction'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='front' toNode='background' toField='frontUrl'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='back' toNode='background' toField='backUrl'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='left' toNode='background' toField='leftUrl'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='right' toNode='background' toField='rightUrl'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='top' toNode='background' toField='topUrl'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='bottom' toNode='background' toField='bottomUrl'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='front' toNode='frontShader' toField='url'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='back' toNode='backShader' toField='url'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='left' toNode='leftShader' toField='url'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='right' toNode='rightShader' toField='url'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='top' toNode='topShader' toField='url'/>"))
        .addComments(CommentsBlock.new("<ROUTE fromNode='UrlSelector' fromField='bottom' toNode='bottomShader' toField='url'/>"))
        .addChild(Script.new()
            .setDEF("Animate")
            .setDirectOutput(true)
            .addField(Field.new()
...
x3D0.toFileX3D "../data/flowers7.new.jruby.x3d"
x3D0.toFileJSON "../data/flowers7.new.jruby.x3dj"

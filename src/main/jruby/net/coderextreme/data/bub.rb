        ...
        .addChild(ProtoDeclare.new()
            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Transform.new()
                  ...
                  .addComments(CommentsBlock.new("<ComposedShader DEF='gl' language=\"GLSL\">"))
                  .addComments(CommentsBlock.new("<field name='cube' type='SFInt32' accessType=\"inputOutput\" value='0'/>"))
                  .addComments(CommentsBlock.new("<field name='chromaticDispertion' type='SFVec3f' accessType=\"inputOutput\" value='0.98 1.0 1.033'/>"))
                  .addComments(CommentsBlock.new("<field name='bias' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>"))
                  .addComments(CommentsBlock.new("<field name='scale' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>"))
                  .addComments(CommentsBlock.new("<field name='power' type='SFFloat' accessType=\"inputOutput\" value='2.0'/>"))
                  .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/gl.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/gl.vs\"'></ShaderPart>"))
                  .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/pc_bubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_bubbles.fs\"' type='FRAGMENT'></ShaderPart>"))
                  .addComments(CommentsBlock.new("</ComposedShader>"))
                  .addComments(CommentsBlock.new("<ComposedShader DEF='freewrl' language=\"GLSL\">"))
                  .addComments(CommentsBlock.new("<field name='fw_textureCoodGenType' type='SFInt32' accessType=\"inputOutput\" value='0'/>"))
                  .addComments(CommentsBlock.new("<field name='chromaticDispertion' type='SFVec3f' accessType=\"inputOutput\" value='0.98 1.0 1.033'/>"))
                  .addComments(CommentsBlock.new("<field name='bias' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>"))
                  .addComments(CommentsBlock.new("<field name='scale' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>"))
                  .addComments(CommentsBlock.new("<field name='power' type='SFFloat' accessType=\"inputOutput\" value='2.0'/>"))
                  ...
                  .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/pc_bubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_bubbles.fs\"' type='FRAGMENT'></ShaderPart>"))
                  .addComments(CommentsBlock.new("</ComposedShader>"))
                  .addComments(CommentsBlock.new("<ComposedShader DEF='instant' language=\"GLSL\">"))
                  .addComments(CommentsBlock.new("<field name='cube' type='SFInt32' accessType=\"inputOutput\" value='0'/>"))
                  .addComments(CommentsBlock.new("<field name='chromaticDispertion' type='SFVec3f' accessType=\"inputOutput\" value='0.98 1.0 1.033'/>"))
                  .addComments(CommentsBlock.new("<field name='bias' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>"))
                  .addComments(CommentsBlock.new("<field name='scale' type='SFFloat' accessType=\"inputOutput\" value='0.5'/>"))
                  .addComments(CommentsBlock.new("<field name='power' type='SFFloat' accessType=\"inputOutput\" value='2.0'/>"))
                  .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/instant.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/instant.vs\"'></ShaderPart>"))
                  .addComments(CommentsBlock.new("<ShaderPart url='\"../shaders/pc_bubbles.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/pc_bubbles.fs\"' type='FRAGMENT'></ShaderPart>"))
                  .addComments(CommentsBlock.new("</ComposedShader>"))
...
x3D0.toFileX3D "../data/bub.new.jruby.x3d"
x3D0.toFileJSON "../data/bub.new.jruby.x3dj"

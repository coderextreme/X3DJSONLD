...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("modified")
            .setContent("November 9 2024")
        )
        .addMeta(Meta.new()
            .setName("title")
            .setContent("myextrusion.x3d")
        )
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/data/myextrusion.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
        ...
        .addChild(Group.new()
            .addChild(Shape.new()
                .setGeometry(Extrusion.new()
                    .setDEF("myextrusion")
                    .setSpine([-50, -50, 0, 50, 50, 0].to_java Java::float)
...
"                }")            )
            ...
            .addChild(ROUTE.new()
                ...
                .setToNode("myextrusion")
                .setToField("set_spine")
            )
        )
    )
x3D0.toFileX3D "../data/myextrusion.new.jruby.x3d"
x3D0.toFileJSON "../data/myextrusion.new.jruby.x3dj"

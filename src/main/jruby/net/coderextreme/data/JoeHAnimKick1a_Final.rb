...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(NavigationInfo.new()
            .setType([", ", "FLYANY"].to_java Java::java.lang.String)
            .setSpeed(2.5)
            .setHeadlight(false)
        )
        ...
        .addChild(Group.new()
            ...
            .addChild(HAnimHumanoid.new()
                ...
                .addSkeleton(HAnimJoint.new()
                    ...
                    .setTranslation([0.15315, 0.019584, -0.22976].to_java Java::float)
                    .setRotation([-1, 0, 0, 0.040483].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .addChild(HAnimJoint.new()
                            .setName("l_hip")
                            .setDEF("hanim_l_hip")
                            .setRotation([1, 0, 0, 0.23414].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                .setName("l_knee")
                                .setDEF("hanim_l_knee")
                                .setRotation([0.2106, 0, 0.97757, 0.22603].to_java Java::float)
                                ...
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setRotation([1, 0, 0, 0.16032].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            .setName("r_hip")
                            .setDEF("hanim_r_hip")
                            .setRotation([1, 0, 0, 0.03807].to_java Java::float)
                            .setCenter([-0.1, 0.92, 0].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                .setName("r_knee")
                                .setDEF("hanim_r_knee")
                                .setRotation([1, 0, 0, 0.48097].to_java Java::float)
                                                                                            ...
                                                                                            .addChild(HAnimJoint.new()
                                                                                                ...
                                                                                                .addChild(HAnimJoint.new()
                                                                                                    ...
                                                                                                    .addChild(HAnimJoint.new()
                                                                                                        .setName("vc4")
                                                                                                        .setDEF("hanim_vc4")
                                                                                                        .setRotation([0.98593, 0, -0.16716, 0.46046].to_java Java::float)
                                                                                            ...
                                                                                            .addChild(HAnimJoint.new()
                                                                                                ...
                                                                                                .addChild(HAnimJoint.new()
                                                                                                    ...
                                                                                                    .addChild(HAnimJoint.new()
                                                                                                        ...
                                                                                                        .setRotation([0, 0, 1, 1.3884].to_java Java::float)
                                                                                                        ...
                                                                                                        .addChild(HAnimJoint.new()
                                                                                                            ...
                                                                                                            .setRotation([-1, 0, 0, 1.3339].to_java Java::float)
                                                                                                            ...
                                                                                                            .addChild(HAnimJoint.new()
                                                                                                                ...
                                                                                                                .setRotation([0, 1, 0, 1.2033].to_java Java::float)
                                                                                            ...
                                                                                            .addChild(HAnimJoint.new()
                                                                                                ...
                                                                                                .addChild(HAnimJoint.new()
                                                                                                    ...
                                                                                                    .addChild(HAnimJoint.new()
                                                                                                        ...
                                                                                                        .setRotation([0, 0, -1, 1.7595].to_java Java::float)
                                                                                                        .setCenter([-0.2, 1.44, -0.04].to_java Java::float)
                                                                                                        ...
                                                                                                        .addChild(HAnimJoint.new()
                                                                                                            ...
                                                                                                            .addChild(HAnimJoint.new()
                                                                                                                ...
                                                                                                                .setRotation([0, 1, 0, 0.077855].to_java Java::float)
                ...
                .addSkin(Shape.new()
                    ...
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setEmissiveColor([0.13, 0.55, 0.13].to_java Java::float)
                        )
        ...
        .addChild(Transform.new()
            .setDEF("SBall")
            .setTranslation([-0.074397, 0.094551, -0.074397].to_java Java::float)
            .setRotation([-0.70711, 0, -0.70711, 1.231].to_java Java::float)
...
x3D0.toFileX3D "../data/JoeHAnimKick1a_Final.new.jruby.x3d"
x3D0.toFileJSON "../data/JoeHAnimKick1a_Final.new.jruby.x3dj"

    ...
    .setScene(Scene.new()
        ...
        .addChild(Shape.new()
            .setAppearance(Appearance.new()
                .setAcousticProperties(AcousticProperties.new()
        ...
        .addChild(Sound.new()
            ...
            .setSource(AudioClip.new()
                ...
                .setUrl(["sound/saxophone.mp3", "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/saxophone.mp3"].to_java Java::java.lang.String)
            )
        )
        .addChild(Sound.new()
            .setLocation([0, 1.6, 0].to_java Java::float)
            .setSource(MovieTexture.new()
                .setDescription("testing")
                .setUrl(["bogus.mpg", "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/bogus.mpg"].to_java Java::java.lang.String)
            )
        )
...
x3D0.toFileX3D "../data/AllAudioGraphNodesTest.new.jruby.x3d"
x3D0.toFileJSON "../data/AllAudioGraphNodesTest.new.jruby.x3dj"

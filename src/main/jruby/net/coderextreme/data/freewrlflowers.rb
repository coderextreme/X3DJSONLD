    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(["../data/flowerprotofreewrl.x3d#FlowerProto", "https://coderextreme.net/X3DJSONLD/src/main/data/flowerprotofreewrl.x3d#FlowerProto"].to_java Java::java.lang.String)
                .addField(Field.new()
                    .setName("vertex")
...
x3D0.toFileX3D "../data/freewrlflowers.new.jruby.x3d"
x3D0.toFileJSON "../data/freewrlflowers.new.jruby.x3dj"

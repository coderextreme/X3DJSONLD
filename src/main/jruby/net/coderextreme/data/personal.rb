    ...
    .setScene(Scene.new()
        ...
        .addChild(Switch.new()
          ...
          .addComments(CommentsBlock.new("<Inline url='\"../data/flowers7.x3d\" \"https://coderextreme.net/X3DJSONLD/src/main/data/flowers7.x3d\"'/>"))
            .addChild(Inline.new()
                .setUrl(["../data/force-tidy.x3d", "https://coderextreme.net/X3DJSONLD/src/main/data/force-tidy.x3d"].to_java Java::java.lang.String)
            )
        )
...
x3D0.toFileX3D "../data/personal.new.jruby.x3d"
x3D0.toFileJSON "../data/personal.new.jruby.x3dj"

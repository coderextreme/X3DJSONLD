...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("Image")
            .setContent("../Poses/images/HAnimPoseExampleKoreanCharacter04Young.png")
        )
        .addMeta(Meta.new()
            .setName("reference")
    ...
    .setScene(Scene.new()
        ...
        .addChild(HAnimHumanoid.new()
          ...
          .addComments(CommentsBlock.new("original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'"))
            ...
            .addSkeleton(HAnimJoint.new()
                ...
                .setCenter([0, 31.540001, -0.3172].to_java Java::float)
                .setContainerFieldOverride("skeleton")
                .addChild(HAnimSegment.new()
                    .setName("sacrum")
                    .setDEF("hanim_sacrum")
                    .addChild(Transform.new()
                        .setTranslation([0, 31.540001, -0.3172].to_java Java::float)
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                ...
                                .setTexture(ImageTexture.new()
                                    ...
                                    .setUrl(["images/Young.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Young.png"].to_java Java::java.lang.String)
                                )
                            )
                ...
                .addChild(HAnimJoint.new()
                    .setName("l_hip")
                    .setDEF("hanim_l_hip")
                    .setCenter([3.504, 29.040001, -0.4027].to_java Java::float)
                    .addChild(HAnimSegment.new()
                        .setName("l_thigh")
                        .setDEF("hanim_l_thigh")
                        .addChild(Transform.new()
                            .setTranslation([3.504, 29.040001, -0.4027].to_java Java::float)
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("l_knee")
                        .setDEF("hanim_l_knee")
                        .setCenter([3.414, 14.95, -0.4549].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l_calf")
                            .setDEF("hanim_l_calf")
                            .addChild(Transform.new()
                                .setTranslation([3.414, 14.95, -0.4549].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([3.18, 3.449, -0.3088].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("l_talus")
                                .setDEF("hanim_l_talus")
                                .addChild(Transform.new()
                                    .setTranslation([3.18, 3.449, -0.3088].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([3.18, 3.189, 0.9724].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    .setName("l_tarsal_proximal_phalanx_2")
                                    .setDEF("hanim_l_tarsal_proximal_phalanx_2")
                                    .addChild(Transform.new()
                                        .setTranslation([3.18, 3.189, 0.9724].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(Transform.new()
                            ...
                            .addChild(Shape.new()
                                ...
                                .setGeometry(IndexedFaceSet.new()
                                
.8705, 0.5509, 0.917, 0.5452, 0.917, 0.5266, 0.89, 0.5304, 0.89, 0.5452, 0.917, 0.522, 0.89, 0.5268, 0.917, 0.5349, 0.89, 0.537, 0.917, 0.5555, 0.89, 0.5534, 0.917, 0.5684, 0.89, 0.5636, 0.917, 0.5638, 0.89, 0.56, 0.8746, 0.531, 0.8746, 0.5452, 0.8746, 0.5279, 0.8746, 0.5368, 0.8746, 0.5524, 0.8746, 0.5613, 0.8746, 0.5581].to_java Java::float)
                                    )
                            ...
                            .addChild(Transform.new()
                                ...
                                .addChild(Shape.new()
                                    ...
                                    .setGeometry(IndexedFaceSet.new()
                                        ...
                                        .setCreaseAngle(1.57)
                                        .setTexCoordIndex([0, 1, 2, -1, 2, 3, 4, -1, 0, 2, 4, -1, 0, 4, 5, -1, 6, 0, 5, -1, 9, 10, 7, -1, 7, 8, 9, -1, 12, 9, 8, -1, 8, 11, 12, -1, 14, 12, 11, -1, 11, 13, 14, -1, 16, 14, 13, -1, 13, 15, 16, -1, 18, 16, 15, -1, 15, 17, 18, -1, 20, 18, 17, -1, 17, 19, 20, -1, 10, 20, 19, -1, 19, 7, 10, -1, 21, 22, 10, -1, 10, 9, 21, -1, 23, 21, 9, -1, 9, 12, 23, -1, 24, 23, 12, -1, 12, 14, 24, -1, 25, 24, 14, -1, 14, 16, 25, -1, 26, 25, 16, -1, 16, 18, 26, -1, 27, 26, 18, -1, 18, 20, 27, -1, 22, 27, 20, -1, 20, 10, 22, -1, 1, 0, 22, -1, 22, 21, 1, -1, 2, 1, 21, -1, 21, 23, 2, -1, 3, 2, 23, -1, 23, 24, 3, -1, 4, 3, 24, -1, 24, 25, 4, -1, 5, 4, 25, -1, 25, 26, 5, -1, 6, 5, 26, -1, 26, 27, 6, -1, 0, 6, 27, -1, 27, 22, 0, -1, 8, 7, 28, -1, 28, 29, 8, -1, 11, 8, 29, -1, 29, 30, 11, -1, 13, 11, 30, -1, 30, 31, 13, -1, 15, 13, 31, -1, 31, 32, 15, -1, 17, 15, 32, -1, 32, 33, 17, -1, 19, 17, 33, -1, 33, 34, 19, -1, 7, 19, 34, -1, 34, 28, 7, -1, 29, 28, 35, -1, 35, 36, 29, -1, 30, 29, 36, -1, 36, 37, 30, -1, 31, 30, 37, -1, 37, 38, 31, -1, 32, 31, 38, -1, 38, 39, 32, -1, 33, 32, 39, -1, 39, 40, 33, -1, 34, 33, 40, -1, 40, 41, 34, -1, 28, 34, 41, -1, 41, 35, 28, -1].to_java Java::int)
                                        .setCoord(Coordinate.new()
                                            .setPoint([-0.6335, 1.142, 0.0206, -0.3202, 1.142, 0.8245, 0.3837, 1.142, 0.9871, 0.9483, 1.142, 0.5315, 0.9483, 1.142, -0.3447, 0.3837, 1.142, -0.8003, -0.3202, 1.142, -0.6377, -2.06, -3.778, 0.0206, -1.287, -2.905, 1.78, -1.089, -1.147, 2.133, -1.867, -1.397, 0.0206, 0.715, -2.905, 2.263, 0.6583, -1.147, 2.559, 1.987, -3.778, 1.106, 2.06, -1.397, 0.8632, 1.987, -4.457, -1.205, 2.06, -1.397, -0.822, 0.715, -4.457, -2.559, 0.6583, -1.397, -2.087, -1.287, -4.457, -2.076, -1.089, -1.397, -1.661, -0.9877, 0.2851, 1.672, -1.704, 0.2851, 0.0206, 0.622, 0.2851, 2.043, 1.913, 0.2851, 1.002, 1.913, 0.2851, -0.8149, 0.622, 0.2851, -1.817, -0.9877, 0.2851, -1.445, -1.417, -11.1, 0.0028, -0.8123, -11.09, 1.38, 0.5457, -11.09, 1.72, 1.635, -11.1, 0.767, 1.635, -11.11, -0.8605, 0.5457, -11.11, -1.535, -0.8123, -11.11, -1.195, -0.6234, -12.52, 0.021, -0.3177, -12.52, 0.7175, 0.3691, -12.52, 0.8896, 0.9199, -12.52, 0.4076, 0.9199, -12.53, -0.4156, 0.3691, -12.53, -0.7569, -0.3177, -12.53, -0.5849].to_java Java::float)
                                        )
                                        .setTexCoord(TextureCoordinate.new()
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .setCenter([0, 27.07, -0.3172].to_java Java::float)
                    .addChild(HAnimSegment.new()
                        .setName("pelvis")
                        .setDEF("hanim_pelvis")
                        .addChild(Transform.new()
                            .setTranslation([0, 27.07, -0.3172].to_java Java::float)
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                ...
                                .setGeometry(IndexedFaceSet.new()
                                    ...
                                    .setTexCoordIndex([0, 1, 2, -1, 0, 2, 3, -1, 0, 3, 4, -1, 0, 4, 5, -1, 0, 5, 6, -1, 0, 6, 7, -1, 0, 7, 8, -1, 0, 8, 9, -1, 0, 9, 10, -1, 0, 10, 11, -1, 0, 11, 12, -1, 0, 12, 1, -1, 14, 2, 1, -1, 1, 13, 14, -1, 15, 3, 2, -1, 2, 14, 15, -1, 16, 4, 3, -1, 3, 15, 16, -1, 17, 5, 4, -1, 4, 16, 17, -1, 18, 6, 5, -1, 5, 17, 18, -1, 19, 7, 6, -1, 6, 18, 19, -1, 20, 8, 7, -1, 7, 19, 20, -1, 21, 9, 8, -1, 8, 20, 21, -1, 22, 10, 9, -1, 9, 21, 22, -1, 23, 11, 10, -1, 10, 22, 23, -1, 24, 12, 11, -1, 11, 23, 24, -1, 13, 1, 12, -1, 12, 24, 13, -1, 26, 14, 13, -1, 13, 25, 26, -1, 27, 15, 14, -1, 14, 26, 27, -1, 28, 16, 15, -1, 15, 27, 28, -1, 29, 17, 16, -1, 16, 28, 29, -1, 30, 18, 17, -1, 17, 29, 30, -1, 31, 19, 18, -1, 18, 30, 31, -1, 32, 20, 19, -1, 19, 31, 32, -1, 33, 21, 20, -1, 20, 32, 33, -1, 34, 22, 21, -1, 21, 33, 34, -1, 35, 23, 22, -1, 22, 34, 35, -1, 36, 24, 23, -1, 23, 35, 36, -1, 25, 13, 24, -1, 24, 36, 25, -1, 38, 26, 25, -1, 25, 37, 38, -1, 39, 27, 26, -1, 26, 38, 39, -1, 40, 28, 27, -1, 27, 39, 40, -1, 41, 29, 28, -1, 28, 40,
                                    )
                                    .setTexCoord(TextureCoordinate.new()
                                        .setPoint([0.6211, 0.5754, 0.7851, 0.572, 0.7614, 0.572, 0.6907, 0.5698, 0.62, 0.5698, 0.6158, 0.5702, 0.5451, 0.5702, 0.4167, 0.5698, 0.5451, 0.5702, 0.6158, 0.5702, 0.62, 0.5698, 0.6907, 0.5698, 0.7614, 0.572, 0.8036, 0.5346, 0.7761, 0.5346, 0.6989, 0.4838, 0.6219, 0.4428, 0.6154, 0.4438, 0.5492, 0.4639, 0.4166, 0.5346, 0.5492, 0.4639, 0.6154, 0.4438, 0.6219, 0.4428, 0.6989, 0.4838, 0.7761, 0.5346, 0.7912, 0.4044, 0.7635, 0.4044, 0.7042, 0.3925, 0.6194, 0.3907, 0.6148, 0.3907, 0.545, 0.3974, 0.4163, 0.4938, 0.545, 0.3974, 0.6148, 0.3907, 0.6194, 0.3907, 0.7042, 0.3925, 0.7635, 0.4044, 0.795, 0.3772, 0.7662, 0.3772, 0.6945, 0.3645, 0.6236, 0.3695, 0.616, 0.3695, 0.5438, 0.378, 0.416, 0.453, 0.5438, 0.378, 0.616, 0.3695, 0.6236, 0.3695, 0.6945, 0.3645, 0.7662, 0.3772, 0.7887, 0.3451, 0.7635, 0.3451, 0.698, 0.3508, 0.6262, 0.3508, 0.6297, 0.3503, 0.5389, 0.3503, 0.4181, 0.3884, 0.5389, 0.3503, 0.6297, 0.3503, 0.6262, 0.3508, 0.698, 0.3508, 0.7635, 0.3451, 0.6237, 0.3398].to_java Java::float)
                                    )
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter([5.441, 45.830002, 0.1786].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l_upperarm")
                            .setDEF("hanim_l_upperarm")
                            .addChild(Transform.new()
                                .setTranslation([5.441, 45.830002, 0.1786].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([6.823, 36.080002, 0.08607].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("l_forearm")
                                .setDEF("hanim_l_forearm")
                                .addChild(Transform.new()
                                    .setTranslation([6.823, 36.080002, 0.08607].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([6.915, 28.41, 0.3752].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    .setName("l_carpal")
                                    .setDEF("hanim_l_carpal")
                                    .addChild(Transform.new()
                                        .setTranslation([6.915, 28.41, 0.3752].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                ...
                                .addChild(Transform.new()
                                    ...
                                    .addChild(Shape.new()
                                        ...
                                        .setGeometry(IndexedFaceSet.new()
                                            ...
                                            .setCoord(Coordinate.new()
                                                .setPoint([-0.1597, 0.4908, -1.015, -0.9881, 0.4908, -0.2281, -0.5166, 0.4908, 0.9165, 0.6033, 0.4908, 0.8366, 0.8239, 0.4908, -0.3574, -0.1063, -0.5229, -1.433, -1.277, -0.5229, -0.3764, -0.6107, -0.5229, 1.433, 0.972, -0.5229, 1.306, 1.284, -0.5229, -0.5807, -0.117, -2.864, -1.416, -1.367, -2.864, -0.3724, -0.6839, -2.352, 1.419, 1.006, -2.352, 1.294, 1.367, -2.864, -0.5747, -0.0931, -7.459, -1.267, -1.005, -7.459, -0.1128, -0.4859, -7.459, 1.331, 0.7465, -7.459, 1.214, 0.9892, -7.459, -0.3022, -0.054, -8.009, -0.7805, -0.6765, -8.009, 0.0074, -0.3221, -8.009, 0.919, 0.5194, -8.009, 0.8391, 0.6852, -8.009, -0.1219].to_java Java::float)
                                            )
                                            .setTexCoord(TextureCoordinate.new()
                                                .setPoint([0.4222, 0.6201, 0.4327, 0.6201, 0.3884, 0.6201, 0.3987, 0.6201, 0.4103, 0.6201, 0.4213, 0.6265, 0.4321, 0.6265, 0.3894, 0.6265, 0.399, 0.6265, 0.4105, 0.6265, 0.4214, 0.6413, 0.4323, 0.6413, 0.389, 0.6381, 0.3992, 0.6381, 0.4103, 0.6413, 0.4213, 0.6705, 0.4336, 0.6705, 0.3899, 0.6705, 0.3981, 0.6705, 0.4094, 0.6705, 0.4215, 0.674, 0.4346, 0.674, 0.3899, 0.674, 0.398, 0.674, 0.4083, 0.674, 0.3787, 0.6201, 0.3682, 0.6201, 0.3787, 0.6201, 0.3782, 0.6265, 0.3782, 0.6265, 0.3783, 0.6413, 0.3783, 0.6413, 0.3796, 0.6705, 0.3676, 0.674, 0.3806, 0.674, 0.3796, 0.6705, 0.3806, 0.674].to_java Java::float)
                                            )
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("vl5")
                        .setDEF("hanim_vl5")
                        .setCenter([0, 35.75, -0.445].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l5")
                            .setDEF("hanim_l5")
                            .addChild(Transform.new()
                                .setTranslation([0, 35.75, -0.445].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([0, 50.470001, -0.1481].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("skull")
                                .setDEF("hanim_skull")
                                .addChild(Transform.new()
                                    .setTranslation([0, 50.470001, -0.1481].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
        ...
        .addChild(EXPORT.new()
            .setAS("KoreanCharacter04Young")
            .setLocalDEF("hanim_Young")
        )
    )
x3D0.toFileX3D "../data/KoreanCharacter04Young.new.jruby.x3d"
x3D0.toFileJSON "../data/KoreanCharacter04Young.new.jruby.x3dj"

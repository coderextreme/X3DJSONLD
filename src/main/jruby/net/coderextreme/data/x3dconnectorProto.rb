...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            .setPosition([0, 0, 5].to_java Java::float)
            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.7, 0.2, 0.2].to_java Java::float)
                    )
                )
        ...
        .addChild(Transform.new()
            .setDEF("G2")
            .setTranslation([1, -1, 0.01].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.2, 0.7, 0.2].to_java Java::float)
                    )
                )
                .setGeometry(Sphere.new()
                    .setRadius(0.1)
            ...
            .addChild(PlaneSensor.new()
                .setDescription("Grab to move")
                .setOffset([1, -1, 0.01].to_java Java::float)
                .setDEF("PS2")
            )
            .addChild(ROUTE.new()
                .setFromNode("PS2")
        ...
        .addChild(Transform.new()
            ...
            .addChild(Transform.new()
                ...
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setDiffuseColor([0.2, 0.7, 0.7].to_java Java::float)
                            .setTransparency(0.5)
                        )
                    )
...
x3D0.toFileX3D "../data/x3dconnectorProto.new.jruby.x3d"
x3D0.toFileJSON "../data/x3dconnectorProto.new.jruby.json"

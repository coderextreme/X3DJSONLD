...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/JinOriginalLOA3.x3d")
        )
        .addMeta(Meta.new()
            .setName("generator")
                ...
                .addChild(HAnimJoint.new()
                        ...
                        .addChild(Transform.new()
                            ...
                            .addChild(Shape.new()
                                ...
                                .setGeometry(IndexedFaceSet.new()
                                    ...
                                    .setCoord(Coordinate.new()
                                        .setPoint([4.178, 1.114, 3.711, 5.76, 1.15, 1.754, 1.52, 0.9575, -3.918, 3.95, 0.9672, -2.776, 5.309, 1.072, -0.9797, 3.789, 0.0396, 2.969, 5.166, 0.0713, 1.445, 1.593, -0.0798, -2.916, 3.6, -0.0573, -2.087, 4.841, -0.0103, -0.6841, 1.635, 1.083, 4.322, 1.595, 0.0009, 3.405, 0, 0.0009, 3.405, 0, 1.083, 4.322, -1.595, 0.0009, 3.405, -3.789, 0.0396, 2.969, -4.178, 1.114, 3.711, -1.635, 1.083, 4.322, -5.166, 0.0713, 1.445, -5.76, 1.15, 1.754, -3.6, -0.0573, -2.087, -1.593, -0.0798, -2.916, -1.52, 0.9575, -3.918, -3.95, 0.9672, -2.776, -4.841, -0.0103, -0.6841, -5.309, 1.072, -0.9797, 0, -0.0798, -2.916, 0, 0.9575, -3.918, 1.609, 1.473, 4.099, 4.053, 1.473, 3.512, 5.524, 1.473, 1.692, 5.098, 1.473, -0.8893, 3.806, 1.473, -2.528, 1.47, 1.473, -3.626, 0, 1.473, -3.626, -1.47, 1.473, -3.626, -3.806, 1.473, -2.528, -5.098, 1.473, -0.8893, -5.524, 1.473, 1.692, -4.053, 1.473, 3.512, -1.609, 1.473, 4.099, 0, 1.473, 4.099].to_java Java::float)
                                    )
                                )
                            )
                        )
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .addChild(HAnimJoint.new()
                            .setDEF("hanim_vl3")
                            .setName("vl3")
                            .setCenter([0, 42.03, -0.6117].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setDEF("hanim_l3")
                                .setName("l3")
                                .addChild(Transform.new()
                                    .setTranslation([0, 42.03, -0.6117].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .addChild(HAnimJoint.new()
                                    .setDEF("hanim_vl1")
                                    .setName("vl1")
                                    .setCenter([0, 43.52, -0.6117].to_java Java::float)
                                    .addChild(HAnimSegment.new()
                                        .setDEF("hanim_l1")
                                        .setName("l1")
                                        .addChild(Transform.new()
                                            .setTranslation([0, 43.52, -0.6117].to_java Java::float)
                                            .addChild(Shape.new()
                                                .setAppearance(Appearance.new()
                                                    .setMaterial(Material.new()
                                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                ...
                                                .setGeometry(IndexedFaceSet.new()
                                                    ...
                                                    .setCoord(Coordinate.new()
                                                        .setPoint([3.702, 1.056, 2.588, 1.286, 1.056, 3.04, 5.104, 1.056, 1.294, 1.363, 1.056, -2.529, 3.588, 1.056, -1.686, 4.805, 1.056, -0.5256, 0, 1.056, 3.04, 3.71, 0.0128, 2.648, 4.818, 0.0128, -0.5615, 0, 0.0128, 3.092, 0, 0.0128, -2.595, 5.128, 0.0128, 1.321, 1.293, 0.0128, -2.595, 3.593, 0.0128, -1.696, 1.281, 0.0128, 3.092, -1.281, 0.0128, 3.092, -3.71, 0.0128, 2.648, -3.702, 1.056, 2.588, -1.286, 1.056, 3.04, -5.128, 0.0128, 1.321, -5.104, 1.056, 1.294, -3.593, 0.0128, -1.696, -1.293, 0.0128, -2.595, -1.363, 1.056, -2.529, -3.588, 1.056, -1.686, -4.818, 0.0128, -0.5615, -4.805, 1.056, -0.5256, 0, 1.056, -2.529, 1.266, 1.5, 2.82, 3.599, 1.5, 2.383, 4.867, 1.5, 1.212, 4.6, 1.5, -0.4169, 3.469, 1.5, -1.496, 1.323, 1.5, -2.308, 0, 1.5, -2.309, -1.323, 1.5, -2.308, -3.469, 1.5, -1.496, -4.6, 1.5, -0.4169, -4.867, 1.5, 1.212, -3.599, 1.5, 2.383, -1.266, 1.5, 2.82, 0, 1.5, 2.82, 3.606, -0.3662, 2.442, 1.261, -0.3662, 2.872, 0, -0.3662, 2.872, -1.261, -0.3662, 2.872, -3.606, -0.3662, 2.442, -4.891, -0.3662, 1.241, -4.612, -0.3662, -0.451, -3.473, -0.3662, -1.506, -1.251, -0.3662, -2.375, 0, -0.3662, -2.375, 1.251, -0.3662, -2.375, 3.473, -0.3662, -1.506, 4.612, -0.3662, -0.451, 4.891, -0.3662, 1.241].to_java Java::float)
                                                    )
                                                )
                                            )
                                        )
                                    ...
                                    .addChild(HAnimJoint.new()
                                        .setDEF("hanim_vt12")
                                        .setName("vt12")
                                        .setCenter([0, 44.57, -0.6117].to_java Java::float)
                                        .addChild(HAnimSegment.new()
                                            .setDEF("hanim_t12")
                                            .setName("t12")
                                            .addChild(Transform.new()
                                                .setTranslation([0, 44.57, -0.6117].to_java Java::float)
                                                .addChild(Shape.new()
                                                    .setAppearance(Appearance.new()
                                                        .setMaterial(Material.new()
                                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                    ...
                                                    .setGeometry(IndexedFaceSet.new()
                                                        ...
                                                        .setCoord(Coordinate.new()
                                                            .setPoint([3.695, 1.054, 2.529, 5.081, 1.054, 1.266, 1.292, 1.054, 2.988, 1.434, 1.054, -2.463, 3.584, 1.054, -1.677, 4.793, 1.054, -0.4897, 3.702, 0.0104, 2.588, 1.286, 0.0104, 3.04, 5.104, 0.0104, 1.294, 1.363, 0.0104, -2.529, 3.588, 0.0104, -1.686, 4.805, 0.0104, -0.5256, 0, 0.0104, 3.04, -3.584, 1.054, -1.677, -4.793, 1.054, -0.4897, -4.805, 0.0104, -0.5256, -3.588, 0.0104, -1.686, 0, 1.054, -2.464, -1.434, 1.054, -2.463, -1.363, 0.0104, -2.529, 0, 0.0104, -2.529, -3.702, 0.0104, 2.588, -3.695, 1.054, 2.529, -1.292, 1.054, 2.988, -1.286, 0.0104, 3.04, -5.104, 0.0104, 1.294, -5.081, 1.054, 1.266, 0, 1.054, 2.988, 1.276, 1.452, 2.823, 3.618, 1.452, 2.375, 4.904, 1.452, 1.204, 4.639, 1.452, -0.4096, 3.494, 1.452, -1.534, 1.405, 1.452, -2.298, 0, 1.452, -2.298, -1.405, 1.452, -2.298, -3.494, 1.452, -1.534, -4.639, 1.452, -0.4096, -4.904, 1.452, 1.204, -3.618, 1.452, 2.375, -1.276, 1.452, 2.823, 0, 1.452, 2.823, 3.625, -0.4686, 2.435, 1.271, -0.4686, 2.875, 0, -0.4686, 2.875, -1.271, -0.4686, 2.875, -3.625, -0.4686, 2.435, -4.927, -0.4686, 1.233, -4.651, -0.4686, -0.4442, -3.499, -0.4686, -1.544, -1.333, -0.4686, -2.364, 0, -0.4686, -2.364, 1.333, -0.4686, -2.364, 3.499, -0.4686, -1.544, 4.651, -0.4686, -0.4442, 4.927, -0.4686, 1.233].to_java Java::float)
                                                        )
                                                    )
                                                )
                                            )
                                        ...
                                        .addChild(HAnimJoint.new()
                                            .setDEF("hanim_vt11")
                                            .setName("vt11")
                                            .setCenter([0, 45.61, -0.6117].to_java Java::float)
                                            .addChild(HAnimSegment.new()
                                                .setDEF("hanim_t11")
                                                .setName("t11")
                                                .addChild(Transform.new()
                                                    .setTranslation([0, 45.61, -0.6117].to_java Java::float)
                                                    .addChild(Shape.new()
                                                        .setAppearance(Appearance.new()
                                                            .setMaterial(Material.new()
                                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                            ...
                                            .addChild(HAnimJoint.new()
                                                .setDEF("hanim_vt10")
                                                .setName("vt10")
                                                .setCenter([0, 46.37, -0.6127].to_java Java::float)
                                                .addChild(HAnimSegment.new()
                                                    .setDEF("hanim_t10")
                                                    .setName("t10")
                                                    .addChild(Transform.new()
                                                        .setTranslation([0, 46.37, -0.6127].to_java Java::float)
                                                        .addChild(Shape.new()
                                                            .setAppearance(Appearance.new()
                                                                .setMaterial(Material.new()
                                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                ...
                                                .addChild(HAnimJoint.new()
                                                    .setDEF("hanim_vt9")
                                                    .setName("vt9")
                                                    .setCenter([0, 47.03, -0.6117].to_java Java::float)
                                                    .addChild(HAnimSegment.new()
                                                        .setDEF("hanim_t9")
                                                        .setName("t9")
                                                        .addChild(Transform.new()
                                                            .setTranslation([0, 47.03, -0.6117].to_java Java::float)
                                                            .addChild(Shape.new()
                                                                .setAppearance(Appearance.new()
                                                                    .setMaterial(Material.new()
                                                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                    ...
                                                    .addChild(HAnimJoint.new()
                                                        .setDEF("hanim_vt8")
                                                        .setName("vt8")
                                                        .setCenter([0, 47.68, -0.6117].to_java Java::float)
                                                        .addChild(HAnimSegment.new()
                                                            .setDEF("hanim_t8")
                                                            .setName("t8")
                                                            .addChild(Transform.new()
                                                                .setTranslation([0, 47.68, -0.6117].to_java Java::float)
                                                                .addChild(Shape.new()
                                                                    .setAppearance(Appearance.new()
                                                                        .setMaterial(Material.new()
                                                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                        ...
                                                        .addChild(HAnimJoint.new()
                                                            .setDEF("hanim_vt7")
                                                            .setName("vt7")
                                                            .setCenter([0, 48.37, -0.6117].to_java Java::float)
                                                            .addChild(HAnimSegment.new()
                                                                .setDEF("hanim_t7")
                                                                .setName("t7")
                                                                .addChild(Transform.new()
                                                                    .setTranslation([0, 48.37, -0.6117].to_java Java::float)
                                                                    .addChild(Shape.new()
                                                                        .setAppearance(Appearance.new()
                                                                            .setMaterial(Material.new()
                                                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                            ...
                                                            .addChild(HAnimJoint.new()
                                                                .setDEF("hanim_vt6")
                                                                .setName("vt6")
                                                                .setCenter([0, 48.95, -0.6117].to_java Java::float)
                                                                .addChild(HAnimSegment.new()
                                                                    .setDEF("hanim_t6")
                                                                    .setName("t6")
                                                                    .addChild(Transform.new()
                                                                        .setTranslation([0, 48.95, -0.6117].to_java Java::float)
                                                                        .addChild(Shape.new()
                                                                            .setAppearance(Appearance.new()
                                                                                .setMaterial(Material.new()
                                                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                ...
                                                                .addChild(HAnimJoint.new()
                                                                    .setDEF("hanim_vt5")
                                                                    .setName("vt5")
                                                                    .setCenter([0, 49.64, -0.6117].to_java Java::float)
                                                                    .addChild(HAnimSegment.new()
                                                                        .setDEF("hanim_t5")
                                                                        .setName("t5")
                                                                        .addChild(Transform.new()
                                                                            .setTranslation([0, 49.64, -0.6117].to_java Java::float)
                                                                            .addChild(Shape.new()
                                                                                .setAppearance(Appearance.new()
                                                                                    .setMaterial(Material.new()
                                                                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                    ...
                                                                    .addChild(HAnimJoint.new()
                                                                        .setDEF("hanim_vt4")
                                                                        .setName("vt4")
                                                                        .setCenter([0, 50.31, -0.6117].to_java Java::float)
                                                                        .addChild(HAnimSegment.new()
                                                                            .setDEF("hanim_t4")
                                                                            .setName("t4")
                                                                            .addChild(Transform.new()
                                                                                .setTranslation([0, 50.31, -0.6117].to_java Java::float)
                                                                                .addChild(Shape.new()
                                                                                    .setAppearance(Appearance.new()
                                                                                        .setMaterial(Material.new()
                                                                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                        ...
                                                                        .addChild(HAnimJoint.new()
                                                                            .setDEF("hanim_vt3")
                                                                            .setName("vt3")
                                                                            .setCenter([0, 51.13, -0.6117].to_java Java::float)
                                                                            .addChild(HAnimSegment.new()
                                                                                .setDEF("hanim_t3")
                                                                                .setName("t3")
                                                                                .addChild(Transform.new()
                                                                                    .setTranslation([0, 51.13, -0.6117].to_java Java::float)
                                                                                    .addChild(Shape.new()
                                                                                        .setAppearance(Appearance.new()
                                                                                            .setMaterial(Material.new()
                                                                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                            ...
                                                                            .addChild(HAnimJoint.new()
                                                                                .setDEF("hanim_vt2")
                                                                                .setName("vt2")
                                                                                .setCenter([0, 52.23, -0.6127].to_java Java::float)
                                                                                .addChild(HAnimSegment.new()
                                                                                    .setDEF("hanim_t2")
                                                                                    .setName("t2")
                                                                                    .addChild(Transform.new()
                                                                                        .setTranslation([0, 52.23, -0.6127].to_java Java::float)
                                                                                        .addChild(Shape.new()
                                                                                            .setAppearance(Appearance.new()
                                                                                                .setMaterial(Material.new()
                                                                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                ...
                                                                                .addChild(HAnimJoint.new()
                                                                                    .setDEF("hanim_vt1")
                                                                                    .setName("vt1")
                                                                                    .setCenter([0, 53.29, -0.6117].to_java Java::float)
                                                                                    .addChild(HAnimSegment.new()
                                                                                        .setDEF("hanim_t1")
                                                                                        .setName("t1")
                                                                                        .addChild(Transform.new()
                                                                                            .setTranslation([0, 53.29, -0.6117].to_java Java::float)
                                                                                            .addChild(Shape.new()
                                                                                                .setAppearance(Appearance.new()
                                                                                                    .setMaterial(Material.new()
                                                                                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                    ...
                                                                                    .addChild(HAnimJoint.new()
                                                                                        .setDEF("hanim_vc7")
                                                                                        .setName("vc7")
                                                                                        .setCenter([0, 54.45, -0.6695].to_java Java::float)
                                                                                        .addChild(HAnimSegment.new()
                                                                                            .setDEF("hanim_c7")
                                                                                            .setName("c7")
                                                                                            .addChild(Transform.new()
                                                                                                .setTranslation([0, 54.45, -0.6695].to_java Java::float)
                                                                                                .addChild(Shape.new()
                                                                                                    .setAppearance(Appearance.new()
                                                                                                        .setMaterial(Material.new()
                                                                                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                        ...
                                                                                        .addChild(HAnimJoint.new()
                                                                                            .setDEF("hanim_vc6")
                                                                                            .setName("vc6")
                                                                                            .setCenter([0, 54.98, -0.6695].to_java Java::float)
                                                                                            .addChild(HAnimSegment.new()
                                                                                                .setDEF("hanim_c6")
                                                                                                .setName("c6")
                                                                                                .addChild(Transform.new()
                                                                                                    .setTranslation([0, 54.98, -0.6695].to_java Java::float)
                                                                                                    .addChild(Shape.new()
                                                                                                        .setAppearance(Appearance.new()
                                                                                                            .setMaterial(Material.new()
                                                                                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                            ...
                                                                                            .addChild(HAnimJoint.new()
                                                                                                .setDEF("hanim_vc5")
                                                                                                .setName("vc5")
                                                                                                .setCenter([0, 55.54, -0.6695].to_java Java::float)
                                                                                                .addChild(HAnimSegment.new()
                                                                                                    .setDEF("hanim_c5")
                                                                                                    .setName("c5")
                                                                                                    .addChild(Transform.new()
                                                                                                        .setTranslation([0, 55.54, -0.6695].to_java Java::float)
                                                                                                        .addChild(Shape.new()
                                                                                                            .setAppearance(Appearance.new()
                                                                                                                .setMaterial(Material.new()
                                                                                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                                ...
                                                                                                .addChild(HAnimJoint.new()
                                                                                                    .setDEF("hanim_vc4")
                                                                                                    .setName("vc4")
                                                                                                    .setCenter([0, 56.08, -0.6695].to_java Java::float)
                                                                                                    .addChild(HAnimSegment.new()
                                                                                                        .setDEF("hanim_c4")
                                                                                                        .setName("c4")
                                                                                                        .addChild(Transform.new()
                                                                                                            .setTranslation([0, 56.08, -0.6695].to_java Java::float)
                                                                                                            .addChild(Shape.new()
                                                                                                                .setAppearance(Appearance.new()
                                                                                                                    .setMaterial(Material.new()
                                                                                                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                                    ...
                                                                                                    .addChild(HAnimJoint.new()
                                                                                                        .setDEF("hanim_vc3")
                                                                                                        .setName("vc3")
                                                                                                        .setCenter([0, 56.66, -0.6695].to_java Java::float)
                                                                                                        .addChild(HAnimSegment.new()
                                                                                                            .setDEF("hanim_c3")
                                                                                                            .setName("c3")
                                                                                                            .addChild(Transform.new()
                                                                                                                .setTranslation([0, 56.66, -0.6695].to_java Java::float)
                                                                                                                .addChild(Shape.new()
                                                                                                                    .setAppearance(Appearance.new()
                                                                                                                        .setMaterial(Material.new()
                                                                                                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                                        ...
                                                                                                        .addChild(HAnimJoint.new()
                                                                                                            .setDEF("hanim_vc2")
                                                                                                            .setName("vc2")
                                                                                                            .setCenter([0, 57.17, -0.6695].to_java Java::float)
                                                                                                            .addChild(HAnimSegment.new()
                                                                                                                .setDEF("hanim_c2")
                                                                                                                .setName("c2")
                                                                                                                .addChild(Transform.new()
                                                                                                                    .setTranslation([0, 57.17, -0.6695].to_java Java::float)
                                                                                                                    .addChild(Shape.new()
                                                                                                                        .setAppearance(Appearance.new()
                                                                                                                            .setMaterial(Material.new()
                                                                                                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                                            ...
                                                                                                            .addChild(HAnimJoint.new()
                                                                                                                .setDEF("hanim_vc1")
                                                                                                                .setName("vc1")
                                                                                                                .setCenter([0, 57.69, -0.6695].to_java Java::float)
                                                                                                                .addChild(HAnimSegment.new()
                                                                                                                    .setDEF("hanim_c1")
                                                                                                                    .setName("c1")
                                                                                                                    .addChild(Transform.new()
                                                                                                                        .setTranslation([0, 57.69, -0.6695].to_java Java::float)
                                                                                                                        .addChild(Shape.new()
                                                                                                                            .setAppearance(Appearance.new()
                                                                                                                                .setMaterial(Material.new()
                                                                                                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                                                ...
                                                                                                                .addChild(HAnimJoint.new()
                                                                                                                    ...
                                                                                                                    .addChild(HAnimJoint.new()
                                                                                                                        ...
                                                                                                                        .setCenter([2.245, 62.4, 1.464].to_java Java::float)
                                                                                                                        .addChild(HAnimSegment.new()
                                                                                                                            .setDEF("hanim_l_eyelid")
                                                                                                                            .setName("l_eyelid")
                                                                                                                            .addChild(Transform.new()
                                                                                                                                .setTranslation([2.245, 62.4, 1.464].to_java Java::float)
                                                                                                                                .setRotation([1, 0, 0, -0.5236].to_java Java::float)
                                                                                                                                .addChild(Shape.new()
                                                                                                                                    .setAppearance(Appearance.new()
                                                                                                                                        .setMaterial(Material.new()
                                                                                                                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                                                                    ...
                                                                                                                                    .setGeometry(IndexedFaceSet.new()
                                                                                                                                        ...
                                                                                                                                        .setCoord(Coordinate.new()
                                                                                                                                            .setPoint([0.7812, -0.3922, 2.571, -0.0916, -0.4605, 3.239, -0.6939, -0.6908, 3.379, -1.201, -1.081, 3.304, 1.44, -0.7409, 1.741, 0.5651, -1.538, 2.334, -0.0316, -1.56, 2.732, -0.5556, -1.456, 2.994, -0.9123, -1.31, 3.138, 1.238, -0.9979, 1.826, 1.125, -0.5541, 2.164, 0.8496, -1.396, 2.061, 0.6573, -0.3994, 2.377, -0.1708, -0.5443, 2.903, -0.7043, -0.7411, 3.046, -1.214, -1.081, 3.172, 1.382, -0.7409, 1.7, 0.5305, -1.549, 2.255, -0.061, -1.557, 2.59, -0.5907, -1.457, 2.881, -0.9336, -1.31, 3.023, 1.226, -0.991, 1.738, 1.011, -0.5701, 2.042, 0.8046, -1.4, 2.015, 0.7041, -1.015, 2.416, -0.0583, -1.031, 3.036, -0.5943, -1.139, 3.166, 0.9909, -1.005, 2.116].to_java Java::float)
                                                                                                                                        )
                                                                                                                                    )
                                                                                                                                )
                                                                                                                            )
                                                                                                                    ...
                                                                                                                    .addChild(HAnimJoint.new()
                                                                                                                        ...
                                                                                                                        .setCenter([2.139, 61.53, 3.691].to_java Java::float)
                                                                                                                        .addChild(HAnimSegment.new()
                                                                                                                            .setDEF("hanim_l_eyeball")
                                                                                                                            .setName("l_eyeball")
                                                                                                                            .addChild(Transform.new()
                                                                                                                                .setTranslation([2.139, 61.53, 3.691].to_java Java::float)
                                                                                                                                .addChild(Shape.new()
                                                                                                                                    .setAppearance(Appearance.new()
                                                                                                                                        .setMaterial(Material.new()
                                                                                                                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                                                    ...
                                                                                                                    .addChild(HAnimJoint.new()
                                                                                                                        ...
                                                                                                                        .setCenter([0.9666, 61.93, 4.753].to_java Java::float)
                                                                                                                        .addChild(HAnimSegment.new()
                                                                                                                            .setDEF("hanim_l_eyebrow")
                                                                                                                            .setName("l_eyebrow")
                                                                                                                            .addChild(Transform.new()
                                                                                                                                .setTranslation([0.9666, 61.93, 4.753].to_java Java::float)
                                                                                                                                .addChild(Shape.new()
                                                                                                                                    .setAppearance(Appearance.new()
                                                                                                                                        .setMaterial(Material.new()
                                                                                                                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                                                                                    ...
                                                                                                                    .addChild(HAnimJoint.new()
                                                                                                                        ...
                                                                                                                        .setCenter([0, 57.45, 0.6835].to_java Java::float)
                                                                                                                        .addChild(HAnimSegment.new()
                                                                                                                            .setDEF("hanim_jaw")
                                                                                                                            .setName("jaw")
                                                                                                                            .addChild(Transform.new()
                                                                                                                                .setTranslation([0, 57.45, 0.6835].to_java Java::float)
                                                                                                                                .addChild(Shape.new()
                                                                                                                                    .setAppearance(Appearance.new()
                                                                                                                                        .setMaterial(Material.new()
                                                                                                                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
...
x3D0.toFileX3D "../data/JinOriginalLOA3.new.jruby.x3d"
x3D0.toFileJSON "../data/JinOriginalLOA3.new.jruby.x3dj"

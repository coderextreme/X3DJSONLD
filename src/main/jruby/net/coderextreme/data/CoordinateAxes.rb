...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("reference")
            .setContent("https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.x3d")
        )
        .addMeta(Meta.new()
            .setName("reference")
            .setContent("https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxesNSEW.x3d")
        )
        .addMeta(Meta.new()
            .setName("reference")
    ...
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("CoordinateAxes.x3d")
        )
        .addChild(Collision.new()
            .setDEF("DoNotCollideWithVisualizationWidget")
          .addComments(CommentsBlock.new("Invoke CoordinateAxes in other scenes as an Inline child inside a scaling Transform node, at the topmost level of the scene graph."))
          .addComments(CommentsBlock.new("This NavigationInfo allows examine mode and will be overridden by any parent scene."))
          .addComments(CommentsBlock.new("Each arrow goes from +1m to -1m to allow linear scaling to fit a scene"))
          .addComments(CommentsBlock.new("Note each label rotates about the scene's vertical Y axis for consistency, enabling local orientation by user"))
            .setProxy(Group.new()
            .addComments(CommentsBlock.new("Vertical Y arrow and label"))
                .addChild(Group.new()
                    .setDEF("ArrowGreen")
                    .addChild(Shape.new()
                        ...
                        .setAppearance(Appearance.new()
                            ...
                            .setMaterial(Material.new()
                                .setDiffuseColor([0.1, 0.6, 0.1].to_java Java::float)
                                .setEmissiveColor([0.05, 0.2, 0.05].to_java Java::float)
                            )
                        )
                    )
                ...
                .addChild(Transform.new()
                    .setTranslation([0, 1.08, 0].to_java Java::float)
                    .addChild(Billboard.new()
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                .setDEF("LABEL_APPEARANCE")
                                .setMaterial(Material.new()
                                    .setDiffuseColor([1, 1, 0.3].to_java Java::float)
                                    .setEmissiveColor([0.33, 0.33, 0.1].to_java Java::float)
                                )
                            )
                            .setGeometry(Text.new()
                                .setString(["Y"].to_java Java::java.lang.String)
            ...
            .setProxy(Transform.new()
                .setRotation([0, 0, 1, -1.57079].to_java Java::float)
            .addComments(CommentsBlock.new("Horizontal X arrow and label"))
                .addChild(Group.new()
                    .addChild(Group.new()
                        .setDEF("ArrowRed")
                        .addChild(Shape.new()
                            ...
                            .setAppearance(Appearance.new()
                                .setDEF("Red")
                                .setMaterial(Material.new()
                                    .setDiffuseColor([0.7, 0.1, 0.1].to_java Java::float)
                                    .setEmissiveColor([0.33, 0, 0].to_java Java::float)
                                )
                            )
                        )
                        .addChild(Transform.new()
                    ...
                    .addChild(Transform.new()
                        .setRotation([0, 0, 1, 1.57079].to_java Java::float)
                        .setTranslation([0.072, 1.1, 0].to_java Java::float)
                .addComments(CommentsBlock.new("note label rotated back to original coordinate frame"))
                        .addChild(Billboard.new()
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                ...
                                .setGeometry(Text.new()
                                    .setString(["X"].to_java Java::java.lang.String)
                                    .setFontStyle(FontStyle.new()
                                        .setUSE("LABEL_FONT")
                                    )
                                )
            ...
            .setProxy(Transform.new()
                .setRotation([1, 0, 0, 1.57079].to_java Java::float)
            .addComments(CommentsBlock.new("Perpendicular Z arrow and label, note right-hand rule"))
                .addChild(Group.new()
                    .addChild(Group.new()
                        .setDEF("ArrowBlue")
                        .addChild(Shape.new()
                            ...
                            .setAppearance(Appearance.new()
                                ...
                                .setMaterial(Material.new()
                                    ...
                                    .setEmissiveColor([0.1, 0.1, 0.33].to_java Java::float)
                                )
                            )
                        )
                        .addChild(Transform.new()
                    ...
                    .addChild(Transform.new()
                        .setRotation([1, 0, 0, -1.57079].to_java Java::float)
                        .setTranslation([0, 1.1, 0.072].to_java Java::float)
                .addComments(CommentsBlock.new("note label rotated back to original coordinate frame"))
                        .addChild(Billboard.new()
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                ...
                                .setGeometry(Text.new()
                                    .setString(["Z"].to_java Java::java.lang.String)
                                    .setFontStyle(FontStyle.new()
                                        .setUSE("LABEL_FONT")
                                    )
                                )
...
x3D0.toFileX3D "../data/CoordinateAxes.new.jruby.x3d"
x3D0.toFileJSON "../data/CoordinateAxes.new.jruby.x3dj"

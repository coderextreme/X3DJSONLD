...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setPosition([0, 0, 1.7].to_java Java::float)
        )
        .addChild(Transform.new()
            .setTranslation([-1, 1, 0].to_java Java::float)
            .addChild(Inline.new()
                .setUrl(["HAnimModelHandLeft.x3d", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelHandLeft.x3d", "HAnimModelHandLeft.wrl", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelHandLeft.wrl"].to_java Java::java.lang.String)
            )
            .addChild(Transform.new()
                ...
                .addChild(Inline.new()
                    ...
                    .setUrl(["../../Savage/Tools/Authoring/GridXY_20x20Fixed.x3d", "https://savage.nps.edu/Savage/Tools/Authoring/GridXY_20x20Fixed.x3d", "../../Savage/Tools/Authoring/GridXY_20x20Fixed.wrl", "https://savage.nps.edu/Savage/Tools/Authoring/GridXY_20x20Fixed.wrl"].to_java Java::java.lang.String)
                )
            )
        )
        .addChild(Transform.new()
            .setTranslation([1, 1, 0].to_java Java::float)
            .addChild(Inline.new()
                .setUrl(["HAnimModelHandRight.x3d", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelHandRight.x3d", "HAnimModelHandRight.wrl", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelHandRight.wrl"].to_java Java::java.lang.String)
            )
            .addChild(Transform.new()
        ...
        .addChild(Transform.new()
            .setTranslation([-1, -1, 0].to_java Java::float)
            .addChild(Inline.new()
                .setUrl(["HAnimModelFootLeft.x3d", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootLeft.x3d", "HAnimModelFootLeft.wrl", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootLeft.wrl"].to_java Java::java.lang.String)
            )
            .addChild(Transform.new()
                .setUSE("GridXY_20x20Fixed_AdjustScale")
            )
        ...
        .addChild(Transform.new()
            .setTranslation([1, -1, 0].to_java Java::float)
            .addChild(Inline.new()
                .setUrl(["HAnimModelFootRight.x3d", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootRight.x3d", "HAnimModelFootRight.wrl", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/HAnimModelFootRight.wrl"].to_java Java::java.lang.String)
            )
            .addChild(Transform.new()
                .setUSE("GridXY_20x20Fixed_AdjustScale")
            )
...
x3D0.toFileX3D "../data/HAnimModelsHandsFeet.new.jruby.x3d"
x3D0.toFileJSON "../data/HAnimModelsHandsFeet.new.jruby.x3dj"

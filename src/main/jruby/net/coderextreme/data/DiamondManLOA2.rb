...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("title")
            .setContent("DiamondManLOA2.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("HAnim skeletal structure at level of articulation two, one diamond at the base node for the structure, blue spheres for HAnimSite feaature points")
        )
        .addMeta(Meta.new()
            .setName("creator")
        ...
        .addMeta(Meta.new()
            .setName("modified")
            .setContent("Mon, 15 Sep 2025 05:18:47 GMT")
        )
        .addMeta(Meta.new()
            .setName("Image")
            .setContent("DiamondManLOA2.png")
        )
        .addMeta(Meta.new()
            .setName("Image")
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Templates/DiamondManLOA2.x3d")
        )
    )
    .setScene(Scene.new()
        ...
        .addChild(HAnimHumanoid.new()
            ...
            .addViewpoints(HAnimSite.new()
                .setDEF("hanim_DiamondManLOA2_view")
                .setName("DiamondManLOA2_view")
...
x3D0.toFileX3D "../data/DiamondManLOA2.new.jruby.x3d"
x3D0.toFileJSON "../data/DiamondManLOA2.new.jruby.x3dj"

        ...
        .addChild(Shape.new()
            ...
            .setGeometry(IndexedFaceSet.new()
                ...
                .setTexCoord(TextureCoordinate.new()
                    .setPoint([0, 1, 0, 0, 1, 1, 1, 0].to_java Java::float)
                )
            )
        )
    )
x3D0.toFileX3D "../data/indexedfacesetPixeltexture_whole.new.jruby.x3d"
x3D0.toFileJSON "../data/indexedfacesetPixeltexture_whole.new.jruby.x3dj"

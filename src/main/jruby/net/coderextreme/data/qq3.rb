    ...
    .setScene(Scene.new()
        .addChild(ProtoDeclare.new()
            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Group.new()
              .addComments(CommentsBlock.new("left"))
                        ...
                        .addChild(Shape.new()
                            ...
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    .setDiffuseColor([0.7, 1, 0].to_java Java::float)
                                )
                            )
                            .setGeometry(Extrusion.new()
                                .setSpine([-2.5, 0, 0, -2, 0, 0, -1.5, 0, 0].to_java Java::float)
              ...
              .addComments(CommentsBlock.new("right"))
                    .addChild(Transform.new()
                        .setScale([0.5, 0.5, 0.5].to_java Java::float)
                        .addChild(Shape.new()
                            .setDEF("ShapeUpRight")
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                                    .setDiffuseColor([0, 0.7, 1].to_java Java::float)
                                )
                            )
                            .setGeometry(Extrusion.new()
                                .setSpine([1.5, 0, 0, 2, 0, 0, 2.5, 0, 0].to_java Java::float)
                                .setCreaseAngle(0.785)
                                .setCrossSection([1, 0, 0.92, -0.38, 0.71, -0.71, 0.38, -0.92, 0, -1, -0.38, -0.92, -0.71, -0.71, -0.92, -0.38, -1, 0, -0.92, 0.38, -0.71, 0.71, -0.38, 0.92, 0, 1, 0.38, 0.92, 0.71, 0.71, 0.92, 0.38, 1, 0].to_java Java::float)
                            )
                        )
                    )
              .addComments(CommentsBlock.new("up"))
                    .addChild(Transform.new()
                        .setScale([0.5, 0.5, 0.5].to_java Java::float)
                        .addChild(Shape.new()
                            .setUSE("ShapeUpRight")
              ...
              .addComments(CommentsBlock.new("down"))
                    .addChild(Transform.new()
                        .setScale([0.5, 0.5, 0.5].to_java Java::float)
                        .addChild(Shape.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setOrientation([1, 0, 0, -0.4].to_java Java::float)
            .setPosition([0, 5, 12].to_java Java::float)
        )
        .addChild(Transform.new()
...
x3D0.toFileX3D "../data/qq3.new.jruby.x3d"
x3D0.toFileJSON "../data/qq3.new.jruby.x3dj"

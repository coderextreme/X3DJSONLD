...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            ...
            .setGroundColor([0, 0.5, 0, 0, 0.5, 0].to_java Java::float)
            .setSkyColor([0, 0, 1].to_java Java::float)
        )
        ...
        .addChild(Script.new()
            .setDEF("MYSCRIPT")
            .setUrl(["jumpcut_loadurl.js", "https://www.web3d.org/x3d/content/examples/ConformanceNist/BindableNodes/NavigationInfo/jumpcut_loadurl.js"].to_java Java::java.lang.String)
            .addField(Field.new()
                .setName("myParameter")
...
x3D0.toFileX3D "../data/jumpcut_loadurl.new.jruby.x3d"
x3D0.toFileJSON "../data/jumpcut_loadurl.new.jruby.x3dj"

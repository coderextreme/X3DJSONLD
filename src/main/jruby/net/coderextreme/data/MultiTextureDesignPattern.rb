...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor([0.72549, 1, 0.721569].to_java Java::float)
        )
        ...
        .addChild(Shape.new()
            .setGeometry(Text.new()
                .setString(["Source shows design pattern for", "MultiTexture, MultiTextureCoordinate,", " and MultiTextureTransform nodes"].to_java Java::java.lang.String)
            ...
            .setAppearance(Appearance.new()
                .setMaterial(Material.new()
                    .setDiffuseColor([0.2, 0.4, 0.8].to_java Java::float)
                )
            )
        )
        .addComments(CommentsBlock.new("================================"))
          ...
          .addComments(CommentsBlock.new("add a single geometry node here"))
            .setGeometry(IndexedFaceSet.new()
              ...
              .addComments(CommentsBlock.new("add multiple TextureCoordinate nodes here, match corresponding MultiTexture child texture nodes"))
                    .addTexCoord(TextureCoordinate.new()
                        .setPoint([0, 0, 1, 0, 1, 1, 0, 1].to_java Java::float)
                    )
                    .addTexCoord(TextureCoordinate.new()
                        .setPoint([0, 0, 1, 0, 1, 1, 0, 1].to_java Java::float)
                    )
            ...
            .setAppearance(Appearance.new()
                ...
                .setTexture(MultiTexture.new()
                    .setAlpha(0.8)
                    .setColor([0.9, 1, 0.2].to_java Java::float)
                    .setFunction(["COMPLEMENT", "ALPHAREPLICATE"].to_java Java::java.lang.String)
                    .setMode(["MODULATE", "REPLACE", "BLENDDIFFUSEALPHA"].to_java Java::java.lang.String)
                    .setSource(["DIFFUSE", "SPECULAR", "FACTOR"].to_java Java::java.lang.String)
...
x3D0.toFileX3D "../data/MultiTextureDesignPattern.new.jruby.x3d"
x3D0.toFileJSON "../data/MultiTextureDesignPattern.new.jruby.x3dj"

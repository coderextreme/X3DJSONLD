...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        .addComments(CommentsBlock.new("Viewpoint DEF='Tour' position='0 0 4' orientation='1 0 0 0' description='Tour Views'/"))
        .addComments(CommentsBlock.new("PositionInterpolator DEF='TourPosition' key='0 1' keyValue='-0.5 -0.5 4 -0.5 0.5 4'/"))
        .addChild(GeoViewpoint.new()
            .setDEF("Tour")
            .setPosition([0, 0, 4].to_java Java::double)
        ...
        .addChild(GeoPositionInterpolator.new()
            ...
            .setKeyValue([0.0015708, 0, 4, 0, 0.0015708, 4].to_java Java::double)
        )
        .addChild(Script.new()
...
x3D0.toFileX3D "../data/geobubbles.new.jruby.x3d"
x3D0.toFileJSON "../data/geobubbles.new.jruby.x3dj"

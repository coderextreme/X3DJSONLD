...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setPosition([0, 2, 40].to_java Java::float)
        )
        .addChild(Viewpoint.new()
            .setDEF("EntryView2")
            .setDescription("Hello characters 2")
            .setPosition([-15, 10, 30].to_java Java::float)
            .setOrientation([0, 1, 0, -0.643501].to_java Java::float)
            .setCenterOfRotation([0, 10, 10].to_java Java::float)
        )
        .addChild(Transform.new()
            .setDEF("TextRoot")
            .setTranslation([9.8557, 0.95, 3.5].to_java Java::float)
            .addChild(Shape.new()
                .setDEF("ModelDescriptionText")
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.960784, 0.894118, 0].to_java Java::float)
                    )
                )
                .setGeometry(Text.new()
                    .setString(["This scene tests", "", "experimental approaches", "", "for human animation"].to_java Java::java.lang.String)
        ...
        .addChild(Transform.new()
            .setDEF("Root4")
            .setTranslation([11.3657, 0.475, 3.377131].to_java Java::float)
        )
        .addChild(Transform.new()
            .setDEF("Root5")
            .setTranslation([10.55646, 0.475, 3.391616].to_java Java::float)
        )
        .addChild(Transform.new()
            .setDEF("Root6")
            .setTranslation([9.167682, 0.475, 3.332752].to_java Java::float)
        )
        .addChild(PositionInterpolator.new()
            .setDEF("Gramps_HumanoidRoot_TranslationInterpolator")
            .setKey([0, 0.09, 0.11, 0.22, 0.043, 0.55, 0.63, 0.73, 0.85, 0.86, 1].to_java Java::float)
            .setKeyValue([6.8557, 0.95, 0.5, 6.8557, 0.95, 0.5, 6.8557, 0.95, 0.5, 9.8557, 0.95, 3.5, 9.8557, 0.95, 3.5, 9.8557, 0.95, 3.5, 14.3558, 0.95, 8, 16.8558, 0.95, 15, 21.3557, 0.95, 24.5, 21.3557, 0.95, 24.5, 21.3557, 0.95, 24.5].to_java Java::float)
            .setMetadata(MetadataString.new()
                .setName("poses")
                .setValue(["Gramps_Stand01", "Gramps_Stand01", "Gramps_Walk01", "Gramps_Stand02", "Gramps_Turn01", "Gramps_Walk01", "Gramps_Walk02", "Gramps_Skip01", "Gramps_Stand03", "Gramps_Stand03", "Gramps_Stand03"].to_java Java::java.lang.String)
            )
        )
        .addChild(PositionInterpolator.new()
            .setDEF("Leif_HumanoidRoot_TranslationInterpolator")
            .setKey([0, 0.09, 0.11, 0.223, 0.043, 0.55, 0.63, 0.73, 0.85, 0.86, 1].to_java Java::float)
            .setKeyValue([-7.9962, 0.4, 3, -7.9962, 0.4, 3, -7.9962, 0.4, 3, -7.9962, 0.4, 3, 9.004, 0.475, 3.4999, 11.5048, 0.475, 3.3699, 16.0038, 0.475, 7.8699, 18.5038, 0.475, 14.8699, 23.0038, 0.475, 24.3699, 23.0038, 0.475, 24.3699, 23.0038, 0.475, 24.3699].to_java Java::float)
            .setMetadata(MetadataString.new()
                .setName("poses")
                .setValue(["Leif_Stand01", "Leif_Stand01", "Leif_Stand01", "Leif_Run01", "Leif_Turn01", "Leif_Walk01", "Leif_Walk01", "Leif_Skip01", "Leif_Stand01", "Leif_Stand01", "Leif_Stand01"].to_java Java::java.lang.String)
            )
        )
        .addChild(PositionInterpolator.new()
            .setDEF("Lily_HumanoidRoot_TranslationInterpolator")
            .setKey([0, 0.09, 0.11, 0.225, 0.043, 0.55, 0.63, 0.73, 0.85, 0.86, 1].to_java Java::float)
            .setKeyValue([-8.0962, 0.4, 5.6, -8.0962, 0.4, 5.6, -8.0962, 0.4, 5.6, -8.0962, 0.4, 5.6, 8.9038, 0.475, 4.0999, 10.6538, 0.475, 3.3499, 15.1538, 0.475, 7.8499, 17.6538, 0.475, 14.8499, 22.1538, 0.475, 24.3499, 22.1538, 0.475, 24.3499, 22.1538, 0.475, 24.3499].to_java Java::float)
            .setMetadata(MetadataString.new()
                .setName("poses")
                .setValue(["Lily_Stand01", "Lily_Stand01", "Lily_Stand01", "Leif_Run01", "Lily_Turn01", "Lily_Walk01", "Lily_Walk01", "Lily_Skip01", "Lily_Stand01", "Lily_Stand01", "Lily_Stand01"].to_java Java::java.lang.String)
            )
        )
        .addChild(PositionInterpolator.new()
            .setDEF("Tufani_HumanoidRoot_TranslationInterpolator")
            .setKey([0, 0.09, 0.11, 0.227, 0.043, 0.55, 0.63, 0.73, 0.85, 0.86, 1].to_java Java::float)
            .setKeyValue([-8.0962, 0.4, 6.4, -8.0962, 0.4, 6.4, -8.0962, 0.4, 6.4, -8.0962, 0.4, 6.4, 9.40338, 0.475, 4.3999, 9.1538, 0.475, 3.2699, 13.6538, 0.475, 7.7699, 16.1538, 0.475, 14.7699, 20.6538, 0.475, 24.2699, 20.6538, 0.475, 24.2699, 20.6538, 0.475, 24.2699].to_java Java::float)
            .setMetadata(MetadataString.new()
                .setName("poses")
                .setValue(["Tufani_Stand01", "Tufani_Stand01", "Tufani_Stand01", "Tufani_Run01", "Tufani_Turn01", "Tufani_Walk01", "Tufani_Walk01", "Tufani_Skip01", "Tufani_Stand01", "Tufani_Stand01", "Tufani_Stand01"].to_java Java::java.lang.String)
            )
        )
        ...
        .addChild(Background.new()
            ...
            .setSkyColor([0, 0.71, 0.886].to_java Java::float)
            .setGroundAngle([1.57].to_java Java::float)
            .setGroundColor([0.356863, 0.639216, 0, 0.721569, 1, 0.501961].to_java Java::float)
        )
        .addChild(Background.new()
            .setDEF("Background5LightGrey")
            .setSkyColor([0.827, 0.827, 0.827].to_java Java::float)
        )
        .addChild(Background.new()
            .setDEF("Background6DarkGrey")
            .setSkyColor([0.6, 0.2, 0.2].to_java Java::float)
        )
        ...
        .addChild(BooleanSequencer.new()
            ...
            .setKey([0, 0.09, 0.11, 0.22, 0.043, 0.55, 0.63, 0.73, 0.85, 0.86, 1].to_java Java::float)
            .setKeyValue([true,  true,  true,  false,  false,  false,  false,  false,  false,  false,  false].to_java Java::boolean)
        )
        .addChild(BooleanSequencer.new()
            .setDEF("Background4Sequencer")
            .setKey([0, 0.09, 0.11, 0.22, 0.043, 0.55, 0.63, 0.73, 0.85, 0.86, 1].to_java Java::float)
            .setKeyValue([false,  false,  false,  true,  true,  false,  false,  false,  false,  false,  false].to_java Java::boolean)
        )
        .addChild(BooleanSequencer.new()
            .setDEF("Background5Sequencer")
            .setKey([0, 0.09, 0.11, 0.22, 0.043, 0.55, 0.63, 0.73, 0.85, 0.86, 1].to_java Java::float)
            .setKeyValue([false,  false,  false,  false,  false,  true,  true,  true,  false,  false,  false].to_java Java::boolean)
        )
        .addChild(BooleanSequencer.new()
            .setDEF("Background6Sequencer")
            .setKey([0, 0.09, 0.11, 0.22, 0.043, 0.55, 0.63, 0.73, 0.85, 0.86, 1].to_java Java::float)
            .setKeyValue([false,  false,  false,  false,  false,  false,  false,  false,  true,  true,  true].to_java Java::boolean)
        )
        .addChild(ROUTE.new()
...
x3D0.toFileX3D "../data/WinterAndSpringHumanoidTimings.new.jruby.x3d"
x3D0.toFileJSON "../data/WinterAndSpringHumanoidTimings.new.jruby.x3dj"

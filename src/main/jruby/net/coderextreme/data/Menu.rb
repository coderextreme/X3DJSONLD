...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addComments(CommentsBlock.new("Menu prototype declaration"))
            ...
            .setProtoBody(ProtoBody.new()
                .addChild(Group.new()
                    .addChild(Transform.new()
                        ...
                        .setTranslation([48, 27, 0].to_java Java::float)
                        ...
                        .addChild(Shape.new()
                            ...
                            .setGeometry(IndexedFaceSet.new()
                                ...
                                .setCoord(Coordinate.new()
                                    .setPoint([25, 36, -0.01, -25, 36, -0.01, -25, -51, -0.01, 25, -51, -0.01].to_java Java::float)
                                )
                            )
                        )
                    )
              ...
              .addComments(CommentsBlock.new("Script to handle selection logic"))
                    .addChild(Script.new()
                        .setDEF("MenuScript")
                        .addField(Field.new()
                            .setName("menuItems")
...
"          }\n"+
"        }")                    )
              .addComments(CommentsBlock.new("ROUTEs to connect everything"))
                    .addChild(ROUTE.new()
...
x3D0.toFileX3D "../data/Menu.new.jruby.x3d"
x3D0.toFileJSON "../data/Menu.new.jruby.x3dj"

        ...
        .addChild(Anchor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(["LOA1_StandAnimation.x3d", "defines a prototype", "for animating a humanoid.", "", "Click this text to see", "InterchangableActorsViaDynamicRouting example."].to_java Java::java.lang.String)
...
x3D0.toFileX3D "../data/LOA1_StandAnimation.new.jruby.x3d"
x3D0.toFileJSON "../data/LOA1_StandAnimation.new.jruby.x3dj"

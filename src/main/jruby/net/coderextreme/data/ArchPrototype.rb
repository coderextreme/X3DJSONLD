...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        .addChild(ProtoDeclare.new()
            ...
            .addComments(CommentsBlock.new("COLOR OF ARCH"))
            .addComments(CommentsBlock.new("INPUT PARAMETERS"))
            .addComments(CommentsBlock.new("General parameters: measures in meters"))
            .addComments(CommentsBlock.new("Parameters to create to create shapes related to arch: put true to apply"))
                .addField(Field.new()
            ...
            .addComments(CommentsBlock.new("IndexedFaceset creates arch"))
                .addChild(Transform.new()
                    .setDEF("ArchTransform")
                    .addChild(Shape.new()
                        .setDEF("Arch")
                .addComments(CommentsBlock.new("note that convex='false' (meaning concave geometry) is crucial for this IFS of a geometric chord to render properly"))
            ...
            .addComments(CommentsBlock.new("This embedded Script provides the X3D author with additional visibility and control over prototype inputs and outputs"))
                .addChild(Script.new()
                    .setDEF("ArchPrototypeScript")
                    .setUrl(["../node/ArchPrototypeScript.js", "https://coderextreme.net/X3DJSONLD/src/main/node/ArchPrototypeScript.js"].to_java Java::java.lang.String)
              .addComments(CommentsBlock.new("INPUT PARAMETERS"))
              .addComments(CommentsBlock.new("General parameters"))
              .addComments(CommentsBlock.new("Parameters to create to create shapes related to arch: put true to apply"))
              .addComments(CommentsBlock.new("OUTPUT PARAMETERS"))
                    .addField(Field.new()
                        .setName("clearSpanWidth")
                        .setAccessType("initializeOnly")
        ...
        .addComments(CommentsBlock.new("Add any ROUTEs here that connect ProtoInstance to/from prior nodes in Scene (and outside of ProtoDeclare)"))
        .addChild(Inline.new()
            .setDEF("CoordinateAxes")
            .setUrl(["../data/CoordinateAxes.x3d"].to_java Java::java.lang.String)
        )
    )
x3D0.toFileX3D "../data/ArchPrototype.new.jruby.x3d"
x3D0.toFileJSON "../data/ArchPrototype.new.jruby.x3dj"

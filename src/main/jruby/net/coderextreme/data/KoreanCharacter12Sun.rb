        ...
        .addChild(HAnimHumanoid.new()
          ...
          .addComments(CommentsBlock.new("original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=female\" \"height=1.5\"'"))
            ...
            .addSkeleton(HAnimJoint.new()
                ...
                .setCenter([0, 29.860001, -0.4567].to_java Java::float)
                ...
                .addChild(HAnimSegment.new()
                    ...
                    .addChild(Transform.new()
                        .setTranslation([0, 29.860001, -0.4567].to_java Java::float)
                        .addChild(Shape.new()
                ...
                .addChild(HAnimJoint.new()
                    .setName("l_hip")
                    .setDEF("hanim_l_hip")
                    .setCenter([2.955, 28.940001, -0.5218].to_java Java::float)
                    .setUlimit([0, 0, 0].to_java Java::float)
                    .setLlimit([0, 0, 0].to_java Java::float)
                    .addChild(HAnimSegment.new()
                        .setName("l_thigh")
                        ...
                        .addChild(Transform.new()
                            .setTranslation([2.955, 28.940001, -0.5218].to_java Java::float)
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("l_knee")
                        .setDEF("hanim_l_knee")
                        .setCenter([2.948, 16.459999, -0.5275].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l_calf")
                            .setDEF("hanim_l_calf")
                            .addChild(Transform.new()
                                .setTranslation([2.948, 16.459999, -0.5275].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([2.839, 3.899, -0.4116].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("l_talus")
                                ...
                                .addChild(Transform.new()
                                    .setTranslation([2.839, 3.899, -0.4116].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([2.839, 3.312, 1.078].to_java Java::float)
                                .setUlimit([0, 0, 0].to_java Java::float)
                                .setLlimit([0, 0, 0].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    ...
                                    .addChild(Transform.new()
                                        .setTranslation([2.839, 3.312, 1.078].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter([6.077, 45.880001, -1.319].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l_upperarm")
                            ...
                            .addChild(Transform.new()
                                .setTranslation([6.077, 45.880001, -1.319].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([7.076, 38.529999, -1.385].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("l_forearm")
                                ...
                                .addChild(Transform.new()
                                    .setTranslation([7.076, 38.529999, -1.385].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([6.946, 30.889999, -1.308].to_java Java::float)
                                .setUlimit([0, 0, 0].to_java Java::float)
                                .setLlimit([0, 0, 0].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    .setName("l_carpal")
                                    ...
                                    .addChild(Transform.new()
                                        .setTranslation([6.946, 30.889999, -1.308].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("vl5")
                        .setDEF("hanim_vl5")
                        .setCenter([0.05249, 34.130001, -0.468].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l5")
                            .setDEF("hanim_l5")
                            .addChild(Transform.new()
                                .setTranslation([0.05249, 34.130001, -0.468].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([0, 51.25, -1.124].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("skull")
                                .setDEF("hanim_skull")
                                .addChild(Transform.new()
                                    .setTranslation([0, 51.25, -1.124].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
...
x3D0.toFileX3D "../data/KoreanCharacter12Sun.new.jruby.x3d"
x3D0.toFileJSON "../data/KoreanCharacter12Sun.new.jruby.x3dj"

...
"      }")        )
        ...
        .addChild(Sound.new()
            ...
            .setSource(AudioClip.new()
                ...
                .setUrl(["../resources/chandubabamusic1.wav"].to_java Java::java.lang.String)
            )
        )
...
x3D0.toFileX3D "../data/JoeExample.new.jruby.x3d"
x3D0.toFileJSON "../data/JoeExample.new.jruby.x3dj"

    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(Transform.new()
                .setTranslation([6.14221, 0.0694613, -0.000999451].to_java Java::float)
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        ...
                        .setTexture(PixelTexture.new()
                            ...
                            .setImage([2, 2, 4, -16776961, -65536, -65536, -16776961].to_java Java::int)
                        )
                    )
                    .setGeometry(Box.new()
                    )
            ...
            .addChild(Transform.new()
                .setTranslation([-4.85443, 0.0694381, -0.00149918].to_java Java::float)
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                        )
            ...
            .addChild(Transform.new()
                .setTranslation([-1.47341, 0.036672, -0.00175095].to_java Java::float)
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                        )
            ...
            .addChild(Transform.new()
                .setTranslation([2.31094, 0.0694206, -0.00187683].to_java Java::float)
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                        )
...
x3D0.toFileX3D "../data/rgb_alpha.new.jruby.x3d"
x3D0.toFileJSON "../data/rgb_alpha.new.jruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setDEF("ModelInfo")
            .setInfo(["Example scene for HAnimPose node"].to_java Java::java.lang.String)
        ...
        .addChild(Group.new()
          ...
          .addComments(CommentsBlock.new("Also tested satisfactorily: KoreanCharacter01Jin KoreanCharacter02Chul KoreanCharacter03Hyun KoreanCharacter04Young KoreanCharacter05Ju KoreanCharacter06Ga KoreanCharacter07No KoreanCharacter08Da KoreanCharacter09Ru KoreanCharacter10Mi KoreanCharacter11Min KoreanCharacter12Sun"))
            .addChild(Inline.new()
                ...
                .setUrl(["../Skin/JoeSkeletonSkinSite.x3d", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Skin/JoeSkeletonSkinSite.x3d"].to_java Java::java.lang.String)
            )
        ...
        .addChild(HAnimPose.new()
            ...
            .setMetadata(MetadataString.new()
                ...
                .setValue(["hello HAnimPose metadata"].to_java Java::java.lang.String)
            )
        ...
        .addChild(HAnimPose.new()
          ...
          .addComments(CommentsBlock.new("not defining any poseJoint HAnimJoint nodes equals the default \"I\" pose"))
        )
        .addChild(HAnimPose.new()
            .setName("H")
            .setDEF("H_Pose")
            ...
            .setLoa(-1)
          .addComments(CommentsBlock.new("TODO define poseJoint HAnimJoint nodes"))
        )
        .addChild(HAnimPose.new()
            .setName("FaceLeft")
...
x3D0.toFileX3D "../data/HAnimPoseExample.new.jruby.x3d"
x3D0.toFileJSON "../data/HAnimPoseExample.new.jruby.x3dj"

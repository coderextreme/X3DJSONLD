          ...
          .addComments(CommentsBlock.new("the second layer contains the sliders that are moved with the user's display like a HUD (heads up display)"))
            ...
            .addComments(CommentsBlock.new("basic nodes, which might be present in any scene"))
                .addChild(NavigationInfo.new()
                    .setType(["EXAMINE", "FLY", "LOOKAT", "ANY"].to_java Java::java.lang.String)
            ...
            .addComments(CommentsBlock.new("the model that is being reviewed by the users of this scene"))
              ...
              .addComments(CommentsBlock.new("Images courtesy of Paul Debevec's Light Probe Image Gallery"))
                  ...
                  .addComments(CommentsBlock.new("<IndexedFaceSet convex=\"false\" DEF=\"Orbit\" creaseAngle=\"0\"> <Coordinate DEF=\"OrbitCoordinates\"/> </IndexedFaceSet>"))
                            .setAppearance(Appearance.new()
                                .setMaterial(Material.new()
                    ...
                    .addComments(CommentsBlock.new("<ComposedShader DEF=\"freewrlShader\" language=\"GLSL\"> <field name='fw_textureCoordGenType' accessType='inputOutput' type='SFInt32' value='0'></field> <field name='chromaticDispertion' accessType='initializeOnly' type='SFVec3f' value='0.98 1.0 1.033'></field> <field name='bias' type='SFFloat' accessType='inputOutput' value='0.5'></field> <field name='scale' type='SFFloat' accessType='inputOutput' value='0.5'></field> <field name='power' type='SFFloat' accessType='inputOutput' value='2'></field> <field name='a' type='SFFloat' accessType='inputOutput' value='15'></field> <field name='b' type='SFFloat' accessType='inputOutput' value='5'></field> <field name='c' type='SFFloat' accessType='inputOutput' value='20'></field> <field name='d' type='SFFloat' accessType='inputOutput' value='20'></field> <field name='tdelta' type='SFFloat' accessType='inputOutput' value='0'></field> <field name='pdelta' type='SFFloat' accessType='inputOutput' value='0'></field> <ShaderPart type='VERTEX'> <IS> <connect nodeField=\"url\" protoField=\"vertex\"/> </IS> </ShaderPart> <ShaderPart type='FRAGMENT'> <IS> <connect nodeField=\"url\" protoField=\"fragment\"/> </IS> </ShaderPart> </ComposedShader>"))
                            )
                        )
                    )
                )
                            ...
                            .addChild(Transform.new()
                                ...
                                .addChild(Transform.new()
                                    ...
                                    .addChild(PlaneSensor.new()
                                        .setDEF("protoSensor")
                                        .setMaxPosition([2, 0].to_java Java::float)
                                    )
                                    .addChild(Transform.new()
...
"	};")                            )
                ...
                .setLayout(Layout.new()
                    ...
                    .setOffset([-0.5, 0].to_java Java::float)
                )
...
x3D0.toFileX3D "../data/bumpyfreewrlsliders.new.jruby.x3d"
x3D0.toFileJSON "../data/bumpyfreewrlsliders.new.jruby.x3dj"

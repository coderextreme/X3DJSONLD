...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        .addMeta(Meta.new()
            .setName("title")
            .setContent("HelloWorldCommented.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("Numerous comments added to simple X3D scene example for testing JSON encoding alternatives.")
        )
        .addMeta(Meta.new()
            .setName("created")
            .setContent("19 December 2015")
        )
        .addMeta(Meta.new()
            .setName("modified")
        ...
        .addMeta(Meta.new()
            .setName("info")
            .setContent("HelloWorldCommented.json is most current, HelloWorldCommentedOriginalEncoding.json and HelloWorldCommentedAlternativeEncoding.json were experimental.")
        )
        .addMeta(Meta.new()
            .setName("reference")
            .setContent("HelloWorldCommented.json")
        )
        .addMeta(Meta.new()
            .setName("reference")
            .setContent("HelloWorldCommentedOriginalEncoding.json")
        )
        .addMeta(Meta.new()
            .setName("reference")
            .setContent("HelloWorldCommentedAlternativeEncoding.json")
        )
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://x3dgraphics.com/examples/X3dForAdvancedModeling/HelloWorldScenes/HelloWorldCommented.x3d")
        )
        .addMeta(Meta.new()
            .setName("license")
    ...
    .setScene(Scene.new()
        .addComments(CommentsBlock.new("Example scene to illustrate comments interspersed among X3D nodes and fields (XML elements and attributes)"))
        .addComments(CommentsBlock.new("WorldInfo begin"))
        .addChild(WorldInfo.new()
            .setTitle("Hello world!")
        )
        .addComments(CommentsBlock.new("WorldInfo complete, Group begin"))
        .addChild(Group.new()
          .addComments(CommentsBlock.new("Viewpoint begin"))
            .addChild(Viewpoint.new()
                .setDEF("ViewUpClose")
                .setCenterOfRotation([0, -1, 0].to_java Java::float)
                .setDescription("Hello world!")
                .setPosition([0, -1, 7].to_java Java::float)
            )
          .addComments(CommentsBlock.new("Viewpoint complete, Transform begin"))
            .addChild(Transform.new()
                .setRotation([0, 1, 0, 3].to_java Java::float)
            .addComments(CommentsBlock.new("Shape begin"))
                .addChild(Shape.new()
              .addComments(CommentsBlock.new("Sphere begin"))
              .addComments(CommentsBlock.new("Sphere complete, Appearance begin"))
              .addComments(CommentsBlock.new("Appearance complete"))
                    .setGeometry(Sphere.new()
                    )
                    .setAppearance(Appearance.new()
                .addComments(CommentsBlock.new("Material begin"))
                .addComments(CommentsBlock.new("Material complete, ImageTexture begin"))
                .addComments(CommentsBlock.new("ImageTexture complete"))
                        .setMaterial(Material.new()
                            .setDEF("MaterialLightBlue")
                            .setDiffuseColor([0.1, 0.5, 1].to_java Java::float)
                        )
                        .setTexture(ImageTexture.new()
                            .setDEF("ImageCloudlessEarth")
                            .setUrl(["earth-topo.png", "earth-topo.jpg", "earth-topo-small.gif", "https://www.web3d.org/x3d/content/examples/Basic/earth-topo.png", "https://www.web3d.org/x3d/content/examples/Basic/earth-topo.jpg", "https://www.web3d.org/x3d/content/examples/Basic/earth-topo-small.gif"].to_java Java::java.lang.String)
                        )
                    )
                )
            .addComments(CommentsBlock.new("Shape complete"))
            )
          .addComments(CommentsBlock.new("Transform complete, Transform begin"))
            .addChild(Transform.new()
                .setTranslation([0, -2, 0].to_java Java::float)
            .addComments(CommentsBlock.new("Shape begin"))
                .addChild(Shape.new()
              .addComments(CommentsBlock.new("Text begin"))
              .addComments(CommentsBlock.new("Text complete, Appearance begin"))
              .addComments(CommentsBlock.new("Appearance complete"))
                    .setGeometry(Text.new()
                        .setDEF("TextMessage")
                        .setString(["Hello", "world!"].to_java Java::java.lang.String)
                .addComments(CommentsBlock.new("FontStyle begin"))
                .addComments(CommentsBlock.new("FontStyle complete"))
                    ...
                    .setAppearance(Appearance.new()
                .addComments(CommentsBlock.new("Material begin"))
                .addComments(CommentsBlock.new("Material complete"))
                        .setMaterial(Material.new()
          ...
          .addComments(CommentsBlock.new("Transform complete"))
        )
        .addComments(CommentsBlock.new("Group complete"))
    )
x3D0.toFileX3D "../data/HelloWorldCommented.new.jruby.x3d"
x3D0.toFileJSON "../data/HelloWorldCommented.new.jruby.json"

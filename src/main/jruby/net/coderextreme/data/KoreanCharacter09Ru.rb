...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("title")
            .setContent("KoreanCharacter09Ru.x3d")
        )
        .addMeta(Meta.new()
            .setName("creator")
    ...
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("KoreanCharacter09Ru.x3d")
        )
        ...
        .addChild(HAnimHumanoid.new()
          ...
          .addComments(CommentsBlock.new("original HAnimHumanoid info='\"authorName=Chul Hee Jung and Myeong Won Lee\" \"authorEmail=myeongwonlee@gmail.com\" \"creationDate=31 March 2011\" \"humanoidVersion=2.0\" \"gender=male\" \"height=1.5\"'"))
            ...
            .addSkeleton(HAnimJoint.new()
                ...
                .setCenter([0, 35.950001, -1.712].to_java Java::float)
                ...
                .addChild(HAnimSegment.new()
                    ...
                    .addChild(Transform.new()
                        .setTranslation([0, 35.950001, -1.712].to_java Java::float)
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                ...
                                .setTexture(ImageTexture.new()
                                    .setDEF("RuTextureAtlas")
                                    .setUrl(["images/Ru.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Characters/images/Ru.png"].to_java Java::java.lang.String)
                                )
                            )
                            .setGeometry(IndexedFaceSet.new()
                                .setCoordIndex([0, 1, 2, -1, 0, 2, 3, -1, 0, 3, 4, -1, 0, 4, 5, -1, 0, 5, 6, -1, 0, 6, 7, -1, 0, 7, 8, -1, 0, 8, 1, -1, 10, 2, 1, -1, 1, 9, 10, -1, 11, 3, 2, -1, 2, 10, 11, -1, 12, 4, 3, -1, 3, 11, 12, -1, 13, 5, 4, -1, 4, 12, 13, -1, 14, 6, 5, -1, 5, 13, 14, -1, 15, 7, 6, -1, 6, 14, 15, -1, 16, 8, 7, -1, 7, 15, 16, -1, 9, 1, 8, -1, 8, 16, 9, -1, 18, 10, 9, -1, 9, 17, 18, -1, 19, 11, 10, -1, 10, 18, 19, -1, 20, 12, 11, -1, 11, 19, 20, -1, 21, 13, 12, -1, 12, 20, 21, -1, 22, 14, 13, -1, 13, 21, 22, -1, 23, 15, 14, -1, 14, 22, 23, -1, 24, 16, 15, -1, 15, 23, 24, -1, 17, 9, 16, -1, 16, 24, 17, -1, 25, 18, 17, -1, 25, 19, 18, -1, 25, 20, 19, -1, 25, 21, 20, -1, 25, 22, 21, -1, 25, 23, 22, -1, 25, 24, 23, -1, 25, 17, 24, -1].to_java Java::int)
                                .setCreaseAngle(1.57)
                                .setTexCoordIndex([0, 8, 9, -1, 1, 9, 10, -1, 2, 10, 11, -1, 3, 11, 12, -1, 4, 12, 13, -1, 5, 13, 14, -1, 6, 14, 15, -1, 7, 15, 16, -1, 18, 9, 8, -1, 8, 17, 18, -1, 19, 10, 9, -1, 9, 18, 19, -1, 20, 11, 10, -1, 10, 19, 20, -1, 21, 12, 11, -1, 11, 20, 21, -1, 22, 13, 12, -1, 12, 21, 22, -1, 23, 14, 13, -1, 13, 22, 23, -1, 24, 15, 14, -1, 14, 23, 24, -1, 25, 16, 15, -1, 15, 24, 25, -1, 27, 18, 17, -1, 17, 26, 27, -1, 28, 19, 18, -1, 18, 27, 28, -1, 29, 20, 19, -1, 19, 28, 29, -1, 30, 21, 20, -1, 20, 29, 30, -1, 31, 22, 21, -1, 21, 30, 31, -1, 32, 23, 22, -1, 22, 31, 32, -1, 33, 24, 23, -1, 23, 32, 33, -1, 34, 25, 24, -1, 24, 33, 34, -1, 35, 27, 26, -1, 36, 28, 27, -1, 37, 29, 28, -1, 38, 30, 29, -1, 39, 31, 30, -1, 40, 32, 31, -1, 41, 33, 32, -1, 42, 34, 33, -1].to_java Java::int)
                                .setCoord(Coordinate.new()
                                    .setPoint([0, 1.234, 0, 0, 0.8727, -0.8727, -0.6171, 0.8727, -0.6171, -0.8727, 0.8727, 0, -0.6171, 0.8727, 0.6171, 0, 0.8727, 0.8727, 0.6171, 0.8727, 0.6171, 0.8727, 0.8727, 0, 0.6171, 0.8727, -0.6171, 0, 0, -1.234, -0.8727, 0, -0.8727, -1.234, 0, 0, -0.8727, 0, 0.8727, 0, 0, 1.234, 0.8727, 0, 0.8727, 1.234, 0, 0, 0.8727, 0, -0.8727, 0, -0.8727, -0.8727, -0.6171, -0.8727, -0.6171, -0.8727, -0.8727, 0, -0.6171, -0.8727, 0.6171, 0, -0.8727, 0.8727, 0.6171, -0.8727, 0.6171, 0.8727, -0.8727, 0, 0.6171, -0.8727, -0.6171, 0, -1.234, 0].to_java Java::float)
                                )
                                .setTexCoord(TextureCoordinate.new()
                                    .setPoint([0.7928, 0.4648, 0.8105, 0.4648, 0.8282, 0.4648, 0.8458, 0.4648, 0.8635, 0.4648, 0.8811, 0.4648, 0.8988, 0.4648, 0.9165, 0.4648, 0.7928, 0.4295, 0.8105, 0.4295, 0.8282, 0.4295, 0.8458, 0.4295, 0.8635, 0.4295, 0.8811, 0.4295, 0.8988, 0.4295, 0.9165, 0.4295, 0.9341, 0.4295, 0.7928, 0.3942, 0.8105, 0.3942, 0.8282, 0.3942, 0.8458, 0.3942, 0.8635, 0.3942, 0.8811, 0.3942, 0.8988, 0.3942, 0.9165, 0.3942, 0.9341, 0.3942, 0.7928, 0.3589, 0.8105, 0.3589, 0.8282, 0.3589, 0.8458, 0.3589, 0.8635, 0.3589, 0.8811, 0.3589, 0.8988, 0.3589, 0.9165, 0.3589, 0.9341, 0.3589, 0.7928, 0.3235, 0.8105, 0.3235, 0.8282, 0.3235, 0.8458, 0.3235, 0.8635, 0.3235, 0.8811, 0.3235, 0.8988, 0.3235].to_java Java::float)
                                )
                            )
                        )
                    )
                ...
                .addChild(HAnimJoint.new()
                    .setName("l_hip")
                    .setDEF("hanim_l_hip")
                    .setCenter([3.602, 33.740002, -1.967].to_java Java::float)
                    .setUlimit([0, 0, 0].to_java Java::float)
                    .setLlimit([0, 0, 0].to_java Java::float)
                    .addChild(HAnimSegment.new()
                        .setName("l_thigh")
                        ...
                        .addChild(Transform.new()
                            .setTranslation([3.602, 33.740002, -1.967].to_java Java::float)
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("l_knee")
                        .setDEF("hanim_l_knee")
                        .setCenter([3.931, 18.23, -1.935].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                .addComments(CommentsBlock.new("weight values go here in HAnimJoint, or within animating HAnimDisplacer"))
                        .addChild(HAnimSegment.new()
                            .setName("l_calf")
                            .setDEF("hanim_l_calf")
                            .addChild(Transform.new()
                                .setTranslation([3.931, 18.23, -1.935].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([4.077, 4.031, -1.998].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("l_talus")
                                ...
                                .addChild(Transform.new()
                                    .setTranslation([4.077, 4.031, -1.998].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([4.077, 3.104, -0.9239].to_java Java::float)
                                .setUlimit([0, 0, 0].to_java Java::float)
                                .setLlimit([0, 0, 0].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    ...
                                    .addChild(Transform.new()
                                        .setTranslation([4.077, 3.104, -0.9239].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                            ...
                                            .setGeometry(IndexedFaceSet.new()
                                                ...
                                                .setTexCoord(TextureCoordinate.new()
                                                    .setPoint([0.8363, 0.2274, 0.8605, 0.2295, 0.8399, 0.2422, 0.8699, 0.2396, 0.8551, 0.2481, 0.8603, 0.2295, 0.84, 0.2422, 0.852, 0.0874, 0.8536, 0.1039, 0.8299, 0.1039, 0.8299, 0.1039, 0.9432, 0.2103, 0.9472, 0.2203, 0.9665, 0.2076, 0.948, 0.2019, 0.9418, 0.2099, 0.948, 0.2019, 0.8363, 0.2002, 0.86, 0.2002, 0.9605, 0.1109, 0.9438, 0.1056, 0.9438, 0.1056, 0.8956, 0.2323, 0.8898, 0.2227, 0.8898, 0.2227, 0.8536, 0.1039, 0.8839, 0.0983, 0.8823, 0.0818, 0.8839, 0.0983, 0.86, 0.2002, 0.8902, 0.1946, 0.8902, 0.1946, 0.9211, 0.2215, 0.9191, 0.2126, 0.9212, 0.1946, 0.9189, 0.2126, 0.9212, 0.1946, 0.9185, 0.0988, 0.9169, 0.0823, 0.9185, 0.0988, 0.8362, 0.2274, 0.8363, 0.2002, 0.8299, 0.1039, 0.8091, 0.2395, 0.8062, 0.2288, 0.8075, 0.2052, 0.8079, 0.2025, 0.8079, 0.2025, 0.8079, 0.2025, 0.8075, 0.2052, 0.8062, 0.2288, 0.8091, 0.2395, 0.8239, 0.2437, 0.852, 0.0874, 0.8284, 0.0874, 0.8284, 0.0874, 0.9589, 0.0944, 0.9422, 0.0891, 0.9422, 0.0891, 0.852, 0.0874, 0.8823, 0.0818, 0.8823, 0.0818, 0.9169, 0.0823, 0.9169, 0.0823, 0.8284, 0.0874, 0.9602, 0.1187, 0.9416, 0.113, 0.9416, 0.113, 0.8299, 0.1114, 0.8536, 0.1114, 0.8536, 0.1114, 0.8839, 0.1057, 0.8839, 0.1057, 0.9149, 0.1058, 0.9149, 0.1058, 0.8299, 0.1114, 0.8011, 0.1163, 0.8015, 0.1136, 0.8015, 0.1136, 0.8015, 0.1136, 0.8011, 0.1163].to_java Java::float)
                                                )
                                            )
                                        )
                                    )
                        ...
                        .addChild(HAnimSegment.new()
                            ...
                            .addChild(Transform.new()
                                ...
                                .addChild(Shape.new()
                                    ...
                                    .setGeometry(IndexedFaceSet.new()
                                        .setCoordIndex([32, 0, 1, -1, 1, 38, 32, -1, 33, 2, 0, -1, 0, 32, 33, -1, 34, 3, 14, -1, 14, 39, 34, -1, 35, 4, 3, -1, 3, 34, 35, -1, 5, 4, 35, -1, 35, 36, 5, -1, 6, 5, 36, -1, 36, 37, 6, -1, 1, 6, 37, -1, 37, 38, 1, -1, 24, 25, 8, -1, 8, 7, 24, -1, 26, 9, 8, -1, 8, 25, 26, -1, 15, 31, 27, -1, 27, 10, 15, -1, 11, 10, 27, -1, 27, 28, 11, -1, 12, 11, 28, -1, 28, 29, 12, -1, 13, 12, 29, -1, 29, 30, 13, -1, 24, 7, 13, -1, 13, 30, 24, -1, 9, 15, 20, -1, 20, 18, 9, -1, 31, 15, 9, -1, 9, 26, 31, -1, 8, 16, 17, -1, 17, 7, 8, -1, 9, 18, 16, -1, 16, 8, 9, -1, 19, 20, 15, -1, 15, 10, 19, -1, 21, 19, 10, -1, 10, 11, 21, -1, 22, 21, 11, -1, 11, 12, 22, -1, 23, 22, 12, -1, 12, 13, 23, -1, 7, 17, 23, -1, 23, 13, 7, -1, 33, 18, 20, -1, 20, 39, 33, -1, 16, 32, 38, -1, 38, 17, 16, -1, 18, 33, 32, -1, 32, 16, 18, -1, 19, 34, 39, -1, 39, 20, 19, -1, 35, 34, 19, -1, 19, 21, 35, -1, 36, 35, 21, -1, 21, 22, 36, -1, 37, 36, 22, -1, 22, 23, 37, -1, 38, 37, 23, -1, 23, 17, 38, -1, 2, 33, 39, -1, 39, 14, 2, -1, 24, 40, 25, -1, 25, 40, 26, -1, 26, 40, 31, -1, 31, 40, 27, -1, 27, 40, 28, -1, 28, 40, 29, -1, 29, 40, 30, -1, 30, 40, 24, -1, 0, 41, 1, -1, 1, 41, 6, -1, 6, 41, 5, -1, 5, 41, 4, -1, 4, 41, 3, -1, 3, 41, 14, -1, 14, 41, 2, -1, 2, 41, 0, -1].to_java Java::int)
                                        .setCreaseAngle(1.57)
                                        .setTexCoordIndex([1, 0, 3, -1, 3, 2, 1, -1, 5, 4, 0, -1, 0, 1, 5, -1, 7, 6, 9, -1, 9, 8, 7, -1, 11, 10, 42, -1, 42, 43, 11, -1, 12, 10, 11, -1, 11, 13, 12, -1, 14, 12, 13, -1, 13, 15, 14, -1, 3, 14, 15, -1, 15, 2, 3, -1, 18, 17, 16, -1, 16, 19, 18, -1, 21, 20, 16, -1, 16, 17, 21, -1, 24, 23, 22, -1, 22, 25, 24, -1, 26, 45, 44, -1, 44, 27, 26, -1, 28, 26, 27, -1, 27, 29, 28, -1, 30, 28, 29, -1, 29, 31, 30, -1, 18, 19, 30, -1, 30, 31, 18, -1, 20, 24, 33, -1, 33, 32, 20, -1, 23, 24, 20, -1, 20, 21, 23, -1, 16, 34, 35, -1, 35, 19, 16, -1, 20, 32, 34, -1, 34, 16, 20, -1, 36, 33, 24, -1, 24, 25, 36, -1, 37, 46, 45, -1, 45, 26, 37, -1, 38, 37, 26, -1, 26, 28, 38, -1, 39, 38, 28, -1, 28, 30, 39, -1, 19, 35, 39, -1, 39, 30, 19, -1, 5, 32, 33, -1, 33, 8, 5, -1, 34, 1, 2, -1, 2, 35, 34, -1, 32, 5, 1, -1, 1, 34, 32, -1, 36, 7, 8, -1, 8, 33, 36, -1, 11, 43, 46, -1, 46, 37, 11, -1, 13, 11, 37, -1, 37, 38, 13, -1, 15, 13, 38, -1, 38, 39, 15, -1, 2, 15, 39, -1, 39, 35, 2, -1, 4, 5, 8, -1, 8, 9, 4, -1, 18, 40, 17, -1, 17, 40, 21, -1, 21, 40, 23, -1, 23, 40, 22, -1, 44, 40, 27, -1, 27, 40, 29, -1, 29, 40, 31, -1, 31, 40, 18, -1, 0, 41, 3, -1, 3, 41, 14, -1, 14, 41, 12, -1, 12, 41, 10, -1, 10, 41, 42, -1, 6, 41, 9, -1, 9, 41, 4, -1, 4, 41, 0, -1].to_java Java::int)
                                        .setCoord(Coordinate.new()
                                            .setPoint([-1.182, -14.56, -1.091, -1.553, -14.56, -0.1072, 0.017, -14.56, -1.525, 1.457, -14.56, 0.0005, 1.094, -14.56, 1.145, 0.0351, -14.56, 1.587, -1.152, -14.56, 1.015, -2.207, -0.1521, -0.0163, -1.741, -0.1513, -1.643, -0.0996, -0.1509, -2.309, 2.273, -0.1521, -0.0254, 1.777, -0.153, 1.747, -0.0533, -0.1533, 2.309, -1.78, -0.153, 1.71, 1.127, -14.56, -1.093, 1.751, -0.1513, -1.552, -1.478, -6.77, -1.405, -2.057, -6.579, 0.0221, -0.0355, -7.09, -2.115, 2.021, -7.528, -0.1026, 1.592, -7.4, -1.399, 1.559, -7.392, 1.458, -0.0464, -7.091, 2.044, -1.588, -6.828, 1.431, -2.162, 0.6392, -0.0205, -1.659, 0.6662, -1.561, -0.1032, 0.6473, -2.279, 2.22, 0.6402, 0.0258, 1.673, 0.6576, 1.57, -0.0642, 0.6305, 2.263, -1.651, 0.6333, 1.643, 1.706, 0.6436, -1.513, -1.251, -13.99, -1.252, 0.0065, -13.99, -1.806, 1.765, -13.99, -0.0246, 1.337, -13.99, 1.25, 0.0302, -13.99, 1.876, -1.35, -13.99, 1.226, -1.865, -13.99, -0.0781, 1.425, -13.99, -1.381, -0.0589, 1.002, 0.1259, -0.0075, -14.75, -0.0616].to_java Java::float)
                                        )
                                        .setTexCoord(TextureCoordinate.new()
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .setCenter([0, 32.209999, -2.058].to_java Java::float)
                    .setUlimit([0, 0, 0].to_java Java::float)
                    .setLlimit([0, 0, 0].to_java Java::float)
                    .addChild(HAnimSegment.new()
                        .setName("pelvis")
                        .setDEF("hanim_pelvis")
                        .addChild(Transform.new()
                            .setTranslation([0, 32.209999, -2.058].to_java Java::float)
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .setCenter([6.479, 53.209999, -2.007].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l_upperarm")
                            ...
                            .addChild(Transform.new()
                                .setTranslation([6.479, 53.209999, -2.007].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([7.489, 44.990002, -2.016].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("l_forearm")
                                ...
                                .addChild(Transform.new()
                                    .setTranslation([7.489, 44.990002, -2.016].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([7.938, 35.98, -1.856].to_java Java::float)
                                .setUlimit([0, 0, 0].to_java Java::float)
                                .setLlimit([0, 0, 0].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    .setName("l_carpal")
                                    ...
                                    .addChild(Transform.new()
                                        .setTranslation([7.938, 35.98, -1.856].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("vl5")
                        .setDEF("hanim_vl5")
                        .setCenter([0, 38.25, -1.903].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l5")
                            .setDEF("hanim_l5")
                            .addChild(Transform.new()
                                .setTranslation([0, 38.25, -1.903].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([0, 58.450001, -1.829].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("skull")
                                .setDEF("hanim_skull")
                                .addChild(Transform.new()
                                    .setTranslation([0, 58.450001, -1.829].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
...
x3D0.toFileX3D "../data/KoreanCharacter09Ru.new.jruby.x3d"
x3D0.toFileJSON "../data/KoreanCharacter09Ru.new.jruby.x3dj"

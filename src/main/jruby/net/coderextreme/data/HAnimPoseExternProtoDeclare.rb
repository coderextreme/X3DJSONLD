...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor([0.6, 0.6, 0.8].to_java Java::float)
        )
        ...
        .addChild(ExternProtoDeclare.new()
            ...
            .setUrl(["Filename.x3d#HAnimPose", "https://some.address.org/Filename.x3d#HAnimPose"].to_java Java::java.lang.String)
            .addField(Field.new()
        ...
        .addChild(Transform.new()
            ...
            .addChild(Anchor.new()
                ...
                .setUrl(["https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Poses/HAnimPoseExternProtoDeclareIndex.html"].to_java Java::java.lang.String)
                .addChild(Shape.new()
                    .setGeometry(Text.new()
                        .setString(["Utility scene", "HAnimPoseExternProtoDeclare.x3d"].to_java Java::java.lang.String)
                    ...
                    .setAppearance(Appearance.new()
                        ...
                        .setMaterial(Material.new()
                            .setDiffuseColor([0.1, 0.3, 0.5].to_java Java::float)
                        )
                    )
                )
                .addChild(Shape.new()
                    .setGeometry(Box.new()
                        .setSize([3.5, 0.5, 0.001].to_java Java::float)
                    )
                    .setAppearance(Appearance.new()
        ...
        .addChild(Transform.new()
            ...
            .addChild(Anchor.new()
                ...
                .setParameter(["target=_blank"].to_java Java::java.lang.String)
                .setUrl(["https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Poses/HAnimPosePrototypeIndex.html"].to_java Java::java.lang.String)
                .addChild(Shape.new()
                    .setGeometry(Text.new()
                        .setString(["This model supports", "HAnimPosePrototype.x3d"].to_java Java::java.lang.String)
                        .setFontStyle(FontStyle.new()
                            .setUSE("HeaderFont")
                        )
                    )
            ...
            .addChild(Shape.new()
                .setGeometry(Box.new()
                    .setSize([2.6, 0.5, 0.001].to_java Java::float)
                )
                .setAppearance(Appearance.new()
...
x3D0.toFileX3D "../data/HAnimPoseExternProtoDeclare.new.jruby.x3d"
x3D0.toFileJSON "../data/HAnimPoseExternProtoDeclare.new.jruby.x3dj"

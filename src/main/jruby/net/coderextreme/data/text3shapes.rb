...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        .addChild(Transform.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(["Node2", "\\\\\\\\\\\\Node2"].to_java Java::java.lang.String)
                    .setFontStyle(FontStyle.new()
                    )
                )
                .setAppearance(Appearance.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(["Node3 \\\\\\\\ \\\\ Node3\"\"\""].to_java Java::java.lang.String)
                    .setFontStyle(FontStyle.new()
                    )
                )
                .setAppearance(Appearance.new()
...
x3D0.toFileX3D "../data/text3shapes.new.jruby.x3d"
x3D0.toFileJSON "../data/text3shapes.new.jruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            ...
            .setTranslation([10, 10, 0].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                    )
                    .setTexture(ImageTexture.new()
                        .setUrl(["images/WinterAndSpring.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WinterAndSpring.png"].to_java Java::java.lang.String)
                    )
                )
                .setGeometry(Box.new()
...
x3D0.toFileX3D "../data/WinterAndSpringTitleBox.new.jruby.x3d"
x3D0.toFileJSON "../data/WinterAndSpringTitleBox.new.jruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        .addMeta(Meta.new()
            .setName("generator")
            .setContent("hand conversion from http://www.x3dom.org/x3dom/test/functional/flipper.html")
        )
        .addMeta(Meta.new()
            .setName("title")
            .setContent("flipp.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("flipper flopping around")
        )
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("http://www.x3dom.org/x3dom/test/functional/flipp.x3d")
        )
        .addMeta(Meta.new()
            .setName("creator")
            .setContent("Yvonne Jung, metadata by John Carlson")
        )
        .addMeta(Meta.new()
            .setName("translated")
    ...
    .setScene(Scene.new()
        .addChild(Viewpoint.new()
            .setDEF("cam0")
            .setDescription("cam0 description")
            .setPosition([0, 0, 800].to_java Java::float)
        )
        .addChild(Viewpoint.new()
            .setDEF("cam1")
            .setDescription("cam1 description")
            .setPosition([0, 0, 2000].to_java Java::float)
        )
        .addChild(Viewpoint.new()
            .setDEF("cam2")
            .setDescription("cam2 description")
            .setPosition([0, 200, 1000].to_java Java::float)
        )
        .addChild(Background.new()
            .setGroundAngle([0.9, 1.5, 1.57].to_java Java::float)
            .setGroundColor([0.21, 0.18, 0.66, 0.2, 0.44, 0.85, 0.51, 0.81, 0.95, 0.51, 0.81, 0.95].to_java Java::float)
            .setSkyAngle([0.9, 1.5, 1.57].to_java Java::float)
            .setSkyColor([0.21, 0.18, 0.66, 0.2, 0.44, 0.85, 0.51, 0.81, 0.95, 0.51, 0.81, 0.95].to_java Java::float)
        )
...
x3D0.toFileX3D "../data/flipp.new.jruby.x3d"
x3D0.toFileJSON "../data/flipp.new.jruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        .addMeta(Meta.new()
            .setName("title")
            .setContent("WinterAndSpringMusicCreditAllTitleBox.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("Credits for scene musics clips.")
        )
        .addMeta(Meta.new()
            .setName("creator")
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringMusicCreditAllTitleBox.x3d")
        )
    )
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("WinterAndSpringMusicCreditAllTitleBox.x3d")
        )
        .addChild(Viewpoint.new()
            .setDEF("WSAuthorsAllTitleView")
            .setDescription("Look at Music Credit title")
            .setPosition([10, 11, -15].to_java Java::float)
            .setOrientation([-0.15, 0, 0, 0.2].to_java Java::float)
        )
        .addChild(Transform.new()
            .setDEF("WSMusicCreditAllTitle")
            .setTranslation([10, 10, -20].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                    )
                    .setTexture(ImageTexture.new()
                        .setUrl(["images/WSMusicCreditAll.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSMusicCreditAll.png"].to_java Java::java.lang.String)
                    )
                )
                .setGeometry(Box.new()
                    .setSize([4, 3, 0.25].to_java Java::float)
                )
            )
        )
    )
x3D0.toFileX3D "../data/WinterSpringMusicCreditAllTitleBox.new.jruby.x3d"
x3D0.toFileJSON "../data/WinterSpringMusicCreditAllTitleBox.new.jruby.x3dj"

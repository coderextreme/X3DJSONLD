...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        .addMeta(Meta.new()
            .setName("title")
            .setContent("WinterAndSpringDedicationAllTitleBox.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("Credits for scene dedications.")
        )
        .addMeta(Meta.new()
            .setName("creator")
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringDedicationAllTitleBox.x3d")
        )
    )
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("WinterAndSpringDedicationAllTitleBox.x3d")
        )
        .addChild(Viewpoint.new()
            .setDEF("WSDedicationAllTitleView")
            .setDescription("Look at Dedication title")
            .setPosition([10, 11, -5].to_java Java::float)
            .setOrientation([-0.15, 0, 0, 0.2].to_java Java::float)
        )
        .addChild(Transform.new()
            .setDEF("WSDedicationAllTitle")
            .setTranslation([10, 10, -10].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                    )
                    .setTexture(ImageTexture.new()
                        .setUrl(["images/WSDedicationAll.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSDedicationAll.png"].to_java Java::java.lang.String)
                    )
                )
                .setGeometry(Box.new()
...
x3D0.toFileX3D "../data/WinterSpringDedicationAllTitleBox.new.jruby.x3d"
x3D0.toFileJSON "../data/WinterSpringDedicationAllTitleBox.new.jruby.x3dj"

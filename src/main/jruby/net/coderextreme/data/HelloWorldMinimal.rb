...
x3D0 = X3D.new
    ...
    .setVersion("4.0")
      .addComments(CommentsBlock.new("All head/meta tags are optional, WorldInfo is also optional"))
      .addComments(CommentsBlock.new("Text node not supported by X3D Interchange profile, use Immersive profile or Text component level 1"))
    .setHead(Head.new()
        .addMeta(Meta.new()
            .setName("title")
...
x3D0.toFileX3D "../data/HelloWorldMinimal.new.jruby.x3d"
x3D0.toFileJSON "../data/HelloWorldMinimal.new.jruby.x3dj"

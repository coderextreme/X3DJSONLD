...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://coderextreme.net/X3DJSONLD/src/main/data/flower.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("a flower")
    ...
    .setScene(Scene.new()
        ...
        .addChild(DirectionalLight.new()
            .setDirection([0, -0.8, -0.2].to_java Java::float)
            .setIntensity(0.5)
        )
        ...
        .addChild(Viewpoint.new()
            ...
            .setPosition([0, 0, 50].to_java Java::float)
        )
        .addChild(Transform.new()
            .setTranslation([0, -1, 1].to_java Java::float)
            .setRotation([0, 1, 0, 3.1415926].to_java Java::float)
            .setScale([1.5, 1.5, 1.5].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setTransparency(0.1)
                        .setDiffuseColor([0.9, 0.3, 0.3].to_java Java::float)
                        .setSpecularColor([0.8, 0.8, 0.8].to_java Java::float)
                        .setShininess(0.145)
                    )
                )
                .setGeometry(IndexedFaceSet.new()
                    .setCcw(false)
                    .setConvex(false)
                    .setCoordIndex([0, 1, 2, -1].to_java Java::int)
                    .setDEF("Orbit")
                    .setCoord(Coordinate.new()
                        .setDEF("OrbitCoordinates")
                        .setPoint([0, 0, 1, 0, 1, 0, 1, 0, 0].to_java Java::float)
                    )
                )
            )
        )
        .addChild(Script.new()
          ...
          .addComments(CommentsBlock.new("<field accessType=\"inputOutput\" name=\"resolution\" type=\"SFInt32\" value=\"150\"/>"))
...
x3D0.toFileX3D "../data/flower.new.jruby.x3d"
x3D0.toFileJSON "../data/flower.new.jruby.x3dj"

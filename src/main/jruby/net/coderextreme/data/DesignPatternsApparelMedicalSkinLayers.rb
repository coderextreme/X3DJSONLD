...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor([0, 0.6, 0.6].to_java Java::float)
        )
        .addChild(Group.new()
            ...
            .setMetadata(MetadataString.new()
                ...
                .setValue(["E.4 Multiple humanoids per file"].to_java Java::java.lang.String)
            )
        ...
        .addChild(Anchor.new()
            ...
            .setParameter(["target=blank"].to_java Java::java.lang.String)
            .setUrl(["https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Skin/DesignPatternsApparelMedicalSkinLayersIndex.html"].to_java Java::java.lang.String)
            .addChild(Shape.new()
            .addComments(CommentsBlock.new("TODO adjust Text string and Box size, then set Material transparency='1'"))
                .setGeometry(Text.new()
                    .setString(["DesignPatternsApparelMedicalSkinLayers.x3d", "", "explores potential apparel approaches"].to_java Java::java.lang.String)
            ...
            .addComments(CommentsBlock.new("Author TODO: to adjust transparent Box as text-selection assist, set width and height to match size, then set transparency='1' to make invisible."))
                .setGeometry(Box.new()
                    .setSize([11, 2, 0.001].to_java Java::float)
                )
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setTransparency(1.0)
...
x3D0.toFileX3D "../data/DesignPatternsApparelMedicalSkinLayers.new.jruby.x3d"
x3D0.toFileJSON "../data/DesignPatternsApparelMedicalSkinLayers.new.jruby.x3dj"

    ...
    .setScene(Scene.new()
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setCenter([7.808, 31.46, -0.0585].to_java Java::float)
                                    .addChild(HAnimSegment.new()
                                        .setName("l_carpal")
                                        .setDEF("hanim_l_carpal")
                                        .addChild(Transform.new()
                                            .setTranslation([7.808, 31.46, -0.0585].to_java Java::float)
                                            .addChild(Shape.new()
                                                .setAppearance(Appearance.new()
                                                    .setMaterial(Material.new()
                                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
        ...
        .addChild(RigidBodyCollection.new()
            ...
            .setCollider(CollisionCollection.new()
                .setAppliedParameters(["FRICTION_COEFFICIENT_1", "SLIP_COEFFICIENTS"].to_java Java::java.lang.String)
            )
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([-7.808, 31.46, -0.0585].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([-8.093, 40.38, -0.2502].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([-5.975, 52, -0.1452].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([0, 57.43, -0.6863].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([-3.854, 3.64, 0.7402].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([-3.854, 3.939, -0.7038].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([-4.116, 17.26, -0.8639].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([-4.207, 32.02, -0.8155].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                .setDEF("hanim_vl5_rb")
                .setPosition([0, 40.07, -0.8527].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
                    .setDEF("hanim_l5_cs")
                    .setShape(Shape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([0, 35.8, -0.7076].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addBodies(RigidBody.new()
                ...
                .setPosition([0, 30.53, -0.7076].to_java Java::float)
                .setMass(0.5)
                .addGeometry(CollidableShape.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([0, 35.8, -0.7076].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([4.207, 32.02, -0.8155].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([4.116, 17.26, -0.8639].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([3.854, 3.939, -0.7038].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([3.854, 3.64, 0.7402].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([0, 40.07, -0.8527].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([0, 57.43, -0.6863].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([5.975, 52, -0.1452].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([8.093, 40.38, -0.2502].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
            ...
            .addJoints(SingleAxisHingeJoint.new()
                .setAnchorPoint([7.808, 31.46, -0.0585].to_java Java::float)
                .setAxis([0, 0, 1].to_java Java::float)
                .setMinAngle(1.5708)
                .setMaxAngle(1.5708)
                .setBody1(RigidBody.new()
...
x3D0.toFileX3D "../data/JinLOA1RigidBody.new.jruby.x3d"
x3D0.toFileJSON "../data/JinLOA1RigidBody.new.jruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor([0, 0, 0.9].to_java Java::float)
        )
        .addChild(Transform.new()
            ...
            .addChild(Transform.new()
                .addChild(Shape.new()
                    ...
                    .setGeometry(IndexedFaceSet.new()
                        .setCoordIndex([12, 13, 14, 15, 16, 17, 18, 12, -1].to_java Java::int)
                        .setCreaseAngle(1.45)
                        .setSolid(false)
                        .setCoord(Coordinate.new()
                            .setPoint([0, 0.08, 0, 0.02, 0.05, 0, 0.05, 0.05, 0, 0.06, 0.06, 0, 0.06, 0.09, 0, 0.05, 0.1, 0, 0, 0.1, 0, -0.05, 0.1, 0, -0.06, 0.09, 0, -0.06, 0.06, 0, -0.05, 0.05, 0, -0.02, 0.05, 0, 0.005, 0.08, 0, 0.02, 0.055, 0, 0.05, 0.055, 0, 0.055, 0.06, 0, 0.055, 0.09, 0, 0.045, 0.095, 0, 0.005, 0.095, 0, -0.005, 0.08, 0, -0.02, 0.055, 0, -0.05, 0.055, 0, -0.055, 0.06, 0, -0.055, 0.09, 0, -0.045, 0.095, 0, -0.005, 0.095, 0].to_java Java::float)
...
x3D0.toFileX3D "../data/MaskAndSnorkel.new.jruby.x3d"
x3D0.toFileJSON "../data/MaskAndSnorkel.new.jruby.x3dj"

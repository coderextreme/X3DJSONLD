        ...
        .addChild(Group.new()
            ...
            .addChild(Anchor.new()
                ...
                .addChild(Transform.new()
                    ...
                    .addChild(Inline.new()
                        .setUrl(["../data/gridBack.x3d", "https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.x3d", "gridBack.wrl", "https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials/gridBack.wrl"].to_java Java::java.lang.String)
                    )
                )
            )
            .addChild(Viewpoint.new()

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setPosition([0, 10, 25].to_java Java::float)
        )
            ...
            .addChild(Group.new()
                .addChild(Shape.new()
                    ...
                    .setGeometry(IndexedLineSet.new()
                        .setColorIndex([1, 0, 0, 0, 0, 2, 0, 0, 0, 0, 1, 0, 0, 0, 0, 2, 0, 0, 0, 0, 1].to_java Java::int)
                        .setColorPerVertex(false)
                        .setCoordIndex([1, 22, -1, 2, 23, -1, 3, 24, -1, 4, 25, -1, 5, 26, -1, 6, 27, -1, 7, 28, -1, 8, 29, -1, 9, 30, -1, 10, 31, -1, 11, 32, -1, 12, 33, -1, 13, 34, -1, 14, 35, -1, 15, 36, -1, 16, 37, -1, 17, 38, -1, 18, 39, -1, 19, 40, -1, 20, 41, -1, 21, 42, -1].to_java Java::int)
                        .setCoord(Coordinate.new()
                            .setDEF("EndPoints")
                            .setPoint([0, 0, 0, -10, 0, 10, -9, 0, 10, -8, 0, 10, -7, 0, 10, -6, 0, 10, -5, 0, 10, -4, 0, 10, -3, 0, 10, -2, 0, 10, -1, 0, 10, 0, 0, 10, 1, 0, 10, 2, 0, 10, 3, 0, 10, 4, 0, 10, 5, 0, 10, 6, 0, 10, 7, 0, 10, 8, 0, 10, 9, 0, 10, 10, 0, 10, -10, 0, -10, -9, 0, -10, -8, 0, -10, -7, 0, -10, -6, 0, -10, -5, 0, -10, -4, 0, -10, -3, 0, -10, -2, 0, -10, -1, 0, -10, 0, 0, -10, 1, 0, -10, 2, 0, -10, 3, 0, -10, 4, 0, -10, 5, 0, -10, 6, 0, -10, 7, 0, -10, 8, 0, -10, 9, 0, -10, 10, 0, -10].to_java Java::float)
                        )
                        .setColor(Color.new()
                            .setColor([0.4, 0.4, 0.4, 0.8, 0.2, 0, 0.4, 0.1, 0.05].to_java Java::float)
                        )
                    )
                )
                .addChild(Transform.new()
                    .setDEF("LinesAlignedAlongX")
                    .setRotation([0, 1, 0, 1.57079].to_java Java::float)
                    .addChild(Shape.new()
                    ...
                    .addChild(Billboard.new()
                        .addChild(Shape.new()
                            .setGeometry(Text.new()
                                ...
                                .setString(["origin"].to_java Java::java.lang.String)
                ...
                .addChild(Transform.new()
                    .setTranslation([10, -0.5, 10].to_java Java::float)
                    .addChild(Billboard.new()
                        .addChild(Shape.new()
                            .setGeometry(Text.new()
                                .setString(["10 0 10"].to_java Java::java.lang.String)
                                .setFontStyle(FontStyle.new()
                                    .setUSE("FS4")
                                )
                            )
...
x3D0.toFileX3D "../data/GridXZ_20x20Fixed.new.jruby.x3d"
x3D0.toFileJSON "../data/GridXZ_20x20Fixed.new.jruby.x3dj"

    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(Group.new()
                ...
                .addChild(Transform.new()
                    .setTranslation([0, -1, 0].to_java Java::float)
                    .setRotation([1, 0, 0, 3.1416].to_java Java::float)
                    .addChild(Shape.new()
                    ...
                    .addChild(Shape.new()
                        ...
                        .setGeometry(Text.new()
                            ...
                            .setFontStyle(FontStyle.new()
                                ...
                                .setSize(0.2)
                                .setJustify(["MIDDLE"].to_java Java::java.lang.String)
                            )
                        )
                    )
                )
        ...
        .addChild(Transform.new()
            .setRotation([0, 0, 1, -1.5708].to_java Java::float)
            .addChild(Group.new()
                .addChild(Group.new()
                    .setUSE("ARROW")
                )
        ...
        .addChild(Transform.new()
            .setRotation([1, 0, 0, 1.5708].to_java Java::float)
            .addChild(Group.new()
                .addChild(Group.new()
                    .setUSE("ARROW")
                )
...
x3D0.toFileX3D "../data/JointCoordinateAxes.new.jruby.x3d"
x3D0.toFileJSON "../data/JointCoordinateAxes.new.jruby.json"

...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        .addMeta(Meta.new()
            .setName("title")
            .setContent("FlowerSet.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("Set of three flowers for for the aromatic pleasure of the viewer. Carol did coordinates for stage and beginning to end flowers.")
        )
        .addMeta(Meta.new()
            .setName("creator")
        ...
        .addMeta(Meta.new()
            .setName("modified")
            .setContent("Mon, 15 Sep 2025 05:18:50 GMT")
        )
        .addMeta(Meta.new()
            .setName("reference")
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/FlowerSet.x3d")
        )
    )
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("FlowerSet.x3d")
        )
        ...
        .addChild(TimeSensor.new()
            .setDEF("FlowerStartTIME")
            .setLoop(true)
            .setStopTime(1757913530.194)
        )
        .addChild(TimeSensor.new()
            .setDEF("FlowerDelayTIME")
            .setCycleInterval(2.0)
            .setStartTime(1757913530.194)
        )
        .addChild(TimeSensor.new()
            .setDEF("FlowerHeartTimer")
            .setCycleInterval(100.0)
        )
        .addChild(BooleanFilter.new()
            .setDEF("FlowerDelayFILTER")
        )
        .addChild(TimeTrigger.new()
            .setDEF("FlowerTRIGGER")
        )
        .addChild(TimeSensor.new()
            .setDEF("PetalTime")
        ...
        .addChild(Group.new()
            ...
            .addChild(Transform.new()
                ...
                .setRotation([0.443850035587418, 0.896101080152242, 0, 6.28000595004544].to_java Java::float)
                .addChild(Shape.new()
                    .setDEF("FlowerPetal")
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
            ...
            .addChild(Transform.new()
                ...
                .setRotation([0.443820012787074, 0.896115950226133, 0, 0.522657613080648].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.443734579863432, 0.896158257582568, 0, 1.04552632941227].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.443609062236622, 0.89622039694572, 0, 1.56879714319555].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.443471991765267, 0.896288230715849, 0, 2.09259899845629].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.443363291286105, 0.896342006122637, 0, 2.61692975073691].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.443321552427192, 0.896362650467736, 0, 3.14160001589697].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.4433632935451, 0.896342005005255, 0, 3.66627027586694].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.443471995415153, 0.896288228909932, 0, 4.19060101505081].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.443609066086745, 0.896220395039996, 0, 4.71440285464847].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.443734582923915, 0.896158256067163, 0, 5.23767365490645].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
            .addChild(Transform.new()
                ...
                .setRotation([0.443820014451128, 0.896115949401974, 0, 5.76054236247118].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("FlowerPetal")
                )
            )
        ...
        .addChild(Group.new()
            .setDEF("BorderFlowers")
            .addChild(Transform.new()
                .setDEF("rFlowerSpecial")
                .setTranslation([7, 0.35, 0].to_java Java::float)
                .setScale([2, 2, 2].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower01")
                .setTranslation([9.198902, 0.25, -0.863062].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower02")
                .setTranslation([13.13242, 0.25, 0.935333].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower03")
                .setTranslation([17.52433, 0.25, 1.916645].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower04")
                .setTranslation([20.60856, 0.25, 5.182358].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower05")
                .setTranslation([21.64926, 0.25, 9.571372].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower06")
                .setTranslation([21.48226, 0.25, 14.11668].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower07")
                .setTranslation([24.02613, 0.25, 17.74993].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower08")
                .setTranslation([26.9932, 0.25, 21.15544].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower09")
                .setTranslation([27.82307, 0.25, 25.58628].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("rFlower10")
                .setTranslation([27.49279, 0.25, 30.1268].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower01")
                .setTranslation([-1.441, 0.25, 0.1745].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower02")
                .setTranslation([0.2505, 0.25, 4.274].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower03")
                .setTranslation([3.55, 0.25, 7.177].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower04")
                .setTranslation([7.952796, 0.25, 7.761609].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower05")
                .setTranslation([11.54255, 0.25, 0.060083].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower06")
                .setTranslation([12.36343, 0.25, 14.36499].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower07")
                .setTranslation([12.33216, 0.25, 18.81194].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower08")
                .setTranslation([14.54865, 0, 22.60859].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower09")
                .setTranslation([17.73875, 0.25, 25.70914].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
            .addChild(Transform.new()
                .setDEF("lFlower10")
                .setTranslation([18.51515, 0.25, 30.00324].to_java Java::float)
                .addChild(Transform.new()
                    .setUSE("BorderFlower01")
                )
            )
        ...
        .addChild(Group.new()
            .addChild(PositionInterpolator.new()
                .setDEF("lFlower01_TranslationInterpolator")
                .setKey([0, 0.785, 0.787, 0.81, 1].to_java Java::float)
                .setKeyValue([-1.441071, 0.25, 0.174511, -1.441071, 0.25, 0.174511, 5, 1.25, 16, 21.75, 2.25, 32, 21.75, 2.25, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("lFlower02_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([0.250537, 0.25, 4.273979, 0.250537, 0.25, 4.273979, 21.55, 2.35, 32, 21.55, 2.35, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("lFlower03_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([3.550097, 0.25, 7.177285, 3.550097, 0.25, 7.177285, 21.55, 2.45, 32, 21.55, 2.45, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("lFlower04_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([7.952796, 0.25, 7.761609, 7.952796, 0.25, 7.761609, 21.45, 2.55, 32, 21.45, 2.55, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("lFlower05_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([11.54255, 0.25, 10.06008, 11.54255, 0.25, 10.06008, 21.55, 2.45, 32, 21.55, 2.45, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("lFlower06_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([12.36343, 0.25, 14.36499, 12.36343, 0.25, 14.36499, 21.36, 2.79, 32, 21.36, 2.79, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("lFlower07_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([12.33216, 0.25, 18.81194, 12.33216, 0.25, 18.81194, 21.45, 2.9, 32, 21.45, 2.9, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("lFlower08_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([14.54865, 0.25, 22.60859, 14.54865, 0.25, 22.60859, 21.59, 2.86, 32, 21.59, 2.86, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("rFlower01_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([9.198902, 0.25, -0.863062, 9.198902, 0.25, -0.863062, 21.85, 2.35, 32, 21.85, 2.35, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("rFlower02_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([13.13242, 0.25, 0.935333, 13.13242, 0.25, 0.935333, 21.95, 2.45, 32, 21.95, 2.45, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("rFlower03_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([17.52433, 0.25, 1.916645, 17.52433, 0.25, 1.916645, 22.05, 2.55, 32, 22.05, 2.55, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("rFlower04_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([20.60856, 0.25, 5.182358, 20.60856, 0.25, 5.182358, 22.15, 2.65, 32, 22.15, 2.65, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("rFlower05_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([21.64926, 0.25, 9.571372, 21.64926, 0.25, 9.571372, 22.14, 2.79, 32, 22.14, 2.79, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("rFlower06_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([21.48226, 0.25, 14.11668, 21.48226, 0.25, 14.11668, 22.06, 2.9, 32, 22.06, 2.9, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("rFlower07_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([24.02613, 0.25, 17.74993, 24.02613, 0.25, 17.74993, 21.91, 2.86, 32, 21.91, 2.86, 32].to_java Java::float)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("rFlower08_TranslationInterpolator")
                .setKey([0, 0.785, 0.81, 1].to_java Java::float)
                .setKeyValue([26.9932, 0.25, 21.15544, 26.9932, 0.25, 21.15544, 21.75, 2.85, 32, 21.75, 2.85, 32].to_java Java::float)
            )
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerStartTIME")
            .setFromField("cycleTime")
            .setToNode("FlowerStartTIME")
            .setToField("set_stopTime")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerStartTIME")
            .setFromField("stopTime_changed")
            .setToNode("FlowerDelayTIME")
            .setToField("set_startTime")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerDelayTIME")
            .setFromField("isActive")
            .setToNode("FlowerDelayFILTER")
            .setToField("set_boolean")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerDelayFILTER")
            .setFromField("inputFalse")
            .setToNode("FlowerTRIGGER")
            .setToField("set_boolean")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerTRIGGER")
            .setFromField("triggerTime")
            .setToNode("FlowerHeartTimer")
            .setToField("set_startTime")
        )
        .addChild(ROUTE.new()
        ...
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("lFlower01_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("lFlower02_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("lFlower03_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("lFlower04_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("lFlower05_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("lFlower06_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("lFlower07_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("lFlower08_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("rFlower01_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("rFlower02_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("rFlower03_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("rFlower04_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("rFlower05_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("rFlower06_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("rFlower07_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("FlowerHeartTimer")
            .setFromField("fraction_changed")
            .setToNode("rFlower08_TranslationInterpolator")
            .setToField("set_fraction")
        )
        .addChild(ROUTE.new()
            .setFromNode("lFlower01_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("lFlower01")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("lFlower02_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("lFlower02")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("lFlower03_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("lFlower03")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("lFlower04_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("lFlower04")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("lFlower05_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("lFlower05")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("lFlower06_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("lFlower06")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("lFlower07_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("lFlower07")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("lFlower08_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("lFlower08")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("rFlower01_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("rFlower01")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("rFlower02_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("rFlower02")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("rFlower03_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("rFlower03")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("rFlower04_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("rFlower04")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("rFlower05_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("rFlower05")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("rFlower06_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("rFlower06")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("rFlower07_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("rFlower07")
            .setToField("set_translation")
        )
        .addChild(ROUTE.new()
            .setFromNode("rFlower08_TranslationInterpolator")
            .setFromField("value_changed")
            .setToNode("rFlower08")
            .setToField("set_translation")
        )
    )
x3D0.toFileX3D "../data/FlowerSet.new.jruby.x3d"
x3D0.toFileJSON "../data/FlowerSet.new.jruby.x3dj"

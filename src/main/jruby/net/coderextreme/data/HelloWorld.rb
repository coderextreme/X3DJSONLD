...
x3D0 = X3D.new
    ...
    .setVersion("4.0")
    .setHead(Head.new()
        .addComments(CommentsBlock.new("Alternate encodings: VRML97, X3D ClassicVRML Encoding, X3D Compressed Binary Encoding (CBE), X3DOM, JSON"))
        .addMeta(Meta.new()
            .setName("title")
    ...
    .setScene(Scene.new()
        .addComments(CommentsBlock.new("Example scene to illustrate X3D nodes and fields (XML elements and attributes)"))
        .addChild(WorldInfo.new()
            .setInfo(["Example scene to illustrate a simple X3D model"].to_java Java::java.lang.String)
...
x3D0.toFileX3D "../data/HelloWorld.new.jruby.x3d"
x3D0.toFileJSON "../data/HelloWorld.new.jruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Anchor.new()
            ...
            .setUrl(["NancyDiving.x3d", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/NancyDiving.x3d", "NancyDiving.wrl", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/NancyDiving.wrl"].to_java Java::java.lang.String)
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(["LOA1_SwimmingFlutterKickAnimation.x3d", "defines a prototype", "for animating a humanoid.", "", "Click text to see example."].to_java Java::java.lang.String)
...
x3D0.toFileX3D "../data/LOA1_SwimmingFlutterKickAnimation.new.jruby.x3d"
x3D0.toFileJSON "../data/LOA1_SwimmingFlutterKickAnimation.new.jruby.x3dj"

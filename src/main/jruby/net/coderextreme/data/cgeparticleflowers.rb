            ...
            .addChild(ParticleSystem.new()
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        ...
                        .setFrontTexture(ImageTexture.new()
                            .setUrl(["../resources/images/all_probes/stpeters_cross/stpeters_from.png", "https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"].to_java Java::java.lang.String)
                        )
                ...
                .addComments(CommentsBlock.new("</field>"))
                        .addParts(ShaderPart.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setType("FRAGMENT")
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/castle.fs"].to_java Java::java.lang.String)
                        )
                    )
                )
            )
...
x3D0.toFileX3D "../data/cgeparticleflowers.new.jruby.x3d"
x3D0.toFileJSON "../data/cgeparticleflowers.new.jruby.x3dj"

    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            .addChild(ParticleSystem.new()
                ...
                .addComments(CommentsBlock.new("<field name='cube' type='SFNode' accessType=\"initializeOnly\"> <ComposedCubeMapTexture USE=\"texture\"></ComposedCubeMapTexture> </field>"))
...
x3D0.toFileJSON "../data/cgeparticleflowers.new.jruby.json"

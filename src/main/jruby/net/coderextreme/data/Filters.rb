...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            ...
            .setTranslation([-200, 50, 0].to_java Java::float)
            .addChild(Shape.new()
        ...
        .addChild(Transform.new()
            .setDEF("AnimDataBoxM")
            .setTranslation([15, 100, 0].to_java Java::float)
        )
        .addChild(Transform.new()
            .setDEF("AnimDataBoxL")
            .setTranslation([30, 100, 0].to_java Java::float)
        )
        .addChild(Transform.new()
                            ...
                            .addChild(Analyser.new()
                                .addChild(BiquadFilter.new()
                                    ...
                                    .addChild(AudioClip.new()
                                        ...
                                        .setLoop(true)
                                        .setUrl(["sound/techno_beat.mp3", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/techno_beat.mp3"].to_java Java::java.lang.String)
                                    )
                                )
                            )
                        )
                            ...
                            .addChild(Analyser.new()
                                .addChild(BiquadFilter.new()
                                    ...
                                    .addChild(AudioClip.new()
                                        ...
                                        .setLoop(true)
                                        .setUrl(["sound/beat.mp3", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/beat.mp3"].to_java Java::java.lang.String)
                                    )
                                )
                            )
                        )
                            ...
                            .addChild(Analyser.new()
                                .addChild(BiquadFilter.new()
                                    ...
                                    .addChild(AudioClip.new()
                                        ...
                                        .setLoop(true)
                                        .setUrl(["sound/wobble_loop.mp3", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/wobble_loop.mp3"].to_java Java::java.lang.String)
                                    )
                                )
                            )
                        )
...
x3D0.toFileX3D "../data/Filters.new.jruby.x3d"
x3D0.toFileJSON "../data/Filters.new.jruby.json"

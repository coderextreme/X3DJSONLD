...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("title")
            .setContent("KoreanCharacterAnnexB01Jin.x3d")
        )
        .addMeta(Meta.new()
            .setName("creator")
        ...
        .addMeta(Meta.new()
            ...
            .setContent("HAnim 2.0 Part 2: Humanoid animation (HAnim) motion data animation, Annex D (informative) Examples of HAnim motion data animation using a Motion object")
        )
        .addMeta(Meta.new()
            .setName("specificationUrl")
            .setContent("https://www.web3d.org/documents/specifications/19774/V2.0/MotionDataAnimation/ExampleKeyframeAnimation.html")
        )
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/KoreanCharacterAnnexB01Jin.x3d")
        )
        .addMeta(Meta.new()
            .setName("generator")
    ...
    .setScene(Scene.new()
            ...
            .addSkeleton(HAnimJoint.new()
                        ...
                        .addChild(Shape.new()
                            .setAppearance(Appearance.new()
                                ...
                                .setTexture(ImageTexture.new()
                                    .setDEF("Annex01JinTextureAtlas")
                                    .setUrl(["Jin.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Specifications/Jin.png"].to_java Java::java.lang.String)
                                )
                            )
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("l_hip")
                        .setDEF("hanim_l_hip")
                        .setCenter([4.207, 32.02, -0.8155].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l_thigh")
                            ...
                            .addChild(Transform.new()
                                .setTranslation([4.207, 32.02, -0.8155].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                    ...
                                    .setGeometry(IndexedFaceSet.new()
                                        ...
                                        .setCoord(Coordinate.new()
                                            .setPoint([2.96, 3.738, 0, 1.643, 3.738, 3.209, -1.316, 3.738, 4.002, -3.367, 3.738, 1.781, -3.367, 3.738, -1.781, -1.316, 3.738, -4.002, 1.643, 3.738, -3.209, 2.96, -0.0114, 0, 1.643, -0.0114, 3.209, -1.316, -0.0114, 4.002, -3.367, -0.0114, 1.781, -3.367, -0.0114, -1.781, -1.316, -0.0114, -4.002, 1.643, -0.0114, -3.209, 2.96, -6.507, 0, 1.643, -6.507, 3.209, -1.316, -6.507, 4.002, -3.367, -6.507, 1.781, -3.367, -6.507, -1.781, -1.316, -6.507, -4.002, 1.643, -6.507, -3.209, 3.367, -13.13, 0, 1.897, -13.13, 3.582, -1.407, -13.13, 4.467, -3.355, -13.13, 1.988, -3.355, -13.13, -1.988, -1.407, -13.13, -4.467, 1.897, -13.13, -3.582, 2.146, -4.985, 0, 1.136, -4.985, 2.462, -1.135, -4.985, 3.07, -2.633, -4.985, 1.366, -2.633, -4.985, -1.366, -1.135, -4.985, -3.07, 1.136, -4.985, -2.462, 2.156, -11.45, 0, 1.225, -11.45, 1.956, -0.8662, -11.45, 2.439, -2.543, -11.45, 1.085, -2.543, -11.45, -1.085, -0.8662, -11.45, -2.439, 1.225, -11.45, -1.956, 2.051, 5.729, 0, 1.076, 5.729, 2.375, -1.114, 5.729, 2.961, -2.87, 5.729, 1.318, -2.87, 5.729, -1.318, -1.114, 5.729, -2.961, 1.076, 5.729, -2.375, 1.842, -15.12, 0, 1.03, -15.12, 1.873, -0.7965, -15.12, 2.295, -2.261, -15.12, 1.113, -2.261, -15.12, -0.9478, -0.7965, -15.12, -2.13, 1.03, -15.12, -1.708, 0.6277, -16.1, 0, 0.2723, -16.1, 0.912, -0.5262, -16.1, 1.096, -1.167, -16.1, 0.5796, -1.167, -16.1, -0.4145, -0.5262, -16.1, -0.9313, 0.2723, -16.1, -0.7469].to_java Java::float)
                                        )
                                        .setTexCoord(TextureCoordinate.new()
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .addChild(HAnimJoint.new()
                                    .setName("l_metatarsophalangeal")
                                    .setDEF("hanim_l_metatarsophalangeal")
                                    ...
                                    .addChild(HAnimSegment.new()
                                        ...
                                        .addChild(Transform.new()
                                            ...
                                            .addChild(Shape.new()
                                                ...
                                                .setGeometry(IndexedFaceSet.new()
                                                    .setCoordIndex([3, 4, 10, -1, 3, 10, 11, -1, 0, 3, 11, -1, 1, 0, 11, -1, 11, 12, 1, -1, 1, 12, 16, -1, 16, 9, 1, -1, 2, 17, 10, -1, 10, 4, 2, -1, 13, 8, 6, -1, 14, 13, 6, -1, 5, 14, 6, -1, 7, 15, 14, -1, 14, 5, 7, -1, 7, 9, 16, -1, 16, 15, 7, -1, 2, 8, 13, -1, 13, 17, 2, -1, 20, 21, 22, -1, 20, 22, 23, -1, 20, 23, 24, -1, 19, 20, 24, -1, 19, 24, 18, -1, 0, 1, 19, -1, 19, 18, 0, -1, 1, 9, 20, -1, 20, 19, 1, -1, 9, 7, 21, -1, 21, 20, 9, -1, 7, 5, 22, -1, 22, 21, 7, -1, 5, 6, 23, -1, 23, 22, 5, -1, 6, 3, 24, -1, 24, 23, 6, -1, 3, 0, 18, -1, 18, 24, 3, -1, 6, 8, 2, -1, 3, 6, 2, -1, 4, 3, 2, -1, 28, 26, 25, -1, 25, 29, 28, -1, 35, 27, 26, -1, 26, 28, 35, -1, 27, 35, 40, -1, 25, 26, 31, -1, 31, 30, 25, -1, 31, 26, 27, -1, 27, 32, 31, -1, 32, 27, 40, -1, 40, 41, 32, -1, 42, 29, 25, -1, 25, 30, 42, -1, 28, 29, 34, -1, 34, 33, 28, -1, 35, 28, 33, -1, 33, 36, 35, -1, 36, 40, 35, -1, 34, 37, 38, -1, 38, 33, 34, -1, 38, 39, 36, -1, 36, 33, 38, -1, 39, 41, 40, -1, 40, 36, 39, -1, 42, 37, 34, -1, 34, 29, 42, -1].to_java Java::int)
                                                    .setCreaseAngle(3.14159)
                                                    ...
                                                    .setCoord(Coordinate.new()
                                                        .setPoint([2.927, -1.627, -1.013, 2.089, -3.648, -1.013, 0, 0.2797, 0.3064, 2.045, -0.3017, -1.013, 1.695, 0.0029, -0.0151, -2.927, -1.627, -1.013, -2.045, -0.3017, -1.013, -2.089, -3.648, -1.013, -1.695, 0.0029, -0.0151, 0, -3.648, -1.013, 1.74, -0.3226, 1.158, 2.661, -1.866, 0.9192, 2.14, -3.648, 0.9192, -1.74, -0.3226, 1.158, -2.661, -1.866, 0.9192, -2.14, -3.648, 0.9192, 0, -3.648, 0.9192, 0, -0.0274, 1.661, 2.405, -1.656, -1.915, 1.75, -2.942, -1.915, 0, -2.942, -1.915, -1.75, -2.942, -1.915, -2.405, -1.656, -1.915, -1.742, -0.5681, -1.915, 1.742, -0.5681, -1.915, 1.784, -0.648, 2.332, 2.216, -2.267, 4.144, 2.216, -3.648, 3.776, 0, -2.267, 5.463, 0, -0.5463, 3.95, 1.74, -0.3226, 1.158, 2.661, -1.866, 0.9192, 2.14, -3.648, 0.9192, -2.216, -2.267, 4.144, -1.784, -0.648, 2.332, 0, -3.648, 5.096, -2.216, -3.648, 3.776, -1.74, -0.3226, 1.158, -2.661, -1.866, 0.9192, -2.14, -3.648, 0.9192, 0, -3.648, 3.776, 0, -3.648, 0.9192, 0, -0.0274, 1.661].to_java Java::float)
                                                    )
                                                    .setTexCoord(TextureCoordinate.new()
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .addChild(HAnimJoint.new()
                                    .setName("r_metatarsophalangeal")
                                    .setDEF("hanim_r_metatarsophalangeal")
                                    .setCenter([-3.854, 3.64, 0.7402].to_java Java::float)
                                    .setUlimit([0, 0, 0].to_java Java::float)
                                    .setLlimit([0, 0, 0].to_java Java::float)
                                    .addChild(HAnimSegment.new()
                    ...
                    .addChild(HAnimJoint.new()
                        .setName("vl5")
                        .setDEF("hanim_vl5")
                        .setCenter([0, 40.23, -0.8527].to_java Java::float)
                        .setUlimit([0, 0, 0].to_java Java::float)
                        .setLlimit([0, 0, 0].to_java Java::float)
                        .addChild(HAnimSegment.new()
                            .setName("l5")
                            .setDEF("hanim_l5")
                            .addChild(Transform.new()
                                .setTranslation([0, 40.23, -0.8527].to_java Java::float)
                                .addChild(Shape.new()
                                    .setAppearance(Appearance.new()
                                        .setMaterial(Material.new()
                                            .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .setCenter([5.975, 52, -0.1452].to_java Java::float)
                            .setUlimit([0, 0, 0].to_java Java::float)
                            .setLlimit([0, 0, 0].to_java Java::float)
                            .addChild(HAnimSegment.new()
                                .setName("l_upperarm")
                                ...
                                .addChild(Transform.new()
                                    .setTranslation([5.975, 52, -0.1452].to_java Java::float)
                                    .addChild(Shape.new()
                                        .setAppearance(Appearance.new()
                                            .setMaterial(Material.new()
                                                .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setCenter([7.808, 31.46, -0.05849].to_java Java::float)
                                    .setUlimit([0, 0, 0].to_java Java::float)
                                    .setLlimit([0, 0, 0].to_java Java::float)
                                    .addChild(HAnimSegment.new()
                                        .setName("l_hand")
                                        .setDEF("hanim_l_hand")
                                        .addChild(Transform.new()
                                            .setTranslation([7.808, 31.46, -0.05849].to_java Java::float)
                                            .addChild(Shape.new()
                                                .setAppearance(Appearance.new()
                                                    .setMaterial(Material.new()
                                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                                ...
                                                .setGeometry(IndexedFaceSet.new()
                                                    .setCoordIndex([4, 5, 0, -1, 0, 2, 4, -1, 6, 7, 3, -1, 3, 1, 6, -1, 1, 0, 5, -1, 5, 6, 1, -1, 8, 9, 5, -1, 5, 4, 8, -1, 10, 11, 7, -1, 7, 6, 10, -1, 9, 10, 6, -1, 6, 5, 9, -1, 12, 13, 9, -1, 9, 8, 12, -1, 14, 15, 11, -1, 11, 10, 14, -1, 13, 14, 10, -1, 10, 9, 13, -1, 4, 2, 16, -1, 2, 3, 7, -1, 7, 16, 2, -1, 17, 19, 18, -1, 18, 20, 17, -1, 21, 16, 7, -1, 7, 11, 21, -1, 8, 21, 12, -1, 12, 21, 11, -1, 11, 15, 12, -1, 13, 12, 15, -1, 15, 14, 13, -1, 8, 4, 19, -1, 19, 17, 8, -1, 4, 16, 18, -1, 18, 19, 4, -1, 16, 21, 20, -1, 20, 18, 16, -1, 21, 8, 17, -1, 17, 20, 21, -1, 22, 27, 23, -1, 26, 25, 24, -1].to_java Java::int)
                                                    .setCreaseAngle(3.14159)
                                                    .setTexCoordIndex([4, 6, 5, -1, 5, 7, 4, -1, 2, 3, 1, -1, 1, 0, 2, -1, 14, 16, 15, -1, 15, 17, 14, -1, 8, 9, 6, -1, 6, 4, 8, -1, 38, 40, 39, -1, 39, 41, 38, -1, 18, 19, 36, -1, 36, 37, 18, -1, 10, 11, 9, -1, 9, 8, 10, -1, 42, 43, 40, -1, 40, 38, 42, -1, 20, 21, 19, -1, 19, 18, 20, -1, 22, 24, 23, -1, 24, 26, 25, -1, 25, 23, 24, -1, 27, 29, 28, -1, 28, 30, 27, -1, 31, 23, 25, -1, 25, 32, 31, -1, 33, 31, 34, -1, 34, 31, 32, -1, 32, 35, 34, -1, 20, 34, 35, -1, 35, 21, 20, -1, 8, 4, 12, -1, 12, 13, 8, -1, 22, 23, 28, -1, 28, 29, 22, -1, 23, 31, 30, -1, 30, 28, 23, -1, 31, 33, 27, -1, 27, 30, 31, -1, 14, 24, 26, -1, 14, 16, 24, -1].to_java Java::int)
                                                    .setCoord(Coordinate.new()
                                                        .setPoint([1.247, 0.07, 0.7975, 1.209, 0.0872, -1.349, -0.7098, -0.0015, 0.8912, -0.7183, 0.0002, -1.283, -0.9295, -0.613, 1.478, 1.647, -0.4252, 1.388, 1.589, -0.3921, -1.989, -1.044, -0.5947, -1.984, -0.8227, -2.521, 2.408, 1.951, -2.334, 2.08, 1.892, -2.301, -2.409, -1.192, -2.614, -2.248, -0.5703, -3.958, 1.694, 0.8836, -4.2, 1.75, 0.8251, -4.167, -2.071, -0.7842, -3.968, -1.934, -1.037, -0.5968, -0.1872, -1.642, -2.561, 1.941, -1.951, -0.9492, 0.058, -1.914, -1.016, 1.885, -1.649, -2.56, 0.1377, -1.066, -2.61, -0.2014, 1.209, 0.0872, -1.349, -0.7183, 0.0002, -1.283, -0.7098, -0.0015, 0.8912, 1.247, 0.07, 0.7975, 1.209, 0.0872, -1.349, -0.7098, -0.0015, 0.8912].to_java Java::float)
                                                    )
                                                    .setTexCoord(TextureCoordinate.new()
                                    ...
                                    .addChild(HAnimSegment.new()
                                        ...
                                        .addChild(Transform.new()
                                            ...
                                            .addChild(Shape.new()
                                                ...
                                                .setGeometry(IndexedFaceSet.new()
                                                    .setCoordIndex([4, 2, 0, -1, 0, 5, 4, -1, 6, 1, 3, -1, 3, 7, 6, -1, 1, 6, 5, -1, 5, 0, 1, -1, 8, 4, 5, -1, 5, 9, 8, -1, 10, 6, 7, -1, 7, 11, 10, -1, 9, 5, 6, -1, 6, 10, 9, -1, 12, 8, 9, -1, 9, 13, 12, -1, 14, 10, 11, -1, 11, 15, 14, -1, 13, 9, 10, -1, 10, 14, 13, -1, 4, 16, 2, -1, 2, 16, 7, -1, 7, 3, 2, -1, 17, 20, 18, -1, 18, 19, 17, -1, 21, 11, 7, -1, 7, 16, 21, -1, 8, 12, 21, -1, 12, 15, 11, -1, 11, 21, 12, -1, 13, 14, 15, -1, 15, 12, 13, -1, 8, 17, 19, -1, 19, 4, 8, -1, 4, 19, 18, -1, 18, 16, 4, -1, 16, 18, 20, -1, 20, 21, 16, -1, 21, 20, 17, -1, 17, 8, 21, -1, 22, 23, 27, -1, 26, 24, 25, -1].to_java Java::int)
                                                    .setCreaseAngle(3.14159)
                                                    .setTexCoordIndex([4, 7, 5, -1, 5, 6, 4, -1, 2, 0, 1, -1, 1, 3, 2, -1, 14, 17, 15, -1, 15, 16, 14, -1, 8, 4, 6, -1, 6, 9, 8, -1, 38, 41, 39, -1, 39, 40, 38, -1, 18, 37, 36, -1, 36, 19, 18, -1, 10, 8, 9, -1, 9, 11, 10, -1, 42, 38, 40, -1, 40, 43, 42, -1, 20, 18, 19, -1, 19, 21, 20, -1, 22, 23, 24, -1, 24, 23, 25, -1, 25, 26, 24, -1, 27, 30, 28, -1, 28, 29, 27, -1, 31, 32, 25, -1, 25, 23, 31, -1, 33, 34, 31, -1, 34, 35, 32, -1, 32, 31, 34, -1, 20, 21, 35, -1, 35, 34, 20, -1, 8, 13, 12, -1, 12, 4, 8, -1, 22, 29, 28, -1, 28, 23, 22, -1, 23, 28, 30, -1, 30, 31, 23, -1, 31, 30, 27, -1, 27, 33, 31, -1, 14, 26, 24, -1, 14, 24, 16, -1].to_java Java::int)
                                                    .setCoord(Coordinate.new()
                                                        .setPoint([-1.247, 0.07, 0.7975, -1.209, 0.0872, -1.349, 0.7098, -0.0015, 0.8912, 0.7183, 0.0002, -1.283, 0.9295, -0.613, 1.478, -1.647, -0.4252, 1.388, -1.589, -0.3921, -1.989, 1.044, -0.5947, -1.984, 0.8227, -2.521, 2.408, -1.951, -2.334, 2.08, -1.892, -2.301, -2.409, 1.192, -2.614, -2.248, 0.5703, -3.958, 1.694, -0.8836, -4.2, 1.75, -0.8251, -4.167, -2.071, 0.7842, -3.968, -1.934, 1.037, -0.5968, -0.1872, 1.642, -2.561, 1.941, 1.951, -0.9492, 0.058, 1.914, -1.016, 1.885, 1.649, -2.56, 0.1377, 1.066, -2.61, -0.2014, -1.209, 0.0872, -1.349, 0.7183, 0.0002, -1.283, 0.7098, -0.0015, 0.8912, -1.247, 0.07, 0.7975, -1.209, 0.0872, -1.349, 0.7098, -0.0015, 0.8912].to_java Java::float)
                                                    )
                                                    .setTexCoord(TextureCoordinate.new()
        ...
        .addChild(Group.new()
            .setDEF("KeyframeAnimation")
            .addChild(TimeSensor.new()
                .setDEF("KeyframeTimer")
                .setCycleInterval(8.033494)
                .setLoop(true)
            )
            .addChild(PositionInterpolator.new()
                .setDEF("Keyframe_HumanoidRootTranslation")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_HumanoidRootOrientation")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_sacroiliac")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_l_shoulder")
                .setKey([0, 0.5, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, -1, 0, 0, 3, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_l_elbow")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_l_radiocarpal")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_r_shoulder")
                .setKey([0, 0.5, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, -1, 0, 0, 3, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_r_elbow")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_r_radiocarpal")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
            ...
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_skullbase")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_l_hip")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_l_knee")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_l_talocrural")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_l_metatarsophalangeal")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_r_hip")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_r_knee")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_r_talocrural")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(OrientationInterpolator.new()
                .setDEF("Keyframe_r_metatarsophalangeal")
                .setKey([0, 1].to_java Java::float)
                .setKeyValue([0, 0, 0, 0, 0, 0, 0, 0].to_java Java::float)
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_HumanoidRootTranslation")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_HumanoidRootOrientation")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_sacroiliac")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_l_shoulder")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_l_elbow")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_l_radiocarpal")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_r_shoulder")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_r_elbow")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_r_radiocarpal")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_vl5")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_skullbase")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_l_hip")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_l_knee")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_l_talocrural")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_l_metatarsophalangeal")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_r_hip")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_r_knee")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_r_talocrural")
            )
            .addChild(ROUTE.new()
                .setFromField("fraction_changed")
                .setFromNode("KeyframeTimer")
                .setToField("set_fraction")
                .setToNode("Keyframe_r_metatarsophalangeal")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_HumanoidRootTranslation")
                .setToField("translation")
                .setToNode("hanim_HumanoidRoot")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_HumanoidRootOrientation")
                .setToField("rotation")
                .setToNode("hanim_HumanoidRoot")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_sacroiliac")
                .setToField("rotation")
                .setToNode("hanim_sacroiliac")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_l_shoulder")
                .setToField("rotation")
                .setToNode("hanim_l_shoulder")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_l_elbow")
                .setToField("rotation")
                .setToNode("hanim_l_elbow")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_l_radiocarpal")
                .setToField("rotation")
                .setToNode("hanim_l_radiocarpal")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_r_shoulder")
                .setToField("rotation")
                .setToNode("hanim_r_shoulder")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_r_elbow")
                .setToField("rotation")
                .setToNode("hanim_r_elbow")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_r_radiocarpal")
                .setToField("rotation")
                .setToNode("hanim_r_radiocarpal")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_vl5")
                .setToField("rotation")
                .setToNode("hanim_vl5")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_skullbase")
                .setToField("rotation")
                .setToNode("hanim_skullbase")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_l_hip")
                .setToField("rotation")
                .setToNode("hanim_l_hip")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_l_knee")
                .setToField("rotation")
                .setToNode("hanim_l_knee")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_l_talocrural")
                .setToField("rotation")
            ...
            .addChild(ROUTE.new()
                ...
                .setFromNode("Keyframe_l_talocrural")
                .setToField("rotation")
                .setToNode("hanim_l_metatarsophalangeal")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_r_hip")
                .setToField("rotation")
                .setToNode("hanim_r_hip")
            )
            .addChild(ROUTE.new()
                .setFromField("value_changed")
                .setFromNode("Keyframe_r_knee")
                .setToField("rotation")
            ...
            .addChild(ROUTE.new()
                ...
                .setFromNode("Keyframe_l_talocrural")
                .setToField("rotation")
                .setToNode("hanim_r_metatarsophalangeal")
            )
        )
    )
x3D0.toFileX3D "../data/KoreanCharacterMotionAnnexB01Jin.new.jruby.x3d"
x3D0.toFileJSON "../data/KoreanCharacterMotionAnnexB01Jin.new.jruby.json"

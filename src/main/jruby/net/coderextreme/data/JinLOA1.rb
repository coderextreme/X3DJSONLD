    ...
    .setScene(Scene.new()
        ...
        .addChild(HAnimHumanoid.new()
            ...
            .addSkeleton(HAnimJoint.new()
                ...
                .setCenter([0, 30.530001, -0.7076].to_java Java::float)
                ...
                .addChild(HAnimSegment.new()
                    ...
                    .addChild(Transform.new()
                        .setTranslation([0, 30.530001, -0.7076].to_java Java::float)
                        .addChild(Shape.new()
                ...
                .addChild(HAnimJoint.new()
                    ...
                    .setCenter([0, 35.799999, -0.7076].to_java Java::float)
                    .setUlimit([0, 0, 0].to_java Java::float)
                    .setLlimit([0, 0, 0].to_java Java::float)
                    .addChild(HAnimSegment.new()
                        .setName("pelvis")
                        .setDEF("hanim_pelvis")
                        .addChild(Transform.new()
                            .setTranslation([0, 35.799999, -0.7076].to_java Java::float)
                            .addChild(Shape.new()
                                .setAppearance(Appearance.new()
                                    .setMaterial(Material.new()
                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .addComments(CommentsBlock.new("TODO append _2"))
                                        .addChild(Transform.new()
                    ...
                    .addChild(HAnimJoint.new()
                        ...
                        .addChild(HAnimJoint.new()
                            ...
                            .addChild(HAnimJoint.new()
                                ...
                                .setCenter([8.093, 40.380001, -0.2502].to_java Java::float)
                                .setUlimit([0, 0, 0].to_java Java::float)
                                .setLlimit([0, 0, 0].to_java Java::float)
                                .addChild(HAnimSegment.new()
                                    .setName("l_forearm")
                                    ...
                                    .addChild(Transform.new()
                                        .setTranslation([8.093, 40.380001, -0.2502].to_java Java::float)
                                        .addChild(Shape.new()
                                            .setAppearance(Appearance.new()
                                                .setMaterial(Material.new()
                                                    .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
                                ...
                                .addChild(HAnimJoint.new()
                                    ...
                                    .setCenter([7.808, 31.459999, -0.05849].to_java Java::float)
                                    .setUlimit([0, 0, 0].to_java Java::float)
                                    .setLlimit([0, 0, 0].to_java Java::float)
                                    .addChild(HAnimSegment.new()
                                        .setName("l_carpal")
                                        ...
                                        .addChild(Transform.new()
                                            .setTranslation([7.808, 31.459999, -0.05849].to_java Java::float)
                                            .addChild(Shape.new()
                                                .setAppearance(Appearance.new()
                                                    .setMaterial(Material.new()
                                                        .setDiffuseColor([0.588, 0.588, 0.588].to_java Java::float)
...
x3D0.toFileX3D "../data/JinLOA1.new.jruby.x3d"
x3D0.toFileJSON "../data/JinLOA1.new.jruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setBackUrl(["images/generic/BK1.png", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/images/generic/BK1.png"].to_java Java::java.lang.String)
            .setBottomUrl(["images/generic/DN1.png", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/images/generic/DN1.png"].to_java Java::java.lang.String)
            .setFrontUrl(["images/generic/FR1.png", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/images/generic/FR1.png"].to_java Java::java.lang.String)
            .setLeftUrl(["images/generic/LF1.png", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/images/generic/LF1.png"].to_java Java::java.lang.String)
            .setRightUrl(["images/generic/RT1.png", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/images/generic/RT1.png"].to_java Java::java.lang.String)
            .setTopUrl(["images/generic/UP1.png", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/images/generic/UP1.png"].to_java Java::java.lang.String)
        )
        .addChild(Viewpoint.new()
            ...
            .setOrientation([1, 0, 0, -0.523599].to_java Java::float)
            .setPosition([0, 2000, 3500].to_java Java::float)
        )
        ...
        .addChild(PositionInterpolator.new()
            ...
            .setKeyValue([0, 2000, 3500, 0, 2000, 0, 0, 2000, -3500, 0, 2000, 0, 0, 2000, 3500].to_java Java::float)
        )
        .addChild(OrientationInterpolator.new()
            .setDEF("Camera001-ROT-INTERP")
            .setKey([0, 0.25, 0.5, 0.75, 1].to_java Java::float)
            .setKeyValue([1, 0, 0, -0.523599, 0.99999, 0.003554, 0.002727, -1.309007, 0, -0.965926, -0.258819, -3.141593, 0.002282, -0.793351, -0.60876, -3.135645, 1, -0.000001, 0, -0.523599].to_java Java::float)
        )
        .addChild(ROUTE.new()
        ...
        .addChild(Transform.new()
            .setDEF("Floor")
            .setTranslation([1.241, 0, 0.358].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setDEF("WireColor")
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.122, 0.114, 0.125].to_java Java::float)
                    )
                )
                .setGeometry(Box.new()
                    .setSize([2000, 1, 2000].to_java Java::float)
                )
            )
        )
        .addChild(Transform.new()
            .setDEF("TransformAudio1")
            .setTranslation([-933.123474, 0, -926.253235].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setDEF("WireColor_1")
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.690196, 0.101961, 0.101961].to_java Java::float)
                    )
                )
            ...
            .addChild(Billboard.new()
                .addChild(Transform.new()
                    .setDEF("violin")
                    .setRotation([1, 0, 0, -0.5].to_java Java::float)
                    .setScale([100, 100, 100].to_java Java::float)
                    .setTranslation([0, 100, 0].to_java Java::float)
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setMaterial(Material.new()
                                ...
                                .setShininess(0.51)
                                .setSpecularColor([0.46, 0.46, 0.46].to_java Java::float)
                            )
                        )
                        .setGeometry(Text.new()
                            .setString(["Violin"].to_java Java::java.lang.String)
                            .setFontStyle(FontStyle.new()
                                .setDEF("ModelFontStyle")
                                .setFamily(["Times", "SERIF"].to_java Java::java.lang.String)
                                .setStyle("BOLD")
                            )
                        )
                    )
        ...
        .addChild(Transform.new()
            ...
            .setTranslation([933.475586, 0, 924.423218].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setDEF("WireColor_2")
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.105882, 0.694118, 0.580392].to_java Java::float)
                    )
                )
                .setGeometry(Sphere.new()
                    .setRadius(100.0)
            ...
            .addChild(Billboard.new()
                .addChild(Transform.new()
                    ...
                    .addChild(Shape.new()
                        ...
                        .setGeometry(Text.new()
                            .setString(["Saxophone"].to_java Java::java.lang.String)
                            .setFontStyle(FontStyle.new()
            ...
            .addChild(SpatialSound.new()
                ...
                .addChild(Gain.new()
                    .addChild(AudioClip.new()
                        ...
                        .setLoop(true)
                        .setUrl(["sound/violin.mp3", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/violin.mp3"].to_java Java::java.lang.String)
                    )
                )
            )
            .addChild(SpatialSound.new()
                ...
                .addChild(Gain.new()
                    .addChild(AudioClip.new()
                        ...
                        .setLoop(true)
                        .setUrl(["sound/saxophone.mp3", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/saxophone.mp3"].to_java Java::java.lang.String)
                    )
                )
            )
        )
    )
x3D0.toFileX3D "../data/SpatialAudioCameraAnimation.new.jruby.x3d"
x3D0.toFileJSON "../data/SpatialAudioCameraAnimation.new.jruby.json"

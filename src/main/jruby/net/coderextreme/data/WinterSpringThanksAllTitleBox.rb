...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setPosition([10, 11, -10].to_java Java::float)
            .setOrientation([-0.15, 0, 0, 0.2].to_java Java::float)
        )
        .addChild(Transform.new()
            .setDEF("WSThanksAllTitle")
            .setTranslation([10, 10, -15].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                    )
                    .setTexture(ImageTexture.new()
                        .setUrl(["images/WSThanksR2trimmed.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSThanksR2trimmed.png"].to_java Java::java.lang.String)
                    )
                )
                .setGeometry(Box.new()
...
x3D0.toFileX3D "../data/WinterSpringThanksAllTitleBox.new.jruby.x3d"
x3D0.toFileJSON "../data/WinterSpringThanksAllTitleBox.new.jruby.x3dj"

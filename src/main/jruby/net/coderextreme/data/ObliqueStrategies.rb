...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(NavigationInfo.new()
            .setType(["NONE"].to_java Java::java.lang.String)
        )
        .addChild(Background.new()
            .setSkyColor([0.419608, 0.427451, 1].to_java Java::float)
        )
        .addChild(Transform.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(["Oblique Strategies", "", "(Over One Hundred Worthwhile Dilemmas)", "", "by Brian Eno and Peter Schmidt"].to_java Java::java.lang.String)
            ...
            .addChild(Transform.new()
                .setScale([10, 3, 1].to_java Java::float)
                .addChild(Shape.new()
                    ...
                    .setGeometry(IndexedFaceSet.new()
                        ...
                        .setCoord(Coordinate.new()
                            .setPoint([1, 1, 0, 1, -1, 0, -1, -1, 0, -1, 1, 0].to_java Java::float)
                        )
                    )
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setAmbientIntensity(0.245763)
                            .setDiffuseColor([0.34773, 0.090909, 0.005289].to_java Java::float)
                            .setShininess(0.07)
                            .setSpecularColor([0.336735, 0.051091, 0.051091].to_java Java::float)
                            .setTransparency(0.8)
                        )
                    )
                )
        ...
        .addChild(Script.new()
            .setDEF("TextScript")
            .setUrl(["ObliqueStrategiesScript.js", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/ObliqueStrategiesScript.js"].to_java Java::java.lang.String)
          .addComments(CommentsBlock.new("initialize() method includes unit test to printAllStrategies() to console"))
          .addComments(CommentsBlock.new("TODO insert field definitions here (index string_changed previous next random) and then animate!"))
            .addField(Field.new()
                .setName("index")
        ...
        .addChild(Transform.new()
            ...
            .addChild(Sound.new()
                ...
                .setMinBack(20.0)
                .setMinFront(20.0)
            .addComments(CommentsBlock.new("Make sure the sound source AudioClip is audible at the user location"))
            .addComments(CommentsBlock.new("Not all X3D players seem to use the .mp3"))
            .addComments(CommentsBlock.new("&#38; is ampersand character, avoids escaping problems and inconsistencies in browsers and X3D players"))
            .addComments(CommentsBlock.new("%20 is space character used in uri/url encoding"))
                .setSource(AudioClip.new()
                    .setDEF("TextToSpeechAudioClip")
                    .setDescription("sends strategy text google translate")
                    .setUrl(["http://translate.google.com/translate_tts?tl=en&amp;q=Feed%20the%20recording%20back%20out%20of%20the%20medium", "translate_tts_mp3FileFormatNotSupported.wav", "https://x3dgraphics.com/examples/X3dForAdvancedModeling/Inspiration/translate_tts_mp3FileFormatNotSupported.wav"].to_java Java::java.lang.String)
                )
            )
            .addChild(ROUTE.new()
        ...
        .addChild(Transform.new()
            .setScale([0.4, 0.4, 0.4].to_java Java::float)
            .setTranslation([-3.2, 2.5, 0].to_java Java::float)
            .addChild(TouchSensor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(["previous"].to_java Java::java.lang.String)
                    .setFontStyle(FontStyle.new()
                        .setUSE("MessageFont")
                    )
                )
                .setAppearance(Appearance.new()
                    ...
                    .setMaterial(Material.new()
                        .setDiffuseColor([1, 0, 0.6].to_java Java::float)
                    )
                )
            )
            .addChild(Transform.new()
                .setScale([2, 0.6, 1].to_java Java::float)
                .addChild(Shape.new()
                    .setDEF("TransparentClickSurface")
              .addComments(CommentsBlock.new("support Selectable Text with a scalable IFS"))
                    .setGeometry(IndexedFaceSet.new()
                        .setCoordIndex([0, 1, 2, 3, -1].to_java Java::int)
                        .setSolid(false)
                        .setCoord(Coordinate.new()
        ...
        .addChild(Transform.new()
            .setScale([0.4, 0.4, 0.4].to_java Java::float)
            .setTranslation([3.5, 2.5, 0].to_java Java::float)
            .addChild(TouchSensor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(["next"].to_java Java::java.lang.String)
                    .setFontStyle(FontStyle.new()
                        .setUSE("MessageFont")
                    )
                )
            ...
            .addChild(Transform.new()
                .setScale([1.2, 0.6, 1].to_java Java::float)
                .addChild(Shape.new()
        ...
        .addChild(Transform.new()
            .setScale([0.4, 0.4, 0.4].to_java Java::float)
            .setTranslation([-3.3, -0.5, 0].to_java Java::float)
            .addChild(TouchSensor.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Text.new()
                    .setString(["random"].to_java Java::java.lang.String)
                    .setFontStyle(FontStyle.new()
                        .setUSE("MessageFont")
                    )
                )
            ...
            .addChild(Transform.new()
                .setScale([1.8, 0.6, 1].to_java Java::float)
                .addChild(Shape.new()
                    .setUSE("TransparentClickSurface")
                )
            )
        ...
        .addChild(Transform.new()
            ...
            .addChild(Anchor.new()
                ...
                .setUrl(["http://translate.google.com/translate_tts?tl=en&amp;q=Overtly%20resist%20change"].to_java Java::java.lang.String)
                .addChild(ROUTE.new()
                    .setFromField("textToSpeechUrl")
                    .setFromNode("TextScript")
                    .setToField("url")
                ...
                .addChild(Shape.new()
                    .setGeometry(Text.new()
                        .setString(["speech"].to_java Java::java.lang.String)
                        .setFontStyle(FontStyle.new()
                            .setUSE("MessageFont")
                        )
                    )
...
x3D0.toFileX3D "../data/ObliqueStrategies.new.jruby.x3d"
x3D0.toFileJSON "../data/ObliqueStrategies.new.jruby.json"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Transform.new()
            .setDEF("REDBALL")
            .setTranslation([1.615999, 0, 0].to_java Java::float)
            .addChild(Shape.new()
        ...
        .addChild(PositionInterpolator.new()
            ...
            .setKeyValue([0, 0, 0, 2, 0, 0, 0, 0, 0, -2, 0, 0, 0, 0, 0].to_java Java::float)
        )
        .addChild(PositionInterpolator.new()
            .setDEF("GREENINTERP2")
            .setKey([0, 0.25, 0.5, 0.75, 1].to_java Java::float)
            .setKeyValue([0, 0, 0, 0, 2, 0, 0, 0, 0, 0, -2, 0, 0, 0, 0].to_java Java::float)
        )
        .addChild(PositionInterpolator.new()
            .setDEF("BLUEINTERP3")
            .setKey([0, 0.25, 0.5, 0.75, 1].to_java Java::float)
...
x3D0.toFileX3D "../data/TestCycleTimeStart.new.jruby.x3d"
x3D0.toFileJSON "../data/TestCycleTimeStart.new.jruby.x3dj"

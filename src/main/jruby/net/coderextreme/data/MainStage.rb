...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(DirectionalLight.new()
            ...
            .setDirection([-0.5, -0.5, -0.5].to_java Java::float)
            .setGlobal(true)
        )
        .addChild(DirectionalLight.new()
            .setAmbientIntensity(1.0)
        ...
        .addChild(Viewpoint.new()
            ...
            .setOrientation([1, 0, 0, -0.449999988].to_java Java::float)
            .setPosition([0, 4, 10].to_java Java::float)
        )
        .addChild(Viewpoint.new()
            .setDEF("Scene_InclinedView")
            .setDescription("hanim_Inclined View")
            .setOrientation([-0.112999998, 0.992999971, 0.034699999, 0.671000004].to_java Java::float)
            .setPosition([2.619999886, 1.049999952, 4.059999943].to_java Java::float)
        )
        .addChild(Viewpoint.new()
            .setDEF("Scene_StageFrontView")
            .setDescription("hanim_Stage Front View")
            .setPosition([0, 1, 5].to_java Java::float)
        )
        .addChild(Viewpoint.new()
            .setDEF("Scene_FeetStageBottomView")
            .setDescription("hanim_feet View")
            .setOrientation([1, 0, 0, 1.570000052].to_java Java::float)
        ...
        .addChild(Viewpoint.new()
            ...
            .setOrientation([1, 0, 0, -1.570000052].to_java Java::float)
            .setPosition([0, 15, 0].to_java Java::float)
        )
        .addChild(Viewpoint.new()
            .setDEF("Scene_TopFrontCloseView")
            .setDescription("hanim_Head Top View")
            .setOrientation([1, 0, 0, -1.100000024].to_java Java::float)
            .setPosition([0, 8, 3].to_java Java::float)
        )
        .addChild(Group.new()
            .setDEF("HAnimStage")
            .addChild(Transform.new()
                .setDEF("cordsysfloor")
                .setScale([0.174999997, 0.174999997, 0.174999997].to_java Java::float)
                .addChild(Inline.new()
            ...
            .addChild(Transform.new()
                ...
                .setScale([1, 0.01, 1].to_java Java::float)
                ...
                .addChild(Shape.new()
                    ...
                    .setGeometry(Box.new()
                        .setSize([9, 1, 9].to_java Java::float)
                    )
                )
                .addChild(Transform.new()
                    .setDEF("Circle0")
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            ...
                            .setMaterial(Material.new()
                                .setAmbientIntensity(1.0)
                                .setDiffuseColor([0.699999988, 0, 0.899999976].to_java Java::float)
                                .setEmissiveColor([0.449999988, 0.449999988, 1].to_java Java::float)
                                .setShininess(1.0)
                                .setSpecularColor([0, 0, 1].to_java Java::float)
                            )
                        )
                ...
                .addChild(Transform.new()
                    .setDEF("Circle3")
                    .setScale([2, 1, 2].to_java Java::float)
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setUSE("LineColor")
                        )
                ...
                .addChild(Transform.new()
                    .setDEF("Circle4")
                    .setScale([3, 1, 3].to_java Java::float)
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setUSE("LineColor")
                        )
...
x3D0.toFileX3D "../data/MainStage.new.jruby.x3d"
x3D0.toFileJSON "../data/MainStage.new.jruby.json"

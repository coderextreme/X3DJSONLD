        ...
        .addChild(Transform.new()
            ...
            .addChild(Shape.new()
                .setGeometry(Extrusion.new()
                    ...
                    .setCrossSection([0, 0.8, 0.2, 1, 0.7, 0.95, 1, 0.5, 0.8, 0, 0.5, -0.3, 0, -0.7, -0.5, -0.3, -0.8, 0, -1, 0.5, -0.7, 0.95, -0.2, 1, 0, 0.8].to_java Java::float)
                    .setScale([0.01, 0.01, 0.8, 0.8, 1, 1, 0.8, 0.8, 0.01, 0.01].to_java Java::float)
                    .setSolid(false)
                    .setSpine([0, 0, 0, 0, 0.1, 0, 0, 0.5, 0, 0, 0.9, 0, 0, 1, 0].to_java Java::float)
                )
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.8, 0.3, 0.3].to_java Java::float)
                    )
                )
            )
        )
    )
x3D0.toFileX3D "../data/ExtrusionHeart.new.jruby.x3d"
x3D0.toFileJSON "../data/ExtrusionHeart.new.jruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setFrontUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"].to_java Java::java.lang.String)
            .setBackUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"].to_java Java::java.lang.String)
            .setLeftUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"].to_java Java::java.lang.String)
            .setRightUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"].to_java Java::java.lang.String)
            .setTopUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"].to_java Java::java.lang.String)
            .setBottomUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"].to_java Java::java.lang.String)
        )
        .addChild(Transform.new()
            .addChild(ParticleSystem.new()
                ...
                .addPhysics(BoundedPhysicsModel.new()
                ...
                .setAppearance(Appearance.new()
                    ...
                    .setTexture(ComposedCubeMapTexture.new()
                        ...
                        .setFrontTexture(ImageTexture.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"].to_java Java::java.lang.String)
                        )
                        .setBackTexture(ImageTexture.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"].to_java Java::java.lang.String)
                        )
                        .setLeftTexture(ImageTexture.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"].to_java Java::java.lang.String)
                        )
                        .setRightTexture(ImageTexture.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"].to_java Java::java.lang.String)
                        )
                        .setTopTexture(ImageTexture.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"].to_java Java::java.lang.String)
                        )
                        .setBottomTexture(ImageTexture.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"].to_java Java::java.lang.String)
                        )
                    )
                    .addShaders(ComposedShader.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.vs"].to_java Java::java.lang.String)
                        )
                        .addParts(ShaderPart.new()
                            .setType("FRAGMENT")
                            .setUrl(["https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs"].to_java Java::java.lang.String)
                        )
                        .addField(Field.new()
...
x3D0.toFileX3D "../data/fwparticleflowersTidy.new.jruby.x3d"
x3D0.toFileJSON "../data/fwparticleflowersTidy.new.jruby.x3dj"

...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Script.new()
            .setDEF("ENGINE")
            .setUrl(["BoxMan.js", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Legacy/BoxMan.js"].to_java Java::java.lang.String)
...
x3D0.toFileX3D "../data/BoxMan4.new.jruby.x3d"
x3D0.toFileJSON "../data/BoxMan4.new.jruby.json"

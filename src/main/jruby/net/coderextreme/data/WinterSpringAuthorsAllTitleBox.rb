...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        .addMeta(Meta.new()
            .setName("title")
            .setContent("WinterAndSpringAuthorsAllTitleBox.x3d")
        )
        .addMeta(Meta.new()
            .setName("description")
            .setContent("Credits for scene authors.")
        )
        .addMeta(Meta.new()
            .setName("creator")
        ...
        .addMeta(Meta.new()
            .setName("identifier")
            .setContent("https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/WinterAndSpringAuthorsAllTitleBox.x3d")
        )
    )
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("WinterAndSpringAuthorsAllTitleBox.x3d")
        )
        .addChild(Viewpoint.new()
            .setDEF("WSAuthorsAllTitleView")
            .setDescription("Look at Authors title")
            .setPosition([10, 11, 0].to_java Java::float)
            .setOrientation([-0.15, 0, 0, 0.2].to_java Java::float)
        )
        .addChild(Transform.new()
            .setDEF("WSAuthorsTitle")
            .setTranslation([10, 10, -5].to_java Java::float)
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                    )
                    .setTexture(ImageTexture.new()
                        .setUrl(["images/WSAuthorsAll.png", "https://www.web3d.org/x3d/content/examples/HumanoidAnimation/WinterAndSpring/images/WSAuthorsAll.png"].to_java Java::java.lang.String)
                    )
                )
                .setGeometry(Box.new()
...
x3D0.toFileX3D "../data/WinterSpringAuthorsAllTitleBox.new.jruby.x3d"
x3D0.toFileJSON "../data/WinterSpringAuthorsAllTitleBox.new.jruby.x3dj"

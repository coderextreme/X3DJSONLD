        ...
        .addChild(Shape.new()
            ...
            .setGeometry(IndexedFaceSet.new()
                ...
                .setCoord(Coordinate.new()
                    .setPoint([-2, 1.5, 1, -2, -1.5, 1, 2, 1.5, 1, 2, -1.5, 1, 2, 1.5, -1, 2, -1.5, -1, -2, 1.5, -1, -2, -1.5, -1].to_java Java::float)
                )
            )
        )
    )
x3D0.toFileX3D "../data/indexedfacesetPixeltexture_entire.new.jruby.x3d"
x3D0.toFileJSON "../data/indexedfacesetPixeltexture_entire.new.jruby.x3dj"

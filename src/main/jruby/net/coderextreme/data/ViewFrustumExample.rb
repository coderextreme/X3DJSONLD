...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setPosition([0, 40, 0].to_java Java::float)
        )
        .addChild(Viewpoint.new()
        ...
        .addChild(Viewpoint.new()
            ...
            .setOrientation([0.8005, 0.5926, 0.0898, -0.3743].to_java Java::float)
            .setPosition([-5, 5, 20].to_java Java::float)
        )
        ...
        .addChild(ExternProtoDeclare.new()
            ...
            .setUrl(["ViewFrustumPrototype.x3d#ViewFrustum"].to_java Java::java.lang.String)
            .addField(Field.new()
        ...
        .addChild(Inline.new()
            .setDEF("GridXZ")
            .setUrl(["GridXZ_20x20Fixed.x3d"].to_java Java::java.lang.String)
        )
        .addChild(Transform.new()
            .setScale([5, 5, 5].to_java Java::float)
            .addChild(Inline.new()
                .setDEF("CoordinateAxes")
                .setUrl(["CoordinateAxes.x3d"].to_java Java::java.lang.String)
            )
        )
    )
x3D0.toFileX3D "../data/ViewFrustumExample.new.jruby.x3d"
x3D0.toFileJSON "../data/ViewFrustumExample.new.jruby.x3dj"

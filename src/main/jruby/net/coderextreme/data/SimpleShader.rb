...
x3D0 = X3D.new
    ...
    .setVersion("4.0")
    .setHead(Head.new()
        .addComments(CommentsBlock.new("meta content='under development' name='warning'/"))
                    ...
                    .addChild(Shape.new()
                        .setAppearance(Appearance.new()
                            .setMaterial(Material.new()
                                .setDiffuseColor([0.5, 0.5, 0.9].to_java Java::float)
                            )
            ...
            .setMetadata(MetadataSet.new()
                ...
                .addValue(MetadataSet.new()
                    ...
                    .addValue(MetadataSet.new()
                        ...
                        .setDEF("nodes")
                        .setReference("http://titania.create3000.de")
                .addComments(CommentsBlock.new("NULL"))
                    )
                )
                .addValue(MetadataSet.new()
                    ...
                    .addValue(MetadataString.new()
                        ...
                        .setDEF("type")
                        .setReference("http://titania.create3000.de")
                        .setValue(["EXAMINE"].to_java Java::java.lang.String)
                    )
                )
                .addValue(MetadataSet.new()
                    .setName("Viewpoint")
                    .setDEF("Viewpoint")
                    .setReference("http://titania.create3000.de")
                    .addValue(MetadataDouble.new()
                        .setName("position")
                        .setDEF("position")
                        .setReference("http://titania.create3000.de")
                        .setValue([6.24067728185014, 0.00250837343276661, 2.92117542307615].to_java Java::double)
                    )
                    .addValue(MetadataDouble.new()
                        .setName("orientation")
                        .setDEF("orientation")
                        .setReference("http://titania.create3000.de")
                        .setValue([-0.110173424710488, 0.990158061907379, -0.0863065984000336, 1.21146676119191].to_java Java::double)
                    )
                    .addValue(MetadataDouble.new()
                        .setName("centerOfRotation")
                        .setDEF("centerOfRotation")
                        .setReference("http://titania.create3000.de")
                        .setValue([-0.808320198626341, -0.358072370409949, 0.22817191560906].to_java Java::double)
                    )
                )
            )
        )
...
x3D0.toFileX3D "../data/SimpleShader.new.jruby.x3d"
x3D0.toFileJSON "../data/SimpleShader.new.jruby.x3dj"

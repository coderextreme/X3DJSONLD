...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(Background.new()
            .setSkyColor([0.2, 0.2, 0.21].to_java Java::float)
        )
        .addChild(Viewpoint.new()
            .setOrientation([1, 0, 0, -0.5].to_java Java::float)
            .setPosition([0, 500, 600].to_java Java::float)
            .setRetainUserOffsets(true)
        )
        .addChild(Transform.new()
            .setDEF("PowerR")
            .setTranslation([100, 400, 400].to_java Java::float)
            .addChild(Transform.new()
                .setRotation([1, 0, 0, -0.5].to_java Java::float)
                .setTranslation([0, 40, 0].to_java Java::float)
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setDEF("audio_emit")
                        .setMaterial(Material.new()
                            .setDiffuseColor([0, 1, 0].to_java Java::float)
                            .setEmissiveColor([0.8, 0.8, 0.8].to_java Java::float)
                            .setSpecularColor([0.01, 0.01, 0.01].to_java Java::float)
                        )
                    )
                    .setGeometry(Box.new()
                        .setSize([10, 80, 0.01].to_java Java::float)
                    )
                )
            )
            .addChild(Transform.new()
                .setRotation([1, 0, 0, -0.5].to_java Java::float)
                .setTranslation([-2.7, 37, 0].to_java Java::float)
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setDEF("audio_emit2")
                        .setMaterial(Material.new()
                        ...
                        .setTexture(ImageTexture.new()
                            .setUrl(["images/line.png", "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/images/line.png"].to_java Java::java.lang.String)
                        )
                    )
                    .setGeometry(Box.new()
                        .setSize([25, 83, 0.01].to_java Java::float)
                    )
                )
            )
            .addChild(Transform.new()
                .setDEF("volumeRight")
                .setRotation([1, 0, 0, -0.5].to_java Java::float)
                .setScale([10, 10, 10].to_java Java::float)
                .setTranslation([0, -10, 0].to_java Java::float)
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setMaterial(Material.new()
                            .setAmbientIntensity(0.0933)
                            .setDiffuseColor([0.345, 0.345, 0.882].to_java Java::float)
                            .setShininess(0.51)
                            .setSpecularColor([0.46, 0.46, 0.46].to_java Java::float)
                        )
                    )
                    .setGeometry(Text.new()
                        .setString(["Right Channel Volume"].to_java Java::java.lang.String)
        ...
        .addChild(Transform.new()
            ...
            .addChild(Transform.new()
                .setRotation([1, 0, 0, -0.5].to_java Java::float)
                .setTranslation([13.2, 37, 0].to_java Java::float)
                .addChild(Shape.new()
                    .setAppearance(Appearance.new()
                        .setDEF("audio_emit4")
                        .setMaterial(Material.new()
            ...
            .addChild(Transform.new()
                ...
                .addChild(Shape.new()
                    ...
                    .setGeometry(Text.new()
                        .setString(["Left Channel Volume"].to_java Java::java.lang.String)
                        .setFontStyle(FontStyle.new()
        ...
        .addChild(Transform.new()
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setDEF("floor")
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.1, 0.1, 0.1].to_java Java::float)
                        .setShininess(0.8)
                        .setSpecularColor([0.5, 0.6, 0.7].to_java Java::float)
                    )
                )
                .setGeometry(Box.new()
                    .setSize([1500, 10, 500].to_java Java::float)
                )
            )
        )
        ...
        .addChild(ChannelSplitter.new()
            ...
            .addOutputs(AudioClip.new()
                ...
                .setUrl(["sound/violin.mp3", "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/sound/violin.mp3"].to_java Java::java.lang.String)
            )
        )
        .addChild(Transform.new()
            .setDEF("Audio3")
            ...
            .addChild(Shape.new()
                .setAppearance(Appearance.new()
                    .setDEF("audio_emit5")
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.3, 1, 0.3].to_java Java::float)
                        .setEmissiveColor([0.8, 0.8, 0.8].to_java Java::float)
                        .setSpecularColor([0.01, 0.01, 0.01].to_java Java::float)
                    )
                    .setTexture(ImageTexture.new()
                        .setUrl(["images/loudspeaker.png", "https://www.web3d.org/x3d/content/examples/X3dForAdvancedModeling/AudioSpatialSound/images/loudspeaker.png"].to_java Java::java.lang.String)
                    )
                )
                .setGeometry(Box.new()
                    .setSize([100, 100, 0.001].to_java Java::float)
                )
            )
        )
    )
x3D0.toFileX3D "../data/SplitChannels.new.jruby.x3d"
x3D0.toFileJSON "../data/SplitChannels.new.jruby.x3dj"

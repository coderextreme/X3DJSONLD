...
x3D0 = X3D.new
    ...
    .setScene(Scene.new()
        ...
        .addChild(NavigationInfo.new()
            .setAvatarSize([0.25, 1.60000002384186, 0.75].to_java Java::float)
        ...
        .addChild(Background.new()
            .setTopUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"].to_java Java::java.lang.String)
            .setBackUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"].to_java Java::java.lang.String)
            .setLeftUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"].to_java Java::java.lang.String)
            .setFrontUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"].to_java Java::java.lang.String)
            .setRightUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"].to_java Java::java.lang.String)
            .setBottomUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"].to_java Java::java.lang.String)
        )
            ...
            .addChild(Shape.new()
                ...
                .setAppearance(Appearance.new()
                    .setMaterial(Material.new()
                        .setDiffuseColor([0.699999988079071, 0.699999988079071, 0.699999988079071].to_java Java::float)
                    ...
                    .addShaders(ComposedShader.new()
                        ...
                        .addField(Field.new()
                            ...
                            .addChild(ComposedCubeMapTexture.new()
                                .setBackTexture(ImageTexture.new()
                                    .setUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_back.png"].to_java Java::java.lang.String)
                                )
                                .setBottomTexture(ImageTexture.new()
                                    .setUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_bottom.png"].to_java Java::java.lang.String)
                                )
                                .setFrontTexture(ImageTexture.new()
                                    .setUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_front.png"].to_java Java::java.lang.String)
                                )
                                .setLeftTexture(ImageTexture.new()
                                    .setUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_left.png"].to_java Java::java.lang.String)
                                )
                                .setRightTexture(ImageTexture.new()
                                    .setUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_right.png"].to_java Java::java.lang.String)
                                )
                                .setTopTexture(ImageTexture.new()
                                    .setUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/resources/images/all_probes/stpeters_cross/stpeters_top.png"].to_java Java::java.lang.String)
                                )
                            )
                        )
                        .addField(Field.new()
                        ...
                        .addParts(ShaderPart.new()
                            .setUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/shaders/castle.vs"].to_java Java::java.lang.String)
                            .setType("VERTEX")
                        )
                        .addParts(ShaderPart.new()
                            .setDEF("commonfs")
                            .setUrl(["file:/C:/Users/jcarl/X3DJSONLD/src/main/shaders/castle.fs"].to_java Java::java.lang.String)
                            .setType("FRAGMENT")
                        )
                    )
                )
...
x3D0.toFileX3D "../data/ballcge.new.jruby.x3d"
x3D0.toFileJSON "../data/ballcge.new.jruby.x3dj"

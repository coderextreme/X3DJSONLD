...
x3D0 = X3D.new
    ...
    .setHead(Head.new()
        ...
        .addMeta(Meta.new()
            .setName("title")
            .setContent("OrientationInterpolator.x3d")
        )
        .addMeta(Meta.new()
            .setName("creator")
    ...
    .setScene(Scene.new()
        .addChild(WorldInfo.new()
            .setTitle("OrientationInterpolator.x3d")
        )
        .addComments(CommentsBlock.new("<OrientationInterpolator DEF='Stop_l_midtarsal_RotationInterpolator' key='0 0.5 1' keyValue='0 0 1 0 0 0 1 0 0 0 1 0'/>"))
    )
x3D0.toFileX3D "../data/OrientationInterpolator.new.jruby.x3d"
x3D0.toFileJSON "../data/OrientationInterpolator.new.jruby.x3dj"

...
"        }")                )
        ...
        .addChild(ProtoInstance.new()
          ...
          .addComments(CommentsBlock.new("<fieldValue name='set_startpoint'> </fieldValue> <fieldValue name='set_endpoint'> </fieldValue>"))
        )
        .addChild(ROUTE.new()
            .setFromNode("G1")
            .setFromField("translation_changed")
...
x3D0.toFileX3D "../data/x3dconnector.new.jruby.x3d"
x3D0.toFileJSON "../data/x3dconnector.new.jruby.json"

        ...
        .addChild(Shape.new()
            ...
            .setGeometry(IndexedFaceSet.new()
                ...
                .setTexCoord(TextureCoordinate.new()
                    .setPoint([0.5, 1, 0.5, 0.5, 1, 1, 1, 0.5].to_java Java::float)
                )
            )
        )
    )
x3D0.toFileX3D "../data/indexedfaceset_pixeltexture_part.new.jruby.x3d"
x3D0.toFileJSON "../data/indexedfaceset_pixeltexture_part.new.jruby.x3dj"

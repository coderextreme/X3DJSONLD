    ...
    .setScene(Scene.new()
        ...
        .addChild(Group.new()
            .addChild(ExternProtoDeclare.new()
                .setName("FlowerProto")
                .setUrl(["../data/flowerproto.x3d#FlowerProto", "https://coderextreme.net/X3DJSONLD/src/main/data/flowerproto.x3d#FlowerProto"].to_java Java::java.lang.String)
                .addField(Field.new()
                    .setName("vertex")
...
x3D0.toFileX3D "../data/sphereflowers.new.jruby.x3d"
x3D0.toFileJSON "../data/sphereflowers.new.jruby.json"

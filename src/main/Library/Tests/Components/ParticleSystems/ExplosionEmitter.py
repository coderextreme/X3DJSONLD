...
MetadataDouble(name="position", DEF="position", reference="http://titania.create3000.de", value=[float(0),float(0),float(10)]),
...
field(name="currentValue", accessType="initializeOnly", type="SFInt32", value=2000)
], 
...
ParticleSystem(DEF="_1", geometryType="POINT", maxParticles=2000, particleLifetime=4, lifetimeVariation=0.5, particleSize=((1,1)), colorKey=(float(0),float(0.2),float(0.5),float(0.7),float(0.8),float(1)), 
emitter=(
ExplosionEmitter=(speed=0.5, variation=0.5, mass=0.1, surfaceArea=0.1)), physics=(
WindPhysicsModel(direction=((0,1,0)), speed=0.7, gustiness=1.7, turbulence=0.3),
WindPhysicsModel(speed=0.5, gustiness=2)), 
color=
ColorRGBA(color=[(1,0.38,0,0),(1,0.58,0.06,0.01),(1,0.37,0,0.1),(1,0.05,0,0),(0,0,0,0.015),(0,0,0,0)]), 
appearance=
Appearance(
lineProperties=(
LineProperties(linewidthScaleFactor=10)))),
...
geometry=
Text(DEF="_2", string=["numParticles 2337"], solid=True, 
fontStyle=
FontStyle(family=["SANS"], justify=["END"])))]),
Transform(DEF="TransparancySlider", translation=((0.025,-0.923,-3.49096e-06)), center=((0,-0.027,0)), children=[
Transform(DEF="IndexedLineSet_1", children=[
Shape(
appearance=
Appearance(
lineProperties=(

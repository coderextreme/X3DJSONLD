...
MetadataDouble(name="position", DEF="position", reference="http://titania.create3000.de", value=[float(235.02507019043),float(-304.458618164062),float(206.560821533203)]),
MetadataDouble(name="orientation", DEF="orientation", reference="http://titania.create3000.de", value=[float(0.838011514790102),float(0.301117702286433),float(0.455043767619048),float(1.16040551972849)]),
...
Appearance(
lineProperties=(
LineProperties(linewidthScaleFactor=3.24)), 
material=
Material(DEF="Rococo17", ambientIntensity=0.187004, diffuseColor=((0.640987,0.460097,0.748016)), specularColor=((0.251984,0.251984,0.251984)), emissiveColor=((0.640987,0.460097,0.748016)), shininess=0.612121)))])])]))),

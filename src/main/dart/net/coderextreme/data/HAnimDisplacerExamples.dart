        ...
        head(
          ...
          meta_ : [
            meta(
              ...
              content_ : SFString('HAnimDisplacerExamples.x3d')),

            meta(
              name_ : SFString('description'),
              content_ : SFString('This model illustrates use of the HAnimDisplacer node.')),
            ...
            meta(
              ...
              content_ : SFString('9 January 2014')),
            ...
            meta(
              name_ : SFString('TODO'),
              content_ : SFString('Provide clear HAnimDisplacer examples that other can use, with initial displacements of head and left-hand index figure.')),

            meta(
              name_ : SFString('identifier'),
              content_ : SFString('http://www.web3d.org/x3d/content/examples/HumanoidAnimation/MotionAnimation/HAnimDisplacerExamples.x3d')),

            meta(
              name_ : SFString('reference'),
              content_ : SFString('../Legacy/JoeSkinTexcoordDisplacerKick.x3d'))]),
      Scene_ : 
        Scene(
          children_ : [
            WorldInfo(
                    ...
                    HAnimJoint(
                      ...
                      children_ : [
                        HAnimSegment(
                          ...
                          children_ : [
                            HAnimSite(
                              DEF_ : SFString('Joe_humanoid_sacrum_pt'),
                              name_ : SFString('humanoid_sacrum_pt'),
                              translation_ : SFVec3f([SFDouble(0), SFDouble(0.875), SFDouble(0)]),
                              children_ : [
                                Shape(
                                  DEF_ : SFString('RedBox'),
                                  appearance_ : 
                                    Appearance(
                                      material_ : 
                                        Material(
                                  ...
                                  geometry_ : 
                                    Box(
                                      size_ : SFVec3f([SFDouble(0.01), SFDouble(0.01), SFDouble(0.01)])))]),

                            HAnimSite(
                              DEF_ : SFString('Joe_humanoid_origin_view'),
                              name_ : SFString('humanoid_origin_view'),
                              children_ : [
                                Transform(
                                  DEF_ : SFString('HAnimHumanoidOrigin'),
                                  scale_ : SFVec3f([SFDouble(0.175), SFDouble(0.175), SFDouble(0.175)]),
                                  children_ : [
                                    Viewpoint(
                                      DEF_ : SFString('ViewBodyRootAxes'),
                                      description_ : SFString('Joe_HAnim Root Coordinate Axes View')),
                                  child_ : 
                                    Shape(
                                                                                                    ...
                                                                                                    HAnimJoint(
                                                                                                      ...
                                                                                                      children_ : [
                                                                                                        HAnimJoint(
                                                                                                          ...
                                                                                                          rotation_ : SFRotation([SFDouble(-0.999999999999989), SFDouble(0), SFDouble(0), SFDouble(0.177942317505106)]),
                                                                                                                        ...
                                                                                                                        HAnimJoint(
                                                                                                                          ...
                                                                                                                          children_ : [
                                                                                                                            HAnimJoint(
                                                                                                                              ...
                                                                                                                              displacers_ : 
                                                                                                                                HAnimDisplacer(
                                                                                                                                  DEF_ : SFString('Joe_L_finger_tips'),
                                                                                                                                  name_ : SFString('Joe_L_finger_tips_raiser_action'),
                                                                                                                                  weight_ : 0.2205769,
                                                                                                                                  coordIndex_ : MFInt32([SFInt32(172), SFInt32(173), SFInt32(174)]),
                                                                                                                                  displacements_ : MFVec3f([SFVec3f([0,-1.15,0]),SFVec3f([0,-1.15,0]),SFVec3f([0,-1.15,0])])),
                                                                                                                              children_ : [
                                                                                                                                HAnimJoint(
            ...
            Group(
              DEF_ : SFString('SkullDisplacerAnimationGroup'),
              children_ : [
                TimeSensor(
                  DEF_ : SFString('skull_tipTimer'),
                  cycleInterval_ : 5.73,
                  loop_ : true),

                ScalarInterpolator(
                  DEF_ : SFString('skull_tipInterp'),
            ...
            Group(
              DEF_ : SFString('Joe_L_finger_tipsDisplacerAnimationGroup'),
              children_ : [
                TimeSensor(
                  DEF_ : SFString('L_finger_tipsTimer'),
                  cycleInterval_ : 4.73,
                  loop_ : true),

                ScalarInterpolator(
                  DEF_ : SFString('L_finger_tipsInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.1), SFFloat(0.2), SFFloat(0.35), SFFloat(0.6), SFFloat(0.7), SFFloat(0.85), SFFloat(0.88), SFFloat(0.94), SFFloat(0.97), SFFloat(1)]),
                  keyValue_ : MFFloat([SFFloat(0), SFFloat(0), SFFloat(0), SFFloat(0), SFFloat(0.2), SFFloat(0.4), SFFloat(1), SFFloat(0), SFFloat(1), SFFloat(0.4), SFFloat(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('L_shoulderDispRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.4), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(-1), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)]))]),
            ...
            ROUTE(
              fromNode_ : SFString('skull_tipTimer'),
              fromField_ : SFString('fraction_changed'),
              toNode_ : SFString('skull_tipInterp'),
              toField_ : SFString('set_fraction')),

            ROUTE(
              fromNode_ : SFString('skull_tipInterp'),
              fromField_ : SFString('value_changed'),
              toNode_ : SFString('Joe_skull_tip'),
              toField_ : SFString('set_weight')),

            ROUTE(
              fromNode_ : SFString('L_finger_tipsTimer'),
              fromField_ : SFString('fraction_changed'),
              toNode_ : SFString('L_finger_tipsInterp'),
              toField_ : SFString('set_fraction')),

            ROUTE(
              fromNode_ : SFString('L_finger_tipsInterp'),
              fromField_ : SFString('value_changed'),
              toNode_ : SFString('Joe_L_finger_tips'),
              toField_ : SFString('set_weight')),

            ROUTE(
              fromNode_ : SFString('L_finger_tipsTimer'),
              fromField_ : SFString('fraction_changed'),
              toNode_ : SFString('L_shoulderDispRotInterp'),
              toField_ : SFString('set_fraction')),

            ROUTE(
              fromNode_ : SFString('L_shoulderDispRotInterp'),
              fromField_ : SFString('value_changed'),

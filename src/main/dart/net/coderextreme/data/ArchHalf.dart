                ...
                IndexedFaceSet(
                  ...
                  coord_ : 
                    Coordinate(
                      ...
                      point_ : MFVec3f([SFVec3f([2,0,0]),SFVec3f([1.997498,0.1,0]),SFVec3f([1.989975,0.2,0]),SFVec3f([1.977372,0.3,0]),SFVec3f([1.959592,0.4,0]),SFVec3f([1.936492,0.5,0]),SFVec3f([1.907878,0.6,0]),SFVec3f([1.873499,0.7,0]),SFVec3f([1.83303,0.8,0]),SFVec3f([1.786057,0.9,0]),SFVec3f([1.732051,1,0]),SFVec3f([1.670329,1.1,0]),SFVec3f([1.6,1.2,0]),SFVec3f([1.519868,1.3,0]),SFVec3f([1.428286,1.4,0]),SFVec3f([1.322876,1.5,0]),SFVec3f([1.2,1.6,0]),SFVec3f([1.053565,1.7,0]),SFVec3f([0.9020948,1.785,0]),SFVec3f([0.7599342,1.85,0]),SFVec3f([0.6244998,1.9,0]),SFVec3f([0.5425634,1.925,0]),SFVec3f([0.4444097,1.95,0]),SFVec3f([0.3618163,1.967,0]),SFVec3f([0.2821347,1.98,0]),SFVec3f([0.1997498,1.99,0]),SFVec3f([0.1671855,1.993,0]),SFVec3f([0.1413329,1.995,0]),SFVec3f([0.1095034,1.997,0]),SFVec3f([0.08942036,1.998,0]),SFVec3f([0.06323764,1.999,0]),SFVec3f([0,2,0]),SFVec3f([-0.06323764,1.999,0]),SFVec3f([-0.08942036,1.998,0]),SFVec3f([-0.1095034,1.997,0]),SFVec3f([-0.1413329,1.995,0]),SFVec3f([-0.1671855,1.993,0]),SFVec3f([-0.1997498,1.99,0]),SFVec3f([-0.2821347,1.98,0]),SFVec3f([-0.3618163,1.967,0]),SFVec3f([-0.4444097,1.95,0]),SFVec3f([-0.5425634,1.925,0]),SFVec3f([-0.6244998,1.9,0]),SFVec3f([-0.7599342,1.85,0]),SFVec3f([-0.9020948,1.785,0]),SFVec3f([-1.053565,1.7,0]),SFVec3f([-1.2,1.6,0]),SFVec3f([-1.322876,1.5,0]),SFVec3f([-1.428286,1.4,0]),SFVec3f([-1.519868,1.3,0]),SFVec3f([-1.6,1.2,0]),SFVec3f([-1.670329,1.1,0]),SFVec3f([-1.732051,1,0]),SFVec3f([-1.786057,0.9,0]),SFVec3f([-1.83303,0.8,0]),SFVec3f([-1.873499,0.7,0]),SFVec3f([-1.907878,0.6,0]),SFVec3f([-1.936492,0.5,0]),SFVec3f([-1.959592,0.4,0]),SFVec3f([-1.977372,0.3,0]),SFVec3f([-1.989975,0.2,0]),SFVec3f([-1.997498,0.1,0]),SFVec3f([-2,0,0]),SFVec3f([2,0,3]),SFVec3f([1.997498,0.1,3]),SFVec3f([1.989975,0.2,3]),SFVec3f([1.977372,0.3,3]),SFVec3f([1.959592,0.4,3]),SFVec3f([1.936492,0.5,3]),SFVec3f([1.907878,0.6,3]),SFVec3f([1.873499,0.7,3]),SFVec3f([1.83303,0.8,3]),SFVec3f([1.786057,0.9,3]),SFVec3f([1.732051,1,3]),SFVec3f([1.670329,1.1,3]),SFVec3f([1.6,1.2,3]),SFVec3f([1.519868,1.3,3]),SFVec3f([1.428286,1.4,3]),SFVec3f([1.322876,1.5,3]),SFVec3f([1.2,1.6,3]),SFVec3f([1.053565,1.7,3]),SFVec3f([0.9020948,1.785,3]),SFVec3f([0.7599342,1.85,3]),SFVec3f([0.6244998,1.9,3]),SFVec3f([0.5425634,1.925,3]),SFVec3f([0.4444097,1.95,3]),SFVec3f([0.3618163,1.967,3]),SFVec3f([0.2821347,1.98,3]),SFVec3f([0.1997498,1.99,3]),SFVec3f([0.1671855,1.993,3]),SFVec3f([0.1413329,1.995,3]),SFVec3f([0.1095034,1.997,3]),SFVec3f([0.08942036,1.998,3]),SFVec3f([0.06323764,1.999,3]),SFVec3f([0,2,3]),SFVec3f([-0.06323764,1.999,3]),SFVec3f([-0.08942036,1.998,3]),SFVec3f([-0.1095034,1.997,3]),SFVec3f([-0.1413329,1.995,3]),SFVec3f([-0.1671855,1.993,3]),SFVec3f([-0.1997498,1.99,3]),SFVec3f([-0.2821347,1.98,3]),SFVec3f([-0.3618163,1.967,3]),SFVec3f([-0.4444097,1.95,3]),SFVec3f([-0.5425634,1.925,3]),SFVec3f([-0.6244998,1.9,3]),SFVec3f([-0.7599342,1.85,3]),SFVec3f([-0.9020948,1.785,3]),SFVec3f([-1.053565,1.7,3]),SFVec3f([-1.2,1.6,3]),SFVec3f([-1.322876,1.5,3]),SFVec3f([-1.428286,1.4,3]),SFVec3f([-1.519868,1.3,3]),SFVec3f([-1.6,1.2,3]),SFVec3f([-1.670329,1.1,3]),SFVec3f([-1.732051,1,3]),SFVec3f([-1.786057,0.9,3]),SFVec3f([-1.83303,0.8,3]),SFVec3f([-1.873499,0.7,3]),SFVec3f([-1.907878,0.6,3]),SFVec3f([-1.936492,0.5,3]),SFVec3f([-1.959592,0.4,3]),SFVec3f([-1.977372,0.3,3]),SFVec3f([-1.989975,0.2,3]),SFVec3f([-1.997498,0.1,3]),SFVec3f([-2,0,3]),SFVec3f([-2,-1,3]),SFVec3f([-2.5,-1,3]),SFVec3f([-2.5,2.5,3]),SFVec3f([2.5,2.5,3]),SFVec3f([2.5,-1,3]),SFVec3f([2,-1,3]),SFVec3f([-2,-1,0]),SFVec3f([-2.5,-1,0]),SFVec3f([-2.5,2.5,0]),SFVec3f([2.5,2.5,0]),SFVec3f([2.5,-1,0]),SFVec3f([2,-1,0]),SFVec3f([2.5,0,3]),SFVec3f([2.5,0,0]),SFVec3f([-2.5,0,3]),SFVec3f([-2.5,0,0]),SFVec3f([-2.5,2,3]),SFVec3f([-2,2,3]),SFVec3f([-2,2,0]),SFVec3f([-2.5,2,0]),SFVec3f([-2,2.5,3]),SFVec3f([-2,2.5,0]),SFVec3f([0,2.5,3]),SFVec3f([0,2.5,0]),SFVec3f([2,2,3]),SFVec3f([2.5,2,3]),SFVec3f([2.5,2,0]),SFVec3f([2,2,0]),SFVec3f([2,2.5,3]),SFVec3f([2,2.5,0])]))))]));
void main() { exit(0); }

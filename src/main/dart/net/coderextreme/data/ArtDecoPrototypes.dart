            ...
            Anchor(
              ...
              children_ : [
                Shape(
                  ...
                  geometry_ : 
                    Text(
                      string_ : MFString([SFString("ArtDecoExamples.x3d"), SFString("is a Materials Prototype declaration file."), SFString("For an example scene using these node,"), SFString("click this text and view"), SFString("ArtDecoExamples.x3d")]),
                      fontStyle_ : 
                        FontStyle(

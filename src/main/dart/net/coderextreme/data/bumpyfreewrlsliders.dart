        ...
        head(
          ...
          meta_ : [
            meta(
              ...
              content_ : SFString('bumpyfreewrlsliders.x3d')),

            meta(
              name_ : SFString('description'),
              content_ : SFString('Bumpy Orbitals with Sliders for FreeWRL')),
            ...
            meta(
              ...
              content_ : SFString('https:/coderextreme.net/X3DJSONLD/src/main/data/bumpyfreewrlsliders.x3d')),
            ...
            LayerSet(
              ...
              layers_ : 
                Layer(
                  ...
                  children_ : [
                    NavigationInfo(
                      type_ : MFString([SFString("EXAMINE"), SFString("FLY"), SFString("LOOKAT"), SFString("ANY")]),
                      ...
                      ProtoInterface_ : 
                        ProtoInterface(
                          field_ : [
                            ...
                            field(
                              type_ : SFString("SFVec3f"),
                              name_ : SFString('numberTranslation'),
                              accessType_ : SFString("inputOutput"),
                              value_ : SFString('0.2 0 0')),
                              ...
                              children_ : [
                                    ...
                                    Transform(
                                      ...
                                      children_ : [
                                        PlaneSensor(
                                          ...
                                          maxPosition_ : SFVec2f([SFDouble(2), SFDouble(0)])),
                                              ...
                                              IS_ : 
                                                IS(
                                                  connect_ : [
                                                    connect(
                                                      nodeField_ : SFString('translation'),
                                                      protoField_ : SFString('numberTranslation'))]),
                                              child_ : 
                                                Shape(
                                                  geometry_ : 
                                                    Text(
                                                      DEF_ : SFString('protoNumber'),
                                ...
                                Script(
                                  ...
                                  field_ : [
                                    ...
                                    field(
                                      type_ : SFString("MFString"),
                                      name_ : SFString('protoNumber_changed'),
                                      accessType_ : SFString("inputOutput"),
                                      value_ : SFString('\"0.0\"')),
	    ...
	    Browser.println(protoParameterName);
                  ...
                  layout_ : 
                    Layout(
                      ...
                      offset_ : MFFloat([SFFloat(-0.5), SFFloat(0)]))],
                  viewport_ : 
                    Viewport()))));
void main() { exit(0); }

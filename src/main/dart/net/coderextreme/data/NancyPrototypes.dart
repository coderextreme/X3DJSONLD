        ...
        head(
          meta_ : [
            meta(
              ...
              content_ : SFString('NancyPrototypes.x3d')),
            ...
            meta(
              ...
              content_ : SFString('Canonical HAnim 1.1 specification example, using ProtoDeclaration and ProtoInstance instead of native X3D tags. Prototype definitions are a compatible combination of version 1.0 and 2.0 prototype interfaces.')),

            meta(
              name_ : SFString('warning'),
              content_ : SFString('using ProtoDeclare is only for developmental experimentation, use X3D native tags for Humanoids instead')),
            ...
            meta(
              name_ : SFString('TODO'),
              content_ : SFString('Material color of neck and arms is ignored/incorrect in Xj3D, possily DEF/USE problem.')),

            meta(
              name_ : SFString('identifier'),
              content_ : SFString('https://www.web3d.org/x3d/content/examples/HumanoidAnimation/Prototypes/NancyPrototypes.x3d')),
          ...
          /*Start scene graph.*/
            ...
            ProtoInstance(
              ...
              fieldValue_ : [
                ...
                fieldValue(
                  name_ : SFString('info'),
                  value_ : SFString('\"humanoidVersion=Nancy V1.2b\" \"authorName=Cindy Ballreich\" \"authorEmail=cindy@ballreich.net\" \"copyright=1997 3Name3D / Yglesias Wallock Divekar Inc. all rights reserved.\" \"creationDate=Tue Dec 30 08:30:08 PST 1997\" \"usageRestrictions=Noncommercial usage is ok if 3Name3D name and logo <www.ballreich.net/vrml/HAnim/small_logo.gif> is present and proper credit is given.\"')),
                ...
                Group(
                  ...
                  children_ : [
                    ...
                    TimeSensor(
                      ...
                      cycleInterval_ : 0.009999999776482582)]),

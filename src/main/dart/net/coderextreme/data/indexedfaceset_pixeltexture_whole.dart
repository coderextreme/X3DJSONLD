        ...
        head(
          meta_ : [
            meta(
              ...
              content_ : SFString('indexedfaceset_pixeltexture_whole.x3d')),

            meta(
              name_ : SFString('warning'),
              content_ : SFString('file did not transform to vrml97')),

            meta(
              name_ : SFString('Image'),
              content_ : SFString('indexedfaceset_pixeltexture_whole-front.jpg')),

            meta(
              name_ : SFString('Image'),
              content_ : SFString('indexedfaceset_pixeltexture_whole-rear.jpg')),

            meta(
              name_ : SFString('Image'),
              content_ : SFString('indexedfaceset_pixeltexture_whole-top.jpg')),

            meta(
              name_ : SFString('Image'),
              content_ : SFString('indexedfaceset_pixeltexture_whole-bottom.jpg')),

            meta(
              name_ : SFString('Image'),
              content_ : SFString('indexedfaceset_pixeltexture_whole-left.jpg')),

            meta(
              name_ : SFString('Image'),
              content_ : SFString('indexedfaceset_pixeltexture_whole-right.jpg')),
            ...
            meta(
              ...
              content_ : SFString('Test of browser ability to map the entire portion of an PixelTexture onto an IndexedFaceSet geometry. Four equal sized red (bottom left), green (bottom right) yellow (top left) and white (top right) squares in the pixel texture map all the faces of the cube.')),

            meta(
              name_ : SFString('identifier'),
              content_ : SFString('https://www.web3d.org/x3d/content/examples/ConformanceNist/GeometricProperties/TextureCoordinate/indexedfaceset_pixeltexture_whole.x3d')),
            ...
            Shape(
              ...
              geometry_ : 
                IndexedFaceSet(
                  ...
                  texCoord_ : 
                    TextureCoordinate(
                      point_ : MFVec2f([SFVec2f([0,1]),SFVec2f([0,0]),SFVec2f([1,1]),SFVec2f([1,0])]))))]));
void main() { exit(0); }

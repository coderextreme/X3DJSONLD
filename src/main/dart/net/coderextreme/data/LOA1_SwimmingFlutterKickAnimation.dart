            ...
            Anchor(
              ...
              children_ : [
                Shape(
                  geometry_ : 
                    Text(
                      string_ : MFString([SFString("LOA1_SwimmingFlutterKickAnimation.x3d"), SFString("defines a prototype"), SFString("for animating a humanoid."), SFString("Click text to see example.")]),
                      fontStyle_ : 
                        FontStyle(

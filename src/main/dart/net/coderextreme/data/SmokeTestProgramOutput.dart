        ...
        head(
          ...
          meta_ : [
            meta(
              ...
              content_ : SFString('SmokeTestProgramOutput.x3d')),
            ...
            meta(
              ...
              content_ : SFString('Example SmokeTestProgram creates an X3D model using the X3D Java Scene Access Interface Library (X3DJSAIL)')),
            ...
            meta(
              ...
              content_ : SFString('SmokeTestProgramOutput.java')),
            ...
            meta(
              ...
              content_ : SFString('20 June 2026')),
            ...
            meta(
              name_ : SFString('generator'),
              content_ : SFString('https://www.web3d.org/specifications/java/examples/SmokeTestProgram.java')),
            ...
            meta(
              name_ : SFString('reference'),
              content_ : SFString('https://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/java/examples/SmokeTestProgramOutput.x3d')),
            ...
            meta(
              name_ : SFString('reference'),
              content_ : SFString('SmokeTestProgramOutput.txt')),

            meta(
              name_ : SFString('reference'),
              content_ : SFString('SmokeTestProgramOutput.x3dv')),

            meta(
              name_ : SFString('reference'),
              content_ : SFString('SmokeTestProgramOutput.wrl')),

            meta(
              name_ : SFString('reference'),
              content_ : SFString('SmokeTestProgramOutput.html')),

            meta(
              name_ : SFString('reference'),
              content_ : SFString('https://savage.nps.edu/X3dValidator?url=https://www.web3d.org/specifications/java/examples/SmokeTestProgramOutput.x3d')),

            meta(
              name_ : SFString('identifier'),
              content_ : SFString('https://www.web3d.org/specifications/java/examples/SmokeTestProgramOutput.x3d')),
        ...
        Scene(
          children_ : [
            ViewpointGroup(
              ...
              children_ : [
                Viewpoint(
                  ...
                  navigationInfo_ : 
                    NavigationInfo(
                      DEF_ : SFString('ViewpointChildNavigationInfo'))),
            ...
            WorldInfo(
              ...
              title_ : SFString('SmokeTestProgram produced by X3D Java SAI Library (X3DJSAIL)')),
            ...
            Shape(
              ...
              appearance_ : 
                Appearance(
                  material_ : 
                    Material(
                      emissiveColor_ : SFColor([SFDouble(0.6), SFDouble(0.1961), SFDouble(0.8)]))),
              geometry_ : 
                IndexedLineSet(
                ...
                Collision(
                  ...
                  proxy_ : 
                    Shape(
                      ...
                      geometry_ : 
                        Text(
                          string_ : MFString([SFString("One, Two, Text"), SFString("He said, \"Immel did it!\" \"\"")])))),
          ...
          /*repeatedly spin 180 degrees as a readable special effect*/
            ...
            OrientationInterpolator(
              ...
              keyValue_ : MFRotation([SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(4.7124), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(1.5708)])),
...
// TODO check line wrapping when exporting/converting
                ...
                ColorInterpolator(
                  ...
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFColor([SFColor(0.9412), SFColor(1), SFColor(1), SFColor(0.2941), SFColor(0), SFColor(0.5098), SFColor(0.9412), SFColor(1), SFColor(1)]),
                ...
                ProtoBody(
                  ...
                  children_ : [
                    Material(
                      ...
                      diffuseColor_ : SFColor([SFDouble(0.2824), SFDouble(0.0852), SFDouble(0.1345)]),
                      shininess_ : 0.1273,
                      specularColor_ : SFColor([SFDouble(0.2763), SFDouble(0.1143), SFDouble(0.1399)])),
            ...
            ExternProtoDeclare(
              ...
              url_ : MFString([SFString("https://www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02"), SFString("https://www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02")]),
          ...
          /*Tested ArtDeco01ProtoInstance, ArtDeco02ProtoInstance for improper node type when ProtoInstance is added in wrong place*/
            ...
            Inline(
              ...
              url_ : MFString([SFString("newScene.x3d"), SFString("https://www.web3d.org/specifications/java/examples/newScene.x3d")])),
...
/* dummy test source code */)),
            ...
            OrthoViewpoint(
              DEF_ : SFString('SpecialTestOrthoViewpoint'),
              fieldOfView_ : MFFloat([SFFloat(1), SFFloat(3), SFFloat(2), SFFloat(4)]))));
void main() { exit(0); }

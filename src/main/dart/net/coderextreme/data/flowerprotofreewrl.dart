                ...
                ProtoInterface(
                  field_ : [
                    field(
                      ...
                      value_ : SFString('\"../shaders/freewrl_flowers_chromatic.vs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl_flowers_chromatic.vs\"')),

                    field(
                      type_ : SFString("MFString"),
                      name_ : SFString('fragment'),
                      accessType_ : SFString("inputOnly"),
                      value_ : SFString('\"../shaders/freewrl.fs\" \"https://coderextreme.net/X3DJSONLD/src/main/shaders/freewrl.fs\"'))]),
              ProtoBody_ : 
                ProtoBody(
                  children_ : [
                    Transform(

            ...
            Anchor(
              ...
              children_ : [
                Shape(
                  geometry_ : 
                    Text(
                      string_ : MFString([SFString("LOA1_RunAnimation.x3d"), SFString("defines a prototype"), SFString("for animating a humanoid."), SFString("Click this text to see"), SFString("InterchangableActorsViaDynamicRouting example.")]),
                      fontStyle_ : 
                        FontStyle(

      ...
      head_ : 
        head(
          ...
          meta_ : [
            ...
            meta(
              name_ : SFString('info'),
              content_ : SFString('Joe No Reservations 20200709 fix hier20161206 20161111 20160720 20121221 20040109 x3d/hanim')),

            meta(
              name_ : SFString('description'),
              content_ : SFString('The Joe model is a Humanoid with textured skin.')),
            ...
            meta(
              ...
              content_ : SFString('09 July 2020')),
            ...
            meta(
              ...
              content_ : SFString('https://www.web3d.org/x3d/content/examples/Basic/HumanoidAnimation/JoeSkinTexcoordDisplacerKick.x3d')),
        ...
        Scene(
                                                                                                                        ...
                                                                                                                        HAnimJoint(
                                                                                                                          ...
                                                                                                                          displacers_ : 
                                                                                                                            HAnimDisplacer(
                                                                                                                              ...
                                                                                                                              DEF_ : SFString('Joe_skull_tipTest'),
            ...
            Group(
              ...
              /*Interpolators*/
                ...
                OrientationInterpolator(
                  DEF_ : SFString('HumanoidRootRotInterp'),
                ...
                PositionInterpolator(
                  DEF_ : SFString('HumanoidRootTransInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('sacroiliacRotInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('l_ankleRotInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('l_subtalarRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_midtarsalRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_metatarsalRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_hipRotInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('r_ankleRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.25), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('r_subtalarRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_midtarsalRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_metatarsalRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vl5RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vl4RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vl3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vl2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vl1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt12RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt11RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt10RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt9RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt8RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt7RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt6RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt5RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt4RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vt1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vc7RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vc6RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vc5RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vc4RotInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('vc3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vc2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('vc1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('skullbaseRotInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('l_eyelid_jointRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_eyeball_jointRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_eyebrow_jointRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_eyelid_jointRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_eyeball_jointRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_eyebrow_jointRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('temporomandibularRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_sternoclavicularRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_acromioclavicularRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_shoulderRotInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('l_elbowRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('l_wristRotInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('l_thumb1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_thumb2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_thumb3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_index0RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_index1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_index2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_index3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_middle0RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_middle1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_middle2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_middle3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_ring0RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_ring1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_ring2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_ring3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_pinky0RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_pinky1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_pinky2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('l_pinky3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_sternoclavicularRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_acromioclavicularRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_shoulderRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('r_elbowRotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(-1), SFRotation(0), SFRotation(0), SFRotation(3), SFRotation(-1), SFRotation(0), SFRotation(0), SFRotation(0.75), SFRotation(-1), SFRotation(-1), SFRotation(0), SFRotation(0.5)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_wristRotInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('r_thumb1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_thumb2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_thumb3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_index0RotInterp'),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('r_index1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                ...
                OrientationInterpolator(
                  DEF_ : SFString('r_index2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_index3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_middle0RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_middle1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_middle2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_middle3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_ring0RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_ring1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_ring2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_ring3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_pinky0RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_pinky1RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_pinky2RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)])),

                OrientationInterpolator(
                  DEF_ : SFString('r_pinky3RotInterp'),
                  key_ : MFFloat([SFFloat(0), SFFloat(0.5), SFFloat(0.75), SFFloat(1)]),
                  keyValue_ : MFRotation([SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(1.5), SFRotation(0), SFRotation(0), SFRotation(1), SFRotation(0)]))]),
          /*TimeSensor to Interpolators*/
            ...
            ROUTE(
              ...
              toNode_ : SFString('HumanoidRootRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('HumanoidRootTransInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('sacroiliacRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_hipRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_kneeRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_ankleRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_subtalarRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_midtarsalRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_metatarsalRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_hipRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_kneeRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_ankleRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_subtalarRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_midtarsalRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_metatarsalRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vl5RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vl4RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vl3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vl2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vl1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt12RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt11RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt10RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt9RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt8RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt7RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt6RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt5RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt4RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vt1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vc7RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vc6RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vc5RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vc4RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vc3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vc2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('vc1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('skullbaseRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_eyelid_jointRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_eyeball_jointRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_eyebrow_jointRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_eyelid_jointRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_eyeball_jointRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_eyebrow_jointRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('temporomandibularRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_sternoclavicularRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_acromioclavicularRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_shoulderRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_elbowRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_wristRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_thumb1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_thumb2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_thumb3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_index0RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_index1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_index2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_index3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_middle0RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_middle1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_middle2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_middle3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_ring0RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_ring1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_ring2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_ring3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_pinky0RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_pinky1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_pinky2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('l_pinky3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_sternoclavicularRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_acromioclavicularRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_shoulderRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_elbowRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_wristRotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_thumb1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_thumb2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_thumb3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_index0RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_index1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_index2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_index3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_middle0RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_middle1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_middle2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_middle3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_ring0RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_ring1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_ring2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_ring3RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_pinky0RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_pinky1RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_pinky2RotInterp')),

            ROUTE(
              fromField_ : SFString('fraction_changed'),
              fromNode_ : SFString('KickTimer'),
              toField_ : SFString('set_fraction'),
              toNode_ : SFString('r_pinky3RotInterp')),
          /*Routes from Interpolators to Joe_ model Joints*/

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('HumanoidRootRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_HumanoidRoot')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('HumanoidRootTransInterp'),
              toField_ : SFString('set_translation'),
              toNode_ : SFString('Joe_HumanoidRoot')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('sacroiliacRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_sacroiliac')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_hipRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_hip')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_kneeRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_knee')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_ankleRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_ankle')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_subtalarRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_subtalar')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_midtarsalRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_midtarsal')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_metatarsalRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_metatarsal')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_hipRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_hip')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_kneeRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_knee')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_ankleRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_ankle')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_subtalarRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_subtalar')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_midtarsalRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_midtarsal')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_metatarsalRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_metatarsal')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vl5RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vl5')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vl4RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vl4')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vl3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vl3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vl2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vl2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vl1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vl1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt12RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt12')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt11RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt11')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt10RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt10')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt9RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt9')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt8RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt8')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt7RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt7')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt6RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt6')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt5RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt5')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt4RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt4')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vt1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vt1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vc7RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vc7')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vc6RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vc6')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vc5RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vc5')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vc4RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vc4')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vc3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vc3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vc2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vc2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('vc1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_vc1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('skullbaseRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_skullbase')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_eyelid_jointRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_eyelid_joint')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_eyeball_jointRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_eyeball_joint')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_eyebrow_jointRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_eyebrow_joint')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_eyelid_jointRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_eyelid_joint')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_eyeball_jointRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_eyeball_joint')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_eyebrow_jointRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_eyebrow_joint')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('temporomandibularRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_temporomandibular')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_sternoclavicularRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_sternoclavicular')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_acromioclavicularRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_acromioclavicular')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_shoulderRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_shoulder')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_elbowRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_elbow')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_wristRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_wrist')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_thumb1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_thumb1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_thumb2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_thumb2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_thumb3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_thumb3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_index0RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_index0')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_index1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_index1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_index2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_index2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_index3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_index3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_middle0RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_middle0')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_middle1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_middle1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_middle2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_middle2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_middle3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_middle3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_ring0RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_ring0')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_ring1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_ring1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_ring2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_ring2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_ring3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_ring3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_pinky0RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_pinky0')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_pinky1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_pinky1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_pinky2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_pinky2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('l_pinky3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_l_pinky3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_sternoclavicularRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_sternoclavicular')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_acromioclavicularRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_acromioclavicular')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_shoulderRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_shoulder')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_elbowRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_elbow')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_wristRotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_wrist')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_thumb1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_thumb1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_thumb2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_thumb2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_thumb3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_thumb3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_index0RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_index0')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_index1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_index1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_index2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_index2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_index3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_index3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_middle0RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_middle0')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_middle1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_middle1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_middle2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_middle2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_middle3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_middle3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_ring0RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_ring0')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_ring1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_ring1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_ring2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_ring2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_ring3RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_ring3')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_pinky0RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_pinky0')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_pinky1RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_pinky1')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_pinky2RotInterp'),
              toField_ : SFString('set_rotation'),
              toNode_ : SFString('Joe_r_pinky2')),

            ROUTE(
              fromField_ : SFString('value_changed'),
              fromNode_ : SFString('r_pinky3RotInterp'),
              toField_ : SFString('set_rotation'),
            ...
            Group(
              ...
              children_ : [
                ...
                ROUTE(
                  ...
                  fromNode_ : SFString('KickTimer'),
                  toField_ : SFString('set_fraction'),
                  toNode_ : SFString('skull_tipTest')),

                ROUTE(
                  fromField_ : SFString('value_changed'),
                  fromNode_ : SFString('skull_tipTest'),
                  toField_ : SFString('weight'),
                  toNode_ : SFString('Joe_skull_tipTest'))]),

            Group(
              DEF_ : SFString('skintexturetransform_animation'),
              children_ : [
                ScalarInterpolator(
                  DEF_ : SFString('skinTexTransTest'),
                ...
                ROUTE(
                  ...
                  fromNode_ : SFString('KickTimer'),
                  toField_ : SFString('set_fraction'),
                  toNode_ : SFString('skinTexTransTest')),

                ROUTE(
                  fromField_ : SFString('value_changed'),
                  fromNode_ : SFString('skinTexTransTest'),
                  toField_ : SFString('rotation'),
                  toNode_ : SFString('kicktextrans'))]),
            ...
            Group(
              ...
              /*Ball Animation Routes*/
                ...
                ROUTE(
                  ...
                  fromNode_ : SFString('KickTimer'),
                  toField_ : SFString('set_fraction'),
                  toNode_ : SFString('ballTransInterp')),

                ROUTE(
                  fromField_ : SFString('value_changed'),
                  fromNode_ : SFString('ballTransInterp'),
                  toField_ : SFString('set_translation'),
                ...
                ROUTE(
                  ...
                  fromNode_ : SFString('KickTimer'),
                  toField_ : SFString('set_fraction'),
                  toNode_ : SFString('ballRotInterp')),

                ROUTE(
                  fromField_ : SFString('value_changed'),
                  fromNode_ : SFString('ballRotInterp'),
                  toField_ : SFString('set_rotation'),
                  toNode_ : SFString('SBall'))]),

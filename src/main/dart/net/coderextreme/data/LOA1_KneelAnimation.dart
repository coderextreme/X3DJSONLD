      ...
      head_ : 
        head(
          meta_ : [
            ...
            meta(
              name_ : SFString('reference'),
              content_ : SFString('https://www.HAnim.org/Models/HAnim2001/boxman/protos/LOA1_WalkAnimation.wrl')),
            ...
            Anchor(
              ...
              children_ : [
                Shape(
                  geometry_ : 
                    Text(
                      string_ : MFString([SFString("LOA1_KneelAnimation.x3d"), SFString("defines a prototype"), SFString("for animating a humanoid."), SFString("Click this text to see"), SFString("InterchangableActorsViaDynamicRouting example.")]),
                      fontStyle_ : 
                        FontStyle(

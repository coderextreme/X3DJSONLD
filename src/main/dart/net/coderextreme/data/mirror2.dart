        ...
        head(
          ...
          meta_ : [
            ...
            meta(
              ...
              content_ : SFString('https://coderextreme.net/X3DJSONLD/src/main/data/mirror2.x3d')),

            meta(
              name_ : SFString('description'),
              content_ : SFString('a mirrored sphere'))]),
      Scene_ : 
        Scene(
          children_ : [
            Viewpoint(
	    ...
	    if (side != old) {
		    ...
		    bottom_changed[0] = bottomUrls[side];
                ...
                ROUTE(
                  ...
                  toNode_ : SFString('cube'),
                  toField_ : SFString('frontUrl')),

                ROUTE(
                  fromNode_ : SFString('UrlSelector'),
                  fromField_ : SFString('back_changed'),
                  toNode_ : SFString('cube'),
                  toField_ : SFString('backUrl')),

                ROUTE(
                  fromNode_ : SFString('UrlSelector'),
                  fromField_ : SFString('left_changed'),
                  toNode_ : SFString('cube'),
                  toField_ : SFString('leftUrl')),

                ROUTE(
                  fromNode_ : SFString('UrlSelector'),
                  fromField_ : SFString('right_changed'),
                  toNode_ : SFString('cube'),
                  toField_ : SFString('rightUrl')),

                ROUTE(
                  fromNode_ : SFString('UrlSelector'),
                  fromField_ : SFString('top_changed'),
                  toNode_ : SFString('cube'),
                  toField_ : SFString('topUrl')),

                ROUTE(
                  fromNode_ : SFString('UrlSelector'),
                  fromField_ : SFString('bottom_changed'),
                  toNode_ : SFString('cube'),
                  toField_ : SFString('bottomUrl')),

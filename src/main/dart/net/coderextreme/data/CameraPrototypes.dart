      ...
      head_ : 
        head(
          meta_ : [
            ...
            meta(
              name_ : SFString('reference'),
              content_ : SFString('https://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/content/examples/Basic/development/CameraPrototypes.x3d')),
                ...
                Transform(
                  child_ : 
                    Shape(
                      geometry_ : 
                        Text(
                          string_ : MFString([SFString("CameraPrototypes.x3d"), SFString("defines multiple prototype nodes"), SFString("Click on this text to see"), SFString("CameraExamples.x3d scene")]),
                          fontStyle_ : 
                            FontStyle(

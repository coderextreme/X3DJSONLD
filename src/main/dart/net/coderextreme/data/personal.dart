        ...
        head(
          meta_ : [
            meta(
              ...
              content_ : SFString('personal.x3d')),

            meta(
              name_ : SFString('identifier'),
              content_ : SFString('https://someAddress/somePath/personal.x3d')),

            meta(
              name_ : SFString('description'),
              content_ : SFString('Joh\' Portfolio')),

            meta(
              name_ : SFString('generator'),
              content_ : SFString('vim and X3D-Edit, https://savage.nps.edu/X3D-Edit'))]),
      Scene_ : 
        Scene(
          children_ : [
            Viewpoint(
            ...
            Switch(
              ...
              children_ : [
                Inline(
                  url_ : MFString([SFString("../data/force-tidy.x3d"), SFString("https://coderextreme.net/X3DJSONLD/src/main/data/force-tidy.x3d")]))]),
          /*<Script DEF=\"Choice0\">*/

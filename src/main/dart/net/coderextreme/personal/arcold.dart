        ...
        head(
          meta_ : [
            ...
            meta(
              ...
              content_ : SFString('https://coderextreme.net/X3DJSONLD/src/main/personal/arc.x3d')),

            meta(
              name_ : SFString('description'),
              content_ : SFString('an attempt to implement an arc in a graph'))]),
      Scene_ : 
        Scene(
          children_ : [
            Viewpoint(
              position_ : SFVec3f([SFDouble(0), SFDouble(0), SFDouble(5)]),
              description_ : SFString('a moving graph')),

            Background(
              skyColor_ : MFColor([SFColor(0.4), SFColor(0.4), SFColor(0.4)])),

            Transform(
              DEF_ : SFString('trans1'),
              children_ : [
                Transform(
            ...
            ProtoInstance(
              ...
              fieldValue_ : [
                ...
                fieldValue(
                  ...
                  children_ : [
                    Transform(
                      USE_ : SFString('trans1'))]),

                fieldValue(
                  name_ : SFString('rotscalenode'),
                  children_ : [
                    Transform(
                      USE_ : SFString('rotscale1'))])]),
            ...
            ProtoInstance(
              ...
              fieldValue_ : [
                ...
                fieldValue(
                  ...
                  children_ : [
                    Transform(
                      USE_ : SFString('trans2'))]),

                fieldValue(
                  name_ : SFString('rotscalenode'),
                  children_ : [
                    Transform(
                      USE_ : SFString('rotscale2'))])]),
            ...
            ProtoInstance(
              ...
              fieldValue_ : [
                ...
                fieldValue(
                  ...
                  children_ : [
                    Transform(
                      USE_ : SFString('trans3'))]),

                fieldValue(
                  name_ : SFString('rotscalenode'),
                  children_ : [
                    Transform(
                      USE_ : SFString('rotscale3'))])]),

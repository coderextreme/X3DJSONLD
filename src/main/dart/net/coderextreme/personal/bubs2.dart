        ...
        head(
          meta_ : [
            ...
            meta(
              ...
              content_ : SFString('https://coderextreme.net/X3DJSONLD/src/main/personal/geo.x3d')),
...
, function set_fraction(value) {
	...
	initialize();
            ...
            ProtoInstance(
              name_ : SFString('Bubble'),
              DEF_ : SFString('bubbleB')),

            ProtoInstance(
              name_ : SFString('Bubble'),
              DEF_ : SFString('bubbleC')),

            ProtoInstance(
              name_ : SFString('Bubble'),
              DEF_ : SFString('bubbleD'))]));
void main() { exit(0); }

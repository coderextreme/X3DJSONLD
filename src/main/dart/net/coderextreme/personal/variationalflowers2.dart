        ...
        head(
          ...
          meta_ : [
            meta(
              ...
              content_ : SFString('variationalflowers2.x3d')),
            ...
            meta(
              ...
              content_ : SFString('A flower variational system')),

            meta(
              name_ : SFString('identifier'),
              content_ : SFString('https://coderextreme.net/X3DJSONLD/src/main/personal/variationalflowers2.x3d'))]),
      Scene_ : 
        Scene(
          children_ : [
            WorldInfo(
              title_ : SFString('variationalflowers2.x3d')),

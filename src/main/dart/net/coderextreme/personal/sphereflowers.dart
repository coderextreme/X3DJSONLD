        ...
        head(
          ...
          meta_ : [
            ...
            meta(
              ...
              content_ : SFString('https://coderextreme.net/X3DJSONLD/src/main/personal/sphereflowers.x3d'))]),
      Scene_ : 
        Scene(
          children_ : [
            NavigationInfo(),
            ...
            Group(
              children_ : [
                ExternProtoDeclare(
                  ...
                  url_ : MFString([SFString("../personal/flowerproto.x3d#FlowerProto"), SFString("https://coderextreme.net/X3DJSONLD/src/main/personal/flowerproto.x3d#FlowerProto")]),
                  field_ : [
                    field(

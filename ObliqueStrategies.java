    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new ScriptObject().setDEF("TextScript").setUrl(new MFStringObject(new MFString6().getArray()))
          ...
          .addField(new fieldObject().setName("string_changed").setAccessType("outputOnly").setAppinfo("latest strategy card value").setType(fieldObject.TYPE_MFSTRING))
          .addField(new fieldObject().setName("textToSpeechUrl").setAccessType("outputOnly").setAppinfo("url to invoke Google Translate").setType(fieldObject.TYPE_MFSTRING))
          .addField(new fieldObject().setName("newCardTime").setAccessType("outputOnly").setAppinfo("activate Sound node").setType(fieldObject.TYPE_SFTIME))
          .addField(new fieldObject().setName("selectPreviousCard").setAccessType("inputOnly").setType(fieldObject.TYPE_SFBOOL))
          .addField(new fieldObject().setName("selectNextCard").setAccessType("inputOnly").setType(fieldObject.TYPE_SFBOOL))
          .addField(new fieldObject().setName("selectRandomCard").setAccessType("inputOnly").setType(fieldObject.TYPE_SFBOOL))
          .addField(new fieldObject().setName("traceEnabled").setAccessType("initializeOnly").setAppinfo("controls console tracing").setType(fieldObject.TYPE_SFBOOL).setValue("true")))

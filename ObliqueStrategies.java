    ...
    public X3DObject initialize() {
      ...
      .setScene(new SceneObject()
        ...
        .addChild(new ScriptObject().setDEF("TextScript").setUrl(new MFStringObject(new MFString6().getArray()))
          ...
          .addField(new fieldObject().setName("selectNextCard").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFBOOL))
          .addField(new fieldObject().setName("selectRandomCard").setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setType(fieldObject.TYPE_SFBOOL))
          .addField(new fieldObject().setName("traceEnabled").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("controls console tracing").setType(fieldObject.TYPE_SFBOOL).setValue("true")))

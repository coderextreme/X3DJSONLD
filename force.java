      ...
      .setScene(new SceneObject()
        .addChild(new ProtoDeclareObject().setName("node")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setName("position").setAccessType("inputOutput").setType(fieldObject.TYPE_SFVEC3F).setValue("0 0 0")))
          .setProtoBody(new ProtoBodyObject()
            ...
            .addChild(new ScriptObject().setDEF("MoveBall")
              ...
              .addField(new fieldObject().setName("keyValue").setAccessType("outputOnly").setType(fieldObject.TYPE_MFVEC3F))
...
""))
        ...
        .addChild(new ProtoDeclareObject().setName("cylinder")
          .setProtoInterface(new ProtoInterfaceObject()
            .addField(new fieldObject().setName("positionA").setAccessType("inputOnly").setType(fieldObject.TYPE_SFVEC3F))
          ...
          .setProtoBody(new ProtoBodyObject()
            ...
            .addChild(new ScriptObject().setDEF("MoveCylinder")
              .addField(new fieldObject().setName("spine").setAccessType("inputOutput").setType(fieldObject.TYPE_MFVEC3F).setValue("0 -50 0 0 50 0"))
              .addField(new fieldObject().setName("set_endA").setAccessType("inputOnly").setType(fieldObject.TYPE_SFVEC3F))
              .addField(new fieldObject().setName("set_endB").setAccessType("inputOnly").setType(fieldObject.TYPE_SFVEC3F))
              .setIS(new ISObject()
...
""))
        ...
        .addChild(new ScriptObject().setDEF("clickHandler")
          .addField(new fieldObject().setName("counter").setAccessType("inputOutput").setValue("0").setType(fieldObject.TYPE_SFINT32))
          .addField(new fieldObject().setName("node_changed").setAccessType("outputOnly").setType(fieldObject.TYPE_SFNODE))
          .addField(new fieldObject().setName("add_node").setAccessType("inputOnly").setValue("0").setType(fieldObject.TYPE_SFBOOL))
          .addField(new fieldObject().setName("ModifiableNode").setId(MN).setType(fieldObject.TYPE_SFNODE).setAccessType("initializeOnly")

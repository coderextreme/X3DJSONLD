...
""))
        ...
        .addChild(new ScriptObject().setDEF("clickHandler")
          ...
          .addField(new fieldObject().setName("node").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setType(fieldObject.TYPE_SFNODE))
          ...
          .addField(new fieldObject().setName("ModifiableNode").setId(MN).setType(fieldObject.TYPE_SFNODE).setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY)

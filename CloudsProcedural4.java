      ...
      .setScene(new SceneObject()
        ...
        .addChild(new GroupObject().setDEF("Clouds")
          ...
          .addChild(new ScriptObject().setDEF("PixelScript").setDirectOutput(true)
            .addField(new fieldObject().setName("Cumulus").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
              .addChild(new TransformObject().setUSE("Cumulus")))
            .addField(new fieldObject().setName("Cirrus").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE)
              .addChild(new TransformObject().setUSE("Cirrus")))
            .addField(new fieldObject().setName("Fog").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setType(fieldObject.TYPE_SFNODE))
...
protected class MFString2 {
  protected MFStringObject getArray() {
    return new MFStringObject(new String[] {"MontereyBayLargeMesh.x3d","https://savage.nps.edu/Savage/Environment/Atmosphere/MontereyBayLargeMesh.x3d","MontereyBayLargeMesh.wrl","https://savage.nps.edu/Savage/Environment/Atmosphere/MontereyBayLargeMesh.wrl"});
  }
}
protected class MFString3 {
  protected MFStringObject getArray() {
    return new MFStringObject(new String[] {"ocean.png","https://savage.nps.edu/Savage/Environment/Atmosphere/ocean.png"});
  }
}
protected class MFString4 {
  protected MFStringObject getArray() {
    return new MFStringObject(new String[] {"Lighthouse.x3d","https://savage.nps.edu/Savage/Environment/Atmosphere/Lighthouse.x3d","Lighthouse.wrl","https://savage.nps.edu/Savage/Environment/Atmosphere/Lighthouse.wrl"});
  }
}
}

...
public class geobubbles
{
  ...
  .setScene(new SceneObject()
    ...
    .addChild(new BackgroundObject().setBackUrl(new MFStringObject("\"cubemap/BK.png\" \"http://coderextreme.net/X3DJSONLD/cubemap/BK.png\"")).setBottomUrl(new MFStringObject("\"cubemap/BT.png\" \"http://coderextreme.net/X3DJSONLD/cubemap/BT.png\"")).setFrontUrl(new MFStringObject("\"cubemap/FR.png\" \"http://coderextreme.net/X3DJSONLD/cubemap/FR.png\"")).setLeftUrl(new MFStringObject("\"cubemap/LF.png\" \"http://coderextreme.net/X3DJSONLD/cubemap/LF.png\"")).setRightUrl(new MFStringObject("\"cubemap/RT.png\" \"http://coderextreme.net/X3DJSONLD/cubemap/RT.png\"")).setTopUrl(new MFStringObject("\"cubemap/TP.png\" \"http://coderextreme.net/X3DJSONLD/cubemap/TP.png\"")))

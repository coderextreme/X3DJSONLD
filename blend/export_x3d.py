...
def export(file,
    ...
    def writeJoints(ident, joint_parent, joint, matrix):
        ...
        if use_hierarchy:
            ...
            try:
                if joint.type == 'ARMATURE':
                    for joint_child in joint.pose.bones:
                        writeJoints(ident, joint, joint_child, joint_matrix)
                else:
    ...
    def export_armature(ident, armature_parent, armature, armature_matrix):
        ...
        bpy.ops.object.mode_set(mode='EDIT')  # could be 'POSE' or 'OBJECT'
        ...
        writeJoints(ident, armature_parent, armature, armature_matrix)

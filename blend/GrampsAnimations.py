...
bpy.ops.export_scene.x3dv(filepath="GrampsAnimations.x3dv", export_round_precision=20, export_yup=True, export_normals=True, export_format="X3DV")
bpy.ops.export_scene.x3dv(filepath="GrampsAnimations.x3d", export_round_precision=20, export_yup=True, export_normals=True, export_format="X3D")

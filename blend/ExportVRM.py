...
bpy.ops.import_anim.bvh(
    filepath="../../amc2bvh/skippingLOA12.bvh",
    axis_up='Z',
    axis_forward='Y',
    filter_glob="*.bvh",
    target='ARMATURE',
...
bpy.ops.export_scene.x3dv(filepath="skipping.x3d", export_format="X3D", export_round_precision=20, export_normals=True)
bpy.ops.export_scene.x3dv(filepath="skipping.x3dv", export_format="X3DV", export_round_precision=20, export_normals=True)

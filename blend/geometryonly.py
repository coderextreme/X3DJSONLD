...
input_file = 'JinLOA4.scaled.noanim.x3d'
...
geometries = scene.findall(".//IndexedFaceSet")

for child in list(scene):
    scene.remove(child)

for geometry in geometries:
    scene.append(geometry)
...
file_output = os.path.join(".",os.path.basename("JinLOA4.scaled.geometryonly.x3d"))

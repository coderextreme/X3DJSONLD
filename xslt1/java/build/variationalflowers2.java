 ...
 <p> Related links:  source variationalflowers.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr style="background-color:silver; border-color:silver;">
			...
			<td style="text-align:left;   padding:10px 0px;">variationalflowers&nbsp; Document Metadata </td>
		</tr>
...
public class variationalflowers
{
  ...
  .setHead(new head()
    ...
    .addMeta(new meta().setName(meta.NAME_TITLE      ).setContent("variationalflowers.x3d"))
    ...
    .addMeta(new meta().setName(meta.NAME_IDENTIFIER ).setContent("https://coderextreme.net/X3DJSONLD/src/main/data/variationalflowers.x3d")))
  .setScene(new Scene()
...
// *** X3dToJava.xslt error: encountered incorrect type (check incorrect capitalization), VariationPhysicsModel variations: $isNumeric=true, $attributeType=, value='0.2 0.1 0.3 0.3 0.01 0.01']
        ...
        .setAppearance(new Appearance()
          ...
          .addShaders(new ComposedShader("x_ite").setLanguage("GLSL")
            ...
            .addParts(new ShaderPart().setUrl(new String[] {"../shaders/x_ite_variations.vs"}))
            .addParts(new ShaderPart().setType("FRAGMENT").setUrl(new String[] {"../shaders/commonnew.fs"})))))
...
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"variationalflowers\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("variationalflowers self-validation test results: ");

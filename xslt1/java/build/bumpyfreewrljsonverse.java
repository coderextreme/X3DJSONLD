 ...
 <p> Related links:  source bumpyfreewrljsonverse.java, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
	<table style="color:black; border:0px solid; border-spacing:10px 0px;">
		...
		<tr style="background-color:silver; border-color:silver;">
			...
			<td style="text-align:left;   padding:10px 0px;">bumpyfreewrljsonverse&nbsp; Document Metadata </td>
		</tr>
...
""")
        ...
        .addChild(new DISEntityManager("EntityManager").setNetworkMode("networkReader")
          .addChild(new DISEntityTypeMapping().setCategory(77).setReadInterval(3.0).setSpecific(1).setUrl(new String[] {"../data/Gramps8Final.x3d","https://coderextreme.net/X3DJSONLD/src/main/data/Gramps8Final.x3d"}))
          .addChild(new DISEntityTypeMapping().setCategory(77).setReadInterval(3.0).setSpecific(2).setUrl(new String[] {"../data/Leif8Final.x3d","https://coderextreme.net/X3DJSONLD/src/main/data/Leif8Final.x3d"}))
          .addChild(new DISEntityTypeMapping().setCategory(77).setReadInterval(3.0).setSpecific(3).setUrl(new String[] {"../data/Lily8Final.x3d","https://coderextreme.net/X3DJSONLD/src/main/data/Lily8Final.x3d"}))
          .addChild(new DISEntityTypeMapping().setCategory(77).setReadInterval(3.0).setSpecific(4).setUrl(new String[] {"../data/Tufani8Final.x3d","https://coderextreme.net/X3DJSONLD/src/main/data/Tufani8Final.x3d"})))
...
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"bumpyfreewrljsonverse\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("bumpyfreewrljsonverse self-validation test results: ");

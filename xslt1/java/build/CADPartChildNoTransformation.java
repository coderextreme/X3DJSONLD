 ...
 * <p> Developer scene to explore Mantis Issue 528, providing a baseline example with no transformation of CADPart children. </p>
 <p> Related links: Catalog page <a href="../../../CAD/CADPartChildNoTransformationIndex.html" target="_blank">CADPartChildNoTransformation</a>,  source <a href="../../../CAD/CADPartChildNoTransformation.java">CADPartChildNoTransformation.java</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dResources.html" target="_blank">X3D Resources</a>, <a href="https://www.web3d.org/x3d/content/examples/X3dSceneAuthoringHints.html" target="_blank">X3D Scene Authoring Hints</a>, and <a href="https://www.web3d.org/x3d/content/X3dTooltips.html" target="_blank">X3D Tooltips</a>. </p>
...
//      System.out.println("X3D model construction complete.");
        ...
        if      (argumentsLoadNewModel)
                System.out.println("WARNING: \"CADPartChildNoTransformation\" model invocation is attempting to load file \"" + fileName + "\" instead of simply validating itself... file loading ignored.");
		...
		String validationResults = thisExampleX3dModel.validationReport();
            //  System.out.println("-----------------------------------"); // omit when duplicated outputs problem is solved/refactored
                System.out.print("CADPartChildNoTransformation self-validation test results: ");
                if (!validationResults.equals("success"))
                    System.out.println();
                System.out.println(validationResults.trim());

                // experimental: test X3DJSAIL output files
                // ./CADPartChildNoTransformation_JavaExport.* file validation is checked when building X3D Example Archives
                String filenameX3D  = "./CADPartChildNoTransformation_JavaExport.x3d"; 
                String filenameX3DV = "./CADPartChildNoTransformation_JavaExport.x3dv"; 
                String filenameJSON = "./CADPartChildNoTransformation_JavaExport.json";

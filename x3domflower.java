...
public class x3domflower {
  public static void main(String[] args) {
    ...
    new x3domflower().initialize().toFileJSON("x3domflower.new.json");
    }
          ...
          .addChild(new ShapeObject()
            .setAppearance(new AppearanceObject()
              ...
              .addShaders(new ComposedShaderObject().setLanguage("GLSL")
                ...
                .addField(new fieldObject().setName("a").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0.5"))
                .addField(new fieldObject().setName("b").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0.5"))
                .addField(new fieldObject().setName("c").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("3"))
                .addField(new fieldObject().setName("d").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("3"))
                .addField(new fieldObject().setName("tdelta").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0.5"))
                .addField(new fieldObject().setName("pdelta").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0.5"))
          ...
          .addChild(new ShapeObject()
            .setAppearance(new AppearanceObject()
              ...
              .addShaders(new ComposedShaderObject().setLanguage("GLSL")
                ...
                .addField(new fieldObject().setName("tdelta").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0.5"))
                .addField(new fieldObject().setName("pdelta").setType(fieldObject.TYPE_SFFLOAT).setAccessType(fieldObject.ACCESSTYPE_INPUTONLY).setValue("0.5"))
                .addParts(new ShaderPartObject().setUrl(new MFStringObject(new MFString28().getArray())).setType("VERTEX"))
                .addParts(new ShaderPartObject().setUrl(new MFStringObject(new MFString29().getArray())).setType("FRAGMENT"))))
            .setGeometry(new SphereObject().setRadius(20f)))))      ;
    return X3D0;
    }

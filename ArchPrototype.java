      ...
      .setScene(new SceneObject()
        .addChild(new ProtoDeclareObject().setName("ArchPrototype").setAppinfo("Create an arch. Can modify general parameters: clearSpanWidth, riseHeight, depth, topAbutmentHeight, pierWidth, pierHeight. - Possibility to create shapes related to an arch: ArchHalf; IntradosOnly; ArchFilled; ArchHalfFilled; Lintel. See the reference file ArchModelingDiagrams.pdf to find further information. See also ArchPrototypeScript_more_readable.js.js.")
          .setProtoInterface(new ProtoInterfaceObject()
            ...
            .addField(new fieldObject().setName("diffuseColor").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("color of arch").setType(fieldObject.TYPE_SFCOLOR).setValue("0.2 0.8 0.8"))
            .addField(new fieldObject().setName("emissiveColor").setAccessType(fieldObject.ACCESSTYPE_INPUTOUTPUT).setAppinfo("color of arch").setType(fieldObject.TYPE_SFCOLOR).setValue("0.2 0.8 0.8"))
            .addField(new fieldObject().setName("clearSpanWidth").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("clearSpanWidth: clearSpanWidth must be double of riseHeight to obtain an half circumference").setType(fieldObject.TYPE_SFFLOAT).setValue("4"))
            .addField(new fieldObject().setName("riseHeight").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("riseHeight: riseHeight must be half of clearSpanWidth to obtain an half circumference").setType(fieldObject.TYPE_SFFLOAT).setValue("2"))
            .addField(new fieldObject().setName("depth").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("depth").setType(fieldObject.TYPE_SFFLOAT).setValue("3"))
            .addField(new fieldObject().setName("topAbutmentHeight").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("topAbutmentHeight:topAbutmentHeight=0 means no topAbutment").setType(fieldObject.TYPE_SFFLOAT).setValue("0.5"))
            .addField(new fieldObject().setName("pierWidth").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("pierWidth:pierWidtht=0 means no pierWidth").setType(fieldObject.TYPE_SFFLOAT).setValue("0.5"))
            .addField(new fieldObject().setName("pierHeight").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("pierHeight: pierHeight=0 means no pierHeight").setType(fieldObject.TYPE_SFFLOAT).setValue("1"))
            .addField(new fieldObject().setName("archHalf").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("archHalf: can modify also clearSpanWidth, riseHeight, depth, pierWidth, pierHeight, topAbutmentHeight, archHalfExtensionWidth at purpose, clearSpanWidth measure refers to a full arc, consider clearSpanWidth/2 for the archHalf width").setType(fieldObject.TYPE_SFBOOL).setValue("false"))
            .addField(new fieldObject().setName("archHalfExtensionWidth").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("archHalfExtensionWidth: measure in meters, use only if archHalf=true, it is the width of the etension of the abutment of the archHalf. See the reference file ArchModelingDiagrams.pdf to find further information.").setType(fieldObject.TYPE_SFFLOAT).setValue("0"))
            .addField(new fieldObject().setName("onlyIntrados").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("onlyIntrados: note it is a flat curved surface, can modify also clearSpanWidth, riseHeight, depth at purpose, if needed apply archHalf=true.").setType(fieldObject.TYPE_SFBOOL).setValue("false"))
            .addField(new fieldObject().setName("archFilled").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("archFilled: note it is an half cylinder, can modify also clearSpanWidth, riseHeight, depth at purpose.").setType(fieldObject.TYPE_SFBOOL).setValue("false"))
            .addField(new fieldObject().setName("archHalfFilled").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("archHalfFilled: note it is a quarter cylinder, can modify also clearSpanWidth, riseHeight, depth at purpose, clearSpanWidth measure refers to a full arc, consider clearSpanWidth/2 for the archHalfFilled width.").setType(fieldObject.TYPE_SFBOOL).setValue("false"))
            .addField(new fieldObject().setName("lintel").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("lintel: no arc is rendered, but a lintel: topAbutmentHeight on pierHeight, total height is pierHeight + topAbutmentHeight, if needed apply archHalf=true.").setType(fieldObject.TYPE_SFBOOL).setValue("false")))
          .setProtoBody(new ProtoBodyObject()
            ...
            .addChild(new ScriptObject().setDEF("ArchPrototypeScript").setUrl(new MFStringObject(new MFString0().getArray()))
              ...
              .addField(new fieldObject().setName("clearSpanWidth").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for clearSpanWidth parameter").setType(fieldObject.TYPE_SFFLOAT))
              .addField(new fieldObject().setName("riseHeight").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for riseHeight parameter").setType(fieldObject.TYPE_SFFLOAT))
              .addField(new fieldObject().setName("depth").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for depth parameter").setType(fieldObject.TYPE_SFFLOAT))
              .addField(new fieldObject().setName("topAbutmentHeight").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for topAbutmentHeight parameter").setType(fieldObject.TYPE_SFFLOAT))
              .addField(new fieldObject().setName("pierWidth").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for pierWidth parameter").setType(fieldObject.TYPE_SFFLOAT))
              .addField(new fieldObject().setName("pierHeight").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for pierHeight parameter").setType(fieldObject.TYPE_SFFLOAT))
              .addField(new fieldObject().setName("archHalf").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for archHalf parameter").setType(fieldObject.TYPE_SFBOOL))
              .addField(new fieldObject().setName("archHalfExtensionWidth").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for archHalfExtensionWidth parameter").setType(fieldObject.TYPE_SFFLOAT))
              .addField(new fieldObject().setName("onlyIntrados").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for onlyIntrados parameter").setType(fieldObject.TYPE_SFBOOL))
              .addField(new fieldObject().setName("archFilled").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for archFilled parameter").setType(fieldObject.TYPE_SFBOOL))
              .addField(new fieldObject().setName("archHalfFilled").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for archHalfFilled parameter").setType(fieldObject.TYPE_SFBOOL))
              .addField(new fieldObject().setName("lintel").setAccessType(fieldObject.ACCESSTYPE_INITIALIZEONLY).setAppinfo("user or default input for lintel parameter").setType(fieldObject.TYPE_SFBOOL))
              ...
              .addField(new fieldObject().setName("pointOut").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("send computed points to the Coordinate node").setType(fieldObject.TYPE_MFVEC3F))
              .addField(new fieldObject().setName("indexOut").setAccessType(fieldObject.ACCESSTYPE_OUTPUTONLY).setAppinfo("send computed indices to the IndexedFaceSet node").setType(fieldObject.TYPE_MFINT32))
              .setIS(new ISObject()
